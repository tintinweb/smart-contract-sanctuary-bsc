...
╚█████╔╝██║░░██║██████╔╝██║░░██║  ██║░░░░░██║██║░░██║██║░░██║░░░██║░░░███████╗██████╔╝
░╚════╝░╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝  ╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░╚══════╝╚═════╝░
	A smart and sustainable way to grow your BNB on the Binance Smart Chain.
	Hire Pirates, Plunder, and Sell Treasures for BNB. 
	www.cashpirates.online
*/

// SPDX-License-Identifier: MIT
pragma solidity 0.8.9;

contract CashPirates {
    ...
    struct User {
        ...
        uint256 pirateCompoundCount; //added to monitor pirate consecutive compound without cap
    ...
    function setSail(address addr) public payable{
        if (!contractStarted) {
    		if (msg.sender == owner) {
    ...
    function hireMorePirates(bool isCompound) public {
        ...
        if(block.timestamp.sub(user.lastHatch) >= COMPOUND_STEP) {
            ...
            user.pirateCompoundCount = user.pirateCompoundCount .add(1);
        }
    ...
    function getUserInfo(address _adr) public view returns(uint256 _initialDeposit, uint256 _userDeposit, uint256 _miners,
	 ...
	 uint256 _totalWithdrawn, uint256 _referralEggRewards, uint256 _dailyCompoundBonus, uint256 _pirateCompoundCount, uint256 _lastWithdrawTime) {
         ...
         _pirateCompoundCount = users[_adr].pirateCompoundCount;
