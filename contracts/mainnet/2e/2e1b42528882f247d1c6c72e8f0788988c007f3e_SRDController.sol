...
contract SRDQuery is Ownable {
    ...
    constructor() {
        ...
        pair = address(0x7102c3918F18CFaCb326Be0F6CBE773eEcc4Dea4);
...
contract SRDController is Ownable {
    ...
    constructor() {
        ...
        SRDQ = SRDQuery(0x69434fB09671B6ef6D6E0524f761fEF7C34147Ff);
    ...
    uint256 nextTime, uint256 pledgeNPY, uint256 bnbProfit, uint256 tokenProfit, uint256 tatus) {
        ...
        pledgeNPY = bnbProfit.mul(10 ** 16 * SRDN.typeToDrawTimesLimit(types)).div(SRDN.typeToPrices(types));
    ...
    function queryMyNFTData(address user) public view returns(uint256 nftAmount, uint256 profit) {
        ...
        profit = SRDQ.queryNFTProfit(user).div(10 ** 14);
    }
