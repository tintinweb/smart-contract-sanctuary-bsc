...
contract Adamite is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "Adamite";
    string public _symbol = "ADM";
    ...
    constructor() ERC20Detailed("TestMite", "TSTM", uint8(DECIMALS)) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Sushi 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E // cake test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ...
        autoLiquidityReceiver = 0xcf61252EEe28b8a6F852c06C39bC37e9C6B1F0a0;
        TreasuryReceiver = 0x79fB4c642eD7B1e5f5Ec589E16d65d87aE760565;
        RiskFreeValueReceiver = 0x661c191E8b52Bef77207630103Bb813A24EBb588;
