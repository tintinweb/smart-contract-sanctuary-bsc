...
BabyCultZhao is born after the Cult Zhao token has mooned. 
This will be the baby version of CultZhao and will moon even harder than before. 
How? BabyCultZhao will get traction based on CZ tweet.

buy tax 8% , sell tax 12%

https://t.me/BabyCultZhao
...
contract BabyCultZhao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCultZhao";
    string private _symbol = "BCZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55454402A0A30cB2D655E0022CE18376Fd70F960); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x55454402A0A30cB2D655E0022CE18376Fd70F960); // Buyback Wallet Address
