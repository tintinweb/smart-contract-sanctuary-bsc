...
Telegram: https://t.me/sabtoshigrow
...
contract SABTOSHI is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 2;  // Liquidity Fee 1%
    uint256 private _buyMarketingFee = 2;  // Markting Fee 6%
    uint256 private _buyDevFee = 3;  // Dev Fee 1% 

    // 7% Sell Tax
    uint256 private _sellTaxFee = 0; // Reflection Fee 0%
    uint256 private _sellLiquidityFee = 2;  // Liquidity Fee 3%
    uint256 private _sellMarketingFee = 2;   // Markting Fee 6%
    ...
    constructor() {
        _name = "Sabtoshi Grow"; //  Name
        _symbol = "SGROW"; //  Symbol
        ...
        _maxTxAmount = 200000000000 * 10**_decimals; // 2% Of Total Supply
        _maxWalletBalance = 200000000000 * 10**_decimals; // 2% Of Total Supply 
        _marketingWalletAddress = 0x14b2c434a15a1ccf1F63a9780afde98BBBd07218; // Marketing Wallet 
        _devWalletAddress = 0x14b2c434a15a1ccf1F63a9780afde98BBBd07218; // Dev Wallet 
