...
contract Avatar2 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x188d6FB6F6F3BE4591D33304e37f9874D8e24C46);
    address payable public teamWalletAddress = payable(0xdD7C6d3a7a4bFa0E2F9169F4E2928634008215Cd);
