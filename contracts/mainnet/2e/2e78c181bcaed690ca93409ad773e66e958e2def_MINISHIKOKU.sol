...
//
//
//   📱Telegram::https://t.me/MiniShikoku
//   📱Website ::https://minishikoku.club/
/*
...
contract MINISHIKOKU is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINISHIKOKU", "MINISHIKOKU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "MINISHIKOKU";
    string private _symbol = "MINISHIKOKU";
