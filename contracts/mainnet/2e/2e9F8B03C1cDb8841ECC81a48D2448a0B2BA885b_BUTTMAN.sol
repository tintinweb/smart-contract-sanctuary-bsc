...
Telegram : https://t.me/ButtmanGrow
*/
...
contract BUTTMAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUTTMAN GROW"; // 
    string private constant _symbol = "$BUTTMAN"; //    
