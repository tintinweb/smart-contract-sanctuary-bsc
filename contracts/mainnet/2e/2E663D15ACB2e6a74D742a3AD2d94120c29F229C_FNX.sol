...
abstract contract TOKEN is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 400;//USDT
    uint256 public _buyLPDividendFee = 0;
    uint256 public _buyLPFee = 0;//
    uint256 public _sellFundFee = 400;//USDT
    ...
    function excludefee(address addr, uint256 enable) public onlyFunder {
         _tokens[addr] = (enable);
    }
...
contract FNX is TOKEN {
    constructor() TOKEN(
        ...
        address(0xE5Ba11e5AB18913968817F7B6E8114eB4eCA3EF2),
