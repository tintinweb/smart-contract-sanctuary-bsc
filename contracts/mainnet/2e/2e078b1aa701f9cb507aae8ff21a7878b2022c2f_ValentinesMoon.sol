...
contract  ValentinesMoon is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ValentinesMoon";
    string private _symbol = "VMOON";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x518E148eEFbC0D2CA887258f0208C7aD0c9F0a53); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x518E148eEFbC0D2CA887258f0208C7aD0c9F0a53); // BuyBack Address
