...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);//要分红的币
...
contract ZILLAMATRIX is IBEP20, Auth {
    ...
    address WBNB = 0x55d398326f99059fF775485246999027B3197955;//交易对 要USDT池子就换成USDT合约
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Polar Bear";//名字
    string constant _symbol = "PB";//名字
    ...
    uint256 public liquidityFee    = 5;//流动税
    uint256 public reflectionFee   = 1;//分红税
    uint256 public marketingFee    = 1;//营销费
    uint256 public devFee          = 1;//dev费
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + devFee;
    uint256 public feeDenominator  = 100;

    bool public blacklistMode = false;//是否启用黑名单
    bool public walletTransferAllowed = true;
    mapping (address => bool) public isBlacklisted;

    uint256 public deadBlocks = 0;//杀区块 
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**17 * 10**_decimals;
