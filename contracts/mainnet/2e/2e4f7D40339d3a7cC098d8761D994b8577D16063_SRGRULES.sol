...
//SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract Ownable is Context {
        ...
        constructor() {
            _owner = 0xA63B1dB461b1Cf43381F0d7888e8D8ae8EaD9859;
    ...
    contract SRGRULES is IERC20, Context, Ownable, ReentrancyGuard {
        event Bought(
        ...
        // token data
        string private constant _name = "SRGRULES";
        ...
        // Total Supply
        uint256 public constant _totalSupply = 100000 * _DECMULTIPLIER;
        ...
        uint256 public sellMul = 97;
        uint256 public buyMul = 97;
        uint256 public constant DIVISOR = 100;

        //Max bag requirements
        mapping(address => bool) public isTxLimitExempt;
        uint256 public maxBag = _totalSupply * 200/100 / 100;
        uint256 public maxTX = _totalSupply * 50/100 / 100;
        
        //Tax collection
        uint256 public taxBalance = 0;

        //Tax wallets
        address public teamWallet = 0xA63B1dB461b1Cf43381F0d7888e8D8ae8EaD9859;
        address public treasuryWallet = 0xA63B1dB461b1Cf43381F0d7888e8D8ae8EaD9859;

        // Tax Split
        uint256 public teamShare = 66;
        ...
        //trading parameters
        uint256 public liquidity = 10000 * 10**_srgDecimals;
