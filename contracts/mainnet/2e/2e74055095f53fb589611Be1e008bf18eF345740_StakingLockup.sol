...
contract StakingLockup is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 90, 0, 200, 951293759, 0, 0, 0)); // 1% liquidity
        lockups.push(Lockup(1, 180, 0, 200, 1902587518, 0, 0, 0)); // 1% liquidity
        lockups.push(Lockup(2, 360, 0, 100, 1426940638, 0, 0, 0)); // 1% liquidity
        lockups.push(Lockup(3, 540, 0, 100, 1951293759, 0, 0, 0)); // 1.5% liquidity
