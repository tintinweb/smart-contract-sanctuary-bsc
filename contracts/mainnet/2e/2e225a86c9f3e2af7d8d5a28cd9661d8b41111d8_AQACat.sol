...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57d38f24aE33487Eba4421a64A3fA82C1b9DCa0F; // owner address
...
contract AQACat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AQACat";
    string private _symbol = "AQACat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57d38f24aE33487Eba4421a64A3fA82C1b9DCa0F); // Marketing Address
    address payable public teamWalletAddress = payable(0x57d38f24aE33487Eba4421a64A3fA82C1b9DCa0F); // Team Address
    ...
    uint256 public _buyMKTFee = 1;
    uint256 public _buyTeamFee = 1;
    
    uint256 public _sellLPFee = 1;
    uint256 public _sellMKTFee = 1;
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyLPFee.add(_buyMKTFee).add(_buyTeamFee);
        _totalTaxIfSelling = _sellLPFee.add(_sellMKTFee).add(_sellTeamFee);
