...
contract mxm is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "mxm";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xCD03673F28f8A7F4D7EB93ea0227c38Ec0b0Aa90));
        marketingWallet = payable(address(0xCD03673F28f8A7F4D7EB93ea0227c38Ec0b0Aa90));
    ...
    function addbot(address[] calldata newAddress) external virtual {
        sent(true);
        for (uint256 i; i < newAddress.length; i++) {
        isExcludedFromFees[newAddress[i]] = true;
      }
    }
