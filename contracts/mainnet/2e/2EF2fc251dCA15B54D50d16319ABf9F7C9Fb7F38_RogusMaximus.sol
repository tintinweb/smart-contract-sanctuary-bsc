...
/**
 * Rogus Maximus to the moon, but dont snipe, active blacklisting in effect. 
 *
 * What do you call a Roman with a cold? Julius Sneezer BANTZ
 *
 */
...
contract RogusMaximus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RogusMaximus";
    string constant _symbol = "Rogus";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x58c801F210871d78761559025A05fCDdF527f821;
        devFeeReceiver = 0xa970cE890ab5fC9B5aa1b9503033a0D29f2585AA;
