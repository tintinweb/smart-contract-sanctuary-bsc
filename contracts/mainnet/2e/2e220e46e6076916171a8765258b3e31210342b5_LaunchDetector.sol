...
contract LaunchDetector is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNCH DETECTOR";
    string private _symbol = "LDB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7C491e0983EEA24AEE533aD8A9b537CF355eEfc9); 
    address payable public BurnedWalletAddress = payable(0x7C491e0983EEA24AEE533aD8A9b537CF355eEfc9); 
    ...
    uint256 public _buyBurnedFee = 9;
