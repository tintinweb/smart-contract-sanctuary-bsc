...
/* LUNA PRINTER | $PRINTER | https://www.t.me/LunaPrinterBSC 

Luna Printer is a decentralised community-driven project with 1% Luna Rewards, a based dev and marketing pre-paid. We plan to grow using a combination of organic shilling and conventional Telegram marketing from the get-go! 

ROADMAP
Phase 1 - Website, Dev KYC, Initial TG + Twitter Marketing
Phase 2 - Marketing Push, Community-Building, Fundraising 
Phase 2 - Renounce Contract, Lower Taxes To 5/5, Create Utility
...
Max Wallet 1% | Max Transaction 1%

Initial LP - 2 BNB

https://www.t.me/LunaPrinterBSC */
...
contract LunaPrinter is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Luna Printer";
    string constant _symbol = "$PRINTER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xe085aB3a66c5780A21B39449B829d10b3AFf85c0;  
        anothermarketingWallet = 0xcC6b3b8861c6Da352336B858EEE62bf192b63DD0;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(4).div(9);
