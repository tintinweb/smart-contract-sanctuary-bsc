...
/**
   ...
   Catate was born from the hype andrew tate and world cat day (today). We all hope that catate can catch up with his mother (tate token) who touched 10 million marketcap. Utility will be dropped soon. If you are asking my prev, its only hit 3 million from 100$ marketcap, but forget it.
    I wish we could all fly Catate to the moon ,same supply with tate, and same tax with tate . 1 million minimum!

   Telegram: https://t.me/Catateofficial
...
contract Catate is Context, IERC20, Ownable {
