...
https://t.me/BoredLaunch by  @BoredApeCryptoCalls
...
contract  BoredApe is Context, IERC20, Ownable {
    ...
    string private _name = "Bored Ape";
    string private _symbol = "BAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f4B5922f7b4F97005e0cb7C133cB986ded1DaaB);
    address payable public teamWalletAddress = payable(0x30F5C555549f734Affa69288CF99Bc85bdd9611f); 
