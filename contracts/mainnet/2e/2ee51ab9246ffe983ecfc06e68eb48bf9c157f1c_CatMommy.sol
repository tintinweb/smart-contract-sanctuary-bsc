...
contract CatMommy is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CatMommy";
    string private constant _symbol = unicode"CMom";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x0bB293e1E3D2b2a20D44514A05F2efE2B6a8cc7E);
    address payable public MarketingWallet = payable(0x42eF2162260fB1774873aE52152e8E6A3D60BB34);
