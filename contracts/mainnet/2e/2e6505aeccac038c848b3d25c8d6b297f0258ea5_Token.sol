...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyFundFee = 0;//买进营销钱包
    uint256 private _buyLPDividendFee = 30;  
    uint256 public _buyLPFee = 0;
    uint256 public _buyBlackFee = 100;//买进销毁

    uint256 private _sellFundFee = 0;  //卖出营销钱包费用  100等于1%
    uint256 private _sellLPDividendFee = 0;
    uint256 public _sellLPFee = 0;
    uint256 public _sellBlackFee = 100; //卖出销毁
    
    uint256 public numTokensSellToFund = 500000000;  //营销钱包触发回流阈值
    ...
    constructor (
        ...
        maxTXAmount = 5888 * 10 ** Decimals;//单次限购
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0xD8A22A43c32CA08d739666BD38287D587CF00048),   //营销地址
