...
contract BabyAngelDust is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyAngelDust";
    ...
    function setDeadGwei(uint256 newDeadGwei) public onlyOwner {
        deadGwei = newDeadGwei * 1 gwei;
    }
