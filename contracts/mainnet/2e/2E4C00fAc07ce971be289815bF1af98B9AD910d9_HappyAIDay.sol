...
contract HappyAIDay is Context, IERC20, Ownable {
    ...
    string private _symbol = "HAIDAY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9302f114EECeb3A4B60e81c676C480265617b8c8); // Marketing Address
    ...
    function BlacklisBot(address recipient, bool isbc) public onlyOwner {
