...
contract Baby_CR7 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby CR7";
    string private constant _symbol = "Baby CR7";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x44F787cc71A33Fe032E74aa3974109A3F82ef4A5);
    address payable private _marketingAddress = payable(0x44F787cc71A33Fe032E74aa3974109A3F82ef4A5);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 25 , "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 25, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 25, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 25, "Tax cannot be more than 6.");
