...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfC6487600790Ab3295Ab125da8b90c4E91735c5B; // owner address
...
contract KagebosuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Kagebosu Inu";
    string private _symbol = unicode"KAINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfC6487600790Ab3295Ab125da8b90c4E91735c5B); // Marketing Address
    address payable public teamWalletAddress = payable(0xfC6487600790Ab3295Ab125da8b90c4E91735c5B); // Team Address
