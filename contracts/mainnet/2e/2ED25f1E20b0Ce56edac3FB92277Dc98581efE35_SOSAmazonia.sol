...
// as well as other intellectual property laws and treaties. This SmartContract is licensed for SOS AMAZON without expiration.
...
contract SOSAmazonia is GasHelper, ERC20 {
  ...
  string constant private _nameToken = "SOS Amazonia";
  string constant private _symbolToken = "SOSAMZ";
  ...
  constructor()ERC20(_nameToken, _symbolToken) {
    ...
    administrativeWallet = 0x7f02307589715B45a378Eb1a4064183548DBc8e1;
    _permissions[administrativeWallet] = 15; // exempt fee, fee receiver, tx limit and wallet limit
    internalFundWallet = 0xcEBC3EAc391B2dA395Fa039B449C883c33aB2665;
