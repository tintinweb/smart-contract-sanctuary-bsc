...
contract GTRExpress is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x01F7146942Ae6311a4D17D616490Ec6758952220); 
    ...
    string private _name = "GTR Express";
    string private _symbol = "GTRE";
