...
contract babyBNI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyBNI";
    string private _symbol = "BabyBNI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x74128fC23E0f4580e4dBC0D3075Fc52F34329374); // Marketing Address
    address payable private teamWalletAddress = payable(0x74128fC23E0f4580e4dBC0D3075Fc52F34329374); // Team Address
