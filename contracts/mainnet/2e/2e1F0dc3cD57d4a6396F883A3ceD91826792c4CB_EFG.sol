...
contract EFG is Context, IERC20, Ownable {
    ...
    string private _name = "superTEDDYMOON";
    string private _symbol = "superTEDDYMOON";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd8d15324B9D0Ffe3D581C47A0D713E12DB798a5d));
        __wal = payable(address(0x48829032A35530aE4b26f65767F1b95b4Bf94E32));
