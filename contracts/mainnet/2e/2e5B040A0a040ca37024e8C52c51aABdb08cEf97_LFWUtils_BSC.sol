...
contract LFWUtils_BSC {
    ...
    address private busd_usdt = 0x169F653A54ACD441aB34B73dA9946e2C451787EF;
    address private busd_usdc = 0xc2F5B9a3d9138ab2B74d581fC11346219eBf43Fe;
    address private usdt_usdc = 0x3EFebC418efB585248A0D2140cfb87aFcc2C63DD;
    ...
    function getPancakeFarmingInfo(
        ...
        if (_pId == 133){
            ...
            farmingData[1] = busd;
            farmingData[2] = cake;
            IStable scPair = IStable(busd_usdt);
            farmingInfo[2] = scPair.balances(0);
            farmingInfo[3] = scPair.balances(1);
            farmingInfo[4] = farmingInfo[2] + farmingInfo[3];
        } else if (_pId == 134) {
            farmingData[0] = usdc;
            farmingData[1] = busd;
            farmingData[2] = cake;
            IStable scPair = IStable(busd_usdc);
            farmingInfo[2] = scPair.balances(0);
            farmingInfo[3] = scPair.balances(1);
            farmingInfo[4] = farmingInfo[2] + farmingInfo[3];            
        } else if (_pId == 135) {
            ...
            farmingData[1] = usdc;
            farmingData[2] = cake;
            IStable scPair = IStable(usdt_usdc);
            farmingInfo[2] = scPair.balances(0);
            farmingInfo[3] = scPair.balances(1);
            farmingInfo[4] = farmingInfo[2] + farmingInfo[3];             
        } else {
