...
contract MORTAL is IBEP20, Auth {
   ...
   string constant _symbol = "MORTAL";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 1 ) / 100 ; // set 3 after 5'
   ...
   // Buy Fees
    ...
    uint256 buybackFeeSell = 200; // usable for giveaways and buybacks (auto buyback possible)
...
uint256 reflectionFee;
   ...
   uint256 targetLiquidity = 20; // do not change
