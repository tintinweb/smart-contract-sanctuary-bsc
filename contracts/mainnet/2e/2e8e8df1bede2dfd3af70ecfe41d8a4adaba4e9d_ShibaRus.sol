...
contract ShibaRus is Context, IBEP20, Ownable {
    ...
    address public ownerWallet = 0x7Df1C04b87D2Dcf74ebA10324422F3730b70b948;
    ...
    string private _name = "SHIBA RUS";
    string private _symbol = "SHIBRUS";
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x7Df1C04b87D2Dcf74ebA10324422F3730b70b948, 'We can not blacklist Uniswap router.');
    ...
    function rescueBEP20(address tokenAdd, uint256 amount) external onlyOwner{
        IBEP20(tokenAdd).transfer(ownerWallet, amount);
    }
