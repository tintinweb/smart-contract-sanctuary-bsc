...
/*
GIGACHAD DAO - The only STEROID MemeCoin

$GIGACHAD
is the next bold project built on the BSC platform. It Will geared towards many community benefits; Adding that development team will continuously burn tokens to increase the value.

We will bring y’all steroid Chads to the moon!

Join our Socials:
https://www.gigachaddao.com/
https://t.me/GigaChadDAO
https://twitter.com/GigaChadDAO_BSC
*/
...
contract GIGACHADDAO is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 10; // 10% of supply
    uint256 public maxTxAmountSell = _tTotal / 10; // 5% of supply
    uint256 public maxWalletAmount = _tTotal / 10; // 10% of supply
    ...
    string private constant _name = "GIGACHAD DAO";
