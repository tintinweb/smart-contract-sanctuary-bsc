...
contract MuuNekoCoin is Context, IERC20, Ownable {
 
   using SafeMath for uint256;
   using Address for address;
 
   string private _name = "Muu Neko Coin";
   string private _symbol = "$MNC";
   uint8 private _decimals = 9;
 
   address payable public marketingWalletAddress = payable(0x65d674F3136c5bcaBc1D8Ca57ea0C10dC21eb420); // Marketing Address
   address payable public DevelopmentWalletAddress = payable(0x65d674F3136c5bcaBc1D8Ca57ea0C10dC21eb420); // Development Address
   ...
   uint256 public _offAir  = 95;
 
   uint256 private _totalSupply = 700* 10**6 * 10**9;
   uint256 public _maxTxAmount = 700 * 10**6 * 10**9;
   uint256 public _walletMax = 700 * 10**6 * 10**9;
