...
contract LUNAFLOKICLASSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Floki Classic"; // 
    string private constant _symbol = "LUNFC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x25263de426959C94D2A584eCAE7bFfe5410CD0aB;
