...
/*
Looking for a rare gem token in BSC?
PiGoblin will be your 1st choice!

A new BSC token with experienced Dev & Team, PiGoblin will be born soon. By investing in PiGoblin, part of the transaction fees will be converted into reflection & reward all our holders. A number of transaction fees is also allocated to buy back the token & maintain a strong & powerful chart.

- Dev & Team with years of experience
- Token with unique & bullish name
- Enjoy token reflection just by holding it
- Buy back function to protect chart
- Floor price for all our early investors

Join PiGoblin in Telegram : https://t.me/PiGoblin
*/
...
contract PiGoblin is Context, IERC20 { 
    ...
    string private constant _name = "PiGoblin"; 
    string private constant _symbol = "PiGoblin"; 
