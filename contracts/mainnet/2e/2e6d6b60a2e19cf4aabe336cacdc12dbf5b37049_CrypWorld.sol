...
abstract contract CrypWorldContext {
...
contract CrypWorld is CrypWorldContext, CrypWorldIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrypWorld Finance";
    string private _symbol = "wCWC";
