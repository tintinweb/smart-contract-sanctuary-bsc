...
contract MIKOCOIN is Context, IBEP20, Ownable {
    ...
    address payable public HentaiWallet =
        payable(0x945A7cae3baeeBE5e349c3bC492d07968eafD933);
    address public WatchtoEarn =
        0x945A7cae3baeeBE5e349c3bC492d07968eafD933;
    ...
    string private constant _name = "Miko Coin";
    string private constant _symbol = "MIKO";
    ...
    constructor() {
        ...
        _isExcludedFromFee[HentaiWallet] = true;
        _isExcludedFromWalletHoldingLimit[owner()] = true;
        _isExcludedFromWalletHoldingLimit[HentaiWallet] = true;
    ...
    function UpdateWallets(
        ...
        HentaiWallet = newMarkeitngWallet;
        WatchtoEarn = newDevelopmentWallet;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_MarketingFee > 0){
            ...
            transferToAddressETH(HentaiWallet, transferredBalance);
        }
    ...
    function takeDevelopment(
        ...
        _rOwned[WatchtoEarn] = _rOwned[WatchtoEarn].add(
            rDevelopment
        );
        emit Transfer(sender, WatchtoEarn, tDevelopment);
        return (tTransferAmount, rTransferAmount);
    }
