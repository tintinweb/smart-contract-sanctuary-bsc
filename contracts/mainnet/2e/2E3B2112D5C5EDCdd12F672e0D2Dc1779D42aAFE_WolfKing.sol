...
contract WolfKing is Context, IERC20, Ownable {
    ...
    string private _name = "King of Wolf";
    ...
    uint256 private _elseFee = 9;
    uint256 private _previousElseFee = _elseFee;

    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public mainAddres = address(0xD4E68b08ACE735efa2e994BeF92EE077B4963700);
    address public marketAddress = address(0xe3b17c4DCD79DCcC9cF01ffdeb4e1248F5c2C9Fd);
    address public fundAddress = address(0x19aCfD4a0cEEf2e9EadBedf0a530CC54F205e5C2);
    address public liquidAddress = address(0xE3184e304F2945eA3e3711F2dc3C9d16c19fe5Ba);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _takeInviterFee(sender, recipient, tAmount); // 5%
        _takeLiquidity(sender, tElseFee * 2 / 9); // 2%
        _takeBurn(sender, tElseFee / 9);      // 1%
        _takeMarket(sender, tElseFee / 18);   // 0.5%
        _takeFund(sender, tElseFee / 18);     // 0.5%
    ...
    function _takeInviterFee(
        ...
        uint8[20] memory inviteRate = [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2];
