...
contract DogeSnake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Snake";
    string private _symbol = "DOGESNAKE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x932326872B60067209962671b2F652909C65fB63);
