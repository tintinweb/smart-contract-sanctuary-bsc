...
contract BabyDogeKingSon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyDogeKingSon";
    string constant _symbol = "BabyDogeKingSon";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x398E0bCdca2Db9A8ACD28ce3C6ac0951c07a1A8d;
