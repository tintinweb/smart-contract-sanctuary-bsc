...
/**
MEMEY is an ALL in ONE project, focusing on High Rate Dividend Passive income !

MEMEY brings the most revolutionary mechanism to BSC ecosystem, programmed to reward holders while increasing in both liquidity and value. Earn by holding $MMY token.

We will deploy various apps (MEMEY HUB, Staking, Swapping, NFT Collection, Mini Games,P2E Game, MemeySwap) Its our aim to take cryptocurrency to new heights. We aim to be a platform that will provide all facilities under a single platform in a fun way.

✅High Rate Passive Income
...
contract REEFER is Context, IERC20, Ownable {
