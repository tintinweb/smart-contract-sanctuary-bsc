...
contract CatMan is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x21fBBEf04aD43A49836e900852b63da9dbB594e9;

    string private constant _name = "CatMan";
    ...
    Taxes public taxes = Taxes(0, 5, 3);
    Taxes public sellTaxes = Taxes(0, 5, 3);
