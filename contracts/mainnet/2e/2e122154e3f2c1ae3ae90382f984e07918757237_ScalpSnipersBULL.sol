...
contract ScalpSnipersBULL is  ERC721A,DefaultOperatorFilterer, Ownable, ReentrancyGuard {  
...
// ================== Constructor Start =======================
  constructor(
    string memory _uri
  ) ERC721A("ScalpSnipers BULL", "BULL")  { //change this line to your full and short NFT name
    seturi(_uri);
  }
