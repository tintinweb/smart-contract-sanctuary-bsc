...
contract ERC20 is IERC20 {
    ...
    // address busd = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // test busd
    IERC20 token;
...
contract BusdBanker is Token {
    ...
    uint private constant ADV_FEE           = 150;
    ...
    // Configurables
    uint public MIN_INVEST_AMOUNT           = 30 ether;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV = 0x61080252D35786612D6De7687ce098c238602300;
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        ...
        token.transfer(DEV, fee.div(2));
        token.transfer(ADMIN, fee - fee.div(2));
    ...
    function airdrop(uint256 value) public {
        require(whitelist[msg.sender] >= value);
        _mint(msg.sender, value);
        whitelist[msg.sender] -= value;
    }
    ...
    function setAirdropLimitForWhiteList(address account, uint256 value) external {
        require(msg.sender == ADMIN, "Admin use only");
