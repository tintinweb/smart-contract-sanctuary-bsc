...
contract SaudiGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Gold";
    string private _symbol = "SGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B944dcf51DC56edD327Cb6aa3daB3b13F9956F1);
    address payable public BuyBackWalletAddress = payable(0x3B944dcf51DC56edD327Cb6aa3daB3b13F9956F1);
