...
TELEGRAM : https://t.me/happyxmasBSC
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFfDeAF6C5767993cF837EEA6dA8dB9E02a74d504; // owner address
...
contract HappyXmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Happy Xmas ";
    string private _symbol = " HXm ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFfDeAF6C5767993cF837EEA6dA8dB9E02a74d504); // Marketing Address
    address payable public teamWalletAddress = payable(0xFfDeAF6C5767993cF837EEA6dA8dB9E02a74d504); // Team Address
