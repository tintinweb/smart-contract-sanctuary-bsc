...
contract AirdropLock is Ownable {
    ...
    uint256 public unlockPeriod = 31536000; // 31536000 - 365 days in seconds
    uint256 public unlockPercent = 200; // 200 its 20%
    ...
    address public airdropAddress = 0xb8a1ece4f9eC7C7Ae75DE6Fc9bfcae187Fb6844E;
    ...
    function claim() public {
        ...
        _token.safeTransfer(airdropAddress, _amount);
    }

    function changeAirdropAddress(address newAirdrop) public onlyOwner() {
        airdropAddress = newAirdrop;
    }
