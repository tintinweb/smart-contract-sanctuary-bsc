...
/* 
We are excited to announce the launch of Sato King on BSC, the first AI MEME TOKEN on the BSC blockchain 🤖💎. 

We will also be launching a $SatoKing AI buy bot and conducting marketing efforts to support the launch 🚀. 

Will be introducing the FIRST EVER AI DRIVEN STAKING POOL. LAUNCHING 🔜 
📈Taxless 0% buy 📈5% sell 📈Rewards $BTC 5% every Sell📈
🔐Liqudity lock for 6 Months Mudra.locker
📈 Renounce Onwership
💬 Telegram: https://t.me/SatoKing 
🌎 Website: SatoKing.ai (under construction)
*/
...
contract SatoKing is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'SatoKing';
    string private _symbol = '$SatoKing';
