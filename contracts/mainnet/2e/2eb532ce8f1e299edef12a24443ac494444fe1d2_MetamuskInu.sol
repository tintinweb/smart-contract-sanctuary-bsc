...
contract MetamuskInu is IERC20, Ownable {
    ...
    string _name = "MetaMusk Inu";
    string _symbol = "METAMUSK";
    ...
    constructor () {
        ...
        teamFeeReceiver = 0xCeE94FBD6d1F203Db10534b855F1D4FFbbdad246;
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (liq_fee, varMarketingFee, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = swapThreshold.mul(liq_fee).div(_totalFee).div(2);
        ...
        uint256 totalBNBFee = _totalFee.sub(liq_fee.div(2));
        uint256 amountBNBLiquidity = amountBNB.mul(liq_fee).div(totalBNBFee).div(2);
    ...
    function changeFees(uint256 _liq_fee, uint256 _reflectionFee, uint256 _varMarketingFee, uint256 _giveawayFee) external onlyOwner {
        liq_fee = _liq_fee;
        reflectionFee = _reflectionFee;
        varMarketingFee = _varMarketingFee;
        giveawayFee = _giveawayFee;
        totalFee = liq_fee.add(reflectionFee).add(varMarketingFee).add(giveawayFee);
        require(totalFee <= 70, "Fees must be less than 70%");
    }
