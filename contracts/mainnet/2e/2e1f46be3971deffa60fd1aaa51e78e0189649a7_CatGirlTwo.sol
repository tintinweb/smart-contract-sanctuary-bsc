...
contract CatGirlTwo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x57DDF0F614713E742572adb617e06F3AF2B4fA68); 
    address payable public Wallet_Dev = payable(0x730875458Ecd3801e6691DB98Adee65e6e9046d9);
    ...
    string private constant _name = "CatGirl2.0"; 
    string private constant _symbol = unicode"$CATG2"; 
    ...
    constructor () {
        ...
        _owner = 0xb14C28069c30aE75ee13dF2688DB4E9112308f4f;
