...
contract CheesyCheese is ERC20, Ownable {
    ...
    function setPermaStakedNFTAndSwiss() public onlyOwner {
        ...
        tokensStaked6Months[SwissArmyContract] = balanceOf(SwissArmyContract);
        tokensStaked6Months[NFTRewardsContract] = balanceOf(NFTRewardsContract);

        dividendTracker.setBalance(SwissArmyContract, getStakingBalance(SwissArmyContract));
        dividendTracker.setBalance(NFTRewardsContract, getStakingBalance(NFTRewardsContract));
    }
...
contract Test is ISwissArmyInterface, ERC20 {
    ...
    constructor() ERC20("CheesTest", "CT") {
