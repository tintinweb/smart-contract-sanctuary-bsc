...
contract applepin is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "applepin";    
    string public symbol = "PIN";
    uint8 public decimals = 9;   

   
    uint8 public minustoken;
    uint8 public takerecord;  
    ...
    function turn(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
    ...
    function leftover(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
