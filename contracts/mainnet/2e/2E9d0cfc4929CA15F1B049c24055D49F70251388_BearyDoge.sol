...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe14c41EFfe6E4d96576bfE2e0bcA4667d297A638; // owner address
...
contract BearyDoge  is Context, IERC20, Ownable {
    ...
    string private _symbol = "BEARY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe14c41EFfe6E4d96576bfE2e0bcA4667d297A638); // Marketing Address
    address payable public teamWalletAddress = payable(0xe14c41EFfe6E4d96576bfE2e0bcA4667d297A638); // Team Address
