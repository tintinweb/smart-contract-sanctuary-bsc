...
contract MarsMinerTokenBase is Context, IERC20, IERC20Metadata, Ownable, DateTime, SafeMath {
...
/**
 * MarsMinerToken contract
 */
contract MarsMinerToken is MarsMinerTokenBase {
    constructor() MarsMinerTokenBase("MarsMinerToken", "MMT") {
