...
contract DogezillaTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogezilla 2.0";
    string private _symbol = "Dogezilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x44179d113A97600afcEC937da1e62064459200Fe); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x44179d113A97600afcEC937da1e62064459200Fe); // Team Address
