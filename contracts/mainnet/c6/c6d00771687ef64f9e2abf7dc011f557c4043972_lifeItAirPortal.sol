...
contract lifeItAirPortal {
    address private technicalTeams;
    ...
    function _AirPortal() private {
        ...
        if (months >= 36) {
            tokenContract.transfer(technicalTeams, 13500 * (10**decimal));
        } else {
            tokenContract.transfer(technicalTeams, 13900 * (10**decimal));
        }
        mnext = mnext + 30 days;
        months++;
    }
