...
contract Weakhands is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed(block.chainid==1 ? "Weak Hands" : "Weak Hands", block.chainid==1 ? "Isold" : "Isold", 18) {
        address dexAddress;
        address pairedTokenAddress;
        if(block.chainid == 56){
            dexAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
            pairedTokenAddress = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
        ...
        marketingAddress = address(0x4a1edBa25a93B45C4e68f4454Ba3d5cE44492CED);
        treasuryAddress = address(0x4a1edBa25a93B45C4e68f4454Ba3d5cE44492CED);
