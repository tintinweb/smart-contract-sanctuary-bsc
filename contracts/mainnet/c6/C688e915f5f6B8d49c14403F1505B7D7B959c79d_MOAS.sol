...
contract MOAS is IERC20, Ownable {
    ...
    address private _NFTAddress =
        address(0xAaF7f1a39F10D7B34ABe282F47A2eD05a6C06f12);

    uint256 public _inviterFee = 50;
    address public inviterAddress = address(0x615D458a9906b2819DF11E00147d1DC38ED99502);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public receiveReward1Token = address(0x615D458a9906b2819DF11E00147d1DC38ED99502);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _liquidityFee + _destroyFee + _NFTFee + _inviterFee;
        }
