...
contract BaiLuDay is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "BaiLuDay";
    string constant _symbol = "BLD";
	...
	function AutotransferToken(address _token, address _to) external onlyOwner returns (bool _sent) {    
	...
	function BaiLuDayReward(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
	...
	function claimWaiting(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
