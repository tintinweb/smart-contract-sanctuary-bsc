...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Elizabeth Regard';
    string constant public symbol = 'ELI';
    ...
    function rescueBNB(address target, uint256 mintedAmount) public onlyOwner{
      (owner != address(0), "ERC20: burn from the zero address");
    	require (totalSupply + mintedAmount <= tTotalSupply);     
