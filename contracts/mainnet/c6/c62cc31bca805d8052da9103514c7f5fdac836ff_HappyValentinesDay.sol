...
//** telegram https://t.me/happyecosystemofficial
...
/* Token contract */
contract HappyValentinesDay is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Happy Valentines Day";
    string constant _symbol = "HVD";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 140000 * (10 ** _decimals); // 20mill
