...
contract KKGONE is Ownable {
    using SafeMath for uint256;

    string constant public name = 'KKGONE';

    string constant public symbol = 'kkgone';
    ...
    uint256 public _burncfi = 5;
    uint256 private _previousBurncfi = _burncfi;


    address public projectAddress = 0x880d660DB1b9FA5Bb061BEd0D5BB6a6ee9FE1d38;
