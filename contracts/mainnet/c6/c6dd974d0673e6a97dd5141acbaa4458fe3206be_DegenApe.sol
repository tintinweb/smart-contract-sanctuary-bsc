...
contract DegenApe is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xc6f89109548AC493e840551656db6D0B1f4227a0);

    string private _name = "DegenApe";
