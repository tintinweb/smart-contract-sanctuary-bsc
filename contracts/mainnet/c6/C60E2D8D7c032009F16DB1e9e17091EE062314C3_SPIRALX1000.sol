...
SPIRALS is a Stealth Launch🔥

🔥SPIRALS Finding a light of hope for crypto investors at a time of world turmoil and cryptocurrency bear market.
🔥Join us SPIRALS and let's make a new ATH together.
...
Website and Social Media are not yet available at the moment.

Telegram: https://t.me/spirals1000x

✅ Contract will be release an hr before Launch.
✅ SPIRALS is an anonymous, But 101% trusted team.
**/
...
contract SPIRALX1000 is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 4; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 4; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 4; // 2% of supply
    ...
    string private constant _name = "SPIRALS";
    string private constant _symbol = "SPIRALS";
