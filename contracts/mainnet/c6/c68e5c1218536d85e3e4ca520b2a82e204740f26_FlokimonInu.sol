...
/**
Telegram https://t.me/flokimoninu
site www.flokimon.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5c8Eb9c27D6E79d971B1166fFF4B6619d2B85a65;
...
contract FlokimonInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flokimon Inu";
    string private _symbol = "FLOKIMON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC7941598e01C16C71136022b627e77c20340c446);
    address payable public teamWalletAddress = payable(0xC7941598e01C16C71136022b627e77c20340c446);
