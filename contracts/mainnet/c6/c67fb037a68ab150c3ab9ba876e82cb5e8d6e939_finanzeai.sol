...
// Solidity v0.8.7 Development Midart AI Network
/*
  Finanzen AI uses advanced algorithms to analyze market data and provide users with real-time trading signals and automated trading strategies.
  It is an artificial intelligence supported platform for cryptocurrency trading.

  Finanzen AI will collect and analyze large amounts of data from various sources such as social media, news articles and financial data to identify patterns,
  trends and market sentiment.
  AI algorithms then use this information to generate real-time trading signals that can be used by traders to make informed buying and selling decisions.

 
  https://t.me/FinanzenAI
...
contract finanzeai is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 234000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Finanzen AI";
    string private _symbol = "FIAI";
    ...
    address public charityWallet = 0x7ad2F29a7eEfe16f799C1Ef00501B3E20201923E;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 2340000 * 10**9;
    uint256 public _maxTxAmount = 234000000 * 10**9;
