...
contract RabbitSkullBSC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RABBIT SKULL BSC";
    string private constant _symbol = unicode"$RASK";
    ...
    address payable public DevWallet = payable(0x5f7575133AEdbf1c89869819BEF57092B9022a8e);
    address payable public MarketingWallet = payable(0x2458d7Ce366cd0A74B310d0fb6223AA9cE1a2820);
