...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x69b14e8D3CEBfDD8196Bfe530954A0C226E5008E);
...
contract Ghost is IBEP20, Auth {
    ...
    address MATIC = 0x69b14e8D3CEBfDD8196Bfe530954A0C226E5008E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "360";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "360";
    uint8 constant _decimals = 0;

    uint256 _totalSupply = 1* 10 ** 36 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[0xDf04e22Be94F39d38b53A96C0287Db721f1563AA] = true;
        isFeeExempt[0xDf04e22Be94F39d38b53A96C0287Db721f1563AA] = true;
        ...
        marketingFeeReceiver = 0x015dCfbb32cE95D34EfBb01afc4D0e39dE9cbE89;

        _balances[0xDf04e22Be94F39d38b53A96C0287Db721f1563AA] = _totalSupply;
        emit Transfer(address(0), 0xDf04e22Be94F39d38b53A96C0287Db721f1563AA, _totalSupply);
    }
