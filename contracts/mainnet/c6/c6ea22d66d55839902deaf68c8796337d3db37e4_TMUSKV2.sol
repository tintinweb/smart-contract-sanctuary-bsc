...
// Submitted for Telegram: https://t.me/BSCommunityProject
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TMUSKV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " TWITTER MUSK V2 ";
    string private _symbol = " TMUSKV2 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Fca2C0FD2fAcb937C6d07104651EAA682b72C46);
    address payable public teamWalletAddress = payable(0x620e18031418A2Bb9EcE31b24605CDeE228cA36C);
    ...
    uint256 public _maxTxAmount = 1 * 250000 * 10**_decimals; 
    uint256 public _walletMax = 1 * 250000 * 10**_decimals;
