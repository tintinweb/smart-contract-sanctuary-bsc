...
/* Token contract */
contract KingFrogInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; // REWARDS ADDRESS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;// ADD FOR RENOUNCE
    address DEV = 0x25B70191D57EA66AF182Aca9b40dc8d968597D4d; // DEVLOPMENT WALLET
    ...
    // Name and symbol
    string constant _name = "KING FROG INU";
    string constant _symbol = "KFG";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1 TRILLION SUPPLY
    ...
    uint256 public swapThreshold = _totalSupply * 36 / 10000; 
    ...
    bool public EnableAntiBots = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x25B70191D57EA66AF182Aca9b40dc8d968597D4d;  
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(EnableAntiBots,"AntiBot not enabled yet");
        }
    ...
    function DistributeReward(address _address, bool _value) public authorized{
    ...
    function setRewardAmount(bool _enabled, uint256 _amount) external authorized {
