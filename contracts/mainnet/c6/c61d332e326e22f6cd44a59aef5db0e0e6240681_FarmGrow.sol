...
FarmGrow ($FGW) is the new buyback deflationary token, designed to become scarcer over time. Our main buyback feature is the biggest of all projects on the market, which will contribute to a rapid decrease in the number of tokens in circulation, as a result of the active price growth and hype due to this.
...
contract FarmGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FarmGrow";
    string constant _symbol = "FGW";
