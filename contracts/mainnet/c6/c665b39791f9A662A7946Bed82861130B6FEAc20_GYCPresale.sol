...
contract GYCPresale is Owned {
    ...
    uint256 public tokenRatePerEth = 2100e18;
    uint256 public rateDecimals = 0;
    
    uint256 public minEthLimit = 2e17; // 0.2 BNB
    uint256 public maxEthLimit = 2e18; // 1 BNB

    uint256 public hardCap = 128e18;
