...
contract Twitterdollars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Twitter dollars";
    string private _symbol = "Twitterdollars";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x9550553E80ECA76a7e456E4Bdb77f43692da63B4);
