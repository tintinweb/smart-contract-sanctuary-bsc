...
contract ESP is Operator {
    ...
    string private _name = "ESP";//#币名
    string private _symbol = "ESP";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 1000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 1000000000000 * 1e9);
