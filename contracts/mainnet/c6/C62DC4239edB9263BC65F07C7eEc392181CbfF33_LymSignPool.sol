...
contract LymSignPool is OwnableUpgradeable, DivestorUpgradeable {
    ...
    event RegisterSignMining(uint8 indexed nodeLevel, address indexed inviter);
    ...
    function registerSignMining(uint8 nodeLevel_, address inviter_) external onlyOrigin onlyOpen {
        ...
        emit RegisterSignMining(nodeLevel_, msg.sender);
    }
        ...
        )
    {
        ...
        info[0] = user.reSetNumber == 11 ? 0 : user.lastReSetTm;
