...
/**
 *活了近三十年的我，终于明白，我们这一 代人真是陷入了一个圈套。在外拼命打工，抛 妻弃子，四处奔波，即使透支身体也在所不 惜，就是为了挣俩钱、为了遇事不求人、为了 生活能体面点。 结果挣来的血汗钱，还房贷、还车贷，进 医院。自己舍不得吃、舍不得喝、舍不得穿， 日子还是过得紧巴巴的，生活也是一地鸡毛。 假使以后有了孩子，他们长大了以后，又 何处不是走上了我们的老路。如此这般循环往 复，整日忙忙碌碌、心力交瘁。没有时间考虑 我们为什么?有了学区房，在旁边的学校上学， 就能跨越阶层了吗？醒醒吧！社会是已经既得 利益者的！ 我们是时候该考虑一下了，我们拼命赚钱 到底是为了什么?为了养家糊口，还房贷、还车 贷，把身体累垮了再去医院，治好了继续干， 好不了就只有死路一条。 当死亡来临的那一刻，我们能否参透奋斗 的意义是什么呢？
*/
...
contract DagongRen is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DagongRen";
    string private _symbol = "DagongRen";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x52a11E6aA26a4ebaEF668eeeB4BFb9773195232d);
