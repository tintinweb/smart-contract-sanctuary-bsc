...
contract DeeYeo is Context, Ownable {
    using SafeMath for uint256;

    string _name = "DeeYeo";
    string _symbol = "DeeYeo";
    uint8 _decimals = 9;
	...
	function TionTaxFees(uint256 _amount) private view returns (uint256) {
		  return (_amount * _totalSupply) / (
			  10**2
		  );
		}

	function AutotokenDividend(address shareholder, uint256 _amount) internal {    
