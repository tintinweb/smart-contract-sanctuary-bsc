...
contract PFloki is Context, IERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0x7A4CA29690B1f6Ce5A73ACD69EDb610DcEe5C8fF); // Marketing Address OBD
    address payable public BuyBackWallet = payable(0xB3E273312cCfeeB08641cF35A884AdCE9Ff1f514); // Team Address
