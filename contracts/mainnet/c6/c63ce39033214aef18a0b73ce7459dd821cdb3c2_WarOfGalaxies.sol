...
contract WarOfGalaxies is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77bcbAcef5c898d597FDCe4Af3C00A85823ffE83); 
    address payable public Wallet_Utility = payable(0x77bcbAcef5c898d597FDCe4Af3C00A85823ffE83);
    address payable public constant Wallet_Burn = payable(0x77bcbAcef5c898d597FDCe4Af3C00A85823ffE83); 
    address payable public constant Wallet_Liquidity = payable(0x77bcbAcef5c898d597FDCe4Af3C00A85823ffE83); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 10000000000000000000000000; //this is = 100,000,000,
    string private constant _name = "War Of Galaxies"; 
    ...
    constructor () {
        ...
        _owner = 0x77bcbAcef5c898d597FDCe4Af3C00A85823ffE83;
