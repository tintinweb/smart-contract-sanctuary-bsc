...
| 7% TAX | - 5% marketing, 2% liquidity

Telegram:
https://t.me/kittyKatzPortal
*/
...
contract Kittykatz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KittyKatz";
    string private _symbol = "KKATZ";
