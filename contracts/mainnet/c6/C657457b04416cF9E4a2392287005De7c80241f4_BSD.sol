...
contract BSD is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8dE242B276D842799808c5AB79f29818cD47d0D3); 
    address payable public teamWalletAddress = payable(0x30DE29f8EF96d9A1D650067E80dDE64dD067Ebf6); 
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if (recipient == uniswapPair) {
                    require(_antiBot.isNotBot(sender), "ERC20: Bot Address");
                }
