...
contract RAT is Context, IBEP20, Ownable {
    ...
    string private _name = "RatRace"; // token name
    string private _symbol = "RAT"; // token ticker
    ...
    uint256 public minTokenToSwap = 125000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 2000000 * 1e9;
    uint256 public minBuyLimit = 1000000 * 1e9;
    ...
    uint256 public liquidityFeeOnBuying = 1;
    ...
    uint256 public marketWalletFeeOnSelling = 85;
