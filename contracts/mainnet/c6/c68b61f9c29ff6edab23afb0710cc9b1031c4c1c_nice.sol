...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x7691DFdCC30119a0AA5ef5748A4b1EDB19fFFf32;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x7691DFdCC30119a0AA5ef5748A4b1EDB19fFFf32),//fund 

        address(0x7691DFdCC30119a0AA5ef5748A4b1EDB19fFFf32)//dev 
    ){
