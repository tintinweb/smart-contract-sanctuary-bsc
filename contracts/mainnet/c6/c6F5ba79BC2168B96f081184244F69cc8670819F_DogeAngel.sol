...
contract DogeAngel is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeAngel";
    string private _symbol = "DogeAngel";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCA44961dFC05078F9a66A1d90BC6b1c848A60B48); 
    address payable private teamWalletAddress = payable(0xd6Fe51060A6EaBd5A023B4980c0Dfc76FD60f73b); 
    ...
    uint256 public _maxTxAmount = 1 * 10**10 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**10 * 10**6* 10**_decimals;
