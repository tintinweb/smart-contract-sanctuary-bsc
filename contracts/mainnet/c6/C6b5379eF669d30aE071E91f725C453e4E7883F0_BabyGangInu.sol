...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02ffd1fB48ea046f74325FEC618102fAB1cD47Eb; // owner address
...
contract BabyGangInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGangInu";
    string private _symbol = "BGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1441888b07ebB6414fC4773650a234d036716f77); // Marketing Address
    address payable public teamWalletAddress = payable(0x1441888b07ebB6414fC4773650a234d036716f77); // Team Address
