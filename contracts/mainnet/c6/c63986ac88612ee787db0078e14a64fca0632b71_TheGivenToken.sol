...
interface IRouter {
    ...
    contract TheGivenToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0x374Cd93Bc2c4d96A6fA197f68F96b4E8f6f604a6;
    address private devWallet = 0x26D8C42d1769812EE1B588765918CC8b0a3556a1;
    address public charityWallet = 0x5d122D2aA90214285d8b5fcf28F8362A67f4d8fe;
    address public buybackWallet = 0x50ba97f274a2e28c0d09c06e6CBAFa5b4ccF4e6F;
    ...
    Taxes private taxes = Taxes(4, 2, 2,  2, 1);
    Taxes private sellTaxes = Taxes(4, 2, 2, 2, 1);
    ...
    constructor(address routerAdd) ERC20("The Given Token", "TGT") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        taxes = Taxes(_marketing, _charity, _buyback, _liquidity, _dev);
        require((_marketing + _charity + _buyback + _liquidity + _dev) <= 15, "Must keep fees at 15% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _charity, _buyback,_liquidity, _dev);
        require((_marketing + _charity + _buyback + _liquidity + _dev) <= 30, "Must keep fees at 30% or less");
    }
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 1_000_000, "Cannot set max wallet amount lower than 0.1% of tokens");
