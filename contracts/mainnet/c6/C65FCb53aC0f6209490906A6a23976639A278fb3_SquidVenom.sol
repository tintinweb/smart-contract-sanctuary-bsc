...
/** ----EPICALLS TEAM NEW PROJECT. Made by @epicalls LAST PROJECT 300X----

Welcome to SQUID VENOM!

Join our social channels: 
TG - https://t.me/squidvenom
TWITTER- https://twitter.com/squid_venom
WEBSITE- www.squidvenom.com
*/ 
...
/* Token contract */
contract SquidVenom is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xD0DE42968e6dE373DC027DC3750bB7a1Eb108DDc;
    ...
    // Name and symbol
    string constant _name = "SquidVenom";
    string constant _symbol = "SQUIDVENOM";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1.0% 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1.0% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2.0% 
    ...
    uint256 public swapThreshold = _totalSupply * 31 / 10123; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD0DE42968e6dE373DC027DC3750bB7a1Eb108DDc;
