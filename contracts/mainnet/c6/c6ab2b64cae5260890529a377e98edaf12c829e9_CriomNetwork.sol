...
Criom Network aims to develop and release an aritificial intelligence that it has produced for blockchain technologies,
completely for the blockchain and crypto money industry.
This artificial intelligence, created for its main purposse, develops itself synchronously with Web 3.0 technologies and compiles 
all the data it has learned algorithmically and applies it on the Criom Token.
To put it briefly, Criom Network is an experimental community and development project, and Criom Token,
on the other hand, provides project continuity by having a structure managed by an artificial intelligence,
leaving emotional factors aside and making decisions based on true-false and statistical data only.
  
  Web Sites - http://criom.network/
  Telegram  - https://t.me/CriomNetwork
...
contract CriomNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Criom Network";
    ...
    address public charityWallet = 0x76ffFEBB383F745eF55dD99ebA82A683F8ffB4C1;
