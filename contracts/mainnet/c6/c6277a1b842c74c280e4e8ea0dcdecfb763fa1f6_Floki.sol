...
/**
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
   I make this Floki--- to hand it over to the community.
   I suggest a Telegram group name for you to create: Floki---  is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract Floki  is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xF97A8304417015A73b0e8183dEED528B9de31d1E);
