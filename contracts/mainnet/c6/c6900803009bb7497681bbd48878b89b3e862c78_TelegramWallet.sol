...
/**
Telegram is planning to launch a CEX
https://watcher.guru/news/telegram-is-planning-to-build-a-crypto-exchange-and-non-custodial-wallets?utm_source=TelegramNews&utm_medium=TelegramNews&utm_campaign=TelegramNews
*/
...
contract TelegramWallet is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Telegram Wallet";
    string constant _symbol = "TGWALLET";
