...
contract BullRocket is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000000000;
    uint256 private constant swapTokensAtAmount = 7;

    uint256 public _maxWalletToken = 10000000000000;

    uint256 private _previousMaxWalletToken = _maxWalletToken;

    string private constant _name = "Bull Rocket Token";
    string private constant _symbol = "BRT";

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet =
        0xFbBB388c662261Bb56A13849bC9Ee4e814E68157;
    address private _burnWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public _rateLimit = 1 minutes;
        ...
        returns (uint256)
    {
        ...
        _tOwned[_burnWallet] = _tOwned[_burnWallet] + liquidityFee;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && airdropFlag == false) {
            require(
                _lastBuy[to] + _rateLimit < block.timestamp,
                "Are you a bot?"
            );
    ...
    function setMarketingTaxPercent(uint256 marketingFee) external onlyOwner {
