...
contract SincereTiger is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SincereTiger";
    string private _symbol = "STiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7F4c189289229aD84432fcd472F354e72e5798d); 
    address payable public teamWalletAddress = payable(0xb7F4c189289229aD84432fcd472F354e72e5798d); 
    ...
    address payable public teamWallteAddress = payable(0xb7F4c189289229aD84432fcd472F354e72e5798d); 
