...
contract BETWOLDCUP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BET WOLDCUP 2022";
    string private _symbol = "BETWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5985B77bBfCabC5Ee14CC377A6D1953262458Dba); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5985B77bBfCabC5Ee14CC377A6D1953262458Dba); // BuyBack Address
