...
contract AIBabyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIBabyDoge";
    string private _symbol = "AIBabyDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x024C5f86959E42315636Eee703c2739EEED786f8); 
    address payable private teamWalletAddress = payable(0xF2d90E8BAe7383181Be11bB45dFC98A38a7Dec0E); 
