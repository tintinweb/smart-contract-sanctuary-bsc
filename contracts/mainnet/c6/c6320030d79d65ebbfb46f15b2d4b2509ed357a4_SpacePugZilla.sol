...
contract SpacePugZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpacePugZilla"; // 
    string private constant _symbol = "$SPZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xab23206651613bdeDecabB5F9516952AE4912c49);
