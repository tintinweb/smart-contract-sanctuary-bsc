...
contract SuperBNB is ERC20 {
	...
	address public _fundAddress = address(0x90aa0aA12Ec631841e75D230B0d851CA8695fF4b);
	address public _luckAddress = address(0x12829A00AAD581AaBEd90A6d816b0210821a1B09);
    mapping(address => bool) private _isExcludedFromFees;
	mapping(address => bool) private _isBlacklist;
    mapping(address => bool) private _isBlacklistFees;
    ...
    constructor(address tokenOwner) ERC20("SuperBNB", "SuperBNB") {
        ...
        _isBlacklistFees[address(this)] = true;
        swapTokensAtAmount = total.div(50000);
        _mint(tokenOwner, total.div(10).mul(4));
		_mint(_luckAddress, total.div(10).mul(6));
	...
	function Blacklist(address account, bool excluded) public onlyOwner {
	...
	uint256 public oneTimeAmount = 5 * 10**19;
	uint256 public maxAmount = 1 * 10**20;
	...
	function changeSwapWarp(GogezillaWarp _warp) public onlyOwner {
        warp = _warp;
        _isBlacklistFees[address(warp)] = true;
    }
    ...
    function addOtherTokenPair(address _otherPair) public onlyOwner {
        _isBlacklistFees[address(_otherPair)] = true;
    } 
    ...
    function _transfer(
        ...
        require(from != address(0) && !_isBlacklist[from], "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(amount>0);

		if(_isBlacklistFees[from] || _isBlacklistFees[to]){
