...
Candyinu token meme with stealth launch for organic boost.
and an experienced team has a plan to encourage Candyinu to get the desired target.

Tokenomic:                  Telegram : @CandyInu
Max Wallet : 4%             Dev : @Barayev_Casey
Max Tax : 2%
...
contract CandyInu is IBEP20, Auth {
    ...
    string constant _name = "CandyInu";
    string constant _symbol = "CANDY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 200; //4% 
    uint256 public _maxWalletSize = (_totalSupply * 4) / 400; //4%
    ...
    address private marketingFeeReceiver = 0x5CAa8E9e731149E3331EE4ae885AB209Dc6D734B;
    address private developmentFeeReceiver = 0x74b52bE8569b98a0B2ddb027e814768Bd8E76256;
