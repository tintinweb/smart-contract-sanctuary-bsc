...
/**
    Calling all 🤖& 🧌 - Based Elon Tweet

    https://twitter.com/elonmusk/status/1602027334751571968
    
    tg: https://t.me/CallingallBots
*/
...
//Calling All Bots Contract /////////////

contract CallingAllBots is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Calling All Bots';
    string private constant _symbol = 'ElonVsBots';
    ...
    //DevWallets
    address public TeamWallet=payable(0xb2630AA391251a84731b4B22d6F491fB80E8f934);
    address public walletTwo=payable(0xd6044fDaaa252CBCAE29eDA004344F814B7C617d);
    //TestNet
