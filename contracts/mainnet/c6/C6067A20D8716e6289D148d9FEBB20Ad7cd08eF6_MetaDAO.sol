...
contract MetaDAO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC3F9B57a940cd987eBD7850609355f6C54364672);
    address payable public teamWalletAddress = payable(0xC3F9B57a940cd987eBD7850609355f6C54364672);
