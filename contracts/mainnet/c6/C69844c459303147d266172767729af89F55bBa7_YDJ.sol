...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xd073FDD6ECf1b043813ba7e382F63a4eAdCEb23B;
...
contract YDJ is AbsToken {
    constructor() AbsToken(
        ...
        address(0x9F4384F2c0847cDb9362aA57DEbE99C7FA7Ddc0D),
    
        address(0xE0Ea10d9a0319c539360fcd0C23710fE5D85C329)
    ){
