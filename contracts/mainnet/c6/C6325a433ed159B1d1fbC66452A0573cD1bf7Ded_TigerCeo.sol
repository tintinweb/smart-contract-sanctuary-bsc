...
The boss is here. And he will bring huge profits to all smart apes out there. 

HUGE FAIRLAUNCH COMING!! MARCH 2ND 18HRS EST!

✅4% tax on BNBTIGRESS rewards 
✅Hyped Fairlaunch
✅Big team and dev have mooned to 50k before

https://t.me/TigerCEOBSC
*/
...
contract TigerCeo is IERC20 {
    ...
    string constant private _name = "Tiger CEO";
    string constant private _symbol = "$TCEO";
    ...
    address payable public marketingWallet = payable(0x91a06e5ca9004919f73dec08bCAFc1a85021CDA1);
    ...
    uint256 private _maxTxAmount = (_tTotal * 30) / 1000;
    uint256 private _maxWalletSize = (_tTotal * 30) / 100;
