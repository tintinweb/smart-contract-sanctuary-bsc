...
contract ICFToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 13000000 * 10 ** 9;

    string private _name = "ICF";
    string private _symbol = "ICF";
    
    uint public _lpFee = 20;
    uint public _lqFee = 40;
    uint public _mkFee = 10;
    uint public _burnFee = 70;
    uint public totalFee = 70;
    ...
    uint public lqTxAmount = 10e9;
    uint public mkAmount;
    uint public mkTxAmount = 2e9;

    uint public sellRate = 9999;
    ...
    function setLpTxAmount(uint _lqTxAmount,uint _mkTxAmount,uint _sellRate)external onlyOwner{
    ...
    function _transfer(
        ...
        if( !ammPairs[from] && from != address(this) ){
            uint sellAbleAmount = balanceOf(from) * sellRate / 10000;
            amount = amount > sellAbleAmount ? sellAbleAmount : amount;
            require(amount > 0,"value lock");
        }
