...
/**
    ...
    ✅Baby Shiba CEO is far better than other CEOs Projects. Elon Mask named me
    CEO of Twitter. Great Marketing Campaigns. Awesome Future Plans & Strategies. 
    Audited, Safe & Renounced Contract . We will be using amount of presale 
    finalization on heavy paid marketing. So we are aiming for at least 1,000,000$ 
    Mcap on launch day and starting mcap will be 25,000$ so at least 40x on launch day🔥

    ✅TG @BabyShibaCEO_EN
    ✅Website BabyShibaCEO.com
...
contract BABYSHIBACEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x61B0965C0F77B2753938187a5cC6cb20125c16d1;

    string private constant _name = "Baby Shiba CEO";
    string private constant _symbol = "BABYSHIBACEO";
