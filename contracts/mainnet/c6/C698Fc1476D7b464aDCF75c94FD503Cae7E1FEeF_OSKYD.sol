...
contract OSKYD is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 2800 * 10 ** _decimals;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0xc97362627D558F0fdFed9374FdB8a54C64e97d11;
        devAddress = 0x9da57321a3C18edD6F67efF68FB0cFe4399e0056;
        ...
        ceoList[0xa29480CEA106e28F134252967a52806D9F512540] = true;
    ...
    function setRecieverAddress(address addr) external authorized {
