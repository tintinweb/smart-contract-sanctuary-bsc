...
contract Shikokucoin is Context, IERC20, Ownable {
    ...
    string private _symbol = "Shikoku Coin ";
    ...
    address payable private _marketingWallet = payable(0x850332aa0fc1F80f621A4fa26910A9799253fE07);
    address payable private _devWallet = payable(0xA53e1F7142E8d07c189dbddF0b67DDc010b488B9);
