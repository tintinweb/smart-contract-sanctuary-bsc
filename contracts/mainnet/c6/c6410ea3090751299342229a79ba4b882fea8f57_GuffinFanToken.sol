...
/**
 ...
 Celebrating Gubbin's love and showing gratitude for all his efforts to make us PRINT 🎲 .



 Links : 
 
 Telegram : https://t.me/GubbinFan
 Twitter : https://twitter.com/GubbinFan
...
contract GuffinFanToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GubbinFanToken";
    string constant _symbol = "Gubbin Fan";
    ...
    address public Owner=0x278dca8d144Ab1C7D4A805fF066C1eb5b30214e5; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x278dca8d144Ab1C7D4A805fF066C1eb5b30214e5;
