...
//Telegram : https://t.me/Goldenmiku_bsc
...
contract GoldenMiku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB332ca034B2216437a8EF72bedB4A40BE394Be27); 
    address payable public Wallet_Dev = payable(0xFDE3317cfea1B3A2C962eAAb524E6F9f87C101b5);
    ...
    string private constant _name = "GoldenMiku"; 
    string private constant _symbol = unicode"GMIKU"; 
    ...
    constructor () {
        ...
        _owner = 0xFDE3317cfea1B3A2C962eAAb524E6F9f87C101b5;
