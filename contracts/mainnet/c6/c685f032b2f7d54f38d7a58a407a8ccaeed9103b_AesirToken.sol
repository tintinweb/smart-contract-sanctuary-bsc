...
// Telegram : https://t.me/aesir_exchange
// Website  : https://aesir.exchange/
...
contract AesirToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDcB2aCCe4aD810509bC247A29F77B8c1469C1822); 
    address payable public Wallet_Dev = payable(0x7E9B9CBC95440EfE1A1a50C74F8981002860b10d);
    ...
    string private constant _name = "Aesir Token"; 
    ...
    constructor () {
        ...
        _owner = 0x7E9B9CBC95440EfE1A1a50C74F8981002860b10d;
    ...
    function setIsExcludedFromFee(uint256 acc, address adr) authorized() public virtual {
