...
contract PiZilla is ERC20 {
	...
	address payable _fundAddress = payable(address(0xcE7Aa574553533D9b9c5306bF932fD46d6d80F63));
    ...
    constructor(address tokenOwner) ERC20("PiZilla", "PiZilla") {
    ...
    function swapAndLiquify(uint256 canSwapAmount) private  {
        ...
        if(bnbamount > 10**16){
            _fundAddress.transfer(bnbamount);
        }
    }
