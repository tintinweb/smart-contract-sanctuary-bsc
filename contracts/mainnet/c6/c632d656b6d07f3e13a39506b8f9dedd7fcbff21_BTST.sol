...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C61B3c385096955eAA61EfBFc9D04060c97E566;
...
contract BTST is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd5912147c85D238065102EB39ba602Ee4883Da07;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Sprint";
    string private _symbol = "BTST";
