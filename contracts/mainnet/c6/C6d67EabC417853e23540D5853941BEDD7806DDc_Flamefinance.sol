...
contract Flamefinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 210 * 10**8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Flame finance";
    string private _symbol = "SHIS";
    ...
    uint256 public _maxTxAmount = 210 * 10**8 * 10**9;
