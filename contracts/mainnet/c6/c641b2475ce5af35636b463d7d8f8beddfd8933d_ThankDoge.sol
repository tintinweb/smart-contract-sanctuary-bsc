...
Hello Everyone and Welcome to ThankDoge! 

https://t.me/thankdoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2162b1Bdd446785bdCF829540861Bd7b04c63729; // owner address
...
contract ThankDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ThankDoge";
    string private _symbol = "THANKDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x719eE689f71C4b7f4C70F15de97DBd5d37138396); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6Bd0C9F27EB33e0f173f8E7F08a19b491835233); // Team Address
