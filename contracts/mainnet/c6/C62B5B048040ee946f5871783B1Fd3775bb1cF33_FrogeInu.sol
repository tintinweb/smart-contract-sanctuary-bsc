 ...
 * DO YOU MISS Frog Inu
 * DON'T MISS Froge Inu
 
 * Do you need to 100000X ?

 * BUY AND HOLD Froge Inu
 * LET'S MAKE MILLIONAIRE

contract Froge Inu is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("Froge Inu", "FGI") {}
*/
...
contract FrogeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Froge Inu";
    string constant _symbol = "FGI";
