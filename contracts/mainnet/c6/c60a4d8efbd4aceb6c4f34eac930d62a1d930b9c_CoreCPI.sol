...
contract CoreCPI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfC2479b0B4CFD46cE57A4c170feA902c3d32a707);
    address payable public Wallet_Dev = payable(0xfC2479b0B4CFD46cE57A4c170feA902c3d32a707);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**8 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "CORE CPI"; 
    string private constant _symbol = unicode"CoreCPI";
