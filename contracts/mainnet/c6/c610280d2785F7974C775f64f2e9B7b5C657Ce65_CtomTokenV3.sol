...
contract CtomTokenV3 is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 20 * (10 ** decimals()); 

    uint256 public fee = 6;
    uint256 public buybackFee = 167;   
    uint256 public marketingFee = 333;
    uint256 public dividentFee = 500;
    ...
    function _transfer(
        ...
        if(!from.isContract()) {
            ...
            require(fromBalance > 1000000000000000, "YydToken: Balance lock");
    ...
    function swapAndDistribute(uint256 amount) private {
        ...
        uint256 perAmount = swapRemainAmount.div(marketingFee.add(dividentFee));
        ...
        uint256 dividentAmount = swapRemainAmount.sub(marketingAmount);
