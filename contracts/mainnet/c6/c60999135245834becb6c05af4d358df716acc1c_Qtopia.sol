...
offering NFT holders the opportunity to get involved in the creation of a game and animation 
series and collect limited-edition real-world merchandise. Our mission is to create a one-of-a-kind experience, 
building a social metaverse and RPG game that brings people together and builds thriving communities, 
and creates meaningful connections!
https://discord.com/invite/qtopia
*/
...
contract Qtopia is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Qtopia';
    string private _symbol = 'Qtopia';
