...
/*   HAYYA INU
        swap , earn , and build on leading decentralized crypto trading protocol

        Telegram : https://t.me/Hayyainu
        Website : https://hayyainubsc.live
...
contract HAYYAINU is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "HAYYA INU"; 
    string private _symbol = "HAYYAINU";  
    ...
    */
    ...
    uint256 public _maxTxAmount = _tTotal.div(3); 
