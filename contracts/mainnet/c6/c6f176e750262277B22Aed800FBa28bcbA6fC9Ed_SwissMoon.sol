...
contract SwissMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "SwissMoon"; // 
    string private constant _symbol = "SWMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x6b24272A87639a463eD1b7Ac45aFEa25AE5B3B41;
