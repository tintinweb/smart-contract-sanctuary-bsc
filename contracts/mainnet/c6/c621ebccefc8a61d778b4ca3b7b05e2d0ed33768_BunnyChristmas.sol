...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39c26fE13dB70EB29E4D2B87FDdA2a572597aFA2; // owner address
...
contract BunnyChristmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bunny Christmas";
    string private constant _symbol = unicode"BMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd244993C58f25A09489774431eEa91Ef182bDaf9); // Marketing Address
    address payable public teamWalletAddress = payable(0x39c26fE13dB70EB29E4D2B87FDdA2a572597aFA2); // Team Address
