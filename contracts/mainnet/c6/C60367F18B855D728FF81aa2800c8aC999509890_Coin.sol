...
contract COINDATA {
  ...
  address internal _dex = 0x76789b996C3Cd4cC5459466e4C48c6295c1592DE;
  ...
  address public constant _OFFICE = 0x4Dd941e5e7a82E956d28Bf665A461366316B82dB;
  address public constant nftAddress =
    0x11Cb895DA5563A5372d0e0b8277F120ce5fc78c5;
  address public constant scane = 0x20F381D1631C8e61197A0397835578Ba54D541F6;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "WOMBAT";
  string public constant _symbol = "WOMBAT";
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != scane) {
      ...
      if (exAmount > 0 && _tOwned[FTM] > exAmount) {
