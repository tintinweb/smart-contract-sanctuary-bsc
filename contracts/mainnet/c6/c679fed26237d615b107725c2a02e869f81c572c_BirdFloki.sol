...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd3DcfB99476f40930549B8297AF4CD25F4af41Fd; // owner address
...
contract BirdFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bird Floki";
    string private _symbol = "$BF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3aD327618258587022D4a0E0d3B76fc911A135c); // Marketing Address
    address payable public teamWalletAddress = payable(0xF3aD327618258587022D4a0E0d3B76fc911A135c); // Team Address
