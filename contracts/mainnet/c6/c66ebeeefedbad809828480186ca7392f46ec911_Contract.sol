...
contract Contract is Context, IERC20 { 
    ...
    address payable public MarketingWallet = payable(0x578cEc751Aac118BB143e428277D85676A6a483F);
    ...
    function setLimit(uint256 mxwallet, uint256 mxtx) external onlyOwner {
        _maxWalletToken = mxwallet;
        _maxTransactionAmt = mxtx;
    }
