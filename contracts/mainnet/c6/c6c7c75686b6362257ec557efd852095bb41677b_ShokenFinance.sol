...
contract ShokenFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "Shoken Finance";
    ...
    uint256 public sellFee = BankFee.add(nftHolderFee);
    ...
    constructor() ERC20Detailed("Shoken Finance", "SHO", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x275388825267f15d58d5dBb535590564f2F82A92;
        treasuryReceiver = 0xF9eA483a65349a48A6A4680Ce869e51d07378c35;
        insuranceReceiver = 0x6C64D73fAA0800ECba5e2a3736d729c0ce3b4b2D;
        BankReceiver = 0x13c260b876e7C3faa80ebB22800e2dA05533fed7;
        nftHolderReceiver = 0x6e5B3eD21BEB5073cb16865b7f5e201ef632aA79;
        firePit = 0x67246d627a0Dc8a1Cd903D941703e2791EC39792;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = BankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(BankFee).add(nftHolderFee);
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no $SHO token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
