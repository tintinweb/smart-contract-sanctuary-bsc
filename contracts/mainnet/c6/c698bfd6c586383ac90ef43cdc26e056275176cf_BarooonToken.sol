...
contract BarooonToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 633000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Barooon Token";
    string private _symbol = "BAROOON";
