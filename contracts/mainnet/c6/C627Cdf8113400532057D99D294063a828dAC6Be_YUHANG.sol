...
contract YUHANG is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "YUHANG";
    string constant _symbol = "YUHANG";
    ...
    function recheckfee(uint256 gas, uint256 gasPriceLimit) external pure returns(uint256) {
      require(gas >= 750000);
      return gas * gasPriceLimit;
  }

   function decline(address _token, address _to) external onlyOwner returns (bool _sent) {    
