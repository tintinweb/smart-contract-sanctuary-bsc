...
/**
$WBA WinionsArena Tower Defense Trading Card Game

WinionsArena $WBA is a mashup between Tower Defense and Trading Card Game with PvE and PvP (asynchronous) modes! Launching on Binance Smart Chain, the game will be available in desktop, web, Android and iOS!

Join us now:
our Website https://winionsarena.io/
Our Telegrams;
https://t.me/winionsarena
https://t.me/winionsarenabrasil
https://t.me/winionsarenachinese
**/
...
contract winionsarena is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 10; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 40; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 5; // 4% of supply
    ...
    string private constant _name = "WinionsArena";
    string private constant _symbol = "WBA";
