...
/* wowoo.org Binance launch Pad- BNB Reward Token

website: https://wowoo.org
Listing 1 WOW = 1.2 USD
...
contract WOW is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x61d3E1d84b4Ec4275601Af29f227A4391F52835F); // Marketing Address
    address payable public charityAddress = payable(0x61d3E1d84b4Ec4275601Af29f227A4391F52835F); // Charity/Dev Address
    ...
    string private _name = "Wowoo Token";
