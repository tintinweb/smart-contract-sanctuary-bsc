...
Terra World (TWD) token is the native governance and utility token for the Terra World Metaverse.

Terra World is a metaverse built on the Terra Luna ecosystem designed to facilitate connections, interactions, economy, and more. Users will be able to log on to Terra World and explore the wonders of the blockchain and start their journey into their metaverse life.

An entire tokenized economy will power the infrastructure of the metaverse and allow users to play to earn and perform economic activities including transacting, designing, building, trading, gamification and so forth. This is all made possible through our Terra World (TWD) token, a native governance and utility token built on the Terra Luna blockchain.

TWD can be used to simplify wage and salary contracts between land owners and job seekers, builders, promoters, NFT artists, consumers. TWD will power the infrastructure of the metaverse by facilitating a tokenized economy.

Telegram : https://t.me/twdoffices
Website  : https://terraworld.me
...
contract TerraWorldToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88bFff5D239cd42374Ec446EC8ea3BDb31fEa91E); 
    address payable public Wallet_Dev = payable(0xf492a7A79F800965417bA844DfFce04959Ac0108);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 25**10 * 10**_decimals;
    string private constant _name = "Terra World Token"; 
    ...
    constructor () {
        ...
        _owner = 0x4108E323d4408B6Fc64219EbEcC737385b29F998;
