...
contract MiniFlokiGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x4A3f01043412608d8D4dBc069A81412BE7256D6D);
    ...
    string private constant _name = "Mini Floki Grow"; 
    string private constant _symbol = unicode"MFG"; 
    ...
    constructor () {
        ...
        _owner = 0x4A3f01043412608d8D4dBc069A81412BE7256D6D;
