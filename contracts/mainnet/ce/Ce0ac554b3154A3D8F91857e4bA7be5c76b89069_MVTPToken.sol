...
contract MVTPToken is ERC20, AccessControl {
    ...
    constructor(
        ...
        _mint(
            address(0xBd75Ce53c423Df5Dc82f42bc578CFb9AC1938237),
            9600_0000_000000000000000000 //  （9600万）
        ); //初始分配9600万
        //
        // 初始分配
        // 1. 流通 10 %（960万）
    ...
    //     require((_totalSupply + amount) <= 9600_0000_000000000000000000, "totalSupply must not be greate than 9600_0000_000000000000000000");
