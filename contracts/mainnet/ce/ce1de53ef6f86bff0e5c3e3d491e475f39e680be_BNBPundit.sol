...
contract BNBPundit is _IBEP20, ANTIBOTS {
    ...
    string _name = "BNB Pundit";
    string _symbol = "BNBPUN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 210_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAMOUNT = 210_000_000 * (10 ** _decimals);   // 100% 
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xedaC1B561033De2EC752A4cF4d3E6E702acbc687;
        marketingFeeReceiver = deployer;
        teamFeeReceiver = 0xedaC1B561033De2EC752A4cF4d3E6E702acbc687;
