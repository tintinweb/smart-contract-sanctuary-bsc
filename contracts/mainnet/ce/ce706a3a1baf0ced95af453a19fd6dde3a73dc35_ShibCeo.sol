...
contract ShibCeo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe083AB5A14fd764FbBBC67A7c626855863FC71B7); // Marketing Address
    address payable public teamWalletAddress = payable(0xF0be10b7347f4F6B1e5dD4cB4D673771261364A1); // Team Address
