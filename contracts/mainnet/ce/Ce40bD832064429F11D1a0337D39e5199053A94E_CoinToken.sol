...
contract CoinToken is Ownable, ERC20 {
    ...
    constructor(address _marketing, address _dev) ERC20("Coin Token", "CT") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CoinToken: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "CoinToken: The new dividend tracker must be owned by the deployer of the contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "CoinToken: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CoinToken: Account is already the value of 'excluded'"
        );
        feeExcluded[account] = excluded;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CoinToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CoinToken: Cannot update gasForProcessing to same value"
        );
