...
contract PIGECOLA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PIGE COLA";
    string private _symbol = "PIGE COLA";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1363153d384D0EB5A97E1b2af7E624cc3bAd3b4C
));
        marketingWalletAddress = payable(address(0x1363153d384D0EB5A97E1b2af7E624cc3bAd3b4C
));
