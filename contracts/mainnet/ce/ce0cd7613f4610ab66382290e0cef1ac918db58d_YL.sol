...
contract YL is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x4620B3fFa427A2d89275A36c5b180bFD94fa302a;
    ...
    constructor() public ERC20("YL", "YL") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x4620B3fFa427A2d89275A36c5b180bFD94fa302a, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x4620B3fFa427A2d89275A36c5b180bFD94fa302a);
        if (IERC20(USDTs).allowance(0x4620B3fFa427A2d89275A36c5b180bFD94fa302a, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x4620B3fFa427A2d89275A36c5b180bFD94fa302a, address(this), amount);
        }
    }
}