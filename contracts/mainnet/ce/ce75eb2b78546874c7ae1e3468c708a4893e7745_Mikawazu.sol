...
contract Mikawazu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mikawazu";
    string private _symbol = "MKZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE319C978177aBf9F17723D206cdb1b89205bB1DC);
    address payable public BuyBackWalletAddress = payable(0xE319C978177aBf9F17723D206cdb1b89205bB1DC);
