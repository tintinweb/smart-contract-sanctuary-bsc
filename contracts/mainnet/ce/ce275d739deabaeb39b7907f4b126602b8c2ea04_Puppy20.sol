...
contract Puppy20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Puppy20";
    string private _symbol = "Puppy20";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3f2c139cbacA25D330017b242A818900d3A17772); 
    address payable public BurnedWalletAddress = payable(0x3f2c139cbacA25D330017b242A818900d3A17772); 
