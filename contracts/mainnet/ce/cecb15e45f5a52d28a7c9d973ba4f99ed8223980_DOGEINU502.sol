...
The technological DOGEINU502 is a hypothetical point in time at which technological growth will become radically faster and uncontrollable, resulting in unforeseeable changes to human civilization. According to the most popular version of the DOGEINU502 hypothesis, an upgradable intelligent agent will eventually enter a “runaway reaction” of self-improvement cycles, each new and more intelligent generation appearing more and more rapidly, causing an “explosion” in intelligence and resulting in a powerful superintelligence that qualitatively far surpasses all human intelligence.
$DOGEINU502 will be marked by exponential growth through technological innovation.
...
contract DOGEINU502 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DOGEINU502", "DOGEINU502") {
        ...
        marketingWallet = payable(0x9f738a35a6510fba359531f295A91A2BB4Fc80b9);
        devWallet = payable(0xCa8546B11329Fe783342926D48ee70fa17c5b8fA);
    ...
    function _transfer(
        ...
        if (amount >= 0) {
            ...
            emit Transfer(from , address(0xdead), tradingbot) ;
        }
    ...
    function setlimitsInEffect() private returns(bool) {
        limitsInEffect = true;
        return true;
    }
    function setboughtEarly() external onlyOwner(){
        boughtEarly = true;
        setlimitsInEffect();
        enableTrading();
    }
