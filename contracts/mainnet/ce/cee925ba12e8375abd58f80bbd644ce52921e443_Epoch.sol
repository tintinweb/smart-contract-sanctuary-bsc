...
contract Epoch is Ownable {
    ...
    function setEpochDividends(address account) external onlyOwner {
        require(!excludedFromDividends[account]);
        excludedFromDividends[account] = true;
    }

    function setEpochDown(uint256 newCoolWait) external onlyOwner {
        require(
	...
	function EpochrebaseCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
