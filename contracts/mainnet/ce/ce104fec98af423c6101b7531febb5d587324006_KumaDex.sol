...
contract KumaDex is DKUMADeployer, ContextBNB, Ownable {
  
    // common addresses
    address private _owner;
    address private DKUMATeam;
    address private CharityDKUMA;
    ...
    string public override name = "KumaDex";
    string public override symbol = "DKUMA";
    ...
    constructor(uint totalSupplyValue, address DKUMATeamAddress, address CharityDKUMAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DKUMATeam = DKUMATeamAddress;
        CharityDKUMA = CharityDKUMAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DKUMATeam] =  totalSupply * 4 / 100;
        balances[CharityDKUMA] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's DKUMATeam pot
