...
contract Mycoin is ERC20, Ownable  {
    ...
    uint256 private _maxTradeVolume = 5000000000 * 1e18;
    uint256 private _maxWalletVolume =1000000000  * 1e18;

    address public constant marketAddress = 0x1bA1328BE793CEF400b0FD239c3Fb2916666EA6a;
    ...
    uint256 public numTokensSellToAddToLiquidity = 2000000000 * 1e18;
    ...
    constructor() ERC20("LunaDao", "LunaDao") {
    ...
    function _transfer(
        ...
        {
            require(_isTradeList[sender] || _isTradeList[recipient] || balanceOf(sender) + amount < _maxWalletVolume, "WalletVolume must be lower than _maxWalletVolume");
        }
