...
contract Plus is ERC20, Ownable {
    ...
    address public marketingWallet = 0x63b63Be6f10C5122aa7dC493F50816479cE0c51C;
    address public teamWallet = 0x96603E306Ea79C4fAFa685345C9023353acCf80f;
    address public tokenOwner = 0x74417dca1a6951A90cf37cc006639B12624A013e;

    uint256 public numTokensSellToSwap = 50000 * 1e18;

    uint256 public buyMarketingFee = 15;
    uint256 public buyLpFee = 25;
    uint256 public buyTeamFee = 9;

    uint256 public sellLpFee = 25;
    uint256 public sellMarketingFee = 15;
    uint256 public sellTeamFee = 9;

    uint256 public transferBurnFee = 5;
    ...
    constructor() ERC20("PLUS", "PLUS") {
        ...
        */
        _mint(tokenOwner, 300000000 * 1e18);
    }
    ...
    function setEnableTransfer(bool value) external onlyOwner {
        enableTransfer = value;
    }
    ...
    function _transfer(
        ...
        require(enableTransfer || _isExcludedFromFees[from], "ERC20: no transfer");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if(takeFee) {
            ...
            if(sender == uniswapV2Pair) { //buy
                feeToThis = buyMarketingFee + buyLpFee + buyTeamFee;
            } else if (recipient == uniswapV2Pair) {
                feeToThis = sellMarketingFee + sellLpFee + sellTeamFee;
            } else {
            ...
            if (feeToThis > 0) {
                uint256 feeAmount = originalAmount * feeToThis / 1000;
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalShare = buyMarketingFee + buyLpFee + buyTeamFee + sellLpFee + sellMarketingFee + sellTeamFee;
        ...
        uint256 balanceToTeam = newBalance * (buyTeamFee + sellTeamFee) / totalShare;
        IERC20(USDT).transferFrom(address(tokenReceiver), teamWallet, balanceToTeam);

        IERC20(USDT).transferFrom(address(tokenReceiver), address(this), newBalance - balanceToTeam - balanceToMarketing);
    }
