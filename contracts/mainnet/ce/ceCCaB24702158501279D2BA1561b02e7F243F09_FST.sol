...
constructor(address _contract) public payable {
    ...
    function feesInfo() public view returns
    (
    ...
    function setContractFees(uint256 hold_fee, uint256 burn_fee, uint256 liquidity_fee, uint256 dev_fee, uint256 market_fee, uint256 associate_fee) external supAccess {
        _holderFee = hold_fee;
        _burnFee = burn_fee;
