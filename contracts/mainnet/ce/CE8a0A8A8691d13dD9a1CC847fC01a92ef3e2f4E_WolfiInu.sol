...
contract WolfiInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WolfiInu";
    string constant _symbol = "Wolfi";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x12f31C5B53711cA8E47CB13690eAd5B0A56F2636;
