...
contract Kirakuya is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kirakuya";
    string private _symbol = "KIRAKUYA";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x8BdaA2c50836a871c26C807a6B7f34eA86C5c46F); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8BdaA2c50836a871c26C807a6B7f34eA86C5c46F); // BuyBack Address
