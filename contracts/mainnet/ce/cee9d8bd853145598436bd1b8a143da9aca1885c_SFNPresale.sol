...
contract SFNPresale is Context,ReentrancyGuard{
    ...
    modifier onlyAdmin(){
       require(_admin==_msgSender(),"Caller form non admin wallet.");
       _;
    }

    constructor(IERC20 token, address payable wallet, uint256 rate) public {
    ...
    function _forwardFunds(uint256 weiAmount) internal{
        _wallet.transfer(weiAmount); // transfer the bnb balance of this contract 
    }
    ...
    function endPresale() onlyAdmin public{
