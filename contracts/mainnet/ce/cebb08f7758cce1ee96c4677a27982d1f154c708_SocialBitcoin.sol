...
contract SocialBitcoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Social Bitcoin";
    string private _symbol = "SBTC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x4eA406480936C764812627d8440D06A5aDB478c1);
