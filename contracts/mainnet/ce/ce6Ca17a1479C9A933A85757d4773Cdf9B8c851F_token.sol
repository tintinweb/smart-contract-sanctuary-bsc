...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "SuperRac";
    string private _symbol = "SuperRac";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf61B3dE3B57F9f00B68bDa333e578441A8eeadeE); // Marketing Address
