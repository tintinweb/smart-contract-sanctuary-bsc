...
contract TEST is Context, IERC20 { 
    ...
    */
    ...
    address public Wallet_Multi_Sig = 0x28C842A7aa9b065248d79A346DBaf19e163a9b43;                       // Used to verify ownership transfer

    address payable public Wallet_Marketing = payable(0x451163EEA57676A16975E74CD1860DD286f7fc36);      // Marketing Wallet
    address payable public Staking_Wallet_Contract = payable(0x451163EEA57676A16975E74CD1860DD286f7fc36);   // Staking Wallet 
    address payable public Wallet_Development = payable(0xC47424998c358b43Df478bb6a65581fD8D58A57E);    // Solidity Developer
    address payable private Wallet_CakeLP = payable(0xECDa741c8327b8C63FF9f126090142d9ED0B279A);         // Auto Liquidity CakeLP Destination
    ...
    bool public swapAndLiquifyEnabled = false; // Set to true after pre-sale
    ...
    constructor () {
        ...
        Contract_Developer = 0xa41F6Cf4e0fb402fd5a6602D51C3AA165af4D449;

        _owner = 0x451163EEA57676A16975E74CD1860DD286f7fc36;
    ...
    */
    ...
    function Wallet_Update_SolidityDev(address payable wallet) external {
        ...
        emit E_Wallet_Update_SolidityDev(Wallet_Development,wallet);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Take development and Staking fee
