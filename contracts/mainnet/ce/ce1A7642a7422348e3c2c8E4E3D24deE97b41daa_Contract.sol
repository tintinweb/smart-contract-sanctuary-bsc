...
contract Contract is Context, IBEP20, Ownable{
    ...
    uint256 public _tradeMarketRatio = 4;

    uint256 public _tradeBurnRatio = 4;

    address marketingWalletAddress = 0xb1139d6A27F09b2887fe49e5e2EA533970Bda8Dd; // market wallet

    address public contractHash = 0xA7C5E331ea34C51BB9702cB209695d092EB4826E; // contract hash
