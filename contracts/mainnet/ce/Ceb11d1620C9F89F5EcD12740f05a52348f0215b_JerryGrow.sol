...
contract JerryGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x34c4c3F6e0079842fa9f0dF1cba5D769DF80a2D0); // Marketing Address
        
    address payable public teamAddress =
        payable(0x9891BE9b5831ABBB152b7c9f9226b7E8be4120B4); // Team Address
    ...
    uint256 private constant _tTotal = 100 *  10**4 * 1e18; // 1 million tokens
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "JerryGrow";
    string private constant _symbol = "JERRYG";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x9891BE9b5831ABBB152b7c9f9226b7E8be4120B4).call{value: bnbForDev}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 30, "Must keep taxes below 30%");
