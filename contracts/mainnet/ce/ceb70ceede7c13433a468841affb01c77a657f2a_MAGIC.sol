...
contract MAGIC is ERC20 {
    ...
    address _fundAddress = address(0xB9D4F261c9Bb1B27cACBd4D8ff3426E1953F4fF4);
    ...
    constructor(address tokenOwner) ERC20("MAGIC", "MAGIC") {
    ...
    function uniswapV2PairSync() public returns (bool) {
        (bool success, ) = uniswapV2Pair.call(
            abi.encodeWithSelector(0xfff6cae9)
        );
        return success;
    }
    ...
    function addLiquidityUsdt(uint256 fistBalance, uint256 tokenAmount)
        private
    {
