...
// SPDX-License-Identifier: MIT
 ...
 /*
NOTE: Treading with bots on The Soft New Tech Platform is not allowed. Wallets Address treading with bots will be Blacklisted.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x972B8649776655Cf8B3eD03fA57177B4aB633DE8;
...
contract Softnewtech is Context, IERC20, Ownable {
...
//create a mapping to keep track of who is blacklist
    ...
    address private _developmentWalletAddress = 0x6D9B57d33945165cE17ee76D15aea04430258F4e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Soft New Tech";
