...
library Address{
 ...
 contract BabyBearInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 25_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 25_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 25_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x931b9A85FAdd63b19543dc31B3A6077DD00535f6;
    address public donationWallet = 0x931b9A85FAdd63b19543dc31B3A6077DD00535f6;

    string private constant _name = "BabyBear Inu";
    string private constant _symbol = "BBRI";
    ...
    Taxes public taxes = Taxes(0, 7, 2, 1);
    Taxes public sellTaxes = Taxes(0, 4, 2, 1);
