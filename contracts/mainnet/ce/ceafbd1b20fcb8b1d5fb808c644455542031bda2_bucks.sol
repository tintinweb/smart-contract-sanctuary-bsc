...
contract bucks is Context, IERC20, Ownable {
    ...
    string private _symbol = "$15 down the drain";
    ...
    address payable public marketingWalletAddress = payable(0xc8cdA553CBC425A0cFD5Bf656A09363bc030e1AB); // Marketing Address
