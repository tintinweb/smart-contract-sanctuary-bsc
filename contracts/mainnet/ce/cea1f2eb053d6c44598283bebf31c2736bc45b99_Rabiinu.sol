...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2eFDaDbE97C5613C9bF779d376B161b09B43f34D; // owner address
...
contract Rabiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabi Inu";
    string private _symbol = "RINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2eFDaDbE97C5613C9bF779d376B161b09B43f34D); // Marketing Address
    address payable public teamWalletAddress = payable(0x2eFDaDbE97C5613C9bF779d376B161b09B43f34D); // Team Address
