...
contract BattleInfinity is ERC20, Ownable, CrossChainERC20 {
    ...
    uint256 internal totaltokensupply = 10000000000 * (10**18);
    ...
    uint256 public maxtranscation = 5000000000000000000000000;
    ...
    constructor() RouterCrossTalk(_genericHandler) public ERC20("BattleInfinity", "IBAT") AccessControl() {
