 ...
 */
contract MooncatToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "Mooncat Token";
    ...
    uint256 private _tTotal = (10**5) * _DECIMALFACTOR; // Total supply: 1 Quadrillion
    ...
    uint256 public SEND_REWARD = 1; // 1%
    uint256 public RECV_CHARGE = 2; // 2%
    uint256 public BUY_RATE = 1; // 1%
    uint256 public SELL_RATE = 20; // 2%
    uint256 public RFLX_RATE = 60; // 60% of (charge - reward)
    uint256 public BURN_RATE = 20; // 20% of (charge - reward)
    uint256 public CMTY_RATE = 20; // 20% of (charge - reward)
