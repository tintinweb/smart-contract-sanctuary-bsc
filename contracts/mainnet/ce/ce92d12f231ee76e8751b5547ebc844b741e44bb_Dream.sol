...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0xe4233AA5f3Ed5363f74a26EFC0714516Fc393767);
...
contract Dream is Ownable, IBEP20 {
    ...
    address payable public MarketingWalletAddress =
        payable(0xaE7844a5B9325d7B4Bf11EBa223f867E3b29cDD9);
    address payable public DevelopmentWalletAddress =
        payable(0xB9EEE71FfA3e50E39c377BD014b5212E93e15E22);
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**6 * 10**_decimals;
