...
contract wBNBTwo is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "wBNBTwo";
    string constant _symbol = "wBNB 2.0";
    ...
    address public marketingFeeReceiver = 0xEC1c01AA93D03F561c08efd4DBdb0eb49DfaBF27;

    IDEXRouter public router;
    address public pair;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 10000 * 300;
    bool inSwap;
