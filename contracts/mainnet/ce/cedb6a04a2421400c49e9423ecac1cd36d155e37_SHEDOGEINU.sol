...
A female version of Doge!
https://t.me/shedogeportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEb730Ec5364Fc52C4526C77E79D3c79C7c5353eC; // owner address
...
contract SHEDOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHEDOGE INU";
    string private _symbol = "SHEDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20E0328f936B5085cFdcfB1A5670c13E450B79D5); // Marketing Address
    address payable public teamWalletAddress = payable(0x20E0328f936B5085cFdcfB1A5670c13E450B79D5); // Team Address
