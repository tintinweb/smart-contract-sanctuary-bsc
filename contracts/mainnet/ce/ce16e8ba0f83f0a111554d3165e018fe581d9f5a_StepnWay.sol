...
contract StepnWay is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StepnWay";
    string private _symbol = "STPW";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xc82520CCB7D0313761ede02DBaEf17be311e5fDd);
