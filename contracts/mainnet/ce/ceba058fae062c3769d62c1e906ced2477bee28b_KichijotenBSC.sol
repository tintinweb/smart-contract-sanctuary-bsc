...
Kichijoten (吉祥天) is Japanese Buddhism’s version of the Indian goddess Lakshmi. 
She grants beauty, fertility, and happiness to her worshipers, and is sometimes included as one of the Seven Lucky Gods.
👸Following the path of the ERC20 Launch

👸https://t.me/KichijotenBSC
👸Medium: https://medium.com/@KichijotenBSC
...
👸Tg: https://t.me/KichijotenBSC
👸Web : WWW.KichijotenBSC.IO
👸Medium: https://medium.com/@KichijotenBSC
...
abstract contract ContextBinanceArt {
...
contract OwnableBinanceArt is ContextBinanceArt {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceArt: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceArt: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract KichijotenBSC is ContextBinanceArt, BinanceArt, OwnableBinanceArt {
    ...
    string private _name = 'Kichijoten';
    string private _symbol = '$Kichi';
