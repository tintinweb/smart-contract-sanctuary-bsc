...
contract TwitterInuGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twitter Inu Grow";
    string private constant _symbol = "TwitInuGrow";
