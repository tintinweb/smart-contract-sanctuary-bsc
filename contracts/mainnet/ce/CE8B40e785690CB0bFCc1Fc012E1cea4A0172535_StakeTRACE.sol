...
contract StakeTRACE {
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address DAO_WBNB = 0xFf00E422b604c3ee5161AaD64e51e9cabB6fD5aC; // DAO_WBNB pancake pool address
        IERC20 DAOTOKEN = IERC20(0xf4395E5faB0745eF81c648cDED74Ec4C48fd10AE); // DAO Token address 
