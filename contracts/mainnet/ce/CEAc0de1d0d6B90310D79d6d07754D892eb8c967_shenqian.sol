...
contract shenqian is Context, IERC20, Ownable{
    ...
    function newtokenaddress(address account) external onlyOwner() {
    ...
    function shareamount(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
   ...
   function setsupplyamount(uint256 iSupply) private pure returns(uint256, uint256) {
