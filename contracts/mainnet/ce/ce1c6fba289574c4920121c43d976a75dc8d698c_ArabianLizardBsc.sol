...
library Address{
 ...
 contract ArabianLizardBsc is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 80_000 * 10**9;
    uint256 public maxSellLimit = 40_000 * 10**9;
    uint256 public maxWalletLimit = 80_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x6350f89480662676D77CE8f291AB300D4E09bcc5;
    address public donationWallet = 0xe85D6A7381E436C969B403d6109d70D5991cafaB;

    string private constant _name = "ArabianLizardBsc";
    string private constant _symbol = "ALB";
    ...
    Taxes public taxes = Taxes(0, 7, 2, 3);
    Taxes public sellTaxes = Taxes(0, 7, 2, 3);
