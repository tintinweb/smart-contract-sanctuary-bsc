    ...
    ERC721PausableUpgradeable
{
    ...
    mapping(address => bool) excludedFromRestrict;
    ...
    function initialize()
        ...
        initializer
    {
        __ERC721_init("Nemogem Lucky Ticket", "NLT");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());

        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(PAUSER_ROLE, _msgSender());

        excludedFromRestrict[_msgSender()] = true;
    }
    ...
    function excludeFromRestrict(address[] memory addresses, bool status) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()));
        
        for (uint256 i = 0; i < addresses.length; i++) {
            excludedFromRestrict[addresses[i]] = status;
        }
    }
    ...
    function mint(address to) public virtual {
        require(
            ...
            "NLT: must have minter role to mint"
        );
    ...
    function bulkMint(address to, uint256 quantity) public {
    ...
    function pause() public virtual {
        require(
            ...
            "NLT: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "NLT: must have pauser role to unpause"
        );
        _unpause();
    }
        ...
        )
    {
        super._beforeTokenTransfer(from, to, tokenId);
        require(
            balanceOf(to) < 1 || excludedFromRestrict[to],
