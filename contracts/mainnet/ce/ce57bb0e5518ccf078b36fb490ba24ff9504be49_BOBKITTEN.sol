...
/**
BobKitten A.K.A Son of BobCat

BobCats have a kittens that are groomed for the utility in the Bob Verse
This token is refined with a max buy in order to maintain the exclusivity of the token price
and max sell to prevent jeet from destroying the chart.

renounce will be applied to make this token fully community owned.
*/
...
contract BOBKITTEN is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxSellTransactionAmount = 200000000000 * (10**18);
    ...
    function setFee(uint256 _liquidityFee, uint256 _DevFee) public onlyOwner {
        ...
        DevFee = _DevFee;
        DevWallet = payable(0xB880C53fc2bC47cd3cee93375ddb817ecA9312a3);
    ...
    constructor() ERC20("BOB KITTEN", "BOB KITTEN") {
        liquidityFee = 2;
        DevFee = 7;
