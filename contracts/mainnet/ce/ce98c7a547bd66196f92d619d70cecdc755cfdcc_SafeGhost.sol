...
contract Ownable is Context {
     ...
     * Can only be called by the current owner. community token.
     */
...
contract SafeGhost is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safe Ghost";
    string private constant _symbol = unicode"GHOST";
    uint8 private constant _decimals = 9;

    address payable public marketingWallet =
        payable(0xb095aC45f3Cc7087Fc463d3B55588726Ad03D2dd);
