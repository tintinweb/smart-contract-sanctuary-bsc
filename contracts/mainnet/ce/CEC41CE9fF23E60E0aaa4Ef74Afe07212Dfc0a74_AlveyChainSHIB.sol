...
contract AlveyChainSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlveyChainSHIB";
    string private _symbol = "wALVSHIB";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xA3cD993C9A46885A0D211eDEcAaF0fA16efdC305); 
    address payable private teamWalletAddress = payable(0x3c134823Fb2194B38527ae037Ee909159DaEFfb1); 
