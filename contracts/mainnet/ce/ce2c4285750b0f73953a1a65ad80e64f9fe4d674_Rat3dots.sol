...
abstract contract Ownable is Context {
    ...
    function setMarketingWallet(address adr) public onlyOwner {
...
contract Rat3dots is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x01e3935C38045974FC921BBf57CbEadAa48f4355; //
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _burn) external authorized {
    ...
    function updateMaxTxAmount(uint256 amount) external authorized{
        maxTxAmount = _tTotal * amount/ 1000000; // MAXTX: 1 = 0.1%/1000
    }

    function updateMaxWalletBalance(uint256 amount) external authorized{
        maxWalletAmount = _tTotal * amount / 1000000; // MAXWALLET: 1 = 0.1%/1000
    }

    function updateSwapTokensAtAmount(uint256 amount) external authorized{
        swapTokensAtAmount = _tTotal * amount / 1000000; // THRESHOLD : 1 = 0.1%/10000
    }
