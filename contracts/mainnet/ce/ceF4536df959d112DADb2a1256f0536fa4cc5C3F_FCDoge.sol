...
/**
First Football Club fully powered by crypto.
*/

// Telegram : https://t.me./FCDoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3b4d307948619B282791062A248Ec84ff3e526C9; // owner address
...
contract FCDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FC Doge";
    string private _symbol = "FCDoge";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3b4d307948619B282791062A248Ec84ff3e526C9); // Marketing Address
    address payable public teamWalletAddress = payable(0x3b4d307948619B282791062A248Ec84ff3e526C9); // Team Address
