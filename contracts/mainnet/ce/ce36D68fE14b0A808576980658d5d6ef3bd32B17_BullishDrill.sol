...
contract Bullish is ReentrancyGuard, Pausable, ERC1155Holder
{
	...
	function make_reward(address _address_token_reward, uint256 _emission_per_block, uint256 _emission_start_block_id, uint256 _emission_end_block_id, uint256 _emission_fee_rate_e6) external onlyOperator
	{
		...
		reward_token.set_chick(address_chick); // for transfer fee to chick
	}
