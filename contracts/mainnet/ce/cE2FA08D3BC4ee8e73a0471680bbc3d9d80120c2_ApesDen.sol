...
/**
Contract Name: ApesDen
https://t.me/+rLExxa0Eg2AwNzk0
*/
...
contract ApesDen is IBEP20, Auth { // NAME OF YOUR TOKEN
    ...
    string constant _name = "ApesDen"; // NAME OF YOUR TOKEN SAME AS LINE 184
    string constant _symbol = "AD"; // SYMBOL FOR TOKEN
    ...
    uint256 teamFee = 6; // TEAM/DEV FEE (DEFAULT - 0%)
    uint256 marketingFee = 2; // MARKETING FREE 
    uint256 totalFee = 10; // TOTAL OF FEES 
    uint256 feeDenominator = 100; // DEFAULT - NO NEED TO CHANGE
    
    address private marketingFeeReceiver =0x9A2abbDAf8F3C20123EDf9Eb0579648F03e559E0; // MARKETING WALLET 
    address private teamFeeReceiver =0x94ca35D66241Be5Ed5f33c104C0Cef01595AF94b; // TEAM WALLET (USE MARKETING WALLET IF NO TEAM FEES)
