...
contract Shibaxmas is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBAxmas";
    string private constant _symbol = "Sxmas";
    ...
    address payable public DonationsAddress = payable(0x092f95f62615cEA4cE582985dB3F094A088e72a0);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 4;
    uint256 private liquidityTax = 4;
    uint256 private DonationsTax =  4;
    ...
    address public DonationsWallet = 0x092f95f62615cEA4cE582985dB3F094A088e72a0;
