...
contract ARK is ERC20 {
    ...
    uint256 public walletHoldMax = 5 * 10**18;
    bool public walletHoldMaxLimitEnable = true;
    ...
    string internal tokenName = "ARK";
    string internal tokenSymbol = "ARK";
    ...
    function setWalletHoldMax(uint256 walletHoldAmount) public onlyOwner {
        walletHoldMax = walletHoldAmount;
    }

    function setwalletHoldMaxLimitEnable(bool _walletHoldMaxLimitEnable) public onlyOwner {
        walletHoldMaxLimitEnable = _walletHoldMaxLimitEnable;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && _tokenOwner != to){
            if(walletHoldMaxLimitEnable){
                require(balanceOf(to)+amount <= 5 * 10**18,"exceed maxLimit");
            }
        }
