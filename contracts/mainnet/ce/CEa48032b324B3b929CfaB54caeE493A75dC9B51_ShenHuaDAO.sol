...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 80;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x92363287F37029b9FCc9D480BCbf85A9B5192d0A;
...
contract ShenHuaDAO is AbsToken {
    constructor() AbsToken(
        ...
        address(0x5e72c7911A75cfBFD32F0d17dc18c4ED0f23961C),
    
        address(0xf51A4e55123d6b2FC9e918f59165fd7E63A19fac)
    ){
