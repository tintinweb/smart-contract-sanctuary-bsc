...
/**
Telegram : https://t.me/unicorn_ceo
Twitter  : https://twitter.com/ceo_unicorn
Website  : https://unicornceo.trade/
*/
...
contract UnicornCEO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "UNICORN CEO";
    string private _symbol = "UNICEO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0609e550488009783C36f2EBb153Cec3Ce997eB0);
