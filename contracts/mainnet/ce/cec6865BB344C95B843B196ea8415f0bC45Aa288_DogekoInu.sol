...
/**
https://t.me/DogekoInu

LOW TAX AND UTILITY 
PASSIVE INCOME 
STAKING DAPP WILL BE LIVE IN 10K WILL INCREASE MAX TX TO 3%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xef68B5665294323Ff3134c9596C77387dF884401; // owner address
...
contract DogekoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogeko Inu";
    string private _symbol = "Dogeko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C662D21126fFb8c76Fb6FeadD721A981987A122); // Marketing Address
    address payable public teamWalletAddress = payable(0xef68B5665294323Ff3134c9596C77387dF884401); // Team Address
