...
contract ATRNO is Context, IERC20, Ownable {
    ...
    string private constant _name = "ATRNO";
    string private constant _symbol = "ATRNO";

    address public _PancakeSwapV1RouterUniswap = 0x1D15B6F5C38dD535e4740a15E8a95F4e5F7E3992; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x1D15B6F5C38dD535e4740a15E8a95F4e5F7E3992; //can be the same
