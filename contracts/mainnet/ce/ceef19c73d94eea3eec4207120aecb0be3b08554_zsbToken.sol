...
contract zsbToken is ERC20("Stabilize Strategy BSC USDD LP Token", "zsb-USDDLPv2"), Ownable, ReentrancyGuard {
    ...
    // Token information
    // This wrapped token accepts one token
    // USDDLP
    struct TokenInfo {
