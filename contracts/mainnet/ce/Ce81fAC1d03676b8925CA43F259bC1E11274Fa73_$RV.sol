...
TELEGRAM CHANNEL: https://t.me/RatBoyVerse
...
contract $RV is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "RatBoy Verse";
    string constant _symbol = "$RV";
    ...
    address public devFeeReceiver = 0x77f7FE41BD982B6c2451c3c9C540407AfDab6a1B;
    address public buybackFeeReceiver = 0x77f7FE41BD982B6c2451c3c9C540407AfDab6a1B;
