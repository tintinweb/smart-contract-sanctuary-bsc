...
contract PlanetRouter {
    ...
    function swapExactTokensForTokensThenStableSwap(
        ...
        stablesReceived = StableSwap(stableSwapPool).exchange(stableSwapPoolData[0], stableSwapPoolData[1], tokensReceived, stableSwapPoolData[2], to);
    ...
    function StableSwapExactTokensThenSwapTokensForTokens(
        ...
        _approveTokenIfNeeded(StableSwap(stableSwapPool).get_coins(stableSwapPoolData[0]), stableSwapPool);
        uint256 stablesReceived = StableSwap(stableSwapPool).exchange(stableSwapPoolData[0], stableSwapPoolData[1], amountIn, stableSwapPoolData[2], address(this));
        ...
        returns (uint256 stableReceived)
    {
        ...
        _approveTokenIfNeeded(path[lastIndex], stableSwapPool);
        stableReceived = StableSwap(stableSwapPool).exchange(stableSwapPoolData[0], stableSwapPoolData[1], tokensReceived, stableSwapPoolData[2], to);
    }
    ...
    {
        _approveTokenIfNeeded(StableSwap(stableSwapPool).get_coins(stableSwapPoolData[0]), stableSwapPool);
        stablesReceived = StableSwap(stableSwapPool).exchange(stableSwapPoolData[0], stableSwapPoolData[1], amountIn, stableSwapPoolData[2], address(this));
