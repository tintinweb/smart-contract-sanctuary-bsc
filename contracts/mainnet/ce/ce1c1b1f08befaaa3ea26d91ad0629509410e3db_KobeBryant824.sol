...
/**
   #Kobe Bryant 8 24 The New Community of Ape Token
    
   I make this #Kobe Bryant 8 24 to hand it over to the community.
   I suggest a Telegram group name for you to create: Kobe Bryant 8 24 is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/KobeBryant8_24
...
contract KobeBryant824 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kobe Bryant 8-24";
    string private constant _symbol = "MAMBA_8_24";
    ...
    address private marketingWallet = address(0xb0a617b99f72884a12fba814adceB8C44Ff974A2);
