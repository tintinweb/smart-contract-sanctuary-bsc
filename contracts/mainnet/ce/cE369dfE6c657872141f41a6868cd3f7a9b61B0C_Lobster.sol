...
contract Lobster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lobster";
    string private _symbol = "Lobster";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x67158bEf4c7515D3f0305B5532791480B6b111cc);
    address payable public teamWalletAddress = payable(0x7B991FCbd4Ac5848D92a60eF0A3173b4007454Cd);
    ...
    function blacklist_Switch(bool IsFlag) public onlyOwner {
        noBlackList = IsFlag;
    } 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
			if (noBlackList){
				require(!_isBlacklisted[sender] && !_isBlacklisted[recipient], "This address is blacklisted. Transaction reverted.");
			}
