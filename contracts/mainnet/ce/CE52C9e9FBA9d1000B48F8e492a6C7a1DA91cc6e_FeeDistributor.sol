...
contract FeeDistributor is Ownable {
    ...
    function setBuyFees(uint[] memory _fees) external onlyTokenOwner {
    ...
    function setSellFees(uint[] memory _fees) external onlyTokenOwner {
    ...
    function _dividend(uint _amount) internal returns (bool) {
        ...
        require (success, "failed sending to dividend tracker");
    ...
    function addReservedFee(uint _buyFee, uint _sellFee, address _wallet) external onlyTokenOwner {
