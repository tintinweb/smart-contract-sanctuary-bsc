...
contract Shengweitu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shengweitu";
    string private _symbol = "Shengweitu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8189072d3aCa144Bc0D81a67f4601418A2c84D4C); 
    ...
    constructor () {
        ...
        emit Transfer(address(0x2270a31Ddb65151Df596F054Bc52b3D6Bb0Cf1c1), _msgSender(), _totalSupply);
    }
