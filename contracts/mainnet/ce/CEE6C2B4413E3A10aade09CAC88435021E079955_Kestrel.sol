...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb1FaF58589e042e656748C6B8BF3889148a35fA9;
...
contract Kestrel is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb1FaF58589e042e656748C6B8BF3889148a35fA9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kestrel";
    string private _symbol = "KSRL";
