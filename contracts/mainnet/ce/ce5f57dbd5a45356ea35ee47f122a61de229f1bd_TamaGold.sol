...
contract TamaGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tama Gold";
    string private _symbol = "TAMAGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4651d1019C1D74e36dF122644166320C655344B6);
    address payable public BuyBackWalletAddress = payable(0x4651d1019C1D74e36dF122644166320C655344B6);
