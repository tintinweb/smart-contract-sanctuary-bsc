...
contract TokenClaimV2 is Pausable, Ownable, ReentrancyGuard {
    ...
    function withdrawFundedToken() external onlyOwner {
     ...
     */
    function setWhitelist(address[] calldata addrs, uint256[] calldata amounts) external onlyOwner {
    ...
    function getUnlockedTokenAmount(address addr, uint256 totalFundedAmount) private view returns (uint256) {
        ...
        uint256 lockedAmount = totalFundedAmount;
