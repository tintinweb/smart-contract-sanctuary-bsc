...
contract PancakeGirlInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pancake Girl Inu"; //
    string private constant _symbol = "PGI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x75C17B3389F4B6FaE5870aC1d127B579Fec3CefF;
