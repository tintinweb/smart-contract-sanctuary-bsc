...
███████║███████╗██║  ██║ ╚████╔╝ ╚██████╗╚██████╔╝██║██║ ╚████║
╚══════╝╚══════╝╚═╝  ╚═╝  ╚═══╝   ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝
https://t.me/slavcoinbsc
LET US GOPNIKS SHOW BSC HOW WE CAN SQUAT THE REAL SLAV WAY...
*/
...
contract SLAVCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "SlavCoin"; // 
    string private constant _symbol = "CCCP"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 49;
    uint256 public _liquidityFee = 50;
    address public _marketingWallet = 0x0017b18a0f16ae3241F58d63e2D57Dc8bEbA23A0;
