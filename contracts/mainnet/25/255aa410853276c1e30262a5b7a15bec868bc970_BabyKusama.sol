...
/*
  Baby Kusama token is inspired by Kusama token and will build a strong ecosystem going forth.

  website: https://kusama.network/
  Telegram: https://t.me/Kusamaofficialchat_en
...
contract BEP20 is Context {
  ...
  address public constant _pancakeRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    //0x10ED43C718714eb63d5aA57B78B54704E256024E; 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
...
contract BabyKusama is BEP20, IERC20 {
  mapping(address => uint256) private _tOwned;
  mapping(address => mapping(address => uint256)) private _allowances;

  uint256 private constant MAX = ~uint256(0);

  string public name =/*TOKENNAME*/"Baby Kusama"/*TOKENNAME*/;
  string public symbol =/*TOKENSYMBOL*/"BKSM"/*TOKENSYMBOL*/;
