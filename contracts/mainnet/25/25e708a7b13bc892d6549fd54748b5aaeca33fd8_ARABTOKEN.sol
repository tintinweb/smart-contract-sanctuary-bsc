...
contract ARABTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x444233B074C2E879EBa95e56bd1b09d58bbe6bd2);

    address payable public teamAddress =
    payable(0x5B2d4f877B6e39544FaE4e97a80477820a8Bb271);

    address payable public liquidityAddress =
    payable(0xd86Aa64A7004B0715542D9eF6eBD78D9c7cefB70);
    ...
    string private constant _name = "Arabian Token";
