...
contract FoolsCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FoolsCat";
    string private _symbol = "FCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDB81AD454fd59fb06D20Eb0fe699e10Ac0875505); 
    address payable public teamWalletAddress = payable(0x47371C242C589c4eBe01E99d5212c7305Db71b83); 
