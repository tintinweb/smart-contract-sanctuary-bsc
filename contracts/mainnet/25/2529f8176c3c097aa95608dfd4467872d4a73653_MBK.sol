...
contract MBK is ERC20Detailed, Ownable {
    ...
    uint256 public inviterMinHoldAmount = 1000 * 10 ** DECIMALS;
    uint256 public MinAirdropAmount = 10 * 10 ** DECIMALS;
    ...
    uint256 private constant MAX_SUPPLY = 10**15 * 10**DECIMALS;
    uint256 private constant MIN_SUPPLY = 10**8 * 10**DECIMALS; 
