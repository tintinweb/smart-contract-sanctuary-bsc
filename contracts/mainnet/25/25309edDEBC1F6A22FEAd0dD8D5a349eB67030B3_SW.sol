...
contract SW is IERC20, Ownable {
    ...
    constructor() {
        ...
        _rOwned[0x08E7619563574E9fb311252f39408407813aeE73] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0x08E7619563574E9fb311252f39408407813aeE73] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = msg.sender;
        emit Transfer(address(0),0x08E7619563574E9fb311252f39408407813aeE73, _tTotal);
    }
