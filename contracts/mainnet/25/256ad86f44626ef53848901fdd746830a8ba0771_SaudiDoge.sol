...
Its time for the bull market to make its comeback. 

Tokens are beggining to do well again, BSC is seeing more and more diamond hands and they are being rewarded.
Its time we continue this growth, dont be afraid to hold, find that solid utility and token, hold and work as one.
This is one of them, this utility can deliver, they just need investor support. Let the chart breathe, hodl that bag and lets start changing BSC for the better.

Remember back to the good old days of not so long ago.
...
contract SaudiDoge is IBEP20, Auth {
    ...
    string constant _symbol = "SAUDIDOGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0f64d6f53817A6a595b8EdB547205b628f38a174;
