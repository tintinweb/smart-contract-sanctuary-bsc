...
Mrs. Cheems has been pushing ATH after ATH,
so hopefully these couple can move in the same direction!
Well known Cheems now working together as a couple!
Meet us! 
MrsMrCheems
MrsMrCheems
MrsMrCheems
...
contract MrsMrCheems is Context, IERC20, Ownable {
    ...
    string private _name = "MrsMrCheems";
    string private _symbol = "Mrs&MrCheems";
