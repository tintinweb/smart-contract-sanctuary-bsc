...
contract AIBERTAINSTEIN is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0xC1e6706B575AeA14cb845871308Ec49a260A2769; 

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "AIBERTAINSTEIN";
    string constant _symbol = "AIAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    
    //max transaction amount: 20%
    uint256 public _maxTxAmount = _totalSupply * 20 / 100;

    //max wallet amount: 20%
