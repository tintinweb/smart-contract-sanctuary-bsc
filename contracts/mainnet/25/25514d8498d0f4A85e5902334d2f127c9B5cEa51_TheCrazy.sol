...
contract TheCrazy is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Crazy"; //
    string private constant _symbol = "LOCO"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xdF42215A294d7A5F837CF581De8EF90ee301471f;
