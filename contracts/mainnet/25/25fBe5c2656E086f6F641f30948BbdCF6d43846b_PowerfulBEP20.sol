...
// File: contracts/token/BEP20/lib/IBERC1363.sol
...
/**
 * @title IBERC1363 Interface
 * @dev Interface for a Payable Token contract as defined in
 *  https://eips.ethereum.org/EIPS/eip-1363
 */
interface IBERC1363 is IBEP20, IERC165 {
    /**
...
// File: contracts/token/BEP20/lib/BERC1363.sol
...
/**
 * @title IBERC1363
 * @dev Implementation of the {IBERC1363} interface
 */
abstract contract BERC1363 is BEP20, IBERC1363, ERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == type(IBERC1363).interfaceId || super.supportsInterface(interfaceId);
    }
 ...
 */
contract PowerfulBEP20 is BEP20Capped, BEP20Mintable, BEP20Burnable, BERC1363, TokenRecover, Roles, ServicePayer {
    constructor(
        string memory name_,
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControl, BERC1363)
        returns (bool)
    {
