...
contract MEGNUSH is Context, BEP20, Ownable {
    ...
    string private _name = "MEGNUSH";
    string private _symbol = "MEGNUSH";
    ...
    uint256 public _maxTxAmount = 900000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 900000000000000000 * 10**18;
