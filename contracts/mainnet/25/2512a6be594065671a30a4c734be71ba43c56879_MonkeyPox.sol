...
/**
 ...
 Find us at https://t.me/BoredMonkeypoxYachtClub

 The contract will be renounced once LP is set up and the contract is set to the community standard.  Low taxes 5% in and 9% out.
 Auto LP builder with LP to be locked in higher lengths the larger the market cap grows.  This is to provide security to the community.
 2% refections that are currently wrapped eth.  Let's see how far we can take this to help everyone around us.  WAGMI
...
contract MonkeyPox is IBEP20, Auth {
    ...
    string constant _name = "BoredMonkey";
