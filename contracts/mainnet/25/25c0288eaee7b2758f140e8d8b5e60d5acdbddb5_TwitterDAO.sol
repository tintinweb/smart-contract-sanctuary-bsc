...
contract TwitterDAO is Context, IERC20, Ownable {
    ...
    string private _symbol = "TwitterDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCfC0b18780160e326f22Df796c304da7c7aEfCD0);
    address payable public teamWalletAddress = payable(0x0C22840d2bB4c99b0bc3ed0aE93df50b51D3d5c5);
