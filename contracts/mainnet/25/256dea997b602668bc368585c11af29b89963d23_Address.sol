...
contract DEEP is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3B80f40C202753C025BBea1720E5d106eC4a35DD); 
    address payable public Wallet_Dev = payable(0x3B80f40C202753C025BBea1720E5d106eC4a35DD);
    address payable public constant Wallet_Burn = payable(0x3B80f40C202753C025BBea1720E5d106eC4a35DD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "DEEP Token"; 
