...
interface ERC20 {
    ...
    function burn(address _msgSender, address account, uint256 amount) external returns (bool);
...
contract Token {
    ...
    function burn(address _spender, uint _value) public returns (bool) {
        ...
        return ERC20(_lower_address).burn(msg.sender, _spender, _value);
    }
...
contract BEP20 is Token {
    constructor (address l_addr, address owner_) {
        setAddress(l_addr);
