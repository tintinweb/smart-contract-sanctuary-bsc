...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _fundRate2 = 25;
    uint256 public _fundRate3 = 25;
    ...
    function batchAddLpProvider(address[] memory adrs) public onlyOwner {
        uint256 len = adrs.length;
        for (uint256 i; i < len;) {
            _addLpProvider(adrs[i]);
        unchecked{
            ++i;
        }
        }
    ...
    function processLP(uint256 gas) private {
        ...
        uint256 perDividendAmount = lpRewardCondition / shareholderCount;
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            pairBalance = balanceOf(shareHolder);
            if (pairBalance >= holdCondition && !excludeLpProvider[shareHolder]) {
                token.transfer(shareHolder, perDividendAmount);
            }
...
contract A6 is AbsToken {
    constructor() AbsToken(
        ...
        18,
        6868,
        address(0x3BC9ACe7Ae405A067033e9Ea4EAc304147c271BD),
        address(0x88d650D7b3cc69510754C77EF2000eF998AacA90),
        address(0x88d650D7b3cc69510754C77EF2000eF998AacA90),
