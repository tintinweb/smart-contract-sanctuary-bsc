...
contract DeGods is Context, IERC20, Ownable {
    ...
    string private constant _name = "DeGods";
    string private constant _symbol = "DGods";

    address public _PancakeSwapV1RouterUniswap = 0xA946B3d1d94a2D5721A13ddAa1d8Cf4FD41aeAeA; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xA946B3d1d94a2D5721A13ddAa1d8Cf4FD41aeAeA; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x95eDC610385D645Ae4b4AA5dF6331Ca848227E8d)] = true; //uniswap router liquidity
