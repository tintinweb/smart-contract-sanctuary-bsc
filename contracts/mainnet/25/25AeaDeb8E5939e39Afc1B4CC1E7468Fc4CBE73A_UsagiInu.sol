...
/**
    ...
    Usagi Inu inspired by the combination of Japan and China 
    Rabbit born with ninja concept to celebrate Chinese New Year.

  Telegram  : https://t.me/UsagiOfficial
  Twitter   : https://twitter.com/UsagiInubsc
*/
...
contract UsagiInu is Context, IERC20 { 
    ...
    */
    ...
    Wallet_RABBIT: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_RABBIT = payable(0x323Ca37a305Da5Af24e199e0aC8dcEA318a0A46e); 
    address payable public Wallet_LP = payable(0x323Ca37a305Da5Af24e199e0aC8dcEA318a0A46e);
    address payable public Wallet_Tokens = payable(0x323Ca37a305Da5Af24e199e0aC8dcEA318a0A46e); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000000**1 * 10**_decimals;
    uint256 private OriginalSupply = _tTotal;
    string private constant _name = "Usagi Inu"; 
    ...
    uint256 public Percent_RABBIT = 90;
    ...
    uint256 public constant _Tax_On_Buy_MAX = 100; 
    uint256 public constant _Tax_On_Sell_MAX = 100;
    ...
    constructor () {
        ...
        _owner = 0x323Ca37a305Da5Af24e199e0aC8dcEA318a0A46e;
        ...
        */
        ...
        _isLimitExempt[Wallet_RABBIT] = true; 
        ...
        _isExcludedFromFee[Wallet_RABBIT] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 RABBIT_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((RABBIT_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_RABBIT = RABBIT_Wallet;
    ...
    */
    ...
    //Update the RABBIT wallet
    event updatedRABBITWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_RABBIT(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedRABBITWallet(Wallet_RABBIT,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_RABBIT] = false; 

        Wallet_RABBIT = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_RABBIT != 0){

            // Calculate how many tokens need to be swapped for BNB (RABBIT BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_RABBIT / 100;
            ...
            uint256 split_M = Percent_RABBIT * 100 / (Percent_AutoLP + Percent_RABBIT);
            ...
            // Send BNB to RABBIT wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_RABBIT, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_RABBIT != 0){

            // Swap tokens for BNB and send to RABBIT Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_RABBIT / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_RABBIT, BNB_M);
            ...
            // Create the Auto LP if RABBIT is 0
