...
contract REXApp is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
       ...
       uint256 _emergencyWithdrawFees
        ...
        pooldata[30].returnPer = 36700; // 367%

        //90 days
        pooldata[90].lockupDuration = 90;
        pooldata[90].returnPer = 54800; // 548%

        //180 days

        pooldata[180].lockupDuration = 180;
        pooldata[180].returnPer = 77300; // 773%

        //365 days
        pooldata[365].lockupDuration = 365;
        pooldata[365].returnPer = 98800; // 988%
    ...
    function setEmergencyWithdrawalFees(uint256 _emergencyWithdrawFees) external onlyOwner {
        ...
        require(_emergencyWithdrawFees <= 90, "Can't set higher than 90%");
        emergencyWithdrawFees = _emergencyWithdrawFees;
    }
