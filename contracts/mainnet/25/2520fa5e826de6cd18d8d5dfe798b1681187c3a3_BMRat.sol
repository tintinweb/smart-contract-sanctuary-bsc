...
contract BMRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bill Murray Rat";
    string private _symbol = "BMRat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39eCa701F828b31001ef8e604a9CC02d12eB57aE);
    address payable public BuyBackWalletAddress = payable(0x39eCa701F828b31001ef8e604a9CC02d12eB57aE);
    ...
    uint256 public _walletMax = 100000 * 10**9;
