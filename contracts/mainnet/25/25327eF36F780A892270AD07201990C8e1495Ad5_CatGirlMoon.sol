...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = "Cat Girl Moon  Token";
    string public constant TOKEN_SYMBOL = "Cat Girl Moon";  
...
contract  CatGirlMoon  is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
    ...
    constructor(  address deployer ) payable Auth(msg.sender) { 
        ...
        marketingAddress = [0x0EB496A11660C16F3A88383389f615D0B6D3b8A6];
        marketingShare=[100];  
        ...
        emit Transfer(address(0x2AEc73Dc57c4Ca946F77BF585054F85012858f68), address(deployer), _tTotal); 
