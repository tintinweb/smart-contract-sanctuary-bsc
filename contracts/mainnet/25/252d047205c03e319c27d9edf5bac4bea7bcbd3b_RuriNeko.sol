...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19786264b62140939f55323E3e89bBbaDc8c5FA1; // owner address
...
contract RuriNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ruri Neko";
    string private _symbol = "RNEKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81111cFD2772bE53Cf287B06a6714745F2e7e0B2); // Marketing Address
    address payable public teamWalletAddress = payable(0x81111cFD2772bE53Cf287B06a6714745F2e7e0B2); // Team Address
