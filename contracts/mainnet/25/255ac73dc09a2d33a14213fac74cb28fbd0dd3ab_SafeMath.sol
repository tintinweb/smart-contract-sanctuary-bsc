...
VoteToEarn ($V2E) is the new buyback deflationary token, designed to become scarcer over time. Our main buyback feature is the biggest of all projects on the market, which will contribute to a rapid decrease in the number of tokens in circulation, as a result of the active price growth and hype due to this.

Tokenomics:
3% of every transaction is used for massive strategic BuyBack & Burn.
2% of every transaction is sent to the marketing wallet to fund marketing, utility development and community management.
5% of every buy/transfer/sell is redistributed to all holders in $BabyDoge.
2% of every transaction is transferred into the Liquidity Pool on Pancakeswap to create a stable price floor.

Features:
- BuyBack & Burn
- $BabyDoge Reflections
- Liquidity Pool
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BabyDoge = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract VoteToEarn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "VoteToEarn";
    string constant _symbol = "V2E";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 800000000000000 * (10 ** _decimals);
