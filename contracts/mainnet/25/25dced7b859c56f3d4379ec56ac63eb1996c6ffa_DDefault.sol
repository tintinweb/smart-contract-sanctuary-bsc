...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Peaceful Inu";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1998D64600FD17FAc8240A567556EFCCd55950E7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xaa7362cBc5f5c93C67aE289c61c90776aF1EE9e3); // BuyBack Address
