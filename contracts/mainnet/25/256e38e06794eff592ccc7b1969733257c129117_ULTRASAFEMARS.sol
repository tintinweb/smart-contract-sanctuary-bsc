...
/**
ULTRASAFEMARS
Safe Degen Play - Launched by @Specialkira & @LetsFuckingGoGoGo
*/
...
contract ULTRASAFEMARS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xC2361Ae24B1f89001d9F8FA5D08626c6562661AB));
    address payable public devWallet =
        payable(address(0xa32F977b7C4DcFEDb3e26660b5D7EFf2309BD239));
    address public liquidityReceiver =
        0xa32F977b7C4DcFEDb3e26660b5D7EFf2309BD239;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "ULTRASAFEMARS";
    string private _symbol = "uMARS";
