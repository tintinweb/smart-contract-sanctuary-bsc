...
contract CrossTokenHub {
    ...
    function transferIn(bytes32 tid, address contractAddr, address payable recipient, uint amount) public onlyOwner {
        _transferIn(tid, contractAddr, recipient, amount);
    }

    function _transferIn(bytes32 tid, address contractAddr, address payable recipient, uint amount) internal {
