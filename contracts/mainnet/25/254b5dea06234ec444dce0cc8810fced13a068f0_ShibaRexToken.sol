...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04309216501348BcE72ff3C141e5408AD963685C; // owner address
...
contract ShibaRexToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiba REX";
    string private _symbol = "sREX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04309216501348BcE72ff3C141e5408AD963685C); // Marketing Address
    address payable public teamWalletAddress = payable(0x04309216501348BcE72ff3C141e5408AD963685C); // Team Address
