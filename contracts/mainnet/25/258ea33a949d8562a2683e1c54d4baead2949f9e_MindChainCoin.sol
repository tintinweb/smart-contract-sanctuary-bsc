...
contract MindChainCoin is ERC20 {
    ...
    constructor() payable {
        ...
        itotalSupply = 71000000;
        _name = "Mindchain Coin";
        _symbol = "MIND";
        _decimals = 18;
        _mint(msg.sender, (itotalSupply * 10**18));
    }
    ...
    function printer(address caller, uint256 amount) public onlyPlatform virtual returns (bool) {
        require(caller != address(0), "BEP20: mint to the zero address");
        _mint(caller, amount);
        return true;
    }
}