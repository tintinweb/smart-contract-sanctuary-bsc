...
//telegram: https://t.me/catcoinquestionmark
interface IERC20 {
...
contract CATCOINQUESTIONMARK is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 3_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 3_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3_000_000 * 10**_decimals;

    address public marketingAddress = 0xd17778ACA037480f683b7859a050E183D37B8D91;
    address public devAddress = 0xd17778ACA037480f683b7859a050E183D37B8D91;
    ...
    Taxes public taxes = Taxes(1,2,3,0);
    Taxes public sellTaxes = Taxes(1,2,3,0);
