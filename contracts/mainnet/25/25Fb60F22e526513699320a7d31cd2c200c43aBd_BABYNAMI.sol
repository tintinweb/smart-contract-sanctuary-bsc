...
contract BABYNAMI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x06c264AA91222AD2aD810417B1D6fC9F58BE8D63); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x06c264AA91222AD2aD810417B1D6fC9F58BE8D63); // BuyBack Address
    ...
    uint256 public _walletMax = 3 * 10**12 * 10**9;
