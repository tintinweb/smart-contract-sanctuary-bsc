...
contract $bPRO is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 1000; // 2%
    uint256 public _walletMax = _totalSupply * 2 / 1000; //2% 
    ...
    string constant _name = "Baby Prodev Inu";
    string constant _symbol = "$bPRO";
