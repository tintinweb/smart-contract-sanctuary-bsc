...
/**
#OB The Old Doge COIN 
  BACK TO THE OLD DAYS OF Doge COIN,CAN U HOLD IT FOR 10000X?    
  Initial LP:2 BNB
  LOW TAX:2/2
  OWNERSHIP RENOUNCED
https://t.me/oldDogecoin
*/
...
contract OD is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3B25c999a77E8Aa63eb025EEA7aa6d9b2e8A5D3B); 
    address payable public teamWalletAddress = payable(0x3B25c999a77E8Aa63eb025EEA7aa6d9b2e8A5D3B); 
