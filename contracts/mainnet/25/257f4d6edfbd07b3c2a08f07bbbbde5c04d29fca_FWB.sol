...
contract FWB is Context, IERC20, Ownable {
    ...
    string private _name = "FWB";
    string private _symbol = "FWB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc69F67356e7cb1243F0B8e54519B6FE10adC3725); // Marketing Address
    address payable public teamWalletAddress = payable(0xc69F67356e7cb1243F0B8e54519B6FE10adC3725); // Team Address
