...
abstract contract ContextBEP20Armada {
...
contract OwnableBEP20Armada is ContextBEP20Armada {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20Armada: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20Armada: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ArmadaAIToken is ContextBEP20Armada, BEP20Armada, OwnableBEP20Armada {
    ...
    string private _name = 'Armada AI';
    string private _symbol = 'Armada AI';
