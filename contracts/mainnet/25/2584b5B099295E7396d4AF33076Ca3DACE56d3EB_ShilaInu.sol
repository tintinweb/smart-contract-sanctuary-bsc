...
contract ShilaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB517F2AC3DAf254D9f53F47aB6D05136f371b0e3); 
    address payable public Dev_Wallet = payable(0xa636a7B77AF35d5B3C28eBFE0A1fB1B1F7920AeD);
    ...
    constructor (
        ...
        _owner = 0xa636a7B77AF35d5B3C28eBFE0A1fB1B1F7920AeD;
