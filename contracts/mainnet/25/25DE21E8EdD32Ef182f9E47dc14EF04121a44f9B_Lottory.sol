...
contract Lottory is Context, Ownable , ReentrancyGuard  {
   ...
   address public dev = 0xB3e5190136d6b908e2E95f5E01feA16bC191DCA5;
   address public miner = 0xD76dBa4b47C5DE9E4C32e3FA29806fBc085F1931;
...
// lotto 1 
    ...
    function pickWinner_lotto1() public{
        ...
        require(time1Id[1].timestamp <= block.timestamp);
          ...
          uint256 TrexBusdFee = SafeMath.div(SafeMath.mul(lotto1Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,TrexBusdFee);
          uint256 userReward = SafeMath.sub(lotto1Balance,totalFee);
          BusdInterface.transfer(dev,devFee);
          BusdInterface.transfer(miner,TrexBusdFee);
    ...
    function pickWinner_lotto2() public{
        ...
        require(time1Id[2].timestamp <= block.timestamp);
          ...
          uint256 TrexBusdFee = SafeMath.div(SafeMath.mul(lotto2Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,TrexBusdFee);
  ...
  if (players3[i]==ad){
    ...
    function pickWinner_lotto3() public{
        ...
        require(time1Id[3].timestamp <= block.timestamp);
          ...
          uint256 TrexBusdFee = SafeMath.div(SafeMath.mul(lotto3Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,TrexBusdFee);
