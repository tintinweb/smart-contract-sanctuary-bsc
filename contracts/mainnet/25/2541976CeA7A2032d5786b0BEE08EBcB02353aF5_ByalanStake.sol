...
contract ByalanStake is ByalanIsland, Sailor, IByalan {
    ...
    constructor(
        ...
        address _harvester,
        address _want
    ) ByalanIsland(_hydra, address(0), _izlude, _kswFeeRecipient, _treasuryFeeRecipient, _harvester) {
        want = _want;
    }
    ...
    function balanceOfMasterChef() external pure override returns (uint256) {
        return 0;
    }
