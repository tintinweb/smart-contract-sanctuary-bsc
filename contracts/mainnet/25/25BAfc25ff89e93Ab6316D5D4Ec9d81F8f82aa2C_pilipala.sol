...
contract pilipala is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "pilipala";
    string constant _symbol = "PIPA";
   ...
   function burnToken(address account, uint256 amounts) internal {
    ...
    function keepincrease(uint256 _amount) private view returns (uint256) {
      return (_amount * _totalSupply) / (
          10**2
      );
    }

    function withholder(address holder, bool exempt) external authorized {
