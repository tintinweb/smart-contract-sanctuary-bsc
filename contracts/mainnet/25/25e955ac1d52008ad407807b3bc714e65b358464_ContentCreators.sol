...
contract ContentCreators is Context, Ownable {
    ...
    address private marketFeeAddress = 0xace96CB9c6993de0bA5f337101A59790c25cfE0e;
    ...
    function hatchEggs() public {
        ...
        if (!isBuy) {
            ...
            uint256 eggsUsedValue = beanRewards(msg.sender);
            totalDeposit[msg.sender] += eggsUsedValue;
        }
    ...
    function getDepositAmount(address adr) public view returns(uint256) {
        return totalDeposit[adr];
    }

    function getWithdrawAmount(address adr) public view returns(uint256) {
