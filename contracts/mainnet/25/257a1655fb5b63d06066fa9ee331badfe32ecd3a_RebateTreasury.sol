...
contract RebateTreasury is Ownable, Pausable {
    ...
    uint256 public staticBondPremium = 100_000;
    bool public enableStaticBondPremium;
    ...
    function getBondPremium() public view returns (uint256) {
        if (enableStaticBondPremium == true) {
            return staticBondPremium;
        }
    ...
    function setStaticBondPremium(uint256 _staticBondPremium) external onlyOwner {
        staticBondPremium = _staticBondPremium;
    }

    function setEnableStaticBondPremium(bool _enableStaticBondPremium) external onlyOwner {
        enableStaticBondPremium = _enableStaticBondPremium;
    }
}