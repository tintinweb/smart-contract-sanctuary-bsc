...
contract ShibaDealer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Dealer";
    string private _symbol = "Shiba Dealer";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55298aD8fcb98fAE135AD46FBF4cb22975e17bCF); // Marketing Address
    address payable public teamWalletAddress = payable(0xE4DCaA28aa7d1bbC887b949d338B26aeF9c621f7); // Team Address
