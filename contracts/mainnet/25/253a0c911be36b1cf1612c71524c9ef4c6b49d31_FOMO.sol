...
/**
 Max Wallet : 500,000 from total supply

 Max transaction to avoid bot

 Max transactions will increase after 5 minutes of launch !!
*/
...
contract FOMO is Context, IERC20, Ownable {
    ...
    string private _name = "Dev is Fomo";
    string private _symbol = "FOMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52032dA2A906C22357926f815356837e1A2E779f);
    address payable public BuyBackWalletAddress = payable(0x52032dA2A906C22357926f815356837e1A2E779f);
