...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public constant marketingAddr = 0x7E16F6017323d419217cD90bE13034404100BF1f;
    address public constant buybackAddr = 0x1cb92E3755400Cbb8a562f2D04024df6c3742d13;
...
contract GoldIngot is ExcludedFromFeeList, DividendFee {
    ...
    uint256 public _maxTxSellAmount = 20 * 1e18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;

    constructor() ERC20("GoldIngot", "GOLDINGOT", 18) DividendFee() {
    ...
    function _transfer(
        ...
        require((balanceOf[recipient] + amount) <= _maxHavAmount || isHavLimitExempt[recipient], "HAV Limit Exceeded");

        if(recipient == uniswapV2Pair || sender == uniswapV2Pair){require(amount <= _maxTxSellAmount || isTxLimitExempt[sender], "TX Limit Exceeded");}
