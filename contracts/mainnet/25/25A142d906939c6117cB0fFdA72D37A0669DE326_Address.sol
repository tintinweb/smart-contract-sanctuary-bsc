...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f9024D13cCDe17C3b8D3Eed745e547288d6CA59; // owner address
...
contract HyperInuTest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hyper Inu Test";
    string private _symbol = "HIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f9024D13cCDe17C3b8D3Eed745e547288d6CA59); // Marketing Address
    address payable public teamWalletAddress = payable(0x0f9024D13cCDe17C3b8D3Eed745e547288d6CA59); // Team Address
