...
contract AptProtocol is Context, IBEP20, Ownable {
    ...
    string public _name = "AptProtocol"; // token name
    string public _symbol = "APR"; // token ticker
    ...
    uint256 public minTokenToSwap = 100 * 1e9; // 100k amount will trigger the swap and add liquidity
