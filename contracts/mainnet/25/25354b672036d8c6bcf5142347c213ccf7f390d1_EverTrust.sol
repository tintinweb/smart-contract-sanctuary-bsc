...
contract EverTrust is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public liquidityReceiver = 0x994253007b13Bb734467880759a92661c9C858ac;
    address public treasuryReceiver = 0x994253007b13Bb734467880759a92661c9C858ac;
    address public riskFreeValueReceiver = 0x994253007b13Bb734467880759a92661c9C858ac;
    ...
    constructor() ERC20Detailed("EverTrust", "ETRUST", uint8(DECIMALS)) {
    ...
    function setFeeReceivers(address _liquidityReceiver, address _treasuryReceiver, address _riskFreeValueReceiver) external onlyWhitelisted {
