...
/* Token contract */
contract Wen69MillRATZ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "69RATZ";
    string constant _symbol = "69RATZ";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 69000 * (10 ** _decimals); // 10TH

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 69000 / 69000;
    uint256 public _maxSellTxAmount = _totalSupply * 69000 / 69000;
    uint256 public _maxWalletToken = ( _totalSupply * 69000 ) / 69000;
