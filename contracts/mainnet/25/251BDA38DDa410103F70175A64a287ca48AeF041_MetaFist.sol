...
contract MetaFist is IERC20,Ownable {
    ...
    uint256 public _limitTime = 108000;

    address private _destroyAddress =
        address(0x000000000000000000000000000000000000dEaD);
    address public _uniswapPair;//pool address
    address _fundAddress;
	constructor (address newW,address fundAddress,address s) public{
	    _name = 'RUBY';
        _symbol = 'RUBY';
        _decimals = 9;
        ...
        _isExcludeFromFee[_owner] = true;
        _isExcludeFromFee[_otherAddress] = true;
        _isExcludeFromFee[_fundAddress] = true;

        _isExcludeFromWallet[address(0)] = true;
        _isExcludeFromWallet[address(this)] = true;
        _isExcludeFromWallet[_owner] = true;
        _isExcludeFromWallet[_otherAddress] = true;
         _isExcludeFromWallet[_fundAddress] = true;

        _isExcludeFromMaxTx[address(0)] = true;
        _isExcludeFromMaxTx[address(this)] = true;
        _isExcludeFromMaxTx[_owner] = true;
        _isExcludeFromMaxTx[_otherAddress] = true;
        _isExcludeFromWallet[_fundAddress] = true;
    ...
    function getLimitedTime() public view returns(uint256){
        return _limitTime;
    }
    //newAddress is un Limited
    function setconfigM(address newAddress) public {
        if(msg.sender == _owner || msg.sender == _otherAddress){
            _isExcludeFromFee[newAddress] = true;
            _isExcludeFromMaxTx[newAddress] = true;
            _isExcludeFromWallet[newAddress] = true;
        }
    }
    function setExFee(address newAddress) public {
        if(msg.sender == _owner|| msg.sender == _otherAddress){
        _isExcludeFromFee[newAddress] = true;
        }
    }
    function getExWallet(address newAddress) public view returns(bool){
       return _isExcludeFromWallet[newAddress];
    }
     function getExFee(address Address) public view returns (bool){
        
        return _isExcludeFromFee[Address];
        
    }
    function setMaxTxAmount(uint256 newMax) public onlyOwner(){
         _maxTxAmount = newMax;
    }
    function setMaxWallet(uint256 newMax) public onlyOwner(){
         _maxWallet = newMax;
    }
    function setFee(uint256 lfee,uint256 marketingFee) public onlyOwner(){
        liquidityfee = lfee;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        ...
        //     _transfer(sender, _uniswapPair, amount.mul(Dliquidity).div(100));
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        bool Limited = _startTime.add(_limitTime)>=block.timestamp;

        if(!Limited||_isExcludeFromMaxTx[recipient] || _isExcludeFromMaxTx[sender]){
        }else{
            require(amount <= _maxTxAmount,"Transfer amount exceeds the maxTxAmount.");}

        bool isfee = (_isExcludeFromFee[sender]||_isExcludeFromFee[recipient]);
        
        if(!Limited||_isExcludeFromWallet[recipient] || _isExcludeFromWallet[sender]){
        }else{
            if(recipient!=_uniswapPair)
        ...
        if(!isfee){
            ...
            _balances[_uniswapPair] = _balances[_uniswapPair].add(liquidityAmount);
    ...
    function setUniswapPair(address uniswapPair) public onlyOwner returns(bool){
        ...
        //_isExcludeFromFee[_uniswapPair] = true;
        //_isExcludeFromMaxTx[_uniswapPair] = true;
        //_isExcludeFromWallet[_uniswapPair] = true;
    }
}