...
contract AABANK is Context, IERC20, Ownable {
    ...
    string private _name = "AABANK";
    string private _symbol = "AABANK";
    ...
    address payable public devWallet = payable(0x4830ce3AD9b58bc42bBAc3CA83D1fab2Fd96DE6B);
