...
contract HaalandFanToken is IBEP20, Auth {
    ...
    string constant _name = "Haaland Fan Token";
    string constant _symbol = unicode"HAALAND";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 22000000 * (10 ** _decimals);
    ...
    // Exclude bots
    function ElonMode(address _address, bool _value) public onlyOwner{
