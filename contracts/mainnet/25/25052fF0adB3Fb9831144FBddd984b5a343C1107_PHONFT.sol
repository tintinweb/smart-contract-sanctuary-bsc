...
contract PHONFT is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public sellStartID;
    uint256 public sellDayLimit;
    ...
    function mintNft(string memory uri) public {
        require(sellStartID <= 100, "sell id < 100");
        require(sellDayLimit <= 50, "sellDayLimit  < 50");
        require(_tokenIdCounter.current() < 1000, "_tokenIdCounter < 1000");
        
        IERC20(_usdt).transferFrom(msg.sender, address(this), nftPrice);
    ...
    function mintRootNft(string memory uri) public {
        require(msg.sender == _owner);
        require(_tokenIdCounter.current() < 1000, "_tokenIdCounter < 1000");
