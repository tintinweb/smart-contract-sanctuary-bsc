...
contract DARKUNIVERSE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DARKUNIVERSE";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x59a11bc626A4e710e0c97095DB9614131b628446;
        marketingFeeReceiver = 0x59a11bc626A4e710e0c97095DB9614131b628446;
