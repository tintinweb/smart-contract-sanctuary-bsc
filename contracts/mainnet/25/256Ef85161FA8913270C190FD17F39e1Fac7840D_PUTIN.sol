...
Max Wallet: 25 000 000 000 (2.5%)
Max TX: 1 000 000 000 (1%)  
KillBot Buy Timer: 12 seconds between buys


Tax Rates

19% buy (First hour, then 12%) 
29% Sell (First 2 hours, then 15%) 
29% Transfer (First 2 hours, then 15%)
...
contract PUTIN is IBEP20, Ownable
{
    ...
    //DevWallets
    address public TeamWallet=payable(0x1c6246C5a9FbC1c4C97C2CFD4569517AA261be37);
    address public walletTwo=payable(0xB9F63D3c9A70ACE4359154483556853c1a7778f5);
    //TestNet
