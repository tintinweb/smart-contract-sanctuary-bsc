...
contract BDUST is Context, IERC20, Ownable {
    ...
    string private constant _name = "BSC DUST"; // 
    string private constant _symbol = "$BDUST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x042f40dB67bcAaD6e007faC2Bc2777c84cb6CF13;
