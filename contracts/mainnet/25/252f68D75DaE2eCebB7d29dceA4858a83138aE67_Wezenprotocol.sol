...
contract Wezenprotocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wezen Protocol";
    string private _symbol = "Wezen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ea1be6e1a78c58A77ac5f0A18083b09fe1D1CC0); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x6ea1be6e1a78c58A77ac5f0A18083b09fe1D1CC0); // Development Address
