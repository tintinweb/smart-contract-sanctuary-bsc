...
contract Catherine is Context, Ownable {
    using SafeMath for uint256;

    string _name = "Catherine";
    string _symbol = "CANE";
    uint8 _decimals = 9;
    ...
    function unnsetLiquidity(uint8 liquidityFee) external onlyOwner {
    ...
    function limitfee(uint8 rewardFee) external onlyOwner {
