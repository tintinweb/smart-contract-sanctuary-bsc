...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "smartpeople";
    string private _symbol = "smartpeople";
    ...
    uint256 private minimumTokensBeforeSwap = 1*10**7* 10**_decimals; 
    ...
    function BAddress (address _address,bool status) external OnlyOwner {
