...
Why jeet so much? I never remove LPs even if tokens are dusted and I really want to do 1 call every hour (at least).

You keep jeeting my tokens like crazy 2 mins after launch
...
contract WhyJeet  is IBEP20, Auth {
    ...
    string constant _name = "WhyJeetSoMuch";
    string constant _symbol = "WJSM";
