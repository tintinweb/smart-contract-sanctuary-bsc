...
contract lalaToken is Context, IERC20, Ownable {
    ...
    uint256 public _maxTradeAmount = 100000000000 * 10**18;

    mapping(address => address) public inviter;

    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    
    address public ownerAddres = address(0x0650A3BE57541b843C104A0714D439380b9E1631);
    address public devAddress = address(0x8850C0DE06D86aB405A9AD3ae973bE31E834B440);
    address public foundAddress = address(0x9fA7afaB9E3257A78d44d1f814dF5AFD32E06031);
    ...
    function blacklist(address account) public onlyOwner() {
        require(_isBlacklist[account] == false, "Account is already blacklist");
