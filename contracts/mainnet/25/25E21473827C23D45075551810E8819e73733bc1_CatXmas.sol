...
/*
  ...
  //Telegram : https://t.me/CatXmas

  //Cat Xmas to become the meme token killer on Binance Smart Chain,
  //with strong project that will give passive income for diamond holders.
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA0b0b1680595bb806d5B87E9A4890cB1063cfDD0;
...
contract CatXmas is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Xmas"; // 
    string private constant _symbol = "CatXmas"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xaCeb6BCe2011F6a391aDd934bd26BE51A68C9f20);
