...
contract Medals is ERC721, AccessControlEnumerable, ReentrancyGuard {
    ...
    function init(address _gas) external onlyRole(OPERATOR_ROLE) {
        gas = _gas;
    }
    ...
    function setBaseTokenURI(string memory _tokenURI) external onlyRole(OPERATOR_ROLE) {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        uint256 _index = tokenIds[tokenId];
