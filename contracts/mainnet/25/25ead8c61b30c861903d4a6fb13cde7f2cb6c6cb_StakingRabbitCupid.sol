...
contract StakingRabbitCupid is Context, Ownable {

    using SafeMath for uint256;

    //==========STAKING=========
    address targetToken = address(0x9C89203A8492302947e6632309D0bDE87F9b378C);
    IERC20 token;
