...
contract KishuInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9d7a9aA63559B93906C85345f199fFA3f078D827); 
    address payable public Wallet_Dev = payable(0x9d7a9aA63559B93906C85345f199fFA3f078D827);
    ...
    string private constant _name = "kishuinu"; 
    string private constant _symbol = unicode"khinu"; 
 

    uint256 private _Tax_On_Buy = 3;
    uint256 private _Tax_On_Sell = 3;
    ...
    constructor () {
        ...
        _owner = 0x9d7a9aA63559B93906C85345f199fFA3f078D827;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) public {
