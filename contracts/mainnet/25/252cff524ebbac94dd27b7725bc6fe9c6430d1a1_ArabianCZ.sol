...
/*
    ...
    Telegram: https://https://t.me/arabiancz_bsc
...
contract ArabianCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArabianCZ";
    string private _symbol = "CZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0Fba9D60f9C9FD108c3dD718C33097801c105AC); 
    address payable public DevOutsourceWallet = payable(0x67C45baD13267765518fd0a60AFbD1F77513b9f6); 
