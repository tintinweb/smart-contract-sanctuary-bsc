...
website : https://pennypet.network
https://t.me/Pennypetnetwork
*/
...
contract PennypetNetwork is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address burnAdd = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x0307eFe348ec7DAFef68852F167C6fD86857B050;
    ...
    uint256 public swapAtAmount =  40 * (10**18);
    ...
    constructor() BEP20("PennyPet", "PNT", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "NeoShiba: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NeoShiba: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "NeoShiba: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NeoShiba: Automated market maker pair is already set to that value");
