...
contract TDAO is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("TDAO", "TDAO") {
        ...
        swapTokensAtAmount = total.div(8000);
    ...
    function splitOtherToken() private {
        ...
        if(balanceOf(address(this)) > thisAmount && thisAmount >= 10**16){
