...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA8B386b01e758dd415845a257FeBCF45b827eE16; // owner address
...
contract UpChart is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UpChart";
    string private _symbol = "UC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA8B386b01e758dd415845a257FeBCF45b827eE16); // Marketing Address
    address payable public teamWalletAddress = payable(0xA8B386b01e758dd415845a257FeBCF45b827eE16); // Team Address
