...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x893535ED1b5C6969E62a10bABfED4F5fF8373278); 
...
contract ShiiibaIIInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sh!ba !nu";
    string constant _symbol = "SH!B";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x087f37983E2221dBeB23e19E5Dadd102E1425A17;  
        anothermarketingWallet = 0x38936b82a891401D07Aba961f0D94e3f871A41bF;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(5).div(7);
