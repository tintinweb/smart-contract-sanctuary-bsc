...
contract PigeNobi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pige Nobi";
    string private constant _symbol = "$PigeNobi";
