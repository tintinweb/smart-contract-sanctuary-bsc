...
//
// $RabbitDAO proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/RabbitDao1000x
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _RabbitDAO(uint256 amount) public onlyOwner {
...
contract $RabbitDAO is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Rabbit DAO", "RDAO") {
     _RabbitDAO(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}