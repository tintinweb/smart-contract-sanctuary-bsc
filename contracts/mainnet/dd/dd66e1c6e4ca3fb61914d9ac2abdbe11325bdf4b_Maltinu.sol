...
contract ELONTOKEN is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "ELONTOKEN: caller is not the owner");
        _;
    }
     /**
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ELONTOKEN: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract Maltinu is ELONMUSK, ELONTOKEN {
    ...
    string _name = "Malt Inu";
    string _symbol = "MALTINU";
    ...
    constructor () {
        ...
        teamFeeReceiver = 0xf7e802388bA0a2E81830561B3dB87D4e4f517a5a;
