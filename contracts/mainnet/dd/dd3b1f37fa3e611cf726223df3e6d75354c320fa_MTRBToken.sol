...
// File: contracts/MTRBToken.sol


pragma solidity ^0.8.10;


contract MTRBToken is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**5 * (10**9); //0.1% of the supply

    uint256 public maxBuyAmount = 2 * 10**6 * 10**9; // 2% of the supply
    uint256 public maxSellAmount = 2 * 10**6 * 10**9; // 2% of the supply
    uint256 public maxWalletAmount = 2 * 10**6 * 10**9; // 2% of the supply
    ...
    address payable _devWallet = payable(address(0xc89E22bEEDf21f7d847a5fcaA7FcC9378Fb9Ade0)); // replace your devWallet here
    ...
    constructor() ERC20("MetaArab", "METAARAB") {
       
        buyFee.devFee = 3;
        buyFee.liquidityFee = 7;
        totalBuyFee = 10;

        
        sellFee.liquidityFee = 7;
        sellFee.devFee = 3;
        totalSellFee = 10;
        ...
        */
        _mint(owner(), 1 * 10**8 * (10**9)); // 100,000,000 Tokens
    }
    ...
    function setBuyFee(
        ...
        totalBuyFee =  dev + liquidity ;
        require (totalBuyFee < 20,"total buy fee should be less than 20%");
    }
    ...
    function setSellFee(
        ...
        totalSellFee = dev + liquidity;
        require (totalSellFee < 20, "max sell fees should be less than 20");
    }
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 devTokens = contractTokenBalance - swapTokens;
    ...
    function swapAndSendToDev(uint256 tokens) private lockTheSwap {
        ...
        uint256 devShare = IERC20(BUSD).balanceOf(address(this));
