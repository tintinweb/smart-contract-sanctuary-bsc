...
TELEGRAM:  https://t.me/saudichadbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE0056200881CA9bbD6130Ad2E8B9BBB627B2D528;
...
contract SaudiChad is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Chad"; // 
    string private constant _symbol = "CHAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xE0056200881CA9bbD6130Ad2E8B9BBB627B2D528);
