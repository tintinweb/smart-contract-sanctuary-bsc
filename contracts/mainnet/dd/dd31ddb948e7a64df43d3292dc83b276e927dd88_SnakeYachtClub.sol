...
/**
Welcome to SnakeYachtClub !



TG: https://t.me/snakeyachtclub
...
contract SnakeYachtClub is Context, IERC20, Ownable {
    ...
    string private constant _name = "SnakeYachtClub";
    string private constant _symbol = "SYC";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 14, // dev team fee in %
            treasury: 0, // treasury fee in %
            lp: 6, // lp rate in %
            toSwap: 20 // treasury + dev + lp
        });
