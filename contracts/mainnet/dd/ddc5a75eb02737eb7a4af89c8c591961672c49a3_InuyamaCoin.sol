...
contract InuyamaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inuyama Coin";
    string private _symbol = "INUYAMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d1d4e1Ce823d057Ba64c237eA4862Eaa2A3fFF2); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6d1d4e1Ce823d057Ba64c237eA4862Eaa2A3fFF2); // buyback Address
