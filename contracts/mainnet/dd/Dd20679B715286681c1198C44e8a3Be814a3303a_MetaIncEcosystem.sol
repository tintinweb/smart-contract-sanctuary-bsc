...
TG: https://t.me/MetaIncEcosystem
...
contract MetaIncEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Meta Inc Ecosystem";
    string private _symbol = unicode"MINC";
