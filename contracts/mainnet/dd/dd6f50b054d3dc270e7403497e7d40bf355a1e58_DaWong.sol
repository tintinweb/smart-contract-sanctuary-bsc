...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x449BEE2715961C8851a3DBd597a08a331519cdBA;
        // owner address
...
contract DaWong is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DanQiWopng";
    string private _symbol = "DaWong";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x449BEE2715961C8851a3DBd597a08a331519cdBA); // Marketing Address
    address payable public teamWalletAddress = payable(0x449BEE2715961C8851a3DBd597a08a331519cdBA); // Team Address
    ...
    function setDLDaWong(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEDaWong(uint256 fe) external onlyOwner {
