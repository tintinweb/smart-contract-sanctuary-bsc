...
abstract contract Auth {
 ...
 contract OrdinalLuna is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Ordinal Luna Official";
    string constant _symbol = "$oLUNA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xE8d6B7aAD8d8e5F628564b6dced0e272EAe455bc; // liquidity
