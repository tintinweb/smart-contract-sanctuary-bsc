...
//
//
//   📱Telegram::https://t.me/+n3viCb0UXs43NjQ1
//   📱Website :: https://wewhale.co/wiki-whale/
/*
...
contract WikiWhales is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Wiki Whales", "WikiWhales") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WikiWhales";
    string private _symbol = "WikiWhales";
