...
contract TWITHEREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twithereum";
    string private _symbol = "TWTH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xefB27d0744e1eb1D0c9421b0E52923F536A00dDc); 
    address payable public DevelopmentalWalletAddress = payable(0x840d29585b5a310905c29ceac1cDE2778dB290ff); 
