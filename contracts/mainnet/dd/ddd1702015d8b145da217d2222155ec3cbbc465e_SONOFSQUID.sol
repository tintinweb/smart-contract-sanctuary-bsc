...
//
// Son of Squid
// The newborn squid has arrived on BSC!
// 
// https://t.me/SonofSquid_BSC
...
contract SONOFSQUID is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Son of Squid";
    string private _symbol = "$SoS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAC7b3c5b12D2FBAaa7EF9bEdFC3E1f457BB6C55d);
    address payable public DevelopmentWalletAddress = payable(0xAC7b3c5b12D2FBAaa7EF9bEdFC3E1f457BB6C55d);
    ...
    uint256 private _totalSupply = 505505 * 10**9;
    uint256 public _maxTxAmount = 505505 * 10**9;
    uint256 public _walletMax = 505505 * 10**9;
