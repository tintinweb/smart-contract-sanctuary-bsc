...
contract ZTU is ERC20 {
    ...
    address private tokenOwner = 0x24827302568714a6d437517B7E46b85c56e5C133;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){         
            super._transfer(from, buyFeeAddr, amount.div(100).mul(buyFee-10));  
            super._transfer(from, _destroyAddress, amount.div(100).mul(10));
            amount = amount.div(100).mul(1000-buyFee);

        }else{   
            super._transfer(from, sellFeeAddr, amount.div(100).mul(sellFee-10));
            super._transfer(from, _destroyAddress, amount.div(100).mul(10));
