...
contract SaudiDogeQatar is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe6239b4240cF704c316F788d8062C2db606B6713); 
    ...
    string private constant _name = "Saudi Doge Qatar"; 
    string private constant _symbol = unicode"SDQa"; 
    ...
    */
    ...
    // Default is true
    function tranferingnote (bool true_or_false, uint256 _uint) public onlyOwner {
