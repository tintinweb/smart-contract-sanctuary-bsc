...
/**
 ...
 Instagram Inu
 Telegram : https://t.me/Instagram_Inu
...
/* Token contract */
contract InstagramInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB3aBC1200835f37c8F79Bc991e6f69A15449dfF2;
    ...
    // Name and symbol
    string constant _name = "Instagram Inu";
    string constant _symbol = unicode" INSTINU ";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 200200200200 * (10 ** _decimals); // 10

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (200)
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% (100)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (200)
