...
/*
Hello Inu's Army! Welcome to NoCall Inu Community Global 🐶🚀 !
🌺🐕 NoCall Inu 🐕🌺
HOLD $NCINU and receive rewards in $Shib $NoCallInu
Tokenomics 
🤍 5% LP
🎁 5% Reward
🤍Tax 10% Slipage 8

🐕NoCall Inu 🐕is excited about the future allowing holders to not only earn via the success of $MASHIB but To build power of Global Community without Calls 🌺 !  🌺🐕

https://t.me/NoCallInuChannel
https://t.me/NoCallinu
*/
...
contract NoCallInu is Context, BinanceGaming, Ownable {
    ...
    string private _name = 'NoCall Inu';
    string private _symbol = 'NC INU';
