...
// Donation Token By Peduli Anak
// https://www.pedulianak.org/id/donate-bitcoin/
// https://twitter.com/pedulianak
...
contract DonationToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Donation Token";
    string private constant _symbol = "DNT";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0x7A2507082778D20c83705030227c0b2ca61067C2);
    address payable private _marketingAddress = payable(0x7A2507082778D20c83705030227c0b2ca61067C2);
    address payable private _buybackAddress = payable(0x7A2507082778D20c83705030227c0b2ca61067C2);
    address payable private _burnAddress = payable(0x7A2507082778D20c83705030227c0b2ca61067C2);
