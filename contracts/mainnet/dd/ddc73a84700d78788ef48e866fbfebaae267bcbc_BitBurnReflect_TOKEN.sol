...
/**
Welcome to BitBurnReflect TOKEN!
...
contract BitBurnReflect_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "BitBurnReflect";
    string private constant _symbol = "BBR";
