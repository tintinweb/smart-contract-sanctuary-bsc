        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x0B3264AE79Cc42156d558B30305148FFc6b11A39), block.timestamp
                );
            }
        }
    }
...
contract BEP20 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3bC90D4f0450C9eFaaae27237CdEdc54E216aF5b),
        address(0x5d31874e9bEFCbE34c758F9c81D159151d75bdFA),
    
        address(0x100B241D5529A223aDc9F26e0D03081e6D739Ced)
    ){
