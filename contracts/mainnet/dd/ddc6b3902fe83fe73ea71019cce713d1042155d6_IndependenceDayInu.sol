...
TG: https://t.me/BETA_Do_Not_Buy_BETA
###################################################################################
*/
...
contract IndependenceDayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Independence Day Inu";
    string private _symbol = "$Independence Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF50efEB120Cb284CFC4F49f3A20CB90740849317); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF50efEB120Cb284CFC4F49f3A20CB90740849317); // BuyBack Address
