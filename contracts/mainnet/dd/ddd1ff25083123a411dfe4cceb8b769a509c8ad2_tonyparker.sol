...
contract tonyparker is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tonyparker";
    string private _symbol = "Tonyparker";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4498a40e9586CC63450AAB10fDa27304588fC7B0); 
    address payable public BurnedWalletAddress = payable(0x4498a40e9586CC63450AAB10fDa27304588fC7B0); 
