...
// TELEGRAM: https://t.me/ShiroOfficial

// 𝐓𝐖𝐈𝐓𝐓𝐄𝐑: https://twitter.com/ShiroBSC
...
contract SHIRO is Context, IERC20, Ownable {
    ...
    uint256 public _ShiroLiquidityFee = 4;
    uint256 public _ShiroMarketingFee = 4;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _ShiroMarketingFee / 100;
        uint256 liquidityFee = amount * _ShiroLiquidityFee / 100;
    ...
    function swapAndLiquify() private {
        uint256 liquidityTokens = balanceOf (address(this)) * _ShiroLiquidityFee / (_ShiroMarketingFee + _ShiroLiquidityFee);
