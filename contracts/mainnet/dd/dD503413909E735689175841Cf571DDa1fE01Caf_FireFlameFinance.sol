...
Telegram https://t.me/fireflamefinance
...
contract FireFlameFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fire Flame Finance";
    string private _symbol = "FFF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdd68ba10da1BD88E3c4b45DbF22ef3bE05c4e225); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA446982bcf998d00dEf3e2b58CDa914c1D961A5d); // BuyBack Address
