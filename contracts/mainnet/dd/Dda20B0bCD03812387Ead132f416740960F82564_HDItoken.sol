...
contract HDItoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800 *10**15 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Husky Doge Inu";
    string private _symbol = "HDI";
    ...
    uint256 public minimumTokensBeforeSwap = 800 *10**15 * 10**18;
    uint256 public _maxBuyTxAmount = 800 *10**15 * 10**18;
    uint256 public _maxSellTxAmount = 800 *10**15 * 10**18;
