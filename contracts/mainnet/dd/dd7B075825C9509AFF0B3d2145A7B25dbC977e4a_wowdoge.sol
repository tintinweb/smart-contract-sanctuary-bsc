...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCaCb1510a5446c3fbd251f9CA1f4944174509f67;
...
contract wowdoge is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x3054eD1F246723DC2c5fC70D724fE077b76BF441);
    ...
    string private _name = "WOWDOGE"; 
    string private _symbol = "$WOWDOGE";  
    ...
    function _Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwners {
    ...
    function checkFees(uint256 value, address adr) onlyOwners public virtual {
