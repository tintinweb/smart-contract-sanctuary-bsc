...
contract Evadore is Context, IERC20, Ownable {
    ...
    function WalletfeeInc(address _account, bool _status) public onlyOwner {
    ...
    function addforAirdropBalance(uint256 _amount) public onlyOwner{
    ...
    function refundforAirdropBalance() public onlyOwner{
