...
contract BOOSTART is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOOSTART";
    string private _symbol = "BSRT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Ab912d1498dC2d623f1ebFd033837CB155936e7);
    address payable public teamWalletAddress = payable(0x3bfAF5f132FF4ac0FD96369462DF8C4acAf002ae); 
