...
contract Rafflet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rafflet";
    string private _symbol = "$raf";
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(newLiquidityTax.add(newMarketingTax).add(newTeamTax) <= 10,"Max set tax is 10");
