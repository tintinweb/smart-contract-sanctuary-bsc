...
// TELEGRAM : https://t.me/decorativecoin
...
contract DECORATIVE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DECORATIVE";
    string private _symbol = "$DECO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x27F06eB71393ecB5D49A6573E78631dEB1981558); // MARKETING Address
    address payable public teamWalletAddress = payable(0x27F06eB71393ecB5D49A6573E78631dEB1981558); // BUYBACK Address
