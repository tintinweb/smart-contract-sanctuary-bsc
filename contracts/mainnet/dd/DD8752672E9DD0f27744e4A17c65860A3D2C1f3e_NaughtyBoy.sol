...
contract NaughtyBoy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naughty Boy";
    string private constant _symbol = "NB";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 69000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 2070000 * 10**_decimals;
    uint256 public _maxTxAmount = 2070000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 51750 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(msg.sender);
