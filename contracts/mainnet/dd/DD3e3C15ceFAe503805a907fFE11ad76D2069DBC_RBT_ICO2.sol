...
contract RBT_ICO2 is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public  RATE = 3241917428; // Number of tokens per 1 BNB
  uint256 public  CAP = 5000; // Cap in BNB
  ...
  uint256 public  MinPurchase = 48 * 1e15; /** 0.048 BNB  **/

  
  uint256 public constant initialTokens = 50000000000000 * 10**16; // 5% of total tokens available
