...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcBA71eF890A4A0ca6CC8A9659AFf5BF3F877CB01;
...
contract HurricaneTaz is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hurricane Taz"; // 
    string private constant _symbol = "H'Taz"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xcBA71eF890A4A0ca6CC8A9659AFf5BF3F877CB01);
