...
contract AlertAIMochis is Context, Ownable {
    ...
    function StuckBalance() public payable onlyOwner {payable(msg.sender).transfer(address(this).balance);
    }
