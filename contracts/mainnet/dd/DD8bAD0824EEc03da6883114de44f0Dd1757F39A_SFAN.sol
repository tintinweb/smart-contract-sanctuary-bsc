...
contract SFAN is
    ...
    Freezable
{
    string constant private _name = "SFAN";
    string constant private _symbol = "SFAN";
    uint8 constant private _decimals = 18;
    uint256 constant private _initial_supply = 21_000_000;
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "SFAN/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "SFAN/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "SFAN/approve : Should not approve zero address"
        );
