...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB35058aB38a506d9452E063f5718Ca57CB8922a6; // owner address
...
contract BADASSRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BADASS RABBIT";
    string private _symbol = "BRT";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x5022F14b5e707b907d681dB3CE42E33D93a0e5C1); 
    address payable public teamWalletAddress = payable(0x5022F14b5e707b907d681dB3CE42E33D93a0e5C1);
