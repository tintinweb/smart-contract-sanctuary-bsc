...
contract OG is Context, IERC20, Ownable {
    ...
    string private _name = "OGQUEEN";
    string private _symbol = "OGQEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1fd8814C78356f76185DCFCEfdE9a259602C2E7D);
    address payable public BurnedWalletAddress = payable(0xc68aB0b36E37a731cEB4311197A83dcD4835498F); 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBuyBack = amountReceived.mul(_BurnedShare).div(totalBNBFee);
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(BurnedWalletAddress, amountBNBBuyBack);
