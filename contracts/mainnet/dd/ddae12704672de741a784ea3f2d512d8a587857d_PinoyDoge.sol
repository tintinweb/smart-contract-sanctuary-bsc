...
/*
PinoyDoge
A proud Pinoy degen play project.
PinoyDoge is a defi community-driven NFT utility coin 
which aims to aid financial loss by simply holding the token. 
It offers low tax and faster ROI to support all holders. 

Telegram:   https://t.me/PinoyDoge
Website:    https://www.pinoydoge.ml

Stealth Launch: 
AUGUST 5, 2022 @ 3:00pm UTC
...
contract PinoyDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "PinoyDoge"; //
    string private constant _symbol = "PinoyDoge"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x5c00E6AD480DAce42F7afdD4293c9d908aD02A5c;
