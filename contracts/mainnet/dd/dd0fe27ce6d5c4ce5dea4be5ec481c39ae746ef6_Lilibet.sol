...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C7dDB503da0D21D32D02a21be65f83f13C2227f;
...
contract Lilibet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3972285f74203218fb0f7D70d04b7BDAE3D39d6a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lilibet";
    string private _symbol = "LILIBET";
