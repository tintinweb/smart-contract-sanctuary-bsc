...
contract EXPOSED is Context, IERC20, Ownable {
    ...
    string private _name = "EXPOSED";
    string private _symbol = "XPOSE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xDa4Ce1b241BDd0ed47bD03775e66A67e8FE4B832);
