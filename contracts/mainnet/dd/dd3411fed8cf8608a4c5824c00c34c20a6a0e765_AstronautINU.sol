...
/*
👩‍🚀 Astronaut Inu($Asnu)👩‍🚀
Astronaut Inu(BSC GEM) is the first coin to conquer the universe, not just the moon. 
with the mission to reach the planet inhabited by the inu group, and let's work together in building the ecosystem of the inu universe.

Come and join the universe mission!
>> https://t.me/Astronaut_INU
>> https://twitter.com/astronaut_inu
*/
...
contract AstronautINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "ASNU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf503eD8D349553421923a4Ed563da9fB28e45446);
    address payable public liqWalletAddress = payable(0xf503eD8D349553421923a4Ed563da9fB28e45446);
    ...
    uint256 private _totalSupply =  145000* 10**_decimals;
    uint256 public _maxTxAmount =    4350* 10**_decimals;
    uint256 public _walletMax =      5800* 10**_decimals;
