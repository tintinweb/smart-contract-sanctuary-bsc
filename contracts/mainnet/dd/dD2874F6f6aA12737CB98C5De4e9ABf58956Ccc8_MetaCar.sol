...
contract MetaCar is Context, IERC20, Ownable {
    ...
    string private _name = "GreatDanekiller";
    string private _symbol = "GreatDanekiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f32E2468cBACF254dA43f7A3ccb8B881821D844);
    address payable public teamWalletAddress = payable(0xda80Ed3bcE70eCE24F3D54cbaDa85c251e0d9fb0);
