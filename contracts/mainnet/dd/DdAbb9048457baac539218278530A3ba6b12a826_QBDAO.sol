...
contract QBDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QBDAO";
    string private _symbol = "QBDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x552798ebe0639307CebC61474D17bb830A364511); // Marketing Address
    address payable public teamWalletAddress = payable(0x5726F022B244dB0Bc5d4A304A79621159A1164d4); // Team Address
    ...
    uint256 private _totalSupply = 2018 * 10**_decimals;
    uint256 public _maxTxAmount = 2018 * 10**_decimals; 
    uint256 public _walletMax = 2018 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2018 * 10**3; 
