...
contract VICECOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0xd4B32d47C435C120B7fBB5E786265984045784Bb); 
    address payable public developmentAddress = payable(0xd4B32d47C435C120B7fBB5E786265984045784Bb); 
    address payable public charityAddress = payable(0xd4B32d47C435C120B7fBB5E786265984045784Bb); 
    address payable public vaultRewardAddress = payable(0xd4B32d47C435C120B7fBB5E786265984045784Bb); 
    ...
    string private constant _name = "VICE COIN";
