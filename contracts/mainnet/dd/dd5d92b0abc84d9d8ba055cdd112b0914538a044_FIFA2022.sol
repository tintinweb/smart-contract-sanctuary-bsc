...
contract FIFA2022 is FIFA2022Deployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FIFA2022Team;
    address private CharityFIFA2022;
    ...
    string public override name = "FIFA2022";
    string public override symbol = "FIFA2022";
    ...
    constructor(uint totalSupplyValue, address FIFA2022TeamAddress, address CharityFIFA2022Address) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FIFA2022Team = FIFA2022TeamAddress;
        CharityFIFA2022 = CharityFIFA2022Address;
        
        // split the tokens according to agreed upon percentages
        balances[FIFA2022Team] =  totalSupply * 45 / 100;
        balances[CharityFIFA2022] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's FIFA2022Team pot
