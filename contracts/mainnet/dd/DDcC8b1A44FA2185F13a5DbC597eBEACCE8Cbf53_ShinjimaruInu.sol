...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93513390D20607A348F769DF072a5a0C8ad5E854; // owner address
...
contract ShinjimaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Shinjimaru Inu";
    string private _symbol = unicode"SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93513390D20607A348F769DF072a5a0C8ad5E854); // Marketing Address
    address payable public teamWalletAddress = payable(0x93513390D20607A348F769DF072a5a0C8ad5E854); // Team Address
