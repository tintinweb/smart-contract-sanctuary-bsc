...
/**
⚡️ Oasys BSC Fan Token⚡️

🚀celebration of the ido success of 21 million dollars $$$$

🚀#StealthLaunch | Bullish Name | #Slowmoon | 100XPotential

💠 LP LOCKED 1Year
⚡️ CA VERIFIED & RENOUNCED
⚡️ 100% SAFU DEV

📱Telegram group: https://t.me/OasysBSC
...
⚡️Oasys IDO Details :
🌎 IDO Link https://icodrops.com/oasys/
...
contract OasysBSC is OasysBSCDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private OasysBSCTeam;
    address private CharityOasysBSC;
    ...
    string public override name = "Oasys Fan Token";
    string public override symbol = "Oasys";
    ...
    constructor(uint totalSupplyValue, address OasysBSCTeamAddress, address CharityOasysBSCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        OasysBSCTeam = OasysBSCTeamAddress;
        CharityOasysBSC = CharityOasysBSCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[OasysBSCTeam] =  totalSupply * 4 / 100;
        balances[CharityOasysBSC] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's OasysBSCTeam pot
