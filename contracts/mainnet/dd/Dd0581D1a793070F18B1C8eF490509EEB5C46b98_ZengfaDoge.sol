...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xDb11A49F0bc35FF9d148c020BcF6fD1584DEd1b1));
        marketingWalletAddress = payable(address(0xd761c8F45e839075C508357C1B96e1d6Fdf54282));
