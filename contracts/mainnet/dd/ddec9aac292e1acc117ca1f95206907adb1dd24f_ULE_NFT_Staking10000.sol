...
//Variables
    ...
    mapping (address => mapping (uint256 => bool)) public IDOwnerCheck;
...
//Stake NFTS to earn Reward in coca coin
    function Stake(uint256 tokenId) external 
    {
       ...
       require(check[tokenId]==false,"id already exist");
           NFTToken.transferFrom(msg.sender,address(this),tokenId);
           check[tokenId]=true;
           IDOwnerCheck[msg.sender][tokenId]=true;
...
function sendMultiBnb(address payable[]  memory  _contributors, uint256[] memory _balances) public  payable onlyOwner {
...
//User have to pass tokenID to unstake token
    function unstake(uint256 _tokenId,address add)  external 
        {
            require(IDOwnerCheck[add][_tokenId]==true,"you are not owner of this id");
            NFTToken.transferFrom(address(this),add,_tokenId);
            IDOwnerCheck[add][_tokenId]=false;
        }
//token 0x3a549866a592C81719F3b714a356A8879E20F5d0
}