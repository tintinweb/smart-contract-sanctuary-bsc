...
contract RESIST is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6cd4f4F2FF27fc354bCbF55046b8d33D7564E2ed); 
    address payable public Wallet_Developer = payable(0x92607B368f26B7d8A7aFC43C1f60f1d01d9E91dB);
    ...
    string private constant _name = "Resist"; 
    ...
    constructor () {
        ...
        _owner = 0x92607B368f26B7d8A7aFC43C1f60f1d01d9E91dB;
