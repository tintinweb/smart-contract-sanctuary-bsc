...
/**
Telegram : https://t.me/+f8M0rhGtlU02ZWFl
*/
...
contract MuuMuraiJiru  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Muu MuraiJiru"; // 
    string private constant _symbol = unicode"MuuJiru"; //    
    ...
    function _Feesapproved(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
