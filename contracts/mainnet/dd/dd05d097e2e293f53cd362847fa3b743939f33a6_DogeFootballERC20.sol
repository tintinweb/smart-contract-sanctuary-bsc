...
// Doge Football is a coin meme that connects crypto lovers with football lovers around the world. 
// To make this connection we will launch the game Doge Football on the BSC platform. 
// At the same time we also develop our own Swap and Crosschain Dex platform.
// SOCIAL DOGE FOOTBALL :
// WEBSITE : https://dogefootball.world/
// TWITTER :https://twitter.com/dogefootball_
// TELEGRAM GROUP : https://t.me/dogefootballofficial
// TELEGRAM CHANNEL : https://t.me/dogefootball_world
// LINKEDIN : https://www.linkedin.com/company/dogefootball/
// YOUTUBE : https://www.youtube.com/@dogefootball_world

// COPYRIGHT © 2022 DOGE FOOTBALL TEAM
...
contract DogeFootballERC20 is ERC20, Ownable {
...
contract BSCBridge is Ownable {
    ...
    function transit(address _ercToken, string memory _name, string memory _symbol, uint256 _amount, string memory _transitId, bytes calldata _signature) external payable {
        ...
        if (ercToBep[_ercToken] == address(0)) {
            ...
            bytes memory bytecode = abi.encodePacked(type(DogeFootballERC20).creationCode, abi.encode(_name, _symbol));
        ...
        DogeFootballERC20(ercToBep[_ercToken]).mint(msg.sender, _amount);
    ...
    function payback(address _bepToken, uint256 _amount) external payable {
        ...
        DogeFootballERC20(_bepToken).burn(msg.sender, _amount);
    ...
    function transferTokenOwnership(address _bepToken, address _to) onlyOwner external {
        ...
        DogeFootballERC20(_bepToken).transferOwnership(_to);
