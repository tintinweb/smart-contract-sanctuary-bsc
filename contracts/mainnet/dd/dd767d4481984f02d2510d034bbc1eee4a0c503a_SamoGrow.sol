...
/*
    SAMO GROW ~ COMMUNITY TOKEN

    telegram      : https://t.me/SamoGrowPortal

    Samo is Japanese Dog based in luck and charm and coming to Bsc to be one of the most successful project in BSC Network carrying their talisman of luck with a bigger goal to be the next 1000x gems🚀🚀🚀
...
contract SamoGrow  is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0xabf4B9a5ea24eEfE8f1BB1FC0d873014452540ee);
    address payable public Wallet_Dev = payable(0xabf4B9a5ea24eEfE8f1BB1FC0d873014452540ee);
    ...
    string private constant _name = "Samo Grow";
    string private constant _symbol = unicode"SMG";
    ...
    constructor () {
        ...
        _owner = 0xabf4B9a5ea24eEfE8f1BB1FC0d873014452540ee;
