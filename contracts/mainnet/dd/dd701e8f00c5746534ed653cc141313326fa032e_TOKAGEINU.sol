...
contract TOKAGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tokage Inu";
    ...
    address payable public buyBackWalletAddress = payable(0xb61F2b9D9fA3D6Ed173C6ea535E50299516a5A55); 
