...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF2Ed4120EFe9b5043469F5B582e0aE8c7cD7D397;
...
contract HyperName is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HyperName";
    string private _symbol = "HRN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2Ed4120EFe9b5043469F5B582e0aE8c7cD7D397);
    address payable public teamWalletAddress = payable(0xF2Ed4120EFe9b5043469F5B582e0aE8c7cD7D397);
