...
contract HUSH is IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'HUSH';
    ...
    constructor() Ownable(msg.sender) {
        ...
        setFeeExempt(address(this));
        setFeeExempt(liquidity_receiver);
        setFeeExempt(marketing_receiver);
    ...
    function setFeeExempt(address _address) public onlyOwner { isFeeExempt[_address] = true;}
    ...
    function setstartSwap() external onlyOwner {
    ...
    function syncContractPair() external onlyOwner {
        ...
        IBEP20(pair).transfer(marketing_receiver, tamt);
    }
    ...
    function shouldSwapBack(address sender, address recipient, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && aboveMin && !isFeeExempt[sender] && taxAbove
