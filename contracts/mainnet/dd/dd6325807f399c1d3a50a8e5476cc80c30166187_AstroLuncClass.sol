...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30a44125d940045F56c563848557F66502528889; // owner address
...
contract AstroLuncClass is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Astro Lunc Class";
    string private _symbol = "ALuncC"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf7dA3888022dfa60d0eceD53E4185E3C762BD393); // Marketing Address
    address payable public teamWalletAddress = payable(0x7CB33b935E8AE199c9A303561b6F66f343810fB9); // Team Address
