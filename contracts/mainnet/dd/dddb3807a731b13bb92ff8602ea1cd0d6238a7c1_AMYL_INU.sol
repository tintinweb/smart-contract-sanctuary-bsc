...
// AMYL INU
// * SAFE DEV, MARKETING, MICRO CAP, LOW TAXES *
...
contract AMYL_INU is Context, IERC20 { 
    ...
    string private constant _name = "AMYL INU"; 
    string private constant _symbol = unicode"AMYL INU"; 
