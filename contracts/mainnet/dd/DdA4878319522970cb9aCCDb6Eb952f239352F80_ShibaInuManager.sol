...
contract ShibaInuManager is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0xcf824733D3598DeE16435aE93538c4c9Db10d959);
    address payable public Wallet_Dev = payable(0xcf824733D3598DeE16435aE93538c4c9Db10d959);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    string private constant _name = "SHIBA INU MANAGER";
    string private constant _symbol = "$SHIBAIM";
