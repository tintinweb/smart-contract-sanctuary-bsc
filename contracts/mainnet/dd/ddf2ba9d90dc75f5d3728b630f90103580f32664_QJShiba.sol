...
contract QJShiba  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " QJShiba ";
    string private _symbol = " $QJSHI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCBB6EF3ec9443fa73F596eDE537559D2EBa53Cc1); 
    address payable public teamWalletAddress = payable(0xCBB6EF3ec9443fa73F596eDE537559D2EBa53Cc1); 
