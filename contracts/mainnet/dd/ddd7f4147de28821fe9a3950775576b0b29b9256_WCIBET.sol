...
\ \    / /((_)( )| |)\| |    (( )(_))| '_ \    (_)(_))((_)) 
 \ \/\/ // _ \ '_| | _` |    / _| || | .__/    | | ' \) || |
  \_/\_/ \___/_| |_|__/_|    \__|\_._|_|       |_|_||_|\_._|
**/ 
...
contract WCIBET is ERC20, Ownable {
    ...
    constructor() ERC20("World Cup Inu Bet", "WCIBet") 
    {
        initialSupply = 1000000000 * (10**18); // 1 Billion tokens
        maxWallet = initialSupply * 4 / 100; //4% of the supply
