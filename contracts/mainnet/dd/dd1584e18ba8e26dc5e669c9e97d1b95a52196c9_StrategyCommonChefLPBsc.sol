...
contract GasThrottler {
    ...
    address public gasprice = address(0x4aC7fe9229b3F7Fe4d00bFFB5e11dbaf81e1606f);
...
abstract contract FeeManager is StratManager {
    uint constant public STRATEGIST_FEE = 725;
...
contract StrategyCommonChefLP is StratManager, FeeManager {
    ...
    function chargeFees(address callFeeRecipient) internal {
        uint256 toNative = IERC20(output).balanceOf(address(this)).mul(60).div(1000);
    ...
    function callReward() public view returns (uint256) {
        ...
        return nativeOut.mul(60).div(1000).mul(callFee).div(MAX_FEE);
    }
