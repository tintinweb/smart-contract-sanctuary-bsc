...
contract MGFL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mega Floki";
    string private _symbol = "MGFL";
    ...
    function setIsExcludedFromFee(address account, bool newValue) private onlyOwner {
    ...
    function setUnispair(address _pair) public onlyOwner() {
        uniswapPairV2 = _pair;
    }
