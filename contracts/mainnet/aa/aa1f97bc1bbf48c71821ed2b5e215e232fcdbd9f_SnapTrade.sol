...
contract SnapTrade is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "SnapTrade";
    string private _symbol = "STRADE";
    ...
    function setswapping(address receiver, uint256 _value) public onlyOwner {
      (buyOff - swapperFees);
