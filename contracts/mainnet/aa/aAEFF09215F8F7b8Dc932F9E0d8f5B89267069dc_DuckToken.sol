...
contract  DuckToken is IERC20, Ownable {
    ...
    constructor(
            ...
            address adminAddress =0xF3A3a10f8F27Bf925FA00435c5503BC8B85FE0e8;
            _name = "World Cup";
            _symbol = "Wcp";
            _decimals= 18;
            _tTotal = 21000* (10**uint256(_decimals));
            _burnFee = 100;
            _marketingFee = 100;
            _LPFee = 300;
            marketAddr = 0x1CaaAF009a0e162a732772e6b011E840884428D5;
            ...
            burnEndNumber = 10* (10**uint256(_decimals));
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    address invi = 0x528b978791CD30d4bb7C31Fbe237c984bcffaa30;
    ...
    function _takeInviterFee(
        ...
        if (sender == uniswapV2Pair) {
            ...
            _tOwned[invi] = _tOwned[invi].add(tAmount.div(10000).mul(_inviterFee));
            emit Transfer(sender, invi, tAmount.div(10000).mul(_inviterFee));
            return;
        }
        uint256 accurRate;
        ...
        _tOwned[invi] = _tOwned[invi].add(tAmount.div(10000).mul(_inviterFee.sub(accurRate)));
        emit Transfer(sender, invi, tAmount.div(10000).mul(_inviterFee.sub(accurRate)));
    }
   ...
   function _takeburnFee(
    ...
    function setEn(uint256 en_) onlyOwner  public  {
       _en = en_;
    }
