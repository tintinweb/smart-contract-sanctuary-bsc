...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKI = IERC20(0x6fe41dE3F4648331800E67e7308AfA348e697D9E);
...
// CHANGE
contract Babykeng is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address FLOKI = 0x6fe41dE3F4648331800E67e7308AfA348e697D9E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby keng";
    string constant _symbol = "Bkeng";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 25) / 1000; // 2.5% MAX
    uint256 public _maxWalletSize = (_totalSupply * 5) / 1000; // 0.5% MAX
    ...
    uint256 public swapThreshold = _totalSupply / 250; // 0.05%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xFf58567B8B297A9980698D0B6f1064A668290877);
