 ...
 */
contract AstraVerse is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Astra Verse";
    string constant _symbol = "1VERSE";
    ...
    address private devFeeReceiver = 0xD514429518B49a17c9A796CD49aC1B96789DE7A6;
    address private marketingFeeReceiver = 0xD514429518B49a17c9A796CD49aC1B96789DE7A6;
    ...
    function setBuyFees(uint256 marketing, uint256 dev, uint256 rewards, uint256 liquidity) external onlyOwner { // Owner can set buy fees - Maximum allowed is 25%
        require(_tradingEnabled,"Trading not enabled");
