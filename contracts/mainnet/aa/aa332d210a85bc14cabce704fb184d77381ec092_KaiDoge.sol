...
contract KaiDoge is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xf2a5c620A791DCF1E0b237c4e518eceA9BF3d30d);

    string private _name = "KaiDoge";
    string private _symbol = "KaiDoge";
