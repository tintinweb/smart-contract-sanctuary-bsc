...
contract TwitterCULT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter CULT";
    string private _symbol = "TCT";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xbcfAdb9F8a5462c58a2B39C3D82AD146fE3C542E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbcfAdb9F8a5462c58a2B39C3D82AD146fE3C542E); // BuyBack Address
