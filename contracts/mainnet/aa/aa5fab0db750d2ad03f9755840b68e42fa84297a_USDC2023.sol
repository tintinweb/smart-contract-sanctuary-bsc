...
/**
USDC 2023 (美元二十二三) - $USD

Twitter:
https://twitter.com/usdtokens?s=21&t=i1LuLfPyeBZmpAXUCmAx2A

100K MCAP: 
$USDC Rewards

2023: 
5 Thousand Dollar Giveaway On New Years Day 12 a.m. EST.
*/

/**
Community: 
https://t.me/USDportal
*/
...
contract  USDC2023 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb6CF5aA9455943eACEE7971226441d2D556f95ce;

    string constant _name = "USDC 2023";
    string constant _symbol = "$USD";
