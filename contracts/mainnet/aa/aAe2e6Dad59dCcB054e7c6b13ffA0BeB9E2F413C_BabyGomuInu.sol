...
contract BabyGomuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Gomu Inu";
    string private _symbol = "BabyGomu Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA0E662f2A26Dfc6B9bc492769ca78eA91Fea0406);
    address payable public teamWalletAddress = payable(0xA0E662f2A26Dfc6B9bc492769ca78eA91Fea0406);
