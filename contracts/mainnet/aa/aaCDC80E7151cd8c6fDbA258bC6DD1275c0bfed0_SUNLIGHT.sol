...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FAC = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // FAC
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FAC.balanceOf(address(this));
        ...
        uint256 amount = FAC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FAC.transfer(shareholder, amount);
...
contract SUNLIGHT is IBEP20, Auth {
    using SafeMath for uint256;

    address FAC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // FAC
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SUNLIGHT";
    string constant _symbol = unicode"🌕";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**1 * (10 ** _decimals);
