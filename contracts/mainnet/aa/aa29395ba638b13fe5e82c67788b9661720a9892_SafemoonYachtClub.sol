...
// Telegram : https://t.me/SafemoonYachtClubb
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardContract = IBEP20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = rewardContract.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(rewardContract);
        ...
        uint256 amount = rewardContract.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            rewardContract.transfer(shareholder, amount);
...
contract SafemoonYachtClub is IBEP20, Auth {
    using SafeMath for uint256;

    address rewardContract = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Safemoon Yacht Club";
    string constant _symbol = "SAFEMOONYC";
    ...
    function lpToken(bool _status) public onlyOwner {
        swapBaby = _status;
    }
