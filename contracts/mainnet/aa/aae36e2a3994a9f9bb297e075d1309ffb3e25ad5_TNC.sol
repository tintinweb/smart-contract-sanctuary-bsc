...
/**
 *WEBSITE  : https://tokenmarketcaps.com
 *TWITTER  : https://twitter.com/Tokenn_coin
 *TELEGRAM : https://t.me/TNC_project
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xCf811DCFC48e8bc34803f5A3AABfa514ADa4A4cE;
...
contract TNC is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Token MarketCaps"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xCf811DCFC48e8bc34803f5A3AABfa514ADa4A4cE), BNB_Tot);
            }
