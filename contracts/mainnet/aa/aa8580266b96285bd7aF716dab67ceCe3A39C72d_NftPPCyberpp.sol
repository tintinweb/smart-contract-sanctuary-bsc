  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        charAttributes.name,
        '", "caractere":"Male", "clan":"CYBERPP", "description": "PPCARD SEASON3 CYBERPP #',
        Strings.toString(_tokenId),
        '  www.psykotikpanda.com", "image": "',
        charAttributes.imageURI,
        '", "attributes": [ { "trait_type": "caractere", "value": "Male"}, { "trait_type": "defense", "value": ',strPoints,'}, { "trait_type": "attaque", "value": ',strStars,'}, { "display_type" : "max_collection_number", "trait_type": "CollectionMax", "value": ',strMaxCollectionId,'}, {"display_type" : "collection_number", "trait_type": "CollectionID", "value": ',strCollectionId,'} ]}'
      )
    );
