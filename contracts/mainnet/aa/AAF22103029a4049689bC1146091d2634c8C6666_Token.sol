...
// TG:https://t.me/metababydogeking
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Rascal Rabbit";
    string private _symbol = "Rascal Rabbit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xF3Bb08DdD1Bfe2380082B3188c558676B2459c9F);
    address payable public BurnedWalletAddress =
        payable(0xF3Bb08DdD1Bfe2380082B3188c558676B2459c9F);
    address public immutable deadAddress =
        0xBf98397910c31cc36835aCf0EC79c9b344481422;
