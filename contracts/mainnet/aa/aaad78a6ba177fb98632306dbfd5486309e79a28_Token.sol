...
contract  Token is IERC20, Ownable {
    ...
    uint256 public minDistribution = 50 * (10 ** 8); 
    uint256 public minLPDividendToken =  500 * (10 ** 8);
    ...
    constructor(
        ...
        NFTDividerAddr = 0x61e48638753ee62575F47f0E705571967d0F027D;
        ...
        _isExcludedFromFee[pundasAddr] = true;
        _isExcludedFromFee[repoAddr] = true;
        _isExcludedFromFee[NFTDividerAddr] = true;
    ...
    function distributeDividend(address shareholder ,uint256 amount) internal {
        (bool b1, ) = address(this).call(abi.encodeWithSignature("transfer(address,uint256)", shareholder, amount));
    ...
    function _transfer(
        ...
        if(tokenBal>= minLPDividendToken  && !isDividendExempt[from]) {
            processReward(distributorGas,tokenBal); // lp分红
        }
    }
    ...
    function _tokenTransfer(
        ...
        if(takeFee){
            ...
            _takeTransfer(sender,address(this), tAmount,_LPFee);
    ...
    function processReward(uint256 gas,uint256 rewardTokenAmount) public {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (tokenBalance > 0 && !excludeHolder[shareHolder]) {
                amount = rewardTokenAmount * tokenBalance / holdTokenTotal;
                if (amount > 0) {
