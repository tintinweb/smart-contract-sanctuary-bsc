...
contract Critical is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Critical40";
    string private _symbol = "Critical40";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x84da1f001B68E30187f22c2aAa0BC0AFECFa163D); 
    address payable private teamWalletAddress = payable(0x0C54ecEa06CB2Baae40df88a12213e19E1787A11); 
