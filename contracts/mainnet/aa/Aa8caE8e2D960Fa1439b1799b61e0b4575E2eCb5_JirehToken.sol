...
//   Jireh Token brings a real world utility and charity together 
// which will benefit every hodler of the token. Portions of all
// rental properties will be used to buy back and burn tokens, 
// steadily decreasing the circulating supply.  We are out to
// help widows and widowers on fixed income stay in their forever
// homes by making needed repairs along with paying their utilities,
// taxes and insurance for a period of time. Visit https://jirehtoken.com 
// for all the details and to see exactly where our resources are being used.

// Site – https://jirehtoken.com
// Twitter - https://twitter.com/jirehtoken
// Telegram - https://t.me/JirehTokenOfficial
// Owner – Andy Woolard
...
contract JirehToken is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xB12691d2b543ae393325C56746a3C52562a1C588));
    address payable public _devwallet =
        payable(address(0x82e970462119c3000C54550112215D626a6f281b));
    address public _exchangewallet =
        payable(address(0x82e970462119c3000C54550112215D626a6f281b));
    address private _donationAddress =
        payable(address(0x21fa3ed3bC6B6D0cB2A692cF38606fFe87b2Ee27));

    string private _name = "Jireh Token";
