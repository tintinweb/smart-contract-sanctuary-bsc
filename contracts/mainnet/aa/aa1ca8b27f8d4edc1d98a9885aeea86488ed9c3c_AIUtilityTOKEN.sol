...
abstract contract ContextAIUtilityBep20 {
...
contract OwnableAIUtilityBep20 is ContextAIUtilityBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableAIUtilityBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableAIUtilityBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract AIUtilityTOKEN is ContextAIUtilityBep20, AIUtilityBep20, OwnableAIUtilityBep20 {
    ...
    string private _name = 'AI Utility Token';
    string private _symbol = 'AIUT';
