...
// Telegram: https://t.me/GalaxyNFT

// Website: https://galaxynft.app/
...
/* Token contract */
contract GalaxyNFT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2cDbEAf984374b090E4638afdF085c4decC36E45;
    ...
    // Name and symbol
    string constant _name = "GalaxyNFT";
    string constant _symbol = "GX1";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 9000 / 10000; // 90%
    uint256 public _maxSellTxAmount = _totalSupply * 9000 / 10000; // 90% 
    uint256 public _maxWalletToken = ( _totalSupply * 9000 ) / 10000; // 90% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2cDbEAf984374b090E4638afdF085c4decC36E45;
