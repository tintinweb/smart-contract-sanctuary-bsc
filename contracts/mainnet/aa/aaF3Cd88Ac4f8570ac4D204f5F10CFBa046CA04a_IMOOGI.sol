...
contract IMOOGI is Context, IBEP20, Ownable {
  ...
  constructor() {
    ...
    _symbol = "IMO";
    _decimals = 18;
    _totalSupply = 800000000000000000000000000; //100M
...
contract ICO is IMOOGI {
    ...
    uint public saleStart = block.timestamp;  // Démarrage de la IMOOGI
