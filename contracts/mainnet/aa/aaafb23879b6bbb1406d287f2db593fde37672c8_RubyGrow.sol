...
contract RubyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ruby Grow";
    string private constant _symbol = "RUBYGROW";
