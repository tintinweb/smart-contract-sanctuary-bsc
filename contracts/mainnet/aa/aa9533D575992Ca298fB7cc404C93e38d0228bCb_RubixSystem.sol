...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xecCe5Ce5E2715b4646554aB24aE7dd98c21e7102; // owner address
...
contract RubixSystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Rubix System";
    string private _symbol = unicode"RUBIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xecCe5Ce5E2715b4646554aB24aE7dd98c21e7102); // Marketing Address
    address payable public teamWalletAddress = payable(0xecCe5Ce5E2715b4646554aB24aE7dd98c21e7102); // Team Address
