...
contract Chadai is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x698CC624A81027932add74b2CCaAE6C493B5F4b9); // Marketing Address
        
    address payable public teamAddress =
        payable(0x698CC624A81027932add74b2CCaAE6C493B5F4b9); // Team Address

    address payable public liquidityAddress =
        payable(0x698CC624A81027932add74b2CCaAE6C493B5F4b9); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x698CC624A81027932add74b2CCaAE6C493B5F4b9).call{value: bnbForDev}("");
