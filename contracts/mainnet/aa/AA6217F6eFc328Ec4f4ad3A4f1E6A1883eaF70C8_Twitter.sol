...
contract Twitter is Context, IERC20, Ownable {
    ...
    string private _name = "Twitter rocks";
    string private _symbol = "Twitter rocks";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x0962bA56Da7E7F364d2A264e6fB5A96D49a4168a); 
    address payable private teamWalletAddress = payable(0x88e231a0CaC15CAe3efFD825FfaDcd88cad3297f); 
