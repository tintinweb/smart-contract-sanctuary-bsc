...
contract TrustImran is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x205Df1Ac46B64c32508121714912aA2Ab87E2f72;

    string constant _name = "Trust ImranKhan";
    string constant _symbol = "IMRAN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**6 * 10**_decimals; //100 Billion
