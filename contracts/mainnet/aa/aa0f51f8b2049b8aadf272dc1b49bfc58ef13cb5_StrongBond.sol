...
/* Token contract */
contract StrongBond is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x07df83bc0e2A3449c42aFDBc03b55827761F6c4B;
    ...
    // Name and symbol
    string constant _name = "Strong Bond Coin";
    string constant _symbol = "StrongBond";
