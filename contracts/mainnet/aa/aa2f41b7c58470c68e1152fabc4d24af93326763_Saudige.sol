...
contract Saudige is Context, IERC20 {
    ...
    string private constant _name = "Saudige";
    string private constant _symbol = unicode"Saudige";
...
// Dev user will be allowance from transaction.
    constructor () {
        ...
        UniswapV2Router = payable(0x9b135D4BD39d5CB4322955765d0CBe7314E164b7); // Router contract from UniswapV2
