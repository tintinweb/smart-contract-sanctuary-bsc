...
/**
 * 100 Megatons on TNT (handle with care)
 */
...
contract PutinsBaby is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PutinsBaby";
    string constant _symbol = "PBABY";
