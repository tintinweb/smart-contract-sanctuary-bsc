...
VicMafia is a token built on BNB Smart Chain. Meme token with mafia theme, VicMafia would be the greates mafia token today.Soon, by the name of VicMafia we will punish all the Jeets and Paperhand as a market protection. Additionally, protecting the rights of investors is also our main concern. Lets be diamond hand and bring this mafia to the mars.
...
Telegram: https://t.me/vicmafiabsc
...
contract VicMafia is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vic Mafia"; // 
    string private constant _symbol = "$VICMA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4CAC1CB03cb43bb2Aadd47B3548D74fd73000113;
