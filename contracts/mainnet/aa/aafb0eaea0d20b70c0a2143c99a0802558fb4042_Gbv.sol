...
contract Gbv
 is Context, IERC20, Ownable {
    ...
    string private _name = "Gorbachev";
    string private _symbol = "Gorbachev";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1d4b3723F37D9a9d4294199f33C13FD35b8b763f));
        _secondWallet = payable(address(0x1d4b3723F37D9a9d4294199f33C13FD35b8b763f));
