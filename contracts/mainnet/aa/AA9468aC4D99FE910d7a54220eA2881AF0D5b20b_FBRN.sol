...
contract FBRN is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        taxExepmt[0x56c54092cE7294EC81b84De221B08063FdF51b05] = true; // FBN Marketing wallet
        taxExepmt[0xE74A502705737F9DaFACd53e5f69bC7A5ECa277C] = true; // FBN Team wallet
    ...
    {
        uint256 taxAmount = amount.div(feeDenominator).mul(tax);
