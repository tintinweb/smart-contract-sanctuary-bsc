...
Telegram : https://t.me/ApeBinanceGrow
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x272C1D888Be45F5292E5231B15D627da51DAf455;
...
contract APE is Context, IERC20, Ownable {
    ...
    string private constant _name = "APEBINANCE GROW"; // 
    string private constant _symbol = "$BINANCE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x272C1D888Be45F5292E5231B15D627da51DAf455);
