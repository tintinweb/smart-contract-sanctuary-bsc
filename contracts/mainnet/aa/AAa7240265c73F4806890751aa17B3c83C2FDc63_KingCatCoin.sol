...
/**
    STEALTH LAUNCH 16:00 UTC

KING CAT COIN! 

$KCC is a community-driven venture,DeFi Token with valuable mechanism that benefits our investors. A new-created kawaii token will come to our hands and let us experience the this explosive project in Binance Smart Chain ecosystem! This potential token will surely involve, intensify, and blast to the moon! Earn big time, while having fun!
...
🌐WEBSITE: https://kingcatcoin.com/
📈TWITTER:https://twitter.com/KINGCATCOIN
☎️TELEGRAM: https://t.me/KingCatCoin_Official
*/
...
pragma solidity ^0.6.12;
    ...
    contract KingCatCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'King CatCoin';
