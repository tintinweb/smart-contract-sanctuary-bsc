...
/**
 * https://t.me/ApeRocketBSC
 🦍 ApeRocket 🦍

ApeRocket is the new token for you to be a true APE and invest with complete confidence and security!🚀

🚀Launch at 50 members
💰LP: 0.5
✅Healthy community
🧑🏻‍💻Dev Based
...
contract ApeRocketBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeRocketBSC";
    string private constant _symbol = "$AprCkt";
    ...
    address payable public DonationsAddress = payable(0xcD0F849FDf56ED650Eb9EBc3b615cc60Eb234b94);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 0;
    uint256 private liquidityTax = 0;
    uint256 private DonationsTax =  2;
    ...
    address public DonationsWallet = 0xcD0F849FDf56ED650Eb9EBc3b615cc60Eb234b94;
