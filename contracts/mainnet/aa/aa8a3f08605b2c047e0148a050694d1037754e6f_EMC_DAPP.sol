...
contract EMCoin  {
    string  public name = " Easy Mining Coin";
...
contract EMC_DAPP {
    string public name = "Easy Mining Coin Staking App";
      EMCoin public emc  ;
    ...
    constructor(EMCoin tokenaddress) public payable {
        emc  = tokenaddress;
...
function transferOwnership(address newOwner) public  {
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        emc.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        emc.transfer(msg.sender, balance);
    ...
    function customRewards() public {
        ...
        for (uint256 i = 0; i < customStakers.length; i++) {
            ...
            uint256 balance = customStakingBalance[recipient] * defaultAPY;
            balance = balance / 100000;
