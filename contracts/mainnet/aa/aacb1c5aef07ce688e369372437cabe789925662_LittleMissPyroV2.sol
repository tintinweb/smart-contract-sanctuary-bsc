...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x1B7f2572cE1C0B2D14DCEa0623F6db83bc0B4a7a);
...
contract LittleMissPyroV2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LittleMissPyroV2";
    string constant _symbol = "LILMP";
