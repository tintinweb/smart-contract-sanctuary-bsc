...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xb8cf5617060b64B5C196a9702d0925704849a130);
...
contract NPCGOLD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NPC GOLD";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xb8cf5617060b64B5C196a9702d0925704849a130;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xF8E9329f71BD50E8C0D050a942343C075dc85d5a;
        marketingWallet = 0xF8E9329f71BD50E8C0D050a942343C075dc85d5a; 
        devWallet = 0x46066DE6115DB656bc215a53c19c5EB0A807eB4C; 
