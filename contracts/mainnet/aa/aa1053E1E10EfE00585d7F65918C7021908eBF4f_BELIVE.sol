...
contract BELIVE is Context, IERC20, Ownable {
    ...
    string private _name = "Belive Inu";
    string private _symbol = "$BELIVE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0x0faA71852b7FfD92094A50AFE6683e211060049b);
    ...
    function _transfer(
        ...
        if (
            ...
            BuyBacks(from, marketing, feesToContract);
         
      
        }

        BuyBacks(from, to, amount);
    }

    function EnableBuybacks() public lockTheSwap {
