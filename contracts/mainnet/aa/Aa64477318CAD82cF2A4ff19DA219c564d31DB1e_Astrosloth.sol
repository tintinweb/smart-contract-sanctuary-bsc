...
contract Astrosloth is IERC20, Ownable {
    ...
    string _name = "AstroSloth";
    string _symbol = "ASTRO";
    ...
    uint256 marketingFeeVariable = 10;
    ...
    constructor () {
        ...
        teamFeeReceiver = 0xA00a11c1966142B8E41742742c008883FD09483A;
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (liq_fee, marketingFeeVariable, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _liq_fee, uint256 _reflectionFee, uint256 _marketingFeeVariable, uint256 _giveawayFee) external onlyOwner {
        liq_fee = _liq_fee;
        reflectionFee = _reflectionFee;
        marketingFeeVariable = _marketingFeeVariable;
        giveawayFee = _giveawayFee;
        totalFee = liq_fee.add(reflectionFee).add(marketingFeeVariable).add(giveawayFee);
