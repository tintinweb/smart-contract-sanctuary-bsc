...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x858786568Ff16E9eA5Be6B3EAA946fAF52b22b88; // owner address
...
contract RABBITGROW is Context, IERC20, Ownable {
    ...
    string private _symbol = "$RABBITGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x858786568Ff16E9eA5Be6B3EAA946fAF52b22b88); // Marketing Address
    address payable public teamWalletAddress = payable(0xb6c1aC90017E391Bd1dB006c478fF077F87c984F); // Team Address
