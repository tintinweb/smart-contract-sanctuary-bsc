...
contract SquidGrow30 is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3 * 10**13 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**_decimals;
    string private constant _name = "SquidGrow 3.0";
    string private constant _symbol = "SquidGrow 3.0";
