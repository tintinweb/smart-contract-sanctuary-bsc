...
/* Token contract */
contract BRAZILINUGRINGOSADEV is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "BRAZIL";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 250) / 10000; // 2% on launch or 20k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 100) / 10000; // 1% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 250) / 10000; // 2% or 20k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc03840F389c096A49a146F0a0248d77267E1dFaD;
        devFeeReceiver = 0x09AFB289bC9e26581C55AbCB94e6E697C3c26Af0;
