...
// Telegram : https://t.me/andreatateinuportal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C);
...
contract Andrea_tate_inu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Andrea Tate Inu";
    string constant _symbol = "$Andreatateinu";
    ...
    //Mainnet
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xc5c86c5a3aDEEC435fECDD072b61ABC20a5bc847;
        buybackWallet = 0x11ac4D5946411e40516536a5aAe7C14e2921d33D;
