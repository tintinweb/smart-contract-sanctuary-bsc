...
// Telegram : https://t.me/BabyNukeInuBsc
// We are here to support Nuke Inu! Freaking strong community, reward in Nuke tokens!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x008aAd7Dc5229FaBF5AFbc186b002DE9037648fE;
...
contract BabyNukeInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x008aAd7Dc5229FaBF5AFbc186b002DE9037648fE);
    ...
    */
    ...
    string private _name = "Baby Nuke Inu"; 
    string private _symbol = "BabyNuke";  
    ...
    */
    ...
    PURGE RANDOM TOKENS - Add the random token address and a wallet to send them to, If we found any botters or snipers, we wont launch the token hence we going
    to take the liquidity out and thinking for the next launch. Either same name or different one. We just want to have a clean launch, thats it. Stop sniping,
    or else your funds will be lost. We are not responsible for the funds that are lost.
