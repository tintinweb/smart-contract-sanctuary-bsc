...
contract Dragon is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x67A901b5Fd851bc75e6ec0802f22190d88146966;
        _mark = 0x58bA1f422Bdd377CD301F456876f43019e3fd760;
        ...
        _mint(_msgSender(), 50000 * 10 ** decimals());
    }
    ...
    function _swapAndLiquid() private {
        ...
        if (_maxsell > 0 && balances > _maxsell) {
            balances = _maxsell;
            _swapTokenForToken(balances * 2 / 3);
            fistval = IERC20(_fist).balanceOf(address(this));
            if (balances/3 > 0 && fistval/2 > 0) {
                addLiquidity2(balances/3, fistval/2);
            }
        }
    }
