...
TG: https://t.me/OracleAIBSC
Website: https://medium.com/@OracleAI
...
contract OracleAIBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Oracle AI";
    string private _symbol = unicode"$ORCL";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x88d1A41a27F5b33B755807333B9dbAa7a91998d5);
    address payable private taxWallet2 = payable(0x88d1A41a27F5b33B755807333B9dbAa7a91998d5);
