...
/**
High performing BUSD rewards at 5% rate to holders to promote the bottom of BNB.

Hold our locked in BUSD liquidity pool and earn BUSD while holding passively.
...
contract BNBottom is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BNBottom";
    string constant _symbol = "BNBottom";
