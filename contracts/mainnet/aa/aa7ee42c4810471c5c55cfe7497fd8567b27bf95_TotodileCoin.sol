...
contract TotodileCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x0355e9ED56AfA7664837fbe18DB81C35ae2d9f53;
    string constant _name = "TotodileCoin";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit autoBurned(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event autoBurned(uint256 amountBNB, uint256 amountBOG);
}