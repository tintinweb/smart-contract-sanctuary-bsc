...
contract CoinToken is IBEP20, Auth {
    ...
    string constant _name = "ChongDoge";
    string constant _symbol = "ChongDoge";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 907983482597325 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA81E2aA13e856b97AA00C5E04B57B6a16dB08878;
