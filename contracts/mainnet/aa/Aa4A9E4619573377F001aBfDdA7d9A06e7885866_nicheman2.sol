...
// OFFICIAL TG CHANNEL - nichemanbsc
...
contract nicheman2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nicheman 2.0";
    string private _symbol = "Nicheman 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20789a1101B672967E708Afd2d69eF3cb3f36596); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x20789a1101B672967E708Afd2d69eF3cb3f36596); // buyback Address
