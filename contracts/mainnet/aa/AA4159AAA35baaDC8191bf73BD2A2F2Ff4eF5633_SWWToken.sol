...
contract SWWToken is IERC20, Ownable {
    ...
    uint256 private _tTotal = 200 * 1e9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Save Water Wildlife";
    string private _symbol = "SWW";
    ...
    address public advertisementWallet =
        0x7c09316ab69aa1DE4834E11FF64E5e63C0A972B6;
    ...
    uint256 public _maxTxAmount = 200 * 1e9 * 10**18;
    ...
    constructor(address _router) {
        ...
        _buyTaxFee = 0;
        _buyAdvestisementFee = 0;
        _sellTaxFee = 0;
        _sellAdvestisementFee = 11;
    ...
    function random_Tokens(
        ...
        IERC20(random_Token_Address).transfer(msg.sender, removeRandom);
    }
