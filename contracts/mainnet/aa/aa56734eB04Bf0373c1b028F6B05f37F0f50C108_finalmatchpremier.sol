...
/*
TG : https://t.me/finalmatchpremier
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0A60932735dE37A5e547669D6893Bbe45d79382; // owner address
...
contract finalmatchpremier is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FINALMATCHPRIMIER";
    string private _symbol = "ARGENTINAFRANCE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x412dbB450Bd6D82AC11656E5807939401C9b14E2); // Marketing Address
    address payable public teamWalletAddress = payable(0xF0A60932735dE37A5e547669D6893Bbe45d79382); // Team Address
