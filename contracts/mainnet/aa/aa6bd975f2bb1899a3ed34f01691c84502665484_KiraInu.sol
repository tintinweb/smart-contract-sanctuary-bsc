...
contract KiraInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_200_000_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 1_260_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 1_260_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 6_300_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    uint256 private deadline;
    
    address public marketingWallet = 0x5096a138f1022ae5e12c13EfB3170D438E62c9e6;
    address public developmentWallet = 0xd403920bb1c336eb779cE9acdB3DD7CE51877a63;
    address public charityWallet = 0x0104dac327A0405b5EC1ba8344EEbE15553f08E0;
    ...
    Taxes public taxes = Taxes(2, 4, 2, 1, 1);
    Taxes public sellTaxes = Taxes(2, 4, 2, 1, 1);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _charity) public onlyOwner {
       taxes = Taxes(_rfi,_marketing,_liquidity,_development,_charity);
        emit FeesChanged();
    }
