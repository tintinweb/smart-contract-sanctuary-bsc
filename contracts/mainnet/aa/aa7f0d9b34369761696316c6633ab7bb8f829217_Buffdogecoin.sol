...
/**
 ...
 Telegram https://t.me/buffdogecointwo
 
*/

/**

Buff Doge Coin 2.0 [$DOGECOIN] is the Buff version of $DOGE. Buff Doge Coin 2.0 [$DOGECOIN] is extremely hyper deflationary where each burn will double in its quantity to the previous burn. 
The project has a serious mission of rescuing animal shelter and environment such as forest conservation. It is due to the Interconnection of Everything. 
When we destroy nature, it will also destroy human and animals as “We are One”. If we destroy one part, the other part will also get affected. 
We believe that the most important mission in this lifetime is to live in harmony with all sorts of life - human beings, animals and nature. 
Whatever you destroy outside yourself, you destroy within yourself. Thus, some of the developer’s profit will be donated to rescue animal shelter and environment.”
...
contract Buffdogecoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa8F837BB0b9ab146D89Cf994EF666F40FbC59ffB); 
    address payable public Wallet_Dev = payable(0xa8F837BB0b9ab146D89Cf994EF666F40FbC59ffB);
    ...
    string private constant _name = "Buff Dogecoin 2.0"; 
    ...
    uint256 private Percent_Burn = 10;
    ...
    constructor () {
        ...
        _owner = 0xCdBc1f868053E02f27f972b458e14d93447163C3;
