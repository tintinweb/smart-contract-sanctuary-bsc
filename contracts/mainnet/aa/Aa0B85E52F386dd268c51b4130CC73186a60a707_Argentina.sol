...
contract Argentina is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x931BF2bbB013303460A439Aac12582Ad58b403DC); 
    address payable private teamWalletAddress = payable(0x931BF2bbB013303460A439Aac12582Ad58b403DC); 
    ...
    uint256 private _totalSupply = 6900 * 10**6* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 6900 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 6900 * 10**6 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6900 * 10**6* 10**_decimals; 
