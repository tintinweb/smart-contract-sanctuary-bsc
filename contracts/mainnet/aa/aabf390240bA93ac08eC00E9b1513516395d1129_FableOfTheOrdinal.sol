...
TG: https://t.me/FableOfTheOrdinal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x955A389C2b5FE92E422c57D9e95a4AE683AAdB2A; // owner address
...
contract FableOfTheOrdinal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Fable Of The Ordinal";
    string private _symbol = unicode"$FOTO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x955A389C2b5FE92E422c57D9e95a4AE683AAdB2A); // Marketing Address
    address payable public teamWalletAddress = payable(0x955A389C2b5FE92E422c57D9e95a4AE683AAdB2A); // Team Address
