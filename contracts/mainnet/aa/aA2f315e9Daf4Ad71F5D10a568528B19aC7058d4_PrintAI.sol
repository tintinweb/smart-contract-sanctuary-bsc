...
contract PrintAI is IERC20, Context, Ownable {
    ...
    string private constant _name = "PrintAI";

    uint256 private __Max_BuySze = 20000000 * 10**9;
    uint256 private __Max_SellSze = 20000000 * 10**9;

    address private __Marketing_Wallet = 0x3E7a4c5C779B6de9fBf05790F0D842337440296d;
    address private __Team_Wallet = 0x3E7a4c5C779B6de9fBf05790F0D842337440296d;

    uint256 private __max_WalletSze = 20000000  * 10**9;
    ...
    Taxes public taxes = Taxes(0, 25, 5, 0);
