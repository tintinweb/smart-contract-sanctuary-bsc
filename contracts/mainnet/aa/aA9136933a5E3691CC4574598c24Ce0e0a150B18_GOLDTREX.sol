...
contract GOLDTREX  is BEP20Detailed {

    constructor(address receiver, uint8 decimal_) BEP20Detailed ("GOLDTREX", "GOLDTREX", decimal_) {
            _mint(receiver, 500000000000 * (10 ** decimal_));
        }
