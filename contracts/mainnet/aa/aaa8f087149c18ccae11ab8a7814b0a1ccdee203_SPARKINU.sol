...
contract SPARKINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SPARK INU";
    ...
    address private marketingWallet = address(0x8a3e13f1E9954Bb3fa54c1969bf9Ebd2248c12de);
