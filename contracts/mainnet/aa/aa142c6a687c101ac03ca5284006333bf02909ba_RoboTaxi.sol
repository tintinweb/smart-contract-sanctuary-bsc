...
/*
Telegram: https://t.me/RoboTaxiOfficial
*/
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMath: division bfy zero");
    }
...
contract RoboTaxi is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x449F3Eb22F00bE12f5ABad38e55f36a8Fbca4C52); // Marketing Address
        
    address payable public teamAddress =
        payable(0x2095CDbf7C0526056f1D7fA495C710ee5d8afb7d); // Team Address
        
    address payable public liquidityAddress =
        payable(0x449F3Eb22F00bE12f5ABad38e55f36a8Fbca4C52); // Liquidity Address
            ...
            if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to]) {
                    ...
                    require(amount + balanceOf(to) <= maxWallet, "Max wallet exceeded.");
                         if (!isMarketMaker[from] && !isMarketMaker[to]) {
                            if(block.timestamp < tradingActiveBlock + 10 seconds){
    ...
    function setisMarketMaker(address account, bool exempt) external onlyOwner {
        isMarketMaker[account] = exempt;
    }
