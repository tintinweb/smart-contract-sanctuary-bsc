...
/**
 Telegram : https://t.me/SpookyInu_Portal
*/
...
contract Spookyinu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = ( _tTotal * 5 ) / 100; // 3%

    uint256 public _maxWalletToken = ( _tTotal * 5 ) / 100; // 4%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "Spooky Inu"; // 
    string private constant _symbol = "SPOOKYINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0DFb18104277e083d06a1B9fdb17C0ee1c1719a8;
