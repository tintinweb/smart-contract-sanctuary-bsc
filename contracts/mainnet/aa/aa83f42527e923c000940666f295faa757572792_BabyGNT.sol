...
contract BabyGNT is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGNT";
    string private _symbol = "BabyGNT";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8f06A47492Ecb301EC0B168f280f9D2096f2CcE1); // Marketing Address
