...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1503Ea791FC746c5D48Cf549D0a6de573D84049A; // owner address
...
contract KingCupCR7 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " King Cup CR7 ";
    string private _symbol = " $KCCR7 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1503Ea791FC746c5D48Cf549D0a6de573D84049A); // Marketing Address
    address payable public teamWalletAddress = payable(0x1503Ea791FC746c5D48Cf549D0a6de573D84049A); // Team Address
