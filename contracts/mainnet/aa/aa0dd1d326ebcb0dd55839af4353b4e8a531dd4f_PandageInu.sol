...
contract PandageInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PandageInu";
    string private _symbol = "PInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x852a9b4fEAA940FD180E3e4b944E69aEDb8C946E); // Marketing Address
    address payable public teamWalletAddress = payable(0x6fB5f661E671c07726e99bF56Fac39289BEe6912); // Team Address
