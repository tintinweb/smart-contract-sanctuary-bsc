...
TG: https://t.me/khabysock

KHABYSOCK was collaboration Khaby and elon tweets,that runs on Binance Smart Chain network.

🔥dev last project hit 100k MC
🔒 LP Locked 
🟢 Owner Renounced
✅ Verified Contract
💰 Low MCap
...
contract KHABYSOCK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x754028915363F2df1192FBA63C08794De131580B); 
    address payable public Wallet_Dev = payable(0x754028915363F2df1192FBA63C08794De131580B);
    ...
    string private constant _name = "KhabySock"; 
    string private constant _symbol = unicode"KHABYSOCK"; 
    ...
    constructor () {
        ...
        _owner = 0xD0e7aEc2d120EEcf6f70Ed0937E3855626aa66F1;
