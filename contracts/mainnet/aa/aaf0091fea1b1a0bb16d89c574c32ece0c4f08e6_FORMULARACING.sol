...
contract FORMULARACING is ERC20, Ownable {
        ...
        ERC20("FORMULA RACING", "F1")
    {
        ...
        // 30% each
        mktwallet = address(0x31630871A8021DFf77d30e3ba920c2Aa0A9FAa91);
        partnerwallet = address(0x037795f49E11Ad0AB907763aA3fdA0c5f2661bA8);
        rewardwallet = address(0xabf840eC1b048Ce91Ce24Da3e277829BF9c6966e);
        // 10% for treasure
        treasurewallet = address(0x09f90C241Dec6116C3d13dAf50978D20D86e30C3);
        ...
        // _isExcludedFromFees[treasurewallet] = true;
    ...
    function claimStuckBNB() external onlyOwner {
        sendBNB(payable(mktwallet), address(this).balance);
    }
        ...
        onlyOwner
    {
        ...
        partnerwallet = _pnwallet;
        rewardwallet = _rwwallet;
        treasurewallet = _tswallet;
    }
    ...
    function _transfer(
        ...
        emit EventTransfer(from, to, amount, fees);
    }
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 bl_d_30 = newBalance * 30 / 100;
        uint256 bl_d_10 = newBalance - bl_d_30 * 3;

        sendBNB(payable(mktwallet), bl_d_30);
        sendBNB(payable(partnerwallet), bl_d_30);
        sendBNB(payable(rewardwallet), bl_d_30);

        sendBNB(payable(treasurewallet), bl_d_10);
