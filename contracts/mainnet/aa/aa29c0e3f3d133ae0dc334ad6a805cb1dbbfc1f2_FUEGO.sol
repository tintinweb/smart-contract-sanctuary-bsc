...
contract FUEGO is IBEP20, Auth {
    ...
    string constant _name = "FUEGO";
    string constant _symbol = "$FUEGO";
    ...
    uint256 public swapThreshold = _totalSupply * 61 / 10000;
    bool inSwap;
    ...
    function burnSnipers(address[] memory sniperAddresses) external authorized {
