...
contract OinkSatoshi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oink Satoshi";
    string private _symbol = "Oink Satoshi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x181234d4D3B9261C0052310ecD61De0fafa27e08);
    address payable public teamWalletAddress = payable(0x181234d4D3B9261C0052310ecD61De0fafa27e08);
