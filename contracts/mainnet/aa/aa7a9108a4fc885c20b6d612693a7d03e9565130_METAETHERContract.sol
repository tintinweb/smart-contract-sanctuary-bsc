...
// METAETHER is the currency that rewards holders with passive income (8% of daily volume as a form of ETHEREUM will be distributed to holders depending on their shares)
// As we are aiming to use the token to pay for our services that will be available along our way (Gaming , NTF Marketplace)
...
contract METAETHERContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public marketingFeeReceiver = 0x8825cE2757D5798ee3e9C0571eeB3F05fbe97627; 
