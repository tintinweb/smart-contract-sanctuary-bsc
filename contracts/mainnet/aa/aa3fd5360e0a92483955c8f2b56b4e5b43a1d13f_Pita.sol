...
contract Pita is IERC20 {
    ...
    string constant private _name = "Pita";
    string constant private _symbol = "Pita";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x000000000000000000000000000000000000dEaD)
    });
...
//===============================================================================================================
    ...
    function getTokenAmountAtPriceImpact(uint256 priceImpactInHundreds) external view returns (uint256) {
        return(((balanceOf(lpPair) * priceImpactInHundreds) / masterTaxDivisor) / 10**_decimals);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 marketingBalance = (amtBalance * _ratios.marketing) / _ratios.totalSwap;
        ...
        bool success;
        uint256 _marketingBalance = marketingBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: _marketingBalance, gas: 35000}("");
        }
    }
    ...
    function takeTaxes(address from, address to, uint256 tAmount, bool takeFee, bool buy, bool sell, bool ttax) internal returns (ExtraValues memory) {
