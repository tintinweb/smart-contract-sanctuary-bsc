...
contract Pamphui is Context, IERC20, Ownable {
    ...
    string private constant _name = "PampHui"; // 
    string private constant _symbol = " $PAMPHUI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x69D9E56A5fEDb6C5855262195b0E481204EEB12A;
