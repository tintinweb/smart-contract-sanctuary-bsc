...
contract CMGAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHRISTMAS GIFT APE";
    string private _symbol = "CMGAPE";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xD9786e83AB3cF24af354ED367B658573F4b84E0f); // Marketing Address
    address payable public BuyBackWallet = payable(0xD9786e83AB3cF24af354ED367B658573F4b84E0f); // Team Address
    ...
    uint256 public _maxTxAmount = _totalSupply.div(28); 
    uint256 public _walletMax = _totalSupply.div(28);
