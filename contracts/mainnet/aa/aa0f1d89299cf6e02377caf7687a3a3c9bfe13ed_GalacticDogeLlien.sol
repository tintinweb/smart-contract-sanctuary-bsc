...
// Telegram: https://t.me/GalacticDogeLien
...
contract GalacticDogeLlien is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Galactic DogeLlien";
    string private _symbol = "$GDL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC4eb52F83Ee6d5EEaE69a3FFf2ccc0fF657831B1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9b59F55cBB5796927E7739310c0f80f1bB5219C8); // Team Address
