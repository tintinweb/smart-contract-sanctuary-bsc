...
contract BabyBookSHib is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'BabyBookShib';
    string private constant _symbol = 'BabyBookShib';
    ...
    uint256 public swapThreshold = ( _tTotal * 700 ) / 100000; // .30% of total supply
