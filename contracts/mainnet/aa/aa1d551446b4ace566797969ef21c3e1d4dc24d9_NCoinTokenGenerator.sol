...
contract NCoinTokenGenerator is Context, IERC20, Ownable {
    ...
    function setMaxTxAmount(uint256 maxTxAmountPercent) external onlyOwner() {
        require(maxTxAmountPercent >= 1, "Set Max TX between 1% - 100% of total supply");
        _maxTxAmount = _totalSupply*maxTxAmountPercent/100;
    }
    ...
    function setWalletLimit(uint256 newLimitPercent) external onlyOwner {
        require(newLimitPercent >= 1, "Set Max Wallet between 1% - 100% of total supply");
