...
contract LockToken is Ownable {
    ...
    function openTrade(bool _trueorfalse) external onlyOwner {
        isOpen = _trueorfalse;
    }
...
contract Cloudpet is Context, IERC20, Ownable, LockToken {
    ...
    string private _name = "CloudPet Test";
    string private _symbol = "CPETest";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xf6a896281545301d6e19C3f429df9A42d53A8F36);
    ...
    uint256 public minimumTokensBeforeSwap = 200 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForLiquidity = contractTokenBalance.mul(_saleLiquidityFee).div(_saleLiquidityFee.add(_saleMarketingFee));
