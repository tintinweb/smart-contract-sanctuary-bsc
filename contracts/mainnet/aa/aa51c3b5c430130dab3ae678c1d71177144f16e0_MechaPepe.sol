...
contract MechaPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MechaPepe";
    string private _symbol = "$MEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0eD4122f07Fd6f190f36DD479F539580D58bCBE6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0eD4122f07Fd6f190f36DD479F539580D58bCBE6); // BuyBack Address
