...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5967b9154DC2024E202B38B6bF91A4d03bF6F3f0;
...
contract NEAN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA2AC3dA7143e022914ad46eA69BEe3c66F7EB52E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NEAN";
    string private _symbol = "$NEAN";
