...
The WUNA team is excited to announce the inception of our decentralized exchange built on 
the binance smart blockchain. The WUNA platform will allow users to swap, earn and build 
...
WUNA ($WUNA) will be stealth launched on Wednesday the 8th of March 2023, the launch 
time will be at random, and there was no IDO or private sale for $WUNA, therefore, all tokens 
will be readily available to buy on market. The $WUNA token has a 1% tax to the liquidity pool. 

That is all for now, expect us to be live soon.

Telegram: https://t.me/WUNABSC
*/
...
contract WUNA is Context, ibep20, Ownable {
    ...
    string private _name = 'WUNA Token';
    string private _symbol = 'WUNA';
