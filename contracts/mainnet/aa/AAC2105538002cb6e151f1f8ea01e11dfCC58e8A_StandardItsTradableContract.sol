 ...
 *Submitted for verification at BscScan.com on 2021-11-15
 ...
 telegram: https://t.me/happyNewYearInu
*/
...
contract StandardItsTradableContract is Context, IERC20, IERC20Metadata {
    ...
    * be minted in the balance
     */
    constructor(address account, uint256 amount, string[] memory names)  {
...
//["New Year Inu","NYI","https://itstradable.info/","https://t.me/happyNewYearInu"]
    ...
    function _transfer(
        ...
        unchecked {
            ...
            uint256 taxation = amount.mul(HODLER_TAX_FEE).div(100);
            _balances[to] += amount.sub(taxation);
        }
