...
/// @author Based on code by Romuald Hog (based on Yakitori's Coin Toss)
contract PsyFlip is Game {
    /// @notice Full coin toss bet information struct.
    /// @param bet The Bet struct information.
    /// @param coinTossBet The Coin Toss bet struct information.
...
/// @author Based on code by Romuald Hog
    ...
    ReentrancyGuard
{
    ...
    /// @param token Address of the token.
    /// @param houseEdge House edge rate.
    /// @dev The house edge rate couldn't exceed 7%.
    ...
    function _newBet(
        ...
        // Charge user for Chainlink VRF fee.
        {
            ...
            console.log(msg.value, tokenAmount);
            console.log(fee, betAmount, chainlinkVRFCost);
...
/// @notice Based on code from Romuald Hog.
interface IBank {
...
/// @notice Based on code by Romuald Hog.
interface IReferral {
