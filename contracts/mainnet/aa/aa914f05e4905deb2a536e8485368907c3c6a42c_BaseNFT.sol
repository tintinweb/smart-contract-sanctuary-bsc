 ...
 */
contract BaseNFT is AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable {
     ...
     * See {ERC721-tokenURI}.
     */
    function initialize(string memory name, string memory symbol, uint256 hardCap, string memory baseTokenURI, address owner) public initializer {
    ...
    function mint(address to) public virtual {
        ...
        require(_tokenIdTracker.current() < cap, "Mint exceeds hard cap");
    ...
    function mintMany(uint256 amount, address to) public {
        for (uint i = 0; i < amount; i++) {
            mint(to);
        }
    }

    function mintManyIndexes(IVaultToken vault, uint256 amount, address to) public {
        ...
        vault.mintTo(tokenIds, amounts, to);
    }
