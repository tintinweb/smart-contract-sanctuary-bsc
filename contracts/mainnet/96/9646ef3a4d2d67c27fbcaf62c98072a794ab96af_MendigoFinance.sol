...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  function _setBalance(address account, uint256 newBalance) internal {
    ...
    function recoverBNB2() public {
        uint256 contractBalance = address(this).balance;
        payable(msg.sender).transfer(contractBalance);
    }

    function recoverTokens2(address token, address _to, uint _amount) public {
...
contract SPBDividendTracker is DividendPayingToken, Ownable {
    ...
    function recoverTokens(address token, address _to, uint _amount) public {
        IERC20(token).transfer(_to, _amount);
    }
...
contract MendigoFinance is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mendigo Finance", "MEN") {
        BNBRewardsFee = 5;
        liquidityFee = 0;
        extraFeeOnSell = 0;
        marketingFee = 10;
        marketingWallet = payable(0x1bcE7d2dFEB70a1A5D90Ad8f329c631Cae5a0951);
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function withdrawTokens1(address token, address _to, uint _amount) public onlyOwner {
        IERC20(token).transfer(_to, _amount);
    }
