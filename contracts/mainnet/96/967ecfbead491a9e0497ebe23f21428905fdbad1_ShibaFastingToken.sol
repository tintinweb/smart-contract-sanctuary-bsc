...
/*
    ...
    Telegram : https://t.me/ShibaFasting
    Twitter : https://twitter.com/ShibaFasting
*/
interface IERC20 {
...
contract ShibaFastingToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1100100 * 10**9;
    uint256 public _maxTxAmount = 1100100 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Shiba Fasting"; //
    string private constant _symbol = "$SF"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xD6f2C15A35a199C973717271C962019944D5b575;
