...
contract MetaNayuki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " MetaNayuki ";
    string private _symbol = " MetaNayuki ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x448A07b77273D947f624aEA9a21975D589E9Ba1C);
    address payable public teamWalletAddress = payable(0x057129053BcA5c8513Df5a30cBA22a139Bc65FCD);
