...
contract NFT is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function updateSubscription(uint256 tokenId, uint256 price, uint256 subsLength)
        external
    ...
    function addFounderIfPossible(address addr) public onlyAdmin {
    ...
    function addToTree(address rootAddress, address newUser) public onlyAdmin {
    ...
    function setWeekTurnover(uint256 _weekTurnover) public onlyAdmin {
    ...
    function distributeProfits(address sponsor, uint256 amount)
        public
        onlyAdmin
    {
