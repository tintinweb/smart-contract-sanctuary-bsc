...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "NOLP";
    string private _symbol = "NOLP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe9465453f81d2C3596E50256f0022075Af72a809); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe9465453f81d2C3596E50256f0022075Af72a809); // BuyBack Address
