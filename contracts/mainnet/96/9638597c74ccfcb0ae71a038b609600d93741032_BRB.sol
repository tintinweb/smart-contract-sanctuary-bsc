...
contract BRB is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x79C7534b62B34602660A4dE2416ecD5c4398c1DC;
    ...
    constructor() public ERC20("Black Rabbit TEST", "BRBT") {
    ...
    function swapAndSendDividends(uint256 tokens) private {
     ...
     function calculateFee() private {
        ...
        if(numWBNB >= 300 * (10**18) && numWBNB < 800 * (10**18)){
        ...
        if(numWBNB >= 800 * (10**18) && numWBNB < 1600 * (10**18)){
         ...
         if(numWBNB >= 1600 * (10**18) && numWBNB < 5000 * (10**18)){
          ...
          if(numWBNB >= 5000 * (10**18)){

            _ETHRewardsFee = 0;
            _MarketingFee = 0;
            _BurnFee = 0;
            _TotalFees = _ETHRewardsFee.add(_MarketingFee).add(_BurnFee);//0%
