...
contract FifaWorldCup1930 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Fifa World Cup 1930 ";
    string private _symbol = " FWC1930 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA1b233447FBE4a5b97efDd15D7558fD3Cd02C6B7);
    address payable public teamWalletAddress = payable(0xA1b233447FBE4a5b97efDd15D7558fD3Cd02C6B7);
    ...
    uint256 private _totalSupply = 193000000 * 10**_decimals;
    uint256 public _maxTxAmount = 3860000 * 10**_decimals; 
    uint256 public _walletMax = 3860000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 965000 * 10**_decimals; 
