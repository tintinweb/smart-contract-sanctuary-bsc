...
contract INRD_StakePool_5 is Ownable,ReentrancyGuard {
    ...
    uint256 public poolNumber = 5;
    uint256 public poolMinStake = 100;
    uint256 public poolMaxStake = 25000000;
    uint256 public poolRewardPercent = 19;
    uint256 public earlyPenalty = 30;
    uint256 public fullMaturityTime = 365 days; 
    uint256 public totaldays = 365;
