...
contract TestNummer4 is Context, IERC20, Ownable {
    ...
    string private _name = "TestNummer4";
    string private _symbol = "TEST4";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 1e7 * 1e9;
    ...
    constructor() {
        marketWallet = payable(0x80FDc8147D3ec616093E636913a9E0bBD9E1a439);
        devWallet = payable(0x56787Bc8E6263683Eb2B557b42AD447705940934);
