...
contract TESTDividendDistributor is IDividendDistributor {
    ...
    bool initialized = false; // unnecessary as all booleans are initialised to false;
...
contract TEST is IBEP20, Auth {
    ...
    */
    ...
    TESTDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new TESTDividendDistributor(address(router));
    ...
    function setDistributor(TESTDividendDistributor dist)external authorized {
        distributor = dist;
    }
