...
contract SpaceZTZ  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        if (form !=pair && to !=pair && to == panckepair && form !=panckepair ){
            require( amount <= balanceOf(panckepair).mul(10).div(100));
        }
