...
/**
STEALTH LAUNCH 
TG: https://t.me/BabyTigeInuPortal
TAX: 
BUY : 10% 
SELL: 10%
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TIGEINU = IBEP20(0x91e75EeC2580EC52298080F144824652850F4243);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TIGEINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(TIGEINU);
        ...
        uint256 amount = TIGEINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TIGEINU.transfer(shareholder, amount);
...
contract BabyTigeInu is IBEP20, Auth {
    ...
    address TIGEINU = 0x91e75EeC2580EC52298080F144824652850F4243;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
