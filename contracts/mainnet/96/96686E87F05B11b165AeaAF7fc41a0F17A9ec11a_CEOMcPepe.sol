...
Meet McPepe - a successful rags to riches Degen who started from the bottom working at McD and now a wallstreet hustler. 

Telegram: https://t.me/CeoMcPepe
...
contract CEOMcPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CEO McPepe";
    string private _symbol = unicode"$MCPEPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x805a8BFD52d54013827D9CFC9C480825f76e98C9);
    address payable private taxWallet2 = payable(0x805a8BFD52d54013827D9CFC9C480825f76e98C9);
