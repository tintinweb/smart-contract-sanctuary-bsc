...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x22BACE28549eFFc8E0ff0e5a219FF428D0e85b90;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x22BACE28549eFFc8E0ff0e5a219FF428D0e85b90),//fund 

        address(0x22BACE28549eFFc8E0ff0e5a219FF428D0e85b90)//dev 
    ){
