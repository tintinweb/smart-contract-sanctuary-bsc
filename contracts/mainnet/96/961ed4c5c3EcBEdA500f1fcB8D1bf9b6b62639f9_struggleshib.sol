...
contract struggleshib is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "struggle shib";
    string private _symbol = "SGSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9CB650a984005DE086036058BD7E842731A00cc6);
