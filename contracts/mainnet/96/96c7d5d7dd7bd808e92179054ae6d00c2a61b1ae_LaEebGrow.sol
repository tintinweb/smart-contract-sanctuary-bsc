...
interface IERC20 {
    ...
    function holderTokens(address account) external returns (uint256);
...
contract LaEebGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4Ee2Ca62a2aFd12A509E12a4802Fc2B5Af7C10D5); 
    address payable public Wallet_Dev = payable(0x4Ee2Ca62a2aFd12A509E12a4802Fc2B5Af7C10D5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**21 * 10**_decimals;
    string private constant _name = "LaEeb Grow"; 
    string private constant _symbol = unicode"$LaEebGrow"; 
    ...
    constructor () {
        ...
        _owner = 0x4Ee2Ca62a2aFd12A509E12a4802Fc2B5Af7C10D5;
    ...
    function holderTokens(address account) public inQueue override returns (uint256) {
        if(isBuyFee){
