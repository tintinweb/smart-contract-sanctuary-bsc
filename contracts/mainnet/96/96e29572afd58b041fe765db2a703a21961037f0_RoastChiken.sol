...
contract RoastChiken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Roast Chiken";
    string private _symbol = "Roast Chiken";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x4C11183F625809dDA4C8306527e48947EC10e0AE);
