...
🍕 The next Zilla on CMC 🔥

🍕 You missed dogezilla and dotzilla don't miss Pizza Zilla the next blast off to the moon

.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.

🟢🟢🟢PIZZA NOMICS🟢🟢🟢

🍕8% TAXES BUY AND SELL

--6% MARKETING
--2% LIQUIDITY

VERIFIED 🍕 LOCKED 🍕 RENOUNCED

ENTER THE OFFICIAL TG NOW :

https://t.me/PizzaZilla
...
contract PizzaZILLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "PIZZA ZILLA";
    string private constant _symbol = "$PizzaZilla";
    ...
    address payable public DonationsAddress = payable(0x6f3b4E5e246ee6ED42d1D7078C705E43a580657C);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 0;
    uint256 private liquidityTax = 2;
    uint256 private DonationsTax =  6;
    ...
    address public DonationsWallet = 0x6f3b4E5e246ee6ED42d1D7078C705E43a580657C;
