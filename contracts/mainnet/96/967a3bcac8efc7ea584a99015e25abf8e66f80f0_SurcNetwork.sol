...
Surc network bring in faster and reliable Technologies (Blockchain, Metaverse, NFT) with our 
best skills and a keen understanding of the role of technology in business.
Surc Network is a High end-level of solution enabling the equitable and decentralized 
DeFi applications, powered by the community itself.
A new financial system, a new future and a new generation for decentralized finance.
We aim to create a strong and transparent community that will be part of the company.
...
contract SurcNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "SurcNetwork"; 
    string private constant _symbol = "SRN"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x31f33F359AC9dB48CE9AC55cacFAD45Ab98dF9bf;
