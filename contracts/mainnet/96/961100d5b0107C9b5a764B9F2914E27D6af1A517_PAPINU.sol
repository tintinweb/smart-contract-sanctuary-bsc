...
// 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/PaprikaInu
// 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/paprikainu
...
contract PAPINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PAPINUDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Paprika Inu", "PAPINU") {
        UtilityWallet = payable(0xEc5592B2CcA4c04efBe00004fEE3E6E66Be06707);
        DevelopmentWallet = payable(0x49690C2ac2f6a3c1ED04E5c5679144aFC245fa94);
        ...
        dividendTracker = new PAPINUDividendTracker(
            payable(this),
            router,
...
contract PAPINUDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        PAPINUContract = PAPINU(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PAPINU_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PAPINU_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PAPINU contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PAPINUContract);

            uint256 prevBalance = PAPINUContract.balanceOf(address(this));
            ...
            {
                uint256 received = PAPINUContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PAPINUContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
