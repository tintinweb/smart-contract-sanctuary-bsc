...
contract rush is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gold Rush";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x46B1A90Fb439935ea1a8f379c7e5c0b20f46bE92);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = 21000000 * 10**9;
        _maxWalletSize = 21000000 * 10**9;
        tradingOpen = true;
