...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x542717977F101842C358EEBEF9793bcB0772AdCf;
...
contract AuraOfBSC is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Aura Of BSC"; 
    string private constant _symbol = unicode"Aura Of BSC"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x542717977F101842C358EEBEF9793bcB0772AdCf), BNB_Tot);
            }
