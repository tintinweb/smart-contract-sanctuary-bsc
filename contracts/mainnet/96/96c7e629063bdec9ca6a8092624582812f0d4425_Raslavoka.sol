...
/**
Ras Lavoka 🥑🇲🇦❤️ #dimamaghrib
🥑 Ras lavoka FAN TOKEN 🥑
✅ Low Marketcap Gem
❇️ NFA DYOR
...
contract Raslavoka is RaslavokaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RaslavokaTeam;
    address private CharityRaslavoka;
    ...
    string public override name = "Ras lavoka";
    string public override symbol = "Raslavoka";
    ...
    constructor(uint totalSupplyValue, address RaslavokaTeamAddress, address CharityRaslavokaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RaslavokaTeam = RaslavokaTeamAddress;
        CharityRaslavoka = CharityRaslavokaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RaslavokaTeam] =  totalSupply * 4 / 100;
        balances[CharityRaslavoka] = totalSupply * 4 / 100;
