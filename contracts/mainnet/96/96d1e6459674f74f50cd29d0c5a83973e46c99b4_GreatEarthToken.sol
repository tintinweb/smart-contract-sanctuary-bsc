...
// Visit us on www.GreatEarthToken.com
...
contract GreatEarthToken is ERC20, Ownable {
    ...
    GreatEarthTokenDividendTracker public dividendTracker;
    ...
    uint256 public buytreasuryFee = 2;
    ...
    constructor() ERC20("GreatEarthToken", "GET") {
        dividendTracker = new GreatEarthTokenDividendTracker();

        teamWallet = 0xc20701d05C61c92A18a3202a160C7Df49cD28998;
        treasurywallet = 0x46fbC04EB8bDD91Bd9Be129F49936F6B1E363B34;
        marketingWallet = 0x8e9e5dE30f05d835E5E111e8f56F1A98A1A3791f;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "ERC20: The dividend tracker already has that address"
        );

        GreatEarthTokenDividendTracker newDividendTracker = GreatEarthTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "ERC20: The new dividend tracker must be owned by the ERC20 token contract"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ERC20: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "ERC20: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "ERC20: Cannot update gasForProcessing to same value"
        );
...
contract GreatEarthTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("ERC20_Dividend_Tracker", "ERC20_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ERC20 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "ERC20_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "ERC20_Dividend_Tracker: Cannot update claimWait to same value"
        );
