...
/**
 $SHERLOCK is a rug-proof deflationary BEP20 token on the Binance Smart Chain.
The more $SHERLOCK you hold, the more tokens you will earn. So it creates an ecosystem that encourages investor to hold their tokens and enjoy the rewards.
 https://t.me/SherlockInu
 Twitter: https://twitter.com/sherlockinu
 Website: https://sherlockinu.com
*/
...
contract SherlockInu is IERC20, Ownable {
    ...
    string _name = "Sherlock Inu";
    string _symbol = "SHERLOCK";
    ...
    constructor () {
        ...
        address marketingreceiver = 0xca2e523841983Bd5b9F17b6A613Dcfd001fFc99A;
