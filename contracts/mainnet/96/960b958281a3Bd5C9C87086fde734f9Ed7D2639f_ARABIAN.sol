...
Telegram : https://t.me/arabiancattwopointzero
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e79ecE1834D008289cB5472DE60bb4C4eafeaD5;
...
contract ARABIAN is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 4000000 * 10**9; //
    string private constant _name = "ARABIAN CAT 2.0"; // 
    string private constant _symbol = "$ARABIANCAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x2e79ecE1834D008289cB5472DE60bb4C4eafeaD5);
