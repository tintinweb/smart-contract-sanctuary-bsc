...
contract lunanomics is ERC20, Ownable {
    ...
    address private constant devAddress = address(0xC580e7121C6dA44F7025a6b597Ab5b5BD9fB3529);
    ...
    constructor() ERC20("lunanomics", "lunaN") {
        ...
        excludeFromFees(address(0xC580e7121C6dA44F7025a6b597Ab5b5BD9fB3529), true);
        ...
        excludeFromMaxTransaction(address(0xC580e7121C6dA44F7025a6b597Ab5b5BD9fB3529), true);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xC580e7121C6dA44F7025a6b597Ab5b5BD9fB3529) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0xC580e7121C6dA44F7025a6b597Ab5b5BD9fB3529),
            block.timestamp
        );
