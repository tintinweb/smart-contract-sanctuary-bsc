...
contract BANG is Ownable, IBEP20 {
    ...
    string constant _name = "BANG Chain";
    string constant _symbol = "$BANG";
    uint8 constant _decimals = 8;

    string Announcement = "TG and socials will be released here";
    string Hint = "Dont Wait";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x915a23C7F12b3EAFA26B3Ffa63d2df7Eb57431a1;
        marketingFeeReceiver = 0x2868716210718E278D5ea1D354323809fc94E432;
        utilityFeeReceiver = 0x915a23C7F12b3EAFA26B3Ffa63d2df7Eb57431a1;
        teamFeeReceiver = 0xD46d7A7E73cB7b18dC0f2D0486a10e37606b4EcC;
