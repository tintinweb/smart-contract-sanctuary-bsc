...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0xaa0Faeb54a2F613D66feC3567a335cD5900aCA84] = true;
...
contract ShunGon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "ShunGon";    
    string private constant _symbol = "SHUNGON";
    ...
    uint256 public mStx = ( _totalSupply * 300 ) / 10000;
