...
contract TDXP is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 100 * 10**8 * (10**10);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x4c772975B93C3df6F31910F38CeC89fa58cA0499); // Team Wallet
    address public _projectWalletAddress = address(0x4c772975B93C3df6F31910F38CeC89fa58cA0499); //Project Wallet
    ...
    constructor() ERC20("The Dex Protocol", "TDXP") {
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "TDXP: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TDXP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TDXP: Automated market maker pair is already set to that value");
