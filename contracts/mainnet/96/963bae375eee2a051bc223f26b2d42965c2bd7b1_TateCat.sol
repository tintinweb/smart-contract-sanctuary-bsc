...
contract TateCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TateCat";
    string private _symbol ="TCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x988176E06DCD08Db322bae764C769Ede3876e7cB);
    address payable public teamWalletAddress = payable(0x988176E06DCD08Db322bae764C769Ede3876e7cB);
