...
contract ConnectOmega is Ownable, ERC20Permit {
    using SafeMath for uint256;
    uint256 public maxSupply = 1000000000e9;
    bool public minted = false;
    address public alfaMatrix;

    constructor(address _matrix) ERC20('Connect Omega', 'cOMA', 9) ERC20Permit('Connect Omega') {
        alfaMatrix = _matrix;
    }
    ...
    function setMatrixAddress(address _address) external onlyOwner {
    ...
    function _transferFrom(
        ...
        IAlfaMatrix(alfaMatrix).transInvites(recipient, sender, amount);
        return true;
    }
