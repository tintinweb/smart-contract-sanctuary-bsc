...
contract WhiteListSale is Ownable{
    ...
    function init(
        ...
        preToken = 20000 * 10 ** 18;
     
        minContribe = 1 * 10**15; //1bnb
        maxContribe = 1 * 10**16; // 1bnb
     
     
        softHardBnb = 1 * 10 ** 15; //軟頂1 bnb 
        totalBnb = 1 * 10 ** 16; //300 bnb
    ...
    function doContribute() public payable {
        ...
        //充值金额不能小于0.2
        require(buyAmount >=0.001 ether, "single minimum 0.2.");

        require(buyAmount % 0.001 ether == 0, "only multiples of 0.1.");
