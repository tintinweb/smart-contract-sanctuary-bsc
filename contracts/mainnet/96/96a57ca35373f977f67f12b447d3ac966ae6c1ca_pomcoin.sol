...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x762884eEd72d58B0b0bFd3336506293640eB7911;
...
contract pomcoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2b05908D809683A1F18C4efeFEfc3eCabe9529F7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "POMCOIN";
    string private _symbol = "POMC";
