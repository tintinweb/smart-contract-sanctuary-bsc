...
contract TOKENS is Context, IERC20, Ownable {
    ...
    string private _name = "Saleceshi";
    string private _symbol = "Saleceshi";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public botblock = 1;
    ...
    function setBotBlock(uint num) public onlyOwner {
        botblock = num;
    }
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    if (block.number <= launchedBlock + botblock) {                  
                        addBot(recipient);
                    }
                }
