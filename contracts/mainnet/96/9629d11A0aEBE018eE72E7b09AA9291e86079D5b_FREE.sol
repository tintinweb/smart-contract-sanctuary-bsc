...
contract FREE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000 * 10**0 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "FREE";
    ...
    uint256 public _maxTxAmount = 100 * 10**0 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**0 * 10**9;
