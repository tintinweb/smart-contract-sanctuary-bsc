...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x343eDa5977E6632944b5a5E8ab2dF1B25F25AA6d;
...
contract MemePets is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2b84e24447e067b25b13C28429A8738D4882b127;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MemePets";
    string private _symbol = "MPets";
