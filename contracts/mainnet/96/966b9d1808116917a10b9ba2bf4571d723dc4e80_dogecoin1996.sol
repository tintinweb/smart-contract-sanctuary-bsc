...
contract dogecoin1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"dogecoin1996";
    string private _symbol = unicode"doge96";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xc854feB55a3Ebf94DA06705B4f032844a82Bb65A); 
    address payable public BurnedWalletAddress = payable(0xc854feB55a3Ebf94DA06705B4f032844a82Bb65A); 
    ...
    uint256 public _walletMax = _totalSupply * 2 / 30; 
