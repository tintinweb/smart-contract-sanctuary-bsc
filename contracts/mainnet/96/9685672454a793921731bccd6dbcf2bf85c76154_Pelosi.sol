...
contract Pelosi is Context, IERC20, Ownable {
    ...
    string private _name = "China is 1";
    string private _symbol = "China is 1";
    ...
    address payable private marketingWalletAddress = payable(0xB72A0E5bdbBC239C393bB594dDAa0E043c7A024e);
