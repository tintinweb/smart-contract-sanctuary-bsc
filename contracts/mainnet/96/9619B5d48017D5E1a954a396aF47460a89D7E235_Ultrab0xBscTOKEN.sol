...
// File: Ultrab0x/bsc/Ultrab0xBscTOKEN.sol
...
contract Ultrab0xBscTOKEN is BEP20("Ultrab0x Bsc NFT TOKEN", "b0xBSC_TOKEN") {

    uint256 public MAX_SUPPLY = 11112000000000000000000;

    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Ultrab0xBscNFT).
