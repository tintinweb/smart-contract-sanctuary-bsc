...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Do Kwon";
    string private _symbol = unicode"Do Kwon";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xca4d6e4f893A20e299E31E3Ec07BF0C977C1A83F); 
    address payable public BurnedWalletAddress = payable(0xca4d6e4f893A20e299E31E3Ec07BF0C977C1A83F); 
