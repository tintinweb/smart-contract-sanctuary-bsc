...
contract ELONPLAYLEAGUE is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000000_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "Elon Play league";
    string private _symbol = "EPL";
    ...
    address public burnAddress = 0x123d1271B64d061Ef9f128f96CB8288CA85F643d;
    address payable private _marketingWallet = payable(0xe8E0F2CeFad05b1A4F1CCee520Aede806D74213A);
    address payable private _devWallet = payable(0x3D7c6a27FF2017f458f5CbF17675a253bb204FeE);
    ...
    uint256 private maxTxPercent = 50; // Less fields to edit
