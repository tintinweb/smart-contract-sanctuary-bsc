...
* SincereWeed *
A community driven project with one goal in mind... to climb the beanstalk all the way to the moon!

- Telegram: https://t.me/Sincereweed
...
contract SincereWeed is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereWeed";
    string private _symbol = "SWeed";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2eD4d743B3e40E5756A60e2FDE2BA44D8F222ecB);
    address payable public teamWalletAddress = payable(0x2eD4d743B3e40E5756A60e2FDE2BA44D8F222ecB);
