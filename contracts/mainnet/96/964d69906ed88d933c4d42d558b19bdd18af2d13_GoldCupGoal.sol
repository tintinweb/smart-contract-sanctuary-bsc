...
contract GoldCupGoal is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldCupGoal";
    string private constant _symbol = "GCG";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x5e3aFdE05c3d71f710967C80f27Dd307B4efa4a4);
    address payable private _marketingAddress = payable(0x1f6Ac30E18E3026E418fDb8ae6A6E43ED45d0E4b);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 8, "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 8, "Redis cannot be more than 10.");
