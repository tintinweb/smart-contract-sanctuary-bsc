...
contract DK is DKDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private DKTeam;
    address private CharityDK;
    ...
    string public override name = "Dogs Kombat";
    string public override symbol = "DK";
    ...
    constructor(uint totalSupplyValue, address DKTeamAddress, address CharityDKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        DKTeam = DKTeamAddress;
        CharityDK = CharityDKAddress;
       
        // split the tokens according to agreed upon percentages
        balances[DKTeam] =  totalSupply * 4 / 100;
        balances[CharityDK] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's DKTeam pot
