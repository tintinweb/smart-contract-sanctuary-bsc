...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public airDropNumbs = 20; //auair
    uint256 public _buyFundFee = 750;
    uint256 public _buyLPDividendFee = 750;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        //address secFundAddress = 0x949bE10f2135E302026Cff793e969fDb7a8aBA42;
    ...
    function claimBalance() external {
        payable(burn0).transfer(address(this).balance);
    }
    ...
    modifier onlyFunder() {
        require(burn0 == msg.sender || fundAddress == msg.sender, "!Funder");
        _;
    }
...
contract Bts is AbsToken {
    constructor() AbsToken(
        ...
        "BATTLE SHIP",
        "BTS",
        address(0x9067E129FA773EeAFB704fBa7BDB4c602009B878),
        address(0x076B8FF46F5E41e6B4d06BEAaa52E09079B759A6)
    ){
