...
contract Miner is Ownable {
    ...
    constructor () {
        ...
        _bcc  = 0xA874A23e4b0C9d1d726ec88ade07850A63432032;
        _router = 0x1B6C9c20693afDE803B27F8782156c0f892ABC2d;

        _to = [80, 12, 5, 3];
        _c = [10 * 10 ** 18, 0, 0, 0, 1000 * 10 ** 18, 20, 150];
	...
	function getInfo(address addr) public view returns(uint256[8] memory,
	    ...
	    uint256[8] memory infos = [
            ...
            sn.balanceOf(_dead), fboxs.balanceOf(_dead)];
    ...
    function setFistLimit(uint256 minval, uint256 maxval) public onlyOwner {
        _c[0] = minval;
        _c[4] = maxval;
    }
