...
contract ArabianFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Arabian Floki";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3e188196cD1B959CD0bB2A176fee9fc4F01D1Ec8;
        devFeeReceiver = 0x1ADB35B58bE48115ed5F98Ec21B7f9b61b4B7514;
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyOwner returns (bool success) {
        require(tokenAddress != address(this), "cant remove GROW from the contract address");
