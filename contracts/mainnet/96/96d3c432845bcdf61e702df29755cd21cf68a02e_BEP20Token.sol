...
contract TransfertTokenAndPercentageToTargetAddress{
    ...
    // pay 1% of all transactions to marketing address
    address payable target = 0x471019a7c1bb0d539FD44E3705d783B5B2375936;

    // state variables for token to track balances and to test
    ...
    // goes to the marketing address specified above
    function transfer(address _to, uint amount) public {

        // calculate the share of tokens for your marketing address
        ...
        // add the share to the marketing address
