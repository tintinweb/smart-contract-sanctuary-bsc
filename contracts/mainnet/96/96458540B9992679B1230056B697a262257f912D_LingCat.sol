...
contract LingCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ling Cat";
    string private _symbol = "LCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F541e910bEDFC393E3b60E71C7f67d602D7bd04);
