...
/* 
🐃$BUETH 🐃The Bull Ether 🐃
🐃WHAT'S BUETH?
🐃$BUETH is a new cryptocurrency token on Binance Smart Chain 
🐃with the goal of becoming one of the biggest community driven of Identity KYC Dapp Known as 🐃"EStripe"🐃

🐃With the recent surge in Ethereum's price, we believe eth will soon have one of the best years for explosive growth it has experienced in a while. $BUETH will be a token that follows that trajectory, bringing  the idea of digital identity to NFTS memes and community along with it. 

🐃$BUETH IS NOT JUST ANOTHER MEMECOIN, HOWEVER.

🐃Clues and hints on what we're building will be teased on our Twitter as the days progress.
🐃$BUETH  WILL MAKE HISTORY.

#WAGMI #BULLETH #EStripe #BSC #Gem #Moonshoot #Lowbsc

🐃Telegram https://t.me/BUETHTOKEN
presale phase 2 🔥in 24 hours🔥https://forms.gle/a7k9Ff7W13Fyg2fy5
...
contract TheBullEther is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'The Bull Ether';
    string private _symbol = 'BUETH';
