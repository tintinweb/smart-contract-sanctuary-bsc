...
contract BRich is BEP20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    uint256 public maxTransactionAmount = 20000 * (10**9) * (10**18); //2%
    ...
    uint256 public _SellBNBRewardsFee = 12;
    ...
    uint256 public maxWalletToken = 20000 * (10**9) * (10**18); //2%
