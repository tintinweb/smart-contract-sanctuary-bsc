...
contract CQ is ERC20 {
	...
	address public WHT = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    constructor(address tokenOwner) ERC20("CQ", "CQ") {
        ...
        _approve(address(this), address(ROUTER), total.mul(1000));
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			_takeInviterFee(from, to, amount);//9
