...
contract OSKDAO is ERC20, Ownable {
    using SafeMath for uint256;

    string private name_ = "OSKDAO";
    string private symbol_ = "OSKDAO";
    ...
    uint256 public maxHolderAmount = 100 * 10 ** 18;

    address public rewardToken = 0x55d398326f99059fF775485246999027B3197955;
    uint256 private tokenBalanceForReward_ = 10 * 10**18;

    address public _marketingWalletAddress = 0xc40a65C2460d0f7763ef958339CcB7F9D5ccF19c;
