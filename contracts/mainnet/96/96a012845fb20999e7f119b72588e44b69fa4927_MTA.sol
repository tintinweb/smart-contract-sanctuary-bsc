...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90C3aD9ca017c61106d0ba967e1eD87dcA3F8736; // owner address
...
contract MTA is Context, IERC20, Ownable {
    ...
    string private _name = "META ARABIAN";
    string private _symbol = "MTA$";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaA98B0aAA4204d9caf48da41bdD53ba75eA9c4Fb); // Marketing Address
    address payable public teamWalletAddress = payable(0x3BCFB8275f9AE54c00ba5eC1202FD3DDCC344143); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10_000_000_000 * 10**_decimals; 
