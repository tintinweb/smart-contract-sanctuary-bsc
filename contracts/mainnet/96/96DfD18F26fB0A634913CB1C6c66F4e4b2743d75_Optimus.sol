...
contract Optimus is ERC20, Auth {
    ...
    string constant private _name = "Optimus";
    string constant private _symbol = "Optimus";
    ...
    address private marketingFeeReceiver = 0x72067C1c4608ae8765a9Fb0E24947dC5159310b5;
    address private stakingFeeReceiver = 0x72067C1c4608ae8765a9Fb0E24947dC5159310b5;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!isFeeExempt[sender] && !isFeeExempt[recipient]){
            require(tradingEnabled,"Once open trading, cannot pause trading");
        }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _balances[sender] = _balances[sender].sub(amount, "Insufficient of Balance");
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount > _totalSupply / 2000000, "No limit trading");
        _maxTxAmount = amount;
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        ...
        require (feeDenominator >= 100, "Limited, protect investor");
    ...
    function setAutomatedMarketMakerPair(address _pair, bool _value) public onlyOwner {
            ...
            if(_value){
                ...
                require(_markerPairs.length > 1, "At least 1 pair");
