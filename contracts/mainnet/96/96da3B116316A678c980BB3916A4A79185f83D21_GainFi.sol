...
contract GainFi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV     = 0x1E8e24dDeB810a47D137F085DA31c5374A401f28;
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _marketingFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy     = _liquidityFeeBuy;
        buybackFeeBuy       = _buybackFeeBuy;
        reflectionFeeBuy    = 5;
        marketingFeeBuy     = _marketingFeeBuy;
        devFeeBuy           = 1;
        totalFeeBuy         = _liquidityFeeBuy.add(_buybackFeeBuy).add(reflectionFeeBuy).add(_marketingFeeBuy).add(devFeeBuy);
        feeDenominator      = _feeDenominator;
        require(totalFeeBuy < feeDenominator/5, "Fees cannot be more than 20%");
    }

    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _marketingFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell    = _liquidityFeeSell;
        buybackFeeSell      = _buybackFeeSell;
        reflectionFeeSell   = 5;
        marketingFeeSell    = _marketingFeeSell;
        devFeeSell          = 1;
        totalFeeSell        = _liquidityFeeSell.add(_buybackFeeSell).add(reflectionFeeSell).add(_marketingFeeSell).add(devFeeSell);
        feeDenominator      = _feeDenominator;
