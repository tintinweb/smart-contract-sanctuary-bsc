...
https://t.me/LemogeInu

WELCOME TO LEMOGE INU!!!

LEMOGE BEING ONE OF THE MOST PRAISED ANIMALS OF THE ZUN DYNASTY!!!

WE LOVE THE NEW TRENDS AND ARE PREPARED TO MAKE THE NEXT MOONSHOT! 
...
contract LEMOGEINU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Lemoge Inu';
    string private constant _symbol = 'LemogeInu';
    ...
    bool swapping; 
    bool botOn = true;
    uint256 swapThreshold = ( _totalSupply * 652 ) / 100000;
