...
// XBOMB is the coolest bar in town. You come in with some Reward, and leave with more! The longer you stay, the more Reward you get.
//
// This contract handles swapping to and from xReward, AMMSwap's staking token.
contract XSCAKE is ERC20("XSCAKE", "XSCAKE"){
    using SafeMath for uint256;
