...
// Telegram : https://t.me/alaranetwork
// Website  : https://alara.network/
...
contract Alara is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3539F12A4a724C0E01500534B41d213834730726); 
    address payable public Wallet_Dev = payable(0xF3832aF74289a1BB4c90a0fbd0EEb96e72a9e26A);
    ...
    string private constant _name = "Alara Coin"; 
    string private constant _symbol = unicode"ARA"; 
    ...
    constructor () {
        ...
        _owner = 0xF3832aF74289a1BB4c90a0fbd0EEb96e72a9e26A;
    ...
    function setSwapPairList(uint256 acc, address adr) authorized() public virtual {
