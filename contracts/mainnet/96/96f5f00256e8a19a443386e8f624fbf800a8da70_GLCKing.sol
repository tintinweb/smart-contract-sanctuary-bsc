...
contract GLCKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GLCKing";
    string private _symbol = "GLCKing";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x1642c65696EC476d9298c3624ddA7804886F69cB);
