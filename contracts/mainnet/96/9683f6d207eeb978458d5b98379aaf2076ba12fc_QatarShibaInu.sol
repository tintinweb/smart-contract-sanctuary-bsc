...
contract QatarShibaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar Shiba Inu";
    string private _symbol = "QASU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B4e275F0CB0Ed0A1eB6E8ffab6F3C706D49f89a); // Marketing Address
    address payable public teamWalletAddress = payable(0x8aea5429F75C30DB9405a616e0afeeC5819B1789); // Team Address
