...
contract WTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "9/11 Token";
    string private _symbol = unicode"WTC";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x29acB1196a9e66D8fB1d1F6DF15F64976141717E); 
    ...
    uint256 public _buyDevelopmentFee = 9;
 
    uint256 public _sellLiquidityFee;
    uint256 public _sellDevelopmentFee = 11;
