...
contract AirDrop {
    ...
    address private tokenAddr = 0x8961E477802b922aDb909Af7c80f25445de507Ea;  
      IERC20 public token;
    ...
    function buyToken() public payable{
        ...
        uint256 tokensValue = 50000 * (msg.value / INVEST_MIN_AMOUNT);
   ...
   function getContractBalance() public view returns (uint256) {
    ...
    function claim() public payable {
       ...
       token.safeTransfer(msg.sender, 5000); 
