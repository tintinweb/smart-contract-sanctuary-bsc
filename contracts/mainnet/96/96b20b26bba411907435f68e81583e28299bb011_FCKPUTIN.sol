...
contract FCKPUTIN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7FC47323c206cF12BeE9F953A85508A5ea791C43;
    address public donationWallet = 0x3a6B6905C225800d50216E87B6b309201B4e1a86;

    string private constant _name = "FCKPUTIN";
    string private constant _symbol = "FCKP";
    ...
    Taxes public taxes = Taxes(2, 7, 2, 2);
    Taxes public sellTaxes = Taxes(2, 9, 2, 4);
