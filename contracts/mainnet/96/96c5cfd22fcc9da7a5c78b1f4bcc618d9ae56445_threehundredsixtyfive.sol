...
contract threehundredsixtyfive is IBEP20, Auth {
    ...
    string constant _name = "365";
    string constant _symbol = "365";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 365 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 1000;  // .1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 250) / 1000;  // .1% max wallet
    ...
    address private marketingFeeReceiver = 0xF90Ed6e220B6ED8B846F613b70D3353673824E70;
    address private teamFeeReceiver = 0xF90Ed6e220B6ED8B846F613b70D3353673824E70;
