...
abstract contract Auth {
    ...
    /**
     * Check if address SaviorOfFrance is owner
     */
...
contract MarijuanaDrink is IBEP20, Auth {
    ...
    string constant _name = "Marijuana Drink";
    string constant _symbol = "MJD";
    ...
    address private marketingFeeReceiver = 0x3eCA891433fE5413BCD446e9DfBb2FCb9592Efe4;
    address private developmentFeeReceiver = 0x6FF1d326105BAC5EDEe67cf8DD012EAC05ab28c1;
    ...
    function changeTax(uint256 _liquidityFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function maxWalletAddress(address account, bool newValue) public onlyOwner {
