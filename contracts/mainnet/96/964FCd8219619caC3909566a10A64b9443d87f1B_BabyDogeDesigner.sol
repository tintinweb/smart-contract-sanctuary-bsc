...
contract BabyDogeDesigner is Context, IBEP20, Ownable {
    ...
    uint256 private maxS = 100000000000 * 10 ** 18;
    ...
    uint256 private WalletM = 100000000000 * 10 ** 18;
    ...
    */
    ...
    constructor(address Tokencontract, address payable airdropWalletS) {
        _name = "BabyDogeDesigner";
        _symbol = "BabyDogeDesigner";
        _decimals = 18;
