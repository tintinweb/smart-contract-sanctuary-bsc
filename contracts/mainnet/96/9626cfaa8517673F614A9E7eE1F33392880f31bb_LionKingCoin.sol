...
contract LionKingCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lion King Coin"; //
    string private constant _symbol = "LKC"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x84192AeEeEB0D039a52F8F388133eFf1feEdbbBd ;
