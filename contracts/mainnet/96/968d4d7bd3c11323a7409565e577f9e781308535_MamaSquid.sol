...
/**
    我们的目标是成为最伟大的社区代币之一，为我们的持有者提供最佳优势和长期发展。
    只需购买并持有，您将获得很多利润。

    https://t.me/MamaSquid
*/
...
contract MamaSquid is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mama Squid";
    string private _symbol = "Mama Squid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB61BF76A9466aef4F6F5C65657979dD7D7037d92); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xB61BF76A9466aef4F6F5C65657979dD7D7037d92); // Development Address
