...
contract SpaceSnake05 is IBEP20, Auth {
    ...
    string constant _name = "Space Snake 0.5";
    string constant _symbol = "SpaceSnake05";
...
event AutoLiquify(uint256 amountBNB, uint256 amountSS);
