...
contract JAY is IERC20, Ownable {
    ...
    address private fundAddress = address(0x6dCD5A17f62B5932A1aB2Bb08f0dD0e166849f43);
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                require(balanceOf(from).sub(amount)>=1*10**11,"sell error");
            }
            takeFee = true;
            ...
            if (from!=uniswapV2Pair && isRoute[from]){
                ...
                if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                    require(balanceOf(from).sub(amount)>=1*10**11,"tran error");
                }
                takeFee = false;
            }
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                _takeTransfer(
                    sender,
                    address(0x7715316adB6A96C9378A0491F57E2F55D0fAa51e),
                ...
                _takeTransfer(
                    sender,
                    address(0xB0e28Ed67dB339cC9d936694D727a5f609c32fF4),
                ...
                _takeTransfer(
                    sender,
                    address(0x6dCD5A17f62B5932A1aB2Bb08f0dD0e166849f43),
                ...
                _takeTransfer(
                    sender,
                    address(0x9B531595AD9F407B9A52188EA0f3b35DE368EB99),
                    tAmount.div(1000).mul(_fundFee.mul(multiple)),
                    currentRate
                );
                ...
                _takeTransfer(
                    sender,
                    address(0xA5d1Cdb7554ed8c9d48aCbe61796B87B6961DaFE),
                    tAmount.div(1000).mul(_taxFee.mul(multiple)),
                    currentRate
                );
