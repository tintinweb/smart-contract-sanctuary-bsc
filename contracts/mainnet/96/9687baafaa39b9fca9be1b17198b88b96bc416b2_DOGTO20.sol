...
contract DOGTO20 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DOGTO 2.0";
    string private _symbol = "DGT2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xdf2D9AF75c6fcC443Adc49e792e0DdDDf7f0Fa45);
    address payable public liqWalletAddress = payable(0xdf2D9AF75c6fcC443Adc49e792e0DdDDf7f0Fa45);
    ...
    uint256 public _walletMax =     8888888  * 10**_decimals;
