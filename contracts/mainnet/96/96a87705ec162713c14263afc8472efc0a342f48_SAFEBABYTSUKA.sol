...
// 
//
// 📱 Telegram:https::https://t.me/+GHghEyoabXA5MGM1
...
contract SAFEBABYTSUKA is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SAFEBABY TSUKA", "SAFEBABYTSUKA") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SAFEBABYTSUKA";
    string private _symbol = "SAFEBABYTSUKA";
