        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                if (sellLeagueFee > 0) {
                    ...
                    _takeTransfer(_mainPair, address(leagueAddress), sellLeagueFee);
                }
                if (sellNodeFee > 0) {
                ...
                if (buyLeagueFee > 0) {
                    ...
                    _takeTransfer(_mainPair, address(leagueAddress), buyLeagueFee);
                }
                if (buyNodeFee > 0) {
                ...
                if (buyDividendFee > 0) {
                    ...
                    if(flag){
                        _fffController.addLevelDividend(buyDividendFee);
                    }
                }
            }
        }
