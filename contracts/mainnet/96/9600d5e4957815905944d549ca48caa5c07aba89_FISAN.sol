...
contract FISAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA SANTA";
    string private _symbol = "FISAN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xD820B7De2Da02825477Bedb6a78088A7f702dA71); // Marketing Address PF
    address payable public BuyBackWallet = payable(0xD820B7De2Da02825477Bedb6a78088A7f702dA71); // Team Address
