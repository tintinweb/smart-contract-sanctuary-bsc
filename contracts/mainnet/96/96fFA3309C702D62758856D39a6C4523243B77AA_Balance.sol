...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5227958153e7788903Cac6daf53d958991c70fE6;
...
contract Balance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4ED704ecFa8E4A901670021a409fe8a4e0F7bCFa;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Balance";
    string private _symbol = "BLNC";
