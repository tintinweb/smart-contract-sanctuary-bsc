...
contract BASIVIA_Farm {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.4 ether; // 0.4 bnb
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(90, 10)); // 90 days 1.5% daily // 135%
        plans.push(Plan(45, 10)); // 45 days 1.5% daily // 67.5%
