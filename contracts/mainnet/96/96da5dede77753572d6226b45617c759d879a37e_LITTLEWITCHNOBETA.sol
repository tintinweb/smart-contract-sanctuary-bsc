...
Little Witch Nobeta is an anime action game built on the BSC where players can play to earn.

Limited edition NFT area coming soon!
...
contract LITTLEWITCHNOBETA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Little Witch Nobeta";
    string private _symbol = "LWN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81F86cc3aC3425CE7F0145b9cFf033F251a6AD8d); 
    address payable public teamWalletAddress = payable(0x0Ec84025F906712c6bE0a095705EDc0f79ec7f1C); 
