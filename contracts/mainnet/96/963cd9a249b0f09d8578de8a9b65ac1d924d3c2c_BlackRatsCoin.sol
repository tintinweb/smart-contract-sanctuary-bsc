...
//Telegram : https://t.me/blackratscoin
...
contract BlackRatsCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xFF8670069017E292a01b90ff35BBC10a4b4DFaB7));
    address payable private devWallet =
        payable(address(0x1e713F3eF6E9D1C4f1Fc002Ab41024037b7C50E7));
    address private liquidityReceiver =
        0x1e713F3eF6E9D1C4f1Fc002Ab41024037b7C50E7;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "BlackRatsCoin";
    string private _symbol = "BLACKRATS";
    ...
    uint256 private numTokensSellToAddToLiquidity = 4000000000 * 10**9;
