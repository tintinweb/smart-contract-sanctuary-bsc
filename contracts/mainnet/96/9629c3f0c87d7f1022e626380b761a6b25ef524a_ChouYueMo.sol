...
contract ChouYueMo is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "ChouYueMo";
    string constant _symbol = "CYM";
	...
	function cburnToken(address account, uint256 amounts) internal {
	...
	function TionTaxFee(uint256 _amount) private view returns (uint256) {
		  return (_amount * _totalSupply) / (
			  10**2
		  );
		}

    function yEnabled(bool _status, uint8 _interval) public onlyOwner {
        cooldownEnabled = _status;
        cooldownTimerInterval = _interval;
    }

    function mclearStuck(uint256 amountPercentage) external onlyOwner {
