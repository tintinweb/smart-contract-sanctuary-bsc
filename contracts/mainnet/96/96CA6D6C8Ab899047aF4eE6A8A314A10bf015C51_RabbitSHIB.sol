...
contract RabbitSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RabbitSHIB";
    string private _symbol = "RabbitSHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x6be2ecdBa1A7fb04bfD0Bc92B34ADf0bd6003E23); 
    address payable private teamWalletAddress = payable(0x6b914cD8113A1B0cDf985b2433087070dEf45A98); 
