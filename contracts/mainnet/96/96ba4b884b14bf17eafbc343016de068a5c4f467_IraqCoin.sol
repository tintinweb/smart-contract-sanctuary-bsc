...
contract IraqCoin is Context, IERC20, AuthOwnerShip{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "IraqCoin";
    string private _symbol = "IraqCoin";
    ...
    function takeIraqCoinetting(address sender, uint256 amount) internal returns (uint256) {
	...
	function AutoIraqCoinCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
	...
	function getIraqCoinFees(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
