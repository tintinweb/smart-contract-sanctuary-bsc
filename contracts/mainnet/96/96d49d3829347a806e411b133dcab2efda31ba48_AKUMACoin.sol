...
contract AKUMACoin is AKUMADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private AKUMATeam;
    address private CharityAKUMA;
    ...
    string public override name = "Akuma World";
    string public override symbol = "AKUMA";
    ...
    constructor(uint totalSupplyValue, address AKUMATeamAddress, address CharityAKUMAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        AKUMATeam = AKUMATeamAddress;
        CharityAKUMA = CharityAKUMAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[AKUMATeam] =  totalSupply * 4 / 100;
        balances[CharityAKUMA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's AKUMATeam pot
