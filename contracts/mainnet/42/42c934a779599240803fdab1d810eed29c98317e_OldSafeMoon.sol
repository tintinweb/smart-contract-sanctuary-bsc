...
contract OldSafeMoon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Old Safemoon";
    string private _symbol = unicode"$oSFM";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9134e2850cde97cEa43D0410Eb5729d668FAbc4a);
    address payable private taxWallet2 = payable(0x9134e2850cde97cEa43D0410Eb5729d668FAbc4a);
