...
Telegram : https://t.me/babyratbsc
...
contract BabyRat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdF3e3E32fB808160D844061316B86dabCF6737F4); 
    address payable public Wallet_Dev = payable(0xdF3e3E32fB808160D844061316B86dabCF6737F4);
    ...
    string private constant _name = "Baby Rat"; 
    string private constant _symbol = unicode"BYRAT"; 
    ...
    uint256 public Tax_on_Lrat = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Tax_on_Brat = 0;             
    ...
    constructor () {
        ...
        _owner = 0xdF3e3E32fB808160D844061316B86dabCF6737F4;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Tax_on_Brat / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Tax_on_Lrat / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Tax_on_Lrat + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Tax_on_Lrat + Percent_Marketing + Percent_Dev);
