...
/**
Telegram : https://t.me/DOGEHELL_Bsc
*/
...
contract DOGEHELL is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGEHELL";
    string private constant _symbol = "DOGEHELL";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;

    uint256 public _maxWalletAmount = _tTotal.mul(3).div(10**2);
    uint256 public _maxTxAmount = _tTotal.mul(3).div(10**2);
    ...
    address private marketingWallet = address(0x1390B9cC55c3E7e349834679F407cd0DA83d591a);
    address private liquidityReceiver = address(0x1390B9cC55c3E7e349834679F407cd0DA83d591a);
