...
TG: https://t.me/ShrimpDogeOfficial
*/
...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`newShrimpDogeOwner`).
...
contract ShrimpDoge_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShrimpDoge";
