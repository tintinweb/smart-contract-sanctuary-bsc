...
contract TomiokaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tomioka Inu";
    string private _symbol = "TOMIOKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe6b890EA0DF898E8ad944a5e816fD772d84a1a82); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe6b890EA0DF898E8ad944a5e816fD772d84a1a82); // buyback Address
