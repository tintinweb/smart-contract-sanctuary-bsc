...
Tg:https://t.me/Adakingb _%10 Ada Rewards 
...
contract ChernobylRewardsDividentTracker  is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract ChernobylNPP is ERC20, Ownable, BaseToken {
    ...
    ChernobylRewardsDividentTracker  public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = ChernobylRewardsDividentTracker (
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ChernobylRewardsDividentTracker  newDividendTracker = ChernobylRewardsDividentTracker (
            payable(newAddress)
        );
