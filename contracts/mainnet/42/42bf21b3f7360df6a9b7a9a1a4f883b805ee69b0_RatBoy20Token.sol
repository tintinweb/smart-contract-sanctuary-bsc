...
/*
    Telegram    : https://t.me/RatBoy20
    Twitter     : https://twitter.com/RatBoy20
    Website     : https://ratboy20.io/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x499732E03f6F94de94F1D77C0288D07678f8F0e0; // owner address
...
contract RatBoy20Token is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rat Boy 2.0";
    string private _symbol = "$WENTXN2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x499732E03f6F94de94F1D77C0288D07678f8F0e0); // Marketing Address
    address payable public teamWalletAddress = payable(0x499732E03f6F94de94F1D77C0288D07678f8F0e0); // Team Address
