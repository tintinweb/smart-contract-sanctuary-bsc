...
contract POSfuel is Context, IERC20, Ownable {
    ...
    string private _name = "POSfuel";
    string private _symbol = "POSfuel";
    ...
    uint256 public _tranFee = 2;
	
	uint256 public _removeFee = 2;
	
	// fee list end
	address public ownerAddress = 0x52F65701Ee29A690C3C35Ef3E991B2386646013A;
    
	address public address1 = 0x52F65701Ee29A690C3C35Ef3E991B2386646013A;

    address public address2 = 0x52F65701Ee29A690C3C35Ef3E991B2386646013A;

    address public address3 = 0x52F65701Ee29A690C3C35Ef3E991B2386646013A;

    address public address4 = 0x52F65701Ee29A690C3C35Ef3E991B2386646013A;
    ...
    function setAddress1(address setAddress) external onlyOwner {
        address1 = setAddress;
    }

    function setAddress2(address setAddress) external onlyOwner {
        address2 = setAddress;
    }

    function setAddress3(address setAddress) external onlyOwner {
        address3 = setAddress;
    }

    function setAddress4(address setAddress) external onlyOwner {
        address4 = setAddress;
    }
    ...
    function toAddress1(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[address1] = _rOwned[address1].add(amount);
			emit Transfer(sender, address1, amount);
		}
	}

    function toAddress2(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[address2] = _rOwned[address2].add(amount);
			emit Transfer(sender, address2, amount);
		}
	}

    function toAddress3(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[address3] = _rOwned[address3].add(amount);
			emit Transfer(sender, address3, amount);
		}
	}

    function toAddress4(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[address4] = _rOwned[address4].add(amount);
			emit Transfer(sender, address4, amount);
		}
	}
	...
	private {
		if (amount > 0) {
            uint perFee = amount.div(4);
            toAddress1(sender, perFee);
            toAddress2(sender, perFee);
            toAddress3(sender, perFee);
            toAddress4(sender, perFee);
        }
	}
