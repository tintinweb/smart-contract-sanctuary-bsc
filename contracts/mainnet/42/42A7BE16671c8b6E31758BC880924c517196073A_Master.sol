...
contract Master is Ownable {
    ...
    // Market oracle provides the pea/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _pea) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = pea.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && pea.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(pea.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return pea.totalSupply().toInt256Safe()
