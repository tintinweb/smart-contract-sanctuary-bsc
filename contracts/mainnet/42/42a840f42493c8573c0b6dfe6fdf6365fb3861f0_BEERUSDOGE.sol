...
contract BEERUSDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BeerusDoge";
    string private _symbol = "BDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xec2B640749e0B6E29084f25652cAba2c4c309c94); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x672EE00D466b23E4bd6250F8764Fb249f9d64Db8); // Developmental Address
