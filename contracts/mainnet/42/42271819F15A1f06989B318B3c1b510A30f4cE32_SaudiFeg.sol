...
contract SaudiFeg  is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xa6e02D5d4cCE8eef66101C61Ff9416b773228E95); 
    address payable public Wallet_Dev = payable(0x61E9236C4c5928Afd7E63A96a17dbC89433237d7);
    ...
    string private constant _name = "SaudiFeg"; 
    string private constant _symbol = unicode"$SaudiFeg"; 
    ...
    constructor () {
        ...
        _owner = 0x61E9236C4c5928Afd7E63A96a17dbC89433237d7;
