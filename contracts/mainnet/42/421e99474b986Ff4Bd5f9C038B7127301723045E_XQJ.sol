...
contract XQJ is Context, IERC20, Ownable {
    ...
    string private constant _name = "XQJ";
    string private constant _symbol = "XQJ";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 88000 * 10**_decimals;
    uint256 public _maxTxAmount = 2640 * 10**_decimals;
    uint256 public _maxWalletAmount = 2640 * 10**_decimals;
