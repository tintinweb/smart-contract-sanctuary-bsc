...
contract Irondoge is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "Irondoge";
  string constant _symbol = "Irondoge";
  ...
  constructor() Auth(msg.sender) {
    ...
    autoLiquidityReceiver = 0xAa58c56277e45dBacBc3aCb6040E65EA46Ba7BB3;
    marketingFeeReceiver = 0xc61D9627Ba1DB89F33fA6BF610090464815d8077;
    devFeeReceiver = 0xA2748a2B3dAF5FfC5c9a9e82611479eA8A00FF39;
