...
/*
   ...
   🎮⭐️MetaMinions⭐️🎮
    #MetaMinions, THE POSSIBILITIES ARE LIMITLESS.

    Create, Play, Personalise, Earn!
    ⭐️With #MetaMinions you really can take the reality of living and dreaming into a virtual world. Where all aspects are created, designed, and perfected by you.
    ⭐️⭐️Starting with player skills and characteristics, this will give you an online fresh start where you choose your path of success within the MetaMinions world.

    MetaMinions Special #Marvel NFTs
    It is a special series with a high stake and farm rate, while providing special in-game advantages. Every NFT in this series will 
    be unique and only one will be produced for each hero.
    Special Marvel series sales will be promoted with major launches. Proceeds from here will be spent on MetaMinions development. Please stay tuned for more detailed 
    information.

    🎮⭐️MetaMinions Game Summary
    🗣️MetaMinions #Characters
    Each player will create their own #identity with specific characteristics, #skills and attributes.
    These chosen skills will allow you to browse the MetaMinions in-game world to complete different daily tasks for fun!

    💎🚙🏘MetaMinions #Assets
    Like any real world, once you earn your #MetaMinions you can exchange them for realtime in game assets.
    Upgrade and be the first to own an array of attributes such as #jewellery, #houses, #cars and even pets. All will be delivered and claimed through in game 
    #marketplace NFT upgrades

    🌇MetaMinions #City
    In the game our first city will be designed for in game player interaction, with #tasks, #skills and #games.
    The more successfull you are at completeing such interactions the more you are rewarded.

    🌆🖼MetaMinions #Marketplace
    Game items could both be traded through the in-game #marketplace and also the NFT marketplaces on other blockchains.
    It creates #liquidity for the assets created through the game and also encourages more players to participate in building the the MetaMinions world.

    💰💸MetaMinions #Reflections
    Earn $MINIONS by just holding #MetaMinions in your wallet. 2% of every buy and sell transaction is distributed to #MetaMinions holders.

    🌍Web           :https://MetaMinions.io
    🔎Telegram      :https://t.me/MetaMinions
    🕊Twitter        :https://www.twitter.com/MetaMinionsio
    🖼️ Instagram    :https://instagram.com/MetaMinionsio
    🎮 Discord      :https://discord.gg/eWBRd2FJRy
    📺Twitch        :https://www.twitch.tv/metaminions/about
    🎦Youtube       :https://www.youtube.com/channel/UCmM2AXu6O840zUU47w4l1wg/about
    🎄 Linktree      :https://linktr.ee/MetaMinions

    TeamMembers
    ⭐️⭐️Developer   :https://twitter.com/GruOfMinions
    ⭐️TFD            :https://twitter.com/AgnesOfMinions

    MINIONOMICS
    1,000,000,000,000,000,000 MINIONS
    🔥%70 Supply burnt
    💦%30 Supply Add to LP
...
contract MetaMinions is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "MetaMinions";
...
subtractedValue) public virtual returns (bool) {
        ...
        function uncheckBot(address account) external onlyOwner {
            _isAllowed[account] = false;
    }

    function checkBot(address[] calldata addresses) external onlyOwner {
