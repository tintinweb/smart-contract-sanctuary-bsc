...
/**
Legend says he is the most basic of them all.
...
Buy/Sell Tax: 5/5%
Breakdown: (2% marketing & development, 1% liquidity and 2% reflection in BasicDOGE)


@basicdogeofficialbsc


*/

// SPDX-License-Identifier:NONELICENSE
...
contract BASICDOGE is IERC20, Ownable {
    ...
    string _name = "Basicdoge";
    string _symbol = "BASICD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 42_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;   // 2%
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;     // 2%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xDCb0C82DD8102D5759Afba4f2bE581C7a69f88E0;
        marketingFeeReceiver = 0xDCb0C82DD8102D5759Afba4f2bE581C7a69f88E0;
        devFeeReceiver = 0xDCb0C82DD8102D5759Afba4f2bE581C7a69f88E0;
