...
We are the official baby hype coin following the father's path! 

https://t.me/TheBabyHypeCoin
...
contract TheBabyHypeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Baby Hype Coin";
    string private _symbol = "BABYHYPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb6B57c05D4e260Ae2625409852Cf1a2CfF23c811); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb6B57c05D4e260Ae2625409852Cf1a2CfF23c811); // BuyBack Address
