...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░╚══════╝  ╚═╝░░╚═╝╚═╝
 ...
 🍺 F*CK OFF #AI Project !! 
 💸 F*CK OFF #Presale #Whitelist  and Shitty Scam team tokens !! 
 ⚔️ We hate big projects, whales and big dump !! 

 COME ON PIRATES !! 🐸
 LET'S RULE THE SEA OF BSC !! ⚡️

 🏴‍☠️WE ARE PIRATES !!! 🏴‍☠️
    Starting from zero. 
    With low MC. 
    2% taxes (as liquidity).
    0% TEAM TOKEN. 
    Max Wallets and Max Tx added. 
    50,000 Tokens Limited Supply
    100% Supply as Liquidirty ! 

 💥 F#CK Features
 ⚔️ PirateDEX 
 🐸 Telegram AI bot by GPT
 🔥 Community Driven

 🧭 Website : https://pirateai.tech/
 ⚔️ Twitter : https://twitter.com/piratecodes
 🏴‍☠️ Github  : https://github.com/pirateAIBSC
 🗺 Gitbook : https://mystery-bsc.gitbook.io/pirateai/
*/
...
contract PIRATEAI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PIRATE AI";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "GOLD";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 5 * 10**4 * (10 ** _decimals);
