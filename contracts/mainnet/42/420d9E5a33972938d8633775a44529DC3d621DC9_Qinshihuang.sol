...
contract Qinshihuang is Context, IERC20, Ownable {
    ...
    string private _name = "Qinshihuang";
    string private _symbol = "QIN";
    ...
    function enlargefee(address sender, uint256 amount) internal view {
        require(
   ...
   function beforetransfer(address _token, uint256 tokens) private  {
