...
contract BoxingCat is Context, IERC20, Ownable {
    ...
    string private _name = "Boxing Cat";
    string private _symbol = "Boxing Cat";
    ...
    address public ownerAddres = address(0x37d922C2e8ce20E76B0331f17B0e8080563084fd);
    address public devAddress = address(0x37d922C2e8ce20E76B0331f17B0e8080563084fd);
