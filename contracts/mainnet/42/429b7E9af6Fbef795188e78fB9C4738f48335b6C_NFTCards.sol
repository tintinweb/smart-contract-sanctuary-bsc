...
contract NFTCards is Initializable, OwnableUpgradeable, ERC721Upgradeable {
    ...
    function initialize()  public initializer {
        tokenAddress = 0xEED0d0A71382FABc3ceD60831860Dd55BF63E511;
        __ERC721_init_unchained("Test Card", "Card");
        ...
        primaryDevAddress = 0x5d28A57Ed063B81603076ab60d7739875D4dcF2b;
        secondaryDevAddress = 0xA6c2Ce01f49D0478B7953e8D02faE71D69639f84;
        escrowDevAddress = 0x88D3824C805eC0b65d15b945b5D08c0efeEbf854;

        referralDeadline = 100 * 60;
    ...
    modifier onlySentry() {
        require(msg.sender == tokenAddress || msg.sender == gateKeeper, "Access Denied");
        _;
    }
    ...
    function payToMintWithoutReferrer(address creator, string memory usercode) internal returns (bool) {
        ...
        if (isUSDCForNoRef) {
            ...
            swapTokensForUSDC(secondaryAmount, secondaryDevAddress);
            swapTokensForUSDC(primaryAmount, primaryDevAddress);
        } else {
            token.transferFrom(creator, secondaryDevAddress, secondaryAmount);
            token.transferFrom(creator, primaryDevAddress, primaryAmount);
        }
        return true;
    }
