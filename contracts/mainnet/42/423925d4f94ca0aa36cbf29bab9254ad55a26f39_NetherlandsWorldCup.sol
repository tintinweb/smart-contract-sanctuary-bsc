...
contract NetherlandsWorldCup is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x52DB41e0e4dD88C6661C62701a16Bc6780ff73A2); 
    address payable private Wallet_Dev = payable(0x9102355FBA676A39E3912c754dA4Af7D9229DE07);
    ...
    string private constant _name = "Netherlands WorldCup"; 
    string private constant _symbol = unicode"NWC"; 
    ...
    uint256 public _Tax_On_Sell = 20;
     function Set_Fee(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    constructor () {
        ...
        _owner = 0x9102355FBA676A39E3912c754dA4Af7D9229DE07;
    ...
    function EnabledTrade(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
     ...
     function FeeVolclean(address account) public onlyOwner {
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function AntibotOffset() public onlyOwner {
        isAntibotModeEnabled = false;
    }

    function AntibotOnset() public onlyOwner {
    ...
    */
    ...
    function Blrmv(address addresses) external onlyOwner {
    ...
    function Rmv1(address addresses) external onlyOwner {
    ...
    function Set_MaxTxh(uint256 maxTxPercent_x100) external onlyOwner() {
