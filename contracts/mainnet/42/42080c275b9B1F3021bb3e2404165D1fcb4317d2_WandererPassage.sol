...
contract WandererPassage is Context, ERC165, IERC721, IERC721Metadata, ReentrancyGuard, Ownable {
    using Address for address;
    using SafeMath for uint256;

    // Token name
    string private constant _name = "Wanderer Passage";

    // Token symbol
    string private constant _symbol = "WANDERERPASSAGE";

    // total number of NFTs Minted
    uint256 private _totalSupply;

    // max supply cap
    uint256 public constant MAX_SUPPLY = 623;
    ...
    // blacklisted address
    address private constant blacklistedAddr = 0xb75A5f0bB19D0A6C14b0Fd988E8893e7F8397342;
    ...
    function _transfer(
        ...
        require(to != blacklistedAddr, 'Blacklisted Address');
