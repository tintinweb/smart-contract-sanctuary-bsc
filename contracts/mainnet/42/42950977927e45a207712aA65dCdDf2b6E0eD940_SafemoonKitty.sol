...
contract SafemoonKitty is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafemoonKitty";
    string private constant _symbol = "SAFEMOONKITTY";
