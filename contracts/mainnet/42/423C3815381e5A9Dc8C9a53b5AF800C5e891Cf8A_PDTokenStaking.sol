...
contract PDTokenStaking is Ownable {
    using SafeMath for uint256;

    uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public PERCENTS_DAILY = 10;
    uint256 constant public REFERRAL_PERCENTS = 100;
    uint256 constant public TIME_STEP = 1 days;
	
	ERC20Interface PDToken;
    ...
    constructor(address _PDToken) public {
        PDToken = ERC20Interface(_PDToken);
    }

    function invest(address referrer, uint256 amount) public {
		PDToken.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = PDToken.balanceOf(address(this));
		...
		PDToken.transfer(msg.sender, totalAmount);
