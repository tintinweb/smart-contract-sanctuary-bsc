...
// Telegram: https://t.me/LGBTQCAT_BSC
...
contract LGBTQCAT is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LGBTQCAT";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (3 * 10**5 * 10**9), "Max wallet should be more than or euqal to 0.3% totalSupply");
