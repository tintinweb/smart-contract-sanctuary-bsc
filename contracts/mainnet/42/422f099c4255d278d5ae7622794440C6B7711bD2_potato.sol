...
contract potato is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9Df7aF4BE6bb80dF6C605A446d16634F95c5a41f);
    address payable public teamWalletAddress = payable(0x13547DE802FFC5E39095E90EAf4942AE6853ae01); 
    ...
    uint256 public _maxTxAmount = 1000 * 10**7 * 10**_decimals; 
    uint256 public _walletMax = 1000 * 10**7 * 10**_decimals;
