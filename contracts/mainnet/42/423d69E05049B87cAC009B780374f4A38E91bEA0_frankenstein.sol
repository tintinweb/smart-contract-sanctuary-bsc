...
// File: frankenstein_bsc.sol


/*

https://t.me/frankenstein_bsc

This is community based, low tax and high reward in Echelon coin. 
Developers will create best circumstances for this token to fly.


Tokenomics:
Buy tax: 10% 
Sell tax: 10% (30% on launch, lowered to normal after max 20 minutes)
...
contract frankenstein is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Frankenstein";
    string constant _symbol = "Frankenstein";
