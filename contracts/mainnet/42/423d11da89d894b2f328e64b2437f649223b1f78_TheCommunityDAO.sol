...
contract TheCommunityDAO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "The Community DAO";
    string private constant _symbol = unicode"cDAO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 67 * 10**_decimals;

    address payable private DevWallet = payable(0x4371596f63C5C3F8D19a8dD97460101279091806);
    address payable private MarketingWallet = payable(0x4371596f63C5C3F8D19a8dD97460101279091806);
    ...
    uint256 public _maxTxAmount = _tTotal * 3 / 200;
    uint256 public _maxWalletToken = _tTotal * 3 / 200;
