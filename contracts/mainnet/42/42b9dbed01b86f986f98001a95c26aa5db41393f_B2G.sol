...
contract B2G is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB 2.0 GROW"; // 
    string private constant _symbol = "B2G"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd29DD3dC47A5D349d9De0f2da242C47F56B7e147;
