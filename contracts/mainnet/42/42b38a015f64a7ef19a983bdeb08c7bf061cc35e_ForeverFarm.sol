...
contract ForeverFarm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ForeverFarm";
    string private _symbol = "FFARM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcC31F611c7f5B0eA051010CD931583339966DfcE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xcC31F611c7f5B0eA051010CD931583339966DfcE); // BuyBack Address
