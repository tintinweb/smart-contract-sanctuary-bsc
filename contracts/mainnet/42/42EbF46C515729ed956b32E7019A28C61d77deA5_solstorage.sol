...
contract solstorage is Context, IERC20, Ownable {
    ...
    string private constant _name = "storage"; //
    string private constant _symbol = unicode"storage"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xcc3efd51a0dda1d6fd749c15b778e7E381B21202;
