...
contract TITIYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TiTi Yacht Club";
    string private _symbol = "TYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C5c6e869423f77AfC7f005195371Dbc0dc52eB3); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x20ce6D5076A023f119203978B4f9Cf042C99762d); // Developmental Address
