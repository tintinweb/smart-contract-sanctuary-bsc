...
/**
    TESTING CONTRACT ON BEHALF OF T.ME/SURGEHUNTER A NEW SRG20 TOKEN ALERT BOT
 */
...
contract testhunter is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Test Hunter";
    ...
    //Tax wallets
    address public teamWallet = 0x87EFBCC2576506fbAC0E97AB967b00f3ee2d85B8;
    address public treasuryWallet = 0x87EFBCC2576506fbAC0E97AB967b00f3ee2d85B8;

    // Tax Split
    uint256 public teamShare = 0;
    uint256 public treasuryShare = 90;
    uint256 public rewardShare = 0;
    uint256 public burnShare = 0;
    uint256 public constant SHAREDIVISOR = 90;
