...
//////
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(0.03 ether, 1, 5));
        plans.push(Plan(0.04 ether, 1, 6));
        plans.push(Plan(0.05 ether, 1, 7));
        plans.push(Plan(0.06 ether, 1, 8));
...
user.checkpointRefBonus = block.timestamp;
 ...
 //if(block.timestamp >= user.checkpointRefBonus)
