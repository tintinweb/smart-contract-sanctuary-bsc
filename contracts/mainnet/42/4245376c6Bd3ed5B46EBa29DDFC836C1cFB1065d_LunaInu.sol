...
contract LunaInu is IBEP20, Auth {
    ...
    address MarketingWallet = 0x25ab0944b526a60a2b84424594d9eC4C8F511ce7; //mw dj
    address DevWallet       = 0x25ab0944b526a60a2b84424594d9eC4C8F511ce7; //dw sfz

    string constant _name = "Luna Inu";
    string constant _symbol = unicode"LINU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);
    uint256 public _maxSell = 5000000 * (10 ** _decimals);
    ...
    address PAIR = 0x25ab0944b526a60a2b84424594d9eC4C8F511ce7;
