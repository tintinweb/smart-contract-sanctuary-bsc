...
contract REKT is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5000000 * 1e9; // 5 m total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RektCity"; // token name
    string private _symbol = "BITCH"; // token ticker
    ...
    uint256 public minBuyLimit = 50000 * 1e9;
