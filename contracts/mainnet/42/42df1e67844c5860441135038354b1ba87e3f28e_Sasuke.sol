...
contract Sasuke is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "SASUKE COIN";
    ...
    address public burnAddress = 0xB9336B65cf84A3238CDdD488c8A3CF1bB03Dc0bb;
    address payable private _marketingWallet = payable(0xB9336B65cf84A3238CDdD488c8A3CF1bB03Dc0bb);
    address payable private _devWallet = payable(0xB9336B65cf84A3238CDdD488c8A3CF1bB03Dc0bb);
    ...
    uint256 public percentToSell = 100 ;
