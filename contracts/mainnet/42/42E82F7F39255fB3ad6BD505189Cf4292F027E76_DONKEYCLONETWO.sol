...
Tax: 
0% buy
60% sell at launch, declining 5% every 30 mins
15% after 4 hrs and a half
    (40% burn | 60% liquidity | 0% marketing)
TG: 
*
*/
...
//DONKEY CLONE TWO Contract /////////////

contract DONKEYCLONETWO is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DONKEY CLONE TWO';
    string private constant _symbol = 'DC2';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000 * 10**_decimals;//equals 10MLLON (100%)

    //Divider for the MaxBalance based on circulating Supply (2%) // 2% CLOSED?
    uint8 public constant BalanceLimitDivider=20;
    //Divider for sellLimit based on circulating Supply (1%) // less than 1% -> 99k  //  0.5 (49k or less than 49k?)
    ...
    //The time Liquidity gets locked at start and prolonged once it gets released // is this time to lower taxes? (30 mins in secs)
    uint256 private constant DefaultLiquidityLockTime= 1800;
    //DevWallets
    address public TeamWallet=payable(0x92851a8419Eb7DE9Ff8f05E2786d23FFd06ca9dE);
    address public walletTwo=payable(0x92851a8419Eb7DE9Ff8f05E2786d23FFd06ca9dE);
    //TestNet
	...
	uint256 private antiWhale = 50000 * 10**_decimals; //50k (0.5%)
    ...
    function claim(address addr) private{
        ...
        path[1] = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;  //Binance-Peg XRP Token (exchangeable for bus?)
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 25000 * 10**_decimals; //15QLLION (0.25%)
    ...
    _swapContractToken();
     ...
     //Limits need to be at least target, to avoid setting value to 0(avoid potential Honeypot) //is this 5% decrease over time? 
