...
contract Sharkjumping is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sharkjumping";//Warriors of Future
    string private _symbol = "Sharkjumping";
    ...
    address payable private activityWalletAddress = payable(0x95871cb3F6Cac7daA83B7615c0C3d3f456377A55);
    ...
    uint256 public _activityShare = 8;
    ...
    uint256 private minimumTokensBeforeSwap = 100 * 5 **_decimals; 
