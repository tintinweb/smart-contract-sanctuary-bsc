...
/*
Join us :https://t.me/CheeseMusk 
Project By  DegenDragon
*/
...
contract CheeseMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheeseMusk";
    string private _symbol = "CM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15daEa809b87C4FfB561dF0AA8897A48103A3Fdc);
    address payable public teamWalletAddress = payable(0x0AeC921F5BBf0e9BBEd157e66108eaa6B376571f); 
