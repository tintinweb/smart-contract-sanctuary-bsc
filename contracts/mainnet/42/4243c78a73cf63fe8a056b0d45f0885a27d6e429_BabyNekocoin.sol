...
contract BabyNekocoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Neko Coin";
    string private _symbol = "BNC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C8dA66F9F1d6F8D570A2b7820E30CB566DcF8da); // Marketing Address
    address payable public teamWalletAddress = payable(0x2C8dA66F9F1d6F8D570A2b7820E30CB566DcF8da); // Team Address
