...
FAN TOKEN
@MsTweetETH
http://t.me/MsTweetETH

$Ms.Tweet the first Twitter Queen Meme token on Ethereum network
...
contract MsTweet is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc3cDd2EeF92B469F07a7f739736A63EFc371FC29); 
    address payable public Wallet_Dev = payable(0xc3cDd2EeF92B469F07a7f739736A63EFc371FC29);
    ...
    string private constant _name = "Ms Tweet"; 
    string private constant _symbol = unicode"Ms. Tweet"; 
    ...
    constructor () {
        ...
        _owner = 0xc3cDd2EeF92B469F07a7f739736A63EFc371FC29;
