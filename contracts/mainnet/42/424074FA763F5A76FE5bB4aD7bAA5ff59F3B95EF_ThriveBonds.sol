...
contract ThriveBonds is Ownable, ERC721, ERC721Enumerable {
    ...
    string public _assetsBaseURI;
    uint private _decimalBase = 3;
    uint public  _maxMintPerTx;
    ...
    // mint shares
    uint private _mintSharesTeam = 500;
    uint private _mintSharesReflect = 500;
    ...
    // -- utils -- //
    function _actualMintPrice() public onlyOwner returns (uint) {
     ...
     */
    function _splitMintFees(uint payment) public onlyOwner {
        if (payment > 0) {
