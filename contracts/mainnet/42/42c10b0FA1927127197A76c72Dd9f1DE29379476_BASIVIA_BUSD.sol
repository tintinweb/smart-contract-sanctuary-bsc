...
contract BASIVIA_BUSD {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;
    
    IERC20 public token = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);

	uint256 constant public INVEST_MIN_AMOUNT = 100 ether; // 100 BUSD
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(30, 10)); // 30 days 1% daily // 30%
        plans.push(Plan(20, 10)); // 20 days 1% daily // 20%
        plans.push(Plan(15, 10)); // 15 days 1% daily // 15%
        plans.push(Plan(12, 10)); // 12 days 1% daily // 12%
	}
