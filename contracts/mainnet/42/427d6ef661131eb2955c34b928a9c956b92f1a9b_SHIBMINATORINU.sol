...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // rewards token address #1
...
contract SHIBMINATORINU is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // put rewards CA here #3
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SHIBMINATOR INU"; //token name #4 
    string constant _symbol = "SHIBMINATORINU"; // token tika #5
    ...
    uint256 liquidityFee    = 33; // ammount to LP
    uint256 reflectionFee   = 33; // ammount to rewards
    uint256 marketingFee    = 33; // ammount to marketing wallet
