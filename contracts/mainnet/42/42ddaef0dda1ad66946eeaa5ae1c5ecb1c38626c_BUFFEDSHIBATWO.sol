...
/**
 BUFFED SHIBA TWO THE NEXT BUFFED SHIBA
*/
...
contract BUFFEDSHIBATWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUFFED SHIBA 2.0";
    string private _symbol = "BSHIBTwo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0AbFc34B4cC9772d352B4CC4844C7C031df75b8e); // Marketing Address
    address payable private developmentWalletAddress = payable(0x0AbFc34B4cC9772d352B4CC4844C7C031df75b8e); // Development Address
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100000 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
