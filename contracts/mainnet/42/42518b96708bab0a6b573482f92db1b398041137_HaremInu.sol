...
contract HaremInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Harem Inu";
    string private _symbol = "Harem";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6518c6DA8Ab68137b5796C24062b6Dae068226FE); 
    address payable public buyBackWalletAddress = payable(0x6518c6DA8Ab68137b5796C24062b6Dae068226FE); 
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**7 * 10**9; 
