...
contract RGTStakingProgram {
    using SafeMath for uint256;

    BEP20 public token = BEP20(0x6000b9c20B70B80379B65fbd65DFE1a409b22003);  // RGT Coin
    ...
    function staking(uint256 stakeAmt) public returns(bool){
        require(stakeAmt>=1e18,"Investment must be at least 1 RGT!");
