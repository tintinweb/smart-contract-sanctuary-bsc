...
contract Thegoddog is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Thegoddog";
    string private _symbol = "Thegod dog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4fe53Af98c04c4C35fD2173d8f3fB2E6Bc29294b);
