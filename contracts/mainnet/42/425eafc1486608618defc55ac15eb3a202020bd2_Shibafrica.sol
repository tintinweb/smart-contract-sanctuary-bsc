...
/* Token contract */
contract Shibafrica is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xF23b9853D5A99908e11A8670F76Fc7088bCdA741;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 1000000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000000; // 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 1000000; // 2% 
