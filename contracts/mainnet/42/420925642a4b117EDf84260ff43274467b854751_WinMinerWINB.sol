...
contract WinMinerWINB {
    ...
    // Staking token
    // address erctoken = 0xE68fcc69a5958B905F3ca49C9877BF19D89E40A3; /** WINB Testnet **/
    address erctoken = 0x0Eb17A4Ef7127b8aB2Efda4F6C4EAbb29f05671a; /** WINB Mainnet **/

    /// WINB contract
    IBEP20 winb = IBEP20(0x0Eb17A4Ef7127b8aB2Efda4F6C4EAbb29f05671a); /** WINB testnet **/
    ...
    function withdrawBEP20(IBEP20 _token, uint256 _amount) external {
        require(msg.sender == owner, "Admin use only");
