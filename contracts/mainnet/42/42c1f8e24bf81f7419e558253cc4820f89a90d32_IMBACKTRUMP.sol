...
contract IMBACKTRUMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "IMBACKTRUMP"; // 
    ...
    address public  _marketingWallet = 0x6A93aC6F4a15814C6A614C0De871977aD3B22284;
    ...
    function setLiq(uint256 liquiFee, uint256 markeFee) public onlyOwner {
        _liquidityFee = liquiFee;
        _marketingFee = markeFee;
    }
