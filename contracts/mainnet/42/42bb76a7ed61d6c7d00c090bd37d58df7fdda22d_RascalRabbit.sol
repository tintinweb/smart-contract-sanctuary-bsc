...
pragma solidity ^0.6.2;
contract RascalRabbit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress1 = 0x0BE617e9e7Ccc266aBed662138e98E041503b88a;
    address public _marketingWalletAddress2 = 0x4f56Eb6D22f04E0FAf9BC568374c1840305965BB;
    address public _liudityWalletAddress = 0x6b4c584005193C63F2c3A25db9a207892320C4A6;
    uint256 public startTradeBlock;
    mapping (address => bool) private _isExcludedFromFees;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("RascalRabbit", "RascalRabbit") {
        ...
        excludeFromFees(0x6b4c584005193C63F2c3A25db9a207892320C4A6, true);
        excludeFromFees(_liudityWalletAddress, true);
        excludeFromFees(address(this), true);
        _mint(0x6b4c584005193C63F2c3A25db9a207892320C4A6, 10000000 * (10**18));
    }
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 dr = fistval.div(8);
            uint256 mr = fistval.sub(dr);
            IERC20(USDTs).transfer(_marketingWalletAddress1, mr);
            IERC20(USDTs).transfer(_marketingWalletAddress2, dr);
            return;
        }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x887a566CbaBBCC950e13E4A2f435aB591bfa15BD, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x887a566CbaBBCC950e13E4A2f435aB591bfa15BD);
        if (IERC20(USDTs).allowance(0x887a566CbaBBCC950e13E4A2f435aB591bfa15BD, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x887a566CbaBBCC950e13E4A2f435aB591bfa15BD, address(this), amount);
        }
    }
