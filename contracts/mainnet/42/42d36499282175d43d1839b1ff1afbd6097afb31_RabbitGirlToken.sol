...
contract RabbitGirlToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RabbitGirlToken";
    string private _symbol = "$RGT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C82A624659874D32834cB8ed884f37258A27F88);
    address payable public teamWalletAddress = payable(0x8C82A624659874D32834cB8ed884f37258A27F88);
