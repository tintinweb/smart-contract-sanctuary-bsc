...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 500 * 10**18;
    string private _name = "HCH";
    string private _symbol = "HCH";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x588D1fdcd706AE47CF034981bb73117D12792eF5);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 500 * 10**18;
