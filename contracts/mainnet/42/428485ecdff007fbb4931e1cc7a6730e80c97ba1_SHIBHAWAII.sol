...
contract SHIBHAWAII is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x451Bf250Cbb00550E1a8b322E77aCc4793BD625C);
    address payable public Wallet_Dev = payable(0x6d0aC0747C4ce90F8398E2C2F85073C58125ede0);
    ...
    string private constant _name = "Shiba Hawaii";
    string private constant _symbol = unicode"SHIBHAWAII";
