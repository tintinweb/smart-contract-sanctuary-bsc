...
OwnableUpgradeable
{
    ...
    function changeMainWallet(address payable _mainWallet) external onlyRole(DEFAULT_ADMIN_ROLE) {
        mainWallet = _mainWallet;
    }

    function changeBackupWallet(address payable _backupWallet) external onlyRole(DEFAULT_ADMIN_ROLE) {
