...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7f49A3bD7d61E0036d70D68103d11cA1fBB607B2);
...
contract BabyNovaCoin is IBEP20, Auth {
    ...
    string constant _symbol = "BABYNOVA";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7f49A3bD7d61E0036d70D68103d11cA1fBB607B2;

    uint256 _totalSupply = 1999999999 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x73a98d375fc3D87f507b027bF2A4c9d269947202;
        marketingWallet = 0x73a98d375fc3D87f507b027bF2A4c9d269947202; 
        devWallet = 0x6417A2Ab69710bBE8d412c6F0e25b3527286b200; 
