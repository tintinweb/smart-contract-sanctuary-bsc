...
contract LBOY is IERC20, Ownable {
    ...
    address private _destroyAddress =
        address(0xD15A4997976204FA4A29573Ae14D55Ba385DD5b2);
    //质押池
    address private _pledgeAddress =
        address(0xbD3F3CaB0722a9d1d281acdC550DC6963aDfEB7F);

    uint256 public _inviterFee = 30;
    address public inviterAddress = address(0xca858277cE006FC670F4126186b41BbA730e1147);
    ...
    function _takeInviterFee(
        ...
        address cur;
        address cur_a=address(0x0000000000000000000000000000000000000000);
