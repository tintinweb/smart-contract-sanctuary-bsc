...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x946d58e6E6110cb75B0F3598A4809DDe756f8997;
...
contract UkraineAid is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x466e0aD5d805B1eA3FF5786291875795e222F052;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ukraine Aid";
    string private _symbol = "UKRAID";
