...
contract Tfloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "TFLOKI";
    string private constant _symbol = "TFLOKI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xF98E7fA1214C0ac66A7Bb002c231B0EE65977b1b);
    address payable private _marketingAddress = payable(0xc4DD787Bafb5e9013c080BcCf98068D99efD5995);
