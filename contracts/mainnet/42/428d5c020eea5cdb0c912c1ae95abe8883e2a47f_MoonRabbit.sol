...
contract MoonRabbit is Context, IERC20, Ownable {
    ...
    address payable private _anotherA = payable(0xAf8c8B6e1e59208817770fa1fe87125030B6bB7C); 
    address payable private teamWalletAddress = payable(0xAf8c8B6e1e59208817770fa1fe87125030B6bB7C); 
