...
//  WWW://DanielisTangerianBSC.COM
// SPDX-License-Identifier: Unlicensed
//THIS IS: Daenerys Stormborn of House Targaryen
...
contract DanielisTangerian is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DanielisTangerian";
    string private _symbol = "The Mother of Dragons";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3aCa3bD28216784bc8c8778ffd5703Bdb8d5Fe66);
