...
contract Best_Nestwork is Context, Ownable, IERC20 {
    ...
    string private _name = "Best Network Token";
    ...
    address payable public burnWallet = payable(0x89e0cBCD9a2CBd2a51AC65e1BDa1617A4AeFb0cC);
    address payable public marketingWallet = payable(0x94f53eceaC7f197139F9c8926FfD0e3DdBad6e38);
    address payable public liquidityWallet = payable(0x1371b90219522B3c21bF26d798393a2be7E7633D);
    address payable public airdropWallet = payable(0x81f283B528c895738FbB3e7d5dA0c556256E3B5f);
