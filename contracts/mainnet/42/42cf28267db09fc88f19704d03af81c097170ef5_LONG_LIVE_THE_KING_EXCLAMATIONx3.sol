...
TG: https://t.me/LonglivethekingExclamationx3
*/ 
...
contract LONG_LIVE_THE_KING_EXCLAMATIONx3
 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "NEW MONARCH";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 3, // Marketing and Development fee in %
            treasury: 1, // treasury fee in %
            lp: 3, // lp rate in %
            toSwap: 7 // treasury + Marketing and Development + lp
        });
