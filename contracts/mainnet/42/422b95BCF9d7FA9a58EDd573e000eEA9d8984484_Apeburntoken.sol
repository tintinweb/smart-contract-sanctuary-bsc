...
contract Apeburntoken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x08F3Eb1eF25024e52Ff5C29700B412A4ae687B2c); // Marketing Address
    ...
    uint256 private _tTotal = 1350000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ApeBurnToken";
