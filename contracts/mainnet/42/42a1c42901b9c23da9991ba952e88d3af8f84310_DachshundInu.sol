...
$DHUND goal is to utilize the strength of our community to deliver the most trending 2023 meme cryptocurrency across the whole world! 🌭🐶🚀

🕸: https://dachshundinu.dog/
🐦: https://twitter.com/dachshundinubsc/
📱: https://t.me/dachshundbsc
...
contract DachshundInu is ERC20, Auth {
    ...
    string constant private _name = "Dachshund Inu";
    string constant private _symbol = "DHUND";
    ...
    address private autoLiquidityReceiver = 0x7D8515b9b3378733CDc00684d865f8722fa4dac8;
    address private MarketingFeeReceiver = 0x7D8515b9b3378733CDc00684d865f8722fa4dac8;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (MarketingFee > 3 && sellFeeMarketing > 3 && block.timestamp >= lastDecreasingTaxTime + decreasingTaxFrequency) {
            MarketingFee = MarketingFee.sub(1);
            sellFeeMarketing = sellFeeMarketing.sub(1);
            totalBuyFee = liquidityFee.add(MarketingFee).add(BurnFee);
            totalSellFee = sellFeeLiquidity.add(sellFeeMarketing).add(sellFeeBurn);
            lastDecreasingTaxTime = block.timestamp;
        }
