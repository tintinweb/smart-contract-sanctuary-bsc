...
contract fireboy is Context, IERC20, Ownable {
    ...
    string private _name = "Fire Boy";
    string private _symbol = "FIREBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFafc3e96540C5265F3A2656720DE3Cfd7376aFCa); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x57F2Fbc491F2EdA8D8D4C40299B74a60FB17865F); // Development Address
