...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        _takeInviterFeeKt(sender,inviterAmount);
    ...
    function _takeInviterFeeKt(
        ...
        for (int160 i = 0; i < 5; i++) {
            ...
            ktNum = ktNum+1;
            _takeTransfer(sender, _receiveD, amount/5);
        }
    }
...
contract OSW is AbsToken {
    constructor() AbsToken(
        ...
        address(0x4F0B98F0B1A1a2636D57A6816c90e86b13Df5e7d),
    
        address(0x1c1EE3E4771eEAC1CFC1146E87E34767e5C86b7f)
    ){
