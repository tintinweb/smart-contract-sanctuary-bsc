...
contract newtoken is Context, IERC20, Ownable {
    ...
    string private _name = "Against";
    string private _symbol = "AGAINST";
    ...
    function triggerTxSetting(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function triggerAutomatedSetting(address pair, bool value) external onlyOwner {
