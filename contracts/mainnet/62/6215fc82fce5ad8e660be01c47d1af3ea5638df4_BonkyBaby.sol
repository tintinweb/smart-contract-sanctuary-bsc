...
contract BonkyBaby is IBEP20, Auth {
    ...
    string constant private _name = "Bonky Baby";
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        // switch Trading
    function tradingAllowed(bool _status) public authorized {
        tradingOpen = _status;
        if(tradingOpen){
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setMaxTxPercent(uint256 amountBuy) external authorized {
    ...
    function enable_blacklist(address _address, bool _value) public authorized{
