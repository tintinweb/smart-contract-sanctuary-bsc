...
contract BaseToken is Ownable {
    ...
    string constant public name = 'ONELOVE';

    string constant public symbol = 'ONELOVE';
    ...
    uint256 private _taxftttx = 0;
    uint256 private _burnftttx = 2;
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muli(_taxftttx).div(100);
        uint256 burn =  value.muli(_burnftttx).div(100);
