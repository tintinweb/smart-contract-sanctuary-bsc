...
contract AICarePro is ReentrancyGuardUpgradeable, ERC721URIStorageUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  //   constructor() ERC721("AI Care Pro Marketplace", "APM") {
  ...
  function setCollectionFee(uint256 fee, address addressCollect, address ownerCollect) public {
    require(owner() == msg.sender, "Only marketplace owner can update collection fee");
  ...
  function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
    ...
    uint256 itemCollectFee = (msg.value).mul(exchangeCollectionFee).div(1000);
