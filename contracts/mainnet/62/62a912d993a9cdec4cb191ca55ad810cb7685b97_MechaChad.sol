...
contract MechaChad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MechaChad";
    string private _symbol = "$ARABDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43A1E4dFDd806aDFE336ceFF0D36fBdA7536909D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x43A1E4dFDd806aDFE336ceFF0D36fBdA7536909D); // BuyBack Address
