...
contract SOLARIZE is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SOLARIZE"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (10); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (1); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (10); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0xf9144F3d4809B2C04bD6f92c1c49f6D13d84dF01; //LP receiver
    address private marketingFeeReceiver = 0x49D16A7A149D342C9765387C2806491e4583fB63; //mkt
    address private devFeeReceiver = 0x49D16A7A149D342C9765387C2806491e4583fB63; //31 BuyBack
    address private teamFeeReceiver = 0x49D16A7A149D342C9765387C2806491e4583fB63; //32 
