...
10% BUY
10% SELL
XRP REWARDS TOKEN WITH REAL PUMPS BUILT IN BURN MECHANISM REDUCES SUPPLY FOR SHORT SQUEEZE AND MASSIVE REWARDS
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
...
contract XRPAMPME is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'XRPAMP ME';
    string private constant _symbol = 'XRP ME';
    ...
    uint256 public _maxTransferAmount = ( _tTotal * 50 ) / 10000;
    ...
    uint256 public swapThreshold = ( _tTotal * 350 ) / 100000; // .35% of total supply
    uint256 public _minTokenAmount = ( _tTotal * 10 ) / 100000; // .01% of total supply
