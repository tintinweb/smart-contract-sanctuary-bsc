...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB37522598E99D1659B9c69EfD34393a6FEF5649e; // owner address
...
contract S3XAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "S3XAI";
    string private _symbol = "S3X";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbC153DAA6aD81F7e0B8d05927Ba7Ca7C866bF84c); // Marketing Address
    address payable public teamWalletAddress = payable(0x41fe76535515b61cd2a16C09f33d6433F276d15F); // Team Address
