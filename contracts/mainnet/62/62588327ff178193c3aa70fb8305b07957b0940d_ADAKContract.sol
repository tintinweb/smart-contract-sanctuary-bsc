...
contract ADAKContract is  Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 723 * 10**15 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Adak Token";
    string private _symbol = "ADAK";
    ...
    address public marketingWallet = 0x47d6B5038157d196c80DbB6944971680F8cd4BA8;
    ...
    uint256 public numTokensSellToAddToLiquidity = 7 * 10**17 * 10**18;
    uint256 public _maxTxAmount = 5 * 10**17 * 10**18;
