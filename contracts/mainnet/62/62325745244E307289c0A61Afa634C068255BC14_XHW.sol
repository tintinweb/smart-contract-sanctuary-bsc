...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeWhiteList[address(0x9d0Cb94a8BC4268F1042E827252172e2f11E65bB)] = true;
    ...
    function _transfer(
        ...
        if (startTradeBlock + 200 > block.number && _limitAmount > 0 && !_swapPairList[to] && !_feeWhiteList[to]) {
    ...
    function setBuyFee(uint256 buyFundFee, uint256 buyLPFee) external onlyOwner {
        _buyFundFee = buyFundFee;
        _buyLPFee = buyLPFee;
    }

    function setSellFee(uint256 sellDestroyFee, uint256 sellLPFee) external onlyOwner {
...
contract XHW is AbsToken {
    ...
    //Total
        1000,
    //Fund
        address(0x3457CA5cde4A985A1F13031E8511c5169b1E080A),
    //Receive
        address(0x360b1bB5AB8305451d7e7ccC1509A65000d71Fa5),
    //LimitAmount
        2
    ){
