...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xc08642eCdD511B90C5A29a65c0aBAf47B0AA7164;
...
contract WEENDREAM is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"WeenDream"; 
    string private constant _symbol = unicode"$WEENSTER"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xc08642eCdD511B90C5A29a65c0aBAf47B0AA7164), BNB_Tot);
            }
