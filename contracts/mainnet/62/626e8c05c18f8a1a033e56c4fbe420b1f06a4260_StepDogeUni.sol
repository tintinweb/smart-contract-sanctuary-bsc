...
/**
Telegram : https://t.me/stepdogeuni
*/ 
...
contract StepDogeUni is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StepDogeUni";
    string private _symbol = "$STEPDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62F348f2D827E00AD045F1169dF1D4ADe471F0aD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x62F348f2D827E00AD045F1169dF1D4ADe471F0aD); // BuyBack Address
