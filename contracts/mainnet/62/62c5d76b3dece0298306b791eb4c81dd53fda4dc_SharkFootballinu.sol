...
contract SharkFootballinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shark Football Inu";
    string private _symbol = "$SFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35493ee4dD45d094edd7ce46eCf5470F44D08D89);
    address payable public teamWalletAddress = payable(0x35493ee4dD45d094edd7ce46eCf5470F44D08D89);
