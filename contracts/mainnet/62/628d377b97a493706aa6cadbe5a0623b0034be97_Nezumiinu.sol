...
contract Nezumiinu is Context, IERC20, Ownable {
    ...
    string private _name = "Nezumi Inu";
    string private _symbol = "Nezumi Inu";
    ...
    uint256 public _boostedMarketingFee = 1200;
    ...
    address payable private _marketingWallet = payable(0x1dB4274A221cFf030D17d01cd6D3e72bca687e75);
    address payable private _devWallet = payable(0x9e87EC21Fe6807b14b4E63486ea04af8fba494d0);
