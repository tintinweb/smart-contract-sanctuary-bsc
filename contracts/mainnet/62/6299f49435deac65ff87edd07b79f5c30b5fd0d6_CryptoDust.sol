...
contract CryptoDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " CryptoDust ";
    string private _symbol = " $CRYPTO "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x480c3724cD24f0504871dF64E2152c22C49662Be); 
    address payable public teamWalletAddress = payable(0x480c3724cD24f0504871dF64E2152c22C49662Be);
