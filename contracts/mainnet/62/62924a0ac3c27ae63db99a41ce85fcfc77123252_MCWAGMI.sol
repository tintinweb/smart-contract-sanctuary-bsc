...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xD5F9C3b520bA78dcb8a29bad546A9352e3d19295); //pigs
...
contract MCWAGMI is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xD5F9C3b520bA78dcb8a29bad546A9352e3d19295; //pigs
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MCWAGMI";
    string constant _symbol = "MCWAGMI";
