...
contract WEXReferral is IWedexReferral, Ownable {
    ...
    constructor(
        ...
        operators[0x25c52710E73010ff2f06f7ca130BdDC12DD28765] = true;
        operators[0x3d5072451B3F18b5179E73c2Ca5A15e33b826c21] = true;
        operators[0x6D6bb29ae359B0989a7C0a03F0e4Af50a655304F] = true;
        operators[0xA8a8B895D95DbD2791799476B35d9cAeb9c36a13] = true;
        operators[0x34e6bc1505C82D4FBDb877D569f97D08ED6c0bd1] = true;
     }
    ...
    function recordReferral(address _user, address _referrer,bool _vipBranch, uint256 _leaderCommission) public override onlyOperator {
        if (_user != address(0)
            ...
            && wexProfile.getUserStatus(_referrer)
    ...
    function getReferrer(address _user) public override view returns(address) {
        if(!wexProfile.getUserStatus(referrers[_user].referrer)){
            return address(0);
        }
