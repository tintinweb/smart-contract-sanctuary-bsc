...
library Address{
 ...
 contract KasihiroInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1_500_000_000_000 * 10**9;
    uint256 public maxSellLimit = 1_500_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 1_500_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xc14EaFB36FA198E1d5CFcC33E54DE1C2B6903edC;
    address public donationWallet = 0xc14EaFB36FA198E1d5CFcC33E54DE1C2B6903edC;
    string private constant _name = "Kasihiro Inu";
    string private constant _symbol = "KASIHIRO";
    ...
    Taxes public taxes = Taxes(1, 3, 1, 3);
    Taxes public sellTaxes = Taxes(1, 3, 1, 3);
