...
contract THE_ROCK is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Staking = 0xABA1128aE8422dDE53a290b8F6ce8acFacC2Ac52;

    string constant _name = "THEROCK";
    ...
    uint256 public swapThreshold = _totalSupply / 414; // 0.02%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4273cF967Fb14d13206436bA07b7fC4b8392A5bb;
        marketingFeeReceiver = 0xcbfdC790D329151D2191096894373BB8Ea49721e;
        RewardPoolFeeReceiver = 0x17CC2305a161391677EEa9508Bbe976827D06eeb;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 amountRewardPool = amountBNB.mul(RewardPool).div(totalBNBFee);

            (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
            ( success, /* bytes memory data */) = payable(RewardPoolFeeReceiver).call{value: amountRewardPool, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _StakingFee, uint256 _marketingFee, uint256 _RewardPool, uint256 _feeDenominator, uint256 _totalSellFee) external authorized() {
        ...
        require(totalSellFee <= feeDenominator / 1, "Sell fee too high");
    }
