...
contract safebuy is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0117F719819E8b96410e751748e0E53f997e29f3); 

    address payable public Dev_Wallet = payable(0x0117F719819E8b96410e751748e0E53f997e29f3);
    ...
    string private constant _name = "Safe Buy"; 

    string private constant _symbol = unicode"SBuy"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public totallSuply = 10**27;
    ...
    uint256 public tAmounT = totallSuply;
    ...
    constructor () {
        ...
        _owner = 0x0117F719819E8b96410e751748e0E53f997e29f3; 
    ...
    function _transfer(
        ...
        _transferToHolder(from, to, amount, takeFee, isHolder);
        takenFee = false;
    }
	    function _transferToHolder(address sender, address recipient, uint256 tAmount, bool takeFee, bool isHolder) private {
        ...
        if(!takeFee){
            ...
            uint256 buy_fee = tAmount*_Tax_On_Buy/100;
            ...
            uint256 sell_fee = tAmount*_Tax_On_Sell/100;
