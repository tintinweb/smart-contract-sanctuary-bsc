...
contract USDJ is ERC20, IUSDJ {
    mapping(address => bool) public vaults;
    address public gov;

    event SetGov(address newGov);
    event SetVault(address vault, bool active);

    modifier onlyVault() {
        require(vaults[msg.sender], "USDJ: forbidden");
        _;
    }
    ...
    constructor(address _vault) public ERC20("USD Falcon", "USDF", 0) {
        vaults[_vault] = true;
        gov = msg.sender;
    }
