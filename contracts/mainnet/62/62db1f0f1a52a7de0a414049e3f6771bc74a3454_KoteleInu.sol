...
contract KoteleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kotele Inu"; // 
    string private constant _symbol = "Kotele"; //    
