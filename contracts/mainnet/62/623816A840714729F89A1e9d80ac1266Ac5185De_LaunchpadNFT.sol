...
/**
 * @title Marble NFT Launchpad
 * @notice Pre-market sell Marble NFT tokens.
 */
    ...
    ReentrancyGuardUpgradeable
{
    ...
    /**
     * @notice Buy Marble NFT token from launch
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 nftId = marbleNFT.launchpadMint(
            msg.sender,
            _launch.level,
            false
        );
