...
contract SALL is IERC20, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address routerAddress) public initializer { 
        ...
        __Context_init_unchained();
        __Ownable_init_unchained();
        __SALL_v1_init_unchained(routerAddress);

    }

    function __SALL_v1_init_unchained(address routerAddress) internal initializer {
        ...
        snipeBlockAmt = 3;
        MarketingAddress = 0x205eF8Aab68aa252EC469ee651e3A5843E1e1Bff;
