...
contract FckValentine is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckValentines";
    string constant _symbol = "INGLE";
    ...
    uint256 public _marketingFeeSell = 1600;
    ...
    address payable private _marketingWallet = payable(0xEA47670824D0c59d641517DE2fBf8538F3FbF2Af);
