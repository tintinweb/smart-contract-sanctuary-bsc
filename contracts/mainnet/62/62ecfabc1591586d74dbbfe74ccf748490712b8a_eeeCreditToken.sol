...
contract eeeCreditToken is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000;   // 10 EEEC tokens
    // Trading bool
    ...
    /**z
     * @notice Constructs the EEEC token contract.
     */
    constructor(address _feeWallet) public BEP20("eeeCredit", "EEEC") {
        operator = _msgSender();
    ...
    /// @dev overrides transfer function to meet tokenomics of EEEC
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "EEEC::transferOperator: new operator is the zero address");
