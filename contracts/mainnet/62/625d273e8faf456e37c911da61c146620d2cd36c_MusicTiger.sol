...
contract MusicTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MusicTiger";
    string private _symbol = "MusicTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x974a0E94D5A5Cc4FE1c174412FE2E58F969b29bE); // Marketing Address
    address payable public teamWalletAddress = payable(0xE68505e5512b2f87546D03885755ab94e9c19411); // Team Address
    ...
    uint256 private _totalSupply = 10 * 10**2* 10**2 * 10**2 * 10**_decimals;
    uint256 public _maxTxAmount = 10 * 10**2 * 10**2* 10**2 * 10**_decimals; 
    uint256 public _walletMax = 10 * 10**2 * 10**2* 10**2 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10 * 10**2* 10**2 * 10**_decimals; 
