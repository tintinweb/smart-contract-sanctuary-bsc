...
contract MozartInu is Context, IERC20, Ownable {
    ...
    string private _name = "Mozart Inu";
    string private _symbol = "MOZARTINU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x190F99f18C24AE711FE175DCBf002cc4E5dA7f92);
