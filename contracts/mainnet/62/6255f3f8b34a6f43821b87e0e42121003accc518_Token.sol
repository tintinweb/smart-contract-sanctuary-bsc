...
contract Token is ERC20, ERC20Burnable, IDividendDistributor, Ownable {
    ...
    function setLimit(uint256  txMax,uint256 positionMax,uint256 part) external onlyOwner { 
