...
/* Token contract */
contract SquidMoonGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb60e9dfC936fAf7Db9d4F8Cff7D30e9FE6732270;
    ...
    // Name and symbol
    string constant _name = "SquidMoonGrow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 5000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb60e9dfC936fAf7Db9d4F8Cff7D30e9FE6732270;
