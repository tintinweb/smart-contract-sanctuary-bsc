...
contract NIKEFOX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NIKEFOX";
    string private _symbol = "NIKEFOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x102ad0FA3a3d52eD632Be59647C7Ef70bd67C558);
    address payable public teamWalletAddress = payable(0x102ad0FA3a3d52eD632Be59647C7Ef70bd67C558);
