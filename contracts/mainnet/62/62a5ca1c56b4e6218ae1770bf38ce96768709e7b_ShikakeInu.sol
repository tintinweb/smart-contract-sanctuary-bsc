...
/** SHIKAKE iNU 矿兔
Tuzi礦場是在BSC網絡上推出的社區代幣。偉大的營銷將在這裡進行，以創建一個未來的項目，讓您在投資中感到舒適和安全。
https://t.me/shikakeinu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd8E673381CaD01A9935010Ef66A07109c6D2bCa5; // owner address
...
contract ShikakeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikake Inu ";
    string private _symbol = "SHIKAKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd8E673381CaD01A9935010Ef66A07109c6D2bCa5); // 
    address payable public teamWalletAddress = payable(0xd8E673381CaD01A9935010Ef66A07109c6D2bCa5  ); // 
