...
SpaceAkitaZilla ($SAZ) Stealth launching with hype of Space Doge Zilla. 
3% of every transaction is distributed amongst loyal Holders.
9/9 Tax, lp locked and ownership renounced bullish name.

Telegram: https://t.me/SpaceAkitaZilla
...
contract SpaceAkitaZilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x79990E486B4c7d3cCe247cED86A2ae0Ce182a867); 
    address payable public Wallet_Dev = payable(0x79990E486B4c7d3cCe247cED86A2ae0Ce182a867);
    ...
    string private constant _name = "SpaceAkitaZilla"; 
    string private constant _symbol = unicode"SAZ"; 
    ...
    constructor () {
        ...
        _owner = 0x79990E486B4c7d3cCe247cED86A2ae0Ce182a867;
