...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD40CB461Ac5C8d5D5b50a3C07aBE2B886178Ade1; // owner address
...
contract MaxDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaxDAO";
    string private _symbol = "MaxDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD40CB461Ac5C8d5D5b50a3C07aBE2B886178Ade1); // Marketing Address
    address payable public teamWalletAddress = payable(0xD40CB461Ac5C8d5D5b50a3C07aBE2B886178Ade1); // Team Address
