...
/**YardTools a delivers a sophisticated set of tools for tracking and monitoring.


https://t.me/YardTools

YardTools ETH bot @YardtoolsETHbot
YardTools BSC bot @YardToolsBSC_bot
https://theyard.tools/
*/
...
contract YardTools is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Yard Tools";
    string constant _symbol = "YARD";
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xc0a8b0e4B95d30661c138371ACD3e98e6ad7794E;  
        anothermarketingWallet = 0xc0a8b0e4B95d30661c138371ACD3e98e6ad7794E;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(1).div(10);
