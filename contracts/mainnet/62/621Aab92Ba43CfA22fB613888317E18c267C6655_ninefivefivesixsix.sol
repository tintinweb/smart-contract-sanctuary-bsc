...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb3E268157bB5E3ea0eE7952B3764fCD4e7e6B6D; // owner address
...
contract ninefivefivesixsix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "95566";
    string private _symbol = "95566";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfb3E268157bB5E3ea0eE7952B3764fCD4e7e6B6D); // 
    address payable public teamWalletAddress = payable(0xfb3E268157bB5E3ea0eE7952B3764fCD4e7e6B6D); // 
    ...
    uint256 private _totalSupply = 95566 * 10**_decimals;
    uint256 public _maxTxAmount = 95566 * 10**_decimals; 
    uint256 public _walletMax = 95566 * 10**_decimals;
