...
contract BabyBitBurnReflect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Jizz XRP", "JIZZXRP") {
        marketingWallet = payable(0x1Eb7a82C7DEf417F0971d9FA009137138C2A44E2);
        devWallet = payable(0x1Eb7a82C7DEf417F0971d9FA009137138C2A44E2);
        ...
        uint256 totalTokenSupply = (69_000_000_000) * (10**18);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    BabyBitBurnReflect public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BabyBitBurnReflect(mainContract);
