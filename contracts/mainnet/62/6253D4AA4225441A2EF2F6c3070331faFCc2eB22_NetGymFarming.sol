...
contract NetGymFarming is OwnableUpgradeable, ReentrancyGuardUpgradeable {
	...
	require(_pid !=0,"Withdraws are Temporary Disabled");
    ...
    function getDepositPriceInfo(address _user)
        external
        view
        returns (UserDepositPriceInfo memory)
    {
        return userSpecialOfferDeposit[_user];
    }

function setStorageInfo(address _user) public onlyOwner {
