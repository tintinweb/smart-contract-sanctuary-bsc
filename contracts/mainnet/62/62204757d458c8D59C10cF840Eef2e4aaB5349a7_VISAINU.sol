...
𝑬𝑨𝑹𝑵 25 𝑫𝑶𝑳𝑳𝑨𝑹𝑺 𝑷𝑬𝑹 𝑫𝑨𝒀 𝑩𝒀 𝑯𝑶𝑳𝑫𝑰𝑵𝑮 𝑴𝑶𝑹𝑬 𝑻𝑯𝑨𝑵 3%


𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 > https://t.me/VisaInu

𝗪𝗘𝗕𝗦𝗜𝗧𝗘 > https://www.visa.lol

𝗧𝗪𝗜𝗧𝗧𝗘𝗥 > https://twitter.com/VisaInu
...
contract VISAINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "VISAINU";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 7; 
    uint256 public _VisaReward = 5; 
    address public  _marketing = 0x0040d742612d14998D94d8C42BE2084c95203390;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _VisaReward / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _VisaReward / (_marketingAndLiquidityFee + _VisaReward);
