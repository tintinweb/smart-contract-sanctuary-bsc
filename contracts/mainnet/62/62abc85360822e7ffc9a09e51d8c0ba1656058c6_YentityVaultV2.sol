...
// Safe yentity transfer low-level function, just in case if rounding error causes the pool to do not have enough YENTITYs,
...
contract YentityVaultV2 is OwnableUpgradeSafe, RescueTokens {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of YENTITYs
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. YENTITYs to distribute per block.
        uint256 accYentityPerShare; // Accumulated YENTITYs per share, times 1e12. See below.
    ...
    // Update the given pool's YENTITYs allocation point. Can only be called by the owner.
    ...
    // View function to see pending YENTITYs on frontend.
    ...
    // Safe yentity transfer function, just in case if rounding error causes pool to not have enough YENTITYs.
