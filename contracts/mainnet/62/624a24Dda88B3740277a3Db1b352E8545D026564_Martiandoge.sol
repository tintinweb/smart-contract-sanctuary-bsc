...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    address public marketAddr = 0x9Ac02A6CD79cBE1276feB17084576a1ef61e1a3B;
...
contract Martiandoge is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 300000000* 1e18;
    uint256 public _maxHavAmount = 300000000* 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;

    constructor() ERC20("Martian doge", "MAD", 18) DividendFee(1e17, true, USDT, 1) {
