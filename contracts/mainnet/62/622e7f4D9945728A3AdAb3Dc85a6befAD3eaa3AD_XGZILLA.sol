...
contract XGZILLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XGZILLA";
    string private _symbol = "XGZILLA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x977945E788537c4EDDc78983af38BF6936770117); // Marketing Address
    address payable public teamWalletAddress = payable(0xb92845A2Be6eB5Dd6d93064Ba22EFe2D0Db50f4D); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x2f1721A88191BF9eF8e9224510aa00194BE7F44B),
            block.timestamp
        );
    }
