...
contract UFOFinanceCash is IERC20 {
    ...
    string constant private _name = "UFO Finance Cash";
    string constant private _symbol = "UFC";
    ...
    address public developmentWallet = 0x911e34F9dD39CfF25dB896765DDa9266652F1c0c;
    ...
    constructor () payable {
        ...
        IERC20_PairedToken = IERC20(USDT);
...
//===============================================================================================================
    ...
    function setWallets(address development) external onlyOwner {
