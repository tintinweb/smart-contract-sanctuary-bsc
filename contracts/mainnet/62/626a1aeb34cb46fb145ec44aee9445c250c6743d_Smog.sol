...
contract Smog is Context, IERC20, Ownable{
    ...
    string private _name = "Smog";
    string private _symbol = "SMOG";
    ...
    function transferForeignToken(address _token, address _to) external onlyOwner returns (bool _sent)
  {
    ...
    function dividedAdd(uint256 newLimit) external onlyOwner {
        _maxAmountTx = newLimit;
    }

    function newAddress() public view returns (uint256) {
