...
contract X is IBEP20, Ownable
{
    ...
    uint256 currentAmountToSwap = 1500000000 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x69d2333997d875308B28863C6947f19D711a0dEb);
    address public MarketingWallet=payable(0xdE52E2187C8f988e385b769cB38c30B44af3507e);
    //TestNet
	...
	uint256 private antiWhale = 2000000000 * 10**_decimals; //0.2%
