...
/**
 * @title pikachuSwap Farms Auctions.
...
contract FarmAuction is Ownable, ReentrancyGuard {
    ...
    IERC20 public immutable pikachuToken;
    ...
    /**
     * @notice Constructor
     * @param _pikachuToken: address of the $Pikachu token
     * @param _operatorAddress: address of the operator
     * @param _maxAuctionLength: max amount of blocks for an auction
     */
    constructor(
        address _pikachuToken,
        ...
        pikachuToken = IERC20(_pikachuToken);
     ...
     * @param _amount: amount of the bid in $Pikachu token
    ...
    function bid(uint256 _amount) external nonReentrant {
        ...
        pikachuToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function claimAuction(uint256 _auctionId) external nonReentrant {
        ...
        pikachuToken.safeTransfer(address(msg.sender), claimableAmount);
    ...
    /**
     * @notice Close an auction round, and store $Pikachu leaderboard threshold
     * @param _bidLimit: minimal $Pikachu committed to be a winner
     * @dev Callable by operator
     */
    ...
    /**
     * @notice Claim $Pikachu for all bids by bidders in leaderboard
     * @param _auctionId: auction id
     * @param _bidders: addresses of bidders
    ...
    function recoverToken(address _token, uint256 _amount) external onlyOwner {
        require(_token != address(pikachuToken), "Recover: Cannot be Pikachu token");
