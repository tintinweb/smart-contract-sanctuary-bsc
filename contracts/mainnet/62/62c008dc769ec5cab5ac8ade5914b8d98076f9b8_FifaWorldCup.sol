...
/**
 *Fifa World Cup
  is not just a simple Meme coin but a combination that integrates Meme coins and cryptocurrencies.
  Meme coins are the king of cryptocurrencies, the World Cup is the main competition in football.
  everyone hopes that there will be a more prosperous future waiting for them.
  The combination of the two will create a new king on the proposed Meme coins,
  Let's look forward to the Fifa Worldcup!

*/

// *Telegram : https://t.me/WorldCup_Binance
