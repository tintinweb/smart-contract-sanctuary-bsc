...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x426AE2b6655E55A03251a3F91Bafb1A3aEabbd61;
...
contract KAZA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x494bdaDF7d8421Ca6622B62b369b30ca708B906f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kaza Inu";
    string private _symbol = "KZINU";
