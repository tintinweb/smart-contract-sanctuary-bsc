...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5CF3A4900d217A9A115A326129C2B5Cc08F96E1c; // owner address
...
contract ShibTuzi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibTuzi";
    string private _symbol = "Stuzi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x419c39431216a1c8322aDF00C94c2109737F26fE); // Marketing Address
    address payable public teamWalletAddress = payable(0x419c39431216a1c8322aDF00C94c2109737F26fE); // Team Address
