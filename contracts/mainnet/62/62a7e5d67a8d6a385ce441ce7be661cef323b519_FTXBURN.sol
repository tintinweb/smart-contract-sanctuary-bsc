...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x134b29569A14158500880c0a915cAfcc36e7d26D; // owner address
...
contract FTXBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX BURN";
    string private _symbol = "FTXBURN";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x134b29569A14158500880c0a915cAfcc36e7d26D); // Marketing Address
    address payable public teamWalletAddress = payable(0x134b29569A14158500880c0a915cAfcc36e7d26D); // Team Address
