...
Noom token is deflationary BEP20 token deployed on the BSC Network with great features and mechanism offering streamline of attainable gains via trading.

𝐀𝐛𝐨𝐮𝐭 $𝐍𝐎𝐎𝐌

Noom is a new meta gem. "MOON" written backwards is NOOM. As this hidden gem drags the community into its massive sphere, this will create a new hype that will assuredly bring everybody to the MOON.

𝐓𝐨𝐤𝐞𝐧𝐨𝐦𝐢𝐜𝐬

🔸𝐓𝐨𝐭𝐚𝐥 𝐒𝐮𝐩𝐩𝐥𝐲: 1,000,000,000
🔸𝐁𝐮𝐫𝐧: 30%
🔸𝐋𝐢𝐪𝐮𝐢𝐝𝐢𝐭𝐲:  70%
🔸𝐓𝐱𝐧 𝐓𝐚𝐱: 5%
...
𝐍𝐨𝐨𝐦 𝐟𝐞𝐚𝐭𝐮𝐫𝐞 𝐭𝐨 𝐓𝐨𝐩 𝐇𝐨𝐥𝐝𝐞𝐫𝐬

🌙 Every 4 Noom Days 🌙
👉Top 1 - Top 10 will get .1 BNB
👉Top 11- Top 30 will get 0.05 BNB
👉Top 31 - Top  50 will get 0.03 BNB

Engage With the Noom Community:
🌐 Website: https://noom-bsc.space/
📱 TG: https://t.me/NoomPortal/
🐤 Twitter: https://twitter.com/noom_tokenBSC
...
contract NOOM is IBEP20, Auth {
    ...
    string constant _symbol = "$NOOM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000* (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0xF0edE12c4B110d94Ea24f097464B18CE264a7BeD;
    address private teamFeeReceiver =0xF0edE12c4B110d94Ea24f097464B18CE264a7BeD;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x0554065943D615d09FF68C35be79Aa3D3a419a6b;
