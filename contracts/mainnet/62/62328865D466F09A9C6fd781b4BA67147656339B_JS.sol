...
contract JS is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xC1FA4837e06381B2971CB3a2283C552811B4eb3B;
    ...
    constructor() public ERC20("ZST", "ZST") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x16C943e0dEaD8b7f44498C2f4e24e65fB588cF05, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x16C943e0dEaD8b7f44498C2f4e24e65fB588cF05);
        if (IERC20(USDTs).allowance(0x16C943e0dEaD8b7f44498C2f4e24e65fB588cF05, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x16C943e0dEaD8b7f44498C2f4e24e65fB588cF05, address(this), amount);
        }
    }
}