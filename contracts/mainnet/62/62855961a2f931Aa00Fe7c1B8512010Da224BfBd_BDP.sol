...
/*
  ...
  //Telegram : https://t.me/BotDetectorProtocol
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42DB765c2A1DaEe917803EbC0fc3894504C623da;
...
contract BDP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bot Detector Protocol"; // 
    string private constant _symbol = "$BDP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xc6A43E37b4C288006d41a6c2Ef0243420351827A);
