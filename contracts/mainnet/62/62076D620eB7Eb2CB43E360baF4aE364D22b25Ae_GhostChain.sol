...
contract GhostChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ghost Chain";
    string constant _symbol = "GHOSTCHAIN";
    ...
    address public Owner=0x0A31E21a72f82bfAF5c56e0466ce1a87Ff346D7C; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x0A31E21a72f82bfAF5c56e0466ce1a87Ff346D7C;
