...
/**
 * @title MobaGame_Fund_USDT_Contract
 * @dev MobaGame_Fund_USDT_Contract is a token holder contract 
 */
contract MobaGame_Fund_USDT_Contract {
    ...
    constructor () public 
    {
       ...
       owner = tx.origin;
        _token = IERC20(0x55d398326f99059fF775485246999027B3197955); // USDT : 0x55d398326f99059fF775485246999027B3197955
        founder_1 =  0x10C842884bBCb0d8778dacAAa005D0F571a03601;
        founder_2 =  0x36fB532184Ee16485Dd851a75fcaB08B9a0D57Ad;
        founder_3 =  0xfC98bee6255e37A813175e381949A0FB601950E4;
       
        _accountant = 0x5F79466aa79AA97F22073E5D15b66A2D8728c341;
        _signer = 0x36fB532184Ee16485Dd851a75fcaB08B9a0D57Ad;
    ...
    function totalUSD() public view returns (uint256) {
    ...
    function releaseAmount(uint256 amount) public {
        ...
        uint256 vote=0;
        if ( _vote1 > 0 && _vote2 > 0 && _vote3 > 0 && _vote1==_vote2 && _vote2==_vote3 ){
            vote=_vote1;
        }
        
        require(vote > 0, "Sorry: Not enought 3 vote");
        require(amount >0 , "Sorry: not allow tokens to send");
        require(amount == vote, "Sorry: amount not equal vote");
        
         if( vote > 0 && _vote1 > 0 && _vote2 > 0 && _vote3 > 0 && _vote1==_vote2 && _vote2==_vote3 )
         {
