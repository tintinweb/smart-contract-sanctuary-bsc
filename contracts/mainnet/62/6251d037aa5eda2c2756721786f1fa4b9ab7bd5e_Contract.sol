...
contract Contract is Context, IERC20 { 
    ...
    string private _symbol = unicode"RYN";
    ...
    uint256 public _maxTransactionAmt = _tTotal * 1 / 200;
    ...
    address payable public MarketingWallet = payable(0x057594f34e6A95857505855C90eB0D80c1cd8469);
