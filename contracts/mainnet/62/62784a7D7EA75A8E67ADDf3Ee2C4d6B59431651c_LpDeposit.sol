...
contract LpDeposit is AccessControlEnumerable { 
    using SafeERC20 for IERC20;

    bool public rewardWithdrawSwitch = true;
    bool public bonusSwitch = false;
    address public daos = 0x87b903535c983Bd9f1f1fD5d64c55e02A5c4b18e;
    address public fuel = 0xADC660e078F274844025c2159A5b9f6cA143B2B5;
    address public usdtDaosPair = 0x5D4A0b382e7d13b38399BF44e082C4E3E1E1502A;
    ...
    address public fuelTreasury = 0x4c596c6595c11c5B11E837b68D84aA63EC5d8D99;
    ...
    function setDaos(address _addr) external onlyRole(OPERATOR_ROLE){
        daos = _addr;
    }

    function setUsdtDaosPair(address _addr) external onlyRole(OPERATOR_ROLE){
        usdtDaosPair = _addr;
    }
    ...
    function harvestBatch() external {
        ...
        if (totalPending > 0) {
            IERC20(daos).transfer(msg.sender, totalPending);
        }
    }
    ...
    function harvestForBonus() external {
        ...
        if(totalBonusPending > 0) {
            ...
            IERC20(fuel).transferFrom(msg.sender, fuelTreasury, burnAmount);
