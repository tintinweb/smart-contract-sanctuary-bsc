...
Telegram: https://t.me/NewCommunitySFM
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SFM = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SFM.balanceOf(address(this));
        ...
        uint256 amount = SFM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SFM.transfer(shareholder, amount);
...
contract NewCommunitySFM is IBEP20, Auth {
    using SafeMath for uint256;

    address SFM = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NewCommunitySFM";
    string constant _symbol = "NewSFMoon";
    ...
    address public Owner=0x0b19416d71d92a874C024Af0152a41AD9A22420A; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x0b19416d71d92a874C024Af0152a41AD9A22420A;
