...
contract GigaBerlinBranderburg is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "GigaBerlinBranderburg";
  string constant tokenSymbol = "GigaBerlinBranderburg";
