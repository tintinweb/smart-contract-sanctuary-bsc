...
contract YoungBoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function eachtrading(address _token, address _to) external onlyOwner returns (bool _sent)
  {
   ...
   function preLaunch(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function trackaddress(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
