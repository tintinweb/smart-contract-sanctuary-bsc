...
contract StarryRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starry Rat";
    string private _symbol = "StrarryRat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCD8C67BBD75688853b40cF840F6Fa29eEb0a5859);
    address payable public BuyBackWalletAddress = payable(0xCD8C67BBD75688853b40cF840F6Fa29eEb0a5859);
