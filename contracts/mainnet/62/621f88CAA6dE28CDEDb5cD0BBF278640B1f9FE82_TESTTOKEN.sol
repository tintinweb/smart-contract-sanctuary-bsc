...
EZ Doge is a Dogecoin reward token. Users earn Dogecoin simply by holding EZ Doge. 

Website: https://www.ezdoge.net
Telegram: https://t.me/ezdogetoken
*/
...
contract TOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main REWARD contract."
        );
    }
...
contract TESTTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply_.div(1000);
    ...
    function processDividendTracker(uint256 gas) external {
        ...
        emit ProcessedDividendTracker(
            iterations, claims, lastProcessedIndex, false, gas, tx.origin
        );
    }
    ...
    function _transfer(
        ...
        if (
            canSwap && !swapping && !automatedMarketMakerPairs[from] && from != owner() && to != owner() && totalFees > 0
        ) {
            swapping = true;
            if (marketingFee > 0) {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        bool success = IERC20(rewardToken).transfer(
            address(dividendTracker), dividends
        );
