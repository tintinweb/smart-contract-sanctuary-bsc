...
contract BWW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BWW TEST";
    string private _symbol = "BWW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBDee47a4CEEeE39431069611b1d96ff1230092C2);
    address payable public teamWalletAddress = payable(0xBDee47a4CEEeE39431069611b1d96ff1230092C2);
