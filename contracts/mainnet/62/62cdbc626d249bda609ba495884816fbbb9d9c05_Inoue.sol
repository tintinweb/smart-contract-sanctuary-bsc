...
Orihime Inoue (井上 織姫, Inoue Orihime) is a Human living in Karakura Town. She is a former student of Karakura High School. She is married to Ichigo Kurosaki and has a son named Kazui Kurosaki.

Gojounomics
✔️ Marketing Calls 30 Holders With 1-2k MarketCap
✔️ Middle Tax Fee 7-8%
✔️ Anime Trend Easy Moon
✔️ Contract Safe
✔️ Liquidity Locked
✔️ Owner Renounced

Marketing Plan
✔️ Shill For Your Bags
✔️ 1-2k Marketcap ( 3-4 Micro Calls )
✔️ 4-5k MarketCap ( Midle Calls Average, Lemon, Valhalla Gambler or Bsc Low Tax )
✔️ 10-20k ( Travladd Safu Calls )
...
contract Inoue is Context, IERC20, Ownable {
    ...
    string private constant _name = "Inoue INU "; //
    string private constant _symbol = "INOUE "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x08087fADDA1a9D54E5c8856FFd9afa75C3a5FCf3 ;
