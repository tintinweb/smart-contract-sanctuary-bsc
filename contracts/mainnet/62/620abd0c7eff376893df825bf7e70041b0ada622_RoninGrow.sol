...
//RoninGrow =================================================================================== TO THE MOON
//Telegram : https://t.me/ronin_grow
...
contract RoninGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf0E3B4A381650174AE2F3A79432A0d6C020f3CeD); 
    address payable public Wallet_Dev = payable(0xA1C845d65501a782F1aC4152b40a7dfc741CD87C);
    address payable public W_Deployer = payable(0xA1C845d65501a782F1aC4152b40a7dfc741CD87C);
    ...
    string private constant _symbol = unicode"RONINGROW"; 
    ...
    constructor () {
        ...
        _owner = 0xA1C845d65501a782F1aC4152b40a7dfc741CD87C;
