...
/**
Ukraine Rise UP is a charity Crypto token, in collaboration with the R4R foundation. Their operations are scaled up to support refugees fleeing from conflict in Ukraine!

Homepage - https://www.ukraineriseup.io/
Twitter - https://twitter.com/UKRRISEUP
Telegram - https://t.me/UKRRISEUP_Official

R4R - https://refugee4refugees.gr/
R4R sosials - https://www.facebook.com/Refugee4Refugees

Tokenomics: 
2% LP
8% Charity and marketing (70% goes to charity, and 30% to marketing)
*/         
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // No rewards! Everything goes to charity!
...
contract UKRRiseUp is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "UKRRiseUp";
    string constant _symbol = "UKRRiseUp";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // No rewards! Everything goes to charity!
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x15fB118A2F660Fdb7d655974FA72C84a3fd20c47;  // The Charity wallet
        anothermarketingWallet = 0xfff0D791b62ae4BB9E608894bb5848F9F41f3983; // The actual marketing wallet
