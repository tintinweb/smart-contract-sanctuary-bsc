...
contract BDVIP_Dist is AccessControlUpgradeable, PausableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        partners.push(0x058C02254965Cf3e6d19a7ea9d5a80ba7655EBA6);
        partners.push(0xD2308164406E4cd89756e6aF9B0e4809B685B9CB);
...
//*************** USER FUNCTIONS ******************************* */
     ...
     function distribute() public whenNotPaused(){
        require(usdt.balanceOf(address(this)) > 0, "Nothing to distribute");
    
        // transfer funds
        uint256 _amount = usdt.balanceOf(address(this))/partners.length;

        for(uint i=0; i<partners.length; i++){
                usdt.transfer(partners[i], _amount);
        }
    }

//*************** ADMIN FUNCTIONS ******************************* */
    
   function updatePartners(address[] memory _partners) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused(){
       partners = _partners;
    }
