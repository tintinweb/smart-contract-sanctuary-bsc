...
contract CyberCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x594Cf024eB59523C42cddc91ED1ff501Dc4291F4); 
    address payable public Wallet_Dev = payable(0x594Cf024eB59523C42cddc91ED1ff501Dc4291F4);
    ...
    string private constant _name = "Cyber Cat"; 
    string private constant _symbol = unicode"CyberCat"; 
    ...
    constructor () {
        ...
        _owner = 0x594Cf024eB59523C42cddc91ED1ff501Dc4291F4;
