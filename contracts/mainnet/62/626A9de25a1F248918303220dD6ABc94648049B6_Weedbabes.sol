...
contract Weedbabes is Context, IERC20, Ownable {
    ...
    string private constant _name = "Weedbabes";
    string private constant _symbol = "Weedbabes";
