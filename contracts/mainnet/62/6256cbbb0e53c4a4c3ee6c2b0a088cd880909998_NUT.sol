...
contract NUT is Context, IBEP20, Ownable {
    ...
    string private _name = "NUT"; // token name
    string private _symbol = "$NUT"; // token ticker
    ...
    uint256 public maxBuyLimit = 10000000 * 1e9;
