...
contract GAMBLERSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GAMBLERSE";
    string private _symbol = "GAMBLERSE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDEf9Ded827782db54FCf6ba5bfAE30062A10081D); 
