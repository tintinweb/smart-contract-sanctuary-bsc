...
contract DOGEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("DOGE_Dividen_Tracker", "DOGE_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 500 * (10**18); //must hold 50000+ tokens
    }
...
pragma solidity ^0.6.12;
contract PumpkinTwitter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _DevWalletAddress = 0xDaf0Bb3D734c729a9FD117b317AB09226cC78c9F;
    address public _FoudWalletAddress = 0x3937539FECEBf0EF3601f8608b88605A7EEF1aCC;
    ...
    uint256 public DOGERewardsShare = 4;
    ...
    uint256 public snipeTime = 2; // unix time in seconds
    ...
    // lockWallet
    address public _AppWalletAddress = 0x48A50037609518A6C4716c9888a4c118CB75dE9d;
    address public _CrossWalletAddress = 0xDaf0Bb3D734c729a9FD117b317AB09226cC78c9F;
    ...
    constructor() public ERC20("Pumpkin Twitter", "PTwitter") {
