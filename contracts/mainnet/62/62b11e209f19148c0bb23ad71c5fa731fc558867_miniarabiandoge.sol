...
Mini Arabian Doge is a hyper-deflationary token that rewards its holders with reflections. So, just by holding, believing, and supporting the project, you automatically earn more Mini Arabian Doge tokens with every transaction!

🐪 Arabian DAO
♻️ Automatic LP
🌆 Mini Arabian Doge NFTs
🎨 NFT Marketplace
💵 Arabian Ventures
🛠 Real-Life NFT Utility

Telegram: https://t.me/miniarabiandoge
...
contract miniarabiandoge is IERC20, Ownable {
