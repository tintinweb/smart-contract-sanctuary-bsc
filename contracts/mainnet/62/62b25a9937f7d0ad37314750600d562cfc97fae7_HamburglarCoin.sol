...
/* 
//HamburglarCoinOfficial
Totally Supply: 10M
Initial MC: 3BNB
Liquidity Lock: Mudra for 3days
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x893253DdF0437D8dFe9857aC3d0C86Ad04e15aD2;
...
contract HamburglarCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x893253DdF0437D8dFe9857aC3d0C86Ad04e15aD2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HamburglarCoin";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**8;
