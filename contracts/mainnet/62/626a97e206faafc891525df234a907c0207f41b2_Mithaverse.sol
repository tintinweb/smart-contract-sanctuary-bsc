...
// SPDX-License-Identifier: UNLICENSED
    ...
    contract Mithaverse is IStakeable {
        ...
        event PoolDetailsUpdated(uint256 rewardAmount, uint256 stakingDuration);
        ...
        function stake(uint256 amount, uint256 _stakePool, Sign memory sign) external {
            require(_stakePool > 0 && _stakePool <= 4, "Pool value must me greater than zero or less than four");
        ...
        function unStake(uint256 amount, Sign memory sign) external {
            ...
            Users[msg.sender].rewards += getReward(msg.sender);
        ...
        function getReward(address account) public view returns(uint256) {
            ...
            if(Users[account].isStaker) {
                totalParticipants = getParticipantsByTierId(uint256(Users[account].tierId), Users[account].poolLevel);   
        ...
        function getParticipantsByTierId(uint256 tierId, uint256 poolLevel) public override view returns(uint256) {
