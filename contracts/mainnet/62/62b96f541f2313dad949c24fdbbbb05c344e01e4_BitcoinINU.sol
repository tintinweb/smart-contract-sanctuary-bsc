...
/*
https://bitcoin-inu.com/
https://t.me/bitcoininuentry
https://twitter.com/BitcoinInu_BSC
...
contract BitcoinINU is BEP20, Ownable, Pausable {
    ...
    IPancakeswapV2Router02 private pcsV2Router02;
    IPancakeswapV2Factory private pcsV2Factory;
    IPancakeswapV2Pair private pcsV2Pair;
    
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) BEP20(_tokenName, _tokenSymbol) payable
    {
        ...
        pcsV2Router02 = IPancakeswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Mainnet PCS V2 Router 
        pcsV2Factory = IPancakeswapV2Factory(pcsV2Router02.factory());
        pcsV2Pair = IPancakeswapV2Pair(pcsV2Factory.createPair(address(this), pcsV2Router02.WETH()));
        taxWallets["liquidity"] = address(0);
        setBuyTax(3,1); //dev tax, liquidity tax
        setSellTax(3,1); //dev tax, liquidity tax
        setTaxWallets(address(0xaff8D1eD3cA3abE6B780797ba907c70091d4AD4d)); // replace this with your wallet
        exclude(msg.sender);
    ...
    function handleTax(address from, address to, uint256 amount) private returns (uint256) {
        ...
        sellPath[1] = pcsV2Router02.WETH();
        
        if(!isExcluded(from) && !isExcluded(to)) {
            uint256 tax;
            uint256 baseUnit = amount / denominator;
            if(from == address(pcsV2Pair)) {
                ...
                uint256 ethValue = pcsV2Router02.getAmountsOut( devTokens + liquidityTokens, sellPath)[1];
                ...
                if(ethValue >= swapThreshold) {
                    ...
                    _approve(address(this), address(pcsV2Router02), toSell);
            
                    pcsV2Router02.swapExactTokensForETH(
                        toSell,
                        0,
                        sellPath,
                        address(this),
                    ...
                    _approve(address(this), address(pcsV2Router02), liquidityToken);
                    
                    pcsV2Router02.addLiquidityETH{value: liquidityETH}(
                        address(this),
                        liquidityToken,
                        0,
                        0,
    ...
    function _transfer(
        ...
        require(!isBlacklisted(msg.sender), "BEP20: sender blacklisted");
        require(!isBlacklisted(recipient), "BEP20: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "BEP20: sender blacklisted");
    ...
    function triggerTax() public onlyOwner {
        handleTax(address(0), address(pcsV2Pair), 0);
    }
    ...
    function pause() public onlyOwner {
        require(!paused(), "BEP20: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "BEP20: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "BEP20: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "BEP20: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "BEP20: Account is already excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "BEP20: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "BEP20: Tax is already disabled");
        taxStatus = false;
    }
