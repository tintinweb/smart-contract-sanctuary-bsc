...
contract BTSAN is ERC721Enumerable, Ownable {
    ...
    string private _uri = "https://nft.staralliance.top/json/";
    ...
    constructor() ERC721("BTSA NFT", "BTSAN") {
        manager = 0x74668fA8132cF68C120A0f609EC4eaE981cfe2DD;
        cids[1] = "1.json";
        cids[2] = "2.json";
        cids[3] = "3.json";
        cids[4] = "4.json";
