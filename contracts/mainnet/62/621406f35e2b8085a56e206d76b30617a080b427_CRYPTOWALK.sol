...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xa2F1FB5B120434128502E05c15740E1e34134573;
        _token = msg.sender;
    }
...
contract CRYPTOWALK is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x09CDeA40476c4B7C2e51c0e13FC4Aeb48A07Bb57;
    address DevWallet       = 0xADE8bEfC4CcbA4cA9812Cf127e9c507D52eB961d;

    string constant _name = "CryptoWalk";
    string constant _symbol = "CWALK";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000 * (2 ** _decimals);
    uint256 public _maxWalletToken = 100000000 * (1 ** _decimals);
    ...
    uint256 public sellMultiplier  = 270;
    ...
    address PAIR = 0x3a79460b27A8D3278BB71af6fE70d97BbD7E8Bd2;
