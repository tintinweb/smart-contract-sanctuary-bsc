...
contract FATMNH is IBEP20, Admin{
    ...
    string constant _name = "FIFA TO MOON";
    string constant _symbol = "FATMNH";
    ...
    address private marketingFeeReceiver = (0x242581aE1d9fdCc1be2DD53EebCDA5431519bB2B); // marketing address
    ...
    function setBMFATMNH(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMFATMNH(uint256 fv) external onlyOwner {
        totalFee = fv;
    }
