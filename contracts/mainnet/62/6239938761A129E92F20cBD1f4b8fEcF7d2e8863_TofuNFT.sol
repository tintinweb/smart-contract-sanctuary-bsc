...
// File: contracts/YoungKingsClub.sol

pragma solidity ^0.8.0;
contract TofuNFT is ERC721, ERC2981, PaymentSplitter, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;
  Counters.Counter private supply;
  string public uriPrefix = "ipfs://QmRn5co4CKLQAJ6G3NJFrcyefdAqmb8QC8irmnvoAvPBMW/"; // Metadata URI from pinata
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  uint96 royaltyFeeInBips = 500;  // Royalty fee - 500 means 5% royalty
  uint256 public preSaleWalletLimit = 5;  // NFTs per walllet for whitelist sale
  uint256 public publicSaleWalletLimit = 10; // NFTs per wallet for public sale
  uint256 public cost = 0.1 ether; // Cost in ethereum (You can use any currency) 
  uint256 public maxSupply = 100; // Maximum supply of the NFTs
  uint256 public maxMintAmountPerTx = 15; // Maximum mint per transaction
  uint[] private _shares = [50,25,25]; // Percentage per share holder
  bool public paused = false; // Contract is paused or open for sale
  bool public revealed = true; // NFTs are revealed or not - True means instant reveal
  bool public onlyWhitelisted = true; // Whitelist sale or public sale
  bytes32 public RootHash = 0xd1ae9784a402bf9e7ec83dd76f3abe89f89c459a96d7880854e41a86f526f3f2; // Root hash - to be generated and updated
  address royaltyReceiver; // Default to the wallet who deploys the contract
  address[] private _team = [
      0x5B38Da6a701c568545dCfcB03FcB875f56beddC4,
      0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2,
      0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db
  ]; // Address of share holders in order as per shares array

  // Change the name and symbol as per your collection, Change the prereveal metadata URI if you have one
  constructor() ERC721("TofuNFT", "TNFT") PaymentSplitter(_team, _shares) {
    setHiddenMetadataUri("ipfs://QmeE2iz66nDiWUtRn8f/hidden.json");
  ...
  function whitelistMint(uint _mintAmount, bytes32[] calldata _merkleProof) external payable {
    require(!paused, "The contract is paused!");
      if (onlyWhitelisted == true){
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, RootHash, leaf), "Not Whitelisted");
