...
contract BabyUlla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Baby Ulla";
    string private _symbol = "Baby Ulla";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x633e8d697d57214B6289A051482c715B422C5f87);
    ...
    uint256 private _totalSupply = 4200000000000* 10**9;
