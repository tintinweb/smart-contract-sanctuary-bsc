...
contract BeraFrens is Context, IERC20 { 
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Ownable: Sorry my frens your not owner!");
        _;
    }
    ...
    address payable public Wallet_Marketing = payable(0xD6F795E38Ce43a79751d0813A696ba5c37D4DcF6); 
    address payable public Wallet_Dev = payable(0x9b8cC1CB9b6F960B64aB2D9b807480dC98872bF0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Bera Frens"; 
    ...
    constructor () {
        ...
        _owner = 0x9b8cC1CB9b6F960B64aB2D9b807480dC98872bF0;
