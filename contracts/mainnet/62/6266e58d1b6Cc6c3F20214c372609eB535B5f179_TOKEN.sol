...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 30 * usdtDecimals;
        holderCondition = 1;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                ...
                isSell = true;
                uint256 airdropFeeAmount = _sellAirdropFee * tAmount / 10000;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = lpDividendFee + fundFee + lpFee;
        totalFee += totalFee;
    ...
    function setBuyFee(
        uint256 lpDividendFee, uint256 fundFee, uint256 lpFee
    ) external onlyOwner {
    ...
    function setSellFee(
        uint256 lpDividendFee, uint256 fundFee, uint256 lpFee, uint256 airdropFee
    ) external onlyOwner {
...
contract TOKEN is AbsToken {
    ...
    //USDT
        ...
        2100,
    //Receive，接收
        address(0x3a2DFAB4b09C5856d9fb5aeF25bC658a3f7df079),
    //Fund，营销
        address(0x0e93cEEF3Aa11997211bCe98a7A5Ce663dc88680)
    ){
