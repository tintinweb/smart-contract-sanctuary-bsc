...
contract BullFireNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bull Fire Network";
    string private constant _symbol = "BFNet";
