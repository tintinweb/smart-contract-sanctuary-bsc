...
contract KingCZInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "King CZ Inu";
    string constant _symbol = "KCI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //PCS Router
    ...
    uint256 public BNBRewardsFee = 40;
    uint256 public developmentFee    = 60; 
    uint256 public liquidityFee  = 20;
    uint256 public totalFees     = BNBRewardsFee + developmentFee + liquidityFee;
    ...
    uint256 private maxWalletRate = 2;
    ...
    function setFeeRates(uint256 _BNBRewardsFee, uint256 _liquidityFee, uint256 _developmentFee, uint256 _feeDenominator) public onlyOwner {
            BNBRewardsFee = _BNBRewardsFee;
            liquidityFee = _liquidityFee;
            developmentFee = _developmentFee;
            totalFees = _BNBRewardsFee + _liquidityFee + _developmentFee;
    ...
    function swapBack() internal lockTheSwap {
        ...
        if(developmentFee > 0){
            payable(devWallet).transfer(amountBNBTeam);
        }
