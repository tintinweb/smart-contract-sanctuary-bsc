...
/*
Name: Scam Detector Bot
Symbol: SDB
Supply: 1.000.000 SDB

Telegram: https://t.me/ScamDetectorbot_Bsc
*/
...
contract ScamDetectorBot is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Scam Detector Bot";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x723f5EDC3EeEaf6B6d88B594F0336eA744449201;
        marketingFeeReceiver = 0x723f5EDC3EeEaf6B6d88B594F0336eA744449201;
