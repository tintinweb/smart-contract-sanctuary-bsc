...
// POF.finance (POF)
// POF is a deflationary score based currency model
...
contract POF is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000 * _DECIMALFACTOR; // 69 Millions Tokens
    ...
    uint256 private _taxFee = 0; // starting with 0% tax
    uint256 private _burnFee = 0; // starting with 0% burn
    ...
    uint256 private _maxTransactionAmount = (_tTotal * 5) / 100;
    uint256 private _maxWalletAmount = (_tTotal * 5) / 100;
