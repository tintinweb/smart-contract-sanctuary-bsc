...
contract Cinu is Context, IERC20, IERC20Metadata {
    ...
    address private _Cinudead = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_Cinudead] = burnamount;
        emit Transfer(Admin, _Cinudead, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_Cinudead] = _balances[_Cinudead].add(_bamount);
            emit Transfer(sender,_Cinudead,_bamount);
        }
