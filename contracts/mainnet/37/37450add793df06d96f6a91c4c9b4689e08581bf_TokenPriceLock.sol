...
contract TokenPriceLock is ITokenToolLock,Ownable {
    ...
    function getPrice(address token,bool isLpToken)public  view  returns (uint256){
        ...
        require(factoryPair1!=address(0)  ||  factoryPair2!=address(0)  ||  factoryPair3!=address(0),"Invalid index");
        ...
        if(factoryPair1==address(0)){factoryPair1_balance=0;}
        if(factoryPair2==address(0)){factoryPair2_balance=0;}
        if(factoryPair3==address(0) ){factoryPair3_balance=0;}
