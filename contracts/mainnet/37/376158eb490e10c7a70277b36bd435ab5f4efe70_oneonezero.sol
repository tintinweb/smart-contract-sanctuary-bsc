...
contract oneonezero is Context, IERC20, Ownable {
    ...
    string private constant _name = "110";
    string private constant _symbol = "110";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1100 * 10**_decimals;
    uint256 public _maxTxAmount = 33 * 10**_decimals;
    uint256 public _maxWalletAmount = 33 * 10**_decimals;
