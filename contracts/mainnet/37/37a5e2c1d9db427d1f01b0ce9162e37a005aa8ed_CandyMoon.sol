...
contract CandyMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CandyMoon";
    string private _symbol = "CDM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x974402C3376dAbC3c25b4f8b462502f6d21ca3cC); 
    address payable public teamWalletAddress = payable(0x4975442A42c19844e1CA04fcc751A1f0d14E1989); 
