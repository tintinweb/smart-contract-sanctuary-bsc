...
Telegram Chat : https://t.me/skullhuntertoken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C0546AB7d12C59b908068fF6F8eCf47dDeb1B8D; // owner address
...
contract SkullHunter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Skull Hunter";
    string private _symbol = "SkullHunter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF16620692F010Ae6243d6393A80DfA425D719757); // Marketing Address
    address payable public teamWalletAddress = payable(0x4C0546AB7d12C59b908068fF6F8eCf47dDeb1B8D); // Team Address
