...
//https://t.me/wifethorinu
//https://twitter.com/WifeThorInu
...
contract WifeThorInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WifeThor Inu";
    string private _symbol = "WifeThorInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc920cfacF9488A90727e394cF74eB9D6E2365B70);
    address payable public teamWalletAddress = payable(0xc920cfacF9488A90727e394cF74eB9D6E2365B70);
