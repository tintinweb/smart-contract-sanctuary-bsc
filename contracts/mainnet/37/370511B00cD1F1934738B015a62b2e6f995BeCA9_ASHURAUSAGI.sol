...
/**
 Ashura Usagi -  is a meme platform on Binance Smart Chain and Ashura Usagi is a rabbit and hedgehog.
  It was created to make a big surprise in the crypto space with its security-first approach. 
  ASHURAGI are cryptocurrencies usually inspired by rabbit. The project seeks to value its community, 
  and all decision-making power stays with the community members to decide the project's direction. 
  Ashura Usagi is helpful, friendly, and quite happy to go with the flow.

Total Supply: 1,000,000
Taxes: 5%

Telegram: https://t.me/AshuraUsagi
Twitter: https://twitter.com/usagi_ashura
*/
...
contract ASHURAUSAGI is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x99EcA88Be96Cb7D9132C876b6F487E83a7457796);
        teamWallet= payable(0x466f40765f336DBC916124bA0ca7937362Af86B2);
