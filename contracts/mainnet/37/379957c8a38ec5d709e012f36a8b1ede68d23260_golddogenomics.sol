...
----------------------------------------------------------------------------------------------------------------
Name : Gold DOGENOMICS
ticker : GDNOMICS
total supply : 100,000,000
buy tax : 10%
breakdown buy tax : (7% marketing/1% dev/2% LP)
sell tax : 10%
breakdown sell tax : (7% marketing/1% dev/2% LP)
max wallet : 2%
max tx : 2%
TG : @GOLDOGENOMICS
twitter : TBA after launch
...
contract golddogenomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gold DOGENOMICS";
    string private constant _symbol = "GDNOMICS";
