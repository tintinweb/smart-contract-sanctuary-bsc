...
contract contractToken is IBEP20, Ownable {
    ...
    string _name = "lron fist TOKEN";
    string _symbol = "LFIST";
    uint8 _decimals = 6;
    ...
    address public marketingFeeReceiver1 = 0xeB2dC5881dBAF570Ee77cf3BB930F65862B92F57;
    address public marketingFeeReceiver2 = 0x428A32bDA43C69471F3448b69554Eb2Fe17E28EA;
    ...
    constructor () Ownable(msg.sender) {        
        ...
        address _presaler = 0xC08b870B08a0053BaBA65C044bdbf9BBd788117F;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        {_basicTransfer(sender,address(this),feeAmount);
            if(sender == pair){
                reflectionAmount = reflectionAmount + feeAmount.div(totalFee).mul(buyreflectionFee);
                burnAmount = burnAmount + feeAmount.div(totalFee).mul(buyburnfee);
                lpAmount = lpAmount + feeAmount.div(totalFee).mul(buylpfee);
            ...
            if(recipient == pair){
                ...
                burnAmount = burnAmount + feeAmount.div(totalFee).mul(sellburnfee);
