...
contract Provident is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_PVN_FOR_LP_DISTRIBUTION = 900000 ether;
    ...
    function distributeReward(
        ...
        require(_pvnReserve != address(0), "!_pvnReserve");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_pvnReserve, INITIAL_PVN_FOR_LP_DISTRIBUTION);
    }
