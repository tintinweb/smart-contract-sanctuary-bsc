...
contract APEBLACK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "APEBLACK";
    string constant _symbol = "APBK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  500000* (10**9); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x15Ab0E01a9c4279740535c2FF81c459aA70CDD10;
