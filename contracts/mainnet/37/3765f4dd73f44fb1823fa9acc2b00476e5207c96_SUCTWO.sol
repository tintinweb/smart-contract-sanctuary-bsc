...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x258D3db4fA3C9f015b79bdF5460f6fcC72B682aE; // owner address
...
contract SUCTWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUC 2.0";
    string private _symbol = "SUC 2.0";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x258D3db4fA3C9f015b79bdF5460f6fcC72B682aE); // Marketing Address
    address payable public teamWalletAddress = payable(0x258D3db4fA3C9f015b79bdF5460f6fcC72B682aE); // Team Address
