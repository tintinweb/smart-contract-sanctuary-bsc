...
contract safeshiba51 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x14E4Ce40f0B11DA233e3FA4BF3728Ca1A1135a7A));
    address payable public devWallet =
        payable(address(0x81B7FB14E2258EBD15d330c9775510825c4e3061));
    address public liquidityReceiver =
        0x14E4Ce40f0B11DA233e3FA4BF3728Ca1A1135a7A;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "51 SAFE SHIBA";
    string private _symbol = "51 SSHIB";
