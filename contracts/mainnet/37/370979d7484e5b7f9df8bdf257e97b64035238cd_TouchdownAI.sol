...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F77C054EfE027ab28768AbF7eBB5Fb329A81726;
...
contract TouchdownAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x17fB97b58b0D64D5C6a104dBbb3A0556b24c613d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Touchdown AI";
    string private _symbol = "TDAI";
