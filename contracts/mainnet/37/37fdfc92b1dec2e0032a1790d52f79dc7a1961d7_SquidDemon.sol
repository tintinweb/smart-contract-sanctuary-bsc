...
/** 
    Squid Grow back to 28m. Rabbit Demon reach 3M Mcap
    Squid + Demon trend = Squid Demon. Dont miss it
    We are the hottest meme in BSC space

    https://t.me/SquidDemonBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe1ce2191C128C8019c926798ba47f14b7666C826; // owner address
...
contract SquidDemon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Demon";
    string private _symbol = " $SQUID ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe1ce2191C128C8019c926798ba47f14b7666C826); // 
    address payable public teamWalletAddress = payable(0xe1ce2191C128C8019c926798ba47f14b7666C826); // 
