...
contract FractionMetavers is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public charityAddress = 0x3639AAE6bC53dF6d081b98cD76ecef311b5a3Ae6; // Charity wallet Address.
    ...
    uint256 private _tTotal = 1_500_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fraction Metavers";
    ...
    uint256 private minimumTokensBeforeSwap = 99_000_000 * 10**18; 
