...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31247cCa218798008Fcf40495853f6e811902717; // owner address
...
contract OrdinalInuOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ordinal Inu";
    string private _symbol = "OI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa30cD53F58B12f64D435a54AA343a3854B8CA4d0); // Marketing Address
    address payable private teamWalletAddress = payable(0xa30cD53F58B12f64D435a54AA343a3854B8CA4d0); // Team Address
