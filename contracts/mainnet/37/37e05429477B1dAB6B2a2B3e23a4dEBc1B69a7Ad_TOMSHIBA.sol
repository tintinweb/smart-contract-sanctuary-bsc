...
contract TOMSHIBA is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x811CeC2b485Dba722198Ab5fe8EA6b8A3200f2d5));
        marketingWalletAddress = payable(address(0x811CeC2b485Dba722198Ab5fe8EA6b8A3200f2d5));
