...
/*
                RABBIT DOGE INU || Stealth Launch 
                    (2:30 p.m - 3:30 p.m UTC)

            𝗥𝗮𝗚𝗲 𝗜𝗻𝘂 was born from the 𝙍𝙖𝙗𝙗𝙞𝙩 𝙖𝙣𝙙 𝘿𝙤𝙜𝙚 
                with concept 𝐓𝐡𝐞 𝐋𝐮𝐧𝐚𝐫 𝐘𝐞𝐚𝐫 𝐎𝐟 𝟐𝟎𝟐𝟑 
    (𝘤𝘰𝘮𝘣𝘪𝘯𝘢𝘵𝘪𝘰𝘯 𝘰𝘧 𝙍𝙖𝙗𝙗𝙞𝙩 𝙖𝙣𝙙 𝘿𝙤𝙜𝙚) 𝘮𝘢𝘥𝘦 𝘧𝘰𝘳 𝘵𝘩𝘦 ᴄᴏᴍᴍᴜɴɪᴛʏ, 𝘵𝘩𝘦 𝘵𝘦𝘢𝘮 𝘸𝘪𝘭𝘭 𝘥𝘦𝘭𝘪𝘷𝘦𝘳 𝘢𝘯𝘥 𝘤𝘰𝘮𝘮𝘶𝘯𝘪𝘵𝘺 𝘮𝘶𝘴𝘵 𝘣𝘦 𝘴𝘰𝘭𝘪𝘥.

    Telegram Dev Channel    :https://t.me/IceLandGambLes
    Telegram Group          :https://t.me/RaGeInu_Official
    Twitter                 :TBA
    Website                 :TBA
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06e94b3a4F804a01f2C9D611c4219a8aA5b0AC76;
...
contract RaGeInu is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x06e94b3a4F804a01f2C9D611c4219a8aA5b0AC76);
    ...
    string private _name = "RABBIT DOGE INU"; 
