...
/**
Mutant Among Us (MAU)
Mutant Among Us is a crypto project  inspired by the game of Among Us with a unique artistic reinterpretation. 
Mutant Among us doesn't like to promise things that will be provided. 
We like to speak about utilities already built and available for our holders from day 1. 
In fact, the vision of Mutant Among Us is to under promise and overdeliever. You will see by discovering our utilities!
...
interface MutantAmongUsDeployer {
...
contract MutantAmongUs is MutantAmongUsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MutantAmongUsTeam;
    address private CharityMutantAmongUs;
    ...
    string public override name = "Mutant Among Us";
    string public override symbol = "Mutant Among Us";
    ...
    constructor(uint totalSupplyValue, address MutantAmongUsTeamAddress, address CharityMutantAmongUsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MutantAmongUsTeam = MutantAmongUsTeamAddress;
        CharityMutantAmongUs = CharityMutantAmongUsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MutantAmongUsTeam] =  totalSupply * 4 / 100;
        balances[CharityMutantAmongUs] = totalSupply * 4 / 100;
