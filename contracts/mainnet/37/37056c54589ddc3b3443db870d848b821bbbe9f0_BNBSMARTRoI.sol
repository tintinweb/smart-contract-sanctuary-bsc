...
contract BNBSMARTRoI {
    ...
    uint256 constant public INVEST_MAX_AMOUNT = 10 ether;
    uint256 constant public HOUR_LIMIT = 11 ether; // only 11 BNB per Hour
	uint256 constant public MAX_INVESTS = 300; 
	uint256[] public REFERRAL_PERCENTS = [0];
	uint256 constant public TOTAL_REF = 0;
	uint256 constant public CEO_FEE = 10;
	uint256 constant public DEV_FEE = 10;
	uint256 constant public REINVEST_BONUS = 0;
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        require(msg.value <= INVEST_MAX_AMOUNT, "max amount is 10 BNB");
