...
contract CakeWorld is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cake World";
    string constant _symbol = "CWORLD";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1e11 * (10 ** _decimals);
