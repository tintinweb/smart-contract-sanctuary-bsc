...
//
// ASTRO PROTOCOL COPYRIGHT (C) 2022 
...
contract AstroToken is ERC20Detailed, Ownable {
    ...
    string public _name = "ASTROYIELD";
    string public _symbol = "ASTRO";
    ...
    constructor() ERC20Detailed("ASTROYIELD", "ASTRO", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x813Ad7a4E30F30AE3980002E0ab93A1be1f110c5;
        treasuryReceiver = 0xd6a2Dc9Fd2fE2aD8105CEdfE403c3fb934Ad1c5D; 
        astroInsuranceFundReceiver = 0x2625fD3F68Ac947aEc1973CA4011CC7cb62aD154;
        blackhole = 0x000000000000000000000000000000000000dEaD;
        nftFeeReceiver = 0xc2E3984E171e960bE9078404090491fC274A957f;
        ...
        _initRebaseStartTime = 1651240800;	
        _lastRebasedTime = 1651240800;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            if (block.timestamp - _initRebaseStartTime > (24 hours)) {
                ...
                _treasuryFee = treasuryFee.add(245);
                _nftFee = nftFee;
            } else {
