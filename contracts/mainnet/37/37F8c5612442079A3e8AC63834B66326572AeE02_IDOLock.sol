...
contract IDOLock is Ownable {
    ...
    address public tokenAddress = 0xE1d39a1dF0D1828249D85cF9fd54D3F985487F8B;
    address public marketingAddress = 0xa3074b7552785c0f29d2C6A310f7d47bc729b5B3;
    address public teamAddress = 0xb2527c56A8F678A1e75eDC8D67389240097944FE;
    address public reserveAddress = 0xAd9f918F64E985e9dF12Abdaf373455EB79e00d7;
    address public buybackAddress = 0x6acB0D6605Bae6180016996C8A3a90813999d4f2;
    uint256 public marketingPercent = 160;
    uint256 public teamPercent = 40;
    uint256 public reservePercent = 160;
    uint256 public liquidityPercent = 480;
    uint256 public buybackPercent = 160;
    ...
    function buy(uint256 amountBUSD) public {
        ...
        emit Buy(msg.sender, tokenAmount, amountBUSD);
    ...
    function distributionBUSD() public onlyOwner() {
        ...
        uint256 _teamAmount = _totalBalanceBUSD * teamPercent / 1000;
        uint256 _reserveAmount = _totalBalanceBUSD * reservePercent / 1000;
        uint256 _liquidityAmount = _totalBalanceBUSD * liquidityPercent / 1000;
        uint256 _buybackAmount = _totalBalanceBUSD * buybackPercent / 1000;
        _busd.safeTransfer(marketingAddress, _marketingAmount);
        _busd.safeTransfer(teamAddress, _teamAmount);
        _busd.safeTransfer(reserveAddress, _reserveAmount);
        _busd.safeTransfer(tokenAddress, _liquidityAmount);
        _busd.safeTransfer(buybackAddress, _buybackAmount);
