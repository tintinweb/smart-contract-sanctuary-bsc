...
TELEGRAM: https://t.me/WorldCupCheems
|
*/
...
contract WORLDCUPCHEEMS   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " World Cup Cheems ";
    string private _symbol = " WCC "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEFbcDE18d0E98034105e7aC23568A82a4105058c); 
    address payable public teamWalletAddress = payable(0x31C331971480585C2374ae00F9CfB5981f43A4C3); 
