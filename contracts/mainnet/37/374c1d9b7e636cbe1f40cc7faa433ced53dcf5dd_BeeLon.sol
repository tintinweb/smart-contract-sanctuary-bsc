...
contract BeeLon is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xABac7b04f09370EE4CbCd27338fc9E3302E1F678); // Marketing Address
        
    address payable public teamAddress =
        payable(0xABac7b04f09370EE4CbCd27338fc9E3302E1F678); // Team Address
        
    address payable public liquidityAddress =
        payable(0xABac7b04f09370EE4CbCd27338fc9E3302E1F678); // Liquidity Address
    ...
    string private constant _symbol = "BeeLon";
