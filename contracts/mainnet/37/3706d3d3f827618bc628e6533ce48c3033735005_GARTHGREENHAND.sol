...
Next 1000X TG https://t.me/GARTHGREENHANDbsc
...
contract GARTHGREENHAND is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GARTH GREENHAND";
    string constant _symbol = "$GREENHAND";
