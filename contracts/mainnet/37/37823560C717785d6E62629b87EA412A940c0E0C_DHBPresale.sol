...
// import 'D:\repos\smart-contracts\dhb\dhb.presale\#smart-contracts\node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\IBEP20.sol';
// import 'D:\repos\smart-contracts\dhb\dhb.presale\#smart-contracts\node_modules\@pancakeswap\pancake-swap-lib\contracts\math\SafeMath.sol';
// import 'D:\repos\smart-contracts\dhb\dhb.presale\#smart-contracts\node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\Address.sol';
...
contract DHBPresale is ReentrancyGuard, Context, Ownable {
    ...
    function init_data(purchaseInfo[] calldata _presale_init) external onlyOwner nonReentrant {
        ...
        for (uint256 i = 0; i < _presale_init.length; i++) {
            ...
            emit TokenPurchaseLock(info.purchaser, info.valueToken, info.value, info.amount, info.endDate);
        }
        _init_data = true;
    }
    ...
    function updateStepDuration(uint256 _stepDuration) external onlyOwner {
        require(_stepDuration > 0);
        stepDuration = _stepDuration;
    }
