...
abstract contract Contextbep20TextmateAI {
...
contract Ownablebep20TextmateAI is Contextbep20TextmateAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20TextmateAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20TextmateAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TextmateAI  is Contextbep20TextmateAI, bep20TextmateAI, Ownablebep20TextmateAI {
