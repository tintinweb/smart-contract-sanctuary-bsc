...
contract UkraineSavior is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 35_000_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Ukraine Savior"; // 
    string private constant _symbol = "Ukraine Savior"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x4A372F17BcCd350ae597382977a065d8a7B0330e;
