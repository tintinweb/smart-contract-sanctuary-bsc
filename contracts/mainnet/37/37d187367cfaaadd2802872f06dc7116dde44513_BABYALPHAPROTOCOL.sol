...
contract BABYALPHAPROTOCOL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Baby Alpha Protocol";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6C674942bcB919ECf02354260AaaccC778d883ad));
        marketingWalletAddress = payable(address(0x6C674942bcB919ECf02354260AaaccC778d883ad));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x6C674942bcB919ECf02354260AaaccC778d883ad), _msgSender(), _totalSupply);
    }
