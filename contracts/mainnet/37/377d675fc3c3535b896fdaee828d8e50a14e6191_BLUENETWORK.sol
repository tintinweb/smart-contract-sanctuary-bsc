...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7108467d3442D8C9d9C468D7f0573C992FC8b3B; // owner address
...
contract BLUENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blue Network";
    string private _symbol = "BLUENTWRK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7108467d3442D8C9d9C468D7f0573C992FC8b3B); // Marketing Address
    address payable public teamWalletAddress = payable(0xa7108467d3442D8C9d9C468D7f0573C992FC8b3B); // Team Address
