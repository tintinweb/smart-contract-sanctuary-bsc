...
contract DHCNM is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1* 10**8* 10**1;
    ...
    string private constant _name = "DHCNM";
    string private constant _symbol = "DHCNM";
