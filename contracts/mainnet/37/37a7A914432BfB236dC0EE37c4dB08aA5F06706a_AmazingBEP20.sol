...
abstract contract BEP20Operable is BEP20, IBEP20Operable, ERC165 {
    ...
    function transferAndCall(
        ...
        transfer(to, amount);
        require(_checkAndCallTransfer(_msgSender(), to, amount, data), "BEP20Operable: _checkAndCallTransfer reverts");
        return true;
    }
    ...
    function transferFromAndCall(
        ...
        require(_checkAndCallTransfer(from, to, amount, data), "BEP20Operable: _checkAndCallTransfer reverts");
        return true;
    }
...
contract AmazingBEP20 is BEP20Mintable, BEP20Burnable, BEP20Operable, TokenRecover, ServicePayer {
    ...
    ) payable BEP20(name_, symbol_) ServicePayer(feeReceiver_, "AmazingBEP20", signature_, _msgSender()) {
