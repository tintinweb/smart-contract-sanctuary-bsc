...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTCB = IBEP20(0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C);
...
/* Token contract */
contract Cobainu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb870DC7d3Cd77d20Fef7223419f9068F28cb6924;
    ...
    // Name and symbol
    string constant _name = "Coba Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% (300 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% (300 mil)
    ...
    uint256 public totalFeeSell = 19;
