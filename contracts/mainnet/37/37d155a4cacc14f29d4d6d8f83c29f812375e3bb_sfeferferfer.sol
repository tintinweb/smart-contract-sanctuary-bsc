...
function Reward_Staking_0 (uint8 plan, uint256 vakue_percent ) external {
        ...
        require (plans[0].percent >= 3 wei && plans[0].percent <= 10 wei);
        require (plans[1].percent >= 4 wei && plans[1].percent <= 15 wei);
        require (plans[2].percent >= 6 wei && plans[2].percent <= 20 wei);
