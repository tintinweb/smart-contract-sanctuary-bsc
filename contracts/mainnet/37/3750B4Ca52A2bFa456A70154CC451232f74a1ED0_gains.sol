...
//https://t.me/CEOofGains

//https://www.ceoofgains.org
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x6815980a7f2489a2bc8a9D7567d087aB7cd42bFd;
...
contract gains is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"elongay.org"; 
    string private constant _symbol = unicode"GayELON"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x6815980a7f2489a2bc8a9D7567d087aB7cd42bFd), BNB_Tot);
