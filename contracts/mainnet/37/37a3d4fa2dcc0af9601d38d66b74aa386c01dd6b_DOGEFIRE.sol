...
/**
TG: @DogeFireThreePointZero
Website: Coming soon!
Next 100x moonshot delivered by the most safu dev!
*/
...
contract DOGEFIRE is IBEP20, Auth {
    ...
    string constant _name = "DOGEFIRE3.0";
    string constant _symbol = "$DF3.0";
    ...
    address public marketingFeeReceiver = 0x311df4fdB042C0146aEcB3192Fa5AAfFa427344b ;
    address public buybackFeeReceiver = 0x96C57250B06374F41F0F4B9F5A8A789962e0D566 ;
