...
contract RSG is BEP20Detailed, BEP20 {
  using SafeMath for uint256;
  ...
  constructor() payable BEP20Detailed("RoosterGrow", "RSG", 9) {
    uint256 totalTokens = 3_000_000_000 * 10**uint256(decimals());
    ...
    marketingPool   =      0xD433D97b8b2B07301E6b6370BF92A4865F693fF8;
    DevPool         =      0x455e8aA66E6463C606360a3cF142B567c86AC8DE;
    LiquidityPool2  =      0xEaf7667fc28E30a97B50f03E0984EF0060F87f76; 
