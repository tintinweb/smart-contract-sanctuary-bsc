...
/**
 Tg : https://t.me/angrycatoken

 Welcome to Angry Cat Token, made by the idea on how ANGRYCAT occupied the BSC Chain.
  A unique BEP20 token which allow us to earn by staking our NFT. 
  It will be the native token to be mined once the NFT’s are out. 
...
contract AngryCaToken is Context, IBEP20, Ownable {
