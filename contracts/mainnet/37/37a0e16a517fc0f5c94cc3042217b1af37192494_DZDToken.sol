...
contract DZDToken is Context, IERC20, Ownable {
	...
	constructor (address _ceoadd, address _cfoAddress, address _biadd, address _feeRadd) {
		CeoAddress = _ceoadd;
	...
	function setcfo(address _cfo) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		cfoAddress = _cfo;
	}
	function setFeeRadd(address _Radd) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		feeRadd = _Radd;
	}
	function setFeeBurn(uint256 _value) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		require(_value>0, "Err: error value");
		require(_value<100, "Err: error value");
		_FeeBurn = _value;
	}	
	function setSwapFee(uint256 _value) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		require(_value>0, "Err: error value");
		require(_value<100, "Err: error value");
		_swapFee = _value;
	}
	function setminswap(uint256 _value) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		require(_value>0, "Err: error value");
		_minswap = _value * 10**16;
	}

	function setblack(address _badd, uint256 _value) public {
		require(msg.sender==cfoAddress, "Err: error ceo");
		_blacklist[_badd] = _value;
	}

	function setwhite(address _wadd, uint256 _value) public {
		require(msg.sender==cfoAddress, "Err: error ceo");
