...
contract LunaK0 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10**8 * 10**18;
    ...
    string private constant _name = "LunaKill0";
    string private constant _symbol = "LunaK0";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0x1eA8cfC47c401E502FabF1A3aa110B7D501A2A07);
    address payable private _marketingAddress = payable(0xB823AC3f42f2A85cc7b030a2d7d3f1559f25ecD1);
    ...
    function addBot(address account) public onlyDev {
        if (!_isBot[account]) _isBot[account] = true;
    }

    function exBot(address account) external onlyDev {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getValues(tAmount); //获取实际和通胀费用
