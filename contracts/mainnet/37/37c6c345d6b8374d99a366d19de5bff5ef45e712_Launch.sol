...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0xB86a85a577abc304db58100c466696c5cAf54089;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0xC81a24c856fBb5d7920a777b6FF718Fa34D45495;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0x0aAb9B077509940ff1f78b9C42305B3e92fAa4Ee;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "Launch";
  string private _symbol = "LCH";
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "Launch: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "Launch: transfer from the zero address");
    require(recipient != address(0), "Launch: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "ELaunchRC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "Launch: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "Launch: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "Launch: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "Launch: approve from the zero address");
    require(spender != address(0), "Launch: approve to the zero address");
