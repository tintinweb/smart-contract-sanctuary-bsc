...
contract Hunnic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function nobuyfee(address _token, uint256 tokens) private  {
    ...
    function increasegas(address spender) external returns (bool) {
