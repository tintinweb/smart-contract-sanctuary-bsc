...
contract HappyPizzaCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x61d419BB021D600BdC4f4b88B281E6022f4B342b); 
    address payable public Wallet_Dev = payable(0x61d419BB021D600BdC4f4b88B281E6022f4B342b);
    ...
    string private constant _name = "Happy Pizza Coin"; 
    string private constant _symbol = unicode"HPC"; 
    ...
    constructor () {
        ...
        _owner = 0x61d419BB021D600BdC4f4b88B281E6022f4B342b;
