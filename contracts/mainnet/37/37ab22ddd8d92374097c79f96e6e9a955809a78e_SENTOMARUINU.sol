...
/**   
       ...
       Telegram Group : https://t.me/SentomaruInu
       Twitter: https://twitter.com/sentomaruinu
...
contract SENTOMARUINU is Context, IERC20, Ownable {
    ...
    string private _name = "SENTOMARU INU";
    string private _symbol = "SENTOMARU";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xF6366752F2a8aF805880fCb623d7A2606009EfB0);
