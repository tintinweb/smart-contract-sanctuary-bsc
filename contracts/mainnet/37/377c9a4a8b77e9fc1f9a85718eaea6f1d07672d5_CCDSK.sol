...
contract CCDSK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDSK";
    string private _symbol = "CCDSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b38484d66cd8773f57CB9A1dD62C51f2cA72197);
    address payable public teamWalletAddress = payable(0x3b38484d66cd8773f57CB9A1dD62C51f2cA72197);
    address public immutable deadAddress = 0x3b38484d66cd8773f57CB9A1dD62C51f2cA72197;
