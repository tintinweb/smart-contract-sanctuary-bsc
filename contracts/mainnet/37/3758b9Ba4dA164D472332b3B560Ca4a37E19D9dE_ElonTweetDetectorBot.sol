...
/**               
Links                                                                             
Telegram: https://t.me/ElonTweetDetectorBot
...
contract ElonTweetDetectorBot is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ElonTweetDetectorBotDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ElonTweet Detector BOT", "ElonBOT") {
        marketingWallet = payable(0x3E8f00e2502c74F1b81792280DC6d944E0757D5f);
        devWallet = payable(0x3E8f00e2502c74F1b81792280DC6d944E0757D5f);
        ...
        dividendTracker = new ElonTweetDetectorBotDividendTracker(
            payable(this),
            router,
            0xbA2aE424d960c26247Dd6c32edC70B295c744C43,
            "ElonTweetDetectorBotTRACKER",
            "ElonTweetDetectorBotTRACKER"
        );
...
contract ElonTweetDetectorBotDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ElonTweetDetectorBot public ElonTweetDetectorBotContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ElonTweetDetectorBotContract = ElonTweetDetectorBot(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ElonTweetDetectorBot_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ElonTweetDetectorBot_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ElonTweetDetectorBotcontract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ElonTweetDetectorBotContract);

            uint256 prevBalance = ElonTweetDetectorBotContract.balanceOf(address(this));
            ...
            {
                uint256 received = ElonTweetDetectorBotContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ElonTweetDetectorBotContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
