...
/**
Welcome to MOONAKITA V2 MAKA V2
   
   This is a community revival token. 
   We have migrated to V2 to improve our tokenomics/taxes and create a marketing wallet. 
   Only use our official contract - ask the community through our socials below and we will help you. 
   The Telegram is https://t.me/maka_revived
   The Website is https://moonakita.us/
   Moon Akita Linktree https://linktr.ee/maka_revived
   Moon Akita Reddit https://www.reddit.com/r/moonakita/
   Moon Akita Discord https://discord.com/invite/yxZ4kGBgPd
   Moon Akita Twitter https://twitter.com/moonakita_maka
   ...
   The tax is low so you can pump volume!

   We always reward our loyal holders!  
   Ownership will be renounced when we hit cmc/cg
   Audit + KYC - because we want our community to thrive. 

   1,000 NFTs - to make funds for marketing and listings

   Lets get our dog to the moon!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6DaF9766a6E3F66c614216DD693cfC2094e8d637;
...
contract MAKAV2OFFICIAL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2C5c7e552a121c52745a94553Edc17461F9f337f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Moon Akita V2";
    string private _symbol = "MoonAkitaV2";
