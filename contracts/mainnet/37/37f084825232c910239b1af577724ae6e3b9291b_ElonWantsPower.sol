...
contract ElonWantsPower is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon Wants Power";
    string private constant _symbol = "EmPowerELON";
