...
Total Fee : 10%
telegram = https://t.me/KINGuintoken
*/
...
/* Token contract */
contract KINGuinToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "KINGuin Token";
    string constant _symbol = "KINGuin";
    ...
    uint256 public _maxWalletToken = _totalSupply * 200 / 10000; // 4% or 4M tokens
