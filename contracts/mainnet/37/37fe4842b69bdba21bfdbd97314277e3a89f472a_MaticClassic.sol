...
/* MaticClassic -  MaticClassic (MTC) is Matic-Backed Digital assets for a stable currency with Binance Smart Chain Network. MTC Will become The world’s only enterprise blockchain solution for global payments
...
contract MaticClassic is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5603912023B7cb90C48Fc80fdCCb43A33d4710c2); // Marketing Address
    address payable public charityAddress = payable(0x5603912023B7cb90C48Fc80fdCCb43A33d4710c2); // Charity/Dev Address
    ...
    string private _name = "MaticClassic";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 800000000000000000000000000; // 700,000,000; token will be given on airdrop
