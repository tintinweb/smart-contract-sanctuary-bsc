...
Possesses the ability to destroy and can travel at an unbelievable speed with ferocity.  
Breeds
...
abstract contract Ownable is Context {
 ...
 contract BRANNBIL is ERC721Enumerable, Ownable   {
  ...
  uint256 public MinitngPricein_token=2500;    // token
  ...
  function mint_with_token(uint256 _count ,uint256 amount,uint256 amount1) public
     {
        ...
        uint256 totalamount  = ValueinToken*_count;
