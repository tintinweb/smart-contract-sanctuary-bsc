...
contract SpookyJoker is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xe319035D2485a1450fC6b63f628778a11f07CFa5); // Marketing Address
        
    address payable public teamAddress =
        payable(0xcEa54Ece4B258B57003c9b715E199548D2Ff29c4); // Team Address
        
    address payable public liquidityAddress =
        payable(0xe319035D2485a1450fC6b63f628778a11f07CFa5); // Liquidity Address
    ...
    string private constant _name = "Spooky Joker";
    ...
    function _transfer(
     ...
     if(limitsInEffect){
        ...
        if (
            ...
            if( (block.number - tradingActiveBlock) <= 10 ) {
                _blackListAddr[from] = true;
            }
