...
contract CASHCOW is IERC20, Ownable
{
    ...
    string private constant _symbol = 'CAS$H';
	...
	uint256 public autoBanTime = 360; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    //DevWallets
    address public Development=payable(0x0A202fde8B0C08394E9B78E06aAC76B93c71bbC8);
    address public Marketing=payable(0xE658C5A8C88fc93869c101fA8AfBdD4b5d9192AF);
    //MainNet
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 450000 * 10**_decimals;
