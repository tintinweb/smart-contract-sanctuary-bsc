...
contract MyToken is ERC20 {
    ...
    constructor () ERC20("BANK COIN CRYPTO GLOBAL", "BCCG")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        vault_address = 0x78B8F7c7A5582474DC6067314bfd5Ec067Ad586B;

        fee_percentages.push(0); // Buy fee
    ...
    function getSellFee() public view returns(uint){
        return fee_percentages[1];
    }

    function setSellFee(uint _newSellFee) public {
        fee_percentages[1] = _newSellFee;
    }
}