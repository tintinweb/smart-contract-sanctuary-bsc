...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEeFbB3284A9bf583c0B2FBCBAf9acFd190c1aCff; 
...
contract PepesAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepesAI";
    string private _symbol = "PepesAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEeFbB3284A9bf583c0B2FBCBAf9acFd190c1aCff); // 
    address payable public teamWalletAddress = payable(0xEeFbB3284A9bf583c0B2FBCBAf9acFd190c1aCff); // 
