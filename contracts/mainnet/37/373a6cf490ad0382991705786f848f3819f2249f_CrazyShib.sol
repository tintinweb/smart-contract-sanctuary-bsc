...
LP 0.5 BNB AND LOCKED, and this will growing moon organic 📣 Lock will be extended on 5K MC 🔐
...
contract CrazyShib is Context, IERC20, Ownable {
    ...
    address payable private burnAddress = payable(0xedf9676309CBDc4ac89330B29248e7d49D838f9c); //
    ...
    string private _name = unicode"CrazyShib";
    string private _symbol = unicode"CSHIB";
