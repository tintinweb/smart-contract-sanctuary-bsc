...
contract NobuFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEac100616814B9C6ef325E781AC32Dc2B80E9304); // Marketing Address
    address payable public charityAddress = payable(0xEac100616814B9C6ef325E781AC32Dc2B80E9304); // Charity/Dev Address
    ...
    uint256 private _tTotal = 1000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Nobu Finance";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   0; // Airdrop fee
    ...
    uint256 private salePrice = 500000;// 500,000 NOBU for 1 BNB (set as per requirements)                         
