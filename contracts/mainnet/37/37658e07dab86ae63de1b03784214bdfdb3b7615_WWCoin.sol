...
Telegram Channel : https://t.me/+JbQwLcsay3A5ZTY0
...
contract WWCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WinWin Coin";
    string private _symbol = "WWC";
    ...
    uint256 public _taxFee = 500; // 500 = 5%
    uint256 public _buybackv1Fee = 100; // 100 = 1.00%
    uint256 public _buybackv2Fee = 100; // 100 = 1.00%
    uint256 public _burningFee = 200; // 200 = 2.0%
    uint256 public _smarketingFee = 500; // 500 = 5%
    
    uint256 public _maxTxAmount = 30000000 * 10**18; // 30 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0xC1407496F2898845deCdFa4e9b49Ad13E315c3C5;      // BuyBackv1 Address
    address public buybackv2Address  = 0x124B258D6831c1B4fc190e87581E28afFbBA3b2F;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xCC3bC081EFaC50F6829a19C1e16330CD226D616D;      // SMarketing Address
