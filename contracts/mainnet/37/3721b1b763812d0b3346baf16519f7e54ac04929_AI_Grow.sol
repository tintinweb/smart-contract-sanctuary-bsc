...
contract AI_Grow is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x5c64bc6Dd4D7C6C9D05087A519eC79985A3B3f51);
    address payable public MarketingWallet = payable(0x5c64bc6Dd4D7C6C9D05087A519eC79985A3B3f51);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && _TxCount >= _decimals) {idclaim();}
