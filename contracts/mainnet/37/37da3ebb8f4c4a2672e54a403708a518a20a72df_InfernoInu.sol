...
contract InfernoInu is IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Inferno Inu';
    string private constant _symbol = 'INFERNU';
    ...
    address public marketing_receiver = 0x51604F41cbA32FB8A519C96D052a4B6Eede88B57;
    address public default_receiver = 0x51604F41cbA32FB8A519C96D052a4B6Eede88B57;
    ...
    function setStructure(uint256 _liq, uint256 _mark, uint256 _tran) external onlyOwner {
        liquidityFee = _liq;
        marketingFee = _mark;
        transferFee = _tran;
        totalFee = liquidityFee.add(marketingFee);
        require(totalFee <= feeDenominator.div(10) && transferFee <= feeDenominator.div(5), "Above allowed tax threshold");
    }
