...
contract BABYMIKU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY MIKU";
    string private _symbol = "BABYMIKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9C99B01EdD522B5aA436D322F6BB0618490c027b); 
    address payable public buyBackWalletAddress = payable(0x1f041C343eaC388B657d6410A53ed504895c8A93); 
    ...
    uint256 private minimumTokensBeforeSwap = 80000000 * 10**9; 
