...
contract AlchemyVirtualMachine is BEP20 {
    ...
    string public constant name = "Alchemy Virtual Machine";
    string public constant symbol = "AVM";
    uint public constant decimals = 9;
    uint public deadline = now + 20 * 1 days;
    uint public round2 = now + 15 * 1 days;
    uint public round1 = now + 10 * 1 days;
    
    uint256 public totalSupply = 800000000000e9;
    ...
    constructor() public {
        uint256 teamFund = 400000000000e9;
        owner = msg.sender;
