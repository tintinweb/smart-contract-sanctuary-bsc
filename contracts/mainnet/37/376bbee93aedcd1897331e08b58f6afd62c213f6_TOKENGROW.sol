...
// Telegram: https://t.me/solanahackbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x188f0158260d0B82CBe61a4BD1c6e09d4B1d4204; // owner address
...
contract TOKENGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solana Grow";
    string private _symbol = "SOLG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x188f0158260d0B82CBe61a4BD1c6e09d4B1d4204);
    address payable public teamWalletAddress = payable(0x188f0158260d0B82CBe61a4BD1c6e09d4B1d4204); 
