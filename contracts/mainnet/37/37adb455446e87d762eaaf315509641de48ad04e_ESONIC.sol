...
contract ESONIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ELON SONIC ";
    string private _symbol = " ESONIC "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9118A495e1Afb3eeC5f5AFDA3B9Ef89323F8af0D); 
    address payable public teamWalletAddress = payable(0x9118A495e1Afb3eeC5f5AFDA3B9Ef89323F8af0D); 
    ...
    uint256 private minimumTokensBeforeSwap = 1120000 * 10**_decimals;
