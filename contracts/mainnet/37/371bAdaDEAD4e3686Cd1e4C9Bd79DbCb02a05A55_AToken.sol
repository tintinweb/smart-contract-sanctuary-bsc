...
contract AToken is ERC20,Ownable {
    using SafeMath for *;
    uint256 MAX = 6600 * 10000 * 1e18;
    address private BORN_ADDRESS = 0x0000000000000000000000000000000000000001;
    address private TEAM_ADDRESS = 0x17392AD058338b100A841bEc767bDA93826c4D1E; //TODO
    address private BACK_ADDRESS = 0x62FEBeaa775b1882587BCC97625B8974d1684CD8; //TODO
    address private TRANCE_ADDRESS = 0x7d1e1703A22267771dE27572c244E2bE8Fd904b5; //TODO
...
//    address private ROUTER = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    ...
    constructor() public ERC20('SXC TOKEN', 'SXC'){
        ...
        feeWhiteList[0x5e09C5dbE5647BACa00504FC4c2320864BDC9745] = true;
        _mint(0x5e09C5dbE5647BACa00504FC4c2320864BDC9745, MAX);
    }
        ...
        if (swapPairList[from] || swapPairList[to]) {
            if (!feeWhiteList[from] && !feeWhiteList[to]) {
                ...
                if(swapPairList[to]){
                    ...
                    super._transfer(from, BORN_ADDRESS, bornAmount);
