...
contract easyfeedbacktoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4059344D038B60F6d5Db7A65eC6F08f991f574e6); //nice
    address payable public charityAddress = payable(0x4059344D038B60F6d5Db7A65eC6F08f991f574e6); //nice
    ...
    uint256 private _tTotal = 1800000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Easy Feedback Token"; //CC
    string private _symbol = "FEE";  //nice
    ...
    uint256 public _maxTxAmount = 27000 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 27000 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 18000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 27000;// 0.01*270 token for 0.01 bnb (set as per requirements)
