...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3c4A1d46A464c45216e71dD84b213f5Bd40A75C5; // owner address
...
contract WHO is Context, IERC20, Ownable {
    ...
    string private _name = "Who Am I ?";
    string private _symbol = "Who";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3c4A1d46A464c45216e71dD84b213f5Bd40A75C5); // Marketing Address
    address payable public teamWalletAddress = payable(0x3c4A1d46A464c45216e71dD84b213f5Bd40A75C5); // Team Address
