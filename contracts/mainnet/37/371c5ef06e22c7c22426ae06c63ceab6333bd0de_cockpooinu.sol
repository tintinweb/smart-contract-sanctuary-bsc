...
Telegram: https://t.me/COCKPOOINU

Website: https://cockpooinu.trade/
...
contract cockpooinu is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Cockpoo Inu";
   string constant _symbol = "COCKINU";
