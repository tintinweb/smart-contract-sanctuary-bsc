...
contract SquidGirlInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidGirlInu";
    string private constant _symbol = "$SQUIDGRL";
    ...
    address private marketingWallet = address(0xF5bAfc35BA2DB170658eFfe534622Fb1f3F7E6a2);
    address private liquidityReceiver = address(0xF5bAfc35BA2DB170658eFfe534622Fb1f3F7E6a2);
