...
{
    // Token info
    string private constant Name = "World Cup Qatar 2022";
    string private constant Symbol = "QATAR"; 
    uint8 private constant Decimals = 18;
    uint256 private TotalSupply = 300_000_000 * 10**Decimals;
    ...
    // Important addresses
    address payable private DevAddress = payable(0x274a1081DC1cEd9C28429d122bDc98709b7d86e7); 
    address payable private MarketingAddress = payable(0xC864928b7437D7a8a52787eb1526CE16b137b0da);
    address payable private BurnAddress = payable(0x000000000000000000000000000000000000dEaD); 

    // Otras cosas de config
    uint256 private HardCap = TotalSupply / 2;
