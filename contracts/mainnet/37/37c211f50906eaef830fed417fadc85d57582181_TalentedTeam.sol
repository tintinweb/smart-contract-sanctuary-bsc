...
Telegram: https://twitter.com/TalentedTeamBSC

Twitter: https://twitter.com/TalentedTeamBSC

Let Elon's make us the 6 digit dream!
...
contract TalentedTeam is Context, ERC20, Ownable {
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function setMarketFee(uint256 Marketfee) public onlyOwner virtual {
