...
contract dsfasd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beitdoge";
    string private _symbol = "Beitdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9Ed3f4C0B639d6A5ca55D4b3E9d94d537620eA40); // Marketing Address
    address payable public teamWalletAddress = payable(0x9Ed3f4C0B639d6A5ca55D4b3E9d94d537620eA40); // maxTxAmount
	address public OwnerAddress =0x1b0B8E9D8bE9CE5a38331153C68307a2E9B10e03;
    ...
    uint256 private _totalSupply = 988655533333333 * 10**_decimals;
    uint256 public _maxTxAmount = 988655533333333 * 10**_decimals; 
    uint256 public _walletMax = 988655533333333 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 988655533333333 * 10**_decimals; 
