        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xF3ae2e31C8f4742972955b56aA981a0981238211), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0xF3ae2e31C8f4742972955b56aA981a0981238211),//
        address(0xF3ae2e31C8f4742972955b56aA981a0981238211)//
    ){
    }
}