...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9d5Ce64420241bAE5E65F2311BEf4a13d2Bea61F; // owner address
...
contract mp5INU is Context, IERC20, Ownable {
    ...
    string private _symbol = "MP5 INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x207037AD8D9E2575BE2DE11417ac8eB6b15D41Ff); // Marketing Address
    address payable public teamWalletAddress = payable(0x207037AD8D9E2575BE2DE11417ac8eB6b15D41Ff); // Team Address
