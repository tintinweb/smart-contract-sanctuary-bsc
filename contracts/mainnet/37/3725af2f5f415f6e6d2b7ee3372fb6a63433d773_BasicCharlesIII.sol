...
contract BasicCharlesIII is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BASIC CHARLES III";
    string private _symbol = "BCIII";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7DFC873E2CcAa9a515D46DdE223385Ad2605A6aa);
