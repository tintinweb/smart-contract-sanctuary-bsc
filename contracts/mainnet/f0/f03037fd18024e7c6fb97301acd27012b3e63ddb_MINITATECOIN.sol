...
contract MINITATECOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniTate";
    string private _symbol = "MTATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB082a01D7aFD6413499886Ee39f6F2c1CA074DE); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x8bA474aD4D84A5a5348e9de3EaC0D1E6f11fB620); // Developmental Address
    ...
    uint256 public _walletMax = 200000 * 10**9; 
