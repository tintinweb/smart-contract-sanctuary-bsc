/**
do not buy, test contract. buying this = rugged. dont be dumb.
**/
...
contract test is ERC20Permit, Ownable {
    ...
    address public _rewardWalletAddress = address(0xF89c6A83F7F0B265FF1d2765B83614D7590a29D1);
    ...
    function updateFees(bool sells) internal {
        if (!sells) {
            totalBuyFees = liquiditySellFee.add(marketingSellFee);
        } else {
            totalSellFees = liquiditySellFee.add(marketingSellFee);
        }
    }
