...
contract LKD is ERC20 {
	...
	address payable _receive = payable(address(0xB9d96fda7e026e346608de157F093114E82Aea6b));
    ...
    constructor(address tokenOwner,address fundAddress,address root) ERC20("Lucky Day", "LKD") {
	...
	function setExcludedFromVip(address user, bool value) public {
