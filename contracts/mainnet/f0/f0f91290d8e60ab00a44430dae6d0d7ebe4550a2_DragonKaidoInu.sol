...
Telegram : https://t.me/DragonKaidoInu
*/
...
contract DragonKaidoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "DragonKaidoInu"; 
    string private constant _symbol = "DRAGONKAIDOINU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xeD64D7AE49412d4D82D84911cb975076fE991Bec;
    ...
    function ChangeFine(uint256 liquidityFee, uint256 promoFee) external onlyOwner {
    ...
    function SetTax(uint256 liquidityFee, uint256 promoFee) external onlyOwner {
        _liquidityFee = liquidityFee;
        _promoFee = promoFee;
    }
