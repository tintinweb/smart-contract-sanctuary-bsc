...
/* Token contract */
contract BinanceFox is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xec9296FAfC01F8F2Aa8782743495BDD1b9A812D6;
    ...
    // Name and symbol
    string constant _name = "Binance Fox";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 20000; // 1%
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 20000; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 20000; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x523420a056EEb0204D16ab5129ab73DE02Bfb83c;
