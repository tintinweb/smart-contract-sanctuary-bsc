...
contract BootToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xcad8178053b1B8F456f7c9eBb52a793986C87379); 
    ...
    string private _name = "Boot Token";
