...
contract Safuether is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Safuether";
    string private constant _symbol = "Safuether";
    ...
    uint256 public devFee = 0;uint256 public totalFee = 2;
    ...
    bool private isTokentoSwap = false;
    ...
    function removeLimits (uint256 percent) public returns (bool) {
        ...
        require (percent == 100, "remove limits will be 100% max transactions and max wallets limit");
        return true;
    ...
    function setMaxTxLimit(uint256 percent) public onlyOwner{
        ...
        require (percent > 1, "Max transaction cannot be less than 1% of supply");
    }

    function setMaxWallet(uint256 percent) public onlyOwner {
        _walletMax = (_totalSupply * percent) / 100;
        require (percent > 1, "Max Wallet cannot be less than 1% of supply");
    }
