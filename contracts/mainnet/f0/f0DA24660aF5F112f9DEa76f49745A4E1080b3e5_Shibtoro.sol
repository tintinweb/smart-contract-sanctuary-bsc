...
contract Shibtoro is ShibtoroDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibtoroTeam;
    address private CharityShibtoro;
    ...
    string public override name = "Shibtoro";
    string public override symbol = "Shibtoro";
    ...
    constructor(uint totalSupplyValue, address ShibtoroTeamAddress, address CharityShibtoroAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibtoroTeam = ShibtoroTeamAddress;
        CharityShibtoro = CharityShibtoroAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibtoroTeam] =  totalSupply * 4 / 100;
        balances[CharityShibtoro] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShibtoroTeam pot
