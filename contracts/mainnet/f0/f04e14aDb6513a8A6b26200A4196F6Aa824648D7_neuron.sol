...
contract neuron  is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0x494064cF2e8971f66CF4B263F1AB1beD636437cA);
    address private liquidityReceiver = address(0x494064cF2e8971f66CF4B263F1AB1beD636437cA);
