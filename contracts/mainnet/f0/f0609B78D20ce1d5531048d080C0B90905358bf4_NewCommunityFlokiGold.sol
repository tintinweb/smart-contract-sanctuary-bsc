...
/**
https://t.me/NewCommunityFlokiGold
...
contract NewCommunityFlokiGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x9e57529636379898Fd5Bc882569091a05fF874Ef); // Marketing Address
    address payable public devWalletAddress = payable(0x9e57529636379898Fd5Bc882569091a05fF874Ef); // Dev Address
    ...
    string private _name = "NewCommunityFlokiGold";
    string private _symbol = "NCFG";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x9e57529636379898Fd5Bc882569091a05fF874Ef, 'We can not exclude Uniswap router.');
