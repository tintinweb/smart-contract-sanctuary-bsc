...
// TG: https://t.me/theguardianofforawa
// Website: https://www.forowa.net/
...
contract Forowa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Forowa";
    string private _symbol = "FRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb9908f7cCf795F9A07770d083c643d26B148aba6); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x250524d9CF20F4151F5565F1B2E8D27616247769); // Development Address
