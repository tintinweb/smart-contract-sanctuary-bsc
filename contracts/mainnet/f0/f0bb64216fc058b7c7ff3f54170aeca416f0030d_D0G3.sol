...
contract D0G3 is IBEP20, Auth {
    ...
    string constant _name = "DzeroGthree";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "D0G3";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 3 * (10 ** _decimals);
...
uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 10000; // will start swapping once 0.01% of supply is in the swap wallet
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x5A773c824E9b3Aba3D2c71730D6D057f2619711E;
        marketingFeeReceiver = 0x5A773c824E9b3Aba3D2c71730D6D057f2619711E;
