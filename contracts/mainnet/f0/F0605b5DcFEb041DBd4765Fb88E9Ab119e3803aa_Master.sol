...
contract Master is Ownable {
    ...
    IDouble public Double;

    // Market oracle provides the Double/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _Double) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = Double.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && Double.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(Double.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return Double.totalSupply().toInt256Safe()
