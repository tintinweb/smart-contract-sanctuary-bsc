...
contract INFINET is IBEP20, Auth {
    using SafeMath for uint256;

    address WINFINET = 0x17bF1FC1D16778373E4cd738389e05ae0932328c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Infinity Network";
    string constant _symbol = "INFINET";
    ...
    address private marketingFeeReceiver = 0x2126cC648246C9438222878Fc139B093ce276131;
    address private teamFeeReceiver = 0xe5E67dD59546B88cFC4f95bBa38361e0B8BA0215;
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(WINFINET, address(this));
