...
contract WENTXNRATKIDZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatKidz BSC";
    string private _symbol = "WENKXN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6f16E7B2005Ff0AAdaccC426a831812E74414CD0); 
    address payable public BurnedWalletAddress = payable(0x6f16E7B2005Ff0AAdaccC426a831812E74414CD0); 
    ...
    uint256 private _totalSupply = 10000000 * 10**6 * 10**_decimals;
