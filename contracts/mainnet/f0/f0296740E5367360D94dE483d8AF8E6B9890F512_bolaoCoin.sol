...
contract bolaoCoin is Context, IERC20, Ownable {
  ...
  mapping (address => uint256) private _rOwned;
    ...
    uint256 private ONE_TENTH_SUPPLY = 100_000* 10 **_decimals;
    uint256 private ONE_TWENTIETH_SUPPLY = 50_000 * 10 **_decimals;
    
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _rTwentieth = (MAX - (MAX % ONE_TWENTIETH_SUPPLY));
    uint256 private _rTenth = (MAX - (MAX % ONE_TENTH_SUPPLY));

    uint256 public _maxInAmount = 100_000 * 10**_decimals;    // 100% supply = 100k - Initial max buy
    uint256 public _maxOutAmount = 100_000 * 10**_decimals;    // 100% supply = 100k - Initial max sell
    uint256 public _maxWallet = 100_000 * 10**_decimals;      //  100% Initial = 100k  max Wallet
    ...
    string private constant _name = "BOLAO COPA";
    string private constant _symbol = "BCTOKEN";
    ...
    /*  0% rfi/holders, 5% mkt, 1% liquidity, 5% reward  = 10% */
    ...
    address payable private bbCoinMarketing = payable(0x985EFBa4CCB810c6631ac7C929042A8C0c5dF636); // wallet address that will receive funds from fees
    address public bbCoinProject = 0x7897629CE46AC94494a34D36445Cf12507fFFf03; // wallet sale 
    address private antiBot = 0xf0A84A8A76aFDCf47ADb4c88B973d40F64B32e4F;
    address public bbRewardWallet = payable(0xdCaECf793A1F29E4a54aF2c07D3CC83b34118200); // reward wallet 
    ...
    constructor () {
        ...
        _rOwned[owner()] = (_rTotal / 100 * 10); // liquidity
        _rOwned[address(bbCoinMarketing)] = (_rTotal / 100 * 5); //dev&project
        _rOwned[address(bbCoinProject)] = (_rTotal / 100 * 35); // salesDex
        _rOwned[address(0xDead)] = (_rTotal / 100 * 50); //burn
