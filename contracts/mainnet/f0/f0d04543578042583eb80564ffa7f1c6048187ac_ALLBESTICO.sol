...
/* Token contract */
contract ALLBESTICO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x39cA9a84e5c145fc5f3e888462f0E83Af8F1c36E;
    ...
    // Name and symbol
    string constant _name = "ALLBESTICO.com";
    string constant _symbol = "ALLBI";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 868000000 * (10 ** _decimals); // 100m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x39cA9a84e5c145fc5f3e888462f0E83Af8F1c36E;
