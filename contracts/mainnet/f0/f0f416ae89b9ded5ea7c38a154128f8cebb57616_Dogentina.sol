...
/**
Telegram : https://t.me/Dogentina

// La Selección | Albicelestes | Qatar Wolrd Cup 2022
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3AD6d97A1d9FB39b22Bbf413be5112Ee23cb69C1; // owner address
...
contract Dogentina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogentina";
    string private _symbol = "$AFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3AD6d97A1d9FB39b22Bbf413be5112Ee23cb69C1); // Marketing Address
    address payable public teamWalletAddress = payable(0x3AD6d97A1d9FB39b22Bbf413be5112Ee23cb69C1); // Team Address
