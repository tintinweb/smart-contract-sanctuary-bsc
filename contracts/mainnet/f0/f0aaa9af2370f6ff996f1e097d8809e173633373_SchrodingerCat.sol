...
/**
     ...
     telegram: https://t.me/SchrodingerCatPortal
...
/* Token contract */
contract SchrodingerCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x981403C9FF4bad4BC95EaEb2aAd76D78D3B44FaA;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 1% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 1% (100 mil)
