...
contract MandikeToken {
    ...
    constructor() {
        name = "Mandike"; // Sets the name of the token, i.e Ether
        symbol = "wXMD"; // Sets the symbol of the token, i.e ETH
    ...
    function transferOwnership(address payable _newOwner) public returns (bool success) {
