...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address RouterAddress, address USDTAddress, address FundAddress, address ReceiveAddress, uint256 LimitAmount){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (!inSwap && _swapPairList[to]) {
                    ...
                    if (contractTokenBalance > 0) {
                        ...
                        uint256 numTokensSellToFund = amount * swapFee / 100;
...
contract BNBFootball is AbsToken {
    constructor() AbsToken(
        ...
        address(0xeFb178896d924c27297De6902A9174Af6d345085),
        address(0xeFb178896d924c27297De6902A9174Af6d345085),
        1
    ){
