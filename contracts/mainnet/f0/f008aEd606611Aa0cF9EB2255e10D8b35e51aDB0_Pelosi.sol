...
abstract contract Token is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 1000000000000000000000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xEe1D34e12c8688f6143E6E5096e34fF3BABDcf3B;//fund address
...
contract Pelosi is Token {
    constructor() Token(
        ...
        address(0xEe1D34e12c8688f6143E6E5096e34fF3BABDcf3B),//fund address
    
        address(0xEe1D34e12c8688f6143E6E5096e34fF3BABDcf3B)//dev address
    ){
