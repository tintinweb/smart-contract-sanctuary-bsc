...
//Telegram: https://t.me/+PU5QkJgsY0NlYzM0
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Aa46498847509Ea77DFad17e2d3afd40B5dF70b; // owner address
...
contract INVESTORCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Investors club";
    string private _symbol = "$CLUB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7Aa46498847509Ea77DFad17e2d3afd40B5dF70b);
    address payable public teamWalletAddress = payable(0x7Aa46498847509Ea77DFad17e2d3afd40B5dF70b); 
