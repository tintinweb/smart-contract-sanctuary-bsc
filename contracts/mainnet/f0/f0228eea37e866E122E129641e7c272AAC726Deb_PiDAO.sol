...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "PiDAO_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PiDAO_Dividend_Tracker: Cannot update claimWait to same value");
...
contract PiDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = new TokenDividendTracker(rewardTokenAddress_, 5000);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 100000 && newValue <= 400000, "GasForProcessing must be between 100,000 and 400,000");
