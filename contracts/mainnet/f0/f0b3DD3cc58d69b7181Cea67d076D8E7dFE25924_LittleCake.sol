...
contract LittleCake is IBEP20, Auth {
    ...
    string constant _name = "LITTLE CAKE";
    string constant _symbol = "L-CAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 200000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0x2889747772b4c2b672ae195D714D23949dA60b2c; 
        ...
        marketingFeeReceiver = 0x2889747772b4c2b672ae195D714D23949dA60b2c;
        buybackFeeReceiver = msg.sender;
        rewardFeeReceiver = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
