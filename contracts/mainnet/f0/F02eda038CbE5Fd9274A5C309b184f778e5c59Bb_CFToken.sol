...
contract CFToken is StandardToken,Ownable {
    ...
    //----------------------------------------------------------------------------------------
    address public poolAccount = 0xD1CCAE9bBB6BCfCcD3fDB6eBa1F16948002641E3;//回交易池
    ...
    constructor(
        ...
        totalSupply_ = 14570 * (10 ** uint256(decimals));
    ...
    uint public sort = 0;
    uint public state = 0;// 0-close  1-限购5枚  2-限购10枚
    ...
    function transfer(address dst, uint256 wad) public returns (bool){
      ...
      if(state == 0){
        ...
        if(sort==BUY){
          if(balances[dst]+wad.div(100).mul(95)>10000000000000000000){
              return false;
          }
        }else if(sort==TRANSFER){
          if(balances[dst]+wad.div(100).mul(99)>10000000000000000000){
              return false;
          }
        }
      }
    ...
    { 
      ...
      if(sort==SALE){
          ...
          uint256 wadPool = wad.div(100);
          uint256 wadLpPrise = wad.div(100).mul(3);
          uint256 wadBlackhole = wad.div(100);
          ...
          super.transferFrom(src,dst,wadTransferfee);
          super.transferFrom(src,dst,wad);
          return true;
       }
