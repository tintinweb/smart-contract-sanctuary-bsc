...
contract UnipinDetector is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Unipin Detector";
    string private _symbol = "UNDECT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4b6Dd525f9061f5d7bCEA5407a2A5d1acba66A68);
    address payable public teamWalletAddress = payable(0x4b6Dd525f9061f5d7bCEA5407a2A5d1acba66A68);
