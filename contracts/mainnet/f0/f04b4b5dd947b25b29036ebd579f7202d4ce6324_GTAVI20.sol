...
contract GTAVI20 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE29416bC4Bacc5DC995e4EC92e5C80A3f784E480); 
    address payable public Wallet_Dev = payable(0xE29416bC4Bacc5DC995e4EC92e5C80A3f784E480);
    ...
    string private constant _name = "GTA VI 2.0"; 
    string private constant _symbol = unicode"GTAVI2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x1a4A9A70398AafF40a5a0F50613064559D76F9fB;
