...
contract LamarQuise is Context, IERC20, Ownable {
    ...
    string private _name = "LAMAR QUISE";
    string private _symbol = "LAMA";
    ...
    uint256 private numTokensSellToAddToLiquidity = 2000 * 10**3 * 10**9;
