        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x8AF22E4D940cee990777672F56380cECCdc8A63F), block.timestamp
                );
            }
        }
    }
...
contract WaterCoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x32b5834044e35b4597a8bbCAc9e440D1Bb531DBf),//FundAddress
        address(0x87eFC7f9048889Ff40e7153C46E7A4809F6de43e)//ReceiveAddress
    ){
    }
}