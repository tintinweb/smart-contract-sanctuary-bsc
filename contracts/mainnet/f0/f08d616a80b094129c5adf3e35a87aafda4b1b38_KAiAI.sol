...
contract KAiAI is Context, IERC20 { 
    ...
    address payable public TeamMarketing = payable(0xc2F4597931F4d9c8c3a97Ce6Be769EEa965a15FF); 
    address payable public DevWallet = payable(0xc2F4597931F4d9c8c3a97Ce6Be769EEa965a15FF);
    ...
    string private constant _name = "KAiAI"; 
    string private constant _symbol = unicode"KAiAI"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _BTax = 3;
    uint256 public _STax = 3;
    ...
    constructor () {
        ...
        _owner = 0xc2F4597931F4d9c8c3a97Ce6Be769EEa965a15FF;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_BTax/100;
            ...
            uint256 sellFEE = tAmount*_STax/100;
