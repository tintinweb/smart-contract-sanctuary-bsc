...
/**
SuperBuckMoon
Inspired by the recent Supermoon phenomenon, Dev planned to launch a gem token with mission to enlighten BSC by becoming top trending token of the month.

Other than earn from the price raise, with the light of SuperBuckMoon, you can also earn reflection by holding it.

Tokenomics:
1) Supply = 1,000,000,000 (1 Billion)
2) Tax = 10% (5% Reflection - 2% LP - 3% Marketing)
3) Max Wallet = 3.5%

Join SuperBuckMoon in TG : https://t.me/SuperBuckMoon
*/
...
contract SuperBuckMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "SuperBuckMoon"; // 
