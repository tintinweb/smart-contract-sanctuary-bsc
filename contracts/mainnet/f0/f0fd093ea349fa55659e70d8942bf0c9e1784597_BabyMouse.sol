...
// File: contracts/baby_mouse.sol

/**
 Baby Mouse Coin:
The Official Mouse Coin MSCN Eco-system Reward Token  
Deployed 06/09/2022 on the Binance Smart Chain.

Web: 
https://mousecoin.io - Mouse Coin Eco-system Platform

Telegram:
Telegram - Global: https://t.me/mousecoin_official

Socials:
Twitter: https://twitter.com/mousecoin_io
Facebook: https://www.facebook.com/mousecoincommunity

Tokenomics:
9%  Transaction Tax: Buy - Sell, Transfer
Automatic Rewards Dividends in MSCN Token
Reflections
Liquidity
...
Team and Dev Token Allocation: Less than 3%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x76B19d54dd2B12c61F6534B2348EB5EbB1945353);
...
contract BabyMouse is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x67383abd597484C673963cA7E73f4E3a25201D15;

    string constant _name = "Baby Mouse";
    string constant _symbol = "BabyMSCN";
    ...
    function withdrawToken(address _tokenContract, uint256 _amount) public onlyOwner  {
        ...
        // transfer tokens sent / held in the contract in error
