...
/* Token contract */
contract Squidkawai is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1F6916806774a6ab1990dd0A0e36e5f4436F08Cc;
    ...
    // Name and symbol
    string constant _name = "SquidKawai";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 250 ) / 10000; // 2.5% 
    ...
    uint256 public swapThreshold = _totalSupply * 28 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc47E81468367F4e2e9DcaBd20982f35fe55e45B1;
