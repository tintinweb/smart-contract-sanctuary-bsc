...
* - No Poo -
* 
* * Join the Telegram - https://t.me/NoPooBSC
* 
*/
...
contract NoPoo is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NoPoo"; // 
    string constant _symbol = "NoPoo"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (5); // 10%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (5); //10%
    uint256 public _maxWalletToken = _totalSupply / (100) * (15); // 20%

    // Fees receivers
    address private autoLiquidityReceiver = 0xAd8394E02aDA1eb045947C59Db486a0B9c789365; //LP receiver
    address private marketingFeeReceiver = 0x8c39246773538FD1D3Df15460898837A7056b47f; //Marketing
    address private devFeeReceiver = 0x8c39246773538FD1D3Df15460898837A7056b47f; //BuyBack
    address private teamFeeReceiver = 0x8c39246773538FD1D3Df15460898837A7056b47f; // Team 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xC434Cb8E0edbb7b70F6b10aB88d1805A036153Ae;
