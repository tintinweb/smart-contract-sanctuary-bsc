 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BabyVenomKitten
 * 
 * 
 * BabyVenomKitten token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BabyVenomKitten is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyVenomKitten";
    string constant _symbol = "BVITTEN";
