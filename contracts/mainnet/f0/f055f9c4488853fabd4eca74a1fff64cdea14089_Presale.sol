...
contract Presale is Context, ReentrancyGuard {
    ...
    address payable private _wallet; // receives total payment
    ...
    constructor(
        ...
        require(
            __wallet != address(0),
            "Crowdsale: wallet90 is the zero address"
        );
        require(
        ...
        require(
            __tokenWallet != address(0),
            "AllowanceCrowdsale: token wallet is the zero address"
        );
        require(
            usdt != address(0),
            "PRESALE: USDT address is the zero address"
        );
