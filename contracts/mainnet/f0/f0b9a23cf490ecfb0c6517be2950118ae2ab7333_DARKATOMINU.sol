...
contract DARKATOMINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10_000_000 * 10**8;
    uint256 public _maxTxAmount = 10_000_000 * 10**8; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**8; //
    string private constant _name = "DARK ATOM INU"; //
    string private constant _symbol = "DAI"; //
    uint8 private constant _decimals = 8; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x7620fbC0b6b730879679502bA4af79699ba8E952 ;
