...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(_totalSupply<=_maxSupply,"total supply exceed maximum supply.");
...
contract MasterBuilder is Ownable {
    ...
    function DexTokenOwnershipTransfer(address _address) public onlyOwner {
        dexToken.transferOwnership(_address);
    }
