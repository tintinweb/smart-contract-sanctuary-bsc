...
/* Token contract */
contract AnimeGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x418376B00ABa04F5343ee4Ff8E61CB2A8387dEAf;
    ...
    // Name and symbol
    string constant _name = "AnimeGrow";
    string constant _symbol = "AnimeGrow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (2mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (1mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (2mil)
