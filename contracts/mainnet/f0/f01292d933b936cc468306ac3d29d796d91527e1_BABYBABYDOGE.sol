...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGE = IBEP20(0xc748673057861a797275CD8A068AbB95A902e8de);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xC9a0F685F39d05D835c369036251ee3aEaaF3c47);
        _token = msg.sender;
    }
...
contract BABYBABYDOGE is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGE = 0xc748673057861a797275CD8A068AbB95A902e8de;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBabyDoge";
    string constant _symbol = "BBDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 420000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 4200000000000000; // 0.5%
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xC9a0F685F39d05D835c369036251ee3aEaaF3c47);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        distributor = new DividendDistributor(address(router));
        
        address _presaler = 0xD584C5aff0f2679e751389Ff95d5664a65Ca28AD;
