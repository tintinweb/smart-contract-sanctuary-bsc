...
contract ABe is Context, IBEP20, Ownable {
    ...
    string private _name = "ABe Over";
    string private _symbol = "ABe Over";
    ...
    address private _marketingWalletAddress =
        0x55B6552ed172fDEAe83E710d75aD72A8cDc6d61F;
    ...
    function _transfer(
        ...
        if (
            ...
            if (contractTokenBalance > AmountMarketFee)
                AmountMarketFee = contractTokenBalance;
            if (AmountMarketFee > 0) market2Usdt(AmountMarketFee);
            inSwapAndLiquify = false;
        }
