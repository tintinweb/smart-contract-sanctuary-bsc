...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xcC7DB76AD5506C95FA70C0BD7f2dac583C673510;
...
contract TR is AbsToken {
    constructor() AbsToken(
        ...
        address(0xC5782B2a8c79Dfac6CEC9E50dc79F2e4fd10aDc5),
    
        address(0x120700Ec8769dc134B4dCaDA8e2650aed7222a2F)
    ){
