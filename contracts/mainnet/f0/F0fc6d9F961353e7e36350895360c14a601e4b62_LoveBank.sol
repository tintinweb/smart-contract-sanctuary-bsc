...
contract LoveBank is ReentrancyGuard, AccessControlEnumerable {
    ...
    address gas = 0x86712327a875C46375F06b5B2Bc592d31bC99AbC;
    address gasStake = 0x96FFfBD9C6C7b3A115F0A1a2a74E5E2F2Fb199f9;

    function baseInit(address usdtAddr, address gasAddr, address gasStakeAddr, address account, address random)
