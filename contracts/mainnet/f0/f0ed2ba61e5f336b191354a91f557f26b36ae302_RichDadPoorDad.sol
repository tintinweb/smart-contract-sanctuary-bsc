...
library Address{
 ...
 contract RichDadPoorDad is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rich Dad Poor Dad";
    ...
    Taxes public taxes = Taxes(0, 4, 1, 2);
    Taxes public sellTaxes = Taxes(0, 4, 1, 2);
