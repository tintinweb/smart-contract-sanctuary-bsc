...
contract PandaDuck is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PandaDuck";
    string constant _symbol = "PDUCK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(7).div(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8b7ADA88A8509EcA0f842435DA3fA4f2C3385e1B;
        ecosystemfeeReceiver = 0xFcbA8fdA8cFB9752B764229aAE29601527d796Bf;
