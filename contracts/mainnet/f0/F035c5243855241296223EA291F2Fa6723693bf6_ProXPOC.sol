...
contract ProXPOC is ERC721Enumerable, Ownable {
  ...
  address private oldCollectionWallet = 0x87E165a90Fe7409a66AfB1c72d3445e3845d0806;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount,  "ProXPOC: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "ProXPOC: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "ProXPOC: total cost isn't match");
    }
    // Minting
