...
/** 
 *  SourceUnit: d:\GitWork\KeySwapNFTMarketplace\contracts\contracts\Market.sol
*/
...
contract Market is Ownable, ERC721Holder {
    ...
    function buy(uint256 _id) external payable {
		...
		if (pairs[_id].tokenAdr == address(0x0)) {
			...
			require(governanceToken.transfer(adminAddress, totalAmount.mul(feeAdmin).div(PERCENTS_DIVIDER)));			
