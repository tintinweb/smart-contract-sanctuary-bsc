...
contract FloshinaInu is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x197ddD9455ee93c634c6096bDEaceB15B86E7995;

    string constant _name = "Floshina Inu";
    string constant _symbol = "FloshinaInu";
