...
__        _______ _   _ ________ _     _        _    
\ \      / | ____| \ | |__  |_ _| |   | |      / \   
 \ \ /\ / /|  _| |  \| | / / | || |   | |     / _ \  
  \ V  V / | |___| |\  |/ /_ | || |___| |___ / ___ \ 
   \_/\_/  |_____|_| \_/____|___|_____|_____/_/   \_\
                                                     
When will Dogezilla launch? Print your 1000x here instead                              
                                                     
   telegram : https://t.me/wenzillabsc
*/
...
contract WenZilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x51ec542e972CD9f5C8362CC43988B52a8099B588); 
    address payable public Wallet_Dev = payable(0x51ec542e972CD9f5C8362CC43988B52a8099B588);
    address payable public constant Wallet_Burn = payable(0x51ec542e972CD9f5C8362CC43988B52a8099B588); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "WenZilla"; 
    string private constant _symbol = unicode"WenZilla"; 
    ...
    constructor () {
        ...
        _owner = 0x51ec542e972CD9f5C8362CC43988B52a8099B588;
