...
contract SpooQuid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpooQuid";
    string private _symbol = "SPOOQUID";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2D1ff0Fe529acd43Db048C73c591BA7a636085a7);
