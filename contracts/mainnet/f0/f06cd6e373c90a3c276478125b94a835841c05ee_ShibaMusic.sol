...
contract ShibaMusic  is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xaD94dFE3bDF804F76a958126765D087561672926); 
    address payable private Wallet_Dev = payable(0xaD94dFE3bDF804F76a958126765D087561672926);
    ...
    constructor () {
        ...
        _owner = 0xaD94dFE3bDF804F76a958126765D087561672926;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xaD94dFE3bDF804F76a958126765D087561672926); // Testnet
