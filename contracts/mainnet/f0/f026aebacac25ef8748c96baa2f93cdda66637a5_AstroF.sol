...
// PRINTING BUSD NEVER STOPS !
// ASTRO FINANCE BSC - 13% BUSD REWARDS
// UPDATE : 1H
...
contract AstroF is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "AstroFinance"; //  Name
        _symbol = "ASF"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 100000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 13000000 * 10**_decimals;
        _maxTxAmount = 20000000 * 10**_decimals; // 1% of total supply
        _maxWalletBalance = 15000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0xC9D84769c16Def8300Ef6D031BB32a6B3F7B4D6b; // Marketing wallet 
        _devWalletAddress = 0xC9D84769c16Def8300Ef6D031BB32a6B3F7B4D6b; // Burn Token 
