...
contract BabyBone is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xd7C6aBCe31B29045bbAaD0791E2B73dc7CE832D1;
    address public devAddress = 0x6F1108C26f4773CE0706De5C2588100F8b6b7487;

    string private constant _name = "Baby Doge Bone";
    ...
    // Owner cannot transfer out BabyBone from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out BabyBone!");
