...
Telegram: https://t.me/Grimace1969bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79944779D477E72f1d52F3C73fA7ad0fbeDf00D5; // owner address
...
contract GRIMACE1969 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GRIMACE 1969";
    string private _symbol = "GRIM69"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF555d91C4649fAD7F9c9B6E91B7AaFE5a59b5C4e); // Marketing Address
    address payable public teamWalletAddress = payable(0x96a62d377Cc71E10F404f2Ef8cA013262FABC282); // Team Address
