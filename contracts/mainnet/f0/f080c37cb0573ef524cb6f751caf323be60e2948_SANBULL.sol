...
contract SANBULL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SANTA BULL";
    string private _symbol = "SANBULL";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x02280630768f13AF2E06093291491DEAB7F88186); // Marketing Address
    address payable public BuyBackWallet = payable(0x02280630768f13AF2E06093291491DEAB7F88186); // Team Address
