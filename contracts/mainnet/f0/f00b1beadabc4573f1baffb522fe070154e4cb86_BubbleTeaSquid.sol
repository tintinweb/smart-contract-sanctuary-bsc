...
contract BubbleTeaSquid is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Bubble Tea Squid";
    string private constant _symbol = "BT SQUID";
