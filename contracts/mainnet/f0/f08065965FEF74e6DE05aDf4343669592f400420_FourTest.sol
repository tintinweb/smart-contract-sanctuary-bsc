...
contract FourTestDividendTracker is Ownable, DividendPayingToken {
    ...
    event MinReqUpdated(uint256 indexed newValue, uint256 indexed oldValue);
    ...
    function updateMinReq(uint256 newMinReq) external onlyOwner {
        emit ClaimWaitUpdated(newMinReq, minimumTokenBalanceForDividends);
        minimumTokenBalanceForDividends = newMinReq;
    }
