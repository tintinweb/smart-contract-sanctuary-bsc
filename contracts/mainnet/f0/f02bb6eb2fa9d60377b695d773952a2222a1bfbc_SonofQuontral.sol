...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3AA4dF07f2Cc4763e35196b9054CAE127175fe76;
...
contract SonofQuontral  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x343532A958D10B9Bbb1c35b27018B702e64A04E8;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SON OF QUONTRAL";
    string private _symbol = "sQUON";
