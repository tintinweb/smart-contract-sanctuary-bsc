...
Enjoy Busy Rewards !!!
Telegram Chat: https://t.me/busdyexclamationmark3x
...
contract Busdyexclamationmark3x is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Busdyexclamationmark3xDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Busdy!!!", "Busdy!!!") {
        marketingWallet = payable(0x62173709c62828ac2389eABC4C7ffCE9c0408a25);
        devWallet = payable(0x55eB627F0D6A6E14f7027Dd319eBACfCd35db888);
        ...
        dividendTracker = new Busdyexclamationmark3xDividendTracker(
            payable(this),
            router,
            0x5BEBfAB847DD89B1D03cA654685BaC07Aa01224e,
            "Busdyexclamationmark3xTRACKER",
            "Busdyexclamationmark3xTRACKER"
        );
...
contract Busdyexclamationmark3xDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Busdyexclamationmark3x public Busdyexclamationmark3xContract;
    ...
    constructor(
        ...
        defaultToken = token;
        Busdyexclamationmark3xContract = Busdyexclamationmark3x(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Busdyexclamationmark3x_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Busdyexclamationmark3x_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Busdyexclamationmark3x contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Busdyexclamationmark3xContract);

            uint256 prevBalance = Busdyexclamationmark3xContract.balanceOf(address(this));
            ...
            {
                uint256 received = Busdyexclamationmark3xContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Busdyexclamationmark3xContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
