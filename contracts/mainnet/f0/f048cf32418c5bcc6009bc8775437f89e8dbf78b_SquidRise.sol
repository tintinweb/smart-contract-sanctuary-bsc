...
contract SquidRise is Context, IERC20, Ownable {
    ...
    string private _name = "SquidRise";
    string private _symbol = " sRise";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCB07d5cddE446243a2B3698C4237C44796D76321); // Marketing
    address payable public BuyBackWalletAddress = payable(0xCB07d5cddE446243a2B3698C4237C44796D76321); // BuyBack 
