...
contract FovoerUP is Context, IBEP20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xBAA3AdC38a5A01e947AB87774DE5966fEc1786F3); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FovoerUP";
