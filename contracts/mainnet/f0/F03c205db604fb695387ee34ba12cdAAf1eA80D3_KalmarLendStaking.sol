...
// File contracts/KalmarLendStaking.sol
...
interface IRewardVault {
  ...
  function getRewardVest(address _to, uint256 _amount) external;
}
...
contract KalmarLendStaking is ReentrancyGuard, Initializable {
    ...
    function _mintRewards(address _user, uint256 _amount) internal returns (uint256) {
        if (_amount > 0) {
            ...
            rewardVault.getRewardVest(receiver, _amount);
