...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7e809Eb6e6E2265389d617E202dbD48fa8310161;
...
contract PAIMON is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB71c214e58Ed164e1959C75969496d0EBF916dAC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PAIMON";
    string private _symbol = "PAIM";
