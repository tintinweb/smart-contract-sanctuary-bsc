...
/*
    ...
    Telegram: https://t.me/RussianBlueInu
...
contract RussianBlueInu is IERC20, Ownable {
    ...
    string _name = "Russian Blue Inu";
    string _symbol = "BLUE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);   // 1,000,000,000,000,000
    uint256 public _transferLimit = (_totalSupply * 1) / 200;   // 0.5% 
    ...
    uint256 giveawayFee = 3;
    uint256 liquidityFee = 1;
    uint256 totalFee = 10;
    uint256 feeDenominator = 100;
    
    address autoLiquidityReceiver;
    address marketingFeeReceiver = 0xE0Ce1dBf157B144953A0922C672CfF587159FD1a;
    address giveawayFeeReceiver = 0x8083fEf68C379541F49D9Ae2a029A1A3c25Fd4C1;
