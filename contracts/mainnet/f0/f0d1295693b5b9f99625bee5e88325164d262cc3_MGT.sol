...
contract MGT is Context, Ownable, IBEP20, BEP20Detailed {
    ...
    address payable public marketingaddress =
        payable(0xa5290078599D1D0f4d2fbe55bF64FEe909dE178B);
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee)
        external
        onlyOwner
    {
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee)
        external
        onlyOwner
    {
        require(
            updatedSellMarketingFee <= 5,
            "Sell fee should be less than 5%"
        );
    ...
    function changeNumTokensSellToFee(uint256 _numTokensSellToFee)
        external
        onlyOwner
    {
        require(
            _numTokensSellToFee >= 100 * 10**18 &&
                _numTokensSellToFee <= 1000000 * 10**18,
            "Threshold must be set within 100 to 1,000,000 tokens"
        );
