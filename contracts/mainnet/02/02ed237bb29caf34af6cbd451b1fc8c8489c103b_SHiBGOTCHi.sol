...
contract OwnableSHIB is ContextSHIB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableSHIB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSHIB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SHiBGOTCHi is ContextSHIB, BinanceBNB, OwnableSHIB {
