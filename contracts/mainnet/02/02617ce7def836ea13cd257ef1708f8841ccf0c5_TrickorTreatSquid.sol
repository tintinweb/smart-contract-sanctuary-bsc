...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x492a46E4172f95eb229D3cAD6d7C3f2eBd163b05; // owner address
...
contract TrickorTreatSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trick Or Treat Squid";
    string private _symbol = "$TOTSquid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x492a46E4172f95eb229D3cAD6d7C3f2eBd163b05); // Marketing Address
    address payable public teamWalletAddress = payable(0x492a46E4172f95eb229D3cAD6d7C3f2eBd163b05); // Team Address
