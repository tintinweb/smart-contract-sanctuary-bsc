...
contract ShibaKuza is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShibaKuza";
    string constant _symbol = "$SHIKA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x81FCf50e49959F1e7c95931a360C7F3DA99be129;  // shibakuzamarketingwallet
        anothermarketingWallet = 0x81FCf50e49959F1e7c95931a360C7F3DA99be129; // jackpotwallet
