...
contract SLeePRZ is IBEP20, Ownable {
    ...
    string private _name = "SLEEPRZ";
    string private _symbol = "SLPRZ";
    uint256 private constant INITIAL_SUPPLY = 1_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 private constant MAX_TAX = 100;      //Team can never set tax higher than this value
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0x1ec6793Cde9148bEC6286D1bd87Ed9E53FFbC480,
        Dev: 0x1ec6793Cde9148bEC6286D1bd87Ed9E53FFbC480,
        marketing: 0xf9C1b474286cDEa5EEa561102Ff93faCCED3cE0B
    });
