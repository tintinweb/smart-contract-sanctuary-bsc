...
contract StylikeGovernance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stylike Governance"; // 
    string private constant _symbol = "$STYL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x6408444A2b0c9CA03777642d1C0E087e930C3B8c;
