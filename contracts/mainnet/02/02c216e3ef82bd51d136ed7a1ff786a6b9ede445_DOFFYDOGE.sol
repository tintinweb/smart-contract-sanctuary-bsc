...
contract DOFFYDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x3AdB8c7E3A1318cA64969C1AB7d3C5100A95C67c);
    ...
    string private constant _name = "DOFFYDOGE"; 
    string private constant _symbol = unicode"DOFFYDOGE"; 
    ...
    constructor () {
        ...
        _owner = 0x3AdB8c7E3A1318cA64969C1AB7d3C5100A95C67c;
