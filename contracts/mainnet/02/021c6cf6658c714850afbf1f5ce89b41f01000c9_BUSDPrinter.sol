...
contract BUSDPrinter {
    ...
    constructor(address _owner, address _partner) {
            owner = _owner;
            partner = _partner;
    ...
    function stakeStablecoins(uint256 amtx, address ref)  external payable initialized {
        ...
        BUSD.safeTransfer(owner, stakeFee * 4/8);
        BUSD.safeTransfer(partner, stakeFee * 4/8);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        BUSD.safeTransfer(owner, withdrawFee * 4/8);
        BUSD.safeTransfer(partner, withdrawFee * 4/8);
