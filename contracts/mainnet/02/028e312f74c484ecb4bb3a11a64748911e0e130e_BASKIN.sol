...
contract BASKIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baskin Robins Inu";
    string private _symbol = "BASKIN";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x736597B193F34854e8832De293Ff46c639473312); // Buy Back Address
