...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x34f9889B36f8f7dE2d7671891Ffe472B7A64bd73;
...
contract Hyenagirlinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "HYENA GIRL INU"; // 
    string private constant _symbol = "HGI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x34f9889B36f8f7dE2d7671891Ffe472B7A64bd73);
