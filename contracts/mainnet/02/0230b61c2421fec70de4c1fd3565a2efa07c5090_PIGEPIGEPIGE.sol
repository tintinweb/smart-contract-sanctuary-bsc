...
contract PIGEPIGEPIGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigePigePige";
    string private _symbol = "PigePigePige";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23AA56F5317F4f3e0E17d23004bF66703Db6abcc); 
    address payable public DevelopmentalWalletAddress = payable(0xC314c4f16AA64D718C22185e7D04B85D29A585f1); 
