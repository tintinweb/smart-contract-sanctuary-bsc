...
// Telegram: https://t.me/chadgrowbsc
...
contract CHADGROW is IBEP20, Auth {
   ...
   constructor () Auth(msg.sender) {
       ...
       marketingFeeReceiver = 0x56a4E6399e0453C0933BDaeA5E34a60D398DC97d; // Marketing Wallet
       buybackFeeReceiver = 0x330443c01DF00A1e81913B2d5F1c249b039aeD9a; // Dev Wallet
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   // Set the correct fees for buying or selling
    ...
    function ClaimHuman() public onlyOwner { 
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(7).div(8);
       uint256 amountBNBBuyback = (amountBNB.mul(buybackFee).div(totalBNBFee)).mul(3).div(4);
       uint256 amountleft = (amountBNBMarketing.div(7)).add(amountBNBBuyback.div(3));
