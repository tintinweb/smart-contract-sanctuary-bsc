...
contract RoboCatTest is ERC20Detailed, Ownable {
    ...
    string public _name = "RoboCat Test";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 500 * 10**7 * 10**DECIMALS;
    ...
    uint256 private constant MAX_SUPPLY = 500 * 10**10 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("RoboCat Test", "RCAT", uint8(DECIMALS)) Ownable() {
