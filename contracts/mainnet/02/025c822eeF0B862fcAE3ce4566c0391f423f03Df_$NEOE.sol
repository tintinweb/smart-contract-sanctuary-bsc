...
contract $NEOE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neura Link of ELon"; 
    string private _symbol = "$NEOE"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9221f9E663324Bb194c2D752e176d3c6C02da585); 
    address payable public teamWalletAddress = payable(0x9221f9E663324Bb194c2D752e176d3c6C02da585); 
