...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe56D412aeFfAc86475985C4645a084C549F39281; // owner address
...
contract SucInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Suc Inu";
    string private _symbol = "SUC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x850035E65697308Eea419e4246d8649fbC239E17); // Marketing Address
    address payable public teamWalletAddress = payable(0x850035E65697308Eea419e4246d8649fbC239E17); // Team Address
