...
contract LaeebInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxRxAmount = 10000000000 * 10**_decimals;   
	uint256 public _maxWallet = 10000000000 * 10**_decimals;   
    uint256 public numTokensToSwap = 100000000 * 10**_decimals; 
	uint public sellPerSecond = 0; 
    uint public buyPerSecond = 0;	
    ...
    string private constant _name = "LaaebInu";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        marketingAddress = payable(0xe335F7418b58fC1550d8Da798226229115E9b565); 
