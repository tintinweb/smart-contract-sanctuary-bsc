...
contract CatSamurai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatSamurai";
    string private _symbol = "CS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc7283873b3D4321aB43d4c8fA0992af6D5d2b7Da); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc7283873b3D4321aB43d4c8fA0992af6D5d2b7Da); // BuyBack Address
