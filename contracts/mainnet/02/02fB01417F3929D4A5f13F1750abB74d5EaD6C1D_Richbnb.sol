...
contract Richbnb is IERC20 {
  ...
  event SwapTokensForETH(uint256 amountIn,address[] path );
    ...
    address public cake = address(0xC275DDdBD0AA7d8Be23D98992a5B7819c3115917);
    ...
    constructor () {
       ...
       _symbol = "RichBNB";
       _decimals = 9;
       _totalSupply = 1000000000000000000000 * 10**2 * 10**_decimals;  
       maxTrade = 2500000000000000 * 10**13 * 10**_decimals;   //1%
