...
/**
  ...
  _____                      _____ _               _      
 |  __ \                    / ____| |             (_)     
 | |  | | ___   __ _  ___  | |    | | __ _ ___ ___ _  ___ 
 | |  | |/ _ \ / _` |/ _ \ | |    | |/ _` / __/ __| |/ __|
 | |__| | (_) | (_| |  __/ | |____| | (_| \__ \__ \ | (__ 
 |_____/ \___/ \__, |\___|  \_____|_|\__,_|___/___/_|\___|
                __/ |                                     
               |___/                                      
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract DogeClassic is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Classic";
    string constant _symbol = "DOGEC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 4) / 200; // 2% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 4) / 200; // 2% of Total supply
    ...
    uint256 public swapThreshold = _totalSupply * 45 / 10000; // 0.45
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBot[sender], "ERC20: address blacklisted (bot)");
