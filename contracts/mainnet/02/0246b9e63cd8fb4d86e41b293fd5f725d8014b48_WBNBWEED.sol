...
contract WBNBWEED is Initializable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function initialize() public initializer {
        __Ownable_init();
        WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; /* Binance: Wrapped BNB */
        WBNBinterface = IERC20(WBNB);
        min = 0.01 ether; // 0.01 WBNB
        max = 100000 ether; // 100k WBNB
        roi = 25;
        fee = 3;
        withdraw_fee = 3;
        ref_fee = 15;
    ...
    function deposit(address _ref, uint256 _amount) public nonReentrant {
        require(
            ...
            "Amount must be between 0.01 and 100000 WBNB"
        );
        ...
        if (!checkAlready()) {
            ...
            WBNBinterface.transferFrom(msg.sender, dev, total_fee);
            WBNBinterface.transferFrom(
                msg.sender,
                address(this),
                total_contract
            );
    ...
    function withdrawal() public nonReentrant {
        ...
        WBNBinterface.transfer(msg.sender, totalAmountToWithdraw);
        WBNBinterface.transfer(dev, wFee);
    ...
    function unStake() external nonReentrant {
        ...
        WBNBinterface.transfer(msg.sender, UnstakeValueCore);
    ...
    function Ref_Withdraw() external nonReentrant {
        ...
        WBNBinterface.transfer(msg.sender, value);
    ...
    function getBalance() public view returns (uint256) {
        return WBNBinterface.balanceOf(address(this));
    }

    function getUserBalance(address _user) public view returns (uint256) {
        return WBNBinterface.balanceOf(_user);
    }
}