...
// 7% REFLECTIONS TO ALL HOLDERS IN EVERY TX
// tg: https:/t.me/SantaAi_bnb
/*
...
pragma solidity ^0.6.12;
    ...
    contract SantaAi is Context, IERC20, Ownable {
        ...
        string private _name = 'SantaAI';
        string private _symbol = 'SantaAI';
        ...
        uint256 private _numOfTokensToExchangeForMarketing = 2 * 10**3 * 10**9;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x0fC9B48a1e37beBbf10C52B6F00388BF9AB83836, 'We can not exclude Uniswap router.');
