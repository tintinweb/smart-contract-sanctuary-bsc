...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x88479186BAC914E4313389a64881F5ed0153C765);
...
/* Token contract */
contract SQUIDBONKGROW2023 is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x88479186BAC914E4313389a64881F5ed0153C765; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x88cc0D0bC37a1b73a4005E3db2b4ff39450C32b6;
    ...
    // Name and symbol
    string constant _name = "SquidBonk Grow 2023";
    string constant _symbol = "SquidBonk Grow 2023";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% or 5m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 10000; // 1% of supply
