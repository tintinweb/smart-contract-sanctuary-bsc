...
🇪🇺 Welcome to Europe Grow 🇪🇺


TG: https://t.me/europegrow
...
contract EUROPEGROW is Context, IERC20, Ownable {
    ...
    uint256 private _buyMarketingFee = 3;  // Markting Fee 4%
    ...
    uint256 private _sellMarketingFee = 18;   // Markting Fee 6%
    uint256 private _sellDevFee = 0; // Dev Fee 3%
    ...
    constructor() {
        _name = "Europe Grow"; //  Name
        _symbol = "EGROW"; //  Symbol
