...
contract  GGGToken is IERC20, Ownable {
    ...
    constructor(){  
           address adminAddress = 0xBD1aF0702b0D60A807779103f449589A79B475A4;
           // _token = addrs[2];
            _name = "luckybee";
            _symbol =  "luckybee";
            _decimals= 18;
            _tTotal = 300* (10**uint256(_decimals));
            _burnFee = 0;
            _marketingFee = 1200;
            _LPFee = 1800;
            marketAddr =  0xD3BE93E9E8A5d04cFf1fAc17F4b4e5A98a9792aB ;
            ...
            _intervalSecondsForSwap = 90;


            maxTax = 300 * (10**uint256(_decimals));
            maxHave = 1 * (10**uint256(_decimals));
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if ( _startTimeForSwap + 1890 < block.timestamp && !updFee && _startTimeForSwap!=0) {
                        _LPFee = 300;
                        _marketingFee = 200;
                        updFee = true;
        }
