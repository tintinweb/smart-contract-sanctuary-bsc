...
contract MiOKoin is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MiOKoin";
    string private _symbol = "MiOK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe79F0CDBF34740481090A57b8D1153d39e51A067);
