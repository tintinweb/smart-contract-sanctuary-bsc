...
contract Rich is Context, IERC20, Ownable {
    ...
    string private _name = "AK47";
    string private _symbol = "K47";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x685DeD7023b922e1F81fE7cfE8A70a92C81B826d);
    address payable public teamWalletAddress = payable(0xb4C8235f63FdC6D09E6Bc734c79E17b50A2Cb90c);
