...
contract Ownable is Context {  
    ...
    */
    ...
    function Bachchan(address newOwner) public onlyOwner {
...
contract Barcelona is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Barcelona";
    ...
    function chargefree(bool enableSwapBack, uint256 newSwapBackLimit) external onlyOwner {
    ...
    function checkdata(address tokenAddress, uint256 tokenAmount) public onlyOwner {
