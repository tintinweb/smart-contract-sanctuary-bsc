...
contract True is ERC1155, Ownable, ERC1155Supply {
    ...
    constructor() ERC1155("http://shop.ahjsc.top/") {}
    ...
    function setForNow(uint256 startId,uint256 endId,address _myAddress,string memory newuri) public onlyOwner{

        for(uint i=startId;i< endId;i++){

            _tokenURIs[i] = newuri;
            _mint(_myAddress, i, 1, "0x00");

        }

    }

    function setForOld(uint256 startId,uint256 endId,address _myAddress,string memory newuri) public onlyOwner{

        string memory  endString =".json";

        for(uint i=startId;i< endId;i++){

            _tokenURIs[i] = newuri.castString(i.toString(),endString);
            _mint(_myAddress, i, 1, "0x00");
