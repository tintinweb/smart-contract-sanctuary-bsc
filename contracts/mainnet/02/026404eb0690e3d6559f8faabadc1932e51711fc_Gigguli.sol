...
contract Gigguli is ERC20Detailed, Ownable {
    ...
    string public _name = "Giggeli";
    string public _symbol = "Guthis2";
    ...
    constructor() ERC20Detailed("GIGGELI", "GUTHIS2", uint8(DECIMALS)) Ownable() {
