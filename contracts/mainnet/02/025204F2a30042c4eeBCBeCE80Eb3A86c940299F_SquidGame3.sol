...
contract SquidGame3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGame 3.0";
    string private _symbol = "SQ3";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xDe41cCf9D9AE5794BfE56961BDf3bEaA62Da0f0a);
    address payable public teamWalletAddress = payable(0xDe41cCf9D9AE5794BfE56961BDf3bEaA62Da0f0a);
