...
contract BabyAbe is Context, IERC20, Ownable {
    ...
    string private _name = "BabyAbe";
    string private _symbol = "BabyAbe";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1cF853942bd93d743844048353772451A0935C5e); // Marketing Address
    address payable public teamWalletAddress = payable(0x1cF853942bd93d743844048353772451A0935C5e); // Team Address
    address payable public liquidityAddress = payable(0x1cF853942bd93d743844048353772451A0935C5e); // Team Address
