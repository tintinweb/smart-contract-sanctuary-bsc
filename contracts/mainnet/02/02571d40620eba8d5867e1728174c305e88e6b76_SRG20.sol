...
/**
    SURGE BITCOIN ($BTC) token has a total supply of 21-million and only available on the Surge Protocol.
    The key feature of this token is to create a decentralized cryptocurrency for Surge protocol users. 
    ...
    Telegram: https://t.me/Surge_BTC

  _____ _    _ _____   _____ ______      ____ _____ _______ _____ ____ _____ _   _ 
 / ____| |  | |  __ \ / ____|  ____|    |  _ \_   _|__   __/ ____/ __ \_   _| \ | |
| (___ | |  | | |__) | |  __| |__       | |_) || |    | | | |   | |  | || | |  \| |
 \___ \| |  | |  _  /| | |_ |  __|      |  _ < | |    | | | |   | |  | || | | . ` |
 ____) | |__| | | \ \| |__| | |____     | |_) || |_   | | | |___| |__| || |_| |\  |
|_____/ \____/|_|  \_\\_____|______|    |____/_____|  |_|  \_____\____/_____|_| \_|
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    //Tax wallets
    address public teamWallet = 0xA8e8450F8b73A6431890fbea15BAB0bA0Cd24bFE;
    address public treasuryWallet = 0x86c77f53D798AC1310078f72606Fd753A8B5c0D5;
