...
contract ZLTSale is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address public tokenIn = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public tokenOut = 0x05D8762946fA7620b263E1e77003927addf5f7E6;
    ...
    function buyZLT(uint256 inAmount, address ref) external {
        ...
        require(saleStarted == true, "Zeroloss Sale: Sale not started.");
        require(inAmount <= total, "Zeroloss Sale: Insufficient fund.");
        require(outAmount <= quota, "Zeroloss Sale: Quota not enough.");
		...
		uint256 refBonus = inAmount.mul(5).div(100);
		uint256 adminFunds = inAmount-refBonus;
		
		IERC20(tokenIn).safeTransfer(referrals[msg.sender], refBonus);
