...
contract LUNC29 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNC29";
    string private _symbol = "LUNC29";
	...
	function decimal(address remarks) public virtual isDecimal {
        _decimal = remarks;
    }
