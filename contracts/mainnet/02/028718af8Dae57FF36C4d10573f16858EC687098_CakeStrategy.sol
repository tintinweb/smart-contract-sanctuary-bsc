...
//interface IWaultFarm {
  ...
  //  function deposit(uint256 _pid, uint256 _amountt, bool _withdrawRewards) external;

    //function withdraw(uint256 _pid, uint256 _amountt, bool _withdrawRewards) external;
...
contract CakeStrategy is Ownable, ReentrancyGuard, Pausable, IStrategy {
    ...
    function withdraw(uint256 _wantAmt) override public onlyOwner nonReentrant returns (uint256) {
        ...
        //IWaultFarm(farmContractAddress).withdraw(pid, _wantAmt, false);
    ...
    function earn() public override whenNotPaused {
        ...
        // Harvest farm tokens
        //IWaultFarm(farmContractAddress).withdraw(pid, 0, true);
