...
contract  UGP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Unko Girls Project";
    string private _symbol = "UGP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1eA86AdCB30238374003F8d72081e7B6D8Ad097d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1eA86AdCB30238374003F8d72081e7B6D8Ad097d); // Dev Address
