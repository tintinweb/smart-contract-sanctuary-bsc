...
contract VOXILLIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Voxillium";
    string private _symbol = "VXLM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB967b33fbf5A844DD59267753Bc39902b723CB50); 
    address payable public DevelopmentalWalletAddress = payable(0xB967b33fbf5A844DD59267753Bc39902b723CB50); 
