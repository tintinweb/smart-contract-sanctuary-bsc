...
contract BabyM31V2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF91e1A3b6EA0021Fff652A84C891239dDFB5c23F); // Marketing Address
    ...
    string private _name = "BabyM31V2";
    string private _symbol = "BabyM31V2";
