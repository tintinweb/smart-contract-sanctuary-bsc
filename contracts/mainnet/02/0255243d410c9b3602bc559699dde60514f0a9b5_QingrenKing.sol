...
contract QingrenKing is Context, IERC20, Ownable {
    ...
    // naming and symbol
    string private _name = "QK";
    string private _symbol = "QingrenKing";
    
    // decimals
    uint8 private _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**6 * 10**_decimals; // 100,000,000,000,000.000 000 000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 public _maxTxAmount = 500000 * 10**6 * 10**_decimals; //0.5% of tTotal
    uint256 public numTokensSellToAddToLiquidity = 50000 * 10**6 * 10**_decimals; //0.05% of tTotal
    ...
    constructor () {
        ...
        // marketing wallet
        _marketingWalletAddress = 0x777777B4EA39F8bd36E22eD5003FABfE258Fc9Ab;
    ...
    function setTokenLiquifyCap(uint256 tokenNumber) external onlyOwner() {
        numTokensSellToAddToLiquidity = tokenNumber* 10**6 * 10**_decimals;
    }
