...
One of the famous FLOKI. 
She will organise BSC like how it used to be.
4FLOKI The next hype.

https://t.me/foreverflokibsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3172393d00687F856003e9e59b629b3D00b7DfF5; 
...
contract ForeverFLoki is Context, IERC20, Ownable {
    ...
    string private _symbol = "4FLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3172393d00687F856003e9e59b629b3D00b7DfF5); // 
    address payable public teamWalletAddress = payable(0x3172393d00687F856003e9e59b629b3D00b7DfF5); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x3172393d00687F856003e9e59b629b3D00b7DfF5)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x3172393d00687F856003e9e59b629b3D00b7DfF5),removeRandom);
}}