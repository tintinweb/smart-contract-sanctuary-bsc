...
contract Ownable is Context {
    address private _owner = 0x0e2257431174812f0A093EBB8344f1f587768F36;
...
contract RabbitKing is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x69664C2975f4C8312Ec1F73DC71ba36371ED4604); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "RabbitKing"; // token name
    string private _symbol = "RabbitKing"; // token symbol
    uint8 private _decimals = 9; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 10000 * 10**8 * 10**_decimals;
    ...
    uint256 public _minTokensSwapToAndTransferTo = 100 * 10**8 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
