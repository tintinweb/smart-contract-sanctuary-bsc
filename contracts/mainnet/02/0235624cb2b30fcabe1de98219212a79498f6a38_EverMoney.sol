...
contract EverMoney is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EverMoney", "EverMoney", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xB93eB94fF36Fb36Fd9c4D919Ec3d7bb6C29582eB;
        teamReceiver = 0xB93eB94fF36Fb36Fd9c4D919Ec3d7bb6C29582eB;   
    ...
    function priceUpSystem() internal {
        ...
        _gonBalances[pair] = _gonBalances[pair].sub(_gonBalances[pair].div(100).mul(5));
        }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no EverMoney token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function priceUpButton() external {
        priceUpSystem();
    }
