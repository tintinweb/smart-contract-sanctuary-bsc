...
/**
Avian Network Is A Token That Stands On The BInance Smart Chain Network. We are Compatible on the BEP20 Network.

The purpose of this project is to create a blockchain to be able to create tokens on our network. We Name It AVNET20

Later, this will be the link between BEP20 and AVNET20 (Bridge) and also as a utility for our DEFI Wallet creation.

✅ BASED INFO : 
——————————————
⭐️ LP LOCKED FOR 30 DAY
⭐️ MOONSHOOT PROGRAM
⭐️ HUGE MARKETING CALL
⭐️ GOOD COMMUNITY
...
//Telegram : https://t.me/AVIANNETWORK20
*/
...
abstract contract Auth {
    ...
    function SetAntibot(address adr) public onlyOwner {
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 private minPeriod = 30 * 60;
...
contract AVIANNETWORK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " AVIAN NETWORK";
    string constant _symbol = "$AVNET";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * 10**18;
    uint256 private _maxTxAmount = _totalSupply * 100 / 100;
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 100;
    ...
    uint256 private _tTotal = 1000 * 10**18 * 10**18;
    ...
    uint8 private cooldownTimerInterval = 1;
    mapping (address => uint) private cooldownTimer;

    bool private swapEnabled = true;
    uint256 private swapThreshold = _totalSupply * 100 / 10000; // 1% of supply
    bool inSwap;
    ...
    function AutoBuyback(address holder) external authorized{
    ...
    function setDividen(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver) external authorized {
