...
contract Sunzila is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sunzila";
    string private constant _symbol = "SUNZILA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xD956cfDBc1f9987604eA849C2EC4C359268726d2);
    address payable private _marketingAddress = payable(0xD956cfDBc1f9987604eA849C2EC4C359268726d2);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 9, "Redis cannot be more than 9.");
	    require(redisFeeOnSell < 95, "Redis cannot be more than 95.");
	    require(taxFeeOnBuy < 9, "Tax cannot be more than 9.");
	    require(taxFeeOnSell < 95, "Tax cannot be more than 95.");
