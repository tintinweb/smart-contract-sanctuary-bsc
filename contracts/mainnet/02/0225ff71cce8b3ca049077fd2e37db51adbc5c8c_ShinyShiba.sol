...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2472cD82A0A46880ba065f134038aD3aE7C843c5; // owner address
...
contract ShinyShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiny Shiba";
    string private _symbol = "Sshib"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x171a9e3293814F9D404959c6d819C2FB9aFc7d54); // Marketing Address
    address payable public teamWalletAddress = payable(0x45D2B937fA6AE97F873E9ab0817252EBBb89a37C); // Team Address
