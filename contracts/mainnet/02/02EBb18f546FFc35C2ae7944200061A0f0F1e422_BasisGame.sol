...
contract TokenBGMWrapper {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IERC20 public TokenBGM ; //Token
    ...
    function withdraw(uint256 amount) public {
        ...
        TokenBGM.safeTransfer(msg.sender, amount);
    }
}

contract BasisGame is TokenBGMWrapper {
	...
	constructor(address _TokenBGS, uint256 _Interval) TokenBGMWrapper(IERC20(_TokenBGS)) public{
	    TokenBGS = IERC20(_TokenBGS);

        InitRewards = 1000000000000000;   //0.001BGS
        Interval = _Interval;   //45 days，3888000 seconds

        Index = 0;

        //StartTime = 1655305200; /*2022-06-15 23:00:00*/
        StartTime = 1655046000; /*2022-06-12 23:00:00*/
    ...
    // stake visibility is public as overriding TokenBGMWrapper's stake() function
    function stake(uint256 amount) public
    { 
