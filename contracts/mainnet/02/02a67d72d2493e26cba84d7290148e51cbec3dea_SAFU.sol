...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6F2852c3BAD1145166273844D9fc2FD41b016b13;
...
contract SAFU is Context, IERC20, Ownable {
    ...
    string private _name = "Solabbit Inu";
    string private _symbol = "Solabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F2852c3BAD1145166273844D9fc2FD41b016b13);
    address payable public teamWalletAddress = payable(0x6F2852c3BAD1145166273844D9fc2FD41b016b13);
