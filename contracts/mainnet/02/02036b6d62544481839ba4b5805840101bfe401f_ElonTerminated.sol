...
contract ElonTerminated is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon Terminated"; // 
    string private constant _symbol = "ElonT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x319abce3E3a4F7F00b4C2F12173983F0AC032C2a;
