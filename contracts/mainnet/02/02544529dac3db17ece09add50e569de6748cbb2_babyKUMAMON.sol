...
contract babyKUMAMON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBe90733c9164a1A6dB037c1879648D5eDDb0Ee03;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "babyKUMAMON";
    string constant _symbol = "$babyKUMAMON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 490 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 490 / 10000; 
    uint256 public _maxWalletToken = ( _totalSupply * 490 ) / 10000;  
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xBe90733c9164a1A6dB037c1879648D5eDDb0Ee03;
