...
contract CHM is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x464342FE1259dD6D93bC761FFCEbfEAe7843Bc97;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1669896000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("CHM", "CHM") {
        ...
        excludeFromFees(0x56Df34281bC6d7C6EfAfbEeE97B310BE22Cd1BDB, true);
        excludeFromFees(0xA2db22f0B685bf838Cb99fbe6128E01bbdDD412E, true);
        excludeFromFees(0xbf427CD6ca9DAF727BCe65d7cbd3eD085f925416, true);
        _mint(owner(), 880000 * (10**18));
    }
        ...
        if(takeFee) {
            if(from == uniswapV2Pair){
                if(block.timestamp <= times.add(600)){
                    uint256 lpfees = amount.mul(10).div(100);
                ...
                if(block.timestamp <= times.add(600)){
                    uint256 lpfees = amount.mul(15).div(100);
        	        amount = amount.sub(lpfees);
                    super._transfer(from, address(this), lpfees);
                }else{
                    uint256 lpfees = amount.mul(5).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, _marketingWalletAddress, block.timestamp);
    }
}