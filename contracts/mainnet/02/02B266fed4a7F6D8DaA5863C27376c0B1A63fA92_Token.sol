...
contract Token is ERC20, Ownable {
    ...
    address payable public devWallet = payable(0x8E56e2E98C275c4f6DCf678CE24371c9Bf008Afb);
    address payable public marketingWallet = payable(0x4aF1dd0Bd97B37741083BAa3e12Bb1F0fb0B3657);
    address payable public buybackWallet = payable(0xBcDCC657c2138b52b62aE82cc5258860483466b1); 
    ...
    constructor() ERC20("MoonMoon Inu", "Mooni") {
        ...
        uint256 totalSupply = 1000000000000e18;
 
        buyMarketingFee = _buyMarketingFee;
        buydevFee = _buydevFee;
        buybuybackFee = _buybuybackFee;
        buyTotalFees = buyMarketingFee + buydevFee + buybuybackFee;
