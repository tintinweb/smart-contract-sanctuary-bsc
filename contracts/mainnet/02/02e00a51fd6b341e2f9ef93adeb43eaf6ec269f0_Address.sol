...
Welcome to EvaFoxU Of Tesla
   
   This is a community token. If you want to create a telegram I suggest to name it to @EvaFoxU Of Tesla
   ...
   I will renounce the ownership to burn addresses to transfer #EvaFoxU Of Tesla to the community, make sure it's 100% safe.

   I will add .55 BNB and all the left 10% total supply to the pool
   Can you make #EvaFoxU Of Tesla 10000X?  The deve team will join the first community
...
contract EvaFoxUOfTesla is Context, IERC20, Ownable {
    ...
    string private _name = "EvaFoxU Of Tesla";
    string private _symbol = "TEFU";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xdA5D253417d508d35d7053d36ffE97828e69F9F3, 'We can not exclude Uniswap router.');
