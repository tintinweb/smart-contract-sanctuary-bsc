...
Add this address to your wallet to see rewards
0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c

BTC 6.9 is the hottest new upgrade in DEFI.  Get your little hands around it before it gets to big for you.

https://t.me/BTC6POINT9
...
/* Token contract */
contract BTC6POINT9 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xaAb3332846737457a46f407eb6aF17c1F602eaC7;
    ...
    // Name and symbol
    string constant _name = "BTC 6.9";
    string constant _symbol = "BTC 6.9";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000000 / 100000000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 3000000 / 100000000; // 3% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 3000000 ) / 100000000; // 3% or 2m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 250 / 100000000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x754D1B24C7567b1edE27463C9F14c9fD3b962356;
