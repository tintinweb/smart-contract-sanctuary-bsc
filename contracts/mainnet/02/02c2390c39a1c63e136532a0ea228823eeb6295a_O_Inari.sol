...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0x15392783C9E6816e6BfDd1F981c9f6D96B21208f);
...
contract O_Inari is IBEP20, Ownable {
    ...
    string constant _name = unicode"Ō-Inari";
    string constant _symbol = "ONR";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 333_000_000 * (10**_decimals);
    uint256 public _maxWalletHoldingAmount = (_totalSupply * (3)) / (100);
    ...
    address public marketingFeeReceiver =
        address(0x32A14707A161BA0514d5DA4E2BD0fC3054937204);
    address public teamFeeReceiver =
        address(0x5726e18D82385A6Bd6fA592BE7174239F29736C2);
    ...
    constructor() {
        ...
        isWalletHoldingLimitExempt[teamFeeReceiver] = true;
        isWalletHoldingLimitExempt[address(this)] = true;
        isWalletHoldingLimitExempt[marketingFeeReceiver] = true;
    ...
    function setWalletHoldingLimit(uint256 amount) external onlyOwner {
        require(
            amount * 10**_decimals >= (300_000 * 10**_decimals),
