...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x357f5cdA7e0F45599C21a9270d91a14b25358b62; // owner address
...
contract BNBfreeze is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BNB Freeze";
    string private _symbol = unicode"BNBF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x357f5cdA7e0F45599C21a9270d91a14b25358b62); // Marketing Address
    address payable public teamWalletAddress = payable(0x357f5cdA7e0F45599C21a9270d91a14b25358b62); // Team Address
