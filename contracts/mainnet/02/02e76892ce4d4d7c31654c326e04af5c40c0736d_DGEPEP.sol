...
contract DGEPEP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Pepe";
    string private _symbol = "DGEPEP";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x9870D214640cc201882710DDc6F593E99a8F2250); // Marketing Address BSI
    address payable public BuyBackWallet = payable(0x6b3aB0CF594BCbF5718e188Fce8Bc6a8FF8205DF); // Team Address
