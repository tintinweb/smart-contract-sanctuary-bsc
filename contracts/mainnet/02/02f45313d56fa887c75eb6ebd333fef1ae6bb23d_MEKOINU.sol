...
contract MEKOINU is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 2;  // Liquidity Fee 4%
    uint256 private _buyMarketingFee = 7;  // Markting Fee 5%
    uint256 private _buyDevFee = 1;  // Dev Fee 1% 

    // 12% Sell Tax
    uint256 private _sellTaxFee = 0; // Reflection Fee 0%
    uint256 private _sellLiquidityFee = 2;  // Liquidity Fee 4%
    uint256 private _sellMarketingFee = 9;   // Markting Fee 8%
    uint256 private _sellDevFee = 1; // Dev Fee 3%
    ...
    constructor() {
        ...
        _maxTxAmount = 20000000000 * 10**_decimals; // 1% Of Total Supply
        _maxWalletBalance = 20000000000 * 10**_decimals; // 1% Of Total Supply 
        _marketingWalletAddress = 0x70d0bd5a3e6deF2f53C5cB133443025B3bbD58c3; // Marketing Wallet 
        _devWalletAddress = 0xC4c0830c069d2a55E892FB0f8D0202d485ee9810; // Dev Wallet 
