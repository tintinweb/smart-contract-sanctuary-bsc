...
//Telegram : https://t.me/SmartSearchContract
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB39307a37af54c4A40669B20B5425Ae48D5BC314; // owner address
...
contract SmartSearchContractBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Smart Search Contract Bot";
    string private _symbol = "SSC"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x863DfcAB86807cBF796e9Af06DA10F3AF17415Ea); // Marketing Address
    address payable public teamWalletAddress = payable(0x9C1396b1A3fDDd78ee904256E65b67Ad824ad327); // Team Address
