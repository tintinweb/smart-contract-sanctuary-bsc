...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf2E877986543f1542A14d17259FeF273d5210D7b; // owner address
...
contract Hyoreum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hyoreum";
    string private _symbol = "HOM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2E877986543f1542A14d17259FeF273d5210D7b); // Marketing Address
    address payable public teamWalletAddress = payable(0xf2E877986543f1542A14d17259FeF273d5210D7b); // Team Address
