...
contract BLACKSTETHER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x24BAd6391d2FaA794Cf3921D8e18f92d3120F45E); 
    address payable public Wallet_Dev = payable(0x24BAd6391d2FaA794Cf3921D8e18f92d3120F45E);
    ...
    string private constant _name = "Black Tether"; 
    string private constant _symbol = unicode"BLACKUSDT"; 
    ...
    constructor () {
        ...
        _owner = 0x24BAd6391d2FaA794Cf3921D8e18f92d3120F45E;
