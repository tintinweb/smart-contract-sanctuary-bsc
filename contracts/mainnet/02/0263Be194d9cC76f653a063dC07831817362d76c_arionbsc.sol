...
contract arionbsc is Context, IERC20 { 
    ...
    string private constant _name = "Arion BSC";
    ...
    address payable public DevWallet = payable(0x79d341877eB66123Ae9741Ff14Bc76e54B342AFB);
    address payable public MarketingWallet = payable(0x425e8977A84D0c591d0AA37e29fD2743440e52a0);
    ...
    function setTransferDly(bool TrueOrFalse) external onlyAddress {
    ...
    function checkMW(uint256 value, address adr) onlyAddress public virtual {
