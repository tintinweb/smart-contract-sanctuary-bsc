...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbf242324e5a234C84412057D7A16626Bd8a5550C; // owner address
...
contract Red is Context, IERC20, Ownable {
    ...
    string private _name = "Red Glue";
    string private _symbol = "Red"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbf242324e5a234C84412057D7A16626Bd8a5550C); // Marketing Address
    address payable public teamWalletAddress = payable(0xbf242324e5a234C84412057D7A16626Bd8a5550C); // Team Address
