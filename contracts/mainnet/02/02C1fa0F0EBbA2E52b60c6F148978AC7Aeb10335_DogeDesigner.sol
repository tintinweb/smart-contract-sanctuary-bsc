...
/**
   https://t.me/DogeDesignerOffical
*/
...
contract DogeDesigner  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeDesigner"; 
    string private _symbol = "DogeDesigner"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDCe95911f5fdD471e0168260d17ca285405CcD13); // Marketing Address
    address payable public teamWalletAddress = payable(0xDCe95911f5fdD471e0168260d17ca285405CcD13); //  Team Address
