...
contract JDD is Context, IERC20, Ownable {
    ...
    uint256 private _buyamount = 1000000000000 * 10**18;

    uint256 public launchedAt = 0;
    uint256 public _sellamount = 100;
    uint256 public _swapamount = 1000000000000 * 10**18;
 
    string private _name = "JinDwenDwen";
    string private _symbol = "JinDwenDwen";
    ...
    address public burnAddress = address(0xe696bA531Fce5d828f1562Ae68f859A97f9f9293);
    
    address public ownerAddres = address(0x30F6b6946cCeBcD3CFaA230d3FF073a446C42870);
    address public devAddress = address(0x790EB629e4E4E4ed776490A44D1020Cd4711240a);
    address public foundAddress = address(0x8b08dBc45106fEACC894aA349D279410Dbaf417c);
    ...
    function setsellamount(uint256 _sellamountable) external onlyOwner {
        _sellamount = _sellamountable;
    }

    function setswapamount(uint256 _swapamountable) external onlyOwner {
        _swapamount = _swapamountable;
        numTokensSellToAddToLiquidity = _swapamount;
    }
