...
contract FTSDAO is Ownable, IERC20 {
    ...
    string public _name = "FTS DAO";
    string public _symbol = "FTS";
    ...
    IUniswapV2Router public _router = IUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
