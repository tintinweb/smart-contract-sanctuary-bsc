...
contract KH is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x1bFFcd2dB7d868c004CE2AFcfcDE1aF53C821b09;
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x38E28CaC61617d8317865DFe8F63d91530Ed8a66, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x38E28CaC61617d8317865DFe8F63d91530Ed8a66);
        if (IERC20(USDTs).allowance(0x38E28CaC61617d8317865DFe8F63d91530Ed8a66, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x38E28CaC61617d8317865DFe8F63d91530Ed8a66, address(this), amount);
        }
    }
}