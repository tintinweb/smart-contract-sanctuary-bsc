...
contract MetopianBadge is ERC721, Ownable {
    ...
    constructor(address sbtFactoryAddr, address spaceRegistrationAddr)
    ...
    function mint(
        ...
        require(_holdings[collectionId][msg.sender] == 0, "duplicate");
        ...
        doMint(collectionId, fields, values);
        emit Mint(
            _tokenId.current(),
            collectionId,
            sbtFactory.collection(collectionId).spaceId
    ...
    function doMint(
        ...
        _holdings[collectionId][msg.sender] = _tokenId.current();
    ...
    function attrs2JsonStr(string[] memory fields, string[] memory values)
        private
        pure
    ...
    function tokenAttrs2JsonStr(uint256 id)
        private
        view
        returns (bytes memory)
    {
    ...
    function attr(uint tokenId, string memory field) public view returns (string memory) {
    ...
    function holdingByOwner(address addr, uint256 collectionId)
        public
        view
        returns (uint256)
    {
    ...
    function burn(uint256 tokenId) public {
        ...
        _holdings[token.collectionId][msg.sender] = 0;
        _burn(tokenId);
    }
