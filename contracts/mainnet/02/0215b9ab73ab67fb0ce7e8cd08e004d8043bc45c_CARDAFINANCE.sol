...
/**   
       ...
       Telegram: https://t.me/cardafinance
🐦 Twitter: https://https://twitter.com/CardaFinance
*/
...
contract CARDAFINANCE is Context, IERC20, Ownable {
    ...
    string private _name = "CARDA FINANCE";
    string private _symbol = "CARDA FINANCE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xEE473b8a1Ede456aeFf06B2d443C0f619D76af3c);
