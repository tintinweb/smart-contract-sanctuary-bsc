...
Telegram: https://t.me/blackrockdogeportal
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD57B18EC44769c797fE51054140a9DC4A5eb2239;
...
contract BLACKROCKDOGE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3.0000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10000000 * 10**9; //
    string private constant _name = "BLACKROCK DOGE"; // 
    string private constant _symbol = "BROGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xD57B18EC44769c797fE51054140a9DC4A5eb2239);
