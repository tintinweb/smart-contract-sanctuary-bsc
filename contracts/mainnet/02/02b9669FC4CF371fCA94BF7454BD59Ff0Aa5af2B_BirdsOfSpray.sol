...
contract BirdsOfSpray is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Birds of Spray";
    string constant _symbol = "BOSS";
    ...
    uint256 public _walletMax = 1000000 * (10 ** _decimals); //_totalSupply;
