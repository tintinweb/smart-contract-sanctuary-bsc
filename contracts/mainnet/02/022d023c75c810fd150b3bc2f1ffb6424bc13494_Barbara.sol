...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function Traunsee(address newOwner) external onlyOwner returns (bool) {
...
contract Barbara is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Barbara";    
    string public symbol = "BARBARA";
    uint8 public decimals = 9;   

    uint8 public _bonusFee;
    ...
    function dividedAdd(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
    ...
    function initialfee(uint256 newCoolWait) external onlyOwner {
        require(
    ...
    function dividedAdd(uint256 launchAt, uint256 dura) public view returns (bool){
