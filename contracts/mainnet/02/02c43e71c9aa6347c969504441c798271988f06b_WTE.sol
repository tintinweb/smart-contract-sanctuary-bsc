 ...
 */
contract WTE is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private _name = "WATCHN";
    string private _symbol = "WTE";
    ...
    address payable private _marketingAddress =
        payable(0xcC35b937290FF81DF75a334C6a43e912187fC242);
    address payable private _autoLiquidityReceiver =
        payable(0x1CcdC7cC3D97bE8c40947FeBE06Bb52c2189FddC);

    uint256 private _marketingDivFee = 2;
    uint256 private _systemDivFee = 3;
    ...
    function sendETHToFee(uint256 amount) private {
        _autoLiquidityReceiver.transfer(amount.div(_marketingDivFee));
        _marketingAddress.transfer(amount.div(_systemDivFee));
    }
