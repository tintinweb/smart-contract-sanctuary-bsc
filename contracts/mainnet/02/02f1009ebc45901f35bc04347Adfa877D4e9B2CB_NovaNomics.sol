...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19257152618a9485d24FC1601FB6db42e235bA9f; // owner address
...
contract NovaNomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NovaNomics";
    string private _symbol = "NOVANOMICS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52fA6477207A2cb75E1590debAA5f5a878560fd5); // Marketing Address
    address payable public teamWalletAddress = payable(0x19257152618a9485d24FC1601FB6db42e235bA9f); // Team Address
