...
contract TTTTCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7A5b32fB226f110F9c3Ac6CF559eEce5AA49A58D); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10  * 10**4 * 10**18; // 10 trillion, or 1% of total supply
