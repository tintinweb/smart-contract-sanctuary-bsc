...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7890F197A99c7573d96E650e6b29d097C1C8001; // owner address
...
contract ANNABELLE is Context, IERC20, Ownable {
    ...
    string private _name = "ANNABELLE";
    string private _symbol = "ABELL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x730F7C53A1eC4d2Bd04Ec74C3281ebE1D9B968E9); // Marketing Address
    address payable public teamWalletAddress = payable(0xa9248cB239945a44dAa946CFF4f8839AC34aBD21); // Team Address
