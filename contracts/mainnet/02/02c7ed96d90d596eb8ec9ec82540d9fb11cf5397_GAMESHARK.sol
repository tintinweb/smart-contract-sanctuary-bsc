...
contract GAMESHARK is Context, IERC20, Ownable {
    ...
    string private constant _name = "GAME SHARK"; //
    string private constant _symbol = "GS"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xFeB1421695Fc797fbfF0B3A8dc10882C7119739E ;
