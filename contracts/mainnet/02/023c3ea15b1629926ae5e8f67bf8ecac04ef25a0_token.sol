...
contract token is ERC20 {
    ...
    address private _marketWallet = address(0x489930B1d0D369F180caeF7E59429C9d18AA6506);
    address private _teamWallet = address(0xa94e2695E16aC614100C44eB96de68296376C895);

    //name,symbol
    string internal tokenName = "CZ";
    string internal tokenSymbol = "CZ";
    uint256 constant total  =  21000000 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair){     
                super._transfer(from, uniswapV2Pair, amount.div(100).mul(1));
                super._transfer(from, address(this), amount.div(100).mul(5));
                amount = amount.div(100).mul(94);//94%
