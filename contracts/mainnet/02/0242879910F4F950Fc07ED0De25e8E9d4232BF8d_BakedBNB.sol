...
contract BakedBNB is Ownable {
    ...
    uint256 public Dop = 2e20; // tvl to 5000BNB 
    ...
    function reinvest() public {
        ...
        if (lastHatch[msg.sender] + 600 <= block.timestamp) {
    ...
    function claimRewards() public {
        require(initialized);
        require(lastHatch[msg.sender] + 600 < block.timestamp, "You can do action every 24 hours");
