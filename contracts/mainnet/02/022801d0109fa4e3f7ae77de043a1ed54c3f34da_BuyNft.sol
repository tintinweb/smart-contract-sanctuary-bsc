...
contract BuyNft is Ownable {
    ...
    uint256 public level1_price = 50000 * 10**18;

    uint256 public level1_amount = 99999;
    ...
    function configsUm(uint256 _level1_price) public onlyOwner {
        level1_price = _level1_price;
    }

    function buyNfts(uint256 quantityEggs) public returns (bool) {
        uint256 pricePay;
