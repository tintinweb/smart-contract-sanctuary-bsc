...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 4800;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x3dc782e97Db55A81b280216D1E9fA242218E3628;
...
contract UAlliance is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3dc782e97Db55A81b280216D1E9fA242218E3628),
