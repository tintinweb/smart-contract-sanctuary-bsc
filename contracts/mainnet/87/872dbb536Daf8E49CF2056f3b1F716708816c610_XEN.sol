...
library SafeMath {
 ...
 contract XEN is IERC20, Ownable {
    ...
    constructor (
        ...
        //bnb分红最低数
        holderRewardCondition = 20000000000;
        _tTotal = total;
        ...
        //改钱包
        MarketingAddress = 0xFf971DfEF66d4f32ED02a15C22C072DC8547cBA0;
        ...
        _totalBuyFee = _buyMarketingFee.add(_buyLPDividendFee);
        _totalSellFee =_sellMarketingFee.add(_sellLPDividendFee);
    ...
    function swapTokenForETH(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 MarketingAmount = balance.mul(6).div(10);
    ...
    function setBuyFee(uint256 buyMarketingFee,uint256 buyLPDividendFee) external onlyOwner {
        _buyMarketingFee=buyMarketingFee;
        _buyLPDividendFee=buyLPDividendFee;
        _totalBuyFee = _buyMarketingFee.add(_buyLPDividendFee);
    }

    function setSellFee(uint256 sellMarketingFee,uint256 sellLPDividendFee) external onlyOwner {
