...
/**
🐶💎Shih-Tzu Inu ,Considered a lucky charm for Chinese tradition, 
Brings to market the innovation of Memecoins, 50% of Shih-Tzu token burned 
💥 Buy 0% and Sell 2%🎁 SAFU, KYC and AUDIT 
✅ Future partnership Coming Soon🎉Ama's on major channels, like Gollums , Venom, Caesar and WhaleCoinTalk 🎉 
Shih-tzu Inu will seek his space in the meme coin market, and promises to surprise everyone! 🌪A Great Safe Memecoin, Contract Renounced 
🐶🐶 The New Gem💎💎💎
Shih Tzu Inu
*/
...
contract ShihTzuInu is ShihTzuDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShihTzuTeam;
    address private CharityShihTzu;
    ...
    string public override name = "Shih Tzu Inu";
    string public override symbol = "Shih-Tzu";
    ...
    constructor(uint totalSupplyValue, address ShihTzuTeamAddress, address CharityShihTzuAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShihTzuTeam = ShihTzuTeamAddress;
        CharityShihTzu = CharityShihTzuAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShihTzuTeam] =  totalSupply * 45 / 100;
        balances[CharityShihTzu] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's ShihTzuTeam pot
