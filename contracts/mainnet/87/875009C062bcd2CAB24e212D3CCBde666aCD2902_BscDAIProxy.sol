...
contract INSURANCE {
    ...
    address private tokenAddr = 0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3; // BSC DAI Contract Address
    IERC20 public token;
...
contract BscDAIProxy {
    ...
    uint constant public            INVEST_MIN_AMOUNT               = 10 ether;             // 10 DAI
    ...
    constructor() {
        ...
        WALLET_PROJECT = payable(0xa764e830aB4d271aB320d3f5eFb1FBc631743e5B);
