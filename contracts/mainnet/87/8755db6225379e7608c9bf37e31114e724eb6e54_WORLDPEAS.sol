...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xA4a6E677ef0f3A600B164E8b076b4EEC12cFaDc0;
...
contract WORLDPEAS is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"WORLD PEAS"; 
    string private constant _symbol = unicode"$WORLDPEAS"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xA4a6E677ef0f3A600B164E8b076b4EEC12cFaDc0), BNB_Tot);
            }
