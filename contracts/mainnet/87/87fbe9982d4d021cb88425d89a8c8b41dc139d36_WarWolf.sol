...
contract WarWolf is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCD5894EE1541B66Ed09BA2AcB47cB2CFEc8E49bD); // Marketing Address
    ...
    string private _name = "WarWolf";
    string private _symbol = "ZWolf";
