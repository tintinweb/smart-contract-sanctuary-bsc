...
contract Never is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0x28478A2e8ebB02C881a96C328846de6FF931c217; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x28478A2e8ebB02C881a96C328846de6FF931c217; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x28478A2e8ebB02C881a96C328846de6FF931c217)] = true; //uniswap router liquidity
