...
contract GalaRisk is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x48897D7CA1cc7a5567a73d717163C5C8FCa0cA11); 
    address payable public Wallet_Dev = payable(0xB25fECf0bA29A2B39F612e89A45aB32F681C712B);
    ...
    string private constant _name = "Gala Risk"; 
    string private constant _symbol = unicode"GALARISK"; 
    ...
    constructor () {
        ...
        _owner = 0x48897D7CA1cc7a5567a73d717163C5C8FCa0cA11;
