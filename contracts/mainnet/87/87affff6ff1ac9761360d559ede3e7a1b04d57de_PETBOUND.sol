...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract PETBOUND is Context , IERC20, Ownable {
    ...
    uint256 public _devFee = 5;  // 5% to project development and marketing
    address public devWallet = 0x7988440C40742E2B60aE786796d27F9B7aF7BB0D; // development wallet
    ...
    uint256 public _maxTxAmount = 10 * 10**7 * 10**7; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**7 * 10**7;
    uint256 public _maxWalletToken = 20 * 10**7 * 10**7; //2% of total supply
