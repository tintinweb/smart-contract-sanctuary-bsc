...
contract PowerInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Power Inu";
    string private constant _symbol = unicode"POINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 public _TxCount = 0;
    uint256 private _tTotal = 1* 10**11 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xcf23618a9c90D89d17ee45fB68Fab2070dD75ECD);
    address payable public MarketingWallet = payable(0x1FBEe2Aa733e87a3B47E046D3c344d560Be1EcdA);
