...
contract STRUGGLENETWORK is Context, IERC20, Ownable {
    ...
    string private _name = "STRUGGLE NETWORK";
    string private _symbol = "STRUGGLE NETWORK";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xA03FB16b21C3540AcF398Dba75166394B25a17Ed);
