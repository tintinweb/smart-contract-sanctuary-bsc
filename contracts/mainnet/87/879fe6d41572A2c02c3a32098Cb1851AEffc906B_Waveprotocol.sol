...
contract Waveprotocol is IBEP20, Auth {
    using SafeMath for uint256;

    event TradingEnabled(uint256 startDate);

    address constant WBNB = 0x3C12010Cb0388f894Ab3D526e8C2fA10Aa1dB6da; //Mainnet BSC :0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c // Testnet BSC: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd // ETH Mainnet: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D // ETH Testnet: 0xc778417E063141139Fce010982780140Aa0cD5Ab
    address constant DEAD = 0x000000000000000000000000000000000000dEaD; 
    address constant ZERO = 0x0000000000000000000000000000000000000000;

    string private constant _name = "Waveprotocol";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 1,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 1,000,000
    ...
    address private devFeeReceiver = 0x3C12010Cb0388f894Ab3D526e8C2fA10Aa1dB6da;
