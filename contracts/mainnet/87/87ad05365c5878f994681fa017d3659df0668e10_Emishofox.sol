...
/*
Emishofox | #1 dex in the entire crypto space

$emfox
 will be an exchange on the network. Dex order book without liquidity so you can launch memecoin without liquidity and only trade through order book.

✅ Fixed memecoin space from dump, slippage, bad price impact due to liquidity error
✅It also stops rugs from happening as there won't be any liquidity to begin with so rugs won't be a problem to deal with anymore
✅ It will change the space

🔥 The goal is to integrate these berylbit, bsc and ethereum networks and keep them cross-chain 🔥

📲 : https://t.me/Emishofox
*/
...
contract Emishofox is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Emishofox";
    string private _symbol = "$EFOX";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x7aF42FbCCBbea77e91d4B194932371265Cf91796;
    address public developerWallet = 0x7aF42FbCCBbea77e91d4B194932371265Cf91796;
