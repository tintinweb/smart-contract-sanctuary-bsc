...
/**
Tomb     TOMB 
https://sites.google.com/view/tombcoin
*/
...
contract Tomb is TombDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TombTeam;
    address private CharityTomb;
    ...
    string public override name = "Tomb";
    string public override symbol = "TOMB";
    ...
    constructor(uint totalSupplyValue, address TombTeamAddress, address CharityTombAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TombTeam = TombTeamAddress;
        CharityTomb = CharityTombAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TombTeam] =  totalSupply * 5 / 100;
        balances[CharityTomb] = totalSupply * 5 / 100;
    ...
    // Get the address of the token's TombTeam pot
