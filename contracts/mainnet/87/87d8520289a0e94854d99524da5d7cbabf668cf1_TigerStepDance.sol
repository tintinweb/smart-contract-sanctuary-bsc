...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // WBNB BEP20
...
contract TigerStepDance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tiger Step Dance";
    string constant _symbol = "TSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 99) / 1; 
	uint256 public _maxWalletToken = ( _totalSupply * 99 ) / 1;
