...
contract LUNCX1000  is IBEP20, Auth {
    ...
    string constant _name = "LUNCX1000";
    string constant _symbol = "LUNCX1000";
    ...
    address private marketingFeeReceiver = 0xCE1B13D43A99AD719d8A0FFb03B293ce2b07b666;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdevelopment;


        if (balanceBNB >= 50000000000000000){
        
            amountBNBdevelopment = balanceBNB*20/100;
            amountBNBmarketing = balanceBNB - amountBNBdevelopment;
