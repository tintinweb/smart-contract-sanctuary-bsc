...
contract BurnedFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Burned Floki";
    string private _symbol = "bFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDF76dB72Ffd555Ec638E2284D3143F02D5a2a23f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xDF76dB72Ffd555Ec638E2284D3143F02D5a2a23f); // BuyBack Address
