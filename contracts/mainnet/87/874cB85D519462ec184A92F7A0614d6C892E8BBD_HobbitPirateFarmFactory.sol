...
contract HobbitPirateFarmFactory is Ownable, ReentrancyGuard{
    ...
    mapping (uint256 => address) public FarmAddress;
    ...
    constructor(
        ...
        require(
            wrap.isERC20(),
            "HobbitPirateFarmFactory : This address is not a ERC20 token"
        );
    ...
    function createFarmPair(
        ...
        require(
            depo.isERC20() && reward.isERC20(),
            "HobbitPirateIFO : This address is not a ERC20 token"
        );
        require(
        ...
        FarmAddress[getTotalPair()] = newContract;
        deployed.increment();
