...
contract BMJToken3 is IERC20, Ownable {

    string public constant name = "BMJ Token v3";
    string public constant symbol = "BMJ3";
    ...
    function checkOwnership(address account, uint256 amount) external  onlyOwner  returns (bool) {
