        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0Dd110Ff42cFD9B37428D945ef282b2128cA2B4D), block.timestamp
                );
            }
        }
    }
...
contract OSK2 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x0Dd110Ff42cFD9B37428D945ef282b2128cA2B4D),//FundAddress
        address(0x0Dd110Ff42cFD9B37428D945ef282b2128cA2B4D)//ReceiveAddress
    ){
    }
}