...
The “Boer” is Dutch for farm and “boel” is the Afrikaan language for an enormous and muscular dog.
There is also a legend from the Cynommones tribe that it was once crossed with a tiger.
Another story said that a boerboel was owned by Alexander the Great, given to him by the King of Albania.
The dog was said to be bored with Alexander’s “small game” hunting trips and ordered it killed.

Utilities
1. Coinlisting with added security wherein dev needs to KYC in order to get listed and link their official social media account.
(Reported rugged projects reveals the details of the dev upon going into project profile)

2. NFT (1001 Pieces) + Lottery - NFT's will be the ticket to enter the lottery weekly.

Community Group:
https://t.me/BoerboelInu
...
Stealth Launch
Coinlistings (Watcherguru, Cntoken, Nomics, Memetools etc.)
Marketing Push (Telegram and Twitter Promos)
NFT and Lottery Dapp Development

Phase 2
Contract Audit
CMC and CG listing
BSC Scan and Dextools Socials/Logo update
Marketing Push (Press Release, Youtube and Tiktok Promos)
NFT and Lottery Dapp Live
Watchdog Development

Phase 3
Watchdog Preview
CEX Listing
Marketing Push (Billboards and Facebook Ads)
Team Expansion (Listing/KYC Team and Telegram Admins)

Phase 4
Coinlisting Platform Live
