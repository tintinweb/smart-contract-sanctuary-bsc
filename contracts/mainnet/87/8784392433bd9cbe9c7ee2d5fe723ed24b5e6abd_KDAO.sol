...
contract KDAO is KDAODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private KDAOTeam;
    address private CharityKDAO;
    ...
    string public override name = "KarmaDao";
    string public override symbol = "KDAO";
    ...
    constructor(uint totalSupplyValue, address KDAOTeamAddress, address CharityKDAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        KDAOTeam = KDAOTeamAddress;
        CharityKDAO = CharityKDAOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[KDAOTeam] =  totalSupply * 4 / 100;
        balances[CharityKDAO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KDAOTeam pot
