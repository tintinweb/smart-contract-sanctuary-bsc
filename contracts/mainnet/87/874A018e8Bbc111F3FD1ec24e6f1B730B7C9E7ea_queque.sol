...
contract queque is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "queque";
    string private _symbol = "QUE";
    ...
    function Dividedtoken(uint256 share, uint256 dividendsPerShare) internal pure returns (uint256) {
   ...
   function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
    ...
    function rechargefee() public view returns (uint256) {
