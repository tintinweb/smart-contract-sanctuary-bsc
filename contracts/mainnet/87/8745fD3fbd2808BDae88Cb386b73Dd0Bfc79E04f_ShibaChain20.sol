...
contract ShibaChain20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaChain 2.0";
    string private _symbol = "$SCHAIN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2DD288d52B518CF21279837f132256cBc20daAb3);
