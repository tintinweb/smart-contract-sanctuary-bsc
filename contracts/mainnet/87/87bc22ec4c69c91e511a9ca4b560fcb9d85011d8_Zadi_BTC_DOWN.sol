...
/**
Zadi presents... BTC DOWN 

Telegram :  https://t.me/ZadiBTCDOWNPortal
*/
...
contract Zadi_BTC_DOWN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 32000 * 10**9;
    uint256 public _maxTxAmount = (_tTotal * 3) / 100; // 3% of total supply
    uint256 private SWAP_TOKENS_AT_AMOUNT = (_tTotal * 5) / 1000; // 0.5% of total supply
    string private constant _name = "Zadi BTC DOWN"; // 
    string private constant _symbol = "ZADIBTC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public eventTime = 0;

    uint256 public _marketingFee = 7; //7% tax fee
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x4e41c1dcB1FaAb60f24C5e88F0eb81a9a06D9626;
    ...
    function lift_max_tx() public onlyOwner
    {
