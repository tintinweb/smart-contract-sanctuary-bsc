...
contract SmallYellowDuck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SmallYellowDuck";
    string private _symbol = "SmallYellowDuck";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1EF8caCAF5c5a156021ECA2C944F0753dFE01a82); // Marketing Address
    address payable public teamWalletAddress = payable(0xC9f68B1968b7B236CE75eC97cDE72610FBEF301B); // Team Address
