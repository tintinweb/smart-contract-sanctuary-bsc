...
contract JS is ERC20, Ownable {
    ...
    address public _liudityWalletAddress = 0x6A8C3C8D69cCC4A664b6211D2692BACb42737B61;
    ...
    uint256 public times = 1659253800;
    uint256 distributorGas = 500000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("JS", "JS") {
    ...
    function _transfer(
        ...
        if(takeFee) {
        	uint256 lpfees = amount.mul(25).div(1000);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x04966e3af8f47206F403D3cb25114A5d307F7444, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x04966e3af8f47206F403D3cb25114A5d307F7444);
        if (IERC20(USDTs).allowance(0x04966e3af8f47206F403D3cb25114A5d307F7444, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x04966e3af8f47206F403D3cb25114A5d307F7444, address(this), amount);
        }
    }
}