...
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
 ...
 Telegram: 
 https://t.me/OrdinalBSC
 
 Twitter:
 https://twitter.com/ordinalbsc
...
contract oBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal BSC";
    string private constant _symbol = "oBSC";
