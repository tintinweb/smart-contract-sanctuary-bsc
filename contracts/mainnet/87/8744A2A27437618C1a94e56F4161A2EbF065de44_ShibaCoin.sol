...
abstract contract Ownable {
    ...
    contract ShibaCoin is Ownable, IBEP20{
    ...
    uint public MaxWalletDenominator=25;
    ...
    uint constant  InitialSupply=10**21*10**_decimals;
    ...
    function symbol() external pure override returns (string memory){return "PINU";}
    function name() external pure override returns (string memory){return "Peace Inu";}
