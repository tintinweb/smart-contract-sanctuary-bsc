...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6FE05e19b338914570627265bD10c9C703740eaC; // owner address
...
contract one is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6FE05e19b338914570627265bD10c9C703740eaC); // Marketing Address
    address payable public teamWalletAddress = payable(0x6FE05e19b338914570627265bD10c9C703740eaC); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = (_totalSupply * 2 / 100) * 10**_decimals; 
