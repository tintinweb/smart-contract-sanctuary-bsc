...
contract SPF is Context, IERC20, Ownable {
    ...
    string private _name = "TV2SPF";
    string private _symbol = "TV2SPF";
    ...
    address public developerAddress = address(0xF83447c565602135cd0907484E58E9a223d301D0);
    ...
    constructor() public {
        ...
        _balances[address(0x1AF958293A443B73c75FBD87bE6dfd7c713d375E)] = 490000 * 10**18;
        _balances[address(0x5dD3f2998c9C8CAfB239347BdE9d94ec7bA43341)] =  10000 * 10**18;

        emit Transfer(address(0), address(0x1AF958293A443B73c75FBD87bE6dfd7c713d375E), 490000 * 10**18);
        emit Transfer(address(0), address(0x5dD3f2998c9C8CAfB239347BdE9d94ec7bA43341),  10000 * 10**18);

        doAddKol(address(0x4A3672D9acDd25685B10B22151cf64Ea8f7ba2Dc));
    }
