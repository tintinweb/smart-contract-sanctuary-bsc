...
contract GBOX is ERC20Interface, Owned {
    ...
    address public supe_dao = address(0xf0CC13549403CF01Fe2654B285A7e685ff9b1d52);
    address public treasury = address(0x2641bb0820cB5D844877604D85730aFD410Bf730);
    address public supe_token = address(0xb972C4027818223BB7b9399b3cA3cA58186e1590);
    ...
    IUniswapV2Factory public swapFactory = IUniswapV2Factory(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function _swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if(extra_enable){
            _swapETHForSUPE(toTreasury, supe_dao);
        }else{
