...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    uint8 public _liquidityFee = 158;

    uint8 public _previousRewardFee = 23;
    address ZERO = 0x0000000000000000000000000000000000000000;

    constructor () {}   
    
   
    function called(address shareholder) internal returns (bool) {}
...
contract fiercecat is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'fiercecat';
