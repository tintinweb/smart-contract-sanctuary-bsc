...
// https://t.me/TheTacticsofMistake
...
contract TheTacticsofMistake is Context, IBEP20, Ownable {
    ...
    string public _name = "The Tactics of Mistake"; // token name
    string public _symbol = "TTOM"; // token ticker
