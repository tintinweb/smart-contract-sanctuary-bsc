...
contract DefiStar is Context, IERC20, Ownable {
    ...
    string private _symbol = "DefiStar";
    ...
    address public ownerAddres = address(0xe42dDFed15436C21b74303bcEC01C747c09380b6);
    address public devAddress = address(0x459FBc4617c8fDF5038F3237Cba2bC34eF37b897);
    address public foundAddress = address(0xFAB77345058C6AeF37AeA7E85d4468191e6A2E9E);
