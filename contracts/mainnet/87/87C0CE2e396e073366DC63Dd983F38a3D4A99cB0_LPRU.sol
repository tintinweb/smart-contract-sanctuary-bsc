...
contract LPRU is IERC20, Ownable {
    ...
    address private fundAddress = 0x7678bC3835814cFc3e26460fcffB450B90111111;
    address private devAddress = 0xb6667bA52ceb9b58Edd9caA9447C7B9ff1000000;
    address private receiveAddress = 0xb6667bA52ceb9b58Edd9caA9447C7B9ff1000000;

    string private _name = "LP Receive Usdt";
    string private _symbol = "LPRU";
    ...
    uint256 public lpLimitTime = 1664603765;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isSell) {
                uint256 destroyAmount = (tAmount * 0) / 100;
                if (destroyAmount > 0) {
            ...
            uint256 swapAmount = (tAmount * 0) / 100;
            if (swapAmount > 0) {
    ...
    function claimBalance() external isAuth {
    ...
    function addLpProvider(address _target) external onlyOwner {
