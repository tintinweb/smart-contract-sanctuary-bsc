...
library Address{
 ...
 contract DestackingStarship is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf5F202D6fbd6567fd048330fAc3590EE6a634af2;
    address public donationWallet = 0xf5F202D6fbd6567fd048330fAc3590EE6a634af2;

    string private constant _name = "Destacking Starship";
    string private constant _symbol = "DestackingStarship";
    ...
    Taxes public taxes = Taxes(0, 13, 1, 0);
    Taxes public sellTaxes = Taxes(0, 14, 1, 0);
