...
// Samart Contract Developers - CRYPTOZONIC //
//                              - @rezolenz //
//   Contact us at [email protected] //

//*************************************************//

//For more infromation, visit https://beepoapp.net //

// SPDX-License-Identifier: MIT
pragma solidity >=0.8.10 <0.8.17;
...
abstract contract ERC20Capped is ERC20 {
    ...
    constructor(uint256 cap_) {
        require(cap_ > 20000000, "ERC20Capped: cap is 20000000");
        _cap = cap_;
    }
...
contract BeepoToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    ...
    constructor()
        ERC20("Beepo Token", "BEEP")
        ERC20Permit("Beepo Token")
    {
...
//------------------FeeManagement_1.0------------------//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy <= 3, "Marketing fee on sell cannot be more than 3%");
