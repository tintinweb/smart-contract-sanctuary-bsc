...
Telegram : https://t.me/MuuBoss
Website : https://muuboss.io/
...
contract MuuBoss is Context, IERC20, Ownable {
    ...
    string private constant _name = "Muu Boss";
    string private constant _symbol = "MUUBOSS ";
    ...
    address public marketingWallet = address(0x723223353dFef55bCD2CBa6069Fd8bc139241650);
    ...
    function setMaxTxPercent(uint256 newMaxTxPercent) public onlyOwner {
        require(newMaxTxPercent >= 100, "MaxTx atleast 1% or higher");
    ...
    function setMaxWalletPercent(uint256 newMaxWalletPercent) public onlyOwner {
        require(newMaxWalletPercent >= 100, "MaxWallet atleast 1% or higher");
