...
contract GITOKEN is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("GITOKEN", "GIT", 18) {
    uint256 totalTokens = 600000000 * 10**uint256(decimals());
    _mint(msg.sender, totalTokens);
    sellTax = 0;
    buyTax = 0;
    transferTax = 0;
    tradeCooldown = 40;
    marketingPool = 0xf40D1CCe3737D8F0E32bE807a009246DBD0DF7A8;
  }
