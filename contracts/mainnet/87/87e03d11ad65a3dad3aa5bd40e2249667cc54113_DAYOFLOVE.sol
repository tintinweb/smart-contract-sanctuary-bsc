...
contract DAYOFLOVE is ERC20Detailed, Ownable {
    ...
    string public _name = "DAYOFLOVE";
    string public _symbol = "DOL";
    ...
    uint256 public consensusFundFee = 30; 
    uint256 public daoFee = 20;
    ...
    constructor(uint256 _startTradingTime) ERC20Detailed(_name,_symbol, uint8(DECIMALS)) Ownable() {
        ...
        _totalSupply = 666000000*(10**DECIMALS);
        TOTAL_GONS =
