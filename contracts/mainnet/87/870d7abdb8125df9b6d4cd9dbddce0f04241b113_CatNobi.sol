...
contract CatNobi is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CATN"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x34AbB9762eD7A61671102652858AB08E576d7A2A;
