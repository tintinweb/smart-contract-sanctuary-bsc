...
contract bananamoon is bananamoonDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private bananamoonTeam;
    address private Charitybananamoon;
    ...
    string public override name = "bananamoon";
    string public override symbol = "bananamoon";
    ...
    constructor(uint totalSupplyValue, address bananamoonTeamAddress, address CharitybananamoonAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        bananamoonTeam = bananamoonTeamAddress;
        Charitybananamoon = CharitybananamoonAddress;
        
        // split the tokens according to agreed upon percentages
        balances[bananamoonTeam] =  totalSupply * 4 / 100;
        balances[Charitybananamoon] = totalSupply * 4 / 100;
