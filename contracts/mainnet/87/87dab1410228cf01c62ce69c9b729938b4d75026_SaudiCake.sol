...
contract SaudiCake is Context, IERC20, Ownable {
    ...
    string private _name = "Saudi Cake";
    string private _symbol = "SACAKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3d8Bc957358b2B62704b07afD2A229add4284F2f);
    address payable public BuyBackWalletAddress = payable(0x3d8Bc957358b2B62704b07afD2A229add4284F2f);
