...
contract TEST2 is IERC20, Context, Ownable, ReentrancyGuard {
   ...
   if(!isDividendExempt[spender]){ try distributor.setShare(spender, _balances[spender]) {} catch {} }
   ...
   /** Sends Tokens to the buyer Address */
    ...
    function _sell(
        ...
        if(!isDividendExempt[seller]){ try distributor.setShare(seller, _balances[seller]) {} catch {} }
