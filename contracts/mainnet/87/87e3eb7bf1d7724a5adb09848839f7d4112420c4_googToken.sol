...
contract googToken is IERC20, Ownable {
    ...
    address public marketingWalletAddr = 0x8e115f2CD0dACd9ddbA9b20D15Eb42a69cCb68fb;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(
        ...
        emit Transfer(sender, address(0), tAmount.div(10000).mul(_burnFee));
    }

    function _takeMarktingFee(address sender,uint256 tAmount) private {
        if (_marketingFee == 0 && _cakeFee == 0) return;
        _tOwned[address(this)] = _tOwned[address(this)].add(tAmount);
        emit Transfer(sender, marketingWalletAddr, tAmount.div(10000).mul(_marketingFee));
    }
    ...
    function _transferStandard(
        ...
        _takeMarktingFee(sender, tAmount.div(10000).mul(_marketingFee.add(_cakeFee)));
        _takeInviterFee(sender, recipient, tAmount);
       
        uint256 recipientRate = 10000 - _burnFee -_marketingFee - _cakeFee - _inviterFee;
