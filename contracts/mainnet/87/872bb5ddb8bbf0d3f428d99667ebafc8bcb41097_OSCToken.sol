...
contract ERC20 is Context,IERC20,Ownable{
    ...
    address public addLiquidityPool=0xCf0c71A7c7532f14E493560F19472F642Ed5b69F;
    ...
    function getReward(address account) public view returns (uint256) {
        ...
        return
            _balances[account].mul(SPY).div(10000).mul(
...
contract OSCToken is ERC20 {
  ...
  using Address for address;
  using SafeMath for uint;
  constructor () public ERC20("OSCtest Token", "OSCtest", 18,10000000*10**18) {
