...
contract APCStake is Initializable,OwnableUpgradeable,ReentrancyGuardUpgradeable{
  ...
  function stake(uint lpAmount) public {
    ...
    userDeposits[msg.sender].push(Deposit(msg.sender,lpAmount,amountAPC,amountUSDT,0,block.timestamp,block.timestamp,0,0));
  ...
  function exit() public {
    for(uint i=0;i < userDeposits[msg.sender].length;i++){
      ...
      userDeposits[msg.sender][i].exitAmount = userDeposits[msg.sender][i].amount;
