...
contract  RabbitBaby is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YYES";
    string private _symbol = "YYES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7B128De2E0308811e6Ff3679b63960B276173a71);
    address payable public teamWalletAddress = payable(0xB2541B480B12B3F6C34820c62980Ba77125a24eC);
    ...
    uint256 public _walletMax =     600 * 10**_decimals;
