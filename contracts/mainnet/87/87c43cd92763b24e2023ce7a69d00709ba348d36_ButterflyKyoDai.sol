...
contract ButterflyKyoDai is IERC20, Ownable {
    ...
    string _name = "ButterflyKyoDai";
    string _symbol = "&#129419";
    uint8 constant _decimals = 11;

    uint256 _totalSupply = 10 ** 11 * (10 ** _decimals);   // 1,000,000,000 SUPPLY
