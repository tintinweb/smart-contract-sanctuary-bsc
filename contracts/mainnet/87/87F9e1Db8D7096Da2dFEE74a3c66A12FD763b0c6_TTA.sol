...
contract TTA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "The Twitter Algorithm";
    string constant _symbol = "TTA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x9323AA606732d4f5a0a17AEeb75916980eF6B3d7;
