...
contract XLP is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "XLP";
  string private _name = "XLP GAZA COIN";
  ...
  function _burn(address _to, uint256 _amount) onlyOwner public returns (bool){
