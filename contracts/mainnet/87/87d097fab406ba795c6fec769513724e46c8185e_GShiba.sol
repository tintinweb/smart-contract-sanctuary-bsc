...
contract GShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD2A4946f6C291Adb84cc724C086830f835C93a2f); 
    address payable private Wallet_Dev = payable(0xD2A4946f6C291Adb84cc724C086830f835C93a2f);
    ...
    string private constant _name = "Giant Shiba "; 
    string private constant _symbol = unicode"GSHIBA"; 
    ...
    constructor () {
        ...
        _owner = 0xD2A4946f6C291Adb84cc724C086830f835C93a2f;
