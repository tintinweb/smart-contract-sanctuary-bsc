...
contract ZonoIco is Ownable {
    ...
    uint256 private _startDate = 1666928000; // When to start ICO - Oct 6, 2022 22:00:00 UTC
    uint256 private _endDate = 1668047416; // When to end ICO - Oct 12, 2022 22:00:00 UTC
    uint256 private _claimDate = 1668054616; // When to claim ICO - Oct 13, 2022 00:00:00 UTC

    uint256 private _hardcap = 2 ether; // hard cap
    uint256 private _softcap = 1 ether; // softcap
    uint256 private _icoPrice = 0.0005 ether; // token price
    uint256 private _minPerUser = 0.001 ether; // min amount per user
    uint256 private _maxPerUser = 0.5 ether; // max amount per user
