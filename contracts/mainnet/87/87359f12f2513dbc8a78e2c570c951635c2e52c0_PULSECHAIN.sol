...
contract PULSECHAIN is Context, IERC20, Ownable {
    ...
    string private _name = "PULSE CHAIN";
    string private _symbol = "$PC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9588d699158e53Ed9B65ac8942ecf4Ce36362414);
    address payable public teamWalletAddress = payable(0x9588d699158e53Ed9B65ac8942ecf4Ce36362414);
