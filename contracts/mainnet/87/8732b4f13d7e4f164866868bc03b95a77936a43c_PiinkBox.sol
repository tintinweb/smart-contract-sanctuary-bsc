...
/**
 *Telegram https://www.t.me/piinkboxportal
 *Website https://www.piinkbox.net
 *Utility https://www.piinkbox.com
 *Twitter https://twitter.com/piink_box
*/
...
contract PiinkBox is ERC20, Ownable {
    ...
    uint256 public  TeamMarketingFeeOnBuy;
    uint256 public  TeamMarketingFeeOnSell;
    ...
    event TeamMarketingWalletChanged(address TeamMarketingWallet);
    ...
    event SendTeamMarketing(uint256 bnbSend);
    ...
    constructor() ERC20("PiinkBox", "PIINKBOX") 
    {
        rewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

        address newOwner = 0x9046C2439566D3f4af8d34eE04b9BFB95c8D079b;
        ...
        TeamMarketingFeeOnBuy   = 1;
        TeamMarketingFeeOnSell  = 1;
        ...
        TeamMarketingWallet = 0x78f104d47c7F8776D27857E547965566321e6693;
        TreasuryWallet = 0x7b76FD6eA82308700F1250C7041B1BC52BD015dd;
    ...
    function changeTeamMarketingWallet(address _TeamMarketingWallet) external onlyOwner {
        require(_TeamMarketingWallet != TeamMarketingWallet, "TeamMarketing wallet is already that address");
        require(_TeamMarketingWallet != address(0), "TeamMarketing wallet cannot be the zero address");
        TeamMarketingWallet = _TeamMarketingWallet;
        emit TeamMarketingWalletChanged(TeamMarketingWallet);
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 TeamMarketingShare = TeamMarketingFeeOnBuy + TeamMarketingFeeOnSell;
            uint256 rewardShare    = rewardFeeOnBuy    + rewardFeeOnSell;
            uint256 TreasuryShare   = TreasuryFeeOnBuy   + TreasuryFeeOnSell;
            uint256 totalShare = liquidityShare + TeamMarketingShare + rewardShare + TreasuryShare ;
            ...
            uint256 bnbShare = TeamMarketingShare + rewardShare + TreasuryShare;
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(TeamMarketingShare > 0) {
                    uint256 TeamMarketingBNB = newBalance * TeamMarketingShare / bnbShare;
                    payable(TeamMarketingWallet).sendValue(TeamMarketingBNB);
                    emit SendTeamMarketing(TeamMarketingBNB);
                }
                if(TreasuryShare > 0){
