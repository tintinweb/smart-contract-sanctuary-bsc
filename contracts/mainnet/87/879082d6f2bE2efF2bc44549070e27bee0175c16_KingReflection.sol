...
contract KingReflection is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Reflection";
    string private constant _symbol = "KingReflection";
