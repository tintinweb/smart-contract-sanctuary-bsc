...
contract MBK is ERC20Detailed, Ownable {
    ...
    uint256 public inviterMinHoldAmount;
    uint256 public MinAirdropAmount;
    ...
    function setInviter(
        ...
        if (deltaTimeFromInit < (60 days)) {
        ...
        } else if (deltaTimeFromInit >= (120 days)) {
        ...
        } else if (deltaTimeFromInit >= (300 days)) {
            ...
            inviterMinHoldAmount = 10**8 * 10**DECIMALS;
