...
//Telegram Link : https://t.me/DubaiSafeMoon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5); //SFM REWARD
...
contract DubaiSafeMoon is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5; //change in two places
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Dubai SafeMoon";
    string constant _symbol = "DubaiSFM";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x66DA4782e3212692D0f2507Df867395E50c5a7a8;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x66DA4782e3212692D0f2507Df867395E50c5a7a8;
