...
contract PulsinatorBoost is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PulsinatorBoostDividendTracker public dividendTracker;

    address payable public MarketingAndPulseBTrading;
    ...
    uint256 public sellMarketingAndPulseBTradingFees;
    uint256 public sellLiquidityFee;
    uint256 public buyDeadFees;
    uint256 public buyMarketingAndPulseBTradingFees;
    ...
    event UpdateFees(
        ...
        uint256 sellMarketingAndPulseBTradingFees,
        uint256 sellLiquidityFee,
        uint256 sellRewardsFee,
        uint256 buyDeadFees,
        uint256 buyMarketingAndPulseBTradingFees,
    ...
    constructor() ERC20("PulsinatorBoost", "PulseB") {
        MarketingAndPulseBTrading = payable(0xc7E51e4DfA4A039Bd3a3708022509c0D44022e9f);
        devWallet = payable(0x1973Aef7dB46330e4187c29082bc327311886030);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 2;
        sellDeadFees = 2;
        buyMarketingAndPulseBTradingFees = 4;
        sellMarketingAndPulseBTradingFees = 4;
        buyLiquidityFee = 2;
        sellLiquidityFee = 2;
        buyRewardsFee = 4;
        sellRewardsFee = 4;
        ...
        totalBuyFees = buyRewardsFee
            .add(buyLiquidityFee)
            .add(buyMarketingAndPulseBTradingFees)
            .add(buyDevFee);
        totalSellFees = sellRewardsFee
            .add(sellLiquidityFee)
            .add(sellMarketingAndPulseBTradingFees)
            .add(sellDevFee);

         dividendTracker = new PulsinatorBoostDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "PulsinatorBoostTRACKER",
            "PulsinatorBoostTRACKER"
        );
        ...
        dividendTracker.excludeFromDividends(MarketingAndPulseBTrading);
        dividendTracker.excludeFromDividends(owner());

        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(dividendTracker)] = true;
        _isExcludedFromFees[address(MarketingAndPulseBTrading)] = true;
        ...
        maxWallet = totalTokenSupply / 50; // 20k tokens
        swapTokensAtAmount = totalTokenSupply / 1000; // 1k tokens;
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 50, "max wallet cannot be set to less than 20k ");
        maxWallet = value;
    }
    ...
    function updateFees(
        uint256 deadBuy,
        uint256 deadSell,
        uint256 MarketingAndPulseBTradingBuy,
        uint256 MarketingAndPulseBTradingSell,
        ...
        buyDeadFees = deadBuy;
        buyMarketingAndPulseBTradingFees = MarketingAndPulseBTradingBuy;
        buyLiquidityFee = liquidityBuy;
        buyRewardsFee = RewardsBuy;
        sellDeadFees = deadSell;
        sellMarketingAndPulseBTradingFees = MarketingAndPulseBTradingSell;
        ...
        emit UpdateFees(
            sellDeadFees,
            sellMarketingAndPulseBTradingFees,
            sellLiquidityFee,
            sellRewardsFee,
            buyDeadFees,
            buyMarketingAndPulseBTradingFees,
            buyLiquidityFee,
            buyRewardsFee,
            buyDevFee,
            sellDevFee
    ...
    function _transfer(
        ...
        uint256 RewardsFee;
        uint256 deadFees;
        uint256 MarketingAndPulseBTradingFees;
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                MarketingAndPulseBTradingFees = sellMarketingAndPulseBTradingFees;
                ...
                MarketingAndPulseBTradingFees = buyMarketingAndPulseBTradingFees;
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + MarketingAndPulseBTradingFees + devFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyMarketingAndPulseBTradingFees + buyDevFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellMarketingAndPulseBTradingFees + sellDevFee);
        }
        ...
        uint256 _completeFees = sellMarketingAndPulseBTradingFees.add(sellDevFee) +
            buyMarketingAndPulseBTradingFees.add(buyDevFee);

        uint256 feePortions;
        if (_completeFees > 0) {
            feePortions = address(this).balance.div(_completeFees);
        }
        uint256 MarketingAndPulseBTradingPayout = buyMarketingAndPulseBTradingFees.add(sellMarketingAndPulseBTradingFees) * feePortions;
        uint256 devPayout = buyDevFee.add(sellDevFee) * feePortions;

        if (MarketingAndPulseBTradingPayout > 0) {
            (successOp1, ) = address(MarketingAndPulseBTrading).call{value: MarketingAndPulseBTradingPayout}("");
        }
        if (devPayout > 0) {
        ...
        emit SendDividends(
            dividends,
            MarketingAndPulseBTradingPayout + devPayout,
...
contract PulsinatorBoostDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PulsinatorBoost public PulsinatorBoostContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PulsinatorBoostContract = PulsinatorBoost(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PulsinatorBoost_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PulsinatorBoost_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PulsinatorBoost contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PulsinatorBoostContract);

            uint256 prevBalance = PulsinatorBoostContract.balanceOf(address(this));
            ...
            {
                uint256 received = PulsinatorBoostContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PulsinatorBoostContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
