...
contract LuckyShib is ERC20, Ownable, BaseToken {
	...
	uint256 public drawRound;   
	uint256 public nextDrawTime;
	uint256 public tokenBuyersNum;
    ...
    constructor(
        ...
        */
        ...
        nextDrawTime = block.timestamp + 86400; //next 24 hours
        drawRound = 0;
        tokenBuyersNum = 0;
        pool_balance = 0;
    }
    ...
    function calcTotalFees() internal {
    ...
    function _drawPool() private {
        ...
        for (uint256 i = 0; i < n; ++i) { 
            ...
            _transfer(address(this), topTokenBuyers[i], award);
			total += award;
        ...
        drawRound += 1; 
        tokenBuyersNum = 0; 
        nextDrawTime += ((block.timestamp - nextDrawTime) / 86400 + 1) * 86400; //next time
    }
    ...
    function _swapTokenFee (address from, address to) private {
        ...
        if (!swapping) {
            contractTokenBalance = balanceOf(address(this));//current balance
        ...
        if (
            ...
            //rewardToken
            uint256 rewardTokens = contractTokenBalance.mul(tokenRewardsFee).div(totalFees); 
            swapAndSendDividends(rewardTokens);

            //poolFee
            uint256 poolTokens = contractTokenBalance.sub(marketingTokens).sub(swapTokens).sub(rewardTokens);
    ...
    function swapTokensForCake(uint256 tokenAmount) private {
        ...
        // swap the amount,need to be did it
    }
