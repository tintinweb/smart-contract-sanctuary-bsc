...
/**
*
*    WaCatzashi tokenomics:
*    7% Marketing & Development
*    3% fee on each tx, added to the liquidity pool
*
*    TG:  https://t.me/WaCatzashi
* 
*    The Side arm of the most incredible cat warrior the world has ever seen
*    Slice into Enemy with incredible precision.
*    The Catana has been disarmed, it's time to draw the WaCatzashi!
*    Swift death arrives to all opponents who face the WaCatzashi
*    Only the noble shall survive
*    
*    
*/
...
contract WaCatzashi is Ownable, IBEP20 {
    ...
    string constant _name = "WaCatzashi Coin";
    string constant _symbol = "WaCatzashi";
    ...
    constructor() {
        ...
        marketingWallet = 0x8070b277a0D0B7B207B390B9A13f7a090315679e;
