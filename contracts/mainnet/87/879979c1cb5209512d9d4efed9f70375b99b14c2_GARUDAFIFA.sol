...
/**
    ...
    LOCAL PRODUCT, GOES TO GLOBAL

    First Garuda token for the World Cup on Binance Smart Chain

    Website   : https://garudafifa.com/
    Telegram  : https://t.me/GarudaFifa
*/
...
contract GARUDAFIFA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xEF0D048B9466d576d4e6340ba2F7E898F7d74Fc9);
    address payable public teamWalletAddress = payable(0x51F6dEAf422FDFf4B00BA2e840284F83F257DF58);
    ...
    string private _name = "GARUDA FIFA";
    string private _symbol = "GARUDA";
