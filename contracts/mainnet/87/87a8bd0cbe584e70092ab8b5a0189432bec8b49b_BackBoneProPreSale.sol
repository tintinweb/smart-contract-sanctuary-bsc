...
// File: contracts/BUSD-Presale.sol
...
contract BackBoneProPreSale {   
    ...
    uint256 public MaxOrder = 1117318000000000000000000; // Max token order
    uint256 public TotalSupply = 40000000000000000000000000; // Total token supply
    uint256 public LockingTime = 0; // Locking time in second
    uint256 public VestingTime = 15778476; // 6 Months Vesting time in seconds
    uint256 public ClaimPeriod = 86400; // Claim once per day 
    uint256 public TokenPrice = 8950000000000000; // Token price per BUSD
    /* end sale config */
