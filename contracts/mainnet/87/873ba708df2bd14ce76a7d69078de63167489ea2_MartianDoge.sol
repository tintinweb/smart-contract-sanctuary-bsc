...
// https://t.me/MartianDogecoin

//  Martian Doge
  //这个名为“AU-spot”的自主火星犬是来自火星的第一种科技生物狗，火星犬机器人可以自主导航去探索火星上危险的地形和地下洞穴。火星狗可以达到每小时3英里的正常行走速度。即使它们摔倒了，它们也能重新爬起来。它具备超强的敏捷性和弹性，并与传感器相结合，使它们能够避开障碍物，在多条路径之间进行选择，并为基地的操作人员构建地下隧道和洞穴的虚拟地图。这将为科学家发现地球以外生命迹象提供新的机会。最后，科学家们表示：“有朝一日，这些行为可能会使革命性的科学任务能够在火星表面和地下顺利开展
...
contract MartianDoge is IBEP20, Auth {
    ...
    string constant _symbol = "MDDOGE";
    ...
    address private marketingFeeReceiver = 0xb6e759dA4B0165a2ceF444cE4fe5e3C4d2d1279D;
    address private teamFeeReceiver = 0xb6e759dA4B0165a2ceF444cE4fe5e3C4d2d1279D;
