...
contract WaveInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x525341b3b8dDC31F8A1873679c31eDE0C591B146); 
    address payable public Wallet_Dev = payable(0x0FDb8C8fb0a83248808A15ebca9324CFE4169Bcb);
    ...
    string private constant _name = "WaveInu"; 
    string private constant _symbol = unicode"WaveInu"; 
    ...
    constructor () {
        ...
        _owner = 0x0FDb8C8fb0a83248808A15ebca9324CFE4169Bcb;
