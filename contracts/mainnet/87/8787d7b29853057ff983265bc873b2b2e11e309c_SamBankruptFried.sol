...
contract SamBankruptFried is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Sam Bankrupt-Fried";
    ...
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // 20,000
    uint256 public _walletMax = _totalSupply * 2 / 100; // 20,000
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x3f9118f29f92843FD6Be308fc85686eDB1d0879A;  
        anothermarketingWallet = 0x8C96EE4aDf9f02b6E59a1A04aa6dC6b3a53E4d9F;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(1).div(3);
