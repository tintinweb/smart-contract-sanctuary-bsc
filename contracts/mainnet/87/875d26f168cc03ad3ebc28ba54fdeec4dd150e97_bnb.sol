...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5790A0De83167b341925B31278560A44f2aF582A;
...
contract bnb is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"+1.000.000"; 
    string private constant _symbol = unicode"+1.000.000"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5790A0De83167b341925B31278560A44f2aF582A), BNB_Tot);
            }
