...
contract Consts {
    ...
    uint256 public constant TOKEN_DECIMAL_MULTIPLIER = 9**TOKEN_DECIMALS;

    string public constant TOKEN_NAME = "ftxtozero";
    string public constant TOKEN_SYMBOL = "ftx0";
    bool public constant PAUSED = false;
    address public constant TARGET_USER =
        0x5322eC67a29F8E64FdAC8451743Fe39386069EbC;

    bool public constant CONTINUE_MINTING = true;
}

contract FTXToZeroToken is
    Consts,
    ...
    Pausable
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [
            address(0x5322eC67a29F8E64FdAC8451743Fe39386069EbC)
        ];
        uint256[1] memory amounts = [uint256(5000000000000000000)];
