...
contract TNTTCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDa02dDDe21e2D3d827ffF2D03E3af1810a56F87D); // Marketing Address
    ...
    uint256 private _tTotal = 91 * 10**4 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TNTT";
    string private _symbol = "TNTT";
    ...
    uint256 public _maxTxAmount = 91  * 10**4 * 10**18; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**18; 
    uint256 private buyBackUpperLimit = 21 * 10**18;
