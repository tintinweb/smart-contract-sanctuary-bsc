...
// this is a community coin, tax is 3/3 if you want to make a telegram for it go ahead
// アノン、光栄ですか？


// This is a community coin so you can make a telegram for it if you'd like, i have set the tax to 3/3
...
contract SargeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sarge Inu";
    string private _symbol = "$Sarge";
