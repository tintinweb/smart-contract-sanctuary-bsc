...
contract BridgeToken is Context, IERC20, Ownable {
    ...
    string private _name = "LunaN";
    string private _symbol = "LunaN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x68695C872968AE0c4532aaA66a77C73AA839516f); // Marketing Address
