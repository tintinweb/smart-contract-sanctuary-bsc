...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6aF221b32876B877c9B4e4C0199061E01C047201; // owner address
...
contract AlphaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x031Ed2e18C75DDD14428c11F69Dbb3E5abd69D44); // Marketing Address
    address payable public teamWalletAddress = payable(0x031Ed2e18C75DDD14428c11F69Dbb3E5abd69D44); // Team Address
