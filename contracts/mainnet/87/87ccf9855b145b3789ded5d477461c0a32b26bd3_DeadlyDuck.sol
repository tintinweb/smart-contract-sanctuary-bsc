...
contract DeadlyDuck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Deadly Duck";
    string private _symbol = "$DD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37D61BDd2b7A89068Db627B9fc1619Fe8172Eb36); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x37D61BDd2b7A89068Db627B9fc1619Fe8172Eb36); // BuyBack Address
