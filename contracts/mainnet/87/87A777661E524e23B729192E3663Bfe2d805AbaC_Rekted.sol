...
contract Rekted is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x24395cc37CC6b3aEAAfc72aa409e168fbAAF4559;
 
    string constant _name = "Rekted";
    string constant _symbol = "REKT";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  //1% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 100) / 100;  //2% max wallet
