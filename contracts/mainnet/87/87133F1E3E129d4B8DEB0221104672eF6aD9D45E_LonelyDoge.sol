...
contract LonelyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BNBM0";
    string private _symbol = "BNBM0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x24c0cb0469610E9308E090C02AAde4702b999999); // Marketing Address
