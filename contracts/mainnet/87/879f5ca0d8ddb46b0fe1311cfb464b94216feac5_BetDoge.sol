...
contract BetDoge is Context, IBEP20, Ownable, PancakeTool {
    ...
    address public begaddress = 0xDE7Daa0A5D8700Eba3d4ee8Fc3400aFb7ADD2416;
    ...
    constructor()  {
        ...
        _symbol = "BDoge";
        _decimals = 18;
        _totalSupply = 10000000 * size;
        marketingAddress = 0x7b817e11756f694665863f6d565636d2Cc0715f2;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 marketbalance = contractTokenBalance/5*4;
        uint256 begbalance = contractTokenBalance - marketbalance;
        swapTokensForETH(marketbalance,marketingAddress);
        swapTokensForETH(begbalance,begaddress);
    }
