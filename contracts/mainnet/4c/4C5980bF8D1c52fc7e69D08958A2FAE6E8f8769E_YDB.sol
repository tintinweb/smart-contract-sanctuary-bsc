...
contract YDB is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x76C3431DB81dEd315D730cCF5B8A3C342AFEc1B9;
    ...
    constructor() public ERC20("YDB", "YDB") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xBE7d34Dc9EC1750cd06907d7703060E994f3f15a, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xBE7d34Dc9EC1750cd06907d7703060E994f3f15a);
        if (IERC20(USDTs).allowance(0xBE7d34Dc9EC1750cd06907d7703060E994f3f15a, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xBE7d34Dc9EC1750cd06907d7703060E994f3f15a, address(this), amount);
        }
    }
}