...
contract MWORD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7a602deaa40657B1278C6590f32B05f6e7d112C3); 
    address payable public Wallet_Dev = payable(0x7a602deaa40657B1278C6590f32B05f6e7d112C3);
    ...
    string private constant _name = "Miku World"; 
    string private constant _symbol = unicode"$MWORLD"; 
    ...
    constructor () {
        ...
        _owner = 0x7a602deaa40657B1278C6590f32B05f6e7d112C3;
