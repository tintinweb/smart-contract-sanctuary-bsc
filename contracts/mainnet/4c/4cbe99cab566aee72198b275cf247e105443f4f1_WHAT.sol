...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8dc4e4b1603B377Ad673A0802273CdC701Be52A5; // owner address
...
contract WHAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4a1b51C227F454196F82A386e00f80e49E4090Df); // Marketing Address
    address payable public teamWalletAddress = payable(0x497FbEEaf1646e56256bd26B344230fE97B18231); // Team Address
    ...
    uint256 public _totalDistributionShares = 13;  // original 12
