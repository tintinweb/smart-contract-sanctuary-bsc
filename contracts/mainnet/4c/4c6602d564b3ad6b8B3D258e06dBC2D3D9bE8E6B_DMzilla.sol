...
contract DMzilla is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dmzilla";
    string private _symbol = unicode"Dmzilla";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xa42F4D7E0AbaD9F32104e87ae7faD5A99914B736));
        marketingWallet = payable(address(0xa42F4D7E0AbaD9F32104e87ae7faD5A99914B736));
