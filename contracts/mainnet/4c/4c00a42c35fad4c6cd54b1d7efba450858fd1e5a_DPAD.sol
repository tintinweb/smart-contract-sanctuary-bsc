...
/**
A protocol to ideate, innovate and change Web3 solutions for the masses. DPAD Project consists of:

1.) Launchpad 2.0 to launch next-generation projects in Web3, NFT, Metaverse, P2E games.
2.) World’s 1st social venture builder to fill the gaps in Web3 market.
3.) Meta Incubation with Founderverse of Web3 builders for networking.

$DPAD is a multi-utility token. LAUNCHPAD BETA APP IS LIVE. Created a dedicated TALK SHOW for IDO investors. Team vesting- 12 months. ✅KYC ✅AUDIT ✅UTILITY TOKEN ✅STAKING ✅DEFLATIONARY
*/
