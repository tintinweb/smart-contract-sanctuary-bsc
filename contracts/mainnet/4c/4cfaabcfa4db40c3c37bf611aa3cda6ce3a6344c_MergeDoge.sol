...
🐶MergeDoge🐶
Welcome to 🗨MergeDoge community!🗨 
MemeCoin
...
💯community Token
💯 Strong Buyback
🚀Next 100x #memecoin #Binancechain #binance #ethpow

✅LIQUIDITY LOCK 🔐1Month
✅Token LOCK 🔐100Month for High MC
Tax
✅10 % Tax
...
contract MergeDoge is Context, BinanceGaming, Ownable {
    ...
    string private _name = 'MergeDoge';
    string private _symbol = 'MergeDoge';
