...
contract MoonToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("Moon", "Moon")  {
        uint256 totalSupply = 110000000 * (10**18);
        swapTokensAtAmount = totalSupply.mul(2).div(10**6); // 0.002%;
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory())
            .createPair(address(this), address(usdt));
        marketingWalletAddress = 0x4D0E6AF47762408DB4F0D1c078B58431641397F4;
        buybackWalletAddress = 0xb92892f5F01d4cC27215249908D792Dd5F1EB388;
