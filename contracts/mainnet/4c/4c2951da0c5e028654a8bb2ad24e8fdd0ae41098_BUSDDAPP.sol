...
contract BUSDDAPP is Context, Ownable , ReentrancyGuard {
    ...
    address public dev = 0x8e6142c1496A56ce2Fb1208b19EcDEEafc935b66;
    ...
    require(totalWithdraw[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,2), "You cant withdraw you have collected Two times Already"); // hh new
...
if (totalRewards[msg.sender].amount >= SafeMath.mul(investments[msg.sender].invested,2)){
