...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55905635783B59a1588C86CBc5F7d6D2dADaC58F; // owner address
...
contract WowDogeBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOW DOGE";
    string private _symbol = "WD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8679DF55031d94DAC66c73496B36537f16873984); // Marketing Address
    address payable private teamWalletAddress = payable(0x55905635783B59a1588C86CBc5F7d6D2dADaC58F); // Team Address
