...
contract NewCommunityMuuInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunity Muu INU";
    string private _symbol = "NCMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x79bef225e0bd98b19d26dcf150028fDeB7D9523D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x79bef225e0bd98b19d26dcf150028fDeB7D9523D); // BuyBack Address
