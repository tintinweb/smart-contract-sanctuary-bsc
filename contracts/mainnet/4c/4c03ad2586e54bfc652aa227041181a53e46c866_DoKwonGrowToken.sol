...
contract DoKwonGrowToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Do Kwon Grow";
    string private _symbol = "$DKG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf178dFC0D041Ccc780e06DC79709e002e911eA23); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf178dFC0D041Ccc780e06DC79709e002e911eA23); // BuyBack Address
