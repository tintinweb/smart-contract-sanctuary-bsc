...
Telegram : https://t.me/JustAnotherCryptoCurrency
Twitter  : https://twitter.com/JACC_Token
Website  : (CURRENTY_IN_DEVELOPMENT)

Just Another CryptoCurrency is a community token that aims to create a cryptocurrency community 
without the fear of fraud.

We're here to make something special, but we can't do it alone! 
Community is the basis for everything we build, promote and imagine. 
We look forward to embody and inspire creativity not just one, but as many as possible.

JACC has NFT's available on LooBr.com and proceeds will go towards liquidity.  Thank you for your support.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  LooBr = IBEP20(0x2d537cc7a9aA092ca3dD1Ee542c0B73560cB14f0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LooBr.balanceOf(address(this));
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LooBr);
        ...
        uint256 amount = LooBr.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LooBr.transfer(shareholder, amount);
...
contract Just_Another_CryptoCurrency_2_test is IBEP20, Auth {
    using SafeMath for uint256;
    address LooBr = 0x2d537cc7a9aA092ca3dD1Ee542c0B73560cB14f0; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x7056AF136a26FD9Bf228581c8f6198c5544969eE;
    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;
    string constant _name = "Just Another CryptoCurrency 2 test";
    string constant _symbol = "JACC v2t";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x37f05ccCbA34fab58a11760F9521514cDdfdAd7f;
