...
contract BonusTetherDividendTracker is Ownable, DividendPayingToken{
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BonusTether_Dividend_Tracker", "BONT_Dividend_Tracker") {
    	claimWait = 3600;
...
contract BonusTether is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    BonusTetherDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x0d77C31465eF869C5D84359d9CD9021c38797144;
    ...
    constructor() public ERC20("BonusTether", "BONT") {

    	dividendTracker = new BonusTetherDividendTracker();
        ...
        _mint(getOwner(), 1000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BonusTetherDividendTracker newDividendTracker = BonusTetherDividendTracker(payable(newAddress));
