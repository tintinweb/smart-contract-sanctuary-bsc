...
// Telegram : https://t.me/kingukongupirates
...
contract KINGUKONGUPIRATES is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KINGUKONGUPIRATES";
    string constant _symbol = "$KIPI";
    ...
    function manage_addlist(address[] calldata addresses, bool status) public onlyOwner {
