...
library Address{
 ...
 contract MbappeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9a4e216Aa2Dbd90E2940Ab8451b51232eAFFFb02;
    address public donationWallet = 0x9a4e216Aa2Dbd90E2940Ab8451b51232eAFFFb02;

    string private constant _name = "Mbappe Inu";
    ...
    Taxes public taxes = Taxes(1, 5, 1, 1);
    Taxes public sellTaxes = Taxes(1, 5, 1, 1);
