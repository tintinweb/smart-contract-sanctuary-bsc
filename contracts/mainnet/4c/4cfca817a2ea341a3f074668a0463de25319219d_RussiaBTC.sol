...
// .....
// telegram : https://t.me/RussiaBTCOfficial
// -
// -
// -
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTC_BEP20 = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BTC_BEP20.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BTC_BEP20);
        ...
        uint256 amount = BTC_BEP20.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BTC_BEP20.transfer(shareholder, amount);
...
contract RussiaBTC is IBEP20, Auth {
    using SafeMath for uint256;

    address BTC_BEP20 = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Russia BTC";
    string constant _symbol = "RussiaBTC";
