...
contract GDAONFT is ERC721Enumerable, Ownable {
    string private _uri;
    ...
    function buy(uint256 num) external {
        ...
        _takeToken(_token, account, _tokenAmount * num);
        _batchMint(account, num);
    }
    ...
    function getBaseInfo() public view returns (
        bool pauseBuy, uint256 tokenAmount,
    ...
    function _batchMint(address to, uint256 num) private {
    ...
    function setCash(address cashAddress) external onlyOwner {
        _cash = cashAddress;
    }
    ...
    constructor() ERC721("GDAO NFT", "GDAO NFT"){
        _minter[msg.sender] = true;
        _token = address(0xF3D72B129A218835DEF2245cD274fB7029Ee6924);
        _tokenAmount = 2 * 10 ** IERC20(_token).decimals();
        _cash = address(0x1118Bb2F96184075eF27D6905D50D3Eff52A24c4);
    }
}