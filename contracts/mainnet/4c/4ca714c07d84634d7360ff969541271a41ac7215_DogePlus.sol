...
contract DogePlus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogePlus";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xa4A9BF50EE4bFCB9dC9e65e3D1b47b036229ced5;
        marketingFeeReceiver = 0xa4A9BF50EE4bFCB9dC9e65e3D1b47b036229ced5;
