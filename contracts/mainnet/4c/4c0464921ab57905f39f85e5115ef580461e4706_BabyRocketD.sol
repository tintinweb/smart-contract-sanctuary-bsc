...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x45a565609EF267Cfc9b48371388a802730523257);
...
contract BabyRocketD is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xE7a783bBAe72C4B46D552f10E8FBA0D3C37Db2Bf;

    string constant _name = "BABY ROCKETDOGE";
    string constant _symbol = "BRDOGE";
