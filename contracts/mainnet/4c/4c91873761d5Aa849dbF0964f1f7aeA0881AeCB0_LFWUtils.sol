...
contract LFWUtils {
    uint256 public numStakingParameters = 4;
    uint256 public numFarmingParameters = 2;
    ...
    uint256 public dailyBlock = 28800;
    ...
    function getPancakeStakingInfo(
        ...
        uint256 rewardPerDay = scInterface.rewardPerBlock()*dailyBlock;
        ...
        stakingInfo[2] = rewardPerDay/stakedTokenBalance;

        // [3] is the pool countdown by block
        stakingInfo[3] = scInterface.bonusEndBlock() - block.number;
    }
    ...
    function getBabyStakingInfo(
        ...
        // [2] Calculate an optional term to calculate APR for backend
        uint256 rewardPerDay = scInterface.cakePerBlock()*dailyBlock;
