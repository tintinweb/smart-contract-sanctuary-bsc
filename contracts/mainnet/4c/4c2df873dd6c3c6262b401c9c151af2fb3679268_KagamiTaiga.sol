...
//Telegram: https://t.me/kagamitaigabsc
...
contract KagamiTaiga is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x702C310c28A6C9c779f7E9486582507ED0a972F9); 
    address payable public Wallet_Dev = payable(0xB51034D9308Ff0052027C69374e1C36523E360f8);
    ...
    string private constant _name = "KagamiTaiga"; 
    string private constant _symbol = unicode"$KATAGA"; 
    ...
    constructor () {
        ...
        _owner = 0xB51034D9308Ff0052027C69374e1C36523E360f8;
