...
contract musk is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xc001369aB08b7a274329416E78646Fc99F859684); // Marketing Address

    address payable public teamAddress =
        payable(0x39fF4aAffF825c6e8EF3Ab44c00ab22Dc519cffE); // Team Address

    address payable public liquidityAddress =
        payable(0x302D0Fd153b6b87A61B026999a44364482d44056); // Liquidity Address
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 200 / 1000; // 2% maxWalletToken
