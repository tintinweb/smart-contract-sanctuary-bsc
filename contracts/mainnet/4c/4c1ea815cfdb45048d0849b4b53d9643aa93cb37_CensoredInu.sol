...
Censored INU 
memecoin on the bep-20 smart chain with the purpose of uncovering the scams going on in the space,
 as such being an detective in this space and educate the newcomers,
 and vets what to look for in their next investment in this space to be as safe as possible,
  Censored Inu aim with detective brian to uncover the scams that has been recently in this space on a case by case basis where after such there will be added utility to do an review of your future investment.
...
contract CensoredInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Censored Inu";
    string private constant _symbol = "$CENINU";
    ...
    address private marketingWallet = address(0x9c35bA70f917B43d6AF2b42245da851bD8960127);
