...
contract Treasury is ERC721Holder, ReentrancyGuard, AccessControlEnumerable {
    ...
    address public medals = 0x10F1B21148217EA5521BAC3AeecD657C1F7f7eBd;
    ...
    function award() external nonReentrant {
        ...
        require(awardSwitch && bonusAmount > 0, "Treasury: can not award.");
    ...
    function setAwardSwitch(bool _switch) external onlyRole(OPERATOR_ROLE) {
        awardSwitch = _switch;
    }
}
