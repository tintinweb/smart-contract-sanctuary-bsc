...
contract Language is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Language";
    string private _symbol = "LANG";
    ...
    function UNisTxExempt(address sender, uint256 amount) internal view {
        require(
    ...
    function setTxLimit(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function DDEErecoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
			// do not allow recovering self token
			require(tokenAddress != address(this), "Self withdraw");
			IERC20(tokenAddress).transfer(owner(), tokenAmount);
		}

    function XYZremovefee(address pair, bool value) external onlyOwner {
