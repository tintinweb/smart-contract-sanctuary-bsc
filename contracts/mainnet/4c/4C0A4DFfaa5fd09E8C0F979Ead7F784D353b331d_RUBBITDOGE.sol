...
TELEGRAM: https://t.me/rubbitdogeportal
*/
...
contract RUBBITDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " RUBBITDOGE ";
    string private _symbol = " RUBIGE "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6A2D47112c7455B6a0059A64610C6c530dD614CE); 
    address payable public teamWalletAddress = payable(0x6A2D47112c7455B6a0059A64610C6c530dD614CE); 
