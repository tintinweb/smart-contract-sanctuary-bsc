...
//submitted for Telegram: https://t.me/NasFanTokenOfficiall
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract NasFanToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Nas Fan Token ";
    string private _symbol = " NFT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f41EE8a3f7047C79881048738CfA22E9c348417);
    address payable public teamWalletAddress = payable(0xB7878D59E018eCBF7B7fFdE79e89f68E5C2F7751);
    ...
    uint256 private _totalSupply = 5 * 1000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10000000000 * 10**_decimals; 
    uint256 public _walletMax = 1 * 10000000000 * 10**_decimals;
