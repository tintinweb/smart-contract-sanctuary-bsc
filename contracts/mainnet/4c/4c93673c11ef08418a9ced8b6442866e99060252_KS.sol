...
contract KS is Context, IERC20, Ownable {
  ...
  string private _name = "Khaby Squid";
  ...
  uint256 private _maxWallet = _totalSupply.mul(10).div(1000);
  ...
  uint256 private _liquidityFeeBuy = 5;
  ...
  uint256 private _buybackWalletFeeBuy = 40;
  uint256 private _previousBuybackWalletFeeBuy = _buybackWalletFeeBuy;
  uint256 private _buybackWalletFeeSell = 120;
  uint256 private _previousBuybackWalletFeeSell = _buybackWalletFeeSell;

  uint256 private _marketingFeeBuy = 40;
  uint256 private _previousMarketingFeeBuy = _marketingFeeBuy;
  uint256 private _marketingFeeSell = 120;
  uint256 private _previousMarketingFeeSell = _marketingFeeSell;

  address payable private _buybackWallet = payable(0xaa930A3495d7D71819Ab6A0270BD24EEfBc48a06);
  address payable private _marketingWallet = payable(0xaa930A3495d7D71819Ab6A0270BD24EEfBc48a06);
  ...
  uint256 private _numTokensForSwap = 125 * 10**_decimals;
