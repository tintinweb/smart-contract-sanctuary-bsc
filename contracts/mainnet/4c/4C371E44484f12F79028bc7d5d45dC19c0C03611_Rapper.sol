...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFaa4533ce5BB9c10cd9ECED5CC2a09C61BFE737B; // owner address
...
contract Rapper is Context, IERC20, Ownable {
    ...
    string private _name = "Rapper";
    string private _symbol = "$Rap"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFaa4533ce5BB9c10cd9ECED5CC2a09C61BFE737B); // Marketing Address
    address payable public teamWalletAddress = payable(0x3536b1aA369eD69Ec2764276cafcE8345300BBB8); // DEVELOPMENT Address
