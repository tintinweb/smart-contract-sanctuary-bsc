...
contract PokeWorld is Context, IERC20, Ownable {
    ...
    string private _name = "PokeWorld";
    string private _symbol = unicode"$POKEWORLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf44784B023b64862487c4546e4e45E43b774a023); 
    address payable public buyBackWalletAddress = payable(0xf44784B023b64862487c4546e4e45E43b774a023); 
