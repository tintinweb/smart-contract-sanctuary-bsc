...
contract Ownable is Context {
    address private _owner = 0xa4F867b65Ebf0759f3aE29ad1c779f9015E961F0;
...
contract ABESHINZO is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0x4Ea423c2307f3b40B621aba28570Ad0A270d682d); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "ABE SHINZO"; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 2000 * 10**6 * 10**_decimals; 
