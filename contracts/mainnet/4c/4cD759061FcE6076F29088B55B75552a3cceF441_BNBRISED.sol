...
// TELEGRAM: https://t.me/BNBRISED
// BNB RISED IS A PURE STEALTH LAUNCH AND GOAL TO BE PART OF CRYPTO SPACE UTILITY AND WEBSITE WILL RELEASE SOON !
...
contract BNBRISED is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 100 * 10**_decimals;
    
    uint256 public maxSellAmount = 15000 * 10**_decimals;
    uint256 public maxBuyAmount = 30000 * 10**_decimals;
    uint256 public maxWalletBalance = 30000 * 10**_decimals;

    address public marketingAddress = 0x15cbD0f2B529D24d2028526114A1dAc885C2452F;
    address public devAddress = 0xa8683BD51657116b6F22daE7D3C683eCc513C3eB;

    string private constant _name = "BNBRISED";
    string private constant _symbol = "BRISED";
