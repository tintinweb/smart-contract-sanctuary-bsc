...
contract sucmoonzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sucmoonzilla";
    string private _symbol = "sucmoonzilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x20FCc0a81B0e7Fb18FB773c01e6B7af7312A1c19); 
    address payable public ttWal = payable(0x20FCc0a81B0e7Fb18FB773c01e6B7af7312A1c19); 
