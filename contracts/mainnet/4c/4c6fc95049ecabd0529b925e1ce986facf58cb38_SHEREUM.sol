...
contract SHEREUM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SHREUM BSC";
    string constant _symbol = "$SHEREUM";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x94585A0Fb3492f166ccEEC9321A8dDA6A9044576; 
        devWallet = 0x94585A0Fb3492f166ccEEC9321A8dDA6A9044576; 
