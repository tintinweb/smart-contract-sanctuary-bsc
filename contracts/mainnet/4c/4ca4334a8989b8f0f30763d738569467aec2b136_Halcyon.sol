...
contract Halcyon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Halcyon Chain"; //
    string private constant _symbol = "Halcyon"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x97D99234B4423a3Cf312319fEd6eF56697325a2d ;
