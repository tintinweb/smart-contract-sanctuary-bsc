...
contract Kityy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Happy Kityy";
    string private _symbol = "MDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0EEF3577f452FB37abFBFB01bec552EE4C42902a); 
    address payable private teamWalletAddress = payable(0x0EEF3577f452FB37abFBFB01bec552EE4C42902a); 
