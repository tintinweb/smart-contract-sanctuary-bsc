...
//A community-driven meme project. It intends to provide an asset for the community that is stable in price during the bear market and steadily rising when not. It is a decentralized token created on the Binance chain to maximize returns to investors. Now with a serious marketing approach we are utilizing this high rewards token to better the community.
//will present you guys with  lot of marketing with an experienced team in the bsc ! 
//The team has had many projects that have mooned in the millions of market cap! new classic nomad
//More then an meme token long term project!


pragma solidity ^0.8.5;

//https://t.me/NewclassicNomadcommunity
...
contract NEWCLASSICNOMAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Classic NOMAD"; // 
    string private constant _symbol = "NEWCNOMAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x23BCae104B6e2e503E09A358447dBC53889d4805;
