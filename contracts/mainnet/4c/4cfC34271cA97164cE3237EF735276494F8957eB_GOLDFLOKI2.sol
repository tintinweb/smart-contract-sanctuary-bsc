...
/* Token contract */
contract GOLDFLOKI2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x63F2004415510Dda70b2e6231330dD9B598aDE3f;
    ...
    // Name and symbol
    string constant _name = "GOLD FLOKI 2.0";
    string constant _symbol = "$GF2.0";
