...
contract SquidPulse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidPulse";
    string private _symbol = "Spulse";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCcE9cDe87864D17ef2150f38d75174fa9b1e2d48);
    address payable public BuyBackWalletAddress = payable(0xCcE9cDe87864D17ef2150f38d75174fa9b1e2d48);
