...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01d79AA222F7F105E8a07aCAbC67762adFc087C5;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB38220C20F850631f15e3D9C71FC1d4EbAd81331;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "one yatch club";
    string private _symbol = "1YC";
