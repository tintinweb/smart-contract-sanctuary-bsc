...
/**
Uptrend is the new token in the blue color of the chart. 
The project exaggerates the strong comeback of BNB in the BSC network.
Telegram: https://t.me/Uptrend_bsc
*/
...
contract Uptrend is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1D94026Ecc57676d0A75dD5cdB10305449371d7D); 
    address payable public Wallet_Dev = payable(0x1D94026Ecc57676d0A75dD5cdB10305449371d7D);
    ...
    string private constant _name = "UpTrend"; 
    string private constant _symbol = unicode"UPTREND"; 
    ...
    constructor () {
        ...
        _owner = 0x1D94026Ecc57676d0A75dD5cdB10305449371d7D;
