...
/**
SJM elon tweet, we can make 100000X
https://t.me/SJM_Token
*/
...
contract SJM is IBEP20, Auth {
    ...
    string constant _name = "SJM";
    string constant _symbol = "SJM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 private _maxTxAmount = ( _totalSupply * 100 ) / 100; // 3%
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 100; // 10%
