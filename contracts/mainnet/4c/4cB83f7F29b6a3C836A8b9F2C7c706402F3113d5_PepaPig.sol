...
contract PepaPig is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepa Pig";
    string private constant _symbol = "PEPAPIG";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 420000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 21000000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 21000000000000000 * 10**_decimals;
