...
contract Token is IBEP20, Auth {
    ...
    address DEV = 0x194Ac0868A69C1c6340811704d2E97DF48ee2A03;
    ...
    // Name and symbol
    string constant _name = "XSTMD";
    string constant _symbol = "XSTMD";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1688 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 68 / 1688; 
    uint256 public _maxSellTxAmount = _totalSupply * 68 / 1688; 
    uint256 public _maxWalletToken = ( _totalSupply * 68 ) / 1688; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x194Ac0868A69C1c6340811704d2E97DF48ee2A03;
