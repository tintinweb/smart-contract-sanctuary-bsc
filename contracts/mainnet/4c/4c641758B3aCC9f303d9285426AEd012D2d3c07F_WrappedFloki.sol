...
// SPDX-License-Identifier:MIT Liceense

/*
WrappedFloki
Wrapped Doge’s cousin, Wrapped Floki!

JOIN US : https://t.me/wrappedflokijoin
...
contract  WrappedFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WrappedFloki";
    string private _symbol = "WFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF17771D0Bd725D3B2B907cC89c28632D5FCa4499);
    address payable public teamWalletAddress = payable(0x5E6d70fe6C91cD1d7129A01a3f611DD93F7492D8); 
