...
contract BSCVaultMultiZone is Ownable{
    ...
    event Rent(address _renter, address _NFTaddr, uint _tokenID, uint _rentTime, uint _note);
    ...
    function rent(address _NFTaddr, uint _tokenID, uint _rentTime, uint _note) public{
        ...
        term[_NFTaddr][_tokenID].note = _note;
        ...
        emit Rent(msg.sender, _NFTaddr, _tokenID, _rentTime, _note);
    }
