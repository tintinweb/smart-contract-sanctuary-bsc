...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x297d7bf71016589446e829059dDe165FFCd515E7;
...
contract CheemsCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "CheemsCoin"; // 
    string private constant _symbol = "CheemsCoin"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x297d7bf71016589446e829059dDe165FFCd515E7);
