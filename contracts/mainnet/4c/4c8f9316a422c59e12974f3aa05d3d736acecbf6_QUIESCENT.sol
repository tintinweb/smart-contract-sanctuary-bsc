...
Telegram https://t.me/Quiescent_HoldToEarn_BSC
website https://quiescentholdtoearn.tech
*/
...
contract QUIESCENT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUIESCENT HOLD TO EARN";
    string private _symbol = "QCENT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A715074FF1D23a15C8f46FD5DEf8B1221AB2325); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5A715074FF1D23a15C8f46FD5DEf8B1221AB2325); // BuyBack Address
