...
contract EMPTYCAN is Context, IERC20, Ownable {
    ...
    string private _name = "Emptycan";
    string private _symbol = "$CAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7EC9f5dB3FDE64aB14017048C65FD8fC1882C63);
    address payable public teamWalletAddress = payable(0xb7EC9f5dB3FDE64aB14017048C65FD8fC1882C63); 
