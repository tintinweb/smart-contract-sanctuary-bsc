...
contract BNBKINGSON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB KING SON";
    string private _symbol = "BNBKINGSON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB68337F522eCaD536718293E76DD8eBd9209fbCB);
    address payable public teamWalletAddress = payable(0xB68337F522eCaD536718293E76DD8eBd9209fbCB);
