...
contract FireCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FireCat";
    string private _symbol = "FIREC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4Fc2931375d23b7Cb961B20B3fbEF899729Be1f8);
    address payable public teamWalletAddress = payable(0x4Fc2931375d23b7Cb961B20B3fbEF899729Be1f8);
    ...
    uint256 public _totalTokensDec = 100000000000000;    
