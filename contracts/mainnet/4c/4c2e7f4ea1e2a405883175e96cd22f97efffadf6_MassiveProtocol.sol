...
contract OwnableMAV is ContextMAV {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableMAV: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableMAV: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract MassiveProtocol is ContextMAV, BinanceBNB, OwnableMAV {
    ...
    string private _name = 'Massive Protocol';
    string private _symbol = 'MAV';
