...
contract Token is Ownable, IERC20, IERC20Metadata {
    ...
    constructor() {
        ...
        address _main = 0xA3291151a4A8DE2B0aa169B1a840655Ad614E7c9;
        _market = 0xE3b6D97ADeD7e65740d37A89f777b2761D4A8da5;
        _mint(_main, 9999 * 10 ** decimals());
    ...
    function _transfer(
        ...
        // market 1%
        _balances[_market] += (amount / 100);
        emit Transfer(sender, _market, (amount / 100));
