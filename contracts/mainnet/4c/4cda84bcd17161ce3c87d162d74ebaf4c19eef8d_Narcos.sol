...
contract Narcos is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200 * 10**18;
    uint256 public maxSellLimit = 100 * 10**18;
    ...
    address public marketingWallet = 0xAaaC875Bcf2bE7Bac5010E4F65DA42A7a6961cfF;
    ...
    Taxes private sellTaxes = Taxes(5, 2, 3);
    ...
    constructor(address routerAdd) ERC20("Narcos", "Narco") {
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 100, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 100, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 100, "Cannot set max wallet amount lower than 0.1%");
