...
contract GREENLUNA is Context, IERC20, Ownable {
    ...
    string private constant _name = "GREEN LUNA"; // 
    string private constant _symbol = "$GLN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 11;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xB0108770B34D8fcf5486B933C79f63bCAAC1d8B5;
