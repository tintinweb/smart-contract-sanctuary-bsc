...
contract BAKITA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blue Akita"; // 
    string private constant _symbol = "BAKITA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 50;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xe6C0cC3ACB18190a070728DE1a2bC7302a4004fa;
