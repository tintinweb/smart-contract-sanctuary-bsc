...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69b0573A4a17D8Cd920f00e5eD2913CCA6697378; // owner address
...
contract TayoriInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tayori Inu";
    string private _symbol = "TAYORI";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x69b0573A4a17D8Cd920f00e5eD2913CCA6697378); // Marketing Address
    address payable public teamWalletAddress = payable(0x69b0573A4a17D8Cd920f00e5eD2913CCA6697378); // Team Address
