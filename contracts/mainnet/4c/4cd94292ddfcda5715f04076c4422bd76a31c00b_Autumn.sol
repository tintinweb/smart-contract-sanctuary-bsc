...
contract Autumn is AutumnDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private AutumnTeam;
    address private CharityAutumn;
    ...
    string public override name = "Autumn";
    string public override symbol = "AUTUMN";
    ...
    constructor(uint totalSupplyValue, address AutumnTeamAddress, address CharityAutumnAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        AutumnTeam = AutumnTeamAddress;
        CharityAutumn = CharityAutumnAddress;
       
        // split the tokens according to agreed upon percentages
        balances[AutumnTeam] =  totalSupply * 45 / 100;
        balances[CharityAutumn] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's AutumnTeam pot
