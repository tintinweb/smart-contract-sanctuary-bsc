...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 50000 * 10 ** IERC20(FISTAddress).decimals();
...
contract CCGDSTWO is AbsToken {
    constructor() AbsToken(
        ...
        unicode"CCGDS 2.0",//Name
        unicode"CCGDSTWO",//Symbol
        9,//Decimals
        1000000,//Supply
        address(0xF5B178410518c934Ee2695E73c0d8E23341CF36f),//FundAddress
        address(0xF5B178410518c934Ee2695E73c0d8E23341CF36f)//ReceiveAddress
    ){
    }
}