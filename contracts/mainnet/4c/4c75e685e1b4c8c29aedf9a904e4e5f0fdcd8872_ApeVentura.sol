...
Welcome to Ape Ventura token!

Buy tax: 8% marketing
Sell tax: 3% liquidity, 12% buyback

After buyback sell tax is multiplied 2x for 30 minutes to rekt paperhands.
More paperhands = more burned tokens = better floor
...
/* Token contract */
contract ApeVentura is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Ape Ventura";
    string constant _symbol = "APEV";
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 1000; // .5% of supply
    ...
    // NOTE: 1% = 100
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        _maxWalletToken = _totalSupply.mul(maxWallPercent).div(100);
