...
contract GLSN is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingAddress = payable(0x0f0260bc07E6561B0AA374572560db29a79eCcd4);
    ...
    constructor () ERC20Detailed("Golden Santa", "GLSN", 9) {
    ...
    function setBuyFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 100, "Fee is crossing the boundaries");
    }
    ...
    function setSellFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 100, "Fee is crossing the boundaries");
    }
