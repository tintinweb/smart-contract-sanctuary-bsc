...
contract HUSTLE2 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5e8 * 10**_decimals;
    ...
    uint256 public maxWalletLimit = 5_000_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 3;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xd878eF4e63EDAcD04F9E3005510aaF0BA36c9d51;
    address public devWallet = 0x43b98aDdD609898bEed877C33336FbF508683a63;
    address public opsWallet = 0x736D28E03CE9ac7DB62422Be597d73AdFbfa442a;

    string private constant _name = "HUSTLE2.0";
    ...
    Taxes public taxes = Taxes(1, 3, 1, 1, 1);
    Taxes public sellTaxes = Taxes(1, 3, 1, 1, 1);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev + _ops) <= 20, "Must keep fees at 20% or less");
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 5_000_000, "Cannot set swap threshold amount higher than 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 500_000, "Cannot set max buy amount lower than 0.1% of tokens");
        require(maxSell >= 500_000, "Cannot set max sell amount lower than 0.1% of tokens%");
        require(maxWallet >= 5_000_000, "Cannot set max wallet amount lower than 1% of tokens");
