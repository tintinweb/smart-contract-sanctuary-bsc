...
LINUX BLOCKCHAIN is a blockchain platform for innovators, and visionaries, 
with the tools and technologies required to create possibility for the many, as well as the few, and bring about positive global change.

Not only is LINUX BLOCKCHAIN ultra-fast and low cost, it is censorship resistant.
...
🌐LINUX Staking
🌐LINUX Wallet
🌐LINUX Blockchain{Network}

☎️TELEGRAM :https://t.me/linuxblockchainofficial
🌍WEBSITE : https://linuxblockchain.org/
Explorer : https://linuxblockchain.org/explorer
📠DISCORD : https://discord.gg/WAVJ95Bj
🕊TWITTER : https://www.twitter.com/LINUXBLOCKCHAIN
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0688AFdc7446219083E4a792210C5D9d4210085b;
...
contract Linux is Context, IERC20, Ownable {
    ...
    string private constant _name = "Linux BlockChain"; // 
    string private constant _symbol = "LINUX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x108e2223Bc1aF43986E29931f0424FEB729EBC05);
