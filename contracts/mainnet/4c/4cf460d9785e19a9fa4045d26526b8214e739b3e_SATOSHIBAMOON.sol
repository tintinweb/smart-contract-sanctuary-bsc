...
✅ Possible next Meme Moonshot
✅ Verified contract & LP Lock
✅ Big Marketing
✅ LP BURN
✅ Rennounce ownership
✅ Community token
...
contract SATOSHIBAMOON is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "SATOSHIBAMOON";
    ...
    uint256 private _mTokens = 1000000000000 * 10 ** _decimals;
