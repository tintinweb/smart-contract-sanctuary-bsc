...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCf88880082144C5B80E43f74FAAb68214bE9E044; 
...
contract HosekiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hoseki Inu";
    string private _symbol = "HSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4aff54964D5D64BAA474bb780ECf8caA6a5e6cCB); // 
    address payable public teamWalletAddress = payable(0xCf88880082144C5B80E43f74FAAb68214bE9E044); // 
