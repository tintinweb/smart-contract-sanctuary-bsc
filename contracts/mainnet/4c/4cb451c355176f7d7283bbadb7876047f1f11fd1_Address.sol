...
contract FogeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x969b96E8cCC2924ff2A9B14db9401fDea3b1a044); 
    address payable public Wallet_Dev = payable(0x969b96E8cCC2924ff2A9B14db9401fDea3b1a044);
    ...
    string private constant _name = "Gaspa Inu"; 
    string private constant _symbol = unicode"GALE"; 
    ...
    constructor () {
        ...
        _owner = 0x969b96E8cCC2924ff2A9B14db9401fDea3b1a044;
