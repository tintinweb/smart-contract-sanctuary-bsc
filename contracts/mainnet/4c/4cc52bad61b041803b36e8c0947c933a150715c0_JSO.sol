...
contract JSO is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("JSO", "JSO") {
        ...
        lpAddress = payable(0x682552fD0828417D7c0928Bb66A9527d4162B4Df);
        marketAddress = payable(0xAf495349c3d880FE0A3C0AC02BE860722261d285);
        teamAddress = payable(0xc24dE2F664B6bb74567d7f7f014fae071c96Aa42);
        _mint(
            0x4507a9B45fdA6C9d2fe0aCA71eBc89b360c7701E,
            800 * 10**decimals()
        );
        _mint(
            0x81a0dDA965ccf5D63cc30Ac56D2ef3091658e7dE,
            800 * 10**decimals()
        );
        _mint(
            0xE9C40133ae620698015E6B9E5170Cc486de31b52,
            100 * 10**decimals()
        );
        _mint(
            0x6201EC16782BaB2Bb4e14aaF261e0Ce935b4017C,
            188 * 10**decimals()
        );
    }
