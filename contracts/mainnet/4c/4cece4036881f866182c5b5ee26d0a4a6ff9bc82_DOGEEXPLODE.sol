...
contract DOGEEXPLODE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEEXPLODE";
    string private _symbol = "DOXP";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xbF8440fF75cE2A26D586e3745C3Bf2Dd4275a14B); // Marketing Address
    address payable public teamWalletAddress = payable(0x7cCf1f3C5D7f09193D0F64DE0790e93b5da56a20); // Team Address
