...
// Telegram : https://t.me/StarShipBNB
...
contract SpaceARK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD097CD38FEbFAe020d2296Ed895106D65FA49018); 
    address payable public Wallet_Dews = payable(0x3A200531A9A53e5D5a1FC054FF614c853eF42bE0);
    ...
    string private constant _name = "Space Ark"; 
    string private constant _symbol = unicode"SPACE ARK"; 
    ...
    constructor () {
        ...
        _owner = 0x3A200531A9A53e5D5a1FC054FF614c853eF42bE0;
