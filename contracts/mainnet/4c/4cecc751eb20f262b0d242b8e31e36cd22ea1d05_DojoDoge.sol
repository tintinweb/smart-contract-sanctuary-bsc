...
contract DojoDoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DojoDoge Coin";
    string private _symbol = "DojoDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa8063e6091bDa9a5e6bE25aF13e8AdbcBb988069);
