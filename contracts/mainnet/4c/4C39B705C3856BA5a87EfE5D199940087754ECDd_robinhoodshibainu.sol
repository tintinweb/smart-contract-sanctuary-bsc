...
contract robinhoodshibainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Robinhood Shiba Inu";
    string private _symbol = "$RSHIBA INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x69D6220a82C688fF952d95Bf3882C2a87323a8ee);
    address payable public teamWalletAddress = payable(0x69D6220a82C688fF952d95Bf3882C2a87323a8ee);
