...
coin: https://t.me/maritesOFFICIAL
...
contract MARITES is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9ee42E2017B582A14B0AC81efEdA7C2eCA3fee70); 
    address payable public Wallet_Dev = payable(0x9ee42E2017B582A14B0AC81efEdA7C2eCA3fee70);
    ...
    string private constant _name = "MARITES"; 
    string private constant _symbol = unicode"MARITES"; 
    ...
    constructor () {
        ...
        _owner = 0x9ee42E2017B582A14B0AC81efEdA7C2eCA3fee70;
