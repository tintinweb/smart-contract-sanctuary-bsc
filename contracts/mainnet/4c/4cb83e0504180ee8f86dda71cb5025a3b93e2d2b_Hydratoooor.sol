...
/* Token contract */
contract Hydratoooor is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x05d7C93E22DC4cd2777EF8121F61628964a644E6;
    ...
    // Name and symbol
    string constant _name = "Hydratoooor Inu";
    string constant _symbol = "Hydratoooor";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10 / 1000; // 0.1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 1000; // 0.1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 1000; // 0.1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        authorizations[address(0x05d7C93E22DC4cd2777EF8121F61628964a644E6)] = true;

        // Set the marketing and liq receiver to the owner as default
        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver =0x05d7C93E22DC4cd2777EF8121F61628964a644E6;
