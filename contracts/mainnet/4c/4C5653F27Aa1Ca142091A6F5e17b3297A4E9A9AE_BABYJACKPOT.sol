...
contract BABYJACKPOT is IBEP20, Auth {
    ...
    uint256 public nextMintTime = block.timestamp + 1 days;
    ...
    */
    ...
    function mintToken() public onlyOwner{
        require(nextMintTime < block.timestamp, 'You can only mint once in every 6months');
        uint256 amount = 1000000 * 10**_decimals ;
        _totalSupply = _totalSupply.add(amount);
        _balances[msg.sender] = _balances[msg.sender].add(amount);
        nextMintTime = block.timestamp + 182 days;
