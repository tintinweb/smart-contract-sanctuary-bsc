...
🚀 SHIBA BEER 🐕🍺 $SHIBEER
 ...
 🏦 LP Locked on Mudra Manager

 🗓 Lined up Calls
 
 ↔️ Stealth Launch
 🤝 100% Efficient Marketing Team
 💬 Organic upgrowth community 
📱TG: https://t.me/ShibaBeer

 🔄 Slippage Buy/Sell 14%
 🐕 7% Marketing
 🍺 7% Beer Production
PancakeSwapV2 | PooCoin Swap
〽️ Charts 🛠 ACH 💩 PooCoin 🟢 BBB
🤑 🐕🍺

 🍻$SHIBEER🍻 🍺 Real Brewery Partnerships Exchange 📈 Join us for a Beer 🍻 VC for AMA at launch | Chart 🌐 Visit http://www.ShibaBeer.net for more info  💻
...
contract _Shiba_Beer_ is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB5dC446a7f03a41283ead4b6D18585f128Ed5c3A); 
    address payable public Wallet_ShibaBeer = payable(0x07b25758C895b79ab57F0FdD99b5D7C5ceB0A26F);
    ...
    string private constant _name = "Shiba Beer"; 
    string private constant _symbol = unicode"$SHI BEER"; 
    ...
    uint256 public Percent_ShibaBeer = 50;
    ...
    constructor () {
        ...
        _owner = 0x87bd4BD1cB04ddd2200B5e33ddDE76D80f10b065;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_ShibaBeer / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_ShibaBeer);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_ShibaBeer * 100 / (Percent_AutoLP + Percent_Marketing + Percent_ShibaBeer);
            ...
            sendToWallet(Wallet_ShibaBeer, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_ShibaBeer, removeRandom);
