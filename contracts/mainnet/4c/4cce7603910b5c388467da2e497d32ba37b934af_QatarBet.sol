...
contract QatarBet is ERC20Detailed, Ownable {
    ...
    string public constant _symbol = "QB";
    ...
    uint256 public totalFee = ecosystemFee.add(liquidityFee).add(burnFee);
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(_decimals)) Ownable() {
        ...
        ecosystemReceiver = 0x97A95C2837e611d46fD4f8c198cFB91D8F2eC179;
    ...
    function _transferFrom(
        ...
        require(amount > 100000000, "Amount must be higher than 1000000 wei");
        if (inSwap) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = ecosystemFee.add(burnFee);

        (bool success, ) = payable(ecosystemReceiver).call{
            value: amountETHToTreasuryAndReward.mul(ecosystemFee).div(_currentFee),
            gas: 30000
        }("");
