...
contract ERC20 is Context,Ownable, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        defaultInviter = address(0xDd0eB539566F819d656c392B8a6A80941695FE29);
        foundation = address(0xa95BA5A810aa0B03BaB32c4c12027E9a3A033EDD);
        defaultNode = address(0x8257207728DAa45Ea29931BcdA1dA8945f72b543);
...
contract NCHtoken is ERC20 {

    mapping(address => bool) public blacklist;
    
    constructor() ERC20("New CH", "NCH") {
