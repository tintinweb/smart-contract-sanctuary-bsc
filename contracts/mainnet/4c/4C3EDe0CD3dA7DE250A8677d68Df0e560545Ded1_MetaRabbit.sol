...
/*
MetaRabbit - Every Childhood's Dream
A new metaverse concept that primary aim for childhood's dream to pet all your favorite animals, MetaRabbit is motivated to build a metaverse to make all these dream comes true! By owning MetaRabbit, you are able to buy & pet your favorite animals.
...
Join our Telegram group for more details : https://t.me/MetaRabbitBSC
*/
...
contract MetaRabbit is Context, IERC20 { 
    ...
    string private constant _name = "MetaRabbit"; 
    string private constant _symbol = "MetaRabbit"; 
