...
contract testy4 is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x59021506a624484c202d1Ec68aD693965dcC14bA;

    string constant _name = "testy4";
    string constant _symbol = "tst4";
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(marketingFeeReceiver).transfer(amountBUSD * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBUSDDev = amountBUSD.mul(devFee).div(totalBUSDFee);
        ...
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountBUSDDev, gas: 30000}("");
