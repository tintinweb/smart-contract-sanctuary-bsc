...
contract JSG is Ownable{
    ...
    uint256 private dayPerCycle = 7 days;
    uint256 private dayRewardPercents = 214290000000000000000;
    ...
    function Withdrawal() external {
        ...
        withdrawableJUTTO = (withdrawableJUTTO.add(dynamicTotalJUTTOReward).add(CTOTotalJUTTOReward)).mul(tokenper);
    ...
    function _calCurAllCTO(address _user) public view returns(uint256,uint256){
    ...
    function checkLevel2(address _address) private view returns(bool,uint256)
    {
    ...
    function checkLevel3(address _address) private view returns(bool,uint256)
    {
    ...
    function checkLevel4(address _address) private view returns(bool,uint256)
    {
    ...
    function checkLevel5(address _address) private view returns(bool,uint256)
    {
    ...
    function getAvailablity(address _user) public view returns(bool,bool,bool,bool){
    ...
    function _calLevelNow(address _user) private view returns(uint256)
    {
        ...
        (uint256 maxTeam, uint256 otherTeam, ) = getTeamDeposit(_user);
            ...
            if(total >= 2000e18 && user.teamNum >= 500 && user.directsNum >= 8 && maxTeam >= 500001e18 && otherTeam >= 500001e18){
                levelNow = 5;
    ...
    function level5BalanceDistribution_() private {
        uint256 level5Count;
        for(uint256 i = 0; i < level5.length; i++){
    ...
    function level4BalanceDistribution_() private {
        uint256 level4Count;
        for(uint256 i = 0; i < level4.length; i++){
    ...
    function level3BalanceDistribution_() private {
        uint256 level3Count;
        for(uint256 i = 0; i < level3.length; i++){
    ...
    function level2BalanceDistribution_() private {
        uint256 level2Count;
        for(uint256 i = 0; i < level2.length; i++){
