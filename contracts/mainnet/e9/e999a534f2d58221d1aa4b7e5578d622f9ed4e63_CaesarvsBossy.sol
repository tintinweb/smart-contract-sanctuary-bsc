...
// https://t.me/CaesarVsBossy

// Lp lock for 1 day
// LP lock for 1 week in 20k
// LP lock for 1 month in 50k
...
contract CaesarvsBossy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Caesar Vs Bossy";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x679c47b4A8F6a30f6016C3E8662AAD7649E9D64c;
        marketingFeeReceiver = 0x679c47b4A8F6a30f6016C3E8662AAD7649E9D64c;
