...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x368BC2B89dCd994Bf69Ed248887522C586967530;
...
contract Cyberse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa26411FD11dAf599575CC23b0c5301Ce93bE4B37;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Project Cyberse";
    string private _symbol = "PERSE";
