...
contract ASBAKINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ASBAK INU";
    string constant _symbol = "ASIKINU";
    ...
    uint256 public extraFeeOnSell = 45;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xe44C3FcA28b6911212C466Ee8114d07697db4663;
        marketingWallet = 0xe44C3FcA28b6911212C466Ee8114d07697db4663;
        Development = 0xe44C3FcA28b6911212C466Ee8114d07697db4663;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newDevelopment) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(Development).call{value: anothermarketingShare, gas: 30000}("");
