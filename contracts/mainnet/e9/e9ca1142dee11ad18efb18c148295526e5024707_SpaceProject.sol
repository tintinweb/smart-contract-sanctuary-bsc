...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x494d5120865959D97a5C907529771b587cB7d23C;
        _owner = msgSender;
...
contract SpaceProject is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0xebA46E30ed90A87a5cBe5297cd87b386Ebfa67cE; // Marketing wallet Address.
    address public developerAddress = 0xe5ECF21Ce635b42620262374977b9DA94D91F067; // Developer wallet Address.
    ...
    string private _name = "Space Project";
    string private _symbol = "SPCT";
    uint8 private _decimals = 18;
    
    uint256 public _liquidityFee = 5; //5% liquidity Fee
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _marketingFee = 1; // 1% marketing Fee
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _developerFee = 1; // 1% developer Fee
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) 
    {
        ...
        return _amount.mul(__totalFee).div(100);
    }
