...
contract Aptos2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x129994b518FA1b744C7e870346874fB188F30cdF); 
    address payable public Wallet_Utility = payable(0xAc83dB872347eC15210350f944b4848FF7179574);
    ...
    string private constant _name = "Aptos 2.0"; 
    string private constant _symbol = unicode"Aptos2"; 
    ...
    constructor () {
        ...
        _owner = 0xAc83dB872347eC15210350f944b4848FF7179574;
