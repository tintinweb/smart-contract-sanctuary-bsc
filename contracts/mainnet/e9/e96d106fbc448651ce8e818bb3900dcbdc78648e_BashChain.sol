...
/** 
Official Site : http://bashchain.site/
Telegram : https://t.me/BASHCHAIN_OFFICIAL
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAfa0714fbC7E25B42280B7999d967A714482c5Dd; // owner address
...
contract BashChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BashChain";
    string private _symbol = "SHELL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAfa0714fbC7E25B42280B7999d967A714482c5Dd); // Marketing Address
    address payable public teamWalletAddress = payable(0xAfa0714fbC7E25B42280B7999d967A714482c5Dd); // Team Address
