...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB020138Fd41C4C778f9d5c6A15ad4556b1bF0F67; // owner address
...
contract Diamondchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Diamondchain";
    string private _symbol = "Diamond";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB020138Fd41C4C778f9d5c6A15ad4556b1bF0F67); // Marketing Address
    address payable public teamWalletAddress = payable(0xB020138Fd41C4C778f9d5c6A15ad4556b1bF0F67); // Team Address
