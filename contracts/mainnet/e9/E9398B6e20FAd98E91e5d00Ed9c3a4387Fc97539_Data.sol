...
// assert(a == b * c + a % b); // There is no case in which this doesn't hold
    ...
    contract Base {
        ...
        Erc20Token public MCN   = Erc20Token(0xE4a7850E674DC2EF3c01C9DB85EF46e92B317E33);
...
contract Data is Base{
  ...
  public {
    ...
    function transferMCN(uint256 _value) public onlyowManager {
        require(block.timestamp.sub(_startTime)>=oneDay);
        MCN.transfer(zyaddress,_value);
