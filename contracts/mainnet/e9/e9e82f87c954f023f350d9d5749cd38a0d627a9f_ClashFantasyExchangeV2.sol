...
contract ClashFantasyExchangeV2 is Initializable {
        ...
        isOwnerCard(_tokenId)
    {
        ...
        contractCards.transferTo(wallet, _to, _tokenId, 1);
        ...
        historyCardExchanges[_tokenId].push(
            HistoryCardExchange(
                ...
                _to, 
                0,
                cardExchanges[_tokenId].price,
                block.timestamp,
                1
            )
        );

        emit HistoryCard(wallet, _to, 0, 1);
    }
    ...
    function sellCard(uint256 _tokenId) public {
        ...
        emit HistoryCard(wallet, msg.sender, 0, 0);
    }
