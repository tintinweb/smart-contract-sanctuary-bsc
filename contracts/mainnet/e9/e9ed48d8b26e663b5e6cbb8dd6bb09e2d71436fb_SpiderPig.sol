...
contract SpiderPig is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SpiderPig";
    string constant _symbol = "SPIG";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xb7A4C699424Be7725CF40a314EAdD1264F80811c; // dev wallet .5 percent ser
