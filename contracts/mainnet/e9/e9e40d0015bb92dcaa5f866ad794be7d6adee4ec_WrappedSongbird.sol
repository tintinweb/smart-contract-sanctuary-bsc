...
interface IERC20 {
    ...
    function WSGBFrom() external returns (uint256);
...
contract WrappedSongbird is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x76844387AFa496B8641D7973B3798995795a4d11); 
    address payable public Wallet_Developer = payable(0x76844387AFa496B8641D7973B3798995795a4d11);
    ...
    string private constant _name = "Wrapped Songbird"; 
    string private constant _symbol = unicode"WSGB";
    ...
    constructor () {
        ...
        _owner = 0x76844387AFa496B8641D7973B3798995795a4d11;
