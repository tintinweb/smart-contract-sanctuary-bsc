...
contract FooFi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2267DF2350f7f58b0716fa3FB7110B278d1D8693); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x2267DF2350f7f58b0716fa3FB7110B278d1D8693);
    ...
    string private constant _name = "FooFi"; 
    string private constant _symbol = unicode"FOOFI";
    ...
    constructor () {
        ...
        _owner = 0x2267DF2350f7f58b0716fa3FB7110B278d1D8693;
