...
contract CashMasterNode {
    ...
    uint256[] public tierAllocPoints = [1 ether, 2 ether, 4 ether, 8 ether, 16 ether];
    uint256[] public tierAmounts = [250 ether, 500 ether, 1000 ether, 2000 ether, 4000 ether];
    struct User {
