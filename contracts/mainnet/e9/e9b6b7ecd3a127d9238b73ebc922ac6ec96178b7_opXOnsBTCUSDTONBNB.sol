...
contract opXOnsBTCUSDTONBNB is ReentrancyGuard {
    ...
    constructor(
        ...
        USDTToken = IERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
        BTCBToken = IERC20(0x55d398326f99059fF775485246999027B3197955);
        btcAmount = _btcAmount;
        feePercentage = _feePercentage;
        holdDuration = _holdDurationInDays * 60;
        maxTimeToWithdraw = _maxTimeToWithdrawHours * 60;
    ...
    function release() public nonReentrant {
        ...
        require(amountOfUSDT >= strikePrice, "You have not insert the requiret amount of USDT to claim your BTC");
        uint256 amountOfBTC = balanceOfBTC();
        require(amountOfBTC >= 0, "There is no BTC to Withdraw");
        BTCBToken.safeTransfer(beneficiary, amountOfBTC);
    ...
    function refundAll() public {
        ...
        BTCBToken.safeTransfer(feeAddress, amountOfBTC);
        uint256 amountOfUSDT = balanceOfUSDT();
        if (amountOfUSDT > 0) {
            USDTToken.safeTransfer(feeAddress, amountOfUSDT);
        }
