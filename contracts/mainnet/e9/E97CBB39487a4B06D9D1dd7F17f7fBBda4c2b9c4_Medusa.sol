...
contract Medusa is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 200 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Medusa", "MEDUSA", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xc25682cA53a0692BeAc296496AE9aCEbef257cFf;
        treasuryReceiver = 0x22A48f1aBbcFCB987dB168AeE0F359237E1CD7Ae; 
        riskFreeFundReceiver = 0xC3DCB2cB23597A15F54c55245F4C1ce1760cf1f0;
        venomPit = 0x000000000000000000000000000000000000dEaD;
    ...
    function takeFee(
        ...
        _gonBalances[venomPit] = _gonBalances[venomPit].add(
            gonAmount.div(feeDenominator).mul(venomPitFee)
        );
