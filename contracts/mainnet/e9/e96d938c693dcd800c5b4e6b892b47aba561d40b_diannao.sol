...
contract diannao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "diannao";
    string private _symbol = "diannao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55552dfcB64C76d8809Be44d2A99932b04aB169B);
    address payable public teamWalletAddress = payable(0x55552dfcB64C76d8809Be44d2A99932b04aB169B);
