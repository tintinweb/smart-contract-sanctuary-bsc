...
Telegram : https://t.me/VLegacyPortal
Website : https://vlegacybsc.com/
*/
...
contract VirtuaLLegacy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_00_000_000 * 10**9;
    uint256 public _maxTxAmount = 2_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "VIRTUAL LEGACY"; // 
    string private constant _symbol = "$VLEGACY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x240160E1A338eE81dBB883f6E008c10Af2B98Bd6;
