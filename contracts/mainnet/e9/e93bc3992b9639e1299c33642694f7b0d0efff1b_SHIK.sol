...
contract SHIK is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIK";
    string private constant _symbol = "SHIK";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xBfd3a0F9862Ce16bD19884904Dc4591CB974F36E);
    address payable private _marketingAddress = payable(0xBfd3a0F9862Ce16bD19884904Dc4591CB974F36E);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 98, "Redis cannot be more than 98.");
	    require(redisFeeOnSell < 98, "Redis cannot be more than 98.");
	    require(taxFeeOnBuy < 98, "Tax cannot be more than 98.");
