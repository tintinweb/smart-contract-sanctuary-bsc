...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1bB17D8755D3e51E13D14f2d15920B2aFDbFe14; // owner address
...
contract BlueFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blue Floki";
    string private _symbol = "BF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFB6d72d8d32F8FE33073E50652105BBE3784B79f); // Marketing Address
    address payable private teamWalletAddress = payable(0xF1bB17D8755D3e51E13D14f2d15920B2aFDbFe14); // Team Address
