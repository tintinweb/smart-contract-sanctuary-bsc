...
contract bnbFOMO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "bnbFOMO";
    string private _symbol = "bFOMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2600f7f4C7e612a8C6C7e75E41D8Ba70d38D8801); // Marketing Address
    ...
    uint256 public _walletMax = 80 * 10**6 * 10**9;
