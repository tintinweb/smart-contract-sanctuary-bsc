...
/**
Telegram : https://t.me/botrugdetector
*/
...
contract BOT is Context, IERC20, Ownable {
    ...
    string private _name = "BOT RUG DETECTOR";
    string private _symbol = "BOTRUG";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x1A80f43f3332f72Dd4775778C2284800cC8dEc48); // Marketing Address
    address payable public teamWalletAddress = payable(0x1A80f43f3332f72Dd4775778C2284800cC8dEc48); // Team Address
