...
contract ACH is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        // Private 
        phaseDetails['PHASE_1'] = Phase(1655078400,1656115199,3000000000 * 1e18,3000000000 * 1e18,false,1); 
        // Presale 
        phaseDetails['PHASE_2'] = Phase(1656115200,1656633599,3000000000 * 1e18,3000000000 * 1e18,false,1);  
        // ICO
        phaseDetails['PHASE_3'] = Phase(1656633600,1688169600,3000000000 * 1e18,3000000000 * 1e18,false,1);  

        
        adminDetails['ADMIN_1'] = Admin(payable(ADMIN_WALLET_1),10);
