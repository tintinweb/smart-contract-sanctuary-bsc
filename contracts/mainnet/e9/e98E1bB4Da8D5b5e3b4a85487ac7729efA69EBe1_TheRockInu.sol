...
/**
The Rock Inu is a community driven platform promoting financial well-being by 
empowering people of all ages and cultures to be in control of their money and
...
contract TheRockInu is Context, IBEP20, Ownable {
    ...
    string private _name = "The Rock Inu"; // token name
    string private _symbol = "$Rock Token"; // token ticker
    ...
    uint256 public minTokenToSwap = 1250 * 1e9; // 
    uint256 public maxHoldingAmount = 40000 * 1e9;
    ...
    uint256 public BuyBackFeeOnBuying = 30;
    ...
    uint256 public BuyBackFeeOnSelling = 30;
