...
import "./LeonicornIJOLeos.sol";

/**
 * @title LeonicornIJOFactroy
 */
contract LeonicornIJOFactoryLeos is Ownable {
    ...
    function createIJO(
        ...
        bytes memory bytecode = type(LeonicornIJOLeos).creationCode;
        ...
        LeonicornIJOLeos(ijoAddress).initialize(
            _lpToken,
            _offeringToken,
            _startBlock,
            _endBlock,
