...
contract MetaRabbit
 is Context, IERC20, Ownable {
    ...
    string private _name = "MetaRabbit";
    string private _symbol = "MetaRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4Ec6f8d66724738c695111E1d148c26f7f4fDbe1);
    address payable public teamWalletAddress = payable(0x4Ec6f8d66724738c695111E1d148c26f7f4fDbe1);
    address public immutable deadAddress =0x4Ec6f8d66724738c695111E1d148c26f7f4fDbe1;
