...
contract BaiconToken is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold =  30000000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xd29A119094fd046E80C983966bEFcB9388a7BC43;
    ...
    constructor() BEP20("Baicon", "Baic") {
        _tokengeneration(msg.sender, 30000000 * 10**decimals());
        ...
        exemptFee[0xA86bE6782A57D73cA9EB6c7f77FdDD0801ec2482] = true;
        exemptFee[0xA86bE6782A57D73cA9EB6c7f77FdDD0801ec2482] = true;
