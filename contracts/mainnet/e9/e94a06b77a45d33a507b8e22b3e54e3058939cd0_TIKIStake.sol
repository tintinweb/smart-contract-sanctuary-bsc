...
contract TIKIStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [1 days, 2 days, 3 days, 4 days];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0x04FB9C05FeE1d523c82305d1d16F79d645a51F95; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x38F74C5419e0666834A9a74C1C03e3Ee8335fd06); // TKN Token address 
