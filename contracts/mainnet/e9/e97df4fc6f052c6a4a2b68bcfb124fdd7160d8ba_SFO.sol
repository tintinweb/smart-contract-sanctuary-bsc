...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Star Fishos';

    string constant public symbol = 'SFO';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 1010000000*10**uint256(decimals);
