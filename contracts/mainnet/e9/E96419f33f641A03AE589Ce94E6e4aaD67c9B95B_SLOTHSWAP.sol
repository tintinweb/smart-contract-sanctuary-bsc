...
/*    SLOTHSWAP
        Telegram : https://t.me/Slothswapbsc
*/
...
contract SLOTHSWAP is Context, IERC20, Ownable {
    ...
    string private constant _name = "SLOTH SWAP"; // 
    string private constant _symbol = "SWP"; //    
