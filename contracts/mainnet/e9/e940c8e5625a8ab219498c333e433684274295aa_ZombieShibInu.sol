...
contract ZombieShibInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zombie Shib Inu"; 
    string private _symbol = "ZSHIB"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20d1B377ea8D46bF1D86a8B9170549c3aC34Fb98); 
    address payable public teamWalletAddress = payable(0x20d1B377ea8D46bF1D86a8B9170549c3aC34Fb98); 
