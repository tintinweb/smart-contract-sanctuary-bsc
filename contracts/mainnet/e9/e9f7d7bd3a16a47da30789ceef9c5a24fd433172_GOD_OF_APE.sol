...
contract GOD_OF_APE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GODOFAPE";
    string private _symbol = "APEGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x603Fd0141E9F36f5a2185daAB0Ce6491e5faa95a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x603Fd0141E9F36f5a2185daAB0Ce6491e5faa95a); // BuyBack Address
