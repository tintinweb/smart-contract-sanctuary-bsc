...
contract BNBDAPP {
    ...
    uint public startTime = 1668859200; // Saturday, 19 November 2022 12:00:00 PM UTC https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _mkt) {
        ...
        plans.push(Plan(100, 30,  0.05 ether, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan(100, 35,  5 ether, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 100, 40,  10 ether, 50 ether, 0, 0, 0, 0, true));
	}
