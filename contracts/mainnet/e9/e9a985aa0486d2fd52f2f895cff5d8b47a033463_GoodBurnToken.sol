...
// File: contracts/Propios/Good Burn Token/Good Burn Token.sol
...
contract GoodBurnToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC753C79EEEaD6FFb6486FAd86e85F0352E7E48A4); 
    address payable public Wallet_Dev = payable(0x3DbB641c8083b5D9C79FabA7ba2cd6db84ADbf3A);
    ...
    string private constant _name = "Good Burn Token"; 
    ...
    constructor () {
        ...
        _owner = 0x3DbB641c8083b5D9C79FabA7ba2cd6db84ADbf3A;
