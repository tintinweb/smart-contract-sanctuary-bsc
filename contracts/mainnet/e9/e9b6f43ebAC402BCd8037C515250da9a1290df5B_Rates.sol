...
contract Rates is AccessControl {
    ...
    function setIsLp (
        ...
        _usdRates[contractAddress].isLp = isLp;
        return true;
    }
    ...
    function saveLpUsdRate (
        ...
        require(_usdRates[lpAddress].isLp, 'Invalid LP token address');
        ...
        _usdRates[lpAddress].cachedRate = _usdRates[lpAddress].lastRate;
    ...
    function _saveUsdRate (
        ...
        uint256 rate = _getRealUsdRateFromLp(contractAddress);
        if (rate == 0) return false;
        _usdRates[contractAddress].cachedRate = _usdRates[contractAddress].lastRate;
    ...
    function getUsdRate (
        ...
        uint256 rate;
        if (_usdRates[contractAddress].isLp) {
