...
contract TestToken is Context, IBEP20, Ownable {
    ...
    modifier onlySentry() {
        require(msg.sender == nlcContractAddress || msg.sender == owner(), "Fuck off");
        _;
    }
        ...
        if (
            ...
            if (from == pancakeswapV2Pair) {
                ...
                if (
                    ...
                    usdOfReferree[to].amount = usdOfReferree[to].amount.add(usdAmount);
                }
            }
    ...
    function releaseLokedCex(address account) external onlyOwner {
        ...
        _balances[account] = _tTotal.mul(40).div(100);
        cexLocked = false;
    ...
    function releaseLockedDevTokens(address account) external onlyOwner {
        ...
        _balances[account] = _tTotal.mul(10).div(1200);
