...
contract kermitgrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kermit Grow"; // 
    string private constant _symbol = "$KG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x658a05FB242beAbED3fE57e6021289c9270fA98c;
