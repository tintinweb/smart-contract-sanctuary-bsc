...
/**
 *  Created By: Gomu Dev
 *  Telegram: https://t.me/gomuinubsc
 *  Website: https://mobile.twitter.com/gomuinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1CC2bB1d47Fc854B030f095c7e7E5675e3A74d53; // owner address
...
contract GomuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gomu Inu";
    string private _symbol = "GOMU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CC2bB1d47Fc854B030f095c7e7E5675e3A74d53); // 
    address payable public teamWalletAddress = payable(0x1CC2bB1d47Fc854B030f095c7e7E5675e3A74d53); // 
