...
contract RABBITCAKE is IBEP20, Ownable {
    string private constant _name = "RabbitCake"; // Name
    string private constant _symbol = "RBTC"; // Symbol
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 100e6 * 10**_decimals; //Token Decimals
    ...
    uint256 public totalBuyFee = 4; //Total Buy Fee
    uint256 public totalSellFee = 4; //Total Sell Fee
    ...
    uint256 public swapLimit = 1e6 * (10**_decimals);
    ...
    constructor() {
        ...
        liquedityReceiver = address(0x725a153D206CA834398e28Cf7012580c271ddc11);
        marketFeeReceiver = address(0x725a153D206CA834398e28Cf7012580c271ddc11);
        devFeeReceiver = address(0x725a153D206CA834398e28Cf7012580c271ddc11);
