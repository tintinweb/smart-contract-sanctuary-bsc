...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe860dC0c5cDD330aF724Db79414171bF19b51111; // owner address
...
contract UTEP8 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UTEP-8";
    string private _symbol = "$U8";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xe860dC0c5cDD330aF724Db79414171bF19b51111); 
    address payable public teamWalletAddress = payable(0xe860dC0c5cDD330aF724Db79414171bF19b51111);
