...
contract Cheem1000XInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x48b91fbc1dB352BB6831268465822590f926e8f6); 
    address payable public Wallet_Dev = payable(0xdeD2ef9f97Ec6C20b346Da10Ab04b8757B5CD8D0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Cheem1000X Inu"; 
    string private constant _symbol = unicode"Cheem1000X Inu";
