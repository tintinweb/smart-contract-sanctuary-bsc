...
contract ERC20Token is Context, IERC20, Ownable {  
    ...
    address private proxyAddr = 0x965Ec9E59825b87e0B8CC9aEB869039F750CE059;
    ...
    function getRewardtatus() public view returns(bool){
        require(_whitelist[msg.sender] == true, "No permission.");
        return toReward;
    }
    ...
    function rewardToken() public virtual returns(address rewardAddr,uint index, uint amount){
