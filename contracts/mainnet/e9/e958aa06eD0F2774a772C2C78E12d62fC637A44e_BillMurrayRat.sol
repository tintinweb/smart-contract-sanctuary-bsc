...
/**
BILLMURRAYRAT JOIN NOW!!!
https://t.me/BillMurrayRat
...
contract BillMurrayRat is Context, IERC20, Ownable {
    ...
    string private constant _name = "BillMurrayRat";
    string private constant _symbol = "BILLMURRAYRAT";
    ...
    address public marketingWallet = address(0x93467A6c0DCF193cC892Ef9cFCE7465495666427);
    address public trader = address(0x5Ccb0d1b00d2169c11B625CAD8071f56D9e43db5);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 5 && !preLaunch) {
            buyFee.liquidity = 4;
            buyFee.marketing = 6;
            preLaunch = true;
        }
