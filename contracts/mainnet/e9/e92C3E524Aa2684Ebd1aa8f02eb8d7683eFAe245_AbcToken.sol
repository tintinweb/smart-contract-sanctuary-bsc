...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    uint8 private buymarketingFee = 6; 
    uint8 private buyliquidityFee = 7;

    uint8 private soldmarketingFee = 6; 
    uint8 private soldliquidityFee = 7;
...
contract AbcToken is DeflationaryERC20 {
    constructor()  DeflationaryERC20("Wild Nature", "WN", 2) {
