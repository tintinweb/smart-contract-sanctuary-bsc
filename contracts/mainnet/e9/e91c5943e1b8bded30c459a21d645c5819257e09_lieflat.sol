...
面对我们的时间、精力、体力、金钱、甚至智力不断被权力方当韭菜收割，

我们的唯一愿望只有躺平。什么是躺平？

“躺平”的核心逻辑就是，只要我躺平，内卷就卷不到我，镰刀就割不到我。
*/


/*https://t.me/lieflat_bsc*/
...
contract lieflat is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "lieflat";
    string private _symbol = "lieflat";
