...
// Phige Inu. Phinea's favorite doge.
...
library Address{
 ...
 contract PhigeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5AC9873F44e0F802C68aBa02A37fa5C43D26AAbc;
    address public donationWallet = 0x63A616aeDF48A243e830Ad8C445cD79756962d05;

    string private constant _name = "Phige Inu";
    string private constant _symbol = "PHIGE";
