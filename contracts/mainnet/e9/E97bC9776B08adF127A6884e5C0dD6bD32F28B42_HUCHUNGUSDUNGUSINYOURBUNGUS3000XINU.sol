...
LETS NOT ACT LIKE WE NEVER LIKED A LITTLE FINGER SWIRL AROUND THE BUNGUS! WELLNOW YOU GET THE DUNGUS THAT GOES IN THE BUNGUS!
...
contract HUCHUNGUSDUNGUSINYOURBUNGUS3000XINU  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'HUCHUNGUS DUNGUS IN YOUR BUNGUS3000XINU';
    string private constant _symbol = 'BUNGUS3000X';
