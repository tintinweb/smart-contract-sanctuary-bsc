...
Note: 
*As with all 4% tax tokens do not forget to use 6–8% slippage to avoid losing your funds to bots.
...
contract ZeroToHero is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "ZeroToHero";
    string constant _symbol = "ZTH";
    ...
    address public devFeeReceiver = 0x4a0Fa4c2054A3d490EA8e2DFc56128fC13b01803;
    address public buybackFeeReceiver = 0xb0430c219f8420c814FaC43abee9eBc0b4ECACcA;
