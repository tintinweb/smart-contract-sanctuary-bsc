...
/**
The aim of the MetaHub team is to create a platform that expands the use-case of the Metaverse space to business, education, and retail applications. 

The team believes that through MetaHub, we could push for an organic adoption from the blockchain technology to the gaming community and most importantly the general public. 

Fueled by experience & passion in Blockchain technology, the MetaHub team envisions the convenience of stepping into the Metaverse using a consumer-oriented platform. 

Unlike other virtual worlds and social networks, MetaHub is not controlled by a centralized organization. It is fully, and permanently controlled and owned by the community. 

Hence, there is no single agent or script with the power to modify the rules of the software, contents of land, economics of the currency, or prevent others from accessing their world. 

Metahub is a combined metaverse and NFT Staking.


A game wherein you can build & design your own city the way you wanted to.
It was inspired by the game Tycoon City which was published 2006.
...
MetaBox is a Reflection that rewards holders for every transaction you'll get 2%
The Unique function of MetaBox is a consumable virtual item which can be redeemed to receive a randomized selection of further virtual items, or loot, ranging from simple customization options for a Buildings/Theme Park/ Monuments or to a game-changing Buildings such
 as Unique Buildings and Tier 5 NFTs A loot box is typically a form of monetization, with players either buying the boxes directly within BSC Network or with which to redeem them.

 
All Opened MetaBox will automatically BURNED and over time the value of the MetaBox will increase.

Total Supply of MetaBox will be 500,000. 5% of the total supply will be used for rewards, airdrops and for more exciting events as soon we launch the Token
...
You can increase your HashPower by combining 3 different types of NFT with the same tier and with your MHT Tokens.
All tokens used for upgrading will also be sent to a dead address and will be burned.
...
You will stake your buildings in order to receive rewards from $MHT.

MetaHub is a unique metaverse project combining the aspects of social media, 
online gaming, augmented reality
virtual reality and cryptocurrencies to allow users
to interact virtually to create, experience, and monetize platform content.
...
contract MetaHub is Context, IBEP20, Ownable {
    ...
    string private _name = "MetaHub"; // token name
    string private _symbol = "$MHT"; // token ticker
    ...
    uint256 public minTokenToSwap = 12500 * 1e9; // 
    uint256 public maxHoldingAmount = 400000 * 1e9;
    uint256 public minBuyLimit = 100000 * 1e9;
    ...
    uint256 public marketWalletFeeOnBuying = 55;
    uint256 public burnFeeOnBuying = 5;

    uint256 public reflectionFeeOnSelling = 10;
    uint256 public liquidityFeeOnSelling = 30;
    uint256 public marketWalletFeeOnSelling = 55;
    uint256 public burnFeeOnSelling = 5;
