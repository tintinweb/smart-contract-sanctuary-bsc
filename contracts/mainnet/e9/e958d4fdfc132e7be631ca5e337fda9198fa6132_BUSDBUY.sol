...
contract BUSDBUY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BUSD??? BUY! ";
    string private _symbol = " $BUSDB "; 
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcC38BEABdbba6EF9327A20b60faF1830f7dcDC92);
    address payable private teamWalletAddress = payable(0xcC38BEABdbba6EF9327A20b60faF1830f7dcDC92);
