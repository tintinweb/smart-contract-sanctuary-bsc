...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBeB120E8a1081D10C90C9232e4ab3DD7AB0680FB; // owner address
...
contract LaysInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lays Inu";
    string private _symbol = "LAYS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBeB120E8a1081D10C90C9232e4ab3DD7AB0680FB); // Marketing Address
    address payable public teamWalletAddress = payable(0xF4985dE6C66c50D6DCc7b5511274050786A016CB); // Team Address
