...
contract SeaDoggtwo  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SeaDogge 2.0";
    string private _symbol = "SeaDogtwo";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xc9094946932070cb939fc10DEA75c948157406dA);
