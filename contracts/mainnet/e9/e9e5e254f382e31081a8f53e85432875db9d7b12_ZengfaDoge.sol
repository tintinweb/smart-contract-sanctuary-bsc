...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC1aA9E2a54C416164752E90406048E30D5A3FCD7));
        marketingWalletAddress = payable(address(0xC1aA9E2a54C416164752E90406048E30D5A3FCD7));
