...
// Telegram Chat: https://t.me/bsc413safemoonchat
// Telegram Group: https://t.me/BSC413SAFEMOON
...
contract SFM is Context, IERC20, Ownable {
    ...
    string private _name = "413SAFEMOON";
    string private _symbol = "413SFM";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x23f4a25A2b64ADcA9057B78C2F1373e4940c4Fbf); // Marketing Address
    address payable private TeamWallet = payable(0x23f4a25A2b64ADcA9057B78C2F1373e4940c4Fbf); // Buy Back Address
    ...
    uint256 private _totalSupply = 413 *  1**1 * 10**_decimals;
