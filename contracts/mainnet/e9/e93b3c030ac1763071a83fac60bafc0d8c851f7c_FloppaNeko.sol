...
contract FloppaNeko is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FloppaNeko";
    string constant _symbol = "Floppa";
    ...
    constructor () Auth(msg.sender) {
        ...
        Cr = 0xCf8CBF8ec1C875C0bB069daf37F0502035834444;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address Acr) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(Cr).call{value: anothermarketingShare, gas: 30000}("");
