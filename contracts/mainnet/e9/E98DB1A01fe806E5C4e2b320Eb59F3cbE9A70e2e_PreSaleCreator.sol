...
//	IERC20 public buyToken = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //endereço da token USDT utilizada para comprar (TESTENET)
	IERC20 public buyToken = IERC20(0x55d398326f99059fF775485246999027B3197955); //endereço da token USDT utilizada para comprar (MAINNET)
	//possível incluir no constructor para mais flexibilidade
	IERC20 public sellToken; //endereço da token que será vendida
//	IERC20 public taxToken = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //endereço da token USDT para cobrar a taxa (TESTENET)
	IERC20 public taxToken = IERC20(0x55d398326f99059fF775485246999027B3197955); //endereço da token USDT para cobrar a taxa (MAINNET)
