...
contract   Shineko is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 35_000 * (10**_decimals);
    uint256 public maxSellLimit = 35_000 * (10**_decimals);
    uint256 public maxWalletLimit = 35_000 * (10**_decimals);
    
    uint256 private asTime;
    uint256 private tTimer;
    address public marketingWallet = 0x69c08b7170aa5479984662FF378aA998D1F70223;
    address public devWallet = 0x69c08b7170aa5479984662FF378aA998D1F70223; 
    address public operationWallet = 0x69c08b7170aa5479984662FF378aA998D1F70223;
    address public charityWallet = 0x69c08b7170aa5479984662FF378aA998D1F70223; 

    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Shineko";
    ...
    Taxes public taxes = Taxes(0, 8, 0, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 18, 0, 0, 0, 0);
