...
contract JizzXRP is ERC20, Ownable {
    ...
    constructor() ERC20("JizzXRP", "$JIZZXRP") {
...
contract JizzXRPDividendTracker is DividendPayingToken, Ownable {
    ...
    JizzXRP public JizzXRPContract;
    ...
    constructor(
        ...
        defaultToken = token;
        JizzXRPContract = JizzXRP(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(JizzXRPContract);

            uint256 prevBalance = JizzXRPContract.balanceOf(address(this));
            ...
            {
                uint256 received = JizzXRPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    JizzXRPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
