...
contract QATARBOY is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0x5B2e6C90b05F99C98640cC051032925B3C142C99);
    ...
    string private constant _symbol = "QBOY";
