...
contract CORGISAMURAI is Context, IBEP20, Ownable {
    ...
    string private _name = "CORGI SAMURAI"; // token name
    string private _symbol = "COSAMU"; // token ticker
