...
contract WENCALL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "When Call ???";
    string private _symbol = "WCALL???";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xceeFa15147F553335E8EbE4e3765B852EE7E2563); // Marketing Address
    address payable private TeamWallet = payable(0x59Bb0644ACb80B23Fc2A3Ed7D9f5dEfFE28Bd354); // Buy Back Address
