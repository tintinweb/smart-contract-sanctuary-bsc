...
contract Andromeda is Context, IERC20, Ownable {
    ...
    string private _name = "Andromeda Network";
    string private _symbol = "ANDROMEDA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4eC634d8B10A8a20b23b48917a0A108E3e8808b1);
    address payable private developmentWalletAddress = payable(0x3B4De99336165d030f06d486340A274B6909a8af);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100 * 10**5 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
