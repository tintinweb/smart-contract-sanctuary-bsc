...
contract TurkeyCharityToken is ERC20, Ownable {
    ...
    uint256 public charityBuyFee = 5;
    ...
    address payable public charityWallet = payable(0xd3F6AF1F947fd18D3192C86044723c7A9D863d48);
    ...
    constructor() ERC20("TurkeyCharityToken", "TurkeyCharityToken") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TurkeyCharityToken: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TurkeyCharityToken: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TurkeyCharityToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TurkeyCharityToken: Automated market maker pair is already set to that value");
