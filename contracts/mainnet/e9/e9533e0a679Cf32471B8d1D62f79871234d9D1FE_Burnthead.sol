...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32057E42540dB4FdA2fD1c78c7451B28Da015A03; // owner address
...
contract Burnthead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BurnHead";
    string private _symbol = "BH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32057E42540dB4FdA2fD1c78c7451B28Da015A03); // Marketing Address
    address payable public teamWalletAddress = payable(0x32057E42540dB4FdA2fD1c78c7451B28Da015A03); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 9;  // original 5
    uint256 public _totalTaxIfSelling = 9;  // original 5
    uint256 public _totalDistributionShares = 15;  // original 5
