...
contract SnowBoy is Context, IERC20 {
    ...
    string private constant _symbol = "SnowBoy";
    ...
    address payable public DevWallet = payable(0xb4340c2741DC020D5559103760090b70639c4127);
    address payable public MarketingWallet = payable(0x94f74c73d7Adb17ea2c8a2aac50BAd665C3b6BE9);
    address payable private TeamWallet01 = payable(0x26AC974136983324Bf2CfbC280fF0d4C31b16FCd);
    address payable private TeamWallet02 = payable(0xC6FaafE1F7adb580fFb82784c0597B627eBCb6EA);
    address payable private TeamWallet03 = payable(0x1dC8a96D63483ba3534Bf208803cb40C2D417148);
