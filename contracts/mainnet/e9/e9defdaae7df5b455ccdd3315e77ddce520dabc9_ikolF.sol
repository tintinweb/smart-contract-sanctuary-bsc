...
contract ikolF is IBEP20, Auth {
    ...
    address GameDev          = 0xC480Bf019AB71a6DC6984F5eB02C622aE62e2100;
    address ContractDev      = 0xC480Bf019AB71a6DC6984F5eB02C622aE62e2100;
    ...
    uint256 public totalFee = marketingFee + liquidityFee + devFee + devFee2;
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = GameDev;
        devFee2Receiver = ContractDev;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(devFee).div(totalBNBFee).div(2);
