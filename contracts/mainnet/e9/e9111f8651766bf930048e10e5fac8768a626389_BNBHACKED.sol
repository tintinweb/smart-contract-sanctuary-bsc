...
// Party place : https://t.me/bnbhackedtoken
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x22890c388Bb6E89c45C9e674cc833bE8cb0BaAad);
...
contract BNBHACKED is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x22890c388Bb6E89c45C9e674cc833bE8cb0BaAad;

    string constant _name = "BNB HACKED";
    string constant _symbol = "$BNBHACK";
    ...
    function setMaxWalletPercent_base100(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 100;
    }
    function setMaxTxPercent_base100(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) / 100;
    }
