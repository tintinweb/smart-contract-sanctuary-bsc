...
contract StbReborn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StbReborn";
    string private _symbol = "SR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x626A592B0319b386Cb36fb826E4fe30e2A1EfaFd);
    address payable public teamWalletAddress = payable(0x626A592B0319b386Cb36fb826E4fe30e2A1EfaFd);
