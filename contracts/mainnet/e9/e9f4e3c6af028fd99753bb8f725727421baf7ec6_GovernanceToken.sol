...
contract GovernanceToken is ERC20 , Ownable , Pausable {
    ...
    {
        require(  ApprovedContracts[msg.sender] , "onlyAdminOrMinter - Admin/Minter Role Required." ) ;
        _;
    }
    ...
    function mintRequestedTokenByContracts ( address recipient , uint256 amount   ) public onlyContracts whenNotPaused returns (bool ) 
    {
    ...
    function burnRequestedTokenByContracts ( address recipient , uint256 amount   ) public onlyContracts whenNotPaused returns (bool )
    {
