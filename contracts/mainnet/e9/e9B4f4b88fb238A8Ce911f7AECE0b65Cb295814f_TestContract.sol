...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xd1421f138Fd1bCa936C1c4b2cCc80Fc133372e77);
...
contract TestContract is IBEP20, Auth {
    ...
    address DEV = 0x71876E7ccB5A2e1489DD95E355db07779E3024a9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != treasuryFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver){
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        treasuryFee = _treasuryFee;
        devFee = 1;
        totalFee = _liquidityFee.add(_reflectionFee).add(_treasuryFee).add(devFee);
