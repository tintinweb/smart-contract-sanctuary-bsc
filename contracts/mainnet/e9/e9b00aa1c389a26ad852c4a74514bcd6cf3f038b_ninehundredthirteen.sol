...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x911119669B26300F8C8711011bDfa6C8f48566E4; // owner address
...
contract ninehundredthirteen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "913";
    string private _symbol = "913";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x911119669B26300F8C8711011bDfa6C8f48566E4); // 
    address payable public teamWalletAddress = payable(0x911119669B26300F8C8711011bDfa6C8f48566E4); // 
    ...
    uint256 private _totalSupply = 913 * 10**_decimals;
