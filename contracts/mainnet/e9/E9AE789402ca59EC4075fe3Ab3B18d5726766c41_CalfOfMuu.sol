...
contract CalfOfMuu is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Calf of MUU';
    string private constant _symbol = 'CALF OF MUU';
    ...
    uint256 public swapThreshold = ( _tTotal * 600 ) / 100000; // .30% of total supply
    uint256 public _minTokenAmount = ( _tTotal * 20 ) / 100000; // .02% of total supply
