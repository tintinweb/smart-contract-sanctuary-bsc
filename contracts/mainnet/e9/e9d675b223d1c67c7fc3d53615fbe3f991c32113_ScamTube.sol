...
//***ScamTube
/**
    ScamTube = "Scammer YouTube" based on Elon Musk tweet. bullish af!

    Evolution of ScamTube (Scammer YouTube)

    2012 - Ads before a video
    2015 - Ads in between videos
    2018 - Double ads before a video % several ads in between videos
    2021 - Videos between in ads


    https://twitter.com/elonmusk/status/1534196611978383361 

    I create this token for community, so this will be community token. 
    If you want to make some hype, I suggest you to make tg @ScamTubePortal

    Features : 
    Tax buy/sell : 4% Low tax with Community driven will goes to LP + Marketing

    Max wallet : (4%) 400,000,000,000,000
    Max Tx     : (2%) 200,000,000,000,000

    Don't miss it !!!

*/

// TG: https://t.me/ScamTubePortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x6618E69692E93f069460fAa6836b03db3dC5AcC1); //Mainnet
...
contract ScamTube is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0x6618E69692E93f069460fAa6836b03db3dC5AcC1; // Mainnet
    ...
    address _marketingAdr = 0x254f263d87589F640a1F241A870989319aF49E69;
 
    string constant _name = "SCAMTUBE";
    string constant _symbol = "$SCAMTUBE";
