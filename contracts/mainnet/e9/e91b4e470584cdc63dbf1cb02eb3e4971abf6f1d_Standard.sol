...
contract Standard is Context, Ownable, IERC20 {
    ...
    string constant private _name = "Standard";
    string constant private _symbol = "Standard";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 previusMarketingFee = 0;
        uint256 previusdeveloperFee = 0;
        ...
        if(burnFee > 0) {
            previusMarketingFee = marketingFee;
            previusdeveloperFee = developerFee;
        ...
        if(burnFee > 0) { 
            ...
            developerFee = previusdeveloperFee;
        }
