...
contract TXXX is IBEP20, Auth {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    address MKT     = 0x374f5b0d0559B1Af57F99caAf49871013C0dC9aA;
    address PROJECT = 0x374f5b0d0559B1Af57F99caAf49871013C0dC9aA;
    address DEV     = 0x374f5b0d0559B1Af57F99caAf49871013C0dC9aA;

    string constant _name = "TXXX";
    string constant _symbol = "TXXX";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 400000000000000000000000000;
    // initial max transactrion amount of 100%
