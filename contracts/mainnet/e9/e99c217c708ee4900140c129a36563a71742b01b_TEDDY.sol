...
contract BaseToken is Ownable {
    ...
    string constant public name = 'TeddyDoge';

    string constant public symbol = 'TEDDY';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 14962344350*10**uint256(decimals);
