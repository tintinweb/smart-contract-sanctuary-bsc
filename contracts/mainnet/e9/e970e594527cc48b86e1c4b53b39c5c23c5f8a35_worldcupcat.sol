...
/**
Telegram : https://t.me/worldcupcat_portal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3E8a83E0E451aA7c8Fa11902550f2b6F3e20F6ac; // owner address
...
contract worldcupcat is Context, IERC20, Ownable {
    ...
    string private _name = "World Cup Cat";
    string private _symbol = "Wcupcat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75ac94f0B0D8eA6bBB47621fE7446f4c31cB0394); // Marketing Address
    address payable public teamWalletAddress = payable(0x3E8a83E0E451aA7c8Fa11902550f2b6F3e20F6ac); // Team Address
