...
contract GreenChartInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GreenChart Inu";
    string private _symbol = "PUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x959a15279Eac71704FA64004D1E2b18Db636C719); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5C8E7F398CC76c29d2057ea40eC9994Fc568a056); // BuyBack Address
