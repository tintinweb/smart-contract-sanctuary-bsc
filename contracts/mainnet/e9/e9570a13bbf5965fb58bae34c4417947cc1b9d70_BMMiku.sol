...
contract  BMMiku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Mini MIku";
    string private _symbol = "BMMiku";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x063c77FfFA28442B31b1B28BA654785Eb835f920); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x063c77FfFA28442B31b1B28BA654785Eb835f920); // Dev Address
