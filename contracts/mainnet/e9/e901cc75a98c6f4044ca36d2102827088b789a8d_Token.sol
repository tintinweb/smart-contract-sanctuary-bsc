...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        pcsV2Pair = IUniswapV2Factory(_pcsV2Router.factory())
            .createPair(address(this), address(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70));
    ...
    function _transfer(
        ...
        if (
            ...
            if(_buybackFee !=0){
                uint256 balance =  IERC20(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70).balanceOf(address(this));
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_liquidityFee != 0){
            ...
            uint256 initialBalance =  IERC20(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70).balanceOf(address(this));

            // swap tokens for ETH
            swapTokensForBNB(half); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

            // how much ETH did we just swap into?
            uint256 newBalance =  IERC20(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70).balanceOf(address(this)).sub(initialBalance);
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = address(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70);
    ...
    function swapBNBForTokens(uint256 amount) private {
         ...
         _approve(address(this), address(pcsV2Router), amount);
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70);
        path[1] = address(this);
        // make the swap
        pcsV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            amount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        _approve(address(this), address(pcsV2Router), tokenAmount);
        _approve(address(0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70), address(pcsV2Router), ethAmount);
        // add the liquidity
