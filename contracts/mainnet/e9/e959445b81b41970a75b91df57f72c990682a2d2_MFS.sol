...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function totalSupply() public view virtual override returns (uint256) {
        return _totalSupply - address(0xdead).balance;
    }
...
contract MFS is ERC20, Ownable{
    ...
    address public marketingWallet = 0xbFd03353AaA47D70684E4440aB35629b0A9B82Dc;
    address public lp = 0xaD9C3B63206B44d6eA782DaC84832C1103e32AE4;
    ...
    Taxes public taxes = Taxes(0,0,0); // BUY 0%
    Taxes public sellTaxes = Taxes(1,2,2);  //SELL 5%
    ...
    constructor() ERC20("Meta Force Space", "MFS") {
        _mint(msg.sender, 1e8 * 10 ** decimals());
        excludedFromFees[msg.sender] = true;

        IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //主网
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if( tokenpair[recipient] ) {   
            fee = amount * (sellTaxes.liquidity) / 100;
            burnAmt = amount * (sellTaxes.burn) / 100;
            marketingfee = amount * (sellTaxes.marketing) / 100; 
        }
        else {
