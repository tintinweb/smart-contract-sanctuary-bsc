...
contract Onigami is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa682C28814aeE827245f19A4DC73b8285ABe6Ebf); 
    address payable public Wallet_Dev = payable(0xa682C28814aeE827245f19A4DC73b8285ABe6Ebf);
    ...
    string private constant _name = "OGI"; 
    string private constant _symbol = unicode"Oni Inu"; 
