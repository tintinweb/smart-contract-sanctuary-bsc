...
contract Queenomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _devAddress = 0xd57aba08d2a52d4039Da4834D1eC022E0942B9fd;
    
    string constant _name = "Queenomics";
    string constant _symbol = "Queenomics";
