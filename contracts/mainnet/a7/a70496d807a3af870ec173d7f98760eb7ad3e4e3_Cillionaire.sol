...
// https://twitter.com/binance/status/1553772509044031488
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1FDB2c3851D067502Ce2122bE80a41ea212949E2); //PIGE INU
...
contract Cillionaire is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Cillionaire";
    string constant _symbol = "Cillionaire";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8A3BCF64d23B82af9E3963fb4befF51ED215aA4e; 
        devWallet = 0x8A3BCF64d23B82af9E3963fb4befF51ED215aA4e; 
