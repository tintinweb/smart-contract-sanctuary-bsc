...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf211a0ae3bAAF13D65C37adD50feFCEbc63990f4; // owner address
...
contract TRAVRAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TRAVRAT";
    string private _symbol = "TRAVRAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dEC28D83c174d3b75bA00A94F2927A5E2FCB2B0); // Marketing Address
    address payable public developmentWalletAddress = payable(0x0dEC28D83c174d3b75bA00A94F2927A5E2FCB2B0); // Development Address
