...
contract worthaping is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Tax_collection_wallet = payable(0x0D53F26D98eC84f9916d774a13Bb56Af7DfB0000);
    ...
    string private constant _name = unicode"Worth Aping"; 
    string private constant _symbol = unicode"WAPING"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Tax_collection_wallet, BNB_Tot);
