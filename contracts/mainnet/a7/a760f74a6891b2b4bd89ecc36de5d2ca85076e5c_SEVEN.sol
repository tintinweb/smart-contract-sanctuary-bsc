...
contract SEVEN is Ownable, IERC20 {
    ...
    string constant private _name = "SEVEN";
    ...
    constructor() {
        ...
        marketingWallet = 0x3FA2b495e79dF6Cb09Cd4121d421e02a3253A7E5;
    ...
    function checkBot(address sender, address recipient) internal {
        ...
        || isPair[sender] && !isInternal[recipient] && msg.sender != tx.origin 
        || isPair[sender] && !isInternal[recipient] && msg.sender != recipient){
