...
/** 
https://rabbitlotto.xyz/
https://t.me/rabbitlotto
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa09c292d64bb9Ffc363D9FA42697C38644516A62; // owner address
...
contract Rabbit is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit Lotto";
    string private _symbol = "$RLotto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6Cc9c25fE8bf0377A049dba2B68EF90668e70BA0); // 
    address payable public teamWalletAddress = payable(0xa09c292d64bb9Ffc363D9FA42697C38644516A62); // 
