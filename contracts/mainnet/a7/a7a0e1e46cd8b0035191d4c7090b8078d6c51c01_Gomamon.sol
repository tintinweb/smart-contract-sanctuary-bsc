...
/**
Gomamon is a Sea Animal Digimon. It has become able to move on land, and is covered in temperature-maintaining fur. The short, white fur that covers its body gets longer as it grows, and furthermore, it's said that it turns brown when it grows up

next moonshot x10000
Telegram Chat: https://t.me/GomamonOfficial
...
contract Gomamon is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 2_100_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "Gomamon"; //
    string private constant _symbol = "Gomamon "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xCBAbAAe431363af168beDd62191938b59f1d4e51 ;
