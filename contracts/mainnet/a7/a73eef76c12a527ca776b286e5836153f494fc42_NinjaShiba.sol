...
// CHANGE
contract NinjaShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Ninja Shiba";
    string constant _symbol = "NINJASHIBA";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x0E26db66FB0e1A68aC182268a43605456620B1D7);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _rewardFee, uint256 _shillFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        rewardFee = _rewardFee;
        shillFee = _shillFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_rewardFee).add(_shillFee);
