...
/*
Telegram: https://t.me/holobsc
website : http://holobsc.com
twitter : https://twitter.com/holobsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C7f98703B604Df4487f38c242f0270CEFf90309; // owner address
...
contract HOLOCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Holo Coin";
    string private constant _symbol = unicode"🎀ホロ🎀";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C7f98703B604Df4487f38c242f0270CEFf90309); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C7f98703B604Df4487f38c242f0270CEFf90309); // Team Address
