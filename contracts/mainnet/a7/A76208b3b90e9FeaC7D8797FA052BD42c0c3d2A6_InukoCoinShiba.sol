...
Telegram : https://t.me/InukoCoinShiba
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF57a07Bc46B4be6a880BE9586B9Ca5A34369a01a;
...
contract InukoCoinShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Inuko Coin Shiba"; // 
    string private constant _symbol = "$INUCOSHIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xF57a07Bc46B4be6a880BE9586B9Ca5A34369a01a);
