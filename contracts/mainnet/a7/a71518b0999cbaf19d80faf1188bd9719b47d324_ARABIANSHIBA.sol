...
/*
    ...
    MINISHARK & NETFLIX INU DEV

    Telegram    : t.me/ArabianShibaPortal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6686D796BcF2C1609ee1bd59442C692E3b006EbA; // owner address
...
contract ARABIANSHIBA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ARABIAN SHIBA";
    string private _symbol = "ARSH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6686D796BcF2C1609ee1bd59442C692E3b006EbA); // Marketing Address
    address payable public teamWalletAddress = payable(0x6686D796BcF2C1609ee1bd59442C692E3b006EbA); // Team Address
