...
contract BioApesv2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BioApes2.0"; 
    string private constant _symbol = "$BIO"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 9;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xd60b55f4836ED1a9Cf7A1859f0Eb39c643Fc7859;
