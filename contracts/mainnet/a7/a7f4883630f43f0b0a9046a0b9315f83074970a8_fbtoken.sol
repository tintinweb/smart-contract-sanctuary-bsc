...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xd6d425D784Db51d431C6760193E5372BD4Cc1feA;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xd6d425D784Db51d431C6760193E5372BD4Cc1feA),//fund address
    
        address(0xd6d425D784Db51d431C6760193E5372BD4Cc1feA)//dev address
    ){
