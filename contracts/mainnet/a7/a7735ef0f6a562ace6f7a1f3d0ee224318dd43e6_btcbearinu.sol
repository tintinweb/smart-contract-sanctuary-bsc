...
library Address{
 ...
 contract  btcbearinu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000_000 * 10**9;
    ...
    address public marketingWallet = 0xe47B0e89eB116779f33226970dE0a89ecC94068F;
    address public donationWallet =0xe47B0e89eB116779f33226970dE0a89ecC94068F ;

    string private constant _name = "btcbearinu";
    ...
    Taxes public sellTaxes = Taxes(1, 0, 10, 0);
