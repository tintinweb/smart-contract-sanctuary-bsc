...
// telegram : https://t.me/DogeCloudRocket

// Website : http://www.dogecloudrocket.space/
...
contract CryptoMoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD54a70338726c2bA76B0D33f26f1C21721D9B837); 
    address payable public Wallet_Dev = payable(0x18CDDcB6e327d9dAD55855446A945098d4FD3faB);
    ...
    string private constant _name = "Doge Cloud Rocket"; 
    string private constant _symbol = unicode"DCloud"; 
    ...
    constructor () {
        ...
        _owner = 0x8749018629d3f46c4D52628C3ae7C6fd872cb052;
