...
website : https://crystalorchins.com
https://t.me/crystalorchins
...
contract CrystalOrchins is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crystal Orchins";
    string private _symbol = "CSL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeE86dE58d3C2A7478aF46bE5EB523386690d6EA2); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x253C96D30403Aa77A314BDdD21f128009Ee06FD1); // Buyback Wallet Address
    ...
    uint256 public _walletMax = 400000000 * 10**9; // 4%
