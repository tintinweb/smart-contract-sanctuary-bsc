...
contract ZillaKingSon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zilla King Son";
    string private _symbol = "ZillaKingSon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5264f9cBB946d1a8c4DA83F484B905fd8A85AE9E);
    address payable public teamWalletAddress = payable(0x5264f9cBB946d1a8c4DA83F484B905fd8A85AE9E);
