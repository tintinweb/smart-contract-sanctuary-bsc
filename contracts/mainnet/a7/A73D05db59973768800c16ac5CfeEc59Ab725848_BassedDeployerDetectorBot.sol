...
TG: https://t.me/BassedDeployerDetectorBot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDb3A0424D799BBeAC9F4881Fb95b21c783db78A7; // owner address
...
contract BassedDeployerDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bassed Deployer Detector Bot";
    string private _symbol = unicode"BDDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDb3A0424D799BBeAC9F4881Fb95b21c783db78A7); // Marketing Address
    address payable public teamWalletAddress = payable(0xDb3A0424D799BBeAC9F4881Fb95b21c783db78A7); // Team Address
