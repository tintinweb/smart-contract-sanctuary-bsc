...
contract GlamorcoinStaking2{
    using SafeMath for uint256;
   
    address payable owner;
    BEP20 token = BEP20(0x646182Cf40692f15fd147b6A75E64c3ad895B88C);
    ...
    function withdrawal(address payable _address, uint _amount) external onlyOwner{
