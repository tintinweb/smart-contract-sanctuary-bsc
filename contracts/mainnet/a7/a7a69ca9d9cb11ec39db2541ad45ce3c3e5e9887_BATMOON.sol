...
contract BATMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BATMOON";
    string private _symbol = "BATMOON";
    ...
    address payable public teamWalletAddress = payable(0x9B6aa747Ad126da8d5e53ce819357C46FC4383CF); // Team Address
