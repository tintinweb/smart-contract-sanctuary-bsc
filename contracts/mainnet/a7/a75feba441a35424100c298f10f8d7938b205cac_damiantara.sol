...
contract damiantara is Context, IERC20, Ownable {
    ...
    string private constant _name = "Damian Tara"; // 
    string private constant _symbol = "DANTA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x645021791B4c326C6eD709FaBe5a588a0ff0CD5d;
