...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8aea361a71EC60d28E6f1d408D2B99497e27Bd62; // owner address
...
contract CUMONELON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CUM ON ELON";
    string private _symbol = "CUMELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8aea361a71EC60d28E6f1d408D2B99497e27Bd62); // Marketing
    address payable public teamWalletAddress = payable(0x8aea361a71EC60d28E6f1d408D2B99497e27Bd62); // Team
