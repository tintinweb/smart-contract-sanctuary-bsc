...
contract NewCommunityNeko is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Neko";
    string private _symbol = "NewCommunityNeko";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x99B11f5bcd8eF9cB269E7Efa913A302FA1d1388D);
