...
// 
//
// 📱 Telegram:https::https://t.me/+1QC8io0Y1HM4MjA9
...
contract $WhalesMerge is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Whales Merge", "WhalesMerge") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WhalesMerge";
    string private _symbol = "WhalesMerge";
