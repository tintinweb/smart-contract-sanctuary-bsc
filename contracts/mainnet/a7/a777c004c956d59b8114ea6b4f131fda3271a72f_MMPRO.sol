...
contract MMPRO is Context, IERC20, Ownable {
    ...
    string private _name = "MMPRO";
    string private _symbol = "MMPRO";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x3aa48883a45AD52a9DC4553283ED0AC8DCB6666B));
    address _tokenOwner;
