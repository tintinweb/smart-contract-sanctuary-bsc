...
/**
SPOOKY HAYYA (Stealth Launch)

Inspired by the world's first cup charity coin Hayya itself.
We are pleased to introduce to everyone the next charity coin that will focus on supporting those in dire situation.
Teamwork makes the dreamwork, this will be our mantra as we go on and spread the love for humanity.
Absolute Unique Spooky Hayya NFT's will be online at 20K Mcap and will be distributed to the loyal holders.

Credible DEV + Functional Team
Website + Featured Utilities @20K Mcap
Healthy Community + Lined-Up Callers

Website: In The Works
Telegram: @SpookyHayyaOfficial
*/
...
contract SpookyHayya is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Hayya"; // 
    string private constant _symbol = "SPKYHAYYA"; //    
