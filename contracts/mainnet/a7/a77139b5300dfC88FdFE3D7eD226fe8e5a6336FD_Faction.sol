...
library Address{
 ...
 contract Faction is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1000000 * 10**9;
    uint256 public maxSellLimit = 1000000 * 10**9;
    uint256 public maxWalletLimit = 1000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x88DBcFf6325f9316b77645C0Fe830AcDb7a768a1;
    address public donationWallet = 0x88DBcFf6325f9316b77645C0Fe830AcDb7a768a1;

    string private constant _name = "Faction";
    string private constant _symbol = "FACT";
    ...
    Taxes public sellTaxes = Taxes(0, 9, 2, 1);
