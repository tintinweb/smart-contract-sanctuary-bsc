...
contract BUDDY  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC82A83c239A0314d611A1cA02C8e6ba03f0DED2A); 
    address payable public Wallet_Dev = payable(0xC82A83c239A0314d611A1cA02C8e6ba03f0DED2A);
    ...
    string private constant _name = "Buddy Inu"; 
    ...
    constructor () {
        ...
        _owner = 0xC82A83c239A0314d611A1cA02C8e6ba03f0DED2A;
