...
/**
oBONE is a pool that generates yield for BONE hodlers
*/
...
contract oBONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "oBONE";
    string private _symbol = "oBONE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc07F2146B9666f13E87Ffb3a3e7cF280869c7331); // Marketing Address
    address payable public teamWalletAddress = payable(0xc07F2146B9666f13E87Ffb3a3e7cF280869c7331); // Team Address
