...
contract Test is IBEP20, Auth {
    ...
    string constant _name = "Need JP Keras Sir";
    string constant _symbol = "MakanyaSuruh Si Edy Panjul Tidur";
    ...
    address public Owner=0x203107724f6f6693DC868C8a36C41D1A273A73e7; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x203107724f6f6693DC868C8a36C41D1A273A73e7;
