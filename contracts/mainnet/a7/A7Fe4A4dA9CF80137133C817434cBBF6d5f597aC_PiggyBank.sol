...
contract PiggyBank is IBEP20, Auth {
    ...
    string constant _name = "Piggy Bank";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x25CF3511Cc31879C880DAF17fA8136F548CE95E1;
        marketingFeeReceiver = 0x25CF3511Cc31879C880DAF17fA8136F548CE95E1;
