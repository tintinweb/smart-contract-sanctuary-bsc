...
we introduce a limited edition cocacola product with 0 sugar!!!
and only sold a few bottles of drinks!
LFG

 ----------------------------------------------------
-
 -   Telegram 
    https://t.me/OfficialMetaverseCocacola

 -   Twitter
    https://twitter.com/MetaverseCoca
...
contract  Metaverse_Cocacola is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 70 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x79f40d46F269A1368bC73210ac4e06F69ef76D55));


    string private _name = " Metaverse Cocacola";
