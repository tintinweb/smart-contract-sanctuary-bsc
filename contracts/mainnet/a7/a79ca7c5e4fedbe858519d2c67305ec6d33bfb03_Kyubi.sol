...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //no rewards, save for later
...
contract Kyubi is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xebfFCE0e1E98ff7e1f7Ed64409e92470F22A8cab;
        teamFeeReceiver = 0xebfFCE0e1E98ff7e1f7Ed64409e92470F22A8cab;
        devFeeReceiver = 0xffA33651b726A0De3BDFd0eFE68084dB4d8A8848;
