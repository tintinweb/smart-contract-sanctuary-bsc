...
contract CMN is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x757794f4F81876AfBF098141CAEbE3CB9A287600;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**9 * 10**9;
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     function setAddressFee(address spender, uint256 taxFee) public onlyOwner {
        ...
        function setbusd(bool busd) external onlyOwner() {
        _busd = busd;
    }
}