...
contract ILLUMINECAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ILLUMINECAT"; 
    string private _symbol = "IllumineCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9E126b303385ac2D4ACB26001A35cff9a6f96312);
    address payable public teamWalletAddress = payable(0xe062c3543Ba11DF925dFCd101f1D55051BA54763);
