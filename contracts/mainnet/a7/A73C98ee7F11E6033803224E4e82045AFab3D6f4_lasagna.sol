...
contract lasagna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="lasagnaBEP";
    string private _symbol = unicode"LSG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x243a3c1821F21857472E92240fc4Dc748496BA16);
    address payable private taxWallet2 = payable(0x243a3c1821F21857472E92240fc4Dc748496BA16);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*500/1000; 
