...
contract RaceToRichMountain is IBEP20, Auth {
    ...
    string constant _name = "RaceToRichMountain";
    string constant _symbol = "RaceRich";
    ...
    address public marketingFeeReceiver = 0xD3700Ed3e57a0fF43197EACBB2F00DE04908C4cA;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 65; // 0.65%
    bool inSwap;
