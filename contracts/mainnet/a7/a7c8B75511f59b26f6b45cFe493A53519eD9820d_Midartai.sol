...
/*
  Midart AI Network (MIDAI) Token
  Midart AI Network is inspired by Chat GPT artificial intelligence program. 
  ...
  Midart AI Network artificial intelligence aims to provide software support to 
  cryptocurrency projects. Developed 100% community-driven and targeted, the Midart AI 
  project has released the entire BEP20 token created on the Binance Smart Chain network. 
  The Midart AI project, which has proven its reliability as 100%, has waived its smart contract 
  and has completely locked its liquidity.

  TotalFee: 2% [Marketing Fee: 2%]

  https://t.me/midartainetwork
  Website: midartai.network
...
contract Midartai is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 257000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Midart Ai";
    string private _symbol = "MIDAI";
    ...
    address public charityWallet = 0x171a50DE6a31d08282927d1b13861C136B1a7cF8;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 2570000 * 10**9;
    uint256 public _maxTxAmount = 257000000 * 10**9;
