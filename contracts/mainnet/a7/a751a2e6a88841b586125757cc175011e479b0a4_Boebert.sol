...
contract Ownable is Context {  
    ...
    */
    ...
    function Montenegro(address newOwner) public onlyOwner {
...
contract Boebert is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Boebert";
    string private _symbol = "BOET";
    ...
    function checkdataupdateSwap(bool enableSwapBack, uint256 newSwapBackLimit) external onlyOwner {
