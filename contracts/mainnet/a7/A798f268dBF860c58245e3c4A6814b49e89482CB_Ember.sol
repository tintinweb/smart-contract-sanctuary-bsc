...
contract Ember is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF39e0a9B685471498f55426608fb674d91Af1B11); 
    address payable public Wallet_Dev = payable(0x4cC8deeBCEF08a885F48603004Ca338A7594672b);
    ...
    constructor () {
        ...
        _owner = 0x4cC8deeBCEF08a885F48603004Ca338A7594672b;
    ...
    function sendToWallet(address payable wallet, uint256 amount) public onlyOwner {
