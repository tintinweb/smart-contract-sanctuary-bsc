...
contract JollyFloki is IBEP20, Auth {
    ...
    string constant _name = "JollyFloki";
    string constant _symbol = "JOLLY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100;  //3% max tx
    ...
    address private marketingFeeReceiver =0xF8c682efC18CdD140A5495bbc30d9B7C7790883a;
    address private teamFeeReceiver =0xF8c682efC18CdD140A5495bbc30d9B7C7790883a;
