    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd)); // RatKing - 0
...
contract ROYALRAT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address _owner, address _marketingWallet)
        ERC20("RoyalRat", "RRT", 9)
    {
        address newOwner = _owner; //make sure to transfer tokens to owner
        uint256 _totalSupply = 100 * 1e6 * 1e9; //100 million
        ...
        swapTokensAtAmount = (_totalSupply * 8) / 10000; // 0.08% swap tokens amount
