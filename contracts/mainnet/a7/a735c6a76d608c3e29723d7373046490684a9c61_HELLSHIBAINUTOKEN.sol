...
contract HELLSHIBAINUTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HELL SHIBA INU TOKEN";
    string private _symbol = "HSHIB";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xB48A21c2CBc668BCeA26fbb53C40d1d573b12ea6);
    address payable public teamWalletAddress = payable(0x28e8B90e9635eFb38116436BE34028A49f007261);
