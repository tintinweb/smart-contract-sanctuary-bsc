...
contract ANT is BEP20, Ownable {
    ...
    constructor(
        ...
        _mint(address(0x7D5f0b978001809aC4ee1FFe3DD9bf78F7CFD511), _total * (10**uint256(decimals)));
        ...
        isUniswapPair[IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), USDT)] = true;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require((!isStop[sender] && !isStop[recipient]),"address error");
