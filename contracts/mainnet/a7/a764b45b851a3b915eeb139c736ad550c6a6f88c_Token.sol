...
constructor() {
        name = "SHITCO.INU"; // Sets the name of the token, i.e Ether
        symbol = "SHT"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 69420000000000000000000000; // Holds an initial supply of coins
