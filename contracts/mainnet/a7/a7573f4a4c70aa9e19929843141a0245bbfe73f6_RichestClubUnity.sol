...
contract RichestClubUnity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Richest Club Unity";
    string private _symbol = "RCU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x703635772D26530AaaF076B2049fFFD8eC89c8E0);
    address payable public teamWalletAddress = payable(0x703635772D26530AaaF076B2049fFFD8eC89c8E0);
