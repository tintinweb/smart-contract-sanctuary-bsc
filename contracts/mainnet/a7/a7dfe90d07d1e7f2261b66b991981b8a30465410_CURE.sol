...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF022a223B30A58ac67a3e22aA664dEaDAa3b3bea;
...
contract CURE is Context, IERC20, Ownable {
    ...
    string private constant _name = "CURE BITCOIN"; // 
    string private constant _symbol = "CURE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 12;
    address payable public  _marketingWallet = payable(0xF022a223B30A58ac67a3e22aA664dEaDAa3b3bea);
