...
contract ST is ERC20, Ownable {
    ...
    function setBuyTaxes(uint256 rewardsFee) external onlyOwner {
        buyTokenRewardsFee = rewardsFee;
    }

    function setSelTaxes(uint256 rewardsFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(IERC20(usdtAddress).balanceOf(address(this)) >= minEthVal && 
    ...
    function process(uint256 gas) private {
        uint256 tokens = IERC20(usdtAddress).balanceOf(address(this));
