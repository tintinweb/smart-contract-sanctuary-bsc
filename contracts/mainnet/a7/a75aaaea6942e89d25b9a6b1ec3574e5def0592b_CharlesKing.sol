...
contract CharlesKing is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CharlesKing";
    string constant _symbol = "CharlesKing";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //100,000,000
