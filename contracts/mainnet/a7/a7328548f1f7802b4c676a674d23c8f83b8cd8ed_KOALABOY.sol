...
/*      Koala Boy 
            Telegram : https://t.me/koalaboytoken
*/
...
contract KOALABOY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Koala Boy", "KOBOY") {
        ...
        uint256 totalSupply = 1 * 10**30 * 10**9;
 
        maxWallet = totalSupply.div(20);
        swapTokensAtAmount = totalSupply.div(100);

        BuyTax = _buyTax;
		SellTax = _sellTax;
         
		_deployer = address(owner());
        marketingWallet = address(0xA81Aa985d6381B9784bbBEf0e514A4Ae45Ca1b9C);
