...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdAC2055C8dC6c0168A6c8A7812e0b8D6C6934a70; // owner address
...
contract RatSanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rat Santa";
    string private constant _symbol = "RS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5591307808d7AED35cbd15aFF960Be9f5606574); // Marketing Address
    address payable public teamWalletAddress = payable(0xdAC2055C8dC6c0168A6c8A7812e0b8D6C6934a70); // Team Address
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyTeamFee.add(_buyMarketingFee).add(_buyReflectionFee);
        _totalTaxIfSelling = _sellTeamFee.add(_sellMarketingFee).add(_sellReflectionFee);
