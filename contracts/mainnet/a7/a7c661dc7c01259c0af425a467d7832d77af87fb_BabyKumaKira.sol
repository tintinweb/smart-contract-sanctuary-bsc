...
/*
Telegram : https://t.me/BabyKumaKiraBSC
*/
...
contract BabyKumaKira is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Kuma Kira";
    string private _symbol = "BABY KUMAKIRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1046B7909361Ca06d00A32793589f41517eBc3dF); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1046B7909361Ca06d00A32793589f41517eBc3dF); // buyback Address
    ...
    uint256 public _walletMax = 5000000 * 10**9; 
