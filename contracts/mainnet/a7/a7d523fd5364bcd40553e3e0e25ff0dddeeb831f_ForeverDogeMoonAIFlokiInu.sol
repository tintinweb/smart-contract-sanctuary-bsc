...
contract ForeverDogeMoonAIFlokiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Forever Doge Moon AI Floki Inu";
    string private _symbol = "ForeverDogeMoonAIFlokiInu";
