...
// Dependency file: contracts/quantum/IterableMapping.sol
...
// Dependency file: contracts/quantum/QuantumDividendTracker.sol
...
// import "contracts/quantum/IterableMapping.sol";
...
contract QUANTUMPROTOCOLDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main QUANTUMPROTOCOL contract."
        );
    }
...
// Root file: contracts/quantum/Quantum.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/quantum/QuantumDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract QUANTUMPROTOCOL is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    QUANTUMPROTOCOLDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = QUANTUMPROTOCOLDividendTracker(
        ...
        */
        ...
        emit TokenCreated(owner(), address(this), TokenType.quantum, VERSION);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "QUANTUMPROTOCOL: The dividend tracker already has that address"
        );

        QUANTUMPROTOCOLDividendTracker newDividendTracker = QUANTUMPROTOCOLDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "QUANTUMPROTOCOL: The new dividend tracker must be owned by the QUANTUMPROTOCOL token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "QUANTUMPROTOCOL: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "QUANTUMPROTOCOL: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "QUANTUMPROTOCOL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "QUANTUMPROTOCOL: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "QUANTUMPROTOCOL: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "QUANTUMPROTOCOL: Cannot update gasForProcessing to same value"
        );
