...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address WBNBAddress = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        ...
        address ReceiveAddress = 0x591dA898D46c99F273F96Cd91B790846CBC51fE7;
    ...
    function _tokenTransfer(
        ...
        if (antiBotEnable){
            if (starBlock + checkBClistedBlockNumber <= block.number){
                require(!_Deny[sender],"bc");
            }
        }else{
            require(!_Deny[sender],"bc");
        }        
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000,
        address(0x591dA898D46c99F273F96Cd91B790846CBC51fE7)
    ){
    }
}