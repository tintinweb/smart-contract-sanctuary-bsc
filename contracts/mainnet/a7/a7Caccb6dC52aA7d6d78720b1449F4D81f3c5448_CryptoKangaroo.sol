...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multipliCryptoKangarooion overflow");
...
contract CryptoKangaroo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoKangaroo";
    string private _symbol = "CryptoKangaroo";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2B211127a024C1d1a5425D1D1eA42aAA6120C0Cc); 
    address payable private teamWalletAddress = payable(0x9F8b36304Bc92C94844Bc1e8e886c860441623e7); 
