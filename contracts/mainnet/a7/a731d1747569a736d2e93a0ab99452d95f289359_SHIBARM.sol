...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;// SPDX-License-Identifier: Unlicensed
...
contract SHIBARM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Arm";
    string private _symbol = "SHIBARM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5EFC2Ef17B86cbF5D460b443Ed8193b53D6D6072); 
    address payable public buyBackWalletAddress = payable(0x5EFC2Ef17B86cbF5D460b443Ed8193b53D6D6072); 
    ...
    uint256 public _walletMax = 10000000000000 * 10**9; 
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax, uint256 feeDenomnator) external onlyOwner() {
        _liquidityFee = newLiquidityTax;
        _marketingFee = newMarketingTax;
        _buyBackFee = newBuyBackTax;
        _extraFeeOnSell = feeDenomnator;
