...
contract xingmingDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "xingmingDAO"; // 
    string private constant _symbol = " $XMDAO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x345aFf9e87788d25a23ff1533AE651deb23280Af;
