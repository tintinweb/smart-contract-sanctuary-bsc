...
/**                                                                                                                                                                                                              
 ...
 \/__/~~/:/  / \:\~\:\ \/__/ \::::::::/__/ \::::::::/__/ \/__\:\/:/  /
     ...
     \/__/         \/__/         \/__/         \/__/         \/__/    
            ...
            Mezza - 𝒮𝒾𝓃ℊ 𝒯ℴ ℰ𝒶𝓇𝓃
                                  Website  : https://mezzatoken.com/
                                  Telegram : https://t.me/MezzaToken
...
contract MEZZA is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Staking = 0xD64c5e4E434b34Dbf329c46632b2b1b4edC07723;

    string constant _name = "MEZZA";
    string constant _symbol = "MZZ";
    ...
    uint256 MezzaRewardPool = 2;

    uint256 totalBuyFee = liquidityFee + StakingFee + marketingFee + MezzaRewardPool;
    uint256 totalSellFee = 8;
    ...
    uint256 public swapThreshold = _totalSupply / 260; // 0.02%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x9f58640223Bb333Cc0bAEc7e31F8f0C45Ad4a663;
        marketingFeeReceiver = 0x62110259A048a5A0310Ac95901cDE11bEed4d113;
        RewardPoolFeeReceiver = 0x075aDCcbb99cF1ADF31D16C01Ac00b034068938F;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 amountRewardPool = amountBNB.mul(MezzaRewardPool).div(totalBNBFee);
