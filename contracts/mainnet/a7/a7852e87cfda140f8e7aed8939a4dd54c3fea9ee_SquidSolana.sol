...
// TG: https://t.me/squidsolana
// First BSC Solana Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xfA54fF1a158B5189Ebba6ae130CEd6bbd3aEA76e); 
...
contract SquidSolana is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c ;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x5d72f680a7D56BbBDc8FE61C2AC4A35Bfa353c3D;

    string constant _name = "Squid Solana";
    string constant _symbol = "SS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 40000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 40000000000 * (10 ** _decimals);
