...
/**
Giving out $BULLS rewards and still wrecking the bears. 
only Baby backed by Bull's World.

telegram: https://t.me/BabyBullsWorldOfficial
website: Babybullsworld.com
...
contract Babybullsworld is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Bulls World";
    string constant _symbol = "BBW";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * 10**18;
    uint256 private _maxTxAmount = _totalSupply * 4 / 100;
    uint256 private _maxWalletToken = ( _totalSupply * 4 ) / 100;
    ...
    uint256 private swapThreshold = _totalSupply * 100 / 10000; // 0.35% of supply
    bool inSwap;
