...
/*
Mugiwara No Inu is a new community based token that is on Binance Smart Chain.
Inspired by incoming One Piece Movie Red, our developers want to build a community based token that inspired by it.
This will be number one community based token.
...
contract MugiwaraNoInu is IBEP20, Auth {
    ...
    string constant _name = "MugiwaraNoInu";
    string constant _symbol = "$MUGINU";
