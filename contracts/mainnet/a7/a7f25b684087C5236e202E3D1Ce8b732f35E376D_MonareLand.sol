...
contract MonareLand is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MonareLand", "MonareLandNFT"){
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _tokenAmount) public payable saleIsOpen {
        ...
        address payable sendTo = ownerWallet;
    ...
    function setOwnerWallet(address payable _address) external onlyOwner{
