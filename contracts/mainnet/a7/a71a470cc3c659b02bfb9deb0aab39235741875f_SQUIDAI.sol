...
contract SQUIDAI is Context, IERC20, Ownable {
    ...
    string private _name = "SQUID AI";
    string private _symbol = "Squid AI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x499A9f4ea12EbA9783Ded3473f782f09773B3A76); // Marketing Address
    address payable private developmentWalletAddress = payable(0x499A9f4ea12EbA9783Ded3473f782f09773B3A76); // Development Address
