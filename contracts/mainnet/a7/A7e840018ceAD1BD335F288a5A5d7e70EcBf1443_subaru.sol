...
contract subaru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SUBARU";
    string private _symbol = "SUBARU";
    uint8 private _decimals;
    address payable public marketingWalletAddress;
    address payable public teamWalletAddress;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public usd= 0x55d398326f99059fF775485246999027B3197955;
    address public marketingAddress = 0x358f70a2A4FD25a73D80FbbeDe163240f69bE101;
    address public teamAddress = 0x358f70a2A4FD25a73D80FbbeDe163240f69bE101;
    ...
    constructor (
        ...
        _maxTxAmount = 100 * 10**_decimals;
        _walletMax = 5000 * 10**_decimals;
