...
contract KAIDO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfF9e42F44cB11b9EAa0A90b071bD102FE14ecC3E);
    address payable public Wallet_Dev = payable(0x9C2F776f1077A8193EAa5c81867Fe4Dcdd216091);
    address payable public constant Wallet_Buyback = payable(0xB7f0F321D33D14841544193d363Bc2011b240864); 
    ...
    uint256 private Percent_Buyback = 20;
