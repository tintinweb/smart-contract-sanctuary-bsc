...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB6AcF55EaB260180bcAaaBE42Ca92c601b6824de;
...
contract Stella is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stella Spark"; // 
    string private constant _symbol = "$STEPAR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xB6AcF55EaB260180bcAaaBE42Ca92c601b6824de);
