...
// CHANGE
contract ArabianDoge2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Arabian Doge 2.0";
    string constant _symbol = "AD 2.0";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x73714Ec5e88eCe18FDa058a65350f1E6fE78d33E);
