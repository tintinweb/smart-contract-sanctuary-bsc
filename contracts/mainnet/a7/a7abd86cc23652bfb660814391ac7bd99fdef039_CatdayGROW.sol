...
contract CatdayGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "CatdayGROW"; //
    string private constant _symbol = "$CatGROW"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x22D041722738e34107BDbC6349840659827A68Fe;
