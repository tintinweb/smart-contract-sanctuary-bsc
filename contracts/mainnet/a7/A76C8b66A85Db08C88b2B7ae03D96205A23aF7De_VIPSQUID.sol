...
contract VIPSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VIP SQUID";
    string private _symbol = "VIPs";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf14bE47e656014041548dC3E423bCE82BF17e390); // Marketing Address
    address payable public teamWalletAddress = payable(0xf14bE47e656014041548dC3E423bCE82BF17e390); // Team Address
