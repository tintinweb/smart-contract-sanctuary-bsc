...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress,address FundAddress1,address FundAddress2, address FundAddress3,address ReceiveAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        isWalletLimitExempt[fundAddress1] = true;
        isWalletLimitExempt[fundAddress2] = true;
        isWalletLimitExempt[FundAddress3] = true;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount0 = fundAmount * 1 / 15;
        uint256 fundAmount1 = fundAmount * 12 / 15;
        uint256 fundAmount2 = fundAmount * 1 / 15;
        uint256 fundAmount3 = fundAmount * 1 / 15;
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount0);
        FIST.transferFrom(address(_tokenDistributor), fundAddress1, fundAmount1);
        FIST.transferFrom(address(_tokenDistributor), fundAddress2, fundAmount2);
        FIST.transferFrom(address(_tokenDistributor), fundAddress3, fundAmount3);
    ...
    function setFundAddress1(address addr) external onlyFunder {
        fundAddress1 = addr;
        _feeWhiteList[addr] = true;
    }
    ...
    function setFundAddress3(address addr) external onlyFunder {
        fundAddress3 = addr;
        _feeWhiteList[addr] = true;
    }
...
contract btcdao is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        2800,//Supply
        address(0xE147C28AC005FD81F5A4E6E14612c642CccE40b3),//FundAddress
        address(0xE147C28AC005FD81F5A4E6E14612c642CccE40b3),//FundAddress1 duo
        address(0xE147C28AC005FD81F5A4E6E14612c642CccE40b3),//FundAddress2
        address(0xE147C28AC005FD81F5A4E6E14612c642CccE40b3),//FundAddress3
        address(0x93c1e7Ac6A86A5E386Dd1a2b9F2Ad74AA7dF76Bd)//ReceiveAddress
    ){
