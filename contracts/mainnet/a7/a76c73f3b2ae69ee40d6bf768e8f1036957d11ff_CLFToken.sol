...
contract CLFToken is ERC20Burnable, Ownable {
    ...
    modifier onlyMinter() {
        require(minter[msg.sender], "CLF: not minter");
        _;
    }
    ...
    function setMinter(address account, bool flag) public onlyOwner {
        minter[account] = flag;
    }

    function mint(address to, uint256 amount) public onlyMinter {
        require(totalSupply() + amount <= 10000000 ether, "CLF: Maximum supply is 10 million");
        _mint(to, amount);
    }
