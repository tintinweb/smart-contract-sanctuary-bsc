...
contract hJT is IERC20, Ownable {
    ...
    address private fundAddress = address(0xA6AD5909d8AB83Ed7d01e9D050f859Ac2aC95aeE);
    address private fundAddress2 = address(0xCa35E747158fE5EcD2FeC2F2cAD46740386D6F5D);

    address private lpAddress = address(0xC8bc267C3Ed6FaCdBc2232F70107B8F9F304d0F4);
    ...
    function _transfer(
        ...
        if (!isRoute[to] && (to != _destroyAddress)) {
            takeFee = true;
        }
