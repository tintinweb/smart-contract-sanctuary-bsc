...
/*
    Contrato de NFT da 5ª raridade da Rayons
...
contract RayonsNewNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    "https://bafybeig5idiqcauvuwbeuqn27rjqckvsllei7rsznd4uqr6hmvjidpo57e.ipfs.nftstorage.link";

    mapping(address => bool) public mappingAuth;

    constructor() ERC721("RayonsNFT", "RYS_NFT") {}

    modifier onlyAuth() {
        require(_msgSender() == owner() || mappingAuth[_msgSender()], "Nao autorizado");
        _;
    }
