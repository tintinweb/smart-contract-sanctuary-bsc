...
contract SquidAlvey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Squid Alvey";

    string private _symbol = "Squid Alvey";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x7123e62A42cA3CBb5e7c410Aa5EDEdE228204002;
