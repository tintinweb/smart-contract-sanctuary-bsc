...
contract MomentumToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Momentum Token";
    ...
    uint256 _totalSupply = 1234567890 * (10 ** _decimals); // 210000000 * 10**_decimals
