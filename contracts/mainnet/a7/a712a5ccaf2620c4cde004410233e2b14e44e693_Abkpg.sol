...
contract Abkpg is Context, IERC20, Ownable, Pausable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Abkpg Token";
    string private _symbol = "Abkpg";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {//buy
            ...
            if(_transferFee > 0) {
                ...
                _balances[treasuryAddress] = _balances[treasuryAddress].add(feeAmount);
                emit Transfer(sender, treasuryAddress, feeAmount);
            }
        }
