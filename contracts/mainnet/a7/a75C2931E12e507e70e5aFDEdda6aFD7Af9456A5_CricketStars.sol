...
/******************************************************************************
Buy & Sell Fee 2% Marketing, 1% Auto Burn, 4% Reflection/Reward In BNB
********************************************************************************/
...
contract CricketStars is Context, IERC20, Ownable {  
    ...
    string private _name = "Cricket Stars";
    ...
    uint256 public constant  _TaxFee = 7;
    uint256 public constant  _marketingPer = 2;
    uint256 public constant  _autoBurnPer = 1;
    uint256 public constant  _RewardPer = 4;
    uint256 public constant  _subMarketingPer = 5;  
    ...
    function _transfer(
        ...
        _tokenTransfer(from,to,amount,TaxType);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,uint TaxType) private {
