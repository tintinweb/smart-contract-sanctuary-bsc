...
// 
//
// 📱 Telegram:https:://https://t.me/+ObpIWwtI_bYzOTRl
//
...
contract $SAUDITATEDOGE is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SAUDITATE DOGE", "SAUDITATEDOGE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SAUDITATEDOGE";
    string private _symbol = "SAUDITATEDOGE";
