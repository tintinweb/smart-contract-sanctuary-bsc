...
/**
ShibaQatar - Mystery launch



Join us on TG : https://t.me/+vJL9c9fxkS42MGQ0
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfdF7714cE76Bcf675CAc3C17797FECc22b706A1B; // owner address
...
contract ShibaQatar is Context, IERC20, Ownable {
    ...
    string private _symbol = "$QSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfdF7714cE76Bcf675CAc3C17797FECc22b706A1B); // Marketing Address
    address payable public teamWalletAddress = payable(0xfdF7714cE76Bcf675CAc3C17797FECc22b706A1B); // Team Address
