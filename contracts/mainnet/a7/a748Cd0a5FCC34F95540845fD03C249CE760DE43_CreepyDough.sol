...
For reference: https://twitter.com/CryptoWendyO/status/1602700815747014662

Lets try this as a community driven coin with low tax. 

Make TG. Or what for me to make it.
...
contract CreepyDough is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Creepy Dough Currency";
    string constant _symbol = "$Creepy Dough Currency";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(1000).mul(100);
    uint256 public _maxWalletToken = _totalSupply.div(1000).mul(100);
