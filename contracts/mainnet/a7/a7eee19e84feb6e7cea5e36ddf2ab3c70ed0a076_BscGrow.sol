...
contract BscGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xaBD826Ef1bC98548AFa64DDA85cE9eD2267a90f3); // Marketing Address

    address payable public teamAddress =
        payable(0xB743ab7c1AfEeB2A7b3152Cf3e553cd35576932E); //  Development Address

    address payable public liquidityAddress =
        payable(0xB743ab7c1AfEeB2A7b3152Cf3e553cd35576932E); // Liquidity Address
    ...
    string private constant _name = "BSC GROW";
    string private constant _symbol = "BSCG";

    uint8 private constant _decimals = 18;

    uint256 private constant BUY = 7;
    uint256 private constant SELL = 7;
