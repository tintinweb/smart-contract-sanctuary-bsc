...
隱形發射 - Yuan Xiao Jie | 元宵节
關於元宵節的起源
有一個傳說故事，講述的是一位智者在中國古代漢朝首都長安城（公元前 202 年至前 220 年）將悲劇變成狂歡節的故事廣告。
東方朔是當時皇帝的謀士
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE2b0b8A9F777FD48c26c20fE9c9C44Bdfa236F07;
...
contract yuanxiaojie is Context, IERC20, Ownable { 
    ...
    string private _name = "yuan xiao jie"; 
    string private _symbol = "YUXIE";  
    ...
    */
    ...
    address payable public Wallet_Marketing = payable(0xE2b0b8A9F777FD48c26c20fE9c9C44Bdfa236F07);
