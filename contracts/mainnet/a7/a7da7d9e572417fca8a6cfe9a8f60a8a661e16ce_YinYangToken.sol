...
contract YinYangToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("YinYang", "YY", uint8(DECIMALS)) Ownable() {
        ...
        address _owner = 0xb988FD16a903b73506c2a4d5a91C1ef29942B05e;
    ...
    function setAllFees ( uint256 _liquidityFee, uint256 _lotteryFee, uint256 _treasuryFee, uint256 _firePitFee ) external isAuth {
        ...
        require(liquidityFee>0 && lotteryFee>0 && treasuryFee>0 && firePitFee>0, "All fees must be greater than 0");
