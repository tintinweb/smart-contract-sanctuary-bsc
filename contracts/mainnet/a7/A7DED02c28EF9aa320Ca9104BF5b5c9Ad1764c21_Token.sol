...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x0CA7c0571a66ea6F4bE260085251b1e87399133E;
        _mark = 0x3eE29adfdE66d86Bdf64F511fbfcb9495382374c;
        _pool = 0x72f1eAAD481593e5E6a862Dc398833ec7D3e6C18;
    ...
    function _transfer(
        ...
        if (usdts >= _maxusdt && !_swapping && sender != _pair) {
            _swapping = true;
            // pool 2%
            IERC20(_usdt).transfer(_mark, usdts * 2 / 4);
            // fund 2%
            IERC20(_usdt).transfer(_pool, usdts * 2 / 4);
            // usdt to fbox 1%
            _swapUsdtForToken(_gow, usdts * 0 / 4);
            _swapping = false;
            isbonus = true;
        }
        ...
        // burn 3%
        _balances[_dead] += (amount * 4 / 100);
        emit Transfer(sender, _dead, (amount * 4 / 100));
