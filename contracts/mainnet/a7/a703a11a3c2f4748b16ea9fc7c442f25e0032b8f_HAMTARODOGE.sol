...
contract HAMTARODOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HAMTARODOGE";
    string constant _symbol = "HAMD";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBrelfection = amountBNB.mul(reflectionFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBrelfection}() {} catch {}
