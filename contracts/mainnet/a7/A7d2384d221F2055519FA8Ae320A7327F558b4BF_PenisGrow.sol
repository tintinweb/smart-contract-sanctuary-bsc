...
/*
    PENIS GROW - YOUR ONLY CHANCE TO HAVE A BIG PENIS

    Portal: https://t.me/PenisGrow
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa49f6aF5275FB9628261DFc7C40b219e1f39C898; // owner address
...
contract PenisGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PenisGrow";
    string private _symbol = "Penis Grow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa49f6aF5275FB9628261DFc7C40b219e1f39C898); // Marketing Address
    address payable public teamWalletAddress = payable(0xa49f6aF5275FB9628261DFc7C40b219e1f39C898); // Team Address
