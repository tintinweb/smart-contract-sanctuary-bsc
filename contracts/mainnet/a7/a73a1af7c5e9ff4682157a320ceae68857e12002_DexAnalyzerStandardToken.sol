...
contract DexAnalyzerStandardToken is ERC20, Ownable {
    ...
    constructor(
        ...
        buyTotalFees = buy.marketing + buy.liquidity + buy.safe; //Max 9%
        sellTotalFees = sell.marketing + sell.liquidity + sell.safe; //Max 8%
        ...
        onlyOwner
    {
        ...
        require(buyTotalFees <= 9, "Can't be more than 9%");
    }
        ...
        onlyOwner
    {
        ...
        require(sellTotalFees <= 8, "Can't be more than 8%");
    }
