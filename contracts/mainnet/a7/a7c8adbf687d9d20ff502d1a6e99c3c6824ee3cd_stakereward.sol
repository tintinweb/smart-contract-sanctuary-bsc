...
contract stakereward {
        ...
        public
    {
        ...
        uint256 _type = usrLastLevel[msg.sender];
        if(_type < stakeLevel.length.sub(1))
        {
            _type = usrLevelStakeCounts[msg.sender][_type] >= 3?_type+1:_type;
        }
    ...
    function setRestake(uint256 _id)
        external
