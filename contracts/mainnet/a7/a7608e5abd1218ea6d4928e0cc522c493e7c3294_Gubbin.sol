...
/**
Telegram: https://t.me/GubbinsBlackPortal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB5520194d26A856A358525A14d4c081fa1186D5E; // owner address
...
contract Gubbin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gubbin Black";
    string private _symbol = "GB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB5520194d26A856A358525A14d4c081fa1186D5E); // Marketing Address
    address payable public teamWalletAddress = payable(0xB5520194d26A856A358525A14d4c081fa1186D5E); // Team Address
