...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1897054D991B18521D7a92C6508BC093909F886c; // owner address
...
contract LUNARCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNAR CAT";
    string private _symbol = "LCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1897054D991B18521D7a92C6508BC093909F886c); // Marketing Address
    address payable public teamWalletAddress = payable(0x1897054D991B18521D7a92C6508BC093909F886c); // Team Address
