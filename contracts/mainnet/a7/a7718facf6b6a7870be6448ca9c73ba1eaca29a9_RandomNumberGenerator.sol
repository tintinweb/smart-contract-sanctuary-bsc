...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Tmf lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == tmfLottery, "Only TmfLottery");
    ...
    /**
     * @notice Set the address for the TmfLottery
     * @param _tmfLottery: address of the Tmf lottery
     */
    function setLotteryAddress(address _tmfLottery) external onlyOwner {
        tmfLottery = _tmfLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ITmfLottery(tmfLottery).viewCurrentLotteryId();
    }
}