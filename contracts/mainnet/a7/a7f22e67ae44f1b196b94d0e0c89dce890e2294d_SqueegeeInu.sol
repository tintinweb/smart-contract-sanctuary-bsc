...
contract SqueegeeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SQUEEGEE INU";
    string constant _symbol = "SqueegeeInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * 10**_decimals;

    uint256 public _maxTxAmount = 10000 * 10**_decimals;
    uint256 public _maxWalletToken = 400 * 10**_decimals;
