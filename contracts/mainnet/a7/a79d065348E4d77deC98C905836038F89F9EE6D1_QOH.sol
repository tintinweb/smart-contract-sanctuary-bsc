...
contract QOH is QOHDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private QOHTeam;
    address private CharityQOH;
    ...
    string public override name = "Doge Hunter ";
    string public override symbol = "QOH";
    ...
    constructor(uint totalSupplyValue, address QOHTeamAddress, address CharityQOHAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        QOHTeam = QOHTeamAddress;
        CharityQOH = CharityQOHAddress;
       
        // split the tokens according to agreed upon percentages
        balances[QOHTeam] =  totalSupply * 4 / 100;
        balances[CharityQOH] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's QOHTeam pot
