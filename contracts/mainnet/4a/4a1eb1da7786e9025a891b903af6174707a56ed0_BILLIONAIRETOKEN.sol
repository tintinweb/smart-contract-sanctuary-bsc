...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB73021F63ccdfAfb236a9e38ee85BFe2d2b9BB3f; // owner address
...
contract BILLIONAIRETOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BILLIONAIRE TOKEN";
    string private _symbol = "$BT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02d08DC04bAF2Bf0C9AA369cAD7Bb1103052c789); // Marketing Address
    address payable public teamWalletAddress = payable(0xC8642aD4A016605A1fc25A0552bfdBcfD788EAcA); // Team Address
