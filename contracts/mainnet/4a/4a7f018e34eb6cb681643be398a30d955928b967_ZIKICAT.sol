...
contract ZIKICAT is IBEP20, Auth {
    ...
    string constant _name = "ZIKI CAT COIN";
    string constant _symbol = "ZIKI CAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; 
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1; 
    ...
    address public marketingFeeReceiver = 0x0C865fE8d3730B6A910b6273E2eabf8eA7d7EDc3;
    address public devFeeReceiver = 0x277c00F6d0F067FcC2e5fB8F9eD26Ad5F34f0115;
