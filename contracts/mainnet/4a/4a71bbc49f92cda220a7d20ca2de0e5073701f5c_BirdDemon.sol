...
contract BirdDemon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BirdDemon";
    string private _symbol = "BirdDemon";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x5A8f36C8811DfDDe6EAF3DA2ce99ccbe02558067);
