...
contract CATCOINDAO  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATCOIN DAO";
    string private _symbol = "CATCOINDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4427C98dce38e8178753E0fcDC6c6d015Cb2B37C); 
    address payable public teamWalletAddress = payable(0x854B25AC57eFe1E7B109f33D3FA4224d1126bCa4); 
