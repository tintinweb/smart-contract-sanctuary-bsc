...
contract NRBTCToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1900000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'NRBTC';
    string private _symbol = 'NRBTC';
    uint8 private _decimals = 6;
    
    address private _burnPool = address(0xB856ea0534AC14308D78FEF1a5Cf1012e6FEff32);
    address public _exchangePool = address(0);
    address public _burnAddress = address(0xB856ea0534AC14308D78FEF1a5Cf1012e6FEff32);
    ...
    uint256  _buyInviterFee;
    uint256  _sellInviterFee;
