...
contract VBNB
 is Context, IERC20, Ownable {
    ...
    string private _name = "Vitalik Zhao";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x98847cb034185Ef9174A8E190ecedDcFe4d44C32));
        _anotherA = payable(address(0x98847cb034185Ef9174A8E190ecedDcFe4d44C32));
