...
/**
   ...
   I make this #Moonsafe to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/MoonsafeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #Moonsafe to the community and ensure it's 100% safe.

   I will add .5 BNB and 99% of the total supply to the pool
   Can you make #Moonsafe 10000000X? 
...
contract Moonsafe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Moonsafe";
    string private constant _symbol = "Moonsafe";
    ...
    address payable public DonationsAddress = payable(0x904b88b0aE5d91b49725432ee50f2f32a824Dda3);
    ...
    address public DonationsWallet = 0x904b88b0aE5d91b49725432ee50f2f32a824Dda3;
