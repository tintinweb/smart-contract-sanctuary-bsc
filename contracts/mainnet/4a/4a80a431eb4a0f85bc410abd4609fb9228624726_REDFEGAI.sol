...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 50 / 10000;
            if (burnAmount > 0) {
...
contract REDFEGAI is AbsToken {
    constructor() AbsToken(
        ...
        address(0x8fE4CdfBe144266a8bD8C4e8c328F8CE5291A251),//FundAddress
        address(0x702B2b0bEef42eB70f6816c452DEA12153A9c194)//ReceiveAddress
    ){
    }
}