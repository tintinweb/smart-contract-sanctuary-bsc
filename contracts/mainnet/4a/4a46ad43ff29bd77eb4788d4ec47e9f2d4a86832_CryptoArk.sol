...
/*
 ...
 _____                  _         ___       _    
/  __ \                | |       / _ \     | |   
| /  \/_ __ _   _ _ __ | |_ ___ / /_\ \_ __| | __
| |   | '__| | | | '_ \| __/ _ \|  _  | '__| |/ /
| \__/\ |  | |_| | |_) | || (_) | | | | |  |   < 
 \____/_|   \__, | .__/ \__\___/\_| |_/_|  |_|\_\
             __/ | |                             
            |___/|_|                             
      ...
      Yes sir, straight to the moon! \                       __________________________
                                          |   ____     _____
     ___           O                      |  |____|   |_____|
...
~~~~      =/       ~~~~~~~~ ~~~~~~    ~~~~~~~~~~~~~             ~~~~~
  ...
  Website:  https://theCryptoArk.org
  Telegram: https://t.me/cryptoarkbsc
  Twitter:  https://twitter.com/the_cryptoark/
  Discord:  https://discord.gg/WJNwSjZm
*/
...
contract CryptoArk is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'CryptoArk';   // Name
	string constant _symbol = 'TICKET';    // Symbol
	uint8 constant _decimals = 18;         // Decimals

    uint256 private constant _totalSupply = 100_000_000 * (10 ** _decimals);  // 1 million
    uint256 public  constant _maxWalletLimit = 1_000_000 * (10 ** _decimals);  // 1%
    ...
    // Buy Fees
    uint256 constant reflectionFeeBuy = 100;
    uint256 constant liquidityFeeBuy  = 100;
    uint256 constant marketingFeeBuy  = 700;
    uint256 constant totalFeeBuy      = 900;

    // Sell Fees
    uint256 constant reflectionFeeSell = 200;
    uint256 constant liquidityFeeSell  = 100;
    uint256 constant marketingFeeSell  = 900;
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0xe2609d014B4c03aA7d52AB0Ce37eFB6BdEbBcb46;
        marketingFeeReceiver = 0xe2609d014B4c03aA7d52AB0Ce37eFB6BdEbBcb46;
