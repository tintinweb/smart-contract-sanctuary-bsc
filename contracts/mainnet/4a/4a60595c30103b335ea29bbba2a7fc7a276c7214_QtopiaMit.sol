...
contract QtopiaMit is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "QtopiaMit";
    string private _symbol = "QPM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x23324bcBf8e09ACEc15450011568538297812705);
    address payable public liqWalletAddress = payable(0x23324bcBf8e09ACEc15450011568538297812705);
    ...
    uint256 private _totalSupply =  999999* 10**_decimals;
    uint256 public _maxTxAmount =    29999* 10**_decimals;
    uint256 public _walletMax =      39999* 10**_decimals;
