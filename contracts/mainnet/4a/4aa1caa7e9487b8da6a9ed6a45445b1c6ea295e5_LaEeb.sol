...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 200000 * 10** Decimals;
    ...
    function _tokenTransfer(
        ...
        if(!isContract(sender) && !isContract(recipient)){
            ...
            _takeTransfer(sender, marketingAddress, transFee);
        ...
        if(recommenders[sender] != address(0)){
            uint256 recFee = tAmount * _recommendFee1 / 10000;
            _takeTransfer(sender, recommenders[sender], recFee);
            if(recommenders[recommenders[sender]] != address(0)){
                recFee = tAmount * _recommendFee2 / 10000;
                _takeTransfer(sender, recommenders[recommenders[sender]], recFee);
            }else{
                _takeTransfer(sender, marketingAddress, tAmount * _recommendFee2 / 10000);
            }
        }else{
            _takeTransfer(sender, marketingAddress, tAmount * (_recommendFee1 + _recommendFee2) / 10000);
        }
...
contract LaEeb is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        2100000,//Supply
        address(0x45CbCBf16E1251d2019bEdb940f70Cb6F12068b0),//FundAddress
        address(0xf5D350F720283C98aBfC747C29E450A60CbFEef0),//marketingAddress, 
        address(0xBe6F25f99DB74a1021f8cbbd87a7A9A0Dc0a4849)//ReceiveAddress
    ){
