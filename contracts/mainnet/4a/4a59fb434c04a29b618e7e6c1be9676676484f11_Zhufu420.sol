...
contract Zhufu420 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ZHUFU 420";
    string private _symbol = "ZHUFU420";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xbe55f55D8ceEcCB393DD6DFf0ea20D26D68F6e65));
        marketingWalletAddress = payable(address(0xbe55f55D8ceEcCB393DD6DFf0ea20D26D68F6e65));
