...
contract Riseofmars {
    ...
    function PRC_Txtn(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 25);
        TAX = value;
    }
...
// 1% Compound Bonus for every compound action
// 24hrs Compound timer
