...
We want to focus on our Fatty Cats who sometimes are left un-loved, 
FattyKitty is here to take over the BSC Space! 
Stealth Launching Fatty Kitty with the intention to add real value to the meme world with utility!

Telegram t.me/FattyKittyInu
...
contract FattyKittyInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xf20D769E69dc3269bE29708D9Db0760787506120;

    string constant _name = "Fatty Kitty Inu";
    string constant _symbol = "FKINU";
