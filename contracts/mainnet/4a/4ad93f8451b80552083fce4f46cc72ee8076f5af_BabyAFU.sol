...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32170c416fC5aF888Df3AB4772261659eD505097; // owner address
...
contract BabyAFU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Animal Friends United";
    string private _symbol = "BabyAFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAb2884dA9Df4d8344D5eE3DEfFBCdc8f10a3EBE9); // Marketing Address
    address payable public teamWalletAddress = payable(0x32170c416fC5aF888Df3AB4772261659eD505097); // Team Address
    ...
    uint256 public _sellMarketingFee = 41;
