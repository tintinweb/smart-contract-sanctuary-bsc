...
contract PowerOfDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE OF POWER";
    string private _symbol = "DOGEOP";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x39540956f0b2123213B7445fa87033cA7b409a7f); // Marketing Address
    address payable public teamWalletAddress = payable(0x39540956f0b2123213B7445fa87033cA7b409a7f); // Team Address
