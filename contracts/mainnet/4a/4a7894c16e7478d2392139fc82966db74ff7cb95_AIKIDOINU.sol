...
abstract contract Project {
    ...
    address public treasuryWallet = 0x01859e5D0541Ca170E0Ff80EF8EdaE633528BA9f;

    string constant _name = "AIKIDO INU";
    string constant _symbol = "AKO";
...
contract AIKIDOINU is Project, IBEP20, Auth {
    using SafeMath for uint256;
