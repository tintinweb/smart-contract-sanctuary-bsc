...
/* Token contract */
contract UniCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xffBbBaBfa6A1d185165745C220602E8D37112555;
    ...
    // Name and symbol
    string constant _name = "UniCat";
    string constant _symbol = "UniCat";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 3% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 3% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3% (100 mil)
