...
*TELEGRAM: https://t.me/PIGEBOYOFFICIAL
*/
...
contract PIGEBOYBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " PigeBoy BSC ";
    string private _symbol = " WERTXN "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7EE328C7C253C1F17cD71D7B3489FE0b6Ed9322C); 
