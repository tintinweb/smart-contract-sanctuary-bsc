...
0.8BNB Initial Lp&Locked

50% of tax will be used for MooZilla buy and burns
50% of tax will be used for MooZilla2.0 buy and burns

Pyromaniac dev , for @moozillabsc community
Do not jeet, its a token to help old and new holders.
...
contract MooZilla2  is IBEP20, Auth {
    ...
    string constant _name = "MooZilla2.0";
    string constant _symbol = "MZ2";
    ...
    address public marketingBFeeReceiver;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF1158cFE1Ef413549F1F7A064292d571D6A9425E;
        marketingBFeeReceiver = 0x96d47F41187e85F81445F6e2c883751BA10C3AD0;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess2, ) = payable(marketingBFeeReceiver).call{
    ...
    function setFeeReceivers(address MarketingTax, address marketingBTax) external onlyOwner {
        marketingFeeReceiver = MarketingTax;
        marketingBFeeReceiver = marketingBTax;
    }
