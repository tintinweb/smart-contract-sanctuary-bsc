...
contract ElonGrow  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Elon Grow";
    string constant _symbol = "ElonGrow";
