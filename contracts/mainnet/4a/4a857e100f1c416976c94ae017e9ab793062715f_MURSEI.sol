...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 doubleReward = IBEP20(0xb5b3507aEd99fd34EAC54219A2C7f9B48223E5EB);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = doubleReward.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(doubleReward);
        ...
        uint256 amount = doubleReward.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            doubleReward.transfer(shareholder, amount);
...
contract MURSEI is IBEP20, Auth {
    using SafeMath for uint256;

    address doubleReward = 0xb5b3507aEd99fd34EAC54219A2C7f9B48223E5EB;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Murray Sensei";
    string constant _symbol = "MURSEI";
