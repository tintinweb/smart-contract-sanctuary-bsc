...
contract LOVEMETENDER is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9Fd2d1F7A73733f622f95FC7938fA37ca92A66F7); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9Fd2d1F7A73733f622f95FC7938fA37ca92A66F7); // buyback Address
    ...
    uint256 public _maxTxAmount = 1500000000000000 * 10**9; // 1.5%
    uint256 public _walletMax = 2500000000000000 * 10**9; // 2.5%
