...
contract CHANNEL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHANNEL";
    string private _symbol = "CHANNEL";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB890256Ed9fE2A3F03Bcdf2b35585d167de54E0A); 
