...
contract CcLockStaking is Ownable, ReentrancyGuard {
    ...
    uint public emergencyWithdrawalFee = 3000;
    ...
    constructor(       IBEP20 _stakedToken,
        ...
        require(decimalsRewardToken < 30, "Should be inferior to 30");
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (withdrawalFee > 0 ) {
              _amount -= _amount.mul(withdrawalFee).div(10000);
    ...
    function setEmergencyFee(uint emFee) external onlyOwner {
        require(emFee <= 3000, "EmergencyWithdrawFee should be <= 15");
