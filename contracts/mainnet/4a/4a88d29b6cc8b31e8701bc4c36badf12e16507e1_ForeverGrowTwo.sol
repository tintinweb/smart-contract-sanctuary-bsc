...
contract ForeverGrowTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Forever Grow 2.0";
    string private _symbol = "GROW2";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xA8b31239df10c050E8d14c185F73F458D91365B2);
