...
/**
        ...
        Telegram: https://t.me/RatBratBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  Ratboy = IBEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Ratboy.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Ratboy);
        ...
        uint256 amount = Ratboy.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Ratboy.transfer(shareholder, amount);
...
/* Token contract */
contract Ratbrat is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address Ratboy = 0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x4010323cd06D8700307C5A623Bdd28BaF66af048;
    ...
    // Name and symbol
    string constant _name = "Rat Brat";
    string constant _symbol = "$RATBRAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x004Fd7D39851F6158732E6C3BDE7664f13302ff5;
