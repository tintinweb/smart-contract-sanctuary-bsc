...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xdfEf61b16B9D7118AEc32e646C694c449705FB53;
...
contract HACKERCULT is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BSC Hacker Cult"; 
    string private constant _symbol = unicode"HACKERCULT"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xdfEf61b16B9D7118AEc32e646C694c449705FB53), BNB_Tot);
            }
