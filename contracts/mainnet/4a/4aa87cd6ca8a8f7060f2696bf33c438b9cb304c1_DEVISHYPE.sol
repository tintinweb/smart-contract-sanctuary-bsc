...
contract DEVISHYPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dev is HYPE";
    string private constant _symbol = "DEVHYPE";
