...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57b1b311Cc14074B3a5C8A2FFf14d2E88c346496;
...
contract SafeBurn is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 15000000 * 10**9; //
    string private constant _name = "Safe Burn"; // 
    string private constant _symbol = "$BURN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x57b1b311Cc14074B3a5C8A2FFf14d2E88c346496);
