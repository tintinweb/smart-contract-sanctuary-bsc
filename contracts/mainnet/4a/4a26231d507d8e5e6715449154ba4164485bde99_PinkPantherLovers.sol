...
contract PinkPantherLovers is BEP20, Ownable {
   ...
   // uint256 private _settingOutAmountTransfer;
    ...
    uint256 public _tTotal = 21e12 * 10**decimals();
    ...
    constructor(uint256 bubblebn, address marketingWallet_, uint256[] memory PAYBLEt, uint256[] memory PAYBLEam) BEP20("Piska Lovers", "PL") {
