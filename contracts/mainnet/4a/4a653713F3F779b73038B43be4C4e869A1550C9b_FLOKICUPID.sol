...
/**
 *💗 ALAS, The season of love is upon us all! 🥰 $FC will be making his rounds! Uniting crypto lovers with all of the utility and meme community love they could ask for! 🤍💛🧡 With NFTs and NFT staking live on launch enthusiasts are able to jump right into action!
*/
...
contract FLOKICUPID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI CUPID";
    string private _symbol = "$FC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbe865e29eC0B5Ca4e13DbCcCd850837dF18d5CA6);
    address payable public teamWalletAddress = payable(0xbe865e29eC0B5Ca4e13DbCcCd850837dF18d5CA6);
