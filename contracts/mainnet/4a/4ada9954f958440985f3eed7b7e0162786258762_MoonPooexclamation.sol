...
contract MoonPooexclamation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonPoo!!!";
    string private _symbol = "MoonPoo!!!";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x72C204ab64B8F4B28E094D29cD3b051B1DaeA0Dc); 
    address payable public BurnedWalletAddress = payable(0x72C204ab64B8F4B28E094D29cD3b051B1DaeA0Dc); 
