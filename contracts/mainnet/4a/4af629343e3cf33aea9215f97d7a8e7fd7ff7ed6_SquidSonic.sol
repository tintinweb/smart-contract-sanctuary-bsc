...
contract SquidSonic is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA9e3B51f72cD2D79C21ab984ECa605c812487B5b); 
    address payable public Wallet_Dev = payable(0xA9e3B51f72cD2D79C21ab984ECa605c812487B5b);
    ...
    string private constant _name = "Squid Sonic"; 
    string private constant _symbol = unicode"SQUINIC"; 
    ...
    constructor () {
        ...
        _owner = 0xA9e3B51f72cD2D79C21ab984ECa605c812487B5b;
