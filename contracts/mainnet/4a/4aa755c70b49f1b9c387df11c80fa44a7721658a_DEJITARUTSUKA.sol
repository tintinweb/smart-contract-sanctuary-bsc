...
/**    
    ...
    DEJITARU TSUKA  is a decentralized token project on the BSC network.

    DEJITARU is coveted by the knowing and revered by the lesser. It instills fear and terror in the hearts and minds of those who question. 

    Seal your fate and fortune by harnessing the unrivalled power of the DEJITARU!

    //https://t.me/DejitaruTsuka

    The team is well know and connected and has a surprise utility they will unleash at 1M MC.

    CMC & CG FAST-TRACKED 

    Don’t wait grab your bag or forever be demonized by DEJITARU.
...
contract DEJITARUTSUKA is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xA2603f8B8F25B53AdDD3CF50c7ff02f55bcb789b);
    address private liquidityReceiver = address(0xA2603f8B8F25B53AdDD3CF50c7ff02f55bcb789b);
