...
contract SPOOKYFLOKY is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8E1f06d06DF5d147336C7b52bFF45cEcEea688AF; //

    string private constant _name = "Spooky Floky"; //
    string private constant _symbol = "sFLOKY"; //
