...
/**
FISH ROCKET is Amel Discus Coin Reward token. 

AMEL Contract 0x8216188E9b8bE5bf88CceEADDeB6E7B58546f601
*/
...
/*
    ...
    Telegram: https://t.me/FishRocketBSC

   Great  features:
   2% fee auto liquidity
   7% fee for marketing and buyback ( will hard marketing)
   3% rewards fee


   I will add 1 BNB for intial liquidity
   lambo? where? only at amel tokenn
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8216188E9b8bE5bf88CceEADDeB6E7B58546f601);
...
contract FishMetaContestant is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Fish Rocket";
    string constant _symbol = "$FR";
    ...
    //Mainnet
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8216188E9b8bE5bf88CceEADDeB6E7B58546f601;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x75a7376acb3D7F9c8D0024f4D7240613CC47D917;
        buybackWallet = 0xbed67D8aD83d23aB4C1EeAd5A9920FE2449B42bA;
