...
contract ThetaFuel is ThetaFuelDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ThetaFuelTeam;
    address private CharityThetaFuel;
    ...
    string public override name = "Theta Fuel";
    string public override symbol = "Theta Fuel";
    ...
    constructor(uint totalSupplyValue, address ThetaFuelTeamAddress, address CharityThetaFuelAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ThetaFuelTeam = ThetaFuelTeamAddress;
        CharityThetaFuel = CharityThetaFuelAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ThetaFuelTeam] =  totalSupply * 45 / 100;
        balances[CharityThetaFuel] = totalSupply * 45 / 100;
