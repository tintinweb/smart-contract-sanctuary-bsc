...
contract BABYDOGE is BEP20, Ownable {
	...
	BEP20(name_, symbol_) {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0x4C1314F8177a9A61FdC66fd27A08525CaD2B818a));
