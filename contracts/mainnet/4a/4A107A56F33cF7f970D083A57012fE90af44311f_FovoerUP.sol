...
contract Ownable is Context {
    address private _owner = 0xBAA3AdC38a5A01e947AB87774DE5966fEc1786F3;
...
contract FovoerUP is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x8aB44c0ea64A597E5351c5f542056Cc4048DEa2A); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FovoerUP"; // token name
    string private _symbol = "UP"; // token symbol
    ...
    uint256 public _tokenFee = 5; // marketing fee 1% to be sent as tokens
    ...
    uint256 public _liquidityFee = 5; // liquidity fee 3%
