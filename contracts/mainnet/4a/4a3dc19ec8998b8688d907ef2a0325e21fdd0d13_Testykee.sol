...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24705e07e83BF2Ec7Fa067259C103e62845aa7ec;
...
contract Testykee is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBC986974Aed890C0de67Ce39383Cec391eeae07D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1337000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Testykee";
    ...
    uint256 public _maxTxAmount = 2700000000 * 10**18;
