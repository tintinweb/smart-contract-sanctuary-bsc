...
contract CROWNINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5A2E78d9d9338226Ec03AeD3732FAfE1cc2D5db4); 
    address payable public Wallet_Dev = payable(0x9851773bDD7CaaEaF94e7EeBDcC37F00fA79dDc4);
    ...
    string private constant _name = "CROWNINU"; 
    ...
    constructor () {
        ...
        _owner = 0x9851773bDD7CaaEaF94e7EeBDcC37F00fA79dDc4;
