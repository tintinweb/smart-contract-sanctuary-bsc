...
contract BelleToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("Belle", "Belle")  {
        uint256 totalSupply = 3000 * (10**18);
        swapTokensAtAmount = totalSupply.mul(2).div(10**6); // 0.002%;
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory())
            .createPair(address(this), address(usdt));
        marketingWalletAddress = 0x2CFAb5feC6DE3AE03264f4366F361d1AF0bB06A5;
        buybackWalletAddress = 0x6aff9AD21AB56Be91E3D0De8f290b272d3306Ad3;
