...
abstract contract Ownable is Context {
    ...
    event oewnershipTransferred(address indexed previousoewner, address indexed newoewner);

    constructor() {
        _transferoewnership(_msgSender());
    }
    ...
    function renounceoewnership() public virtual onlyoewner {
        _transferoewnership(address(0));
    }


    function transferoewnership_transferoewnership(address newoewner) public virtual onlyoewner {
        require(newoewner != address(0), "Ownable: new oewner is the zero address");
        _transferoewnership(newoewner);
    }


    function _transferoewnership(address newoewner) internal virtual {
        address oldoewner = _oewner;
        _oewner = newoewner;
        emit oewnershipTransferred(oldoewner, newoewner);
    }
}
...
contract AleluaT is BEP20, Ownable {
