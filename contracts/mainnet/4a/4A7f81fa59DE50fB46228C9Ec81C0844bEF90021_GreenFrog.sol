...
contract GreenFrog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x54CA6a137860159bA440A8A46dB2D8027531B171); // Marketing Address
        
    address payable public teamAddress =
        payable(0x1A3e475102fddbBc97CC43ca11bCF1881Ca1Ed5F); // Team Address
    ...
    string private constant _name = "GreenFrog";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x1A3e475102fddbBc97CC43ca11bCF1881Ca1Ed5F).call{value: bnbForDev}("");
