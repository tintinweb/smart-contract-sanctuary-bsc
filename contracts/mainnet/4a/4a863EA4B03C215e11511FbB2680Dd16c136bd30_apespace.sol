...
contract apespace is Context, IERC20, Ownable {
    ...
    string private constant _name = "apespace"; //
    string private constant _symbol = unicode"AS"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xae72063244Eb49af828fA3b68f08721165e57889;
