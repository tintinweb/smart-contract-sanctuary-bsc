...
contract NEWCOMMUNITYDOKWON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY DO KWON";
    string private _symbol = "DOKWON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49f3a8A26B4c52C4BDd4957AFF5083e1eeDb72C4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x49f3a8A26B4c52C4BDd4957AFF5083e1eeDb72C4); // BuyBack Address
