...
contract Jiunma is Context, IERC20, Ownable {
    ...
    string private constant _name = "jiuniang";
    string private constant _symbol = "JN";
    uint8 private constant _decimals = 10;
    
    address payable private _developmentAddress = payable(0x73991d422f1d01d2be3977ba9182bd89e1ccF820);
    address payable private _marketingAddress = payable(0x5A2cd28853AB7960418990879806DF64ccAe895C);
