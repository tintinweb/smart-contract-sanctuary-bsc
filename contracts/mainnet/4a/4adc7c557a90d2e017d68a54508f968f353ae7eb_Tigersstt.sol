...
contract Tigersstt  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x19e10f8f59845c0Dd2532e94Ee462a5016357dC1); 
    address payable public Wallet_Dev = payable(0xa3102C84f69Dc12B4AA1401C133F40ee5cF4D2cA);
    ...
    string private constant _name = "TIGERSSTT"; 
    string private constant _symbol = unicode"$SSTT"; 
    ...
    constructor () {
        ...
        _owner = 0xa3102C84f69Dc12B4AA1401C133F40ee5cF4D2cA;
