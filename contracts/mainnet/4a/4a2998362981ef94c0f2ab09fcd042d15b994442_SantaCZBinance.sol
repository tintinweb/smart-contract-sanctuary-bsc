...
contract SantaCZBinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Santa CZ Binance ";
    string private _symbol = " $SCZB "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb4ac043fC2a60D801fdfB8648adD6901dA4b07d8); 
    address payable public teamWalletAddress = payable(0xFd7567d1bF7a8F97591FF27E859108A815f7f8EB);
