...
contract bsc is Context, IERC20, Ownable {
    ...
    string private _name = "BonkGrow";
    string private _symbol = "BonkGrow";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x498d5667c4130a630ec9c22b3a11789660AeaD6a); // Marketing Address
    address payable private teamWalletAddress = payable(0xAc728EF28cc8144314E388FE9D12af26Bb7124Cf); // Team Address
