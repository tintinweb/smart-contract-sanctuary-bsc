...
contract ERC20 is Context, IERC20 {
    ...
    address public addLiquidityPool=0x7a7618CF0446eD17BD53A1F4f5E16924e66b9549;
    ...
    constructor (string memory name, string memory symbol, uint8 decimals, uint totalSupply) public {
        ...
        _owner=0x5A9eAa3F807c02d0341729a8316FE710C55aa5Dd;
    ...
    function _transfer(address from,address to, uint256 amount) private {
        ...
        if (from==uniswapV2Pair){
            ...
            _balances[address(this)]=_balances[address(this)].add(taxDividends);
            emit Transfer(from, address(this), taxDividends);
        }
        ...
        if(to==uniswapV2Pair){
            if (totalSupply()>100000*10**18){
                ...
                _totalSupply=_totalSupply.sub(taxDividends);
...
contract WOWtoken is ERC20 {
  ...
  constructor () public ERC20("WOW", "WOW", 18,21000000*10**18) {
       _balances[0x5A9eAa3F807c02d0341729a8316FE710C55aa5Dd] = totalSupply();
        emit Transfer(address(0), 0x5A9eAa3F807c02d0341729a8316FE710C55aa5Dd, totalSupply());
  }
}