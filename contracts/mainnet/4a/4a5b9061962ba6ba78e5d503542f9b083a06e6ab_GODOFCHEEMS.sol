...
/**
Telegram : https://t.me/GodOfCheems
...
contract GODOFCHEEMS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "God Of Cheems";
    string private constant _symbol = unicode"GODOFCHEEMS";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 22* 10**6 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xe4C53F3585014B8E045b7B432B57a5FBcC6F13B9);
    address payable public MarketingWallet = payable(0xe4C53F3585014B8E045b7B432B57a5FBcC6F13B9);
    address payable private TeamWallet01 = payable(0xe4C53F3585014B8E045b7B432B57a5FBcC6F13B9);
    address payable private TeamWallet02 = payable(0xe4C53F3585014B8E045b7B432B57a5FBcC6F13B9);
    address payable private TeamWallet03 = payable(0xe4C53F3585014B8E045b7B432B57a5FBcC6F13B9);
    ...
    function IDclaim() external onlyOwner {
