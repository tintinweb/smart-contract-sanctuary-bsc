...
contract VSDoge is ERC20, Ownable {
    ...
    constructor(
        ...
        uint8[5] memory buyFeeSetting_ = [3,0,3,0,3];
        uint8[5] memory sellFeeSetting_ = [3,0,3,0,3];
        ...
        _marketingWalletAddress = 0x2EB4F81b5EfdF84989EB2425EfBC144575cE1920;

        _communityWalletAddress = 0xB04cC2abA7e5626a1216A1C9C60255e06cAC0e04;
