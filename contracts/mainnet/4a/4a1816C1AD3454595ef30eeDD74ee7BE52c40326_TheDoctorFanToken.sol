...
contract TheDoctorFanToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Doctor Fan Token";
    string private constant _symbol = "TheDoctor";
