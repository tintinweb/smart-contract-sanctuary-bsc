...
contract Zambia is Context, IERC20, Ownable {
    ...
    string private _name = "Zambia";
    string private _symbol = "Zambia";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xDD4a2672C923134e32e7d5475Ebb8238c0D3f90E));
        marketWall = payable(address(0xDD4a2672C923134e32e7d5475Ebb8238c0D3f90E));
