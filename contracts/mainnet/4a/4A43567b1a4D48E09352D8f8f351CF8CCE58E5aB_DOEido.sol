...
abstract contract AbsPreSale is Ownable {
    ...
    constructor(address USDTAddress, address TokenAddress, address CashAddress, address NFTAddress){
        ...
        _saleInfo.push(SaleInfo(100 * usdtDecimals, 1000 * tokenDecimals, 20000000, 0));
        //（认购金额，代币数量，总供应份额）
...
contract DOEido is AbsPreSale {
    constructor() AbsPreSale(
    //USDT
        address(0x55d398326f99059fF775485246999027B3197955),
    //Token
        address(0x6769981403FF5533A2D85a3facE5502f4249ff38),
    //Cash
        address(0xf22502cfc36884A00D79B91813Db4f26CCBecc8E),
    //NFT
        address(0x7ED29463170B495373F345Ac4cc67D560C0a1666)
    ){
