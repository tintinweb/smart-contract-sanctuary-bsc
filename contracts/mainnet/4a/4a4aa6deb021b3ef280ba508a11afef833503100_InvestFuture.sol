...
----------------------------------------------------------------------------------
                                                                                 -
    This coin is an automatic coin created by the ivf coin team.                 -
    If you want to invest in the future, save ivf coins.                         -
    1% distribution is made to the partners in each purchase and sale.           -
    No investment can be known to yield great returns.                           -
    When investing, do it with thought. Even if this is ivf coin.                -                                                                        -                                                -
                                                                                 -
    Telegram Chat                                                                -
    https://t.me/ivfcoinchat                                                     -           
                                                                                 -
    Telegram News                                                                -
    https://t.me/ivfcoinnews                                                     -
                                                                                 -
    Twitter                                                                      -
    https://twitter.com/ivfcoin                                                  -
                                                                                 -
                                                                                 -
    Total Supply                : 999.000.000                                    -
    Market Sales                : 900.000.000 / Liquidity will be locked forever -
    Team Fee                    :  21.000.000                                    -
    Scholarship Fee for Students:  78.000.000                                    -
----------------------------------------------------------------------------------
                                                                                 -
                                                                                 -                                                -
                                                                                 -
Team Wallet: 0x999ac60dFB0d9a4c30f2904a69358f7Ce32ba53B                          -
It will be opened when the liquidity reaches 100 BNB.                            -
                                                                                 -
                                                                                 -
                                                                                 -
----------------------------------------------------------------------------------
                                                                                 -
Scholarship Wallet for Students: 0x323320B30cE9Df68e35787898c504C7cDce3dC55      -
                                                                                 -
The wallet will be opened when the liquidity reaches 10 BNB.                     -
Scholarship students will be shared on our telegram channel.                     -
The community will determine the students who will be awarded scholarships.      -
----------------------------------------------------------------------------------
*/
...
contract InvestFuture is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet =
        0x8e570a86A0a1D99c6d2a9186aB82592eF8e57Cf1;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 999 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Invest Future";
    string private constant _symbol = "IVF";
    ...
    uint256 private numTokensSellToAddToLiquidity = 9 * 10**6 * 10**8;
    uint256 public _maxTxAmount = 9 * 10**6 * 10**8;
    uint256 public _maxWalletHoldingLimit = 99 * 10**6 * 10**8;

    event TaxFeeUpdated(uint256 feeUpdated);
    event MaxTxAmountUpdated(uint256 updatedMaxTxAmount);
    event numTokensSellToAddToLiquidityUpdated(uint256 thresholdValue);
    ...
    function UpdateTaxFeePercentage(
        uint256 taxFee,
        ...
        require(
            taxFee.add(liquidityFee).add(MarketingFee)
             <= 25,
   ...
   function UpdateMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
    ...
    function UpdateSwapThresholdValue(uint256 thresholdValue)
        ...
        onlyOwner
    {
        numTokensSellToAddToLiquidity = thresholdValue * 10**8;
