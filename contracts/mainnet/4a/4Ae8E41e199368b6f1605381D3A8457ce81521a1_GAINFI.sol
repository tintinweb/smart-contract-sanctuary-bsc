...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract GAINFI is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "GAINFI";
    ...
    uint256 public _maintenanceFee = 13; 
   ...
   address payable maintenanceWallet = payable(0x566AFfb4f691D1c1132d13bC5A4261E89770a233);
