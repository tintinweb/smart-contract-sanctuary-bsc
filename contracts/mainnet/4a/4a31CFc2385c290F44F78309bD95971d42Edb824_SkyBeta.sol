...
contract SkyBeta is ERC20PresetMinterPauser, Ownable {
    ...
    function setBetaAmount(uint256 _amount) public onlyOwner {
        betaAmount = _amount;
    }
    ...
    function mint(address _to, uint256 _amount) public onlyOwner override {
        require((totalSupply() + _amount) <= tokenSupply, "Over supply");
        super.mint(_to, _amount);
    }


    function getBetaToken() public {
        require(!betaList[msg.sender], "It has been collected");
        betaToken.safeTransfer(msg.sender, betaAmount);
        betaList[msg.sender] = true;
    }
