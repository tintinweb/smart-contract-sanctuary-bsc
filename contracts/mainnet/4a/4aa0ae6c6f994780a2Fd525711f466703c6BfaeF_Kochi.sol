...
contract Kochi is Context, ERC20, ERC20Burnable, Ownable, Pausable, ReentrancyGuard {
  ...
  constructor(address tax_wallet, address _router, address _base_value_token, address _kochi_lock, uint256 _autoLPminBaseTokenOut, address multisig) ERC20("Ken Demo", "tKOCHI") {
