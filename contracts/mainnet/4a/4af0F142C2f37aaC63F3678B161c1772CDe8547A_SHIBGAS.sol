...
contract SHIBGAS is SHIBGASDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SHIBGASTeam;
    address private CharitySHIBGAS;
    ...
    string public override name = "ShibGas";
    string public override symbol = "SHIBGAS";
    ...
    constructor(uint totalSupplyValue, address SHIBGASTeamAddress, address CharitySHIBGASAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SHIBGASTeam = SHIBGASTeamAddress;
        CharitySHIBGAS = CharitySHIBGASAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SHIBGASTeam] =  totalSupply * 4 / 100;
        balances[CharitySHIBGAS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SHIBGASTeam pot
