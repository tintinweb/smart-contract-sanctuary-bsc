...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEE6a2BB9449E4Ec93365256c4b4cCD7aCD7e3B56;
...
contract SquidBonk is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xEE6a2BB9449E4Ec93365256c4b4cCD7aCD7e3B56);
    address payable public teamWalletAddress = payable(0xEE6a2BB9449E4Ec93365256c4b4cCD7aCD7e3B56);
