...
contract princessazulaBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "princess azula BSC"; // TODO change
    string private _symbol = "AzulaBSC"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0x2903cB81568f6183A7cb54345925460cd2B4A77b); // Buyback Address
