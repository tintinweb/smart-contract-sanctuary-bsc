...
contract jiumoluoshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "jiumoluoshi";
    string private _symbol = "LUOSHI";
   ...
   function build(uint256 rate, uint256 amount) private pure returns (uint256) {     
    ...
    function foundation(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
    ...
    function remaingasfee() public view returns (uint256) {
