...
contract CND is ERC20, Ownable {
    ...
    {   
        transferOwnership(0x88e7dE9F80c5Df075DD569e1F9658B89Cb72198D);
        ...
        marketingWallet = 0xc65678fB8C75Ac1016D35809FE59508445aAF94c;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        uint256 oldFee = _totalFeesOnBuy + _totalFeesOnSell;
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= oldFee, "Total Fees cannot exceed the old fee");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 4, "Wallet to Wallet Transfer Fee cannot exceed the maximum");
