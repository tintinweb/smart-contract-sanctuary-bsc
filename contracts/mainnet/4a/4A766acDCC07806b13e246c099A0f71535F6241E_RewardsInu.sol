...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BookShib = IBEP20(0xeC13736FFB2A50F3A4817E5797C8A8A777A147CB);
...
/* Token contract */
contract RewardsInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BookShib = 0xeC13736FFB2A50F3A4817E5797C8A8A777A147CB; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x839305F340455ddDCAF534CfB90CbA11A3D8d849;
    ...
    // Name and symbol
    string constant _name = "RewardsInu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf28780fe53E8Fe8055CBD3b20D27651A232AA45c;
