...
contract HoOh is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x06569E6663492E3681C0FE54845030968a31b8d0);
    address payable private _marketingAddress = payable(0x06569E6663492E3681C0FE54845030968a31b8d0);
    
    string private constant _name = "Ho-Oh Coin";
    string private constant _symbol = "Ho-OhCoin";
