...
contract SN is IERC20, Ownable {
    ...
    // 这是默认的邀请地址.
    address private _default = address(0x5ecBDEd38A77800Ef326349d8118908EE3c167F2);
    // 购买时，币会自动打入这个地址 
    address private _fundBuyAddress = address(0xEC6953FD1f4236b383182039259095a41Aee410B);
    // 卖出时，一定费率打入这个地址 
    address private _fundSellAddress = address(0x65A6Ec380d8677eA4799239Ed9F3946b3fdD09b6);
    ...
    function _tokenTransferSell(
        ...
        if (takeFee) {
            ...
            _takeInviterSellFee(sender, recipient, tAmount, currentRate);
    ...
    // 这个1% 是随便分给下面的 人, 比如：我自己买1000U，10U随便分给下面的人
