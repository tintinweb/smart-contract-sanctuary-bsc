...
library SSBscMysteryBoxOkxWalletType {

    string constant _name_ = "Superpower Squad Mystery Box Okx Wallet Bsc";
    string constant _symbol_ = "SSMBOWBsc";
    string constant _uri_ = "https://www.ssquad.games/mysteryBoxOkxWalletBsc";
