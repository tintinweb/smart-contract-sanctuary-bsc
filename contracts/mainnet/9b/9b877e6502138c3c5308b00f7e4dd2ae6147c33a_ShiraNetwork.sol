...
Liquidity Pool 3 BNB
LP LOCK 1 YEAR
HUGE MARKETING

https://t.me/ShiraNetwork
https://twitter.com/ShiraNetwork
www.ShiraNetwork.finance
...
contract ShiraNetwork is Context, IERC20, Ownable {
    ...
    string private _name = " Shira Network";
    string private _symbol = "$SHIRA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2A657d4222092682b15E7c1efa7C27F3bc662178);
