...
contract XiaoQ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "XiaoQ";
    string private _symbol = "XiaoQ";
    ...
    function isXiaoQTxExempt(address sender, uint256 amount) internal view {
        require(
    ...
    function setXiaoQTxLimit(address holder, bool exempt)
        external
        onlyOwner
    {
	...
	function getBacking(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
	...
	function RadXiaoQtokenRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
