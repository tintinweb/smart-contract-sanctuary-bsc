...
QILIN INU 社區驅動的代幣建立在最安全和完善的區塊鏈“Bsc 網絡”之上，讓投資者和粉絲保持去中心化。


Telegram Chat: https://t.me/QilinInu
...
contract QilinInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1_100_000_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "Qilin Inu"; //
    string private constant _symbol = "Qinu "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x90053167c3330E529d9e2F778B0070E704A70e81 ;
