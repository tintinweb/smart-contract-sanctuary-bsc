...
contract Dochila is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOCHILA";
    string private _symbol = "Dochila";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68f19C82677Fa04357Eb91FEed236B84000734bD);
    address payable public teamWalletAddress = payable(0x68f19C82677Fa04357Eb91FEed236B84000734bD);
