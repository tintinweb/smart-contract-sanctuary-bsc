...
contract BISMILLAH is Context, IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSale, bool isBuy) private view returns (valuesFromGetValues memory to_return) {
        to_return = _getTValues(tAmount, takeFee, isSale, isBuy);
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSale, bool isBuy) private view returns (valuesFromGetValues memory s) {
