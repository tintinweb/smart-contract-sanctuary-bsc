...
contract Vesting is Ownable {
    address public immutable wirtual;
    ...
    function unlockToken (
        ...
        for (uint256 i=0; i < vestingReceiver[_id].length; i++) {
            require(IERC20(wirtual).transfer(vestingReceiver[_id][i], vestingAmount[_id][i]), "Fail transfer");
        }
        released[_id] = true;
    ...
    function lockToken (
        ...
        require(IERC20(wirtual).transferFrom(_msgSender(), address(this), totalLockingAmount), "Fail transfer");
