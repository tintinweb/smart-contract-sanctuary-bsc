...
contract GoldFish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gold Fish";
    string private _symbol = "GF";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x08Cfee14cc86383Bbbfb06661F99EEF58011eD09);
