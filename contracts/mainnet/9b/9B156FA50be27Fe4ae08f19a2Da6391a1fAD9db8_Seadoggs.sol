...
SEADOGGSPLAYS TOKEN IS COMING

UTILITY
 - Buybacks from seadoggsplays promotions (usually 1 bnb per)
- Buybacks from SeaDegens (not all, as admins are paid from this channel) .3 per
 - May  develop a website to use as advertising / launchpad / KYC badges

MARKETING PLAN
- This will be all over BSC tomorrow so we wont need many calls, as im sure fomo calls will flood
- Will CMC fast track
- Marketing Partnership with myself
- Ads on Safe analyzer bot

TOKENOMICS
- Low tax 6/6
- Larger Initial LP with no LP tax (5 bnb)
...
contract Seadoggs is IBEP20, Auth {
    ...
    string constant _name = "Seadoggs";
    string constant _symbol = "SEADOGGS";
    ...
    address private marketingFeeReceiver = 0x09F3273Edea7E2B15b337Cf886878a7a56185622;
    address private buybackFeeReceiver = 0x09F3273Edea7E2B15b337Cf886878a7a56185622;
