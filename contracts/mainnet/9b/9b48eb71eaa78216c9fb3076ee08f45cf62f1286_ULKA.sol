...
contract ULKA is Context, IERC20, Ownable {
    ...
    string private constant _name = "ULKA FINANCE 2.0";
    string private constant _symbol = "ULKA 2.0";
    ...
    address private marketingWallet = address(0x51B645877b9cc01359a78C3ae4bd520f96065787);
