...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A015f2b799af8D53B2eE971ffC817692DDA1861;
...
contract MiniGames is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x736B01AD8AD5957A822b1C294D6961F79183dda2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mini Games";
    string private _symbol = "MIG";
