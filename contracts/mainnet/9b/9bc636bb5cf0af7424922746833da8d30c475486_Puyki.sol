...
contract Puyki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUYKINU";
    string private _symbol = "PKI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x997920860389E90B3D5E2D0DF08cB43813d937CC); 
    address payable public teamWalletAddress = payable(0x997920860389E90B3D5E2D0DF08cB43813d937CC); 
