...
contract TateDoge is ERC20, Ownable {
    ...
    address public marketingWallet = 0x3e49532a5b0e90f72CDaE07D30e7E0862B42854e;
    ...
    constructor() ERC20("TateDoge", "TATEDOGE") 
    {
        address newOwner = 0x0D41e0ee70Ba15F4B1131CBf25A0d8e355289fD1;
        transferOwnership(newOwner);

        _mint(owner(), 100_000_000_000 * (10 ** 18));
        swapTokensAtAmount = totalSupply() / 5000;

    	dividendTracker = new DividendTracker(100_000_000_000 / 50000, rewardToken);
