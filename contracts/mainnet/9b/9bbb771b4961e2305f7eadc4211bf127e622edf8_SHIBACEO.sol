...
Telegram: https://t.me//SHIBA_CEO_S8/**
...
contract SHIBACEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBACEO";
    string private constant _symbol = "SHIBACEO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x2A9d8FFC96e9A2186C90577dcA47C50c9E6371C5);
    address payable private _marketingAddress = payable(0x2A9d8FFC96e9A2186C90577dcA47C50c9E6371C5);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell <49 , "Redis cannot be more than 49.");
	    require(taxFeeOnBuy < 5, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 49, "Tax cannot be more than 49.");
