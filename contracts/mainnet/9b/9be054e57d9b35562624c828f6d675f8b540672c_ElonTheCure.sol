...
contract ElonTheCure is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "ElonTheCure";
    string constant _symbol = "ElonTheCure";
