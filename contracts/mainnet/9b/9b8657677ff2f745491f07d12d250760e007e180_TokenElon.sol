...
contract TokenElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TOKENELON";
    string private _symbol = "TELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6Cd563BEfb449F8609Eb5284B6CAdCE90d3E45BF); 
    address payable public teamWalletAddress = payable(0x6Cd563BEfb449F8609Eb5284B6CAdCE90d3E45BF); 
