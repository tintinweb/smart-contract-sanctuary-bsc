...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0xa4b36f9a6Edfa5B157634cAD668246a25a902C0A);
    Distributor public distributor;

    bool public swapToDividend = true;
    uint256 public numTokenToDividend = 6 * 1e18;
...
contract Homeland is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 666 * 1e18;

    uint256 badBlock = 3;
    uint256 public launchedAt;
    uint256 public launchedAtTimestamp;

    uint256 public _maxHavAmount = _totalSupply / 111; // 1%
    ...
    constructor() ERC20("Homeland", "Homeland", 18) DividendFee() {
