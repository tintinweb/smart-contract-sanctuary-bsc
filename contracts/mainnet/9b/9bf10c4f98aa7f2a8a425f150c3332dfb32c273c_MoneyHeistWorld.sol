...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x223963cb59B1B0a0345365958146FD44cde2B7D1);
...
contract MoneyHeistWorld is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xBdd459000559a2A0ceefe33FcB9425DD436B7B24;

    string constant _name = "Money Heist World";
    string constant _symbol = "$HeistWorld";
