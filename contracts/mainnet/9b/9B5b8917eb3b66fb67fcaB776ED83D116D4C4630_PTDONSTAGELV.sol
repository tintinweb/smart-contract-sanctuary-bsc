...
contract PTDONSTAGELV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "#PTD_ON_STAGE_LV";
    string private _symbol = "PTD";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5F19805dd360DC38086F9efcb0546B19dF61102d);
