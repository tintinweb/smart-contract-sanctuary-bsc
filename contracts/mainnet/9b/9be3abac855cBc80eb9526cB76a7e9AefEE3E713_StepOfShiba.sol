...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEF56bb022eF7540B284aE22FcE52fBC573Bd2Dc7;
...
contract StepOfShiba is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xEF56bb022eF7540B284aE22FcE52fBC573Bd2Dc7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "StepOfShiba";
    string private _symbol = "STEPS";
