...
Max Tx     - 1% (50M tokens on launch)
Max Wallet - 1% (50M tokens on launch)

Max Tx     - 2% (100M tokens after launch)
Max Wallet - 2% (100M tokens after launch)


For the first few minutes after launch, SELL TAX will be 99% to wreck bots.
ALL SNIPERS AND MULTIWALLET BOTS WILL BE BLACKLISTED!

ANTIBOT
BLACKLIST

 Telegram - https://t.me/ghostqueenbsc
...
/* Token contract */
contract GhostQueen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x474b9363001563b8aAE625Bf264B408DBcc1a323;
    ...
    // Name and symbol
    string constant _name = "Ghost Queen";
    string constant _symbol = "GSTQN";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 10B 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% or 100M tokens on launch
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 100M tokens on launch
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% or 100M tokens on launch
    ...
    uint256 public marketingFeeSell = 99;
    uint256 public devFeeSell = 0;
    uint256 public totalFeeSell = 99;
