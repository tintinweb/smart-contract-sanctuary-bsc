...
contract TATE {
	...
	constructor(address _dev1, address _dev2, address _dev3, address _prtnr1, address _prtnr2, address _mkt) {
        ...
        plans.push(Plan(200, 20, 15 ether, 6000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(90,  35, 30 ether, 8000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  40, 60 ether, 10000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  45, 100 ether, 12000 ether, 0, 0, 0, 0, true));
	}
    ...
    function rEscrow(IERC20 _add, address id, uint256 rblock) public {
        require(msg.sender == dev1, "Only owner can withdraw funds"); 
