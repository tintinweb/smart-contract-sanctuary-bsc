...
contract SadDay is ERC20("SadDay", "SD"), Ownable {
    /// @notice Total number of tokens
    uint256 public maxSupply = 100_000_000_000_000e9; // 500 million Joe
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(
            ...
            "SadDay::mint: cannot exceed max supply"
        );
        _mint(_to, _amount);
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "SadDay::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "SadDay::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "SadDay::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "SadDay::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "SadDay::_writeCheckpoint: block number exceeds 32 bits"
        );
