...
contract LunaDogeZilla is Context, IBEP20, Ownable {
...
address payable public doYouLikeBase;
    ...
    uint256 private maxB = 1000000000000 * 10 ** 18;
    uint256 private maxS = 1000000000000 * 10 ** 18;
    ...
    uint256 private WalletM = 1000000000000 * 10 ** 18;
    ...
    */
    ...
    constructor(address Tokencontract, address payable airdropWalletS,address payable _doYouLikeAddr) {
        _name = "LunaDogeZilla";
        _symbol = "LunaDogeZilla";
        _decimals = 18;
        ...
        airdropWallet = payable(airdropWalletS);
         doYouLikeBase = payable(_doYouLikeAddr);
        New[msg.sender] = true;
