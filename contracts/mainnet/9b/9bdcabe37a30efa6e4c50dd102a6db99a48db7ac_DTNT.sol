...
contract  DTNT is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0x6D5E8240fB1A46Ac3D4Bb8745A77C78BbEc193Da;
    mapping(address => bool) public isbook;
      uint256 private _maxTxAmount = 1 * 1000000000000 * 10**2;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 5 * 10**10 * 10**2;
     bool swapingtwo = true;
     address public owe = 0xc3fED2c3f071Fe3736ee48D02C2Cd866C46FD51E;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x4A0b4AF6dA98B48E3310447cd0f913460eA92b02;


    constructor() public ERC20("DefiTigerNFT", "DTNT",2) {
