...
// It's bout time we make BSC great again. OG Deployer IYKYK. Im gonna communicate via channel, will open community group when the time is right.
...
contract SpookyWorld is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 30000000 * 10 ** Decimals;
        _tTotal = total;
