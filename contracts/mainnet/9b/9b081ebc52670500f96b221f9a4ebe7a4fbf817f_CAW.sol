...
contract CAW is Context, IERC20, Ownable {
    ...
    string private _name = "CAW(A Hunters Dream)";
    string private _symbol = "$CAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE440Dee3B582a104CEBC4b8371E835638a0Ee39f);
    address payable public teamWalletAddress = payable(0x14CFCB8f775770AFe9dC76a318923Db697eAA120);
    ...
    uint256 private _totalSupply =  6666666666666 * 10**_decimals;
    uint256 public _maxTxAmount =   6666666666666 * 10**_decimals; 
    uint256 public _walletMax =     6666666666666 * 10**_decimals;
