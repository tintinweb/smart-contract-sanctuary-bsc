...
contract Retro_INU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Retro INU";
    ...
    function _transferStandard(
        ...
        // _getTValues
        uint256 tFee = tAmount.mul(currentFee).div(2);
        uint256 tLiquidityFee = tAmount.mul(currentFee).div(2);
