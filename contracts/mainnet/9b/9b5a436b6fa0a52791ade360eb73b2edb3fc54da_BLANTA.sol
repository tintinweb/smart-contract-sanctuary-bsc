...
contract BLANTA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Black Santa"; // Edit Name
    string constant _symbol = "BLANTA"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 30000000000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public marketingFee    = 9; // Edit Marketing Fee
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 1000; // Adjust Auto-Sell (10 = 1%)
    bool inSwap;
