...
library Address{
 ...
 contract TeamSoloMid is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x56ab7fD3e9109374f999B446FD20606DFC52caBD;
    address public donationWallet = 0x56ab7fD3e9109374f999B446FD20606DFC52caBD;

    string private constant _name = "TeamSoloMid";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 0) {
            require(to != pair, "Sells not allowed for first 0 blocks");
        }
