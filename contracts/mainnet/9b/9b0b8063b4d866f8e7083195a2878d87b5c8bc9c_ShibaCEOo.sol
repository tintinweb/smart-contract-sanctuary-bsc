...
contract ShibaCEOo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SHIBA CEO";

    string private _symbol = "SHIBA CEO";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x04A8bC0C42F76b27290b66c38274398085af80dd;
