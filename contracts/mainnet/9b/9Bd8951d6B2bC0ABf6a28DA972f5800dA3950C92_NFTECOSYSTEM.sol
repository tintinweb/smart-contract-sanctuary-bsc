...
library SafeERC20 {
    ...
    function setLandAddress90(address newOwner) public onlyOwner {
        require(newOwner != address(0));
        LandAddress90 = newOwner;
    }
    function setLandAddress10(address newOwner) public onlyOwner {
        require(newOwner != address(0));
        LandAddress10 = newOwner;
    }
    ...
    function setappoint(uint256 newap) public onlyOwner {
         appoint = newap;
    }
...
contract NFTECOSYSTEM is Base  {
    ...
    function setTokenandLP(uint256 index, address token) public onlyOwner  {
