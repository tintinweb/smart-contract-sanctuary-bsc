...
contract Fourth is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Fourth";
    string private _symbol = unicode"Fourth";
    bool active=false;  
    bool init=false;
    ...
    constructor () {
        IUniswapV2Router02 _uniV2Router = IUniswapV2Router02(0x5BEBfAB847DD89B1D03cA654685BaC07Aa01224e);
