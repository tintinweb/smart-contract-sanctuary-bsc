...
//
//
//   📱Telegram::https://t.me/SpringToken
//   📱Website ::https://SpringToken.io/
/*
...
contract SpringToken is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SpringToken", "SpringToken") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SpringToken";
    string private _symbol = "SpringToken";
