...
Telegram : https://t.me/arkleebscofficial
...
contract ARKLEETOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AR KLEE TOKEN";
    string private _symbol = "$KLEE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77730AA3C30e49CAA90Adf4bC0Ae85CF0f2eDE03); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x78fD194caBB3a7bBF1eFF241D2fe771c039c2771); // buyback Address
