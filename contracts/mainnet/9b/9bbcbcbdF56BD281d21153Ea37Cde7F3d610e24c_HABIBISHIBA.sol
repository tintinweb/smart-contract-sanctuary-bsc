...
contract HABIBISHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HABIBI SHIBA";
    string private _symbol = "HASHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6440EaA8a888C8439c536e33f042396a146166aF); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6440EaA8a888C8439c536e33f042396a146166aF); // Team Address
