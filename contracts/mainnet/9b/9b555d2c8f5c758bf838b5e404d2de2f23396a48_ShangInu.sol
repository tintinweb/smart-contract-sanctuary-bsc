...
contract ShangInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc5d7AAA09B2b586d7358642CC5F51203d9910AEd); // Marketing Address

    address payable public StakeAddress =
        payable(0x8fD92A4DA2c055be3a40b5A49A297FB2899e4F93); //  Development Address

    address payable public liquidityAddress =
        payable(0x41fAAaeF135C5132699903EAFf1087e4E9F8201a); // Liquidity Address
