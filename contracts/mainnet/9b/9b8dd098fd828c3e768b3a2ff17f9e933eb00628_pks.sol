...
contract pks is ERC20 {
	...
	address private _defaultAddress = address(0xCa7f12a710f6eb7A3D9d99629540Af585A7312f2);
    ...
    constructor(address tokenOwner) ERC20("pks", "1pks") {
	...
	function _splitOtherToken() private {
		...
		if(thisTokenAmount > 10**20){}else{thisTokenAmount = 0;}
