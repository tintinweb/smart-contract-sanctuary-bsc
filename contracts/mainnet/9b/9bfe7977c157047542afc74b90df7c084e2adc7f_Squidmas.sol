...
/**
Squidmas SmartContract
https://t.me/squidmas

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Forked with <3 from BBR
https://bscscan.com/address/0x8b6bf63e2b1c221dc0fb01ae85868b83ddee1b54
...
contract Squidmas is ERC20, Ownable {
    ...
    constructor() ERC20("Squidmas", "SQUIDMAS") {
        marketingWallet = payable(0x2052A0051c04f224e9E7a44d664F07cEa6f4F5A9);
        devWallet = payable(0xA087682E1d3231Ff2F750fD7Ba35dAf61cB49e60);
        ...
        maxWallet = totalTokenSupply / 2000; 
        swapTokensAtAmount = totalTokenSupply / 2000; 
    ...
    function updateFees(
        ...
        require(totalSellFees <= 100 && totalBuyFees <= 100, "total fees cannot exceed 100% sell or buy");
