...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x243b50ca4C6B0D55d73009A056abc1605191d279;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD3BD8aC285acF2529305F908c8017cF7bDCCC6f1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Make Crypto Not War";
    string private _symbol = "MCNW";
