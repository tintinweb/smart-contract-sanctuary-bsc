 ...
 function setKG(bool kgg) public onlyOwner {
    ...
    function SellABCorder(uint256 orderID,uint256 price,uint256 ABC_quantity) public  returns(uint256){
      ...
      else
       {
            ...
            uint256 ABC_quantityZS = ABC_quantity.mul(PriceHL).div(100000);

            ABC.transferFrom(msg.sender,address(this), (ABC_quantity.add(ABC_quantityZS)).mul(1e18));
    ...
    if(buyOrSell){
      ...
      function CancelSellABCorder(uint256 orderID) public  {
         uint256 ABC_Num = 0;
            ...
            ABC_Num = ABC_Num.add(listSell[orderID].ABC_quantity.add(listSell[orderID].ABC_quantityZS)); 
