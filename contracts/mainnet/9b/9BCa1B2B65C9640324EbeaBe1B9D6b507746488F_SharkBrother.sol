...
/*
SharkBro is a hyper-deflationary token with rewards for its holders, used in Metaverse and GameFi with its own NFT Marketplace.

TG : https://t.me/sharkBroBSC
*/
...
contract SharkBrother is Context, IERC20 { 
    ...
    uint256 private _tTotal = 4 * 10**15 * 10**_decimals;
    string private constant _name = "SharkBrother"; 
    string private constant _symbol = "SharkBrother"; 
