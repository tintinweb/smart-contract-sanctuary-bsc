...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "REKT 413";
    string private constant _symbol = "R413";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 4130 * 10**_decimals;
    uint256 public _maxTxAmount = 207 * 10**_decimals;
    uint256 public _maxWalletAmount = 207 * 10**_decimals;
