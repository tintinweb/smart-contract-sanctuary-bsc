...
// Telegram : https://t.me/PrisonerSambscx100
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDCefbc4C488Cc1Fb0B8D53738FA492F807a62400;
...
contract prisonersam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PRISONER SAM";
    string private _symbol = "PRISONER SAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDCefbc4C488Cc1Fb0B8D53738FA492F807a62400);
    address payable public teamWalletAddress = payable(0xDCefbc4C488Cc1Fb0B8D53738FA492F807a62400);
