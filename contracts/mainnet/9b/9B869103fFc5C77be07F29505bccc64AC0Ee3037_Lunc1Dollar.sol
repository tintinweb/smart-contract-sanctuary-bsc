...
/*
Lunc1Dollar (LUNC$1) is a Lunc Rewarding token that are deflationary with autoburn function.

Having big success on several Lunc-themed token. Lunc1Dollar is a new project from based dev.
Enjoy 1000x moonshot in Lunc1Dollar

TG : https://t.me/Lunc1Dollar
*/
...
contract Lunc1Dollar is Context, IERC20 { 
    ...
    string private constant _name = "Lunc1Dollar"; 
    string private constant _symbol = "LUNC$1"; 
