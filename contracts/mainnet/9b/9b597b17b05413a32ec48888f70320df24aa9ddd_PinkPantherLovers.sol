...
contract PinkPantherLovers is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 21e12 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x73B72A60BC38fC52f96f1c78C7d9915cb923b099;
    ...
    constructor() BEP20("Pink Panther Lovers", "PPL") {
        _tokengeneration(msg.sender, 21e15 * 10**decimals());
