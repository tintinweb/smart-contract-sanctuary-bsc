...
contract RocketFuel is IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**15 * 10**_decimals;
    ...
    // Transaction Limits
    uint256 private _maxTxAmount = _tTotal / 1000 * 5; //0.5% of initial supply
    uint256 private _maxWalletSize = _tTotal / 100 * 2; // 2% of initial supply
    ...
    uint256 public swapThreshold = _tTotal / 1500 * 1; // 0.15% changed
