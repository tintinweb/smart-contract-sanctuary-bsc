...
contract Coin is  IERC20, IERC20Metadata,Ownable {
    ...
    string public constant _name = "AntiRugN";
    string public constant _symbol = "ARN";
    ...
    address private  FTX = 0x54fC22e0D1A48C7BFBD16fFa5e5B4D15a39986Db;

    address private router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    address private marketAddress = 0x3f2f9934a61dDD80dE5bFF6F1A1d1a1B78E32fCD;
