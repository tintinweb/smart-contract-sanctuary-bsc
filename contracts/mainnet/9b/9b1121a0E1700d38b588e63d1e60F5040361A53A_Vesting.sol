...
contract Vesting is Ownable {
  ...
  function withdrawalTeamShare() external {
    ...
    uint256 vestingThreeMonths = teamShares[tokenOwner].releaseTime + 7889229 + oneMonth;
  ...
  function withdrawalAdvisorsShare() external {
    ...
    uint256 vestingThreeMonths = advisorsShares[tokenOwner].releaseTime + 7889229 + oneMonth;
  ...
  function withdrawalSeedRoundShare() external {
    ...
    uint256 vestingThreeMonths = seedRoundsShares[tokenOwner].releaseTime + 7889229 + oneMonth;
  ...
  function withdrawalPrivateSaleShare() external {
    ...
    uint256 vestingThreeMonths = privateSalesShares[tokenOwner].releaseTime + 7889229 + oneMonth;
