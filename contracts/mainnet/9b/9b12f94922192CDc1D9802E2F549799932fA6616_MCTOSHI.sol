...
contract MCTOSHI  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MCTOSHI";
    string private _symbol = "McT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x269AbFf6237D740b1973589a18a96D4b0d1c1246); 
    address payable public teamWalletAddress = payable(0x16225769b26E138D457896BC63f46dBcC3857FF4); 
