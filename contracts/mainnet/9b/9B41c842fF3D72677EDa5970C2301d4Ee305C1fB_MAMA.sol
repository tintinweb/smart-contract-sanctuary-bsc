...
contract MAMA is MAMADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MAMATeam;
    address private CharityMAMA;
    ...
    string public override name = "MAMA SHIBA";
    string public override symbol = "MAMA";
    ...
    constructor(uint totalSupplyValue, address MAMATeamAddress, address CharityMAMAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MAMATeam = MAMATeamAddress;
        CharityMAMA = CharityMAMAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MAMATeam] =  totalSupply * 4 / 100;
        balances[CharityMAMA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MAMATeam pot
