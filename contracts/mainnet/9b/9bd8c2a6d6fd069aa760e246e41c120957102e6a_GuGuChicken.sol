...
contract GuGuChicken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GuGuChicken";
    string private _symbol = "GGC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60f046ac5Eb24B16875C04e937E45F3A0FD7157B); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xAD241a157Afa7D517083E8F609fB6dadF48C6F1d); // buyback Address
