...
contract IGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Imov Grow";
    string private _symbol = "IGROW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x989C5604d8f227cFFAC96F9e1aA244EF4fEF5B14); // Marketing Address BHC2
    address payable private TeamWallet = payable(0xFdFcA009E6f44d7B3C18460Cd2CAc94101774E98); // Buy Back Address
