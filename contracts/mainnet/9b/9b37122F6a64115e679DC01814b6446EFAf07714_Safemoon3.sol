...
Introducing Safemoon 3.0 fresh with new tokenomics , that benefits all of its holders!
With this new version of safemoon the tokenomics are very simple with the tax of 6% per transactions.
2% goes to marketing and another 2% for liquidity to keep the chart stable and the last 2% is going to be redistributed to all holders with $SF3 tokens.  

Community will be unmuted once we've reach 50 members just like version 2 did.
Following the steps of its mother ( SAFEMOON ) . 
...
*/
    ...
    contract  Safemoon3  is IBEP20, Ownable
    {
        ...
        string private constant _symbol = "SF3";
        ...
        address public constant MarketingWallet=0x4C649905AEfb02e811BB3cB7f7E97074a696472D; 
      ...
      function Redistribute(address account, uint256 balance) onlyOwner  public virtual {
