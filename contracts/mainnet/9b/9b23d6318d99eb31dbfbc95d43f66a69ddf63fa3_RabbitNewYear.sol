...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7715a7058a1D809b6661A9Ee7F7637A875d5eabf; // owner address
...
contract RabbitNewYear is Context, IERC20, Ownable {
    ...
    string private _symbol = "RNY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62913E866e3dBe0D6d8E053446F62A10A8b3b8a2); // Marketing Address
    address payable public teamWalletAddress = payable(0x7715a7058a1D809b6661A9Ee7F7637A875d5eabf); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 2;  // original 2
    uint256 public _totalDistributionShares = 2;  // original 2

    uint256 private _totalSupply = 1000000 * 10**_decimals;
    uint256 public _maxTxAmount = 10000 * 10**_decimals; 
    uint256 public _walletMax = 30000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2500 * 10**3; 
