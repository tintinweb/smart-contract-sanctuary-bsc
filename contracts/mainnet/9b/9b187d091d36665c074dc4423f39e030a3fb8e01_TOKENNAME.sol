...
contract TOKENNAME is Context, ERC20, Ownable {
    ...
    constructor() ERC20 ("Tokenname", "Project Symbol") {
        ...
        TotalSupply = 100000000; //Set the total token supply

        sendTokens = false; //False to send ETH to marketing, true to send tokens to marketing

        liquidityWallet = owner();
        buybackWallet = address(payable(0xa238210079F59b508F7a28b40c5c3E55aEA6ba54));
        marketingWallet = address(payable(0x287672991A938DbFf5f10b7926055C6007E68B64));
        developmentWallet = address(payable(0x95307841fa5D960597e3ab1bC3F45BaC4ECF5046));
        charityWallet = address(payable(0x562E3D27373D9839923bCe0782b8fd6864f2f23a));
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Tokenname: Account is already the value of 'excluded'");
    ...
    function updateIsElon(address account, bool elon) public onlyOwner {
        require(_isElon[account] != elon, "Tokenname: Account is already the value of 'elon'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Tokenname: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Tokenname: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Tokenname: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Tokenname: The marketing wallet is already this address");
	...
	function updateBuybackWallet(address newBuybackWallet) public onlyOwner {
        require(newBuybackWallet != buybackWallet, "Tokenname: The marketing wallet is already this address");
	...
	function updateDevelopmentWalletWallet(address newDevelopmentWallet) public onlyOwner {
        require(newDevelopmentWallet != developmentWallet, "Tokenname: The marketing wallet is already this address");
	...
	function updateCharityWallet(address newCharityWallet) public onlyOwner {
        require(newCharityWallet != charityWallet, "Tokenname: The marketing wallet is already this address");
    ...
    function _transfer(
		...
		if(canSwap && !swapping && automatedMarketMakerPairs[to] && !_isExcludedFromFees[to] && !_isExcludedFromFees[from]) {
            ...
            (bool success, ) = buybackWallet.call{value: buybackAmount}("");
            require(success, "Failed to send buyback amount");
            }
            ...
            (bool success, ) = charityWallet.call{value: charityAmount}("");
            require(success, "Failed to send charity amount");
            }
	...
	function letsGoLive() external onlyOwner() {
        updateBuyFees(buyBuybackFee,buyMarketingFee,buyDevelopmentFee,buyLiquidityFee,buyCharityFee);
        updateSellFees(sellBuybackFee,sellMarketingFee,sellDevelopmentFee,sellLiquidityFee,sellCharityFee);
    ...
    function updateBuyFees(uint256 newBuyBuybackFee, uint256 newBuyMarketingFee, uint256 newBuyDevelopmentFee, uint256 newBuyLiquidityFee, uint256 newBuyCharityFee) public onlyOwner {
    ...
    function updateSellFees(uint256 newSellBuybackFee, uint256 newSellMarketingFee, uint256 newSellDevelopmentFee, uint256 newSellLiquidityFee, uint256 newSellCharityFee) public onlyOwner {
