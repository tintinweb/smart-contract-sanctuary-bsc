...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2129d472aF31a5E8F81Cda13C7dD9C60fE2aC701;
...
contract DiamondDOGE is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0x2129d472aF31a5E8F81Cda13C7dD9C60fE2aC701;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DiamondDOGE";
    string private _symbol = "DMDOGE";
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[marketingWallet] = _rOwned[marketingWallet].add(rDevelopment);
        if(_isExcluded[marketingWallet])
            _tOwned[marketingWallet] = _tOwned[marketingWallet].add(tDevelopment);
    }
