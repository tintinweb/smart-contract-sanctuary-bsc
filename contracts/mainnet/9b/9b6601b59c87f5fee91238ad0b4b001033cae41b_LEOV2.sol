...
contract LEOV2
 is Context, IERC20, Ownable {
    ...
    string private _name = "LEO V2";
    string private _symbol = "LEO V2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x175076d9dD223107cC98ebB8CDD1B7578E785Ac1);
    address payable public teamWalletAddress = payable(0x175076d9dD223107cC98ebB8CDD1B7578E785Ac1);
    address public immutable deadAddress = 0x175076d9dD223107cC98ebB8CDD1B7578E785Ac1;
