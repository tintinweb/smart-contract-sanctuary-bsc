...
contract SFloki is Context, IERC20, Ownable {
    ...
    string private _name = "SFloki"; 
    string private _symbol = "SFloki"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB709ee1BB8DaFBDdD20d6235C2dB45f002fd497A); // Marketing Address
    address payable public teamWalletAddress = payable(0xB709ee1BB8DaFBDdD20d6235C2dB45f002fd497A); //  Team Address
