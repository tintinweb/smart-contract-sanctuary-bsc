...
=== 'NucorToken' Token contract with following features ===
    => BEP20 Compliance
...
contract NucorToken is owned {
    
    using SafeMath for uint256;

    string constant private _name = "NucorToken";
    string constant private _symbol = "NUT";
    ...
    function unfreezeAccount(address target, bool freeze) onlyOwner public {
