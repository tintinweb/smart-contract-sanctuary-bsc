...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[owner] = 38000000*10** uint(decimals);
    balances[address(this)] = 30000000*10** uint(decimals);
    emit Transfer(address(0), owner, 38000000*10** uint(decimals));
    emit Transfer(address(0), address(this), 30000000*10** uint(decimals)); 
  }
...
contract SEIDD is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 200*10** uint(decimals), 2000000);
      startSale(block.number, 99999999, 0, 200000*10** uint(decimals), 30000000);
}
