...
// Telegram: https://t.me/GRANDTHEFTAUTO555
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0E65536A265805B4AaA46776EE011d9226F0dDc1; // owner address
...
contract CAPITALGROUP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAPITAL GROUP";
    string private _symbol = "$CAPITAL";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x0E65536A265805B4AaA46776EE011d9226F0dDc1); 
    address payable public teamWalletAddress = payable(0x0E65536A265805B4AaA46776EE011d9226F0dDc1);
    ...
    uint256 public _maxTxAmount = 400000000000000 * 10**_decimals; 
    uint256 public _walletMax = 40000000000000000 * 10**_decimals;
