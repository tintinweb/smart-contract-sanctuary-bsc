...
import "../interfaces/ILshareVault.sol";
...
contract LShareRewardPoolV2 {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            if (_pending > 0) {
                vault.safeLShareTransfer(_sender, _pending);
    ...
    function setVault(ILshareVault _vault) external onlyOperator {
        vault = _vault;
    }
...
interface ILshareVault {
    function safeLShareTransfer(address _to, uint256 _amount) external;
}
