...
contract BabyMemenation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Memenation";
    string private _symbol = "$BMN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xaF5D7BcB493A6292e3e9C603469E1D93a146BB33); // Marketing Address SM
