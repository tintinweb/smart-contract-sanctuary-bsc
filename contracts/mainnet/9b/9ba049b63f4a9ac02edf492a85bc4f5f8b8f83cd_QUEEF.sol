...
contract QUEEF is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Queef Elizabeth Inu", "QUEEF") {
        ...
        maxWallet = totalSupply * 250 / 1000; // 25% maxWallet
        swapTokensAtAmount = totalSupply * 2500 / 10000; // 25% swap wallet
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 250 / 1000, "Swap amount cannot be higher than 0.5% total supply.");
