...
contract DRAC  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DRAC";
    string private _symbol = "DRAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x990BFa2f5Fbe1bB75A727137d41Eef1E4C67C06e);
    address payable public teamWalletAddress = payable(0x39824A35bF78509E61755e0d8004d594bf16D64C);
    ...
    constructor () {
        ...
        emit Transfer(address(0xABCD756f71564a1c24e4C8f429580c4A6DCfbccc), _msgSender(), _totalSupply);
    }
