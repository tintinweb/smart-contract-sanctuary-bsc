...
contract dappbot is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x586f0BeF394B11D6e9dC28Fd283089C2E26A543C); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x586f0BeF394B11D6e9dC28Fd283089C2E26A543C);
    ...
    constructor () {
        ...
        _owner = 0x586f0BeF394B11D6e9dC28Fd283089C2E26A543C;
