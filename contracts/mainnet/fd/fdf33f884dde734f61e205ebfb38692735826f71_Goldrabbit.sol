...
contract Goldrabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gold Rabbit";
    string private _symbol = "GRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B1d1e83E5771b1fD88Ae5C46ffba1c82bb7d64c);
    address payable public teamWalletAddress = payable(0x1B1d1e83E5771b1fD88Ae5C46ffba1c82bb7d64c);
