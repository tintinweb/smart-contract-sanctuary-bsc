...
/**
/*  
我们在 BSC CHAIN 上线，让 $SHIRA 成为一个未来的项目，通过持有 $SHIRA 代币，可以让你在未来实现财务自由。
2/2 用于营销，供应量为 3,000,000
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBB5B48Abe7ea4389fc73B7D2e962C585363Ff7C5; 
...
contract ShiraInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBB5B48Abe7ea4389fc73B7D2e962C585363Ff7C5); // 
    address payable public teamWalletAddress = payable(0xBB5B48Abe7ea4389fc73B7D2e962C585363Ff7C5); // 
