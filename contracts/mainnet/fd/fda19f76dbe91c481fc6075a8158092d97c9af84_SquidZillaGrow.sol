...
Meme season is here! Missed Squid Grow? Like Godzilla emerging from the depths of the Ocean, we have the next trending GROW token here with SQUIDZilla Grow! 
...
contract SquidZillaGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidZillaGrow"; // 
    string private constant _symbol = "SQUIDZG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    uint256 public reflect = 0;
    address public  _marketingWallet = 0x66B2B0d52137880B72F12a7077F81639B5E68ecB;
