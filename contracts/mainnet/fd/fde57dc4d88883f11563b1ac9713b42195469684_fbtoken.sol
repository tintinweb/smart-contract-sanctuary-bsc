...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8715623b678009a0A51B486438666A81fC32C350;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x8715623b678009a0A51B486438666A81fC32C350),//fund address
    
        address(0x8715623b678009a0A51B486438666A81fC32C350)//dev address
    ){
