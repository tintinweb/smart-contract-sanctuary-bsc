...
contract BabyRichCoin is Context, IERC20, Ownable, Initializable, ReentrancyGuard {
    ...
    IERC721 constant BWC_NFT = IERC721(0x5686bdadee47A9CD028a8591FAb5774dA46AC06c);
    ...
    IERC721 constant BBF_NFT = IERC721(0xbfC6f05de1117ADD87d6e2fB5338633dc96D6f64);
    ...
    function available(address _user, NftItem[] memory items) external view returns (uint totalRemain) {
        if (block.timestamp < claimStartAt || block.timestamp > claimStopAt) {
            return 0;
        }
