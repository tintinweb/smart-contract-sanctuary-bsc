...
contract VRGW is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 500000 * 10**18;
    ...
    constructor() BEP20("Virtual Reality Game World", "VRGW") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 5000000, "Swap threshold amount should be lower or equal to 1% of tokens");
