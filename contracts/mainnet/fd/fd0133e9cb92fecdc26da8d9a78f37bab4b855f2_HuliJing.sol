...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3D0C50F3a3a363E46fE1463F5DB27E4154080493; 
...
contract HuliJing is Context, IERC20, Ownable {
    ...
    string private _name = "Huli Jing";
    string private _symbol = "HULIJING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D0C50F3a3a363E46fE1463F5DB27E4154080493); // 
    address payable public teamWalletAddress = payable(0x3D0C50F3a3a363E46fE1463F5DB27E4154080493); // 
