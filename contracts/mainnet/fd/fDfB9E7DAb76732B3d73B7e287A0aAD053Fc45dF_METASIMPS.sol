...
contract METASIMPS is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'METASIMPS';   // Name
	string constant _symbol = 'MSIMPS';    // Symbol
    ...
    uint256 constant liquidityFeeBuy  = 500;
    uint256 constant marketingFeeBuy  = 500;
    uint256 constant totalFeeBuy      = 1000;

    // Sell Fees
    uint256 constant reflectionFeeSell = 0;
    uint256 constant liquidityFeeSell  = 500;
    uint256 constant marketingFeeSell  = 500;
    uint256 constant totalFeeSell      = 1000;
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0xb27B8d3cfd73CbC2c947bC67AEa7090637D97E1C;
        marketingFeeReceiver = 0xA64F0286E9818A939B1F28Bd27d7eB373127D0EB;
