...
contract bunny is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 3000_000_000_000 * 10 ** _decimals;  //

    address public marketingAddress = 0x96f8c4B8B4c8dD6cd88dF0f37e87B1431D86EE54; //
    address public devAddress = 0x7E613b53c443f7347e5c81b9Db72325BAdBb8D5E;    //

    string private constant _name = "Easter Bunny";  //
    string private constant _symbol = "Easter Bunny";  //
