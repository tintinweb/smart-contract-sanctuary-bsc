...
contract TwinShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TwinShib";
    string constant _symbol = "TwinShib";
    ...
    address public Owner=0xFAF4847475e62617f468cd5CCe56008a7c7a8CaA; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xFAF4847475e62617f468cd5CCe56008a7c7a8CaA;
