...
contract iTube is BEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        rewardFeeReceiver = 0xF7553b27207918c6D790797699F2e6eFE92209CD;
    ...
    function swapBack() internal swapping {
        ...
        if(rewardFee > 0){
            uint256 amountBNBreward = (amountBNB * rewardFee) / totalFee;
    ...
    function setFees_base1000(uint256 _marketingFee, uint256 _rewardFee) external onlyOwner {
        marketingFee = _marketingFee;
        rewardFee = _rewardFee;
        totalFee = _marketingFee + _rewardFee;
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _rewardFeeReceiver) external onlyOwner {
        ...
        require(_rewardFeeReceiver != address(0),"Team fee address cannot be zero address");

        marketingFeeReceiver = _marketingFeeReceiver;
        rewardFeeReceiver = _rewardFeeReceiver;

        emit Set_Wallets(marketingFeeReceiver, rewardFeeReceiver);
    }
...
event Set_Wallets(address MarketingWallet, address RewardPoolWallet);
