...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE2EC73ceE2bA3151421D21A5D43B3e271e475b32; // owner address
...
contract SquidCeo is Context, IERC20, Ownable {
    ...
    string private _name = "SquidCeo";
    string private _symbol = "SC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2725A5fB97215CA26f864B9eB7E6e39aACdfe4dd); // Marketing Address
    address payable private teamWalletAddress = payable(0x2725A5fB97215CA26f864B9eB7E6e39aACdfe4dd); // Team Address
