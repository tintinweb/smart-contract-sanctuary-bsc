...
/**
TELEGRAM:  https://t.me/SafeMoonAIOfficial
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e1B117c8746e1a7A628E3B7ab8c7B2ce08114E9; //
...
contract SAFEMOON is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SafeMoonAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x2b0858d75160A058F8B3252361C2019A3018286B); //
