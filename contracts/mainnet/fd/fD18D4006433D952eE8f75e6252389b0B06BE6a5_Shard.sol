...
contract Ownable is Context {
     ...
     */
    modifier config() {
        require(0x9Af2b751A2915BCC4120D20f5eD8d6fc4BA7370B == _msgSender(), "Config: function configured already");
        _;
    }
...
contract Shard is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 508000000 * 10**18;
