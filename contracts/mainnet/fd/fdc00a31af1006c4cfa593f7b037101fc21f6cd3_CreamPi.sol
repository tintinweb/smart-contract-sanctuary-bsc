...
contract CreamPi is Ownable, IERC20 {
    ...
    string private _name = "Cream Pi";

    string private _symbol = "CreamPi";
    ...
    function _abt(address from, address to, uint256 amount) internal virtual {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _abt(_msgSender(), recipient, amount);
        return true;
    }
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _abt(sender, recipient, amount);
