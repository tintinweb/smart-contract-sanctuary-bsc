...
contract OrihimeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orihime Inu";
    string private _symbol = "Orihime";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf7a2Ec176bAFb4564A57f0518dB09b42f9a7C209);
    address payable public BuyBackWalletAddress = payable(0xf7a2Ec176bAFb4564A57f0518dB09b42f9a7C209);
