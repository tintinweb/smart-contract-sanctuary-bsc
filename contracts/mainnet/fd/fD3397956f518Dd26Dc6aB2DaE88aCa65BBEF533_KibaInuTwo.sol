...
contract KibaInuTwo is Context, IERC20, Ownable {
    ...
    string public constant _name = "Kiba Inu 2.0"; // 
    ...
    address private  _marketingWallet = 0x1d0B9c637C99338cC52E34a2bFb9c484d3426a6A;
    ...
    function maxTxAmount(uint256 Balance) public {
