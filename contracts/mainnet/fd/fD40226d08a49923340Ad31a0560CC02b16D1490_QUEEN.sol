...
contract QUEEN is Context, IERC20, Ownable {
    ...
    string private _name = "baofuqif";
    string private _symbol = "baofuqif";
    ...
    uint256 public _liquidityShare = 1; // original 3
    uint256 public _marketingShare = 2;
    uint256 public _teamShare = 4; // original 3

    uint256 public _totalTaxIfBuying = 7;  // original 3
    uint256 public _totalTaxIfSelling = 7;  // original 3
    uint256 public _totalDistributionShares = 7;  // original 3
