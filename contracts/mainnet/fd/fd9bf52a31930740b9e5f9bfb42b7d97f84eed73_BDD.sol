...
contract BDD is ERC20 {
	...
	address _fundAddress = _destroyAddress;
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) public automatedMarketMakerPairs;

    bool public swapAndLiquifyEnabled = true;
    uint256 public maxdestroy;
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("BDD", "BDD") {
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**29);
        ...
        uint256 total = 21000 * 10**18;
		maxdestroy = total.div(100).mul(99);
    ...
    function _transfer(
        ...
        if(address(this) == from || address(to) == to){
