...
contract BabyMercury is ERC20Taxation {
    bool public presaleEnded;
    IBarrier private _barrier;

    constructor() 
    ERC20("BabyMercury", "BABYMERCURY")
    ERC20DexLink(0x10ED43C718714eb63d5aA57B78B54704E256024E)
    {
        autoSupportWallets = [0x2030E4030ce641bD2Dd4CA84226C2e9A17a7A4d6, 0x331313CcEFC39062aCB857d9f7a84ecC4f65dAF1, 0x198465c94401B92d3F0E8fD7F321c96DaCfCA43E];
        _isExcludedFromFee[0x2030E4030ce641bD2Dd4CA84226C2e9A17a7A4d6] = true;
        _isExcludedFromFee[0x331313CcEFC39062aCB857d9f7a84ecC4f65dAF1] = true;
        _isExcludedFromFee[0x198465c94401B92d3F0E8fD7F321c96DaCfCA43E] = true;
    ...
    function finalizePresale() public onlyOwner {
        require(!presaleEnded, "BabyMercury: Its already finalized.");
        presaleEnded = true;
    }
    ...
    modifier onlyBarrier() {
        require(_msgSender() == address(_barrier), "BabyMercury: You are not the barrier.");
        _;
    }
}