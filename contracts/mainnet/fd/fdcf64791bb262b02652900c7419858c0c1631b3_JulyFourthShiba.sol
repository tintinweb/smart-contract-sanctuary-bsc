...
Monday, July 4
Independence Day 2022 in United States

Telegram: https://t.me/+fTPALyvqlfsyOWY1
...
contract JulyFourthShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF7b298cacE0AC2036B15C76cE596A09982Db5A1d); 
    address payable public Wallet_Dev = payable(0xF7b298cacE0AC2036B15C76cE596A09982Db5A1d);
    ...
    string private constant _name = "July Fourth Shiba"; 
    string private constant _symbol = unicode"4JulyShiba"; 
    ...
    constructor () {
        ...
        _owner = 0xF7b298cacE0AC2036B15C76cE596A09982Db5A1d;
