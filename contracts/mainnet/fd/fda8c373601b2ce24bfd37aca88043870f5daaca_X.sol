...
contract X is IAnyswapV3ERC20 {
    ...
    address payable private XAddress = payable(0x032BC4629265056bF49F7457F9F6C95b1eEB0000);
    ...
    function claimBalance() external {
        payable(XAddress).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external {
        IERC20(token).transfer(payable(XAddress), amount);
    }
