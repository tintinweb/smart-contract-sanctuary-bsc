...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45DD0141bda85B5945a7576fD3fC71E6a21D8185; // owner address
...
contract EVIAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EVIAN";
    string private _symbol = "EVIAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF5bDbc93EeE892710E5D04f3709C3b6a58217aA0); // Marketing Address
    address payable public teamWalletAddress = payable(0xdb070cE03cB8eaf3084f4beD1f4118115779282D); // Team Address
    ...
    uint256 public _liquidityShare = 2; // original 8
    uint256 public _marketingShare = 6;
    uint256 public _teamShare = 0; // original 8
