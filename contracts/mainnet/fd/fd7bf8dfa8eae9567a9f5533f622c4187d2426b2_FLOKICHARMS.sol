...
contract FLOKICHARMS is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6eBAaF6B5374dB9563c22bea234e4ba6daE11cdA;

    string private constant _name = "FLOKI CHARMS";
    ...
    Taxes public taxes = Taxes(4, 8, 2);
    Taxes public sellTaxes = Taxes(4, 8, 2);
