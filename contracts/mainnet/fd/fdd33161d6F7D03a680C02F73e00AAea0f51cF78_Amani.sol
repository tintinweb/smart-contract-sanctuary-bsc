...
contract Amani is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Amani";
    string private _symbol = "Amani";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15033F7973786a36027f03cE0831AC26da888B2B); // Marketing Address
    ...
    uint256 private _totalSupply = 1993 * 10**_decimals;
    uint256 public _maxTxAmount = 1993 * 10**_decimals; 
    uint256 public _walletMax = 1993 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1993 * 10**3; 
