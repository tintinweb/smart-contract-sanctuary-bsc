...
/**
    ...
    OneChi Inu is a humorous characteristic Maangchi. low tax community driven coin. 5/5 Tax
    Telegram: https://t.me/OneChiInu
    Tax: 5% Tax Buy/Sell
...
contract OneChiInu is IBEP20, Auth {
    ...
    string constant _name = "OneChi Inu";
    string constant _symbol = "OCHINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 400;     //5%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 200;   //10%
    ...
    address private marketingFeeReceiver = 0x56805060F767C5adFdf7009d1449014745868FBd;
    address private teamFeeReceiver = 0x56805060F767C5adFdf7009d1449014745868FBd;
