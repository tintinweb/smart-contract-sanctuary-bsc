...
//**telegram https://t.me/KILL_ALL_CEO
...
contract KILLALLCEO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "KILLALLCEO";
    string private _symbol = "KILLCEO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe554fA1e289C87ABDcE492F8bDa47Cdfb801674E);
    address payable public liqWalletAddress = payable(0xe554fA1e289C87ABDcE492F8bDa47Cdfb801674E);
