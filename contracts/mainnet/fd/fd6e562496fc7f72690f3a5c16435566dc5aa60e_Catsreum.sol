...
contract Catsreum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catsreum";
    string private _symbol = "CATSR";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x826F4F058A03BfeBF4A791a0dBe563Ca621Bb425); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdFB05bc1a8E891bfbd9eCBA5DB33Af7246F1d1b5); // BuyBack Address
