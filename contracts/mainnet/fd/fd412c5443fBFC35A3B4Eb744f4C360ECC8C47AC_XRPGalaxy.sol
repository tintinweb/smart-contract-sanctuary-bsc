...
XRPGalaxy - 8% XRP reflection

Total supply: 1,000,000
Max wallet: 20,000(2%)
Max Buy / Sell: 10,000 (1%)
...
Telegram: https://t.me/XRP_Galaxy
...
contract XRPGalaxyDividendTracker is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1000 * (10**9); // Must hold 1000 token to receive XRP
...
contract XRPGalaxy is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "XRPGalaxy";
    string _symbol = "XRPY";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxWallet = _totalSupply.mul(3).div(150); 
    ...
    address public marketing = address(0x35570027C19948be4322ab3a5d32482f244f3ad2);
    address public liquidity = address(0x6Fd4EB90607eF894530a97D505E80CcB0c89a18e);

    IDEXRouter public router;
    address pair;

    XRPGalaxyDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new XRPGalaxyDividendTracker();
