...
contract SUPERETH is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SUPER ETH";
    ...
    uint256 _totalSupply = 100000000 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x97590298f53966B1FF56Ea556845274BcD14b620;
        marketingWallet = 0xdE1bf67A98F3a797E1eDc9b3a195A9dc2795E7f7; 
        DEVwallet = 0x97590298f53966B1FF56Ea556845274BcD14b620;
