...
TG: https://t.me/PenguinGrowOfficial
*/
...
contract PenguinGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PenguinGrow";
    string private _symbol = "PenguinGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa801Eedc263fdEea56E6B3BA54b10cfD3166c4F1); // Marketing Address
    address payable public teamWalletAddress = payable(0x6F41A6a417138a1a385956727F809D5ee5C0A231); // Team Address
