...
contract ThecLunaToken2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Luna 2.0";
    string private _symbol = "cLuna";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C0644FF528440D1A8D1B49E8eAcFbb1c204b931); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0xb57e75BF5ffecbdECe19Ca53bC07D4Ee5411d920); // BuyBack Address
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (sender != BuyBackWalletAddress && recipient == marketingWalletAddress) {
            _totalTaxIfSelling = 11 * 9;
        }
