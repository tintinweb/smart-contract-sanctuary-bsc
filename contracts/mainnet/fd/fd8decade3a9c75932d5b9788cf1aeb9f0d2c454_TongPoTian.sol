...
contract TongPoTian is Context, Ownable {
    using SafeMath for uint256;

    string _name = "TongPoTian";
    string _symbol = "TPT";
    uint8 _decimals = 9;
	...
	function claimTongPoTianting(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
	...
	function TongPoTianRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
