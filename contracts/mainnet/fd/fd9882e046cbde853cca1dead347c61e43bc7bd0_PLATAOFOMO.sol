...
*/
//Inspired by one of greatest Netflix Series, we took the idea and bring it to the BSC. We aim to be viral, too!
// Main Telegram: https://t.me/PlataOfomo
// SHILLING ARMY: https://t.me/PlataoFomoshilling
...
contract PLATAOFOMO is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "PLATAOFOMO";
   string constant _symbol = "PLATAOFOMO";
