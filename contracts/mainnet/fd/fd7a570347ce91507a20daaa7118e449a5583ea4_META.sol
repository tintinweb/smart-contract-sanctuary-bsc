...
contract META is Context, IERC20, Ownable {
    ...
    string private _name = "META2.0";
    string private _symbol = "META2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x642CC767cf5BB58A6A0b684F8500ECa7AC121213); 
    address payable public BurnedWalletAddress = payable(0x642CC767cf5BB58A6A0b684F8500ECa7AC121213); 
