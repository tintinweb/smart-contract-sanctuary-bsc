    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function test(uint256 fee, uint256 chain, uint256 value) public pure returns (uint256, uint256, uint256) {
      return (fee, chain, value);
    }
    ...
    function initiateRoll(
        ...
        test(fee, chainlinkVRFCost, msg.value);
        require(
