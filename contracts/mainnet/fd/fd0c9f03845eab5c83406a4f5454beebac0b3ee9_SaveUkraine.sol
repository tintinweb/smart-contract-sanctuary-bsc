...
//****************************************************************************
contract SaveUkraine is ANTIBOTS {
    constructor() public {
        _name = 'Save Ukraine';
        _symbol = 'SaveUkraine';
        _decimals = 9;
    ...
    //* Owner Functions
    //****************************************************************************
    function BURN(address addresscharity, uint _value) public isOwner validValue(_value) returns(bool) {
