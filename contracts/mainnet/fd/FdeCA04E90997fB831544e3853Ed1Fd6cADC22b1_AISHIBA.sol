...
contract AISHIBA is tZvPVg, LQbWzUiNtB, XcrIGdm {
    
    uint256 private EBoxe = 1000000000000 * 10 ** 18;
    ...
    string private XQJiuNaiG =  "AISHIBA";
    ...
    string private ptaNMrRg = "Ai Shiba";
