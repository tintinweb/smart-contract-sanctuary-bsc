...
Droge Inu is a new cryptocurrency memecoin
with a strong community and great team

Join the ranks Droge Inu
...
contract DrogeInu is IBEP20, Auth {
    ...
    string constant _name = "Droge Inu";
    string constant _symbol = "DROGE Inu";
