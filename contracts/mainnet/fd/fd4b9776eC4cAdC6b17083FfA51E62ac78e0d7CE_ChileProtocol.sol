...
contract ChileProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Chile Protocol";
    string constant _symbol = "CHIL";
