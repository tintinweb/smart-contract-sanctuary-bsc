...
contract XRP2050 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XRP 2050";
    string private _symbol = "XRP50";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x54B1f2F35DC72fbbcDd932C16af1684F16ceD689); // Marketing Address
    address payable public teamWalletAddress = payable(0x438cD4154e6B549B236e0D9961643019a0b7f1Ce); // Team Address
