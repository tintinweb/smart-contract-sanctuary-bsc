...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4907C1955963b2D466C6d3D2ec0840Ba3Cc0E83C; // owner address
...
contract Newcommunityacala is Context, IERC20, Ownable {
    ...
    string private _name = "New Community Acala";
    string private _symbol = "NCA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3ad09d83833ddE349366dC6DBd5aC2C84d0c1bC7); // Marketing Address
    address payable public teamWalletAddress = payable(0x3ad09d83833ddE349366dC6DBd5aC2C84d0c1bC7); // Team Address
