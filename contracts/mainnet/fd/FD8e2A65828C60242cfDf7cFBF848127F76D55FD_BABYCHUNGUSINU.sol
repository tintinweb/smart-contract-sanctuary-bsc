...
/**
IF CHUNGUS HAD A BABY THIS WOULD BE IT THE PERFECT MEME TO CONTINUE CHUNGUS AS A BABY IS AWESOME HAVE YOU SEEN THE GLORY THAT IT IS
COME JOIN US AS WE TAKE THIS CHUNGUS TO THE MOON WITH HUCHUNGUS CHUNGUS REWARDS!
...
contract BABYCHUNGUSINU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'BABY CHUGUS INU';
    string private constant _symbol = 'BABY CHUNGUS';
