...
contract NOBITAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nobita Inu"; // 
    string private constant _symbol = "NOBITA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x86b9A0dB4592269fa3e1506E141A0418316Aa634;
