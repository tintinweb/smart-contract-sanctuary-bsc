...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE76409C7A98dF7145650Dd425d50a231899f3ee8;
...
contract WomenInu is Context, IERC20, Ownable {
    ...
    string private _name = "Women Inu";
    string private _symbol = "WomenInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE76409C7A98dF7145650Dd425d50a231899f3ee8);
    address payable public teamWalletAddress = payable(0xE76409C7A98dF7145650Dd425d50a231899f3ee8);
