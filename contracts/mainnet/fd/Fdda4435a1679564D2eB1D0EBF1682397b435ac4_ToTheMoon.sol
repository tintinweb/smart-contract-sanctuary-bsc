...
// To The MOON Source Code
// Ethereum Reward on Binance Smart Chant Network
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD Rewrds Holders
...
/* Token contract */
contract ToTheMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x869411c2F2d672DD73D8B12ABB849c7cA9D2e034; // Wallet Developer
    ...
    // Name and symbol
    string constant _name = "To The Moon";
    string constant _symbol = "MOON";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);  // 1 QUATRILLION Supply

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 30 Trillions
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 30 Trillions
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 30 Trillions
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 0; // Send Back to Liquidity
    uint256 public buybackFeeBuy = 0; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeBuy = 3; // Reward Holders with BUSD
    uint256 public marketingFeeBuy = 5; // Calls Marketing Telegram Future
    uint256 public devFeeBuy = 2; // Continue Development and Pay team
    uint256 public totalFeeBuy = 10; //  Not more that 5% Total Tax

    // Sell fees
    uint256 public liquidityFeeSell = 0; // Send Back to Liquidity
    uint256 public buybackFeeSell = 0; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeSell = 3; // Reward Holders with BUSD
    uint256 public marketingFeeSell = 5; // Calls Marketing Telegram Future
    uint256 public devFeeSell = 2; // Continue Development and Pay team
    uint256 public totalFeeSell = 10; //  Not more that 5% Total Tax
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x263a257C48A859CD7Dc1a169d123Db1A41aA1a63; // Wallet Marketing Work
