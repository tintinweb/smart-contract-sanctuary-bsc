...
/**
 * BNB Sent to this contract will be used to automatically buy Token and send it back to the sender
 */
contract TokenSwap is Context, Ownable {
  ...
  address public _tokenAddr = 0x9fF0846a1F3f1D2950927ab2BE74f70e3B106cFA;
  
  function swapForToken(address sender, uint256 value) internal {
  ...
  function setTokenAddress(address nTKNAddr) public onlyOwner {
      _tokenAddr = nTKNAddr;
  }
