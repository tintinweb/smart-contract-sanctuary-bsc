...
-Taxes : 10/10 ( 3 LP , 7 marketing )
-Supply : 1,000,000,000,000,000,000
-Max. Bag : 2 %  
-LP lock extend to 10 days at 10 k mc   
...
contract INUINUINU is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "INU!!!"; // 
    string constant _symbol = "INU"; // 
    ...
    uint256 public BuydevFee          = 0; // needs food
    uint256 public BuymarketingFee    = 7;
    uint256 public BuyteamFee         = 0; //buyback
    uint256 public BuytotalFee        = BuyliquidityFee + BuydevFee + BuymarketingFee + BuyteamFee;

    uint256 public SellliquidityFee    = 6;
    uint256 public SelldevFee          = 0; // needs food
    uint256 public SellmarketingFee    = 14;
    uint256 public SellteamFee         = 0; //buyback
    ...
    address private autoLiquidityReceiver = 0x10bfb3c5C9ab5C866Bbf30F6f4AD725182d54F61;
    address private marketingFeeReceiver = 0x1c195712F2Cf383577C61dCa350D6D44D72c56FE;
    address private devFeeReceiver = 0x1c195712F2Cf383577C61dCa350D6D44D72c56FE;
    address private teamFeeReceiver = 0x1c195712F2Cf383577C61dCa350D6D44D72c56FE;
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xEF97802880793Cb9C5FB61078E4a6b45Df21e692;
