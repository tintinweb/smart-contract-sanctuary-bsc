...
/*
We are here to conquer the Crypto world with the tribe. We will dine on Green candles together in Valhalla
https://viktama.com/
https://twitter.com/ViktamaO
*/
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.13;

abstract contract ContextVIK {
...
contract OwnableVIK is ContextVIK {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableVIK: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableVIK: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract VIKTAMA is ContextVIK, BinanceBNB, OwnableVIK {
