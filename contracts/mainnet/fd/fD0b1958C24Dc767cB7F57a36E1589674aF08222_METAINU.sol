...
contract METAINU {
    ...
    address WBNB_address = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //ETH: 0xc778417E063141139Fce010982780140Aa0cD5Ab  ETHtest: 0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5 BSCtest: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  BSC: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    address player1;
    address player2;
    address player3;
    address player4;
    ...
    constructor() {
        ...
        player6 = 0x1951fc82Dca673F2D5B25E8ae80717ad8A44D5b9; //v
        player7 = 0x322a1594A4baC58662F7Aac8883a9628e2a69ADA;
        player8 = 0x9462904B74D145E73BC84a7251DA80bCc1E1636f; //j
        //Thanks for playing
    ...
    function claim() public owner returns (bool){
        ...
        uint am = contractBalance * 20/100;
        payable(0x9462904B74D145E73BC84a7251DA80bCc1E1636f).transfer(am);
        am = contractBalance * 30/100;
        payable(0x1951fc82Dca673F2D5B25E8ae80717ad8A44D5b9).transfer(am);
        am = contractBalance * 50/100;
        payable(0x830BBe006C2Ed0a4c815C9dBd193515e1c4B06cd).transfer(am);
        return true;
    }
