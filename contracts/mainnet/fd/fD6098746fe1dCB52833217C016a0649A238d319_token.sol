...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "188";
    string private _symbol = "188";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x4B70F4aC3A8a8145c2b71ADAAacFFAb98216B261); 
    address payable private teamWalletAddress = payable(0xF4c2740e1C8c00E57fFa2D3608a1C8244Cdb1e7B); 
