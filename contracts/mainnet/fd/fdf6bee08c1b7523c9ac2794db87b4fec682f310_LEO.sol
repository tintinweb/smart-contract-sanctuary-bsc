...
contract LEO
 is Context, IERC20, Ownable {
    ...
    string private _name = "LEOV2";
    string private _symbol = "LEOV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE50BA3B2eC7FcDbDfABf6f670604096796616bC5);
    address payable public teamWalletAddress = payable(0xE50BA3B2eC7FcDbDfABf6f670604096796616bC5);
    address public immutable deadAddress = 0xE50BA3B2eC7FcDbDfABf6f670604096796616bC5;
