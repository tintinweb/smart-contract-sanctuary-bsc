...
contract MiniCatInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mini Cat Inu";    
    string constant _symbol = "MiniC";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 10 * 10**5 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 101) / 10000;
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000;
    uint256 public mStx = ( _totalSupply * 101) / 10000;
    ...
    uint256 public sT = _totalSupply *  81/ 100000;
