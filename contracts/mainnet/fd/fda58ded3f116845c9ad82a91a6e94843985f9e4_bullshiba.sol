...
contract bullshiba is Context, IERC20, Ownable {
    ...
    string private _name = "BullShiba Chain";
    string private _symbol = "wBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcfF25EAbdc30Fa48B08e8ccC25ACb585bfF4a4CF);
    address payable public teamWalletAddress = payable(0xc7108D8b857357Ca76463bc29EFC04e093DaB125);
