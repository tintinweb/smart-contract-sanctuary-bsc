...
contract DRE is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 47;
    ...
    constructor (){
        ...
        uint256 total= 10000000000000;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0xB39F680eC08669BB850A97eCC311815dEEe2770A;
        devAddress = 0xB39F680eC08669BB850A97eCC311815dEEe2770A;
        ...
        ceoList[0x99add5c6e6003966d0768fb54676cD803161b8d9] = true;

        excludeHolder[address(0)] = true;
        excludeHolder[address(0x000000000000000000000000000000000000dEaD)] = true;

        holderRewardCondition = 2 * 10 ** IERC20(_fist).decimals();
        _limitAmount = 10 * 10 ** _decimals;
                ...
                if (_swapPairList[to]) {
                    ...
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            ...
                            uint256 numTokensSellToFund = amount * swapFee / 10;
