...
contract Tyrant is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x50B378f2Ff2e0D669754A37c8A8CDf98b1dE955C));
        marketingWallet = payable(address(0xba463Cb08b7E618A3a92e5e8025b13636F36E3a0));
