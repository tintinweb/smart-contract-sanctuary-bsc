...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2aCB861758a30E46333b27eF512c78ac5125F4CB; // owner address
...
contract Former is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev is Former";
    string private _symbol = "FORMER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5954D08CD43E1938924970957aa2D0df3Ae55228); // Marketing Address
    address payable public teamWalletAddress = payable(0x5954D08CD43E1938924970957aa2D0df3Ae55228); // Team Address
