...
//change "name1" and "symbol"
    ...
    uint256 internal _tokenTotal = 100_000_000_000e8;
    ...
    uint256 public minTokensBeforeSwap = 100_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x192e16ad98BBabDc420aC8dFfd6646ec6CE75Fbd;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
