...
// File: contracts/SimbaX.sol

pragma solidity ^0.8.4;

contract SimbaX is IERC20, Ownable, BaseToken {
  ...
  // Only for initialization. Owner can't set this back to false after initialization.
  bool public isTradingStarted = false;
    ...
    onlyOwner
  {
    require(
      pair != uniswapV2Pair,
      'SIMBAX TOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'SIMBAX TOKEN: Automated market maker pair is already set to that value'
    );
    automatedMarketMakerPairs[pair] = value;
  ...
  function _transfer(
    ...
    if (!isTradingStarted && (from == uniswapV2Pair || to == uniswapV2Pair)) {
