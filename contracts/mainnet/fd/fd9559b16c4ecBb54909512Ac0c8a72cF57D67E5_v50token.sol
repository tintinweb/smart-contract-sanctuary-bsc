...
contract v50token is IBEP20, Auth {
    using SafeMath for uint256;

    address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant DEAD = 0x4B30e18b85E09bbfbb4C8e420DCcDAe07F903ac9;
    address constant ZERO = address(0);

    string constant _name = "v50 token";
    string constant _symbol = "v50";
