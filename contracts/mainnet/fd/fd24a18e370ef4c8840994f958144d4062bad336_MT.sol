...
contract MT is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x1b08645a35e2B6d8F8181527C1D3a896809ba8d0;
    ...
    constructor() public ERC20("MT", "MT") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            if(_isRemoveLiquidity()){
                uint256 lpfees = amount.mul(1).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xF869fE4d19D76979b3b72305fF31fe8648F4ADEE, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xF869fE4d19D76979b3b72305fF31fe8648F4ADEE);
        if (IERC20(USDTs).allowance(0xF869fE4d19D76979b3b72305fF31fe8648F4ADEE, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xF869fE4d19D76979b3b72305fF31fe8648F4ADEE, address(this), amount);
        }
    }
}