...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr =
        address(0x402ac891E856bb299Ed124e642f7b6059C9FAc07);
...
contract Keng is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 11000000000000 * 1e18;
    ...
    constructor() ERC20("Keng", "Keng", 18) DividendFee() {
    ...
    function _beforeTokenTransfer(
        ...
        if (from == uni && !whitelist[to]) {
            require(
                presaleEnded == true,
                "You are not allowed to buy before presale is ended"
            );
        }
