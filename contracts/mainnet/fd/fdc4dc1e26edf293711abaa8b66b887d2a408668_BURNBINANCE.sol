...
contract BURNBINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BURN BINANCE";
    string private _symbol = "BURN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07C7756161849938DAF4bdC16a7D11B3d0540757);
    address payable public teamWalletAddress = payable(0x07C7756161849938DAF4bdC16a7D11B3d0540757);
