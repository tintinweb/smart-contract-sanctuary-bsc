...
contract GoldenDragon is Context, IERC20 { 
    ...
    string private constant _name = "GoldenDragon"; 
    string private constant _symbol = unicode"GDragon"; 
    ...
    function set_MaxWallet (uint256 maxTxAmount, uint256 maxWalletToken) external payable {
