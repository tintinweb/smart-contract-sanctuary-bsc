...
contract ustluna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ustluna";
    string private _symbol = "ustluna";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5; 
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9F421f25d57e822656E1eEdfC8c7E793F6E218B6);
    address payable public teamWalletAddress = payable(0x0B740cFfb47738F083Ec9A2d4c9BFD6142DACb36); 
