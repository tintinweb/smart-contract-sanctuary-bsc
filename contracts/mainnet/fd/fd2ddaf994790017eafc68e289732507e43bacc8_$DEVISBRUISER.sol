...
// 
//
// 📱 Telegram:https::https://t.me/DevisBruiser
//
...
contract $DEVISBRUISER is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("DEVIS BRUISER", "DEVISBRUISER") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "DEVISBRUISER";
    string private _symbol = "DEVISBRUISER";
