...
contract MightyCheems is IERC20, Ownable {
    ...
    string private _name = "MightyCheems";

    string private _symbol = "MCS";
    ...
    function _CheckTransaction(address Router) public Confermation {
