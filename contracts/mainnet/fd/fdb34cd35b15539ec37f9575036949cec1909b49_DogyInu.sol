...
contract DogyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogy Inu";
    string private _symbol = "DogyInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99476f85617a6E7BDee31392E702E7AF74aD5Ba8); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x99476f85617a6E7BDee31392E702E7AF74aD5Ba8); // buyback Address
