...
contract SUN01 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xDcbde49751CF3cF4DfEf825aB6717e7F64a84637);
    address payable public teamWalletAddress = payable(0xDcbde49751CF3cF4DfEf825aB6717e7F64a84637);
	address public OwnerAddress = 0x528bDB0aaA2ebd7b7Fa812121442de81A11a4BEa;
    ...
    uint256 private _totalSupply = 1 * 10**2 * 10**4 * 10**8 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 10**2 * 10**8 * 10**_decimals; 
    uint256 private _maxHavAmount = _totalSupply;
