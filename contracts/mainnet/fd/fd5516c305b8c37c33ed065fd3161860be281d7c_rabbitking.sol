...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf1bE982Db2C4b3139Cd8CBaF437E0AC9b6A8f91F; 
...
contract rabbitking is Context, IERC20, Ownable {
    ...
    string private _name = "RABBIT KING";
    string private _symbol = "$RKG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFfeCb5E9859A4b46881D61519997088b6BbDe9E9); 
    address payable public teamWalletAddress = payable(0xf1bE982Db2C4b3139Cd8CBaF437E0AC9b6A8f91F); 
