...
contract TbeToken is TbeTokenAdmin {
    ...
    constructor() ERC20("TBE", "TBE") {
        ...
        // 替换营销收币地址
        setFeeToMarketReceiver(address(0x309e172be22d0C0217FC3144d57cbEcC2F888888));
        // 1.替换邀请奖励出USDT地址；
        // 2.发布TBE合约后，区块浏览器中找到USDT合约，授权USDT给发布后的合约；
        // 3.给出金地址转入一些USDT，否则DEX购买会失败
        setInviteUsdtRewardPool(address(0xC2cC6a87E3c5Bd8525e0248dd546e9e329564DC3));
        // 1.替换持股分红地址：
        // 2.发布TBE合约后，区块浏览器中找到USDT合约，授权USDT给发布后的合约；
        setHolderUsdtRewardPool(address(0xC2cC6a87E3c5Bd8525e0248dd546e9e329564DC3));
