 ...
 * @notice It distributes LC tokens with a Merkle-tree airdrop for Zbc AMA.
 */
contract ZbcAmaAirdrop is Pausable, ReentrancyGuard, Ownable {
    ...
    function claim(
        ...
        require(count < maxCount, "Airdrop: MaxCount Limit");
    ...
    function canClaim(
        ...
        if (block.timestamp <= endTimestamp && count < maxCount) {
            // Compute the node and verify the merkle proof
