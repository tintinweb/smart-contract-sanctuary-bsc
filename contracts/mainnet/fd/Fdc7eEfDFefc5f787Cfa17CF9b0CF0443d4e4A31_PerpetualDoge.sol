...
contract PerpetualDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Perpetual Doge";
    string private _symbol = "$PerpDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4472D424d4BfeeD19D12BFD620229d48F85Ea8B3); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC60Ed687D1a28F165C3Bffdf78eCcDDF5Ee6A899); // Team Address
