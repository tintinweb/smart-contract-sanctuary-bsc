...
contract BRISU is Context, IBEP20, Ownable {
    ...
    string public _name = "Baby Risu"; // token name
    string public _symbol = "BRISU"; // token ticker
    ...
    uint256 private minTokenToSwap = 1000000000 * 1e18; // 100k amount will trigger the swap and add liquidity
