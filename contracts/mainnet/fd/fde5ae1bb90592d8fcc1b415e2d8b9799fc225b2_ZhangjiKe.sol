...
contract ZhangjiKe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ZhangjiKe";
    string private _symbol = "ZhangjiKe";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x21b7cD5A4ed507dcFC1B0FCAbd19C4bd7844C1dB); 
    address payable public teamWalletAddress = payable(0x21b7cD5A4ed507dcFC1B0FCAbd19C4bd7844C1dB); 
