...
uint256 amount;
    ...
    IBEP20 RewardToken = IBEP20(0x73419De8E3E26A17e0E6b0436e29dd04A25B061D) ; //mike
...
contract BabyMiku is IBEP20, Auth {
    ...
    string constant _symbol = "bMiku";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x73419De8E3E26A17e0E6b0436e29dd04A25B061D; //miku
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x471B07C266acdDD7341c6b49F6f5fDe26def8B7a; // liquidity
        marketingWallet = 0xB92B5b81B18011302BF1E6079392258B564BC47f;  // marketing
