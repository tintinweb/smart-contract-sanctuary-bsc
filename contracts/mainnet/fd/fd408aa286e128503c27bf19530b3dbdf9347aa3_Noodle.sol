...
Noodle is a community-driven token and decentralized coin in Binance Smart Chain
Destined for a millions market cap
Team has a lot of plans for this project
Get in early

Telegram : https://t.me/NoodleBSC
*/
...
contract Noodle is Context, IERC20, Ownable {
    ...
    string private _name = "Noodle";
    string private _symbol = "Noodle";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6f735747E42CAdB661C27141d14fc3cD4460F9e6); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x6f735747E42CAdB661C27141d14fc3cD4460F9e6); // Development Address
