...
This is our first trip but we are an experienced team. because we have been in cryptocurrency for a long time. We have a mission to create a market and with a strong community it is very possible to make catinu token a huge success. 

https://t.me/+orylqe9Wi-42MDJi
*/
...
contract CatInuToken is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0x763559E417eD8cA3bAa5d18e339045C53CF1852f);
    address payable public Wallet_Dev = payable(0x763559E417eD8cA3bAa5d18e339045C53CF1852f);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 1000000 * 10**_decimals;
    string private constant _name = "Cat Inu Token";
