...
contract SkylabsBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SkylabsBurn"; 
    string private _symbol = "SBURN"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E18843bA81aC2f716fA7fB95a01b0d2EaaCC6Cd); 
    address payable public teamWalletAddress = payable(0x47e5B2eaC5f2545e160530DF803d462511c8e4F4); 
