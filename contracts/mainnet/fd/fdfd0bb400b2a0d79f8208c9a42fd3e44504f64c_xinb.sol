        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xbdccF56868c7eEf74F544459494678039b30B358), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        50000000,//Su
        address(0xbdccF56868c7eEf74F544459494678039b30B358),//
        address(0xbdccF56868c7eEf74F544459494678039b30B358)//
    ){
    }
}