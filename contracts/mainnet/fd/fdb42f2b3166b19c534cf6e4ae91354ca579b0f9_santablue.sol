...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x202B10D9aa7e2949AF6629F87a1497401f3522ca; // owner address
...
contract santablue is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Blue";
    string private _symbol = "SANTABLUE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe77d374405346816BB64811A4a9FE2560FCfCFC6); // Marketing Address
    address payable public teamWalletAddress = payable(0x202B10D9aa7e2949AF6629F87a1497401f3522ca); // Team Address
