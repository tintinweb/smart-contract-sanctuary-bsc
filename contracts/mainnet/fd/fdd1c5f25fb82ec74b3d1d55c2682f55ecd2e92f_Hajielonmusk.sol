...
contract Hajielonmusk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Haji Elonmusk";
    string constant _symbol = "H Elonmusk";
    ...
    uint256 marketingdevelopmentFee = 900;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xE61718D2956Cb9f658C59DEF0a21a9e0c5Aab53d; //change;
