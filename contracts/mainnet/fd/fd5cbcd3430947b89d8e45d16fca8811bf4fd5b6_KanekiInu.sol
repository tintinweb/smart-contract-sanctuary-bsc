...
/* Token contract */
contract KanekiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xeFC24594eE062E864929DB8C2fe6DcE02F4e15b2;
    ...
    // Name and symbol
    string constant _name = "Kaneki Inu";
    string constant _symbol = "KanekiInu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 4% or 5M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xeFC24594eE062E864929DB8C2fe6DcE02F4e15b2;
