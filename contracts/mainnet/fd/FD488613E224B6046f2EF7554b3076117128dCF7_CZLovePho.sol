...
interface IReward {
    function claimWinerReward(address _userAddress,uint256 amount) external;
    function setBurnAddress(address burnAddress) external;
    function setBotAddress(address botAddress) external;
    function setLQAddress(address lQAddress) external;
    function setBurnEnable(bool _burnEnable) external;
}
...
contract CZLovePho is Ownable, ERC20 , IReward {
    using SafeMath for uint256;
