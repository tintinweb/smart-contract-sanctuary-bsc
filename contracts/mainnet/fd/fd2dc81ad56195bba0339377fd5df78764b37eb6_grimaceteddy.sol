...
// *Telegram : https://t.me/GrimaceTeddy
...
contract grimaceteddy is Context, IERC20, Ownable {
    ...
    string private constant _name = "GrimaceTeddy"; // 
    string private constant _symbol = "$GRIMACETED"; //    
