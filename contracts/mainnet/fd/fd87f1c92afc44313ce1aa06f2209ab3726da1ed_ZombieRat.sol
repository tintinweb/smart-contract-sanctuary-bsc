...
contract ZombieRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zombie Rat";
    string private _symbol = "RATZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeC1CA534c4B72bDd6A99df62701CA5Dae2b6DfFa);
    address payable public BuyBackWalletAddress = payable(0xeC1CA534c4B72bDd6A99df62701CA5Dae2b6DfFa);
