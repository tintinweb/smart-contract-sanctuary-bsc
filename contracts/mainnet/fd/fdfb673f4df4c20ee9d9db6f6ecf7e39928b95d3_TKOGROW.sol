...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90E16591E912Fad61aACb2D131137C057AE6BA34; // owner address
...
contract TKOGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " TKO GROW ";
    string private _symbol = " TKOGROW ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90E16591E912Fad61aACb2D131137C057AE6BA34); // Marketing Address
    address payable public teamWalletAddress = payable(0x90E16591E912Fad61aACb2D131137C057AE6BA34); // Team Address
