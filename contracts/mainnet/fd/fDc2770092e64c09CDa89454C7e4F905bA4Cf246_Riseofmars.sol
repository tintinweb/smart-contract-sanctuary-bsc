...
contract Riseofmars {
    ...
    /** base parameters **/
    uint256 public EGGS_TO_HIRE_1MINERS = 864000;              /** up to 10% daily (During Mars Festival it will be up to 12% Daily, Mars festival will happen three times in a year between July 17 to july 26, August 15 to August 24, september 30 to October 9) **/
    uint256 public REFERRAL = 100;                             /** 10% Referral **/
    ...
    function PRC_TXN(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 20);
        TAX = value;
    }
