...
contract NYSafeMoon96 is Context, IERC20, Ownable {
    ...
    string private constant _name = "$NYSafeMoon96";
    string private constant _symbol = "$NYSM96";
