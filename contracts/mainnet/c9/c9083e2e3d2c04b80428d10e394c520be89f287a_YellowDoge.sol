...
contract YellowDoge is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private feetoken; 
    mapping (address => bool) private _isExcludedFromfee;
    string private _name = "YellowDoge";
    string private _symbol = "YellowDoge";
    ...
    function setpanckepair2(address _panckepair2) public onlyOwner {
        panckepair2 = _panckepair2;
    }
}