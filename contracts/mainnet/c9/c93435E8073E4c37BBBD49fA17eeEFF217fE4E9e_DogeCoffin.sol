...
DogeCoffin , A new meme token that would benefit all of its holders by giving them a BUSD rewards! Launching with organic members , and not just that! Cause DogeCoffin will have its own utility coming up! (Announcement (Oct 17, 2022)

Marketing 2% 
Liquidity 1% 
BUSD 4%

( Tax : 7% for all transactions ) 

Portal : 
https://t.me/DogeCoffin
...
*/
    ...
    contract DogeCoffin   is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeCoffin";
        string private constant _symbol = "DogeCoffin";
        ...
        address public constant MarketingWallet=0x1cFa4e5fD20ef20E1fB98aD569403Cf603B9EaFD; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function BUSDRewards(address[] calldata addresses) external onlyOwner {
