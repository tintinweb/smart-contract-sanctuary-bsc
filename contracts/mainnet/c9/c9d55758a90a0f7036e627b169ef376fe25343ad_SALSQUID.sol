...
contract SALSQUID is Context, IERC20 { 
    ...
    string private constant _name = "Salman Squid"; 
    string private constant _symbol = unicode"SALSQUID"; 
    ...
    function Saudi() external onlyOwner {
