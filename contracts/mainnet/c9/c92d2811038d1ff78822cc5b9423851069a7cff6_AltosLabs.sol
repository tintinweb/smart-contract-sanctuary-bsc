...
contract AltosLabs is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   AltosLabsDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Altos Labs", "Altos") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
		_buyMarketingFee = 2;
        _buyDevFee = 1;
    	...
    	dividendTracker = new AltosLabsDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x2a36dCFb2f73765B80DE98a7299EdF3c3Ba56fBa);
        _devWallet = payable(0x2A22E9fd43150167A158A9515939cf6026AB3e8A);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Altos Labs: The dividend tracker already has that address");

        AltosLabsDividendTracker newDividendTracker = AltosLabsDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Altos Labs: The new dividend tracker must be owned by the Altos Labs token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "Altos Labs: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Altos Labs: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Altos Labs: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Altos Labs: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Altos Labs: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Altos Labs: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Altos Labs: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Altos Labs: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Altos Labs: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Altos Labs: Cannot update gasForProcessing to same value");
...
contract AltosLabsDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Altos_Dividend_Tracker", "Altos_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "Altos_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Altos Labs contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "Altos_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Altos_Dividend_Tracker: Cannot update claimWait to same value");
