...
contract NFTBAI is IBEP20, Auth {
    ...
    string constant _name = "NFTB AI";
    string constant _symbol = "NFTB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 977700000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x84e343022BefDa858aAD9dbF74B6910174Fe14fE;
