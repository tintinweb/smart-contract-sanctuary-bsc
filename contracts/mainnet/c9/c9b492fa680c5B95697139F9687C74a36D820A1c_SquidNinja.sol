...
contract SquidNinja is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Ninja";
    string private _symbol = "SNinja";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xa9c7C012AF9D92a40463Ec626b7A5b430C0ff025);
    address payable public teamWalletAddress = payable(0x8D8E5aCCBd1309028C040Ba5c08AF8a44E97F3b0);
