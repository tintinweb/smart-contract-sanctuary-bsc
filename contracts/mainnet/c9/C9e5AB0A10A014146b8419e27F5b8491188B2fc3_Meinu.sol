...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x401d4d1110659f2B4B1f76Bc8812627c2c8E23bd; // owner address
...
contract Meinu is Context, IERC20, Ownable {
    ...
    string private _name = "Meinu";
    string private _symbol = "MEINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D6585D7E2E81426e94a3cF66A4185aFbb074228); // Marketing Address
    address payable public teamWalletAddress = payable(0x079c019f63a0883F5b8aAD5fc877a99ba75aAfA9); // Team Address
