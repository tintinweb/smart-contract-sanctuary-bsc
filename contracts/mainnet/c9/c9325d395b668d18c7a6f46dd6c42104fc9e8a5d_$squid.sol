...
// *Telegram : https://t.me/squidgameclassicbsc
...
contract $squid is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x4e2a5Ded8d36A44b112b36ca668eB45c7474eAE7));
    address payable public devWallet =
        payable(address(0x4e2a5Ded8d36A44b112b36ca668eB45c7474eAE7));
    address public liquidityReceiver =
        0x4e2a5Ded8d36A44b112b36ca668eB45c7474eAE7;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "squid game classic";
    ...
    uint256 public _maxWalletSize = 270000000000 * 10**9;
