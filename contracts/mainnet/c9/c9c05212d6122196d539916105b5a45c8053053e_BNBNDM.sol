...
contract BNBNDM is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB Kingdom";
    string private constant _symbol = "BNBNDM";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  21000000  * 10**_decimals;

    uint256 public _maxTxAmount = 21000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 21000000 * 10**_decimals;
