...
// TELEGRAM https://t.me/Fintechelon
...
contract FINTECHELON is Context, IERC20, Ownable {
    ...
    string private _name = "FINTECH ELON";
    string private _symbol = "$ELON";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xE7eB7A3a318da42c83Ff9236bC7C5B3491f8A1Ca);
