...
contract BCoinToken is ERC20 {
	...
	address payable _receive = payable(address(0x5ef0f16f88735A881445c0eBD802Ec03e4c90Bd0));
    ...
    constructor(address tokenOwner,address root) ERC20("Bomber Coin", "BCOIN") {
        ...
        _root = root;
        doge = IERC20(0xd03d50d5D74f67497175bf69c550b36811C695B4);
        uint256 total = 10**33;
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0xd03d50d5D74f67497175bf69c550b36811C695B4);
