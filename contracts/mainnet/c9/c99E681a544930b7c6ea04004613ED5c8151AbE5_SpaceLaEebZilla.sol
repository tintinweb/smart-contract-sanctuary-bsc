...
contract SpaceLaEebZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceLaEebZilla";
    string private _symbol = "SpaceLaEebZilla"; //SpaceLaEebZilla
    ...
    uint256 public _walletMax = 20 * 10**10 * 10**_decimals;   //200000000000
