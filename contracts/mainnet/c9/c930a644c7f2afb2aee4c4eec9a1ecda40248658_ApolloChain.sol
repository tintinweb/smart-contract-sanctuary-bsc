...
APOLLO CHAIN aim to be the most safety and secure blockchain tokens and will make a new Blockchain that can give many advantages and development in middle and long term for our holders.
...
37% Token Liquidity Pancake
60% Token Burned
3%    Marketing Token (Lock 2 Months)
...
🔥 Join Our Community 🔥
Telegram Group 
https://t.me/ApollochainOfficial
Twitter
https://twitter.com/Apollo_Chain
Website : https://apollochain.network/
*/
...
contract ApolloChain is Context, IBEP20, Ownable {
    ...
    string private _name = "Apollo Chain"; // token name
    string private _symbol = "$APC"; // token ticker
    ...
    uint256 public minTokenToSwap = 100000000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 100000000 * 1e9;
    uint256 public minBuyLimit = 100000000 * 1e9;
    ...
    uint256 public marketWalletFeeOnSelling = 230;
