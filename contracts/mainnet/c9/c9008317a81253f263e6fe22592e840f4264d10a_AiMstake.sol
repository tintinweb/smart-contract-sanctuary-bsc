...
/**
    ...
    . All rights reserved.
        ...
        ┌───────────────────────────────────────────────────────────────────────┐
        │                                                                       │
        │   Telegram Public Group: https://t.me/aimtoken                   |
        │                                                                       |
        └───────────────────────────────────────────────────────────────────────┘
    ...
    Withdrawals are subject to 20% Sustainability tax.
    *sustainability tax stays in the contract.
    ~ PLAN REQUIREMENTS: 
    min. 300 AIM, max. of 200k AIM
    
    ~ REFERRAL SYSTEM:
    1 level referral bonus of 8%.
    ...
    Disclaimer: Funds that are used to invest can be withdrawn. Please use the application at your own risk. 
...
contract AiMstake {
	...
	//address token = 0x0bF3BAcAF2442Ecb7545709960056dbDe23FD674; /** AIM Testnet **/
	address token = 0x0bF3BAcAF2442Ecb7545709960056dbDe23FD674; /** AIM **/

	/** default percentages **/
	uint256 public PROJECT_FEE = 200;
	uint256 public MKT_BUYBACK_FEE = 70;
	uint256 public REFERRAL_PERCENT = 80;
	uint256 public SUSTAINABILITY_TAX = 200;
	...
	uint256 public MAX_WITHDRAW = 200000 ether;
    ...
    uint public startTime = 1673659788; //  https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _mkt) {require(!isContract(_dev1) && !isContract(_mkt));
        ...
        plans.push(Plan(360, 10, 300 ether, 200000 ether, 0, 0, 0, 0, true));
	}
	...
	function withdraw() public {
        ...
        totalAmount = totalAmount.sub(totalAmount.mul(SUSTAINABILITY_TAX).div(PERCENTS_DIVIDER)); /* 20% of withdrawable amount goes back to the contract. */
