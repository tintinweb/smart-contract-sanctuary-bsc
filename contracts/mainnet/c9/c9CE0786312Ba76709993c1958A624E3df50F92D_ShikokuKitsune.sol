...
/**
 Shikoku Kitsune (SHIKO) is a community meme token that has a smart exchange system built into the ecosystem on Binance Smart Chain. Our mission is to provide a safe place for investors by protecting their bags with additional security measures. (SHIKO) aims to be the world's most known and most used cryptocurrency. Dedicated and experienced team members run (SHITSUNE), we have multiple utilities and a well-planned long-term roadmap

Come and join to our growing community!

SAFU? Yes! we will lock and renounce 
Tax friendly!

Tokenomics:

Circulation Supply: 1.000.000.000
Tax: 5%

-1% LP
-4% MARKETING AND TEAM 

Max Transaction: 25,000,000
Max Wallet: 40,000,000

TELEGRAM: https://t.me/ShikokuKitsune
TWITTER: https://twitter.com/ShikokuKitsune
MEDIUM: https://medium.com/@shikokukitsune
*/
...
contract ShikokuKitsune is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "Shikoku Kitsune";
        _symbol = "SHIKO";
        _decimals = 9;

        marketWallet = payable(0x63813e1F76BfBaD530442b41f67cf468570359cE);
        teamWallet= payable(0x669e3639C9b0A5847b6bBd33243dAaEd00ec9839);
        ...
        _maxTxAmount = 250000000 * 10**_decimals;
        _maxWalletSize = 400000000 * 10**_decimals;
