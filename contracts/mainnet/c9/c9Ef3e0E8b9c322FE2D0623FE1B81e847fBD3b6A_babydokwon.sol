...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa687Cca45fE74560241D241793FBDF2A68a967D6; // owner address
...
contract babydokwon is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Dokwon";
    string private _symbol = "BDK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa687Cca45fE74560241D241793FBDF2A68a967D6); // Marketing Address
    address payable public teamWalletAddress = payable(0xa687Cca45fE74560241D241793FBDF2A68a967D6); // Team Address
