...
Telegram : https://t.me/goldenolddog
...
contract GoldenOldDog is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08605294e8062E4D84c709bA35C9B9a5D3E39B24); 
    address payable public Wallet_Dev = payable(0x08605294e8062E4D84c709bA35C9B9a5D3E39B24);
    ...
    string private constant _name = "Golden Old Dog"; 
    string private constant _symbol = unicode"GOLDODOG"; 
    ...
    constructor () {
        ...
        _owner = 0x08605294e8062E4D84c709bA35C9B9a5D3E39B24;
    ...
    function Nowhale() public returns (bool) {
        Percent_Dev = 0;
        Taxes_on_L = 0;
