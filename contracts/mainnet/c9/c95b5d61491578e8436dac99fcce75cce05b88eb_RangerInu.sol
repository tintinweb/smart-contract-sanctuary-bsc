...
Ranger Inu is a beloved rescue dog who loves to lend a helping paw! He loves nothing more than going on long runs with strangers, chasing after balls and playing tug-of-war. 
From protecting their home to offering companionship, Ranger Inu is always up for an adventure. He's smart and brave, eager to please and always ready for the next big project. 
With Ranger Inu around, there's never a dull moment!

⚡️1B $RANGER SUPPLY
⚡️7% Tax, 2% of the tax will be donated to dog rescuers

🌐Website Coming Soon

💠Telegram: https://t.me/RangerInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x618E79f4322C1A5Ef5A791B6F29c8284607e84A2; // owner address
...
contract RangerInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RangerInu";
    string private _symbol = "RANGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x618E79f4322C1A5Ef5A791B6F29c8284607e84A2); // Marketing Wallet
    address payable public teamWalletAddress = payable(0xc80441791303f44CE65B7D63Ed846D333180d4E0); // Dog Rescue
