...
/**
 *Submitted for verification at BscScan.com on 2022-08-29
*//*  -----BREAKING BAD TEAM IS BACK, BIG LAUNCH TODAY,SHIBANINJA(900K ATH),SHIBAWARS(600K ATH) TARGET:1M
...
contract BreakingBadTeamLaunch is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BreakingBadTeamLaunch";
    string constant _symbol = "BBTEAM";
