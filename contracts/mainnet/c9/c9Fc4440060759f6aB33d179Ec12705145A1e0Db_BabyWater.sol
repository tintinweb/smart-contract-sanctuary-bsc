...
//Official baby token for "water". If there is magic on this planet, it is contained in water. 1% off all transactions goes to support of fresh water. 
...
/* Token contract */
contract BabyWater is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe7b29445618e90d7e677fAbadb5391609cBb5ca2;
    ...
    // Name and symbol
    string constant _name = "Baby Water";
    string constant _symbol = "$BWAT";
