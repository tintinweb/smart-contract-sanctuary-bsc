...
pragma solidity ^0.6.12;
    ...
    contract TESTICLESZXC is Context, IERC20, Ownable {
        ...
        uint holdingCapPercent = 1;   
        uint256 private _tTotal = 100000000* 10**9;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'TESTICLESZXC';
        string private _symbol = 'SPERMSZXC';
        ...
        require(balanceOf(recipient)+amount <= _getMaxHolding(), "Max holding cap breached.");
            if(!takeFee)
                removeAllFee();
        ...
        return  (_tTotal * holdingCapPercent) / 100;
        }
