...
/** 
Telegram Group https://t.me/ratgayofficial
*/
...
contract RatGay is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "RatGay";
    string private _symbol = "WENYTXN";
//bool
    ...
    bool public maxlimitSells = true;
    bool public maxlimitBuys = true;
    bool private isInternalTransaction = false;
//address
    address public uniswapV2Pair;
    address public _MarketingWalletAddress = 0x0ee252667672581aD68E6Ae2A2fc6E1700c3e3bd;
   address public _RndWalletAddress = 0x0ee252667672581aD68E6Ae2A2fc6E1700c3e3bd;
...
//uint
    ...
    uint public sellLiqFee = 9;

    uint public buyMarketingFee = 2;
    uint public sellMarketingFee = 9;
    
    uint public buyRndFee = 0;
    uint public sellRndFee = 0;
    ...
    uint public minimumTokensBeforeSwap = 3500000 * (10**9); 
...
// constructor
    constructor() {
        ...
        maxSellTxAmount = _tTotal; 
        maxBuyTxAmount = _tTotal; 
    ...
    function setRndFee(uint buy, uint sell) external onlyOwner() {
        buyRndFee = buy;
        sellRndFee = sell;
        setFees();
    }
