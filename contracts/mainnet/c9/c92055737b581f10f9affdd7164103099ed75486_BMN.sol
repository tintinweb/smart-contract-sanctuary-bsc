...
Telegram    : https://t.me/blockmodenetwork
Website     : https://blockmodenetwork.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19a486b0Ffb4Cb45C361c3415e9d45D32C149301; // owner address
...
contract BMN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BlockMode Network ";
    string private _symbol = " BMN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4169e174C3CC6E575C7d003AF8A2beddE63f3623); // Marketing Address
    address payable public teamWalletAddress = payable(0x19a486b0Ffb4Cb45C361c3415e9d45D32C149301); // Team Address
