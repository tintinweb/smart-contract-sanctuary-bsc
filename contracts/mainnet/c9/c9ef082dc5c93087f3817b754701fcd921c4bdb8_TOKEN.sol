...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x857EAa5CFb82E39546F7995049534C17F13eE611; // owner address
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Wiki China";
    string private _symbol = "WC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x857EAa5CFb82E39546F7995049534C17F13eE611); // 
    address payable public teamWalletAddress = payable(0x857EAa5CFb82E39546F7995049534C17F13eE611); // 
    ...
    uint256 private _totalSupply = 2800000 * 10**_decimals;
    uint256 public _maxTxAmount = 28000 * 10**_decimals; 
    uint256 public _walletMax = 28000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 28000 * 10**_decimals; 
