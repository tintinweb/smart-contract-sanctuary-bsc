...
contract ALRihla is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax = 6000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6000000000 * 5 **_decimals; 
    ...
    constructor (address ReceiveAddress, address MW) {
