...
contract InuBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "InuBot";
    string private _symbol = "IBot";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdC482CAFd4dcA224BFb3cccCB1dAB2239Aad49Fd);
    address payable public teamWalletAddress = payable(0xdC482CAFd4dcA224BFb3cccCB1dAB2239Aad49Fd);
