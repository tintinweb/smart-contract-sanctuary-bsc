...
contract QW1 is Context, IERC20, Ownable {
    ...
    string private _name = "QW1";
    string private _symbol = "QW1";
    ...
    address public ownerAddres = address(0xE6B77a90e96AbC16Dd9E9Db6654d3c0F0A60F4e9);
    address public devAddress = address(0xC073e1aaD865b77dC9992E3ffe98A4FEdB985e46);
    ...
    uint256 private numTokensSellToAddToLiquidity = 1888 * 10 **18;
