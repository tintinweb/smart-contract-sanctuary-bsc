...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15817213ff9d71a9b8E86DFA44295713BF29BAF8; // owner address
...
contract babyinukobsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"babyinukobsc";
    string private _symbol = unicode"binu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15817213ff9d71a9b8E86DFA44295713BF29BAF8); // Marketing Address
    address payable public teamWalletAddress = payable(0x15817213ff9d71a9b8E86DFA44295713BF29BAF8); // Team Address
