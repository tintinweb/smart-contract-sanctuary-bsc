...
contract GoldDogMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldDogMoon";
    string private _symbol = "GoldDogMoon";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xb0e32965b6Ef128A15a219eA998B9c15F589F50E); 
    address payable public ttWal = payable(0xb0e32965b6Ef128A15a219eA998B9c15F589F50E); 
    ...
    uint256 public _sellReserveFee = 2;
