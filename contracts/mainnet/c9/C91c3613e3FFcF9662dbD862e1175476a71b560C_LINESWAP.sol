...
// Telegram : https://t.me/lineswap
// Website :  https://lineswapexchange.com
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x411be6FD4043B446740238Db28e69a1b5BEd77Ed;
...
/* Token contract */
contract LINESWAP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x411be6FD4043B446740238Db28e69a1b5BEd77Ed;
    ...
    // Name and symbol
    string constant _name = " LineSwap";
    string constant _symbol = "LINE";
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xae50C9F5d425BecB66eB88a7Ec6A91E7C75c1375;
