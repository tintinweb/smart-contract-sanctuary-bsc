...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_sellFundFee) * 2 / swapFee;
        uint256 liquidityAmount = fistBalance * (_buyLiquidityFee + _sellLiquidityFee + _buyFundFee) * 2 / swapFee;
...
contract LDH is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        100000000,//Supply
        address(0x8E835A2Bb24f80F4Ef71Ee85BA3c8D5aadcE0a18),//FundAddress
        address(0x97ECAAB46486d2eDA372e42bFF45567f0474AA42)//ReceiveAddress
    ){
