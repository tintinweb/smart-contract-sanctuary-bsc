...
/**
$NASDAQ born from Investors for Investors. Our Token has an automatic rebase principe, that guarantee every block (3 seconds) a reward of 0.0000985%, thanksgiving to compound interests we guarantee an Annual Percentage Yield of 985,221.78%. Our long term goal is to create an ETF with all major shares regarding Network and Health.

$NASDAQ is the safest rebse token on DeFi you can get more information about it here: https://docs.nasdaqvault.com/nasdaq-vault/safest-rebase-token-in-defi

Launch Phase:

- Fairlaunch on Pinksale 19th April 2022
- Pinksale KYC
- 2 Security Audits (InterFi - Analytix Audit)
- Low SoftCap (50 BNB)
- APY 985,221.78%
- Dapp Ready
- Fairlaunch Top Contributors Contest
- Free Stock Giveaway
- Meme Contest, Shill Contest, Raid Contest etc...

Don't miss this such opportunity: https://t.me/NasdaqVaultToken
*/
