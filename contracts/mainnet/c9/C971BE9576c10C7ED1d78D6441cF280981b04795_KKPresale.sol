...
contract KKPresale is Ownable {
    ...
    IERC20 public KK = IERC20(0xc715a8e0E9670875D28A99f0E1f94e5bB132cb81);
    address public Recipient = 0xa4361521756D3795d2cbd60F77df3b2BE7D0dE83;

    uint256 public tokenRatePerEth = 10000; // 10000 * (10 ** decimals) KK per eth
    uint256 public minETHLimit = 0.2 ether;
    uint256 public minInviteETHLimit = 0.2 ether;
   ...
   function referParent(address parentAddress) public {
	...
	userInfo[parentAddress].referNum= userInfo[parentAddress].referNum+ 1;
