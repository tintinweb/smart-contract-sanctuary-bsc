...
// File: contracts/BUSD-SeedSale.sol
...
contract BackBoneProSeedSale {   
    ...
    uint256 public MaxOrder = 13758943000000000000000000; // Max token order
    uint256 public TotalSupply = 160000000000000000000000000; // Total token supply
    uint256 public LockingTime = 31556952; // 12 Months Locking time in second
    uint256 public VestingTime = 94672800; // 36 Months Vesting time in seconds
    uint256 public ClaimPeriod = 86400; // Claim once per day 
    uint256 public TokenPrice = 3634000000000000; // Token price per BUSD
    /* end sale config */
