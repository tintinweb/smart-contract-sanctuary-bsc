...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x9Fb348B32df4a405dd8E730d1234e86bA84c2666;//fund address
...
contract LUNA is Token {
    constructor() Token(
        ...
        address(0x29cDa0E75e3640A163FC80dae1e06AFC76154720),//fund address
    
        address(0x9Fb348B32df4a405dd8E730d1234e86bA84c2666)//dev address
    ){
