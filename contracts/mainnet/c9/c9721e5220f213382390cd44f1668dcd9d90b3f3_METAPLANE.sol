...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3223c7f5581d135DF452070344D74041A4541b32;
...
contract METAPLANE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8eCE78c0a2746b794c0b1Bb85bb3F05540FDBfA1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "META PLANE GAME";
