...
/**
🅰️n🅰️rchy Token
Meet Anarchy - a state of disorder due to absence or non-recognition 
of authority or other controlling systems
What is Anarchy?
Anarchy: a state of disorder 
due to absence or non-recognition 
of authority or other controlling systems. 
Authorities in crypto world like 3ac, Voyage Digital, 
LFG and etc captured investors' fund and gave false hope and promise to them. 
Eventually they never fulfil what they promised. They lied. 
They fled. They failed. It's time for us to build a community in anarchy way. We hate authority.
ZERO TAX
https://medium.com/@anarchyerc
5M MAX TOKEN SUPPLY
RENOUNCED CONTRACT
100 YEAR LOCKED LIQUIDITY
COMMUNITY OWNED
...AND MUCH MORE
*/
...
contract Ownable is ContextNFT {
...
contract Anarchy is ANARCHYDeployer, ContextNFT, Ownable {
 
    // common addresses
    address private _owner;
    address private ANARCHYTeam;
    address private CharityANARCHY;
    ...
    constructor(uint totalSupplyValue, address ANARCHYTeamAddress, address CharityANARCHYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ANARCHYTeam = ANARCHYTeamAddress;
        CharityANARCHY = CharityANARCHYAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ANARCHYTeam] =  totalSupply * 5 / 100;
        balances[CharityANARCHY] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's ANARCHYTeam pot
