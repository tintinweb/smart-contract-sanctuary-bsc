...
contract test1 is IBEP20, Ownable {
	...
	string constant _name = 'test1';   // Name
	string constant _symbol = 'test1';    // Symbol
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0x635648a2B14FCCeD9f662b1F4c2FA6E9DEbB3C06;
        marketingFeeReceiver = 0x635648a2B14FCCeD9f662b1F4c2FA6E9DEbB3C06;
