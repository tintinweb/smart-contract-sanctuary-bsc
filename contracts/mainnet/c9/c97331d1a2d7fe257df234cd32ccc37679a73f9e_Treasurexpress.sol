...
contract Treasurexpress is ReentrancyGuard {
    // Structs
    struct User {
        uint id;
    ...
    constructor(address payable _tokenBurner) public {
        ...
        minTotalUsersForLevel[4] = 1;
        minTotalUsersForLevel[5] = 1;
        minTotalUsersForLevel[6] = 1;
        minTotalUsersForLevel[7] = 1;
        minTotalUsersForLevel[8] = 1;
        minTotalUsersForLevel[9] = 1;
        minTotalUsersForLevel[10] = 1;
        minTotalUsersForLevel[11] = 1;
        minTotalUsersForLevel[12] = 1;
        minTotalUsersForLevel[13] = 1;
        minTotalUsersForLevel[14] = 1;  
        minTotalUsersForLevel[15] = 1;  
        minTotalUsersForLevel[16] = 1;  
