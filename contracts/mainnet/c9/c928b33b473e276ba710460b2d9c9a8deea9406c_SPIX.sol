...
contract SPIX is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "SPIX";
    string private constant _symbol = "SPIX";
    ...
    uint256 public swapThreshold = (_totalSupply * 2) / 2000;
     uint256 public _TxLimitwallet = (_totalSupply * 30) / 1000;
