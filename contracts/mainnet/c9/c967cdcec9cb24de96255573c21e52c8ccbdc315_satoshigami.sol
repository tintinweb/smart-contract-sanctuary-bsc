...
/**
*/
// Telegram : https://t.me/SatoshiGami
// Website  : https://satoshigami.live/
...
contract satoshigami is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xe7317Cf3b15102Fe6F1e3bf841D9973B9f11dfa2));
    address payable public devWallet =
        payable(address(0x933045538C8cDF2a32bE99Ac057660fdC4BC1361));
    address public liquidityReceiver =
        0xe7317Cf3b15102Fe6F1e3bf841D9973B9f11dfa2;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Satoshi Gami";
