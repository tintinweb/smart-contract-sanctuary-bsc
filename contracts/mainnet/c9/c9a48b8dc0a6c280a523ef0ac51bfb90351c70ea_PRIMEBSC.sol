...
Let's bring old good BSC back.

We are launching with micro marketcap.

MAX TX will be 1.5%
MAX WALLET will be 2,5%

The plan is simple. We will focus on calls.
...
contract PRIMEBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PRIME BSC";
    string private _symbol = "PRIME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49372fb4A74D03C316F07e9fbC8Ad8307DE68500); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x49372fb4A74D03C316F07e9fbC8Ad8307DE68500); // buyback Address
