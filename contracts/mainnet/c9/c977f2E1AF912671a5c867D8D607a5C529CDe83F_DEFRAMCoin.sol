...
contract DEFRAMCoin is ERC20, Ownable {
    ...
    constructor () ERC20("DEFRAMCoin", "DFC") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xA50bb606Fb4c7BD46f63279F15E90108187Aa4B0;
        developmentWallet = 0x215cA5975366d0f020767E1AFE671e49836EAa88;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 1_000_000_000, "SwapTokensAtAmount must be greater than 0.0000001% of total supply");
