...
contract BerlinRocks is Context, IERC20, Ownable {
    ...
    constructor() public {
        ...
        //root member
        _levelRootAddress = 0xB88Da38D487E791a4709213BD47D48e0E8eC1C97;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_robots[sender] && !_robots[recipient], "Berlin rocks: You are a robot");
        require(amount <= _maxTransAmount, "Berlin rocks: Maximum transaction volume limit");
