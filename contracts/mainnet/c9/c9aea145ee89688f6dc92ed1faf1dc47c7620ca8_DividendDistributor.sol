...
/*
*Anti-dumping No more than 1 maximum sale in every 24 hours
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Doge = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract PaoLuB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "PaoLuB";
    string private _symbol = "PaoLuB";
    uint8 private _decimals = 9;

    uint256 public _maxTxAmount = 2 * 10**_decimals;
    uint256 public _maxHavAmount = 5 * 10**_decimals;
...
uint256 _totalSupply = 100000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10000; // 0.005% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x184054C795F284Bb57af2c1aB89E97478b7Ff129;
