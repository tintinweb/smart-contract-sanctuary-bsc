...
contract MMWHALE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MM WHALE";
    string private _symbol = "MMW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0764A95Fb1a326442713217f0726668De6C3497E);
