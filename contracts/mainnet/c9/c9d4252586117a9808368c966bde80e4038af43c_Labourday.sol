...
contract Labourday is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Labour day";
    string private _symbol = "5/1";
    ...
    uint256 private _totalSupply = 5100000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 5100000000000000 * 10**_decimals; 
    uint256 public _walletMax = 5100000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA99d92A0Cb66Ce6b7bf01829c0c8Bd45DcA9Dbff));  //NTFguilei
        marketingWalletAddress = payable(address(0x593270f843E8e6570015D7A76246896A316Db769));//chuagnjianzhe
