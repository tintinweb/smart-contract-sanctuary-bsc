...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc2bE686df9683C1074c7d46507A1A3E247dAe8f4; // owner address
...
contract QATARWORLDCUP is Context, IERC20, Ownable {
    ...
    string private _name = "QATAR WORLD CUP";
    string private _symbol = "QWCT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D2210cE0C94e413D7a8586fDeCF6A97ceE8ec58); // Marketing Address
    address payable public teamWalletAddress = payable(0x8200aC976D0AC4D0da5030c05C7EE8F20a3dC540); // Team Address
    ...
    uint256 private _totalSupply = 2022202202220220 * 10**_decimals;
