...
contract FlockingExclamations is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flocking Exclamations!!!";
    ...
    address private marketingWallet = address(0x0C07fE96174C4198779C732B930CaC9059f3cceB);
