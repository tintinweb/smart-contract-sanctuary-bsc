...
TG Community: https://t.me/cresteddog
...
contract CrestedDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrestedDog";
    string private _symbol = "$CRESTED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe2fce0d945Ce7B81cF5B4d261D909c32816012Fd); // Marketing Address
    address payable public TeamWalletAddress = payable(0xe2fce0d945Ce7B81cF5B4d261D909c32816012Fd); // Team fee
