...
contract GhostNFTMarketV2 is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    address public ghostNftAddress;
     ...
     * @param _ghostNftAddress: address of the ghostNft
    ...
    constructor(
        ...
        require(_ghostNftAddress != address(0), 'Operations: Ghost NFT address cannot be zero');
        ...
        ghostNftAddress = _ghostNftAddress;
        WBNB = _WBNBAddress;
    ...
    function _buyToken(
        ...
        if (creatorFee != 0) {
            ...
            if (_collection == ghostNftAddress) {
                _creatorAddress = IGhostNFT(ghostNftAddress).getCreatorAddress(_tokenId);
            } else {
