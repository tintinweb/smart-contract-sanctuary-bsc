...
/**
 *Submitted for verification at snowtrace.io on 2022-06-10
*/
...
contract Airdrop is Ownable {
    ...
    modifier onlyAdmin() {
        require(msg.sender == admin || msg.sender == owner(), "Caller is not the auth!");
        _;
    }
    ...
    function dropTokens(address[] memory _recipients, uint256[] memory _amount) public onlyAdmin returns (bool) {
    ...
    function updateTokenAddress(address newTokenAddr) public onlyAdmin {
