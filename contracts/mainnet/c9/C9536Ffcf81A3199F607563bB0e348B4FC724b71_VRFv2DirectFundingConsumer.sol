...
contract VRFv2DirectFundingConsumer is VRFV2WrapperConsumerBase, ConfirmedOwner {
    ...
    // Address LINK - hardcoded for BNB chain
    address linkAddress = 0x404460C6A5EdE2D891e8297795264fDe62ADBB75; // Mainnet
    // address linkAddress = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;    // testnet

    // address WRAPPER
    address wrapperAddress = 0x721DFbc5Cfe53d32ab00A9bdFa605d3b8E1f3f42; // Mainnet

    // address wrapperAddress = 0x699d428ee890d55D56d5FC6e26290f3247A762bd; // testnet
    ...
    function setNumWords(uint32 _val) public onlyOwner {
        numWords = _val;
    }

    function setGasLimit(uint32 _val) public onlyOwner {
     ...
     */
    function getWinningNFT(uint256 _collectionSize, uint256 _index) public view returns (uint256) {
