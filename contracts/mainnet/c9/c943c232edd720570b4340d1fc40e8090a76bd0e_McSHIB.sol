...
abstract contract Project {
    address public marketingWallet = 0x99Df9dDFb5C0bc514B8AEA5DD5ED7B8E8fcfcAca;
    address public twrecievermanager = 0x91dDD94a50F933074e8D19B00544f4000C730112;

    string constant _name = "McDonaldSHIB";
    string constant _symbol = "McSHIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // (_totalSupply * 10) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 2; //2%

    uint256 public buyBurnFee         = 0;// zero buyburnfee meaning no buy burn fee added
    ...
    uint256 public swapBurnFee        = 0;// zero swapburnfee meaning no swapnburnfee added
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);//0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract McSHIB is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingWallet && recipient != twrecievermanager && recipient != autoLiquidityReceiver){
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(twrecievermanager).call{value: amountBNBTreasury, gas: 30000}("");
    ...
    function setTreasuryFeeReceiver(address _newWallet) external authorized {
        isFeeExempt[twrecievermanager] = false;
        isFeeExempt[_newWallet] = true;
        twrecievermanager = _newWallet;
    }
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _newMarketingWallet, address _newTreasuryWallet ) external authorized {
        ...
        twrecievermanager = _newTreasuryWallet;
    }
