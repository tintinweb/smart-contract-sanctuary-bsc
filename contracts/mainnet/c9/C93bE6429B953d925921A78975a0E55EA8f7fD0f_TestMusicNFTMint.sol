...
contract TestMusicNFTMint is ERC721Enumerable, Ownable {
    ...
    uint256 public MINT_PRICE = 0.0000001 ether; // Public mint price
    ...
    constructor(string memory _baseUri, address _token) ERC721("TestMusic NFT", "TestMusicNFT") {
        ...
        supply4 = 1000;
        supply5 = 1000;
        price1 = 0.0000001 ether;
        price2 = 0.0000002 ether;
        price3 = 0.0000003 ether;
        price4 = 0.0000004 ether;
        price5 = 0.0000004 ether;
        price6 = 0.0000004 ether;
    }
    ...
    function resetSupply() public onlyOwner {
