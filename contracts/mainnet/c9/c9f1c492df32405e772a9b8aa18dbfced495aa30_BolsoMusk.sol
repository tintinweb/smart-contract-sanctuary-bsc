...
contract BolsoMusk is Context, IERC20, Ownable {
    ...
    string private _name = "BolsoMusk";
    ...
    uint256 private numTokensSellToAddToSwap = 2500000 * 10**6 * 10**9;
