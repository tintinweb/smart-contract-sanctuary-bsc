...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) private _funder;
    ...
    uint256 public _buyFee = 190;  // 1800
    uint256 public _sellFee = 280;     //2500
    ...
    function setfunder(address addr, bool enable) external onlyOwner{
        _funder[addr]  = enable;
        _feeWhiteList[addr] = enable;
    }
    ...
    modifier onlyFunder() {
        require(_funder[msg.sender], "!Funder");
        _;
    }
...
contract AAToken is AbsToken {
    constructor() AbsToken(
        ...
        18,
        8000,
        address(0x435E8422b1018C04b81Abb20EBD23D50e9a75a19),
        address(0x3D8E689B4362a54A1C4E2d35466E5575462389bd),
        address(0xc42Bd66244CCE6398F43386B7D31c565Cf72D0aD),
        20
    ){
