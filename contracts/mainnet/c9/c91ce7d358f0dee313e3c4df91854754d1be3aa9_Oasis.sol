...
//Telegram : https://oasisinuofficial
// Website : www.oasisinu.com
...
contract Oasis is IBEP20, Auth {
    ...
    address DEV  = 0x41f146a80b3b6e8589fE65A4a13341ac7B55AF89;
    ...
    // Name and symbol
    string constant _name = " Oasis Inu";
    string constant _symbol = "Oasis";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch or 20M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 10M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% or 20M tokens
    ...
    uint256 public totalFeeSell = 21;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x5Aa198d720e29085d5fD1E35e84Ef662500A1C11;
