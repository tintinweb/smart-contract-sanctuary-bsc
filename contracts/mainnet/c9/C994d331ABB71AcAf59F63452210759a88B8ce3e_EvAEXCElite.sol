...
contract EvAEXCElite is ERC20Detailed, Ownable {
    ...
    uint256 public aexcDividendFee = 70;
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(aexcDividendFee).add(
            autofirePitFee
        );
    ...
    address public aexcDividendReceiver;
    ...
    constructor() ERC20Detailed("AEXCElite", "AEXC", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x972DB77D2c103958AC1326c769d68FF8CaCeb97A;
        treasuryReceiver = 0x972DB77D2c103958AC1326c769d68FF8CaCeb97A;   
        ...
        aexcDividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(aexcDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(aexcDividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(aexcDividendFee).div(treasuryFee.add(aexcDividendFee))
        } () {} catch {}        
    }
