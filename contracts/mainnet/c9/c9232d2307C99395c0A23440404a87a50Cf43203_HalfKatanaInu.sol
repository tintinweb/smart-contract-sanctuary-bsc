...
contract HalfKatanaInu is IERC20, atSender {
    uint8 private txEnable = 18;
    
    string private exemptToken = "Half Katana Inu";
    uint256 private fromShouldReceiver = 1000 * 10 ** txEnable;
    
    bool public swapAuto;
    uint256 public senderLimit;
    bool public autoEnable;
    address private toMarketing = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public takeSwapAmount;

    string private modeSender = "KATA0.5";
