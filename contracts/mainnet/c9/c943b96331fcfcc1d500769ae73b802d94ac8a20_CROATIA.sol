...
// Telegram : https://t.me/croatia_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd5Cd2bA6CE2320e989bbd4f1F02156bc89A4b40E;
...
contract CROATIA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Croatia";
    string private _symbol = "#CRO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xd5Cd2bA6CE2320e989bbd4f1F02156bc89A4b40E); 
    address payable public teamWalletAddress = payable(0xd5Cd2bA6CE2320e989bbd4f1F02156bc89A4b40E); 
