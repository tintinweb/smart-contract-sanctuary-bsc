...
contract BabyBOSS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Baby BOSS";
    string private constant _symbol = unicode"BabyBOSS";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0x5A773c824E9b3Aba3D2c71730D6D057f2619711E);
    address payable private MarketingWallet = payable(0x5A773c824E9b3Aba3D2c71730D6D057f2619711E);
