...
contract ORALGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ORALGROW";
    ...
    address payable public marketingWalletAddress = payable(0x8e96FCF56dD534118d7eaF0C70b12f8A4B33f1B8);
    address payable public teamWalletAddress = payable(0x3b23F441c27Ab78452ED2C7FD642912854D06d5A);
