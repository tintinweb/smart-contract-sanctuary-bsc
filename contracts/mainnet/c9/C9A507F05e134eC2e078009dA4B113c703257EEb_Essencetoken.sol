...
contract Essencetoken is ERC20, Ownable {
    ...
    EssencetokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Essence Token", "ESNC") {
        marketingWallet = payable(0x60E077dC9aF86bc471cF853E5F5d6ea2a6f160d1);
        devWallet = payable(0x60E077dC9aF86bc471cF853E5F5d6ea2a6f160d1);
        ...
        dividendTracker = new EssencetokenDividendTracker(
            payable(this),
            router,
...
contract EssencetokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Essencetoken public EssencetokenContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EssencetokenContract = Essencetoken(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Essencetoken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Essencetoken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EssencetokenContract);

            uint256 prevBalance = EssencetokenContract.balanceOf(address(this));
            ...
            {
                uint256 received = EssencetokenContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EssencetokenContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
