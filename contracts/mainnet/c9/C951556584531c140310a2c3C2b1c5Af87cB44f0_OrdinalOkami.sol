...
contract OrdinalOkami is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OrdinalOkami";
    string private _symbol = "OOK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x043a871A69006a944686091C9278c45E1f532Ecb); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x043a871A69006a944686091C9278c45E1f532Ecb); // BuyBack Address
