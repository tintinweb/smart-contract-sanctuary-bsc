...
/* gridcoin.finance Binance launch Pad- BNB Reward Token

website: https://gridcoin.finance
Listing 1 GIC = 1.2 USD
...
contract GIC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAFaCdd2C48139FFAb5c5C9DA137EBBAa9aC3Ab07); // Marketing Address
    address payable public charityAddress = payable(0xAFaCdd2C48139FFAb5c5C9DA137EBBAa9aC3Ab07); // Charity/Dev Address
    ...
    string private _name = "Grid Coin";
