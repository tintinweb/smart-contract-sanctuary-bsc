...
contract WorldCupPool is Ownable {
    ...
    function setWinner(uint256 _winnerId) public onlyOwner {
        ...
        winnerId = _winnerId;
        winningAmount = Token(BUSD_ADDRESS).balanceOf(address(this))/ WorldCup(WORLDCUP_ADDRESS).getTypeMinted(_winnerId);
    }
    ...
    function claimWinner(uint256 _id) public {
        ...
        Token(BUSD_ADDRESS).transfer(msg.sender, winningAmount);
    } 
