...
contract MuuRonin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Muu Ronin"; // 
    string private constant _symbol = "$MuuRonin "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x7499d1E11632174FceE3045cfdbeC6407cEE001c;
