...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB1117B356dF2a267a06cE5570Bb78d8BcF2A7187;
...
contract DegenCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x78486Cd0f2cF831a3e0Bdd558a09C305D8B32bE6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Degen Coin";
    string private _symbol = "Degc";
