...
contract Amberheard2 is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Amberheard2";
    string constant _symbol = "UST2.0";
    ...
    uint256 public sellMultiplier  = 200; //2x i.e 6x2= 12% on Sell
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**7 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE648331Fe83B1dD172C7867D9c8734F4708f6858;
        LotteryFeeReceiver = 0x844367790918f027f12A0A0fF4427620dbd6338a;
