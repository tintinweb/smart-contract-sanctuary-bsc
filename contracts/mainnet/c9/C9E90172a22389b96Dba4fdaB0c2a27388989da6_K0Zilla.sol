...
contract K0Zilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kill 0 Zilla";
    string private _symbol = "K0Zilla";
    ...
    uint256 private _totalSupply = 10 * 10**18* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 10 * 10**18 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 10 * 10**18 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10 * 10**18* 10**_decimals; 
