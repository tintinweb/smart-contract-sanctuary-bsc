...
pragma solidity >=0.6.0 <0.8.0;
contract QUANFT is ERC721, Ownable {
    ...
    constructor() public ERC721("QUANFT", "QUANFT") {
        _contractOwner = msg.sender;
    }

    function mint(uint256 _tokenId,string memory _tokenURI, address _toAddress, uint _price) public onlyOwner returns (uint) {
