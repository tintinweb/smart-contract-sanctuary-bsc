...
The best Shiba, the leading meme, the token that will lead the BSC!
...
🐦 Twitter: www.twitter.com/ShibaLeaderBSC
🌐 Website: www.shibaleader.com
🆔 Telegram: @ShibaLeader
*/
...
contract ShibaLeader is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 50000000000 * 10**9;
    uint256 public _maxTxAmount = 50000000000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 700 * 10**9;
    string private constant _name = "Shiba Leader";
    string private constant _symbol = "ShibaLeader";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x27d459C3e440B3f45027f12575d9D44db5a0F33A;
