...
/**
CandyRush is a new BSC token that give both profit to holders from its price raise & also lucky spin chances to holders that hold a minimum of 0.1% token from the total supply.

What are the gifts from the lucky spin? At the beginning, we will have coins/tokens from the list below:
1) CandyRush
2) BNB
3) ADA
4) MATIC
...
The list is still not final yet, we will announce the final list a day before we launch our dApp. dApp is planned to launch next week, which is 25th of July.

Join our telegram to get the latest update : https://t.me/CandyRushOfficial
*/
...
contract CandyRush is Context, IERC20, Ownable {
    ...
    string private constant _name = "CandyRush"; // 
    string private constant _symbol = "CandyRush"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x07e5680EB60bc600da63127Cf8dEF140C2DF1F21;
