...
Telegram: https://t.me/WeedFarmEMPIRE
Website: https://crypto-hempire-miner.vercel.app/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WEED = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WEED.balanceOf(address(this));
        ...
        uint256 amount = WEED.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WEED.transfer(shareholder, amount);
...
contract WeedFarmEmpire is IBEP20, Auth {
    using SafeMath for uint256;

    address WEED = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HEMPIRE";
    string constant _symbol = "HEMPIRE";
    ...
    address public Owner=0x14B2570884B822a9feaB6a49AE4C5de29c400Af8; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x14B2570884B822a9feaB6a49AE4C5de29c400Af8;
