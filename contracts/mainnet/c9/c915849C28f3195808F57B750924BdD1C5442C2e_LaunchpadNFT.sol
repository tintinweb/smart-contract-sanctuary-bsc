...
contract LaunchpadNFT is Ownable {
    ...
    IBooster public booster = IBooster(0x92564524AcFCb3c96B301924CC75c5b42dF5f20f);
    ...
    constructor(address launchpad, uint256 maxSupply,uint8 _level)  {
        LAUNCHPAD = launchpad;
    ...
    function tokenURI(uint256 tokenId) public view virtual returns (string memory) {
        return booster.tokenURI(tokenId);
    }
