...
contract CIBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CUPIDO INU BSC";
    string private _symbol = "CIBSC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x3aFdD48DaC2fC6adF5701516B6aa659f841296D4); // Marketing Address
    address payable public BuyBackWallet = payable(0x3aFdD48DaC2fC6adF5701516B6aa659f841296D4); // Team Address
