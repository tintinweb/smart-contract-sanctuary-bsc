...
abstract contract Token is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 9300;   //卖税
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x585C3a8d146aBe620ACB21C6e61b185EBf851349;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x585C3a8d146aBe620ACB21C6e61b185EBf851349),//fund address
    
        address(0x585C3a8d146aBe620ACB21C6e61b185EBf851349)//dev address
    ){
