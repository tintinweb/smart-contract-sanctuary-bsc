...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa424A3A5E09bc149F7A590911A7871710008fd70;
...
contract DogeWorldCup is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa424A3A5E09bc149F7A590911A7871710008fd70;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge World Cup";
    string private _symbol = "DogeWorldCup";
