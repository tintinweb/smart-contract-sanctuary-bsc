...
Welcome to the BSC - Bozoge Smart Chain! Lets all be clowns together!
...
contract Bozoge is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Bozoge';
    ...
    uint256 public gasLimit = 5000000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0xebA326Aa9Ef8652211d95fF988502C195FB4935B);
    address public Marketing=payable(0xebA326Aa9Ef8652211d95fF988502C195FB4935B);
    //MainNet
