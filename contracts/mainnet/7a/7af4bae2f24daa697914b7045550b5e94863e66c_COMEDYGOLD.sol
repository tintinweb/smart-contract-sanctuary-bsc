...
/*
Telegram :https://t.me/ComedyGoldBsc
...
contract COMEDYGOLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0Fa353C8BAC5749d027A602F66A2cD2f9cB83e5A); 
    address payable public Wallet_Dev = payable(0x0Fa353C8BAC5749d027A602F66A2cD2f9cB83e5A);
    address payable public W_Deployer = payable(0x0Fa353C8BAC5749d027A602F66A2cD2f9cB83e5A);
    ...
    string private constant _name = "Comedy Gold"; 
    string private constant _symbol = unicode"COMEDYGOLD"; 
    ...
    constructor () {
        ...
        _owner = 0x0Fa353C8BAC5749d027A602F66A2cD2f9cB83e5A;
