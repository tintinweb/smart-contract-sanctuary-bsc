...
contract CoffeeShop is Ownable {
    ...
    address private _router = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // DEX router address
    address private _vrf = 0x968b3DBB044f02Ef318e4DBa4130663C5e3B9263; // Randomizer generator contract address
    ...
    /// @notice Getting count all coffeeBean
    /// @return (uint)
    function getCount() external view onlyOwner returns (uint){
        return _coffeeBeansCounter.current();
    }
    ...
    /// @notice Getting sum Bank of Shop
    /// @return (uint)
    function getAmountShop() external view onlyOwner returns (uint){
        return _bankShop;
    }
