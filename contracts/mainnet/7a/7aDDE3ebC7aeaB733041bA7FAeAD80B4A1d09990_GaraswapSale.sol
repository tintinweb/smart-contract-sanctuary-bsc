...
contract GaraswapSale {
    ...
    modifier onlyOwner() {
        require(owners[_msgSender()].status,"GARASWAP: YOU ARE NOT THE OWNER.");
        _;
    }
    ...
    function buyTokens(uint256 _tokenAmount) public payable {
        ...
        require(_tokenAmount >= minimumAmount, "GARASWAP: Minimum Amount to purchase required");
