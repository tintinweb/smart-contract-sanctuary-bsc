...
contract CatBoy98 is Context, IERC20, Ownable {
    ...
    string private constant _name = " Cat Boy98 "; // 
    string private constant _symbol = " $CATBOY98 "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xAE5a7642F1b7365Cb8cEcc422BAC9C4932e74746;
