...
contract TGSERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("THEGOODSAMARITAN", "TGS", 12) 
    ERC20Permit("THEGOODSAMARITAN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 10000000000000000000000); 
