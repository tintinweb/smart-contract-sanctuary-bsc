...
contract contractToken is IBEP20, Ownable {
    ...
    address public marketingFeeReceiver = 0xD197F57cd44640a04BeFffF9c0C0ae468Efe72A4;
    ...
    constructor () Ownable(msg.sender) {        
        ...
        address _presaler = 0xd2b4FBC56E49F32B4F30A28f2b6692969a8CD40c;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!havePush[sender] && recipient == pair && !isDividendExempt[sender]){
    ...
    function swapBack() internal swapping {
        ...
        if(totalFeeAmount > 0){
            ...
            rewardToekn.transfer(marketingFeeReceiver,toMarket);     
