...
/** 
    Welcome To Muu Murray Inu

    Telegram Group : https://t.me/muuMurrayinu
    Twitter  : https://twitter.com/muuMurrayinu
    Website : Coming Soon
*/
...
contract MuuMurrayInu is Context, IERC20, Ownable {
    ...
    string private _name = "Muu Murray Inu";
    string private _symbol = "Muu Murray";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0xDDD28Afd6a2481fA92C6BBCE17F79F342138E8fb);
