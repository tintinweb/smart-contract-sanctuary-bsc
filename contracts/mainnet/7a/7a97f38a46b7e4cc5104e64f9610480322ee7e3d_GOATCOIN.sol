...
Community Token, Renounced Ownership, Whale wallet backed project, Starting MC $120, 
...
contract GOATCOIN is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "GOATCOIN"; //  Name
        _symbol = "$KING GOAT"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 100000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 500000000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 1000000000000 * 10**_decimals; // 1% of total supply
        _maxWalletBalance = 3000000000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0x5C1105E459d8aa71516F0a8AA2C1aF41dec6f262; // Marketing wallet 
        _devWalletAddress = 0xf17e573d416B21CCaAAe88F51425D6Db21e70952; // Dev wallet 
