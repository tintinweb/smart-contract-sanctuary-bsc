...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xbdEaBFaE228f19C7adB7F11CF7023B51A3DD1EbB;//   营销
...
contract aaaaatoken is Token {
    constructor() Token(
        ...
        address(0xbdEaBFaE228f19C7adB7F11CF7023B51A3DD1EbB),//fund address
    
        address(0xbdEaBFaE228f19C7adB7F11CF7023B51A3DD1EbB)//dev address
    ){
