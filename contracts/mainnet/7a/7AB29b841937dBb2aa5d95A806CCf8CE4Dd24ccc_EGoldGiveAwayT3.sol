...
contract EGoldGiveAwayT3 is AccessControl , ReentrancyGuard{
    ...
    modifier isVaildMint( address _user  ) {
        ...
        require( parent != address(0) , "EGoldGiveAwayT3 : Not valid Referer");
    ...
    function Giveaway( uint256 _type , address _user , address _ref  ) external isVaildMint( _user) nonReentrant onlyRole(LAMDA_ROLE) {
        iAddUser( _user ,_ref);
        iMint(_user, _type);
