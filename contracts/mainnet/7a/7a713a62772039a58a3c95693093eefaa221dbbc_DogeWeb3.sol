...
contract DogeWeb3 is Context, IERC20, Ownable {
    ...
    string private _name = "DogeWeb3";
    string private _symbol = "DogeWeb3";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe007A334cf783EdB7Ed657cD05D88A024d07039D);
    address payable public teamWalletAddress = payable(0xe007A334cf783EdB7Ed657cD05D88A024d07039D);
