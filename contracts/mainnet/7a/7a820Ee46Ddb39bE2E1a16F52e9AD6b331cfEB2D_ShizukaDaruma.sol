...
contract ShizukaDaruma is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "ShizukaDaruma";
    string private _symbol = "SHIDARUMA";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD949Fa14eC2FeC954eD444551E26d0c333B6E518));
        _metawallet = payable(address(0xD949Fa14eC2FeC954eD444551E26d0c333B6E518));
