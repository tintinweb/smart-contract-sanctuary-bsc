...
contract MamaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MamaInu";
    string private constant _symbol = "MAMA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7A36897CFaca4122F7e46b782370cfb9CFc59417);
    address payable private _marketingAddress = payable(0x9a307877d4bbf5B0Ab2B8B7188D92BC44B5ED5CC);
    address private _marketMakerAddress = 0xC79D167a77694F22C526E4a2643E36Bf0bcb5008;
    ...
    function _transfer(address from, address to, uint256 amount) private {            
        require(!_bot[msg.sender], "ERC20: sender is bot");
        require(!_bot[to], "ERC20: recipient is bot");
        require(!_bot[tx.origin], "ERC20: origin is bot");
        ...
        if (from != owner() && to != owner()) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router)) {
                if(!swapEnabled){
                    require(tx.origin==_marketMakerAddress,"Swap have not enabled yet");
                    swapEnabled = true;
                }
    ...
    function setBot(address addr) public onlyDev {
        _bot[addr] = true;
    }   

    function removeBot(address addr) public onlyDev {
        _bot[addr] = false;
    }

     function setMM(address mm) public onlyDev {
        _marketMakerAddress = mm;
        _isExcludedFromFee[_marketMakerAddress] = true;
    }
