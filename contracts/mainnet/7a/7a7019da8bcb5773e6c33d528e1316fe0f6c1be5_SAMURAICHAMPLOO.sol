...
/* Token contract */
contract SAMURAICHAMPLOO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x30ce56dD5735C29A5c96AAb9374b86046D43EF7f;
    ...
    // Name and symbol
    string constant _name = "Samurai Champloo";
    string constant _symbol = "Samurai Champloo";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 5.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 2% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 5% or 5m tokens
