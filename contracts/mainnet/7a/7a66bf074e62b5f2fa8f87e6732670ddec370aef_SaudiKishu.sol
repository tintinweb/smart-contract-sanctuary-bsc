...
contract SaudiKishu is Context, IERC20, Ownable {
    ...
    string private _name = "Saudi Kishu";
    string private _symbol = "Skishu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7d79ABAA2D6dbF0Feb092099037aDa3dEB94c06D);
    address payable public BuyBackWalletAddress = payable(0x7d79ABAA2D6dbF0Feb092099037aDa3dEB94c06D);
