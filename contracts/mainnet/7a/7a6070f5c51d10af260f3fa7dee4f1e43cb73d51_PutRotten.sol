...
contract PutRotten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PutRotten";
    string private _symbol = "PutRotten";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDBAdcbc787cfA230035dc023884400141d97aB91);
    address payable public teamWalletAddress = payable(0xDBAdcbc787cfA230035dc023884400141d97aB91);
    address public immutable deadAddress = 0xDBAdcbc787cfA230035dc023884400141d97aB91;
