...
contract SCURE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCURE";
    string private _symbol = "SCURE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1763006A6e0c1C97391d84Bc139C1813372366A); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xBEc1ebda4adba90DC0300D8cB186Ddf24a9329c1); // Development Address
