...
contract BasedCloud is IBEP20, Auth {
    ...
    string constant _name = "BasedCloud";
    string constant _symbol = "BASED";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 6) / 100; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100; //3%
    ...
    address private marketingFeeReceiver = 0xfD20BE64Bba28CC260448132f289EcFA1D9347A7;
    address private developmentFeeReceiver = 0xfD20BE64Bba28CC260448132f289EcFA1D9347A7;
