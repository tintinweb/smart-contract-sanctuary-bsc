...
interface IBEP20 {
    ...
    function revoke(address spender, uint256 subtractedValue) external returns (bool);
...
contract Main is IBEP20, Auth, Initializable {
    ...
    function revoke(address spender, uint256 subtractedValue) public returns (bool) {
