...
contract DogeKingEarmy is Context, IERC20, Ownable {
    ...
    string private _name = "DogeKingEarmy";
    string private _symbol = "DogeKingEarmy";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5aBcf5d5194C3861bE11c33bAC20bCF3a21E5846));
        __wal = payable(address(0x5aBcf5d5194C3861bE11c33bAC20bCF3a21E5846));
