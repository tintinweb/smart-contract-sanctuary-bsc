...
contract SAFEORACLE is ERC20, Ownable {
    ...
    constructor() ERC20("TEST v2", "TXT"){
        address newOwner = address(0xB7C2a6B3df83520a231F291Bc94BC2064D8657a9);
    
        uint256 totalSupply = 1 * 100000000 * 10**18;
        ...
        totalPenaltySellFees =  marketingPenaltySellFee + liquidityPenaltySellFee + charityPenaltySellFee;

        
        marketingSellFee = 900;
        liquiditySellFee = 300;
        charitySellFee = 0;
        totalSellFees =   marketingSellFee + liquiditySellFee + charitySellFee;
        ...
        liquidityWallet = address(0xCB5ebc5f82914Ed83a9c96BF968ef7D644854eaC); // set as liquidity wallet
