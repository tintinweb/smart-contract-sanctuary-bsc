...
contract PepperCoinProject {
    
    mapping(address => uint) public balances;
    mapping(address => mapping(address => uint)) public allowance;
    
    string public name = "PepperCP";
    string public symbol = "PPRCP";
    
    uint public numeroDeMoedas = 500000000;
    uint public casasDecimais = 8;
    
    uint public burnRate = 5; // Found Burn Donate = 5%  transferred from one wallet to another to invest in projects
