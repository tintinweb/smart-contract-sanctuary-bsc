...
*/
 /** 
    Teleprompter Inu- Elon tweet!
    https://twitter.com/elonmusk/status/1545457074389151744?s=20&t=pKAXjsFDzG4K9pK9S3tnxw

    I just had to make this super quick from Elon tweet.

    ELON TWEET COIN

    Low Tax 6% buy-sell, dev working hard, hyped Community, website in development, Elon tweet this✅
    GO IN BEFORE MOON!

// TG: https://t.me/TeleprompterInu
...
contract TeleprompterInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Teleprompter Inu";
    string private constant _symbol = "$PROMPTER";
    ...
    address private marketingWallet = address(0x9Eeb1803eE4fc9118D2f843EC80E07E80f4d8B0B);
    address private liquidityReceiver = address(0x9Eeb1803eE4fc9118D2f843EC80E07E80f4d8B0B);
