...
contract BasicToken is ERC20, Ownable, BaseToken {
    ...
    {   
        ...
        require(_arg.marketingShare_ + _arg.liquidityShare_ == 100, "Total fee shares must be equal to 100");
        ...
        emit TokenCreated(owner(), address(this), TokenClass.basicToken, 2);
    }
