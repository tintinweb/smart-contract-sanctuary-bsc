...
/**
Welcome to luna2.0. Together we will celebrate the Titano Days!
Join the TG https://t.me/LUNAhhh

Liquidity Burned.
Shortly after launch all max wallet and transactions will be lifted and taxes will be 5%
After all is well contract will be renounced. 
*/
...
contract lunatwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lunatwo";
    string private _symbol = "luna2.0";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x3Ed37bDbf45D257fA1371cB385490a19034AcD3e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3Ed37bDbf45D257fA1371cB385490a19034AcD3e); // BuyBack Address
    ...
    uint256 private _maxSellTxAmount = 3 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100 * 10**6 * 10**9), "Max wallet should be less or euqal to 10% totalSupply");
