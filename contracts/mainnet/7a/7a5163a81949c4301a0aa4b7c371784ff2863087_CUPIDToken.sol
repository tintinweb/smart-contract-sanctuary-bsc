...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    string private _name = "ZS";
    string private _symbol = "ZS";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x423961F0A955677a8AD07E8F6B1B2C8BF926e62f);
    address public pointAddress = address(0x423961F0A955677a8AD07E8F6B1B2C8BF926e62f);
