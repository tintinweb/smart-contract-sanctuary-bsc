...
contract SAFUUAQUAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFUU AQUAX";
    string private _symbol = "SAFUU AQUAX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B01Cc83eE528F98866cc26A692AC84340268e9d); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0DE11398AB9066F0FB8b44538E1c0e98DaA1d15F); // Development Address
    ...
    uint256 public _sellDevelopmentFee = 7;
