...
contract TE is Context, IERC20, Ownable {
   ...
   // address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    address charity = 0x0A2BC0E607c93EDD839430f0A41b7cA7bC9ffC29;
    address liquidAdress = 0x0A2BC0E607c93EDD839430f0A41b7cA7bC9ffC29;
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        _isExcludedFromFee[liquidAdress] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_buybackFee != 0){
            ...
            swapTokensForAddLiquid(otherHalf);
            totSpentAmount = totSpentAmount + spentAmount;
        }
 ...
 function swapTokensForAddLiquid(uint256 tokenAmount) private {
    ...
    function removeLiquidity(uint256 tokenAmount) private {
        // approve token transfer to cover all possible scenarios
        _approve(address(this), address(pcsV2Router), tokenAmount);

        // add the liquidity
        pcsV2Router.removeLiquidityETH(
            address(this),
            tokenAmount,
            0, // slippage is unavoidable
            0, // slippage is unavoidable
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
         ...
         if (!takeFee) {
            ...
            if (sender != pcsV2Pair && recipient != pcsV2Pair) {
                removeAllFee();
                _transferStandard(sender, recipient, amount);
