...
contract CaiShenDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CaiShenDao";
    string private _symbol = "CaiShenDao";
    ...
    address public immutable deadAddress = 0x86ca249a0191bB25d2F38e6a02B576121A44502f;
