...
LP LOCKED.ANTI-WHALE, ANTI-DUMP. SAFU
...
contract HouseofShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "House Of Shiba";
    string constant _symbol = "HOS";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(BUSDFee).div(totalBNBFee);
