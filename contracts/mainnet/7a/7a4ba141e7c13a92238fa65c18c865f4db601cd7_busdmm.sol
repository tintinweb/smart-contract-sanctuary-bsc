...
contract busdmm {
    ...
    uint256 public EGGS_TO_HATCH_1MINERS = 781990;//11%
    uint256 private PSN = 10000;
    uint256 private PSNH = 5000;
    uint256 private devFeeVal = 10;
    uint256 private referalPercent = 10;
    ...
    constructor(address payable wallet) {
        ...
        OldContract=address(0x0CB26FD20702DB6dcF9D87C6F59d047bdaA60c66);
    ...
    function hatchEggs(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed,referalPercent));
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        uint256 fee2=fee/10;
        ERC20(busd).transfer(OldContract, fee2);
