...
Telegram: https://t.me/worksimulator
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xA41b82721c9024227e65852Cc4243570a5e7F5a5;
...
contract WORKSIMULATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = "WORK SIMULATOR"; // 
    string private constant _symbol = "$WSIM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xA41b82721c9024227e65852Cc4243570a5e7F5a5);
