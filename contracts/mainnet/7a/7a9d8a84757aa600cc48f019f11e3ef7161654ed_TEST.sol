...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x12dAe1BD02B657fEA8f2a763e2AAed9b8Ab7e9d7));
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(15); //1.5%
