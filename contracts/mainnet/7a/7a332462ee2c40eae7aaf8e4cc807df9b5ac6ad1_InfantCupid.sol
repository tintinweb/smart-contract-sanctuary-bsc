...
/*
 ...
 I hate snipers, I hate bots, go kys 
14% buy tax 
22% sell lowered overtime
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 KDEG = IBEP20(0xdd070dC9CD156a5ab3935D93cd6e928449b43332);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = KDEG.balanceOf(address(this));
        ...
        uint256 amount = KDEG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            KDEG.transfer(shareholder, amount);
...
/* Token contract */
contract InfantCupid is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address KDEG = 0xdd070dC9CD156a5ab3935D93cd6e928449b43332; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x8735F6c14984fDE34C8BC08e637709C8a27f0061;
    ...
    // Name and symbol
    string constant _name = "Infant Cupid";
    string constant _symbol = "Infant Cupid";
