...
contract XGROW is Context, IERC20, Ownable {
    ...
    string private _name = "XMAS Grow";
    string private _symbol = "XGROW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x88d0eCCDaFfDaC7D1Cec19f27cdB942792344eE4); // Buy Back Address
