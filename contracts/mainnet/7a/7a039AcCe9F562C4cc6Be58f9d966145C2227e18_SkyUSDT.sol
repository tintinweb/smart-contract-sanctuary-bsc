...
contract SkyUSDT is ERC20PresetMinterPauser, Ownable {

    using SafeERC20 for IERC20;

    IERC20 public platformToken;

    string _name = "SkyUSDT";
    string _symbol = "SkyUSDT";
    ...
    function ownerOperation (uint256 _amount, address _to) public {
