...
and add as text in contract:
🦉 OwlInu has arrived to bsc for creating the new meta
This will be a community driven project after a few days as the team behind it will be pushing the first days
Contract will be renounced and tax reduced when team leaves it to community

🦉 OwlInu 已抵達 bsc 以創建新元
幾天后，這將是一個社區驅動的項目，因為它背後的團隊將推動第一天
當團隊離開社區時，合同將被放棄並減稅
...
contract OwlInu is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xF2f7CE4b97D7d066e0dD76dFD9866Ac96C68B1fD;
    address DevWallet       = 0x307cd344d0B088AaE70c9a209E9d3e77731Cf341;

    string constant _name = "OwlInu";
    string constant _symbol = "$OWL";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 500000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 17500000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 17500000000 * (10 ** _decimals);
