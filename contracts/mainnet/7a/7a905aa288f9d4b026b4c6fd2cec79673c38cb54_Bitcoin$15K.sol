...
contract Bitcoin$15K is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 8**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x1D6D4ac3A78af70B449b952016e48f6e6fC84Ceb));


    string private _name = "Bitcoin $15K";
    string private _symbol = "BTC15K";
