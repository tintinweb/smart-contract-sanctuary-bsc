...
contract CronaldoInu is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xAb058220A687240C7528a60a24a1386d0a12FFd0); 
    address payable private Wallet_Dev = payable(0xAb058220A687240C7528a60a24a1386d0a12FFd0);
    ...
    string private constant _name = "CRonaldo Inu"; 
    string private constant _symbol = "CR7 INU"; 
    ...
    constructor () {
        ...
        _owner = 0xAb058220A687240C7528a60a24a1386d0a12FFd0;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xAb058220A687240C7528a60a24a1386d0a12FFd0); // Testnet
