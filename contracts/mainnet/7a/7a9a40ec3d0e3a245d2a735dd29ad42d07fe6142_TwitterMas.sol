...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x650abF68900e98E42224bD2bDa62d9AF783c12C0; // owner address
...
contract TwitterMas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Mas";
    string private constant _symbol = "TMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x650abF68900e98E42224bD2bDa62d9AF783c12C0); // Marketing Address
    address payable public teamWalletAddress = payable(0x650abF68900e98E42224bD2bDa62d9AF783c12C0); // Team Address
