...
contract BRISING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC RISING";
    string private _symbol = "BRISING";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xe8832Ee5C01b25eDAF7C9a9a4cd70040Ba9f04cD); // Marketing Address
    address payable private TeamWallet = payable(0xe8832Ee5C01b25eDAF7C9a9a4cd70040Ba9f04cD); // Buy Back Address
