...
contract KoksalBabaNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_PER_MINT = 5000;

    string public baseTokenURI;

    address public founderAddress = 0xA5625bE7474aeEc93654a360078eaA920C18A88A;

    constructor(string memory baseURI) ERC721("Koksal Baba NFTs", "KOKSALNFT") {
        setBaseURI(baseURI);
    }
