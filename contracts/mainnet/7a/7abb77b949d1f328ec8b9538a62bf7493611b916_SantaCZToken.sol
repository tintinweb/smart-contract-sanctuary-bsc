...
contract SantaCZToken is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa CZ";
    string private _symbol = "Santa Cz";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x061EC7DC03F01eB482BDd71aFb6408b4c43002dE); // 
    address payable teamWalletAddress = payable(0x82C2062CA7F3b3e8183E2891286595b728e4cf5F); //
