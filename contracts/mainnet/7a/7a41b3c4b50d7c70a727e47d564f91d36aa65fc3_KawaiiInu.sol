...
Introducing the world's first Dog-Walk To Earn (DWTE) project! 

The project is simple, over 80% of domesticated dogs are microchipped. We are creating a fully decentralized dog walking application which ties each microchipped dog to the blockchain. 

Dog Walkers will be paid out weekly in $KINU but required to stake each weeks earnings for 1 week. 

- Additionally, we will have 20127 unique NFTs with staking. 
- Holding NFTs will increase your hourly earnings (must be staked minimum 1 month)
- If you hold a rare NFT, you can 2-4X your hourly earnings. 
...
contract KawaiiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kawaii Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd704643f21F0134Fd51276A04cd28698F7a3ad5C;
        ecosystemfeeReceiver = 0xd704643f21F0134Fd51276A04cd28698F7a3ad5C;
