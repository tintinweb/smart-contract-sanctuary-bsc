...
contract GALXE is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "GALXE";
    string private constant _symbol = "GALXE";
    ...
    uint256 public swapThreshold = (_totalSupply * 20) / 20000;
     uint256 public _TxWalletLimit = (_totalSupply * 300) / 10000;
