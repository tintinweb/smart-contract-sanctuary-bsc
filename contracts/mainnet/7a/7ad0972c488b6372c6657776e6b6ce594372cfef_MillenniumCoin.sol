...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA4C04396Cdc474AdBEdfB0bF590b2b73e0b5515b;
...
contract MillenniumCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x665f7Dc5D6906BD3a74615bF447548b438155c15;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Millennium Coin";
    string private _symbol = "MLX";
