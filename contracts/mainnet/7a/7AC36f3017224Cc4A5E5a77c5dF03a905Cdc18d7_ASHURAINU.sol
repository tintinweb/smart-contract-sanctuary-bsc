...
Well, It's ASHURA INU for you! 

ASHURA INU This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best

Why ASHURA INU ?

It is a Community Powered - ASHURA INU fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - ASHURA INU smart contract has been verified and its Liquidity Pool is locked. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDD17DEABf53408F6bd1D39A56710F6754904fed7; // owner address
...
contract ASHURAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASHURA INU";
    string private _symbol = "ASHURA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB3b9c19650345e5e91aa0bCa5f6be1929A47BD11); // Marketing Address
    address payable public buybackWalletAddress = payable(0xB3b9c19650345e5e91aa0bCa5f6be1929A47BD11); // Buyback Address
