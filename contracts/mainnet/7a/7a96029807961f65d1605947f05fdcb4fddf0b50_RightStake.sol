...
contract RightStake {
    ...
    IERC20 public token = IERC20(0x08D4e1D410316F807440cfd35805c8eafF3B53eB); 
	uint256 constant public INVEST_MIN_AMOUNT = 5e6; // 5 USDT
	uint256[] public REFERRAL_PERCENTS 	= [1000, 500, 200, 200, 100, 100, 100, 100, 100, 100];
	uint256[] public SEED_PERCENTS 		= [2500, 1000, 500, 250, 250, 100, 50, 50, 25, 25];
