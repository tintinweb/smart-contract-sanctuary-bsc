...
contract FinalTestDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("FinalTest_Dividend_Tracker", "FinalTest_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(false, "FinalTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the mainFinalTest contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FinalTest_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
...
contract FinalTest is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
   ...
   FinalTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("FinalTest", "TFF") {
        BNBRewardsFee = 0;
        liquidityFee = 1;
        extraFeeOnSell = 2; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0x4c217D57476cdBF39E284e611Fa79b752aCF350d);
