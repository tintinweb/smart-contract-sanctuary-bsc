...
/**
 Welcome to $Akita Protocol, a decentralized & community-driven meme token on the Binance Smart Chain.🦴  🕹
...
☎️Telegram: https://t.me/AkitaProtocolBSC
...
contract AkitaProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9622D5af03f0Ada96f37aDcFB5d2c6F054cB23FA); 
    address payable public Wallet_Dev = payable(0xF8AF44B166D57BC87d02f798D83D5A1A713aCB1A);
    ...
    string private constant _name = "Akita Protocol"; 
    ...
    constructor () {
        ...
        _owner = 0xF8AF44B166D57BC87d02f798D83D5A1A713aCB1A;
