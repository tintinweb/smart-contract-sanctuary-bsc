...
/* 
    ...
    //------------------ Description ------------------//
     ...
     Sell Fee : 3%
     Liquidity Buy Fee  : 1%
     Liuiqidty Sell Fee : 2%
     Token Transfer : 1%

     Maximum Tax : 3% ( Line 769 )
...
contract SurpRise is ERC20, Ownable {
    ...
    {   
        ...
        _mint(newOwner, 100e8 * (10 ** decimals()));
    ...
    function updateFees(uint256 lFeeOnBuy, uint256 mFeeOnBuy, uint256 lFeeOnSell, uint256 mFeeOnSell) external onlyOwner{
        ...
        require(_totalFeesOnBuy <= 3, "Buy Fees Cannot exceed 3%");
        require(_totalFeesOnSell <= 3, "Sell Fees Cannot exceed 3%");
