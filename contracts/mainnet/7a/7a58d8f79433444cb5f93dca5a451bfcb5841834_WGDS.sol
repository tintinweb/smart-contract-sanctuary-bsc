...
contract WGDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Wrapped GDS";
    string private _symbol = "wGDS";
    uint8 private _decimals;
    address payable public marketingWalletAddress;
    address payable public teamWalletAddress;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public usd= 0x55d398326f99059fF775485246999027B3197955;
    address public marketingAddress = 0xCd6f92D35f7E3769a4CCC475C462770Ab4B80f15;
    address public teamAddress = 0xCd6f92D35f7E3769a4CCC475C462770Ab4B80f15;
    ...
    constructor (
        ...
        _maxTxAmount = 150 * 10**_decimals;
        _walletMax = 750 * 10**_decimals;
        _maxDestroyAmount = 0 * 10**_decimals;
