...
contract OptimusWhales is Context, IERC20, Ownable {
    ...
    string private constant _name = "Optimus Whales";
    string private constant _symbol = "OPWHALES";
