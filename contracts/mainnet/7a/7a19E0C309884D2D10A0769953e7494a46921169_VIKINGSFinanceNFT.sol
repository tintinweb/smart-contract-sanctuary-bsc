...
contract VIKINGSFinanceNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 555;
    uint256 public normalPrice = 0.05 ether;
    ...
    constructor(string memory _baseURI) ERC721("Vikings Finance NFT", "VKNGS NFT") {
        baseUrl = _baseURI;
    }
