...
TELEGRAM:  https://t.me/BabyGoat_INU
*/
...
contract BABYGOATINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Goat INU"; // 
    string private constant _symbol = "BGOATI"; //    
