...
contract SOCHH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son Of Chihuahua"; // 
    string private constant _symbol = "SOCHH "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x6BB9b7eff3877F2B133b931708a5d6529f5ff627;
