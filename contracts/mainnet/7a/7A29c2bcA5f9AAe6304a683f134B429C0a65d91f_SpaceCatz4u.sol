...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x26ee8A1839Dc8E18C69959066107C6914408172B;
...
contract SpaceCatz4u is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf9007BC45a46DC21e831bA3bbEC3d343C3e2bC3e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SpaceCatz4u";
    string private _symbol = "SpaceCatz4u";
