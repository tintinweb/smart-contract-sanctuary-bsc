...
/**
The official Ukra Neko Inu contract
https://t.me/UkraNekoInu
...
contract UkraNekoInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x65767d32C732eB18e1A39BdE98150941B87AE15C); // Marketing Address
        
    address payable public teamAddress =
        payable(0x65767d32C732eB18e1A39BdE98150941B87AE15C); // Team Address
        
    address payable public liquidityAddress =
        payable(0x65767d32C732eB18e1A39BdE98150941B87AE15C); // Liquidity Address
    ...
    string private constant _name = "Ukra Neko Inu";
    string private constant _symbol = "UKINU";
