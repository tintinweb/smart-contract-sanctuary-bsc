...
contract NomadNomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NomadNomics";
    string private _symbol = "$NomNom";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x450EA95ECBDE355813fF05BA0287a3770b629999); // Marketing Address
    address payable public teamWalletAddress = payable(0x450EA95ECBDE355813fF05BA0287a3770b629999); // Team Address
