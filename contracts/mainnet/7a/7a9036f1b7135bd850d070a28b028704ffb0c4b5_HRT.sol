...
//www.highrollerpepe.org

//🎲 Welcome to HighRollerPepe 🎲 
//Roll your lucky dice 🎲

//$HRT is safe yet degen-friendly token with a potential for high results

//Your gamble is safe due to clean CA and a fat LP
//🎰2.5BNB initial LP
//🎱Buy & Sell tax: 2%
//🎯Max Wallet: 50 000
//💵Total Supply: 1 000 000
//💎50% LP / 50% development budget and marketing
//🎲Based Team / Locked LP👌 
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x4c789FdBB4Bb6516AA8395A42Afae604F1123560;
...
contract HRT is Context, IERC20, Ownable { 
    ...
    string private constant _symbol = unicode"HRT"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x4c789FdBB4Bb6516AA8395A42Afae604F1123560), BNB_Tot);
