...
TELEGRAM: https://t.me/shijirupanda
            中國古代優雅美麗的十吉如熊貓。她富有同情心和愛心，
            也被稱為shijiruinu完美中的心靈之魂。
            正式準備在智能鏈 BlockChain 上給予愛和靈感。
*/
...
contract shijirupanda   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " shijiru Panda ";
    string private _symbol = " $SHIPANDA "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e810EEeddf3E7Bfbe426Cba8E907756ee7068e0); 
    address payable public teamWalletAddress = payable(0x5e810EEeddf3E7Bfbe426Cba8E907756ee7068e0); 
