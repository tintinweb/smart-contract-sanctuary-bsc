...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeF50d8531e4a6C63C1Fced73dDF8d2ffE15E6cFd; // owner address
...
contract RabbitNomics is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit Nomics";
    string private _symbol = "RN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeF50d8531e4a6C63C1Fced73dDF8d2ffE15E6cFd); // Marketing Address
    address payable public teamWalletAddress = payable(0xeF50d8531e4a6C63C1Fced73dDF8d2ffE15E6cFd); // Team Address
