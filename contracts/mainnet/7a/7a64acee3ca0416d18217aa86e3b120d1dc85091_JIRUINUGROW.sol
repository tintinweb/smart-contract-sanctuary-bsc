...
contract JIRUINUGROW is Context, IERC20, Ownable {
    ...
    string private _name = "JiroInu Grow";
    string private _symbol = "JIGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x700406436e9fa60A0dD4603Fd40A868DB632F067); 
    address payable public buyBackWalletAddress = payable(0x6dFaE16Bf0B22BAc1Ad73Cbb8C6a070061d35F66); 
    ...
    uint256 private _totalSupply = 800000000000 * 10**9;
    uint256 public _maxTxAmount = 16000000000 * 10**9;
    uint256 public _walletMax = 24000000000 * 10**9; 
