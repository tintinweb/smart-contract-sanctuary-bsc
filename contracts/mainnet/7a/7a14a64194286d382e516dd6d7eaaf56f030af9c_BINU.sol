...
contract BINU is BINUDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BINUTeam;
    address private CharityBINU;
    ...
    string public override name = "BINU";
    string public override symbol = "BINU";
    ...
    constructor(uint totalSupplyValue, address BINUTeamAddress, address CharityBINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BINUTeam = BINUTeamAddress;
        CharityBINU = CharityBINUAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BINUTeam] =  totalSupply * 4 / 100;
        balances[CharityBINU] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BINUTeam pot
