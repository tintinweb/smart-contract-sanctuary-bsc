...
contract oxmoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "oxmoon";
    string private _symbol = "$OXM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31D31C4cba6ebcdF8E7A2F602791CE349f8b6620);
    address payable public teamWalletAddress = payable(0x38bfF88333B6c3e0B0d405f70B8a74f874195Dd5);
