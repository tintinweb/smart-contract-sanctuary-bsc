...
contract OKTZilla is Context, IERC20, Ownable {
    ...
    string private _name = "OKTZilla";
    string private _symbol = "OKTZilla";
    ...
    constructor(address _marketWallet, address _calldata) {
        ...
        emit Transfer(address(0), 0x3B30Bac3c331168e40FC6338BA2295A2F3adDe52, _totalSupply);
    }
