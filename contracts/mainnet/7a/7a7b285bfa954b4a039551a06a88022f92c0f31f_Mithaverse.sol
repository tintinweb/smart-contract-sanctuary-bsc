...
contract Mithaverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x52B0bC42dd89d68D1cb6b753A60288d7C9345148); 
    address payable public developmentAddress = payable(0x52B0bC42dd89d68D1cb6b753A60288d7C9345148); 
    address payable public charityAddress = payable(0x52B0bC42dd89d68D1cb6b753A60288d7C9345148); 
    address payable public vaultRewardAddress = payable(0x52B0bC42dd89d68D1cb6b753A60288d7C9345148); 
    address payable public liquidityWallet = payable(0x52B0bC42dd89d68D1cb6b753A60288d7C9345148); 
    ...
    string private constant _name = "Mithaverse";
    string private constant _symbol = "MITHA";
    ...
    uint256 public _sMaxTxAmount = 1000000000  * 10**2;
