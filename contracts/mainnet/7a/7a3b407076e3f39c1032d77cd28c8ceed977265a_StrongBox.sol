...
contract StrongBox is Context, Ownable {
    ...
    function hatchEggs(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed.mul(100000000),714285714));
        ...
        if(referrals[msg.sender]!=address(0)){
            ...
            referralsData[currentIndex] = ReferralData({
                ...
                amount:referralsData[currentIndex].amount.add(SafeMath.div(eggsUsed.mul(100000000),714285714)),
