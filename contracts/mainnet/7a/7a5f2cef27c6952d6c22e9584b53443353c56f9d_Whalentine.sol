...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x902a087308C3E62CeE04e7c67FbF61d8b8fd945f; 
...
contract Whalentine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whalentine";
    string private _symbol = "Whalentine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x902a087308C3E62CeE04e7c67FbF61d8b8fd945f); 
    address payable public teamWalletAddress = payable(0x902a087308C3E62CeE04e7c67FbF61d8b8fd945f); 
