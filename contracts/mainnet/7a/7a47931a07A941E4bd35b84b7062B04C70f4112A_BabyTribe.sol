...
contract BabyTribe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Baby Tribe";
    string private _symbol = "BABYTRIBEX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xafafE1a956C4F6B7726c4f4F6CBe2441Cc03eD69);
    ...
    uint256 private _totalSupply = 500 * 10**8 * 10**_decimals;
