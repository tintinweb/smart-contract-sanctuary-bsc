...
/*
RabbitGrow is a new BSC community token that will grow alongside the incoming bullish market.

Telegram Group: 
https://t.me/RabbitGrow

By holding RabbitGrow, holder will receive 6% RabbitGrow reflection from the collected tax fees, meaning the more you hodl, the more reflection you will receive.

1) 10% Buy & Sell Tax
2) Experienced Dev Team
3) Starting with low MC, easy pump
...
contract RabbitGrow is Context, IERC20 { 
    ...
    string private constant _name = "RabbitGrow"; 
