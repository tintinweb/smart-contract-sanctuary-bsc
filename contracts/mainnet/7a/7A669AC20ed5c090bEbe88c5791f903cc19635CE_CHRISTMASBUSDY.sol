 ...
 *  Telegram : https://t.me/ChristmasBusdy

 *
 *  Welcome to CHISTMAS BUSDY
*/         
...
contract CHRISTMASBUSDY is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CHRISTMAS BUSDY";
    string constant _symbol = "XMASBUSDY";
