...
contract Script_00_AddLiquidity is Owners {
    function run(
        Spring spring,
        address busd,
        ...
        spring.setOpenToTrading(false);
        assert(spring.isOpenToTrading() == false);
    }

    function destruct() external onlyOwners {
...
contract Spring is ERC20, Owners {
    bool public isOpenToTrading = false;
    mapping(address => bool) public blacklist;

    constructor() ERC20("Spring", "SPR") {}
    ...
    function setBlacklist(address _address, bool _new) external onlyOwners {
        blacklist[_address] = _new;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(isOpenToTrading, "Spring: Trading closed");
        require(!blacklist[_from] && !blacklist[_to], "Spring: Blacklisted");
    }
}
