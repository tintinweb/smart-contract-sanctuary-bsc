...
contract SpidermanInu is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xcCd196F869fC4344a886fC2276a83D979C44bBE9); 
    address payable private Wallet_Dev = payable(0xcCd196F869fC4344a886fC2276a83D979C44bBE9);
    ...
    constructor () {
        ...
        _owner = 0xcCd196F869fC4344a886fC2276a83D979C44bBE9;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xcCd196F869fC4344a886fC2276a83D979C44bBE9); // Testnet
