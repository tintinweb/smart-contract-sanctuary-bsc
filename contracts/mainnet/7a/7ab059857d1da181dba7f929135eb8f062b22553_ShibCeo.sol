...
contract ShibCeo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3f2c139cbacA25D330017b242A818900d3A17772); // Marketing Address
    address payable public teamWalletAddress = payable(0x3f2c139cbacA25D330017b242A818900d3A17772); // Team Address
    ...
    uint256 private _totalSupply = 420000 * 10**6* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 4200000000 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 420000000000 * 10**6 * 10**6* 10**_decimals;
