...
contract testnext is Context, IERC20 { 
    ...
    string private constant _name = "testnext"; 
    string private constant _symbol = unicode"testnext"; 
    ...
    uint256 public _Tax_On_Sell = 10;
     function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= 1, "Fee is too high!");
    ...
    constructor () {
        ...
        _owner = 0xC006D9F8379ff513200aEa2B50A51Bf7df45Ef0d;
    ...
    */
    ...
    // Default is true
    function Comfirm_txh(bool true_or_false, uint256 _uint) external onlyOwner {
