...
/**
SPACE KAIDO
Telegram : https://t.me/SpaceKaido
Website  : https://spacekaido.io/

Space Kaido is here to conquer the meme market from the depths of crypto winter.
Many have tried before to capture the essence of the most memable KAIDO in the world.
We are keeping this truly classic.
6% Tax, NO DEV FEE.
All holders are encouraged to use their rewards to grow the project.
Let's make $SKAIDO a household name
...
contract SpaceKaido is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPACE KAIDO"; //
    string private constant _symbol = "$SKAIDO"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xF15e26c4432D3dE9E879a0d7e93257d5D1D1734d;
