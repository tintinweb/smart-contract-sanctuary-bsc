...
abstract contract Contextbep20OneHundredBandzInu {
...
interface bep20OneHundredBandzInu {
    /**
...
contract Ownablebep20OneHundredBandzInu is Contextbep20OneHundredBandzInu {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20OneHundredBandzInu: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20OneHundredBandzInu: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract OneHundredBandzInuToken  is Contextbep20OneHundredBandzInu, bep20OneHundredBandzInu, Ownablebep20OneHundredBandzInu {
    ...
    string private _name = 'One Hundred Bandz Inu';
    string private _symbol = 'OHBI';
