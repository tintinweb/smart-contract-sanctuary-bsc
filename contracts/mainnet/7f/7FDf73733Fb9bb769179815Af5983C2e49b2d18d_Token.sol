...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0d88B6461A93d67f9f3c5C3f7c3645Fb04Fc2074); // Marketing Address
    address payable public teamWalletAddress = payable(0x0d88B6461A93d67f9f3c5C3f7c3645Fb04Fc2074); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x0d88B6461A93d67f9f3c5C3f7c3645Fb04Fc2074),
            block.timestamp
        );
    }
