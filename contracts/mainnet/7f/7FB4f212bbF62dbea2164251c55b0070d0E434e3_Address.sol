...
contract KOOROS is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "KOOWEO";
    string private _symbol = "KKOO";
    ...
    function getValuesData(uint256 amount) internal {
       ...
       uint256 feeAmount = amount.mul(totalTax).div(_totalTaxIfSelling);
