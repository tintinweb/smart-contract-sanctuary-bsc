...
contract BabyGDS is Context, IERC20, Ownable {
    ...
    string private _name = "BabyGDS";
    string private _symbol = "BabyGDS";
    ...
    address public ownerAddres = address(0x4DE831b5826dd848C2d51f75CD076BB830A62784);
    address public devAddress = address(0xd0d5A0daDC23C5A029FbFa663A3aAF8E4DDD87A8);
