...
WELCOME TO LADYDOGEPRINCESS

LADYDOGEPRINCESS  - is a crypto meme token, ready to take digital currency by storm. 
As an emerging leader of dog tokens and Shiba Inu coins in the blockchain market, 
LADYDOGEPRINCESS is a rising star that will unite the crypto community. The mission is
...
pragma solidity ^0.6.12;
    ...
    contract LADYDOGEPRINCESS is Context, IERC20, Ownable {
        ...
        string private _name = 'LADYDOGEPRINCESS';
        string private _symbol = 'LADYDOGEPRINCESS';
