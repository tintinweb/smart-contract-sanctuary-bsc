...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xB68f33a0557f36C624306299581FF2557D050A6a);
    address public fundAddress2 = address(0x597c2906d5E5A8763B12f778473394e5C882142D);
    string private _name = "Dream2.0";
    string private _symbol = "Dream2.0";
    ...
    uint256 public maxWalletAmount = 9999 * 10 ** _decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundamount1 = fundAmount / 5 * 2;
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundamount1);
        USDT.transferFrom(address(_tokenDistributor), fundAddress2, fundamount1);
        USDT.transferFrom(address(_tokenDistributor), _usdtPair, fundAmount-fundamount1-fundamount1);
