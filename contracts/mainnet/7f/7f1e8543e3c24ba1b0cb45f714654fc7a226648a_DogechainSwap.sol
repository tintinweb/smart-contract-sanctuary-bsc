...
contract DogechainSwap is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x8f96Ab79D6B5F37979f262776315C4214053A513;

    string constant _name = "Dogechain Swap";
    string constant _symbol = "DSWAP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1326707643 * 10**2 * (10 ** _decimals);
