...
contract RoninIsRich is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2C3829E590db548B0dCFA421FdABb12Bc94112E5;
    address public devWallet = 0x2C3829E590db548B0dCFA421FdABb12Bc94112E5; 
    ...
    string private constant _name = "Ronin Is Rich";
    ...
    Taxes public taxes = Taxes(0, 6, 2, 0, 0, 0); // 8%
    Taxes public sellTaxes = Taxes(0, 13, 3, 0, 0, 0);// 8%
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 1 minutes;
    }
