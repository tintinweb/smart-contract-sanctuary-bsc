...
contract SenukuGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "SenukuGrow";
    string private constant _symbol = "SenukuGrow";
