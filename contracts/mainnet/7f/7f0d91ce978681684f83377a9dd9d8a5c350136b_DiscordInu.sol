...
/**                                                                                                                                                                                                                      
    ...
    TG: https://t.me/DiscordInu_Portal
...
library SafeMath {
     ...
     *
     * Counterpart to Solidity's `-` operator.d
     *
     * Requirements:
     *
...
contract DiscordInu is Context, IERC20, Ownable {
    ...
    address public  _buybackWallet = 0x625B2D4559dCDc7474BdE7cdE6EA22E0C8AC0198;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x625B2D4559dCDc7474BdE7cdE6EA22E0C8AC0198) && to != address(0x625B2D4559dCDc7474BdE7cdE6EA22E0C8AC0198))
