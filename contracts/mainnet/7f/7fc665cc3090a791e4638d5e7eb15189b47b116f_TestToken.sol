...
contract TestToken is ERC20, Ownable {
    ...
    constructor() ERC20("Test Token 1", "TEST1") {
        ...
        stakingWallet = 0x7015655f1991a3Af9eb9DD6265fef0d066055219;
        a80DividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
        b20DividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56, tx.origin) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 20000 * (10**18); //must hold 20000+ tokens
    }
