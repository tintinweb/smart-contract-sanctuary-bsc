...
// File: contracts/NFT/Ownable.sol
...
// File: contracts/NFT/ERC721Metadata.sol
...
// File: contracts/NFT/AddressUtils.sol
...
// File: contracts/NFT/SupportsInterface.sol
...
// File: contracts/NFT/ERC721TokenReceiver.sol
...
// File: contracts/NFT/NFToken.sol
...
// File: contracts/NFT/NFTokenMetadata.sol
...
// File: contracts/NFT/NovaNFT.sol
...
contract HTKNFT is NFTokenMetadata, Ownable {
  constructor() {
    nftName = "HTKNFT";
    nftSymbol = "HTKNFT";
  }
  ...
  function create( address to,uint256 start, uint256 end) external onlyOwner {
    string memory preffix = "http://nft.htkdao.com/nfts/heros/json/";
    string memory suffix = ".json";
    for(uint256 i=start;i<=end; i++){
      super._mint(to, i);
      string memory _uri = strConcat(preffix,toString(i),suffix);
