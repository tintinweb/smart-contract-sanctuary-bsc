...
library Address{
 ...
 contract FPU is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_000 * 10**3;
    ...
    string private constant _name = "FPU";
    string private constant _symbol = "FPU";
