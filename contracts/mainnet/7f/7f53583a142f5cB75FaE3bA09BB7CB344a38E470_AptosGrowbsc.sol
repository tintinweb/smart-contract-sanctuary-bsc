...
/**
Telegram : https://t.me/AptosGrowBsc
*/
...
contract AptosGrowbsc is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Aptos Grow";
    string constant _symbol = "APTG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 59) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 59) / 100; 
