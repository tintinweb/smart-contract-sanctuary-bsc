...
contract COM is COMDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private COMTeam;
    address private CharityCOM;
    ...
    string public override name = "Cult Hunter";
    string public override symbol = "COM";
    ...
    constructor(uint totalSupplyValue, address COMTeamAddress, address CharityCOMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        COMTeam = COMTeamAddress;
        CharityCOM = CharityCOMAddress;
       
        // split the tokens according to agreed upon percentages
        balances[COMTeam] =  totalSupply * 4 / 100;
        balances[CharityCOM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's COMTeam pot
