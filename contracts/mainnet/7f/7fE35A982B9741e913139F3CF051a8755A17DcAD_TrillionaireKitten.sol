...
contract TrillionaireKitten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trillionaire Trillionaire"; 
    string private _symbol = "TrillionKitten";
