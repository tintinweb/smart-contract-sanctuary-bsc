...
*
*NewAI is a combination of the OpenAI and Dialogflow function
*You can use for asking with text and voice, so it's a complete bot
*
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC364EA2D4a432AcD937F8e7Af528aB2a4794AF7a; // owner address
...
contract NewAI is Context, IERC20, Ownable {
    ...
    string private _name = "New AI";
    string private _symbol = "NEWAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC364EA2D4a432AcD937F8e7Af528aB2a4794AF7a); // Marketing Address
    address payable public teamWalletAddress = payable(0xC364EA2D4a432AcD937F8e7Af528aB2a4794AF7a); // Team Address
