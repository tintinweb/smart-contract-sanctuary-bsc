...
/**
 SHINJA GROW!
 Come join our hoard of $SHINJA warriors and let your inner Ninja out!

 Website: http://shinjagrow.com
 Telegram: https://t.me/shinjagrow
 Twitter: https://twitter.com/Shinjagrow
...
contract SHINJA_GROW is Context, IBEP20, Ownable {
    ...
    string private _name = "SHINJA GROW"; // token name
    string private _symbol = "$SHINJA"; // token ticker
    ...
    // buy tax fee
    uint256 public reflectionFeeOnBuying = 1;
    uint256 public liquidityFeeOnBuying = 4;
    uint256 public marketWalletFeeOnBuying = 4;
    uint256 public burnFeeOnBuying = 1;

    // sell tax fee
    uint256 public reflectionFeeOnSelling = 1;
    uint256 public liquidityFeeOnSelling = 4;
    uint256 public marketWalletFeeOnSelling = 4;
