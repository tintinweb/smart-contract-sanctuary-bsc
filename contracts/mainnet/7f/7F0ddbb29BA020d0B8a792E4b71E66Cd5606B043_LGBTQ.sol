...
contract LGBTQ is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2000000 * 10**decimals();
    ...
    address private marketingWallet = 0x38BA75fc80c063De1D3782e7B2F8F53457537602;
    address private devWallet = 0xc205838Cf3667b9280BB6C11a3AA06C6e5294A9e;
    ...
    Taxes public taxes = Taxes(7, 0, 0);
    Taxes public sellTaxes = Taxes(7, 0, 0);
    ...
    constructor(address routerAdd) ERC20("LGBTQ BADDIES", "LGBTQ") {
