...
Tokens are beginning to do well again, BSC is seeing more and more diamond hands, and they are being rewarded.
Its time we continue this growth, don't be afraid to hold, find that solid utility and token, hold and work as one.
This is one of them, this utility can deliver, they just need investor support. Let the chart breathe, hodl that bag and let's start changing BSC for the better.
...
contract CRESTED is IBEP20, Auth {
    ...
    string constant _name = "Chinese Crested Dog";
    ...
    uint256 sellMultiplier = 70;
    uint256 buyMultiplier = 70;
    uint256 transferMultiplier = 70;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x183E2c8227d7cfF098e5626E913171ea923A90a7;
