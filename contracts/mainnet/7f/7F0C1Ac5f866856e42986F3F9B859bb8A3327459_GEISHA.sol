...
contract GEISHA is IBEP20, Auth {
    ...
    uint256 private NFTFee         = 2;
    uint256 private developmentFee = 0;
    uint256 public stakingFee      = 0;
    uint256 public totalFee        = developmentFee + marketingFee + liquidityFee + NFTFee + stakingFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0xE87a278C2d911254555fDc0c38EF6DaA52256F89; 

        _allowances[address(this)][address(router)] = type(uint256).max;

        isFeeExempt[msg.sender] = true;
        isFeeExempt[marketingFeeReceiver] = true;
        isFeeExempt[NFTFeeReceiver] = true;
        ...
        isTimelockExempt[NFTFeeReceiver] = true;

        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[pair] = true;
        isTxLimitExempt[marketingFeeReceiver] = true;
        isTxLimitExempt[NFTFeeReceiver] = true;

        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver = 0xE87a278C2d911254555fDc0c38EF6DaA52256F89;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(NFTFeeReceiver).call{value: amountBNBNFT}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _NFTFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
        marketingFee = _marketingFee;
        NFTFee = _NFTFee;
        stakingFee = _stakingFee;
        totalFee = _liquidityFee.add(_developmentFee).add(_marketingFee).add(_NFTFee).add(_stakingFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Buy Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _NFTFeeReceiver, address _stakingFeeReceiver, address _developmentFeeReceiver) external authorized {
