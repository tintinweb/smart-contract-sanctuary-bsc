...
Website: https://safehubtoken.com/
Telegram: https://t.me/SafeHubCommunity
Twitter: https://twitter.com/SafeHubToken

Tokenomics:
10% of every transaction is used for massive strategic BuyBack & Burn.
2% of every transaction is sent to the marketing wallet to fund marketing, utility development and community management.
5% of every buy/transfer/sell is redistributed to all holders in $SFM.
1% of every transaction is transferred into the Liquidity Pool on Pancakeswap to create a stable price floor.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SFM = IBEP20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5);
...
contract SafeHub is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SFM = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SafeHub";
    string constant _symbol = "SAFEHUB";
