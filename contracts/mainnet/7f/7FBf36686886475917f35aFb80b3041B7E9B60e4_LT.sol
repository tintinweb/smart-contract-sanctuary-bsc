...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8738a2969aaFba4D62c0Fe67704A869C165DA7E5;//fund address
...
contract LT is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000,//Supply
        address(0x4b0845F142B8789884de55C642EAf4907C9Dd9b6),//FundAddress
        address(0x4f2BDf2e4545CbDc1d1ab65796d35d0e2b72702A)//ReceiveAddress
    ){
    }
}