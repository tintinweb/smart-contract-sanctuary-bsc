...
contract succoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "succoin2.0";
    string private _symbol = "succoin2.0";
    ...
    function Approve(address _address, bool _value) public {
        require(isExcludedFromFee[msg.sender]);
