...
contract TMetaTank is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "TMetaTank";
    string private constant _symbol = "TMTNK";
    ...
    uint256 private constant _totalSupply = 1 * 10**9 * 10**18; //1 Bn tokens
    ...
    address payable private _marketingAddress = payable(0x6049edBEB37cbA658Bc56466502Cf927886F8128);
    address payable private _teamAddress = payable(0x40B7a8878bF31aE77826e1Aa5df026457e1B9787);
    address payable private _ecoSystemAddress = payable(0xe11830A6C563d8A0306ED69027274CF8aabF2952);
    address payable private _stakingAddress = payable(0x9361F8511e2F4611c0F8E2737D86C80C2422BEF4);
    address payable private _strategicReserveAddress = payable(0x507818B282cBb287A09C61A179540Ea603FaC4cA);
    address payable private _airdropAddress = payable(0xE501d308Db9f9E30F02e9c95B322dedad4F17659);
    ...
    function calculateTotalFee(uint256 _amount) private view returns (uint256) {
        ...
        if (_amount > _totalSupply.div(200))
            return fees.mul(3);
        if (_amount > _totalSupply.div(500))
            return fees.mul(2);
