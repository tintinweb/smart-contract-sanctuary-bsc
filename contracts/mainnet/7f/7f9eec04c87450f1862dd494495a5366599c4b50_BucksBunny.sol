...
contract BucksBunny is IBEP20, Auth {

    using SafeMath for uint256;

    string _name = "BucksBunny";
    string _symbol = "BUCKS";
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(creator).call{value: amountBNBMarketing, gas: 30000}("");
        tmpSuccess = false;
