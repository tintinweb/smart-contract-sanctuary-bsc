...
contract V60 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x849bD0070C4CA476711a6F027D21F70BD67E04b0;
    address public V60_DiamaondWallet = 0x849bD0070C4CA476711a6F027D21F70BD67E04b0;

    string private constant _name = "V60";
    string private constant _symbol = "V60";
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[V60_DiamaondWallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[marketingWallet] = true;
        allowedTransfer[V60_DiamaondWallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(teamAmt > 0){
            payable(V60_DiamaondWallet).sendValue(teamAmt);
        }
    }
    ...
    function Lordshiba_RpdateroyalWallet(address newWallet) external onlyOwner{
        V60_DiamaondWallet = newWallet;
    }
