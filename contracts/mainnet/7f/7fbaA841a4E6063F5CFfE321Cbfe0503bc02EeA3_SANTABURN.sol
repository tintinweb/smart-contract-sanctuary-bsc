...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78ef76a91446a39c8920Ed1C7E2915A45C444f35;
...
contract SANTABURN is Context, IERC20, Ownable {
    ...
    string private constant _name = "SantaBurn"; // 
    string private constant _symbol = "Christmas"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x78ef76a91446a39c8920Ed1C7E2915A45C444f35);
