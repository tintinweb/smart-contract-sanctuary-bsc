...
Telegram : https://t.me/FlokiMinePortal

The community token is launched by an experienced team in the BSC Chain to make safe and comfortable investments.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc5cF364CAfD591FF984f8B579C11F9f67a65FCc1; 
...
contract Flokimine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flokimine";
    string private _symbol = "Flokimine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5cF364CAfD591FF984f8B579C11F9f67a65FCc1); // 
    address payable public teamWalletAddress = payable(0xc5cF364CAfD591FF984f8B579C11F9f67a65FCc1); // 
