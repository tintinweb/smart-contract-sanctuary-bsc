...
contract MIKUJIRU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MikujiruBSC";
    string private _symbol = "MikujiruBSC";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address sgw2
    address payable private TeamWallet = payable(0x286ccae7552d4912dD2E1cBE71B4F6Cb29A0e6Be); // Team Address
