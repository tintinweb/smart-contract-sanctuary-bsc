...
contract RobotrageAI {
	...
	constructor() {
        ceoWallet = payable(0x2390DfCe3e5eF5579d494cE7f7bCD7Ce51682699);
		marketinWallet = payable(0x539FACbed690b7f9Bcc30600dBC8D0ADeFD73Fe1);
        insuranceWallet = payable(0xde162A71D7C8A8f2eD2A8104534d9160C11a8da3);

		startDate = 1674306000; //Date and time (GMT): Saturday, January 21, 2023 1:00:00 PM

        plans.push(Plan(180, 20));
