...
contract i420Cats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "i420Cats";
    string private _symbol = "I420CATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38384fb2e4D4fa209BA83276C1bB10e32E9D622d);
    address payable public teamWalletAddress = payable(0xF261B17Dfbe7BcFEaA3af71763345C09f2029CDa); 
