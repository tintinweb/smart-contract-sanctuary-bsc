...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcd73ffA60EdF0616aa9698195415126c9b1ceBCa; // owner address
...
contract HOLYBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Holy BSC";
    string private _symbol = "PrayForBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd73ffA60EdF0616aa9698195415126c9b1ceBCa); // Marketing Address
    address payable public teamWalletAddress = payable(0xcd73ffA60EdF0616aa9698195415126c9b1ceBCa); // Team Address
