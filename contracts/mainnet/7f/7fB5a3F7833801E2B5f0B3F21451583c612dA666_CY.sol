...
contract CY is Token {
    constructor() ERC20(
        ...
        address _marketing = address(0xd6ffc49eA2eeF9C1c71B0e9034407495FBffFdE4); // 
        address _receive = address(0x48f7E56a75FbFB1f84b4933e4d388102b0C62B02);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0xd6ffc49eA2eeF9C1c71B0e9034407495FBffFdE4)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(15 ether);  
        setInitPrice(10 ether); 
        feeMarketingTo2 = address(0x1c9Ba7C64eD0Eb368E4a752d8f360b59A7E57085);   
        feeEarn = 1500; 
    }
}