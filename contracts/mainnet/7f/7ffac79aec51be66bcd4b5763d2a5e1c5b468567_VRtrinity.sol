...
contract VRtrinity is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0xd84A640785e2348ccF4e8A281a2Aed302Da8299B;
    mapping(address => mapping(address => uint256)) private _allowances;
    using SafeMath for uint256;
    uint256 private _totalSupply;
    string private _name;
    string private _symbol;
    address public  uniswapV2Pair = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    struct userSells{
        uint256 swapLimit;
        bool isSwap;
    }
    ...
    constructor() {
       _totalSupply = 1000000000 * (10**18);
        _setOwner(0xd84A640785e2348ccF4e8A281a2Aed302Da8299B);
        _name="VRtrinity";
        _symbol="VRT";
        _mint(0xd84A640785e2348ccF4e8A281a2Aed302Da8299B, _totalSupply);
    }
