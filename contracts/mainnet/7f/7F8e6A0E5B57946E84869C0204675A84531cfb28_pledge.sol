...
contract pledge is DataPlayer {
   ...
   function _asArray(address add) private pure returns (address[] memory) {
    ...
    function investmentEPT(uint256 amount ) public payable   {
        ...
        uint256 endTime =Daynumber.add(10) ;
    ...
    function getInvestInfo(uint256  Daynumber,uint256  id ,uint256  index  ) public   returns(uint256)  {
