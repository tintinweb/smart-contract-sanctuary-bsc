...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private marketAddress = address(0xfEc1b58e1714F099e6cEc8ffD10c6acf35e2CB1f);
    address public  deadAddress = address(0x000000000000000000000000000000000000dEaD);
    address private wFirstAddress = address(0x0E72811fC4ce0C63679dc4Dc17dfBf8249B84C50);
    address private wSecondAddress = address(0x35240468a918393BCF5186D63a5AD5860B0a2118);
    address private wThirdAddress = address(0x07937698579A18D1e7708b55029768827bf63bf1);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address lpBackAddress = 0xfEc1b58e1714F099e6cEc8ffD10c6acf35e2CB1f;
