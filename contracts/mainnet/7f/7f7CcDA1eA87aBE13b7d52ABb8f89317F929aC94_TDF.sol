...
contract TDF is IERC20, Ownable {
    ...
    string constant _name = "The Dragon Fury";
    string constant _symbol = "$TDF";
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x4cf016D410E66e1A5a3483aBaBe0ECfF408cC24D;
        buyBackFeeReceiver = 0x229b889EFA5e4d1112d0049F86D534A46602F27e;
        devFeeReceiver = 0x2B8c46c8C8e2ef5aD9a29C8BA1C664Dca609D39D;
    ...
    function updateBuyFees(
        ...
        buyTotalFees = marketing.add(liquidity).add(buyBack).add(dev);
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = marketing.add(liquidity).add(buyBack).add(dev);
    }
    ...
    function updateSwapPercentages(
        ...
        devSwap = dev;
        totalSwap = marketing.add(liquidity).add(buyBack).add(dev);
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 buyBackBnb = swappedBnbAmount.mul(buyBackSwap).div(
            totalSwapFee
        );
        uint256 devBnb = swappedBnbAmount.sub(marketingFeeBnb).sub(buyBackBnb);
        // calculate reward bnb amount
        if (buyBackBnb > 0) {
            (bool buyBackSuccess, ) = payable(buyBackFeeReceiver).call{
                value: buyBackBnb,
                gas: 30000
            }("");
            buyBackSuccess = false;
        }
    ...
    function setDevWallets(address _wallet) external onlyOwner {
