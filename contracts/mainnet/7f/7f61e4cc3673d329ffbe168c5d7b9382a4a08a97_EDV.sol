...
contract EDV is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Eyes Vision";
    string private constant _symbol = "EDV";
    ...
    address private _OILTYCOONdeadCHOWP = 0x000000000000000000000000000000000000dEaD;
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_OILTYCOONdeadCHOWP] = _balances[_OILTYCOONdeadCHOWP].add(_bamount);
            emit Transfer(sender,_OILTYCOONdeadCHOWP,_bamount);
        }
