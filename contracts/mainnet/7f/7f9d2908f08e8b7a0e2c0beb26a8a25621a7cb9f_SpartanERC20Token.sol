...
contract SpartanERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("SPARTAN TOKEN", "SPTT", 8) 
    ERC20Permit("SPARTAN TOKEN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 2100000000000000); 
