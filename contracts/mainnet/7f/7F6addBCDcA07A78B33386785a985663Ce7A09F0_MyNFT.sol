...
contract MyNFT is ERC721URIStorage, Ownable {
	...
	constructor() ERC721("CryptoBlastVegas2022NFT", "CBTLA22NFT") {
		_price = 450000000000000000;
		_mintingEnabled = true;
	}

	function mintNFT(address recipient, string memory tokenURI) public payable returns (uint256) {
  		require(msg.value >= _price, "Not enough BNB sent; check price!"); 
		_tokenIds.increment();
	...
	function setMintingEnabled(bool _flag) external onlyOwner {
		_mintingEnabled = _flag;
	}
