...
contract GalaInu2 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Gala Inu 2.0";
    string constant _symbol = "GINU2";
    ...
    address public marketingFeeReceiver = 0x4575ee82c20A6014CFee01EF2cA5e3abD9Bb166f;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x4575ee82c20A6014CFee01EF2cA5e3abD9Bb166f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x4575ee82c20A6014CFee01EF2cA5e3abD9Bb166f] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x4575ee82c20A6014CFee01EF2cA5e3abD9Bb166f,
                block.timestamp
            );
