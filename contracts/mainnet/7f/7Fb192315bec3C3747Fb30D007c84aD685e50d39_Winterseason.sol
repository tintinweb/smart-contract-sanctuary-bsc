...
contract Winterseason is IBEP20, Auth {
    ...
    string constant _name = "Winterseason";
    string constant _symbol = "Win";
    ...
    address private marketingFeeReceiver =0xaecbaa7C564Ab2B12d7F46A112a2af6EC7505cF3;
    ...
    function setTxLimit(uint256 amount) external onlyOwner {
        require(amount >= _totalSupply / 1000, "Cannot set TxLimit lower than 0.1%");
        _maxTxAmount = amount;
    }

   function setMaxWallet(uint256 amount) external onlyOwner() {
        require(amount >= _totalSupply / 1000, "Cannot set MaxWallet lower than 0.1%");
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount) external onlyOwner {
        require(_amount > 0, "swapThreshold should be greater than 0");
