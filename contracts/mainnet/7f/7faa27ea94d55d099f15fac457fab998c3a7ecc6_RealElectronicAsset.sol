...
=== 'RealElectronicAsset' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards RealElectronicAsset
-------------------------------------------------------------------
*/ 
...
contract RealElectronicAsset is Context, IBEP20, Ownable, Pausable {
