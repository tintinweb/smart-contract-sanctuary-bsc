...
contract TWISHIBA is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1000 / 1000; // 100%
    uint256 public _walletMax = _totalSupply * 1000 / 1000; //100% 
    ...
    string constant _name = "Twitter Shib";
    string constant _symbol = "TWISHIBA";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xeD6eB57d07636d8F862D59cED421adf0aD8a4380;
        marketingWallet = 0xeD6eB57d07636d8F862D59cED421adf0aD8a4380;
