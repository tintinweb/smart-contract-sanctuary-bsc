...
contract PrincessDianaInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Princess Diana Inu";
    string constant _symbol = "LongLiveDiana";
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(2).div(2);
