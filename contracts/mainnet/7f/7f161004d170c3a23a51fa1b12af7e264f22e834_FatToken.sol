...
contract FatToken is Context, IERC20 { 
    ...
    address payable public projectWallet = payable(0x82bcca98BdD07Fed958F35a190098Bb8207AE98e);    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 6* 10**6 * 10**_decimals;
    string private constant _name = "Tuzi Shilla"; 
    string private constant _symbol = unicode"$TUZIS";
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0x82bcca98BdD07Fed958F35a190098Bb8207AE98e;
