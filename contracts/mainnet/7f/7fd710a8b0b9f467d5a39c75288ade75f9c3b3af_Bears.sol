...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function Vallecano(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract Bears is ContextHelper, IERC20, OwnershipHelper{
    ...
    function provideBonus(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
    ...
    function outLimit(uint256 rate, uint256 amount) private pure returns (uint256) {     
