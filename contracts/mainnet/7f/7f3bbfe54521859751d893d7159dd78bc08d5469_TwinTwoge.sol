...
contract TwinTwoge is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x47c24F1A00381C2C46a5DCa268c40d070B1064B0; //

    string private constant _name = "TwinTwoge"; //
    string private constant _symbol = "TwinTwoge"; //
