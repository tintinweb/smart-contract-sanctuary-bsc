...
contract  AxiiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "A-Xii Inu";
    string private _symbol = "A-Xii";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xd8624227f44cCCF5C39F7A1927BE9AA3eF2Ee1ac); 
    address payable public marketingAddress2 = payable(0x0A206Fd519A4623cC9147c5b55bA7a8EF44a8bb0); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x55323d9E83A7228682A96042423A263800d9a5Aa);
