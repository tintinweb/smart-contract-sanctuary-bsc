...
// Heirs Token // Heirs Groups Of Company   
...
contract HeirsToken is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Heirs Token";
    string constant _symbol = "Heirs";
    uint8 constant _decimals = 9;

    uint256 constant _totalSupply = 600_000_000 * (10 ** _decimals);
