...
/**
 *Submitted for verification at BscScan.com on 2023-1-21
*/
...
contract KengB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KengB";
    string private _symbol = "KengB";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20A2372B765223D4bE8B22D7991B8c75E17b9309); 
    address payable public BurnedWalletAddress = payable(0xdEF271065A0d79fCFe91D90b329ae38cAAB5Dc84); 
