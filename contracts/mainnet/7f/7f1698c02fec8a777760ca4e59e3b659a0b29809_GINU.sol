...
contract GINU is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xDFffFdB58b7b3d82f3ef819F9060492F6f7d2735);
    ...
    function setSellFees(uint256 newLiquidityFee, uint256 newMarketingFee) public onlyOwner {
        require(newLiquidityFee + newMarketingFee <= 100, "Can't set sellFee above 100%");
