...
contract BOBA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BOBA INU";
    string constant _symbol = "BOBA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x14320d438bEAD83f8105907C589ca664597a6d66;
