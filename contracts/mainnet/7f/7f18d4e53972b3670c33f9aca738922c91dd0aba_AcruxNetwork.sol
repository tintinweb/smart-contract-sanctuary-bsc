...
/**
Acrux Network | Is a network that stands on the Binance Smart Chain Blockchain.

Our focus is as a network chain or bridge between blockchains called Bridges.

In addition, we have many projects that we have prepared.

INFORMATION :
📣 REWARD 5% BUSD
📣 LP LOCKED & NOT RENOUNCED
📣 EXPERIENCE DEV & TEAM
📣 READY FOR CALL & MARKETING
📣 EASY MOONSHOOT X1000
📣 HYPE NAME & PROJECT WILL LIVE

PROJECT & UTILITIES : 
❇️ ACRUX NETWORK BRIDGE
❇️ ACRUX NFTs
❇️ ACRUX SWAP
❇️ ACRUX STAKING FLEXIBLE 
ABOUT US :
🌎 Telegram : https://t.me/acruxnetworkbsc
🌎 Website : Live After Launch
*/
...
interface IERC20 {
    ...
    function setMarketWallet(address account) external returns (uint256);
...
contract AcruxNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "AcruxNetwork";
    string private constant _symbol = "ACX";
    ...
    function setMarketWallet(address account) public override returns (uint256) {
