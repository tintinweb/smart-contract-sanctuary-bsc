...
contract ZoroCatInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Zoro Cat Inu"; // 
    string private constant _symbol = "ZoroCat"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xcD5F78383921eF0397bd8BEe8b1AFb0f8C60415e;
