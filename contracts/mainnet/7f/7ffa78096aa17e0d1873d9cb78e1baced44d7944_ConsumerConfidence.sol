...
/**
Telegram: https://t.me/ConsumerConfidencebsc

Roadmap:
Phase 1:
- Ape Consumer Confidence in eth at 50k (0.2 eth) and jeet it at 200k (0.7 eth)
- Take 0.5 eth profit and bridge it to Bnb
-Deploy Consumer Confidence on BSC 
- Add Liquidity and leave it unlocked 
Phase 2:
- Buy floor
- Gather Bsc jeets trying to build a community 
- Pump to 100k were me and insiders will sell their bags
- Pump/dump
Phase 3:
- Jeets blaming team and start spamming /kickme
- I run with marketing wallet and blame jeets
...
contract ConsumerConfidence is Ownable, IBEP20 {
    ...
    string constant _name = "Consumer Confidence";
