...
Telegram: https://t.me/platformpoliciesinu
...
contract PlatformPoliciesInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Platform Policies Inu"; // 
    string private constant _symbol = "$POLICIESINU"; //    
