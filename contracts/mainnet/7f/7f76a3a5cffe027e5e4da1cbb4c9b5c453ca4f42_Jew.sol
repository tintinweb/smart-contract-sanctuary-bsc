...
8%/8% tax for Holocaust orphaned war veterans.

Telegram: t.me/HolocaustMemorialOrphansFund.

LP will be locked and ownership renounced. I'm not a Jew.
...
contract Jew is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666_666 * 10**9;
    uint256 public _maxTxAmount = 10_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "Holocaust Memorial Orphan's Fund"; // 
    string private constant _symbol = "HOMO FUND"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x603a3c42c4370874E32aFF642685D58ADD09F53b;
