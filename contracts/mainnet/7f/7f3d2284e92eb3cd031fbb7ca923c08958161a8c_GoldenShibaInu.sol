...
contract GoldenShibaInu is Context, IERC20, Ownable {
    ...
    string private _name = "GoldenShibaInu";
    string private _symbol = "GOLDS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2622d4f2D877aC55F98650ccE09b9CF6CF1F8d4A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2622d4f2D877aC55F98650ccE09b9CF6CF1F8d4A); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**3;
    uint256 public _walletMax = 1000 * 10**6 * 10**3;
