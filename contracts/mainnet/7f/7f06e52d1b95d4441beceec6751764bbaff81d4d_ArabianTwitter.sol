...
contract ArabianTwitter is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Arabian Twitter";
    string private _symbol = "AT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3666C28F26a150fc88bb2867778A89c18Ea63969);
    address payable public teamWalletAddress = payable(0xEB325037a18973E23D722320C170Ec9Bf37fc382);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 tokensForLP = tAmount.mul(_liquidityShare).div(2);
        uint256 tokensForSwap = tAmount.sub(tokensForLP);

        swapTokensForEth(tokensForSwap);
        uint256 amountReceived = address(this).balance;

        uint256 totalBNBFee = (_liquidityShare.div(2));
