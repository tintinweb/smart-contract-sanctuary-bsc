...
contract HoldMoon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HOLD MOON";
    string private constant _symbol = unicode"HOLDMOON";
    ...
    address payable public DevWallet = payable(0xCa9EE509035E8CFA43D09eaa213d48AaC41d9B33);
    address payable public MarketingWallet = payable(0xCa9EE509035E8CFA43D09eaa213d48AaC41d9B33);
