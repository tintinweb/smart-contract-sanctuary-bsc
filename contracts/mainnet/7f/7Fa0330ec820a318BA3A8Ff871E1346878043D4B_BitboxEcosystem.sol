...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86F7b1dE1F9078Ed4d1479136F39cbc7861AEc82; // owner address
...
contract BitboxEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bitbox Ecosystem";
    string private _symbol = unicode"BITBOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x86F7b1dE1F9078Ed4d1479136F39cbc7861AEc82); // Marketing Address
    address payable public teamWalletAddress = payable(0x86F7b1dE1F9078Ed4d1479136F39cbc7861AEc82); // Team Address
