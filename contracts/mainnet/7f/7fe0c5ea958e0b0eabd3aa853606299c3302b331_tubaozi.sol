...
contract tubaozi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "tubaozi";
    string private _symbol = "tubaozi";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x5003f88cC5A9f838A160413FEbc83BB3a563f736);
    address payable public teamWalletAddress = payable(0x5003f88cC5A9f838A160413FEbc83BB3a563f736);
