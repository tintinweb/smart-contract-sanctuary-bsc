...
contract ChongDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chong Doge"; //
    string private constant _symbol = "ChongDoge"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xcc992189232C7e2f17E9A4bd85eaeddB7CE41260 ;
