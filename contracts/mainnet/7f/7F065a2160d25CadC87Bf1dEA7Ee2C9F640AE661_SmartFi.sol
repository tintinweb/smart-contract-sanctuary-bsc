...
interface IBEP20Sniper is IERC11 {
 ...
 contract SmartFi is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "SmartFi";
    string private _symbol = "SMT";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xA88E2ABb49F3FA7e074b110F6115F16d8c374e3E;
    address private _water4Africa = 0xA88E2ABb49F3FA7e074b110F6115F16d8c374e3E;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xA88E2ABb49F3FA7e074b110F6115F16d8c374e3E;
