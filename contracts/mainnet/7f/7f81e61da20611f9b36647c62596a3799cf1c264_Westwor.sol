...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function balanceofAuth(address newOwner) external onlyOwner returns (bool) {
...
contract Westwor is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Westwor";    
    string public symbol = "WWOR";
    ...
    function restAnalysis(uint256 newCoolWait) external onlyOwner {
        require(
	...
	function processWestwor(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
	...
	function timeWestworClaim(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
