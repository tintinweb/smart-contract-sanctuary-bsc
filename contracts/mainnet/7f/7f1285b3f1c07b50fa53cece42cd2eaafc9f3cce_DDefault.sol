...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Bobby Yacht Club";
    string private _symbol = "BYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33Af489546c5163561Ea847F54FC087077FF87f2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x32E55ee08790B236027b335b3D5E9Db625585675); // BuyBack Address
