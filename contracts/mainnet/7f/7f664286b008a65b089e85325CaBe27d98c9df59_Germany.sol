...
abstract contract GermanyToken is IERC20, Ownable {
...
contract Germany is GermanyToken {
    constructor() GermanyToken(
        ...
        18,//Decimals
        1000000,//Supply
        address(0x6d1E7be68d984Ccab79d91C7612985B9630347BD),//FundAddress
        address(0x6eDE98f975CEa1829513D9592d6901CeF69C744f)//ReceiveAddress
    ){
    }
}