...
contract CuteLunaClassic is Context, IBEP20, Ownable {
    ...
    string public _name = "Cute Luna Classic"; // token name
    string public _symbol = "CLUNC"; // token ticker
    ...
    uint256 private maxHoldingAmount = 1000000 * 1e9;
    uint256 private minBuyLimit = 1000000 * 1e9;
