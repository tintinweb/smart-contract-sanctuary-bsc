...
contract CHEFDOGE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "CHEF DOGE";
    string public _symbol= "CHEF";
     bool balances1 = true;

    address payable public charityAddress = payable(0xd66Ab04cCDC0C5464F7070a71cd04a0D738b2390); // Marketing Address
