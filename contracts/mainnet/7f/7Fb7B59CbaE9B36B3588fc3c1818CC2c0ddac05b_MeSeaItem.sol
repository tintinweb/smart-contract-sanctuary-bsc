...
contract MeSeaItem is ERC1155PresetMinterPauserUpgradeable, OwnableUpgradeable {
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    bytes32 public constant GATEWAY_ROLE = keccak256("GATEWAY_ROLE");

    string public constant name = "MeSea Items";
    string public constant symbol = "MeSeaERC1155";
    mapping(uint256 => uint256) private _totalSupply;

    function erc1155Initialize() public initializer {
    ...
    function setURI(string memory _newuri) external {
        require(
            ...
            "ERC1155PresetMinterPauser: must have admin role to set URI"
        );
        _setURI(_newuri);
