...
contract Ken1 is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x2a1A6ba81813283Af012f0F6FF3244ec1d5dFA9e));
        ruinWalletAddress = payable(address(0x2a1A6ba81813283Af012f0F6FF3244ec1d5dFA9e));
        _name = coinName;
       _symbol = coinSymbol;
