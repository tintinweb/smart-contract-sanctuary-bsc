...
contract luckysqu1d3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lucky Squ1d3"; // 
    string private constant _symbol = "$luckysqu1d3"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x49Fe2ee5456ef489Ad0AfdE5dd851f73e974B2ED;
