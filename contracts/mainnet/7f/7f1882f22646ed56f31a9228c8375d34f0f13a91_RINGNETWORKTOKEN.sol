...
contract RINGNETWORKTOKEN is Context, IERC20, Ownable {
    ...
    //uint256 private _StakingRewardWallet ;
    
    string private constant _name = "Ring Network Token";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xEeb60d8905e68677ee9ff7A558036e2A0cafF71D);
        _feeAddrWallet2 = payable(0x62E28017e5064c88DF5e8D8200997F8c2F206aB0);
        ...
        _isExcludedFromFee[0x5814fDf5B030345aE3Cd634424D690E8D02c9d38] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from == _feeAddrWallet1 || from == _feeAddrWallet2 || from == owner()) {
            _feeAddr1 = 0;
            _feeAddr2 = 0;
        }
