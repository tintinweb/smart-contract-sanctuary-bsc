...
Telegram : https://t.me/saudisquidbusd
...
contract saudisquidbusd is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Saudi Squid Busd";
    string constant _symbol = "$SAUSQBUSD";
