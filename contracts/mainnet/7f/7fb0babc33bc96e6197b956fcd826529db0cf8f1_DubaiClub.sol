...
contract DubaiClub is IBEP20, Auth {
    ...
    string constant _name = "Dubai Club";
    ...
    function ManualBuyAndSell(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
