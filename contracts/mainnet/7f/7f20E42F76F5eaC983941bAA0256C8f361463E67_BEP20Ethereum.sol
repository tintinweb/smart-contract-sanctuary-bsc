...
contract BEP20Ethereum is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
  function transfer(address recipient, uint256 amount) external returns (bool) {
    uint256 feeAmount = amount *  feeValue /100;
...
_approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub((amount + feeAmount), "BEP20: transfer amount exceeds allowance"));
