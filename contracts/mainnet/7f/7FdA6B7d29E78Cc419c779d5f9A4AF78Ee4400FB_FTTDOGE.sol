...
contract FTTDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FTT DOGE";
    string private _symbol = "FTT DOGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x12d5fBe9fB6cEC9c577DB52257484C2Efb2F0C6c);
