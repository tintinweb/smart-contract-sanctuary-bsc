        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x99384d181Ab74EeB7ab9245f2a65aF3116De0403), block.timestamp
                );
            }
        }
    }
...
contract RRKPRO is AbsToken {
    constructor() AbsToken(
        ...
        "RENRENKE APP TOKEN PRO",//Name
        "RRKPRO",//Symbol
        6,//Decimals
        1000000,//Supply
        address(0xbCFF7DE7044af65764ac024eA036087EBEe72fed),//FundAddress
        address(0x82BBcFBce20c9d51cF29C1FD47eD042Bf0Cb651c)//ReceiveAddress
    ){
