...
*/
/**
Lazy team launched a meme token under the name LazyApe.
 LazyApe project with carefully thought out calculations, and the right plan,
 marketing results will be directed to get influencers to push LazyApe to the moon.
...
contract LAZYAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lazy Ape";
    string private _symbol = "LAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC076a96f06491Ed2fcB8176962c13c2497D8E5E3); // 营销钱包
    address payable public teamWalletAddress = payable(0xC076a96f06491Ed2fcB8176962c13c2497D8E5E3); // 团队钱包
