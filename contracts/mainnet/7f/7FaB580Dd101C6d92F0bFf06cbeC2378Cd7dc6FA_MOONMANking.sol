...
contract MOONMANking is Context, IERC20, Ownable {
    ...
    string private _name = "MOONMANking";
    string private _symbol = "MOONMANking";
    ...
    uint256 public _maxTxAmount = 10 * 10**15 * 10**18;
    uint256 private minimumTokensBeforeSwap = 3 * 10**12 * 10**18; 
