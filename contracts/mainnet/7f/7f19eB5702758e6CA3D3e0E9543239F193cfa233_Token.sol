...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Ukraine-Russia Peace";
    string private _symbol = "Ukraine-Russia Peace";
    ...
    address payable public marketingWalletAddress = payable(0x966816956C2A505945056713bD01358C31EbB1f1); // Marketing Address
    address payable public teamWalletAddress = payable(0x966816956C2A505945056713bD01358C31EbB1f1); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x966816956C2A505945056713bD01358C31EbB1f1),
            block.timestamp
        );
    }
