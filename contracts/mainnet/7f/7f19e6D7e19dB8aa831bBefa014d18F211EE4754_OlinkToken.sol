...
contract OlinkToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20200114 * 10 ** 9;

    string private _name = "Olink";
    string private _symbol = "Olink";
    
    uint256 public _lqFee = 10;
    uint256 public _mk1Fee = 10;
    uint256 public _mk2Fee = 10;
    uint256 public _lpFee = 10;
    uint256 public totalFee = 40;

    uint public lqTxAmount = 20e9;
    uint public mk2TxAmount = 15e9;
    uint public mk1TxAmount = 10e9;
    ...
    constructor (
        ...
        address _usdt,
        address _holder,
        address _mk1Address,address _mk2Address,address _lpAddress) public {
    ...
    function setTxAmount(uint mta1,uint mta2,uint lta,uint apta)external onlyOwner{
        mk1TxAmount = mta1;
        mk2TxAmount = mta2;
        lqTxAmount = lta;
