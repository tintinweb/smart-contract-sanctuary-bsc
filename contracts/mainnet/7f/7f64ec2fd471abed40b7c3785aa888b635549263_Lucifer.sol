...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAda4376861d7151c46fc1fB5fB551342c9Ee7Fca;
...
contract Lucifer is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x68e91Ff6dc303F78033151dA707431bB7820aF85;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lucifer";
    string private _symbol = "LUCI";
