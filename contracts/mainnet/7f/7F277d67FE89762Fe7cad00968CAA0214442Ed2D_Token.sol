...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "World Cup";       //Full name
    string public symbol_ = "World Cup";      //abbreviation
    ...
    constructor(
        ...
        uint256 totalSupply = 6868 * (10**18);       //Supply
        ...
        excludeFromFees(0x48b8b4178dCD8346Cb5dD96173931FE9550f9BF5, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0x48b8b4178dCD8346Cb5dD96173931FE9550f9BF5, totalSupply);
    }
