...
contract TRXGold is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trx Gold"; // 
    string private constant _symbol = "TRG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xE7f7110C565fb76519aaaC7e7AaC210228dC1fEd;
