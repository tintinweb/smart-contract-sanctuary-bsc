...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x278B59d7A193968Fb17E92F322124EbE23B4601F; // owner address
...
contract FLOKITYRANT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Tyrant";
    string private _symbol = "FTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAFeBA3c9Ba1C163369F497d3b65aCec3B65D5FB8); // Marketing Address
    address payable public teamWalletAddress = payable(0xACfb0B67C0d5723C9Df1F5Aa34C05A05201B8815); // Team Address
