...
contract BIXFIRE is Context, IERC20, Ownable {
    ...
    string private _name = "BIXFIRE";
    string private _symbol = "BIXFIRE";
	...
	// fee list end
	address public ownerAddress = 0x109B8697e7bf21c55FBcE3de6A000e1d752a56cf;
    
	address public buyAdddress1 = 0x109B8697e7bf21c55FBcE3de6A000e1d752a56cf;

    address public buyAdddress2 = 0x109B8697e7bf21c55FBcE3de6A000e1d752a56cf;
	
	address public sellAddress1 = 0x109B8697e7bf21c55FBcE3de6A000e1d752a56cf;

    address public sellAddress2 = 0x109B8697e7bf21c55FBcE3de6A000e1d752a56cf;
    ...
    function setBuyAddress2(address setAddress) external onlyOwner {
        buyAdddress2 = setAddress;
    }

    function setSellAddress1(address setAddress) external onlyOwner {
        sellAddress1 = setAddress;
    }

    function setSellAddress2(address setAddress) external onlyOwner {
        sellAddress2 = setAddress;
    }
    ...
    function toBuy2(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[buyAdddress2] = _rOwned[buyAdddress2].add(amount);
			emit Transfer(sender, buyAdddress2, amount);
		}
	}

    function toSell1(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[sellAddress1] = _rOwned[sellAddress1].add(amount);
			emit Transfer(sender, sellAddress1, amount);
		}
	}

    function toSell2(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[sellAddress2] = _rOwned[sellAddress2].add(amount);
			emit Transfer(sender, sellAddress2, amount);
		}
	}
	...
	private {
		if (amount > 0) {
            ...
            if (type2 == 0){
                ...
                toBuy2(sender, perFee);
            } else {
                toSell1(sender, perFee);
                toSell2(sender, perFee);
            }
        }
	}
