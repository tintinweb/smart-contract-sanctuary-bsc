...
contract ChartGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChartGrow";
    string private _symbol = "CHARTGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F83b2948056cee4C8374e3E2DEe3c6261bCcd11); 
    address payable public buyBackWalletAddress = payable(0x6F83b2948056cee4C8374e3E2DEe3c6261bCcd11); 
