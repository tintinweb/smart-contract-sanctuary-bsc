...
contract TSTToken is IERC20, Ownable {
    ...
    address private lottery = 0x5598A99935e1D36FD758D42DfCb0f0563EE62ea6;       
    address private whiteList = 0xaA989E8671F412B78bE2376d6Ef8Dd788dE2E1Bf;     
    ...
    constructor() {
        ...
        .createPair(address(this), 0x806E523c79e08fFc6e34bDB8cE7EC3547c56B4A0);

        address fund = 0x3E59Ec88Db095538AdEDC9137BBDe54d440AAfeE;
    ...
    function setPairAddr(address tstPairAddr_) external onlyOwner {
    ...
    function setWhiteListAddr(address addr_) external onlyOwner{
        whiteList = addr_;
    }

    function setWhitelistSwitch(bool switch_) external onlyOwner{
        whitelistSwitch = switch_;
    }

    function excludeFeeSwitch(address[] calldata accounts, bool _switch) public onlyOwner {
    ...
    function setfeeOn(bool flag_) external onlyOwner {
        feeOn = flag_;
    }
