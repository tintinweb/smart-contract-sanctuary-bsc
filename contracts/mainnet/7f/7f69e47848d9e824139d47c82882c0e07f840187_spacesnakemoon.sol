...
contract spacesnakemoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "spacesnakemoon"; // 
    string private constant _symbol = "$spacesnakemoon"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x9424c04b21F7d8553551Ab8715fCe5A4C2e0cba9;
