...
//website under development www.shibamiku.com
...
contract ShibaMiku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Miku"; // 
    string private constant _symbol = "Shimiku"; //    
