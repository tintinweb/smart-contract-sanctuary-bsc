...
contract GTP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x5295A0EcFc2b512Ed6d3beD65255F793f81B1d21); 
    address payable public developmentAddress = payable(0x5295A0EcFc2b512Ed6d3beD65255F793f81B1d21); 
    address payable public charityAddress = payable(0x5295A0EcFc2b512Ed6d3beD65255F793f81B1d21); 
    address payable public vaultRewardAddress = payable(0x5295A0EcFc2b512Ed6d3beD65255F793f81B1d21); 
    address payable public liquidityWallet = payable(0x5295A0EcFc2b512Ed6d3beD65255F793f81B1d21); 
    ...
    uint256 private constant _tTotal = 100000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "GT-Protocol";
    ...
    uint256 public _bMaxTxAmount = 100000000  * 10**2;
    uint256 public _sMaxTxAmount = 100000000  * 10**2;
    uint256 private _trigger = 100000000  * 10**2;
    uint256 private minimumTokensBeforeSwap = 5000  * 10**2; 
    uint256 public buyBackSellLimit = 1 * 10**10;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 100000000 * 10**2; // 1000000
        _sMaxTxAmount = 100000000 * 10**2;
    }
