...
contract Pool  is Ownable {
    ...
    function checkThreshold(address _checkAddress) public view returns (bool) {
        ...
        returns(uint256)
    {
        return lastAddUpReward[_address] +
          ((getRewardPerShare() - lastAddUpRewardPerShare[_address]) * shares[_address]);
    }
    ...
    {
        return lastAddUpReward[_address] +  
            ((getRewardPerShare() - lastAddUpRewardPerShare[_address]) * shares[_address]) - withdrawdReward[_address];
    }
