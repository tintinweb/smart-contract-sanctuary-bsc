...
contract Takiyasha is IBEP20, Ownable {
    ...
    string constant _name = "Takiyasha the Witch";
    string constant _symbol = "TAKIYASHA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //100% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 5) / 100;  //100% max wallet
    ...
    address public marketingFeeReceiver = 0x88824631B54A63bcAF1C3B730b73EA469E481c38;
