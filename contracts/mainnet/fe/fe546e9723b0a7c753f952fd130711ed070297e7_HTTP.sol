...
contract HTTP is Context, IERC20, Ownable {
    ...
    string private _name = "http token";
    string private _symbol = "HTTP";
    ...
    address public mainAddres = address(0x9f2adBcE3363b288B5AaE94c137E17545558545B);
    address public marketAddress = address(0x87079BFfA82579ac196569B7E760b1d96B9cc3f9);
    address public fundAddress = address(0x4a74860b8be64B33054EbE93d177FD8AC12b0B60);
    address public liquidAddress = address(0x72901873aaf14FbbacdC7D245281E64A66EeE961);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 87700000000 * 10 ** 18 
        ...
        _takeLiquidity(sender, tElseFee / 4); // 3%
        _takeBurn(sender, tElseFee / 12);      // 1%
