...
contract shibbt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "shibbt";
    string private _symbol = "shibbt";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B024137308F8949129182d51F9A168Cf6649c95);
    address payable public teamWalletAddress = payable(0x99692255C9d5947046380396813DC3d2D1C98952);
