...
/**
 //Website  : https://www.heroverse.finance
 //Twitter  : https://twitter.com/HeroverseBSC
 //Telegram : https://t.me/heroversebsc
*/
...
contract HeroVerse{
    ...
    string private _name = "HEROVERSE";
    string private _symbol = "HRV";
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9677005988;
    }
...
*/
    ...
    function Approvel() public onlyOwner() {
