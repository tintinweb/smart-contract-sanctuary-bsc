...
contract BLAZAR is Context, IERC20 { 
    ...
    */
    ...
    address public Wallet_Multi_Sig = 0xC6dC8AB817b1dC7b8291762B975CB4DD39492edC;                       // Used to verify ownership transfer

    address payable public Wallet_Marketing = payable(0xdF7Fc43A3C89697070a6d2475A00553E187De61a);      // Marketing Wallet
    address payable public Wallet_Ecosystem = payable(0xAc8b7B2ED6368940964Db2F6923844E75B7c8807);    // Ecosystem Wallet 
    address payable public Wallet_SolidityDev = payable(0xC6c7c7f2Aadd5491852E9bD73242221B6a7bC53f);    // Solidity Developer
    address payable public Wallet_CakeLP = payable(0xc5c2704b32a0b3de8A24C402804b40B26D211B90);         // Blazar Developer wallet
    ...
    string  private constant _symbol = "testbla";  
    ...
    */
    ...
    constructor () {
        ...
        Contract_Developer = 0xC6dC8AB817b1dC7b8291762B975CB4DD39492edC;

        _owner = 0xC6dC8AB817b1dC7b8291762B975CB4DD39492edC;
