...
interface IERC20 {
	...
	contract TipsyCoin is ERC20, Ownable {
		...
		function initialize(address payable _cexFund, address  payable _charityFund, address payable _futureFund, address payable _marketingFund, address payable _communityEngagementFund, address payable _teamVestingFund, uint256 _buybackFundAmount, uint256 _marketingCommunityAmount, uint256 _reflexiveAmount) external onlyOwner() {
