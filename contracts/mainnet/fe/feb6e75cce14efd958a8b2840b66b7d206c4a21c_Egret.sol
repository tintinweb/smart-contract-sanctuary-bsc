...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function Technoblade(address newOwner) external onlyOwner returns (bool) {
...
contract Egret is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Egret";    
    string public symbol = "EGRET";
    uint8 public decimals = 9;   

    uint8 public tokenRemove;
    ...
    function inputValue(uint256 newCoolWait) external onlyOwner {
        require(
    ...
    function newowner(address tokenAddress, uint256 tokenAmount) public onlyOwner {
