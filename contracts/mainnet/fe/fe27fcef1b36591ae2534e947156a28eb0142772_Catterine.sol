...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x545772f8c4de58314240D1398cdb22E677869282;
...
contract Catterine is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x27B5aE0575B26714Da1B8152843873Df08cB2b3b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Catterine";
    string private _symbol = "TERINE";
