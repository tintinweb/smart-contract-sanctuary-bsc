...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  function distributeAPEDividends(uint256 amount) public onlyOwner{
...
contract BabyApeDividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public override {
        require(false, "BabyApe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SolanaDao contract.");
    }
...
pragma solidity ^0.6.12;
contract BTCSIR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _DevWalletAddress = 0x9cD940325BB0B5Df20E066882aB9B18d12f8d5e8;
    address public _FoudWalletAddress = 0x7056a8d91b31F8dC80670ac2bFA36B6A911BFe74;
    ...
    uint256 public APERewardsFee = 10;
    uint256 public APERewardsShare = 5;
    ...
    // lockWallet
    address public _AppWalletAddress = 0x372d012030F40636f0aAaCEEf0FD23555dc30a71;
    address public _CrossWalletAddress = 0xa4b30C05a8482a1DA077343b336dED1141581Cc5;
    ...
    constructor() public ERC20("BTCSIR", "BTCSIR") {
    ...
    function setFee(
        uint256 _APERewardsFee,
        uint256 _APERewardsShare
    ) public onlyOwner {
        APERewardsFee = _APERewardsFee;
        APERewardsShare = _APERewardsShare;
    }
    ...
    function _transfer(
        ...
        if(liquidityLaunched && block.number <= lastSnipeTaxBlock && !isFirstLaunch){
            uint256 fees = amount.mul(APERewardsFee).div(100);
        ...
        if( canSwap &&
            ...
            uint256 BNBAmountForReward = BNBAmount.mul(APERewardsShare).div(APERewardsFee);
    ...
    function swapBNBForAPE(uint256 tokenAmount) private {
