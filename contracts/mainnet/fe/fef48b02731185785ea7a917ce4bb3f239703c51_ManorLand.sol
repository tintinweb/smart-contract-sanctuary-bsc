...
Last Update
Feb 7, 2023
True Ownership for Players Gaming3 Ecosystem
Developing a gaming ecosystem through innovative Web3 experiences, quality gameplay, high-end design, 
purposeful storytelling and financial incentives. All backed by a strong and sustainable play and own model. 
Incubated by Ubisoft and developed on Unreal Engine 5.

https://t.me/manorland                                                   
 */
...
contract ManorLand  is Contextbep20, bep20, Ownablebep20 {
    ...
    uint256 private constant _allTotalSupply = 2300000000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'ManorLand';
    string private _symbol = 'ManorLand';
