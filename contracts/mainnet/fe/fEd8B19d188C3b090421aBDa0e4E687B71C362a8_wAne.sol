...
contract wAne is IBEP20, Auth {
    ...
    string constant _name = "Wrapped jAne";
    string constant _symbol = "wAne";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 22495 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1170a2a0Aa784321496913718F08F3DF0A6a87CA;
