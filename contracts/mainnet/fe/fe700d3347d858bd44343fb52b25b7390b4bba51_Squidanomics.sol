...
/*
   ...
   _____  ____  _    _ _____ _____          _   _  ____  __  __ _____ _____  _____   ___    ___  
  / ____|/ __ \| |  | |_   _|  __ \   /\   | \ | |/ __ \|  \/  |_   _/ ____|/ ____| |__ \  / _ \ 
 | (___ | |  | | |  | | | | | |  | | /  \  |  \| | |  | | \  / | | || |    | (___      ) || | | |
  \___ \| |  | | |  | | | | | |  | |/ /\ \ | . ` | |  | | |\/| | | || |     \___ \    / / | | | |
  ____) | |__| | |__| |_| |_| |__| / ____ \| |\  | |__| | |  | |_| || |____ ____) |  / /_ | |_| |
 |_____/ \___\_\\____/|_____|_____/_/    \_\_| \_|\____/|_|  |_|_____\_____|_____/  |____(_)___/ 
...
/* Token contract */
contract Squidanomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x883e9F4827E89ee2fE7D7a9EFba1418B0A2e54D7;
    ...
    // Name and symbol
    string constant _name = "Squidanomics 2.0";
    string constant _symbol = "SQUID2";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 426000000 * (10 ** _decimals); // 1m 
