...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf4b525A3270F92c545286915652388789a1f0fAd; // owner address
...
contract RunningShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RunningShib";
    string private _symbol = "RunningShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4b525A3270F92c545286915652388789a1f0fAd); // 
    address payable public teamWalletAddress = payable(0xf4b525A3270F92c545286915652388789a1f0fAd); // 
