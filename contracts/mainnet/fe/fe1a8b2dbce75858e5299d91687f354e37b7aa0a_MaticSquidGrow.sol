...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);
...
/* Token contract */
contract MaticSquidGrow is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC = 0xCC42724C6683B7E57334c4E856f4c9965ED682bD; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5719F134c08a2148370892E580dd35AdDa3Ed335;
    ...
    // Name and symbol
    string constant _name = "Matic Squid Grow";
    string constant _symbol = "MaticSquid";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000000; // 2% 
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000000; // 0.25%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x5719F134c08a2148370892E580dd35AdDa3Ed335;
