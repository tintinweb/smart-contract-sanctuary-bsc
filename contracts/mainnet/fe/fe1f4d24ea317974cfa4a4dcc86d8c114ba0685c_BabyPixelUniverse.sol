...
// Telegram: https://t.me/BPU_Portal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1A128f7B095b360A682C7e6921F3fcE5c25072D2); //Pixel Universe
...
contract BabyPixelUniverse is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Pixel Universe";
    string constant _symbol = "BPU";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x1A128f7B095b360A682C7e6921F3fcE5c25072D2; // Pixel Universe
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5f7668AF4d6f3cC01F2Ff12A7912fE4cD1C21534; 
        devWallet = 0xDe3E380B808FDB89F3565383ff0eBDeBeB49d5C3; 
