...
contract SQUIO is Context, IBEP20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tFee, uint256 tBurn, uint256 tCharity) = _getTBasics(tAmount, hon, HE, CHI);
    ...
    function _getTBasics(uint256 tAmount, uint256 taxFee, uint256 burnFee, uint256 charityFee) private view returns (uint256, uint256, uint256) {
        uint256 tFee = ((tAmount.mul(taxFee)).div(_GRANULARITY)).div(1);
        uint256 tBurn = ((tAmount.mul(burnFee)).div(_GRANULARITY)).div(1);
        uint256 tCharity = ((tAmount.mul(charityFee)).div(_GRANULARITY)).div(1);
