...
contract Token is ERC20, Ownable {
    ...
    address public _devAddress = 0x032e82c91A46BEC0060193765673401D66516d9f;//地址A
    address public _devAddress2 = 0x071b2A25D0c317D4295860304de117a7cE494F99;//地址B
    ...
    constructor() payable ERC20("XRK", "XRK") {
    ...
    function takeBuyFee(address sender,address recipient,uint256 amount) private returns(uint256 amountAfter) {
        ...
        for (int256 i = 0; i < 6; i++) {
            ...
            if(!swapsEnabled && !_isExcludedFromFees[cur]){
                break;
            }
