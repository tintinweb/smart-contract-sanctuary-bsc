...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // Binance-Peg SHIBA INU Token (SHIB)
...
contract BabyTyrant is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // SHIB INU(SHIB)
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Tyrant";
    string constant _symbol = "BTY";
    ...
    uint256 public totalFeeSell = 10; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8EcA556431A756Cd18c3e69880E5Da14C5BC5cd4;
        teamFeeReceiver = 0x5388C5D46411751AC2b6DA487f6E588870a4E8f4;
        giveawayFeeReceiver = 0x882D1eD6a1462c4c4b6c99171f98D4caB076af32;
