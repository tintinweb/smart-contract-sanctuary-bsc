...
contract MiniTennisOfficial is ERC20, Ownable, SafeToken {
    ...
    function setFee(uint256 _liquidityFee, uint256 _TeamFee) public onlyOwner {
        liquidityFee = _liquidityFee;
        TeamFee = _TeamFee;

        totalFees = liquidityFee.add(TeamFee); // total fee transfer and buy
    }
    ...
    constructor() ERC20("MiniTennisOfficial", "MTO") {
        liquidityFee = 1;
        TeamFee = 2;
        ...
        TeamWallet = payable(0x09B9f0E373E2dA0739ba39903A434CDdE8b29e62);
