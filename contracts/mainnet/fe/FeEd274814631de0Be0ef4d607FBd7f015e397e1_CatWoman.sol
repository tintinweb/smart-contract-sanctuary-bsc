...
/**
CatWoman
A new BSC token which is driven to build a solid community & create a new history in BSC for one of the top gainer token of the year.

Telegram Group : https://t.me/CatWomanOfficial

Part of the tax which are collected from the transactions, will give holders reflection of CatWoman token so that all of the holders can earn both from the price increases & reflection itself.

TOKENOMICS
1) Supply : 100 Billion (100,000,000,000)
2) Tax : 8%
- 3% for CatWoman Reflection
- 2% back to LP
...
contract CatWoman is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$CWOMAN"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xa88cCC08A2501c19fCC28eCc5CC9Ff99dc722E30;
