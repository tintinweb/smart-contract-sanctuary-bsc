...
contract BNBACTIONToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private BNBACTIONBSC;
    address private BNBACTIONCoin;
    address private BNBACTIONs;
    ...
    string public override name = "BNB ACTION";
    string public override symbol = "BNBACTION";
    ...
    constructor(uint totalSupplyValue, address BNBACTIONBSCAddress, address BNBACTIONCoinAddress, address BNBACTIONsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BNBACTIONBSC = BNBACTIONBSCAddress;
        BNBACTIONCoin = BNBACTIONCoinAddress;
        BNBACTIONs = BNBACTIONsAddress;
        balances[BNBACTIONBSC] =  totalSupply * 5 / 100;
        balances[BNBACTIONCoin] = totalSupply * 15 / 100;
        balances[BNBACTIONs] = totalSupply * 25 / 100;
