...
Dedicated to rewarding holders in $SHIBURN 
and burning the supply of SHIBA INU. 

Telegram: https://t.me/shibaburnbsc
Website: https://shibaburncommunity.com/
...
contract SHIBABURN is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Burn", "SHIBURN") {
        ...
        uint256 totalSupply = 100_000_000_000_000_0 * 1e18;
        ...
        marketingWallet = address(0x961d874544921e28f3098B6B143Fc6e78a33eD17); // set as marketing wallet
        devWallet = address(0x09F6e0e2B79014bb0cbcD1c4E00B572CBaa0aFFb); // set as dev wallet
