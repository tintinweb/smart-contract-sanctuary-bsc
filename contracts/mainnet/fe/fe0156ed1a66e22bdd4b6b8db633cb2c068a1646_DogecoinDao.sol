...
contract DogecoinDao is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0xaA092777Bc046cdA09DF9527B7A9c5204b9002c1;
    address public receiveSellFeeWallet = 0x6bFa376C57c8BBBe553E25138F01345EAb24D50E;
    IWrap public wrap = IWrap(0xF931b644666142eb3aE72687e315CBE910BD4E56);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Dogecoin Dao", "DOGEDAO", 18, 10000 * 10 ** 18){
        address msgSender = _msgSender();
