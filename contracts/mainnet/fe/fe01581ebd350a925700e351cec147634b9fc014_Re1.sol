...
contract Re1 {
    ...
    uint256 private EGGS_TO_HATCH_1MINERS = 664500;
    ...
    function hatchDevils(address ref) public {
        require(initialized);
        if(ref == msg.sender) {
            ref = address(0);
        }
    ...
    function buyDevils(address ref) public payable {
        require(initialized);
