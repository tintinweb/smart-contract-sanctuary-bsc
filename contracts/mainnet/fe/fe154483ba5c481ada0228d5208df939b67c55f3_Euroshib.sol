...
contract Euroshib is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10_000_000_000 * 10**0;
    uint256 public _maxTxAmount = 10_000_000_000 * 10**0; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100 * 10**0; //
    string private constant _name = "Euro Shib"; // 
    string private constant _symbol = "EUROSHIB"; //    
    uint8 private constant _decimals = 0; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x2CC6a55BCB7BD22DffDFbDF6f01d8324Edc50Fd5;
