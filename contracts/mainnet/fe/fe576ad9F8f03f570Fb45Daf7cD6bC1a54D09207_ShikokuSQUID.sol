...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1bB6E39beBeC4b5F58C0c2d3bfcE283e5fB4FB21; // owner address
...
contract ShikokuSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikoku Squid";
    string private _symbol = "SS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1bB6E39beBeC4b5F58C0c2d3bfcE283e5fB4FB21); // Marketing Address
    address payable private teamWalletAddress = payable(0x1bB6E39beBeC4b5F58C0c2d3bfcE283e5fB4FB21); // Team Address
