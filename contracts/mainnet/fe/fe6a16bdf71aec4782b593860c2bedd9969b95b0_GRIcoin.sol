...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x8f1597d17a87543B94d47408528Af63a7B2A591f;
    }
}
...
contract GRIcoin is Context, IBEP20, Ownable {
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        _investingWallet = 0x37519d811b739Cc80e009b8d36CDA6D4fcC069c6;
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee <= 14, "Liquidity Fee cannot exceed 14%");
