...
contract ViewV3 is IView, Ownable
{
    ...
    constructor(
        ...
        address supply, address teamAdr, address firstLineAdr)
    {
        ...
        team = ITeam(teamAdr);
        firstLine = IReferalFirstLine(firstLineAdr);
    }
