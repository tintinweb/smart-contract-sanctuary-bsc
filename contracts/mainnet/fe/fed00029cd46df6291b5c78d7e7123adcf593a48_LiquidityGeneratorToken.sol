...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    constructor () {        
        ...
        _balances[address(this)] = _sTotal;
    ...
    function isExcludedFromFee(address account, bool newValue) public onlyOwner {
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = amount >= minimumTokensBeforeSwap;
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            to==uniswapV2Pair &&
