...
TG: https://t.me/newcommunityalvey
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd6A1888AF0B65E70f54B8F56b78B09AdC4745a5d; // owner address
...
contract NewCommunityAlvey is Context, IERC20, Ownable {
    ...
    string private _symbol = "NewAlvey";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b13F19BD6eE964bcbB4580DF41b6B12b9Db5c5e); // Marketing Address
    address payable public teamWalletAddress = payable(0xd6A1888AF0B65E70f54B8F56b78B09AdC4745a5d); // Team Address
