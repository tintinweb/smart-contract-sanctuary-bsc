...
contract BlueWolf is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x8809203C3c6b8C541f926f2523a1CE8D84cdB570); // Marketing Address
        
    address payable public teamAddress =
        payable(0xABa6896f8776e8dB9Baa7ec32eD57024C8Dd592A); // Team Address
        
    address payable public liquidityAddress =
        payable(0xABa6896f8776e8dB9Baa7ec32eD57024C8Dd592A); // Liquidity Address
    ...
    string private constant _name = "Blue Wolf Protocol";
    string private constant _symbol = "BLUEWOLF";
