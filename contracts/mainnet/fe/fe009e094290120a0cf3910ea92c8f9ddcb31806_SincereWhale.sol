...
contract  SincereWhale is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereWhale";
    string private _symbol = "SWhale";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEB24D3fb937A8379AEc6f9F8b48284f9BfB87174);
    address payable public teamWalletAddress = payable(0xEB24D3fb937A8379AEc6f9F8b48284f9BfB87174);
