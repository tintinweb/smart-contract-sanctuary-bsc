...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbdCDaF9824605651F2D303c93a0dA5fc18AB2921; // owner address
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "143";
    string private _symbol = "143";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbdCDaF9824605651F2D303c93a0dA5fc18AB2921); // 
    address payable public teamWalletAddress = payable(0xbdCDaF9824605651F2D303c93a0dA5fc18AB2921); // 
    ...
    uint256 private _totalSupply = 1430 * 10**_decimals;
