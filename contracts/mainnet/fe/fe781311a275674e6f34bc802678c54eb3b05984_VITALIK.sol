...
The merge will happen when a Terminal Total Difficulty (TTD)* of  58750000000000000000000 is reached. Lets celebrate with Vitalik!
...
contract VITALIK is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Vitalik";
    string private _symbol = unicode"MERGE";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x9b96Ad783f7260C30b7B06f8f416632775Ba2f38); 
    address payable public BurnedWalletAddress = payable(0x9b96Ad783f7260C30b7B06f8f416632775Ba2f38); 
