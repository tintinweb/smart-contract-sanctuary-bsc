...
/**
 * EverSAFUv2 Protocol = ES2  is a Dual Reward system combining the power
 * BUSD Dividen reward and a positive rebase reward of $ES2 with Auto-Staking and Auto-Compounding
 *
 * Website : https://eversafuv2.com/
 * Twitter : https://mobile.twitter.com/EversafuV2
 * Telegram : https://t.me/EverSAFU_V2_OFFICIAL
 */
...
contract EverSAFUv2 is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EverSAFUv2", "ES2", uint8(DECIMALS)) Ownable() {
