...
contract VestingPlaytoEarn {
    ...
    uint256 constant public totalAmount =  40_000_000* 10**18;
    uint256 constant public amountPerMonth =  1_000_000* 10**18;
    uint256 constant public lastMonthAmount =  1_000_000* 10**18;
    ...
    function initWithdrawTime() internal {
        //2022
        ecoSystemAndRewardInfo memory apr22infor = ecoSystemAndRewardInfo(1648771200,amountPerMonth,true);//01/04/2022
        ecoSystemAndRewardInfo memory may22infor = ecoSystemAndRewardInfo(1651363200,amountPerMonth,false);//01/05/2022
        ecoSystemAndRewardInfo memory jun22infor = ecoSystemAndRewardInfo(1654041600,amountPerMonth,false);//01/06/2022
        ecoSystemAndRewardInfo memory jul22infor = ecoSystemAndRewardInfo(1656633600,amountPerMonth,false);//01/07/2022
        ecoSystemAndRewardInfo memory aug22infor = ecoSystemAndRewardInfo(1659312000,amountPerMonth,false);//01/08/2022
        ecoSystemAndRewardInfo memory sep22infor = ecoSystemAndRewardInfo(1661990400,amountPerMonth,false);//01/09/2022
        ecoSystemAndRewardInfo memory oct22infor = ecoSystemAndRewardInfo(1664582400,amountPerMonth,false);//01/10/2022
        ecoSystemAndRewardInfo memory nov22infor = ecoSystemAndRewardInfo(1667260800,amountPerMonth,false);//01/11/2022
        ecoSystemAndRewardInfo memory dec22infor = ecoSystemAndRewardInfo(1669852800,amountPerMonth,false);//01/12/2022
        //2022
        ...
        // 2023
        ecoSystemAndRewardInfo memory jan23infor = ecoSystemAndRewardInfo(1672531200,amountPerMonth,false);//01/01/2023
        ecoSystemAndRewardInfo memory feb23infor = ecoSystemAndRewardInfo(1675209600,amountPerMonth,false);//01/02/2023
        ecoSystemAndRewardInfo memory mar23infor = ecoSystemAndRewardInfo(1677628800,amountPerMonth,false);//01/03/2023
        ecoSystemAndRewardInfo memory apr23infor = ecoSystemAndRewardInfo(1680307200,amountPerMonth,false);//01/04/2023
