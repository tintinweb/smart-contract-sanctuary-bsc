...
contract SFMXMAS is Context, IERC20, Ownable {
    ...
    address payable private TeamWallet = payable(0xcA21aEf1e8669cB776B82f1A06262109a1Bc6e2f); // Buy Back Address
    ...
    uint256 public _maxTxAmount = _totalSupply.div(31); 
    uint256 public _walletMax = _totalSupply.div(31);
