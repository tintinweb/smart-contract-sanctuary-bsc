...
contract HAKIINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HAKI INU";
    string private _symbol = "HAKI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x9352D797DbF5F2aFeE435b1e1CD3f0fcd1E9f726);
