...
contract McBirdie is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x616b000db11a344d199Dc1fdFe0d34de5Ed17532); // Marketing Address

    address payable public teamAddress =
        payable(0xcEA540A826Af114f54c5D4295Aec33a664c9E16B); // Team Address

    address payable public liquidityAddress =
        payable(0x616b000db11a344d199Dc1fdFe0d34de5Ed17532); // Liquidity Address
    ...
    string private constant _name = "McBirdie";
