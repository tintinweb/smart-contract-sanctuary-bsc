...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7159068B01D0d89E0eC237236F874175B5b43945;
...
contract AILunaTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AILuna 2.0";
    string private _symbol = "AILuna";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x449bd4F00174906681e345Cd86ec6f27C1892243);
    address payable public teamWalletAddress = payable(0x449bd4F00174906681e345Cd86ec6f27C1892243);
