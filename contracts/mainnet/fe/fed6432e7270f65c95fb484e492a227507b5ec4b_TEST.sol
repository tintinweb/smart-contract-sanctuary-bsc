...
contract TEST  is IBEP20, Auth {
    ...
    address DEV = 0xEF4c2087F1C8c33aE976A13Cc5E844ACF1dDE02D;
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xEF4c2087F1C8c33aE976A13Cc5E844ACF1dDE02D;
