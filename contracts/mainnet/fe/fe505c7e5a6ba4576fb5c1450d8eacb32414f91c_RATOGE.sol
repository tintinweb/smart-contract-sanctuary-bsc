...
📣 TG: https://t.me/Ratoge_BSC

8% Buy Tax | 10% Sell Tax

✨RATOGE is the latest game changer in the world of Meme tokens in the BSC chain✨
Going with the rat trend we combine the powerful persona's of the RAT and DOGE to make RATOGE.

Supply: 1,000,000,000 
Max Buy: 3% - 30,000,000 / 30000000
Max Sell: 3% - 30,000,000 / 30000000
Max Wallet: 3% - 30,000,000 / 30000000

SELL TAX WILL BE HIGHER ON LAUNCH AND WILL REDUCE WITHIN 5 MINUTES.
...
contract RATOGE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'RATOGE';
    ...
    address public Marketing=payable(0xEb27Ae50Fe06196c009443A6F09bBfE2b7ab5876);
    address public Development=payable(0xEb27Ae50Fe06196c009443A6F09bBfE2b7ab5876);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==Development;
    }
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*4)/5);
        payable(Development).transfer((amount*1)/5);
    } 
