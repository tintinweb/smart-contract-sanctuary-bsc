...
// THE ONE AND ONLY OFFICIAL CA OF SNAKESLAYER !
// Wait for LOCK and follow our Channel ! JOIN GROUP WILL BE OPEN ONCE WE START THE MARKETING
...
contract SSlayer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public Owner=0xFE62480Be4eb7ABCa7e0D0A203B622AB6e3b42C6; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xFE62480Be4eb7ABCa7e0D0A203B622AB6e3b42C6;
