...
contract  GustavsEliteClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gustav's Elite Club";
    string private _symbol = "GEC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47dF89C2F5b8677bf2825Dad1b1F9429Ab459e0E); 
    address payable public teamWalletAddress = payable(0x7819138421B141d6d57463BE8c8390330EFd7374); 
