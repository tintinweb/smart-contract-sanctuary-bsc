...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf27079E647028E22BACb0089Ca68541C2Eb9caae;
...
contract Bittorent is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x390F8124a65acBD9995f6374C7adc74a925BBA4a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bittorent 2.0";
    string private _symbol = "BTTWO";
