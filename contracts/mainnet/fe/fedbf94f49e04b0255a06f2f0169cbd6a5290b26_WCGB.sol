...
contract WCGB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x1435de84BD1dB12C1B4Fc1E4b2a69f0E8504563f); // Marketing Address
    ...
    uint256 private _tTotal = 200 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WCGB";
    string private _symbol = "WCGB";
