...
contract Lychee is Ownable, SpacemanLOLMetaData {
	...
	uint256 private _tokenSupply = 100000 * 10**6 * 10**18;
	/**
	 ...
	 */
	uint256 public maxTxAmount = 5000000 * 10**6 * 10**18;

	/**
	 *@dev Number of tokens needed to provide liquidity to the pool
	 */
	uint256 private _numberTokensSellToAddToLiquidity = 500000 * 10**6 * 10**18;
