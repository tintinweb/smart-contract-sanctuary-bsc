...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48B42e7d903349C34c3bA8B3D04D0cd1701C4dbe;
...
contract DogeBro is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Bro";
    string private _symbol = "DOGE BRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48B42e7d903349C34c3bA8B3D04D0cd1701C4dbe);
    address payable public teamWalletAddress = payable(0x48B42e7d903349C34c3bA8B3D04D0cd1701C4dbe);
