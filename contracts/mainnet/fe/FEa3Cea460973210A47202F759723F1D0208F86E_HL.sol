...
abstract contract AbsToken is IERC20, Ownable {
	...
	modifier onlyOperator() {
        require(operatorsList[msg.sender], 'PancakeSwap: caller is not the operator');
        _;
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xB98EC5928Ae244e717DB686E4576606799CEe155;
    ...
    function setFundAddress(address addr) external onlyOperator {
        fundAddress = addr;
    ...
    function setFeeWhiteList(address addr, bool enable) external onlyOperator {
    ...
    function setSwapPairList(address addr, bool enable) external onlyOperator {
    ...
    function setHolderRewardCondition(uint256 amount) external onlyOperator {
        holderRewardCondition = amount;
    }

    function setExcludeHolder(address addr, bool enable) external onlyOperator {
        excludeHolder[addr] = enable;
    }
}

contract HL is AbsToken {
    constructor() AbsToken(
        ...
        address(0x37C1ae57c7B103C43e4d5Da83BFD9883650F3a0F),
    
        address(0xd1AeE154151b3e15EcCBA7c488D0214B7cF320CE),

        address(0xB98EC5928Ae244e717DB686E4576606799CEe155)
    ){
