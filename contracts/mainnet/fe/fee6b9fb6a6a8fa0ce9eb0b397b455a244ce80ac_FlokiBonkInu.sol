...
contract FlokiBonkInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Bonk Inu";
    ...
    address public Owner=0x69C98aE2ba4C946246C8ad8f50477e4eA13DbF74; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x69C98aE2ba4C946246C8ad8f50477e4eA13DbF74;
