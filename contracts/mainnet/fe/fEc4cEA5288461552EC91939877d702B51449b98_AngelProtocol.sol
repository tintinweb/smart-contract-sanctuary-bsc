...
contract AngelProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xE9D926cC13E15057cFB8fc06f0757628a048e0E1); // Marketing Address
    ...
    string private _name = "Angel Protocol";
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "Angel Protocol: Invalid marketing address");
