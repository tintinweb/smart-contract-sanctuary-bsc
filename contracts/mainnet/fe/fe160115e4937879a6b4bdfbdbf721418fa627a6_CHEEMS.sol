...
Telegram : https://t.me/CheemsBalltze
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C56c1a066229baF44709a5299358B80BEC0fe2e;
...
contract CHEEMS is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHEEMS BALLTZE"; // 
    string private constant _symbol = "$CHEEMS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x4C56c1a066229baF44709a5299358B80BEC0fe2e);
