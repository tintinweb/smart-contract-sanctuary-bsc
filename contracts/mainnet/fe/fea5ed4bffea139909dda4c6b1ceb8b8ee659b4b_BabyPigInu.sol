...
/**
Token with low taxes
3% buy & sell taxes (Marketing)
Telegram: 
*/
...
contract BabyPigInu is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "BabyPigInu";
    string private _symbol = "BABYPIG";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _marketingfee = 3;
    address private _marketingaddress = 0x876933aE2ae9710693edC3192714a922b4efc718;
