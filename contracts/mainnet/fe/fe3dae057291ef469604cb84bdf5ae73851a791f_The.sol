...
contract The is IBEP20, Auth {
    ...
    string constant _name = "TheTyran";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xC6DCDcF631F8688cEc5d79D00C4Ecfb60f8bDEa7;
        marketingFeeReceiver = 0xC6DCDcF631F8688cEc5d79D00C4Ecfb60f8bDEa7;
