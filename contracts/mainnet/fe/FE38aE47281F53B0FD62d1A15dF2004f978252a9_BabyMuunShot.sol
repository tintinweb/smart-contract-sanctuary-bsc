...
contract BabyMuunShot is IBEP20, Auth {
    ...
    string constant _name = "BabyMuunShot";
    string constant _symbol = "BMS";
    ...
    address private marketingFeeReceiver =0x0554065943D615d09FF68C35be79Aa3D3a419a6b;
    address private teamFeeReceiver =0x0554065943D615d09FF68C35be79Aa3D3a419a6b;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 80; // 0.3%
    bool inSwap;
