...
contract RayleighInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x2025737051d1D4C86FaF4a06715C2F9ACE769C43;
    string constant _name = "Rayleigh Inu";
    string constant _symbol = "Rayleigh";
