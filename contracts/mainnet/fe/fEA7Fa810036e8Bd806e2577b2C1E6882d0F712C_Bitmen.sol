...
/**
    Project: Bitmen
    Website: https://www.bbits.art/

    by a14stoner (a14stoner.com)
*/
...
contract Bitmen is ERC721Base, ReentrancyGuard {
    ...
    function mint(uint256 _amount) external payable {
        require(msg.value == cost * _amount, "Value sent does not match price");
    ...
    function pause(bool _state) public onlyOwner {
     ...
     function _mintTo(address _to, uint256 _amount) internal nonReentrant {
