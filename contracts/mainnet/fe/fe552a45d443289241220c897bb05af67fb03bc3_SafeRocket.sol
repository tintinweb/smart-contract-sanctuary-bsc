...
// change "name1" into ur name
    contract SafeRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "SafeRocket";
    string private _symbol = "SAFEROCKET";
    ...
    // change this for total supply (100e8 = 100) (1000000000e8 = 100000000) (dont forget the e8 it has to be there)
    uint256 internal _tokenTotal = 10000000000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0xC9086Ab0035e574E6ED24bb6eECe49e83ff883F9;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
