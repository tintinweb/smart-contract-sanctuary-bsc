...
| $$  | $$| $$  | $$| $$  | $$| $$_____/ /$$/\  $$
| $$$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$  \ $$
|_______/  \______/  \____  $$ \_______/|__/  |__/
                     /$$  \ $$                    
                    |  $$$$$$/                    
                     \______/                     
...
contract DogeXBSC is Context, IERC20, Ownable {
    ...
    address payable private _dogexdev = payable(0x5b867729A87d6DF4D304fEA90ea4577351c053e7);
    
    string private constant _name = "DogeXBSC.com";
    ...
    constructor () {
        ...
        _isExcludedFromFee[_dogexdev] = true;
