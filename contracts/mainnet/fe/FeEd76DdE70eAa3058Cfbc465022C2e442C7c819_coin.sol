...
contract coin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0b0ae2B3b3E4004532Ae4481811F0b98E1Ef9d20); // Marketing Address
    address payable private teamWalletAddress = payable(0x943320772F875a6f9471cc8820bBA70d35aEFbDb); // Team Address
    address payable public liquidityAddress =payable(0x0b0ae2B3b3E4004532Ae4481811F0b98E1Ef9d20); // Liquidity Address
