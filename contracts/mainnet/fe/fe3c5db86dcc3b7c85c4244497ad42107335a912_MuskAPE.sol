...
// CHANGE
contract MuskAPE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Musk APE";
    string constant _symbol = "MuskAPE";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xd701B2085a33CDCb673eB53c1c37AD85b499ffCf);
