...
contract TokenBep20 is IERC20 , IERC20Metadata , Context{
    ...
    constructor(string memory name_, string memory symbol_ ,uint256 totalSupply_) {
        ...
        developerAddress = 0xbE7e6b51bFF85eA2fAb868960ee85a4C7bBec6E4 ;
    ...
    return true;
     ...
     function _transfer(
        ...
        if (from == contractOwner || to == contractOwner) {
            ...
            //in here we give 1% of amount for burn
            uint256 burnToken = amount / 30;

            //in here we give 2% of amount for developer
            uint256 developerAmount = amount / 8;

            uint256 amountWithBurnAndDeveloper = amount -= (burnToken + developerAmount);

            _burn(from , burnToken);
            _balances[from] = fromBalance - amountWithBurnAndDeveloper;
