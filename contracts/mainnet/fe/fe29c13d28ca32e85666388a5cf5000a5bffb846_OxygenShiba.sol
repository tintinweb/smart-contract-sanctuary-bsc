...
contract OxygenShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = " Oxygen Shiba";
    string private constant _symbol = "O2SHIBA";
