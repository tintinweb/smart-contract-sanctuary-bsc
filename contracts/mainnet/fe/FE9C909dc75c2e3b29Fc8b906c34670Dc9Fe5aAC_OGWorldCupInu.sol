...
contract OGWorldCupInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OG World Cup Inu";
    string private constant _symbol = "OGWCI";
