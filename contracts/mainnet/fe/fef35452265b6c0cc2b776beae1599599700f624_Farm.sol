...
//THIS IS A FUCKING BOT FARM IDIOT
...
contract DividendDistributor is IDividendDistributor {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 4 / 100; // 1%
    uint256 public _maxSellTxAmount = _totalSupply * 2 / 100; // 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100; // 1%
    ...
    bool public tradingOpen = true; //set to false as standard. if set to true, trading will be enabled after LP is added
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x57f4aF10aee6d9EFdf1f08d9B8D3dCE0A1903949; //Marketing wallet
        devFeeReceiver = 0x6d298f9359B244750139a1154478A4A2691705a2; //Dev fee
