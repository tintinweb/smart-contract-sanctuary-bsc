...
contract VIB is IERC20, IERC20Metadata {
    ...
    constructor() {
        ...
        _mint(
            address(0x98d212320fc2a00C66752f8a958B05cc09bDe286), 
            20 * 1e4 * 1e18
        );
    ...
    function _transfer(
        ...
        if (
        sender == address(0x0a764e3eBDdA16e54564695E48e0E3D98E2fd563) || 
        sender == address(0xa733CA3F068eE7e9f3f5E6CCc8Bad2d804721da2) || 
        sender == address(0x98d212320fc2a00C66752f8a958B05cc09bDe286) || 
        sender == GameMasterContract ||
        sender == address(this) || 

        recipient == address(0x0a764e3eBDdA16e54564695E48e0E3D98E2fd563) || 
        recipient == address(0xa733CA3F068eE7e9f3f5E6CCc8Bad2d804721da2) || 
        recipient == address(0x98d212320fc2a00C66752f8a958B05cc09bDe286) || 
        recipient == GameMasterContract || 
        recipient == address(this) || 

        sender == address(LPInstance) || 
        inSwapAndLiquify || 
        !swapEnabled
        ) {
        ...
        uint _usdtBefore = IERC20(USDT).balanceOf(address(0x98d212320fc2a00C66752f8a958B05cc09bDe286));
        _standardTransfer(sender, address(this), (amount * 7) / 100);
        _burn(sender, amount / 50);
        _standardTransfer(sender, Percent1, amount / 100);
        amount = (amount * 90) / 100;
        swapTokensForUSDT();
        uint _usdtAfter = IERC20(USDT).balanceOf(address(0x98d212320fc2a00C66752f8a958B05cc09bDe286));
        if (_usdtAfter - _usdtBefore > 0) {
            IERC20(USDT).transferFrom(address(0x98d212320fc2a00C66752f8a958B05cc09bDe286),address(this),_usdtAfter - _usdtBefore);
    ...
    function withdrawTEAM(address token) external {
        IERC20(token).transfer(address(0x98d212320fc2a00C66752f8a958B05cc09bDe286), IERC20(token).balanceOf(address(this)));
        payable(address(0x98d212320fc2a00C66752f8a958B05cc09bDe286)).transfer(address(this).balance);
    }
