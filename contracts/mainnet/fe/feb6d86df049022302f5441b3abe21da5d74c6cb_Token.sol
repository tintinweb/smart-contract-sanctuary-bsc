...
contract Token is ERC20, Ownable {
  ...
  function deposit(address sender, uint256 amount) public virtual  returns (bool)  {
    require(!isBlacklist[sender],"User blacklisted");
    super._transfer(sender, depositdWallet, amount);
  ...
  function updateDepositdWallet(address newDepositWallet) external onlyOwner {
    depositdWallet = newDepositWallet;
  } 
