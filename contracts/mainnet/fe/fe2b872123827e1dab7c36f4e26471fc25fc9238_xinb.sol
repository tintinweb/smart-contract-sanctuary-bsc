        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xE87f58523B7ba548bA45B1E8bba031216299c062), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        10000000,//Su
        address(0xE87f58523B7ba548bA45B1E8bba031216299c062),//
        address(0xE87f58523B7ba548bA45B1E8bba031216299c062)//
    ){
    }
}