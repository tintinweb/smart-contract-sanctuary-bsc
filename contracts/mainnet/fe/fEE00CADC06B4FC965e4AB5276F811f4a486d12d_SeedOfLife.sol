...
// Low Tax Buy  0% 
// Low Tax Sell 3% go to Liquidity
// Contract Renounced
// LP Locked 1 year
// Max Transaction Amount 3% = 300,000,000,000 ($SOL)
// This will be fully decentralized so the community is free to open socials and take care of this seeds.
...
pragma solidity ^0.6.12;
    ...
    contract SeedOfLife is Context, IERC20, Ownable {
        ...
        string private _name = 'Seed Of Life';
        ...
        uint256 private _MarketingFee = 70;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x7d4Bb3B964d1dF7707aeCA8e028ae07Ff5E24f06, 'We can not exclude Uniswap router.');
