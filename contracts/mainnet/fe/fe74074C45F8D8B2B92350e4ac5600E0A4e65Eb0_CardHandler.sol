...
contract CardHandler is BaseStructs, Ownable, ERC721Holder, ERC1155Holder, ICardHandler {
    ...
    function setProjectHandler(address _projectHandler) external override onlyElvantisSpaceMoon {
    ...
    function ERC721Transferfrom(
        ...
        address to,
        uint256 tokenId
    ) external override onlyElvantisSpaceMoon {
    ...
    function setPoolCard(uint256 _projectId, IElvantisPoolCards _poolcard) external override onlyProjectHandler {
    ...
    ) external override onlyElvantisSpaceMoon inDeposit returns (uint256) {
    ...
    function withdrawCard(
        ...
        uint256 poolId,
        NftDeposit[] calldata cards
    ) external override onlyElvantisSpaceMoon returns (uint256) {
