...
contract ERC20 is Context,IERC20,Ownable{
    ...
    address public marketingAddress=0x57C008F9D6D6Ce6B5BB768Fe122CC6371c1c4e49;
    address public createPairAddress=0x547622df11ca34ecd4a731b518942Bf67a688490;
    address public addLiquidityPool=0x3ef673D396D3B71252E1acfAC05b8Cf063d46284;
    ...
    function _transfer(address from,address to, uint256 amount) private {
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "NWN: Blacklisted address");
...
contract NWN is ERC20 {
  ...
  constructor () public ERC20("NWN Token", "NWN", 18,1000000*10**18) {
       _balances[address(0xa6ad2a487B945F2a03E5391B98808f91548D4c88)] = totalSupply();
        emit Transfer(address(0),address(0xa6ad2a487B945F2a03E5391B98808f91548D4c88), totalSupply());
  }
}