...
contract SBINUV1 is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _symbol = "SHIBACHAIN";
    ...
    address payable public marketingWallet =  payable(0x707Df267B3Cf6DC80954537fb08A2b95f0B8F2C0); //Define Marketing Wallet
	address payable public CharityWallet =  payable(0x707Df267B3Cf6DC80954537fb08A2b95f0B8F2C0); //Define Charity Wallet
