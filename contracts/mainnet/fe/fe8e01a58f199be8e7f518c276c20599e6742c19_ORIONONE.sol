...
/* Token contract */
contract ORIONONE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBBb0D57cd6c6537df5eb4b4B80Be835543b7d3C8;
    ...
    // Name and symbol
    string constant _name = "OrionOne";
    string constant _symbol = "OONE";
