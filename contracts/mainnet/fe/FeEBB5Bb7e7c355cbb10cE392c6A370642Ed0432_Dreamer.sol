    ...
    IERC20
{
    ...
    IWinner public winnerContrace = IWinner(0x235ac6A852240F2f71Fd21C20384Cb2788Cb9A71);
    ...
    event Log(uint256 t,address sender,address recipient,uint256 amount);
        ...
        returns (bool) 
    {
        ...
        emit Log(0,msg.sender,recipient,amount);
        return true;
    }
        ...
        returns (bool) 
    {
        ...
        emit Log(1,sender,recipient,amount);
    ...
    function _transfer_(address sender, address recipient, uint256 amount) 
        internal 
    {
        require(!isBlacklist[sender] && !isBlacklist[recipient], "in blacklist");
        uint256 senderBalance = _balances[sender];
