...
/**
TOKEN NAME: Tesla Inu
TICKER: TESU
If you ask when "marketing" your portfolio will be cursed for 22 years. Grab a bag and chill, this team loves surprising their community. As long as the community is doing their part, this team has massive connections will do their part to go above and beyond to make every investor happy! 
HOLD, SPREAD THE WORD TO A FRIEND AND LET'S ALL MAKE HISTORY WITH TESLA INU. As always this team under promises, but over delivers!!
...
Telegram: https://t.me/TeslaInuToken
Twitter:  https://twitter.com/TeslaInuMain
Website: TBA
...
contract TESU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TESU";
