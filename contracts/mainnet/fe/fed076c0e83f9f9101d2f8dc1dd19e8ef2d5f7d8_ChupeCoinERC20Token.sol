...
contract ChupeCoinERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("CHUPECOIN", "CHUPE", 18) 
    ERC20Permit("CHUPECOIN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 13026222000000000000000000000); 
