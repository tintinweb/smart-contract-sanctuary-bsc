...
// File @uniswap/v2-periphery/contracts/interfaces/IUniswapV2Ro[email protected]
...
contract TTC is ExtendedReflections {
    ...
    uint256 private _maxTxAmount = 60_000_000_000_000 * (10 ** _decimals);
    uint256 private _maxWalletAmount = 60_000_000_000_000 * (10 ** _decimals);
    ...
    constructor (address _marketingAddress) ExtendedReflections("FireFoxBSC", "FFB", _decimals, _tokenSupply) {
