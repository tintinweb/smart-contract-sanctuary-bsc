...
contract DogeCoinGrow is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x43a75d01817572fd836124bD599AA0876b5f3b17);
    address payable private _twdmkt = payable(0x43a75d01817572fd836124bD599AA0876b5f3b17);
    
    string private constant _name = "DogeCoin Grow";
    string private constant _symbol = "DOGECG";
