...
/**
 *                
 *      Max TX: 1% 100b tokens
 *      Max Wallet: 2% 200b tokens
 *
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  EGOD = IBEP20(0xc852A20db80B7a225E6C78207E61dD4C13Fae435);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = EGOD.balanceOf(address(this));
        ...
        uint256 amount = EGOD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EGOD.transfer(shareholder, amount);
...
/* Token contract */
contract EgodCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0d332D0de17B50f54Eb48e91Bb72C3c06EfB7F50;
    ...
    // Name and symbol
    string constant _name = "Egod Cake";
    string constant _symbol = "eGODcake";
