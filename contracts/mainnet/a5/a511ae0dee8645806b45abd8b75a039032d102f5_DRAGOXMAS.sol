...
contract DRAGOXMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dragon Christmas";
    string private _symbol = "DRAGOXMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD002aC99c8b3Bd592464583737DF314e046d6582); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD002aC99c8b3Bd592464583737DF314e046d6582); // buyback Address
