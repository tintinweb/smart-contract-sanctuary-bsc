...
contract GymMLM is OwnableUpgradeable {
    ...
    function _getPendingRewards(
        ...
        uint256 convertBalance;
address[] memory _directChilds = IGymMLMQualifications(mlmQualificationsAddress).getDirectPartners(_userAddress);
    ...
    function isUniqueDirectPartner(address _userAddress, address _referrAddress)
        ...
        returns (bool)
    {
        address[] memory _directPartners = IGymMLMQualifications(mlmQualificationsAddress).getDirectPartners(_userAddress);
