...
contract MUSICCAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0F484D3Fc1181C80E1C6d872117de6a215A36c12); // Marketing Address
    address payable public teamWalletAddress = payable(0x0F484D3Fc1181C80E1C6d872117de6a215A36c12); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x0F484D3Fc1181C80E1C6d872117de6a215A36c12),
            block.timestamp
        );
    }
