...
contract Daddy is Context, IERC20, Ownable {
    ...
    string private _name = "Vladdy Daddy";
    string private _symbol = "VLADDY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xb2169dFac969cd59bDC2dC919b0C4e2996721AbA); // Marketing Address
    address payable public teamWalletAddress = payable(0x236305ce8dA73C717b766C13db43C26ab8fE923C); // Team Address
