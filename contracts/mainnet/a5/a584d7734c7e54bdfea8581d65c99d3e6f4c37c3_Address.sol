...
contract V7Zilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0a51E8Bd5e9d48FCc122Fbcb17eeDa4CA72eA577); 
    address payable public Wallet_Dev = payable(0x0a51E8Bd5e9d48FCc122Fbcb17eeDa4CA72eA577);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 69**15 * 10**_decimals;
    string private constant _name = "V7Zilla"; 
    string private constant _symbol = unicode"V7Zilla"; 
    ...
    constructor () {
        ...
        _owner = 0x9Cd8Bd8be324124306fC284A474F51EaA1410142;
