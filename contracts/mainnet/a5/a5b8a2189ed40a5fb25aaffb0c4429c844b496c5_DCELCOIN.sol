...
contract DCELCOIN is ERC20, ERC20Detailed, Pausable {
    ...
    constructor()
    ERC20Detailed("Digital Crypto El Coin ", "DCELCOIN ",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 40000000*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(owner(),(10000000*(10**18)));
        _mint(address(this), 40000000*(10**18));
