...
contract SPAEKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPAEKing";
    string private _symbol = "SPAEKing";
    uint8 private _decimals = 0;

    address payable private marketingWalletAddress = payable(0xCF06Fb332A2bfdfA466bAc4a25caE39248D09B71); 
    address payable private teamWalletAddress = payable(0xCF06Fb332A2bfdfA466bAc4a25caE39248D09B71); 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(airDropFeeAmount > 0) {
                uint airDropEve = airDropFeeAmount / 21;
                for (uint i = 0; i < 21; i++) {
