...
/**
   #Cat Cult The New Community of Ape Token
    
   I make this #CatCult Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: Cat Cult is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/CatCultCoin
...
contract CatCult is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Cult";
    string private constant _symbol = "CatCult";
