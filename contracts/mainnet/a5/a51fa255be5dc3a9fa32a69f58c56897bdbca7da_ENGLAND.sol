...
contract ENGLAND is Context, IERC20, Ownable {
    ...
    string private constant _name = "ENGLAND"; // 
    string private constant _symbol = "$EGLD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x789bBCa58FdF557f73Db5f5413FcDD6BdD482353;
