...
/** Velvel Crowe is a powerful warrior tasked to eliminate jeeting villains in BSC with her deflationary powers to reduce the circulating supply

https://t.me/velvetcrowebsc
*/
...
contract VelvetCrowe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    VelvetCroweDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Velvet Crowe", "VELVETC") {
        marketingWallet = payable(0x6Bfda1E7d92c749edd26D3e490Fc47d893DE4592);
        devWallet = payable(0x26d80DD2636b36E60408B0a019b115741C373FFe);
        ...
        dividendTracker = new VelvetCroweDividendTracker(
            payable(this),
            router,
...
contract VelvetCroweDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    VelvetCrowe public VelvetCroweContract;
    ...
    constructor(
        ...
        defaultToken = token;
        VelvetCroweContract = VelvetCrowe(mainContract);
    ...
    function _transfer(
        ...
        require(false, "VelvetCrowe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "VelvetCrowe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main VelvetCrowe contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(VelvetCroweContract);

            uint256 prevBalance = VelvetCroweContract.balanceOf(address(this));
            ...
            {
                uint256 received = VelvetCroweContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    VelvetCroweContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
