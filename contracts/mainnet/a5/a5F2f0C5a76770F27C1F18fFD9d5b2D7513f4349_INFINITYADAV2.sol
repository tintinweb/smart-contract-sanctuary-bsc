...
contract INFINITYADAV2 is ERC20Upgradeable, OwnableUpgradeable, IAntiBotBabyToken {
  using SafeMath for uint256;
  ...
  constructor() {
    ...
    pinkAntiBot.setTokenOwner(0x9C63417d9408DCc6c082bBbe8338Edb54791c8Fb);
    enableAntiBot = true;
    ...
    uint256 totalSupply_ = 560000000e18;
    ...
    dividendTracker.initialize(rewardToken, 55000e18);
