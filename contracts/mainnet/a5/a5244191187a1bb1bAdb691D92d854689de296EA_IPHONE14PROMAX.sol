...
//TELEGRAM: https://t.me/IPHONE14PROMAXBSC
...
contract IPHONE14PROMAX is Context, IERC20, Ownable {
    ...
    string private constant _name = "IPHONE 14 PRO MAX"; // 
    string private constant _symbol = "$IPHONE14PMAX"; //    
