...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    constructor(string memory _name, string memory _symbol, address _rewardToken) BEP20(_name, _symbol) { 
...
contract BigBrainAI is BEP20, Ownable {
    ...
    constructor() payable BEP20("BigBrain AI", "BigBrain-AI") {
