...
contract SHIBLOOD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBLOOD";
    string private _symbol = "SHIBLOOD";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x985B89A1Db23C8cC9C03189b330ebE692cc687ac;
    address public developerWallet = 0x9111fd8730901E899B15Aa098f530Ce4824f987C;
