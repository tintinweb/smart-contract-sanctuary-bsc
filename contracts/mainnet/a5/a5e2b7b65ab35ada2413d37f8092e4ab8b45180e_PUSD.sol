...
contract PUSD is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    constructor(address owner_, string memory name_, string memory symbol_, uint8 decimals_, uint256 supply_, uint256 cap_, bool isBurnable_) ERC20(name_, symbol_) {
        require(decimals_ <= 18, "PUSD: decimals has to be lower or equal than 18");
        _decimals = decimals_;
        _cap = cap_;
    ...
    function burn(uint256 amount) public virtual override {
        require(_isBurnable, "PUSD: burn option is deactivated");
        super.burn(amount);
    }
