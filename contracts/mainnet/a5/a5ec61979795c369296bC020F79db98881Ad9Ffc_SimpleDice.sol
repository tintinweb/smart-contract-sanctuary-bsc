...
contract SimpleDice is GambleBase, AccessControlEnumerable {
    ...
    uint256 public houseEdge = 500; // Percentage points
    ...
    function setMinBet(address _tokenAddress, uint256 _value) external onlyAdmin {
    ...
    **/
    function startBet(IERC20 _token, uint256[4] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseCommit) external noContract {
        ...
        require (profit <= maxWin(_token), "Profit exceeds max win amount");
    ...
    function finishBet(IERC20 _token, address _gambler,uint256 _blockNumber, uint256[4] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseReveal) external onlyCoupier {
        ...
        (uint256 roll, uint256 payout, Bet memory betObject, bytes32 betHash) = computeResult(_token, _gambler, _blockNumber, blockhash(_blockNumber), _rollIntegerVariables, _userSeed, _houseReveal);
    ...
    function computeResult(IERC20 _token, address _gambler, uint256 _blockNumber, bytes32 blockHash, uint256[4] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseReveal) public view returns (uint256 roll, uint256 payout, Bet memory betObject, bytes32 betHash) {
