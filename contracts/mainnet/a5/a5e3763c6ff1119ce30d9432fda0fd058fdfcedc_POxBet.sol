...
contract POxBet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0xa895a175e7c91d53a636202603c00D743C559e94); 
    address payable public developmentAddress = payable(0xa895a175e7c91d53a636202603c00D743C559e94); 
    address payable public charityAddress = payable(0xa895a175e7c91d53a636202603c00D743C559e94); 
    address payable public vaultRewardAddress = payable(0xa895a175e7c91d53a636202603c00D743C559e94); 
    ...
    uint256 private constant _tTotal = 110000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Portugal";
    string private constant _symbol = "POxBet";
