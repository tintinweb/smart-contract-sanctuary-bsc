...
contract Retrium  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Retrium Network Global";
    string constant _symbol = "RNG";
