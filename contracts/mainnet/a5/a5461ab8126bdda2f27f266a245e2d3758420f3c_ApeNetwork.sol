...
/* ApeNetwork - Building NFTs future together
...
contract ApeNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC32f9fE30254294A442D624459989d4b4D428BF2); // Marketing Address
    address payable public charityAddress = payable(0xC32f9fE30254294A442D624459989d4b4D428BF2); // Charity/Dev Address
    ...
    string private _name = "ApeNetwork";
