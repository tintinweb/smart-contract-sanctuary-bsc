...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 1000000000000000* 10 ** IERC20(FISTAddress).decimals();
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"tian keng",//Name
        unicode"tian keng",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address(0x012f2Da7fb384f9Ca547aEf6Fa2589b069c48638),//FundAddress
        address(0x7e76Aa6e7895C72Ba01Fd1D978747C794550381A)//ReceiveAddress
    ){
    }
}