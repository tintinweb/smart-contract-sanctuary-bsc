...
// Telegram: https://t.me/DeployerSquid
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3759D932398fCD3D4cDC9EC435f460962FD0402; // owner address
...
contract DEPLOYERSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Deployer Squid";
    string private _symbol = "DEPLOYER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3759D932398fCD3D4cDC9EC435f460962FD0402);
    address payable public teamWalletAddress = payable(0xb3759D932398fCD3D4cDC9EC435f460962FD0402); 
