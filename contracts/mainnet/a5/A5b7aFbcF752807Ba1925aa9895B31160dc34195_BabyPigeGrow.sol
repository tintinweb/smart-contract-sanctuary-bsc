...
contract BabyPigeGrow is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pige Grow";
    string private _symbol = "$BPIGEGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc711Dc393eEc979d9B770e53DDFc47BD31E2CdDB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8C3399958502Be814aD814CC21416160d3BD8652); // BuyBack Address
