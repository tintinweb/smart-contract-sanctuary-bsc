...
contract ElonsFlameThrower is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Elons FlameThrower";
    string private constant _symbol   = "ElonFlame";
    uint8  private constant _decimals = 9;
   
     // Counter for liquify trigger for marketing
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 2000 / 10000; // 2% of total supply
 ...
 // This will set the number of transactions required before the 'swapAndLiquify' function triggers
    ...
    function _transfer(
        ...
        {  
            ...
            uint256 TokensforMarketing = contractTokenBalance / 10000 * _percentageOfLiquidityForMarketing;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbForLiquidity = newBalance;
