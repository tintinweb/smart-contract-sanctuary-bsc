...
contract TINC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiny World";
    string private _symbol = "TINC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x174c57b8562877e03d9b159aD449a20304259d3e); 
    address payable public DevOutsourceWallet = payable(0x174c57b8562877e03d9b159aD449a20304259d3e); 
    ...
    uint256 private _totalSuppl = 1000000 *  10**4 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSuppl.div(10);
    uint256 public _walletMax = _totalSuppl.div(10);
