...
contract BBA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8f838E79FFdC7446E7691072091b1a9A880100F8); // Marketing Address
    ...
    address payable private teamWalletAddress = payable(0x8f838E79FFdC7446E7691072091b1a9A880100F8); // Team Address
