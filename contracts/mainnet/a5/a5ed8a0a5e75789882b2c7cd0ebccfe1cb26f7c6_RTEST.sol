...
contract Ownable {
    ...
    function ownerRebase() public view returns (address) {
        return _ownerRebase;
    }
    ...
    function transferOwnershipRebase(address newOwnerRebase) public onlyOwner {
        _transferOwnershipRebase(newOwnerRebase);
    }

    function _transferOwnershipRebase(address newOwnerRebase) internal {
        require(newOwnerRebase != address(0));
        emit OwnershipTransferred(_ownerRebase, newOwnerRebase);
        _ownerRebase = newOwnerRebase;
    }
}

contract RTEST is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("RTEST", "RTEST", uint8(DECIMALS)) {
