...
contract DUCK is IERC20 {
    ...
    string constant private _name = "DUCK";
    string constant private _symbol = "DUCK";
    ...
    address payable teamWallet = payable(0xF21fA76760e99bcAa667760B2C6315B9F1279d5A);
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 team) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.team = team;
        _ratios.totalSwap = team + reflection;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable team) external onlyOwner {
        require(team != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        (success,) = teamWallet.call{value: address(this).balance, gas: 35000}("");
    }
    ...
    function takeTaxes(address from, address to, uint256 tAmount, bool takeFee, bool buy, bool sell, bool other) internal returns (ExtraValues memory) {
        ...
        if (takeFee) {
            ...
            values.tFee = (feeAmount * ratios.reflection) / ratios.totalSwap;
