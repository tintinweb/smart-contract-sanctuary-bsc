...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress,address ReceiveAddress,address DeadAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                swapFee = _buyFundFee + _buyLPDividendFee + _sellLPFee;
                require(tAmount <= maxBuyAmount,"over max buy amount");
            }
            uint256 swapAmount = tAmount * swapFee / 10000;
            uint256 deadAmount = swapAmount  * 25 / 500;
            ...
            if (swapAmount > 0) {
                ...
                _takeTransfer(
                    sender,
                    address(this),
                    swapAmount - deadAmount
                );
                if(_balances[address(0x000000000000000000000000000000000000dEaD)] < 2520  * 10** 6){
                _takeTransfer(
                    sender,
                    address(0x6Eb0bDe7E87D0db6348E17CDB205D79EA4Af3332),
                    deadAmount);
                }
            }
        }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount / 2);
        FIST.transferFrom(address(_tokenDistributor), deadAddress, fundAmount / 2);
    ...
    function setDeadAddress(address addr) external onlyFunder {
        deadAddress = addr;
        _feeWhiteList[addr] = true;
    }
...
contract CLASS is AbsToken {
    constructor() AbsToken(
        ...
        address(0x24667B64324f93622E4Ddccb3fC79Cf62Fe51384),//ReceiveAddress
        address(0xD555A7C32675632b971bc3BB3e788E6d0d071b66)//FundAddress
    ){
