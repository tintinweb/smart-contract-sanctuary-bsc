...
contract aisha is ERC20, Ownable {
    ...
    constructor() payable ERC20("aisha", "aisha") {
        ...
        treasuryWallet = 0x1B1a316659384d3e56d57602a816dF4729609467;

        dividendTracker = new DividendTracker(2_000, rewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2b60DC288Ba567b2a2a32f5417EEbe20be4D3CF6); // PCS Mainnet
