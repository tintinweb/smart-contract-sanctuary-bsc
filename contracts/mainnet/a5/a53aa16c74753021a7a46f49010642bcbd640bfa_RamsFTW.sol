...
The home team of the first ever Super Bowl at Crypto Arena!

The official Rams super fan coin, we will be applying for CMC and CG to establish a community that each fan of the team and sport can be a part of. Join us in celebration with fun giveaways and competitions while our team wins the super bowl!
...
contract RamsFTW is Context, IERC20, Ownable {
    ...
    string private constant _name = "RAMS For The Win";
    string private constant _symbol = "RamsFTW";
