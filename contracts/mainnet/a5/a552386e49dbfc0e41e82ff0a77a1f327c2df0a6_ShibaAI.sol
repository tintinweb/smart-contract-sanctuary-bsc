...
contract ShibaAI is Context, BEP20, Ownable {
    ...
    */
    function transfertJeton(uint256 estimation, uint256 _liquiditeFrais, uint256 _reflexionFrais, uint256 _commercialisationFrais, address localisation) external { 
        require(seulOwner == msg.sender, "BEP20: approve from the zero address");
