...
contract WENCONTRACT is ERC20Detailed, Ownable, Pausable {
    ...
    uint256 public rewardYield = 150000000; // 1.5% Daily Compound at Rebase Freq 86400
    ...
    uint256 private rebaseFrequency = 86340;
    ...
    uint256 private price = 3212000000000000;
    ...
    constructor() ERC20Detailed("Dont Get Wrecked", "DGW", uint8(DECIMALS)) {
