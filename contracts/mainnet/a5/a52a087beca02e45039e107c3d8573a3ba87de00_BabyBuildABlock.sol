...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xCDC491Ef9A9ccBb3D00b15Af252d050700F813F3);
...
/* Token contract */
contract BabyBuildABlock  is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xCDC491Ef9A9ccBb3D00b15Af252d050700F813F3; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x28e4501559C1Fc8479b4d07D450ed844422C4F00                                          ;
    ...
    // Name and symbol
    string constant _name = "Baby Build a Block";
    string constant _symbol = "BBUILD";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 75000 / 10000; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 25000 / 10000; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 75000 ) / 10000; // 3% or 5m tokens
