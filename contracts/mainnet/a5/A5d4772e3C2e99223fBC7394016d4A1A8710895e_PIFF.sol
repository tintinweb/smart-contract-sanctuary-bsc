...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    contract PIFF is BEP20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "PIFF";
    ...
    uint256 public _maintenanceFee = 5; 
   ...
   address payable maintenanceWallet = payable(0xC939C9525bd2D41bbd4Aa7CDade71F1CAAA67449);
