...
contract BUSDPrinter {
    ...
    constructor(address _owner, address _partner, address _partner2) {
            owner = _owner;
            partner = _partner;
            partner2 = _partner2;
    ...
    function stakeStablecoins(uint256 amtx, address ref)  external initialized {
        ...
        BUSD.safeTransfer(owner, stakeFee * 2/6);
        BUSD.safeTransfer(partner, stakeFee * 2/6);
        BUSD.safeTransfer(partner2, stakeFee * 2/6);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        BUSD.safeTransfer(owner, withdrawFee * 2/6);
        BUSD.safeTransfer(partner, withdrawFee * 2/6);
        BUSD.safeTransfer(partner2, withdrawFee * 2/6);
    ...
    function withdrawRefBonus() external initialized {
        User storage user = UsersKey[msg.sender];
    ...
    function stakeRefBonus() external initialized {
        User storage user = UsersKey[msg.sender];
        Main storage main = MainKey[1];
    ...
    function compound() external initialized {
        User storage user = UsersKey[msg.sender];
        Main storage main = MainKey[1];
