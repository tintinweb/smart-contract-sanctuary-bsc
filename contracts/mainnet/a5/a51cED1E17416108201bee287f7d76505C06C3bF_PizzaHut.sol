...
contract PizzaHut is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4193c82f12E06bB3dDc83d6aa76169E3610E7327); // Marketing Address
    ...
    string private _name = "Pizza Hut Crypto";
