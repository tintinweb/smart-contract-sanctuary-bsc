...
contract ShamrockShibaSZN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShamrockShibaSZN";
    string private _symbol = "SHIBSZN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x631aA1Ee5A663EA0e61f1FA92Fc09DB596fa44aa);
    address payable public teamWalletAddress = payable(0x631aA1Ee5A663EA0e61f1FA92Fc09DB596fa44aa);
