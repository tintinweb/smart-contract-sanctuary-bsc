...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC569D50c8Cb6b0172C3441Bd46e0AbE511263230; 
...
contract HoliShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HoliShiba";
    string private _symbol = "HSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC569D50c8Cb6b0172C3441Bd46e0AbE511263230); // 
    address payable public teamWalletAddress = payable(0xC569D50c8Cb6b0172C3441Bd46e0AbE511263230); // 
