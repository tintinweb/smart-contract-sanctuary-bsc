...
contract CeToken is Ownable, ERC20, ERC20Burnable {
    using Address for address;

    uint256 public totalBurn;

    uint256 public price;
    bool public whiteContract;
    ...
    modifier onlyAdmin() {
        require(admin[msg.sender], "not damin");
        _;
    }
    ...
    constructor() ERC20("CE", "CE") {
        ...
        _mint(0x6eDaD58Eb9a015083C8bcfA29B8241268F60678c, 100_000_000 ether);
    }
    ...
    function setContractStatus(bool status_) public onlyOwner {
        whiteContract = status_;
    }

    function setAdmin(address com_, bool isAdd_) public onlyOwner {
    ...
    function _burn(address account_, uint256 amount_) internal virtual override {
        super._burn(account_, amount_);
        totalBurn += amount_;
        userBurn[msg.sender] += amount_;
    }

    function maxBalance(address account_) public view returns (uint256) {
        return balanceOf(account_) + userBurn[account_];
    }
    ...
    function transfer(address recipient_, uint256 amount_) public virtual override returns (bool) {
        ...
        require(whiteList[_msgSender()] || whiteList[recipient_], "not white list");
    ...
    function transferFrom(
        ...
        require(whiteList[sender_] || whiteList[recipient_], "not white list");
