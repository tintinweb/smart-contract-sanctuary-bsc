...
/**
Degen play, . If you want to create a telegram I suggest to name it to @jemboetcoin
...
contract JemboetCoin is Context, IERC20, Ownable {
    ...
    string private _name = unicode"JemboetCoin";
    string private _symbol = unicode"Jemboet";
