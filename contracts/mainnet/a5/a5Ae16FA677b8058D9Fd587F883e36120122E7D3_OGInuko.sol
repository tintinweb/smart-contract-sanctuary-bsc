...
contract OGInuko   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " OG Inuko ";
    string private _symbol = " OGO "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x631BE466c5394743Ed673BFAa8D0Ab0002349bd0); 
    address payable public teamWalletAddress = payable(0x631BE466c5394743Ed673BFAa8D0Ab0002349bd0); 
