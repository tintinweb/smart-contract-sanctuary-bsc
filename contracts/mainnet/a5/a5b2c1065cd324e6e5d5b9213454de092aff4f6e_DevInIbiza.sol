...
// It's the end of summer and this dev NEEDS to get to Ibiza. Follow us on this incredibly funny play and get a chance to win some BNB or a trip of your own. 
...
contract DevInIbiza is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dev In Ibiza";
    string constant _symbol = "$IBIZA";
