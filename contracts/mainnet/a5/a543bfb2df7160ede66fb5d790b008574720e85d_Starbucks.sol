...
contract Starbucks is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1971 * 10**18;
    ...
    address public burnAddress = address(0x3091B75E6358DABdaED843E9825cAE75b15206BC);
    address public ownerAddres = address(0x0D31F54E90132aE7205834325b6e3398c6a5fEb2);
    ...
    uint256 public _maxTxAmount = 1971 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 6 * 10 **17;
    uint256 public  maxBurn = 1761 * 10 **18;
