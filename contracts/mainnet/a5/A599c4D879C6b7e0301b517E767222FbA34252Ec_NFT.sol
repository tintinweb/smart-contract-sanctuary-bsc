...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256[2] public prices = [0 * 1e18, 0 * 1e18];
    uint256[2] public nftTotals = [300, 100];
    address private _market;
    IERC20 private _USDT;
    IERC20 private _FIST;
    constructor() ERC721("NFT Of FIST", "NOF") {
        _FIST = IERC20(0x1Ee99e05424F91827085bE74bC82861b373eC2d7);
        _market = 0x125fd56796a9e344384a1d68D57AB6F940E5dFB0;
    ...
    function setPrice(uint256 p1, uint256 p2) public onlyAdmin {
        prices[0] = p1;
        prices[1] = p2;
    }
