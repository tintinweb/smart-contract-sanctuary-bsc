...
contract Teston is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teston";
    string private _symbol = "Test";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEb154E431ACF509a72f67026C3DD00D631Bc7a8d);
    address payable public BuyBackWalletAddress = payable(0xEb154E431ACF509a72f67026C3DD00D631Bc7a8d);
