...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x4E71e9b674C458e7cfb9fFE1dAeC88f1D7fB0151;
...
contract XiaoX is AbsToken {
    constructor() AbsToken(
        ...
        address(0xeb0821a5b4A2518644d863b60B10f6BDEA1c35DF),
    
        address(0x007eb35be2c3ba2560144f4f4F41006D0Bd4497F)
    ){
