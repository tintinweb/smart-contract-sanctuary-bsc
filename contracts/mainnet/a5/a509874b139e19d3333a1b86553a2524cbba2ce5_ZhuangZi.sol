...
contract ZhuangZi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZhuangZi";
    string private _symbol = "ZhuangZi";
    ...
    uint256 public _maxTxAmount =   288 * 10**_decimals; 
    uint256 public _walletMax =     288 * 10**_decimals;
