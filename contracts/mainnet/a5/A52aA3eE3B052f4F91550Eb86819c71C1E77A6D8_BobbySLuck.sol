...
Is today your Lucky day? Do you have “Bobby’s Luck”?

Daily Buys enter you to win the Daily Lottery. If you sell, you are no longer eligible for Daily Lottery
...
contract BobbySLuck is IBEP20, Auth {
    ...
    string constant private _name = "Bobby's Luck";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _taxFeeVar, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxFeeVar = _taxFeeVar;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _taxFeeVar.add(__sellFee).add(_devFee);
