 ...
 *Submitted for verification at BscScan.com on 2022-03-13
*/
//t.me/sexty9official - What's your position tonight?
...
/* Token contract */
contract Tokensexty9 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5EF6eF2CaD74A5beEc9e53368ed6B6C41039cA6D;
    ...
    // Name and symbol
    string constant _name = "Token Sexty9";
    string constant _symbol = "$T69";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 69 * (10 ** _decimals); // 69
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4cca0Cc3D9B97770ba8B8E60506787c218578A65;
