...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0xE5c355c993dE69C06b5DD1A0c9a2c39b4Cde5511);
...
contract BabyFrogToken is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   FrogDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BabyFrog Token", "BFrog") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
        _buyMarketingFee = 8;
        _buyDevFee = 0;
        ...
        contractTokenBalanceAmount = 500000 * 10**18;
        
        swapTokensAtAmount = 500000 * (10**18);
        _maxWallet = 1000000 * (10**18);
        _maxBuy = 500000 * (10**18);
        _maxSell = 500000 * (10**18);
        ...
        dividendTracker = new FrogDividendTracker();

        liquidityWallet = owner();
        
        marketingWallet = payable(0xdfbD623069488240FC0a315FdAfB0614595e4665);
        _devWallet = payable(0xe8D8540948F7021687b3bE0428cDd14585DCaCf2);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Frog: The dividend tracker already has that address");

        FrogDividendTracker newDividendTracker = FrogDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Frog: The new dividend tracker must be owned by the Frog token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "Frog: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Frog: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Frog: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Frog: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Frog: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Frogs: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Frog: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Frog: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Frog: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Frog: Cannot update gasForProcessing to same value");
...
contract FrogDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Frog_Dividend_Tracker", "Frog_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "Frog_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Frog contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "Frog_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Frog_Dividend_Tracker: Cannot update claimWait to same value");
