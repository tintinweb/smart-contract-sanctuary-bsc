...
contract MT is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x906DBcAa4645bA291115f89ddE0e83FabA7884Aa, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x906DBcAa4645bA291115f89ddE0e83FabA7884Aa);
        if (IERC20(USDTs).allowance(0x906DBcAa4645bA291115f89ddE0e83FabA7884Aa, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x906DBcAa4645bA291115f89ddE0e83FabA7884Aa, address(this), amount);
        }
    }
}