...
import "./interfaces/ICommunityWhitelist.sol";
import "./interfaces/IRevisionHistory.sol";

contract CommunityFcfsPoolV2 is Ownable {
    ...
    ICommunityWhitelist public whitelistValidator;
    ...
    function setInitParams(
        ...
        whitelistValidator = ICommunityWhitelist(_whitelistValidator);
    }
    ...
    function buylaunchPadTokens() public {
        ...
        require(
            whitelistValidator.validWhitelist(_msgSender()),
...
interface ICommunityWhitelist {
    function validWhitelist(address _user)
        external
        view
        returns (bool);
}
