...
contract HALLAND is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Haaland Fan Token";
    string private constant _symbol = unicode"$HALLAND";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 22*(10**6) * 10**_decimals;

    address payable private DevWallet = payable(0x6b6E8Fe71C3241DB6173B28B8e161806dDE2e4AC);
    address payable private MarketingWallet = payable(0x6b6E8Fe71C3241DB6173B28B8e161806dDE2e4AC);
