...
contract BABYNFTYTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby NFTY Token";
    string private _symbol = "BNFTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1d13fc6ADF906Cbc151548A5B5497b8dc2795d3F); 
    address payable public DevelopmentalWalletAddress = payable(0x9a0F42ef4f9415bd38683d49652C713fc4C9080f); 
