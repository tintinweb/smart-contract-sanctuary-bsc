...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        require(totalFees <= 30, "Total fee is over 30%");
    ...
    function inBlack(address account) external onlyOwner {
        _isBlacklist[account] = true;
    }

    function unBlack(address account) external onlyOwner {
        _isBlacklist[account] = false;
    }

    function setopen(bool val) external onlyOwner {
        isopen = val;
    }
