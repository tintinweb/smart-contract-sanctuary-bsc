...
contract SpaceStation is Context, IERC20, Ownable {
    ...
    string private _symbol = "SpaceStation";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A942B755cf41e526d70A5006d747ac73635E9f7); // Marketing Address
    address payable public teamWalletAddress = payable(0x66Dc5A069542b6A0bD9c806b6A687E9008348a04); // Team Address
    ...
    uint256 private _totalSupply = 9640000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 96400000000 * 10**_decimals; 
    uint256 public _walletMax = 300000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 9640000000000 * 10**3; 
