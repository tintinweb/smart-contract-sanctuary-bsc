...
/*
PotatoTate ~ BSC Token

Inspired by Andrew Tate, who showed up everywhere in Tiktok, PotateTate is ready to stealth launch within next 6 hours. Andrew Tate may not be everyone's favorite person, but PotatoTate will definitely be everyone's favorite potato! By having low tax fees & anti sniper protocol, PotatoTate is ready to hype on BSC.

Join us now in TG : https://t.me/PotatoTateToken

TOKENOMICS
1) Supply : 10,000,000,000 (10 Billion)
2) Initial LP : $330 (1 BNB)
3) Tax : 6%
*/
...
contract PotatoTate is Context, IERC20 { 
    ...
    string private constant _name = "PotatoTate"; 
    string private constant _symbol = "$PTATE"; 
