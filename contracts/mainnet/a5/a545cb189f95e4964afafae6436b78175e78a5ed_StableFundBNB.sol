...
contract StableFundBNB is Ownable,ReentrancyGuard{
    ...
    constructor(address newOperatorAddress, address newDevAddress, address _devWallet, uint256 _startDate) {
        ...
        require(msg.sender == devAddress || msg.sender == operatorAddress, "Only owner or operator can call this function");
        _;
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        function collect(uint256 value) public nonReentrant onlyOwnerOrOperator {
