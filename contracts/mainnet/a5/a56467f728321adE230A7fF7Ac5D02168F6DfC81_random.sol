...
contract random is Governance {
    ...
    string[] public urls = ["QmR1sb4S31tausUN1f1bTAJWgWQLCD9sh8uxZ6vPVYb7cw",
                            "QmPPorWbF7Fb2g9XZLfjXbUUR426RkPTGLm87FoWsftxL8",
                            "QmS5j6t7psbwft1xFVfAueL5jwaY1a97j8WxPxnKpH5t73",
                            "QmUZsk7iyDT8d3zVWtYuCVtATq3c62Jz4vSPr8kTKXx2cn",
                            "QmZbRHifcPDJeCySHdn7HjbU3WzUjvidmf33EQPxik97Mf",
                            "QmcYLU62ZVdLjhPADnNywZX8ovHHQp94ZYhFDEuLvursBo",
                            "Qmf1ugKoj8ZDkTMkXsNnxDUdoQ4FTbWfCNCtyuDLeVU9oU",
                            "QmdCt6tBvJ3vUFSnXTnmqNiv3LvxYdgpxWjVZXe6FsT7ff",
                            "QmWHY2bLYtdrdoMBz6kgTZAhY2cynhWd42mfKwJp7PV1vJ",
                            "QmTpnjfdPAgYH6V5mS2NZKkt9bUqAgFPSfviGFAtTwcyND",
                            "QmZrk6K8T3gnNTdjQtCWj4Pv6iJuBuSU8f8xwQDcy5LxZq",
                            "QmZrzwhFGc9PV4HnXRuSWfub7yYB6nvAPPSHc7hKkA8Q7n",
                            "QmY4wNWNKCG9uyLuQmb9aZocndvJEF2wFKXURwVsjHqh5s",
                            "QmfAifEAeaQBTjzBVFnGBkWghjdkE9UpknHvGJ2eftYwsX",
                            "QmZVNsg8xLPMRCuDzuigpkyu5F9yok8NaJ9h59ZoiDLSUr"];

    uint public desNum = 100*1e18;
    // uint public leftAmounts = 400;                                        

    uint randomNumber;
    struct periodSetting {
        uint _randomNumber;
        uint _randomAlphabet;
        uint _person;
        uint _amounts;
        uint _startTime;
        uint _endTime;
    ...
    mapping(address => uint) public hasRewardAmount;
     ...
     constructor (address new_stakeToken,address new_nfttoken,address new_inviteAddr,address new_teamAddr,address new_mysticAddr1,address new_mysticAddr2) public {
    ...
    function getRandom() external onlylock {
        ...
        nfttoken(_nfttoken).mint(msg.sender,urls[_parame],4);
    ...
    function Reward(uint _period,address[] calldata accunts) external onlyGovernance {  
        ...
        itemRecord._randomAlphabet = getRandom4RepeatHash(randomNumber.mod(1000000)).mod(6);
