...
contract USDTWrapper {
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        stakeInToken.safeTransfer(msg.sender, amount*99/100);
        stakeInToken.safeTransfer(address(0), amount/100);
        if (_balances[msg.sender] == 0) {
...
contract LpStakingPool is USDTWrapper,Ownable {
    ...
    constructor() public {
        ...
        stakeInToken = IERC20(0xF1F3512bb961e3846b9b0C376a3AD867e9d61A05);
        stakeOutToken = IERC20(0x74C127D8bD25534fB56D9Ced47A42833Fde2F1d0);
    }
    ...
    modifier updateReward(address account) {
        ...
        perSecondRewardAll=102712500/(2**x)/24/60/60;
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            if ( p!= address(0) && balanceOf(p)>=minlp) {
