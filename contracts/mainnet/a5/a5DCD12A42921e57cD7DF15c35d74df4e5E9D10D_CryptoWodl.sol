...
/**
CRYPTOWODL
Rewarding Word Puzzle Game
Telegram Group : https://t.me/CryptoWodlBSC

A new BSC Token with word puzzle game concept that give the winners reward, CryptoWodl is ready to dive into BSC.

Word puzzle game has been known as a game that can expand our knowledge & fun to play. In CryptoWodl, other than all the things you can experience, you will also be rewarded with BNB for all your correct answers!

Every holders can play the game for number of times based on the total amount of token that they hodl, and on each game will have 5 chances to guess the right answer. 

A total amount of prize pool will be announce & share equally for all participants with right answer!
*/
...
contract CryptoWodl is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptoWodl"; // 
    string private constant _symbol = "CryptoWodl"; //    
