...
/*
    ...
    Wikigirl is a Telegram bot that answers all your questions using Wikipedia API.
    You can ask WikiGirl anything! Either ask it in DM or add WikiGirl to your community chat!

    https://t.me/WikiGirlBSC
...
contract WikiGirl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xA1b401385C17E3479a4146bDa14b1abC0821dC17); // Marketing Address
        
    address payable public teamAddress =
        payable(0x227A0463EB2521e49ba9184D67770B45eC4e5315); // Team Address
        
    address payable public liquidityAddress =
        payable(0x227A0463EB2521e49ba9184D67770B45eC4e5315); // Liquidity Address
    ...
    string private constant _name = "WikiGirl";
    string private constant _symbol = "WIKIGIRL";
