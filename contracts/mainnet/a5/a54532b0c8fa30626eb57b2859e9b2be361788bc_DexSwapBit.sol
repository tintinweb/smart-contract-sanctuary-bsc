...
contract DexSwapBit is Context, Ownable, IERC20 {
    ...
    string private _name = "DexSwap Bit";
    ...
    feeRatesStruct public buyFees = feeRatesStruct(
     {taxFee: 0,
	  ...
	  liquidityFee: 2000,
      charityFee: 1000, 
      swapFee: 10000, // burnFee+airdropFee+liquidityFee+charityFee
      totFees: 2
    });
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xC1083F68a623a5151B5d1FA8175997263cA3B87c] = true;
