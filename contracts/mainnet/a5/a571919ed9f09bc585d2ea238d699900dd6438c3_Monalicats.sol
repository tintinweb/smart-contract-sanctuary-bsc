...
Join our community on Telegram @monalicats
...
contract Monalicats is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Monalicats";
    string constant _symbol = "MONALICATS";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2112F12c64649E35ee2D07dc6358446fD7AD61d0);
