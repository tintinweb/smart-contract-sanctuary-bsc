...
contract NBP is Context, IERC20, Ownable {
    ...
    uint256 private _rTotal = 200000 * 10**18 ;
  
    string private _name = "NBP";
    string private _symbol = "NBP";
    uint8 private  _decimals = 18;
    
   
    constructor () public {
        _balance[address(msg.sender)] = _rTotal;
        emit Transfer(address(0), address(this), _rTotal);
    }
