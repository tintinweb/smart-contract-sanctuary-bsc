...
contract Columbus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Columbus";
    string private _symbol = "Columbus";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD3d326cE13CA7e01e013d73bc1415Bb2f19aefdf); // Marketing Address
    address payable public teamWalletAddress = payable(0xD3d326cE13CA7e01e013d73bc1415Bb2f19aefdf); // Team Address
