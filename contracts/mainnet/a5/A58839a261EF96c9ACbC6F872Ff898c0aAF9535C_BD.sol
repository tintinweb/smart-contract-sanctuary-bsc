...
contract BD is IERC20, Ownable {
    ...
    address private fundAddress = address(0xc5e86b424Bb608Da4D69bAAB767759F9426E8381);
    address private fundAddress2 = address(0xa2B2aa481a40B67E4d5Abd9c4650Cfd487f65938);
    address private lpAddress = address(0xc5e86b424Bb608Da4D69bAAB767759F9426E8381);
    ...
    function swapAndFee(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (newBalanceusdt>0) {
            IERC20(USDT).transfer(fundAddress,newBalanceusdt.div(2));
            IERC20(USDT).transfer(fundAddress2,newBalanceusdt.sub(newBalanceusdt.div(2)));
        }
    ...
    function process(uint256 gas) private {
        ...
        nowbanance=nowbanance.sub(_funTotal);
        uint256 gasUsed = 0;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                _funTotal=_funTotal.add(tAmount.div(100).mul(1));
