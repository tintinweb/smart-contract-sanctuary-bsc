...
contract LuckyDogeZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyDogeZilla";
    string private _symbol = "LuckyDogeZilla";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x3a2F47b651e28016515a80e13F16161de998634e); 
    address payable private teamWalletAddress = payable(0xBaF1d6F4b20574Ae36fE49729352062C3136EBFa); 
    ...
    uint256 private _totalSupply = 1 * 10**4* 10**6 * 10**_decimals;
