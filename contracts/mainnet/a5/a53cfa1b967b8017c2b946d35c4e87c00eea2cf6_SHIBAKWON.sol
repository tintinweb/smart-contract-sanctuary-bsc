...
contract SHIBAKWON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcdA3cE38EB780C2A7948EEE7DF20c136F4EA6C1C); 
    address payable public Wallet_Dev = payable(0xcdA3cE38EB780C2A7948EEE7DF20c136F4EA6C1C);
    ...
    string private constant _name = "SHIBAKWON"; 
    string private constant _symbol = unicode"SHIBAKWON"; 
    ...
    constructor () {
        ...
        _owner = 0xcdA3cE38EB780C2A7948EEE7DF20c136F4EA6C1C;
    ...
    function _setFees(uint256 _fee) public onlyOwner {
        _Tax_On_Sell = _fee;
        _Tax_On_Buy = _fee;
    }
