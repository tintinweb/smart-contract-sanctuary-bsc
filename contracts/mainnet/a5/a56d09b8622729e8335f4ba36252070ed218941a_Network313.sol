...
(=c  )\ `._.' |       \:./ _  _ ___  ____ ____ _    _ _ _ _ _  _ ___\        | `._.' /(  =)
 \ (_)       )       \./  |\/| |__) |___ |m___ |___ _X_ _X_  \/  _|_ \       (       (g_) /
  \    `----'         """"""""""""""""""""""""""""""""""""""""""""""""       `----'    /
                       _______          __                       __    
    ...
    \ (=\     \                                                            /     /-) /
     \_)_\     \                                                          /     /_(_/
          ...
          (     (,-' `-..__                                    __..-' `-,)     )
           \_.-''          ``-..____                  ____..-''          ``-._/
            `-._                    ``--...____...--''                    _.-'
                `-.._             Which side of the door
                                   will you take when                 _..-'
                     `-..__              it opens?               __..-'
                           ``-..____                  ____..-''
                                    ``--...____...--''
...
// Network $313 1st scam free blockchain - BSC part  ( Making crypto how it was meant to be #FearlessInvesting
...
contract Network313 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Network313";
    string private constant _symbol = "$313";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xfd85b1FAF45Fbcb8930ffA45d61242E2C24aDC6E);
    address payable public developmentWalletAddress = payable(0x2666D37ceDAA2E0E3Be2288bE883EFD69B56904D); 
    ...
    uint256 public _walletMax = 150 * 10**2 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**4; 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee).add(_developmentFee);
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newdevelopmentTax, uint256 newExtraFeeOnSell) external onlyOwner() {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee).add(_developmentFee);
        _totalTaxIfSelling = _totalTaxIfBuying.add(_extraFeeOnSell);
         require(_totalTaxIfBuying <= 14, "Must keep fees at 10% or less");
          require(_totalTaxIfSelling <= 22, "Must keep fees at 12% or less");
