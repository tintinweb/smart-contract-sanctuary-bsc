...
contract CHATGPTCOIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CHATGPT";
    string private constant _symbol = "Al";
    ...
    address payable private _developmentAddress = payable(0x02DaC1829BdCD8C62B0cDC82bCDF2c46cA96C2aD);
