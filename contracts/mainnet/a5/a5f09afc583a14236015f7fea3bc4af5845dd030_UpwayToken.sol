...
contract UpwayToken is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 4498990;
    ...
    address public liquidityReceiver = 0xa8Bd870b1e94DFAd5b65D3052057Be8AA9a07A17;
    address public treasuryReceiver = 0xAd29F0CDBADCe6c9d2D8763ffF50D5AAb8847eB9;
    address public riskFreeValueReceiver = 0x3EA3C7f46C341e12F1b325FeC692ec9824780F1c;
    address public rewardReceiver = 0x6E95b2AF3F475Bd485e8C21FF7bdC770cAE5A9D2;
    ...
    constructor() ERC20Detailed("UpWay DAO", "UPWAY", uint8(DECIMALS)) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToReward = contractTokenBalance.mul(rewardFee.mul(2)).div(realTotalFee);
        uint256 amountToTreasury = contractTokenBalance.sub(amountToLiquify).sub(amountToRFV).sub(amountToReward);
        ...
        if(amountToReward > 0){
            _swapTokensForBusd(amountToReward, rewardReceiver);
        }
