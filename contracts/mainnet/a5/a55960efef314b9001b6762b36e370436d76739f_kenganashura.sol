...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc94ce458AccE8375Ee2F472f1f059DC0049D626F; // owner address
...
contract kenganashura is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KENGAN ASHURA";
    string private _symbol = "KENGAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A61bEfD076bd7eB229Ab02467aCA08F57E0EEcd); // Marketing Address
    address payable public teamWalletAddress = payable(0xc94ce458AccE8375Ee2F472f1f059DC0049D626F); // Team Address
