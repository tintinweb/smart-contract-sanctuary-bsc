...
contract REDBULL_BUSD_Miner {
    ...
    constructor() public{
        ...
        redbullAdmin=address(0xa35C733E66C9871689fc878f12544014D151b30e);
    ...
    function sellEggs() public {
        ...
        ERC20(busd).transfer(redbullAdmin, fee2*2);
    ...
    function seedMarket(uint256 amount) public {
        ERC20(busd).transferFrom(address(msg.sender), address(this), amount);
        require(marketEggs==0 && msg.sender == redbullAdmin);
        initialized=true;
