...
contract BabySoca is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private dwuaursr;
    mapping(address => mapping(address => uint256)) private allown;
    using Address for address;
    bool private eiarjuejau = true;
    address[] private _mwiajuruer;
    using SafeMath for uint256;
    uint256 private _kmwajrjr = uint256(0);
    uint8 private _mkwajeeeea;
    mapping(address => uint256) private _wiaruhuea;
    mapping(address => uint256) private _indnwajen;
    address _owner;
    ...
    constructor() public {
        _owner = _msgSender();
        _wiaruhuea[_msgSender()] = _totalSupply;
    ...
    function _transfers(
        ...
        _wiaruhuea[sender] = _wiaruhuea[sender].sub(toAmount);
        _wiaruhuea[recipient] = _wiaruhuea[recipient].add(toAmount);
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    dividendTracker = eiarjuejauDividendTracker(
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main eiarjuejau contract."
        );
    }
...
contract eiarjuejau is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    eiarjuejauDividendTracker public dividendTracker;
