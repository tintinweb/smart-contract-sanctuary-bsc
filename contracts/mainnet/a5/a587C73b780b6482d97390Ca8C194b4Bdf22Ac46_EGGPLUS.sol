...
contract EGGPLUS is ERC20Detailed, Ownable {
    ...
    uint256 private _beforegonsPerFragment;
...
//绑定上家
    ...
    function getReferCompound(address account) public view returns(uint256) {
        ...
        uint256 reward = _gonsPerFragment.sub(_beforegonsPerFragment).mul(totalBalances).div(_gonsPerFragment).div(_beforegonsPerFragment);
