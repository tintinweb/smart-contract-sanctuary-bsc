...
eSolen is a 100% Brazilian startup based in Pernambuco with the main objective of unifying 3 major solutions: 1 - Charging stations for electric cars; 2 -Tokenization of surplus energy generated; 3 - Use of tokens in exchange for recharge or services offered within the eSolen Mobitech platform. Creating a decentralized system of electricity credit tokens.
eSolen (ESOL) it’s a BEP-20 Token For more information visit the link bellow :
https://esolen.org/

The crypto active market, is prone to a intense volatility and is high risk.

65,000,000 Total Supply 
...
contract eSolen is Context, IERC20, Ownable {
    ...
    string private _name = "eSolenmobility";
    string private _symbol = "ESOLMOB";
    ...
    address public charityWallet = 0x7dEA8113D26eF4c6eC57b9F23cA42BCFe335807A;
