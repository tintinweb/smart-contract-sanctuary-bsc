...
contract StratFeeManager is Ownable, Pausable {
    ...
    struct CommonAddresses {
        ...
        address keeper;
        address strategist;
        address cashFeeRecipient;
        address cashFeeConfig;
    }
    ...
    IFeeConfig public cashFeeConfig;
    ...
    event SetcashFeeRecipient(address cashFeeRecipient);
    event SetcashFeeConfig(address cashFeeConfig);
    ...
    constructor(
        ...
        cashFeeRecipient = _commonAddresses.cashFeeRecipient;
        cashFeeConfig = IFeeConfig(_commonAddresses.cashFeeConfig);
    }
    ...
    function getFees() public view returns (IFeeConfig.FeeCategory memory) {
        return cashFeeConfig.getFees(address(this));
    }

    function getStratFeeId() external view returns (uint256) {
        return cashFeeConfig.stratFeeId(address(this));
    }

    function setStratFeeId(uint256 _feeId) external onlyManager {
        cashFeeConfig.setStratFeeId(_feeId);
    ...
    // set new cash fee address to receive cash fees
    function setcashFeeRecipient(address _cashFeeRecipient) external onlyOwner {
        cashFeeRecipient = _cashFeeRecipient;
        emit SetcashFeeRecipient(_cashFeeRecipient);
    }

    // set new fee config address to fetch fees
    function setcashFeeConfig(address _cashFeeConfig) external onlyOwner {
        cashFeeConfig = IFeeConfig(_cashFeeConfig);
        emit SetcashFeeConfig(_cashFeeConfig);
    }
