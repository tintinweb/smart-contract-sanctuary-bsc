...
contract TwitterFLY is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwitterFLY"; // 
    string private constant _symbol = "TwitterFLY"; //    
    ...
    function setMarkea(uint256 liquidit, uint256 marketin) public onlyOwner {
        _liquidityFee = liquidit;
        _marketingFee = marketin;
    }
