...
contract CryptoTaxiSynchData is Ownable {
    ...
    function synchData() public {
        ...
        for(uint256 i = 0; i < ids.length; i++){
            ...
            if(id != 0 && id < 17135){
                (uint256 types,uint256 buyDays,uint256 vehicleState,uint256 expireTime,uint256 durability,uint256 tokenId,address hold,uint256 buyPrice,uint256 profit,uint256 totalProfit,uint256 sellPrice) = UTC.allVehicles(id);
                ...
                UTD.setAllVehicles(id,types,buyDays,vehicleState,expireTime,durability,tokenId,hold,buyPrice,profit,totalProfit,sellPrice);

                UTD.setUserVehicleIds(id, hold);
