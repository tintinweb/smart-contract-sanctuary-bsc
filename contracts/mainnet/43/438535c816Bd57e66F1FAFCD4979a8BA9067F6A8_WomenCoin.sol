...
contract WomenCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Women Coin";
    string private _symbol = "WMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF1C0930dec1f77e8F3A8C3eEaF0675a910Af2F19); // Marketing Address
    address payable public teamWalletAddress = payable(0xaad3599849dcc3ef418f8BC012784bbd6381f3B6); // Team Address
