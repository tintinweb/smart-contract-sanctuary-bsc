...
contract PLMMToken is Context, IBEP20, Ownable {
    ...
    address public marketAddress = 0x2007a8fb89063fB57CdCE523b8162F5dA066b495;    
    constructor() public {
        _name = "PLMM Token";
        _symbol = "PLMM";
        _decimals = 8;
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(!shmdm[sender] && !shmdm[recipient], "in blacklist");
