...
contract BMK is BEP20, BEP20Burnable {
    constructor() BEP20("BioMedica Karma", "BMK") {
        _mint(msg.sender, 5000000000 * 10 ** decimals()); // 5,000,000,000 initial supply
    }
     ...
     function claimStuckedTokensAndBNB(address _token) external onlyOwner {
        ...
        if (_token == address(0x0)) {
            ...
            return;
             ...
             require(balanceOf(address(this))> 0, "BMK: Contract balance should be greator than zero");
