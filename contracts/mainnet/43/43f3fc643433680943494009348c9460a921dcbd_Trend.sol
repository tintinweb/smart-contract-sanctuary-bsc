...
contract Trend is Context, IERC20, Ownable {
    ...
    string private _name = "TRENDING BOT";
    string private _symbol = "Trending Bot";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x00d7A46E96E1B9B149B00295ace19163DfCA3ad9); // Marketing Address
    address payable private developmentWalletAddress = payable(0x00d7A46E96E1B9B149B00295ace19163DfCA3ad9); // Development Address
