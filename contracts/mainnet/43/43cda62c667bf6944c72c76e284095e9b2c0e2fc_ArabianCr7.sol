...
Telegram : https://t.me/ArabianCr7
...
contract ArabianCr7 is IBEP20, Auth {
    ...
    string constant _name = "Arabian Cr7";
    string constant _symbol = "ACR7";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 7) / 100;  //7% max wallet
    ...
    address private marketingFeeReceiver = 0xA8A031441e434b79B2a95caDFfF67937816616f1;
    address private developmentFeeReceiver = 0x347550282f867d5428de503bB2FDAD58bA388901;
