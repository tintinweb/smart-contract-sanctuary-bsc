...
contract METAWIKI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xAD8d53661509BB50057c05652608a1e16fa137bB;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "METAWIKI";
    string constant _symbol = "$MWIKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xAD8d53661509BB50057c05652608a1e16fa137bB;
