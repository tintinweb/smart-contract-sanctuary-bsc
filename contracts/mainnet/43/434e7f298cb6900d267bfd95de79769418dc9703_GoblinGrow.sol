...
library Address{
 ...
 contract GoblinGrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5D810418CE7Ab9C85768AB5C7e790Ef5d7dF1B1A;
    address public teamwallet = 0x5D810418CE7Ab9C85768AB5C7e790Ef5d7dF1B1A;

    string private constant _name = "Goblin Grow";
    string private constant _symbol = "GOBLING";
    ...
    Taxes public sellTaxes = Taxes(0, 7, 1, 0);
