...
contract STUDENTINU is STUDENTINUDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private STUDENTINUTeam;
    address private CharitySTUDENTINU;
    ...
    string public override name = "Student Inu";
    string public override symbol = "STUDENTINU";
    ...
    constructor(uint totalSupplyValue, address STUDENTINUTeamAddress, address CharitySTUDENTINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        STUDENTINUTeam = STUDENTINUTeamAddress;
        CharitySTUDENTINU = CharitySTUDENTINUAddress;
       
        // split the tokens according to agreed upon percentages
        balances[STUDENTINUTeam] =  totalSupply * 4 / 100;
        balances[CharitySTUDENTINU] = totalSupply * 4 / 100;
