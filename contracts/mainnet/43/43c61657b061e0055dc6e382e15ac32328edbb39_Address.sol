...
contract SPORTSFX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x19407aA6d1c6e3a23015dD0C1DA081f8737b5f76); // Marketing Address

     address payable public bullRelicAddress =
        payable(0x95EB6375cAF303d3a8508d7C535702718f5EE5C7); // BullRelic Address

    address payable public devAddress =
        payable(0xBa9E6d9dEEC53705FdeF084F4b5b29E357662A54); // Dev Address
    ...
    uint256 private constant _brctTotal = 100000000000000 * 1e18;
    uint256 private _brcrTotal = (MAX - (MAX % _brctTotal));
    uint256 private _brctFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "sportsfx";
    string private constant _symbol = "SPFX";
