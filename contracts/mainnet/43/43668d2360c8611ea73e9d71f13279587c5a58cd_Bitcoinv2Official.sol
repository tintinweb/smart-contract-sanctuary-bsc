 ...
 *Submitted for verification at BscScan.com on 2022-05-13
 _______  ___   _______  _______  _______  ___   __    _    _______        _______ 
|  _    ||   | |       ||       ||       ||   | |  |  | |  |       |      |  _    |
| |_|   ||   | |_     _||       ||   _   ||   | |   |_| |  |____   |      | | |   |
|       ||   |   |   |  |       ||  | |  ||   | |       |   ____|  |      | | |   |
|  _   | |   |   |   |  |      _||  |_|  ||   | |  _    |  | ______| ___  | |_|   |
| |_|   ||   |   |   |  |     |_ |       ||   | | | |   |  | |_____ |   | |       |
|_______||___|   |___|  |_______||_______||___| |_|  |__|  |_______||___| |_______|

Bitcoin2.0 is a community-driven token deployed on the Binance Smart Chain through the BSC medium. 
It is community driven and backed by a strong team to deliver for investors with the goal of creating 
wealth and use case just by holding the token. To achieve this vision, a detailed roadmap is laid out 
and the liquidity is locked initially to grant investors confidence in this project.
*/
...
contract Bitcoinv2Official is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa9952e76Dd54B1780DFc8e9Ab1218eff054f1ff5;
        teamFeeReceiver = 0xa9952e76Dd54B1780DFc8e9Ab1218eff054f1ff5;
