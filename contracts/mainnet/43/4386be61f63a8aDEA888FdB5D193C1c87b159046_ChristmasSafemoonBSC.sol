...
TELEGRAM: https://t.me/ChristmasSafemoonBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x727f925C2BDc8f94AF58a1e7dF6e6a06C0790DE6; // owner address
...
contract ChristmasSafemoonBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Safemoon";
    string private _symbol = "CS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61BFC49995deAa5d24051c0d13364F2e2FC10C95); // Marketing Address
    address payable public teamWalletAddress = payable(0x61BFC49995deAa5d24051c0d13364F2e2FC10C95); // Team Address
