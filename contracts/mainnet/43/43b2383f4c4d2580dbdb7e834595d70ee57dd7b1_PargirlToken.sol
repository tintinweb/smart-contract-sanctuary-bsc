...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1f341D99E40691295dF8446eB907F73f69eb3464;
...
contract PargirlToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1f341D99E40691295dF8446eB907F73f69eb3464;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pargirl Token";
    string private _symbol = "Pargirl";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!takeFee)
            removeAllFee();
        if(!tradingEnabled){
            require(tradingEnabled,"Cant close launch mode when trading is disabled");
        }
    ...
    function setTradingStatus(bool YN) onlyOwner public {
        tradingEnabled = YN;
    }
}