...
contract MuufoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Muufo Inu"; // 
    string private constant _symbol = "MUUFO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x0C7C77C3984A57bBc116653051027c2e7CA18B0F;
