...
/**
BOOGIE INU stealth launch on Pancakeswap.
10% Buy 10% Sell
...
contract BoogieInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xB53502E4CAEAB2783d0c7a8A05D61CB4757Ab866));
    address payable public devWallet =
        payable(address(0xB53502E4CAEAB2783d0c7a8A05D61CB4757Ab866));
    address public liquidityReceiver =
        0xB53502E4CAEAB2783d0c7a8A05D61CB4757Ab866;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Boogie Inu";
    string private _symbol = "BOOGINU";
