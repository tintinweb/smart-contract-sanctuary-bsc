...
contract DHXY is Context, IERC20, Ownable{
    ...
    uint256 public feeToLpDifidend =25 ;
    uint256 public feeToburn = 30;
    ...
    function processFee(
                ...
                difidendAmount= amount * FeeToDifidend/1000;
                if(difidendAmount>0){
                ...
                uint256 difidendLPAmount = amount * feeToLpDifidend/1000;
                difidendToLPHolders(sender, difidendLPAmount);

                 
                uint256 difidendMarkingAmount = amount * FeeToMarketing/1000;
                _balances[marketing] = _balances[marketing] + difidendMarkingAmount;
                emit Transfer(sender, marketing, difidendMarkingAmount);

                
                uint256 burnAmount;
                if(_balances[address(0)] < (_totalSupplyAmount*amountToStopBurn/1000) ){
