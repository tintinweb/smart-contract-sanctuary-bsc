...
contract VShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Voice Shib";
    string private _symbol = "VSHIB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB74465596d1Ffb2851F3f65B24C23fc67E96EB2C); 
    address payable public BurnedWalletAddress = payable(0xB74465596d1Ffb2851F3f65B24C23fc67E96EB2C); 
