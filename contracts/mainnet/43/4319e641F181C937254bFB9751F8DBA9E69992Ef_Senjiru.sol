...
/**
Senjiru inu stealth launch

Senjiru inu is your next BSC moonshot and a rare BSC gem. Senjiru is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.
...
pragma solidity ^0.6.5;
    ...
    contract Senjiru is Context, IERC20, Ownable {
        ...
        string private _name = 'Senjiru inu';
        string private _symbol = 'Senjiru inu';
