...
// Telegram : https://t.me/Babymrbeastfantokenofficial
...
contract BabyMrBeastFanToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RippleBurnReflectDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby MrBeast Fan Token", "BMBFT") {
        marketingWallet = payable(0x812f0154ab7C3D6A1ceF7FB5764700D46aAFF19B);
        devWallet = payable(0x812f0154ab7C3D6A1ceF7FB5764700D46aAFF19B);
        ...
        dividendTracker = new RippleBurnReflectDividendTracker(
            payable(this),
            router,
            0xE3250dEfE22Ab7E5452Be3c5360BBf094EC229C1,
            "BabyMrBeastFanTokenTRACKER",
            "BMBFTTRACKER"
        );
        ...
        swapTokensAtAmount = totalTokenSupply / 200000; // 2%;
...
contract RippleBurnReflectDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyMrBeastFanToken public BabyMrBeastFanTokenContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyMrBeastFanTokenContract = BabyMrBeastFanToken(mainContract);
    ...
    function _transfer(
        ...
        require(false, "RippleBurnReflect_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "RippleBurnReflect_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RippleBurnReflect contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyMrBeastFanTokenContract);

            uint256 prevBalance = BabyMrBeastFanTokenContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyMrBeastFanTokenContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyMrBeastFanTokenContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
