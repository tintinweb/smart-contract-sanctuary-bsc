...
contract CatPoopCoin is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "CatPoopCoin";
    string private _symbol = "CatPoopCoin";
    ...
    uint256 public _liquidityFee = 5000; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _boostedLiquidityFee = 5000;

    uint256 public _marketingFee = 4900; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _boostedMarketingFee = 4900;
    ...
    address public burnAddress = 0xE36ac5Da8E0A2256d759893C6b10DCf4F2a80CcF;
    address payable private _marketingWallet = payable(0x91fCbaD52fFB5Eb26171441E46DB38494A20cb87);
    address payable private _devWallet = payable(0x1886eedEAfEa3689d7aca2Fe4d2BC7Ba9a77AeF4);
