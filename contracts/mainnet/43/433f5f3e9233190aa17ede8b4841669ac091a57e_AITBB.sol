...
contract AITBB  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AITBB ";
    string private _symbol = "AITBB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x093CD3bCd7FcE8688CE39dA9598162C0d3a16FF7);
    address payable public teamWalletAddress = payable(0x093CD3bCd7FcE8688CE39dA9598162C0d3a16FF7);
    address public immutable deadAddress = 0x093CD3bCd7FcE8688CE39dA9598162C0d3a16FF7;
