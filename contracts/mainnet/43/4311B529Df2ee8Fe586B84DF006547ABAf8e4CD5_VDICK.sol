...
contract VDICK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VDICK";
    string private _symbol = "VDICK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1e069fc7acfA1E5C0d162be6edD8179702344444); 
    address payable private teamWalletAddress = payable(0x1e069fc7acfA1E5C0d162be6edD8179702344444); 
    ...
    uint256 private _totalSupply = 10 * 10**3* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 10 * 10**3 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 10 * 10**3 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100 * 10**3* 10**_decimals; 
