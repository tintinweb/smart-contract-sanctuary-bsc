...
contract kingfrog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KING FROG";
    string private _symbol = "KFROG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xD6e7Aec65aa02a29A59B3d6f5730d468c0E2E43F);
