...
contract LT is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x5b3f2840a09FFB0abBAe199A76a1C502fa90AA25;
    ...
    constructor() public ERC20("LT", "LT") {
        ...
        excludeFromFees(0x0d95215ffA1E1588895cacB412aC842d7bB9386A, true);
        excludeFromFees(0xfd4D98E2d994D947Fa36Cea8E8B3Bf9A43507A1f, true);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 nftu = fistval.mul(3).div(7);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xDb18A26D66FcD5d6947E1bf08FEC70730adDc7d6, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xDb18A26D66FcD5d6947E1bf08FEC70730adDc7d6);
        if (IERC20(USDTs).allowance(0xDb18A26D66FcD5d6947E1bf08FEC70730adDc7d6, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xDb18A26D66FcD5d6947E1bf08FEC70730adDc7d6, address(this), amount);
        }
    }
