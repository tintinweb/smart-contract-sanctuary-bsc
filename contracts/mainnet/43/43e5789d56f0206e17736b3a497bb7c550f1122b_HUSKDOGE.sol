...
contract HUSKDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Husk Doge";
    string private _symbol = "HUSKDOGE";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x5796c02A410fdbfA952434A19F1DE9697E53fB06); // Marketing Address SPZ
    address payable private TeamWallet = payable(0xb7522A6C22dFeDa941489447144987D6fd59390B); // Buy Back Address
