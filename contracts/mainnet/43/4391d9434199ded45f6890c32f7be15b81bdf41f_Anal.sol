...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1163637199BF9A2961A9264dc10D1c6012dBbD05;
...
contract Anal is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anal Dust AI"; // 
    string private constant _symbol = "ANALAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x1163637199BF9A2961A9264dc10D1c6012dBbD05);
