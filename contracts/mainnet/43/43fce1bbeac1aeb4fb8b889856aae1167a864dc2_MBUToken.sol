...
contract MBUToken is ERC20("cs2", "cs2"), Ownable {
    ...
    address public foundtionWallet = 0x419c3aBd29b9e629e09429c0E8d454Cd233DfB54;
    ...
    constructor() {
        ...
        liquidityWallet = 0x419c3aBd29b9e629e09429c0E8d454Cd233DfB54;
    ...
    function _transfer(
        ...
        require(_rOwned[sender].mul(99).div(100) >= amount, "Only 99% token can be transfer");
        require(balanceOf(sender).mul(99) >= amount.mul(100), "Only 99% token can be transfer");
    ...
    function _tokenTransferWithFee(
        ...
        if (!limitExcluded[sender]) {
            require(balanceOf(sender).mul(99) >= tAmount.mul(100), "Only 99% token can be transfer");
        }
