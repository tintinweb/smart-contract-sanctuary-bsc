...
contract MetaSocialityStaking is Ownable {   
    ...
    function updateBNBPrice() external{
       require(msg.sender == subOwner || msg.sender == owner,"IR");
    ...
    function buyTokenWithBNB() external payable {
        BEP20 tokenObj = BEP20(tokenAddr);
        uint tariff = 0;
        require(msg.value >= 0);
        ...
        tokenObj.transferFrom(tokenOwnerAddr,contractAddr, tokenVal);
        
        emit DepositBNBAt(msg.sender, tariff, tokenVal,msg.value);
