...
/**
A wise Doge from the East is here to share inner peace to all! 

https://t.me/shibaguru_bsc
...
contract SHIBAGURU is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SHIBAGURU"; // 
    string constant _symbol = "GSHIB"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (4);
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (4);
    uint256 public _maxWalletToken = _totalSupply / (100) * (4);

    // Fees receivers
    address private autoLiquidityReceiver = 0xE944e9372173196320fb77F53cd6BED5748BBB90; 
    address private marketingFeeReceiver = 0x4159D9B02113Ba6563d7E00A08569FAc9f669A28; 
    address private devFeeReceiver = 0x5C03DA7CACEC07838e3d327Aa731cA1dC5325125; 
    address private teamFeeReceiver = 0x4159D9B02113Ba6563d7E00A08569FAc9f669A28; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xd949d96bDe1Ab9b1B6B60305150FD30381Dd851f;
