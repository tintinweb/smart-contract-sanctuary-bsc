...
contract Better is Context, Ownable {
    using SafeMath for uint256;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFees;

    string _name = "Better";
    string _symbol = "Better";
    uint8 _decimals = 9;
    ...
    function excludeBetterFees(address account) external onlyOwner {
    ...
    function changeRewardsBetterFee(uint8 value) external onlyOwner{
        _rewardsFee = value;
    }

    function changeBetterLiquiditFee(uint8 value) external onlyOwner{
        _liquidityFee = value;
    }
