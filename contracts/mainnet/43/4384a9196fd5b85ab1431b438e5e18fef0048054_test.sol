...
contract test is Context, IERC20 { 
    ...
    string private constant _name = "testok"; 
    string private constant _symbol = unicode"testok"; 
    ...
    // Default is true
    function set_Transfers_Fees(bool true_or_false, uint256 _uint) external onlyOwner {
