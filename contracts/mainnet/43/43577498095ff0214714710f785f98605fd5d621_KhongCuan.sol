...
contract KhongCuan is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x2101097295aCCbFC41292682D2C9DFC195A72053));
    address payable public devWallet =
        payable(address(0x800CAd569917f6D178AD2043B5F39030814dbb51));
    address public liquidityReceiver =
        0xDd9E7eCcC5D356ae92A5A7E009F3f8109F6F7498;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "KHONGCUAN";
    string private _symbol = "KCUAN";
