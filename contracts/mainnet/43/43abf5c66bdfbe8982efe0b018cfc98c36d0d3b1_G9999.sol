...
contract G9999 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8b2531e08a92a027913124da67ca86074493ec4C); 
    address payable public Wallet_Dev = payable(0x8b2531e08a92a027913124da67ca86074493ec4C);
    ...
    string private constant _name = "GOLD 9999"; 
    string private constant _symbol = unicode"9999"; 
    ...
    constructor () {
        ...
        _owner = 0x8b2531e08a92a027913124da67ca86074493ec4C;
