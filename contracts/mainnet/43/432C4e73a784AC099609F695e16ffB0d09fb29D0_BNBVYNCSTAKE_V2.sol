    ...
    OwnableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        dataAddress = 0x398aA65899b111caC4ffAEBe6d01193152c97278; // info address
        ...
        bnbBusdPriceAddress = 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16; // lp address bnb-busd pair on pancakeswaps
        bnbPrice = busdBnbLpAddress(bnbBusdPriceAddress);
        migrateAddress = 0xb1Fb1Cd32b0f5288f6a5fbf7CC43D8Ad7326b7D4; // old bnb pool address
        migrate = VyncMigrate(migrateAddress);
        vync = IERC20(0xee1ae38BE4Ce0074C4A4A8DC821CC784778f378c);
        bnb = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //wbnb address for pancakeswap
        router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        factory = IUniswapV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73);
        lpToken = 0xC0f66021A700eb7A2388e207eae04CBf1Bc16F38; // lp address bnb-vync
    ...
    function stake() external payable nonReentrant {
        ...
        (uint256 _bnbAmount, uint256 _busdAmount,) = bnbPrice.getReserves();
    ...
    function migrateStaking() public {
        ...
        userInfo[staker].stakeBalanceWithReward =
            userInfo[staker].stakeBalanceWithReward +
            user.stakeBalance +
            migrate.compoundedReward(staker) + _compoundReward;
