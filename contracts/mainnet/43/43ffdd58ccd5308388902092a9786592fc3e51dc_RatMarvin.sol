...
//https://t.me/+IuGhHIscIKc2ZjI1

//Rat Marvin Special Tokenomics
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x6d7549dDb0871019F76547C7F40aDb372DcbcbE7;
...
contract RatMarvin is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public crispiness = payable(0x6d7549dDb0871019F76547C7F40aDb372DcbcbE7);
    ...
    string private constant _name = unicode"Rat Marvin"; 
    string private constant _symbol = unicode"Rat Marvin"; 

    uint256 public P_DevReward = 50;
    ...
    uint256 public _maxWalletToken = _tTotal.div(25);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(crispiness, BNB_Tot);
