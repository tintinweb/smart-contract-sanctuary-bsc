...
contract Loona is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Loona";
    string constant _symbol = "LOONA";
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x6a0083dCB7Eff0c9D333214E017f1C3A705FE621; //LP receiver
        marketingWallet = 0x28fecF84d4B4BeE1D0A8b1713fA3203A2140833F;  //marketing wallet
        taxMan = msg.sender;  
