...
contract BabyReindeer is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x8D43CF392ceDF863e9416905d466568c633fFAB8;

    string constant _name = "Baby Reindeer";
    string constant _symbol = "BRDR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * 10**6 * 10**_decimals; //100M
...
function airdropRewards(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
