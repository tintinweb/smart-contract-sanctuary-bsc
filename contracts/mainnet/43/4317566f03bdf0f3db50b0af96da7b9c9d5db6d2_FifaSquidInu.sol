...
/**
 ...
 This project aims to fire up the hype even more in BSC network by 
 building a solid community & strongest army following the mission of Fifa inu.

 TELEGRAM: https://t.me/fifasquidinu
...
contract FifaSquidInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_500_000_000 * 10**_decimals;
    ...
    address public marketingAddress = 0x8b7ff19834946Fe01c3B08651795315fD4C7b3eE;
    address public devAddress = 0x3a75848fb429e9775942022Ba36e4d7614fD3451;

    string private constant _name = "Fifa Squid Inu";
    string private constant _symbol = "FSI";
    ...
    Taxes public taxes = Taxes(0,2,6,2);
    Taxes public sellTaxes = Taxes(0,2,6,2);
    ...
    // Owner cannot transfer out Squid Fifa Inu from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Squid Fifa Inu!");
