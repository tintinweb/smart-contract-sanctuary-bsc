...
*/
 //  Stealth Launch 
//Welcome to ShibaMerge 
//ShibaMerge  is a community meme token that gives you tons of X. ShibaMerge  project will have an auto liquidity to stabilize and make the chart strong.
//Ookami was combined to the most popular dog in crypto space that what's you called ShibaMerge , 

//We're going to the moon and we're bringing you with. You can buy and sell using 10% slippage.

//ShibaMerge
//Tokenomics:

//Total Supply: 1,000,000,000
//🔥Burn Supply:   200,000,000
//Max tx : 20,000,000
...
contract ShibaMerge is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ShibaMerge";
    string constant _symbol = "SHIBMERGE"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 30 / 1000; //Initial 1%
    uint256 public _maxWalletSize = _tTotal * 30 / 1000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0x577Ee9deE3f674B7fBbAbd2Fe8688653A8f9876a;
    address public marketingFeeReceiver = 0x577Ee9deE3f674B7fBbAbd2Fe8688653A8f9876a;
    address public liquidityFeeReceiver = 0x577Ee9deE3f674B7fBbAbd2Fe8688653A8f9876a;
