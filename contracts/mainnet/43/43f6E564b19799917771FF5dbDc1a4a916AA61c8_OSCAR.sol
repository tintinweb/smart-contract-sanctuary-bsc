...
contract OSCAR is OSCARDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private OSCARTeam;
    address private CharityOSCAR;
    ...
    string public override name = "Oscar";
    string public override symbol = "OSCAR";
    ...
    constructor(uint totalSupplyValue, address OSCARTeamAddress, address CharityOSCARAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        OSCARTeam = OSCARTeamAddress;
        CharityOSCAR = CharityOSCARAddress;
       
        // split the tokens according to agreed upon percentages
        balances[OSCARTeam] =  totalSupply * 4 / 100;
        balances[CharityOSCAR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's OSCARTeam pot
