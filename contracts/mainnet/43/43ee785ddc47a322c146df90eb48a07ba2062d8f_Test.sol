...
pragma solidity ^0.6.12;
    ...
    interface IUniswapV2Pair {
        ...
        event Supply(address indexed sender, uint amount0, uint amount1);
        ...
        function supply(address to) external returns (uint liquidity);
    ...
    contract Test is Context, IERC20, Ownable {
        ...
        uint256 private _maxWalletAmount = 100000000000e9;
