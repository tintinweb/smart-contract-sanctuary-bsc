...
GangnamStyle video created a world record back in 2012. ShibaInu however makes another record in Cryptocurrency world in 2021.
What if the two hype combined into one? It would be an excellent moonshot!

GangnamShiba combines the best of two world, by experienced dev of QPAY. GangnamShiba is a 500x potential gem.

TG : https://t.me/GangnamShiba
*/
...
contract GangnamShiba is Context, IERC20 { 
    ...
    string private constant _name = "GangnamShiba"; 
