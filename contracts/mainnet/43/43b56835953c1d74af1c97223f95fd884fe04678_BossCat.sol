...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6BDcFd5E6bBb21f25F6D5539b76B4CF0C518659d; // owner address
...
contract BossCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boss Cat";
    string private _symbol = "BCAT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4953758d5441e23042EDe17fc0A4662f9D70400C); // Marketing Address
    address payable public teamWalletAddress = payable(0xDCF205215175E2F69f2D022794Ab1fd279dF6C8a); // Team Address
