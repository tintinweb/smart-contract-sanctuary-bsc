...
TG: https://t.me/BugNetworkOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3927d58ed52621bdf291e54d7B25f98D8DC07C2B; // owner address
...
contract BugNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bug Network";
    string private _symbol = unicode"BugNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3927d58ed52621bdf291e54d7B25f98D8DC07C2B); // Marketing Address
    address payable public teamWalletAddress = payable(0x3927d58ed52621bdf291e54d7B25f98D8DC07C2B); // Team Address
