...
/**
https://t.me/FxxKingRabbitsOfficial
*/
...
contract FxxkingRabbits is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FxxkingRabbits";
    string private constant _symbol = unicode"FKRABBITS";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x7aE146506F3b5c891f153628c8A61a3De507ca45);
    address payable public MarketingWallet = payable(0x345799385B45D5190fB2A9A9c5b88bC794646130);
    ...
    function TradingStatus(bool tradingACT) public onlyOwner {
        tradingActive = tradingACT;
    }
