...
contract BRWL is BRWLDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BRWLTeam;
    address private CharityBRWL;
    ...
    string public override name = "Blockchain Brawlers";
    string public override symbol = "BRWL";
    ...
    constructor(uint totalSupplyValue, address BRWLTeamAddress, address CharityBRWLAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BRWLTeam = BRWLTeamAddress;
        CharityBRWL = CharityBRWLAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BRWLTeam] =  totalSupply * 4 / 100;
        balances[CharityBRWL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BRWLTeam pot
