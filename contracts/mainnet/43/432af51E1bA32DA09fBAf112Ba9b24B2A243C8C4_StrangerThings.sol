 ...
 * If you are fed up with inu dogs, frogs and food tokens I give you iconic token Stranger Things (ELEVEN).
 * Degen play only for best crypto superheroes!
 * https://t.me/Eleven_Stranger_Things
 *
 */
...
contract StrangerThings is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stranger Things";
