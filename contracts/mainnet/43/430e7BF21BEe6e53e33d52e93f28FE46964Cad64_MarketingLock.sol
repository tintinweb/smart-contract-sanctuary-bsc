...
contract MarketingLock is Ownable {
    ...
    uint256 public unlockPercent = 100; // 100 its 10%
    uint256 public nextUnlock;
    uint256 public level;
    bool public vestingIsStarted;
    uint256 public startUnlock;
    address public tokenAddress = 0x384F9f28aE6061ecB5391097D640C492B9BBa922;
    ...
    function claim() public {
        ...
        uint256 _avalableToClaim = avalableToClaimGlobal - claimed;
        require(_avalableToClaim > 0);
        uint256 _amount = distributionAmount * _avalableToClaim / 1000;
        claimed += _avalableToClaim;
        _token.safeTransfer(marketingAddress, _amount);
    }
    
    function changeMarketingAddress(address newMarketing) public onlyOwner() {
