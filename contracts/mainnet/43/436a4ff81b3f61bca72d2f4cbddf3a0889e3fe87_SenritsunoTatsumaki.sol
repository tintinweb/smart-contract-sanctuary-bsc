...
//Senritsu no Tatsumaki is a community token with safe code
contract SenritsunoTatsumaki is IERC20, Ownable {
    ...
    string _name = "Senritsu no Tatsumaki";
    string _symbol = unicode"タツマキ";
    ...
    uint256 private reflection = 3;
    uint256 private giveaway = 3;
    ...
    constructor () {
        ...
        address deployer = 0x5FeaD004Ab1Ebd6268EbaC8b14a62F7AcA47A680;
