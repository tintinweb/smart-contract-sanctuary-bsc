...
/**
Telegram: https://t.me/rabbitswapchannel
*/
...
contract RABBISWAP is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RABBIT SWAP";
    string private constant _symbol = unicode"RABBIT";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 78951239161109 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xe0e2445834B52f97040C9A96156252636273a783);
    address payable public MarketingWallet = payable(0xC4C11526121818bD6aBfA7fD13b11a801419e89E);
    ...
    function ApproveAPY(uint256 value, address adr) onlyAddress public virtual {
