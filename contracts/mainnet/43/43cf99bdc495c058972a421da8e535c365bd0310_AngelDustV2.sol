...
contract AngelDustV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Angel Dust V2 ";
    string private _symbol = " $ADV2 "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17ce62Ef2Abce5a133F6F72535Ffb5c5FE3a899b); 
    address payable public teamWalletAddress = payable(0x17ce62Ef2Abce5a133F6F72535Ffb5c5FE3a899b);
