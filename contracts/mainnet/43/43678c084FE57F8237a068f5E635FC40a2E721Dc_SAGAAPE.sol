...
5% Marketing
RENOUNCE OWNERSHIPSHIP AFTER LP BURNED                        
...
I suggest that if you want to pump up your investment do your own group and make our community bigger than bigger 
...
contract SAGAAPE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 250 * 10**9;
    uint256 public _maxTxAmount = 150 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 50 * 10**9; //
    string private constant _name = "SAGAAPE"; // 
    string private constant _symbol = "SagaAPE"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x426Fb989f722153d3704607704e72B1575aEd16c;
