...
contract McShamrockShake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McShamrockShake";
    string private _symbol = "McShamrockShake";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1cCc11F52346B7aD9A565Fc8fAA13548Eafc34bb);
    address payable public teamWalletAddress = payable(0x1cCc11F52346B7aD9A565Fc8fAA13548Eafc34bb);
