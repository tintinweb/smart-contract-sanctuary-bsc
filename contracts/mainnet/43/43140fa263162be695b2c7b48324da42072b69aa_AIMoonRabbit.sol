...
contract AIMoonRabbit is IERC20Metadata, Ownable {
    ...
    uint256 public maxTx = _totalSupply.div(25);
    ...
    function swapBack() internal swapping {
        ...
        try pcsRouter.swapExactTokensForBNBSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
            ...
            if(amountToLiquify > 0){
                try pcsRouter.addLiquidityBNB{ value: amountBNBLiquidity }(
                    address(this),
                    amountToLiquify,
                    0,
                    0,
