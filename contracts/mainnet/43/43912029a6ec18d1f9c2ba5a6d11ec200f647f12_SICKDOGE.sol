...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36e3501FAEDfc7906F07c354C32E9608ee36aD0e;
...
contract SICKDOGE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE7FC6A290FF08593ecbC64141115A08496FCa009;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tCharity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rDevelopment = tCharity.mul(currentRate);
