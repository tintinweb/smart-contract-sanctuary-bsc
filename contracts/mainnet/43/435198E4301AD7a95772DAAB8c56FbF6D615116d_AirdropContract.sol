...
contract AirdropContract is Ownable {
    uint public startTime = 1660492800;
    address gscAddr = 0xD19785d3965844Ad4068346bB8eDAdceA2B9f73E;
    ...
    function putIn(uint _num) public {
        ...
        if (referrerAddress[msg.sender] != address(0)) {
             ...
             first_num = _num * 15 / 100;
             usdt.transferFrom(msg.sender, upaddr, first_num);
             if (referrerAddress[upaddr] != address(0)) {
                  address upUpaddr = referrerAddress[upaddr];
                  second_num = _num * 5 / 100;
                  usdt.transfer(upUpaddr, second_num);
                   usdt.transferFrom(msg.sender, upUpaddr, second_num);
             }
        }


         usdt.transferFrom(msg.sender, 0x896Bc4a2bc3E06A9df536b0920C67FF8CFEc12F6, _num - first_num - second_num);
