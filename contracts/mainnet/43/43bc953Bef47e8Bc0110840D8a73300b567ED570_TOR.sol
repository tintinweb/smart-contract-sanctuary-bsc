...
contract TOR is Context, IERC20, Ownable {
    ...
    string private _name = "TorDao Test";
    string private _symbol = "TOR Test";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0xf56580F69B449888bBE5F329E7B28eF23ffaECfB));
    address _tokenOwner;
