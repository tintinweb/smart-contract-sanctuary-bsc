...
contract bnb100 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFE86C380106B3606e37AAaa5515dDB75dB6129C9); 
    address payable public Dev_Wallet = payable(0xFE86C380106B3606e37AAaa5515dDB75dB6129C9);
    ...
    uint256 private _tTotal = 1* 10**3 * 10**_decimals;
    string private constant _name = "100BNB"; 
    string private constant _symbol = unicode"100BNB"; 
    ...
    constructor () {
        ...
        _owner = 0xFE86C380106B3606e37AAaa5515dDB75dB6129C9;
