...
// ORIGINAL ITSUKI CODE
// https://t.me/ItsukiCoin
interface IBEP20 {
...
contract ITSUKI is Context, IBEP20, Ownable {
    ...
    string private _name = "Itsuki"; // token name
    string private _symbol = "ITSUKI"; // token ticker
    ...
    uint256 public minTokenToSwap = 12500000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 10000000000000000 * 1e9;
    uint256 public minBuyLimit = 10000000000000000 * 1e9;
