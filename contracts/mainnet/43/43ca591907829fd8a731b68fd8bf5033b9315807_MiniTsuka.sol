...
contract MiniTsuka is Context, IERC20, Ownable {
    ...
    string private _name = "MiniTsuka";
    string private _symbol = "mTSUKA";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x2e2D9471e4ad0D1C252753d60021671c91068693); // Marketing Address
    address payable public teamWallet = payable(0x2e2D9471e4ad0D1C252753d60021671c91068693); // BuyBack Address
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(teamWallet, amountBNBBuyBack);
