...
contract YOOSHI20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x514e98188dd89523d97b35Fe3b462a622FB40496); // Marketing Address
    ...
    string private _name = "YOOSHI 2.0";
    string private _symbol = "YOOSHI20";
