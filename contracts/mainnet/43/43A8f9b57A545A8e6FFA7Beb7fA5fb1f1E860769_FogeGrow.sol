...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D9AF12D259F23461E7cBAC593F0447Bb0e3B6F2; // owner address
...
contract FogeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FogeGrow";
    string private _symbol = "FogeG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a3D99BA8C5145EA67650Bb473B92073fB850F9b); // Marketing Address
    address payable public teamWalletAddress = payable(0x6D9AF12D259F23461E7cBAC593F0447Bb0e3B6F2); // Team Address
