...
contract SparkLaunch_rev2 is Ownable {
  ...
  function openSale(uint256 _startTime, bool _enableWhitelist) external onlyOwner {
    require(!isInitialized(), "This step should perform before the sale");
  ...
  function buyTokens(uint256 amount) external {
    ...
    if(isWhitelistEnabled) require(whitelistSnapshot.whitelist, "You are not in whitelist");
