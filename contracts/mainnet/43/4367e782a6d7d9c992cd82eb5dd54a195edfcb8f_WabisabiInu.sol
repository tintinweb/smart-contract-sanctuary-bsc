...
/* Token contract */
contract WabisabiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "WabisabiInu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 300) / 10000; // 3% on launch or 2M tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 150) / 10000; // 1.5% or 1M tokens
