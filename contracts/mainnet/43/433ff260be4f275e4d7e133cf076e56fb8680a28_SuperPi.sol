...
contract SuperPi is CTToken {
    constructor() CTToken(
        ...
        9,//Decimals
        10000000000,//Supply
        address(0x9506B14741c46df1BEaac0Bf97E0Ac0CD1F5E533),//FundAddress
        address(0x9506B14741c46df1BEaac0Bf97E0Ac0CD1F5E533),//SSAddress
        address(0xD5563C1EFdB035d3279af1e122055F4A41e19217)
    ){
    }
}