...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x91179265ba79cf29Bcaa78d861D18F8ed63A2396;
...
contract OSKKing is AbsToken {
    constructor() AbsToken(
        ...
        address(0x16f69f556385733970e82Ea96BBc9445FF1640Da),
    
        address(0x7aB6E25D53aB10b8A64B8333F6AC2559ab4E78B5)
    ){
