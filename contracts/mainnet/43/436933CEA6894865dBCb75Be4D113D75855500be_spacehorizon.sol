...
/**
🔥OFFICIAL🔥
🌐Website: https://space-horizon.com/
📞Telegram: https://t.me/SpaceHorizonOfficial

START EXPLORING THE GALAXY AND EARN $SHC TOKENS
Introducing the first space play-to-earn game for PC on the BSC with multi-format game modes.
The player takes the role of a spaceship pilot, and may fight, complete government missions, explore uninhabited planets or trade!
METAVERSE
...
The "credit" is the metaverse money in "Space Horizon". 1 $SHC = 1 credit.
You can spend earned credits on the most powerful ship, or exchange your credits for $SHC to be able to sell them for $BNB.
*/
...
contract spacehorizon is ERC20DividendToken {
