...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x864CD0504a07A75cD704748a9284E5e125458E47;
...
contract ZELENSKYYToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3B8f3b94CC02B1178c128456c4E6Df99E080a1A6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZelenskyyToken";
    string private _symbol = "ZELSKY";
