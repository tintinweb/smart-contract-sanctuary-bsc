...
Telegram: https://t.me/ErogeChain
...
contract ErogeChainContract is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ErogeChain";
    string private _symbol = "EROGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEb3A7b179582Ba97d4Fe647661b09b033b0fcB08);
    address payable public TeamWalletAddress = payable(0xA206D05c1eA52AE4Ca0F5309FBCA51cBCcDDcbac);
    ...
    function removeFromBlackListmulti(address[] calldata addresses) public onlyOwner(){
