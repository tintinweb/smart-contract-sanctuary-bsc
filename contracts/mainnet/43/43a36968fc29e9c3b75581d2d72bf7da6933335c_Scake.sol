...
/*
https://www.scakefinance.com/
S̴̢͇͕̔̀ć̸͍̻̺͘͠a̵̘̪̝̔̿͊k̸͚̝͓͒͒̀ë̸͉̫̘́̔
S̴̢͇͕̔̀ć̸͍̻̺͘͠a̵̘̪̝̔̿͊k̸͚̝͓͒͒̀ë̸͉̫̘́̔
...
██████╔╝╚█████╔╝██║░░██║██║░╚██╗███████╗
╚═════╝░░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝
$Scake is the first Binance smart chain Algorithmic token pegged to $Cake in pancakeswap.
 Scake Finance is a decentralized algorithmic pegged coin on Binance Smart Chain, pegged to the price of 1 
 Cake(pancakeswap.finance) via seigniorage, 1 Scake =1 Cake≈0.019 BNB. 
 ✅Best Tomb fork on earth! ✅FairLaunch for Everyone. 
 ✅KYCed/Audit/No team Token. 
 ✅Solid Money Printer in BSC Chain. 
 ✅Earn 4.26% passive income with staking $Scake everyday!
Scake Token
...
contract Scake is ScakeDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ScakeTeam;
    address private CharityScake;
   
    // token liquidity Scakedata
    ...
    // token title Scakedata
    string public override name = "ScakeFinance";
    string public override symbol = "Scake";
    ...
    constructor(uint totalSupplyValue, address ScakeTeamAddress, address CharityScakeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ScakeTeam = ScakeTeamAddress;
        CharityScake = CharityScakeAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ScakeTeam] =  totalSupply * 4 / 100;
        balances[CharityScake] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ScakeTeam pot
