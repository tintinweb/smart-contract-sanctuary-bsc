...
contract  LuncGrow is Context, IERC20, Ownable {
    ...
    string private _symbol = "LuncGrow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x46945aea73495224BcA0DE874BBca71b78f7fe1D));
        marketWall = payable(address(0x46945aea73495224BcA0DE874BBca71b78f7fe1D));
