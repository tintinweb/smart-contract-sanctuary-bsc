...
contract APE96 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ape1996", "APE96") {
        ...
        // 3% sell tax to start, will be reduced over time.
    	...
    	MarketingWallet = address(0xa30f450986aea15E2c2fAdaD91c3Eb0819857D2e); 
    	DevWallet = address(0xa30f450986aea15E2c2fAdaD91c3Eb0819857D2e); 
    ...
    function updateBuyFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
        ...
        buyDevFee = _DevFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 100, "Must keep fees");
    }
