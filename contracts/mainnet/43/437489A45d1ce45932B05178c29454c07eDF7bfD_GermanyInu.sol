...
Germany Inu is a German fan who will always support the 2022 World Cup matches. We hope Germany can win the World Cup this year.

We will make betting games on every German match according to the community's decision, if your bet choice is correct then you will get 2X the profit of your betting capital.

Chat Will Be Open After Launch.

So Please Start Here Guys.

Telegram: https://t.me/GermanyInuBSC
*/
...
/* Token contract */
contract  GermanyInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xDE77F512cF60e14A23ca8269819cB0e639AF7b06;
    ...
    // Name and symbol
    string constant _name = "Germany Inu";
    string constant _symbol = "GER Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDE77F512cF60e14A23ca8269819cB0e639AF7b06;
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
        ...
        DevelopmentFeeSell = _devFeeSell;
