...
contract DANIELALVESXWORLDCUPINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "daniel alves x worldcup inu";
    string private constant _symbol = "DAXWCI"; 
