...
contract FlyDoge is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("FlyDoge", "DG", 18) {
    uint256 totalTokens = 20000000000000000 * 10**uint256(decimals());
