...
Telegram : https://t.me/TigerGoldBsc
Website : https://twitter.com/TigerGoldBsc
...
contract TIGERGOLD is Context, IBEP20, Ownable {
    ...
    string private _name = "TIGER GOLD"; // token name
    string private _symbol = "TIGER GOLD"; // token ticker
    ...
    uint256 public maxHoldingAmount = 1000000000000 * 1e9;
    uint256 public minBuyLimit = 1000000000000 * 1e9;
