...
uint256 constant distributefee = 25; //持币分红手续费
uint256 constant liquidityFee = 15; //回流手续费
uint256 constant marketFee = 20; //营销手续费
uint256 constant burnFee = 10; //销毁手续费

address constant marketAddr = 0x4Fc57fEDBDC4384780D5Dd544697fAa1ebcCCaaB; //营销地址
...
abstract contract DexBaseUSDT {
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(SHIB, 100, 1 ether);
    }
}
...
abstract contract LiquidityFeeUSDT is Ownable, DexBaseUSDT, ERC20 {
    ...
    uint256 public numTokensSellToAddToLiquidity = 5e17;
...
abstract contract InviteFee is Ownable, ERC20 {
    ...
    uint256 public minInvite = 1 * 1e17;
...
contract wc is
    ...
    InviteFee
{
    uint256 private constant _totalSupply = 10400 * 1e18;
    ...
    constructor()
        ERC20("wc", "wc", 18)
        DividendFee(_totalSupply / 2_0000, true)
        LiquidityFeeUSDT(_totalSupply / 20_0000, true)
        MarketAndBurn()
        InviteFee()
    {
