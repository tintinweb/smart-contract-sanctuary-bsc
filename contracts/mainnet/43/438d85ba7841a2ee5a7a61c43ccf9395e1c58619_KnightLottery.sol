 ...
 */
contract KnightLottery is ReentrancyGuard, IKnightSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInKnight = 50 ether;
    uint256 public minPriceTicketInKnight = 0.005 ether;
     ...
     * @param _knightTokenAddress: address of the CAKE token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _knightTokenAddress, address _randomGeneratorAddress) {
        knightToken = IERC20(_knightTokenAddress);
        ...
        nonReentrant
    {
        ...
        knightToken.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function claimTickets(
        ...
        knightToken.safeTransfer(msg.sender, rewardInCakeToTransfer);
        ...
        nonReentrant
    {
        ...
        knightToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        knightToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInCake >= minPriceTicketInKnight) && (_priceTicketInCake <= maxPriceTicketInKnight),
            "Outside of limits"
        );
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(knightToken), "Cannot be CAKE token");
    ...
    /**
     * @notice Set Knight price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInKnight: minimum price of a ticket in CAKE
     * @param _maxPriceTicketInKnight: maximum price of a ticket in CAKE
     */
    function setMinAndMaxTicketPriceInKnight(uint256 _minPriceTicketInKnight, uint256 _maxPriceTicketInKnight)
        external
        onlyOwner
    {
        require(_minPriceTicketInKnight <= _maxPriceTicketInKnight, "minPrice must be < maxPrice");

        minPriceTicketInKnight = _minPriceTicketInKnight;
        maxPriceTicketInKnight = _maxPriceTicketInKnight;
    }
