...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82B8721E83474e1d3F3253EA4bc8c4866caD3ef3;
...
contract AIApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI APE"; // 
    string private constant _symbol = "AIA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xc8A081286c21C74D52B3192aCF6b1978986F9b15);
