...
GEMIE💫 | Token is LIVE 🔥
@Gemie_Official
An Asian Leading Metaverse Built On Fan Culture. 
Trade $GEM
A Sneak Peak of Our Designs
All the vibrant elements in our Town Square, Gemie Room and Avatar you will soon be able to experience!
Gemie Token
...
contract Gemie is GemieDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GemieTeam;
    address private CharityGemie;
    ...
    string public override name = "Gemie Tama";
    string public override symbol = "Gemie";
    ...
    constructor(uint totalSupplyValue, address GemieTeamAddress, address CharityGemieAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GemieTeam = GemieTeamAddress;
        CharityGemie = CharityGemieAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GemieTeam] =  totalSupply * 4 / 100;
        balances[CharityGemie] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's GemieTeam pot
