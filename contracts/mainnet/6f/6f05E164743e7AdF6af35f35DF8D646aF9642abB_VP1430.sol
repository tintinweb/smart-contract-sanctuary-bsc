...
contract VP1430 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Voyager Pass 1430";
    string private _symbol = "VP1430";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA88f3b75298C45804a566ad202b75C0AdfcdEBFe); // Marketing Address
    address payable public teamWalletAddress = payable(0xA88f3b75298C45804a566ad202b75C0AdfcdEBFe); // Team Address
