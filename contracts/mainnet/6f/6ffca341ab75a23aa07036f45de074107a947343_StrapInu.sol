...
contract StrapInu is Context, IERC20, Ownable {
    ...
    string private _name = "StrapInu";
    string private _symbol = "$STRAP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x750bcc21f7f64e4Bd5b9c209C7b1C61876671430); // Marketing Address
    address payable public teamWalletAddress = payable(0x750bcc21f7f64e4Bd5b9c209C7b1C61876671430); // Team Address
