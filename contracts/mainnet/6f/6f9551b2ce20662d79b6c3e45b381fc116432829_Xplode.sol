...
contract Xplode is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "Xplode";
    string private constant TOKEN_SYMBOL = "XPLODE";
    ...
    address payable public _marketingWallet = payable(0x0234647220950D350F7e263A8C2E470B8c7c0850);
