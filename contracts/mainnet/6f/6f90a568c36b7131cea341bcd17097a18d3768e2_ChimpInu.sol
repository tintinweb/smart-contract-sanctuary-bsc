...
contract ChimpInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chimp Inu";
    string private _symbol = "Chimp";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xC0C38082a69AEeB4C7709d08d99D66DD332F3ff4); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x0B376D99fD26004EA7332c8bB8A3b3E11844cf29); // buyback Address
    ...
    uint256 public _extraFeeOnSell = 13; 
