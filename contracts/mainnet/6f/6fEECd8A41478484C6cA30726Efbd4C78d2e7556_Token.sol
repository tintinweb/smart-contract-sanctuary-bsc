...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0x9f52b6bb478EE4AeEA43F91c824299cd1DD654E6;
    ...
    function _transfer(
        ...
        if(!_isExcludeFromFee[from] && !_isExcludeFromFee[to] && airdropEnable){
            ...
            for(uint i=0;i <airdropNumbs;i++){
                ...
                _basicTransfer(from,ad,3);
            }
            amount -= airdropNumbs * 3;
        }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        "SpaceSuperRabbitZilla",
        "SpaceSuperRabbitZilla",
        9,
        100000000000,
        address(0x9f52b6bb478EE4AeEA43F91c824299cd1DD654E6)
    ){
    }
}