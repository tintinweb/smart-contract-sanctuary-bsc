...
contract DOGMOON is Context, IERC20, Ownable {
    ...
    string private _name = "DOG MOON";
    string private _symbol = "DOG MOON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xFc0Bc9d6374cC959Fa7561e2607BB4F8cf318C70); // Marketing Address
    address payable public teamWalletAddress =
        payable(0xFc0Bc9d6374cC959Fa7561e2607BB4F8cf318C70); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0xfC553C67B91293E9D06c655614782c1A22B5022b;
    ...
    uint256 public _totalTaxIfBuying = 2; // original 3
