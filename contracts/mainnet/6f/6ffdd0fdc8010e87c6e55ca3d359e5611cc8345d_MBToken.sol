...
=== 'MB Token' Token contract with following features ===
    => BEP20 Compliance
...
contract MBToken is owned {
    
    using SafeMath for uint256;

    string constant private _name = "MBToken";
    string constant private _symbol = "MB";
