...
contract DaddyShidoInu is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = unicode"Daddy Shido Inu";
    string constant _symbol = unicode"DSINU";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(swapdevelopmentFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _swapdevelopmentFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        swapdevelopmentFee = _swapdevelopmentFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_swapdevelopmentFee).add(_marketingFee);
