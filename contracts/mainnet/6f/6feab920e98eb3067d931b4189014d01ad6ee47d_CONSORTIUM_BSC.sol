...
Telegram https://t.me/Consortium_bsc
...
contract CONSORTIUM_BSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CONSORTIUM BLOCKBIT";
    string private _symbol = "CONSORTIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB0dcaBD1Fd77b0f16c7d006b2dBF7183D44Db402); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x110003880010463eFf1EFeaC80A5103B47ad2Dab); // BuyBack Address
