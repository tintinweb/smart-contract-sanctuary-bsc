...
/**
StakeBUSD official links:
Website: https://stakebusd.finance
Telegram: https://t.me/stakebusd
Twitter: https://twitter.com/stake_busd

Fork Baked Beans V2 BUSD EDITION.
*/
...
contract StakeBUSD is Context, Ownable {

    using Math for uint256;
    address public OWNER_ADDRESS;
    bool private initialized = false;
    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public DEV_ADDRESS = 0x7889797ea15Dbad9A5ED25FA32743a76F8fdE87e;
    address public MARKETING_ADDRESS = 0x6dEe1C78F0EAbe2484f7877406Ea03b34AfF780e;
    address public CEO_ADDRESS = 0x17bEd7ed8e0F02eb45D6dfe346E10fd52969a062;
    address public GIVEAWAY_ADDRESS = 0xa8525e8ADa1beF4Bde661236636bD07AaF44Ff33;
    ...
    function hasBeanTaxed(address adr) public view returns (uint256) {
        ...
        if (lastDigit <= 0) return 85;
        if (lastDigit <= 1) return 75;
        if (lastDigit <= 2) return 65;
        if (lastDigit <= 3) return 55;
        if (lastDigit <= 4) return 45;
        if (lastDigit <= 5) return 35;
        if (lastDigit <= 6) return 25;
        if (lastDigit <= 7) return 15;
        if (lastDigit <= 8) return 5;
        return 0;
    }
    ...
    function dailyReward(address adr) public view returns (uint256) {
        ...
        if (referralsCount < 10) return (55000);
        if (referralsCount < 20) return (60000);
        if (referralsCount < 30) return (65000);
        if (referralsCount < 40) return (70000);
        if (referralsCount < 50) return (75000);
        return 80000;
    }
