...
DONT BUY UNLESS WE GIVE SIGNAL ON TELEGRAM JOIN US !
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9AEe747800a2ff909D4249683449032305078814; // owner address
...
contract KingShiba is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9AEe747800a2ff909D4249683449032305078814); // Marketing Address
    address payable public teamWalletAddress = payable(0x9AEe747800a2ff909D4249683449032305078814); // Team Address
