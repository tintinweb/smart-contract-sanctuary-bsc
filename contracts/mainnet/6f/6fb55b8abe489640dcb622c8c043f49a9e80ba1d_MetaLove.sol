...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x93073d13365278caAE0AFC1AF2613B95Fd5E1b23;
        _owner = msgSender;
...
contract MetaLove is Context, IBEP20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;
    
    address public marketingAddress = 0x4cDc04a7823CA5B31415c9bfcd5fCf83Be502654; // Marketing wallet Address.
    ...
    uint256 private _tTotal = 500_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MetaLove";
    string private _symbol = "MetaLove";
    ...
    uint256 private minimumTokensBeforeSwap = 50_000 * 10**18; 
    ...
    function _transfer(address from, address to, uint256 amount) open(from, to) private 
    {
        ...
        uint256 contractTokenBalance = balanceOf(address(this))-clifedAmount;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private 
    {
        ...
        if(balanceOf(deadAddress)<_tTotal.div(2))
        {
           burnTokens = amount.mul(_burnFee).div(100);
        }
