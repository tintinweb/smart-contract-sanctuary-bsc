...
Meet Foge!
A new meme token which is a peer-to-peer digital asset

| Website |
https://www.fogecoin.site/
| Telegram |
https://t.me/fogegrowportal
| Mint NFT |
https://fogenft.com/
...
contract FogeGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Foge Grow";
    string constant _symbol = "FOGEG";
    ...
    uint256 private Development     = 1;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + Development;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc11F8D8fae0b2948aE28f78237789d402C29D19E;
        DevelopmentReceiver = 0xc11F8D8fae0b2948aE28f78237789d402C29D19E;
    ...
    function ChangeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _Development, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        Development= _Development;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_Development);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator);
    }
  
    function ChangeFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _DevelopmentReceiver ) external authorized {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(Development).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(DevelopmentReceiver).call{value: amountBNBDev, gas: 30000}("");
