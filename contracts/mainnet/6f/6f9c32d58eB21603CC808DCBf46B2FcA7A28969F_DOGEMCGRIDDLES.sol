...
contract DOGEMCGRIDDLES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEMCGRIDDLES"; 
    string private _symbol = "DMCGRIDDLES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D84A4b2B6Bf3D435e569372c4e6D75525Af7B93);
    address payable public teamWalletAddress = payable(0x3D84A4b2B6Bf3D435e569372c4e6D75525Af7B93);
