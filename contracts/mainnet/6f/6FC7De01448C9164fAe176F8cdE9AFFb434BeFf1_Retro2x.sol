...
contract Retro2x is ERC20, Ownable {
    uint256 public tax = 5;

    address public marketingWallet = 0xA75AB71a1e94F735D4A3FEde4b5A87C7526414C8;
    ...
    constructor () ERC20("Retro 2x", "R2X") 
    {   
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 tokensToLiquidity = contractTokenBalance / 4;
            ...
            addLiquidity(tokensToLiquidity, deltaBalance / 3);
