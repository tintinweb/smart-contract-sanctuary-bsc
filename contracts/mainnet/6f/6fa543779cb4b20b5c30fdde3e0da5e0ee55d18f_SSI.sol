...
contract SSI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Space Snake Inu";
    ...
    uint256 public swapTokenAtAmount = 20000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0xBB70a5aFB5e644b0B64Fc2e2684C04cA4262C816);
