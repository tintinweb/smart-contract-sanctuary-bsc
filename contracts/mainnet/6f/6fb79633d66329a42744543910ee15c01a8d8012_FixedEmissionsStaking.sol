...
contract FixedEmissionsStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address _stakingToken, address _rewardToken, uint256 _rewardsPerSecond, uint256 _lockDurationInDays, uint256 _exitPenaltyPerc) {
    ...
    function compound() external nonReentrant {
        require(stakingToken == rewardToken, "Cannot compound differing tokens");
        PoolInfo storage pool = poolInfo[0];
        UserInfo storage user = userInfo[msg.sender];
