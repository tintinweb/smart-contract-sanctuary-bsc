...
/**
 *Official Project DUSD
 *Welcome to the Official DUSD Miner.
 *Get 12% for each referral
 *Official developers of DUSD developers.
 *Official project site.   
 *www.miner.dusd.network
...
contract INSURANCE {
	...
	address private tokenAddr = 0x5EbA288F8833071bA7Cd5C2B356754811c0CE8Fb; // DUSD token
	IERC20 public token;
...
contract DUSDMiner {
	...
	uint256 constant private INVEST_MAX_AMOUNT = 5000000 ether;
	uint256[] private REFERRAL_PERCENTS = [120];
	uint256 constant private TOTAL_REF = 120;
	uint256 constant private CEO_INVEST_FEE = 40;
    uint256 constant private CEO_WITHDRAW_FEE = 50;
	uint256 constant private DEV_FEE = 40;
	uint256 constant private HOLD_BONUS = 200;
	...
	uint constant public INSURANCE_PERCENT = 200;            // insurance fee 20% of withdraw
