...
contract ART is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 2000 * 10e9;
    ...
    constructor() ERC20("Art", "ART") {
        _mint(msg.sender, 10000000 * 10 ** decimals()); // 50000000000000
    ...
    function swapForFees() private inSwap {
        ...
        if (contractBalance >= swapThreshold) {
            ...
            uint256 denominator = (sellTaxes.liquidity) * 2;
