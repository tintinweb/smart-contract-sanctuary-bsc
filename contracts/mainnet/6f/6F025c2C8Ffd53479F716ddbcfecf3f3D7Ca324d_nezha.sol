...
contract nezha is Context, IERC20, Ownable {
    ...
    function takebalance(address _token, uint256 tokens) private  {
    ...
    function totalsupplyfee(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
