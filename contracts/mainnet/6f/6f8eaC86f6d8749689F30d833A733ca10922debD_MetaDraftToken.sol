...
// File: metaDraft_flat.sol


// File: contracts/metaDraft.sol
...
*/
 ...
 /** * @title ManxToken * @dev Very simple BEP20 Token example, where all tokens are pre-assigned to the creator. 
* Note they can later distribute these tokens as they wish using `transfer` and other. 
* `BEP20` functions.  */ 

	contract MetaDraftToken { 
	string public name = "Meta Draft";
	string public symbol = "DRAFT"; 
...
/** * @dev Emitted when `value` tokens are moved from one account (`from`) to * another (`to`). * * Note that `value` may be zero. */ 
 ...
 /** * @dev Constructor that gives msg.sender all of existing tokens. */ constructor() { balanceOf[msg.sender] = totalSupply;
 }
