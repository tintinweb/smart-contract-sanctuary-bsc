...
contract ApeMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeMusk"; //
    string private constant _symbol = "ApeMusk"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xF78276935A3b714280c537a89Fc4b5Fe0283b3E2 ;
    ...
    function includeInFee(address account) public onlyOwner {
        ...
        function MaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
