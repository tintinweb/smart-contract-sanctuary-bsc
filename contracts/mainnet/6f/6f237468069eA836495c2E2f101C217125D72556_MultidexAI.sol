...
contract MultidexAI is IERC20 {
    ...
    string constant private _name = "Multidex-AI";
    string constant private _symbol = "MDA";
    ...
    address payable public taxWallet = payable(0xdC6a24C0a5f71a5C2983E5F05b83cd8D99276B34);
...
//===============================================================================================================
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (feeAmount > 0) {
            _tOwned[taxWallet] += feeAmount;
            emit Transfer(from, taxWallet, feeAmount);
        }
