...
/*
ROSE.ai
oin us during #BUIDLWEEK to hear from web3 experts on the most pressing issues regarding privacy in blockchain
Roseai
Artist
Find my music on all platforms!
NEW ARTIST MERCH OTW! 🌍🔥🐲
Need recording, mixes or masters? Hit me up for TOP QUALITY engineering.
Based in Vegas 📍
...
abstract contract Contextbep20ROSEAI {
...
contract Ownablebep20ROSEAI is Contextbep20ROSEAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20ROSEAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20ROSEAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ROSEAIToken  is Contextbep20ROSEAI, bep20ROSEAI, Ownablebep20ROSEAI {
    ...
    string private _name = 'ROSEAI';
    string private _symbol = 'ROSEAI';
