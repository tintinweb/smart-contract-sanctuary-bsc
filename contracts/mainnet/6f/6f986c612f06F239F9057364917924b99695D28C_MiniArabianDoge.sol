...
From the community of ArabianDoge. Dev is from DogeWealth (Previous ATH $69,000) , a DOGE rewarding token . 
Dev found promising potential in ArabianDoge and decided to do ArabianDoge.

✅ High potential project
✅ Rewarding holder in ArabianDoge
✅ Hold MiniArabianDoge and get free ArabianDoge
✅ Experienced Dev 
✅ Bullish Name
✅ Potential $69,000 from initial $450 Marketcap (153x)

TG : https://t.me/miniArabianDoge
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0x5cB7e2dC122b33c7b191799ca7E23d5b4A15fBD0); 
...
contract MiniArabianDoge is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniArabianDoge";
    ...
    uint256 public _maxWallet = _totalSupply.mul(390).div(10000);
    ...
    function checkTxLimit(address sender, address recipient, uint256 amount) internal view {
        if (!excludeMaxWallet[recipient] && !excludeFee[recipient]) {
