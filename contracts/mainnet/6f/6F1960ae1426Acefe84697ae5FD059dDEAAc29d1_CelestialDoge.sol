...
#Celestial Doge The 
   ...
   I make this #CelestialDoge to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/CelestialDoge
   ...
   I will renounce the ownership to burn addresses to transfer #CelestialDoge to the community and ensure it's 100% safe.

   I will add 1 BNB and 99% of the total supply to the pool
   Can you make #CelestialDoge 10000000X? 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x692bdc9C9bcf711F3428074c0d3a58b6Cb93A305; // owner address
...
contract CelestialDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CelestialDoge";
    string private _symbol = "CelestialDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3DBEA12869ed0148198F6EceBe2eB74ADB239C4C); // Marketing Address
    address payable public buybackWalletAddress = payable(0x3DBEA12869ed0148198F6EceBe2eB74ADB239C4C); // Buyback Address
