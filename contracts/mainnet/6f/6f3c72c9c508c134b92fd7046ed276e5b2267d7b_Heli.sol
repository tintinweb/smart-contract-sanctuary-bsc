...
contract Heli is Context, IERC20 { 
    ...
    address payable private DevWallet = payable(0xAB9D81F8e2c0C5de4E0558a97625B2Bb1aA4B5c3);
    address payable private MarketingWallet = payable(0xa873d5D3B657c423D31026489fb1f2E9Ab9aDB9B);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && tradingActiveBlock + 15 seconds <= block.timestamp) {idclaim();}
