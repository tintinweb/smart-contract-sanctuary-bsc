...
contract BaseToken is Ownable {
    ...
    string constant public name = 'WangLiHong';

    string constant public symbol = 'WangLiHong';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 1000000000000*10**uint256(decimals);

    uint256 public constant MAXSupply = 1000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0xDB98ffAa155806251e431771054C6Ce2a00E6E65;
...
contract WangLiHong is BaseToken {
