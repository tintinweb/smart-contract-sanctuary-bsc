...
contract ShrimpShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name               = "ShrimpShiba";
    string constant _symbol             = "SHRIMPSHIBA";
    ...
    function Reflections(address[] calldata addresses, bool status) public onlyOwner {
