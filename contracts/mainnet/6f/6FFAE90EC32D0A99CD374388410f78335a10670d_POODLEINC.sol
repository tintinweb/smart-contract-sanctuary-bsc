...
contract POODLEINC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Poodle Inc";
    string constant _symbol = "POODLE";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xa7D4BaEEf82325CC604220Eb7A1B18eEA6e2868B;
        marketingWallet = 0x9B01030cb5fF1bB5E7153a81252aac18f10Bcd6a;  //marketingwallet
        anothermarketingWallet = 0xF43Ac62986Fe59Aa4160d861DDF3117Fca8cEa9d; //backup wallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(anothermarketingWallet).call{value: anothermarketingShare, gas: 50000}("");
