...
//Proof Of Gala is a community token that can be used by the community and the public that will unite the Crypto Community,
//and will provide great passive income for new investors.

//Tg : https://t.me/ProofOfGala
...
contract POG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Gala"; // 
    string private constant _symbol = "$POG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x20f047f600f290F5CFd7769EbB7b79d2d187280C;
