...
contract BNBM {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 0.05 ether;			// 0.01BNB
	uint[] public					REFERRAL_PERCENTS				= [50, 30, 20, 5, 5];	// 7% 2% 1% 0.5% 0.5%
	uint constant public			DEV_FEE							= 100;					// dev fee 10% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 30 ether;				// claim 25 BNB max per time
