...
contract ADTest is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 100000000* 10 ** 18;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 18;
    uint256 MAX_LOCK   = 100000000 * 10 ** 18;
    ...
    address public addressForBuyBack;

    uint256 public tokensForRewards   = MAX_TOKENS_FOR_REWARDS;

    // Anti bot-trade
    bool public antiBotEnabled;
    uint256 public antiBotDuration = 0 minutes;
    uint256 public antiBotTime;
    uint256 public antiBotAmount;

    // Transfer fee
    uint256 public sellFeeRate = 12;
    uint256 public buyFeeRate = 12;


    constructor() ERC20("ADTest", "ADT") {
        addressForMarketing = address(0x1173CB6df3C01aE34eA4B7663CE017a20Eb47726);
        addressForBuyBack = address(0xd3c4275B6bfeC21ecbf70189095be7Afd2c389D4);
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender, uniswapV2Pair, _fee.mul(2).div(12));
                super._transfer(sender, addressForBuyBack, _fee.mul(6).div(12));
                super._transfer(sender, addressForMarketing, _fee.mul(4).div(12));
