...
contract MountainMinerBNB is Ownable{
    ...
    uint256 public MIN_DEPOSIT_LIMIT = 0.0033 ether;
    uint256 public MAX_WITHDRAW_LIMIT = 3.3 ether;
    uint256[5] public ROI_MAP = [161 ether, 321 ether, 1_600 ether, 3_200 ether, 16_000 ether];
