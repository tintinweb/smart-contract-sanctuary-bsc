...
contract BakedDoge is IBEP20, Auth {
    ...
    string constant _name = "BakedDoge";
    string constant _symbol = "BakedDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 200; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100; //2%
    ...
    address private marketingFeeReceiver = 0x78BfC65182a8022a10B7FCEB153365d8a733826c;
    address private developmentFeeReceiver = 0x78BfC65182a8022a10B7FCEB153365d8a733826c;
