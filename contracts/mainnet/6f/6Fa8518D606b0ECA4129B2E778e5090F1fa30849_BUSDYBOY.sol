...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWRD = IBEP20(0x842BFbA3603bD97F1ae49122F0b56C073d56031F); // To Reward Holders
...
/* Token contract */
contract BUSDYBOY is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWRD = 0x842BFbA3603bD97F1ae49122F0b56C073d56031F; // Reward Token (BPET)
    ...
    address DEV = 0xBC647084F69A290dED14A1c694A41001310BEC00; // Wallet Developer
    ...
    // Name and symbol
    string constant _name = "BUSDY BOY";
    string constant _symbol = "BBOY";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);  // 1 BILLION Supply

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 20 Millions 2% Supply
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 20 Millions 2% Supply
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 20 Millions 2% Supply
    ...
    uint256 public totalFeeBuy = 9; //  Not more that 5% Total Tax
    ...
    uint256 public marketingFeeSell = 3; // Calls Marketing Telegram Future
    uint256 public devFeeSell = 1; // Continue Development and Pay team
    uint256 public totalFeeSell = 9; //  Not more that 10% Total Tax
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAC44586b9828Bf13Bc17ca915e15493B63e1607c; // Wallet Marketing Work
