...
// telegram: https://t.me/DoughnutFloki
...
contract DoughnutFloki is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500_000_000 * 10**_decimals;
    ...
    address public marketingWallet =0x8454637B64b3E2e3bc77AE01e917057bab54D40B;
    address public devWallet = 0x8454637B64b3E2e3bc77AE01e917057bab54D40B; 
    address public operationWallet = 0x8454637B64b3E2e3bc77AE01e917057bab54D40B;
    address public charityWallet = 0x8454637B64b3E2e3bc77AE01e917057bab54D40B; 

    string private constant _name = "Doughnut Floki";
    string private constant _symbol = "DFLOKI"; 
    ...
    Taxes public sellTaxes = Taxes(0, 20, 10, 20, 0, 0);
