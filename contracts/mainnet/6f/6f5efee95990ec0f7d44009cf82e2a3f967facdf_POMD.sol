...
THE MEMECOIN PUP OF THE POM NFT MARKETPLACE

Introducing the currency of the revolutionary meme.love NFT marketplace.

The Proof Of Memes Dog - Pomeranian.
*/
...
contract POMD is Context, POMDECO, Ownable {
    ...
    string private _name = 'Proof Of Memes Dog';
    string private _symbol = 'POMD';
