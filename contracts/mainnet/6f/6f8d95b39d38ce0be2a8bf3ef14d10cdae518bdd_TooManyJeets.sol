...
contract TooManyJeets is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xE39A195089705a7Ea69D8e5f998ecAe4Aa17ad2C;
    address public devWallet = 0x1bc84A94a5A71Bc7634964F7a7B076F8cdBD9150;
    address public buybackWallet = 0x07634cC441d97FFcab4D454B9880242fd1eA5652;

    string private constant _name = "TooManyJeets";
    string private constant _symbol = "TMJ";
    ...
    Taxes public taxes = Taxes(2, 5, 3, 1, 2);
    Taxes public sellTaxes = Taxes(2, 3, 3, 1, 4);
