...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        marketingAddress[0] = address(0x29CF78a5a7F3f04c5d35F1B6e0d1139Bfe19e3F8);
...
contract MetaDoge is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("MetaDoge", "MetaDoge") {
        ...
        address _initHolder = 0x79871c354D5f515b68612Fe30Cebd97913674AFC;
