...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14F0306135EAcf1778810f68fdb1d54F42Cd5949;
...
contract Token is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xDC20Ad069a89f0473104868939a61a73676E6414;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lunc Squid";
    string private _symbol = "LuncSquid";
