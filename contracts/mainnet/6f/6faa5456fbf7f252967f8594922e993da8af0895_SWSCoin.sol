...
contract SWSCoin is Context, IERC20, Ownable {
    ...
    string private _name = unicode"二舅他大爷的奶奶的表婶的三外甥";
    string private _symbol = unicode"三外甥";

    uint256 private _zeroTax = 4;
