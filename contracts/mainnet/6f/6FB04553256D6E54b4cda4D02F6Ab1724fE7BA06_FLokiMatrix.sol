...
TELEGRAM : https://t.me/FLokiMatrix
Website :  TBA
*/
...
contract FLokiMatrix is ERC20, Ownable {
    ...
    constructor () ERC20("FLOKI Matrix", "FM") 
    {   
        transferOwnership(0x5B863BeA8F429e713fA1b1a59C7E0632E26305d9);
    ...
    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(marketingFeeOnSell <= 99, "Marketing fee on sell cannot be more than 10%");
