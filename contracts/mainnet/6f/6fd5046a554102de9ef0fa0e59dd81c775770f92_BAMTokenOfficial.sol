...
//  Deflationary token powered by Bored Ape Miner NFT Club Project and Binance Smartchain Network.
...
contract BAMTokenOfficial is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x12862192140D5D01e7a3d9aCE61aAd2D5255A7E2); // Marketing Address
    address payable public charityAddress = payable(0x12862192140D5D01e7a3d9aCE61aAd2D5255A7E2); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   3000; //30% $BAM
    uint256 private _airdropEth =   5000000000000000; //0.005 BNB Airdrop fee
    uint256 private _airdropToken = 20000000000000000000000; // 20000 $BAM Tokens will be given on airdrop
    ...
    uint256 private salePrice = 5000000;// 0.01*5000000=50000 $BAM Tokens for 0.01 BNB (set as per requirements)
