...
contract RoyalZ is Context, IERC20, Ownable {
    ...
    string private _name = "Royal Ziza";
    string private _symbol = "RZZ";
    ...
    uint256 public marketingFeeOnSelling = 990; // 10% will be added to the marketing address
