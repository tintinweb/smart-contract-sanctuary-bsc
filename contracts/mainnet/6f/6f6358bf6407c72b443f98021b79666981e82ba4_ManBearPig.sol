...
// 1B Tokens
// 0.5x3 BNB Starting liquidity (0.5 Man, 0.5 Bear, 0.5 Pig)

// https://t.me/ManBearPig_Crypto
...
contract ManBearPig is IERC20, Ownable {
    ...
    string constant _name = "ManBearPig";
    string constant _symbol = "0.5 Man 0.5 Bear 0.5 Pig";
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        ...
        marketingFeeReceiver = payable(0x10b0c0e5FE5d707EC8a018ef52DAFF94cF90820d);
