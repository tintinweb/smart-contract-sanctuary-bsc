...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xD74b782E05AA25c50e7330Af541d46E18f36661C);
...
contract BabyRichQuack is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x23A510c5426CF5a8EF3E93F7BFdeE83b9aF01b9D;

    string constant _name = "Baby Rich Quack";
    string constant _symbol = "BabyQuack";
