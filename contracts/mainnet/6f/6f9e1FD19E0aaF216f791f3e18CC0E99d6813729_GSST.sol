...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address RouterAddress, address USDTAddress, address marketAddress, address TeamAddress, address ReceiveAddress){
        ...
        uint256 total = Supply * 10 ** Decimals * 300;
        _totalSupply = total;
    ...
    function _transfer(
        ...
        if (_feeWhiteList[from] || _feeWhiteList[to]){
            ...
            if (_swapPairList[to] || _swapPairList[from]) { 
                if(balanceOf(address(0))<999800000000000000000000000) _tokenTransfer(from, address(0), amount/50, 0);         
                _tokenTransfer(from, _marketAddress, amount/100, 0); 
                _tokenTransfer(from, _teamAddress, amount/100, 0);
                _tokenTransfer(from, _mainPair, amount/25, 0);
                _tokenTransfer(from, to, amount*92/100, 0); 
...
contract GSST is AbsToken {
    constructor() AbsToken(
        "GOLD STANDARD SNIPER TOKEN",
        "GSST",
        18,
        1e8,
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955), 
        address(0xBC0955B721664A5Ac70956A0cC85B5fbCeAE3736), 
        address(0x764818Ae368eeDa9249365800EB787De40001b58), 
        address(0xFb6BE597655159250E80D728208E53015480b901) 
    ){
