...
contract MIKUMIKUMI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby MikuMikuMi";
    string private _symbol = "$BMMM";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xe608736c8EB1Bd4083444A043B1588Ec97EBA250); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xe608736c8EB1Bd4083444A043B1588Ec97EBA250); // Team Address
