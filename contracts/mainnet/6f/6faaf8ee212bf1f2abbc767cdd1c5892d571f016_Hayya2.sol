...
contract Hayya2 is Context, IERC20, Ownable {
    ...
    string private _name = "Hayya2.0";

    string private _symbol = "Hayya2.0";
    ...
    address payable public marketAddress = 0x0B8a463521d1D26995558cc316320fcB8a27Db0D ; //Marketing
