...
contract SUPERKOALA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPERKOALA";
    string private _symbol = "SUPERKOALA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x73a5Ff2163Fd3c993362E1DC98F028a6CbE06391); // Marketing Address
    address payable public teamWalletAddress = payable(0x73a5Ff2163Fd3c993362E1DC98F028a6CbE06391); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x73a5Ff2163Fd3c993362E1DC98F028a6CbE06391),
            block.timestamp
        );
    }
