...
Telegram : https://t.me/GamblerDoge
* Wbnb Reward : 
TokenNomics : 50% Burn
50% PancakeSwap
...
contract GamblerDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Gambler Doge";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 31 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 361 / 100000; // 0.3
    bool inSwap;
