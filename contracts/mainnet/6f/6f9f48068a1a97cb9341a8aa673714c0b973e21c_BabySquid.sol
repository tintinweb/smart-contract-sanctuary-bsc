...
contract BabySquid is Context, IERC20, Ownable {
    ...
    string private _name = "BabySquid2.0";
    string private _symbol = "BSTWO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCc71E3c6B8aC79Ea1A99FB09De4358B0287caA9c));
        marketingWalletAddress = payable(address(0xCc71E3c6B8aC79Ea1A99FB09De4358B0287caA9c));
