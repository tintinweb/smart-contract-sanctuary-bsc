...
interface IDepositExecute {
    /**
        @notice It is intended that deposit are made using the StarlinkBridgeCRO contract.
        @param destinationChainID Chain ID deposit is expected to be bridged to.
        @param depositNonce This value is generated as an ID by the StarlinkBridgeCRO contract.
        @param depositer Address of account making the deposit in the StarlinkBridgeCRO contract.
    ...
    /**
        @notice It is intended that proposals are executed by the StarlinkBridgeCRO contract.
...
/**
    @title Interface for StarlinkBridgeCRO contract.
    @author ChainSafe Systems.
 */
interface IStarlinkBridgeCRO {
    /**
        @notice Exposing getter for {_chainID} instead of forcing the use of call.
        @return uint8 The {_chainID} that is currently set for the StarlinkBridgeCRO contract.
     */
...
interface IERCHandler {
    ...
    /**
        ...
        @param newStarlinkBridgeCROAddress Address of the updated bridge address.
    */
    function updateStarlinkBridgeCROAddress(address newStarlinkBridgeCROAddress) external;
}
...
/**
    ...
    @author ChainSafe Systems.
 */
contract StarlinkBridgeCRO is Pausable, AccessControl, SafeMath {
    ...
    address public _starlinkAddress;
    ...
    constructor (uint8 chainID, uint256 initialRelayerThreshold, uint256 fee, uint256 expiry, address wtoken, address wstarlink) public {
        _chainID = chainID;
        _relayerThreshold = initialRelayerThreshold;
        _fee = fee;
        _expiry = expiry;
        _wtokenAddress = wtoken;
        _starlinkAddress = wstarlink;
    ...
    /**
        ...
        @param depositNonce ID of proposal generated by proposal's origin StarlinkBridgeCRO contract.
    ...
    /**
        ...
        @param newStarlinkBridgeCROAddress Address of the updated _bridgeAddress.
     */
    function adminUpdateStarlinkBridgeCROAddress(
        address handlerAddress,
        address newStarlinkBridgeCROAddress
    ) external onlyAdmin {
        IERCHandler handler = IERCHandler(handlerAddress);
        handler.updateStarlinkBridgeCROAddress(newStarlinkBridgeCROAddress);
    }
    ...
    /**
        ...
        @notice Only callable when StarlinkBridgeCRO is not paused.
    ...
    /**
        ...
        @notice Only callable by relayers when StarlinkBridgeCRO is not paused.
        @param chainID ID of chain deposit originated from.
        @param depositNonce ID of deposited generated by origin StarlinkBridgeCRO contract.
