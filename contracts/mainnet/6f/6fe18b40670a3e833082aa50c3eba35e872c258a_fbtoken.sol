...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xEB05200a624A852B379B072568C3de23f8b136ae;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xEB05200a624A852B379B072568C3de23f8b136ae),//fund address
    
        address(0xEB05200a624A852B379B072568C3de23f8b136ae)//dev address
    ){
