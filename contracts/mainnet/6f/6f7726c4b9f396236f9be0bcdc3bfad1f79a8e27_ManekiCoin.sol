...
/** 
 ...
 Telegram   : https://t.me/manekicoinbsc
...
contract ManekiCoin is Context , IERC20, Ownable {
    ...
    string private _name = "MANEKI COIN BSC";
    ...
    address public marketingWallet = 0x1278bD2F6E821EfB0a3577A150547eD09eF3538F; 
    ...
    uint256 public _maxWalletToken = 10 * 10**6 * 10**9;
    ...
    function updateFee(uint256 taxFee,uint256 burnFee,uint256 marketingfee ,uint256 LiquidityFee) external onlyOwner() {
        _taxFee = taxFee;
        _burnFee = burnFee;
