...
// Black Valentine $BLACK
// Join the cryptoporn revolution!

// www.BlackValentine.love
...
contract blackvalentine is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private constant gasPriceLimit = 100 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() ERC20("Black Valentine", "$BLACK") {
		...
		marketingWallet = 0xdd06C9131D7B19ec96DC192c9efb932aFbD81Db6;
    ...
    function updateBuyFees(
        ...
        buyTotalFees =
            ...
            buyDevFee +
            buyBuyBackFee;
        require(buyTotalFees <= 20, "Fees are locked and safe");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees =
            ...
            sellDevFee +
            sellBuyBackFee;
        require(sellTotalFees <= 20, "Fees are locked and safe");
    }
    ...
    fallback() external payable{
        revert ("Don't send tokens to this address.");
    }
