...
TTPROTOCOL
@TTPROTOCOL
Borderless lending protocol with low transaction fees and cross-chain interoperability.
TTPROTOCOL.IO
*/
...
contract TTPROTOCOL is Context, TTPROTOCOLECO, Ownable {
    ...
    string private _name = 'TT PROTOCOL';
    string private _symbol = 'TT PROTOCOL';
