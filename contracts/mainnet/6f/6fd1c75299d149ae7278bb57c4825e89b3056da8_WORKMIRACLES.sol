...
contract WORKMIRACLES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WORKMIRACLES";
    string private _symbol = "WORKMIRACLES";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x40A421591525C86a718Cecc51d1EB2b21A64E603); // Marketing Address
    address payable public teamWalletAddress = payable(0x40A421591525C86a718Cecc51d1EB2b21A64E603); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x40A421591525C86a718Cecc51d1EB2b21A64E603),
            block.timestamp
        );
    }
