...
contract LittlePussy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Pussy 2.0";
    string private constant _symbol = "PSSY2.0";
