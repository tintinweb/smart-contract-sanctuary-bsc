...
/**
Telegram : https://t.me/redbullinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfDC67504Ba1F823FfE6480106D625397aE1D2547; // owner address
...
contract RedBullInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RedBull Inu";
    string private _symbol = "RedBull";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfDC67504Ba1F823FfE6480106D625397aE1D2547); // Marketing Address
    address payable public teamWalletAddress = payable(0xfDC67504Ba1F823FfE6480106D625397aE1D2547); // Team Address
