...
*TELEGRAM: https://t.me/LORDFLOKIII
*/
...
contract LordFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LordFloki"; 
    string private _symbol = "LordFloki"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE0B00d50DC5909cAdfeFE5ffD40a9fe885A1A044); 
