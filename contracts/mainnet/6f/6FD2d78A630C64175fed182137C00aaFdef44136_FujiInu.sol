...
contract FujiInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xd09941bFB1502e45137DdeC753D4238819FF8163;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xd09941bFB1502e45137DdeC753D4238819FF8163] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xd09941bFB1502e45137DdeC753D4238819FF8163] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xd09941bFB1502e45137DdeC753D4238819FF8163,
                block.timestamp
            );
