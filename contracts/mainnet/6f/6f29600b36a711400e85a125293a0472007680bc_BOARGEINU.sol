...
contract BOARGEINU is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BOARGE INU"; // 
    string constant _symbol = "BOARGE"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (5); 
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (5); 
    uint256 public _maxWalletToken = _totalSupply / (100) * (5); 

    // Fees receivers
    address private autoLiquidityReceiver = 0xAB36bF47A396A2c56eC4B0357a74721B0C598C04; 
    address private marketingFeeReceiver = 0xEBE05600f4519E4453c5b7d094F9947F032bdC16; 
    address private devFeeReceiver = 0xD7438f3fe839aA739bADEd91cBd34C72d40525dC; 
    address private teamFeeReceiver = 0xD7438f3fe839aA739bADEd91cBd34C72d40525dC; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xd4cC9dd76B5c22279f0A4DDbe9F6556393d8EC3e;
