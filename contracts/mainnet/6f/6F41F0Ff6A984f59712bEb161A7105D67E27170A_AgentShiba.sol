...
abstract contract Auth {
     ...
     */
    function isOwner(address dead) public view returns (bool) {
        return dead == owner;
    }
...
/* Token contract */
contract AgentShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xf8701ebABc28F41287585AA8Cf1Baf9F06858414;
    ...
    // Name and symbol
    string constant _name = "Agent Shiba";
    string constant _symbol = "ASHIB";
    ...
    uint256 public swapThreshold = _totalSupply * 37 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf8701ebABc28F41287585AA8Cf1Baf9F06858414;  
    ...
    function getOwner() external view override returns (address) { return DEAD; }
