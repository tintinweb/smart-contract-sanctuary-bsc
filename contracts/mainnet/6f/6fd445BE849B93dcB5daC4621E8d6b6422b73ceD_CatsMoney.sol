...
contract CatsMoney is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatsMoney";
    string private _symbol = "CatsMoney";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCbefD1d579Fbf348B09DEaDB2F3Bc928f44A8775); 
    address payable private teamWalletAddress = payable(0x45fFAaD4475288573C8e4ECDAeF40E4666386025); 
    ...
    uint256 private _totalSupply = 1 * 10**20* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**20 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**20 * 10**6* 10**_decimals;
