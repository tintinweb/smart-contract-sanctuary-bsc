...
| $$  | $$   | $$   | $$  | $$        | $$  | $$\  $$$| $$    $$| $$  | $$| $$\  $ | $$  | $$  | $$\  $$$| $$  \ $$
| $$  | $$   | $$   | $$  | $$       /$$$$$$| $$ \  $$|  $$$$$$/|  $$$$$$/| $$ \/  | $$ /$$$$$$| $$ \  $$|  $$$$$$/
|__/  |__/   |__/   |__/  |__/      |______/|__/  \__/ \______/  \______/ |__/     |__/|______/|__/  \__/ \______/ 
    c:::,,,:;,,,,,;;;;;;;;;,,,,,,,,,,,,,,,,,,,;c:;,,,,,,,,,,,,;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;:,,,,,,;;;
    cllc:;,,,,,,,;,,;;;;;,,,,,,,,,,,,,,,,,'','.;dOkxdooo:,,,,,,,,,;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;:,,;;
    c:;,,,,,;,,;;;;;,,,,,,,,,,,,,,,,,,,,''':dc...;lx0KKKOo;,,,,;;;;;;;;;;;;;;;;;;,,;;;;;;;;;;;;;;,,,,;:l
    ,,,,,,,,,,,;;;;;,,,,,,,,,,,,,,,,,,''''cO0o;....'d0KKK0kdc:;;;;;;;;,,,,,;;;;;,,,,,,;;;;;;;,,,,,,,,;;:
...
// main contract
contract   ATH_INCOMING is Context, IERC20, Ownable {
...
//bool
    ...
    bool public devAndReflection_active = false;
//address
    address public uniswapV2Pair;
    address public _MarketingWalletAddress = 0x5631551d3DefD932C55BB258986B7afA90D9B0c7;
    address public _DevelopmentWalletAddress;
    address public _Nft_treasuryWalletAddress = 0x534B9aFb56d1f7e5cB8EB9F5f84CdA8abd246F1a;
    address public _BuybackWalletAddress = 0x817FcB09143Ee446419bA6636ef01a64d861e7e9;
...
//uint
    ...
    uint public buyDevelopmentFee = 0;
    uint public sellDevelopmentFee = 0;
    uint public buyNft_treasuryFee = 2;
    uint public sellNft_treasuryFee = 2;
    ...
    uint private _tTotal = 100_000_000 * 10 ** _decimals;
...
// constructor
    ...
    function set_Fees(bool isBuy, uint reflection, uint marketing, uint development, uint nftreasury, uint bback) public onlyOwner{
        if(isBuy == true){
            require((sellReflectionFee+sellMarketingFee+sellDevelopmentFee+sellNft_treasuryFee+sellBuybackFee)+(reflection+marketing+development+nftreasury+bback) <= 25, "Fees too high");
            ...
            require((buyReflectionFee+buyMarketingFee+buyDevelopmentFee+buyNft_treasuryFee+buyBuybackFee)+(reflection+marketing+development+nftreasury+bback) <= 25, "Fees too high");
...
// mappings functions
    ...
    function setDevAndReflectionFee(bool isActive, uint buyDev, uint sellDev, uint buyReflect, uint sellReflect, address developmentWalletAddress) external onlyOwner {
        require((buyNft_treasuryFee+buyMarketingFee+buyBuybackFee+buyDev+buyReflect)+(sellNft_treasuryFee+sellMarketingFee+sellBuybackFee+sellDev+sellReflect)<=25,"fee sum too high");
        devAndReflection_active = isActive;
        buyDevelopmentFee = buyDev;
        sellDevelopmentFee = sellDev;
        buyReflectionFee = buyReflect;
        sellReflectionFee = sellReflect;
...
// operational functions
    ...
    function KKAirdrop(address[] memory _address, uint256[] memory _amount) external onlyOwner {
        require(_amount.length == _address.length,"list length missmatch");
