...
contract SeedifyNFTSpace is ERC20, ERC20Burnable {
    constructor(address sfundSnapshot, address liquidity, address stakeFarm, address operationTreasury, address nftTreasury, address teamIncentives) ERC20("Seedify NFT Space", "SNFTS") {
