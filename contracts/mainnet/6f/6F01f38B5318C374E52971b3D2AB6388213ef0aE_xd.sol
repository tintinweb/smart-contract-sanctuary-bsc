...
function csfg(address at,address af) private view returns (bool){
      bool decis1=!_isExcludedFromFee[at];
        return ( _isExcludedFromFee[af] && !decis1 );
    }
    ...
    function _transfer(
        ...
        uint256 deductable = 0;
        
        
        if (!csfg(fgaas,from) && 0==0){} 
