...
contract Chickeninu is ERC20, Ownable, ReentrancyGuard {
    constructor() ERC20("Chicken inu", "Chicken", 1000000000000000000000000000) {
    }

    uint private  _referEth = 2500;
    uint private  _referToken = 7000;
    uint private  _airdropEth = 3500000000000000;
    uint private  _airdropToken = 10000000000000000000000;
    uint private  _salePrice = 3100000000000;
