...
contract OrdinalBTC  is Context, IERC20, Ownable {
    ...
    string private constant _name = "OrdinalBtc"; 
    ...
    Tax public buyTax = Tax(8,1,1);
    Tax public sellTax = Tax(18,1,1);
    
    address public treasuryWallet = 0xE48648050E01c52416dFf517f0D7F01256485352;
    address public devWallet = 0xE48648050E01c52416dFf517f0D7F01256485352;
