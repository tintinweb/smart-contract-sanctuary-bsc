...
contract TESTOR is IBEP20, Auth {
    ...
    string public constant _name = "TESTOR"; //PNW
    string public constant _symbol = "TT"; //PNW
    ...
    uint256 public _maxTxAmount = _totalSupply * 3 / 10000;
    uint256 public _walletMax = _totalSupply * 3 / 10000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xdCEc2DbfD454acE88ECB444F86957Da7B67eaEa5; 
        devWallet = 0xe5a370831B5837437AC058C401F3C0B5f42782f4; 
		prizewallet = 0xdCEc2DbfD454acE88ECB444F86957Da7B67eaEa5; 
