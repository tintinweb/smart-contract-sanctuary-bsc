...
/* Reward Token - Baby Tokerr
Tokerr deployer still no reward so we consider that that why
we launch this in remix instead of tokerr deployer 
*/
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BUSD = IBEP20(0xd9b96FB20610a7D09F68309C524C8C72B7810b40); //reward ca can be changed any
...
contract BabyTokerr is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUSD = 0xd9b96FB20610a7D09F68309C524C8C72B7810b40; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby Tokerr";
   string constant _symbol = "BTOKR";
...
uint256 reflectionFee = 3;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x817203d6b420E263e97aDc81b46b5f2411d647Cb; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x817203d6b420E263e97aDc81b46b5f2411d647Cb; //Can be change to any wallet you want
       marketingFeeReceiver = 0x00fB164f020D7e0b13fbe9a2491BeB6FBB52B23A; //Can be change to any wallet you want
