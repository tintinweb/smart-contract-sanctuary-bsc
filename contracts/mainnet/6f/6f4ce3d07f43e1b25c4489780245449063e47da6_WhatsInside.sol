...
// File: contracts/whatsinside.sol
...
contract WhatsInside is ERC721Enumerable, Ownable, ERC2981 {
    ...
    constructor(string memory  _baseUri, address _receiver, uint96 _royaltyFeeNumerator) ERC721("What's inside?", "WINS") {
    ...
    function setDefaultRoyalty(address _receiver, uint96 _royaltyFeeNumerator) external onlyOwner{
        _setDefaultRoyalty(_receiver, _royaltyFeeNumerator);
    }
