...
contract BluetoothInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bluetooth Inu";
    string private _symbol = "BINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xa876003020482904e0eDF96A65CDB37321Ec7Fab);
