...
contract ART is Ownable {
    ...
    constructor (){
        ...
        lpAddress = address(0); //LP地址
        feeAddress = 0xD43b13de2cF9E141C9a4eed886aAA473AB446c70; //提现手续费地址
        pancakeRoute2Address = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // pancakeroute2

        arbAddress = 0xDAbb5F1689417F129D302cE39C7EB4b3c8480956;//Art代币
        ...
        arbthreeAddress = 0xd0949E3B71b90763234DdD5283f57940F8156d94; //ARB30%地址
        arblpAddress = 0x063b30Fa43DadE2468B469fE16b9000e6C58B806; //ART lp接收地址
