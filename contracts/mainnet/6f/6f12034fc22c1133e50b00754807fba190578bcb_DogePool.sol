...
contract DogePool is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Pool";
    string private constant _symbol = "DGPL";
    ...
    address payable public DonationsAddress = payable(0xb8f4e850205C5e66603AC2e447F0a964C15DB698);
    ...
    address public DonationsWallet = 0xb8f4e850205C5e66603AC2e447F0a964C15DB698;
