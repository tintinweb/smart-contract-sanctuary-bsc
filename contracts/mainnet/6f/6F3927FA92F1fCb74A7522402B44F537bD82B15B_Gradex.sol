...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    symbol = "GRDX"; //Изменяем на буквенное сокращенное название токена (пример - BTC)
    name = "Gradex"; //Изменяем на буквенное название токена (пример - Bitcoin)
    decimals = 4; //Количество десятичных дробей (пример - "8" = "0,00000001") 
    _totalSupply = 1000000000000000000; //Общее количество монет
...
contract Gradex is TokenBEP20 { //Изменяем слово "Name" на название своего токена
