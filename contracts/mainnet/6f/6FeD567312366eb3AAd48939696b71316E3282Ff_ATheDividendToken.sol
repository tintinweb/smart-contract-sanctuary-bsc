...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public constant marketingAddr =
        0xBf75d6aa7e4F0058E1a89B86F20028458F9FADbE;
...
contract ATheDividendToken is ExcludedFromFeeList, DividendFee {
    uint256 private constant _totalSupply = 999 * 1e18;
    ...
    uint256 public minDistribution = 1e17;

    constructor() ERC20("BTB", "BTB", 18) DividendFee() {
