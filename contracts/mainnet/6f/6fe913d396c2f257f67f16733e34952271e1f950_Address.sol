...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0a39Eef34cF57F386BC93de1CA13C3bEA2017AB1;
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(1), "Ownable: new owner is the one address");
...
contract AgroFeeds is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x74DaA2d2D1c888181A045ade5C2Fc9D729A4baCA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Agro Feeds";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf177C221027cDA57621a2AAa9Effa1b80C0773a3);
