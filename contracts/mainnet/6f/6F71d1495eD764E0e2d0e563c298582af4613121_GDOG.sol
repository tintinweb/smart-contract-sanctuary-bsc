...
contract GDOG is IERC20 {
    ...
    string constant private _name = "GDOG";
    string constant private _symbol = "GDOG";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x636b7F3e359c79c741033B1b40ebd7CF30642067),
        charity: payable(0x1eca9EFD47840Ab16cB12bA4eF967eb52fd00D46)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 charity, uint16 marketing) external onlyOwner {
...
//            Reflector
    ...
    function getCurrentReward() external view returns (address) {
        return reflector.getCurrentReward();
    }
}