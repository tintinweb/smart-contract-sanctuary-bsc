...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x866abC3043BDDB82a6b01a2aC3FAEBdF4a03362B; // owner address
...
contract METAGROW is Context, IERC20, Ownable {
    ...
    string private _name = "META GROW";
    string private _symbol = "METAGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x866abC3043BDDB82a6b01a2aC3FAEBdF4a03362B); // Marketing Address
    address payable public teamWalletAddress = payable(0x866abC3043BDDB82a6b01a2aC3FAEBdF4a03362B); // Team Address
