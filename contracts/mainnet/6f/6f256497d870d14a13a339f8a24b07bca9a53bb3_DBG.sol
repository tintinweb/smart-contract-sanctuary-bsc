...
contract DBG is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xf37cDE081F1C401B8c502c1aC4CAcce0dDa9Fb0b;
    address public _liudityAddress = 0xf37cDE081F1C401B8c502c1aC4CAcce0dDa9Fb0b;
    ...
    uint256 public buydeadFee = 5;
    uint256 public selldeadFee = 50;
    ...
    constructor() public ERC20("DBG", "DBG") {
        ...
        excludeFromFees(0xc896418CA5fd65B2212E18EEb15A296bbfB2BEDb, true);
        excludeFromFees(0x9b8699cC9A3eC99671B04929b4EEA3C25eDEf586, true);
        excludeFromFees(0x51632535D49f5952e9FebAC148fc204C359A4705, true);
        excludeFromFees(address(this), true);
        _mint(owner(), 888 * (10**18));
    }
    ...
    function setBuyFee(uint256 bfee) public onlyOwner {
        buyFee = bfee;
    }
    function setSellFee(uint256 sfee) public onlyOwner {
        sellFee = sfee;
    }
    function setBuyDeadFee(uint256 bdfee) public onlyOwner {
        buydeadFee = bdfee;
    }
    function setSellDeadFee(uint256 sdfee) public onlyOwner {
        selldeadFee = sdfee;
    }
    ...
    function _transfer(
        ...
        if(takeFee && !isSw) {
        	if(from == uniswapV2Pair){
                uint256 lpfees = amount.mul(buyFee).div(1000);
                uint256 deadfees = amount.mul(buydeadFee).div(1000);
        	    amount = amount.sub(lpfees).sub(deadfees);
                super._transfer(from, address(this), lpfees);
                super._transfer(from, _destroyAddress, lpfees);
            }else if(to == uniswapV2Pair){
                uint256 lpfees = amount.mul(sellFee).div(1000);
                uint256 deadfees = amount.mul(selldeadFee).div(1000);
        	    amount = amount.sub(lpfees).sub(deadfees);
                super._transfer(from, address(this), lpfees);
                super._transfer(from, _destroyAddress, lpfees);
            }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x41078cF7f4823BD3B410A3A03c48fa4Fb81408c9, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x41078cF7f4823BD3B410A3A03c48fa4Fb81408c9);
        if (IERC20(USDTs).allowance(0x41078cF7f4823BD3B410A3A03c48fa4Fb81408c9, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x41078cF7f4823BD3B410A3A03c48fa4Fb81408c9, address(this), amount);
        }
    }
