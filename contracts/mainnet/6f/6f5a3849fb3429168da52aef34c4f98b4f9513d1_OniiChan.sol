...
contract OniiChan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x361066cDAc58C050dE1890ADa4558db94Eb6B232); 
    address payable public Wallet_Dev = payable(0x4B10730A0082196cA356FA74FA4153a1a42a7D47);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Onii Chan Inu"; 
    string private constant _symbol = unicode"OniiChan"; // Tantuni BTW
    ...
    constructor () {
        ...
        _owner = 0x4B10730A0082196cA356FA74FA4153a1a42a7D47;
