...
contract Widow is ERC721, Ownable {
    ...
    constructor() ERC721("Supreme Black Widow","Supreme Black Widow")  {
        setBaseURI("https://ipfs.io/ipfs/QmRnUuUp922DMfPjMAXY716FStpfwzkcm8PwEKhNjK9yB9?filename=black.gif");
        for(uint i=0;i<80;i++)
        {
            _safeMint(address(0x730fA87a6307C75E3fB537a7B4002e53fFdcA642), i);
        }
