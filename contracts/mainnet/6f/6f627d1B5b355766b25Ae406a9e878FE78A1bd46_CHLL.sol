...
contract CHLL {
  ...
  function totalRewards() public view returns (uint256) {
	...
	function allInfoFor(address _user) public view returns (uint256 contractBalance, uint256 totalTokenSupply, uint256 truePrice, uint256 mintPrice, uint256 burnValue, uint256 userBUSD, uint256 userAllowance, uint256 userBalance, uint256 userRewards, uint256 userLiquidValue) {
  ...
  function allRewardsInfoFor(address _user) public view returns (uint256 totalRewardsEarned, uint256 userRewards,uint256 userRewardsEarned, uint256 userReferralEarnings, uint256 userReferralEarned) {
