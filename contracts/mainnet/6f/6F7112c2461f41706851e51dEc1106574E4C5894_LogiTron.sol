...
LogiTron copies the world which is all that is the case

https://logitron.io/
https://twitter.com/logitron_office
https://discord.com/invite/tdJuTHeqrd
https://t.me/logitron_io
...
contract LogiTron is LogiTronDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private LogiTronTeam;
    address private CharityLogiTron;
    ...
    string public override name = "LogiTron";
    string public override symbol = "LTR";
    ...
    constructor(uint totalSupplyValue, address LogiTronTeamAddress, address CharityLogiTronAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LogiTronTeam = LogiTronTeamAddress;
        CharityLogiTron = CharityLogiTronAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LogiTronTeam] =  totalSupply * 4 / 100;
        balances[CharityLogiTron] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LogiTronTeam pot
