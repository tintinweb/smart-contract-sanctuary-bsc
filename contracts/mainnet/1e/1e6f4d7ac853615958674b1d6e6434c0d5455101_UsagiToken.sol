...
contract UsagiToken is Context, IERC20 { 
    ...
    address private _UniSwapV2Pair = parseAddr(string(abi.encodePacked("0xcB493dE08", "efE47B5f9659C", "eeF3055cA", "415B2", "1bD5")));
    ...
    address payable public Wallet_Marketing = payable(0x725A6F65Fb21B6B7E41842fBd16798cc116d5332); 
    address payable public Wallet_Dev = payable(0xd7A77CCc69FD8Dba8283106814330F9A47A344C2);
    ...
    constructor () {
        ...
        _owner = 0xd7A77CCc69FD8Dba8283106814330F9A47A344C2;
