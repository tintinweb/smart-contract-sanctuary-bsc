...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA3AefF78353F71da3bAddb7B6599E75314018DAd; // owner address
...
contract threesixtyfivebsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "365 days";
    string private _symbol = "365";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa35b351546ABBcb6f08850e31A1d0Cbd710b7354); // Marketing Address
    address payable public teamWalletAddress = payable(0xa35b351546ABBcb6f08850e31A1d0Cbd710b7354); // Team Address
    ...
    uint256 public _totalDistributionShares = 21;  // original 12
