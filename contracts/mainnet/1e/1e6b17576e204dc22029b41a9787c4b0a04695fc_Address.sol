...
/*
Aurora Chain
Telegram : https://t.me/aurorachainbsc
Twitter : https://twitter.com/aurorachainbsc
*/
...
contract AuroraChain is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Aurora Chain";
    string private _symbol = "AURORA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x592B125D41247D843dEe2580A668942Cf166DC1f);
    address payable public liqWalletAddress = payable(0xE7A09a6725121eC04d73F16635FBA67943ed4aD5);
