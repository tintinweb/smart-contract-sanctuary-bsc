...
// main contract
contract SantaFillsBags is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "SantaFillsBags";
    ...
    uint256 public sellIncFactor = 100;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb5Ef22b128b1a2c3302fDfbf7a957af655F2BD62;
        CSBFeeReceiver = 0xaA23B2e56046213dB3351EB8a9bf6c5D08E90c42;
        ...
        isFeeExempt[CSBFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBCSB = amountBNB.mul(_CSBFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(CSBFeeReceiver).transfer(amountBNBCSB);
    ...
    function setFeeReceivers(
        ...
        address _CSBFeeReceiver
    ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        CSBFeeReceiver = _CSBFeeReceiver;
    }
