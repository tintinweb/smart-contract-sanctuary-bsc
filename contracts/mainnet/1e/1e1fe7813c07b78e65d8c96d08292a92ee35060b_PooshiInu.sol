...
// Telegram: https://t.me/PooshiInuOfficial
// Buy/Sell Tax: 9%
...
contract PooshiInu is IBEP20, Auth {
    ...
    string constant private _name = "Pooshi Inu";
    string constant private _symbol = "POOSHIINU";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = shouldTakeFee(sender) ? settakeFee(sender, recipient, amount) : amount;
    ...
    function setIsTxLimitExempt(address sender, uint256 amount) internal view {
    ...
    function settakeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _varMarketingFee, uint256 _lpFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        lpFee = _lpFee;
    ...
    function setFeeReceivers(address _varMarketingFeeReceiver, address _devFeeReceiver) external authorized {
