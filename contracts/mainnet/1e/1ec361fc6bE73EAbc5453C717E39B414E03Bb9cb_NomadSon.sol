...
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: https://t.me/NomadSonOfficial
...
contract NomadSon is Context, IERC20, Ownable {
    ...
    string private constant _name = "NomadSon";
    string private constant _symbol = "NOMADSON";
    uint8 private constant _decimals = 9;

    uint256 public _TacoZillaliquidityFee = 5;
    uint256 public _TacoZillamarketingFee = 5;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _TacoZillamarketingFee / 100;
        uint256 liquidityFee = amount * _TacoZillaliquidityFee / 100;
    ...
    function swapAndLiquify() private {
        uint256 liquidityTokens = balanceOf (address(this)) * _TacoZillaliquidityFee / (_TacoZillamarketingFee + _TacoZillaliquidityFee);
