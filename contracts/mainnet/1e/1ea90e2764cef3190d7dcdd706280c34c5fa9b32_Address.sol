...
contract Songoku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB63F0B561B02aB82e3AbDb18B62e6cA7c6cb2f82); 
    address payable public Wallet_Dev = payable(0xBbc0a365CDA509F180B178427Caf2569De6A6c28);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Songoku Inu"; 
    string private constant _symbol = unicode"Songoku"; 
    ...
    constructor () {
        _owner = 0xBbc0a365CDA509F180B178427Caf2569De6A6c28;
