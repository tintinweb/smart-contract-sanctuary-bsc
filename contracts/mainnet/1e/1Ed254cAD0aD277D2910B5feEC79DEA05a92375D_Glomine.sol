...
/*
Telegram : https://t.me/glominee
Website : https://glomine.org
*/
...
contract Glomine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Glomine";
    string private _symbol = "GLO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfA1aBC8fe72a0eB1fb2f8bA5e425B74f4E3cbF11);
    address payable public teamWalletAddress = payable(0xfA1aBC8fe72a0eB1fb2f8bA5e425B74f4E3cbF11);
