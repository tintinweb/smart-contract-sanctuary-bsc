...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4A97963a733909b426677eAAdc4e5B589E211f0D;
...
contract CROKX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8C15DdBa3169d9D61520edBcB5Fb8D1faED15077;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CROKX";
    string private _symbol = "CROGEOKX";
