...
contract PUMPKINS is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x436D2C67A1cB5a314aAA3cEEE8FBb6f21415f2c1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 1e9 * (10 ** _decimals);
    string private constant _name = "Pumpkin Token"; 
    ...
    uint256 public _maxWalletToken = 1e8 * (10 ** _decimals);
    ...
    function setFeeBuySell (uint256 Buy, uint256 Sell) public onlyOwner{
        _Tax_On_Buy = Buy;
        _Tax_On_Sell = Sell;
    }

    function setPercentTax (uint256 Marketing, uint256 Burn, uint256 Liquidity) public onlyOwner{
    ...
    function setMaxAll (uint256 maxAmount, uint256 maxWallet) public onlyOwner{
