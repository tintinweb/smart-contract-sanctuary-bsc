...
/**
    ...
    Telegram : https://t.me/SnakeSquidBsc
*/
...
contract SnakeSquid is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SnkSquid";
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_limit[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _limit[to] = block.timestamp;
        }
