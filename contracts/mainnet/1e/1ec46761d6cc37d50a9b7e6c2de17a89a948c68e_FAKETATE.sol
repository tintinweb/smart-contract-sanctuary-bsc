...
🐦TWITTER : https://twitter.com/Faketatebsc
☎️TELEGRAM : https://t.me/Faketate
...
contract FAKETATE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0F4A75C89479e56B18a4B13C8FDa3023B338a033); 
    address payable public Wallet_Dev = payable(0x34201707790eED18B30BA0956D826f6A98162BbB);
    ...
    string constant _name = "Fake TATE";
    string constant _symbol = unicode"FAKETATE";
    ...
    constructor () {
        ...
        _owner = 0x34201707790eED18B30BA0956D826f6A98162BbB;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x0F4A75C89479e56B18a4B13C8FDa3023B338a033); // Testnet
        uniSwapV2Pair = payable(0x34201707790eED18B30BA0956D826f6A98162BbB);
