...
/*
https://poocoin.app/tokens/0x1ecfd66e4550e8a897f43b1a1bb8953f7a5904d3
 https://defiforge.io/
 DeFi is the future and it is all of our responsibilities to build a better future for those that follow behind us
...
contract DeFiForge is DeFiForgeDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private DeFiForgeTeam;
    address private CharityDeFiForge;
    ...
    string public override name = "DeFi Forge";
    string public override symbol = "FORGE";
    ...
    constructor(uint totalSupplyValue, address DeFiForgeTeamAddress, address CharityDeFiForgeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        DeFiForgeTeam = DeFiForgeTeamAddress;
        CharityDeFiForge = CharityDeFiForgeAddress;
       
        // split the tokens according to agreed upon percentages
        balances[DeFiForgeTeam] =  totalSupply * 4 / 100;
        balances[CharityDeFiForge] = totalSupply * 45 / 100;
