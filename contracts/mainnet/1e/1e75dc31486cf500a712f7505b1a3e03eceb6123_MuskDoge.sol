...
contract MuskDoge is IBEP20, Ownable
{
    ...
    uint16 public constant MaxSellLockTime= 1800; // 30 Minutes i.e 1800 sec
    ...
    function TeamSetTaxes(uint16 burnTaxes, uint16 liquidityTaxes, uint16 stakingTaxes,uint16 buyTax, uint16 sellTax, uint16 transferTax) public onlyOwner{
