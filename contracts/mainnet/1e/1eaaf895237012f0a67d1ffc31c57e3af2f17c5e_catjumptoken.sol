...
contract catjumptoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Jump Token"; // 
    string private constant _symbol = "CJ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x01F9f8497925015A79132Db0878759029A5C2224;
