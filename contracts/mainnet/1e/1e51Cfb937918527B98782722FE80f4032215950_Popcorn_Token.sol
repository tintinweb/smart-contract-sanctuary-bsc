...
contract Popcorn_Token is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = 'Popcorp';
    ...
    uint256 public popInsuranceFundFee = 30;
    uint256 public infernoPitFee = 80;
    uint256 public totalFee = liquidityFee.add(gameTreasuryFee).add(popInsuranceFundFee).add(infernoPitFee);
    ...
    address public popInsuranceFundReceiver;
    ...
    constructor(
        ...
        address _popInsuranceFundReceiver
        ...
        popInsuranceFundReceiver = _popInsuranceFundReceiver;
        infernoPit = ZERO;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_gameTreasuryFee.add(popInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(gameTreasuryReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(gameTreasuryFee).div(gameTreasuryFee.add(popInsuranceFundFee)),
            gas: 30000
        }('');
        (success, ) = payable(popInsuranceFundReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(popInsuranceFundFee).div(
                gameTreasuryFee.add(popInsuranceFundFee)
            ),
            gas: 30000
        }('');
    }
    ...
    function setFee(
        ...
        uint256 _popInsuranceFundFee,
        uint256 _infernoPitFee,
        uint256 _sellFee
    ) external onlyOwner {
        liquidityFee = _liquidityFee;
        gameTreasuryFee = _gameTreasuryFee;
        popInsuranceFundFee = _popInsuranceFundFee;
        infernoPitFee = _infernoPitFee;
        totalFee = liquidityFee.add(gameTreasuryFee).add(popInsuranceFundFee).add(infernoPitFee);
        sellFee = _sellFee;
