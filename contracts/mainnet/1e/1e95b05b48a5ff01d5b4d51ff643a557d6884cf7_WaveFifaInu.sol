...
contract WaveFifaInu  is Context, IERC20 { 
    ...
    string private constant _name = "WaveFifaInu";
    string private constant _symbol = "WFINU";
    ...
    function _transfer(
        ...
        require(!isDividendExempt[from], "ERR: Using 0 address!");
