...
//ZoroApe Nft <Rewards Of doge every Transaction
...
contract ZoroApe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ZoroApe";
    string constant _symbol = "ZAPE";
    ...
    uint256 public _walletMax = _totalSupply * 43 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x21478863D92450205938B95473F6D74a9deCb705;
