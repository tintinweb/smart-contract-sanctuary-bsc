...
contract Winter_Dog is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1CD1c3dA0CA0aFb0049B48EFeF0d5B0DdA396C22;
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 amount) external onlyOwner {
        require(maxBuy >= 20_000_000, "Cannot set max buy amount lower than 1%");
        require(maxSell >= 1_000_000, "Cannot set max sell amount lower than 1%");
        require(amount >= 20_000_000, "Cannot set max wallet amount lower than 1%");
