...
TG: https://t.me/HappyBirthdayDoge2022
...
contract HappyBirthdayDoge is Context, IERC20, Ownable {
    ...
    string private _symbol = "HPD";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x9d4203D86eF79Dba955f1e4643EC218EE39B07B5);
    address payable public teamWalletAddress = payable(0x5c401d2A34a6430640406455B509694Fbb228B4A);
