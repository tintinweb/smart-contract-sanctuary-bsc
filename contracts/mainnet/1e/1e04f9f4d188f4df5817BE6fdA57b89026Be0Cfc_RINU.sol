...
/**
Telegram Group :
https://t.me/RenjiroInu

Twitter :
https://twitter.com/RenjiroInu
...
contract  RINU is IBEP20, Auth {
    ...
    address DEV =  0x40754D3bc581239Dbc567577B01B4b6b8b2b5630;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 1000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 1000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 1000; // 2% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x40754D3bc581239Dbc567577B01B4b6b8b2b5630;
