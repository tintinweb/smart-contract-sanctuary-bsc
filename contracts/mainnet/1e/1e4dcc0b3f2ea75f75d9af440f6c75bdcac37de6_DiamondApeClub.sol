...
TG: https://t.me/DiamondApeClub
Website: https://www.diamondapeclubcoin.com/
Twitter: https://twitter.com/diamondapeclubb
...
contract DiamondApeClub is IBEP20, Auth {
    ...
    string constant _name = "Diamond Ape Club";
    string constant _symbol = unicode"DAPECLUB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 6000000000 * (10 ** _decimals);
