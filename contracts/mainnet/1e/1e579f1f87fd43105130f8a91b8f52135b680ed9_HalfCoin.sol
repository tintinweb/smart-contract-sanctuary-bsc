...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;
            MarketingWallet = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;
            DevWallet       = 0xFF82598087E2b56d149f3290668D72f916F37978;
        _token = msg.sender;
    }
...
contract HalfCoin is IBEP20, Auth {
    ...
    string constant _name = "Half Coin";
