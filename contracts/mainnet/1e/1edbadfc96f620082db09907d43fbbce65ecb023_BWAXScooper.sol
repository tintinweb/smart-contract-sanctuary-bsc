...
// SPDX-License-Identifier: Unlicensed
    ...
    */
    ...
    contract BWAXScooper is ReentrancyGuard, PriceConsumerV3, WiPayFarm {
        ...
        function manuallySetClaimable(address _user) public returns(uint256){
            require(msg.sender == dev_ && !started, 'AlreadyStarted');
            claimable[_user] = _oldToken.balanceOf(_user);
            return(claimable[_user]);
        }
        ...
        function burnOld() public{
            ...
            uint256 tclaimable = _amount;
            if(tclaimable > claimable[msg.sender]){
                tclaimable = claimable[msg.sender];
            }
