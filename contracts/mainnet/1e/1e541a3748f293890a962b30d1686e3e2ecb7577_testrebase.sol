...
contract testrebase is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**6 * 10**DECIMALS; // 1m
    uint256 public gonMaxWallet = TOTAL_GONS.div(100).mul(1); // 1%
    ...
    constructor() ERC20Detailed("testrebase", "testrebase", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x48A969349d3F47Aa40c978e995148C0a6Eb2bD28;
        marketingFeeReceiver = 0x48A969349d3F47Aa40c978e995148C0a6Eb2bD28;
        ecosystemFeeReceiver = 0x48A969349d3F47Aa40c978e995148C0a6Eb2bD28;
        buyBackFeeReceiver = 0x48A969349d3F47Aa40c978e995148C0a6Eb2bD28;
