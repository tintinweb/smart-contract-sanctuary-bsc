...
contract SHIB2 is Context, IERC20, Ownable {
    ...
    string private _name = "SHIB-2";
    string private _symbol = "SHIB-2";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**_decimals; // 5%
    uint256 public _walletMax = 50000000 * 10**_decimals; // 5%
