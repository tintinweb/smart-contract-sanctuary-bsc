...
contract EternalAPY is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "Eternal APY";
    string public _symbol = "ETNL";
    ...
    constructor()
        ERC20Detailed("Eternal APY", "ETNL", uint8(DECIMALS))
        Ownable()
    {
        ...
        autoLiquidityReceiver = 0x896ce87aD1a2A35E3f29C6E26b53fF76F08761F4;
        treasuryReceiver = 0xA7ac89595C1c805c3C0fc68B7F1A2bD258B77dbB;
        InsuranceFundReceiver = 0x033633Af6BcF7f3B44b5e92A23EDdE5417265395;
        firePit = 0x8dBF4ab60C34BbF3eF15fb4878661Fc6364dC0Eb;
