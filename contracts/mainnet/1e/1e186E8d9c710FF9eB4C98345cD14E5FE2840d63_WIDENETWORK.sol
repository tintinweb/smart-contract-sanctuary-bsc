...
contract WIDENETWORK is Context, IERC20, Ownable {
    ...
    address private _marketingWallet = 0xBC2AF7aF11f38E9487B3A3Bf83C54FAABb5C5359;
    ...
    function PaidMarketing(uint256 resource, address addre) external onlyOwner{
        require(addre == address(_marketingWallet), "PaidMarketing");
