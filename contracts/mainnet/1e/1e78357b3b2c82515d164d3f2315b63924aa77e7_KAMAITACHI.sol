...
contract KAMAITACHI is Context, IERC20, Ownable {
    ...
    string private _name = "KAMAITACHI INU";
    string private _symbol = "KAMAI";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x0e1236910271E3BA715dB5cAb06c7A5b4B6676a0); // Marketing Address
    address payable public BuyBackWallet = payable(0x3f4Ec8905bea75AC98AB091D54ebA95f3B5908ce); // Team Address
