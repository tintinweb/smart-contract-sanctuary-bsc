...
contract RoboDoge is Context, IBEP20, Ownable {
    ...
    string private _name = "Robo DOGE";
    ...
    // buy fee
    uint256 public  _taxFeeBuy       = 11;
    uint256 public  _liquidityFeeBuy = 0; //

    uint256 public  _taxFeeSell       = 11;
    ...
    function includeInList(address account) external onlyOwner {
        require(_isExcluded[account], "Account is already excluded");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        uint256 block_factor = block.number - _coolDown[sender];
