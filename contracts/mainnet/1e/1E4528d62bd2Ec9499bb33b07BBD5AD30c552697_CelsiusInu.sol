...
/**
Celsius Inu 
Dev : https://t.me/TrafalgarLawCalls
Init Liq : 10 BNB
...
contract CelsiusInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "CelsiusInu";
    string private constant _symbol = "CEL";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 21000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 420000000 * 10**_decimals;
    uint256 public _maxTxAmount = 420000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 42000000 * 10**_decimals;

    address public liquidityReceiver;
    address public marketingWallet = address(0x92EBE9Fff9077838DDACF4286FC16752d15c6089);
