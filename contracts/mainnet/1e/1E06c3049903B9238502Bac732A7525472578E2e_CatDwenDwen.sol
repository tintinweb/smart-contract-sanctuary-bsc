...
contract CatDwenDwen is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Dwen Dwen";
    string private _symbol = "CATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9B933653894111E9bc5653d44d9f83f75537e92);
    address payable public teamWalletAddress = payable(0xA9B933653894111E9bc5653d44d9f83f75537e92);
