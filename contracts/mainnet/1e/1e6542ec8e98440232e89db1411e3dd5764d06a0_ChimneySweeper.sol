...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73F5A0D11E74BF711CBC27a8Bed178A146db8014;
...
contract ChimneySweeper is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA51d472dcd5b7794e553650cE542d0af3e277483;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ChimneySweeper";
    string private _symbol = "CHSW";
