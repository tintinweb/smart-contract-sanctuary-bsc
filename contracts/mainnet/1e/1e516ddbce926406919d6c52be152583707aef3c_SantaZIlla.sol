...
contract SantaZIlla is Context, IBEP20, Ownable {
    ...
    string private constant _name = "SantaZilla";
    string private constant _symbol = "SANTAZILLA";
