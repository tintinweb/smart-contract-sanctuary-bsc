...
Telegram: https://t.me/scoobydogeeofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x439135Faca6e9C3f5640497578909132AFf329eB;
...
contract SCOOBYDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SCOOBY DOGE"; // 
    string private constant _symbol = "SDOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x439135Faca6e9C3f5640497578909132AFf329eB);
