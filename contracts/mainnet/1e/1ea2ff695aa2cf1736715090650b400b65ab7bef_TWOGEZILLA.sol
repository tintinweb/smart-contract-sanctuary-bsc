...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59CfC1206aECD12e9385ADe05292b2E378ae6d0f; // Owner
...
contract TWOGEZILLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWOGE ZILLA";
    string private _symbol = "TWOZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59CfC1206aECD12e9385ADe05292b2E378ae6d0f); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x6ebaD507d44D40a35b21342a2e8eEeFE40681894); // Team Wallet
