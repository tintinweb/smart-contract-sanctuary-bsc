...
// File: @devbitexblock/bitexblock-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/BitexblockProfile.sol

pragma solidity ^0.6.0;

/** @title BitexblockProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract BitexblockProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public bitToken;
    ...
    uint256 public numberBitToReactivate;
    uint256 public numberBitToRegister;
    uint256 public numberBitToUpdate;
    ...
    constructor(
        IBEP20 _bitToken,
        uint256 _numberBitToReactivate,
        uint256 _numberBitToRegister,
        uint256 _numberBitToUpdate
    ) public {
        bitToken = _bitToken;
        numberBitToReactivate = _numberBitToReactivate;
        numberBitToRegister = _numberBitToRegister;
        numberBitToUpdate = _numberBitToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends BIT to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer BIT tokens to this contract
        bitToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBitToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer BIT token to this address
        bitToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBitToUpdate
    ...
    /**
     * @dev Claim BIT to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        bitToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of BIT to register
     * Callable only by owner admins.
     */
    function updateNumberBit(
        uint256 _newNumberBitToReactivate,
        uint256 _newNumberBitToRegister,
        uint256 _newNumberBitToUpdate
    ) external onlyOwner {
        numberBitToReactivate = _newNumberBitToReactivate;
        numberBitToRegister = _newNumberBitToRegister;
        numberBitToUpdate = _newNumberBitToUpdate;
    }
