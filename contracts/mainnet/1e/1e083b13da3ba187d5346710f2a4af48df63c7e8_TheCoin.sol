...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31142B52Ba41A8707EDd5F8aABf336ec50E42d52;
...
contract TheCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x491cA6f95b55b4716cD8BF9DF920ac38a30f56fb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 360000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "The Coin";
    ...
    uint256 public _maxTxAmount = 360000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 360000 * 10**18;
