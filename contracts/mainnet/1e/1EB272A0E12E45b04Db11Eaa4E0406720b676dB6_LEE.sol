...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 550;
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 5 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 1 / 1000;
            if (burnAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xfea5Ad96D852b9F6995c64Cb177087C9Be0B89E1;
    ...
    function processReward(uint256 gas) private {
        if (progressRewardBlock + 80 > block.number) {
            return;
        }
...
contract LEE is AbsToken {
    constructor() AbsToken(
        ...
        address(0xcB250698059f426B018e2F096CAA5E0bEc26Cecd),
    
        address(0xe1689D9e27Ab434dECf0d40bb8f2D60b18C97341)
    ){
