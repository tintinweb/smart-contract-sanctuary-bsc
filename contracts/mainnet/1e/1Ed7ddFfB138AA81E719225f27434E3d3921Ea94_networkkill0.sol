...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x49ceBCad08eF215777e45aa1F107f967Df3dae50;
...
contract networkkill0 is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x49ceBCad08eF215777e45aa1F107f967Df3dae50;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 9950000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NETWORK KILL0";
    string private _symbol = "NETKILL";
    ...
    uint256 public _maxTxAmount = 4000000000000000 * 10**6 * 10**9;
