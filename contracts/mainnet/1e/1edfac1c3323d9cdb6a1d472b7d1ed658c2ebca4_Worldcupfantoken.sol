...
/* Token contract */
contract Worldcupfantoken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Worldcup Fan Token";
    string constant _symbol = "WCFT";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 2000000 * (10 ** _decimals); // 1m

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 10000;
