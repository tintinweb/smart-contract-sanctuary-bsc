...
/**
https://t.me/peakygrow

This Peaky Inu has broken at $90K Mcap, can Peaky Grow exceed it?
*/
...
contract PeakyGrow is Context, IERC20, Ownable {
    ...
    // At any given time, buy and sell fees can NOT exceed 42% each
    uint256 private constant TOTAL_FEES_LIMIT = 4200;
    ...
    string private constant _name = "PeakyGrow";
    string private constant _symbol = "PG";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 10000000 * 10**_decimals;

    // Max wallet size initially set to 2%
    uint256 public maxWalletSize = _tTotal.div(50);

    // Buy fees
    // 2% liquidity
    uint256 public bLiquidityFee = 200;
    // 4% marketing
    uint256 public bMarketingFee = 400;
    // 3% dev
    ...
    // 50% of jackpot cashout to last buyer
