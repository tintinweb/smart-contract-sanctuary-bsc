...
/**
 * Allows for contract ownership along with multi-address authorization  */ abstract contract Auth {
...
contract Cinutopia is IBEP20, Auth {
    ...
    string constant _name = "SPIDERSHIBA";
    string constant _symbol = "$PIDERSHIB";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xDC8b11c70a2B0ECeCD3Abda24F0ff77A1Ec71E23;
