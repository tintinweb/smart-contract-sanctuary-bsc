...
contract MechaSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "MechaSquid"; // 
    string private constant _symbol = "$MechaSQ "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x65D42DD27b19E4e0Ba73ef079cB4B0D93E13466E;
