...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4bd74efA7BC168559DbfCb51A99E3DDB4702ddaB;
...
contract Shibosu is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIBOSU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4bd74efA7BC168559DbfCb51A99E3DDB4702ddaB); // Marketing Address
    address payable private teamWalletAddress = payable(0x4bd74efA7BC168559DbfCb51A99E3DDB4702ddaB); // Team Address
