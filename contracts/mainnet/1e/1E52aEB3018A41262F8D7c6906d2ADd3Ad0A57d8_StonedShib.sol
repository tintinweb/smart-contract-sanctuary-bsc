...
abstract contract Auth {
    ...
    /**
     * Function modifier require caller to be authorized
     */
    modifier authorized() {
    ...
    /**
     * only owner can Remove address' authorization.
     */
...
contract StonedShib is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StonedShib";
    ...
    uint256 public _walletMax = _totalSupply * 53 / 100;
    ...
    uint256 public liquidityFee = 6; //pool maintainence
    uint256 public marketingFee = 5; //for promotion
    uint256 public rewardsFee = 3; //reflection BUSD
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xD8A9Fe90CA20Fc76990219bbB0A7324FA2400E3f;
