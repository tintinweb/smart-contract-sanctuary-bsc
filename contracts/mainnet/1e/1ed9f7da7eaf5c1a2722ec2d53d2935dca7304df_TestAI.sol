...
contract TestAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Test Meta AI";
    string private constant _symbol = unicode"TESTAI";
    ...
    function manualSwapForEth(uint256 amount) public onlyOwner {
        uint256 tokenBalance=balanceOf(address(this));
