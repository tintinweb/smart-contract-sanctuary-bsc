...
/**
* -------------------------------------------------------------------------------- 
*               MetaYieldChain NewMasterBuilder 
* --------------------------------------------------------------------------------
* The MetaYieldChain Contract on BSC Network
* MetaYieldChain - is a decentralized blockchain dApp built on Binance Smart Chain, 
* with cross chain features enabled, including farming, staking, NFTs, and support 
* for Ethereum Virtual Machine based smart contracts by a Proof of Stake (P.O.S) consensus.
*
* Website: https://metayieldchain.com
* 
* MIT Licence
--------------------------------------------------------------------------------
*/
...
contract RewardToken is BEP20('ALV Reward Token', 'ALVRT') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterBuilder).
    function mint(address _to, uint256 _amount) public onlyOwner {
