...
/**
 *               https://t.me/INBREDPORTAL
 *                 
 *         https://medium.com/@Inbread/cat-breading-inbred-545d1eb12a5e 
 * 
*/         
...
contract INBREAD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Cat Breading";
    string constant _symbol = "INBREAD";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x8D3d2a97e519699Fe6C731ED4a0B7D26a01EB5A3;
        marketingWallet = 0x2cD504a0412dAeBf1bc537193CE530695510C6e5;  
        anothermarketingWallet = 0xeCea2520300c8b9B6E3fa98e22c622aB194ba6C4;
