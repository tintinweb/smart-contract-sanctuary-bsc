...
contract SaitamaKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAITAMA KING";
    string private _symbol = "SaitamaKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96078b8A57c908951C1d8A47DedC35E161b2F85d);
    address payable public teamWalletAddress = payable(0x96078b8A57c908951C1d8A47DedC35E161b2F85d);
