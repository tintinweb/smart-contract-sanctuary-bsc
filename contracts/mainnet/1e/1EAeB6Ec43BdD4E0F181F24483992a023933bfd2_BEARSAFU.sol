...
contract BEARSAFU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9B97AF60195539103b41ecb0505369Dfc6D85361); // Marketing Address
    address payable public charityAddress = payable(0x9B97AF60195539103b41ecb0505369Dfc6D85361); // Charity/Dev Address
    ...
    uint256 private _tTotal = 100000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BEARSAFU";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   8000000000000000; //0.002 BNB Airdrop fee
    uint256 private _airdropToken = 200000000000000000000000; // 9.000.000.000; token will be given on airdrop
    ...
    uint256 private salePrice = 20000000;// 0.01*30,000,000,000=300,000,000 token for 0.01 bnb (set as per requirements)
