...
// TONIGHT MCDONALDS WILL ANNOUNCE COLLAB WITH PAPA KANYE AND BABY KANYE MEAL WILL GO PARABOLIC, BUY OR CRY AFTER THE SUPERBOWL PERFORMANCE!
// TG BABYKANYEMEAL
...
contract babykanye is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyKanyeWestMeal";
    string private _symbol = "BABY KANYE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C71a5b99960dBee4A0B8087d5432f2Eb9abD3fa); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7C71a5b99960dBee4A0B8087d5432f2Eb9abD3fa); // buyback Address
