...
contract BezosPepsi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd9E0c89f093b56ddc0a4150E6BBD4450daBE7E2d); // Marketing Address

    address payable public teamAddress =
        payable(0x446Dae7590bfD25e14cF2dcF95f626fb2A3C04A5); // BuyBack / Dev Address

    address payable public liquidityAddress =
        payable(0xdB4fdEB7dD2c2240B65AC13884EACdc39fdC5B5D); // Liquidity Address
    ...
    string private constant _name = "BezosPepsi";
    ...
    uint256 private gasPriceLimit = 15 * 1 gwei;
