...
contract CATBUTT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATBUTT";
    string private _symbol = "CATBUTT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x633df37020E5e7762ACBc3F2c7D891575602a869);
    address payable public teamWalletAddress = payable(0x633df37020E5e7762ACBc3F2c7D891575602a869);
