...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89D94Fc291e7865986374F22A7a211BCBE4D19B0;
...
contract ShrimpKid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shrimp Kid"; // 
    string private constant _symbol = "$HRMPKD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x89D94Fc291e7865986374F22A7a211BCBE4D19B0);
