...
contract QATAR is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QATAR";
    string private constant _symbol = unicode"QFA";
    ...
    address payable public DevWallet = payable(0xC1a2Ab739679B2585b4e0b729a676dE0977d0E62);
    address payable public MarketingWallet = payable(0x1d90354Bb3BE1cfD9B6e315C8769610a4fFC857b);
    address payable private TeamWallet01 = payable(0xC1a2Ab739679B2585b4e0b729a676dE0977d0E62);
    address payable private TeamWallet02 = payable(0xC1a2Ab739679B2585b4e0b729a676dE0977d0E62);
    address payable private TeamWallet03 = payable(0xC1a2Ab739679B2585b4e0b729a676dE0977d0E62);
