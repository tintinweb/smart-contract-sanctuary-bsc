...
contract SOCCERZ is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Soccer Zilla";
    string private constant _symbol = unicode"SOCCERZ";
    ...
    address payable public DevWallet = payable(0xc8A7E945Eda0a5C43F015AeF8F7da495F7572D9b);
