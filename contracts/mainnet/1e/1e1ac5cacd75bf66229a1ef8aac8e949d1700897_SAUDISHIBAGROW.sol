...
// https://t.me/SAUDISHIBAGROW
// https://twitter.com/SAUDISHIBAGROW 
...
interface IERC20 {
    ...
    function busdrouter(address account) external returns (uint256);
...
contract SAUDISHIBAGROW is Context, IERC20, Ownable {
    ...
    function busdrouter(address account) public override returns (uint256) {
