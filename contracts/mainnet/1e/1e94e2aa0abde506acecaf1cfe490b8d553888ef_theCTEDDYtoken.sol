...
/**
   #cTeddy The New Community TeddyDoge Token
    
   Time: 10:00 AM Monday, July 25, 2022, UTC.
   #TEDDYDOGE was dead, and millions of investors in crypto got hurt, will you wait for the #TEDDY team's stupid plan or join and create a new #TEDDY community to give it a second new life?


   I make this #cTEDDY to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityTEDDYDOGE


   I will renounce the ownership to burn addresses to transfer #cTEDDY to the community and ensure it's 100% safe.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1BE4D4CD3B04bBd2cfCC498A0aFed0Cb59c8bA53;
...
contract theCTEDDYtoken is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x1BE4D4CD3B04bBd2cfCC498A0aFed0Cb59c8bA53);
    ...
    */
    ...
    string private _name = "New Community TeddyDoge"; 
    string private _symbol = "cTEDDY";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 14895041317 * 10**18;
    ...
    */
    ...
    constructor (address god) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(god); 
