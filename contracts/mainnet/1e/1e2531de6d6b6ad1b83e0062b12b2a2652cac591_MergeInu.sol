...
library Address{
 ...
 contract MergeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7D2150b95B3e72bfEEDdF327aa1bFf82b8B7Eb59;
    address public donationWallet = 0x49aDa9288F913eB2E67A05c1513bA1F23754bD1C;

    string private constant _name = "MergeInu";
    string private constant _symbol = "MERGEINU";
    ...
    Taxes public taxes = Taxes(0, 3, 0, 2);
    Taxes public sellTaxes = Taxes(0, 4, 0, 3);
