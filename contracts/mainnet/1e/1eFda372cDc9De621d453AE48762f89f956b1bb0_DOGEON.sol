...
contract DOGEON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x885bd1Fa1444D220e210fF4d0fCa47cef9d58221); // Marketing Address
    ...
    string private _name = "Doges and Dragons";
    string private _symbol = "DOGEON";
