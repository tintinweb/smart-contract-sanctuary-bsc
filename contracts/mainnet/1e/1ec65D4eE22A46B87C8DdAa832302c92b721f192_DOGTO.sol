...
DOGTO 2.0 not just your ordinary dog 🐶

🔥 It operates on binance smart chain 

🔥 Take your place before its to late
  📈📉📈📉📈📉📈📉📈📉
...
contract DOGTO is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "DOGTO 2.0";                                          // name
    string private _symbol = "DOGTO2.0";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x81287A84af7261De8de2921Af97FB045ffa0653c),                             // Dev+Team wallet
        payable(0x81287A84af7261De8de2921Af97FB045ffa0653c),                             // Marketing wallet
        payable(0x81287A84af7261De8de2921Af97FB045ffa0653c)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function setLiquidityFee4Sellers(uint256 liquidityFee4Sellers) external onlyOwner() {
        require(liquidityFee4Sellers <= 95, "Fee too high!");
