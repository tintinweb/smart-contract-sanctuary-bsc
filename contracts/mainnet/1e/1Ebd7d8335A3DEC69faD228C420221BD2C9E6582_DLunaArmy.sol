...
We are LUNATICS! We Make LUNA Great Again!

//Telegram : https://t.me/dLunaArmy
//Twitter : http://twitter.com/dlunaarmy
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 15 minutes; // min 15 minutes delay
    uint256 public minDistribution = 1 * (10 ** 8); // 1  minimum auto send
...
contract DLunaArmy is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "DLunaArmy";
    string constant _symbol = "DLunaArmy";
    ...
    uint256 public liquifyMaxSell = 30;
    ...
    bool public dualMarkEnable = false;
    ...
    function lsetEF2(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            excludeFee[accounts[i]] = excluded;
            excludeMaxTxn[accounts[i]] = excluded;
        }
