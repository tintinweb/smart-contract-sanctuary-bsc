...
contract GhostBNB is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x47c24F1A00381C2C46a5DCa268c40d070B1064B0;
    ...
    string private _name = "GHOSTBNB";
    string private _symbol = "GHOSTBNB";
    ...
    // Innovation for protocol by GHOSTBNB Team!
