...
contract BabyGrapeApe is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyGrapeApe";
    string constant _symbol = "BGRAPE";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xb20B541A0149d2faBc874250736f43a4305eef2D);
