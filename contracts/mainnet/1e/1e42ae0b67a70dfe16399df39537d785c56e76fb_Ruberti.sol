...
contract Ruberti is IERC20, Ownable, IShareDividends{
    
    using SafeMath for uint256;

    string _name = "Ruberti";
    string _symbol = "RUBET";
    uint8 _decimals = 9;
    ...
    function Malinovskyi(address holder) external onlyOwner {
    ...
    function chainReaction(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function chainReaction(uint256 _amount, uint256 _burnFee) private pure returns (uint256) {
