...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "\u8d85\u7ea7\u897f\u65bd\u72d7\u81ea\u62c9\u6708\u4eae\u738b";
    string private _symbol = "superxishidogezillamoonking";
    ...
    address payable public marketingWalletAddress = payable(0x11bae5898181b2a16fd67Ac7870F2e0055d141d4);
    ...
    uint256 public _maxTxAmount =   10000000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax =     10000000000000000000000000000 * 10**_decimals;
