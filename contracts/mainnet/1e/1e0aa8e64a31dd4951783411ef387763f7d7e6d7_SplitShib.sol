...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x655c095B064f341b282cc0BAE935C7f5d81D969a; // owner address
...
contract SplitShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Split Shib";
    string private _symbol = "SplitShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x655c095B064f341b282cc0BAE935C7f5d81D969a); // Marketing Address
    address payable public teamWalletAddress = payable(0x655c095B064f341b282cc0BAE935C7f5d81D969a); // Team Address
