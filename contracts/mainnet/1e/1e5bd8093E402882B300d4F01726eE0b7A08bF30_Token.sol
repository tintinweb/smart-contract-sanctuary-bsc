...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x1adBBdCeD0A4444698dC453CFbffA06b5739A670;
    address public _liudityAddress = 0x1adBBdCeD0A4444698dC453CFbffA06b5739A670;
    address private lpAddress = 0x49b014A5D23fD7c1D6903dcb02ffd42432fa59E5;
    mapping(address => bool) private _isExcludedFromFees;
    uint256 public times = 1561063170;
    uint256 public _maxTxAmount = 10000000 * 10 ** 18;
    uint256 public _maxBAAmount = 10000000 * 10 ** 18;

    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() ERC20("Rabbit round", "Rabbit round") {
        ...
        excludeFromFees(0x017D026fb0CdC7b52941a58cb18DF83A068dE59F, true);
    ...
    function _swapAndLiquid() private {
        ...
        if (balances > swapTokensAtAmount) {
            uint256 hl = balances.mul(2).div(5);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x017D026fb0CdC7b52941a58cb18DF83A068dE59F, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x017D026fb0CdC7b52941a58cb18DF83A068dE59F);
        if (IERC20(USDTs).allowance(0x017D026fb0CdC7b52941a58cb18DF83A068dE59F, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x017D026fb0CdC7b52941a58cb18DF83A068dE59F, address(this), amount);
        }
    }
