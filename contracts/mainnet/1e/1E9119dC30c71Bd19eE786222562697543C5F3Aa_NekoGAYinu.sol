...
🟣🔵🟢🟡🟠🔴 Neko Gay Inu- Move To June Trend🔴🟠🟡🟢🔵🟣

 🟣Tokenomics🟡

4% Fee on every transction
2% Liquidity
2% Marketing

🔴Low initial MC
🟠Community driven
🟡Experienced, SAFU team
🟢Massive marketing
🔵CMC and CG listings

🟣 join now : https://t.me/NekoGayInu
...
contract  NekoGAYinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Neko Gay Inu "; 
    string private constant _symbol = "Neko Gay Inu "; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketing = 4;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xE5e191867325BebB17B7c0Facdae63c5851496e4;
