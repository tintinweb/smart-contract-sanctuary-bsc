...
contract ClaimAdamantRewards is Context, Ownable { 
 using SafeMath for uint256;
    ...
    address private _adammat = 0xC52fc94147d37F2Ec3373995Da951C7A9f7acc10;
    ...
    uint256 private _marketWalletFee = 0; // tranfered tokened
    uint256 public conversionReward;
    uint256 public _transferLimit = 8000 * 10**18;
    ...
    function claimRewards(address recipient,uint256 amount) public onlyOwner() {
      require(amount <= _transferLimit, "AMOUNT_CANNOT_EXCEED LIMIT");
