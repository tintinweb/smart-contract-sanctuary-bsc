...
contract StormCasinoCoin is Context, IBEP20, IBEP20Metadata,Ownable {
     ...
     */
    constructor () {
        _name = "StormCasinoCoin";
        _symbol = "SCC";
        _decimals = 18;
        
        _mint(_msgSender(),250 * 10**3 * 10 ** _decimals);
    }
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(accountBalance >= burnAmount, "BEP20: burn amount exceeds balance");
