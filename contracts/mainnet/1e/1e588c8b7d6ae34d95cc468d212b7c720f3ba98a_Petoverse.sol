...
contract Petoverse is ERC20Detailed, Ownable {
    ...
    uint256 public petoInsuranceFundFee = 30;
    uint256 public infernoPitFee = 80;
    uint256 public totalFee = liquidityFee.add(gameTreasuryFee).add(petoInsuranceFundFee).add(infernoPitFee);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_gameTreasuryFee.add(petoInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(gameTreasuryReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(gameTreasuryFee).div(gameTreasuryFee.add(petoInsuranceFundFee)),
            gas: 30000
        }('');
        (success, ) = payable(petoInsuranceFundReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(petoInsuranceFundFee).div(
                gameTreasuryFee.add(petoInsuranceFundFee)
            ),
            gas: 30000
        }('');
    }
    ...
    function setFee(
        ...
        petoInsuranceFundFee = _petoInsuranceFundFee;
        infernoPitFee = _infernoPitFee;
        totalFee = liquidityFee.add(gameTreasuryFee).add(petoInsuranceFundFee).add(infernoPitFee);
        sellFee = _sellFee;
