...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Inazuma Eleven Squid"; //
    string private constant _symbol = "IES"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x07C7c9C0Cb17Bc09c7658f14d8AA94CEfF8E15ae;
