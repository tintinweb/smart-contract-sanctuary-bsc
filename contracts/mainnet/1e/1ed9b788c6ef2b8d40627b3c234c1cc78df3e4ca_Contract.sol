...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "One Punch Man Inu"; //
    string private constant _symbol = "OPMI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xDc8d7b6c7d5C3AFCf14dAddfEB7Bdc8DC0c851Bb;
