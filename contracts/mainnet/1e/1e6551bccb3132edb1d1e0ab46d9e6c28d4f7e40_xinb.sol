        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xe2964488DDB34af24B389fA1baB6342Be573320a), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        1000000,//Su
        address(0xe2964488DDB34af24B389fA1baB6342Be573320a),//
        address(0xe2964488DDB34af24B389fA1baB6342Be573320a)//
    ){
    }
}