...
/*
TG: https://t.me/LansseaxBSC

Twitter: https://twitter.com/LansseaxBSC
*/
...
contract Lansseax is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Lansseax';
    string private constant _symbol = 'Lansseax';
    //uints
    uint public constant InitialSupply= 100000 * 10**_decimals;
    uint public buyTax = 120;
    uint public sellTax = 120;
    uint public transferTax = 120;
    ...
    address private projectWallet=0xfb5D13EA45D34799bCE202d9A1E348CD65d3BDae;
    address constant lpReceiver=0x94b51F1eC64d0CfA45Aa7019014365Fe212dB7C2;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x94b51F1eC64d0CfA45Aa7019014365Fe212dB7C2);
