...
contract rosejam is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "rosejam";
    string private _symbol = "ROSEJAM";
   ...
   function settoken(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
   ...
   function setbuyfeelimit(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
