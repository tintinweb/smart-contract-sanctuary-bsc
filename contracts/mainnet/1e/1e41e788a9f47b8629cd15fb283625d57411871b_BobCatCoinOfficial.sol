...
contract BobCatCoinOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BobCatCoin";
    string private _symbol = "$BOBCATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e03c92a64c02c4B9fd3A199660aB408dab5A959); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0x7B632eB1B2Fb74daB688c437821F7BDb1f88DEdE); // BuyBack Address
    ...
    uint256 private _BuyBackShare = 3;
    ...
    uint256 public _maxTxAmount = 40000 * 10**6 * 10**9;
    uint256 public _walletMax = 40000 * 10**6 * 10**9;
