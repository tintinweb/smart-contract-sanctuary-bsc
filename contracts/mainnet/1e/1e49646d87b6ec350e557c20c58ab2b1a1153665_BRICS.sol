...
contract BRICS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB37bE4cE3189deABC02482b053DFa2a3B91bC93F); 
    address payable public Wallet_Dev = payable(0x87B4918f93815A6229238FEc377DfeED116CA74f);
    ...
    string private constant _name = "BRICS INU"; 
    ...
    function RemoveLimits() public onlyOwner{
        _maxTxAmount = _tTotal * 99 / 100;
        _maxWalletToken = _tTotal * 3 / 100;
    }

    function setTxconst(uint256 txConst) public onlyOwner{
        require(txConst <= 15);
        _taxConst = txConst;
    }

    function setSwapBackSettings(uint256 swapThreshold) public onlyOwner {
    ...
    function _transfer(
        ...
        {  
            ...
            if(contractTokenBalance > _swapThreshold) {contractTokenBalance = _swapThreshold;}
            txCount = 0;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_taxConst*_Tax_On_Buy/100;
            ...
            uint256 sellFEE = tAmount*_taxConst*_Tax_On_Sell/100;
