...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42c9938d9C11f75090b0A03e5ce96479E797da3F; 
...
contract RoyalShibInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Royal Shib Inu";
    string private _symbol = "RYSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42c9938d9C11f75090b0A03e5ce96479E797da3F); 
    address payable public teamWalletAddress = payable(0x42c9938d9C11f75090b0A03e5ce96479E797da3F); 
    ...
    uint256 public _maxTxAmount = 3800000 * 10**_decimals; 
    uint256 public _walletMax = 3800000 * 10**_decimals;
