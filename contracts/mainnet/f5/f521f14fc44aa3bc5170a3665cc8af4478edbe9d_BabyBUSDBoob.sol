...
// Telegram : https://t.me/babybusdyboobsofficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x069CC2a419b1aeb1D771C9d87eACfA0BDB10cE90);
...
contract BabyBUSDBoob is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby BUSD Boob";
    string constant _symbol = "$BaBuBo";
    ...
    //Mainnet
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x069CC2a419b1aeb1D771C9d87eACfA0BDB10cE90;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0C1bed95eAF1D0028BC36B74dc0ae4568eeBB941;
        buybackWallet = 0x0C1bed95eAF1D0028BC36B74dc0ae4568eeBB941;
