...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8e59351A84646774E854B9f8960437FE800a81A7;
...
contract AIKybe is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6b49263922C0753d0fFb29b374DD94B80AF1E664;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AIKybe";
    string private _symbol = "AIK";
