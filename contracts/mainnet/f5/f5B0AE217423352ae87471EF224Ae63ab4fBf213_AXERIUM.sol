...
♻️ AXERIUM SWAP
https://swap.axeriumchain.com
(live)

♻️ AXERIUM DEFI STAKING
https://staked.axeriumchain.com
(live)

♻️ AXERIUM CHAIN  BETA TESTNET EXPLORER
https://betatestnet.axeriumchain.com/
(Live)
...
/* Token contract */
contract  AXERIUM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x518Fa0Ab0D9121894f138484c8f9CAa71850EE7f;
    ...
    // Name and symbol
    string constant _name = "AXERIUM CHAIN";
    string constant _symbol = "AXERIUM";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 180000000 * (10 ** _decimals); // 100 Million
