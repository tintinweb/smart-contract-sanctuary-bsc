...
contract ElonX is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x6F8a258A4ea266888d6Ab367D161Eea3d0fB8E10);
    address payable public MarketingWallet = payable(0x778db8B046857b81A5F82f7e2b37b5518E85080b);
