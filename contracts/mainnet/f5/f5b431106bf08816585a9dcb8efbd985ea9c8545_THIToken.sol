 ...
 * 
 */
contract THIToken is IERC20 {
    
    using SafeMath for uint256;
    
    //THI token, creator will take 0.6% fee
    address public feeTo = 0x1aBeD4e94389B0d23178116bbB4F65e6Ce556Af6;

    string public name = "THI Token";
    string public symbol = "THI";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //THI Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 THI
