...
contract Lemon is LemonDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private LemonTeam;
    address private CharityLemon;
    ...
    string public override name = "Lemon";
    string public override symbol = "Lemon";
    ...
    constructor(uint totalSupplyValue, address LemonTeamAddress, address CharityLemonAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LemonTeam = LemonTeamAddress;
        CharityLemon = CharityLemonAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LemonTeam] =  totalSupply * 4 / 100;
        balances[CharityLemon] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LemonTeam pot
