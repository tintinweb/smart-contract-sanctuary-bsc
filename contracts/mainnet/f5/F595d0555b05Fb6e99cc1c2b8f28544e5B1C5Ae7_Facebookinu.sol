...
contract Facebookinu is IBEP20, Auth {
    ...
    string constant _name = "Facebook inu";
    string constant _symbol = "FBI";
    ...
    address public marketingFeeReceiver = 0x29C3E9E796853bA84c9ae853715381C7fb3061CF;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 100; // 1.0% = 10000 * 100
    bool inSwap;
