...
contract PerryThePlatyPus is Context, IERC20, Ownable {
    ...
    string private _name = "PerryThePlatyPus";
    string private _symbol = "PTPP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x375De83f0C550e4b692635FA2225268B23BE7EF3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x375De83f0C550e4b692635FA2225268B23BE7EF3); // BuyBack Address
