...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71674f9a6d6f413B4615e80ADD6b7ef4B00c4fc6;
...
contract Cowrie is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x890c3D54a40F913dfb4382EDdb8CDe6Cd7e861CC);
    ...
    address private _authorized = 0x71674f9a6d6f413B4615e80ADD6b7ef4B00c4fc6;
    ...
    */
    ...
    string private _name = "Cowrie"; 
    string private _symbol = "$COWR";  
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(300).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(300).div(100); 
