...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C003e42a1f16Bd1198dc4affBAed5752241F40f;
...
contract MoonSift is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0C003e42a1f16Bd1198dc4affBAed5752241F40f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MoonSift";
    string private _symbol = "MoonSift";
