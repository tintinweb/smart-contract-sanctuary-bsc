...
contract Shangresou is ERC20 {
	...
	address private _fundAddress = address(0x20a7204f0c895F0Ab1F68CE5Fd220c236eB4dA54);
    ...
    constructor(address tokenOwner) ERC20("Shangresou", "Shangresou") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 1 * 10**29;
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			changeUsdtAmount = changeUsdtAmount.add(amount.div(100).mul(4));
