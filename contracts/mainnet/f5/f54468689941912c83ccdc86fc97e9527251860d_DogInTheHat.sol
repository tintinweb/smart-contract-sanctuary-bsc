...
contract DogInTheHat is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x89EdC32Cc6ACcD5e0ce3A3891834ECC951F3041e;
    address public devWallet = 0x89EdC32Cc6ACcD5e0ce3A3891834ECC951F3041e;

    string private constant _name = "DogInTheHat";
    string private constant _symbol = "DIH";
    ...
    Taxes public taxes = Taxes(1, 1, 5, 0);
    Taxes public sellTaxes = Taxes(1, 1, 9, 0);
