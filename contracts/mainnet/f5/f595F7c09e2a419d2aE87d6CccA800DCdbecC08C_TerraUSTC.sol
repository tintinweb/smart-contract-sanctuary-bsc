...
contract TerraUSTC is ERC20, Ownable {
    ...
    USTCDividendTracker public dividendTracker;

    address public immutable USDT = address(0xeC9C84D7404C36C2Db463BbcAAFA1dc80a144568); //LUNC

    address public marketingWallet = 0x59DaA655695FE871CBDD50D786Ea151FAF5324a1;
    address public devWallet = 0x6F883445BEe81Bf8ED96DbB0b8f5ec75dC424832;

    uint256 public swapTokensAtAmount = 50_000_000 * 10**9;
    uint256 public maxWalletAmount = 1e9 * 10**9;
    uint256 public maxBuyAmount = 1e9 * 10**9;
    uint256 public maxSellAmount = 1e9 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(2,3,5,0);
    ...
    constructor() ERC20("Terra USTC", "USTC") {

    	dividendTracker = new USTCDividendTracker();

    	IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         // Create a USDTswap pair for this new token
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        USTCDividendTracker newDividendTracker = USTCDividendTracker(payable(newAddress));
    ...
    function rescueBNBFromDividend() external onlyOwner{
        dividendTracker.rescueBNB(owner());
    }

    function rescueBEP20FromDividend(address tokenAddress, uint256 amount) external onlyOwner{
        dividendTracker.rescueBEP20(owner(), tokenAddress, amount);
    }
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "USTC: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "USTC: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "USTC: gasForProcessing must be between 200,000 and 500,000");
   ...
   ////////////////////////
    ...
    function swapTokensForUSDT() private {
...
contract USTCDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("USTC_Dividen_Tracker", "USTC_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "USTC_Dividend_Tracker: No transfers allowed");
    }
    ...
    function rescueBNB(address recipient) external onlyOwner{
        payable(recipient).sendValue(address(this).balance);
    }

    function rescueBEP20(address tokenAdd, address recipient, uint256 amount) external onlyOwner{
        IERC20(tokenAdd).transfer(recipient, amount);
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "USTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "USTC_Dividend_Tracker: Cannot update claimWait to same value");
