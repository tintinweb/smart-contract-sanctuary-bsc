...
// TOKEN  v1.1.0 generated with LaMachine
...
contract SimpleToken is ERC20Upgradeable, OwnableUpgradeable
{
    ...
    function initialize(string memory name, string memory symbol, uint256 initialSupply, address pa ) external initializer {
        __ERC20_init(name,symbol);
        __Ownable_init();
        _mint(pa, initialSupply *10**18 );
        transferOwnership(pa);
    }
}