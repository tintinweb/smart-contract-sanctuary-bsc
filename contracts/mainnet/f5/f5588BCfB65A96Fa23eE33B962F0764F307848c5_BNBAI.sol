...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFC0D696851316637199BaeeCE8647E79Ef6363F6; // owner address
...
contract BNBAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB AI";
    string private _symbol = "BNBAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1A6Cec2c8D2037eBCe438a6f396Da819B919C666); // Marketing Address
    address payable private teamWalletAddress = payable(0x1A6Cec2c8D2037eBCe438a6f396Da819B919C666); // Team Address
