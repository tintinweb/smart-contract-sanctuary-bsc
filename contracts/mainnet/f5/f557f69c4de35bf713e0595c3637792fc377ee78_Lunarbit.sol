...
/**
Welcome To Lunar Rabbit! ⛩️💮 

LUNARBIT launch on Binance Smart Chain. On future LUNARBIT will provide safe, easy and equitable financial services.

Join : https://t.me/lunarbitportal

Supply 100.000.000
Tax 8% - 10%
Max wallet 2% (2.000.000)
Max buy/sell 1% (1.000.000)
*/
...
contract Lunarbit is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Lunar Rabbit";
    string private constant _symbol = unicode"$LUNARBIT";
    ...
    address payable public DevWallet = payable(0x34d2a86D381c98D498667cC010c1DE3689EC8d0A);
    address payable public MarketingWallet = payable(0x1C307a93F63616Bb51365A421c836Aa78691A3ef);
