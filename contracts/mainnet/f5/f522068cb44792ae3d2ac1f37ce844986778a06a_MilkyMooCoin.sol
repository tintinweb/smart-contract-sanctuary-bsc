...
// Telegram : https://t.me/milkymoocoin
...
contract MilkyMooCoin is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 0.4 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "MILKY MOO COIN"; // 
    string private constant _symbol = "MILKY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xbf73B4b11bA2412DED3ba95063Cb48Ef0677c755;
