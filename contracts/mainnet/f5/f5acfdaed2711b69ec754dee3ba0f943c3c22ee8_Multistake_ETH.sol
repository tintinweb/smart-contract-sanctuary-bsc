...
contract Multistake_ETH {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; // ETH
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 0.003 ether; // 0.003 XRP
    uint256[] public REFERRAL_PERCENTS = [50, 20, 10];
    uint256 public constant TOTAL_REF = 100;
    uint256 public constant FUND_FEE = 20;
