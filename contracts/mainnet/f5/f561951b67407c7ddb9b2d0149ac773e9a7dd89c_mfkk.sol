...
contract mfkk is Context, IERC20, Ownable {
    ...
    string private constant _name = "mfkk";
    string private constant _symbol = "mazen";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xED39BC4aFDd1fB2BBCc16F9d645E96DAdd4A6325)] = true; //uniswap router liquidity
