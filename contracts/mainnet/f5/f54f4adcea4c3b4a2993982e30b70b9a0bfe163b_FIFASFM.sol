...
contract FIFASFM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fifa Safemoon"; // 
    string private constant _symbol = "FIFASFM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0x80fC17B29D0F58bbDdeCc8e1E06E333c89dFAb27);
