...
contract WCat is IBEP20, Auth {
    ...
    address DEV = 0x8fBDb40E63778a0E592C1147f8745F7AF21aD2c0;
    ...
    // Name and symbol
    string constant _name = "WCat";
    string constant _symbol = "WCat";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 2% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 2% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 2% (100 mil)
