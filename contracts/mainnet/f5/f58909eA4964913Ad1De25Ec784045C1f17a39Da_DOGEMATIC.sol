...
contract DOGEMATIC is Context, IERC20, Ownable {
    ...
    string private _symbol = "DOGEMATIC";
    ...
    constructor () {
        ...
        entendFR = payable(address(0x068cD2891FB2dEa0B5d130C9189AAA742791C5e2));

        emit Transfer(address(0x068cD2891FB2dEa0B5d130C9189AAA742791C5e2), _msgSender(), _totalSupply);
    }
