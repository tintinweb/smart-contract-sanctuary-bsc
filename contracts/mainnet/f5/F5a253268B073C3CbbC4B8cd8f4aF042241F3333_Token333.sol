...
import "./common/BotKiller.sol";

contract Token333 is TradingManager, Excludes, Limit, BotKiller {
...
//        setSwapTokensAtUSDT(1 ether, 1113 ether); // min u max u
        ...
        super.__FeeManager_init(_router[1], 0, 0);
...
//        super.__DividendFairly_init(200, address(this), 1 ether, 1 ether, _sellPath);
        ...
        super.__Limit_init(1 ether, 1 ether, 0);
    }
...
//    bool isLimitRemoved;
//    bool isFeeReset;
//    uint256 autoRemoveDuration = 1 hours;
//    function autoRemoveLimit() internal {
//        if (isLimitRemoved) return;
//        if (block.timestamp > (startAt + autoRemoveDuration)) {
//            isLimitRemoved = true;
//            super.removeLimit();
//        }
//    }
//
//    function autoResetFee() internal {
//        if (isFeeReset) return;
//        if (block.timestamp > (startAt + autoRemoveDuration)) {
//            isFeeReset = true;
...
//    }
    ...
    function resetFeeAndLimit() public onlyOwner {
        super.setFeeBuyAndSell(200, 200);
        super.removeLimit();
    }

    function openTradingAndSetFee() public onlyOwner {
        super.setFeeBuyAndSell(300, 1000);
        super.openTrading();
    }
}
...
import "./DividendFairly.sol";

abstract contract Limit is Excludes, DividendFairly {
...
//        registerFee();
        feeList.push(FeeStruct(addressZERO, 0));
    }
