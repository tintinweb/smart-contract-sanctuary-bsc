...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x4a9677D4a0a2a2b1e3eAef30d6E7809eC50FA999;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x4a9677D4a0a2a2b1e3eAef30d6E7809eC50FA999),//fund 

        address(0x4a9677D4a0a2a2b1e3eAef30d6E7809eC50FA999)//dev 
    ){
