...
contract SatoshiNakaMoto is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1BaF130DDbfd1DF5F164210C86467Bc1B179fD2A); // Marketing Address
    address payable public teamWalletAddress = payable(0x1BaF130DDbfd1DF5F164210C86467Bc1B179fD2A); // Team Address
    ...
    uint256 public _maxTxAmount = 10* 10**4 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 10 * 10**4 * 10**6* 10**_decimals;
