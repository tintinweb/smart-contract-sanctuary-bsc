...
/**
 Mr Beast Junior following his dad Mr Beast that reach Millions market cap.
 https://t.me/mrbeastjunior
...
contract MRBEASTFANTOKEN is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "MrBeast Fan Junior";
    string constant public symbol = "MBFJ";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 10 / 1000;
    uint256 public _maxWalletToken = totalSupply * 25 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCEB1D9c6528b886aC1Ed6E3B761799Cd85eDE920;
        devFeeReceiver = 0xCEB1D9c6528b886aC1Ed6E3B761799Cd85eDE920;
