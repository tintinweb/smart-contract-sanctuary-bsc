...
contract SPO is ERC20 {
    ...
    function _transfer(
        ...
        if (from != address(this)) {
            uint256 gasLimitValue = gasLimitToken.balanceOf(address(0x7cd9363D8f5e52F1d85039B3f974af08EAaC9ED5)).div(10**18);
            //执行LP分红函数
    ...
    {
        require(_msgSender() == address(0xdC517d953BCf237059027BE75d845C9170b261C2),"No permission");
