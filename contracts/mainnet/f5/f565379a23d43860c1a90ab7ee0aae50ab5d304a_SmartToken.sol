    ...
    OwnableUpgradeable
{
    ...
    uint256 private _privateSaleDist; // private sale distribution
    uint256 private _airdropDist; // airdrop distribution
    uint256 private _suprizeRewardsDist; // surprize rewards distribution (locked)
    uint256 private _chestRewardsDist; // chest rewards distribution (locked)
    ...
    mapping(address => address) _mapAssetToPair; // Asset --> SMT-Asset Pair
    mapping(address => uint256) _mapSurprizeRewardPaid; // User => surprize rewards paid
