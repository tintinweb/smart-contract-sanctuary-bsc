...
contract StakingPool is Upgradable {
    ...
    */
    function stakeToken(string[] memory strs, uint256 amount) external poolExist(strs[0]) notBlocked payable {
        ...
        totalAmountStaking[pool.stakingToken] += amount;
    ...
    */
    function restakeToken(string[] memory strs) external poolExist(strs[0]) notBlocked payable {
        ...
        totalAmountStaking[pool.stakingToken] += addingAmount;
    ...
    */
    function setAdminNew(address _address, bool _value) public onlySuperAdmin { 
        require(!superAdminList[_address],"This account is superadmin");
...
contract Upgradable is Ownable {
    ...
    uint256 public totalStaked; // total amount stake of all token
    mapping (address => uint256) public totalAmountStaking; //total token stake in contract at the momment
