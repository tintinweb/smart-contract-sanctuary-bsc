...
contract MiamiGP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiamiGP";
    string private _symbol = "MiamiGP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2b9156778563caecc6C8Dfe9144F18f7c3C51C26); 
    address payable public BurnedWalletAddress = payable(0x2b9156778563caecc6C8Dfe9144F18f7c3C51C26); 
