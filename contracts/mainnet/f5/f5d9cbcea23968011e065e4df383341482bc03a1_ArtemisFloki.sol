...
contract ArtemisFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArtemisFloki";
    string private _symbol = "ArtemisFloki";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5eD131a83D31D695622D676593b0A0831F57852A); 
    address payable public buyBackWalletAddress = payable(0x5eD131a83D31D695622D676593b0A0831F57852A); 
