...
//Telegram : https://t.me/EazyCopytrading
//Website : https://eazycopytrading.live/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x40b59fB01c44a6E5790E53C04ed9C6fc755Cdd40; // owner address
...
contract EazyCopytrading is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eazy Copytrading";
    string private _symbol = "EAZY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBEcC3B4F3866cB3658F58ad3955664CAa53C86bc); // Marketing Address
    address payable public teamWalletAddress = payable(0x40b59fB01c44a6E5790E53C04ed9C6fc755Cdd40); // Team Address
