...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1da775Bbd23f702898bd48852873128896d05Ee9; // owner address
...
contract DevIsDead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevIsDead";
    string private _symbol = "DEAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6582d9a2D1F7114f4008382E14a3D8945b5e06b); // Marketing Address
    address payable public buybackWalletAddress = payable(0x1da775Bbd23f702898bd48852873128896d05Ee9); // Buyback Address
