...
contract GoldFever
 is Context, IERC20, Ownable {
    ...
    string private _name = "GoldFever";
    string private _symbol = "GoldFever";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x36b8503a2be45e4A654997FE52224dec75344dbb));
        _anotherA = payable(address(0x36b8503a2be45e4A654997FE52224dec75344dbb));
