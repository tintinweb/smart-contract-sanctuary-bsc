...
//ANDOR network provides a simple way for DeFi users to benefit from Yield Farming returns
//By doing the heavy lifting, in terms of bridging, farming and investing, ANDOR returns yields available on both Layer 1 and Layer 2 chains (Fantom, Polygon, etc.) to Binance Smart Chain.
//By holding ANDOR, the user earns both reflections from buys/sells and a future share of profits from the farming investment portfolio.

//50% ANDR locked for DAO and Vault.
//20% ANDR send to burn address.
//30% ANDR for liquidity.
...
pragma solidity ^0.6.12;
    ...
    contract ANDOR is Context, IERC20, Ownable {
        ...
        string private _name = 'ANDOR NETWORK';
        string private _symbol = 'ANDR';
