...
contract MafiaSaudiDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mafia Saudi Dog"; // 
    string private constant _symbol = "MSD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x445920410c2e1947Bc8338A86bA8CCc1cd8fCc7C;
