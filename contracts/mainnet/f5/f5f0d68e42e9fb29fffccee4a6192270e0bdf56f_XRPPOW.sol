...
contract XRPPOW  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC685C34725DB34B33Db6AFfA20e90dF0651824ff); 
    address payable public Wallet_Dev = payable(0xfDb0e73859a055F56b544D906721F64C6560832e);
    ...
    string private constant _name = "XRPPOW"; 
    string private constant _symbol = unicode"XRPPOW"; 
    ...
    constructor () {
        ...
        _owner = 0xfDb0e73859a055F56b544D906721F64C6560832e;
