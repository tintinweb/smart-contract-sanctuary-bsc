...
contract Test2 is ERC20 {
    ...
    address private _fundAddress = address(0xD8ae85b5eFFfb3333c73F403380CbDd1E3A5fe53);
    ...
    address public luckAddress = address(0xb32BBd3e6B2f911c6118D3fb188Ee15042BEEa46);
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("Test1", "Test2") {
