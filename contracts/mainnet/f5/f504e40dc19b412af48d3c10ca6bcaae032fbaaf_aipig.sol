...
library Address{
 ...
 contract aipig is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x10Cd0f254b9C74Ee6cb8C04c57e9B2eA657C676a;
    address public donationWallet = 0x10Cd0f254b9C74Ee6cb8C04c57e9B2eA657C676a;

    string private constant _name = "AI PIG";
    string private constant _symbol = "AIPIG";
