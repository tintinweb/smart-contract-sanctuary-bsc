...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09b754BA0f822a3C02733cbF691C65fa9a996Bdc; 
...
contract MOONDAY is Context, IERC20, Ownable {
    ...
    string private _symbol = "MOONDAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09b754BA0f822a3C02733cbF691C65fa9a996Bdc); 
    address payable public teamWalletAddress = payable(0x09b754BA0f822a3C02733cbF691C65fa9a996Bdc); 
    ...
    uint256 private _totalSupply = 222222 * 10**_decimals;
