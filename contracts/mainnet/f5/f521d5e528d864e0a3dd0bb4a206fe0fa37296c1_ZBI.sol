...
contract ZBI is ERC20, Ownable {
    ...
    IERC20 public RC1 = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "ZBI: The marketing wallet is already this address");
    ...
    function updateDevWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != devWallet, "ZBI: The dev wallet is already this address");
    ...
    function updatebusdTokenDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(busdTokenDividendTracker), "ZBI: The dividend tracker already has that address");
 
        BUSDDividendTracker newbusdTokenDividendTracker =  BUSDDividendTracker(payable(newAddress));
 
        require(newbusdTokenDividendTracker.owner() == address(this), "ZBI: The new dividend tracker must be owned by the ZBI token contract");
    ...
    function updateRc1DividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(rc1DividendTracker), "ZBI: The dividend tracker already has that address");
 
        RC1DividendTracker newrc1DividendTracker = RC1DividendTracker(payable(newAddress));
 
        require(newrc1DividendTracker.owner() == address(this), "ZBI: The new dividend tracker must be owned by the ZBI token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "ZBI: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ZBI: The PanadaSwap pair cannot be removed from automatedMarketMakerPairs");
 
        _setAutomatedMarketMakerPair(pair, value);
    }
 
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "ZBI: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "ZBI: Cannot update gasForProcessing to same value");
...
contract RC1DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("RC2_RC1_Dividend_Tracker", "RC2_RC1_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "RC2_RC1_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ZBI contract.");
    }
...
contract BUSDDividendTracker is DividendPayingToken {
    ...
    function withdrawDividend() pure public override {
        require(false, "RC2_BUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ZBI contract.");
    }
