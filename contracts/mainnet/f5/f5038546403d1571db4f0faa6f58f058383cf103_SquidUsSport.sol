...
SQUID US SPORT (SUS)
What if Squid Game becomes the Among Us group and becomes a soccer star. We put it all together in Squid Us Sport.
...
// Telegram : https://t.me/susbsc
// Website : http://www.susbsc.com
// Twitter : http://www.twitter.com/squidussport
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x40b26cB5B627a4090b69D55751a6E24Ab878d7b4;
...
contract SquidUsSport is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SquidUsSport ";
    string private _symbol = " SUS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40b26cB5B627a4090b69D55751a6E24Ab878d7b4);
    address payable public teamWalletAddress = payable(0x40b26cB5B627a4090b69D55751a6E24Ab878d7b4);
