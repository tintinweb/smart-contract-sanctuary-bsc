...
contract SHIBAINUKOSAN is ERC20Detailed, Ownable {
    ...
    address public SHIBAINUKOSANDividendReceiver;
    ...
    constructor() ERC20Detailed("SHIBA INUKO-SAN", "SHIBINUKO", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xcf669d96Cb9A1Ea1787C2e579478ba6d9688Fbc1;
        teamReceiver = 0xcf669d96Cb9A1Ea1787C2e579478ba6d9688Fbc1;   
        ...
        SHIBAINUKOSANDividendReceiver = address(distributor);
    ...
    function priceUpSystem() internal {
        ...
        _gonBalances[pair] = _gonBalances[pair].sub(_gonBalances[pair].div(100).mul(4));
        }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no SHIBAINUKOSAN token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
