...
contract QFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Queen Floki";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "QFloki";
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x93B8FCBCAbdf8Ff13779De3fE8680e5Bf1EC51B6;
        marketingFeeReceiver = 0x93B8FCBCAbdf8Ff13779De3fE8680e5Bf1EC51B6;
