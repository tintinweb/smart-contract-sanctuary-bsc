...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x085fd441C8c6b0ad671Ac22Af8454bcc91dF58A3;
...
contract DEORBITBURN is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"DEORBITBURN"; 
    string private constant _symbol = unicode"$DBURN"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x085fd441C8c6b0ad671Ac22Af8454bcc91dF58A3), BNB_Tot);
            }
