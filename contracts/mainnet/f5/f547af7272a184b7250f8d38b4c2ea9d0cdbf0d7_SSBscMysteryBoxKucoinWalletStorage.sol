...
library SSBscMysteryBoxKucoinWalletType {

    string constant _name_ = "Superpower Squad Mystery Box Kucoin Wallet Bsc";
    string constant _symbol_ = "SSMBKWBsc";
    string constant _uri_ = "https://www.ssquad.games/mysteryBoxKucoinWalletBsc";
