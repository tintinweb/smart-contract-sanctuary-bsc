...
contract Kobito is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kobit";
    string private _symbol = "KOBITO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2AA63f034e093af963d0D7bC7B57575E5ae63b40); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2AA63f034e093af963d0D7bC7B57575E5ae63b40); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**9; // 1% max tx
