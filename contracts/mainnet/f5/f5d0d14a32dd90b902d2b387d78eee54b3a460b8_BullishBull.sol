...
contract BullishBull is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x71c2616AadAbD307337059D1E147f3e2a9d95744); // Marketing Address
        
    address payable public CharityAddress =
        payable(0x8f7903e312B2652C085de0A8be35FBC72d6481F5); // Charity Address
    ...
    uint256 private constant _tTotal = 600 * 1e9 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "BullishBull";
