...
Telegram : https://t.me/STARBOYSHIBA
...
contract STARBOYSHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf0fe6fef55abCEfD7A48F4B39c9C68720A69F5E5); 
    address payable public Wallet_Dev = payable(0x9f5Fd0f0c0494f7e520285F9377a0bd6a6aA9C14);
    ...
    string private constant _name = "STARBOYSHIBA"; 
    string private constant _symbol = unicode"SBOYSHIBA"; 
    ...
    constructor () {
        ...
        _owner = 0x9f5Fd0f0c0494f7e520285F9377a0bd6a6aA9C14;
