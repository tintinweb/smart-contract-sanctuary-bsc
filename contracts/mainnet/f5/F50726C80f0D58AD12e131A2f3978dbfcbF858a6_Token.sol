...
contract Token is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "CoinForHumanity";
        _symbol = "CFH";
        _decimals = 18;
        uint256 amount = 21000000000000000000000000000; // 1B
        _totalSupply = amount;
    ...
    function addToLockWhitelist(address wallet) external onlyOwner {
        _lockWhiteList[wallet] = true;
    }

    function removeFromLockWhitelist(address wallet) external onlyOwner {
