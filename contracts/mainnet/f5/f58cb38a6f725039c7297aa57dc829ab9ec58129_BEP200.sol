...
contract BEP200 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCube";
    string private _symbol = "BabyCube";
    ...
    constructor (address own) {
        ...
        ownerLi = owner();
        teamWalletAddress = payable(0x791D1Abd2F39aa3aE9f48619ad0159C0Dba31c2f);
        marketingWalletAddress = payable(0x8B65ad31e1F9dDC43Cb06a899Bc9C4e8BB93A3Ff);
