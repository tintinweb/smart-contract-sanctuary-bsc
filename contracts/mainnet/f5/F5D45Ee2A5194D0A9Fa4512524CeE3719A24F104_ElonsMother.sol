...
/* Token contract */
contract ElonsMother is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x53254FC17a880F0495E8b5B80792b512c5BFDCAE;
    ...
    // Name and symbol
    string constant _name = "Elon's Mother";
    string constant _symbol = "ZAYE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 74000000 * (10 ** _decimals); // 100m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x90942851F823EF129B6da8A2Bf87ac95512cc46a;
