...
contract InsuranceFundV1 is Ownable {
    ...
    function setRewardBurnRate( uint256 burnRate ) external onlyOwner {
        generalNFTReward.setRewardBurnRate(burnRate);
    }
...
interface IGeneralNFTReward {
    ...
    function setRewardBurnRate( uint256 burnRate ) external;
