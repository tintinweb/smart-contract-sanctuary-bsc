...
/**
    Moon Labs is a utility-driven, multi-purpose project, 
    centered around providing easy-to-use tools for developers and investors.$MLAB is a hyper deflationary token 
    that implements aggressive internal and external burn methods. $MLAB burns tokens on every trade along with a percentage 
    of all profits generated by Moon Labs is directed towards burning $MLAB tokens. 
    
    Check out our NFTs that airdrop you BNB just for holding!

    Website  : https://www.moonlabs.site
    Twitter  : https://twitter.com/MoonLabOfficial
    Telegram : https://t.me/MoonLabsOfficial
...
contract MoonLabs is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5a5D2F9D68b4D45de8bB9f5B12a9421DbCA825ba);
    address payable public DevelopmentWalletAddress = payable(0x5a5D2F9D68b4D45de8bB9f5B12a9421DbCA825ba);
