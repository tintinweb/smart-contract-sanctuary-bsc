...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc812BD6d3d74F5aB2129868920e352Eb5763CC6b; // owner address
...
contract Litedex is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Litedex Official";
    string private _symbol = unicode"LDEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc812BD6d3d74F5aB2129868920e352Eb5763CC6b); // Marketing Address
    address payable public teamWalletAddress = payable(0xc812BD6d3d74F5aB2129868920e352Eb5763CC6b); // Team Address
