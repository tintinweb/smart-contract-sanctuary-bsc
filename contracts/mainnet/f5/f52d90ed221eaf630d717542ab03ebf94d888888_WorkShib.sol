...
contract WorkShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WorkShib";
    string private _symbol = "WorkShib";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x59Dce22C552d8D63FAf58F7e16315C01a6a96E8a); 
    address payable public BurnedWalletAddress = payable(0x59Dce22C552d8D63FAf58F7e16315C01a6a96E8a); 
