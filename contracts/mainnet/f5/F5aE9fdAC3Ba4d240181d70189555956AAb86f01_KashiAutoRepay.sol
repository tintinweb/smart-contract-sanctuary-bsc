...
import "../interfaces/IKashiAutoRepay.sol";
...
contract KashiAutoRepay is Ownable, IKashiAutoRepay {
  ...
  function selfLiquidatePayDefault(
    ...
    uint256 feeAmount,
    KashiArgs calldata kashiArgs
  ) external override userFeeVerified returns (uint256 actualParts) {
  ...
  function _selfLiquidatePaySpecific(
    ...
    actualRepayParts = kashiArgs.pair.totalBorrow().toBase(_amountOf.realAsset * 999999 / 1000000, false);   // deduct 0.0001% for overflow by roundUp
...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "./IKashiPairMediumRiskV1.sol";

interface IKashiAutoRepay {
