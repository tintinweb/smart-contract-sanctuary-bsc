...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA452D7c5E8eA24A9Ff439059b74359aCa5BF714c;
...
contract RamitHealth  is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply = 500000000000000000000  *(10**decimals());
    ...
    constructor () {
        ...
        _balances[owner()]= 400000000000000000000 *(10**decimals());
        _balances[devWallet] = 100000000000000000000 *(10**decimals());
      
        emit Transfer(address(0),devWallet, 100000000000000000000*(10**decimals()));
        emit Transfer(address(0),owner(), 400000000000000000000*(10**decimals()));
