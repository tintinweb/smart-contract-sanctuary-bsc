...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75324Abc41F8e1F0D31dF3780C85844cA2aa6665; // owner address
...
contract WatCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WatCat";
    string private _symbol = "WatCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75324Abc41F8e1F0D31dF3780C85844cA2aa6665); // Marketing Address
    address payable public teamWalletAddress = payable(0x75324Abc41F8e1F0D31dF3780C85844cA2aa6665); // Team Address
