...
/******************************************************************************
Token Name : UMBRELLA POWER INNOVATION V2
Short Name/Ticker : UPIV2
Total Supply : 1000000000 UPI V2
Decimal : 8
Platform : BEP20 
Project Name : UMBRELLA POWER INNOVATIONV2
...
Buy Fee 2% Marketing, 1% Auto Burn, 6% Reflection, 0.5%helping, 0.5%charity
Sell Fee 2% Marketing, 1% Auto Burn, 6% Reflection, 0.5%helping, 0.5%charity
Marketing Distributed In Two Part 1% of Marketing In Sub Marketing
...
contract UmbrellaPowerInnovationV2 is Context, IERC20, Ownable {  
    ...
    string private _name = "Umbrella Power Innovation V2";
    string private _symbol = "UPIV2";
    ...
    constructor () public {
        ...
        marketingwallet = 0x823D22589653E82c88f3d59b26cCaC333a9B18BD;
        submarketingWallet= 0x08F466e52aE7EC18Db54bbF68A851302c76f4b60; 
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee) private {
        ...
        MarketingShare=tAmount.mul(_marketingPer).div(10**3);
        RewardShare=tAmount.mul(_RewardPer).div(10**6);
        BurningShare=tAmount.mul(_autoBurnPer).div(10**1);      
