...
contract ABSORBER is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "ATEST";
    ...
    //Tax wallets
    address public teamWallet = 0x8473ca0543d22781F6C7AD2A1d2146D073797ead;
    address public treasuryWallet = 0xa00A9A272a02CaE4aBc5ea6554cCd34696f22e07;
    ...
    uint256 public constant TRADE_OPEN_TIME = 1677794410;
    ...
    /** Purchases ABSORBER Tokens and Deposits Them in Sender's Address*/
        ...
        returns (bool)
    {
        ...
        // revert if under 1
        require(tokensToSend > 1, "Must Buy more than 1 decimal of ABSORBER");

        // revert for slippage
        require(tokensToSend >= minTokenOut, "INSUFFICIENT OUTPUT AMOUNT: TRY AGAIN");
    ...
    /** Sells ABSORBER Tokens And Deposits the BNB into Seller's Address */
    function _sell(
        uint256 tokenAmount,
        uint256 deadline,
        uint256 minBNBOut
