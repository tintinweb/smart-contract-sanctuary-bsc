...
After reaching 80M mcap in eth, we will now bring $CAWS on BSC.

CAWS BSC is a Decentralized and Community-driven project which intends to develop NFTs and utilities. We want to be recognized as one of the popular meme in BSC.
Write to Chameleon Team
...
1% max TRX, 1% max wallet

TG: http://t.me/CAWSBSC
...
contract CAWSBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "CAWS BSC";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            marketing: 95, // marketing fee in %
            lp: 2, // lp rate in %
            toSwap: 6 // marketing + lp
        });
