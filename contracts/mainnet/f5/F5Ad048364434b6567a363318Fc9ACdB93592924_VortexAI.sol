...
https://t.me/vortexai
Vortex AI brings together  building ML under one, unified UI and API.
...
contract VortexAI is IBEP20, Auth {
    ...
    string constant _name = "VortexAI";
    string constant _symbol = "VortexAI";
