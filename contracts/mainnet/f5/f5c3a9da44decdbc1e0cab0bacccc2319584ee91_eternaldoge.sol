...
contract eternaldoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "eternaldoge";
    string private _symbol = "eternaldoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6BbF46c762250Ac0a73e271037Fe0b84Ec333dB1); // Marketing Address
    address payable public teamWalletAddress = payable(0x672188E211AA0D4A2a9E8A9edE3A672CaDB2BBC5); // Team Address
	address public OwnerAddress = 0x6BbF46c762250Ac0a73e271037Fe0b84Ec333dB1;
