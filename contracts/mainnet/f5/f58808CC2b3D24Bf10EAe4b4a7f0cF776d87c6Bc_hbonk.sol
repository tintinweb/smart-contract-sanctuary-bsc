...
contract hbonk is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"HonkBonk"; 
    string private constant _symbol = unicode"HBONK"; 
