...
contract CupDao is ERC20 {
	...
	address public _fund1Address = address(0x6c557688A6FD98D120dbB320d3B424681D47413B);
	address public _fund2Address = address(0x476377ffC700A8a0386825173d7eA4A5021FAA63);
	address public _fund3Address = address(0x6Ec9052B3d24F81AbE21E407CCDb2938ba7E9fEF);
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			USDT.transfer(_fund1Address,newAmount.div(100).mul(1));
			USDT.transfer(_fund2Address,newAmount.div(1000).mul(5));
			USDT.transfer(_fund3Address,newAmount.div(1000).mul(5));
		}
    }
