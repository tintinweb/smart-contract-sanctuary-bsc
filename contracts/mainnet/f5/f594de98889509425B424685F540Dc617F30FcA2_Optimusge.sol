...
Optimus Doge, cryptocurrency project created to support and honor Doge's friends, Elon Musk, and Optimus. 
Optimusge is being developed by Optimus. with a plan to change the way we live and work forever. 
Our project is designed to pay tribute to the Optimus Bot with our own blockchain and AI innovation.
...
contract Optimusge is Context, IERC20, Ownable {
    ...
    string private _symbol = "OPTIMUSGE";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x894d91eBEB916eAbC9764c94cBA8E9988Bb79B07); // Marketing Address
    address payable public BuyBackWallet = payable(0x894d91eBEB916eAbC9764c94cBA8E9988Bb79B07); // Team Address
