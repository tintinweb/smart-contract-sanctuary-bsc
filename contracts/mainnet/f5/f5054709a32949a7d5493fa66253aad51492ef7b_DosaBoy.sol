...
contract DosaBoy is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DOSB";
    string private constant _symbol = unicode"DOSB";
    ...
    address payable private MarketingWallet = payable(0x9510C9Ec7aEC6f9e3D3B33DcD45087B468A94b0C);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && _TxCount >= swapTrigger) {idclaim();}
