...
contract ShirojiInuGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiroji Inu Girl"; //
    string private constant _symbol = "SIG"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xA8e9BBd7092790113EF19DC43dAE184b563FC69C;
