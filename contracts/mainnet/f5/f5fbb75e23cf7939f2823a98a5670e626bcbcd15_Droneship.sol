...
contract Droneship is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xC0A9dD46D0a9D288Cc89bBF40c9836ffa28e2469); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x63470D280Dda5561C1Ef6aBC85e0CD69236ebb9C); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "DroneShip";
    string private constant _symbol = "DroneShip";
    ...
    constructor() {
        address newOwner = address(0x63470D280Dda5561C1Ef6aBC85e0CD69236ebb9C);
