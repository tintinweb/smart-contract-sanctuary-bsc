...
contract GINTOKI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Gintoki";
    string private constant _symbol = unicode"GINTOKI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x1E2404E906D12ae6B5E7Fba0dD3473Cc27be1f7D);
    address payable public MarketingWallet = payable(0xb2Fd715d50618c40EBFA4Ea778585853c4dba85F);
