...
/*
    ...
    Cheems Star Boy is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable cheems in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $CSB a household name.
