...
contract BackRooms is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Backrooms"; // 
    string constant _symbol = "BACKROOMS"; // 
    ...
    // Detailed Fees
    //Be a man with culture, try to solve my puzzle and you will be rewarded
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (50) * (1); 
    uint256 public _maxSellTxAmount = _totalSupply / (50) * (1); 
    uint256 public _maxWalletToken = _totalSupply / (50) * (1); 

    // Fees receivers
    address public autoLiquidityReceiver = 0xB50b87366d4Bb580d0B22157A04aBF4E0aAb62cb;
    address public marketingFeeReceiver = 0x231212F52B2c4DDDc720A6d252D25c8495A0F0A3;
    address public devFeeReceiver = 0x231212F52B2c4DDDc720A6d252D25c8495A0F0A3;
    address public buybackFeeReceiver = 0x231212F52B2c4DDDc720A6d252D25c8495A0F0A3;
