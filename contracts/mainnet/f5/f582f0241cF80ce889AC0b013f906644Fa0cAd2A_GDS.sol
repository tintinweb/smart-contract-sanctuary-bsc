...
interface IDividendDistributor {
    function transferToken(address sender, uint256 amount) external;

    function splitToken(address[] memory addressList, uint256[] memory rateList, uint256 holderLen) external;
}

contract GDS is ERC20 {
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    address public dividendDistributor;
    uint256 public startTime;
    uint256 public marketDivAmount;
    ...
    constructor(address tokenOwner) ERC20("GDS", "GDS")  {
        ...
        uint256 total = 30000000 * 10 ** decimals();
    ...
    function _transfer(
        ...
        if (takeFee) {
            if (sender == uniswapV2Pair) {
                require(200 * 10 ** 18 >= (balanceOf(recipient) + amount), "amount exceed!");
            }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        bool success;
        bytes memory data;
        uint256 addMarketDivAmount = (curAmount - preAmount) * marketDivAmount / contractTokenBalance;
