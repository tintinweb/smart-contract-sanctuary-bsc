...
/**
    Good buy and sell rates
    4% fee auto add to the liquidity pool to lock forever when selling
    3% fee auto distribute to all holders
    3% fee auto swaped with BNB and move to marketing fund
    
    Twitter: https://twitter.com/RocketWToken
    Telegram: https://t.me/RocketWayToken
    Official site: https://rocketwaytoken.com
 */
...
contract RocketWayToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT  = 0xF483e9DA0130085343886ddaf46DC8dF642E789e;

    string constant _name = "Rocket Way Token";
    string constant _symbol = "RWT";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 5 * 10**7 * 10 ** 18;
