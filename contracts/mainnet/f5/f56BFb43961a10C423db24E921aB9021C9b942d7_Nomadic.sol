...
Telegram: https://t.me/NomadicBSC
Twitter: https://twitter.com/NomadicBSC
...
contract Nomadic is IBEP20, Ownable {
    ...
    string private constant _name               = 'Nomadic';  
    string private constant _symbol             = 'NOMADI';    
    ...
    uint16 private constant SellLimitDivider    = 10000;
    uint8 public constant MaxSellTax            = 20; // Max buytax = 99%

    //tax distribution
    //total normal tax = 12%
    uint8 private _devTax                       = 20; //2%
    uint8 private _burnTax                      = 0;
    uint8 private _marketingTax                 = 50; //5%
    uint8 private _liquidityTax                 = 30;
    uint8 private _stakingTax                   = 0; //3%
    uint8 private _buyBackTax                   = 0; 

    //buy, sell and transfer tax
    uint8 public _buyTax                        = 10;
    uint8 public _sellTax                       = 10;
    ...
    address public MainReward = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;   // $vCOOL
    ...
    function getMainLRewardBalance(address addr) public view returns (uint256){
...
//OnlyOwner has control of LP functions
    ...
    //TotalTaxes is 100%. Max BuyTax is 99% due to bot/snipers by listing; Selltax can't be higher than 12% to prevent a honeypot; TransferTax is also max. 12%
    ...
    function UpdateTaxes(uint8 burnTaxes, uint8 buybackTaxes, uint8 devTaxes, uint8 marketingTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public authorized{
        ...
        require(buyTax<=99,"Buytax is higher than the 99%.");
