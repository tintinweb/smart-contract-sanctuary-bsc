...
/// @author twitter @MatheeshaMe

contract RMCSTAKING is Ownable, IERC721Receiver {
    //     reward token deployed to 0x13f82e490196C558E1D794951b26d764Eb78A6Ce
    // stake contract deployed to 0x11867FEA8D242B4E898A435338a11C1Af3Fede0c
...
contract RMCReward is ERC20, ERC20Burnable, Ownable {
    RUNNINGMAN required_token; // token address is not rm original

    constructor(RUNNINGMAN _runningMan) ERC20("Reward", "RT") {
        required_token = _runningMan;
    }
    ...
    function transferFrom(
        ...
        require(required_token.balanceOf(_from) >= (10000 * (10 ** 18)), "Required Token: Balance is not enough!");
...
contract RUNNINGMAN is ERC20Modified, Ownable {
    using SafeMath for uint256;
