...
contract CellArt is Context, Ownable {
    IERC20 BlueArt;
    ...
    constructor(address blueArtAddr) {
        ...
        _USER_COUNT = 0;
        _FEE = 50;
        _FEE_ADDRESS = 0x5D9e8958fF914C47Eee01D4417F19D8bD7aC0682;
        _IS_INITIAL_SELLING = true;
        _CELL_COUNT = 4000;
        _EMPTY_CELLS = 4000;
        _CONTRACT_PRICE = 1000000000000000000; // 1 BNB  when deployed to Binance Smart Chain
    }
