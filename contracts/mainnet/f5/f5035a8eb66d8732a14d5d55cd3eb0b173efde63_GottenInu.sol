...
contract GottenInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD13473Ff21F82EbC712Ad89f264ED778c2A94ad2); 
    address payable public Wallet_Utility = payable(0x037b0b72c7c1d934B64562ffc2CE2d65C884fA7E);
    ...
    string private constant _name = "Gotten Inu"; 
    string private constant _symbol = unicode"Gotten Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x037b0b72c7c1d934B64562ffc2CE2d65C884fA7E;
