...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x951ce70a870A0Af2E73E0E63840EfED7d99da93E; // owner address
...
contract BabyBoboInu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Bobo Inu";
    string private _symbol = "BabyBobo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32A034C5C9ddD50CB3440bf82a5dC1FB04C66217); // Marketing Address
    address payable public teamWalletAddress = payable(0x32A034C5C9ddD50CB3440bf82a5dC1FB04C66217); // Team Address
