...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWD = IBEP20(0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3);
...
/* Token contract */
contract MegaMask is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWD = 0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "MegaMask";
    string constant _symbol = "MegaMASK";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xdC080f85Df3Af5fa717e0450cB596bbC53b4603C;
