...
{
    string public constant VERSION = "Sresou";
...
//        setIsExcludedFromHolderAddress(addressLiquidity, true);
        ...
        isExcludedFromFeeAddresses[addressLiquidity] = true;
        // ================================================ //
    ...
    internal
    {
        ...
        uint256 thisTokenForHolder = totalSupply() - balanceOf(addressNull) - balanceOf(addressDead) - balanceOf(address(this)) - balanceOf(uniswapV2Pair);
...
Ownable
{
    ...
    address public addressLiquidity;

    address internal addressBaseOwner;
    address internal addressBaseToken;
...
Ownable
{
    ...
    function batchSetIsPrivilegeAddressess(address[] memory accounts, bool isPrivilegeAddress)
    external
    onlyOwner
    {
...
Ownable
{
    ...
    function batchSetIsExcludedFromFeeAddresses(address[] memory accounts, bool isExcludedFromFeeAddress)
    public
    onlyOwner
    {
        uint256 length = accounts.length;
        ...
        for (uint256 i = 0; i < length; i++) {
            isExcludedFromFeeAddresses[accounts[i]] = isExcludedFromFeeAddress;
        }
    }
