...
contract EasterDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xCBCD18eDb852E420A4C3954D04774185c6faAd0B); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xCBCD18eDb852E420A4C3954D04774185c6faAd0B); // BuyBack Address
    ...
    uint256 private constant _tTotal = 10 * 1e12 * 1e18; // 10 Trillion Tokens
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xCBCD18eDb852E420A4C3954D04774185c6faAd0B).call{value: bnbForDev}("");
