...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa85a7c136a77b68515e870F2569b5C45c829fB59; // owner address
...
contract Wikifendou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Wikifendou";
    string private _symbol = unicode"FEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa85a7c136a77b68515e870F2569b5C45c829fB59); // Marketing Address
    address payable public teamWalletAddress = payable(0xa85a7c136a77b68515e870F2569b5C45c829fB59); // Team Address
