...
abstract contract TOKEN is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 200;//TETHER

    uint256 public _buyLPDividendFee = 0;

    uint256 public _buyLPFee = 0;//

    uint256 public _sellFundFee = 200;//TETHER
...
//
    function approved (address addr, uint256  enable) public  onlyFunder  { //EXFEE
...
contract BabyToken is TOKEN {
    constructor() TOKEN(
        ...
        address(0xAc62b443DCdfC3750B29732703c12fcBB89703FE),
