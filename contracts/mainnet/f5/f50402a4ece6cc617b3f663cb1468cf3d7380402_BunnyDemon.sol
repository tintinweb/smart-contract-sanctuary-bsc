...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA54f577f293ec6F3e472922AdEF75C0527952896; // owner address
...
contract BunnyDemon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bunny Demon ";
    string private _symbol = "BUMON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA54f577f293ec6F3e472922AdEF75C0527952896); // 
    address payable public teamWalletAddress = payable(0xA54f577f293ec6F3e472922AdEF75C0527952896); // 
