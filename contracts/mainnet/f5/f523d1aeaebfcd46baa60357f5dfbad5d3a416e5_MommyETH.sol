...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE755D98Ec0d938565f6F0B9d7Ce9E5dA4605E1B3; // owner address
...
contract MommyETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MommyETH";
    string private _symbol = "MommyETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xac884a48261f1177E91Dfb809267154748125710); // Marketing Address
    address payable public teamWalletAddress = payable(0xac884a48261f1177E91Dfb809267154748125710); // Team Address
