...
contract UltimateDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1977B1f02e9bBa1d452223339E5c94D7c5a3c74C); // Marketing Address
    ...
    uint256 private _tTotal = 4200000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "UltimateDoge";
    ...
    uint256 public _maxTxAmount = 4200000000000 * 10**2 * 10**9;
