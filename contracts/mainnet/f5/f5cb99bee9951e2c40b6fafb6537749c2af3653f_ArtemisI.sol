...
contract ArtemisI is Context, IERC20, Ownable {
    ...
    address public ownerWallet = 0x4E192Cec8FAee40187850B1c3c95C83247858d0B;
    ...
    string private _name = "ARTEMISI";
    string private _symbol = "ARTEMISI";
    ...
    uint256 public _maxTxAmount = 30000 * 10**6 * 10**8;
