...
contract RMB is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4C79c3b599CA84179F7B9b1e384686CC52c0E90A;
    address public developersWallet = 0xF767B4e5A1C87945148031f49Aa3D1faA2640Ccb;
    ...
    uint256 public devFeePercent = 40;
    ...
    uint256 public numTokensSellToAddToLiquidity = 250 * 10**9;
    ...
    function setDevFeePercent(uint256 fee) public onlyOwner {
        devFeePercent = fee;
    }
    ...
    function setDevWalletOne(address walletAddress) public onlyOwner {
        developersWallet = walletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 half = contractTokenBalance.div(5).mul(4);
        uint256 otherHalf2 = contractTokenBalance.div(5);
        ...
        uint256 marketingshare1 = newBalance.mul(devFeePercent).div(100);
        payable(developersWallet).transfer(marketingshare1);
        newBalance -= marketingshare1;
        // add liquidity to uniswap
        addLiquidity(otherHalf2, newBalance);

        emit SwapAndLiquify(half, newBalance, otherHalf2);
    }
