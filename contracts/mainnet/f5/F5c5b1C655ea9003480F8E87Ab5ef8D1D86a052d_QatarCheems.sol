...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD8753559244751dC3630262cBD4b0C9eCECaDf6; // owner address
...
contract QatarCheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar Cheems";
    string private _symbol = "QatarCheems";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB1700EaA838C89df8f441cb549D0CAa3f3C3aA77); // Marketing Address
    address payable public teamWalletAddress = payable(0xcD8753559244751dC3630262cBD4b0C9eCECaDf6); // Team Address
