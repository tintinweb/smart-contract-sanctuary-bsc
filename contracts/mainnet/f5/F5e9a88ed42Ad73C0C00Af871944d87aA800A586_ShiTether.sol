...
contract ShiTether is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x172efc1C5eDF4F11DA2539F570c9e8E4Ab45d6Be); 
    address payable public Wallet_Dev = payable(0x172efc1C5eDF4F11DA2539F570c9e8E4Ab45d6Be);
    ...
    string private constant _name = "ShiTether"; 
    string private constant _symbol = unicode"SUSDT"; 
    ...
    constructor () {
        ...
        _owner = 0x172efc1C5eDF4F11DA2539F570c9e8E4Ab45d6Be;
