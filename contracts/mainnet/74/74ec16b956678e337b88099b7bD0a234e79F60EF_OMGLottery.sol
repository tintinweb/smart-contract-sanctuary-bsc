...
// File: contracts/interfaces/IOMGLottery.sol

pragma solidity ^0.8.4;

interface IOMGLottery {
    /**
 ...
 */
contract OMGLottery is ReentrancyGuard, IOMGLottery, Ownable {
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(cakeToken), "Cannot be OMG token");
