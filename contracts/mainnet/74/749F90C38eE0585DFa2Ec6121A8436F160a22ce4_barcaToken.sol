...
/*
    ...
    telegram      : https://t.me/barcatoken
*/
interface IERC20 {
...
contract barcaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Barcelona"; //
    string private constant _symbol = "barca"; //
