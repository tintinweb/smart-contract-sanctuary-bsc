...
contract CGTToken is
    Initializable,
    ERC20Upgradeable,
    ERC20BurnableUpgradeable,
    AccessControlUpgradeable
{
    bytes32 public constant BLACKLISTED_ROLE = bytes32(uint256(1));
    ...
    function burn(uint256 amount) public virtual override {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Only Admin can burn tokens");
        super.burn(amount);
    }
