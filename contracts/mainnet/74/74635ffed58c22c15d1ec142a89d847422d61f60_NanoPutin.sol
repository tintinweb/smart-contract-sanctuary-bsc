...
contract NanoPutin is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "NanoPutin";
    string constant _symbol = "NanoPutin";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 55;
	uint256 public _maxWalletAmount = _totalSupply / 55;
    ...
    uint256 public marketingFee = 160;
