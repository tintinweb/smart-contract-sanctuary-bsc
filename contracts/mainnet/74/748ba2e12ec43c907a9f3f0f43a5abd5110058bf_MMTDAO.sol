...
contract MMTDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MMTDAO";
    string private _symbol = "MMTDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF1699ED56Fc20fD58b676c954ACfd8800F64A29F);
    address payable public teamWalletAddress = payable(0xF1699ED56Fc20fD58b676c954ACfd8800F64A29F);
    address public immutable deadAddress = 0xF1699ED56Fc20fD58b676c954ACfd8800F64A29F;
