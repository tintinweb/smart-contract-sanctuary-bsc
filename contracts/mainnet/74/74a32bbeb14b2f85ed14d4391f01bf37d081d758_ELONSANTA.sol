...
abstract contract Project {
    address public marketingWallet = 0x72Fd59994F1890F8813Da90fE61c3E9F909Cb369;
    address public treasuryWallet = 0x68ba6085E20ED24ff6487Fb8D0d28e25cd6f7A0e;

    string constant _name = "ELONSANTA";
    string constant _symbol = "ELONSANTA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 21) / 1000; // (_totalSupply * 10) / 1000 [this equals 2%]
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x740eBb632DA8856129cb50649aCe8120Ba623AfF);
...
contract ELONSANTA is Project, IBEP20, Auth {
    using SafeMath for uint256;
