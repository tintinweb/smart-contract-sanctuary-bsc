...
contract bigblackbear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "big black bear";
    string private _symbol = "big black bear";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x68B72b3C701Cd503D95806982d67E3929a0c2d6C);
    address payable public teamWalletAddress = payable(0x68B72b3C701Cd503D95806982d67E3929a0c2d6C);
