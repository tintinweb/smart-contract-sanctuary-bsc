...
*/
    ...
    🍕🌶 PEPPERONIS COIN  - THE NEW PIZZA HUT CURRENCY 🍕🌶 ($PIZZAHUT)

    PEPPERONIS COIN IS A COMMUNITY DRIVEN TOKEN FOLLOWING THE PIZZA HUT ..PEPPERONIS HAS A POTENTIAL OF X100 .. 

    MIGHT BE THE NEXT MOONSHOOT 
...
contract PEPPERONIS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x2D089Ec547808d5fBabcEed345ea7C0462CAcfe1;
 
    string constant _name = "PEPPERONIS COIN";
    string constant _symbol = "$PIZZAHUT";
