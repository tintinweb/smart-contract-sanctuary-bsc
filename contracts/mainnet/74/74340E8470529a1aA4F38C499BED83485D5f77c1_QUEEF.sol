...
LONDON BRIDGE HAS FALLLEN $QUEEF QUEEN HAS FALLEN 
SAFE CODE; NO MINT FUNCTION, NO DISABLE TRADE FUNCTION, NO BLACLIST FUNCTION, 
DEPLOYER CAN'T SET TAXES HIGHER THAN 15% 
https://t.me/queenhasfallen
*/
...
contract QUEEF is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("QUEEN HAS FALLEN", "QUEEF") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xfAB7A9508ae74521B9a161eC980bF4aBb5b18179); // CHANGE THIS TO YOURS
        devWallet = payable(0xC5996bF6293eD4b5C5579748BD999Cb867A3Da61); // CHANGE THIS TO YOURS
