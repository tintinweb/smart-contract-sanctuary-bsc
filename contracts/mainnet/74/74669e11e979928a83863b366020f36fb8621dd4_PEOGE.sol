...
contract PEOGE is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: address(this).balance, gas: 30000}("");
