...
contract ChickGrow is Context, IERC20, Ownable {
    ...
    string private _symbol = "ChickGw";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 1000;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xAB751e8De782e0A117E8198e4020EA22aD49D456); // Marketing Address
    address payable public teamWalletAddress = payable(0xAB751e8De782e0A117E8198e4020EA22aD49D456); // Team Address
