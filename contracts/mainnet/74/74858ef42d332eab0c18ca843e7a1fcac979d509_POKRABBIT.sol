...
//https://t.me/POKEMONRABBIT_portal
...
contract POKRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POKEMON RABBIT";
    string private _symbol = "POKRABBIT";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xF2B45439522aAe78A25d4725F670E025757F5D7F); // Marketing Address
    address payable public BuyBackWallet = payable(0xF2B45439522aAe78A25d4725F670E025757F5D7F); // Team Address
