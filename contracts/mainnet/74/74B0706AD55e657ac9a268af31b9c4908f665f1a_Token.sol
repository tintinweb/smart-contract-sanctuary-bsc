...
contract Token is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0xBC870232B0F21c80c57E7Cc22581119369cb0d1c;
    ...
    string private _name = "Beijing Opera";
    string private _symbol = "Beijing Opera";
    ...
    constructor () {
        _rOwned[0x1eB1bA4f14B33323FE793e8F25a41400B2d01070] = _rTotal;
        ...
        _isExcludedFromFee[0x1eB1bA4f14B33323FE793e8F25a41400B2d01070] = true;
         _isExcludedFromFee[0xBC870232B0F21c80c57E7Cc22581119369cb0d1c] = true;
          _isExcludedFromFee[0x175A29FacB5F2A8bec44Be95feD7E907c6d7f2e1] = true;
		
        emit Transfer(address(0), 0x1eB1bA4f14B33323FE793e8F25a41400B2d01070, _tTotal);
    }
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && to == pancakeSwapV2Pair){
            _taxFee = 0;
            _charityFee = 4;
            _liquidityFee = 2;
		    _burnFee = 0;
