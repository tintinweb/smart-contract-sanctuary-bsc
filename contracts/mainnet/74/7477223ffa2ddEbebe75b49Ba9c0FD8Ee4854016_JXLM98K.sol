...
contract JXLM98K is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "JXLM98K";       //Full name
    string public symbol_ = "JXLM98K";      //abbreviation

    uint256 public deadFee = 10;       //Destroyed
    uint256 public liquidityFee = 10;      //LP reflow
    uint256 public marketingFee = 10;      //marketing
    uint256 public foundationFee = 10;      //Buyback pull order
    ...
    address public marketingWalletAddress = 0x71076D05eaf89AB5dB0fB76c54E4310645a52B80;  //Marketing address
    address private foundationWalletAddress = 0x5124793cec90E1a3fd4a8Ce311879829d7d5bE02;  //Buyback Guard
    address private liquidityReceiveAddress = 0x5124793cec90E1a3fd4a8Ce311879829d7d5bE02;   // burn
