...
contract UnityChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unity Chain";
    string private constant _symbol = "UnityChain";
