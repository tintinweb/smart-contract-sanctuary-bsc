...
contract EverImpact is ERC20, Ownable {
    ...
    address private _newOwner = 0x4769C0f0748c2d0a8A84d259Ac41eFB144FAED82;
    ...
    constructor() ERC20("Ever Impact", "EIT") {
        ...
        token2DividendToken = 0xDFcF44e9a6D99717FC04AddD57Fb667286Bb7DC0;
...
contract Token1DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("EverImpact_Token1_Dividend_Tracker", "EverImpact_Token1_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
    	claimWait = 3600;
...
contract Token2DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("EverImpact_Token2_Dividend_Tracker", "EverImpact_Token2_Dividend_Tracker", 0xDFcF44e9a6D99717FC04AddD57Fb667286Bb7DC0) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000000 * (10**18); //must hold 2000000+ tokens
    }
