...
/**
   ...
   Stealth Launch RubyCheems

RubyCheems is a community meme token that gives you tons of X. RubyCheems  project will have an auto liquidity to stabilize and make the chart strong.
Ookami was combined to the most popular dog in crypto space that what's you called RubyCheems , 
...
library Address{
 ...
 contract RubyCheems is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 15_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x567266813b1160596748F4eB12f430d865a078BA;
    address public donationWallet = 0x567266813b1160596748F4eB12f430d865a078BA;

    string private constant _name = "RubyCheems";
    string private constant _symbol = "RubyCheems";
