...
contract AstroX_PR1 is Ownable{
    uint256 public total = 0 ether;
    uint256 public cap = 900 ether;
    
    uint256 public tx1 = 15 ether;
    uint256 public tx2 = 7.5 ether;
    uint256 public tx3 = 5 ether;
    uint256 public tx41 = 2 ether;
    uint256 public tx42 = 0.1 ether;

    mapping(address => uint256) sentAmounts;

    function depositBNB() public payable{
        require(total + msg.value <= cap, "Hard cap is reached!");
        require(msg.value >= tx42 && msg.value <= tx41 || msg.value == tx3 || msg.value == tx2 || msg.value == tx1, "Invalid contribution amount!");
        total += msg.value;
    ...
    function setLimits(uint256 _tx1, uint256 _tx2, uint256 _tx3, uint256 _tx41, uint256 _tx42) public onlyOwner {
        tx1 = _tx1 * 10 ** 9;
        tx2 = _tx2 * 10 ** 9;
        tx3 = _tx3 * 10 ** 9;
        tx41 = _tx41 * 10 ** 9;
