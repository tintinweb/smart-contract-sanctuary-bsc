...
contract Ohhilol is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Oh hi lol inu";
    string constant _symbol = "OH";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x4254f9B774a7CeCE2aC07E88DF954d582Eb850A8;
