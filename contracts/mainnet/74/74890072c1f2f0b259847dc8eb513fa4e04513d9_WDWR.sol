...
contract WDWR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "World War";
    string private _symbol = "WDWR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2E8B8900A61697ef14fc8Fa08DF8b9EFe6c6f17); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xF2E8B8900A61697ef14fc8Fa08DF8b9EFe6c6f17); // buyback Address
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**9; // 100%
    uint256 public _walletMax = 1000000000000 * 10**9; // 100%
