...
contract Fortuna {
    ...
    uint256[15] private level5Percents = [100, 100, 50, 50, 100, 100, 100, 50, 50, 50, 50, 50, 50, 50, 50];
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 250 && maxTeam >= 60000e18 && otherTeam >= 60000e18){
                levelNow = 5;
            }else if(user.teamNum >= 100 && maxTeam >= 20000e18 && otherTeam >= 20000e18){
                levelNow = 4;
