/**
 ...
 ##   # #     #        ##    ##     ###        ###     ###  ##      
  ...
  #############       ##     ##      ##  ##  ##             ####### 
   ...
   ##     ###      ##     ####       ##########             ##      
 ##        #      #         #        ##      ##             # 
TAX:3-3  tax all Rewards USDT
TG：https://t.me/FenDouGlobal
*/
...
contract FenDou is ERC20, Ownable {
    using SafeMath for uint256;

    string private name_ = "FenDou";
    string private symbol_ = "FenDou";
    ...
    uint256 public sellMarketingFee = 80;
    ...
    uint256 private tokenBalanceForReward_ = 1000000 * 10**18;

    address public _marketingWalletAddress = 0x2D873792164562A67f472118da299AB370ad31fF;
    address public lpReceiveWallet = 0x2D873792164562A67f472118da299AB370ad31fF;
