...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Journey Inu"; //
    string private constant _symbol = "The Journey"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x5791DFAd80Fb385156f980Dd883CC02DE042bADA;
