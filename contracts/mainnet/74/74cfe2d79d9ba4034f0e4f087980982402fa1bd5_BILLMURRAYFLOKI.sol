...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0865036495F294d04ddd11C40a35843E6426411B; // owner address
...
contract BILLMURRAYFLOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BILLMURRAYFLOKI";
    string private _symbol = "BMFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE4735d68B2AC95C9859c3dD9ae5b113153650368); // Marketing Address
    address payable public developmentWalletAddress = payable(0xE4735d68B2AC95C9859c3dD9ae5b113153650368); // Development Address
