...
contract CORGIAI is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Corgi AI';
    string  private constant _SYMBOL = 'CORGIAI';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x474aB71EEC6d18617Bdd50e3F16C718E5478D9B9, 'We can not exclude Uniswap router.');
