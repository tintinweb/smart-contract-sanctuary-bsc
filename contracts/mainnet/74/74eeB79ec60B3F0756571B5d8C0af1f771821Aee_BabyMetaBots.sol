 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BabyMetaBots
 * 
 * 
 * BabyMetaBots token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BabyMetaBots is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMetaBots";
    string constant _symbol = "BMETABOT";
