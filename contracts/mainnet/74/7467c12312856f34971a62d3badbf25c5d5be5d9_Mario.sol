...
contract Mario is Context, IERC20, Ownable {
    ...
    string private _name = "MARIO BROS"; 
    string private _symbol = "MARIO"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E37413511C9BeAaE23C9C73f8B0e4E94b1b7743); 
    address payable public teamWalletAddress = payable(0x7E37413511C9BeAaE23C9C73f8B0e4E94b1b7743); 
