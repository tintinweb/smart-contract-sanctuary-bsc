...
contract ManKinCoin is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "ManKin";
    string constant _symbol = "ManKin";
    ...
    uint8 public coolManKinBlock;
    uint8 public coolMarket;
    uint8 public swapTarget;
    uint8 public swapManKinLimit;
    ...
    function setStatusManKin(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    ...
    function setSwapManKinFees(bool _enabled, uint256 _amount) external authorized {
