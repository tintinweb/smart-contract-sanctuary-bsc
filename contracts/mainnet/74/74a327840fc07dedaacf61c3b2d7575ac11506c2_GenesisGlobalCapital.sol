...
/**
  #GenesisGlobalCapital-GGC

   #该代币的产生灵感来当加密货币贷款机构Genesis Global Capital正式向美国纽约联邦地方法院申请破产保护。
    8000亿巨头宣布破产发生了什么？
    本项目将会邀请中国中央电视为你揭秘！！！！！

    本代币总供应量为1,000,000,000，DEV将会将所有供应量和0.1BNB添加到池子，并将LP进行销毁（发送到0x000000000000000000000000000000000000dead）

    最后让我们期待中国中央电视为你揭秘 8000亿巨头宣布破产，这一切的背后到底是道德的沦丧，还是人性的扭曲？

    电报：https://t.me/GenesisGlobalCapital
 */
...
contract GenesisGlobalCapital is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Genesis Global Capital";
    string private _symbol = "GGC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3348894BE113dc3F80A16b3a92EEacfBaC4c2360);
    address payable public liqWalletAddress = payable(0x3348894BE113dc3F80A16b3a92EEacfBaC4c2360);
