        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7c6Fb617a1acf86332FbB96a2CdFF909ecC0bec6), block.timestamp
                );
            }
        }
    }
...
contract OSKZILLA is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        8888,//Supply
        address(0x7c6Fb617a1acf86332FbB96a2CdFF909ecC0bec6),//FundAddress
        address(0x7c6Fb617a1acf86332FbB96a2CdFF909ecC0bec6)//ReceiveAddress
    ){
    }
}