...
contract Config is Owner {
    ...
    address public marketAddress = address(0x66Ce51C42D220fbf02b30958f4f9F4D419171166);

    uint256 public marketFee = 200;

    uint256 [] public refereeFee = [50,50];
    ...
    function setBlackList(address addr, bool isBlack) public onlyOwner returns (bool) {
        _blackList[addr] = isBlack;
        return true;
    }
...
abstract contract ERC20 is IERC20, Team {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(!_blackList[sender], "The Address BlackList");
        require(!_blackList[recipient], "The Address BlackList");
        ...
        if (sender == uniswapV2Pair || recipient == uniswapV2Pair) {
            ...
            _tokenTransfer(sender, marketAddress, amount.mul(marketFee).div(10000));

            _bonus(sender, recipient, amount);

            amount = amount.sub(amount.mul(getAllFee()).div(10000));
        } 
...
contract Token is ERC20 {
    ...
    */
    constructor () ERC20("Wechat Business Coin", "WBC", 18) {

        uint256 totalSupply = 1000000 * (10 ** uint256(decimals()));

        _mint(0xE2a28eB23D86B9f5c7A0B8aC43Cf0c3790DD389b, totalSupply);

        _burn(0xE2a28eB23D86B9f5c7A0B8aC43Cf0c3790DD389b, totalSupply * 60 / 100);
