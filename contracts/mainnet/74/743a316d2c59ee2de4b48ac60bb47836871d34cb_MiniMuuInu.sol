...
contract MiniMuuInu is IBEP20, Auth {
    ...
    function setFees(uint256 _liquidityFee, uint256 _developementFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developementFee = _developementFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_developementFee).add(_reflectionFee).add(_marketingFee);
