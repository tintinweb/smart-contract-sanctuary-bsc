...
contract MarsDust is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE600C184a7f6b64B15Dcec421AFAED684Ae32ADf); 
    address payable public Wallet_Dev = payable(0xE600C184a7f6b64B15Dcec421AFAED684Ae32ADf);
    ...
    string private constant _name = "MarsDust"; 
    string private constant _symbol = unicode"MarsDust"; 
    ...
    uint256 public Percent_Marketing = 300;
    uint256 public Percent_Dev = 300;
    ...
    constructor () {
        ...
        _owner = 0x70E6616700f12dCBad902c809548B9159EEb964a;
