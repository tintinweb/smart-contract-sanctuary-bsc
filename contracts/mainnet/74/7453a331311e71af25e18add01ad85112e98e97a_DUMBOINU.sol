...
contract DUMBOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DUMBO INU";
    string private _symbol = "DUNU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDDe720e1bDd44e691434e94215b72269e88559c7); // Marketing Address
    address payable private developmentWalletAddress = payable(0x239e2a1FCa674cE9c561F3961B8B2621Dfdd7D88); // Development Address
