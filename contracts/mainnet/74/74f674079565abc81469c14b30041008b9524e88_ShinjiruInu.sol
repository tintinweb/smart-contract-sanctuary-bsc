...
contract ShinjiruInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf80ECaf9BF90201AFdb73d5058a1b04EF494A9A1); 
    address payable public Wallet_Dev = payable(0xf80ECaf9BF90201AFdb73d5058a1b04EF494A9A1);
    ...
    constructor () {
        ...
        _owner = 0xf80ECaf9BF90201AFdb73d5058a1b04EF494A9A1;
