...
contract SsiAnimatedNFT is ERC721Enumerable, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, string memory _tokeBaseURI, address _tokenAddr) ERC721(_name, _symbol) {
        ...
        characters.push(CharacterInfo("king", 2, 0));             
        characters.push(CharacterInfo("wizard", 6, 0));           
        characters.push(CharacterInfo("businessman", 4, 0));      
        characters.push(CharacterInfo("doctor", 4, 0));           
        characters.push(CharacterInfo("firefighter", 4, 0));      
        characters.push(CharacterInfo("architect", 20, 0));       
        characters.push(CharacterInfo("policeman", 20, 0));
        characters.push(CharacterInfo("scientist", 68, 0));
        characters.push(CharacterInfo("mechanic", 112, 0));
        characters.push(CharacterInfo("teacher", 160, 0));
        _updateMaxSupply();
    }
