...
contract iShiba14 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "iShiba14";
    string private _symbol = "ISHIB14";
    uint8 private _decimals = 18;

    address public marketingWallet = 0xf364957815F6172139A1589DDBF91d573b96ae2C;
    address public developerWallet = 0xf364957815F6172139A1589DDBF91d573b96ae2C;
    ...
    uint256 public _walletMax = _totalSupply;    //4%
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if((block.timestamp > launchTime + 30 minutes) && !triggered && (launchTime != 0) ){
    ...
    function openTrade(bool _status) public onlyOwner {
