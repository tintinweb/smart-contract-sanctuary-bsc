...
contract DIYinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DIY INU";
    string private _symbol = "DIYINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Cf3B357c290A0628739Dd9572e442A0C81702D7); 
    address payable public teamWalletAddress = payable(0xF3fCde14dA483A1984F2B0C37AAD477B9e9832fd); 
    ...
    uint256 public _walletMax = 5 * 10**6 * 10**_decimals; //(5%)
