...
/**
 TG GROUP：https://t.me/FenDouDOGE
*/
...
contract FenDouDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FenDouDOGE";
    string private _symbol = "FenDouDOGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x00b118aC53a1b3E4E4Ad2211F1af7b0BFD609bB8);
