...
/**
Telegram: https://t.me/AiElonMusk
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D2e8704ADadBF2a4aF7d0d9D9a7e6E8D0f154bD; 
...
contract AIELON is Context, IERC20, Ownable {
    ...
    string private _name = "AI ELON MUSK";
    string private constant _symbol = unicode"AIELON";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x7D2e8704ADadBF2a4aF7d0d9D9a7e6E8D0f154bD); // Marketing Address
    address payable public teamWalletAddress = payable(0x7D2e8704ADadBF2a4aF7d0d9D9a7e6E8D0f154bD); // Team Address
