...
contract NAGATOINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x265a7b99448620c1335ce2C36785a3764b45cf26); 
    address payable public Wallet_Dev = payable(0xD2e21436B0aE0C5579cED17b49182ED7ce83f1e0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Nagato Inu"; 
    string private constant _symbol = unicode"NAGATOINU";
