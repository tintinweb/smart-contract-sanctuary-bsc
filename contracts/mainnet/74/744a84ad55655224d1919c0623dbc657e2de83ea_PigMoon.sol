...
// File contracts/PigMoon.sol

pragma solidity 0.6.12;

// PigMoon
contract PigMoon is ERC20("PigMoon Token", "PigMoon") {
    uint256 private constant MAX_SUPPLY = 200000000000000e18;
    ...
    constructor(address _treasuryAddr) public {
        ...
        // Mints 160,000,000 PigMoon (8%) for Airdrop, IDO and Seed Funders.
        _mint(treasuryAddr, 16000000e18);
        _totalMinted = _totalMinted.add(16000000e18);
        emit Mint(msg.sender, treasuryAddr, 16000000e18);
    }
