...
contract DexStaking is Ownable, ReentrancyGuard {
    ...
    uint256 public BONUS_F1 = 50;
    uint256 public BONUS_F2 = 25;
    uint256 public BONUS_F3 = 15;

    uint256 public CLAIM_FEE = 2;

    uint256 public WITHDRAW_PERIOD_1 = 180 days;
    uint256 public WITHDRAW_PERIOD_2 = 365 days;
    uint256 public WITHDRAW_PERIOD_3 = 1095 days;
    ...
    event SetFBonus(address indexed owner, uint256 _f1Bonus, uint256 _f2Bonus, uint256 _f3Bonus);
    ...
    event Stake(address indexed owner, Package _package, uint256 _amount, address _f1, address _f2, address _f3);
    event Withdraw(address indexed owner, uint256 _amount);
    event Claim(address indexed owner);
    event AddUserInfo(address indexed owner, address _account, Package _package, uint256 _stakingAmount, uint256 _bonusDebt, uint256 _depositAt);
    event UpdateUserInfo(address indexed owner, address _account, Package _package, uint256 _stakingAmount, uint256 _bonusDebt, uint256 _depositAt);
    ...
    function addUserInfo(address account, Package _package, uint256 _stakingAmount, uint256 _bonusDebt, uint256 _depositAt) external onlyOwner{
    ...
    function updateUserInfo(address account, Package _package, uint256 _stakingAmount, uint256 _bonusDebt, uint256 _depositAt) external onlyOwner{
        userInfo[account].package = _package;
        userInfo[account].stakingAmount = _stakingAmount;
        userInfo[account].bonusDebt = _bonusDebt;
        userInfo[account].depositAt = _depositAt;
    ...
    function setFBonus(uint256 _f1Bonus, uint256 _f2Bonus, uint256 _f3Bonus) external onlyOwner {
        BONUS_F1 = _f1Bonus;
        BONUS_F2 = _f2Bonus;
        BONUS_F3 = _f3Bonus;

        emit SetFBonus(msg.sender, _f1Bonus, _f2Bonus, _f3Bonus);
    }
    ...
    function stake(Package package, uint256 amount, address f1, address f2, address f3) public {
    ...
    function _stake(address account, Package package, uint256 amount, address f1, address f2, address f3) private {
