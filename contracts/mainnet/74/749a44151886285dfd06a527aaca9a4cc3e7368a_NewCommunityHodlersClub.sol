...
// New Community Hodlers Club 
// Taxes: BUY 9% - SELL12%
// TG: https://t.me/NewCommunityHodlersClub
...
contract NewCommunityHodlersClub  is IBEP20, Auth {
    ...
    string constant private _name = "New Community Hodlers Club";
    string constant private _symbol = "NCHC";
   ...
   function changeMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function changeMaxTx(uint256 amountBuy) external authorized {
