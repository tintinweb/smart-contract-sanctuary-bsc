...
http://t.me/newcommunityfurbie

If you've found this on some kind of scanner, we'll be launching in a few hours, join the TG and be patient.
...
contract FURBIE is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "New Community Furbie";
    string constant _symbol = "FURBIE";
    ...
    uint256 public liquidityFeeThou = 4;
    uint256 public marketingFeeThou = 3;
    ...
    constructor() Auth(msg.sender) {
        autoLiquidityReceiver = 0x26FbaECD7075412Fe029bbc25E0c57cf5306aad1;

        marketingWallet = 0x26FbaECD7075412Fe029bbc25E0c57cf5306aad1;
        ...
        totalFeeThou = liquidityFeeThou.add(marketingFeeThou);
    ...
    function changeFees(uint256 newLiqFeeThou, uint256 newMarketingFeeThou)
        external
        onlyOwner
    {
    ...
    function _transferFrom(
        ...
        if (((launchedAt + deadBlocks) > block.number) && recipient != pair) {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBLiquidity = amountBNB
            ...
            .div(totalBNBFeeThou)
            .div(2);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFeeThou).div(
            totalBNBFeeThou
        );
