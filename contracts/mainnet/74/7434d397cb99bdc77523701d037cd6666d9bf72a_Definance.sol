...
contract Definance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Definance";
    string private _symbol = "Definance";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xce57Dc3784A167ECb9501A09D07884D6ba3f2fac); // Marketing Address
    address payable public teamWalletAddress = payable(0x9BdCE3a0739bccf9f204F1bEebCdBaB234234A40); // Team Address
