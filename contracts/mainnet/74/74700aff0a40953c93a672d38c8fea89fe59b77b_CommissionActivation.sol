...
contract CommissionActivation is OwnableUpgradeable {
    address public bankAddress;
    address public farmingAddress;
    address public mlmAddress;
    address public singlePoolAddress;

    // mapping for store info about activation of pending commission by contract type
    mapping(uint256 => mapping(address => bool)) public commissionsActivations;
    ...
    modifier onlyRelatedContracts() {
        require(
            ...
            "CommissionActivation:: Only related contracts"
        );
        _;
    }
    ...
    /**
     * @notice Function to activate pending commission
     ...
     */
    function activateCommissions(uint256 _type, address _user) external onlyRelatedContracts {
        commissionsActivations[_type][_user] = true;
    }

    /**
     * @notice Function to get Commission activation
     ...
     */
    function getCommissionActivation(address _user, uint256 _type) external view returns (bool) {
        return commissionsActivations[_type][_user];
    }
}
