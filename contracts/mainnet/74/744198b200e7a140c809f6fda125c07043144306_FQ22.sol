...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08667FEf85F876e0a1c47A109652c6c4af4126b1; // owner address
...
contract FQ22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA QATAR 2022";
    string private _symbol = "FQ22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08667FEf85F876e0a1c47A109652c6c4af4126b1); // Marketing Address
    address payable public teamWalletAddress = payable(0x08667FEf85F876e0a1c47A109652c6c4af4126b1); // Team Address
