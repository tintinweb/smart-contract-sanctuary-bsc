...
contract GERNATIONALTRAUMA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "GERNATIONAL TRAUMA";
    string private _symbol = "TRAUMA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7D3B2D064026b97CDe10965B3240df5A5F942416);
    address payable public liqWalletAddress = payable(0x7D3B2D064026b97CDe10965B3240df5A5F942416);
