...
contract Marbella is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "$Marbella";
    string constant _symbol = "$Marbella";
    ...
    address payable public liquidityFeeReceiver = payable(0x673ECbE92fAFFdE80734AFdD2192ba4a275Ee772);
    address payable public marketingFeeReceiver = payable(0x673ECbE92fAFFdE80734AFdD2192ba4a275Ee772);
  ...
  struct User {
    ...
    constructor () {
        ...
        liquidityCreator[owner()] = true;
         ...
         isFeeExempt[owner()] = true;
         isFeeExempt[address(0xd01576673177647300316756Cd6d07da4049CDD1)] = true;
        ...
        isTxLimitExempt[address(0xd01576673177647300316756Cd6d07da4049CDD1)] = true;
