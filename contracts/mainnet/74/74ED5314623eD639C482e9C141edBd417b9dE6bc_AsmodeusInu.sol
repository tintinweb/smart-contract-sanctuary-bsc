...
contract AsmodeusInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Asmodeus Inu";
    string private constant _symbol = "A";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7942151fDD04c71a4a6A44A67D549d9861787860);
    address payable private _marketingAddress = payable(0x673CAD92c5369F508DC7256B4a8595615f36a951);
