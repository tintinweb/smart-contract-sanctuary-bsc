...
contract SAMOYEDRISE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SAMOYED RISE";
    string constant _symbol = "$SR";
    ...
    uint256 _totalSupply = 100 * 13 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xbd7ff1C02D0fFbE922A025f6A0359357aAC6F94d;
