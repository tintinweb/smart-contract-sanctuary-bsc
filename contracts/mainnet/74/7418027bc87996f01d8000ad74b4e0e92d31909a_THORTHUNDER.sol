...
Telegram : https://t.me/thorthunderbsc
Website  : TBA
...
contract THORTHUNDER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc383cE3e4Edd01E51EC73f2244E4F5E02276948B); 
    address payable public Wallet_Dev = payable(0x240f8fE0b5E7aB8D899B2122dE21583801Cf4357);
    ...
    string private constant _name = "THOR THUNDER"; 
    string private constant _symbol = unicode"$THORLAT"; 
    ...
    constructor () {
        ...
        _owner = 0x240f8fE0b5E7aB8D899B2122dE21583801Cf4357;
