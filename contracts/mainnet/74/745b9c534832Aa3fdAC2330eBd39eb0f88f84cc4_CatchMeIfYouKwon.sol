...
/**
 *
 No Tg!!! No Website!!! No Twitter!!!
 ETH version already above 100k Mkt Cap
 100% Tokens in liquidity
 Low Tax
 Let's Catch Kwon
...
contract CatchMeIfYouKwon is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0x25f80C353965ad4609c61dF73F889721EA09220E);
    address public DevelopmentWallet =
        0x25f80C353965ad4609c61dF73F889721EA09220E;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 2 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Catch Me If You Kwon";
    ...
    uint256 public _maxWalletHoldingLimit = 10 * 10**8 * 10**18;
