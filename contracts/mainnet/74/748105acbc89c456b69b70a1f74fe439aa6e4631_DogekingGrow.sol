...
/**
 DOGEKING GROW
 Missed Squidgrow? Don't miss DogeKing Grow. 
 The reigning doge that is destined to seize the space of grow trend.

 TELEGRAM: https://t.me/dogekinggrow_official
 WEBSITE: https://dogekinggrow.wtf
...
contract DogekingGrow is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_800_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 2_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 2_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 2_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x79BaD67d3DC44d270bd2c1C7e2e192EFA8A6fFDB;
    address public devAddress = 0x396e1f22B52deDB4bCd1631839f822B9cF5f8543;

    string private constant _name = "DogeKing Grow";
    string private constant _symbol = "DKGROW";
    ...
    Taxes public taxes = Taxes(0,2,5,2);
    Taxes public sellTaxes = Taxes(0,2,80,2);
    ...
    // Owner cannot transfer out DogeKing Grow from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out DogeKing Grow!");
