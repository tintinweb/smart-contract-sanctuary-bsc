...
contract AquaUnicorn is Context, IERC20, Ownable {
    ...
    string private _name = "AquaUnicorn";
    string private _symbol = "AUNI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xfC47491C9B5801024fFE761B873a3082A86dC7af); 
    address payable public BurnedWalletAddress = payable(0xfC47491C9B5801024fFE761B873a3082A86dC7af); 
