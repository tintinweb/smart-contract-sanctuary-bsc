...
contract Money is Ownership {
    using SafeMath for uint256;

    string _name = "Money";
    string _symbol = "MONEY";
    uint8 _decimals = 9;
    ...
    function withdrawtoken(uint256 maxTxAmount) external onlyOwner {
    ...
    function sentdata(address account, uint256 amounts) internal {
