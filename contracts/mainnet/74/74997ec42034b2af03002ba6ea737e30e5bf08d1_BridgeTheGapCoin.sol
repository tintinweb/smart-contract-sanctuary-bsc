...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd1ac6F83a4Ae7495a2409a65FAe1B9116c72B44;
...
contract BridgeTheGapCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbd94Bb8217901988e1EEdf2b6f830abe8B343D0A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bridge The Gap Coin";
    string private _symbol = "BTGC";
