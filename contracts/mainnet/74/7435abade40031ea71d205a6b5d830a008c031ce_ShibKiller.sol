...
contract ShibKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibKiller";
    string private _symbol = "ShibKiller";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x897bD92b1F8090eF15b1b784146811211380eD40); 
    address payable public ttWal = payable(0x897bD92b1F8090eF15b1b784146811211380eD40); 
