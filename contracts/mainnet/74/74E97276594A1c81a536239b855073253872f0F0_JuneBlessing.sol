...
/*
JuneBlessing - Bringing Luck into Your Life
Brought to you by CryptoSage, JuneBlessing is believed to be NFT that bringing luck into your life. By having only 2% of tax fees, JuneBlessing will held a fairlaunch in a next few upcoming minutes.

1. Based Dev, CryptoSage which has few previous projects above $100K MC
2. NFT Marketplace that supports bid
3. 2% low tax fees
4. Liquidity fully locked

Shill & join us now : https://t.me/JuneBlessingToken
*/
...
contract JuneBlessing is Context, IERC20 { 
    ...
    string private constant _name = "JuneBlessing"; 
    string private constant _symbol = "$JBless"; 
