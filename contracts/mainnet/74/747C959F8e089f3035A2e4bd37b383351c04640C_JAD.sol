...
// I love RH & Pulse Chain This will be me provoing my unique example to a problem by creating confusion
...
/**
 * @title bplsX ERC20 token
 * @dev
 *      Written By ANON GRV Holo Dev where as Admin we hit 120 Mil
 */
contract JAD is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**5 * 12**DECIMALS;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("JeetsAgainstDrugs", "JAD", uint8(DECIMALS))
        payable
        public
    {
