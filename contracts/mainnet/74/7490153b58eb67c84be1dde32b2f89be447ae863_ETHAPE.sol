...
contract ETHAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHAPE";
    string private _symbol = "ETHAPE";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xd4E2DA14c4b735B3aC41C0613674d1CAb173E7Ba); 
    address payable public marketingAddress2 = payable(0x78954BDEE8c5E442083599D4D0FBa9cBc1e9520d); 
