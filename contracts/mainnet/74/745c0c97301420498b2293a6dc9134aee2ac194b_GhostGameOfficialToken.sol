...
// https://www.gamecity.ne.jp/zero/mask/event/ghost.html
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface GhostGameOfficial {
...
contract GhostGameOfficialToken is GhostGameOfficial {
    ...
    string public override name = unicode"四つん這いの女";
    string public override symbol = unicode"四つん這いの女";
