...
/**
    Telegram : https://t.me/DuckNetwork
*/
...
contract DuckNetwork is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Duck Network";
    string private _symbol = "DUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xacFE631F1131978aEf8A12873a341F1Ea86491bC);
    address payable public DevelopmentWalletAddress = payable(0xacFE631F1131978aEf8A12873a341F1Ea86491bC);
