...
contract aBNBcSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "aBNBcSHIB";
    string private _symbol = "aBNBcSHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xAc9094209637EA770947A7296f8b4D8ee0a531D9); 
    address payable private teamWalletAddress = payable(0xbA05D8e1f38BEF1DF7ce0dA598a4495553f0279E); 
