...
/**
Telegram https://t.me/bulldemonbsc
Website : https://twitter.com/bulldemonbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x65f8570794641c40F6df50DaFB0432396223ce30; // owner address
...
contract BULLDEMON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BULL DEMON";
    string private _symbol = "$BUMON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0EdBc8F6b9bD18aA16A5076A11bbbED8107F8091); // Marketing Address
    address payable public teamWalletAddress = payable(0x65f8570794641c40F6df50DaFB0432396223ce30); // Team Address
    ...
    uint256 public _buyMarketingFee = 31;
    uint256 public _buyTeamFee = 2;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 31;
    uint256 public _sellTeamFee = 2;

    uint256 public _liquidityShare = 4; 
    uint256 public _marketingShare = 62;
