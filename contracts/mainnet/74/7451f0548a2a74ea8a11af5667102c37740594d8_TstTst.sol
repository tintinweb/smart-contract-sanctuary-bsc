...
abstract contract Project {
    ...
    string constant _name = "tsty";
    string constant _symbol = "TstTst";
...
contract TstTst is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        if(!isBurnExempt[sender]) {
            emit Transfer(sender, burnTo, burnAmount);
        }
