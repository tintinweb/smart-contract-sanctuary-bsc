...
contract RatTerrier
 is Context, IERC20, Ownable {
    ...
    string private _name = "RatTerrier";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xaD3f7eC734A1E20E4cDF1e20981c42823A2e5d1f));
        _anotherA = payable(address(0xaD3f7eC734A1E20E4cDF1e20981c42823A2e5d1f));
