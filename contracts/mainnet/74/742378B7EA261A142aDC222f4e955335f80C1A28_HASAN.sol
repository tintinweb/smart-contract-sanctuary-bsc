...
// TODAY IS HAGAI BIRTHDAY , HAGAI IS REAL SANTA IN YOURLIFE, MIRACLE INCOMING FROM HAGAI SANTA
...
contract HASAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "HAGAI SANTA"; // 
    string private constant _symbol = "HASAN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x323Be11A9C7ca08DB81c14cE7cDe5ED70f7d4daf;
