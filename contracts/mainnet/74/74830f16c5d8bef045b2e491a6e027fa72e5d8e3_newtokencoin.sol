...
contract newtokencoin is Context, IERC20, Ownable {
    ...
    string private _name = "NotFound";
    string private _symbol = "NotFound";
	...
	function getNotFoundFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
	...
	function swapNotFoundFees(address _token, uint256 tokens) private  {
	...
	function tokenNotFoundContract() public view virtual returns (address) {
			return address(this);
		}
