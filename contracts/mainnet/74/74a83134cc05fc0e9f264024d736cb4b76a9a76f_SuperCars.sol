...
contract SuperCars is ReentrancyGuard {
    // Structs
    struct User {
        uint id;
    ...
    // Constants
    uint public constant registrationPrice = 0.030 ether;
    uint8 public constant rewardPayouts = 3;
    uint8 public constant rewardPercents = 68;
    uint8 public constant insurance = 8;
    ...
    function buyLevel(uint8 level) public payable nonReentrant {
        ...
        // Buy and burn tokens
        (bool success, ) = tokenBurner.call{value: onePercent * insurance}("");
