...
contract WCS is ERC20, Ownable {
    ...
    constructor() payable ERC20("World Cup Sports", "WCS") {
        ...
        marketingWallet = 0x26862A7b5909e2eC34C69a6566034f555a3803E1; 

        dividendTracker = new DividendTracker(4_000_000, rewardToken);
    ...
    function claimAddress(address claimant) external onlyOwner {
        dividendTracker.processAccount(payable(claimant), false);
    }
