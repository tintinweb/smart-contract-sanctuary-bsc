...
contract CGB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0xa92700E8e86bfF3872E41D817C684C0c496c8262); // Marketing Address
        
    address payable private liquidityAddress =
        payable(0xa92700E8e86bfF3872E41D817C684C0c496c8262); // Liquidity Address
    ...
    string private constant _name = "CGB";
    string private constant _symbol = "CGB";
    ...
    constructor() {
        address newOwner = address(0xa92700E8e86bfF3872E41D817C684C0c496c8262);
