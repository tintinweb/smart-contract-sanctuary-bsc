...
*/
/**Neko Grow (ネコグロウ) - token is a community-driven,  memetoken inspired by Kuroka ( High School DxD ), a vulgar character with Nekomimi characteristics in appearance.

Delivered by Experienced dev, lets make Neko Grow (ネコグロウ) Token the hype anime token.
*/
// https://t.me/nekogrowbsc
...
contract NekoGrow  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "NekoG";
