...
contract DejitaruTsukaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dejitaru Tsuka Inu";
    string private _symbol = "DejitaruTsukaInu";
