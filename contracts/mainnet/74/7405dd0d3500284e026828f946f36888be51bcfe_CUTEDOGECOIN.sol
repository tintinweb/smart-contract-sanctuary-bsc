...
/*
    Telegram: https://t.me/cutedogecoinbsc
*/
...
contract CUTEDOGECOIN is IERC20, Ownable {
    ...
    string _name = "CUTE DOGE COIN";
    string _symbol = "$CUTEDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);   // 1,000,000
    uint256 public _transferLimit = (_totalSupply * 100) / 100;   // 100% 
