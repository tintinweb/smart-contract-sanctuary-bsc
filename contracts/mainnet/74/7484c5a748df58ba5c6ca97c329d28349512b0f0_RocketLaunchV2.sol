...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    uint256 private _tTotal = 300 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Rocket Launch V2";
    string private _symbol = "ROCKET";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1; // 1% reflections
    ...
    address public devWallet = 0xb9d73e2164DbdfAc8AF28a7244a3F9ff07DB5Db0; // development wallet
