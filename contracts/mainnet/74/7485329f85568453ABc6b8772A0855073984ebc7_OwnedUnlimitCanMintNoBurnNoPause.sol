...
contract FactoryNoOwnerFixedNoMintNoBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (NoOwnerFixedNoMintNoBurnNoPause) {
...
contract FactoryNoOwnerFixedNoMintCanBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (NoOwnerFixedNoMintCanBurnNoPause) {
...
contract FactoryOwnedFixedNoMintNoBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedFixedNoMintNoBurnNoPause) {
...
contract FactoryOwnedFixedNoMintCanBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedFixedNoMintCanBurnNoPause) {
...
contract FactoryOwnedFixedNoMintNoBurnCanPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedFixedNoMintNoBurnCanPause) {
...
contract FactoryOwnedFixedNoMintCanBurnCanPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedFixedNoMintCanBurnCanPause) {
...
contract FactoryOwnedUnlimitCanMintCanBurnCanPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedUnlimitCanMintCanBurnCanPause) {
...
contract FactoryOwnedUnlimitCanMintNoBurnCanPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedUnlimitCanMintNoBurnCanPause) {
...
contract FactoryOwnedUnlimitCanMintNoBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedUnlimitCanMintNoBurnNoPause) {
...
contract FactoryOwnedUnlimitCanMintCanBurnNoPause {
    function create(
        ...
        address owner,
        uint8 decimals
    ) public returns (OwnedUnlimitCanMintCanBurnNoPause) {
...
contract FactoryOwnedCappedCanMintCanBurnCanPause {
    function create(
        ...
        uint8 decimals,
        uint256 _cap
    ) public returns (OwnedCappedCanMintCanBurnCanPause) {
        return
            new OwnedCappedCanMintCanBurnCanPause(
                name,
                symbol,
                initialSupply,
                owner,
...
contract FactoryOwnedCappedCanMintNoBurnCanPause {
    function create(
        ...
        uint8 decimals,
        uint256 _cap
    ) public returns (OwnedCappedCanMintNoBurnCanPause) {
        return
            new OwnedCappedCanMintNoBurnCanPause(
                name,
                symbol,
                initialSupply,
                owner,
...
contract FactoryOwnedCappedCanMintCanBurnNoPause {
    function create(
        ...
        uint8 decimals,
        uint256 _cap
    ) public returns (OwnedCappedCanMintCanBurnNoPause) {
        return
            new OwnedCappedCanMintCanBurnNoPause(
                name,
                symbol,
                initialSupply,
                owner,
...
contract FactoryOwnedCappedCanMintNoBurnNoPause {
    function create(
        ...
        uint8 decimals,
        uint256 _cap
    ) public returns (OwnedCappedCanMintNoBurnNoPause) {
        return
            new OwnedCappedCanMintNoBurnNoPause(name, symbol, initialSupply, owner, decimals, _cap);
    }
}
