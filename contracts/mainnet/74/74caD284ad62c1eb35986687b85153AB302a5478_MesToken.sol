...
interface IAnyswapV3ERC20 is IMesToken, IERC2612 {
...
contract MesToken is IAnyswapV3ERC20 {
    ...
    constructor(
        ...
        if (_underlying != address(0x0)) {
            require(_decimals == IAnyswapV3ERC20(_underlying).decimals());
        }
    ...
    function depositWithPermit(
        ...
        IAnyswapV3ERC20(underlying).permit(
            target,
            address(this),
            value,
            deadline,
    ...
    function depositWithTransferPermit(
        ...
        IAnyswapV3ERC20(underlying).transferWithPermit(
            target,
            address(this),
            value,
            deadline,
    ...
    function turnOffAntibotMode() public onlyVault {
