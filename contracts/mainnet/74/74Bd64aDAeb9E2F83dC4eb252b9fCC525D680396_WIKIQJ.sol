...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x457Fe77bd7c3467A9D0F1f937969F7A2C37Db3dB;//   营销
...
contract WIKIQJ is Token {
    constructor() Token(
        ...
        address(0x457Fe77bd7c3467A9D0F1f937969F7A2C37Db3dB),//fund address
    
        address(0x457Fe77bd7c3467A9D0F1f937969F7A2C37Db3dB)//dev address
    ){
