...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), dividendAddress, newBalance * fundFee / totalUsdtFee);
...
contract DOE is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1 * 10 ** 6,
        address(0xaf4Dc8b71aad69089526C348a82Ea726E1426f05),
        address(0x317222e091Cc514Cbe2D7482ac882E325B54138a)
    ){
