...
Telegram group: https://t.me/Astro_Inu
*/
...
contract AstroInu is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet = 0x5Bb78Cb6043b9398426f8CdCb18eEbEb8319e6A0;
    ...
    uint256 public _maxWalletHoldingAmount = 10000000 * 10**9;
    ...
    constructor() {
        ...
        _isExcludedFromWalletLimit[BurnWallet] = true;
    ...
    function setBuyFees(uint256 liquidityFee,uint256 BurnFee,uint256 MarketingFee) external onlyOwner() {
