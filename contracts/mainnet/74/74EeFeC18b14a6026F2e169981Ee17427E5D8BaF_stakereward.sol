...
contract stakereward {
    ...
    uint256[32] public _priceID = [5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,
                                   5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,
                                   5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8,5000*1e8];
