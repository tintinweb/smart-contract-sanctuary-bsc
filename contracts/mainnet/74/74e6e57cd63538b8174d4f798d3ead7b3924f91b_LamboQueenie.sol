...
Liquidity will be Lock through Deep Locker
Anti-Dump Mechanism
Max Buy/Sell: 5%

Total 4% Taxes:
2% $ADA Reward to holders
1% Liquidity Fee
1% Marketing Fee

Join with us:
Telegram: https://t.me/LamboQueenie
...
contract LamboQueenie is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LamboQueenie";
    string constant _symbol = "QUEENIE";
