...
//Twitter    : https://twitter.com/ProofBape
...
contract PROOFOFBAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof of Bape";
    string private _symbol ="PROOFB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1617017F3D10F12b22512b68fc3D0b8C038bd934); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1617017F3D10F12b22512b68fc3D0b8C038bd934); // BuyBack Address
