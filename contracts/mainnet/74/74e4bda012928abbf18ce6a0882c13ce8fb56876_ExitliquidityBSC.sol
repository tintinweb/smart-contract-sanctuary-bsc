...
/**
https://t.me/ExitliquidityBSC

6% marketing (of which 25% probably goes to anothermarketingwallet which I will use as devwallet) 4% autoliq.

Unfair fair launch, I will show the ca before I add liq. 1% wallet will be sent to the winner of the logo competition, 0,5% to me, since I thought of the name kek.
...
contract ExitliquidityBSC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Exit Liquidity";
    string constant _symbol = "ExitLiq";
