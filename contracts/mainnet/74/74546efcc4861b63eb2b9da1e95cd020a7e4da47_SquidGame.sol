...
🐙SquidGameis a meme token that was taken from the name hype . This token is community based and an experienced team in the crypto field . 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1fcfddb0CADB19810ee7C3be50250c9A5Fc8DE43;
...
contract SquidGame is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x1fcfddb0CADB19810ee7C3be50250c9A5Fc8DE43);
