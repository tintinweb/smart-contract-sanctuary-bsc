...
contract WLFT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wolf Inu Token";
    string private _symbol = "WLFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBC20712004D30DCdE104cB00eD246Cf630F22007);
    address payable public buyBackWalletAddress = payable(0xBC20712004D30DCdE104cB00eD246Cf630F22007);
