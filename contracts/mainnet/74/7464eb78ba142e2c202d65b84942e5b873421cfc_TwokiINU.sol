...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9D645A0d8C9B9AA3CF6464cB0cEbe12659c51A4C; // owner address
...
contract TwokiINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twoki Inu";
    string private _symbol = "$Twoki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x195838Bb870377E73c530C1502Ed8d5f640C8Ab9); // Marketing Address
    address payable public teamWalletAddress = payable(0x195838Bb870377E73c530C1502Ed8d5f640C8Ab9); // Team Address
