...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!_blackList[from] || _feeWhiteList[from], "bList");
        ...
        if (lastMaybeAddLPAddress != address(0)) {
            ...
            if (lpBalance > 0) {
                addLpProvider(lastMaybeAddLPAddress);
            }
        }
...
contract AiL is AbsToken {
    constructor() AbsToken(
        ...
        520,
    //Receive
        address(0x6138F9Ad3A41Fc502FeA42FD1aF4e6E1789f8CCD),
    //Fund
        address(0xA45b911799aaeb60b5Fc03E4570F6fEc01e60Af6)
    ){
