...
/*
    Moonfire Finance is a fusion between fiat & crypto with real growth, 
    we want people to earn the most stabilized coin on the blockchain $BUSD 
    as a hourly passive income simply by holding $MFF in your crypto wallet. 
    To change the future for the new generation we bring our charity program. 
    Moonfire Finance is much more than a Crypto Token, 
    it is a company with a clear mission to improve the global community we live in. Join us and be part of this journey.

    Website: https://moonfirefinance.com/
    Twitter: https://twitter.com/MoonfireFinance
    Telegram: https://t.me/MoonfireFinanceOfficial
*/
...
contract MoonfireFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonfire-Finance";
    string private _symbol = "MFF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x84e5c4408d12EeFd0ac008e2B2BF9f2dfDEBf86d);
    address payable public buyBackWalletAddress = payable(0x84e5c4408d12EeFd0ac008e2B2BF9f2dfDEBf86d);
    ...
    uint256 private _totalSupply = 1000 * 10**12 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply / 100 * 4;
    uint256 public _walletMax = _totalSupply / 100 * 10;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if(!isTxLimitExempt[sender] && !isTxLimitExempt[recipient] && !isMarketPair[sender]) {
