...
contract SONICMUU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SONIC MUU"; // 
    string private constant _symbol = "$SONICMUU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xF83839DB97EEcEBD886493C0fBF90d6Ad03e1Fa2;
