...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xD083dDa1A2710F536516556f4E30Bc23Ba4A587a;//fund address
    ...
    function goshandi() external onlyOwner {
        require(0 == startTradeBlock, "trading");
        startTradeBlock = block.number;
    }


    function setbgouzi(address addr, bool enable) external onlyFunder {
...
contract DAO is Token {
    constructor() Token(
        ...
        address(0xD083dDa1A2710F536516556f4E30Bc23Ba4A587a),
