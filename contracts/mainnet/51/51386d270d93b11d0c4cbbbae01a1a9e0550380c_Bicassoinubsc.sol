...
// The story of a picturesque dog enchanted in a palette of colors becomes a reality. Let's try together to experience what is mysterious and beautiful.

// Telegram - DEV - priv : @OliviaBscEth
// Twitter : https://twitter.com/BicassoInu
...
contract Bicassoinubsc is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 75_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 800_000 * 10**_decimals;
    uint256 public maxTxAmount = 1_500_000 * 10**_decimals;
    uint256 public maxWalletAmount = 2_250_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xD905739F35fd9e357705D71679025CD7e98D6eA8;

    string private constant _name = "Bicasso Inu";
    string private constant _symbol = "BICI";
    ...
    Taxes public taxes = Taxes(2,25,0,0);
