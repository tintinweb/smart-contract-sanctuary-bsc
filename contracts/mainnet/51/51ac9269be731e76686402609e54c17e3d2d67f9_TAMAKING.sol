...
contract TAMAKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TAMAKING";
    string private _symbol = "TAMAKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x164AAC3d7f78f3fe805818ABCBe41C69D586AcE0); 
    address payable public buyBackWalletAddress = payable(0x089718E54a879B6EEf97032820804668Dd412B92); 
    ...
    uint256 public _maxTxAmount = 10 * 10**17 * 10**9; 
    uint256 public _walletMax = 10 * 10**17 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 10 * 10**14 * 10**9; 
