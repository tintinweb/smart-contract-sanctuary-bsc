...
contract VIOLET is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Violet";
    string constant _symbol = "Violet";
    ...
    address public Owner=0xB4d09545a03B11772dA27c968256fb08c37644Bd; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xB4d09545a03B11772dA27c968256fb08c37644Bd;
