...
contract TEST is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the TEST ERC-20 contract.
     */
    constructor() public ERC20("TEST", "TEST") {
        // Mints 1 TEST to contract creator for initial pool setup
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints TEST to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of TEST to mint to
