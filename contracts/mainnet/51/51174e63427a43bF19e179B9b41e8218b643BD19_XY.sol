...
contract XY is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "XY";       //Full name
    string public symbol_ = "XY";      //abbreviation
    ...
    uint256 public maxburn = 160 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x14325C11D19799E5D3e8c7c13dC052Fc5F50308d;  //Marketing address
