...
contract ElonsPePe is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = ( _tTotal * 3 ) / 100; // 4%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "ELONS PEPE"; // 
    string private constant _symbol = "EPEPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xe86d9b9Bfd76Fbb4dc9C6011C0a0611b3FC66032;
