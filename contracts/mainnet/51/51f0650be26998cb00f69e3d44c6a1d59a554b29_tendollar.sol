...
contract tendollar is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "10Dollar"; // 
    string constant _symbol = "10$"; // 
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1 * 10**2 * 10**_decimals;
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (99); 
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (99); 
    uint256 public _maxWalletToken = _totalSupply / (100) * (99); 

    address private autoLiquidityReceiver = 0xAe9cbA8C28F01216cf3484FCEeDB9056F38b0E97; 
    address private marketingFeeReceiver = 0xAe9cbA8C28F01216cf3484FCEeDB9056F38b0E97; 
    address private devFeeReceiver = 0xAe9cbA8C28F01216cf3484FCEeDB9056F38b0E97; 
    address private teamFeeReceiver = 0xAe9cbA8C28F01216cf3484FCEeDB9056F38b0E97; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xAe9cbA8C28F01216cf3484FCEeDB9056F38b0E97;
