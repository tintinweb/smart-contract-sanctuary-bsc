...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa3Dc256b70D4EBA1493BdE151b2EbD7C738B5002; 
...
contract Japanese is Context, IERC20, Ownable {
    ...
    string private _name = "Japanese";
    string private _symbol = "Japanese";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3Dc256b70D4EBA1493BdE151b2EbD7C738B5002); 
    address payable public teamWalletAddress = payable(0x088120DEd44E7561142EF24A0d2aB94EEE163d58); 
