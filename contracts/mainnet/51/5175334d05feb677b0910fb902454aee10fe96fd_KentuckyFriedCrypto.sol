...
contract KentuckyFriedCrypto is IBEP20, Auth {
    ...
    string constant _name = "Kentucky Fried Crypto";
    ...
    bool public kentuckyFriedddMode = true;
    mapping (address => bool) public iskentuckyFrieddded;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6a4f228BDa6C3F042A7889F97Ecc825F2F8C58f8;
        treasuryFeeReceiver = 0x6a4f228BDa6C3F042A7889F97Ecc825F2F8C58f8;
        devFeeReceiver = 0x25c9AeEE24b448835B7f4B91Eb1cbd4CcBFaA111;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // kentuckyFrieddd
        if(kentuckyFriedddMode){
            require(!iskentuckyFrieddded[sender] && !iskentuckyFrieddded[recipient],"sorry ser you are kentuckyFriedd");    
        }
    ...
    function enable_kentuckyFrieddd(bool _status) public onlyOwner {
        kentuckyFriedddMode = _status;
    }

    function manage_kentuckyFrieddd(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            iskentuckyFrieddded[addresses[i]] = status;
        }
    }
