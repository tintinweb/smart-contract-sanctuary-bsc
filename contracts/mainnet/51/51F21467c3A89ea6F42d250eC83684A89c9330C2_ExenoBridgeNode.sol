    ...
    ERC1363Payable
{
     ...
     * @param fee - the required fee: first value is denominated in cash (i.e. native currency), while the second value is denominated in core token (i.e. EXN token)
