...
contract ShibmurayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBMURAY INU"; 
    string private _symbol = "SINU"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc67F48edf0FC0CB3B538fDDF5228503C6869af05); 
    address payable public teamWalletAddress = payable(0xc67F48edf0FC0CB3B538fDDF5228503C6869af05); 
