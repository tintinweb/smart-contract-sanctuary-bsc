...
contract OptimusYooshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Optimus Yooshi";
    string private constant _symbol = "OPSHI";
