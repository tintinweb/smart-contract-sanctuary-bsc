...
//Telegram : https://t.me/AIDemon666
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77dCcfDD5F27F01e1F7B2896D2BDBEf191B9447E; // owner address
...
contract AIDEMON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI DEMON";
    string private _symbol = "$AID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77dCcfDD5F27F01e1F7B2896D2BDBEf191B9447E); // Marketing Address
