...
contract Power2 is Owner {
    ...
    mapping(address => mapping(address=>SuborInfo)) public subordinate;
    ...
    function _takeInviterFee(
        ...
        for (int256 i = 0; i < 2; i++) {
            ...
            subordinate[sender][address(cur)].amount=subordinate[sender][address(cur)].amount.add(curTAmount);
            subordinate[sender][address(cur)].level=uint(i);
