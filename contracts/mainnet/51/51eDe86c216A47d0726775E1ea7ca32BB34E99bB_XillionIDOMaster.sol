...
contract XillionIDOMaster is XillionIDOCommon {
        ...
        if (isSuccessfullyFunded) {
            ...
            if(idoValueCap > 0){
              for (uint256 i; i < finalInvestorsAmount; i++) {
                ...
                console.log("tokensToDistribute", tokensToDistribute);
    ...
    function claimPoolTokens() external nonReentrant {
        ...
        console.log("idoPoolTokenBalance",idoPoolTokenBalance);
        console.log("idoBEP20Balance", idoBEP20Balance);
        console.log("idoBNBBalance",idoCurrencyBalance);
