...
contract Awareness is Context, IERC20, Ownable {
    ...
    string private _name = "Awareness Token";

    string private _symbol = "$WAKEUP";
    ...
    address payable public marketingWalletAddress = payable(0xebA88D4e47322b1Be6F9d6A7A10607077e181cF9); // Marketing Address
    ...
    uint256 public _maxTxAmount = 100 * 10**6 * 10**9; //10%

    uint256 public _walletMax = 100 * 10**6 * 10**9; // 10%
    ...
    // 0x10ED43C718714eb63d5aA57B78B54704E256024E - production

    // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 - development
