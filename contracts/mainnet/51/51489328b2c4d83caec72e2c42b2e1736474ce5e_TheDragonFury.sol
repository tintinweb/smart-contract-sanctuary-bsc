...
contract TheDragonFury is Context, IERC20 {
    ...
    string constant private _name = "The Dragon TestNet";
    string constant private _symbol = "TDTEST";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        buyback: payable(0x1E4C37BF536d43FaF73F927D3012d910bd582501),
...
//===============================================================================================================
    ...
    function setMaxWalletSize(uint256 percent) external onlyOwner {
        ...
        //100%=>1000 in uint
        require(percent >= 10, "Max Wallet Size must be above 1% of circulating supply.");
    ...
    function setWallets(address payable marketing, address payable buyBack, address liquidity) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0 && _ratios.total - _ratios.liquidity > 0) {
            ...
            _taxWallets.buyback.transfer((amountBNB * _ratios.buyback) / (_ratios.total - _ratios.liquidity));
