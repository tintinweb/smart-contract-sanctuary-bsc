...
/**
 * MINI FALCON
 TELEGRAM: https://t.me/ChibiFoxy
 WEBSITE:  http://cfoxy.code.blog
 BUY & SELL TAX - 14-18%
 max buy - 0.1
...
contract CHIBIFOXY is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CHIBI FOXY";
    string constant _symbol = "$CBFY";
