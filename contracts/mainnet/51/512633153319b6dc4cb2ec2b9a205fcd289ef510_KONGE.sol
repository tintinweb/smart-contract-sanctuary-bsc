...
contract KONGE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xa563B6860428b954D7BdeE8d268763E9551775Fe);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1*1000000000 * 10**_decimals;
    string private constant _name = "Konge INU"; 
    string private constant _symbol = unicode"KONGE"; 
