...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd663DcfBf4812b0a670A8bB09F865C71928825a1;
...
contract NanoCap is Context, IERC20, Ownable {
    ...
    string private constant _name = "NanoCap"; // 
    string private constant _symbol = "NANO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xd663DcfBf4812b0a670A8bB09F865C71928825a1);
