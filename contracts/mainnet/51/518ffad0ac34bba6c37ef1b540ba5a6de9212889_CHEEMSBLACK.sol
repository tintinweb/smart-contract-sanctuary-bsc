...
// 
//
// 📱 Telegram:https::https://t.me/+kNcbX-amHkI2ODU1
/*
...
contract CHEEMSBLACK is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHEEMSBLACK", "CHEEMSBLACK") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEMSBLACK";
    string private _symbol = "CHEMSBLACK";
