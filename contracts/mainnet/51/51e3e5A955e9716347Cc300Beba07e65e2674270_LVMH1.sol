...
contract LVMH1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LVMH";
    string private _symbol = "LVMH";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x5F10e4B446281c05e6DEb50af543DA1e6D75d392); 
    address payable public marketingAddress2 = payable(0xb541c7Ba332ED0dB616Eec987a7E99310d354A9f); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x6a5Ae61297998B86465d43D147315Cdc2661f088);

    address ethAddress = address(0xDB219D2398D8208Cc02F846F0d5AfED30D38e494);
    address  public wapV2RouterAddress = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    uint256 public genesisBlock;
    uint256 public coolBlock = 10; 
   
    uint256 private _limitBuy =4000; 
    ...
    uint256 private _totalSupply =280000 * 10**_decimals;
    ...
    uint256 public _buyBackLpFee = 2;
    ...
    uint256 public _sellBackLpFee = 2;
