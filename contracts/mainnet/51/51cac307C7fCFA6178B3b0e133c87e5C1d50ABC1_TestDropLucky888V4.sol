...
// Dependency file: contracts/vrf/CryptoDropLucky888V4.sol
...
contract CryptoDropLucky888V4 is VRFElementIdUint256 {
    using SafeERC20 for IERC20;
    using Address for address;
    ...
    function placeBet() external payable virtual nonReentrant whenNotPaused {
        ...
        Bet memory bet = Bet("", block.number - 1, betSize, msg.value - betSize, 0, "");
    ...
    function _beforeProcessBet(uint256 _id, uint256 _amount) internal virtual {
...
// Root file: contracts/test/TestDropLucky888V4.sol


pragma solidity ^0.8.0;

// import "contracts/vrf/CryptoDropLucky888V4.sol";

contract TestDropLucky888V4 is CryptoDropLucky888V4 {
    constructor(address _vrfCoordinator, address _linkToken) CryptoDropLucky888V4(_vrfCoordinator, _linkToken) {}
}