...
library Address{
 ...
 contract GROWINU is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 250_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0x0A3E776F58C2e5c23A0De3983C1eC98eD3AA148c;
    address public donationWallet = 0x0A3E776F58C2e5c23A0De3983C1eC98eD3AA148c;

    string private constant _name = "Grow Inu";
    ...
    Taxes public taxes = Taxes(1, 5, 1, 3);
    Taxes public sellTaxes = Taxes(1, 5, 1, 3);
