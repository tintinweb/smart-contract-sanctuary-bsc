...
contract DogePOW is Bep20, Context, BATNFT  {
    ...
    string public override name = "Doge POW";
    string public override symbol = "DogePOW";
    ...
    constructor(uint totalSupplyValue, address BATAddress, address BATDAOAddress) {
        ...
        balances[BAT] =  totalSupply * 100 / 100;
        balances[BATDAO] = totalSupply * 100 / 100;
