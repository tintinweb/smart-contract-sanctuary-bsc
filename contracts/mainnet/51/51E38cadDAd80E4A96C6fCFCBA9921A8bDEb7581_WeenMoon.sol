...
contract WeenMoon is Context, IBEP20, Ownable {
    ...
    uint256 private buycharityFee = 2;
    uint256 private buyTotalFee = buyDevFee + buyMarketingFee + buyLiquidityFee + buycharityFee;

    //Sell Fees Variables
    uint256 private sellDevFee = 2;
    uint256 private sellMarketingFee = 5;
    uint256 private sellLiquidityFee = 3;
    uint256 private sellcharityFee = 2;
    uint256 private sellTotalFee = sellDevFee + sellMarketingFee + sellLiquidityFee + sellcharityFee;
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x5e204Ca8cE3c28AF475bCD27F1edb155E4B34A7a;
    address public marketingFeeReceiver = 0x5e204Ca8cE3c28AF475bCD27F1edb155E4B34A7a;
    address public liquidityFeeReceiver = 0x5e204Ca8cE3c28AF475bCD27F1edb155E4B34A7a;
    address public charityReceiver = 0xB698c98e10d9EFe4Cea9EECca00121Daf7a28Ab0;
