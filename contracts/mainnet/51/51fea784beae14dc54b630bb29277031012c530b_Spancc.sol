...
contract Spancc is IBEP20, Admin{
    ...
    string constant _name = "SpiderManCC";
    string constant _symbol = "Spancc";
    ...
    address private marketingFeeReceiver = (0x7C40d56AAC22Ea6870964742377d31A21519d1B4); // marketing address
    ...
    function setBMSpancc(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMSpancc(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
