...
// Visit our website www.GreatEarthToken.com
...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Test_Busd_Dividend_Tracker", "Test_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 30000000 * (10**18); //must hold 3,000,000+ tokens
    }
...
contract GreatEarthToken is ERC20, Ownable {
    ...
    constructor() ERC20("GreatEarthToken", "GET") {
    	...
    	marketingWallet = 0x1Dec821C52E959773e7914E00dE694f284b366B9; 
