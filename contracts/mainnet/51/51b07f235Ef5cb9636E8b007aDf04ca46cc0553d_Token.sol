...
contract Token is ERC20, Ownable {
    ...
    address public _devAddress = address(0xB7ba33FeCe6Ba7Cb3Bde7e1F086609a19733F112);//技术维护1
    address public _deadAddress = address(0x000000000000000000000000000000000000dEaD);//销毁地址1
    address public _markAddress = address(0x8518fF40787a39CB5381758242A6938Ac88a5bFd);//营销地址1
    address public _liudityAddress = address(0xDF5eF3C11362E4a81c0CF0144BE894d411043696);//回流地址1
    address public _mindAddress = address(0x926993AcEF97d430A272C20FfC8A3Bb8e3189D9B);//中转地址（授权u给合约）1
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 devGetU = fistval.div(5);
            uint256 markGetU = fistval.sub(devGetU);
            IERC20(USDTs).transfer(_devAddress, devGetU);
            IERC20(USDTs).transfer(_markAddress, markGetU);
            return;
        }
