...
contract TVAT is IERC20, Ownable {
    ...
    address private fundAddress = address(0xE65b039CEA3DD4943D1C46Efd00e37E833c49d9e);
    address private fundAddress2 = address(0x0D53B2D8AB2FA9C457102C41CDa9A773B53ce701);
    ...
    constructor() {
        ...
        .createPair(address(this), 0x7c5beF849B6201Dd577548f85acbBDC222d2af8e);

        uniswapV2Router = _uniswapV2Router;

        _tTotal = 113410000 * 10 ** _decimals;
