...
contract Multistake_MTD {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x096D25018a4900cAA2271B2FF72b752E6b64BdCc; // MTD
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 0.02 ether; // MTD
