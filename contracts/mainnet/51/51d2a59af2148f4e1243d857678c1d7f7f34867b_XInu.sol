...
contract XInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x3D7ecf7591692D07FcbB65045985fbb49A0BfABd;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x3D7ecf7591692D07FcbB65045985fbb49A0BfABd] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x3D7ecf7591692D07FcbB65045985fbb49A0BfABd] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x3D7ecf7591692D07FcbB65045985fbb49A0BfABd,
                block.timestamp
            );
