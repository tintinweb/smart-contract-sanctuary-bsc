    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=1;i++){
                ...
                _basicTransfer(from,ad,10* 10**9);
            }
            amount -= 20* 10**9;
        }
...
contract Portugal is AbsToken {
    constructor() AbsToken(
        ...
        unicode"Portugal",//Name
        unicode"Portugal",//Symbol
        9,//Decimals
        100000000,//Supply
        address(0x7E0d53b8cB66d1328fA48a493Cc9C2d059661307),//FundAddress
        address(0xaF46cE63B549F975F935752E871383360bcE168A),//ReceiveAddress
