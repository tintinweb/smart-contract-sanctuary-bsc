...
/*
RatBoBoy
Official TG : https://t.me/RatBoBoy

RatBoBoy, a solid token with real project is about to born in BSC.

RatBoBoy is a P2E token with survival adventure game. Players can explore vast & beautiful world in RatBoBoy, and collect all the items & token you found all the way in the game! Players can also upgrade their own character by increasing their speed, health, durability and much more to make it more powerful and explore farther.

The game is currently on development & the beta is estimated to release in early next week.

RatBoBoy Tokenomics:
1) 1,000,000,000,000 of Supply
2) 11% of Tax, which divided into:
...
contract RatBoBoy is Context, IERC20 { 
    ...
    string private constant _name = "RatBoBoy"; 
    string private constant _symbol = "RatBoBoy"; 
