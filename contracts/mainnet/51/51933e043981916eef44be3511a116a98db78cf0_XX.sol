...
contract XX is Context, IERC20, Ownable {
    ...
    string private _name = "\u5C0F\u4FA0";
    string private _symbol = "\u5C0F\u4FA0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x899cD1bEF469273969b477d5e4908B58DD159462); 
    address payable public BurnedWalletAddress = payable(0x899cD1bEF469273969b477d5e4908B58DD159462); 
