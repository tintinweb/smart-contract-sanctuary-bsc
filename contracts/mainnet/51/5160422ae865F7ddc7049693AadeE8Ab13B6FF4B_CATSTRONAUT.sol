...
/**
 * 
 t.me/MEMECENTRALPLAYS
 https://catstronaut.vercel.app/
 Fuck centralized domains
 No but for real I lost the keys to my tg
 nO THAT AINT WHAT I WANNA WRITE
 I couldnt buy the domain that i why we are using vercel
 Telegram : t.me/catstronautBSC
*/
...
library Address{
 ...
 contract CATSTRONAUT is Context, IERC20, Ownable {
    ...
    Taxes public selltax = Taxes(0, 20, 10, 2);
