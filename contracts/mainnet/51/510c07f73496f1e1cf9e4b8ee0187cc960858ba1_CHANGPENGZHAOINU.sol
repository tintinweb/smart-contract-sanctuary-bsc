...
TELEGRAM: https://t.me/+lSk0AcEcTSYwMWRl
*/
...
contract CHANGPENGZHAOINU   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Changpeng zhao Inu ";
    string private _symbol = " CHI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xadAEEc3989870dE474190B680307d5e6ed2EeD1a); 
