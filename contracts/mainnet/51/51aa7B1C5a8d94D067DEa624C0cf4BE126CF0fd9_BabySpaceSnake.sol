...
//https://t.me/BabySpaceSnakeOfficial
...
/* Token contract */
contract BabySpaceSnake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x12AdD8e2765f066Eb81dFCb64C52264eD3f39BD3;
    ...
    // Name and symbol
    string constant _name = "BabySpaceSnake";
    string constant _symbol = "BABYSSNAKE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 5000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x12AdD8e2765f066Eb81dFCb64C52264eD3f39BD3;
