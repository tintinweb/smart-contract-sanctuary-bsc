...
// https://twitter.com/search?q=親父熱愛
...
contract FatherDevotionToken is BEP20Official {
    ...
    string public override name = unicode"親父熱愛";
    string public override symbol = unicode"親父熱愛";
