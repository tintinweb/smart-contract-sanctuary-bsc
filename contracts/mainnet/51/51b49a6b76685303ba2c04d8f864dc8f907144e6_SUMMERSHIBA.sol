...
contract SUMMERSHIBA is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() BEP20("SUMMERSHIBA", "SUMMERSHIBA") {
        marketingWallet = payable(0xF6c81Bc501Fb83828CF6bf486718860fEB8E3Dd1);
        ...
        swapTokensAtAmount = totalSupply / 25; // 4%;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling && !_taxableTransfer[from]) {
                super._transfer(from, to, amount);
            }

            if (isSelling && !_isExcludedFromFees[from]) {
            ...
            else if (isBuying && !_isExcludedFromFees[to]) {
