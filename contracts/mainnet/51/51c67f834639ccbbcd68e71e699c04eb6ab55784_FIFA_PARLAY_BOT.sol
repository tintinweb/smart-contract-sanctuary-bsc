...
contract FIFA_PARLAY_BOT is Context, IBEP20, Ownable {
    ...
    string private constant _name = "FIFA PARLAY BOT";
    string private constant _symbol = "Parlay";
