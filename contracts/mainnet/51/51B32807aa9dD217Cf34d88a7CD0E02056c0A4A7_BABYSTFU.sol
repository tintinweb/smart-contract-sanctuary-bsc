...
// Telegram: https://t.me/BabySTFULabs - Official partnership with daddy when we reach higher mcap.
...
/* Token contract */
contract BABYSTFU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BABY STFU Labs";
    string constant _symbol = "$BABYSTFU";
