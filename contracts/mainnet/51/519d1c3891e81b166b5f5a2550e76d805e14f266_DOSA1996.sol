...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xED335a1EE8d23De95CAB65569403A4f5cBEaE512;
...
contract DOSA1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " DOSA1996 ";
    string private _symbol = " DOSA96 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xED335a1EE8d23De95CAB65569403A4f5cBEaE512);
    address payable public teamWalletAddress = payable(0xED335a1EE8d23De95CAB65569403A4f5cBEaE512);
