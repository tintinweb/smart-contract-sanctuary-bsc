...
contract cLuna_Protector is Context, IERC20 {
    ...
    string private _name = "cLuna Protector";
    string private _symbol = "cLuna Protector";
//==========================
    // FEES
    struct taxes {
    uint buyFee;
    ...
    {buyFee: 900, sellFee: 900, transferFee: 900, antiDumpLT: 900});
//==========================
    // Maxima
    ...
    {maxBuy: 1500, maxSell: 1750, maxTransfer: 2500, maxAntiDump: 2500});
//==========================    
    ...
    { liquidity: 200, burn: 100, operations: 425, developer: 175});
//==========================
    // Anti-Dump
...
//==========================
    ...
    address payable public _operationsWallet = payable(0x685AD51bB4197be96208fb6Ec3e136027BCFa2f0);
    address payable public _developerWallet = payable(0x9fEAf0dBdD1875A79Af87b470b1AFfB43901C543);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    
    uint256 private maxTxPercent = 1; // Max Transaction Amount = 0.5%
    uint256 private maxTxDivisor = 100;
    uint256 private _maxTxAmount = (_tTotal * maxTxPercent) / maxTxDivisor;
    
    uint256 private maxWalletPercent = 2; //Max Wallet = 2%
