...
contract WW3 is Context, IERC20, Ownable {
    ...
    string private _name = "WW3COIN";
    string private _symbol = "WW3";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27D2B1a145cbF5a8ad6AcaBC175Dd091Caf8A0Af);
    address payable public teamWalletAddress = payable(0x27D2B1a145cbF5a8ad6AcaBC175Dd091Caf8A0Af);
