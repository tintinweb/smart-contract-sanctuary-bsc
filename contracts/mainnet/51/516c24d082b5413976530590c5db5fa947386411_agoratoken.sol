...
contract agoratoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0d556FB7dF084dd3289f4afb196b5664a9B170eb); //nice
    address payable public charityAddress = payable(0x0d556FB7dF084dd3289f4afb196b5664a9B170eb); //nice
    ...
    string private _name = "Agora Token"; //CC
    string private _symbol = "AGO";  //nice
