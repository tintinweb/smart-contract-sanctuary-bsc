...
contract QUIZGAMETOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1C9B7A98181eA342D7b7e0BCaEa6853E6192783A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "QUIZ GAME TOKEN";
    string private _symbol = "QGT";
