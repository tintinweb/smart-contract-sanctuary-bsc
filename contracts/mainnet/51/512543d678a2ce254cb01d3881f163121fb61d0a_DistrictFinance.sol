...
/**
District finance, is a Decentralized Super Deflationary Coin

Telegram : https://t.me/DistrictFinance
Website : https://districtfinance.site
Whitepaper : https://districtfinance.site/whitepaper.pdf
 */
...
contract DistrictFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "District Finance";
    string private constant _symbol = "DISTRICT";
    uint8 private constant _decimals = 6;

    uint256 private constant MAX = 8 * 10**40 * 10**_decimals;
    uint256 private  _toknTot = 1 * 10**12 * 10**_decimals;
    ...
    address payable public DonationsAddress = payable(0x8dD966dF420Ab138891b21a9002c91a30a3e3CB1);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 1;
    uint256 private liquidityTax = 2;
    uint256 private DonationsTax =  1;
    ...
    address public DonationsWallet = 0x8dD966dF420Ab138891b21a9002c91a30a3e3CB1;
