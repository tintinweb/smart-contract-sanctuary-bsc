...
contract B2023MOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY 2023 MOON";
    string private _symbol = "B2023MOON";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x801a8f9aF2d5417a85993a2843Ceb9c1882114c5); // Buy Back Address
