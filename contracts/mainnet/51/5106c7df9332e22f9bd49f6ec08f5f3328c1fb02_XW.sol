...
contract XW is IERC20, Ownable {
    ...
    address private taxAddress = address(0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4);

    uint256 public _destroyFee;
    address private _destroyAddress = address(0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4);
    ...
    address public ownerAddr = 0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4;
    ...
    constructor() {
        ...
        isRoute[0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4]=true;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d);
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);
        ...
        _tokenOwner = ownerAddr;

        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[ownerAddr] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[ownerAddr] = true;

        _owner = 0x9fFeE202aed6Aad4cb5E0b9123e12AA042B642A4;
    ...
    function setDestroyFee(uint256 val) public onlyOwner {
        _destroyFee = val;
    }
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if(block.timestamp<starttime){
                require(_isExcludedFromFee[from] || _isExcludedFromFee[to],"time error");
            }
    ...
    function _takeInviterFee(
        ...
        for (uint256 i = 1; i <= 8; i++) {
            ...
            if (cur == address(0)) {
                ...
                emit Transfer(sender, fundAddress, curTAmount);
                cur = address(0);
            }else{
                uint256 curTAmount = tAmount.div(10000).mul(rate);
                uint256 curRAmount = curTAmount.mul(currentRate);
