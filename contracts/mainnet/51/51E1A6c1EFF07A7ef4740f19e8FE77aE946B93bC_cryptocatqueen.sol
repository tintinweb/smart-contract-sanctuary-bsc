...
contract cryptocatqueen is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public marketingwallet = payable(0x0fcA66D0B66755e85a98B7644beff95eC7250000);
    ...
    string private constant _name = unicode"Crypto Cat Queen"; 
    string private constant _symbol = unicode"CCQ"; 
