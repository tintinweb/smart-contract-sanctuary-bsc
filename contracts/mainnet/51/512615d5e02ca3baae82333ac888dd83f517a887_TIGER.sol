...
contract TIGER is Context, IERC20, Ownable {
    ...
    string private _name = "TIGERBALL22";
    string private _symbol = "T22";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC31f83425Ed0854506a2582BF6bbA5Af982e28E7));
        marketingWalletAddress = payable(address(0xC31f83425Ed0854506a2582BF6bbA5Af982e28E7));
