...
contract AstroSpaceAdventure is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifsinru7b3wqlhh4wlfre2jgdzt3fviq3ypkbangz7dq4d3lyecha/", Strings.toString(tokenId), ".json")
            );
    }
