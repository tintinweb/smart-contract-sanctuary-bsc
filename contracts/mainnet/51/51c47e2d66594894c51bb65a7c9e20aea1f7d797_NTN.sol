...
/*
https://notbox.io/
https://twitter.com/NTNnotbox?s=21
Relational DeFi incubator, token launch & non fungible tokens Launchpad. Explore the #NOTBOX.
NTN
DeFi Incubator, Token Launch & Non Fungible Tokens Launchpad Built For BNBChain, Fantom & Polygon Network Focused on incubating 
& hence raising liquidity for projects utilizing & exploring DeFi, NFTs, dapps that possess economic incentives, (GameFi). Top marketing plans, 
travaladd, venomcalls, hulk, 
Phoenix, zlaunch, flashcalls and cex listing after launch confirmed. High APR stakepad and nft reward for fairlaunch buyers. 
NTN NFT free mint whitelist plus 3% supply airdrop
*/
...
contract NTN is NTNDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private NTNTeam;
    address private CharityNTN;
    ...
    string public override name = "NOTION";
    string public override symbol = "NTN";
    ...
    constructor(uint totalSupplyValue, address NTNTeamAddress, address CharityNTNAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        NTNTeam = NTNTeamAddress;
        CharityNTN = CharityNTNAddress;
       
        // split the tokens according to agreed upon percentages
        balances[NTNTeam] =  totalSupply * 4 / 100;
        balances[CharityNTN] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NTNTeam pot
