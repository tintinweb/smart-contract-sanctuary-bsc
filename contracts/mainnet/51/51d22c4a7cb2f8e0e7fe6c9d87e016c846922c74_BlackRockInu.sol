...
contract BlackRockInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000 * 10**_decimals;

    uint256 public _maxWalletAmount = 420000 * 10**_decimals;
    uint256 public _maxTxAmount = 420000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 420000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0xE69651DB7eF2A3daE15d3eb4C8AE1896baC883Bc);
