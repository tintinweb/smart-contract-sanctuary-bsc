...
/**
Telegram : Https://Telegram.me/Spkings

Spkings is a warrior princess endowed with the fortitude
...
contract Spkings is ERC20, Auth {
    ...
    string constant private _name = "SpainKing";
    string constant private _symbol = "Spkings";
    ...
    address private autoLiquidityReceiver = 0x47Ad6197cDf56869e908aB083DE9B9521519Ca74;
    address private MarketingFeeReceiver = 0x47Ad6197cDf56869e908aB083DE9B9521519Ca74;
    ...
    function setBMSpkings(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMSpkings(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
