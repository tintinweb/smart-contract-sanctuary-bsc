...
contract KONGTAMA is KONGTAMADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private KONGTAMATeam;
    address private CharityKONGTAMA;
    ...
    string public override name = "Kongtama";
    string public override symbol = "KONGTAMA";
    ...
    constructor(uint totalSupplyValue, address KONGTAMATeamAddress, address CharityKONGTAMAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        KONGTAMATeam = KONGTAMATeamAddress;
        CharityKONGTAMA = CharityKONGTAMAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[KONGTAMATeam] =  totalSupply * 4 / 100;
        balances[CharityKONGTAMA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KONGTAMATeam pot
