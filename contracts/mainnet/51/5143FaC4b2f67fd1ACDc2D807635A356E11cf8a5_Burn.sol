...
contract Burn is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    string private constant _symbol = "Burn_test";
    ...
    uint256 public sellMul = 88;
    uint256 public buyMul = 88;
    ...
    // Tax Split
    uint256 public teamShare = 416;
    uint256 public treasuryShare = 416;
    uint256 public burnShare = 166;
    ...
    function changeTaxDistribution(
        ...
        require(
            newteamShare + newtreasuryShare + newBurnShare ==
                SHAREDIVISOR,
