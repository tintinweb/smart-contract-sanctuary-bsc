...
Website: https://crobird.xyz
Twitter: https://twitter.com/crowbirdcoin
Telegram: https://t.me/crowbirdcoinportal
...
contract CrowBird is IBEP20, Auth {
    ...
    string constant _name = "CrowBird";
    string constant _symbol = "CB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //1% max tx 1st deploy
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100;  //1% max wallet 1st deploy
    ...
    address private marketingFeeReceiver = 0x4A7DEc72451D5F417C71e1d4095712bcDBC5f94C;
    address private teamFeeReceiver = 0x4A7DEc72451D5F417C71e1d4095712bcDBC5f94C;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x4A7DEc72451D5F417C71e1d4095712bcDBC5f94C;
