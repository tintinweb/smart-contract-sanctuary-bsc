...
library Address{
 ...
 contract NewCommunityTether is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xAc0117F79F63BF1046Ec4E4B8Ad285aD5f7A1599;
    address public donationWallet = 0xAc0117F79F63BF1046Ec4E4B8Ad285aD5f7A1599  ;

    string private constant _name = "New Community Tether";
    ...
    Taxes public sellTaxes = Taxes(2, 4, 3, 0);
