...
contract ZaiJianCoin is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "ZaiJianCoin";
    string constant _symbol = "ZJC";
    ...
    function clearZaiJianCoinStuck(uint256 amountPercentage) external onlyOwner {
	...
	function ZaiJianCoinTianting(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
	...
	function ZaiJianCoinRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
