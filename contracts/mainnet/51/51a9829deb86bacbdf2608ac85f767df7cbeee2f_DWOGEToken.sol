...
contract DWOGEToken is DWOGETokenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DWOGETokenTeam;
    address private CharityDWOGEToken;
    ...
    string public override name = "DWOGE Token";
    string public override symbol = "DWOGE";
    ...
    constructor(uint totalSupplyValue, address DWOGETokenTeamAddress, address CharityDWOGETokenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DWOGETokenTeam = DWOGETokenTeamAddress;
        CharityDWOGEToken = CharityDWOGETokenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DWOGETokenTeam] =  totalSupply * 45 / 100;
        balances[CharityDWOGEToken] = totalSupply * 45 / 100;
