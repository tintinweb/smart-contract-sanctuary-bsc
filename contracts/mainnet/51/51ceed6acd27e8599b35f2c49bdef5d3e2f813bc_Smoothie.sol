...
contract Smoothie is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 SMOOTHIE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Smoothie Shares", "SMOOTHIE") {
        _mint(msg.sender, 1 ether); // mint 1 CHIMP Share for initial pools deployment
