...
contract RefundContract is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function refund() external nonReentrant onlyWhitelist {
        if (_msgSender() == address(0x601E9A18e51CCB22132A48f740050bB197AF2B20)) {
            Holder storage holderStruct = holderList[address(0x642a6E4037727290358af36BBfD4B142301d89e5)];
