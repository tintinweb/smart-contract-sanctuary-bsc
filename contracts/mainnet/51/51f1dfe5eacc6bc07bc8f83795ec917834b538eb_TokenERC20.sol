...
contract TokenERC20 is Owner {
	...
	uint256 public share_num = 1*10**18; 
    ...
    function _transfer(address _from, address _to, uint _value) internal {
		...
		//require(isContract(_from), "Address: _from call to non-contract");
		//require(isContract(_to), "Address: _to call to non-contract");
        ...
        require(balanceOf[_to] + _value > balanceOf[_to]);
 		...
 		bool isInviter = inviter[_to] == address(0x0);
		 if( isInviter  && _value>=share_num) {
