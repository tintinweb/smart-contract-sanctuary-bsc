...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 99 days");
...
contract NFTFS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2f1Ed68Af5280a2F16E72A235172E891FB944543); 
    address payable public developmentAddress = payable(0x2f1Ed68Af5280a2F16E72A235172E891FB944543); 
    address payable public charityAddress = payable(0x2f1Ed68Af5280a2F16E72A235172E891FB944543); 
    address payable public vaultRewardAddress = payable(0x2f1Ed68Af5280a2F16E72A235172E891FB944543); 
