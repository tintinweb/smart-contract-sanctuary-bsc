...
contract kingflokiv3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Floki V3";
    string private _symbol = "KING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x254B70C12e928B9b45eA36f97F5a58BF5449729E);
    address payable public teamWalletAddress = payable(0xa241c82988a9dc098b83984BAB414b68f5f97090);
