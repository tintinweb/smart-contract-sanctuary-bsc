...
contract BTest22082022 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "BTest22082022";
    string private constant _symbol = "BTest22082022";
    ...
    constructor(address payable addr1, address payable addr2,address payable addr3 ) {
        ...
        _isExcludedFromFee[addr3] = FeeExcluded(true,true,true);
        ...
        _sellContractFee = 12;
        _sellBurn = 3; 
        _sellBoostFee = _sellContractFee.div(6); 

        // remaining 6% is boost dai 
        currentSellFee = 15;
        sellFeeEnabled = true;
       ...
       _buyContractFee = 8;
        _buyBurn = 2;
        _buyBoostFee = _buyContractFee.div(4); 
    ...
    function setBuyFee(uint256  _per ) external onlyOwner() {
        ...
        _buyContractFee = 4;
        _buyBurn = 1;
        _buyBoostFee = _buyContractFee.div(2); 
        
        // remaining 2% is boost dai 
    ...
    function setSellFee(uint256  _per ) external onlyOwner() {
        ...
        _sellContractFee = 8; 
        _sellBurn = 2;
        _sellBoostFee = _sellContractFee.div(4); 
