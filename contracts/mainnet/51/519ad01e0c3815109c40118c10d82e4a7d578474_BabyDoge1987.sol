...
/**
Telegram : https://t.me/babydoge1987
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75ac94f0B0D8eA6bBB47621fE7446f4c31cB0394; // owner address
...
contract BabyDoge1987 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Doge 1987";
    string private _symbol = "BabyDoge87";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3E8a83E0E451aA7c8Fa11902550f2b6F3e20F6ac); // Marketing Address
    address payable public teamWalletAddress = payable(0x75ac94f0B0D8eA6bBB47621fE7446f4c31cB0394); // Team Address
