...
contract EPIGGY is ERC20, Ownable {
    ...
    address public marketingWallet = 0x3e73Cc5A0c972148eAb75c344a2d259b167C6427;
    address public newOwner = 0xadE23195Ee857703e685A64416856A11c06aa239;
    ...
    constructor() ERC20("EPIGGY", "EPIGGY") 
    {
    	...
    	dividendTracker = new DividendTracker(100000000 / 50000, rewardToken);
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 10 && _sellFee <= 15, "Fees must be less than sell 15% and Buy 10%");
        buyFee = _buyFee;
        sellFee = _sellFee;
        emit FeesUpdated(buyFee, sellFee);
    }

    function updateFeeShares(uint256 _marketingFeeShare, uint256 _rewardShare) external onlyOwner {
        require(_marketingFeeShare  + _rewardShare == 100, "Fee shares must add up to 100");
    ...
    function enableTrading() external onlyOwner {
        require(launchTime == 0, "Trading already enabled");
    ...
    function setAntibotStatus(bool _antibotEnabled) external onlyOwner {
        require(
            ...
            !_antibotEnabled,
            "Cannot enable antibot 1 day after launch"
        );
    ...
    function _transfer(
        ...
        if (antibotEnabled && launchTime > 0 &&
