...
contract GOOSE is Context, IERC20, Ownable {
    ...
    string private _name = "Goose Inu";
    string private _symbol = "Goose Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0119ad096d919d8d0Ebb5eC18B2A7BFcb8bFD51B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0119ad096d919d8d0Ebb5eC18B2A7BFcb8bFD51B); // BuyBack Address
