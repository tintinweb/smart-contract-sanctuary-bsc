...
contract NewTokenEth is Context, IERC20, Ownable {
    using SafeMath for uint256;
	...
	function getHuLuWaFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
	...
	function swapHuLuWaFee(address _token, uint256 tokens) private  {
