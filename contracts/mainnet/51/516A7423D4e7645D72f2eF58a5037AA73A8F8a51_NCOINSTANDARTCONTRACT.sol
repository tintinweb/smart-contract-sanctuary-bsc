...
contract NCOINSTANDARTCONTRACT is Context, IERC20, Ownable {
    ...
    address payable private C_WalletAddress = payable(0xB3fdce183ceCDCa44ae00A9B7bfb100b6e2e4978);
    ...
    uint256 private minMaxTxWallet = _totalSupply * 1/100;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
        require((newLiquidityTax + newMarketingTax) <= maxPossibleFee, "Fee is too high!");
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= minMaxTxWallet, "Set Max TX between 1% - 100% of total supply");
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= minMaxTxWallet, "Set Max Wallet between 1% - 100% of total supply");
        _walletMax  = newLimit;
    }
