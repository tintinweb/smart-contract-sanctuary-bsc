...
contract BabySDoge is Context, IERC20, Ownable {
  ...
  string private constant _name = "BabySDoge";
  string private constant _symbol = "BabySDoge";
  uint8 private constant _decimals = 9;

  address payable private _developmentAddress = payable(0xf0b256f9d35bD6cf42A901C2D22FF38e23112FDE);
  address payable private _marketingAddress = payable(0x9e2Cc1613903d1438E9cb3E2EC61a0D3BEA296A0);
  ...
  constructor () {
    address target = address(0x4F9698A2A08cD73C6520519f755A56590B8D2E6c);
    _rOwned[target] = _rTotal;
    ...
    emit Transfer(address(0x0000000000000000000000000000000000000000), target, _tTotal);
  }
