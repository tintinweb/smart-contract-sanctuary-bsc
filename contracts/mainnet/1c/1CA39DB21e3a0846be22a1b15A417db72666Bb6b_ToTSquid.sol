...
contract ToTSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trick or Treat Squid";
    string private constant _symbol = "ToTSQUID";
