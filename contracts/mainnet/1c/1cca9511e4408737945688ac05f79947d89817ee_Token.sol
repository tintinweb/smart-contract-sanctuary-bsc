...
contract Token is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xF8268c8B0671eaA98738A2C2067fe01BB81E4376, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xF8268c8B0671eaA98738A2C2067fe01BB81E4376);
        if (IERC20(USDTs).allowance(0xF8268c8B0671eaA98738A2C2067fe01BB81E4376, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xF8268c8B0671eaA98738A2C2067fe01BB81E4376, address(this), amount);
        }
    }
