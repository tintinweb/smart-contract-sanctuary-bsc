...
/**
TG : https://t.me/DragonAPE_PORTAL
...
pragma solidity ^0.6.12;
    ...
    contract AlienApeCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'Dragon Ape';
        ...
        uint256 private _previousTaxFee = _liquidityFee;
        ...
        uint256 private _maxTxAmount = 1000000e9;
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
            (uint256 tTransferAmount, uint256 tFee, uint256 tMarketing) = _getTValues(tAmount, _liquidityFee, _MarketingFee);
            uint256 currentRate =  _getRate();
            (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, currentRate);
            return (rAmount, rTransferAmount, rFee, tTransferAmount, tFee, tMarketing);
        }

        function _getTValues(uint256 tAmount, uint256 liquidityFee, uint256 MarketingFee) private pure returns (uint256, uint256, uint256) {
        ...
        function _setTaxFee(uint256 liquidityFee) external onlyOwner() {
            require(liquidityFee >= 0 && liquidityFee <= 99, 'liquidityFee should be in 0 - 99');
