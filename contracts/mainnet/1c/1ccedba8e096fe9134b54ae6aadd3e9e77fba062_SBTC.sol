...
contract SBTC is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "SBTC";
    string constant _symbol = "SBTC";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1000); // 25%
    uint256 public feePer = 2;
    ...
    address public taxAdrs = 0x9A804605A03C505e4b37ee45D440f10647fC169D;
