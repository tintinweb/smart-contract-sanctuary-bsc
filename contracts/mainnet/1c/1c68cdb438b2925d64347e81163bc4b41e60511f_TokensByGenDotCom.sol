...
To check if a team completed our KYC Audit visit https://tokensbygen.com/kyc/
Teams may choose to use other auditing services, please check their website for details.

What is KYC?

KYC stands for 'Know Your Customer' our KYC auditing service collects information about the team, including proof of address,
official photo ID, live video footage, proof of developer wallet ownership, IP address, background checks and more. 

If a token created by a team that we have collected data on is involved in a scam, we will release this data to anybody that 
wants to press criminal charges against the team, if we believe that the data submitted to support the claim of a scam is sufficient.
