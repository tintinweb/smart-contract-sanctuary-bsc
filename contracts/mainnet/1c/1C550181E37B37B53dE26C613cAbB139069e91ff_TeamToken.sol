...
contract TeamToken is Context, IERC20, Ownable {
    ...
    string private _name = "sishen";
    string private _symbol = unicode"sishen";
    ...
    uint256 private _maxTxAmount = 5000000 * 10**_decimals;
    uint256 private _maxWalletSize = 4000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x000000000000000000000000000000000000dEaD));
        marketingWallet = payable(address(0x000000000000000000000000000000000000dEaD));
