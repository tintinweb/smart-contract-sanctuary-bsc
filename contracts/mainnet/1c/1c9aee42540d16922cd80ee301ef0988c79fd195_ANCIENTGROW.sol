...
/** ------ Marin Kitagawa Calls Team ----- ANCIENT GROW
 *Submitted for verification at BscScan.com on 2022-08-03
*//*https://t.me/AncientGrowPortal
...
contract ANCIENTGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANCIENT GROW";
    string private constant _symbol = "$AGROW";
    ...
    address private marketingWallet = address(0xDA0ff00Bd899D4f7Bf338E3dDa2a43aA1d238bA9);
    address private liquidityReceiver = address(0x6bcf782e52736839eb612e9C51901320a3F43818);
