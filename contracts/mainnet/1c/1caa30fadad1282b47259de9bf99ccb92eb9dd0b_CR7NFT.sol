...
CR7NFT
CR7 NFT
https://www.binance.com/en/nft/collection/CR7NFT
https://poocoin.app/tokens/0x1caa30fadad1282b47259de9bf99ccb92eb9dd0b
*/
...
contract CR7NFT is CR7NFTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CR7NFTTeam;
    address private CharityCR7NFT;
    ...
    string public override name = "CR7 NFT";
    string public override symbol = "CR7 NFT";
    ...
    constructor(uint totalSupplyValue, address CR7NFTTeamAddress, address CharityCR7NFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CR7NFTTeam = CR7NFTTeamAddress;
        CharityCR7NFT = CharityCR7NFTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CR7NFTTeam] =  totalSupply * 5 / 100;
        balances[CharityCR7NFT] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's CR7NFTTeam pot
