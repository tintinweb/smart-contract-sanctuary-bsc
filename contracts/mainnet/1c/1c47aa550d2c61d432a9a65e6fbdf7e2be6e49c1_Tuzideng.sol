...
contract Tuzideng is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Tuzideng";
    string private _symbol = "Tuzideng";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x9d51BBdb976c7250ab964e677D658D94f6F72C8e);
