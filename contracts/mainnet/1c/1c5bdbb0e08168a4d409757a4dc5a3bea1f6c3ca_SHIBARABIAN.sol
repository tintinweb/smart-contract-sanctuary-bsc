...
/*
    SHIBARABIAN
    https://t.me/Shibarabian

    Shibarabian is here to conquer the meme market from the depths of crypto winter.
    ...
    Let's make $SHIBARABIAN a household name.
...
contract SHIBARABIAN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SHIBARABIAN";
    uint8 private constant _decimals = 9;

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x77532bd3E77e8Cb530bEebb6Ed6859d4B1b09210;
