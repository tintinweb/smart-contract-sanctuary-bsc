...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x427643F6197b1c262707147469D5010bcd74FBF4;
...
contract KakaFanToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAKA FAN TOKEN";
    string private _symbol = "KAKA10"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3050c67E617f1BC984e8e999090764908f739579); // Marketing Address
    address payable public teamWalletAddress = payable(0x427643F6197b1c262707147469D5010bcd74FBF4); // Team Address
