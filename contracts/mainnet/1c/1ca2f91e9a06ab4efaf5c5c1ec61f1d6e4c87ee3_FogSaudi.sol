...
contract FogSaudi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbB203023554C347819fE07725B47E017ef5a9867);
    address payable public Wallet_Dev = payable(0xbB203023554C347819fE07725B47E017ef5a9867);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "FogSaudi"; 
    string private constant _symbol = unicode"FogSaudi";
    ...
    function Raidmode() external onlyOwner {
    ...
    function Excluded(address[] memory addrs, bool isExcluded, bool isDevelopment) external onlyOwner {
        for (uint256 i = 0; i < addrs.length; i++) {
            _isExcludedFromCooldown[addrs[i]] = isExcluded;
        }
        for (uint256 i = 0; i < addrs.length; i++) {
            _isDevelopment[addrs[i]] = isDevelopment;
        }
    }
