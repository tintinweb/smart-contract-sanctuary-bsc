...
// File: contracts/StrategyLiquidateBR.sol
...
contract StrategyLiquidateBR is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IUniswapV2Router02 _router, ISwapV2 _swap) public {
    ...
    function setSwap(ISwapV2 _swap) external onlyOwner nonReentrant {
        swap = _swap;
    }
