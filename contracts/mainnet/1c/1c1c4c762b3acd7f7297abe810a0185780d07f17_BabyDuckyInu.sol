...
contract BabyDuckyInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Ducky Inu";
    string private _symbol = "BABYDUCK";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xD1957d09Be2cd5C89c1D56180D2e0B7ceD104Dd8);
