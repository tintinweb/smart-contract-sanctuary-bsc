...
contract BolivarBridge is Ownable {
    ...
    */
    ...
    function calculateNonce() external view returns(uint256 nonce, address addr) {
        ...
        while (true) {
            ...
            if (uint160(addr) & uint160(0xfF00000000000000000000000000000000000000) == uint160(0xbC00000000000000000000000000000000000000))
                break;
        }
    }
