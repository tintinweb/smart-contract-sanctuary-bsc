...
contract SFN is Context, IERC20, Ownable {
    ...
    string private _name = "SFN";
    string private _symbol = "SFN";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xC06ba7Ca5A5E5CCe54Cd653cc54daCa19e37c614);
    address payable public lpWallet = payable(0xC06ba7Ca5A5E5CCe54Cd653cc54daCa19e37c614);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(tradingOpen || isExcludedFromFee[sender] || isExcludedFromFee[recipient], "Trading is not open yet");
