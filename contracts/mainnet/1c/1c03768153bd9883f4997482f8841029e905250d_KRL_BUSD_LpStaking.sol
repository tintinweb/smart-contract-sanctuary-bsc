...
/* Renewable Pool Contract for https://kryptolite.rocks
*  Twitter: https://twitter.com/KryptoliteSwap
*  Telegram News: https://t.me/KryptoliteNews
*  Telegram Chat: https://t.me/KryptoliteCommunity
*/
...
contract KRL_BUSD_LpStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // The block number when $WAGMI mining ends.
    uint256 public bonusEndBlock;

    // The block number when $WAGMI mining starts.
    ...
    // $WAGMI tokens rewarded per block.
    ...
    */
    ...
    function updateRewardPerBlock(uint256 _rewardPerBlock) external onlyOwner {
		...
		require(block.number < bonusEndBlock, "Rewards have not been stopped");
