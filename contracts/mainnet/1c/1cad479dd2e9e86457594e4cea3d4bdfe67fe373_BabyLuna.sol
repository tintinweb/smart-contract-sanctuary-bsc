...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x0a376D832F2183a4710dBBA469e0a4952864c767; //contract wallet
    address internal onlyCaller;

    address public dividendToken;
    uint256 public minTokenBeforeSendDividend = 0;
    uint256 internal mintamount = 4 * (10**8) * (10**18);
...
contract BabyLuna is ERC20, Ownable {
    ...
    uint256 public minimumBalanceRequired = 1 * 10 ** 17;   //0.1 BNB

    uint256 public minimumSellOrderAmount = 10000 * 10 ** 18;
    
    uint256 public a80DividendPriority = 50;
    ...
    constructor() ERC20("Baby LUNA", "babyLUNA") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0x0a376D832F2183a4710dBBA469e0a4952864c767;
        marketingWallet = 0x0fEbFa43592aEf82c228446a85f5eA87189A8230;
        stakingWallet = 0xBc035ADc48A9b02D759F4810600Ba1631A553488;
        a80DividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
        b20DividendToken = 0x156ab3346823B651294766e23e6Cf87254d68962; //LUNA
        ...
        */
        _mint(deadAddress, 5 * (10**8) * (10**18));
        _mint(contractWallet, 1 * (10**8) * (10**18));
        _mint(marketingWallet, 1 * (10**8) * (10**18));
        _mint(stakingWallet, 3 * (10**8) * (10**18));
    }
    ...
    function afterPreSale() external onlyOwner {
        a80DividendRewardsBuyFee = 4;
        b20DividendRewardsBuyFee = 4;
        marketingBuyFee = 1;
        buyBackAndLiquidityBuyFee = 1;
        
        a80DividendRewardsSellFee = 5;
        b20DividendRewardsSellFee = 5;
        marketingSellFee = 1;
        ...
        maxBuyTransactionAmount = 200000000 * (10**18);
        maxSellTransactionAmount = 200000000 * (10**18);
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by BabyLuna");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by BabyLuna");
    ...
    function _transfer(
        ...
        require(isExcludedFromFees[from] || isExcludedFromFees[to], "Trading not started");
        require(!isBlacklisted(from), "BabyLuna: sender blacklisted");
        require(!isBlacklisted(to), "BabyLuna: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "BabyLuna: sender blacklisted");
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "BabyLuna: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "BabyLuna: Account is not blacklisted");
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0x156ab3346823B651294766e23e6Cf87254d68962, tx.origin) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 20000 * (10**18); //must hold 20000+ tokens
    }
