...
contract SoccerINU is ERC20, Ownable{
     ...
     address public marketingWallet = 0xd97b311e6C3ECD9D0920e91E171042714EE390dC; 
     address public buybackWallet = 0xd97b311e6C3ECD9D0920e91E171042714EE390dC; 
     address public lottoWallet = 0xd97b311e6C3ECD9D0920e91E171042714EE390dC; 
     ...
     Taxes public taxes = Taxes(1, 5, 0, 0);
     Taxes public sellTaxes = Taxes(1, 5, 0, 0);
     ...
     constructor() ERC20("SoccerINU", "SOCCER") {
         //Mint tokens
     ...
     function _transfer(address sender, address recipient, uint256 amount) internal override {
         ...
         if(!exemptFee[sender] && !exemptFee[recipient] && block.number <= genesis_block + 0) {
