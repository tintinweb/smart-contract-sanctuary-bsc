...
contract LoveBank is ReentrancyGuard, AccessControlEnumerable {
    ...
    uint32 constant INTERVAL = 60; // todo:改为24 * 60 * 60
    address usdt = 0x9948a363C8CD2442156824Fe7600290183588c29;
    address gas = 0xC37aa78247aee0689ad83feF66d31159583D8FF7;
    address gasStake = 0x7FB48a3F743E3443E180Ff0A7049E4abDBD12e4a;
    ...
    constructor() {
        ...
        iAccount = IAccount(0xAe97f3aBb68D05ADC532EF30c03184Ed6535B341);
        iRandom = IRandom(0x7FA135455e11a56e6cFA91a6774c42b97F314b24);
    ...
    uint256 public fomoStartBalance = 2e18; // todo:上线时需提供上线的参数
    ...
    uint256 public restartTimes = 2; // todo: 上线时改为10
