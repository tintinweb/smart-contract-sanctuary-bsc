...
contract DogeBagInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xbAE18be3771880883e77E430a0779de01B837a0B;
    address public devWallet = 0xbAE18be3771880883e77E430a0779de01B837a0B; 
    address public operationWallet = 0xbAE18be3771880883e77E430a0779de01B837a0B;
    address public charityWallet = 0xbAE18be3771880883e77E430a0779de01B837a0B; 

    string private constant _name = "DogeBag Inu";
    string private constant _symbol = "DBAG";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 2, 0, 0, 0);
