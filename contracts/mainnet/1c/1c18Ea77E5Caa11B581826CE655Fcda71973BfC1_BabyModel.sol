...
contract BabyModel is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyModel";
    string private _symbol = "BabyModel";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa2497C81b35362944BB44856425B92E628736Bd8);
    address payable public teamWalletAddress = payable(0xa2497C81b35362944BB44856425B92E628736Bd8);
