...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60e2E2ABD1646d99952ea82Dfe4E84D058Cde074; // owner address
...
contract Toy is Context, IERC20, Ownable {
    ...
    string private _name = "Toy INU";
    string private _symbol = "$TINU"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60e2E2ABD1646d99952ea82Dfe4E84D058Cde074); // Marketing Address
    address payable public teamWalletAddress = payable(0x60e2E2ABD1646d99952ea82Dfe4E84D058Cde074); // Team Address
