...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30AF6825247222af4B062ee3e9ecEF32aA5C6E52;
...
contract HighClassRaffleToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0d82322D1731ce805Cd0CE6C3e4aA973a7Ef1191;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "High-Class Raffles Token";
    string private _symbol = "HCR";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 1000;
