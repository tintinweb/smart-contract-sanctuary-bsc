...
/**
    ...
    # METAHAREbsc features:
   ⤏ 2% fee auto added to the liquidity pool every transaction
   ⤏ 4% to Marketing wallet for buyback 
...
contract METAHAREBSC is Context, IERC20, Ownable {
    ...
    string private _name = "META HARE";
    ...
    address public marketingWallet = 0xA3AfC368843ae59f7B9C80bd873B4f9d5433Ae8A;
