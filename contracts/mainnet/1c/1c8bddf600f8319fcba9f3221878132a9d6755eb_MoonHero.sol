...
https://t.me/MoonHeroBSC

ZEROOOOOOOOOOOOOOOOOOOOO PERCENT TAX, 10,000X MOONSHOT!!!

MoonHero is project that is created on the Binance Smart Chain which is formed to deliver a solid MOON MISSION with ZERO PERCENT TAX on both Buys and Sells.

Also a Project fully backed by its Community, we believe in Unity.
...
contract MoonHero  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'MoonHero';
    string private constant _symbol = 'MoonHero';
    ...
    //MoonHero is destined to be a no tax MoonShot!
}