...
contract USSOPINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "USSOP INU";
    string private _symbol = "USSOINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7114e68D7dB05b00E648fEC313F2014ED1063a74);
