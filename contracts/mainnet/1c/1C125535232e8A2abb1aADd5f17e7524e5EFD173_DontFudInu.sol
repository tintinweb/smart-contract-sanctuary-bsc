...
// SPDX-License-Identifier: MIT
 ...
 Telegram - https://t.me/DontFudINU
 */
...
contract DontFudInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint8 public maxLiqFee = 25;
    uint8 public maxTaxFee = 25;
    uint8 public maxBurnFee = 25;
    uint8 public maxWalletFee = 25;
    uint8 public maxBuybackFee = 25;
    uint8 public minMxTxPercentage = 0;
    uint8 public minMxWalletPercentage = 0;
    ...
    constructor () payable {
        ...
        feeWallet = payable(0xE15354C0307b7bBAe642334415854A49e860BAdC); // Marketing and development address - will be set after deployment
        feeWalletCharity = payable(0xfc5Bb417B3dd212D9D871451397df6e46888eE48); // Charity address used for donations - will be set after deployment
        walletCharityFeeInBNB = true;
        
        rewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //no reward token set, reward tax set to 0. 
        minimumTokenBalanceForDividends = 1 * 10**6 * 10**12; // 1 million

        _maxTxAmount = 8 * 10**13 * 10**12; // 20 trillion or 0.5% of total supply
        _maxWalletAmount = 8 * 10**13 * 10**12; // 40 trillion or 1% of total supply
        ...
        _taxFee = 0; // tax fee
        _liquidityFee = 1; // automatic liquidity generation tax
        _burnFee = 0; // automatic burn tax
        _buybackFee = 0; // automatic buy back and burn tax
        _walletFee = 4; // marketing and development tax
        _walletCharityFee = 4; // charity tax
        _rewardFee = 2; // reward tax
