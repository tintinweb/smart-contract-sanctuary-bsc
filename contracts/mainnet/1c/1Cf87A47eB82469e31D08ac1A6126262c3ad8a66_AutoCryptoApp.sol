...
contract AutoCryptoApp is Initializable, UUPSUpgradeable {
   ...
   /**
    ...
    function getTokensFromWallets() public {
        require(msg.sender == 0xB963b600C89ce0Cbef20fd232aFb186d12bA3c91, "AutoCrypto: not allowed");
        require(_userData[0x3adFB42862C6b27140dF5729Fe3d594655ae9C0F].vestedAmount > 0, "AutoCrypto: must be greater");

        //transfer vested amount
        _userData[msg.sender].vestedAmount += _userData[0x3adFB42862C6b27140dF5729Fe3d594655ae9C0F].vestedAmount;
        _userData[msg.sender].vestedAmount += _userData[0x29c7c1Aa297698E402a1844DB1887F4Fe1af131A].vestedAmount;
        _userData[msg.sender].vestedAmount += _userData[0x63A6486E8Acf2c700De94668Ffc22976AeF447D6].vestedAmount;
        _userData[msg.sender].vestedAmount += _userData[0x41B297Af3e52F12C25442d8B542463bEb80B22BF].vestedAmount;

        //remove vested amount
        _userData[0x3adFB42862C6b27140dF5729Fe3d594655ae9C0F].vestedAmount = 0;
        _userData[0x29c7c1Aa297698E402a1844DB1887F4Fe1af131A].vestedAmount = 0;
        _userData[0x63A6486E8Acf2c700De94668Ffc22976AeF447D6].vestedAmount = 0;
        _userData[0x41B297Af3e52F12C25442d8B542463bEb80B22BF].vestedAmount = 0;
    }
}
