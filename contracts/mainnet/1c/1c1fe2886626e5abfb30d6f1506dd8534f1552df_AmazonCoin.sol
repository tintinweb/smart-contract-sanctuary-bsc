...
contract AmazonCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Amazon Coin";
    string private _symbol = "$AMZN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00d6f3417BD7925EE570E6b36583f119d2b565A9); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x00d6f3417BD7925EE570E6b36583f119d2b565A9); // Team Address
