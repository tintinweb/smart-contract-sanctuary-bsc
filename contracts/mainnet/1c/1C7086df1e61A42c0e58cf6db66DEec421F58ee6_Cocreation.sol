...
contract Cocreation is Ownable, IBEP20 {
    ...
    address private pancakeRouterAddr =0x10ED43C718714eb63d5aA57B78B54704E256024E;
                                                                                                                    address public marketing = 0xD39Df93D25b97383D9d86352BeBda6897FE2B464; 
    uint256 public buyFeeToDifidend = 1;
                                                                                                                    uint256 public buyFeeToMarketing = 1;
    uint256 public buyFeeToInviter = 0;
                                                                                                                    uint256 public sellFeeToDifidend = 1;
    uint256 public sellFeeToMarketing = 3;
                                                                                                                    uint256 public sellFeeToInviter = 0;
    uint256 public feeToLpDifidend = 2;
    ...
    bool public firstadd = false;
                                                                                                                     ...
                                                                                                                     _symbol = "YILOOG";
                                                                                                                     _decimals = 18;
                                                                                                                     _totalSupply = 1000000000000 * (10**18); //总供应量
        ...
        _exemptFee[pancakeRouterAddr] = true;
                                                                                                                     amountToStopBurn = _totalSupply.div(100000000); 
                                                                                                                     amountToAddLiquidity = _totalSupply.div(100000); 
                                                                                                                     amountTodifidend = _totalSupply.div(5000000); 
                                                                                                                     amountToDifidendWBNB = _totalSupply.div(50000); 
