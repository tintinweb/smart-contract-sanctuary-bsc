...
/*
Avatar Inu - Stealth Launch

Website DAPP: https://www.avatarinu.gg/
Twitter: https://twitter.com/avatarinucoin
Telegram: https://t.me/avatarinucoin

Avatar Inu Jackpot Wars: 
Event incurs when volume slows down with a Huge Jackpot Fund. Main idea is to pause the Fund from being drained in low activity 
hours + reserve the Funds for an event which will create hype! Jackpot will be paused until the Jackpot Wars start (scheduled). 
Big Bang will be raised to 10 BNB. Min Buy will be set at 0.5 BNB for every 5 Minutes. If for 5 minutes, no buys at least 0.5 BNB are recorded, 
the last buyer will receive 50% of the entire Jackpot Fund. This will drive EXTREME BUY PRESSURE AND MOMENTUM!

Avatar Inu Big Bang Jackpot Event:
The Jackpot is fed through taxes. If it reaches 8 BNB, the Jackpot will immediately cash out 4 BNB to the buyback wallet. 
This initiates the BIG BANG PROTOCOL: 4 BNB Worth of Tokens bought back and burned! The remaining 4 BNB stays in the jackpot and the games continue 
(may create more momentum and buying pressure for continuous big bangs)
*/
...
contract AvatarInu is Context, IERC20, Ownable {
    ...
    // We don't add to liquidity unless we have at least 1 token
        ...
        )
    {
        ...
        // Either 0 or 1+ Token to prevent PCS errors on liq swap
