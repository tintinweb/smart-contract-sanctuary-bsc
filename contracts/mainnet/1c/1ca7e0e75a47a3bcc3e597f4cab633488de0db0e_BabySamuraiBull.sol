...
/**
   #SBULL The New Community of Ape Token
    
   I make this #SBULL to hand it over to the community.
   I suggest a Telegram group name for you to create: Baby Samurai Bull is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/BabySamuraiBull
...
contract BabySamuraiBull is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Samurai Bull";
