...
contract EternalCakesStaker is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    address public DISTRIBUTOR = 0x453b2d84d9A9520a91f8Ee4C0B7DcBEB0BB58e23; // Mock distributor for testing
    ...
    uint public BOOSTER_DURATION = 7 days;
    ...
    function stakeInBooster(uint amount) private {
        IFarmBoosterProxy(FARM_BOOSTER_PROXY).deposit(amount, 0);
    }
    ...
    function compound() public {
        ...
        IBEP20(TOKEN).transfer(DISTRIBUTOR, forDistribution);
    ...
    // requires this contract to have some CAKE >= amount and also it should be approved 
