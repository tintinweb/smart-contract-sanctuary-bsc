...
/**
Welcome to BabyLeveInvest TOKEN!
...
contract BabyLeveInvest_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Leve Invest";
    string private constant _symbol = "BLEVE";
