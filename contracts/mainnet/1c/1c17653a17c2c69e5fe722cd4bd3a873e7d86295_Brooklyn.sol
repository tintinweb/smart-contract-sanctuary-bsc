...
contract Brooklyn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brooklyn";
    string private _symbol = "BROOKLYN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5B3d5E7DF2CE75AEfE8d7c01E9aD503f37ce122c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5B3d5E7DF2CE75AEfE8d7c01E9aD503f37ce122c); // BuyBack Address
