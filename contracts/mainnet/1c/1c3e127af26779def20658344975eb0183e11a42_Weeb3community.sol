...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72646e0C37D4Dd8e3998531d2A7c15648dB624D1; // owner address
...
contract Weeb3community is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Weeb 3 Community";
    string private _symbol = "Weeb 3 Community";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E6ec20aa921994f812064820b9a01C2F7f2d307); // Marketing Address
    address payable public teamWalletAddress = payable(0x6E6ec20aa921994f812064820b9a01C2F7f2d307); // Team Address
