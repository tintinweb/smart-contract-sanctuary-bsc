...
contract BabyDNT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDNT";

    string private _symbol = "BabyDNT";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x43cF538C82d124A791FABd006F275f0455F37812;
    ...
    uint256 public _totalSupply =  300200100 * 10**_decimals;
