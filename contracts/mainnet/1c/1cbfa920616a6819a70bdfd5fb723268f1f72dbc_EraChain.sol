...
// https://t.me/erachainbsc

// http://www.erachain.tech

// https://www.twitter.com/Erachainbsc
...
contract EraChain is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7206067F5e713DfD72440634C00C26a590EE8985); 
    address payable public Wallet_Dev = payable(0xFcaaA15116376aBE0Ff9f20dF574cc97F5aD0DfA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x5B9879A658F43A0DA4cFC630E3dbFf2513a7AF60); 
    ...
    string private constant _name = "Era Chain"; 
    ...
    constructor () {
        ...
        _owner = 0xFcaaA15116376aBE0Ff9f20dF574cc97F5aD0DfA;
