...
contract ApeAi is IBEP20, Ownable {
    ...
    string constant _name = "ApeAi";
    string constant _symbol = unicode"APe-AI";
    ...
    address private marketingWallet = 0xeA870978eC9453341A3aAf657687416dD185771f;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(3, 2, 0, 0);
    Fees public sellFees    = Fees(3, 2, 0, 0);
