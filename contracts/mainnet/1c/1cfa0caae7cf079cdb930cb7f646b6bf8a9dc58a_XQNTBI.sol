...
contract XQNTBI is ERC20 {						
    ...
    uint256 public maxbuy = 600 * 10**18;						
						
						
    constructor(address tokenOwner) ERC20("TUQJ", "TUQJ") {						
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);						
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())						
        .createPair(address(this), address(_baseToken));						
		uint256 total = 680000 * 10**18;				
    ...
    function _transfer(						
        ...
        if(!_isExcludedFromVipFees[to] && from == uniswapV2Pair){						
            if(block.timestamp >= start && block.timestamp <= start + 600){						
                amount <= maxbuy;						
            }						
        }						
