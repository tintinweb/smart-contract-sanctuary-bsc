...
contract deneme29394 is Context, IBEP20, Ownable {
    ...
    string private _name = "Denememaxss";
    string private _symbol = "dmaxs";
...
constructor (uint256 o2OneFee, uint256 o2TwoFee, uint256 cO2OneFee, uint256 cO2TwoFee, uint256 cO2ThreeFee,
    ...
    function _takeBuyFee(address sender, uint256 amount) private returns (uint256) {
        ...
        if(_O2TwoFee != 0){
            ...
            _transferStandard(sender, _O2OneWalletAddress, O2TwoAmt);
        }
        _taxFeeAmount = taxAmt;
        return amount.sub(_O2OneFee).sub(_O2TwoFee);
    }
