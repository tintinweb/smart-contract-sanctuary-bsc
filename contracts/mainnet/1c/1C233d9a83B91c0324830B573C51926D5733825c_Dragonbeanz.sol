...
---*Telegram: t.me/dragonbeanz
    Twitter:   twitter.com/dragonbeanz
*/
...
contract Dragonbeanz is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dragon Bean Z";
    string constant _symbol = "DBZ";
