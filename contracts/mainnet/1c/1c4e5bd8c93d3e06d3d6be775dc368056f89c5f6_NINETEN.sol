...
contract NINETEN is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 913 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 10 * 10**_decimals;

        fundAddress = 0xfB4eEcfA012A66D6B6cf86260067b2C78d85823d;
        devAddress = 0xfB4eEcfA012A66D6B6cf86260067b2C78d85823d;
