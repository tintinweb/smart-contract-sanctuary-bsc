...
contract MBB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta Baby Bezos";
    string private _symbol = "MBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39672E21117290293B38E000D1F77AC3BaFE4D83); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6e5F447062F05175c1458c70Ed21A3Ea42E41075); // buyback Address
    ...
    uint256 public _extraFeeOnSell = 14; 
    ...
    uint256 public _walletMax = 40000000000000 * 10**9; // 2%
