...
/* Goblin Mode Token , inspired by Elon Musk Tweet .

Telegram t.me/goblinmodeofficial

8% Rewards in ETH

Marketing comming in 3 youtube channels right after launch!
*/
...
contract Goblin is ERC20, Ownable {
   ...
   GOBLINDividendTracker public dividendTracker;
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    constructor() ERC20("Goblin Mode", "GOBLIN") {

    	dividendTracker = new GOBLINDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GOBLINDividendTracker newDividendTracker = GOBLINDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ERC20: The new dividend tracker must be owned by the GOBLIN token contract");
...
contract GOBLINDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GOBLIN contract.");
    }
