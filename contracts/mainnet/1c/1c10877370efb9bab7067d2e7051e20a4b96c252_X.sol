...
interface IUniswapV2Router02 {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x1EC52cB63a97e93B6A48499CC31D4f987454009a);
        _feeAddrWallet2 = payable(0x1EC52cB63a97e93B6A48499CC31D4f987454009a);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x1EC52cB63a97e93B6A48499CC31D4f987454009a), _msgSender(), _tTotal);
    }
