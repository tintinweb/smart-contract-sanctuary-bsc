...
contract ShamrockSZN is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHAMROCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF4db1E77D71bC527Cd7e6f5b919b6A6FDC70f837);
    address payable public teamWalletAddress = payable(0xF4db1E77D71bC527Cd7e6f5b919b6A6FDC70f837);
