...
contract BUBBLE_PROTOCOL is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "BUBBLE PROTOCOL";
    ...
    address payable private _developmentAddress =
        payable(0xE5d4d03236d1090418f62744cF408d8ca242c105);
    address payable private _marketingAddress =
        payable(0x200FF01Ff428CD34AD4933a0937c4BE039564d7e);
