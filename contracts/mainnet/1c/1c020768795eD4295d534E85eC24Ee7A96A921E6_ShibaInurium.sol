...
contract ShibaInurium is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2184B3ED57D87e77bAE6A6e8d26A2408b56D9204); 
    address payable public Wallet_Dev = payable(0x2184B3ED57D87e77bAE6A6e8d26A2408b56D9204);
    ...
    string private constant _name = "Shiba Inurium"; 
    string private constant _symbol = unicode"SHIBAIRIUM"; 
    ...
    constructor () {
        ...
        _owner = 0x2184B3ED57D87e77bAE6A6e8d26A2408b56D9204;
