...
TG portal https://t.me/BabFlokiGrow
...
contract BabFlokiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Floki Grow";
    string private constant _symbol = "BabyFlokiGrow";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000 * 10**_decimals;

    uint256 public _maxWalletAmount = 300* 10**_decimals;
    uint256 public _maxTxAmount = 300* 10**_decimals;
    uint256 public swapTokenAtAmount = 300 * 10**_decimals;
    ...
    address private marketingWallet = address(0x7f0F6a8bc7a506B0C4ed64533f053f0C3D60904a);
    address private liquidityReceiver = address(0x7f0F6a8bc7a506B0C4ed64533f053f0C3D60904a);
