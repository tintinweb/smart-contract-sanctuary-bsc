...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract CROKIGOLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Croki Gold";
    string private _symbol = "CROKI GOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B81024cD1b2F0d027C54A2076f68bACbdE5169B);
    address payable public devWalletAddress = payable(0xC0d41Cb60efDc035f42cFee8E36C2d2f3Ca1D4d1);
