...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new DogeBNBUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DogeBNBUser1155Token token = DogeBNBUser1155Token(address(addr));
...
contract DogeBNBUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
