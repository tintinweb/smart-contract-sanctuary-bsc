...
contract SQUIDGRU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Gru";
    string private _symbol = "SGRU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xCde9D5f46bc704e78038df08934D279463b0fC59); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xa0e52660e62eFA0F72A4736076b292c7630B01aC); // Team Address
