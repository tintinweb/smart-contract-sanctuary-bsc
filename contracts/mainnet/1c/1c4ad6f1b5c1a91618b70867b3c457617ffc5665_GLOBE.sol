...
contract GLOBE is ERC20, Ownable {
    ...
    {   
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + marketingFeeOnBuy + partnerFee;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + partnerFee;

        marketingWallet = 0x8377197EC9470444FeA27F37b26625d1bF1760dE;
        partnerWallet   = 0x7533955f96507e3C8c1E87514d8262e503469a7A;
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (partnerFee > 0) {
                uint256 partnerTokens = contractTokenBalance * (partnerFee * 2) / totalFee;
                swapAndSendPartner(partnerTokens);
            }      
...
//------------------Swap------------------//
    ...
    function swapAndSendPartner(uint256 tokenAmount) private {
        uint256 initialBalance = address(this).balance;
        ...
        payable(partnerWallet).sendValue(newBalance);
    }
}