...
contract Config is Owner {
    ...
    //Fee = x / 1000
    uint256 public _holdFee = 30;
    uint256 public _marketFee = 20;
    
    address public _holdAddress = 0x7E89cEF997EefFe367374c2A736cd43773E15216;
...
abstract contract ERC20 is IERC20, Config, ERC20Detailed {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_whiteList[sender] == true) {
            ...
            _tokenTransfer(sender, _holdAddress, amount.mul(_holdFee).div(1000));
...
contract Token is ERC20 {
    ...
    */
    constructor () ERC20Detailed("The Little Princess", "TLP", 18) {

        uint256 totalSupply = 2100000 * (10 ** uint256(decimals()));
