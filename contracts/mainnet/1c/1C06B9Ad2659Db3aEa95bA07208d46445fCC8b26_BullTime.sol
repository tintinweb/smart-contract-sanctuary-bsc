...
Hi Everyone, we all can see how marketing is behaving.
But according to our details analyis, bear time is over and its time for bull run to begun.
Thus we are launching Bull Time to start bull run with this market and us together making a good harmony.

Telegram : https://t.me/BullTimeOfficial
...
contract BullTime is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BULL TIME";
    string constant _symbol = "BULL TIME";
