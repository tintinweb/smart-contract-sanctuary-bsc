...
contract SquidWing is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Squid Wing";
    string private _symbol = "Squid Wing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a79C812098936497501C459389d72c76A500527);
    address payable public DevelopmentWalletAddress = payable(0x7a79C812098936497501C459389d72c76A500527);
    ...
    uint256 private _totalSupply = 1001001 * 10**9;
    uint256 public _maxTxAmount = 1001001 * 10**9;
    uint256 public _walletMax = 1001001 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1001001 * 10**9;
