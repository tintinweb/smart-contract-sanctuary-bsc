...
contract ONEPIECE is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD74e45eC7Ab839AeDb2a1bd65e620151b82Cfcb4));
        ruinWalletAddress = payable(address(0xD74e45eC7Ab839AeDb2a1bd65e620151b82Cfcb4));
