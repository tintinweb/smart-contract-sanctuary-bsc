...
contract Shibaworldfinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x673357A31DC7e065A9b88C04B5ab63E355147561); // Marketing Address
    ...
    string private _name = "Shibaworld Finance";
    string private _symbol = "Shiba world";
    ...
    uint256 private minimumTokensBeforeSwap = 4000000 * 10**9; 
