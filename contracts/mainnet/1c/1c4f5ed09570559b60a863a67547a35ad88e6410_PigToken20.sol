...
contract PigToken20 is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x82CfC460D2b525b73B1e6A42E449f4234fb8C12d); 
    address payable private Wallet_Dev = payable(0x82CfC460D2b525b73B1e6A42E449f4234fb8C12d);
    ...
    constructor () {
        ...
        _owner = 0x82CfC460D2b525b73B1e6A42E449f4234fb8C12d;
