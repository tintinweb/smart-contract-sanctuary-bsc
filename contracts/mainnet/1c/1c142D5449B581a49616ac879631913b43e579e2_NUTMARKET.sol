...
contract NUTMARKET is ERC721URIStorage, Ownable, ReentrancyGuard {
  ...
  event MarketItemCreated(uint256 indexed tokenId, address seller, address owner, uint256 price, uint256 tokens, bool sold);

  constructor() ERC721('NutGain', 'NUTGV2') {}
  ...
  function mintTokenNUTG(
    ...
    idToMarketItem[newTokenId] = MarketItem(newTokenId, payable(seller), payable(msg.sender), price, tokens, true);
    ...
    emit MarketItemCreated(newTokenId, seller, msg.sender, price, tokens, true);
