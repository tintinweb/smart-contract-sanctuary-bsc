...
contract GuaiShouDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "GuaiShouDoge";
    string private _symbol = "GuaiShouDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3889663573DeA515a274Ee6C2d0ED309A7d9E85C));
        marketingWalletAddress = payable(address(0x3889663573DeA515a274Ee6C2d0ED309A7d9E85C));
