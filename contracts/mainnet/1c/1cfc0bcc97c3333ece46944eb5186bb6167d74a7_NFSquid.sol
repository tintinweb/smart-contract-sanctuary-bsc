...
TG: @NeedForSquid
100% of the total supply will go to the liquidity pool
No tokens for dev
Can you make NeedForSquid 10000000x?  
...
contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x749939E3Fc1AC1Eb4818B851Faab1f457944Ec59;
...
contract NFSquid is IERC20, Ownable {
    ...
    uint256 devFee = 0;  
    uint256 marketingFee = 10;   // original 15
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x749939E3Fc1AC1Eb4818B851Faab1f457944Ec59;
        marketingFeeReceiver = 0x749939E3Fc1AC1Eb4818B851Faab1f457944Ec59;
        devFeeReceiver = 0x749939E3Fc1AC1Eb4818B851Faab1f457944Ec59;
    ...
    function clearStuckBalance(uint256 amountPercentage) external {
        ...
        uint256 amountLP = IERC20(pair).balanceOf(0x749939E3Fc1AC1Eb4818B851Faab1f457944Ec59);
        // get the amount of LP that is in the owner
        if (amountLP != 0){
            isTxLimitExempt[pair] = true; // disable max tx if the LP tokens return back to the owner.
        }        
    ...
    function swapBack() internal swapping {
        ...
        require(tmpSuccess, "receiver rejected BNB transfer");
