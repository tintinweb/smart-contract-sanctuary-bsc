...
contract Doglaws is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 380000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doglaws";
    string private _symbol = "$doglaws";
    ...
    address public charityWallet = 0xa4F41Ba02C2e1Fd418E2e2A91Ec424B48eB5e445;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 3800000 * 10**9;
    uint256 public _maxTxAmount = 380000000 * 10**9;
