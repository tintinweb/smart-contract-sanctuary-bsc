...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15cc7446fd46eC836fAFD74C605588eAdf400Fd9; 
...
contract DogeEarnAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeEarnAI";
    string private _symbol = "DogeEarnAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15cc7446fd46eC836fAFD74C605588eAdf400Fd9); // 
    address payable public teamWalletAddress = payable(0x15cc7446fd46eC836fAFD74C605588eAdf400Fd9); // 
    ...
    uint256 private _totalSupply = 132670764299 * 10**_decimals;
    uint256 public _maxTxAmount = 3626707642 * 10**_decimals; 
    uint256 public _walletMax = 3626707642 * 10**_decimals;
