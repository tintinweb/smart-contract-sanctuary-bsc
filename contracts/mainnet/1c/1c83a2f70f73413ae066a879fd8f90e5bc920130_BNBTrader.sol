...
contract BNBTrader is Ownable {
    ...
    uint256 public constant MINIMUM = 3e16; //0.01 BNB minimum investment needed
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(12, 0)); //unlimited
        investmentPlans_.push(Objects.Plan(23, 90*60*60*24)); //90 days
        investmentPlans_.push(Objects.Plan(26, 60*60*60*24)); //60 days
        investmentPlans_.push(Objects.Plan(27, 45*60*60*24)); //45 days
    }
