...
contract Dream is IERC20, Auth {
    ...
    uint256 developmentBuyFee = 250;
    uint256 public totalBuyFee =
        marketingBuyFee + liquidityBuyFee + developmentBuyFee;

    uint256 marketingSellFee = 0;
    uint256 liquiditySellFee = 0;
    uint256 developmentSellFee = 250;
    uint256 public totalSellFee =
        marketingSellFee + liquiditySellFee + developmentSellFee;
    ...
    constructor() Auth(msg.sender) {
        ...
        // Set fee receivers
        liquidityWallet = 0x290fA49823720DCF113d2acbb07878e05e520111;
        marketingWallet = 0x290fA49823720DCF113d2acbb07878e05e520111;
        developmentWallet = 0x290fA49823720DCF113d2acbb07878e05e520111;
    ...
    // Set the buy fees, this can not exceed 25%, 250 / 1000 = 0.25 = 25%
    function setBuyFees(
    ...
    // Set the sell fees, this can not exceed 25%, 250 / 1000 = 0.25 = 25%
    ...
    function checkLimits(
        ...
        if (!isTxLimitExempt[recipient]) {
            require(
                amount + balanceOf(recipient) <= _maxWalletToken,
                "Max wallet"
            );
        }
    }
