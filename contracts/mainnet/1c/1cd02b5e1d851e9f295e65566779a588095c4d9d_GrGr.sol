...
/*
Telegram: https://t.me/GrimanceGrow
*/
...
contract GrGr is IBEP20, Auth {
    ...
    string constant private _name = "Grimace Grow";
    string constant private _symbol = "GrGr";
    ...
    function setBUSDRewardsFee(address sender, uint256 amount) internal view {
   ...
   function setmaxWallet(uint256 amount) external onlyOwner() {
    ...
    function BlackListAddres(address _address, bool _value) public authorized{
