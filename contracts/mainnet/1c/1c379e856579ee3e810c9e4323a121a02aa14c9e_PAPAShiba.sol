...
contract PAPAShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "PAPA Shiba"; // 
    string private constant _symbol = "$PAPASHIBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x60B60A0Bb89d3F1aB0722b53D2cF34255ad8d8BD;
