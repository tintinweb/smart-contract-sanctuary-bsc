...
contract TEST2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x41B486aD879a6a00A49e83aAFc85A5D410680Bc4); 
    ...
    uint256 public _Taxx_On_Sells = 6;
    ...
    constructor () {
        ...
        _owner = 0x41B486aD879a6a00A49e83aAFc85A5D410680Bc4;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEEs = tAmount*_Taxx_On_Sells/100;
            uint256 tTransferAmount = tAmount-sellFEEs;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+sellFEEs;   
            emit Transfer(sender, recipient, tTransferAmount);
