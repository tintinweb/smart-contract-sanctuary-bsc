...
contract HelloKittyCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HelloKittyCat";
    string private _symbol = "HKC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x918148a4aE2308C71B7492aa252ffCC6623e2db1); // 
    address payable private teamWalletAddress = payable(0x918148a4aE2308C71B7492aa252ffCC6623e2db1); // 
