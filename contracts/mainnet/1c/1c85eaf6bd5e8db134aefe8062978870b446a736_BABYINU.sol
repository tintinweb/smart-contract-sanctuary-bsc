...
contract BABYINU is ERC20, Ownable {
    ...
    constructor() ERC20("BabyINU", "BABY") {
        ...
        marketingWallet = address(0xCE20a1b051D9dA1BabE70086d264c49B8455f92C); //
        devWallet = address(0x9Ee86Ac772E11F8E14813EE004d362873348a13f); //
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 7, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 7, "Must keep fees at 25% or less");
    }
