...
contract TEST1 is ERC20DividendToken {
    ...
    constructor (address _marketingAddress, address _devAddress) ERC20DividendToken("TEST1", "TEST1", _tokenSupply, _routerAddress, _marketingAddress, _devAddress) {
