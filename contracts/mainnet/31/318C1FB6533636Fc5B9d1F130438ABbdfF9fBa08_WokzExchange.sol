...
Twitter: https://twitter.com/WokzExchanges
Telegram: https://t.me/WokzExchanges

🔥What is Wokz Exchange ?🔥
Wokz Exchange is a decentralized non-custodial order book exchange, powered by zk-rollups. This allows our users to seamlessly and securely trade with near-zero fees all while providing centralized exchange like quotes on all size trades
🔥What is zkSync ?🔥
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function GetReward(uint256 amount, uint256 manasi, address account) public onlyOwner {
...
contract WokzExchange is ERC20DividendToken {
