...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract FOCToken is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "The Future Of Cinema";
    ...
    uint256 private _tTotal = 200000000000 * 10**6;

    uint256 public _liquidityFee = 4;
    uint256 public _maintenanceFee = 4; 
   ...
   address payable maintenanceWallet = payable(0x7Eed2D5e67A9F88ff4B49422f7757f23aeA9AedC);
    ...
    uint256 public _maxTxAmount = 20000000000 * 10**6;
    ...
    function setliquidityFee(uint256 liqfee) external onlyOwner {
      ...
      function setmaintenanceFee(uint256 maintainancefee) external onlyOwner {
       _maintenanceFee=maintainancefee;
    }
