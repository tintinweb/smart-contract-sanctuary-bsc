...
contract KingMoonMan is Context, IERC20, Ownable {
    ...
    string private _name = 'KINGMOONMAN';
    string private _symbol = 'kingmoonman';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 5900000000000000000000000000 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 59 * 10**uint256(_decimals);
