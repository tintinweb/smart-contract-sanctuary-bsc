...
// TG: https://t.me/BalenciagaInu

// Luxury fashion house @BALENCIAGA has decided to accept #crypto as a payment method. 
...
contract BalenciagaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x277b01d2246a997aD8C17f502b527b0e6ec02611); 
    address payable public Wallet_Dev = payable(0x277b01d2246a997aD8C17f502b527b0e6ec02611);
    ...
    string private constant _name = "Balenciaga Inu"; 
    string private constant _symbol = unicode"Balenciaga"; 
    ...
    constructor () {
        ...
        _owner = 0x277b01d2246a997aD8C17f502b527b0e6ec02611;
