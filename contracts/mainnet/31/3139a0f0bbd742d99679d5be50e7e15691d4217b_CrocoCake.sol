...
/**
Croco Cake is a rewards token on the BSC which rewards holders with reflection in CAKE! 🍰 

Croccy is hungry and he wants the whole cake, not just one piece. 🎂
...
/* Token contract */
contract CrocoCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address Buyback = 0x7F8c988aAC18efD9227Ce0B0226042CA1279d705;
    ...
    // Name and symbol
    string constant _name = "CrocoCake";
    string constant _symbol = "CrocoCake";
