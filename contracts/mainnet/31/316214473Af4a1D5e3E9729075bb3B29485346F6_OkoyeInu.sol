...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D68C723c424f7bc22A0DACCef8a2E80310fd3bC; // owner address
...
contract OkoyeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Okoye Inu";
    string private _symbol = "OKOYE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D68C723c424f7bc22A0DACCef8a2E80310fd3bC); // Marketing Address
    address payable public teamWalletAddress = payable(0x7D68C723c424f7bc22A0DACCef8a2E80310fd3bC); // Team Address
