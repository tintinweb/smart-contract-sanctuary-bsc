...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xbbB986B07F9c14A3E1b56049a9D02Ea412084b6D;
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   contract FINOX is Context, IERC20, Ownable{
    ...
    address private _developmentWalletAddress = 0x71cbBde0369E7d1c4bC54b874e5E77D39D01f2cd; 
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FINOX COIN";
