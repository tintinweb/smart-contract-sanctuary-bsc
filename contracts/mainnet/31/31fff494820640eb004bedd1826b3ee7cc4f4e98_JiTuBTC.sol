...
contract JiTuBTC is Context, IERC20, Ownable {
    ...
    string private constant _name = " Velox Rabbit "; // 
    string private constant _symbol = " $VLXRABBIT "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x3c257EED86eBC9Bdfe6979458311f271fF0C80b5;
