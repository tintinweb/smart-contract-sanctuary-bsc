...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 200; //回流
    uint256 public _buyFundFee2 = 200; //回流
    uint256 public _buyDividendFee = 100; //买入分红
...
contract CSTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xd8dA00e547F04Ac7e2C25275Cc185d6A8c95Ce68),

        address(0x8A2bB762aE77794B47fC618C051120c8Bf701b49),

        address(0xcB3D7AB9892D34B70dFeAE216A2163B1Ae4aE8E2)
    ){
