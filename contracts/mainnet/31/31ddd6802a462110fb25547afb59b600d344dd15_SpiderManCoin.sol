...
/*
👥 Become part of the SPIME community today

🆔 Telegram:
https://t.me/Spiderman_Coin
🐕 Twitter: 
https://twitter.com/SpiderMan_Token
🌎 Website: 
https://www.spiderman-token.store/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(address(this));
...
contract SpiderManCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpiderMan";
    string constant _symbol = "SPIME";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000 * 10**9 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4805d1cb64A0195f9d1B01e46414aCBAD55Dc87F;
        BuyBackReceiver = 0x4805d1cb64A0195f9d1B01e46414aCBAD55Dc87F;
