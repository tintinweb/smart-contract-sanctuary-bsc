...
contract MOOPstaking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakableToken = IBEP20(0xd633BFcAB889C4A50b6256Bd4c4ebF1E55114B1f);   //add the main token
        rewardToken = IBEP20(0x4198F3234d600eC736E5b1d3E1646A5b49105311);    // reward token
        ...
        poolInfo.push(PoolInfo({
            lpToken: IBEP20(0xd633BFcAB889C4A50b6256Bd4c4ebF1E55114B1f), //token here
            allocPoint: 1000,
