...
contract GreenDot is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Dot";
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tBurn) = _getTValues(tAmount, _burnFee, _taxFee);
        uint256 currentRate =  _getRate();
    ...
    function setFee(uint256 burnFeeOnBuy, uint256 burnFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(burnFeeOnBuy < 100, "Redis cannot be more than 10.");
	    require(burnFeeOnSell < 100, "Redis cannot be more than 10.");
