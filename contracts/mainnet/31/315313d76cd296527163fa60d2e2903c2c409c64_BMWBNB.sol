...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6199891dDF6BcbABefFAF3ca93630DB3a95533B2; // owner address
...
contract BMWBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BMW X BNB";
    string private _symbol = "BMWBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7e27492C6A43a67F716f2e874f724D012a4F6948); // Marketing Address
    address payable public teamWalletAddress = payable(0x1430C11c48aB3ef3Febe753774FB63a059574bD4); // Team Address
