...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 1000000000 *10**18; // 10 Billion totalSupply
    ...
    address public buybackv1Address  = 0x513b7631BF0476353AD5467e1B752AacCAAd4423;      // BuyBackv1 Address
    address public buybackv2Address  = 0x513b7631BF0476353AD5467e1B752AacCAAd4423;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x513b7631BF0476353AD5467e1B752AacCAAd4423;      // SMarketing Address
