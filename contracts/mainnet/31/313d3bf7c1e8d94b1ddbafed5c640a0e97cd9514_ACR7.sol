...
contract ACR7 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian CR7 Inu";
    string private _symbol = "ACR7";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x472B98F9c6bA2550f9818fb78f169A2177692ec6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x472B98F9c6bA2550f9818fb78f169A2177692ec6); // BuyBack Address
    ...
    uint256 private _maxSellTxAmount = 1000 * 10**6 * 10**9;
