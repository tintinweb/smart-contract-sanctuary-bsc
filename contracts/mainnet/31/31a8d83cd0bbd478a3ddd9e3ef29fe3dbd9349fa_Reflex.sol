...
//
// Reflex ($Reflex) is a reflections token with the ability to change its reflected token at any time
// Total Tax: 6% (Reflections: 5% | Liquidity: 1%)
//
// Website: reflexbsc.com
// Telegram: t.me/reflexbsc
...
contract Reflex is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string _name = "EverReflex";
    string _symbol = "EFLEX";
    ...
    uint256 public totalFee = liquidityFee + reflectionFee; // Reflections fee - 5%, Liquidity fee - 1%
