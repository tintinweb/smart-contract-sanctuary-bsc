...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe700BaEc5f7d3378b0700e1B8A26aD4FD698fce6; // owner address
...
contract TwitGram is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitGram";
    string private _symbol = "TWITGRAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7fe783C7F52fCB778a1Fe0509Ce3B8A0c5bcBF83); // Marketing Address
    address payable public teamWalletAddress = payable(0xe700BaEc5f7d3378b0700e1B8A26aD4FD698fce6); // Team Address
    ...
    function setTradingStatus (bool newtradingStatus) public onlyOwner{
