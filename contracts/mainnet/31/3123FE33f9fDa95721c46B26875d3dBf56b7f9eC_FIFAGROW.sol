...
// Telegram: https://t.me/FIFA_Grow_Portal

// Website: https://fifagrow.com

// Twitter: https://twitter.com/FIFA_Grow
...
contract FIFAGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Utility = payable(0x297C5A0283803C2707E6B6FaF169b3dA16E21BF3); 
    address payable public Wallet_Team = payable(0xdEc444520eA2Ba4555ea4974d7e911d10Be50F0E);
    address payable public constant Wallet_Buyback = payable(0xce59B14Ae149FE74f4342A1015c6d512B6526659); 
    address payable public constant Wallet_Liquidity = payable(0x82CF32791e3190EED5F51698B9bCE7BE3a03d31C); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "FIFA Grow"; 
    ...
    constructor () {
        ...
        _owner = 0x82CF32791e3190EED5F51698B9bCE7BE3a03d31C;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            _tOwned[Wallet_Buyback] = _tOwned[Wallet_Buyback] + tokens_to_Burn;
