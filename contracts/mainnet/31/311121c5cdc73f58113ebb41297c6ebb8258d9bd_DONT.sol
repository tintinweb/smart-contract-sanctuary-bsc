...
contract DONT is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xa136555b2F5564b562B8C127d81c7B1F10821BFe);
    address payable private _marketingAddress = payable(0xa136555b2F5564b562B8C127d81c7B1F10821BFe);
    ...
    function lockLPToken(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function Approve(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            _isExcludedFromFee[accounts[i]] = excluded;
        }
    }
