...
contract AmidamaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AMIDAMARU INU";
    string private _symbol = "AMIDAMINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD84D54Db5cfFc25a4301587f30b30a3e01640b09); 
    address payable public buyBackWalletAddress = payable(0xf046C0E41C0B48621Bbd8CE7995774a8213C0418); 
