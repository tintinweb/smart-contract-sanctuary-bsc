...
contract MetaRabbit is ERC20 {
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) public blackList;
    address public tokenOwner =
        address(0xBf187AeA07771F402ba1aB7B29213630Bb00eE80);
    address public fundAddr =
        address(0x26d8Ee1D81984F3Cb8DaaD916961B65C88888888);

    uint256 public marketPercent = 200;

    constructor() ERC20("MetaRabbit", "MetaRabbit") {
