...
contract OwnContract is  Ownable {
    using SafeMath for uint256;

    // Testnet
    // address public addressOfUSDT = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    // address public addressOfBUSD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function swapAllOfBNBToBUSD() public onlyOwner {
    ...
    function swapBNBToBUSD(uint256 amount) public onlyOwner {
    ...
    function swapAllOfBNBToUSDT() public onlyOwner {
        require(address(this).balance > 0, "Contract balance is not enough.");
        uint256 amount = address(this).balance;
    ...
    function swapBNBToUSDT(uint256 amount) public onlyOwner {
        require(address(this).balance >= amount, "Contract balance is not enough.");
    ...
    function swapAllOfBUSDToBNB() public onlyOwner {
    ...
    function swapBUSDToBNB(uint256 amount) public onlyOwner {
        amount = amount * 10**18;
    ...
    function swapAllOfUSDTToBNB() public onlyOwner {
    ...
    function swapUSDTToBNB(uint256 amount) public onlyOwner {
        amount = amount * 10**18;
    ...
    function withdrawAllOfBNB(address receiver) public onlyOwner {
        require(address(this).balance > 0, "Contract balance is not enough.");
        uint256 amount = address(this).balance;
    ...
    function withdrawOfBNB(uint256 amount, address receiver) public onlyOwner {
        require(address(this).balance >= amount, "Contract balance is not enough.");

        payable(receiver).transfer(amount);
    }

    function withdrawAllOfUSDT(address receiver) public onlyOwner {
        require(balanceOfUSDT() > 0, "Contract balance is not enough.");
        uint256 amount = balanceOfUSDT();
    ...
    function withdrawOfUSDT(uint256 amount, address receiver) public onlyOwner {
        amount = amount * 10**18;
        require(balanceOfUSDT() >= amount, "Contract balance is not enough.");
    ...
    function withdrawAllOfBUSD(address receiver) public onlyOwner {
        require(balanceOfBUSD() > 0, "Contract balance is not enough.");
        uint256 amount = balanceOfBUSD();
    ...
    function withdrawOfBUSD(uint256 amount, address receiver) public onlyOwner {
        amount = amount * 10**18;
        require(balanceOfBUSD() >= amount, "Contract balance is not enough.");
