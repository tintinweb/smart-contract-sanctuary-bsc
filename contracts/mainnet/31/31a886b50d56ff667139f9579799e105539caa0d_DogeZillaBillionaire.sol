...
contract DogeZillaBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeZilla Billionaire";
    string private _symbol = "DZillaB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x41Bc54Fe364b1C58bdc51010690deE25e629c8d2); 
    address payable public BurnedWalletAddress = payable(0x41Bc54Fe364b1C58bdc51010690deE25e629c8d2); 
