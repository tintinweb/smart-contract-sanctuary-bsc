...
contract CoinToken is IBEP20, Auth {
    ...
    string constant _name = "XY DAO";
    string constant _symbol = "XY";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 2200 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3Ca734bf0E1c73F37C0BCB816d4620D9e979A395;
