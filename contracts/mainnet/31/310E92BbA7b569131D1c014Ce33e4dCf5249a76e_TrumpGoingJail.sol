...
contract TrumpGoingJail is IBEP20, Auth {
    ...
    address constant DEV = 0x8550369a3db3E04a3a59490eAfFa434Efe52729d;


    string constant _name = "TRUMP GOING JAIL";
    string constant _symbol = "$TGJ";
