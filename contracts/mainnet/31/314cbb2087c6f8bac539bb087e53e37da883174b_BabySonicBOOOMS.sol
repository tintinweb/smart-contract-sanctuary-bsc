...
// Missing Sonic BOOMS!! ? Now Baby Sonic BOOMS!!
// Why Low Liq ? Liq will Burn
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2Cd67008180B68099DD9cB90Ef6E11B6b1eC3A0E; //  Master
...
contract BabySonicBOOOMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Sonic BOOMS!!";
    string private _symbol = "BSBOOMS!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Cd67008180B68099DD9cB90Ef6E11B6b1eC3A0E); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x6D20aa29f4f411a9a08819DD82edF15e909C6eA2); // Team Wallet
