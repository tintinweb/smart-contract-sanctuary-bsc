...
contract BabyHypeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Hype coin";
    string private _symbol = "BabyHCoin";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xB364967B53d8f082B8ae0936aae88fC7660d8349); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xC3a7384467dBBb212525c6bB97e801bFE54f2A09); // Team Address
