...
/** 
    New Community Floki
    Telegram : https://t.me/newcommunityfloki
*/
...
contract Newcommunity is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _isgetReward;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetReward[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetReward[to] = block.timestamp;
        }
