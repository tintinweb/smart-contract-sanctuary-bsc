...
contract NegativeTax is IERC20 {
    ...
    string constant private _name = "Negative Tax";
    string constant private _symbol = "$NETA";
    ...
    constructor () payable {
        ...
        _isExcludedFromDividends[address(bonusHolder)] = true;
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 negativeTax) external onlyOwner {
        ...
        require(buyFee <= maxBuyTaxes, "Cannot exceed maximums.");
        require(negativeTax <= maxNegativeTaxes, "Cannot set above maximum.");
                ...
                if (contractSwapEnabled
                   ...
                   && from != address(cashier)
                    ...
                    if (contractTokenBalance >= swapThreshold) {
                        ...
                        finalizeTransfer(address(this), address(cashier), contractTokenBalance, false, false, true);
                        try cashier.load(contractTokenBalance) {} catch {}
                    }
                }
            }
        } 
