...
contract Ownable {
    ...
    constructor (address _addr) {
        _owner = 0x830ac856f11a19C4345cdcd86408034F81140F7F;
...
contract TOKEN is ERC20, Ownable{
    ...
    constructor () Ownable(msg.sender){
        ...
        _mint(0x830ac856f11a19C4345cdcd86408034F81140F7F, 200000000 * 10**18);
    ...
    function _beforeTokenTransfer(
        ...
        address _to,
        uint256 _amount
    )internal override lock returns (uint256){
	...
	function share_holder(uint256 amount_span) private   {
