...
contract TEST01 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TEST01 TOKEN";
    string private _symbol = "TEST01";
    ...
    address payable private marketingWalletAddress = payable(0xf5E0886C643Ea71517bC345F6cA5A7630c230031);
