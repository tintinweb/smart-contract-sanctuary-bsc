...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x765602783f1c619E3BbC359e5a9793f291Fd4F1C; // owner address
...
contract BabyTelegramInu is Context, IERC20, Ownable {
    ...
    string private _name = "BabyTelegramInu";
    string private _symbol = "BTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x765602783f1c619E3BbC359e5a9793f291Fd4F1C); // Marketing Address
    address payable public teamWalletAddress = payable(0x765602783f1c619E3BbC359e5a9793f291Fd4F1C); // Team Address
