...
contract SensoNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Senso Neko";
    string private _symbol = "SENKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE54Fddd84EF0149aA2637aFacD20FAf995CdC89C); // 
    address payable public teamWalletAddress = payable(0xE54Fddd84EF0149aA2637aFacD20FAf995CdC89C); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xE54Fddd84EF0149aA2637aFacD20FAf995CdC89C)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xE54Fddd84EF0149aA2637aFacD20FAf995CdC89C),removeRandom);
}}