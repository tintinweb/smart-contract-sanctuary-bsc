...
contract BATGEINU is Context, IERC20, Ownable {
    ...
    string private _name = "Batge Inu";
    string private _symbol = "BATINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaf8091611f5bFe0494C6AEED0bd1E575582a4FA4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xaf8091611f5bFe0494C6AEED0bd1E575582a4FA4); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (2 * 10**12 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
