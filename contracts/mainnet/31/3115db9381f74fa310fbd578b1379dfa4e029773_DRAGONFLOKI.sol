...
/**
DragonFloki. Follow me and you will be free.
*/
...
//Contract
contract DRAGONFLOKI is IBEP20, Ownable {
    ...
    uint8 public constant MaxTax=95;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    ...
    uint8 private _buyTax=90;
    uint8 private _sellTax=90;
