...
contract KittyYachtClub is IBEP20, Auth {
    ...
    string constant _name = "KittyYachtClub";
    string constant _symbol = "KittyYachtClub";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 200;  // max tx
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; // max wallet
    ...
    address private marketingFeeReceiver = 0x2e444c0c90dA04B7f52a2fdD2ea93D9436a8658e;
    address private developmentFeeReceiver = 0x2e444c0c90dA04B7f52a2fdD2ea93D9436a8658e;
