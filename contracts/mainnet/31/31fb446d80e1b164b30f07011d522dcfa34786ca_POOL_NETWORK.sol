...
Telegram : https://t.me/GlobalChat_PoolNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51cEeFa900337aC0eDFF798CB09c584A8C4d791a; // owner address
...
contract POOL_NETWORK is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x59C5ddf679ada127Fe56eeB3381781a33FdC1B27); // Marketing Address
    address payable public teamWalletAddress = payable(0x51cEeFa900337aC0eDFF798CB09c584A8C4d791a); // Team Address
