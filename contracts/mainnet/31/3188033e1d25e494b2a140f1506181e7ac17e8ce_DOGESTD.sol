...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5c2E8A2377D7C13EDC17dAE90A78Fae0dCcd6FF; // owner address
...
contract DOGESTD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGESTD";
    string private _symbol = "DSTD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xACbe2e04e20E5d82649d81C606d3c98435B3f990); // Marketing Address
    address payable public teamWalletAddress = payable(0x99Ea9497666f456Fd5B80aD1B4b53C9A4BDEC0d6); // Team Address
