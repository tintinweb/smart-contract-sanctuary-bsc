...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    uint public all_holders_amount;
...
contract Widow is ERC721, Ownable {
    ...
    constructor() ERC721("Supreme Black Widows","Supreme Black Widows")  {
        setBaseURI("https://ipfs.io/ipfs/QmWJ3iGi8LSdPJXbZHqiEjRw2ociveJcMihgc6jYdJEqqM");
        for(uint i=1;i<=80;i++)
        {
