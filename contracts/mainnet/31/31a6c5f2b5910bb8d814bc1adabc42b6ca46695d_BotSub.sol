...
contract BotSub {
	...
	address payable public immutable ceoWallet;
    ...
    function deposit(uint256 amount) external {
        ...
        require(amount >= 1 ether, "Minimum deposit amount is 1 BUSD");

		uint256 dFee = amount.mul(67).div(100);
        uint256 ceo = amount.mul(33).div(100);

        BUSD.safeTransferFrom(msg.sender, devWallet, dFee);
        BUSD.safeTransferFrom(msg.sender, ceoWallet, ceo);
