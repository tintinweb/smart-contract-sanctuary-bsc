...
// Black Raccoon is here!

//I know many of you have missed 100X token  so I'm sure you don't want to miss another chance, especially when you have the opportunity to become a whale at such a low price.
//Don't miss this Big project BlackRaccoon Everyone is looking for that 100x gem that is still under the radar
pragma solidity ^0.8.6;


// SPDX-License-Identifier: MIT

//https://t.me/RccoonPortal
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88E10E9d128D0e080C7a19CF92c2904Cb41429D9;
...
contract BlackRaccoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "BLACK RACCOON"; // 
    string private constant _symbol = "BRC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x88E10E9d128D0e080C7a19CF92c2904Cb41429D9);
