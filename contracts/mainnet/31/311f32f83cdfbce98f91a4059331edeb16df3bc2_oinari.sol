...
/* Token contract */
contract oinari is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xf3173B8Ed7f97926DD1Dd03Cb18c20C437A949F8;
    ...
    // Name and symbol
    string constant _name = "Oinarisan";
    string constant _symbol = "OINARI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100000 / 100000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 100000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 100000 ) / 100000; // 2% 
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 100000; // 0.25%
