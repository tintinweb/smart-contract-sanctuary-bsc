...
META AI tokenized assets allow rights holders to hold securely, transfer, sell and collateralize their possessions without opening their lives to scrutiny. 

The META AI provides options for low cost permanent blockchain storage, creating timeless and durable assets with no maintenance overhead, ever.


⚜️Join us now!!
Twitter: https://twitter.com/metaaiofficial
Website: https://metaaiofc.xyz/
Tg: @metaaiofficial
...
contract MetaAI is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xfbCbF0EB056363f9dc27B9b725d197040557c74F);
    address payable public MarketingWallet = payable(0xc1E0AA40bECC536135A01Ba6FcFDe030426B173f);
