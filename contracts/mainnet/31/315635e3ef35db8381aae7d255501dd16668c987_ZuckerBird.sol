...
/*
           ...
           .......m.m........
 _____         _           _____ _       _ 
|__   |_ _ ___| |_ ___ ___| __  |_|___ _| | ©️
|   __| | |  _| '_| -_|  _| __ -| |  _| . |
|_____|___|___|_,_|___|_| |_____|_|_| |___|                                                                                          
                                                
  Website:  https://ZuckerBird.net
  Telegram: https://t.me/zuckerbirdcrypto
  Twitter:  https://twitter.com/zuckerbirdBSC
*/
...
contract ZuckerBird is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'ZuckerBird.net';   // Name
	string constant _symbol = 'ZBIRD';    // Symbol
    ...
    uint256 constant marketingFeeBuy  = 1000;
    uint256 constant totalFeeBuy      = 1200;

    // Sell Fees
    uint256 constant reflectionFeeSell = 0;
    uint256 constant liquidityFeeSell  = 200;
    uint256 constant marketingFeeSell  = 1200;
    uint256 constant totalFeeSell      = 1400;
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0x3C7fB37B949870C8b3e85ee195D3A720916AE75d;
        marketingFeeReceiver = 0x3C7fB37B949870C8b3e85ee195D3A720916AE75d;
