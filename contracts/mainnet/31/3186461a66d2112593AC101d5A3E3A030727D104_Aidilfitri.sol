...
contract Aidilfitri is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aidilfitri";
    string private _symbol = "Aidilfitri";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x3f145d78D3dd3A16A8D24842Bc9CF1983b52Dfd9); // Marketing Address
    address payable public teamWalletAddress = payable(0xD244BF8159Bb7750a688682fb1E37B5ad7Ce010E); // Team Address
