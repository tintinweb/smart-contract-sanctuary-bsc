...
contract PiSnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PiSnake";
    string private _symbol = "PiSnake";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbe65C80f514868D2Acf5386F18BCE8c1CEDD58ae); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa63B1872Ac2C25d61DB2EF6b25A1712F46318b31); // buyback Address
