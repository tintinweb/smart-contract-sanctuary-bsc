...
contract SQDogeRise is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidDogeRise"; // 
    string private constant _symbol = "SQDogeRise "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x2729Be2458f12B87F4C52bDB0233F617c7690fEc;
