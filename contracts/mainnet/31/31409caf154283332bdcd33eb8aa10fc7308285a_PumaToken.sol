...
contract PumaToken is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet =
        0xC41c1c000eb4081a19491e90350df615EC5166dB;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 101 * 10**9 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "PUMA TOKEN";
    string private constant _symbol = "PU";
    ...
    uint256 public _maxWalletHoldingLimit = 10 * 10**9 * 10**8;
