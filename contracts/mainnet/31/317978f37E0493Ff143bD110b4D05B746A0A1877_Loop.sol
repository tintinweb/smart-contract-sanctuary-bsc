...
-o    | |   | |  | | |  | |  ___/ 
-o    | |___| |__| | |__| | |     
-o    |______\____/ \____/|_|     
-o                             
-o    Join LOOP telegram:
-o    https://t.me/LoopRewards
-o
-o    Max wallet, BUSD rewards, auto liquidty and much more.
-o    Code © @jeffcalls
-o
*/

// SPDX-License-Identifier: PRIVATE CODE BY JEFFCALLS
...
contract Loop is IBEP20, Auth {
    ...
    string constant _name = "t.me/LoopRewards";
    ...
    address public MarketingFeeReceiver =
        0xbd483419955Eff67d463bDd4e33E7067116056F2;
    ...
    constructor() Auth(address(0xbd483419955Eff67d463bDd4e33E7067116056F2)) {
        ...
        isFeeExempt[address(0xbd483419955Eff67d463bDd4e33E7067116056F2)] = true;
        isTxLimitExempt[address(0xbd483419955Eff67d463bDd4e33E7067116056F2)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xbd483419955Eff67d463bDd4e33E7067116056F2);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xbd483419955Eff67d463bDd4e33E7067116056F2)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xbd483419955Eff67d463bDd4e33E7067116056F2)] = _totalSupply;
        emit Transfer(address(0), address(0xbd483419955Eff67d463bDd4e33E7067116056F2), _totalSupply);
    }
