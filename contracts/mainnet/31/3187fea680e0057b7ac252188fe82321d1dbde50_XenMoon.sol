...
//
// XenMoon Token - Rewards + Utility Tools on BSC
//
// 5% Tax on Buys and Sells - Use +5% Slippage
// 2.5% Max Wallet per user - 25 000 000 (25 million) tokens!
//
// More info about XenMoon in the links below:
//
// Website: https://xenmoontoken.com
// Twitter: https://twitter.com/xenmoontoken
// Telegram: https://t.me/xenmoontoken
//
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0x064509e82AaB3F7882aC51b2EEc4b39A06Ce6FB8); // USDC rewards
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // CHNG router
        _token = msg.sender;
    }
...
contract XenMoon is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0x064509e82AaB3F7882aC51b2EEc4b39A06Ce6FB8; // USDC Rewards
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // UNI v2 ROUTER
        pair = IDEXFactory(router.factory()).createPair(router.WETH(), address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        distributor = new DividendDistributor(0x10ED43C718714eb63d5aA57B78B54704E256024E); // UNI v2 ROUTER
        ...
        approve(0x10ED43C718714eb63d5aA57B78B54704E256024E, _totalSupply); // UNI v2 ROUTER
