...
contract DoraemiaoPresale is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
	...
	function _addInviteInit() private {
		_initInviteArr.push(Invite("0fae6dce", 0x55DB0A05FF5fB4E8Ee6Da9Aea33FC33567C57E61));
		_initInviteArr.push(Invite("688c8238", 0x15651bBeae4E60C3eF7bF54712ca46dB8A7b3946));
		_initInviteArr.push(Invite("690f6b25", 0x14Fc433A2ab7a1283571b42495B9dd03042f1EA6));
		_initInviteArr.push(Invite("b4e6dc24", 0x8927B3Bba64b0EbB7396c4507256c52B9e122926));
		_initInviteArr.push(Invite("d59ee64a", 0x797d3DdED56028D04a82760684F1BBc5Be802f5C));
		_initInviteArr.push(Invite("e3e978cc", 0xD6d38414A5f1C21E361e1a7491C04A174078bB0a));
		_initInviteArr.push(Invite("d13dc108", 0xb6008AA1AD5403c22dA28Ad15253156BB57D99c1));
		_initInviteArr.push(Invite("1b2db62e", 0xcf199E22bb98d1b5A78D4D4C56Cb80B46187a5d1));
		_initInviteArr.push(Invite("d822e7d3", 0x5320C8963A7a65f64eb9C4EdC71AaEE7146e60B5));
		_initInviteArr.push(Invite("e4ac0d69", 0x5aBBD393bEbACE82e0D2CD01C3e2FA88E5EeD695));
		_initInviteArr.push(Invite("c30db546", 0xEb9Edb11f3971241a44EAa07EF0925766a56e747));
		_initInviteArr.push(Invite("db480081", 0x9563DF72050e1F8cEc62Dd27c6B8c608A1d0f177));
		_initInviteArr.push(Invite("68596ed0", 0x8FFe4E2e7FfEF947E586e965071A02Fa3A65c378));
		_initInviteArr.push(Invite("c3a5b466", 0x39738A182fe339700d30be772d20322A7035462a));
		_initInviteArr.push(Invite("a920ca89", 0xe8F7375B233b2023106e0cF19a679a13aF30B639));
 ...
 * @dev To getPresalePrice Each round of pre-order usdt price
    ...
    * @dev To update the sale end times
	...
	returns (bool)
	{
		...
		require(
			_inviteRewardClaimStart > endTime && _inviteRewardClaimStart > block.timestamp,
	...
	function inviteRewardClaim() external whenNotPaused returns (bool) {
		require(block.timestamp >= inviteRewardClaimStart, "Claim has not started yet");
		require(isExistInviteAddr(_msgSender()), "not inviter");
		require(!hasInviteRewardClaimed[_msgSender()], "Already claimed");
		
		hasInviteRewardClaimed[_msgSender()] = true;
