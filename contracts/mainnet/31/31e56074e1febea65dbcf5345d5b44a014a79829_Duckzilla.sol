...
DuckZilla
A Decentralized Meme Token with the hype of zilla. Aim to be the next Moonshot! 
Dev & Team is very active all the time. Big Caller & more marketing lined up.
...
Telegram: https://t.me/DuckzillaOFFICIAL
...
contract Duckzilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "Duckzilla"; // 
    string private constant _symbol = "$DZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x49D4c82D3B4734b33cfB530c1e80899ccBEB4d1D;
