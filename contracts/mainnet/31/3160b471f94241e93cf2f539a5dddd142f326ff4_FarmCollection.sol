...
contract FarmCollection  {
    address public MasterChef = 0x73feaa1eE314F8c655E354234017bE2193C9E24E;
    address public rewardToken;
    uint256 public rDec;
    string public rSym;

    function setRewardToken() internal {
        rewardToken = masterChef(MasterChef).cake();
        rDec = token(rewardToken).decimals();
        rSym = token(rewardToken).symbol();
    }
