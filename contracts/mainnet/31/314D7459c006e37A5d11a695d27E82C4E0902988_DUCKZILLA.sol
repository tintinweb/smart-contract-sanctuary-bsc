...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x969FA4F1AD26FCAfF1cA6DE50d0821Ea027bbC13; // owner address
...
contract DUCKZILLA is Context, IERC20, Ownable {
    ...
    string private _name = "DUCKZILLA";
    string private _symbol = "DZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x969FA4F1AD26FCAfF1cA6DE50d0821Ea027bbC13);
    address payable public teamWalletAddress = payable(0x969FA4F1AD26FCAfF1cA6DE50d0821Ea027bbC13); 
