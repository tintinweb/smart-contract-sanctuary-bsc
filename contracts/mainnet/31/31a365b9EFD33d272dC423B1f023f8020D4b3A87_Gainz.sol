...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //the reward token you want distributed 
...
contract Gainz is IBEP20, Auth {
 using SafeMath for uint256;
 // address REWARDS = 0xBe1a001FE942f96Eea22bA08783140B9Dcc09D28; //BNB rewards - comment out as necessary
 address REWARDS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD Rewards - comment out as necessary
 address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x7704426aF7F16Df3547C8653b5c52ea846137F6f;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "Gainz";
...
function setMaxWalletPercent(uint256 maxWallPercent) external authorized {
 ...
 require(maxWallPercent > 2, "Must be greater than 2%");
 }
