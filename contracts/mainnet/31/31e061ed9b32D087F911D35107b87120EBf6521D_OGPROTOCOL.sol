...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe129646413f5626217AF9420fc4E2D9Bd45C56E6; // owner address
...
contract OGPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG PROTOCOL";
    string private _symbol = "OP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe129646413f5626217AF9420fc4E2D9Bd45C56E6); // Marketing Address
    address payable public teamWalletAddress = payable(0xe129646413f5626217AF9420fc4E2D9Bd45C56E6); // Team Address
