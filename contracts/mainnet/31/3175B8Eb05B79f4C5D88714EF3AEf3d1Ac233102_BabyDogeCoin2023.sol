...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x083a2706668DcaE498AdE3d0932d246d16e76Ff4; // owner address
...
contract BabyDogeCoin2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDogeCoin 2023";
    string private _symbol = "BDC2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x083a2706668DcaE498AdE3d0932d246d16e76Ff4); // Marketing Address
    address payable public teamWalletAddress = payable(0x083a2706668DcaE498AdE3d0932d246d16e76Ff4); // Team Address
