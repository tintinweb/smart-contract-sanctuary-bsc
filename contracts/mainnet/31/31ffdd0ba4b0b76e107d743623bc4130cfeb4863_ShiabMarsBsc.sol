...
/**
Shiba Mars strives to provide financial freedom for its investors as the crypto economy continues to develop

 Telegram: https://t.me/shibamarsbscc

 Website: http://shibamarscoin.com/
...
contract ShiabMarsBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA MARS";
    string constant _symbol = "SHIBMARS";
