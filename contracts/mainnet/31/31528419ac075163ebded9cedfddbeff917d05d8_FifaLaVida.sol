...
contract FifaLaVida is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa La Vida";
    string private _symbol = "FifaLaVida";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe56d247b69A6cd3F72EEfD2c0c83d1ABA16F906C); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe56d247b69A6cd3F72EEfD2c0c83d1ABA16F906C); // buyback Address
