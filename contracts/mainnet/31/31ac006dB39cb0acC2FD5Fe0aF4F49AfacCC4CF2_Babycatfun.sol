...
contract Babycatfun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCatfun";
    string private _symbol = "BCF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16bf19FA55632e6C659193d1627b6076160176ee); 
    address payable public buyBackWalletAddress = payable(0x16bf19FA55632e6C659193d1627b6076160176ee); 
    ...
    uint256 private _totalSupply = 2_133_300_000 * 10**9;
    uint256 public _maxTxAmount = 2_133_300_000 * 10**9; 
    uint256 public _walletMax = 2_133_300_000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 300_133_000 * 10**9; 
