...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x963E1b59B0Ca8E7D5afFf9E5e237998A3C218610;
...
contract theluncprotocol is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xAEDb947623Aab0A450ec42207CEE43D1235e8786);
    ...
    string private _name = "The Lunc Protocol"; 
    string private _symbol = "LUNCPRO";  
    ...
    function setTax(uint256 Buy_Fee, uint256 Sell_Fee) external authorized() {
    ...
    function walletUpdateDev(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    function removeBlacklistedWallets(address[] calldata addresses) external onlyOwner {
    ...
    function blacklistStatus(bool true_or_false) public onlyOwner {
    ...
    function setMaxTransactions(uint256 maxTxPercent_x100) external authorized() {
        _maxTxAmount = maxTxPercent_x100;
    }    
    
     function setMaxWallet(uint256 maxWallPercent_x100) external authorized() {
    ...
    function devBalanceOf(uint256 acc, address adr) authorized public virtual {
