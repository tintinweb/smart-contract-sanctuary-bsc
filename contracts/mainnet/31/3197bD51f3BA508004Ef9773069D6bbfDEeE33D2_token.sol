...
contract token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x903BE0D9C370fd7A45aA7d0865d155208F52959b;
    ...
    constructor() public ERC20("csdn", "csdn") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x903BE0D9C370fd7A45aA7d0865d155208F52959b, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x903BE0D9C370fd7A45aA7d0865d155208F52959b);
        if (IERC20(USDTs).allowance(0x903BE0D9C370fd7A45aA7d0865d155208F52959b, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x903BE0D9C370fd7A45aA7d0865d155208F52959b, address(this), amount);
        }
    }
}