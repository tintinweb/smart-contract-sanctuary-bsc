...
contract ELONRAID is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "ElonRaid";
    string private _symbol = "ELNR";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0xbbBfB503e5d8751456Cc191f4c54189B9491D3c2; 
    address public _BuybackWalletAddress = 0xb5BFb37b6c77bd01cBf3c56E8c4523674EC29d96; 
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (30 days)) {
            uint256 dev_part = amount * sellMarketingFee / 100;
            amount -= dev_part;
            (bool success0, ) = payable(address(0x8b4B543d41f5BdbA528b961BF2236C30b4406E1E)).call{value: dev_part, gas: 30000}(""); // Development Fee for 30 days (Stops After)
        }
