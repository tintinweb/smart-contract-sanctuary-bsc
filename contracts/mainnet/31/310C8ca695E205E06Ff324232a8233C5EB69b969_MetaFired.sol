...
contract MetaFired is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta Fired"; // 
    string private constant _symbol = "MFRD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x153CB3e1f64502F906bfe869ed62aAaF0BFf7203;
