...
pragma solidity ^0.8.6;
 ...
 library SafeMath {
     ...
     function mul(uint256 a, uint256 b) internal pure returns (uint256) {
         ...
         // benefit is lost if 'b' is also DrStrangeed.
 ...
 library Address {
      ...
      * use https://solidity.readthedocs.io/en/laDrStrange/units-and-global-variables.html?highlight=abi.decode#abi-encoding-and-decoding-functions[`abi.decode`].
      *
      * Requirements:
      *
 ...
 contract DrStrange is Context, IERC20, Ownable {
     ...
     string private constant _name = "Dr Strange";
     string private constant _symbol = "MultiVerse";
     uint8 private constant _decimals = 9; 
     
     uint256 public _marketingFee = 8;
     uint256 public _liquidityFee = 2;
     address public _marketingWallet = 0x0340e0aCdc76Cf84134BD0d10fc8D7d1c489D713;
