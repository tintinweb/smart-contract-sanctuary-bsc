...
contract CHRISTMASDOGETWO is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CHRISTMAS DOGE 2.0"; // 
    string constant _symbol = "XMAD20"; // 
    ...
    uint256 public SelldevFee          = 4;//buyback
    uint256 public SellmarketingFee    = 31;
    ...
    // Fees receivers
    address private autoLiquidityReceiver = 0x3EbEc4F0e2B1BE1D7dAd4e345a2dC44291869848; //LP receiver
    address private marketingFeeReceiver = 0x8Fa681D6Feb7728274e820A88dB141B59ED9c85c; //mkt
    address private devFeeReceiver = 0x305DB0ADAC191Ffa60FF422988aDCCf5612776f6; //31 BuyBack
    address private teamFeeReceiver = 0x305DB0ADAC191Ffa60FF422988aDCCf5612776f6; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x7F3Bb33c46487429141fEF133a3f046eB30a3B0f;
