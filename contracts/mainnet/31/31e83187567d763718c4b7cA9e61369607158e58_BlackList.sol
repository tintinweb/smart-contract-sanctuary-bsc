...
contract BlackList is IERC20, Ownable {
    ...
    // ********************************* START VARIABLES *********************************
    string private _name = "SHILL TO EARN";                                                     // name
    string private _symbol = "S2E";                                                      // symbol
    uint256 private _totalSupply = 1000000000000 * 10**uint256(_decimals);               // total supply
    uint256 public _maxTxAmount = _totalSupply.div(1);                                   // max transaction has no limit.
    bool pauseStatus = true;                                                             // initial value is paused
    // ********************************** END VARIABLES **********************************
    ...
    constructor() public {
        // Mint 1 trillion tokens to owner
    ...
    function _transfer(
        ...
        require(pauseStatus == false, "All Transactions are not allowed");
