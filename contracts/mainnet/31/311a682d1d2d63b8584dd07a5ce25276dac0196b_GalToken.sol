...
// We present to your attention the new Gal token. 
...
// Welcome to Gal, a simple reward token based on the Binance Smart Chain. All holders are passively rewarded in $GAL for holding.
// 🌶 Low Cap Gem
// 🌶 Founder fully anonymous
// 🌶 Locked liquidity
// 🌶 New website live
// 🌶 CG, CMC submitted
...
contract GalToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Gal';
    string private _symbol = 'GAL';
    uint8 private _decimals = 18;
    uint256 public _maxWallet = 200_000 * 10**18;
