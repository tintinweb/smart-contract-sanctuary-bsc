...
contract ERC20 is Context, IERC20, IERC20Metadata, Pausable{
     ...
     */
    function allowance(address owner, address spender) public whenNotPaused view virtual override returns (uint256) {
...
contract HubbleX is ERC20, Ownable {
    ...
    address public marketingWallet=0x458a812Fe187654C831938A5794b370f3f821b70;
    address public devWallet=0x458a812Fe187654C831938A5794b370f3f821b70;
    ...
    constructor() ERC20("HUBBLEX", "HUBBLEX") { 
        ...
        uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals(); // 1 Trillion 
 
        maxTransactionAmount = 1 * 10 ** 8 * 10 ** decimals(); //  maxTransactionAmountTxn
        maxWallet = 1 * 10 ** 9 * 10 ** decimals(); //  maxWallet
