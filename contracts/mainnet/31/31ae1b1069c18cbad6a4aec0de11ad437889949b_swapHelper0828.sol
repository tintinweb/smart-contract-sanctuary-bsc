...
contract swapHelper0828 is  Ownable {
    ...
    function swapCOT(
        ...
        routerAddress.swapExactTokensForTokens(amountIn,0,path2,address(this),block.timestamp);
        (uint256[] memory amounts) = routerAddress.swapExactTokensForTokens(tokenA.balanceOf(address(this)),0,path,msg.sender,block.timestamp);
        require(amounts[1]>=amountIn.mul(99).div(100));
    }
