...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xde0Dca51c5C3C9AA3a03a56e4fCA4D5e967eB012; // owner address
...
contract ShibaInuManagerOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Inu Manager";
    string private _symbol = "$SIM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xde0Dca51c5C3C9AA3a03a56e4fCA4D5e967eB012); // Marketing Wallet
    address payable private teamWalletAddress = payable(0xde0Dca51c5C3C9AA3a03a56e4fCA4D5e967eB012); // Team Wallet
