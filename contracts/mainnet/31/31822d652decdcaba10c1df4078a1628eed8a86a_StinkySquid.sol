...
contract StinkySquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stinky Squid";
    string private constant _symbol = "STINKQUID";
    ...
    address private marketingWallet = address(0x03f7f3605d0C65cF69A7B7C4f609A615428ae3Fe);
