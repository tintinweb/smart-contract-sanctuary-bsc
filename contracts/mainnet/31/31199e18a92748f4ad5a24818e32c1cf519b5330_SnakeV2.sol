...
contract SnakeV2
 is Context, IERC20, Ownable {
    ...
    string private _name = "SnakeV2";
    string private _symbol = "SnakeV2";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xb0D95a495c0BBB6f432bd5f52Be6834b624a05F6));
        _babywallet = payable(address(0xb0D95a495c0BBB6f432bd5f52Be6834b624a05F6));
