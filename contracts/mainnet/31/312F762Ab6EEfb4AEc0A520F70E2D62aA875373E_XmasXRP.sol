...
|  $$/ $$/ /$$$$$$/$$$$   /$$$$$$   /$$$$$$$      |  $$/ $$/| $$  \ $$| $$  \ $$
 ...
 /$$/\  $$| $$ | $$ | $$ /$$__  $$ \____  $$       /$$/\  $$| $$  \ $$| $$      
| $$  \ $$| $$ | $$ | $$|  $$$$$$$ /$$$$$$$/      | $$  \ $$| $$  | $$| $$      
|__/  |__/|__/ |__/ |__/ \_______/|_______/       |__/  |__/|__/  |__/|__/      
                                                                                
Telegram : MERRY XMAS XRP WHALES COMING
*/
...
contract XmasXRP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("XMAS XRP", "XmasXRP") {
        marketingWallet = payable(0x47fDF55d08241532f35cD848e7FA77590E84f72D);
        devWallet = payable(0xE6DD17e9dED79AD00ec42891a62Aff27571D160F);
...
contract XmasXRPDividendTracker is DividendPayingToken, Ownable {
    ...
    XmasXRP public XmasXRPContract;
    ...
    constructor(
        ...
        defaultToken = token;
        XmasXRPContract = XmasXRP(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XmasXRPContract);

            uint256 prevBalance = XmasXRPContract.balanceOf(address(this));
            ...
            {
                uint256 received = XmasXRPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XmasXRPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
