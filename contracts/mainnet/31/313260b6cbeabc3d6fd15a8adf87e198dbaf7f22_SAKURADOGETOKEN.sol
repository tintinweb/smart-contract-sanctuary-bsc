...
contract SAKURADOGETOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public sakuraDogeTracker;
    ...
    constructor(
    ) payable ERC20("SakuraDoge","SakuraDoge")  {
        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        _marketingWalletAddress = payable(0x5844E2c04EeC2DBC630983943F35C7371Add6FCb);
        _lpWalletAddress=payable(0xFcF0e03386a81038267E9f08f9E086A77E8b5A41);
        sakuraDogeTracker=0x642B97BCe05bB766f1119A6Ca1F80F9a8318F7DA;
        ...
        dividendTracker = BABYTOKENDividendTracker(
            payable(Clones.clone(sakuraDogeTracker))
        );
