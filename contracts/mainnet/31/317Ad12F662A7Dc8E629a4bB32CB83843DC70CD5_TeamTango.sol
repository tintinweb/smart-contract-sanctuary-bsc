...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2C7924b697c40d3d2e367D2c276EEA58884dDf43; // owner address
...
contract TeamTango is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Team Tango";
    string private _symbol = unicode"TANGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C7924b697c40d3d2e367D2c276EEA58884dDf43); // Marketing Address
    address payable public teamWalletAddress = payable(0x2C7924b697c40d3d2e367D2c276EEA58884dDf43); // Team Address
