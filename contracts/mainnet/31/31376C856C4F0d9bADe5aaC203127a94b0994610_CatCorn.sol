...
// 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/CatCornPortal

// 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/0xCatCorn
...
contract CatCorn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CatCornDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CatCorn", "CatCorn") {
        UtilityWallet = payable(0xf48b9EDA24fb9b668d546Ee5CfA7c525686fa42b);
        DevelopmentWallet = payable(0x83AB7Cf056e286579D1c19a2fe781112faFEE526);
        ...
        dividendTracker = new CatCornDividendTracker(
            payable(this),
            router,
...
contract CatCornDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CatCorn public CatCornContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CatCornContract = CatCorn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "CatCorn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CatCorn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CatCorn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CatCornContract);

            uint256 prevBalance = CatCornContract.balanceOf(address(this));
            ...
            {
                uint256 received = CatCornContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CatCornContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
