...
contract Surgex is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Surgex";
    ...
    //Tax wallets
    address public marketingWallet = 0x1E4771872830B1D8dAEF0516F72B223ed407D0e2;
