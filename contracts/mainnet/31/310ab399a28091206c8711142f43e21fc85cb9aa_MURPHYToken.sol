...
contract MURPHYToken is owned {
    ...
    string constant private _name = "MURPHY";
    string constant private _symbol = "MRP";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 60000000 * (10**_decimals);         //6 CR tokens
    uint256 constant public maxSupply = 60000000 * (10**_decimals);    //6 CR tokens
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        if(burnStart==true)
        {
            burn((_value*Burnpercent)/100);
            _valuee = _value - ((_value*Burnpercent)/100);
        }
        else{
            _valuee = _value;
        }
        ...
        _balanceOf[_to] = _balanceOf[_to].add(_valuee);        // Add the same to the recipient
    ...
    uint256 public airdropFee = 0.05 * (10**18);
    
    uint256 public Burnpercent;   
    bool public burnStart;
    
    function changeBurnStatus(uint256 _Burnpercent, bool _burnStart) onlyOwner public{
