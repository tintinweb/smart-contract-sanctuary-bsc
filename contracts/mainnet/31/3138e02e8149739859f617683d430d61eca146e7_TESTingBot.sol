...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02150aA3aC784b4167B54A7D5815eE86BF51e6A2;
...
contract TESTingBot is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdFE1ee78A45aBb669f1e5F045a77955C5012e4E1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTingBot";
    string private _symbol = "PlsDntBuy";
