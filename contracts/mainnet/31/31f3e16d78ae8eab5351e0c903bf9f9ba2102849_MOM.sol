...
contract MOM is Context, IERC20, Ownable {
    ...
    string private _symbol = "MomCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2eCf1014E1DA7A218b9eA34f9d682271c5952d21);
    address payable public teamWalletAddress = payable(0x2eCf1014E1DA7A218b9eA34f9d682271c5952d21);
    address public immutable deadAddress = 0x2eCf1014E1DA7A218b9eA34f9d682271c5952d21;
