...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x837709A7b751e155CB5072567236547369B2Fcda;
...
contract BabyRocks is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdfb962f3e89376185Cb60ce4928471F816cf64c2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Rocks";
    string private _symbol = "BabyRocks";
