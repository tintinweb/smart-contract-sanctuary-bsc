...
// 
//
// 📱 Telegram:https::https://t.me/+NdDUFlO6ClA5YWNl
/*
...
contract $SantaWhales is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$Santa Whales", "$SantaWhales") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "$SantaWhales";
    string private _symbol = "$SantaWhales";
