...
contract SPO is ERC20 {
    ...
    //测试函数
    function getLpNumber(address addr) public view returns (uint256){
        
        IERC20 mainpair = IERC20(_mainPair);

        return mainpair.balanceOf(addr);
    }
    ...
    function getTotalPair() public view returns (uint256){
        ...
        return mainpair.totalSupply();
    }

    function getExcludeTotalPair() public view returns (uint256){
    ...
    function getLpProviders() public view returns (uint256){
        
        return lpProviders.length;
    }

    function getLpProviderAddress(uint index) public view returns (address){
        
        return lpProviders[index];
    }

    function getExcludeLpProvider(address lpHolderAddress) public view returns (bool){
        
        return excludeLpProvider[lpHolderAddress];
    }

     function getExcludeTotal() public view returns (uint256){
