...
contract yasuo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x43d0A45f01d5904320f072d85FBf181A439C211C); // Marketing Address
    address payable private teamWalletAddress = payable(0x43d0A45f01d5904320f072d85FBf181A439C211C); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000 * 3 **_decimals; 
