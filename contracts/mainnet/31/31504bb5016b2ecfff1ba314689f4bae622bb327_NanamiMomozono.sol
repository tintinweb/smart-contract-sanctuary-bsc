...
contract NanamiMomozono is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nanami Momozono";
    string private _symbol =unicode"桃園 奈々生";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfD80775fE3F379e7f3F32de5a3516F8a2867f1d7);
    address payable public teamWalletAddress = payable(0xfD80775fE3F379e7f3F32de5a3516F8a2867f1d7);
