...
contract DuckyChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ducky Chain";
    string private _symbol = "DUCKY";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x80d1868c050E5e51A8fd698fB807C61257Eca875);
