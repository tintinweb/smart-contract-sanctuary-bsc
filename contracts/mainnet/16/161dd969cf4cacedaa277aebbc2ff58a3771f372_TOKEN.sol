...
abstract contract AbsToken is IERC20, Ownable {
    ...
    bool public killBatch = true;
    function setkillBatchEnable(bool status) public onlyOwner{
        killBatch = status;
    }
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                //
                if (_swapPairList[from] && block.number < goMoonBlock + 100 && killBatch){
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount_all = fistBalance * (_buyFundFee + _sellFundFee) * 2 / swapFee;
        uint256 fundAmount_1 = fundAmount_all / 3;
        uint256 fundAmount_2 = fundAmount_all - fundAmount_1;
        ...
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAmount_all);
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        666,//Supply
        address(0x021aD1147e5f218199f1Cffcce152DE1c34796a8),//FundAddress 1%
        address(0xEe6f57315D7af83541688F4Ed39fA2cAC8036265),//FundAddress 2%
        address(0x8B724457Bc1Eb92ae04b5AcD4581ea6129247e78)//ReceiveAddress
    ){
    }
}