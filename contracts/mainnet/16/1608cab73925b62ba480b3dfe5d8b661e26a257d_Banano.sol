...
abstract contract ERC20Detailed is IERC20 {
    ...
    function bname() public view returns (string memory) {
        return _name;
    }

    function bsymbol() public view returns (string memory) {
        return _symbol;
    }

    function bdecimals() public view returns (uint8) {
        return _decimals;
    }
}
...
contract Banano is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Banano v1 (Stealth)", "BNNO", uint8(DECIMALS)) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //SSHI 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        TreasuryReceiver = 0xF4173826EBe06d6Be6991cF265623951Ca424727;
        RiskFreeValueReceiver = 0xF4173826EBe06d6Be6991cF265623951Ca424727;
