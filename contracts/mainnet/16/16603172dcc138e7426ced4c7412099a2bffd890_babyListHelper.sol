...
interface Token {
    function babyList(address _userList) external view returns (bool);
}


contract babyListHelper {
    Token public _token = Token(0x9Dd812A7365fc34C729E7E336be5BaF9180a37f8);
    function getBabyList(address[] memory _userList) external view returns(address[] memory _returnList) {
        uint256 num = 0;
