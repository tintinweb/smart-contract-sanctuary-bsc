...
contract AnimePlanet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anime Planet Crypto";
    string private _symbol = "Anime";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x18aef80D6ec0ed06aEEaf73f297E3b774beddd5e); 
    ...
    uint256 public _sellDevelopmentFee = 18;
