...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1dF48d00419709B5e12451f263a4dfc7ead35FCE;
...
contract FighterRoosters is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x981489A1D28AF91d3308288f7CfFCe784d857754;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FighterRoosters";
    string private _symbol = "FTR";
