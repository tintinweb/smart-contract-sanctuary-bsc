...
contract Ownable is Context {
    ...
    constructor () 
    {
        address msgSender = 0xdAeEafba811aB350bD5174FEd98014E9abC44bc1;
        _owner = msgSender;
...
contract Lifebex is Context, IERC20, LockToken {
    using SafeMath for uint256;
    using Address for address;
    
    address public developerWalletAddress = 0x92358AbBfa2C966130236790571BD010d0D0d463; // Developer wallet Address.
    ...
    string private _name = "Lifebex";
    string private _symbol = "LFX";
    ...
    uint256 private minimumTokensBeforeSwap = 1_00_000_000 * 10**18; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        amount = amount.sub(developerTokens).sub(burnTokens);
        ...
        {
            _transferStandard(sender, developerWalletAddress, developerTokens);
        }
        if(burnTokens > 0)
        {
    ...
    {
        _amount = _amount.div(100-_burnFee-_developerFee).mul(100);
    ...
    function setdeveloperWalletAddress(address _developerWalletAddress) external onlyOwner() {
        developerWalletAddress = payable(_developerWalletAddress);
    }
