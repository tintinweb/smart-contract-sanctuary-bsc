...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x6A2A1e3905E859D614C1ee29176b545f7e6Cacc6;
    }
}
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    string private _name     = "TEST TO";
    string private _symbol   = "KIKH2";
    uint8 private  _decimals = 18;

    uint256 public _taxFee = 0;
    uint256 public _liquidityFee = 38;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        require(taxFee <= 40, "Holder Reflection cannot exceed 40%");
        _taxFee = taxFee;
    }

    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee <= 40, "Liquidity Fee cannot exceed 40%");
