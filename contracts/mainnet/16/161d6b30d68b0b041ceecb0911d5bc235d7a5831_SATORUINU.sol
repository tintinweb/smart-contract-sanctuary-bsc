...
Website : https://satoruinu.fun

Telegram: https://t.me/satoruinu

Twitter : https://twitter.com/inu_satoru
...
/* Token contract */
contract SATORUINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x76507b69D02bc485147bAf4870499602b3d40DeC;
    ...
    // Name and symbol
    string constant _name = "SATORU INU";
    string constant _symbol = "SATORUINU";
    ...
    uint256 public gameDevelopmentbuy = 0;
    ...
    uint256 public gameDevelopmentSell = 0;
    ...
    uint256 public swapThreshold = _totalSupply * 35 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x76507b69D02bc485147bAf4870499602b3d40DeC;
        marketingFeeReceiver = 0x76507b69D02bc485147bAf4870499602b3d40DeC;
    ...
    function setCorrectFees(bool isSell) internal {
        if(isSell){
            ...
            gameDevelopment = gameDevelopmentSell;
            ...
            gameDevelopment = gameDevelopmentbuy;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(gameDevelopment).div(totalBNBFee); 
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _gameDevelopmentbuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        reflectionFeeBuy = _reflectionFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        gameDevelopmentbuy = _gameDevelopmentbuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_reflectionFeeBuy).add(_marketingFeeBuy).add(_gameDevelopmentbuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _gameDevelopmentSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        reflectionFeeSell = _reflectionFeeSell;
        marketingFeeSell = _marketingFeeSell;
        gameDevelopmentSell = _gameDevelopmentSell;
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_reflectionFeeSell).add(_marketingFeeSell).add(_gameDevelopmentSell);
        feeDenominator = _feeDenominator;
    }
