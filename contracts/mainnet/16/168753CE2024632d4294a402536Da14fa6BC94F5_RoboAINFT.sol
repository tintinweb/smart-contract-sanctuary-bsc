...
/*
Robo AI is a collection of algorithmically generated droid characters designed by Robo AI NFT
The RoboAI team are Meela, Lulu, Zackboto, Niklas, Bureboto, Ireboto, Captain Excellent, Jaboto, Darude, the Bueno Team, and Pablo Stanley

https://t.me/RoboAINFT
https://robotainft.store/
*/
...
contract RoboAINFT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Robo AI NFT";
    string private constant _symbol = "ROBO";
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =  300000000  * 10**_decimals;

    uint256 public _maxWalletAmount = 6000000 * 10**_decimals;
    uint256 public _maxTxAmount = 6000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1500000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 2701 && !stage3) {
            _maxWalletAmount = 6000000 * 10**_decimals;
            _maxTxAmount     = 6000000 * 10**_decimals;
