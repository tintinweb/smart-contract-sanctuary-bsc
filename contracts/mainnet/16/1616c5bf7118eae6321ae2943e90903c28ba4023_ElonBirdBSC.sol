...
contract ElonBirdBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Bird BSC";
    string private _symbol = "EBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3fD1cf2F3D3418Eaf71F3AAFa39E84F85eE2B13A);
    address payable public teamWalletAddress = payable(0x3fD1cf2F3D3418Eaf71F3AAFa39E84F85eE2B13A);
