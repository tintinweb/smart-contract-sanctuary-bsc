...
contract ElonsBoredApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ElonsBoredApe";
    string constant _symbol = "$EBA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 private _maxTxAmount = ( _totalSupply * 6 )  / 200; //3

    //max wallet holding of 3%
    uint256 private _maxWalletToken = ( _totalSupply * 3 ) / 100; //3
    ...
    uint256 private teamFeeSell         = 2;
    uint256 private giveawayFeeSell     = 0;
    uint256 private totalFeeSell = 11; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xA505A9553baCBad1853629a665b407FC38c9B45C;
        ...
        marketingFeeReceiver = 0x49AA50A875F8A335732873bF27fCBc6E769686C6;
        teamFeeReceiver = 0xe3011153d1D0Bd3463134dC3Efa8ef50D3bdcc7b;
        giveawayFeeReceiver = 0xef61F646f0403a4c9e6004C3A196f3831729516C;//36
