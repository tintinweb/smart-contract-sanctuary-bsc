...
/**
       🚀Join telegram : https://t.me/BuffedMilo

       🌐Website : https://buffedmilo.com ( TBA ) est. 30-45 mins

       🐦 Twitter : https://twitter.com/BuffedMilo
*/
...
contract BuffedMilo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BuffedMilo"; 
    string private _symbol = "B-Milo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD2F76ED46F32aDB0e848074305AbC30F608c630A);
    address payable public teamWalletAddress = payable(0xD2F76ED46F32aDB0e848074305AbC30F608c630A);
