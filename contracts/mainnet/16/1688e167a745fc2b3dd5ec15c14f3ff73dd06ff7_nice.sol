...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x6cd82Cdb36025847CB6094E18cc87da3A41299db;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x6cd82Cdb36025847CB6094E18cc87da3A41299db),//fund 

        address(0x6cd82Cdb36025847CB6094E18cc87da3A41299db)//dev 
    ){
