...
contract BloodyMoonShot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOODY MOON SHOT";
    string private _symbol = "$BloodyMoonShot";
    ...
    uint256 private _totalSupply = 3 * 10**12 * 10**9;
    ...
    address payable public marketingWalletAddress = payable(0x6ee272C618A415b29431435f2e15BaA11599357E); 
    address payable public rewardsWalletAddress = payable(0x85BD6268bE5b5e5EE3C0A8153982b1EF102107F3); 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee).add(_reflectionFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBRewards = amountReceived.mul(_reflectionFee).div(totalBNBFee);
