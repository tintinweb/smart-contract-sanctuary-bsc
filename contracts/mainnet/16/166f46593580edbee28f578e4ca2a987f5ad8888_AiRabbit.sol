...
contract AiRabbit is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("AiRabbit", "AiRabbit") {
        ceo = _msgSender();
        ...
        address _marketingAddress = 0xe38d4674ec8292AD37bcF53f7c02BF5Fe8336c5f;
        mkt = new MktCap(ceo, _baseToken, _router, _marketingAddress);
        _approve(address(mkt), _router, uint256(2**256-1));

        address _initHolder = 0xeff70D6d27c9faff3eAb128a20F6E901F516BD97;
