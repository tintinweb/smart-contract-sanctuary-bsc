...
// File: contracts/strategies/USDDLPStrategyStakeOnlyV3.sol
...
contract USDDLPStrategyStakeOnlyV3 is Ownable {
    using SafeMath for uint256;
    ...
    */
    ...
    function checkHarvestWBNB() internal view returns (uint256) {
        ...
        if(usddAmount > 0){
            ...
            uint256 outAmount = CurveLikeExchange(USDD_BUSD_POOL_ADDRESS).get_dy(0, 1, usddAmount);
    ...
    function harvestRewards() internal {
        ...
        if(usddAmount > 0){
            ...
            CurveLikeExchange curve = CurveLikeExchange(USDD_BUSD_POOL_ADDRESS);
            ...
            curve.exchange(0, 1, usddAmount, 1);
