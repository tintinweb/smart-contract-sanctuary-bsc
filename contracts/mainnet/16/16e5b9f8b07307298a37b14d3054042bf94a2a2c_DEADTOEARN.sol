...
contract DEADTOEARN is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEAD TO EARN";
    string private constant _symbol = "DTA";
    ...
    address private marketingWallet = address(0x01e51686Fc3F1C090C8217b8E580C0D8BECA6bd4);
    address private liquidityReceiver = address(0x01e51686Fc3F1C090C8217b8E580C0D8BECA6bd4);
