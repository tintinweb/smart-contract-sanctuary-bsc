...
contract Perp is PerpContext, PerpIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Perp Inu";
    string private _symbol = "PERPINU";
