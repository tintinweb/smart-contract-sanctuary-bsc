...
contract BBSHIDO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Shido";
    string private _symbol = "BBSHIDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CB8f64cCDD44b11b853AF3cA30Fe5EDc051c582); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4e6d8314be77825B5B34b5fb936Ca898d016C610); // BuyBack Address
