...
contract  LFGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LFGrow";
    string private _symbol = "LFG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd386D8186dD84728e0dB0E1F2D215217f276862);
    address payable public teamWalletAddress = payable(0xA2319E75692fB25bcAe5D14D900056f9A01c8032); 
