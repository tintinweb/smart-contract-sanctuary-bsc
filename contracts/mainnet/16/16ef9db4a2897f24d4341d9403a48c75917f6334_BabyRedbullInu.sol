...
/*
TG OF COIN: https://t.me/BabyRedbullinu
*/
...
contract BabyRedbullInu  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyRedBullInu";
    string private _symbol = "$BBYREDBULL";
