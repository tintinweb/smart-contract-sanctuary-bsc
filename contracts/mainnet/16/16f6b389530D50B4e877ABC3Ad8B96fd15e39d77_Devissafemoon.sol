...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43CEF530747C6944C1142a1C8E777F2D93057110; // owner address
...
contract Devissafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev is Safemoon";
    string private _symbol = "DSafemoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x226FC2dbDC6bD488A712bF40DA6a576d9A035236); // Marketing Address
    address payable public buybackWalletAddress = payable(0x226FC2dbDC6bD488A712bF40DA6a576d9A035236); // Buyback Address
