...
contract BabyScat
 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyScat";
    string private _symbol = "BabyScat";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x77362260714fE5882776205746de2EF51920119D));
        _anotherA = payable(address(0x77362260714fE5882776205746de2EF51920119D));
