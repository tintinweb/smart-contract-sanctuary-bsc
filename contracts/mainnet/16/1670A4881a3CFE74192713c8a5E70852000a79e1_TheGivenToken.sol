...
/*
Telegram: https://t.me/giventoken

Web: https://thegiventoken.com/
*/
...
contract TheGivenToken is IBEP20, Auth {
    ...
    string constant private _name = "The Given Token";
    string constant private _symbol = "TGT";
    ...
    address public varMarketingFeeReceiver = 0xCeE94FBD6d1F203Db10534b855F1D4FFbbdad246;
    address public devFeeReceiver = 0xEB518da47c6F20360d6524Cf3e93A174d272Fb65;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(liq_fee).div(totalFee).div(2);
        ...
        uint256 totalBNBFee = totalFee.sub(liq_fee.div(2));
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _varMarketingFee, uint256 _liq_fee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        liq_fee = _liq_fee;
        varMarketingFee = _varMarketingFee;
        devFee = _devFee;
        totalFee = _liq_fee.add(_varMarketingFee).add(_devFee);
