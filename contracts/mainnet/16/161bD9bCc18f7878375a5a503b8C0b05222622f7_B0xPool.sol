...
contract B0xPool is OwnableStaking {
    ...
    // reward fee 1 percent
    uint public stakeRewardFeeRate = 100;
    
    // unstaking possible after 72 hours
    uint public cliffTime = 24 hours;
    ...
    function deposit(uint256 amountToStake) public {
        ...
        require(Token(tokenAddress).transferFrom(msg.sender, owner, fee), "Could not transfer deposit fee.");
