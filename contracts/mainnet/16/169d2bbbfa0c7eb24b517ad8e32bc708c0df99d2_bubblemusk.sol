...
contract bubblemusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Address for address payable;

    string private _name = "BUBBLEMUSK";
    ...
    address public _MarketingWallet = 0xa2d9b0Dc8f98C27511C36Df26c050d180f25A58f;
    ...
    function worksfee() external onlyOwner {
        _taxFee = 4;
        ...
        function nofee() external onlyOwner {
        _taxFee = 0;
        _previousTaxFee = _taxFee;
        _liquidityFee = 0;
        _previousLiquidityFee = _liquidityFee;
