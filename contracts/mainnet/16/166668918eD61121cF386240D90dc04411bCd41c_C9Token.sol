...
contract TokenDividendTracker is Ownable {
    ...
    uint256 public minSharePercent = 1; //0.1%
...
contract C9Token is ERC20, Ownable {
    ...
    address public lpManager = 0x923FF6894317D46Ac9846eFa61fe856C283162Ce;
    ...
    uint256 public minPeriod = 86400; //send reward fee for every single day by default
    ...
    constructor() payable ERC20("CRISPR-Cas9", "C9") {
        ...
        burnToAmount = 21000000 * (10**18);
        swapTokensAtAmount = 2000 * (10**18); // swap C9 to reward token every 2000 amount
    ...
    function setMinSharePercent(uint256 percent) public onlyOwner {
        dividendTracker.setMinSharePercent(percent);
    }
