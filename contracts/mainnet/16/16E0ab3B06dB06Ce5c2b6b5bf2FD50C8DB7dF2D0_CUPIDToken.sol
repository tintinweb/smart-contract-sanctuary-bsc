...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 50000 * 10**18;
    string private _name = "SMD";
    string private _symbol = "SMD";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x7567fF2ca65BC68D4CDD3C65d02a8bdD21E2FF2E);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 50000 * 10**18;
