...
// SPDX-License-Identifier: Unlicensed
    ...
    contract LOCK is ERC20 {
        ...
        function includeAndExcludeInWhitelist(address account, bool value) private onlyOwner {
        ...
        function setMaxWalletBalance(uint256 maxBalancePercent) internal onlyOwner {
        _maxWalletBalance = maxBalancePercent * 10** decimals();
        }

        function setMaxTxAmount(uint256 maxTxAmount) internal onlyOwner {
