...
/**
Shikigami was deployed on the Binance Smart Chain by an unknown individual and handed over to the community.
...
Join our community Telegram: https://t.me/shikigamibscofficial
*/
...
contract Shikigamibsc is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xBE8ca15F5e07B533f91b7F583A0343B9192D2831); 
    address payable private Wallet_Dev = payable(0xBE8ca15F5e07B533f91b7F583A0343B9192D2831);
    ...
    string private constant _symbol = "SHIKIGAMI"; 
    ...
    constructor () {
        ...
        _owner = 0xBE8ca15F5e07B533f91b7F583A0343B9192D2831;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xBE8ca15F5e07B533f91b7F583A0343B9192D2831); // Testnet
