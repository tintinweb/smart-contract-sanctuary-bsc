...
/**
Ikanami inu  inu stealth launch

Ikanami inu is your next BSC moonshot and a rare BSC gem. Ikanamiinu is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.
...
pragma solidity ^0.6.12;
    ...
    contract Ikanamiinu is Context, IERC20, Ownable {
        ...
        string private _name = 'Ikanami inu';
        string private _symbol = 'Ikanami inu';
