...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0x4f31CC7fd4e5A0FE7D1941a19ec1Ea7EECa2044d);
...
contract TwitterDOGE2 is ExcludedFromFeeList, BlackList, DividendFee {
    ...
    constructor() ERC20("TwitterDOGE2.0", "TwitterDOGE2.0", 18) DividendFee() {
