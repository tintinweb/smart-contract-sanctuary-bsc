...
contract MiniBNB is IBEP20, Auth {
    ...
    string constant _name = "Mini BNB";
    ...
    address private AntiBotmarketingWallet;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[AntiBotmarketingWallet] = true;
        ...
        AntiBotmarketingWallet = 0x8eA0F12b455200835b0c6619dF3563Fa0C683c6f;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newAntiBotmarketingWallet) external authorized {
        autoLiquidityReceiver = newLiquidityReceiver;
        marketingWallet = newMarketingWallet;
        AntiBotmarketingWallet = newAntiBotmarketingWallet;
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 AntiBotmarketingShare = amountBNBMarketing.sub(marketingShare);
        
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 30000}("");
        (bool tmpSuccess1,) = payable(AntiBotmarketingWallet).call{value: AntiBotmarketingShare, gas: 30000}("");
