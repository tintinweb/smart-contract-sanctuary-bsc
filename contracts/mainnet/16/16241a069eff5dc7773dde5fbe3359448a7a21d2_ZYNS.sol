...
contract ZYNS is ERC20, Ownable {
    ...
    constructor(
        ...
        address[5] memory addrs, // reward, router, marketing wallet, dividendTracker, owner
        uint256[2] memory buyFeeSetting_, // rewards,market
        uint256[2] memory sellFeeSetting_,// rewards,market
    ...
    function setBuyTaxes(uint256 rewardsFee, uint256 marketingFee) external onlyOwner {
        require(rewardsFee.add(marketingFee) <= 100, "Total buy fee is over 100%");
        buyTokenRewardsFee = rewardsFee;
        buyMarketingFee = marketingFee;
    }

    function setSelTaxes(uint256 rewardsFee, uint256 marketingFee) external onlyOwner {
        require(rewardsFee.add(marketingFee) <= 100, "Total sel fee is over 100%");
