...
Telegram : https://t.me/busdmoon
Website: https://busdastro.trade/
...
contract busdastro is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSD ASTRO";
    string constant _symbol = "$BUSDASTRO";
