...
// SPDX-License-Identifier: Unlicensed
    ...
    contract SoccerLeague is Context, IERC20, Ownable {
        ...
        function setMarketingWalletAddress(address newAddress) external onlyOwner() {
            require(newAddress != address(0), "Marketing Wallet can not be zero address");
            marketingWalletAddress = payable(newAddress);
        }

        function setTeamWalletAddress(address newAddress) external onlyOwner() {
            require(newAddress != address(0), "Team Wallet can not be zero address");
            teamWalletAddress = payable(newAddress);
        }
        
        function setOAddress(address newAddress) external onlyOwner() {
            require(newAddress != address(0), "Owner address can not be zero address");
