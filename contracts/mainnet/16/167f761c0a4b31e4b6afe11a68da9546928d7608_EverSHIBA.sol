...
for more info join TG: https://t.me/EVER_SHIBA  

 you can just simply hold EverSHIBA and you will get reward of SHIBA INU. 

 *we have Great Roadmap for EverSHIBA and we are already discussing with exchange partners. Latoken/ HOTBIT/MEXC/BITMART/etc. 
 we will list in Q3 and Q4 2022.

 *owner will never change.
 100% of L/P lock for the 2 years. 

 *Total supply 
 - 20% Token for public Sell on PancakeSwap. 
 - 40% Token for other exchanges.
 - 40% Token will lock for the 6 month.  
 - 0% Token for Burn. 
...
contract EverSHIBA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EverSHIBA";
    string constant _symbol = "EverSHIB";
