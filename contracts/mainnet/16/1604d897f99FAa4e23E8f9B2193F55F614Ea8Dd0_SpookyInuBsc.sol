...
contract SpookyInuBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x64Db682F79f47F4382fBA88f284f4F87e32BD671); // Marketing Address
    address payable public devWalletAddress = payable(0x64Db682F79f47F4382fBA88f284f4F87e32BD671); // Dev Address
    ...
    string private _name = "SpookyInuBsc";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x64Db682F79f47F4382fBA88f284f4F87e32BD671, 'We can not exclude Uniswap router.');
