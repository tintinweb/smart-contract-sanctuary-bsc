...
RENOUNCED
LP LOCK (always extend if the community is strong)
NO DEV WALLET
VERIFIED CONTRACT
-----------------------
Supply: 1.000.000.000.000 $TEKKEN
LIQUIDITY 2%
MARKETING 2%
REFLECTION 3%
 * 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0B04cD90B0be10fd64D14de951f1EbD5bE5c3107;
...
contract BabyTEKKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeF1FDC62DaAF9A92566Fb3A73b167C972Ed66A6D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BABY TEKKEN";
