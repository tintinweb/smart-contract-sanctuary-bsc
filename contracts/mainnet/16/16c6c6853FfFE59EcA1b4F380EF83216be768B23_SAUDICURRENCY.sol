...
/* Token contract */
contract SAUDICURRENCY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x0898cC13134610A7087335AD2B992a0Ba385B9Df;
    ...
    // Name and symbol
    string constant _name = "SAUDI CURRENCY";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 1000; // KILL ZERO 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000; // KILL ZERO 
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 1000; // KILL ZERO 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0898cC13134610A7087335AD2B992a0Ba385B9Df;
