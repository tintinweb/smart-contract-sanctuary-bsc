...
contract HFSP is Context, IERC20, Ownable {
    ...
    string private _name = "#HFSP";
    string private _symbol = "#HFSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B4734cfF574cE4Fa7F711531307852eCCddBBA6); // Marketing Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= _totalSupply / 10, "Cannot set MaxTxAmount lower than 0.1%");
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= _totalSupply / 10, "Cannot set MaxWallet lower than 0.1%");
        _walletMax  = newLimit;
    }
