...
contract PIGTOKENTWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pig Token 2.0";
    string private _symbol = "PIGTWO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4bC8E0a2e47B3cD541536C5838a3116277d250CB); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x4bC8E0a2e47B3cD541536C5838a3116277d250CB); // Team Address
