...
contract token is ERC20,WhiteList {
    ...
    IERC20 public RewardTokenTwo = IERC20(0x156ab3346823B651294766e23e6Cf87254d68962); //LUNA
    address public pairToken = address(0x55d398326f99059fF775485246999027B3197955); 
    ...
    function _transfer(
        ...
        if(!isWhiteListed(to)){
            require(swappause);
            if(startTime.add(endtime) > block.timestamp && to != uniswapV2Pair){
            ...
            if(holderSize >20){
                for(uint256 i=0;i<20;i++){
                    ...
                    if(balanceOf(user) >= 0){
                        ...
                        uint256 amountReward = thisAmount.mul(rate).div(10000);
                        if(amountReward>10**13){
