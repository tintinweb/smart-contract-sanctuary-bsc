...
contract yessss is Context, IERC20, Ownable {
    ...
    string private _name = "yessss";
    string private _symbol = "yessss";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x390348d82F6f1a0B0a54dAaC0D72331Cd4197bc0); 
    address payable public BurnedWalletAddress = payable(0x390348d82F6f1a0B0a54dAaC0D72331Cd4197bc0); 
