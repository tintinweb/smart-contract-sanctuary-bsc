...
contract FUSHIGUROINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUSHIGURO INU";
    string private _symbol = "FINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf988D08c9034Cb2639d2eaa3A16cD4e9A6a14b5D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xf988D08c9034Cb2639d2eaa3A16cD4e9A6a14b5D); // Team Address
