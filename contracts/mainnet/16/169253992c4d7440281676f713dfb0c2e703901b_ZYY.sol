...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x9eec86203AD6A0A304f9B892b116Ce7b0384A575;//   营销
...
contract ZYY is Token {
    constructor() Token(
        ...
        address(0x68D8a29AB048A07F5A9f62978BC1C020dDF06e51),//fund address
    
        address(0x68D8a29AB048A07F5A9f62978BC1C020dDF06e51)//dev address
    ){
