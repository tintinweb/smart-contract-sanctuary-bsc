...
// ███████╗██║███████╗╚█████╔╝██║██║░╚███║╚██████╔╝
// ╚══════╝╚═╝╚══════╝░╚════╝░╚═╝╚═╝░░╚══╝░╚═════╝░
// https://www.zizoinu.finance/
// https://t.me/zizoinu_bsc
// https://twitter.com/zizoinu
/**
...
contract ZizoInu is ERC20("ZizoInu", "ZIZO"), Ownable {
    ...
    address public marketingWallet = 0x923120EfF50DA5ccda903345c204899822FF3855;
    ...
    function openTrading() external onlyOwner {
     ...
     function openTradingOngoing() external onlyOwner {
        _tradingOpen = false;
        swapAndWithdrawEnabled = false;
    }
        ...
        returns (uint256)
    {
        require(
            ...
            "ZIZO::getPriorVotes: not yet determined"
        );
