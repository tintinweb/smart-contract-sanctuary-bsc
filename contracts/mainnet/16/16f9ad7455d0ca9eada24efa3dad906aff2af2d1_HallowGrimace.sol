...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59B22A61e3Bd0CA81A5FA9Edb15D5d989c868425; // owner address
...
contract HallowGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hallow Grimace";
    string private _symbol = "HG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52C4944484a76c25f74dd7F77D6DAdbEcbe82cE9); // Marketing Address
    address payable public teamWalletAddress = payable(0x52C4944484a76c25f74dd7F77D6DAdbEcbe82cE9); // Team Address
