...
contract BJcoin is Context, IERC20, Ownable {
    ...
    string private _name = "BJ coin";
    string private _symbol = "BJ coin";
    ...
    address payable public marketingWallet = payable(0xa9bA6265D5a11B91579fEFA26D7F458eA89a744d);
    address payable  public devWallet = payable(0x5357d20144d18cC8f52d5EaAb5dE956D09238C99);
