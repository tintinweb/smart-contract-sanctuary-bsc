...
contract MetaWay is IERC20, Ownable {
    ...
    constructor(address tokenOwner) {
        ...
        _launchedAt = 1647691200;

        // pancakeswap router02
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        // Create a pancakeswap pair for this new token
        // BSC-USD
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56));
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        if(msg.sender == uniswapV2Pair || msg.sender == fnswapPair || recipient == swapPairList[recipient] ){
    ...
    function _transfer( address from, address to, uint256 amount) private {
        ...
        if(!_authList[from] && !_authList[to]){
            require(block.timestamp > _launchedAt, "Trading not open yet");
        }
    ...
    function setLaunchedAt(uint256 t) public onlyOwner {
        _launchedAt = t;
    }
