...
/**
TOKEN NAME: Shinzigami
TICKER: SGAMI

Shinzigami is a meme token + community cryptocurrency project that's completely based off of Shinzi Network.
...
0% airdrops/team tokens

Sell Tax : 7% (15% sell tax first HOUR after launch and then tax will be reduced to 7/7 permanetly)
Developer 
Marketing
Liqudity

1.5% max TRX, 1.5% max wallet (possible increase overtime)

TG: https://t.me/Shinzigami
Twitter:  https://twitter.com/shinzinetwork
Website: https://shinzi.io
*/
...
contract SGAMI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinzigami";
    string private constant _symbol = "SGAMI";
