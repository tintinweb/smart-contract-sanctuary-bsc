...
contract MAFIA is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'MAFIA: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'MAFIA: incorrect fee percent');
        require(owner != address(0), 'MAFIA: incorrect owner address');
        require(mintToAddr != address(0), 'MAFIA: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'MAFIA: transfer from the zero address');
        require(recipient != address(0), 'MAFIA: transfer to the zero address');
