...
contract CompoundInu is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Test Contract", "TestCT", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x63CBCfB12d0c8d27c52338E6Dfa0CE95B3915Bd3;
        TreasuryReceiver = 0x63CBCfB12d0c8d27c52338E6Dfa0CE95B3915Bd3;
        DevelopmentReceiver = 0x63CBCfB12d0c8d27c52338E6Dfa0CE95B3915Bd3 ;
    ...
    function _transferFrom(
        ...
        if (
            ...
            require(!isTransfer,"Not transfer!");
            ...
            if(tradeData[sender].lastTradeTime <= launchTime + 172800){
                sellPercent = this.balanceOf(sender).mul(1).div(100);
            }
            else if(launchTime + 172800 < tradeData[sender].lastTradeTime && tradeData[sender].lastTradeTime <= launchTime + 345600){
                sellPercent = this.balanceOf(sender).mul(2).div(100);
            }
            else if(tradeData[sender].lastTradeTime > 345600){
    ...
    {       
        ...
        _swapTokensForBNB(devAmount,DevelopmentReceiver);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHDevelopment = amountETH.mul(buyDevelopmentFee.add(sellDevelopmentFee)).div(totalETHFee);
