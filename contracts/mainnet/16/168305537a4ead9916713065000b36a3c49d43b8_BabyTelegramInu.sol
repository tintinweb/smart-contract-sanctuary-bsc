...
contract BabyTelegramInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Telegram Inu";
    string private _symbol = "BABYTINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x3ab5fbeF689e9af1F2a028D375BC7762Cd858299);
