...
contract HongKong is Context, IERC20, Ownable {
    ...
    string private _name = "Hongkong";
    string private _symbol = "HK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6a44F2E793C875c1b82B97147264FFBFc568505C);
    address payable public buyBackWalletAddress = payable(0x6a44F2E793C875c1b82B97147264FFBFc568505C);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply / 500; 
