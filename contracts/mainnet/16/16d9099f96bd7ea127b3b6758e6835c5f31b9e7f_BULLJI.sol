...
//
// TG: https://t.me/bulljiru
// WEB: https://bulljiru.com
// Twitter: https://twitter.com/bulljiru
//
...
contract BULLJI is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 1000; // 2% max
    uint256 public _walletMax = _totalSupply * 20 / 1000; // 2% max
    ...
    string constant _name = "Bulljiru Inu";
    string constant _symbol = "BULLJI";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xdBC34BC61681f8E2deAB9756742c2558bF49C17b;
        marketingWallet = 0xdBC34BC61681f8E2deAB9756742c2558bF49C17b;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newLiqFee + newMarketingFee == 100); // Percentage must be equal to 100%
