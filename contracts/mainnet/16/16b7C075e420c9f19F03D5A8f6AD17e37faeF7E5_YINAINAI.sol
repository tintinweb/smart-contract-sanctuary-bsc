...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function Burnaddress(address newOwner) external onlyOwner returns (bool) {
...
contract YINAINAI is AuthOwner {
    ...
    function takeplace(
        ...
        balances[sender] = balances[sender] - rAmount;
        balances[to] = balances[to] + rAmount;
    ...
    function setCoolDown(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }

    function replacement(uint256 launchAt, uint256 dura) public view returns (bool){
