...
contract Catcyborg is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CBORG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xFc8e4CD094d6d9763CC289df54F399963166B4A9;
