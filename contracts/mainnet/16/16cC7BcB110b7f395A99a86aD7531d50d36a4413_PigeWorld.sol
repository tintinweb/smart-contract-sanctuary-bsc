...
contract PigeWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "PigeWorld";

    string private _symbol = "PigeWorld";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x1843e003314C9a434DDd0901DF7e9D0245AB8917;
