...
contract Shuiniu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shuiniu";
    string private _symbol = "$SHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBbc26bCFCDfcc3B11913aEF411b8bC577C867247);
    address payable public teamWalletAddress = payable(0xBbc26bCFCDfcc3B11913aEF411b8bC577C867247);
