...
contract CZ20 is IBEP20, Ownable {
    ...
    string constant _name = "CZ 2.0";
    string constant _symbol = unicode"CZTWOZERO";
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 3, 1, 0);
    Fees public sellFees    = Fees(1, 3, 1, 0);
