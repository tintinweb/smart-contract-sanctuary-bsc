...
contract  SafemoonTwoge is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Twoge";
    string private _symbol = "SMT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x850863EC09B3Acc6B2EAB5Df9AdEb01B99b56Ad6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x850863EC09B3Acc6B2EAB5Df9AdEb01B99b56Ad6); // BuyBack Address
