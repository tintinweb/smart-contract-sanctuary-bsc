...
contract SkateBoardToken is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 0;
    uint256 public marketingFeeOnSell = 0;

    address public marketingWallet = 0xA9CFd52656221801982d74D7fA0E29ea6C13cB5A;
    ...
    constructor () ERC20("SkateBoard", "SkateBoard") 
    {   
