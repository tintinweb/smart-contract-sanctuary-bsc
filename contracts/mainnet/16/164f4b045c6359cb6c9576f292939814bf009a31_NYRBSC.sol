...
//https://t.me/NewyearresolutionBSC
...
contract NYRBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW YEAR RESOLUTION BSC";
    string private _symbol = "NYRBSC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x39406fBc95a7653017F5B9Fcc7fe3a3aF5035Fa6); // Marketing Address
    address payable public BuyBackWallet = payable(0x39406fBc95a7653017F5B9Fcc7fe3a3aF5035Fa6); // Team Address
