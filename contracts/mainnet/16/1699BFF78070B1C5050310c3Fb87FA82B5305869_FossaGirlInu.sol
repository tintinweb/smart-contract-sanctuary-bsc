...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33951AB9bc8356c9b77098B9970189377B4C6d5E;
...
contract FossaGirlInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOSSA GIRL INU"; // 
    string private constant _symbol = "FGI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x33951AB9bc8356c9b77098B9970189377B4C6d5E);
