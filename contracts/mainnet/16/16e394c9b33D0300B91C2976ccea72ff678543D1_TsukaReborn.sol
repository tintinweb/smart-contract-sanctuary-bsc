...
Community token: Make TG you lazy fucks.
...
contract TsukaReborn is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TsukaReborn";
    ...
    uint256 public _maxSellTxAmount = _totalSupply.div(100).mul(50);
    uint256 public _maxWalletToken = _totalSupply.div(100).mul(50);
