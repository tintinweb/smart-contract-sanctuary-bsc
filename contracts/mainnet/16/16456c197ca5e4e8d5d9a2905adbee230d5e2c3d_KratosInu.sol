...
contract KratosInu is Context, IERC20, Ownable {
    ...
    string private _name = "KratosInu"; 
    string private _symbol = "Krat"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB1cC7A5448e51A6537B7410CdD787ed3B8478f50); 
    address payable public teamWalletAddress = payable(0x31410E80bF5c8b479B7B178F18eb88F9629944a1); 
