...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"无无";
    string private _symbol = unicode"无无";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x4C8FF216f3d4E176eA176379fe1dD93121BB0000); 
    address payable public BurnedWalletAddress = payable(0x4C8FF216f3d4E176eA176379fe1dD93121BB0000); 
