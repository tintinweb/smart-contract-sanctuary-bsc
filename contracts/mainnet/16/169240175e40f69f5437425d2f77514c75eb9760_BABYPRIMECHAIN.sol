...
contract BABYPRIMECHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Prime Chain";
    ...
    address payable public teamWalletAddress = payable(0x734F63b8783ea3cB39ff98Ecf7a74B78Ff90A619); 
