...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x023560Eda764FAF999e333B4cECE657Ae8F93B7A;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x023560Eda764FAF999e333B4cECE657Ae8F93B7A),//fund 

        address(0x023560Eda764FAF999e333B4cECE657Ae8F93B7A)//dev 
    ){
