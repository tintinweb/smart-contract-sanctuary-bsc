...
/**
(BSC) Shibarium Hunter 🃏 
Gamble 🎲  $Shunter. Just launched , degen for now. Shibarium plays have been well. 
Locked and renounced. Dyor as always fam

Locked
Renounced 
5/5

$SHUNTER aims to build a platform for users to find early access to projects related to Shibarium. 
Our dapp will allows users to get early access to Shibarium ecosystem projects. By extracting 
valuable insights from token names we will help you make smarter investment decisions. 
Some of the main features we will include are identifying patterns, trending words, high potential 
tokens, scam detection, word matching and more. 

SOCIALS:

Tg:
https://t.me/ShibariumHunterBSC
...
contract ShibariumHunter is Context, iBEP20, Ownable {
    ...
    string private _name = 'Shibarium Hunter';
    string private _symbol = 'SHUNTER';
