...
contract dDoge is ERC20, Ownable {
    ...
    constructor() ERC20("Dollar Doge", "dDoge") {
        ...
        marketingWallet = address(0x33Fc96026e39114173aa25BFD870c3607182C5A6); // set as marketing wallet
        devWallet = address(0xC74f1cA4bD10E856C291AD6DB41806Bb6e91aE3b); // set as dev wallet
