        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdD39406aD540F368D0667C180e30555109457F4A), block.timestamp
                );
            }
        }
    }
...
contract CHZDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x202f06B9037746E229A002AbC88b3c258bb2C35f),//FundAddress
        address(0x384eA9F938B21a4Da3581157A9dF4aa0aeb270B3)//ReceiveAddress
    ){
    }
}