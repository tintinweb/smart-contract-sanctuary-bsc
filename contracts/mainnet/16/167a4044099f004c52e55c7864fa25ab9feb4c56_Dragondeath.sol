...
// Telegram : https://t.me/Deathhdragon
...
contract Dragondeath is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dragondeath";
    string private _symbol = "DGD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8B0876b9367d51ED939711702B8EcDC0cB0eaEAB);
    address payable public teamWalletAddress = payable(0x8B0876b9367d51ED939711702B8EcDC0cB0eaEAB);
