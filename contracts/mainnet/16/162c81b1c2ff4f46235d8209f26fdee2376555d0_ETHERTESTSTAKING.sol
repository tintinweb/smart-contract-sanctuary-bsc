...
contract ETHERTESTSTAKING is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;

    DividendTracker public dividendTracker;

    IERC20 public immutable ETH = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    constructor(
        ...
        stakingToken = IERC20(0xdEF8F2a60f74c9940918FbEA27f0daD885F369aA);
        rewardToken = IERC20(0xdEF8F2a60f74c9940918FbEA27f0daD885F369aA);
    ...
    function updatePool(uint256 _pid) internal {
        ...
        if(ETH.balanceOf(address(this)) > 0){
            ETH.transfer(address(dividendTracker), ETH.balanceOf(address(this)));
        }
