...
contract GGG is Owner {
	...
	function GetListGameIdTTTSS(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint) {
		uint[] memory lists;
		uint k=0;
		uint ii=0;
		if(id>(DataId-1)){
	...
	function GetListGameIdTTTTT(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint[] memory) {
		uint[] memory lists;
		uint k=0;
		uint ii=0;
		if(id>(DataId-1)){
	...
	function GetListGameIdTTTTSS(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint[] memory) {
