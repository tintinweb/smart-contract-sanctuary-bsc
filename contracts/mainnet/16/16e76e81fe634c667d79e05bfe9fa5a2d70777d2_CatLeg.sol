...
contract CatLeg is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CatLeg";
    string constant _symbol = "CatLeg";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf95DDA787C14d64c4F50d1eB04b4B76e165613a3;
