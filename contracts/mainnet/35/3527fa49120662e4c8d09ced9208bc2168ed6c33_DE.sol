...
contract DE is Context, IERC20, Ownable {
    ...
    uint256 private _burnFee = 18;
    uint256 private _previousBurn= _burnFee;
 
    address public  advertisementWallet = 0x7341322DBCa16a2d1262B705671da73Bd4BfBE6a;
 
 
    uint256 public _advestisementFee = _buyAdvestisementFee;
    uint256 private _previousAdvestisementFee = _advestisementFee;
 
    address public constant DEAD_ADDRESS = 0xf6E265442866079295A91F12970e031ba0C7e164;
 
    uint256 public _maxTxAmount = 10*1e6  * 10**18;
