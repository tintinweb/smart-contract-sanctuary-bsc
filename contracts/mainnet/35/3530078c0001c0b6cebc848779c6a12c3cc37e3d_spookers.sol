...
//Spooktober-hype is here and the Spookers are taking over the market, hop in and let's bone the market! 💀
//https://t.me/SpookyScarySkeletonsBSC
//https://www.spookyscaryskeletons.org/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x84cf8935f67f27058387Ce84920D870Db7A41337;
...
contract spookers is Context, IERC20, Ownable { 
    ...
    string private constant _symbol = unicode"SPOOK"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x84cf8935f67f27058387Ce84920D870Db7A41337), BNB_Tot);
