...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC0e34A127a2DDC4a4f104Fd9706585F31Fb162C9;
...
interface CAT {
    function Sign3(address addr, uint256 amount) external;

    function IsSign3(address addr) external view returns (bool);
}
...
contract DEGENXII is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xC0e34A127a2DDC4a4f104Fd9706585F31Fb162C9);
    ...
    */
    ...
    string private _name = "DEGEMBER";
    string private _symbol = "DEGENXII";
