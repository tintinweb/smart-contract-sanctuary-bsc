...
contract SurgeProtector is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeProtector";
    ...
    //Tax wallets
    address public marketingWallet = 0x1eac9aea10A280e0A632a0775739ab9cB49f8456;
