...
TW : https://twitter.com/CoreAIOfficial
...
contract CoreAI is Context, IERC20, Ownable {
    ...
    string private _name = "CoreAI";
    string private _symbol = "CoreAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6F35fdD91a59C3460A64c53CA18982bdFeadC77A);
    address payable public liqWalletAddress = payable(0x6F35fdD91a59C3460A64c53CA18982bdFeadC77A);
    ...
    uint256 private _totalSupply =  11000 * 10**_decimals;
    uint256 public _maxTxAmount =   220 * 10**_decimals;
    uint256 public _walletMax =     220 * 10**_decimals;
