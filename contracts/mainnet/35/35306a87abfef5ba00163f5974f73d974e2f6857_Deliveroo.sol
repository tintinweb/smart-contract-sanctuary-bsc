...
contract Deliveroo is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "Deliveroo";
    string _symbol = "DEVEO";
    uint8 _decimals = 9;
    ...
    function Corinthians(address holder) external onlyOwner {
    ...
    function doubleInput(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
    ...
    function reducedata(bool newStatus) public onlyOwner {
