...
contract IRONSHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x72432FbcD05f4BF9901e06853D764554F370a2A6);
    address payable public Wallet_Dev = payable(0x0EC20008995050F2079B1518F763bC13bb11C329);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "IRON SHIBA";
    string private constant _symbol = unicode"ISHIB";
    ...
    function SetFees(uint256 buyfees, uint256 sellfees ) external onlyOwner {
        _Tax_on_Buy = buyfees;
        _Tax_on_Sell = sellfees;
    }
