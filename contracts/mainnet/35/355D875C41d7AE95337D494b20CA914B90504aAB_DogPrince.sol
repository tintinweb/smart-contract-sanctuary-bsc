...
contract DogPrince is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dog Prince";
    string private _symbol = "Dog Prince";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb94c27667bA6f4b79E05bF67Df50f01818e7f5D8); // Marketing Address
    address payable public teamWalletAddress = payable(0xb94c27667bA6f4b79E05bF67Df50f01818e7f5D8); // Team Address
