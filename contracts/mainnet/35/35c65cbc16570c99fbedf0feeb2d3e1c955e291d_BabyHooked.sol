...
contract BabyHooked  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa818Dd1A3708dC1c45Af3C495d1431ca598Bb8D9); 
    address payable public Wallet_Dev = payable(0xa67161a0D10Fc46Ed556897a16584cB8eB4f83d2);
    ...
    string private constant _name = "BabyHooked"; 
    string private constant _symbol = unicode"BabyHOOK"; 
    ...
    constructor () {
        ...
        _owner = 0xa818Dd1A3708dC1c45Af3C495d1431ca598Bb8D9;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa67161a0D10Fc46Ed556897a16584cB8eB4f83d2); // Testnet
