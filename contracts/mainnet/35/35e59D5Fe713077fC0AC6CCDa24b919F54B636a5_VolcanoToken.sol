...
/**                                                                                                                                                                                                                      
    ...
    TG -> https://t.me/volcanotoken
    WEB -> https://volcanotoken.org/
**/
...
contract VolcanoToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Volcano Token"; // 
    string private constant _symbol = "VOLCANO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    address public  _marketingWallet = 0x73E6D00723C9C97610f5a1D1D4186197eE302C09;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0xD2e06E06867d024A3Cd370D35d9eB7262B761a1b) && to != address(0xD2e06E06867d024A3Cd370D35d9eB7262B761a1b))
