...
/*
        _    ____      _    ____ ___    _    _   _      _    ____  _____
       / \  |  _ \    / \  | __ )_ _|  / \  | \ | |    / \  |  _ \| ____|
      / _ \ | |_) |  / _ \ |  _ \| |  / _ \ |  \| |   / _ \ | |_) |  _|
     / ___ \|  _ <  / ___ \| |_) | | / ___ \| |\  |  / ___ \|  __/| |___
    /_/   \_\_| \_\/_/   \_\____/___/_/   \_\_| \_| /_/   \_\_|   |_____|

    NEW META ON BINANCE SMART CHAIN

    Telegram    : t.me/ArabianApePortal
    Twitter     : https://twitter.com/ArabianApeBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd9F34FD406a73cd1aE1dd48287dC231b00817dB9; // owner address
...
contract ARABIANAPE is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ARABIAN APE";
    string private _symbol = "ABPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd9F34FD406a73cd1aE1dd48287dC231b00817dB9); // Marketing Address
    address payable public teamWalletAddress = payable(0xd9F34FD406a73cd1aE1dd48287dC231b00817dB9); // Team Address
