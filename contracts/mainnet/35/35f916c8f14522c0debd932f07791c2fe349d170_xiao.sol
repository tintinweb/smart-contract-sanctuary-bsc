...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = usdtBalance * (_buyFundFee + _sellFundFee) * 7 / swapFee;
...
contract xiao is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x6eaCF8AA71DD635c346cec2def5A88aa65a561c4),//FundAddress
        address(0x20FFD00Afcf5b811318500a7FcA035d4755200Ed)//ReceiveAddress
    ){
    }
}