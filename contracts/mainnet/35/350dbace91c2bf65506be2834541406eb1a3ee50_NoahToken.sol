...
contract NoahToken is ERC20Capped, Orchestrated {
    using SafeMath for uint256;

    uint public marketFee = 300;

    address public marketFeeWallet = address(0xD5c76AaD927F4FAEb3651bF5381B168A45eA8180);
    ...
    constructor() ERC20Capped(700000 * 1e18) ERC20("Noah", "Noah") {
        ERC20._mint(msg.sender, 700000 * 1e18);
