...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC8761e71BAf8DB498Ca301B767808228818649e8; 
...
contract TokenBEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Sugar Elon";
    string private _symbol = "SugarElon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC8761e71BAf8DB498Ca301B767808228818649e8); // 
    address payable public teamWalletAddress = payable(0xC8761e71BAf8DB498Ca301B767808228818649e8); // 
