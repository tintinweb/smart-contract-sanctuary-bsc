...
Telegram : https://t.me/MessiWorldCupBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x331070a6aD69ae71E5AedC20aec01afF441BBaF9; // owner address
...
contract Messi_World_Cup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Messi World Cup";
    string private _symbol = "$Messi"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E2d26A2c9d57ac14F5175937AB9b08dfa840A7D); // Marketing Address
    address payable public teamWalletAddress = payable(0xDa56BccfD756EF4C796DA370CA7838F776F77dD6); // Team Address
