...
// Telegram: https://t.me/yeetceo
// Website: https://t.me/yeetceo
...
contract YEETCEO is IBEP20, Auth {
    ...
    string constant _name = "YEET CEO";
    string constant _symbol = "YEET";
	...
	bool public launchEvent = false;
    mapping (address => bool) public isBlacklisted;


    mapping (address => bool) isFeeExempt;

    uint256 public launchFee    = 40;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
		...
		if(launchEvent){
        feeAmount = amount.mul(launchFee).div(feeDenominator);
		}else{
    ...
    // disable antibotMode after launch
    function disableAntibotMode() public onlyOwner {
        antibotMode = false;
		launchEvent = true;
    }
	
    function disablelaunchEventMode() public onlyOwner {
		launchEvent = false;
    }
