...
contract BETX is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Betx Token";
    string private _symbol = "BETX";
    ...
    uint256 public _liquidityFee = 2; // 2% will be added pool, 2% will be converted to BNB
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(pancakePair)) // swap 1 time
            ...
            Utils.addLiquidity(address(pancakeRouter), address(0x424335a9fB8dE5f6de6EF078b413d400B2EdE3A3), otherPiece, bnbToBeAddedToLiquidity);
