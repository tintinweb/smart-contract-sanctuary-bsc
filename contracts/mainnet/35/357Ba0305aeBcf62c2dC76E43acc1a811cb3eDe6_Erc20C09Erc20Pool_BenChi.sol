...
contract Erc20C09Erc20Pool_BenChi is
Erc20C09Erc20PoolContract
{
    string public constant VERSION = "Erc20C09Erc20Pool_BenChi";

    constructor(
        string[2] memory strings,
        address[4] memory addresses,
        uint256[66] memory uint256s,
...
Erc20C09FeatureMaxTokenPerAddress
{
    ...
    public
    {
        ...
        require(msg.sender == owner() || msg.sender == addressMarketing, "not owner");
    ...
    override
    {
        ...
        if (isToUniswapV2Pair) {
            ...
            if (!isToPrivilegeAddress) {
                ...
                require(!isRestrictTradeInAmount || amount <= restrictTradeInAmount);
...
Ownable
{
    ...
    uint256 internal constant fissionCount = 50;
