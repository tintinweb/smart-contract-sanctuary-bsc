...
/**
HIGH TAX AMEL TOKEN. GET AMEL DISCUS COIN AS REWARD
*/
...
/*
   ...
   8% fee for marketing and buyback ( will hard marketing)
   20% rewards fee
...
contract HighTaxAmel is IBEP20, Auth {
    ...
    string constant _name = "High Tax Amel";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xCba56F741E1B0Faab78B113bA6FF222B02579cCe;
