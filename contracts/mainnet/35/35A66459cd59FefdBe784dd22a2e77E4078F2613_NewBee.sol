...
contract NewBee is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewBee";
    string private _symbol = "NewBee";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xECe75BC21fd9495a05D0BD4aa5A4825d7150c3a4);
    address payable public teamWalletAddress = payable(0xe2fb9787597dFEC216DF5DAeBA6D6Deb4853D5dF); 
    ...
    uint256 private _totalSupply = 1000 * 10**7 * 10**_decimals;
