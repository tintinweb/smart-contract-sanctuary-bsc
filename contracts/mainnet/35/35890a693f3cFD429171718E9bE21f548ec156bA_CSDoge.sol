...
contract CSDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CSDoge";
    string private _symbol = "CSDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F5f9A6c27ED32BA07866d319BAbd3a5cC03Ab11); // Marketing Address
    address payable public teamWalletAddress = payable(0x8F5f9A6c27ED32BA07866d319BAbd3a5cC03Ab11); // Team Address
