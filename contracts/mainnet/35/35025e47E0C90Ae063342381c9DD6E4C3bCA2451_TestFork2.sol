...
contract TestFork2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Test Fork";
    string private _symbol = "TestFork2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFEAa072cb2c54AcFC15Fbdc400C5ae6Ed8DF9ef9); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7B8A7C0d3689834E4347dF9fE1083206DbC56C83); // Team Address
