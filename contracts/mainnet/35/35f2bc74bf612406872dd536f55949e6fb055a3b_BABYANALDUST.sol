...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AnalDust = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AnalDust.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(AnalDust);
        ...
        uint256 amount = AnalDust.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AnalDust.transfer(shareholder, amount);
...
contract BABYANALDUST is IBEP20, Auth {   
    ...
    address AnalDust = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY ANAL DUST";
    string constant _symbol = "$BabyAnalDust";
