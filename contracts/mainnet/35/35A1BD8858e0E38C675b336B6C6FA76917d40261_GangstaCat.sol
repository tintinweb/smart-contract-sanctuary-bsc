...
Telegram    : https://t.me/GangstaCatOfficial
Twitter     : https://twitter.com/GangstaCat
...
contract GangstaCat is Ownable, IBEP20 {
    ...
    string  _name               = "GangstaCat";
    string  _symbol             = "GASCAT";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 250;
    bool inSwap;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x5b8Bd6371067F1a51F9D20b16E32D0EBdEe3f630;
        ecoFeeReceiver = 0x53050051c60817B37314043a9Bc3FcDfdE08cd03;
        devFeeReceiver = 0x82d5D3d50FE358fD78Cc3C9Fbcdc0348E67d6e78;
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _ecoFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        require(totalFee < feeDenominator/2, "Fees cannot be more than 25%");
    }
