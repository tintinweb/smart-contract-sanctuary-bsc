...
contract GROLIToken is BEP20 {
    ...
    string public constant name = "GRO Loyalty Inu";
    string public constant symbol = "GROLI";
    ...
    uint256 totalSupply_ = 5000000000000 * _decimalFactor;
...
contract Staking is Context, Ownable, GROLIToken {
    using SafeMath for uint256;

    address[] internal stakeholders;

    GROLIToken public GRO;
    ...
    uint256 public tokenPrice = 100000000000000; //1.0;
    ...
    constructor(GROLIToken _address) public payable {
        GRO = _address;
    }
