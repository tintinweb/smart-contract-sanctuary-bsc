...
contract YaoTeng is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function changePercentage(uint256 maxTXPercentage) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxTXPercentage) / 1000;
    }

    function changeYaoTengMax(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
