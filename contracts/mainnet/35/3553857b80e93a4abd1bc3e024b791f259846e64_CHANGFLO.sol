...
contract CHANGFLO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChangpumpFloki";
    string private _symbol = "CHANGFLO";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x2235303A9a499c8c294a041386a54FBF3353a72D); // Marketing Address
    address payable public TeamWallet = payable(0x2235303A9a499c8c294a041386a54FBF3353a72D); // Team Address
