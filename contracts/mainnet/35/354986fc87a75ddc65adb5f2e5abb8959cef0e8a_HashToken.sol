...
contract HashToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEEB968EFa6D95dCD9d8587Ec7576e1CC187D3cA4); 
    address payable public Wallet_Dev = payable(0x3f4d7d15A2F7c42Ef43542fF17dd4b3dfbB7BdDD);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x3f4d7d15A2F7c42Ef43542fF17dd4b3dfbB7BdDD); 
    ...
    string private constant _name = "Old BSC Coin"; 
    ...
    constructor () {
        ...
        _owner = 0x3f4d7d15A2F7c42Ef43542fF17dd4b3dfbB7BdDD;
