...
/**
Telegram : https://t.me/rachnetwork
*/
...
contract RACHNET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RACH NETWORK";
    string private _symbol = "RACHNET";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x543e54FE8f2b9BbA2EBBDf1DfF8cCE4783F7FAFC); // Marketing Address
    address payable public teamWalletAddress = payable(0x543e54FE8f2b9BbA2EBBDf1DfF8cCE4783F7FAFC); // Team Address
