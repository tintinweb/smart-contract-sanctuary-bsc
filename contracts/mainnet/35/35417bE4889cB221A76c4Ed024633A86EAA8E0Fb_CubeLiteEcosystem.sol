...
TG: https://t.me/CubeLiteEcosystem
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x653E9CC01336541BC7df4ef6A1c3a840468979F2; // owner address
...
contract CubeLiteEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CubeLite Ecosystem";
    string private _symbol = unicode"CUBE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x653E9CC01336541BC7df4ef6A1c3a840468979F2); // Marketing Address
    address payable public teamWalletAddress = payable(0x653E9CC01336541BC7df4ef6A1c3a840468979F2); // Team Address
