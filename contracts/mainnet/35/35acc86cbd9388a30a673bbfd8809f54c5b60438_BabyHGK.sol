...
contract BabyHGK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyHGK";
    string private _symbol = "BabyHGK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x413E6dD7Ca70FF6eCa3C7D7DDc9444039D6cEDF7);
