...
contract PeepoDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEEPODAO";
    string private _symbol = "DAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70887f8e8e4169c95D2750C751875F6B5548DffC);
    address payable public teamWalletAddress = payable(0x70887f8e8e4169c95D2750C751875F6B5548DffC);
