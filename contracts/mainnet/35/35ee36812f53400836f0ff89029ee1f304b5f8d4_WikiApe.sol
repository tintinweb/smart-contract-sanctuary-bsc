...
//
//
//   📱Telegram::https://t.me/WikiApe
//   📱Website ::https://en.wikipedia.org/wiki/Ape
/*
...
contract WikiApe is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Wiki Ape", "WikiApe") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WikiApe";
    string private _symbol = "WikiApe";
