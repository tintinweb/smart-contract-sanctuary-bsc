...
/**
        ...
        Degen Play, LP Will be locked and Ownership Renounce
        If you're early holders i suggest to make a group and name it @Croballs
...
contract Croballs is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Croballs";
    string private _symbol = unicode"CROBALLS";
