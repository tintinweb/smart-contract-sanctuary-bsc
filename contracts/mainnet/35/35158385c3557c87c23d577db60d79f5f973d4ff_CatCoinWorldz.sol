...
contract CatCoinWorldz  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Cat Coin Worldz";
    string constant _symbol = "CCW";
