...
/* Token contract */
contract Dogenixinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Dogenixinu";
    string constant _symbol = "Dogenixinu";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 10000;
