...
contract Zsoltcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
   
    string private _name = "Zsoltcoin";
    string private _symbol = "ZOU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x987B87eec4996F738BB03F68D78f03Db7f65ce30);
    address payable private teamWalletAddress = payable(0x987B87eec4996F738BB03F68D78f03Db7f65ce30);
