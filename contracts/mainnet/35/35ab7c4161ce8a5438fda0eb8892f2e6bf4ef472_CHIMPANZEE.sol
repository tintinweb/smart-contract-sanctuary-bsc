...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc34E43fd3cEc4C29A6125fb0F24c009deeC477AC;
...
contract CHIMPANZEE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcFe6382d5b0c19A95558fED9A93ea42A5cdc1aDf;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Chimpanzee Coin";
    string private _symbol = "CHIMP";
