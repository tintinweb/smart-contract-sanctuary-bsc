...
/**
   ...
   Welcome to Elon Musk 2.0

   TG: https://t.me/ElonMusk2BSC
   ...
   We will add .5 BNB and all the left 10% total supply to the pool 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
   
   We aim high, we stay strong! We are ELON MUSK 2.0 TEAM
...
contract ElonMuskTWO is Context, IERC20, Ownable {
    ...
    string private _name = "ElonMusk 2.0";
    string private _symbol = "ElonMuskTWO";
