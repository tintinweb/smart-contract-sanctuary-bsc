...
// WEBSITE : https://www.delosdefi.com/
...
contract DELOS is ERC20, Ownable {
   ...
   DELOSDividendTracker public dividendTracker;
    ...
    uint256 public constant maxBuyTransactionAmount = 100000000000 * (10**18); //100Bi
    uint256 public maxSellTransactionAmount = 100000000000 * (10**18); //100Bi
    uint256 public constant swapTokensAtAmount = 20000 * (10**18); //20K
    uint256 public _maxWalletToken = 100000000000 * (10**18); //100Bi
    uint256 public BUSDRewardsFee = 4;
    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 2;
    uint256 public MaxIndividualFee = 8;
    ...
    constructor() public ERC20("DELOS Defi", "DELOS") {

        dividendTracker = new DELOSDividendTracker();

        liquidityWallet = owner();
        marketingWallet = address (0x981A4E01fbB7b86B3b2117275bc862F362f66537);
    ...
    function setMaxWalletToken(uint256 value) external onlyOwner{
        require(value >= 2000000000 * (10**18), "DELOS: Minimum max wallet limit is 2 percent");
    ...
    function setBUSDRewardsFee(uint256 value) external onlyOwner{
        require(value <= MaxIndividualFee, "MAX INDIVIDUAL FEE LIMIT");
