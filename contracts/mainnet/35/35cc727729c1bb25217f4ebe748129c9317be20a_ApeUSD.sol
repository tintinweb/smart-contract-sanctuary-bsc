...
// Join our official Telegram at t.me/OfficialApeUSD -- Passive income. Ape Together Strong
...
contract ApeUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeUSD";
    string constant _symbol = "$AUSD";
