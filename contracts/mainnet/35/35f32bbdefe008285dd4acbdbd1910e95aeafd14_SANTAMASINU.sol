...
/*
tg : https://t.me/santamasinu
twitter : https://twitter.com/santamasinu
*/
...
contract SANTAMASINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x677c80Eeb12147168881702bF5275d23d3d3A300); 
    address payable private Wallet_Dev = payable(0xE383370D1EfBEbe2bA82cD5AbD14e818706B4868);
    ...
    string private constant _name = "SANTAMAS INU"; 
    string private constant _symbol = unicode"SMASINU"; 
    ...
    constructor () {
        ...
        _owner = 0xE9Aa5e36DA70F1B2d0f19BF8BC15a5124E51417b;
