...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF2d66c79b605A77706e40C8ac7cAa4371977fE52; // owner address
...
contract ZhuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZhuInu";
    string private _symbol = "ZHUI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2d66c79b605A77706e40C8ac7cAa4371977fE52); // 
    address payable public teamWalletAddress = payable(0xF2d66c79b605A77706e40C8ac7cAa4371977fE52); // 
