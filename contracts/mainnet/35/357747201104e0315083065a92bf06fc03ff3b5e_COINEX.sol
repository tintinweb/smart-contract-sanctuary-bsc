...
contract COINEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COINEX";
    string private _symbol = "COINEX";
    uint8 private _decimals = 9;

    address payable public promoWalletAddress = payable(0xe53a8d3D6Cc8AAcfb158558E3b4a1e39cd85e8EE); 
    address payable public teamWalletAddress = payable(0xdE57a761F1628e1ECEDabCA9433197F13A8c0b83); 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_promoFee);
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newPromoTax, uint256 newTeamTax) external onlyOwner() {
        _liquidityFee = newLiquidityTax;
        _promoFee = newPromoTax;
        _teamFee = newTeamTax;
    ...
    function setPromoWalletAddress(address newAddress) external onlyOwner() {
        promoWalletAddress = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBPromo = amountReceived.sub(amountBNBLiquidity).sub(amountBNBTeam);
