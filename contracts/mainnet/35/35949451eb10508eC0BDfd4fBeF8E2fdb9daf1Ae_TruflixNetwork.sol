...
contract TruflixNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Truflix Network";
    string constant _symbol = "TRUFLIX";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4963b2e271103eb651041d549ebcDF962AC09443; //replace with your wallet address
        devfeeReceiver = DEAD; //replace with your address if you want to receive this
        burnFeeReceiver = DEAD; //replace with your address if you want to receive this
