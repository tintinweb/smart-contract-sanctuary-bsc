...
contract SANTABSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SANTAS REVENGE", "REVENGE") {
        ...
        marketingWallet = address(0x41193d785a62c834c98F763Fd8bC46A63D8D748C); // set as marketing wallet 
        devWallet = address(0x41193d785a62c834c98F763Fd8bC46A63D8D748C); // set as dev wallet
