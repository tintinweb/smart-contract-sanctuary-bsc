...
contract LadyRat   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " LadyRat ";
    string private _symbol = " LADYRAT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6558Be29DFcC695d256a4Ab49154C0565d5cDd47); 
    address payable public teamWalletAddress = payable(0x6339fDD6aCc9bAa59F2A9dFdAcC588Ded102230f); 
