...
contract OneBull is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0eEd6bfdfFCA0A98b8d390EF96394bEbd211b9E1);
    address payable public teamWalletAddress = payable(0x0eEd6bfdfFCA0A98b8d390EF96394bEbd211b9E1);
    ...
    string private _name = "ONE BULL";
    string private _symbol = "OBL";
