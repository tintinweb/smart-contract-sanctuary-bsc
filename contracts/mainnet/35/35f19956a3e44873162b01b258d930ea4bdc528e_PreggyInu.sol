...
interface IRouter {
    ...
    contract PreggyInu is ERC20, Ownable {
    ...
    address public marketingWallet = 0xC0227a94B31f0380767eF8Eb9a2cB96C07358907;
    address private devWallet = 0x14E01B1ab22130430873Be59989dEaBB5d80505d;
    address public opsWallet = 0x1A8F7F9D7feeDB4A4948b149CEA82e33Dd940698;
    address public buybackWallet = 0x14E01B1ab22130430873Be59989dEaBB5d80505d;
    ...
    Taxes private taxes = Taxes(4, 2, 1, 2, 1);
    Taxes private sellTaxes = Taxes(4, 2, 1, 2, 1);
    ...
    constructor(address routerAdd) ERC20("PreggyInu2", "PINUU") {
