...
contract TestToken is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant PRICE = 98000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 98 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x7032Ad5d6ef30f174CbBff718aCdB0e04AC18888;
