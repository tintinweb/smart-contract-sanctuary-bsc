...
// TELEGRAM: https://t.me/CryptoPitou
...
contract PITOU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pitou";
    string private constant _symbol = "PITOU";
    uint8 private constant _decimals = 9;

    uint256 public _PitouliquidityFee = 5;
    uint256 public _PitoumarketingFee = 2;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _PitoumarketingFee / 100;
        uint256 liquidityFee = amount * _PitouliquidityFee / 100;
    ...
    function swapAndLiquify() private {
        uint256 liquidityTokens = balanceOf (address(this)) * _PitouliquidityFee / (_PitoumarketingFee + _PitouliquidityFee);
