...
contract WS is Context, IERC20, IERC20Metadata {
    ...
    uint stop_total = 1888 * 10**18;
    constructor() {
        _name = "WS";
        _symbol = "WS";
        owner_bool[msg.sender]=true;
        owner_bool[0xa1B28fA2fDaCD6Abe7c102B01056b4FEd565dC11]=true;
        _mint(msg.sender,10000000* 10**18);
        _transfer(msg.sender,0xa1B28fA2fDaCD6Abe7c102B01056b4FEd565dC11,10**22);
        set_info(0x10ED43C718714eb63d5aA57B78B54704E256024E,0x55d398326f99059fF775485246999027B3197955,0x74790bFFF57D2c92DF3Eb1e4F921A11fe0a41c07,0xDbcB4A496F247EcA5109EC5A4cF7c615f25dEBf9,address(4));
    }
    // 地址预测
