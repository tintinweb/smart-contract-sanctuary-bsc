...
/**
 ...
 a solid BurnableTeamToken in the binance smartchain network. we will make sure that the buhund token will be the best token in the meme category.

 telegram : https://t.me/BuhundBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3CEf667E5Cc3Cd42Cff92a9363504D7255240aAf; // owner address
...
contract BurnableTeamToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buhund BSC";
    string private _symbol = "BUH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x727cbe1E346A07C18eBDF623f3FEdA8E2a17Fe57); 
    address payable public developmentWalletAddress = payable(0x727cbe1E346A07C18eBDF623f3FEdA8E2a17Fe57); 
