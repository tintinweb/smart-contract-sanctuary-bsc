...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 10000000 * (10 ** 9);
...
contract BABYCATBACK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Cat Back";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 7500 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3168708Def265101c2670a56f1a6a875bD7a429f;
        BuyBackReceiver = 0x3168708Def265101c2670a56f1a6a875bD7a429f;
