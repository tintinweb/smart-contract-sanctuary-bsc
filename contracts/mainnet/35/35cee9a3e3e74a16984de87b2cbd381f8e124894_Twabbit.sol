...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3721d478879e479873d37762842353e6Dc1d1391;
...
contract Twabbit is Context, IERC20, Ownable {
    ...
    string private _name = "Twabbit Inu";
    string private _symbol = "Twabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3721d478879e479873d37762842353e6Dc1d1391);
    address payable public teamWalletAddress = payable(0x3721d478879e479873d37762842353e6Dc1d1391);
