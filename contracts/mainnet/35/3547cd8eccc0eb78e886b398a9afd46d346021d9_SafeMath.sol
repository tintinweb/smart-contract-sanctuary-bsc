...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x72DF56f319CB1353511858d5458D982e46F00c9f;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x72DF56f319CB1353511858d5458D982e46F00c9f);
        _token = msg.sender;
    }
...
contract NewName is IBEP20, Auth {
    ...
    address DEV = 0x72DF56f319CB1353511858d5458D982e46F00c9f;

    string constant _name = "RewardMe";
    string constant _symbol = "RWME";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x72DF56f319CB1353511858d5458D982e46F00c9f);
