...
/**
B&Beats is a decentralized marketplace where you can trade any service related to Music, whether you are an artist, an investor or a fan. The Music industry is so complicated because it belongs to a centralized ecosystem, and in most cases, the artists don’t receive what their work is worth, especially upcoming stars. B&Beats’ Platform will allow everyone who likes music, wherever in the world to earn passive income and enjoy their passion. Whether you are artists, productor, compositor or just someone who likes the music, to create/trade or own a song/album as an NFT
*/
...
contract BNBEATS is Context, IERC20, Ownable {
