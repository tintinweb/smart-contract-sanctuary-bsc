...
abstract contract ABS is ERC20, ERC20Permit, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        string memory name,
        address liquidityRestrictorAddr
    ) ERC20(name_, symbol_) ERC20Permit(name) {
        liquidityRestrictor = ILiquidityRestrictor(liquidityRestrictorAddr);
    }
...
contract YFIIDAO is ABS {
    constructor() ABS("DFI.Money Dao", "YFIIDAO", "DFI.Money Dao", 0x6Fb61F7E30FaD6d477c3Bddbfe184F436696e779) {
        _mint(msg.sender, 40000 * 10**decimals());
        setEnableWhitelist(false);
        setMarketingWallet(0x47Ac1ebD0Ec244BA4BFCD57CD6D9CF226C617B01);
        setDevWallet(0xb39D0AdEcb695222F4E3157843502a77F73375b9);
        setBuySlippage(3);
        setSellSlippage(3);
