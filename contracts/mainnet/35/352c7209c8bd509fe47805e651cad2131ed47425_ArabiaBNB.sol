...
contract ArabiaBNB is Context, IERC20, Ownable {
    ...
    string private _symbol = "Arab Coins";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA0e250F2e9B6A2f6496f0238fCDA872769D9Dd10); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA0e250F2e9B6A2f6496f0238fCDA872769D9Dd10); // BuyBack Address
