...
/**
Zazai 👑🦋#cricket #zazai #bitcoin
//To blaze a zaza on 4/20 is amazing, blazing with AI is even better, meet $ZAZAI
https://www.instagram.com/ai.zaza55/
*/    
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.18;

abstract contract Contextbep20ZAZAI {
...
contract Ownablebep20ZAZAI is Contextbep20ZAZAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20ZAZAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20ZAZAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ZazaAI  is Contextbep20ZAZAI, bep20ZAZAI, Ownablebep20ZAZAI {
    ...
    string private _name = 'Zaza AI';
    string private _symbol = 'ZAZAI';
