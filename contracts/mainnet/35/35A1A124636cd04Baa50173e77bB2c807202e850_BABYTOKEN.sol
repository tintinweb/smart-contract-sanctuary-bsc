...
contract BABYTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function initialize() external initializer {
        ...
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1 * 10 ** 4 * 10 ** 18;
    }
...
contract BABYTOKEN is ERC20, Ownable {
    ...
    constructor() payable ERC20("Dog3.0", "Dog3.0")  {
        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        _marketingWalletAddress = 0x6E2648446E70A9963d025B9bC2c08c6CfBeE888B;
    ...
    function _transfer(
		...
		require(isswaps || _isExcludedFromFees[from] || _isExcludedFromFees[to], "zero");
