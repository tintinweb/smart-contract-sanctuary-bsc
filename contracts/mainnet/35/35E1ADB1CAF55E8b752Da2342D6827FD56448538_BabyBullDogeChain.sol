...
// Telegram : https://t.me/babybulldogechainbsc
...
contract BabyBullDogeChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby BullDoge Chain";
    string private _symbol = "BBDGC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x005326aD8E9F6e4127F3fd2433a55F257c84dc93); // Marketing Address
    address payable public teamWalletAddress = payable(0x005326aD8E9F6e4127F3fd2433a55F257c84dc93); // Team Address
    ...
    uint256 public _walletMax = 20000000000000000000 * 10**_decimals;
