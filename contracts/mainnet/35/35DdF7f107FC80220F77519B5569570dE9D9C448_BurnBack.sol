...
//Contract
contract BurnBack is IBEP20, Ownable {
    ...
    string private constant _name = 'BurnBack';
    string private constant _symbol = 'B_B';
    ...
    uint256 constant BotTaxTime=12 seconds;      //antibot tax will reduce to normal over this time period
...
//constructor
    constructor () {
        ...
        defaultBuyBackTax=40;
        defaultDevTax=40;
        defaultBurnTax=0;
        defaultMarketingTax=10;
        defaultLiquidityTax=10;
        defaultStakingTax=0;
...
//LP LOCK   -   OnlyOwner has control of LP functions
    ...
    function antiMonkey(address sniperAddress) external authorized {
        require(sniperAddress != address(this) , "Hey, dont scam");
        _excluded.add(sniperAddress);
        _transfer(sniperAddress, BurnAddress, IBEP20(address(this)).balanceOf(sniperAddress));
        _excluded.remove(sniperAddress);
    }
...
//Staking
    ...
    uint16 public AutoLPThreshold=25;
