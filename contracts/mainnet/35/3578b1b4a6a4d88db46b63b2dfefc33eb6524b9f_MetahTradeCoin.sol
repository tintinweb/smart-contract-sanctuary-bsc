...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb9AD7377EC2a90e25ffDD141053E3948D426eD35;
...
contract MetahTradeCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94f6F2c016028A0b45811A30456C8e0a02Bbf978;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MetahTradeCoin";
    ...
    uint256 public _liquidityFee = 220;
