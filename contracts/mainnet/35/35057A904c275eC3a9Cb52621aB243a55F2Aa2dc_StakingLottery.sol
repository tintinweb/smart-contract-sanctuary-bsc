...
contract StakingLottery {
    ...
    IBEP20 public constant TOKEN = IBEP20(0x06989Bc4F2c409990EB01a950ff3c7d663f36e76); 
    ...
    function openStaking(uint256 stakingJackpotPrize, uint256 _howManyWinners) external onlyOwner {
        ...
        lastChanceToStake = block.timestamp + (stakingOpenForDays * 1 hours); // changed to hours for testing
        stakingEnds = block.timestamp + (daysUntilEnd * 1 hours); // changed to hours for testing
