...
/**
TWOGEWEEN is a meme token following Twoge adaptation to the market and celebrating 
the Halloweeen Combination between "TWOGE" and "HALLOWEEN"

TG :https://t.me/TwogeweenOfficial 
*/
...
contract TWOGEWEEN is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x989aecb18cfa131A78aCbe8C75b4Fb42B5081106);
    ...
    string private _name = "TWOGEWEEN"; 
    string private _symbol = "TWOGEWEEN";  
    ...
    function set_Max_Transaction_Percent(uint256 amountPercent) external authorized() {
        _maxTxAmount = (_tTotal * amountPercent ) / 100;
    }    
    
     function set_Max_Wallet_Percent(uint256 amountPercent) external authorized() {
