...
contract ToolDOGEZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ToolDOGEZilla";
    string private _symbol = "ToolDOGEZilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x3336c76B49b76959c9441D166B11200FcF624568); 
    address payable public ttWal = payable(0x3336c76B49b76959c9441D166B11200FcF624568); 
