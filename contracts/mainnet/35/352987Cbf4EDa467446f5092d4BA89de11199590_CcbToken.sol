...
contract BasicToken is Ownable, ERC20Basic {
    ...
    uint public buyPointsRate = 3100;
...
contract CcbToken is StandardToken {
    ...
    function setFeeParams(uint newBasisPoints, uint newbuyPoints) public onlyOwner {
    ...
    function setFeeAddrParams(address newfeeaddr1) public onlyOwner {
