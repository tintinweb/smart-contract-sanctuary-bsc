...
contract CXDogeToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CXDoge";
    string private _symbol = "CXDoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4bd02111fa41379727858DC9Bcd78Ac6b6b7Ac7C); 
    address payable public BurnedWalletAddress = payable(0x4bd02111fa41379727858DC9Bcd78Ac6b6b7Ac7C); 
