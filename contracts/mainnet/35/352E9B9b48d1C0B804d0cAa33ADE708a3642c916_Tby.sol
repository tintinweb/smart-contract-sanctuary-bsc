...
contract Tby is IERC20, Ownable {
    ...
    address private fundAddress = address(0x4d3D1aD416DE8B04a72d98C82DEeA21bEb1d47Dc);
    ...
    constructor() {
        ...
        _isExcludedFromFee[0x2eFFc21fE943Aaf0F7F7F1a9F3a8D650CD673746] = true;
    ...
    function setstarttime2(uint256 _num) public onlyOwner {
        _starttime2 = _num;
    }
    ...
    function _transfer(
        ...
        if(_starttime>0 && _starttime>block.timestamp  && block.timestamp>_starttime2 && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
        ...
        if(_starttime2>0 && _starttime2>block.timestamp  && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            require(balanceOf(from).mul(999).div(1000)>=amount,"sell limit");
            takeFee = true;
        }else{
