...
contract OneBoyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oneb Boy Inu"; // 
    string private constant _symbol = "Boy"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x355cc2C78766AaeB538d102F1Cf10b30b4E9533c;
