...
contract QueenNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QueenNeko";
    string private _symbol = "QN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF171f34a47BEc738970401f222B3B44be97Ba2Ea); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF171f34a47BEc738970401f222B3B44be97Ba2Ea); // BuyBack Address
