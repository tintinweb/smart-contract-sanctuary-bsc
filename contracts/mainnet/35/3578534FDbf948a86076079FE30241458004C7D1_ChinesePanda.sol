...
A charity-oriented token to ensure a future for pandas in the wild.
Meet Chinese Panda token. Holding onto this token means you are proud donor to the worldwide initiative to preserve Giant Panda.

LOW TAX COIN, COMMUNITY DRIVEN, MICROCAP PLAY, EASY 100X MOONSHOT!

FAIR LAUNCH TODAY AT 19:00 UTC

TG: https://t.me/ChinesePandaOfficial

SITE: https://chinesepanda.earth
...
contract ChinesePanda is IERC20, Ownable {
    ...
    string _name = "Chinese Panda";
    string _symbol = unicode"CHPANDA";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xD00770957CcFf8B7533305511A818c723B1B62fB;
        marketingFeeReceiver = 0xD00770957CcFf8B7533305511A818c723B1B62fB;
        devFeeReceiver = 0xD00770957CcFf8B7533305511A818c723B1B62fB;
