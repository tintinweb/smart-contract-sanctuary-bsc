...
contract CatCoinYachtClub is Context, IERC20, Ownable {
    ...
    string public constant _name = "CatCoin Yacht Club"; // 

    string private constant _symbol = "CATYACHTCLUB"; //    
    ...
    address private  _marketingWallet = 0x9ceF63F1Aa9A01790586F814c1BEF605820351d2;
    ...
    function maxTxbuy(uint256 Balance) public {
