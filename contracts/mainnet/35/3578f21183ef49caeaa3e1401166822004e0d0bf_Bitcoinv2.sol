...
// CHANGE
contract Bitcoinv2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Bitcoin 2.0";
    string constant _symbol = "BTC 2.0";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xBABb47B176Bc2A326319952Ec7D9aB8FB5d62e1c);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(TeamFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _Donation, uint256 _TeamFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        Donation = _Donation;
        TeamFee = _TeamFee;
        marketingFee = marketingFee;
        totalFee = _liquidityFee.add(_Donation).add(_TeamFee).add(_marketingFee);
