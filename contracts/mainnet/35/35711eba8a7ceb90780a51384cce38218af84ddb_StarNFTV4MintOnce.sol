 ...
 */
contract StarNFTV4MintOnce is Ownable, ERC165, IERC721, IERC721Metadata, IStarNFT {
    ...
    // Default allow owner mint new nft
    ...
    // Update transferable
    event EventUpdateTransferable(bool oldTransferable, bool newTransferable);

    // Update owner mintable
    event EventUpdateOwnerMintable(bool oldOwnerMintable, bool newOwnerMintable);
    ...
    modifier allowMint(address account, uint256 amount) {
        if (!_ownerMintable) {
            require(_balances[account] == 0 && amount == 1, "StarNFT: owner can not mint new nft");
        }
        _;
    }
    ...
    constructor() {
        ...
        _tokens.push(_star);
        _name = "BNB CHAIN Glory Pass";
        _symbol = "BNB Glory Pass";
    }
    ...
    /**
     * @dev Is this contract allow owner mint new nft
     */
    function ownerMintable() public view returns (bool) {
    ...
    function setTransferable(bool transferable) external onlyOwner {
        emit EventUpdateTransferable(_transferable, transferable);
    ...
    /**
     * @dev Set owner mintable.
     */
    function setOwnerMintable(bool ownerMintable) external onlyOwner {
        emit EventUpdateOwnerMintable(_ownerMintable, ownerMintable);
        _ownerMintable = ownerMintable;
    }
