...
contract PatrickStarInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xeB8782c5649C7c8fbB41efc949aa484cd970c3BC);
    address payable private _marketingAddress = payable(0xdcEf16137f72dC2A9d416D7Ae032C3d3fF8A1ABc);
