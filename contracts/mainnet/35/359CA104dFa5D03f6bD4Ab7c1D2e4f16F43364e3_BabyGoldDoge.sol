...
contract BabyGoldDoge is Context, IERC20 { 
    struct Cooldowns {
        uint256 sender;
        uint256 recipient;
        uint256 global;
    ...
    address payable public wm_address = payable(0x16BCC2fF9D6A49b30F4dB7bE09C0ff2bC7121fE3); 
    address payable public wbnb_address = payable(0x4487166ce135537448181E283cE02996bb5C622c);
    address payable public wd_address = payable(0x9dDF26E0504e63E69Ed12A3712E2210AE25f941C);
    ...
    string private constant _name = "Baby GoldDoge"; 
    ...
    constructor () {
        ...
        _owner = 0x9dDF26E0504e63E69Ed12A3712E2210AE25f941C;
