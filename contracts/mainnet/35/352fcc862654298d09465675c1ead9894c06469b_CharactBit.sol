...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25582F93326830a6fd186aF1027127Bf54f747c7; // owner address
...
contract CharactBit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CharactBit";
    string private _symbol = "CHB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x202F8aC6f42cfA4BB04f92D0E25a7C4A23711f6D); // Marketing Address
    address payable public teamWalletAddress = payable(0x202F8aC6f42cfA4BB04f92D0E25a7C4A23711f6D); // Team Address
