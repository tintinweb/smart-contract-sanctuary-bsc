...
contract StableSanta is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stable Santa";
    string private _symbol = "$SANTA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7F8e73509557064Da1992Ea975ee092ff8ce3b74); // 
    address payable teamWalletAddress = payable(0x4b1B2bb18E36d6664Bf677bd2b3824EA71192eBb); //
