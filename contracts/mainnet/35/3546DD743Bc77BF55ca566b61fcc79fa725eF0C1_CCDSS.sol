...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x9CDAf41110F5F25416B093A008944b92070B401B);
    ...
    uint256 private _tTotal = 88888 * 10 ** _decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if(_usdtPair!=address(0)){
            uint256 _usdtPairAmount=tokenAmount/8;
    ...
    function setFee(uint256 fee1,uint256 fee2,uint256 fee3,uint256 fee4,uint256 fee5,uint256 fee6) external onlyOwner {
        _buyFundFee = fee1;
        _buyLPDividendFee = fee2;
        _buyLPFee = fee3;
        _sellFundFee = fee4;
        _sellLPDividendFee = fee5;
        _sellLPFee = fee6;
    }
