...
library Address{
  ...
  contract BIDENINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa28Ada240775bF797426a622Fb95e5A05D3D2c6f;
    address public devwallet = 0x6BcE1Ea7D4a67722d6F4a619BD178BC40c96EE09;

    string private constant _name = "Biden Inu";
    string private constant _symbol = "BDN";
    ...
    Taxes public sellTaxes = Taxes(2, 5, 2, 1);
