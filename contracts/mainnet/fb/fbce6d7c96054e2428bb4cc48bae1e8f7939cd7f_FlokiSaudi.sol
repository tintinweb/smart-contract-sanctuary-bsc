...
contract FlokiSaudi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE06488111A0b146FDe323D244ba5eC2B382FF641);
    address payable public Wallet_Dev = payable(0xE06488111A0b146FDe323D244ba5eC2B382FF641);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "FlokiSaudi"; 
    string private constant _symbol = unicode"FlokiSaudi";
