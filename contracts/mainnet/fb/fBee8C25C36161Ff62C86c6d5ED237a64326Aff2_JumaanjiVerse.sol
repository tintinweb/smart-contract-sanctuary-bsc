...
contract JumaanjiVerse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee).add(devFee);

    address public _marketingWalletAddress = 0x53021A29464a413d2cf5CFbBa701fF25Ae3475ca;
    address public _devWalletAddress = 0x22F2dc3c52Af1F6F424571b8c264d0b99AE84969;

    uint256 public _maxWalletTokens = 200000000 * (10**18);
    uint256 public _maxTxTokens = 200000000 * (10**18);
    ...
    constructor() public ERC20("JumaanjiVerse", "JUM") {
        ...
        _mint(getOwner(), 10000000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if( !swapping &&
            ...
            super._transfer(address(this), _devWalletAddress, devTokens);
