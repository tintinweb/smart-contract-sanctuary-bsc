...
contract BaseTigerToken is Ownable {
    ...
    function BaseTigerToken() public {
        owner = msg.sender;
        maxtokens =  5000000000000;
    }
...
contract TRSCoinToken is BaseTigerToken {

    string public constant name = "Torreos Token";
    string public constant symbol = "TRS";
    uint32 public constant decimals = 6;

}

contract TRSCoinSeller is Ownable {
    ...
    uint public rate;
    uint256 public MaxTokens;
    TRSCoinToken public token = new TRSCoinToken();

    function TRSCoinSeller() public {
        rate = 1000000;
        owner = msg.sender;
