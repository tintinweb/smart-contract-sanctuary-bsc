...
//Telegram https://t.me/baby_vitalik
...
contract BabyVitalik is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Vitalik";
    string private _symbol = "BabyV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C32A4B1A2a26EbB50990F3961A2cB26d404b98E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4cAc89e3b24D11527945722D0d7d4fA99060aDde); // BuyBack Address
    ...
    //Reader - You will see LP is set to 0, this is to avoid deployer wallet selling to add to LP, the LP is auto added via the buyback wallet
