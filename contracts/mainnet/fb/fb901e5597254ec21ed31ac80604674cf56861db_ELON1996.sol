...
contract ELON1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON1996"; 
    string private _symbol = "E96"; 
    ...
    uint256 public _walletMax = _totalSupply * 12 / 100; 
