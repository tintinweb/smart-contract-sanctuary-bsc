...
contract KoukiInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x3b1f8D549400903cB759D15E7c310929849C6168));
    address payable public devWallet =
        payable(address(0x3b1f8D549400903cB759D15E7c310929849C6168));
    address public liquidityReceiver =
        0x3b1f8D549400903cB759D15E7c310929849C6168;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Kouki Inu";
    string private _symbol = "$KOUKI";
    ...
    uint256 private numTokensSellToAddToLiquidity = 15000000000 * 10**9;
