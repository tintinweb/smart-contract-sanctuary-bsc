...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x2ab3e8Af2d3554dF9F08788A6659D15Bde36c1eb;
    IDEXRouter router;
...
contract OdinalTeslaCeo is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2ab3e8Af2d3554dF9F08788A6659D15Bde36c1eb;

    string constant _name = "Odinal Tesla Ceo";
    string constant _symbol = "$OTC";
