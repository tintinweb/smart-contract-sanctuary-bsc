...
contract MAXAM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MAXAM Performance Token", "MAXAM") {
        ...
        uint256 totalSupply = 989448046 * 1e18;
    ...
    function updateSellFees(uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellDevFee) external onlyOwner {
