...
Outer Ring MMO 🪐
@OuterRingMMO
🪐 Explore, battle, and create your own adventure!
🏴‍☠️ Become a Space Corsaire http://mtr.bio/outer-ring-mmo
LEVEL Finance #RealYield
@Level__Finance
Decentralized and non-custodial perpetual market on #BNB Chain with custom risk management and innovative LP solutions. | http://linktr.ee/levelfinance | Ticker: $LVL
*/
...
contract GQLVL  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'GQLVL';
    string private _symbol = 'GQLVL';
