...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41eBA43FB20ff9393fb80F7F901E30eb21286988;
...
contract MMVT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4e0B0b0095b8217A75E3693EE48f59488afCa5a5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Multi METAVERSE Token";
    string private _symbol = "MMVT";
