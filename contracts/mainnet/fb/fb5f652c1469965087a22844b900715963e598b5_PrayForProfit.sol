...
contract PrayForProfit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PrayForProfit", "PFP") {
        marketingWallet = payable(0x6B800c086a70CA5bD7356D3a37F76a2eD2dE2c5f);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;
     ...
     PrayForProfit public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = PrayForProfit(mainContract);
