...
contract FHC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FHC";
    string private _symbol = "FHC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0cFc0A47734b1cd4Ee820128c1255eBfd86890CB); 
    address payable public BurnedWalletAddress = payable(0x0cFc0A47734b1cd4Ee820128c1255eBfd86890CB); 
