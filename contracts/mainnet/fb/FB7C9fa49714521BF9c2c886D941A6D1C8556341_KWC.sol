...
/**
    ...
    //Lp Locked
    //Community Driven
    Telegram: https://t.me/KingWorldCup
...
contract KWC is Context, IERC20, Ownable {
    ...
    string private _name = "KingWorldCup";
    string private _symbol = "$KWC";
    ...
    uint256 private minimumTokensBeforeSwap = 65196 * 10**9; 
    ...
    function updateMaxBuyTranscationAmount(uint256 maxBuy) public onlyOwner {
        maxBuyTranscationAmount = maxBuy * 10**9;
    }
