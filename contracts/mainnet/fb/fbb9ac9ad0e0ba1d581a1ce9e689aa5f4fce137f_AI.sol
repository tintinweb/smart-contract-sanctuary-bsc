...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCb6983682D6786411790DD75f8f3eD629e13Efe8; //
...
contract AI is Context, IERC20, Ownable {
    ...
    string private constant _name = " AI SQUID"; // 
    string private constant _symbol = "$AIS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xB954E17fbbB63D126F45494Ad36aeA119dA01C33); //
