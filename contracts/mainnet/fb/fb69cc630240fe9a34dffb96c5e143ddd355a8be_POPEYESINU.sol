...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xb3c3Cd311747360A28A90E45f007fFE0Fe43aF06;
...
contract POPEYESINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "POPEYES INU"; // 
    string private constant _symbol = "Popeyes Inu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xBb46A7C6ef58C1BA3200Ab9125CB9B11d7AfaAEf);
