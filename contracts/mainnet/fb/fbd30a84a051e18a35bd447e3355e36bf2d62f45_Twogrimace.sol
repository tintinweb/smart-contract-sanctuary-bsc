...
/**
*
Telegram: https://t.me/twogrimace
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e802144F4EAA28b0D1d8a0d938f97634f2f4B4b; // owner address
...
contract Twogrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twogrimace";
    string private _symbol = "TWG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x446427ffAEE08a8fffD1aF1d18c7abbBD7ecAeb6); // Marketing Address
    address payable public teamWalletAddress = payable(0x2e802144F4EAA28b0D1d8a0d938f97634f2f4B4b); // Team Address
