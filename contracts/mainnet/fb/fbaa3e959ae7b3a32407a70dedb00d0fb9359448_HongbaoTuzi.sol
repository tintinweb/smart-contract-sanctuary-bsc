...
Telegram : https://t.me/HongbaoTuziPortal
...
contract HongbaoTuzi is Context, IERC20, Ownable {
    ...
    string private _name = "Hongbao Tuzi";
    string private _symbol = "Hongbao Tuzi";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0x3Fc61b2dAF51B5dA7E5D1B247756476910d5C510);
