...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0x7157830B5f342F7d927b6CE465C5284B9115b558);
...
contract FFF is IBEP20, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "Financial Freedom Fighter";
    string private _symbol = "F3";
    uint8 private _decimals = 18;

    uint256 private _totalSupply;
    uint256 private _maxSupply = 1 * 10**12 * 10**_decimals;
    uint256 private _initialSupply = 350 * 10**9 * 10**_decimals;
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(    
            ...
            "You can't mint more than 1 Trillion"
        );
