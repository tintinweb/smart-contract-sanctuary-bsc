...
contract HODLZILLA_MINER {
    ...
    uint256 constant launch = 1667203200;   //1667203200 08:00 AM 31th Oct. UTC
    ...
    constructor() {
            owner = address(0xFEBaBDF0CaE4388C9AF3990507204cdBcF7c39D1);
            dev = msg.sender;
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        DeposMap[msg.sender][user.depoList.length] = Depo({
        ...
        BUSD.safeTransfer(owner, stakeFee*75/100);
        BUSD.safeTransfer(dev, stakeFee*25/100);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        BUSD.safeTransfer(owner, withdrawFee*75/100);
        BUSD.safeTransfer(dev, withdrawFee*25/100);
    ...
    function withdrawInitial(uint256 keyy) external {
        ...
        if (currDays < FeesKey[10].daysInSeconds){ // LESS THAN 10 DAYS STAKED
            ...
            BUSD.safeTransfer(owner, minusAmt*75/100);
            BUSD.safeTransfer(dev, minusAmt*25/100);
            ...
            BUSD.safeTransfer(msg.sender, transferAmt);
            BUSD.safeTransfer(owner, minusAmt*75/100);
            BUSD.safeTransfer(dev, minusAmt);
