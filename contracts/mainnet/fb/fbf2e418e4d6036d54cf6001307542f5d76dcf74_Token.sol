...
contract Token is ERC20 {
    ...
    constructor()  payable ERC20("ben token", "BEN") {
    ...
    function _transfer(
        ...
        if (leftToLiquify>0 && enableLiquify && !inSwapAndLiquify && !_automatedMarketMakerPairs[from]) {
            uint256 contractTokenBalance = balanceOf(address(this));
            if(contractTokenBalance>0 && contractTokenBalance<leftToLiquify) leftToLiquify=contractTokenBalance;
