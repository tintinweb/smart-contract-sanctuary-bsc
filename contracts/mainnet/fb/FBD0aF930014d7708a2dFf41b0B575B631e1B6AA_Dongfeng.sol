...
contract Dongfeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DongFeng";
    string private _symbol = "DongFeng";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38cC30608Aa09a3Be6979072f426e390cab1a4d8); // Marketing Address
    address payable public teamWalletAddress = payable(0xE7C583d41B9724904adEfA1DCff21604d2e91e1C); // Team Address
