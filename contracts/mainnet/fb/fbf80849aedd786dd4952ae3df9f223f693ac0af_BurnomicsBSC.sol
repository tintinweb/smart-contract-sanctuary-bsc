...
((_)_  /((_)(()\   )\ )   )\    )\  '((_)  )\  )\((_)_ (_))  )\___  
 ...
 | _ \| || || '_|| ' \))/ _ \| '  \() | |/ _| (_-<| _ \\__ \ | (__  
 |___/ \_,_||_|  |_||_| \___/|_|_|_|  |_|\__| /__/|___/|___/  \___| 
                                                                    

BurnomicsBSC
True Burn with very low tax community token.

TG: https://t.me/burnomicsbsc
First dozen or so to join TG will get Admin privileges. Just Ask.
...
contract BurnomicsBSC is BEP20, Auth {
    ...
    string constant _name = "BurnomicsBSC";
    string constant _symbol = "BurnBSC";
    ...
    function trueBurn(uint256 percent_base10000) public authorized returns (bool){
