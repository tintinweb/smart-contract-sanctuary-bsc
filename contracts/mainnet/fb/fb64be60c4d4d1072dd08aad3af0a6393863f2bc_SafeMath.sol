...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public rewardToken =
        IERC20Extended(0x2674Dce54C3FDA081bAA9eDb9fabDA0873A85D06);
...
// main contract
contract RefCoin is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Real Efficient Finance";
    string private constant _symbol = "REFCOIN";
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply =
        1_000_000_000_000 * 18**_decimals;

    address public rewardToken = 0x2674Dce54C3FDA081bAA9eDb9fabDA0873A85D06;
    ...
    constructor(
        address router_, // 0xd5c038DF8dB0492F7C67307Eed20b9663F0FB2Ac
        address antiBot_, // 
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB
            ...
            .div(totalBNBFee)
            .div(2);
        uint256 amountBNBREF = amountBNB.mul(REFFee).div(
            totalBNBFee
        );
