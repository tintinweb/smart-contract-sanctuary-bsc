...
abstract contract ContextSHIBx2BSC {
...
contract OwnableSHIBx2BSC is ContextSHIBx2BSC {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableSHIBx2BSC: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSHIBx2BSC: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SHIBx2  is ContextSHIBx2BSC, SHIBx2BSC, OwnableSHIBx2BSC {
    ...
    string private _name = 'SHIBx2';
    string private _symbol = '$SHIBx2';
