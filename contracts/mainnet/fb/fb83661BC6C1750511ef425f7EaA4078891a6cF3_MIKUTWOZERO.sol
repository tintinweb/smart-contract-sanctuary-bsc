...
contract MIKUTWOZERO is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 2 * 10**15 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 300 * 10**_decimals;
