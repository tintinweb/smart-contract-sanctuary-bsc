...
contract SwishFishGuilds is Ownable {
    ...
    constructor(
        ...
        guilds[name_] = Guild({
        name: name_,
        creator_address: payable(creator_),
        ...
        guild_owner[creator_] = true;
        emit GuildCreated(name_, creator_, tax_fee_creator_, tax_fee_community_, price_);
    }
    ...
    function createGuild(
        ...
        require(tax_fee_creator_  <= 20, "New Guild: commissions must be less than 20 percent");
        require(msg.value >= guild_program_price, "New Guild: send more ether");
