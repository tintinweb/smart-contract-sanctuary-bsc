...
New token surfing on the new "DAO" hype, you need to be refered with one token before you can buy.
Post your wallet in the TG if you haven't got one, and someone will send you one.

You get 3% of the buys of each person you refered, so jump in and start banking 🚀🚀

Come get your triple dose of DoKlown                                                         

https://t.me/DoKlown

10% buy - sell       
LP Will be locked on Mudra as soon as we launched
100M supply
2% Max Wallet                                                              
*/
...
contract DoKlownDAO is IBEP20, Auth {
    ...
    string constant _name = "Do Klown";
    string constant _symbol = "DKLWN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1000000; 
    ...
    address private marketingFeeReceiver = 0xE0B8A03A9507f9e2B43E2Fd426C69D8Dd9e91484;
    address private devFeeReceiver = 0xE0B8A03A9507f9e2B43E2Fd426C69D8Dd9e91484;
