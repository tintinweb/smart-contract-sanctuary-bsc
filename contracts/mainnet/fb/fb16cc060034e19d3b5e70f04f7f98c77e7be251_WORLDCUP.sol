...
/**
 To keep up with his daddy hype on eth, we bring a small version to bsc to make's new vibe!!
  https://t.me/miniworldc_portal
*/
...
contract WORLDCUP is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Mini World Cup";
    string constant public symbol = "MWC";
