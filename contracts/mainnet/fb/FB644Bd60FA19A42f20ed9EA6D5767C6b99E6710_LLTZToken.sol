...
contract LLTZToken is IERC20, Ownable {
    ...
    address private projectAddress1 = 0xfA0EA3da220970C93Df98930560F585D56245f64;
    address private projectAddress2 = 0x5767C78502738394C639b9777F13Fc2F5985d6cd;
    address USDT = 0x55d398326f99059fF775485246999027B3197955;
    string private _name = "LLTZ";
    string private _symbol = "LLTZ";
    ...
    constructor() {
        _tOwned[projectAddress1] = 10000 * 10**18;
        _tOwned[projectAddress2] = 2000 * 10**18;       
        ...
        _isExcludedFromFee[projectAddress1] = true;
        _isExcludedFromFee[projectAddress2] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), projectAddress1, 10000 * 10**18);
        emit Transfer(address(0), projectAddress2, 2000 * 10**18);
    }
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
        if(_tOwned[address(this)] >= _tTotal.div(10**7) ) {
    ...
    function distributeDividend(address shareholder ,uint256 amount) internal {
            if( amount < _tTotal.div(10**15)) return;         
