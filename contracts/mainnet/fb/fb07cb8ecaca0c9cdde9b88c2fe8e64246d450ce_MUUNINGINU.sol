...
*/
//t.me/muuninginu - collect rewards in MUU. !!!!!!
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x2900e6b68658128784B9a1de242F811d938d8bA7);
...
/* Token contract */
contract MUUNINGINU is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x2900e6b68658128784B9a1de242F811d938d8bA7; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x493a11104361aE3d9b0f4a34D31e3562010d47a5;
    ...
    // Name and symbol
    string constant _name = "MUUNING INU";
    string constant _symbol = "$MUUNIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x36F09F958dA4e7C3ac7a285c15c072D51bFE2896;
