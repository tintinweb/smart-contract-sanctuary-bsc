...
// Inspired by Black Mirror series
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc993dE480B2e21C6ce548cb06f5A89675cE73511; 
...
contract BlackMirror is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Mirror";
    string private _symbol = "BlackMirror";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b18CF60898169f1833D2c29F14159b938CF6450); 
    address payable public teamWalletAddress = payable(0x5b18CF60898169f1833D2c29F14159b938CF6450); 
