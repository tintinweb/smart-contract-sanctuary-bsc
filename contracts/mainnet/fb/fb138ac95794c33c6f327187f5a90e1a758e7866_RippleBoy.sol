...
contract RippleBoy is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RippleBoy";
    string constant _symbol = "$XRPBoy";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xD1292E8AbAc5b2D77a2341FEE109Fa6D518dF539;
