...
contract DurhamInu is Context, IERC20, Ownable {
    ...
    string private _name = "Durham Inu";
    ...
    uint256 public _boostedMarketingFee = 1600;
    ...
    address payable private _devWallet = payable(0x1998F2fB2f25D7B465a89AA3Be25cDb19beb209A);
    ...
    uint256 private maxTxPercent = 30; // Less fields to edit
