...
// File: contracts/HobosOnBSC_Pets.sol
    ...
    ReentrancyGuard
{
    ...
    uint256 public constant maxSupply = 1234;

    string public baseURI;
    string public notRevealedUri =
        "https://bnbhobos.wtf/pets/hidden/hidden.json";
    ...
    uint256 public pricePublic = 0.07 ether;
    uint256 public pricePresale = 0.05 ether;

    Counters.Counter private _tokenIds;

    constructor()
        ERC721("HobosOnBSC Pets", "HOBP")
    {
    }
