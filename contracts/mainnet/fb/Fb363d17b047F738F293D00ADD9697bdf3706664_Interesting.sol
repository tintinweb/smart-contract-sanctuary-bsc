...
contract Interesting is Context, IERC20, Ownable {
    ...
    string private _name = "Interesting";
    string private _symbol = "Interesting";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xcb4BAAD313D1A80452C007Aa6b065F6EeA5bB556);
    address payable public liqWalletAddress = payable(0xB51d2bdeE9Ad78ac2B1096c4EB164f1eD25571a2);
