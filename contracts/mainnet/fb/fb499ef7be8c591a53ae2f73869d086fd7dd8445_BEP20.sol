...
contract BEP20 is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        setBUSDRewardsFee     (sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        setBUSDRewardsFee     (msg.sender, recipient, amount);
        return true;
    }

    function setBUSDRewardsFee     (
        address from,
        address to,
        uint256 amount
    ) private {
...
// // /// https://naikoninja.financexi.io/
// / // // https://t.me/NaikoNinja
