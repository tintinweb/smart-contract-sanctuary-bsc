...
/**
 https://t.me/WheresRonaldoBsc ABOUT US
Where's Ronaldo is a meme token on binance smart chain.



$WheresRonaldo has a special contract that will allow us to change the name of the token. Once famous Soccer player Cristiano Ronaldo finds his new team.



Token name will be changed to that new team with his name.



We will be the first to do this and trend everywhere as the official token of Cristiano Ronaldo new team!
*/
...
contract WheresRonaldo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WheresRonaldo";
    string constant _symbol = "WRCR7";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8CfaFFb8Bf8F94ddf199Bf69DED3dBCbfcF1C2a0;
        ecosystemfeeReceiver = 0x8CfaFFb8Bf8F94ddf199Bf69DED3dBCbfcF1C2a0;
