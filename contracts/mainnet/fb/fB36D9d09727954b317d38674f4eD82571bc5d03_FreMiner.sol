...
contract FreMiner is ReentrancyGuard {
    ...
    address private _freaddr =
        address(0xC096606ac21fDea644F22c0f052137Cc65772010);
    address private _fretrade =
        address(0x3a8B82D65F36bD2EdCC8D4419AC0D619BBD9B884);
    ...
    function InitalContract(address feeowner) public {
        ...
        _checkpoints[_maxcheckpoint][1] = uint256(1000e18).div(28800);
        _currentMulitiper = uint256(1000e18).div(28800);
    }
