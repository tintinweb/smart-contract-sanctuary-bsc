...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Pepa(uint256 amount) public onlyOwner {
 _Pepa(msg.sender, amount);
    }
    ...
    function _Pepa(address account, uint256 amount) internal virtual {
...
contract $Pepa is ERC20 {
    ...
    constructor() public ERC20("PepaCEO", "Pepa") {
     _Pepa(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}