...
contract fission is IERC20, Ownable {
    ...
    address public deadAddress = 0x94142b17C906DA15A1337760F80c44c8EF9778Ec;
    address public fundAddress = 0x4f547fE87aD901D45AD278104f2Fb5bb0530187D;
    address public nodeAddress = 0x10e14992cf772Aba7b7Ad5A542278DA0D453471D;
    address public U = 0x55d398326f99059fF775485246999027B3197955;
    address public USDT = address(0x55d398326f99059fF775485246999027B3197955);

    string private _name = "Fission";
    string private _symbol = "Fission";
    ...
    uint256 private _previoufundFee;

    uint256 public _nodeFee = 200;
    uint256 private _previounodeFee;

    uint256 public _inviterFee = 800;
    uint256 private _previousInviterFee;
	
    uint256 public bonusAmount =  1 * 10**9;
    ...
    bool public swapProcessSwitch = true;
    ...
    constructor() {
        address should = 0x94142b17C906DA15A1337760F80c44c8EF9778Ec;
		...
		_isExcludedFromFee[nodeAddress] = true;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
	...
	function setFixedSwitch(bool _fixedSwitch) external onlyOwner{
        fixedSwitch = _fixedSwitch;
    }
    function setBonusAmount(uint256 amount) external onlyOwner {
        bonusAmount = amount;
    }
    function includeInFee(address account) public onlyOwner {
        _isExcludedFromFee[account] = false;
    }
    function setSwapProcess(bool _swapProcessSwitch) public onlyOwner {
        swapProcessSwitch = _swapProcessSwitch;
    }
    ...
    function removeAllFee() private {
        ...
        _previoufundFee = _fundFee;
        _previousInviterFee = _inviterFee;
        _previounodeFee = _nodeFee;
    ...
    function restoreAllFee() private {
        _nodeFee = _previounodeFee;
        _burnFee = _previousburnFee;
        _LPFee = _previousLPFee;
        _inviterFee = _previousInviterFee;
        _fundFee = _previoufundFee;
    }
    ...
    function _transfer(
        ...
        uint256 balance;
        if ((to == uniswapV2Pair && !_isExcludedFromFee[from]) || (!_isExcludedFromFee[to] && !_isExcludedFromFee[from])) {
        ...
        toAddress = to;  
         ...
         if(swapProcessSwitch  &&  from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _tokenFromTransfer(
        ...
        _transferFromStandard(sender, recipient, amount);

        if (!takeFee) restoreAllFee();
    }
    function _transferFromStandard( address sender, address recipient, uint256 tAmount ) private {	
    ...
    function _takeInviterFee(
        ...
        uint256 accurRate;
		uint16[8] memory inviteRate = [300, 150, 100, 50, 50, 50, 50, 50];
    ...
    function _transferStandard(
        ...
        _takewlletFee(sender,fundAddress, tAmount.div(10000).mul(_fundFee),_fundFee);

        _takewlletFee(sender,nodeAddress, tAmount.div(10000).mul(_nodeFee),_nodeFee);

        _takewlletFee(sender,address(this), tAmount.div(10000).mul(_LPFee),_LPFee);
		
        uint256 recipientRate = 10000 - _burnFee - _LPFee - _fundFee - _nodeFee;
