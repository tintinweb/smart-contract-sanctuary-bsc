...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA52f4576e0A05A37c11ebA9fe8E0DeCccb26ea60;
...
contract TheZeroState is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe05B1f11810f5F366a219F13aeB97321f0f2d596;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TheZeroState";
    string private _symbol = "TZS";
