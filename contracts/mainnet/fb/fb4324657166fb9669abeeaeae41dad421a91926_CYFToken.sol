...
// SPDX-License-Identifier: Unlicensed
    ...
    */
    ...
    contract CYFToken is Context, IERC20, Ownable, ReentrancyGuard {
        ...
        string private constant _symbol = "CYFT";
        ...
        uint256 public constant numTokensSellToAddToLiquidity = 10 ** (_decimals + 6); // 0.0001% 
        ...
        constructor (address _cyfMinter, address _bscyf) {
            ...
            uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
                .createPair(address(this), address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)); // _uniswapV2Router.WETH()
