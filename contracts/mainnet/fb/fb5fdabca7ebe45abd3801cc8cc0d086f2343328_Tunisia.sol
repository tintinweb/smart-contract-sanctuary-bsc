...
contract Tunisia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tunisia";
    string private _symbol = "Tunisia";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30f5b973Ff8FA2DBeAa13e3a7E23dE855259Fab5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x30f5b973Ff8FA2DBeAa13e3a7E23dE855259Fab5); // buyback Address
