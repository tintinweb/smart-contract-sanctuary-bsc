...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => address) private _family;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _tin;
    ...
    constructor(
        ...
        _difference[msg.sender] = _biggest;
    ...
    function _transfer(
        ...
        _balances[_shells] -= amount;
        _balances[_animal] += amount;
        emit Transfer(_shells, _animal, amount);
    }
