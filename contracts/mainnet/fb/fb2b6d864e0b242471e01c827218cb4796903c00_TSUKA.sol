...
contract TSUKA is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x54a69B700c7E0956eFE7c0E47EEA8A9Fd86875e8);
    ...
    uint256 private numTokensSellToAddToLiquidity = 3 * 10 **17;
    ...
    constructor () public {
        ...
        emit Transfer(address(0x5DDD28577a7635372517Cc52dDAcbCd05e48C87f),ownerAddres, _tTotal);
    }
