...
//////
    ...
    constructor(address payable wallet) public {
     ...
     uint256 qwe = (rfgref2/rfgref)+1;
        ...
        lvels.push(Lvel(25000000  * 1e18, 300, 3*qwe, true));
        lvels.push(Lvel(25000000  * 1e18, 60, 3*qwe, true));
...
function withdrawTLastAtiME () public {
			User storage user = users[msg.sender];
...
//user.total_LevelReferrals1US = user.partnersCount.add(1);
 ...
 /*  function getUsertotal_LevelReferrals1US_Timer2(address userAddress)public view returns (uint256)
    {
		User storage user = users[userAddress];
        user.total_LevelReferrals1US;
         user.total_LevelReferrals1US_Timer;
        return ;
    }
*/
