...
This new channel "Kanahei's Call" is for degen plays and long term plays, created by us, 
we'll post daily, mostly low mc stealth launches. 
We would do any promos made by other teams so you can be 100% sure you're early here.
...
contract KanaheiCall is IBEP20, Auth {
    ...
    string constant _name = "Kanahei Call";
