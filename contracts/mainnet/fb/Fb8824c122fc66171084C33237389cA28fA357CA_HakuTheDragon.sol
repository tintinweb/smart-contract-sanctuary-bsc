...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0AcFcfC7fA1955f1783eCfABF03ad97609d0dCCb; // owner address
...
contract HakuTheDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Haku The Dragon";
    string private _symbol = "HTD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe30eA99Afe1d8A89aE28Cc8757B2d0f5968FC6f3); // Marketing Address
    address payable public teamWalletAddress = payable(0x0AcFcfC7fA1955f1783eCfABF03ad97609d0dCCb); // Team Address
