...
contract NKAKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NKAKI";
    string private _symbol = "NKAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeb78B8EFbb1a521DDF05bb59aAb3CF19bcbFfD34);
    address payable public teamWalletAddress = payable(0xeb78B8EFbb1a521DDF05bb59aAb3CF19bcbFfD34);
    address public immutable deadAddress = 0xeb78B8EFbb1a521DDF05bb59aAb3CF19bcbFfD34;
