...
// 
//
// 📱 Telegram:https::https://t.me/ELONMINUPortal
/*
...
contract $ELONMINU is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("$ELONMINU", "$ELONMINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "$ELONMINU";
    string private _symbol = "$ELONMINU";
