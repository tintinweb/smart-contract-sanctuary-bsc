...
contract WCG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x614c7130a45b01f869d7B4F717a7Cc7CF1dc4a20); 
    address payable public Wallet_Dev = payable(0x614c7130a45b01f869d7B4F717a7Cc7CF1dc4a20);
