...
contract ABCcoin is ERC20, Ownable{
    ...
    address public marketingWallet = 0x4BbE5AFbc01dfdAFEcBA43e768Ec4A0135519098;
    ...
    Taxes public sellTaxes = Taxes(1,2,4);
    ...
    constructor() ERC20("ABCcoin", "ABC") {
        _mint(msg.sender, 21e10 * 10 ** decimals());
