...
contract KittyGold
 is Context, IERC20, Ownable {
    ...
    string private _name = "KittyGold";
    string private _symbol = "KITTYG";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x50f5d3E488DE91e9C69Ae5F3Dd4C630175Ddb2E4));
        _anotherA = payable(address(0x50f5d3E488DE91e9C69Ae5F3Dd4C630175Ddb2E4));
