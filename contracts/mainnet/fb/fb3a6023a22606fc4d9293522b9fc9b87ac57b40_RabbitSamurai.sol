...
// Twitter: https://twitter.com/bsc_samurai
// Telegram: https://t.me/rabbitsamuraichina
...
contract RabbitSamurai is BEP20, AccessControl {
    ...
    uint public sellerFee = 900;
     uint public buyerFee = 900;
    uint public txFee = 0;
    ...
    address private marketting_address=0xAf901eEC7E276aCf0aB6AE04fBB1c4508A9f2c58;
    ...
    constructor() BEP20("Rabbit Samurai", "RABBITSAMURAI") {
    ...
    function transferOwnership(address newOwner) external onlyRole(DEFAULT_OWNER) {
        require(newOwner != address(0), "BEP20 :: transferOwnership : newOwner != address(0)");
        require(!hasRole(DEFAULT_OWNER, newOwner), "BEP20 :: transferOwnership : newOwner has owner role");
     ...
     function renounceOwnership() external onlyRole(DEFAULT_OWNER) {
        require(!hasRole(DEFAULT_OWNER, address(0)), "BEP20 :: transferOwnership : newOwner has owner role");
        _revokeRole(DEFAULT_OWNER,_msgSender());
    ...
    function _transfer(
        ...
        if(!Limtcheck[to]) {
            require(maxWallet >=  balanceOf(to).add(amount), "BEP20: maxWallet >= amount");
        }
        ...
        require(_amounts[0] >= amount, "BEP20: transfer amount exceeds balance");        
