...
contract RCStandardToken is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        emit TokenCreated(_owner, address(this), TokenType.standard, VERSION);
    }
...
contract RCStandardTokenFactory is Ownable{
    ...
    function deploy(
        ...
        RCStandardToken token = new RCStandardToken(
            name_,
            symbol_,
            decimals_,
            totalSupply_,
