...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CRO = IBEP20(0x1a7a91afF8885d46c3ECf44282053A3659bE6f03);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CRO.balanceOf(address(this));
        ...
        uint256 amount = CRO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            CRO.transfer(shareholder, amount);
...
contract STARLINKINU is IBEP20, Auth {
    ...
    address CRO = 0x1a7a91afF8885d46c3ECf44282053A3659bE6f03;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Starlink INU";
    string constant _symbol = "Starlink INU";
    ...
    function getMultipliedFee() public view returns (uint256) {
        uint256 remainingTime =
            buybackMultiplierTriggeredAt.add(buybackMultiplierLength).sub(
                block.timestamp
            );
        uint256 feeIncrease =
            totalFee
