...
/**
*/
/**  BNBCAT2 | TAX 0% | RENOUNCE CA | LP BURN | INITIAL LP 0.3BNB
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD2c54e53b9c8410b9bd0cBA764151fC97D5038Bc; // owner address
...
contract BNBCAT2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBCAT 2.0";
    string private _symbol = "BNBCAT2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD2c54e53b9c8410b9bd0cBA764151fC97D5038Bc); // 
    address payable public teamWalletAddress = payable(0xD2c54e53b9c8410b9bd0cBA764151fC97D5038Bc); // 
