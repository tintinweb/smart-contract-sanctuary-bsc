...
contract KITTYDOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittyDogeInu";
    string private _symbol = "KDI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6157913fd51f33E12a9842A762cC50CF0E08Cc39); // 营销钱包
    address payable public teamWalletAddress = payable(0x6157913fd51f33E12a9842A762cC50CF0E08Cc39); // 团队钱包
