...
// !!!!ChineseShiba to the moon!!!!

// t.me/chineseshibabsc
...
contract ChineseShiba is IBEP20, Auth {
    ...
    address DEV = 0x14377aCB143dF2f665207cb64C324D69c2B200a2;

    string constant _name = "ChineseShiba";
    string constant _symbol = "CSHIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 22012023 * 10**0 * 10**_decimals;
