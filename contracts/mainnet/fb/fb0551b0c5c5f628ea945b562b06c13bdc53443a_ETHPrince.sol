...
ETH Prince ($ETHPrince) - New Hyper-Deflationary Token created on BSC!

Hold $ETHPrince tokens to earn automatically rewards in $ETH every 30 minutes! 

- Our team is aiming to turn this Degen into a long term project with strong holders!

5%  Goes to the Marketing Wallet.
5%  Goes to Liquidity Pool. 
10% ETH (BEP-20) rewards on each transaction goes to all our holders.

Telegram: https://t.me/ETHPrince_BSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
contract ETHPrince is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ETH Prince";
    string constant _symbol = "ETHPrince";
