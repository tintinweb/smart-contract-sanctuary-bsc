...
contract DirtyDanInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xCEdBC14Bb4612d290bd3983fbb900fA4Cf7657D0); // Marketing Address
    address payable public devWalletAddress = payable(0xCEdBC14Bb4612d290bd3983fbb900fA4Cf7657D0); // Dev Address
    ...
    string private _name = "Dirty Dan Inu";
    string private _symbol = "DirtyDanInu";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xA595d3b063C39128ec6Db190bd402C270771AA27, 'We can not exclude Uniswap router.');
