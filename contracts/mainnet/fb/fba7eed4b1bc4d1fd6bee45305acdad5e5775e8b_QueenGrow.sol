...
contract QueenGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Queen Grow";
    string private _symbol = "QUEENGROW";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x61a315511b2eec5F4a030E1Af3034DA15182DC7B);
