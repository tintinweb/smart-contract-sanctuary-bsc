...
contract ETHERGROW is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   ETHERGROWDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("ETHERGROW", "ETHERGROW") {
        _buyRewardsFee = 3;
        _buyLiquidityFee = 4;
		_buyMarketingFee = 5;
        _buyDevFee = 2;
    	...
    	dividendTracker = new ETHERGROWDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x3029Cdf0884874E88C4353D5655Ae8baa3039153);
        _devWallet = payable(0x5425214dA11A1F9f6cb025f438B3413bB0D80dE4);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "ETHERGROW Verse: The dividend tracker already has that address");

        ETHERGROWDividendTracker newDividendTracker = ETHERGROWDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ETHERGROW Verse: The new dividend tracker must be owned by the ETHERGROW Verse token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "ETHERGROW Verse: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ETHERGROW Verse: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ETHERGROW Verse: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "ETHERGROW Verse: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ETHERGROW Verse: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ETHERGROW Verse: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "ETHERGROW Verse: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "ETHERGROW Verse: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ETHERGROW Verse: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ETHERGROW Verse: Cannot update gasForProcessing to same value");
...
contract ETHERGROWDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("ETHERGROW_Dividend_Tracker", "ETHERGROW_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "ETHERGROW_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ETHERGROW Verse contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "ETHERGROW_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ETHERGROW_Dividend_Tracker: Cannot update claimWait to same value");
