...
contract TESLADOGE is Context, IERC20, Ownable {
    ...
    string private _name = "TESLA DOGE";
    string private _symbol = "TESD";
    ...
    uint256 internal _tokenTotal = 21_000_000e9;
    ...
    uint256 public _marketingFee= 0;// meanse 0%  
    uint256 public _liquidityFee = 900; // means 9%
    uint256 public _rewardFee = 0; // means 0%
    uint256 public _ecosystemFee = 0; // means 0%
    
    uint256 public _SelltaxFee = 200; // means 2% which distribute to all holders reflection fee
    uint256 public _SellmarketingFee = 0;// meanse 0% 
    uint256 public _SelllLiquidityFee = 1300; // means 14%
    uint256 public _SellrewardFee = 0; // means 0%
    uint256 public _SellecosystemFee = 0; // means 0%
    
    
    address private marketingAddress=0x076144EB692b8804E96E062e37BcFa5a742D6f7d;
    address private rewardAddress=0x87935366a37Ca4B4Deb2cE417827593e7dF03a4f; 
    address private ecosystemAddress=0xa1Bf6fE2712F07f838EC4395150B0aAff3355C1a;
    ...
    uint256 public minTokensBeforeSwap = 210e18;
