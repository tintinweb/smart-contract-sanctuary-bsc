...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xD25E02DB74B9Aa86189554E8E418196665dDc22A;//fund address
...
contract NSSB is Token {
    constructor() Token(
        ...
        address(0xD25E02DB74B9Aa86189554E8E418196665dDc22A),//fund address
    
        address(0x92C8CE23A64C7A60A9D44b0bC5E6cf1b8c536995)//dev address
    ){
