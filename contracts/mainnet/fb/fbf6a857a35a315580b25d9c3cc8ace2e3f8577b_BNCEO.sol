...
contract BNCEO  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNCEO ";
    string private _symbol = "BNCEO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5e53399Db708e471279eeAc9e80fBbE0ECE6DDd);
    address payable public teamWalletAddress = payable(0xc5e53399Db708e471279eeAc9e80fBbE0ECE6DDd);
    address public immutable deadAddress = 0xc5e53399Db708e471279eeAc9e80fBbE0ECE6DDd;
