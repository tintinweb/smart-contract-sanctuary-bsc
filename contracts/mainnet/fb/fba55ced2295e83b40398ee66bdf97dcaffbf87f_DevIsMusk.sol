...
contract DevIsMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is Musk";
    string private _symbol = "$DMUSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF5be3Cc4F3685aF9578A8a24c630be5c3c6F3A89);
    address payable public BuyBackWalletAddress = payable(0xF5be3Cc4F3685aF9578A8a24c630be5c3c6F3A89);
