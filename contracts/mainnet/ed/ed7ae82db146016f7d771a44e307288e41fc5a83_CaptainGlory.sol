...
contract CaptainGlory is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Captain Glory";
    string private _symbol = "GLORY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdc1d02cD20127EE0f8aF57c737F7932FceCF4292); // whales
    address payable public teamWalletAddress = payable(0xdc1d02cD20127EE0f8aF57c737F7932FceCF4292); // whales
