...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, getUrl(tokenId));
        return true;
    }
    ...
    function getUrl(uint256 tokenid) public pure returns(string memory){
        return appendUintToString("https://duba-1256662691.cos.ap-chengdu.myqcloud.com/json/",tokenid);
    }
}
...
contract DaoTRC721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("YiDAO NFT", "YiDAONFT") {
