...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xA8A35Ac880E9754D2df8803f3A7D637e245dcC85); //SQUIDGAME2.0
...
contract CheoulSu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Cheoul-Su";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xBB5A9067A1419b994EC917878B3275be77BEF016;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xcE2b43064d64604abFe7cC9E44BAc73eF5290a7C;  //marketingwallet
        anothermarketingWallet = 0xcE2b43064d64604abFe7cC9E44BAc73eF5290a7C; // dev wallet .5 percent ser
