...
contract AladMiner is Ownable {
    ...
    function deposit(uint256 amount) external {
        ...
        if (isAleadyMyChilders[msg.sender]) {
            ...
            isAleadyMyChilders[msg.sender] = false;
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 cWithdraw = acc.selfExpectedRewards.mul(r).mul(getp2()).div(
            1e18
        );
    ...
    function withdrawPrivateRewards(uint256 amount) external {
        ...
        require(amount <= trew, "Insufficient amount");
