...
contract CLown is Context, IERC20, Ownable {
    ...
    string private _name = "Clown Inu";
    string private _symbol = "Clown";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4d69A55450A012F57aD0b1063DA102c696f4c201); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4d69A55450A012F57aD0b1063DA102c696f4c201); // BuyBack Address
