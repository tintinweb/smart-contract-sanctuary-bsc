...
/**
 *Submitted for verification at BscScan.com on 2022-02-30
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  SARDINE = IBEP20(0xaAEbD6BEA5288ddF049c10bCD48Cf8e20EFB236b);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SARDINE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SARDINE);
        ...
        uint256 amount = SARDINE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SARDINE.transfer(shareholder, amount);
...
/* Token contract */
contract BabySardineCoin is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address SARDINE = 0xaAEbD6BEA5288ddF049c10bCD48Cf8e20EFB236b; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Baby Sardine Coin";
    string constant _symbol = "Baby Sardine";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc8a7E018095fb92087eF973956C9AbceAc813b69;
