...
// 
//
// 📱 Telegram:https::https://t.me/+-uVjFFtEW1VmODc1
//
...
contract $BINANCEINU is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("BINANCEINU", "BINANCEINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BINANCEINU";
    string private _symbol = "BINANCEINU";
