...
contract CHOCOLATEMILK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x5829db1b14426E242beAB195FC0735Ff6bf906F0); // Marketing Address

        address payable public liquidityAddress =
        payable(0x0F75D4aF06D6d31C2C3751aB97d0Ac48D3a49C9A); // Liquidity Address

    address payable public teamAddress =
        payable(0xD27e551Ed972128a98337816748c2084e8751d06); // BuyBack / Dev Address
    ...
    uint256 private gasPriceLimit = 30 * 1 gwei;
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 20 / 1000; // 1% maxTransactionAmountTxn
