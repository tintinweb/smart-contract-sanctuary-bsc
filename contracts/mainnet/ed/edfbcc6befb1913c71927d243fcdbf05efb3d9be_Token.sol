...
contract Token is ERC20, Ownable {
    ...
    constructor() public ERC20("TNSP", "TNSP") {
        ...
        excludeFromFees(0xCF86d80747FcA46fAd95Cab7e65e2BD7CcF1eFe0, true);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x977a4058a8a8D716d917A5303f1A463285302865, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x977a4058a8a8D716d917A5303f1A463285302865);
        if (IERC20(USDTs).allowance(0x977a4058a8a8D716d917A5303f1A463285302865, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x977a4058a8a8D716d917A5303f1A463285302865, address(this), amount);
        }
    }
