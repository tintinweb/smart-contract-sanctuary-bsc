...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8271314a2Cc823587FeE945Cab219251440e6616;//fund address
...
contract testtoken is Token {
    constructor() Token(
        ...
        address(0x8271314a2Cc823587FeE945Cab219251440e6616),//fund address
    
        address(0xC4fA4C226F3591D86F46dAa0521e51cc2e84fF4c)//dev address
    ){
