...
/**
Vitalik Tweet About $X - NEW MOONSHOT
...
contract BURN$X is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BURN $X"; 
    string private _symbol = "$X"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x281C547600eeB3D0740f3c8b50885aB94FA73462); 
    address payable public teamWalletAddress = payable(0xaEe56c11Dd7cE2CF8CB664b5354dBaaB5A4B2f4c); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 65 / 10000;
