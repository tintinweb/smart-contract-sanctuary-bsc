...
/**
https://t.me/Different_World_BSC

https://www.differentworld.space/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7951B67c07Ce68E8Ef80010Bfd3b35854C7eA25; // owner address
...
contract DifferentWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DifferentWorld";
    string private _symbol = "$DWORLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7951B67c07Ce68E8Ef80010Bfd3b35854C7eA25); // Marketing Address
    address payable public teamWalletAddress = payable(0xb7951B67c07Ce68E8Ef80010Bfd3b35854C7eA25); // Team Address
