...
// TG: https://t.me/+FrRyBQDmG4MzMjE1
...
contract BasicSexyBitch is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Basic Sexy Bitch"; // Edit Name
    string constant _symbol = "B$B"; // Edit Symbol
