...
contract Token is ERC20, Ownable {
    ...
    uint256 public _protectTime = 70;
    uint256 public _burnTime = 30;
    ...
    constructor() ERC20("Charge Horn", "CHN") {
        ...
        _marketingWalletAddress = 0xDA86c2504B79cf21e94eC280324e161eE2aC1f34;

        _rankWallet = 0xcf2B5E097bDDC9B5dd1e8b7613646D1Fbb39bd85;
    ...
    function updateBurnTime(uint256 value) external onlyOwner {
        _burnTime = value;
    }
    ...
    function launchCheck(address sender, address recipient) internal {
        ...
        if (
            ...
            if (block.timestamp < launchedAtTime + _burnTime) {
