...
contract Scholaroid is ERC721URIStorage, Ownable {
    ...
    uint256 private _maxToken = 10012;
    uint256 private _nftPrice = 0.5 ether;
    ...
    function getTokenSize() public view onlyOwner returns(uint256){
        return _tokenIds.current();
    }

    function mintBatch(uint256 number) public payable returns(uint256) {
