...
contract CowBlindBox2 is AdminTransfer,Multicall,ReentrancyGuard {
    INFTAdmin immutable public cowAdmin;
    address immutable public cc;
    ...
    constructor(INFTAdmin cowAdmin_,address _cc,VRFCoordinatorV2Interface _link,uint _price,uint _minLevel,uint _maxLevel) {
        cowAdmin=cowAdmin_;
        cc=_cc;
        link=_link;
        price=_price;
    ...
    function _open(address to,uint randomX128) internal {
        ...
        uint tokenId=cowAdmin.mintNFT(to);
        cowAdmin.setUintProperty(tokenId,"level",cowLevel);
