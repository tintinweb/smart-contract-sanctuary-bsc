...
contract BabyWorldCup is Context, IERC20, Ownable {
    ...
    string private _name = "Baby World Cup";
    string private _symbol = "BWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32205cF82be83954C10C489F62989F5fA4F3C389); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x32205cF82be83954C10C489F62989F5fA4F3C389); // BuyBack Address
