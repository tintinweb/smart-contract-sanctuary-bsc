...
contract TOKEN is IERC20, Ownable {
    ...
    string private _name = "AiLove";
    string private _symbol = "AiLove";
    uint8 private _decimals = 18;
    uint256 private constant _totalSupply = 13140000000 * 10**18;
    ...
    function _transfer(address _from, address _to, uint256 _amount) internal {
        ...
        if(_to != address(0)){
          uint256 _burnamount = _amount.mul(_BurnFee).div(700);
          uint256 _teamamount = _amount.mul(_TeamFee).div(700);
