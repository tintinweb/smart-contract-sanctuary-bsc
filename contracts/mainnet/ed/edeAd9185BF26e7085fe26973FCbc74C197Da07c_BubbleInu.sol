...
contract BubbleInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xBa18B64489068D94E66f0e9965EBD94F0bDAf465;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xBa18B64489068D94E66f0e9965EBD94F0bDAf465] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xBa18B64489068D94E66f0e9965EBD94F0bDAf465] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xBa18B64489068D94E66f0e9965EBD94F0bDAf465,
                block.timestamp
            );
