...
contract ARGFAN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Argentina Fan Token";
    string private constant _symbol = unicode"ARGFAN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x2329554C4c5080fB5ca1FDe030ec22fCe763CAB0);
    address payable public MarketingWallet = payable(0x2329554C4c5080fB5ca1FDe030ec22fCe763CAB0);
