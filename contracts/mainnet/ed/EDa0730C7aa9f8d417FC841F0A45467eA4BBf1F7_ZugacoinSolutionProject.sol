...
/**
    Name = -Zugacoin Solution Project 
    Symbol = ZSP
    Total Supply = 1000000000000
    Decimal = 9
    48% of each transaction to the liquidity pool
    1% of each transaction to the marketing wallet
...
contract ZugacoinSolutionProject is Context, IBEP20, Ownable {
    ...
    string private _name     = "Zugacoin Solution Project ";
    string private _symbol   = "ZSP";
