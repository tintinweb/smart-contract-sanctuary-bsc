...
Welcome to the Peaky Coin

TOKENOMICS:
Supply: 999,999,999 tokens

Buy Tax 6% / Sell Tax 8%
2 / 3 % marketing
2 / 3 % buyback
2 / 2 % LP

TG: https://t.me/PeakyCoin
...
contract peakycoin is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal; // 2% of supply
    uint256 public maxWalletAmount = _tTotal; // 2% of supply
    ...
    string private constant _name = "Peaky Coin";
