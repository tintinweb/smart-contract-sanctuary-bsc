...
contract FMRH is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIFA MOON RICH"; //
    string private constant _symbol = "FMRH"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x8627EAfe2CC6087f37627E884a92E36F1519902f;
    ...
    function setFBFMRH(address addr, bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }

    function setMFFMRH(uint256 mv) external onlyOwner {
        _marketingFee = mv;
    }
