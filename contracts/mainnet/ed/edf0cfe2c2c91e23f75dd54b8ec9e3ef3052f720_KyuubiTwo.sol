...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD91c663590374cC25D9b9559a993d6c70bF7aA4B; // owner address
...
contract KyuubiTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kyuubi 2.0";
    string private _symbol = "KYUUBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD91c663590374cC25D9b9559a993d6c70bF7aA4B); // Marketing Address
    address payable public teamWalletAddress = payable(0xD91c663590374cC25D9b9559a993d6c70bF7aA4B); // Team Address
