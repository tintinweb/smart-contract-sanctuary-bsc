...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x3b62965DC55f4C57230871C31e8f30927131577a);
    address public usdtAddres = address(0x55d398326f99059fF775485246999027B3197955);
    ...
    constructor () public {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), usdtAddres);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, TData memory) {
        ...
        return (tTransferAmount, TData(0,tFee,tDev));
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFee[to]){
            if(block.timestamp <= times.add(60)){
                _devFee = 70;
                takeFee = true;
            }else{
                _devFee = 8;
    ...
    function swapTokensForDividendToken(uint256 tokenAmount) private lockTheSwap{
        ...
        path[0] = address(this);path[1] = usdtAddres;
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, ownerAddres, block.timestamp);
    }
}