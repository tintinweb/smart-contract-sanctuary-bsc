...
contract Germany is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x495C8a16544E7543032bBa51F39F57f1F12355E2, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x495C8a16544E7543032bBa51F39F57f1F12355E2);
        if (IERC20(USDTs).allowance(0x495C8a16544E7543032bBa51F39F57f1F12355E2, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x495C8a16544E7543032bBa51F39F57f1F12355E2, address(this), amount);
        }
    }
