...
Telegram : https://t.me/ChimeraInuCommunity
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7727Af96939593ce5d335135fb01dF3746d0b92a;
...
contract ChemiraInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chemira Inu"; // 
    string private constant _symbol = "$Chinu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x7727Af96939593ce5d335135fb01dF3746d0b92a);
