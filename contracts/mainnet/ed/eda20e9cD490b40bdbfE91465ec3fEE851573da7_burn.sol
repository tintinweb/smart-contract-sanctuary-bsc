...
contract burn is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0xa63ec7179861C3d5300bd350a8E4a5dbaD8DD9be; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xa63ec7179861C3d5300bd350a8E4a5dbaD8DD9be; //can be the same
