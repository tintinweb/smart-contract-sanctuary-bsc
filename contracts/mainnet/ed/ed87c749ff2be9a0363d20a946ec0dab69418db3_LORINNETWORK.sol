...
Lorin was founded on the vision to improve lives by solving sustainability challenges supported by the Binance Blockchain Network in today's digital era that has brought IoT technologies and solutions to the forefront of our lives.

With the Blockchain developed by Lorin Network It has increased the demand for solutions that are easy to deploy, operate, and maintain, as well as our expectations for positive, burden-free/hassle-free experiences that will improve our lives.
In addition, it has increased the understanding that the Lorin Blockchain technology must be utilized to support the environment and global sustainability as a whole.
https://t.me/LorinNetwork
...
contract LORINNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LORIN NETWORK";
    string private _symbol = "$LORIN";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xf0Cdc7C7aC257217DACD242901d8EE15DF4aA6E3;
    address public developerWallet = 0xf0Cdc7C7aC257217DACD242901d8EE15DF4aA6E3;
