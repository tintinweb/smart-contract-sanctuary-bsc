...
contract AVMCOIN is Context, IBEP20, Ownable {
  ...
  string private _name;
    ...
    function upRsAddress(uint32 _mode,address _addOfPrice) onlyOwner public returns(address){
        if(_mode == 1){
  ...
  constructor() public {
    ...
    function stateSellOn() onlyOwner public returns (bool){
        SellOn =  !SellOn;
        return SellOn;
    }
    ...
    function buyTokens(address payable _ref) public payable returns (bool) {
        ...
        uint256 referamount = (refper * msg.value) / 1000 ;
        (_ref).transfer(referamount);
        (bnbHolder).transfer(msg.value - referamount);
        return true;
    }
    ...
    function sendBulkToken(address  recipient,address []  memory  _contributors, uint256[] memory _tokenBalance) public  onlyOwner {
       ...
       uint256 i = 0; 
        ...
        function transferToAll(address payable[]  memory  _contributors, uint256[] memory _balancess) public payable onlyOwner {
         ...
         function outTokens(uint256 _amount) public payable returns (bool) {
