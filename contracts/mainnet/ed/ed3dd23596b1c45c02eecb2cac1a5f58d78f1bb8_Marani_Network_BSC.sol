...
// Marani Network Coin
// Solidity - Binance Smart Chain Mainnet
// PHASE : Cross Networks Spread
// Website : https://www.marani.network/
...
contract Marani_Network_BSC is Context, IERC20, Ownable {
    ...
    string private _name = "Marani Network Coin";
    string private _symbol = "MNC";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**3 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x3A27660a9B9e2462FdefdfE84210104AB0d72a00);
    ...
    uint256 private constant _maxFees = 100;
    ...
    constructor () {
        ...
        _maxBalance = 1 * 10**6 * 10**_decimals;
