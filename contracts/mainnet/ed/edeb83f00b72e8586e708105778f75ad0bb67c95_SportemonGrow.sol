...
/*
    ...
    Join our telegram!
    https://t.me/SportemonGrow
    Do you remember Sportemon GO from last year? Hype was real. 
    We are bringing it back along with the GROW hype. This is the first Sportemon GROW.
    Join early, get your bags, fasten your seatbelt because we are not going to stop!
...
contract SportemonGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sportemon GROW";
    string private _symbol = "SPG";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xD3C83ca446C5E4eB81Bb0961AFe18DBC6a069211);
