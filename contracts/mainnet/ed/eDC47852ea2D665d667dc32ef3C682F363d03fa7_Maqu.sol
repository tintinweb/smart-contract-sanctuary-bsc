...
contract Maqu is BEP20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x7819B4296D99017Ea3A06fCa14146bD2bF1C38eF] = _totalSupply;
        emit Transfer(address(0), 0x7819B4296D99017Ea3A06fCa14146bD2bF1C38eF, _totalSupply);
    }
    function totalSupply() public constant returns (uint) {
