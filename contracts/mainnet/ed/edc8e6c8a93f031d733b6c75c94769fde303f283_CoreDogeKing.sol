...
contract CoreDogeKing is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CORE DOGEKING";
    string private _symbol = "CDK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x667BbBe470F1134f644a25e62877893599b1c3Ca);
    address payable public liqWalletAddress = payable(0x667BbBe470F1134f644a25e62877893599b1c3Ca);
    ...
    uint256 private _totalSupply =  332765* 10**_decimals;
    uint256 public _maxTxAmount =   9982* 10**_decimals;
    uint256 public _walletMax =     9982* 10**_decimals;
