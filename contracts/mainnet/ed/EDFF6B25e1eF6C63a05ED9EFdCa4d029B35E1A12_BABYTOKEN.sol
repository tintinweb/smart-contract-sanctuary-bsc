...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 520 * 10 ** IERC20(FISTAddress).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8F95124001F60Cef722180af324408E9D2314cb6;//
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"TangYuan",//Symbol
        9,//Decimals
        520,//Supply
        address(0x8F95124001F60Cef722180af324408E9D2314cb6),//FundAddress
        address(0x8F95124001F60Cef722180af324408E9D2314cb6)//ReceiveAddress
    ){
    }
}