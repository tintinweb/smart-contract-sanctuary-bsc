...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87799D4EA90ae3f9cD380BaeaE5985fB4e46132f; // owner address
...
contract GalaRise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GalaRise";
    string private _symbol = "GalaRise";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87799D4EA90ae3f9cD380BaeaE5985fB4e46132f); // 
    address payable public teamWalletAddress = payable(0x87799D4EA90ae3f9cD380BaeaE5985fB4e46132f); // 
