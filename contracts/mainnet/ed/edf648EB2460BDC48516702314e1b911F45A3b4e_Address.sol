...
abstract contract ArkenDexTrader {
    ...
    function _wrapEther(address weth, uint256 amount) internal {
        ...
        IWETH(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889).deposit{value: amount}();
    }

    function _unwrapEther(address weth, uint256 amount) internal {
        // IWETH(weth).withdraw(amount);
        IWETH(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889).withdraw(amount);
    }
    ...
    ArkenDexTrader
{
    ...
    address public _WETH_ = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //bsc
    // address public _WETH_; //mumbai
