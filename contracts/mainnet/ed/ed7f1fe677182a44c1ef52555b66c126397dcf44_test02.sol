...
/**
Telegram: https://t.me/christmas_doge
*/
...
contract test02 is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "test02";
    string private constant _name = "test 02";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 1, 10);
    Taxes public taxes = Taxes(0, 5, 1, 5);
