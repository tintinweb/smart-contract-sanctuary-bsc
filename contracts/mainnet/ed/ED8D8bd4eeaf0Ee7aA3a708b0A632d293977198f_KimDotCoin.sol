...
$ KIM DOT COM FANTOKEN $

Burn Mechanism:
3% of every transaction gets automated burned.
The Supply gets thinner at every buy and sell!

1% LP distribution.

4% Marketing Fees. Theese will be lowered after some time.
Will be used for Marketing, Donations...
...
TG: t.me/Kim_DotCoin
Twitter: https://twitter.com/KFantoken
...
contract KimDotCoin is BEP20, Auth {
    ...
    string public constant name = "Kim DotCoin";
    string public constant symbol = "KDCoin";
