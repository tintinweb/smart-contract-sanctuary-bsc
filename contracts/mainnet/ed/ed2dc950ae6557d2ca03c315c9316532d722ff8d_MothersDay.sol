...
contract MothersDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MothersDay";
    string private _symbol = "MothersDay";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD6538aC7E0862d5F59CCb548ad30120f94cCA883); // Marketing Address
    address payable public teamWalletAddress = payable(0x8fa43FB2407AF534637fA5A83074a4AC434459CC); // Team Address
