...
abstract contract ContextyuanCHINABep20 {
...
contract OwnableyuanCHINABep20 is ContextyuanCHINABep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableyuanCHINABep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableyuanCHINABep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DigitalYuanCNTokenClub is ContextyuanCHINABep20, yuanCHINABep20, OwnableyuanCHINABep20 {
    ...
    string private _name = 'Digital Yuan';
    string private _symbol = '$DYAUN$';
