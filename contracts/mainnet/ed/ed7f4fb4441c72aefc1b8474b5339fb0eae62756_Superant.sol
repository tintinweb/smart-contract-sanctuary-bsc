...
contract Superant is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x472eeF4209b19D88a853A27D6D30886c476c19A8); // Marketing Address
    ...
    uint256 private _tTotal = 1000000000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Superant";
    string private _symbol = "Superant";
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**2 * 10**9;
