...
contract Tetsuya is Context, IERC20, Ownable {
    ...
    string private _name = "Tetsuya Coin";
    string private _symbol = "Tetsuya";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xFc57aAaF7B21E6476E1BAC82F5613D5706cc8b2c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFc57aAaF7B21E6476E1BAC82F5613D5706cc8b2c); // BuyBack Address
