...
contract IAM is Context, IERC20, Ownable {
    ...
    string private _name = "IAM";
    string private _symbol = "IAM👑";
    ...
    constructor (address BurnWallet) public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5E19BD0895B4C25e381aEd72e5395B9dE1369258); //TESTNET
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x5E19BD0895B4C25e381aEd72e5395B9dE1369258, 'We can not exclude Uniswap router.');
