...
TELEGRAM:  https://t.me/peppapigcoinV2
*/
...
contract PEPPAPIGV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPPA PIG V.2"; // 
    string private constant _symbol = "$PEPPA V.2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x2696eE82251411fb06ab1A2cd5F7dED0Cb705Aa1;
