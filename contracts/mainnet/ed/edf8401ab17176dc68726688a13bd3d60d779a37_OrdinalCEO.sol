...
contract OrdinalCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal CEO";
    string private constant _symbol = "OrdinalCeo";
