...
contract DEVISGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dev is Grow";
    string private constant _symbol = "DEVGROW";
