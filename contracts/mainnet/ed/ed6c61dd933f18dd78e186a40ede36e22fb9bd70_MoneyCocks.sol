...
contract MoneyCocks is Context, IERC20, Ownable {
    ...
    string private constant _name = "Money Cocks";
    string private constant _symbol = "MoneyCocks";
