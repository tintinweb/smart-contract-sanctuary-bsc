...
contract LaborDogeKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Labor Doge King";
    string private _symbol = "LDK";
    uint8 private _decimals = 5;

    uint256 _totalSupply = 5000000 * 10**15 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x7405EE195084640Aeb470c93c648A9c5f9fD3467; 
