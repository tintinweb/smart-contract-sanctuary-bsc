...
// Infinity Spermacy Network

// https://t.me/InfinityspermacyNet
...
contract InfinitySpermacy is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9aE53f4Ae6C8819bB46b040306669a7880B1D7C7); 
    address payable public Wallet_Dev = payable(0x9aE53f4Ae6C8819bB46b040306669a7880B1D7C7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x9aE53f4Ae6C8819bB46b040306669a7880B1D7C7); 
    


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 0;
    uint256 private _tTotal = 1000000000 * 10**24;
    string private constant _name = "Infinity Spermacy Network"; 
    string private constant _symbol = unicode"ISN"; 
    ...
    constructor () {
        ...
        _owner = 0x9aE53f4Ae6C8819bB46b040306669a7880B1D7C7;
