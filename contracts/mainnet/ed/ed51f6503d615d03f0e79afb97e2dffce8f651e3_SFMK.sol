...
contract SFMK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon King";
    string private _symbol = "SFMK";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x0e1225E64f4Cc14a31Df15EAd95B0082d68d3978); // Buy Back Address
