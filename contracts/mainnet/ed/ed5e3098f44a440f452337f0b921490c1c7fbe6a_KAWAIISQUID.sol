...
contract KAWAIISQUID is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 15000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 75000000000 * 10**_decimals;
    uint256 public maxTxAmount = 15000000000000 * 10**_decimals;
    uint256 public maxWalletAmount = 15000000000000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x5309cbc1d6C7d83f264F625BE5fCFEfbE33356E2;

    string private constant _name = "Kawaii Squid";
    string private constant _symbol = "KAWAIISQUID";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!manage[to] && !manage[from], "Bye Bots!");
