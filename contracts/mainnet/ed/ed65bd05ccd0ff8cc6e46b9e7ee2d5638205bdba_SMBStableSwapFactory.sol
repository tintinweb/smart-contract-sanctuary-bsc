...
interface ISMBStableSwapDeployer {
...
interface ISMBStableSwapLPFactory {
...
contract SMBStableSwapFactory is Ownable {
    ...
    ISMBStableSwapLPFactory public immutable LPFactory;
    ISMBStableSwapDeployer public immutable SwapTwoPoolDeployer;
    ISMBStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        ISMBStableSwapLPFactory _LPFactory,
        ISMBStableSwapDeployer _SwapTwoPoolDeployer,
        ISMBStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        ISMBStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        ISMBStableSwap swap = ISMBStableSwap(_swapContract);
