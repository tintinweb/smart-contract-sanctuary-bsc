...
// MADUTOKEN Renewable NFT staking Contract
...
contract SmartNFTPoolRenewable is IERC721Receiver ,Ownable, ReentrancyGuard {
    ...
    // The staked token
    IMaduTokenNFT public stakedToken;
    ...
    address public vault = 0xf7925e56Fc59672A706479de988AF94275900996;    // MADU FEE
    uint256 public tokenFee = 50000000000000000000;
    ...
    */
    function extendPoolWithFundsAlreadyInContract() external onlyOwner {
        ...
        emit ExtendPoolWithFundsAlreadyInContract();
    }
    ...
    function startNewPool( uint256 _startInDays, uint256 _poolLengthDays ) external onlyOwner {
        ...
        emit StartNewPool(_startInDays, _poolLengthDays);
    }

    function setupTokens(
        IMaduTokenNFT _stakedToken,
        IBEP20 _rewardToken,
