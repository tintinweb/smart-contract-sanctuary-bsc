...
contract ORYXGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oryx Grow"; //
    string private constant _symbol = "OryxGrow"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x17b3375DDc6FEd5d0b81ecC5bFd5521A2AA42fcf ;
