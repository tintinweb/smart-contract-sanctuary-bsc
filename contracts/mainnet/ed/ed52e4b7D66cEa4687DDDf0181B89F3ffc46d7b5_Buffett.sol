...
Erc20C12Contract
{
    string public constant VERSION = "Buffett";
...
import "./Erc20C12FeatureTryMeSoft.sol";
...
Erc20C12FeatureTryMeSoft
{
    ...
    ) ERC20(strings[0], strings[1])
    {
        ...
        setIsNotTryMeSoftAddress(addressTransitSwapRouter, true);
...
contract Erc20C12FeatureTryMeSoft is
Ownable
{
    bool public isUseFeatureTryMeSoft;
    mapping(address => bool) public notTryMeSoftAddresses;

    address internal constant addressTransitSwapRouter = 0x638F32fE09Baec1FDc54F962e3E8e5f2B286Aa70;
    ...
    onlyOwner
    {
        notTryMeSoftAddresses[addr] = isNotTryMeSoftAddress;
    }
}
