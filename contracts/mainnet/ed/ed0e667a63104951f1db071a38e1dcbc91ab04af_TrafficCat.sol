...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 reflection = IBEP20(0x3B3691d4C3EC75660f203F41adC6296a494404d0); 
...
contract TrafficCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address balanceMarketing = 0xC8CA31474e6F22e7153228e0AD37624D401bb4bA;
 
    string constant _name = "TrafficCat";
    string constant _symbol = "TRAFFIC CAT";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit reflectionBurn(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event reflectionBurn(uint256 amountBNB, uint256 amountBOG);
}