...
contract CAESARLORD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Caesar Lord";
    string private _symbol = "CAESARLORD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xae393C5808ec0a5760FD7e65Ff03B2a654af5758); // Marketing Address
    address payable private teamWalletAddress = payable(0xae393C5808ec0a5760FD7e65Ff03B2a654af5758); // Team Address
    ...
    uint256 public _maxTxAmount = 2 * 10**2* 10**6* 10**_decimals; 
