...
contract SoyMilk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Soy Milk";
    string private _symbol = "$SOYMILK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x078B768a868d887e7dC5d85dc6ca5059781FFEF2); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x078B768a868d887e7dC5d85dc6ca5059781FFEF2); // Team Address
