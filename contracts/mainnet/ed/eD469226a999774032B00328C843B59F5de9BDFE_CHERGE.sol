...
contract CHERGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cheems Merge"; // 
    string private constant _symbol = " $CHERGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xFa9002A19be5DE46294EF6D2F1573b9BeD9290A3;
