...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3094852e501304A2e91586997F2f96B3fF6c3075; // owner address
...
contract SHIBARABIAN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3094852e501304A2e91586997F2f96B3fF6c3075); // Marketing Address
    address payable public teamWalletAddress = payable(0x3094852e501304A2e91586997F2f96B3fF6c3075); // Team Address
