...
contract DawgsDay is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dawgs Day";
    string private _symbol = "DWD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE5672e70D1a4BA754b6156B373fD78F24600Fa57);
    address payable public liqWalletAddress = payable(0xE5672e70D1a4BA754b6156B373fD78F24600Fa57);
    ...
    uint256 private _totalSupply =  7000000 * 10**_decimals;
