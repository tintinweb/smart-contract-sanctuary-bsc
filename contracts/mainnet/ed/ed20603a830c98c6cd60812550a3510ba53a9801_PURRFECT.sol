...
contract PURRFECT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PURRFECT";
    string constant _symbol = "PURRFECT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 8) / 200; // 4% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 8) / 200; // 4% of Total supply
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 1000; // 0.4
    bool inSwap;
