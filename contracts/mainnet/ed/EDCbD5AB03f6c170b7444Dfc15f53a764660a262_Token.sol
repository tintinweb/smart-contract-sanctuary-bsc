        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xDEaAf0f007B549365B2CBd5A4a14E3220D5389fC), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply100000
        address(0x33BbB6AdE9Be32E1772a75aa27d12C5392d595a3),//FundAddress
        address(0x33BbB6AdE9Be32E1772a75aa27d12C5392d595a3)//ReceiveAddress
    ){
    }
}