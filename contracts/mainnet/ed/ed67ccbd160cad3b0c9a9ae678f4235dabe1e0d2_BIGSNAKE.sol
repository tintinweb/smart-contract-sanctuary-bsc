...
contract BIGSNAKE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BIGSNAKE';
    string private constant _symbol = '$BIGSNAKE';
    ...
    //DevWallets
    address public TeamWallet=payable(0x867cC5a3512fa708EB2e8e967aA72c9D3095753E);
    address public walletTwo=payable(0x376A67BFc7F42D5C07f9F1F6425e8c94567CC11F);
    //TestNet
	...
	uint256 private autoBanTime = 120; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
