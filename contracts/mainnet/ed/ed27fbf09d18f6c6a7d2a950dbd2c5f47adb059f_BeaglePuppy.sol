...
BeaglePuppy  - New Meta On BSC 🚀

BeaglePuppy  is a community-driven cryptocurrency meme on Binance Smart Chain. 
*/
...
pragma solidity ^0.6.7;
    ...
    contract BeaglePuppy is Context, IERC20, Ownable {
        ...
        string private _name = 'Beagle Puppy';
        string private _symbol = 'BPPY';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xC4a4bF370d8195fDc42720f67C852f34688c0e70, 'We can not exclude Uniswap router.');
