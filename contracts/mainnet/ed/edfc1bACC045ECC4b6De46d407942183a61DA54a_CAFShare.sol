...
contract CAFShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Caffeine Fund Share", "CAFSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 CAF Share for initial pools deployment
