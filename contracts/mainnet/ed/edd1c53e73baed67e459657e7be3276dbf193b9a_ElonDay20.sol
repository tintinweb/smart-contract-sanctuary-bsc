...
/**
Telegram: https://t.me/Elonday20_portal
*/
...
contract ElonDay20 is IBEP20, Auth {
    ...
    string constant _name = "ElonDay20";
    string constant _symbol = "ElonDay20";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 8) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0x13526C15aF31a89394A6295d23dEF26fe0B33B35;
    address private teamFeeReceiver =0xCBa338b4863B7219c5c0E17a0c203Fe4d09A3460;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x13526C15aF31a89394A6295d23dEF26fe0B33B35;
