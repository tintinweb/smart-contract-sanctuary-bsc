...
contract CharizardGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Charizard Grow";
    string private _symbol = "CZG";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xF53129E00555bA71b247ac14663251D76383882C);
    address payable public teamWalletAddress = payable(0x76bA89288d691b22aFb23D64A057B2EE952CC8db);
