...
contract DogeToMoonBSC is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeToMoon";
    string private _symbol = "$DTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C2631D1E17a27c5f1ac13202A996CB4f79754Fd); // Marketing Address
    address payable teamWalletAddress = payable(0xAea7fb9122E665d5C9fa9942737fDEd142D8F465); //
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; //1 * 10**6 * 10**9;
