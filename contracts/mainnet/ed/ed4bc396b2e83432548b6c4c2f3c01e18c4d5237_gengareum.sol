...
contract gengareum is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gengareum";
    string private _symbol = "GENETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5391d3Bb69ae2be3bd9D527A7422f53BC386DdE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD5391d3Bb69ae2be3bd9D527A7422f53BC386DdE); // BuyBack Address
