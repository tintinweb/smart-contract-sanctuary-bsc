...
contract HogeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hoge Grow";
    string private _symbol = "Hogegrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBF7449c1F381F3e9BAd09C8719C4AE96b9C8B16d);
    address payable public BuyBackWalletAddress = payable(0xBF7449c1F381F3e9BAd09C8719C4AE96b9C8B16d);
