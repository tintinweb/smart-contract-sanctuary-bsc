...
contract DROIDTEST is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(riskFreeValueFee).add(devFee);
    ...
    address public devWalletReceiver;
    ...
    constructor(
    ...
    ) ERC20Detailed("DROIDTEST", "DROIDTEST", uint8(DECIMALS)) {
        ...
        _isFeeExempt[devWalletReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHDev = amountETH.mul(devFee).div(
            totalETHFee
        );
        ...
        (success, ) = payable(devWalletReceiver).call{
            value: amountETHDev,
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        treasuryReceiver = _treasuryReceiver;
        riskFreeValueReceiver = _riskFreeValueReceiver;
        devWalletReceiver = _devFeeReceiver;
    }
