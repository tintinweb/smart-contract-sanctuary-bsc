...
Hello Players. 
This is the frontman speaking. Squid Black is not a project of the Squid Game 2.0 team. We had arranged a partnership with them to work with us to push and create the initial hype. We are not connected to GTA VI token or any other Squid Black token deployed so far. 

The Black Squid Game will commence soon. 

Good luck players.

Telegram: https://t.me/SquidBlackBSC
...
contract SquidBlack is Ownable, IBEP20 {
    ...
    uint256 public gas = 20 * 1 gwei;

    string constant _name = "Squid Black";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x043EB5Be29B6797ca8401abdc09ee3F4bc83d571;
        marketingWallet = 0x043EB5Be29B6797ca8401abdc09ee3F4bc83d571;

        totalFee = 10;
        totalFeeIfSelling = 10;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(liquidityFee).div(2).div(100);
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(100).div(2);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(100);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 1);
        require (newTotalSell < 1);
        require (newLiqFee + newMarketingFee == 100);
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;

        totalFee = newTotalBuy;
        totalFeeIfSelling = newTotalSell;
    }
