...
/**
ChiyoInu is ready to join the Binance Smart Chain blockchain.
His mission is to take over the world of Meme Token.
Chiyo is just a little chicken, in the real world chiyo can't fly,
but in the degen world chiyo can fly and fly higher.

📫Telegram : https://t.me/ChiyoInuBSC
**/
...
contract ChiyoInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xEA3e1770507468D8f128468F8106d4a803a27F7f);
        
    address payable public teamAddress =
        payable(0x70bEb8B36Af9C68B2CCB505A87B4964d6bED543b);
        
    address payable public liquidityAddress =
        payable(0xfae1c4B873708CCCE0Bd5575A5544E3e2352c207);
    ...
    string private constant _name = "Chiyo Inu";
    string private constant _symbol = "CHIYO";
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 49, "Must keep taxes below 49%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 49, "Must keep taxes below 49%");
