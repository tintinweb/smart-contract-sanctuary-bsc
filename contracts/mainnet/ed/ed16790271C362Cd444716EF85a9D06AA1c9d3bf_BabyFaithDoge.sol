...
contract BabyFaithDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby FaithDoge";
    string private _symbol = "FAITH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5917d4FF3479FCDA63EdD7966B5Ad1D7Ba15Ceec);
    address payable public teamWalletAddress = payable(0x5917d4FF3479FCDA63EdD7966B5Ad1D7Ba15Ceec);
