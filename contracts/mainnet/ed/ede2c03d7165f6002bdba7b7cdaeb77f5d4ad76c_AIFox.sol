...
interface IAIFOXEcosystemFeeDistributor {
    function distributeAIFoxTokens()
    external
    returns (bool);
    event DistributedAIFoxTokens(uint256 amount);
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyAIFoxEcosys() {
        require(msg.sender == _AIFoxEcosys);
        _;
    }
    ...
    function setAIFoxEcosys (address AIFoxEcosys) external onlyToken {
        _AIFoxEcosys = AIFoxEcosys;
    }
    ...
    function deposit() external payable override onlyAIFoxEcosys {
...
contract AIFox is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "AIFox";
    string constant _symbol = "AIFOX";
    uint8 constant _decimals = 18;

    address private _owner;

    uint256 _totalSupply = 500000 * 10**9 * (10**_decimals); // 500 Trillion
    ...
    IAIFOXEcosystemFeeDistributor public AIFoxEcosys;
    ...
    constructor() {
        ...
        AIFoxEcosys = IAIFOXEcosystemFeeDistributor(address(this));
    ...
    function swapBack() internal swapping {
       ...
       _basicTransfer(address(this),address(AIFoxEcosys), amountSwapBackBefore.div(2));
    
    
        try AIFoxEcosys.distributeAIFoxTokens() {} catch {}
    ...
    function setecosystem(address _AIFoxEcosys) external onlyOwner {
        AIFoxEcosys = IAIFOXEcosystemFeeDistributor(_AIFoxEcosys);
        distributor.setAIFoxEcosys(_AIFoxEcosys);
    }
