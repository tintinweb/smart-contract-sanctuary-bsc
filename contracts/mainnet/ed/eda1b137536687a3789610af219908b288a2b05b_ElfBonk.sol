...
contract ElfBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElfBonk";
    string private _symbol = "EBONK";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xa595913AAcf7Cc830691D4D615797B66485f3E85); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xa595913AAcf7Cc830691D4D615797B66485f3E85); // Liquidty Address
