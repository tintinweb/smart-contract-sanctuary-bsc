...
contract NekoMao is Context, IERC20, Ownable {
    ...
    string private _name = "NekoMao Token";
    string private _symbol = "Nmao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28C6C27E987736FE58687Caca5DCDB5E256b27a4);
    address payable public DevWalletAddress = payable(0x28C6C27E987736FE58687Caca5DCDB5E256b27a4);
