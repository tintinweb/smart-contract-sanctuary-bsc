...
// 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/PolymerizationBSC

// 𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://www.polymerization.icu

// 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/PolymerizationX
...
contract Polymerization is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PolymerizationDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Polymerization", "POLYMERIZATION") {
        UtilityWallet = payable(0x613405861Acc3dFb1D05058300138cd5F9Bb8088);
        DevelopmentWallet = payable(0x9a1A48F368e791249D24EA2b2c81E9eF91a2A650);
        ...
        dividendTracker = new PolymerizationDividendTracker(
            payable(this),
            router,
            0xDB20F6A8665432CE895D724b417f77EcAC956550,
            "PolymerizationTRACKER",
            "PolymerizationTRACKER"
        );
...
contract PolymerizationDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Polymerization public PolymerizationContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PolymerizationContract = Polymerization(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Polymerization_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Polymerization_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Polymerization contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PolymerizationContract);

            uint256 prevBalance = PolymerizationContract.balanceOf(address(this));
            ...
            {
                uint256 received = PolymerizationContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PolymerizationContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
