...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0a19DAb017b66f54D633f0Cf8d7C6A2d4A5D21fe;
...
contract SUAVIS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0ab03097231bc660D66C92eb0E4572b5aD2a6fa8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SUAVIS";
    string private _symbol = "suavis";
