...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBdf70b1ddFf58155fe58F729dd2fd59E9F94d8E3; // owner address
...
contract PepaCeoOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPA CEO";
    string private _symbol = "PEPA CEO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x48Eaf081Fe8D771E7264d9B042ac792518728BEf); // Marketing Address
    address payable private teamWalletAddress = payable(0xBdf70b1ddFf58155fe58F729dd2fd59E9F94d8E3); // Team Address
