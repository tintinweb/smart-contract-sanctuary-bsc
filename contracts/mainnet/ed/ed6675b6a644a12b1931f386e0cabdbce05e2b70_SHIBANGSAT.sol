...
contract SHIBANGSAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBANGSAT"; //
    string private constant _symbol = "SHIBANGSAT"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x80513E22A5e3e2D67abD1372298177Fca25ed6CF;
