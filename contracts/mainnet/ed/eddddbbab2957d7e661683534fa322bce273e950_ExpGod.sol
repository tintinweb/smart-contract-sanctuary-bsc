...
contract ExpGod is IERC20, Ownable {
    ...
    string constant _name = "Exp God";
    string constant _symbol = "EXPG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1;
    uint256 public _maxWalletSize = (_totalSupply * 2) / 1;
    ...
    uint256 public tradingAnytimeLimit = 1;
    ...
    uint256 public swapThreshold = _totalSupply / 2;
    bool inSwap;
