...
/**
Welcome to Lunamon TOKEN!
Relaunched BSC Version
...
contract Lunamon_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "LUNAMON";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 11, // dev team fee in %
            treasury: 11, // treasury fee in %
            lp: 3, // lp rate in %
            toSwap: 25 // treasury + dev + lp
        });
