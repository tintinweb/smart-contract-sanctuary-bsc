...
// TELEGRAM: https://t.me/NaziTrumpPutin69Inu
...
contract naziputin is Ownable, IERC20 {
    ...
    string private _name = "NaziTrumpPutin69Inu";
    string private _symbol = "NaziPutin";
 
    uint public _liquidityFee = 5;
    uint public _marketingFee = 4;
    uint256 public _totalFee = _liquidityFee + _marketingFee;
    uint public _liquiditySellFee = 5;
    uint public _marketingSellFee = 7;
