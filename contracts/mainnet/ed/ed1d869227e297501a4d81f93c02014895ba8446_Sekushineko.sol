...
contract Sekushineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sekushineko";
    string private _symbol = "Shineko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFa26Bc6a0EFF27743cF356c0494DE4D42880B2e2);
    address payable public BuyBackWalletAddress = payable(0xFa26Bc6a0EFF27743cF356c0494DE4D42880B2e2);
