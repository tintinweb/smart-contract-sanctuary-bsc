...
contract OrganicApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Organic Ape";
    string private _symbol = "OGNAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfa4525021615dAc7ecb39194Ba4E20A61B1718ec); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x7ABd26cF07C647240293567c792B09FE0653839a); // Development Address
    ...
    constructor () {
        ...
        liquidityWalletAddress = msg.sender;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBDevelopment > 0)
            transferToAddressETH(BuybackWalletAddress, amountBNBDevelopment);
