...
// * * 2% Rewards in SOLANA * TG : QsolinuBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); // SOLANA
...
contract SolInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x57a4a86915Ad41231883E026A95f21Fec40B45a2;

    string constant _name = "Sol Inu";
