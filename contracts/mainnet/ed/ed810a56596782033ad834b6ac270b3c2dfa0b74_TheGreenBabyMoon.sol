...
contract TheGreenBabyMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Green Baby Moon";
    string private _symbol = "TGBM";
    ...
    address payable public marketingWallet = payable(0x92afdF1aEB418901C2F3FC543E7Ff0d6F95b20B7);
