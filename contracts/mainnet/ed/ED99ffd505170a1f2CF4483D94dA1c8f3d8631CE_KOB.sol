...
contract KOB is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x318F733aBeAe822648804170139a9A0b50092222);
    address public devAddress = address(0xa375215022d845B53d8140798Bfdba00657C20cC);
