...
Every new player that buys $HODL will mint 5 new $HODL that will get redistributed proportionally to all exsisting holders of $HODL.
...
contract HODL {
	...
	uint256 constant private new_address_supply = 5e3;
