...
/*      Buggy Inu
            Telegram : https://t.me/buggyinuportal
            Webiste : https://buggyinu.com/
*/
...
contract BUGGYINU is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x721f5278b77070fbb8034d79f54e38F5793cEA79);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**9 * 10**_decimals;
    string private constant _name = "Buggy Inu"; 
