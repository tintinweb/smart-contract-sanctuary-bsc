...
Waka Inu is decentralized exchange, integrating Enhanced Privacy and new Features to come to the DEFI generation

We are very unique so we can beat the market

*Website: https://wakainu.finance
...
contract WakaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Waka Inu";
    string private constant _symbol = "WAKA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0b6F4D68007794e557506Fb6009b59C45fa9841D);
    address payable private _marketingAddress = payable(0x68684FDd8A046C0E5962239c2177002598135b05);
