...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa91DBe7AF630230181B1357F8d8E25214455950E; // owner address
...
contract BigGun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Big Gun";
    string private _symbol = unicode"BIGUN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61233C6de65C216Fce155e62A5ec0d3882BAB081); // Marketing Address
    address payable public teamWalletAddress = payable(0xa91DBe7AF630230181B1357F8d8E25214455950E); // Team Address
