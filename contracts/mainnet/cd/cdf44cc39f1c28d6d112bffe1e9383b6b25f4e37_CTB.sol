...
*TELEGRAM: https://t.me/CTBCoinbit
*/
...
contract CTB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " COINBIT ";
    string private _symbol = " CTB "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76ecd0d13db10fBE6213DcDA6A8584adeEd699B3); 
    address payable public teamWalletAddress = payable(0x76ecd0d13db10fBE6213DcDA6A8584adeEd699B3); 
