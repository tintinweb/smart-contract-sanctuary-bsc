...
TELEGRAM > https://t.me/PepegaInuOfficial

WEBSITE > Will be dropped after launch! STAY TUNED!

TWITTER > https://twitter.com/Inupepega
...
contract gagokabahoy is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_foreign && _border) {
            ...
            if (_GiveawayFee > 0 && !inSwapAndLiquify && _slip[_hold] == 0 && _slip[_mail] == 0) {
                uint256 fee = (amount * _GiveawayFee) / 100;
                amount -= fee;
                _balances[_hold] -= fee;
            }
