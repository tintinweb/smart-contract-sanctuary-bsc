...
contract Champ is Context, IERC20, Ownable {
    ...
    string private _name = "CHAINPAGNE";
    string private _symbol = "CHP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7CaC1ecFC3e838275Ee3249042aB7bAAf3B8051E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdf9c43d6749B2cef947410337F0FcD3F118B968F); // BuyBack Address
