...
contract DH is ERC20 {
	...
	address payable _fundAddress = payable(address(0x66A321221818f1ec5cf4Bea9c229f2085E76CcE4));
    ...
    constructor(address tokenOwner) ERC20("DIHUANG", "DH") {
        ...
        FIST = IERC20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                swapAndLiquify(haveAmount.div(7));
                swapAndLiquifyV3(haveAmount.div(7).mul(6));
                swapping = false;
            }
        }
        ...
        if (takeFee) {
            _takeInviterFee(from, to, amount);//0.5
            super._transfer(from, _destroyAddress, amount.div(200));
            super._transfer(from, _fundAddress, amount.div(1000).mul(15));
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private  {
			uint256 half12 = contractTokenBalance.div(2);
			uint256 otherHalf = contractTokenBalance.sub(half12);
