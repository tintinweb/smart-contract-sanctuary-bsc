...
contract Kgold is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kabuto Gold";
    string private _symbol = "KG";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x95CbD5068F0654F3C283E9d15EB6BdFE193bEdC7);
