...
contract LFWUtils {
    ...
    function getPancakeFarmingInfo(
        ...
        // [2] is the lp token address
        farmingData[0] = address(scInterface.lpToken(_pId));
    ...
    function getApeBANANAFarmingInfo(
        ...
        // [2] is the lp token address
        (farmingData[0], , , ) = scInterface.poolInfo(_pId);

        // [3] is the reward token address
        farmingData[1] = banana;
    }

    function getApeJungleFarmingInfo(
        address _scAddress,
        address _userAddress
    ) public view returns(uint256[] memory farmingInfo, address[] memory farmingData) {
        // Define array to return
        ...
        // [2] is the lp token address
        farmingData[0] = scInterface.STAKE_TOKEN();

        // [3] is the reward token address
        farmingData[1] = scInterface.REWARD_TOKEN();
    }
