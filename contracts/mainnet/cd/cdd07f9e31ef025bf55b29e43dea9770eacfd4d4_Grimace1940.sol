...
/**
   ...
   "Grimace was born from McDonalds tweet. McDonalds was founded in 1940. Grimace 1940 is created to celebrate this moonshot pairing, following Safemoon1996 & Doge1971 trend. 
   Safe dev with previous moonshots, grab a bag and ride the hype with us"

    Made in AlphaBee Calls ™️  🐝

    💪Community cooperation is the key as proven in my previous projects;  
    Just like how Baltasar Gracian Inu [19X], 
    Super Mario Inu  [30X], Tequila  [61X], CyberPunk2029  [40X] 
    ...
    💥Buy tax     4% (2% marketing, 2% LP)
    💥Sell tax      12% (6% marketing, 6% LP)
Note: cumulative tax = 16%, equivalent of a 8% buy/sell tax CA)

    tg: https://t.me/GRIMACE1940
*/
...
//GRIMACE1940 Contract /////////////

contract Grimace1940 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Grimace 1940';
    string private constant _symbol = 'Grimace1940';
    ...
    uint16 public constant MaxSellLockTime= 50 seconds;
    ...
    //DevWallets
    address public TeamWallet=payable(0x93c38804Cc9E6F153e386Cb5BC3d827963031090);
    address public walletTwo=payable(0x39CacEAD42678B0C2d15385bB60AE2924C6896A0);
    //TestNet
