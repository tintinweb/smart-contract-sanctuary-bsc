...
//////
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(0.02 ether, 10 minutes, 1000));
        plans.push(Plan(0.03 ether, 15 minutes, 1000));
        plans.push(Plan(0.04 ether, 20 minutes, 1000));
        plans.push(Plan(0.05 ether, 30 minutes, 1000));
        plans.push(Plan(0.06 ether, 40 minutes, 1000));
        plans.push(Plan(0.07 ether, 60 minutes, 1000));
        plans.push(Plan(0.08 ether, 1 minutes, 1000));
        plans.push(Plan(0.09 ether, 1 minutes, 1000));
        plans.push(Plan(0.10 ether, 1 minutes, 1000));
        plans.push(Plan(0.09 ether, 1 minutes, 1000));
         plans.push(Plan(0.09 ether, 1 minutes, 1000));
        plans.push(Plan(0.09 ether, 1 minutes, 1000));
        plans.push(Plan(0.09 ether, 1 minutes, 1000));
