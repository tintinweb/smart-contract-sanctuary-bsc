...
https://twitter.com/HalloDogeBSC
...
contract HalloDoge is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x7d056c0A0673F06F9178533e45CC4e27C9749F44);
    ...
    string private constant _symbol = unicode"HalloDoge";
    ...
    constructor() {
        _owner = 0x7d056c0A0673F06F9178533e45CC4e27C9749F44;
