...
contract EWO2 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 579_999_999 * 10**9;
    ...
    address public CallWallet = 0x71df220426EBFcf70c8473831AFdD4EEe289C9fd;
    address private devWallet = 0xF55930f2A0E88A5000D96a7b76e692F704eaCf13;
    address public buyBurnAddLiQ = 0x6a9Abe0d713324f4705f850013e5c64b0b8a3666;

    string private constant _name = "EWO 2.0";
    string private constant _symbol = "EWO 2.0";
    ...
    Taxes public taxes = Taxes(0, 3, 0, 3, 0);
    Taxes public sellTaxes = Taxes(0, 3, 0, 3, 0);
