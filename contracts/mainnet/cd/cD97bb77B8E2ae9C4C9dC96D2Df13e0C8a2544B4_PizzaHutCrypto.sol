...
// File contracts/PizzaHutCrypto.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract PizzaHutCrypto is ERC20, Ownable {
    ...
    event RewardsTriggered(uint256 amount);

    constructor() ERC20("Pizza Hut Crypto", "PIZZA") {
    	...
    	RewardsWallet = msg.sender; // set as Rewards wallet
    ...
    function RewardsTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        emit RewardsTriggered(bnbAmountInWei);
    }
}