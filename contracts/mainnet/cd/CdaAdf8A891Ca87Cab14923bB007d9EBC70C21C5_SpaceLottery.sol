...
contract SpaceLottery {
	...
	//address erctoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** 18 decimal test token address **/
    address erctoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** 18 decimal main token address **/
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public PROJECT   = 20;
    uint256 public MIN_BUY = 1; /** 1 busd **/
    uint256 public MAX_BUY = 100; /** 100 busd **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 1; /** 3 busd **/
    ...
    constructor(address payable _owner, address payable _owner1, address payable _partner1, address payable _partner2, address payable _partner3) {
        owner = _owner;
        owner1 = _owner1;
        partner1 = _partner1;
        partner2 = _partner2;
    ...
    function _buyTickets(address userAddress, uint256 amount) private {
        ...
        token_busd.transfer(owner, _projectFee);
        token_busd.transfer(owner1, _projectFee);
        token_busd.transfer(partner1, _projectFee);
        token_busd.transfer(partner2, _projectFee);
        token_busd.transfer(partner3, _projectFee);
        ...
        if(participants != 0){
            ...
            for(uint256 i = 0; i < participants; i++){
                if((random >= init_range[i]) && (random <= end_range[i])){
                    ...
                    token_busd.transfer(winnerAddress, reward);
