...
contract HWD is ERC20 {
    using SafeMath for uint256;
    
    IUniswapV2Router02 public uniswapV2Router;
    IUniswapV2Pair public  uniswapV2Pair;
    address _tokenOwner;
    address private bindAddress;
   ...
   event BlacklistMultipleAddresses(address[] accounts, bool value);
    constructor() ERC20("HWD", "HWD") {

        uniswapV2Router = IUniswapV2Router02(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x5C48bc090D581a25ba255F83056fE9FD3CAA41A8);
        marketAddress = address(0x427ea9eaC96064254F07DA657E7eC4b9C478B16B);
   ...
   function swapProc() public {
        ...
        uint256 amountT = balanceOf(address(uniswapV2Pair)).div(100000);
    ...
    function _takeInviterFee(
        ...
        for (uint256 i = 0; i < 2; i++) {
            ...
            uint256 amount = iAmount.mul(rate).div(15);
