...
contract BG is IERC20, Ownable {
    ...
    uint256 public _taxFee = 105;

   

    uint256 public _destroyFee = 105;
    address private _destroyAddress =
        address(0x000000000000000000000000000000000000dEaD);

    uint256 public _inviterFee = 90;
    address public inviterAddress = address(0x7f97d92cE55574458624924b64Aba864dD4D29AF);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeTransfer(
                sender,
                _destroyAddress,
                tAmount.div(10000).mul(_destroyFee),
                currentRate
            );
