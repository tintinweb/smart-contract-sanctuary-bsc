...
contract SHIMPA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIMPA INU";
    string private _symbol = "SHIMPA";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x020d85ca2C0FBC3753d18fE65d871aE32bD5bC8A); // Marketing Address
    address payable public BuyBackWallet = payable(0x020d85ca2C0FBC3753d18fE65d871aE32bD5bC8A); // Team Address
