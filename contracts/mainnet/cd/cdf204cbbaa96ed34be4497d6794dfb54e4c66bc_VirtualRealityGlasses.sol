...
contract VirtualRealityGlasses is BEP20, Ownable {
    ...
    address public marketingWallet = 0x8dDF9d5A31e6032Da63E5C374ed3D2eceF791CEe;
    ...
    constructor() BEP20("Virtual Reality Glasses", "VRG") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 toSwap = contractBalance/2;
            ...
            if (deltaBalance > 0) {
                ...
                super._transfer(address(this), marketingWallet, contractBalance-toSwap);
            }
        }
    }
