...
contract BunnyBoy is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUNNY BOY"; // 
    string private constant _symbol = "$BBOY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x443ea0b0268cc7E1A804b9Cc6A8DF0e86d0dceaC;
