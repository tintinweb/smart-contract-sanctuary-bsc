...
contract MetaFranchiseManagerV3 is Initializable, PausableUpgradeable {
    ...
    function createMetaFranchiseUsingTokens(
        ...
        uint256 tokensForContract = (createFranchisePrice -
            (createFranchisePrice * teamAddressPercent) /
            10000);

        uint256 teamTokens = (createFranchisePrice -
            (createFranchisePrice * teamAddressPercent) /
            10000);
