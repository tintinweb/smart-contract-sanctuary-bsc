...
contract BrokeAngel is IERC20 {
    ...
    string constant private _name = "SAXON";
    string constant private _symbol = "SAXON";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6eA86cf206EAc2e259d8C1E43a944B40B1b2A457),
        //buyback: payable(0x0462D940c63a67147C594676055e95CAd8F1C21B),
        //lottery: payable(0xDCc5f0a97d0648FbE44F093Bc2B6f2E28365B9B8),
        tokens: 0x6eA86cf206EAc2e259d8C1E43a944B40B1b2A457,
        dev: payable(0x6eA86cf206EAc2e259d8C1E43a944B40B1b2A457)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 tokens, uint16 dev) external onlyOwner {
        //_ratios.liquidity = liquidity;
        _ratios.dev = dev;
        _ratios.marketing = marketing;
        _ratios.tokens = tokens;
        _ratios.totalSwap = dev + marketing ;
    ...
    function setWallets(address payable marketing, address payable dev, address tokens) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
       ...
       // ratios.totalSwap -= ratios.liquidity;
        ...
        if (ratios.dev > 0) {
            (success,) = _taxWallets.dev.call{value: devBalance, gas: 35000}("");
        }
