...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC92a4ddA4582B657D95D67b961A22a3FE3494E84; // owner address
...
contract AlexLV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlexLV";
    string private _symbol = "AlexLV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC92a4ddA4582B657D95D67b961A22a3FE3494E84); // Marketing Address
    address payable public teamWalletAddress = payable(0xC92a4ddA4582B657D95D67b961A22a3FE3494E84); // Team Address
