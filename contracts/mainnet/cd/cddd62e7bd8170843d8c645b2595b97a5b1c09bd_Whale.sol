...
Telegram : https://t.me/whalegrowmoonshot
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04c4143f898459e7eBeD7d6eE4eA883203BEB1B0;
...
contract Whale is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$WHALEGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x04c4143f898459e7eBeD7d6eE4eA883203BEB1B0);
