...
/* 
👳Dont Jeet Inu $DJI 👳|| Fairlaunch (Bep20)|| 
👇👇👇
Don't Need Dyor No Risk Rug 
👇👇👇
Join our Jeets BSC community, take refuge with our family, don’t miss this potential X100
👇👇👇
👳Token Name: Dont Jeet Inu
👳Token Symbol: $Dji
...
👳Tax Distribution (2% Total TX Fee)
👳2% $Dji Rewards


✅initial LP 0.5BNB
✅24 Hours BoostLP 2 BNB
✅48 Hours BoostLP 4 BNB
✅72 Hours BoostLP 8 BNB
👳‍👳‍👳‍
Telegram : https://t.me/DjiBSC
...
abstract contract ContextBEP20ERC20 {
...
contract OwnableBEP20ERC20 is ContextBEP20ERC20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20ERC20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20ERC20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DontJeetInuBSC is ContextBEP20ERC20, BEP20ERC20, OwnableBEP20ERC20 {
    ...
    string private _name = 'Dont Jeet Inu';
