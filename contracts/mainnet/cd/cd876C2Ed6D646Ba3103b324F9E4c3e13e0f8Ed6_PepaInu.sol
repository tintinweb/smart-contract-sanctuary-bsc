...
contract PepaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepa Inu";
    string private constant _symbol = "PEPA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x4E728616215F50870aC2eABBE21583E141857e53);
    address payable private _marketingAddress = payable(0x4E728616215F50870aC2eABBE21583E141857e53);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 99, "Redis cannot be more than 81.");
	    require(redisFeeOnSell < 99, "Redis cannot be more than 81.");
	    require(taxFeeOnBuy < 99, "Tax cannot be more than 81.");
	    require(taxFeeOnSell < 99, "Tax cannot be more than 81.");
