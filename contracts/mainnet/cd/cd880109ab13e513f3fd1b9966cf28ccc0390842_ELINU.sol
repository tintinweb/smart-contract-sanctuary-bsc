...
contract ELINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON LEADER INU";
    string private _symbol = "ELINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78cc241e28A8Fa786edBbF538b136072E2ED1489); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x78cc241e28A8Fa786edBbF538b136072E2ED1489); // buyback Address
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**9; // 0.1%
    uint256 public _walletMax = 50000000000000 * 10**9; // 2%
