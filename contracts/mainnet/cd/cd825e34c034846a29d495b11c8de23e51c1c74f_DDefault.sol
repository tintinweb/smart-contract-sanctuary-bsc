...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "MissedCatanaCoin";
    string private _symbol = "MCC";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xD89b85e0765F11A20230412f15A1ABb3C198aE88); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x834096fCD3c0740Df1A192d829E20F3cF35976BA); // BuyBack Address
