...
contract glory is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x5824a4E32B9B20C425E0aA6F831B5E3f2a8C8bF8;
        _mark = 0x403AF640911463Aa396c16a5D80C5c471e616815;
        _mark1 = 0xC4Aa737abf86230b5825D57045b4Db67750387cd;
    ...
    function _swapAndLiquid() private {
        ...
        if (_maxsell > 0 && balances > _maxsell) {
            balances = _maxsell;
            _swapTokenForToken(balances*15/16);
            uint256 fistval2 = IERC20(_fist).balanceOf(address(this));
                _doBonusFist(fistval2*8/15);
                IERC20(_fist).transfer(_mark, fistval2*4/15);
                IERC20(_fist).transfer(_mark1, fistval2*2/15);
            balances = _maxsell;
                if (balances*1/16 > 0 && fistval2*1/15 > 0) {
                addLiquidity2(balances*1/16, (fistval2)*1/15);
            }
    ...
    function setAddr(address mark,address mark1, address main) public {
