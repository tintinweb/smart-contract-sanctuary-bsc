...
contract  GTADoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GTA Doge";
    string private _symbol = "GTAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc93543DDbFC9BFe49b251bC10702E37368B7D0D1);
    address payable public teamWalletAddress = payable(0xc4B4c8D96966b55226Dd0dAF419d2D9a92Df0C78); 
