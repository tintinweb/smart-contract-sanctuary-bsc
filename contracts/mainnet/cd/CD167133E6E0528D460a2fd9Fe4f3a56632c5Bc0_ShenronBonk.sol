...
ShenronBonk - A community-centric decentralized finance (DeFi) project with aims of revolutionising the De-Fi crypto space.  Using the latest technology, ShenronBonk aims to create new and innovative financial products empowering users to send, spend, and invest their crypto from anywhere in the world, faster, and more affordably than any bank in the market.

Telegram: https://t.me/ShenronBonk
Twitter: https://twitter.com/BonkShenron
...
contract ShenronBonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shenron Bonk";
    string private constant _symbol = "SHENBONK";
