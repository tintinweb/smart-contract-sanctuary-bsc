...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7093290E40929B95c74E6F4de26D4aDF5Dbf8Dc8; // owner address
...
contract AmongRULEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AmongRULEX";
    string private _symbol = "ARULEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7093290E40929B95c74E6F4de26D4aDF5Dbf8Dc8); // Marketing Address
    address payable public teamWalletAddress = payable(0x7093290E40929B95c74E6F4de26D4aDF5Dbf8Dc8); // Team Address
