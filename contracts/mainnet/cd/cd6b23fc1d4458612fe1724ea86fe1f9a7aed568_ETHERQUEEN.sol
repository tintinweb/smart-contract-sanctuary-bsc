...
/**
Website : https://etherqueen.art/
Telegram : https://t.me/Etherqueencoin
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71B742880b1B2945Ff5625004786be1316c7590A; // owner address
...
contract ETHERQUEEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHERQUEEN";
    string private _symbol = "EQUEEN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC6513EA2B19D9c335D4e8D0a0a431ae658fd014b); // Marketing Address
    address payable private teamWalletAddress = payable(0xC6513EA2B19D9c335D4e8D0a0a431ae658fd014b); // Team Address
