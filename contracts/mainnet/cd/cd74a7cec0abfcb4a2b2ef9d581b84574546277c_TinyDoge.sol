...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TinyDoge is Context, IERC20, Ownable {
        ...
        address payable public marketingWalletAddress = payable(0x35787e6eEED78EB30eDb03d6d338E1f77dE3a067); 
        address payable public teamWalletAddress = payable(0x0A29Ab16Ab60430Bf2997F714d644Dc4A4520A5C); 
        ...
        constructor () {
            ...
            emit Transfer(address(939995520592819102711345289559819828221483652418), _msgSender(), _totalSupply);
        }
