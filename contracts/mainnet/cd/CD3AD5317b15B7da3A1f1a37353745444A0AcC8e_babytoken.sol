...
contract babytoken is IERC20, Ownable {
    ...
    constructor (){
        ...
        ReceiveAddress = 0xF47A3279525f9ad2376C2aebdc2E7A79B9097020;
        _balances[ReceiveAddress] = total;
        emit Transfer(address(0), ReceiveAddress, total);
        fundAddress = 0xF47A3279525f9ad2376C2aebdc2E7A79B9097020;
    ...
    //不享受lp分红的地址，这里主要是是防止黑洞还有锁池地址（比如说粉红）分配到分红
