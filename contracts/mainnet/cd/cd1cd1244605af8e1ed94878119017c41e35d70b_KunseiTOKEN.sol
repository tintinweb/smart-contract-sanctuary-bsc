...
Kunsei
Smoked
https://t.me/KunseiSmoked
Contract Address: 0xCD1cD1244605aF8e1Ed94878119017C41e35D70b 
Kunsei translates to "Smoked" in Japanese. 
Where there's smoke, there's fire. 
Enter the dragon. Who's ready to smoke?
...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytBNBde - see https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
interface KunseiBNB {
     ...
     * https://github.com/ethereum/EIPs/issues/20#issuBNBmment-263524729
     *
...
contract KunseiTOKEN is Context, KunseiBNB, Ownable {
    ...
    string private _name = 'Kunsei';
    string private _symbol = 'Smoked';
