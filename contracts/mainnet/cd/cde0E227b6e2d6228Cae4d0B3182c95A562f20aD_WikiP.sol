...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x109A7aF7bdF0B6885022B4625d9417849Ff82a5B;
...
contract WikiP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wiki Protocol"; // 
    string private constant _symbol = "WP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x109A7aF7bdF0B6885022B4625d9417849Ff82a5B);
