...
contract DAO is IBEP20, IPROXY, Auth {
    ...
    function viewCurrentVoteInfo() public view returns (string memory, string memory, uint256, uint256, string memory, string memory, string memory, string memory) {
            return(
                header,
                subheader,
                VoteStart,
    ...
    function viewCurrentVoteStats() public view returns (string memory, uint256, uint256, uint256, string memory, uint256, string memory, uint256, string memory, uint256, string memory, uint256) {
            return(
                header,
                VoteEnd,
                VotesYes,
