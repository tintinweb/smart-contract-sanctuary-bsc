...
contract SpaceWEGO is ERC20 {
	...
	address payable _fundAddress = payable(address(0x5fC00d0BFc3f0De948bF977DF63128EAe98Fe85A));
    ...
    constructor(address tokenOwner) ERC20("SpaceWEGO", "SpaceWEGO") {
