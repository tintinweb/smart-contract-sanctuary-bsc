...
contract WhaleAi is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'Whale AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Whale AI: incorrect fee percent');
        require(owner != address(0), 'Whale AI: incorrect owner address');
        require(mintToAddr != address(0), 'Whale AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Whale AI: transfer from the zero address');
        require(recipient != address(0), 'Whale AI: transfer to the zero address');
