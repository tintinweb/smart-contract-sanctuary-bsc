...
/**
   INUBurn The New Community of Ape Token
    
   I make this  INUBurn  to hand it over to the community.
   I suggest a Telegram group name for you to create:  INUBurn is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract INUBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "INUBurn!!!";
    string private constant _symbol = "IBURN";
    ...
    address private marketingWallet = address(0xf282b362d5366cEb027a673d7Fa617d782c70F42);
