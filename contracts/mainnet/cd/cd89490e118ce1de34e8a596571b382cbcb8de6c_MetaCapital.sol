...
// Produced to create Capital for an upcoming P2E Platform that provides loans to LLC licensed companies, this will be a joint part of the MetaCapital inc. ecosystem for lending services.
// Twitter ; @MetaCapitalEco
...
contract MetaCapital is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "MetaCapital";
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xE009035bF7224d294aa7Fa79db58C135Dd9D9e5d;
        _marketingWallet = 0x999D86C0BDabB0949b2E7fEd133d1adC758DC2dd;
