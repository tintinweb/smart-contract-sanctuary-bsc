...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        zeon.safeTransferFrom(msg.sender, address(this), amount);
    }
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 60; // Lock for 60 epochs (360h) before release withdraw
        rewardLockupEpochs = 30; // Lock for 30 epochs (180h) before release claimReward
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            zbnb.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        zbnb.safeTransferFrom(msg.sender, address(this), amount);
