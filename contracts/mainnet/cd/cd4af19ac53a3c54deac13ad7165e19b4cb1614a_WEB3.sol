...
// web3 PROTOCOL COPYRIGHT (C) 2022 
...
contract WEB3 is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY =
        800000 * 10 * 10**DECIMALS;

    uint256 public liquidityFee = 20;
    uint256 public treasuryFee = 20;
    uint256 public WEB3InsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(WEB3InsuranceFundFee).add(
            firePitFee
        );
    ...
    address public WEB3InsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("WEB3", "WEB3", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x41b4a81bf6Cb375a302C6f62718F87AD41Bdd5A2;
        treasuryReceiver = 0xd34991fE504aa1c285135C20B725E9b2149c177D; 
        WEB3InsuranceFundReceiver = 0xccCB991220Fc39e381541dEb13B1473A0d408F1C;
        firePit = 0x2BA8bf59d82396A51106c3812851714e406C75a6;
    ...
    function takeFee(
        ...
        uint256 _WEB3InsuranceFundFee = WEB3InsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _WEB3InsuranceFundFee = WEB3InsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(WEB3InsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(WEB3InsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(WEB3InsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(WEB3InsuranceFundFee).div(
                treasuryFee.add(WEB3InsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no WEB3 token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _WEB3InsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        WEB3InsuranceFundReceiver = _WEB3InsuranceFundReceiver;
        firePit = _firePit;
    }
