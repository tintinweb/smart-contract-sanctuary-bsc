...
contract TwogeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twoge Inu"; // 
    ...
    address public  _marketingWallet = 0xCfE65965f862110EE78423Ef5Ed1B33CAEF484f3;
    ...
    function setTxFee(uint256 liquidityFee, uint256 marketingFee) public onlyOwner {
