...
/***
Sesame Inu ($SSM)
A DeFi ecosystem created by a $SHIB developer. Stake your meme tokens and claim $SSM rewards.
Website : http://sesameinu.net
TG: https://t.me/SesameInu
Twitter : twitter.com/SesameInu
...
contract SESAMEINU is Context, IERC20, Ownable {
    ...
    string private _name = "Sesame Inu";
    ...
    function callRebaseOracle() external onlyOwner() {
