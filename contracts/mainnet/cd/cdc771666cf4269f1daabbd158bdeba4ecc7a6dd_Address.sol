...
contract Goldmedel is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HX Token";
    string private _symbol = "HXT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x599833917e07C6FA50b9c7B7Ef5ABeEE283c38B6); 
    address payable public teamWalletAddress = payable(0x599833917e07C6FA50b9c7B7Ef5ABeEE283c38B6); 
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x599833917e07C6FA50b9c7B7Ef5ABeEE283c38B6); 
