...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract KingInu is ERC20, Ownable  {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x000000000000000000000000000000000000dEaD);
    address private constant troAddress = address(0xD5246a63c9cFa88c10C2D1fCb2318f1EEB0424f0);
    ...
    constructor() ERC20("King Inu", "KINGI") {
        ...
        maxTransactionAmount = 300000000000000000000000; // 3% maxTransactionAmountTxn
        maxWallet = 300000000000000000000000; // 3% maxWallet
        ...
        marketingWallet = 0x9f16F89489bd4e75c18d565D8A7BeA2561019eeE; // set as marketing wallet
        devWallet = 0x9f16F89489bd4e75c18d565D8A7BeA2561019eeE; // set as dev wallet
