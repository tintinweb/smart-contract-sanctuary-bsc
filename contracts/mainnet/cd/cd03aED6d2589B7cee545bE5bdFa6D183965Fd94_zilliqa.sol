...
contract zilliqa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "zilliqa";
    string private _symbol = "zilliqa";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9Cdd12715F246549824d4CfE34881091c964d76);
    address payable public teamWalletAddress = payable(0x1e5153441F33308CD730151F13eE868C7Fa7De78);
