...
contract FFFFFFFF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "killer2.0";
    string private _symbol = "killer2.0";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0x45e48689be8EE6c1da7378A6875471a2A7D33381);
    address payable public teamWalletAddress = payable(0x45e48689be8EE6c1da7378A6875471a2A7D33381);
