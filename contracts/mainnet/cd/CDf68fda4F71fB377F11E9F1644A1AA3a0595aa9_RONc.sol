...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x211064D32086A2FBd411dB6dfc4C242A01459C27;
...
contract RONc is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xced85C2B25b9A2a52041338386882D0e9d723517;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RONc";
    string private _symbol = "RONc";
