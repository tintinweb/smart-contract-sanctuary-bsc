...
Join: https://t.me/YasinCengizINUportal
...
contract YasinCengizINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yasin Cengiz INU";
    string private _symbol = "DBYS";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x24a248CF740D33f21EDf9cBE9A218159DbF7D6AA);
    address payable public teamWalletAddress = payable(0x0bFb96A5e4093d6bf8B233D79292b1a9Bb3bddD5);
