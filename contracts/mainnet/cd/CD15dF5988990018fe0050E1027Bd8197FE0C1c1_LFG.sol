...
contract LFG is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x63F40154F54A37BD64a56E7a7bA186205048Dfc5;
    address public donationWallet = 0xeA4a8f98c12D433197253E8413e9b3DF10d26395;



    string private constant _name = "Lets Flokin Grow";
    ...
    Taxes public taxes = Taxes(0, 7, 3, 1);
    Taxes public sellTaxes = Taxes(0, 7, 3, 2);
