...
/*
https://t.me/BallzyPortal


https://t.me/SpermyPortal
Reward token: 0x2a8375ba6c16b6d72b31d1c0870c61034f913322
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2A8375Ba6C16b6D72B31d1c0870C61034F913322);
...
contract BALLZY is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "BALLZY";
    string constant _symbol = "BALLZ";
    uint8 constant _decimals = 9;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2A8375Ba6C16b6D72B31d1c0870C61034F913322;
    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 3000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x025DB4e1260F2596A2bBb6A38a0eC9CB81679618;
        devWallet = 0x025DB4e1260F2596A2bBb6A38a0eC9CB81679618;
