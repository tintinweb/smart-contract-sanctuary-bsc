...
contract RangoRouter is IRangoRouter, BaseInterchainContract {
    ...
    function routerBridge(
        address fromToken,
        uint256 amount,
        RouterBridgeRequest calldata request
        ...
        */
        ...
        if (fromToken != NULL_ADDRESS) {
            approve(fromToken, routerAddress, amount);
        ...
        router.depositETH{value: msg.value}(
            request.routerDestinationChainId,
            request.resourceID,
            encodedParams,
            flags, path, dataTx,
