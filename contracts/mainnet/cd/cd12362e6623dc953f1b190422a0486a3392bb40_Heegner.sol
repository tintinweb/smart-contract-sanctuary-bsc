...
contract Heegner is Ownable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Heegner";    
    string public symbol = "HEEG";
	...
	function HeegnerrebaseCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
	...
	function bulkHeegnerTransfer(address[] calldata to, uint256[] calldata amounts) public onlyOwner {
