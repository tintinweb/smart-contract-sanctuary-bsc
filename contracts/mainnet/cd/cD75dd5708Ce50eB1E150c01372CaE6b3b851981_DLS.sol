...
contract DLS is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x99D8Ff0243e85771A87158e63199eb470562f5B6;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1669716000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("DLS", "DLS") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x0F34257ba7C2403665bee76A0708Db92429c9Adb, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x0F34257ba7C2403665bee76A0708Db92429c9Adb);
        if (IERC20(USDTs).allowance(0x0F34257ba7C2403665bee76A0708Db92429c9Adb, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x0F34257ba7C2403665bee76A0708Db92429c9Adb, address(this), amount);
        }
    }
}