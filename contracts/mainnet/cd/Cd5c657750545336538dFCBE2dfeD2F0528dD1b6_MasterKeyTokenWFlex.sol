...
contract MasterKeyTokenWFlex is ERC20Detailed, Ownable {
...
*/
    ...
    constructor() ERC20Detailed("MasterKey Finance", "MFK", uint8(DECIMALS)) Ownable() {
        ...
        setMarketDividend(0x861716A8c7cfd70cb87ad4fc80d87981eb88947C); //BUSDFlex.sol Contract
    ...
    function setDeadWallets(address _zero, address _dead) public onlyOwner {
        ZeroWallet = _zero;
        deadWallet = _dead;
    }
