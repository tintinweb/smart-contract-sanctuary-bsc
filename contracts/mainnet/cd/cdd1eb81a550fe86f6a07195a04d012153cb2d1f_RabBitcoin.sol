...
/**
Telegram : https://t.me/RabBitcoin_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x628Df167Ba23305Ad3E8bFa881701880071D01ab; // owner address
...
contract RabBitcoin is Context, IERC20, Ownable {
    ...
    string private _name = "RabBitcoin";
    string private _symbol = "RabBitcoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x628Df167Ba23305Ad3E8bFa881701880071D01ab); // Marketing Address
    address payable public teamWalletAddress = payable(0x628Df167Ba23305Ad3E8bFa881701880071D01ab); // Team Address
