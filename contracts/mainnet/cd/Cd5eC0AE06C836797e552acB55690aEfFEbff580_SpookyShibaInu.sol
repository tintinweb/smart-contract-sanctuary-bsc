...
contract SpookyShibaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SpookyShibaInu";

    string private _symbol = "SSI";

    uint8 private _decimals = 18;

    address public _marketingWallet = 0x15A82e4e60C4F675bfD38D2496097B3348f57B6D;
