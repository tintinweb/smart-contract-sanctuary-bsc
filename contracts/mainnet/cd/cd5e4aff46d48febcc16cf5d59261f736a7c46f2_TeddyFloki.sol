...
Telegram: http://t.me/teddyflokiportal
...
contract TeddyFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd3De0bd4dD15776724352bd6C4b82806Bb4E7A96); 
    address payable public Wallet_Dev = payable(0x743016abC916A201a7700acFBBA97Fe06dB8D95A);
    ...
    string private constant _name = "Teddy Floki"; 
    string private constant _symbol = unicode"teddyfloki"; 
