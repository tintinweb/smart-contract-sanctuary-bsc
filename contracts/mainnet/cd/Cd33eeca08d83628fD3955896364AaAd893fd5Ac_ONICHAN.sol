...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5fd178a9201d20978cE9C5FBc2f777F99412FA83; // owner address
...
contract ONICHAN is Context, IERC20, Ownable {
    ...
    string private _name = "ONI CHAN";
    string private _symbol = "ONI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa6401e0Ff1A79Ff37f8358882859eE054ab0C7fA); // Marketing Address
    address payable public teamWalletAddress = payable(0xa6401e0Ff1A79Ff37f8358882859eE054ab0C7fA); // Team Address
