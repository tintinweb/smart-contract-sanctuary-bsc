...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5bA422513455fcE9923fFF962010564D641F9d87; 
...
contract LOOPAUDIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Loop Audit";
    string private _symbol = "LA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAa8f6737c3858AD08C40FF4E83518779687D3D8a); 
    address payable public teamWalletAddress = payable(0xAa8f6737c3858AD08C40FF4E83518779687D3D8a); 
