...
contract foodinc is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xED3Ab36263809825214c0647460f7cd92f980502;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 250; // 0.25%
    bool inSwap;
