...
/**
  Telegram : https://t.me/AwakeningApe
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract AwakeningApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Awakening Ape ";
    string private _symbol = " AWAKENING ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5fa7814113897091F09E66C3A9a95F98feFd847E);
    address payable private teamWalletAddress = payable(0x11250A40ec5dAb4a97Ca3fF791906D6C0F062F6E);
