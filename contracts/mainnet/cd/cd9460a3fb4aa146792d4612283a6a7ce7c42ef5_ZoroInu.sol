...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2cae9B854Abc2D165439BFeF0355CB0886fe3023; 
...
contract ZoroInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC41160D8c042249E656138d433AA1B88fC1822a5); // 
    address payable public teamWalletAddress = payable(0x2cae9B854Abc2D165439BFeF0355CB0886fe3023); // 
