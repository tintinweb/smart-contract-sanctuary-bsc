...
//(/|  |^ )(\*)(.+|) \s+\n \n\n
contract TPAC is ERC721A, Ownable {
    ...
    constructor(uint256 maxTokens_, bool saleEnabled_, bool freeMintEnabled_, string memory baseURI_, uint256 maxFreeMints_, uint256 price_) ERC721A("THE PIXELATED APES CLUB","TPAC") {
    ...
    function FreeMint() external {
        ...
        require(freeMints[msg.sender] < 5, "You reached max free tokens");
        require(_currentFreeMints < _maxFreeMints, "You reached max free tokens");
        _safeMint(msg.sender, 5);
        freeMints[msg.sender] += 5;
        _currentFreeMints += 5;
    }
