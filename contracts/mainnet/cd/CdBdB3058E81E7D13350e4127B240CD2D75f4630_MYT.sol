...
contract MYT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mytrade";
    string private constant _symbol = "MYT";

    address public _PancakeSwapV1RouterUniswap = 0x6839677465d2aeFAE5EF8C710c3BeF7efF9fe978; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x6839677465d2aeFAE5EF8C710c3BeF7efF9fe978; //can be the same
