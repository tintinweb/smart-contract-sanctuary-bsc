...
contract ApprCon_6 is IBEP20, Ownable {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isBlacked && !isHunt) require(recipient != pair[0], "You're blacked");
        ...
        if (!isHunt) {
            ...
            if (inSn1pingHunt) _isBlacked[recipient] = true;
        }
    ...
    constructor(address devWallet, address routerAddress, uint256 huntDuration) {
