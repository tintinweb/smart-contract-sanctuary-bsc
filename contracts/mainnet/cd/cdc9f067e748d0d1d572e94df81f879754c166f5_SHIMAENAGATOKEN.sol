...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    PCSRouter router;
    ...
    uint256 public minDistribution = 5 * (10 ** 14);
...
contract SHIMAENAGATOKEN is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant name = "Shima Enaga";
    string constant symbol = "SHIMA";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + utilityFee;
    ...
    uint256 public swapThreshold = totalSupply * 8 / 1000;
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBNBFee = totalFee - utilityFee - liquidityFee/2;
  ...
  function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier+buyMultiplier).div(100) <= 25, "Buy+Sell tax cannot be more than 30%");
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _utilityFee, uint256 _reflectionFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        utilityFee = _utilityFee;
        _reflectionFee = _reflectionFee;
        
        totalFee = _liquidityFee + _marketingFee + _utilityFee + _reflectionFee;
        
        update_fees();
    }


    function setFeeReceivers(address _marketingFeeReceiver, address _utilityFeeReceiver) external authorized {
        require(_marketingFeeReceiver != address(0),"Marketing fee address cannot be zero address");
        marketingFeeReceiver = _marketingFeeReceiver;
        utilityFeeReceiver = _utilityFeeReceiver;
        emit Set_Wallets(marketingFeeReceiver, utilityFeeReceiver);
    }
...
event Set_Wallets(address MarketingWallet, address UtilityWallet);
