...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    // The address of the smart chef factory
    address public feeAddress = 0x151eD89351bdc66BC16aF8c1D46eb3b641137408;
    ...
    function remainLockTime(address _user, uint256 _amount) 
        public
        view
        returns (uint256)
    {
        ...
        if (user.depositTime == 0 || _amount == 0) {
            remainingLockTime = 0;
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        uint256 remainLock = remainLockTime(msg.sender, _amount);
