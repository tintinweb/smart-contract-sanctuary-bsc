...
contract EverGrow is ERC20, Ownable {
    ...
    address public marketingWallet = 0x7e0b5d07E1C3A500FE2fDdb45A2404C778E0797A;
    address public devWallet = 0x84455a3eA6abDeCe22982AC95e8455FfE8fb57AB;
    address public buybackWallet = 0x8A5A560055dCC3B520D67E3276f731112B7fab8D;
    ...
    Taxes public taxes = Taxes(3, 0, 3, 6);
    Taxes public sellTaxes = Taxes(3, 0, 3, 6);

    uint256 public TotalBuyFee = taxes.marketing + taxes.liquidity + taxes.dev + taxes.buyback;
    uint256 public TotalSellFee = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev + sellTaxes.buyback;
    ...
    constructor(address routerAdd) ERC20("EverGrow", "EG") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        TotalBuyFee = _marketing + _liquidity + _dev + _buyback;
    ...
    function SetSellTaxes(
        ...
        TotalSellFee = _marketing + _liquidity + _dev + _buyback;
