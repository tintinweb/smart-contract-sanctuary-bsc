...
Name: PUNK RABBIT INU

Telegram:https://t.me/PUNKRABBITINU
...
contract PUNKRABBITINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "PUNK RABBIT INU"; //
    string private constant _symbol = "PRIBU"; //
