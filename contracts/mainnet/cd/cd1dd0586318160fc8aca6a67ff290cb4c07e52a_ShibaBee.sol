...
🐝Safe Low no Tax  no max
🐝0% tax Transaction for in/out
...
contract ShibaBee is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'ShibaBee';
    string private _symbol = 'ShibaBee';
