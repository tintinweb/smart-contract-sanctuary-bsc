...
//Telegram: https://t.me/PREpumpDetector

// Prepump Detector is a prepump and airdrop detector bot. Not only that PDB (Prepump Detector Bot) shows the percentage of prepumped and airdropped wallets in every new launch.
...
contract PrepumpDetector
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Prepump Detector";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x010864539C22C17c04628A6c8e8Cb014379f2Cf3));
        _anotherA = payable(address(0x010864539C22C17c04628A6c8e8Cb014379f2Cf3));
