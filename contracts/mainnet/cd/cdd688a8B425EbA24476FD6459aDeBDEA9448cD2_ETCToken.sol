...
contract ETCToken is Context, IERC20, IERC20Metadata ,  Ownable{
    ...
    IERC20 public usdtAddress =  IERC20(0x55d398326f99059fF775485246999027B3197955);
    ...
    constructor(
        ...
        //================= update ================
        marketAddress = 0xB72dF656d9F40Cc0cF5D3aB194360F0Dd0C95DCC;

        usdtDaoManager = 0x7eC63fF7a0A17FBeeAD6464BA85d0FbB77eD06EB; // doo pool usdt manager in
        
        usdtLpPoolManager = 0x39Da9E989A14b9519591147DDe26D76903cD0cFB;// lp pool usdt manager in
