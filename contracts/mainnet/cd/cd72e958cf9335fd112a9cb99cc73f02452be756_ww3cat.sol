...
World war 3 cat is a token about the upcoming world war 3 that will happen after nato intervenes in ukraine.
Our coin is meant to go crazy after world war 3 happens.
If we predict the war correctly and elon tweets about us, this will possibly do 1000000x.
Get ready to get the moon !!!!!

 TOTAL TAX :

♻️14% Tax on Transactions
...
TG: https://t.me/ww3cat
 Telegram: https://t.me/ww3cat
 Website: TBA
...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract ww3cat is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "ww3cat";
        string constant _symbol = "ww3cat"; 
