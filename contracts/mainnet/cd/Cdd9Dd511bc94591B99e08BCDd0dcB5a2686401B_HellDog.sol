...
contract HellDog is ERC20, Ownable {
    using SafeMath for uint256;
    string  _name = "Hell Dog";
    string  _symbol = "HDG";
    ...
    address _marketingFeeReceiver = 0xF4A710D2787B19e8Dc8540b9ffFfC07332CF96c0;
    address _teamFeeReceiver = 0xE65Ba9AF715EC387B0A7f561Ffffc94349d7B2AE;
    ...
    function _tokenTransfer(address from, address to, uint256 amount, bool isSell) private {
        uint256 feeAmount;
        if (isSell) {
