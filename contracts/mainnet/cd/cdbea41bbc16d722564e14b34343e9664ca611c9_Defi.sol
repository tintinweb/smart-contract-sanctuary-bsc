...
contract Defi is Ownable {
    ...
    address public recive1 = 0xa89B06279Fd72dca843433C37162679CC233056b;
    address public recive2 = 0x4CE794f104d6466155C34d7fb6902ed587b9248c;

    address public recive3 = 0x27dFEAA6e8f01f30F1832af8DC568dbe5E5096fB;
    ...
    function staking(uint256 amountIp) public returns (bool) {
        ...
        _joinToken.safeTransfer(recive1, (amountIp * 7) / 100);
        _joinToken.safeTransfer(recive2, (amountIp * 13) / 100);
