...
contract BigMomInu is Context, IERC20, Ownable {
    ...
    uint256 private _slipFeeOnBuy = 1;
    uint256 private _taxFeeOnBuy = 5;
    
    uint256 private _slipFeeOnSell = 1;
    uint256 private _taxFeeOnSell = 5;
    
    uint256 private _slipFee;
    uint256 private _taxFee;
    
    string private constant _name = "BigMom Inu";
    string private constant _symbol = "BigMom";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x6deC6BF44018A0302E071674eF4f6d0482FEB2ae);
    address payable private _marketingAddress = payable(0xa9599f00f88A7BF4643634c1BB1A9f5142a39933);
    ...
    constructor () {
        ...
        // Real IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Test IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9ac64cc6e4415144c455bd8e4837fea55603e5c3);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router)) {
                _slipFee = _slipFeeOnBuy;
                _taxFee = _taxFeeOnBuy;
            }
    
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                _slipFee = _slipFeeOnSell;
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _slipFee, _taxFee);
        uint256 currentRate =  _getRate();
