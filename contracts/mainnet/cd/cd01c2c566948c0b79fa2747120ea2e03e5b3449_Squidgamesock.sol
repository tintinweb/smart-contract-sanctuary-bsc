...
contract Squidgamesock is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA6AE53D1BFBE9D805A53DA59C70ce73FFcddb8d0); 
    address payable public Wallet_Dev = payable(0xA6AE53D1BFBE9D805A53DA59C70ce73FFcddb8d0);
    ...
    string private constant _name = "SquidGame Sock"; 
    ...
    constructor () {
        ...
        _owner = 0xFaa25b96A6A50Ff0a0706b248C22dDC9425C507E;
