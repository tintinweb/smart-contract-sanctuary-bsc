...
contract Smosharing is SmosharingBasic {
    ...
    constructor(IERC20 _depositTokenAddress, address company_wallet) public  {
        ...
        BASIC_PRICE = 250000000000000000000;
        MAX_INCOME = 500000000000000000000;
        BALANCE_PERCENT = 100;
        PROFIT_PERCENT = 50;
        LAST_LEVEL = 1;
        TIME_TO_INVEST = 7;
    ...
    function registration(address userAddress, address referrerAddress) private {
        depositToken.safeTransferFrom(msg.sender, address(this), BASIC_PRICE.add(2500000000000000000));
        SYSTEM_BALANCE += BASIC_PRICE / 1000 * 700;
        COMPANY_FEE += BASIC_PRICE / 1000 * 200;
        COMPANY_FEE += 2000000000000000000;
