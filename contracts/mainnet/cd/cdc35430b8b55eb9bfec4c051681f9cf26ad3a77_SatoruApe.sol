...
contract SatoruApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Satoru Ape";
    string private _symbol = "SAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD06f8E1a21faeC1E986c2C44D86CC22fb07cc0a0); 
    address payable public buyBackWalletAddress = payable(0xD06f8E1a21faeC1E986c2C44D86CC22fb07cc0a0); 
