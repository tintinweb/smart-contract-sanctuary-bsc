...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f71aA740050572800f3caCAf92f753E440D3f36;
...
contract Reziant is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7050166767e50575df79e187d5D357F33Fb67E4f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Reziant";
    string private _symbol = "RZNT";
