 ...
 * 
 * 
   Kovid Finance is a Life Saving Project. 
  ...
  visit kovid.finance for more information!
 ...
 were made to make this project inline with the mission of Kovid Token -- helping Covid Patients.
*/
...
/* Kovid Finance is on a mission to Help Covid effected person

*/
contract kovid is Context, IERC20, Ownable {
  ...
  address payable charityWallet = 0x3513B7dA9c7636002b0a97A28a5AB1F297e8E7Fb;
  ...
  */
  ...
  string private constant _name = "KOVID FINANCE";
  ...
  */
  ...
  function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {      // split the contract balance into halves
  ...
  function buykovidWithLeftoverBNB(uint256 amount) external onlyOwner() {
      // buy back kovid with BNB leftover from SwapAndLiquify to increase kovid price
