...
contract HighestBFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "HighestBFinance";
    string public _symbol = "HB2";
    ...
    uint256 public highBankFee = 20;
    uint256 public greatHolderFee = 20;

    uint256 public sellFee = highBankFee.add(greatHolderFee);
    ...
    address public highBankReceiver;
    address public greatHolderReceiver;
    ...
    constructor() ERC20Detailed("HighestBFinance", "HB2", uint8(DECIMALS)) Ownable() {
        ...
        insuranceReceiver = 0xf6272dAB1Ed884370D54910b14696467090b6d46;
        highBankReceiver = 0xDd41e238F544638019c600217397EDac0fa64ca1;
        greatHolderReceiver = 0xB4e8EFacCe2F64C1C1D5E14c00744d5F0aB660b5;
    ...
    function setZxFees() external onlyOwner {
        ...
        sellFee = highBankFee.add(greatHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(highBankFee).add(greatHolderFee);
        ...
        (success, ) = payable(highBankReceiver).call{
        value: currentBalance.mul(highBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");

        (success, ) = payable(greatHolderReceiver).call{
        value: currentBalance.mul(greatHolderFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _greatHolderReceiver,
        address _highBankReceiver
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        insuranceReceiver = _insuranceReceiver;
        greatHolderReceiver = _greatHolderReceiver;
        highBankReceiver = _highBankReceiver;
