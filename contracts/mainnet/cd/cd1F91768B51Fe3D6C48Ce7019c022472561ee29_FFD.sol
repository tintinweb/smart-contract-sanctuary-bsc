...
contract FFD is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0x496c0EA971CfA9A2Da12BA6C225946B08A2eC925);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0x81F4621DD9724BBfb64494590b5B262eA947fA1e);
