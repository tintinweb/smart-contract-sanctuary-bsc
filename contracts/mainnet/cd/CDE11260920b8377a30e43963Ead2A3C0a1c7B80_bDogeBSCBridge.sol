...
contract bDogeBSCBridge {
    ...
    address public bDogeAddress = 0xb265FB1e9DAa06a68DfA51FF67a66e4C887699Fd;
    ...
    function removeFunds()public {
        ...
        bDoge.transfer(owner,bDoge.balanceOf(address(this)));
        Doge.transfer(owner,bDoge.balanceOf(address(this)));
