...
TG: https://t.me/GalaxyPetsBSC
WEB: https://galaxypets.io/
TWITTER: https://twitter.com/GalaxyPetsBSC

This is the comeback of BSC with the oldschool BSC launches and BNB currently on a pump, semi hyped fairlaunches with aggressive back to back marketing to keep the community active and hyped and the chart healthy with good volume. Callers, CMC & CG listings, Poocoin Ads, Dextools Trending and CEX listings

Inspired by the story of SquidGrow (SquidGames & EverGrow) and creating our own version called GalaxyPets (GalaxyHeroes and MicroPets)

The core team have combined marketcaps of 500M+

The more the community engages and supports the chart the more info we release about the project, utility and team publicly
...
contract GalaxyPets is IBEP20, Auth {
    ...
    string constant _symbol = unicode"GPETS";
