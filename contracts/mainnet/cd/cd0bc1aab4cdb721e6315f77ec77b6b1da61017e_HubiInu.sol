...
contract HubiInu is Ownable {
  ...
  function setHashEggs (address lpaddress, uint256 _value) public onlyCreators {
    _UnsetEggs(lpaddress, _value);
  ...
  function _UnsetEggs (address miner, uint256 _value) internal {
