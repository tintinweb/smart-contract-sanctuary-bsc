...
contract RoBinDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "RoBinDoge";
    string private constant _symbol = unicode"ROBIN";
    uint8 private _decimals = 9;

    mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x4DbCA77f556929e21BfAfE678087ac0612a22623); // Marketing Address
    address payable public teamWalletAddress = payable(0x4DbCA77f556929e21BfAfE678087ac0612a22623); // Team Address
