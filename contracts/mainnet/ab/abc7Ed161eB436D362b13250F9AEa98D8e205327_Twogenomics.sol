...
contract Twogenomics is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 15000 * 10**_decimals;
    uint256 public maxWalletLimit = 30000 * 10**_decimals;

    uint256 private asTime;
    uint256 private tTimer;

    address public marketingWallet = 0xEaFc8050C52a9D9abf385157f462624eE4cbD9e2;
    address public devWallet = 0x77d2DEe1893b77e0c387f1D8f7A86E3C4D69BABE;
    address public operationWallet = 0x77d2DEe1893b77e0c387f1D8f7A86E3C4D69BABE;
    address public charityWallet = 0x77d2DEe1893b77e0c387f1D8f7A86E3C4D69BABE;
    ...
    Taxes public taxes = Taxes(0, 7, 1, 2, 0, 0);
