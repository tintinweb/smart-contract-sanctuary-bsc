...
/**
 --WELCOME TO RUDOGE OFFICIAL BSC TOKEN--

 5% DOGE REWARDS BUY/SELL

TG: https://t.me/RUDOGEOFFICIALBSC
...
contract RUDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 20;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) / 10;
    }
