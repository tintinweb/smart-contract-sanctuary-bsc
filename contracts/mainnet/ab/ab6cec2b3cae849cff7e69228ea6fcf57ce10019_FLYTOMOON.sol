...
contract FLYTOMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLYTOMOON";
    string private _symbol = "FLYTOMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEf14e6FE31f69F697bbD6b1ea515Ec56B23Ed681); // Marketing Address
    address payable public teamWalletAddress = payable(0xEf14e6FE31f69F697bbD6b1ea515Ec56B23Ed681); // Team Address
