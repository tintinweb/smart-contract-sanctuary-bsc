...
contract EasterDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Easter Doge";
    string constant _symbol = "Easter Doge";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 10 * 10**3 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // 4%
    ...
    uint256 marketingFee = 9500;
    uint256 totalFee = 9900;
