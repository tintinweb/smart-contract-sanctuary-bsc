...
// Spooky Hunter deploying to destroying all spooky, portal : https://t.me/spookyhunterportal 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DEV = IBEP20(0xA2594909e3A7FF4941672cFDBE6645f680cD09a0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DEV.balanceOf(address(this));
        ...
        uint256 amount = DEV.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DEV.transfer(shareholder, amount);
...
contract SpookyHunter is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x168EFEA83c9ed4D70eFCFBED6b6378dF4B195C31;

    string constant _name = "Spooky Hunter";
    string constant _symbol = "SPKHunter";
    ...
    function blacklistSnipers(bool _status) public onlyOwner {
        easily = _status;
    }
