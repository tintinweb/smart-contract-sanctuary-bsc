...
contract Vesting is AccessControl, ITokenVesting, ReentrancyGuard {
    ...
    struct VestingSchedule {
        ...
        uint16 earlyUnlockPercent; // The unlock percent of tokens which available after cliff.
     ...
     * in the direction of rounds: Public, Seed, Private.
     */
    uint256 public constant MAX_ROUNDS_AMOUNT = 140000000e18;

    /**
     * @notice The max amount of tokens that can be distributed between
     * accounts in the direction of Marketing.
     */
    uint256 public constant MAX_MARKETING_AMOUNT = 250000000e18;
    ...
    /**
     * @notice Sets private round vest for user.
     * @param _accounts The array of users.
     * @param _amounts The array of amounts.
     */
    function setPrivateRoundVestFor(
        address[] calldata _accounts,
        uint256[] calldata _amounts
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        uint128 startDate = startAt;
    ...
    function _vestFor(
        ...
        uint256 unlockAmount = (_amount * _unlockPercent) / 1e4;
