...
TG: https://t.me/ThreehundredOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x657d1925B899A2214EabB0e9381837e7E27E9558; // owner address
...
contract ThreeHundred is Context, IERC20, Ownable {
    ...
    string private _name = unicode"300 Thiss is cryptooo !!!";
    string private _symbol = unicode"300";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x657d1925B899A2214EabB0e9381837e7E27E9558); // Marketing Address
    address payable public teamWalletAddress = payable(0x657d1925B899A2214EabB0e9381837e7E27E9558); // Team Address
