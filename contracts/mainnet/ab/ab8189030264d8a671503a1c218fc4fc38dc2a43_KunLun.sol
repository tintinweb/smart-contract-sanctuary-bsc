...
contract KunLun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KunLun";
    string private _symbol = "KUNL";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe1e8744229d6fBaD63524041e294a8086dfC1d4A); 
    address payable public BurnedWalletAddress = payable(0xe1e8744229d6fBaD63524041e294a8086dfC1d4A); 
