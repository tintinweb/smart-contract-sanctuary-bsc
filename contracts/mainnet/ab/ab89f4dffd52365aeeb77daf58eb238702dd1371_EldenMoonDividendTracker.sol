...
Telegram : https://t.me/eldenmoonofficial
...
contract EldenMoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    EldenMoonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("EldenMoon", "ELDENMOON") {
        marketingWallet = payable(0x98A1d9F11aB4d4839B3eD83b21705AFcb22f5AD8);
        devWallet = payable(0xBBbEfa4B4aC8EF98d98eF4f37525Bd9F1f0de0BB);
        ...
        dividendTracker = new EldenMoonDividendTracker(
            payable(this),
            router,
...
contract EldenMoonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EldenMoon public EldenMoonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EldenMoonContract = EldenMoon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EldenMoon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EldenMoon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EldenMoon contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EldenMoonContract);

            uint256 prevBalance = EldenMoonContract.balanceOf(address(this));
            ...
            {
                uint256 received = EldenMoonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EldenMoonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
