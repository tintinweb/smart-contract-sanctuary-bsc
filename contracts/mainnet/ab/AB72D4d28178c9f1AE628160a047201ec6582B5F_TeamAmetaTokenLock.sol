 ...
 */
contract TeamAmetaTokenLock {
    using SafeERC20 for IERC20;

    string public name = "Team Ameta Token Lock";
    ...
    // total lock 120M token
    uint256 public totalAllocation = uint256(120_000_000 * 10**18);

    uint256 public months = uint256(36);

    /**
     * @param _token: APLUS token address
    ...
    function unlockedAmountAt(uint256 _timestamp)
        public
        view
        returns (uint256)
    {
        ...
        return (totalAllocation * monthsUnlock) / months;
    }
