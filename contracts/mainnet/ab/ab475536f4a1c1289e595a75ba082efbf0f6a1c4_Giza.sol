...
/*
Telegram : https://t.me/gizalabs
Website : https://giza-labs.online/
*/
...
contract Giza is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Giza-Labs";
    string private _symbol = "Giza";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56D05548b079B61f376299286DF492C6CAcad182);
    address payable public teamWalletAddress = payable(0x56D05548b079B61f376299286DF492C6CAcad182);
