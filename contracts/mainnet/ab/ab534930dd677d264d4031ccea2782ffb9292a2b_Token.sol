...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x2518465F0a3C59335D4bf803c54aD115c022f0f8);
    address public devAddress = address(0x400494b0731a9fD943C1Dc6c4E08af39C4386c40);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, TData memory) {
        ...
        return (tTransferAmount, TData(0,tFee, tLiquidity, tDev));
    }
