...
contract taim is ERC20 {
	...
	address public _fund1Address = address(0x4BC6b634232e665616b3A239EB1d49ce3A09A761);
	address public _fund2Address = address(0xA8dEae67f289238A9153F202b433E4F160cD4F35);
    ...
    constructor(address tokenOwner) ERC20("taim", "taim") {
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			USDT.transfer(_fund1Address,newAmount.div(8).mul(1));
			USDT.transfer(_fund2Address,newAmount.div(8).mul(2));
