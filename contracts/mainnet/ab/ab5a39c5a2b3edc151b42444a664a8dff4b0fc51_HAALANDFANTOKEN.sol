...
pragma solidity ^0.8.4;
   ...
   // Twitter: https://twitter.com/haalandfantoken
   // Discord: https://discord.gg/GFhxJMXPBZ
...
contract HAALANDFANTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Haaland Fan Token";
    ...
    uint256 public _walletMax = 660000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 66000 * 10**9; 
