...
In here we don't take things too seriously because that's no fun.
...
https://t.me/DogenutBSC

Launch date: 22th Sep. 7pm UTC on PancakeSwap
...
contract Dogenut is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogenut";
    string private _symbol = "$DOUT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6591f94AD3f26a0894657E8A9b78D54403D8aAab); // Marketing Address
