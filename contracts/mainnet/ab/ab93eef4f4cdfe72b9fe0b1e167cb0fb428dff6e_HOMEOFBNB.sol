...
HOMEOFBNB
Tax 12/12
Telegram : https://t.me/homeofbnbofficial
Website : https://homeofbnb.net/
*/
...
contract HOMEOFBNB is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 RnDFee = 200;
    uint256 totalFee = burnFee.add(reflectionFee).add(marketingFee).add(RnDFee);
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            payable(RnDWallet).call{value: amountBNBRnD, gas: 30000}("");
    ...
    function setFees(uint256 _burnFee, uint256 _RnDFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        burnFee = _burnFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        RnDFee = _RnDFee;
        totalFee = _burnFee.add(_reflectionFee).add(_marketingFee).add(_RnDFee);
    ...
    function setRnDWallet(address _RnDWallet) external onlyOwner {
