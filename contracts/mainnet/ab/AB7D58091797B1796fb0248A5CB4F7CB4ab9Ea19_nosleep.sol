...
//https://t.me/DevNeverSleeps

/**
👳 Total Supply: 1 000 000 000 NOSLEEPs 
🌙 Max Wallet: 40 000 000 NOSLEEPs
🧘🏼 Tax: Buy 10% / Sell 10%
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x3C18C434303efE5E8257553E5B3407ac27102A39;
...
contract nosleep is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public deployer = payable(0x3C18C434303efE5E8257553E5B3407ac27102A39);
    ...
    string private constant _name = unicode"DevNeverSleeps"; 
    string private constant _symbol = unicode"NOSLEEP"; 

    uint256 public P_DevReward = 80;
    uint256 public Part_AutoLiquidity = 20; 
