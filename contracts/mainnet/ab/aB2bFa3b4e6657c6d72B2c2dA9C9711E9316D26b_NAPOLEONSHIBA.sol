...
contract NAPOLEONSHIBA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NAPOLEON SHIBA";
    string private _symbol = "$NAPOLEON";
    uint8 private _decimals = 18;
    uint256 public _totalDistributionShares = 24;

    address payable public marketingwallet = payable(0xBFBb249A7858B3a3a68bD734ec6be442197d7dAE);
