...
contract MiloDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiloDao";
    string private _symbol = "MiloDao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x639C3E9F379C7595Fb4511E072A76B33fB7ac72c);
    address payable public teamWalletAddress = payable(0x639C3E9F379C7595Fb4511E072A76B33fB7ac72c);
