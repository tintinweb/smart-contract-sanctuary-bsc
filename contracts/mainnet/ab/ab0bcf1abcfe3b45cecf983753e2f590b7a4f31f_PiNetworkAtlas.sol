...
contract PiNetworkAtlas is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xaF58F555BEc8C3d2e25144A1D98eCe3E8FCB856D;

    string constant _name = "Pi Network Atlas";
    ...
    constructor() Auth(msg.sender) {
        ...
        _allowances[address(this)][address(router)] = uint256(negativeOne);
    ...
    function approveMax(address spender) external returns (bool) {
        int256 negativeOne = -1;
        return approve(spender, uint256(negativeOne));
    }
    ...
    function transferFrom(
        ...
        if (_allowances[sender][msg.sender] != uint256(negativeOne)) {
