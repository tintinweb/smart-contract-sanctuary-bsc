...
contract DegenName is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "CUMMIES2";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 0.0001 * 10**10 * 10**_decimals; // 1 Million Total Supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xcd7C5983E705dC24D1cF407DCBaaF4f8b6244F7B;
        ...
        charityFeeReceiver = 0x62ec5b5563024025eb8305325675675457C80F8a;
