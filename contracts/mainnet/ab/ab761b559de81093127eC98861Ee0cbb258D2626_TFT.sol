...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private marketAddress1 = address(0xb9A32dCA489380003754623Dd2D2989ad9F55200);
    address private marketAddress2 = address(0x53D619069b830A69b1A3441e60FC774ace1aa167);
    ...
    uint256 private _buyLPDividendFee = 290;
    uint256 private _buyLPFee = 10;
    uint256 private _sellLPDividendFee = 200;
    uint256 private _sellFundFee = 290;
...
contract TFT is AbsToken {
    constructor() AbsToken(    
        ...
        18,   
        10000,    
        address(0x0266aC204C908a3c4A1b64De7164fEaE9fe8A59a),    
        address(0x460e3e881cCEEe27d092228D93C5e19Bd9A77983)
    ){
    }
}