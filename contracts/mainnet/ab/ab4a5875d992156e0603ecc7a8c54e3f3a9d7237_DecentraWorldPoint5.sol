...
/**
 #DECENTRAWORLD.5 
   I make #DEWO.5 as a community base coin.
   Lets create the community and build something good and get some money back from DEWO.   
   Official channel https://t.me/DEWOPOINT5
   Taxes and Info
   2% fee auto add to the liquidity pool 
   7% fee Marketing
  Ownership to burn addresses to transfer #DEWO.5 to the community and ensure it's 100% safe. Lets make #DEWO.5 1000X?
*/
...
contract DecentraWorldPoint5 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DecentraWorldPoint5";
    string constant _symbol = "DEWO.5";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6C4E3a9600EE0f8B694AD41209cb733184d4E111;
        ecosystemfeeReceiver = 0x6C4E3a9600EE0f8B694AD41209cb733184d4E111;
