...
contract DogeDogeDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Doge Doge";
    string private _symbol = "DDD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDbAb7646FD89B7a9A1E1942f99c5EAcED8D75876); // Marketing Address
    address payable public teamWalletAddress = payable(0xDbAb7646FD89B7a9A1E1942f99c5EAcED8D75876); // Team Address
