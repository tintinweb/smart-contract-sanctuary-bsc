...
contract WINDSOFCHANGE is ERC20, Ownable {
    ...
    constructor() ERC20("WINDS OF CHANGE", "WOC") {
        ...
        devWallet = address(0x25fCA19b9eD7105BeCBfc7b28228BB71305CC5D9); // set as dev wallet
