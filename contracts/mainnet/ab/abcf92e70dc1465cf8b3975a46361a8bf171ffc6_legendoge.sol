...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1b06210c1Bb726e4D2eEB26BDeBc1f4f0D5aE51d; // owner address
...
contract legendoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Legend Of Doge";
    string private _symbol = "LOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1b06210c1Bb726e4D2eEB26BDeBc1f4f0D5aE51d); // Marketing Address
    address payable public teamWalletAddress = payable(0x1b06210c1Bb726e4D2eEB26BDeBc1f4f0D5aE51d); // Team Address
