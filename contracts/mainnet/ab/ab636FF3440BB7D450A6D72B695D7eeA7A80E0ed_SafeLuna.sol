...
contract SafeLuna is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xEC9d0eF90cD22c898332214D52f1f1F258F42d63));
    address payable private devWallet =
        payable(address(0xEC9d0eF90cD22c898332214D52f1f1F258F42d63));
    address private liquidityReceiver =
        0xEC9d0eF90cD22c898332214D52f1f1F258F42d63;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Safe Luna";
    string private _symbol = "SAFELUNA";
    ...
    uint256 private _maxTxAmount = 40000000 * 10**9;
