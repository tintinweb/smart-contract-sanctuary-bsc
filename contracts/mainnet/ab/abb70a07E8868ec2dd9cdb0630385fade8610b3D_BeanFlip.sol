...
//https://t.me/BeanMachineMiner
// ECOSYSTEM OF BEANMACHINE
...
/* Token contract */
contract BeanFlip is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xC7006F3Ab6B34746F6A795868be747C56D629848;
    ...
    // Name and symbol
    string constant _name = "BeanFlip";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 75000 / 10000; // 1.0% on launch
    uint256 public _maxSellTxAmount = _totalSupply * 25000 / 10000; // 1% on launch
    uint256 public _maxWalletToken = ( _totalSupply * 75000 ) / 10000; // 1% on launch
