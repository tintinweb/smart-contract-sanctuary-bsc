...
// File: contracts/MikusFortune.sol

/**
Telegram : https://t.me/MikuFortune
Website : https://mikusfortune.cc/
*/
...
contract LiquidityGeneratorToken is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        require(communityFeeBps_ >= 0, "Invalid community fee");
        if (communityAddress_ == address(0)) {
            require(
                communityFeeBps_ == 0,
        ...
        require(
            taxFeeBps_ + liquidityFeeBps_ + communityFeeBps_ <= 10**4 / 1,
        ...
        _communityFee = communityFeeBps_;
    ...
    function setTaxFeePercent(uint256 taxFeeBps) external onlyOwner {
        _taxFee = taxFeeBps;
        require(
            _taxFee + _liquidityFee + _communityFee <= 10**4 / 1,
            "Total fee is over 25%"
        );
    }
