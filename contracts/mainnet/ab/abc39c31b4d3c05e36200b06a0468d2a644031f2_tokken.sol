        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xaB253031c4231D758eD09c55865387392eaC454C), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0xaB253031c4231D758eD09c55865387392eaC454C),//
        address(0xaB253031c4231D758eD09c55865387392eaC454C)//
    ){
    }
}