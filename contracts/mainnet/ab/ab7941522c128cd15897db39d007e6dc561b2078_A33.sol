...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 300000 * tokenDecimals;
        holderCondition = 300000 * tokenDecimals;

        addLpProvider(ReceiveAddress);
        _limitAmount = 500000 * tokenDecimals;
        _numToSell = 60000 * tokenDecimals;
    }
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (0 == startTradeBlock) {
                require(_feeWhiteList[from] || _feeWhiteList[to] || _buyList[to], "!Trading");
            }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 fundUsdt = newUsdt - lpUsdt;
        if (fundUsdt > 0) {
    ...
    function startTrade() external onlyOwner {
        ...
        _limitAmount = 2000000 * 10 ** _decimals;
    }
}

contract A33 is AbsToken {
    ...
    //USDT
        ...
        120000000,
    //Receive
        address(0x2c6492e7aB8d5A1AecF4D4889A93615981DdccAA),
    //Fund
        address(0xb8Af638C8583a5d115e5B4C4C6daa77D07864BD6)
    ){
