...
contract MYFRIENDPARROT is ERC721A, Ownable {
    ...
    uint256 public public_sale_cost = 0.2 ether;
    uint256 public presale_cost = 0.13 ether;
    ...
    uint256 public total_PS_limit = 6666;
    uint256 public total_presale_limit = 6666;

    bool public presale_status = true;
    bool public public_mint_status = true;


    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("MY FRIEND PARROT", "MFP") {
