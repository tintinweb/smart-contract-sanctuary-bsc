...
interface IAutoCompound {
    ...
    function dueForCompound (  ) external view returns ( uint256 );
    function getCompounding (  ) external view returns ( address[] memory );
    function getCompounds ( address participant_ ) external view returns ( uint256[] memory );
    function getCompoundsLeft ( address participant_ ) external view returns ( uint256 );
    function getLastCompound ( address participant_ ) external view returns ( uint256 );
    function getTotalCompounds ( address participant_ ) external view returns ( uint256 );
    function initialize (  ) external;
    function nextUp (  ) external view returns ( address );
    function owner (  ) external view returns ( address );
    function pause (  ) external;
    function paused (  ) external view returns ( bool );
    function proxiableUUID (  ) external view returns ( bytes32 );
