...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf427a3A655FC0EFD2acD5aCD89CF752bFc838b2d; // owner address
...
contract RabbitNation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Nation";
    string private _symbol = "RN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf427a3A655FC0EFD2acD5aCD89CF752bFc838b2d); // Marketing Address
    address payable public teamWalletAddress = payable(0xf427a3A655FC0EFD2acD5aCD89CF752bFc838b2d); // Team Address
