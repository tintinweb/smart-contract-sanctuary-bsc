        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xfE140589f8d6C9Fe339DFEf6B6C205066Ebb2aA3), block.timestamp
                );
            }
        }
    }
...
contract SVDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0xfE140589f8d6C9Fe339DFEf6B6C205066Ebb2aA3),//FundAddress
        address(0xfE140589f8d6C9Fe339DFEf6B6C205066Ebb2aA3)//ReceiveAddress
    ){
    }
}