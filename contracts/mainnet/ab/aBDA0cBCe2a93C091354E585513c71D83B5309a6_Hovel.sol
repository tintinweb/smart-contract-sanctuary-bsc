...
contract Hovel is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    string public constant symbol = "HVL";
    string public constant name = "Hovel";
    uint256 public constant decimals = 8;

    mapping(address => uint) public balances;
    mapping(address => mapping(address => uint)) public allowed;
    address public constant deadWallet = address(0x9d8da7B8A48B38152776636254121c0955a64031);
    mapping(address => bool) public isBlackListed;
    uint256 public _totalSupply = 51007200000000000000000;
