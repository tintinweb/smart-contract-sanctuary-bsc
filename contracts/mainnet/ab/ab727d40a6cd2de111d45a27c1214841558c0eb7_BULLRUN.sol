...
BULLRUN 23 IS COMING!!!

Join: https://t.me/bullishbitcoin23
...
contract BULLRUN is Context, IERC20, Ownable {
    ...
    string private _name = "BullRun 23";
    string private _symbol = "BULLRUN23";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xA243EA8E7c73F4dC3B6423b3AaEB4c0c160fe401);
    address payable public teamWalletAddress = payable(0x527c4F180F135f66572DECf113b8d2f7c5d463d5);
