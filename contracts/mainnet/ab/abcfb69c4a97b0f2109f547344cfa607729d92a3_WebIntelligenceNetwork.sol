...
/*
  Web Intelligence Network - WEINT Token
  Web Intelligence (WEINT.NETWORK) is a software network project created to focus on solutions
  to problems in the Web3 internet world. It aims to provide developers with
  DApp modules and ready-made software that have been further developed and
  presented with increased efficiency in addition to standard programs and software.

  It can offer community solutions for developers by offering ready-made modules
  that can be used with many software. RPC systems are one of the main advantages
  of open-source Typescript software.

  Total Fee: 4% (3% Marketing | 1% Auto-LP)
  Slippage: 5%

  Website: weint.network
  Telegram: @WeintToken
  Twitter: @WeintToken
*/
...
contract WebIntelligenceNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Web Intelligence Network";
    string private _symbol = "WEINT";
    ...
    address public charityWallet = 0x7bEb008990e9BC5C1dE94996263cd40922c6Cd7e;
