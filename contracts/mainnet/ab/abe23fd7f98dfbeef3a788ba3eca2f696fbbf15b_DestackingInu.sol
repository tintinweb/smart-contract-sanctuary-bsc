...
/**
 telegram https://t.me/DestackingInuOfficial
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 NoneReward = IBEP20(0x03fF0ff224f904be3118461335064bB48Df47938);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = NoneReward.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(NoneReward);
        ...
        uint256 amount = NoneReward.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            NoneReward.transfer(shareholder, amount);
...
contract DestackingInu is IBEP20, Auth {
    using SafeMath for uint256;

    address NoneReward = 0x03fF0ff224f904be3118461335064bB48Df47938;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DestackingInu";
    string constant _symbol = "DestackingInu";
    ...
    function startingLiquidity(bool _status) public onlyOwner {
        swapBaby = _status;
    }
