...
contract MCILIV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MCILIV";
    string private _symbol = "MCILIV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2748822e60F8AB94f52427151bf54faCF3Acb73c);
    address payable public teamWalletAddress = payable(0x2748822e60F8AB94f52427151bf54faCF3Acb73c);
