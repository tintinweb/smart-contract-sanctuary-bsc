...
Telegram: https://t.me/aseinubsc

🌙 TOP MOON🔝TOP MOON

📊 Chart ☑️ Tracker 🟢 Trending
🔥Fair launch TOP MOON 🔝
🟢 Low MC 
🟢 Hyped
🟢 LP Three Month Lock 🔐
🟢 Soon Collab With Bossy Team
🟢 Dev team with Connections
🔐100% Safu
...
contract ASEINU is IBEP20, Ownable {
    ...
    string constant _name = "AseInu";
    string constant _symbol = unicode"ASEINU";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply     = 21000000000 * 10**_decimals;
    uint256 public _maxTxAmount     = 1050000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 1050000000 * 10**_decimals;

    address private deadWallet      = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0x0901F7439C0E702809371076e5733a85A6a1486b;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(4, 4, 1, 0);
    Fees public sellFees    = Fees(4, 4, 1, 0);
