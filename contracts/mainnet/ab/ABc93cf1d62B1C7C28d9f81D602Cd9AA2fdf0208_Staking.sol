...
contract Staking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        syrup = IBEP20(0xaDAaE082237cB1772c9e079dB95c117E6Dd0C5aF);
        rewardToken = syrup;
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                require(pending <= rewardPerBlock(), "Cannot withdraw other people's staked tokens.  Contact an admin.");
