...
/**
    !Disclaimer!
    By purchasing and using the Tennisball token, you achnowledge and agree that
    the company and its affiliates shall not be liable for any losses,
    damages, or claims arising out of or in connection with your purchase,
    ownership, or use of the token.
    The token is a utility token intended for use withing the TennisBey app
    and makes no promises of profit or return. Future promotions and events
    will be announced solely throught official social media channels and any
    actions taken on your part should be done at your own risk.
    You are solely responsible for any taxes or other liabilities that may
    arise from the ownership or use of the token.
*/
...
contract TennisBey is Context, IBEP20, Ownable {
    ...
    constructor ()  {
		...
		FeeAddress = 0x231eaD3CC2a1252C5aCCb900d48D314174d3aC0f;
		_owner = 0xB37286f42c1a0717c2543856050413D8444A3202;
