...
library Address{
  ...
  contract SPARTAINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9b124abD9e849149e2F207fb3a1654d116270D6F;
    address public DAOwallet = 0xdf160F6B97281CE2dccBB8ee75d37b5a6862483b;

    string private constant _name = "Sparta Inu";
    string private constant _symbol = "SPARTA INU";
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(DAOwallet).sendValue(donationAmt);
        }
    }
