...
//Take a look at our website here: https://lucky-cash.net
//Join The Community here: https://t.me/luckycashbsc 
...
contract LuckyCash  is IBEP20, Auth {
    ...
    string constant _name = "LuckyCash";
    string constant _symbol = "LCASH";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =  100 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 100;    //max TX 1%
    uint256 public _maxWalletToken = _totalSupply / 50;  //max Wallet 2%
    ...
    uint256 public LotteryFee       = 4;  //goes to lotterycontract
    uint256 public devFee           = 0;
    uint256 public utilityFee       = 0;
    uint256 public totalFee         = devFee + marketingFee + liquidityFee + LotteryFee + utilityFee;
    uint256 public feeDenominator   = 100;

    uint256 public sellMultiplier = 300;  //first 24h  only
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x375bC77B4E53980659Ef2D78cEA454b87584fBaE;
        marketingFeeReceiver = 0xD2423F5b4aF9f1a16fd200a53B5fd5192B405Ab4;
        LotteryFeeReceiver = 0xd3D2E0eCe59f768baE205d42E5908EbAe9949D3C;
        devFeeReceiver = 0x375bC77B4E53980659Ef2D78cEA454b87584fBaE;
        utilityFeeReceiver = 0x375bC77B4E53980659Ef2D78cEA454b87584fBaE; 
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _LotteryFee, uint256 _utilityFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        marketingFee = _marketingFee;
        LotteryFee = _LotteryFee;
        utilityFee = _utilityFee;
        totalFee = _liquidityFee.add(_devFee).add(_marketingFee).add(_LotteryFee).add(_utilityFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");    //tax cant be change to more than 50% ever 
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _LotteryFeeReceiver, address _utilityFeeReceiver, address _devFeeReceiver) external onlyOwner {
