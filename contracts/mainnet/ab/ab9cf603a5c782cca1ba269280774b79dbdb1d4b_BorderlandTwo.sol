...
contract BorderlandTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeInBorderland 2.0";
    string private _symbol = "BORDERLAND";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xdE29bE549A43356Cdf2A8cf779Bfb0d532F4770E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xB4685FF63E57757B8fDB2b29DEEa3F1Ff44fDE45); // BuyBack Address
