...
/* Token contract */
contract shibyDoxed is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB5754c3D202246895Cc5DE5e5aE6B0A57cEABe4f;
    ...
    // Name and symbol
    string constant _name = "SHIBBALLS";
    string constant _symbol = "$Shibballs";
