...
contract Moma is BEP20, Pausable, BEP20Detailed {
    
	address teamWallet = 0xdc912DE9C4006726E83992AFAC3E41B22D04C0b0;
	...
	constructor() public BEP20Detailed("MOMA", "MOMA", 6) {  
	        
       
        totalCoins = 8000000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 10 billion coins
        
        BEP20.transfer(teamWallet, 8000000000 * 10 ** uint256(decimals()));  
