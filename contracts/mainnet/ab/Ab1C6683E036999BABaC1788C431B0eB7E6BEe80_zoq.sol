...
contract  zoq is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"209W" ;
    string private _symbol = unicode"209W";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x520D5542eD736B88EaA4C9A33D13DF5022e6aC3d);
    address payable public teamWalletAddress = payable(0x520D5542eD736B88EaA4C9A33D13DF5022e6aC3d);
    ...
    uint256 private _totalSupply =  209 * 10**_decimals;
