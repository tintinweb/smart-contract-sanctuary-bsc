...
/**
   ...
   #Grimacepizza will list on #BSC 

   I make this #Grimacepizza to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/Grimacepizzabsc
   ...
   I will renounce the ownership to burn addresses to transfer #Grimacepizza to the community and ensure it's 100% safe.

   I will add 1 BNB and 70% of the total supply to the pool
...
contract Grimacepizza is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grimacepizza"; 
    string private constant _symbol = "Grimacepizza"; 
