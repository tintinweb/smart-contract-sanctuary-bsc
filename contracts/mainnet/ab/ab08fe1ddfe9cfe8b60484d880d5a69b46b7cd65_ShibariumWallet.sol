...
/**
Shibarium Wallet 
Introducing $SHIBFOLIO, the ultimate wallet solution for Shibarium token holders - where privacy and fun come together! 
Our token is the perfect blend of cutting-edge Zero Knowledge technology and the playful energy of the Shiba Inu meme. 
With Shibarium Wallet, you can enjoy secure transactions and complete privacy while also joining the fun and excitement of the meme coin world Shibarium. 
Join our community today and experience the joy of owning Shibarium Wallet!
                                                                                                                       

╔═════════╦════════════════════════════════════════════════════════╗
║ NAME ║ Shibarium Wallet ║
╠═════════╬════════════════════════════════════════════════════════╣
║ TELEGRAM║ https://t.me/ShibariumWallets ║
╠═════════╬════════════════════════════════════════════════════════╣
║ TOKEN ║ TOTAL SUPPLY | 100,000,000,000,000 ║ LAUNCH | STEALTH ║
║ ║ MAX WALLET | 2% ║ TAX | 3/3 ║
╚═════════╩════════════════════════════════════════════════════════╝
...
contract ShibariumWallet is Context, iBEP20, Ownable {
    ...
    string private _name = 'Shibarium Wallet';
    string private _symbol = 'SHIBFOLIO';
