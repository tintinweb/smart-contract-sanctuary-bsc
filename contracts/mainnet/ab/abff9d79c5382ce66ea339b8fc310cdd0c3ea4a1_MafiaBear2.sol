...
contract MafiaBear2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2177A89a2f2847493A3F248837E5a25570acCF08); 
    address payable public Wallet_Dev = payable(0xdcc2106b3dEd867021f1C24B68d3915DdE1f7356);
    ...
    string private constant _name = "Mafia bear 2.0"; 
    string private constant _symbol = unicode"MFB2"; 
    ...
    constructor () {
        ...
        _owner = 0xF85C56Fd007eA1834345E32C5B83Ec93fCA94b2e;
