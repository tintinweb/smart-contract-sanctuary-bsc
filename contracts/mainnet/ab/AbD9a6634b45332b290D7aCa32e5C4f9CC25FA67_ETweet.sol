...
/**
ETweet the next Moonshoot Token on BSC!

We Burn on all Elon Tweets! Hence Forward! 2022
We Support Free Speech, Counter Cancel Culture!
 **/
...
/* Token contract */
contract ETweet is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC1fB780B14B9FBDC145bBFc853FB13418A423dD7;
    ...
    // Name and symbol
    string constant _name = "ETweet";
    string constant _symbol = "ETweet";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% on launch or 3T tokens
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1.5% or 1.5T tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% or 3T tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x819A78dD53337a488c28515AeBb8B005a1e2587d;
