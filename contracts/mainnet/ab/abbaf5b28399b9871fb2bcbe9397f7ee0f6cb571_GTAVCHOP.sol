...
contract GTAVCHOP is Context, IERC20, Ownable {
    ...
    string private constant _name = "GTA V CHOP"; // 
    string private constant _symbol = "VCHOP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0838dEbB8857B73d43Cd311Fb63f329F90f8Fbfd;
