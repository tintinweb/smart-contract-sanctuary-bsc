...
contract HellGirlMiho is IBEP20, Auth {
    ...
    string constant _name = "Hell Girl Miho";
    string constant _symbol = unicode"HGM";
    ...
    function SetWhitelistStatus(address _marketingFeeReceiver, address _devFeeReceiver) external onlyOwner {
