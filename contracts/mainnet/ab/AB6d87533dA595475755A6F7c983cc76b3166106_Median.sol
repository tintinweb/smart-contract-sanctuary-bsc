...
interface IBaseMedian {
    function withdraw(address token, address usdtAddress) external returns(bool);
}
...
contract Median is AccessControl {
    ...
    function changeOperator(address _operator) external onlyRole(ADMIN_ROLE) returns(bool) {
