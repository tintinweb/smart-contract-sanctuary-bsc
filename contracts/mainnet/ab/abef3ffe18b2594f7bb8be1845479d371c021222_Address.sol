...
contract OmegaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x089e2ed16b6A13acd2b30EeC19726D26109f2568); // Marketing Address
    address payable public charityAddress = payable(0x089e2ed16b6A13acd2b30EeC19726D26109f2568); // Charity/Dev Address
    ...
    string private _name = "Omega Token";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 1000000000000000000000; // 1000; token will be given on airdrop
    ...
    uint256 private salePrice = 500000;// 500,000 OMEGA for 1 BNB (set as per requirements)                         
