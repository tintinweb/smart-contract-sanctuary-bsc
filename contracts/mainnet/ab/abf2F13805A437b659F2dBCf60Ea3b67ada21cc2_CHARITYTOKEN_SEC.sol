...
// CHARITYTOKEN + ANTIBOT v1.1.2 generated with LaMachine.io 
...
contract CHARITYTOKEN_SEC  is ERC20Upgradeable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function initialize(
        ...
        address[4] memory addrs, // reward, router, marketing wallet, charity
        ...
        _isExcludedFromFees[_marketingWalletAddress] = true;
        _isExcludedFromFees[address(_charityWalletAddress)] = true;
        ...
        isExcludedFromTransactionlock[address(_charityWalletAddress)] = true;
        ...
        isExcludedFromAntiWhale[address(_charityWalletAddress)] = true;
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner {
        require(
            wallet != address(0),
            "Cnnot be the value of zero"
        );
        require(!wallet.isContract(), "Cannot be a contract");
    ...
    function _transfer(
        ...
        if (
            ...
            if (charityFee > 0) {
                uint256 charityToken = contractTokenBalance
                    .mul(charityFee)
                    .div(totalFees);
                swapAndSendToFee(charityToken,_charityWalletAddress);
            }
    ...
    function swapAndSendToFee(uint256 tokens, address dest) private {
        ...
        IERC20(rewardToken).transfer(dest, newBalance);
    }
