...
contract ZoaVesting3Public is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting3Public: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting3Public: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting3Public: wrong TGE timestamp");
