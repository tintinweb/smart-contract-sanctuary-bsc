...
// 
//
// 📱 Telegram:https::https://t.me/BabyNukeInuVerify
//
...
contract BABYNUKEINU is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("BABYNUKE INU", "BABYNUKEINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BABYNUKEINU";
    string private _symbol = "BABYNUKEINU";
