 ...
 * https://t.me/HokkaidoPup (Join TG for more info)
 * HokkaidoPup is a Community token that automatically provides LP and reward holders for holding the $HOKKAIDOPUP token!
 
 * HokkaidoPup Tax Distribution
 - 3% redistributed to holders
 - 2% sent to the Liquidity Pool to increase the price floor
...
contract HOKKAIDOPUP is Context, IERC20, Ownable {
    ...
    string private _name = "HokkaidoPup";
    string private _symbol = "HOKKAIDOPUP";
