...
YEN DIGITAL TOKEN is a community governed crypto currency project that aims to establish itself as a secure 
and stable alternative to the currency with the third biggest gross domestic profit (GDP) per year.  Launched 
by an experienced, committed and PROVEN team, Yen Digital Token boasts of visions and concepts poised for 
continuous growth and eventual success

https://t.me/yendigitaltoken
...
contract yendigitaltoken is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Yen Digital Token";
