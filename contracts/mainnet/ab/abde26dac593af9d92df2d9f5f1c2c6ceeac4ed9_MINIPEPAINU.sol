...
contract MINIPEPAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Pepa Inu";
    string private _symbol = "MINIPEPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e9e87719bdfB8b54e8b43AD9B010E52CD0b8518); 
    address payable public buyBackWalletAddress = payable(0xef807f6a9b02f3071f508a25fAA06D822Fd04754); 
    ...
    uint256 private minimumTokensBeforeSwap = 6300000000 * 10**9; 
