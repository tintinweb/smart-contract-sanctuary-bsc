...
contract bnbcoinToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8a5022F0533e9bbc4663CE2433a5F53b11bE901d); 
    address payable public marketingAddress2 = payable(0x8a5022F0533e9bbc4663CE2433a5F53b11bE901d); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x1D716f1FbF877EaFC8B91601C5031844eea759bd);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
    address ethAddress = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
