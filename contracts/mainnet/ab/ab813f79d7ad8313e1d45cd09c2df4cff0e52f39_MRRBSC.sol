...
//Telegram: https://t.me/MrBSCPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 3 * (10 ** 12);
...
contract MRRBSC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MR BSC";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xF33b6B3DD26EE0B7c0Ba1Ce3239A1Ce15B94934C;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xDD53783B50E63cf5428CCc186Fd2364ca79023b5; 
        devWallet = 0x7016384a10C3Db79F76688077605BC90E501535c; 
