...
contract DummyFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "DummyFloki"; // 
    string private constant _symbol = " $DUMBFLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x90d3f4e94CDe5DFCd154FFf4b35F9cDc3E9a75C9;
