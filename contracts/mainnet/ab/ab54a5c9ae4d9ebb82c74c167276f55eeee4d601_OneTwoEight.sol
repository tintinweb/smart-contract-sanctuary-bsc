...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x844f289F5C7B6510EbBb4bc2F3F4CC9f2e65C393;
...
contract OneTwoEight is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 2**7 * 10**_decimals;
    string private constant _name = unicode"+128"; 
    string private constant _symbol = unicode"+128"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x844f289F5C7B6510EbBb4bc2F3F4CC9f2e65C393), BNB_Tot);
            }
