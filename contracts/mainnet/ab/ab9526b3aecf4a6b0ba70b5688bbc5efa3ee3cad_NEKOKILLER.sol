...
// TG : https://t.me/NekoKillerOfficial
...
contract NEKOKILLER is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "NekoKiller";
   string constant _symbol = "NEKOKILLER";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 100000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 25 ) / 1000; // 
