...
contract Kombat is Context, IERC20, Ownable {
    ...
    uint256 private constant MAX = ~uint256(1000000);
    uint256 private constant _tTotal = 100000000 * 10**4 * 10**5;
    ...
    string private constant _name = "Kombat";
    string private constant _symbol = "KBT";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9f4B8C3885c1c5010997e640C7F88E5469B1bA85);
    address payable private _marketingAddress = payable(0x415f382245CEDa8267304B40Ba65238BbF9e981b);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 21, "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 21, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 21, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 21, "Tax cannot be more than 6.");
