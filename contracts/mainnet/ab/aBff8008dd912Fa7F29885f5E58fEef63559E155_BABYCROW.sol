...
contract BABYCROW is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 2_000_000_0 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "BABY CROW"; // 
    string private constant _symbol = "$BCR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x34D5A13a9996c4662Ef7f2c52aA4B675A20F8D6D;
