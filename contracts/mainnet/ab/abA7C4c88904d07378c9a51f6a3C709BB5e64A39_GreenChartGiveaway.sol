...
contract GreenChartGiveaway is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Green Chart | Official Giveaway", "GCGiveaway") {
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://ipfs.infura.io/ipfs/Qma4Es4NgYeqS2ipdPZqeT5T5N6kc4QXZ9YCzdTiLerjtV";
    }
