...
contract DogeBonk is Context, IERC20, Ownable {
    ...
    string private _name = "DogeBonk";
    string private _symbol = "DOBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x497aaE9cE6Ba5CbEe7F22f16b6f52a40b56f0F89); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xB7C8026Aa15d9cfFF9E1A57CFB18ff35E399b1db); // BuyBack Address
