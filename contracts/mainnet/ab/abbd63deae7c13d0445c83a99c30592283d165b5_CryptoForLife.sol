...
* Telegram: https://t.me/CryptoForLifeofficial
*/
...
contract CryptoForLife is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Crypto For Life";
    string constant _symbol = "CFL";
    ...
    uint256 public swapThreshold = _totalSupply * 69 / 10_000;
    bool inSwap;
