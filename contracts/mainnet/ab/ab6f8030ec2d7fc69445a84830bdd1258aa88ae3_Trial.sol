...
contract Trial is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 2500000; // 2% of sp
    uint256 public maxTxAmountSell = 2500000; // 2% of sp
    uint256 public maxWalletAmount = 7500000; // 2% of sp
    ...
    string private constant _name = "Harder";
