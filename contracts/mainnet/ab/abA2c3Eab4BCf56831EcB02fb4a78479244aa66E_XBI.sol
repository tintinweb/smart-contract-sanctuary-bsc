...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB48A2277586cbd3b1e27fB1Fa3d4fEAd2A1635a5;
...
contract XBI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb44e5111573C729CE6e01A734160bDc49bFeC168;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Xiaobai";
    string private _symbol = "XBI";
