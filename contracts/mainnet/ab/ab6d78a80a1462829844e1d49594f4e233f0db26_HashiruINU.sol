...
contract HashiruINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hashiru INU";
    string private _symbol = "HASH";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x9ac2655249D44ad308a090edA98Cbfa663F58f3a);
