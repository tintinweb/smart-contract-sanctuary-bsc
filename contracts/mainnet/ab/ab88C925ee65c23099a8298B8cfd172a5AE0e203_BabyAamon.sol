...
/**
 Baby aamon is a basic token from mlbb and it's going to hype up any minute!.
 Earn BUSD By Holding Baby AAMON
 NAME : BABY AAMON
 SYMBOL : BABY
 TOTAL SUPPLY: 1 hours again
 Slippage : BUY 7% | SELL 11%
 Marketing fee : BUY 2% | SELL 7%
 REWARDS BUSD : 2% | 2%
 LIQUIDTY FEE : BUY 3% | SELL 2%
*/

// Telegram:https://t.me/babyaamon
// Website: SOON
...
contract BabyAamon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8D14C94a3954C07bcec402e3ead5b88367950Ef3); 
    address payable public Wallet_Dev = payable(0x8D14C94a3954C07bcec402e3ead5b88367950Ef3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 7**_decimals;
    string private constant _name = "BABY AAMON"; 
    ...
    constructor () {
        ...
        _owner = 0x8D14C94a3954C07bcec402e3ead5b88367950Ef3;
