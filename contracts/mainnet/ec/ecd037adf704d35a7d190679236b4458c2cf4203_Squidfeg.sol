...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86e23E33890d6aCeDD19E8daEC169aAf77Ca8686; // owner address
...
contract Squidfeg is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Feg";
    string private _symbol = "SF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3Be5057BE632e6f80b139f182fbf1945d03CAFA3); // Marketing Address
    address payable public teamWalletAddress = payable(0x3Be5057BE632e6f80b139f182fbf1945d03CAFA3); // Team Address
