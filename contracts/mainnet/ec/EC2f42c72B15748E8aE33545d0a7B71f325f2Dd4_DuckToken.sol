...
contract DuckToken is Ownable, IERC20 {
    ...
    string public _name = "Xiansheng";
    string public _symbol = "xa";
    ...
    uint256 public _totalSupply = 800 * 10 ** _decimals;
    uint256 public _maxTxAmount = 1 * 10 ** _decimals;
    uint256 public _maxWallet =   1 * 10 ** _decimals;
