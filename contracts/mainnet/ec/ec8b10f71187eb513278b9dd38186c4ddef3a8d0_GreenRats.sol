...
contract GreenRats is Context, IERC20, Ownable {
    ...
    string private _name = "Green Rats";
    string private _symbol = "GRATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x358b4f66891120739d9338DC54016fb4C7109439);
    address payable public BuyBackWalletAddress = payable(0x358b4f66891120739d9338DC54016fb4C7109439);
