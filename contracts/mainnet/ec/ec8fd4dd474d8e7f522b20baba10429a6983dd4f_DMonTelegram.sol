...
/**
ALL TRACKERS, MESSAGE ME ON TELEGRAM: @Acquiree
...
contract DMonTelegram is IBEP20, Auth {
    ...
    string constant _name = "DMonTelegram";
    ...
    address private marketingFeeReceiver =0x5412b63eCEca1A30551f65d50F4C56a06bbf1bdb;
    address private teamFeeReceiver =0x5412b63eCEca1A30551f65d50F4C56a06bbf1bdb;
