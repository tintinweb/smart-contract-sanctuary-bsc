...
interface IStakingPlatform {
    ...
    function lockStaking(address stakeHolder) external view returns (uint);
...
contract StakingPlatform is IStakingPlatform {
    ...
    uint public totalBloggerR = 50000000;
    address public owner = 0x3D62B3A7e17fD0e5A78A3d641c6977654711c90b;
    string public names = "sBlogger";
    uint public timeStakingH = 30;
    uint public timeStakingD = 90;
    uint public timeStakingW = 180;
    uint public timeStakingE = 360;
    ...
    function lockStaking(uint amount, address payable destAddr) public {
    ...
    function openStaking(uint amount, address payable destAddr) public {
        require(amount <= balance, "");
    ...
    function lockStaking(address stakeHolder)
        external
        view
        override
        returns (uint)
