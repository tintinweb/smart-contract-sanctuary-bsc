...
pragmaa solidity 0.6.12


lnterface IERC20

   totalSupply  external view returns 
 ...
 dev Moves `amount` tokens from the caller's account to `recipient`.
  ...
  Emits a Transfer event.
   ...
   Website
   https://twitter.com/CCIS_TOKENBSC

    Telegram 
    https://t.me/CyberCubeInternetSecurity
...
contract CyberCubeInternetSecurity is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x20D960359b3FC14d3D0299cAceC59530ed7D9B3d));


    string private _name = "Cyber Cube Internet Security";
    string private _symbol = "CCIS";
