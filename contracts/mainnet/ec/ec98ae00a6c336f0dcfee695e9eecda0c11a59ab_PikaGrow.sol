...
Let's make Pika Grow a household name
...
contract PikaGrow is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Pika Grow"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xaE7e8666B8EAA49cfe4e3A4Bc75D83517423e0E5;
