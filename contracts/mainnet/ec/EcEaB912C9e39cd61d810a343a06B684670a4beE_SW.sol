...
contract SW is IERC20, Ownable {
    ...
    address private fundAddress = address(0x9575e5f0E371C1624f28979957F71eB8947D2B11);
    ...
    constructor() {
        ...
        _rOwned[0x470Ba78c913544f8Ec19a061B90073E270998C82] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0x470Ba78c913544f8Ec19a061B90073E270998C82] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = msg.sender;
        emit Transfer(address(0),0x470Ba78c913544f8Ec19a061B90073E270998C82, _tTotal);
    }
