...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TATE = IBEP20(0x8f1D278C438242653Ee0bdd9DbD5A7f29CD046bF);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TATE.balanceOf(address(this));
        ...
        uint256 amount = TATE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TATE.transfer(shareholder, amount);
...
contract TatElon is IBEP20, Auth {
    using SafeMath for uint256;

    address TATE = 0x8f1D278C438242653Ee0bdd9DbD5A7f29CD046bF;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TatElon";
    string constant _symbol = "Tate Elon";
