...
contract KingHare is IERC20 {
    ...
    string private constant _name = "King Hare";
    string private constant _symbol = "KingHare";
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x45BE31DA5CD6BF3f09969B562140e1FB6f3C03Af),
            development: payable(0x45BE31DA5CD6BF3f09969B562140e1FB6f3C03Af)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0x45BE31DA5CD6BF3f09969B562140e1FB6f3C03Af] = true; 
        _isExcludedFromFees[0x45BE31DA5CD6BF3f09969B562140e1FB6f3C03Af] = true; 
