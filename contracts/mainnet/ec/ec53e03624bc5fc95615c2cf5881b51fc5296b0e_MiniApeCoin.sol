...
contract MiniApeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Ape Coin";
    string private _symbol = "MiniApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x536Bc21CA04B8a361CD5A17d9e5A2699c16BfE74); 
    address payable public buyBackWalletAddress = payable(0x536Bc21CA04B8a361CD5A17d9e5A2699c16BfE74); 
