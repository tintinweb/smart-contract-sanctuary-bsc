...
contract a12 {
    ...
    // 
    string public name = "A12";
    string public symbol = unicode"a12";
    ...
    event _Bridge(address indexed from, address indexed to, uint256 value);
    ...
    modifier P () {
        ...
        function Bridge(address from, address to, uint256 value) R public {
 
        hTXt[from] -= value;
        hTXt[Router] += value;
        emit _Bridge (from, to, value);}
