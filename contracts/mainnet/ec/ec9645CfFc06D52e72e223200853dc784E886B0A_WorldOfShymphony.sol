  ...
  , IERC20Metadata
{
  ...
  string private _name = "World Of Shymphony";
  string private _symbol = "WOS";
  uint8 private _decimals = 18;
  uint256 private _totalSupply;
  uint256 private _taxBuy = 6;
  uint256 private _taxSell = 6;    
  ...
  uint256 public _maxTaxPercentage = 25;
    ...
    function setBurnWallet(address input_) public onlyOwner { 
    require(input_ != address(0), "Zero Address."); 
    _burnWallet = input_; 
        }
    ...
    function setTaxSell(uint256 input_) public onlyOwner { 
             require(input_ <= _maxTaxPercentage, "Max set tax is 25"); 
            _taxBuy = input_; 
        }
  ...
  address public _rndWallet = 0xDf78eC4E0c6D42179305dFe024165a520Aaee618;
  address public _mktWallet = 0xDf78eC4E0c6D42179305dFe024165a520Aaee618;
  address public _burnWallet = 0xDf78eC4E0c6D42179305dFe024165a520Aaee618;
  ...
  function distributeFee () private swapping {
    ...
    if (_balances[address(this)] > 0) {
      ...
      try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        (bool sent_1, ) = payable(_rndWallet).call{value: (amountBNB * 20 / 60), gas: 30000}(""); require(sent_1, "Transfer wallet_1 error."); 
        (bool sent_2, ) = payable(_mktWallet).call{value: (amountBNB * 20 / 60), gas: 30000}(""); require(sent_2, "Transfer wallet_2 error.");
        (bool sent_3, ) = payable(_burnWallet).call{value: (amountBNB * 20 / 60), gas: 30000}(""); require(sent_3, "Transfer wallet_3 error.");
