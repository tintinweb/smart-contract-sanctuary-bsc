...
contract DDGDS is Context, IERC20, Ownable {     //合约名字
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DDGDS";   //全名
    string private _symbol = "DDGDS"; //符号
    ...
    uint256 private _buyTeamFee = 45;       
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6C464130FFd722C3355c139ABBBdCc9021fe3854));   
