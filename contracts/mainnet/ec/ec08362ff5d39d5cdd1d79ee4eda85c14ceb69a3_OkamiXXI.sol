...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x571C6B0A5d421FEb23894699282df99ff31cc242; // owner address
...
contract OkamiXXI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OkamiXXI";
    string private _symbol = "$OKAMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x571C6B0A5d421FEb23894699282df99ff31cc242); // Marketing Address
    address payable public teamWalletAddress = payable(0x571C6B0A5d421FEb23894699282df99ff31cc242); // Team Address
