...
contract HTEST is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xFAd725DcFEcD98C861d3976338bcB1fE5a836a84;
    ...
    uint256 public _maxTxAmount = 10 * 10 ** 7 * 10 ** uint256(_decimals);
