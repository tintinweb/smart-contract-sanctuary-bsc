...
library Address{
  ...
  contract XmasBot is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5e7 * 10**9;
    uint256 public maxBuyLimit = 1e8 * 10**9;  // 0.1% Max 
    uint256 public maxSellLimit = 1e8 * 10**9; // 0.1% Max
    uint256 public maxWalletLimit = 2e8 * 10**9;  // 0.2% Max

    uint256 public genesis_block;

    address public marketingWallet = 0x6174f8161d3c641ACaEF5F49A214E71890267E91;
    address public devwallet = 0x0A7d6AD534D07759442041C646D62C95211989a4;

    string private constant _name = "X Mas Bot";
    string private constant _symbol = "XMASBOT";
    ...
    Taxes public taxes = Taxes(0, 1, 9, 0);
    Taxes public sellTaxes = Taxes(0, 1, 9, 0);
