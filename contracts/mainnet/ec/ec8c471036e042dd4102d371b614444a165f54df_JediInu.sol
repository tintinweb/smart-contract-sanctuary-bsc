...
/*
    ...
    4% Auto add LP
    3% Marketing Wallets
    4% Reflection for Holders
    11% Total Tax
    Slippage both : 12% more

    May the force be with you

    Join us now : https://t.me/jedi_inu
*/
...
contract JediInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 6 * 10**10 * 10**9;
    uint256 public _walletMax = 6 * 10**10 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10000 * 10**9; 

    address payable public marketingWalletAddress = payable(0x74ab4dcc6A3bA21E63de8A2BF2625152020247a1); 
    address payable public rewardsWalletAddress = payable(0xE4C51745b8971f7E89fa10EDf73C1277c0C77b1e); 
