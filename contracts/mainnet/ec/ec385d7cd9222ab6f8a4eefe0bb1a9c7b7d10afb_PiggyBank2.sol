...
contract PiggyBank2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Piggy Bank 2.0";
    string private _symbol = "PB2.0";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x35004Ac39E4ce0a30971BbAf3222270945480A75);
    address payable public teamWalletAddress = payable(0x35004Ac39E4ce0a30971BbAf3222270945480A75);
