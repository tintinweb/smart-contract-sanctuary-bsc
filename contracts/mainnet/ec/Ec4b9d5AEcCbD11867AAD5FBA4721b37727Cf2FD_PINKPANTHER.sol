...
So I made "pinkpanther" as wagmi cat as I like this term and how its gained more significance over the past year_ 
I don't have any huge ambitions for dopecat as I know where I'm deploying it/
However I've designed this as a rare gem and community based stronghold in the sea of
 capitalist refuse which currently swarms the chain/ I have got a friend to make a telegram 
 group for the token t.me/pinkpantherbsc 
lol_ thats pretty much it_ ill renounce ca and lock liq  due to the  turbulence of 
the year thus far/ 
...
contract PINKPANTHER is Context, IERC20, Ownable {
    ...
    string private _name = "PINKPANTHER";
    string private _symbol = "$PPANTHER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEBa9AC147056d5C3E62EE3F42599A8f6f585dB4A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xEBa9AC147056d5C3E62EE3F42599A8f6f585dB4A); // BuyBack Address
