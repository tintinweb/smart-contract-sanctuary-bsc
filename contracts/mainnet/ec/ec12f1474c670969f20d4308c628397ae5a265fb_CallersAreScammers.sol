...
Welcome to callers are scammers.
We do not like callers. 
we use them.... 
Callers farm you
We do not
XD CALLERS ARE DESTROYING BSC!!!!!!!
...
/* Token contract */
contract CallersAreScammers is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "CallersAreScammers";
    string constant _symbol = "NOCALL";
