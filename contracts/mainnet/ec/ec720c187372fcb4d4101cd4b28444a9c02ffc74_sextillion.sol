...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9ce64Ca23717B2E77501Ac855cBE6d48623d20aC; // owner address
...
contract sextillion is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9ce64Ca23717B2E77501Ac855cBE6d48623d20aC); // Marketing Address
    address payable public teamWalletAddress = payable(0x9ce64Ca23717B2E77501Ac855cBE6d48623d20aC); // Team Address
    ...
    uint256 public _maxTxAmount = 40000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 40000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 40000000000000000000 * 10**_decimals; 
