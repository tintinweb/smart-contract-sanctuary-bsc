...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe9fa70331EFc6cC198bc0aFa2521a6F9Cc30dAcb; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "Cat Girl Grow";
    string private _symbol = "$CGG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe9fa70331EFc6cC198bc0aFa2521a6F9Cc30dAcb); // Marketing Address
    address payable public teamWalletAddress = payable(0xe9fa70331EFc6cC198bc0aFa2521a6F9Cc30dAcb); // Team Address
