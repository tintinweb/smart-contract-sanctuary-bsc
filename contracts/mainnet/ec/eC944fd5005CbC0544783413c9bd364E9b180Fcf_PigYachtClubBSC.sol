...
contract PigYachtClubBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0x106496dA67f7212B3C340C2cc7095b329455A028;

    string constant _name = "PigYachtClubBSC";    
    string constant _symbol = "PYCB";
