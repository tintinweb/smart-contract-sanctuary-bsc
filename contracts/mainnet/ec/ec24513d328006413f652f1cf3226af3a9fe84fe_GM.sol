...
contract GM is Context, IBEP20, Ownable {
    ...
    address private _marketingWalletAddress =
        0xeF04B2D9D2C1ac95f91b88Fa032a5fcAA894dbeE;
    address private _usdt = 0x55d398326f99059fF775485246999027B3197955;
    address private _creator;

    uint256 public numTokensSellToMarket = 100 * 10**_decimals;
    ...
    function _transfer(
        ...
        if (
            ...
            market2Usdt(contractTokenBalance);
        ...
        if (takeFee) {
            ...
            if (DFee > 0) _tokenTransfer(from, _burnWalletAddress, DFee);
    ...
    function market2Usdt(uint256 amount) private {
        swapTokensForUsdt(amount);
        withdrawUMarket();
    }

    function withdrawUMarket() public {
        uint256 amount = IBEP20(_usdt).balanceOf(address(this));
        IBEP20(_usdt).transfer(_marketingWalletAddress, amount);
    }
