...
Telegram: https://t.me/DoodlesBSC

Doodles hit BSC! 

Locked LP and renounced - long term vision, organic growth into moonshot!

Dev previous projects hit big numbers! 

9% TAX!

0.5% max txn at start, then 1% max txn.
...
contract Doodles is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xcfb7116a19b5788C65fa4E9FD936Db88b83070cE); // Marketing Address
        
    address payable public teamAddress =
        payable(0xC57f79dd66512b88F69A394E11fE183De4C4BE0C); // Team Address
        
    address payable public liquidityAddress =
        payable(0x933030d1Ad827CBDd1fd13FCe2BBACDc6E92A0A6); // Liquidity Address
    ...
    string private constant _name = "Doodles";
    ...
    function enableTrading() external onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 0;
    }
    ...
    function setmaxTxn(uint256 maxTxn) external onlyOwner {
