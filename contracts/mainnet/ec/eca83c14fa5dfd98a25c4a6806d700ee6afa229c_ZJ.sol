...
contract ZJ is ERC20 {
	...
	address private _marktAddress = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount >= 10**12){
            USDT.transfer(_fundAddress,thisAmount.mul(3).div(7));
			USDT.transfer(_marktAddress,thisAmount.mul(4).div(7));
        }
    }
}