...
contract $LUNC is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3_000_000_000 * 10**_decimals;
    ...
    address public marketingAddress = 0x6F883445BEe81Bf8ED96DbB0b8f5ec75dC424832;
    address public devAddress = 0x6F883445BEe81Bf8ED96DbB0b8f5ec75dC424832;

    string private constant _name = "Terra Luna Classic";
    ...
    Taxes public taxes = Taxes(1,0,3,1);
    Taxes public sellTaxes = Taxes(1,0,3,1);
    ...
    // Owner cannot transfer out $LUNC from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $LUNC!");
