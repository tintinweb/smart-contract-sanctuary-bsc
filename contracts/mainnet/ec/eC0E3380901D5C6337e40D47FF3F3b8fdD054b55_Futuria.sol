...
contract Futuria is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Futuria", "FUTURIA") {
        ...
        address[18] memory addressList = [
            0x88c6c349458466b9b2e87A56e64FD59604B7f7C1, // Eagle
            address(0),
            0xc0C3CE0C4791e573fFb978e951F55463aD0d4A30, // SISIYQEN
            ...
            SXZEWWRV, // SXZEWWRV
            address(0),
            0x7d096F8E9C1ff08b7AE0EF7b0FA22CB0270763Cf, // Twolions
