...
// 
//
// 📱 Telegram:https::https://t.me/MudraProtocol
//
...
contract $MudraProtocol is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("MudraProtocol", "MudraProtocol") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "MudraProtocol";
    string private _symbol = "MudraProtocol";
