...
contract AngPao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ang Pao";
    string private _symbol = "ANGPAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4d38B18002B0c83D99eD9DBe65e37404db9B9ACC); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x4d38B18002B0c83D99eD9DBe65e37404db9B9ACC); // Development Address
