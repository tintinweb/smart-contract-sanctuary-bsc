...
contract WorldCupDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name   = "WorldCupDoge";
    string constant _symbol = "WCDOGE";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100_00_00 * (10 ** _decimals);
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerCybleBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
