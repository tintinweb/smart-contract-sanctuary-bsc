...
The REAL Squid Game is the one that you are searching for

There is NO LOCK

Liquidity WILL BE PULLED, but not soon... a Squid Game rugpull needs to be epic.

Tax is very low and the community must shill this privately.

When jeets sell, buy their dip. That is, if you are feeling lucky.
...
contract TheRealSquidGame  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'The Real Squid Game';
