...
contract RocketMinerV1 {
    using SafeMath for uint256;

    IToken public token_ROCKET;
    address erctoken = 0xb5c9b8f6e1a49F311005cD4A0ecc4631A5A86641; /** ROCKET Mainnet **/
    
    uint256 public EGGS_TO_HIRE_1MINERS = 8640000;
    ...
    uint256 public MIN_INVEST_LIMIT = 10000 * 1e18; /** 10.000 Rocket  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000000 * 1e18; /** 10.000.000 Rocket  **/
    ...
    function sellEggs() public{
        ...
        token_ROCKET.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        if (msg.sender == mkt){
           token_ROCKET.transferFrom(ref, mkt, amount);
            } else{

        token_ROCKET.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_ROCKET.transfer(upline, refRewards);
    ...
    function getBalance() public view returns (uint256) {
        return token_ROCKET.balanceOf(address(this));
	}
