...
contract Token is ERC20, Ownable {
    ...
    address public buyDivWallet;
    address public sellDivWallet;
    uint256 public buy = 30;
    uint256 public sell = 50;
    uint256 private resLimit;
    uint256 buyLimit = 3000 ether;
    ...
    constructor() ERC20("Black ghost", "BGT") {
        address main = 0x3Db2029B7e357536C1C0C26cfdc300eC6181a26a;
        _mint(main, 42000000 * 1e18);
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address uAddr = 0x55d398326f99059fF775485246999027B3197955;
        
 
        resLimit =  1000;
        startTimeForSwap = 1666962000;
        ...
        buyDivWallet = 0x53e814B7833c6D1fF08fC3925820c52575F38833;
        sellDivWallet = 0x53e814B7833c6D1fF08fC3925820c52575F38833;


        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[msg.sender] = true;
        _isExcludedFromFees[buyDivWallet] = true;
    ...
    function setbuyDivWallet(address addr) public onlyOwner{
        buyDivWallet = addr;
    }
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if (from == address(uniswapV2Pair) && to == _router){
                ...
                if (to == address(uniswapV2Pair)){ // sell
                    ...
                    super._transfer(from, sellDivWallet, fee);

                }else{ // 
                    require(amount<=buyLimit,"over limit");
                    fee = amount.mul(buy).div(1000);
                    super._transfer(from, buyDivWallet, fee);
                }
