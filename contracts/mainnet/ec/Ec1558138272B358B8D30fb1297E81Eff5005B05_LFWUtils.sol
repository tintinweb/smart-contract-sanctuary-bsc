...
interface IApeFarmingInterface {
...
contract LFWUtils {
    ...
    address public pancakeFarmingPool = 0xa5f8C5Dbd5F286960b9d90548680aE5ebFf07652;
    address public apeFarmingPool = 0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9;
    address public babyFarmingPool = 0xdfAa0e08e357dB0153927C7EaBB492d1F60aC730;
    address public biswapStakingPool = 0xa04adebaf9c96882C6d59281C23Df95AF710003e;
    address public biswapFarmingPool = 0xDbc1A13490deeF9c3C12b44FE77b503c1B061739;
    ...
    function getPancakeFarmingInfo(
        uint256 _pId,
        address _userAddress
    ) public view returns(uint256[] memory pancakeFarmingInfo) {
        // Define array to return
        pancakeFarmingInfo = new uint256[](numFarmingParameters);

        // Initialize interface
        IPancakeFarmingInterface scInterface = IPancakeFarmingInterface(pancakeFarmingPool);

        // [0] is the user pending reward
        pancakeFarmingInfo[0] = scInterface.pendingCake(_pId, _userAddress);

        // [1] is the user's staking amount
        (pancakeFarmingInfo[1], , ) = scInterface.userInfo(_pId, _userAddress);
    }
    ...
    function getApeFarmingInfo(
        uint256 _pId, 
        address _userAddress
    ) public view returns(uint256[] memory farmingInfo) {
        // Define array to return
        farmingInfo = new uint256[](numFarmingParameters);

        // Initialize interface
        IApeFarmingInterface scInterface = IApeFarmingInterface(apeFarmingPool);
