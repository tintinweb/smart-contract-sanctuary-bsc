...
contract BUSDAI is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x6db867083f8c14A66FC27abF6a2B51e7529C0f72;

    string constant _name = "BUSD AI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf41975891f49f26125c3cBAaf90bf52fa030008a;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(Go_Live,"Trading not open yet");
        }


        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != address(DEV)){
    ...
    function Go_Live_(bool _status) public onlyOwner {
        Go_Live = _status;
    }
