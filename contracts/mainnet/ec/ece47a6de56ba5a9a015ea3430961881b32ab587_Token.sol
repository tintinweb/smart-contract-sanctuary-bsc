...
contract Token is ERC20Detailed, Ownable {
    ...
    string public _name = "Ready Player One";
    string public _symbol = "RPO";
    ...
    uint256 public liquidityFee = 60; //6% 回流
    uint256 public inviteFee = 40;//4%邀请奖励
    uint256[] public REFERRAL_PERCENTS = [40, 20, 5, 5, 5, 5, 5, 5, 5, 5];

    uint256 public treasuryFee = 30;//3% 基金会
    uint256 public consensusFundFee = 0;//0% 回流
    uint256 public daoFee = 50;//3% 合伙人
    uint256 public firePitFee = 20;//2% 销毁
