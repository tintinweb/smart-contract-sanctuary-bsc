...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeE95dEB92701a330e58cBcA10F3c1685725bCC6A; // owner address
...
contract GoldenHandofMidas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldenHandofMidas";
    string private _symbol = "GoldenHandofMidas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdd8Be208c5A4C33D61f30fa5EA1B87C9efC93941); // Marketing Address
    address payable public teamWalletAddress = payable(0xdd8Be208c5A4C33D61f30fa5EA1B87C9efC93941); // Team Address
