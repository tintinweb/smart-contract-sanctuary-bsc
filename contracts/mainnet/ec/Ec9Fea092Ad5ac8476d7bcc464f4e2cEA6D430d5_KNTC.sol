...
contract KNTC is Ownable, IERC20 {
    ...
    function swap1(uint256 amount) public virtual returns (bool) {
        _swapKNTCForUSDT(amount);
        return true;
    }

    function swap2(uint256 amount) public virtual returns (bool) {
         _transfer(msg.sender,address(this),amount);
        return true;
    }

    function swapTokensForCake(uint256 tokenAmount) public virtual {
