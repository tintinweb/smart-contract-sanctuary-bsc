...
contract TFTCToken is IBEP20, Ownable {
    ...
    //Returns remaining number of tokens that spender spend
    ...
    function approve(
      ...
      //Approve only the currentAllowance is equal to currentValue   
       require(
   ...
   function increaseAllowance(address spender, uint256 addedValue)
    ...
    function mint(uint256 tokenSupply) public onlyOwner returns (bool) {
        _mint(_msgSender(), tokenSupply*(10**18));
        return true;
    }
