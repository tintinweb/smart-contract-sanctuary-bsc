...
Cows have Tails, They Swish


https://t.me/cowtail

We were the OG Larps with Cat Arm, the first and the best, coming back one more time.
...
contract CowTail is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Cow Tail';
    ...
    uint256 private gasLimit = 8100000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0xb531183c9954D917639D8922BFA51262CcB3431E);
    address public Marketing=payable(0xb531183c9954D917639D8922BFA51262CcB3431E);
    //MainNet
    ...
    uint256 currentAmountToSwap = 380000 * 10**_decimals;
