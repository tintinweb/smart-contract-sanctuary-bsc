...
contract WakaWaka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Waka Waka"; // 
    string private constant _symbol = "$WW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC8B0B0Ef2CD13Eb4ab2aB0b4D22B08771734ad2a;
