...
contract GREENBABYFLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x934122866874C6494Ab837473e8b69F4b112c510); // Marketing Address
    address payable public charityAddress = payable(0xF7744e328C36878DdDEcfA4Fd962A0972bA6E26b); // Charity/Dev Address
    ...
    string private _name = "GREEN BABY FLOKI";
    string private _symbol = "GBFLOKI";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 3000000000000000000000; // 3,000 token will be given on airdrop
    ...
    uint256 private salePrice = 1000000;// 0.01*1000000=10,000 token for 0.01 bnb (set as per requirements)
