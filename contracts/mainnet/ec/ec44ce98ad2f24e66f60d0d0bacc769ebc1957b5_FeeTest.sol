...
contract FeeTest is ERC20, Ownable {
    ...
    FeeTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("FeeTest", "FT") {
        marketingWallet = payable(0xee843184aff083Cb4D9a5DF50edB8760702238b7);
        ...
        dividendTracker = new FeeTestDividendTracker(
            payable(this),
            router,
...
contract FeeTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    FeeTest public FeeTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        FeeTestContract = FeeTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "FeeTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "FeeTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FeeTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(FeeTestContract);

            uint256 prevBalance = FeeTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = FeeTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    FeeTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
