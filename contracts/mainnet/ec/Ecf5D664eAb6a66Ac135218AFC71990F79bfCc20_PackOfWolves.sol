...
contract PackOfWolves is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pack of Wolves";
    string constant _symbol = "PWT";
    ...
    uint256 _totalSupply = 23 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x1FB1B4705b7886Ae879816F994b279AF7a27c86d;
        marketingWallet = 0xD9eb60007a469b045a6a1b92BD6aAC516b54EA2c;  // marketingwallet
        teamWallet = 0x0fa74a80711f84582F5fcfAf3E82e42D13c5b0B7;  // team
