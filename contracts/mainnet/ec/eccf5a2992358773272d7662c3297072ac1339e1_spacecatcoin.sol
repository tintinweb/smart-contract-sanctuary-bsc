...
library Address{
 ...
 contract spacecatcoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0e3e5e024534B7E94a4e072245AfAC5641E90587;
    address public donationWallet = 0x0e3e5e024534B7E94a4e072245AfAC5641E90587;



    string private constant _name = "SPACE CATCOIN";
    string private constant _symbol = "SpaceCAT";
    ...
    Taxes public sellTaxes = Taxes(0, 18, 2, 0);
