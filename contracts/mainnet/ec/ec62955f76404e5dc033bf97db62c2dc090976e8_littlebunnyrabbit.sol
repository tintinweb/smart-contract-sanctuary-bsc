...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78EE843740342DB891F95c467823e5138A182f70; // owner address
...
contract littlebunnyrabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Little Bunny Rabbit";
    string private _symbol = "$LBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78EE843740342DB891F95c467823e5138A182f70); // 
    address payable public teamWalletAddress = payable(0x78EE843740342DB891F95c467823e5138A182f70); // 
