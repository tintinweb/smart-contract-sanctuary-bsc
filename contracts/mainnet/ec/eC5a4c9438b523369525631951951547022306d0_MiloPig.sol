...
contract MiloPig is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiloPig";
    string private _symbol = "MiloPig";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71e83aa85205Fe138BA2b48c45A00d364bC25B57);
    address payable public teamWalletAddress = payable(0x71e83aa85205Fe138BA2b48c45A00d364bC25B57);
