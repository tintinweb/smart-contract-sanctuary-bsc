...
/*
AI LAUNCH
A multifaceted launchpad specialising in Artificial Intelligence.
THE FUTURE OF CRYPTO IS HERE
Welcome to the AI LAUNCH community! The NEW HOME for AI Crypto Launches. We want to make sure that everyone has a chance to get involved in the new and exciting AI industry. 
It’s with this mission statement in mind that we set out to build the new home for AI Crypto Launches right here on AI LAUNCH.
*/
...
contract AILAUNCH  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'AI LAUNCH';
