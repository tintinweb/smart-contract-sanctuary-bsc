...
contract Kennedy is Context, IERC20, Ownable {
    ...
    string private _name = "Kennedy";
    string private _symbol = "Kennedy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x203459312511c2c85F1eb1fD78Ab2463506cF49B); // Marketing Address
    address payable private teamWalletAddress = payable(0x203459312511c2c85F1eb1fD78Ab2463506cF49B);
