...
1BNB Initial Lp&Locked

No telegram , socials on the way.
...
contract Mojiba  is IBEP20, Auth {
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingBFeeReceiver = 0xF1158cFE1Ef413549F1F7A064292d571D6A9425E;
    ...
    function setFees(
        ...
        require(_totalFee <= 30 && _totalSellFee <= 30 && _totalTransferFee <= 30);
        totalFee = _totalFee;
