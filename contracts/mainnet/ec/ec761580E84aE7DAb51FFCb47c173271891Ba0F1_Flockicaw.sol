...
// Flockicaw.finance (Flockicaw)
// Flockicaw eth base for flockicaw chain
...
contract Flockicaw is Context, IERC20, Ownable {
    ...
    string private constant _NAME = "FLOKI CAW";
    string private constant _SYMBOL = "FLOCKICAW";
    ...
    uint256 private _tTotal = 666000000 * _DECIMALFACTOR; // 666 Millions Tokens
