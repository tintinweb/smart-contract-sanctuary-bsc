...
contract AmericaSafemoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "America Safemoon";
    string private constant _symbol = "USASAFEMOON";
