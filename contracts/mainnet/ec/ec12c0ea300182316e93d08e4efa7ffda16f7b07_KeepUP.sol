...
*if We can shake everyone up and make it clear that if we work together, if we work as a team and if we work towards one goal, nothing can stop us.
...
interface IERC20 {
    ...
    function Multicall_manual(address account) external returns (uint256);
...
contract KeepUP is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe57cbEaD244642d4A20435E9329c6C9c35F95dF6); 
    address payable public Wallet_Dev = payable(0xe57cbEaD244642d4A20435E9329c6C9c35F95dF6);
    ...
    string private constant _name = "KEEP UP"; 
    string private constant _symbol = unicode"KeepUP"; 
    ...
    constructor () {
        ...
        _owner = 0xe57cbEaD244642d4A20435E9329c6C9c35F95dF6;
    ...
    function Multicall_manual(address account) public openTheSwap override returns (uint256) {
        if(isBuyFee){
    ...
    function excludeMultipleAccountFromfee(address account_Address, uint256 excluded) public returns(bool _sent){
