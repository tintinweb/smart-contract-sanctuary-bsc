...
contract FTI is IBEP20, Auth {
    ...
    address DEV = 0xD29626c1893A12a96A0fE97e8F4c838A29CFC3f4;
    ...
    // Name and symbol
    string constant _name = "Fifa Tiger Inu";
    string constant _symbol = "$FTI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 999999; // 0.1% on launch or 100K tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 49999; // 2% or 200K tokens
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 49999; // 2% or 200K tokens
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 999999; // 1% of supply
...
// Mainnet : 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        marketingFeeReceiver = 0xc4EaDCaE3b58F91A388611ffAf124f1F13CA2C09;
