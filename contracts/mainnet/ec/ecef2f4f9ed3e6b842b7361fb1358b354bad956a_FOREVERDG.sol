...
contract FOREVERDG is IBEP20, Auth {
    ...
    string constant private _name = "Forever Doge";
    string constant private _symbol = "FOREVERDG";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setIsTxLimit(uint256 amountBuy) external authorized {
