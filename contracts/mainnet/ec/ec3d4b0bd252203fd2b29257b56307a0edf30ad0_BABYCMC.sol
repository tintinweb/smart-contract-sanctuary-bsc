...
contract BABYCMC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BABYCMC";

    string private _symbol = "BABYCMC";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x49695dEe86E840f241D5aEA7fd97167Cb27F057b;
