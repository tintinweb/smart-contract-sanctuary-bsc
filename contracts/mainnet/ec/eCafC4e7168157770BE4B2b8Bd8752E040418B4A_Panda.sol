...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable,Ownable {
    ...
    returns (string memory)
  {
    ...
    */
    ...
    mapping(uint256 => uint256) public PandaCount;

    // Map the number of tokens burnt per PandaId
    mapping(uint256 => uint256) public PandaBurnCount;
    ...
    function mint(address _to,uint256 _tokenId) external override onlyManager(){
        ...
        _tokenIds.increment();
        PandaCount[_tokenId] = PandaCount[_tokenId].add(1);
...
contract Panda  is ERC721    {
    ...
    constructor() public ERC721("csNFT", "CSNFT") {
    }
