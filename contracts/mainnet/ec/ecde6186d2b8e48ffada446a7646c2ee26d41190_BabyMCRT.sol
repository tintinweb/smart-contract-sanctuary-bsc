...
contract BabyMCRT is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xfC11aBDDcE86B826CD66677998F4B4898F4E4E9D;

    string constant _name = "Baby MCRT";
    string constant _symbol = "BBMCRT";
