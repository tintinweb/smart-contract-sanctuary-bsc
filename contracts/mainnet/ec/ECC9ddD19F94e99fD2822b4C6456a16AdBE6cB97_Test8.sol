...
contract Test8 is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = 10000000 * 10**18; // 1% maxTx for sell
    uint256 public _maxWalletSize = 10000000 * 10**18; // 1% maxWallet
    ...
    string private _name = "Test8";
    string private _symbol = "Test8";
    ...
    address public charityWallet = 0xB695453a011041db632A43B1000FE239fCC7b818;
