...
contract Donkey is IERC20 {
    ...
    string constant private _name = "Donkey";
    string constant private _symbol = "$Donkey";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6e8627D2C3Cc0167e0F0D3D84E5ce3cE6203F0f7),
        development: payable(0xF464bFF322cF344b9980d5EC7f4dbF6e05Ccfed2)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 burn, uint16 liquidity, uint16 marketing, uint16 development) external onlyOwner {
        _ratios.burn = burn;
