...
interface IERC20 {
    ...
    /**
     * @dev Moves `amount` tokens from the caller's account to `recipient` sign xgll-bihai.
     *
...
contract DOP is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 999 * 10 **18;
    ...
    address public _ownerAddress = address(0x4c608b71D75f0546961029e14C891a9aAb6eD766);
    address public _devAddress = address(0xC0869662dCb66341f6C85e7B3B3E98f0eEe9f1E6);
