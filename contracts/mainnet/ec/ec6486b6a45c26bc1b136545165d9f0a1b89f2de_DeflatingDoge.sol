...
contract DeflatingDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Deflating Doge";
    string private _symbol = "DEDOG";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x9Dd357e8A576983F7711D7CD8F816f2018Ab2F16; // Marketing
    address public _BuybackWalletAddress = 0xF1734ce728660D63E5Af853a173628Ec7fc69946; // Buyback to DEFLATE
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (2 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0x9Dd357e8A576983F7711D7CD8F816f2018Ab2F16)).call{value: dev_part, gas: 30000}(""); // Prioritises Marketing Wallet for first 48h
        }
