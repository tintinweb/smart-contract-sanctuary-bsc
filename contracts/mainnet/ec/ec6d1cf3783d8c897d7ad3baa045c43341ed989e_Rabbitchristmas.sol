...
/**
Telegram : https://t.me/rabbitchristmasbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x624AD949bCA11B4ee2A8f8Ca693d1ffd73Fd4960; // owner address
...
contract Rabbitchristmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Christmas";
    string private _symbol = "Rabbitmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x624AD949bCA11B4ee2A8f8Ca693d1ffd73Fd4960); // Marketing Address
    address payable public teamWalletAddress = payable(0x624AD949bCA11B4ee2A8f8Ca693d1ffd73Fd4960); // Team Address
