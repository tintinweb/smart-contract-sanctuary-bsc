...
contract Honeyclub is HoneyclubDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HoneyclubTeam;
    address private CharityHoneyclub;
    ...
    string public override name = "Honeyclub";
    string public override symbol = "Honeyclub";
    ...
    constructor(uint totalSupplyValue, address HoneyclubTeamAddress, address CharityHoneyclubAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HoneyclubTeam = HoneyclubTeamAddress;
        CharityHoneyclub = CharityHoneyclubAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HoneyclubTeam] =  totalSupply * 4 / 100;
        balances[CharityHoneyclub] = totalSupply * 4 / 100;
