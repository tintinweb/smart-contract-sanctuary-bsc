...
https://t.me/KaijuGrow  

The Kaiju Grow creed is to create, protect, and rule together.
We aim to help in the development of Web3 and other creatives, 
focusing on the NFT and meme token ecosystem in particular.
...
contract KaijuGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kaiju Grow";
    string constant _symbol = "KROW";
