...
/**
                ...
                Telegram - https://t.me/discolifestyle
                Website - https://disco.tech
...
contract DISCOLIFESTYLE is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0x768fD58D832AcB4F415f562Fa150F3604D80c0a7);
    address public DevelopmentWallet =
        0x8Ba857c714389f8074FeEA5e9AECCBABA9559Ffe;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 1 * 10**10 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Disco Lifestyle";
    string private constant _symbol = "DISCON";
    ...
    uint256 public _maxWalletHoldingLimit = 30 * 10**6 * 10**18;
