...
contract WorldCupCommunity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "World Cup Community";
    string private _symbol = "$WCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbF77438d44b58EB3184b5180Ce7458Be3A259cB5); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xF97492c6C9481072990a420C59c95206F38b45Fc); // Development Address
