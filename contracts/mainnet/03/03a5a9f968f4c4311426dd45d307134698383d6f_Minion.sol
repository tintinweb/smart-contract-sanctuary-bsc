...
contract Minion is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x317D2a484A491D293048a7934071424d9946A47a;

    string private constant _name = "Minion INU";
    string private constant _symbol = "MININU";
    ...
    Taxes public taxes = Taxes(1,2,5,0);
