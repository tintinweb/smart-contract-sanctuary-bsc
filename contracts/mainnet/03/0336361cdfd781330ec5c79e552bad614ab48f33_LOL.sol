...
contract LOL is ERC20 {
	...
	address payable _receive = payable(address(0x0000000000000000000000000000000000000000));
	address private _destroyAddress = address(0x0000000000000000000000000000000000000000);
    address private _fundAddress = address(0xE71d6b0a5E02ec2A76c91E5a1f487172Fdf5e3b6);
    address private _markAddress = address(0x715A99Ec95987c16257699d06a86156A3581Fb1d);
    ...
    constructor(address tokenOwner) ERC20("lol", "lol") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, _markAddress, amount.div(50));
            super._transfer(from, address(this), amount.div(20).mul(3));
