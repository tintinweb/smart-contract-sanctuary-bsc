...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xAF24d920b50eD21f54311447347bF3d0D0382715;
...
contract cronks is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"The Crypto Stonks"; 
    string private constant _symbol = unicode"CRONKS"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xAF24d920b50eD21f54311447347bF3d0D0382715), BNB_Tot);
            }
