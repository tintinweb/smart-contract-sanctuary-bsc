...
contract PIGEMOO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIGE MOO";
    string private _symbol = "PIMOO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb6607654837B3bb0Bc084e88Bfaa14265ac9B208); // Marketing Address
    address payable public teamWalletAddress = payable(0xb6607654837B3bb0Bc084e88Bfaa14265ac9B208); // Team Address
    ...
    function Caesarlist(address[] calldata addresses) external onlyOwner {
