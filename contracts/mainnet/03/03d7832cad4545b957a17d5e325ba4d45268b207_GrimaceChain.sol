...
contract GrimaceChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrimaceChain";
    string private _symbol = "GRICHAIN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2312B9aB64A793493EFA29e64188E3e6E51aBB14);
