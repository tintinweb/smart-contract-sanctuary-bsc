...
/**
    Pumpkin inu is a cryptocurrency token Base on Binance Smart Chain (BEP-20),
    Fully Decentralized And Driven By Community and to Bring spirit halloween into BSC Play
    https://t.me/FrankensteinInu
    https://twitter.com/PumpkinInuBSC
...
contract PumpkinInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x222C3Bd0383a39D65c61fAf2430a0F6773d286fA); // Marketing Address
    address payable private developmentWalletAddress = payable(0xd5fF6Bb4C0b214CE25eca928FEA28Be9C19DF9aB); // Development Address
