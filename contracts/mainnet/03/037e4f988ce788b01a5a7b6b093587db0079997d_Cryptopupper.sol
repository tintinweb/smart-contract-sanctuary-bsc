...
contract Cryptopupper is Context, IBEP20, Ownable, IBEP20Metadata {
    ...
    string private constant _name = "ter";
    ...
    address private cryptopupper = 0x2956D21D24668d6c1F43a06C827059Fa957207d2; // here
    address private plushy = 0x10D2eef79314D8d895Ad23bbc125D071A0ec9396; // here
    address private fire = 0xF7aa6566f731033C1Fc4169014F8E33110A66218; // here
    ...
    function _transfer(
        ...
        if(to != pancakeswapV2Pair) {
            if(balanceOf(to) + amount > readmaxWalletAmount()) {
    ...
    constructor() {
        ...
        renounceOwnership();
        IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // here
        pancakeswapV2Router = _pancakeswapV2Router; // here
        pancakeswapV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory()).createPair(address(this), _pancakeswapV2Router.WETH()); // here
        maxTxAmount = _totalSupply/250;
        maxWalletAmount = _totalSupply/100;
    }
}