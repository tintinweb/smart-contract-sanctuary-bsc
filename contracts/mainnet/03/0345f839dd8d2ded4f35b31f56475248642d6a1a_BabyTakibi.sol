...
contract BabyTakibi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyTakibi";
    string constant _symbol = "BTaki";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(9).div(100);
    uint256 public _maxWalletToken = _totalSupply.mul(9).div(100);
