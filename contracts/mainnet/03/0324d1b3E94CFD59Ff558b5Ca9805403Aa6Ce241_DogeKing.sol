...
contract BaseToken is Ownable {
    ...
    string constant public name = "DogeKing";

    string constant public symbol = "DogeKing";
    ...
    address public projectAddress = 0x386c8827B5Df060D74DeAa1d1b0707D60649Bd8b;
...
contract DogeKing is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0x386c8827B5Df060D74DeAa1d1b0707D60649Bd8b;
