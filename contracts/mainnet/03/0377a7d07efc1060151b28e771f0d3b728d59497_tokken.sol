        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x26ddc908D4fF7467D87184d1D0Af5c4e248E226F), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x26ddc908D4fF7467D87184d1D0Af5c4e248E226F),//
        address(0x26ddc908D4fF7467D87184d1D0Af5c4e248E226F)//
    ){
    }
}