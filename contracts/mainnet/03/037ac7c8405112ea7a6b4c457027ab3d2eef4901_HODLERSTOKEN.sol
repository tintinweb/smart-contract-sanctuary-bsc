...
contract HODLERSTOKEN is IBEP20, Auth {
    ...
    string constant _name = "Hodler Inu";
    string constant _symbol = "HODLER";
    ...
    uint256 public sellMultiplier  = 200; // Double sell tax first 30 mins
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf9a13aFCA1bd6b259b163619Ad0bF2c57B29181d;
        teamFeeReceiver = 0xc17ff93BBCBD63D4f08Ec5D3CA3B31dEF80ab01E;
        devFeeReceiver = 0x2C1CE68E78be3091544AF25FEc2a498c38534009;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBTreasury = amountBNB.mul(teamFee).div(totalBNBFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBTreasury, gas: 30000}("");
