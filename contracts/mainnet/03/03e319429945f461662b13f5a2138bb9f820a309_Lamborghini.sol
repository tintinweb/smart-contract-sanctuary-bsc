...
contract Lamborghini is Context, IERC20, Ownable {
    ...
    using Address for address;
     ...
     address payable public marketingAddress = payable(0x52945ECD41f9ef98f6F850865eC80Cf1F228eC3a); // Marketing Address
    ...
    uint256 private _tTotal = 20220000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lamborghini";
    ...
    uint256 public _maxTxAmount = 20220000000000 * 10**2 * 10**9;
