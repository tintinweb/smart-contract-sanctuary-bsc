...
contract WOWINU is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x522FbFA615d3FD7c58a6001dfb6E5dEce4B37618);
    address payable private _twdmkt = payable(0x522FbFA615d3FD7c58a6001dfb6E5dEce4B37618);
    
    string private constant _name = "WOW INU";
