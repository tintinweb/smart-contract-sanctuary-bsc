...
contract Coming
 is Context, IERC20, Ownable {
    ...
    string private _name = "Coming";
    string private _symbol = "Coming";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4E584b4b29B451A2533a7Bba73E65f3151865a9B));
        _anotherA = payable(address(0x4E584b4b29B451A2533a7Bba73E65f3151865a9B));
