...
interface IDEXRouter {
 ...
 contract LETI is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "LETI";
    string constant _symbol = "LETI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1800000000000 * (10 ** _decimals);
    ...
    address public donateFeeReceiver = 0xf4DAf1505653720Eea46094ad4bfc33736677A2b;
    address public marketingFeeReceiver = 0xf4DAf1505653720Eea46094ad4bfc33736677A2b;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdonate = amountBNB.mul(donateFee).div(totalBNBFee);


        (bool donateSuccess, /* bytes memory data */) = payable(donateFeeReceiver).call{value: amountBNBdonate, gas: 30000}("");
        require(donateSuccess, "receiver rejected ETH transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _donateFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        donateFee = _donateFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_donateFee).add(_marketingFee);
    ...
    function setFeeReceiver(address _donateFeeReceiver, address _marketingFeeReceiver) external authorized {
    ...
    function transferForeignToken(address _token) public authorized {
        ...
        payable(donateFeeReceiver).transfer(_contractBalance);
    }
