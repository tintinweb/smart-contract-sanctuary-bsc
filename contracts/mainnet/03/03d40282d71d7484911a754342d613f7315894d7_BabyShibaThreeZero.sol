...
🐶Baby Shiba 3.0🐶 under Binance Smart Chain building the next moonshot! 
 
Baby Shiba Deployer:  
💠 Experienced Dev 
💠 Tokenomics Designed to hold the floor via LP Building and drive product and hype!  
💠 Manual Buy Back from Team 
💠 Marketing Decisions and Project Direction is driven by community feedback 
 
Tokenomics 5% Tax Buy/Sell 
💠 2% Marketing 
💠 2% Liquidity 
💠 1% Development 

Telegram: https://t.me/BabyShibaThreeZero
...
contract BabyShibaThreeZero is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Shiba 3.0"; // 
    string private constant _symbol = "BShiba 3.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1d53bcA1F2297BB054Eca07e8be7B47B25b04b23;
