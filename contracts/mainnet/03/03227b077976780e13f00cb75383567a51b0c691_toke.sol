...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xC05d71d7F06F746C3f1F0038275ac1EdA6A23b49;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xC05d71d7F06F746C3f1F0038275ac1EdA6A23b49),//fund address
    
        address(0xC05d71d7F06F746C3f1F0038275ac1EdA6A23b49)//dev address
    ){
