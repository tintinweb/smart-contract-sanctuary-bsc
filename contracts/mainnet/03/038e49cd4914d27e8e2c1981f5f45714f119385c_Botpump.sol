...
contract Botpump is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bot Pump"; // 
    string private constant _symbol = "BOTPUMP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xA9C26a8D9B7A8f829dC8FB0CBaeBb09CB1eF5531;
