...
*  LOWCAP TOKEN
*  JOIN OUR COMMUNITY!
*  Telegram : https://t.me/HappyMothersDayofficial
* 
*/
...
contract HappyMothersDay is IBEP20, Auth {
    ...
    address private marketingFeeReceiver = 0xb1f8faefa7EE714B94ec4B1575CD4C24174EBDCb;
    address private developmentFeeReceiver = 0xb1f8faefa7EE714B94ec4B1575CD4C24174EBDCb;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 8;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        isTimelockExempt[developmentFeeReceiver] = true;
    ...
    function Name1() external authorized {
        ...
        _name = "HappyMothersDay";
        _symbol = "HappyMothersDay";
        nameCreated = true;
    }
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + _numberOfBlock >= block.number){ return feeDenominator.sub(1); }
    ...
    function setNumberOfBlocks(uint8 blockNumbers) external authorized {
