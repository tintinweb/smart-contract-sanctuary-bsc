...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88732B890e3DC573763F32b4dF8EeF45396c4a07;
...
contract Diaswap is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe9F92B209307e6308D315e106b47651CB80df7e2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Diaswap";
    string private _symbol = "Dswp";
