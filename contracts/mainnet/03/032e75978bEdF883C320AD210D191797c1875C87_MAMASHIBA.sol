...
https://www.mamashiba.io/
https://twitter.com/MamaShiba_Token
https://t.me/MamaShibaOfficial
https://www.instagram.com/mamashiba_official/
*/
...
contract MAMASHIBA is MAMASHIBADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MAMASHIBATeam;
    address private CharityMAMASHIBA;
    ...
    constructor(uint totalSupplyValue, address MAMASHIBATeamAddress, address CharityMAMASHIBAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MAMASHIBATeam = MAMASHIBATeamAddress;
        CharityMAMASHIBA = CharityMAMASHIBAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MAMASHIBATeam] =  totalSupply * 4 / 100;
        balances[CharityMAMASHIBA] = totalSupply * 4 / 100;
