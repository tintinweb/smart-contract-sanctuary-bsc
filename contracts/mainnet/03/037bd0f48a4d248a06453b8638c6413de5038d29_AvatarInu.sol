...
// True Burn contract fork! Audit
// TG      - https://t.me/AvatarInuBscc
// Twitter - https://twitter.com/AvatarinuBSC 
...
//Contract
contract AvatarInu is IBEP20, Ownable {
    ...
    string private constant _name = 'AvatarInu';  
    string private constant _symbol = 'AvatarInu';    
    ...
    //tax distribution
    uint8 private _devTax=60;
    uint8 private _burnTax=50;
    uint8 private _marketingTax=0;
    ...
    address public MarketingWallet = payable(0xe572592C155F38Edc681154a3a9F35899ABBCE56);     //This wallet has authorization and access to marketing funds
    address private Developer = payable(0xe572592C155F38Edc681154a3a9F35899ABBCE56);      //This is set to deployer and has access to developer funds
