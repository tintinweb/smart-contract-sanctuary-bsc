...
contract superFootball is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SuperFootball";
    string private _symbol = "SuperFootball";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0309283217d7Aa85d3a1103Ca338274181b3c123));
