...
contract ChihuahuaInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7 * 1e6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Chihuahua Inu";
    ...
    address public advertisementWallet =
        0xFd978Fcbc036f21f2B91759a6fE51b0A1a986c83;
    ...
    uint256 public _maxTxAmount = 7 * 1e6 * 10**18;
