...
//
// Squid Evil
// We here with the evil forces to bring BSC great again!
// 666
...
contract SQUIDEVIL is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Squid Evil";
    string private _symbol = "$SE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x546318A8e0A114C25C9Fccd0b3d00cB7668B0248);
    address payable public DevelopmentWalletAddress = payable(0x546318A8e0A114C25C9Fccd0b3d00cB7668B0248);
    ...
    uint256 private _totalSupply = 666666 * 10**9;
    uint256 public _maxTxAmount = 666666 * 10**9;
    uint256 public _walletMax = 666666 * 10**9;
