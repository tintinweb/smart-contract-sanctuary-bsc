...
contract TeamToken is Context, IERC20, Ownable {
    ...
    string private _name = "YFIzilla";
    string private _symbol = unicode"YFIzilla";
    ...
    uint256 private _maxTxAmount = 800000 * 10**_decimals;
    uint256 private _maxWalletSize = 800000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x376D94692BE28ee0D485e048aEb6701bFE0924fE));
        marketingWallet = payable(address(0x376D94692BE28ee0D485e048aEb6701bFE0924fE));
