...
/*
BearishBull
Gem token that was motivated by the current bearish market, BearishBull has a team of capable & experienced Dev & Programmers with excellent marketing plans. Aim to become one of the top gainer token that are rally on the bearish market, BearishBull is ready to stealth launch.

1. Experienced team on BSC
2. Pre-arranged marketing plans
3. Low tax 6% for buy & sell
4. Starting with low MC : $300
5. Easy 100x

Telegram : https://t.me/BearishBullOfficial
*/
...
contract BearishBull is Context, IERC20 { 
    ...
    string private constant _name = "BearishBull"; 
    string private constant _symbol = "BearishBull"; 
