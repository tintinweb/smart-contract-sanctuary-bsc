...
contract DogeXmas is IBEP20, Auth {
    ...
    string constant _symbol = "$DMAS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 4 / 1000; // 0.4%
    uint256 public _maxTxAmountSell = _totalSupply * 4 / 1000; // 0.4%
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 1000; // 0.5% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x8A3cbc28bd4C404b34E8752f99012DF837Eb8209;
