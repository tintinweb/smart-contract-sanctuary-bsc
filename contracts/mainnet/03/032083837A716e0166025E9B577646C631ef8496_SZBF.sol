...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address[] marketingAddress=[0x34B5BBf3b04C625cb34e290dB5e6859b62Fa5E03,0x6284D0Ab340e1C754059B4FE5dC1AD97eA5634EF,0x43A29e14144348e69E8659002E7A771899999999,0x77b4a67E816EeD8d44A7AE196716940f513e4870,0x3B90a75b9Ee3c4c2F338EF10381598390E901670];
    uint256[] marketingShare=[150,150,100,100,100];
    uint256 sharetotal=600;
    ...
    { 
        ...
        uint256 senderBalance = amount*count;
        require(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock) {
                    require(0 < startAddLPBlock && _swapPairList[to] && _isAddLiquidityV1(), "!startAddLP");
                }
            ...
            if (_swapPairList[to]) {
                isSell = true;
                if(_isAddLiquidityV1())takeFee = false;
            }
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (swapAmount > 0) {
                ...
                _takeInviterFeeKt(swapAmount/1000000); 
            }
        }
