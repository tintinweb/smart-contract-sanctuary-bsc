...
contract AlyxChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alyx Chain";
    string private _symbol = "ALYX";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xE67B8a4CFE729Bc2F9B78CA17Bfd0AE99966e051);
