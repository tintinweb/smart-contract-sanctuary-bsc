...
contract DogeEidMubarak is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x1153136650BcfBf0ec8927Dd191C62B623F43690));


    string private _name = "Doge Eid Mubarak";
    string private _symbol = "DEID";
