...
// CHANNEL: https://t.me/BillMurrayQuestionMark
...
contract BillMurrayQuestionMark is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BillMurray???";
    string private _symbol = "BillMurray???";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8913d112B10c34c893D3D3fd6c991bBbe62A95D0); // Marketing Address
    address payable public devWalletAddress = payable(0x8913d112B10c34c893D3D3fd6c991bBbe62A95D0); // Dev Address
    ...
    uint256 private _maxSellTxAmount = 2000 * 10**6 * 10**9;
...
//create a mapping to keep track of who is blacklist
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(devWalletAddress, amountBNBBuyBack);
