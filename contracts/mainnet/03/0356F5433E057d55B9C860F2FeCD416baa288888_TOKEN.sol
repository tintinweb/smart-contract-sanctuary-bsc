...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _cantOp;
    ...
    function seKillMulti(bool status) public onlyFunder{
        killMulti = status;
    }
    ...
    function _transfer(
        ...
        require(!_cantOp[from], "blackList");
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                //
                if (_swapPairList[from] && block.number < goMoonBlock + 10000 && killMulti){
    ...
    function manage_wl(address[] calldata addresses, bool status) public onlyFunder {
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        8888,
        address(0xA4DaF141D03f54e462D80fB72a6300A4A0d58888),
        address(0xA4DaF141D03f54e462D80fB72a6300A4A0d58888)
    ){
    }
}