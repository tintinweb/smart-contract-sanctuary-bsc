...
Telegram : https://t.me/SincereGrimaceCN
*/
...
contract SincereGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereGrimace";
    string private _symbol = "$SincereGrimace";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cb6E2364123884eb76D7ED2cC11df78b87B6dBc); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7cb6E2364123884eb76D7ED2cC11df78b87B6dBc); // BuyBack Address
