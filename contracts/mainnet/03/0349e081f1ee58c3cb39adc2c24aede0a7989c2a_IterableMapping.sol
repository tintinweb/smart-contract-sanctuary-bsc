...
contract  LiqProvider is Ownable{
    IERC20 mainToken;
    IERC20 liqToken;
    constructor(address _mainToken, address _liqToken){
        mainToken = IERC20(_mainToken);
        liqToken = IERC20(_liqToken);
    }

    function sweep() public onlyOwner{
        liqToken.transfer(address(mainToken),liqToken.balanceOf(address(this)));
    }

    function claimStuckTokens(address token,address receiver) public onlyOwner {
...
contract FXG is ERC20, Ownable {
    ...
    address public marketingGamingWallet = 0xe4af15254D73887A6F62Ff74EC8c5BDe476177B2;
    address public marketingWallet = 0x421C5602861aa7Db642548DD7ca895584C71A993; 
    ...
    LiqProvider public liqProvider;
    address public constant rewardToken = 0x55d398326f99059fF775485246999027B3197955;//USDT
    address public liqToken = 0x55d398326f99059fF775485246999027B3197955;
    IERC20 public USDT = IERC20(rewardToken);
    ...
    constructor() ERC20("FXG", "FXG") {
        address newOwner = 0x6B449b4a94d324956b51D36e593D21055FDd6FbE;
        ...
        liqProvider = new LiqProvider(address(this),rewardToken);
   ...
   function setAntiBotStatus(bool status) public onlyOwner{
    ...
    function liqProvider_ClaimStuckTokens(address token, address receiver) external onlyOwner {
        liqProvider.claimStuckTokens(token,receiver);
    }
    ...
    function setWhiteListedContract (address account, bool value) external onlyOwner {
        require(_isWhiteListedContract[account]!=value, "Account is alredy in this state");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(marketingShare > 0) {
                ...
                swapTokensForUSDT(marketingWallet,marketingTokens);
            ...
            if(marketingGamingShare > 0) {
                ...
                swapTokensForUSDT(marketingGamingWallet,marketingGamingTokens);
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        swapTokensForUSDT(address(liqProvider),otherHalf);
        liqProvider.sweep();
        uint256 afterBalance = USDT.balanceOf(address(this));
        uint256 newBalance = afterBalance-beforeBalance;
        addLiquidityUSDT(half,newBalance);
        emit SwapAndLiquify(half, newBalance, otherHalf);
    }

    function swapTokensForUSDT(address receiver, uint256 tokenAmount) public {
    ...
    function swapAndSendDividends(uint256 amount) private{
        swapTokensForUSDT(address(dividendTracker),amount);
        uint256 balanceRewardToken=USDT.balanceOf(address(dividendTracker));
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "gasForProcessing must be between 200,000 and 600,000");
