...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x213503534d927424A5cdf6d580E9Fd408be9337a);
    PCSRouter router;
...
contract FPSGrow is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "FPS Grow";
    string constant public symbol = "FPSGROW";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 4 / 1000;
    uint256 public _maxWalletToken = totalSupply * 4 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xeDE832739A21Decfd75ca491ed0a7b3f7635D69a;
        devFeeReceiver = 0xc2f570bC2E77852E8DDaFe1C52455A55e6119695;
