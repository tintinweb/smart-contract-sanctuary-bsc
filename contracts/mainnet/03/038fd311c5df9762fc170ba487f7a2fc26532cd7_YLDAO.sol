...
contract YLDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "YLDAO";
    string private _symbol = "YLDAO";
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.4000 * 10**18;
    uint256 public _maxWalletToken = 4000 * 10**18;
