...
contract SPZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space Pug Zilla";
    string private _symbol = "SPZilla";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xae06177EDf064b400Df57EfC69C383088170b1b1); // Marketing Address pac8
    address payable private TeamWallet = payable(0xADcE7D1Dc566B1A8d72E51dCCad35650c89D45F0); // Buy Back Address
    ...
    bool private GwBL = true;
    uint256 public endtime = 5;
    uint256 private feeTXtime;
    uint256 private GWEI = 9 * 1 gwei;
