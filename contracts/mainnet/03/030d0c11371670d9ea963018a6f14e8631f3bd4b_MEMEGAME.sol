...
contract MEMEGAME is IBEP20, Auth {
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_devFee).add(_rewardFee).add(_marketingFee);
