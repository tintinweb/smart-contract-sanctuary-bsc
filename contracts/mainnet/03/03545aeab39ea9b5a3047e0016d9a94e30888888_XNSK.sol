...
contract XNSK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-NSK";
    string private _symbol = "X-NSK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9EB500204455CCA48d07EcB9ed207053899B7dC4); 
    address payable public BurnedWalletAddress = payable(0x9EB500204455CCA48d07EcB9ed207053899B7dC4); 
