...
contract AgreedElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AgreedElon";
    string private _symbol = "$AGREED"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf79Fa6bE9e084E72B18A236252F2e3E290c27b61); 
    address payable public teamWalletAddress = payable(0xf79Fa6bE9e084E72B18A236252F2e3E290c27b61);
