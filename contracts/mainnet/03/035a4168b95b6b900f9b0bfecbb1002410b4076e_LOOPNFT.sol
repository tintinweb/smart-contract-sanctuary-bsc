...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFd87fdf72081359c123D940779b44f8c7eDDf5F2; 
...
contract LOOPNFT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOOP NFT";
    string private _symbol = "LOOPNFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x585577B548D4f3C0FfD8924E994eBF500B21c4a8); 
    address payable public teamWalletAddress = payable(0x585577B548D4f3C0FfD8924E994eBF500B21c4a8); 
    ...
    uint256 public _maxTxAmount = 70000 * 10**_decimals; 
    uint256 public _walletMax = 70000 * 10**_decimals;
