...
contract ContractWolfTokenGen is ERC20, Ownable {
    ...
    address private devWallet = 0x8167D75baC061d8E6D51205feAFBd61e2490a61b;
    ...
    Taxes public taxes = Taxes(19, 5, 1);
    Taxes public sellTaxes = Taxes(19, 5, 1);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("Buyback Madness ", "BBUY") payable {
        _tokengeneration(msg.sender, 1000000000 * 18**decimals());
