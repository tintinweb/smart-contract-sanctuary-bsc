...
contract OKX is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract BRich is BEP20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x2A7Bf0472Bf2f5018730caC0C7794aE58356e55E;
    address public _developmentWalletAddress = 0x2A7Bf0472Bf2f5018730caC0C7794aE58356e55E;
    ...
    constructor() BEP20("OKX", "BRich", 18) {

    	dividendTracker = new OKX ();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        OKX newDividendTracker = OKX(payable(newAddress));
