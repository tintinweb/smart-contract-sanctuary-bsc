...
https://t.me/muutwozerobsc & https://t.me/MuuTwoZeroAIBot


https://twitter.com/muutwozero
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x509A74d5F05821c57cc5B596EA9D6D8834AC0923; 
...
contract MUU20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muu 2.0";
    string private _symbol = "MUU20";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x509A74d5F05821c57cc5B596EA9D6D8834AC0923); 
    address payable public teamWalletAddress = payable(0x509A74d5F05821c57cc5B596EA9D6D8834AC0923); 
    ...
    uint256 public _marketingShare = 125;
