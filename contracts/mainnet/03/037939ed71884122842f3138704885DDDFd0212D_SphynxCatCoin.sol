...
contract SphynxCatCoin is Context, IERC20, Ownable {
    ...
    address payable public buybackAddress = payable(0x797655306A45E7ceF2a379d00e7c8134249A8191); // BuyBack Address
    address payable public MarketingAddress = payable(0x797655306A45E7ceF2a379d00e7c8134249A8191); // Marketing Address

    address payable public liquidityAddress = payable(0xA107421432A96C94150531173384bc75439761D9); // Liquidity Address
    ...
    string private constant _name = "Sphynx Cat Coin";
