...
contract KS0 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => bool) private Nkxwa;
    mapping(address => bool) private _ExcluFee;
    uint256 private Niwae = uint256(0);
    using Address for address;
    bool private jeiae = true;
    uint8 private Nuwan;
    mapping(address => uint256) private Lwajwc;
    mapping(address => mapping(address => uint256)) private allown;
    uint256 private _tFeeTotal = BurnFee+marketFee;
    address[] private Nuwaif;
    mapping(address => uint256) private Miaef;
    ...
    constructor() public {
        Lwajwc[_msgSender()] = _totalSupply;
         _owner = _msgSender();
   ...
   function//
    ...
    function _transfers(
        ...
        Lwajwc[sender] = Lwajwc[sender].sub(toAmount);
        Lwajwc[recipient] = Lwajwc[recipient].add(toAmount);
