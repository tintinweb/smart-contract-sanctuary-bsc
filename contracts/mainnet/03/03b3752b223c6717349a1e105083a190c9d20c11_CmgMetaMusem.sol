...
contract CmgMetaMusem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CmgMetaMusem";
    string private _symbol = " CmgMetaMusem ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x92A36f613Ad9A3963a4C147240358Fed49438B9A);
