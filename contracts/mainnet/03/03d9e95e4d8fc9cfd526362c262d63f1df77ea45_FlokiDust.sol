...
contract FlokiDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Dust";
    string private _symbol = "FLUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A858fBDaeeF1Faf4615fcF3C612F1d49931c532);
    address payable public BuyBackWalletAddress = payable(0x1A858fBDaeeF1Faf4615fcF3C612F1d49931c532); 
