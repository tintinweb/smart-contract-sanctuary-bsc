...
contract RyubyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ryuby Inu";
    string private constant _symbol = "RYUBYINU";
