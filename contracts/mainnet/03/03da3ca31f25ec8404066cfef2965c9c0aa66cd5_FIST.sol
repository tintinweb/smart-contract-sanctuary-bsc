...
contract FIST is ANTIBOTS, ER3Z, NEWATHR {
    
    using SafeMathique for uint256;
    using Address for address;
    
    string private _name = "FIST INU";
    string private _symbol = "FISTINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x668553253ecCDfD712F154555B2c76CED28d409A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x668553253ecCDfD712F154555B2c76CED28d409A); // BuyBack Address
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        ER3Z(_tokenAddr).transfer(_to, _amount);
    }
