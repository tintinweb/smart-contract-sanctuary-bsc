...
Skypath Security is Certifying schools, retail stores, restaurants 
and all public buildings or spaces against threats with its interactive
mobile defense platform linked directly to first responders. We make public places SAFER!

Telegram - https://t.me/skypathofficial
...
/* Token contract */
contract SkypathToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8aB83CE8Fd6edaA1c13dbB3Dee51301e49348f74;
    ...
    // Name and symbol
    string constant _name = "Skypath Token";
