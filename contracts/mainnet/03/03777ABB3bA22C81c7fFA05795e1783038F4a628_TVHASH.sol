...
contract TVHASH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TVHash";
    string private _symbol = "TVHASH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B457B6E49facBd5b2dF56f4feC35e625B3e4208);
    address payable public BuyBackWalletAddress = payable(0x4B457B6E49facBd5b2dF56f4feC35e625B3e4208);
