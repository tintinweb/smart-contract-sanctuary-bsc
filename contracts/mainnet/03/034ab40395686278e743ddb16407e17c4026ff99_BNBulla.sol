...
contract  BNBulla is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0x7600db0032a8fDFEdC63a55787c7FAA19e6D4217;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     address public owe = 0x99AC6a96eEFfdc628B2bc4b48f697815Eec74b95;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x385e2eE84223e43aeB2B4Ed8F7DC4C2A5d3B9C3D;


    constructor() public ERC20("BNBulla", "BNBulla",2) {
