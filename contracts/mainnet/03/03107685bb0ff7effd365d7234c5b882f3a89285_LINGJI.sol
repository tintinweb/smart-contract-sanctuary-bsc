...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE8bCEb7A5f1920fB792c9cDB4B11d57FCb76E647;
...
contract LINGJI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE32E4D15249A50AC3F48eDFf443c48Ef7E8b6455;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LINGJI";
    string private _symbol = "MYR";
