...
contract SuperKanye is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SuperKanyeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Super Kanye", "KANYE") {
        marketingWallet = payable(0x0c332874162D696F68E2506c42723f55035A9A19);
        devWallet = payable(0xa09c5e5D2297dd074538e5a3a8C06cbe67Ae749C);
        ...
        dividendTracker = new SuperKanyeDividendTracker(
            payable(this),
            router,
...
contract SuperKanyeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SuperKanye public SuperKanyeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SuperKanyeContract = SuperKanye(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SuperKanye_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SuperKanye_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SuperKanye contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SuperKanyeContract);

            uint256 prevBalance = SuperKanyeContract.balanceOf(address(this));
            ...
            {
                uint256 received = SuperKanyeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SuperKanyeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
