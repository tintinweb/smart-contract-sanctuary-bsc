...
contract FuMeta is Context, IERC20, Ownable,ReentrancyGuard {
    ...
    function setContract(address _U,address _manager)public onlyOwner{
        USDT = IERC20(_U);
        decimalsU = USDT.decimals();
    ...
    function setStart(bool _rState,bool _txState,uint _firstTime)public onlyOwner{
        startRelease = _rState;
        nextReleasedTime = _firstTime;
        _txState?startTradeBlock=_firstTime:startTradeBlock=MAX;
    }
    ...
    function setWLBL(address _userAddr,bool _wlState,bool _blState)public onlyOwner{
        whiteList[_userAddr]=_wlState;
        blackList[_userAddr]=_blState;
    }
...
contract FMT is FuMeta {
    constructor() FuMeta(
        "FMT",                                      // string   name_,
        "FMT",                                      // string   symbol_,
        0x375426665A8f70EF20B9A22416A9f2d13d3B4FEC, // address _managerAddr,
        0x55d398326f99059fF775485246999027B3197955, // address _USDT,
        0xa89aa9e323049Ac213Ce9ecf3cD38eEcEc3479dF, // address _funderAddr,
