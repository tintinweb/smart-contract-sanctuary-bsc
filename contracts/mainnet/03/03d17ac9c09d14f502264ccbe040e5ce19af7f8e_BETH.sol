...
contract BETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ethereum Base";
    string private constant _symbol = "BETH";

    address public _PancakeSwapV1RouterUniswap = 0xc5C209e829fC9744e831d1F5979BaC97c1607a70; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xc5C209e829fC9744e831d1F5979BaC97c1607a70; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xF6cCbF8a4Fc2574174BE1c0fd018De455D489405)] = true; //uniswap router liquidity
