...
contract Pizzoge is IERC20, Ownable {
    ...
    string _name = "Pizzoge";
    string _symbol = "PIZZOGE";
    ...
    uint256 taxFeeVar = 10;
    uint256 giveawayFee = 1;
    uint256 marketingFeeVariable = 12;
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (taxFeeVar, marketingFeeVariable, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _taxFeeVar, uint256 _reflectionFee, uint256 _marketingFeeVariable, uint256 _giveawayFee) external onlyOwner {
        taxFeeVar = _taxFeeVar;
        reflectionFee = _reflectionFee;
        marketingFeeVariable = _marketingFeeVariable;
        giveawayFee = _giveawayFee;
        totalFee = taxFeeVar.add(reflectionFee).add(marketingFeeVariable).add(giveawayFee);
