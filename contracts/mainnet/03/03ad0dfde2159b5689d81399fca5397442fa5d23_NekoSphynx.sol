...
contract NekoSphynx is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Neko Sphynx";
    string constant _symbol = "NSPHYNX";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xf7F7eb6cde870B1D89a9189CA90b3Fb05b2d7842);
