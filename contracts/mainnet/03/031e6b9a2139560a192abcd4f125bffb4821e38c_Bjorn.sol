...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0c7920AE83eCDD14Ad2e00768431c9b0Bff74F4C;
...
contract Bjorn is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf27E44a4BD6FC5574c82aFf3f7d283EBF0432Bec;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bjorn";
    string private _symbol = "BJORN";
