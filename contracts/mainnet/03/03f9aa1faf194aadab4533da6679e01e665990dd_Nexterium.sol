...
contract Nexterium is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Nexterium";
    ...
    address payable public DevWallet = payable(0x01158022a95bf76FEFBed1efCd94783e0B3ED858);
    address payable public MarketingWallet = payable(0xD1a83294b07875631ecb47a1Ff2DDCc6F3e33C3d);
