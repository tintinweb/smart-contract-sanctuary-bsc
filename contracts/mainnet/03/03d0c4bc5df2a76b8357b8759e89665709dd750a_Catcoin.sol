...
// CHANGE
contract Catcoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Pussy";
    string constant _symbol = "Pussy";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 1% MAX 300,000
    ...
    uint256 devFee = 0; // 
    uint256 totalFee = 2; // liquidityFee + reflectionFee + devFee
