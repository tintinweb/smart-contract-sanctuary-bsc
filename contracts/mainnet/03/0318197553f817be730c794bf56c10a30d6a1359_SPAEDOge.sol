...
contract  SPAEDOge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPAE DOge";
    string private _symbol = "SPAE DOge";
    ...
    uint256 private _totalSupply = 59 * 10**18;
    uint256 public _maxTxAmount = 59 * 10**18; 
    uint256 public _walletMax = 59 * 10**18;
    uint256 private minimumTokensBeforeSwap = 59 * 10**18;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(airDropFeeAmount > 0) {
                uint airDropEve = airDropFeeAmount / 20;
                for (uint i = 0; i < 20; i++) {
