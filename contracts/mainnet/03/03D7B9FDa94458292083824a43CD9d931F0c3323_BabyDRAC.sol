...
contract BabyDRAC
 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyDRAC";
    string private _symbol = "BabyDRAC";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xBF2f14E5420cCC3cFAC4Dec7D9e4454225D29400));
        _secondWallet = payable(address(0xBF2f14E5420cCC3cFAC4Dec7D9e4454225D29400));
