...
contract FTTFanTokenv2 is Context, IERC20, Ownable {
    ...
    string private constant _name = " FTT Fan TokenV2 "; // 
    string private constant _symbol = " $FFTFTV2 "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x176e99f0Fcb9cDC855858e202579455628eA464E;
