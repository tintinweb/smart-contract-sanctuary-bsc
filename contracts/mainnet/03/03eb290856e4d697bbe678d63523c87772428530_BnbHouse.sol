...
contract BnbHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	uint256 vrfFee = 1600000000000000; // default 0.0016 BNB
    ...
    /* ========== MUTATIVE FUNCTIONS ========== */
    function depositBank() payable external {
        require(msg.value > minDeposit, "Lower than Minimum Deposit Amount");
   ...
   function refund(uint256 _betId) external nonReentrant {
    ...
    function bet(uint256 _odd) external payable nonReentrant {
        ...
        require(msg.value >= minBet + vrfFee, "Value too small");

        uint256 _betAmount = msg.value - vrfFee;

        //Prevent Bet Spamming 
		address _sender = msg.sender;
        ...
        require(pauseBet == 0, "Betting is paused, Visit Discord/Telegram for more Information");
