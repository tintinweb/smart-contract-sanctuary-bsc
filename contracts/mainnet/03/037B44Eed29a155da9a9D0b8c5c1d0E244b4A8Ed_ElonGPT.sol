...
contract ElonGPT is ERC20, Ownable {
    using SafeMath for uint256;
 ...
 uint256 public tokensForCharity;
    ...
    constructor() ERC20("ElonGPT", "EGPT") {
        ...
        buyTotalFees = buyMarketingFee + buyCharityFee;
        
        sellMarketingFee = _sellMarketingFee;
        sellCharityFee = _sellCharityFee;
        sellTotalFees = sellMarketingFee + sellCharityFee;
        
        marketingWallet = address(0xdA6C082D88B5cd2D5FaD5206422fB435Dfa529F8); // set as marketing wallet
        CharityWallet = address(0xFa81f57c32F65B0e2Ec37e17535153Ab4b0a3ad7);
...
excludeFromFees(0x228FaB75b59516086C46D6471b359a72DB3958b2, true); 
        ...
        excludeFromMaxTransaction(0x228FaB75b59516086C46D6471b359a72DB3958b2, true);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _charityFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _charityFee) external onlyOwner {
