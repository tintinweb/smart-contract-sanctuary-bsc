...
Ultimately, the downfall of the Freemasons was giving away their stonecutting services for nothing - Elon Tweet

 Launching very soon. it can be moonshot! 
 Do you miss for ElonaCoin, BerlinRocks, etc..? so, dont missed for the new one!
*/

// telegram : https://t.me/FreemasonsInuBSC
...
contract FreemasonsInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "$MASONS";
