...
contract AitamaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x51bEada7d215AE0437C28C11bbD81e0Fb6A0987d); 
    address payable public Wallet_Dev = payable(0xeBEd4c6E15aB2EbdbeCEB12bcc1C34A1714Ce143);
    ...
    string private constant _name = "Aitama Inu"; 
    string private constant _symbol = unicode"AITAMA"; 
    ...
    constructor () {
        ...
        _owner = 0xeBEd4c6E15aB2EbdbeCEB12bcc1C34A1714Ce143;
