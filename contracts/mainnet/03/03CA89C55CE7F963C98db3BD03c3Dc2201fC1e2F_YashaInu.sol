...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8bEeb6C3f248Ec3F3d704e333b6Ef3132D1D5F15; // owner address
...
contract YashaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Yasha Inu";
    string private _symbol = "Yasha";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa776030Bf24B77C5762e8b8Ac61E50F133A47537); // Marketing Address
    address payable public teamWalletAddress = payable(0xa776030Bf24B77C5762e8b8Ac61E50F133A47537); // Team Address
