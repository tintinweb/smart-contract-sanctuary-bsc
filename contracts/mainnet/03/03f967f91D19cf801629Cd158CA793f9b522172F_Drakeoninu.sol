...
/*
   ...
   Welcome to Drakeon inu
   
  
    I make this #Drakeoninu to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/drakeoninu
   ...
   I will renounce the ownership to burn addresses to transfer #Drakeoninu to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #Drakeoninu 10000X? 

   1,000,000,000,000,000 total supply
   500,000,000,000,00 tokens limitation for trade, which is 0.5% of the total supply
   ...
   it's the best part of the #Drakeoninu idea, increasing the liquidity pool automatically, 
...
contract Drakeoninu is Context, IERC20, Ownable {
    ...
    string private _name = " Drakeon inu";
    string private _symbol = "Drakeon Inu";
