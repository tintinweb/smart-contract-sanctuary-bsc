...
contract SellBoxBySOT is Ownable {
    ...
    constructor(IPancakeRouter _pancakeRouteAddress, address _WBNBAddress, address _BUSDAddress, address _SOW, IRefferal _refer, IERC1155 _box, IERC20 _tokenBuy, address _ceo) {
    ...
    function buy(uint _tokenId, uint _amount) external {
        ...
        if(refer.isReferrer(_msgSender())) {
            ...
            pancakeRouter.swapExactTokensForTokens(buyBack, amounts[0], path, address(this), block.timestamp);
