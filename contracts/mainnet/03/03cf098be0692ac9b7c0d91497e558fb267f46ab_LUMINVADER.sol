...
library Address{
 ...
 contract LUMINVADER is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4514dc4BD7E226685283fE1a8940fAf3eD739B49;
    address public donationWallet = 0x4514dc4BD7E226685283fE1a8940fAf3eD739B49;



    string private constant _name = "LUM INVADER";
    string private constant _symbol = "$LUM";
    ...
    Taxes public sellTaxes = Taxes(0, 16, 2, 0);
