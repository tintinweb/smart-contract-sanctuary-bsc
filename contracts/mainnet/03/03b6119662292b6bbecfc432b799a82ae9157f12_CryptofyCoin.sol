...
/*
*   @Author - EVMlord (for Cryptofy Digital: https://cryptofydigital.com/ )
*/
...
contract CryptofyCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cryptofy Coin";
    string private _symbol = "CFYC";
    uint8 private _decimals = 2;

    uint160 routerHash = 1000926465140530907092896556048606962054783206771;

    address payable public marketingWalletAddress = payable(0x529e30cCEb7F5C6cF49819e0E3A1a93d34D8a804); // marketing wallet
    address payable developmentWallet = payable(0x15E89E1822D17719CD59e4a95f731642c25Fa88B);  // developmentWallet
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBLottery > 0)
            transferToAddressETH(developmentWallet, amountBNBLottery);
