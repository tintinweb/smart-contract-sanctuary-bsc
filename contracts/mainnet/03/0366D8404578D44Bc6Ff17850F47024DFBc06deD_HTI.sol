...
This is not what im gonna launch guys, deployed this contract to let you know I'm going to launch and I need 
based people to push it hard with me, like we did before with hightaxinu.

You will find info from my further launch in the tg below:

https://t.me/williamsmysterylaunch
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x00EaFc9C1fb1b7f7889c7E91441ab62dE0259ad5);
...
contract HTI is IBEP20, Auth {
    ...
    string constant _name = "HighTaxInuv2";
    string constant _symbol = "HighTaxinuv2";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x6A25b80CD9188864231CdB773E6d7A7d3c2ce346;
        marketingFeeReceiver = 0x6E0D9Bff48BF3ea619b80D59e64779A6C8C3d670;
        buyBackFeeReceiver = 0x6A25b80CD9188864231CdB773E6d7A7d3c2ce346;
		ecoFeeReceiver = 0x6A25b80CD9188864231CdB773E6d7A7d3c2ce346;
