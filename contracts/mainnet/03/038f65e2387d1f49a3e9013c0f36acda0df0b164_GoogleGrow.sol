...
contract GoogleGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x535425B5f0ba5f813B1875e3072BBEae6C655F68); 
    address payable public Wallet_Dev = payable(0x535425B5f0ba5f813B1875e3072BBEae6C655F68);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x535425B5f0ba5f813B1875e3072BBEae6C655F68); 
    ...
    string private constant _name = "GoogleGrow"; 
    string private constant _symbol = unicode"GoogleGrow"; 
    ...
    constructor () {
        ...
        _owner = 0x535425B5f0ba5f813B1875e3072BBEae6C655F68;
