...
contract VoiceAI is IBEP20, Auth {
    ...
    string constant _symbol = "VoiceAI";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256  _maxTxAmount = 1000000 * 10 ** _decimals;
    ...
    uint256 private feeBotsMinExemptReceiverTrading = 10;

    //SELL FEES
    uint256 private sellModeTradingAuto = 0;
    uint256 private burnMaxBuySwapTx = 20;
