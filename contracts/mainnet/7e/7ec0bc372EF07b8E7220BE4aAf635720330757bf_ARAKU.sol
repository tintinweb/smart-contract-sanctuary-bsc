...
contract ARAKU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Miku"; // 
    string private constant _symbol = "$ARAKU "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xAAA4AbAe9ba35eC662Dc3113C2766392c5108bF4;
