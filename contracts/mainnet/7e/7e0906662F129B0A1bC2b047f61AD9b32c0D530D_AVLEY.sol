...
Telegram : https://t.me/AlveyDogeBSC
*/
...
contract AVLEY is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALVEY DOGE"; // 
    string private constant _symbol = "$ALVEYDOGE"; //    
