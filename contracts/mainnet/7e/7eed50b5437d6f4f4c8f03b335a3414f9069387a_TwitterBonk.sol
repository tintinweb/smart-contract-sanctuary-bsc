...
contract TwitterBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterBonk";
    string private _symbol = "TBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x74D52F791d2Ee8a804ff7404E33bF5460a528543);
    address payable public BuyBackWalletAddress = payable(0x74D52F791d2Ee8a804ff7404E33bF5460a528543);
