...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe933981c99A0bbFC410bE146fF54D8f61Ab724ed; 
...
contract LionFlokiCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256; //
    using Address for address;
    
    string private _name = "Lion Floki CEO";
    string private _symbol = "LFLC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe933981c99A0bbFC410bE146fF54D8f61Ab724ed); 
    address payable public teamWalletAddress = payable(0xe933981c99A0bbFC410bE146fF54D8f61Ab724ed); 
