...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85a4d75784Dd536f552c27B3D8495aa1dd7EDD76; // owner address
...
contract WatBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WatBunny";
    string private _symbol = "WatBunny";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85a4d75784Dd536f552c27B3D8495aa1dd7EDD76); // Marketing Address
    address payable public teamWalletAddress = payable(0x85a4d75784Dd536f552c27B3D8495aa1dd7EDD76); // Team Address
