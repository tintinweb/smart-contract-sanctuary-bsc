...
contract TRUTHPRESALENFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {

    using Address for address;

    // Token name
    string private constant _name = "TRUTH PRESALE NFT";

    // Token symbol
    string private constant _symbol = "TRUTHPS";
