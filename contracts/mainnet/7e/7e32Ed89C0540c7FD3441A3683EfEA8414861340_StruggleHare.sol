...
contract StruggleHare is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "StruggleHare";
    string private _symbol = "SGHare";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xBbE88FA6E463d5A2a9828e63Ea593C8c62fa02Da));
