...
contract BabyGreatDane is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Baby Great Dane";
    string private _symbol = "BabyGreatDane";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 10000000 * 10**15 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xb306b3194163AE62A7bDCCf33336f1ae9265F86B; 
