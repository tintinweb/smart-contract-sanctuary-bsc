...
contract SHIBANETWORK is Token {
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0xF1CD55ba3CF256F21fe20cb73d2e4dcb41Bd7d52;  // N
        ADV_1 = 0xf509d8b4Ce4C5173a06a54294B0cf669fA4bBF32;  // 0         
        ADV_2 = 0xba3B0547438940FC539036D96E8798d926c7f1A4;  // E        
        ADV_3 = 0x5B09a74e136C5BCa7d730874338C1f0603E9e7e7;  // o     
        FIN_1 = 0xC1f5e9408A42227CeF066b8034A592a4e175e42e;  // S   
        MAR_1 = 0x916784AFc5815e7DA66c40447bA2F52f90469274;  // DESB      
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > 1643119200);                
