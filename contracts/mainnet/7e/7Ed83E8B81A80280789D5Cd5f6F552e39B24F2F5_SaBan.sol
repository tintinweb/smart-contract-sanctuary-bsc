...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function shareSaBanDividend(address _dividend) external onlyOwner {
...
contract SaBan is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "SaBan";
    string private _symbol = "SABAN";
    ...
    function setSaBanMarketing(uint8 newLiquidityTax, uint8 newMarketingTax, uint8 newBuyBackTax) external onlyOwner {
        taxLiquidity = newLiquidityTax;
        taxMarketing = newMarketingTax;
