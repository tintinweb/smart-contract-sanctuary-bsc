...
contract ViaRouter is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @notice Event emitted when fee is collected by contract
    ...
    function execute(
        ...
        _checkValidatorSignature(viaData, swapData, bridgeData, validatorSig);
        ...
        // Check that deadlien has not passed yet
        require(
        ...
        uint256 extraNativeValue = viaData.assetIn.transferIn(viaData.amountIn);

        // Collect fees from incoming asset
        collectedFees[viaData.assetIn] += viaData.fee;
        uint256 amountIn = viaData.amountIn - viaData.fee;
    ...
    function _swap(
        ...
        return (assetOut, balanceOutAfter - balanceOutBefore);
    }
