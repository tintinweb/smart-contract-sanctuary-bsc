...
contract FLOKIINLOVE is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI IN LOVE";
    string private _symbol = "FKIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd34251f28b6be90063430b462f4045B1771E1456); // 
    address payable public teamWalletAddress = payable(0x861531895F233ff3b3C9a511199df4ed983c2624); // 
