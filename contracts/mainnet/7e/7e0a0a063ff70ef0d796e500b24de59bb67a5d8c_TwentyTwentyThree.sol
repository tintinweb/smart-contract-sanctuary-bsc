...
contract TwentyTwentyThree is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   TwentyTwentyThreeDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("TwentyTwentyThree", "2023") {
        _buyRewardsFee = 12;
        _buyLiquidityFee = 3;
		_buyMarketingFee = 6;
        _buyDevFee = 1;
		...
		contractTokenBalanceAmount = 25000 * 10**18;
        
        swapTokensAtAmount = 25000 * (10**18);
        _maxWallet = 100000 * (10**18);
        _maxBuy = 50000 * (10**18);
        _maxSell = 50000 * (10**18);
    	...
    	dividendTracker = new TwentyTwentyThreeDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xA1E32Aae0f8986B5De0D7eA278D0120aecC50350);
        _devWallet = payable(0xA1E32Aae0f8986B5De0D7eA278D0120aecC50350);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TwentyTwentyThree: The dividend tracker already has that address");

        TwentyTwentyThreeDividendTracker newDividendTracker = TwentyTwentyThreeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TwentyTwentyThree: The new dividend tracker must be owned by the TwentyTwentyThree token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "TwentyTwentyThree: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TwentyTwentyThree: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TwentyTwentyThree: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "TwentyTwentyThree: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TwentyTwentyThree: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TwentyTwentyThree: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TwentyTwentyThree: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "TwentyTwentyThree: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TwentyTwentyThree: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TwentyTwentyThree: Cannot update gasForProcessing to same value");
	...
	function letsGoLive() external onlyOwner() {
        ...
        updateMaxWallet(1000000);
        updateMaxBuySell(1000000, 1000000);
...
contract TwentyTwentyThreeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("TwentyTwentyThree_Dividend_Tracker", "TwentyTwentyThree_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "TwentyTwentyThree_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TwentyTwentyThree contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "TwentyTwentyThree_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TwentyTwentyThree_Dividend_Tracker: Cannot update claimWait to same value");
