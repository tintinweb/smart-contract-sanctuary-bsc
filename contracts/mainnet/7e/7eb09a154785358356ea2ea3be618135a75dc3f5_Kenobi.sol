...
contract Kenobi is AuthOwnable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 10000000000 *  10**9;
    string public name = "Kenobi";    
    string public symbol = "Kenobi";
    ...
    function excludeFromKenobi(address account) external onlyOwner() {
    ...
    function recipientFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
    ...
    function initopenTrading(bool _trading) public onlyOwner
    {
