...
/**
WEBSITE: WWW.AstroBNB.app
TELEGRAM: t.me/AstroBNBapp
*/
...
contract AstroBNB is ERC20DividendToken {
    ...
    constructor (address _marketingAddress, address _devAddress) ERC20DividendToken("AstroBNB", "AstroBNB", _tokenSupply, _routerAddress, _marketingAddress, _devAddress) {
