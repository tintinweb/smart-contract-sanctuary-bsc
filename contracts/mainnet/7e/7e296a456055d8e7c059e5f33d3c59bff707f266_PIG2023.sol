...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6fB5fB3B5C723F67f17080da11d3d158332773b5; // owner address
...
contract PIG2023 is Context, IERC20, Ownable {
    ...
    string private _name = "PIG 2023";
    string private _symbol = "PIG2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6fB5fB3B5C723F67f17080da11d3d158332773b5); // Marketing Address
    address payable public teamWalletAddress = payable(0x6fB5fB3B5C723F67f17080da11d3d158332773b5); // Team Address
