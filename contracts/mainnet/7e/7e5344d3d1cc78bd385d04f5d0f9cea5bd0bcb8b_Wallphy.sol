...
contract Ownable is ContextETH {
...
contract Wallphy is WALLPHYDeployer, ContextETH, Ownable {
  
    // common addresses
    address private _owner;
    address private WALLPHYTeam;
    address private CharityWALLPHY;
    ...
    string public override name = "Wallphy";
    string public override symbol = "WALLPHY";
    ...
    constructor(uint totalSupplyValue, address WALLPHYTeamAddress, address CharityWALLPHYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WALLPHYTeam = WALLPHYTeamAddress;
        CharityWALLPHY = CharityWALLPHYAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WALLPHYTeam] =  totalSupply * 4 / 100;
        balances[CharityWALLPHY] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's WALLPHYTeam pot
