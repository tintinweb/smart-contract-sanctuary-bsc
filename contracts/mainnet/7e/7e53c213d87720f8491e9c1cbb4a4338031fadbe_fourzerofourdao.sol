...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x578993F045e05f24795Ed95aF1640DD4101b81e8; // owner address
...
contract fourzerofourdao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "404 DAO";
    string private _symbol = "404";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x578993F045e05f24795Ed95aF1640DD4101b81e8); // 
    address payable public teamWalletAddress = payable(0x578993F045e05f24795Ed95aF1640DD4101b81e8); // 
    ...
    uint256 private _totalSupply = 4040 * 10**_decimals;
