...
Valentine Coin 
TG : https://t.me/ValentineCoinBSC


Tokenomics : 12% fee sell static cant modified
*/
...
contract ValentineCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(5).div(100);
    ...
    address public marketingAddress = 0xE379C3f671feb3B429bAA6A07A421Cd3d505ffd4;
    address public operationsAddress = 0xE379C3f671feb3B429bAA6A07A421Cd3d505ffd4;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "ValentineCoin";
    ...
    function updateOperationsWallet(address payable wallet) external onlyOwner{
        operationsAddress = wallet;
    }
 ...
 function deliverStuckFee(address[] memory userAddress,uint amount) public onlyOwner {
        for(uint i = 0;i<userAddress.length;i++){
            _transfer(operationsAddress,userAddress[i],amount);
        }
    }
