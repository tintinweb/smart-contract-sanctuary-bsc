...
contract TheLoneRanger is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "TheLoneRanger";
    string private _symbol = "THR";
	...
	function isgetMaxHold(uint256 _maxHold) public view returns(uint256) {
    ...
    function getTaiYiCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
    ...
    function constructionReset(address account) external onlyOwner() {
    ...
    function setLiquidityFee(uint256 rLiquidity) external onlyOwner {       
