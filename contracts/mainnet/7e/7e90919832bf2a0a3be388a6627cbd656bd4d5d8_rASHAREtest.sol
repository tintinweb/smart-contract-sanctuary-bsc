...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7fa6A0642E2593F7BDd7b2E0A2673600d53BBE9;
...
contract rASHAREtest is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf7fa6A0642E2593F7BDd7b2E0A2673600d53BBE9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "rASHAREtest";
    string private _symbol = "rASHAREt";
