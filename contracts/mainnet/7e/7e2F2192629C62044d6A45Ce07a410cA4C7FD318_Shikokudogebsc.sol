...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2988567dbec051247C54235d25d5D67C83ED123a; // owner address
...
contract Shikokudogebsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShikokuDoge";
    string private _symbol = "SD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2988567dbec051247C54235d25d5D67C83ED123a); // Marketing Address
    address payable private teamWalletAddress = payable(0x2988567dbec051247C54235d25d5D67C83ED123a); // Team Address
