...
// Telegram : https://t.me/binanceftx_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6490D3e31841225A22b65a90B25F7E3a3e5a9632; // owner address
...
contract binanceftx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BINANCE FTX";
    string private _symbol = "BFTX";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x6490D3e31841225A22b65a90B25F7E3a3e5a9632); // Marketing Address
    address payable public teamWalletAddress = payable(0x6490D3e31841225A22b65a90B25F7E3a3e5a9632); // Team Address
