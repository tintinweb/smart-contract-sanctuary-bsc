...
contract MeConsensus is Ownable {
  ...
  mapping(address => address[]) public recommendedData;
  ...
  address public _consensus_pool;
  ...
  function consensus() public {
    ...
    if(remainAmount > 0){
      meToken.transfer(_consensus_pool, remainAmount);
    }
  ...
  function claimReward() public {
    ...
    receivedReward[account] += tReward;
