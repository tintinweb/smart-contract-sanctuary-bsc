...
// main contract
contract FooDeFi is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "FooDeFi";
    string private constant _symbol = "FOOD";
    ...
    uint256 public totalBuyFee = 900;
    ...
    function setMaxTxAmount(uint256 _maxTxAmount) external authorized {
        require(_maxTxAmount >= _totalSupply.div(100_000), "Must be greater than 0.001%");
    ...
    function setBuyFees(
        ...
        require(totalBuyFee <= feeDenominator.div(4), "Can't be greater than 25%");
    }
    ...
    function setSellFees(
        ...
        feeDenominator = _feeDenominator;
        require(totalSellFee <= feeDenominator.div(4), "Can't be greater than 25%");
    }
