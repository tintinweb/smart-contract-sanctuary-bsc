/**
    ...
    Telegram: https://t.me/demonicdoge
    Website: https://demonicdoge.com/
...
contract DEMONICDOGE is ERC20, Ownable {
    ...
    DemonicDogeDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3558Dfdb0a6Fd686B9FfC0cF0A1561980DB5fa4C;
    address public devWallet = 0x61A1a09CCE069ec6831837f216E70F4c4d46cb6f;
    address public operationsWallet = 0x4B0e607Ae107dc77A61b392F5b839dfbC0D75E59;
    address public gamedevWallet = 0xE8A5db17dfc0F9923048410cfB5B37F7937F6eA3;

    uint256 public swapTokensAtAmount = 300_000 * 10**9;
    uint256 public maxWalletBalance = 3_000_000 * 10**9;
    uint256 public maxBuyAmount = 3_000_000 * 10**9;
    ...
    uint256 public launchtax = 13;
    uint256 public coolDownBalance = 250000 * 10**9;
    ...
    constructor() ERC20("Demonic Doge", "DMD") {
        dividendTracker = new DemonicDogeDividendTracker();
        ...
        excludeFromFees(gamedevWallet, true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        DemonicDogeDividendTracker newDividendTracker = DemonicDogeDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DemonicDoge: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setGamedevWallet(address newWallet) external onlyOwner {
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "DemonicDoge: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "DemonicDoge: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DemonicDoge: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndLiquify(uint256 tokens, uint256 swapTax) private {
        ...
        // Send BNB to gamedev
        uint256 gamedevAmt = unitBalance * 2 * sellTaxes.gamedev;
        if (gamedevAmt > 0) {
...
contract DemonicDogeDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("DemonicDoge_Dividen_Tracker", "DemonicDoge_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "DemonicDoge_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DemonicDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "DemonicDoge_Dividend_Tracker: Cannot update claimWait to same value"
        );
