...
contract SpookyMoon is IBEP20, Auth {
    ...
    string constant _name = unicode"SpookyMoon";
    ...
    address public marketingFeeReceiver = 0xbB39bE29D61cACE0C44C7e4476A2E24660ecd8b9;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 100; // 0,3.00%
    bool inSwap;
