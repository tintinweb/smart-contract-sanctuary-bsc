...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96032656cbFd403fBA839aac3739F97856DaD968; 
...
contract BaijiuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baijiu Inu";
    string private _symbol = "Baijiu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96032656cbFd403fBA839aac3739F97856DaD968); // 
    address payable public teamWalletAddress = payable(0x96032656cbFd403fBA839aac3739F97856DaD968); // 
