...
contract BJX is Context, IERC20, Ownable {
    ...
    string private _name = "BEIJIXIONG";
    string private _symbol = "BEIJIXIONG";
    uint8 private _decimals = 3;

    address payable private marketingWalletAddress = payable(0x94Fe5b50E385B7028116E4b570beB86055526666); 
    address payable private teamWalletAddress = payable(0x94Fe5b50E385B7028116E4b570beB86055526666); 
