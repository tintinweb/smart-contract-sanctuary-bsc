...
contract Healthy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1Healthy";
    string private _symbol = "1Healthy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa03760A6B6975966bc62D73aD2DB31b0D5d4FdF8); 
    address payable public teamWalletAddress = payable(0x5a8D96a2B7DF37b3a49b599D36503Df33e54baC5); 
    ...
    uint256 private _totalSupply = 24 * 10**7 * 10**_decimals;  
    uint256 private minimumTokensBeforeSwap = 120 * 10**4 * 10**_decimals;
