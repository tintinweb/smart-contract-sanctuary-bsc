...
contract ZoaVesting5Farming is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting5Farming: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting5Farming: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting5Farming: wrong TGE timestamp");
