...
contract TKNStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [90 days, 180 days, 270 days, 365 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [10, 30, 60, 100];
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        totalFee = 0;
        maxStakeableToken = 100000000000000000000000000;
        percentDivider = 1000;
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        IERC20 BUSDTOKEN = IERC20(0xbff38FdB9E1ab546303473BBc6235A47cA465251); // BUSD Token address
        ...
        address TKN_WBNB = 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0xbff38FdB9E1ab546303473BBc6235A47cA465251); // TKN Token address 
