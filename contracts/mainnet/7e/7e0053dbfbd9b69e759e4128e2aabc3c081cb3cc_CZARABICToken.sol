...
/* 
🔶CZARABIC🔶 10% TAX🔶 LP lock🔶40%Burn🔶

🔶10% TAX FEES IS THE ONE OF THE RIGHT KEYS 🔶

rewards 10% of token itself $CZARABIC FROM SELLERS , BEST STRATEGY IS HOLD AS BOLD AS GOLD .
...
👉 token ADRESS 
 🔶  0x7E0053dBfBd9b69e759e4128E2AaBc3C081CB3CC   🔶
from CZ BINANCE - I WISH- AND WILL BE LISTED ON https://coinmarketcap.com/ HOPEFULLY SOOOON.

CZ 🔶 Binance
CZ IS CEO  @binance , holder of #bnb #btc
...
contract CZARABICToken is ContextBEP20, BEP20, OwnableBEP20 {
    ...
    string private _name = 'CZARABIC';
    string private _symbol = 'CZARABIC';
