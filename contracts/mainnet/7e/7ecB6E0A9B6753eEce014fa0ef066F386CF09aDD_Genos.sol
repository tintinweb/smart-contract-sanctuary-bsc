...
// BUSD Reward ~ https://t.me/GenosDSC
...
contract GenosTokenDividendTracker is DividendPayingToken, Ownable {
  using SafeMath for uint256;
  using SafeMathInt for int256;
  ...
  constructor()
    DividendPayingToken("GenosToken_Dividend", "GenosToken_Dividend")
  {
    claimWait = 3600;
...
contract Genos is ERC20, Ownable {
  using SafeMath for uint256;
  // Events Declarations
  ...
  GenosTokenDividendTracker public dividendTracker;
  ...
  // GenosGuard is active on default
  // bool internal genosGuardOffline = true;

  address payable public marketingWallet =
    payable(0xC3d319e5bFF8c716b2D4Dbc7918A98883f44a265);
  address payable public devWallet =
    payable(0xFD65dB500aF3251a29ddC71312418bF020A5c97b);
  address payable public buyBackWallet =
    payable(0x50e7B1c5d8F4871C859421724c01B25f45822Fd5);
  ...
  constructor() ERC20("Genos", "Genos") {
    dividendTracker = new GenosTokenDividendTracker();
  ...
  // function isGenosGuardEnabled() public view returns (bool) {
  //   return genosGuardOffline;
  // }
  ...
  // function shutdownGenosGuard() external onlyOwner {
  //   require(!genosGuardOffline, "genos guard is already offline");
  //   genosGuardOffline = true;
  // }
  ...
  function updateDividendTracker(address newAddress) public onlyOwner {
    ...
    GenosTokenDividendTracker newDividendTracker = GenosTokenDividendTracker(
      payable(newAddress)
    );
  ...
  function _transfer(
    ...
    //   require(
    //     genosGuardOffline || isWhitelisted[to],
    //     "trading isnt enabled or account isnt whitelisted"
    //   );
    // } else if (to == uniswapV2Pair) {
    //   require(
    //     genosGuardOffline || isWhitelisted[from],
    //     "trading isnt enabled or account isnt whitelisted"
    //   );
    // }
