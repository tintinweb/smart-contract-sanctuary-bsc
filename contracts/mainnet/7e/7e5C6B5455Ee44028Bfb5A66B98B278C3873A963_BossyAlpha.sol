...
contract BossyAlpha is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bossy Alpha Coin";
    string private constant _symbol = "Bossy Alpha";
    ...
    uint256 public swapTokenAtAmount = 2325000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0xf09A3D8DA80CE72668B3e0A5aF66d7f0F5d58421);
    address private liquidityReceiver = address(0xf09A3D8DA80CE72668B3e0A5aF66d7f0F5d58421);
