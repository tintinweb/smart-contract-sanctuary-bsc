...
contract BNBChain is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Chain";
    string private _symbol = "BNB Chain";
    ...
    uint256 private _totalSupply = 176406561 * 10**_decimals;
    uint256 public _maxTxAmount = 176406561 * 10**_decimals; 
    uint256 public _walletMax = 176406561 * 10**_decimals;
    ...
    function seuyaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function seSelxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
