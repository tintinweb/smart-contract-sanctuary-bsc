...
contract ewew is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ewew";
    string private _symbol = "ewew";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x418de1392e3c5f699d57275AB9F4109480930AF5); 
    address payable public ttWal = payable(0x418de1392e3c5f699d57275AB9F4109480930AF5); 
    ...
    constructor (address UniswapV2RouterAddress) {
        ...
        _router = PancakeRouter(UniswapV2RouterAddress);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHTeam > 0)
            transferToAddressETH(ttWal, amountETHTeam);
