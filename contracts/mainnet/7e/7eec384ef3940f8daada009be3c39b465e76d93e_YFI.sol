...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        allot = Allot(750, 0, 250, 1000);

        address[] memory marketingAddress = new address[](1);
        marketingAddress[0] = address(0x466a1fC42ffb17B168FcD52F3Bec86509F8A5F1C);
...
contract YFI is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("YFI", "YFI") {
        ...
        address _initHolder = 0x466a1fC42ffb17B168FcD52F3Bec86509F8A5F1C;
