...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90072Ff6237d29ee8D062E661bA2F060Aec3143e; // owner address
...
contract LokcbitNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Lockbit Network";
    string private _symbol = unicode"LOCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90072Ff6237d29ee8D062E661bA2F060Aec3143e); // Marketing Address
    address payable public teamWalletAddress = payable(0x90072Ff6237d29ee8D062E661bA2F060Aec3143e); // Team Address
