...
/**
TG : https://t.me/MBPBSC
Twitter : https://twitter.com/MobiPadOFC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85d9038abb1f33A132951454DDe2fB5C027570BD; // owner address
...
contract $M is Context, IERC20, Ownable {
    ...
    string private _name = "MobiPad";
    string private _symbol = "$M";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85d9038abb1f33A132951454DDe2fB5C027570BD); // Marketing Address
    address payable public teamWalletAddress = payable(0x85d9038abb1f33A132951454DDe2fB5C027570BD); // Team Address
    ...
    uint256 public _maxTxAmount = 700 * 10**_decimals; 
    uint256 public _walletMax = 700 * 10**_decimals;
