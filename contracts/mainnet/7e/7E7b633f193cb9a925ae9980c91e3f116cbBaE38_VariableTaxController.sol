...
contract VariableTaxController is OwnableUpgradeable {
    ...
    function getVariableTaxV2(address _addr, uint256 _base_tax, uint256 _amount_to_claim, uint256 _amount_to_nitro, uint256 _amount_to_deposit) external view returns (uint256) {
        (,,uint256 user_deposits,,,,) = race.userInfo(_addr);
    ...
    function getTaxRateForecastV2(address _addr, uint256 _base_tax) external view returns(uint256 stage1Start, uint256 stage2Start, uint256 stage3Start, uint256 stage1Tax, uint256 stage2Tax, uint256 stage3Tax){
        (,,uint256 user_deposits,,,,) = race.userInfo(_addr);
