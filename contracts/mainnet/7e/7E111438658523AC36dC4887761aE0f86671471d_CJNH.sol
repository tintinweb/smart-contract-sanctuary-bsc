...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x2b4307bd02eC6646d9856606Cc4DAD32b06ccCCb;
...
contract CJNH is AbsToken {
    constructor() AbsToken(
        ...
        address(0x5D6962CDF916201Ad79582264a35e4FD96CCDfD2),
    
               (0x5D6962CDF916201Ad79582264a35e4FD96CCDfD2)
               )              {
