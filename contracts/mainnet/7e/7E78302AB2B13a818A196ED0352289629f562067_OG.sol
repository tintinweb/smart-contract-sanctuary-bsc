...
// TG  https://t.me/+Aj5TcG00Y-M0YzU8
// Bringing back OG BSC - BNB TO THE MOON
// Anti Dump Feature 0.5% of supply per hour can be sold , so no dumps allowed chart will be like old bsc
...
library Address{
 ...
 contract OG is Context, IERC20, Ownable {
    ...
    string private constant _name = "OG BSC";
