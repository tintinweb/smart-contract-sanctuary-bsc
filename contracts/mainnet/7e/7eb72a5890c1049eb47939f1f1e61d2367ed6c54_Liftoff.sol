...
* Telegram:
 *       MAIN TOKEN:         
 *     https://elonhype.space/             
 *     https://t.me/ElonHypeOfficial 
 *                          
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7730ac665114c0e343B141dAaaeB097197191F8a); //ELONHYPE
...
contract Liftoff is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LiftoffINU";
    string constant _symbol = "LELON";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7730ac665114c0e343B141dAaaeB097197191F8a;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xCe8b4E3155De0bDE4024723fa0116BD899173e98;
