...
/*
   TG : https://t.me/StarscreamEntry
   Twitter: https://twitter.com/STARSCREAMBSC
...
contract STARSCREAM is ERC20, Ownable {
    ...
    constructor() ERC20("STARSCREAM", "STARSCREAM") {
        ...
        maxTransactionAmount = 50 * 1e7 * 1e18; 
        maxWallet = 50 * 1e7 * 1e18; 
        ...
        devWallet = address(0xb1092B1EBa8fd5704D8e5f0C36fE40B6a9625153); 
