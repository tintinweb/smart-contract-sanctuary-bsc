...
contract AIDistrict is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e6 * 10**18; // 0.1% of total supply
    uint256 public maxBuyLimit = 1e8 * 10**18; // 1% of total supply
    uint256 public maxSellLimit = 1e8 * 10**18; // 1% of total supply
    uint256 public maxWalletLimit = 1e8 * 10**18; // 1% of total supply

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x178ae733d0539D4946B6A5c52b61646E4464830D;
    address public treasuryWallet = 0x1321d1876a40a2ad1fb2b58bC21B42010C289eFb;
    ...
    constructor() BEP20("AI District", "AID") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            // Split the contract balance into tree equal parts
            uint256 denominator = feeswap * 3;
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _treasury + _liquidity) <= 4, "Must keep fees at 4% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _treasury + _liquidity) <= 6, "Must keep fees at 4% or less");
    }
