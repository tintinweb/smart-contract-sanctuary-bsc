...
contract HUDLProtocolGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "HUDL Protocol Grow";
    string private constant _symbol = "HUDL GROW";
