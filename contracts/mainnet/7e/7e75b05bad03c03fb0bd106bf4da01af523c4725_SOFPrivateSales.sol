...
contract SOFPrivateSales {
    ...
    uint256 public MAX_DEPOSIT_LIMIT = 70 * 1e18; // MAX DEPOSIT
    address softoken = 0x258A1e13501Da18eA07950253e1adA4c48A05b74; /** SOF token **/

    uint256 transactionCount;
    uint256 public AMOUNT_TO_CHECK = 36000000000;  
    ...
    function Deposit(address payable receiver , string memory email, uint amount) public payable  {
