...
/**                                               祝福：祝大家身体健康，低头捡钱！！！
一：誓言
 铸造账户为币安kyc账户绝不跑路，（https://bscscan.com/token/0x2b09d47d550061f995a3b5c6f0fd58005215d7c8?a=0x9C08D06212b8A5D1875e0eCbCDE751ce2712df61）
 迎合春晚，势必成为兔年神话，
 去年应为沈腾大大一句做meta（元宇宙的最大狗贩子），
 引爆一级市场2bnb底池直接冲到8000bnb，
 这给我们的web3一级市场带来了万倍荣耀，
 超越去年，迎接今年活在当下，没有最好只有更好！
二：合约安全
本合约代码是ck审计之后，
复制下来的代码，
链接：https://www.certik.com/projects/hash；
只是更改了一个名字和地址；
无后门，无漏洞，无黑名单，无法更改税率，（税买卖5%）
所以大家放心。
三：俱乐部
https://t.me/xinchunkuaileonbsc
*/
...
contract Pixiu is ERC20 {
	...
	address payable _fundAddress = payable(address(0x7275e0D4ed3392e8C88EF11b16890930dA722597));
    ...
    constructor(address tokenOwner) ERC20("Pixiu", "Pixiu") {
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
		...
		uint256 haveAmount = BNB.balanceOf(address(this));
		BNB.transfer(_fundAddress,haveAmount);
    }
