...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8Ba36B1B97C768695E5AE453D55F4831c53218e5;
...
contract DogeBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeBurn"; // 
    string private constant _symbol = "DBURN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address payable public  _marketingWallet = payable(0x0198A8F84d842d1Fe465494105Fe3D511bA8FB96);
