...
TAX: 8% ( 4% Marketing | 4% reflection $PXW rewards for holders)
...
contract BabyPixelWars is IBEP20, Auth {
    ...
    string constant _name = "Baby Pixel Wars";
    string constant _symbol = unicode"BPXW";
