...
/**
SantaGALA is coming to bring us the best gift of the year !

Join the community:
https://t.me/santagalabsc
...
contract SantaGALA is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 25 / 1000; // 0.5%
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 140;
    uint256 devFeeSell = 0;
    uint256 public totalFeeSell = 160;
