...
contract MoodDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOOD DOGE";
    string private _symbol = "MoodDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD2bd3962328f6c9E3C113bE08d9Ab0c2E0081e39);
    address payable public teamWalletAddress = payable(0x35Fec073d2C248981270560a4CD48dff8fE9582f);
