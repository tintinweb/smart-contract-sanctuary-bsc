...
contract BNBZebra is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bnb Zebra";
    string private _symbol = "BNBZebra";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5124E249a79eb41515116A288a688abFDac31282); // Marketing Address
    address payable public teamWalletAddress = payable(0xE0fCfaa46019B7db806a96cDA3D0241c67C868Ff); // Team Address
