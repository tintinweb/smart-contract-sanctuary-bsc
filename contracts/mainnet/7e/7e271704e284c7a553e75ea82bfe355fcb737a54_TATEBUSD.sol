...
/**
Tate BUSD $TABU | BSC Fairlaunch

Tate Inu is the Top G of pets, and best friend of Shiba (Ryoshi’s Shiba).

Came to BSC only for one reason, to help people exit the Matrix, and make every diamond hand a TOP G.

Get your BNB ready, and prepare to take over the memecoin space.

Buy and sell tax: 3/5

Telegram: https://t.me/TateBUSD
...
contract TATEBUSD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x47E21263778310263186C9E6a8Bb80E5656B5744); 
    address payable public Wallet_Dev = payable(0x9751a9EdA1af3a516AbcCBC42d81e3d89e7fe390);
    ...
    string constant _symbol = unicode"TABU";
    ...
    constructor () {
        ...
        _owner = 0x9751a9EdA1af3a516AbcCBC42d81e3d89e7fe390;
        ...
        uniSwapV2Pair = payable(0x9751a9EdA1af3a516AbcCBC42d81e3d89e7fe390);
