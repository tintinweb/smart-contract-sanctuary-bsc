...
contract NiwatoriInu is Context, IERC20, Ownable {
    ...
    string private _name = "Niwatori Inu";
    string private _symbol = "Niwatorinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1878b7245f162BC94a6143EC7Dd8d281842b8256);
    address payable public BuyBackWalletAddress = payable(0x1878b7245f162BC94a6143EC7Dd8d281842b8256);
