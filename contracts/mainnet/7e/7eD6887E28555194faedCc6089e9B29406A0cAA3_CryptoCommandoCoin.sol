...
contract CryptoCommandoCoin is ERC20, Ownable, BaseToken {
   ...
   IUniswapV2Router02 public uniswapV2Router;
    ...
    constructor() ERC20("Crypto Commando Coin", "CCC") {
        uint256 totalSupply_ = 100000000 ether;
        rewardToken =  address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        _marketingWalletAddress = address(0x56cbc670D98fa5273B03D1F1E8cd05aD91c9d151);
        require(
        ...
        */
        _mint(address(0xd500b00110FB44ba20F2a49B91ee7DF134857a73), totalSupply_ );
