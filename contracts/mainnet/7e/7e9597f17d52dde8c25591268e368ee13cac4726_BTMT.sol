...
contract ERC20Pausable is ERC20, Pausable {
    function transfer(address to, uint256 value) public whenNotPaused virtual override returns (bool) {
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) public whenNotPaused virtual override returns (bool) {
        return super.transferFrom(from, to, value);
    }

    function approve(address spender, uint256 value) public whenNotPaused virtual override returns (bool) {
        return super.approve(spender, value);
    }

    function increaseAllowance(address spender, uint addedValue) public whenNotPaused virtual override returns (bool success) {
        return super.increaseAllowance(spender, addedValue);
    }

    function decreaseAllowance(address spender, uint subtractedValue) public whenNotPaused virtual override returns (bool success) {
...
contract BTMT is ERC20Detailed, ERC20Pausable, ERC20Burnable {
    ...
    event UpgradeTo(address indexed implementation, address indexed _newImplementation);
    ...
    constructor() ERC20Detailed("Bitman Token", "BTMT", 18) public  {
    ...
    function approve(address spender, uint256 value) public override(ERC20, IERC20, ERC20Pausable) returns (bool) {
        return super.approve(spender, value);
    }
   
    function transfer(address to, uint256 value) public notFrozen(msg.sender) notFrozen(to) override(ERC20, IERC20, ERC20Pausable) returns (bool) {
    ...
    function transferFrom(address from, address to, uint256 value) public override(ERC20, IERC20, ERC20Pausable) returns (bool) {
        return super.transferFrom(from, to, value);
    }
    ...
    function upgradeTo(address _newImplementation) public onlyOwner {
        ...
        emit UpgradeTo(implementation, _newImplementation);
    }
