...
contract STS is IBEP20, Auth {
    using SafeMath for uint256;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    // address private constant ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Satoshi Nakamoto Fan Token";
    string constant _symbol = "STS";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = (taxExcluded[sender] || recipient == pool) ?  amount:takeTax(sender, recipient, amount);
    ...
    function transferTax() internal {
        ...
        _basicTransfer(address(this), marketing, amount);
    }
    ...
    function setMarketingWallet(address _marketing) external authorized {
        taxExcluded[marketing] = false;
