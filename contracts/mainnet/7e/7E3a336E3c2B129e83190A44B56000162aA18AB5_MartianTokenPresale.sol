...
contract MartianTokenPresale is Ownable {
    ...
    constructor() {
        ...
        MartianContractAddress = 0xE61701C0bcCBdABf0B0051b85968a1Ecc8FDcA78;
    ...
    function minContributionInBNB() public view returns (uint256 minBNBRequired) {
    ...
    function GetTokensValue(uint256 _bnbValue) public view returns (uint256 tokenValue) {
        (uint256 bnbPrice) = GetBNB_USDPrice();
    ...
    function BuyWithBNB(uint256 _msgValue) private {
        require(_msgValue >= minContributionInBNB(), "You need atleast $100 value of BNB");
        uint256 tokenValue = GetTokensValue( _msgValue);
        IERC20(MartianContractAddress).transferFrom(TokenOwnerAddress, msg.sender, tokenValue);
    }
    ...
    function ChangeBNBPriceContractAddress(address _address) external onlyOwner {
    ...
    function WithdrawToken(address _tokenAddress, uint256 _value) external onlyOwner {
