...
contract zbit is IERC20,Context,Ownable,Pausable{
    ...
    string private _name = "ZBIT";
    string private _symbol = "ZBIT";
    ...
    address public CharityWallet = 0x769e6A822692B4Eca026282141dFD5c0A8b48750;
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000000000 * 10**18;
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tMarketing = tAmount.div(100).mul(_CharityFee);
        uint256 rMarketing = tMarketing.mul(_getRate());
        rTransferAmount = rTransferAmount.sub(rMarketing);
        tTransferAmount = tTransferAmount.sub(tMarketing);
        _rOwned[CharityWallet] = _rOwned[CharityWallet].add(rMarketing);
        emit Transfer(sender, CharityWallet, tMarketing);
        return(tTransferAmount, rTransferAmount); 
    }
