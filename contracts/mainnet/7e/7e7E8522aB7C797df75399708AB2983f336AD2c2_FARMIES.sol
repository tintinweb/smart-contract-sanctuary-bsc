...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEc57f6cbe3b39e5bdb62716638B4573446a66A98;
...
contract FARMIES is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9A0199efDc020bECCE801c728C45ccB82e3cfB2f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FARMIES";
    string private _symbol = "MIES";
