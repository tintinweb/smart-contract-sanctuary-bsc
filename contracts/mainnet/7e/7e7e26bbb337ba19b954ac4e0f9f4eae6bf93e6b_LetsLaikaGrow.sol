...
contract LetsLaikaGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lets Laika Grow";
    string private _symbol = "LLG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd053272eF9D1e7aA275d7D649AF688D1b46797Aa);
    address payable public teamWalletAddress = payable(0xd053272eF9D1e7aA275d7D649AF688D1b46797Aa);
