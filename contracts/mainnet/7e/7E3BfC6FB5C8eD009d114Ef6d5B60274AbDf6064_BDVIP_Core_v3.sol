...
contract BDVIP_Core_v3 is AccessControlUpgradeable, PausableUpgradeable
{
    struct Product{
    ...
    function initialize(address _NFTContract) public initializer {
        ...
        tempProduct = Product({
           price:   [uint128(100000000000000000000), 90000000000000000000, 82000000000000000000],
           cost1:    48000000000000000000,
           cost2:     2000000000000000000,
       ...
       admin_mint (0x335457De1fa4728B65dD4F0F314a0b6132f0D1CD, 1, 1);
       admin_mint (0xA5335FCf6acA38F40752f09161275533d72C66F9, 1, 1);
       admin_mint (0xA570AD5Ccd48C4Ab8B41BeC9b5774B5C8B94C5Bc, 1, 1);
...
//*************** ADMIN FUNCTIONS ******************************* */
   ...
   function admin_mint(address _receiver, uint256 _parentTokenID, uint8 _level) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused(){
    ...
    function admin_buyProduct(uint256 _receiverID, uint8 _productID, uint32 _itemsAmount, uint128 _price) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused(){
    ...
    function updateProductPrice(uint8 _productIndex, uint128[3] memory _newPrice) public onlyRole(DEFAULT_ADMIN_ROLE){
        require(_productIndex < products.length, "Product index is out of bounds");
