...
/**
 Telegram : t.me/catclassictoken
 Twitter : twitter.com/catclassicbsc
 Website : www.catclassic.org
*/
...
contract CatClassicToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private teamAddress = payable(0x75D1f3c5f5f8D1b31D580e045135db55573fA3f5); // team Address
    ...
    string private _name = "Cat Classic Token";
    string private _symbol = "CATC";
    ...
    uint256 public _teamFee = 13; //team fee will be use for marketing and charity
    uint256 private _previousteamFee = _teamFee;
    
    uint256 private teamDivisor = 13;
    
    uint256 public _maxTxAmount = 20000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 20000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2245125145 * 10**9;
