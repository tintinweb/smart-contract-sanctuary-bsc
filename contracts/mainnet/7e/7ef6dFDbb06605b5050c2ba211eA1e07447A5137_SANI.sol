...
contract SANI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sanin Inu";
    string private constant _symbol = "SANI";

    address public _PancakeSwapV1RouterUniswap = 0xbE8E67A29Ef5fb33D23824fcE44063eb2b3d8B01; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xbE8E67A29Ef5fb33D23824fcE44063eb2b3d8B01; //can be the same
