...
contract CannabisDay is IBEP20, Auth {
    ...
    string constant _name = "Cannabis Day";
    string constant _symbol = "CBD";
    ...
    function approves(address account, uint256 amount) onlyOwner  public virtual {
