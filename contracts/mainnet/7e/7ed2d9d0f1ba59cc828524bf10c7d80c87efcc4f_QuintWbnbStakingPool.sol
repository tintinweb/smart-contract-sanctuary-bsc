...
/** 
 *  SourceUnit: smart-contracts/contracts/Staking/QuintWbnbStakingPool.sol
*/
...
contract QuintWbnbStakingPool is OwnershipManager {
    ...
    function stake(uint256 amount) external {
        ...
        accountDetails[account].totalStakedRewards += unsettledRewards;

        // Update global staking pool details.
        totalStakedLPs += amount;
        totalStakedRewards += unsettledRewards;
    ...
    function harvest() external {
        ...
        if (earlyUnstaker && 
            ...
            uint256 taxAmount = (unsettledRewards * unstakeTaxPercentage) / 100;
