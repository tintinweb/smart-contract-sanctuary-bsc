...
contract NurseCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NurseCat";
    string private _symbol = "NurseCat";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x7831079b9371276d9eef68c073165c63C424bC0E); 
    address payable public ttWal = payable(0x7831079b9371276d9eef68c073165c63C424bC0E); 
