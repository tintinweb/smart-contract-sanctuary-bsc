...
contract TEst3 is ERC20, Ownable {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        devBuyFee = _devFee;
        totalBuyFees = marketingBuyFee + rewardsBuyFee + liquidityBuyFee + _devFee;
        require(totalBuyFees <= 13, "Must keep fees at 13% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalSellFees <= 26, "Must keep fees at 26% or less");
    }
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethFormarketing - ethForRewards - ethForDev;
