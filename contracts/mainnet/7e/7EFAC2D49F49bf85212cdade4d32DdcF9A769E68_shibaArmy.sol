...
/**
        STEALTH LAUNCH TODAY 
           SHIBA ARMY 2.0 
  "Our priority is made our army rich"
   Built by community for community 

    t.me/ShibaArmyOficial
*/
...
contract shibaArmy is Context, IERC20 { 
    ...
    */
    ...
    Wallet_ShibaArmy: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_ShibaArmy = payable(0xD26e7033260D47AE08A6f28c9a3C871Bed1EC5bf); 
    address payable public Wallet_LP = payable(0xD26e7033260D47AE08A6f28c9a3C871Bed1EC5bf);
    address payable public Wallet_Tokens = payable(0xD26e7033260D47AE08A6f28c9a3C871Bed1EC5bf); 
    ...
    string private constant _name = "Shiba Army 2.0"; 
    string private constant _symbol = unicode"ShibaArmy2.0"; 
    ...
    uint256 public Percent_ShibaArmy = 80;
    ...
    constructor () {
        ...
        _owner = 0xD26e7033260D47AE08A6f28c9a3C871Bed1EC5bf;
        ...
        */
        ...
        _isLimitExempt[Wallet_ShibaArmy] = true; 
        ...
        _isExcludedFromFee[Wallet_ShibaArmy] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 ShibaArmy_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((ShibaArmy_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_ShibaArmy = ShibaArmy_Wallet;
    ...
    */
    ...
    //Update the ShibaArmy wallet
    event updatedShibaArmyWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_ShibaArmy(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedShibaArmyWallet(Wallet_ShibaArmy,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_ShibaArmy] = false; 

        Wallet_ShibaArmy = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_ShibaArmy != 0){

            // Calculate how many tokens need to be swapped for BNB (ShibaArmy BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_ShibaArmy / 100;
            ...
            uint256 split_M = Percent_ShibaArmy * 100 / (Percent_AutoLP + Percent_ShibaArmy);
            ...
            // Send BNB to ShibaArmy wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_ShibaArmy, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_ShibaArmy != 0){

            // Swap tokens for BNB and send to ShibaArmy Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_ShibaArmy / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_ShibaArmy, BNB_M);
            ...
            // Create the Auto LP if ShibaArmy is 0
