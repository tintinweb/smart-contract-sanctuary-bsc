...
contract BOXC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOXCASINO TOKEN2.0";
    string private _symbol = "BOXC2.0";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x44654e4005c2e998bC4f310b7d45d33DeFfee8C6); 
    address payable private teamWalletAddress = payable(0x89056c000Ca105c4dDfDcedA6A990f4b183CE38D); 
