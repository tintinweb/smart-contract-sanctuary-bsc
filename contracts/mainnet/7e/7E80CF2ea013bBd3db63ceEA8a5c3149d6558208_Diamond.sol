...
contract Diamond is ERC20 {
    ...
    uint256 public _walletMax = 300 *10**18;
    ...
    constructor() ERC20("Chamion", "Chamion") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0xa6491D49525828109BCA12182335CeAc56644B54);
        marketAddress = address(0x919aa13e20eca9396b53891fbB05Ee9811d8d47F);
        teamAddress= address(0x827aac4c885ABE3A9B993A6b981E83220913ae74);
        ...
        _mint(_tokenOwner, 100000 * 10**18);
        divLpHolderAmount = 1 * 10**16;
        lpTokenDivThres = 60000 * 10**18;
    }
