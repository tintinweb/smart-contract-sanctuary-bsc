...
STEALTHLAUNCH TODAY AT 1PM UTC 

PREVIOS PROJECT VERY GOOD 
...
contract DaimonInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x15BCD844f1a9f14FBaDc2369da2BCF09ce2368c7); // Marketing Address

    address payable public devAddress =
        payable(0x15BCD844f1a9f14FBaDc2369da2BCF09ce2368c7); // Buyback Address

    address payable public liquidityAddress =
        payable(0x15BCD844f1a9f14FBaDc2369da2BCF09ce2368c7); // Liquidity Address
    ...
    string private constant _name = "DAIMON INU";
