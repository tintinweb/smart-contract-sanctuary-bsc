...
contract  TikkyPow  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " tikky Pow ";
    string private _symbol = " POW "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3d1783Faf8FA102372135DbF5318C84D2FE6c373); 
