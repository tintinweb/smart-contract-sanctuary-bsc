...
contract BabyChihuahua is IERC20, Ownable {
    ...
    string _name = "Baby Chihuahua";
    string _symbol = "BabyChihuahua";
    ...
    uint256 totalFee = marketingFee + liquidityFee + TeamFee + reflectionFee; 
    ...
    uint256 smallSwapThreshold = _totalSupply * 20 / 10000;
