...
contract KRSCN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KRISA COIN";
    string private _symbol = "KRSCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcD8bc8d7aA5bb67b459eeD29254D914cBEC6F165); // Marketing Address
    address payable public buybackWalletAddress = payable(0x157dA8541F01C5f52F534dE8934c4cD5c027C17e); // Buyback Address
