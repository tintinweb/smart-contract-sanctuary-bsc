...
contract Shibadogceo is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBADOG CEO";
    string private constant _symbol = "Shibadog";
