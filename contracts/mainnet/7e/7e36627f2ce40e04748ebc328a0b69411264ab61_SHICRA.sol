...
+ Ordinal $SHICRA Inscription 
+ Launchpad for Shibarium 
+ Staking 
#SHICRA #OrdinalShibone #ShibaArmy #Shibarium #Ordinal #NFT


Tokenomics
name  SHIBARIUM CRAFT
Symbol SHICRA
...
contract SHICRA is Context, BEP20, Ownable {
    ...
    string private _name = 'SHIBARIUM CRAFT';
    string private _symbol = 'SHICRA';
