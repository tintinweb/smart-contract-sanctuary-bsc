...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6EC9E2509748f40b0D33Bd6a6f1f29c9265887F7; // owner address
...
contract Browndog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brown dog";
    string private _symbol = "BD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDCbefE40AbD2608493Ede2b0c6386819337406f7); // Marketing Address
    address payable public teamWalletAddress = payable(0xe72f732a8f1BdE18D65B1678cFB4337b83fFb027); // Team Address
    ...
    uint256 public _walletMax = 300000000000000000 * 10**_decimals;
