...
contract CShareRewardPool {
    ...
    uint256 public withdrawFee = 600;
    ...
    uint256 public cSHAREPerSecond = 0.00088 ether; // 59500 cshare / (370 days * 24h * 60min * 60s)
    uint256 public runningTime = 730 days; // 365 days
    ...
    function setWithdrawFee(uint256 _withdrawFee) external onlyOperator {
        require(_withdrawFee <= 10000, "Fee is over") ;
