...
contract bnbUsdtStaking is Ownable {
    ...
    IBEP20 public USDTxBSCmaster;
    IBEP20 public USDTmaster;
    bool private hasStart=true;    
    address public USDT=0x55d398326f99059fF775485246999027B3197955;
    address public wNative=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public token=0xe0ABcf91Ce7F36cD1f3cf8bFCd919D1EE2280702;    
    address public USDTxBSC=0x221C0A7fE75336a47fa840904D9be2Ea0925A513;    
    ...
    constructor() public Ownable(0x9d76c8346f94CA80B1AF6AC54C1E2f451Df9f38F){
        ...
        USDTxBSCmaster = IBEP20(USDTxBSC);      
    ...
    **/
    function buyTokenToUSDT(uint256 _amount) public{   
        ...
        USDTxBSCmaster.burn(msg.sender, _amount);
