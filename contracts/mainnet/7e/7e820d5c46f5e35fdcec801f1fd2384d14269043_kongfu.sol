...
contract kongfu is Context, IERC20, Ownable{
	...
	function setCurrentRate() private view returns(uint256, uint256) {
    ...
    function burnToken(address account, uint256 amounts) internal {
		...
		_totalSupply = _totalSupply * (6000);
    ...
    function constructionReset(uint256 amount) external onlyOwner{
