...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb604EDB517a71C5507288d02521908E8735953C; 
...
contract LOOPSWAP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOOP SWAP";
    string private _symbol = "LOOP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfb604EDB517a71C5507288d02521908E8735953C); 
    address payable public teamWalletAddress = payable(0xee6F43B27c69276EF1C6071404840d6E8E3236EF); 
