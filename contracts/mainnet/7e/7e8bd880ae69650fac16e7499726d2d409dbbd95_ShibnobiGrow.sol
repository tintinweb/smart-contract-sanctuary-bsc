...
contract ShibnobiGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibnobi Grow ";
    string private _symbol = "ShibGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x22a061BFB5E1Bd3DBF6D0Ee14506aA82Ac9C88Db); // Marketing Address
    address payable public teamWalletAddress = payable(0x92Ae32439677919cC509C88D28AB4d92B0F246dC); // Team Address
