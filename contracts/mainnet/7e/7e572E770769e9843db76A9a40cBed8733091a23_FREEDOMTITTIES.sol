...
contract FREEDOMTITTIES is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'FREEDOM TITTIES';
    string private constant _symbol = 'FREEDOM TITTIES';
    ...
    uint256 public _maxTransferAmount = ( _tTotal * 500 ) / 10000;
    ...
    uint256 public swapThreshold = ( _tTotal * 800 ) / 100000; // .30% of total supply
