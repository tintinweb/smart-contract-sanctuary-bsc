...
contract haoxiongdi is Context, IERC20, Ownable {
    ...
    string private constant _name = " Hao Xiong DI"; // 
    string private constant _symbol = " HAO XIONG DI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xc57CC8cf3D728CFc9363be5B9D2cE3f62BF39005;
