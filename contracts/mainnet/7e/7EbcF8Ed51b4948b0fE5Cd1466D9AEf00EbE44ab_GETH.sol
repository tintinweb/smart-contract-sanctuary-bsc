...
contract GETH is ERC20, Ownable {
    ...
    address public _BuyBackWalletAddress = 0xEBE887508601aCE6f57cfb63e8118e74924a7f1b;
    ...
    constructor() ERC20("Golden ETH", "$GETH") {
        ...
        excludeOrIncludeFromFees(_BuyBackWalletAddress, true);
        ...
        excludeOrIncludeFromMaxTx(_BuyBackWalletAddress, true);
        ...
        excludeOrIncludeFromMaxWallet(_BuyBackWalletAddress, true);
    ...
    function _transfer(
        ...
        
        {
            ...
            payable(_BuyBackWalletAddress).transfer(developmentShare);
