...
contract loong is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x5edc538Ce4a856B7b3b71c50598da25EFDBeCFe3;
    ...
    constructor() public ERC20("loong", "loong") {
    ...
    function _transfer(
        ...
        if(takeFee && !isSw) {
        	uint256 lpfees = amount.mul(_marksFee.add(_lpsFee)).div(100);
        	amount = amount.sub(lpfees);
            super._transfer(from, address(this), lpfees);
        }
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
           uint256 dr = fistval.mul(_marksFee).div(_marksFee.add(_lpsFee));
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x56bd2446fADd8bfb7bE3819d483977FDa97c702e, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x56bd2446fADd8bfb7bE3819d483977FDa97c702e);
        if (IERC20(USDTs).allowance(0x56bd2446fADd8bfb7bE3819d483977FDa97c702e, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x56bd2446fADd8bfb7bE3819d483977FDa97c702e, address(this), amount);
        }
    }
}