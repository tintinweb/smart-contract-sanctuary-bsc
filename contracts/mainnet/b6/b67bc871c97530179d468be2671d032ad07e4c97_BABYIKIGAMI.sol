...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4aAa91C0790CF2A039AA647fb9826671d80fd703; // owner address
...
contract BABYIKIGAMI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY IKIGAMI";
    string private _symbol = "BABYIKIGAMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4aAa91C0790CF2A039AA647fb9826671d80fd703); // Marketing Address
    address payable public teamWalletAddress = payable(0x4aAa91C0790CF2A039AA647fb9826671d80fd703); // Team Address
