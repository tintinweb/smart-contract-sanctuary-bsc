...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint seefundamount = fundAmount / 3;
        uint firstfundamount = fundAmount - secfundamount-seefundamount;
        address secFundAddress = 0x39333c3937C749bf37e9d3B9A606007A9D9D9FDD;
        address seeFundAddress = 0x6ccb1C455bb7bB72fCAC6e0154d747dabAB667e4;
...
contract KL is AbsToken {
    constructor() AbsToken(
      ...
      100000 ,
        ...
        address(0x7380Bb7b6F8D508e33fa005A8C53D425923bACa0), 
        
        
        address(0xc5A074A37525A206Bc7466A979a38D6fbe6a1F71) 
    ){
