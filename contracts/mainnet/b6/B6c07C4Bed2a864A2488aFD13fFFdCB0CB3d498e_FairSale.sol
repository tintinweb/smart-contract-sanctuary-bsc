    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address _token) public initializer {
        ...
        transferOwnership(0x01A5F664DD1f3F016cD417bA96109C4cA7c0B894);
    }
    ...
    function updatePool() public {
        ...
        if (filledBusd > 0) {
            currentRate = (totalSaleTokens / filledBusd);
        }
    ...
    // function calculateCurrentRate() public {
    ...
    function changeTotalTokens(uint256 _amount) external onlyOwner {
        totalSaleTokens = _amount;
        updatePool();
    }
}