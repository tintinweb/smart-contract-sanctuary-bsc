...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x55d398326f99059fF775485246999027B3197955);// 2% USDT Rewards
    IDEXRouter router;
...
contract OORTMoneyV2 is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        buybackFeeReceiver = 0xaDfF5E97aCb9A35B87A5a9f4C40A57DA786f7808;//
        teamFeeReceiver = 0xCb4bB02ef2d0f69E628AbE4EcA86E797df8dc389;//
