...
pragma solidity ^0.6.12;
    ...
    contract SHIBAGAMI is Context, IERC20, Ownable {
        ...
        string private _name = 'Shibagami';
        string private _symbol = 'Shiga';
        ...
        function sendETHToMarketing(uint256 amount) private {
            _MarketingWalletAddress.transfer(amount.mul(2).div(8));
            _TeamWalletAddress.transfer(amount.mul(1).div(8));
