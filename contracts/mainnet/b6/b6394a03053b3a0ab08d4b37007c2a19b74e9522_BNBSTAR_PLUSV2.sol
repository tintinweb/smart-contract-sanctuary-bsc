...
contract BNBSTAR_PLUSV2 {    
    ...
    constructor(address _token) public {
        ...
        levelPrice[4] = 500 ether;
        levelPrice[5] = 1000 ether;
        levelPrice[6] = 2500 ether;
        levelPrice[7] = 5000 ether;
    ...
    function buyLevel(uint8 _level,uint256 _amount) external payable {
		depositToken.safeTransferFrom(msg.sender,platform_fee,_amount);
    ...
    function setPayoutAccount(address payable _platform_fee) public onlyContractOwner {
