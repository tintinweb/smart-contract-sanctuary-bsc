...
contract BNBPool is AccessControl, IBNBPool{
    ...
    modifier onlyAuthorized() {
        ...
        "BNBPool:Restricted to only authorized accounts.");
        _;
    }
...
contract MetabetMask is IMetabetMask, Ownable {
    ...
    */
        ...
        public onlyAdmin returns (bytes32)
    {
        ...
        ITokenPool busdPool = new Pool(adminAddress);
        ITokenPool goalPool = new Pool(adminAddress);
        ITokenPool usdcPool = new Pool(adminAddress);
        ITokenPool metabetPool = new Pool(adminAddress);
...
// A Smart-contract that holds the sport Bet funds
contract Pool is AccessControl, ITokenPool{
    using SafeERC20 for IERC20;
