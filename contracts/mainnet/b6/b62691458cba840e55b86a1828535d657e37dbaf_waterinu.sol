...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9Ee7EA967b93C271c343D0b53734b7a865651C8d; // owner address
...
contract waterinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Water Inu";
    string private _symbol = "$WINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9Ee7EA967b93C271c343D0b53734b7a865651C8d); // Marketing Address
    address payable public teamWalletAddress = payable(0x9Ee7EA967b93C271c343D0b53734b7a865651C8d); // Team Address
