...
3% rewards in Bridged Echelon
6% marketing + LP

3% max TRX, 3% max wallet //Increase later

TG: https://t.me/BabyEchelonBsc
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x00EaFc9C1fb1b7f7889c7E91441ab62dE0259ad5);
...
contract BABYECHELON is IERC20, Ownable {
    using SafeMath for uint256;

    
    address REWARD = 0x00EaFc9C1fb1b7f7889c7E91441ab62dE0259ad5;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Echelon";
    string constant _symbol = "BABYECH";
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 0.30
    bool inSwap;
