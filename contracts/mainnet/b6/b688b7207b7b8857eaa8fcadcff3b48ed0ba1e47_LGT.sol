...
contract LGT is IERC20, Ownable {
    ...
    address private buyFundAddress = address(0x2eBEDdC4c93069253C39a116b89EbcE122cf7180);
	address private sellFundAddress = address(0x2eBEDdC4c93069253C39a116b89EbcE122cf7180);
    address private fundAddress = address(0x2eBEDdC4c93069253C39a116b89EbcE122cf7180);
	...
	uint256 public buyFundRate = 1;
	uint256 public sellLpRate = 3;
	uint256 public sellFundRate = 10;
	function changeRate(uint256 _buyFundRate,uint256 _sellLpRate,uint256 _sellFundRate) public onlyOwner {
