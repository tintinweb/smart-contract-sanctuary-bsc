...
/*
 ...
 Find us on TG: https://t.me/stonkyinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbaD61DcF7765C9B7706c61c542Ee28dEaE658169; // owner address
...
contract stonkyinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StonkyInu";
    string private _symbol = "$STONKER"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd8827a463B8E380DcB06dcD7c27A2f039B49B395); // Marketing Address
    address payable public teamWalletAddress = payable(0xd8827a463B8E380DcB06dcD7c27A2f039B49B395); // Team Address
