 ...
 *   @dev     💵 90% Handled by DxSale for IDO.
 *   @dev     💵 5% Marketing wallet initial fund.
 *   @dev     💵 5% Referal and Airdrop.
 *   @dev     💵 53.4% DxSale presale.
 *   @dev     💵 33.6% Liquidity.
 *   @dev     💵 3% DxSale Platform and Security fee.
 *
...
contract ShibaLuffyInuToken is Context, Ownable, IERC20 {
    ...
    function updatePancakePairAddress() external onlyOwner {
