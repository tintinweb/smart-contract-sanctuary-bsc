...
contract TVL is BEP20, BEP20Burnable, Ownable {
    constructor() BEP20("TVL", "TVL") {
        _mint(msg.sender, 777000000000 * 10 ** decimals());
    }


    function claimStuckedTokens (address tkn) external onlyOwner {
       IBEP20 bep20Token = IBEP20 (tkn);
       bep20Token.transfer(owner(), balanceOf(address(this)));
    }
}