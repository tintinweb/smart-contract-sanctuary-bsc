...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb90EBE99Fd1E536F8e3F83a439434d74471640FD; // owner address
...
contract catiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cati Inu";
    string private _symbol = "CINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb90EBE99Fd1E536F8e3F83a439434d74471640FD); // Marketing Address
    address payable public teamWalletAddress = payable(0xb90EBE99Fd1E536F8e3F83a439434d74471640FD); // Team Address
