...
contract Sushineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sushineko";
    string private _symbol = "Suneko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1735eb2766A12018501483E2EAB8f2208ff6fdaC);
    address payable public BuyBackWalletAddress = payable(0x1735eb2766A12018501483E2EAB8f2208ff6fdaC);
