...
contract ArabianChiHuaHua is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian ChiHuaHua";
    string private _symbol = "ARABIANCHH";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xa780d964Bc00e68F662149F4e743CD5602fe070c);
