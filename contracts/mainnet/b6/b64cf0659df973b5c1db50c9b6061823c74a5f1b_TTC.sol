...
contract TTC is ExtendedReflections {
    ...
    uint256 private _maxTxAmount = 35_000_000_000_000 * (10 ** _decimals);
    uint256 private _maxWalletAmount = 35_000_000_000_000 * (10 ** _decimals);
    ...
    constructor (address _marketingAddress) ExtendedReflections("BabySatoshiNakamoto", "BSN", _decimals, _tokenSupply) {
