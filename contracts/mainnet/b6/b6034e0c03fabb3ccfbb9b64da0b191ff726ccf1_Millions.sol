...
💥 https://t.me/millionsentry
🕊 https://twitter.com/millionsbsc
🌎 https://millionss.site/
...
contract Millions is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MILLIONS";
    string private constant _symbol = unicode"$MILLIONS";
    ...
    address payable public DevWallet = payable(0xad9232138253ccdB617C91aBF9A6361473315F1a);
    address payable public MarketingWallet = payable(0x6172654F34A3BAAEF23D97769a8D3cbE2e375c00);
