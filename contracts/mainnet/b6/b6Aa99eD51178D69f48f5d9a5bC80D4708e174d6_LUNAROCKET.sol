...
/**
 Telegram: https://t.me/LunaRocket1000x
...
contract LUNAROCKET is IBEP20, Auth {
    ...
    string constant _name = "Luna Rocket";
    string constant _symbol = "Luna1000x";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 80) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 80) / 100; 
    ...
    address public marketingFeeReceiver = 0x83CAdFfDf4A6730Bd1c261Fc5f3C36a9638D4FDa;
    address public devFeeReceiver = 0x83CAdFfDf4A6730Bd1c261Fc5f3C36a9638D4FDa;
