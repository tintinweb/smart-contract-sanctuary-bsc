...
/**
Telegram : Https://Telegram.me/Haweking

Haweking is a warrior princess endowed with the fortitude
...
contract Haweking is ERC20, Auth {
    ...
    string constant private _name = "HawkEyeKing";
    string constant private _symbol = "Haweking";
    ...
    address private autoLiquidityReceiver = 0x27b6b5dAAc14d2bc61cf1880fdBcA19515194435;
    address private MarketingFeeReceiver = 0x27b6b5dAAc14d2bc61cf1880fdBcA19515194435;
    ...
    function setBMHaweking(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMHaweking(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
