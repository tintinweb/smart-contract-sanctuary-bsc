...
contract SaudiLaika is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Saudi Laika";
    string constant _symbol = "SLAIKA";
    ...
    function updateMaxWalletlimit(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }
    function updateMaxTxLimit(uint256 maxTXPercentage_base1000) external onlyOwner() {
