...
contract Metaverse20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Metaverse2.0";
    string private constant _symbol = "Metaverse2.0";
    uint8 private constant _decimals = 3;
    
    address payable private _developmentAddress = payable(0x1990C6B6D0FeA15a2745145f90d2Dfae67f83167);
    address payable private _marketingAddress = payable(0xFFa7741bbcD688012B894BCC340F68cc9F8B22E8);
