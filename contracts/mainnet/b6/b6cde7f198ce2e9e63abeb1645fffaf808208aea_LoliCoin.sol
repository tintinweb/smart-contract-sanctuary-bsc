...
contract Ownable is Context{
    ...
    function reannounceOwnership()public virtual onlyOwner{
...
interface IUniswapV2Router01{
    ...
    function addLiquidity(address tokenA, address tokenB, uint amountADesired, uint amountBDesire, uint amountAMin, uint amountBMin, address to, uint deadline)
...
contract LoliCoinDividendTracker is Ownable, DividendPayingToken{
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("LoliCoin_Dividend_Tracker", "LOLI_Dividend_Tracker") {
    	claimWait = 1800;
...
contract LoliCoin is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    LoliCoinDividendTracker public dividendTracker;
    ...
    address public _devWalletAddress = 0xfa29a8410899A434612A8B7Ca369665463100fe3;
    uint256 public gasForProcessing = 300000;

    uint256 public _maxWalletTokens = 210000 * (10**18);
    uint256 public _maxTxTokens = 210000 * (10**18);
    ...
    constructor() public ERC20("LoliCoin", "LOLI") {

    	dividendTracker = new LoliCoinDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        LoliCoinDividendTracker newDividendTracker = LoliCoinDividendTracker(payable(newAddress));
        require(newDividendTracker.getOwner() == address(this), "The new dividend tracker must be owned by the BonusTether token contract");
    ...
    function setBUSDRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = BUSDRewardsFee.add(liquidityFee).add(marketingFee).add(devFee);
    }
    ...
    function _transfer(
        ...
        require(amount <= _maxTxTokens, "TX Limit Exceeded");
        require(balanceOf(msg.sender) + amount <= _maxWalletTokens, "Exceeds maximum wallet token amount (1%)");
