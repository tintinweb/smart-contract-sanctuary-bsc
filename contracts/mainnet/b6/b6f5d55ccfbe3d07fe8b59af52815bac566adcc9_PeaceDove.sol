...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    function shouldbute(address shareholder) internal view returns (bool) {}
    function tributeDividend(address shareholder) internal returns (bool) {}
    function mDividend() external returns (bool) {}
    function lativeDividends(uint256 share) internal view returns (uint256) {}
...
contract PeaceDove  is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'PeaceDove ';
  string private constant _symbol = 'PeaceDove ';
