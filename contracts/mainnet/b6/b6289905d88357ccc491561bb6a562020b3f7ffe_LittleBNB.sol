...
Telegram :  https://t.me/littlebnbofficial
...
contract LittleBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little BNB"; // 
    string private constant _symbol = "LBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x59fDa9205566984ba4D76781B6C244908FbF4234
;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 80; 
        uint256 liquidityFee = amount * _liquidityFee / 20; 
