...
✅ Advanced solidity code with innovative system

✅ Inside contract utility

✅ Doxed and professional team

✅ Fair chance of entry for all type of investors, mobile friendly provided CA 

✅ Implemented protection against all kinds of bots

✅ Proper marketing structure, with pre-launch secured deals & trackability post-launch


🟣 https://t.me/OniOfficial    <<  TG group portal 🟣
...
contract YOKAI is IBEP20, Auth {
    ...
    address DEV = 0x227BD5F5512286F9E0895552FfF40Bf78Ef9E651;
    ...
    // Name and symbol
    string constant _name = "YOKAI ONI";
    string constant _symbol = "YOKAI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply *  5000/ 10000; //  on launch
    uint256 public _maxSellTxAmount = _totalSupply * 5000 / 10000; //  tokens
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 10000; // tokens
    ...
    uint256 public swapThreshold = _totalSupply * 5000000 / 10000; // of supply
    ...
    // Enable GREED
    function enableAntiBot(uint256 _seconds) public authorized {
    ...
    function blacklistBOTAddress(address _address, bool _value) public authorized{
