...
https://t.me/ChungusInu

Chungus has no beginning. Chungus has no end. Chungus is infinite. 
Millions of years after our civilization has been eradicated and forgotten, 
Chungus will endure.

Chungus is eternal. The pinnacle of evolution and existence. 
We are but rudimentary creatures of blood and flesh. 
We touch Chungus' mind, fumbling in ignorance, incapable of understanding.

Organic life is nothing but a genetic mutation, an accident. 
Our lives are measured in years and decades. We wither and die. 
Chungus is eternal. Before it, we are nothing.

Chungus imposes order on the chaos of organic life. We exist because Chungus allows it.

Total Supply: 1,000,000,000,000
Max Wallet: 2% (20,000,000,000 Tokens)
Max Transaction: 1% (10,000,000,000 Tokens)
Buy / Sell Tax: 9% 
...
contract ChungusInu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Chungus Inu';
    string private constant _symbol = 'CHINU';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;//total
    ...
    //DevWallets
    address public MarketingWallet=payable(0x18c9ed58490282D1fA82B99eDfD79B5cD82c3Ca1);
    address public Development=payable(0xc48c669FfaAa921736259AF66e6Dc6D79464aE60);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==MarketingWallet||addr==Development;
    }
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 6500000000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*75) / 100);
