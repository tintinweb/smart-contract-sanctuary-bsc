...
contract Spooky is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x1A0201A05998C9912f6e0452003c60c7567a75EE);
    address payable private activityWalletAddress = payable(0xb4891C6a04d2E9e6B00c75aC2CE7A362Aa792ece);
    address payable private liquidityWalletAddress = payable(0x1EFBd307b4daa2e1F751c8b9dFb10e7E56dAd22F);
