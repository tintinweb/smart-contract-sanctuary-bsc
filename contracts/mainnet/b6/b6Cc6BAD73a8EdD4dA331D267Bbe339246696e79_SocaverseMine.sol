...
// File: SocaverseMine.sol


pragma solidity ^0.8.0;

contract SocaverseMine is Ownable {
    ...
    constructor() {
        retoken = IERC20(0x57Af121A8dDb1F9A8FafcF3229c92bF2856A8a29);
        retokenPeS = 20000000000000;
        startTime = 1643359353;
        endTime = 1643359353 + 180 days;
        feeAddress = 0x0AeaD2b619FbA4C3d8068AFf46244D8966205367;
    }
    ...
    function addPool(uint256 _allocPoint, IERC20 _token, uint256 _feePoint, bool _withUpdate) external onlyOwner {
        ...
        pools.push(Pool({token : _token, amount : 0, accUnits : 0, lastRewardTime : uint256(lastRewardTime), allocPoint : _allocPoint, feePoint : _feePoint}));
    }

    function setPool(uint256 _pid, uint256 _allocPoint, uint256 _feePoint, bool _withUpdate) external onlyOwner {
    ...
    function pendingReward(uint256 _pid, address _user) external view returns (uint256){
        ...
        return user.amount * accUnits / 1e12 - user.rewardDebt + user.remainingReward;
    }
