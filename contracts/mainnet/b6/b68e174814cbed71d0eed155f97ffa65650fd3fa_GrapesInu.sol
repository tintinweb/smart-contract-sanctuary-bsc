...
contract GrapesInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grapes Inu"; // 
    string private constant _symbol = "Grapes"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x8020E051B7a10357bf4A957FeCDD0df7E04eF158;
