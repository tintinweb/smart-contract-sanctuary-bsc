    ...
    IERC20
{
    ...
    address managerAddress = 0xC2F8Cd61cBE09fb0A1373c83fEC1644Da47475B6;
    uint256 cardRatio = uint256(400);
    address cardAddress = 0x0A6866Da76f124eE1f8C9B8B432cDE223DFC9742;
    uint256 rankingRatio = uint256(100);
    address rankingAddress = 0x868b6e148625bfF42aC9Fbc4e2F20847c8Ea5C89;
        ...
        internal 
    {
        ...
        emit Transfer(sender, address(this), awardAmount);
        ...
        internal
    {
        ...
        token.transfer(managerAddress, managerAmount);
        uint256 cardAmount = amount * cardRatio / totalRatio;
        token.transfer(cardAddress, cardAmount);
        uint256 rankingAmount = amount * rankingRatio / totalRatio;
        token.transfer(rankingAddress, rankingAmount);
