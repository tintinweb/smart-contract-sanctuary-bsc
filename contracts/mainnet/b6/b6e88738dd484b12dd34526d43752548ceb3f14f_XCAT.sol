...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC8936164EF21A887f5b764dAf3e308Cc6D76d686; // owner address
...
contract XCAT is Context, IERC20, Ownable {
    ...
    string private _name = " Xmas Cat ";
    string private _symbol = " XCAT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC8936164EF21A887f5b764dAf3e308Cc6D76d686); // Marketing Address
    address payable public teamWalletAddress = payable(0xC8936164EF21A887f5b764dAf3e308Cc6D76d686); // Team Address
