...
contract TestGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Test GROW"; // Edit Name
    string constant _symbol = "Test"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 10000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public liquidityFee    = 2; // Edit Liquidity Fee
    uint256 public reflectionFee   = 3; // Edit BUSD Reward Fee
    uint256 public marketingFee    = 5; // Edit Marketing Fee
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 1000; // Adjust Auto-Sell (10 = 0.1%)
    bool inSwap;
