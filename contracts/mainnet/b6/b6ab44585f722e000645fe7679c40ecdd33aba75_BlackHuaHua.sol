...
contract BlackHuaHua is IBEP20, Ownable {
    ...
    string constant _name = "BlackHuaHua";
    string constant _symbol = "$BHH";
    ...
    address public marketingFeeReceiver = 0x906DD2B090654e974425119c91Edb4d0C967b3d2;
