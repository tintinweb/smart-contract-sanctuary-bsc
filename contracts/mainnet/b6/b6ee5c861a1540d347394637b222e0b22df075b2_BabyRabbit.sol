...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        autoSell = autoConfig(true, 5, 10000, 1000000000);
        allot = Allot(750, 0, 250, 1000);

        /*
        address[] calldata marketingAddress = new address[];
        marketingAddress.push(address(0xBBbE21e9ba573eC757efd73752d1868F06836a1E));

        uint256[] memory shares = new uint256[];
        shares.push(1);

        setMarketing(marketingAddress, shares); // can not be compiled
        */
    }
...
contract BabyRabbit is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("BabyRabbit", "BabyRabbit") {
        ...
        address _initHolder = 0x957A1FBdD47e143792C3813f4cB79724ebc032aD;
