...
//
// DAFU PROTOCOL COPYRIGHT (C) 2022 
...
contract Dafuu is ERC20Detailed, Ownable {
    ...
    string public _name = "Dafu";
    string public _symbol = "DAFU";
    ...
    constructor() ERC20Detailed("Dafu", "DAFU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xAC014Da803E893fD649062c25745b38131A07794;
        treasuryReceiver = 0x8359b403f11F8250b359989e6273e8075A03BEaB; 
        safuuInsuranceFundReceiver = 0x50a22a7494Ddb6941C47351e6c7071050a76D6F8;
        firePit = 0x18B853C78f81fa98792d00C1218c04E34b7BAb65;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Dafu token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
