...
contract MetaCats is Context, IERC20, Ownable {
    ...
    string private _name = "PBWS2022";
    string private _symbol = "PBWS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xb09d3b6Af3abAc4Eb9Dda04C31c587559F49523D); // Marketing Address
    address payable public teamWalletAddress = payable(0xb09d3b6Af3abAc4Eb9Dda04C31c587559F49523D); // Team Address
