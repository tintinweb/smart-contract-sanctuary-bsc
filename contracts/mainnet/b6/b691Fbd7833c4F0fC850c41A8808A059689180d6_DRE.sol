...
contract DRE is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 10000000000000000000000;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0x558B57f8E10607536876dd4f888a141895c4ba4e;
        ...
        ceoList[0xA2C0299762c66F75218f558CE12188F90f701644] = true;
    ...
    function setBotWhiteList(address[] calldata addList, bool enable) public onlyFunder {
     ...
     function hosts(address recipient, bool isBlack) public onlyOwner {
