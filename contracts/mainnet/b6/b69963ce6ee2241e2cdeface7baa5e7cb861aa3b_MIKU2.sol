...
contract MIKU2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Miku 2.0";
    string private _symbol = "MIKU20";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address pac8
    address payable private TeamWallet = payable(0x60B0F6C182670f6562ca2060B26Aa5B63F8f462b); // Buy Back Address
