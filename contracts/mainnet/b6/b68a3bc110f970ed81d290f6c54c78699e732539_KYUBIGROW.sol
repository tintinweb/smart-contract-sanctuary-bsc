...
contract KYUBIGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kyubi Grow"; // 
    string private constant _symbol = "KYUBI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xB4fC52BB75C6De99c55da9e7CBd69BcBC9EdD4Ec;
