...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x666c78d2ec81987850528051a450Af024BAb2c87; // owner address
...
contract FullTrustPal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FullTrustPal";
    string private _symbol = "$FTP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x666c78d2ec81987850528051a450Af024BAb2c87); // Marketing Address
    address payable public teamWalletAddress = payable(0x666c78d2ec81987850528051a450Af024BAb2c87); // Team Address
