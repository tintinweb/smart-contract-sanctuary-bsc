...
TELEGRAM: https://t.me/NOVYIUM
WEBSITE: https://novyium.network/
...
contract NOVYIUM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 780000000 * 10**9;
    uint256 public _maxTxAmount = 23400000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**9; //
    string private constant _name = "NOVYIUM"; // 
    string private constant _symbol = "NOVYIUM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7D60138B1277c36f65cF766fb3F34105A0b66416;
