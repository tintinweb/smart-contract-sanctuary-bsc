...
 Liu Bei Coin 
about this coin simply
 7% Tax
 2% Dev Wallet

my steps as a dev
1. Pancakeswap Listing 
2. Verified Contract to avoid sniper
3. Lock Liquidity Pool
4. Renounce
5. Get more member
6. Doing the marketing step by step

 Telegram : https://t.me/liubeicoin
 Website : https://t.me/devprojectpump
...
contract LiuBeiCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1090501000 * 10**9;
    uint256 public _maxTxAmount = 1090501000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 0.005 * 10**9; //
    string private constant _name = "Liu Bei Coin"; // 
    string private constant _symbol = "$LIUBEI"; //    
