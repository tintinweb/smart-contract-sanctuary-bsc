...
contract LBRGToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "LBRG";
    string private _name= "LIBRA GAINS";
...
contract LBRGTokenSale {
    address payable admin;
    LBRGToken public tokenContract;
    ...
    constructor(LBRGToken _tokenContract, uint256 _tokensSold)  {
