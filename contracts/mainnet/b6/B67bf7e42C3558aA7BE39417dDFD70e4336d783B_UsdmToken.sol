...
contract UsdmToken is ERC20, Ownable {
    bool isAntiBotModeEnabled = true;
    IUniswapV2Router02 public uniswapV2Router02;
    mapping(address => bool) antiBotModeWhitelist;

    constructor(address _uniswapV2Router02) ERC20("Usdm Token", "USDM") {
        uniswapV2Router02 = IUniswapV2Router02(_uniswapV2Router02);
        address _uniswapV2Pair = IUniswapV2Factory(uniswapV2Router02.factory())
    ...
    function setAntibotModeWhitelist(
        address[] memory toAddAddresses,
        address[] memory toRemoveAddresses
    ) public onlyOwner {
        for (uint256 i = 0; i < toAddAddresses.length; i++)
            antiBotModeWhitelist[toAddAddresses[i]] = true;
        for (uint256 i = 0; i < toRemoveAddresses.length; i++)
            antiBotModeWhitelist[toRemoveAddresses[i]] = false;
    }
