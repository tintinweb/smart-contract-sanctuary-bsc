...
contract MetaSwapFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0x2423B8F754AC12f1Fb2Ef5f93ea5F73e3648591b);
    uint8 public _houseFeePercentage = 30; // In 0.1% increments

    address public _devFeeReceiver = address(0x2423B8F754AC12f1Fb2Ef5f93ea5F73e3648591b);
