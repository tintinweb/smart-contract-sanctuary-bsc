...
/**
Telegram https://t.me/yearsoftherabbit
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeE631932BAF696C7C3F176b92b2b23002e237e2A; // owner address
...
contract HappyNewYears is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Years Of The Rabbit";
    string private _symbol = "HappyNewYears";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeE631932BAF696C7C3F176b92b2b23002e237e2A); // Marketing Address
    address payable public teamWalletAddress = payable(0xeE631932BAF696C7C3F176b92b2b23002e237e2A); // Team Address
