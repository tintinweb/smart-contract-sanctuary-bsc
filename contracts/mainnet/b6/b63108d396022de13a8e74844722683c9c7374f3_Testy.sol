...
//When you get the chance import SM from openzeppelin to make it cleaner
/**
...
contract Testy is IBEP20, Auth {
    ...
    string constant _symbol = "TESTYTEST";
   ...
   // cryptoD
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xF4173826EBe06d6Be6991cF265623951Ca424727;
        marketingFeeReceiver = 0xF4173826EBe06d6Be6991cF265623951Ca424727;
 
        _balances[msg.sender] = _totalSupply;
        emit Transfer(address(0), msg.sender, _totalSupply);
    }
    function recoverBNB() public onlyOwner() { address payable wallet = 0xF4173826EBe06d6Be6991cF265623951Ca424727;
...
abstract contract Pausable is Context, Auth {
    /**
