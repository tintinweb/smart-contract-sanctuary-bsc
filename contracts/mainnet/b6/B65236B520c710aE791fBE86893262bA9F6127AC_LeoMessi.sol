...
contract LeoMessi is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 20 * 10e18;
    
    //market 营销钱包
    address public marketingWallet = 0xc042A4819B8452abC98d531Ea4390C49D8CbA306;
    ...
    //代币名称、代币符号
    constructor() ERC20("Leo Messi", "Leo Messi") {
        _mint(msg.sender, 1e18 * 10 ** decimals());
