...
/**
        ...
        TG: https://t.me/MiniBullsWorldBSC
...
contract MINIBULLSWORLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Bulls World";
    string private _symbol = "MBULLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2F186975A05874b0CC88754016c3F43Ce04f9A2d); 
    address payable public teamWalletAddress = payable(0xC43c9fcBcb39a4282Ed58C91424756754Cf101C2); 
