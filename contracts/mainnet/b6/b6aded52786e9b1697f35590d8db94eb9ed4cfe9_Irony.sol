...
contract Irony is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA3161386C87f4B52a9da5bdCED9cB4cCd708Fa34); 
    address payable public Wallet_Developer = payable(0xfc63a67cA8ED7Fe83B9875C56960978ec079985B);
    ...
    string private constant _name = "Irony"; 
    ...
    constructor () {
        ...
        _owner = 0xfc63a67cA8ED7Fe83B9875C56960978ec079985B;
