...
contract ThoreumMiner_upgradeable_v3 is Initializable, UUPSUpgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function retrieveTokens(address token) external onlyOwner returns(bool){
        require(token != address(token_MAIN),"Cannot retrieve main token");
