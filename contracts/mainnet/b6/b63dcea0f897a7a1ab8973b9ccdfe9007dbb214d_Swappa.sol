...
contract Swappa is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x97605D9aB2968a3E0251F196Ae2a596651b48881); // Marketing Address
        
    address payable public CharityAddress =
        payable(0x97605D9aB2968a3E0251F196Ae2a596651b48881); // Charity Address
        
    address payable public liquidityAddress =
        payable(0x97605D9aB2968a3E0251F196Ae2a596651b48881); // Liquidity Address
    ...
    string private constant _name = "Swappa";
    ...
    event UpdatedCharityAddress(address buyback);
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 40 / 1000; // 2% maxTransactionAmountTxn
        maxWallet = _tTotal * 4 / 100;  // 4% Max wallet
    ...
    */
    ...
    function _transfer(
     ...
     if(limitsInEffect){
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _marketingTokensToSwap + _CharityTokensToSwap;
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(boughtEarly[from]  && earlyBuyPenaltyEnd <= block.number){
                    _taxFee = _taxFee * 35;
                    _liquidityFee = _liquidityFee * 35;
                }
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap.add(_CharityTokensToSwap).add(_marketingTokensToSwap);
        ...
        (bool success,) = address(CharityAddress).call{value: bnbForCharity}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyCharityFee <= 20, "Must keep taxes below 20%");
        emit SetBuyFee(buyMarketingFee, buyLiquidityFee, buyTaxFee, buyCharityFee);
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellCharityFee <= 20, "Must keep taxes below 20%");
        emit SetSellFee(sellMarketingFee, sellLiquidityFee, sellTaxFee, sellCharityFee);
    }
    ...
    function setCharityAddress(address _CharityAddress) external onlyOwner {
        ...
        _isExcludedFromFee[CharityAddress] = true;
        emit UpdatedCharityAddress(CharityAddress);
    }
