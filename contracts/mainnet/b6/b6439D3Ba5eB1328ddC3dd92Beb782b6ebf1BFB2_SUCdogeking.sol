...
contract SUCdogeking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUCdogeking";
    string private _symbol = "SUCdogeking";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x0f48F9e5f6671BA0DDBebfBC134874626250F8F3); 
    address payable public ttWal = payable(0x0f48F9e5f6671BA0DDBebfBC134874626250F8F3); 
