...
/**
BOUNDMAN INU 
is a community token meme that we created with the full aim of the community, be a part of BOUNDMAN and let’s make a strong community.

Join Boundman Community
Telegram https://t.me/BOUNDMANINU
Twitter https://twitter.com/boundmaninu
Website https://boundmaninu.com
*/
...
contract BoundmanInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBA9CD15A7e9eABA12AE34f4Cae65b58aaAcd7F76); 
    address payable public Wallet_Dev = payable(0xBA9CD15A7e9eABA12AE34f4Cae65b58aaAcd7F76);
    ...
    string private constant _name = "Boundman Inu"; 
    string private constant _symbol = unicode"Boundman"; 
    ...
    constructor () {
        ...
        _owner = 0xBA9CD15A7e9eABA12AE34f4Cae65b58aaAcd7F76;
