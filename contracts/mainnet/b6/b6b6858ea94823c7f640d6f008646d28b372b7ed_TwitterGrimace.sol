...
/**
Telegram : https://t.me/TwitterGrimace
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0aCC352b0A601DC9E01ce351a4035117336d2bb4; // owner address
...
contract TwitterGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Grimace";
    string private _symbol = "TGRIM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0aCC352b0A601DC9E01ce351a4035117336d2bb4); // Marketing Address
    address payable public teamWalletAddress = payable(0x0aCC352b0A601DC9E01ce351a4035117336d2bb4); // Team Address
