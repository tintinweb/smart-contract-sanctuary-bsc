...
contract PyroMatic  is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "PyroMatic";
    ...
    address public burnAddress = 0xbe289Bd49BeBd376bF2988f67aa7Bce43E9C07C9;
    address payable private _marketingWallet = payable(0xbe289Bd49BeBd376bF2988f67aa7Bce43E9C07C9);
    address payable private _devWallet = payable(0xbe289Bd49BeBd376bF2988f67aa7Bce43E9C07C9);
    ...
    uint256 private maxTxPercent = 500; // Less fields to edit
    ...
    uint256 private maxWalletPercent = 500; // Less fields to edit
    ...
    uint256 public percentToSell = 1 ;
