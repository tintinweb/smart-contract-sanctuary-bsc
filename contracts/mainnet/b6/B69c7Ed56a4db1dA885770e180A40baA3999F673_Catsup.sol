...
/*
* A fork of JACKPOT Token. CREATE A TG FOR THIS. Lottery will automatically run once it reaches a new ATH*/
...
contract Catsup is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'CATSUP';
    string  private constant _SYMBOL = 'CTS';
