...
/**
 *
    ___      _  _     __     ___        _        _  _      ____    _  _      _     
   F __".   FJ  L]    FJ    F _ ",     /.\      F L L]    F __ ]  FJ  L]    /.\    
  J (___|  J |__| L  J  L  J `-'(|    //_\\    J   \| L  J |--| LJ |  | L  //_\\   
  J\___ \  |  __  |  |  |  | ,--.\   / ___ \   | |\   |  | |  | |J J  F L / ___ \  
 .--___) \ F L__J J  F  J  F L__J \ / L___J \  F L\\  J  F L__J JJ\ \/ /F/ L___J \ 
 J\______JJ__L  J__LJ____LJ_______JJ__L   J__LJ__L \\__LJ\______/F\\__//J__L   J__L
  J______F|__L  J__||____||_______F|__L   J__||__L  J__| J______F  \__/ |__L   J__|

TG // https://t.me/ShibaNovaBSC
WEB // https://shibanova.space/                                                                                
*/
...
contract ShibaNova is IBEP20, Auth {
    ...
    string constant _name = "ShibaNova";
    string constant _symbol = "SNOVA";
    ...
    address public MarketingWallet = 0x76060c4b8c448E0d25EABf2D78c71b67fEece0a4;
    address public devFeeReceiver = 0x76060c4b8c448E0d25EABf2D78c71b67fEece0a4;
    ...
    function ChangeFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function Antibot(address _address, bool _value) public onlyOwner{
