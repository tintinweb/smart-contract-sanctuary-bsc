...
contract NihonKenInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8f80e96D2F0e2462B82DB8D39B5107722eF248b9); 
    address payable public Wallet_Dev = payable(0x5EC72E7fB2aE4ADC67280F99a2f6204dAD657EDD);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "NihonKenInu"; 
    string private constant _symbol = unicode"日本ケン";
