...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2Bcce493B852fB7a106A541518FA5dB40DA98c4e;
...
contract Samsunghype is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x690DE3fcFedF31cc3625AcE656e6Abd53BD48493;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SAMSUNG HYPE";
    string private _symbol = "SAMSUNG";
