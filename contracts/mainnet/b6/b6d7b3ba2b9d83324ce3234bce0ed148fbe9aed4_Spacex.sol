...
contract Spacex is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceX2.0";
    string private _symbol = "SpaceX2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCB40dd773D328d4234838bc74e4D7c9767cEF634);
    address payable public teamWalletAddress = payable(0xCB40dd773D328d4234838bc74e4D7c9767cEF634);
