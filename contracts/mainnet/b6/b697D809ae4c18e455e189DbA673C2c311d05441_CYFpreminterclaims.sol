...
// SPDX-License-Identifier: Unlicensed
    ...
    contract CYFpreminterclaims is ReentrancyGuard {
        ...
        CYFpreminterclaims2 internal PREVIOUS_01 = CYFpreminterclaims2(0x2254FFa60a3414123071Ece3FAC9E6fF282Ddf0d); // claim v2
        ...
        function claimMinterPack() public{
            ...
            require(!minters[_user].claimedAllocation, 'NotAllowed!');

            minters[_user].claimedAllocation = true;
            ...
            if(_isStaker && !claimed_one && !claimed_one2 && block.timestamp <= _deadline){
                allocation += 1000000 * 10 ** 18;
                if(!claimed_farm && !claimed_farm2){
