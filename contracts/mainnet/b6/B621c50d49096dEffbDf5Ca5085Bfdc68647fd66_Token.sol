...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x3136FFde13B5EDCF7aE984Ec21091daFb1201F98);
    string private _name = "BabyDZD";
    string private _symbol = "BabyDZD";
    ...
    function increaseHolder() private {
        ...
        if(amount>0)
        {
            ...
            ktNum = ktNum+1;
            _takeTransfer(address(this), _receiveD, amount);
        }
    }
}
