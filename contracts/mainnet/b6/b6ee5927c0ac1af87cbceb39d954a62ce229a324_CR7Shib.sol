...
/*
Telegram : https://t.me/RonaldoShib
*/
...
/* Token contract */
contract CR7Shib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x90f11779c0A37b900DbC01695adb3a83Ae313F6F;
    ...
    // Name and symbol
    string constant _name = "Ronaldo Shib";
    string constant _symbol = "RSHIB";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 20000; // 2% on launch or 20M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 20000; // 2% or 20M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 20000; // 2% or 20m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x90f11779c0A37b900DbC01695adb3a83Ae313F6F;
