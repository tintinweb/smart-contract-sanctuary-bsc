...
contract AWKC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alpha WiKi Cat";
    string private _symbol = "BWKC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4e8529aE462E9e5a0d523c27b9f976d9E8639118); // marketing wallet
    address payable lotteryWallet = payable(0xE909F56146C3287568ab8E564A1bAcDFAD75a4B1);  // lotterywallet
