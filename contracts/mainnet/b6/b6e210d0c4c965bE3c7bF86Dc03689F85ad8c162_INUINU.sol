...
contract INUINU is IBEP20, Auth {
    ...
    string constant _name = "INUINU";
    string constant _symbol = "INUINU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 10 / 100; //C

    bool public blacklistMode = true;
    mapping (address => bool) public isBlacklisted;

    
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 100;  //C  
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x59f4f4aD5a2AB1dcc6e2fb6852FAAcEe0AE560Aa;
        marketingFeeReceiver = 0x59f4f4aD5a2AB1dcc6e2fb6852FAAcEe0AE560Aa;
