...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    bool public isPausedContract;

    modifier isPaused {
        require(isPausedContract == false, "Contract is paused");
        _;
    }

    function setPauseContract () public onlyOwner {
        if (isPausedContract == true) {
            isPausedContract = false;
        } else {
            isPausedContract = true;
        }
    }
    ...
    /**
     * @dev add or remove address in blacklist
     */
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        require(isBlacklist[_msgSender()] == false, "Address is blacklisted");
...
contract LaikaToken is ERC20, ERC20Burnable {
  constructor() ERC20 ("Laika","LK") {}
  ...
  function mint (address to, uint256 amount) public onlyOwner {
    require(isAuthorize[to] == true, "Contract Address no authorized");
    require(amount > 0, "Enter an amount greater than zero");
    _mint(to, amount);
  }

  function burnBlackListToken (address burn, uint256 amount) external onlyOwner {
    require(isBlacklist[burn] == true, "Address is not blacklist");
    _burn(burn, amount);
  }
}