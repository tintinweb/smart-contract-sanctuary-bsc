...
// Telegram : https://t.me/dogepower_bsc
...
contract dogepower is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE POWER";
    string private _symbol = "DPOWER";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xaaAa299EC975405ccd1367852c0fE7eeB05bce8B); // Marketing Address
    address payable public teamWalletAddress = payable(0xaaAa299EC975405ccd1367852c0fE7eeB05bce8B); // Team Address
