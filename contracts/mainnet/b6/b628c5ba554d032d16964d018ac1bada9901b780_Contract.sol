...
contract Contract is Context, IERC20 { 
    ...
    */
    ...
    function Deploy_05__Wallet_Limits(
        ...
        require(Max_Tokens_Per_Transaction >= _tTotal / 1000 / 10**_decimals, "Min 0.1%");
        require(Max_Total_Tokens_Per_Wallet >= _tTotal / 1000 / 10**_decimals, "Min 0.1%");
    ...
    */
    ...
    function Deploy_08__Blacklist_Bots(address Wallet, bool true_or_false) external onlyOwner {
        ...
        if (true_or_false){require(LaunchTime == 0, "pre-launch only");}
    ...
    */
    ...
    function tokenFromReflection(uint256 _rAmount) internal view returns(uint256) {
        require(_rAmount <= _rTotal, "Over Ref");
    ...
    */
    ...
    function _transfer(
        ...
        if (LaunchPhase && to != address(this) && _isPair[from] && to != owner())
            ...
            require(amount <= max_Tran_Launch, "OverTX");
        ...
        require(!_isBlacklisted[to] && !_isBlacklisted[from],"BL");
        ...
        if (!_isLimitExempt[to] || !_isLimitExempt[from])
            {
            require(amount <= max_Tran, "OverTX");
            }
