...
contract PitbullFork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PitbullFork";
    string constant _symbol = "PITFORK";
    ...
    constructor () Auth(msg.sender) {
        ...
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        pair = IDEXFactory(router.factory()).createPair(CAKE, address(this));
