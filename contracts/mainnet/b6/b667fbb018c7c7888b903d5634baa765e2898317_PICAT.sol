...
contract PICAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Picat 2.0";
    string private _symbol = "$PIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0527269B08bc87e123B900bEc4a22d4b4E80Be08); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0527269B08bc87e123B900bEc4a22d4b4E80Be08); // BuyBack Address
