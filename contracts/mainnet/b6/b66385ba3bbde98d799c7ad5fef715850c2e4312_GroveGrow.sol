...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53669773b0b7BA056b4362EDa6BEc5426D4eF32e; // owner address
...
contract GroveGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GroveGrow";
    string private _symbol = "GG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3972e4442680d848D95C5A833500e64BFAFAd230); // Marketing Address
    address payable public teamWalletAddress = payable(0x3972e4442680d848D95C5A833500e64BFAFAd230); // Team Address
