...
contract BNB201R0Cket is IBEP20, Auth {
    ...
    string constant private _name = "1R0CKET";
    string constant private _symbol = "1RCK";
    ...
    address public marketingFeeReceiver = 0x5E120702bBC63B743f9eEBCB281755C0F30Aef9f;
    address public devFeeReceiver = 0x6fa4f79d45BF439cF3e06729a5aE1E812aBa6433;
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function changeFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
    ...
    function SetNFTHolderStatus(address holder, bool exempt) external authorized {
