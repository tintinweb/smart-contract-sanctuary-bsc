...
contract ShireGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shire Grow";
    string private _symbol = "SHIREGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x096218522471020CD98E29D121EF16EF6F81F6D7);
    address payable public BuyBackWalletAddress = payable(0x096218522471020CD98E29D121EF16EF6F81F6D7);
