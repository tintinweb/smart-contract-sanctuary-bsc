...
1% max tx
2% max wallet
1% max sell will change on higer marketcap
*/
...
contract BabyHoichi is IBEP20, Auth {
    ...
    address MarketingWallet = 0xBC1Fc24dcC99262119d2C6e204B26ce9BC930Adb; //mw dj
    address DevWallet       = 0xBC1Fc24dcC99262119d2C6e204B26ce9BC930Adb; //dw sfz

    string constant _name = "Baby Hoichi";
