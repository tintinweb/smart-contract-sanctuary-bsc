...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address secFundAddress = 0x7ac6cf6ef3A950CDAFc7f4442C462067484FabfC;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 2 / 10000;
            if (burnAmount > 0) {
...
contract Abs is AbsToken {
    constructor() AbsToken(
        ...
        address(0x5934ff563e944AcA5a6BE2bB104366F8E05b132B),
    
        address(0x6c002C192ea869b263Eb2076C19f2dda2B343e23)
    ){
