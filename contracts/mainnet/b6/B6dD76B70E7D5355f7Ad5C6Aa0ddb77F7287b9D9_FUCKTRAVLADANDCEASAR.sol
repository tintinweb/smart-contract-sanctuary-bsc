...
Telegram link :https://t.me/Caesars_Calls

Website : https://t.me/AMA_Central
*/
...
contract FUCKTRAVLADANDCEASAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCK TRAVLAD AND CEASAR";
    string private _symbol = "FTAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5f532e6A7aDc0cC1F88ABBE502C4BFb70036b9B); // Marketing Address
    address payable public teamWalletAddress = payable(0xD5f532e6A7aDc0cC1F88ABBE502C4BFb70036b9B); // Team Address
