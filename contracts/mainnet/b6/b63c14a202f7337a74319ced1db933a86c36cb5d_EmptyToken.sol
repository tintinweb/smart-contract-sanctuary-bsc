...
/* 
Empty Token No space No roadmap No Team 
just Empty space
#BSC #Gem #Moonshoot #Lowbsc

Telegram https://t.me/EmptyToken
max wallet 100%
max txs 100%
launch 100%
100% Empty Token
no team no marketing no serious project
Empty Token Empty Token Empty Token Empty Token
lazy dev for lazy and noobs traders
*/
...
contract EmptyToken is ContextBep20, Bep20, OwnableBep20 {
   ...
   uint256 public _maxTxAmount = _allTotalSupply.div(100).mul(20);
    uint256 public _maxWalletToken = _allTotalSupply.div(100).mul(20);
