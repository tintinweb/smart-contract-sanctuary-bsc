...
If you make the biggest buy (in BNB) you become the VIC20, and collect 5% fees (in BNB) the same way marketing does. 
If you sell any tokens at all at any point you can never be the VIC20. 
If someone beats your record, they become the VIC20. 
If you sell while the VIC20, the marketing wallet becomes VIC20 and the record is reset to 0, this way no one can buy a ton and then sell and keep collecting tax fees.
The VIC20 is set via biggest buy in BNB.
The point is to reward big buys. There are no punishments other than disallowing sellers to be the VIC20.

Each VIC20 has a timelimit. After 30 minutes (can be changed), they cease to be VIC20 and the record is reset to 0, giving more a chance and increasing volume.
*/
