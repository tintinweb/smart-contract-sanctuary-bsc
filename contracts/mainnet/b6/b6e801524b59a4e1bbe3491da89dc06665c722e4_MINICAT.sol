...
contract MINICAT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x10D029b1b0f4f752D0dCE835329c9Cbc0B22D9Bf); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x676929CeBb5dfF53c857E17c91dB3a2d93183b9E); // Liquidity Address
    ...
    string private constant _name = "MINICAT";
    string private constant _symbol = "MINICAT";
    ...
    constructor() {
        address newOwner = address(0x1946d7e4B6cAc8cD0eBDEed23Be0808ac699f8A1);
        ...
        if(limitsInEffect){
            if (
                ...
                if(from != owner() && to != uniswapV2Pair){
                    if(block.number == tradingActiveBlock +1 || block.number == tradingActiveBlock){
                        boughtEarly[to] = true;
                        emit BoughtEarly(to);
                    }
                }
