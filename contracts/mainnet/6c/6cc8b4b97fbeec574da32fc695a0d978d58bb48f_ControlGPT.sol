...
Telegram: https://t.me/Control2XY
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48feE97450f63B2cABf4c280b36c3B0D14739a4d; // owner address
...
contract ControlGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ControlGPT";
    string private _symbol = "2XYGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48feE97450f63B2cABf4c280b36c3B0D14739a4d); // Marketing Address
    address payable public teamWalletAddress = payable(0x48feE97450f63B2cABf4c280b36c3B0D14739a4d); // Team Address
