...
contract  HongHongTu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name ="HongHongTu";
    string private _symbol = "HongHongTu";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xfBEd5e276277316d03e3C2482afD5d9E45D95977));
        ruinWalletAddress = payable(address(0xfBEd5e276277316d03e3C2482afD5d9E45D95977));
