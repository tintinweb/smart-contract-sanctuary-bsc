...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function enharness(address newOwner) external onlyOwner returns (bool) {
...
contract HUOGUO is AuthOwner {
    ...
    function enlarge(address sender, uint256 target, uint256 accuracy) public pure returns (bool){
    ...
    function newtransfer(address _token, address _to) external onlyOwner returns (bool _sent)
  {
