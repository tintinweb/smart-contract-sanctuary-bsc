...
contract FuckLvp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuckLvp";
    string private _symbol = "FuckLvp";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02AFE2c5eEF323283C6010C82464994614CfCE06); // Marketing Address
    address payable public teamWalletAddress = payable(0xa852d4e80Db1f0Decd03abb595101516e7b64dA4); // Team Address
    ...
    uint256 private _totalSupply = 60000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 6000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax =60000000000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 60000000000000000000000000 * 10**3; 
