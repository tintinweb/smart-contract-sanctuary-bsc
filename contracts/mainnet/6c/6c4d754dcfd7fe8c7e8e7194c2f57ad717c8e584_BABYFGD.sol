...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x5fAc926Bf1e638944BB16fb5B787B5bA4BC85b0A);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x069A306A638ac9d3a68a6BD8BE898774C073DCb3);
        _token = msg.sender;
    }
...
contract BABYFGD is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x0566B9a8fFb8908682796751EEd00722da967Be0;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABYFGD";
    string constant _symbol = "BABYFGD";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x069A306A638ac9d3a68a6BD8BE898774C073DCb3);
        ...
        marketingFeeReceiver = 0x118E8699d85A8967fE165E8D2BAd91AD138c5D4F;
        devfeeReceiver = 0x118E8699d85A8967fE165E8D2BAd91AD138c5D4F;
