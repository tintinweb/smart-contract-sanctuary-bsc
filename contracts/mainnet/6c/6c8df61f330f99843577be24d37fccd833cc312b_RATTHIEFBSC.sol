...
*TELEGRAM: https://t.me/RATTHIEFBSC
...
contract RATTHIEFBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " RAT THIEF ";
    string private _symbol = " $RAT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6C97DBb48B20Ad42c9B18A58780d97F17af5379b); 
