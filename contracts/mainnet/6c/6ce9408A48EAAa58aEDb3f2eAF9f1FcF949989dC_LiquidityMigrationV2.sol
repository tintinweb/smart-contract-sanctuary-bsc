...
contract LiquidityMigrationV2 is Context, Ownable, ReentrancyGuard {
  ...
  address public v1Address = 0x69b35209CBFa56CAA1F04278269e53AB443Be5E5; // old token address
  address public v2Address = 0xd8E5E7992352775Cd11c0A750140999ca15D5D10; // new token address
  address public lpAddress = 0xE950a08BEB4eDB0958eb1dcAE77a9dc748a880D3; // old token LP Pair Address
  address public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // pancakeRouter
  ...
  function migrate(uint256 _lpTokens) public nonReentrant {
      ...
      require(!isTradingPaused, "MetavieToken:: Contract is paused");
