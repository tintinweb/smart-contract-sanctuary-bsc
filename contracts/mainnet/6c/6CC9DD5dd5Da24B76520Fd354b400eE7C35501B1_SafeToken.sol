...
contract SafeToken is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, uint256 supply_, uint256 taxFee_,
                uint256 liquidityFee_, uint256 maxTxAmount_, uint256 numTokensSellToAddToLiquidity_,
                address uniswapV2Router_, address addr_)  Ownable(addr_) public payable{
