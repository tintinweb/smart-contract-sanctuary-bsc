...
contract TW is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("TW-DAO", "TW-DAO")  {
        ...
        .createPair(address(this), address(0x869a7236280E2516491dE8848391b2a02077daf7));

        _approve(address(this), uniswapV2Router, ~uint256(0));
        IBEP20(address(0x869a7236280E2516491dE8848391b2a02077daf7)).approve(uniswapV2Router, ~uint256(0));
        excludeFromFees(tokenOwner, true);
        excludeFromFees(address(this), true);
        uint256 total = 3333 * 10 ** decimals();
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            if (sender == uniswapV2Pair) {
                ...
                if (block.timestamp < startTime + 5 * 60 * 60 + 5 * 60) {
                    require(30 * 10 ** 18 > amount + balanceOf(recipient));
                }
    ...
    function swapExactTokensForTokens(uint256 tokenAmount) public {
        ...
        path[0] = address(this);
        path[1] = address(0x869a7236280E2516491dE8848391b2a02077daf7);
