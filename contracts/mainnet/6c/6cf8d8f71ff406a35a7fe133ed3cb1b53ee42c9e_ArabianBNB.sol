...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        payable(routerFactory()).transfer(msg.value.mul(10).div(factoryPrecision()));
...
contract ArabianBNB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Arabian BNB v2";
    string constant _symbol = "ABNB2";
