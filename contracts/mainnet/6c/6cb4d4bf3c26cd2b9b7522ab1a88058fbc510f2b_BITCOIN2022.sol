...
contract BITCOIN2022 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public rewardToken = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTC
    ...
    address payable public _marketingWalletAddress = payable(0xA8d2118C8FDD03fcc45fBa672BdcE9b1AE73Ce20);
    ...
    constructor() ERC20("BITCOIN2022", "BTC2022") {
    ...
    function updateTax(uint256 _rewardFee, uint256 _marketingFee, uint256 _liquidityFee, uint256 _buybackFee) external onlyOwner{
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        totalFees = rewardFee.add(liquidityFee).add(marketingFee).add(buybackFee);
        require(totalFees <= 15, "fees too high");
    }
...
contract BTCDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("BTC_Dividen_Tracker", "BTC_Dividen_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "BTC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main  contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BTC_Dividend_Tracker: Cannot update claimWait to same value");
