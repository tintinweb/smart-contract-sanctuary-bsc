...
library Address {
    ...
    function sendAmount(address payable recipient, uint256 amount) internal {
...
contract CryptoStation  is Context, IERC20 { 
    ...
    string private constant _name = "CryptoStation"; 
    string private constant _symbol = unicode"cStat"; 
    ...
    constructor () {
        ...
        _owner = 0x6068f23808759e9d86CA183A55bb4714Bb47263d;
