...
contract DonationInternational  {
    ...
    constructor(address ownerAddress,address adminAddress, IBEP20 _COIN) public 
    {
        owner = ownerAddress;
     ...
     function registrationOwner(uint256 _referrerID,address userAddress, address referrerAddress) public payable 
    {
        ...
        for (uint8 i = 1; i <= 6; i++) 
        {
            users[userAddress].activeLevel[i] = true;
            emit Investment(userAddress, levelPrice[i],i,"SLOT BUY");
        } 
