...
contract PRIMEDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Prime Doge";
    ...
    address payable public buyBackWalletAddress = payable(0xceCb5c7B7Ec0C15483A890aE4343Ba59Cb95b180); // buyback Address
