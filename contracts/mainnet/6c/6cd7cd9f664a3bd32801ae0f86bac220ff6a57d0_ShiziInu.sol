...
/**
/*  
Shizi 是受著名的模因代币 $SHIBA 和 $ZILLA 启发的代币。$Shizi 被选为 $SHIBA 和 $ZILLA 的女儿，
她将在币安智能链区块链上创建一个去中心化的 meme 项目。旨在创造将跟随 $SHIBA 和 $ZILLA 旅程的最佳模因。
https://t.me/ShiziInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x415b8b538Fb98A1ef9268db2729F28d77e31B112; 
...
contract ShiziInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shizi Inu";
    string private _symbol = "Shizi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x415b8b538Fb98A1ef9268db2729F28d77e31B112); // 
    address payable public teamWalletAddress = payable(0x415b8b538Fb98A1ef9268db2729F28d77e31B112); // 
