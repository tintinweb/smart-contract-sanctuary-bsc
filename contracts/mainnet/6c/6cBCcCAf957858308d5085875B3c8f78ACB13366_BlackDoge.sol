...
contract BlackDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BlackDogeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Black Doge", "BDOGE") {
        marketingWallet = payable(0x16e12f132D96763382a8f5875aF818c1D51F4c0B);
        devWallet = payable(0x16e12f132D96763382a8f5875aF818c1D51F4c0B);
        ...
        dividendTracker = new BlackDogeDividendTracker(
            payable(this),
            router,
            0xbA2aE424d960c26247Dd6c32edC70B295c744C43,
            "BlackDogeTRACKER",
            "BlackDogeLASSICTRACKER"
        );
...
contract BlackDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BlackDoge public BlackDogeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BlackDogeContract = BlackDoge(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BlackDoge_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BlackDoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BlackDoge contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BlackDogeContract);

            uint256 prevBalance = BlackDogeContract.balanceOf(address(this));
            ...
            {
                uint256 received = BlackDogeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BlackDogeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
