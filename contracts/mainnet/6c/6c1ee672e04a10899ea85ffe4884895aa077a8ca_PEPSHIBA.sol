...
/*
    Telegram    : https://t.me/PEPSHIBA
    Twitter     : https://twitter.com/PEPSHIBA
    Website     : https://pepshiba.io/

    COME AND JOIN OUR OFFICIAL TELEGRAM CHANNEL
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFb088d36c88CC37851C670F1250cd558DA873e27; // owner address
...
contract PEPSHIBA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "PEPSHIBA";
    string private _symbol = "PEPSHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFb088d36c88CC37851C670F1250cd558DA873e27); // Marketing Address
    address payable public teamWalletAddress = payable(0xFb088d36c88CC37851C670F1250cd558DA873e27); // Team Address
