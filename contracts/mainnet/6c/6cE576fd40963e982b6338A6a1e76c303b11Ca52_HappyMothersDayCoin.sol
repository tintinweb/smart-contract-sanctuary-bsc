...
https://t.me/HappyMothersDayCoin
...
contract HappyMothersDayCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Mothers Day Coin"; // 
    string private constant _symbol = "$HaMoDa"; //    
