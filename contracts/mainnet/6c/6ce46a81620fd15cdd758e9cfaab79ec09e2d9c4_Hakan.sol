...
contract Hakan is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   HakanDividendTracker public dividendTracker;
    ...
    uint256 public maxTransactionAmount = 10000 * (10**18); //1%
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    constructor() ERC20("Hakan", "HKN") {

    	dividendTracker = new HakanDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        HakanDividendTracker newDividendTracker = HakanDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ERC20: The new dividend tracker must be owned by the Hakan token contract");
...
contract HakanDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Hakan contract.");
    }
