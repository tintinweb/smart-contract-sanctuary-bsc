...
// Giving rewards in $BUSD and real movie tickets being distributed every weekend for holders!
// Join our official telegram: t.me/SpiderShiba
...
contract SpiderShiba is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   CoinDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("SpiderShiba", "SPIDERSHIBA") {
        _buyLiquidityFee = 2;
		_buyMarketingFee = 1;
        _buyDevFee = 1;
        _sellLiquidityFee = 2;
		...
		marketingWallet = payable(0x195c9D531f0A55877D0Cd5dE24Db553471b2866D);
        _devWallet = payable(0x0970E31a1f6F628DecD549F98DBBD655C4350871);
