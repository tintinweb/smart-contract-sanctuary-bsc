...
/**
😡🐕Mad Shiba Inu😡🐕 MSHIB (USE 2 slippage)

😡The Angry  Meme Token of 2023 😡
😡ABOUT US😡
😡$MADSHIB
😡An angry shib was born in BSC ,keep angry,keep passionate,kill all other shib!

CONTRACT ADDRESS: 0x6c825a39dab5b128a59edfb6489701c1433af64c

😡Tax 3%
😡🐕TOKENOMICS
😡🐕TOTAL SUPPLY: 1000000000 $MSHIB
😡🐕Total Tax on Buys and Sells  3%

😡🐕https://t.me/MadShibaInu
😡🐕https://twitter.com/mad_shib
😡🐕http://www.madshibinu.com/


😡🐕 🥞Buy now https://pancakeswap.finance/swap?outputCurrency=0x6c825a39dab5b128a59edfb6489701c1433af64c
😡🐕 📈Chart Poocoin  https://poocoin.app/tokens/0x6c825a39dab5b128a59edfb6489701c1433af64c
😡🐕 🥇LP LOCK PINKSALE https://www.pinksale.finance/pinklock/detail/0x21394f5932215370144faf4a4434015222B206Ce?chain=BSC
😡🐕🥇Rennounce onwership https://bscscan.com/tx/0x3039020e0e3da767dea1e3ebed44532cd3e1382ec42816de0f7ef323f3318fac

Disclaimer: When purchasing this token you will agree to the fullest extent 
that you have done research considering cryptocurrency DEFI- space and to not hold this token 
or its affiliated persons from and against all losses that arise from or relate to your purchase. 
We as a team will do our best to work for this token and it's value.
...
contract MadShibaInuToken is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"$MADSHIB"; 
    ...
    uint256 public Percent_Marketing = 86;
    uint256 public Percent_Dev = 0;
    uint256 public Percent_Burn = 7;
    uint256 public Percent_AutoLP = 7; 
    ...
    constructor () {
        ...
        _owner = 0xf43d9Ff2Ebe19a2c7Eb58a078ade1407aaCbE359;
