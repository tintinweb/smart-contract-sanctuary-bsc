...
address constant marketAddr = 0xd8BC5564Be518AD4cf0b30cbCFDA79157Aa2A864; //营销地址
...
abstract contract DexBaseUSDT {
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(SHIB, 100, 10 ether);
    }
}
...
abstract contract LiquidityFeeUSDT is Ownable, DexBaseUSDT, ERC20 {
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 1e17;
    ...
    InviteFee
{
    ...
    constructor()
        ERC20("GT", "GT", 18)
        DividendFee(_totalSupply / 1_0000, true)
        LiquidityFeeUSDT(_totalSupply / 50_0000, true)
        MarketAndBurn()
        InviteFee()
    {
    ...
    function takeFee(
        ...
        if (launchedAt + 11 >= block.number) {
            ...
            super._transfer(sender, address(marketAddr), antAmount);
            return some;
        }
