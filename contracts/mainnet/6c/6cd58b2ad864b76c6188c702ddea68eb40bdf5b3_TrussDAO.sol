...
contract TrussDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrussDAO";
    string private _symbol = "$Truss";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13c518E47B285E3E3Fa3466DA3592077a8E761F9); 
