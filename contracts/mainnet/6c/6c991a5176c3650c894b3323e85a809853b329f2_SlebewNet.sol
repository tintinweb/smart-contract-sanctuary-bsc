...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xFEa6aB80cd850c3e63374Bc737479aeEC0E8b9a1);
...
contract SlebewNet is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Slebew Network ";
    string constant _symbol = "SLEBEW";
    ...
    //Mainnet
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xFEa6aB80cd850c3e63374Bc737479aeEC0E8b9a1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9f211Fff0438ff05F6acA75bBa4289Ae3673c0B1;
        buybackWallet = 0x9f211Fff0438ff05F6acA75bBa4289Ae3673c0B1;
