...
contract ElonsBurntHair is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAe45C0514c33944b2b6DC59572A3e11C6e115432); // Marketing Address
    ...
    string private _name = "Elons Bunt Hair";
    string private _symbol = "EBH";
