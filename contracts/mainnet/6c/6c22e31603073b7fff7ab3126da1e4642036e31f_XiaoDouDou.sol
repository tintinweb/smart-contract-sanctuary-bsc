...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function ChangeAgnes(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract XiaoDouDou is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "XiaoDouDou";
    string private _symbol = "XDD";
    ...
    function checkXiaoDouDoulatedFee() external view returns (uint256, uint256) {
	...
	function XiaoDouDouCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
    ...
    function setXiaoDouDouFees(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
