...
contract CQL  is IERC20, Ownable {
    ...
    address public marketAddressOne = 0x8350A0719288A677539947F642C1F9EdED7e4a67;
    address public marketAddress = 0x8350A0719288A677539947F642C1F9EdED7e4a67;
    NFT     public NFTCQ     = NFT(0x1Ad454504c8bDcaef7ed8d7945402bf64E388C86);
    ...
    function setmarketAddress02(address account) public  {
        require(msg.sender == marketAddressOne, "ERC20: approve from the zero address");
...
function includeInFee(address account) public onlyOwner {
    ...
    function get_aount() public view returns(uint256) {
        ...
        if(usdtBalance == 0){
            ...
            return  SpireBalance.mul(1000000000000000000).div(usdtBalance);
         }
    }
}