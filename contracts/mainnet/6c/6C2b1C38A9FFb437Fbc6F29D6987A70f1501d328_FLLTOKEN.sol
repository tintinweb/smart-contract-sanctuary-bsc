...
contract FLLTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "FLLTOKEN";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1Bdefb720A3dda69d80D9C235C49aA7eEbf76C87));
        marketingWalletAddress = payable(address(0x77478F7182aca5e8eAa774a2B789C0595CB27D4D));
