...
/**
   #Oni Token 2.0 The New Community of Ape Token
    
   I make this #Bear to hand it over to the community.
   I suggest a Telegram group name for you to create: https://t.me/OniToken20
...
contract OniToken20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oni Token 2.0";
    string private constant _symbol = "OT20";
