...
contract RUSSIANMETARUFFY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RUSSIAN META RUFFY";
    string private _symbol = "RUSSIAN MR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04c83d332345502FbcBcb5dd8eA19F71661BbccC);
