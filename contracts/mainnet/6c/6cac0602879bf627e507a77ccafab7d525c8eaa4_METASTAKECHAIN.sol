...
contract METASTAKECHAIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e17 *10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _totalBurnt;

    string private _name = "METASTAKE CHAIN";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1e14 *10**2;
