...
contract BABY7DAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY7DAO";
    string private _symbol = "BABY7DAO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4C2497a7652b5b5467482f3346aF807aa21A6AeA); // Marketing Address
    address payable public teamWalletAddress = payable(0x4C2497a7652b5b5467482f3346aF807aa21A6AeA); // Team Address
    address payable public liquidityAddress = payable(0x4C2497a7652b5b5467482f3346aF807aa21A6AeA); // Team Address
