...
contract Moondome is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moondome";
    string private _symbol = "Moondome";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0561F8F4Ac1C722ebd81992d06dAa5b72abB343C);
    address payable public BuyBackWalletAddress = payable(0x0561F8F4Ac1C722ebd81992d06dAa5b72abB343C);
