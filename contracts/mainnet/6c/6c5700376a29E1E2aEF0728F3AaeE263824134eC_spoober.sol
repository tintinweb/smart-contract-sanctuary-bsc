...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xB61dd391908C0AA2ac5727F62eB9463aB53F9a47;
...
contract spoober is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Spooky Cryptober"; 
    string private constant _symbol = unicode"SPOOBER"; 
    ...
    uint256 public _BuyFee = 15; // 1000
 ...
 function _tokentransfernofee( address to, address sender, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xB61dd391908C0AA2ac5727F62eB9463aB53F9a47), BNB_Tot);
            }
