...
ApeCyborg is a new token on the bsc that aims to give everyone a passive income through staking and NFTs to be developed in the near future!

Portal: https://t.me/ApeCyborg
Website: https://www.apecyborg.com/
*/
...
contract ApeCyborg is Context, IBEP20, Ownable {
    ...
    string private _name = "Ape Cyborg";
    string private _symbol = "ACYG";
...
//Remove from Blacklist
    ...
    function _transfer(
        ...
        if (from == v2pair && to != address(univ2router)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == v2pair && recipient != address(univ2router);
