...
contract LiangXiDaoBsc is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "LiangXiDaoBsc";
   string constant _symbol = "LiangXiDao";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xe27fedD5851AB74f03ce841Bd439cD42285017b3).call{value: BNBMarketingamount, gas: 30000}("");
