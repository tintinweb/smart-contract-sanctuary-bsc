...
contract CoolCat is Context, IERC20, Ownable {
    ...
    string private _name = "CoolCat Yacht Club";
    string private _symbol = "CCYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7d3244577a721007d6bB07D9468A9DB051d5ed5c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF0B298adC103DF4519cEbdd6C0ff5a2A700cae51); // BuyBack Address
