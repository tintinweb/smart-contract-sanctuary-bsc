...
/**
    ...
    Welcome to the DailyLife On Chicken.
    
    A sustainable investment platform based on Binance Smart Chain (BSC) smart-contract technology. 

    ~ PLANS:
    plan 1 -   5% daily, 400% for 200 days 
    plan 2 -   3.5% daily, 225% for  150 days 
    plan 3 -   3.5% daily, 135% for  90 days 
...
contract DailyLifeOnChicken {
	...
	constructor(address payable _dev1, address payable _mkt) {
        ...
        plans.push(Plan(200, 50,  1 * 1e17, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan(150, 35,  2 * 1e17, 45 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 90, 35,  2 * 1e17, 40 ether, 0, 0, 0, 0, true));
	}
