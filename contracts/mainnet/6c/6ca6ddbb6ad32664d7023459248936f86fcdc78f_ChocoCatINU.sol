...
contract ChocoCatINU is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChocoCat INU";
    string private _symbol = "CCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE172eF6022d44fE3257C9b824E098fD4f0A20312); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE172eF6022d44fE3257C9b824E098fD4f0A20312); // BuyBack Address
