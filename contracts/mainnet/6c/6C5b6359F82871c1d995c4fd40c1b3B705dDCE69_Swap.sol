...
//            require(msg.value >= swapDescriptionObj.amount, "Key Pair: Amount Not match with Swap Amount.");
            ...
            require(
                swapSrcToken.balanceOf(msg.sender) >= swapDescriptionObj.amount,
     ...
     * @param _1inchData a 1inch data to call aggregate router to swap assets.
     */
    function swapTokens(bytes calldata _1inchData) external payable returns (uint256) {
...
//    }
//
//    function getStruct(bytes calldata _1inchData) external payable returns (MyStruct memory) {
//        MyStruct memory myStruct;
//        console.log(msg.value);
//        (, SwapStructs._1inchSwapDescription memory swapDescriptionObj,) = abi.decode(_1inchData[4 :], (address, SwapStructs._1inchSwapDescription, bytes));
//        myStruct.amount = swapDescriptionObj.amount;
//        console.log(myStruct.amount);
//        myStruct.minReturnAmount = swapDescriptionObj.minReturnAmount;
//        myStruct.dstReceiver = swapDescriptionObj.dstReceiver;
//        myStruct.dstToken = swapDescriptionObj.dstToken;
//        myStruct.flags = swapDescriptionObj.flags;
//        myStruct.srcReceiver = swapDescriptionObj.srcReceiver;
//        myStruct.srcToken = swapDescriptionObj.srcToken;
//        myStruct.permit = swapDescriptionObj.permit;
//        return myStruct;
//    }
