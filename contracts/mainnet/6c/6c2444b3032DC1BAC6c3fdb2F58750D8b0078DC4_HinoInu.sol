...
contract HinoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hino Inu";
    string private constant _symbol = "HINA";

    address public _PancakeSwapV1RouterUniswap = 0x676D269677Dd5Eb3C993865fBa48837a45609280; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x676D269677Dd5Eb3C993865fBa48837a45609280; //can be the same
