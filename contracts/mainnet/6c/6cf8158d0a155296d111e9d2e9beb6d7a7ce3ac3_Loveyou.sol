...
contract Loveyou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Love you";
    string private _symbol = "Loveyou";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2ab7825f5671b9941478A395f7baa4dEea4375A);
    address payable public teamWalletAddress = payable(0xA2ab7825f5671b9941478A395f7baa4dEea4375A);
    ...
    uint256 public _totalDistributionShares = 31;
