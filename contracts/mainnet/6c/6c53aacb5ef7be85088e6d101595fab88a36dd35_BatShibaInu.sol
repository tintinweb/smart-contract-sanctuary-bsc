...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x47dAdE86020813EB8499f5A1945B86AEc6fD6565;
...
contract BatShibaInu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xe3195986211e4AE8E660d929bAAbaC428f915DA4;
    ...
    string private _name = "BatShibaInu";
    string private _symbol = "BatShiba";
    ...
    function _takemarketing(uint256 tmarketing) private {
        if (tmarketing > 0) {
            ...
            emit Transfer(_msgSender(), _marketingWalletAddress, tmarketing);
        }
    }
