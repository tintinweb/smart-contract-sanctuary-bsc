...
contract AOM {
    ...
    function hireMoreEskimos(bool isCompound) public {
    ...
    function hireEskimos(address ref) public payable{
        require(contractStarted, "Contract not yet Started.");
        User storage user = users[msg.sender];
