...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe97d00d15685BF76952eB92a2Ba4cd47a8928cF1;
...
contract PiGoat is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xED36eA649821b17276E7c9e1b062fa1E4a865b18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 314159265 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PiGoat";
    string private _symbol = "PIGOATS";
    ...
    uint256 public _maxTxAmount = 314159265 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 15000000 * 10**18;
