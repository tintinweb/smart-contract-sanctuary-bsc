...
contract shitcoin is IERC20, Ownable {
    ...
    constructor(
        ...
        uint256 numTokensSellDivisor_,
        uint256 liquidityFeeTransfer_,
        uint256 liquidityFeeBuy_,
        uint256 liquidityFeeSell_,
        address uniswapV2Router_,
        address manualSwapAddress_
    ) payable {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        ...
        liquidityFeeTransfer = liquidityFeeTransfer_;
        ...
        manualSwapAddress = manualSwapAddress_;
    ...
    function _transfer(
        ...
        uint256 liquidityFee = liquidityFeeTransfer;
        ...
        if (takeFee && (liquidityFee > 0)) {
            ...
            if (!manualSwapMode) {
                ...
                _transferAmount(sender, manualSwapAddress, fees);
            }
        }
    ...
    function setLiquidityFee(uint256 liquidityFeeTransfer_, uint256 liquidityFeeBuy_, uint256 liquidityFeeSell_) external onlyOwner {
        liquidityFeeTransfer = liquidityFeeTransfer_;
        liquidityFeeBuy = liquidityFeeBuy_;
        liquidityFeeSell = liquidityFeeSell_;
    ...
    function enableManualSwapMode() external onlyOwner() {
        manualSwapMode = true;
    }

    function disableManualSwapMode() external onlyOwner() {
        manualSwapMode = false;
    }

    function setManualSwapAddress(address manualSwapAddress_) external onlyOwner() {
        manualSwapAddress = manualSwapAddress_;
    }
