...
contract FT is ERC20 {
    ...
    address payable _default = payable(address(0x000000000000000000000000000000000000dEaD));
    ...
    constructor(address tokenOwner) ERC20("FT", "FT") {
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**27);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if(from == uniswapV2Pair){
                ...
                require(balanceOf(from).div(5) >= amount);
