...
contract huobi is Context, IERC20, Ownable {
    ...
    string private _name = "\u706b\u5fc5";
    string private _symbol = "\u706b\u5fc5";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x73CCf12d75FAa7d77B7D02866DE4217963783ACe); 
    address payable public BurnedWalletAddress = payable(0x73CCf12d75FAa7d77B7D02866DE4217963783ACe); 
