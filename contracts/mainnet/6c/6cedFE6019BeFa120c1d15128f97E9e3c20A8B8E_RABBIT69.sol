...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0F401e523C087748948AE5B6619941a41c8CB36b; // owner address
...
contract RABBIT69 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RABBIT 69";
    string private _symbol = "R69";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0F401e523C087748948AE5B6619941a41c8CB36b); // Marketing Address
    address payable public teamWalletAddress = payable(0x0F401e523C087748948AE5B6619941a41c8CB36b); // Team Address
