...
* 🐉🐲 BabyShenronInu 🐉🐲                                                                                                   *
*                                                                                                                              *
* Combining the Legendary Dragon. The Shenron and Inu in BSC aim to build the most legendary project that you'll ever seen.    *
*                                                                                                                              *
* BabyShenronInu is a defi meme token that has a good function to become a reliable to its community.                          *
* A lot of potential is here in this project and this is Inspired to one of the famous dragon which is Shenron.                *
* A project that gives reflection rewards to all holders by holding.                                                           *
*                                                                                                                              * 
...
*                                                                                                                              *
*                                                                                                                              *
* 📞TELEGRAM: https://t.me/BabyShenronInu                                                                                     *
* 🐦TWITTER: https://twitter.com/BabyShenronInu                                                                               *
* 🌐WEBSITE: TBA                                                                                                              *
********************************************************************************************************************************
*/
...
contract BabyShenronInu is IBEP20, Auth {
    ...
    string constant _name = "BabyShenronInu";
    string constant _symbol = "BABYSHENINU";
    ...
    address private marketingFeeReceiver = 0xc1718eC9A9E96413DDb68dAf64E3cF23562676f6;
    address private buybackFeeReceiver = 0x2c88D03e6e975f5E241369B0D98214ec764BD862;
