...
contract MZMale is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MZMaleDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MZMale", "MZMale") {
        marketingWallet = payable(0x680785aBeb2F4C7894ec71E5D2b75a1eB1cEBC24);
        charityWallet = payable(0x680785aBeb2F4C7894ec71E5D2b75a1eB1cEBC24);
        devWallet = payable(0x680785aBeb2F4C7894ec71E5D2b75a1eB1cEBC24);
        ...
        dividendTracker = new MZMaleDividendTracker(
            payable(this),
            router,
...
contract MZMaleDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        MZMaleContract = MZMale(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MZMaleCasino_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MZMaleCasino_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MZMaleCasino contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MZMaleContract);

            uint256 prevBalance = MZMaleContract.balanceOf(address(this));
            ...
            {
                uint256 received = MZMaleContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MZMaleContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
