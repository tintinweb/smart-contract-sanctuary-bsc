...
// Note that this pool has no minter key of bshare (rewards).npx hardhat run --network fantom scripts/write/deploy.ts
// Instead, the governance will call bshare distributeReward method and send reward to this pool at the beginning.
contract bShareRewardPool is IRewardPool, ReentrancyGuard {
