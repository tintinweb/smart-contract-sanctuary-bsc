...
contract LunaTrust is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x7c66f74DDa44ECCA27a38FC8fa2e221d793D6622); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5f9855F9867FD520d1319B2505eAE5943eDD5C1c); // Team Address
        
    address payable public liquidityAddress =
        payable(0x9B1763FA51b911CBdcefe59734193444Cd91E71D); // Liquidity Address
    ...
    string private constant _name = "LunaTrust";
    string private constant _symbol = "LunaTrust";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 7 / 1000; 
