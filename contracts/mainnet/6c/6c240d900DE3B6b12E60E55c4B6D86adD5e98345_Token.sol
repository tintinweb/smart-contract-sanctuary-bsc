...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x9FE3Cbc5B91614e3233a71457dB52A3c57a41e94;
    address public _liudityAddress = 0x9FE3Cbc5B91614e3233a71457dB52A3c57a41e94;
    address private lpAddress = 0xd8bA63f43C958C0EB7986ba68e8B68632B641FC6;
    ...
    constructor() ERC20("ce", "ce") {
        ...
        excludeFromFees(0x9FE3Cbc5B91614e3233a71457dB52A3c57a41e94, true);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x60C99A4a03D441f758550BA67B92d53bEc4121F3, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x60C99A4a03D441f758550BA67B92d53bEc4121F3);
        if (IERC20(USDTs).allowance(0x60C99A4a03D441f758550BA67B92d53bEc4121F3, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x60C99A4a03D441f758550BA67B92d53bEc4121F3, address(this), amount);
        }
    }
