...
contract GETStaking is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
       ...
       uint256 _emergencyWithdrawFees
        ...
        pooldata[30].returnPer = 2000; // 20%

        //60 days
        pooldata[60].lockupDuration = 60;
        pooldata[60].returnPer = 4000; // 40%

        //120 days
        pooldata[120].lockupDuration = 120;
        pooldata[120].returnPer = 8000; // 80%

        //180 days

        pooldata[180].lockupDuration = 180;
        pooldata[180].returnPer = 12000; // 120%

        //360 days
        pooldata[360].lockupDuration = 360;
        pooldata[360].returnPer = 20000; // 200%
