...
/*                                                                                              
Luna Comeback - Deflationary Token with LUNA reward
*/
...
interface LunaDEXRouter02 is LunaDEXRouter01 {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public rewardToken = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
    LunaDEXRouter02 public router = LunaDEXRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
contract Luna is Context, IBEP20Metadata, Ownable, LunaToken, DividendDistributor {
    uint256 private constant VERSION = 1;
    using SafeMath for uint256;
    address private constant DEAD = address(0xdead);
    address private constant ZERO = address(0);
    string public constant _name = "Terra Comeback";
    string public constant _symbol = "LUNACO";
    uint8 public constant _decimals = 18;
    uint256 public _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public liq = 900000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(400); // 0.25%
    uint256 private liquidityFee = 500;
    uint256 private buybackFee = 200;
    uint256 private userrewadFee = 1000;
    ...
    uint256 public autoBuybackCap = 100000 * (10 ** _decimals);
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountLuna);
    ...
    pair = payable (LunaDEXFactory(router.factory()).createPair(
            address(this),
            router.WETH()
        ));
