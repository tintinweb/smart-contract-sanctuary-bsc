...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1AdFB11AD949117Dc74cAc4B0aAaB47cf09b7c85; // owner address
...
contract catPAW is Context, IERC20, Ownable {
    ...
    string private _name = "catPAW";
    string private _symbol = "catPAW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6FE42fDBc938397B242590e4aC181938657dCc5C); // Marketing Address
    address payable private teamWalletAddress = payable(0x6FE42fDBc938397B242590e4aC181938657dCc5C); // Team Address
