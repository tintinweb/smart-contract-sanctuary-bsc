...
contract CZDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZ's Day Token";
    string private _symbol = "CZDay";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB2E18E8D6df4dcf085f8AC9BED9668aEd2C5602B); 
    address payable public teamWalletAddress = payable(0xB2E18E8D6df4dcf085f8AC9BED9668aEd2C5602B); 
