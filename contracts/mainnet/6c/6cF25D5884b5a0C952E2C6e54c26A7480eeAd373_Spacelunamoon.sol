...
contract Spacelunamoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spacelunamoon";
    string private _symbol = "SLM";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xC2679FF16B1A38Ad8f181d83111c514030078391); 
    address payable public ttWal = payable(0xC2679FF16B1A38Ad8f181d83111c514030078391); 
