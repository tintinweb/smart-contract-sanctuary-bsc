...
contract KhabyCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Khaby Coin";
    ...
    address public marketingWallet = address(0x58eFc289C4922cCA85F584071315a1a6C03A43f1);
