...
contract TestingDivisable {
    ...
    string public strategyTitle = "Testing Divisable";
    ...
    function getTokens() public view returns (address[] memory) {
        ...
        tokens[2] = 0x55d398326f99059fF775485246999027B3197955;
        tokens[3] = 0x9aA83081AA06AF7208Dcc7A4cB72C94d057D2cda;
        tokens[4] = 0xB0D502E938ed5f4df2E681fE6E419ff29631d62b;
        return tokens;
    }
    ...
    function func_4(string memory _funcToCall, bytes[3] memory _arguments) public onlyExecutor {
    ...
    function func_6(string memory _funcToCall, bytes[2] memory _arguments) public onlyExecutor {
    ...
    function func_5(string memory _funcToCall, bytes[2] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x3052A0F6ab15b4AE1df39962d5DdEFacA86DaB47;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
    ...
    function func_8(string memory _funcToCall, bytes[3] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x4a364f8c717cAAD9A442737Eb7b8A55cc6cf18D8;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
        ...
        if (useCustomParams) {
            (success, result) = currentFunctionAddress.call(
                abi.encodeWithSignature(
                    ...
                    abi.decode(_arguments[0], (uint16)),
                    abi.decode(_arguments[1], (uint256)),
                    abi.decode(_arguments[2], (address))
                )
            );
        ...
        latestContractData = result;
        require(success, "Function Call Failed On func_8, Strategy Execution Aborted");
    }

    function func_7(string memory _funcToCall, bytes[2] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x3052A0F6ab15b4AE1df39962d5DdEFacA86DaB47;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
        ...
        if (useCustomParams) {
            ...
            (success, result) = currentFunctionAddress.call(
                abi.encodeWithSignature("withdraw(uint256,uint256)", 0, SUSDT_BALANCE / activeDivisor)
            );
        }
        latestContractData = result;
        require(success, "Function Call Failed On func_7, Strategy Execution Aborted");
    }
    ...
    function updateStepsDetails() internal {
        step_4_custom_args = [
            abi.encode(0xB0D502E938ed5f4df2E681fE6E419ff29631d62b),
            abi.encode(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82),
            abi.encode(STG_BALANCE)
        ];
    ...
    function runStrategy_1(bytes[] memory _callBackParams) public onlyExecutor {
        ...
        func_10("runStrategy_2", [abi.encode("donotuseparamsever")]);
        updateBalances();
        updateStepsDetails();
    ...
    function runStrategy_2(bytes[] memory _callBackParams) public onlyExecutor {
        ...
        func_9("runStrategy_3", [abi.encode("donotuseparamsever")]);
    }

    StepDetails[8] public steps;
    uint256[] public reverseFunctions = [11, 17, 10, 17, 5, 7, 8, 11];
