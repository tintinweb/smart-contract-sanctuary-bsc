...
contract SaitamaBSCToken is BEP20Official {
    ...
    string public override name = unicode"Saitama Offcial BSC Token";
    string public override symbol = unicode"Saitama BSC Token";
