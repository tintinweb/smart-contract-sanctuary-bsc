...
contract LotteryERC20 is Ownable, Pausable, ReentrancyGuard {
    ...
    //busd
    address public BUSD = 0x4e3cABD3AD77420FF9031d19899594041C420aeE;

	//fees
	uint256 public ticketPrice = 10 ether; //all prices are in TITANO
    ...
    function delBuildNumber11() internal pure {} //etherscan trick
