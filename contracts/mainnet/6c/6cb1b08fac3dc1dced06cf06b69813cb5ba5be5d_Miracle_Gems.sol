...
/**
BUSD Miracle Gems
 Hire Diggers, Gather Gems, Compile Gems and Sell for BUSD. 
  8% daily daily Rate
  15% Referral Bonus, will go directly to referrer wallet.
  4% stacking compound bonus every 12 hrs, max of 5 days. (40%)
  48 hours cut off time.
  10 BUSD minimum investment.
  1000 BUSD max deposits per wallet.
