...
/**
https://t.me/spooky_vikings_floki
*/
...
contract SPOOKYVIKINGSFLOKI is Ownable, IBEP20 {
    ...
    string constant _name = "Spooky Vikings Floki";
    string constant _symbol = "SVFLOKI";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x51CC7A95E9f8bD367Ca1A59B089b54c920564799;
        marketingWallet = 0xb93B9BD9E91C32519f510C500D9cFFAF038e58D9;
        devWallet = 0x51CC7A95E9f8bD367Ca1A59B089b54c920564799;
    ...
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 9, "Max gas should be higher than 9 gwei");
        gas = newGas * 1 gwei;
    }
