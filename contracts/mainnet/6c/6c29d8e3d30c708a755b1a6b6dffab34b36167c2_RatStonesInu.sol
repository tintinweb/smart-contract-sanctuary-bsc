...
Welcome to RatStonesInu !

Telegram : t.me/StonesTokenBsc
...
contract RatStonesInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RatStones Inu";
    string constant _symbol = "RSINU";
