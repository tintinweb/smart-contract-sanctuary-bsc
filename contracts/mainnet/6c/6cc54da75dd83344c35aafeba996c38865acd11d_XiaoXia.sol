...
contract XiaoXia is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"小侠币";
    string private _symbol = "XiaoXia";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xCe722820A15E78F596e9a4f382212aB60faD994C);
    address payable public BurnedWalletAddress = payable(0xCe722820A15E78F596e9a4f382212aB60faD994C);
    ...
    uint256 private _totalSupply = 5000000 * 10**8 * 10**_decimals;
