...
contract GOLDFATHER is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "The Goldfather";
    string constant _symbol = "GOLDFATHER";
    ...
    address public marketingFeeReceiver = 0xF3Ee52B01088469F967B6962A03430fD29D3f79D;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH.mul(2).div(10);
        uint256 amountETHMarketing = amountETH.sub(amountETHLiquidity);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool LiquiditySuccess, /* bytes memory data */) = payable(autoLiquidityReceiver).call{value: amountETHLiquidity, gas: 30000}("");
        require(LiquiditySuccess, "receiver rejected ETH transfer");
   ...
   function areBots(address[] memory bots_) public onlyOwner {
    ...
    function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 15 && totalSellFee <= 15, "Must keep fees at 15% or less");
    }
