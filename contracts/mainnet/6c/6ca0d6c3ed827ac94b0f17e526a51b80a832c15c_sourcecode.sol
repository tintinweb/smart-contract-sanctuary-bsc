...
contract sourcecode is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 49* 10**_decimals;

    uint256 public _maxTxAmount = 49 * 10**_decimals; 

    uint256 public _walletMax = 49* 10**_decimals;
    ...
    address payable public marketingWalletAddress = payable(0x423961F0A955677a8AD07E8F6B1B2C8BF926e62f);
 ...
 address payable public tWAddress = payable(0x423961F0A955677a8AD07E8F6B1B2C8BF926e62f);
