...
contract GTWATCH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function canceltransfer(uint256 maxWallPercent) external onlyOwner {
   ...
   function getsupply(uint256 rate, uint256 amount) private pure returns (uint256) {     
