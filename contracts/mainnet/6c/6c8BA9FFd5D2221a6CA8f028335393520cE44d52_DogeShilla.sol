...
contract DogeShilla is IBEP20, Auth {
    ...
    string constant _name = "DogeShilla";
    string constant _symbol = "DogeShilla";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 200; //1.5% 
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; //3%
    ...
    address private marketingFeeReceiver = 0x1093Ff40A8664726b09344D3cb43940AeE6045BD;
    address private developmentFeeReceiver = 0x1093Ff40A8664726b09344D3cb43940AeE6045BD;
