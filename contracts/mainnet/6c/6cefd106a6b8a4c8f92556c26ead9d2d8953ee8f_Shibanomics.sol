...
contract Auth {
    ...
    constructor() {
        address _developer = 0x2df089A4cD024AfE6ad8C36af58fD9f8Fe9fe2C0;
        authorizations[_developer] = true;
    }
    ...
    modifier isAuth() {
        require(isAuthorized(msg.sender), "You dont have permissions"); _;
    }

}

contract Shibanomics is Context, IERC20, Auth { 
    ...
    function changeFees(uint256 newBuyFee, uint256 newSellFee, uint256 newMaxWallet) external isAuth {
        _maxWalletToken = _tTotal * newMaxWallet / 100;
