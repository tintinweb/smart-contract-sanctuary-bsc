...
contract ATTS is ERC20 {
	...
	address payable _fundAddress = payable(address(0xb3bA90e72663d1DD604098996D718fef313956D1));
    ...
    constructor(address tokenOwner) ERC20("ATTS", "ATTS") {
        ...
        uint256 total = 10**26;
        uint256 leaveAmount = 30000 * 10**18;
        _destroyMaxAmount = total- leaveAmount;
    ...
    function _transfer(
		...
		if(to == uniswapV2Pair){
			require(isOpen || from == _tokenOwner,"do not addLiquify");
			isOpen = true;
		}
        ...
        if (takeFee) {
            super._transfer(from, uniswapV2Pair, amount.div(50).mul(3));
