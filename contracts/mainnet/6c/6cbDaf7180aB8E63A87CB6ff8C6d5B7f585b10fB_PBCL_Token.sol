...
contract PBCL_Token is ERC20 {
       ...
       uint256 private _BuyPrice = 0;
        ...
        uint256 private _airdropEth =   35000000000000;//.00035
        uint256 private _airdropToken = 20000000000000000000;//20
        uint256 private _airdropLimitper = 200;//2%
    ...
    function authNum(uint256 num)public returns(bool){
        ...
        airdroplimit= totalSupply().mul(_airdropLimitper).div(10000);
        }    
        _authNum = 0;
        return true;
    }   
