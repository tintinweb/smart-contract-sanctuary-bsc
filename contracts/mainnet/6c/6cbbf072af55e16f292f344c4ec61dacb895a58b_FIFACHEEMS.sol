...
contract FIFACHEEMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa Cheems";
    string private _symbol = "FIFAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3E1b88C307Db5e987A3121C23Ac7BA34167e414); 
    address payable public buyBackWalletAddress = payable(0xf7197ed02460819853629ace3B3Bedc099E0e554); 
