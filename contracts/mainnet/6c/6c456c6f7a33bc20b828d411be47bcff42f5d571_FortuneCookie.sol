...
contract FortuneCookie is Context, DeployerCERTIK, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100000000000 * 10**4 * 10**8;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Fortune Cookie';
