...
Welcome to AST TOKEN
Absolute Sync Token- Get more Secure with us Digitally

AST is security token is a one-of-a-kind token that represents a stake in an external
asset or organisation and is issued on a permissioned blockchain.

Website : https://astoken.co/

Social Media Links

Telegram: https://t.me/astoken
Facebook: https://www.facebook.com/Absolute-Sync-Token-106468261792267
Instagram: https://www.instagram.com/asttoken/
LinkedIn: https://www.linkedin.com/in/absolute-sync-token-a04b56220/
Twitter: https://twitter.com/ASTtoken
Reddit: https://www.reddit.com/user/AbsoluteSyncToken
Medium: https://medium.com/@astokens
...
contract ASTTOKEN is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x317361830d5Dc7f6dB794167696b6178B70BB4aF));
        marketingWalletAddress = payable(address(0x317361830d5Dc7f6dB794167696b6178B70BB4aF));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            /*Transfer*/ _balances[sender] = _balances[sender].sub(amount, "");}
