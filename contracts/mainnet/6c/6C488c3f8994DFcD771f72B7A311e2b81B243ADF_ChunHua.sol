...
/**
   ...
   //Telegram : https.://t.me/ChunHua_Cn

   //Chun Hua (春华) Stealth launch, is a community token that can be used by the community and the public that will unite the Crypto Community,
   //and will provide great passive income for new investor
*/
...
contract ChunHua is Context, IERC20 { 
    ...
    address payable public projectWallet = payable(0xaa0bbF3a3E06593D28328Cc96Fd2DE05Bd1Da33B);    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**9 * 10**_decimals;
    string private constant _name = "Chun Hua"; 
    string private constant _symbol = unicode"Chun Hua 春华";
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0xaa0bbF3a3E06593D28328Cc96Fd2DE05Bd1Da33B;
