...
contract GucciShibaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GucciShibaCoin";
    string private _symbol = "GucciShibaCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa113F9fb59FdEe5C11658C1CF7B764390e9841E6); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10 * 10**9 * 10**9; //5 * 10**6 * 10**9 1% max tnx
    uint256 public _walletMax = 15 * 10**9 * 10**9; // 2% max wallet
    uint256 private minimumTokensBeforeSwap = 25000000 * 10**9; 
