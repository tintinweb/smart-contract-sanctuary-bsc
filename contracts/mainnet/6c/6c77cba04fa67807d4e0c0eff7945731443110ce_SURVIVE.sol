...
contract SURVIVE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SURVIVE";
    string constant _symbol = "$SURV";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xD17a490725642452615fc501478974289dD151E0;
