...
contract hongguan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function isTxLimit(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function isAutomated(address pair, bool value) external onlyOwner {
