...
contract BabyLucro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Lucro";
    string private _symbol = "Baby LCR";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 60;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xE75BFC35D16E07E35a743A118d9B0Ac1f5FC8F40); // Marketing Address
    address payable public teamWalletAddress = payable(0xE75BFC35D16E07E35a743A118d9B0Ac1f5FC8F40); // Team Address
