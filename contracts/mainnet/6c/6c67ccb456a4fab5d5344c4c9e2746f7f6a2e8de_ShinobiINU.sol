...
/** SHINOBI INU 
 ...
 Shinobi (しのぶ) is a Japanese verb meaning endurance & patience 

 Safe play brought to you by Doxed Boy

 Features a DEV LIVE IN VC, 1 week liquidity lock, RENOUNCED OWNERSHIP, and no dev wallet 

 Total Supply: 10,000,000,000,000,000
 Max Wallet  : 4% (400,000,000,000,000)
 Tax: 6% Buy / Sell

 // TG : https://t.me/ShinobiPortal

 // Website : http://www.shinobiInu.co/
...
contract ShinobiINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$SHINOBI";
    ...
    address private marketingWallet = address(0x4266bbD6AAbfFbF4Aa5330787cF774D22C5f9B06);
    address private liquidityReceiver = address(0x4266bbD6AAbfFbF4Aa5330787cF774D22C5f9B06);
