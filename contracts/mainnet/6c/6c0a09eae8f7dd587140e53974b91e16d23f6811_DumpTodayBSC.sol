...
contract DumpTodayBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dump Today BSC"; // TODO change
    string private _symbol = "DTB"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0xE5b0B3B1537662E5A94b8F7c1C2846b05a7aaa67); // Buyback Address
