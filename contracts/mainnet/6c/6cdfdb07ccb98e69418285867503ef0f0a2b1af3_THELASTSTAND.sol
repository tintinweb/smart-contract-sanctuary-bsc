...
/*
 https://t.me/TheLastStandOfficial 
     If you are ready step forward those who would serve, 
     for an army will be raised! 
     the corrupt with be ripped from there crypto nests
     and caste out in the to cold crypto space that we know and endure
     justice will be served, spoils enjoyed for the many
     crypto will survive!

WHO DEV?
THE JEET LORD
I have been watching from the ageless void 
waiting for the time i would take human form again
ive been observing the chaos, taking in the lack of raw humanity
It's as if the entire crypto world's fallen in love with their insanity
Hear the innocent voices scream
As their ruggers laugh through all of it
No forgiveness from all I've seen
The degradation, I c annot forget
So sleep soundly in your beds tonight
For judgement falls upon Skem devs at first light
...
contract THELASTSTAND is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("The Last STand", "TLS") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xC9546aBA98EC3858Bc3Ce8EbA77da251a9712cA4); // CHANGE THIS TO YOURS
