...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x55d398326f99059fF775485246999027B3197955);//option for USDT Rewards
    IDEXRouter router;
...
contract TyrantFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tyrant Floki";
    string constant _symbol = "TFLOKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x462D750b3057342eD4236e7BDd0E6278936642BB;//mkt
        buybackFeeReceiver = 0x28aD88610d305964f1689A146759bA4f855C598C;//BUY BACK 21
        teamFeeReceiver = 0x28aD88610d305964f1689A146759bA4f855C598C;//TEAM IF NEEDED 21
