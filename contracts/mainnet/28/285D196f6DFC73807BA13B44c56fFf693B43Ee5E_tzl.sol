...
//    mapping(address => bool) public _blackList;
    ...
    constructor (
        ...
        holderRewardCondition = 30 * 10 ** IERC20(FISTAddress).decimals()/10;
...
//        }
        ...
        bool takeFee;
        bool isSell;
       if (!_swapPairList[from]&&!_swapPairList[to]&&invaddress[to]==address(0)){
         invaddress[to]=from;
          invcount[from]+=1;
        invlist.push();
    ...
    function swapTokenForFund(uint256 tokenAmount) private {
        ...
        if (fistBalance>0) FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance);
...
//    }
    ...
    function getholderRewardCondition()public view returns(uint256){
        return(holderRewardCondition);
    }
