...
Horses within this series are plentiful but like a tornado can travel far and fast.
Breeds
...
abstract contract Ownable is Context {
 ...
 contract ZRAK is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public Token;
  IBEP20 public BUSD;
  ...
  uint256 public MinitngPricein_token=800;    // token
  uint256 public MinitngPricein_token1=200;    // token1
   uint256 public MinitngPrice_with_single=1000;    // token1
