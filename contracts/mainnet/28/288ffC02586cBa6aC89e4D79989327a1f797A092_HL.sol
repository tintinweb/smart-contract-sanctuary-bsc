...
contract HL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "HL";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6c4bDc2245be7337d4f183bbEF62Daa86727F311));
        marketingWalletAddress = payable(address(0x763e3Be313a121c6B6193bB22Cc09ee190C0B278));
