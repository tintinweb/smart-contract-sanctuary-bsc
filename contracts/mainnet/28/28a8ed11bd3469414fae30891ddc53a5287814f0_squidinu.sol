...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = " squidinu";
    string public constant TOKEN_SYMBOL = "squidinu ";  
...
contract squidinu is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
    ...
    string public tokenType=" squid inu ";
    ...
    constructor(  )  payable Auth(msg.sender) { 
        ...
        marketingAddress = [0xbEF6F5d045778d7b4637Eb47A3DB05417C6f1501,0xc0e707587E8479ea281884037F10Ea44b5ade56b,0xEbF72e828A659B73f03C9b1aE2Eb1E74B1992B72];
