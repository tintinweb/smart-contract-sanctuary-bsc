...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaEAF83F0A18a8f3279fC5061Ee27AD30D5a4a241;
...
contract DOGBUTT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAa24Ca27E8a89fC31976A67df890a9f94d8377bd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DOGBUTT";
    string private _symbol = "DOGBUTT";
    ...
    uint256 public _maxWalletToken = 10000000000000 * 10**18;
    ...
    function _transfer(
        ...
        if(contractTokenBalance >= _maxWalletToken)
        {
            contractTokenBalance = _maxWalletToken;
        }
        bool takeFee = true;
