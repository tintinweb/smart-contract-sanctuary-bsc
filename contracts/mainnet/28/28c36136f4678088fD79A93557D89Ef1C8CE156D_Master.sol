...
contract Master is Ownable {
    ...
    // Market oracle provides the Peace/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _Peace) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = Peace.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && Peace.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(Peace.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return Peace.totalSupply().toInt256Safe()
