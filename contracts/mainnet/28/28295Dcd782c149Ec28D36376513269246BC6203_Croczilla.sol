...
library Address{
 ...
 contract Croczilla is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2051a1F210c1Bdf61ef64c81498A3e9d3A57d68c;
    address public donationWallet = 0x2051a1F210c1Bdf61ef64c81498A3e9d3A57d68c;

    string private constant _name = "Croczilla";
    string private constant _symbol = "CROCZILLA";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 3);
    Taxes public sellTaxes = Taxes(1, 3, 2, 3);
