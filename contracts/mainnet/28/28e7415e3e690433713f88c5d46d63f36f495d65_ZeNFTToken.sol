...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6ECa4f33e4C5B5F753396c07541653353Dc3Cc63;
...
contract ZeNFTToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x22EaE0AA4ddeFCFec6EE4d754382dBc38760804A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZeNFTToken";
    string private _symbol = "ZeNFT";
