...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x112eE7d278B1bdB329259C1B571c56b23a3328C0; // owner address
...
contract rabbit is Context, IERC20, Ownable {
    ...
    string private _name = "this is the year of the rabbit";
    string private _symbol = "rabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x112eE7d278B1bdB329259C1B571c56b23a3328C0); // Marketing Address
    address payable public teamWalletAddress = payable(0x112eE7d278B1bdB329259C1B571c56b23a3328C0); // Team Address
