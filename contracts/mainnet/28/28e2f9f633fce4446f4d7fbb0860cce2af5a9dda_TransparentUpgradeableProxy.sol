...
👨🏼‍💼 Community Growth
🐶 BSC Smart Contract Launch
🔰 Audit & KYC
🐶 Telegram and Twitter Marketing
🐶 CMC & CG Listing
🎃 NFT's Staking & SF Ecosystem
🪐 Low Starting MC
 
💬telegram : https://t.me/kawabsc
🌏website : https://www.kawakami.one/
...
abstract contract ERC1967Upgrade {
    ...
    function _upgradeToAndCallSecure(address newImplementation, bytes memory data, bool forceCall) internal {
        ...
        if (!rollbackTesting.value) {
            ...
            require(oldImplementation == _getImplementation(), "ERC1967Upgrade: 26upgrade breaks further upgrades");
