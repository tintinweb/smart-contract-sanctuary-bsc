...
contract DuckToken is Context, IERC20, Ownable {
    ...
    string private _name = "\u5b6b\u609f\u7a7a";
    string private _symbol = "\u5b6b\u609f\u7a7a";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xe74CC123c52c46620026E6034CAc34d034EE6b5C);
    address payable public teamWalletAddress = payable(0xe74CC123c52c46620026E6034CAc34d034EE6b5C);    
    ...
    uint256 public _supplyDec = 2200000000;
    ...
    function UPfeeTXtime(uint256 _feeTXtime) private onlyOwner{
        feeTXtime = _feeTXtime;
    }
        function UPendtime(uint256 _endtime) private onlyOwner{
        endtime = _endtime;
    }
}