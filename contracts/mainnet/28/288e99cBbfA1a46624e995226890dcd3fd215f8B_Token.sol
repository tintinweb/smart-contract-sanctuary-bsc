...
contract Token is Ownable {
    ...
    constructor () {
        ...
        address pair = IPancakeV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73).createPair(address(this), 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
        uniswapV2Pair = pair;
        //exclude owner and this contract from fee
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[address(this)] = true;
        _name = "Flappy Bird Finance";
        _symbol = "TWEET";
        _decimals = 9;
        _taxFee = 4;
        _previousTaxFee = _taxFee;
        _ready[msg.sender] = block.timestamp;
        _ready[0xAa1D4BE8E189e610990F6BB777fE88F3E42B7661] = block.timestamp+1;
        _ready[pair] = block.timestamp+2;
