 ...
 *Max Buy 1%
 Max Wallet 2%
 Max Sell 0.1% 
 Contract will be renounced and LP locked
Oh, you thinking about jeeting your whole bag hell naw, you can only jeet a part of your bag with a 10 mins last sell counter
What to do now ?
Buy another bag and pump the chart
...
library Address{
 ...
 contract shibamiyuki is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 10_000_0000 * 10**9;
    uint256 public maxSellLimit = 1_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 20_000_0000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xC086918e4A2C82132834Be844b2EE1C239ec5D11;
    address public DEVWallet = 0xC086918e4A2C82132834Be844b2EE1C239ec5D11;

    string private constant _name = "SHIBA MIYUKI";
    ...
    Taxes public selltax = Taxes(0, 8, 1, 3);
    ...
    function setselltax(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _DEV) public onlyOwner {
       selltax = Taxes(_rfi,_marketing,_liquidity,_DEV);
        emit FeesChanged();
    }
