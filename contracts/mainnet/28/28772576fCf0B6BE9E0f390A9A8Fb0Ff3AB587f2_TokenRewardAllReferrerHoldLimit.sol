...
contract TokenRewardAllReferrerHoldLimit is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    address ETH_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    ...
    function setHoldLimitAmount(uint256 amount) external onlyOwner {
        holdLimitAmount = amount;
    }
