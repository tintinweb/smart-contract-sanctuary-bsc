...
contract DummyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dummy Inu";
    string private _symbol = "DUMMY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA96D94bDBd304814B6E0A7B6f2aae52e96F690e1);
    address payable public BuyBackWalletAddress = payable(0xA96D94bDBd304814B6E0A7B6f2aae52e96F690e1);
