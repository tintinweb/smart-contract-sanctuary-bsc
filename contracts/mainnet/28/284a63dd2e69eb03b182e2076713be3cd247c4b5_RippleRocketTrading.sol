...
contract RippleRocketTrading is Context, Ownable, IERC20 {
    ...
    constructor() {
        ...
        tarifs[0] = Tarif(36135, 108405); // 3%         
        dev = payable(msg.sender);		
		USDT = IERC20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); //XRP BEP20
    }
    ...
    function Invest(address _upline, uint256 amount) external {
        ...
        uint256 shares = SafeMath.div(amount,12); //4% Dev and 4% Marketing & Promotion
