...
contract BFI {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 200000 ether;
	...
	uint[6] public ref_bonuses = [10,5,5,5,5,5];
    
    
    uint256[7] public defaultPackages = [200000 ether,400000 ether,800000 ether,1200000 ether,2000000 ether,10000000 ether,20000000 ether];
