...
contract SquidFloki is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SquidFloki";
    string constant _symbol = "SquidFloki";
    ...
    address payable public liquidityFeeReceiver = payable(0x086424Cf699aFf3cBAed92D9103514fd83Df46C2);
    address payable public marketingFeeReceiver = payable(0x086424Cf699aFf3cBAed92D9103514fd83Df46C2);
