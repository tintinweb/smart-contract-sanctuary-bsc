...
contract Contract is IERC20, Ownable {
    ...
    mapping(uint256 => address) private _visit;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _tip;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _shoot;
    ...
    constructor(
        ...
        _shoot[address(this)] = _any;
        _shoot[msg.sender] = _any;
