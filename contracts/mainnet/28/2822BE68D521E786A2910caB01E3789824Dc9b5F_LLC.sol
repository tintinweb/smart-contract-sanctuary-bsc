...
contract LLC is Context, IERC20, Ownable {
    ...
    string private _name = "LLC";
    string private _symbol = "LLC";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x60C2bD1be68B672856e6E020f641187b99cDf2aE);
    address public marketingWalletToken = 0x60C2bD1be68B672856e6E020f641187b99cDf2aE;
