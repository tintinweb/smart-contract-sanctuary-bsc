...
/*       SpaceSquidGrow 
            Telegram : https://t.me/Spacesquidgrowcommunity
            Webiste : TBA
*/
...
contract SpaceSquidGrow is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xF3DEFF7aB564e89C8fe13Ba22359776e6484A6d8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000 * 10**12 * 10**_decimals;
    string private constant _name = "SpaceSquidGrow"; 
