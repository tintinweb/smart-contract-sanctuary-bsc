...
contract BBQ is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint; 
    MktCap public mkt;
    ...
    constructor(string memory name_,string memory symbol_,address minter_,uint total_) ERC20(name_, symbol_) {
        ceo=_msgSender();  
