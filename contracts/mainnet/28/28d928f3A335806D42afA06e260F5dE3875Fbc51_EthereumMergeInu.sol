...
contract EthereumMergeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ethereum Merge Inu";
    string private _symbol = "ETHMERGE";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xc80C79D49cc95cE7860D7e79FD4d8ddBD92744cd);
    address payable public teamWalletAddress = payable(0xC60eFFb2a16Df2B52e3dbED63b8203b01657C9df);
