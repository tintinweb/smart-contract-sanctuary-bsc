...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2552Bb93DED948e2121b5045443d7ee4C4f7Fe33; // owner address
...
contract NothingInu is Context, IERC20, Ownable {
    ...
    string private _name = "Nothing Inu";
    string private _symbol = "$NOINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2552Bb93DED948e2121b5045443d7ee4C4f7Fe33); // Marketing Address
