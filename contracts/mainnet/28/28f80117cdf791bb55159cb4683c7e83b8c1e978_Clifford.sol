...
contract Clifford is Context, IERC20Clifford, Ownable {
    ...
    uint256 public _maxwalletTokens = 20000000000 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Red Clifford"; // 
    string private constant _symbol = "Red Clifford"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE213a73b8Bd76EDd9d65A1D89465E8624860dD1b;
