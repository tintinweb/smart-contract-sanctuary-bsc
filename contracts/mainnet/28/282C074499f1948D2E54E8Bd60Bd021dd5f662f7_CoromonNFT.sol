...
/    \  \/ /  _ \_  __ \/  _ \ /     \ /  _ \ /    \ 
\     \___(  <_> )  | \(  <_> )  Y Y  (  <_> )   |  \
 \______  /\____/|__|   \____/|__|_|  /\____/|___|  /
        \/                          \/            \/ 
...
contract CoromonNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Coromon NFT", "COR", 55, 5555) {}
    ...
    uint256 public amountForAllowList = 55;
    uint256 public immutable maxPerAddressDuringMint = 55;
    ...
    uint256 public amountForPublicSale = 5500;
