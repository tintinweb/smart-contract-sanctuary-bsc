...
contract AIDOGE is ERC20, Ownable {
    ...
    uint256 public constant INITIAL_SUPPLY = 120_000_000_000 * 10**18;
    ...
    constructor(
        ...
        require(
            ...
            'AIDOGE: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'AIDOGE: incorrect fee percent');
        require(owner != address(0), 'AIDOGE: incorrect owner address');
        require(mintToAddr != address(0), 'AIDOGE: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'AIDOGE: transfer from the zero address');
        require(recipient != address(0), 'AIDOGE: transfer to the zero address');
