...
contract FartKitty is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FartKitty";
    string private _symbol = "FK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD7D7e263C840f7a9Fb4afB673651362b47544C3);
    address payable public teamWalletAddress = payable(0xdD7D7e263C840f7a9Fb4afB673651362b47544C3);
