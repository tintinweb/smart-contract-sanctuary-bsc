...
The power rangers unite against the monsters (jeetz) 
and destroy them, 
often asking "When, wen, wen ser"
Lets stop the ugly culture

    Telegram https://t.me/PowerRangersBsc

    Twitter https://twitter.com/PowerRangersBSC
...
contract PowerRangers is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x6A395Aa274982d274351A38C9C9Aa1095Dc0e7E3));


    string private _name = "Power Rangers 2.0";
    string private _symbol = "PORANG";
