...
在上次成功的项目之后，我们决定照常做 Listing，给大家一个诚实的评价。

他们带着雄心勃勃的计划来找我们，提出了一项商业计划，其最终目标是成为加密领域高度相关且可持续的去中心化银行。预售投资者也将在发布过程中获得匹配的回报。

他们的团队还在第一个月内确认了 12 家交易所的 $PBoC 上市以及他们在美国的实际地址。

要了解有关该实用程序的更多信息，请务必查看

https://t.me/PBocGlobal
...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 contract PBocGlobal is ERC20, Ownable {
    string private _name = "PBoC Global";
    string private _symbol = "PBoC";
    ...
    address public marketingWallet = 0xdA3295BC7a82C5866ea929135BaCf177551f086a;
