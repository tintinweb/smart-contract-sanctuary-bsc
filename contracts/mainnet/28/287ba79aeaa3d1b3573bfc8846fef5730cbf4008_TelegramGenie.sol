...
contract TelegramGenie is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    address MarketingWallet = 0x6A06b73c64f7931075A5983a3A0BDd77a791E645;
    address MarketingWalletTwo = 0x6A06b73c64f7931075A5983a3A0BDd77a791E645;
 
    string constant _name = "Telegram Genie";
    string constant _symbol = "TGGENIE";
    uint8 constant _decimals = 8;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 99000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 99000000 * (10 ** _decimals);
