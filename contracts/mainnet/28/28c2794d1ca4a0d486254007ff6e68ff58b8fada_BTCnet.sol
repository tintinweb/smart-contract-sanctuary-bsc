...
contract BTCnet is IBEP20, Auth {
    ...
    string constant _name = "BTC NETWORK";
    string constant _symbol = "BTCnet";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
