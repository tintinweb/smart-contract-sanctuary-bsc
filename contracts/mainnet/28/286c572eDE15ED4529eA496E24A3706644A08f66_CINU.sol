...
/**
Welcome to Chinese Inu 🐕👋

Fair launch Today's at 14:00-15:00 PM UTC🚀🚀

✅DEV DOXXED

🏮Chinese Inu is a hyper-deflationary token whose aim to revolutionize Defi. building revolutionary products such as Chinese Inu Blockchain, Chinese Inu Wallet and introducing a multi-chain Chinese Inu Swap across Ethereum, Binance, Cronos, and Polygon.

🐕Utilities🐕

🏮Chinese Inu is not just meme token, it is something fun but with utility: Chinese Inu Blockchain, Chinese Inu Swap, Chinese Inu Wallet, and Multi-chain Bridge.

🏮Chinese Inu will be launched on multiple chains. First launching on the Binance Smart Chain Network, to prove that the developers at Chinese Inu are serious about what we are developing. Chinese Inu team Brings old BSC vibes back to build strong community building brand and products. This is why we are launching on BSC First because we are in it for the long haul.

🐕Tokenomics🐕

🏮Total Supply : 100.000.000.000
🏮Token name : Chinese Inu
🏮Symbol          : CINU
🏮Decimal         : 9
...
So keep an eye on the chat and stay tuned.

🏮WEBSITE AND UTILITY LIVE TOMMOROW🏮

Telegram: https://t.me/Chineseinu
...
contract CINU is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 1e9; // KILL ZERO CHINESE INU
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Chinese Inu"; // token name
    string public _symbol = "CINU"; // token ticker
    ...
    uint256 private minTokenToSwap = 100000000000 * 1e9; 
    uint256 private maxHoldingAmount = 100000000000 * 1e9;
    uint256 private minBuyLimit = 100000000000 * 1e9;
