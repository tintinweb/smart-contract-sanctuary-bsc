...
contract BALLTZE is ERC20, Ownable {
    ...
    constructor() ERC20("BALLTZE", "BTZE") {
        ...
        swapTokensAtAmount = 1000000000000 *1e18; // 0.1% swap wallet

        maxBuyTransactionAmount = 40000000000000 * (10**18); // 2%
        maxSellTransactionAmount = 10000000000000 * (10**18); // 1%
    	...
    	marketingWallet = address(0xEe81F8bA4B977A9cdC0fc003dA00d537389CBE35); // set as marketing wallet
