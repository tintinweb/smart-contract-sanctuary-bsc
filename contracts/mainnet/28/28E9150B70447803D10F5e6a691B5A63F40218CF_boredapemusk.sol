...
contract boredapemusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bored Ape Musk"; // 
    string private constant _symbol = " $BAM "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x2fd69cC777FE6B53b8BF16cE5E378Dcc974d20B9;
