...
contract MTG is ERC20 {
	...
	address payable _receive = payable(address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3));
    ...
    constructor(address tokenOwner,address root) ERC20("MetaGalaxy", "MTG") {
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**35);
        ...
        _root = root;
        doge = IERC20(0x3203c9E46cA618C8C1cE5dC67e7e9D75f5da2377);
        uint256 total = 10**33;
    ...
    function _transfer(
        ...
        if (takeFee) {
            super._transfer(from, _receive, amount.div(100).mul(3));
            
            super._transfer(from, address(this), amount.div(20));

            super._transfer(from, uniswapV2Pair, amount.div(50));
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x3203c9E46cA618C8C1cE5dC67e7e9D75f5da2377);
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount >= 10**8){
            ...
            if(buySize>0){
                ...
                uint256 totalAmount;
                if(buySize >1000){
                    startIndex = (block.timestamp).mod(buySize-1000);
