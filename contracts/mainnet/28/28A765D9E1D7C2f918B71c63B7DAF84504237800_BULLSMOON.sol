...
contract BULLSMOON is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BULLSMOON";
    string constant _symbol = "$BULLSMOON";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xAaB8434Ada20Cf45Aff6D5626C42b6fc2fb150a5 ;
