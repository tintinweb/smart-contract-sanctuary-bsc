...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee = _fundFee + _fundFee2 + _dividendFee + _lpFee;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 totalFee) private lockTheSwap {
        ...
        uint256 fundUsdt2 = usdtBalance * 2 * _fundFee2 / totalFee;
        if (fundUsdt2 > 0) {
...
contract DOGE is AbsToken {
    constructor() AbsToken(
        ...
        address(0xF3af529EcA70a1160c0FAdf6B6fC81E3813b9Fd8)
    ){
