...
/* Token contract */
contract WorldCup2026 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x83BEd61228D455BCb47985414558d0940F33b30e;
    ...
    // Name and symbol
    string constant _name = "WorldCup2026";
    string constant _symbol = "WC2026 ";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 260000000 * (10 ** _decimals); // 100T

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 5% on launch or 5T tokens
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 2.5% or 2.5T tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 5% or 5T tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x83BEd61228D455BCb47985414558d0940F33b30e;
