...
//We are at the precipice of a revolution, to bring things back to how they once were, 
//to bask in the glory of the months of yore all over again.  
//What was once old is new, only... bigger... bolder... LOUDER!  
// https://t.me/kurtlarvadisitoken
//Here Kurtlar Vadisi 
//Don't forget the 

//Kurtlar Vadisi  is a community-centric BSC project led by some of the most based names in the industry today.
//  Kurtlar Vadisi aims to bring back the glory days of BSC by reinventing what is old and bringing something new and exciting to the scene.  It is 100% SAFE.
...
library Address{
 ...
 contract KurtlarVadisi  is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0905ef6a71B9BC3681bc53a2d2258B83702DB215;
    address public donationWallet = 0x0905ef6a71B9BC3681bc53a2d2258B83702DB215;

    string private constant _name = "Kurtlar Vadisi";
    string private constant _symbol = "KV";
    ...
    Taxes public taxes = Taxes(0, 10, 2, 3);
    Taxes public sellTaxes = Taxes(0, 45, 9, 45);
