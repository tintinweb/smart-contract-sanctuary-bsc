...
//    }
    ...
    */
    function redeem() inRedeem isTargetTokenReady nonReentrant external {
        ...
        uint256 firstClaimableAmountFactor = amountFactor.div(2);
        require(firstClaimableAmountFactor != uint256(0), "You didn't purchase or you have redeemed, or you have disqualified");

        purchasedAmountFactor[buyer] = amountFactor.sub(firstClaimableAmountFactor);
        uint256 amount = firstClaimableAmountFactor.mul(targetTokenMultiplicationFactor);
    ...
    function secondRedeem() inRedeem isTargetTokenReady nonReentrant external {
        address buyer = _msgSender();
