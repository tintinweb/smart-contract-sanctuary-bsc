...
/*
    ...
    Telegram : https://t.me/daddysnake
    Website : https://daddysnake.io/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x948E02c027290BBEa63CbfC6BC7D20c5395d8638; // owner address
...
contract DaddySnakeToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Daddy Snake";
    string private _symbol = "$DS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x948E02c027290BBEa63CbfC6BC7D20c5395d8638); // Marketing Address
    address payable public teamWalletAddress = payable(0x948E02c027290BBEa63CbfC6BC7D20c5395d8638); // Team Address
