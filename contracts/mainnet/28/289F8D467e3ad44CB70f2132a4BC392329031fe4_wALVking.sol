...
contract wALVking
 is Context, IERC20, Ownable {
    ...
    string private _name = "wALVking";
    string private _symbol = "wALVking";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC9a890085AdfeAFB430f385aAA43b659f863f42B));
        _anotherA = payable(address(0xC9a890085AdfeAFB430f385aAA43b659f863f42B));
