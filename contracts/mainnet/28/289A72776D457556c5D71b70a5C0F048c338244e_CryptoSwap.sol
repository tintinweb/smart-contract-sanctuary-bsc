...
contract CryptoSwap is Ownable {
    ...
    string constant _name = "Crypto Swap";
    ...
    uint256 public buyTax = 300; //total buy fee
    uint256 public sellTax = 1200; //total sell fee

    uint256 public ecoFee = 300; //ecosystem fee
    uint256 public burnFee = 0; //burnFee 
    uint256 public extraFeeOnSell = 900; //buycompetition Fee
