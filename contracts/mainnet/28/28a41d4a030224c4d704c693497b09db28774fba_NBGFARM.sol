...
pragma solidity ^ 0.6.2;
 ...
 contract NBGFARM is Ownable {
	...
	address REWARD = 0x7d43Fc6E88D1E58Ec59aB7126C973fA09D212702;
    ...
    function balanceAvailable(uint256 _pid, address _user) public view returns(uint256) {
        ...
        uint256 _amount = block.number.sub(user.deposit_time).mul(user.amount.div(pool.daylock.mul(259200)));
