...
contract ES  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEFAe006c86EAE8316CeD273eF4f654b7d0FA0d5a); 
    address payable public Wallet_Dev = payable(0xEFAe006c86EAE8316CeD273eF4f654b7d0FA0d5a);
    ...
    string private constant _name = "Eternal Savior"; 
    ...
    constructor () {
        ...
        _owner = 0x23e9483682504bf3C74455BCFa0F2CB6B5508Be6;
    ...
    function setTaxFeePercent(uint256 taxbuy,uint256 taxsell,uint256 mkt,uint256 dev,uint256 burn,uint256 lp ) public onlyOwner {
        _Tax_On_Buy = taxbuy;
        _Tax_On_Sell = taxsell;
        Percent_Marketing = mkt;
        Percent_Dev = dev;
        Percent_Burn = burn;
        Percent_AutoLP = lp;
    }
