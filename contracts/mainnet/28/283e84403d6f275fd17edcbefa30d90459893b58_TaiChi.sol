...
contract TaiChi is Ownable, IBEP20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x926fF5d7dA5CC238ED597956DE8Cf43DfA2c5E99;
    ...
    function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner {
        require(maxWallPercent >= 5,"Cannot set max wallet less than 0.5%");
        _maxWalletToken = (_totalSupply * maxWallPercent ) / 1000;
    }
    function setMaxTxPercent(uint256 maxTXPercentage) external onlyOwner {
        require(maxTXPercentage >= 5,"Cannot set max transaction less than 0.5%");
    ...
    function setTax(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _stakingFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setTaxReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver) external onlyOwner {
