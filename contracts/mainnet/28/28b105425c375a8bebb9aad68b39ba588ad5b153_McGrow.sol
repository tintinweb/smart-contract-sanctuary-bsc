...
library Address{
 ...
 contract McGrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6411625e7E6E0Ae6Ab4824c1E64d01cc029BB2d9;
    address public donationWallet = 0x6411625e7E6E0Ae6Ab4824c1E64d01cc029BB2d9;

    string private constant _name = "McGrow";
    string private constant _symbol = "MCGROW";
    ...
    Taxes public taxes = Taxes(0, 4, 3, 3);
    Taxes public sellTaxes = Taxes(0, 10, 5, 5);
