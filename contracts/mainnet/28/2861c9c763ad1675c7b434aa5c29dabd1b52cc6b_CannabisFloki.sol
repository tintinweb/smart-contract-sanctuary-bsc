...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd); 
...
contract CannabisFloki is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant private _name = "Cannabis Floki";
    string constant private _symbol = "$CF";
    uint8 constant private _decimals = 18;

    uint256 constant private _totalSupply = 10000000* 10**_decimals;
    ...
    //sellFees
    uint256 private sellFeeLiquidity = 15;
    uint256 private sellFeeMarketing = 40;
    uint256 private sellFeeOps = 15;
    uint256 private sellFeeRewards = 30; 
    ...
    address private marketingFeeReceiver = 0x8bC583D9cF1d13F40811953857D97295014ea34e;
    address private opsFeeReceiver = 0xcc8f7eFAed6538D1DCFD306f5Fe8792B135b6Bac;
    ...
    uint256 public swapThreshold = _totalSupply * 2 / 5000;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(automatedMarketMakerPairs[sender]) { //buy
            if(!isFeeExempt[recipient]) {
                require(_balances[recipient].add(amount) <= _maxWalletAmount, "Max Wallet Limit Limit Exceeded");
