 ...
 */
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 9) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x621Ea15d5fE22FDe3b41158508Ef3376d45F9C4E;//marketing
...
contract BAH is Token {
    constructor() Token(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
    
        address(0x55d398326f99059fF775485246999027B3197955),//pairs
        "BiAnHua",
        "BAH",
        9,
        ...
        address(0x879BC6d332Ae41A5dB98a54Fc38dB274147eEa77),//fund
    
        address(0xC4301a4a05E58711598A8a4EAA5D7ED79AC0dB29)//fund
    ){
