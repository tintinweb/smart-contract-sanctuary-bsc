...
library Address{
 ...
 contract SaudiNeko is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xDC91163CfA98acc2d1971C1D58eD010ce296b285;
    address public donationWallet = 0xDC91163CfA98acc2d1971C1D58eD010ce296b285;

    string private constant _name = "SaudiNeko";
    string private constant _symbol = "SAUDINEKO";
