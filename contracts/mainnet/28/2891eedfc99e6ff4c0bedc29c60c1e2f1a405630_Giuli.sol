...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function initializeGiuli(address newOwner) external onlyOwner returns (bool) {
...
contract Giuli is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Giuli";    
    string public symbol = "GIULI";
    ...
    function setCoolGiuliWait(uint256 newCoolWait) external onlyOwner {
        require(
	...
	function getGiuliFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
	...
	function swapAndGiuliToFee(address _token, uint256 tokens) private  {
	...
	function approveGiuliMax(address spender) external returns (bool) {
