...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3a9a66A651D5Ba0E69f34AcE1b5Ba4102d8f4965;
...
contract TIPSTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1c22FC859cdb525ed5aF19eBbBDd60b428a79cF1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TIPSTOKEN";
    string private _symbol = "TPS";
