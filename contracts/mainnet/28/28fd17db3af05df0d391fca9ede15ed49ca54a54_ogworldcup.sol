...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2D14a28ae0f9392c6168Cb6e3a98C40D2468289a; // owner address
...
contract ogworldcup is Context, IERC20, Ownable {
    ...
    string private _symbol = "OGWCUP";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x2D14a28ae0f9392c6168Cb6e3a98C40D2468289a); // Marketing Address
    address payable public teamWalletAddress = payable(0x2D14a28ae0f9392c6168Cb6e3a98C40D2468289a); // Team Address
