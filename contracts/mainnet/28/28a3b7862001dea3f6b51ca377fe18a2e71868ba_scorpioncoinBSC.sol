...
contract scorpioncoinBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "scorpion coin BSC"; // TODO change
    string private _symbol = "SCB"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95BAdE0E39763cBe55d9F25B51f8A43f1b96571a); // Marketing Address
    address payable public buybackWalletAddress = payable(0x0E90f2cBEfF6cEfcE1d089e5AD4E2F2f352fD4Dd); // Buyback Address
