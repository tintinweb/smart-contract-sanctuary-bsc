...
contract Dogegram is Context, IERC20, Ownable {
    ...
    string private _symbol = "Dgram";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x6CEcaf71eC02bAAC2ceAeeB4f6DA88BeDD0B38B1);
    address payable public teamWalletAddress = payable(0x28437A1588355723C14FF627EC1F231009084F2d);
