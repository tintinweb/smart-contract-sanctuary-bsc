...
/**
TG: https://t.me/molibnetwork
Website: https://web.molib.network
**/
...
contract MolibNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Molib Network";
    string private _symbol = "MNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb97Ca4a229f3bfa6EDbf30F625186689D62e3ae2); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x6496bC454D956CFFd8346fA66b6d3b8dFeC79Cff); // Development Address
