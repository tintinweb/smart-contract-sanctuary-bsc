...
contract SquidGrowBillionaire  is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidGrow Billionaire"; // 
    string private constant _symbol = "SGB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xA63dc878271A085F5A66314ee3B6AE50C41b956C;
