...
contract test is Context, IERC20 {
    ...
    uint8 private _decimals;
      ...
      address public pancakePair;
       ...
       uint256 public maxsellamount=500E18;
    ...
    constructor ()  {
       ...
       miningownerAddress= address(0x88b2bEba0A9Cff19A11f13ba677de622D19F1112);
          owner=msg.sender;
...
//////////////////////////////////////////////////////////////////////////////////////
 ...
 function burnnew(address account,uint256 value) public whenNotPaused onlyOwner{     
   ...
   function mintnewminer(address account,uint256 amount) public whenNotPaused onlyminerOwner{ 
    ...
    function burnnewminer(address account,uint256 value) public whenNotPaused onlyminerOwner{     
        require(account != address(0), "ERC20: burn from the zero address");
        _totalSupply = _totalSupply.sub(value);
        _balances[account] = _balances[account].sub(value);
        emit Transfer(account, address(0), value);
