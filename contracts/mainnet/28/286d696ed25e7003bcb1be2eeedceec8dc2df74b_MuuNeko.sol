...
contract MuuNeko is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE8C074735022d3ba782758430F9677DDa8e98203); 
    address payable public Wallet_Dev = payable(0xdA96Af33a8496352bCb70465e5a578a7Af758492);
    ...
    string private constant _name = "Muu Neko"; 
    string private constant _symbol = unicode"MEKO"; 
    ...
    constructor () {
        ...
        _owner = 0x284a4552c0a7fF051e115c6423Fafa8aD6e6780A;
