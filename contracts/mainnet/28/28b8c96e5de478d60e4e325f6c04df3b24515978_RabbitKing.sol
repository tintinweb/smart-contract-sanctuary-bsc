...
/**
 *Rabbit King | $RING
  The Rabbit King is known as $RING. 2023 is the year of rabbit and by combing the King of BSC and luckiest animal in the twelve zodiac, the rabbit. we hope to create the best and strongest community in BSC network.
  TG:https://t.me/RabbitKingbep20
*/
...
contract RabbitKing is Context, IERC20, Ownable {
    ...
    string private _symbol = "Rabbit King";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x8EC1a35CbFCaa37724cA6D7CE901D8B96f3c6B64);
