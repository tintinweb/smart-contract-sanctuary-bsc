...
contract PLDMONk is Context, IERC20, Ownable {  
    ...
    string  private _name = "OldMonk";
    string  private _symbol = "OMK";
	uint8  private _decimals = 4;
    uint256 public  _TaxFee = 8;
    uint256 private _previousTaxFee = _TaxFee;
    uint256 public  _marketingPer = 8;
    address payable private takeMain;
    address payable public markWallet = payable(0x7309C052C40E335DF48FF00737FAA32CF615933c);
        ...
        function swapAndLiquify(uint256 contractTokenBalance) private
          {
           ...
           uint256 initialBalance = address(this).balance;
            ...
            uint256 SplitBNBBalance = Balance.div(_marketingPer);
