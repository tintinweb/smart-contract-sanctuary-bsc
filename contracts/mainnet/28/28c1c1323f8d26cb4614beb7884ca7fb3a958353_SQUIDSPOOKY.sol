...
contract SQUIDSPOOKY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x52db931BD47Ad071eD47578A753b17968E63f7EF); 
    address payable public Wallet_Dev = payable(0x71bFDea627B6EdEA5726bfbb7b64e3B267c5E792);
    ...
    string private constant _name = "SQUID SPOOKY"; 
    string private constant _symbol = unicode"SDSY"; 
