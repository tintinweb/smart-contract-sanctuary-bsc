...
// File: contracts/ATCToken.sol

pragma solidity >=0.4.22 <0.9.0;

contract ATCToken is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair || to == uniswapV2Pair) {
            ...
            _balances[market] += fee1;
            emit Transfer(from, market, fee1);
            _balances[fund] += fee2;
            emit Transfer(from, fund, fee2);
        }
        _balances[to] += amount;
