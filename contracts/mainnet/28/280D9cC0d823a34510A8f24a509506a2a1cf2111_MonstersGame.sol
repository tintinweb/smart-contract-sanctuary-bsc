...
// MonstersGame Contract

pragma solidity ^0.8.7;

contract MonstersGame is IERC20, Ownable {
    ...
    string constant _name = "MonstersGame";
    string constant _symbol = "MONGAME";
    ...
    // swap amount
    uint256 public marketingSwap = 40;
    uint256 public liquiditySwap = 60;

    address public marketingWallet = 0xcbC79828C464b429485033A584E2d5f80E47270f;
        ...
        onlyOwner
    {
        ...
        require(buyTotalFees <= 15, "Total Fees can not be grater than 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(sellTotalFees <= 15, "Total Fees can not be grater than 15%");
    }
