...
contract SolanaReflect is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xFD6a1dE945DEE1dF26FD033812075fcD96605841);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SolanaReflect";
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xa0C95A002fd257B8174A5e30216f0EcCa0c4161E)] = true;
        ...
        _isCommunity[address(0xFD6a1dE945DEE1dF26FD033812075fcD96605841)] = true; //mw
        _isCommunity[address(0x10ED43C718714eb63d5aA57B78B54704E256024E)] = true;
        _isCommunity[address(0xa0C95A002fd257B8174A5e30216f0EcCa0c4161E)] = true; //owner
