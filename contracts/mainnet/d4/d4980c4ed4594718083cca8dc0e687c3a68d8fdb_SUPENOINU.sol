...
/**  supeno inu to the moon
https://t.me/supenoinu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2969120578a942082F63Df3aA64e5399520b89aD; // owner address
...
contract SUPENOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Supeno Inu";
    string private _symbol = "PENO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2969120578a942082F63Df3aA64e5399520b89aD); // 
    address payable public teamWalletAddress = payable(0x2969120578a942082F63Df3aA64e5399520b89aD); // 
