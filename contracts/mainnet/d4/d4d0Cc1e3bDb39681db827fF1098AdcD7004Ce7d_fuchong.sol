...
contract Ownership is Context {  
    ...
    */
    ...
    function indication(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract fuchong is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "fuchong";
    string private _symbol = "CHONG";
   ...
   function declaim(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function reducefee() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
    ...
    function setAllFees(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
