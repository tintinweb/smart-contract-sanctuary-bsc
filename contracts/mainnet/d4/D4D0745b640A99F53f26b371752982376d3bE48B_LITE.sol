...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xA01683b3d2C6142D9D40E181800Ab0eC5F78EC88;
...
contract LITE is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 1**6 * 10**_decimals;
    string private constant _name = unicode"Litenum"; 
    ...
    uint256 public _maxWalletToken = 1**5 * 10**_decimals;
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xA01683b3d2C6142D9D40E181800Ab0eC5F78EC88), BNB_Tot);
            }
