...
address constant SHJ = 0x59ca1F07db16ec596216aA0f435382582A814507;
...
abstract contract LiquidityFeeUSDT is Owned, DexBaseUSDT, ERC20 {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 initialBalance = IERC20(SHJ).balanceOf(address(this));

        // swap tokens for ETH
        swapTokensForTokens(half); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

        // how much ETH did we just swap into?
        uint256 newBalance = IERC20(SHJ).balanceOf(address(this)) -
            initialBalance;
...
contract KF_Token is ExcludedFromFeeList, LiquidityFeeUSDT, LpFee, BurnFee {
    uint256 private constant _totalSupply = 10888 * 1e18;
