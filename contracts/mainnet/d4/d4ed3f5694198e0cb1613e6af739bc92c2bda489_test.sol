...
contract test is Context, IERC20, Ownable {
    ...
    address payable private teamAddress = payable(0x043a517B6F94Ab142bf878d65363c534d2a510A3); // team Address
    ...
    uint256 public _teamFee = 6; //team fee will be use for marketing and charity
    uint256 private _previousteamFee = _teamFee;
    
    uint256 private teamDivisor = 6;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(teamAddress, transferredBalance.div(_teamFee).mul(teamDivisor));
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tLiquidity = calculateteamFee(tAmount);
