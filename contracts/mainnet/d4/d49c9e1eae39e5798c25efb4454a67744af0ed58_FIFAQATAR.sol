...
library Address{
 ...
 contract FIFAQATAR is Context, IERC20, Ownable {
    ...
    address public donationWallet = 0x5322bBC674F46Eb4919eA50111333366BF3B7B7B;

    string private constant _name = "FIFAQATAR";
    string private constant _symbol = "FIQATAR";
