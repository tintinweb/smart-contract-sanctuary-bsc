...
contract PGALA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF753433a9F60b6D1d417a5db21bcbB477B3C5937;

    string private constant _name = "pGala";
    string private constant _symbol = "pGala";
