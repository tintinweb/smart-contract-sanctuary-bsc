...
abstract contract TToken is IERC20, Ownable {
...
contract T is TToken {
    constructor() TToken(
        ...
        address(0x733D045Fcb780CC6bb4e53B7617ff69585890270),//FundAddress
    
        address(0x245b366156d6f451C68b9073EaAB957eF1FD0284)//Receive Address
    ){
