...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDA3355143b807B4358dB646932e907bE8Bf94173; // owner address
...
contract Diefloki is Context, IERC20, Ownable {
    ...
    string private _symbol = "Dieflo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD74Bd2d4e6e02Cb0136043FA9cA4BaFD2d300616); // Marketing Address
    address payable public teamWalletAddress = payable(0xD74Bd2d4e6e02Cb0136043FA9cA4BaFD2d300616); // Team Address
