...
interface IMining{
    function getOrderAmount(address user) external view returns(uint256);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 order;
        if(mining != address(0)) order = IMining(mining).getOrderAmount(from);
...
contract RAC is ERC20{
    ...
    modifier onlyOwner() {
        require(owner == msg.sender,"Not permit");
        _;
    }
