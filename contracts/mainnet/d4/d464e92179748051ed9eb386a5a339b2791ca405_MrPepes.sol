...
contract MrPepes is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MrPepes";
    string private _symbol = "PEPES";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x1d6d1630d2860cf424EB702F367ED870ED3e8342); 
    address payable public teamWalletAddress = payable(0xf343CE07E9ce8445838dC8419De8a5054D079825); 
