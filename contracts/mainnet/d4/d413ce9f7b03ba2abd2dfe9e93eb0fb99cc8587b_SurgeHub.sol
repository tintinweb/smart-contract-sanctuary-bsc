...
/**
*      𝕥𝕖𝕝𝕖𝕘𝕣𝕒𝕞 : 𝕙𝕥𝕥𝕡𝕤://𝕥.𝕞𝕖/𝕊𝕦𝕣𝕘𝕖𝕙𝕦𝕓    
*   
* This token is prohibited for those under 18
* Welcome to the world of porn, 
* grab your bag and watch this token go to the moon ✔
 */
...
contract SurgeHub is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeHub";
    string private constant _symbol = "SHUB";
    ...
    //Tax wallets
    address public teamWallet = 0x640b1A2a92af8f17861d1DC5d63b7f72E7b7436f;
    address public treasuryWallet = 0x23118eb466317C21dE4a5e5d9B4485cbc3700d1f;
