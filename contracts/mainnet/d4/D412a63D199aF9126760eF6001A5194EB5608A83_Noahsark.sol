...
contract Noahsark is ERC20 {
	...
	address private _fundAddress = address(0x2eADf23A5F18a02e3040384d6Ce40b3bA8F13a50);
	address public _poolAddress = address(0x2eADf23A5F18a02e3040384d6Ce40b3bA8F13a50);
	...
	function changeSwapWarp(NSKWarp _warp) public onlyOwner {
        warp = _warp;
	...
	function swapAndLiquifyUsdt() public {
		...
		if(allAmount > 10**19){
			...
			if(allusdtAmount > usdtAmount){
				...
				USDT.transfer(_poolAddress,newUsdtAmount.div(4));
			}
		}
    }
	...
	uint256 public usdtPerAmount = 10**20;
	...
	function rescueToken(address poolAddress)
    public
    returns (bool success)
    {
        require(contractSender == msg.sender);
