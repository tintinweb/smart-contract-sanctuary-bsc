...
/**
 * TATE BROS - famous brothers on the internet, it’s only a matter of time before the entire world is using $TATEBROS Token. 
   100% community project and Tate Brothers - fan driven.

   You must do your part to spread the word of Tate Bros Token. The more people who are aware of Tate Bros greatness, the larger your net-worth grows.

   Community driven project. Low tax and each buy/sell transaction automatically burning 1%.

   Tax 3/3
   1% Liquidity
   1% Marketing 
   1% token auto burn on each transaction.

TG: https://t.me/TateBrosPortal
*/
...
contract TATEBROS is Ownable, IBEP20 {
    ...
    string constant _name = "TATE BROS";
    string constant _symbol = "TATEBROS";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x7b470f56524aD5027BeEaCE8bC15514dE8687E9b;
        marketingWallet = 0x2Ef8C65AE463cBf7FF232E0b3855803e88FaC2a9;
        devWallet = 0x7b470f56524aD5027BeEaCE8bC15514dE8687E9b;
