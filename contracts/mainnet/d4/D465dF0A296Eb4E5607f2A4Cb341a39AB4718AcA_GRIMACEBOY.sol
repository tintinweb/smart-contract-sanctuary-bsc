...
// Telegram: https://t.me/GrimaceBoy
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB9FC6160599E7F89189CE9a9116E536374BB6471; // owner address
...
contract GRIMACEBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GRIMACE BOY";
    string private _symbol = "GRIMACE";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x4C55E311f93367107023713452457C8ccDAD0B73); 
    address payable public teamWalletAddress = payable(0x4C55E311f93367107023713452457C8ccDAD0B73);
