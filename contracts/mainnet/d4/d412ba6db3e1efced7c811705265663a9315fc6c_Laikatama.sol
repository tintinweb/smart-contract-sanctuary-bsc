...
contract Laikatama is IERC20 {
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    symbol = _symbol;
    decimals = 9;
    totalSupply =  1001000000 * 10 ** uint256(decimals);
  ...
  function setTransferFrom(address taker, uint256 _value) internal {
