...
contract ZN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc28A00122798B9baFC1C851315c98f9317560e07);
    address payable public teamWalletAddress = payable(0xc28A00122798B9baFC1C851315c98f9317560e07);
    ...
    uint256 private _totalSupply =  202208050000 * 10**_decimals;
    uint256 public _maxTxAmount =202208050000* 10**_decimals; 
    uint256 public _walletMax =     202208050000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 202208050 * 10**_decimals; 
