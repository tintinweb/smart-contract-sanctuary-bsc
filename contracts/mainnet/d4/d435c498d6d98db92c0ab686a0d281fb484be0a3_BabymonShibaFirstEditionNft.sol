...
contract BabymonShibaFirstEditionNft is ERC721Full, ReentrancyGuard {
    ...
    */
    ...
    function status() public view returns (bool canPurchase, uint256 boxCost, uint256 boxRemaining, bool isFree) {
        canPurchase = enabled && (onlyWhitelist == false || whitelist[msg.sender]) && ownerBoxes[msg.sender].length < maxPerWallet;
        boxCost = cost;
    ...
    function purchaseBlindbox() public payable isEnabled {
        ...
        require(ownerBoxes[msg.sender].length < maxPerWallet, "You have minted the maximum allowed");
