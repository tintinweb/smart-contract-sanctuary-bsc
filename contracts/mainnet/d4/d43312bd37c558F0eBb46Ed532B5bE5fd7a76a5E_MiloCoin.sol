...
Decimals: 9
Telegram: https://t.me/MiloCoinOfficial
Website: https://milocoin.io
...
contract MiloCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xe74d2B28E2f4D18D66c10911DF190A4985063bCa));
    address payable public devWallet =
        payable(address(0x392103ea1F479fd52EE111da636E1c806547990A));
    address public liquidityReceiver =
        0x392103ea1F479fd52EE111da636E1c806547990A;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Milo Coin";
    string private _symbol = "MiloCoin";
