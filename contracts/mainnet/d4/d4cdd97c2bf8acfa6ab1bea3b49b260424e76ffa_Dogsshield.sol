...
contract Dogsshield is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xF8d58E2ac7E937aa7564B51eCEbA55842E495027;
    address public operationsAddress = 0x207852A6Abe00ae9C7e63a0C233C7E05b3855bcA;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Dogs Shild";
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        uint256 denominator= (feeRates.liquidity + feeRates.burn + feeRates.operations) * 2;
