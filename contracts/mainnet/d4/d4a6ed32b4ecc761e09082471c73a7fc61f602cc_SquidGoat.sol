...
contract SquidGoat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Goat";
    string private _symbol = "SquidGoat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07393D899252541197ff69D943797800df5C2595);
    address payable public BuyBackWalletAddress = payable(0x07393D899252541197ff69D943797800df5C2595);
