...
library Address{
 ...
 contract  fuckyall is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x59f6A9d7a73308836D665e2ee8A2935F7c2B57De;
    address public donationWallet = 0x107453a7ADb08287D12Bc509c77BD02491Efa1f5;

    string private constant _name = "fuckyall";
    string private constant _symbol = "fck";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 4, 4);
