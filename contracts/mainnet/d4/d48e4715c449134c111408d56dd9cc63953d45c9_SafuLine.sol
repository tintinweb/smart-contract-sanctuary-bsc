...
library Address{
 ...
 contract SafuLine is Context, IERC20, Ownable {
    ...
    bool public tradingEnabled = true; // 2022.03.05
    // bool public swapEnabled;
    bool public swapEnabled = true; // 2022.03.05
    ...
    address public marketingWallet = 0xC730C5Ef9D36928944162869411125CaF17cB9Cc;
    address public fundingWallet = 0x5304b6fE9A3d31208c21d983c6662Cf51d6Df91b;

    string private constant _name = "SafuLine";
    string private constant _symbol = "SFLN";
    ...
    Taxes public sellTaxes = Taxes(1, 4, 2, 3);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _funding) public onlyOwner {
        buytotaltaxes = _rfi + _marketing + _liquidity + _funding; // 2022.03.05
        require(buytotaltaxes <= 15, "Must keep taxes at 15% or less"); // 2022.03.05
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _funding) public onlyOwner {
        selltotaltaxes = _rfi + _marketing + _liquidity + _funding; // 2022.03.05
        require(selltotaltaxes <= 15, "Must keep taxes at 15% or less"); // 2022.03.05
