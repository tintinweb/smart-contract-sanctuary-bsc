...
contract $TONER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stoner Inu"; 
    string private _symbol = "$TONER"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58EFbA8a37a419949ef9841B1634157FB6e9243b); 
    address payable public teamWalletAddress = payable(0x372709f3a578553B799489CA12472Bc44525848c); 
