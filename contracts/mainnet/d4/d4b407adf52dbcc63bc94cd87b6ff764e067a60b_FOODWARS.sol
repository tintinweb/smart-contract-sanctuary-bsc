...
contract FOODWARS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yukihira Soma";
    string private _symbol = "YS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07563ed41E30Fc2655a377D1a5b68Aa725EbB775); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xdc3F0eD7Afdb03DbAACD8bE7EfA53d6B596A95ec); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply.div(200); 
