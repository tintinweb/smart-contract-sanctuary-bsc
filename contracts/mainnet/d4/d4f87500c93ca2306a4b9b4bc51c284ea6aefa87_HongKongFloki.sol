...
contract HongKongFloki is Context, IERC20, Ownable {
    ...
    string private _name = "HongKongFloki";
    string private _symbol = "HKFloki";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x6Be508BC4B18E942a36948c7157Df00Da51645e1); 
    address payable public teamWalletAddress = payable(0x6Be508BC4B18E942a36948c7157Df00Da51645e1); 
