...
contract TetToken is BEP20("Tet Token", "Tet") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "Tet::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "Tet::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "Tet::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "Tet::_writeCheckpoint: block number exceeds 32 bits"
        );
