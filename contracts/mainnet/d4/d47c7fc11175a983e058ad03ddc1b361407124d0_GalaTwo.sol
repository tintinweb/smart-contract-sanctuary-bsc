...
// t.me/Gala2BSC
// The smartest auto liquidity pool with no human invervention.
// Our tokenomics are designed to bring smart pumps to our LP to provide users a safe
// cusion of BNB on our project which will always grow.
...
contract GalaTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1111585Ff7f1c68B413e8D2b3c7124B93A0dD73A); // Marketing Address
        
    address payable public teamAddress =
        payable(0x1111585Ff7f1c68B413e8D2b3c7124B93A0dD73A); // Team Address
        
    address payable public liquidityAddress =
        payable(0x1111585Ff7f1c68B413e8D2b3c7124B93A0dD73A); // Liquidity Address
    ...
    string private constant _name = "Gala2.0";
    string private constant _symbol = "Gala2";
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 8, "Must keep taxes below 8%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 8, "Must keep taxes below 8%");
