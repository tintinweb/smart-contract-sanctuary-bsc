...
contract CNWHALE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CN WHALE";
    string private _symbol = "CNWHALE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x48B742Ed8e36A2C889998d14466eD2219076347B);
