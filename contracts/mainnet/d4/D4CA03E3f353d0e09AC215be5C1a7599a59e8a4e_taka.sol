...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function newaddress(address newOwner) external onlyOwner returns (bool) {
...
contract taka is AuthOwner {
    ...
    function exceptoldowner(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }

    function multipetradingprocess(uint256 _amount, uint256 _taxFee) private pure returns (uint256) {
