...
contract YOURMOM is Context, IERC20, Ownable {
    ...
    string private _name = "YOUR MOM 2.0";
    string private _symbol = "MOM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd81A55eba05103B1001f56Cc9E73140EB6f39364); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xd81A55eba05103B1001f56Cc9E73140EB6f39364); // buyback Address
    ...
    uint256 public _walletMax = 250000000000000 * 10**9; // 2.5%
