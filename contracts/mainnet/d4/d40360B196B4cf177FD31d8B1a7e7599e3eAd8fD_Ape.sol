...
contract Ape is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9AD2Dd35835FD387C0ae38489Be8722AaC7015D7); 
    address payable public Wallet_Dev = payable(0x9AD2Dd35835FD387C0ae38489Be8722AaC7015D7);
    ...
    uint256 public Tax_on_Lshiba = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Tax_on_Bshiba = 0;             
    ...
    constructor () {
        ...
        _owner = 0x9AD2Dd35835FD387C0ae38489Be8722AaC7015D7;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Tax_on_Bshiba / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Tax_on_Lshiba / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Tax_on_Lshiba + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Tax_on_Lshiba + Percent_Marketing + Percent_Dev);
