...
contract QFINAL is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1b43EAAc288fAFfca71B41C9738141500d64d703;
    ...
    constructor(address _owner) ERC20("Qatar Final", "$QFINAL") {
        ...
        // exclude from fees or max transaction amount
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) public onlyOwner() {
        require(_buyFee+_sellFee <= 10, "tax too high");
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
