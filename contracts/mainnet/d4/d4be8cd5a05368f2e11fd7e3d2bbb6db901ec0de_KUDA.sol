...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57981F87c43C9978A26a51d90a58ce963fFa98bC;
...
contract KUDA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x115C333D079a94C9a091aB74B50AAd68FB600cEb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 300000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KUDA";
    string private _symbol = "KUDA";
