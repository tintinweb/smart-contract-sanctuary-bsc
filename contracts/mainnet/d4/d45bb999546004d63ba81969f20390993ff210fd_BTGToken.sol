...
contract BTGToken is IERC20, Ownable {
    ...
    address public marketAddress = 0x401da99c870FAe35b58c12072353CC95f34ad3DF;
    ...
    string private _symbol = "BTG COIN";
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 1000 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 5000000000 * 10**9)_burnFee = 0;
