...
contract REKTX is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'REKTX';
    string private constant _symbol = '$RTX';
    //uints
    uint public constant InitialSupply= 32000000000 * 10**_decimals;
    uint public buyTax = 60;
    uint public sellTax = 60;
    uint public transferTax = 60;
    ...
    address private projectWallet=0x50641Fa435bDf66f389B68eDaAAAa6235aDc5a65;
