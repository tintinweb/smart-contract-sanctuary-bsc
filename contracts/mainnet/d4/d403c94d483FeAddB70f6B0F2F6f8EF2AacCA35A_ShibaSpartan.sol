...
TELEGRAM: https://t.me/ShibaSpartan
|
*/
...
contract  ShibaSpartan  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Shiba Spartan ";
    string private _symbol = " $SS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF353b2Ef358A84ADb879627602bBE14F331cBF0f); 
    address payable public teamWalletAddress = payable(0xDd3dc87da7b50bB965fD35aCF3FfA9E6eC5C69DA); 
