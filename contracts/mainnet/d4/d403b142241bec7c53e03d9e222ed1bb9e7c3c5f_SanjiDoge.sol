...
contract SanjiDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "SanjiDoge"; //
    string private constant _symbol = "SanjiDoge"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x602CfDD95f7A5bC97a89ECDa0e3A443eE66AB308 ;
