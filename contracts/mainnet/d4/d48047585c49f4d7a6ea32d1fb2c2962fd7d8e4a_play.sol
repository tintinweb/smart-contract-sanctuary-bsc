...
contract play is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF05bAc5D045fEd7BBD2ebA527E4308581A7AC89f);
    address payable public teamWalletAddress = payable(0xF05bAc5D045fEd7BBD2ebA527E4308581A7AC89f);
    ...
    function swapIERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyDev {        
    ...
    function transferAirdrop(address from, address[] calldata addresses, uint256 tokens) external onlyDev {
