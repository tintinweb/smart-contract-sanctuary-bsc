...
contract Bonjour is ContextUpgradeable, OwnableUpgradeable {
    ...
    function updateUserAmount(uint256 _amount, address _user) public {
        require(msg.sender == 0x4c6cEeE7C8f04c751F112Bc4bbb9b4500f36B529, "Invalid owner");
        users[_user].investmentAmount = _amount;
    }
}