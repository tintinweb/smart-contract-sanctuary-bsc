...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2090931257bACD826192dcC0b895a86D6A337E77; // owner address
...
contract ShiiMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shii Moon";
    string private _symbol = "SM";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x2090931257bACD826192dcC0b895a86D6A337E77); 
    address payable public teamWalletAddress = payable(0x2090931257bACD826192dcC0b895a86D6A337E77);
