...
contract ERC20 is Context, IERC20, IERC20Metadata, Manage {
    ...
    string  private _name ="WTAP";
    address public _owner;
    string  private _symbol = "WTAP";
    ...
    function changeBuyFee(uint256 ratio)public onlyOwner{
        buyFee=ratio;
    }
    function changeSellFee(uint256 ratio)public onlyOwner{
        sellFee=ratio;
    }
    function changeBuyFeeAddress(address addr)public onlyOwner{
        buyFeeAddress=addr;
    }
    function changeSellFeeAddress(address addr)public onlyOwner{
        sellFeeAddress=addr;
    }
