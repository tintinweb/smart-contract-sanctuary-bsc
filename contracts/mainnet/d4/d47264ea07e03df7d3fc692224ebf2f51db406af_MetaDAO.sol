...
contract MetaDAO is IBEP20 , Ownable, BaseToken {
    ...
    constructor(
        ...
        _totalSupply = 1000 * 10**12 * 10**_decimals;
        ...
        marketingWallet = 0x2DA0C478CC2CCE98413c029D63089717422ADc7a;  //marketingwallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(1).div(totalFee).div(2);
