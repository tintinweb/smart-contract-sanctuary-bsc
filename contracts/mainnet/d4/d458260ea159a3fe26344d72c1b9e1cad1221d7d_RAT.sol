...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x91C570aA24a65B3d951DCf5db1F8dC334d9050c1;
...
contract RAT is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x91C570aA24a65B3d951DCf5db1F8dC334d9050c1);
    address payable private Wallet_Burn = payable(0x91C570aA24a65B3d951DCf5db1F8dC334d9050c1); 
    address payable private Wallet_zero = payable(0x91C570aA24a65B3d951DCf5db1F8dC334d9050c1); 
