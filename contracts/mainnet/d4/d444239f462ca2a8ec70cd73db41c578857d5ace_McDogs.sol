...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e19aDa39C797b77F7634d2128A3E63427Ae609F;
...
contract McDogs is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x9AbFD453a48f854632b638B2F0fD56C7C65157B5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "McDogs";
    string private _symbol = "McDogs";
