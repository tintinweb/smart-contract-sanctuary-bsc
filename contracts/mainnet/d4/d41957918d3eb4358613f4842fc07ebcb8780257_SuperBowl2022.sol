...
contract SuperBowl2022 is Context, IBEP20, IBEP20Metadata, Pausable, Ownable{
   ...
   constructor (address _marketingWallet, address _developmentWallet, address _lottery) {
   ...
   function distributeFee() internal {
       ...
       if(contractTokenBalance >= minimumTokensBeforeSwap) {
           ...
           if(buyBackSwapEnabled) swapETHForTokens(address(this), lottery, transferredBalance.mul(buyBackFee).div(totalSwapFee));
