...
contract miloharb   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "miloharb";
    string private _symbol = "miloharb";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8a2b9685F7C21983a6962fE60051480e5a6ed7FF); // Marketing Address
    address payable public teamWalletAddress = payable(0x0215CF98145d07ec34A0Aba17e4f3f441ccA564f); // Team Address
	address public OwnerAddress = 0x8a2b9685F7C21983a6962fE60051480e5a6ed7FF;
