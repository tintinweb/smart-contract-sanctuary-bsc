    ...
    ReentrancyGuard
{
    ...
    function claimSoldAmount(uint256 amount) external onlyIssuer onlyActive nonReentrant {
     ...
     */
    function claimFaceValue() external onlyMatured onlyRefunded nonReentrant {
        uint256 _bondBalance = balanceOf(msg.sender);
        require(_bondBalance != 0, "invalid bond balance");
        _burn(msg.sender, _bondBalance);
