...
contract KOBABYPI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x69294117A25B6f807c2099ffA2eFAaC6A9Dd8A6A); // Marketing Address
    ...
    string private _name = "KOBABYPI";
    string private _symbol = "KOBABYPI";
