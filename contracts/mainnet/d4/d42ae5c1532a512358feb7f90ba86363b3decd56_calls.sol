...
/**
 Telegram : https://t.me/wencallsser
...
contract calls is Context, IERC20, Ownable {
    ...
    string private constant _name = "WenCallsSer"; // 
    string private constant _symbol = "Wencallsser"; //    
