...
/**
The ultimate degen for everyone who appreciates the beauty of this world 🌍!
The the most enjoyable and fun place to be. 
Grab a Moon Bag & Drop your Hottest Eye Candy and be Free in Here.
https://t.me/whoisshetoken
 *with Changeable reward 
*/
...
//Contract for rewards distribution. We distribute in BUSD from BEP20
...
contract WhoIsShe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Who Is She?";
    string constant _symbol = "WIST";
