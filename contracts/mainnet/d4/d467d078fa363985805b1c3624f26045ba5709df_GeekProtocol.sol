...
contract GeekProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Geek Protocol", "GEEK") {
        ...
        marketingWallet = address(0x6028fF76365B665E31385906cfc653C9dA848597); // set as marketing wallet
    	devWallet = address(0x6028fF76365B665E31385906cfc653C9dA848597); // set as dev wallet
