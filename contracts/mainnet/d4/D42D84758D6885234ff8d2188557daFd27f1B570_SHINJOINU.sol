...
contract SHINJOINU is IERC20, Ownable {
    ...
    string _name = "Shinjo Inu";
    string _symbol = "ShinjoInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 12) / 100;   // 2%
    uint256 public _maxTxAmount = (_totalSupply * 12) / 100;     // 2%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x4C3f38206F39e40C7Bc9aA9D9E6478f6E30B4157;
        marketingFeeReceiver = 0x4C3f38206F39e40C7Bc9aA9D9E6478f6E30B4157;
        devFeeReceiver = 0x4C3f38206F39e40C7Bc9aA9D9E6478f6E30B4157;
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalFee < 60, "Fees must be less than 25%");
    }
