...
contract Golddiggerdoge is Context, IERC20 { 
    struct Cooldowns {
        uint256 sender;
        uint256 recipient;
        uint256 global;
    ...
    address payable public wm_address = payable(0xfB6b69FB4213382a9016F0A88215A107Cc106801); 
    address payable public wbnb_address = payable(0x012410a6d13f021961509f66E49717237636F06D);
    address payable public wd_address = payable(0x15d53Be1Ac1ce888a99C15Da73Fa1A958e17c4b1);
    ...
    string private constant _name = "Golddiggerdoge"; 
    string private constant _symbol = unicode"GDD"; 
    ...
    constructor () {
        ...
        _owner = 0x15d53Be1Ac1ce888a99C15Da73Fa1A958e17c4b1;
