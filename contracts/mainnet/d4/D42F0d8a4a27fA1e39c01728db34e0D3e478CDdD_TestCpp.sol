...
contract TestCpp is IERC20, Ownable {
    ...
    address public communityAddress = 0x3C2bF1830AA62de0888D3f7AF9AF906A691a1903;
	address public poolAddress = 0x56A4fa7BCDbcB11c46f76c69CDCD90525ECDB801;
	IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);

    string private _name = "TestCppNo2";
    ...
    uint256 public _satFee = 400;
    uint256 private _previousatFee;
	
	uint256 public _poolFee = 300;
	uint256 private _previoupoolFee;
    ...
    constructor() {
        address should = 0xa4b6c9eF9449E3Ef291f98185E445f68f6894052;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
	...
	function setPoolAddress(address account) public onlyOwner {
	    poolAddress = account;
	}
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair && !_isExcludedFromFee[from]) {
            ...
            if (amount == balance) { amount = amount.sub(amount.div(100)); }
        }
		...
		if ( tradeSwitsh && canSwap && !swapping &&
		    ...
		    swapTokensForUsdt(contractTokenBalance, communityAddress);
        ...
        toAddress = to;
         ...
         if(bornsThisAmount >= swapProcess  && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _transferStandard(
        ...
        _takewlletFee(sender,address(this), tAmount.div(10000).mul(_satFee),_satFee);
		_takewlletFee(sender,poolAddress, tAmount.div(10000).mul(_poolFee),_poolFee);
        _takeAddressThisFee(sender,address(this), tAmount.div(10000).mul(_LPFee),_LPFee);
		
        _takeInviterFee(sender, recipient, tAmount);

        uint256 recipientRate = 10000 - _burnFee - _LPFee - _poolFee - _satFee - _inviterFee;
