...
contract QatarBall is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QatarBall";
    string private _symbol = "QatarBall";
    ...
    uint256 private _totalSupply =  3200000 * 10**_decimals;
    uint256 public _maxTxAmount =   3200000 * 10**_decimals; 
    uint256 public _walletMax =     3200000 * 10**_decimals;
