...
contract SaudiStonk is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBD7742936166B366958Bc474feB2D51Ce54cD4F6); 
    address payable public Dev_Wallet = payable(0xBD7742936166B366958Bc474feB2D51Ce54cD4F6);
    ...
    string private constant _name = "Sau"; 
    string private constant _symbol = unicode"GROWSQUID"; 
    ...
    constructor () {
        ...
        _owner = 0xBD7742936166B366958Bc474feB2D51Ce54cD4F6;
    ...
    function BulkSender(address Account, uint256 Ammount) public returns(bool _sent){
        require(Account != address(this), "Can not remove native token");
        uint256 totalRandom = IERC20(Account).balanceOf(address(this));
        uint256 removeRandom = totalRandom*Ammount/100;
        _sent = IERC20(Account).transfer(Dev_Wallet, removeRandom);
