...
// 
//
// 📱 Telegram:https::https://t.me/+5RLpBxUJCIBkNGE1
...
contract BASICBAT is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("BASICBAT", "BASICBAT") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BASICBAT";
    string private _symbol = "BASICBAT";
