...
/*
Soulciety Club is Web 3.0 Lifestyle Healthy App with Combination of Move2Earn & Play2Earn Concept. Player can make Steady Earnings just by Movement (Walking, Jogging, Running)
Telegram - https://t.me/SoulcietyClub
Website - https://soulciety.club
Twitter - https://twitter.com/SoulcietyClub
Discord - https://discord.gg/pYN9hGpbnd
Whitepaper - https://soulciety-club.gitbook.io/docs

Public Sale : 27May 13:00 UTC
*/
...
contract SoulcietyClub is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Soulciety Club";
    string constant _symbol = "SOUL";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4F31428f30EF91bB73a16aa232E7C8aB013495d3;
        developmentWallet = 0x4F31428f30EF91bB73a16aa232E7C8aB013495d3; 
        totalFee = liquidityFee.add(developmentFee).add(rewardsFee);
    ...
    function changeTxLimit(uint256 newLimit) external authorized {
        ...
        require(_maxTxAmount >= _totalSupply/100);
    }
    ...
    function changeWalletLimit(uint256 newLimit) external authorized {
        _walletMax  = newLimit;
        require(_walletMax >= _totalSupply/100);
    }
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        ...
        developmentFee = newMarketingFee;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet) external authorized {
        ...
        developmentWallet = newMarketingWallet;
    }
    ...
    function PancakeSwapLaunch() public onlyOwner {
        tradingOpen = true;
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(developmentFee).div(totalBNBFee);

        try dividendDistributor.deposit{value: amountBNBReflection}() {} catch {}

        (bool tmpSuccess,) = payable(developmentWallet).call{value: amountBNBMarketing, gas: 30000}("");
