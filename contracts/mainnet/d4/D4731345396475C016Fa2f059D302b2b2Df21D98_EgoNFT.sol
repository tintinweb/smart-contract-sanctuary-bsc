...
contract EgoNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    // address public ROUTER = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // rinkeby

    address public MV_ADDRESS = 0x5f2cc40598Ad7a54a62a9949a560E5888569D483;
    ...
    function mintAllowList(uint8 numberOfTokens, bool withTokens) external payable {
        ...
        if (withTokens) {
            ...
            tkn.transferFrom(msg.sender, MV_ADDRESS, toTransfer);
        } else {
