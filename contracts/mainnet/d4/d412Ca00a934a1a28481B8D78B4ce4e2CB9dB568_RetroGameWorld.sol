...
contract RetroGameWorld is IERC20, Ownable {
    ...
    string _name = "Retro Game World";
    string _symbol = "RETROGAMEWORLD";
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x069a51Eb18DE07661c5C364cA46eee11583623F5;
    ...
    function takeFeeInProportions(address sender, address receiver, uint256 proportionAmount) internal returns (uint256) {
        ...
        if (receiver == pair) {
            ...
            if (_coolDown[receiver] == 0) {
                _coolDown[receiver] = block.number;
            }
        }
