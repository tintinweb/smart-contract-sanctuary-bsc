...
/**
SafeJupiter stealth launch

SafeJupiter is your next BSC moonshot and a rare BSC gem. SafeJupiter is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.


Tokenomics 
Total Supply: 100.000.000.000.000.000
Burn Supply:  50.000.000.000.000.000
⛽️Buytax: 10 %
⛽️Selltax: 10 %
...
📱Website: https://www.SafeJupiterportal.com (not yet live )
📱Telegram: https://t.me/SafeJupiterPortals
...
contract SafeJupiter is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeJupiter"; 
    string private constant _symbol = "SafeJupiter"; 
