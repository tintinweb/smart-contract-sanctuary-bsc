...
contract CakeVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 cakeAtLastUserAction; // keeps track of SantaX deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // SantaX token
    ...
    /**
     * @notice Constructor
     * @param _token: SantaX token contract
    ...
    /**
     * @notice Deposits funds into the SantaX Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in SantaX)
     */
    ...
    /**
     * @notice Reinvests SantaX tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the SantaX Vault
     */
     ...
     * @return Expected reward to collect in SantaX
     */
     ...
     * @return Returns total pending SantaX rewards
     */
    ...
    /**
     * @notice Withdraws from funds from the SantaX Vault
