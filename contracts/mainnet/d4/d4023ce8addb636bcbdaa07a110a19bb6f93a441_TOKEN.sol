...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0x15b28fA826756355Cfb409b9AEAF60ec2bCf7Ff0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 lpfee;
        if(_liquidityFee == 1 || _liquidityFee == 2)
        {lpfee = 1;}
        else{ lpfee = _liquidityFee.div(2);}
        uint256 tFee = _marketingFee.add(lpfee);
        ...
        uint256 halfFunds = newBalance.div(tFee).mul(lpfee);
