...
contract MagicPalm is Ownable, Pausable, ReentrancyGuard {

    bool public started;

    uint8[8] public INIT_PERCENTAGES = [60, 40, 30, 25, 20, 16, 12, 10];
    uint256[8] public INIT_AMOUNTS = [250000000000000000000, 150000000000000000000, 85000000000000000000, 30000000000000000000, 15000000000000000000, 5000000000000000000, 1000000000000000000, 100000000000000000];
