...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ee55eBfc6eB7a7eb040997E1889618BAf38f1F7; // owner address
...
contract BeepBeepInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beep Beep Inu";
    string private _symbol = "BBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42Bb50d60c039D025129C02baD4E3E7bD2f1e2af); // Marketing Address
    address payable public teamWalletAddress = payable(0x0f8CcddC3445C489155358c333aAdDe155C4Af6b); // Team Address
