...
// File: chainbridge/contracts/ERC20Safe.sol
...
// File: chainbridge/contracts/handlers/HandlerHelpers.sol
...
// File: chainbridge/contracts/interfaces/IBridge.sol
...
// File: chainbridge/contracts/handlers/ERC20/ERC20HandlerPercentageFee.sol
...
contract ERC20HandlerPercentageFee is IDepositExecute, HandlerHelpers, ERC20Safe {
    ...
    function deposit(
        ...
        require(_calculateMinimumFee(tokenAddress, destinationDomainID) < amount, "< minFee");
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        uint256 fee = _calculateFee(tokenAddress, IBridge(_bridgeAddress)._domainID(), amount);
        ...
        if (_burnList[tokenAddress]) {
            ...
            mintERC20(tokenAddress, address(_bridgeAddress), fee);

        } else {

            releaseERC20(tokenAddress, address(recipientAddress), amount);

            releaseERC20(tokenAddress, address(_bridgeAddress), fee);
