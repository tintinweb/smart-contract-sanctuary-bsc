...
contract Valorantcipherinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"Valorant cipher inu";
    string private _symbol = unicode"VCINU";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xf0E8b4014f3e7A74457CB6a5f88cbF8Acd9a5314); 
    address payable public BurnedWalletAddress = payable(0xf0E8b4014f3e7A74457CB6a5f88cbF8Acd9a5314); 
