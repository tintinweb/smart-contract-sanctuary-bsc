...
/**
 King Tuzi Project is focused on achieving virality through exposure. 
 Its unique design,
 Roasting Telegram Bot and consistent branding and style will make it easy for people to share and spread the word about the token.

Telegram: https://t.me/KingTuzi
...
contract KingTuzi is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "King Tuzi";
    string private constant _symbol = unicode"KingTuzi";
    ...
    address payable public DevWallet = payable(0xB5DF7Ba252Eb18A5D88E5D5AEe36F8bF0EDc538e);
    address payable public MarketingWallet = payable(0x18fFD37Ce40Ae9C5a64d24ba981734D1821C57Ac);
