...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ABb4b9960E335e19935f1B914c1801767b0Bb24; // owner address
...
contract NetherlandsGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Netherlands Grimace";
    string private _symbol = "NethGrimace";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5ABb4b9960E335e19935f1B914c1801767b0Bb24); // Marketing Address
    address payable public teamWalletAddress = payable(0x5ABb4b9960E335e19935f1B914c1801767b0Bb24); // Team Address
