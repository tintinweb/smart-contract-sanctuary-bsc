...
*/
 ...
 /** The Media Inu
    ...
    https://twitter.com/elonmusk/status/1552324811153707018?s=20&t=jOq_s6qWRhQdf_JKdbhSAQ
    Degen play, if you want lot of bucks make some effort to make telegram group. 
    I suggest to name it @MediaInu 
    
    This is the next evolutionary Decentralized Finance (DeFi) with Elon hyped token.

    Tokenomics
    Tax fee buy&sell 6% - Community driven!

    🔥Liquidty 2%
    💧Marketing 4%

    Total Supply  : 100,000,000,000 tokens
    Max Wallet    : 5% (5,000,000,000 tokens)
    Max Tx        : 5% (5,000,000,000 tokens)

// TG: https://t.me/MediaInu
...
contract MEDIAINU is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0x5ba86f3457A384033F2f296207BFBC208Ec88579);
    address private liquidityReceiver = address(0x900d21853600fd9d85a5365847CC4F45f7b8211f);
