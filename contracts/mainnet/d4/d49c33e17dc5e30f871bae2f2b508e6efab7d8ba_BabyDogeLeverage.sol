...
contract BabyDogeLeverage is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Doge Leverage";
    string private constant _symbol = "BabyDogeL";
