...
contract led is Ownable, IERC20, IERC20Metadata{
    ...
    constructor() {
        ...
        _pairPool= 0x883E56142DaC9DeB11782a4736495c1AE5FD10bd;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(sender == _pair || recipient == _pair){
            ...
            // 6%分润
            if(recipient == _pair){
                dnamicRewards(sender, amount*6/100);
            }else{
                dnamicRewards(tx.origin, (amount*6/100));
            }
            // 剩余
