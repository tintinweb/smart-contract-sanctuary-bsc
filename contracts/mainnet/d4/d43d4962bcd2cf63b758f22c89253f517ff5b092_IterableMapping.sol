...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  function updateDividendUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "4DGEAPE: The router already has that address");
  ...
  constructor() {
    ...
    whiteListRewardTokens[address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82)] = true; // CAKE - Pancake Swap
        whiteListRewardTokens[address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D)] = true; // SHIB
        ...
        whiteListRewardTokens[address(0xDFea6EC0223A9a0E620298528fcd737D60Ba5C64)] = true; // DOGENATION 
        whiteListRewardTokens[address(0x631E1e455019c359b939fE214EDC761d36bF6aD6)] = true; // PINK PANDA 

    
    InvestorAddress = payable(0x554b6147659cF6756B98159019B2fc551bb54FBd);
  }
...
contract DOGEAPEBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private constant gasPriceLimit = 70 * 1 gwei; // do not allow over x gwei for launch
     ...
     // Anti-bot and anti-whale mappings and variables      HAHAHAHAH SORRY JEETS
    ...
    address public defaultToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    ...
    constructor() ERC20("DOGEAPE", "$APE", 18) {
    	...
    	operationsWallet = address(0x490C110E590AA5e977feBB80654B46200Ad1787D);
    	investorWallet = address(0x554b6147659cF6756B98159019B2fc551bb54FBd);
    	marketingWallet = address(0x87589fEc9E33afA85f0aEf7587c4D17A3b4B6a37);
        buybackWallet = address(0xf13f358b867DdD9E70E9bc71093c7c6e2c118b5C);
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
  	...
  	function setWhiteListAMM(address ammAddress, bool isWhiteListed) external onlyOwner {
  	  require(isContract(ammAddress), "4DGEAPE: setWhiteListAMM:: AMM is a wallet, not a contract");
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	...
  	function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "4DGEAPE: The dividend tracker already has that address");

        DividendTracker newDividendTracker = DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "4DGEAPE: The new dividend tracker must be owned by the 4DGEAPE token contract");
    ...
    // shows % in BNB gifted to Investor.
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "4DGEAPE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        require(airdropWallets.length == amount.length, "4DGEAPE: airdropToWallets:: Arrays must be the same length");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) external onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "4DGEAPE: The liquidity wallet is already this address");
    ...
    function updateOperationsWallet(address newOperationsWallet) external onlyOwner {
        require(newOperationsWallet != operationsWallet, "4DGEAPE: The operations wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "4DGEAPE: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "4DGEAPE: Cannot update gasForProcessing to same value");
    ...
    // @dev User Callable Functions start here! ---------------------------------------------
  	...
  	function setRewardToken(address rewardTokenAddress) external returns (bool) {
  	    require(isContract(rewardTokenAddress), "4DGEAPE: setRewardToken:: Address is a wallet, not a contract.");
  	    require(rewardTokenAddress != address(this), "4DGEAPE: setRewardToken:: Cannot set reward token as this token due to Router limitations.");
  	    require(isWhitelistedToken(rewardTokenAddress), "4DGEAPE: setRewardToken:: Reward Token must be whitelisted to be used as rewards.");
  	...
  	function setRewardTokenWithCustomAMM(address rewardTokenAddress, address ammContractAddress) external returns (bool) {
  	    require(isContract(rewardTokenAddress), "4DGEAPE: setRewardToken:: Address is a wallet, not a contract.");
  	    require(ammContractAddress != address(uniswapV2Router), "4DGEAPE: setRewardToken:: Use setRewardToken to use default Router");
  	    require(rewardTokenAddress != address(this), "4DGEAPE: setRewardToken:: Cannot set reward token as this token due to Router limitations.");
  	    require(isWhitelistedToken(rewardTokenAddress), "4DGEAPE: setRewardToken:: Reward Token must be whitelisted to be used as rewards.");
  	    require(isAMMWhitelisted(ammContractAddress) == true, "4DGEAPE: setRewardToken:: AMM is not whitelisted!");
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(userBNBDividends >= holderBNBUsedForBuyBacks[msg.sender].add(msg.value), "4DGEAPE: buyBackTokensWithNoFees:: Cannot Spend more than earned.");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "4DGEAPE: Automated market maker pair is already set to that value");
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 30 * 1e18; //must hold 2500+ tokens to get divs
    }

 

    function withdrawDividend() pure external override {
        require(false, "4DGEAPE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main 4DGEAPE contract.");
    }
