...
contract rabbit  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf4a18bf8Ea5e84255c0C9f0B3da4706f83f54B61); 
    address payable public Wallet_Dev = payable(0xEF19c7400F1B14a0533e35c6fc8B1A2735aeD194);
    ...
    string private constant _name = "RABBIT23"; 
    ...
    constructor () {
        ...
        _owner = 0xEF19c7400F1B14a0533e35c6fc8B1A2735aeD194;
