...
contract SpaceSnake is Context, IERC20, Ownable {
    ...
    address BBBR = 0x639CF44b66D02F822c57F97dabAF3547462f0CE9; // Reward Address

    address payable public marketingAddress =
        payable(0xaD63c909B5197fEa7A92Dbd44F6FA0072cB43937); // Marketing Address
        
    address payable public teamAddress =
        payable(0xb7c0f5c0e30835618864e97fe73fd11c50184BAf); // Team Address
        
    address payable public liquidityAddress =
        payable(0xaD63c909B5197fEa7A92Dbd44F6FA0072cB43937); // Liquidity Address
    ...
    string private constant _name = "SpaceSnake";
    string private constant _symbol = "SSNAKE";
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        if(buyOrSellSwitch == BUY){
            ...
            _teamTokensToSwap += tLiquidity * _buyrewardFee / _liquidityFee;
            ...
            _teamTokensToSwap += tLiquidity * _sellrewardFee / _liquidityFee;
