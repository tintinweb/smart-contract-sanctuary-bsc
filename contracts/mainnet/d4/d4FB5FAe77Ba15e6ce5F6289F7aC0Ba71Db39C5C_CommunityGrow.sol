...
Website - http://www.BeanGrow.net
Twitter - https://twitter.com/BeanGrowOfficial
Telegram - https://t.me/BeanGrowOfficial

The $BEANGROW token is for the THE BEAR. There is no simpler way to say it. If you hold, you get paid in Beans every two weeks.
...
1% Reflections
3% Grow The Bean Beans Rewards (GTB)
7% Community Trust Fund
     -Marketing
...
Forged from the ashes of previous projects, our people have gathered, determined to rise. After enduring multiple rugs, honeypots and malicious devs.. Welcome to the $BEANGROW token.
...
In an environment of dropping bags and fud, where devs abandon projects and their holders, $BEANGROW is an oasis in the crypto dessert. A project that grows by lifting others up!
...
Visit our community and get familiar with our main tg hub
...
Our goal most ambitious - a 100m cap aim.. achievable if an ever increasing amount of us 'Grow The Bean', and seek the rewards.

$BEANGROW tokenomics are specifically meant to enrich us all.. and put ppl in the green. Bimonthly rewards will pay in eth so we don't have to hurt the chart.

Q. Why a 30% transfer tax? 
A. We want to reward people for growing the floor not gaming the system. To prevent any possibility of manipulation we will keep tax at 30% for transfers between wallets. This tax will fuel our GTB rewards wallet.

Q. What are GTB rewards? 
...
For the GTB BNB rewards on July 15tH ALL who bought ON JULY 1ST and didn't sell until July 15th qualify

For the GTB BNB rewards on July 30th ALL who bought before July 15th and didn't sell until July 30th qualify

For the GTB BNB rewards on August 15th ALL who bought before July 30th and didn't sell until August 15th qualify

And so on.

Simply put.. buy $BEANGROW. Buy more on dips. Don't sell, and you will get BNB payouts every two weeks.

In our V2 phase we will put out a BNB Miner with 10% daily reward as earnings from staking Beans on BEANGROW

See as we GROW into the most bullish project on BSC
...
contract CommunityGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BeanGrow";
    string private constant _symbol = unicode"$BEANGROW";
 ...
 // Set the amount of blocks to catch a sniper.
        ...
        _isBlackListedBot[address(0x44964f14bf0eaBFb31bb8858382E7c989820bbbA)] = true;
        _blackListedBots.push(address(0x44964f14bf0eaBFb31bb8858382E7c989820bbbA));
        
        _isBlackListedBot[address(0xea417Fc85603a0C3950A36cC431D3Ed494A0AE73)] = true;
        _blackListedBots.push(address(0xea417Fc85603a0C3950A36cC431D3Ed494A0AE73));
        
        _isBlackListedBot[address(0x0A3133985E93e51e38D912ED7f8c73Aa15D59914)] = true;
        _blackListedBots.push(address(0x0A3133985E93e51e38D912ED7f8c73Aa15D59914));
        
        _isBlackListedBot[address(0xee4caC501306f4B23BA72217449B53a10970B78A)] = true;
        _blackListedBots.push(address(0xee4caC501306f4B23BA72217449B53a10970B78A));

        _isBlackListedBot[address(0x5E9192154407eE1e0DE615DC05dA0765F5B4A851)] = true;
        _blackListedBots.push(address(0x5E9192154407eE1e0DE615DC05dA0765F5B4A851));

        _isBlackListedBot[address(0xaf63DcdAE0b73aF3943a4B3Cab369eacebCd6df1)] = true;
        _blackListedBots.push(address(0xaf63DcdAE0b73aF3943a4B3Cab369eacebCd6df1));

        _isBlackListedBot[address(0xE143da245ebD2DFC3cF856472ce77457cd86C9e6)] = true;
        _blackListedBots.push(address(0xE143da245ebD2DFC3cF856472ce77457cd86C9e6));

        _isBlackListedBot[address(0xc6aFdAc608aac5c335b2be6139AC16e0C7BDD857)] = true;
        _blackListedBots.push(address(0xc6aFdAc608aac5c335b2be6139AC16e0C7BDD857));

        _isBlackListedBot[address(0x97B0DAA5049EC5F024AA9F924c0b2D3BFF56F2CD)] = true;
        _blackListedBots.push(address(0x97B0DAA5049EC5F024AA9F924c0b2D3BFF56F2CD));

        _isBlackListedBot[address(0x9320dCcc58431fC976ae57238F855A0918BC594B)] = true;
        _blackListedBots.push(address(0x9320dCcc58431fC976ae57238F855A0918BC594B));

        _isBlackListedBot[address(0xa3DC464742D4848b3AfE3EDBA775ca922B677745)] = true;
        _blackListedBots.push(address(0xa3DC464742D4848b3AfE3EDBA775ca922B677745));
        ...
        _isBlackListedBot[address(0x3101bD1Df91384F09DE14EaED25C26eBC1aB082a)] = true;
        _blackListedBots.push(address(0x3101bD1Df91384F09DE14EaED25C26eBC1aB082a));
    ...
    function setGTBWallet(address payable newWallet) external onlyOwner() {
