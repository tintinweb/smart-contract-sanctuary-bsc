...
4% Marketing 〽️
2% Liquidity 💧                                         
Telegram : Find us; Don't snipe Us.
*/
...
contract Xrpc is ERC20, Ownable {
    ...
    XrpcDividendTracker public dividendTracker;
    ...
    constructor() ERC20("XRP Classic", "XRPC") {
        marketingWallet = payable(0xf4b22De255827da9C4f98Bc5C38CAE2624e8FDe1);
        devWallet = payable(0x0F990e41a0CcE61f18cFf9C2AD54b38ae53c18eE);
        ...
        dividendTracker = new XrpcDividendTracker(
            payable(this),
            router,
...
contract XrpcDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        XrpcContract = Xrpc(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Xrpc_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Xrpc_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Xrpc contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XrpcContract);

            uint256 prevBalance = XrpcContract.balanceOf(address(this));
            ...
            {
                uint256 received = XrpcContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XrpcContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
