...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbA2aC2f12594Fc550Ac6De31fC467Af88a9937d6; // owner address
...
contract TWOGETWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twoge Inu 2.0";
    string private _symbol = "TWOGETWO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbA2aC2f12594Fc550Ac6De31fC467Af88a9937d6); // Marketing Address
    address payable public teamWalletAddress = payable(0xbA2aC2f12594Fc550Ac6De31fC467Af88a9937d6); // Team Address
