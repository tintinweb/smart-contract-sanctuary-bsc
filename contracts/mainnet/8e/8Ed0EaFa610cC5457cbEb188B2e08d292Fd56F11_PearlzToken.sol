...
contract PearlzToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
	...
	address public uniswapV2Pair; // the main pair (PEARLZ/BUSD)
	...
	function initialize() external virtual initializer {
		...
		trapWallet = address(0x4C85973AA4D667497FEd1556eE3b3A2D27aE8224);
	...
	function excludeFromFees(address account, bool excluded) public onlyOwner {
		require(_isExcludedFromFees[account] != excluded, "PEARLZ: Account is already the value of 'excluded'");
	...
	function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
		//require(pair != uniswapV2Pair, "PEARLZ: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
	...
	function _setAutomatedMarketMakerPair(address pair, bool value) private {
		//require(automatedMarketMakerPairs[pair] != value, "PEARLZ: Automated market maker pair is already set to that value");
	...
	uint256 amount
		...
		if(takeFee) {
			require(amount > totalFees.add(extraSellFee), "amount must be higher than fees");
