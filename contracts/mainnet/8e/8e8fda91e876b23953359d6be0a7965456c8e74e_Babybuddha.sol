...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x291c8Ca16cfcDf95Ab83fCe69c131ABF6a28803A);
...
contract Babybuddha is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xCab201474a532aab91917324fBba193bf5637E5c;

    string constant _name = "Baby Buddha";
    string constant _symbol = "Babybud";
