...
/*
TELEGRAM : https://t.me/Squindependence
*/
...
contract Squid is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 200; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 200; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 200; // 2% of supply
    ...
    string private constant _name = "SQUINDEPENDENCE DAY ";
    string private constant _symbol = "SQUIDAY";
