...
contract NITRO5G is NITRO5GDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private NITRO5GTeam;
    address private CharityNITRO5G;
    ...
    string public override name = "NITRO5G";
    string public override symbol = "NITRO5G";
    ...
    constructor(uint totalSupplyValue, address NITRO5GTeamAddress, address CharityNITRO5GAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        NITRO5GTeam = NITRO5GTeamAddress;
        CharityNITRO5G = CharityNITRO5GAddress;
       
        // split the tokens according to agreed upon percentages
        balances[NITRO5GTeam] =  totalSupply * 4 / 100;
        balances[CharityNITRO5G] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's NITRO5GTeam pot
