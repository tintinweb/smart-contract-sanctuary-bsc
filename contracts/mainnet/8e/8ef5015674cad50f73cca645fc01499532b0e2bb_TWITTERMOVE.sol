...
contract TWITTERMOVE is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x29d4FaCe4430C83C6698EFdD1ac45E95161A678b); 
    address payable private Wallet_Dev = payable(0x29d4FaCe4430C83C6698EFdD1ac45E95161A678b);
    ...
    string private constant _name = "TWITTER MOVE"; 
    string private constant _symbol = unicode"TMOVE"; 
