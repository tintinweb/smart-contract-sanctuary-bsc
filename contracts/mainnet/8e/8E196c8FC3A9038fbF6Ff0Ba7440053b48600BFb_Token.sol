...
contract  Token is IERC20, Ownable {
    ...
    uint256 public minLPDividendToken =  1e9;
    

    
    constructor(
        ) payable {
            address adminAddress = 0xc47E655BC521Bf15981134E392709af5b25947B4;
            _name = "11.11";
            _symbol = "11.11";
            _decimals= 18;
            _tTotal = 202211111111* (10**uint256(_decimals));
            _burnFee = 0;
            _marketingFee = 0;
            _LPFee = 100;
            marketAddr =  0xc47E655BC521Bf15981134E392709af5b25947B4;
            _tOwned[adminAddress] = _tTotal;
            
            burnEndNumber = 0* (10**uint256(_decimals));
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function excludeFromFee(address account) public onlyOwner {
     ...
     function excludeFromBatchFee(address[] memory accounts) public onlyOwner {
    ...
    function _transfer(
        ...
        if(canSwap&&from != address(this) &&from != address(this)  && to != uniswapV2Pair&&from != uniswapV2Pair ){
