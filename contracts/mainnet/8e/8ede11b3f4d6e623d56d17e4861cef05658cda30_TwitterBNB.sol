...
/* Token contract */
contract TwitterBNB is IBEP20, Auth {
    using SafeMath for uint256;
    // Addresses
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xAF4d603CFdf09E9657205319CDE27584f3F4AbA7;
    ...
    // Name and symbol
    string constant _name = "TwitterBNB";
    string constant _symbol = "tBNB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xAF4d603CFdf09E9657205319CDE27584f3F4AbA7;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient] && !isFeeExempt[sender] && !isFeeExempt[recipient] && sender == pair){
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).mul(2);
