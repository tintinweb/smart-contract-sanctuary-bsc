    ...
    UUPSUpgradeable 
{
    ...
    function burnFrom(uint256 _amount, address _address) external {
        uint256 currentAllowance = allowance(_address, _msgSender());
        require(currentAllowance >= _amount, "ERC20: burn amount exceeds allowance");
        unchecked {
            _approve(_address, _msgSender(), currentAllowance - _amount);
        }
