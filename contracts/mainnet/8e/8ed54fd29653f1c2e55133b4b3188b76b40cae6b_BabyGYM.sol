...
contract BabyGYM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGYM";
    string private _symbol = "BabyGYM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA184481Dea7Caa556Ab31B20E3366a5316516776); 
    address payable public BurnedWalletAddress = payable(0xA184481Dea7Caa556Ab31B20E3366a5316516776); 
