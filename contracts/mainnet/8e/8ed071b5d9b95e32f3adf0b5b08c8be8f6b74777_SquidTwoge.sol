...
contract SquidTwoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidTwoge";
    string private constant _symbol = "SQTWGE";
    ...
    function Buy() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
