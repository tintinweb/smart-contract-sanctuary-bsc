...
/*
    ...
    📛 LP locked on #PinkSale (365 Days)
    
    📍Website: https://pixasso.online

    📍Twitter: https://twitter.com/PixassoOnline

    📍Telegram: https://t.me/PixassoOnline
...
contract Pixasso is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = 'Pixasso';
    ...
    address private contentAddress = 0x5b656Da28aA75E0f180aF4ba2BDc7524Ce01bcf3;
    address private marketingAddress =
        0xBd424ADCb25349b14B3944b86d223C4f7d8B2596;
    ...
    function sendETHToFee(uint256 amount) private lockTheSwap {
        ...
        uint256 marketingShare = distributionEth
            ...
            .div(100);
        uint256 contentShare = distributionEth.mul(distribution.content).div(
            100
        );
