...
//SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract SpookyTerra is IBEP20, Auth {
        ...
        string constant _symbol = "SPOOKY TERRA";
        ...
        address public marketingFeeReceiver = 0x67BA2F2a4448A0f522c44D7692110677FA083304;
        address public buybackFeeReceiver = 0x1FB4bAf9e19E8a5244965Ef58387d8640c0D3370;
        ...
        function swapBack() internal swapping {
            ...
            uint256 amountToLiquify = contractTokenBalance.mul(developmentFee).div(totalFee).div(2);
            ...
            uint256 totalBNBFee = totalFee.sub(developmentFee.div(2));
            uint256 amountBNBLiquidity = amountBNB.mul(developmentFee).div(totalBNBFee).div(2);
            ...
            (bool devSuccess, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: amountBNBdev, gas: 30000}("");
        ...
        function setFees(uint256 _developmentFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _feeDenominator) external onlyOwner {
            developmentFee = _developmentFee;
            marketingFee = _marketingFee;
            buybackFee = _buybackFee;
            totalFee = _developmentFee.add(_marketingFee).add(_buybackFee);
        ...
        function transferForeignToken(address _token) public {
            ...
            payable(buybackFeeReceiver).transfer(_contractBalance);
        }
