...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN,Change RWRD contract to change reward token
...
/* Token contract */
contract BLUEYTokenApollo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BLUEY TOKEN";
    string constant _symbol = "BLUEY";
