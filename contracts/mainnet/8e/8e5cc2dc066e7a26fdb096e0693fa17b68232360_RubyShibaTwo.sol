...
contract RubyShibaTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ruby Shiba 2.0";
    string private _symbol = "RSHIBTWO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x744C452244cf6cabA16571b86d37A1620cd9A2e0);
