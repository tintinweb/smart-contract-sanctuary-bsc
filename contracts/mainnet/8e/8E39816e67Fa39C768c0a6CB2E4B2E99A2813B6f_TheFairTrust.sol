...
contract TheFairTrust is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (isSell(from, to) && !isExcludedFromFee(from)) {
    ...
    function _tokenTransferWithTax(
        ...
        _tOwned[BurnAddress] += BurnTax;
        _tOwned[treasuryAddress] += treasuryTax;
        ...
        emit Transfer(sender, BurnAddress, BurnTax);
        emit Transfer(sender, treasuryAddress, treasuryTax);
        ...
        )
    {
        return (
            ...
            _amount.mul(_treasuryFee).div(10**2)
        );
    }
    ...
    function setFees( uint256 liquidityFee , uint256 BurnFee , uint256 TreasuryFee) public onlyOwner{
