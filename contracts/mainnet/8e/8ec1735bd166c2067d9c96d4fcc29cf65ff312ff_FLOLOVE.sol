...
contract FLOLOVE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI LOVE";
    string private _symbol = "FLOLOVE";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x59E36e8bf8CD695B5a1986922Df9F97545aD497f); // Marketing Address
    address payable public BuyBackWallet = payable(0x59E36e8bf8CD695B5a1986922Df9F97545aD497f); // Team Address
