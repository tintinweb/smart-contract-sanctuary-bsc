...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x179b6734d8Cc71707Db8a663d46674038Bb0511A; // owner address
...
contract SHIMAINU is Context, IERC20, Ownable {
    ...
    string private _name = "SHIMA INU";
    string private _symbol = "SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x179b6734d8Cc71707Db8a663d46674038Bb0511A); // Marketing Address
    address payable public teamWalletAddress = payable(0x179b6734d8Cc71707Db8a663d46674038Bb0511A); // Team Address
