...
contract ShitzuInu is Context, IERC20, Ownable {
    ...
    string private _name     = "Shitzu Inu";
    string private _symbol   = "Shitzu";  
    ...
    address public marketingWallet = 0x4b35bc1b6ec5AED31eE51e49dd892f14af6Fb8e1;
    address public newOwner = 0x1D6Fe94ce142659f8652D0Bf644402956fF8ED6b;
    ...
    constructor() 
    { 
        newOwner = 0x1D6Fe94ce142659f8652D0Bf644402956fF8ED6b;
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        require(
            launchTime != 0 && 
            launchTime + 15 days < block.timestamp, 
            "You cannot change fees before 15 days passes after launch"
        );
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee;
        require(totalFees <= 10, "Total fees must be less than 10%");
    }
