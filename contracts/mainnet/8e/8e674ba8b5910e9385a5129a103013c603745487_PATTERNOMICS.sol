...
contract PATTERNOMICS is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 20 / 1000;
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 3 / 100; 

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x623A288F94Fa8ef36D82434d017c2ffeE7f1A477; 

    string private constant _name = "PATTERNOMICS"; 
    string private constant _symbol = "PATTERN"; 
