...
contract DUMPINU is ERC20, Ownable {
    ...
    constructor() ERC20("DUMP INU", "DUMPINU") {
        ...
        uint256 totalSupply = 1 * 10**6 * 1**18;
        ...
        devWallet = address(0xc170AF42EacD38Eb943fAdFabF9e274a91506147); 
