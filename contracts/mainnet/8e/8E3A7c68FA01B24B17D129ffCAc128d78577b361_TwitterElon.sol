...
contract TwitterElon is Context, IERC20, Ownable {
    ...
    string  private constant _symbol = "TwitterElon";   
    ...
    uint8   public  BuyOrSell=2;
     address payable public   _markWallet    =payable(0xFBC0E2cc7b085728929Cc130F6d41edA1DFb2CE5);
     address  public          Wallet_Burn  = 0x000000000000000000000000000000000000dEaD;
    uint256 private _markTx=2;
    uint256 private _markBuyTx=5;
    uint256 private _markSelTx=5;
     uint256 private _setP2PTx=0;
