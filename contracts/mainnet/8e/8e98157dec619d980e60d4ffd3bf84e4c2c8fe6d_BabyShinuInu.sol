...
/**
Baby Shina Inu is memecoins that giving rewards to holder in $SHI Shina Inu.
With our manual buyback to liquidity mechanism, we are able to buy back and build liquidity over the life of the coin.
Baby Shina Inu will be bringing multiple play to earn mini games and NFT's to the market.
...
contract BabyShinuInu is IERC20, Ownable {
    
    address WBNB;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Shinu Inu";
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0x8Ca5FF4375b6bCD2EcF51Fd23C75C211408B4d7D);
        ...
        autoLiquidityReceiver = 0x55c2d7b32ed276F78b070824b326a3122e882c59;
        isFeeExempt[autoLiquidityReceiver] = true;
        isTxLimitExempt[autoLiquidityReceiver] = true;
        isDividendExempt[autoLiquidityReceiver] = true;

        marketingFeeReceiver = payable(0x5c630b328E8aB462E6828C9b5A57d2dba30FE27F);
    ...
    function getBuyTotalFee() public view returns (uint256) {
        return totalBuyFee;
    }
    ...
    function takeBuyFee(address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeAmount = (amount * totalBuyFee) / feeDenominator;
    ...
    function takeSellFee(address sender, uint256 amount) internal returns (uint256) {
        uint256 feeAmount = (amount * totalSellFee) / feeDenominator;
    ...
    function swapBack() internal swapping {
        ...
        uint256 dynamicLiquidityFee = isOverLiquified(targetLiquidity, targetLiquidityDenominator) ? 0 : (buyLiquidityFee + sellLiquidityFee);
        ...
        uint256 amountBNBReflection = (amountBNB * sellReflectionFee) / totalBNBFee;
        uint256 amountBNBMarketing = (amountBNB * (buyMarketingFee + sellMarketingFee)) / totalBNBFee;
