...
TG: https://t.me/DecentralizedBotOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf2AeF41516A83bE7fF3f8591C7B119C48f00561a; // owner address
...
contract DecentralizedBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Decentralized Bot";
    string private _symbol = unicode"Dbot";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2AeF41516A83bE7fF3f8591C7B119C48f00561a); // Marketing Address
    address payable public teamWalletAddress = payable(0xf2AeF41516A83bE7fF3f8591C7B119C48f00561a); // Team Address
