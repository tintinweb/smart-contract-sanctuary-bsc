...
contract XDOGE is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xcf1122A2A237553403a179066aAAfb2154BC5b90);
    address payable private _marketingAddress = payable(0xcf1122A2A237553403a179066aAAfb2154BC5b90);
