...
https://t.me/ShikokuGrowOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0dF1E8dc0C4b7AD44162EeE13a83deB1eAbccab3; // owner address
...
contract ShikokuGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Shikoku Grow";
    string private _symbol = "SG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc4436A82b0951D020d66b01629F39b1aFEE92b63); // Marketing Address
    address payable private teamWalletAddress = payable(0x0dF1E8dc0C4b7AD44162EeE13a83deB1eAbccab3); // Team Address
