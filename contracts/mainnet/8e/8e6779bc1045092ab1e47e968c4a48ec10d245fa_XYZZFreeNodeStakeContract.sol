 ...
 */
contract XYZZFreeNodeStakeContract is Ownable {
   ...
   struct DepositInfo {
    ...
    function add(IERC20 _lpToken,uint256 _tokenPerBlock) public onlyOwner nonDuplicated(_lpToken) {
    ...
    function set(uint256 _pid,IERC20 _newLpToken,uint256 _tokenPerBlock) public onlyOwner {
    ...
    function setIInviteContract(address _newInviteContract) public onlyOwner {
        inviteContract = IInviteContract(_newInviteContract);
    }
