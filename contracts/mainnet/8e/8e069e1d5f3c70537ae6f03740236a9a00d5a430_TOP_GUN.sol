...
/*
    Top Gun is a great movie, you should rewatch it !
...
contract TOP_GUN is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;
  string private _name = "TOP GUN INU";
  string private _symbol = "TOP GUN INU";
  uint8 private _decimals = 9;
  address payable public marketingWalletAddress = payable(0xBd5a4C7270b5d871EB6F1373b7a9526809dA3D61); // Marketing Address
  address payable public DevelopmentWalletAddress = payable(0xBd5a4C7270b5d871EB6F1373b7a9526809dA3D61); // Development Address
