...
contract XDoge is Context, IERC20, Ownable {
    ...
    string private _name = "XDoge Inu";
    string private _symbol = "XDOGE";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x1e264542F345428bEF6c8cbbCee6a935120BdcD7);
    address payable public BuyBackWalletAddress = payable(0xb802A9b64d830db114875DE11f4cF3406C4e676A); 
