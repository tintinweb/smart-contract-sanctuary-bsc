...
contract GidgetInu is IBEP20, Auth {
    ...
    address DEV = 0xa363972d15e4fD3073a0681eD6Da9304DFC9dFea;
    ...
    string constant _symbol = "Taco Bell Dog";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x79EcCF38464a38BE7800aE4313292Bc6473D37a2;  
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _burnFeeBuy, uint256 _charityFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        burnFeeBuy = _burnFeeBuy;
        charityFeeBuy = _charityFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        developmentFeeBuy = _developmentFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_burnFeeBuy).add(_charityFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _burnFeeSell, uint256 _charityFeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        burnFeeSell = _burnFeeSell;
        charityFeeSell = _charityFeeSell;
        marketingFeeSell = _marketingFeeSell;
        developmentFeeSell = _developmentFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_burnFeeSell).add(_charityFeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
