...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7ee9639347415cBfD2FDBc8BaB0400666e03aac7; // owner address
...
contract BenzInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Benz INU";
    string private _symbol = "BINU"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4FbF7048764C7695DC0C549A0b349596065A92D); // Marketing Address
    address payable public teamWalletAddress = payable(0xdE2cC19EfdE8645D84D2E7d800F2d30b653ab88e); // Team Address
