...
contract ShenShou is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _market = 0x2D8b49De95A286C562bb813984F2624a6b45B0AC;
    ...
    uint256 private buyDividendFee = 2;
    uint256 private sellDividendFee = 2;
    ...
    constructor() ERC20("ShenShou", "ShenShou") {
        ...
        swapTokensAtAmount = 300000000000 * (10**18);
...
contract dDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 300000000000 * (10**18); //must hold tokens for dividen
    }
