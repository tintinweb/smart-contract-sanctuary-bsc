...
BabySpookyFloki
https://t.me/BabySpookyFloki_BSC

* 2% Max Tx | 2% Max Wallet
* 9% tax (10% slippage)
* 1% Liquidity
* 5% Marketing
* 3% SpookyFloki Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x5746A963C52924Ff97C81cb53DA7161e366b9b9A);
...
contract BabySpookyFloki is IBEP20, Auth {
    using SafeMath for uint256;


    //set REW to reward token contract
    address REW = 0x5746A963C52924Ff97C81cb53DA7161e366b9b9A;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabySpookyFloki";
    string constant _symbol = "BSF";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xa1D3BFFA11896ccc699C0A102Ad84Be51b730de8;
        marketingFeeReceiver = 0x91c39226237DBa4e86C8dbCA342325B5378200D9;
    ...
    function clearStuckBalance() external {
        ...
        payable(autoLiquidityReceiver).transfer(amountBNB);
    }
 ...
 // switch Trading
   ...
   // enable cooldown between trades
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBswapModule = amountBNBMarketing
        ...
        (tmpSuccess,) = payable(swapModule).call{
                value: amountBNBswapModule, 
                gas: 30000
                }("");
