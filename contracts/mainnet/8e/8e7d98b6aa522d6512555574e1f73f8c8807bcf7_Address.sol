...
contract MAFIAFROG is Context, IERC20, Ownable {
    ...
    string private constant _name = "FROGGO INU"; // 
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x917aB52b5eA9520e085B6Fb6C0Cedd8a610EAA1a);
