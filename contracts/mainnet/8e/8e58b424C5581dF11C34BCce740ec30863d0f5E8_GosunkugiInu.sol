...
contract GosunkugiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gosunkugi Inu";
    string private _symbol = "GOSUNKUGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x473d2f44899669d682604aCEA949b059EfCB0691); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x473d2f44899669d682604aCEA949b059EfCB0691); // Team Address
