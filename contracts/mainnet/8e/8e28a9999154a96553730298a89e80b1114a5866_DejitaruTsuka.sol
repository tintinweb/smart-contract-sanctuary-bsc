...
contract DejitaruTsuka is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x12df974C312a302A8B2C5A82eEc0E7C84D4491Cd); // Marketing Address
    address payable public teamWallet = payable(0x12df974C312a302A8B2C5A82eEc0E7C84D4491Cd); // BuyBack Address
