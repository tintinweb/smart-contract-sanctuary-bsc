...
contract GloryNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Glory Network"; // 
    string private constant _symbol = "GLORY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x6f2253AC0eA0464B35e5c9F7C0cdC5B8C2448De4;
    ...
    function includeInFee(address account) public onlyOwner {
       ...
       function setFee(uint256 NewMarketingFee, uint256 NewLiquidityFee) public onlyOwner {
