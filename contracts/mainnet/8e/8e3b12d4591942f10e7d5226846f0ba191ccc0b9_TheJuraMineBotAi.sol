...
✨New Born Token In BSC By DegenPlay Team✨
🦖 Jura Ai 🦖 Bep20Ai token Inspired by the ICO of  Jura network
Join the #JURAArmy.

👑Low Tax Gem 2%
👑Renounce
👑Lock Liquidty Pinksale
👑Burn 🔥 OwnerShip
 
👑Telegram ✨ https://t.me/JuraToken
          
         ----Don't miss---- 
🩸🩸🩸🩸🩸🩸🩸🩸🩸
NFA & DYOR - TAKE YOUR PIECE OF MEAT!

✨Jura Mine BOT✨https://www.jura.network/minebot
✨ ICO Jura ✨https://icoholder.com/en/jura-22699
...
abstract contract ContextBep20Ai {
...
contract OwnableBep20Ai is ContextBep20Ai {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBep20Ai: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBep20Ai: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TheJuraMineBotAi  is ContextBep20Ai, Bep20Ai, OwnableBep20Ai {
    ...
    string private _name = 'JuraAi';
    string private _symbol = 'JuraAi';
