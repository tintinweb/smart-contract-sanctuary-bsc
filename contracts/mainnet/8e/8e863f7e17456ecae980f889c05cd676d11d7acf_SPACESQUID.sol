...
contract SPACESQUID is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPACESQUID";
    string private constant _symbol = "SPACESQUID";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xa7882cd0D05D03dbf7E94555a00CB0A030b6b4Bd);
    address payable private _marketingAddress = payable(0xa7882cd0D05D03dbf7E94555a00CB0A030b6b4Bd);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 21, "Redis cannot be more than 21.");
	    require(taxFeeOnBuy < 3, "Tax cannot be more than 3.");
	    require(taxFeeOnSell < 21, "Tax cannot be more than 21.");
