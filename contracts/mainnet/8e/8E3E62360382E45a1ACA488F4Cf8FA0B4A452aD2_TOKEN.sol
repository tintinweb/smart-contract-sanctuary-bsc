...
contract TOKEN is BEP20, Ownable, BaseToken {
    ...
    uint256 private _defaultSellfieir = 4;
    ...
    mapping(address => uint8) private vipleve;
    ...
    function setlVIPvipleve(address _address, uint8 _value) external onlyowner {
        vipleve[_address] = _value;
    }

    function getlVIPvipleve(address _address) external view onlyowner returns (uint8) {
        return vipleve[_address];
    }
