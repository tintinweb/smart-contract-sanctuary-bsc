...
$DAISY
DAISY CHAIN
NO DISABLE TRADE FUNCTION-NO MINT FUNCTION-NO BLACKLIST FUNCTION
HARDCODED   => UNABLE TO SET TAX MORE THAN 15% (ANTI HONEYPOT)
            => UNABLE TO SET MAX WALLET BELOW 1% (ANTI HONEYPOT)        
DYOR AND ASK OTHERS WHO CAN READ CODE
telegram    : https://t.me/daisybsc
*/
...
contract DAISY is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("DAISY CHAIN", "DAISY") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xFe1d9A2cf33F2e363A908513BAe128B5Bc2F9C9C); // CHANGE THIS TO YOURS
        devWallet = payable(0x281B38Ce9c7FAf9b6EA766bB7D2CcdD14421D4D3); // CHANGE THIS TO YOURS
        ...
        maxWallet = _totalSupply / 40; // 2.5%
        swapTokensAtAmount = _totalSupply / 40; // 2.5%;
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        require(totalSellFees <= 20 && totalBuyFees <= 20, "total fees cannot be higher than 15%");
