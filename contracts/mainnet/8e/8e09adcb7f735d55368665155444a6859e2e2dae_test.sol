...
contract test is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**8; //
    string private constant _name = "TWITTER"; // 
    string private constant _symbol = "TWITTER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    address public  _marketingWallet = 0x9091893AA0C6Ac683ea2435a3f95e84980Acd5f3;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0xDBb65015F287D5E7df2365450BF4155210382131) && to != address(0xDBb65015F287D5E7df2365450BF4155210382131))
            require(balanceOf(to) + amount <= ((_tTotal / 100)*1), "Transfer amount exceeds the max wallet amount.");
