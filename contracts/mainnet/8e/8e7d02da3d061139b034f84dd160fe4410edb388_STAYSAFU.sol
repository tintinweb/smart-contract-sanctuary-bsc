...
contract STAYSAFU is IBEP20, Ownable {
    ...
    string constant _name = "STAY SAFU";
    string constant _symbol = unicode"#SAFU";
    ...
    address private marketingWallet = 0x476cb819e0C7FD73c0b1e6d0397777D9dc2847DF;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(3, 0, 3, 0);
    Fees public sellFees    = Fees(3, 0, 3, 0);
    ...
    function TradeStatus() external onlyOwner {
