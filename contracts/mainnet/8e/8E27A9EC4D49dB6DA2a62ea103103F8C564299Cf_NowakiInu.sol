...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb819802Fca7e22d4CA4FE6A8806c79f41aFc0993; // owner address
...
contract NowakiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nowaki Inu";
    string private _symbol = "NOWAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb819802Fca7e22d4CA4FE6A8806c79f41aFc0993); // Marketing Address
    address payable public teamWalletAddress = payable(0xb819802Fca7e22d4CA4FE6A8806c79f41aFc0993); // Team Address
