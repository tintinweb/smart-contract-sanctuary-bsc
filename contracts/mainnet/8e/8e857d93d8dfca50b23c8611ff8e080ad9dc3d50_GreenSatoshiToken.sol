...
/**
   BABY GreenSatoshiToken $BABYGST
   FAIRLMEAUNCH 
   Earn GreenSatoshiToken  every 60 minutes automatically on yours wallet
   BURN 50%
   LP LOCK 3 YEARS 
   */
...
contract GreenSatoshiToken is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _GetBuyBackTimeInterval = 5;
  uint256 public _GetSwapMinutes = 4;
  uint256 public _buyBackDivisor = 7;
  uint256 public _buyTaxFee = 1;
  uint256 public _buyBackTokens = 10;
