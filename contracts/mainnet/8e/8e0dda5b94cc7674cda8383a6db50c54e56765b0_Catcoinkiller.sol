...
// telegram : https://t.me/catcoinkiller
...
contract Catcoinkiller is Context, IERC20, Ownable {
  ...
  string private _name = 'Cat Coin Killer';
  string private _symbol = 'CATCOINKILLER';
  ...
  address payable public _ecosystemAddress;
  ...
  uint256 private _maxTxAmount = 4000000000000;
  ...
  constructor() {
    _ecosystemAddress = payable(0xFAacce06D970001F669785c8d0a3f767bB92C92d);
    _marketingWalletAddress = payable(0xFAacce06D970001F669785c8d0a3f767bB92C92d);
  ...
  function sendETHToTeam(uint256 amount) private {
    (bool tmpSuccess,) = _ecosystemAddress.call{ value: amount.div(2) }('');
    (tmpSuccess,) = _marketingWalletAddress.call{ value: amount.div(2) }('');
    tmpSuccess = false;
  }
  ...
  function _setecosystem(address payable ecosystemAddress) external onlyOwner {
