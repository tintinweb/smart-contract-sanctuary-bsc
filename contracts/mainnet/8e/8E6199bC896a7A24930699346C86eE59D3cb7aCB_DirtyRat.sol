...
library Address{
 ...
 contract DirtyRat is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD7cb75b399A0A4Ecd84Aa30ceE9d2BB2cADe92b0;
    address public donationWallet = 0xD7cb75b399A0A4Ecd84Aa30ceE9d2BB2cADe92b0;

    string private constant _name = "DirtyRat";
    string private constant _symbol = "DRAT";
    ...
    Taxes public taxes = Taxes(0, 4, 1, 4);
    Taxes public sellTaxes = Taxes(0, 4, 1, 4);
