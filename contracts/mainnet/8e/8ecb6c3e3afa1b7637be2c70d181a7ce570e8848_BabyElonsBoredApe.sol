...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EBA = IBEP20(0xC5b692145121caf964Dc604aDB8EFD85c9AB5f34);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = EBA.balanceOf(address(this));
        ...
        uint256 amount = EBA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EBA.transfer(shareholder, amount);
...
contract BabyElonsBoredApe is IBEP20, Auth {
    using SafeMath for uint256;

    address EBA = 0xC5b692145121caf964Dc604aDB8EFD85c9AB5f34;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyElonsBoredApe";
    string constant _symbol = "BabyEBA";
    ...
    uint256 public swapThreshold = _totalSupply * 41834766 / 10000000000; // 0.15% of supply
    bool inSwap;
