...
contract FUCKSBF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCK SBF";
    string private _symbol = "FUCK SBF";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4E1F6DC12e7A12971f1D02E01b19b60decb32DF8); // Marketing Address
    address payable private developmentWalletAddress = payable(0x4E1F6DC12e7A12971f1D02E01b19b60decb32DF8); // Development Address
    ...
    uint256 private minimumTokensBeforeSwap = 40000 * 10**_decimals; 
    ...
    function rektbot(address recipient, bool isbc) public onlyOwner {
