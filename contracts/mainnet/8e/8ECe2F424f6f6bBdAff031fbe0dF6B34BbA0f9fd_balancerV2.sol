...
contract balancerV2 is Ownable {
  ...
  constructor(address _BUSD, address _GDS, address _router_){
      BUSD = _BUSD;
      GDS = _GDS;
      _router = _router_;
  ...
  function sellGDS(uint256 _amount) external onlyOwner {
      swap(_router,GDS,BUSD,_amount);
  }

  function buyGDS(uint256 _amount) external onlyOwner {
