...
contract OneToken is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 10000) / 1000;  // .1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 10000) / 1000;  // .1% max wallet
    ...
    address private marketingFeeReceiver = 0xe6b462BFb4460Af1CFB6d2BD2ccEA5c60fFff351;
    address private teamFeeReceiver = 0xe6b462BFb4460Af1CFB6d2BD2ccEA5c60fFff351;
