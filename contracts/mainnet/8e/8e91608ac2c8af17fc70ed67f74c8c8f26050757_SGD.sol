...
contract SGD is IBEP20, Auth {
    ...
    string constant _name = "SGD";
    string constant _symbol = "SGD";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000 * 10**2 * 10**_decimals;
