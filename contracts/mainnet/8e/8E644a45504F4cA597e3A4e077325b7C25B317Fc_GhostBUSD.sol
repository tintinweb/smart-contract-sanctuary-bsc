...
contract GhostBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ghost BUSD";
    ...
    address public Owner=0xDDD216A680e47A3C55b8AbcA74D62020CA2c373C; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xf1332fDF08a4616F3f5019Dfa8b90f8B3aBfD482;
