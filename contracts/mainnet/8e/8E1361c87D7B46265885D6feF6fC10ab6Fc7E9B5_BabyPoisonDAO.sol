...
contract BabyPoisonDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyPoisonDAO";
    string private _symbol = "BPOISON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFc0c271803260973678387d3fFB43bD917e93f90);
    address payable public teamWalletAddress = payable(0xFc0c271803260973678387d3fFB43bD917e93f90);
