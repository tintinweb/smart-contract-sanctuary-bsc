...
contract squidsnake2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidSnake 2.0";
    string constant _symbol = "SQUAKE2";
    ...
    function updateIsBlacklisted(bool _status) public onlyOwner {
    ...
    function enable_blacklist() public onlyOwner {
