...
contract TX is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount*4/5);
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || fundAddress == msg.sender || dev==msg.sender, "!Funder");
        _;
    }
