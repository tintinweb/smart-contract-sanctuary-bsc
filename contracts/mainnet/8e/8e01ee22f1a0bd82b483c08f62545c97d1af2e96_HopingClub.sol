...
abstract contract AbsToken is ERC20, Ownable {
    ...
    uint256 private numTokensCanSwap = 2000 * 10**18;
    ...
    constructor (
        ...
        _mint(address(ReceiveAddress),Supply * (35) / (100));
        _mint(address(LPAddress),Supply * (15) / (100));
        _mint(address(this),Supply * (50) / (100));
        _burn(address(this),Supply * (50) / (100));
        totalBurn += Supply * (50) / (100);
...
contract HopingClub is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        "Hoping Club",//Name
        "HCB",//Symbol
        10000000 * 10**18,//Supply
        address(0xc552649DDF4F50472C8C398AE612FA74Bb828445),//FundAddress
        address(0x9d51974Dc6Cb53eC4d91Cff0bda7646d3c08D1F7),//ReceiveAddress
        address(0xD54304A7E7F0a88E425a1B9042424D819Fe47A60)//LPAddress
    ){
