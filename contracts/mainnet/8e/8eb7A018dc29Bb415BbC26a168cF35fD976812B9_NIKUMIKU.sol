...
contract NIKUMIKU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeF385fA033939BdB9bb02fEf16451502e0489707); 
    address payable public Wallet_Dev = payable(0x90Aa4F15500c33D236798245E230d4144b357EC3);
    ...
    string private constant _name = "NIKU Miku"; 
    string private constant _symbol = unicode"NIKU"; 
    ...
    constructor () {
        ...
        _owner = 0x90Aa4F15500c33D236798245E230d4144b357EC3;
