...
/*
From the Valentine Floki and Halloween Floki Team!
Welcome to this wonderful journey alongside our wonderful community! 
introduce Christmas Floki (FLOC) to our Holiday themed ecosystem! 
Join the best BSC community, as we celebrate the most anticipated Holiday of the year!! 🔥 Trusted Team 
✅ BUSD Rewards ✅ Daily Raffles ✅ CMC/CG 🔥
...
contract FLOC is FLOCDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private FLOCTeam;
    address private CharityFLOC;
    ...
    string public override name = "Christmas Floki";
    string public override symbol = "FLOC";
    ...
    constructor(uint totalSupplyValue, address FLOCTeamAddress, address CharityFLOCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        FLOCTeam = FLOCTeamAddress;
        CharityFLOC = CharityFLOCAddress;
       
        // split the tokens according to agreed upon percentages
        balances[FLOCTeam] =  totalSupply * 4 / 100;
        balances[CharityFLOC] = totalSupply * 45 / 100;
       
        balances[_owner] = totalSupply * 51 / 100;
    }
    ...
    // Get the address of the token's FLOCTeam pot
