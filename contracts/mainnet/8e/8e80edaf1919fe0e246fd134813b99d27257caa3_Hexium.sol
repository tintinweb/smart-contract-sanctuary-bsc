...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0fC3C852ea21eF14331d470c816F457a5a9ED566; // owner address
...
contract Hexium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hexium";
    string private _symbol = "HEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0fC3C852ea21eF14331d470c816F457a5a9ED566); // Marketing Address
    address payable public teamWalletAddress = payable(0x0fC3C852ea21eF14331d470c816F457a5a9ED566); // Team Address
