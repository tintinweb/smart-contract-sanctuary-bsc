...
contract DogeJacks is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Doge Jacks";
    string private _symbol = "Dojacks";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3570fc3B143280b69f9AcBe26ACf54C1AfADc16b);
    address payable public liqWalletAddress = payable(0x3570fc3B143280b69f9AcBe26ACf54C1AfADc16b);
