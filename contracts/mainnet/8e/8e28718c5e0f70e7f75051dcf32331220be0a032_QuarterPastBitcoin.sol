...
contract QuarterPastBitcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Quarter Past Bitcoin";
    string constant _symbol = "QPBitcoin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 525 * 10**4 * 10**_decimals;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 10000;
    }
