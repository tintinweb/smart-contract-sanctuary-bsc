...
//telegram: https://t.me/kittycandycoin
interface IERC20 {
...
contract KITTYCANDY is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xF65ad0CA3B65Be0B8Ca902766939229332119Ad1;
    address public devAddress = 0x6aA17d7a3228Da53346Eb5f9bDAa8A2F1a42f096;

    string private constant _name = "KITTY CANDY COIN";
    string private constant _symbol = "$KICA";
    ...
    Taxes public taxes = Taxes(2,2,3,1);
    Taxes public sellTaxes = Taxes(2,2,3,1);
