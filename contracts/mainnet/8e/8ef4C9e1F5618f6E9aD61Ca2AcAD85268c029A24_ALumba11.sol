...
contract ALumba11 is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000 * 10**4 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _numOfTokensToExchange = 1000 * 10**4 * 10**9;
    ...
    string private _name = "Alamba Finance";
