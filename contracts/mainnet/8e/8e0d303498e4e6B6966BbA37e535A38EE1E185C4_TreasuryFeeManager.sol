...
contract TreasuryFeeManager is AccessControl {
    ...
    TokenData[] public lpTokenToUnwrap;
     ...
     */
    function addLP(
        TokenData calldata _lpTokenData,
        ...
        emit NewLP(_lpTokenData.tokenAddress, _lpTokenData.slippage, _pathTokenA, _pathTokenB);
    }
    ...
    function replaceLP(
        ...
        emit ReplacedLP(_lpTokenData.tokenAddress, _lpTokenData.slippage, _pathTokenA, _pathTokenB);
    }
    ...
    function unwrapTokens() external onlyRole(MANAGER_ROLE) {
        //gas saving
        TokenData[] memory _lpTokenToUnwrap = lpTokenToUnwrap;
            ...
            if (liquidity > 0) {
                ...
                if (
                    ...
                    swapTokens(
                        ...
                        _lpTokenToUnwrap[current].slippage
                    );
                }
                if (
     ...
     * uint64 slippage - Swap slippage in basis points (10000 - no slippage)
     *
     ...
     */
    function swapTokens(address[] storage path, uint64 slippage) internal {
