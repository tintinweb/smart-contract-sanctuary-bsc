...
contract Meta is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xEB6A1Ebebc373cec9303F85b75E941e474a0aBA5);
    address payable public lpWallet = payable(0xA9Bf90198dD714C637df067f28f05D793a5bfa48);
    ...
    uint256 public _totalTax = _marketingFee.add(_lpFee).add(_burnFee);
    ...
    mapping(address => bool) public _checkMev;
    ...
    constructor () {
        ...
        _totalTax = _marketingFee.add(_lpFee).add(_burnFee);
    ...
    function setTaxes(uint256 newMarketingFee,uint256 newLpFee,uint256 newBurnFee) external onlyOwner{
    ...
    function setCheckMev(address account, bool value) external onlyOwner{
        _checkMev[account] = value;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_checkMev[sender] && !_checkMev[recipient], 'Bot address');
