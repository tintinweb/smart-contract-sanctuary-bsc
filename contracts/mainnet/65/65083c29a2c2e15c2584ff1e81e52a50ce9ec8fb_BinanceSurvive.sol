...
contract BinanceSurvive is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6C914dda6f1312C34f825A5bC5b616095a0efEAd); // Marketing Address
        
    address payable public teamAddress =
        payable(0xA0f767cC9018256487515f64aC6B2736c4C49954); // Team Address
    ...
    string private constant _name = "Binance Survive";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xA0f767cC9018256487515f64aC6B2736c4C49954).call{value: bnbForDev}("");
