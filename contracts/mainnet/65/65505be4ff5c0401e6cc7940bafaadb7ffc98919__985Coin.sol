...
abstract contract AbcToken is ERC20, Ownable {
    ...
    uint256 private numTokensCanSwap = 5000 * 10**18;
...
contract _985Coin is AbcToken {
    constructor() AbcToken(
        ...
        "985 Coin",//Name
        "985",//Symbol
        9850000 * 10**18,//Supply
        address(0xA1221B8516B714779BEdE69341A3Cf81C1f7E14a),//FundAddress
        address(0xe03aeE318CF1073136ef711A90a40f1f875ebe91)//LPAddress
    ){
