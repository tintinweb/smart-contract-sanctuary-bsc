...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC0AfD00E41C3AE61033805fA7F6AbF35dc43DF44; // owner address
...
contract DOGECATE is Context, IERC20, Ownable {
    ...
    string private _name = "DOGECATE";
    string private _symbol = "DOGECATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF9e978Ea5aD678927F0a4Da9A330fFf8d9883aA6); // Marketing Address
    address payable public teamWalletAddress = payable(0xF9e978Ea5aD678927F0a4Da9A330fFf8d9883aA6); // Team Address
