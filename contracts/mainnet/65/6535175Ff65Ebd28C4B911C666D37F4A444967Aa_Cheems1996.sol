...
contract Cheems1996 is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cheems1996";
    string constant _symbol = "$Cheems1996";
    ...
    function takeFee(address sender, address recipient, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 burnbabyburn = amount.mul(2).div(feeDenominator);
    ...
    function ISaidDropIt() external onlyOwner{
        antiSnipe = false;       
    ...
    function setMaxBurn (uint256 _max, bool _dynamicBurn, uint256 _minSol, uint256 _graceBlocks) external onlyOwner {
        maxBurn = _max;
