...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x992E52A2a941D9e6312fe983EADaf45f16e9BA63;
...
contract Degen is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Degeneration Token"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x992E52A2a941D9e6312fe983EADaf45f16e9BA63), BNB_Tot);
            }
