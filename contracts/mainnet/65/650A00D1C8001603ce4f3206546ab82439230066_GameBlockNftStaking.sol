...
// File contracts/GameBlockNftStaking.sol
pragma solidity ^0.8.0;
contract GameBlockNftStaking is Ownable, IERC721Receiver {
    ...
    /// `amount` NFT amount the user has provided.
    ...
    /// @notice Address of the NFT token.
    IERC721 public nftToken;

    /// @notice reward amount allocated per NFT.
   ...
   constructor() {
        reward = IERC20(0x43b687c6F2f2cAAcab5E9604e37Ac662954BAC4c);
        nftToken = IERC721(0x87D39BaA08AAC291683c3D122a042246e6c3c7AA);
        annualReward = 2*(10**18);
        nftType = 1;
        accRewardPerShare = 0;
    ...
    /**
     * @notice Deposit NFTs for reward allocation.
     * @param tokenId id
    ...
    /**
     * @notice Withdraw NFTs and harvest rewards to `to`.
     * @param tokenId id
     * @param to Receiver of the NFTs and rewards.
     */
    ...
    function harvest(address to) public {
        require(block.timestamp >= endTime, "Staking pool is not ended yet!");
    ...
    function getLeftPoolTime() public view returns(uint256){
