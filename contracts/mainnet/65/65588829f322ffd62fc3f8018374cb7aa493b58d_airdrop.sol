...
contract airdrop is Ownable{
    ...
    /* Airdrop */
    function muil_transfer(address[] calldata addresses,address token, uint256 tAmount) external onlyOwner {
    ...
    /* Airdrop */
    function muil_transfer(address[] calldata addresses, uint256 tAmount) external onlyOwner {
        require(addresses.length < 801,"GAS Error: max airdrop limit is 800 addresses");
