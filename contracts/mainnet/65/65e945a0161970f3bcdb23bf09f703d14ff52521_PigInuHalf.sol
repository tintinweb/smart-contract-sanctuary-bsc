...
contract PigInuHalf is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pig Inu 2.0"; // 
    string private constant _symbol = " PIGINUHALF "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xb7bEa3240EdF6131781D21af5F9A0bD0555da883;
