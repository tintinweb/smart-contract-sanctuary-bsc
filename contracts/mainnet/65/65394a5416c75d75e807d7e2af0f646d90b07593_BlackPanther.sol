...
/**
Telegram : https://t.me/BlackPanther_Group
Website  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x361b9f68cdCc99a20eeF82a6c637debe756f66B2; // owner address
...
contract BlackPanther is Context, IERC20, Ownable {
    ...
    string private _symbol = "BPANTHER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2AEEf1bb80f67c98C90EB8C14ac5D811780412F0); // Marketing Address
    address payable public teamWalletAddress = payable(0x2AEEf1bb80f67c98C90EB8C14ac5D811780412F0); // Team Address
