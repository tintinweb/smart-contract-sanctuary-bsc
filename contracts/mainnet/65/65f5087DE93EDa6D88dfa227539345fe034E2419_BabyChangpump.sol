...
/**
Telegram Chat: https://t.me/BabyChangpumpZhaoge_official
✉ BabyChangpumpn Zhaoge
✉ Legit - $BZHAO
*/
...
contract Context {
 ...
 contract BabyChangpump is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "BabyChangpump";
    string private _symbol = "BabyChangpump";
