...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFfEEDd71e8AA03f68C501BBe0508D8CC7f33E149; // owner address
...
contract FlokiToMillion is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Floki To Million";
    string private _symbol = unicode"$FTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFfEEDd71e8AA03f68C501BBe0508D8CC7f33E149); // Marketing Address
    address payable public teamWalletAddress = payable(0xFfEEDd71e8AA03f68C501BBe0508D8CC7f33E149); // Team Address
