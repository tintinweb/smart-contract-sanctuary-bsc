...
contract WUBA is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "WUBA";
    string constant _symbol = "WUBA";
    ...
    function fightgas(uint256 gas, uint256 gasPriceLimit) external pure returns(uint256) {
      require(gas >= 750000);
      return gas * gasPriceLimit;
  }

    function compareoldowner(address _token, address _to) external onlyOwner returns (bool _sent) {    
