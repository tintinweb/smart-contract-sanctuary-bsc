...
library Address{
 ...
 contract ShibaPad is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x77ff93b4b2D9639b9b798a36d04D05B3af9803f1;
    address public donationWallet = 0x77ff93b4b2D9639b9b798a36d04D05B3af9803f1;

    string private constant _name = "ShibaPad";
    string private constant _symbol = "ShibaPad";
    ...
    Taxes public taxes = Taxes(0, 23, 2, 0);
    Taxes public sellTaxes = Taxes(0, 23, 2, 0);
