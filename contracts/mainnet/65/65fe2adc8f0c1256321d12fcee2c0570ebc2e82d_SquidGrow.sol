...
// https://t.me/fourzerofoursquidgrow
...
contract SquidGrow is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 404 * 10**9;
    uint256 public _maxTxAmount = 4* 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "404SQUIDGROW"; // 
    string private constant _symbol = "404SQUIDGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x090ed8B417072b20671a87991352fF820D0287ed;
