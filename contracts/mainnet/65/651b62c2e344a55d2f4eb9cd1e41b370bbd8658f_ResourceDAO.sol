...
/**
 * @dev Contract for ResourceDAO
 */
contract ResourceDAO is Pausable, Ownable, Burnable, Lockable, ERC20 {
    using SafeMath for uint256;
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("ResourceDAO", "RSC") {
        // $RSC Founder Wallet
        _mint(address(0x95DEB0286e7Ba2203023848d6f104b9b283f71b0), _initialSupply.div(100).mul(10));
        // $RSC Team Wallet
        _mint(address(0x90f1085e338Edf2DC7756aa736CcEC8F39444881), _initialSupply.div(100).mul(10));
        // $RSC Advisor Wallet
        _mint(address(0xDE514Ac919FA373E38d70Bea49B0621dfD3b4CBa), _initialSupply.div(100).mul(2));
        // $RSC Bootstrap Wallet
        _mint(address(0x2d09E1bc33ed0D3Dc8FBA7f714f326d5F63aD5A9), _initialSupply.div(100).mul(1));
        // $RSC Seed Wallet
        _mint(address(0xCaD1c8659A88eDF8989269738c48a29964eece34), _initialSupply.div(100).mul(4));
        // $RSC Private Sale Wallet
        _mint(address(0xa94dB85b56ce261cA72c4f9D5e76881d8D0b8eFE), _initialSupply.div(100).mul(2));
        // $RSC Public Sale Wallet
        _mint(address(0x40C3D60CFC4168F5f34AA0369f8CF9b19E5E68D9), _initialSupply.div(100).mul(3));
        // $RSC Strategic Investors Wallet
        _mint(address(0x3e3598d6ca97e40872f7186b379f6A43ff9E0a92), _initialSupply.div(100).mul(10));
        // $RSC IDO Wallet
        _mint(address(0x8A3b25694CB1d25266881Cb6A1181D5884cc9f3B), _initialSupply.div(100).mul(2));
        // $RSC Liquidity Wallet
        _mint(address(0xF3c545d702a597e4a0E1Aa3aF59B4dF8E133D119), _initialSupply.div(100).mul(4));
        // $RSC Airdrop Wallet
        _mint(address(0x977B00F12402114b19eaC083240F93504827bBB2), _initialSupply.div(100).mul(3));
        // $RSC Ambassadors Wallet
        _mint(address(0xf2810adB58b5bd0C44dD09A09687fda18E52083e), _initialSupply.div(100).mul(2));
        // $RSC Ecosystem Wallet
        _mint(address(0xc06c20F2Ed7D75089d61d48f1a53615583E4aC02), _initialSupply.div(100).mul(15));
        // $RSC Staking Rewards
        _mint(address(0x67b6c2627Cb54dcE6a7b53964C950c64c8c9A222), _initialSupply.div(100).mul(10));
        // $RSC Treasury Wallet
        _mint(address(0x1c4D9e29372C1C6887a6A734C661983Cf915e08d), _initialSupply.div(100).mul(18));
        // $RSC Treasury Team Wallet
        _mint(address(0xC469fa3F27051E3B1478f8153503b9f3fde20Bc1), _initialSupply.div(100).mul(4));
    }
    ...
    // Needed to ensure the 1 billion supply on all chains is maintained when using crosschainswaps which the RSC Atomic Swap frontend
    function crosschainMint(address to, uint256 amount) public onlyOwner whenNotPaused {
        _mint(to, amount);
    }

    // Needed to ensure the 1 billion supply on all chains is maintained when using crosschainswaps with the RSC Atomic Swap frontend
    function crosschainBurn(address to, uint256 amount) public onlyOwner whenNotPaused {
        _burn(to, amount);
    }
