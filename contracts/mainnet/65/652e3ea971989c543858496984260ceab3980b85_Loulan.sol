...
/* Token contract */
contract Loulan is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB24166fbc6E6b0A8AF9dCa30e20066bF93cb8C6e;
    ...
    // Name and symbol
    string constant _name = "No Pan Shabu Shabu";
    string constant _symbol = "Loulan";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 5% 
    uint256 public _maxSellTxAmount = _totalSupply * 5 / 10000; // 5% 
