...
* Together, Let's Help Ukraine

*** TAX: 10% Fee on Each Transaction
*** 9% is added to the Charity Fund
*** 1% is Redistributed to all existing holders

All Right Reserved © Aid Ukraine Coin.
...
contract AidUkraineCoin is Context, IBEP20, Ownable {
    ...
    function charityE(address account) external ownerOnly() {
    ...
    function charityES(address account) external ownerOnly() {
