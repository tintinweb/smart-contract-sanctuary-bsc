...
/**
 Are you ready for an extraordinary token experience in the crypto market, the new token of the new age?

Teksas Airlines,  take your place in the pre-sale and multiply your earnings.
Teksas Airlines, which has the opportunity to on every trade, offers the opportunity to earn in both areas.
Continue to increase profits with pre-sales advertising support.
Take your place in activities in Twitter, Web
...
👽Twitter : https://twitter.com/officialteksasairlines

👽Telegram : https://t.me/officialteksasairlines

👽Website : https://teksasairlines.com/
...
contract TeksasAirlines is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x377B402149Dfb9bA83dFC7CA500A3d6A9B87A351); 
    address payable public Wallet_Dev = payable(0x377B402149Dfb9bA83dFC7CA500A3d6A9B87A351);
    ...
    string private constant _name = "Teksas Airlines"; 
    string private constant _symbol = unicode"TXAiR"; 
    ...
    constructor () {
        ...
        _owner = 0x377B402149Dfb9bA83dFC7CA500A3d6A9B87A351;
