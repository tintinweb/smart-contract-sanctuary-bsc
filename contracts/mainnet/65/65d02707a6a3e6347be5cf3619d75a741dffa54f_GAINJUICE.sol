...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xc2098a8938119A52B1F7661893c0153A6CB116d5);
...
contract GAINJUICE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GAINJUICE";
    string constant _symbol = "GJUICE";
    ...
    uint256 public sellMultiplier  = 190;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x470F9b9F7D587b1Fa70010eD692B0287193130cd;
        ecosystemfeeReceiver = 0xbB7dCC05234c71c1f91a0DcD3B96af791dae0405;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 200;
    }
