...
contract BerylliumNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beryllium Network";
    string private _symbol = "BERYLLIUM";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xbD4B3280B275823e6Ff345c9c606d9CcA37338D9);
