...
contract HongKong is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x7BaF08F1F7D44bDD0B5346205C270163d3178eCf);
    address payable private _marketingAddress = payable(0x7BaF08F1F7D44bDD0B5346205C270163d3178eCf);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 81, "Redis cannot be more than 81.");
	    require(redisFeeOnSell < 81, "Redis cannot be more than 81.");
	    require(taxFeeOnBuy < 81, "Tax cannot be more than 81.");
	    require(taxFeeOnSell < 81, "Tax cannot be more than 81.");
