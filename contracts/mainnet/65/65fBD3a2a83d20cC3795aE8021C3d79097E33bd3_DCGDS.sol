...
library Address{
 ...
 contract DCGDS is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 150000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 400 * 10**9;
    uint256 public maxBuyLimit = 400 * 10**9;
    uint256 public maxSellLimit = 400 * 10**9;
    uint256 public maxWalletLimit = 400 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xc1aE649DA4F69c6B6e2F1Cc5Ef7615662f1451b1;
    address public developmentWallet = 0xc1aE649DA4F69c6B6e2F1Cc5Ef7615662f1451b1;

    string private constant _name = "DCGDS";
    string private constant _symbol = "DCGDS";
