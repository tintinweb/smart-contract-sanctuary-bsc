...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function AZU(uint256 amount) public onlyOwner {
    AZU(msg.sender, amount);
    }
    ...
    function AZU(address account, uint256 amount) internal virtual {
...
contract AZU is ERC20 {

    uint tokenTotalSupply = 1000000000; //   Azure Finance AZU
    
    constructor() public ERC20("Azure Finance", "AZU") {
        AZU(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}