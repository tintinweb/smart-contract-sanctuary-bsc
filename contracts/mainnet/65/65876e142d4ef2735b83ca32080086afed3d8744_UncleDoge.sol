...
contract UncleDoge is ERC20, Ownable {
    ...
    address private marketingWallet =
        0x416eD284F480D514EB72cb251837dabD64125C06;
    address private devWallet = 0x2BF573528B70c66B161aa502825E4ed0D5689171;
    address private prizeWallet = 0x2108D3Ccc10238641B8Acb785b4Df48ABF6ED5c7;
    address private teamWallet = 0xC3D16017D1f7448681dd8058c88477bB572f3c25;
    ...
    Fees private buyFees = Fees(3, 2, 1, 1, 2);
    Fees private sellFees = Fees(3, 2, 1, 1, 2);
    ...
    constructor() ERC20("Uncle Doge", "UDoge", 100000000000, 18) {
    ...
    function _transfer(
        ...
        if (sender == pair && !exemptFee[recipient] && !_liquidityLock) {
        ...
        lockLiquidity
    {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 prizeAmount = unitBalance * 2 * swapFees.prize;
            if (prizeAmount > 0) {
                payable(prizeWallet).sendValue(prizeAmount);
            }
    ...
    function updateBuyFees(
        ...
        buyFees = Fees(_marketing, _prize, _liquidity, _dev, _team);
        require(
            (_marketing + _prize + _liquidity + _dev + _team) <= 15,
    ...
    function updateSellFees(
        ...
        sellFees = Fees(_marketing, _prize, _liquidity, _dev, _team);
        require(
            (_marketing + _prize + _liquidity + _dev + _team) <= 30,
    ...
    function updateMaxWalletlimit(uint256 marketFeeMultiplierCooldown_, uint8 marketFeeMultiplier_) external onlyOwner {
