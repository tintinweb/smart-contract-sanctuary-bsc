...
🟢AstroRun is the hot trend in crypto space powered by endless possibilities to 
generate money and joy. Now AstroRun Has arrived on the BSC and is ready to claim his throne 
...
contract AstroRun is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AstroRun";
    string constant _symbol = "AstroRun";
