...
contract WORLDCUPBET is ERC20, Ownable {
    ...
    uint256 private _totalFeesOnSell = 2;

    address public marketingWallet = 0x5eF55fA3269d015D47363803B2eB756003C727F9;
    ...
    constructor(address newOwner) ERC20("WORLDCUPBET", "WCB") {
        ...
        _mint(owner(), 2_100_000_000 * (10**18));
