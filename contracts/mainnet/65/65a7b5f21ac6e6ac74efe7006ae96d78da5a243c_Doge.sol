...
contract Doge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa312B55e6d6Ce063ce2974492ED234b3f034d9DA));
        marketingWalletAddress = payable(address(0xa312B55e6d6Ce063ce2974492ED234b3f034d9DA));
