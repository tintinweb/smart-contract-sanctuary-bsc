...
contract SENDA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SENDA";
    string private constant _symbol = "SENDA TOKEN";
    ...
    uint256 public launch = 10 minutes;
