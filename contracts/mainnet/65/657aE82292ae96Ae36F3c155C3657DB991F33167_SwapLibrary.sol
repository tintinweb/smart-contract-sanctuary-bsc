...
contract SwapLibrary {
  ...
  function getTradeDiffSimple(uint amountIn, address tokenIn, address pair) external view returns (uint a, uint b) {
    (uint dec0, uint dec1, uint r0, uint r1, bool st, address t0,) = IPair(pair).metadata();
    a = _getAmountOut(100_000, tokenIn, r0, r1, t0, dec0, dec1, st) * 1e18 / 100_000;
    b = _getAmountOut(amountIn, tokenIn, r0, r1, t0, dec0, dec1, st) * 1e18 / amountIn;
  }
