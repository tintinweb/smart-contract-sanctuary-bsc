...
contract SVETeamAdvisorClaim is Ownable, ReentrancyGuard {
    ...
    address public TEAM_ADVISOR_ADDRESS =
    ...
    function updateWallet(address _TEAM_ADVISOR_ADDRESS) external onlyOwner {
        require(_TEAM_ADVISOR_ADDRESS != address(0), "Error: address(0)");
