...
// Telegram : https://t.me/BabyShibaSoccer
...
contract BabyShibaSoccer is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9AB92163280a73476f5eb2a4a6F44F21a166ee6A); 
    address payable public Wallet_Utility = payable(0xb0a9a711eB9Eb52c117c73eB3E7ee1efd9533f23);
    ...
    uint256 private _tTotal = 50* 10**6 * 10**_decimals;
    string private constant _name = "Baby Shiba Soccer"; 
    string private constant _symbol = unicode"BABY SHIBA SOCCER"; 
    ...
    constructor () {
        ...
        _owner = 0xb0a9a711eB9Eb52c117c73eB3E7ee1efd9533f23;
