...
contract Shenziinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF87342777fa5bCaCc50344eAB760477931838C59); 
    address payable public Wallet_Dev = payable(0xF87342777fa5bCaCc50344eAB760477931838C59);
    address payable public constant Wallet_Burn = payable(0xF87342777fa5bCaCc50344eAB760477931838C59); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Shenzi INU"; 
    string private constant _symbol = unicode"Shenzi"; 
    ...
    constructor () {
        ...
        _owner = 0xF87342777fa5bCaCc50344eAB760477931838C59;
