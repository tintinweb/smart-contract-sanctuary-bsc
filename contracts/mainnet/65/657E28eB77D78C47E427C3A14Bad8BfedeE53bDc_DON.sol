...
contract DON is VRFV2WrapperConsumerBase {
    ...
    function PlayDoubleOrNothing() public pure {
        //Hello!
        //This is a function used to get your attention
        //Come and play our game: Double Or Nothing
        //https://doubleornothing.gg
        //https://t.me/dblnth     
        revert("Play double or nothing @ https://doubleornothing.gg");
    }

    function updateCosts(uint256 _maximumStakePercentage, uint256 _gameFee,  uint256 _minimumBNBstake, uint256 _minimumUSDstake, uint256 _bnbVRFcost, uint256 _usdVRFcost) public onlyWhitelist {
    ...
    function checkCosts() public view returns (uint256,uint256,uint256,uint256,uint256,uint256) {
        return (maximumStakePercentage,gameFee,minimumBNBstake,minimumUSDstake,bnbVRFcost,usdVRFcost);
    }
...
//GAME LOGIC
    function DoubleOrNothing(uint256 _amount, address _token) public payable {
        ...
        if (msg.value > 0) {
            ...
            require(_token == USDT || _token == BUSD, "Stable not supported");
            ...
            _stake = ((_amount / 100) * (100-gameFee)) - usdVRFcost;
