...
contract jeetson is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jeetsons Inu";
    string private _symbol = "Jeetson";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xCFC090DdA4493B47a637c3750B6A059a3dcfaB72); 
    ...
    uint256 private _totalSupply = 62 *  10**7 * 10**_decimals;
