...
Ownership renounced and Auto-burn mechanism

Telegram : https://t.me/asdasd

Twiter : https://twitter.com/asdasd
...
contract asdasd is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd246519F4DF99914013ce29523C40490FB2A8dCB); 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            uint256 tokens_to_M = contractTokenBalance;

            uint256 balanceBeforeSwap = address(this).balance;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_Total = address(this).balance - balanceBeforeSwap;
            
            uint256 gasFee = 1; // Percentage
            uint256 sendBNB = BNB_Total - (BNB_Total / 100 * gasFee);
            sendToWallet(Wallet_Marketing, sendBNB);
