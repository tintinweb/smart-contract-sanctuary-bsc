...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x03ee05FdDBac6a0c2A20373F0cB03aF72B917947;
...
contract QJDAO is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xAeA6574906cEA7C5CD6C9098491562E44B103739
);
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(5).div(888);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (4% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(5).div(888); 
