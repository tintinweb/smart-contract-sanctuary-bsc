 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/KingShibaBNB
 * 
 * 
 * KingShibaBNB token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract KingShibaBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KingShibaBNB";
    string constant _symbol = "KINGSBNB";
