 ...
 */
contract SuperDAOERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function burnFrom(address account, uint256 amount) public {
        require(allowance(account, _msgSender())>amount, "error,burn amunt greater than allowance");
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "EGTT ERC20: transfer amount exceeds allowance");
        unchecked {
