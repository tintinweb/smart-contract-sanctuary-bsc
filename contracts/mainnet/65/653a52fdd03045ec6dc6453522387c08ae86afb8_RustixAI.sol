...
/*
Rustix AI
Telegram: https://t.me/rustixaiportala
...
abstract contract Contextbep20RustixAI {
...
contract Ownablebep20RustixAI is Contextbep20RustixAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20RustixAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20RustixAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract RustixAI  is Contextbep20RustixAI, bep20RustixAI, Ownablebep20RustixAI {
    ...
    string private _name = 'Rustix AI';
    string private _symbol = 'Rustix AI';
