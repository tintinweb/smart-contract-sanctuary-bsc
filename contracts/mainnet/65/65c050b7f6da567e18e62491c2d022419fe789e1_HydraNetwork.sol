...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC058f79D0807872FD40217D9A15094735Cf46bCC; // owner address
...
contract HydraNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hydra Network";
    string private _symbol = "HyNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC058f79D0807872FD40217D9A15094735Cf46bCC); // Marketing Address
    address payable public teamWalletAddress = payable(0xC058f79D0807872FD40217D9A15094735Cf46bCC); // Team Address
