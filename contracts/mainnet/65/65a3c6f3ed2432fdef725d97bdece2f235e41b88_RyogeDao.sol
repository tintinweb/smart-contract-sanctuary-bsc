...
contract RyogeDao is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Ryoge Dao';
    string private constant _symbol = '$Ryoge';
	...
	uint256 private autoBanTime = 3; 
	uint256 private enableAutoBlacklist = 1; 
    uint256 private gasLimit = 7100000000;
    ...
    //DevWallets
    address public Development=payable(0x28699Fdf528AEE0c4641087fDD79301857049655);
    address public Marketing=payable(0x524f0452e7908F362F3be0CCF13bcbc6338f6eD2);
    //MainNet
    ...
    uint256 currentAmountToSwap = 4000000000000 * 10**_decimals;
