...
// File: contracts/Pandabobainu.sol
...
contract Pandabobainu is Context, IERC20, Ownable {
    ...
    payable(0x25db5C453107A956b5348c179418c5A8147E9a5A);
    ...
    uint256 private constant _tTotal = 4 * 1e9 * 1e18;
    ...
    string private constant _name = "Panda Boba Inu";

    string private constant _symbol = "PBI";
