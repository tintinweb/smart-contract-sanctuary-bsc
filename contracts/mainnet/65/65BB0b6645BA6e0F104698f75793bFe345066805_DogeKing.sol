...
contract DogeKing is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x32f7BA9E886855CdD58143b7547DFB52a738026F); 
    address payable private teamWalletAddress = payable(0x75B5151942a5deF49eDFb9127A0a2Ce841A6108f); 
    ...
    uint256 private _totalSupply = 1* 10**13 * 10**_decimals;
