...
/* 
___________ __>_( ɕѼ Ҩ .
[email protected]♥ '(█) ♥ *$
________Ѽ "( ()♥t (Ѽ)o*♥*
_______(█),-♥.-Ѽ [email protected],0 ɕ(█)
____________>o*oѼ @.<
_________o`-.♥[email protected]""-Q '♥[email protected]'
______♥.'`Ѽ ♥ *Ѽ ɕҨ ‘♥ @`-.)
____Ѽ o (█). @* '[email protected]Ѽ ’Q.*(█)’Ѽ
__________Ѽ -♥-'Ѽ ♥._ Ѽ
[email protected]♥ '*Q ♥ *(█), @.♥ '*
___.♥' @ _ ɕ♥ _.-'~♥-. @ Ž(♥)`-*.o
__.(█)* ♥ ..-' (Ѽ) o *.(Ѽ) 0 *(█)`)
...
contract CG is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "ChristmasGifts";
	...
	uint256 public prizewalletfee = 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0F954758B58C2D6a811efDEb88335B3eeA7BA1c7; 
        devWallet = 0xFcAD1d6244548A547e2eb3b1Bbf7aC74946eb020; 
		prizewallet = 0xd6731C81Dc4C93b28aa8bE9c3AD98a10225B0230; 
