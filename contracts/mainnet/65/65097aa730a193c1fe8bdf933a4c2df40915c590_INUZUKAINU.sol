...
contract INUZUKAINU is IBEP20, Auth {
    ...
    string constant _name = "INUZUKA INU 2.0";
    string constant _symbol = "$INKU";
    ...
    address public marketingFeeReceiver = 0x05653e5248eFdCf361a5bA9a7e488f062596bF2D;
