...
contract TwinFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twin Floki";
    string private _symbol = "TFLK";
    uint8 private _decimals = 18;

    address public marketingWallet = 0x88e03f9d4AeB3000942b55a906a264eebC636004;
    address public developmentWallet = 0x331B46D2fA0194Df1CAFF3A65425543ba1f0830C;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if((block.timestamp > launchTime + 15 minutes) && !triggered && (launchTime != 0) ){
            _maxTxAmount =  _totalSupply.mul(20).div(denominator);     //1%
