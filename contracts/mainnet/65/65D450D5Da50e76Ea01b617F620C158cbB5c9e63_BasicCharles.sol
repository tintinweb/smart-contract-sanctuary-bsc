...
/**
Basic Charles (RIP QUEN)
https://t.me/BasicCharles

Nano cap launching at 50$.
2% max buy/sell.
4% max wallet.
...
contract BasicCharles is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xDD45706664F1EFf3603790EE62a6e2C4Db9687fe);
    address payable public Wallet_Dev =
        payable(0x9568e54074C74e14Bd47cc36C66f81789EBA0522);
    ...
    string private constant _name = "Basic Charles";
    string private constant _symbol = unicode"BCHARLES";
    ...
    constructor() {
        _owner = 0x9568e54074C74e14Bd47cc36C66f81789EBA0522;
