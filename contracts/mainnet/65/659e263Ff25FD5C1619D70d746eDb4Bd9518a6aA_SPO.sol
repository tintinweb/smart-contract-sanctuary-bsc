...
contract SPO is ERC20 {
    ...
    //测试函数
    function getLpNumber(address addr) internal view returns (uint256){
    ...
    function getTotalPair() internal view returns (uint256){
    ...
    function getExcludeTotalPair() internal view returns (uint256){
