...
import '@openzeppelin/contracts/math/SafeMath.sol';
import '../interfaces/IBINERC20.sol';

contract BINERC20 is IBINERC20 {
    using SafeMath for uint256;

    string public override constant name = 'BIN-USD LPs';
    string public override constant symbol = 'BIN-LP';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external override {
        require(deadline >= block.timestamp, 'EME: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'EME: INVALID_SIGNATURE');
