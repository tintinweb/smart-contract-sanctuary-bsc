...
contract PeacePutin is IBEP20, Auth {
    ...
    string  _name = "PeacePutin";
    string  _symbol = "PEACEPUTIN";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // cooldown timer, so a bot doesnt do quick trades! 0min gap between 2 trades.
        if (sender == pair &&
            buyCooldownEnabled &&
