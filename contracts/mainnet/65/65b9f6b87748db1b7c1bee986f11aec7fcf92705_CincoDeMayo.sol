...
BUSD Reflection Taxes: 17% buy, 19% sell

Total supply: 100,000,000

Must hold 100,000 token to receive BUSD

Telegram: https://t.me/CincoDeMay0
...
contract CincoDeMayoDividendTracker is IDividendDistributor {
    ...
    uint256 public minDistribution = 1000000000 * (10 ** 9); // 1 BUSD minimum auto send  
    uint256 public minimumTokenBalanceForDividends = 100000; // Must hold 100,000 token to receive BUSD
...
contract CincoDeMayo is Ownable, IBEP20, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "CincoDeMayo";
    string _symbol = "Party";
    ...
    address public marketing = address(0x474D7090d462fbbC76647E009C416C0F2706b141);
    address public liquidity = address(0xF3023a735bbd2E99059217198a916c4B51CC44e6);

    IDEXRouter public router;
    address pair;

    CincoDeMayoDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new CincoDeMayoDividendTracker();
