...
contract VerifySignature is OwnableUpgradeable {
    ...
    function getMessageHash3(address owner, address contract_addr, address to, uint256[] memory tokenIds, uint256 genes, uint _nonce) public pure returns (bytes32)
    {
    ...
    function verify3(address to, uint256[] memory tokenIds, uint256 genes, uint _nonce, bytes memory signature) public view returns (bool)
    {
