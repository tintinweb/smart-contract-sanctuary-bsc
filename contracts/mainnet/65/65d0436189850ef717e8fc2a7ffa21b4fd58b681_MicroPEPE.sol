...
/**
Telegram group: https://t.me/degendinasty
In the Dinasty, you can enjoy endless investment opportunities almost daily in a safe environment to increase your odds to generate consistent gains. 

Fast paced action. No roadmaps, no utility, no NFT collections. Just pure degens.

Disclaimer:
1. You fully understand the risks of fast-paced gamble plays in the dinasty.
2. It’s recommended you split up your buys across multiple plays
3. You understand if you lose money on a degen play, you can try again in the future plays.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x009cE9F1633C35Ec382022Da3A77ef38A9108aA5; // owner address
...
contract MicroPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "Micro Pepe";
    string private _symbol = "MEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x009cE9F1633C35Ec382022Da3A77ef38A9108aA5); // Marketing Address
    address payable public teamWalletAddress = payable(0x009cE9F1633C35Ec382022Da3A77ef38A9108aA5); // Team Address
    ...
    uint256 public _maxTxAmount = 1200 * 10**_decimals; 
    uint256 public _walletMax = 1200 * 10**_decimals;
