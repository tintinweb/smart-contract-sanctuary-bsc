...
contract AlveyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvey Doge";
    string private _symbol = "ALVEYDOGE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x26E22ea23798E1ad1a7890e2509A4E40dEeab1DB);
