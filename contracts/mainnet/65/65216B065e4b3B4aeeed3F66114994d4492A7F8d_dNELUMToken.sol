...
contract dNELUMToken is BEP20Detailed, BEP20, dNELUMTokenInterface {

  address public vicdaoMainContract;

  event changevicdaoMainContract(address _vicdaoMainContract);
 
  constructor() payable BEP20Detailed("VICDAO dNELUM", "dNELUM", 18) {
   // _mint(msg.sender, totalSupply);
  }

  function onUserStake(address receiver, uint256 amount) external virtual override { 
     require(msg.sender == vicdaoMainContract,"Only VicDao Main contract can call this function");
    _mint(receiver, amount);
  }

  function onUserUnStake(address receiver, uint256 amount) external virtual override{
     require(msg.sender == vicdaoMainContract,"Only VicDao Main contract can call this function");
  ...
  function setVicdaoMainContract(address _vicdaoMainContract) external onlyOwner {
    ...
    emit changevicdaoMainContract(_vicdaoMainContract);
  }  
