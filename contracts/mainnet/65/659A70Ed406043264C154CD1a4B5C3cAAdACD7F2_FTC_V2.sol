...
contract FTC_V2 is IERC20 {
    ...
    //默认上级
    address public  _defaultParent=address(0x608CF2283D7Cb996f97e8DDDc4A434BDfCECad3a);
    //默认_defaultParent的上级
    address public _defaultInvite=address(0x966DaeD126d21bd8e9F3A0877B9a16FFf4d89AF2);
    ...
    constructor(bool prod) {
        ...
        _owner = msg.sender;
        //初始化默认上级的上级
        inviter[_defaultParent]=_defaultInvite;
