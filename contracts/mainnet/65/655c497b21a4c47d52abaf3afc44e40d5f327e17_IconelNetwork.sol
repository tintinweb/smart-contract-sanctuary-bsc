...
/*
  Iconel network is a Decentralized Listen-to-earn platform under development for the Binance Blockchain.
   Offers users a familiar and seamless experience, similar to popular music streaming apps like Spotify!

   Telegram : https://t.me/Inconelnetwork
   Medium   : https://medium.com/@inconelnetwork
   twitter  : https://twitter.com/InconelNetwork
*/
...
contract IconelNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Iconel Network";
    string private _symbol = "ICON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x44bb9D6EE3987989Dff8f5AfeAc0329f73ea9Fbd);
