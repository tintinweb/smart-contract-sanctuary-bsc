...
interface KunstlicheIntelligenzDeployer {
...
contract KunstlicheIntelligenz is KunstlicheIntelligenzDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private KunstlicheIntelligenzTeam;
    address private CharityKunstlicheIntelligenz;
    ...
    string public override name = unicode"Künstliche Intelligenz";
    string public override symbol = unicode"Künstliche Intelligenz";
    ...
    constructor(uint totalSupplyValue, address KunstlicheIntelligenzTeamAddress, address CharityKunstlicheIntelligenzAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        KunstlicheIntelligenzTeam = KunstlicheIntelligenzTeamAddress;
        CharityKunstlicheIntelligenz = CharityKunstlicheIntelligenzAddress;
        
        // split the tokens according to agreed upon percentages
        balances[KunstlicheIntelligenzTeam] =  totalSupply * 4 / 100;
        balances[CharityKunstlicheIntelligenz] = totalSupply * 4 / 100;
