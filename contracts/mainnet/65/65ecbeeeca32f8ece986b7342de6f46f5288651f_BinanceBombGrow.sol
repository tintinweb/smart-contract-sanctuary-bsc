...
contract BinanceBombGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binance Bomb Grow";
    string private _symbol = "BNBGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4260123d957969c245F1aB242536D65bF572A56E); // Marketing
    address payable public BuyBackWalletAddress = payable(0x82f98c4Ede01e10da4ccF4a974C876F1C2ea7FA9); // BuyBack 
