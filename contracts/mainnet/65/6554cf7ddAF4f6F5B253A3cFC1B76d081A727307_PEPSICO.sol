...
contract PEPSICO is Context, IERC20, Ownable {
    ...
    address public _MkWalletAddress;        
    address public _ChaWalletAddress;       
    address public _liqWalletAddress;         
    address public _ExWalletAddress;        
    ...
    function Mk_Wallet_Address(address _addr) public onlyOwner {
        _MkWalletAddress = _addr;
    }

    function Cha_Wllet_Address(address _addr) public onlyOwner {
