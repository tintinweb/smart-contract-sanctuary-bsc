...
library SafeMath {
  ...
  */
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    // assert(b > 0); // Solidity automatically throws when dividing by $1
    // uint256 c = a / b;
...
contract BEP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "Binance-Peg BTC Token";
    string public symbol = "BTCB";
    uint8 public decimals = 18;

    constructor() public {
        totalSupply_ = 589500000000000000 * (10 ** uint256(decimals));
    }
