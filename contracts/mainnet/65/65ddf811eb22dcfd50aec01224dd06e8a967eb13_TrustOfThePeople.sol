...
*/
/**
Trust of The People - $TOTP / Based on an Elon tweet

Telegram : https://t.me/TrustOfThePeople
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe23c98Ddf8CaaB088c64212a8DF4cF7c03128998; // owner address
...
contract TrustOfThePeople is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrustOfThePeople";
    string private _symbol = "$TOTP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe23c98Ddf8CaaB088c64212a8DF4cF7c03128998); // Marketing Address
    address payable public teamWalletAddress = payable(0xe23c98Ddf8CaaB088c64212a8DF4cF7c03128998); // Team Address
