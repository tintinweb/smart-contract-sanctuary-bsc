...
/*
Telegram: https://t.me/BERLINROKX
*/
...
contract BERLINROKX is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 45_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "BERLIN ROKX"; //
    string private constant _symbol = "BROKX"; //
