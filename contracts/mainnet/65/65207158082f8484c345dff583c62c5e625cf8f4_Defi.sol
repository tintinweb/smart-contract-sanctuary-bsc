...
contract Defi is Ownable {
    ...
    address public startAdd = 0xdb94Be9E0Ea60B82fa2835874B9A902CaA6404F1;
    ...
    function staking(uint256 amountIp) public returns (bool) {
        ...
        if (amounts < 10000 * 10**18) {
            types = 0;
            pt = 6;
        } else if (amounts >= 10000 * 10**18 && amounts < 50000 * 10**18) {
            types = 1;
            pt = 8;
        } else if (amounts >= 50000 * 10**18 && amounts < 200000 * 10**18) {
            types = 2;
            pt = 10;
        } else if (amounts >= 200000 * 10**18 && amounts < 500000 * 10**18) {
            types = 3;
            pt = 13;
        } else if (amounts >= 500000 * 10**18 && amounts < 1500000 * 10**18) {
            types = 4;
            pt = 16;
        } else if (amounts >= 1500000 * 10**18 && amounts < 3000000 * 10**18) {
            pt = 19;
            types = 5;
        } else if (amounts >= 3000000 * 10**18 && amounts < 6000000 * 10**18) {
            types = 6;
            pt = 22;
        }else if (amounts >= 6000000 * 10**18 && amounts < 10000000 * 10**18) {
            types = 6;
            pt = 25;
        } else {
            types = 7;
    ...
    function withdraw() public returns (bool) {
        ...
        address ref3 = addCmmBrand((reciAm * 10) / 100, ref2);
        address ref4 = addCmmBrand((reciAm * 10) / 100, ref3);
        address ref5 = addCmmBrand((reciAm * 5) / 100, ref4);
        address ref6 = addCmmBrand((reciAm * 5) / 100, ref5);
        address ref7 = addCmmBrand((reciAm * 5) / 100, ref6);
        address ref8 = addCmmBrand((reciAm * 5) / 100, ref7);
        address ref9 = addCmmBrand((reciAm * 5) / 100, ref8);
        addCmmBrand((reciAm * 5) / 100, ref9);
        return true;
    }
        ...
        if (block.timestamp - _stake[msg.sender].timestamp > 15552000) {
            ...
            _joinToken.safeTransfer(
                ...
                _stake[msg.sender].amount -
                    ((_stake[msg.sender].amount * 30) / 100)
            );
        }
