...
contract HIROSHI is Context, IERC20 { 
    ...
    string private constant _name = "Hiroshi Grow"; 
    string private constant _symbol = unicode"HSGROW"; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 sfeeAmount;
            if (_isExcluded[sender]){sfeeAmount = tAmount*_Tax_On_Sell/feeDenominator;}
