...
contract KDOGB is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xeeF4De43E6263a2A9fE6FCbb94B81B66DAC3906f); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x21fD4D880F2A38F1B6EcB14956Bf7b2B924B5634); // Marketing Wallet Address
    address payable public stakingWalletAddress = payable(0x491DEf373DE67F4be58eB3a6aB311816CFB76cED); // staking Wallet Address
    address payable public devWalletAddress = payable(0x7943cbD099807ab7776C67A0d5650B5Cbe39A4a8); // dev Wallet Address
