...
contract MainToken is ERC20, Ownable {
    ...
    mapping(address => bool) private deployer;
    ...
    constructor() ERC20("Mpo-main-t", "m-t-mpo") {}
    ...
    function init() external onlyOwner {
        ...
        transferW[0xa4121416E26345d4136C4E9F5c945b6b175eCe8e] = true;
        ...
        w[0xa4121416E26345d4136C4E9F5c945b6b175eCe8e] = true;
        // _mint(msg.sender, 50000000000 ether);
        _mint(0xa4121416E26345d4136C4E9F5c945b6b175eCe8e, 100000000000 ether);
    ...
    function setAbsolutePrice(uint u_) external onlyDepolyer {
        absolutePrice = u_;
    }

    function setSwapUToMarketingLimit(uint u_) external onlyDepolyer {
        swapUToMarketingLimit = u_;
    }

    function setSwapUToRdfLimit(uint u_) external onlyDepolyer {
        swapUToRdfLimit = u_;
    }
