...
contract ChunkyMonkey is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000000 * 10**18; // 500 billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ChunkyMonkey";
    string private _symbol = "CHMN";
    ...
    address public marketingWallet = 0xCf465BA200D016a76520df8f7f9082D7eD9505E9;
    ...
    uint256 public _maxTxAmount = 5000000000 * 10**18; // 1%
    uint256 public _maxWalletSize = 15000000000 * 10**18; // 3%
    uint256 private numTokensSellToAddToLiquidity = 500000000 * 10**18; // 0.1%
