...
Telegram : https://twitter.com/AptosLabs
...
contract NewCommunityAptos is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77D538616eF95637EE6537B8C25A08d8A1BC3f00); 
    address payable public Wallet_Utility = payable(0x27Df0FA5A29D393f527B333fd81a7af7adebE8cf);
    ...
    string private constant _symbol = unicode"NAPTC"; 
    ...
    constructor () {
        ...
        _owner = 0x27Df0FA5A29D393f527B333fd81a7af7adebE8cf;
