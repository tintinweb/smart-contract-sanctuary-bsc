...
contract Uniqo is IERC20, Initializable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
  ...
  // INFO: UNIQO V1 storage ends here. Add new state variables below. Don't modify orders of old variables to avoid storage collision.
  /**
   * @notice The mapping of black listed LP contracts that will prohibit swapping of the UNIQO token.
  ...
  // INFO: UNIQO v1.1 storage ends here. Add new state variables below. Don't modify orders of old variables to avoid storage collision.
   ...
   * @param denominator The new value of the equation coefficient denominator.
   */
  function setDailyTakeProfitCoefficients(uint256 _coefficientA, uint256 denominator) external onlyOwner {
   ...
   */
  function _shouldApplyTransferFee(
    address sender,
    uint256 gonAmount,
    address recipient
