...
//Contract
contract Burntest is IBEP20, Ownable {
    ...
    string private constant _symbol = 'Testburn';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 10000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=50; //1% = 1,000,000
    uint16 private constant SellLimitDivider=50; //1% = 1,000,000
