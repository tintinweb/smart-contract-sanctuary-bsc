...
contract PawnMe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PAWN ME";
    string private _symbol = "PME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbD79292DFD8FDEa830551a05CE20862B20eD9143); // Marketing Address
    address payable public teamWalletAddress = payable(0x133Bd63E7289dF31Af054d6783280ec9970F97c0); // Team Address
