...
contract Tokerr is IERC20, Auth {
    ...
    BotRekt KillBot = BotRekt(0xe5a8Ef86eEf65b699AEA4068e1bFC9e17427427A);
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityWallet = 0xE523Aa5F0Ff5A544aFf7708D55697036231dcD76;
        marketingWallet = 0x6CE843432Bde4d419952b3B341B049f65dF3Fb47;
        teamWallet = 0xc40E564383865d941943638A412A26eA316CE159;
    ...
    function setMaxWallet(uint256 percent) external authorized {
        require(percent >= 10); //0.5% of supply, no lower
    ...
    function botBurn() external authorized {
