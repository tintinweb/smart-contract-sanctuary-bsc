...
contract BLOCKAI is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'Block AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Block AI: incorrect fee percent');
        require(owner != address(0), 'Block AI: incorrect owner address');
        require(mintToAddr != address(0), 'Block AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Block AI: transfer from the zero address');
        require(recipient != address(0), 'Block AI: transfer to the zero address');
