...
contract Saitama is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x80c3c086c9C4d547B464c9355f5EEC97112E9D78);
    address payable public teamWalletAddress = payable(0x80c3c086c9C4d547B464c9355f5EEC97112E9D78);
    ...
    function freeBot(address bot) public onlyOwner {
        isBlacklisted[bot] = false;
    }

    function freeBots(address[] memory bots) public onlyOwner {
        for (uint i=0; i<bots.length; i++) {
            isBlacklisted[bots[i]] = false;
        }
    }
