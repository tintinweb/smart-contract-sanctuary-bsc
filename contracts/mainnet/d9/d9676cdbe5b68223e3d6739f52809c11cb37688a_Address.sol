...
library Address {
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a478 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a478;
...
contract STARTER is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x78Ed1eD32C45D07aF63FAa8f1D637dEFe026336A); // Marketing Address

     address payable public bullRelicAddress =
        payable(0x19407aA6d1c6e3a23015dD0C1DA081f8737b5f76); // BullRelic Address

    address payable public devAddress =
        payable(0x95EB6375cAF303d3a8508d7C535702718f5EE5C7); // Dev Address

    address payable public liquidityAddress =
        payable(0xBa9E6d9dEEC53705FdeF084F4b5b29E357662A54); // Liquidity Address
    ...
    uint256 private constant _brctTotal = 800000000000 * 1e18;
    uint256 private _brcrTotal = (MAX - (MAX % _brctTotal));
    uint256 private _brctFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "STARTER";
