...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb08025db6232c3a3a738666221BC51B615A5A378; // owner address
...
contract KirishakiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Kirishaki Inu";
    string private _symbol = unicode"KIRINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb08025db6232c3a3a738666221BC51B615A5A378); // Marketing Address
    address payable public teamWalletAddress = payable(0xb08025db6232c3a3a738666221BC51B615A5A378); // Team Address
