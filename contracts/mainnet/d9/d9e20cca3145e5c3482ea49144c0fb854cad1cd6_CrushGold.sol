...
contract CrushGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crush Gold";
    string private _symbol = "CrushGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4DE626Fc4aDB8660DcF47BbeCCd156Aea5adff0A);
    address payable public BuyBackWalletAddress = payable(0x4DE626Fc4aDB8660DcF47BbeCCd156Aea5adff0A);
