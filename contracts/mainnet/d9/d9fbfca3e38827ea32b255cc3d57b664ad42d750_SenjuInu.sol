...
contract SenjuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Senju Inu";
    string private _symbol = "SENJU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21DEAc99Cb2cB5546Bf1546E9E5300E583Dc03A7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1B71792a32816b7A4Ac52d915C10CF2139d2a880); // BuyBack Address
