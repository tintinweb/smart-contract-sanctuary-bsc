...
contract Apening is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Apening BSC";                                          // name
    string private _symbol = "$Ape";                                             // symbol
    ...
    uint256 public _liquidityFee4Buyers = 1;
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x7278Ad98e98D283dE1ABa24A1E6308f72Ab86f71),                             // Dev+Team wallet
        payable(0x7278Ad98e98D283dE1ABa24A1E6308f72Ab86f71),                             // Marketing wallet
        payable(0x7278Ad98e98D283dE1ABa24A1E6308f72Ab86f71)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
