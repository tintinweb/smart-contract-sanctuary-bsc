...
Remember guys - no matter what the FED says- We Are gonna make it.
Join Wagmi Group

TG: https://t.me/WAGMI_GROUP
...
contract Wagmi is IBEP20, Ownable {
    ...
    function takeFee(address sender, address recipient, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        feeAmount = feeAmount.add(burnbabyburn);
