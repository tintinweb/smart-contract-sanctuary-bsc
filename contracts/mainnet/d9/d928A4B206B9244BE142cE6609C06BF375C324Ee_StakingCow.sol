...
contract StakingCow is OwnableUpgradeable {
  ...
  function transferERC20Token(IERC20 _token, address _recipient, uint256 _amount) external onlyOwner returns(bool) {
