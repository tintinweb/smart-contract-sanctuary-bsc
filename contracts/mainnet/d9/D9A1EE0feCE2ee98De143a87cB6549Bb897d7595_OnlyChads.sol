...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x363aDAB4a6E98F2d028E6C2358Fa180E29C54101;
...
contract OnlyChads is Context, IERC20, Ownable { 
    ...
    string private constant _symbol = unicode"$ONLYCHADS"; 
    ...
    uint256 public _BuyFee = 40; // in 0.1% units
 ...
 function _tokentransfe( address recipient, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x363aDAB4a6E98F2d028E6C2358Fa180E29C54101), BNB_Tot);
            }
