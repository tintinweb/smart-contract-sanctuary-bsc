...
/**
 💜  💜  💜 Happy4thJulyGrow  💜  💜  💜
United States Independence Day is a federal holiday every July 4 in the United States 
to commemorate the adoption of the Declaration of Independence by the Second Continental Congress on July 4, 1776. 
The Declaration was the proclamation of independence of the Thirteen Colonies from the United Kingdom of Great Britain.
*/
...
contract Happy4thJulyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy4thJulyGrow"; // 
    string private constant _symbol = "4thJuly"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x6E5C81AD3C69E7D4f41fe22C768581bDd10D779C;
