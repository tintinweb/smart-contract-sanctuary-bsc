...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A0107025e0A36B62B9003a4C82D199ea44BeB39; // owner address
...
contract HookTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hooked 2.0";
    string private constant _symbol = "H2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03Db70998CA9230917C1658dD83d25973F095671); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A0107025e0A36B62B9003a4C82D199ea44BeB39); // Team Address
