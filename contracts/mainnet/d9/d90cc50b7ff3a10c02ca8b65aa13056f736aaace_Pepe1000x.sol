...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9507806E33bE09c60A82B3eE6767F5c3c04d630; // owner address
...
contract Pepe1000x is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe 1000x";
    string private _symbol = "$PX";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xE9507806E33bE09c60A82B3eE6767F5c3c04d630); 
    address payable public teamWalletAddress = payable(0xE9507806E33bE09c60A82B3eE6767F5c3c04d630);
