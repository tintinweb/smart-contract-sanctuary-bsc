...
library Address{
 ...
 contract SpitziInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xcd1Fc70cdcEB5482dbCa743826FE32Ac739beeE7;
    address public donationWallet = 0xcd1Fc70cdcEB5482dbCa743826FE32Ac739beeE7;

    string private constant _name = "SpitziInu";
    string private constant _symbol = "SpitziInu";
    ...
    Taxes public taxes = Taxes(1, 20, 2, 20);
    Taxes public sellTaxes = Taxes(1, 20, 2, 20);
