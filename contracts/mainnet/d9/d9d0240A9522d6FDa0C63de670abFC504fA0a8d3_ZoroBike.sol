...
contract ZoroBike is Context, IERC20, Ownable {
    ...
    string private _name = "Zoro Bike";
    string private _symbol = "ZoroBIKE";
    ...
    uint256 public _sellAdvestisementFee = 10;

    uint256 private _taxFee = _buyTaxFee;
    uint256 private _previousTaxFee = _taxFee;

    address public advertisementWallet =
        0xD79c58c117796E630d1FE731237189edB3b37C49;
    ...
    uint256 public _maxTxAmount = 20 * 1e6 * 10**18; //20% of total supply
    ...
    function burn(uint256 _value) public {
        ...
        require(_value <= _rOwned[_msgSender()], "Burn amount exceeds balance");

        _rOwned[_msgSender()] = _rOwned[_msgSender()].sub(_value);
        _tOwned[DEAD_ADDRESS] = _tOwned[DEAD_ADDRESS].add(_value);

        emit Transfer(_msgSender(), DEAD_ADDRESS, _value);
    }
}