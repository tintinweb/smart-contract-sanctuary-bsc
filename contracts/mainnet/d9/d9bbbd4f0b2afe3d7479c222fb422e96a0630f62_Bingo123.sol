...
contract Bingo123 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xaF1cb2Fce24c8aa5D3469439228DC4e8605f4bBE;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Bingo123";
    string constant _symbol = "Bingo123";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 25 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 25 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xfCAE4a5d0FAD60439F42064283e7172e4442bCb2;
