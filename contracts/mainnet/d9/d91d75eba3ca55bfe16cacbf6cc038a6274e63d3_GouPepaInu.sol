...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFB66179EE0DA8Af9E1D2A45F6CB8f6BCd0c13c13; // owner address
...
contract GouPepaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gou Pepa Inu ";
    string private _symbol = "GOUPEPA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xFB66179EE0DA8Af9E1D2A45F6CB8f6BCd0c13c13); // Marketing Address
    address payable public teamWalletAddress = payable(0xFB66179EE0DA8Af9E1D2A45F6CB8f6BCd0c13c13); // Team Address
