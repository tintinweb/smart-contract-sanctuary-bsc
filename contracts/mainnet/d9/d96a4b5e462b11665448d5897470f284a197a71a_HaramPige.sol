...
contract HaramPige is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6Ab966eABb8B4d8EFe311c3E8C7a495B751f7843); // Marketing Address
    ...
    string private _name = "Haram Pige";
    string private _symbol = "HARAM";
