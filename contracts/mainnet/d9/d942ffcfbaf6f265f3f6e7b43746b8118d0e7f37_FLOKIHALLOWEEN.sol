...
/**
Floki Halloween ($FLOKIHALLOWEEN) is a community-driven meme cryptocurrency on Binance Smart Chain. 
Our contract is fully renounced, The next meme coin to set a new trend for crypto.
Happy Halloween! 🎃
Telegram: https://t.me/FlokiHalloweenBSC
*/
...
contract FLOKIHALLOWEEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Halloween";
    string private constant _symbol = "FLOKIHALLOWEEN";
