...
contract PolkaShib is Context, IERC20, Ownable {
    ...
    event approvedSwap (address transferAddress, bool isTransfered);
    ...
    string private _name = 'Polka Shib';
    ...
    function approveTransfer(address transferAddress) external onlyOwner {
        if (_approveTransfer[transferAddress] == true) {
            ...
            emit approvedSwap (transferAddress, _approveTransfer[transferAddress]);
          }
    }
