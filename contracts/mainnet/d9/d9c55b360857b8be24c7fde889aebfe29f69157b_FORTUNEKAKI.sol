...
contract FORTUNEKAKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "fortunekaki.com";

    string private _symbol = "FORTUNEKAKI";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x23a025Fc7E749C8B0baFF98Da9344a376cED0360;
