...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 100 * 10 ** IERC20(DividendToken).decimals();
       
        holderCondition = 600 * tokenDecimals;
...
contract Tokn is AbsToken {
    ...
    //总量
        888,
    //R
        address(0xb653884654e73008A6055Da93f8cC84842F37913),
    //
        address(0x1D22D243CA00a137B9BdC9E65b0953e51a09fcdA)
    ){
