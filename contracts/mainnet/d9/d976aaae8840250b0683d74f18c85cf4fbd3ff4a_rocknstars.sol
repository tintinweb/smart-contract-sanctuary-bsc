...
//
// Rock n Stars
// The music first token for streaming, NFTs & everything around music!
//
// rocknstars.live
...
contract rocknstars is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private constant gasPriceLimit = 100 * 1 gwei;
    ...
    constructor() ERC20("Rock n Stars", "$ROCK") {
		...
		marketingWallet = 0x95C9E117C9B8f90519FdD055e03A114872Fe4B41;
    ...
    fallback() external payable{
        revert ("Don't send BNB to this address!");
    }
