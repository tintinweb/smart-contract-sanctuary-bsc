...
contract MyTokenA is IERC20(), Proxiable, Context {
...
/////////
    ...
    function initialize(address routerAddress) public {
...
contract MyTokenB is IERC20(), Proxiable, Context {
    address public owner;
///////
    IPancakeRouter02  _router;//internal
    IPancakePair  _pair;//internal
...
/////////
    ...
    function ANALOGinitialize2(address routerAddress) public {
        require(owner == address(0), "Already initalized");
        owner = msg.sender;
        _mint(_msgSender(), 10000e18);
        ...
        function mint2(address account, uint256 amount)  external onlyOwner  returns (bool) {
        _mint(account, amount);
        return true;
    }
//////////////
