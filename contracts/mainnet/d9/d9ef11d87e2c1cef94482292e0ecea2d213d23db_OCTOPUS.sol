...
/**
🦑 Inspired by the octopus prophet Paul who correctly predicted the matches at the 2010 WORLD CUP 
We will conceptualize and create a blockchain octopus platform for football games and meaningful activities at the beach to conserve, 
protect rare marine animals, and protect the marine environment. 
🦑 🌟Mechanism of action : ✅Marine conservation organizations ✅Football games ✅Meme pioneer ✅NFTs collection ✅Prediction Qatar 2022
*/ 

// https://twitter.com/Paul_OctopusBSC
...
contract OCTOPUS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x82f740dDFD24aAbBC187BD668233e4d04744bDAd);
    address payable public buyBackWalletAddress = payable(0x82f740dDFD24aAbBC187BD668233e4d04744bDAd);
    ...
    uint256 private _totalSupply = 3000 * 10**6 * 10**_decimals;
