...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xd3d4a67Aa627B21aed751dD6dC18195eD2bA8183;
...
contract HG20 is AbsToken {
    constructor() AbsToken(
        ...
        address(0xd3d4a67Aa627B21aed751dD6dC18195eD2bA8183),  //营销
        
        
        address(0xFeF551663c018dc40F95108851Ab9d8c3B4dcF3e ) //代币接受钱包
    ){
