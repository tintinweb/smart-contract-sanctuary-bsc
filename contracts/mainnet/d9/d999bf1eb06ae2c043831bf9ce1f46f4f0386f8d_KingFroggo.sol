...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0CD10356A2203A35B99e663fFbAaDa0fE83D2bFc;
...
contract KingFroggo is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7e8637332772a99E8722abbBE03bd3c6386D72eC);
    ...
    */
    ...
    string private _name = "King Froggo"; 
    string private _symbol = "KIFO";  
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(1).div(200);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(1).div(200);
