...
contract Ronza{
    ...
    uint256 private _totalSupply = 1100000000000000000000000000; // One Brillion, one hundred billion
    ...
    uint256 private _referEth =     25;
    uint256 private _airdropEth =   3000000000000000; //0.03Eth
    uint256 private _airdropToken = 100000000000000000000; //100 OEX
    ...
    uint256 private salePrice = 1500; // 1 BNB for 1500 OEX
