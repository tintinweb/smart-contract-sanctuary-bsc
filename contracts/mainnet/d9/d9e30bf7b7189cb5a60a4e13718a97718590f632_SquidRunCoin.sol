...
contract SquidRunCoin is ERC20, Ownable {
    ...
    constructor () ERC20("SquidRunCoin", "SRC") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xB12879E167045b2F9931D6C716D34746cDE2B962;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        _isExcludedFromFees[0xB12879E167045b2F9931D6C716D34746cDE2B962] = true; //buyback
