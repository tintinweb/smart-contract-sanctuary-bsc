...
contract GNA is Context, IERC20, Ownable {
    ...
    string private _name = "GNA";
    string private _symbol = "GNA";
	...
	// fee list end
	address public ownerAddress = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);
    
	address public marketAddress = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);

    address public marketAddress2 = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);
	
	address public lpAddress = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);

    address public lpAddress2 = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);
	
	address public nftAddress = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);

    address public oskAddress = address(0xC5db5aFee4C55DfAD5F2b8226C6ac882E6956a0A);

    address public backAddress = address(0xA906796BCfD9b86010862AA41e9A63196c3C3333);
