...
contract PresaleFactoryFee is OwnableUpgradeable {
    ...
    function  initialize ()  public initializer {
        ...
        wallet1 = 0x2e33e520cCdC4b517F37981c32Efc2f7eeBeb7aC;
        wallet2 = 0x7E2DD1A540eEb07B7985d5319CBE95bF4Db945b1;
        wallet3 = 0xc1F1cBb450789D4dc52821Ad31f8C544DC6BD312;
        wallet4 = 0x0D2D0a8217eea2B586d2B830C530a488f0aF3298;
    ...
    function buyTokensByUSDT(uint256 _amountPrice) external {
        ...
        usdtAddress.transferFrom(msg.sender, wallet4, _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByBUSD(uint256 _amountPrice) external {
        ...
        busdAddress.transferFrom(msg.sender, wallet4, _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByWBTC(uint256 _amountPrice) external {
        ...
        wbtcAddress.transferFrom(msg.sender, wallet4, _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByWETH(uint256 _amountPrice) external {
        ...
        wethAddress.transferFrom(msg.sender, wallet4, _amountPrice * fee4 / feeDenominator);
    ...
    function withdrawAll() external onlyOwner {
        ...
        if (BNBbalance > 0)
        {
            ...
            payable(wallet4).transfer(BNBbalance * fee4 / feeDenominator);
        }
