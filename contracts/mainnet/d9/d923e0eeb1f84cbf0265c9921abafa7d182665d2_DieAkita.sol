...
/**
previous DOGE!!! HIT 100K
ZHOHOU HIT 90K
TG:https://t.me/DieAkita_coin
...
contract DieAkita is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Die Akita";
    string private _symbol = "DieAkita";
