...
contract ClothToken is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 5000000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 1500000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 1500000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 1500000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Cloth Token";
    string private _symbol =  "CLOTH";
    /*=== Modifiers ===*/
