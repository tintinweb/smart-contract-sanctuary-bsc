 ...
 *
 * Join
 * https://t.me/amazmetaverse
 * https://twitter.com/amaz_metaverse
 *
 * Fees
 * 5% distributed to public liquidity pool
 * 2% distributed to loyal token holders
 * 2% distributed to developers
 *
 * Supply
 * 1,000,000,000 total supply
 * 40% of supply fairly distributed 
 * 20% of supply airdrop
 * 20% of supply donated an amazon
 * 20% of the supply for the team and allocated for growth and development
 * 
 * Amaz Metaverse!
 * #AMAZ
 *
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2470448aaa9c7F75fBb8210c0A98b7187958C17b;
...
contract AmazMetaverse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2470448aaa9c7F75fBb8210c0A98b7187958C17b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Amaz Metaverse";
    string private _symbol = "AMAZ";
