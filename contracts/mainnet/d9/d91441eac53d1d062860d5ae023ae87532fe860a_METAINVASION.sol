...
contract METAINVASION is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x25d4cb6676d6Ce9768a7F0318EA0A922C7aCB6A2)); // MarketingWallet
    ...
    constructor() ERC20("Meta Invasion", "INVASION") {
