...
contract SSDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarshipDoge";
    string constant _symbol = "SSDOGE";
    ...
    uint256 public swapThreshold = _totalSupply * 80 / 10000; // 0.15% of supply
    bool inSwap;
