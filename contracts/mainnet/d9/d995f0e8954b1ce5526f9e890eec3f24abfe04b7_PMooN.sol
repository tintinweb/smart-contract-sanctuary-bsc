...
/**
 * @title PmooN ERC20 token
 * @dev
 *      Written By Gangsta Dev Squad ^ 6 
 */
contract PMooN is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**7 * 12**DECIMALS;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("ProofOFMooN", "PMooN", uint8(DECIMALS))
        payable
        public
    {
