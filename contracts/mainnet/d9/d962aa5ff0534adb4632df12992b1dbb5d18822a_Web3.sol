...
contract Web3 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4D5B93775EA34863760DD8badFe7ffCD49DCCA12);
    address payable public teamWalletAddress = payable(0x4D5B93775EA34863760DD8badFe7ffCD49DCCA12);
