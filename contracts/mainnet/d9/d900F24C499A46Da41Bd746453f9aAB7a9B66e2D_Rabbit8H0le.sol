...
contract Rabbit8H0le is Context, IERC20, Ownable {
    ...
    string private constant _name = " Rabbit8H0le "; // 
    string private constant _symbol = " $Rabbit8H0le "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xfBc6Dfb433Ff043B8fd38Ee1864580Ed66AD367b;
