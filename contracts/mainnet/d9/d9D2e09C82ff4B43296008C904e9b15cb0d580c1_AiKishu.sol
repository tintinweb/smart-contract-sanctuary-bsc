...
contract AiKishu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AiKishu";
    string private _symbol = "KISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe99091cdCdE346fDa0ade19090C4e74748D78Eb5);
    address payable public teamWalletAddress = payable(0xe99091cdCdE346fDa0ade19090C4e74748D78Eb5);
