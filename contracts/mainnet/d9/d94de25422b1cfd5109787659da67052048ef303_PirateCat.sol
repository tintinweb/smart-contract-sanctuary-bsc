...
/**
😼Pirates Cat Stealth Launch Soon

Stealth Launch Today.

Delivered by an experience developer!
The team is committed to developing this project, The only cat-related token made to the moon from day one,Pirate Cat Aims to Bring back the Beauty of Crypto Players Like the old BSC, Pirate Cat was built for success not hope!
We are a powerful project with great utility

😼Locked LP
😼Verified CA
😼Massive Marketing
😼Legit and Good Project
😼Based and Experience Team


*/
//Telegram : https://t.me/piratecatbsc
//Website : http://piratecat.xyz/
//Twitter : https://twitter.com/piratecatbsc
...
contract PirateCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pirate Cat";
   ...
   // sell fee
    ...
    address public Owner=0x97864D2792a68EfD1A21475D89B073d82b307ce6; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xEf0533609739e3F961F82A6cc161c96fb6cB141f; // marketing address
