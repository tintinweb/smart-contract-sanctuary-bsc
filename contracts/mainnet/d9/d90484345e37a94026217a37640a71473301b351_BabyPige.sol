...
contract BabyPige is Context, IERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0x5224c4aFAC669ba4f0880849F0FC7B7249658B3B); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xB362119D7f4687dA809c23ecFACdfBfEF03E7075); // Team Address
