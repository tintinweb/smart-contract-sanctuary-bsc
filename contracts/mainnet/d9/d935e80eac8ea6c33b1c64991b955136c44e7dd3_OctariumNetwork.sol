...
contract OctariumNetwork is IBEP20, Auth {
    ...
    address DEV =  0x5cD27467fAa56f8d7bB8D7BA6E29b09169C29329;
    ...
    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch 
    uint256 private _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% 
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% 
