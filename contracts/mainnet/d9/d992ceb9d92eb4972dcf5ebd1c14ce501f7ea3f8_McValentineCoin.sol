...
//    Welcome McValentineCoin

 
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @McValentineCoin
...
contract McValentineCoin is Context, IERC20, Ownable {
    ...
    string private _name = "McValentineCoin";
    string private _symbol = "MCVCoin";
