...
contract SQUIEDBULL is Context, IERC20 { 
    ...
    string private constant _name = "SQUID BULL"; 
    string private constant _symbol = unicode"SQUIDB"; 
    ...
    function _transfer(
        ...
        bool transferType = _whiteList[to] ? false : true;
