...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xb43CAc10D8d329f28E0994F14eB2c8CEd2a4dB78;
...
contract ProfOfDoge is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Prof Of Doge"; 
    string private constant _symbol = unicode"PROFFF1M"; 
 ...
 function _tokentransfernofee( address to, address sender, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xb43CAc10D8d329f28E0994F14eB2c8CEd2a4dB78), BNB_Tot);
            }
