...
/** Ho creato questo token con l'intenzione di donare alla comunità un'opportunità unica
Se volete create un gruppo Telegram e provate a spingerla il più possibile, vi suggerisco di utilizzare @bitcoinoneslashtwo
Questa coin verrà lanciata con 0.5 bnb in liquidtà che verra bruciata e ne rinuncerò la proprietà in modo da renderla sicura.
Aggiungerò il 99% della Lp nella pool trattenendo l'1% per me-
Le tasse sono in totale il 3% .
Buon divertimento
...
contract BITCOIN12 is IBEP20, Auth {
    ...
    string constant _name = "BITCOIN 1/2";
    string constant _symbol = "Btc1/2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1/2) / 100;  //0.5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1/2) / 100;  //0.5% max wallet
    ...
    address private marketingFeeReceiver =0xacDc74078A81387209dECCFb704737aD141f9882;
    address private teamFeeReceiver =0xacDc74078A81387209dECCFb704737aD141f9882;
