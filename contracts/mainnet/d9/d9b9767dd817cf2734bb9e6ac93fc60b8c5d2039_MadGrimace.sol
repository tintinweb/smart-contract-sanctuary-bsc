...
contract MadGrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "MadGrimace";

    string private _symbol = "MADGRIMACE";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0x1B82C95687027fa9809bdf3feFF50a7fa1dfcFAE;
