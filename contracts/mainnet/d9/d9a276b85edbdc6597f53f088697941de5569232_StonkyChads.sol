...
/**
Stonky Chads
Telegram, Twitter - @StonkyGems
*/
/**
 * TOKEN MADE TO HONOUR THE GREAT WORK OF CARRANZA, JRT, JERRY GEMS, PHANTOM, AYIN AND ALL THE OTHER CHADS PUSHING ALPHA IN THE BEAR MARKET
WILL LOWER TAX GRADUALLY TILL WE REACH 1/1 AT 1K MC. WILL THEN LOCK AND RENOUNCE, AND HOPEFULLY BE SAFE PLAY FOR THE COMMUNITY 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public REWARD_TOKEN = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract StonkyChads is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StonkyChads";
    string constant _symbol = "SChads";
    ...
    uint256 public totalFee = marketingFee + rewardFee + liquidityFee + BuyBackFee;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 7 * 10**5 * 10**_decimals;
    ...
    uint256 public _maxTxAmount = rSupply.div(50);      //2%
    uint256 public _maxWalletToken = rSupply.div(33);    //3%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x194Fe53FEBf885B3e9f27238cAA89a6A8f046657;
        BuyBackFeeReceiver = 0x1A391882bB4E1A57110774e2791d7b3A274319cd;
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _BuyBackFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        BuyBackFee = _BuyBackFee;
        totalFee = _liquidityFee.add(_rewardFee).add(_marketingFee).add(_BuyBackFee);
