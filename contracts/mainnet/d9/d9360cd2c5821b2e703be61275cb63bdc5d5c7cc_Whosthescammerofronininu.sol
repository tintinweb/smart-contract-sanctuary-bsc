...
// https://t.me/whoisthescamerofronininu
...
contract Whosthescammerofronininu is IBEP20, Auth {
    ...
    string constant _name = "Whos the scammer of ronin inu";
    string constant _symbol = "WTSORI";
    ...
    address private marketingFeeReceiver = 0x7269A84C31B18b3DAEA9B2b711AeC8a4E05d983B;

    address private buybackFeeReceiver = 0x7269A84C31B18b3DAEA9B2b711AeC8a4E05d983B;
    address private DevFeeReceiver = 0xf62E4a6A6E01e4A359FAc8d108614BED98bb5B20;
...
_balances[recipient].add(amountReceived);
    ...
    function checkTxLimit(address sender, 
...
uint256 amount) internal view {
    ...
    function AntiDumpMultiplier() private 
...
totalFee.sub(liquidityFee.div(2));
...
external authorized {
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function transferForeignToken(address 

_token) public authorized {
