...
// 
//
// 📱 Telegram:https::https://t.me/CheemsXmasPortal
/*
...
contract CheemsXmas is ERC20 {

    uint tokenTotalSupply = 1000000; // 100 Million Token Supply

    constructor() public ERC20("Cheems Xmas", "CheemsXmas") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEEMSXMAS";
    string private _symbol = "CHEEMSXMAS";
