...
Welcome To Salted Inu 

Salted Inu is the next generation BSC token aiming to improve and bring the online betting & gambling transaction system to a decentralized level. Through the SaltedInu token, users will be able to complete faster transactions on betting platforms with lower fees!

Salted Inu is a progressive deflationary DeFi token built to succeed. The main idea behind Salted Inu is to provide a decentralised transaction network which operate on the Binance smart chain (BSC).
 The path forward for SaltedInu is determined by market fluctuations, but the model it runs on begs SaltedInu to succeed.

Tg: https://t.me/saltedinu
Website: https://saltedinu.live
Twitter: https://twitter.com/saltedinu/
...
contract SaltedInu is IERC20, Ownable {
