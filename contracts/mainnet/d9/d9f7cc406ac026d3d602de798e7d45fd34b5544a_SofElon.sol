...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xde1E8Fc78eE3FCc9360D99178B08DAE6990cEC4C;
...
contract SofElon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA68d264f2D1BBAD2Ca2e73b150Ae0b790C2f0f1c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Soldiers Of Elon";
    string private _symbol = "SofElon";
