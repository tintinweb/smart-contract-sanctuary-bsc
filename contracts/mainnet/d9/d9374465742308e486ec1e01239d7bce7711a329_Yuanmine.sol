...
/**
 *  Telegram: https://t.me/YUANMINE_BSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5418e9d274DF879c5F9C460241a389BE153C880c; // owner address
...
contract Yuanmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yuanmine";
    string private _symbol = "Yuanmine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5418e9d274DF879c5F9C460241a389BE153C880c); // 
    address payable public teamWalletAddress = payable(0x5418e9d274DF879c5F9C460241a389BE153C880c); // 
