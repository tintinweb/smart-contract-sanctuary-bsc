...
*/
/*
Telegram : https://t.me/LunamaxBSC 
Get ready to make on what you lost on Luna
...
contract LUNAMAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNAMAX";
    string private _symbol = "$LUNAMAX";
