...
contract stableAdex is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "stableAdex";
  string private _symbol = "stableAdex";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x7CA6391327e1CfC140B50EcfAC83Fab34016192E);
  address payable public teamWallet = payable(0x7CA6391327e1CfC140B50EcfAC83Fab34016192E);
