...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable ETH = address(0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378); //ETH
...
contract $ETHSAITA is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    address public immutable ETH = address(0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378); //BUSD ETH
    ...
    address payable public _marketingWalletAddress = payable(0x0aAb2adA8D2a28Df0F54Be240dc0c31e41B79b5a);
    address payable public _buybackWalletAddress = payable(0x2aA3cc85fA67dE1327B760E11e224F27a79820B6);
    ...
    constructor() BEP20("ETH SAITAMA", "$ETHSAITA") 
    {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner 
    {
        ...
        require(newDividendTracker.owner() == address(this), "ETHSAITA: The new dividend tracker must be owned by the ETHSAITA token contract");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ETHSAITA: The PanETHSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ETHSAITA: gasForProcessing must be between 200,000 and 500,000");
    ...
    function swapAndLiquify(uint256 tokens) private 
    {
       uint256 swapableFee = totalFees.sub(ETHRewardsFee);
        ...
        // how much ETH did we just swap into? BUSD
...
contract ETHSAITADividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("ETHSAITA_Dividend_Tracker", "ETHSAITA_Dividend_Tracker") {
        claimWait = 3600;
