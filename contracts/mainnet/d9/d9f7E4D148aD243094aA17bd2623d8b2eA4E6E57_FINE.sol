...
//https://t.me/AssetsAreFine
//https://www.assetsarefine.com
...
contract FINE is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 40000 * 10**9; //
  
    string private constant _name = "AssetsAreFine"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xC45Ecab5B1AFf1c3cD3EDdC690C92564B7bcCd58).transfer(ethToSend); //marketing wallet
    }
