...
contract FBC is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Farming Block Capital";
    ...
    constructor () RSunAuth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x773b36c44f45CA60736294230d8b409546FCf978;
        marketingFeeReceiver = 0x4bB150E867E378F009709FE483AbFC428e5742b8;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorizedFor(Permission.AdjustContractVariables) {
