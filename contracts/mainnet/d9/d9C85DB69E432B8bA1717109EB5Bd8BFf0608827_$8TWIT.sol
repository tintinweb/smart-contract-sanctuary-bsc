...
contract $8TWIT is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xEADb0DEE958ae45763407DB2db778E99f4dBB743;

    string constant _name = "$8TWIT";
    string constant _symbol = "$8TWIT";
