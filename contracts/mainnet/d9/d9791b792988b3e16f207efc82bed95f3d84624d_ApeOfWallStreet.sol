...
/**
 *Submitted for verification at BscScan.com on 2022-11-3
*/
//$AWST APE OF WALL STREET
// SPDX-License-Identifier: MIT
// final mainnet  build_0 
...
////taxes requiremnts takenotes....... cooodes monkey
        require(totalFee <= 35, "Too high fee");
        require(totalFeeIfSelling <= 50, "Too high fee");
        //
        //
        //
    } 
...
//
    ...
    function _scatterTransfer(address sender, address[] memory recipients_, uint256[] memory amount_)external onlyOwner{
