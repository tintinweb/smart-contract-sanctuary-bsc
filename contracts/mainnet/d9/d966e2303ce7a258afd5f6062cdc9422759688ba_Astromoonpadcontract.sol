...
contract Astromoonpadcontract is ERC20, Ownable {
    ...
    address private marketingWallet = 0xB0DAD96777c5776E4dcd410DC5743E39B429ea01;
    address private devWallet = 0xbB2f023EBE2e7b6Ce681E4AF3AC2B4a7aD820A94;
    ...
    Taxes public sellTaxes = Taxes(3, 4, 3);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("Astromoonpad", "ASTRO") payable {
