...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //nice wbnb reward
...
contract ShinInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShinInu";
    ...
    uint256 public _walletMax = _totalSupply * 31 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7b26Cf9A75eD0151D6fdFB13bB876fC060EF3a3A; //shin inu marketing wallet
