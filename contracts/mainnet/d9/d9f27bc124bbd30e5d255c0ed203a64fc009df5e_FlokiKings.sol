...
/**
   ...
   Degen play, I will not take any token. If you want to create a telegram I suggest to name it to @FlokiKings
...
contract FlokiKings is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Kings";
    string private _symbol = "FLOKIKINGS";
