...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xD915cEb9661963392ef75500E596CE3f63a69B61); //BUSD
...
contract JUJITSU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Jujitsu Inu";
    string constant _symbol = "JINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2 * 10**18 * 10**_decimals;
