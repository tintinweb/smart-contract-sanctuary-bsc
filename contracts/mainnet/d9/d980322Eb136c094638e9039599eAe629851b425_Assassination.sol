...
contract Assassination is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Assassination";
    string private _symbol = "Assassination";
    ...
    address private lpAddress = 0x7Ac03034eD92fE126A41bC523d40b98334DCEb0c;
    ...
    uint256 public _totalTaxIfBuying = 8; // original 3
    uint256 public _totalTaxIfSelling = 8; // original 3
    uint256 public _totalDistributionShares = 8; // original 3
    ...
    address public usdtToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
