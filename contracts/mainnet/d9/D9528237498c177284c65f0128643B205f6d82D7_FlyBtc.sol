...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x782578DA88e06dB3B35E1d4E96374917c8859106;
...
contract FlyBtc  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlyBtc "; //
    string private constant _symbol = "FlyBtc "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x782578DA88e06dB3B35E1d4E96374917c8859106);
