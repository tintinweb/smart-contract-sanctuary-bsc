...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  RABBITINU = IBEP20(0x740eBb632DA8856129cb50649aCe8120Ba623AfF);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RABBITINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(RABBITINU);
        ...
        uint256 amount = RABBITINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RABBITINU.transfer(shareholder, amount);
...
contract Rabbitoge is IBEP20, Auth {
    using SafeMath for uint256;

    address RABBITINU = 0x740eBb632DA8856129cb50649aCe8120Ba623AfF; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x43473A21c34DE377A62C20fF6F664b8864A52eCc;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Rabbitoge";
    string constant _symbol = "RBTOGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x88158d29509ff41b66083a3037cDb5d5C32FCd27;
