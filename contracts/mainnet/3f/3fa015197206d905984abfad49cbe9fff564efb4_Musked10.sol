...
contract Musked10 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0bd397Bbb3682e1aB8c86661bF92134daF88F411); 
    address payable public Dev_Wallet = payable(0x41b1205f13F1704A4B8A3998b6B044FD1DC398e2);
    ...
    string private constant _name = "Elon Musked10"; 
    string private constant _symbol = unicode"Musked10"; 
    ...
    constructor () {
        ...
        _owner = 0x41b1205f13F1704A4B8A3998b6B044FD1DC398e2;
