...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    constructor(uint256 _numTokenToDividend, bool _swapToDividend) {
        ...
        distributor = new DividendDistributor(USDT, 21600, 10 * (10**8));
    ...
    function swapAndToDividend() internal lockTheSwap {
        ...
        uint256 toLpAmount = (theSwapAmount * 3) / 4;
        distributor.transferUSDT(address(this), toLpAmount);
        distributor.distributeDividends(theSwapAmount - toLpAmount);
    }
    ...
    function _takeDividendFee(address sender, uint256 amount)
        ...
        returns (uint256)
    {
        uint256 dividendAmount = (amount * (distributefee + lpFee)) / 100;
...
contract ASK is ExcludedFromFeeList, BlackList, DividendFee {
        ...
        returns (uint256)
    {
        ...
        return amount - divAmount - burnAmount - marketingAmount;
    }
