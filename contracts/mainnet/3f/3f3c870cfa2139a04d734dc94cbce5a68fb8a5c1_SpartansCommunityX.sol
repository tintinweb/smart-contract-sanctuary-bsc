...
Spartans Community X (SCX)

A Fewer The Strongest
Spartans don't need a lot of people to beat the Jeets and conquer their Minds. 
All The Spartans need is only stand tall together.
Lets join Spartans! 


Total Supply 300 tokens
Max Wallet 1.5%
Max Tx 1.5%
...
4% to Dev & Marketing
1% to Liquidity
5% to BUSD Reflection

SELL TAXES 10%
4% to Dev & Marketing
2% to Liquidity
4% to BUSD Reflection

Telegram chat : https://t.me/spartanscommunityX
*/
...
/* Token contract */
contract SpartansCommunityX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa7956154826f5f6c75b3b6F57E923F3B6f9bb256;
    ...
    // Name and symbol
    string constant _name = "SpartansCommunityX";
    string constant _symbol = "SCX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 300 * (10 ** _decimals); // 300

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 150 / 10000; // 1.5% (4.5 tokens)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (3 tokens)
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 10000; // 1.5% (4.5 tokens)
