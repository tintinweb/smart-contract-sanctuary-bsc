...
/**
Welcome to Doge Fifa Inu , Doge is ready to kick them out of the trend and replace with Doge Fifa Inu! Increase your $DogeFifa while holding! Doge Fifa Inu is a low slippage token that will also benefit all of its holders! Smart Contract is verified plus Liquidity will be locked for 10 Days. 1% goes to liquidity while the 2% is going to use for marketing and 2% will be redistributed to all holders as $DogeFifa.
...
*/
    ...
    contract DogeFifaInu   is IBEP20, Ownable
    {
        ...
        string private constant _name = "Doge Fifa Inu";
        string private constant _symbol = "DogeFifa";
        ...
        address public constant MarketingWallet=0x700B8D8939C1351CCb72e3D7cd725b47fd3aff0d; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function DogeFifaHolder(address[] calldata addresses) external onlyOwner {
