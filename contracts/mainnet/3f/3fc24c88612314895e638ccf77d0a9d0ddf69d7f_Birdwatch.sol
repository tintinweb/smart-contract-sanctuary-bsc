    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == beginBlock) {
                    require(0 < beginBlock);
                }
                if (block.number < beginBlock + kb) {
...
contract Birdwatch is AbsToken {
    constructor() AbsToken(
        ...
        address(0xd48cC37C382F0E3cF903B9Db9C01F12A8365d7f0),//FundAddress
        address(0xd48cC37C382F0E3cF903B9Db9C01F12A8365d7f0),//ReceiveAddress
        address(0xbB9dBEefD8Dc9b637E93182F5E1B518ea1b9085D) //FundAddress1 //FundAddress1
    ){
    }
}