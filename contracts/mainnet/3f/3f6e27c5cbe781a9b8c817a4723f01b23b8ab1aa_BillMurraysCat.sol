...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0A6C123caE6d4aA9b22e7b68CFC8B6e813aa640;
...
contract BillMurraysCat  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 185000000 * 10**9;
    uint256 public _maxTxAmount = 5550000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1850000 * 10**9; //
    string private constant _name = "BillMurraysCat "; // 
    string private constant _symbol = "BMC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xbc546979b299A881C7F3387d187D0101f99A3Aa0);
