...
contract GALA is Context, IERC20, Ownable {
    ...
    string private _name = "GALA 2.0";
    string private _symbol = "GALA 2.0";
    ...
    uint256 public _liquidityFee = 10; // All taxes are divided by 100 for more accuracy.
    ...
    address public burnAddress = 0x37B07Fc4DB2aE5E7015d9Bd5Cb1f5b0E85520DbE;
    address payable private _marketingWallet = payable(0x37B07Fc4DB2aE5E7015d9Bd5Cb1f5b0E85520DbE);
    address payable private _devWallet = payable(0x37B07Fc4DB2aE5E7015d9Bd5Cb1f5b0E85520DbE);
