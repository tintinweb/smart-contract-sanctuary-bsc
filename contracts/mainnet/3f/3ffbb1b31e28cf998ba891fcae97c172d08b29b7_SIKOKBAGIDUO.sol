...
contract SIKOKBAGIDUO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SIKOK BAGI DUO"; // 
    string private constant _symbol = "SBD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x25c8679c459ce1Fd43B98ab78fA6C23913baCe0C;
