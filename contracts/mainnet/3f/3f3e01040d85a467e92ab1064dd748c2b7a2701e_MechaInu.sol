...
Telegram : https://t.me/mechainuofficial
Website : mechainu.online
...
contract MechaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MechaInu";
    string constant _symbol = "$MENU";
    ...
    function manageAddress(address[] calldata addresses, bool status) public onlyOwner {
