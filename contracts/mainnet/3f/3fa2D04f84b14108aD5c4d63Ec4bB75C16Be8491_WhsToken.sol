       ...
       if(_ispair && recipient == uniswapV2Pair && sender != address(this))
        {
            ...
            uniswapV2Router.swapExactTokensForTokens(_reward, 0, path, reward, deadline); //lp分红滑点
