...
contract ProtocolFeeCollectorImplementation is ProtocolFeeCollectorStorage, NameVersion {
    ...
    function buyAndBurnDeri(uint256 bTokenAmount, uint256 minDeriAmount) external _onlyAdmin_ {
        require(
        ...
        uint256[] memory res = IUniswapV2Router02(swapRouter).swapExactTokensForTokens(
            bTokenAmount, minDeriAmount, path, burningDestination, block.timestamp
        );
