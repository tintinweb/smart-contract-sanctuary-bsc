...
contract LIKE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mingle';
    ...
    uint256 currentAmountToSwap = 50000 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0xCC698f6661f3E64C58c25025687c27450Ec88999);
    address public walletTwo=payable(0x7362055A7D9DC8F0464E743bEa3486fEE7564929);
	address public walletThree=payable(0x234237Dc3Bc2f73dE32af02cb8AE24ea8605EF94);
	address public walletFour=payable(0x691767Ef600A0F2032B4B60C13494Dc1481a99A0);
    //Testnet
    ...
    constructor () {
		...
		_excluded.add(walletThree);
		_excluded.add(walletFour);
    ...
    function TeamWithdrawALLMarketingBNB() external onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*35) / 100);
        payable(walletTwo).transfer((amount-(amount*35) / 100));
    } 
    function TeamWithdrawXMarketingBNB(uint256 amount) external onlyOwner{
        ...
        payable(TeamWallet).transfer((amount*36) / 100);
        payable(walletTwo).transfer((amount-(amount*78) / 100));
        payable(walletThree).transfer((amount-(amount*79) / 100));
        payable(walletFour).transfer((amount-(amount*79) / 100));				
    } 
