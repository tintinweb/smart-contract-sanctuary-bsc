...
contract Noichi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Noichi";
    string private _symbol = "NOICHI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE41122C2e845A03ab5C4748527e2adf19CE4e810));
        marketingWalletAddress = payable(address(0x9580019CAF7A6020fEeF492E920722ED16C4750C));
