...
Welcome to GoldFNMeka TOKEN!

TOKENOMICS:

1,000,000,000 tokens in the Supply
6% marketing & development
3% LP

2% max TRX, 2% max wallet

TG: https://t.me/GoldFNMeka
*/
...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`newGoldFNMekaOwner`).
...
contract GoldFNMeka_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldFNMeka";
    string private constant _symbol = "$GMEKA";
