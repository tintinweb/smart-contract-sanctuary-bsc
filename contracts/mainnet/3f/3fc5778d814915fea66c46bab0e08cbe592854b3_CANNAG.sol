...
contract CANNAG is owned, Cannag {
    ...
    ) Cannag(initialSupply, tokenName, tokenSymbol) public {}
    ...
    function freezeCANNAG(uint _value, uint _unlockTime) public {
        require(ids[msg.sender]);
        require(balanceOf[msg.sender] >= _value);
    ...
    function unFreezeCANNAG() public {
