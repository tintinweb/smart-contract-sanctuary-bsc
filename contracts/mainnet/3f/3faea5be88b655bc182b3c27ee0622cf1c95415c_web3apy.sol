...
contract web3apy is ERC20Detailed, Ownable {
    ...
    string public _name = "Web3 APY";
    string public _symbol = "WEB3APY";
    ...
    uint256 public web3apyInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(web3apyInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public web3apyInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("WEB3APY", "WEB3APY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x86a6C6A3144B0750B55bFA0D05B3354e303cF4eA;
        treasuryReceiver = 0x6E8019606F06BBd32261cb0C4A3A45F9D4920a82; 
        web3apyInsuranceFundReceiver = 0xca4536A80bc440aDc127EB27bEd8F656BE2dC183;
        firePit = 0xAA73Fc727e157771b3c551eaadb8190b29706f98;
    ...
    function takeFee(
        ...
        uint256 _web3apyInsuranceFundFee = web3apyInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _web3apyInsuranceFundFee = web3apyInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(web3apyInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(web3apyInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(web3apyInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(web3apyInsuranceFundFee).div(
                treasuryFee.add(web3apyInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no WEB3APY token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _web3apyInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        web3apyInsuranceFundReceiver = _web3apyInsuranceFundReceiver;
        firePit = _firePit;
    }
