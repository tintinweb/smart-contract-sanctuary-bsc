...
contract AXSG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Axie Grow"; // 
    string private constant _symbol = "AXSG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xB3d8ca3D7C298CE2a171c0ffaFb5Ffa0743bfE4d;
