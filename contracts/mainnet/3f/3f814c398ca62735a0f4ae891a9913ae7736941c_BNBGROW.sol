...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _TxWhiteList;
    uint256 public kb = 1;
    ...
    constructor (
        ...
        string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, uint256 maxTxAmount,
        ...
        _TxWhiteList[FundAddress] = true;
        _TxWhiteList[ReceiveAddress] = true;
        _TxWhiteList[address(this)] = true;
        _TxWhiteList[address(swapRouter)] = true;
        _TxWhiteList[msg.sender] = true;
    ...
    function _transfer(
        ...
        if(!_TxWhiteList[from] && !_TxWhiteList[to]) {
...
contract BNBGROW is AbsToken {
    constructor() AbsToken(
        ...
        100000000,//Supply
        500000,//maxTxAmount
        address(0x9F0D3599fb3d16A05f021224d9CaD8E4375c2880),//FundAddress
        address(0x034167EcE9F0d975D005B4B8304AbBf27086f6F7)//ReceiveAddress
    ){
