...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5DB49f8C2c3E547652E298BB1c87760Eba3466a8; // owner address
...
contract SLUMDOGMILLIONAIRE is Context, IERC20, Ownable {
    ...
    string private _name = "Slumdog Millionaire";
    string private _symbol = "SDML";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53F8D7D9B10F3E1FF18E086988F83864ba0BD7Bc); // Marketing Address
    address payable public teamWalletAddress = payable(0xCE11A756CE5dAc02f21537221C8efB4eCEf2088f); // Team Address
