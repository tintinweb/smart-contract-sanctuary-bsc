...
BasedAi - 10% Doge reflection

Total supply: 100,000,000,000
Max wallet: 1,500,000,000 (1.5%)
Max Buy / Sell: 500,000,000 (0.5%)
...
Must hold 1000,000 token to receive Doge

Telegram: https://t.me/BSCBasedAi
...
contract BasedAiDividendTracker is IDividendDistributor {
...
contract BasedAi is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "BasedAi";
    string _symbol = "BSCAi";
    ...
    address public marketing = address(0x1f257D6f47A13047C85B06DB120689e67e8964ed);
    address public liquidity = address(0x1f257D6f47A13047C85B06DB120689e67e8964ed);

    IDEXRouter public router;
    address pair;

    BasedAiDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new BasedAiDividendTracker();
