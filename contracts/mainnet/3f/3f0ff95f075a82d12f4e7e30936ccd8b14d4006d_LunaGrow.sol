...
library Address{
 ...
 contract LunaGrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7B3b65F35d4304b1210Ae2463CBC35651910cDA4;
    address public devWallet = 0x8F511F82ec14021d239d2d150f18F06AC3B21fC3;

    string private constant _name = "LunaGrow";
    string private constant _symbol = "$LUG";
    ...
    Taxes public sellTaxes = Taxes(2, 6, 2, 5);
