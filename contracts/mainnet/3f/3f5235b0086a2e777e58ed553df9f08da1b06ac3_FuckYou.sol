...
/**
Telegram: https://t.me/FuckYou_BSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe44a246DdA854064596c8dBe2A82309503F6df93; // owner address
...
contract FuckYou is Context, IERC20, Ownable {
    ...
    string private _symbol = "FYOU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe44a246DdA854064596c8dBe2A82309503F6df93); // Marketing Address
    address payable public teamWalletAddress = payable(0xe44a246DdA854064596c8dBe2A82309503F6df93); // Team Address
