...
contract TwitterDogeZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterDogeZilla";
    string private _symbol = "TwitterDogeZilla";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x441b0A2638b8CA26615fD11c4689655f20C5f89A); 
    address payable public BurnedWalletAddress = payable(0x441b0A2638b8CA26615fD11c4689655f20C5f89A); 
