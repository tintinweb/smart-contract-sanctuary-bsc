...
contract LargeNFT is ERC721Enumerable, Ownable {
    string private _uri;
    ...
    constructor() ERC721("Large NFT", "Large NFT"){
        _maxSupply = 300;
        _uri = "https://gateway.pinata.cloud/ipfs/QmZdBpsVNvTTmh96vMr6EuLRKRR8ATyXHGGki6iXxLbB1S/LargeNFT.json";
    }
}