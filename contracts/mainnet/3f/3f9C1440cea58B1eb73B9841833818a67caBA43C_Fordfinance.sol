...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFCA99722B4376653CAf3D3af124994B3B67cc6bf;
...
contract Fordfinance  is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb39f318eeA3C4F3B6E9054AA9e95F356C91B5639;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "fordfinance";
    string private _symbol = "frdc";
