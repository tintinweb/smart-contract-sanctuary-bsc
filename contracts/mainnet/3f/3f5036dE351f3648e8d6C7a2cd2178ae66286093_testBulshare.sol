...
contract testBulshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 68500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund) public ERC20("Test Bulshare", "tBULSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Digital Share for initial pools deployment
