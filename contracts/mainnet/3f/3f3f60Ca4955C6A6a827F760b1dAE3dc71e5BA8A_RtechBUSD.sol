...
contract RtechBUSD {
    ...
    IERC20 public token = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //** Main RTech Token
	uint256 constant public INVEST_MIN_AMOUNT = 5 ether; // 500 Rtech

	uint256[] public REFERRAL_PERCENTS 	= [1000, 200, 100, 75, 50, 50, 50, 25, 25, 25];
	uint256[] public SEED_PERCENTS 		= [10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
	...
	uint256 public withdrawCooldown = 2678400; //31 Days
