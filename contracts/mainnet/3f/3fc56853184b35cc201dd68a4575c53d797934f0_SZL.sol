...
contract SZL is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("SZL", "SZLong Coin") {
        ...
        lpAddress = payable(0x4f08AF96b4540f48BC9A176321E78C6B684867B7);
        marketAddress = payable(0xdcE25396282ACf3540f9aA9E44C2eC267c249fa1);
        teamAddress = payable(0x99c6ecd12dEb39b25e49F34f3D9e6d723C784AD0);
        _mint(
            0x99c6ecd12dEb39b25e49F34f3D9e6d723C784AD0,
            300 * 10**decimals()
        );
        _mint(
            0x48AC673f3B73c18666e6c761B62C2fAfE9aC70A6,
            300 * 10**decimals()
        );
        _mint(
            0xcf95AFa99B0455fE0cb8Aba7894C2b3F98bE52Dd,
            200 * 10**decimals()
        );
        _mint(
            0x14AedE48b76e3893d673e21C9E32EfA425Cd3691,
            88 * 10**decimals()
        );
    }
