...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MuuINU = IERC20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MuuINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MuuINU);
        ...
        uint256 amount = MuuINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MuuINU.transfer(shareholder, amount);
...
contract MUUS is IERC20, Ownable {
    using SafeMath for uint256;

    
    address MuuINU = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Muu World";
    string constant _symbol = "Muus";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 10) / 500; // 2% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 20) / 500; // 2% of Total supply
    ...
    uint256 reflectionFee = 2; // 2%
    uint256 marketingFee = 3;  // 3%
    uint256 totalFee = 7; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xDFffFdB58b7b3d82f3ef819F9060492F6f7d2735);
        marketingFeeReceiver = address(0xDFffFdB58b7b3d82f3ef819F9060492F6f7d2735);
