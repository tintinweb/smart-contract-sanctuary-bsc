...
contract QJPLUS  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJPLUS ";
    string private _symbol = "QJPLUS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa6159C581bf62553aA74EfE8f174Bd9B7FA53f80);
    address payable public teamWalletAddress = payable(0xa6159C581bf62553aA74EfE8f174Bd9B7FA53f80);
    address public immutable deadAddress = 0xa6159C581bf62553aA74EfE8f174Bd9B7FA53f80;
