...
A memecoin that will go down in history. Let's celebrate the glorious and incredible moments of 2022 again, this time on a new platform with new faces, new hype and an awesome community.

Based on the SurgeProtocol, this will be the best MemeCoin ever.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0x9f19c8e321bD14345b797d43E01f0eED030F5Bff); //Juicy Surge rewards
...
contract SQUIDSURGESRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SquidSurge";
    string private constant _symbol = "SQUIRGE";
    ...
    //Tax wallets
    address public teamWallet = 0xBc3274929568d06201BD338e696051eF6dd2eFB9;
    address public treasuryWallet = 0xBc3274929568d06201BD338e696051eF6dd2eFB9;

    // Tax Split
    uint256 public teamShare = 0;
    uint256 public treasuryShare = 700;
