...
/*
    ...
    Staker contract for w$FlokiPulse 
    ===================================
...
contract wFPStaker is Ownable {
    ...
    IERC20 public depositToken; // eg. PancakeSwap wFPulse token
    IERC20 public rewardToken;  // eg. wFPulse
