...
contract SpookieDookie2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =  21000000000000 * 10**_decimals; // 21 Trillion Fixed Max Supply
    ...
    string private constant _name = "Spooky Dookie2"; //
    string private constant _symbol = "SDookie2"; //
