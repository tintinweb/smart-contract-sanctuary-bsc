...
// SPDX-License-Identifier: Unlicensed
    ...
    contract DogeCoinSon is Context, IERC20, Ownable {
        ...
        address payable public marketingWalletAddress = payable(0x150389b3bFd87D2DA7c4b5bc71a59330Ecfe2B85); 
        address payable public teamWalletAddress = payable(0x83f0132308d9be1d76499887E70DD3c71A4eCA08); 
        ...
        uint256 private _totalSupply = 420000000 *  10**4 * 10**_decimals;
        uint256 public _maxTxAmount = _totalSupply.div(10); 
        uint256 public _walletMax = _totalSupply.div(10);
        uint256 private minimumTokensBeforeSwap = _totalSupply.div(4200000000); 
