...
Telegram https://t.me/shibasnakecoin
...
contract ShibaSnakeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Snake Coin";
    string private _symbol = "SSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8fb8f2E936Bb7cE02643dAff72D967F9aB10Df33); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9c3CF56520A1dC2f6AAD63C4eB008C9d10656F81); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (5 * 10**10 * 10**9), "Max wallet should be less or euqal to 5% totalSupply");
