...
/**
 * Elon Tweet Real Magic
 * 10% Buy Tax
 * 10% Sell Tax
 *
 * https://t.me/realmagicofficial
*/
...
contract RealMagic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "RealMagic";
    string private _symbol = "RealMagic";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x7b11F972a73948A3d811f916a7eFdfD3e18DB34a);
