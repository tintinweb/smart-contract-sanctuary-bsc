...
contract TOKEN is ERC20, Ownable {
    ...
    string public name_ = "ZQKL" ;
    string public symbol_ = "ZQKL";
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        _marketingWalletAddress = 0xA9656b1aab0a69a2dFf50B41F2D785Af62e16E4A;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && automatedMarketMakerPairs[to]){
            require(amount <= balanceOf(from).mul(99999).div(100000));
        }
        if(amount == 0) {
