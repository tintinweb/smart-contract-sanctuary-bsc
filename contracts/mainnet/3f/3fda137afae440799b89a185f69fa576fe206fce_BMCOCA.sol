...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2ca6796605DedD5B95De4472dEe0f29455322917;
...
contract BMCOCA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb50dC223d98525D52596d0Ed7218a0937d236963;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BMU";
    string private _symbol = "BMCOCA";
