...
contract QATARROYALINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QATAR ROYAL INU";
    string private constant _symbol = "QRI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 100 * 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xD963EDFa3ddA6205dAaa2A8eA8C085ce4954e2e6);
    address payable public MarketingWallet = payable(0xD963EDFa3ddA6205dAaa2A8eA8C085ce4954e2e6);
