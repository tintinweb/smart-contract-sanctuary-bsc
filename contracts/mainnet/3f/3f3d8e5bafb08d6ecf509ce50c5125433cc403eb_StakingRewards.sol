...
contract StakingRewards is  ReentrancyGuardUpgradeable,OwnableUpgradeable,AccessControlUpgradeable {
    ...
    function _calculateFeeAmount(address from,uint256 amount) internal returns (uint256) {
        ...
        uint256 stakedTime = block.timestamp.sub(userLastStackedTime[from]);
