...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF84fe7f187B90a6710da9353F2969356CBca5477; // owner address
...
contract santabunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Bunny";
    string private _symbol = "SANTABUNNY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c7155Ac4aA8cadCEDde2008B7ed07088B1A0d02); // Marketing Address
    address payable public teamWalletAddress = payable(0xF84fe7f187B90a6710da9353F2969356CBca5477); // Team Address
