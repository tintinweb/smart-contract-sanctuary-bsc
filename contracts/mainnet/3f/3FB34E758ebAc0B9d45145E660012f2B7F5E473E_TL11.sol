...
contract TL11 is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "TL11";       //Full name
    string public symbol_ = "TL11";      //abbreviation
    ...
    uint256 public maxburn = 100 * (10**18); //max burn
    ...
    constructor(
        ...
        uint256 totalSupply = 288 * (10**18);       //Supply
