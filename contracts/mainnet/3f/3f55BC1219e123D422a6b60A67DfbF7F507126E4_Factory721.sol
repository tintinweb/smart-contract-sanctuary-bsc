...
import "./AifaworldUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new AifaworldUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AifaworldUser721Token token = AifaworldUser721Token(address(addr));
...
contract AifaworldUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
