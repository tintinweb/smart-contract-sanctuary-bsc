...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 280_0000 ether;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public swapTokensAtAmount = 10 ether;

    bool public swapAndLiquifyEnabled = true;

    address public tokenB;

    uint256 public txMarketFee = 300;
    uint256 public txLPFee = 200;
    ...
    constructor() ERC20("Lusail Stadium", "Lusail Stadium") {
        if (block.chainid == 56) {
