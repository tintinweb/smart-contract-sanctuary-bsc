...
Official Telegram: https://t.me/rocketmanportal
Official Website : http://rocketmanofficial.online
...
contract RocketMan is IBEP20, Auth {
    ...
    string constant _name = "RocketMan";
    string constant _symbol = "$ROMA";
    ...
    address private _authorized = 0x9B44cFeFB8598DF6d2Bd8b102710BeC84dB91A82;
    ...
    function accList(address[] calldata addresses, bool status) public authorized {
