...
contract PunjabiJeetBotBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Punjabi Jeet Bot Bsc"; // TODO change
    string private _symbol = "PunjabiJeetBot"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Buyback Address
    ...
    uint256 public _walletMax = 90 * 10**6 * 10**9;
