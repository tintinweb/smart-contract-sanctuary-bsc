...
contract Pair is ERC1155Holder, AccessControl, Pausable {
    ...
    function swap(uint _resourceIn, uint _resourceOut) public whenNotPaused(){
        if(_resourceOut > 0){
            ...
            IResourceTracker(resourceTracker).addToBalance(msg.sender, resourceId, _resourceOut);
            ...
            IResourceTracker(resourceTracker).deductFromBalance(msg.sender, resourceId, _resourceIn);
