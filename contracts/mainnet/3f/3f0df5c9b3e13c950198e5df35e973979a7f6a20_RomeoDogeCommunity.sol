...
contract RomeoDogeCommunity is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Romeo Doge Community";
    string private _symbol = "RDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc33A0A5058146DeCf8f5E1EF6a86B35B6c0200Df); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc33A0A5058146DeCf8f5E1EF6a86B35B6c0200Df); // BuyBack Address
