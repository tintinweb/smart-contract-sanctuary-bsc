...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd400eb75210c796B89e82CD9d2abE70aE5456756;
...
contract FlokiMas is Context, IERC20, Ownable {
    ...
    string private _symbol = " FlokiMas ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcC846d8366A5173945d7a29Ca15054F7eccC813E);
    address payable public teamWalletAddress = payable(0x1AA0E42B7CD5E5A77EDfAb47306F1F8679E1a150);
