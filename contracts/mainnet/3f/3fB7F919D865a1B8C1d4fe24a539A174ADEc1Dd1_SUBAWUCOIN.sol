...
😺Subawu coin😺
         ...
         -SUBAWUCOIN  a meme token created for community. Get a chance to get a x100 or x1000 profit. Community must give effort in shilling this token in able to get higher profit.
TOKENOMICS:
...
Join their TG 📲 https://t.me/SubawuCoin
...
contract SUBAWUCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUBAWU COIN";
    string private _symbol = "SUBAWUCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB6C80df45a12A68A8D740FA076736321c87D02b);
    address payable public teamWalletAddress = payable(0xbB6C80df45a12A68A8D740FA076736321c87D02b);
