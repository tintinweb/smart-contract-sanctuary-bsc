...
contract kitsuneInu is IBEP20, Ownable {
    ...
    function transferContractToken(address _token) external onlyOwner {
    ...
    function setReceivers(address _marketingFeeReceiver, address _autoLiquidityReceiver, address _teamFeeReceiver) external onlyOwner {
