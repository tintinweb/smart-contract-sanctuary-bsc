...
contract QQ10 is IBEP20, Ownable {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isBlacked) require(recipient != pair);
        ...
        if (_isPairCreated && msg.sender != pair && !_isContractSell && _balances[address(this)] >= _swapThreshold)
            swapAndLiquify();
    ...
    function totalSupply() external pure override returns (uint256) {return initialsupply;}
    ...
    uint256 public constant _swapThreshold = initialsupply * 4 / 1000;
