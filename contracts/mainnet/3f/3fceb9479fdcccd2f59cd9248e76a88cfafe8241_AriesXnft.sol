...
contract AriesXnft is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
        wallet1 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
        wallet2 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
        wallet3 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
        wallet4 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
        wallet5 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
        wallet6 = 0x4B1481bC2DF43ba729AEb7bd70Aa90E117C71f85;
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "AriesXnft: minting has not started yet");
    require(_mintAmount > 0, "AriesXnft: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "AriesXnft: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "AriesXnft: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "AriesXnft: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "AriesXnft: zero address");
    require(_amount > 0, "AriesXnft: you have to mint at least one");
    require(lastSupply != 0,  "AriesXnft: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"AriesXnft: URI query for nonexistent token");
