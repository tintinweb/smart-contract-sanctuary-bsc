...
contract KissanCn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kissan China";
    string private _symbol = "Kissan Cn";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xa40C03d1755c317B1680D936A71A2223F79aE626); 
