...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xDD1a10c29C6b181441c431dD3c4a690B69f3E100;
        _owner = msgSender;
...
contract ProjectX is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;

    address public BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public marketingAddress = 0xe69Fb7710Ab2B8666d515A905E5c503B403f2E40; // Marketing wallet Address.
    ...
    function setAllBuyFeePercent(uint256 marketingFee) external onlyOwner() 
    {
        ...
        require(_marketingFee<=20, "Too High Fee");
    }
