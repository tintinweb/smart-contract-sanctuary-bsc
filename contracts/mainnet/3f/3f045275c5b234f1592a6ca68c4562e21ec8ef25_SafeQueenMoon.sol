...
//SafeQueenMoon is the last mision of our honorable Queen Elisabeth II

// TG: T.me/safemoonqueen

// Tokenomics have an amazing feature that allow to trade with low fees and it increment with trading volume the sell taxes.
//Buy tax ALWAYS 0
...
pragma solidity ^0.6.12;
    ...
    contract SafeQueenMoon is Context, IERC20, Ownable {
        ...
        string private _name = 'SafeQueenMoon  ';
        string private _symbol = 'SafeQueenMoon';
        ...
        uint256 private _maxTxAmount = 40000000000e9;
