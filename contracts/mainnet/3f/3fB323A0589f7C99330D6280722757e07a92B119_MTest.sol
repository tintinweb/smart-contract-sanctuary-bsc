...
contract MTest is IBEP20 {
    ...
    event ExcludedFromMaxWallet(address account, bool status);
    ...
    constructor() {
        ...
        excludedFromMaxWallet[address(pair)] = true;
...
/////////////////// ADMIN FUNCTIONS ///////////////////////////////////////////////////////////////////////
    ...
    function oneTimePause() external onlyOwner {
        ...
        require(enabledCounter < 3, "Cannot disable traiding again!"); // this will kill the possibility to disabled it again
        if(enabledCounter < 3 && enabledCounter >= 1) {
            enabled = !enabled; 
            enabledCounter+= 1;
        }
    }
    ...
    function toggleExcludedFromMaxWallet(address account) external onlyOwner {
        excludedFromMaxWallet[account] = !excludedFromMaxWallet[account];
        emit ExcludedFromMaxWallet(account, excludedFromMaxWallet[account]);
    }    
