...
contract OPP is Context, IERC20, Ownable {
    ...
    string private _name = "Ordinal Paw Patrol";
    string private _symbol = "OPawP";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x3E9627f15d6DABe5bde1D766db8ea9E9725AD2E3); // Marketing Address
    address payable public BuyBackWallet = payable(0x3E9627f15d6DABe5bde1D766db8ea9E9725AD2E3); // Team Address
