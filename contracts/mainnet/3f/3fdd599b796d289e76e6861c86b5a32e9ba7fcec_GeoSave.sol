...
contract GeoSave is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 350000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    string private _name = "GeoSave";
    string private _symbol = "GEOS";
    ...
    address public _devWalletAddress =
        address(0x69c4E1490adfDa75F1cbe85d6e02211a7e1cc995);
    ...
    //Etherum
    // Uniswap Router Rinkeby Testnet -> 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    // Pancake Router Mainnet -> 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    uint256 public _maxTxAmount = ((_tTotal * 5) / 1000) * 10**_decimals;
    uint256 public numTokensSellToAddToLiquidity =
        ((_tTotal * 5) / 10000) * 10**_decimals;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        require(taxFee >= 0 && taxFee <= 5, "Invalid tax fee");
        _taxFee = taxFee;
    }

    function setDevFeePercent(uint256 devFee) external onlyOwner {
        require(devFee >= 0 && devFee <= 5, "Invalid tax fee");
        _devFee = devFee;
    }

    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee >= 0 && liquidityFee <= 5, "Invalid tax fee");
        _liquidityFee = liquidityFee;
    }

    function setMaxTxPercent(uint256 maxTxPercent) public onlyOwner {
        require(maxTxPercent > 0, "Invalid Tx Percent");
    ...
    function setNumTokensSellToAddToLiquidity(uint256 amountToUpdate)
        ...
        onlyOwner
    {
        require(amountToUpdate >= 10**_decimals, "Invalid number");
