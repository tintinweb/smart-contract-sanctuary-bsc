...
// TELEGRAM: HTTPS://T.ME/OFFICIAL_ANGELDUST
...
contract ANGELDUST is ERC20, Ownable{
    ...
    Taxes private taxes = Taxes(4,1,3);
    ...
    constructor(address _marketingWallet, address _devWallet) ERC20("Angel Dust", "ANGELDUST") {
