...
contract SPYN is Context, IERC20, Ownable, Pausable {
    ...
    uint256 public mevCooldownTime = 3 minutes;
    ...
    function setMevCooldownTime(uint256 cooldownTime) external onlyOwner {
        require(cooldownTime < 30 minutes, "cooldown must less than 30 mins");
        mevCooldownTime = cooldownTime;
    }
    ...
    */
    ...
    function _afterTokenTransfer(
		...
		if (_cooldownWhitelist[to] != true) {
			...
			_cooldowns[to] = uint32(block.timestamp + mevCooldownTime);
		}
	}
