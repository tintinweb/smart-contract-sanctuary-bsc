...
// File contracts/rarecatfnd.sol
pragma solidity ^0.8.0;

contract RareFNDCAT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 325_000_000 * 10**_decimals;
    ...
    string private constant _name = "RareCAT FND";
    string private constant _symbol = "RCFND";
