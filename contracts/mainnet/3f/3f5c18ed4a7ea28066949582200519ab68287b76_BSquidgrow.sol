...
contract BSquidgrow is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Squidgrow";
    string constant _symbol = "BSquidgrow";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x76B8Cd470414fDa347cfB4D4a87e1f0b392e4257; 
        devWallet = 0x8dB3e628267541F261CbBFf9f23B0FFaDa142CBA; 
