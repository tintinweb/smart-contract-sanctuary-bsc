...
/**
     ...
     TO STAR TO STAR
     TO STAR TO STAR
     Listing on Pancakeswap - Fair Launch  
     Tax      :1/2 LOW TAX
     TelgeGram:https://t.me/ToStartBsc
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "To Star";
    string private _symbol = "To Star";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2FFD9d39D767162FA35034999f5431b2FAd42728);
    address payable public teamWalletAddress = payable(0x2FFD9d39D767162FA35034999f5431b2FAd42728);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!startEnable){
            require(sender == owner() || recipient == owner(), "no start");
        }
