...
Orchid is designed to offer complete 
interoperability between both the orchid.
Interoperability is not limited to digital
assets as it also includes cross-chain
interoperability for data sets. Data can be 
shared across different types of blockchains,
including private, permissioned and public chains

Telegram : https://t.me/Orchid_Chain
Website : http://orchidchain.live
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1519C1DA302cE8B908D513cD89F8144270736f8D;
...
contract OrchidChain is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x1519C1DA302cE8B908D513cD89F8144270736f8D);
    ...
    */
    ...
    string private _name = "OrchidChain"; 
    string private _symbol = "Orchid";  
