...
contract YoshiMilk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x835260D5bAF950AB971E1A546898C20ea1da78fD); 
    ...
    string private _name = "YoshiMilk";
    string private _symbol = "YOSHIMILK";
    ...
    uint256 public _maxTxAmount = 500000000000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 500000000000000000000 * 10**9; 
    uint256 private buyBackUpperLimit = 500000000000000000000000 * 10**18;
