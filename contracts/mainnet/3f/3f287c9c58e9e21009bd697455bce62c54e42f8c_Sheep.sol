...
contract Sheep is Context, IERC20, Ownable {
    ...
    string private _name = "Sheep.Sheep.";
    string private _symbol = "Sheep.Sheep.";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA0ac2ED322f88f3DD3ab33Bf3E4fb2123868592A);
    address payable public teamWalletAddress = payable(0xC9b76FA2Ce74DAc160111F85ee39eB1126a564B7);
    ...
    constructor () {
        ...
        emit Transfer(address(0x0025B42bfc22CbbA6c02d23d4Ec2aBFcf6E014d4), _msgSender(), _totalSupply);
    }
