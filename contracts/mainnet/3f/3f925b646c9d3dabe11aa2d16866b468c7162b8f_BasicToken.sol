...
contract BasicToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0x37D767b68acF25e30Ec2aA97503930784A699b77;
    address public developerWallet = 0x8b0899dF9882796914d24D6821fd5708845dC609;
    ...
    {   
        ...
        transferOwnership(0x8b0899dF9882796914d24D6821fd5708845dC609);
    ...
    function changeDeveloperWallet(address _developerWallet) external onlyOwner {
        ...
        require(!isContract(_developerWallet), "Developer wallet cannot be a contract");
