...
contract TimeLock is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 1800 seconds;
    ...
    string private constant _name = "Time Lock";
    ...
    Taxes public taxes = Taxes(0, 6, 4, 2, 0);
    Taxes public sellTaxes = Taxes(0, 8, 5, 3, 0);
