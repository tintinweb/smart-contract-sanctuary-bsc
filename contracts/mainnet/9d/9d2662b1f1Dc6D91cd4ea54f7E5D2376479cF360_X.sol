...
contract X {
  ...
  address private constant WETH = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
  // Pancake V2 Router
  ...
  constructor() public {
    owner = msg.sender;  
    //testFlashSwap(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c,427922589285278232);
  ...
  function testFlashSwap(address _tokenBorrow, uint _amount) external {
    ...
    token.approve(address(FACTORY), _amount);
