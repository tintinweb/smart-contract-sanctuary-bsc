...
//
//Welcome to the most profitable Yacht Club. The Trump's Yacht Club.Launching at 100 members join tg :https://t.me/trumpsyachtclub
...
contract TRUMPYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TRUMP'S YACHT CLUB";
    string private _symbol = "tg:trumpsyachtclub";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0x184688FdBA6639f0f1Ca0D1c964B6CC75E3619B9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x184688FdBA6639f0f1Ca0D1c964B6CC75E3619B9); // BuyBack Address
