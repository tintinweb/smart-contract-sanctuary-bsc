...
contract HealthHero is HealthHeroDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private HealthHeroTeam;
    address private CharityHealthHero;
    ...
    string public override name = "Health Hero";
    string public override symbol = "HealthHero";
    ...
    constructor(uint totalSupplyValue, address HealthHeroTeamAddress, address CharityHealthHeroAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        HealthHeroTeam = HealthHeroTeamAddress;
        CharityHealthHero = CharityHealthHeroAddress;
       
        // split the tokens according to agreed upon percentages
        balances[HealthHeroTeam] =  totalSupply * 4 / 100;
        balances[CharityHealthHero] = totalSupply * 45 / 100;
