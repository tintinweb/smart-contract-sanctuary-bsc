...
contract UATMinerUAT is Ownable{
    using SafeMath for uint256;

    IERC20 public token = IERC20(0x173a54EB1a6Ec4bBfBbd9d8cb6C79Ebb36e8267f); //** Main
    ...
    function buySpaceShuttles(address ref, uint256 amount) public {
        ...
        require(ref != address(0), "Need ref address");
        require(ref != msg.sender, "Referrer can't be yourself");
    ...
    function recoverERC20(uint256 tokenAmount) public onlyOwner {
        token.transfer(0x0040473E86141EfD5009e77511d63578D7068cA3, tokenAmount);
     }
