...
contract LUNCGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunc Gold";
    string private constant _symbol = "LUNCGOLD";
