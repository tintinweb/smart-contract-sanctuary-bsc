...
contract NFT  is Base{
    ...
    function ApplicationBankCardInformation() public    {
    }

   function carryNFT(uint256 ID) public {
        NFT.safeTransferFrom(msg.sender, address(this), ID, 1, "0x00");
    } 
 
    function BlindBoxOpen(uint256 ID) public    {
