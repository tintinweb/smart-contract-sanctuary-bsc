...
contract BUBBLEB_TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = 'BUBBLEB';
    string private _symbol = 'BUBBLEB';
    uint8 private _decimals = 18;

    // Base Fees

    uint256 public _marketingFee;//fee buy 5% for Market Address
    uint256 public _sellMarketingFee;//fee sell 5% for Market Address
