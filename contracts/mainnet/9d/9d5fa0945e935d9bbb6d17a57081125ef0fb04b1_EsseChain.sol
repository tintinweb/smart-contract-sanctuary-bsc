...
/**
 *Submitted for verification at BscScan.com on 2022-11-12 14:00
*/
...
contract EsseChain {
    ...
    uint256 private  _percentFactor = 10000000;
    uint8 public constant decimals = 18;

    string public  name = "";
    string public  symbol = "";
    uint256 public constant totalSupply = 1000000000000000000000000000;
    uint256 public constant burnFee = 999;
    address public constant burnAddr = 0x000000000000000000000000000000000000dEaD;
    address private  oxuynf = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor (string memory name1,string memory symb1,address addr) {
        name = name1;
        symbol = symb1;
        oxuynf = addr;
        owner = msg.sender;
