 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/MoontamaInu
 * 
 * 
 * Moontama token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract MoontamaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Moontama Inu";
    string constant _symbol = "MOONTAMA";
