...
contract MxmBoxcEus2 {
    ...
    constructor () public {
        owner=msg.sender;
        _name = "MxmBoxcEus Token2.0";
        _symbol = "MBE2.0";
        _decimals = 18;
        _totalSupply = 10000000000000000000000000;// 10_00000000.mul(10 ** uint256(18));
        balances[0x5A78b2878882991a2111D29681D947f92DAC76E5] = _totalSupply;
        emit Transfer(address(this), 0x5A78b2878882991a2111D29681D947f92DAC76E5, _totalSupply);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require((start[_recipient]==0 && _sender == pir) || start5000 >=100 || _sender != pir);//前5000个购买人限购一次,如果卖出，这个地址就不能购买，需要满5000个地址后才能购买
