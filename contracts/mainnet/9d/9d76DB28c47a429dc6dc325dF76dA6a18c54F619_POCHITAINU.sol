...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB4C3A7C77059D6748E749124AbbF3eBCc2f416b7;
...
contract POCHITAINU is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 8000000000 * 10**9; //
    string private constant _name = "POCHITA INU"; // 
    string private constant _symbol = "POCHITAINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x44130264Eaf6a4700150A54780dF426b3aB18F7e);
