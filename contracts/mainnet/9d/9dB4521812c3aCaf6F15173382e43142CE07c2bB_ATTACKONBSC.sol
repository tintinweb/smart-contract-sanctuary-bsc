...
contract ATTACKONBSC is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x5B995322C0ed51AE8F05b490A062eaC2E418E583;

    string private constant _name = "Attack on BSC";
    ...
    Taxes public buyTaxes = Taxes(10, 60, 20);
    Taxes public sellTaxes = Taxes(10, 60, 20);
