...
XIBEX is a new meme project that intends to combine the powers of two strong projects 
that have been sold out by Vitalik.

💹 Telegram https://t.me/IBEXIN
...
contract XIBEX is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000000000 * 10**3 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'X IBEX';
    string private _symbol = 'XIBEX';
