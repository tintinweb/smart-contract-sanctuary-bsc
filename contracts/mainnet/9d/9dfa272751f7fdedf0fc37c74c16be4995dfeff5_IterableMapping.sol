...
contract AventisToken is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   MTKDividendTracker public dividendTracker;
    ...
    uint256 public _BuyETHRewardsFee = 0;
   ...
   // uint256 public extraFeeOnSell = 0;
    ...
    uint256 public _SellETHRewardsFee = 0;
    ...
    address public _marketingWalletAddress = 0x82Ac3208fA60E5A8A3eA15e5424e22680e598cD3;
    address public _developmentWalletAddress = 0x2ca70D64858F307Cf7307A34281D2a3e16871021;
    ...
    constructor() ERC20("Aventis Token", "AVNTS") {

    	dividendTracker = new MTKDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        MTKDividendTracker newDividendTracker = MTKDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ERC20: The new dividend tracker must be owned by the MTK token contract");
...
contract MTKDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MTK contract.");
    }
