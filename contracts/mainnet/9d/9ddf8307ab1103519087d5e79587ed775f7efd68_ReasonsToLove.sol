...
contract ReasonsToLove is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ReasonsToLove";
    string private _symbol = "$ELONTWEET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc4898744a6aa0512C0DC68cc6Be13c6b71be5E87); 
    address payable public buyBackWalletAddress = payable(0x3217693cFc05472107085ae58d4486d907B61800); 
