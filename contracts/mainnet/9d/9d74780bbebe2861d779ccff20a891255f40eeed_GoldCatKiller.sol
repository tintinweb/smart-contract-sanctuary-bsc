...
contract GoldCatKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldCatKiller";
    string private _symbol = "GoldCatKiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e9A3C54de64a3FBDbD78E83486d5d23E9Fc3030);
    address payable public teamWalletAddress = payable(0x5e9A3C54de64a3FBDbD78E83486d5d23E9Fc3030);
