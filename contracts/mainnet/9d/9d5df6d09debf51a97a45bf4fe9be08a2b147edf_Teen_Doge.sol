...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa251999173BD8EaDAAd295AB9543b9833E51DeE3; // owner address
...
contract Teen_Doge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teen Doge";
    string private _symbol = "$TDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa251999173BD8EaDAAd295AB9543b9833E51DeE3); // Marketing Address
    address payable public teamWalletAddress = payable(0xa251999173BD8EaDAAd295AB9543b9833E51DeE3); // Team Address
