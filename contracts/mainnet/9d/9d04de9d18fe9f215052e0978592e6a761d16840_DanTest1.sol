...
contract DanTest1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DanTest1DividendTracker public dividendTracker;
    ...
    constructor() ERC20("DanTest1", "DT1") {
        ...
        dividendTracker = new DanTest1DividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(moonshotBuy <= 6 && moonshotSell <= 6, "Moonshot fees can't exceed 6%");
        buyDeadFees = deadBuy;
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 burntokens = amount.mul(deadFees) / 100;
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0 && sellRewardsFee > 0) {
...
contract DanTest1DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DanTest1 public DanTest1Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        DanTest1Contract = DanTest1(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DanTest1_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DanTest1_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DanTest1 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DanTest1Contract);

            uint256 prevBalance = DanTest1Contract.balanceOf(address(this));
            ...
            {
                uint256 received = DanTest1Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DanTest1Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
