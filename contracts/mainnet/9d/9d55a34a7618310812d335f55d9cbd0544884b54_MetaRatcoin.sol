...
/*
HODL and earn $BUSD  every hour with crazy reflection rate of $METARAT every hour.
High selling tax for the first hour that made paperhand rekt and give us crazy reflection.
Tokenomics: 
2 % busd reflection
2% marketing 

https://t.me/metaratcoin
...
contract MetaRatcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "META RATCOIN";
    string constant _symbol = "MetaRat";
