...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x1a972bD1a898693FDd8b356c0580DA9F024d8A36;
        address seeFundAddress = 0x4df8Ac61b05568EA5959232027DB5Ee15E842b63;
...
contract MomTaste  is AbsToken {
    constructor() AbsToken(
      ...
      3888000000000 ,
        ...
        address(0x4A492d7893350e2248950aFaDd48d6858585A83E), 
        
        
        address(0x7D88EEefA3796b17C0fe0D2c188462e5DACAf908) 
    ){
