...
/**
 *Submitted for verification at BscScan.com on 2022-1-17
*/
...
contract Token is Context, Ownable, IERC20 {
    ...
    string private _name = "Dogekingkiller";
    string private _symbol = "Dogekingkiller";
    
    address public deloyer = 0x0FBf40549965a9E498E8Aaf954202eD9B59E5080;  // deployer address
    address public market = 0x27259a7dc965ebCdC144519981CE86386417C9Ec;  // market address
    address public burn = 0x0bfb74607fb0Bd98BF15f250FB313FEe1AcD941D;  // burn address
    ...
    uint public buyBurnTax = 0;

    uint public denominatorSell = 100;
    uint public sellMarketTax = 10;
    uint public sellBurnTax = 0;
