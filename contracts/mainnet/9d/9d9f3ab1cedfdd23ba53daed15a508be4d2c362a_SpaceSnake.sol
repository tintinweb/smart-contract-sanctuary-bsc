...
Earn 3% rewards by a safu contract dev
...
contract SpaceSnake is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xBda8e56da18dE4Ed1082e1A40649d0855C68d635); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5B6C783C4901C23AA4c9dB061db001463cF6D2AD); // Team Address
        
    address payable public liquidityAddress =
        payable(0xBda8e56da18dE4Ed1082e1A40649d0855C68d635); // Liquidity Address
    ...
    string private constant _symbol = "SpaceSnake";
