...
abstract contract ABSToken is ERC20, Ownable {
    ...
    constructor(
        ...
        address DevWallet_,
        uint256 buySlippage_,
        uint256 sellSlippage_,
        bool liquidityRestrictionEnabled_,
        address liquidityRestrictor_
    ) ERC20(name_, symbol_) {
        _mint(msg.sender, amount_ * 10**decimals());
        setLiquidityRestrictor(liquidityRestrictor_);
        setLiquidityRestrictionEnabled(liquidityRestrictionEnabled_);
        setRouter(router_);
        setMarketingWallet(MarketingWallet_);
        setDevWallet(DevWallet_);
        setBuySlippage(buySlippage_);
        setSellSlippage(sellSlippage_);
        setUsdt(usdt_);
        setPair();
    ...
    function setLiquidityRestrictor(address addr) public onlyOwner {
        liquidityRestrictor = ILiquidityRestrictor(addr);
    }

    function setLiquidityRestrictionEnabled(bool flag) public onlyOwner {
        liquidityRestrictionEnabled = flag;
    }
    ...
    function setPair() public onlyOwner {
        ...
        address pair = swapFactory.getPair(address(this), usdt);
        if (pair == address(0)){
...
contract BabyDogeCoin is ABSToken {
    constructor()
        ABSToken(
            "Baby Doge Coin",
            "BabyDoge",
            ...
            0x66beCc455f73c284414d5087BCd4737327ac773a,
            0xB6DE4e6e14E2c814081Af04A1252d5A230cd7905,
            3,
            3,
            true,
            0x02636b48Ff8Ef3d48b2C1786330E7BA227f02694
        )
    {}
}