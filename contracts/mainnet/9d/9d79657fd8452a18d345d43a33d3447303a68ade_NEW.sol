...
//Telegram : https://t.me/NewRoninInuofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Db03d398BB2dc2d27BAfa8E7Ac5e745013FddC3;
...
contract NEW is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEW RONIN INU"; // 
    string private constant _symbol = "$NRON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x1f10B1F0847c27f2313BEf20F0344804395F8853);
