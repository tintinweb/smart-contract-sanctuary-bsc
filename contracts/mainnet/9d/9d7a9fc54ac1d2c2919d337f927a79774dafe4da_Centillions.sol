...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc71E1fa403b965F89008F8D6151212bdE9b26778;
...
contract Centillions is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0202a3230286924c771ec356aC5333CB982B4D3b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1303 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Centillions";
    string private _symbol = "CENTS";
