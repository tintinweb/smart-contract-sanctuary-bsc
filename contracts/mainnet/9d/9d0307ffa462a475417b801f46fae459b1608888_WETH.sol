...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public partnerAddress = address (0x4D3A5302d3532aa8b863101B2c8E3aC4E372FC46);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (takeFee) {
            ...
            if (partnerFeeAmount > 0) {
                ...
                _takeTransfer(sender, partnerAddress, partnerFeeAmount);
            }
        }
    ...
    function setPartnerAddress(address addr) external onlyWhiteList {
        partnerAddress = addr;
        _feeWhiteList[addr] = true;
    }
