...
contract SHINDO is Context, IERC20, Ownable {
    ...
    string private _name = "Shindo";
    string private _symbol = "SHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6dB554cD7C57a3470CBC5EE609f0bE48115A4675); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xEE1D29Eb120A12a5241bf53e77bD7b04AEe4a0dd); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**9 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
