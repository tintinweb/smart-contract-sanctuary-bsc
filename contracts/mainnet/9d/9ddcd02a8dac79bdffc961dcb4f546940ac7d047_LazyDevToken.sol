...
// No I wont make a tg ( at first), maybe if you jeets deserve it...
// will lock the lp and lock longer, if you jeets deserve it...
// Will Renounce the contract cuz i'm no bitch ass scammer.
// 3% lp fee
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7610D33f1C788214d1dcbe27558bB2D7D59FE280;
...
contract LazyDevToken is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0x7610D33f1C788214d1dcbe27558bB2D7D59FE280);
    ...
    */
    ...
    string private _name = "Lazy Dev Token"; 
