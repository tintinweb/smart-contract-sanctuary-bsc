...
// PIGLET INU Mostly due to his small size and flimsiness, Piglet is an incredibly timid, fragile, and insecure animal. He apparently suffers from anxiety and is often seen cowering in fear in even the tamest moments. Piglet also has a speech impediment that causes him to stutter.
...
contract PIGLETINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x168B9e80817b5612ef436f41e75fDcf61c2853d1); 
    address payable public Wallet_Dev = payable(0x168B9e80817b5612ef436f41e75fDcf61c2853d1);
    ...
    string private constant _name = "Piglet Inu"; 
    string private constant _symbol = unicode"Pignu"; 
    ...
    constructor () {
        ...
        _owner = 0x168B9e80817b5612ef436f41e75fDcf61c2853d1;
