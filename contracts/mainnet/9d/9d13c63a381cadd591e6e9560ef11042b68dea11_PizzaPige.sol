...
contract PizzaPige is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pizza Pige";
    string private _symbol = "PP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb77E1Bd7b82802968E3b6cfc5A19069C1FbfdE68); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb77E1Bd7b82802968E3b6cfc5A19069C1FbfdE68); // BuyBack Address
