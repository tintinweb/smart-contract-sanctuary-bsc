...
contract Token is ERC20, Ownable {
	...
	function setSourceModel(bool _isSource) public onlyOwner{
	    isSource = _isSource;
	}
    ...
    function _transfer(
        ...
        if( canSwap &&
			...
			if(isSource) {
				...
				if(AmountMarketingFee > 0) swapAndSendToFee( AmountMarketingFee>swapTokensAtAmount?swapTokensAtAmount:AmountMarketingFee );
			    if(AmountLiquidityFee > 0) swapAndLiquify( AmountLiquidityFee>swapTokensAtAmount?swapTokensAtAmount:AmountLiquidityFee );
			    if(AmountTokenRewardsFee > 0) swapAndSendDividends( AmountTokenRewardsFee>swapTokensAtAmount?swapTokensAtAmount:AmountTokenRewardsFee );
			}
            swapping = false;
        }
...
contract BaiYanLang is Token{
    ...
    constructor() Token(
        ...
        "baiyanlang",
        1000000000000000,
        [address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43),address(0x10ED43C718714eb63d5aA57B78B54704E256024E),address(0x4B158fc9e74fa875DcbA9019E96aa8c9Ea709eac),address(0x8964173328bE9Bf59BeEfdbb8E40AbCA98eA4DcB)],
        [uint256(5),uint256(3),uint256(2),uint256(0)],   
        [uint256(5),uint256(3),uint256(2),uint256(0)],   
        500000000000*10**18
    ){
