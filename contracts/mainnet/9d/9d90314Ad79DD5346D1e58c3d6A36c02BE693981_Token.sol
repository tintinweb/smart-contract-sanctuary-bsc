...
contract Token is IERC20, Ownable {
    ...
    address private projectAddress = 0xa57F7A2A88Bb1f0e62573287b7B2EC724dc325Cf;
    ...
    uint256 public _projectAddressFee = 200;
    ...
    uint256 private numTokensSellToAddToLiquidity = 20 * 10**18;
    ...
    constructor() {
        _tOwned[0xA19025Ff4FD98b4E7489797D660F987647367B67] = _tTotal;
        ...
        _isExcludedFromFee[0xA19025Ff4FD98b4E7489797D660F987647367B67] = true;
        _isExcludedFromFee[0x7C2934C16b4bd9E64B6eF2e0567B1BbE19e60401] = true;
        _isExcludedFromFee[0x90495237064447d6c31d7Eef46Ae60787B1F45b8] = true;
        _isExcludedFromFee[0x2FC82351BE963E9C062B86716421448add9A4cA4] = true;
        _isExcludedFromFee[0x4fe2522750C3A6402Cf9cFc5a152455b82b1fe16] = true;
        ...
        emit Transfer(address(0), 0xA19025Ff4FD98b4E7489797D660F987647367B67, _tTotal);
    }
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFee[to]){
          require(amount <= balanceOf(uniswapV2Pair).div(1000)); 
          
        }

        if(!_isExcludedFromFee[to] && to != uniswapV2Pair){
            require(balanceOf(to)+amount <= 200 * 10 ** 9);
        }
 ...
 function swapForMarketing(uint256 tokens) private {
        ...
        payable(address(projectAddress)).transfer(WalletAddressBalance);
    }
    ...
    function _swap() private {
        uint256 swapFees = _projectAddressFee;
        uint256 contractTokenBalance = balanceOf(address(this));

        uint256 swapTokens = contractTokenBalance.mul(swapFees).div(_projectAddressFee + _LPFee);
