...
contract Comedy is Context, IERC20, Ownable {
    ...
    string private _name = "Comedy";
    string private _symbol = "Comedy";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x31317Ef90a8CBD287d9B65cF1B9D422DfCc938c1); 
    address payable public BurnedWalletAddress = payable(0x31317Ef90a8CBD287d9B65cF1B9D422DfCc938c1); 
