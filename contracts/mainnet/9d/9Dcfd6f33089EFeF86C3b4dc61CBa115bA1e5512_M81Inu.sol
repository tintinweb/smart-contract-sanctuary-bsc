...
M81 inu - Community driven token with organic members based on M30 token name with different functions. 

Marketing Plan  : 4Chan / Twitter / Telegram , will start at telegram post. 
Tokenomics : 3% Marketing 2%Liquidity (Slippage :5% for all transactions) $BOOM

Portal : https://t.me/M81Inu
...
*/
    ...
    contract M81Inu  is IBEP20, Ownable
    {
        ...
        string private constant _name = "M81 Inu";
        ...
        address public constant MarketingWallet=0x0a52a9be136C25e33d696029fD81Dd1d81ED8632; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AllowHolderStake(address[] calldata addresses) external onlyOwner {
