...
contract token is ERC20 {
    ...
    address public liquidAddress = 0xC992e4a9c300D8CC7e28da80eB927CDEBc155690;
    address public marketAddress = 0x6699297e974e6e2C2492e8645Ff112D76f963E15;
    ...
    string internal tokenName = "Magic rabbit";
    string internal tokenSymbol = "MagicRabbit";
    ...
    function setBuyFee(uint256 _lpFee,uint256 _marketFee, uint256 _burnFee, uint256 _liquidFee) public onlyOwner {
        blpFee = _lpFee;
    ...
    function setSellFee(uint256 _lpFee,uint256 _marketFee, uint256 _burnFee, uint256 _liquidFee) public onlyOwner {
        slpFee = _lpFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(from == uniswapV2Pair ){
                ...
                uint256 allFee = amount.div(1000).mul(blpFee + bliquidFee + bmarketFee);
                ...
                amount = amount.div(1000).mul(1000 - (blpFee + bliquidFee + bmarketFee + bburnFee));
                
            }else if(to == uniswapV2Pair){
                uint256 allFee = amount.div(1000).mul(slpFee + sliquidFee + smarketFee);
                ...
                LPCount = LPCount.add((allFee.sub(cmarketCount)).sub(cliquidCount));
                _takeInviterFee(amount.div(100000));
                amount = amount.div(1000).mul(1000 - (slpFee + sliquidFee + smarketFee + sburnFee));
