...
Jack O Lantern is the next grand meme token on the BSC from halloween, with simplistic tokenomics to maximize the success of the coin as well as reward our holders.
...
contract JackOLantern is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "JackOLantern INU";
    ...
    address public devFeeReceiver = 0x353aB01d51BF21fc2771b8E2B6585aaF6606757a;
    address public buybackFeeReceiver = 0x353aB01d51BF21fc2771b8E2B6585aaF6606757a;
