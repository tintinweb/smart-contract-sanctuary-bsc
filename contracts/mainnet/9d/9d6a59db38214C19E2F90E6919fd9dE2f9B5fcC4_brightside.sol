...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FV = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FV.balanceOf(address(this));
        ...
        uint256 amount = FV.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FV.transfer(shareholder, amount);
...
contract brightside is IBEP20, Auth {
    using SafeMath for uint256;

    address FV = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "bright side of life";
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10000; // 0.01% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5C84942b2Ee71e911859E8cc63E0B46dddca0A4e;
