...
contract SafeLunan is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Safe Lunan";
    string constant _symbol = "SafeLunan";
    ...
    address public devFeeReceiver = 0xdafb7E4A453CDffEAb81db68A412e9926D7be55F;
    address public buybackFeeReceiver = 0xdafb7E4A453CDffEAb81db68A412e9926D7be55F;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(launchedAtT != 0) {
            if(block.timestamp >= (launchedAtT + 600)){
                tradingOpen = false;
            }
        }else {
