...
contract LuckyFlokiKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyFlokiKing";
    string private _symbol = "LuckyFlokiKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x36Ed9b5de5F457F2c78d65e9f8d02837a9731fBC); // Marketing Address
    address payable public teamWalletAddress = payable(0x0730e0EE9eE50A14135424a2e977F48677018795); // Team Address
    address public immutable deadAddress = 0x300D282874892dcaB3AFe182075328C51eC50a83;
