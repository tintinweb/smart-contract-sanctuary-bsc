...
contract SULTANSHIBA is Context, IERC20, Ownable {
    ...
    address private _owner = 0x63527907f1744d68DA89C8f878dE7f63b5aDC53f; //owner of the contract
    ...
    string private constant _name = "SULTAN SHIBA";
    ...
    uint256 public maxAmountCanBuy = 1e6;

    uint256 public _buyTaxFee = 0;
    uint256 public _buyLiquidityFee = 0;
    uint256 public _buyMarketingFee = 6; //6%
    
    uint256 public _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 6; //6%
    
    uint256 public tradingActiveBlock = 0; // 0 means trading is not active
    mapping(address => bool) public boughtEarly; // mapping to track addresses that buy within the first 2 blocks pay a 3x tax for 69 minutes to sell
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 100 * 80;//
        _rOwned[address(this)] = _rTotal / 100 * 20;
         
        _maxTransactionAmount = _tTotal * 1 / 100; // 1% max trx 
        _maxWalletAmount = _tTotal * 2 / 100; // 2% max Wallet
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05 swap tokens amount
        
        marketingAddress = payable(0x9339C66b12657F0b3172EBd0d7f2E17544534430);
        
        devAddress = payable(0x63527907f1744d68DA89C8f878dE7f63b5aDC53f);
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 80 / 100);
        emit Transfer(address(0), address(this), _tTotal * 20 / 100);
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing *  1 / 10;
