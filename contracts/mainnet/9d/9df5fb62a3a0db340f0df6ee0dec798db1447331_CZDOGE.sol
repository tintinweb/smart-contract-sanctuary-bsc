...
contract CZDOGE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CZ Doge";
    string private constant _symbol = unicode"CZDOGE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xfeB50A1950B7876aaB7AaeeeB1136C92867380f2);
    address payable public MarketingWallet = payable(0x318ab7d081aC6999A927fAEba170241d2E6c00bD);
