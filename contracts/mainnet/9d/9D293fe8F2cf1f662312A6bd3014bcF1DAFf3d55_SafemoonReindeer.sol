...
Telegram :     https://t.me/SafemoonReindeerBsc
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c8496ded16E2a2C0AAA761cE2B5A6286CcDd5cB;
...
contract SafemoonReindeer is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon Reindeer"; // 
    string private constant _symbol = "SMR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x8c8496ded16E2a2C0AAA761cE2B5A6286CcDd5cB);
