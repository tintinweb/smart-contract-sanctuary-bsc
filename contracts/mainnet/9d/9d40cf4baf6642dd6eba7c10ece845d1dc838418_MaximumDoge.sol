...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x307F616934eea89f92722D8da9D6578c194fdD7E; 
...
contract MaximumDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Maximum Doge";
    string private _symbol = "MAXDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58869D676854AD63821a540E586C20B3D2F0383b); 
    address payable public teamWalletAddress = payable(0x307F616934eea89f92722D8da9D6578c194fdD7E); 
