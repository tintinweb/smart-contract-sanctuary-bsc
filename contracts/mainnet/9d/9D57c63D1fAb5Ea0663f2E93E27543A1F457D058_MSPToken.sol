...
contract MSPToken is Context, IBEP20, AccessControlEnumerable {
 ...
 /**
  ...
  function mintTo(address _recipient, uint256 amount) public onlyRole(MINTER_ROLE) returns (bool) {
