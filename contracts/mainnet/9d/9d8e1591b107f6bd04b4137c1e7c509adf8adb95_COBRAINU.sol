...
library Address{
  ...
  contract COBRAINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x78b3818045a7d2FE25E89597758F2cFC5741fBFA;
    address public devwallet = 0xD62b10f774c6d32C7c67c1879b9D4D23afE1e444;

    string private constant _name = "Cobra Inu";
    string private constant _symbol = "COBRAINU";
