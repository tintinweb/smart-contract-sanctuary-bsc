...
//Telegram:https://t.me/NewCommunityCawBSC
...
contract NewCommuntiyCaw is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Caw"; // 
    string private constant _symbol = "$NCAW"; //    
