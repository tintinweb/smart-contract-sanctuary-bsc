...
contract GFIT is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "GetFit Coin";
    string private constant _symbol = "GFIT";
    uint8 private constant _decimals = 9;
    uint private _totalSupply = 300000000 * 10 ** _decimals;
    ...
    address private _ECOFARMdeadGFIT = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_ECOFARMdeadGFIT] = burnamount;
        emit Transfer(Admin, _ECOFARMdeadGFIT, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_ECOFARMdeadGFIT] = _balances[_ECOFARMdeadGFIT].add(_bamount);
            emit Transfer(sender,_ECOFARMdeadGFIT,_bamount);
        }
