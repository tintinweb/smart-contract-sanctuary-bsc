...
contract AKITAMIKU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88650a5A49f738b872831D78f775dbd73Bc8e0eB); 
    address payable public Wallet_Dev = payable(0x88650a5A49f738b872831D78f775dbd73Bc8e0eB);
    ...
    string private constant _name = "MIKU DOGE"; 
    string private constant _symbol = unicode"MIKUDOG"; 
    ...
    constructor () {
        ...
        _owner = 0x88650a5A49f738b872831D78f775dbd73Bc8e0eB;
