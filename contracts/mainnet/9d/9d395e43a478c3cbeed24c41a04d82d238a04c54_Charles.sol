...
contract Charles is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xcD08229823f12957A93d7712aca120A9f1c004b1); // Marketing Address
    address payable public teamWalletAddress = payable(0xcD08229823f12957A93d7712aca120A9f1c004b1); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xcD08229823f12957A93d7712aca120A9f1c004b1),
            block.timestamp
        );
    }
