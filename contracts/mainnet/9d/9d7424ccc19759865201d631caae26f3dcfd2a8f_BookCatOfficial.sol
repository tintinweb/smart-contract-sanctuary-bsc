...
contract BookCatOfficial is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Book Cat";
    string private _symbol = "BC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83FB48bced725EFB2a7E2a1eE77ADf4E0e788Cd2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x83FB48bced725EFB2a7E2a1eE77ADf4E0e788Cd2); // BuyBack Address
