...
contract Test is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xc6251cc2515EA5E3175b135AD528b9B9e07f2Eb1;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xc6251cc2515EA5E3175b135AD528b9B9e07f2Eb1] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xc6251cc2515EA5E3175b135AD528b9B9e07f2Eb1] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xc6251cc2515EA5E3175b135AD528b9B9e07f2Eb1,
                block.timestamp
            );
