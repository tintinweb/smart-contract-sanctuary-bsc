...
contract de is IERC20 {
    ...
    string constant private _name = "de";
    string constant private _symbol = "de";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        tokens: 0x807fED738Ea0aC3b6ff76F3700317C5dFDbcEA2D,
        swap: payable(0x807fED738Ea0aC3b6ff76F3700317C5dFDbcEA2D)
        });
