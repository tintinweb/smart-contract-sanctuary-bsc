...
contract Lucky is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax = 260000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 260000 * 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5fC00d0BFc3f0De948bF977DF63128EAe98Fe85A));
