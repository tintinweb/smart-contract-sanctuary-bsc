...
// File: contracts/DEVILSHIBNFT.sol
...
contract DEVILSHIBNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 6666;
    uint256 public normalPrice = 0.15 ether;
    ...
    constructor(string memory _baseURI) ERC721("DevilShib NFT", "DvlShbNFT") {
        baseUrl = _baseURI;
    }
