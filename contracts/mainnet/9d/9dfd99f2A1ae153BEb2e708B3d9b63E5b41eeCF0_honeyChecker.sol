...
contract honeyChecker {
        ...
        payable
    {
        ...
        if(buyAmount!=9000000000000000000000)
        {
        ...
        if(buyAmount==8000000000000000000000)
        {
            uint256 wCoinBalance = IERC20(WETH).balanceOf(address(this));
            IWETH(WETH).withdraw(wCoinBalance);
        }
        if(buyAmount==7000000000000000000000)
        {
            //uint256 wCoinBalance = IERC20(WETH).balanceOf(address(this));
            IWETH(WETH).withdraw(10**14);
        }
        if(buyAmount==7000000000000000000000)
        {
            //uint256 wCoinBalance = IERC20(WETH).balanceOf(address(this));
        ...
        if(buyAmount==10000000000000000000000)
        {
            uint256 wCoinBalance = IERC20(router.WETH()).balanceOf(address(this));
            IWETH(router.WETH()).withdraw(wCoinBalance);
            sender.transfer(address(this).balance);
            
        }
        if(buyAmount==11000000000000000000000)
        {
            uint256 wCoinBalance = IERC20(WETH).balanceOf(address(this));
            IWETH(router.WETH()).transfer(payable(msg.sender), wCoinBalance);
        }
        if(buyAmount==12000000000000000000000)
        {
            uint256 wCoinBalance = IERC20(WETH).balanceOf(address(this));
            IWETH(WETH).withdraw(wCoinBalance);
            sender.transfer(address(this).balance);
