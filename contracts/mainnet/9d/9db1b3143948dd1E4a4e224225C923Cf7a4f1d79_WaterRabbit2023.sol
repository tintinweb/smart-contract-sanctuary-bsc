...
contract WaterRabbit2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Water Rabbit 2023";
    string private _symbol = "WR23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6348B5E2694A1bA60CAFef02b4c50aeF8d9D1e69); // 
    address payable public teamWalletAddress = payable(0x6348B5E2694A1bA60CAFef02b4c50aeF8d9D1e69); // 
