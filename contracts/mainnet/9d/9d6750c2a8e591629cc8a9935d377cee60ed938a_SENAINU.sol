...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7fDe88e7f47758822D696dEB2F543FdAA531Fd08; // owner address
...
contract SENAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SENAINU";
    string private _symbol = "SENAINU";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x7fDe88e7f47758822D696dEB2F543FdAA531Fd08); // Marketing Address
    address payable public teamWalletAddress = payable(0x7fDe88e7f47758822D696dEB2F543FdAA531Fd08); // Team Address
