...
contract FpulseG0ES2Staker is ReentrancyGuard, Ownable {
    ...
    constructor(IERC721 _nftCollection, IERC20 _rewardsToken, uint256 _rewardsPerHour) {
        ...
        emit StakeRewardUpdated(rewardsPerHour);
    }
    ...
    event StakeRewardUpdated(uint256 rewardsPerHour);
    ...
    //setters//
    //////////
    function changeRewardsPerHour(uint256 _rewardsPerHour) external onlyOwner {
        rewardsPerHour = _rewardsPerHour;
    ...
    function _adminSupport(uint256 tokenId) external onlyOwner {
        ...
        // Wallet must own the token they are trying to withdraw
        require(stakerAddress[tokenId] == msg.sender, "You don't own this token!");
