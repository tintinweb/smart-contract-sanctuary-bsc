...
contract BitCoke is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BitCoke";
    string private _symbol = "BitCoke";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x74092a2457fbC3DA53DE326f6D2B3bC4a55bf616); 
    address payable private teamWalletAddress = payable(0x89e1bC5Dd2F11884d351C53de6C1a2cb78DbB582); 
