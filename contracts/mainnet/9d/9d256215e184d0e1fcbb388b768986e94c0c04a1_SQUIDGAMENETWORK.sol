...
/*
    GAME ON !
    Play degen with safe dev
    Diamond hands
    Early gems
    Get moonshot !

    https://t.me/SquidGameNetwork_Official
...
contract SQUIDGAMENETWORK is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;
  string private _name = "Squid Game Network";
  string private _symbol = "$SQUIDGAMENETWORK";
  uint8 private _decimals = 9;
  address payable public marketingWalletAddress = payable(0xb129Ce3965dE30CFB6a034285F559A177595078c); // Marketing Address
  address payable public DevelopmentWalletAddress = payable(0xb129Ce3965dE30CFB6a034285F559A177595078c); // Development Address
