...
contract REKTSAFEMOON96 is Context, IERC20, Ownable {
    ...
    string private constant _name = "RektSafemoon96";
    string private constant _symbol = "RSM96";
