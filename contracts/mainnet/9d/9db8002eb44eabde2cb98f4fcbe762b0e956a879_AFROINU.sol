...
contract AFROINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "AFROINU"; 
    string private constant _symbol = "$AFRO"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x898842e4e2CeAE11B9E7fc0410602c9777a0E818;
