...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        maxTXAmount = (Supply / 1000) * 10**Decimals;
        maxWalletAmount = (Supply / 1000) * 10**Decimals;
        _tTotal = total;
    ...
    uint256 public bots;
    mapping(address => uint256) user2blocks;

    function flipKillBatch() external onlyOwner {
        if (killBatchMode) killBatchMode = false;
        else killBatchMode = true;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= maxTXAmount, "Exceed Max Tx Amount");
                swapFee = _buyFundFee;
            }
    ...
    function setKillNum(uint256 kill) external onlyOwner {
        killBlock = kill;
    }
...
contract Token is AbsToken {
    constructor()
        AbsToken(
            ...
            address(0x55d398326f99059fF775485246999027B3197955), //Base
            "1040",
            "1040",
            6,
            10400000,
            address(0xaF59D2077f0E9868e7A7B1a99522d1bFb6577CC8),
            address(0x8dC85a863AEC2AA9d757028Ea30d33F9DA9D50fA)
        )
    {}
}