...
// Telegram https://t.me/babyBabytoken
// We have a Unique Ca That lets us change the name of the contract which not only shows on poo coin but even updates on the buys and symbol .
...
contract BabyBabyToken is Context, IERC20, Ownable {
    ...
    //
    string private _name = "BabyBabyToken";
    string private _symbol = "Baby";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;
    //
    address payable public marketingAddress = payable(0xD8eefcF159e4FdA092498D6D6aD29e35ADb28e84);
    //
    address public marketingWalletToken = 0xD8eefcF159e4FdA092498D6D6aD29e35ADb28e84;
    //
