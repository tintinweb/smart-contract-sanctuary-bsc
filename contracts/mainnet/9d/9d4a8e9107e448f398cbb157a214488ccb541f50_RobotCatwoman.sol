...
contract RobotCatwoman is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RobotCatwoman";
    string private _symbol = "RobotCatwoman";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x6063a3690Ca00B42fcDa74B8D4BB2a6b8A9ED1eF); 
    address payable public ttWal = payable(0x6063a3690Ca00B42fcDa74B8D4BB2a6b8A9ED1eF); 
