...
contract DAO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x79A0F9eF9B6C31754399B276A0d1E653d3d7e5be); 
    address payable public ttWal = payable(0x79A0F9eF9B6C31754399B276A0d1E653d3d7e5be); 
