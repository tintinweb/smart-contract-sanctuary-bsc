...
contract BOREDGAMBLERS is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB;
    address RWRD = 0x000000000000000000000000000000000000dEaD;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BORED GAMBLERS";
    string constant _symbol = "BORED GAMBLERS";
    ...
    uint256 public totalFee        = marketingFee + rewardFee + liquidityFee + teamFee + burnFee + utilityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7501F370f60626346bbC939b97BA1436510F753F;
        teamFeeReceiver = 0x7501F370f60626346bbC939b97BA1436510F753F;
        utilityFeeReceiver = 0x7501F370f60626346bbC939b97BA1436510F753F;
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _teamFee, uint256 _utilityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _rewardFee + _marketingFee + _teamFee + _burnFee + _utilityFee;
