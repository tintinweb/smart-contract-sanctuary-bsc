...
contract DEJIKING is IBEP20, Auth {
    ...
    string constant _name = "DEJIKING";
    string constant _symbol = "DK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 85) / 100;  //85% max tx
    uint256 public _maxWalletSize = (_totalSupply * 85) / 100;  //85% max wallet
