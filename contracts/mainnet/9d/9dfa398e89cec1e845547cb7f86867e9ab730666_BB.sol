...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public partnerAddress = address(0x96EEB9a9d3AEe4258824Ae8FFB16d4E12330b8F6);
    ...
    uint256 public _techFee = 150;
    uint256 public _lpDividendFee = 330;
    uint256 public _partnerFee = 150;
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress,address TechAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapFee = _fundFee + _partnerFee + _lpDividendFee + _techFee;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 techUsdt = usdtBalance * _techFee /swapFee;
        USDT.transferFrom(tokenDistributor, techAddress, techUsdt);
        
        uint256 partnerUsdt = usdtBalance * _partnerFee / swapFee;
        USDT.transferFrom(tokenDistributor, partnerAddress, partnerUsdt);
        
        USDT.transferFrom(tokenDistributor, address(this), usdtBalance - fundUsdt - partnerUsdt - techUsdt);
    }
    ...
    function setTechFee(uint256 fee) external onlyOwner {
        _techFee = fee;
    }
...
contract BB is AbsToken {
    ...
    //USDT
        ...
        8888,
    //Fund
        address(0x28925e2ff7864297EB45565f60EE1e08af9fF706),
    //Receive
        address(0x4d26D23a22207A54CA7Dad6c475515208a5D706d),
        address(0x4067dB2d6F2998727fEE58Bb11F5caB4c6687699)
    ){
