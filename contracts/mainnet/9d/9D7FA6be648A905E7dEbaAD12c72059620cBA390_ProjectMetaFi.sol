...
Project MetaFi is a PLAY 2 EARN(P2E) metaverse project built using unity Game Engine.
 This project will be offering multiple ways in the short and long term for investors
  to have constant yield. ✅ KYC'd Team with Audited Contract,
   🖥Staking Platform at launch 👾P2E Game soon after launch 🤑

https://sites.google.com/view/project-metafi
https://twitter.com/projectmetafi
https://t.me/ProjectMetaFi
*/
...
contract ProjectMetaFi is Context, ProjectMetaFiECO, Ownable {
    ...
    string private _name = 'Project MetaFi';
    string private _symbol = 'PMETA';
