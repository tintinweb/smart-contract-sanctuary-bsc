...
contract SpaceBabyKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceBabyKitty";
    string private _symbol = "SpaceBabyKitty";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3644376580E7A6e013979aDA3953F9ca95940665); 
    address payable private teamWalletAddress = payable(0x013074De6EdA6e47f9D5182bC74d81B03b76cb35); 
