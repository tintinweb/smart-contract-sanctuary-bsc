...
contract KingShiba is Context, IERC20, Ownable {
    ...
    string internal constant _name = "KING SHIBA";
    string internal constant _symbol = "KINGS";
    ...
    address payable public _marketingWallet =
        payable(address(0xcB8800D3bFAc466bE2BB7B5073D8ADda31AD20a2)); // 

    bool internal inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 1 * 10**7 * 10**9; // 
    uint256 public numTokensSellToGetBnb = 2 * 10**4 * 10**9; //
    ...
    constructor() {
        ...
        _isExcluded[address(0xaaa)] = true;
        _isExcluded[address(0xaa)] = true;
        _isExcluded[address(0xa)] = true;
