...
contract KomodoToken {
    using SafeMath for uint256;
    string public name = "Komodo Swap";
    ...
    function KomodoPair() public view returns (address) {
