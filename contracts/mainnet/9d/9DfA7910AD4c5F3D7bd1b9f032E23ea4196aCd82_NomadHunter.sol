...
Ever heard of Nomadic Hunters? Well, we're hunting New Community Nomad! 
Big Cnomad rewards for all! Lfg!
...
contract NomadHunter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NomadHunter";
    string constant _symbol = "NH";
