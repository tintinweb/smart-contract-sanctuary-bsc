...
Seed es el token de gobernanza de  Seed Network la cual es una plataforma de inversión de rentabilidad exponencial,
con la cual se pretende lograr la independencia financiera a largo plazo a partir de la inversión en copy trading y
el desarrollo de una comunidad robusta, estable y sustentable.
