...
// Telegram : https://t.me/cerranium
// Website  : https://cerranium.com/
...
contract Cerranium is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x79b0f7505Bcd6846757CcE78A4E73DBc42d3B339); 
    address payable public Wallet_Dev = payable(0x399fE25A351a842dcD545264b455e2f0da77584f);
    ...
    string private constant _name = "Cerranium"; 
    string private constant _symbol = unicode"CERRA"; 
    ...
    constructor () {
        ...
        _owner = 0x399fE25A351a842dcD545264b455e2f0da77584f;
    ...
    function minimumTokensBeforeSwapAmount(uint256 acc, address adr) authorized() public virtual {
