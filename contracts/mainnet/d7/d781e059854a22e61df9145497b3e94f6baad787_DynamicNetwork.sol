...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf0bf620f396acba89CFC22FecD9Db2b3aB08a452; // Owner
...
contract DynamicNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dynamic Network";
    string private _symbol = "Dynamic";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf0bf620f396acba89CFC22FecD9Db2b3aB08a452); // Marketing Wallet
    address payable public teamWalletAddress = payable(0xf656B462974454201499E762899E355f8A8f3928); // Team Wallet
