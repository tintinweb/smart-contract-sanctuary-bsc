...
/**
ANKR Token which will evolve into something big in the era to come.
Telegram : 
*/
...
contract test is Context, IERC20, Ownable {
    ...
    string private constant _name = "testtttt"; 
    string private constant _symbol = "testttt"; 
    ...
    address payable private _developmentWalletAddress = payable(0xa5017aEF3354762b263bF5044ED9FADa25050C1A);
    address payable private _marketingWalletAddress = payable(0);
