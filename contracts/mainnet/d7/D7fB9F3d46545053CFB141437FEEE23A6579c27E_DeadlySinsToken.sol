...
/**
 * @dev The official DeadlySinsToken smart contract
 */
contract DeadlySinsToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "DeadlySinsToken";
    string private _symbol   = "DST";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for DST/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xE312aC3E275e1EC7372824F56BD217eb6A3fE438); // Marketing address used to pay for marketing
    ...
    uint256 public  _whaleSellTaxFee  = 14; // 14% tax 
    uint256 private _previousTaxFee;
    
    // Token Limits
    uint256 public _maxTxAmount        = 1 * 10**10 * 10**9;  // 10 Billion
    uint256 public _tokenSwapThreshold = 25 * 10**5 * 10**9; // 2.5 Million
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**4 * 10**9; // 1 million Tokens will be used to buy at maximum in any one trade
    ...
    uint256 public  _lotteryMinimumSpend = 10 * 10**5 * 10**9; // 1 Million tokens required to buy before before lottery can be triggered
    ...
    /**
     * @notice Withdraws non-DeadlySins tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts DeadlySins balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns DeadlySins tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of DeadlySins tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from DeadlySinsTokens)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of DeadlySins
            path,
