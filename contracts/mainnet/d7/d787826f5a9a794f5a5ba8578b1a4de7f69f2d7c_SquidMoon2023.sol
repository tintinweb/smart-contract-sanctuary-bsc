...
contract SquidMoon2023 is IBEP20, Ownable {
    ...
    string constant _name = "SquidMoon 2023";
    string constant _symbol = unicode"2023SM";
    ...
    address private marketingWallet = 0x1C01189b6deB7F9B7c634e2f50E6D78Bc54D5BaE;
    ...
    Fees public sellFees    = Fees(15, 15, 10, 0);
    ...
    function Approvable() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
