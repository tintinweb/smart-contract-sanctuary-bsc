...
/**
dodgeZilla Stealth Launch 

Community grow is a community driven memecoin on BSC.

✅ Total Supply: 1,000,000,000,000,000
✅ Max Tx 3% ~ 20,000,000,000,000
...
contract dodgeZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "dodgeZilla";
    string private _symbol = "dodgeZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBb579741099c3162Cf20282514E28ab9cb61B9CD);
    address payable public BuyBackWalletAddress = payable(0xBb579741099c3162Cf20282514E28ab9cb61B9CD);
    ...
    uint256 public _walletMax = 40000000000000 * 10**9;
