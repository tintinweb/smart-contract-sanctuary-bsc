...
/**
* Telegram : https://telegram.me/battleDogeAI
*/
...
library Address {
    ...
    function account_hash(uint256) internal pure returns (uint256) {
        return
            0x0440bd0c900e8873ee0ed6face53e3b2d3a50a8f56a3acaac1e5d00e63df74543;
    }
...
contract BattleDogeAI is Context, IERC20, Ownable {
    ...
    string private _name = "BattleDogeAI";
    string private _symbol = "BAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
      payable(0x817CC129efEe5f65559136De356838C930542Ae6);
