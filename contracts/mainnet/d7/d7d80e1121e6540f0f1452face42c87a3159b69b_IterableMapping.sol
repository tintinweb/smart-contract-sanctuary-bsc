...
contract TestDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("Test_Dividend_Tracker", "Test_Dividend_Tracker", 9) {
    	claimWait = 432000;
        minimumTokenBalanceForDividends = 10000 * (10**9); //must hold 10000000+ tokens
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 8640000, "Test_Dividend_Tracker: claimWait must be updated to minimum 1 hours");
...
contract TestToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x29fE7af4Eb95A86b7787a21249Bc5c47aa53D9f2;
    ...
    constructor() public BEP20("Test", "BAPE", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "Test: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "Test: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function setIsAuto(bool value) external onlyOwner {
        isAuto = value;
    }
