...
// https://t.me/BUYHalfOnly
// Welcome to BuyHalfOnly!
// Buy half, like .005 , .05 , .5 , 5 BNB
...
contract BuyHalfOnly is IBEP20, Ownable {
    ...
    string private _name = "Buy Half";
    string private _symbol = "BUY.5";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0xd6782f53FF23288d82D916fb2F2Ff49B28E6fc29,
        Dev: 0xd6782f53FF23288d82D916fb2F2Ff49B28E6fc29,
        marketing: 0xd6782f53FF23288d82D916fb2F2Ff49B28E6fc29
    });
