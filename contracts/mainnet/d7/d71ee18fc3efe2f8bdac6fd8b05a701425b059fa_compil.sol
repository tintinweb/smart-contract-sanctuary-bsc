...
contract compil is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "20220222";
    string private _symbol = "20220222";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xb1aeD467ce6B59E4eC457Ae7E5a1F4e8047F9B41));
        marketingWalletAddress = payable(address(0xb1aeD467ce6B59E4eC457Ae7E5a1F4e8047F9B41));
