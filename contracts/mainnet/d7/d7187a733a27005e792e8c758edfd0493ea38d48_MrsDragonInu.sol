...
contract MrsDragonInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x2D427bb4adE668684C60389e7FAB881222e4b2ed;
 
    string constant _name = "Mrs Dragon Inu";
    string constant _symbol = "MrsDragonInu";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit AutoImune(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event AutoImune(uint256 amountBNB, uint256 amountBOG);
}