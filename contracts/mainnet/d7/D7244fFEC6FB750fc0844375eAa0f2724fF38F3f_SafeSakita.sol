...
contract SafeSakita is Context, IERC20, Ownable {
    ...
    constructor (address _marketing, address _treasury) {
        ...
        minimumTokensBeforeSwap = 3760000 * 10**_decimals; 
        ...
        _totalTaxIfBuying = 13;
        _totalTaxIfSelling = 13;
        _totalDistributionShares = 13;
