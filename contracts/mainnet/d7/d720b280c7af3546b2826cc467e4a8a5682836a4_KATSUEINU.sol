...
contract KATSUEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "KATSUE INU"; // 
    string private constant _symbol = "KATSUE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0xC1e50bC44471810fc6D061C0D628EF8bA7526565;
