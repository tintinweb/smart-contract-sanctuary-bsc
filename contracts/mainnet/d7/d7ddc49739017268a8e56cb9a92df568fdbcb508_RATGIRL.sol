...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a2e6803b4Ee70aF6eD3f2Ba1FbE4b3981818E01; // owner address
...
contract RATGIRL is Context, IERC20, Ownable {
    ...
    string private _name = "RAT GIRL";
    string private _symbol = "RATG"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE19041570a402504b46949ea72A52a9901Aa35b2); // Marketing Address
    address payable public teamWalletAddress = payable(0x84D398E20B5A74EBeC30Fb01CCB7Dc902292D222); // Team Address
