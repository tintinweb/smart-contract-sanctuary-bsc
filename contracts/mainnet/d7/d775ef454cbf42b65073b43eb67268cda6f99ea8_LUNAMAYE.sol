...
LUNA MAYE
Stealth Launch
Only the one who sizes opportunities can win! Join our movement - together we are strong.

2022 Don't miss the LUNA MAYE

Renounce
Lp Locked
Low Mcap & Tax

Telegram https://t.me/lunamayebsc
*/
...
contract LUNAMAYE is Context, IERC20, Ownable {
    ...
    string private constant _name = "LunaMaye"; // 
    string private constant _symbol = "LunaMaye"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xECc86993fBe1Aa3c4D6555527554392ee15F679F;
