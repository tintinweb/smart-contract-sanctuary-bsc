...
// All rights reserved
// For Genyen by 5th Web Development
...
contract Genyen is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Genyen';
    string private constant _symbol = '$GYEN';
    //uints
    uint private constant DefaultLiquidityLockTime=3 days;
    uint public constant InitialSupply= 1_000_000_000 * 10**_decimals;
    ...
    uint public overLiquifyTreshold=65;
    ...
    address private projectWallet=0x9145056E718a463113Eaa61678966DE38Da0E731;
    //modifiers
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            uint BuyTaxDuration=21 seconds;
