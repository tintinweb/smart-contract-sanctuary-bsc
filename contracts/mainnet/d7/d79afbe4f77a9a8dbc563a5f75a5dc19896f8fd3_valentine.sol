...
/**
https://t.me/happyvalentinesday_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF7Bd8447a13cf129C8B2C298b4e43258F6140e42; 
...
contract valentine is Context, IERC20, Ownable {
    ...
    string private _name = "Happy Valentine's day";
    string private _symbol = "Valentine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF7Bd8447a13cf129C8B2C298b4e43258F6140e42); 
    address payable public teamWalletAddress = payable(0xF7Bd8447a13cf129C8B2C298b4e43258F6140e42); 
