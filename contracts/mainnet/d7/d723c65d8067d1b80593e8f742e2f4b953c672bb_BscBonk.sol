...
abstract contract ContextBonkBEP20 {
...
contract OwnableBonkBEP20 is ContextBonkBEP20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBonkBEP20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBonkBEP20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract BscBonk is ContextBonkBEP20, BonkBEP20, OwnableBonkBEP20 {
