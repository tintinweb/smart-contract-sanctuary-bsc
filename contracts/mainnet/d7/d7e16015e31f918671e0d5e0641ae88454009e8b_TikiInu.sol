...
In Tiki culture, the dog is a symbol of loyalty, protection, and balance. They are often featured in stories and art as familiars to humans, or objects of veneration. The iconic design of the tiki-masked "Tiki Inu" comes from this tradition and is an enduring symbol of the Polynesian people's reverence for these animals.

🗿🐶 1,000,000,000,000 $TINU SUPPLY 

🗿🐶 8% TAX

🗿🐶 TG: https://t.me/TikiInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78Bb34F91767f3983684687f4ff9a13236391bCF; // owner address
...
contract TikiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Tiki Inu";
    string private _symbol = "$TINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78Bb34F91767f3983684687f4ff9a13236391bCF); // 
    address payable public teamWalletAddress = payable(0x78Bb34F91767f3983684687f4ff9a13236391bCF); // 
