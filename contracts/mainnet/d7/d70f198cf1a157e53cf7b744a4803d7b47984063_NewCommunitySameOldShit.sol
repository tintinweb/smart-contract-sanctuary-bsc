...
contract NewCommunitySameOldShit is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'New Community Same Old Shit';
    string private constant _symbol = 'SameOldShit';
