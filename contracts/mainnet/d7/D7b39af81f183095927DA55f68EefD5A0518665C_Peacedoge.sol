...
contract Peacedoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PeaceDoge";
    string constant _symbol = "PeaceDoge";
    ...
    address payable private _marketingWallet = payable(0x114d47631219CDa313c8EbD65c079EE8218d6d34);
    address payable private _lpwallet = payable(0xd8B12C57b0c0ff8f635121098a22173d7EF9E81c);
    address payable private _devwallet = payable(0x2225D3633B356762AaFfe520270253fd5f9435ed);
    address payable private _charitywallet = payable(0x45831D27F26f94d59bb06E101123713186eaa9d4);
    ...
    uint256 private immutable snipeBlockAmt = 1;
