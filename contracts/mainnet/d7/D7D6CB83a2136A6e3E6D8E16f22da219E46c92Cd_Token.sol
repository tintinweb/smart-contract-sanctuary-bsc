...
constructor() {
        name = "Arab Money Token"; // Sets the name of the token, i.e Ether
        symbol = "AMT"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 2000000; // Holds an initial supply of coins
