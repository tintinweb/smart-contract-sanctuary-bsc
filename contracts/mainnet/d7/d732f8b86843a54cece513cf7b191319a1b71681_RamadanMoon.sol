...
contract RamadanMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RamadanMoon";
    string private _symbol = "RamadanMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28E497254797a4d713fd0939261A969dC86c5727);
    address payable public teamWalletAddress = payable(0x4d01DF1E73545022372E58d8e1E5fC74B4258db6);
