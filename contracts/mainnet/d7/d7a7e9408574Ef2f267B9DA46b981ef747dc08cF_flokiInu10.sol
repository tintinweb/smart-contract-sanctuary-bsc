...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x65e9Db8A896B1788A4821CBe6F563BD2517C1383;
...
contract flokiInu10 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x65e9Db8A896B1788A4821CBe6F563BD2517C1383); //lp+dev+marketing 
    ...
    */
    ...
    string private _name = "FlokiInu 1.0"; 
    string private _symbol = "FLOKIONE";  
    ...
    uint256 public _buyFee = 8; //lp+dev+marketing 
    uint256 public _sellFee = 10; //lp+dev+marketing 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(10).div(100); //10% of liquidity
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(10).div(100); //10% of liquidity
