...
Telegram : https://t.me/SQUIDSNAKESPACEPORTAL
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb9C734102Bb7865A0b438ee37474FA4679642d3f;
...
contract Squid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Snake Space"; // 
    string private constant _symbol = "$SquidSS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xb9C734102Bb7865A0b438ee37474FA4679642d3f);
