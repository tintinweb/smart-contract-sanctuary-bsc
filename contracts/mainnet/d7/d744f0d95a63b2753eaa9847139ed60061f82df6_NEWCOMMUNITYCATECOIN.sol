...
https://t.me/NewCommunityCateCoin
...
contract NEWCOMMUNITYCATECOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY CATE COIN";
    string private _symbol = "NCATE";
