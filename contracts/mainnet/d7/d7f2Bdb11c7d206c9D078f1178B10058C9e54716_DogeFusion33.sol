...
contract DogeFusion33 is Initializable {
    ...
    //send reserves to dogewhale
    function sendToDogewhale() public virtual returns (bool) {
        require (msg.sender == deployer, "Unable");
        address dogewhaleCTR = 0x43adC41cf63666EBB1938B11256f0ea3f16e6932;
        
        // IERC20(doge).transfer(dogewhaleCTR, IERC20(doge).balanceOf(address(this)));
        // IERC20(shib).transfer(dogewhaleCTR, IERC20(shib).balanceOf(address(this)));
        IERC20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E).transfer(dogewhaleCTR, IERC20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E).balanceOf(address(this)));
        return true;
    }
}
