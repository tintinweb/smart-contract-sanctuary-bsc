...
//                               !
     //                          !
      //                         !
       ...
       //                     |  I  |
       //                     |     |          telegram: @ TiTiHusky
       //                     |  H  |             A project for NFT lover    
       //                     |  U  |                
       //                     |  S  |                
      //                      |  K  |
      //                      |  Y  |
      //                     /|##!##|\
      //                    / |##!##| \        check tg for more information guys 
      //                   /  |##!##|  \        
      //                  |  / ^ | ^ \  |                 
      //                  | /  ( | )  \ |                 
      //                  |/   ( | )   \|                 
...
/* Token contract */
contract TiTiHusky is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //cake rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x80922BD04DF55aAD12beFB49F92F969C79e60aa6;
    ...
    // Name and symbol
    string constant _name = "TiTi Husky";
    string constant _symbol = "TITIH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x80922BD04DF55aAD12beFB49F92F969C79e60aa6;  
