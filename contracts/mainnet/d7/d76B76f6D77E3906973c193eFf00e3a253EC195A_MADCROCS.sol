...
contract MADCROCS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MADCROCS";
    string private _symbol = "$CROC$";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdb6c6c82525e72bcE753a9B49c3fccc732A09173); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdb6c6c82525e72bcE753a9B49c3fccc732A09173); // BuyBack Address
