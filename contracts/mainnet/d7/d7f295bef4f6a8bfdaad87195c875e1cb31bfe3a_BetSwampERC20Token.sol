...
contract BetSwampERC20Token is IERC20, ERC20Permit, VaultOwned {
    ...
    constructor() ERC20("Kicker", "Kick", 9) {
        ...
        uint256 totalSupply = 114 * 1e4 * 1e9; // 1 million
    ...
    function setMaxTransactionAmount(uint256 newNum) external onlyOwner {
        require(newNum >= _totalSupply/200, "Can't set max transaction below 0.5% of total supply!");
