...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract PrivateSaleAngelPay is Ownable {
        ...
        uint256 public privateMaxCap = 4155 ether;
        uint256 public privateDepositBalance;

        uint256 public lockTime;

        // A token addresse  
        address token = 0xF3ee2b4b08699B2Ec7a7d3182239Aa02cB59211E;

        constructor() {
            saleStart = block.timestamp;  
            privateSale = block.timestamp.add(2 days);
            lockTime = block.timestamp.add(367 days);
        ...
        function withdrawPrivateSale()public{
            require(depositStatePrivate[msg.sender]==false || getLeftTimeAmount()<privateSale);
            require(block.timestamp > lockTime, "Withdraw is locked");
            depositStatePrivate[msg.sender]=false;
        
            IBEP20(token).transfer(msg.sender,balanceMapPrivate[msg.sender]);
        }
