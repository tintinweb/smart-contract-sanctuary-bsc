...
contract Manlook is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Man look";
   string constant _symbol = "MLK";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xb75a14Ae4B4DE76357CE0E2FD0B6502eA5E43f7E).call{value: BNBMarketingamount, gas: 30000}("");
