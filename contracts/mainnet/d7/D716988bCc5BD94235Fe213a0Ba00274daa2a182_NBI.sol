...
contract NBI is NBIDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private NBITeam;
    address private CharityNBI;
    ...
    string public override name = "NBA Inu ";
    string public override symbol = "NBI";
    ...
    constructor(uint totalSupplyValue, address NBITeamAddress, address CharityNBIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        NBITeam = NBITeamAddress;
        CharityNBI = CharityNBIAddress;
       
        // split the tokens according to agreed upon percentages
        balances[NBITeam] =  totalSupply * 4 / 100;
        balances[CharityNBI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NBITeam pot
