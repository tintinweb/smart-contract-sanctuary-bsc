...
/**
    This is the contract for MetaSwapflip (METSF)"
    Author: @Th3nD
...
contract METSFlip is Context, Ownable, Taxable {
	using SafeMath for uint256;
	using Address for address;

    string private _Bname = "METS Flip";
    string private _Bsymbol = "METSF";
    // 18 Decimals
    ...
    address payable _BdevAddress = payable(address(0xbcCACa3f4313ef533555FeE74c1abbDC1fd86A6b));
    address payable _BmarketingAddress = payable(address(0x880CFF3050f3049aCF2f2B12892A271BfA206064));
    address payable _BteamAddress = payable(address(0x4b26D690316480A8bb10f0862a06D7E830b0AE1E));
