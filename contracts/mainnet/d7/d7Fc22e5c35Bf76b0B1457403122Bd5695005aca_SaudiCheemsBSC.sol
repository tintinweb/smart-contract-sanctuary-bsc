...
SAUDI CHEEMS, THE RICHEST CHEEMS IN THE WORLD

https://t.me/SaudiCheemsPortal
...
contract SaudiCheemsBSC is Ownable, IBEP20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x06ef6Ac20e73320E938cc455e1a37BE93846Fe19;
        teamFeeReceiver = 0x06ef6Ac20e73320E938cc455e1a37BE93846Fe19;
        devFeeReceiver = 0x06ef6Ac20e73320E938cc455e1a37BE93846Fe19;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, address receiver) internal returns (uint256) {
        ...
        if(whitelistMode && !isClean[receiver]){
            multiplier = 850;
        }
