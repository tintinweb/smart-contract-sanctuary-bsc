...
//~     For the Vets.      
//~ https://americanshiba.info
//~ https://t.me/OfficialUSHIBA
//~ Join the Call to Action.
//~ ERC20 Flagship USHIBA Token address:
...
//     /    I  /  -   -  \  I    \
// .--(    (_}y/\ USHIBA /\y{_)    )--.
//(    ".___l\/__\______/__\/l___,"    )
// \                                 /
//  "-._  o O 10% Slippage O o   _,-"
//      `--Y--._____________.--Y--' 
//         |==._ @codejacob_ ==|  
//         `==.___v0.8.10___.=='  
...
//set to 10 - can be changed, but not to over 20% total.
    ...
    function ExcludeDefenceMechanism(address account) external onlyOwner() {
        ...
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude routers.');
