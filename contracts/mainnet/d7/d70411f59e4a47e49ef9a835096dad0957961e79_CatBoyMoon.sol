...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08b8f2E4796E3dd1BA09c1BD63C691b960C64279; // owner address
...
contract CatBoyMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " CatBoy Moon ";
    string private _symbol = " $CATBOYMOON ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08b8f2E4796E3dd1BA09c1BD63C691b960C64279); // Marketing Address
    address payable public teamWalletAddress = payable(0x08b8f2E4796E3dd1BA09c1BD63C691b960C64279); // Team Address
