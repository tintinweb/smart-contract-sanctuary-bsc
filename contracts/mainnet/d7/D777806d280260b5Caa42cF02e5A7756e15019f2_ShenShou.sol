...
contract ShenShou is ERC20, ERC20Burnable, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if(_IPancakePair != address(0) && (sender == _IPancakePair || recipient == _IPancakePair)){

                require(_openBuy, "not open");                

                if(sender == _IPancakePair){ //buy

                    // require(recipient.isContract(), "not allow contract to buy");
                ...
                if(recipient == _IPancakePair){ //sell
                    ...
                    // require(sender.isContract(), "not allow contract to sell");
