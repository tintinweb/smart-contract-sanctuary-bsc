...
/**
MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS
MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS
MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS
MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS
MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS MATICATS
...
Telegram: https://t.me/MATICATS
Twitter: https://twitter.com/MaticatsNFT
Website: https://maticats.com/
...
contract MATICATS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MATICATSDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 45; //default cooldown 45s
    ...
    constructor() ERC20("MATICATS", "MATICATS") {
        marketingWallet = payable(0xCc6631292BD2a2c4b8D3DBc2D471349cb12Df863); 
        ...
        dividendTracker = new MATICATSDividendTracker(
            payable(this),
            router,
            0xCC42724C6683B7E57334c4E856f4c9965ED682bD, //reward token ca
            "MATICATSTRACKER",
            "MATICATSTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 67; // 1.5% - ish
        swapTokensAtAmount = totalTokenSupply / 500; // .2%;
    ...
    function updateFees(
        ...
        require(liquidityBuy <= 2 && liquiditySell <= 2, "Liquidity fees can't exceed 2%");
        require(deadBuy <= 2 && deadSell <= 2, "Burn fees can't exceed 2%");
        require(RewardsBuy <= 8 && RewardsSell <= 8, "Reward fees cannot exceed 8%");
        require(marketingBuy <= 8 && marketingSell <= 8, "Marketing fees can't exceed 8%");
        buyDeadFees = deadBuy;
...
contract MATICATSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MATICATS public MATICATSContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MATICATSContract = MATICATS(mainContract);
        minimumTokenBalanceForAutoDividends = 100_000_000000000000000000; // 100,000
    ...
    function _transfer(
        ...
        require(false, "MATICATS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MATICATS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MATICATS contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MATICATSContract);

            uint256 prevBalance = MATICATSContract.balanceOf(address(this));
            ...
            {
                uint256 received = MATICATSContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MATICATSContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
