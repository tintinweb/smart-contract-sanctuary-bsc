...
//////
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(0.01 ether, 2 minutes, 5));
        plans.push(Plan(0.02 ether, 4 minutes, 10));
        plans.push(Plan(0.03 ether, 10 minutes, 15));
        plans.push(Plan(0.04 ether, 20 minutes, 16));
        plans.push(Plan(0.05 ether, 30 minutes, 17));
        plans.push(Plan(0.06 ether, 40 minutes, 18));
...
///////
 ...
 for (uint256 i = 0; i < user.deposits.length; i++) {
      sfr = (user.checkpointRefBonus+2 minutes);
