...
contract BaseToken is Ownable {
    ...
    string constant public name = 'LOVES';
    string constant public symbol = 'LOVES';
    uint8 constant public decimals = 18;
    uint256 public totalSupply =  1000000000*10**uint256(decimals);
    uint256 public constant MAXSupply = 10000000000000000000000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0xfe4F0ac5C35976409f41689fc23ee777fC851063;
