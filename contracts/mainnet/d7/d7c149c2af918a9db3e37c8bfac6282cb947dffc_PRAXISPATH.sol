...
/*
    ...
    Tax 5% (4% MArketing / 1% Auto LP)

    Keep in mind, with high volume 4% MARKETING will make the most sustainable BSC protocol owned by community.

    Locked and renounced!

    https://t.me/PRAXISPATH

    https://twitter.com/PRAXISPATHBSC
...
contract PRAXISPATH is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD REWARDS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  //WBNB
    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Router
 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    address _marketingAdr = 0xa645C4b4cF06b43f34c7cd7043f2FCa60C722471;
 
    string constant _name = "PRAXIS PATH";
    string constant _symbol = "$PRAXIS";
