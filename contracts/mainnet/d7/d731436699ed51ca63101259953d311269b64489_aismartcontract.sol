...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4500Fc6A2A4c7757f8247AD5eFA3e4Cc6577CBAf; // owner address
...
contract aismartcontract is Context, IERC20, Ownable {
    ...
    string private _symbol = "$AICONTRACT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4500Fc6A2A4c7757f8247AD5eFA3e4Cc6577CBAf); // Marketing Address
    address payable public teamWalletAddress = payable(0x4500Fc6A2A4c7757f8247AD5eFA3e4Cc6577CBAf); // Team Address
