...
contract BONU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boy Inu"; 
    string private _symbol = "BONU"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb04ab2F0a4449ceA0A13A376eEEc3a6B4597b1Ee); 
    address payable public teamWalletAddress = payable(0x7C2A27721f4E30C6b77d1f531B670e49Bc0c7290); 
