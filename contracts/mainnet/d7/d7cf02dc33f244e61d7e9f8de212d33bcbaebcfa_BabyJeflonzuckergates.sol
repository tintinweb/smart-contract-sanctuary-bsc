...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaaE78A8B249Ff69693646F6dA9e189BdBF8C00D0; // owner address
...
contract BabyJeflonzuckergates is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyJeflonzuckergates";
    string private _symbol = "BJZG"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb828FF7adC48265f01565663933AE7F33BD0b1bf); // Marketing Address
    address payable public teamWalletAddress = payable(0x35b46B4C4c940F076E7FDb2BF43c2df6967A938b); // Team Address
