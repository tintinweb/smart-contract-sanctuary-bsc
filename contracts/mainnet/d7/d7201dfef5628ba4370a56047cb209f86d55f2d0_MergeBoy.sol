...
contract MergeBoy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x59b4e7640e9234976C28aAa1A5687C60BCA1e0bA)); //marketing wallet
    ...
    constructor() ERC20("MergeBoy", "MERGE") {
