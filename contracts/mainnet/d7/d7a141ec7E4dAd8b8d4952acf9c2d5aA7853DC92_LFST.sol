...
// File: contracts/LFST.sol


pragma solidity ^0.8.13;


contract LFST is ERC20 {
    ...
    function mintToAddress(address _recipient, uint amount) public onlyOwner {
        _mint(_recipient,amount * 10**uint(decimals()));
    }
