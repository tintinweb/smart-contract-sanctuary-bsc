...
contract chickenbowl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "chickenbowl";
    string private _symbol = "chickenbowl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB19Aa3b51858C330C2797BABbFB49795960f7295); 
