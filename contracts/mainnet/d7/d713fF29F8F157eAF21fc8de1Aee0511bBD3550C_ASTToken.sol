...
contract ASTToken is Context, IERC20, Ownable {
    ...
    uint256 public  _maxTaxFeeTotal = 100000000 * 10**uint256(_decimals);
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeLiquidity(sender, tLpFee, rLpFee);
        _takeFund(sender, tFundFee, rFundFee);
        _reflectFee();
    ...
    function _takeFund(address sender, uint256 tFund, uint256 rFund) private {
        if (tFund > 0) {
