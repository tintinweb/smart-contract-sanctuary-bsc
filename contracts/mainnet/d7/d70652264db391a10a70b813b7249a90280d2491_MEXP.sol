...
/**
 *WEBSITE  : https://niftymoji.com/mint
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x3f42325DdE2D7Ad8E24e4AFeD9f916F3Ee060f0E;
...
contract MEXP is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"NIFTY MOJI"; 
    string private constant _symbol = unicode"MEXP"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x3f42325DdE2D7Ad8E24e4AFeD9f916F3Ee060f0E), BNB_Tot);
            }
