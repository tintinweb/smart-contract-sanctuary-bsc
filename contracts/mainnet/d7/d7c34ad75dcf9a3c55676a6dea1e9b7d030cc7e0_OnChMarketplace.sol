...
contract OnChMarketplace is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function initializeV6(address _holderTokenAddress, uint256 _holderDiscount, uint256 _holderMinimum) public reinitializer(6) {
    ...
    */
    ...
    function _paySellerAndTakePlatformFees(SellOrder memory sellOrder, address buyer, uint256 price) internal {
        ...
        uint256 holderAmount = IERC20(holderTokenAddress).balanceOf(msg.sender);
        if (platformFeeAmount > 0 && holderTokenAddress != address(0) && holderAmount > holderMinimum) {
