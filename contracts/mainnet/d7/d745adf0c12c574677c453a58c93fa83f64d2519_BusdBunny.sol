...
/**
 *Twitter https://twitter.com/Busd_Bunny
*/
...
contract BusdBunny is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    address payable public _marketingWalletAddress = payable(0x59a9e8549F33b7c243a1122301A561257A903261);
    address payable public _buybackWalletAddress = payable(0x1c90Ec0aA826DA2c53C801ad153E88b436671129);
    ...
    constructor() BEP20("BusdBunny", "BBUNNY") 
    {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BusdBunny: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
...
contract BusdBunnyDividendTracker is Ownable, DividendPayingToken {
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "BusdBunny_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BusdBunny_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BusdBunny contract.");
    }
