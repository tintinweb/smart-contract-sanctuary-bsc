...
=== 'MORBIT TOKEN' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards MORBIT
-------------------------------------------------------------------
*/ 
...
contract MORBIT is owned {
    
    using SafeMath for uint256;

    string constant private _name = "MORBIT";
    string constant private _symbol = "MOBT";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 20000000 * (10**_decimals);
    uint256 private maxBurnable = maxSupply.mul(50).div(100);
    mapping (address => uint256) private _balanceOf;
    mapping (address => mapping (address => uint256)) private _allowance;
    mapping (address => bool) public frozenAccount;
    uint256 public _totalBurn;

    uint256 public burningPer = 1; //0.1
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        uint _sendValue;
        uint burnableAmount = _value.mul(burningPer).div(1000);
    ...
    function setPercentage(uint256 _amount) external onlyOwner returns(bool){
        burningPer = _amount;
        return true;
    }
