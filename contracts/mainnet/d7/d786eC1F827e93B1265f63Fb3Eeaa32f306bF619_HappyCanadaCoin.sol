...
contract HappyCanadaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Happy Canada Coin";
    string private _symbol = "$HCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2798a1b20316ced103844Fe715004904FCC08702); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2798a1b20316ced103844Fe715004904FCC08702); // Team Address
