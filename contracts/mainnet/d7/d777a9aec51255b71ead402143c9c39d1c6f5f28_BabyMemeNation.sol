...
| $$$$$$$\ /      $$| $$  | $$| $$  | $$.  5% $MEMEN REWARDS
| $$__/ $$|  $$$$$$$| $$__/ $$| $$__/ $$
| $$    $$ \$$    $$| $$    $$ \$$    $$.  Official BabyMemeNation reward token!
 \$$$$$$$   \$$$$$$$ \$$$$$$$  _\$$$$$$$.  We won't take advantage of the hype of our father
                              |  \__| $$.  we will be constantly burning $MEMEN to support
                               \$$    $$.  our daddy. 
                                \$$$$$$ 
                                                __                  __       __                                     
|  \     /  \                                  |  \  |  \           |  \    |  \                    
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xeF9a61e7A7c4D2249c740c4c0458c992598c4714);
...
contract BabyMemeNation is IBEP20, Auth {
    ...
    // Addresses
    address BUSD = 0xeF9a61e7A7c4D2249c740c4c0458c992598c4714;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1ba2deC2FDD4aa97a805587ffC5e77f021593b46;
    ...
    string constant _symbol = "$BMEMEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1ba2deC2FDD4aa97a805587ffC5e77f021593b46;
