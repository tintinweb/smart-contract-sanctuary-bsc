...
/**
HYPERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
Welcome To Hyper Kitty.

Riding on the current cat craze, here’s a pussycat who’s always hyped!  Low tax, no max, just the way you like it!  Trade responsibly, cat lovers, and may you profit well!
...
KITTYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
*/
...
contract hyperkitty is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hyper Kitty";
    string private constant _symbol = "HYPRKITTY";
