...
contract AIDayDoge is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "AIDay Doge";
    string constant _symbol = "AID DOGE";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(refleciontFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _refleciontFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        refleciontFee = _refleciontFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_refleciontFee).add(_marketingFee);
