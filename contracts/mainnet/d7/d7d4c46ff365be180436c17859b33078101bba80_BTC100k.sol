...
contract BTC100k is ERC20, Ownable {                                                                                          ///////////////
    ...
    constructor() ERC20("BTC100k", "BTC100k") {                                                     /////////////////////////////////
        ...
        devAddress = address(0x851F32D5f260a8B892fbC110561B0AA17C522f06);
        treasuryAddress = address(0x46e16C30ad094129a44b799E141F531f222527ef);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 150000 && newValue <= 250000, "Test: gasForProcessing must be between 200,000 and 800,000");
