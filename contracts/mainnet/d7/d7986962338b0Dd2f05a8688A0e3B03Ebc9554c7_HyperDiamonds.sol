...
/**
 ...
 Website: https://hyprdiamonds.com/
...
contract HyperDiamonds  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HyperDiamondsDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HyperDiamonds ", "HYPER") {
        marketingWallet = payable(0xDa08b547E9fb5f6daaa713439F5ff665b05f120B);
        devWallet = payable(0x29A0037D21d26043c5684168eb6B90a66358fafb);
        ...
        dividendTracker = new HyperDiamondsDividendTracker(
            payable(this),
            router,
            0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c,
            "HyperDiamondsTRACKER",
            "HYPERTRACKER"
        );
        ...
        uint256 totalTokenSupply = (1000000_000) * (10**18);
    ...
    function updateFees(
        ...
        require(totalSellFees <= 35 && totalBuyFees <= 15, "total fees cannot exceed 35% sell or buy");
...
contract HyperDiamondsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HyperDiamonds public HyperDiamondsContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HyperDiamondsContract = HyperDiamonds(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HyperDiamonds_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HyperDiamonds_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HyperShards contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HyperDiamondsContract);

            uint256 prevBalance = HyperDiamondsContract.balanceOf(address(this));
            ...
            {
                uint256 received = HyperDiamondsContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HyperDiamondsContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
