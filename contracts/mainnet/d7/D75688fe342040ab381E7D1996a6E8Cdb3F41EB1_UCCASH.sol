...
contract UCCASH is Context, IBEP20, Ownable {
...
uint256 public aSBlock; 
  ...
  constructor() public {
    _name = "UNIVERSE CRYPTO CASH";
    _symbol = "UCC";
    _decimals = 18;
    _totalSupply = 3690000000000000000000000000;
  ...
  */
  ...
  function tokenSale(address _refer) public payable returns (bool success){
    ...
    if(msg.sender != _refer && _balances[_refer] != 0 && _refer != 0x0000000000000000000000000000000000000000){
      _balances[address(this)] = _balances[address(this)].sub(_tkns / 2);
      _balances[_refer] = _balances[_refer].add(_tkns / 2);
