...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DUCK
...
contract TUD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "The Ugly Duck";
    string constant _symbol = "TUD";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; //DUCK
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xaF6A7fb7CFb2eFC4a1D8bb8914B83d4E56CeA546;
