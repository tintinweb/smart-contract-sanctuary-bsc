...
TG Portal: https://t.me/SquWeedGrow
...
contract SquWeedGrow  is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SquWeed Grow ";
    string constant _symbol = "SquGrow";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 *10**9* 10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply/50;
    uint256 public _maxSellTxAmount = _totalSupply/50;
