...
contract Crypto1996 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
        wallet1 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
        wallet2 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
        wallet3 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
        wallet4 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
        wallet5 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
        wallet6 = 0x5e38ce6C5Ee787B1BEE1812C2755EA48bFAe3d97;
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "Crypto1996: minting has not started yet");
    require(_mintAmount > 0, "Crypto1996: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "Crypto1996: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "Crypto1996: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "Crypto1996: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "Crypto1996: zero address");
    require(_amount > 0, "Crypto1996: you have to mint at least one");
    require(lastSupply != 0,  "Crypto1996: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"Crypto1996: URI query for nonexistent token");
