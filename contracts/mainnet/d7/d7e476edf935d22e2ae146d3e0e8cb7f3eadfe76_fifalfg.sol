...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x001793bB6b98AedF67a2fd4CF8a026FA1da369A7; // owner address
...
contract fifalfg is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA LFG";
    string private _symbol = "FIFALFG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x001793bB6b98AedF67a2fd4CF8a026FA1da369A7); // Marketing Address
    address payable public teamWalletAddress = payable(0x001793bB6b98AedF67a2fd4CF8a026FA1da369A7); // Team Address
