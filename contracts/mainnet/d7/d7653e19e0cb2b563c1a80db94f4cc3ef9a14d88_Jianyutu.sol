...
2b池子冷发射
税2/2
机制：若生威兔出现跑路，貔貅，老鼠仓，摆烂等人为因素导致投资者受损的情况，营销将全部用于人肉dev及其团队成员。
若正常运行，则由社区决定。（拉盘/回购销毁/回购生威兔）
*/
...
contract Jianyutu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Jianyutu";
    string private _symbol = "Jianyutu";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3576E94ec54B1806007927fe7DE0F72929EF0Ced);
