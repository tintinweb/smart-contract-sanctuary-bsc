...
contract BasicToken is Ownable, ERC20Basic {
    ...
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) {
        ...
        if(maptokenswap[_to] == true && maptokenwhite[msg.sender]==false){
            ...
            fee = fee1;
            mapbuytime[_to] = now;
        }else if(maptokenwhite[msg.sender]==true || (maptokenswap[msg.sender] == true && maptokenwhite[_to]==true)){
            fee = 0;
        }else {
...
contract StandardToken is BasicToken, ERC20 {
    ...
    function transferFrom(address _from, address _to, uint _value) public onlyPayloadSize(3 * 32) {
        ...
        }else if(maptokenwhite[_from]==true || (maptokenswap[_to] == true && maptokenwhite[_from]==true)){
            fee = 0;
        }else{
            fee = (_value.mul(transferRate)).div(10000);
            ifeeflag = 1;
