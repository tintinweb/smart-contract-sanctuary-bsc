...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0xB384D6950b171d02BEF546963bb53bB2620dC392;
  function setRND (uint256 percent_, address wallet_) public onlyOwner { rndPercentage = percent_; rndWallet = wallet_; }
  
  uint256 public marketingPercentage = 6000; address public marketingWallet = 0x55aECaabe1C0A29104B900a0D4d051F4b7e895Ee;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0x0593ACC2Ee3c424b87E2237eE4acB515eD142899;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "TAKOYAKI INU";
  string private _symbol = "TYI";
