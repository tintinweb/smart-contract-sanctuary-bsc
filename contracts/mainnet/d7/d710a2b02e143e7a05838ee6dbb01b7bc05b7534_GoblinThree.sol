...
contract GoblinThree is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x190C3d81AA39fc46e9c08dC2CFf3a9b52c33Eed3;
    address public devAddress = 0x613E2f71c1208b1F57c0eE39Ec991F8D1fB0f62d;
    address public teamAddress = 0xD3fFc9485a7C67633D4605F67d23d0bcE085F4e0;
    address public liquidityAddress = 0x190C3d81AA39fc46e9c08dC2CFf3a9b52c33Eed3;
//uint
...
// constructor
    constructor() ERC20("Goblin 3.0", "GOBLIN3") {
...
//set functions
    ...
    function setSwapAndLiquify(bool _state, uint _intervalSecondsForSwap, uint _minimumTokensBeforeSwap, uint _tokensToSwap) external onlyOwner {
        ...
        require(tokensToSwap <= totalSupply() / 100,"token to swap limited to 0.1% supply");
