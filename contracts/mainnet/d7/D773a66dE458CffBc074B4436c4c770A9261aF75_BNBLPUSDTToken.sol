...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 9999 / 100;
...
contract BNBLPUSDTToken is AbsToken {
    ...
    //
        800000000,
    //
        address(0x9302B6Ea803Fdea6e9524D9B204d75B60fa23Ec3),
    //
        address(0x0255024D960aFDb2Dc187dE7306A030550A486CB)
    ){
