...
contract SonareumNomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SonareumNomics";
    string private _symbol = "SNomics";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x468c6E9f7a05f529090a66df9013c5f2E71d276B); 
    address payable public ttWal = payable(0x468c6E9f7a05f529090a66df9013c5f2E71d276B); 
