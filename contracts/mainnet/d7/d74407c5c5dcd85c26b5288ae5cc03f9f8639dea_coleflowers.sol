...
contract coleflowers is ERC20, Ownable {
    ...
    constructor() public  ERC20("coleflowers", "coleflowers"){
        uint256 total_ = 10000000000000000000000000 * (10 ** 9);
        liquidityFee = 12; 
        marketingFee = 0;
        sellNum = 0;
        ...
        swapTokensAtAmount = total_.div(600);
        _marketingWalletAddress = 0xB15FE57F4382C1d94ACAF91E6747e7b10e9f58AE;
        ...
        _init(_marketingWalletAddress,total_);
    }
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        //uint256 WBNBNum = IERC20(uniswapV2Router.WETH()).balanceOf(address(this));
