...
contract VEMP is VEMPDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private VEMPTeam;
    address private CharityVEMP;
   
    // token liquidity VEMPdata
    ...
    // token title VEMPdata
    string public override name = "vEmpire Gamer";
    string public override symbol = "VEMP";
    ...
    constructor(uint totalSupplyValue, address VEMPTeamAddress, address CharityVEMPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        VEMPTeam = VEMPTeamAddress;
        CharityVEMP = CharityVEMPAddress;
       
        // split the tokens according to agreed upon percentages
        balances[VEMPTeam] =  totalSupply * 4 / 100;
        balances[CharityVEMP] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's VEMPTeam pot
