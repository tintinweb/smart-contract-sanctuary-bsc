...
/**
https://t.me/GAMIINUGAMI
Inugami(GAMI)
We are Inugami, We are many.
"Inugami" from the Hyakkai Zukan by Sawaki Suushi

Contract Address : 
0xd72391a7327358a27b8bbb2fda95cb505bb95b22

poocoin
https://poocoin.app/tokens/0xd72391a7327358a27b8bbb2fda95cb505bb95b22
*/
...
contract GAMI is GAMIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GAMITeam;
    address private CharityGAMI;
    ...
    string public override name = "Inugami";
    string public override symbol = "GAMI";
    ...
    constructor(uint totalSupplyValue, address GAMITeamAddress, address CharityGAMIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GAMITeam = GAMITeamAddress;
        CharityGAMI = CharityGAMIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GAMITeam] =  totalSupply * 4 / 100;
        balances[CharityGAMI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GAMITeam pot
