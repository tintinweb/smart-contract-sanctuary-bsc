...
contract NetworkInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA4592811DDB57e0dB4f35f59d9DD4449AEea8884); 
    address payable public Wallet_Dev = payable(0x5B7030C40723f5074190DE901584C50D87DF7cEC);
    ...
    string private constant _name = "Network Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x5B7030C40723f5074190DE901584C50D87DF7cEC;
