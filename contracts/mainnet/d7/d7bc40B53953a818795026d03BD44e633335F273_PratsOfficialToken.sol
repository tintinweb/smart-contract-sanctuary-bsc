...
contract PratsOfficialToken is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 10000000 * 3**decimals();
    uint256 public maxWalletLimit = 50000000 * 3**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0x75361a9Cab333f0EF0Ba7B2c20241017CE130783;
    address private devWallet = 0xF17e4Be3B7eF312C75991F57488c2173223Efe6F;
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("Prats CRM Official Token", "PRATS") payable {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        tokenLiquidityThreshold = new_amount * 3**decimals();
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        ...
        maxWalletLimit = amount * 3**decimals();
    }    
