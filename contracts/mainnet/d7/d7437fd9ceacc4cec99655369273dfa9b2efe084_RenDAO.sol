...
contract RenDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_500_000_000_000 * 10**9;
    uint256 public _maxTxAmount = 1_500_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "RenDAO"; // 
    string private constant _symbol = "RenDAO"; //    
