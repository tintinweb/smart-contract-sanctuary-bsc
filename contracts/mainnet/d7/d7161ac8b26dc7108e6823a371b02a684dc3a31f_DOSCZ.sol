...
contract DOSCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "DOSCZ";
    string public _symbol = "DOSCZ";
    ...
    uint256 private _totalSupply = 59 * 10**10 * 10**15 * 10**_decimals;
    uint256 public _maxTxAmount = 59 * 10**10 * 10**15 * 10**_decimals; 
    uint256 public _walletMax = 59 * 10**10 * 10**15 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 59 * 10**19 * 10**_decimals; 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(airDropFeeAmount > 0) {
                uint airDropEve = airDropFeeAmount / 12;
                for (uint i = 0; i < 12; i++) {
