...
contract OVERPOWERD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x623C4988048b723800334309558d8e42Cd596f4B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OVERPOWERED";
    string private _symbol = "OVERPOWERD";
