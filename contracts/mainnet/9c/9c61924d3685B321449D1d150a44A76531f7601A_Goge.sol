...
contract Goge is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public publicSaleCost = 0.5 ether;
    uint256 public max_per_wallet = 20;
    string public contractURI;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Goge", "GOG") {
