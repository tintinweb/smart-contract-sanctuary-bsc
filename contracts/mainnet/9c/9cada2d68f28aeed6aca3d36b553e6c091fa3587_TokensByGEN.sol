...
contract Contract is Context, IERC20 { 
    ...
    uint256 private max_Tran_Launch  = _tTotal / 200;   // 0.5 %
    uint256 private Launch_Buy_Delay = 10;              // 10 Seconds
    uint256 private Launch_Length    = 5 * 60;          // 5 Minutes
    ...
    */
    ...
    Default Settings:
        ...
        The default settings 10 seconds buy delay time, 0.5% of supply transaction limit, and 5 minute launch phase duration.
