...
contract EMEBridge is Ownable {
    ...
    function getEncodePacked(
        ...
        return abi.encodePacked(chainId, token, user, amount);
    }
    ...
    function getHash(
        ...
        return keccak256(abi.encodePacked(chainId, token, user, amount));
    }
        ...
        return
            keccak256(
                abi.encodePacked(
                    ...
                    keccak256(abi.encodePacked(chainId, token, user, amount))
                )
            );
    }
            ...
            ecrecover(
                keccak256(
                    abi.encodePacked(
                        "\x19Ethereum Signed Message:\n32",
                        keccak256(
                            abi.encodePacked(chainId, token, user, amount)
                        )
                    )
                ),
                v,
