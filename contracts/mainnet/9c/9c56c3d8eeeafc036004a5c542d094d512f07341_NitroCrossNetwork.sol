...
/*
  Nitro Cross Network (NITS) - Community Benefits
  Nitro Cross Network is a technology analysis project that aims to provide a strengthened
  and accelerated cross-chain & bridge structure to solve the problems that occur in blockchain
  infrastructures where cross-chains constantly fail and major hacking events occur.

  Token Ecosystem
  The Nitro Cross Network project is a BEP20 Token using the Binance Smart Chain network.
  The Nitro Cross Network project, whose biggest feature aims to provide community benefit,
  is used with the abbreviation NICS. NICS Token has been offered to the market with a rate
  of 92.6% and its liquidity is locked at 100%. 3% commission is charged for marketing expenses.
  - Total Fee Only 3%
...
contract NitroCrossNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Nitro Cross Network";
    string private _symbol = "NITS";
    ...
    address public charityWallet = 0xC3095c82093E8334412dEf2ad342933377D5D721;
