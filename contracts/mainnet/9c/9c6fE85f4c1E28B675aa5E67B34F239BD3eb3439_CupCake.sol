...
/*
CupCake - Giving You the Best from BSC.
A new BSC gem token, CupCake is brought to you by an experienced Dev on BSC network. By having an ambitious mission to become the next most known swap tools in BSC, CupCake has set a target to surpass PancakeSwap.
...
Telegram Group : https://t.me/BscCupCake
*/
...
contract CupCake is Context, IERC20 { 
    ...
    string private constant _name = "CupCake"; 
