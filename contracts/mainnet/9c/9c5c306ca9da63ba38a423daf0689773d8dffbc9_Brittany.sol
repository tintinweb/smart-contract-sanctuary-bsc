...
contract Brittany is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Brittany";
    string private _symbol = "TANY";
    ...
    function tokenRemove(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function chargefree(uint256 maxWallPercent) external onlyOwner {
    ...
    function initialfee(address shareholder, uint256 _amount) internal {    
