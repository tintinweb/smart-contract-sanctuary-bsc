...
/* SPDX-License-Identifier: MIT
    ...
    * GitHub:          https://github.com/ocbworld
    ...
    Tokenomics Diagram
      maximum supply      [total tokens]               = 19,000,000,000
      decimals            [decimals]                   = 18
     -maxTaxFee           [reflections]                = 1%   company dividends for engineer payouts (the hodlers)
     -maxBurnFee          [token burn]                 = 2%   environmental charges (goverment cut)
     -WalletTransferFee                                = 1%   
*/
...
contract Ocbtoken is ERC20, Ownable {
    ...
    constructor () ERC20("Open Chain Block", "OCB") 
    {   
        address newOwner = 0x187eF1b159ace36Ec216EF0c55FF2AdC1E329015;
        ...
        marketingWallet = 0x0d8Cba1A9C7939340244E55238df018C12BfB94C;
        ...
        _mint(newOwner, 19e9 * (10 ** decimals()));
