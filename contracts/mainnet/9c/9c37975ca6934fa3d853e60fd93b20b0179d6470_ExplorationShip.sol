...
contract ExplorationShip is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ExplorationShip";
    string private _symbol = "EShip";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xaba639aE74B7F951eC9D4871E8531D782b4918B8));
        marketingWalletAddress = payable(address(0xeD11c372fC08738CA5679a5e87cEDb669870D120));
