...
contract littlepony is Context, IERC20, Ownable {
    ...
    function changeTxExempt(address holder, bool exempt)
        external
        onlyOwner
    {
   ...
   function receiveaddress(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
