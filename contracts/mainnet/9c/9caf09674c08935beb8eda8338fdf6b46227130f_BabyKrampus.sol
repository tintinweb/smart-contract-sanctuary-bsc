...
contract BabyKrampus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Krampus";
    string private _symbol = "BBKRAMPUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99a5c301136933d3dEbDD19C827bB52C9eC4402f); 
    address payable public DevWalletAddress = payable(0xb654faed26C7c7802610Dbdf710C3CA5b6218F6b); 
