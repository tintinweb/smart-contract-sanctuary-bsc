...
contract TriviumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TriviumNetwork";
    string private _symbol = "Trivium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02CF7444B2499a6CcB4C36132ecbd6301D8e049f); // Marketing Address
    address payable public teamWalletAddress = payable(0x02CF7444B2499a6CcB4C36132ecbd6301D8e049f); // Team Address
