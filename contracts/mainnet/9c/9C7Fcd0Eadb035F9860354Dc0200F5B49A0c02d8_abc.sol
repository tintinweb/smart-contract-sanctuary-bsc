...
contract abc is ERC721, Ownable {
    ...
    function mint(uint256 _numTokens) external payable { 
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You can only mint a maximum of 10 NETs per transacn.");
    ...
    function withdrawAll() external payable onlyOwner { 
        ...
        (bool transferOne, ) = payable(0x7189C2Cd0025D9428190Dc5c7BDb9c3057911E55).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x7189C2Cd0025D9428190Dc5c7BDb9c3057911E55).call{value: balanceTwo}("");
