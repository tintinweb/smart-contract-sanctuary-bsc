...
contract IZG is ERC20, Ownable {
    ...
    constructor() ERC20("IZZY GROW", "IZG") {
        ...
        marketingWallet = payable(0x0C48ec4382D956c0a9978CA252fc31e11C462D90);
        DevWallet = payable(0x0ed05379A3833a53Fa65d7d01eAa1f7567E62038);
    ...
    function excludedFromReward(address[] memory addrs)
        external
        onlyOwner
        returns (bool)
    {
        for (uint256 i = 0; i < addrs.length; i++) {
            _ExcludedFromReward[addrs[i]] = false;
        }
        return true;
    }
