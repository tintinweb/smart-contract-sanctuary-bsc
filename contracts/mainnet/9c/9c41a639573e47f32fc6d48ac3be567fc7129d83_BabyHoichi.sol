...
contract BabyHoichi is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Hoichi";
    string private _symbol = unicode"芳";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xA5CEdfF4d83Cc56B6FE4E88D94bdc4af0a7Ddf46); // Marketing Address
    ...
    constructor () {
        ...
        isFeeLimitExempt[address(pair)] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(marketingWallet, amountBNBBuyBack);
