    ...
    INftGlobal
{
    ...
    function nftInitialize() public initializer {
        ...
        __ERC721PresetMinterPauserAutoId_init("MeSea Nft", "MeSeaNft", "");
    }
        ...
        returns (uint256)
    {
        ...
        mint(account);
        nfts[tokenId] = Nft(tokenId, nftInput.typeId, tx.origin);
    ...
    function updateNft(uint256 tokenId, NftInput memory nftInput)
        external
        onlyRole(GATEWAY_ROLE)
        returns (Nft memory)
    {
    ...
    function getNftByRanking(uint256 fromIndex, uint256 toIndex)
        external
        view
