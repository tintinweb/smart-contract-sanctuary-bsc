...
/**
 NINJA KOTARO is an esport game based on blockchain technology.You can gather your friends,
  form a team, battle with others and earn money with just your skills.

📌NINJA KOTARO is a game based on Japanese adoption, 
you can play games that produce and also you can choose NFT which you can use when fighting
...
Website: https://www.ninjakotaro.com/
Telegram: https://t.me/ninjakotaro
*/
...
contract NINJAKOTARO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ninja Kotaro";
    string constant _symbol = "NINJAKOTARO";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 5000 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8FC1Fb2bf42bf2333dc29d0E6CDe7DBE821bb06a;
        teamFeeReceiver = 0x8FC1Fb2bf42bf2333dc29d0E6CDe7DBE821bb06a;
        buybackFeeReceiver = 0x8FC1Fb2bf42bf2333dc29d0E6CDe7DBE821bb06a;
