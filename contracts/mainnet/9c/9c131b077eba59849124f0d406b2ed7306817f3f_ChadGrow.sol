...
contract ChadGrow is IBEP20, Auth {
    ...
    address DEV = 0x1323aFf75Ef61048cC73BD1D5E33333E88eFb4Dc;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 2.5% (250 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 2.5% (250 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 250 ) / 10000; // 2.5% (250 mil)
