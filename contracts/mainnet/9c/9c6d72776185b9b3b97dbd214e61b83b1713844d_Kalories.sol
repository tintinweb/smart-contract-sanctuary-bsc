...
interface IBEP20Sniper is IERC1136 {
    /**
 ...
 contract Kalories is AntiBot, IERC1136, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Kalories";
    string private _symbol = "KST";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x3c7f1e6D403c4f1FDC97D3d2Aec3a70c0C1B260f;
    address private _water4Africa = 0x3c7f1e6D403c4f1FDC97D3d2Aec3a70c0C1B260f;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xf4F7C47E4C941F38e30bd8dc3529E82865793596;
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "IERC1136: will not permit action right now.");
        unchecked {
     ...
     * problems described in {IERC1136-approve}.
     *
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "IERC1136: will not permit action right now.");
        unchecked {
