...
contract BHO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BHO Protocol";
    string private _symbol = "BHO";
    uint8 private _decimals = 18;

    address payable public MKTWALLET = payable(0xB692d8DbDbf6af2Fd80b5bf739fd1519d80AbeF8); 
    address payable public BurnedWalletAddress = payable(0xB692d8DbDbf6af2Fd80b5bf739fd1519d80AbeF8); 
