...
contract OpensaleFinance is Context, IERC20, Ownable {
    ...
    string private _name = "OpensaleFinance";
    string private _symbol = "OSF";
    ...
    address payable public teamWallet = payable(0x1c302F1EF478EA4f668e3Ba44d2CaaeC2ff4806c); 
    address payable public marketingWallet = payable(0x79170590d8ecF16bB2272214C08A597B7c370dc1); 
