...
contract MARSINU is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xB663a16cB4ABb7Dfb4a2F8f2fbEbf0e3731EBAFE);
    address payable public reserveWallet = payable(0x92fd8d9b1851CD2FfF02B8C19346505194372702);
    address payable public growthFundWallet = payable(0x57F4dBaBB7485848070e23c38b19aAE23B896ab9);
