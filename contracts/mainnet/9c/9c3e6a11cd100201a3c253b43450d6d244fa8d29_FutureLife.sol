...
contract FutureLife is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress = 0x5711f7B56A4706F97a4940d1787c99236d8B8eb7;     // TODO - team wallet here
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 45000000000 * 10**18;
    uint256 private  _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Future Life";
    ...
    uint256 public _maxTxAmount = 45000000000 * 10**18;
