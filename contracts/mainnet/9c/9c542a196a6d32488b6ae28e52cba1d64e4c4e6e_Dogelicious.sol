...
contract Dogelicious is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogelicious";
    string private _symbol = "Dogelicious";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfcB32592D87b0aBBbbd6809906BB6814eaF1A0BC); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xfcB32592D87b0aBBbbd6809906BB6814eaF1A0BC); // Team Address
