...
contract SurvivalInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Survival Inu";
    string private _symbol = unicode"$SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1ACA7905199470C14A45f870fA8133625Ea3a692); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x478D6023DeDa08CE73A285A33c28F8C0d373e043); // buyback Address
