...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7692581a6abB34E9a378B680014f0a95a5eeC932; // owner address
...
contract ChiSuzaku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chi Suzaku";
    string private _symbol = "CSZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7692581a6abB34E9a378B680014f0a95a5eeC932); // 
    address payable public teamWalletAddress = payable(0x7692581a6abB34E9a378B680014f0a95a5eeC932); // 
