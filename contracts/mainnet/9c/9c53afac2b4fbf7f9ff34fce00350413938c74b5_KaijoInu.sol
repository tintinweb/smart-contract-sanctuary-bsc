...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23ee53767873a5A7B202f3F24Be1820A6b4B90D3; 
...
contract KaijoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kaijo Inu";
    string private _symbol = "KINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23ee53767873a5A7B202f3F24Be1820A6b4B90D3); // 
    address payable public teamWalletAddress = payable(0x23ee53767873a5A7B202f3F24Be1820A6b4B90D3); // 
