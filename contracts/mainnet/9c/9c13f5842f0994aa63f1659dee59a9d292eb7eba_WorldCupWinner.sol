...
The world cup finals is going to end in few minutes , this is going to trend everywhere

TELEGRAM:  https://t.me/WorldCupWinnerBsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08D4d26E75b0EBb1851c2082D0fd2E5335421629;
...
contract WorldCupWinner is Context, IERC20, Ownable {
    ...
    string private constant _name = "WORLD CUP WINNER"; // 
    string private constant _symbol = "WcW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x08D4d26E75b0EBb1851c2082D0fd2E5335421629);
