...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07f871e53467480B62547511C1d4f26daDa50D98;
...
contract HQ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x55140396531BEf9C04382A83A735e626051CD60f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**11;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hacker Queen";
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**11;
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**11;
