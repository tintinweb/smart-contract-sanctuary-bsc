...
/**
    Golden Hand
    Telegram : https://t.me/goldenhand_bsc
*/
...
contract GoldenHand is Context, IERC20, Ownable {
    ...
    string private constant _name = "Golden Hand";
    string private constant _symbol = "GOLDENHAND";
    ...
    mapping (address => uint256) private _isValueRewards;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isValueRewards[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isValueRewards[to] = block.timestamp;
        }
