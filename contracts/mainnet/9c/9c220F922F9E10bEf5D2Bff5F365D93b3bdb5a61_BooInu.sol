...
Telegram : https://t.me/booinucoin
...
library Address{
 ...
 contract BooInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 7_500 * 10**9;
    uint256 public maxBuyLimit = 200_000 * 10**9;
    uint256 public maxSellLimit = 10_000 * 10**9;
    uint256 public maxWalletLimit = 200_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xcdc67D02909c699F2F105Ab754a7E0Cfb445D07F;
    address public donationWallet = 0xcdc67D02909c699F2F105Ab754a7E0Cfb445D07F;

    string private constant _name = "BooInu";
    ...
    Taxes public sellTaxes = Taxes(0, 49, 0, 1);
