...
contract CryptoAquaticV1 is ERC1155, Ownable {
    ...
    function buyItem(
        ...
        bool itemAvailable = _itemAvailable(
            collection.limit,
            count,
            item.supply
        );
        ...
        _mintItem(item, count);
    }

    function _mintItem(Item storage item, uint256 count) private {
    ...
    function createCollection(
        ...
        itemId = addItem(hashCode, collection.id);
        collectionId = collection.id;
    }

    function addItem(string calldata hashCode, uint256 collectionId)
        public
        onlyOwner
    ...
    function _itemAvailable(
        uint256 amount,
        uint256 supply,
        uint256 itemsPurchased
    ) private pure returns (bool) {
        return SafeMath.add(itemsPurchased, supply) < amount;
    }
