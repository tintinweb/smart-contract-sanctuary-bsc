...
/**
Telegram : https://t.me/cecilionbsc
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x170183201e841FC4Fe84d376d1c18DB775467B6B; // owner address
...
contract CECILION is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CECILION";
    string private _symbol = "CECI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x170183201e841FC4Fe84d376d1c18DB775467B6B); // Marketing Address
    address payable public teamWalletAddress = payable(0x170183201e841FC4Fe84d376d1c18DB775467B6B); // Team Address
