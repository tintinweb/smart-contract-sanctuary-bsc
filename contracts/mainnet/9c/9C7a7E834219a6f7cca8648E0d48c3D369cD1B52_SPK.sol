...
contract SPK is Context, IBEP20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 200 * 10**_decimals;

    address private _burnWalletAddress =
        0x000000000000000000000000000000000000dEaD;
    address private _marketingWalletAddress =
        0xe1E0b9Fbc5720DbD7eac9BF2362c07c5f13883fc;
    ...
    function _transfer(
        ...
        if (
            ...
            if (contractTokenBalance > 0) market2BNB(contractTokenBalance);
