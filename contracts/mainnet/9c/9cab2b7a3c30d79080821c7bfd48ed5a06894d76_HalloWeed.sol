...
/*
https:https://t.me/HalloWeedOfficial
*/
...
contract HalloWeed is Context, IERC20, Ownable {
    ...
    string private _name = "HalloWeed";
    string private _symbol = "$W33D";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x4773f53583300E3Cb4260269Cc93ed71e8Dd97c9); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xfD454C3A6082f0a2152ce55A587082e7C8CFb701); // Team Address
