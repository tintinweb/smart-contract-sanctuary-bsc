...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E));
      rewardTokens.push(address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D));
...
contract SHIBDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("SHIBDOGE", "SHIBDOGE") {
        ...
        maxTxAmount = totalSupply * 1 / 100; // 1% Max transaction
        ...
        devSellFee = 30;
        liquiditySellFee = 10;
        totalSellFees = rewardsSellFee + operationsSellFee + devBuyFee + liquiditySellFee;

    	dividendTracker = new DividendTracker();
    	
    	operationsWallet = address(0x3972f43264028E6DcaC1b5ce4e543492b7cc6515); // set as operations wallet
        devWallet = address(0x3972f43264028E6DcaC1b5ce4e543492b7cc6515); // set as dev wallet
        liquidityWallet = address(msg.sender); // set as liquidity wallet
    ...
    function updateMaxTxAmount(uint256 newNum) external {
        require(_msgSender() == operationsWallet);

        require(newNum > (totalSupply() * 2 / 1000)/1e18, "Cannot set maxTx lower than 0.2%");
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _devFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        devBuyFee = _devFee;
        totalBuyFees = operationsBuyFee + rewardsBuyFee + liquidityBuyFee + devBuyFee;
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _devFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        devSellFee = _devFee;
        totalSellFees = operationsSellFee + rewardsSellFee + liquiditySellFee + devSellFee;
    }
    ...
    function updateFeeReceivers(address _operationsWallet, address _devWallet, address _liquidityWallet) external onlyOwner {
