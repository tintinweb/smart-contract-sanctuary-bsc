...
Full-Suite Decentralized & Cross-Chain Services
Anonymous cross-chain transactions, farming, escrow service.
Telegram - https://t.me/blockblendIO
    Audit ✔

Going beyond the norm, blockblend offers non-KYC, multi-cross blockchain transactions with the option of up to 5 destination wallets per transaction. 
You can send in ETH and receive in BNB and still remain untraceable.

No more need to do it through CEX.
...
contract BlockBlend is Context, IBEP20, Ownable {
