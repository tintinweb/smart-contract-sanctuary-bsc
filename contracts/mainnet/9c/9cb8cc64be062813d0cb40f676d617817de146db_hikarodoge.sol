...
/**
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ____  ____  | || |     _____    | || |  ___  ____   | || |      __      | || |  _______     | || |     ____     | |
| | |_   ||   _| | || |    |_   _|   | || | |_  ||_  _|  | || |     /  \     | || | |_   __ \    | || |   .'    `.   | |
| |   | |__| |   | || |      | |     | || |   | |_/ /    | || |    / /\ \    | || |   | |__) |   | || |  /  .--.  \  | |
| |   |  __  |   | || |      | |     | || |   |  __'.    | || |   / ____ \   | || |   |  __ /    | || |  | |    | |  | |
| |  _| |  | |_  | || |     _| |_    | || |  _| |  \ \_  | || | _/ /    \ \_ | || |  _| |  \ \_  | || |  \  `--'  /  | |
| | |____||____| | || |    |_____|   | || | |____||____| | || ||____|  |____|| || | |____| |___| | || |   `.____.'   | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' 
Hikaro Doge. Extreme BUSD Rewards. 

// CONTRACT BY DEV OPS YOUTUBE
Website  : https://hikarodoge.godaddysites.com/
Wtitter  : https://twitter.com/DogeHikaru
Telegram : https://t.me/hikarodoge
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    //Mainnet               // CONTRACT BY DEV OPS YOUTUBE
...
abstract contract Auth {
    ...
    event OwnershipTransferred(address owner);
                                      ...
                                      //Contract Created by Dev Ops Youtube

contract hikarodoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Hikaro Doge";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5963A2ed6Fe2c76BAb7eEe6455eC7eA7EcA9B125;
        buybackWallet = 0x5963A2ed6Fe2c76BAb7eEe6455eC7eA7EcA9B125;
