...
/**
  Solectronics | Utility Wallet, Credit Card for and search for daily needs with a solectronic automatic machine

The market is currently bearish, and is in $Solectronic, a long term pump market,
We are proud to launch our token "Solectronic", we are developing the Solectronic Wallet utility and engine that everyone needs with the search of the solectronic blockchain system.
Telegram :https://t.me/Solectronic
Twiter   :https://twitter.com/Solectronic1
*/
...
contract Solectronic is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x268555080785140228f237287dbFb3C082EA9536); 
    address payable public Wallet_Dev = payable(0x268555080785140228f237287dbFb3C082EA9536);
    ...
    string private constant _name = "SOL-ETRONIC"; 
    string private constant _symbol = unicode"SOLTC"; 
    ...
    constructor () {
        ...
        _owner = 0x268555080785140228f237287dbFb3C082EA9536;
