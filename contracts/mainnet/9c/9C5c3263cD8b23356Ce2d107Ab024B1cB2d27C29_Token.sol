        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7351Cae65204534eBAeFE348eef2563d51CDE63e), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x7351Cae65204534eBAeFE348eef2563d51CDE63e),//FundAddress
        address(0xB4c803E5D1EA0bF470DbA9B0F90EC98b5fA46b88)//ReceiveAddress
    ){
    }
}