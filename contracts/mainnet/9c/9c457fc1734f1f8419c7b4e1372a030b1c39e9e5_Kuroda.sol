...
// Twitter https://twitter.com/kuroda_bsc
...
contract Kuroda  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kuroda Coin";
    string private _symbol = "KRD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b93fD0Ec59242ceB80BFd0ee42B36c01A36fb37); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3b93fD0Ec59242ceB80BFd0ee42B36c01A36fb37); // Dev Address
