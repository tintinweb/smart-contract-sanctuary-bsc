...
contract CHICKEN
 is Context, IERC20, Ownable {
    ...
    string private _name = " CHICKEN2.0";
    string private _symbol = " CHICKEN2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16B1F80BaCc0Fd60EC9E2b6d9A4162450223533E);
    address payable public teamWalletAddress = payable(0x16B1F80BaCc0Fd60EC9E2b6d9A4162450223533E);
    address public immutable deadAddress =0x16B1F80BaCc0Fd60EC9E2b6d9A4162450223533E;
