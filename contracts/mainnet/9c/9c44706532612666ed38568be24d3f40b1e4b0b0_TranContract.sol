...
contract TranContract is Ownable {
    ...
    function swapExactBNBForTokens(address coin_address, address _to, uint _amount) public payable {
        ...
        uint UamountOutMin = Uamounts[Uamounts.length - 1];
		 ...
		 require(UamountOutMin<_amount, "UamountOutMin");
		
        IPancakeRouter02(ROUTER).swapExactETHForTokens{value: _amount}(UamountOutMin, _path, _to, block.timestamp);
