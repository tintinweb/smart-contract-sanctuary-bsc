 ...
 */
contract KnightLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function changeMinLengthLottery(uint256 _minLengthLottery) external onlyOwner {
        MIN_LENGTH_LOTTERY = _minLengthLottery;         
    }

    function changeMaxLengthLottery(uint256 _maxLengthLottery) external onlyOwner {
