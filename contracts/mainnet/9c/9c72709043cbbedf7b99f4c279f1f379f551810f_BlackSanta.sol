...
contract BlackSanta is Context, IERC20, Ownable {
    ...
    string private _name = "Black Santa";
    string private _symbol = "BlackSanta";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0Fb3eB6cd3403D6308BAd6264201191Dc9B62b5b); // Marketing Address
    address payable public teamWalletAddress = payable(0x9fA8Fa61492429eB931Bc139Eb63E8557aF9c6A2); // Team Address
