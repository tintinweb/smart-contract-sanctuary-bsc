...
contract CATBROTHER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatBrother";
    string private _symbol = "CBRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F41749f6756A3d91d19e04080cC16Da31335FEC); 
    address payable public teamWalletAddress = payable(0x80499bc1B95aDA0cB964a7Af6c71BD83F0C59201); 
