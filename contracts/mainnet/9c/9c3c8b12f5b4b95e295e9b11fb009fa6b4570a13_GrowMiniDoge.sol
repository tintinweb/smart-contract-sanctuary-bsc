...
contract GrowMiniDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = " Grow MiniDoge ";
    string private constant _symbol = "GROWMIDO";
