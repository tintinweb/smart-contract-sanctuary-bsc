...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3822708a2D6ae4fBAA40561b7d3DDE22f0f0Db06;
...
contract idoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "idoge"; // 
    string private constant _symbol = "idoge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x4a672F8509bE09964b76391D40412000a4ca2740);
