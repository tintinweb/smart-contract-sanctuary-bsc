...
contract GAMFI {
    ...
    uint256 private _totalSupply = 100000000 * 10**18; //100.000.000 IGO
    string private _name = "GAMFI IGO";
    string private _symbol = "IGO";
    ...
    uint256 private _referToken =   70 * 100; //70% Token
    uint256 private _airdropEth =   0.002 * 10**18; //0.002 BNB Airdrop fee
    uint256 private _airdropToken = 20 * 10**18; //20 token will be given on airdrop


    uint256 private saleMaxBlock;
    uint256 private salePrice = 100 * 100; //100 TOKENS/0.01 BNB
