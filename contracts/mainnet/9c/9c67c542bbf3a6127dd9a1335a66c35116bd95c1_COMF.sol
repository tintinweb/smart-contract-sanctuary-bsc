...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaf0474cdCF6E9a1155dCB89CE0e0675319F1feF9;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x314C5987e15f935D52352aFd2cad58E4181eF51F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PyChain Wallet Token";
    string private _symbol = "PyCW";
