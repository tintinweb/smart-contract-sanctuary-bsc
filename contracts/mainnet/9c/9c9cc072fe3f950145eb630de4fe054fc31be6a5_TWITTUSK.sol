...
TWITTUSK
NEW SOCIAL NETWORK FOR DEGENS


Total Supply : 1 000 000 000 TTUSK Tokens
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFBBd513a629D49f794626ef5B5aF1B29DA6E341B;
...
contract TWITTUSK is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x6B4Cd68Eff230FA814ffE70f219844616e20b7D4);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TWITTUSK";
    string private _symbol = "TTUSK";
