...
Telegram : https://t.me/RexbeatProtocol
Website : https://rexbeatprotocol.website/
Whitepaper : https://rexbeatprotocol.website/whitepaper.pdf
*/
...
contract RexbeatProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rexbeat Protocol";
    string private _symbol = "$RXB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x892419fEf2bBC2D5e1114B876202bd8BE15fF475); 
    address payable public buyBackWalletAddress = payable(0x892419fEf2bBC2D5e1114B876202bd8BE15fF475); 
