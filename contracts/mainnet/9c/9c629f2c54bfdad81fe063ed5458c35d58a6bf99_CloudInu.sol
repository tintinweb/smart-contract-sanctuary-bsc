...
library Address{
 ...
 contract CloudInu is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 15_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 25_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xa2d41F964ed5578c9B141C0d81eB42fabBba6856;
    address public donationWallet = 0x72d3344eD3B5795ebf1952a996B329A350798521;

    string private constant _name = "Cloud Inu";
    ...
    Taxes public sellTaxes = Taxes(0, 7, 2, 0);
