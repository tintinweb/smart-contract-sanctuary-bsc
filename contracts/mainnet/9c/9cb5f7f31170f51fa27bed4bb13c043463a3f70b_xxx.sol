...
contract xxx is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   DividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("xxx", "xxx") {
    	...
    	DevTeamWallet = owner();
		marketingWallet = payable(0x80A6eeA0A8cB1397d597b7977282BdAf9E500BC0);
    ...
    function updatedividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "xxx The dividend tracker already has that address");

        DividendTracker newdividendTracker = DividendTracker(payable(newAddress));

        require(newdividendTracker.owner() == address(this), "xxx: The new dividend tracker must be owned by the xxx token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "xxx: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "xxx: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "xxx: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "xxx: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "xxx: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "xxx: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "xxx: Cannot update gasForProcessing to same value");
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Dividend_Tracker", "Dividend_Tracker", DividendToken) {
        ...
        isAuth[owner()] = true;
        isAuth[address(0x80A6eeA0A8cB1397d597b7977282BdAf9E500BC0)];
    }
