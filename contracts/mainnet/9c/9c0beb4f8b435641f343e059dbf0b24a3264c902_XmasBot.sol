...
library Address{
  ...
  contract XmasBot is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0A7d6AD534D07759442041C646D62C95211989a4;
    address public devwallet = 0x07D419A896Ec483318F557BB66625A55aB7CBf77;

    string private constant _name = "Xmas Bot";
    ...
    Taxes public taxes = Taxes(1, 6, 2, 0);
    Taxes public sellTaxes = Taxes(1, 6, 2, 0);
