...
https://t.me/chimkinofficialportal

Chimkin the fat chicken is a meme project, target to get the trust and built a community.
...
contract Chimkin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chimkin"; // 
    string private constant _symbol = "$CHICK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x1B6442F9D42A67244ED1D0276206C9F9CF5aB54A;
