...
contract MVRT is ERC20 {
	...
	address payable _fundAddress = payable(address(0x4aa8938f2D35C4c719936d31CFa54aEEe611D966));
    ...
    constructor(address tokenOwner) ERC20("MVRT", "MVRT") {
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
        ...
        doge.transfer(_fundAddress,doge.balanceOf(address(this)));
    }
