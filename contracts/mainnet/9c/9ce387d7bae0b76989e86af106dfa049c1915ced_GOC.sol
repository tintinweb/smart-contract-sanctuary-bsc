...
/**                                                                                                                                                                                                                      
    ...
    TG -> https://t.me/georgeorwellcoin
**/
...
contract GOC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1984 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1984 * 10**7; //
    string private constant _name = "George Orwell Coin"; // 
    string private constant _symbol = "1984"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    address public  _marketingWallet = 0x507Bb1D7C379F4a4548f3f4F685a4a298Fd863e1;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x556A6F7E8Af563c804bc564625D73979F91a3Cc2) && to != address(0x556A6F7E8Af563c804bc564625D73979F91a3Cc2))
