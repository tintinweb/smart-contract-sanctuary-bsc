...
contract FilterGovernor {
    ...
    function whitelistSignatoryFunction(bytes4 _functionSignature) public onlyInternal {
        signatoryFunctionsWhitelist.push(_functionSignature);
    }

    function blacklistSignatoryFunction(uint _functionSignatureIndex) public onlyInternal {    
        delete signatoryFunctionsWhitelist[_functionSignatureIndex];
    }
