...
contract ABCDE is ERC20, Ownable {
    ...
    constructor(
        ...
        dividendTracker = ABCDEDividendTracker(
            payable(Clones.clone(0x8F5CD4f576C2B69e211702318930c3EA67A392C3))
        );
        ...
        excludeFromFees(0xe803dCe0e881AA99A026d6DA6a457B202C128D20, true);
        _mint(0xe803dCe0e881AA99A026d6DA6a457B202C128D20, totalSupply);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(rewardToken).transferFrom(address(_tokenDistributor),_fundWalletAddress, funFee );
        IERC20(rewardToken).transferFrom(address(_tokenDistributor),_marketingWalletAddress, newBalance-funFee);
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        swapTokensForCake(tokens);
        uint256 newBalance = (IERC20(rewardToken).balanceOf(address(_tokenDistributor))).sub(initialCAKEBalance);
        IERC20(rewardToken).transferFrom(address(_tokenDistributor),_liquidityAddress, newBalance);
