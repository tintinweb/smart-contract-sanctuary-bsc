...
contract Tesla is ERC20 {
    ...
    uint256 public totalFees = liquidityFee;
    
    address public immutable USDT = address(0x55d398326f99059fF775485246999027B3197955);

    address private _liquidityAddres = 0x4d4d9fD298b179F7b691a17E5cBDe5e7c0Da4d26;
    ...
    constructor() ERC20("Tesla", "Tesla")  public  {
        ...
        _mint(0x4d4d9fD298b179F7b691a17E5cBDe5e7c0Da4d26, 10000 * (10 ** 18));
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        // swap tokens for ETH
        swapTokensForUSDT(contractTokenBalance, _liquidityAddres); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
