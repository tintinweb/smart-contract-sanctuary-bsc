...
contract QUEEN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x184FDbE446f046df1C440724690f3C62eA5B994a); // Marketing Address
    address payable public teamWalletAddress = payable(0x184FDbE446f046df1C440724690f3C62eA5B994a); // Team Address
    ...
    uint256 public _teamShare = 5; // original 3

    uint256 public _totalTaxIfBuying = 5;  // original 3
    uint256 public _totalTaxIfSelling = 10;  // original 3
    uint256 public _totalDistributionShares = 6;  // original 3

    uint256 private _totalSupply = 519000000000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 519000000000 * 10 ** _decimals;
    uint256 public _walletMax = 519000000000* 10 ** _decimals;
