...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa2D01ae0adD9897b23f8ca4d4dd51D9Cab186981;
...
contract Sagitario is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xC753C79EEEaD6FFb6486FAd86e85F0352E7E48A4);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Sagitario";
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xC753C79EEEaD6FFb6486FAd86e85F0352E7E48A4)] = true;
        _isExcludedFromFee[address(0xa2D01ae0adD9897b23f8ca4d4dd51D9Cab186981)] = true;
