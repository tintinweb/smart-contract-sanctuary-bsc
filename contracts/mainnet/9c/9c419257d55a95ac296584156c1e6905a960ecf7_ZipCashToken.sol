...
contract ZipCashToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zip Cash";
    string private _symbol = "Zip";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x84e1E90B0e465466ef43C0960f3d1696c086d8CD);
    address payable public buyBackWalletAddress = payable(0x84e1E90B0e465466ef43C0960f3d1696c086d8CD);
