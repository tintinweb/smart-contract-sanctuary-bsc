...
tg: PRIVATE AT LAUNCH TO KEEP EARLY JEETS AND BOTS OUT
...
contract TWOGIRLSONEAPE is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Two Girls One Ape';
