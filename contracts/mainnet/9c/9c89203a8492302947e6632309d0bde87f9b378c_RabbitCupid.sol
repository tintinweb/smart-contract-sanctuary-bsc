...
contract RabbitCupid is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"RabbitCupid";
    ...
    address payable private _developmentAddress = payable(0x8ebfcBc42F8D37D289fB122792A5520407163718);
    address payable private _marketingAddress = payable(0x8ebfcBc42F8D37D289fB122792A5520407163718);
    ...
    uint256 public _maxTxAmount = 140220 * 10**9;
    uint256 public _maxWalletSize = 140220 * 10**9;
