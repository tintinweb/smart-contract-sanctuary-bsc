...
contract SafemoonKatz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafemoonKatz";
    string private _symbol = "SK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a0F36380687A566766d83CfcdfC346698a45f64); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3a0F36380687A566766d83CfcdfC346698a45f64); // BuyBack Address
