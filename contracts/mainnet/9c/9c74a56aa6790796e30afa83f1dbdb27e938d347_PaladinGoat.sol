...
contract PaladinGoat is Context, IERC20, Ownable {
    ...
    string private constant _name = "PaladinGoat"; 
    string private constant _symbol = "$pgoat."; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x3A3060281508b017C76eF1080b8Da7b8D09C25Da;
