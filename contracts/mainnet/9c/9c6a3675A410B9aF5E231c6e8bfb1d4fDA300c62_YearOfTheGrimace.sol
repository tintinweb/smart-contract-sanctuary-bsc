...
Telegram: https://t.me/YearOfTheGrimace
...
// CHANGE
contract YearOfTheGrimace  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "YearOfTheGrimace";
    string constant _symbol = "YOTG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 2% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2e5a692B1d98313282F5F34d63FF15344b662b0E); // Change
