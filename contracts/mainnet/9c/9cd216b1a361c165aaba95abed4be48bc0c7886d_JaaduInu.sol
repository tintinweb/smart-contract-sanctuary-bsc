...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd9F9408eF254eb6b491a850Fe10C7950aC75E9D1; // owner address
...
contract JaaduInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jaadu Inu";
    string private _symbol = "JI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeD8122aa9Ee9cf7390e7e0CCb46B988Cd057A605); // Marketing Address
    address payable public teamWalletAddress = payable(0xC480a96b31e5427410a554827A4E6fE509Da445d); // Team Address
