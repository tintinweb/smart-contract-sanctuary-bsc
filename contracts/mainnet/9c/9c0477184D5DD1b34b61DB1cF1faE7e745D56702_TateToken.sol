...
contract TateToken is IERC20 {
    ...
    string constant private _name = "Tate Token 2.0";
    string constant private _symbol = "TOPG2";
    ...
    struct TaxWallets {
        ...
        address tokensTax;
        address tokensDevTax;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xDEBba43A949179c02dEa63852c390f498fFd0200),
        tokensTax: 0xDEBba43A949179c02dEa63852c390f498fFd0200,
        tokensDevTax: 0x259388Dc7fd5538FFA9A8Cd571d2EfC56980D7cD
    });
...
//===============================================================================================================
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 tokensTax = feeAmount;

        if (ratios.tokensTax > 0) {
            address destination = _taxWallets.tokensTax;
            _tOwned[destination] += tokensTax * 6 / 10;
            address destinationDev = _taxWallets.tokensDevTax;
             _tOwned[destinationDev] += tokensTax * 4 / 10;
