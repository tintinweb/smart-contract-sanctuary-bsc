...
contract Simpsons is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe17c34306e127d9FF1f288d866146a00698F3f0c);
    address payable private _marketingAddress = payable(0xcaFf8159F53DDD58a8704781a1f6d4caF646F122);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 11, "Redis cannot be more than 5.");
	    require(redisFeeOnSell < 11, "Redis cannot be more than 5.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 7, "Tax cannot be more than 5.");
