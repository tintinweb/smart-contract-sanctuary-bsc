...
contract CeFi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _markeAddress = 0xb894B0edDCE7d381A36dCf26ADFbb22e09244440;//营销地址
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor() payable ERC20("CeFiToken", "CeFi") {
     ...
     function takeSellFee(address sender,address recipient,uint256 amount) private returns(uint256 amountAfter) {
        ...
        if(YFee > 0){
           ...
           uint256 reserveOutNum = 0;
            ...
            if(sxNum>0){
                c_usdt.transfer(_devAddress, sxNum);
            }
        }
