...
pragma solidity ^0.6.12;
    ...
    contract BABYSHF is Context, IERC20, Ownable {
        ...
        string private _name = 'Baby Spooky Halloween Floki';
        string private _symbol = 'BABYSHF';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x48a4eDe2F92fc0d2e10Cbd3C530671C13f809aF9, 'We can not exclude Uniswap router.');
