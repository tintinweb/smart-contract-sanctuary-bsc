...
contract MiniDogeGrowBSC is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 10000000000;
    uint256 public _walletMax = _totalSupply * 20 / 10000000000;
    ...
    string constant _name = "MiniDogeGrowBSC";
    string constant _symbol = "MDGBSC";
