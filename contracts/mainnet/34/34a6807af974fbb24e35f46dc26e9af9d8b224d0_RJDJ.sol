...
contract RJDJ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RJDJ";
    string private _symbol = "RJDJ";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x69Dd8dBa61c6e68c996F1399bcC8963B525f0Ccc); // Marketing Address
    ...
    address payable private teamWalletAddress = payable(0x69Dd8dBa61c6e68c996F1399bcC8963B525f0Ccc); // Team Address
