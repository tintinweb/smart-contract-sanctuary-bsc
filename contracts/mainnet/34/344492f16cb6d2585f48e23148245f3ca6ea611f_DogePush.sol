...
// Telegram : https://t.me/dogepush_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE466bFbA1e8719fE467A05F85EBa4C252f6A7c6A; // owner address
...
contract DogePush is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE PUSH";
    string private _symbol = "DPUSH";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xE466bFbA1e8719fE467A05F85EBa4C252f6A7c6A); // Marketing Address
    address payable public teamWalletAddress = payable(0xE466bFbA1e8719fE467A05F85EBa4C252f6A7c6A); // Team Address
