...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d77D41020ff72b46eA033743F0d1ad1B2702d77; // owner address
...
contract Nitrocat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nitro Cat";
    string private _symbol = "NITCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d77D41020ff72b46eA033743F0d1ad1B2702d77); // Marketing Address
    address payable public teamWalletAddress = payable(0x2d77D41020ff72b46eA033743F0d1ad1B2702d77); // Team Address
