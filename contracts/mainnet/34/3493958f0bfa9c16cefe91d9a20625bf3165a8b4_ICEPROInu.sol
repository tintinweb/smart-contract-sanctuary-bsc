...
contract ICEPROInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa98824Ceb793e6434Ca0d77F711430f938334503); 
    address payable public Wallet_Dev = payable(0xa98824Ceb793e6434Ca0d77F711430f938334503);
    ...
    string private constant _name = "ICEPRO INU"; 
    string private constant _symbol = unicode"$ICEPRO"; 
    ...
    constructor () {
        ...
        _owner = 0xa98824Ceb793e6434Ca0d77F711430f938334503;
