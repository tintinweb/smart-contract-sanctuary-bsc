...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x265911Bb49da10a29Df9e9A6a978E4b26c1dc760] = _marketingwallet;
    }
...
contract supershiba is ERC20, Ownable {
    ...
    constructor() ERC20("supershiba", "supershiba") {
        ...
        excludeFromFees(address(0x265911Bb49da10a29Df9e9A6a978E4b26c1dc760), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x265911Bb49da10a29Df9e9A6a978E4b26c1dc760), true);
