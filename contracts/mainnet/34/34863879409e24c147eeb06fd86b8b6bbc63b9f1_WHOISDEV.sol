...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcB3767AeA8e95382636eb1F30Db464170929321B;
...
contract WHOISDEV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WHO IS DEV";
    string private _symbol = "WID2";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xcB3767AeA8e95382636eb1F30Db464170929321B); // Marketing Address
    address payable public teamWalletAddress = payable(0xcB3767AeA8e95382636eb1F30Db464170929321B); // Team Address
