...
contract Token is Context, IBEP20, Ownable {
  ...
  uint256[] private _fee = [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000]; //[50, 50, 50, 100, 100, 100, 150, 150, 150, 150];
  uint256 private _feeMax = 1000;
  address private _feeAddress;
  uint256 private _feeAmount;
  address private _nftAddress = 0xD8952962973f0Ff9cCB29a887E782C8386b9ee57;
  ...
  address public _shareAddress = 0xBAA0698f54Da1B1F5964379FF312fF220A59A08a;
  ...
  constructor() public {
    ...
    _pair = address(IPancakePair(_factory.createPair(address(this), 0xD3172AbC420b002A98cB043Db914f100d893E294)));
