...
contract ShortsTracker is Governable, IShortsTracker {
    ...
    event SetGlobalShortAveragePrice(address token, uint256 averagePrice);
    event SetIsGlobalShortDataReady(bool ready);
    ...
    function _setGlobalShortAveragePrice(
        ...
        emit SetGlobalShortAveragePrice(_token, _averagePrice);
    }
