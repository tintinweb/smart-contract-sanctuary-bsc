...
contract ToothlessGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x67a558DC321Ceb7070e6e3B65d418582Ad14cA84); 
    address payable public Wallet_Dev = payable(0x003594df294ED76262F06b58f9DBAD1eBA4ef5Df);
    ...
    string private constant _name = "ToothlessGrow"; 
