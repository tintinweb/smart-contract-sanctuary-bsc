...
contract TEL2 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public buyInCharge = 90;//买进手续费
    ...
    * 设置交易名单
    */
    function setTransactionList(address TransactionList_,bool state_) public Owner returns (bool){
    ...
    * 设置铸造白名单
    */
    function setCaster(address Caster_,bool state_) public Owner returns (bool){
