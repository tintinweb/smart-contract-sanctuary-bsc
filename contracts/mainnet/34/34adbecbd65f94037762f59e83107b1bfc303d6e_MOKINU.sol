...
// solhint-disable
contract MOKINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x591C848069DeC4EbFad9352Edc3ad9232C8845C6);
    ...
    string private constant _name = "MOKI SHIBA INU";
    string private constant _symbol = "MOKINU";
    ...
    constructor() payable {
        _owner = msg.sender;
        _rOwned[_owner] = (_rTotal / 1000) * 950;
        _rOwned[address(this)] = (_rTotal / 1000) * 50;

        maxTransactionAmount = (_tTotal * 3) / 1000000000; // 0.3% maxTransactionAmountTxn
        maxWalletAmount = (_tTotal * 5) / 1000000000; // 0.5% maxWalletAmount
        minimumTokensBeforeSwap = (_tTotal * 5) / 100000000; // 0.05% swap tokens amount
        ...
        emit Transfer(address(0), _owner, (_tTotal * 950) / 1000);
        emit Transfer(address(0), address(this), (_tTotal * 50) / 1000);
    }
