...
contract CATYAKUZA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT YAKUZA";
    string private _symbol = "YAKUZA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45e9c42b6B6698F759eeE8Dd3E9098430de6D492); 
    address payable public buyBackWalletAddress = payable(0x45e9c42b6B6698F759eeE8Dd3E9098430de6D492); 
