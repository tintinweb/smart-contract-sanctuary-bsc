...
contract APE23 is Context, IERC20, Ownable {
    ...
    string private _name = "APECOIN 2023";
    string private _symbol = "APE23";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xfaA70a5F396CC51af0edec020b9c8c5977af918b); // Buy Back Address
