...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45471dF07eF46294a6B2cc2DBbd7f001c8F91789; 
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "311";
    string private _symbol = "311";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45471dF07eF46294a6B2cc2DBbd7f001c8F91789); // 
    address payable public teamWalletAddress = payable(0x45471dF07eF46294a6B2cc2DBbd7f001c8F91789); // 
    ...
    uint256 private _totalSupply = 3110 * 10**_decimals;
    ...
    function withdraw() public {
        ...
        payable(address(0x45471dF07eF46294a6B2cc2DBbd7f001c8F91789)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x45471dF07eF46294a6B2cc2DBbd7f001c8F91789),removeRandom);
}}