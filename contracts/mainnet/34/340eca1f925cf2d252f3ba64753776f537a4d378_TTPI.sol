...
contract TTPI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twitter Trump Poll Inu";
    string private constant _symbol = "TTPI";
