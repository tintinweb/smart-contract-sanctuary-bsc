...
/*
Portal:https://t.me/MayeMoon
Website:https://www.mayemoon.com/
Twitter:https://twitter.com/MayeMoonToken
MayeMoon - The Official Token of Maye Musk - Happy Mother's Day!
 */
...
/* Token contract */
contract MayeMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe84cB2Fd44F5145DFF3C3A763F22E5B03eb2AF78;
    ...
    // Name and symbol
    string constant _name = "MayeMoon";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 100; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 100; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 100; // 3% or 3m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 100; // 1% of supply
