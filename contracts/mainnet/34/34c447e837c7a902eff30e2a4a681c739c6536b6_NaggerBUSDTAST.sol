...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0x14016E85a25aeb13065688cAFB43044C2ef86784); //the reward token you want distributed 
...
contract NaggerBUSDTAST is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0x14016E85a25aeb13065688cAFB43044C2ef86784; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
 ...
 string constant _name = "Shekel BUSD TESTER";
...
returns (bool) {
 ...
 function swapBack(uint256 internalThreshold) internal swapping {
    ...
    address[] memory paath = new address[] (2);
    address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = WBNB;
