...
contract mechainu is Context, IERC20, Ownable {
    ...
    string private constant _name = " MechaInu"; // 
    string private constant _symbol = "$MECHINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xc26FA8189Dccd6Fd622028Ac653298bdd61309eF;
