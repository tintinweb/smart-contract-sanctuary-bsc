...
contract  ICWMW is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0x99D7d677BdA83183cDA19d214E96af2F9C5259F4;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 15*10**5 * 10**9;
    ...
    constructor() public ERC20("WF Music Web 3.0", "WMW 3.0",9) {
        ...
        _totalSupply = (3*10**8) * (10**9);
        _balances[owner()] = (3*10**8) * (10**9);
          emit Transfer(address(0), owner(), (3*10**8) * (10**9));
    }
