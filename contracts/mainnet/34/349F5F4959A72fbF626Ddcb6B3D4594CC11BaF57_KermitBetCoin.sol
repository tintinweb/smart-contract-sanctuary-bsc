...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWD = IBEP20(0xf5E1c367D2E41b9143937aD17Da6D53aBBBC306B);
...
/* Token contract */
contract KermitBetCoin is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BET = 0xf5E1c367D2E41b9143937aD17Da6D53aBBBC306B; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x9c7Cc4dB7CCe1eEc24bC682Bc481A14A5BA188B0;
    ...
    // Name and symbol
    string constant _name = "KermitBetCoin";
    string constant _symbol = "KBC";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 100m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x9c7Cc4dB7CCe1eEc24bC682Bc481A14A5BA188B0;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).mul(80).div(50);
        uint256 amountBNBReflection = amountBNB.mul(reflectionFee).div(totalBNBFee).mul(80).div(100);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).mul(80).div(100);
        uint256 amountBNBDev = amountBNB.mul(totalFee).div(totalBNBFee).mul(20).div(100); 


        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool successMarketing, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool successDev, /* bytes memory data */) = payable(address(0x74176FA7eF23bd5c310765cafec44dE83Fa3baCA)).call{value: amountBNBDev, gas: 30000}(""); 
    ...
    function manualSend() external authorized {
        ...
        uint256 contractETHBalancea = contractETHBalance.mul(80).div(100);
        uint256 contractETHBalanceb = contractETHBalance.mul(20).div(100);
        payable(marketingFeeReceiver).transfer(contractETHBalancea);
        payable(address(0x74176FA7eF23bd5c310765cafec44dE83Fa3baCA)).transfer(contractETHBalanceb);
    }
