...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Years Shiba Inu"; //
    string private constant _symbol = "NYSI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xAB751088754bFBC1315f09cee03D6eB181faEcba;
