...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Test_Busd_Dividend_Tracker", "Test_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 3,000,000,000+ tokens
    }
...
contract Test is ERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 500000 * (10**18);
    ...
    constructor() ERC20("Hartz4", "ARGE") {
        	
    	marketingWallet = 0x8FfA7963bB5AAe2800da706B8215a34ecd2B69Aa; 
    	busdDividendToken = 0xb1547683DA678f2e1F003A780143EC10Af8a832B; 
