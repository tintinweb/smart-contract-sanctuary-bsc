...
contract RedApe is Context, IERC20, Ownable {
    ...
    string private _name = "Red Ape";
    string private _symbol = "RAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4AdBc72cD7e2813C0eFEF908956Fc61E02A92dE8); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x18442B3f0a46868401211829aEFaC6B34B309fAD); // Development Address
    ...
    uint256 public _maxTxAmount = 35 * 10**6 * 10**9;
