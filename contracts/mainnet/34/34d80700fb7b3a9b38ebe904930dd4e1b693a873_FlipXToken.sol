...
contract FlipXToken is IERC20 {
    ...
    string public constant name = "FlipXToken";
    string public constant symbol = "FLIPX";
    ...
    function transfer(address receiver, uint256 numTokens) public override returns (bool) {
        ...
        if(flip){
            ...
            balances[address(0)] = balances[receiver].add(BurnAmount);
            flip = false;
        }else{
