...
contract temp1 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Biden Digital Trump Cards";
    string constant _symbol = "BDTC";
    ...
    address public devFeeReceiver = 0xD5cA08EF5B120C72EcD5F787537acc3f40F17BAc;
    address public buybackFeeReceiver = 0xD5cA08EF5B120C72EcD5F787537acc3f40F17BAc;
