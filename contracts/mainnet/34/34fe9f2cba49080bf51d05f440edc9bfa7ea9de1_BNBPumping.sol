...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE895936aFaE35De25d22254746F6e84Ef96c0F9c; // owner address
...
contract BNBPumping  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB PUMPING";
    string private _symbol = "BPUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA4C6023578a3B2Dc3784942849240A78c9800acF); 
    address payable public lotteryWalletAddress = payable(0xE895936aFaE35De25d22254746F6e84Ef96c0F9c); 
    ...
    uint256 public _buylotteryFee = 2;
