...
contract ELONX is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 51000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Elon 51X"; // token name
    string private _symbol = "ELONX"; // token ticker
    ...
    uint256 public minTokenToSwap = 255000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 1020000 * 1e9;
    uint256 public minBuyLimit = 1020000 * 1e9;
