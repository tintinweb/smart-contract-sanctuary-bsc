...
contract Token is ERC20, Ownable {
    ...
    constructor() public ERC20("312", "312") {
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 dr = fistval.mul(20).div(50);
            uint256 dr0 = fistval.mul(10).div(50);
            uint256 dr1 = fistval.mul(7).div(50);
            uint256 dr2 = fistval.mul(13).div(50);
