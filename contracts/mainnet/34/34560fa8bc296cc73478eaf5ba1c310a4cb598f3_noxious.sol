...
Telegram https://t.me/NBC_Community_BSC
website https://noxiousblocklesschain.tech/
*/
...
contract noxious is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NOXIOUS BLOCKLESS CHAIN";
    string private _symbol = "$NBC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbAa62c714546508a17d1f224615253db6D52eD51); // Marketing Address
    address payable public BuyBackWalletAddress = payable (0xbAa62c714546508a17d1f224615253db6D52eD51); // BuyBack Address
    ...
    uint256 public _walletMax = 200 * 10**4 * 10**9;
