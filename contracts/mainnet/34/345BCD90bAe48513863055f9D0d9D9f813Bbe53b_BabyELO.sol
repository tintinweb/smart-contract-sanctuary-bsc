...
contract BabyELO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyELO";
    string constant _symbol = "BabyELO";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 10000; // 0.15% of supply
    bool inSwap;
