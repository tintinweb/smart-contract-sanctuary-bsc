...
/**
 ----------------------------------------------------------------------------------------------------------------
Welcome to "HAPPY AI DAY"

"HAPPY AI DAY"  is a degen token with a bullish drive led by community, to conmemorate Elon Musks tweet celebrating AI DAY on Sept 30th.

We will try to push as far as possible!

https://t.me/happyAIDAY
...
Max Wallet & TX: 1%
Buy/Sell Tvelopment)
ax: 9/9 at launch. Funds will be used for buybacks and calls.
Breakdown: (6% marketing, 2% liquidity , 1% Dev)
Wanna be dev: @Volharding --> if you read this, ily too.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA3B97db7A711ab19418108Fb5c76D0DF88DFd2f2; 
...
contract HAPPYAIDAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "HAPPY AI DAY";
    string private constant _symbol = unicode"🤖";
    uint8 private _decimals = 9;

    mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x733f826E8d7696E36ed846bb94450937262c7393); // Marketing Address
    address payable public teamWalletAddress = payable(0xA3B97db7A711ab19418108Fb5c76D0DF88DFd2f2); // Team Address
