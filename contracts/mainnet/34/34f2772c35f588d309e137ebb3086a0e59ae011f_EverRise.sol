...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x19Eb1a0eB1099f6a36a5dF029D55C43DAbed37e7); // Marketing Address
    ...
    string private _name = "Smalltreecn";
    string private _symbol = "Smalltreecn";
