...
Telegram : https://t.me/Butatwopointzero
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x84299ba24A5C2bd589C1e2FF53679ef164df2969;
...
contract BUTA is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUTA 2.0"; // 
    string private constant _symbol = "BUTA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x84299ba24A5C2bd589C1e2FF53679ef164df2969);
