...
contract VitalikMerge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vitalik Merge";
    string private constant _symbol = "VTM";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xC37E725D17ea29C4e8901014cf3b87638c398703);
    address payable private _marketingAddress = payable(0xB2A92F1E2843f40DC21D88A2BDc0F6F1a8909243);
    address payable private _autoLiquidityReceiver = payable(0x1Dd2C71cf794462BA6e5E0289B4C14D7c702ce6D);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 12, "Redis cannot be more than 12.");
	    require(redisFeeOnSell < 12, "Redis cannot be more than 12.");
