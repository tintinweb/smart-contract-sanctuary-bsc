...
contract ARABIANLUNA is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 25_000_000 * 10**9;
    ...
    address private devWallet = 0x42cF9be443b356E07502D6EBEb4b84C0F951e1cD;

    string private constant _name = "ARABIANLUNA";
    string private constant _symbol = "ALuna";
    ...
    function setSellTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev) <= 30, "Must keep fees at 30% or less");
        emit FeesChanged();
    }
