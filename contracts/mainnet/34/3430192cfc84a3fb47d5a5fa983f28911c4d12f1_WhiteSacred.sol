...
Website : https://whitesacred.site
Telegram : https://t.me/WhiteSacred
...
contract WhiteSacred is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "White Sacred";
    string private _symbol = "SACRED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEB2b4Cddb4f51373f09d4CB1e7394614B5B0684a); 
    address payable public buyBackWalletAddress = payable(0xEB2b4Cddb4f51373f09d4CB1e7394614B5B0684a); 
