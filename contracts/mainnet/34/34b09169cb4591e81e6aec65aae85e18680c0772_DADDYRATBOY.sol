...
/* Token contract */
contract DADDYRATBOY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xbFcB0cd08cCe96Bd9D3B01a7ced2Edafaf256830;
    ...
    // Name and symbol
    string constant _name = "Daddy RatBoy";
    string constant _symbol = "DWENTXN";
