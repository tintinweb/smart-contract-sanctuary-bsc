...
contract BestInu is ERC20 ,Ownable{
    ...
    address payable private _marketingAddress = payable(0x0dD56DB42ff80332501A4bE02Dd4f36f1119c064);  //wallet of marketing
    address private _devAddress = 0x0dD56DB42ff80332501A4bE02Dd4f36f1119c064; //Dev Wallet
    ...
    function setTax(bool enable) external onlyDev {
        taxStatus = enable;
    }
    ...
    function setBot(address _address, bool toggle) external onlyDev {
