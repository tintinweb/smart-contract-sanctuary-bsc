...
contract BNBChadinu is IBEP20, Ownable {
    ...
    string constant _name = "BNB Chad INU";
    string constant _symbol = unicode"BNBChad";
    ...
    address private marketingWallet = 0xc345BD535f77Ddc3685FA493aFbaC9743D31c1B8;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 3, 2, 0);
    Fees public sellFees    = Fees(1, 3, 2, 0);
