...
contract GREENTRANSMIT is Context, Ownable {
    ...
    address public _first = address(0xB5cB1568E7B8Dc5e8AaEba6BDD712DdD8dde5E0E);//main
    address public _receiver = address(0x083BD6B0a63A7fbf2DD261A64610E868c6F65d3C);//main
    //
    constructor() {
        //543juy
    ...
    function setAddress(address receiver) external onlyOwner{
        _receiver=receiver;
    }
