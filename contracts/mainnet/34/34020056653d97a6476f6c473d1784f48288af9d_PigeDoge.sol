...
contract PigeDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "PigeDoge";
    string private constant _symbol   = "PigeDoge";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 3000; //LP tax is whatever is left remaining of 10,000, if marketing is 4000 and team is 4000, auto LP would be 2000
    uint256 private  _percentageOfLiquidityForMarketing = 3000;
    ...
    uint256 public  _minTokenBalance = _tTotal / 150;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 300 / 10000; // 1% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xCe410df03AEA4c4ba9e9Bbac9f95aB60cAdCd028;
        _marketingWallet = 0xCe410df03AEA4c4ba9e9Bbac9f95aB60cAdCd028;
