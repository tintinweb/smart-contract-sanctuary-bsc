...
contract Mizukage is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mizukage";
    string private _symbol = "MZE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5f6A50d30083a7105F9867Fc85887aFfb7d987d);
    address payable public BuyBackWalletAddress = payable(0xD5f6A50d30083a7105F9867Fc85887aFfb7d987d);
