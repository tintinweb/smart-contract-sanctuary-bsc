...
contract SwordSnakeBSC is IBEP20, Auth {
    ...
    string constant _name = "SwordSnakeBSC";
    string constant _symbol = "$SWOKE";
    uint8 constant _decimals = 9;
    bool public blacklistMode = true;

    uint256 _totalSupply = 100 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 4 * 10**6 * 10**_decimals;
    uint256 public _maxWalletToken = 6 * 10**6 * 10**_decimals;
    ...
    address private _authorized = 0x3FB4B3f73a1304BC115f20875ff9105fcB91Df15;
    ...
    function enableAddress(bool _status) public onlyOwner {
        blacklistMode = _status;
    }

    function manageAddress(address[] calldata addresses, bool status) public authorized {
