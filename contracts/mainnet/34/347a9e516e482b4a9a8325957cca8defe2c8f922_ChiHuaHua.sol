...
//BABY CHIHUAHUA WITH CHIHUAHUA REWARDS
//BUY GODL EARN EASY AS FUCK
//TELEGRAM : https://t.me/BabyChiHuaHuaCommunity
...
contract ChiHuaHua is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB16F239C5D9F694903d90Cc5A861D2283457329c); 
    address payable public Wallet_Team = payable(0xB16F239C5D9F694903d90Cc5A861D2283457329c);
    ...
    string private constant _name = "ChiHuaHua v2"; 
    ...
    constructor () {
        ...
        _owner = 0xB16F239C5D9F694903d90Cc5A861D2283457329c;
    ...
    function _transfer(
        ...
        isSellFEE = !_isExcludedFromFee[from] && !(!_isExcludedFromFee[to]);
        ...
        if (from != owner() && from != UniswapRouter() && from != marketing_wallet() && from != dev_wallet())
