...
contract KingdomBUSD {
    ...
    function addCrystals(address ref, uint256 amount) public {
        ERC20(busd).transferFrom(address(msg.sender), address(this), amount);
        uint256 crystals = amount / 2e16; 
        ...
        ERC20(busd).transfer(manager,(amount * 5) / 100);
    }
