...
contract CODE7 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CODE7";

    address public _PancakeSwapV1RouterUniswap = 0x074d406c7377C454f69F9515F9090d1629Dec7CD; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x074d406c7377C454f69F9515F9090d1629Dec7CD; //can be the same
