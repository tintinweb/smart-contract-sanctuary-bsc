...
contract StakeUSDT is recursive {
    ...
    uint256 private package1Time = 10368000;
    ...
    function getStakeInfo(address _staker) public view returns(StakeInfo memory)
    {
        return stakeInfos[_staker];
    }

    function getReferralInfo(address _referrer) public view returns(referralInfo memory)
    {
        return referralInfos[_referrer];
    }

    function getReferralList(address _referrer) public view returns(address[] memory)
    {
        return referralInfos[_referrer].referralList;
    }

    function getReferralsStakeAmount(address _referrer) public view returns(uint256[] memory)
    {
