...
interface IRouter {
    ...
    contract BearBottom is ERC20, Ownable {
    ...
    address private marketingWallet = 0xfe7E9D6Afc5D250681f552e85a576F57fE8C1538;
    address private opsWallet = 0x39d706F2078C0bB686AE2074C1C98bd27f6b0F0b;
    ...
    constructor(address routerAdd) ERC20("Bear Bottom", unicode"🐻") {
    ...
    function UpdateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity, _ops);
        require((_marketing + _liquidity + _ops) <= 100, "Must keep fees at 100% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity, _ops);
        require((_marketing + _liquidity + _ops) <= 100, "Must keep fees at 100% or less");
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 10_000_000, "Cannot set max wallet amount lower than 0.1%");
