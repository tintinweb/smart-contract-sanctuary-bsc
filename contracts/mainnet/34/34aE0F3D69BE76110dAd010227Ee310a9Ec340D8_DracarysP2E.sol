...
/*
DracarysP2E is a dragon-themed P2E games in BSC Network. Proudly presented by SPAY Dev, Dracarys is a 1000x moonshot.

Stealth launch by today with maxWallet. Join early for max gain.

✅ P2E Games Coming Soon
✅ Based and Experienced Dev
✅ LP Lock

TG : https://t.me/DracarysP2eBNB
*/
...
contract DracarysP2E is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd5dcA34F341aD029dF6Cd9dd6bf0A84AC8B8FB82); 
    address payable public Wallet_Dev = payable(0xd5dcA34F341aD029dF6Cd9dd6bf0A84AC8B8FB82);
    ...
    string private constant _name = "DracarysP2E"; 
    string private constant _symbol = "$DP2E"; 
