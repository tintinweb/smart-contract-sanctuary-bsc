...
/**
Telegram : https://t.me/XenGrimaceBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbcaF6AFD7893738855f8F46B8C59a6c8dBaAD43C; // owner address
...
contract XENGRIMACE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XENGRIMACE";
    string private _symbol = "XGRIM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbcaF6AFD7893738855f8F46B8C59a6c8dBaAD43C); // Marketing Address
    address payable public teamWalletAddress = payable(0xbcaF6AFD7893738855f8F46B8C59a6c8dBaAD43C); // Team Address
