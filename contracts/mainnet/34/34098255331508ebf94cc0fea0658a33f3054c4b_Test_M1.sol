...
//////
    ...
    function invest(address referrer, uint8 plan, address referrerAddress) public payable{
...
///////
        ...
        ///////
        sendRegFee();
        emit Registration(referrer, referrerAddress, users[referrer].id, users[referrerAddress].id);
//////////////////////
