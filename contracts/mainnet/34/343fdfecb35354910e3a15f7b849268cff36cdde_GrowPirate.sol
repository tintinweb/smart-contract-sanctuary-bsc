...
contract GrowPirate is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x36952aB57Ef5598eC45037f0b7e4e2f442ac1ecC); 
    address payable public Wallet_Dev = payable(0x36952aB57Ef5598eC45037f0b7e4e2f442ac1ecC);
    ...
    string private constant _name = "GrowPirate"; 
    string private constant _symbol = unicode"$GWPT"; 
    ...
    constructor () {
        ...
        _owner = 0x36952aB57Ef5598eC45037f0b7e4e2f442ac1ecC;
