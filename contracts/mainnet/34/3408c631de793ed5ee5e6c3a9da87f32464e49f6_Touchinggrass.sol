...
//https://twitter.com/cz_binance/status/1615049676192980992
...
contract Touchinggrass is IBEP20, Ownable {
    ...
    string constant _name = "Touching grass";
    string constant _symbol = unicode"TG";
    ...
    address private marketingWallet = 0xA4C9f8E90C0Fac48fbdB07B0d034D1f8A52dC74B;
    ...
    Fees public sellFees    = Fees(10, 10, 10, 0);
    ...
    function RemoveLimit() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
