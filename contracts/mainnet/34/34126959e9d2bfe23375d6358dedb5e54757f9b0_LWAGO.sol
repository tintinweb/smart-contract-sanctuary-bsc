...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0092Ee3F05102325C74Ec36413Ea4C6115192c1A;
        // owner address
...
contract LWAGO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Like World GO";
    string private _symbol = "LWAGO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0092Ee3F05102325C74Ec36413Ea4C6115192c1A); // Marketing Address
    address payable public teamWalletAddress = payable(0x0092Ee3F05102325C74Ec36413Ea4C6115192c1A); // Team Address
    ...
    function setDLLWAGO(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDELWAGO(uint256 fe) external onlyOwner {
