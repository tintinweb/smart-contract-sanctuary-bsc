...
contract GrimaceGrowCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrimaceGrowCoin";
    string private _symbol = "GrimaceGrowCoin";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x6B6aea0019cCeE36a027f5258adb34fD8c0b51aB); 
    address payable public teamWalletAddress = payable(0x6B6aea0019cCeE36a027f5258adb34fD8c0b51aB); 
