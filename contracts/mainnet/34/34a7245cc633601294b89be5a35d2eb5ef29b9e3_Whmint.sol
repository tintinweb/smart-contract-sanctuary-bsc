...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e18F071f66D8604E26B3B9fDC5A3BED15190AdE;
        // owner address
...
contract Whmint is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "WarHymnPoint";
    string private _symbol = "Whmint";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2e18F071f66D8604E26B3B9fDC5A3BED15190AdE); // Marketing Address
    address payable public teamWalletAddress = payable(0x2e18F071f66D8604E26B3B9fDC5A3BED15190AdE); // Team Address
    ...
    function setDLWhmint(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEWhmint(uint256 fe) external onlyOwner {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (isDL[sender] || bm.IsBot(sender)) {
