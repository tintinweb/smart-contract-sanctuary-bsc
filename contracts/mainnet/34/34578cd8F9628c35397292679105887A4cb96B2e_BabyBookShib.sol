...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BookShib = IBEP20(0x4693983B0d0C1d5Ef6692F799A5DD4f6CfA3fEe4);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BookShib.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BookShib);
        ...
        uint256 amount = BookShib.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BookShib.transfer(shareholder, amount);
...
contract BabyBookShib is IBEP20, Auth {
    ...
    // Addresses
    address BookShib = 0x4693983B0d0C1d5Ef6692F799A5DD4f6CfA3fEe4; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2526fcAe024D75d5b6fFe1Dc5512aB6e1A589d81;
    ...
    // Name and symbol
    string constant _name = "BabyBookShib";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x494c152aE282d0a929AefFf2E3136f9619e4240F;
