...
contract ABS is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax = 800000 * 10**_decimals;
...
contract MoonRabbit is ABS {
    constructor()
        ABS(
            "MoonRabbit",
            "MoonRabbit",
            address(0x7Bb6A3AFB9E747Cc505b288465992f2043F8d1b8), //Marketing
            address(0x39EE9D994E1D28a6c0B3AC4fb734410F92c5ba10) //Receiver
        )
    {}
}