...
TG: https://t.me/GigaBerlinBrandenburgInu

 TEAM WITH GOOD EXPERIENCE
 X1000 POTENTIAL
 LOW TAX
 LP Locked (Extends on next 10k MC)
...
Tokenomic:
BUY  TAX 12%
START SELL TAX 20% (will changed to 15% after 1 hour after lounch)
Max TX 2% 
Max Wallet 2%
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _sellMarketingFee = 13;   
    ...
    constructor() {
        _name = "GigaBerlinBrandenburg Inu"; //  Name
        _symbol = "GBB"; //  Symbol
        ...
        _maxTxAmount = 20000000000 * 10**_decimals; // 2% of total supply
        _maxWalletBalance = 20000000000 * 10**_decimals; // 2% of total supply
        _marketingWalletAddress = 0x0B91A4534E022EcE7A4aa2920E0085B52f2B1107; // Marketing wallet 
        _devWalletAddress = 0x7CC4128Ce715647FDdbFB3BB6D901Cd21E6c9222; // Dev wallet 
