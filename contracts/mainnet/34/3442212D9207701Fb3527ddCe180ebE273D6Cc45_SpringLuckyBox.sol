...
contract SpringLuckyBox is ERC721EnumerableUpgradeable, OwnersUpgradeable {
    ...
    bool public openCreateLuckyBoxesWithTokens;
    bool public openCreateLuckyBoxesAirDrop;
    ...
    function initialize(string memory uri, address _handler)
        ...
        initializer
    {
        __SpringLuckyBox_init(uri, _handler);
    }

    function __SpringLuckyBox_init(string memory uri, address _handler)
        internal
        onlyInitializing
    {
        __Owners_init_unchained();
        __ERC721_init_unchained("Spring Lucky Box", "SLB");
        __SpringLuckyBox_init_unchained(uri, _handler);
    }

    function __SpringLuckyBox_init_unchained(string memory uri, address _handler)
        internal
        onlyInitializing
    {
        uriBase = uri;
        handler = _handler;
        openCreateLuckyBoxesWithTokens = false;
        openCreateLuckyBoxesAirDrop = false;
    }
    ...
    function createLuckyBoxesAirDrop(
        ...
        require(openCreateLuckyBoxesAirDrop, "SpringLuckyBox: Not open");
        mintBoxes(name, user, count);
    ...
    function setOpenCreate(bool _open)
        external
        onlyOwners
    {
        openCreateLuckyBoxesWithTokens = _open;
        openCreateLuckyBoxesAirDrop = _open;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if(AddressUpgradeable.isContract(to) && !isAuthorized[to])
            revert("SpringLuckyBox: unauthorized contract");
