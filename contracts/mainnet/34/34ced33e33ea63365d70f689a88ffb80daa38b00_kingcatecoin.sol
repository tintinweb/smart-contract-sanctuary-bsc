...
/**
===============================================================================
KING CATECOIN just launched on BSC backed by experienced and dedicated team. It is inspired by the current trend of KING tokens plus its mother CATE coin. Having that said, holders will earn CATE COIN rewards. Team is also planning to develop its own utility that will start with Staking followed by NFT. 

KING CATE COIN the next KING DOGE
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CATE = IERC20(0xE4FAE3Faa8300810C835970b9187c268f55D998F);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CATE.balanceOf(address(this));
        ...
        uint256 amount = CATE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CATE.transfer(shareholder, amount);
...
contract kingcatecoin is IERC20, Ownable {
    using SafeMath for uint256;

    
    address CATE = 0xE4FAE3Faa8300810C835970b9187c268f55D998F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "King CateCoin";
    string constant _symbol = "KINGCATE";
    ...
    uint256 liquidityFee = 9900; // 2%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 2%
    uint256 marketingFee = 0;  //5%
    uint256 totalFee = 9900; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xA31719841265Cda7E18832bE21Cfb2b35665fB66);
        marketingFeeReceiver = address(0xA31719841265Cda7E18832bE21Cfb2b35665fB66);
