...
contract SonOfCatBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son Of CatBoy";
    string private _symbol = "$SONCATBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdd948B05e449DcD1E37afF60f94100cd498982A1); 
    address payable public teamWalletAddress = payable(0xdd948B05e449DcD1E37afF60f94100cd498982A1); 
