...
contract BUSD_Token_DigiRupi is Context {
...
contract REWARDS_TOKEN is Context, IERC20 { 
    ...
    address payable private constant feeCollector = payable(0x6ad50faFc4d53AA3Afc5C98D8c83b1691993ac01);
    ...
    function Token_Information() external view returns(address Owner_Wallet,
        ...
        string memory Creator = "DigiRupi";
