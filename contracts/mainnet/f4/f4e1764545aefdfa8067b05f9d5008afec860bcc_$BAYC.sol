 ...
 *                
 *           
 *  Billionaire Ape Yacht Club  ($BAYC)     https://t.me/BAYCBSC  
 *         
 * 
*/         
...
contract $BAYC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Billionaire Ape Yacht Club";
    string constant _symbol = "$BAYC";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x841272Dc7aD9928F8957A52171Fbefd843ae5036;
