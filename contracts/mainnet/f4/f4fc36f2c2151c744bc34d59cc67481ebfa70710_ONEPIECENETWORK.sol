...
contract ONEPIECENETWORK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD774234519f1ec2eecC6fe2d9254F100c437d2d4); 
    address payable public Wallet_Dev = payable(0xD774234519f1ec2eecC6fe2d9254F100c437d2d4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Onepiece Network"; 
    string private constant _symbol = unicode"ONENETWORK";
