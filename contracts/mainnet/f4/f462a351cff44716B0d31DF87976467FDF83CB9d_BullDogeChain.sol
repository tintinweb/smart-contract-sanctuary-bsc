...
contract BullDogeChain is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(antibotEnabled){
            if (launchedAt == 0 && to == (uniswapV2Pair)) {
                ...
                if(from == uniswapV2Pair) {
                    ...
                    require(amount <= 2e23, "Max sell amount at launch is 200,000 wBDC");
        ...
        if( swapEnabled && 
            ...
            uint256 treasuryTokens  = contractTokenBalance - liquidityTokens;
    ...
    function swapAndSendTreasury(uint256 tokenAmount) private {
        ...
        sendBNB(payable(treasuryWallet), newBalance);
