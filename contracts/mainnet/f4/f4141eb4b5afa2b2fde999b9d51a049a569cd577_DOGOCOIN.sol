...
Portal: https://t.me/dogegoldcoinn
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6AaAeb6C3047d417643df29D1254a9d98cF1B5D3; // owner address
...
contract DOGOCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE GOLD COIN";
    string private _symbol = "DOGOCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6AaAeb6C3047d417643df29D1254a9d98cF1B5D3); // Marketing Address
    address payable public teamWalletAddress = payable(0x6AaAeb6C3047d417643df29D1254a9d98cF1B5D3); // Team Address
