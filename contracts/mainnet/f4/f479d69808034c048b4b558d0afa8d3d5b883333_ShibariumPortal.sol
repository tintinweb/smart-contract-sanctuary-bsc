...
/**
🔥 Aped Shibarium Fi $SHIBFI
+ Telegram: https://t.me/ShibariumFi

🔥 Mc at 12 right now 
Degen for now , just launched. Locked and renounced 
Let’s see, it has a utility 

🔥 ShibFi is the first decentralized non-custodial liquidity protocol on the Shibarium network where 
users can participate as depositors or borrowers. Depositors provide liquidity to the market to earn 
a passive income, while borrowers are able to borrow in an overcollateralized (perpetually) 
or undercollateralized (one-block liquidity) fashion.

🔥 Features
- Lend: Supply into the protocol and watch your assets grow as a liquidity provider.
- Stake: Deposit your ShibFi into the protocol and earn rewards for securing the protocol.
- Loans: Borrow against your collateral from across multiple networks and assets.
- Governance: Participate in ShibFi governance and vote on new proposals, new assets, and protocol upgrades.
...
contract ShibariumPortal is Context, iBEP20, Ownable {
    ...
    string private _name = 'Shibarium Fi';
