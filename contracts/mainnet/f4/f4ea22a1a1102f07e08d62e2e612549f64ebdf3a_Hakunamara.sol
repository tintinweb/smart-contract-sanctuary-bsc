...
contract Hakunamara is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Hakunamara";
    string constant _symbol = "Hakunamara";
    ...
    address public marketingFeeReceiver = 0x9d04eFF5787409155468C619d9aF9b3F9f8631a2;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x9d04eFF5787409155468C619d9aF9b3F9f8631a2] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x9d04eFF5787409155468C619d9aF9b3F9f8631a2] = true;
