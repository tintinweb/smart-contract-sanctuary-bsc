...
contract MoonSnake is IBEP20, Auth {
    ...
    string constant _name = "Moon Snake";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x34bD91052a9491346489c659ca4997679f143ECf;
        marketingFeeReceiver = 0x34bD91052a9491346489c659ca4997679f143ECf;
