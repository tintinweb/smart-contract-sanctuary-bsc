...
contract EyeSyn is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "EyeSyn";
    string private _symbol = "EyeSyn";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90a0dad3873eB0B7e6b678dF8d46c55846c6b9B0);
    address public immutable deadAddress = 0xEF26fB46C158effdD72Ea9A92d5c50CC33cB23f1;
