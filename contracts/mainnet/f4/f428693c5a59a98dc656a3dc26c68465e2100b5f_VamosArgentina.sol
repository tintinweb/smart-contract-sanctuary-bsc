...
/**
/*  
Telegram : https://t.me/vamosargentinabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76a548FccbF9B895776486857c92B5b2dfba8fBE; 
...
contract VamosArgentina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vamos Argentina";
    string private _symbol = "VAFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa63D845289DB14EeD457Ae4A49846673cF1eABd5); // 
    address payable public teamWalletAddress = payable(0xa63D845289DB14EeD457Ae4A49846673cF1eABd5); // 
