...
contract Astronautselfpulling is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x225F34846E672114bABc6B69Cab652E36caC02d5); // Marketing Address
    ...
    string private _name = "Astronautself-pulling";
    string private _symbol = "YHYZL";
