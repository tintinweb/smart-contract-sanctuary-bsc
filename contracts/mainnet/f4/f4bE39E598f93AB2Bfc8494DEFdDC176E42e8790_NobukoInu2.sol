...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90c1067FFe1C65211c22553a127539F231AA0679; 
...
contract NobukoInu2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nobuko Inu2";
    string private _symbol = "NOBINU2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90c1067FFe1C65211c22553a127539F231AA0679); 
    address payable public teamWalletAddress = payable(0x90c1067FFe1C65211c22553a127539F231AA0679); 
