...
Twitter  :  https://twitter.com/GenesisWhales
Website  :  https://genesiswhales.world
Telegram :  https://t.me/GenesisWhales
...
contract GenesisWhales is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GenesisWhalesDividendTracker public dividendTracker;
    ...
    constructor() ERC20("GenesisWhales", "GenesisWhales") {
        marketingWallet = payable(0xa4644C8cF6E4d689b89079a62022df3d428e1Dc4);
        devWallet = payable(0xf938837316f4fdA496f4E0A4864d0fF8AB0c7d52);
        ...
        dividendTracker = new GenesisWhalesDividendTracker(
            payable(this),
            router,
            0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,
            "GenesisWhalesTRACKER",
            "GenesisWhalesTRACKER"
        );
...
contract GenesisWhalesDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    GenesisWhales public GenesisWhalesContract;
    ...
    constructor(
        ...
        defaultToken = token;
        GenesisWhalesContract = GenesisWhales(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GenesisWhales_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GenesisWhales_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GenesisWhales contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GenesisWhalesContract);

            uint256 prevBalance = GenesisWhalesContract.balanceOf(address(this));
            ...
            {
                uint256 received = GenesisWhalesContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GenesisWhalesContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
