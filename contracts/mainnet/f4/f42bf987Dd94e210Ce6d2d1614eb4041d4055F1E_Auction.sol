...
contract Auction is Ownable {
     ...
     * - is opening bid and amount is equal to or greater than starting bid
    ...
    function isValidBidAmount(
        ...
        if (isOpeningBid) return amount >= startingBid;
