...
abstract contract ContextShinyAiBep20 {
...
contract OwnableShinyAiBep20 is ContextShinyAiBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableShinyAiBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableShinyAiBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ShinyAiTOKEN is ContextShinyAiBep20, ShinyAiBep20, OwnableShinyAiBep20 {
