...
/**
LUCINTA LUNA
just degens so funny with indonesian beautiful queen

Lucinta renounce
Lucinta safu project
Lucinta low tax
Lucinta low mcap
Lucinta lp locked

join telegram https://t.me/lucintalunabsc
*/
...
contract LUCINTALUNA is Context, IERC20, Ownable {
    ...
    string private constant _name = "LUCINTA LUNA"; // 
    string private constant _symbol = "LUCINTA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xEFbAC36Af89B393869A9216646917bDa22a95497;
