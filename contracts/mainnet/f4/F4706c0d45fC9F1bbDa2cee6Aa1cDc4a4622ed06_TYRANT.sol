...
contract TYRANT is ERC20, Ownable {
    ...
    constructor () ERC20("TYRANTBSC", "TYRANT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xaaC9991D01F79D8864B20a2d82131600785be0Ef;
        marketingWallet2 = 0xD7dB97701092ef6202Ba8f9C86c3521A54af6668;
        marketingWallet3 = 0x3A76f565e5ab9fc7e5DD2F4A704881f660333A30;
        marketingWallet4 = 0x4Df2DF1fD4d33E86D292d5BF87bCd41C43fC15E4;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet2] = true;
        _isExcludedFromFees[marketingWallet3] = true;
        _isExcludedFromFees[marketingWallet4] = true;
