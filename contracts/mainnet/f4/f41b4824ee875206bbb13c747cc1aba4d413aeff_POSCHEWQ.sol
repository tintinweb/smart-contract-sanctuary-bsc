...
contract POSCHEWQ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POSCHEWQ";
    string private _symbol = "POSCHEWQ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD9ca07f1505A574901452D1b4f6521f8BA04Aa3C);
    address payable public teamWalletAddress = payable(0x858bE076Ab8332081e12A7a4b7bE8e671273A973);
    ...
    constructor (address payable market) {
