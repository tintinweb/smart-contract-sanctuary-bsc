...
contract SENSEISHIBA is IBEP20, Auth {
    ...
    string constant _name = "Sensei Shiba";
    string constant _symbol = "$SENSI";
    ...
    address public marketingFeeReceiver = 0x974dbbfd4d1Ba8D3C9B6f0a12452207f8D898ffE;
