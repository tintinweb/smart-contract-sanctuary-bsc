...
contract Bronomics  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BRONOMICS";
    string private _symbol = "BNOMICS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xe9baD35B8Be22BDC6aa6ee2764BE4e00eadAeC5F);
