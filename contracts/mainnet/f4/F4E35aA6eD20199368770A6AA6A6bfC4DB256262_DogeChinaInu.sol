...
contract DogeChinaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Doge China Inu";

    string private _symbol = "DOGECHINA";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xA7caBB401DFA28B244a41E52e9C44Aeb3939cf94;
