...
contract MIMI is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private fundAddress = address(0x6aA60ea686B9814CE0191F7Ae3292b52B9C25D47);
    address private commAddress = address(0xB1D58c150E97a11A76404Ca1A5477c5099F68869);
    address private socialAddress = address(0x97583bf6921d5f7183493aF0E9e25E58125559f1);
    address private daoAddress = address(0x94eb7f77b454919813aa5555526047D981F23368);
    address private recvAddress = address(0xc0526858394033F070d8BC074d191a82D608bD79);
    ...
    constructor() public {
        ...
        _mint(_tokenOwner, 21 * 10**4 * 10**18);
    ...
    function _transfer(
        ...
        if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
            ...
            if(recipient == _pair){
                _basicTransfer(sender,fundAddress,share.mul(6));
                _basicTransfer(sender,commAddress,share.mul(6));
                _basicTransfer(sender, recipient, share.mul(88));
            } 
            else {
                _basicTransfer(sender, socialAddress, share.mul(2));
                _basicTransfer(sender, recipient, share.mul(98));
            }
        }
