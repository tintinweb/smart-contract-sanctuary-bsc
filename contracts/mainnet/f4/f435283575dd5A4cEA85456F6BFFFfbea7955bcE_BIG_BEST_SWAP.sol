...
contract BIG_BEST_SWAP{
    ...
    constructor(address payable ownerAddress,IERC20 _BIG,IERC20 _BUSD) public
    {
        owner = ownerAddress;  
        BIG = _BIG;
        BUSD=_BUSD;
    ...
    function BuyToken(uint256 tokenQty) public payable
	{
        ...
        require(BIG.balanceOf(address(this))>=tokenQty,"Low Token Balance In Contract");
		...
		BIG.transfer(msg.sender , tokenQty);
