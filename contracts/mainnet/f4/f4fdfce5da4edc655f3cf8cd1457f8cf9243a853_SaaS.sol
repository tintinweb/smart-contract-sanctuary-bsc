...
contract SaaS is ERC20 {
    ...
    address _fundAddress = address(0x12d9BEE6279d9982ebe2E9668Fa135278456Fcb1);
    address _fund1Address = address(0xac64fB33E968EAf28A4A116a5a5c06551e3Fc3bb);
    address _fund2Address = address(0x717afb883C7140f7552500ee3425D7D13f6DC20f);
    ...
    constructor(address tokenOwner) ERC20("SaaS", "SaaS") {
    ...
    function _transfer(
		...
		bool isInviter = from != uniswapV2Pair && balanceOf(to) == 0 && inviter[to] == address(0) && amount >= 10**2;
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx || balanceOf(_destroyAddress) >= maxDestroyAmount) {
			...
			if(from == uniswapV2Pair){
                ...
                require(amount <= 1 * 10**20,"max amount");
				if(swapStats){
