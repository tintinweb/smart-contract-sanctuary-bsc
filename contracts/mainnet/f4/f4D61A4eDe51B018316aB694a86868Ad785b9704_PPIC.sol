...
// DONT BUY TEST CONTRACT - Passive Perpetual Income Coin
// TELEGRAM 
// WEBSITE 
// TWITTER 
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // According to EIP-1052, 0x0 is the value returned for not-yet created account
        // for accounts without code, i.e. `Passive Perpetual Income Coin('')`
        bytes32 codehash;
        bytes32 accountHash = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470;
        // Passive Perpetual Income Coin
...
contract PPIC is Context, IERC20, Ownable {
    ...
    string private _name = "Passive Perpetual Income Coin ( TEST )";
    string private _symbol = "PPIC (TEST)";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**6 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xA4622eaFd61E90F375da10A2847Af70A5FAbd6A0);
    ...
    constructor () {
        ...
        _maxBalance = 20 * 10**6 * 10**_decimals;
