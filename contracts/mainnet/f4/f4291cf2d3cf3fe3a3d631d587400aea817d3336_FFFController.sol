...
contract FFFController is Ownable {
    ...
    constructor() {
        ...
        powerPrices[1] = 10 * 10 ** 15;
        powerPrices[2] = 100 * 10 ** 15;
        powerPrices[3] = 200 * 10 ** 15;
        powerPrices[4] = 300 * 10 ** 15;
        powerPrices[5] = 500 * 10 ** 15;
        powerPrices[6] = 1000 * 10 ** 15;
    ...
    function buyPower(uint256 types) public {
        ...
        userPower[msg.sender] += powerPrices[types].div(10 ** 15);

        _updateUnderPower(msg.sender);

        _setRegisterTime(msg.sender);

        emit BuyPower(msg.sender, tokenType, cost, powerPrices[types].div(10 ** 15));
    }
