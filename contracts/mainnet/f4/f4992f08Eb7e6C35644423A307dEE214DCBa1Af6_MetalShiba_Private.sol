...
contract MetalShiba_Private is Ownable {
    ...
    function set_Whitelist_enabled(bool status) external onlyOwner {
    ...
    function addWhitelisted(address _account) internal {
    ...
    function update_token_tresury(address _MetalShiba, address _tresury) external onlyOwner {
        MetalShiba = _MetalShiba;
        treasury = _tresury;
    }
}