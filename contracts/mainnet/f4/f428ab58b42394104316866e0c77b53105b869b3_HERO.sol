...
contract HERO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBa15ec5aEbD0ca9A30f1202BAaf78b966c6fda76); // Marketing Address
    address payable public teamWalletAddress = payable(0x5a4A7b6c914f404aCFa55d1B40937179261c3B09); // Team Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!launched() && recipient == uniswapPair) {
            require(_balances[sender] > 0);
            launch();
        }
        if(sender != owner() && recipient != uniswapPair && block.number < launchedAt+4){
