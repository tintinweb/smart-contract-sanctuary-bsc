...
// Telegram : https://t.me/NewCommunityPitbullBSC
...
contract nPIT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7FD9c2b8bB43A13eDf535667f053B3ce865F8E18); 
    address payable public Wallet_Developer = payable(0x0591cbA577B60d96B1F8A2B2cf185dC7a901E7d8);
    ...
    string private constant _name = "New Community Pitbull"; 
    string private constant _symbol = unicode"nPIT";
    ...
    constructor () {
        ...
        _owner = 0x0591cbA577B60d96B1F8A2B2cf185dC7a901E7d8;
