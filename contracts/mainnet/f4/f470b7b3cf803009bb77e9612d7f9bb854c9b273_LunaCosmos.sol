...
contract LunaCosmos is Context, IERC20, Ownable {
    ...
    string private _name = "Luna Cosmos";
    string private _symbol = "Lunv23";
    ...
    address payable public marketingWallet = payable(0x9B5c018F21BB887Fc1F0C03e36486081fe8b98E6);
