...
TELEGRAM: https://t.me/flokichemistryofficial
...
contract FlokiChemistry is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKI CHEMISTRY"; // 
    string private constant _symbol = "$FLOKIC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1c9586B5B7e4EA374C1f69204c8b3d9140d5b6f5;
