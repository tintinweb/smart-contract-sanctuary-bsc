...
// Telegram : https://t.me/RabbitElon
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4077aeD0F0D204510858a9bfe0E6CBbC2f81CAA2; // owner address
...
contract rabbitelon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RABBITELON";
    string private _symbol = "RABBITELON";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x4077aeD0F0D204510858a9bfe0E6CBbC2f81CAA2); // Marketing Address
    address payable public teamWalletAddress = payable(0x4077aeD0F0D204510858a9bfe0E6CBbC2f81CAA2); // Team Address
