...
contract RASHCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RASHCOIN";
    string private _symbol = "RASHCOIN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x05c2473F0250cEbE3dc0358e3676D4326df99ffd); 
    address payable public BurnedWalletAddress = payable(0x05c2473F0250cEbE3dc0358e3676D4326df99ffd); 
