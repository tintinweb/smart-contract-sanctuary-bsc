...
//Brazil Fan Token
//Website: https:brazilfantoken.com
//Tele: https://t.me/brazilfantokenglobal
...
contract BRA is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xD7113667aBD9d1B39d3660533fcCAd3AB71dA055;
    address public devWallet = 0x628E4373Fa964688a1C103ce273469e17966aD93;

    string private constant _name = "Brazil Fan Token";
    ...
    // 3% dev
    // IT CANT BE CHANGE
    Taxes public taxes = Taxes(2, 3, 0, 3);
    Taxes public sellTaxes = Taxes(2, 3, 0, 3);
