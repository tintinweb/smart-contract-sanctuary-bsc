...
/**https://t.me/boredcats_bsc
/**
/**Hi_

So I made "boredcats" as I liked the Bored Apes NFTs and how its gained more significance over the past year_ 
I don't have any huge ambitions for boredcats as I know where I'm deploying it/
thats pretty much it_ ill renounce ca and lock liq  
...
contract BOREDCATS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOREDCATS";
    string private _symbol = "$BC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xadF359635e673520523FD3A52a7af0ADeB05159b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xadF359635e673520523FD3A52a7af0ADeB05159b); // BuyBack Address
