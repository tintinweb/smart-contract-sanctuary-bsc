...
━━━━━━━━━━━━━━┏━┛┃━━━━━━━━━━━━━━━━━━┏━┛┃━━━━━━━━
━━━━━━━━━━━━━━┗━━┛━━━━━━━━━━━━━━━━━━┗━━┛━━━━━━━━
join our channel on telegram ->>  https://t.me/babydragon_official
...
interface IRouter {
	...
	address public constant deadWallet = 0x0000000000000000000000000000000000000000;
    ...
    Taxes private taxes = Taxes(1, 0, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Baby Dragon", "BBD") {//#name and symb
        ...
        exemptFee[0xf9dD48775D55aE58391B6da3e7FFa3132C8Fb9d0] = true;
        exemptFee[0x26fD0Fdb30D3449bdf003FeA653d12c67098ff51] = true;
        ...
        allowedTransfer[0xf9dD48775D55aE58391B6da3e7FFa3132C8Fb9d0] = true;
        allowedTransfer[0x26fD0Fdb30D3449bdf003FeA653d12c67098ff51] = true;
    }
