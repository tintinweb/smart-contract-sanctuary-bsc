...
contract SafeSwapNFT is ERC721Enumerable, IERC2981, Ownable {
    ...
    address private swapTokenAddress = 0xe56a473043EaAB7947c0a2408cEA623074500EE3;
    ...
    function setSwapTokenAddress(address _tokenAddress) external onlyOwner {
        require(_tokenAddress != address(0), "Invalid address");
        require(IERC20(_tokenAddress).totalSupply() > 0, "Invalid token");
    ...
    function setPurchaseLimit(uint256 purchaseLimit, uint256 mintLimit) external onlyOwner {
        MAX_PER_TX = purchaseLimit;
        MAX_PER_USER = mintLimit;
    }
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(totalPrice <= TOKEN.balanceOf(msg.sender), "Error: you dont have enough tokens to pay");
            require(totalPrice <= TOKEN.allowance(msg.sender, address(this)), "Error: approve tokens");
            ...
            TOKEN.safeTransferFrom(msg.sender, _paymentReceiver, totalPrice);
        }
