...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "QatarLaeeb";
    string internal constant SYMBOL = "QLB";
    ...
    address internal charityAddress = 0x116542c6d31b891E756a4c38a4A026dab85A83fB;
    address internal marketingAddress = 0x3b57cefdE82A700873F0F603FfD56fF07dC4E8B8;
    ...
    function _addFees() private {
        ...
        // actually liquidity fee is 1%, marketing fee is 1%
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    address internal marketingAddress2 = 0x3b57cefdE82A700873F0F603FfD56fF07dC4E8B8;
    ...
    function _swapAndLiquify(uint256 amount) private lockTheSwap {
        /**
         * split the contract balance into four parts
         * part1(25%) and part2(25%): add liquify
         * part3(50%): sell all, to marketing address
         */
        uint part1 = amount / 4;
        uint part3 = amount - part1 - part1;

        // add liquidity part
        uint256 initialBalance = address(this).balance;
        _swapTokensForEth(part1+part3);
        uint256 newBalance = address(this).balance.sub(initialBalance);
        uint256 balanceAddToLiquidity = newBalance / 100 * 34;
        _addLiquidity(part1, balanceAddToLiquidity);

        // add marketing address eth
        payable(marketingAddress2).transfer(newBalance-balanceAddToLiquidity);
