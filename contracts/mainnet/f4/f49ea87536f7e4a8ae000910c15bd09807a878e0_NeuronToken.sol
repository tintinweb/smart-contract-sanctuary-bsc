...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3BC649Fc8F7A63EB5AD9B937022BC34c34fcb428; // DEV
...
contract NeuronToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neuron Token";
    string private _symbol = "NT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3BC649Fc8F7A63EB5AD9B937022BC34c34fcb428); 
    address payable public teamWalletAddress = payable(0xdeAC5D84Ecd9aF19983982e7aDd635Bb99F6e7DB); 
