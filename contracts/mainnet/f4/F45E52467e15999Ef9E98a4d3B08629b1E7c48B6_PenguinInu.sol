...
contract PenguinInu is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000 * 10 ** 6;
    ...
    constructor () {
        ...
        Pair = IUniswapV2Factory(_pancakeswapv2Router.factory())
...
//Remove from Blacklist
    ...
    function _transfer(
        ...
        if (from == Pair && to != address(pancakeswapv2Router)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == Pair && recipient != address(pancakeswapv2Router);
