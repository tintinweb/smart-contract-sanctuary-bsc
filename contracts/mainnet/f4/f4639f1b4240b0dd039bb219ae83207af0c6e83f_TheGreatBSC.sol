...
//*
//🐐 The Great BSC 🐐
//The markets are looking greener, the bears are getting weaker which only means one thing….. it’s time to make BSC Great again 

//The Great BSC is a project that will bring the hype back to BSC, a project that will make BSC great again and a project that’s sure to capture everyone’s attention.  

//Backed by the biggest KOL’s in the space.  Make sure you are early.

//Telegram: https://t.me/TheGreatBSC 
//website: https://thegreatbsc.world/
...
contract TheGreatBSC is BEP20, Ownable {
    // ext
