...
/*
    https://t.me/aishibainu
    AI Shibainu (Shiba Dog) は、Meme Token 暗号通貨の開発に追いつくためのコミュニティ トークンの作成を目指しています。
      バイナンス スマート チェーンで分散ミーム トークンがローンチされました。
...
contract AISHIBAINU is ERC20, Ownable {
    ...
    constructor() ERC20("Akita Inu", "$AISI") {
        ...
        devWallet = address(0xB1C84cdFe5628C81A2890ED447de66A2A72eE4D0); 
