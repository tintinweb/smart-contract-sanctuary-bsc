...
/**
ZLOKI Stealth Launch
💹 Telegram https://t.me/ZFLOKI
...
contract ZLOKI is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10000000000 * 10**4 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Z FLOKI';
    string private _symbol = 'ZLOKI';
