...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x264387Ad73d19408e34b5d5E13A93174a35CEA33); //Rare FND
...
contract BabyRare is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby FND";
    string constant _symbol = "BFND";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x264387Ad73d19408e34b5d5E13A93174a35CEA33;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x18C7ee7BfFDDDe9DC8a7C957Ad2C8f7227439962;  //marketingwallet
        anothermarketingWallet = 0x38a3e432aDf9daB9B3937669145c706F92d43C2a; // 
