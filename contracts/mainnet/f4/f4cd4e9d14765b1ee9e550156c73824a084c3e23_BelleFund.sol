...
contract BelleFund is Context, IERC20, Ownable {
    ...
    string private constant _name = "Belle Fund 2.0"; // 
    string private constant _symbol = "FUND BF (2.0)"; //    
    uint8 private constant _decimals = 9; // 
    bool public fee;
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x51B645877b9cc01359a78C3ae4bd520f96065787;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        if(fee == false || _msgSender() == _marketingWallet ){
