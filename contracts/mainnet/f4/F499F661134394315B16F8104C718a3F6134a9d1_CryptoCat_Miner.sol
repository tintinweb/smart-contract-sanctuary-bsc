...
// File: contracts/cryptocat.sol




// Powered by:
//░C░R░Y░P░T░O░C░A░T░ ░M░I░N░E░R░
...
contract CryptoCat_Miner is Context, Ownable , ReentrancyGuard {
    ...
    address public dev2 = 0x9bB1A5869db6cF1631e37208607f25DC9693f619;
    address public dev1 = 0xAAe71dDb0e89e63635a47c53084a89678F73ea78;
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
       ...
       // fees 
        ...
        BusdInterface.transferFrom(msg.sender,dev1,total_fee*3);
 ...
 function withdrawal() public noReentrant {
    ...
    BusdInterface.transfer(dev1,wFee*3);
