...
contract BGBYINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bug Buby Inu";
    string private _symbol = "BGBYINU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x774fe3E4060342666C6F25D30070b04EeEaE8ddc);
    address payable public BurnedWalletAddress =
        payable(0x774fe3E4060342666C6F25D30070b04EeEaE8ddc);
    address public immutable deadAddress =
        0x774fe3E4060342666C6F25D30070b04EeEaE8ddc;
