...
library Address{
 ...
 contract Babycatcoin2 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_000_000_000_000 * 10**4;
    uint256 public maxBuyLimit = 10_000_000_000_000 * 10**4;
    uint256 public maxSellLimit = 10_000_000_000_000 * 10**4;
    uint256 public maxWalletLimit = 10_000_000_000_000 * 10**4;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x75abf540D3e6D0146dF9d16B9556fF684C6c4467;
    address public donationWallet = 0x75abf540D3e6D0146dF9d16B9556fF684C6c4467;

    string private constant _name = "Babycatcoin2.0";
    string private constant _symbol = "BABYCATS2";
    ...
    Taxes public taxes = Taxes(0, 79, 20, 0);
