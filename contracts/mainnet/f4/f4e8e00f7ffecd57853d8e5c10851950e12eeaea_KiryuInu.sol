...
contract KiryuInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Kiryu Inu";
    string constant _symbol = "KIRYU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 200) / 10000; // 1.5% on launch or 15k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 200) / 10000; // 1% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 200) / 10000; // 1.5% or 15k tokens
    ...
    uint256 public marketingFeeSell = 85;
    uint256 public devFeeSell = 0;
    uint256 public totalFeeSell = 95;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x32F826de43ebF82495E23FC49B6C806E643A3149;
        devFeeReceiver = 0xeb19614f3D7f15F97169Df62d58E857439F9391A;
