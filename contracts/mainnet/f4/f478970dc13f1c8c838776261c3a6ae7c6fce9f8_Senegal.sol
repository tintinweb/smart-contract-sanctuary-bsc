...
contract Senegal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Senegal";
    string private _symbol = "Senegal";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x249907003200e2DA800f3478847F09d29E38aC24); 
    address payable public BurnedWalletAddress = payable(0x249907003200e2DA800f3478847F09d29E38aC24); 
