...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31Ce468f88203BB9a0d716bB7965B3B279d2A522; // owner address
...
contract DeJavu is Context, IERC20, Ownable {
    ...
    string private _name = "DeJavu";
    string private _symbol = "$DJV"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb459a57c3cdAf8e9C344f8D1d4C9AfC94C3b60b9); // Marketing Address
    address payable public teamWalletAddress = payable(0xe8851EbF2997A62fDf1a8706972f891B5cff1B63); // Team Address
