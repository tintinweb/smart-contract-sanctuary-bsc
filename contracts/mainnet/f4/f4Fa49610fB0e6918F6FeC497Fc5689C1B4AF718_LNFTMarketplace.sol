...
contract LNFTMarketplace is Market {
    ...
    function buyItem(
        ...
        if (feeAmount != 0) {
            ...
            if (_isTokenPayment(_paymentToken)) {
                require(
        ...
        if (
            ...
            (bool ownerTransferSuccess, ) = _owner.call{
                value: listedItem.pricePerItem.sub(feeAmount)
            }("");
            require(ownerTransferSuccess, "ownerTransfer failed");
        }
