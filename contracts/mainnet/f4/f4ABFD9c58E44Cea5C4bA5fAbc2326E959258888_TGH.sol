...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                uint256 fundAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyFundFee3) / 10000;
                if (fundAmount > 0) {
                    feeAmount += fundAmount;
                    _takeTransfer(sender, address(this), fundAmount);
                }
            } else if (_swapPairList[recipient]) {//Sell
                uint256 fundAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellFundFee3) / 10000;
                if (fundAmount > 0) {
                    feeAmount += fundAmount;
                    _takeTransfer(sender, address(this), fundAmount);
                }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(tokenDistributor, fundAddress3, usdtBalance - fundUsdt - fundUsdt2);
    }
...
contract TGH is AbsToken {
    ...
    //USDT
        ...
        18,
        210000000,
        address(0x721958013878CFbE1D186336380E058813D748D5),
        address(0x5105d906632aF3ab6f18b4a26DFF86EF4A53eA2B),
        address(0x4B85941852c9A0F4376353c3FBF9dDD1EC07e4e0),
        address(0xE8E235aa82362a245866492ac28ab2653ABE2E64)
    ){
