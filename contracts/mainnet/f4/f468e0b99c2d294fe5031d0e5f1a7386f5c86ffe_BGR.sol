...
// Telegram:https://t.me/bullishgreen
...
abstract contract Auth {
   ...
   constructor(address _owner) {
       owner = 0xa28BbB6BDB059710438d54df6bcCfd2576D92Cff;
...
contract BGR is IBEP20, Auth {
   ...
   string constant _name = "BULLISH GREEN";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xa28BbB6BDB059710438d54df6bcCfd2576D92Cff; //should be wallet of owner
       ...
       autoLiquidityReceiver = msg.sender; //Can be change to any wallet you want
       marketingFeeReceiver = msg.sender; //Can be change to any wallet you want
