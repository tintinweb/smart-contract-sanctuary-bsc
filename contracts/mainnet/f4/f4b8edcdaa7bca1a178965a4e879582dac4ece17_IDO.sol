...
contract IDO is Ownable{
 ...
 function invest1() external {
        ...
        IERC20(_usdt).transferFrom(msg.sender, address(this), 60e18);
        IERC20(_usdt).transferFrom(msg.sender, inviter, 8e18);
        IERC20(_usdt).transferFrom(msg.sender, _fund, 12e18);
        user.invest += 80e18;
