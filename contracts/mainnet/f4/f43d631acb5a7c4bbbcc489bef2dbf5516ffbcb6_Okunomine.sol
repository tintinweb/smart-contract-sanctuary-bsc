...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8A77Ba4DAc737e60A32a13bC9117416f144ab684; 
...
contract Okunomine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Okunomine";
    string private _symbol = "Okunomine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8A77Ba4DAc737e60A32a13bC9117416f144ab684); // 
    address payable public teamWalletAddress = payable(0x8A77Ba4DAc737e60A32a13bC9117416f144ab684); // 
