...
contract SaudiShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Saudi Shiba";
    ...
    function setFees(uint256 _liquidityFee, uint256 _charityFee, uint256 _reflectionfee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
