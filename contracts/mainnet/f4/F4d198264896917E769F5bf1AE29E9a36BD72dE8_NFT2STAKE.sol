...
contract NFT2STAKE is IERC20 {
    ...
    string constant private _name = "NFT2STAKE";
    string constant private _symbol = "NFT2$";
    ...
    address payable public marketingWallet = payable(0xddcAF46Ab7b5CDA2bFf03dCc4f0bF2c272C21B96);
...
//===============================================================================================================
    ...
    function setProtectionSettings(bool _antiBlock) external onlyOwner {
        protections.setProtections(_antiBlock);
    }
