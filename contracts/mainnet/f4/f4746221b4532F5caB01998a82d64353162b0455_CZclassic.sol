...
contract CZclassic is IBEP20, Ownable {
    ...
    string constant _name = "CZ CLASSIC";
    string constant _symbol = unicode"czCLASSIC";
    ...
    address private marketingWallet = 0x62EF1e73e733Fe3B41efe838289BB10FBb166F8e;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 1, 1, 1);
    Fees public sellFees    = Fees(1, 1, 1, 1);
