...
contract Ownable is Context {
    address private _owner = 0x3540B729f04bEf3e7a1bA7439e3D80B041FEA0C9;
...
contract SurfTiger is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x8e45D5d9b5833d3D57D2766D4254b7ec3e0c42c2); // Marketing Address
    ...
    uint256 public _minTokensSwapToAndTransferTo = 5000000 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
