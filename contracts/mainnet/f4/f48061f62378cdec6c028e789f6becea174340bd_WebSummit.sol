...
contract WebSummit is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " WebSummit";
    string private _symbol = "WebSummit";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1a2781B49D0c72C1496f7646F6160e8400b68bd2); // Marketing Address
