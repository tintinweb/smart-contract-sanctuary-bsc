...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _maxTxAmount = 999999999999 * 10 ** Decimals;// 这里是 最大的买入卖出量
...
contract JZF is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0xa9BC2d97e88231e86066b987DB3b14e9eD4c2c6C),//营销钱包地址
    
        address(0xa9BC2d97e88231e86066b987DB3b14e9eD4c2c6C)//部署代币接收地址（部署的代币发送到这个钱包地址）
    ){
