...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x06fDECC23b4fC791121ae008C55b70bC17D13783); 
...
contract BabyZhao is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Baby Zhaoge";
    string  _symbol = "BZhao";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x4eBE1F5f5cCB17Ee5955Ef2D4dd975603Fde4895;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0xa9b44A6CC7AdBd30513daA29993b9Bcd2553b7fC;
