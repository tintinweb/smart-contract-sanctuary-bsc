...
Oscar Coin is the Next Generation Meme Token in cryptospace. We are community driven 
token based on the strenght of Community and strong holder.

Oscar Coin - a token for every person, both rookies and veterans of crypto investing. 
We are a fresh launch focusing on the community and enticing steady growth by any means necessary. 
Its time to Grow Up and take over the 
entire world! If we all stand up together, then we will reach this goal in no time!
...
contract OscarCoin is Context, IERC20 { 
