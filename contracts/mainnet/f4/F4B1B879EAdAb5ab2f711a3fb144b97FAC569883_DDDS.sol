...
contract DDDS  is IBEP20, Auth {
    ...
    string constant _name = "DDDS V2";
    string constant _symbol = "DDDS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply  / 3;
    uint256 public _maxWalletSize = _totalSupply / 2;
