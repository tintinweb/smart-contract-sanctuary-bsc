...
contract CAtpi is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xb33B1c080ba25Cc1313df64DdC40AfFAD5470F9F);

    string private _name = "Catpi";
    string private _symbol = "Catpi";
