...
contract StakeCA {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [2 days, 5 days, 10 days, 30 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [10, 25, 50, 200];
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        totalFee = 100;
        maxStakeableToken = 200000;
        percentDivider = 1000;
        minimumStakeToken = 10000;
    }
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xcDEDfb320293E34dec0e53BF6077f69c16c3A751; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0xabbD63DEAE7c13D0445C83A99C30592283D165B5); // TKN Token address 
