...
// XBloxToken.
contract XBloxToken is BEP20, MinterRole {
    ...
    uint256 public transferTaxRate = liquidityFee.add(buybackFee).add(marketingFee).add(burnFee);
    ...
    address public buyBackToken = address(0xb30B27aDb3B0A45e88385eB2BB144Fad9120A420); //buyBackToken
    ...
    constructor() BEP20('XTEST', 'XBX014') {
