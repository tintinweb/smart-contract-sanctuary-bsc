...
contract SquidDance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Dance";
    string private _symbol = "SQDANCE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75fd08e878d27194bA1E400A5b92d6263eFBE370); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x75fd08e878d27194bA1E400A5b92d6263eFBE370); // Development Address
    ...
    uint256 public _DevelopmentShare = 13;
