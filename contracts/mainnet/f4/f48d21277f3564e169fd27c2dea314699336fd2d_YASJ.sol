...
contract YASJ is IBEP20, Auth {
    ...
    address DEV = 0x2Ffc1D0A12Bab2cfc3E95cC661dD4402A5Af88Bd;
    ...
    // Name and symbol
    string constant _name = "YASJ";
    string constant _symbol = "YASJ";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // 0.50% 
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.50% 
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.50%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x2Ffc1D0A12Bab2cfc3E95cC661dD4402A5Af88Bd;
