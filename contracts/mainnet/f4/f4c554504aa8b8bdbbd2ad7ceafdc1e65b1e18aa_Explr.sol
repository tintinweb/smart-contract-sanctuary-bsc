...
contract Explr is Context, IERC20, Ownable {   
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Money Frog";  
    string private _symbol = "Money Frog";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7BF7637A57964badE4a83e39A1dB66D6B26BC6fB);  
    address payable private teamWalletAddress = payable(0x03F7Bb955e1e34E92B5d729a260DC8A7571d4F30);      
    ...
    uint256 private _totalSupply = 1 * 6**6* 10**6 * 6**_decimals;    
    uint256 public _maxTxAmount = 1 * 6**6 * 10**6* 6**_decimals;   
    uint256 public _walletMax = 1 * 6**6 * 10**6* 6**_decimals;       
