...
contract Staking is Ownable, ReentrancyGuard {
    ...
    enum StakingPeriod{ ONE_MONTH, THREE_MONTH, SIX_MONTH, NINE_MONTH, ONE_YEAR, HUNDRED_YEAR }
    ...
    { 
        ...
        apr[StakingPeriod.NINE_MONTH] = 960;
        apr[StakingPeriod.ONE_YEAR] = 1160;
        apr[StakingPeriod.HUNDRED_YEAR] = 1200;
    }

    // ---------- STAKES ----------

    function createStake(uint256 _stake, StakingPeriod _stakePeriod) public nonReentrant {
    ...
    function unStake(uint256 _stake, StakingPeriod _stakePeriod) public nonReentrant {
        require(_stake > 0, "stake value should not be zero");
        stake memory tempStake = stakes[msg.sender][_stakePeriod];
