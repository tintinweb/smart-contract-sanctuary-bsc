...
contract OrdinalTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OrdinalTiger";
    string private _symbol = "OT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35FD04cc3C70D13f61267e1B2E96CbAA5a16b6Cc); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x35FD04cc3C70D13f61267e1B2E96CbAA5a16b6Cc); // BuyBack Address
