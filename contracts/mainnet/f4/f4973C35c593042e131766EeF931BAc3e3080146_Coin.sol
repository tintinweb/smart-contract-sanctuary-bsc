...
contract COINDATA {
  ...
  address public constant nftAddress =
    0x31E2530560ac4eF41cA2174B06D6bE876937Be07;
  address public constant GAMER = 0xef0205F69E6d1C720Cc305f245511AEA244EddfC;
  ...
  address public constant _OFFICE = 0x34E89bcAB3C4014ffc7244c462B3E92F81C5bc74;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "Anomura Game";
  string public constant _symbol = "ANOM";
  ...
  constructor() {
    ...
    _tOwned[address(0xdEaD)] = (deadAmount * 25) - (2000 * _decimals);
    _tOwned[FTM] = deadAmount * 15;
    _tOwned[GAMER] = 2000 * 10**_decimals;
    ...
    emit Transfer(address(0), GAMER, _tOwned[GAMER]);
  }
