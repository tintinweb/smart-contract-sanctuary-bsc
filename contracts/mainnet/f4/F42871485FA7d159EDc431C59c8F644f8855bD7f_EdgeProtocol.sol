...
/*
Edge Protocol 🏔
With cross-margin spot, perpetuals, and money market functionalities, this DEX enables users to trade, earn, and borrow all in one place.
...
contract EdgeProtocol  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Edge Protocol';
    string private _symbol = 'EDGE';
