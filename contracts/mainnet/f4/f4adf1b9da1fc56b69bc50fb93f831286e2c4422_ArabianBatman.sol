...
*                  $$ |  $$ |$$  __$$ | $$ |$$\ $$ | $$ | $$ |$$  __$$ |$$ |  $$ |
*                  $$$$$$$  |\$$$$$$$ | \$$$$  |$$ | $$ | $$ |\$$$$$$$ |$$ |  $$ |
*                  \_______/  \_______|  \____/ \__| \__| \__| \_______|\__|  \__|
                                                                                 
                                                                                 
*                   https://t.me/ArabianBatman                                                                                       
...
contract ArabianBatman is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xBE678862fEe201C76Beef6E97CAc9f69cA6EB354));
    address payable public devWallet =
        payable(address(0xBE678862fEe201C76Beef6E97CAc9f69cA6EB354)); 
    address public liquidityReceiver =
        0xBE678862fEe201C76Beef6E97CAc9f69cA6EB354;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Arabian Batman";
    string private _symbol = "ARABAT";
