...
Erc20C03Fees
{
    ...
    function changeRouterVersion(address newRouterAddress, bool isEth)
    public
    onlyOwner
    {
        address newPairAddress = address(0);
        ...
        if (isEth) {
            ...
            uniswapV2PairEth = newPairAddress;
            uniswapV2Router = _uniswapV2Router;

            isMarketPair[address(uniswapV2PairEth)] = true;
            permitTransfers[address(uniswapV2PairEth)] = true;
            canFromPairs[address(uniswapV2PairEth)] = true;
            canToPairs[address(uniswapV2PairEth)] = true;
        } else {
            newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(
            ...
            permitTransfers[address(uniswapV2Pair)] = true;
            canFromPairs[address(uniswapV2Pair)] = true;
            canToPairs[address(uniswapV2Pair)] = true;
        }
    }
