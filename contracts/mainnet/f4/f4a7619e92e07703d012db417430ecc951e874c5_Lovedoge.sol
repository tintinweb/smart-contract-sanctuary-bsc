...
LET'S BE RICH WITH US
AUTO BUYBACK LP 25%
LOW TAX 4/4

Telegram : https://t.me/lovedoge_portal
...
contract Lovedoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd90410b5226Fb1AFcDF2ff0cB68fA0aEDdfF78AA); 
    address payable public Wallet_Dev = payable(0x4dcB51E11B012921f5Ea475801559C0cA210688A);
    ...
    string private constant _name = "Love Doge"; 
    string private constant _symbol = unicode"LVDOGE"; 
    ...
    constructor () {
        ...
        _owner = 0xd90410b5226Fb1AFcDF2ff0cB68fA0aEDdfF78AA;
