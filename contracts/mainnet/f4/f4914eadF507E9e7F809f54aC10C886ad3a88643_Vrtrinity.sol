...
VR-TRINITY is a metaverse project with the goals of creating a VR treasure-hunt
 gaming platform. $VRT is a part of the metaverse family of tokens.
  VR-TRINITY Token $VRT will be the official token within the game, $VRT is a BEP20 
  token running on the binance smart chain

  https://vr-trinity.com/
  https://twitter.com/vrtrinity_token?s=11
  https://www.facebook.com/VRTRINITYtoken/
  https://t.me/VrTrinity
  https://discord.com/invite/r9QfTefHAZ
...
contract Vrtrinity is VrtrinityDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private VrtrinityTeam;
    address private CharityVrtrinity;
    ...
    string public override name = "Vrtrinity";
    string public override symbol = "VRT";
    ...
    constructor(uint totalSupplyValue, address VrtrinityTeamAddress, address CharityVrtrinityAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        VrtrinityTeam = VrtrinityTeamAddress;
        CharityVrtrinity = CharityVrtrinityAddress;
        
        // split the tokens according to agreed upon percentages
        balances[VrtrinityTeam] =  totalSupply * 4 / 100;
        balances[CharityVrtrinity] = totalSupply * 4 / 100;
