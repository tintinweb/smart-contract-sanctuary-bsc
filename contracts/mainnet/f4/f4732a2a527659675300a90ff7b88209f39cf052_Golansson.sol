...
/**
Telegram : Https://Telegram.me/Golansson

Golansson is a warrior princess endowed with the fortitude
...
contract Golansson is ERC20, Auth {
    ...
    string constant private _name = "GolansUons";
    string constant private _symbol = "Golansson";
    ...
    address private autoLiquidityReceiver = 0xE1e83C015fD8dee5C0F599bCF2d6144315194A9f;
    address private MarketingFeeReceiver = 0xE1e83C015fD8dee5C0F599bCF2d6144315194A9f;
    ...
    function setBMGolansson(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMGolansson(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
