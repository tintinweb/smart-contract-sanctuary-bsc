...
/**
STEALTH LAUNCH A
TG: https://t.me/SpookyHalloweenShiba
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A08B4d4a9a42B3d3aE59A864b2667e2971281E1; // owner address
...
contract Spookyhalloweenshiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Halloween Shiba";
    string private _symbol = "SHB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDc66850b66eacd750A00e5Dfa6e1975dfB5B320A); // Marketing Address
    address payable public teamWalletAddress = payable(0xDc66850b66eacd750A00e5Dfa6e1975dfB5B320A); // Team Address
