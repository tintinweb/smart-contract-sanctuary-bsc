...
contract SolSisters is IERC20, IERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;

    address private constant libraryAddress = 0x52d4A89E5AadD50ef006Db9c5b797C99E07f21d3;

    uint256 private constant _totalSupply = 6969696969 * 10**9;

    string private constant _name = "SolSisters";
    string private constant _symbol = "SOLS";
