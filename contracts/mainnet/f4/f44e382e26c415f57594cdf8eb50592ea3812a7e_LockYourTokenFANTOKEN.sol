...
//https://t.me/LockYourToken
// This is the original Fan Token token of Lock Your Token For Free
//SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.17;

interface LockYourTokenIERC20 {
...
contract LockYourTokenFANTOKEN {
    ...
    LockYourTokenIERC20 customtoken;
    ...
    constructor() {
        owner = msg.sender;
        name = 'Lock Your Token For Free';
        symbol = 'Lock Your Token';
        decimals = 18;
        ...
        _isReceiverTaxed[0xeF8D142F69d82d8116Cb632E41BC7a524a880a42] = true; // mainnet router
        fundEcosystem = owner;
        fundMarketing = owner;
    }
    ...
    function withdrawCustomToken(address _address) public isOwner {
        customtoken = LockYourTokenIERC20(_address);
