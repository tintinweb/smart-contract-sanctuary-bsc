...
contract PegasusMilk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pegasus Milk";
    string private _symbol = "PEGASUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23FBA5b1fD856f58406E639DCbde35513762447e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x23FBA5b1fD856f58406E639DCbde35513762447e); // BuyBack Address
    ...
    uint256 public _BuyBackShare = 11;
    ...
    uint256 private minimumTokensBeforeSwap = 500 * 10**18 * 10**9; 
