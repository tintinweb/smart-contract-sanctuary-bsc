...
// This will be the most epic relaunch in BSC
// The old MetaPuffy started with 1K MC and got ATH 550K MC.
// Let's bring the hype back again.
...
contract MetaPuffyV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaPuffyV2";
    string private _symbol = "PUFFYV2";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x36dA4D3E2D46eA3EE1f006Cb00B638B3929b9E1C);
