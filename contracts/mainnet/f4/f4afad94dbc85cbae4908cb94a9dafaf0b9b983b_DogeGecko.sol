...
/**
   ...
   Degen play, If you want to create a telegram I suggest to name it to @DogeGeckoBSC
   Important: The early you create a group that shares the token, the more gain you'll get.

   I will renounce the ownership to burn addresses to transfer #DOGECKO to the community, make sure it's 100% safe.
...
contract DogeGecko is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Gecko";
    string private _symbol = "DOGECKO";
