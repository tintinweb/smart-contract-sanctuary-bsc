...
/**
 *   Fuck all callers, no reply in time and expansive prices. Negative ROI
*/
...
contract CallerssucksNGL is Context, IERC20, Ownable {
    ...
    string private _name = "CallerssucksNGL";
    string private _symbol = "CallerssucksNGL";
    ...
    uint256 private maxTxPercent = 49; // Less fields to edit
    ...
    uint256 private maxWalletPercent = 49; // Less fields to edit
