...
contract PINKBOY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PinkBoy BSC";
    string private _symbol = "PINKBOY";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xca7cDB6975e02aC74483600530DB6545D048a8b6);
