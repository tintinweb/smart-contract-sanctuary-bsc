...
contract MOONMAN is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 8000 * 10**_decimals;
    uint256 public _maxTxAmount = 8000 * 10**_decimals; 
    uint256 public _walletMax = 8000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB1F95e1420369B25556921005148856A26936a3e));
        marketingWalletAddress = payable(address(0xB1F95e1420369B25556921005148856A26936a3e));
