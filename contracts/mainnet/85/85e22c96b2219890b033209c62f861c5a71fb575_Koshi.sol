...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/KoshiPortal

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://www.koshitoken.com

𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/KoshiToken
...
contract Koshi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    KoshiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Koshi", "KOSHI") {
        MarketingWallet = payable(0xd72Db6b66D9D9bBF60eAFaf7e196c9CA14c2344A);
        TeamWallet = payable(0x1BfABBaAc92Eb4BA787EF46DE8675c52e01015C5);
        ...
        dividendTracker = new KoshiDividendTracker(
            payable(this),
            router,
...
contract KoshiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        KoshiContract = Koshi(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Koshi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Koshi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Koshi contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(KoshiContract);

            uint256 prevBalance = KoshiContract.balanceOf(address(this));
            ...
            {
                uint256 received = KoshiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    KoshiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
