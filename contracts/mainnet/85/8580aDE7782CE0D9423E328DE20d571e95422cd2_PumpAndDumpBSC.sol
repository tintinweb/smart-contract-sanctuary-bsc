...
/**               
Telegram : https://t.me/PumpAndDumpBSC
Website : TBA
...
contract PumpAndDumpBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PumpAndDumpBSCDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PUMP AND DUMP ", "PND") {
        marketingWallet = payable(0x7442Efb228F4822bC7F55D96E629e97Fe6F9B905);
        devWallet = payable(0x7442Efb228F4822bC7F55D96E629e97Fe6F9B905);
        ...
        dividendTracker = new PumpAndDumpBSCDividendTracker(
            payable(this),
            router,
            0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,
            "PumpAndDumpBSCTRACKER",
            "PumpAndDumpBSCTRACKER"
        );
...
contract PumpAndDumpBSCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PumpAndDumpBSC public PumpAndDumpBSCContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PumpAndDumpBSCContract = PumpAndDumpBSC(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PumpAndDumpBSC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PumpAndDumpBSC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PumpAndDumpBSC contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PumpAndDumpBSCContract);

            uint256 prevBalance = PumpAndDumpBSCContract.balanceOf(address(this));
            ...
            {
                uint256 received = PumpAndDumpBSCContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PumpAndDumpBSCContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
