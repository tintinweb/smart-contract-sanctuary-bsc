...
contract  KittyNobiBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittyNobiBSC";
    string private _symbol = "$KINOBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xACAd36d579d2A9b0B7D5C0c506E546dA8660ae03); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xACAd36d579d2A9b0B7D5C0c506E546dA8660ae03); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (80 * 10**6 * 10**9), "Max wallet should be less or euqal to 8% totalSupply");
