...
contract URSS is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Soviet Cat";
    string private constant _symbol = "URSS";
    ...
    uint256 public _floorLiquidityFee = 1;
    uint256 public _floorReflectionFee = 2;
    uint256 public _floorDevFee = 0;

    uint256 public _slideBuybackFee = 0;
    uint256 public _slideMarketingFee = 7;
    uint256 public _slideLiquidityFee = 1;
    ...
    address payable  _marketingAddress = payable(0x3043C55bDEBBAf3aea57cEB4A6b162BD22f91017);
    address payable  _buybackAddress = payable(0x3043C55bDEBBAf3aea57cEB4A6b162BD22f91017);
    address payable constant  _projectMaintainence = payable(0x3043C55bDEBBAf3aea57cEB4A6b162BD22f91017);
    address payable  _developmentAddress = payable(0x3043C55bDEBBAf3aea57cEB4A6b162BD22f91017);
