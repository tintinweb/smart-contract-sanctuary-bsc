...
Fan Token
Limited Edition Figures in the Multiverse. 
DoggoBrick will always stand beside you.
	
@DoggoBrick
Figital Culture & Brand
(Figures + Digital Art)

Discord: http://discord.gg/doggobrick
Communitylinktr.ee/DoggoBrick
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.13;

abstract contract ContextRelay {
...
contract OwnableRelay is ContextRelay {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableRelay: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableRelay: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DoggoBrick is ContextRelay, DoggoBrickRelay, OwnableRelay {
    ...
    string private _name = 'DoggoBrick';
    string private _symbol = 'DoggoBrick';
