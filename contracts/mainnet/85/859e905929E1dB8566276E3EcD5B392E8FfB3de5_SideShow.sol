...
contract SideShow is ERC721Enumerable, Ownable {
  using Strings for uint256;
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x2Ac5e9bb7421496Bb55Cb215C33B705C7a4aA28c).call{value: address(this).balance * 10 / 100}("");
    require(hs);

    (bool cs, ) = payable(0xEFc6293b56D506f48Ff9ad55EACA05951f853506).call{value: address(this).balance * 11 / 100}("");
    require(cs);
