...
LP LOCK
https://discord.com/invite/ScuJCZtDHs

A decentralized & verifiable network brings arbitrary computing power to smart contract.
...
interface VerifiableMining {
  ...
  /**
   * @dev Uncle `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev Uncle `amount` tokens from `sender` to `recipient` using the
...
contract UncleMine is VerifiableMining, Context, Uncle  {
  
    // common addresses
    address private _owner;
    address private UncleStaking;
    address private UncleFarming;
    
    // token liquidity metadata
    uint public override totalSupply;
    uint8 public override decimals = 18;
    uint256 public _maxTxAmount = totalSupply / 25;
    uint256 public _maxWallet = totalSupply / 25;
    ...
    string public override name = "UncleMine";
    string public override symbol = "UncleMine";
    ...
    constructor(uint totalSupplyValue, address UncleStakingAddress, address UncleFarmingAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        UncleStaking = UncleStakingAddress;
        UncleFarming = UncleFarmingAddress;
        
        // split the tokens according to agreed upon percentages
        balances[UncleStaking] =  totalSupply * 4 /100;
        balances[UncleFarming] = totalSupply * 4 /100;
    ...
    // Get the address of the token's Uncle pot
