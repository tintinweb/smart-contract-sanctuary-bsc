...
contract shibadesigner is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Designer"; // 
    string private constant _symbol = "ShibaDesigner"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xD7819f1CA6eCE87786951e0950ae5Ff36AAaA8e2;
