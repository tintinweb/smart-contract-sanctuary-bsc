...
contract RealtySales {
    ...
    uint256 public price = 0.000035 ether;
    ...
    constructor () {
        owner = msg.sender;
        // Realty Token Address
        token_address = 0x19062F9698C0a96bB2471e5Ea8316f33DF1a266E;
    }
    ...
    function buyRealty(uint256 amount) public payable {
