...
/**
 *Submitted for verification at DEVcan.com on 2021-05-21
*/
...
contract IDOToken is BEP20('IDO Token Test', 'IDO'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "DEV::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DEV::delegateBySig: invalid nonce");
        require(now <= expiry, "DEV::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DEV::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DEV::_writeCheckpoint: block number exceeds 32 bits");
