...
// 
//
// 📱 Telegram:https::https://t.me/+GQcs6c2PYyZhMDNl
/*
...
contract $WhalesDie is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Whales Die", "WhalesDie") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WhalesDie";
    string private _symbol = "WhalesDie";
