...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42715B7259E4985265a76BD63727504636f57bba;
...
contract Safu is Context, IERC20, Ownable {
    ...
    string private _name = "2k23YuanYuan";
    string private _symbol = "2k23YuanYuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42715B7259E4985265a76BD63727504636f57bba);
    address payable public teamWalletAddress = payable(0x42715B7259E4985265a76BD63727504636f57bba);
