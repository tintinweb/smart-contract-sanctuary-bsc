...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF);
...
contract Based is IBEP20, Auth {
    ...
    address DEV = 0x6fa37F444BcCEA1820BF4F8D58606f25Ee909720;
    ...
    // Name and symbol
    string constant _name = "Based? Are you fucking kidding me? I spent a decent portion of my life writing all of that and your response to me is Based"
"Are you so mentally handicapped that the only word you can comprehend is based "
"or are you just some fucking asshole who thinks that with such a short response, he can make a statement about how meaningless what was written was?"
"Well, I'll have you know that what I wrote was NOT meaningless, in fact,"
"I even had my written work proof-read by several professors of literature."
" Don't believe me? I doubt you would, and your response to this will probably be Based once again."
"Do I give a fuck? "
"No, does it look like I give even the slightest fuck about five fucking letters? "
"I bet you took the time to type those five letters too, I bet you sat there and chuckled to yourself for 20 hearty seconds before pressing send. "
"You're so fucking pathetic. I'm honestly considering directing you to a psychiatrist, but I'm simply far too nice to do something like that."
"You, however, will go out of your way to make a fool out of someone by responding to a well-thought-out, intelligent, or humorous statement that probably took longer to write than you can last in bed with a chimpanzee."
"What do I have to say to you? Absolutely nothing. I couldn't be bothered to respond to such a worthless attempt at a response. Do you want Based on your gravestone?";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10 / 10000; // .1% 
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 10000; // .1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x6fa37F444BcCEA1820BF4F8D58606f25Ee909720;
