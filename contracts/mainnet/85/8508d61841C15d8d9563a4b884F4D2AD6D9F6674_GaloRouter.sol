...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'cb9223983972e53d07aa9304d34e29d36df82284dd2960589e912941db862e61' // init code hash
            ))));
    }
...
import '../libraries/interfaces/IUniswapV2Router01.sol';

interface IGaloRouter is IUniswapV2Router01 {
  function removeLiquidityETHSupportingFeeOnTransferTokens(
    address token,
    uint liquidity,
    uint amountTokenMin,
