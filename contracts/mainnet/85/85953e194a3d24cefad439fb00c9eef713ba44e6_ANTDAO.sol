...
contract ANTDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ANTDAO";
    string private _symbol = "ANTDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62198c8ba174fEbA41AfF668831C6555ac873ad5); 
    address payable public teamWalletAddress = payable(0xCD19eca1370D71AE73b584A5f585425241d77378); 
    ...
    uint256 private minimumTokensBeforeSwap = 20000000 * 10**3; 
