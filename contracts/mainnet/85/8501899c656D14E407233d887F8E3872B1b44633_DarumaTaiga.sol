...
contract DarumaTaiga is Context, IERC20, Ownable {
    ...
    string private constant _name = "DARUMA TAIGA"; // 
    string private constant _symbol = "DARUMA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xC2E5fA2BF237c0BF1b80988167657281831dEbA2
