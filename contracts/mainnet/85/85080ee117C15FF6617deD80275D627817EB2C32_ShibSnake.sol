...
contract ShibSnake is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shib Snake"; // 
    string private constant _symbol = " $ShibSnake"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x787E20850e4Fa340eC5F969304Bf183C70C90bC4;
