...
contract TWEET is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DutyInu";
    string constant _symbol = "DUTY";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x9Ab8eEE90Fd787dF54c80f772265Fe3796eE137f;
