...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x89335248675BD2DD6331cE14eEdE085365466236;
...
contract cr is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Creep It Real"; 
    string private constant _symbol = unicode"C👻R"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x89335248675BD2DD6331cE14eEdE085365466236), BNB_Tot);
            }
