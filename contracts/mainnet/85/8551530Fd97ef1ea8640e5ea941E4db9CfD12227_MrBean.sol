...
contract MrBean is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner { //1860 Add name + sumbol
  	    maxWalletToken = _maxToken * (10**18);
  	}
              //Contract By: TG @HexAKang
    constructor() ERC20("BeanFactory", "BEAN") {
        BNBRewardsFee = 9;
        liquidityFee = 2;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 5;
        marketingWallet = payable(0xeFA8B43e594C635D9B6669e6241BAAe9AAcC4327);
