...
/**
// Floki 2023 
     ______    __           __      _           ___    ____    ___    _____
    / ____/   / /  ____    / /__   (_)         |__ \  / __ \  |__ \  |__  /
   / /_      / /  / __ \  / //_/  / /          __/ / / / / /  __/ /   /_ < 
  / __/     / /  / /_/ / / ,<    / /          / __/ / /_/ /  / __/  ___/ / 
 /_/       /_/   \____/ /_/|_|  /_/          /____/ \____/  /____/ /____/                                                                                                                                                

// TG: https://t.me/floki_2023
// Website: https://floki2023.com
*/
...
contract Floki2023 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Floki2023DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Floki 2023", "2023") {
        marketingWallet = payable(0x323E4EC136c34e46AB8ff0b1E7B1a9a22fA3CE46);
        devWallet = payable(0xB97e4efA596b74448320673CBa68300308631a54);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 7;
        sellMarketingFees = 11;
        buyLiquidityFee = 1;
        sellLiquidityFee = 2;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new Floki2023DividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "Floki2023DividendTracker",
            "2023TRACKER"
        );
    ...
    function setGasPriceLimit(uint256 GWEI) external onlyOwner {
        require(GWEI >= 7, "can never be set below 5");
...
contract Floki2023DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Floki2023 public Floki2023Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        Floki2023Contract = Floki2023(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Floki2023_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Floki2023_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Floki2023 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Floki2023Contract);

            uint256 prevBalance = Floki2023Contract.balanceOf(address(this));
            ...
            {
                uint256 received = Floki2023Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Floki2023Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
