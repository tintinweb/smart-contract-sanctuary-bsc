...
/**
https://t.me/Yonkoluffyinu

☠️THE NEW EMPEROR OF ONEPIECE ☠️
...
library Address{
 ...
 contract yonkoluffyinu is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 80000000000000000000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 80000000000000 * 10**9;
    uint256 public maxBuyLimit = 80000000000000000000000 * 10**9;
    uint256 public maxSellLimit = 80000000000000000000000 * 10**9;
    uint256 public maxWalletLimit = 80000000000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x92a4b92f7f6e2DDCd7f795a32ab97C4244C84815;
    address public teamWallet = 0x92a4b92f7f6e2DDCd7f795a32ab97C4244C84815; 

    string private constant _name = "YONKOLUFFYINU";
    string private constant _symbol = "YLINU";
    ...
    Taxes public taxes = Taxes(2, 5, 0, 2);
