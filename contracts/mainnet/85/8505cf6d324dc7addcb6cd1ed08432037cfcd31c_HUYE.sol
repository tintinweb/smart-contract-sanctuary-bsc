...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd621d2d13d1F1800885D6814B15A718A31852583;
...
contract HUYE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd621d2d13d1F1800885D6814B15A718A31852583;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lord Tiger Inu";
    string private _symbol = "HuYe";
