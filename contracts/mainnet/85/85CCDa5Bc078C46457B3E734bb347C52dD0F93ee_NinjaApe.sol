...
Stealth launching shortly, Ninja Ape is a new Ninja play that has been lowkey so far. Overall could do well given all of the Ape hype recently! This is going to be a stealth launch that drops soon so make sure to check it out! 

As always trade responsibly, and check out $NINAPE! 

Our Saviour Ninja Ape, a project centered around the one true God Vitalik Buterin. Without him we would be lost in the Blockchain. Poor, naked & afraid. He has single handedly changed the life of all of us degens in this BSC Metaverse and to him we owe all that we have. So this token is dedicated to him. We want all of the BSC Metaverse to join hands and thank the man behind our wealth.
...
contract NinjaApe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NinjaAPE";
    string constant _symbol = "NINAPE";
    ...
    uint256 _totalSupply = 8888888888888888 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x2A6711F40155b6157D9c232eB33F7fEDCeE2a263;
