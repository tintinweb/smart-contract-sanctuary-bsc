...
contract AI is Context, IERC20, Ownable {
    ...
    string private _name = "Ai ROBOT";
    string private _symbol = "AIrobot";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8966697137E53DD1B96650d728Aa72D81920F0A0); // Marketing Address
    address payable private teamWalletAddress = payable(0x8966697137E53DD1B96650d728Aa72D81920F0A0); // Team Address
