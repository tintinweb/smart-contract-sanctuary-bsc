...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30FCffeF950E3A1da6FB70734c335A1ebAc22473; // owner address
...
contract HappyHolidays is Context, IERC20, Ownable {
    ...
    string private _name = "Happy Holidays";
    string private _symbol = "$HAPPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x475Ecc77fD4F00937a766961bED4dB3cb60be224); // Marketing Address
    address payable public teamWalletAddress = payable(0x475Ecc77fD4F00937a766961bED4dB3cb60be224); // Team Address
