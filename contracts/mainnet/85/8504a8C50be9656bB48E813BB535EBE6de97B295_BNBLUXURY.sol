...
//  
//  Deposit fee: 5%
//  Deposit withdrawal fee: 5%
//
//  Profit reinvestment fee: 0%
//  Profit withdrawal fee: 0%
//
//  Referral rewards: 8% - 8% - 3% - 2% - 2%
//
//
...
contract BNBLUXURY {
    ...
    uint256 constant internal LAUNCH_TIME = 1672896663;

    uint8 constant internal PRECENT_DIVEDER = 100;

    uint32 constant internal DEPOSIT_PERIOD = 60*60*24;
    uint8 constant internal DEPOSIT_RATE = 25; //25% Daily

    uint256 constant internal MIN_DEPOSIT = 0.01 ether;
    uint256 constant internal MAX_DEPOSIT = 50 ether;

    address constant internal FEE_ADDRESS = 0x29A19756f75281D8ACf470A44b14848b6a603913;
    uint8 constant internal DEPOSIT_FEE = 5;
    uint8 constant internal WITHDRAW_FEE = 5;

    address constant internal DEFAULT_REFERRER = 0xac5A96F9021389f7D1b962b171b2cee91e883782;
    ...
    // ------
    	...
    	function calculaterewards(uint256 _amount) public onlyRegistered {
