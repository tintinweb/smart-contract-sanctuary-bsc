...
contract TBit is IERC20, Ownable {
    ...
    address private fundAddress = address(0xD8C3bA0B1483A8f4b9aD7Fc3Ae71A0542Dfc94e4);
    address private fundAddress2 = address(0xCEf0b42e10b1e67EDf097683715E1501D898862E);
    address private lpAddress = address(0x756fBa9A31a8970E5D8c20eDF30Bc0F8Be6adF36);
    ...
    constructor() {
        _name = "Batter International Token";
        _symbol = "BIT";
        _decimals = 18;
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                require(balanceOf(from).mul(99).div(100)>=amount,"limit min");
            }
            takeFee = true;
        }else{
