...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 2100000000 * 10** Decimals;
        walletLimit =  2100000000 * 10** Decimals;
        ...
        holderRewardCondition = 50000000 * 10 ** IERC20(FISTAddress).decimals();
...
contract CORE is AbsToken {
    constructor() AbsToken(
        ...
        8,//Decimals
        2100000000,//Supply
        address(0x074e436C614ee3F34Ee21844cE2bfb514c2e8D33),//FundAddress
        address(0x074e436C614ee3F34Ee21844cE2bfb514c2e8D33)//ReceiveAddress
    ){
