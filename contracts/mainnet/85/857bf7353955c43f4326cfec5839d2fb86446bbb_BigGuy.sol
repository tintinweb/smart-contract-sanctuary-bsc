...
Featuring:
You must hold a minimum balance of .1bnb in your wallet to buy this token.
...
contract BigGuy is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "BigGuy";
    ...
    uint256 public _walletMax = _totalSupply * 30 / 1000; //starts at .1%
    uint256 public minBNB = 5 * (10**18) / 10; //minbnb for buy is .1
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x9e81a95C352F766c5eE7ed45E289710bB085013B; //LP receiver
        marketingWallet = 0x9e81a95C352F766c5eE7ed45E289710bB085013B;  //Marketing wallet
	...
	function checkTxLimit(address sender, address recipient, uint256 amount) internal view {
		if (sender != owner
            ...
            require(recipient.balance > minBNB);
    ...
    function setBNBMin(uint256 newMin) external authorized {
        minBNB = newMin * (10**18) / 10;
    }
