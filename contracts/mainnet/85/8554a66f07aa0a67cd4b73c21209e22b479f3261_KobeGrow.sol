...
contract KobeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kobe Grow";
    string private _symbol = "BEGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd282C5c3F4Bb7d61AFBDFe18f0b6B6dC384A2d4e);
    address payable public BuyBackWalletAddress = payable(0xd282C5c3F4Bb7d61AFBDFe18f0b6B6dC384A2d4e);
