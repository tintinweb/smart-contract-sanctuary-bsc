...
Telegram : https://t.me/AlveyMuuinu
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd2F6C29e4Bd62b1C92a81852DC6edd2Aa40e0BFB;
...
contract AVLEYMUUINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALVEY MUU INU"; // 
    string private constant _symbol = "$AMI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xd2F6C29e4Bd62b1C92a81852DC6edd2Aa40e0BFB);
