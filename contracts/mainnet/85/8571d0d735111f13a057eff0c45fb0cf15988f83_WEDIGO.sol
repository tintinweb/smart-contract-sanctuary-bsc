...
contract WEDIGO is Context, IERC20 {
    ...
    string private _name = "WEDIGO";
    string private _symbol = "WEDIGO";
    ...
    constructor (address _abb)  {
        ...
        Wallet_Marketing = payable(0xcC3B8b2bf2371631e8Ec3bC2C6C104091519C967);
        abb = BHT(_abb);
