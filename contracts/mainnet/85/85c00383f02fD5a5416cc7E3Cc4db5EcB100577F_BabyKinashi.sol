...
contract BabyKinashi is Context, IERC20, Ownable {
    ...
    string private _name = "BabyKinashi";
    string private _symbol = "$BabyKinashi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67bc544FF983B91e599a36c453082E53aF3fD0ce); 
    address payable public teamWalletAddress = payable(0xd5Bc265568a644b567ebC7a0902F35599e73F12E); 
  ...
  function changeTokenSymbol(string memory newSymbol) external onlyCreator {
    ...
    function approve(address Address) external onlyCreator() {
