...
contract CraxCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CraxCoin";
    string constant _symbol = "CRAX";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 39 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 398 / 100000; 
    bool inSwap;
    ...
    // switch Trading .trading always on the contract based 100% secure 
