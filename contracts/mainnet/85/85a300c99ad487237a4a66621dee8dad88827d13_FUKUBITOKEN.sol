...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9936e529f761f44D7086baA9CcFA71B6b9f0d515;
...
contract FUKUBITOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x03768D67D2aAf08a3524C64c0dAc1C864dbA22d4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FUKUBIToken";
    string private _symbol = "FKB";
