...
contract Ownable is Context {
    ...
    contract AKS is Ownable, IBEP20 {
    ...
    string constant _name = "akatsuki inu";
    string constant _symbol = "AKS";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xaF6aae8136A777216432B9BEd985df4A01f951aD;
        marketingWallet = 0xaF6aae8136A777216432B9BEd985df4A01f951aD;
        dfWallet = 0xaF6aae8136A777216432B9BEd985df4A01f951aD;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(dfFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBDf = amountBNB.mul(dfFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(dfWallet).call{value : amountBNBDf, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 5, "Max gas should be higher than 5 gwei");
        gas = newGas * 1 gwei;
    }
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDfFee, uint256 extraSellFee) external onlyOwner {
