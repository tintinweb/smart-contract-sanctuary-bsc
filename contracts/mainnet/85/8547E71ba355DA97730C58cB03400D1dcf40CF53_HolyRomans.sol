...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract HolyRomans is ERC721A, Ownable {
        using Strings for uint256;

        uint256 public constant RESERVED_TOKENS = 0;
        uint256 public constant FOR_SALE_TOKENS = 3000 - RESERVED_TOKENS;
        ...
        uint256 public tokenPricePresale = 0.001 ether;
        uint256 public tokenPricePublicSale = 0.001 ether;

        uint256 public maxTokensPerAddressPresale = 20;
        ...
        string public tokenBaseURI = "ipfs://QmQnYpYsoACJB6FNUNcGfsLbw7tPbZw6bJsNg2junA8Nre/";
        string public tokenURIExtension = ".json";

        uint256 public soldAmount = 0;
        mapping(address => uint256) public purchased;

        constructor() ERC721A("Holy Romans", "Holy Romans") {
        ...
        function getLastMinted(address target) external view returns(uint256){
            for (uint256 idx = _currentIndex - 1; idx >= _startTokenId(); idx--){
                if(ownerOf(idx) == target){
                    return idx;
                }
            }
            return 0;
        ...
        function setTokenURIExtension(string calldata extension) external onlyOwner {
