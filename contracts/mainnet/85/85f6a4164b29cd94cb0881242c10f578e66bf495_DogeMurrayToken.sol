...
/*
    ...
    Telegram    : https://t.me/dogemurray
    Website     : https://twitter.com/dogemurray
    Twitter     : https://dogemurray.io/

    COME AND JOIN OUR OFFICIAL CHANNEL
    LETS MOON WITH MURRAY FOR SECOND TIMES
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCa70A263FeEDaf39907B9aEEc1F86dff2Ce194f8; // owner address
...
contract DogeMurrayToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Doge Murray";
    string private _symbol = "$DM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbF1CcdAD40DAF87abCCD67C8346F763445704D83); // Marketing Address
    address payable public teamWalletAddress = payable(0xbF1CcdAD40DAF87abCCD67C8346F763445704D83); // Team Address
