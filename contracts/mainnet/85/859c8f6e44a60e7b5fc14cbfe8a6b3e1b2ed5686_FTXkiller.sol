...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 14;
...
contract FTXkiller is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name="FTXkiller";
    string public _symbol="FTXkiller";
    ...
    uint256 public _totalSupply=10**14 * 10**_decimals;

    uint256 public  _maxTxAmount=10**14 * 10**_decimals;
    ...
    address public marketingWallet=0x61325CC241a0Df559A1A85FC2Fbd2e28e50AedD8;
