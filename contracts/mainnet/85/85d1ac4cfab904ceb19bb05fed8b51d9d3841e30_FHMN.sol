...
contract FHMN is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIFA HAPPY MOON"; //
    string private constant _symbol = "FHMN"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd3883361C5Ece5bA8d5a08fc958acA3E1519d8E4;
    ...
    function setFBFHMN(address addr, bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }
