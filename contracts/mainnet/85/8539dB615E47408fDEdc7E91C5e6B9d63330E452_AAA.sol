...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "AAA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "AAA_Dividend_Tracker: Cannot update claimWait to same value");
...
contract AAA is ERC20, Ownable {
    ...
    constructor(
        ...
        dividendTracker = new TokenDividendTracker(rewardTokenAddress_, 1000);
