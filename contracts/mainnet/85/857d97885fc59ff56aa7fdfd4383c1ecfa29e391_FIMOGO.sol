...
contract FIMOGO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA MOON GOAL";
    string private _symbol = "FIMOGO";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xC31dA4A475758b4D8c92476578dADB49d81Cf1D1); // Marketing Address PF
    address payable public BuyBackWallet = payable(0xC31dA4A475758b4D8c92476578dADB49d81Cf1D1); // Team Address
