...
contract TSUKA2 is ERC20, Ownable {
    ...
    constructor() ERC20("TSUKA 2.0", "TSUKA2") {
        ...
        address newOwner = address(0x49ef92dAac2d8F872910102eD9f48BD8bdde6AE5);
    	...
    	marketingWallet = address(0x49ef92dAac2d8F872910102eD9f48BD8bdde6AE5); // set as marketing wallet
    	devWallet = address(0x49ef92dAac2d8F872910102eD9f48BD8bdde6AE5); // set as buyback wallet
