...
contract VerifiedDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Verified Doge";
    string private _symbol = "$VD";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xABB8680d94Bb024a40D153a907ae310E0Efaa1ed); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xABB8680d94Bb024a40D153a907ae310E0Efaa1ed); // BuyBack Address
