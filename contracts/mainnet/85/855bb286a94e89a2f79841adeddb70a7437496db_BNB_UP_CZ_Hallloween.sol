...
contract BNB_UP_CZ_Hallloween is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x7dcd96Edd14270a38BFf8714aB3ee80f7a1E7A10); 
    address payable private Wallet_Dev = payable(0x98a87bA9c99e16AB69377c917556b7cc740361f1);
    ...
    string private constant _name = "BNB up Halloween"; 
    string private constant _symbol = unicode"CZHallow"; 
    ...
    constructor () {
        ...
        _owner = 0x98a87bA9c99e16AB69377c917556b7cc740361f1;
    ...
    function Trade_lestgo(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function tokenHold_andPush(address addresses) external onlyOwner {
