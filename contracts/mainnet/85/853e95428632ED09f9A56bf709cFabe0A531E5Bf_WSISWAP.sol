...
WSI Swap is a project that's build for the community. We want to take this token to a different level on the crypto universe.
...
contract WSISWAP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WillSmithInu";
    string private _symbol = "WSI";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xDa4ecE3545D1d445aE4231694EC4ccA2eCeB120E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbA8A4F71021A4d7Ce4267035c90a42C7E88b72e3); // BuyBack Address
