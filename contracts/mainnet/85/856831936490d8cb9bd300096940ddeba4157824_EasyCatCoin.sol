...
/**
This is a purely Community Token.
We just need organic shilling and growth.
Marketers, Paid Shillers, Paid Raiders etc:
We do not need you, your presence disturb us.
Do not waste our time with your proposals in TG, otherwise you will be kicked out.
Also do not DM anyone from the team, you will get blocked and reported.
You have marketing, you are a very good Shiller, you are a very good Raider, you DYOR, you buy, you shill, you hold, you get reflections, then you sell after huge profit.
Telegram: https://t.me/EasyCatCoin
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4528F52F45211e880BE2F9DFd1447a8B70EF711A;
...
contract EasyCatCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x59E1D39771c4d4e7Ec1c7bf9D00c0dfE2E6a2494;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EasyCatCoin";
    string private _symbol = "EASYCAT";
    ...
    uint256 public _WalletMax = 30000000000 * 10**18;
