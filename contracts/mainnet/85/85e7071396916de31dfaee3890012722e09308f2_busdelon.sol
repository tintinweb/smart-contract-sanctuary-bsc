...
6% busd rewards 4% marketing 2% dev 

Telegram : https://t.me/busdelon
Website: https://busd3lon.site/
...
contract busdelon is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSD ELON";
    string constant _symbol = "$BUSDELON";
