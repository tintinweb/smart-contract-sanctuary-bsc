...
contract SUPERCOWKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPERCOWKING";
    string private _symbol = "SUPERCOEKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63fE625BEE8311696681399FcB5b2887079D7feF); // Marketing Address
    address payable public teamWalletAddress = payable(0x4c9b326bEC87245fA370Da712463D050712C8734); // Team Address
