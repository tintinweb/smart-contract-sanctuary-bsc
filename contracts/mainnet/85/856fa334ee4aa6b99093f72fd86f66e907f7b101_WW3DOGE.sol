...
War is pointless. No one will be victorious, and everything will just be bloodshed.
...
contract WW3DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "WW3 Doge";
    string private _symbol = "WW3DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFDC43479cfCbc95DCcE4E57550FCFACfeb449534); 
    address payable public teamWalletAddress = payable(0x553912b18AcA56E25249816c4f164F2AdeF807dD); 
