...
/**
TOKEN NAME: Bulls and Bears
TICKER: $BNB

$BNB -  Bulls and Bears

Community Cryptocurrency Project With An Incredible Story Behind It. WE LOVE AND SUPPORT BULLS AND BEARS. The developer of volt inu changed my life and so many others, I hope to do the same.
...
TG: https://t.me/BullsNBearsOfficial
Twitter:
Website: TBA
*/
...
abstract contract Ownable is Context {
    ...
    function _setOwner(address newOwner) private {
        address oldOwner = 0x2036CE5Ce1cf1F5dCa2643a39F93A1a429E69cde;
        _owner = newOwner;
...
contract Bulls_and_Bears is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bulls and Bears";
