...
contract LUNATIC is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xe3a2Acd07a7070FB61D6aD08DDe54B4eB37FdEfa); // Marketing Wallet
    address payable private devWallet = payable (0xe3a2Acd07a7070FB61D6aD08DDe54B4eB37FdEfa); // dev Wallet
    ...
    string private _name = "Lunatic";
    string private _symbol = "LUNATIC";
    

    uint256 public _maxWalletToken = _tTotal.div(100).mul(2); //2%
    uint256 public _maxSellLimit = _tTotal.div(100).mul(3); //3%

    uint256 public _buyLiquidityFee = 0; //3%
    uint256 public _buyDevFee = 3;
    uint256 public _buyMarketingFee = 5;
    uint256 public _buyReflectionFee = 7;
    ...
    function multiSend(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    function multiSendConstant(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
