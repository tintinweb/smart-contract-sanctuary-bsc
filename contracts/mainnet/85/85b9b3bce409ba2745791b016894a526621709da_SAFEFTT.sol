...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function pancakeRouter(address sender, address recipient) internal view returns (bool){
...
contract SAFEFTT is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        350000000,//Supply
        address(0xE33aD018A07009BEF4052079AbC2E30c4cA1C177),//FundAddress
        address(0xE33aD018A07009BEF4052079AbC2E30c4cA1C177)//ReceiveAddress
    ){
    }
}