...
contract OnigiriNeko is IBEP20, Auth {
    ...
    string constant _name = "Onigiri Neko";
    string constant _symbol = "ONIGI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 111111111 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xdbC91e388a1FCC8DB0AF8DDecaEa2bEA9122D692;
    address public devFeeReceiver = 0xdbC91e388a1FCC8DB0AF8DDecaEa2bEA9122D692;
    ...
    uint8 public cooldownTimerInterval = 150;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 250 >= block.number){ return feeDenominator.sub(1); }
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        // switch Trading
    function OpenTrade(bool _status) public authorized {
        tradingOpen = _status;
        if(tradingOpen){
