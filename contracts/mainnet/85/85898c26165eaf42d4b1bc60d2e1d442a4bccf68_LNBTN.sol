...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x916075818AEFd2f9041B4e51cd3d3D4D15195F1F;
        // owner address
...
contract LNBTN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "LIONBANGTUSN";
    string private _symbol = "LNBTN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x916075818AEFd2f9041B4e51cd3d3D4D15195F1F); // Marketing Address
    address payable public teamWalletAddress = payable(0x916075818AEFd2f9041B4e51cd3d3D4D15195F1F); // Team Address
    ...
    function setDLLNBTN(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDELNBTN(uint256 fe) external onlyOwner {
