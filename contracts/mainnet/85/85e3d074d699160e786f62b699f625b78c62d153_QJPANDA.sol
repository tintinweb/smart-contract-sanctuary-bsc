...
contract QJPANDA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "QJPANDA";
    string private _symbol = "QJPANDA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xcf7878a785ad485f34c744e78Ac4aF1A2FAbbb71);
