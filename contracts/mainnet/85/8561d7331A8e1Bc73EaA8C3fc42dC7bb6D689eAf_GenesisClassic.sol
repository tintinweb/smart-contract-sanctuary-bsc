...
// Telegram : https://t.me/GenesisClassicBNB
...
interface IERC20 {
    ...
    function PublicView() external returns (uint256);
...
contract GenesisClassic is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x288d8d9acA8C404e5C9464c8f6CD3F2ade43dC68); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Devs = payable(0xA00d2bC6a58cc72Af507921Ca5e6a5fF9eB42D15);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Genesis Classic"; 
    string private constant _symbol = unicode"cGenesis";
    ...
    constructor () {
        ...
        _owner = 0xA00d2bC6a58cc72Af507921Ca5e6a5fF9eB42D15;
    ...
    function PublicView() public override returns (uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            swapTokensForBNB(swappingEquals);
            uint256 BNB_Total = address(this).balance;
            sendToWallet(Wallet_Devs, BNB_Total);
            stringMemory = false;
