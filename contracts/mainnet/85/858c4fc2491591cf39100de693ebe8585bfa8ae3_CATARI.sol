...
Welcome to Catari
A Decentralized Meme Token That Evolves into a Vibrant Ecosystem.
...
contract CATARI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Catari Inu"; // 
    string private constant _symbol = "$CI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x57EAeD16af782f29D1A34811bD5694b8242b2813;
