...
contract CR7U is BEP20, Ownable {
    ...
    uint256 public maxSellLimit = 5000 * 10**18;
    ...
    constructor() BEP20("CR7 ULTRA", "CR7U") {
        ...
        exemptFee[address (owner())] = true;
        exemptFee[address(0x425eC1A200a291Af290d2bD3B30717fcB32F7503)] = true;
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxSell >= 1e5, "Cannot set max sell amount lower than 01%");
