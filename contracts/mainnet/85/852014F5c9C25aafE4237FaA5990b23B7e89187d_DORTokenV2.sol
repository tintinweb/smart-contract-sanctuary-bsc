...
contract DORTokenV2 is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    uint256 public liquidityFeePercent = (4 * BASE_RATIO) / 100;
    ...
    constructor(
        ...
        fund = 0x37bb59407E77486ab18b58781e49c6f4D5248887;
        ...
        rewardEndTime = block.timestamp.add(7300 days);
       ...
       _balances[0x37bb59407E77486ab18b58781e49c6f4D5248887] = _totalSupply;        
    }
    ...
    function _transfer(
        ...
        if ((!whitelist[from] && !whitelist[to])||( from == liquidity || to == liquidity)) {
