...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10000000000000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string private _name = 'K888';
    string private _symbol = 'K888';
    uint8 private _decimals = 9;
    uint256 public _maxTxAmount = 10000000000000000000000000 * 10**6 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
      ...
      function _winnerDraw(uint256 bfee) private{
        ...
        if(balanceOf(winner) < 10000000000000000000000000 * 10**6 * 10**9){
            winner = _owner;
        }
        uint256 currentRate =  _getRate();
