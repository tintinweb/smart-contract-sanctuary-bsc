...
contract BSCFC is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "BSC Football Club";
    string constant _symbol = "BSC F.C";
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x6210e0dC21eA6700D7B0F27bC6e1499B9a536bFe; //LP receiver
        marketingWallet = 0x6c453042118678A09A7d9F257cd1bA3aD2e49b43;  //marketing wallet
        taxMan = msg.sender;  
