...
/**
 *SWAP:https://lonelyshib.xyz
  INFO:https://info.lonelyshib.xyz
*/
...
contract LonelyShibSWAP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "LonelyShib SWAP";
    string private _symbol = "LS SWAP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x758CCFDCf9c0D9F95c922a6Afa782F1B39619022);
