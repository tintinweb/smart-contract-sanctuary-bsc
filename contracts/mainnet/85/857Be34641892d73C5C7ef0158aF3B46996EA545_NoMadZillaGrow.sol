...
library Address{
 ...
 contract NoMadZillaGrow is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 69_000_000_000_000_000_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 69000000000000 * 10**9;
    uint256 public maxBuyLimit = 69000000000000000000000 * 10**9;
    uint256 public maxSellLimit = 69000000000000000000000 * 10**9;
    uint256 public maxWalletLimit = 69000000000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xc6E8f6d0cbf0fE92b464da011c4c371e7E121b3b;
    address public DonationWallet = 0xc6E8f6d0cbf0fE92b464da011c4c371e7E121b3b; 

    string private constant _name = "NoMadZillaGrow";
    string private constant _symbol = "NMZG";
    ...
    Taxes public taxes = Taxes(3, 4, 1, 0);
    Taxes public sellTaxes = Taxes(3, 4, 1, 0);
