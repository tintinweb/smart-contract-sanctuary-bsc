...
contract ETCsToken is ERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 etcAmoount = IERC20(etcAddress).balanceOf(lpWalletAddress);
