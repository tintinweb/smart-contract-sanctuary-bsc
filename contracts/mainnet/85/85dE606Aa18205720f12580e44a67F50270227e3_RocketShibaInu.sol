...
/**
Rocket Shiba Inu 2.0 a project for BSC Lovers.
Launched on the Binance Smart Chain to facilitate increased adoption due to lower gas fees
$RSI2.0 allows crypto investors to earn regular 
dividends in the form of Binance Pegged ETH just by holding a minimum of $RSI2.0 in their wallet. 🐶🔥🚀

Backed by successful businesses and renowned individuals in the crypto space,
our goal is to grow as a community and provide holders with life changing opportunities through
investing in an asset that is decentralized and owned by the community.

Our mission is to help individuals and their families grow financially and 
emotionally. Rocket Shiba 2.0’s mission is to nurture ideas and support each other no matter what.
This will allow us to create the biggest community in the crypto space.


Rocket Shiba Inu 2.0 : >> 
Telegram : https://t.me/rocketshibainu2
...
contract RocketShibaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rocket Shiba Inu 2.0";
    string private constant _symbol = "RSI2.0";
