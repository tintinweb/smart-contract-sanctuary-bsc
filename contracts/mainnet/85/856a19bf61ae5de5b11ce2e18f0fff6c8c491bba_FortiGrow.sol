...
contract FortiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "FORTIGROW"; // 
    string private constant _symbol = "FORTI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x809522cc83531b975A884C98aC57f74E5f7C6A2E;
