 ...
 */
contract KINGKISHUINU is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "King Kishu Inu";
    string constant _symbol = "KKINU";
    ...
    address private devFeeReceiver = 0xcC3b43e79349f294aC1f6A8a43867c2A69dB4512;
    address private marketingFeeReceiver = 0xcC3b43e79349f294aC1f6A8a43867c2A69dB4512;
    ...
    function setBuyFees(uint256 marketing, uint256 dev, uint256 rewards, uint256 liquidity) external onlyOwner { // Owner can set buy fees - Maximum allowed is 45%
        require(_tradingEnabled,"Trading not enabled");
        require(marketing + dev + rewards + liquidity <= 45, "Cannot set Buy Fees higher than 45%");
