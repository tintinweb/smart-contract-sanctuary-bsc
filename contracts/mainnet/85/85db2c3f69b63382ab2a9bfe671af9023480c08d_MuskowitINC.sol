...
/**
  Muskowit INC - MUOWIT TOKEN
  A new generation metaverse universe
   engine built with Web 3.0 infrastructure.

  Telegram Community: @MuskowitINC
*/
...
contract MuskowitINC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 77000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Muskowit INC";
    string private _symbol = "MUOWIT";
    ...
    uint256 public numTokensSellToAddToLiquidity = 770000000 * 10**9;
    uint256 public _maxTxAmount = 77000000000 * 10**9;
