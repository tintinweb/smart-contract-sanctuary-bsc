...
contract TEDDYV3 is IERC20, Ownable {
    ...
    uint256 private _totalSupply = 9180000 * 10 ** _decimals;
    uint256 public maxTXAmount = 100000000 * 10 ** _decimals;
    uint256 public walletLimit = 9180 * 10 ** _decimals;
    ...
    bool private inSwap;
    bool public toTheMoon = false;

    uint256 private constant MAX = ~uint256(0);
    TokenDistributor public _tokenDistributor;
    uint256 private _buyLPDividendFee = 100;
    uint256 private _buyFundFee = 900;
    uint256 private _buyLPFee = 0;
    uint256 private _sellLPDividendFee = 100;
    uint256 private _sellFundFee = 900;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                if(_swapPairList[sender] && !isMaxEatExempt[recipient])
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint firstfundamount = fundAmount * 3 / 4;
        uint secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0xece568b91d54B8Ca652b6948a6F72CFEBa44b5D8;
    ...
    function setTXLimit(uint256 _maxTXAmount, uint256 _walletLimit) public onlyOwner {
    ...
    function ToTheMoon() external onlyOwner {
    ...
    function setTXWhiteList(address addr, bool enble) external onlyFunder {
        isMaxEatExempt[addr] = enble;
    }
