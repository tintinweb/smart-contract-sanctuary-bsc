...
*/
contract SmexProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public smexToken;
    ...
    uint256 public numberSmexToReactivate;
    uint256 public numberSmexToRegister;
    uint256 public numberSmexToUpdate;
    ...
    constructor(
        IBEP20 _smexToken,
        uint256 _numberSmexToReactivate,
        uint256 _numberSmexToRegister,
        uint256 _numberSmexToUpdate
    ) public {
        smexToken = _smexToken;
        numberSmexToReactivate = _numberSmexToReactivate;
        numberSmexToRegister = _numberSmexToRegister;
        numberSmexToUpdate = _numberSmexToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends Smex to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer Smex tokens to this contract
        smexToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSmexToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer Smex token to this address
        smexToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSmexToUpdate
    ...
    /**
     * @dev Claim Smex to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        smexToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of Smex to register
     * Callable only by owner admins.
     */
    function updateNumberSmex(
        uint256 _newNumberSmexToReactivate,
        uint256 _newNumberSmexToRegister,
        uint256 _newNumberSmexToUpdate
    ) external onlyOwner {
        numberSmexToReactivate = _newNumberSmexToReactivate;
        numberSmexToRegister = _newNumberSmexToRegister;
        numberSmexToUpdate = _newNumberSmexToUpdate;
    }
