...
contract zss is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address[5] memory addrs, // reward, router, marketing wallet, dividendTracker, team
        uint256[2] memory feeSettings, // rewards, marketing, 8 2
        uint256 minimumTokenBalanceForDividends_,
        ...
        swapTokensAtAmount = totalSupply_.mul(2).div(10**5); // 0.002%
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair){
                ...
                uint256 fees = amount.mul(70).div(100);
                amount = amount.sub(fees);
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        IERC20(rewardToken).transfer(_marketingWalletAddress, newBalance.mul(9).div(10));
        IERC20(rewardToken).transfer(_teamWalletAddress, newBalance.mul(1).div(10));
    }
