...
contract SuperDigitalToken is ERC20, Ownable {
    ...
    constructor() ERC20("Super Digital Token", "SDT") {
        ...
        marketingWallet = address(0x591e77c9a58811366FEB8A9667Cd7F409Bc2dDC9); // set as marketing wallet
    	stakingWallet = address(_owner); // set as staking wallet
    	teamWallet = address(0xF601a147fBB498e34989f40224033985eA98264a); // set as teamWallet
    ...
    function setStakeAmounts(uint256 contractBalance) internal {
        ...
        try st.deposit (0, ((contractBalance* 10)/ 100)) {} catch {}
