...
contract BUSDYcat is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUSDY Cat"; // 
    string private constant _symbol = "BUSDYcat"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x64a3fC7206844Ac7511d53039Eca544db05d99Cb;
