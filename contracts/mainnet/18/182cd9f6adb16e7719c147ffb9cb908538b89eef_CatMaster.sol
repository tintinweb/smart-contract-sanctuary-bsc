...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D645DBcDE15fE85866bEbf0675E9D56a8C1f2A2;
...
contract CatMaster is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x930406B2CdBF5DEec4fdaC75FCa68426Fd11442F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal)); 
    uint256 private _tFeeTotal;
    string private _name = "CatMaster";
    string private _symbol = "CTMR";
