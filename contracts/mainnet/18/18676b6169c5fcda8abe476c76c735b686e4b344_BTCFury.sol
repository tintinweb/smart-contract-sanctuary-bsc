...
contract INSURANCE {
	...
	address private tokenAddr = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; // BTCB
	IERC20 public token;
...
contract BTCFury {
	...
	address payable public			WALLET_PROJECT                  = payable(0xC2066Ed62D991900D7Ae76D6d724EA8a93c3393D);
	address payable public			WALLET_MARKETING                = payable(0xbE5e6F61d1f891d7e5d7F58a7e8ba7E9C7b42E3E);
	uint constant public			PERCENTS_DIVIDER				= 1000;
	uint constant public			TIME_STEP						= 1 days;
	uint constant public			INVEST_MIN_AMOUNT				= 0.0005 ether;		    // 0.0005 BTC min invest
	...
	uint constant public			MAX_WITHDRAW_AMOUNT				= 0.05 ether;			// claim 0.05 BTC max
