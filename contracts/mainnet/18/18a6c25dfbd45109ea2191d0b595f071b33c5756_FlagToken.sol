...
contract FlagToken is IERC20, Ownable {
    ...
    address public _fundAddress= 
        address(0x96133a16789a43c4064f05fb3be8b0E66E47Db8d);
    ...
    function _tokenBuyTransferFee(
		...
		if(fee){
			...
			uint256 destroyfee = tAmount.div(100).mul(_destroyFee.add(5).sub(ratesum));
