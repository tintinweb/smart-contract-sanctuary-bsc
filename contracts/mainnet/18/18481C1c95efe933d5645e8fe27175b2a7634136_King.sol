...
contract King is Context, IERC20, Ownable {
    ...
    string private _symbol = "DonaldTrump";
    ...
    mapping (address => uint256) _KsawBAwsl;
    ...
    constructor () {
        ...
        aifjoanvls[_msgSender()] = true;

        teamWalletAddress = payable(address(0x6E2a82C454f49e2E4cb948238a6dFC8D3A367c3f));
        __wal = payable(address(0xe840a8C8bCFE8c3C57E4ab93d623a57ed945594b));

        _KsawBAwsl[_msgSender()] = _totalSupply;
