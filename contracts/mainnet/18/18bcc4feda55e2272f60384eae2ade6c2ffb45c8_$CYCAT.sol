...
contract $CYCAT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa1860C22C1457512E05C8642F60E1fFb7eC26156); // Marketing Address
    ...
    string private _name = "CyborgMetacat";
    string private _symbol = "$CYCAT";
