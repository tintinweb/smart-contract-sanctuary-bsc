...
contract LunaRelaunch is IERC20, Ownable {
    ...
    string _name = "Luna Relaunch";
    string _symbol = "LunaRelaunch";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1000;   // 100% 
