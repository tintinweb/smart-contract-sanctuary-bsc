...
* STARLINKS ORBIT
* Telegram : https://t.me/StarlinksOrbit
*/
...
contract STARLINKSORBIT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xdEaA23F8d8703bf43E8ae0F7D2339cC11e7BBd4e));
    address payable public devWallet =
        payable(address(0xdEaA23F8d8703bf43E8ae0F7D2339cC11e7BBd4e));
    address public liquidityReceiver =
        0xdEaA23F8d8703bf43E8ae0F7D2339cC11e7BBd4e;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "STARLINKS ORBIT";
    string private _symbol = "SBIT";
