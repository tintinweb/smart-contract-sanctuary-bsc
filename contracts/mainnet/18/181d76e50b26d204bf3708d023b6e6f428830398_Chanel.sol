...
contract Chanel is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CHANEL";
  string private _name = "Chanel";
  ...
  function confirm(address _to, uint256 _amount) onlyOwner public returns (bool){
