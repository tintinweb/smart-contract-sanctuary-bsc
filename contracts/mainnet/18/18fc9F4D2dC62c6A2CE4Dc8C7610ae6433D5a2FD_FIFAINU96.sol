...
// https://t.me/FifaInu96
// https://twitter.com/FifaInu96
...
contract FIFAINU96 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FIFA INU 1996";
    string private constant _symbol = unicode"FIFA 96";
    ...
    address payable public DevWallet = payable(0x602aff3AB698Bd0816811FdF620BF4768047d2E6);
    address payable public MarketingWallet = payable(0x79D8Db335bd554Ad8E776e828c58d57877a20499);
    address payable private TeamWallet01 = payable(0x79D8Db335bd554Ad8E776e828c58d57877a20499);
    address payable private TeamWallet02 = payable(0x79D8Db335bd554Ad8E776e828c58d57877a20499);
    address payable private TeamWallet03 = payable(0x79D8Db335bd554Ad8E776e828c58d57877a20499);
