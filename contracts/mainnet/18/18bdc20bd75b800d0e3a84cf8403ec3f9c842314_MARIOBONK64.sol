...
contract MARIOBONK64 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MARIO BONK 64";
    string private _symbol = "MB64";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0211D871C21Ce6200f94a0Fe1E4a34C36C83bEEF);
