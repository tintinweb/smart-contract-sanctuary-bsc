...
contract BabyBitcoin is ERC20, Ownable {
    ...
    constructor() ERC20("BabyBitcoin", "BabyBTC") 
    {
        _maxSupply = 1000000000 * (10**18); //Max Supply
        _setOwner(msg.sender);
        maxWallet = _maxSupply * 5 / 100; // 3% Of total supply
    ...
    */
    ...
    function setMaxWallet (uint256 amount) public onlyOwner {
        require (amount >= totalSupply() * 5 / 100, "NO rug pull");
        maxWallet = amount;
    }
    ...
    */
    ...
    function setSellTax(uint256 _newSellTax) public onlyOwner {
        require (_newSellTax <= 20, "Max Sell Tax Limit is 30%");
