...
contract NAMEBOSS is Context, IPEB20 { 
    ...
    address payable public Wallet_Marketing = payable(0x51f936c83B2B9AA8334C1029649C765131a5B692); 
    address payable public Wallet_Dev = payable(0xA3b9AeD56D06335086cE40D8f265c636b29122Eb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "NAMEBOSS"; 
    string private constant _symbol = unicode"NAMEBOSS";
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 totalRandom = IPEB20(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = IPEB20(random_Token_Address).transfer(Wallet_Dev, removeRandom);
    }
}