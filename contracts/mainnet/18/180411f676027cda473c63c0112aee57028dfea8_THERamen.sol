...
contract THERamen is BEP20, Auth {
    ...
    string public constant name = "THE Ramen";
    ...
    uint256 public swapThreshold = totalSupply / 1500;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD9774c44B025A41cf6Ba526278C6602f83839cbf;
        devFeeReceiver = 0xD9774c44B025A41cf6Ba526278C6602f83839cbf;
    ...
    function _updatefees() internal {
        require(totalFee.mul(buyMultiplier).div(100) <= 100);
        require(totalFee.mul(sellMultiplier).div(100) < 100);
        require(totalFee.mul(transferMultiplier).div(100) < 100);

        emit UpdateFee( uint8(totalFee.mul(buyMultiplier).div(10000)),
            uint8(totalFee.mul(sellMultiplier).div(10000)),
            uint8(totalFee.mul(transferMultiplier).div(10000))
            );
    }
