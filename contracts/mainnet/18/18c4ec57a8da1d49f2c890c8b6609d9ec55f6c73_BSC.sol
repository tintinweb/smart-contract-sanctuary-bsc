...
contract BSC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x480140049791F659Ed6B1632C26cC824669C5F8c); // Marketing Address
    address payable public teamWalletAddress = payable(0x480140049791F659Ed6B1632C26cC824669C5F8c); // Team Address
    ...
    uint256 private _totalSupply = 400 * 10**_decimals;
