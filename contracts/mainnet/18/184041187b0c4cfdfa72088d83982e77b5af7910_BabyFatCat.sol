...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B4a04bF81697BdD2D1745d8eB27fdF8E216c315; // owner address
...
contract BabyFatCat is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Fat Cat";
    string private _symbol = "BBFATCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B4a04bF81697BdD2D1745d8eB27fdF8E216c315); // 
    address payable public teamWalletAddress = payable(0x4B4a04bF81697BdD2D1745d8eB27fdF8E216c315); // 
