...
abstract contract Ownable is Context {
 ...
 /////////////////whitelist prices///////////////////////////// 
  ...
  function mint_with_token(uint256 _count) public
     {
            ...
            if(liveprice == true )
    {
       ...
       uint256 a=_count*WhitelistMinitngPricein_token;
        require(a>0 ,"please enter token1");  
      ...
      else
      {
        ...
        require(totalamount>0,"please enter token2");  
        require(totalamountintoken1>0,"please enter token2");
         ...
         Token1.transferFrom(msg.sender,address(this),totalamountintoken1);
         mintedNFTs[msg.sender] += _count;
      }
      ...
      function mint_with_single(uint256 _count) public
     {
            if(liveprice == true )
    {
         uint256 a =one$toToken();
      ...
      function _mint_with_bnb(uint256 _count ) public payable
     {
            if(liveprice == true )
    {
         uint256 a =one$toToken();
          ...
          if(liveprice == true )
    {
      ...
      function mint_with_BUSD(uint256 _count ) public
     {
           if(  liveprice == true )
    {
         uint256 a =one$toToken();
       ...
       uint256 a=_count*WhitelistMinitngPricein_token;
        require(a>0 ,"please enter token1");  
         ...
         BUSD.transferFrom(msg.sender,address(this),a);
         mintedNFTs[msg.sender] += _count;
      }
      else
      {
      ...
      function mint_with_BUSD_100(uint256 _count) public
     {
                   if(liveprice == true )
    {
         uint256 a =one$toToken();
