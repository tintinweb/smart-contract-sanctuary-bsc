...
pragma solidity ^0.6.2;
contract TIFIDAO is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    address public _marketingWalletAddress = 0x7Ac5c44B27859aFDdb56E8eb394d1522E4f70598;
    uint256 public _markFee = 30;
    uint256 public _otherFee = 70;
    ...
    constructor() public ERC20("TIFIDAO", "TIFIDAO") {
    ...
    function setMarkFee(uint256 value) external onlyOwner{
        _markFee = value;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            if(to == uniswapV2Pair){
                uint256 markfees = amount.mul(_markFee).div(10000);
                uint256 otherfees = amount.mul(_otherFee).div(10000);
