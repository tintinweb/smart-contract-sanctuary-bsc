...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol, uint8 decimals, uint totalSupply) public {
        ...
        _owner=0xf45519b3fD466dd74b8E405DB192692881e63458;
...
contract XYCtoken is ERC20 {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;
  
 
  constructor () public ERC20("XYC Token", "XYC", 18,1000000*10**18) {
       _balances[0xf45519b3fD466dd74b8E405DB192692881e63458] = totalSupply();
        emit Transfer(address(0), 0xf45519b3fD466dd74b8E405DB192692881e63458, totalSupply());
  }
}