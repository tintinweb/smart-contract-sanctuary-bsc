...
contract GORILLA_BUSD is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "GORILLABUSD";
    string constant _symbol = "BGOR";
    ...
    uint256 public _maxTxAmount = 2500000000000000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 4000000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x35E40AB626b8eB99601e7D570A659A5f9D938603;
        devWallet = 0x35E40AB626b8eB99601e7D570A659A5f9D938603;
