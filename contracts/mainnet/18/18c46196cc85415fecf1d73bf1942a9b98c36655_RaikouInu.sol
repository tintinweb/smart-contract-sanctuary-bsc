...
https://t.me/RaikouInuPortal
https://twitter.com/RaikouInu
...
contract   RaikouInu is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 10_000 * (10**_decimals);
    uint256 public maxWalletLimit = 20_000 * (10**_decimals);
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0x20695AF849c3a48556986d2175c802A58caf412F;
    address public devWallet = 0x20695AF849c3a48556986d2175c802A58caf412F; 
    address public operationWallet = 0x20695AF849c3a48556986d2175c802A58caf412F;
    address public charityWallet = 0x20695AF849c3a48556986d2175c802A58caf412F; 

    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Raikou Inu";
    string private constant _symbol = "Raikou";
    ...
    Taxes public taxes = Taxes(0, 7, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 19, 1, 0, 0, 0);
