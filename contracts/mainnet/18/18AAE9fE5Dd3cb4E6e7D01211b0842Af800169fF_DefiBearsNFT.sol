...
contract DefiBearsNFT is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia4i35bg64gvrn6jppz47vzwvt5qaioibavvum4eazizl2do7ytzq/", Strings.toString(tokenId), ".json")
            );
    }
