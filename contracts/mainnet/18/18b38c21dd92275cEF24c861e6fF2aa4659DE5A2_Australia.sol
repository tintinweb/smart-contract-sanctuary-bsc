...
contract Australia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Australia";
    string private _symbol = "Australia";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x804Cf7d43de2753FfAAd0A7CA3B97cbe5B8E763E); 
    address payable private teamWalletAddress = payable(0x48c29DD8f1562e09B514DD1fEF6dF0017E499597); 
