...
contract OREIDOIMPORTADO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT      = 0x36859c4B27BbA41e83bd68c2c6d030080A622cb4;
    address PROJECT  = 0x9B0E790744AfA8d6d2EEb33b2dC2008329Ba48cE;
    address CA       = address(this); 
    string constant _name = "OREIDOIMPORTADO";
    string constant _symbol = "OREI";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2600000000000000000000000;
    ...
    function setFeeDistribution(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,  uint256 _burnFee,  uint256 _projectFee) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_burnFee).add(_projectFee);
