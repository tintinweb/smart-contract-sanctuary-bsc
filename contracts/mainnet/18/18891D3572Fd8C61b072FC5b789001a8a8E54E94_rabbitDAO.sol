...
contract rabbitDAO is Context, IERC20, Ownable {
    ...
    string private _name = "rabbitDAO";
    ...
    address public ownerAddres = address(0xE9909F9bc73743485578767f96C3a9Dd76dbC8a8);
    address public devAddress = address(0x885C7a869E4009bC8D7B4C0532D5719a36b28960);
