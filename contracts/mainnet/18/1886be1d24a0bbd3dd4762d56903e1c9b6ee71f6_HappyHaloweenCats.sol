...
contract HappyHaloweenCats is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "HappyHaloweenCats";
   string constant _symbol = "HHC";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x89CfDB26c7b57842fB35187595292E444bd473b1).call{value: BNBMarketingamount, gas: 30000}("");
