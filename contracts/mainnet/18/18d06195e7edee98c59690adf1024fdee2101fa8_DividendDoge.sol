...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0x55d398326f99059fF775485246999027B3197955);   //DONE  
...
contract DividendDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address USDT = 0x55d398326f99059fF775485246999027B3197955;    //DONE
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;    //DONE
    address DEAD = 0x000000000000000000000000000000000000dEaD;    //DONE
    address ZERO = 0x0000000000000000000000000000000000000000;    //DONE

    string constant _name = "DividendDoge";
    string constant _symbol = "DVD";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x172a299f3A2acc259f8135BECc06E87a110AD699;         //owner Account1
        ...
        marketingFeeReceiver = 0x7671D10d4B201501b742726403A900cc64d59F78;      //Account2
