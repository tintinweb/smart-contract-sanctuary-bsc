...
//Portal: https://t.me/BPU_Portal

//Twitter: https://twitter.com/BabyPixelBsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PIXEL = IBEP20(0x1A128f7B095b360A682C7e6921F3fcE5c25072D2);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = PIXEL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PIXEL.transfer(shareholder, amount);
...
contract BabyPixelUniverse is IBEP20, Auth {   
    ...
    address PIXEL = 0x1A128f7B095b360A682C7e6921F3fcE5c25072D2;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
