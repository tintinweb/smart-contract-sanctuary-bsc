...
contract LIFEDOGEDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "LIFE DOGE DAO";
    string private constant _symbol = "LIFE";

    address public _PancakeSwapV1RouterUniswap = 0x97CA2535D9DFf3541649248a49C9756a488Fa606; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x97CA2535D9DFf3541649248a49C9756a488Fa606; //can be the same
