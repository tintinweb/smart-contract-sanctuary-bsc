...
contract SafeBUSDminer is Token {
    
    uint private startTime = 1672290000; // GMT: Thursday, December 29, 2022 5:00:00 AM
    ...
    uint private constant INITIAL_TOKENS    = 25000 ether;    
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DES_1 = 0xDc432aCC7693306a486b0b94F2dE6cca66c53c44;  // 0
        ADM_1 = 0x8f0D062e4073Ab4DDcb787b1771629BfF1c5d109;  // o         
        VID_1 = 0x8f0D062e4073Ab4DDcb787b1771629BfF1c5d109;  // E        
        MAR_1 = 0x8f0D062e4073Ab4DDcb787b1771629BfF1c5d109;  // t
