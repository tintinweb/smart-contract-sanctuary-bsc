...
// MSSToken with Governance.
contract MetaStakeToken is BEP20('METASTAKESWAP', 'MSS') {
    using SafeMath for uint256;
    uint256 public constant maxSupply = 5000000000000000000000000;
...
contract SyrupBar is BEP20('SyrupBar Token', 'SYRUP') {
    ...
    // The CAKE TOKEN!
    MetaStakeToken public cake;


    constructor(
        MetaStakeToken _cake
    ) {
        cake = _cake;
    }
...
contract MasterChef is Ownable {
    ...
    function transferMetaStakeTokenOwnerShip(address newOwner_) public onlyOwner { 
