...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MIKU = IBEP20(0x73419De8E3E26A17e0E6b0436e29dd04A25B061D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MIKU.balanceOf(address(this));
        ...
        uint256 amount = MIKU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            MIKU.transfer(shareholder, amount);
...
contract SpaceMiku is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address constant MIKU = 0x73419De8E3E26A17e0E6b0436e29dd04A25B061D;
    ...
    string constant _name = "Space Miku";
    string constant _symbol = "SpaceMiku";
    ...
    uint256 internal sellreflectionFee = 4;
    uint256 internal sellmarketingFee = 10;

    uint256 internal feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver =
        0xcA8d8A7EF2f9b09ab70e3e2EcF158928A89b2A98;
    ...
    function _transferFrom(
        ...
        if (launchedAt > block.timestamp && recipient != pair) {
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched for DCU");
        launchedAt = block.timestamp + 10 minutes;
    }
