...
contract AnitoGacha is Pausable, Ownable, ReentrancyGuard {
    ...
    function buyGacha(uint256 gachaCategory, uint256 quantity) public nonReentrant {
        ...
        if(!publicSaleStatus){
            require(gachaWhitelistPrices[gachaCategory] > 0,"invalid price");
            ...
            busdToken.transferFrom(msg.sender, address(this), gachaWhitelistPrices[gachaCategory] * quantity);
            busdToken.transfer(treasuryAddress,gachaWhitelistPrices[gachaCategory] * quantity);
        }else{
