...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3a5A660a4EC165AF04162E2df33C20488c61AF12; // owner address
...
contract XRPChad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XRP CHAD";
    string private _symbol = "XRPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a5A660a4EC165AF04162E2df33C20488c61AF12); // Marketing Address
    address payable public teamWalletAddress = payable(0x3a5A660a4EC165AF04162E2df33C20488c61AF12); // Team Address
