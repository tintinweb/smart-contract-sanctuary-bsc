...
// telegram : https://t.me/Cheemsshiba1996
...
contract CheemsShiba1996 is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x98a87bA9c99e16AB69377c917556b7cc740361f1); 
    address payable private Wallet_Dev = payable(0xE4942eEa7dbccF565812455dBF43B6b0Fc325B0a);
    ...
    string private constant _name = "Cheems Shiba 1996"; 
    string private constant _symbol = unicode"CeS1996"; 
    ...
    constructor () {
        ...
        _owner = 0xE4942eEa7dbccF565812455dBF43B6b0Fc325B0a;
    ...
    function Open(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
     ...
     function Volset(address account) public onlyOwner {
    ...
    */
    ...
    function Blacklisted(address[] calldata addresses) external onlyOwner {
    ...
    function blacklisted(address addresses) external onlyOwner {
    ...
    // Set the maximum wallet holding (percent of total supply)
     function SetmaxWallPercent(uint256 maxWallPercent_x100) external onlyOwner() {
