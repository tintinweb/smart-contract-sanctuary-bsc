...
contract OwnableBTC is ContextBTC {
    address private _owner;

    event OwnerBTCpTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    constructor () {
        ...
        _owner = msgSender;
        emit OwnerBTCpTransferred(address(0), msgSender);
    }
    ...
    function renounceOwnerBTCp() public virtual onlyOwner {
        emit OwnerBTCpTransferred(_owner, address(0));
        _owner = address(0);
    }

    /**
     * @dev Transfers ownerBTCp of the contract to a new account (`newOwner`).
     * Can only be called by the current owner.
     */
    function transferOwnerBTCp(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBTC: new owner is the zero address");
        emit OwnerBTCpTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract random is ContextBTC, BinanceBNB, OwnableBTC {
