...
contract NovuFinance is IBEP20, Auth {
    ...
    string constant _name = "Novu Finance";
    string constant _symbol = "NF";
    ...
    function setFees(uint256 _liquidityFee, uint256 _insurancefundFee, uint256 _reflectionfee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        insurancefundFee = _insurancefundFee;
        reflectionfee = _reflectionfee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_insurancefundFee).add(_reflectionfee).add(_marketingFee);
