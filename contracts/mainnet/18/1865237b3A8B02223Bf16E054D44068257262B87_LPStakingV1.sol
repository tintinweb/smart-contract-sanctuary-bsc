...
contract LPStakingV1 is BaseContract {
    ...
    function setup() external {
        ...
        _fur = IERC20(tokenAddress);
        _lp = IERC20(lpAddress);
        boostRate[0] = 100;
        boostRate[1] = 102;
        boostRate[2] = 105;
        boostRate[3] = 110;
        ...
        _totalReflection = 0;
        if (stakers[0xc448E99A6AFd259627dA38b2DC5184009A39a7f8].stakingAmount > 0) {
            stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].stakingAmount += stakers[0xc448E99A6AFd259627dA38b2DC5184009A39a7f8].stakingAmount;
            stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].boostedAmount += stakers[0xc448E99A6AFd259627dA38b2DC5184009A39a7f8].boostedAmount;
            stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].stakingPeriod += stakers[0xc448E99A6AFd259627dA38b2DC5184009A39a7f8].stakingPeriod;
            delete stakers[0xc448E99A6AFd259627dA38b2DC5184009A39a7f8];
            stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].rewardDebt =
                stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].boostedAmount
                .mul(_accLPPerShare)
                .div(_dividendsPerShareAccuracyFactor);
            stakers[0x038748Fa876903D2223C682E6Af8928652c4Bd60].lastStakingUpdateTime = block.timestamp;
        }
    }
    ...
    function updateRewardPool() public {
        ...
        _totalReward = _lp.balanceOf(address(this)).sub(totalStakingAmount);
        if (_totalReward > 0) {
        ...
        _lastUpdateTime = block.timestamp.div(24 hours).mul(24 hours);
    }
    ...
    function _stake(
        ...
        if (stakers[staker_].stakingAmount > 0) {
            ...
            if (_pending_ > 0) {
                ...
                _usdc.transfer(staker_, _usdcAmount_);
            }
        }
        ...
        whenNotPaused
    {
        ...
        if (stakers[msg.sender].stakingAmount > 0) {
            ...
            if (_pending_ > 0) {
                uint256 _usdcAmount_ = _sellLP(_pending_);
                _usdc.transfer(msg.sender, _usdcAmount_);
            }
        }
        //set boosted LP amount regarding to staking period
    ...
    function _claim(address participant_) internal
    {
        ...
        _usdc.transfer(participant_, _usdcAmount_);
    }
    ...
    function unstake() external whenNotPaused {
        ...
        if (_pending_ > 0) {
            ...
            _usdc.transfer(msg.sender, _Pendingusdc_);
        }
        ...
        )
    {
        ...
        uint256 _USDCBalanceBefore1_ = _usdc.balanceOf(address(this));
        ...
        uint256 _USDCBalance1_ = _usdc.balanceOf(address(this)) -
        ...
        )
    {
        ...
        _path_[1] = usdcAddress;
        uint256 _USDCBalanceBefore_ = _usdc.balanceOf(address(this));
        ...
        )
    {
        ...
        uint256 _balanceBefore_ = _fur.balanceOf(address(this));
        _swapThroughUniswap(usdcAddress, tokenAddress, _amountToSwap_);
        uint256 _amountUSDC_ = _fur.balanceOf(address(this)) - _balanceBefore_;
        if (_amountToLiquify_ <= 0 || _amountUSDC_ <= 0) return (0, 0, 0);
        _usdc.approve(address(router), _amountToLiquify_);
        _fur.approve(address(router), _amountUSDC_);
        (
        ...
        _usdc.transfer(msg.sender, unusedUSDC_);
        _fur.transfer(msg.sender, unusedToken_);
    }
        ...
        )
    {
        ...
        uint256 _amountToSwap_ = paymentAmount_ - _amountToLiquify_;
        if (_amountToSwap_ == 0) return (0, 0, 0);
        uint256 _balanceBefore_ = _usdc.balanceOf(address(this));
        _swapThroughUniswap(tokenAddress, usdcAddress, _amountToSwap_);
        uint256 _amountUSDC_ = _usdc.balanceOf(address(this)) -
            _balanceBefore_;

        if (_amountToLiquify_ <= 0 || _amountUSDC_ <= 0) return (0, 0, 0);
        _fur.approve(address(router), _amountToLiquify_);
        _usdc.approve(address(router), _amountUSDC_);
        ...
        returns (uint256 paymentAmount_)
    {
        ...
        _lp.approve(address(router), lpAmount_);
        uint256 _tokenBalanceBefore_ = _fur.balanceOf(address(this));
