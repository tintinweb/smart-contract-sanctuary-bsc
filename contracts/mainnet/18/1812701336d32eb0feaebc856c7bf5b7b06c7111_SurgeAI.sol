...
contract SurgeAI is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Surge AI";
    string private constant _symbol = "SurgeAI";
    ...
    //Tax wallets
    address public teamWallet = 0x793776E7fa668243283A89E2515223E674510b2C;
    address public treasuryWallet = 0xf14023a528986df6e9ba397870f9A29e386d200d;
