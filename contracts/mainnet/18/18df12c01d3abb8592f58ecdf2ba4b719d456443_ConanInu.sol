...
contract ConanInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x75b084AD8C9e446249Fb28a325431bf7FDB2BB0b); 
    address payable public Wallet_Dev = payable(0x75b084AD8C9e446249Fb28a325431bf7FDB2BB0b);
    ...
    string private constant _symbol = unicode"$ConanInu"; 
    ...
    constructor () {
        ...
        _owner = 0x75b084AD8C9e446249Fb28a325431bf7FDB2BB0b;
