...
______       _             _____              _      _      
| ___ \     | |           |_   _|            | |    | |     
| |_/ / __ _| |__  _   _    | |_ __ _   _ ___| |_ __| | ___ 
| ___ \/ _` | '_ \| | | |   | | '__| | | / __| __/ _` |/ _ \
| |_/ / (_| | |_) | |_| |   | | |  | |_| \__ \ || (_| |  __/
\____/ \__,_|_.__/ \__, |   \_/_|   \__,_|___/\__\__,_|\___|
                    __/ |                                   
                   |___/                                    
    ...
    Telegram: https://t.me/BabyTrustDeBSC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 TrustDe = IBEP20(0xAf379Eb6d72E6046B746bCdC83a3f9FEAc86eA16);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TrustDe.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(TrustDe);
        ...
        uint256 amount = TrustDe.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TrustDe.transfer(shareholder, amount);
...
/* Token contract */
contract BabyTrustDe is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address TrustDe = 0xAf379Eb6d72E6046B746bCdC83a3f9FEAc86eA16; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "BabyTrustDe";
    string constant _symbol = "BTD";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 21000000 * (10 ** _decimals); // 21 Million Token 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 3 / 100; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 3 / 100; // 3%
    ...
    // NOTE: 1% = 100
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        ...
        require (maxWallPercent > 0, "MaxWallet Cannot be 0!");
    }
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external authorized {
        ...
        require (maxBuyTxPercent > 0, "Max Buy cannot be 0 !");
    }
    ...
    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external authorized {
        ...
        require (maxSellTxPercent > 0, "Max Sell cannot be 0!");
    }
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        require (totalFeeBuy <= feeDenominator/5, "Fee Cannot Exceed 20%");
        require (feeDenominator > 0, "Fee Denominator Cannot be 0!");
    }
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
        ...
        feeDenominator = _feeDenominator;
        require (totalFeeSell <= feeDenominator/5, "Fee Cannot Exceed 20%");
        require (feeDenominator > 0, "Fee Denominator Cannot be 0!");
    }
