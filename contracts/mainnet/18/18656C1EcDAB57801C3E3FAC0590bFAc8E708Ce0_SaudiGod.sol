...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDBC0C5deDb190Ae989907A5b3900c0ba415C04F3; // owner address
...
contract SaudiGod is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi God";
    string private _symbol = "SGod";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDBC0C5deDb190Ae989907A5b3900c0ba415C04F3); // Marketing Address
    address payable public teamWalletAddress = payable(0xDBC0C5deDb190Ae989907A5b3900c0ba415C04F3); // Team Address
