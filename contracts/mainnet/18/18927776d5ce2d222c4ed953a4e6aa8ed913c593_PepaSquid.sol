...
//
//
//   📱Telegram::https://t.me/+o-1uEzytg7A1MWU1
//   📱Website ::https://www.Pepasquid.space
/*
...
contract PepaSquid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepa Squid", "PepaSquid") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "PepaSquid";
    string private _symbol = "PepaSquid";
