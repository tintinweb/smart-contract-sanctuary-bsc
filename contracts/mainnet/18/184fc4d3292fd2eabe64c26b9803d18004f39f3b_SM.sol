...
contract SM is ERC20 {
	...
	address private _fundAddress = address(0x54786F186b425D318C913018b1Cf2B2AA989c65B);
	address public _greenAddress = address(0xaE1d91bBc7a3CbABC9b1227B7d5C3D59af5bA30B);
    ...
    constructor(address tokenOwner) ERC20("SM", "SM") {
	...
	function changeSwapWarp(SMWarp _warp) public onlyOwner {
        warp = _warp;
	...
	function swapAndLiquifyUsdt() public {
		...
		if(allAmount > 10**19){
			...
			if(allusdtAmount > 10**18){
				USDT.transfer(_fundAddress,allusdtAmount.div(2));
				USDT.transfer(_greenAddress,allusdtAmount.div(2));
			}
		}
    }
