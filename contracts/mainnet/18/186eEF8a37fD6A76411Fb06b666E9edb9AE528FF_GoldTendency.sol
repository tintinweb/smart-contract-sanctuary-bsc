...
/**
https://t.me/goldtendency
LP BURNED

GOLD TENDENCY NETWORK
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x243664526dAc6aAB7DAabb713347E8eE63420EA3;
...
contract GoldTendency is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Gold Tendency"; 
    ...
    uint256 public _BuyFee = 40; // 4%
    uint256 public _SellFee = 40; // 4%
...
*/
    function _transfer(
        ...
        {  
            ...
            sendToWallet(payable(0x243664526dAc6aAB7DAabb713347E8eE63420EA3), ETH_Tot);
        }
    }
        bool takeFee = true;
        bool isBuy;   
