...
// ENGLISH TG PORTAL: @Squidgrow_Saxon
// 
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    uint256 private _token1DividendRewardsFee = 4;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("SquidGrowSaxon_Track", "SGS", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract SquidGrowSaxon is Main {
    ...
    constructor() Main (
        ...
        0xaa58eBe8502B394e4409Dbb523b34b99b7967B8B,     // Marketing address
        0xaa58eBe8502B394e4409Dbb523b34b99b7967B8B,     // Team address AND DEV
        0xaa58eBe8502B394e4409Dbb523b34b99b7967B8B,     // Multi Use address (CHARITY)
