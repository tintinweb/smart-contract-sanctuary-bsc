...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x386D8B5e5C6f5DA0B08119e88F20FA1FB5026a6a; // owner address
...
contract ftxburn is Context, IERC20, Ownable {
    ...
    string private _symbol = "FTX BURN";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x386D8B5e5C6f5DA0B08119e88F20FA1FB5026a6a); // Marketing Address
    address payable public teamWalletAddress = payable(0x386D8B5e5C6f5DA0B08119e88F20FA1FB5026a6a); // Team Address
