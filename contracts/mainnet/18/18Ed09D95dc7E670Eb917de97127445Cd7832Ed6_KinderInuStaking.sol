...
contract KinderInuStaking is Ownable, Pausable, ReentrancyGuard {
    ...
    function deposit(uint256 amount) external nonReentrant whenNotPaused updateReward updateUserList {
        require (block.timestamp < endTime, "expired");
        require(IERC721(0x854af02c36c815e27f3d0496f38E5aC5Aa56a703).balanceOf(msg.sender) > 0, "You need to own NFT to stake!");
