...
Main Telegram > https://t.me/bigluckycharm
Twitter > https://twitter.com/BigLuckyCharm1
*/
...
contract BigLuckyCharm is Context, IBEP20, Ownable {
    ...
    string private _name = "BigLuckyCharm";
    string private _symbol = "BLCH";
    ...
    function setFees_Buy(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _lpFeeBuy = lpFee;
    }

    function setFees_Sell(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _lpFeeSell = lpFee;
    }
