...
/**
 * Testing some things out, i wouldnt by this, even though it looks juicy.
 */
...
abstract contract Project {
    ...
    address public marketingWallet = 0x9cC3A5A6E803b5DB47A9745c02e7E11C9E01cC0B;
    address public coinwarsWallet = 0x89359a7b7A399DE18966Ebc6cFf496752b3Fb033;

    string constant PROJECT_NAME = "test";
 ...
 * MainContract
 */
contract Test is Project, IBEP20, Ownable {
    using SafeMath for uint256;
