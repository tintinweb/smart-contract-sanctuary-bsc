...
/**
/ ___|| |__ (_) |__   __ _  |  _ \ _ __ ___  __| | __ _| |_ ___  _ __ 
\___ \| '_ \| | '_ \ / _` | | |_) | '__/ _ \/ _` |/ _` | __/ _ \| '__|
 ___) | | | | | |_) | (_| | |  __/| | |  __/ (_| | (_| | || (_) | |   
|____/|_| |_|_|_.__/ \__,_| |_|   |_|  \___|\__,_|\__,_|\__\___/|_|   
...
|___ \  / _ \ 
 ...
 / __/ | |_| |
|_____(_)___/
TELEGRAM - https://t.me/ShibaPredatorTwo
...
contract QOM is ERC20, Auth {
    ...
    string constant _name = "Shiba Predator 2.0";
    string constant _symbol = "QOM2.0";
    ...
    uint256 public liquidityFee    = 2; //set fees here 
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/2, "Fees cannot be more than 10");
    }
