...
contract WWM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "WWM";
    string private _symbol = "WWM";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x64CC41D1f0F608847B2D722EF2B9Ca67D0Fb5772));
        marketingWalletAddress = payable(address(0x64CC41D1f0F608847B2D722EF2B9Ca67D0Fb5772));
