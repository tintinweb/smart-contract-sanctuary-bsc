...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A131D720936cC85625c4AAB208DBE00Ff5f0BeD; // owner address
...
contract RUBBITSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RUBBIT SHIB";
    string private _symbol = "RUBBITSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3A131D720936cC85625c4AAB208DBE00Ff5f0BeD); // 
    address payable public teamWalletAddress = payable(0x3A131D720936cC85625c4AAB208DBE00Ff5f0BeD); // 
