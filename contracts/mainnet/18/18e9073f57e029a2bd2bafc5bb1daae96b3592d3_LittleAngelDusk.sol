...
contract LittleAngelDusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Angel Dusk"; // 
    string private constant _symbol = "LAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xd7541e6dfF1A234A925165db66bEe958D700B056;
