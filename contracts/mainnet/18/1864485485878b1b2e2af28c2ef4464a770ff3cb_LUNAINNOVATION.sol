...
contract LUNAINNOVATION is Context, IERC20, Ownable {
    ...
    string private constant _name = "LUNA INNOVATION"; // 
    string private constant _symbol = "LUNAINN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xcF2a9A58Ffd4d289A7228a58fDd8CA65055900FF;
