...
contract ZTesteToken is Ownable, BasicToken {

    string public name = "Z Teste Token";      //  token name
    string public symbol = "ZTT";           //  token symbol
    ...
    function burn(address to, uint tokens) onlyOwner public {
