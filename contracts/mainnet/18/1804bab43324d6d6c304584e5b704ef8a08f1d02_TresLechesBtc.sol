...
contract TresLechesBtc is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   TresLechesBTCDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Tres Leches Bitcoin", "3LechesBTC") {
        _buyRewardsFee = 4;
        _buyLiquidityFee = 1;
		_buyMarketingFee = 4;
        _buyDevFee = 1;
    	...
    	dividendTracker = new TresLechesBTCDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xC0C57bCDA7D818B328796ae1C0Fbd2A57b201aba);
        _devWallet = payable(0x50f4796E0c5062042Ec54B7006618469C45B396c);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TresLechesBTC: The dividend tracker already has that address");

        TresLechesBTCDividendTracker newDividendTracker = TresLechesBTCDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TresLechesBTC: The new dividend tracker must be owned by the TresLechesBTC token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "TresLechesBTC: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TresLechesBTC: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TresLechesBTC: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "TresLechesBTC: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TresLechesBTC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TresLechesBTC: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TresLechesBTC: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "TresLechesBTC: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TresLechesBTC: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TresLechesBTC: Cannot update gasForProcessing to same value");
...
contract TresLechesBTCDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("TresLechesBTC_Dividend_Tracker", "TresLechesBTC_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "TresLechesBTC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TresLechesBTC contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "TresLechesBTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TresLechesBTC_Dividend_Tracker: Cannot update claimWait to same value");
