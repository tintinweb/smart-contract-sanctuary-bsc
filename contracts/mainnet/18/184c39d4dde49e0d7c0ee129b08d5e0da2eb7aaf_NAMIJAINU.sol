...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15635D44B0ef6AD6388e1a9a322d3297FB03BA0E;
...
contract NAMIJAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NAMIJA INU";
    string private _symbol = "NAMIJA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3dB760EA9C437032D40ac76Ff88b548BcF27f320);
    address payable public teamWalletAddress = payable(0x3dB760EA9C437032D40ac76Ff88b548BcF27f320);
