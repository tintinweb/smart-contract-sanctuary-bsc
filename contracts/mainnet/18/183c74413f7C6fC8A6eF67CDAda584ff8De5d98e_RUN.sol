...
contract RUN is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptoRunner";
    string private constant _symbol = "RUN";

    address public _PancakeSwapV1RouterUniswap = 0x2ACcb9BBc4750387d0c56E62f3BD83041178c7dC; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x2ACcb9BBc4750387d0c56E62f3BD83041178c7dC; //can be the same
