...
*| $$      | $$  | $$| $$      | $$_  $$ | $$  | $$| $$  \ $$| $$  | $$| $$  \ $$
*| $$$$$$$$|  $$$$$$/|  $$$$$$$| $$ \  $$|  $$$$$$$| $$$$$$$/| $$  | $$| $$$$$$$/
*|________/ \______/  \_______/|__/  \__/ \____  $$|_______/ |__/  |__/|_______/ 
*                                         /$$  | $$                              
*                                        |  $$$$$$/                              
*                                         \______/                               
*
...
// Website: http://lbnb.io
// Twitter: https://twitter.com/Lucky_BNB
// Announcements: t.me/LuckyBNB_Official
// Community Chat: t.me/LuckyBNB_Lounge
// Gitbook: luckyworldjackpot.gitbook.io                                                                        
...
contract Jackpot is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // reflection 2%, 2.4% marketing, 2.4% Lp, 2.4% winner, superjackpot 0.8%
    // first 24h double tax - start with those params
    // regular values set in defaultTaxAfter24h()
    ...
    event NotEnoughBuyForTheSlot(address participant, uint256 amount);
    ...
    function checkSwap(address _from, address _to, uint256 amount) internal {
        ...
        if (_from == uniswapV2Pair && _to != address(uniswapV2Router)) {
            ...
            if (amount < thresholdBuy) {
               ...
               emit NotEnoughBuyForTheSlot(_from, amount);
               return;
            }
