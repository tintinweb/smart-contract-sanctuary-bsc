...
interface IL2BridgeZap {
    ...
    function swapTokensMap(address, uint256) external view returns (address);
}
...
import "./interfaces/IL2BridgeZap.sol";
import "./interfaces/ILeechTransporter.sol";
import "./interfaces/ILeechSwapper.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract LeechTransporterSynapse is Ownable, ILeechTransporter {
    ...
    */
    ...
    mapping(address => address) public destinationTokenToNToken;

    /**
    @notice Synapse router instances
    */
    IL2BridgeZap public synapse;

    mapping(uint256 => SwapParams) public chainIdToSwapParams;
     ...
     * @param synapseZap Address of the AnySwap V4 router contract
     */
    function initTransporter(address synapseZap) external onlyOwner {
        synapse = IL2BridgeZap(synapseZap);
    }
    ...
    function setNToken(
        ...
        destinationTokenToNToken[tokenAddress] = nTokenAddress;
    }
    ...
    function setSwapParams(
        ...
        chainIdToSwapParams[chainId] = params;
    }
    ...
    function bridgeOut(
        ...
        address _destAddress
            ...
            _approveTokenIfNeeded(_destinationToken, address(synapse));

            SwapParams memory params = chainIdToSwapParams[_destinationChainId];

            synapse.swapAndRedeemAndSwap(  
                _destAddress,
                _destinationChainId,
                destinationTokenToNToken[_destinationToken],    
