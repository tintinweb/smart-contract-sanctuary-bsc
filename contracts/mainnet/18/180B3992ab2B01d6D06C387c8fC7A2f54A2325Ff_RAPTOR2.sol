...
contract RAPTOR2 is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x5Fb955Cdf775879e4e3EB95258A8dCBf9c7Ba77B;
    ...
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**6 * 10**9; //0.5%
    uint256 public _maxTxAmount = 100000000 * 10**6 * 10**9; //1%
    ...
    constructor () {
        ...
        //Testnet
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x347e2a75e99174d46D94B5D7b4BE8f294bc2F5Fc); 
    ...
    function setMarketingWallet(address marketingWallet) public onlyOwner{
        _charityWalletAddress = marketingWallet;
    }
    ...
    function totalFees() public view returns (uint256) {
        ...
        tokenContract.transfer(_charityWalletAddress, balanceOf(address(tokenContract)));
        }
    ...
    function setFees(uint256 charityFee, uint256 liquidityFee, uint taxFee) public onlyOwner{
