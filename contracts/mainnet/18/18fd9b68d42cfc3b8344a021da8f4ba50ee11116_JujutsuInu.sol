...
/**
    Telegram: t.me/JujutsuInu_Token
*/
...
contract JujutsuInu is Context, IERC20 { 
    ...
    */
    ...
    Wallet_JujutsuInu: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_JujutsuInu = payable(0x2344290Ac7d55Bd633d69e9b57Ccb412b8364d16); 
    address payable public Wallet_LP = payable(0x6e7aCD6E71AF01076e5E5caBedF179A8F19c4A3b);
    address payable public Wallet_Tokens = payable(0x6e7aCD6E71AF01076e5E5caBedF179A8F19c4A3b); 
    ...
    string private constant _name = "Jujutsu Inu"; 
    string private constant _symbol = unicode"JujutsuInu"; 
    ...
    uint256 public Percent_JujutsuInu = 70;
    ...
    constructor () {
        ...
        _owner = 0x2344290Ac7d55Bd633d69e9b57Ccb412b8364d16;
        ...
        */
        ...
        _isLimitExempt[Wallet_JujutsuInu] = true; 
        ...
        _isExcludedFromFee[Wallet_JujutsuInu] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 JujutsuInu_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((JujutsuInu_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_JujutsuInu = JujutsuInu_Wallet;
    ...
    */
    ...
    //Update the JujutsuInu wallet
    event updatedJujutsuInuWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_JujutsuInu(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedJujutsuInuWallet(Wallet_JujutsuInu,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_JujutsuInu] = false; 

        Wallet_JujutsuInu = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_JujutsuInu != 0){

            // Calculate how many tokens need to be swapped for BNB (JujutsuInu BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_JujutsuInu / 100;
            ...
            uint256 split_M = Percent_JujutsuInu * 100 / (Percent_AutoLP + Percent_JujutsuInu);
            ...
            // Send BNB to JujutsuInu wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_JujutsuInu, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_JujutsuInu != 0){

            // Swap tokens for BNB and send to JujutsuInu Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_JujutsuInu / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_JujutsuInu, BNB_M);
            ...
            // Create the Auto LP if JujutsuInu is 0
