...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A14F67c0b58cF75dcD1c44fBB590B88591029Bf; // owner address
...
contract Galadoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gala Doge";
    string private _symbol = "GD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2cf619128128a8fBec66511AbAA5c3dC4fd72099); // Marketing Address
    address payable public teamWalletAddress = payable(0x2cf619128128a8fBec66511AbAA5c3dC4fd72099); // Team Address
