...
contract BUSDGarden is Initializable, UUPSUpgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable  {
    function _authorizeUpgrade(address) internal override onlyOwner {}


    uint256 public constant launch = 1669125600;
    ...
    function initialize() public initializer {
        ...
        PercsKey[10] = DivPercs(400, 2000); //from day 1 to 10
        PercsKey[20] = DivPercs(400, 1800); //from day 11 to 20
        PercsKey[30] = DivPercs(450, 1600);
        PercsKey[40] = DivPercs(550, 1400);
        PercsKey[50] = DivPercs(650, 1200);
        PercsKey[60] = DivPercs(1000, 1000);
        PercsKey[70] = DivPercs(1000, 1000);

        feeWallet = 0x770BdD792f6471EB28cBccD4F193BB26e8B5B07E;
        MAX_EARNINGS = 36000;
        RETRO_MODE = false;

        MIN_INVEST_LIMIT = 10 * 1e18; // 1 LP = $1 , min invest = $10
        WALLET_DEPOSIT_LIMIT = 20000 * 1e18; // max invest = $20000
        // v2
        refPromotion = true;
        // v3
        SET_ZAPPER(0xB1C017705FdC99287afe3Ec2fb201aC690C0eA12);
    }
    ...
    function unstakeAll(address targetToken) nonReentrant whenNotPaused external {
    }
    ...
    function SET_RETRO_MODE(bool _RETRO_MODE) external onlyOwner{
    }
    ...
    uint256 public constant  MAX_DAY = 60;
}
