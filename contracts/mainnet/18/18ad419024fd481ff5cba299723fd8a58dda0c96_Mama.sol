...
contract Mama is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xbD753B6cb57432D602D38C3eD129E8228083E062;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xbD753B6cb57432D602D38C3eD129E8228083E062] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xbD753B6cb57432D602D38C3eD129E8228083E062] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xbD753B6cb57432D602D38C3eD129E8228083E062,
                block.timestamp
            );
