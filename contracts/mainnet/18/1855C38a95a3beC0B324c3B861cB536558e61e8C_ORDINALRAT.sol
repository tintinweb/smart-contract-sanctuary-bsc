...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xff6422d7162414C684Bd0A6a3750E43119562C24; // owner address
...
contract ORDINALRAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xff6422d7162414C684Bd0A6a3750E43119562C24); // Marketing Address
    address payable public teamWalletAddress = payable(0xff6422d7162414C684Bd0A6a3750E43119562C24); // Team Address
