...
/**
 KURUMINHA $KRM
 TG: https://t.me/kuruminhatoken
 Website: https://kuruminha.info

  Tokenomics
 - 4% Kuruminha Reflections
 - 2% LP
 - 2% Fundo de Crescimento
*/
...
contract KRM is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "$KRM";
    string private constant _symbol = "KURUMINHA";
    ...
    address payable  _marketingAddress = payable(0x192165e43Aea50aaF129092015fd4EFC1038BCb7);
    address payable constant  _projectMaintainence = payable(0x192165e43Aea50aaF129092015fd4EFC1038BCb7);
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal.div(2); // 5%
        _maxWalletAmount = _tTotal.div(2); // 5%
