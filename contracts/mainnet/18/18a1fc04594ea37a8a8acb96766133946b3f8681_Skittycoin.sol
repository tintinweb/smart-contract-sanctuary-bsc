...
TG: https://t.me/SkittyCoin
Twitter: https://twitter.com/SkittyCoin
###################################################################################
*/
...
contract Skittycoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Skitty Coin";
    string private _symbol = "$SKITTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb256d6F8dbECF55D30fafaa207F78587641A5254); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb256d6F8dbECF55D30fafaa207F78587641A5254); // BuyBack Address
