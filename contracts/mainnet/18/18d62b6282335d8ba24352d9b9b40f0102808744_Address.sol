...
interface IRouter {
    ...
    address public marketingWallet = 0xDF61B778E2EBbeA424Db4dd5BDcE156a5548C8cf;
    address public opsWallet = 0x53dc113d1ec6688Ea896295Df380a04f78f811DA;
    ...
    Taxes public taxes = Taxes(3, 1, 2, 1);
    Taxes public sellTaxes = Taxes(3, 1, 2, 1);
    ...
    constructor(address routerAdd) ERC20("NinjaX", "NINJAX") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _ops + _dev) <= 15, "Must keep fees at 15% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _ops + _dev) <= 30, "Must keep fees at 30% or less");
    }
    ...
    function updatedeadline(uint256 _deadline) external onlyOwner {
        ...
        require(_deadline < 6,"Deadblock should be less than 6");
        deadline = _deadline;
    }
