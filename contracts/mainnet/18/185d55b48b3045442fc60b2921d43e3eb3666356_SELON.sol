...
contract SELON is Context, IERC20, Ownable {
    ...
    string private _name = " Supreme Elon  ";
    string private _symbol = " $SELON "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4248fe2ec8Eee3A62f338b65aFc7CE2BF45c5458); 
    address payable public teamWalletAddress = payable(0x4248fe2ec8Eee3A62f338b65aFc7CE2BF45c5458); 
