...
/*
A platform that provides solutions for developing as well as implementing new or existing cutting-edge technologies. Its offerings are not limited to AI, Metaverse, Blockchain or dapps, it can also accommodate future trends that meet all your requirements.

WebSite : https://www.torquehq.io

Telegram : https://t.me/torqueheadquarters
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x0c223436d32295D2DA2E5cf017C6F6Bdf5318fD6;
...
contract TorqueHQ is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Torque headquarters";
    string private constant _symbol = unicode"TorqueHQ";
   ...
   function allowance(address owner, address spender) public view override returns (uint256) {
    ...
    function _transfer(
        ...
        {  
            ...
            sendToWallet(payable(0x0c223436d32295D2DA2E5cf017C6F6Bdf5318fD6), ETH_Tot);
        }
    }
        bool takeFee = true;
        bool isBuy;   
