...
contract ShiniV2 is IBEP20, Ownable {
 
    address WDOGE = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    string constant _name = "ShiniV2"; //
    string constant _symbol = "SHIN2"; //
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (1000) * (5); // 0.5%
    uint256 public _maxSellTxAmount = _totalSupply / (1000) * (5); // 0.5%
    uint256 public _maxWalletToken = _totalSupply / (100); // 1%
 
    // Fees receivers
    address public autoLiquidityReceiver = 0xb2268b8057818cccC23C09dE8FFd31f71468e072;
