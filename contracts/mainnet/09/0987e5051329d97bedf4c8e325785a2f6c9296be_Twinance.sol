...
contract Twinance is Context, IERC20, Ownable {
    ...
    string private _name = "Twinance";
    string private _symbol = "TWIN";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x54bd0948d8B5CEd8E2eE0b03fd489140349da7F0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x54bd0948d8B5CEd8E2eE0b03fd489140349da7F0); // BuyBack Address
