...
contract Jessie is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = _tTotal.mul(2).div(100);
    uint256 public maxSellAmount = _tTotal.mul(1).div(100);
    uint256 public swapTokensAtAmount = 7000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 7000000000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x4e15720Fd1d1235fefA9e41841c40EDc27B67712;
    address public operationsAddress = 0xD7deD18b77dD9306d596a9294a6Bff70C6a1b29B;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Jessie Inu";
