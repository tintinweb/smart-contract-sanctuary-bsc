...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C5d4e8835EaD9C314EFaC33BcB3EF0b619C9D4A;
...
contract ChemWorId is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc2a7a02344023FCbb90fFFcf006957D5219dAE24;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ChemWorId";
    ...
    uint256 public _maxTxAmount = 4000000000000 * 40**18;
    uint256 private numTokensSellToAddToLiquidity = 4000000000 * 40**18;
