...
interface IDEXRouter {
    ...
    contract CupidGrimaceInu is IBEP20, Auth {
    ...
    string constant _name = "CupidGrimaceInu";
    string constant _symbol = "CupidGrimaceInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 200; //3.5% 
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; //7%
    ...
    address private marketingFeeReceiver = 0x16eeBe0cc4baFB3d9a90A9CE5a7B45dB4667dA0f;
    address private developmentFeeReceiver = 0x49E4Dcf9e07474C822C3090f34698F5A9e8Bd200;
