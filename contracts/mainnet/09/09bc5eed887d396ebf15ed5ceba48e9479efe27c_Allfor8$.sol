...
/**
Telegram : https://t.me/allfor8dollar
*/
...
contract Allfor8$ is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "All for 8 $";
    string constant _symbol = "AF8";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 48) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 48) / 100; 
