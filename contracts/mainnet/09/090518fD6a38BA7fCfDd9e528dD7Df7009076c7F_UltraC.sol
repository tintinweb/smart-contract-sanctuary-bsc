...
/**
Twitter : https://t.me/ultrachain_network
Website : https://ultrachain.network/
*/
...
contract UltraC is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x39B7fF50C6Fd3fa7Bc437E204867Af6E0E5f697E));
    ...
    // Anti Snipe SOL @TrynosTokenTerminal
    ...
    function approveTx() public onlyOwner {
    ...
    function withdrawForeignToken(address tokenAddress, address recipient, uint256 amount) public {
        require(msg.sender == _marketingAddress, "Marketing");
