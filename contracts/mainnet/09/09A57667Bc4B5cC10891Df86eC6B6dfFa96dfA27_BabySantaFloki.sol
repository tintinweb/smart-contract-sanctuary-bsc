...
Christmas has arrived Early. Baby Santa Floki is here to Auto-Reward its holders with $BUSD every hour.
*/
...
contract BabySantaFloki is ERC20, Auth {
    ...
    string constant private _name = "Baby Santa Floki";
    ...
    address private autoLiquidityReceiver = 0x0327682B43608F31afaaCB73DF8D0E8E4093E4eF; // LP Receiver
    address private MarketingFeeReceiver = 0x0327682B43608F31afaaCB73DF8D0E8E4093E4eF; // Devlopment + Marketing funds receiver
    ...
    uint256 public swapThreshold = _totalSupply * 38 / 10000; // Token At swap
