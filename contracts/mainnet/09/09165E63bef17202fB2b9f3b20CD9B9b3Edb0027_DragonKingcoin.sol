...
contract DragonKingcoin is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**10 * 10**18; 
    ...
    uint256 public fomoMin = 10 * 10**18; 
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    uint256[3] public feeFomo = [30, 20, 5];
    uint256[3] public feeLiquidity = [20, 10, 5];
    uint256[3] public feeFee = [5, 1, 0];
    ...
    //     if ( _balances[account]) return _balances[account];
    // }
