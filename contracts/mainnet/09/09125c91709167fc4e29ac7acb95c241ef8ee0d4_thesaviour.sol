...
/*
 ...
 Find us on TG: https://t.me/elonthesaviourbsc

 www.twitter.com/elonDsaviour
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B9a13FC77d4F74640d18D70C913FD8CbD7E151c; // owner address
...
contract thesaviour is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TheSaviour";
    string private _symbol = "$ELON"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAF6a7094e0a888Ae032C5347144b3C869e48b5c0); // Marketing Address
    address payable public teamWalletAddress = payable(0xBc7D4ABaBb4f011c05280F6d6CFA67C29F51f1C2); // DEVELOPMENT Address
