...
contract  Twitteracquisition is Context, IERC20, Ownable {
    ...
    string private constant _name = " Twitter acquisition Coin";
    string private constant _symbol = " Twitteracquisition";
