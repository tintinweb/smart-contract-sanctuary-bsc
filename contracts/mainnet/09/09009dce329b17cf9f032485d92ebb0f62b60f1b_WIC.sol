...
contract WIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wolves Investment Club";
    string private _symbol = "WIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2753A2700408E0dc1135Afd7E438Dcf6Ee27C18c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2753A2700408E0dc1135Afd7E438Dcf6Ee27C18c); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (10 * 10**6 * 10**9), "Max wallet should be less or euqal to 1% totalSupply");
