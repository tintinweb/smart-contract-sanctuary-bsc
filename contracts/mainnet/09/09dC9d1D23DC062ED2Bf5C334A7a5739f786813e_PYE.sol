...
//--------------------------------------BEGIN TOKEN PARAMS---------|
    ...
    string constant _name = "Test PYE";
    string constant _symbol = "TSTPYE";
...
//--------------------------------------BEGIN CONSTRUCTOR AND RECEIVE FUNCTION---------|    
    ...
    constructor() ERC20("Test PYE", "TSTPYE") {
        _balances[_msgSender()] = _tTotal;

        pyeSwapRouter = IPYESwapRouter(0x98Cc2Cd55Ca2092034146EBD8eb043F9f976623a);
        ...
        if(tokenIndex < pairsLength) {
            ...
            if(allowanceT >= amount) {
                ...
                if(token == BUSD) {
                    ...
                    IERC20(WBNB).transfer(_defaultFees.developmentAddress, developmentFeeAmount2);
