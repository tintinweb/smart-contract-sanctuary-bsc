...
contract wikiwhales is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WIKI WHALES";
    string private _symbol = "wWHALES";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x6D14A50F4c09c4dE0a8f22e9A5961292CC1C3981);
