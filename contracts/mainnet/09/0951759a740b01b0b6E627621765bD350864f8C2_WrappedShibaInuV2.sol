...
contract WrappedShibaInuV2 is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Wrapped Shiba Inu 2.0';
    string private constant _symbol = 'WSHIBAINUV2';
