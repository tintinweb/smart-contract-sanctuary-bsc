...
interface IDEXRouter {
 ...
 contract PumpMine is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "https://t.me/pumpmine";
    string constant _symbol = "PMINE";
    ...
    address public devFeeReceiver = 0x0bd21fCf5be9CDd02bE5B2926a095560E2145503;
    address public treasuryFeeReceiver = 0xB76e87ce9d823421a8aD6Af751f785E9130f5006;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB.mul(treasuryFee).div(totalBNBFee);
        ...
        (bool BuyBackSuccess, /* bytes memory data */) = payable(treasuryFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        treasuryFee = _treasuryFee;
        totalFee = _liquidityFee.add(_devFee).add(treasuryFee);
    ...
    function setFeeReceiver(address _devFeeReceiver, address _treasuryFeeReceiver) external authorized {
