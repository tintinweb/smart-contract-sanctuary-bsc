...
abstract contract ContextBEP20HBIT {
...
contract OwnableBEP20HBIT is ContextBEP20HBIT {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20HBIT: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20HBIT: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract HBITProtocolFanToken is ContextBEP20HBIT, BEP20HBIT, OwnableBEP20HBIT {
    ...
    string private _name = 'HBIT 2023';
    string private _symbol = 'HBIT2023';
