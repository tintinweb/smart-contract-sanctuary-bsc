...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x804E4DCF3A432892C6E8084fd2Aee06CcD2F4412;
...
contract MoonbaseCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd0E30930DAE7fD1796827d5448191Ff78421FDC7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Moonbase Coin";
    string private _symbol = "MOBA";
