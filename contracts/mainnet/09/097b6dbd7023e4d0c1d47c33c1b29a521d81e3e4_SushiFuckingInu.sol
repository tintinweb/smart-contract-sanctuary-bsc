...
contract SushiFuckingInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x83650D1D40Ba2C901724798e454792791FddE8f6); 
    address payable public Wallet_Dev = payable(0x83650D1D40Ba2C901724798e454792791FddE8f6);
    ...
    string private constant _name = "Extreme Sushi Inu"; 
    string private constant _symbol = unicode"Sushi Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x83650D1D40Ba2C901724798e454792791FddE8f6;
