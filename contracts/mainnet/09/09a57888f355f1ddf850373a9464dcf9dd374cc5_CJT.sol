...
interface Event {
    ...
    event TimeLog(uint timestamp);
}

contract CJT is Event {

    string public constant _name = "CJT Token";
    string public constant _symbol = "CJT";
    ...
    function recharge() public payable returns (bool) {
        ...
        emit Recharge(msg.sender, msg.sender, _balanceseth[msg.sender]);
        return true;
    }
