...
contract TwitterS26E12 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter S26E12";
    string private _symbol = "Twitter S26E12";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF9ba09301e6F14e4F812c9f095c24C125F772584); 
    address payable public BurnedWalletAddress = payable(0xF9ba09301e6F14e4F812c9f095c24C125F772584); 
