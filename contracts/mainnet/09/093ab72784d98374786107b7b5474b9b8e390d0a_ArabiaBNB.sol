...
contract ArabiaBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabia BNB";
    string private _symbol = "Arabia Coins";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x487c64600d5A2C05c6781ba0ADDcBdd6dAF03E30); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x487c64600d5A2C05c6781ba0ADDcBdd6dAF03E30); // BuyBack Address
