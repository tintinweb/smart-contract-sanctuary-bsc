...
/**
 ...
 The Okami Tsuki's sister
 the word ōkami (狼) means "wolf" and the word taiyō (太陽) means "sun"
 Telegram: https://t.me/OkamiTaiyo
...
contract OkamiTaiyo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Okami Taiyo";
    string private _symbol = "TAIYO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x282e62BF152173dd6A8f56882475262e5F90AffE); // Marketing Address
    address payable public teamWalletAddress = payable(0x282e62BF152173dd6A8f56882475262e5F90AffE); // Team Address
    ...
    uint256 private _buyMaxTxAmount = 30000000 * 10**_decimals;
    uint256 private _sellMaxTxAmount = 30000000 * 10**_decimals; 
