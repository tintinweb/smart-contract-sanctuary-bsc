...
DEGEN CHAD - Powered by Degen Yacht Club

TG: https://t.me/DegenChadBSCverify
...
contract DegenChad is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Degen Chad';
    string private constant _symbol = 'DEGENCHAD';
    ...
    //DevWallets
    address public BuyBack=payable(0x525F6E1B9F26A0d2DbfbF7e3E0f1A4C35Ea84344);
    address public Marketing=payable(0x864daafD8A03aB2B1c6E8B1E864574d27198FD3B);
    //TestNet
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(BuyBack).transfer((amount*25) / 100);
