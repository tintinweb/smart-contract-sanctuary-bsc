...
contract fifaultimateteam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"fifaultimateteam.it";
    string private _symbol = unicode"FUT";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x0c09c28da5B9Bc5463118f77C6a5FF36C4e439B2); 
    address payable public BurnedWalletAddress = payable(0x0c09c28da5B9Bc5463118f77C6a5FF36C4e439B2); 
