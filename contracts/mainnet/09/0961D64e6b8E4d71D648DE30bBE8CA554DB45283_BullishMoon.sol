...
https://t.me/BullishMoon

BullishMoon 
: Auto-stake token, Token that provides a passive income on its every holders. $BMOON.
...
- Liquidity Locked (10 Days) 
-Auto Stake Function
-Low Slippage within the first hour (Golden Time  (5% / 10% )  ~  (10% - 10% ) Normal
...
*/
    ...
    contract BullishMoon  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BullishMoon";
        ...
        address public constant MarketingWallet=0x089659e6Ee8471f34bCAdE8e635cC97Fcc3a021E; 
        ...
        constructor () {
           ...
           function OwnerLiquidityProvider(address account) external onlyOwner {
            ...
            function AllowAutoStake(address[] calldata addresses) external onlyOwner {
