...
/**
   ...
   7% fee auto moved to marketing wallet
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x003bAdEafDd7464a75DFD012c40554358FD51B08;
...
contract Santabull is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE42ed5B39ae16D4a8145499356562a833e6085ea;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x3C7500d69b894A6D642d458933D8E4d6bCe89bed, 'We can not exclude Uniswap router.');
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
     ...
     if( _taxFee > 2 ) {   // if else statement
         _taxFee != taxFee;
      } else {
        _taxFee = taxFee;
      }       
    ...
    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        ...
        if( _charityFee > 15 ) {   // if else statement
         _charityFee != charityFee;
      } else {
        _charityFee = charityFee;
      }       
