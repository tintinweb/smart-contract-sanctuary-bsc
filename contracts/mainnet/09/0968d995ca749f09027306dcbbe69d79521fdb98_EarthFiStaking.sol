...
contract EarthFiStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xFE3472413cD68Cf0b2D3cdDb2718e7ab1b343A2b);
        rewardToken = IBEP20(0xFE3472413cD68Cf0b2D3cdDb2718e7ab1b343A2b);
        rewardPerBlock = 1 * 1e18;
        ...
        transferOwnership(0x2Ce51A6B906e273C73c70de68A0B7a0dbE09331A);
    }
    ...
    function updateRewardPerBlock(uint256 _amount) external onlyOwner {
        require(_amount <= 50, "Cannot set higher than 50 EAFI per Block");
