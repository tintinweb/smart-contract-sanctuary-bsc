...
contract KUROCHAN is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Kurochan Inu";
    string constant _symbol = "Kurochan"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 2000 / 10000; //Initial 0.5%
    uint256 public _maxWalletSize = _tTotal * 4000 / 10000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0x926C2ab1050344c726CF4576Ee92e394f0a5a53e;
    address public marketingFeeReceiver = 0x926C2ab1050344c726CF4576Ee92e394f0a5a53e;
    address public liquidityFeeReceiver = 0x926C2ab1050344c726CF4576Ee92e394f0a5a53e;
