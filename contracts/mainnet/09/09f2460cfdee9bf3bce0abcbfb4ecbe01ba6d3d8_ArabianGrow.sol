...
interface IRouter {
    ...
    contract ArabianGrow is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 1_500_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 4;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x0cC6987019dDa0235499D1B9979F015ac727Da32;
    address public devWallet = 0x443513E812d4f907eD3fdA0EA0EeA800e1Fa4419;
    ...
    constructor(address routerAdd) ERC20("ArabianGrow", "AGrow") {
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 100_000_000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 100_000_000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 100_000_000, "Cannot set max wallet amount lower than 0.1%");
