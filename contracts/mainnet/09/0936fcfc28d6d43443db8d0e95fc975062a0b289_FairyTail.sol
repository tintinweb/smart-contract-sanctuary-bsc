...
//Telegram: https://t.me/bscfairytail
*/
...
contract FairyTail is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf27964f6DeD8c60BB644C29131a329439DF000bD); 
    address payable public Wallet_Dev = payable(0xf27964f6DeD8c60BB644C29131a329439DF000bD);
    ...
    string private constant _name = "FairyTail"; 
    string private constant _symbol = unicode"$F_TAIL"; 
    ...
    constructor () {
        ...
        _owner = 0xf27964f6DeD8c60BB644C29131a329439DF000bD;
