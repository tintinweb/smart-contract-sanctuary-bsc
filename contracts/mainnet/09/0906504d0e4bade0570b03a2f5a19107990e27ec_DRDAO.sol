...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61B215dE02d1B6B1b9a9f0D0AAAc735850725244;
...
contract DRDAO is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x3C414B1c16dc68A2151036AF974dA01e591B8A9c);
    ...
    */
    ...
    string private _name = "DRDAO"; 
    string private _symbol = "DRDAO";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 110 * 10**18;
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(1).div(110);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (4% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(1).div(110); 
