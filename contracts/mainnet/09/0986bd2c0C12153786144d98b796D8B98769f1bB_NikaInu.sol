...
contract NikaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nika Inu";
    string private _symbol = "NIKA";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x6ea1301cC503AAB5Fc67F5954cC4dB9A206E39BE); // Marketing Address
    address payable private TeamWallet = payable(0x6ea1301cC503AAB5Fc67F5954cC4dB9A206E39BE); // Buy Back Address
