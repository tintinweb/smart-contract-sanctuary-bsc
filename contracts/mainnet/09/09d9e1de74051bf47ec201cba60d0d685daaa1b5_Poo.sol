...
contract Poo is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 125000 * 10**9; //
    ...
    uint256 marketingFeeSell = 23; 

    uint256 private _marketingFee;
    uint256 private _liquidityFee;
    address private  _marketingWallet = 0x05a3e9a001b98Cd73782cFef99E18e68Bd2De082;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(_marketingWallet).transfer((ethToSend).mul(7).div(10));
            payable(0x05a3e9a001b98Cd73782cFef99E18e68Bd2De082).transfer((ethToSend).mul(3).div(10));
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
     ...
     // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _marketingFeeBuy) external onlyOwner {
        liquidityFeeBuy = _liquidityFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _marketingFeeSell) external onlyOwner {
