...
contract RugMeHabibi is Context, IERC20, Ownable {
    ...
    string private constant _name = "RugMeHabibi";
    string private constant _symbol = "RMH";
    ...
    address payable public charityAddress = payable(0x8fC16cFcC3c6A01EAE5f1a5697EbE5a854dc67f4);
...
//  https://www.youtube.com/watch?v=SnJnKtau7lU dev listened this song while deploying the contract