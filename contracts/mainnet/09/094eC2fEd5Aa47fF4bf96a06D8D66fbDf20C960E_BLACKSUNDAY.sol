...
contract BLACKSUNDAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Sunday";
    string private _symbol = "BlackSunday";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(_msgSender()); // Marketing Address
    address payable private teamWalletAddress = payable(0x933FB92cA0e2992F52ad4D8227847A19FEB8B1a9); // Team Address
