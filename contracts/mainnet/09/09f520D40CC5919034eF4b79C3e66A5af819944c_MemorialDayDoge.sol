...
contract MemorialDayDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Memorial Day Doge";
    string private _symbol = "MemorialDayDoge";
