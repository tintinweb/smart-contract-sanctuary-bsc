...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x7dDEE176F665cD201F93eEDE625770E2fD911990);
...
/* Token contract */
contract GalaDontRugMe is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x7dDEE176F665cD201F93eEDE625770E2fD911990; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x4869c74Ac8ADD56Ede7b506CD6F7106e9eaB3Fd9;
    ...
    // Name and symbol
    string constant _name = "GalaDontRugMe";
    string constant _symbol = "GALARUG";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 4%
