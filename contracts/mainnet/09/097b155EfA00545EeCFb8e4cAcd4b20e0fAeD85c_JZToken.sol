...
contract JZToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JZ";
    string private _symbol = "JZ";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x67fE890A01e7fd4848bbeE1142615E0b0117771C); 
    address payable public marketingAddress2 = payable(0x4042f5eFEA90A6Ae197E2cc49FF9D4de88Df2fF1); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x00d0E232730840C7377ba2Ec9f4D647676128009);
    ...
    uint256 private minimumTokensBeforeSwap = 0.1*10**1 * 10**_decimals; 
    uint256 _saleKeepFee = 1;

    uint256 private _totalSupply = 8.8* 10**1 * 10**_decimals;
    ...
    uint256 public _buyDestoryFee = 2;
    uint256 public _buyBackLpFee = 1;
    uint256 public _buyLpFenhongFee = 1;
    ...
    uint256 public _sellBackLpFee = 1;
    uint256 public _sellLpFenhongFee = 1;
