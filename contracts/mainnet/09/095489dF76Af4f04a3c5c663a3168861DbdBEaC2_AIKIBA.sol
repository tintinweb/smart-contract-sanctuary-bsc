...
Twitter: https://twitter.com/AIKIBABSC
...
contract AIKIBA is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"AI KIBA";
    string private _symbol = unicode"AIKIBA";
    uint256 _rTotal = 1000000000000 * 10**_decimals;
    ...
    uint256 public TaxOnLiquidity = 2;
