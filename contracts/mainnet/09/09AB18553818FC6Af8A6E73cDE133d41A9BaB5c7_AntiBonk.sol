...
contract AntiBonk  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF9F786C6a6E0F8B2909007FaC80aE1bD08E4e8bE); 
    address payable public Wallet_Dev = payable(0x837B9e352d749D25C6B8c8873331823D56c0A40E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Anti Bonk"; 
    string private constant _symbol = "AntiBonk"; 
    ...
    constructor () {
        _owner = 0x0731D4E76A708c15482F3b41EB08B318C5eCF826;
