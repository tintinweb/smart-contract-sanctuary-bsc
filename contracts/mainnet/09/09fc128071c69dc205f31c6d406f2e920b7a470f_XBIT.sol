  ...
  , IERC20Metadata
{
  ...
  constructor() {
    ...
    _mint(_msgSender(), 18000000 * 10 ** uint256(_decimals));
  }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "XBIT: decreased allowance below zero");
    unchecked {
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "XBIT: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    ...
    require(accountBalance >= amount, "XBIT: burn amount exceeds balance");
    unchecked {
