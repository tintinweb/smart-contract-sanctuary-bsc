...
contract humbum is BEP20, Auth {
    using SafeMath for uint256;
    address immutable WBNB;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    string public constant name = "Hum Bum";
    string public constant symbol = "HUMBUM";
...
event config_SwapAndSendFeeSettings(uint256 Amount, bool Enabled);
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0x66E3a96f0B8DCBbC6B926FEC8A8A26c9A1BcA169;
        devFeeReceiver = 0x66E3a96f0B8DCBbC6B926FEC8A8A26c9A1BcA169;
    ...
    function _updateTaxes() internal {
        require(totalFee.mul(Augmentbuy).div(100) < 9, "Buy tax cannot be more than 9%");
        require(totalFee.mul(Augmentsell).div(100) < 9, "Sell tax cannot be more than 9%");
        require(totalFee.mul(AugmentTransfer).div(100) < 9, "Transfer Tax cannot be more than 10%");
