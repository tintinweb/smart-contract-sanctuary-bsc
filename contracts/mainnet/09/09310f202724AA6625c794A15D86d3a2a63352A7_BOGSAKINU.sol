...
contract BOGSAKINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BOGSAKINU";
    string constant _symbol = "BOGSAKINU";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // address routerAddress = 0x30665FdD6BeA5eEAd083992Da1199abc0aA322C4; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x30665FdD6BeA5eEAd083992Da1199abc0aA322C4;
        solor = msg.sender;
...
contract StandarToken is BOGSAKINU {
    constructor() {}
}