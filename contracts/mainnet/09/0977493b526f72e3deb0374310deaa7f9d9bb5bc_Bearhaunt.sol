...
contract Bearhaunt is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 3500000000 * 10**9;
    ...
    string private constant _name = "Bearhaunt";
    string private constant _symbol = "BH";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9E89DcADF530F93b214A10DF53E36D41f3539887);
    address payable private _marketingAddress = payable(0x9E89DcADF530F93b214A10DF53E36D41f3539887);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 7, "Redis cannot be more than 7.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 7.");
	    require(taxFeeOnSell < 7, "Tax cannot be more than 7.");
