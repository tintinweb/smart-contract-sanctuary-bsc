...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9812643aa1e067c3d3dacd9d7588Fdc34ad95f78;
...
contract BABYOPTIMUS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x33B8E45C9C69aD244E4e6f61037Fb6cd351498a6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BABYOPTIMUS";
    string private _symbol = "BOPT";
