...
/*
 ...
 //Telegram : https://t.me/XieLonMusk 🟢
 //Website : https://xielonmusk.tiiny.site/

ElonMusk's lookalike, China's equivalent of TikTok. The Asian man quickly went viral for having a near perfect resemblance with Musk. 
The startling resemblance between this anonymous person and the tech billionaire led people to christen him XieLon Musk
...
contract XieLonMusk is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10_000 * 10**9; //
    string private constant _name = "XieLonMusk"; //
    string private constant _symbol = "$XieLonMusk"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x495228D8518C6B1c4523cEA720DB9184c48C76ED ;
