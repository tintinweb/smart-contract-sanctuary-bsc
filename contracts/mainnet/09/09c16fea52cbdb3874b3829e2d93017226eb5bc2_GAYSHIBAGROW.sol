...
contract GAYSHIBAGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GAY SHIBA GROW";
    string private _symbol = "GAYSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9578f7568B6EE08967A8548cbE9e7228c8BA3Aea); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9578f7568B6EE08967A8548cbE9e7228c8BA3Aea); // buyback Address
    ...
    uint256 public _maxTxAmount = 60000000000000 * 10**9; // 1.5%
    uint256 public _walletMax = 60000000000000 * 10**9; // 2.5%
