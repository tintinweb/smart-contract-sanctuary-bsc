...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xab860518f1a6e127847c8D247D51A33768c6a003; 
...
contract McFlokis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McFlokis";
    string private _symbol = "FLOKIS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x934f2c4307CC5Fc72541fEEA567B37E2FB1885d8); // 
    address payable public teamWalletAddress = payable(0xab860518f1a6e127847c8D247D51A33768c6a003); // 
