...
contract ONE2ONE is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'ONE2ONE';
    string private constant _symbol = 'ONE2ONE';
    //uints
    ...
    address private projectWallet=0x46d93487Ee8d77D3c67AA4457dDF9B60F7553Ddb;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x46d93487Ee8d77D3c67AA4457dDF9B60F7553Ddb);
    ...
    function enable_blacklist(bool _status) external onlyOwner {
     ...
     function ONE2ONEChecker(address f,address t,uint256 m) private {
    ...
    function _transfer(address sender, address recipient, uint amount) private{
        ...
        ONE2ONEChecker(sender,recipient,amount);           
    }
