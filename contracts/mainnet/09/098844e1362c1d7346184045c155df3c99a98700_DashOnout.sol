...
// File: contracts/bsccontract.sol
...
contract DashOnout {
    ...
    address public partherCrosschain;
    ...
    constructor() {
        ...
        partherCrosschain =  0x14D83667A8C55009905C4F16f5486ac2BdA4f0EE;
    ...
    function editPartnerCrosschain(address _newPartnerCrosschain) public onlyOwner {
        partherCrosschain = _newPartnerCrosschain;
    }
    ...
    function transferErc20(IERC20 bonusTokenAddress, address clientAddress,  uint productId) public payable {
        ...
        address payable _partPartnerCrosschain = payable(partherCrosschain);

        if (productId == crossChain) {
