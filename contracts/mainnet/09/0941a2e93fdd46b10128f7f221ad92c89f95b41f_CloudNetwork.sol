...
/**
Telegram : https://t.me/cloudnetworkchannel
Website : https://cloud-network.live
*/
...
contract CloudNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cloud Network";
    ...
    address payable public marketingWalletAddress = payable(0xAfF3D2816FAEEcfd8dBfa212ae24F6D6026de4C9); // Marketing Address
    address payable public teamWalletAddress = payable(0xAfF3D2816FAEEcfd8dBfa212ae24F6D6026de4C9); // Team Address
