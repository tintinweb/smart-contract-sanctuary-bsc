...
contract Xiyong is ERC20 {
	...
	address payable _fundAddress = payable(address(0x3AF2e169F66907368F4e7eD5465E9EAe978d500C));
    ...
    constructor(address tokenOwner) ERC20("LX", "LX") {
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
		...
		if(allAmount > haveAmount){
			USDT.transfer(_fundAddress,(allAmount.sub(haveAmount)).mul(5).div(6));
		}
