...
// Hitoshi Inu 等 - Hitoshi is a dog that lives in a Japanese village called Kyoto, Hiroshi is very friendly and kind to everyone.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x855ADD2Ad7434C45ddC5a32EF637175C4509eda7; // owner address
...
contract hitoshi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hitoshi Inu";
    string private _symbol = "$HITOSHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x855ADD2Ad7434C45ddC5a32EF637175C4509eda7); // 
    address payable public teamWalletAddress = payable(0x855ADD2Ad7434C45ddC5a32EF637175C4509eda7); // 
