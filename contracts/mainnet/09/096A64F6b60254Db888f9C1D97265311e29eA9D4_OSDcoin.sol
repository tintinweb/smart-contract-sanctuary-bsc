...
contract OSDcoin is IERC20, Ownable {
    ...
    address public marketAddress = 0x4b101511c4f8376A7039Af5ef669703a0AE5677b;
    uint256 private _tFeeTotal;
    string private _name = "Outer Space Doge";
    string private _symbol = "OSD";
    ...
    address public swapWhiteAddr = 0xb8aDd650f395f4048A3Ee18dB314B545A6FF9Bed;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(address sender,uint256 tAmount) private {
        ...
        if(_tFeeTotal >= 24975000000 * 10**9)_burnFee = 0;
