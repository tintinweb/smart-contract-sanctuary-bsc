...
contract LuMad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuMad";
    string private _symbol = "LuMad";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfa8263ade0fe9388b952b9d0699Df3d17Cd1eDCb); // Marketing Address
    address payable public teamWalletAddress = payable(0xfa8263ade0fe9388b952b9d0699Df3d17Cd1eDCb); // Team Address
