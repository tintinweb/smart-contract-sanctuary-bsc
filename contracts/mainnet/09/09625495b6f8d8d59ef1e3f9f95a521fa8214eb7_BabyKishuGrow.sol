...
library Address{
 ...
 contract BabyKishuGrow is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 555_555_555_555 * 10**9;
    ...
    address public marketingWallet = 0x38DC562A3832457ABD21FABa35834D882e716890;
    address public donationWallet = 0x38DC562A3832457ABD21FABa35834D882e716890;

    string private constant _name = "BabyKishuGrow";
    string private constant _symbol = "BabyKishuGrow";
    ...
    Taxes public taxes = Taxes(1, 5, 3, 1);
    Taxes public sellTaxes = Taxes(1, 5, 3, 1);
