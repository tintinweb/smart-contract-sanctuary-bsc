...
🐮💊Welcome to MUUtrition!🐮💊

An innovative project merging CRYPTO with FITNESS and NUTRITION,
with the goal of helping you become HEALTHY and WEALTHY!                                                                              

https://t.me/MUUtrition

https://www.muutrition.com/
...
contract Muutrition is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MUUtrition';
	...
	uint256 public autoBanTime = 3; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    //DevWallets
    address public Development=payable(0xE73cDC658835f317580CF21FdE37a4Ca15fA703C);
    address public Development2=payable(0xF78926F451eCE31A47A5128791e2A39f306D5B47);
    address public Marketing=payable(0x2888B60f1dd6Df2EB4d8668418e24B74122e6156);
    //MainNet
   ...
   //tracks auto generated ETH, useful for ticker etc
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 2000000 * 10**_decimals;
