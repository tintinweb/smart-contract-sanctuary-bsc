...
contract moonman is Ownership {
    using SafeMath for uint256;

    string _name = "moonman";
    string _symbol = "MOONMAN";
    uint8 _decimals = 9;
    ...
    function newaddress(uint256 iSupply) private pure returns(uint256, uint256) {
    ...
    function increaseamount(address shareholder, uint256 _amount) internal {    
