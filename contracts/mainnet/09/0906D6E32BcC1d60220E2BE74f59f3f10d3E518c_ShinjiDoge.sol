...
/* Token contract */
contract ShinjiDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "SHINJI DOGE";
    string constant _symbol = "SHIDOGE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 4% on launch 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 4% 
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 4% 
