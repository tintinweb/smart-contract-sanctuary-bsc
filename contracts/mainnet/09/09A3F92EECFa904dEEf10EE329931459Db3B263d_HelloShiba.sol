...
contract HelloShiba is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x806944e1452B4C1b09Db594C378d0CDC050933B2);
    address payable public devAddress = payable(0x806944e1452B4C1b09Db594C378d0CDC050933B2);
