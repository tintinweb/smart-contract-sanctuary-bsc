...
contract KochoShinobu is IBEP20, Auth {
    ...
    string constant _name = "Kocho Shinobu";
    string constant _symbol = unicode"$KOCHO";
    ...
    address public marketingFeeReceiver = 0xBE5231f26778BE3afD3b73D681Bf421bD08de967;
