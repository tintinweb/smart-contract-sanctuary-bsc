...
contract AVATAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "AVATAR 2.0";
    ...
    address private marketingWallet = address(0x970B967D403DECBcb4E6563cEF204Ad35029224C);
    address private liquidityReceiver = address(0x970B967D403DECBcb4E6563cEF204Ad35029224C);
