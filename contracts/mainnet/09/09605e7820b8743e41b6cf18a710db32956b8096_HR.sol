...
HACHI reflections VOL2.
For the culture, for the community.
TG: https://t.me/hachireflections
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB47586695F7288fabda99e2059AE62360a757afe; 
...
contract HR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$HACHI reflections";
    string private _symbol = "HR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB47586695F7288fabda99e2059AE62360a757afe); // 
    address payable public teamWalletAddress = payable(0xB47586695F7288fabda99e2059AE62360a757afe); // 
