...
contract LunaSnake is ERC20, Ownable {
    ...
    address public immutable USDT = address(0x156ab3346823B651294766e23e6Cf87254d68962); //LUNA

    address public marketingWallet = 0x4f1cC5D94C12fd53eEe2CF13d3be92D22A2B10C5;
    address public devWallet = 0xDaf2Cfb122b84DECD889f58944C2b24153eF649C;
    ...
    Taxes public sellTaxes = Taxes(2,5,0,0);
    ...
    constructor() ERC20("LunaSnake", "LNSNAKE") {
