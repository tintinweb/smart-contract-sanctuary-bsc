...
contract STAKE is Owner {
	...
	function buy_nft(uint256 value_1,uint256 value_2,uint256 value_3) public   lock returns(bool) {
		...
		uint r=random(100);
		string memory url="https://gateway.pinata.cloud/ipfs/QmVtkVDjuBoH5MJWpKiyPqGVT1RUcBPsr2XXmE71PydRYB";
		
		uint grade_id=1;
		if(r<5){ grade_id=4;url="https://gateway.pinata.cloud/ipfs/QmZCBWHx71QLQz8h8dvxnfmSQ2nygSh3VQFiHKdUpwGBmH";}
		if(r<15 && r>=5){ grade_id=3;url="https://gateway.pinata.cloud/ipfs/QmYsicAZBVxqcMGAaTFczWC1EXwuaRGFY1k1gsFdh5tMNF";}
		if(r<30 && r>=15){ grade_id=2;url="https://gateway.pinata.cloud/ipfs/QmV15j2McAwXMPWdAGfPd9epJ2ng5h6eZ54ghotQ7SkVmA";}
