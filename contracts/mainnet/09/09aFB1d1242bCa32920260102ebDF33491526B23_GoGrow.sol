...
Do you want 1000X...?
We will make it 1000X🔥

STEALTH LAUNCH SOON🚀🚀

GO GROW COIN is The next evolution of a reflection token on the Binance Smart Chain. GO GROW COIN will reward 2% of the transactions in awesome rewards on BUSD.

This utilities and others to-be-announced will bring the Crypto Community together, and will provide an unbelievable passive income to new investors.

ALL OF OUR PROJECT🔥

➡️ NFT Marketplace
➡️ GROW Staking
➡️ Multi Wallet & Cros Chain
➡️ GROW Swap
...
🚀 MARKETING 4%
🚀 REFLECTIONS 2%
🚀 DEVELOPMENT UTILITY 2%

🔥DON'T MISS CHANCE TO 1000X🔥

JOIN NOW👇
Website: https://gogrowcoin.com
Telegram: https://t.me/Gogrowcoin
Twitter: https://twitter.com/Gogrowcoin
*/
...
/* Token contract */
contract  GoGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xa1022F62a68eB514e02961Db617843e7EB395556;
    ...
    // Name and symbol
    string constant _name = "Go Grow";
    string constant _symbol = "GO";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // KILL ZERO

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 100 / 1000; // 1% 
    uint256 private _maxSellTxAmount = _totalSupply * 100 / 1000; // 1% 
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 1000; // 1% 
    ...
    uint256 private devFeeBuy = 2;
    uint256 private totalFeeBuy = 8;

    // Sell fees
    uint256 private liquidityFeeSell = 1;
    uint256 private buybackFeeSell = 0;
    uint256 private reflectionFeeSell = 2;
    uint256 private marketingFeeSell = 16;
    uint256 private devFeeSell = 2;
    uint256 private totalFeeSell = 21;
    ...
    uint256 private swapThreshold = _totalSupply * 50 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa1022F62a68eB514e02961Db617843e7EB395556;
