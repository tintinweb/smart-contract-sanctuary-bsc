...
contract CATSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATSHIBA INU";
    string private _symbol = "CATSHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x9Ddd7F25CcBF8dB5467E640F51663F3aeB401688); 
    address payable private teamWalletAddress = payable(0xB590C200b4EA9885910F23874546a12706D1F6d0); 
