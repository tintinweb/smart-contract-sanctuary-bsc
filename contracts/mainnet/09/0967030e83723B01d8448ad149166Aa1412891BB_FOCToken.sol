...
contract FOCToken {
    ...
    constructor() {
        name = "The Future Of Cinema"; // Sets the name of the token, 
        symbol = "FOC"; // Sets the symbol of the token,
        decimals = 6; // Sets the number of decimal places
        uint256 _initialSupply = 200000000000 * (10**uint256(decimals)); // Holds an initial supply of coins

        /* Sets the owner of the token*/
        owner = payable(0xDd88129a2758C03f334A62a082486Dc8271B7372);
