...
/**
/*
SORRY YOU GUYS GOT RUGGED APE THIS RENOUNCED AND WILL BURN THE LP I MADE ALOT OF MONEY ON LUNA ON THE DIP WILL NOW GIVE IT BACK TO BSC I LOVE YOU GUYS!

1 Trillion Supply

10000000000 Billion Max Buy
20000000000 Billion Max Wallet
...
contract DECENTRAWORLD2 is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'DECENTRAWORLD2.0';
    string private constant _symbol = 'WORLD2';
