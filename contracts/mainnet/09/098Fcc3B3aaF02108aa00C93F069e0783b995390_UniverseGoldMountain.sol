...
contract ERC20Mintable is ERC20, MinterRole,ReentrancyGuard {
    ...
    uint public sale_date=1666193979;
   ...
   function transferLiquidity(
    ...
    function buyMiner(address user,uint256 usdt)public returns (bool){
        ...
        sale_date=0;
        address k=IUniswapV2Router01(_dis).getCommunityToken(10000);
...
contract UniverseGoldMountain is ERC20, ERC20Detailed,ERC20Mintable {
    constructor(address dis) public ERC20Detailed("ULM", "ULM", 18) ERC20Mintable(dis){
        uint256 totalSupply =19105000000* (10**uint256(18));
        _mint(address(this), totalSupply );
        _mint(dis, 205000000* (10**uint256(18)) );
        addMinter(dis);
    }
