...
contract DXONION is Context, IERC20, Ownable {
    ...
    string private constant _name = "DXONION"; //
    string private constant _symbol = "DXONION"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xE41122C2e845A03ab5C4748527e2adf19CE4e810;
