...
https://t.me/GoodVibesOnlyPortal

GOOD VIBES ONLY

Good Vibes Only is a community of apes with Positive and Chill vibes 🤩.

We Chill, Chat, Shill 🚀🔥

Community Driven Project WITH a MARKETING WALLET!!!!

There is no max transaction or max wallet amount defined. Buy it all if you want. Whales welcome.

Shill it. Share it. This is our to time to shine and share GOOD VIBES with the BSC!!!
...
contract GoodVibesOnly  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Good Vibes Only';
    string private constant _symbol = 'GoodVibes';
    ...
    bool swapping; 
    bool botOn = true;
    uint256 swapThreshold = ( _totalSupply * 1500 ) / 100000;
