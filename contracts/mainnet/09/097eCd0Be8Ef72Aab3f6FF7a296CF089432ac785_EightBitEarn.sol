...
contract EightBitEarn is IERC20 {
    ...
    string constant private _name = "8BitEARN";
    string constant private _symbol = "8Bit";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x179a9CB9C80B0d05B131325090F00D8Ca5113679),
        development: payable(0x9AB074d242acA64544Ebbe9212F6e8BadB6dC366)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 development, uint16 marketing) external onlyOwner {
        ...
        _ratios.total = rewards + development + marketing;
