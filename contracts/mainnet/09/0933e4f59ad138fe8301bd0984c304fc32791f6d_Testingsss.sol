...
contract Testingsss is IERC20 {
    ...
    string constant private _name = "Testingsss";
    string constant private _symbol = "testings";
...
//===============================================================================================================
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        require((_tTotal * percent) / divisor >= (_tTotal * 20 / 1000), "Max Transaction amt must be above 2% of total supply.");
        _maxTxAmount = (_tTotal * percent) / divisor;
    }

    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        require((_tTotal * percent) / divisor >= (_tTotal / 50), "Max Wallet amt must be above 2% of total supply.");
