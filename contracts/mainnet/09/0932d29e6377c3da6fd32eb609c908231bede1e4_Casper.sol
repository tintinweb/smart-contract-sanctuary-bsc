...
contract Casper is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x2370d6DFA5a43F33855a7C2893B242045905465D);
    address public devAddress = address(0x2370d6DFA5a43F33855a7C2893B242045905465D);
