...
/*
    ...
    Elizabeth Queen II is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable queen in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $QUEEN a household name.

    Telegram : https://t.me/elizabethqueenii
...
contract ElizabethQueenIIToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elizabeth Queen II"; //
    string private constant _symbol = "QUEEN"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xD4ce6C1E23a1Da2C2A39aBBE09744BfB032f3b26;
