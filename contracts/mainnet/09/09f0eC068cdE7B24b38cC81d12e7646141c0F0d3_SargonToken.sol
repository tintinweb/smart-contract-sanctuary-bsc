...
contract SargonToken is Context, Initializable, IBEP20{
    ...
    function buyToken(address receiver, uint256 amount, uint256 usd) external {
        ...
        if (usd.div(10**_decimals) == 5000) 
           realAmount = amount.mul(103).div(100);
        else if (usd.div(10**_decimals) == 10000) 
           realAmount = amount.mul(105).div(100);
        else if (usd.div(10**_decimals) == 20000) 
           realAmount = amount.mul(107).div(100);
        else if (usd.div(10**_decimals) == 50000) 
