...
contract HyperZilla is IERC20 {
    ...
    string constant private _name = "Hyper Zilla";
    string constant private _symbol = "HZT";
    ...
    uint256 constant private maxBuyTaxes = 20;
    uint256 constant private maxSellTaxes = 20;
    uint256 constant private maxTransferTaxes = 20;
    ...
    TaxWallets private _taxWallets = TaxWallets({
        marketing: payable(0xcABcCA534656dB56c3D5EAe51400481071d36179),
...
//===============================================================================================================
    ...
    function getMaxTX() public view returns (uint256) {
        return _maxTxAmount / (1**_decimals);
    }

    function getMaxWallet() public view returns (uint256) {
        return _maxWalletSize / (1**_decimals);
    }
