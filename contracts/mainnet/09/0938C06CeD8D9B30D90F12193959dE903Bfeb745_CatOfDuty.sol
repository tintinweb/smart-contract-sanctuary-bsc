...
contract CatOfDuty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatOfDuty";
    string private _symbol = "$COD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97cAC66B2f039D223992a51a8Cd1b3a8f3CaAD45); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x97cAC66B2f039D223992a51a8Cd1b3a8f3CaAD45); // BuyBack Address
