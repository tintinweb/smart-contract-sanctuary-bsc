...
contract HamburglarInu is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 30) / 200; //3.5% 
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; //7%
    ...
    address private developmentFeeReceiver = 0xCfB2ba50807608F2537E3A086348EE7FC87522D5;
