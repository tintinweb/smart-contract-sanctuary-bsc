...
contract GALZILLA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GalZilla";
    string private constant _symbol = unicode"GALZILLA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0xd97bAE66BE22AFa9911b11B756aDAd3D2fd26dfA);
    address payable public MarketingWallet = payable(0xD49741D9A5a1DBf63A38F6e0242A699B25F765D6);
