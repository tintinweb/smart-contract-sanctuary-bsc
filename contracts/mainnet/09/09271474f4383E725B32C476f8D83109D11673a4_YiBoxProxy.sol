...
contract TransparentUpgradeableProxy is UpgradeableProxy {
     ...
     */
    constructor(address _logic, address __admin, bytes memory _data) payable UpgradeableProxy(_logic, _data) {
     ...
     * `0xd75a3d07bb23697385041aa69f4af17e6894e51b22f098908bd772ff19ff1b25`
     */
     ...
     * TIP: To get this value clients can read directly from the storage slot shown below (specified by EIP1967) using the
     * https://eth.wiki/json-rpc/API#eth_getstorageat[`eth_getStorageAt`] RPC call.
     * `0xee9acf271fa53c92ca804ae95d7f5b711b83947bed03c83ee01aed35bbdfc721`
     */
...
contract YiBoxProxy is TransparentUpgradeableProxy {
    constructor(address _implementation, address _admin, bytes memory _data) TransparentUpgradeableProxy(_implementation, _admin, _data) {
    }
}