...
/**
https://t.me/miniangeldust_HQ

The very first auto staking protocol to pay out Angel Dust REWARDS!
...
contract MiniAngelDust is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mini Angel Dust';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x6dB7f30a27212ED07AAE4a243b446f3A9e3129e9);
    address public Development=payable(0x0d68AC5BFe491C8Ebd74FC49ddA248d0804a62D7);
    //TestNet
    ...
    uint8 public marketingShare=73;
    ...
    function claim(address addr) private{
        ...
        path[1] = 0x0D536B28Cb33226DBab5B3B086b2c257F859E16B;  //Binance-Peg BUSD Token
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3500000000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*60) / 100);
