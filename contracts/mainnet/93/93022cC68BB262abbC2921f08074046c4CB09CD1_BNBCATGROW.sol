...
contract BNBCATGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBCATGROW";
    string private _symbol = "BNBCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9b485Bdc0417c0630576021B1546971747267014);
    address payable public TeamWalletAddress = payable(0x9b485Bdc0417c0630576021B1546971747267014);
    ...
    uint256 public _maxTxAmount = 188 * 10**9; 
    uint256 public _walletMax = 388 * 10**9; 
