...
contract Tri is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 TRI
    ...
    uint256 public constant START_COMMUNITY_FUND_POOL_ALLOCATION = 1000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 10000 ether;

    uint256 public constant VESTING_DURATION = 45 days;
    ...
    constructor() public ERC20("TriFold", "TRI") {
        // mint 1000 TRI for initial ecosystem development
        _mint(msg.sender, START_COMMUNITY_FUND_POOL_ALLOCATION);

        communityFundRewardRate = COMMUNITY_FUND_POOL_ALLOCATION.div(VESTING_DURATION);
        devFundRewardRate = DEV_FUND_POOL_ALLOCATION.div(VESTING_DURATION);
    }

    function init(uint256 _startTime, address _communityFund, address _devFund) external onlyOperator {
