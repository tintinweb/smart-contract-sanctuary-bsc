...
contract FTXSHIBA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7A9849E7ff01ED5bE4020dC8eD4D35886D90a3d5); // Marketing Address
    ...
    string private _name = "FTX SHIBA";
    string private _symbol = "FTX-SHIBA";
