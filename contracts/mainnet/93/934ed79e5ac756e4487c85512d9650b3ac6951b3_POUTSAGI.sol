...
abstract contract Ownable is Context {
    ...
    constructor() {
        //0x048B3c643A5763f9F57F7982c20Cf35B1141A1B4
        _owner = _msgSender();
...
contract POUTSAGI is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public buyMarketingFee = 30; // 2%
    uint256 public buySantaPresentFee = 0; // 3%
    uint256 public buyTeamFee = 20; // 1%
    uint256 public buyLpFee = 20; // 2%
    uint256 private dexBuyFeeTotal; // Sum of all buyfees

    uint256 public sellMarketingFee = 30; // 2%
    uint256 public sellSantaPresentFee = 0; // 3%
    uint256 public sellTeamFee = 20; // 1%
    ...
    constructor() {
        _mint(0x048B3c643A5763f9F57F7982c20Cf35B1141A1B4, _initSupply); // alt owner()

        taxAddress = 0xa82E349022d20103853a4bd61BA8A6a5E507917C; // alt 0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A
        marketingWallet = 0x6788939151fAA7cCCE82d03ae6E2cF9ed344919D;
        santaPresentWallet = 0x2025efdD9A70304668251e84F7d031f791e1B605;
        TeamWallet = 0x7B41Ae7DC9c87BC49ab11af60615bd20B6584AFD;

        maxTokenPercentage = 50; // initial 0.5% of total supply.
    ...
    function swapAndLiquify(uint256 contractBalance) private lockTheSwap {
        ...
        uint256 _sPFee = _sellBal.mul(sellSantaPresentFee).div(dexSellFeeTotal);
        ...
        uint256 _sPFeeB = _buyBal.mul(buySantaPresentFee).div(dexBuyFeeTotal);
        payable(santaPresentWallet).transfer(_sPFeeB);
