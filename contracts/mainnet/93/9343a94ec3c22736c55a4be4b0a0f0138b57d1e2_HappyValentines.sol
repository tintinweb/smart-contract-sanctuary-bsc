...
/**
HAPPY VALENTINES SmartContract on Binance Smart Chain
...
contract HappyValentines is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HappyValentinesDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Happy Valentines", "HAPPYVALENTINES") {
        marketingWallet = payable(0xeF8c4FeA0A12746A0ed14cAa81945bB396C20f39);
        devWallet = payable(0xBc094892b75d647d13e89C28A55BA38927c920c0);
        ...
        dividendTracker = new HappyValentinesDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "HappyValentinesTRACKER",
            "HAPPYVALENTINESTRACKER"
        );
    ...
    function tradingStatus(bool newTradingStatus) external onlyOwner{
...
contract HappyValentinesDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HappyValentines public HappyValentinesContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HappyValentinesContract = HappyValentines(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HappyValentines_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HappyValentines_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HappyValentines contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HappyValentinesContract);

            uint256 prevBalance = HappyValentinesContract.balanceOf(address(this));
            ...
            {
                uint256 received = HappyValentinesContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HappyValentinesContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
