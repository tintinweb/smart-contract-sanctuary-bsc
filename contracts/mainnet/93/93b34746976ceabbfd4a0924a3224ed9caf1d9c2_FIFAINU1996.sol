...
Telegram: https://t.me/fifainu1996official
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51d2AD9f35888053502EaD4A48ff7b2FF4A7ae7E;
...
contract FIFAINU1996 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$FINU1996"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x51d2AD9f35888053502EaD4A48ff7b2FF4A7ae7E);
