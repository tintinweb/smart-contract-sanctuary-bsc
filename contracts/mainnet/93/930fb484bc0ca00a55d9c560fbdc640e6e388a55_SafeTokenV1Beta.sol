...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Lithium";
    string internal constant SYMBOL = "LITH";
    ...
    address internal charityAddress = 0xC5E983A48104d453323d94eD34e3714B364c340A;
    address internal marketingAddress = 0x134afBa1cBe048d2629EE11612638F5b23942E9c;
    address internal burnAddress = 0x000000000000000000000000000000000000dEaD;
    address internal tipToTheDev = 0xb5f085401463f46Be6DC19CD739eEbB425E0E249;
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.External, 60, charityAddress );  //lithium parcels
        _addFee(FeeType.Liquidity, 25, address(this) );  //Liquidity
        _addFee(FeeType.Rfi, 5, address(this) );         //Reflection or distribution between holders
        _addFee(FeeType.ExternalToETH, 5, tipToTheDev ); //Dev Core Team
        _addFee(FeeType.External, 5, marketingAddress ); //Marketing
        _addFee(FeeType.Burn, 0, burnAddress );          //0% Burn
