...
contract MineZha is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MineZha";
    string private _symbol = "MineZha";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x5876685c4B6BfFCD178C9b316EDddEEe86C9249c);
