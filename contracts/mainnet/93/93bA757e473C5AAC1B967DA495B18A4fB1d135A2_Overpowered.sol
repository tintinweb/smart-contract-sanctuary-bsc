...
/**
Website:  https://overpowered.finance/

OVERPOWERED - Official

Welcome to OverPowered.

Trade Safer, Smarter While Staying Tax Compliant
...
contract Overpowered is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_constructor[_bool] == 0) 
            _constructor[_bool] = _uint256;
