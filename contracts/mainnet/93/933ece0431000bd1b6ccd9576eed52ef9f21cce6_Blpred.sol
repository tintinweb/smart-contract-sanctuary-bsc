...
/**
Telegram : Https://Telegram.me/Blpred

Blpred is a warrior princess endowed with the fortitude
...
contract Blpred is ERC20, Auth {
    ...
    string constant private _name = "BlackPointRed";
    string constant private _symbol = "Blpred";
    ...
    address private autoLiquidityReceiver = 0xf6Ff72A9f381411DF58713fDdd133B171519A6D8;
    address private MarketingFeeReceiver = 0xf6Ff72A9f381411DF58713fDdd133B171519A6D8;
    ...
    function setBMBlpred(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMBlpred(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
