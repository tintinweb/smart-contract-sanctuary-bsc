...
//  HAPPY NOT BIRTHDAY - $HNBD - Binance Hyped Token

     Cz and binance don't want y'all to make a coin for it. 🤣
     

    https://twitter.com/binance/status/1568576237513089025 

   " Happy not birthday Cz_binance! "


    TG: https://t.me/HappyNotBirthdayInu
...
contract HappyNotBirthdayInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HAPPY NOT BIRTDAY INU";
    string private _symbol = "$HNBD";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x07CEEbA4270cF55eD1b41C5409Ec1652Eea32B72);
