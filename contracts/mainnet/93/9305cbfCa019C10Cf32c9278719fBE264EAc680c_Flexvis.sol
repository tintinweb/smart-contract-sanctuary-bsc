...
abstract contract BEP20Pausable is Context, AccessControl, ERC20, Pausable {
    ...
    uint256 constant public DEVELOPMENT = 100_000E18;
    uint256 constant public RESERVE_FUND = 125_000E18;
    uint256 constant public TREASURY = 90_000E18;
    uint constant public MARKETING= 85_000E18;
    ...
    function blockAccount(address account) public virtual {
        require(hasRole(BLOCK_ROLE, _msgSender()), "must have block role to block");
    ...
    function unblockAccount(address account) public virtual {
        require(hasRole(BLOCK_ROLE, _msgSender()), "must have block role to unblock");
    ...
    */
    ...
    function mint(
        ...
        require(!_mintingFinished, "mint finished");
    ...
    */
    function finishMinting() public returns (bool) {
        require(hasRole(MINTER_ROLE, _msgSender()), "must have minter role to finish minting");
        ...
        internal virtual override
    {
        ...
        require(!isBlockListed(from), "Sender account is blocked");
        require(!isBlockListed(to), "Receipient account is blocked");
    }
...
contract Flexvis is BEP20Pausable("Flexvis", "FLX") {

    constructor(address _development, address _treasury, address _marketing, address _reserve_fund){
