...
contract mmmmmmmm is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7b7eCb6cB1DF65eBf1cF3c8Be08d926775a84cfb);
    address payable public teamWalletAddress = payable(0x8037A8CF70C1a77CDF831BA7534D2Fda8ACC3376);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            feeAmount = amount.mul(_totalTaxIfBuying).div(0);
        }
        else if(isMarketPair[recipient]) {
            feeAmount = amount.mul(_totalTaxIfSelling).div(0);
        }
