...
/**
        Test whenever you need to test.
        TG: Testmyballs
        Website: Testit.com
*/
...
contract Testies is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0x1F66F8327039055B6A41B7859484bdA6BF373C53;

    string private constant _name = "Testies";
    ...
    Taxes public taxes = Taxes(0, 9, 2);
    Taxes public sellTaxes = Taxes(0, 9, 2);
