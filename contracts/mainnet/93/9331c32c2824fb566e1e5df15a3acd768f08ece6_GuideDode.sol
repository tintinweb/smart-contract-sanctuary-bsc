...
contract GuideDode is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GuideDoge";
    string private _symbol = "GuideDoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD34f739442521D8b5B4b0da17cA6BcC1cEc29628); // Marketing Address
    address payable public teamWalletAddress = payable(0x4EEE647AEA317cECEfB76cc2A8085b654A78a392); // Team Address
