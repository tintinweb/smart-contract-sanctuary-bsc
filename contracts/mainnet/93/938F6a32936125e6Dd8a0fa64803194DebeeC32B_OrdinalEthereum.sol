...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95CAB21552347FcB35d2658C58EDb7fB2529E1A1; // owner address
...
contract OrdinalEthereum is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Ordinal Ethereum";
    string private _symbol = unicode"OEth";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95CAB21552347FcB35d2658C58EDb7fB2529E1A1); // Marketing Address
    address payable public teamWalletAddress = payable(0x95CAB21552347FcB35d2658C58EDb7fB2529E1A1); // Team Address
