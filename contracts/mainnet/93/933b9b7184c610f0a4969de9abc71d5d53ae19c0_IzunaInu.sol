...
contract IzunaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7889dfefe85e2b757989530fA0029644F4A6B768); 
    ...
    string private constant _name = "Izuna Inu"; 
    string private constant _symbol = unicode"$IZUNA"; 
