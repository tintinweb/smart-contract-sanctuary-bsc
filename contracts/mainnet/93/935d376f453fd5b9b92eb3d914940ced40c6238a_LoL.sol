...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3B0e0Fff0E3A4E03281b722C22Ef8EBae990054E; // owner address
...
contract LoL is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3B0e0Fff0E3A4E03281b722C22Ef8EBae990054E); // Marketing Address
    address payable public teamWalletAddress = payable(0x3B0e0Fff0E3A4E03281b722C22Ef8EBae990054E); // Team Address
