...
// Telegram : https://t.me/bsquidgrowexclamationspoint3x
// Baby Squidgrow to the moon. - Maru
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3b284Af48846cf58964a6FF3a725eCe385A40f04;
...
contract BabySquidgrow is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x3b284Af48846cf58964a6FF3a725eCe385A40f04);
    ...
    */
    ...
    string private _name = "Baby Squidgrow!!!"; 
    string private _symbol = "BSGROW!!!";  
...
// If we found any botters or snipers, we wont launch the token hence we are going to take the liquidity out and thinking for the next launch. 
// Either same name or different one. We just want to have a clean launch, thats it. 
// Stop sniping, or else your funds will be lost. We are not responsible for the funds that are lost. Many people gain from sniping, and its unfair
// for normal investors since they will be 100% slower than the bots. Thanks for your understanding.
