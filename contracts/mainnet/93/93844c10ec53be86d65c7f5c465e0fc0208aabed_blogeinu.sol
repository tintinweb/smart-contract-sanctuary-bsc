...
Originally contract of Bloge Inu
BLOGE will be next hype meme token with utility
...
contract blogeinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOGE INU";
    string private _symbol = "BLOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAfF598A5038efB89C8a54B107fD8F8e17Eb0CAA3); 
    address payable public teamWalletAddress = payable(0x012dE54AF25FC6b10dE859Fc4E03E9e761a7153b); 
