...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x6537D4525f90951435bFeBDf4FFCf91e4525f982);
    address public fundAddress1 = address(0x17214c7BCC10D863Dd1304134F56184444D793c3);
    address public fundAddress2 = address(0x493AE551cdb2470c19B0bAFAc8e9B049994a6a0C);
    
    string private _name = "Totme";
    string private _symbol = "Totme";
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = usdtBalance /5;
        USDT.transferFrom(address(_tokenDistributor), fundAddress1, fundAmount);
        USDT.transferFrom(address(_tokenDistributor), fundAddress2, fundAmount);
        USDT.transferFrom(address(_tokenDistributor), fundAddress, usdtBalance-fundAmount-fundAmount);
    }
