...
/**
   ...
   Time: 10:00 AM Friday, Sept 9, 2022, UTC.
   #Elizabeth was dead, and Charles Philip Arthur George become the new king，this is historic time ？

   #Charles III will list on #BSC at 10:00 AM Friday, Sept 9, 2022, UTC.

   I make this #Charles III to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/Charleslllbsc
   ...
   I will renounce the ownership to burn addresses to transfer #Charles III to the community and ensure it's 100% safe.

   I will add 9.6(Queen's age) BNB and 99% of the total supply to the pool
   Can you make #Charles III 10000000X? 
...
contract CharlesIII is IERC20, Ownable {
    ...
    address public marketAddress = 0xcd2341B71569bA81c1c930Cb3ed2faF67644f979;

    IPancakeRouter02 internal uniswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IERC20 private c_usdt = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    constructor() public {
        ...
        _totalSupply = total;
        emit Transfer(address(0x54901D18fc35Eb2AA8fA7017d6b8a651c4390191), msg.sender, total);
    }
