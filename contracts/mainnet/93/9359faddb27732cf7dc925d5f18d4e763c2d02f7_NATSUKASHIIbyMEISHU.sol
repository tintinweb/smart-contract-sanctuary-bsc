...
Medium - https://medium.com/@therealmeishu
Twitter - https://twitter.com/therealmeishu
*/
...
/* Token contract */
contract NATSUKASHIIbyMEISHU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Natsukashii";
    string constant _symbol = "NATSUKASHII";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 100) / 10000; // 1% on launch or 10k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9A54f3b00769de8159e6b4f3B483E9382BbB6F15;
        devFeeReceiver = 0xd12b06E0a0d8b4C3d7E41D9a53cC92931B12D84c;
