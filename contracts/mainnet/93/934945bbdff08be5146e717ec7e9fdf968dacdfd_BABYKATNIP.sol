...
contract BABYKATNIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY KATNIP";
    string private _symbol = "BABYPURR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf686CCB75c6E11596a36F3A2dC3f611cDce8B795); 
    address payable public buyBackWalletAddress = payable(0xeE4d7B68574B6B29Eb3022f8Db28ce00242129Bd); 
