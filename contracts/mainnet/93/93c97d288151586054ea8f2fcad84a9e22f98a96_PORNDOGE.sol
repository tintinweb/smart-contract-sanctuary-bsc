...
contract PORNDOGE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PornDoge";
    string constant _symbol = "PORND";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xB3E437C752eeD1A1e93Faa68B3D65e6bce8B378d;
