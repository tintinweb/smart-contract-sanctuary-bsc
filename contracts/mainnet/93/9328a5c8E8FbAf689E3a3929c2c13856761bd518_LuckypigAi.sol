...
🚀🚀🚀 FAIR LAUNCH TODAY (3rd March)  at 8pm UTC

Are you ready to get lucky? Introducing LuckyPigAI token, the next big addition to the BSC family! With a total supply of 100 million tokens, LuckyPigAI is designed to serve as a currency for bonuses and rewards on THE #1 crypto casino to offer AI-based games. But that's not all - the team is focused on unique user and holder experience : with a staking and reward system in place, LuckyPigAI holders are incentivised to hold onto the token and re-ape with the rewards. So don't miss your chance to get in on the action - DYOR & buy LuckyPigAI today and see where your luck takes you! 

🟢Features (for more details, please read the whitepaper) :
🐷Staking 🎰
🐷Casino AI-based games 🎰
🐷BNB rewards 🎰
🐷Huge airdrops 🎰
🐷And a lot of surprises!!! 🎰

🟢 Tokenomics :
Total Supply: 100,000,000 LPAI
DEX : 55% in PancakeSwap
Burn : 45%
Liquidity : 3 BNB
Liquidity Locker : Mudra (2 years)
Taxes : 2% buy tax + 4% sell tax

🟢Upcoming Roadmap :
🚀🚀🚀 Today (3rd March) : A.M.A at 11pm UTC
🚀 6th March : Official Website integrating the GUI staking platform
🚀 7th March : Casino website launch

🚀 10th March : CMC Listing + Surprise !! 

🚀🚀🚀 April : Binance AMA, Audit & KYC


✈️ Telegram: https://t.me/LuckyPigAI
*/
...
contract LuckypigAi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5Df8c789daaef177a74968250caaA81b042d6C62;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "LuckyPig AI";
    string constant _symbol = "LPAI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5bD0FD5c0B5fd5178A2982b1A2dec16aC20f2473;
