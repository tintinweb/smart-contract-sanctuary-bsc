...
contract Beach is Context, IBEP20, Ownable {
    ...
    constructor(address payable addr1, address payable addr2,address payable addr3 ,address addr4) {
        ...
        _sellFutureFee = _sellContractFee.div(1);
        ...
        _buyFutureFee = _buyContractFee.div(1); 
    ...
    function checkExcludedAddress(address _address) public onlyOwner view  returns(bool bothFee,bool buyFeeOnly,bool sellFeeOnly){
