...
contract PersianDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PersianDOGE";
    string private _symbol = "PDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE9Ec0be27987c63Fe9b34a4b9505D6de9FA5dDeD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE9Ec0be27987c63Fe9b34a4b9505D6de9FA5dDeD); // BuyBack Address
    ...
    uint256 public _walletMax = 70 * 10**6 * 10**9;
