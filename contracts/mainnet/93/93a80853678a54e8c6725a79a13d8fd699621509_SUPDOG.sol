...
contract SUPDOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUPDOGE";
    string private constant _symbol = "SDOE";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 70, "Tax cannot be more than 60.");
	    require(taxFeeOnSell < 70, "Tax cannot be more than 60.");
