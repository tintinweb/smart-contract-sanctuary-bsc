...
contract BabyMetaWikiCat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyMetaWikiCatDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BABY META WIKI CAT", "BMWC") {
        marketingWallet = payable(0x0ED19cF167f8EC48568946aB3f122A64c2f7A0D5);
        devWallet = payable(0x8Fbfad261CBE164CF3C2f54c8aA0da76Ef3543c6);
        ...
        dividendTracker = new BabyMetaWikiCatDividendTracker(
            payable(this),
            router,
            0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,
            "BabyMetaWikiCatTRACKER",
            "BabyMetaWikiCatTRACKER"
        );
...
contract BabyMetaWikiCatDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyMetaWikiCat public BabyMetaWikiCatContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyMetaWikiCatContract = BabyMetaWikiCat(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyMetaWikiCat_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyMetaWikiCat_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyMetaWikiCat contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyMetaWikiCatContract);

            uint256 prevBalance = BabyMetaWikiCatContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyMetaWikiCatContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyMetaWikiCatContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
