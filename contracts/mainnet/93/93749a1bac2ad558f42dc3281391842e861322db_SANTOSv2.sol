...
contract SANTOSv2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "SANTOS Version 2";
    string private constant _symbol = "SANTOSv2";
