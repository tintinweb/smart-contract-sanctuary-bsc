...
contract BomberShiba  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD0C53e3F4A10EC8AC341F1f2FDe78eE18BC187ef); 
    address payable public Wallet_Dev = payable(0xD0C53e3F4A10EC8AC341F1f2FDe78eE18BC187ef);
    ...
    string private constant _name = "Boomber Shiba"; 
    string private constant _symbol = unicode"BSHIBA"; 
    ...
    uint256 public Percent_AutoLP = 35; 
    ...
    constructor () {
        ...
        _owner = 0x48095544514D8be95302773C0aacB37005eAF874;
