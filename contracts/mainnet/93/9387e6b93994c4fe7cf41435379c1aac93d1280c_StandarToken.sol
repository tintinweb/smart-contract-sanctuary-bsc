...
contract starry is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "starry";
    string constant _symbol = "starry";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //sushi rop
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x6B550f05A44e98688800f9147A14CBbF5449096E;
        solor = msg.sender;
...
contract StandarToken is starry {
    constructor() {}
}