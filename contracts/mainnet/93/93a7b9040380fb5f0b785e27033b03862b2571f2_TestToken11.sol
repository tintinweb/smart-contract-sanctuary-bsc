...
contract TestToken11 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint private holdingCapPercent = 100;
	string private _name = "TestToken11";
	string private _symbol = "TT11";
