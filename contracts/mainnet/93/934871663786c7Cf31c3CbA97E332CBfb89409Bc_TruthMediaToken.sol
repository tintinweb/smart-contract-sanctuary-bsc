...
// Related to Zuck Bucks on ETH 0xB90D0CAE4048b48Ad9E31Cd14f1c9849eAE4D114
...
contract TruthMediaToken is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping(address => uint256) private _includedInFee;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _excludedFromFee;
    string private _name = "Truth Media";
    string private _symbol = "Truth Media";
