...
/**
https://t.me/TerraLunaBSC

https://terraluna.digital/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaEFE15D2089Fc34f335B0598f7b5fb78CC34Db59; // owner address
...
contract NewTerraLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewTerraLuna";
    string private _symbol = "NLUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaEFE15D2089Fc34f335B0598f7b5fb78CC34Db59); // Marketing Address
    address payable public teamWalletAddress = payable(0xaEFE15D2089Fc34f335B0598f7b5fb78CC34Db59); // Team Address
