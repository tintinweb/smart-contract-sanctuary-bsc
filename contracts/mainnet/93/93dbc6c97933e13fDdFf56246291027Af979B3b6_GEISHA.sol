...
contract GEISHA is Context, IERC20, Ownable {
    ...
    uint256 public Geisha_max_BuyLimit = 5000000000 * 10**9;
    uint256 public Geisha_max_SellLimit = 5000000000 * 10**9;
    ...
    function GeishaCooper_Max_Walletlimit(uint256 amount) external onlyOwner{
