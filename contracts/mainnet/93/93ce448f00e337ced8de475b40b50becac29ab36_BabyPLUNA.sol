...
contract BabyPLUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby LUNA Pizza";
    string private _symbol = "BabyPLUNA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB72094080450ECeb8515ed02F43595De16c5d594); 
    address payable public BurnedWalletAddress = payable(0xB72094080450ECeb8515ed02F43595De16c5d594); 
