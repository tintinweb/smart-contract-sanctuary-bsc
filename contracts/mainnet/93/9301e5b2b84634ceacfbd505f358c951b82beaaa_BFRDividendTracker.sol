...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
 ...
 //security fn 
  ...
  function updateUniswapRouter(address newAddress) public onlyMaster {
...
contract BFR is ERC20, Ownable {
    ...
    constructor() public ERC20("Baby Fenrir", "BFR") {
        ...
        address _uniswapV3Pair = IUniswapV3Factory(_uniswapRouter.factory())
        ...
        dividendTracker.excludeFromDividends(address(_uniswapRouter));
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        ...
        newDividendTracker.excludeFromDividends(address(uniswapRouter));
    ...
    function updateUniswapRouter(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapRouter), "BFR: The router already has that address");
...
// sell fee set
        if( 
            ...
            from != address(uniswapRouter) && //router -> pair is removing liquidity which shouldn't have max
