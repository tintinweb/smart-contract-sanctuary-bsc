...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8e8e1BD0C2c95B857793a415FDEa1365952254D0; // owner address
...
contract CTRLF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CTRL-F";
    string private _symbol = "FIND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e8e1BD0C2c95B857793a415FDEa1365952254D0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8e8e1BD0C2c95B857793a415FDEa1365952254D0); // Team Address
