...
contract Y is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000000000000000000 * 10**18;
    ...
    address public ownerAddres = address(0x28258630fd154963100Fd76eE0cE5C262AFefF05);
    address public devAddress = address(0xB001Ee129d19400db5328443DDb5255DD014daE3);
    ...
    uint256 public _maxTxAmount = 100000000000000000000000000000000000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 100000000000000000000000000000000000 * 10 **18;
    uint256 public feeAllTotal = 100000000000000000000000000000000000 * 10 **18;
