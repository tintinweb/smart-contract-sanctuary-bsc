...
contract BKISHU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Basic Kishu";
    string private _symbol = "BKISHU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x8b8953cbd9D4A6f755fa12cfB7b1e88159E9A44d); // Team Address
