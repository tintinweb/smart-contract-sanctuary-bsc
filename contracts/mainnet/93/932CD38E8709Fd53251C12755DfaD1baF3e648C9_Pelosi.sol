...
contract Pelosi is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x885764Ad778fA4FD941B5BCdee98b6666B01B3DB);
    address payable private receiveLP = payable(0x7227801C4DeAB8cd906636310cAC7D3dd9709258);
