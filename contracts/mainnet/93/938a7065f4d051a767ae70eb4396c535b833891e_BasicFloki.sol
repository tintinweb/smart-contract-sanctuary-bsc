...
/** 
    Welcome to Basic Floki
    Telegram : https://t.me/basicfloki_bsc
*/
...
contract BasicFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Basic Floki";
    string private _symbol = "BASICFLOKI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0xAa27DdA1A5Df07FfA525f64625d8fA92EbeED23A);
