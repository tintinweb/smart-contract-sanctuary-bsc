...
contract DroidFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100 * 10**9 * 10**DECIMALS;

    uint256 public liquidityFee = 6;
    uint256 public treasuryFee = 6;
    uint256 public riskFreeValueFee = 6;
    ...
    ) ERC20Detailed("TEST - Droid Finance", "TEST-DROID", uint8(DECIMALS)) {
