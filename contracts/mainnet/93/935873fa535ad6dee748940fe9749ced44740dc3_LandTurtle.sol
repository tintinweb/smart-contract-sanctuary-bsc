...
contract LandTurtle is IBEP20, Auth {
    ...
    string constant _name = "Super Land Turtle";
    string constant _symbol = "LandTurtle";
    ...
    mapping(address => uint256) private buyTimer;
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0xCc316B288EE678DCC099539afFffc1c0d803f9D2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == uniswapV2Pair) {
            if (lastTxn != address(0)) {
                buyTimer[lastTxn] = block.timestamp;
                lastTxn = address(0);
            }
            if (!bReward) {
                lastTxn = recipient;
