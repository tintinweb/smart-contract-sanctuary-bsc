...
contract RisingCoin is Context, IERC20, Ownable {
    ...
    string private _name = "RISC";
    string private _symbol = "RISC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC81836AE244127eab29fbEAcFc3d2d1e13Bb6C1F);
    address payable public teamWalletAddress = payable(0xCb6e772e2DA9F0C0370b6AC9D7894AF9eA662f7b);
