...
contract CONTRACT_NAME is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Qatar&Ecuador";
    string constant _symbol = "QAER"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 50 / 1000; //Initial 0.5%
    uint256 public _maxWalletSize = _tTotal * 100 / 100; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0x2EbfB65E088561cf986165D5dDB40f5D9A605DC7;
    address public marketingFeeReceiver = 0x2EbfB65E088561cf986165D5dDB40f5D9A605DC7;
    address public liquidityFeeReceiver = 0x2EbfB65E088561cf986165D5dDB40f5D9A605DC7;

    IDEXRouter public uniswapRouterV2;
    address public uniswapPairV2;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _tTotal * 10 / 100; //0.1%
    uint256 public maxSwapSize = _tTotal * 1 / 100; //0.01%
