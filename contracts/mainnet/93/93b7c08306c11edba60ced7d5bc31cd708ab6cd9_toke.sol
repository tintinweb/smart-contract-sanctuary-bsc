...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xF3B41e003078b9Db3d8b59D393f1d88D39084F2a;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xF3B41e003078b9Db3d8b59D393f1d88D39084F2a),//fund address
    
        address(0xF3B41e003078b9Db3d8b59D393f1d88D39084F2a)//dev address
    ){
