...
// 
//
// 📱 Telegram:https::https://t.me/+nOuvnBNI_jgyOGNl
/*
...
contract TWITTERYACHTCLUB is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("TWITTERYACHT CLUB", "TWITTERYACHTCLUB") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TWITTERYACHTCLUB";
    string private _symbol = "TWITTERYACHTCLUB";
