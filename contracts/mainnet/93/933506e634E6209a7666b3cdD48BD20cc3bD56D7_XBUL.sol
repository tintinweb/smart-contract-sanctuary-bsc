...
// XBUL is the coolest bar in town. You come in with some Reward, and leave with more! The longer you stay, the more Reward you get.
//
// This contract handles swapping to and from xReward, AMMSwap's staking token.
contract XBUL is ERC20("xBUL", "xBUL"){
    using SafeMath for uint256;
    IERC20 public reward = IERC20(0xdC204a33D49Af5A6b29eFfE3D12e380e87A7D38D);
