...
contract AKEMIBSC is IBEP20, Auth {
    ...
    string constant _name = "AKEMI";
    string constant _symbol = "AKEMI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 10 / 1000; // 0.5%
    uint256 public _maxTxAmountSell = _totalSupply * 10 / 1000; // 0.5%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 15 ) / 1000; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x267c9a04B077ea34F299DB6e06e04295dE0510a3;
        marketingFeeReceiver = 0x267c9a04B077ea34F299DB6e06e04295dE0510a3;
        devFeeReceiver = 0xA4d595B81B7e2C82195F1911361aDbEEcc3BC567;
