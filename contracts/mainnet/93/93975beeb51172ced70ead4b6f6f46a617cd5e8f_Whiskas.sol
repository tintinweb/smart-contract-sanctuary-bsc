...
contract Whiskas is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 20; // totalsupply divided with 20
    uint256 public maxTxAmountSell = _tTotal / 20; // 
    uint256 public maxWalletAmount = _tTotal / 20; // 
    ...
    string private constant _name = "Whiskas";
    string private constant _symbol = "$FLEABAG";
