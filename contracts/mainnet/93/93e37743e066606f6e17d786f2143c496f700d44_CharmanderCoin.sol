...
contract CharmanderCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Charmander Coin";
    string private _symbol = "Charmander Coin";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x8289403DaE42Bf4432a461adADC50B38e6e1f599); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x8289403DaE42Bf4432a461adADC50B38e6e1f599); // buyback Address
    ...
    uint256 public _walletMax = 10000000 * 10**9; // 5%
