...
contract LCT is ERC20 {
	...
	address private _fundAddress = address(0x39172eF7DfEfa2CBe187ADFd4F0442C9bE78888d);
	address private _luckAddress = address(0x5F049Da5D5d9771Eaa6C6Dd7886804A5f99B8571);
    ...
    constructor(address tokenOwner) ERC20("LCT", "LCT") {
        ...
        _mint(tokenOwner, 80000000 * 10**18);
		_mint(_luckAddress, 20000000 * 10**18);
