...
TG : https://t.me/Shikokutomillionaire
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11ce35A1e968d007bcFdB1f878b4f5Ab92df806f; // owner address
...
contract ShikokutoMiilionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikoku to Miilionaire";
    string private _symbol = "$StM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11ce35A1e968d007bcFdB1f878b4f5Ab92df806f); // Marketing Address
    address payable public teamWalletAddress = payable(0x11ce35A1e968d007bcFdB1f878b4f5Ab92df806f); // Team Address
