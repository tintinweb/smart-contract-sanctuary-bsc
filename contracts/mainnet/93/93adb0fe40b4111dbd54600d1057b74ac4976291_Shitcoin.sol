...
contract Shitcoin is IERC20, Ownable
{
    ...
    //Token Info
    string public _name = "Shitcoin";
    string public _symbol = "$SC";
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000 * 10**_decimals;//equals 10000000 tokens 10000000
    ...
    //DevWallets
    address public Development=payable(0xF534fC93d26CbA385095f8Bf34c4aa1C2AD6B190);
    address public Marketing=payable(0xF534fC93d26CbA385095f8Bf34c4aa1C2AD6B190);
    //MainNet
    address private constant UniswapV2Router=0x10ED43C718714eb63d5aA57B78B54704E256024E; //ERC UniswapV2: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    uint256 private MaxBuy = 200000 * 10**_decimals; // 200000 tokens
    ...
    uint256 currentAmountToSwap = 80000 * 10**_decimals;  // 80000 tokens (0.5%)
