...
/*
Telegram: https://t.me/NOMAD_SHIBA
WHALE ONLY ZONE NO PAPER HANDS BEYOND THIS POINT - Renounced Contract No warnings, The safest it gets.
Lock will be extended Upon mcap goals
*/
...
contract NOMADSHIBA is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xa87D3DD2aA1a6d2aedb09797eC75898B615909f4);
    ...
    string private constant _name = "NOMADSHIBA";
    string private constant _symbol = unicode"NOMADSHIBA";
    ...
    constructor() {
        _owner = 0xa87D3DD2aA1a6d2aedb09797eC75898B615909f4;
