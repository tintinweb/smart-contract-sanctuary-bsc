...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE COIN
...
contract TitterDoge is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Titter Doge";
    string constant _symbol = "TDOGE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x1b8306D66b660b2e12a567f55386251202601a6b;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
