...
contract MCHGUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Machine Gun Ape";
    string private _symbol = "MCHGUN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xB3E273312cCfeeB08641cF35A884AdCE9Ff1f514); // Marketing Address PF
    address payable public BuyBackWallet = payable(0xB678CCbE9b288c0A4a69a13ad0C72116AafE7c20); // Team Address
    ...
    uint256 private _totalSupply = 100 *  10**11 * 10**_decimals;
