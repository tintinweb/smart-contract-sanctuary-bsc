...
contract Kingtwopointzero is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King 2.0";
    string private _symbol = "King2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb59Db6217007831aaa20f40f8A3aBEa6329D5cBA); // Marketing Address
    address payable public teamWalletAddress = payable(0xb59Db6217007831aaa20f40f8A3aBEa6329D5cBA); // Team Address
