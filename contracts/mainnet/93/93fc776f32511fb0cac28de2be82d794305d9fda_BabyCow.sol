...
contract BabyCow{
    ...
    uint256 private _totalSupply = 25000000000000000000000000000000;
    string private _name = "BabyCow";
    ...
    uint256 private salePrice = 2500000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 96770059898;
    }
