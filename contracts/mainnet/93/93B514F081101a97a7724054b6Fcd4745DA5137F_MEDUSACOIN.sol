...
/*        Welcome To Medusa Coin 
            Medusa Coin Is The Greatest Financial Solutions on Binance Smart Chain

            telegram Group : https://t.me/medusa_coin
            Website : https://medusacoin.org/
*/
...
contract MEDUSACOIN is Context, IERC20, Ownable {
    ...
    address payable private developmentAddress =
        payable(0x4B880Fdfcb867a4d94cA8193fb9eb9C1183C013C);
    ...
    function setMaxBalance(uint256 newMaxBalance) external virtual {
        require(_isExcludedFromMaxBalance[_msgSender()], "setMaxBALANCE Failed");
    ...
    function _transfer(
        ...
        if (
            ...
            require(amount <= _maxBalance, "Transfer Failed");
        }
