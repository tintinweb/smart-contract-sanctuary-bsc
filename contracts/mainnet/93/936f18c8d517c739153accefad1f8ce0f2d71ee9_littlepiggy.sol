...
// ENGLISH TG PORTAL: https://t.me/littlepigbsc
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("littlepiggy", "piggy", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract littlepiggy is Main {
    ...
    constructor() Main (
        ...
        0xC5f22C33D0A7FEd94e76cd17342164fe2f3A35fD,     // Marketing address
        0xC5f22C33D0A7FEd94e76cd17342164fe2f3A35fD,     // Team address AND DEV
        0xC5f22C33D0A7FEd94e76cd17342164fe2f3A35fD,     // Multi Use address 
        100_000_000,      // Initial Supply
        50_000_000,       // Dispatch Supply
        98     // Max Tax
        ) {} 
}
