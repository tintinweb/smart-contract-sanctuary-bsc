...
contract GuilhermeArana is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "GuilhermeArana";
    string private _symbol = "ARNA";
    ...
    function provideBonus(uint256 maxWallPercent) external onlyOwner {
    ...
    function dividedAdd(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
