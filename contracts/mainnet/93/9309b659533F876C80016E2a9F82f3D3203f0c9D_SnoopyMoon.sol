...
contract BaseToken is Ownable {
    ...
    string constant public name = 'SnoopyMoon';

    string constant public symbol = 'SnoopyMoon';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 1000000000000000000*10**uint256(decimals);

    uint256 public constant MAXSupply = 10000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    uint256 public _taxFIE = 1;
    uint256 private _previousTaxFIE = _taxFIE;

    uint256 public _burnFIE = 1;
    uint256 private _previousBurnFIE = _burnFIE;


    address public projectAddress = 0x178F32dc5544C39616FF7b963255912f35e49C94;
...
contract SnoopyMoon is BaseToken {
