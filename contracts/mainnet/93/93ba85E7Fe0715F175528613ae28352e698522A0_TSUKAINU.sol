...
// TELEGRAM: https://t.me/OfficialTsukaInu
...
contract TSUKAINU is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 3_000_000_000_000 * 10**9;
    uint256 public maxTxAmount = 30_000_000_000_000 * 10**9;
    uint256 public maxWalletAmount = 30_000_000_000_000 * 10**9;
    ...
    Taxes private taxes = Taxes(5,1,4);
    ...
    constructor(address _marketingWallet, address _devWallet) ERC20("Tsuka Inu", "TSUKAINU") {
