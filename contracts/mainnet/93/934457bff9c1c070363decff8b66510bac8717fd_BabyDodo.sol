...
/**
Baby DODO
DIVIDEND YIELD PAID IN DODO PEG20! With the auto-claim feature,
simply hold Baby DODO and you'll receive DODO PEG20 automatically in your wallet.
Website:    https://app.dodoex.io/
TG:         https://t.me/BabyDODO_Bsc
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x67ee3Cb086F8a16f34beE3ca72FAD36F7Db929e2);
...
contract BabyDodo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby DODO";                             
    string constant _symbol = "BDODO";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x67ee3Cb086F8a16f34beE3ca72FAD36F7Db929e2; 
