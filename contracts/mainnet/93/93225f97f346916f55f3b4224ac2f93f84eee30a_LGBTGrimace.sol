...
contract LGBTGrimace is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LGBTGrimace";
    string constant _symbol = "LGBTGrimace";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf72c2fCea9dC5c1bDAACe00234476783ea1E1A9C;
