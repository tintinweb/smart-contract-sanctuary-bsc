...
contract BASTET is Context, IERC20, Ownable {
    ...
    string private _name = "BASTET";
    string private _symbol = "BASTET";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xA3e7432602685Edb6c32A0A7Cf6744d57FA1CC46);
    address payable public CharityWalletAddress = payable(0x926E6ff6d06B6dd259013A3Ca8584c027130c200);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountReceived.mul(_marketingShare).div(_marketingShare.add(_charityShare));
        uint256 amountBNBCharity = amountReceived.sub(amountBNBMarketing);
