...
/**
 * SurgeDice decentralized casino dice built on Surge Protocol
 * Taxes: 10% (2% Casino Development, 6% Casino Treasury wallet, 2% Random Rewards)
 * Max Wallet: 1% (1'000'000 SurgeDice)
 * Telegram: https://t.me/SurgeDice
 * Twitter: https://twitter.com/SurgeDice
 */
...
contract SurgeDice is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeDice ";
    string private constant _symbol = "$SDICE";
    ...
    uint256 public constant CASINO = 100;
    ...
    //Tax wallets
    address public developmentWallet = 0x4cBC5FA7B632c6227adBE4d15ca158AA5cB1b8b7;
    address public treasuryWallet = 0xdEbA4fc3660eC1af8848413562BCe17d38598d97;
    address public rewardWallet = 0x6EbbCC9E8d58F021D0EDB3d026Fd28792CA03066;

    address private _pcsAddress= 0x10ED43C718714eb63d5aA57B78B54704E256024E;


    // Tax Split
    uint256 public developmentShare = 20;
    uint256 public treasuryShare = 60;
    uint256 public rewardShare = 20;
    uint256 public constant SHARECASINO = 100;
    ...
    //volume trackers
    mapping(address => uint256) public spinWheel;
    ...
    function _buy(
        ...
        spinWheel[msg.sender] += dollarBuy;
    ...
    function _sell(
        ...
        uint256 amountTax = (amountSRG * (CASINO - sellMul)) / CASINO;
        ...
        spinWheel[msg.sender] += dollarSell;
    ...
    function changeTaxDistribution(
        ...
        require(
            newdevelopmentShare + newtreasuryShare + newrewardShare == SHARECASINO,
    ...
    function changeFeeReceivers(
        ...
        require(
            newDevelopmentWallet != address(0) && newTreasuryWallet != address(0)&& newRewardWallet != address(0),
    ...
    function withdrawTaxBalance() external nonReentrant onlyOwner {
        bool temp1 = SRGIE.transfer(
            developmentWallet,
            (taxBalance * developmentShare) / SHARECASINO
        );
        bool temp2 = SRGIE.transfer(
            treasuryWallet,
            (taxBalance * treasuryShare) / SHARECASINO
        );

                bool temp3 = SRGIE.transfer(
            rewardWallet,
            (taxBalance * rewardShare) / SHARECASINO
        );
