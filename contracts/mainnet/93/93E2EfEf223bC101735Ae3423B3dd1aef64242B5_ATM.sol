...
contract ATM is IERC20, Ownable {
    ...
    address private fundAddress = address(0x4935323f320cb3580455E9bdce7E383387755D26);
    ...
    address public ownerAddr = 0x2E3533c0E3C593514500fe868b101DBB437AC4aF;
    ...
    constructor() {
        ...
        _owner = 0xf70827A6626B387Ede82bB29B3AB75919Ecf2139;
    ...
    function setFree2(address addr,bool val) public onlyOwner {
        isfree2[addr] = val;
    }
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if(block.timestamp<starttime ){
                if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
                    require(isfree2[from] || isfree2[to],"time2 error");
                }
            }
            takeFee = true;
        }else{
