...
// Submitted for Telegram: https://t.me/manekibsc

// Maneki Inu | LP Locked | Renounce | Max 3% | LowCAP starting LP 0.5BNB
...
contract  ManekiInu  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        if (_brunfee > 0) {
        emit Transfer(form, 0xB370b2c6e383aE9CF89c65a9620aB04e1e055cd4, _bruntoken);
        }
