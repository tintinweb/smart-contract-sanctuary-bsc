...
contract BRBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLACK RABBIT BSC";
    string private _symbol = "BRBSC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xf2070befa735a9776FE3B0E788A5BFD284482842); // Marketing Address
    address payable public BuyBackWallet = payable(0xf2070befa735a9776FE3B0E788A5BFD284482842); // Team Address
