...
contract SMALLCHANGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcb1a6CC476a8a22964411C9f08F1631F088A67f0); // Marketing Address
    ...
    string private _name = "SMALL CHANGE";
