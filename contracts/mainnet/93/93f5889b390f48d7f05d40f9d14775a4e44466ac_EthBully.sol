...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD01172e708877Dc7b69B860e6DbEBeFD56Fc106f;
...
contract EthBully is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD01172e708877Dc7b69B860e6DbEBeFD56Fc106f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EthBully";
    string private _symbol = "EthBully";
