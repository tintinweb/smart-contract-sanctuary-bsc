...
contract CryptoRehab is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptoRehab"; // 
    string private constant _symbol = "$CRB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 5;
    uint256 private _liquidityFee = 0;
    address public  _marketingWallet = 0xBC6385Cd2560c70657778ec18b941866E73252B8;
