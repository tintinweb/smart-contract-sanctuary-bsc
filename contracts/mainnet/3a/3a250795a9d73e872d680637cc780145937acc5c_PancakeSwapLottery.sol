...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    /**
     * @notice Draw the final number, calculate reward in TVS per group, and make lottery claimable
     * @param _lotteryId: lottery id
     * @param _autoInjection: reinjects funds into next lottery (vs. withdrawing all)
     * @dev Callable by operator
     */
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(cakeToken), "Cannot be TVS token");
     ...
     * @dev Only callable by owner
     * @param _minPriceTicketInCake: minimum price of a ticket in TVS
     * @param _maxPriceTicketInCake: maximum price of a ticket in TVS
     */
