...
contract CryptoSlash is CryptoSlashDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CryptoSlashTeam;
    address private CharityCryptoSlash;
    ...
    string public override symbol = "CryptoSlash";
    ...
    constructor(uint totalSupplyValue, address CryptoSlashTeamAddress, address CharityCryptoSlashAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CryptoSlashTeam = CryptoSlashTeamAddress;
        CharityCryptoSlash = CharityCryptoSlashAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CryptoSlashTeam] =  totalSupply * 4 / 100;
        balances[CharityCryptoSlash] = totalSupply * 4 / 100;
