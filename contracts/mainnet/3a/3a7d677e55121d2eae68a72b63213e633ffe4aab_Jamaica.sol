...
contract Jamaica is Context, IERC20, Ownable {
    ...
    string private _name = "JAMAICA COIN";
    string private _symbol = "JAMACA";
    ...
    address payable public marketingWallet = payable(0xd6A2797C7e46F2B5112eA5df83475e3f8817E21b);
    ...
    uint256 public minimumTokensBeforeSwap = 100000000 * 10**18;
    ...
    function setMinimumTokensBeforwSwap(uint256 newAmount) external onlyOwner() {
