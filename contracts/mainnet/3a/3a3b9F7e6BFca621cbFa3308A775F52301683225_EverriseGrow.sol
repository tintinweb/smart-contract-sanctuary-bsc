...
library Address{
 ...
 contract EverriseGrow is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 100000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 250 * 10**9;
    ...
    address public marketingWallet = 0x2303c04b26cAbF3F1fb1c32703b610A4cbcDf448;
    address public donationWallet = 0x2303c04b26cAbF3F1fb1c32703b610A4cbcDf448; 

    string private constant _name = "EverRise Grow";
    string private constant _symbol = "EverRise";
    ...
    Taxes public sellTaxes = Taxes(2, 8, 0, 0);
