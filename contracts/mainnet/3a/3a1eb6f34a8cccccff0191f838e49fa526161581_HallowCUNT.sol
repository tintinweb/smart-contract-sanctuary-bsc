...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Fb3fe38c9C3F387170e0DD773c350B33435C569;
...
contract HallowCUNT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0Fb3fe38c9C3F387170e0DD773c350B33435C569;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hallow Cunt";
    string private _symbol = "HALLOW CUNT";
