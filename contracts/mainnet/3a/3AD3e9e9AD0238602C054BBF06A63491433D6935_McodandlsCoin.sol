...
contract McodandlsCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "McodandlsCoin";
    string private _symbol = "Mcodandls";
    uint8 private _decimals = 18;
    address payable public marketingAddress = payable(0xbB200413894Fe0337CBEfb4ca49fE3f3Db8c6247);
    ...
    uint256 public _TreasuryFeeSell = 13;
    ...
    function establishSelling(uint256 newLiquidTax, uint256 newMarketTax) external onlyOwner() {
        _LiquidityFeeSell = newLiquidTax;
        _TreasuryFeeSell = newMarketTax;
        _finalSellTax = _LiquidityFeeSell.add(_TreasuryFeeSell);
    }

    function establishBuying(uint256 newLiquidTax, uint256 newMarketTax) external onlyOwner() {
