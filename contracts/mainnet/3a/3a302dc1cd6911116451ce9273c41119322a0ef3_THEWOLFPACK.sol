...
contract THEWOLFPACK is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address private TeamReceiver = 0xa1eF812225FC6448E95e733d7f1717023DF4F1e1; // Team
    address private CreatorReceiver = 0xa1eF812225FC6448E95e733d7f1717023DF4F1e1; // Team
    ...
    {
        // Checks
        require(_winner != address(0), "Fireball: zero address");
        require(_amount > 0, "Fireball: you have to mint at least one");
        require(lastSupply != 0, "Fireball: the collection is sold out");
    ...
    function tokenURI(uint256 _id)
        ...
        returns (string memory)
    {
        require(_exists(_id), "Fireball: URI query for nonexistent token");
  ...
  function withdraw() public payable onlyOwner {
    ...
    function claimRewards() public {
        require(!paysInTokens, "Fireball: rewards are paid in tokens");
