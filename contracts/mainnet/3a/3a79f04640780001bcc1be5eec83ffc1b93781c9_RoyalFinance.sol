...
contract RoyalFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RoyalFinance";
    string private _symbol = "ROYAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x218Ee3bd94Fe65b7e79D63Abd61baDDE311aa1e7);
