...
contract SOMBO is IBEP20, Ownable {
    ...
    string private _name = "SOMBO";
    string private _symbol = "SOMBO";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 999990000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair && !_liquidityHolders[from]) {
