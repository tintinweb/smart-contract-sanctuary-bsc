...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd621997C81Ab2a938743fE309576dc55e40F24f1; // owner address
...
contract CommanderInu is Context, IERC20, Ownable {
    ...
    string private _name = "Commander Inu";
    string private _symbol = "CINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd621997C81Ab2a938743fE309576dc55e40F24f1); // Marketing Address
    address payable public teamWalletAddress = payable(0xd621997C81Ab2a938743fE309576dc55e40F24f1); // Team Address
