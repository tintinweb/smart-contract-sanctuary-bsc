...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWD = IBEP20(0x677f3a5ADD4764248ABC4cA8D16Ce54D48760dCd);
...
/* Token contract */
contract BabyKhabyLameInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWD = 0x677f3a5ADD4764248ABC4cA8D16Ce54D48760dCd; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x270a7A435638a947230ddae65C865E7402Ca49fb;
    ...
    // Name and symbol
    string constant _name = "Baby Khaby Lame Inu";
    string constant _symbol = "BabyKLI";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 3 / 100; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x270a7A435638a947230ddae65C865E7402Ca49fb;  
