...
// Telegram : https://t.me/supremeleader_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01fe9a669BB05A8b0a24843c3Aa47591Ca9D23e3; // owner address
...
contract KimJongUn is Context, IERC20, Ownable {
    ...
    string private _name = "SUPREME LEADER";
    string private _symbol = "Kim Jong-un";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01fe9a669BB05A8b0a24843c3Aa47591Ca9D23e3); // Marketing Address
    address payable public teamWalletAddress = payable(0x01fe9a669BB05A8b0a24843c3Aa47591Ca9D23e3); // Team Address
