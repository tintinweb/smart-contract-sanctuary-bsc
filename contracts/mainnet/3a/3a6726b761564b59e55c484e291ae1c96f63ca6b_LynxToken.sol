...
// SPDX-License-Identifier: BSD2.0 - PRIVATE
...
/*
    ...
    ╚══════╝╚═╝   ╚═╝  ╚═══╝╚═╝  ╚═╝
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    𝙇𝙔𝙉𝙓 𝙊𝙍𝙄𝙂𝙄𝙉𝘼𝙇 𝘾𝙊𝙉𝙏𝙍𝘼𝘾𝙏
    (copycats gonna hate this)

    𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 - https://t.me/lynxoriginal
...
contract LynxToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lynx Original";
