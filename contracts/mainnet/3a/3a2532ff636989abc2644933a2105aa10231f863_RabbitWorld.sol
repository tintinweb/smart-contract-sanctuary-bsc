...
TG: https://t.me/RabbitWorldPortal
...
contract RabbitWorld is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rabbit World";
    string private constant _symbol = "RWORLD";
    ...
    address private marketingWallet = address(0x6Ba374EB767562bd3A713557F5BCfb6b6105Ac5C);
    ...
    function isBots() public onlyOwner {
