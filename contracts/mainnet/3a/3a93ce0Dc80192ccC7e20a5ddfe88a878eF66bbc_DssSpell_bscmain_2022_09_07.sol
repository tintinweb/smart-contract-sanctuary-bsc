...
contract DssSpellAction_bscmain_2022_09_07 is DssAction
{
	...
	function actions() public override
	{
		...
		DssExecLib.setChangelogVersion("1.0.6");

		DssExecLib.setIlkDebtCeiling("STKCAKE-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKBANANA-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBNBCAKE-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBNBBUSD-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBNBETH-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBNBBTCB-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBUSDUSDC-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBUSDBTCB-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSBUSDCAKE-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSETHBTCB-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKPCSETHUSDC-A", 0); // line 0
		DssExecLib.setIlkDebtCeiling("STKAPEMORBUSD-A", 0); // line 0

		uint256 _500PERCENT_YEAR = 1000000056816321668209211589; // duty 500% per year
		DssExecLib.setIlkStabilityFee("STKCAKE-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKBANANA-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBNBCAKE-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBNBBUSD-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBNBETH-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBNBBTCB-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBUSDUSDC-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBUSDBTCB-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSBUSDCAKE-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSETHBTCB-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKPCSETHUSDC-A", _500PERCENT_YEAR, true);
		DssExecLib.setIlkStabilityFee("STKAPEMORBUSD-A", _500PERCENT_YEAR, true);

		DssExecLib.setIlkDebtCeiling("PSM-BUSD-A", 500000); // line 500k

		address MCD_JOIN_DAI = DssExecLib.daiJoin();
		DssExecLib.delegateVat(MCD_JOIN_DAI);
		DssExecLib.sendPaymentFromSurplusBuffer(MULTISIG, 70647); // 70,647 MOR
		DssExecLib.undelegateVat(MCD_JOIN_DAI);
	}
}

// valid for 30 days
contract DssSpell_bscmain_2022_09_07 is DssExec(block.timestamp + 30 days, address(new DssSpellAction_bscmain_2022_09_07()))
{
}