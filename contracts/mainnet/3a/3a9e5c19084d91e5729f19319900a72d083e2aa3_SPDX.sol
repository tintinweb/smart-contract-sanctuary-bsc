...
contract SPDX is Context, IERC20, Ownable {
    ...
    string private _name = "SpurDex";
    string private _symbol = "SPDX";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2; /*holders*/
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3; /*auto-lp*/
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 2; /*burn*/
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _charityFee = 5; /*team*/
    address public charityWallet = 0xbebb2b2C49573520a5F0754A95002a2aC50dd16E;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xcBEc6cB1ae9C37e53e013FE82F845f1C8146fB46);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x5F09a5c82E54C6Afa723FDc4fdd31e66Ef259aB1, 'We can not exclude Pancake router.');
