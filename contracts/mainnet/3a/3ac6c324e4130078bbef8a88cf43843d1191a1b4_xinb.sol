        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5F64295d665110A60C5b985f2914b3C5e4253843), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000000,//Su
        address(0x5F64295d665110A60C5b985f2914b3C5e4253843),//
        address(0x5F64295d665110A60C5b985f2914b3C5e4253843)//
    ){
    }
}