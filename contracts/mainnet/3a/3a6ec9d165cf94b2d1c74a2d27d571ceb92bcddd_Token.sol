...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1888 * 10**9;

    string private _name = "RTKing";
    string private _symbol = "RTKing";
    ...
    uint256 public _maxTxAmount = 1888 * 10**9;
    uint256 public _maxHavAmount = 1888 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1888 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market = 0x3433CbFf5B3a6820af40BC75a8Cc78c70df2d062;
