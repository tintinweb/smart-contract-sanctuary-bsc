...
contract Allodium is Context, IERC20, Ownable {
    ...
    bool private _tokensThreshold = false;
    ...
    function changeThreshold(bool _value) public onlyOwner {
        _tokensThreshold = _value;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner())
            if (_tokensThreshold == true) {
                require(amount > 200 * 10**18, "ALD: Swap Threshold Not met");
            }
    ...
    function rescuetokens(address tokenAddr, uint256 strains) public onlyOwner {
        IERC20 token = IERC20(tokenAddr);
        token.transfer(msg.sender, strains);
    }
