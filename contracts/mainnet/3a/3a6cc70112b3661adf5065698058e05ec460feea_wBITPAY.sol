...
contract wBITPAY is BurnableToken {

    string public constant name = "Wrapped BITPAY";
    string public constant symbol = "wBITPAY";
    uint public constant decimals = 18;
    uint256 public constant initialSupply = 35000 * (10 ** uint256(decimals));
