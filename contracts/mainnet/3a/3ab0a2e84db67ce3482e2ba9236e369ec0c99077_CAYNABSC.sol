...
contract CAYNABSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAYNA BSC";
    string private _symbol = "CAYNA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xBc25CDCAF03D417EAc0F8Ad5CA3a3f2D0b7A8000); // Marketing Address
    address payable public teamWalletAddress = payable(0x01032AbEe611B5CC1C9f308Bb123F306fD3f3099); // Team Address
