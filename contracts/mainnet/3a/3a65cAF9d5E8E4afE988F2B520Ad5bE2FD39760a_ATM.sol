...
contract ATM is ERC20, Ownable {
    ...
    uint256 public daoDividendFeeBuy = 50;
    uint256 public daoDividendFeeSell = 50;
    ...
    function _transfer(
        ...
        if (from == address(tokenDividendTracker) || from == address(lpDividendTracker)
            || to == address(tokenDividendTracker) || to == address(lpDividendTracker)) {
