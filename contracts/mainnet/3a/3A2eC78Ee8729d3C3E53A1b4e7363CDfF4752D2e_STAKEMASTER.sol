...
contract STAKEMASTER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Stake Master";
    string constant _symbol = "STK";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 1,000,000,000

        //max wallet holding of 5%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 5,000,000,000
    ...
    uint256 public swapThreshold = _totalSupply / 100; //1,000,000,000
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xa97A066dbe0FC4D958B04697e5bd8c9aC77CB218; 
