...
contract MonsterNFT is ERC721, Ownable {
    ...
    IFootballer _footballer = IFootballer(0xc0CD4d75cA412a6623cc9D4c41063144e4CcB3B6);
    ...
    address _operator = 0x0E998B229c571c20c706892Ad76D0f79b8a4f0F6;

    constructor() ERC721("Monster", "MonsterNFT") {
    ...
    function caculatorReward(uint256 nftID, uint256 monsterID) external view returns (uint256 reward) {
        ...
        uint256 bonus = ( 1 + difficult) * uint(keccak256(abi.encodePacked(block.number))).mod(3) * 10 ** 17;
