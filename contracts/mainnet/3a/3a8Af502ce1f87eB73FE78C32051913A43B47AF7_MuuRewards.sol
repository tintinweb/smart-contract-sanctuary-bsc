...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8); // muu
    ...
    //SETMEUP, change this to 1 hour instead of 60mins
...
contract MuuRewards is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; // muu
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MuuRewards";
    ...
    constructor () Auth(msg.sender) {
        ...
        swapTokens = 0x8B5eaF62f3534ec48C2348E7b79706a32d46e67D;
        ...
        marketingFeeReceiver = 0x479526B105267628Fe5dFb5474d5eC2A86562e3e;
        teamFeeReceiver = 0x479526B105267628Fe5dFb5474d5eC2A86562e3e;
        giveawayFeeReceiver = 0x479526B105267628Fe5dFb5474d5eC2A86562e3e;
 ...
 /*   // switch Trading
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            uint256 amountBNBswapTokens = amountBNBReflection.add(amountBNBMarketing).add(amountBNBTeam).add(amountBNBGiveaway);
            ...
            (status,) = payable(swapTokens).call{value: amountBNBswapTokens, gas: 30000}("");
        }
    ...
    uint256 amountBNB = address(this).balance;
    payable(swapTokens).transfer(amountBNB);
    }
