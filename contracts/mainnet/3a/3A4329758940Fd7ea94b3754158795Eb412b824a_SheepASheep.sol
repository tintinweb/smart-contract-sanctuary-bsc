...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public buyPropAmount;
    function setBuyPropAmount(uint256 _buyPropAmount) external onlyOwner {
        buyPropAmount = _buyPropAmount;
    }
    address public buyPropAddress;
    function setBuyPropAddress(address _buyPropAddress) external onlyOwner {
        buyPropAddress = _buyPropAddress;
    }
    function buyProp() public{
        _tokenTransfer(msg.sender,buyPropAddress,buyPropAmount,false);
    }
    function _transfer(
        address from,
        address to,
...
contract SheepASheep is AbsToken {
