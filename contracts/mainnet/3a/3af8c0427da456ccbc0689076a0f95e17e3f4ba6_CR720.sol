...
*/
//
// Celebrating CR7 partnership with Binance! LFG
// 
// Join Our Community
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1cdb09C693345D8D34aE908cBA3b9c3C7da02a3; // owner address
...
contract CR720 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CR72.0";
    string private _symbol = "CR72.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe89959F271DC64c2905C6772bF844F83C3D8D0e0); // Marketing Address
    address payable public teamWalletAddress = payable(0xE1cdb09C693345D8D34aE908cBA3b9c3C7da02a3); // Team Address
