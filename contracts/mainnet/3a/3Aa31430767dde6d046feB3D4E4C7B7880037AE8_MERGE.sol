...
contract MERGE is IBEP20, Auth {
    ...
    string constant _name = "Merge Inu";
    string constant _symbol = "MINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 30) / 100;  //30% max tx
    ...
    address private marketingFeeReceiver =0x9917985a0cA99a63236C1F7ff8500655bf1De451;
    address private teamFeeReceiver =0x9917985a0cA99a63236C1F7ff8500655bf1De451;
