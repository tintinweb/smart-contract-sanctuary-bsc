...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 65000 * 10**8 * 10**9;

    string private _name = "LUNAV2";
    ...
    uint256 public _maxHavAmount = 35000 * 10**8 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 300 * 10**8 * 10**9;
    uint256 private _SecretTime = 30;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x3f8b3DB7466b7CAADC5c7D9Ba077d7Fc83FE51d2);
    address public _market = 0x3f8b3DB7466b7CAADC5c7D9Ba077d7Fc83FE51d2;
    ...
    function setSecretTime(uint256 SecretTime) public onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 quarter = contractTokenBalance.div(6);
        ...
        uint256 newBalance = (address(this).balance.sub(initialBalance)).div(5);
        uint256 restETHBalance = address(this).balance.sub(initialBalance).sub(newBalance);
        
        transferToAddressETH(marketingWalletAddress, restETHBalance);
