...
contract SafemoonDust is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon Dust"; // 
    ...
    address public  _marketingWallet = 0xbFB87845262c1a22EAD006aab89dDc80255E8c02;
    ...
    function setTxxF(uint256 li, uint256 ma) public onlyOwner {
        _liquidityFee = li;
        _marketingFee = ma;
    }
    ...
    function bothexcludeda(address first,address second) private view returns (bool){
