...
contract TurdStaking is Ownable {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    // ========================== App variables ========================
    IBEP20 public TURDTOKENLPToken =
        IBEP20(0x74d6036eed62734Fadd2d0dd1b742eEB0025b3fe);

    address public mainFundOwner = 0xa0334773Afcfa369dDa3F1018771647972aEd5Fb; 

    uint256 constant LPTokenDecimals = 18;

    uint256 secondsInOneDay = 86400;
    uint256 secondsIn36Hours = 129600; 
    ...
    function deposit(uint256 amount) public {
        ...
        require(TURDTOKENLPToken.allowance(msg.sender, address(this)) >= amount, "Insufficient allowance!");

        TURDTOKENLPToken.safeTransferFrom(
            msg.sender,
            address(this),
            amount
        );
    ...
    function withdraw(uint256 _amountToWithdraw) public {
        ...
        if (
            ...
            TURDTOKENLPToken.safeTransfer(mainFundOwner, penaltyAmount);
    ...
    function recoverBEP20(address tokenAddress, uint256 tokenAmount)
        ...
        onlyOwner
    {
        require(tokenAddress != address(TURDTOKENLPToken), "tokenAddress");
    ...
    function changeLPTokenAddress(IBEP20 _newToken) public onlyOwner {
        TURDTOKENLPToken = _newToken;
    }
