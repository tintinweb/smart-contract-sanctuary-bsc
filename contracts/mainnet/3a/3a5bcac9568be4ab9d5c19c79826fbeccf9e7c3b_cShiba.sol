...
/**
    Shiba Inu Founder Ryoshi Deletes His Social Media Accounts
and we are here to create a new #Shiba community to give a second new life?

    #cShiba will soon be listed on #BSC

   I made this #cShiba to give to the community.

   Telegram: https://t.me/NewCommunityShibaBSC

   I will lock in liquidity for a long period of time.
   I will Renounce Ownership of #cShiba to the community and make sure it is 100% secure.

   Can you make a #cShiba 10000000X?

Total supply: 6,860,000,000,000

Liquidity Pancakes: 50%
Burn Tokens: 50%
Dev Tokens: 2%
...
Tax Buy & Sell: 3%
   ...
   1% fee is automatically added to liquidity
   2% fee is automatically distributed to the marketing wallet
*/
...
contract cShiba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6860000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    address payable public marketingAddress =
        payable(address(0x5faaC8e2Ec45ae9c62976f946CC901E2b0E95580));
    address payable private devWallet =
        payable(address(0x5faaC8e2Ec45ae9c62976f946CC901E2b0E95580));
    address private liquidityReceiver =
        0x5faaC8e2Ec45ae9c62976f946CC901E2b0E95580;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "New Community Shiba";
    ...
    uint256 public _maxTxAmount = 205800000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 20000000000 * 10**9;
    uint256 public _maxWalletSize = 205800000000 * 10**9;
