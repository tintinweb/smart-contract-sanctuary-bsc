...
contract FairyPlanet is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    ...
    constructor() ERC20("Fairy Planet", "FRP") {
        totalTokens = 1000 * 10 ** 6 * 10 ** uint256(decimals()); // 1T
