...
contract TUZI is BEP20, Auth {
    ...
    string public constant name = "TUZI BSC";
    string public constant symbol = "TUZI";
    uint8 public constant decimals = 9;

    uint256 public constant totalSupply = 1000 * 10**9 * 10**decimals;
