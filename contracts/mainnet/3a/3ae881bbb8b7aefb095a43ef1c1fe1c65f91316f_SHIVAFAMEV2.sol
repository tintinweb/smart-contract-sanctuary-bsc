...
contract SHIVAFAMEV2 is IERC20Upgradeable, OwnableUpgradeable {
    ...
    {
        address owner_ = 0x975a9ba4e31dDF695f6cfED9EefBe94EFcd58527;    // Owner address.        
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;           // Pancakeswap router.
        _marketingAddress = 0x480832f577cB7d2Db986e578bca058Ef50FA96C8; // Marketing wallet.
        _name = "SHIBAFAMEV2";
        _symbol = "SFV2";                          
        _tTotal = 100000000000* 10**9;                                  // 500 Billion.
        ...
        _marketingFeeBuy = 400;
        // Sell fees.
        _taxFeeSell = 200;
        _liquidityFeeSell = 1000;
        _marketingFeeSell = 800;
        // Tx fees.
        _taxFeeTx = 0;
        _liquidityFeeTx = 0;
        _marketingFeeTx = 0;
