...
contract OGFLOKI is ERC20, Ownable {
    ...
    string constant _name = "OGFLOKI";
    string constant _symbol = "OGFLOKI";
    ...
    address public marketingFeeReceiver = 0xA320717Bf776439f0aafC5422a47bA9380F067Ca;

    IDEXRouter public router;
    address public pair;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 1000000000 * 300;
    bool inSwap;
