...
contract KINGMICROCATS is Context, IERC20, Ownable {
    ...
    string private constant _name = "KING MICRO CATS"; // 
    string private constant _symbol = "KINGMICRO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x5561f65C1b41Da5bEfd26A6D2060Fc76C294475B;
