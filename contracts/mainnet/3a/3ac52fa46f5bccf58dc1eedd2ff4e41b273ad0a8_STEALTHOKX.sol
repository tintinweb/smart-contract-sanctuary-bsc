...
/*
Telegram Chat: https://t.me/stealthokx
*/
...
contract STEALTHOKX is Context, IERC20, Ownable {
    ...
    string private constant _name = "StealthOKX"; //
    string private constant _symbol = "SOKX"; //
