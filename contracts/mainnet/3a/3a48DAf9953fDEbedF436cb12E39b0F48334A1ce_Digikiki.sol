...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80C47e4Ed3009a17335d88ca17ca192F2BA8c299; // owner address
...
contract Digikiki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digikiki";
    string private _symbol = "DIGIKIKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80C47e4Ed3009a17335d88ca17ca192F2BA8c299); // Marketing Address
    address payable public teamWalletAddress = payable(0x80C47e4Ed3009a17335d88ca17ca192F2BA8c299); // Team Address
    ...
    uint256 public _walletMax = 40_000_000 * 10**_decimals;
