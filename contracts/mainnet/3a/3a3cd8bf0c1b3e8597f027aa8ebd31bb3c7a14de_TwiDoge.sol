...
contract TwiDogeDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TwiDoge contract."
        );
    }
...
// Root file: contracts/baby/TwiDoge.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/TwiDogeDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract TwiDoge is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    TwiDogeDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = TwiDogeDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "TwiDoge: The dividend tracker already has that address"
        );

        TwiDogeDividendTracker newDividendTracker = TwiDogeDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "TwiDoge: The new dividend tracker must be owned by the TwiDoge token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "TwiDoge: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "TwiDoge: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "TwiDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "TwiDoge: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "TwiDoge: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "TwiDoge: Cannot update gasForProcessing to same value"
        );
