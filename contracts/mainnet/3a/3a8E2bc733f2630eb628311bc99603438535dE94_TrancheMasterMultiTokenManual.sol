    ...
    function _processExit() internal {
        ...
        for (uint256 i = 0; i < tranches.length - 1; i++) {
            ...
            trancheSnapshots[cycle][i] = TrancheSnapshot({
                ...
                principal: principal,
                capital: capital,
                validPercent: senior.target.mul(PercentageScale).div(senior.principal.add(senior.autoPrincipal)),
                rate: cycleExchangeRate,
                apy: senior.apy,
                fee: senior.fee,
                startAt: actualStartAt,
...

        {
            ...
            trancheSnapshots[cycle][juniorIndex] = TrancheSnapshot({
                ...
                principal: principal,
                capital: capital,
                validPercent: junior.target.mul(PercentageScale).div(junior.principal.add(junior.autoPrincipal)),
                rate: cycleExchangeRate,
                apy: junior.apy,
                fee: junior.fee,
                startAt: actualStartAt,
