...
// Telegram: https://t.me/SUPERBnBoT

// Website: https://superbnbot.net/

// Twitter: https://twitter.com/superbnbot
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 RBNB = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = RBNB.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           RBNB.transfer(shareholder, amount);
...
contract SUPERBNBOT is IBEP20, Auth {
   using SafeMath for uint256;
 
   address RBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "SUPER BNBot";
   string constant _symbol = "BNBot";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 600; // 2% development 4% marketing
    ...
    uint256 marketingFeeSell = 600; // 2% development 4% marketing
