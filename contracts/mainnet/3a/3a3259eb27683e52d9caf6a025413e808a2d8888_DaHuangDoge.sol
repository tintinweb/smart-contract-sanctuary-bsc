...
我们的目标是星辰大海，去年的dogeking，生威虎
💪初始底池（Initial LP）:5 BNB
✅低税(LOW TAX):2/2
✅合约已经弃权，池子已锁（OWNERSHIP RENOUNCED AND LP LOCKED）
🔉TG:https://t.me/dahuangcn
*/
...
contract   DaHuangDoge  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DaHuangDoge ";
    string private _symbol = "Dahuang";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x5b3aD300348f3107abB6B26582e7d4Af6AF40Ba0);
