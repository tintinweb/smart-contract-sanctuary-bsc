...
contract sQwertyToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Qwerty", "sQWER", 9) ERC20Permit() {
    ...
    /**
        @notice increases sQWER supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sQWER
