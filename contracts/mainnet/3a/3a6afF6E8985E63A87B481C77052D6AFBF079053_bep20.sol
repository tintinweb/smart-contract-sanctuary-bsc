...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbbd8B6902Ae7e3Fbb7bdaD0DaB6921c1F6FC7440; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Aptos Bsc";
    string private _symbol = "aptosbsc";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbbd8B6902Ae7e3Fbb7bdaD0DaB6921c1F6FC7440); // Marketing Address
    address payable public teamWalletAddress = payable(0xbbd8B6902Ae7e3Fbb7bdaD0DaB6921c1F6FC7440); // Team Address
