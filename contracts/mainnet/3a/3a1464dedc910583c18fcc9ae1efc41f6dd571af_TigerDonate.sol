...
contract TigerDonate is IPreIDOBase, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private constant MIN_LOCK = 1 days; // 1 day;
    ...
    constructor(
        ...
        discountsLock[2] = 7 * MIN_LOCK;
        discountsLock[10] = 30 * MIN_LOCK;
    }
    ...
    function _order(
        ...
        uint256 tokenPriceX4 = (tokenPrice * (100 - discountsRate)) / 100; // tokenPrice or 300 = 0.03(default price) * 10^4
    ...
    function setTokenPrice(uint256 _tokenPrice)
        ...
        beforePresaleEnd
    {
        require(_tokenPrice > 0, "Invalid input value"); // IIV
        tokenPrice = _tokenPrice;
    }

    

    function setNotAfterBlock(uint256 _notAfterBlock)
        external
        onlyOwner
        beforePresaleEnd
    {
        require(_notAfterBlock > 0, "Invalid input value"); // IIV
    }
