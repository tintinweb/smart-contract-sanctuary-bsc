...
contract BeerusCat is Context, IERC20, Ownable {
    ...
    address payable private _appAddress = payable(0xaa67b1Cb38A8E5E607703afeC818EC7A1De11d61);
    address payable private _marketingAddress = payable(0xcF2c1F2387a4dfaCa8D6854F18038DB63d0c6A4f);
    address payable private _buybackAddress = payable(0x94000bBa2c15Dc9637e6b03Eb309402898Cb4142);
    address payable private _burnAddress = payable(0x14b6F04354273260776E3945e018ed0BBe4ebd4c);
