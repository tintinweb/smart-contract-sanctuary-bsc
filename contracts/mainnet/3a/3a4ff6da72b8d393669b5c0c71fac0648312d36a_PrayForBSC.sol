...
contract PrayForBSC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PrayForBsc";
    string private constant _symbol = unicode"PrayForBSC";
    ...
    address payable public DevWallet = payable(0x0863B75D1570a8ed4d84AAe4F3bBCb0483e1FEEE);
