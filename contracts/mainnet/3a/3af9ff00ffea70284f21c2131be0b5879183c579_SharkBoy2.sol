...
contract SharkBoy2 is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x19780dfF70Fc9699e9BCa3E9864472F130EB4a17;
    address DevWallet       = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;

    string constant _name = "Shark Boy 2.0";
    string constant _symbol = "SHARKBOY2";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000 * (10 ** _decimals);
    uint256 public _maxSell = 10000 * (10 ** _decimals);
