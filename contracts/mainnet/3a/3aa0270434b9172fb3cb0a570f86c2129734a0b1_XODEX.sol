...
/**
 *XODEX 
 https://t.me/XODEXbscglobal
 *XODEX is aiming to be the best
  📈 Auto-Compounding/Auto-Staking Protocol within the ⛓ Binance Smart Chain Network.
   What XODEX is offering: ✅ Great Interest and Sustainable APY - 400,977%, ✅
    Interest Paid Every 15 Minutes,🔒 Liquidity Locked 👥 Known Developers with Previous
     Projects, Great Community and Mods that are helping to push further the PROJECT,😍
      Awesome Website and App, 📱 Future Mobile App for all Titano Fork tokens (iOS/Android)
       and much more to come!
 *https://XODEX.io/
 *https://twitter.com/XODEXBSC
...
contract XODEX is XODEXTOKEN {
  ...
  modifier onlyOwner() {
    require(owner == msg.sender, "XODEXTOKEN: caller is not the owner");
    _;
  }
