...
TG: https://t.me/NanoTechTreesOfficial
*/
...
contract NanoTechTrees is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Nano Tech Trees ";
    string private _symbol = " $NTT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52368AF4D8e166Cf191208886F6F22faefCffE17); 
    address payable public teamWalletAddress = payable(0x9d8d27d05A529b28bbE4485CbD2029DeE2521c97);
