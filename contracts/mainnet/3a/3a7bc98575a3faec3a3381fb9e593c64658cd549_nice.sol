...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x7fB2D480a2F4e3CCfeEc49b9AEA60d2262Df3783;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x7fB2D480a2F4e3CCfeEc49b9AEA60d2262Df3783),//fund 

        address(0x7fB2D480a2F4e3CCfeEc49b9AEA60d2262Df3783)//dev 
    ){
