...
contract EP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "EMPIRES";
    ...
    address private lpAddress = 0x355B85ed3C9B8bcf755D396049F5A4ecd9A27DB0;
    ...
    uint256 public _totalDistributionShares = 10; // original 3
