...
🔰 Hexa Core is a binanance smart chain based cross chain protocol that provides decentralized, 
safe and fast bridging solutions. 
...
contract HexaCore is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Hexa Core";//
    string private constant _symbol = "HCORE";//
    ...
    address payable private _developmentAddress = payable(0x588C908417cAad4f57575d686f4C6EEa39a8f166);//
    address payable private _marketingAddress = payable(0x588C908417cAad4f57575d686f4C6EEa39a8f166);//
    ...
    uint256 public _maxTxAmount = 2730000 * 10**9; //
    uint256 public _maxWalletSize = 2730000 * 10**9; //
