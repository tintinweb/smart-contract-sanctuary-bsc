...
/**
    ...
    TG https://t.me/HomodeusToken

    Medium https://medium.com/@HomodeusToken

    Twitter https://twitter.com/HomodeusToken

    https://t.me/HomodeusTokenPortal
...
contract HOMODEUSTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOMODEUS TOKEN";
    string private constant _symbol = "$OMO ";
    ...
    address private marketingWallet = address(0x1741F2124fB66F2eD268B2A67892593c12C2A475);
    address private liquidityReceiver = address(0x1741F2124fB66F2eD268B2A67892593c12C2A475);
