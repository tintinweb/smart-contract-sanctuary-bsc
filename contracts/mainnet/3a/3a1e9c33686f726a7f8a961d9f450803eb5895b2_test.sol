...
contract test is Ownable, IBEP20 {
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;
        teamFeeReceiver = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;
    ...
    function ClearForeignToken(address tokenAddress, uint256 tokens) external returns (bool success) {
        ...
        return IBEP20(tokenAddress).transfer(devFeeReceiver, tokens);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).div(3);
