...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0c57847A9020a16f8739F727d5671D4f3b8F917E; // owner address
...
contract SquidMurray is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Murray";
    string private _symbol = "SMUR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45182E10905Fe05350c96d3a1e23d9D542681915); // Marketing Address
    address payable public teamWalletAddress = payable(0x0c57847A9020a16f8739F727d5671D4f3b8F917E); // Team Address
