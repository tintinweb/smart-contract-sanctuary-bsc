...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xB510907D0e37400C6B900fadba81964E8bFd0420;
...
contract ssloth is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public mwallet = payable(0xB510907D0e37400C6B900fadba81964E8bFd0420);
    ...
    string private constant _name = unicode"Stoned Sloth "; 
