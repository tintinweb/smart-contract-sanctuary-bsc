...
/**
Welcome to Dogeking 2.0!

Did you missed dogeking 1? Don't miss dogeking 2.0 launched by a very safe and moonboys team.

Total supply: 100T

Taxes: 5% Marketing, 2% LP

Max wallet and txn: 2%
...
contract dogekingtwozero is IBEP20, Auth {
    ...
    string constant _name = "Dogeking 2.0";
    string constant _symbol = "dogeking2.0";
    ...
    address private marketingFeeReceiver = 0x06162cC7042BAd232567B1BeE80FED93246ab090;
    address private buybackFeeReceiver = 0x06162cC7042BAd232567B1BeE80FED93246ab090;
    ...
    uint256 public swapThreshold = _totalSupply / 2000000000 * 2; // 0.3%
    bool inSwap;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 2000000000);
        _maxTxAmount = amount;
    }
