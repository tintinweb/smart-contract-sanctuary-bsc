...
contract gou is Context, IERC20, Ownable {
    ...
    string private _name = "gou";
    string private _symbol = "gou";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfb1423C168583e5c8c5CFD128152D33A2464c16d); // Marketing Address
    address payable public teamWalletAddress = payable(0x54f1277A0E89317091693d906a3aca8948022f50); // Team Address
