...
contract EthcoinToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ethcoin2.0";
    string private _symbol = "ethcoin2.0";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xe8803aBB9F1836D101d5056Ff1Ad98F262D59359); 
    address payable public marketingAddress2 = payable(0x1015a7B4C8ef165DdaAD192055BF0BD35B13EC4A); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xe08D0EA1dE3563990a4F44897493C2c4E12b2c3C);
