...
contract ElonaMusk is Context, IERC20, Ownable {
    ...
    string private _name = "ElonaMusk";
    string private _symbol = "ELONA";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0x7D73424BbF901d79d69e1CC012c7371A7d960f75); 
    ...
    uint256 public _maxTxAmount = 14 * 10**6 * 10**4;
    uint256 public _walletMax = 10 * 10**6 * 10**4;
    uint256 private minimumTokensBeforeSwap = 5 * 10**6 * 10**4;
