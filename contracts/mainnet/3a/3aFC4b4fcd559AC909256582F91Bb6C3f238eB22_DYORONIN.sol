...
contract DYORONIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DO YOUR OWN Ronin";
    string constant _symbol = "DYORONIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1BE66eFa904dd368B9EB5e7d96f8a6586B5B5987;
