...
contract ZuckerbergInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zuckerberg Inu";
    string private _symbol = "$ZUCC";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xFC333b2EbBCfe9DDd4F5EF0eDf64f0D1ec3Bf826); // Marketing Address
    address payable private TeamWallet = payable(0xFC333b2EbBCfe9DDd4F5EF0eDf64f0D1ec3Bf826); // Buy Back Address
