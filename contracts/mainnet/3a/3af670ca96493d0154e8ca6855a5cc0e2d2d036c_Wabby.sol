...
/**
OPEN AI INSPIRED TOKEN, GOVERNED BY AL!
/ask suggest a token name with ticker that we should launch today. Give its description.

Token name: WABBY (WAB)

 Description: WABBY is a token designed to enable people to invest in more impactful projects and companies.
 It will allow for fractionalized ownership of businesses, allowing anyone to become a part owner of the 
 shares in a company, and the profits generated from those shares will be distributed proportionally to the 
 token holders. The goal is to offer a secure way for people to invest, hoping to create a new way for 
 people to become financially independent.


/**

https://t.me/WABBYofficial
...
contract Wabby is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Wabby';
    string private constant _symbol = 'WAB';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10000 ) / 10000;
    uint256 public _maxWalletToken = ( _totalSupply * 20000 ) / 10000;
    ...
    address public constant liquidity_receiver = 0x7D8F7B7e448b2513280FEf21B013DB47331856A0; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0x7D8F7B7e448b2513280FEf21B013DB47331856A0;
