...
Telegram : https://t.me/TatenomicsPortal
Website :*TBA
Twitter :*TBA
...
contract Tatenomics is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDc78e72be36625841640e5296a1a122A445c7D96); 
    address payable public Wallet_Dev = payable(0xDc78e72be36625841640e5296a1a122A445c7D96);
    ...
    string private constant _name = "Tatenomics"; 
    string private constant _symbol = unicode"TATEN"; 
    ...
    uint256 public _LiquidityPools = 0;
    uint256 public Percent_Marketing = 100;    
    uint256 public _BurningTx = 0;             
    ...
    constructor () {
        ...
        _owner = 0xDc78e72be36625841640e5296a1a122A445c7D96;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _BurningTx / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _LiquidityPools / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_LiquidityPools + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_LiquidityPools + Percent_Marketing + Percent_Dev);
