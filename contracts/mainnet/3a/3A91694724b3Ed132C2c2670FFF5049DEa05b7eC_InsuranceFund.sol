    ...
    WhitelistManager
{
    ...
    modifier onlyFuturesStaking() {
        require(validatedFuturesStaking[_msgSender()], "only futures staking contract");
        _;
    }
    ...
    function updateFuturesStakingStatus(address _futuresStaking, bool _isValidated) public onlyOwner {
