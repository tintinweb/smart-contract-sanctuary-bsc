...
contract FlyingPig is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Flying Pig";
    string constant _symbol = "FPIG";
    ...
    uint256 public swapThreshold = rSupply / 500;
    uint256 public rate;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x311df4fdB042C0146aEcB3192Fa5AAfFa427344b;
        devFeeReceiver = 0x96C57250B06374F41F0F4B9F5A8A789962e0D566;
        devFeeReceiver2 = 0x2a99dA7c674FDaE7b4Ece0EC1A9D5750b523002C;
