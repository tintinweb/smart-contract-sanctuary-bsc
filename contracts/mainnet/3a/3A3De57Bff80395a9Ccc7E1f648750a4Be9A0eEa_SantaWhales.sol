...
//SPDX-License-Identifier: MIT    Santa Whales https://t.me/SantaWhalesOfficial Dev @Vicebrut
...
/* Token contract */
contract SantaWhales is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xdb7D2A1aA7571642F3b5ab2141522ceDAe2Bf3F8;
    ...
    // Name and symbol
    string constant _name = "Santa Whales";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 2000000; //  
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 2000000; // 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 2000000; // 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xBE3fb1Fc8B806d860707F08eFb5412dBE70857cb;
