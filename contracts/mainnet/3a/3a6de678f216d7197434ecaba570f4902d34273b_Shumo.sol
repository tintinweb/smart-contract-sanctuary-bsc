...
contract Shumo is Context, IERC20, Ownable {
    ...
    string private _name = "Catnomics";
    string private _symbol = "Catnomics";
    ...
    address public burnAddress = 0x2EdFD01f263f8C695063146BC4563788a087BF7C;
    address payable private _marketingWallet = payable(0xe653157447b9Bc23Ce8C1882e09Ea17f84Fe5f1f);
    address payable private _devWallet = payable(0xDe65FD2ae3a5ec44Dc5685237f4AB70cFC1202bF);
