...
contract BinanceBeats is Ownable, IBEP20 {
    ...
    uint256 public _walletMax = _totalSupply * 10 / 1000; //1% 
    ...
    string constant _name = "Binancebeats";
    string constant _symbol = "Binancebeats";
