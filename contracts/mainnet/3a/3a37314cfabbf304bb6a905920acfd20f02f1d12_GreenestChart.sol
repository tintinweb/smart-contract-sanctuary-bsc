...
// TG: https://t.me/TheGreenestChart
...
contract GreenestChart is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "GreenestChart";
   string constant _symbol = "GREENEST";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 10000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 4 ) / 1000; // 
