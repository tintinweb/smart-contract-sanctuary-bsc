...
contract SUNRICHLIFEToken is IBEP20 {
...
contract SUNRICHLIFEBUSD {
    address payable admin;
    SUNRICHLIFEToken public tokenContract;
    ...
    constructor(SUNRICHLIFEToken _tokenContract, uint256 _tokensSold)  {
