...
Telegram : https://t.me/mechadogeofficial
...
contract MechaDoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc5608088C23Ff3cB74d8b4f3744410CdDd9C5767); 
    address payable public Wallet_Dev = payable(0xc5608088C23Ff3cB74d8b4f3744410CdDd9C5767);
    ...
    string private constant _name = "MechaDoge"; 
    string private constant _symbol = unicode"MECHADOG"; 
    ...
    uint256 public _Taxes_on_Lp = 10;
    ...
    constructor () {
        ...
        _owner = 0xc5608088C23Ff3cB74d8b4f3744410CdDd9C5767;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _Taxes_on_Lp / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_Taxes_on_Lp + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_Taxes_on_Lp + Percent_Marketing + Percent_Dev);
