...
/**
https://t.me/rilakkumayachtclub

5% marketing (of which 25% probably goes to anothermarketingwallet which I will use as devwallet) 5% autoliq. May be changed at some point. Very low initial liq.

Buy it for a rilakkuma, sell it for a rilakkuma yacht.

I hope yacht club is still a meta and I guess Rilakkuma is bullish for a bear.
...
contract rilakkumayachtclub is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Rilakkuma Yacht Club";
    string constant _symbol = "RilYacht";
