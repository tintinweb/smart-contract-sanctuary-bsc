...
contract AntibodyReactionINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AntibodyReaction INU";
    string private _symbol = "ARI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xe8249B32202A666dC78Be6d80b6509e1dDBB0391);
