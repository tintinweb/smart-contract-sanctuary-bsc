...
contract BabyPirateCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pirate Coin";
    string private _symbol = "BABY ARR";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x403781097883909513A89a0DC58CbD7b02943fcd);
