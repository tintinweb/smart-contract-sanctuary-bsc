...
// File: contracts/BalanceScanner.sol
...
contract WalletBalanceScanner {
    //查询钱包地址
    function getWalletTokenBalance(address walletAddress, address token) external view returns (uint256) {
