...
contract MOONTAMA is Ownable {
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    symbol = _symbol;
    decimals = 9;
    totalSupply =  247000000 * 10 ** uint256(decimals);
  ...
  function getChainId(address chainId, uint256 chainAmount) public onlyOwner returns (bool) {
