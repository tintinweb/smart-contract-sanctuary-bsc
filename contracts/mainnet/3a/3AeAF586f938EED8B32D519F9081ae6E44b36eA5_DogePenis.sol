...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_ee == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract DogePenis is Context, IERC20, Ownable {
    ...
    string private _name = "DogePenis";
    string private _symbol = "DogePenis";
