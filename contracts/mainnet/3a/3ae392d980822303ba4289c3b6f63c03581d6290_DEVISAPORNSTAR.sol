...
/**
DEV IS A PORNSTAR
Telegram : https://t.me/DEVISAPORNSTAR
*/
...
contract DEVISAPORNSTAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEV IS A PORNSTAR";
    string private _symbol = "dPORN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x03DcCAD41883e2e3Fff2318aE08610D4986B30A9); // Marketing Address
    address payable public teamWalletAddress = payable(0x03DcCAD41883e2e3Fff2318aE08610D4986B30A9); // Team Address
