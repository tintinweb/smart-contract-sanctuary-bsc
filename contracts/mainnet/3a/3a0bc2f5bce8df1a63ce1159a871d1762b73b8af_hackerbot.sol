...
// *Telegram : https://t.me/HackerDetectorBot
...
contract hackerbot  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x680A37C71568622f589DD65658b10000e532f298); 
    address payable public Wallet_Dev = payable(0x680A37C71568622f589DD65658b10000e532f298);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 2000000 * 10**_decimals;
    string private constant _name = "HackerDetectorBot"; 
    ...
    function setTxLimit(uint256 txLimit) external onlyOwner {
        _maxTxAmount = txLimit;
    }

    function setBlacklistAddress(address _address, bool _value) public onlyOwner {
