...
contract StarLinkNFT is ERC721Enumerable, Ownable {
    string private _uri;
    mapping(address => bool) admins;

    modifier isAdmin() {
        require(msg.sender == owner() || admins[msg.sender], "Caller is not admin");
        _;
    }
    ...
    function mint(address _to, uint256 _tokenId) external isAdmin{
        _mint(_to, _tokenId);
    }

    function safeMint(address _to, uint256 _tokenId) external isAdmin{
