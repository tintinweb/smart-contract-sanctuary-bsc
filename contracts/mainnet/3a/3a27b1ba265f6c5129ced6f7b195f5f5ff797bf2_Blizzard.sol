...
contract Blizzard is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Blizzard Inu";
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (1000) * (30); 
    uint256 public _maxSellTxAmount = _totalSupply / (1000) * (15); 
    uint256 public _maxWalletToken = _totalSupply / (1000) * (30); 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x3cAfB698850EE3306320EaA6a06060a8ed2a7A82 ;
        marketingFeeReceiver = 0x3cAfB698850EE3306320EaA6a06060a8ed2a7A82 ;
        devFeeReceiver = 0xF22455A36De49BE42D1d4ddEFfDaaE13E02f48c3 ;
