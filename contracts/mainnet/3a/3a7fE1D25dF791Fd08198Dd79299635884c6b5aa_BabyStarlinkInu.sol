...
//Liq locked for 1 Week , contract is renounced after launch .
...
contract BabyStarlinkInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyStarlink Inu";
    string private _symbol = "$BSTARLNK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4AfE33c1B56412401e1D0bEE50085a87F00410d9); // Marketing Address
    address payable public DevWalletAddress = payable(0x4AfE33c1B56412401e1D0bEE50085a87F00410d9); // Dev Address
