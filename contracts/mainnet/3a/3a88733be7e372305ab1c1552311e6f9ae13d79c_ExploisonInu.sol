...
// 💢Explosive INU | Busd Reward💢

// Robust meme token who will make shocking impact on BSC network.
// Triggered by expert crypto enthusiast with numerous successful project and crypto connection.
// By rewarding the holder on BUSD, we strive to empower the community.
...
/* Token contract */
contract ExploisonInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x15bF5083Ee29CE7c9257BEB3Ad13558A630c1e5F;
    ...
    // Name and symbol
    string constant _name = unicode"💢Exploison Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x15bF5083Ee29CE7c9257BEB3Ad13558A630c1e5F;
