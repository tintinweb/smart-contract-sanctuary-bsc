...
contract WeekendInu2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Weeknd Inu 2.0";
    string private constant _symbol = unicode"WEEKND INU 2.0";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals;

    uint256 public _maxWalletAmount = _tTotal.mul(9).div(20**2);
    ...
    address private marketingWallet = address(0x8871Ec3De589658D452802980Af793d00d995343);
    address private liquidityReceiver = address(0x8871Ec3De589658D452802980Af793d00d995343);
    
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    
    bool private swapping;
    uint256 lim = 100 * 1 gwei;
