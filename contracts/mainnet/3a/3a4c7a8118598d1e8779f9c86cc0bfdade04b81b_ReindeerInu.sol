...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x301233D07D3F66E51772f609Ba5dC74bDA3f37fc; // owner address
...
contract ReindeerInu  is Context, IERC20, Ownable {
    ...
    string private _name = "Reindeer Inu";
    string private _symbol = "REI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD597361A7e2c05C83C66929ceE5e89602BeF92e2); 
    address payable public lotteryWalletAddress = payable(0xD597361A7e2c05C83C66929ceE5e89602BeF92e2); 
