...
contract her is IBEP20, Auth {
    ...
    address DEV = 0xfa6Fc5e0177186989897E197D70A3ED66470fc9E;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% MAX 5,000,000
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% MAX 5,000,000
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% MAX 5,000,000
