...
contract GoldenRetriever is Context, IERC20, Ownable {
    ...
    string private _name = "GoldenRetriever";
    string private _symbol = "GoldenRetriever";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x015ac88b6dC03949f0d136506826172F2fA52899); 
    address payable public teamWalletAddress = payable(0x015ac88b6dC03949f0d136506826172F2fA52899); 
