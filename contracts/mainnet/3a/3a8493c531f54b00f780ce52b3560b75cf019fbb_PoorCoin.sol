...
I am not paid enough to write the description, sorry.

    Telegram: https://t.me/PoorCoinBSC
    Website: PLS Build us one :(
    Twitter: Any volunteer social manager?
...
contract PoorCoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa9c7062e0Ff02735D1bC6FB01dc54AEc193a57bC;
    address public devWallet = 0xa9c7062e0Ff02735D1bC6FB01dc54AEc193a57bC;
    address public buybackWallet = 0xa9c7062e0Ff02735D1bC6FB01dc54AEc193a57bC;
    address public lotteryWallet;
    address public charityWallet = 0xa9c7062e0Ff02735D1bC6FB01dc54AEc193a57bC;

    string private constant _name = "PoorCoin";
    ...
    Taxes public taxes = Taxes(0, 1, 0, 0, 1, 0, 1);
    Taxes public sellTaxes = Taxes(0, 1, 0, 0, 1, 0, 1);
