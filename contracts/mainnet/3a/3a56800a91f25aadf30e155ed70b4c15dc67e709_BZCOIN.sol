...
contract BZCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Baby ZillaCoin  ";
    string private _symbol = " BZCOIN "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4301CBcbfb20084297a55056f41C215c0678E3A7); 
    address payable public teamWalletAddress = payable(0x4301CBcbfb20084297a55056f41C215c0678E3A7); 
