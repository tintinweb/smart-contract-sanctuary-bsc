...
contract ABESHI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ABESHI";
    string private _symbol = "ABESHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9771c628365FA86697a0BC761e4BFB778868107D); // Marketing Address
    address payable public teamWalletAddress = payable(0x9771c628365FA86697a0BC761e4BFB778868107D); // Team Address
