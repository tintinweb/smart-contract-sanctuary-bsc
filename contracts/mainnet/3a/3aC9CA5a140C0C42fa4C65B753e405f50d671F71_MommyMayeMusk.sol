...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24ccF9823Fc2F9d544AD0B06b10144f963AeDE53; // owner address
...
contract MommyMayeMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mommy Maye Musk";
    string private _symbol = "$MMM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24ccF9823Fc2F9d544AD0B06b10144f963AeDE53); // Marketing Address
    address payable public teamWalletAddress = payable(0x24ccF9823Fc2F9d544AD0B06b10144f963AeDE53); // Team Address
