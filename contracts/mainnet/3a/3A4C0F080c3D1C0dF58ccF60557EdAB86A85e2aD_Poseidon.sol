...
contract Poseidon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Poseidon";
    string private _symbol = unicode"Posdon";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xa1F8A2707D56D3B74Ef5836BeC8E54407399c114); 
    address payable public BurnedWalletAddress = payable(0xfBE881fDDC8C6E5CF23b50b40C887A70e32c7255); 
