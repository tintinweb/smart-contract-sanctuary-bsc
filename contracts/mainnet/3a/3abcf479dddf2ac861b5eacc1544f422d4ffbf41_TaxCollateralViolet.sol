...
contract TaxCollateralViolet is ERC20 {
    ...
    constructor(address _collateral, address _wbnb) ERC20('Collateral Violet Liquidity', 'cLiquidityViolet' ) {
    ...
    function swapCollateralVioletForETH() external onlyAdmin {
        ...
        uint256 tokenCollateral = collateral.balanceOf(address(this));
        uint256 tokenAmount = (tokenCollateral * 499) / 1000;
        address[] memory path = new address[](2);
        path[0] = address(collateral);
        path[1] = uniswapV2Router.WETH();        

        _approve(address(collateral), address(uniswapV2Router), tokenAmount);
    ...
    function addLiquidityViolet() external onlyAdmin {
        uint256 tokenAmount = collateral.balanceOf(address(this));
    ...
    function removeLiquidity(address _tokenA, address _tokenB) external onlyAdmin {
