...
contract SBEA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safu Bored Elon Ape"; 
    string private _symbol = "SBEA"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe15672bcD47e39885325828Bb4e6C97409706992); 
    address payable public teamWalletAddress = payable(0xe15672bcD47e39885325828Bb4e6C97409706992); 
