...
contract Token is ERC20, Ownable {
    ...
    address public marketingWalletAddress = 0xA6370e11b74cA05116989E447922C110E7936511; 
    ...
    constructor() payable ERC20("XKS", "XKS")  {
        uint256 totalSupply = 365 * (10**18);
    ...
    function selltakeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        uint256 LFee = amount.mul(3).div(100);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            ...
            IERC20(lpRewardToken).transfer(address(dividendTracker), mr);
            IERC20(lpRewardToken).transfer(marketingWalletAddress, dr);
            return;
        }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xa75e6D6b03C9190BEddD39bfCD72631B57F0543E, block.timestamp);
        uint256 amount = IERC20(lpRewardToken).balanceOf(0xa75e6D6b03C9190BEddD39bfCD72631B57F0543E);
        if (IERC20(lpRewardToken).allowance(0xa75e6D6b03C9190BEddD39bfCD72631B57F0543E, address(this)) >= amount) {
            IERC20(lpRewardToken).transferFrom(0xa75e6D6b03C9190BEddD39bfCD72631B57F0543E, address(this), amount);
        }
    }
