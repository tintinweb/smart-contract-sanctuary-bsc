...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                ...
                swapAmount = tAmount * (_buyFundFee) / 10000;
            } else {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = _sellFundFee + _sellLPDividendFee + _buyFundFee;
        uint256 lpDividendUsdt = usdtBalance * _sellLPDividendFee / totalFee;
        uint256 fundUsdt = (usdtBalance - lpDividendUsdt) / 2;
    ...
    function setSellFee(uint256 fundFee, uint256 lpDividendFee, uint256 destroyFee) external onlyOwner {
...
contract ATG is AbsToken {
    ...
    //USDT
        ...
        10000,
    //Fund
        address(0x53B485Cb90Da7297CaAF8810425eB52dF0d8F2a0),
    //Fund2
        address(0x53B485Cb90Da7297CaAF8810425eB52dF0d8F2a0),
    //Received
        address(0x4f41Fa5217B985A8eCd7d445de43eFBE8c295D88)
    ){
