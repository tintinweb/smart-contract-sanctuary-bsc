...
contract AI2023RABBIT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "AI2023 RABBIT";
    string private _symbol = "AIR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x719bfd775f04A43Dc04f1Ba97228084f2C5f5768);
    address payable public liqWalletAddress = payable(0x719bfd775f04A43Dc04f1Ba97228084f2C5f5768);
