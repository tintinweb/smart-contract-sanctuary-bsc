...
contract PocketChange {
    ...
    uint256 constant launch = 1672923600;  //Thu Jan 05 2023 13:00:00 GMT+0000 //for launch
    // uint256 constant launch = 1671880621;  //Sat Dec 24 2022 11:17:01 GMT+0000 //for test
    ...
    constructor() {
            ...
            FeesKey[20] = FeesPercs(1728000, 200);
            FeesKey[30] = FeesPercs(2592000, 160);
            FeesKey[40] = FeesPercs(3456000, 150);
            FeesKey[50] = FeesPercs(4320000, 140);
            FeesKey[60] = FeesPercs(5184000, 130);

            BUSD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);  //mainnet
            // BUSD = IERC20(0x9937718a4e2042EBC67607FdCFF1A31edd52BA7c);  //testnet
