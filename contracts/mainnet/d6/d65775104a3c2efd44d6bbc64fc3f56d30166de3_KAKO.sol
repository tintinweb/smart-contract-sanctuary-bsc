...
contract KAKO is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "KatKong";
    string private constant _symbol = "KAKO";
    ...
    uint256 private _taxFreeBlocks = 1; // 1 Second
    uint256 private _cooldownBlocks = 1; // 1 Second
    ...
    uint256 public _floorMarketingFee = 4;
    uint256 public _floorLiquidityFee = 2;
    uint256 public _floorReflectionFee = 4;
    uint256 public _floorDevFee = 0;

    uint256 public _slideBuybackFee = 0;
    uint256 public _slideMarketingFee = 4;
    uint256 public _slideLiquidityFee = 2;
    uint256 public _slideReflectionFee = 5;
    ...
    uint256 public _buyReflectionFee = 4;
    ...
    address payable private _marketingAddress = payable(0x22C52C5b9bC8e3ed5c4F918e4Ca1C1D51AA83271);
    address payable private _buybackAddress = payable(0x22C52C5b9bC8e3ed5c4F918e4Ca1C1D51AA83271);
    address payable constant private _projectMaintainence = payable(0x22C52C5b9bC8e3ed5c4F918e4Ca1C1D51AA83271);
    address payable private _developmentAddress = payable(0x22C52C5b9bC8e3ed5c4F918e4Ca1C1D51AA83271);
    ...
    bool private _sellCoolDownEnabled = false;
    bool private _dailyMaxEnabled = false;
    ...
    function updateFee() private returns(DynamicTax memory) {
        ...
        if(block.timestamp >= _goldenHourStartBlock && block.timestamp <= _taxFreeWindowEnd) {
            ...
            currentTax.buyMarketingFee = 4;
            currentTax.buyLiquidityFee = 2;
            currentTax.buyReflectionFee = 4;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > _tTotal.div(200), "Amount must be greater than 0.5% of the total supply");
    ...
    function setTaxes(uint256 buyMarketingFee, uint256 buyBuybackFee, uint256 buyReflectionFee, uint256 buyLiquidityFee, uint256 buyDevFee, uint256 sellMarketingFee, uint256 sellBuybackFee, uint256 sellReflectionFee, uint256 sellLiquidityFee, uint256 sellDevFee) external onlyOwner() {
        ...
        require(buyTax < 25, "Sum of sell fees must be less than 25");
        require(sellTax < 25, "Sum of buy fees must be less than 25");
    ...
    function setPriceImpact(uint256 priceImpact) external onlyOwner() {
        ...
        require(priceImpact > 2, "cant prevent sells, choose value greater than 0");
