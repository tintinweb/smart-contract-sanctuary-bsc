...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 allFeeRate) private lockTheSwap {
        ...
        fundAddress.call{value : balance - ethAmount}("");
    ...
    function setFeeRate(uint256 LPFeeRate, uint256 MarketFeeRate) external onlyFunder {
...
contract ABEZL is AbsToken {
    constructor() AbsToken(
        ...
        6,
        1937770000,
        address(0x89e2f96654289dc1eC791C88B32fDB8973De54AF),
        address(0x89e2f96654289dc1eC791C88B32fDB8973De54AF)
    ){
