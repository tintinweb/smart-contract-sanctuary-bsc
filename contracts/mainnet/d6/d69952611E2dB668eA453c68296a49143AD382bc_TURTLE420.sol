...
/*
https://www.420turtle.org
https://t.me/turtle420
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 3) * (10 ** 9);
...
contract TURTLE420 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0xEc077B768d513ca20E2e9EEF4a4Ce1518c604506;

    string constant _name = "420TURTLE";    
    string constant _symbol = "420T";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 420000 * (10 ** _decimals);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (dumpCooldownEnabled
            ...
            && recipient == pair) {
            require(dumpCooldownTimer[sender] < block.timestamp, "Please wait for cooldown between sells");
    ...
    function actAntiBots() external onlyOwner() {
