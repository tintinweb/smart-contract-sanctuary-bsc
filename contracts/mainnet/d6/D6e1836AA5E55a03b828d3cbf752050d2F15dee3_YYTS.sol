...
contract YYTS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "YYTS";
    string private _symbol = "YYTS";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x890B97defAd3630Ac58835B3DcAe4E40F91FD6dB));
        marketingWalletAddress = payable(address(0x2E1a91B5a0ca945209fF5b031D05E92F20e80282));
