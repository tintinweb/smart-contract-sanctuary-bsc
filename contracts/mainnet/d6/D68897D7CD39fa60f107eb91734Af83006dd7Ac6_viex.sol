...
contract viex is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("viex", "viex", uint8(DECIMALS)) {
        ...
        address targetOwner = 0x07B17349B8547E9e19Ece620aDcF4d83853aD8BF;
        autoLiquidityReceiver = 0x9Bc31eb3e93E5E8e92fa5A5a2b8B4492BeeDf1bc;
        TreasuryReceiver = 0x8F997F893BD1Fca4F8ae33830231770fdD448Ce1;
        RiskFreeValueReceiver = 0x02Ab164223Dd0ff6331015e4f741B5E9Da3C85e7;

        _allowedFragments[address(this)][address(router)] = uint256(-1);
        pairContract = InterfaceLP(pair);

        _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
        _gonBalances[targetOwner] = TOTAL_GONS;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);

        initialDistributionFinished = true;
        _isFeeExempt[targetOwner] = true;
        _isFeeExempt[address(this)] = true;

        _transferOwnership(targetOwner);
        emit Transfer(address(0x0), targetOwner, _totalSupply);
    }
