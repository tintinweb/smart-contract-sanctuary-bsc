...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    uint8 public _previousTaxFee = 0;
    uint8 public _liquidityFee = 2;
    uint8 public _previousLiquidityFee = 2;
    ...
    function CumulativeDividends(uint256 share) internal view returns (uint256) {}  
...
contract Pinocchio is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'Pinocchio';
