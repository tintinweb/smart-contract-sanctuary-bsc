...
// twitter:  https://twitter.com/MetaPoos
...
contract PooSMeta is Context, IBEP20, Ownable {
    ...
    string private _name = "PooS Meta"; // token name
    string private _symbol = "Poos"; // token ticker
