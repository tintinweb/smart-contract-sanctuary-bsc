 ...
 *  Telegram: https://t.me/Sixtytokenbsc
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract sixty  is IBEP20, Auth {
    ...
    string constant _name = "60";
    string constant _symbol ="60";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10 * 10**5 * (60 ** _decimals);
