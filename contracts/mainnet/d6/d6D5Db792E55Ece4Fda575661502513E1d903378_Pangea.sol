...
contract Pangea is IBEP20 {
    ...
    constructor() {
        ...
        tokens.push(Token({contractAddress: IBEP20(0x438131Fd53742252dfAaef04Ee8D4779a93abFfa), percentage: 50, active: true}));
        permitedTokens[0xdD8B490001D081eD065239644dae8D1a77b8A91F] = true;
        permitedTokens[0x438131Fd53742252dfAaef04Ee8D4779a93abFfa] = true;        
