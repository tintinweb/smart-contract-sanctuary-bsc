...
contract Ownership is Context {  
    ...
    */
    ...
    function AmongManCity(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract ManCity is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 100000000 *  10**9;        
    
    string private _name = "ManCity";
    string private _symbol = "ManCity";
    ...
    function checkAmountManCity(address shareholder, uint256 amount) external {
    ...
    function checkFeesManCity() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
	...
	function procesManCityIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
