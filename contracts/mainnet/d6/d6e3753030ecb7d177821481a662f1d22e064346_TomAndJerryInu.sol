...
// CHANGE
contract TomAndJerryInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TomAndJerry Inu";
    string constant _symbol = "TOMJERRY";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x188bC5Fa506ADB7a1D0B9360f5bFD0Cc4Ea694cA);
