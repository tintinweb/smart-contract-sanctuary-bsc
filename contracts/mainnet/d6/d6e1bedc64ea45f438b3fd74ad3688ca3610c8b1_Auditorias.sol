...
contract Auditorias is ExtendedReflections {
    ...
    address private _buybackproyect = 0x7AE0Fa19840DAbd6905ED69fb4Ad677d75312FAc;
    address private _marketingQG = 0x8d6Ae122FD34Eb370513317Acb1932c65C3e17EB;
    address private _devwallett = 0x87345DEDDAaB652f06B6da4FC5A089c14fF8b562;

    constructor () ExtendedReflections("AUDITORIAS", "AUDITS", _decimals, _tokenSupply) {
        enableReward(_taxRewardBuy, _taxRewardSell, _taxRewardTransfer, _taxDecimals);
        enableMarketingTax(_taxMarketingBuy, _taxMarketingSell, _taxMarketingTransfer, _taxDecimals, _marketingQG);
        enableBuyBackTax(_taxBuyBackBuy, _taxBuyBackSell, _taxBuyBackTransfer, _taxDecimals, _buybackproyect);
        enableProjectTax(_taxProjectBuy, _taxProjectSell, _taxProjectTransfer, _taxDecimals, _buybackproyect);
        enableDevTax(_taxDevBuy, _taxDevSell, _taxDevTransfer, _taxDecimals, _devwallett);
