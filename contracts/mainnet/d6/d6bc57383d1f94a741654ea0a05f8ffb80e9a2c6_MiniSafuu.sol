...
/**
Hello! And welcome to MiniSafuu - A Community that rewards in Crypto’s biggest trend right now, Safuu!

We all missed the big dip, So lets start our own wave. 

Automatic Safuu Rewards for holders

Join the TG https://t.me/MiniSafuu
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90); 
...
contract MiniSafuu is IBEP20, Auth {
    using SafeMath for uint256;
    address REWARDS = 0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90;  //Mainnet
    ...
    address _marketingAdr = 0xd261D9A0780266Af1ef6013d6976B9d1AA4c2a02;
    string constant _name = "MiniSafuu";
    string constant _symbol = "mSafuu";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 1 * 10**16 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 25;
