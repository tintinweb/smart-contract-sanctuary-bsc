...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95D0DD96255c342C6689E5E840EC3458E8c8c036;
...
contract FTXApeClub is Context, IERC20, Ownable {
    ...
    string private constant _name = "FTX Ape CLUB"; // 
    string private constant _symbol = "FTXAPES"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x96Be3C64C0d576DBf56ce1e1dfec3476298D252C);
