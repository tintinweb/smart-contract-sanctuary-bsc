...
contract NANA is NANADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private NANATeam;
    address private CharityNANA;
    ...
    string public override name = "Burnana";
    string public override symbol = "NANA";
    ...
    constructor(uint totalSupplyValue, address NANATeamAddress, address CharityNANAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        NANATeam = NANATeamAddress;
        CharityNANA = CharityNANAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[NANATeam] =  totalSupply * 4 / 100;
        balances[CharityNANA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NANATeam pot
