...
contract FED75POINTS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FED75POINTS";
    string private _symbol = "FED75POINTS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWallet = payable(0x7892EFfC973870800c520D55D3D4402aBFa48aaA); // Marketing Address
    address payable public teamWalletAddress = payable(0x7892EFfC973870800c520D55D3D4402aBFa48aaA); // Team Address
