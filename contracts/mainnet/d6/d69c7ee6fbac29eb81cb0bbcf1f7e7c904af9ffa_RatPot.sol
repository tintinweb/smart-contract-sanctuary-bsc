...
library Address{
  ...
  contract RatPot is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xCCf042bfc664a196376214CF2444eCE12357B864;
    address public donationWallet = 0x6dc829f0926c4E4a01a60bb1A6aFA6Ed18e933ac;

    string private constant _name = "RatPot";
    string private constant _symbol = "RATPOT";
