...
contract HubandEfe is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x400e2e8DA817019183891f5a7e579270b6968525),
        developer: payable(0x400e2e8DA817019183891f5a7e579270b6968525)
    });
    ...
    uint256 public liquidityLockTime = 0.32 days;
