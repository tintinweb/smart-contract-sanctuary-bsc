...
contract token  is Context, IERC20, Ownable{
    ...
    address payable public marketingAddress =
        payable(0x6bbB1f701589d374D023e80d9ef1BfB85eAD3a2F); // Marketing Address
        
    address payable private liquidityAddress =
        payable(0xFa7635042D8070E3DE086Cd1fC7d885eD8af25E7); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100000000 * 1e6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "TDIAOS";
    string private constant _symbol = "TDIAOS";
    ...
    uint256 private gasMaxLimit =  10000000 * 1 gwei; // gasLeft limit
    ...
    constructor() {
        address newOwner = address(0xff8064562e822e419550429E1fBf801a8d57f60e);
