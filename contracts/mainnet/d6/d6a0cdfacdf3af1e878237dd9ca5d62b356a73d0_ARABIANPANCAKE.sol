...
*/
 /** 
    ...
    ARABIAN PANCAKE,Ready for X100?  and make strong community 🥞👳 .

// TG: https://t.me/ARABIANPANCAKE
...
contract ARABIANPANCAKE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ARABIAN PANCAKE";
    ...
    address private marketingWallet = address(0xF483FAFB5D0178a7b64B24C926caE7D459488D05);
    address private liquidityReceiver = address(0xF483FAFB5D0178a7b64B24C926caE7D459488D05);
