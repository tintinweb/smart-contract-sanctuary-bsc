...
contract BabyBitcoin is Context {
...
contract Contract is Context, IERC20 { 
    ...
    */
    ...
    function Contract_SetUp_01__Fees_on_Buy(
        ...
        // Buyer protection: max fee can not be set over 10%
        require (BNB_on_BUY          + 
                 Liquidity_on_BUY    + 
                 Reflection_on_BUY   + 
                 Burn_on_BUY         + 
                 Tokens_on_BUY       + 
                 _Fee__Buy_Contract <= 10, "E02"); 
    ...
    */
    ...
    function SwapExactTokensForTokens(
        ...
        // Buyer Protection - Swap can only be done before launch
