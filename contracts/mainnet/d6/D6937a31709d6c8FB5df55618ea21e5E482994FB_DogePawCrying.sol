...
contract DogePawCrying is IERC20, Auth {
    ...
    string private constant  _name = "Doge Paw Crying";
    ...
    address payable public marketingWallet = payable(0x823399d43f8BA151a496Fba58Aa3eC14EdE00684);
