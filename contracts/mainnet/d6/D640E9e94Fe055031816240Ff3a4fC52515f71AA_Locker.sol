...
contract Locker is ReentrancyGuard {
    ...
    event Locked(address indexed _beneficiary, uint256 indexed _amount);
    ...
    IERC20 public token = IERC20(0x9FeF1Efe8EFa3bdc1826174be54c177982491c25);

    address public owner = 0x1aa89429d713b9a5C3E69d89Bacf09Aa683f026f;
    ...
    function createLocks(
        ...
        require(_beneficiaries.length > 0, "Empty Data");
        require(
        ...
        for (uint256 i = 0; i < _beneficiaries.length; i++) {
            ...
            createLock(beneficiary, amount);
        }
    }

    function createLock(address _beneficiary, uint256 _amount)
        public
        onlyOwner
    {
        require(isInitialised, "Not initialised");
        ...
        emit Locked(_beneficiary, _amount);
    }

    function claim(address _beneficiary) public nonReentrant {
        uint256 amount = vestedAmount[_beneficiary];
        require(amount > 0, "There is no schedule currently in flight");
        require(block.timestamp >= end, "Claiming too early");
