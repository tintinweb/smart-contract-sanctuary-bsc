...
contract Paws is Context, IERC20, Ownable {
    ...
    string private _name = "PAWS PAWS";
    string private _symbol = "PAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B37a2d3159BEe5C5124C1437674448007dB5eb8); // Marketing Address
    address payable public teamWalletAddress = payable(0xbD79292DFD8FDEa830551a05CE20862B20eD9143); // Team Address
