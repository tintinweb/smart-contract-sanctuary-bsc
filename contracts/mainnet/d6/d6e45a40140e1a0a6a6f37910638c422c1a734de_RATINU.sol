...
✨ 🐁🐕🐀🐁🐕🐀🐁🐕🐀🐁🐕🐀🐁🐕🐀
           ...
           *
        💥
🐀 RAT !NU 🐕  - "Make Rat Coin Great Again"

💠 Telegram: https://t.me/Rat_Inu
💠 Twitter: https://twitter.com/Rat_Inu_BSC
💠 Website:  https://www.ratinu.site/
...
contract RATINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RAT !NU";
    string private constant _symbol = unicode"RAT !NU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**12 * 10**_decimals;

    address payable private DevAddress = payable(0x71E9EA6351F5edbFE5D6d08bb5E04FC6ac2260a2);
    address payable private MarketingAddress = payable(0x71E9EA6351F5edbFE5D6d08bb5E04FC6ac2260a2);
    ...
    uint256 public _maxTxAmount = _tTotal * 1 / 10;
    uint256 public _maxWalletToken = _tTotal * 3 / 10;
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && tradingActiveBlock + 25 seconds <= block.timestamp) {idclaim();}
