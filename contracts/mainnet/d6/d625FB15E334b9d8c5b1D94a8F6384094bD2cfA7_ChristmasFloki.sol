...
contract ChristmasFloki is ERC20, Ownable {
    ...
    constructor() ERC20("ChristmasFloki", "CHFLOKI") {
        _mint(msg.sender, 1000000000000000000 * 10**decimals());

        marketingFeeAddress = payable(
            0xC788dC75459ed91B341BB22a36f9112c156a47B2
        );
        stakingFeeAddress = payable(0x864708926772421A2Fc4d9C1f07062651e3f1A24);
