...
contract Saffuyachtclub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Saffuyachtclub";
    string constant _symbol = "Saffuyachtclub";
    ...
    uint256 public teamFee         = 0; //buyback fee 3%
