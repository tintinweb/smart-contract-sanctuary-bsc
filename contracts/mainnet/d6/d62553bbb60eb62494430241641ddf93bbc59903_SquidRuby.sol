...
contract SquidRuby is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Ruby";
    string private constant _symbol = "SquidRuby";
