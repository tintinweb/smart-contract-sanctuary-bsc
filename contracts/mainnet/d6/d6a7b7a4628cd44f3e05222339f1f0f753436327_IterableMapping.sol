...
contract MetaReflect is ERC20, Ownable {
	...
	uint256 public maxTxAmount = initialSupply * 125 / 100000;
	...
	address public stakingAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

	address public marketingWallet = 0x041E2204e21f4a74E7156218832415843AC403aa;
	address public liquidityWallet = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
	address public buyBackWallet = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
	...
	function updateDividendTracker(address newAddress) public onlyOwner {
		...
		require(newDividendTracker.owner() == address(this), "MetaReflect: The new dividend tracker must be owned by the MetaReflect token contract");
	...
	function blockAccount(address account) public onlyOwner {
		...
		if (_isLanched) {
			require(currentTimestamp.sub(_launchStartTimestamp) < _blockedTimeLimit, "MetaReflect: Time to block accounts has expired");
		}
	...
	function setWallets(address newLiquidityWallet, address newMarketingWallet, address newBuyBackWallet) public onlyOwner {
		...
		if(marketingWallet != newMarketingWallet) {
			require(newMarketingWallet != address(0), "MetaReflect: The marketingWallet cannot be 0");
			emit WalletChange('marketingWallet', newMarketingWallet, marketingWallet);
			marketingWallet = newMarketingWallet;
		}
		if(buyBackWallet != newBuyBackWallet) {
			require(buyBackWallet != address(0), "MetaReflect: The buyBackWallet cannot be 0");
