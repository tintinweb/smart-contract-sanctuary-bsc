...
contract FlurryRebaseUpkeep is AccessControlEnumerableUpgradeable, IFlurryUpkeep {
    ...
    function performUpkeep(bytes calldata performData) external override onlyRole(RELAYER_ROLE) {
        lastTimeStamp = block.timestamp;
    ...
    function registerVault(address vaultAddr) external onlyRole(DEFAULT_ADMIN_ROLE) {
