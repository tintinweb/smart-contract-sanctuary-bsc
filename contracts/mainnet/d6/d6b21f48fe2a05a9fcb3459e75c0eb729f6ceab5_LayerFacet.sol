...
contract LayerFacet is Helper {
    ...
    function invest(uint32 slippage) external payable nonReentrant returns (uint256 getLP, uint256 mintDLP) {
    ...
    /// @param slippage 0.00-100.00 percent (0-10000)
    /// @return getLP Amount of invested tokens LP.
    function updateReserve(uint32[] calldata crates, uint32 slippage) external nonReentrant returns (uint256 getLP) {
