...
contract QUEENJA is Context, IERC20, Ownable {
    ...
    address payable private _devAddress = payable(0x102E7DAB0035ec5f99408f4be81529d85f11c5b1);
    
    string private constant _name = "QUEENJA";
    string private constant _symbol = "QUEENJA";
