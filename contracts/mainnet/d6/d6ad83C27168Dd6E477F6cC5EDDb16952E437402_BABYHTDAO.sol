...
contract BABYHTDAO is IBEP20, Auth {
    ...
    string constant _name = "BABY HTDAO TOKEN";
    string constant _symbol = "BHTDAO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 2000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb9f592CB2a1f9ECEB49178B8141C30eFA960e2F3;
