...
/**
   _____                        _____ _        _        
  / ____|                      / ____| |      | |       
 | (_____      _____  ___ _ __| (___ | |_ __ _| | _____ 
  \___ \ \ /\ / / _ \/ _ \ '_ \\___ \| __/ _` | |/ / _ \
  ____) \ V  V /  __/  __/ |_) |___) | || (_| |   <  __/
 |_____/ \_/\_/ \___|\___| .__/_____/ \__\__,_|_|\_\___|
 | \ | |    | |          | |       | |                  
 ...
 |_| \_|\___|\__| \_/\_/ \___/|_|  |_|\_\               
    ...
    Staking at Launch
        Lottery
    Many More Utilities to come !

    Join Our Community :
    Website     : https://sweepstake.network/
    ...
    GitHub      : https://github.com/SweepStakeNetwork
    Reddit      : https://www.reddit.com/user/Sweepstake_Network/
...
contract SweepStakeNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SweepStake Network";
    string constant _symbol = "$SSN";
    ...
    uint256 public swapThreshold = _totalSupply * 15 / 10000; // 0.15% of supply
    bool inSwap;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        treasuryFee = _treasuryFee;
        buybackFee = _buybackFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(_treasuryFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBTeam = amountBNB.mul(treasuryFee).div(totalBNBFee);
        uint256 amountBNBBuyback = amountBNB.mul(buybackFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(treasuryFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _treasuryFeeReceiver, address _buybackFeeReceiver) external authorized {
