...
contract PERPETUALDOGE is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string _name = "PERPETUAL DOGE";
    string _symbol = "PDOGE";
   ...
   // address constant WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Testnet - WBNB Token
    ...
    address marketingFeeReceiver = 0x1d63bd8a3FfEE4C9a0f4C78d8Ec3198ebEed0f95;
