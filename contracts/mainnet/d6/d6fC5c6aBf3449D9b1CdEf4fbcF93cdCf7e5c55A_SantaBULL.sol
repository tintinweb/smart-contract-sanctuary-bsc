...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24C024859679824D6CB429161848C4BC8F1ED3a4; // owner address
...
contract SantaBULL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaBull";
    string private _symbol = "SBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24C024859679824D6CB429161848C4BC8F1ED3a4); // Marketing Address
    address payable public teamWalletAddress = payable(0x24C024859679824D6CB429161848C4BC8F1ED3a4); // Team Address
