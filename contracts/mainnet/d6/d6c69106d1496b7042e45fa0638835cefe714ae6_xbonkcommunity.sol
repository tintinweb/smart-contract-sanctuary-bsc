...
contract xbonkcommunity is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private devAddress = payable(0x6819a2574e4DaB03a28D7093d12334735f3c4D5c); // dev Address
    ...
    uint256 private devDivisor = 8;
    
    uint256 public _maxTxAmount = 30000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 15012465879 * 10**9;
    ...
    function manualSend() external onlyOwner {
        ...
        payable(devAddress).transfer(contractETHBalance);
    }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(devAddress, transferredBalance.div(_devFee).mul(devDivisor));
