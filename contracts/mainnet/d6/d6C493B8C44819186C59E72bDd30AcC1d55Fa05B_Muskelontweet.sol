...
contract Muskelontweet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Musk elon tweet";
    string private _symbol = "$MET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x69f676b5aC5197df81249Fcb308a96e3Cd9c0c8e); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0x9116d9F77AeA7521aeF03B934A6E713956621f00); // BuyBack Address
    ...
    uint256 private _BuyBackShare = 5;
