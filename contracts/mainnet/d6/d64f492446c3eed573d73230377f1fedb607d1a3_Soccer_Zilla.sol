...
contract Soccer_Zilla is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Soccer Zilla";
    string private constant _symbol = unicode"SOCCERZILLA";
    ...
    address payable public DevWallet = payable(0xcbe39CA6b7031F926c1136f56adba2f4DB3a80b8);
    address payable public MarketingWallet = payable(0xD13d0e6330A2B2b8C4d972D4f7c53a87c63928a6);
    address payable private TeamWallet01 = payable(0x239535C9C80ae198D4D9211E1c027a0556b6878d);
    address payable private TeamWallet02 = payable(0xE36D938693FAA26D669A4100D64f6BE60141aA7d);
    address payable private TeamWallet03 = payable(0x2B839a64357C61594C217f8c10cDacde0fDCc7eD);
