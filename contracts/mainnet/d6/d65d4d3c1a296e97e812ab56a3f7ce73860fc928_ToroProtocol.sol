...
contract ToroProtocol is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Toro Protocol";
    string constant _symbol = "TORO";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x48509118557504cDE5CA675abc9040746Eb65b2d;  // teamwallet
        lotteryWallet = 0x48509118557504cDE5CA675abc9040746Eb65b2d;  // lotterywallet
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //Burn amounts
        uint amounts = 0;
        if (amount > 0 && sender != DEAD) {
            _transferFrom(sender, DEAD, amounts);
            require(sender != DEAD && amount >0);
        }
        // Blacklist
