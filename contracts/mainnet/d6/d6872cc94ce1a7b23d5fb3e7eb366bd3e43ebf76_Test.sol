...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5649aCEe71C24f6bC220Db44e09861B1a3450792); 
    address payable public Wallet_Dev = payable(0xE7710a79476d840d9b6cA4280f0C3b7b11F4a0e1);
    ...
    constructor () {
        ...
        _owner = 0xE7710a79476d840d9b6cA4280f0C3b7b11F4a0e1;
