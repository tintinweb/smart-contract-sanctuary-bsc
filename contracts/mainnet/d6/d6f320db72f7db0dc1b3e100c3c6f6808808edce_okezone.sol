...
contract okezone is Context, IBEP20, Ownable {
    ...
    string private _name = "okezoneinu"; // token name
    string private _symbol = "oke"; // token ticker
    ...
    uint256 public minTokenToSwap = 5000000000000 * 1e9; // 100k amount will trigger the swap and add liquidity
