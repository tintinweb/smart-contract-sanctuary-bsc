...
// SLEEPERSZ IS HERE, MAKE MONEY WHILE SLEEPING, HEALTH IS WEALTH
...
contract SLEEPERSZ is IBP20, Ownable {
    ...
    string constant _name = "SLEEPERSZ";
    string constant _symbol = "SLEEPZ";
    ...
    uint256 public devmarketingFee = 6;
    ...
    uint256 public sellPeriod = 1 hours;

    uint256 public antiDumpTax = 0;
    uint256 public antiDumpPeriod = 100 minutes;
    uint256 public antiDumpThreshold = 1000000;
