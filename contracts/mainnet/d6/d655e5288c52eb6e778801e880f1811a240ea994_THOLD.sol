...
/**
Tg : https://t.me/Tholdfinance?utm_source=DX+TELEGRAM

Website : https://www.thold.finance/?utm_source=DX+WEB
...
contract THOLD is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private constant MAX = ~uint256(0);
    string private _name = "Thold Finance Token";
    string private _symbol = "THOLD";
