...
contract ANGELDUSTGROW is ERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0xEA9F22a539731db7Fe6fD1212D03248cC9177012);
    address payable private devWallet = payable(0x017C17Bd8841D1f4c6CFB1d4ff477A077f4dd230);
    ...
    constructor() ERC20("ANGEL DUST GROW", "ADG") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ANGEL DUST GROW: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ANGEL DUST GROW: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ANGEL DUST GROW: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ANGEL DUST GROW: Automated market maker pair is already set to that value");
