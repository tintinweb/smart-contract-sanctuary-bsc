...
/**
    ...
    ⓂⒺⓉⒶ ⒸⓁⓄⓊⒹ
    special Partnership With DROPBOX, CLOUDMAX, 
    AND GOOGLE.inc


Telegram: https://t.me/metacloudbsc
Website: TBA
...
contract METACLOUDTOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x6c4245a79995C86fB82e1D242a09f6bCe24641D7));
    address payable public devWallet =
        payable(address(0xf238e4a09baab475e7D16d401ddb12656D0dFf26));
    address public liquidityReceiver =
        0x3F9bDC65cDe5f5d517c53fe5579A4Ea144a21085;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "META CLOUD";
    string private _symbol = "METACLOUD";
    ...
    uint256 private numTokensSellToAddToLiquidity = 2002875457 * 10**9;
    ...
    function _transfer(
        ...
        if (privateTradingIsOn && from == uniswapV2Pair && !_isExcludedFromFee[to]) {
            require(whitelistedOnPrivateTrading[to], "");
        }
