...
contract Bigfootinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bigfoot Inu";
    string private _symbol = "bigfoot inu";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x687a6355205A40D942ee3cd992616939073eb46f); // Marketing Address
    address payable public teamWalletAddress = payable(0x687a6355205A40D942ee3cd992616939073eb46f); // Team Address
