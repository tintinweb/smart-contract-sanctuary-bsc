...
library Address{
 ...
 contract Mandrill is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xc4794E7A2F2814A51537C1850f1BBEb2D8faBe0d;
    address public donationWallet = 0xc4794E7A2F2814A51537C1850f1BBEb2D8faBe0d;

    string private constant _name = "MANDRILL";
    string private constant _symbol = "MAND";
    ...
    Taxes public taxes = Taxes(1, 3, 4, 2);
    Taxes public sellTaxes = Taxes(1, 4, 4, 5);
