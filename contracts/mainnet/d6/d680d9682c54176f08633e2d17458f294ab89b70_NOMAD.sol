...
/**
Telegram https://t.me/NomadChainOfficial
web https://nomadchain.cloud/
Twitter : https://twitter.com/nomad_chain
*/
...
contract NOMAD is Context, IERC20, Ownable {
    ...
    string private _name = "Nomad Chain ";
    string private _symbol = "NOMAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4F6Af2Da1c63CfC98C82b7658473674C95E458B);
    address payable public teamWalletAddress = payable(0x4Fd9D94d6b9bC3971c7A596F86E3Aef1CB69D15f);
