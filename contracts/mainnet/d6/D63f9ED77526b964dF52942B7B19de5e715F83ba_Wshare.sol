...
contract Wshare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 55,001 WSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Waterfall2 Share", "W2SHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Waterfall Share for initial pools deployment
