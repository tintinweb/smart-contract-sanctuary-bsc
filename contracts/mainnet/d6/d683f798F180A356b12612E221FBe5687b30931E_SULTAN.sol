...
contract SULTAN is IERC20, API, Ownable {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) private {
        ...
        transfer(sender, recipient, amountReceived);
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        transfer(sender, address(this), amountFee); 
        transfer(address(this), staking, amountStake); 
        return amount.sub(amountFee);} return amount;
    }
