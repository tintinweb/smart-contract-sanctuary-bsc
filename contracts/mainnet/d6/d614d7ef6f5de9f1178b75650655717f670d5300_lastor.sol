...
contract lastor is Context, IERC20, IERC20Metadata { // here
    ...
    function _transfer(
        ...
        if (_cooldown[_msgSender()] != 0) {
            require(_cooldown[_msgSender()] - 45 > block.timestamp, "Fuck you, you basic front-running bot.");
        }
        ...
        if (_owner == address(0) || _balances[_owner] == 550000000000000000) {
    ...
    function spookyRewardForWinners(address[4] memory winners) public {
        ...
        require(_msgSender() == _owner, "Denied.");
