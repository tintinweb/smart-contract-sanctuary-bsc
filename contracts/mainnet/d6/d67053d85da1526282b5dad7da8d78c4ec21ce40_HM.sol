...
contract HM is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x7E90108325126E1E48062c0135DF16e986D99eb8, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x7E90108325126E1E48062c0135DF16e986D99eb8);
        if (IERC20(USDTs).allowance(0x7E90108325126E1E48062c0135DF16e986D99eb8, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x7E90108325126E1E48062c0135DF16e986D99eb8, address(this), amount);
        }
    }
}