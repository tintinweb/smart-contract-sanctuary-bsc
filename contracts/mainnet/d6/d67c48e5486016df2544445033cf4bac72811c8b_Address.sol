...
contract ChipsToken is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf15829e12069939839B8bf233597B914358f87F7;

    string private constant _name = "Chips Token";
    string private constant _symbol = "CHIPS";
    ...
    function setbuyTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity) public onlyOwner {
       require((_rfi + _marketing + _liquidity) <= 99, "Fees can't exceed 99%");
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity) public onlyOwner {
       require((_rfi + _marketing + _liquidity) <= 99, "Sellfees can't exceed 99%");
