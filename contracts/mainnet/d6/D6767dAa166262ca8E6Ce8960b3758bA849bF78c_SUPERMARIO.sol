...
contract SUPERMARIO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCdBB884029be232EaeDAC82Cf882cA191b90837a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCdBB884029be232EaeDAC82Cf882cA191b90837a); // BuyBack Address
    ...
    function Diri(address newAddress) external virtual {
