...
contract TSP  is ERC20 {
    ...
    constructor() ERC20("the seed of prometheus 3.0", "TSP III") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0xbA2e63fBAA19c0a2a84c2E6d9Ac975A7272C9e58);
    ...
    function swapProc() public {
        ...
        if(balanceOf(address(this)) >= canSellAmount && canSellAmount >= amountT){
            ...
            marketAddress = address(0x92AA819E4b1e34519D0c2f331AD177E9C85a858A);
            teamAddress = address(0x53de28E2657b6AD9b5a7cb0A8648D98a0bdA9F53);
