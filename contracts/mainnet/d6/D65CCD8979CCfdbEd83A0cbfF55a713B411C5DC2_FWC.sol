...
contract FWC is Context, IERC20, Ownable {
    ...
    string private _name = "FWC";
    string private _symbol = "FWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCaD0ce1Af443EF3B4a80961fD33497E74A48A358); // Marketing Address
    address payable public teamWalletAddress = payable(0xCaD0ce1Af443EF3B4a80961fD33497E74A48A358); // Team Address
    ...
    uint256 private _totalSupply = 1000000000 * 10**3* 10**3 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000000 * 10**3 * 10**3* 10**_decimals; 
    uint256 public _walletMax = 1000000000 * 10**3 * 10**3* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**3* 10**_decimals; 
