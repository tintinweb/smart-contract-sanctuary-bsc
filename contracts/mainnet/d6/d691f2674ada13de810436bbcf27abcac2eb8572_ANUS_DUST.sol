...
contract ANUS_DUST is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Anus Dust";
    string private constant _symbol = "AnusDust";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  69000000  * 10**_decimals;

    uint256 public _maxWalletAmount = 69000000  * 10**_decimals;
    uint256 public _maxTxAmount = 69000000  * 10**_decimals;
    uint256 public swapTokenAtAmount = 345000 * 10**_decimals;
