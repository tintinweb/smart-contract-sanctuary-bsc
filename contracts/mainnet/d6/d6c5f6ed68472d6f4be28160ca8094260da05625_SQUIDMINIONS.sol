...
contract SQUIDMINIONS is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SQUID MINIONS";
    string private _symbol = "SQUIDM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBe2567a7235a2A5C4D9f6A0E2B10CD16c2670BCc);
    address payable public liqWalletAddress = payable(0x678e4bE8804F572D01DFe798c9F69a897b750b04);
    address payable public devWalletAddress = payable(0xb671C1752104aAbCe30aCC88eA1F85aFe8dA61F6);
