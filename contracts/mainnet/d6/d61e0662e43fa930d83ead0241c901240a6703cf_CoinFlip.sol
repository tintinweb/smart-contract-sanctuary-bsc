...
contract CoinFlip is Ownable{
    ...
    function takeBet(uint _gameCount) public {
        ...
        if(winningSide == _gameStatics.coinSide){
            ...
            require(token.transfer(feeReceiver, fee), "Token Trasfer Failed");
            gameStatics[_gameCount].winner = _gameStatics.player2;
            emit WinnerAnnounced(msg.sender, _gameStatics.player1,  _gameCount, amountAfterFee);
        }

        pastGames.push(GameStatics(_gameStatics.player1, _gameStatics.player2, _gameStatics.winner, _gameCount, _gameStatics.betAmount, winningSide));
