...
uint256 constant liquidityFee = 10; //回流手续费
uint256 constant marketFee = 5; //营销手续费
uint256 constant burnFee = 5; //销毁手续费

address constant marketAddr = 0x539D46bDE394a6Be5834010ada112d12e611a3a0; //营销地址
...
abstract contract MarketAndBurn is Owned, ERC20 {
...
abstract contract InviteFee is Owned, ERC20 {
    ...
    function _takeInviterFee(
        ...
        uint8[3] memory inviteRate = [5, 3, 2];
        address cur = sender;
    ...
    BlackList
{
    ...
    constructor()
        ERC20("RabbitSky", "RS", 18)
        DividendFee(_totalSupply / 10_0000, true, SHIB)
    ...
    function mint(uint256 _n) external onlyOwner {
         _mint(msg.sender, _n);
    }
