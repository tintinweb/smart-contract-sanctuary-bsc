...
contract COWCEO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x3fc09BDCEf35a9D001C7402A1B208a7569D7681E);
    address payable private _marketingAddress = payable(0x3fc09BDCEf35a9D001C7402A1B208a7569D7681E);
