...
contract Hatakejinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hatakejinu"; // 
    string private constant _symbol = "HATAKE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 14;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x069a7211FacA0A6277Bb42Bf426fe60a119a0f8C;
