...
contract WikiZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Zilla";
    string private _symbol = "WKZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbb5c12C2A9C686629f82De9EDE2A3b7120bf8c82); 
    address payable public DevelopmentWalletAddress = payable(0x90A657C5F5E21C26282C6E46A05E35Cc295b14b5); 
