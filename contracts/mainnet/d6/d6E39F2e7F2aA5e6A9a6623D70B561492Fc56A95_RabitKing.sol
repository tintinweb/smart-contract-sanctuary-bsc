...
contract RabitKing is Context, IERC20, Ownable {
    ...
    function _whitelist_release_time_init() internal {
        ...
        whitelistReleaseTime[0] = uint256(1672974900);
        whitelistReleaseTime[1] = uint256(1672975800);
        whitelistReleaseTime[2] = uint256(1672976700);
        whitelistReleaseTime[3] = uint256(1672977600);
    }
    ...
    function addWhitelist(address[] memory accounts) external {
        ...
        require(accounts.length.add(whitelistAddress.length) <= whitelistMaxNum, "Whitelist: accounts num exceed max num!");
        require( balanceOf(address(this)) >= whitelistPresaleAmount.mul(accounts.length), "Whitelist: Amounts exceed balance!");
