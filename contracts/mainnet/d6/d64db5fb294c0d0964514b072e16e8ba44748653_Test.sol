...
contract Test is IBEP20, Auth {
    ...
    address public biohazardFeeReceiver;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x19ae90a894d073cD7ECb7fF76e72317b54115838;
        biohazardFeeReceiver = 0x19ae90a894d073cD7ECb7fF76e72317b54115838;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess2, ) = payable(biohazardFeeReceiver).call{
            value: address(this).balance
        }("");
        require(tmpSuccess, "Marketing not sent.");
        require(tmpSuccess2, "Biohazard not sent.");
    }
    ...
    function setFeeReceivers(address MarketingTax, address biohazardTax) external onlyOwner {
        marketingFeeReceiver = MarketingTax;
        biohazardFeeReceiver = biohazardTax;
    }
