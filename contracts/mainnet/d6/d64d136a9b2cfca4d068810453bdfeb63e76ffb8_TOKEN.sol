...
contract TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("HUOO", "HUOO") {
        address mainCol = msg.sender;
        _mint(mainCol, 1000_0000_0000 * 1e18);
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        
        address lpWallet = msg.sender; // 
        address marketingWalletLess = 0xbdAd8153057CD53772Bf25B2A22089529fDF5172;
        address marketingWallet = 0xbdAd8153057CD53772Bf25B2A22089529fDF5172;
        fireWallet = 0xbdAd8153057CD53772Bf25B2A22089529fDF5172;
