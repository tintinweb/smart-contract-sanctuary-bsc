...
contract BABYSpaceX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySpaceX";
    string private _symbol = "BabySpaceX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6910b0380108bf322b5D62f51E9977E105670f8e);
    address payable public teamWalletAddress = payable(0xa5d60E307c7866f0B78e75f111163C135B5fF921);
