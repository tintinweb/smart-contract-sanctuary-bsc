...
contract cowboyinu is Context, IERC20, Ownable {
    ...
    string private _name = "COWBOY INU";
    string private _symbol = "$CBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x585257342310f89A9Fe36857079fbF52a432269c); // Marketing Address
    address payable public BuyBackWalletAddress = payable (0x585257342310f89A9Fe36857079fbF52a432269c); // BuyBack Address
