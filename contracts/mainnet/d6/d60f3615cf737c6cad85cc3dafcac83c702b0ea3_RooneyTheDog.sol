...
contract RooneyTheDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rooney The Dog"; // 
    string private constant _symbol = "$Rodog"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xDc0971AC6d5fAC579707D0715b0E163F60a201C1;
