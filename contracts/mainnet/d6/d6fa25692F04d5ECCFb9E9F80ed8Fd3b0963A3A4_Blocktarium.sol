...
/* Token contract */
contract  Blocktarium is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x9Fa3f6fcF140825859476082d50d1724edCFcb46;
    ...
    // Name and symbol
    string constant _name = "Blocktarium";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!tradingOpen){ require (liquidityCreator[sender] || liquidityCreator[recipient] || Launching[recipient], "Trading not open yet."); }
