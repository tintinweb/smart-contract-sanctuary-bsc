...
1% max buy, 1% Max Sell, 2% max wallet

TG: https://t.me/DevIsHigh
*/
...
contract DevIsHigh is Context, IERC20, Ownable {
    ...
    address public marketingWallet =0x86F25483C29dd26c0d6278262Bf643ACb0Ed4863;
    address public devWallet = 0xfF427F6bAa8Bc84253BdBaA29B25e06Da2BDE990; 
    address public operationWallet = 0x86F25483C29dd26c0d6278262Bf643ACb0Ed4863;
    address public charityWallet = 0x86F25483C29dd26c0d6278262Bf643ACb0Ed4863; 

    string private constant _name = "DevIsHigh";
    string private constant _symbol = "HighDev";
    ...
    Taxes public taxes = Taxes(0, 2, 2, 2, 0, 0);
    Taxes public sellTaxes = Taxes(0, 2, 2, 2, 0, 0);
