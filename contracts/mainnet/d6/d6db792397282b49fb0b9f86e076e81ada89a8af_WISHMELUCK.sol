...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47c7f7005f6E4023f82E81C365EAA5FC5D8fC0f5; // owner address
...
contract WISHMELUCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WISH ME LUCK!!!";
    string private _symbol = "WISH ME LUCK !!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47c7f7005f6E4023f82E81C365EAA5FC5D8fC0f5); // Marketing Address
    address payable public teamWalletAddress = payable(0x47c7f7005f6E4023f82E81C365EAA5FC5D8fC0f5); // Team Address
