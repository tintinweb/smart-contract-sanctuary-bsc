...
contract CRP365 is Context, IBEP20, Ownable {
    ...
    string private _name     = "CryptoPredictions365";
    string private _symbol   = "CRP365";
    uint8 private  _decimals = 18;
    
    uint256 private _taxFee ; 
    uint256 public _liquidityFee = 3; 
    uint256 public _percentageOfLiquidityForMarketing = 77; 
    uint256 public maxWalletToken = 100000000 * (10**18);

    
    uint256 public  _maxTxAmount     = 100000000 * 10**18;
    uint256 private _minTokenBalance = 5000000 * 10**18;
