...
contract Stakeable {
    ...
    */
     ...
     */
     ...
     function calculateStakeDay(Stake memory _current_stake1) internal pure returns(uint256)
      {
         return (_current_stake1.since) ;
      }
    /**
     * @notice
...
*/
contract BITFUTURE is Ownable, Stakeable{
  ...
  */
  function _mint(address account, uint256 amount) internal {
    ...
    require(account != address(0), "BITFUTURE: cannot mint to zero address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "BITFUTURE: cannot burn from zero address");
    require(_balances[account] >= amount, "BITFUTURE: Cannot burn more than the account owns");
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "BITFUTURE: transfer from zero address");
    require(recipient != address(0), "BITFUTURE: transfer to zero address");
    require(_balances[sender] >= amount, "BITFUTURE: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "BITFUTURE: approve cannot be done from zero address");
      require(spender != address(0), "BITFUTURE: approve cannot be to zero address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, "BITFUTURE: You cannot spend that much on this account");
      // Transfer first
...
/**
    ...
    *
    ...
    function stake(uint256 _amount) public {
      ...
      require(_amount < _balances[msg.sender], "BITFUTURE: Cannot stake more than you own");
