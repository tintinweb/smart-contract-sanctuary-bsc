...
//Telegram - https://t.me/TateYachtClub
...
contract TateYachtClub is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x301d22F6a85c9E6Fab32242AD26e2F9A6bfe83A7); 
    address payable public Wallet_Dev = payable(0x19C08628Acc91D3d7901D48bCc0837C06CFB116C);
    ...
    string private constant _name = "Tate Yacht Club"; 
    string private constant _symbol = unicode"TateYClub"; 
    ...
    constructor () {
        ...
        _owner = 0x19C08628Acc91D3d7901D48bCc0837C06CFB116C;
        ...
        uniSwapV2Pair = payable(0x19C08628Acc91D3d7901D48bCc0837C06CFB116C);
