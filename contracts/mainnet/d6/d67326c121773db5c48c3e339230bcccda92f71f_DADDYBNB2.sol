...
contract DADDYBNB2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Daddy Proof Of Degen";
    string private _symbol = "DADDYBNB2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x844440c86162E56ea81fC13571C675868C7270a0); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x798f4c0340a72bf4D14BDDf4d4ec2B4b78bb9D69); // Development Address
