...
contract Testceo is Context, IERC20, Ownable {
    ...
    string private _name = "Testceo";
    string private _symbol = "Testceo";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**18 * 10**18;
