...
/**
⚔️STEALTH LAUNCH SOON⚔️

⚙️ONEPIECE NETWORK

ONE PIECE NETWORK Protocol V2 is a community focused DeFi token that forms part of the expanding Onepiece Network ecosystem.

▀▄▀▄ 𝗣𝗥𝗢𝗝𝗘𝗖𝗧𝗦 ▄▀▄▀

⚙️ 𝙊𝙣𝙚 𝙋𝙞𝙚𝙘𝙚 𝙎𝙬𝙖𝙥
⚙️ 𝙊𝙣𝙚 𝙋𝙞𝙚𝙘𝙚 𝙎𝙩𝙖𝙠𝙞𝙣𝙜
⚙️ 𝙊𝙣𝙚 𝙋𝙞𝙚𝙘𝙚 𝙉𝙁𝙏 𝘾𝙡𝙪𝙗

⚙️𝙏𝙤𝙠𝙚𝙣𝙤𝙢𝙞𝙘𝙨:

𝙉𝙖𝙢𝙚: One Piece Network
𝙎𝙮𝙢𝙗𝙤𝙡: OPNET
...
🔩Website: https://onepiecenetwork.com
🔩Telegram: https://t.me/onepiece_network
🔩Twitter: https://mobile.twitter.com/piece_network
*/
...
/* Token contract */
contract  OnePieceNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xF4C5bD06eC7ddFD5B5Ad25704a3675CeC436200d;
    ...
    // Name and symbol
    string constant _name = "One Piece Network";
    string constant _symbol = "OPNET";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 1000; // ONE PIECE NETWORK KILL ZERO 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 1000; // ONE PIECE NETWORK KILL ZERO 
    uint256 private _maxWalletToken = ( _totalSupply * 200 ) / 1000; // ONE PIECE NETWORK KILL ZERO
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF4C5bD06eC7ddFD5B5Ad25704a3675CeC436200d;
