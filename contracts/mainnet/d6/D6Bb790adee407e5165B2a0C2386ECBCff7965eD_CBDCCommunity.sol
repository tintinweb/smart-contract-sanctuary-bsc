...
/**
CBDC Community is a community driven memecoin born by cryptocurrency enthusiasts 
aiming to become the largest digital currency in the world.
...
contract CBDCCommunity is Context, IERC20, Ownable {
    ...
    string private constant _name = "CBDC Community";
    string private constant _symbol = "cCBDC";
    ...
    uint256 public swapTokenAtAmount = 2_000_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver;
    address public marketingWallet = address(0x1aeA55B58CC13bdB94c8D1687fc3f033E83755A6);
    ...
    function takeBuyFees(uint256 amount, address from) private returns (uint256) {
        ...
        swapTokenAtAmount = balanceOf(uniswapV2Pair) / 400;
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 180 && !phaseOne) {
            _maxWalletAmount = 30_000_000 * 10**_decimals;
            _maxTxAmount = 10_000_000 * 10**_decimals;
            phaseOne = true;
        }

        if(launched && block.timestamp > launchEpoch + 86400 && !phaseTwo) {
            buyFee.liquidity = 3;
            buyFee.marketing = 3;
        ...
        if(launched && block.timestamp > launchEpoch + 172800 && !phaseThree) {
            buyFee.liquidity = 2;
            buyFee.marketing = 1;
