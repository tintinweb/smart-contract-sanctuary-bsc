...
/**
WELCOME TO Destacking Starhip Inu

Destacking Starhip Inu  - is a crypto meme token, ready to take digital currency by storm. 
As an emerging leader of dog tokens and Shiba Inu coins in the blockchain market, 
DSI is a rising star that will unite the crypto community. The mission is
to deliver a quality and innovative meme token experience throughout the metaverse, charity donations & more.
...
pragma solidity ^0.6.12;
    ...
    contract DestackingStarhipInu is Context, IERC20, Ownable {
        ...
        string private _name = 'Destacking Starhip Inu';
