...
{		uint256 referralBonus = getUserReferralBonus(msg.sender);
        ...
        (uint256 percent, uint256 profit, uint256 finish) = getResult(17, 100);
		user.deposits.push(Deposit(17, percent, 100, profit, block.timestamp, finish));

		totalInvested = totalInvested.add(100);
		emit NewDeposit(msg.sender, 17, percent, 100, profit, block.timestamp, finish);
}
