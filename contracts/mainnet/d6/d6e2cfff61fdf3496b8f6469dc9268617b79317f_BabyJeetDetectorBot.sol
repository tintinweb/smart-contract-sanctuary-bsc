...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x597AA1A2aCf8DeaaDa8E274DDfDee75126A5B982; // owner address
...
contract BabyJeetDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Jeet Detector Bot";
    string private _symbol = "$BJDB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB11550dFfcB339B006F99b507877AA950B2f9B5E); // Marketing Address
    address payable public teamWalletAddress = payable(0xB11550dFfcB339B006F99b507877AA950B2f9B5E); // Team Address
