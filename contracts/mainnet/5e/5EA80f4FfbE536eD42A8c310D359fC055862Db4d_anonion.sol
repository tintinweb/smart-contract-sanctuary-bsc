...
contract anonion is ERC20 {
 ...
 string public constant name = "Anonion Protocol";
 string public constant symbol = "ANONION";
 uint public constant decimals = 8;
 uint public deadline = now + 70 * 1 days;
 uint public round2 = now + 30 * 1 days;
 uint public round1 = now + 60 * 1 days;
 
 uint256 public totalSupply = 500000000000000e8;
 ...
 address multisig = 0xAf720cbC2b6F79ad62841bC07a22a6f9E7ec46f9;
 ...
 constructor() public {
 uint256 teamFund = 500000000000000e8;
 owner = msg.sender;
