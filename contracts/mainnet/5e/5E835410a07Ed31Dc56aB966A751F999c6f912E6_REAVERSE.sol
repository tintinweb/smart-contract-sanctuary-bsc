...
//REAVERSE TOKEN 2022 - THE NEXT METAVERSE
//reaversecentre.com
...
abstract contract LockToken is Ownable {
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 RACA = IBEP20(0x12BB890508c125661E03b09EC06E404bc9289040); // Mainnet
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 1 RACA minimum auto send
...
contract REAVERSE is IBEP20, Ownable, LockToken {
    using SafeMath for uint256;

    string constant _name = "REAVERSE";
    string constant _symbol = "REAV";
    ...
    uint256 private _maxHold = _totalSupply;
    address public marketingFeeReceiver = 0xb3b1130A42C1bEFE8D39AA8B4518af4c668Ca9A4;
    address public developmentFeeReceiver = 0x4e45D957f3Bb03aE3f74F3D63e64E438f56938b2;

	address RACA = 0x12BB890508c125661E03b09EC06E404bc9289040; // Mainnet
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet
    ...
    uint256 totalFee = liquidityFee + reflectionFee + marketingFee + developmentFee + burnFee;
    ...
    event DevelopmentTransfer(bool status);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _developmentFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner() {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        developmentFee = _developmentFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_developmentFee).add(_burnFee);
        feeDenominator = _feeDenominator;
    }

    function setFeeReceivers(address _developmentFeeReciever, address _autoLiquidityReceiver, address _marketingFeeReceiver) public onlyOwner() {
        developmentFeeReceiver = _developmentFeeReciever;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            (bool developmentSuccess, ) = payable(developmentFeeReceiver).call{value: amountBNBDevelopment, gas: 30000}("");
            emit MarketTransfer(marketSuccess);
            emit DevelopmentTransfer(developmentSuccess);
