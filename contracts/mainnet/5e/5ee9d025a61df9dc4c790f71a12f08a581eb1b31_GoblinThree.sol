...
contract GoblinThree is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goblin 3.0";
    string private _symbol = "GOBLIN3";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xf9DaA4Af96c32b214b903765c74B4128774A3fFc);
