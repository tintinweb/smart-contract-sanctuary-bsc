...
contract MetaPokerClub is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 100000 * 18**decimals();
    uint256 public maxWalletLimit = 500000 * 18**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0xb5f950741D56a630A78a0Fd8BDd7F17505f9f9f7;
    address private devWallet = 0x3312E3Fd09307ef4F3a5B161c3FbF34837f50054;
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("Meta Poker Club", "MetaPoker") payable {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 10000, "Cannot set max wallet amount lower than 0.1%");
