...
contract BUSDRUN5 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1; 

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "busdrun5";
    string constant _symbol = "run5";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(msg.sender == 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1);
    }
