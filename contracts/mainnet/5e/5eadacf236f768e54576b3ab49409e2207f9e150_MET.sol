...
library PancakeLibrary {
   ...
   function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
    ...
    // fetches and sorts the reserves fo
}
...
contract MET is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xDa2d5cB4463c27d606015D82e1a89F491C15c692);
    address private devAddress = address(0x000000000000000000000000000000000000dEaD);
    address public foundAddress = address(0x9Ddb03Eb07f93D0952A7E87Cc6b628B34be1925C);
