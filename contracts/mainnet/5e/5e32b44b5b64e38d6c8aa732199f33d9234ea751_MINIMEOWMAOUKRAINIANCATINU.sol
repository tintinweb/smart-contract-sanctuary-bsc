...
contract MINIMEOWMAOUKRAINIANCATINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MINIMEOWMAOUKRAINIANCATINU";
    string constant _symbol = "MINIMEOWMAOUKRAINIANCATINU";
    ...
    uint256 public _walletMax = _totalSupply * 26 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x775C1fAFC0ddFC50bA9f1AA9A2f76a997847dC0F;
