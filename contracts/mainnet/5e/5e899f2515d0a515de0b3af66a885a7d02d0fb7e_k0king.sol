...
contract k0king is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "k0king";
    string private _symbol = "k0king";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9A52c3a177D48e834531EDC56BF6e1017eB0e7A);
    address payable public teamWalletAddress = payable(0xf8aeD09f98983f187814B70eBaf11Eb7cD497eE2);
    ...
    uint256 private _totalSupply =  10000000000000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   10000000000000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax =     10000000000000000000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1000000000000000000000000000000000 * 10**_decimals; 
