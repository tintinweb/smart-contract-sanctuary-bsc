...
contract DevisShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4E5EBdb9AcD21CDB9174926716eeE4EcAd225B89); 
    address payable public Wallet_Dev = payable(0xBFEE8Fd56E54Abf3E07440b6920D3d274960a90c);
    address payable public constant Wallet_Buyback = payable(0x4E5EBdb9AcD21CDB9174926716eeE4EcAd225B89); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Dev is Shiba"; 
    string private constant _symbol = unicode"$DIS";
