...
/**
Welcomeo to RUBY FLOKI, next communitiy driven moonshoot
 */
...
contract GorillaBoy is Context, IERC20, Ownable {
    ...
    string private _name = "RUBY FLOKI";
    ...
    uint256 public _buyBackSplit = 2;
    uint256 public _marketingSplit = 7;
    uint256 public _liquiditySplit = 2;
