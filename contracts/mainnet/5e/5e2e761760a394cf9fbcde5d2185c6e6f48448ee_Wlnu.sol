...
contract Wlnu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wlnu";
    string private _symbol = "$WI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00E5dfDe181f4B008d9EA612FA241f916F5a6874); // Marketing Address
    address payable public devWalletAddress = payable(0x639AF60eCb5334B817Cd3c5aeEd2B38733F0B48b); // Dev Address
