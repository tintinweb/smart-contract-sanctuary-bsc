...
contract BABYELIZABETHII is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Elizabeth II";
    string private _symbol = "ELIZABETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEB71EE8ADBB16923044e86adc6C98d8DdDE17638); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xf0C1c5c17d187719046DA8FfDf4283aD629f9381); // Development Address
