...
contract SHENHUA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SHENHUA";
    string private _symbol = "SHENHUA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x325CA07a861085A1D1e4d66ac4D28681b4Ce3843);
    address payable public liqWalletAddress = payable(0x325CA07a861085A1D1e4d66ac4D28681b4Ce3843);
