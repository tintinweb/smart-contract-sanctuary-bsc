...
contract MINIBABYDOGEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MinibabyDogeKing";
    string private _symbol = "MinibabyDogeKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d6c122bca5d5CF7B18aD7583676B090C81AfcF4);
    address payable public buyBackWalletAddress = payable(0x5842E96bD38A263916Ae1703C3bd9FAD41A64eaF); 
