...
contract DoTwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Do Twon";
    string private _symbol = "Do Twon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCb35c1a57dCFE8Ca60aC0351725823BAB9572265); 
