...
contract MKZ is MKZDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MKZTeam;
    address private CharityMKZ;
    ...
    string public override name = "MEKAZUKI";
    string public override symbol = "MKZ";
    ...
    constructor(uint totalSupplyValue, address MKZTeamAddress, address CharityMKZAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MKZTeam = MKZTeamAddress;
        CharityMKZ = CharityMKZAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MKZTeam] =  totalSupply * 4 / 100;
        balances[CharityMKZ] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MKZTeam pot
