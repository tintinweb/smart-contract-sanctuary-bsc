...
contract SHIBBRONZE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA BRONZE"; // Edit Name
    string constant _symbol = "SHIB BRONZE"; // Edit Symbol
