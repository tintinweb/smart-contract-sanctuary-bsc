...
/**
----------------------------------------------------------------------------------------------------------------
NAME: Baby SHIBA Burn XXX
TICKER: Baby SHIBA Burn XXX
...
contract BabySHIBABurn  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby SHIBA Burn XXX";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xA434a8E2E0719b62678120ce210ae69F396bbb21;
        marketingFeeReceiver = 0x3346FDA32213B33A6c3eCeDff7eA28e2b36C8CB3;
