...
/**
TELEGRAM : https://t.me/IkamijiruInu
*/
...
contract ikamijiruinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "IkamijiruInu"; // 
    string private constant _symbol = "$IKAMI"; //    
