...
contract KEMONO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbFEEF6BC2323D4dECd7a49cd551F6aEca17dde6C); 
    address payable public Wallet_Dev = payable(0x7bfef4B4556c803F8E0a135156364ea198930cc3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "KEMONO"; 
    string private constant _symbol = unicode"KEMONO";
