 ...
 *
 *
 * https://t.me/NuclearCatOfficial
 * website: https://t.me/NuclearCatOfficial
 * Twitter: https://twitter.com/NuclearCat15
 *
 * 
*/
...
contract NuclearCat is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xcDc3FF0bD87186aabD5502cCA4f97E44B135ba24; //Wallet with Gnosis MultiSign
    address public devWallet = 0xadE3Ac1C488cf8AB7B99725E6B136b0cF86664a0; //Wallet to make deploy
    address public operationWallet = 0xCDF2E5e306a368C732CAB14a1bBd6C5E11eD93A2; //Wallet to make the ATOMIC BOMB
    address public charityWallet = 0xcDc3FF0bD87186aabD5502cCA4f97E44B135ba24; // Dont going to be use on this project

    string private constant _name = "NuclearCat";
    string private constant _symbol = "Nuclear Cat";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 20) {
            require(to != pair, "Sells not allowed for first 20 blocks");
        }
