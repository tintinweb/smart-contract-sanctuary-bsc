...
contract GoldenTest is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeEFEA0b5ae3F63596E6De72a00678f02246e168F); 
    address payable public Wallet_Dev = payable(0x9b1f2dA9A9EFC670E1c0e00f7aeada840768Bd88);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "GoldenTest"; 
    string private constant _symbol = unicode"GTest"; 
    ...
    constructor () {
        ...
        _owner = 0xeEFEA0b5ae3F63596E6De72a00678f02246e168F;
    ...
    function set_MaxWallet (uint256 maxTxAmount, uint256 maxWalletToken) external {
    ...
    function Set_Tax_Percent (uint256 NEW_Marketing, uint256 NEW_Dev,uint256 NEW_Burn, uint256 NEW_AutoLP) external onlyOwner() {
        Percent_Marketing = NEW_Marketing;
        Percent_Dev = NEW_Dev;
        Percent_Burn = NEW_Burn;
        Percent_AutoLP = NEW_AutoLP;
    }
