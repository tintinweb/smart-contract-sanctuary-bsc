...
/**
ABENOMICS
TG : https://t.me/AbenomicsBSC

In order to honor Shinzo Abe for his economic policies which successfully bought Japan one step ahead, Dev decided to launch ABENOMICS token into BSC with mission to brings it further into the market. 
By having an experienced Dev & team, ABENOMICS will hold a fair launch & ensure the safety of our token for all our investors.
...
contract Abenomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "Abenomics"; // 
    string private constant _symbol = "Abenomics"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x190893e50a6094E15233Ff0163dC12bA9a5D7056;
