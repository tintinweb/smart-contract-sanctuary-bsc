...
/* 
	...
	*/
	...
	contract InfinityWarriors is Context, IBEP20, Ownable {
	    ...
	    uint256 public _numTokensSellToAddToLiquidity = 5 * 10**3 * 10**9;
	    uint256 public _maxWalletToken = 10 * 10**3 * 10**9; // Max Wallet: 10k (1%)
	    
	    IPancakeRouter02 public immutable pcsV2Router;
	    address public immutable pcsV2Pair;
	
	    string private _name = 'Infinity Warriors';
	    string private _symbol = 'Warriors';
