...
// SPDX-License-Identifier: MIT
/**
 * @title Xave Official PAA token
 * @author Xave Project
 * @notice BEP20 (ERC20) official PAA token
 * 
 *                          .:^~!7????JJJJJ???77!~^..                         
 *                     .:~7?J??7!~^:::.....:::^~!7????!~:.                    
 *                  :!?JJ7~:.  .:^^~!!!777!!!~^:..  .^~7??7~:                 
...
contract PAAXVC is Context, AccessControlEnumerable, ERC20Burnable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(uint256 initialSupply) ERC20("Xave PAAXVC Token", "PAAXVC") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "PAAXVC: must have minter role to mint");
        _mint(to, amount);
    }
