...
// CHANGE
contract EthogeV2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Ethoge V2";
    string constant _symbol = "EV2";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xFC248DA4f76280299008b4FdC68b1C1F049ab01a);
