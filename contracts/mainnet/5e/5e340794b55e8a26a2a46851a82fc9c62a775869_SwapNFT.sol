...
contract SwapNFT is Context, IBEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 1e7 * 10**9;
    uint256 public maxSellLimit = 1e7 * 10**9;
    uint256 public maxWalletLimit = 1e7 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 3;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x6827C97a26AF6D4fe7832145E31fb24A11ce9079;
    address public devWallet = 0x6827C97a26AF6D4fe7832145E31fb24A11ce9079;

    string private constant _name = "SwapNFT";
    string private constant _symbol = "SWAPNFT";
    ...
    Taxes public taxes = Taxes(1, 4, 1, 0);
    Taxes public sellTaxes = Taxes(1, 4, 1, 0);
