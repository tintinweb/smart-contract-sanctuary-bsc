...
contract Ownable {
    ...
    function authorize(address adr, bool _authorize) public authorized {
...
contract Rebase is Context, ERC20Detailed, Ownable {
    ...
    uint256 public firePitFee       = 20;   // 2%
    ...
    event AddLiquidity(uint256 amountToLiquify, uint256 amountETHLiquidity, uint256 lastAddLiquidityTime);

    constructor() ERC20Detailed("Rebase Finance", "RBS", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x1F2C03A848f9F70dd66a45FFC56cFb32a53D01c1;
        treasuryReceiver = 0x1BeFa4eA1D80fd83d7b9C730280d7085E74756FF; 
        insuranceFundReceiver = 0xd00710Da275f683D38C2892455993cC0D87f09C2;
        firePit = 0xa46dE37B5037bB29CfF9F8Af0B9Ab82956b431C2;
    ...
    function addLiquidity() internal swapping {
        ...
        emit AddLiquidity(amountToLiquify, amountETHLiquidity, _lastAddLiquidityTime);
    }
    ...
    function withdrawAllToTreasury() external swapping authorized {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Rebase token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setAutoSwapBack(bool _flag) external authorized {
        _autoSwapBack = _flag;
    }
    ...
    function rescueToken(address _token, address _to) external authorized {
