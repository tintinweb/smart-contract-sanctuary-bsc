...
contract token is ERC20 {
    ...
    string internal tokenName = "ChrisTmas";
    string internal tokenSymbol = "ChrisTmas";
    uint256 constant total  =  210000 * 10**18;
    address public marketAddress = address(0x36EB6886a5b5294F6512a4Beee5470Eb8652C835);
    uint256 buyFee = 10;
    uint256 sellFee = 970;
