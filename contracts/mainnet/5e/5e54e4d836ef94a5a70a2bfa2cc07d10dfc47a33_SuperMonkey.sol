...
abstract contract Auth {
    ...
    constructor(address _owner) {
        _owner =0x432CDdF90755a2C034c94d8590298D134590169f;
...
contract SuperMonkey is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SuperMonkey";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x432CDdF90755a2C034c94d8590298D134590169f;
        devFeeReceiver = 0x432CDdF90755a2C034c94d8590298D134590169f;
