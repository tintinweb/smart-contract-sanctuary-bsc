...
contract CZmas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x59A9cB720dAF9804C92CdC221B310Fb328FcC8A3); // Marketing Address
        
    address payable public teamAddress =
        payable(0xd40f176B7b2e5450e5f1Bf436523770DdD627818); // Team Address
        
    address payable public liquidityAddress =
        payable(0xd40f176B7b2e5450e5f1Bf436523770DdD627818); // Liquidity Address
    ...
    string private constant _name = "CZmas";
    string private constant _symbol = "CZmas";
