...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Project Galaxy';

    string constant public symbol = 'GAL';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 1626000000*10**uint256(decimals);
