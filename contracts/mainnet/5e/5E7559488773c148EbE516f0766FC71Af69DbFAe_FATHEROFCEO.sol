...
FATHER OF CEO! HIDDEN GEM.

Official Telegram: https://t.me/FatherOfCeoBSC
Official Website: https://fatherofceo.com/ 
...
contract FATHEROFCEO is Ownable, IBEP20 {
    ...
    string constant _name = "FATHER OF CEO";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x93B2f9595D21a17a00FAA89e0B0c8b0dE7166666;
    ...
    function setMaxHolderSize(uint256 maxWallPercent_base1000) external onlyOwner {
        ...
        _MaxWallet = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }
    ...
    function setMaxSell(uint256 maxTXPercentage_base1000) external onlyOwner {
        ...
        _MaxTx = (_totalSupply * maxTXPercentage_base1000 ) / 1000;
    }
