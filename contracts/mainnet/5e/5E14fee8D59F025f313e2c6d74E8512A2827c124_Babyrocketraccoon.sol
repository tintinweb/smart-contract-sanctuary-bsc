...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d133840e0E077d08934180425b528f5B546c717; // owner address
...
contract Babyrocketraccoon is Context, IERC20, Ownable {
    ...
    string private _name = "Bby Rocket Raccoon";
    string private _symbol = "BRC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x725e9a8D3a357b84C030B6a2B7A4B60751f973Ca); // Marketing Address
    address payable public teamWalletAddress = payable(0x725e9a8D3a357b84C030B6a2B7A4B60751f973Ca); // Team Address
