...
contract ANGELXRP   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Angel Xrp ";
    string private _symbol = " AXRP "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b15A0fF217D247FcDb52fBa8dDdB14855dA9aAc); 
