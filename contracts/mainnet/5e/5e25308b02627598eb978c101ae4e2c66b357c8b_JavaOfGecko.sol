...
/**
Welcome to The JAVA Of Gecko🔮 $JOFG is a PVP tournament based around futuristic characters within the Oracles,
 in which they go head to head in traditional knockout style, with the winner taking all. KYC and Audit - 
 Well known and Safu developer - Low taxes at just 3% - Low Hard Cap - Huge marketing push - All organic - 
 Targeting listings post launch
...
contract JavaOfGecko is IERC20 {
    ...
    string constant private _name = "Java Of Gecko";
    string constant private _symbol = "JOFG";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x89BB12697012835B2b6270E087Df5b9B53f1ddAe),
        development: payable(0xd75940ffdEfEbEC4CD8Cb6c8a4e93be5605d0228)
    });
