...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x56D8f9250A49b7edb4A3AD846DA4bA389CEc42c6); // Marketing Address
    ...
    uint256 private _totalSupply = 52 * 10**16 * 10**_decimals;
    uint256 public _maxTxAmount =  52 * 10**16 * 10**_decimals; 
    uint256 public _walletMax =  52 * 10**16 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap =  52 * 10**16 * 10**3; 
