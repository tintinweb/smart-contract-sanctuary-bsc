 ...
 * via msg.sender and msg.data, meta-transactions the account sending and
...
contract Elon01B is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 100 ; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 100 ; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 100 ; // 2% of supply
    ...
    string private constant _name = "Elon 0.1B";
    string private constant _symbol = "E0.1B";
