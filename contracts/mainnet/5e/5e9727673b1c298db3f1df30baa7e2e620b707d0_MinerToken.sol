...
contract MinerToken is AccessControl, IERC20 {
    ...
    constructor(address recipient, address router02, address usdt) {
        ...
        _mint(recipient, 1e8 * 10 ** decimals());

        _grantRole(DEFAULT_ADMIN_ROLE, 0x83319A8714815cC83FF224110aF4C10e1C72A11b);
        _grantRole(NEW_SHAREHOLDER_ROLE, 0x609411fCc4cd51067A74a1928226D40851b641E1);
        _grantRole(SET_ENV_ROLE, 0x83319A8714815cC83FF224110aF4C10e1C72A11b);
        _grantRole(SETTLEMENT_ROLE, 0x609411fCc4cd51067A74a1928226D40851b641E1);
        _grantRole(INCOME_ROLE, 0x609411fCc4cd51067A74a1928226D40851b641E1);
        ...
        _projectAddress = payable(0xd2AEa5357862d89e4E687606830C7c5cC99cdf6b);
        _foundationAddress = payable(0xFd8e99176267d8E6D0CeA8b4B856D8FA6697A3dC);
        _liquidityAddress = payable(0xD92311F2E8386868BE1254c99E8a85D8C18749C9);
    }
    ...
    function setPerSettlement(uint256 newPerSettlement) external onlyRole(SET_ENV_ROLE) {
        perSettlement = newPerSettlement;
    }
