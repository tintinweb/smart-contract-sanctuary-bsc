...
contract FriesDoge is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('SauerKrautDoge', 'SKD') {
        require(
            feeAccount != address(0),
            'SauerKrautDoge: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'SauerKrautDoge: incorrect fee percent');
        require(owner != address(0), 'SauerKrautDoge: incorrect owner address');
        require(mintToAddr != address(0), 'SauerKrautDoge: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'SauerKrautDoge: transfer from the zero address');
        require(recipient != address(0), 'SauerKrautDoge: transfer to the zero address');
