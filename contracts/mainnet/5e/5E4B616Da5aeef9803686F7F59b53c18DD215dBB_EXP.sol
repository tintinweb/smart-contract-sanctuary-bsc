...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB1Cc5D01424C40024aFb5c3700DfbC5D6D1810a1; // owner address
...
contract EXP is Context, IERC20, Ownable {
    ...
    string private _name = "Exactly Protocol Elon Tweet";
    string private _symbol = "EXP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB1Cc5D01424C40024aFb5c3700DfbC5D6D1810a1); // Marketing Address
    address payable public teamWalletAddress = payable(0xB1Cc5D01424C40024aFb5c3700DfbC5D6D1810a1); // Team Address
