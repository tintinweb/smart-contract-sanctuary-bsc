...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc9A5B9b69CE879A3F9cd9ACb1aDFD39B00778547; // owner address
...
contract FOREVER is Context, IERC20, Ownable {
    ...
    string private _name = "1234567890";
    string private _symbol = "$123";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xc9A5B9b69CE879A3F9cd9ACb1aDFD39B00778547); 
    address payable public teamWalletAddress = payable(0xc9A5B9b69CE879A3F9cd9ACb1aDFD39B00778547);
