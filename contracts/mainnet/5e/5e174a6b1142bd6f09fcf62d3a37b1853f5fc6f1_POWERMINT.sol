...
contract POWERMINT is IBEP20, Auth {
    ...
    string constant _name = "POWERMINT";
    string constant _symbol = "$PMINT";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 25 ) / 1000; // 2.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xB07a69fAf81067f5737620064339448427e01ba0;
        devFeeReceiver = 0x9d34b4751128F33f157bbed3E17D5C9B6D60694D;
