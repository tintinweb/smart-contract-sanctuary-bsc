...
/**
 * Pirates of the CariBNB (SPARROW)
 * Let's robb some BNB together with Black Pearl Captain!
 * Wherever we want to go, we'll go
 * 10% buy 10% sell tax
 *
 * https://t.me/PiratesOfBNB
 */
...
contract PiratesOfTheCariBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pirates of the CariBNB";
