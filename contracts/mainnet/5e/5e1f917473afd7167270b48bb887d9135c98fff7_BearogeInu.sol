...
/*
Bearoge Inu is here to conquer the meme market from the depths of crypto winter.
Many have tried before to capture the essence of the most memable bear in the world.
We are keeping this truly classic.
4% Tax, no dev fee.
All holders are encouraged to use their rewards to grow the project.
Let's make $BEAR a household name.
...
contract BearogeInu is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x9Af28799934c17b561781cf8F962093e333A7147;
