...
contract RiseofMarsBNB {
    ...
    uint256 private TAX = 16;           
    uint256 private MKT = 12;
    uint256 public MARKET_EGGS_DIVISOR = 5;
    uint256 public MARKET_EGGS_DIVISOR_SELL = 2;

    uint256 public MIN_INVEST_LIMIT = 0.05 * 1e18; /** 0.05 BNB  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 100 * 1e18; /** 200 BNB  **/
    ...
    struct User {
        ...
        uint256 farmerCompoundCount; //added to monitor Aliens consecutive compound without cap
    ...
    function SellLands() public{
        ...
        if(user.dailyCompoundBonus < COMPOUND_FOR_NO_TAX_WITHDRAWAL){
            //daily compound bonus count will not reset and Rewards will be deducted with 90% Mars tax.
...
// Early withdrawal Tax (Penalty) will be credited back to the contract
//https://t.me/riseofmars
