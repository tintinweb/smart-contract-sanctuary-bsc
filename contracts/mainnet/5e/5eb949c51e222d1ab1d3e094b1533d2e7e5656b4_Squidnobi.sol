...
/**
$SquidNobi is the most lovable Memecoin brought to earth by Squid and Nobita Lovers.
SquidNobi is a low tax gem on BSC space with only 2% tax.
Portal https://t.me/snapchatinubsc
*/
...
contract Squidnobi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x847998785e9d13364Ea1924Cc09C8E7ccE6855e4); 
    address payable public Wallet_Team = payable(0x847998785e9d13364Ea1924Cc09C8E7ccE6855e4);
    ...
    string private constant _name = "SQUID NOBI"; 
    string private constant _symbol = unicode"SQN"; 
    ...
    constructor () {
        ...
        _owner = 0x847998785e9d13364Ea1924Cc09C8E7ccE6855e4;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1A920206DdeADE9115D99bE606792110070831B7); // Testnet
