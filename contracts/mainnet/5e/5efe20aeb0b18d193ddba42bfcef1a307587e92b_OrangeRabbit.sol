...
contract OrangeRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OrangeRabbit";
    string private _symbol = "OrangeRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40B08a65660fEeE9443AEF613b62F93772469f4D);
    address payable public teamWalletAddress = payable(0x40B08a65660fEeE9443AEF613b62F93772469f4D);
