...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE5D96E7A093DFf8176b10488C34e8131BF3cd9d8;
...
contract VIRTUALNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _name = "VIRTUAL NETWORK"; // 
    string private constant _symbol = "VNW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xE5D96E7A093DFf8176b10488C34e8131BF3cd9d8);
