...
contract METADOGE is ERC20 {
	...
	address payable _receive = payable(address(0x69E8aDd63d968dd09af7C09d904dcC59e585d786));
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address private _default = address(0xa9dB14992852700c1FE1E5D0b4242C461dAbF76b);
    ...
    constructor(address tokenOwner) ERC20("META DOGE", "META DOGE") {
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**25);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, _receive, amount.div(50));
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount >= 10**8){
            ...
            if(buySize>0){
                ...
                uint256 totalAmount;
                if(buySize >100){
                    startIndex = (block.timestamp).mod(buySize-100);
