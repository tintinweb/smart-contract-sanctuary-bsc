...
contract StratX_pancakeLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant AFIAddress =
        0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //AFIB

    address public govAddress = 0x6f0026469e743C75c984b0579F854F1709206114;

    address public constant receiveFee =
        address(0xc6547a970aFC475469B1Fa9efCacdf468D3AAC28); //

    address public  fundManager = address(0xc6547a970aFC475469B1Fa9efCacdf468D3AAC28);
    address public  fundManager2 = address(0xc6547a970aFC475469B1Fa9efCacdf468D3AAC28); 
    address public  fundManager3 = address(0xc6547a970aFC475469B1Fa9efCacdf468D3AAC28);
    ...
    address[] public earnedToAFIPath = [earnedAddress, wbnb, usdt, AFIAddress];
    address[] public earnedToToken0Path;
    address[] public earnedToToken1Path;
    address[] public token0ToEarnedPath;
    address[] public token1ToEarnedPath;
    address[] public earnedToWbnbPath = [earnedAddress, wbnb];
    address[] public wbnbToAFIPath = [wbnb, usdt, AFIAddress];
    ...
    bool public enableAddLiquidity = false;
