...
/* Token contract */
contract CZBabyDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x783258B7e0Ca9d9b6C63f3A96C74CDd86262C0Da; 
    ...
    // Name and symbol
    string constant _name = "CZ BABY DOGE";
    string constant _symbol = "CZBDOGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x783258B7e0Ca9d9b6C63f3A96C74CDd86262C0Da;  
