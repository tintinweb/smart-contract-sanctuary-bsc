...
contract Cochillo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chocillo";
    string private _symbol = "CHOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x600F54f24D6456208E0dFc776D1061254CCdC868);
    address payable public teamWalletAddress = payable(0x600F54f24D6456208E0dFc776D1061254CCdC868);
