...
/*
This is the official contract of iBull Shiba Token.

🐂 iBullShiba 🐂

iBullShiba is a defi community meme token in the metaverse 
which ensures greater profit to its holders!

Telegram:   https://t.me/iBullShiba

Stealth Launch:  October 23, 2022m 6:00pm UTC
*/
...
contract iBullShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "iBull Shiba"; //
    string private constant _symbol = "iBULL"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 8;
    address private _marketingWallet = 0x4b678102c51B39C3A810c25D1b310b92aE49b419;
