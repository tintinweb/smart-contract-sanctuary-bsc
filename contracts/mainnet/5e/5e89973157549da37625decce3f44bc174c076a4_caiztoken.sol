...
contract caiztoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe0905C33D89bBef38EC49Be745207b66cb575B66); //nice
    address payable public charityAddress = payable(0xe0905C33D89bBef38EC49Be745207b66cb575B66); //nice
    ...
    string private _name = "Caiz Token"; //CC"; //CC
    string private _symbol = "CAI";  //nice
