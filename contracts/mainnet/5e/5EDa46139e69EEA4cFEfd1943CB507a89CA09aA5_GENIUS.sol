...
contract GENIUS  is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEV IS GENIUS"; // 
    string private constant _symbol = "$COMUNITY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xbe20A0B81Fc26Fd8cbaa956eD57490B8125f15b1;
