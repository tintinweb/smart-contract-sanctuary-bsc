...
contract LineStaking {
    ...
    uint256[3] public Duration = [14 days, 30 days, 60 days];
    uint256[3] public Bonus = [156, 833, 8333];
    ...
    constructor() {
        owner = payable(0xAe665600D19956484050BfB233906E599Bb80c78);
        stakeToken = IERC20(0x000923f6C78D301A1044923EeF02C5b0AAF305B4);
        unstakePercent = 1500;
