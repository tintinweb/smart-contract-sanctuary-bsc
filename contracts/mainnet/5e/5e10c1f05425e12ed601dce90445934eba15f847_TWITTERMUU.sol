...
/**
Telegram : https://t.me/twittermuu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbA3d07B347A110e6F5E253486Ae92ECF64AE2332; // owner address
...
contract TWITTERMUU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWITTER MUU";
    string private _symbol = "$TWIMUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbA3d07B347A110e6F5E253486Ae92ECF64AE2332); // Marketing Address
    address payable public teamWalletAddress = payable(0xbA3d07B347A110e6F5E253486Ae92ECF64AE2332); // Team Address
