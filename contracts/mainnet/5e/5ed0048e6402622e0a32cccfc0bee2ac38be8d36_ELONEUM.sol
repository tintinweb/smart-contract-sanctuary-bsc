...
/**
Eloneum coin is here to bring unlimited X's to you and your pocket!
A token aimed to update all investors all the news regarding elon musk!
His tweets, purchases, and all news regarding him!

Know everything about the father of BSC Memes!
Know Elonuem
...
contract ELONEUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELONEUM"; // 
    string private constant _symbol = "ELONEUM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xf9eB146635FD3b639AEbAc0cD9983853B87047B3;
