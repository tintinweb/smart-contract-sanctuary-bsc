...
// File: contracts/Oki.sol

pragma solidity ^0.8.12;

contract OkiToken is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        maxSellAmount = totalSupply().mul(100).div(100000); // 0.5% of the supply
        maxBuyAmount = totalSupply().mul(100).div(100000);// 1% of the supply
        maxWalletAmount = totalSupply().mul(10).div(1000); // 1.5% of the supply
