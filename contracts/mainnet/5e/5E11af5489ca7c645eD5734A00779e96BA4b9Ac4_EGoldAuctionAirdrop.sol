...
contract EGoldAuctionAirdrop is AccessControl ,ReentrancyGuard  {
    ...
    modifier isUser( ){
        require(msg.sender.isContract() == false ,"EGold Auction : NOT USER");
        _;
    }
    ...
    //Core Start
    function Claim ( ) external isActive  nonReentrant isUser {
