...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintOneWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://test-1256662691.cos.ap-chengdu.myqcloud.com/json/11");
        return true;
    }
    function mintTwoWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://test-1256662691.cos.ap-chengdu.myqcloud.com/json/12");
        return true;
    }
    function mintThreeWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://test-1256662691.cos.ap-chengdu.myqcloud.com/json/13");
        return true;
    }
    function mintFourWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://test-1256662691.cos.ap-chengdu.myqcloud.com/json/14");
        return true;
    }
}
...
contract SEPSTRC721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("SEPS NFT", "SEPSNFT") {
