...
// https://t.me/TrueBurnGlobal
// https://TrueBurn.io
// https://www.reddit.com/r/TrueBurnGlobal
// https://trueburnglobal.medium.com
// https://twitter.com/TrueBurnGlobal
// https://instagram.com/TrueBurnGlobal
// https://facebook.com/TrueBurnGlobal
// https://github.com/TrueBurnGlobal
...
contract TrueBurn is IBEP20, Ownable {
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0xA7380bE4532956E521aE30d36Bf7bAB844e02dBd,
        Events: 0x183e0E92310Ff2e50dcc4eDB03c3F554E3ed515D,
        PublicRelations: 0x825f2BA45729B4221fFD7809195E690bf51Da241
    });
...
///// AUTHORIZED FUNCTIONS /////
    ...
    //independently set whether wallet is exempt from limits
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newTeam + newLiquidity + newEvents + newPublicRelations + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newTeam, newLiquidity, newEvents, newPublicRelations, newRewards);
    }
...
///// OWNER FUNCTIONS /////  
    ...
    function setEventsWallet(address payable addr) external onlyOwner {
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Team, uint256 Events, uint256 PublicRelations) {
        return (buybackBalance, TeamBalance, EventsBalance, PublicRelationsBalance);
    }
