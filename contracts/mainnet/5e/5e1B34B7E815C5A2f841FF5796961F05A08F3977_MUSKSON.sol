...
contract Ownable is Context {
    address private _owner = 0x03cEDa6135f00fEd92B6D8200ac853D1e035D6C6;
...
contract MUSKSON is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xa73d33BA679d0513822CBC2E7BBFC0ec029b96A4); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "MUSK SON"; // token name
    string private _symbol = "MUSKSON"; // token symbol
