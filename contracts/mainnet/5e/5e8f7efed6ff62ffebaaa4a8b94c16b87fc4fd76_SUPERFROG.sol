...
contract SUPERFROG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPERFROG";
    string private _symbol = "SUPERFROG";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD9Eb6b3c9747ACFc98A43Ba2f3e4c4630F51fa3A); // Marketing Address
    address payable public teamWalletAddress = payable(0xD9Eb6b3c9747ACFc98A43Ba2f3e4c4630F51fa3A); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xD9Eb6b3c9747ACFc98A43Ba2f3e4c4630F51fa3A),
            block.timestamp
        );
    }
