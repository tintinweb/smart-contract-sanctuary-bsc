...
contract ahegao is Ownable, IBEP20 {
    ...
    string constant _name = "Ahegao";
    string constant _symbol = "AHEGAO";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xD377B2a977b16a66f78fE1732f67B43a68172492;
        marketingWallet = 0xABdD9d0342D2129c52c5571630Ff0e7007150Dc5;
        charityWallet = 0x5E54745077B718E8A6B8b1D582Ae2B6BbF472092;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(CharityFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess2,) = payable(charityWallet).call{value : amountBNBCharity, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newcharityFee, uint256 extraSellFee) external onlyOwner {
