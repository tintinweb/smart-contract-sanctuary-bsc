...
contract PayCoinSolutions is Context, IERC20, Ownable {
    ...
    string private constant _name   = "Pspay";
    
    string private constant _symbol = "Pspay";

    uint256 private _tTotal = 60000000000 * 10**_decimals;        // Supply do Token = 60 billions
...
//       IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0xcfd0463Ff1112dFef4c1a1959A95B0DF1556E8e2); // wallet that accumulates bnb
