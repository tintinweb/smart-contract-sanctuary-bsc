...
contract ratboy is Context, IERC20, Ownable {
    ...
    string private constant _name = " Proof OF RatBoy"; // 
    string private constant _symbol = " RATBOY 2.O"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xfDEea39a7F733358637a7E27b00044123851d764;
