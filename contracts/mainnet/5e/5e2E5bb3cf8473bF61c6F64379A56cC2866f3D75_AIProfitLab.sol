...
//Ai Profit Lab all-in-one tools for trading
//Renounced contract, 100% liquidity burnt at launch

//Telegram: https://t.me/AIProfitLABBSC
...
contract AIProfitLab is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "AI Profit Lab";
    string private _symbol = unicode"AIPL";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x23f371AFb1f1AD34a0E261E369b51eD34DAB19a7));
        marketingWallet = payable(address(0xb55cb27B28e2cbB13bcf7709a6621fa4f7556020));
