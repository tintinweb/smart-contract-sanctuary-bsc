...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcc5D1A79dF3ACD408C472CeC61cCF2b3436f073b; // owner address
...
contract Cameleon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cameleon";
    string private _symbol = "Cameleon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcc5D1A79dF3ACD408C472CeC61cCF2b3436f073b); // Marketing Address
    address payable public teamWalletAddress = payable(0xcc5D1A79dF3ACD408C472CeC61cCF2b3436f073b); // Team Address
