...
contract ETFD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdc952038Ed4d43f5C24528ffF53E4413ee377E36); // Marketing Address
    ...
    string private _name = "ElonTateFlokiDoge ";
    string private _symbol = "ETFD";
    ...
    uint256 private minimumTokensBeforeSwap = 500000000 * 10**6 * 10**9; 
