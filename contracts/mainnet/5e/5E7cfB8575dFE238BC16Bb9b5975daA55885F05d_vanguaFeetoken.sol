...
contract vanguaFeetoken is ERC20 , ERC20Burnable, ERC20Permit, ERC20Snapshot, Ownable, Pausable, ERC20Votes, ERC20FlashMint{
    constructor() ERC20("vanguaFee token", "VFT") ERC20Permit("${name}") {
