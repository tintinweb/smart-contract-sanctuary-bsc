...
/* Token contract */
contract BinanceChristmas is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BinanceChristmas";
    string constant _symbol = "BinanceChristmas";
  ...
  // Sell fees
    ...
    constructor () Auth(msg.sender) {
        ...
        isTimelockExempt[development] = true;
    ...
    function swapBack() internal swapping {
        ...
        (bool successdevelopment, /* bytes memory data */) = payable(development).call{value: amountBNBdevelopment, gas: 30000}(""); 
