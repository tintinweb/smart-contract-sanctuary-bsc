...
contract DarK is IERC20, Ownable {
    ...
    address _marktAddress = address(0x33Ae0aB5E7659C46ba10b1Af8558A773091E1358);
    address public uniswapV2Pair;
    IERC20 pair;
    uint256 public startTime;
    address[] buyUser;
    mapping(address => bool) public havePush;
    uint256 public _destroyRate = 3;
    uint256 public _lpRate = 25;
    uint256 public _fundRate = 15;
    ...
    constructor(address tokenOwner) {
        ...
        _decimals = 18;
        _tTotal = 10**24;
        _destroyMaxAmount = _tTotal.sub(20000 * 10**18);
