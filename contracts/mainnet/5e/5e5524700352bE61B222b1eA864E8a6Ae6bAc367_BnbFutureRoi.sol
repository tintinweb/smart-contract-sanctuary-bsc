...
contract BnbFutureRoi is Context, Ownable {
  ...
  mapping(address => uint256) public myWithdrawValue_;
    ...
    uint256[] planAllDays = [1000, 150, 80, 30];
    uint256[] planMini = [1e16, 2e16, 5e16, 1e17];
  ...
  constructor() public {
    ...
    function buy(uint256 _plan) public payable returns (bool) {
