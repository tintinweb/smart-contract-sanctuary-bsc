...
/**
 √-1 2^3 ∑ Π and It Was Delicious! (I Ate Some Pie and It Was Delicious!)

 https://t.me/iatesomepie
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 noReflect = IBEP20(0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = noReflect.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(noReflect);
        ...
        uint256 amount = noReflect.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            noReflect.transfer(shareholder, amount);
...
contract IAteSomePieandItWasDelicious is IBEP20, Auth {
    using SafeMath for uint256;

    address noReflect = 0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "1 2^3 Phi and It Was Delicious!";
    string constant _symbol = "I Ate Some Pie and It Was Delicious!";
