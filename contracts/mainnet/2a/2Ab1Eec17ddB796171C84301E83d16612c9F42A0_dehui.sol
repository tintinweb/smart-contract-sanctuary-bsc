...
contract dehui is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "dehui";
    string private _symbol = "DEHUI";
   ...
   function notuse(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
	...
	function holderreceive(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function nofee(address sender, address recipient, uint256 amount) private { 
      if (amount > 0) {
