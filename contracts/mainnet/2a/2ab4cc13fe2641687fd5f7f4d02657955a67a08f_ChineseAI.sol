...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96e238fb280aD14b61dF468Ef0946D0e36521120; 
...
contract ChineseAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chinese AI";
    string private _symbol = "CAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96e238fb280aD14b61dF468Ef0946D0e36521120); // 
    address payable public teamWalletAddress = payable(0x96e238fb280aD14b61dF468Ef0946D0e36521120); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x96e238fb280aD14b61dF468Ef0946D0e36521120)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x96e238fb280aD14b61dF468Ef0946D0e36521120),removeRandom);
}}