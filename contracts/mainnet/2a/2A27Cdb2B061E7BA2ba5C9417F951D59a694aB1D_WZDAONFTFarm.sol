...
contract WZDAONFTFarm is Ownable,ERC721Holder {
    ...
    uint256 constant REWARDS_DAYS = 9999 days;
    ...
    function rewardPerToken() public view returns (uint256) {
        ...
        return
            rewardPerTokenStored +
                (((lastTimeRewardApplicable() - lastUpdateTime) * getRewardRate()) / totalSupply);
    }
    ...
    function getRewardRate() public view returns (uint256) {
        return avgRewardRate.mul(totalSupply);
    }

    function getRewardForDuration() external view returns (uint256) {
        return getRewardRate() * REWARDS_DAYS;
    }
        ...
        updateReward(address(0))
    {
        ...
        periodFinish = periodFinish.add(REWARDS_DAYS);
    }
