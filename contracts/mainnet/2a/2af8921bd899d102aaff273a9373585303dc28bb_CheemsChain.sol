...
contract CheemsChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheems Chain";
    string private _symbol = "CC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x94630d52c2fa0E9E1e0cd11b3E78178D5Fe3dB34);
