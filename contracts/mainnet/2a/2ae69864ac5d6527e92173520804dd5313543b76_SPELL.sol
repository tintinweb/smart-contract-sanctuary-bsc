...
contract SPELL is SPELLDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SPELLTeam;
    address private CharitySPELL;
    ...
    string public override name = "SPELL";
    string public override symbol = "SPELL";
    ...
    constructor(uint totalSupplyValue, address SPELLTeamAddress, address CharitySPELLAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SPELLTeam = SPELLTeamAddress;
        CharitySPELL = CharitySPELLAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SPELLTeam] =  totalSupply * 4 / 100;
        balances[CharitySPELL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SPELLTeam pot
