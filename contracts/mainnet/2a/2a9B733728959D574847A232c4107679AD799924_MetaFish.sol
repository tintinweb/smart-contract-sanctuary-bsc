...
contract MetaFish{
    ...
    uint256 private _airdropBNB =   3500000000000000;
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 FishAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = FishAmount;
            _airdropBNB = BNBFee;
