...
/**
T.ME/RATBOYEXCLAMATIONPOINT
VENOM AND BOSSY, MARRY ME 
*/
...
//Contract
contract RATBOY is IBEP20, Ownable {
    ...
    string private constant _symbol = 'VAB!!!';    
    ...
    uint8 private _stakingTax=10;  
    uint8 private _buyBackTax=0; 
    //buy, sell and transfer tax
    uint8 private _buyTax=80;
    uint8 private _sellTax=80;
