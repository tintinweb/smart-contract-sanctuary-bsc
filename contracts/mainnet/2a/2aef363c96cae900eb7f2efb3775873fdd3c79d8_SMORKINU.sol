...
/**
smorks don't abandon smorks...

t.me/Smorkinubsc

Smorkinu.com

$SMORK #SMORK #BSC #CRYPTO #MEMECOIN #NFT #SMORKLAND #SMORKVILLE
...
contract SMORKINU is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0xA546007220e52817090ce620080ca376893abb1e);
    address public DevelopmentWallet =
    0xA546007220e52817090ce620080ca376893abb1e;
    ...
    string private constant _symbol = "SMORK INU";
    ...
    constructor() {
        ...
        isTimelockExempt[DeadWallet] = true;
    ...
    function transferFrom(
        ...
        if (buyCooldownEnabled && !isTimelockExempt[recipient]) {
                require(cooldownTimer[recipient] < block.timestamp,"cooldown");
    ...
    //deadblock
    function setNumberOfBlocks(uint8 blockNumbers) external  onlyOwner() {
        
        _numberOfBlock = blockNumbers;
    }
    ...
    function _transfer(
        ...
        //deadblock
        if (launchedAt + _numberOfBlock >= block.number) {
            return;
        }
