...
contract KULOU is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "KULOU";
    string _symbol = "KULOU";
    uint8 _decimals = 9;
    ...
    function shardholder(address holder) external onlyOwner {
    ...
    function removefee(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function clearance(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
