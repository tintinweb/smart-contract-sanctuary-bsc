...
contract BNBGenius {
	...
	uint256 constant public INVEST_MIN_AMOUNTPL2 = 0.1 ether;
	uint256[] public REFERRAL_PERCENTS = [100];
	uint256[] public REFERRAL_PERCENTSPL2 = [150];
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        require(msg.value >= INVEST_MIN_AMOUNTPL2);
