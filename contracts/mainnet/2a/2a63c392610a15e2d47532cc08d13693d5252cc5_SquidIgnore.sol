...
contract SquidIgnore is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Ignore";
    string private constant _symbol = "SquidIgnore";
