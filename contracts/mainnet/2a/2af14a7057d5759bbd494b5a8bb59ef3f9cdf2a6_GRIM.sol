...
contract GRIM is GRIMDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GRIMTeam;
    address private CharityGRIM;
    ...
    string public override name = "Grim Reaper";
    string public override symbol = "GRIM";
    ...
    constructor(uint totalSupplyValue, address GRIMTeamAddress, address CharityGRIMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GRIMTeam = GRIMTeamAddress;
        CharityGRIM = CharityGRIMAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GRIMTeam] =  totalSupply * 4 / 100;
        balances[CharityGRIM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GRIMTeam pot
