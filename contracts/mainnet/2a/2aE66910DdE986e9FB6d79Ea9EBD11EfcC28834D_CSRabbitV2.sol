...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    address public marketAddr = 0x1fa0cE16e0FD2b843Ec5e34282Bcd345d3a163Ac;
...
contract CSRabbitV2 is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 1000000000000000 * 1e18;
    uint256 public _maxHavAmount = 1000000000000000 * 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;

    constructor() ERC20("CS Rabbit Rebirth V2", "CSrabbit", 18) DividendFee(1e17, true, USDT, 2) {
