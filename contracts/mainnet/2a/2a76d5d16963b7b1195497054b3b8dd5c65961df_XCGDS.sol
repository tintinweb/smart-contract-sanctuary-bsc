...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc6CDc46690844d8898de3E290db3e4c694171FC0; 
...
contract XCGDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XCGDS";
    string private _symbol = "$XCGDS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2EEddb7281A9B78501F58E6F354d720242FCaF12); 
    address payable public teamWalletAddress = payable(0x2EEddb7281A9B78501F58E6F354d720242FCaF12); 
