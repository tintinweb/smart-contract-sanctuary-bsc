...
contract TweetRocket is IBEP20, Auth {
    
    using SafeMath for uint256;

    string _name = "BTCKing";
    string _symbol = "BTC";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address feeAddress = 0x6fBC3abA8D8c80022bbBE40F5a08270b57822832;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    function changeName(string memory newName) external authorized {
        _name = newName;
    }

    function changeSymbol(string memory newSymbol) external authorized {
        _symbol = newSymbol;
    }


    function changeFeeAddress(address newFeeAddress) external authorized {
