...
Telegram://https://t.me/nanokingbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaaeBb289adBE49e46db68c4638Dd12baD502D85B;
...
contract NANOKING is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xaaeBb289adBE49e46db68c4638Dd12baD502D85B);
    address payable private Wallet_Burn = payable(0xaaeBb289adBE49e46db68c4638Dd12baD502D85B); 
    address payable private Wallet_zero = payable(0xaaeBb289adBE49e46db68c4638Dd12baD502D85B); 
    ...
    */
    ...
    string private _name = "Nano King"; 
    string private _symbol = "NKING";  
