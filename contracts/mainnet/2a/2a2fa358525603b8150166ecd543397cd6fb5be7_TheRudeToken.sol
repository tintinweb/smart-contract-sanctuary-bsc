...
/*
TheRudeToken
With its potential for viral growth and popularity, The Rude Token is set to be a trendsetter among the crypto community.
The Rude Token - the ultimate meme-inspired cryptocurrency
...
contract TheRudeToken is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'TheRudeToken';
    string private _symbol = '$RUDE';
