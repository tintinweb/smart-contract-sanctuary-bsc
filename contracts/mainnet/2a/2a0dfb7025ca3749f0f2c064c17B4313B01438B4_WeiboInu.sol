...
Weibo Inu Is a Token Meme Coin Binance Smart Chain Network With Hype Name
...
contract WeiboInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd01bF4Ad456d5371fa799a86C9507977e7B6B616); 
    address payable public Wallet_Team = payable(0xd01bF4Ad456d5371fa799a86C9507977e7B6B616);
    ...
    string private constant _name = "WeiboInu"; 
    string private constant _symbol = unicode"WINU微博犬"; 
    ...
    constructor () {
        ...
        _owner = 0xd01bF4Ad456d5371fa799a86C9507977e7B6B616;
