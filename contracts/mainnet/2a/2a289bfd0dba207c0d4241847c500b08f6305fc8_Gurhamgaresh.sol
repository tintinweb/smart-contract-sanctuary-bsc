...
contract Gurhamgaresh is ERC20Detailed, Ownable {
    ...
    string public _name = "Bu";
    string public _symbol = "BR";
    ...
    uint256 public maxTxAmountBuy = _totalSupply / 500; // totalsupply divided with 20
    uint256 public maxTxAmountSell = _totalSupply / 500; // 
    uint256 public maxWalletAmount = _totalSupply / 500; // 
    // MAPPING
    ...
    constructor() ERC20Detailed("Buresh", "BE", uint8(DECIMALS)) Ownable() {
