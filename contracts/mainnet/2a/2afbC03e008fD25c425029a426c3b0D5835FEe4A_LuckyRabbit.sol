...
contract LuckyRabbit is CTToken {
    constructor() CTToken(
        ...
        unicode"LuckyRabbit",//Name
        unicode"LuckyRabbit",//Symbol
        9,//Decimals
        100000000,//Supply
        address(0xa7fB30D92006863a9902E24b2e7CeDfCFade0cE5),//FundAddress
        address(0xEdd933d328504194372b843f09BCaf7AA8eE4d1b))//SSAddress
    {
    }
}