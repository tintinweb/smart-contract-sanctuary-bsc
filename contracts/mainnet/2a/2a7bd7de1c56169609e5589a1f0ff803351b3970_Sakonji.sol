...
contract Sakonji is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe3B7515990393346eC081e0b0F3A67d5374cE00b); 
    address payable public Wallet_Dev = payable(0xE00F3CcAdb47D7446e9bf6d5F9B580bb0591b5a3);
    ...
    string private constant _name = "Sakonji Inu"; 
    string private constant _symbol = unicode"SAKONJI"; 
    ...
    constructor () {
        ...
        _owner = 0xE00F3CcAdb47D7446e9bf6d5F9B580bb0591b5a3;
