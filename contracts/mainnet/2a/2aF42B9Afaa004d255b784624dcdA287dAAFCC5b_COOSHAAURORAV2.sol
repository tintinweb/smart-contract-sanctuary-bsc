...
contract COOSHAAURORAV2 is IERC20, Context, Ownable {
    ...
    address private Coosha_Aurora_Wallet = 0x93B2f9595D21a17a00FAA89e0B0c8b0dE7166666;
    address private Coosha_Team_Wallet = 0x1E7D723F72829cAc2FF1DE660604c09041c17777;
    ...
    Taxes public sellTaxes = Taxes(0, 25, 10, 10);
    Taxes public taxes = Taxes(0, 25, 10, 10);
