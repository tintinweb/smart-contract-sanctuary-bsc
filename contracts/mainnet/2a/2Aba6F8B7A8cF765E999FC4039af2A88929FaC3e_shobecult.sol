...
contract shobecult is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Shobe Cult";
    string constant _symbol = "SHC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 11) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *11) / 100; 
