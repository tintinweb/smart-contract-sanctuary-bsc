...
Telegram: https://t.me/BabySquidGame3
...
contract BabySquidGame3 is Context, IERC20, Ownable {
    ...
    string private _name = "BABY SQUID GAME 3.0";
    string private _symbol = "BSQUID3";
    ...
    address payable public marketingWallet = payable(0xe8600a058d7A29974405f06daeC0f56925744d2A);
    address payable public devWallet = payable(0xe8600a058d7A29974405f06daeC0f56925744d2A);
