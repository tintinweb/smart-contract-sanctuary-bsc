...
/*
    $GROW $CYC GONNA MAKE MILLIONAIRES WATCH
...
contract CatYachtGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "CatYachtGrow";
    string private constant _symbol = "CYCGROW";
