...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x78f966b45619290478d8ec06dc24440752831857e909e3bc097b1457c6e03eba is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash =0x78f966b45619290478d8ec06dc24440752831857e909e3bc097b1457c6e03eba ;
