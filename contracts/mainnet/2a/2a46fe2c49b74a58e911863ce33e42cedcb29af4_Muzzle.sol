...
/**
Muzzle
Official Fan Token Of Muzzle

https://jidokamuzzle.com/
💬 Community : https://t.me/Muzzle
...
contract Muzzle is MuzzleDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MuzzleTeam;
    address private CharityMuzzle;
    ...
    string public override name = "Muzzle";
    string public override symbol = "Muzzle";
    ...
    constructor(uint totalSupplyValue, address MuzzleTeamAddress, address CharityMuzzleAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MuzzleTeam = MuzzleTeamAddress;
        CharityMuzzle = CharityMuzzleAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MuzzleTeam] =  totalSupply * 4 / 100;
        balances[CharityMuzzle] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MuzzleTeam pot
