...
contract Ducker is IERC20, Ownable {
    ...
    uint256 internal whitelistTime;
    ...
    constructor() Ownable(msg.sender) {
        chainRewards = crossChain(0xA0CA41Fd61B760A221deDf620126E1831B142C32);
    ...
    function checkTradingAllowed(address sender, address recipient) internal {
        ...
        if(whitelistAllowed && tradingAllowed){require(isFeeExempt[sender].whitelist || isFeeExempt[recipient].whitelist || isFeeExempt[sender].feeExempt || isFeeExempt[recipient].feeExempt, "ERC20: Whitelist Period");}
    }
