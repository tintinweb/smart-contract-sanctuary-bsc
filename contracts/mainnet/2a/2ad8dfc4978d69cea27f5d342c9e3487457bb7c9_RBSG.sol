...
contract RBSG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ratboy SquidGrow";
    string private _symbol = "RBSG";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x3682b034d9CAE0C952AA6FA61Faa3b8b0AdF86C1); // Team Address
