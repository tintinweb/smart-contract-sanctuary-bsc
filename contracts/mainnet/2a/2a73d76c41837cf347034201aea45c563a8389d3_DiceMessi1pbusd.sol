...
contract DiceMessi1pbusd is VRFConsumerBaseV2, ReentrancyGuard {
  ...
  uint256 public minBetAmount = 0.005 ether; //5 BUSD
  ...
  constructor() VRFConsumerBaseV2(vrfCoordinator) {
    ...
    VRFv2SubscriptionManagerAddress = 0x1B926e9510daC8041A9868462094bc949BB0fd0A;

    minerAddress = 0xEaAC64311F6BB1C15fbfFC803F0b765b1AA98538; //Mining contract address

    busdAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD Token contract address
  ...
  function processDistribution(address _playerAddress, uint256 _amount, bool _isWon) internal {
    ...
    bool success = busdToken.transfer(minerAddress, minerWalletBalance);
