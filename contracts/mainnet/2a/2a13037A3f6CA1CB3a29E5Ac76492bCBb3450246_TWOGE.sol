...
//https://t.me/TwogePortal
//Twoge, as per CZ 🔶 Binance tweet.
...
contract TWOGE is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Twoge";
    string constant _symbol = "TWOGE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _NULL = 0x0000000000000000000000000000000000000001;

    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    uint256 public _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _initialTotalSupply = _totalSupply;
    ...
    //Added sell for first 24 hours, then set to 0
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xed04e912adB4c8253EA027c0D43C41737F395dE2;
   ...
   function changeTxLimit(uint256 newLimit) external onlyOwner {
    ...
    function changeFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBurnFee, uint256 newStakingFee, uint256 newExtraSellFee) external onlyOwner {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newStakingContract) external onlyOwner {
    ...
    function _burn(address _who, uint256 _value) internal {
        ...
        _totalSupply = _totalSupply.sub(balanceOf(DEAD));        
    }

    function _calculateSupply() external onlyOwner {
        _totalSupply = _initialTotalSupply.sub(balanceOf(DEAD)).sub(balanceOf(ZERO)).sub(balanceOf(_NULL));        
    }  
