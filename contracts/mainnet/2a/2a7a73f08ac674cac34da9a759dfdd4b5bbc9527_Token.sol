...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "Charity Case";
    string constant _symbol = "CASE";
    ...
    uint256 public AstroFee = numberFee;
    uint256 public marketingFee = 4;
    uint256 public rewardsFee = numberFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        MKTWallet = 0x5A49bEb06569570C96cEc2c505BAE5903d0E3A22;  // teamwallet
        lotteryWallet = 0x5A49bEb06569570C96cEc2c505BAE5903d0E3A22;  // lotterywallet
        
        totalFee = AstroFee.add(marketingFee).add(rewardsFee).add(lotteryFee);
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMKTWallet, address newLotteryWallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(AstroFee).div(totalFee).div(2);
        ...
        uint256 totalBNBFee = totalFee.sub(AstroFee.div(2));
        
        uint256 amountBNBLiquidity = amountBNB.mul(AstroFee).div(totalBNBFee).div(2);
        ...
        (bool tmpSuccess,) = payable(MKTWallet).call{value: amountBNBMarketing, gas: 30000}("");
