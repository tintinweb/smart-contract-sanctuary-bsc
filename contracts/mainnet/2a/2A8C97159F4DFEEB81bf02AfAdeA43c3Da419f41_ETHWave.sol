...
/**
              Ethereum Wave ~ 7% ETH rewards ~  
 
Website: https://www.ethereumwave.net
Telegram: https://t.me/Ethereum_Wave
FAIRLAUNCH ON PANCAKESWAP on June 7th at 20:00 utc
7% ETH rewards
1% Liquidity Pool / Burn
5% Marketing
120,000,000 supply ♠ 3B max tx ♠ 6B max wallet ♠
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    //u1
    IBEP20 ETHpeg = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ETHpeg.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ETHpeg);
        ...
        uint256 amount = ETHpeg.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ETHpeg.transfer(shareholder, amount);
...
//u2
contract ETHWave is IBEP20, Auth {
    using SafeMath for uint256;

    address ETHpeg = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Ethereum Wave";
    string constant _symbol = "ETHWave";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x35f5A23d9daf40eBc1D7de4fC5061866906f280a;
        ...
        marketingFeeReceiver = 0xFB3f5CF73512fcC154734409d220b6C8485Fe632;
