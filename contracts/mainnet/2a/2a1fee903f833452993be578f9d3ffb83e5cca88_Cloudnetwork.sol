...
//* Channel:https://cloud-network.live
...
contract Cloudnetwork is Context, IBEP20, Ownable {
    ...
    string private _name = "Cloud Network"; // token name
    string private _symbol = "CloudNet"; // token ticker
