...
//telegram:https://t.me/BnbNewYear2023
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x48D3ebE10b34dF70b0058DFF96bE76759479aD76 ;
...
contract BnbNewYear2023 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB NEW YEAR 2023"; // 
    string private constant _symbol = "BNBNY2023"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0x48D3ebE10b34dF70b0058DFF96bE76759479aD76);
