...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "King2";
    string private _symbol = "King2";
    ...
    address payable public marketingWalletAddress = payable(0x739Fa54BB1B71aA487c3006094C0e9eEb95D47d4);
