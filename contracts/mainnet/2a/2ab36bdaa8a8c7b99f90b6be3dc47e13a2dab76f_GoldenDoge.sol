...
library Address{
 ...
 contract GoldenDoge is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10_000_000 * 10**9; // 0.1%
    ...
    address public marketingWallet = 0xEfAaE7AB81dd8a3C17f20Dff15214ffB6B8b8DdC;
    address public donationWallet = 0xEfAaE7AB81dd8a3C17f20Dff15214ffB6B8b8DdC;
