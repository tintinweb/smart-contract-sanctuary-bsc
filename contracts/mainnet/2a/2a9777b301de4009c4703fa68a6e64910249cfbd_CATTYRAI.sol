...
contract CATTYRAI is Context, IBEP20, Ownable {
    ...
    string private _name = "CATTYRAI"; // token name
    string private _symbol = "CATTYRAI"; // token ticker
    ...
    uint256 public minTokenToSwap = 1000000000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
