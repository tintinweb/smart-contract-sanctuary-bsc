...
contract grizarium2  is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Griz2.0";
    string constant _symbol = "griz2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x36C77f339fbded104a2D641c42afA78fdA08517e ;
