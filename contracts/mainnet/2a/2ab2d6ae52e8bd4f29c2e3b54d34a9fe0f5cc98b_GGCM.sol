...
contract GGCM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x127EdFA3587f19f3De1566eD520C642fA8678e22); 
    address payable public developmentAddress = payable(0x127EdFA3587f19f3De1566eD520C642fA8678e22); 
    address payable public charityAddress = payable(0x127EdFA3587f19f3De1566eD520C642fA8678e22); 
    address payable public vaultRewardAddress = payable(0x127EdFA3587f19f3De1566eD520C642fA8678e22); 
    address payable public liquidityWallet = payable(0x127EdFA3587f19f3De1566eD520C642fA8678e22); 
    ...
    uint256 private constant _tTotal = 500000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Gold Guaranteed Coin";
    string private constant _symbol = "GGCM";
    ...
    uint256 public _bMaxTxAmount = 500000000000  * 10**2;
    uint256 public _sMaxTxAmount = 500  * 10**2;
    uint256 private _trigger = 500000000000  * 10**2;
    uint256 private minimumTokensBeforeSwap = 500  * 10**2; 
    uint256 public buyBackSellLimit = 5 * 10**13;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 500000000000 * 10**2; // 1000000
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 500000000000 * 10**2;
        _sMaxTxAmount = 500 * 10**2;
        setTradingOpen(true);
    }
