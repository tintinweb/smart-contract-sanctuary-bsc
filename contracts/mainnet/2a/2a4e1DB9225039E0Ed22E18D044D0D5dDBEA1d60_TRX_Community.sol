...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // TRXidity only automatically asserts when dividing by 0
...
/* Token contract */
contract TRX_Community is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address TRX = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x46bF0bC9Ca79c6C05AB5E03B75436035c7bDD695;
    ...
    string constant _symbol = "NC TRX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100_000_000 * (10 ** _decimals); // 1m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x46bF0bC9Ca79c6C05AB5E03B75436035c7bDD695;
