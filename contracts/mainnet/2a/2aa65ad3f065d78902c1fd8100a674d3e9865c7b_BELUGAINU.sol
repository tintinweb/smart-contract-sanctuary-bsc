...
interface IRouter {
    ...
    contract BELUGAINU is ERC20, Ownable {
    ...
    address public marketingWallet = 0x6f9D1d9e0C9928dF9f13086A5BD042b5B250cbD0;
    address public developmentWallet = 0x443513E812d4f907eD3fdA0EA0EeA800e1Fa4419;
    ...
    Taxes private taxes = Taxes(4, 1, 2);
    Taxes private sellTaxes = Taxes(4, 1, 2);
    ...
    constructor(address routerAdd) ERC20("Beluga Inu", "BELUGA") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require((_marketing +_development + _liquidity ) <= 20, "Must keep fees at 20% or less");
    }
