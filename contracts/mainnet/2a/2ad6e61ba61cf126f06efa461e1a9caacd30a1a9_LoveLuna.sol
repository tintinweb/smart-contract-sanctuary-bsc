...
contract LoveLuna is ERC20 {
    ...
    constructor() ERC20("Love Luna", "LLNA") {
        _decimals = 9;
        _mint(msg.sender, 1_000_000_000_000 * 10**decimals()); // 1,000,000,000,000

        _owner = msg.sender;
        _isAuthorized[msg.sender] = true;

        wallets = Wallets(
            0x33B2eE40133042F0f60c5661BE39a61e8070BcAC, // Marketing
            0x7D8Db519Ee9188b0B5740F2F346C42e234A22dC5, // Chariry Luna Holders
            msg.sender // Presaler
        );

        taxes = Taxes(10, 10, 100); // Buy, Sell, Denominator
        taxRatio = TaxRatio(5, 5); // 5% for Marketing, 5% for Chariry Luna Holders
        maxTx = MaxTx(totalSupply().div(100), 50); // Default maxTx = 50% totalSupply, 1 block delay
