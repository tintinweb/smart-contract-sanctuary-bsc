...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA9514104F74470A67ba41d81B7e16072469a8FEC; // owner address
...
contract GOAL is Context, IERC20, Ownable {
    ...
    string private _name = "Goal! Goal! Goal!";
    string private _symbol = "GOAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6dC9174d1b49320A28Df29536C6E45ec1cc5eE20); // Marketing Address
    address payable public teamWalletAddress = payable(0xA9514104F74470A67ba41d81B7e16072469a8FEC); // Team Address
    ...
    uint256 public _liquidityShare = 1; // original 1
    uint256 public _marketingShare = 3;
    uint256 public _teamShare = 1; // original 1

    uint256 public _totalTaxIfBuying = 3;  // original 10
    uint256 public _totalTaxIfSelling = 4;  // original 10
