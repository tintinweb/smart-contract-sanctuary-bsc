...
contract Playdoge is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0x01C67E65bf400802622A7E93394cDD0FA4a4CBe4);
    address public DevelopmentWallet =
        0x65F876cacA778C50f697a0577059d30647aE3b9A;
    ...
    string private constant _name = "Play Doge";
    ...
    uint256 internal startLaunching;
    ...
    uint256 public _maxTxAmount = 10 * 10**12 * 10**18;
    uint256 public _maxWalletHoldingLimit = 30 * 10**12 * 10**18;
    ...
    function launchingToken() external onlyOwner{
        require(startLaunching == 0,"Already Launched");
        startLaunching = block.timestamp + 15 minutes;
    }
    ...
    function _transfer(
        ...
        require(!_isBlackList[from] && !_isBlackList[to],"You are blacklisted you can't make transaction's");
        
        if(startLaunching > block.timestamp && !_isAtomaticMarketMaker[to]){
