...
/**
*Doge needs Wife, WifeDoge loves Doge.
*If you like doge, you should like WifeDoge.
*We need to marry them.

This is a Community-driven Meme Token (Degen Play) on BSC.
...
contract WifeDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x70F54868d70bdF96D0844B15c1dc89848525e924;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WifeDoge 2.0";
    string private _symbol = "WDOGE2.0";
