...
contract CloudEco is Ownable {
    ...
    ISmartChef public sc;
     ...
     address[][] public path = [[0xCe3bCd38bF6a389Bd6Fd6D582849f1EFA5418Fd2,0x55d398326f99059fF775485246999027B3197955],[0x55d398326f99059fF775485246999027B3197955,0xCe3bCd38bF6a389Bd6Fd6D582849f1EFA5418Fd2]];
    ...
    uint256 _totalSupply = 888_000_000 *(10**8);
    ...
    function setActualSupply(uint256 _actualSupply) public onlyOwner{
        actualSupply = _actualSupply;
    }

    function setXVariable(uint256 _xVariable) public onlyOwner{
        xVariable = _xVariable;
    }
    ...
    function importUser(uint256 index,uint length) public onlyOwner{
        ...
        for(uint256 i=start;i<end;i++){
            ...
            addUser(usersimport[i],0x0000000000000000000000000000000000000000,userimport.amountUSD12);
    ...
    function pendingReward(uint256 _pid,address _user) public view returns (uint256) {
        ...
        rew = rew*10000 * (_totalSupply+actualSupply)/_totalSupply;
        return rew;
    }
    ...
    function harv(uint256 _pid,address buyer) internal {
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                pending = pending/getPriceToken(0);
                actualSupply = actualSupply + pending;
    ...
    function depo(uint256 _pid,uint256 _amount, address _referrer, address _sender) internal {
        string memory errorMsg = string(abi.encodePacked("Minimum Depo is USDT",minDepo));
        require(_amount >= minDepo, errorMsg);
        PoolInfo storage pool = poolInfo[_pid];
        ...
        if(_amount > 0) {
            ...
            //add actual supply
            actualSupply = actualSupply - _tokenValue/price;
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        ...
        if(commissionAmount>0){
            ...
            if(tpLeader != address(0)){
                ...
                actualSupply = actualSupply + commissionAmount;
            ...
            if(lowlead != address(0)){
                ...
                actualSupply = actualSupply + commissionAmountLead;
            ...
            if(address(referral) != address(0)){
                ...
                if(_referrallevel1 != address(0)){
                    ...
                    actualSupply = actualSupply + commissionAmount1;
                    ...
                    if(_referrallevel2 != address(0)){
                        ...
                        actualSupply = actualSupply + commissionAmount2;
                        ...
                        if(_referrallevel3 != address(0)){
                            ...
                            actualSupply = actualSupply + commissionAmount3;
