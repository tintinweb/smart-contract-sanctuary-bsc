...
contract BadCaTtT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bad Cat Token"; // 
    string private constant _symbol = "$BADCAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3996C112188f31595c85EeA6F00F42bB4Ee19007;
