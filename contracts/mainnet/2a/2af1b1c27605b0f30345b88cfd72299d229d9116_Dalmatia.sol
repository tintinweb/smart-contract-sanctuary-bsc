...
contract Dalmatia is IBEP20, Auth {
    ...
    string constant _name = "DalmatiaInu";
    string constant _symbol = "DALNU";
    ...
    address public marketingFeeReceiver = 0xF0456d437C80f6c2e4CA0BDdf7ED8409a3A6278c;
