...
abstract contract Authorization {
     ...
     */
    function iniAutorize(address _auth) public onlyOwner {
...
contract Highland is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Highland";
    string constant _symbol = "HLAND";
    ...
    function updateCooldownEnabled(bool _status, uint8 _interval) public onlyOwner {
    ...
    function updateTradingStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    ...
    function updateSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
