...
Website: https://arabiansaitama.com

Twitter: https://twitter.com/ArabianSaitama
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x6dfd3103E680e85A4e1fB4903Ec4E99bDfAfC182);
...
/* Token contract */
contract  ArabianSaitama is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x6dfd3103E680e85A4e1fB4903Ec4E99bDfAfC182; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xB74F36Bf513D4162A864Fc6D7B42285B0cC0fC3B;
    ...
    // Name and symbol
    string constant _name = "ARABIAN SAITAMA";
    string constant _symbol = "ASAITAMA";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 100 / 1000; // 1% on launch 
    ...
    uint256 private totalFeeSell = 3;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xfaD1620ffcaaA80b1A053DE1e08Fe1De81b38887;
