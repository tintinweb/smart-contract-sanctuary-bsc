...
contract VCFOMO is Ownable {
    ...
    uint256 constant internal tokenPriceInitial_ = 0.3 ether;
    uint256 constant internal tokenPriceIncremental_ = 0.003 ether;
    uint256 constant internal incTokensPerTicket = 0.3 ether;

    uint256 public maxlatestholders = 6;
    uint256 public hoursForRound = 42;
...
/// Calculate owner of ticket
    ...
    function buyTicket(uint256 _amount) external payable returns(uint256){
      ...
      rounds[roundCount].holderPool += ticketPrice.mul(8).div(10);
