...
contract CookieToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
	...
	function initialize() external virtual initializer {
		...
		timeAntiBot = 60 * timeDetectBotSeconds; 
	...
	uint256 amount
        ...
        if(launchTime > 0) {
            if(block.timestamp - launchTime <= timeDetectBotSeconds && automatedMarketMakerPairs[from]) {    // within 1 block
                _isBot[to] = true;
