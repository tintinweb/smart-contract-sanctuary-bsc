...
library Address{
 ...
 contract CCPC is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 50000 * 10**9;
    uint256 public maxSellLimit = 50000 * 10**9;
    uint256 public maxWalletLimit = 50000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xE66Fdae160cA0eCf252b33930846B6442318E290;
    address public developmentWallet = 0xE66Fdae160cA0eCf252b33930846B6442318E290;

    string private constant _name = "CCPC";
    string private constant _symbol = "CCPC";
    ...
    Taxes public taxes = Taxes(0, 20, 5, 0);
    Taxes public sellTaxes = Taxes(0, 20, 5, 0);
