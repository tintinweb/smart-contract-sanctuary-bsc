...
// TATOGE - 3% LP and 3% REFLECTIONS
// Andrew Tate + Small cute Doge
...
library Address{
 ...
 contract TATOGE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xb634688Aa391B3f6090F4fB8F573da305a86e116;
    address public donationWallet = 0xb634688Aa391B3f6090F4fB8F573da305a86e116;

    string private constant _name = "TATOGE";
    string private constant _symbol = "TATOGE";
    ...
    Taxes public taxes = Taxes(3, 0, 3, 0);
    Taxes public sellTaxes = Taxes(3, 0, 3, 0);
