...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "HUWA";
    string public _symbol= "HWA";
     bool balances1 = true;

    address payable public charityAddress = payable(0x3b9232169FEd95EBdE929b5c914399B92D6Fcc80); // Marketing Address
