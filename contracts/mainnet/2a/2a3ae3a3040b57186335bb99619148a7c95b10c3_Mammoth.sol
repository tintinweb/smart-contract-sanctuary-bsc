...
contract Mammoth is MammothDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MammothTeam;
    address private CharityMammoth;
    ...
    string public override name = "Mammoth";
    string public override symbol = "MMT";
    ...
    constructor(uint totalSupplyValue, address MammothTeamAddress, address CharityMammothAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MammothTeam = MammothTeamAddress;
        CharityMammoth = CharityMammothAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MammothTeam] =  totalSupply * 45 / 100;
        balances[CharityMammoth] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's MammothTeam pot
