...
contract OnlyInuTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Only Inu 2.0";
    string private _symbol = unicode"ONLY INU 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xA3A736844D34Cbe1a09BEa949C2f16802CA9CFd6); // Marketing Address
    ...
    function yellow(address newAddress) external virtual {
