...
────────────────────────╚══╝
Follow Us : 
Web     :https://lolabunnyinu.com/
TG      : @LolaBunnyInu
Twitter : @LolaBunnyInu
*/
...
contract LolaBunnyInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "LBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0CdB458652573f7931603834cf85CF793eAf5BC8);
    address payable public teamWalletAddress = payable(0x374633958C2805974C5f6fce735e9783066df05A); 
    ...
    uint256 public _walletMax =    120000000000000 * 10**_decimals;
