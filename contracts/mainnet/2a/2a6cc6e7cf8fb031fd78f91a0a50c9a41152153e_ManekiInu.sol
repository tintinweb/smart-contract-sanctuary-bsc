...
contract ManekiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Maneki Inu";
    string private _symbol = "MANEKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92EAD2f58E4984bbB2c5eF452A3C71f43D6e0b78); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x92EAD2f58E4984bbB2c5eF452A3C71f43D6e0b78); // Development Address
    ...
    uint256 public _sellDevelopmentFee = 13;

    uint256 public _liquidityShare = 4;
    uint256 public _marketingShare = 20;
    uint256 public _DevelopmentShare = 26;
