...
8% Marketing
2% Liquidity
sell tax : Same on buy
breakdown sell tax : Same on Buy
max wallet : 3%
max tx : 1.5%
TG : https://t.me/SaitamaClassicBSC
*/
...
contract saitamabsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saitama Classic BSC";
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 250;
