...
/*
 ...
 8/8 Buy and Sell Fee

 TG: https://t.me/devisgoonrich
...
contract DevisGoonrich is IBEP20, Auth {
    ...
    string constant _name = "Dev is Goonrich";
    string constant _symbol = "GOONRICH";
    uint8 constant _decimals = 3;

    uint256 _totalSupply = 100 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 2; //2%
    ...
    address private marketingFeeReceiver = 0x3b6560880625f54dEBc9500696A14039bb49Ee0e;
    address private developmentFeeReceiver = 0xc4ac9392c3cFF4DF5017Bc9B33B076c75Cc98413;
