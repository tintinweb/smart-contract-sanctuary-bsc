...
@OnlyZillaPortal This is the portal you'll find.

Only Inu is 1% tax, why? Why Low liq ? IS MOONSHOT

The Only Inu you will ever need. This contract is renounced and burn liquidity forever.

Only Zilla is led by a small group of whales. We truly believe in a space where we can make wonderful projects without greedy teams profiting off of it with high taxes.
*/
...
contract ONLYZILLA is IBEP20, Auth {
    ...
    string constant _name = "Only Zilla";
    string constant _symbol = "ONLY ZILLA";
    ...
    address private marketingFeeReceiver = 0x5f87573b52752b10bb542a47774195f63c00cBe2;
    address private teamFeeReceiver = 0xE9aAcC13db0f470a9B4702C3957F4E12f2F9B2e0;
