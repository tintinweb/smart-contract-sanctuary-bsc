...
contract bitcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "413btc";
    string private constant _symbol = "413btc";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9B8f5Db4D99f4F1e638F779cCbe12A2e7ff32b5e);
    address payable private _marketingAddress = payable(0x9B8f5Db4D99f4F1e638F779cCbe12A2e7ff32b5e);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 26, "Redis cannot be more than 20.");
	    require(redisFeeOnSell < 26, "Redis cannot be more than 20.");
