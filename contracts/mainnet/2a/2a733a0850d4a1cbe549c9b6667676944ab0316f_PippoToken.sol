...
// File: contracts/Pippo.sol

pragma solidity ^0.8.12;

contract PippoToken is Context, IERC20, Ownable {
    ...
    address public _marketingWallet =
        payable(address(0xb53C29092C0526193f461448c301F49932c16bc2));
    ...
    uint8 public constant BLOCKCOUNT = 25; //Blacklist first 25 block buys (antisnipe)
    ...
    constructor() {
        ...
        maxSellAmount = totalSupply().mul(100).div(100000); // 0.1% of the supply
        maxBuyAmount = totalSupply().mul(100).div(100000);// 0.1% of the supply
        maxWalletAmount = totalSupply().mul(10).div(1000); // 1% of the supply
