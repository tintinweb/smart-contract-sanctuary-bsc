...
contract EEETC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCFbD22391098B4a4A279842b36F43de7323E3839); 
    address payable public Wallet_Dev = payable(0xCFbD22391098B4a4A279842b36F43de7323E3839);
    ...
    string private constant _name = "EEETC"; 
    string private constant _symbol = unicode"EETC"; 
    ...
    constructor () {
        ...
        _owner = 0xCFbD22391098B4a4A279842b36F43de7323E3839;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*BuyFee/100;
            ...
            uint256 sellFEE = tAmount*SellFee/100;
