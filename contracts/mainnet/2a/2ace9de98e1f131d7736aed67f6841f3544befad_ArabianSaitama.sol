...
/**
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |      __      | || |  _______     | || |      __      | || |  _________   | || |      __      | || | ____    ____ | || |      __      | |
| |     /  \     | || | |_   __ \    | || |     /  \     | || | |  _   _  |  | || |     /  \     | || ||_   \  /   _|| || |     /  \     | |
| |    / /\ \    | || |   | |__) |   | || |    / /\ \    | || | |_/ | | \_|  | || |    / /\ \    | || |  |   \/   |  | || |    / /\ \    | |
| |   / ____ \   | || |   |  __ /    | || |   / ____ \   | || |     | |      | || |   / ____ \   | || |  | |\  /| |  | || |   / ____ \   | |
| | _/ /    \ \_ | || |  _| |  \ \_  | || | _/ /    \ \_ | || |    _| |_     | || | _/ /    \ \_ | || | _| |_\/_| |_ | || | _/ /    \ \_ | |
| ||____|  |____|| || | |____| |___| | || ||____|  |____|| || |   |_____|    | || ||____|  |____|| || ||_____||_____|| || ||____|  |____|| |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
💥STEALTH LAUNCH 14.30-15.30 PM UTC TODAY !💥
...
Telegroup: https://t.me/ArabianSaitama
Social: https://twitter.com/ArabianSaitama
 */
...
contract ArabianSaitama is IBEP20, Auth {
    ...
    address DEV = 0x6AB4Fea43926E0912dCa0aF2171CD75895b7bDAb;
    ...
    string constant _symbol = "ARATAMA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 0.20% or 250k tokens
