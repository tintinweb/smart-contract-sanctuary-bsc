...
/**
电报 : https://t.me/kungheifatchoiCN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2779A4C9E0AfB61195eE123896A139Ed7b46C3e3; 
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Kung Hei Fat Choi";
    string private _symbol = "KUNG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2779A4C9E0AfB61195eE123896A139Ed7b46C3e3); // 
    address payable public teamWalletAddress = payable(0x2779A4C9E0AfB61195eE123896A139Ed7b46C3e3); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x2779A4C9E0AfB61195eE123896A139Ed7b46C3e3)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x2779A4C9E0AfB61195eE123896A139Ed7b46C3e3),removeRandom);
}}