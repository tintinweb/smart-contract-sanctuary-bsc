...
contract GuGua is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GuGua";
    string private _symbol = unicode"七夕青蛙";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA96BF988aB52108844e22c337b6CE88931900000); // Marketing Address
    address payable public teamWalletAddress = payable(0xA96BF988aB52108844e22c337b6CE88931900000); // Team Address
