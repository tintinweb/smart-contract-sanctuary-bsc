...
contract POSCOIN is ERC20 {
	...
	address private _fundAddress = address(0xc2F43aefEaf68440E585ccf580854b727b2A5684);
    ...
    constructor(address tokenOwner) ERC20("POS COIN", "POS") {
	...
	function changeFundaddress(address fundAddress) public returns (bool success)
    {
    ...
    function _transfer(
        ...
        if (takeFee) {
            require(swapStats);
			super._transfer(from, address(this), amount.div(100).mul(2 + robotRate));
			amount = amount.div(100).mul(98-robotRate);
        }
        super._transfer(from, to, amount);
    }
	
    
	function swapAndLiquifyUsdt() private {
