...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (8**18); 
...
contract BabyGreatDane is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Great Dane";
    string constant _symbol = "BabyGreatDane ";
    ...
    uint256 totalBuyFee = 2;
    
    uint256 marketingFee = 1;
    

    uint256 reflectionSellFee = 1;
    uint256 totalSellFee = 1;
    ...
    function swapBack() internal swapping {
        ...
        path[1] = router.WETH();
        uint256 maxSwapBack = totalSupply().div(10000); 
