...
contract FIFADoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFADoge";
    string private _symbol = "FIFADoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C7628C2194bcfBaDf811e06A5ece800AB20aA84);
    address payable public teamWalletAddress = payable(0x8C7628C2194bcfBaDf811e06A5ece800AB20aA84);
