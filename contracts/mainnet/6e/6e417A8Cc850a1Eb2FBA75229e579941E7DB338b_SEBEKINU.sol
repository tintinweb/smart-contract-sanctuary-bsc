...
/* Token contract */
contract SEBEKINU is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0x3dC8a7Be8c1df1348F7DF7dE06A59aF2Cf0e3B96; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = " SEBEKINU";
    string constant _symbol = "SEBEKINU";
