...
// https://dapp.contractchecker.app/
...
contract BabyToken is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        require(_arg.marketingShare_ + _arg.rewardShare_ + _arg.liquidityShare_ == 100, "Total fee shares must be equal to 100");
        ...
        emit TokenCreated(owner(), address(this), TokenClass.babyToken, 2);
    }
    ...
    function updateFeeShares(uint256 _marketingFeeShare, uint256 _liquidityFeeShare, uint256 _rewardShare) external onlyOwner {
        require(_marketingFeeShare + _liquidityFeeShare + _rewardShare == 100, "Total fee shares must be equal to 100");
