...
contract DragonHover is Context, IERC20, Ownable {
    ...
    string private _name = "Dragon Hover";
    string private _symbol = "$DHOVER";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000000 * 10**_decimals;

    address payable private developmentAddress =
        payable(0xC5008CC4728caB62E4d53a04ec1bbC855870Be94);
    ...
    constructor() {
        ...
        _maxBalance = 30000000 * 10**_decimals;
