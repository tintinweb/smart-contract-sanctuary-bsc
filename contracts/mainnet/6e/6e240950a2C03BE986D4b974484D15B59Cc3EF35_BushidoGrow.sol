...
contract BushidoGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bushido Grow";
    string private constant _symbol = "BushidoGrow";
