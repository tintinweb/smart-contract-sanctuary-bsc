...
// CONNECT DAO INU - New Decentralized Token.
// Telegram: https://t.me/ConnectDAOINU / @ConnectDAOINU
// Website: https://ConnectDAOINU.com
// Tax: 4% buy & 4% sell
...
/* Token contract */
contract ConnectDAOINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x000000000000000000000000000000000000dEaD;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "ConnectDAO INU";
    string constant _symbol = "CDAOINU";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 2% or 5M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 70 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x547ac4E91c838F4a17244cD772f98B000a8Da49B;
