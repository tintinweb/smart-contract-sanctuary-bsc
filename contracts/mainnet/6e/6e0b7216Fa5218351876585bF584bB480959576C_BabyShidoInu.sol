...
contract BabyShidoInu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Shido Inu";
    string private _symbol = "BSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2dD6BbC4E3BE697352914DFe4a9470E37151Ebb);//REWARD ADDRESS
    address payable public teamWalletAddress = payable(0xB5d811750ff8BD68F7aE2db25F5d74883bc2EC73); //MARKETING AND TEAM ADDRESS
