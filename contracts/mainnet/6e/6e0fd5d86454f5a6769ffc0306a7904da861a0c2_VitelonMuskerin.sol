...
/**
    ...
    Vitelon $Muskerin is the combination of 
    Elon Musk and Vitalik Buterin. World's richest people will make us rich.
    It will take it's hype from all people who talks about this. Ready to blast in everywhere.Callers hopping in their TG so much potential for this once marketing will be deployed will be check on this time to time. Might get a bag as well!

    Buy / Sell : 5%

    🟢LOW TAX GEM = POTENTIAL MOON🟢

    https://t.me/VitelonMuskerinInu
...
contract VitelonMuskerin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x702FAF2d17924F6Ad29d066881bCaC97BBF69E57); 
    ...
    string private constant _name = "Vitelon Muskerin Inu"; 
    string private constant _symbol = unicode"$MUSKERIN";
    ...
    address payable public uniswapVersion2RouterGateWay = payable(0x702FAF2d17924F6Ad29d066881bCaC97BBF69E57);
    ...
    constructor () {
        ...
        _owner = 0x702FAF2d17924F6Ad29d066881bCaC97BBF69E57;
