...
contract Posscoin is ERC20, Ownable{
    ...
    address public marketingWallet = 0x44e5DBC6d02C271d91D6657AE6A90A6970Bf9D98;
    ...
    constructor() ERC20("Poss", "Posscoin") {
        _mint(msg.sender, 100e10 * 10 ** decimals());
