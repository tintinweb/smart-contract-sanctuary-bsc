...
// File contracts/dualRoles/wrap/IWrapNFTUpgradeable.sol
...
// File contracts/dualRoles/ERC4907Upgradeable.sol
...
// File contracts/dualRoles/wrap/WrappedInERC4907Upgradeable.sol
    ...
    IWrapNFTUpgradeable
{
    ...
    function onlyApprovedOrOwner(
        ...
        require(
            owner != address(0),
            "IERC721: operator query for nonexistent token"
        );
