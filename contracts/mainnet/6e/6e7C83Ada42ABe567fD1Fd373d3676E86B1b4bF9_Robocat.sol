...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE05D658f068612526bCBBDF53D8E994Fd2949303; 
...
contract Robocat is Context, IERC20, Ownable {
    ...
    string private _symbol = "$R-Cat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE05D658f068612526bCBBDF53D8E994Fd2949303); 
    address payable public teamWalletAddress = payable(0xE05D658f068612526bCBBDF53D8E994Fd2949303); 
    ...
    uint256 public _walletMax = 2250000000 * 10**_decimals;
