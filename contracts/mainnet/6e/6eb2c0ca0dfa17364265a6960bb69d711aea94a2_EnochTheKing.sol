...
/**
👑 EnochTheKing 👑
NO RUG PULL / NO HONEYPOT HERE.
You believe it or not, you agree with it or not, I believe and agree with it, that in Scam Money there are a lot of diseases like Cancer etc.
Therefore to get money for myself, I will buy my own tokens with my own money and I will sell my own tokens same like you sell.
Always remember to DYOR before you buy, and please note that I am not a financial advisor.
Any financial losses are not on my responsibilities.
I wanted to build a community that is enjoyable to be a part of, as well as profitable, but NO WAY CANNOT.
Too many snipers, too many jeets, too many scalpers, they are too strong.
Community Token.
DEGEN Play first, we see what happen.
IF EVERYTHING IS OK. 
THEN FLY WITH ME, LET'S FLY TOGETHER NOT TO THE MOON BUT TO THE HEAVEN LIKE ENOCH THE KING!!!

IMPORTANT:
1. You need to buy ONLY after the LP is Locked, not before like scammers who like to dump on others.
2. If you will buy to sell for cheap because you want to recover your lost you made on other tokens or you do not trust the dev or you are afraid
that the dev will rug pull you even if the LP is locked and the contract is safe, I beg you not to buy please, just eat peanuts that you bought
after you sold for cheap on other tokens and watch the chart growing.

Telegram: https://t.me/EnochTheKing
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b084F3e061a0F0Db07033F781609af522Fc4e9A;
...
contract EnochTheKing is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb921b9956250F6C61216644B7604bbFacDf3CFEC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EnochTheKing";
    ...
    uint256 public _WalletMax = 1000000000000 * 10**18;
