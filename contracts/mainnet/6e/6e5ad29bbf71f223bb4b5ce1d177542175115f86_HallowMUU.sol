...
contract HallowMUU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x016e0F7B4d31DD2cAA313b7Af844418ece24E676); 
    address payable public Wallet_Dev = payable(0x1a4A9A70398AafF40a5a0F50613064559D76F9fB);
    ...
    string private constant _name = "Hallow MUU"; 
    string private constant _symbol = unicode"$HMUU"; 
