...
contract BabySpookyHalloweenFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0207E96642b016fCe00Fb9E27c41d31dA71959Af); 
    address payable public Wallet_Dev = payable(0xB16998B537b1e68E880A2bC5C19a9b1b31B93Efb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Baby Spooky Halloween Floki"; 
    string private constant _symbol = unicode"BabySHF";
