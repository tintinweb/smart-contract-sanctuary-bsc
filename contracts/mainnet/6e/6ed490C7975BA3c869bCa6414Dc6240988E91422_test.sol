...
contract test is Context, IERC20, Ownable {
    ...
    address public FUAddress = 0x71874590580F1E3dBCDB04a5881fdF8b47d63e91;
    address public operationsAddress = 0x71874590580F1E3dBCDB04a5881fdF8b47d63e91;
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function setFeeRates(uint256 _operations, uint256 _FU) external onlyOwner {
        feeRates.operations = _operations;
        feeRates.FU = _FU;
        emit FeesChanged();
    }

    function setSellFeeRates(uint256 _operations, uint256 _FU) external onlyOwner{
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSale) private {
        ...
        emit Transfer(sender, address(this), s.tOperations);
