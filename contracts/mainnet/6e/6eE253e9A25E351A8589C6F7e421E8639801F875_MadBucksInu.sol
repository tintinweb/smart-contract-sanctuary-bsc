...
/**
Telegram: https://t.me/MadBucksInu
...
contract MadBucksInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mad Bucks Inu";
    string constant _symbol = "$MBI";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 61 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 385 / 100000; 
    bool inSwap;
