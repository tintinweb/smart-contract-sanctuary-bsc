...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  GCGDS = IBEP20(0x97220571E7d009e2e865AD5777Fcd86A6B9a0950);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GCGDS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(GCGDS);
        ...
        uint256 amount = GCGDS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GCGDS.transfer(shareholder, amount);
...
contract BABYGCGDS is IBEP20, Auth {
    using SafeMath for uint256;

    address GCGDS = 0x97220571E7d009e2e865AD5777Fcd86A6B9a0950; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "BabyGCGDS";
    string constant _symbol = "BBGDS";
