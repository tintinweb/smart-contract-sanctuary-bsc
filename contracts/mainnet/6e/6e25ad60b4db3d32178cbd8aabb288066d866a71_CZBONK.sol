...
/*
🔶CZ🔶🔶BONK🔶
"Get in on the ground floor of the newest BSC token, endorsed HOPEFULLY by the one and only CZ Binance 
and WILL BE listed on the world's most trusted crypto platform, CoinMarketCap.

Contract Adress : ⏩ 0x6E25aD60B4Db3d32178CBd8AAbb288066d866a71 ⏪

contact /:⏩ https://t.me/pumphodl2023 ⏪
...
contract CZBONK is Context, CZBONKECO, Ownable {
    ...
    string private _name = 'CZBONK';
    string private _symbol = 'CZBONK';
