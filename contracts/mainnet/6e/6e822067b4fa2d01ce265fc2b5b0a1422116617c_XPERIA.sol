...
contract XPERIA is XPERIADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private XPERIATeam;
    address private CharityXPERIA;
    ...
    string public override name = "XPERIA";
    string public override symbol = "XPR";
    ...
    constructor(uint totalSupplyValue, address XPERIATeamAddress, address CharityXPERIAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        XPERIATeam = XPERIATeamAddress;
        CharityXPERIA = CharityXPERIAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[XPERIATeam] =  totalSupply * 4 / 100;
        balances[CharityXPERIA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's XPERIATeam pot
