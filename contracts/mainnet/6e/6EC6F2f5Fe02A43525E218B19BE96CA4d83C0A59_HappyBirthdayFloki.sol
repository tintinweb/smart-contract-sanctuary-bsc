...
contract HappyBirthdayFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xB3Abc860fE13fdafA30F6E4255df2904af035ba4;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Happy Birthday Floki";
    string constant _symbol = "HBOKI";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 100000; // will start swapping once 0.01% of supply is in the swap wallet
    bool inSwap;
