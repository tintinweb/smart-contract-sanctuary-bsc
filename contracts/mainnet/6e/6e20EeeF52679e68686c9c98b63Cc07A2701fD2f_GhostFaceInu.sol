...
contract GhostFaceInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GhostFaceInu";
    ...
    uint256 public _maxWalletToken = rSupply.div(1000).mul(4);
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1f67bd54d9948E5092fD818bF66A70D3E3DAA23D;
        devFeeReceiver = 0x09B6CdcCBa0a74d515261d09D4b25dE4909eA7c7;
    ...
    {
        require(
            addresses.length < 5001,
            "GAS Error: max address allowed is 5000"
        ); // to prevent out of gas & overflow error
