...
contract deviszero is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public deployer = payable(0x0fcA66D0B66755e85a98B7644beff95eC7250000);
    ...
    string private constant _name = unicode"DevIsZero"; 
