...
contract ShibKing is Context, IBEP20, Ownable {
    ...
    string private _name = "ShibiKing";
    string private _symbol = "ShibiKing";
    ...
    uint256 public _maxHavAmount = 1000000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9;

    address public _burn = (0x000000000000000000000000000000000000dEaD);
    address public _market = (0xBF54C3A4C43Ba2F3dEeb4c352aFDff019845897A);
