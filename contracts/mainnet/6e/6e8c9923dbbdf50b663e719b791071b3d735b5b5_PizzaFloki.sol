...
contract PizzaFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pizza Floki";
    string private _symbol = "PFLOKI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x1dA197b90f29c05614C1bA785f241768B4C84e27);
