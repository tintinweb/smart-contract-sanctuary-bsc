...
contract MLJX is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0x0c797ef384844f68d714884ebCD5d2A38d38491f),//营销钱包地址
    
        address(0x0c797ef384844f68d714884ebCD5d2A38d38491f)//部署代币接收地址（部署的代币发送到这个钱包地址）
    ){
