...
contract WEB3GROW is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0x322765a72B6BdA59cBFd3e2C85bF0E2d57988a6d;
    address private devWallet = 0x4cb50CaAACcA735A2dF3D6e0b1587E2d9A6838dC;
    address public Charity = 0xbE0a0DF9Cce9dde23FcBcae21Cc1997c4DBCb3c4;

    string private constant _name = "WEB3GROW";
    string private constant _symbol = "W3G";
    ...
    Taxes public taxes = Taxes(4, 4, 2, 2, 0);
    Taxes public sellTaxes = Taxes(4, 4, 2, 2, 2);
