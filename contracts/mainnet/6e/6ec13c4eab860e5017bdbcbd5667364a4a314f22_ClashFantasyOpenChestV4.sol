...
contract ClashFantasyOpenChestV4 is Initializable {
    ...
    mapping(address => mapping(uint256 => openChestSkeleton)) private arrayOpenChestProxy;
    ...
    {
        openChestSkeleton storage user = arrayOpenChestProxy[_from][_tokenId];
    ...
    {
        require(arrayOpenChestProxy[msg.sender][_tokenId].exists == false, "Chest already unlocked");
        initialNumber++;
        ...
        arrayOpenChestProxy[msg.sender][_tokenId] = openChestSkeleton(_tokenId, block.timestamp, false, true, typeOf, rarity, amount,hasEnergy);
    }
    ...
    function openChest(uint256 _tokenId) 
        ...
        validateChest(_tokenId)
    {
        require(arrayOpenChestProxy[msg.sender][_tokenId].exists, "Chest need first to be unlocked");
    ...
    function openChestWithoutPresale(uint256 _tokenId) 
        internal
    { 
        openChestSkeleton storage user = arrayOpenChestProxy[msg.sender][_tokenId];
        ...
        delete arrayOpenChestProxy[msg.sender][_tokenId];
    }
