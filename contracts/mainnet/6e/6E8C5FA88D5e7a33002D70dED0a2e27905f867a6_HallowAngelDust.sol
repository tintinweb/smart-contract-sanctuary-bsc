...
contract HallowAngelDust is Context, IERC20, Ownable {
    ...
    string private _name = "HallowAngelDust";
    string private _symbol = "HAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ac06ae230De6d103eE0478Ac509F8FEd04D8DCa); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6ac06ae230De6d103eE0478Ac509F8FEd04D8DCa); // BuyBack Address
