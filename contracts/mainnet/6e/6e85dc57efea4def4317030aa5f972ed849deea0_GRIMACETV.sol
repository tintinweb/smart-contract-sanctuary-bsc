...
/**
*
Telegram: https://t.me/GRIMACETVBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8DA17294ED93f4C7CCc2C9E17127B14Ef43e228f; // owner address
...
contract GRIMACETV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grimace-TV";
    string private _symbol = "GRIM-TV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe76758bF1e85958461E3F21cDec0e83a54d50f19); // Marketing Address
    address payable public teamWalletAddress = payable(0xe76758bF1e85958461E3F21cDec0e83a54d50f19); // Team Address
