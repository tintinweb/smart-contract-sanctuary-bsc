...
contract MU5735 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MU5735";
    string private _symbol = "MU5735";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50b71d299F5f0cA38F558Ce2c0F050E00eed40bA);
    address payable public teamWalletAddress = payable(0xfC4bFf92e49522E2423455D65D45ef362c06c3CD);
    ...
    uint256 private _totalSupply =  5735 * 10**_decimals;
