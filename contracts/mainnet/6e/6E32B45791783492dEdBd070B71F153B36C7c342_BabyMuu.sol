...
Welcome to Baby Muu Token

Rewarding & Burning Muu Inu Token

Join our official telegram community at-> https://t.me/babymuu_official
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8); // MuuInu Official Contract
...
contract BabyMuu is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; // Muu Inu Official Contract
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyMuu";
    string constant _symbol = "BabyMuu";
    ...
    address public muuBurnReceiver; 
    ...
    constructor () Auth(msg.sender) {
        ...
        IDEXPair = 0xa75187Ba2a1D404774ec926b2B8c423d92c674f6;
        ...
        marketingFeeReceiver = 0xa75187Ba2a1D404774ec926b2B8c423d92c674f6;
        muuBurnReceiver = 0x5c02B47Acd5F84dD0Cf7f4AE64D592e7a35025B2;
        giveawayFeeReceiver = 0xa75187Ba2a1D404774ec926b2B8c423d92c674f6;
 ...
 /*   // switch Trading
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            (status,) = payable(muuBurnReceiver).call{value: amountBNBTeam, gas: 30000}("");
    ...
    function setFeesBuy(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee,uint256 _muuBurnFeeBuy,uint256 _giveawayFeeBuy,
        ...
        muuBurnFeeBuy = _muuBurnFeeBuy;
        giveawayFeeBuy = _giveawayFeeBuy;
        totalFeeBuy = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_muuBurnFeeBuy).add(_muuBurnFeeBuy);
    ...
    function setFeesSell(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee, uint256 _muuBurnFeeSell, uint256 _giveawayFeeSell,
        uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFee;
        reflectionFeeSell = _reflectionFee;
        marketingFeeSell = _marketingFee;
        muuBurnFeeSell = _muuBurnFeeSell;
        giveawayFeeSell = _giveawayFeeSell;
        totalFeeSell = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_muuBurnFeeSell).add(_giveawayFeeSell);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver,
        ...
        address _muuBurnReceiver,
        address _giveawayFeeReceiver
    ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        muuBurnReceiver = _muuBurnReceiver;
