...
contract HayyaGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "HayyaGrow";

    string private _symbol = "HAYYAGROW";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0x9D7278C6bC11912334a5E0591d68c9b57d78D58C;
