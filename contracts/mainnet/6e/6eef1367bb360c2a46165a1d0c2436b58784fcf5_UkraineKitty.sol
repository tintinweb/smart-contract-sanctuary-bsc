...
/**
 *   Smeting coll which you can't undeartand 
*/
...
contract UkraineKitty is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000; //1 Millions, underscores aid readability
    ...
    string private _name = "UkraineKitty";
    string private _symbol = "UkraineKitty";
    ...
    address public burnAddress = 0x0db26885F336Cf46C2366B51697814b726CBB85e;
    address payable private _marketingWallet = payable(0x123d1271B64d061Ef9f128f96CB8288CA85F643d);
    address payable private _devWallet = payable(0x0db26885F336Cf46C2366B51697814b726CBB85e);
