...
contract JWLSday is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jimmy Wales & Larry Sander";
    string private _symbol = "JWLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25C38DDd9f0ec5a8B21BAaAf56916C95b0105243); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x25C38DDd9f0ec5a8B21BAaAf56916C95b0105243); // Team Address
