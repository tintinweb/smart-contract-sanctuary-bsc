...
contract NomadNocry is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x645C156FA4c1ca6aAe2Ba09b9b377253a095665A;
    address public devAddress = 0x645C156FA4c1ca6aAe2Ba09b9b377253a095665A;

    string private constant _name = "NomadNocry";
    string private constant _symbol = "NomadNocry";
    ...
    // Owner cannot transfer out NomadNocry from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out NomadNocry!");
