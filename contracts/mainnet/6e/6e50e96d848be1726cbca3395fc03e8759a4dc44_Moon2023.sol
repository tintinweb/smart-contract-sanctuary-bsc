...
contract Moon2023 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Moon2023DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Moon2023", "MOON") {
        marketingWallet = payable(0xA03764841c95d61600f5b2F549508ceA0520944F);
        devWallet = payable(0xA03764841c95d61600f5b2F549508ceA0520944F);
        ...
        dividendTracker = new Moon2023DividendTracker(
            payable(this),
            router,
...
contract Moon2023DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Moon2023 public Moon2023Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        Moon2023Contract = Moon2023(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Moon2023_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Moon2023_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Moon2023 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Moon2023Contract);

            uint256 prevBalance = Moon2023Contract.balanceOf(address(this));
            ...
            {
                uint256 received = Moon2023Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Moon2023Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
