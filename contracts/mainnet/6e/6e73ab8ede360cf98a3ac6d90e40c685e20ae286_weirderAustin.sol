...
contract weirderAustin is Context, IERC20, Ownable {
    ...
    string private _name = "Weirder Austin";
    string private _symbol = "$AusWeird";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8cAD64953F0481956903cdb0769d2a663D6C9f7d); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x8cAD64953F0481956903cdb0769d2a663D6C9f7d); // Buyback Address
    ...
    uint256 private _totalSupply = 100000000000000 *  10**6 * 10**_decimals;
