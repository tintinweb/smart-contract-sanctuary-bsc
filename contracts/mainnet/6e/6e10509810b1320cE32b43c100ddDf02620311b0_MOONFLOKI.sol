...
contract MOONFLOKI is Context, IERC20 { 
    ...
    string private constant _name = "MOOONFLOKI"; 
    string private constant _symbol = unicode"MOONFLOKI"; 
