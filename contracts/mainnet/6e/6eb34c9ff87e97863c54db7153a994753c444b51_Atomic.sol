...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeA305151aD279b9a7ee86c11f2fda4093e3B2c75; 
...
contract Atomic is Context, IERC20, Ownable {
    ...
    string private _name = "Atomic Network";
    string private _symbol = "ATM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeA305151aD279b9a7ee86c11f2fda4093e3B2c75); 
    address payable public teamWalletAddress = payable(0x2A53ABc9B99878da9717E01E8B18462EbD528b8d); 
