...
contract HAECHI is
    ...
    Freezable
{
    string constant private _name = "HAECHI";
    string constant private _symbol = "HAECHI";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "HAECHI/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "HAECHI/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "HAECHI/approve : Should not approve zero address"
        );
