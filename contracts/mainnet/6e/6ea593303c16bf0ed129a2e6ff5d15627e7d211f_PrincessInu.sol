...
/**
    ))    ))   wW  Ww\\\  ///  c  c       oo_    oo_   wW  Ww\\\  ///wWw  wWw  
  (o0)-.(Oo)-.(O)(O)((O)(O))  (OO)  wWw /  _)-</  _)-<(O)(O)((O)(O))(O)  (O)  
   | (_))| (_))(..)  | \ || ,'.--.) (O)_\__ `. \__ `.  (..)  | \ || / )  ( \  
   | .-' |  .'  ||   ||\\||/ //_|_\.' __)  `. |   `. |  ||   ||\\||/ /    \ \ 
...
https://t.me/BSCPrincessInu

Do not ape till told you jeets, or you might get wrekt
                                                                                        

MAX WALLET - 3% - 
MAX BUY TX - 1% - 
Buy 8 an sell tax 15 percent,sell  higher at launch
*/
...
contract PrincessInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Princess Inu";
