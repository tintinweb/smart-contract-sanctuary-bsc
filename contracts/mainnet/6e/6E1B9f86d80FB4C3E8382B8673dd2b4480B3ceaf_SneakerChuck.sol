...
👟Sneaker Chuck will be The next 1000x Gem in the BSC Trend!
🔥Let's feel the beat with Sneaker Chuck and take money for life !!!

8% Buy/sell (Marketing 6% + Liquidity 2%)

Telegram: https://t.me/sneakerchuck
...
contract SneakerChuck is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sneaker Chuck"; // 
    string private constant _symbol = "SNEAKER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xd44AdAA94835c33EF0Cfd4e90DAeD4040E97075b;
