...
contract SIGMAINUTWO is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0xde001FF1b9F9D5549C6Bb902187D507029613D58)); // MarketingWallet
    ...
    constructor() ERC20("Sigma Inu 2.0", "SigmaTwo") {
