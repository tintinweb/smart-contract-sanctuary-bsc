...
contract SRO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x4EBdEa9eA847715f42330576725dEDe9d3324326); 
    address payable public developmentAddress = payable(0x4EBdEa9eA847715f42330576725dEDe9d3324326); 
    address payable public charityAddress = payable(0x4EBdEa9eA847715f42330576725dEDe9d3324326); 
    address payable public vaultRewardAddress = payable(0x4EBdEa9eA847715f42330576725dEDe9d3324326); 
    address payable public liquidityWallet = payable(0x4EBdEa9eA847715f42330576725dEDe9d3324326); 
    ...
    string private constant _name = "Dashki";
    string private constant _symbol = "SRO";
