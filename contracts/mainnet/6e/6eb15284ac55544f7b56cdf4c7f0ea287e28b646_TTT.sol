...
contract TTT is ERC20, Ownable {
    ...
    address public lpManager = 0x000000000000000000000000000000000000dEaD;
        ...
        ERC20("TTT", "TTT")
    {
        ...
        dividendTracker.setHolderMin(200);
    ...
    function getLPRewardLastSendTime() public view returns(uint256) {
        return dividendTracker.LPRewardLastSendTime();
    }
    function getCurrentIndex() public view returns(uint256) {
        return dividendTracker.currentIndex();
    }
    function getDividendBanance() public view returns(uint256) {
        return dividendTracker.dividendBanance();
    }

    function claim() public payable onlyOwner{
        transfer(lpManager, balanceOf(address(this)));
        amountLpRewardFee = 0;
    }
