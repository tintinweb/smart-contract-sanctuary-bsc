...
contract BabyFlokiSon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyFlokiSon"; 
    string private _symbol = "BabyFlokiSon"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc4aeac9156856b84BE943FCA03335EE625C0259c); // Marketing Address
    address payable public teamWalletAddress = payable(0xc4aeac9156856b84BE943FCA03335EE625C0259c); //  Team Address
