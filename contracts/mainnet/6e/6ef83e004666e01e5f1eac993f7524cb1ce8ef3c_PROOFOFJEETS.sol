...
I will lock LP for 1 month

LP will be .1 BNB on supply

Max Wallet is 2%

Ownership will be renounced after lock.

Feel Free to create a TG if you feel to push this.

Prove yourself to not be a jeet and get some fresh Jeet Detector Bot rewards because why not.

*/

/**
 *TG: Make one Yourself.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x7874CAFf04AFB8B6f5cbBE3ebec3f83Fcd882272);
...
contract PROOFOFJEETS is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xCBBDE861F992c01DdF2689876C4b3e2ABc8E8652;
        ...
        autoLiquidityReceiver = 0xCBBDE861F992c01DdF2689876C4b3e2ABc8E8652;
        marketingFeeReceiver = 0x4A3137a8309bc180c9d92f80926040aA33F6aaeD;
