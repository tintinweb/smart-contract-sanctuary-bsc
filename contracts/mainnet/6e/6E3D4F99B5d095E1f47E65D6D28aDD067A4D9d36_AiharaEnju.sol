...
contract AiharaEnju is Context, IERC20, Ownable {
    ...
    uint256 public constant SWAP_TOKENS_AT_AMOUNT = 4 * 10**9; //
    string private constant _name = "Aihara Enju"; // 
    string private constant _symbol = "AIJU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x4BA277FC337B69bd0181642Be5481DC96aF8a1F4;
