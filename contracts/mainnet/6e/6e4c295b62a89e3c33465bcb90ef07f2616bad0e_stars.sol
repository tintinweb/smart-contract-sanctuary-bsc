...
contract stars is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x1e8aae3d947a1bc70825153aC3a5c7543b91D5df;
    address public _marketingWalletAddress2 = 0x33abd54F7bb117A02eBA106D9f8b4AC76E989699;
    ...
    constructor() public ERC20("stars", "stars") {
    ...
    function setTodayZero(uint256 number) public onlyOwner {
        todayZero = number;
    }
    ...
    function _transfer(
        ...
        if(_isDestroyLp && !_isExcludedFromFees[from] && !_isExcludedFromFees[to] && from != uniswapV2Pair && to != uniswapV2Pair){
            destroyLp();
        }
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(10)){
                uint256 markfees = amount.mul(45).div(100);
                uint256 lpfees = amount.sub(markfees);
                super._transfer(from, to, lpfees);
                super._transfer(from, address(this), markfees);
                return;
            }
            uint256 price = getPrice(amount);
            require(price <= _maxTxAmount, "zero");
        }
        if(!swapping &&
            from != uniswapV2Pair &&
            from != owner() &&
    ...
    function destroyLp() private {
        ...
        if(currZero == todayZero){
            ...
            uint256 desAmount = lpAmount.div(100);
            super._transfer(uniswapV2Pair, _destroyAddress, desAmount);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            ...
            IERC20(USDTs).transfer(_marketingWalletAddress2, mr);
            return;
        }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x9F500e29908E1ef8e15C0c5601Cf0646d71FE169, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x9F500e29908E1ef8e15C0c5601Cf0646d71FE169);
        if (IERC20(USDTs).allowance(0x9F500e29908E1ef8e15C0c5601Cf0646d71FE169, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x9F500e29908E1ef8e15C0c5601Cf0646d71FE169, address(this), amount);
        }
    }
