...
contract SOLDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SOLDAO";
    string private constant _symbol = "SOLDAO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x8A159dbc1E95e05B9989B272670d3A17d6C83B1b);
    address payable private _marketingAddress = payable(0x8A159dbc1E95e05B9989B272670d3A17d6C83B1b);
