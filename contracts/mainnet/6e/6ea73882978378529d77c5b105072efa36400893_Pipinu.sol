...
contract Pipinu is Context, IBEP20, Ownable {
    ...
    string private _name = "Pipinu";
    string private _symbol = "PPU";
    uint8 private _decimals = 9;
    uint256 private _start_timestamp = block.timestamp;

    address private locker = 0x3f4D6bf08CB7A003488Ef082102C2e6418a4551e;
    address private cfo = 0x455f78b81c3Ee86c08350EA82f22C34F09122471;
    address private cto = 0x75a6c6ED4Ada0f8aB6A08327C8EBb725D33833e7;
    address private router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    //address private router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //testnet
    ...
    constructor() public {
        ...
        _isExcludedFromFee[cfo] = true;
        _isExcludedFromFee[cto] = true;

        _allowances[cfo][router] = _rTotal;
        _allowances[cto][router] = _rTotal;

        _whiteList[owner()] = true;
        _whiteList[address(this)] = true;
        _whiteList[cfo] = true;
        _whiteList[cto] = true;
        _whiteList[locker] = true;
    ...
    function updateWhiteList(address account, bool state) public onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap = 0xccdFf2398C2f3d6e96CBdA9cE7aa02afa2dfcE35;
