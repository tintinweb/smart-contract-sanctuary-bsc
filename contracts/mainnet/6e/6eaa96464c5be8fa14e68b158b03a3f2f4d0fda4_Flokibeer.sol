...
contract Flokibeer is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiBeer";
    string private _symbol = "BEERF";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x90c0E5f247a12821390375b0A1824FDb61CC75C7); // Marketing Address
    address payable public teamWalletAddress = payable(0x90c0E5f247a12821390375b0A1824FDb61CC75C7); // Team Address
