...
Argentina vs. Países Bajos: victoria Argentina por penales en un partidazo. ¡Bien hecho muchachos!

Q... Argentina contra Países Bajos: cuántas veces han jugado y quién ha ganado en más ocasiones?

Telegram: https://t.me/iHurraArgentina
...
contract iHurraArgentina is Context, IERC20, Ownable {
    ...
    string private constant _name = "iHurra Argentina";
    string private constant _symbol = "iHurrA";
    ...
    constructor () {
        ...
        // 6% buy fee (Not more than 10%) 
        buyFee.liquidity = 2;
        buyFee.marketing = 4;
        
        // 9% sell fee (Not more than 20%) 
        sellFee.liquidity = 3;
        sellFee.marketing = 6;
