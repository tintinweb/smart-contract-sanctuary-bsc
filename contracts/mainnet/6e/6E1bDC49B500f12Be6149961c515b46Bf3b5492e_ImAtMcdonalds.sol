...
// SPDX-License-Identifier: Unlicensed https://twitter.com/McDonalds/status/1521143128073424897
...
contract ImAtMcdonalds is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "[email protected] INU";
    string private _symbol = "IMCDONALDS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x44eA54aF0E220F258F3a2C71033B969A24286918);
