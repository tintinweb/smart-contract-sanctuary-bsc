...
contract DragonKingcoin is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 500 * 10**5 * 10**18; 
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**5 * 10**18; 
    ...
    IWrap public wrap;
    uint256[5] public feeFomo = [1, 1, 1, 2, 3];
    uint256[5] public feeLiquidity = [0, 1, 1, 1, 1];
    uint256[5] public feeFee = [0, 0, 0, 1, 1];
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= 5000 * 10**18) {
            return 4;
        } else if (bal <= 10000 * 10**18) {
            return 3;
        } else if (bal <= 30000 * 10**18) {
            return 2;
        } else if (bal <= 500 * 10**2 * 10**18) {
            return 1;
        }
        return 0;
    }
