...
contract starlink is Context, IERC20, Ownable {     
    ...
    string private _name = "starlink8.8";   
    string private _symbol = "starlink8.8"; 
    ...
    uint256 private _sellTeamFee = 45;       
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xbac43Ef3F07E6dF057AAff4C6850cC42CDadeC20));   //营销地址
