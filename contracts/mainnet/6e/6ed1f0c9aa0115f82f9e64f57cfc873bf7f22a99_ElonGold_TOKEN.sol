...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`newElonGoldOwner`).
...
contract ElonGold_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonGold";
