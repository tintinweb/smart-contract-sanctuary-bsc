...
contract Shadow is ERC20Burnable, Operator {
    ...
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 3650 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SHADOW", "SHADOW") {
