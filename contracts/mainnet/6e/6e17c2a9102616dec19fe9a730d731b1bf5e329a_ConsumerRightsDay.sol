...
contract ConsumerRightsDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "3.15";
    string private _symbol = "3.15";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbA1f88564c3B6Ec9b1157f45a0E4dA549D20d228);
    address payable public teamWalletAddress = payable(0xaCbf49C0F014b9AE473c60b1Aa7dAf6b394666E0);
    ...
    uint256 private _totalSupply =  12315 * 10**_decimals;
    uint256 public _maxTxAmount =   12315 * 10**_decimals; 
    uint256 public _walletMax =     12315 * 10**_decimals;
