...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE0c7a02792ca565355CDECD098DE0bd19FBdD832; // owner address
...
contract Whalemine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhaleMine ";
    string private _symbol = " Whale ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE0c7a02792ca565355CDECD098DE0bd19FBdD832); // 
    address payable public teamWalletAddress = payable(0xE0c7a02792ca565355CDECD098DE0bd19FBdD832); // 
