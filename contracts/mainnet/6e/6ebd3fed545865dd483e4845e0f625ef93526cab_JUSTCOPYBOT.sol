...
Telegram: https://t.me/JustCopyOfficial

Just Copy bot is a sniper bot that gives you access to 500+ wallets to follow and copytrade.
📟 $JCB database contains whales' wallets, diamond holders' wallets, and wallets of traders with a success rate above 70%. 
💾 No need to buy manually. Buy will trigger automatically. 

🔊 Bot ➖ @Just_copy_bot
🔊 Twitter ➖ https://twitter.com/Justcopy_bot
...
contract JUSTCOPYBOT is Ownable {
    constructor(
        string memory _NAME,
