...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72083991409087FfeA0B20F771eA33451584495d;
...
contract LittleKitty is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4f3E51Ed8deFa1fD09bb6B1c5e0Db981A2Adf3FA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LittleKitty";
    string private _symbol = "LTL";
