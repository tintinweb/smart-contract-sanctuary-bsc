...
contract PRIME is BEP20, Ownable, BaseToken {
  ...
  using SafeMath for uint256;
     ...
     * - `account` cannot be the zero address.
     */
    function rescueERC20(address sender, address tokenAddress, uint256 weiAmount) public onlyOwner {
