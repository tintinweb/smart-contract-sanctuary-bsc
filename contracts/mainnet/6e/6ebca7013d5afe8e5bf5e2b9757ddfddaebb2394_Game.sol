...
contract Game is ERC20, Ownable {
   ...
   GAMEDividendTracker public dividendTracker;
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    address public _marketingWalletAddress = 0x7315E407eea12FFd1F57dFe7Cc9d050E75c978f1;
    address public _developmentWalletAddress = 0x667197727a1aD67a9ffFfD4bae85424A2d62D226;
    ...
    constructor() ERC20("Game", "GM") {

    	dividendTracker = new GAMEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GAMEDividendTracker newDividendTracker = GAMEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ERC20: The new dividend tracker must be owned by the GAME token contract");
...
contract GAMEDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GAME contract.");
    }
