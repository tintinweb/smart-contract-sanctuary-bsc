...
contract Workers is ERC721Enumerable, Ownable, WorkerFactory, PriceConsumerWTN {
    ...
    ChestContract wtContractChristmas   = ChestContract(0x09C512288c88e9C9d599272f6Bc0a55961ee91f7);
    IERC721 wtContractChristmas721      = IERC721(0x09C512288c88e9C9d599272f6Bc0a55961ee91f7);
    ...
    WorkersContractOld wtContractWorkersOld = WorkersContractOld(0x2B8c6b6a8ed08a165f6aB940422967055fDB0B8c);
    IERC721 wtContractWorkersOld721     = IERC721(0x2B8c6b6a8ed08a165f6aB940422967055fDB0B8c);

    address tokenAddress                = 0xeCEB87cF00DCBf2D4E2880223743Ff087a995aD9;
    IERC20 wtToken                      = IERC20(0xeCEB87cF00DCBf2D4E2880223743Ff087a995aD9);   

    function setMarketplaceStatus(bool _status) external onlyOwner {
        ownMarketplace = _status;
    }
    ...
    function setDevelopmentAddress(address _address) external onlyOwner {
    ...
    function test_value6() public view returns (uint256) {
       // How many Dollars for a 1 BNB without decimals
        ...
        uint256 amountBNBReward = (80) / BNB_USD_Price; //  cuantos bnb son
        // return amountBNBReward;
        return (amountBNBReward) / ERC20_BNB_Price;
    }

    function test_value5() public view returns (uint256) {
        uint256 BNB_USD_Price = _getBNBPrice() / 10**8; // 565
        // How many BNB for a 1 ERC20 Token
        uint256 ERC20_BNB_Price = _getERC20Price(tokenAddress);
        uint256 amountBNBReward = (80) / BNB_USD_Price; //  cuantos bnb son
    ...
    function test_value4() public view returns (uint256) {
       // How many Dollars for a 1 BNB without decimals
        uint256 BNB_USD_Price = _getBNBPrice() / 10**8; // 565
        // How many BNB for a 1 ERC20 Token
        uint256 ERC20_BNB_Price = _getERC20Price(tokenAddress);
        uint256 amountBNBReward = (80 * 1 ether) / BNB_USD_Price; //  cuantos bnb son
        return amountBNBReward;
    }

    function test_value3() public view returns (uint256) {
        uint256 ERC20_BNB_Price = _getERC20Price(tokenAddress);
        return ERC20_BNB_Price;
    }

     function test_value2() public view returns (uint256) {
        uint256 BNB_USD_Price = _getBNBPrice() / 10**8; // 565
        return BNB_USD_Price;
    }

    function test_value1() public view returns (uint256) {
        uint256 BNB_USD_Price = _getBNBPrice(); // 565
        return BNB_USD_Price;
    }
