...
// Metamask show "on your account 500k usdt" (",")
     // the news shows "according to the audit usdt is not backed by anything" (*.*)
...
contract BTCBNB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x52579B37B8Dc3b82e33bafB099aE6084D47296e0); 
    address payable public Wallet_Dev = payable(0xC9300Eb373AB7Aa7AD09127596E0A2247b15711d);
    ...
    string private constant _name = "BTC BNB"; 
    ...
    constructor () {
        ...
        _owner = 0xC9300Eb373AB7Aa7AD09127596E0A2247b15711d;
        ...
        uniSwapV2Pair = payable(0xC9300Eb373AB7Aa7AD09127596E0A2247b15711d);
