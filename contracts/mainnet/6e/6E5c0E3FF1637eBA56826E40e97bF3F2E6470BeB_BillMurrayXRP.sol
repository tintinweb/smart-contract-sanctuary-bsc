...
/* Token contract */
contract BillMurrayXRP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BILL MURRAY OWNS XRP TOO";
    string constant _symbol = "BMOXRP2";
    ...
    function shitFacetAddress(address _address, bool _value) public authorized{
