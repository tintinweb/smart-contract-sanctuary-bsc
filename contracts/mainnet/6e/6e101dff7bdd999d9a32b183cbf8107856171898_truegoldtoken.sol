...
contract truegoldtoken is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "true gold token";
    string constant _symbol = "TGT";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 3_000_000_000 * (10 ** _decimals);
