...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e9b04C6D48B26bcBaD5871e39D81143e3B91132; // owner address
...
contract BULLFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BULLFLOKI";
    string private _symbol = unicode"BULLFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1e9b04C6D48B26bcBaD5871e39D81143e3B91132); // Marketing Address
    address payable public teamWalletAddress = payable(0x1e9b04C6D48B26bcBaD5871e39D81143e3B91132); // Team Address
