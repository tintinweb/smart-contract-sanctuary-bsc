...
/*
⎆ DRAGONFLOKI the next moon rider
...
🧭 At Droki, we are committed to creating a true decentralised and strong community.💘

🔰 We believe that when we work together, we can achieve great things. ♻

⏩ That's why we are dedicated to building a community where everyone has a voice 
and can contribute to our collective success.⏪
...
contract DRAGONFLOKI is Context, DRAGONFLOKIECO, Ownable {
