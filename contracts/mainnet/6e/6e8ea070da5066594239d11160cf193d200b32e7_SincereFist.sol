...
contract SincereFist is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sincere Fist";
    string private _symbol = "SFist";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xBe84005E6c0D935da704eb762A8e88Eff4f42b69);
    address payable public teamWalletAddress = payable(0x8F14C06051682577f459C9A40eeF2f925820f96d);
