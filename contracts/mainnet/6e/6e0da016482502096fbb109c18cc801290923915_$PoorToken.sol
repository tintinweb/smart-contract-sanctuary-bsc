...
/**
* t.me/poortoken1
* https://twitter.com/@poortoken1
* I have no money left, but I know how to make contracts. 
* I hope I can recover from this bad period. the token is for speculation only.
* it has no purpose.
* ======================
* TOKENOMICS:
*  
...
contract $PoorToken is Context, IERC20, Ownable {
    ...
    string private _name = "PoorToken";
    string private _symbol = "$PoorToken";
