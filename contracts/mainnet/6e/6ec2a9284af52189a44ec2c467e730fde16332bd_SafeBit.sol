...
contract SafeBit is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x348698262E2B6Db20834a892AA750ceE0c1CD7EA;

    string constant _name = "Safe Bit";
    string constant _symbol = "SBIT";
