...
// Telegram: https://t.me/oldbabydogeofficial
// website: https://oldbabydoge.site
...
contract OldBabyDoge is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xBDF281b4c70C73d578FB098f0bF0E9EF7e9398bd);
    address payable private _twdmkt = payable(0xBDF281b4c70C73d578FB098f0bF0E9EF7e9398bd);
    
    string private constant _name = "OLD BABY DOGE";
