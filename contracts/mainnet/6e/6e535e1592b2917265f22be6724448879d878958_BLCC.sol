...
contract BLCC is IERC20, Ownable {
    ...
    address private _destroyAddress =
        address(0x4aDa2Cc97DcAA9270d0797C86D9533729F7F4C7E);

        address private _destroyAddress1 =
        address(0x000000000000000000000000000000000000dEaD);
        address private _destroyAddress2 =
        address(0x4aDa2Cc97DcAA9270d0797C86D9533729F7F4C7E);

    uint256 public _inviterFee = 0;
    address public inviterAddress = address(0x40C8EC084286f72277E83B79cB481166a7494a49);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;
    address public uniswapV2Pair;
    address public receiveReward1Token = address(0x40C8EC084286f72277E83B79cB481166a7494a49);
    address public fund1Address = address(0x00F01ABe7987f8516Db90CA774bB5D387edF5732);
    ...
    constructor(address tokenOwner, address root) {
        ...
        _tTotal = 6666 * 10**_decimals;
        uint256 leftAmount = 2 * 10**_decimals;
    ...
    function _tokenTransfer(
        ...
        uint256 rate;
        address  destroyAddress = _destroyAddress;
        if(recipient == uniswapV2Pair){
            destroyAddress == _destroyAddress1;
        }
