...
contract Garyswap is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x32C6e06d70af78811cdC386fd2B6eEf4f501aBbA);
    ...
    string private constant _name = "Gary Swap"; 
    string private constant _symbol = unicode"Gswap"; 
    ...
    constructor () {
        ...
        _owner = 0x32C6e06d70af78811cdC386fd2B6eEf4f501aBbA;
