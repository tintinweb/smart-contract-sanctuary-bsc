...
contract Dogekiller is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**8 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    address payable private _marketingAddress = payable(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
