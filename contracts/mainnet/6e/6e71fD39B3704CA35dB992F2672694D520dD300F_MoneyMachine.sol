...
//  __    __     ______     __   __     ______     __  __        __    __     ______     ______     __  __     __     __   __     ______    
// /\ "-./  \   /\  __ \   /\ "-.\ \   /\  ___\   /\ \_\ \      /\ "-./  \   /\  __ \   /\  ___\   /\ \_\ \   /\ \   /\ "-.\ \   /\  ___\   
// \ \ \-./\ \  \ \ \/\ \  \ \ \-.  \  \ \  __\   \ \____ \     \ \ \-./\ \  \ \  __ \  \ \ \____  \ \  __ \  \ \ \  \ \ \-.  \  \ \  __\   
//  \ \_\ \ \_\  \ \_____\  \ \_\\"\_\  \ \_____\  \/\_____\     \ \_\ \ \_\  \ \_\ \_\  \ \_____\  \ \_\ \_\  \ \_\  \ \_\\"\_\  \ \_____\ 
//   \/_/  \/_/   \/_____/   \/_/ \/_/   \/_____/   \/_____/      \/_/  \/_/   \/_/\/_/   \/_____/   \/_/\/_/   \/_/   \/_/ \/_/   \/_____/ 
...
contract MoneyMachine is Ownable, ReentrancyGuard{
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    uint256 public developerFee = 100; // 100 : 1 %. 10000 : 100 %
    uint256 public referrerReward = 600; // 600 : 6 %. 10000 : 100 %
    uint256 public rewardPeriod = 1 days;
    uint256 public withdrawPeriod = 60 * 60 * 24 * 15;	// 15 days
    uint256 public apr = 175; // 175 : 1.75 %. 10000 : 100 %
    ...
    constructor(address _signer, address _devWallet,address _busdContract) {
        ...
        require(_signer != address(0), "Please provide signe");
        signer = _signer;
    ...
    function deposit(uint256 _amount, address _referrer) external {
        ...
        // transfer 1% fee to dev wallet
        IERC20(BUSDContract).safeTransfer(devWallet,depositFee);
        // transfer 6% fee to referrer
    ...
    function setCoupon(CouponSigData calldata coupon, Sig calldata sig) external {
        ...
        if(coupon.payAmount > 0) {
            ...
            IERC20(BUSDContract).safeTransferFrom(msg.sender, address(this), coupon.payAmount);
            uint256 _id = _getNextDepositID();
            _incrementDepositID();
            depositState[_id].investor = msg.sender;
