...
contract GAY is Context, IERC20, Ownable {
    ...
    string private _name = "Pride Pooches";
    string private _symbol = "PROOCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe36abd9579464B86915672C184e2743A22c52F98); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9DAD298849368eCF2a8596f801d71a3610C54f2B); // BuyBack Address
