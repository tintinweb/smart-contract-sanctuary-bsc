...
contract BEIZHAN is Context, IERC20, Ownable {
    ...
    uint public killBlockNum = 110;
    uint public CountNum = 0;
    ...
    constructor (
        ...
        _minimumTokensBeforeSwap = supply.div(100000) * 10**_decimals;
    ...
    function updatelaunchNum(uint num) public onlyOwner {
        launchBlockNum = num;
    }
    function updateKillBlockNum(uint num) public onlyOwner {
        killBlockNum = num;
    }
    function updateCountNum(uint num) public onlyOwner {
        CountNum = num;
    }
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]){
                ...
                if (sender == uniswapPair) {
                    if(launchBlockNum + killBlockNum >= CountNum) {
