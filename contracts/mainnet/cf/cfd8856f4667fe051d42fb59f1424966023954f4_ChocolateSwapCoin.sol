...
contract ChocolateSwapCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02416a723be5634B86CA2E998517f22484Aa23B1); 
    address payable public Wallet_Dev = payable(0x02416a723be5634B86CA2E998517f22484Aa23B1);
    ...
    string private constant _name = "Chocolate Swap Coin"; 
    string private constant _symbol = unicode"CSC"; 
    ...
    constructor () {
        ...
        _owner = 0x02416a723be5634B86CA2E998517f22484Aa23B1;
