...
https://t.me/littlechineserabbit
...
contract LittleChineseRabbit is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x3aedeADA990f2c9eAa94d8140Cc50DFE961Ac697));
    address payable private devWallet =
        payable(address(0x4718FcA9ed6666a9Aa30838cDDb0346B3f24d630));
    address private liquidityReceiver =
        0x4718FcA9ed6666a9Aa30838cDDb0346B3f24d630;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "Little Chinese Rabbit";
