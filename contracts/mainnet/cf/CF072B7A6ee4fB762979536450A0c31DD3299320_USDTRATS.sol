...
contract USDTRATS is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        marketingWallet = 0xC3ebDdcfF155E5f60226C9bc23Aa63f82960973c;  //marketingwallet
        another = [0x30Fa4257A867a9B40483B3dF5B1065E41EfD676E,0x6A0b6Dbe6882530681Eeeca0866980DFb538e031];     
    ...
    function changeAllExempt(address[] calldata lists,bool feeEx,bool txEx)external authorized{
           
        uint256 count = lists.length; 
        for (uint256 i = 0; i < count; i++) {
         isFeeExempt[lists[i]] = feeEx; 
         isTxLimitExempt[lists[i]] = txEx;
        }
    }
