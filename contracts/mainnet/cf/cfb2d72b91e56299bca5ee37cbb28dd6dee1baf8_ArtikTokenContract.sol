...
contract ArtikTokenContract is IERC20, Initializable {
    ...
    function configureDistributor(address payable _address) external onlyOwner {
        ...
        distributorContract = DistributorContract(_address);
    }
    ...
    function processTransfers(
        ...
        if (
            ...
            distributorContract.addShareHolder(_recipient);
            if (balanceOf(_sender) <= 0) {
                distributorContract.removeShareHolder(_sender);
            }
        }
    }
    ...
    function accumulateFees() external onlyOwner {
        ...
        distributorContract.swapTokens();
    }
