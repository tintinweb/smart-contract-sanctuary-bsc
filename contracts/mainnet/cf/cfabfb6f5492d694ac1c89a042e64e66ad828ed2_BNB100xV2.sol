...
contract BNB100xV2 {
    ...
    constructor() {
        ...
        oldpool = 0xD5a3cCA478bC1788C87e456D9C06755eC4a91f8B; //Pool funds for v1
        owner = address(0);
        uint8 tarifPercent = 109;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value <= 5 ether, "Maximum deposit amount is 5 BNB");
