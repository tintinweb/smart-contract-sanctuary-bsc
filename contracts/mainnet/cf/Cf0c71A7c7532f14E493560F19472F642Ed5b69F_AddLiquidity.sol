...
contract AddLiquidity {
    ...
    modifier onlyOSC() {
                require(OSCAddress == address(msg.sender), "Ownable: caller is not the owner");
                _;
        }

    function setOSCAddress(address _OSC) public onlyOwner{
        OSCAddress=_OSC;
    }

    function swapAndLiquify(uint256 contractTokenBalance) public onlyOSC{
