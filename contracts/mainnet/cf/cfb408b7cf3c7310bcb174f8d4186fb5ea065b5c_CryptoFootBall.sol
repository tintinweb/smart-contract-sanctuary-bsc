...
contract CryptoFootBall is Context, IERC20, Ownable {
    ...
    string private constant _name = " Crypto FootBall "; // 
    string private constant _symbol = " $CRYPTOFB "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x28313c24d2eD7f515BCE6Be6C71573b5A4a1EdF7;
