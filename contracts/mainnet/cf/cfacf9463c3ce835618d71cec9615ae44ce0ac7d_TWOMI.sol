...
contract TWOMI is Context, IERC20 {   

    using SafeMath for uint256;
    using Address for address;
   
    // Contract Wallets
    address private _owner = payable(0xBc92491C73428b517eD0E987DC63e34bA88aa9E1);
    ...
    // Token Info
    string private  _name = "Two Hundred Million Inu";
    string private  _symbol = "$TWOMI";
