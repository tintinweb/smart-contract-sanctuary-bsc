...
//https://t.me/shibaxBScOfficial
//https://www.Shiba-X.space
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa40333fD876ECe56AaFAb3f8D490E5fEA807F21C;
...
contract SHIBAX is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$HIBA-X"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xa40333fD876ECe56AaFAb3f8D490E5fEA807F21C);
