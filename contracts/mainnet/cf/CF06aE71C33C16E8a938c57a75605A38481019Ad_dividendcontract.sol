...
contract dividendcontract is ERC20, Ownable {
    ...
    constructor(
        ...
        require(buyTokenRewardsFee.add(buyLiquidityFee).add(buyMarketingFee).add(buyDeadFee) <= 94, "Total buy fee is over 94%");
        require(sellTokenRewardsFee.add(sellLiquidityFee).add(sellMarketingFee).add(sellDeadFee) <= 94, "Total sell fee is over 94%");
