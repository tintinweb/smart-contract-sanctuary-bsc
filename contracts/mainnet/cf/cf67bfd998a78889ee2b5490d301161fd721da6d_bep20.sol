...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8E05b91350a6D2CE8650f2C7138760A59C342Ec0; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "nyinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8E05b91350a6D2CE8650f2C7138760A59C342Ec0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8E05b91350a6D2CE8650f2C7138760A59C342Ec0); // Team Address
