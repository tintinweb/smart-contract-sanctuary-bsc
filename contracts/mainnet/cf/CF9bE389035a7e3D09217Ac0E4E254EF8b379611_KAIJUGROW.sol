...
// Telegram: https://t.me/kaijugrow
// Website: https://kaijugrow.wtf/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc9fBc8C3eB55005c012320f5F41cA21568334Bf8; // owner address
...
contract KAIJUGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kaiju Grow";
    string private _symbol = "$KROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc9fBc8C3eB55005c012320f5F41cA21568334Bf8);
    address payable public teamWalletAddress = payable(0xc9fBc8C3eB55005c012320f5F41cA21568334Bf8); 
