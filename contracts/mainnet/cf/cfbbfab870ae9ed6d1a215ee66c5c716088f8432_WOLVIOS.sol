...
abstract contract ReentrancyGuard {
    ...
    modifier isHuman() {
        ...
        // Protocol by WOLVIOS Team

contract WOLVIOS is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "WOLVIOS";
    string private _symbol = "WLV";
    ...
    uint256 private minTokenNumberToSell =  1000 * 10**9; // this tx amount will trigger swap and add liquidity
    ...
    uint256 public _taxFee = 0; // 2% will be redistributed among the holders
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 0; // 6% will be added to the liquidity pool
    ...
    uint256 public _devFee = 0;  // 2% will go to the maeketingAndDev address 
