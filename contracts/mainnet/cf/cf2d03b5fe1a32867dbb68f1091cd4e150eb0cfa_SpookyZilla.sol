...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7AB2c6c352872657B67ae1F3F40Bc925B54198D8; // owner address
...
contract SpookyZilla is Context, IERC20, Ownable {
    ...
    string private _symbol = "SPKZL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF37bFa4E620650931E7E997fF6c003360Bc14DB5); // Marketing Address
    address payable public teamWalletAddress = payable(0x927623625046fFa221BeE8ED5880942b382bA80a); // Team Address
