...
contract Savingsv5 {
    ...
    function approveAll() public authorized payable{
...
function liquidate() public authorized {
        ...
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(0, getBusdBalance(), busdOutpath,  address(this), block.timestamp);

        address[] memory cakeOutpath = new address[](2);
        cakeOutpath[0] = cake_address;
        cakeOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(0, getCakeBalance(), busdOutpath,  address(this), block.timestamp);

        address[] memory ethOutpath = new address[](2);
        ethOutpath[0] = eth_address;
        ethOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(0, getEthBalance(), busdOutpath,  address(this), block.timestamp);

        address[] memory dripOutpath = new address[](2);
        dripOutpath[0] = drip_address;
        dripOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(0, getDripBalance(), busdOutpath,  address(this), block.timestamp);
    ...
    function rebalance()public authorized {
        ...
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(getBusdBalance(), 0, busdOutpath, address(this), block.timestamp);

        address[] memory cakeOutpath = new address[](2);
        cakeOutpath[0] = cake_address;
        cakeOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(getCakeBalance(), 0, cakeOutpath,  address(this), block.timestamp);

        address[] memory ethOutpath = new address[](2);
        ethOutpath[0] = eth_address;
        ethOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(getEthBalance(), 0, ethOutpath,  address(this), block.timestamp);

        address[] memory dripOutpath = new address[](2);
        dripOutpath[0] = drip_address;
        dripOutpath[1] = router.WETH();

        router.swapExactTokensForETHSupportingFeeOnTransferTokens(getDripBalance(), 0, dripOutpath,  address(this), block.timestamp);
