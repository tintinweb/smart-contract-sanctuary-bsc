...
contract HeinzBeanz is Context, IERC20, Ownable {
    ...
    string private _name = "Heinz Beanz Token";
    ...
    address payable public marketingWallet = payable(0x9e76543500C119cB16b5BE26E185A8199b2C43FA);
