...
Telegram:https://t.me/Dronaportal
Website: https://dronaportal.com/

JOIN THE TELEGRAM AND HELP TAKE THIS TO THE MOON. 

LP LOCKED. ANTI-BOT, ANTI-WHALE, ANTI-DUMP. SAFU.

BOTS OR THOSE TRYING TO MANIPULATE THE CHART REKT-ING OTHERS MAY FIND THEIR WALLETS REKT THIS IS A SAFU COMMUNITY PROJECT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AD = IBEP20(0x0D536B28Cb33226DBab5B3B086b2c257F859E16B);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AD.balanceOf(address(this));
        ...
        uint256 amount = AD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AD.transfer(shareholder, amount);
...
contract DRONA is IBEP20, Auth {
    using SafeMath for uint256;

    address AD = 0x0D536B28Cb33226DBab5B3B086b2c257F859E16B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DRONA";
    string constant _symbol = "ONA";
