...
Telegram Group : https://t.me/argentinafanstoken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD597F230F2CA34699FDa75a07D9B074B1Afc5c12; // owner address
...
contract ArgentinaFansToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Argentina Fans Token";
    string private _symbol = "AFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD597F230F2CA34699FDa75a07D9B074B1Afc5c12); // Marketing Address
    address payable public teamWalletAddress = payable(0xD597F230F2CA34699FDa75a07D9B074B1Afc5c12); // Team Address
