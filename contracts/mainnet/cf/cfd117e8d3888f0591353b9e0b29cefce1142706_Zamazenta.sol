...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdF5d71f22CD267f428b28E7C7b67F2b2cCD6bafb;
...
contract Zamazenta is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdF5d71f22CD267f428b28E7C7b67F2b2cCD6bafb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1800000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Zamazenta";
    string private _symbol = "ZAMA";
    ...
    uint256 public _maxTxAmount = 1800000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1800000000 * 10**18;
