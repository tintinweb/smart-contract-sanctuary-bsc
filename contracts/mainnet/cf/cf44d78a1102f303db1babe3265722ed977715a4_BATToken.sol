...
contract BATToken is IERC20 {
    ...
    //BAT token, creator will take 99% fee
    address public feeTo = 0x42585c791ea09d24ed5628F9051B759d45E780CB;

    string public name = "PANlatt Token";
    string public symbol = "PANlatt";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 PANlatt
