...
Official Telegram Link > https://t.me/SafeLunaRadio
...
contract SafeLunaRadio is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'SafeLunaRadio';
    string private constant _symbol = 'SLUNRADIO';
