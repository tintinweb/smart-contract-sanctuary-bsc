...
contract CATEGROW is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**18; //
    string private constant _name = "Cate Grow"; // 
    string private constant _symbol = "CGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    uint256 public reflect = 0;
    address public  _marketingWallet = 0xBD7742936166B366958Bc474feB2D51Ce54cD4F6;
