...
contract BabyTSHIB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyTSHIB";
    string private _symbol = "BabyTSHIB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xFf5503CBb046e8FC0510f1F979d1d6EDcF7e0a1B);
    ...
    constructor() {
        ...
        emit Transfer(address(0xbB73FceBbEa70Ea2C5c6A4eE40C80e4746314245), _msgSender(), _totalSupply);
    }
