...
/**
 *                          
 *      Join our Telegram group at:   https://t.me/GoldBrewery
*/         
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
...
contract GOLDBREWERY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gold Brewery", "$BREW") {
        
        address newOwner = address(0x98E2463371b47a867A9a47A0fF5c7f12079cc7bD);
        ...
        rewardsSellFee = 2;
        marketingSellFee = 7;  // 3% Brewery tax + 4% marketing tax
        liquiditySellFee = 1;
        totalSellFees = rewardsSellFee + marketingSellFee + liquiditySellFee;
        
        rewardsBuyFee = 2;
        marketingBuyFee = 7;  // 3% Brewery tax + 4% marketing tax
        liquidityBuyFee = 1;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0xb672a36661529475D2F5FF0f2C9c0A76706a51AD); // Marketing and Brewery taxes are coming here. 40% to brewery, 60% stay in marketing
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 17, "Must keep fees at 15% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 17, "Must keep fees at 15% or less");
    }         
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x98E2463371b47a867A9a47A0fF5c7f12079cc7bD),
            block.timestamp
        );
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 100 * (10**18); //must hold at least 0.1%
    }
