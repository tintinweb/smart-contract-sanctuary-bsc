...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30D6275Ab3f7a02f71333cb161A32A25a894aB88; // owner address
...
contract SkittlesInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Skittles Inu";
    string private _symbol = "SKITTLES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30D6275Ab3f7a02f71333cb161A32A25a894aB88); // Marketing Address
    address payable public teamWalletAddress = payable(0x603738Aa2505DfAAFcC3805F34c15C650f57500C); // Team Address
