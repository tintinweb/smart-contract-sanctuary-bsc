...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7827E10b7a6afbEE3C94c67dB45a8EB1b592090b; 
...
contract flokiboss is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Boss";
    string private _symbol = "FlokiBoss";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7827E10b7a6afbEE3C94c67dB45a8EB1b592090b); 
    address payable public teamWalletAddress = payable(0x7827E10b7a6afbEE3C94c67dB45a8EB1b592090b); 
