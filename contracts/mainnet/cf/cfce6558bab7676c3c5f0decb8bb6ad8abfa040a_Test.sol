...
*/
  ...
  function registr(address userAddress) public payable {
   ...
   function registrationRef(address userAddress, address referrerAddress) public payable {
    ...
    function refinfo(address userAddress)
        public
        view
        returns (address)
    {
    ...
    function refinfo1(address userAddress)
        public
        view
        returns (address)
    {
        return users[userAddress].firstLevelReferrals;
    }
        function refinfo2(address userAddress)
        public
        view
        returns (address)
    {
        ...
        function refinfo3(address userAddress)
        public
        view
        returns (address)
    {
        return users[userAddress].thirdLevelReferrals;
    }
