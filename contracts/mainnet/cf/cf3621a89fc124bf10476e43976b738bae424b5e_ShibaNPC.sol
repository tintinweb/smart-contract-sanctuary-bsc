...
/*
     ____  _   _ ___ ____    _      _   _ ____   ____
    / ___|| | | |_ _| __ )  / \    | \ | |  _ \ / ___|
    \___ \| |_| || ||  _ \ / _ \   |  \| | |_) | |
     ___) |  _  || || |_) / ___ \  | |\  |  __/| |___
    |____/|_| |_|___|____/_/   \_\ |_| \_|_|    \____|

    telegram      : https://t.me/ShibaNPC
    Website       : https://shibanpc.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x032Dd510dDD4ef7D698C88354729A1e80459c763; // owner address
...
contract ShibaNPC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiba NPC";
    string private _symbol = "SNPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x032Dd510dDD4ef7D698C88354729A1e80459c763); // Marketing Address
    address payable public teamWalletAddress = payable(0x032Dd510dDD4ef7D698C88354729A1e80459c763); // Team Address
