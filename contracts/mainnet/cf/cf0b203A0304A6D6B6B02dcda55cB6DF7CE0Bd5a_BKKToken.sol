...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 100000000000000 * 10 ** Decimals;
        maxWalletAmount = 100000000000000 * 10 ** Decimals;
        _tTotal = total;
