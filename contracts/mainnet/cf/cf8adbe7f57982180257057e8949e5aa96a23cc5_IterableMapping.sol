...
contract INUSHA is ERC20, Ownable {
    uint256 public liquidityFeeOnBuy;
    uint256 public teamIncentiveFeeOnBuy;
    uint256 public rewardsFeeOnBuy;

    uint256 private totalBuyFee;

    uint256 public liquidityFeeOnSell;
    uint256 public teamIncentiveFeeOnSell;
    uint256 public rewardsFeeOnSell;

    uint256 private totalSellFee;

    address public teamIncentiveWallet;
    ...
    event TeamIncentiveWalletChanged(address teamIncentiveWallet);
    ...
    constructor() payable ERC20("InuShameBank", "INUSHA") {

        rewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; // BTCb

        liquidityFeeOnBuy   = 0;
        teamIncentiveFeeOnBuy = 1;
        rewardsFeeOnBuy     = 2;

        totalBuyFee         = liquidityFeeOnBuy + teamIncentiveFeeOnBuy + rewardsFeeOnBuy;

        liquidityFeeOnSell  = 0;
        teamIncentiveFeeOnSell = 1;
        rewardsFeeOnSell    = 2;

        totalSellFee        = liquidityFeeOnSell + teamIncentiveFeeOnSell + rewardsFeeOnSell;

        teamIncentiveWallet = 0xD8b34dD11A8286b1C43101337f7947c3bE47d0DB;
        ...
        _isExcludedFromFees[teamIncentiveWallet] = true;
    
        _mint(owner(), 1_212_101_211_121_111 * (10 ** 9));
    ...
    function changeTeamIncentiveWallet(address _teamIncentiveWallet) external onlyOwner {
        require(_teamIncentiveWallet != teamIncentiveWallet, "Team wallet is already that address");
        require(!isContract(_teamIncentiveWallet), "Team wallet cannot be a contract");
        require(_teamIncentiveWallet != DEAD, "Team wallet cannot be the zero address");
        teamIncentiveWallet = _teamIncentiveWallet;
        emit TeamIncentiveWalletChanged(teamIncentiveWallet);
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 bnbShare = (teamIncentiveFeeOnBuy + teamIncentiveFeeOnSell) + (rewardsFeeOnBuy + rewardsFeeOnSell);
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((teamIncentiveFeeOnBuy + teamIncentiveFeeOnSell) > 0) {
                    uint256 teamBNB = newBalance * (teamIncentiveFeeOnBuy + teamIncentiveFeeOnSell) / bnbShare;
                    sendBNB(payable(teamIncentiveWallet), teamBNB);
        ...
        if((rewardsFeeOnBuy + rewardsFeeOnSell) > 0 && swapEnabled) {
