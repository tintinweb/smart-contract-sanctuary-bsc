...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6E6bA3430F6264543981ab5E5f65195Fdfe5BA2; // owner address
...
contract SantaBoyCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaBoyCZ";
    string private _symbol = "$SBCZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6E6bA3430F6264543981ab5E5f65195Fdfe5BA2); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6E6bA3430F6264543981ab5E5f65195Fdfe5BA2); // Team Address
