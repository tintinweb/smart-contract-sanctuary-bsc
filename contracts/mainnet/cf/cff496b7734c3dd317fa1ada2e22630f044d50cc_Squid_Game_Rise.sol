...
Telegram : https://t.me/SquidGameRise

Twitter : https://twitter.com/SquidGameRise
...
contract Squid_Game_Rise is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xeC6a3BB1873F86dD1576bd4d05e1A10030e1EfFA;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Squid Game Rise";
    string constant _symbol = "Squid Game ^";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 11111111 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x46824C683bAb1FC61a250Dac153298fB05133b8b;
