...
contract SaudiBull is Context, IERC20, Ownable {
    ...
    uint256 private maxTxAmount = 3_000_000 * (10**_decimals);
    uint256 private maxWallet =  3_000_000 * (10**_decimals);
    uint256 private _swapThreshold = 1_500_000 * (10**_decimals); 

    string private constant _name = "Saudi Bull"; 
    ...
    address public treasuryWallet = 0xC82f377Ca6187544c3df9e519f5dcD2c29cc2f5d;
