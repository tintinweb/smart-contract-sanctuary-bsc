...
contract QATARISU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QATARISU ";
    string private _symbol = "QRISU";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0xA8dbE6B7a89D37B72B68E4D1F367b9Dc014dA753);
    address payable public teamWalletAddress = payable(0xA8dbE6B7a89D37B72B68E4D1F367b9Dc014dA753);
