...
The Lunar Rabbit ecosystem is an intricate network of utilities such as the $LunarRabbit Token, LunarRabbit NFT Collection, Rabbit Run2Earn Game. Designed to offer several passive income avenue to investors.

Investors can earn good reward from playing the Rabbit Run-To-Earn Game, get reward from the reflection system of the token and earn massive rewards from the Lunar Rabbit NFT that they hold, by staking the NFT or selling them for good profits.
   
*Website: https://www.lunarrabbit.cz/                /)  /)
*Twitter: https://twitter.com/LunarRabbit2023       (˶•-•˶) ♡
*Telegram: https://t.me/LunarRabbitChinese         c/づ  づ
...
contract LunarRabbit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lunar Rabbit", "LunarRabbit") {
        ...
        marketingWallet = address(0x6bd7f652BB574c6f3336b45448c1b4b2d09CF777); // set as marketing wallet
    	stakingWallet = address(_owner); // set as dev wallet
    	teamWallet = address(0x2ea8EE42dA22f5208905B55F15C66EdA3BFDcfA6); // set as teamWallet
