...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC82aFb013F7c9C509c9C0be8d03C5A6841CF7459; // owner address
...
contract shankBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shank BSC";
    string private _symbol = "$Shank";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC82aFb013F7c9C509c9C0be8d03C5A6841CF7459); // Marketing Address
    address payable public buybackWalletAddress = payable(0xC82aFb013F7c9C509c9C0be8d03C5A6841CF7459); // Buyback Address
