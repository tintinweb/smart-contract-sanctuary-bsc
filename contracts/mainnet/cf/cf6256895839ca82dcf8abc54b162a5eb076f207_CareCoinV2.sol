...
contract CareCoinV2 is ERC20, Ownable {
    ...
    address public marketingWallet = 0x2B4490D5eCef63f1b673b76a50338068614E2A7A;
    address public projectWallet   = 0x3f51ab8C2B268840563927d4bc897c38DfA7199D;
    address public charityWallet   = 0x62BfE61f31baB40A548e2F7a9732639125d25a0c;
    ...
    {   
        transferOwnership(0xcA4D9C290CEBC72d42f0FCc4338E25eC68A56B4b);
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 liquidityTokens = (contractTokenBalance * liquidityShare) / totalFees;

            contractTokenBalance -= liquidityTokens;
            
            if(liquidityTokens > 0) {
                swapAndLiquify(liquidityTokens + accumulatedWToWTax);
                accumulatedWToWTax = 0;
            }
        ...
        if(takeFee) {
            uint256 _totalFees;
            if (launchedAt + 1 days > block.timestamp && from == uniswapV2Pair) 
            {
                _totalFees = 0;
            }
