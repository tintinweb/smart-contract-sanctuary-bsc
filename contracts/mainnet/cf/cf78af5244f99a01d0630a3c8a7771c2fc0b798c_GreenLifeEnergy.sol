...
contract GreenLifeEnergy is IERC20 {
    ...
    string constant private _name = "25th Test";
    string constant private _symbol = "25";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        tokens: 0x7ab88a0A55cd8afc8c4C9E05346Fb5641DA86FbE,
        swap: payable(0x7ab88a0A55cd8afc8c4C9E05346Fb5641DA86FbE)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 tokens, uint16 swap) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.tokens = tokens;
        _ratios.swap = swap;
        _ratios.total = liquidity + swap;
    }
    ...
    function contractSwap() internal lockTheSwap {
        ...
        uint256 BNBToLP = amountBNB - amountBNBMarketing;
