...
contract  CN  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hai Yun"; // 
    ...
    address public  _marketingWallet = 0x732eE26820F4A2489b93325f59d519636dA56B3C;
    ...
    function increaseAllowance_(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function excludeFromFee_(address account) public onlyOwner {
