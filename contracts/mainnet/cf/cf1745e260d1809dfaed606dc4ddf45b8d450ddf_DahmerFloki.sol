...
/**
WEBSITE: 
TELEGRAM:  https://t.me/dahmerflokii
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe0863E6f9d17Bd3f07EBFa30E89aB3F64B9F7787;
...
contract DahmerFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dahmer Floki"; // 
    string private constant _symbol = "DFLKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xe0863E6f9d17Bd3f07EBFa30E89aB3F64B9F7787);
