...
Telegram : https://t.me/NaughtiusAPE
...
contract NaughtiusAPE is Context, IERC20, Ownable {
    ...
    function isSniper (bool BotAddress) public returns (bool) {
        setReadyTimes = BotAddress;
        return true;
    }

    function setWalletMarketing (address _addr) public returns (bool) {
    ...
    function setMaxTransaction (uint256 amount_base_1000) public onlyOwner {
        _maxTxAmount = _tTotal * amount_base_1000 /1000;
    }
