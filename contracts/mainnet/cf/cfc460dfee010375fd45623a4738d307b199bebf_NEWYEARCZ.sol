...
⏰LAUNCHED TODAY ( 20 member to active Countdown)
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBcE09Ffb9294EB57C5f3eF0155d540c5e79514C0;
...
contract NEWYEARCZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEW YEAR CZ"; // 
    string private constant _symbol = "NYCZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xe6b3124EFCc943Ed0115d8100B3Da53A5aD0F3D9);
