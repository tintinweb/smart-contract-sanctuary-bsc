...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1AED15966964247238bdF8BB332d46B222e42B4d; // owner address
...
contract Renshib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Renshib";
    string private _symbol = "Renshib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1AED15966964247238bdF8BB332d46B222e42B4d); // 
    address payable public teamWalletAddress = payable(0x1AED15966964247238bdF8BB332d46B222e42B4d); // 
