...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b2D016a95D078725fD8D89AD19AfEE81ec1F4E3; // Owner Anal Play
...
contract AnalPlay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anal Play";
    string private _symbol = "AP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b2D016a95D078725fD8D89AD19AfEE81ec1F4E3); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x5FdC89DC4Da20ad7fbf1Aa782e3F95F581694f46); // Team Wallet
