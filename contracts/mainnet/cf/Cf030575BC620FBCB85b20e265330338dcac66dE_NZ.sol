...
contract NZ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "NZ";
    string private _symbol = "NZ";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3fabE080d666A6e17f02c944e711ca746631f5d4));
        marketingWalletAddress = payable(address(0xeC927b0a1A6Cdd846826216A9b87742Ff0857815));
