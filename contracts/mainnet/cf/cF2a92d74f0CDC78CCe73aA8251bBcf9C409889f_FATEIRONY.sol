...
contract FATEIRONY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FATE IRONY";
    string constant _symbol = unicode"FATE🖤IRONY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 210 * 10**5 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1000).div(1000);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC165e3a66318D8a8ca368Acd5FFfd0821543B541;
        ecosystemfeeReceiver = 0xf8858ACD6195A57EeBbC14A4AFB2B43f401c238F;
