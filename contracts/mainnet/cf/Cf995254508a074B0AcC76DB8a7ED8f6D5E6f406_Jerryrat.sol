...
contract Jerryrat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jerryrat";
    string private _symbol = "Jerryrat";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x20d4973dDf5fa4F180a3D7f7AcB90D9F00a32a61); 
    address payable private teamWalletAddress = payable(0x8a9Fc6cf4932231b624d4A9A89A3DA9478459f52); 
