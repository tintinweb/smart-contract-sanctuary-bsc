...
contract BabyShinjiruInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Shinjiru Inu";
    string private constant _symbol = "BSHINJI";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 896586086728463 * 10**_decimals;
    uint256 public _maxTxAmount = 26897582601853 * 10**_decimals;
    uint256 public _maxWalletAmount = 26897582601853 * 10**_decimals;
