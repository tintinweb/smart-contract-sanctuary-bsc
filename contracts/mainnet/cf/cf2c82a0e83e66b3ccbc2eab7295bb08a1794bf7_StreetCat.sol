...
// telegram : https://t.me/street_catbsc
...
contract StreetCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Street Cat";
    string private _symbol = "$Street Cat$";
    ...
    uint256 private numTokensSellToAddToLiquidity = 97623190959682 * 10**9;
