...
contract RussiaKing is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FomoLuna";
    string constant _symbol = "FomoLuna";
    uint8 constant _decimals = 19;
    ...
    uint256 _totalSupply = 65000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x0518C3a6133E03E1BB2aD0a0891E08123beb7f06;
