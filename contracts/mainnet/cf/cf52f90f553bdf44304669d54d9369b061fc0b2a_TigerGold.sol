...
Tiger Gold is a community based deflation token, Tiger Gold goal is to develop solutions 
that will make the cryptocurrency space safer and easier for everyone

Telegram : https://t.me/TigerGoldBsc
Website : https://tigergold.app
Twitter : https://twitter.com/TigerGoldBsc

// OFFICIAL TIGER GOLD CONTRACT
...
contract TigerGold is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5A83ee9B24c4e21Ea973DedB6696Ec6a217a79A1); 
    ...
    string private constant _name = "TIGER GOLD"; 
    string private constant _symbol = unicode"TIGERGOLD"; 
    ...
    constructor () {
        ...
        _owner = 0x5A83ee9B24c4e21Ea973DedB6696Ec6a217a79A1;
