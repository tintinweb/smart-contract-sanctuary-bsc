...
contract PigeDemon is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Pige Demon";
    string private _symbol = "PIGMON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7D37126b32f71aFc5d334Ff34F8bD0980ea2645C);
    address payable public liqWalletAddress = payable(0x7D37126b32f71aFc5d334Ff34F8bD0980ea2645C);
    ...
    uint256 private _totalSupply =  6666 * 10**_decimals;
    uint256 public _maxTxAmount =   166 * 10**_decimals;
    uint256 public _walletMax =     166 * 10**_decimals;
