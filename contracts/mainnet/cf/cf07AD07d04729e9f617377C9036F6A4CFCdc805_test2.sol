...
contract test2 is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("test2", "t2", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x8E358280993070142307ed31c55B3f0c9632b4A4;
        treasuryReceiver = 0xCbAB42c3fE2645dEcbaD817FF6D38dD2C30049D0;
        insuranceReceiver = 0x8Ab557052C6D354e6F4eb72D30D00FebDEFf2981;
        BankReceiver = 0x061C9cB689F6102f4d30A47F27A4C28beBe53825;
        nftHolderReceiver = 0x2170512571318f85a3Be527D0F160E6Af783A083;
        firePit = 0xD5E42DE3E5e015DbD612548269E1543328a44428;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no $T2 token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
