...
contract MISSILECAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MISSILE CAT";
    ...
    address payable public marketingWalletAddress = payable(0x1a440d69C2B33511215eb3c1A6eD47B1a2abDd2E); 
    address payable public rewardsWalletAddress = payable(0xEeB9D38FF06842B4490734f7541143243B0BE7c4); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public _maxTxAmount = 7 * 10**9 * 10**14;
    ...
    constructor () {
        ...
        _Tax = _liquidityFee.add(_marketingFee).add(_reflectionFee);
        _Slippage = _Tax.add(_BurnFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = recipient == uniswapV2Pair ? amount.mul(_Slippage).div(100) 
