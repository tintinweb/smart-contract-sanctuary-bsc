...
interface ITransferLock {
    function transferLockToken(address recipient, uint256 amount) external returns (bool);
}

contract FrontRunDao is ERC20PresetMinterPauserUpgradeable, ITransferLock {
    ...
    function initialize(uint256 _unlockTime, uint256 _unlockPerSecond) public initializer {
        ...
        __ERC20PresetMinterPauser_init("FRONTRUNDAO", "FRD");
    }
    ...
    function getUnlockAmount(address account, uint256 currentTimestamp) external view returns (uint256)
    {
    ...
    function _getUnlockAmount(address account, uint256 currentTime) internal view returns (uint256)
    {
