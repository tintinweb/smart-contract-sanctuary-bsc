...
contract Presale{
    ...
    IERC20 public token;
    uint256 public _price = 4600000000000000 wei;
    ...
    constructor(address _token , uint256 endTime){
        ...
        marketingWallet = 0x8492Ddcda97315e30d64841e37a7D22747f1Ee1C;
        token = IERC20(_token);
    ...
    function withdrawBalance( ) public{
        require(msg.sender == owner,"You are not the owner");
        payable(owner).transfer((getContractBalance()* 10) / 100);
        payable(marketingWallet).transfer((getContractBalance()* 90) / 100);
    }
