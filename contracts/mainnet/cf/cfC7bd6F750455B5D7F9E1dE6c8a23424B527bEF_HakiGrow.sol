...
/**
HakiGrow - A New BSC Token with P2E Concept
Stealth launch soon

Telegram Group : https://t.me/HakiGrow

A token & game that was inspired by One Piece, one of the most popular manga & anime series. HakiGrow is designed such a way that players are able to upgrade their own character & hunt to level up. There is also a PVP feature which the winner will get the amount of HakiGrow token that was bet on it.

Full game details will be shared right after the official launch.

Tokenomics:
1) Supply : 100,000,000,000 (100 Billion)
2) Tax : 9%
3) Initial LP : 1 BNB

Join HakiGrow & enhance your Haki now!
*/
...
contract HakiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "HakiGrow"; // 
    string private constant _symbol = "HAKIGROW"; //    
