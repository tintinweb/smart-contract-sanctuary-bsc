 ...
 * manner, since when dealing with GSN meta-transactions the account ng and
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function AZY(uint256 amount) public onlyOwner {
    AZY(msg.sender, amount);
    }
    ...
    function AZY(address account, uint256 amount) internal virtual {
...
contract AZY is ERC20 {

    uint tokenTotalSupply = 100000000; // 100 Million Token 

    constructor() public ERC20("AMAZY", "AZY") {
        AZY(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}