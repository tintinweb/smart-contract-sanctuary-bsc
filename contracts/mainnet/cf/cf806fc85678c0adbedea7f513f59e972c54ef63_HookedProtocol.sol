...
contract HookedProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hooked Protocol";
    string constant _symbol = "HOOK";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xfC5A03f238c766546DBE13039fC519AEA3602A6c;
        teamFeeReceiver = 0xFD83081aCaBD18CDa586ef20f759A15FFC89B3B1;
