...
Spreading good vibes and favoring the community with profits.
This is Ninetails Inu Community-Coin is all about.

SAFU Dev + Experienced Team
With Strategic Marketing Plans + Lined Up Callers
LP Lock + Unique Pokemon NFTS made by our artists at 10K MCap

Telegram: @NineTailsInuOfficial
*/
...
contract NineTailsInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 400_000_000 * 10**9;
    uint256 public _maxTxAmount = 4_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "NineTails Inu"; // 
    string private constant _symbol = "NINETAILSINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xd34bdAA3520F9198B1746951A4827a776D48db82;
