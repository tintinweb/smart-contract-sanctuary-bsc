...
/**
Telegram: https://t.me/NekoYacht_Club
Twitter: https://twitter.com/nekoyachtclub
*/
...
contract NEKOYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEKO YACHT CLUB";
    string private _symbol = "$NEKOYACHT";
