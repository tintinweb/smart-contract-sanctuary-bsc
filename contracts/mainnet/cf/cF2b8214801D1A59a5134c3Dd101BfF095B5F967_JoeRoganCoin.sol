...
contract JoeRoganCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JoeRogan Coin";
    string private _symbol = "JRC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xB18FFAe9A4b01F0F23F8DF0ebcebbc94AFdBFAe5);
