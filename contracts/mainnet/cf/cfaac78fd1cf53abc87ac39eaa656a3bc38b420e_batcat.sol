...
A feline billionaire by day, a growling vigilante by night.

Welcome to BATCAT, the newest hero in the BSC scene that aims to save you from all the evils that have invaded this space.

BATCAT is a safe project launched by a proven dev team committed to making this token moon.  

TOKENOMICS:
Supply: 1,000,000,000 tokens
Buy Tax 5% / Sell Tax 15%
0 / 1 % reflections
3 / 11% marketing
2 / 3 % LP
No dev wallet / airdrop

1.5% max TRX, 1.5% max wallet

TG: http://t.me/batcatbscofficial
...
contract batcat is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BATCAT";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 600;
