...
// Bsc Degen - Hit & Run (BEG)
// Buy 10 to Charity Sell 10 to Charity
//  telegram : https://t.me/bscdegenfuckfans
//  website : https://bscdegen.club
...
contract BEG is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BSC DEGEN HIT & RUN"; // 
    string constant _symbol = "BEG"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (1000) * (20); // 20%
    uint256 public _maxSellTxAmount = _totalSupply / (1000) * (10); // 10%
    uint256 public _maxWalletToken = _totalSupply / (1000) * (30); // 30%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0x9169B0dED8A114DFdD1Ea3FCb58D0c6A78Eab865;
    address public devFeeReceiver = 0x9169B0dED8A114DFdD1Ea3FCb58D0c6A78Eab865;
    address public buybackFeeReceiver = 0x9169B0dED8A114DFdD1Ea3FCb58D0c6A78Eab865;

    IDEXRouter public router;
    address public pair;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 10000 * 10; // 1%
    uint256 public maxSwapSize = _totalSupply / 1000 * 10; //10%
