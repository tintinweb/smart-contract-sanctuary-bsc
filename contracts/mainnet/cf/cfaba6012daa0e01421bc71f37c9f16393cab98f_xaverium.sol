...
TG: https://t.me/XaveriumOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C40791F957fe0a9b1923CB7FB25c11adf66e429; // owner address
...
contract xaverium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"xaverium";
    string private _symbol = unicode"xaverium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C40791F957fe0a9b1923CB7FB25c11adf66e429); // Marketing Address
    address payable public teamWalletAddress = payable(0x4C40791F957fe0a9b1923CB7FB25c11adf66e429); // Team Address
