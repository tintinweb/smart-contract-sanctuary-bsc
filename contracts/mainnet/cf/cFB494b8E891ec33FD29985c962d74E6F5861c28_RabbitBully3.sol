...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(!havePush[fromAddress] && !_swapPairList[fromAddress]) setShare(fromAddress);
        if(!havePush[toAddress] && !_swapPairList[fromAddress] ) setShare(toAddress);
    }
