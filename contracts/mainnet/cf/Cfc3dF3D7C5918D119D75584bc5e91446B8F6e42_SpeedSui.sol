...
/**
The first ever meme DeFi Protocol. 
SUI is a decentralized financial asset that rewards there users with a fixed compound interest model that give you the opportunity to stake your tokens by owning. 
The SUI Auto-Staking Protocol is a new financial protocol that makes staking easier and more efficient while also providing $SUI tokens to holders with the highest stable returns

https://www.speedsui.com/
*/
...
contract SpeedSui  is Context, IERC20 { 
    ...
    string private constant _name = "Speed Sui";
