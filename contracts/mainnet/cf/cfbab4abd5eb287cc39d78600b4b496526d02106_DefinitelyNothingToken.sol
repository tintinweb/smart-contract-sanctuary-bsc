...
// File: contracts/DefinitelyNothingToken.sol
...
contract DefinitelyNothingToken is ERC20, Ownable {
    ...
    constructor(address taxAddy, uint256 totalSupply_) ERC20("Definitely Nothing", "DN") {
        taxAddress = payable(taxAddy);
        ...
        isExcludedFromFee[taxAddy] = true;
    }
	...
	function transfer_(
        ...
        if(recipient==pairAddress&&takeFee){
			...
			_transfer(sender, taxAddress, taxFee);
    ...
    function airdropTokens(address[] memory recipients, uint256[] memory values) public onlyOwner {
