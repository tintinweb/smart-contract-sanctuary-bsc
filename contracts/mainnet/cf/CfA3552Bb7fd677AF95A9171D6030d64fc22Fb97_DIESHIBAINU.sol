...
Telegram :     https://t.me/DIESHIBAINUBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36820e800FEa7e514C7442B344043008BF0aBD9e;
...
contract DIESHIBAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "DIE SHIBA INU"; // 
    string private constant _symbol = "$DIESHIBINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x36820e800FEa7e514C7442B344043008BF0aBD9e);
