...
contract Token is ERC20 {
    ...
    address private _MarketAddress = address(0x9A09e87744398Fe2ae5eCa04364Bad759cE1c15e);
    ...
    constructor(address tokenOwner) ERC20("SAFEDAO", "SAFEDAO") {
        ...
        .createPair(address(this), address(0x4d7Fa587Ec8e50bd0E9cD837cb4DA796f47218a1));
        ...
        SAFE = IERC20(0x4d7Fa587Ec8e50bd0E9cD837cb4DA796f47218a1);
        pair = IERC20(_uniswapV2Pair);
        uint256 total = 294 * 10**21;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair){//卖出
                ...
                super._transfer(from, _MarketAddress, amount.div(100).mul(2));//营销2%
                super._transfer(from, address(this), amount.div(100).mul(2));//分红2%
    ...
    function _splitOtherToken() public {
        uint256 thisAmount = SAFE.balanceOf(address(this));
        if(thisAmount >= 10**14){
