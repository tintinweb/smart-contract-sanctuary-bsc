...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBFBb805D4DCF5D27C089096501EB5278b1471494;
...
contract Bamba is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5A52Bc69ABba8CB940b775B4f6affe78fB8a54Af;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bamba";
    string private _symbol = "BAMBA";
