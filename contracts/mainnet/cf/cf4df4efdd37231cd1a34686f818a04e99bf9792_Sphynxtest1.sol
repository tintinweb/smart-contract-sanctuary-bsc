...
2%  - Marketing Fee 
7%  - Rewards Distributed to Token Holders
5%  - Extra Rewards Distributed on Sell to Token Holders
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x0C8094a69e8e44404371676f07B2C32923B5699c;
    IBEP20 public RewardToken = IBEP20(0x6e281f90c6D1b5E5A01FB6f14C428afF69c04C3F); 
...
contract Sphynxtest1 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SphynxTest1";
    string constant _symbol = "SphynxTest1";
    uint8 constant _decimals = 16;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x0C8094a69e8e44404371676f07B2C32923B5699c;
    address RewardToken = 0x6e281f90c6D1b5E5A01FB6f14C428afF69c04C3F;
    address marketingWallet = 0x532e512F7637a244a5D8B7052EecAf57d8e0ae51; 

    uint256 _totalSupply = 1 * 10**6 * (10 ** 16);
    ...
    address wm = 0x532e512F7637a244a5D8B7052EecAf57d8e0ae51; 
    ...
    function changeFees(uint256 newMarketingFee,uint256 newLiqFee, uint256 newRewardFee, uint256 newExtraSellFee) external authorized {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 rewardFee = feeApplicable - marketingFee;
        ...
        //marketing
        _balances[wm] = _balances[wm].add(marketingAmount);
        emit Transfer(sender, wm, marketingAmount);
