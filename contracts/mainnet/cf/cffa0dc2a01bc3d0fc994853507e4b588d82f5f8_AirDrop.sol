...
contract AirDrop {
    ...
    address private tokenAddr = 0x8961E477802b922aDb909Af7c80f25445de507Ea; // Official airDrop Morty Inu amount of 350,000,000 tokens
      IERC20 public token;
    ...
    uint256 constant private AMOUNT_TOKEN = 5000 ether;
    uint256 constant private AMOUNT_TOKEN_BUY = 50000 ether;
    ...
    function buyToken(address refAddr) public payable{
        ...
        if (user.referrer != address(0)) {
           token.safeTransfer(user.referrer, tokensValue / 2);
        }
   ...
   function getContractBalance() public view returns (uint256) {
    ...
    function claimToken(address refAddr) public payable {
       ...
       if (user.referrer != address(0)) {
           token.safeTransfer(user.referrer, AMOUNT_TOKEN / 2);
       }
