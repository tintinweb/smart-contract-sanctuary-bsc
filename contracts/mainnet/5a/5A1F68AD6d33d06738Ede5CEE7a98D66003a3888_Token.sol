...
contract Token is ERC20 {
    ...
    constructor()  payable ERC20("dev token", "ADEV") {
       ...
       //address routerContract=0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B;
...
function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
   ...
   function swapTokensForToken1(uint256 tokenAmount) private {
    ...
    function processLPReward() private {
        ...
        IERC20 lpToken = IERC20(_swapContract1);
