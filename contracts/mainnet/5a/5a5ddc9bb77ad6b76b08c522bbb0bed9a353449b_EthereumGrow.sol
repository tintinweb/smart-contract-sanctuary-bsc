...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc1e2Ca25FF63b3877D2C6548A9C1F903912dEc61; // owner address
...
contract EthereumGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ethereum Grow";
    ...
    address payable public teamWalletAddress = payable(0xD9dA9d0966005636855c0161D98ebD519CD4d6b5); // Team Address
