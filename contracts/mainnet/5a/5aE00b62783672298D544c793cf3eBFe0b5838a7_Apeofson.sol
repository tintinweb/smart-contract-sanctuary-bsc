...
/**
Ape OF SON is a 100% safe BSC project conceived and launched by a proven and experienced team.  
It seeks to build a strong community that will play an integral role in governing the token and charting its destiny. 

Central to the concept of Ape of Son are “horde takeovers.”  
These will happen thrice a day.  Ten NFTs will be dropped to ten wallets at particular intervals.  
Any investor will have the chance to win one (or maybe more) NFT just by holding!
https://t.me/ApeOfson
*/
...
contract Apeofson is Context, IERC20, Ownable {
    ...
    string private constant _name = "APEOFSON"; // 
    string private constant _symbol = "AOS"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x5eC10cf8d818CF3dc25F1299F8A19Be23aBb8B88;
