...
contract Facebookinu is Context, IERC20, Ownable {
    ...
    string private _name = "Facebook Inu";
    string private _symbol = "FACEINU";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x85afe55A7c6cB3208BA65737Ee9DaB76f9E28d00);
    address payable public teamWalletAddress = payable(0xB041398e449f315CFBFF011E93eD740EB2a768b1);
