...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 300000000 * 10** Decimals;
        walletLimit =  300000000 * 10** Decimals;
...
contract CL is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        300000000,//Supply
        address(0x8a33B960E1d5B11487EDE94D3B456537A12f6B93),//FundAddress
        address(0x06399F455906A5F49ff8DDc06593B254c4eB0Eef)//ReceiveAddress
    ){
