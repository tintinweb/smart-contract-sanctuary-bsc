...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3eC4AFeaaF46d034Dd008115Ffa926aCf7155402; // owner address
...
contract TwitterZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Zilla";
    string private _symbol = "$Twilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAc8f64bD529e693ECE9B92643107c4411a73F1C5); // Marketing Address
    address payable public teamWalletAddress = payable(0xAc8f64bD529e693ECE9B92643107c4411a73F1C5); // Team Address
