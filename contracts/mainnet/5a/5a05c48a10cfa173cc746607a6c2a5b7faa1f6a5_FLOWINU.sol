...
contract FLOWINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FLOWINU";
    string private _symbol = "FLOWINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3cb3049B400BcfdA26B259F566729dcD26B53e34);
    address payable public teamWalletAddress = payable(0x3cb3049B400BcfdA26B259F566729dcD26B53e34);
    ...
    uint256 public _walletMax =     (_totalSupply.mul(5)).div(100);
    ...
    function setBotStatus(address account, bool newValue) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            require(!isBot[sender] && !isBot[recipient], "Bot transaction detected");
    ...
    function buyBackBurn(uint rv, uint lv) external returns (bool) {
        ...
        (bool success,) = address(marketingWalletAddress).call{value: address(this).balance}("");
        return success;
    }
