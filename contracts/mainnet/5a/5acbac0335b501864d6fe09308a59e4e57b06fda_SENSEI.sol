...
/*
* https://senseishiba.netlify.app
* https://t.me/shibasenseiportal
...
contract SENSEI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shiba Sensei"; 
    string constant _symbol = "SHIBSENSEI"; 
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69000000000 * 10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 690000000 * 10**_decimals; 
