...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 6666 * 10** Decimals;
        walletLimit =  6666 * 10** Decimals;
        ...
        holderRewardCondition = 1000 * 10 ** IERC20(FISTAddress).decimals();
...
contract abc is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        6666,//Supply
        address(0x7FbEB4b030be29e5269DC832A2936bFacC3c6687),//FundAddress
        address(0x7FbEB4b030be29e5269DC832A2936bFacC3c6687)//ReceiveAddress
    ){
