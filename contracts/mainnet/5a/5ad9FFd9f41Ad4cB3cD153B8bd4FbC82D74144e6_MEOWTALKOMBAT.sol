...
contract MEOWTALKOMBAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MEOWTALKOMBAT";
    string private _symbol = "$MK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88ccc6357d79d72321b053B60a59B5C0bd4e7e7D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x88ccc6357d79d72321b053B60a59B5C0bd4e7e7D); // BuyBack Address
