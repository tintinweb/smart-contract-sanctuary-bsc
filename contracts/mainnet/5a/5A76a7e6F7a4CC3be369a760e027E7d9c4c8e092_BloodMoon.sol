...
contract BloodMoon is ERC20, Ownable {
    ...
    constructor() ERC20("BloodMoon", "BloodMoon") {
        ...
        */
        _mint(marketingWallet, 10000000 * (1e18));
    }
    ...
    function setEnableSell(bool _enableSell) external onlyOwner {
    ...
    function _transfer(
        ...
        require(!_isBlcList[from], "blclist");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(takeFee) {
            ...
            if(sender == uniswapV2Pair) { //buy
                ...
                require(enableSell, "not sell time");
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        address WTX = uniswapV2Router.WETH();
