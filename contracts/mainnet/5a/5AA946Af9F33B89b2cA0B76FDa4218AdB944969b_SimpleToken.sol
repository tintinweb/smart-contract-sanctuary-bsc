...
contract SimpleToken is ERC20, Ownable {
    ...
    ) ERC20("SimpleToken", "SPT")
    {
        ...
        address _tokenPairAddr = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
    ...
    function _transfer(
        ...
        } else if (recipient == tokenPairAddr && !(excludedList[true][sender] || excludedList[true][recipient])) {
    ...
    function setTaxes(uint256 _tax, uint256 _buyTax, uint256 _sellTax) public onlyOwner {
        require(_tax <= taxLimit, "ERC20: tax value higher than tax limit");
        require(_buyTax <= 100 && _sellTax <= 100, "ERC20: included tax cant be higher than 100");
        sellTax = _tax;
