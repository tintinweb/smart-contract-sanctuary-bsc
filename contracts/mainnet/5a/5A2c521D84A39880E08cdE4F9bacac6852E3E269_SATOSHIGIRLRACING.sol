...
contract SATOSHIGIRLRACING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    bool swapping; 
    bool botOn = false;
    uint256 swapThreshold = ( _totalSupply * 232 ) / 100000;
    ...
    function shouldSwapBack(address sender, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && aboveMin && !isInternal[sender] && swapTimes >= minSells;
    }
