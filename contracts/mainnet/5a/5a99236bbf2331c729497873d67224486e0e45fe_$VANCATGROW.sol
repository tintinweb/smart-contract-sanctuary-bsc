...
//
// $VANCATGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/VancatGrow
//
...
contract $VANCATGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("VANCAT GROW", "VANCATGROW") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "VANCATGROW";
    string private _symbol = "VANCATGROW";
