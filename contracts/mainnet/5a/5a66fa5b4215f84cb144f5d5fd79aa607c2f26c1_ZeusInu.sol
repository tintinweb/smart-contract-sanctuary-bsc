...
contract ZeusInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "Zeus Coins";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe1B0685aC0c77f2A66931DB00CD7b57100cf577); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xEe1B0685aC0c77f2A66931DB00CD7b57100cf577); // BuyBack Address
