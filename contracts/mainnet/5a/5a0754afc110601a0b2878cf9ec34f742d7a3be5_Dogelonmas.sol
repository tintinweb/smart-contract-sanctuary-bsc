...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf91A4004D5F6844ba1632cDBF619c7626a117af1;
...
contract Dogelonmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogelonmas";
    string private _symbol = "D-eMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf91A4004D5F6844ba1632cDBF619c7626a117af1);
    address payable public teamWalletAddress = payable(0xf91A4004D5F6844ba1632cDBF619c7626a117af1);
