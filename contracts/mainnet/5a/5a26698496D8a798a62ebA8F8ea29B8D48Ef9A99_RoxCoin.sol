...
contract RoxCoin is Context, IBEP20, Ownable, Pausable {
  ...
  */
   ...
   */
  function mint(uint256 amount) public whenNotPaused returns (bool) {
   ...
   */
  function _mint(address account, uint256 amount) public whenNotPaused {
