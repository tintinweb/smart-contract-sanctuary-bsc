...
/**
Telegram : https://t.me/vinetwogeportal
Website  : TBA
...
contract VINETWOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VINE TWOGE";
    string private _symbol = "VTWOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1bC8d4671C6DC431370B9491f3FeE1B4cE7d96eD); // Marketing Address
    address payable public teamWalletAddress = payable(0x1764c5bE3546af27890C5C8CcFD73621CD858388); // Team Address
