...
abstract contract IPToken is IERC20, Ownable {
    ...
    uint256 public _buyFee = 500;  //买入手续费  /10000
    uint256 public _sellFee = 500;  //卖出手续费  /10000
    uint256 public mk1 = 200;  //营销1
    uint256 public mk2=0;  //营销2
    uint256 public _lpFee = 0;    //回流的税费比例
    uint256 public _destroyFee = 100;  //销毁的手续费比例
    uint256 public _lpDividendFee = 200;  //LP分红的手续费比例
    ...
    constructor (
        ...
        lpRewardCondition = 3 * 10 ** IERC20(usdt).decimals();
...
contract IP is IPToken {
    constructor() IPToken(
        ...
        18,
        2100,
        address(0x57000C0a8A8c8754bc32eAA632Dbc177C8C33CdF),  //营销1  3%手续费
        address(0x5E98F718013643887FA03D2336aDE9150723Ae1F),   //接收代币的地址
        5 //限购数量
    ){
