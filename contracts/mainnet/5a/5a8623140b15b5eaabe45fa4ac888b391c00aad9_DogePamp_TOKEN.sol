...
contract DogePamp_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogePamp";
    string private constant _symbol = "DPAMP";
