...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x39cF18008BAAe0733C30d1631c1998d0e573e861;
...
/* Token contract */
contract Meowmilk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x47eACe9a67A98Ed496255e441c29ff18fC7288B1;
    ...
    // Name and symbol
    string constant _name = "meowmilk";
    string constant _symbol = "MMK";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 10B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% or 20B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x47eACe9a67A98Ed496255e441c29ff18fC7288B1;
