...
/**
1530 - 1730 Will be the timeframe of steatlh Launch.
 https://t.me/ArabianBoredApe

Experienced Team coming together to surpass all arabian tokens and follow the footstep of Bored Ape. 

Team from different projects uniting to create a moonshot: Contract Dev of Blackrock Inu, 
Community Manager of XDog, and a based marketing Dev.

Snipers will get higher tax so think abot it.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4451CFBE73B3a529A810480893f46976C6131D10;
...
contract ArabianBoredApe is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x20Fa4fbd3Bd4d26a9309A063bfb3229dB508BF24);
    ...
    */
    ...
    string private _name = "Arabian Bored Ape"; 
