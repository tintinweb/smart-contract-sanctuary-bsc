...
contract BNBuilderStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [3 days, 7 days, 14 days, 30 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [100, 250, 350, 500];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xF265ECF4dc7BB36436F4dd2a32775dffe5E17cbe; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x35181B3E159FE59C5c0E886F6955D5AA2D44A419); // TKN Token address 
