...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function struction(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract bangbangda is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "bangbangda";
    string private _symbol = "BBANG";
    ...
    function retrain(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
