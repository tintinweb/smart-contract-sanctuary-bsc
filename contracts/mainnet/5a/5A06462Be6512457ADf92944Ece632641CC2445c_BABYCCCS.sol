...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xF27ED8D389566C4E466ee52960c37161484c17DC); //CCCS REWARDS
...
contract BABYCCCS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABY CCCS";
    string constant _symbol = "BABY CCCS";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xF27ED8D389566C4E466ee52960c37161484c17DC; // CCCS REWARDS
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x33cb277741f7B510A1CeC7c02Aa526a4e3E9faCa;
        marketingWallet = 0x33cb277741f7B510A1CeC7c02Aa526a4e3E9faCa;
        devWallet = 0x33cb277741f7B510A1CeC7c02Aa526a4e3E9faCa;
