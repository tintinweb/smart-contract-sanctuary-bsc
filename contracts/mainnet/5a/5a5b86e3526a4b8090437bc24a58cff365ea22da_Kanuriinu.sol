...
contract Kanuriinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kanuri inu";
    string private _symbol = "Kanuri";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf9D9C8BD28CBCf40f300EC1E25104B95BA738372); 
    address payable public buyBackWalletAddress = payable(0xf9D9C8BD28CBCf40f300EC1E25104B95BA738372); 
    ...
    uint256 public _walletMax = 1 * 10**15 * 10**9; 
