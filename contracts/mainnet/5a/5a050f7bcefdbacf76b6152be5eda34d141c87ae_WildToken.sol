...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3835481BA6a6a6f8d6fFb9Bd690f9043A11a8d4;
...
contract WildToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb3835481BA6a6a6f8d6fFb9Bd690f9043A11a8d4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Wild Token";
    string private _symbol = "Witok";
