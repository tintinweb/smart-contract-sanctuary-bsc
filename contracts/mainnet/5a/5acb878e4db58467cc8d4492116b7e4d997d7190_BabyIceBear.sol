...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xc090352363D1C8DC9Ad3C12C6b795F65BbD28124);
    IDEXRouter router;
...
contract BabyIceBear is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Ice Bear";
    string constant _symbol = "BIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb58175D3AD39b37888c375C253FB3d939cb1c3d3;
        buybackFeeReceiver = 0xb58175D3AD39b37888c375C253FB3d939cb1c3d3;
    ...
    function Sell_Multiplier(uint256 _sell) external authorized {
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
