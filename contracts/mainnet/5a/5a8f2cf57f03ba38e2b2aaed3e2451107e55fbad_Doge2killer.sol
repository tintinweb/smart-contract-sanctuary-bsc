...
contract Doge2killer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6A4860eE0C43531cD85C3adb7F6f97ddE1de2BB3); // Marketing Address
    ...
    string private _name = "Doge2.0killer";
    string private _symbol = "Doge2.0killer";
