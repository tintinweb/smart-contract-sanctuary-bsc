...
/**
   ...
   it's the best part of the #MoonGlory idea, increasing the liquidity pool automatically, 
...
contract BONEGROW is Context, IERC20, Ownable {
    ...
    string private _name = "BoneGrow";
    string private _symbol = "BONEGROW";
