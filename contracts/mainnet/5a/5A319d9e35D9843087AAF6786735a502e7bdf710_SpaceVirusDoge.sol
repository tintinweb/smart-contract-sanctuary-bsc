...
contract SpaceVirusDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceVirusDoge";
    string private _symbol = "SpaceVirusDoge";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbdcc386A0b3c81B5Fcfe36B5c46765271539BB9e); 
    address payable private teamWalletAddress = payable(0x18300b877a0a3fDe47DBdd78a5FBcf179aDAdf98); 
