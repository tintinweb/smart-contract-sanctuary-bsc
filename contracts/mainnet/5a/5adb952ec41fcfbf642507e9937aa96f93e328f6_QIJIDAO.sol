        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x32FFa7e72B9E053d10BDeB2A2ABed6024800dD74), block.timestamp
                );
            }
        }
    }
...
contract QIJIDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x32FFa7e72B9E053d10BDeB2A2ABed6024800dD74),//FundAddress
        address(0x7847C4bE722f17d68a10B33D0d69CDa4819629A4)//ReceiveAddress
    ){
    }
}