...
contract MetaverseRocket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaverseRocket";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    uint256 liquidityFee    = 12; //fees. change them to whatever you like. make sure to adjust the totalFee in line 456 to equal total sum of the values in 453,454 and 455.
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0c1D82157e5Fa31a9806692761C142620Eb82E22;
