...
contract COKERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("City Of Knowledge", "COK", 16) 
    ERC20Permit("City Of Knowledge") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 100000000000000000000); 
