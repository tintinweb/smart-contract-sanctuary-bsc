...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87327383341a3AE85Cb2C348a92C2d819ac19F23; // Owner
...
contract Deartwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dear Twitter";
    string private _symbol = "Twitter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87327383341a3AE85Cb2C348a92C2d819ac19F23); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x75A314462cE85197edA02768d9589D8819E0997b); // Team Wallet
