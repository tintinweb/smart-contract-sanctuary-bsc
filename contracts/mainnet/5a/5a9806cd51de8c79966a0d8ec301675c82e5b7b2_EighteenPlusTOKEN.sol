...
30 % (15% for private , 15% for official) for presale
30% for launch
30% for mining
10% for dev
buy/sell percentages: 4% for all holders
, 3 % for liquidity pool,
2% for martketing (dev wallet) (Native tokens) - Required wallet address
*/

contract EighteenPlusTOKEN is Context, IERC20, Ownable {
    ...
    string public _name = "18+ TOKEN";
    string public _symbol = "18+";
    ...
    address public marketingWallet = 0x50349C62e883143cE889887205ec90E2d0592081 ;
