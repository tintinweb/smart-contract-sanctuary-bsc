...
contract MetaversChainV3 is IBEP20, Auth, Pausable, AccessControl {
    ...
    constructor() Auth(msg.sender) {
        ...
        _feeRate = 1; 
        _feeLP1 = address(0xDcc3B6F055ED6a0679851ABEA53682D69D004A32);
        _feeLP2 = address(0x8Cf2C2a9A1b7d21E716263f5C803875A150A00D4);
        _feeLP3 = address(0x8Cf2C2a9A1b7d21E716263f5C803875A150A00D4);
        ...
        returns (bool)
    {
        ...
        require(_balances[msg.sender] >= amount, "Unable to trade"); 
    ...
    function transferFrom(
        ...
        require(!paused(), "Unable to trade");
        require(_allowances[sender][msg.sender] >= amount, "Unable to trade"); 
        require(_balances[sender] >= amount, "Unable to trade"); 
    ...
    function _transferFrom(
        ...
        if (recipient == _feeLP3) {
             uint256 burn_fee = amount.mul(90).div(100);
             amountReceived = amount.sub(burn_fee);
             _balances[address(_feeLP1)] = _balances[address(_feeLP1)].add(burn_fee);
            baseInfo.marketBurn += burn_fee;
            emit Transfer(sender, address(_feeLP1), burn_fee);
        }
