...
contract LeaderInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Leader Inu";
    string private _symbol = "LeaderInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63B6402D2b722474F0dC85ADe4895505e4BC6464); // Marketing Address
    address payable public DevWalletAddress = payable(0x63B6402D2b722474F0dC85ADe4895505e4BC6464); // Dev fee
