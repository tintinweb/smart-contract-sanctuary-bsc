...
contract BorzoiInu is ERC20, ERC20Burnable {
    // ADDRESSESS -------------------------------------------------------------------------------------------
    ...
    string public tokenName = "Borzoi Inu";
    ...
    // CONSTRUCTOR ------------------------------------------------------------------------------------------
    constructor() ERC20("Borzoi Inu", "BORZOI") {
        // set owner
        owner = msg.sender;
        ...
        // 4% on SELL
        // 0% on Transfer
        _feesRates = Fees({buyFee: 400, sellFee: 9900, transferFee: 0});
