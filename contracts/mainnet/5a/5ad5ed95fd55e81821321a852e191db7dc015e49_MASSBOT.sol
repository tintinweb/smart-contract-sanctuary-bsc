...
contract MASSBOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " MASSBOT ";
    string private _symbol = "MBOT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x177Dc504D0dA58AA6ef760cB23821809955814d7); 
    address payable public teamWalletAddress = payable(0x177Dc504D0dA58AA6ef760cB23821809955814d7); 
