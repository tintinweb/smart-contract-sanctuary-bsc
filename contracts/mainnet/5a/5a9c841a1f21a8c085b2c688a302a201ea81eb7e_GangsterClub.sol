...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd74d57eB4Cff403B583fE458602653eF372F26C4; // owner address
...
contract GangsterClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GangsterClub";
    string private _symbol = "$GCLUB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46CeD3Ee976BaeB6F301676Ffc3aD76d9B06B927); // Marketing Address
    address payable public teamWalletAddress = payable(0x21EBbe83F43d18d99f89Cd58971914938562985f); // Team Address
