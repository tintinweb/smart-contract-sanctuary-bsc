...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71a914945a11B1a204602055A56c4C2328828409;
...
contract PINATA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4C12f78Dc68F85fA6bA1D9F1021Cf8Cfe56894cd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 250000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PINATA";
    string private _symbol = "PNA";
