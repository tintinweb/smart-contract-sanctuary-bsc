...
contract GANTZ is GANTZDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GANTZTeam;
    address private CharityGANTZ;
    ...
    string public override name = "GAMEANTZ";
    string public override symbol = "GANTZ";
    ...
    constructor(uint totalSupplyValue, address GANTZTeamAddress, address CharityGANTZAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GANTZTeam = GANTZTeamAddress;
        CharityGANTZ = CharityGANTZAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GANTZTeam] =  totalSupply * 4 / 100;
        balances[CharityGANTZ] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GANTZTeam pot
