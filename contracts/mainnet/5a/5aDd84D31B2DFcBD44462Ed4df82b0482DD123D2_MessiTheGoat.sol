...
contract MessiTheGoat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Messi The Goat";
    string private constant _symbol = "MESSI GOAT";
