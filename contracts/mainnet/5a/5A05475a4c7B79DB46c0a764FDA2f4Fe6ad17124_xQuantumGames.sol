...
contract xQuantumGames {
    ...
    IERC20 public constant BUSD = IERC20(0x55d398326f99059fF775485246999027B3197955); // mainnet USDT contract on BSC
    IERC20 public constant XQZS = IERC20(0x58f26DC61943698B565473057FADa470f16f6722);  //xqzs token adress

    address private _owner; // contract deployer
    ...
    function purchaseMonthlyPackage(Package packageType, address _ref) external {
        ...
        if(_ref!=address(0))
        {
            ...
            BUSD.transferFrom(msg.sender, _owner, amount90);
            XQZS.transfer(msg.sender, packageOne ? GIFT_AMOUNT_PACKAGE_ONE : GIFT_AMOUNT_PACKAGE_TWO);
            
        }else{
            BUSD.transferFrom(msg.sender, _owner, purchaseAmount);
            XQZS.transfer(msg.sender, packageOne ? GIFT_AMOUNT_PACKAGE_ONE : GIFT_AMOUNT_PACKAGE_TWO);
        }
