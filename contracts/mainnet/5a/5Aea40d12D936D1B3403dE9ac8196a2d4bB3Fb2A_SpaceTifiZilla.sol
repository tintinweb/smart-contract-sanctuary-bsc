...
/*
    ...
    SpaceTifiZilla
    Telegram : https://t.me/SpaceTifiZilla
...
contract SpaceTifiZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceTifiZilla";
    string private _symbol = "SpaceTifiZilla"; //SpaceTifiZilla
    ...
    uint256 private _totalSupply = 100000000 * 10**10 * 10**_decimals;
    uint256 public _maxTxAmount = 10 * 10**10 * 10**_decimals; //100000000000
    uint256 public _walletMax = 25 * 10**10 * 10**_decimals;   //250000000000
    uint256 private minimumTokensBeforeSwap = 10 * 10**10 * 5 **_decimals; 
    ...
    constructor (address RandomContract) {
