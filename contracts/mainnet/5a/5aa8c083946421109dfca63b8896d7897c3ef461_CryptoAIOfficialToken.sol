...
// https://cryptoai.gitbook.io/cryptoai-whitepaper-v.1.0/
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface CryptoAIOfficial {
...
contract CryptoAIOfficialToken is CryptoAIOfficial {
    ...
    string public override name = unicode"CryptoAI";
    string public override symbol = unicode"CryptoAI";
