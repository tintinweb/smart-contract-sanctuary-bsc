...
contract dzz is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x5167a4891fAbbFd62BDbF43D2d2F31d3b2f93a65);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;
    
    address public fund1Address = address(0x5091a146f50e9513bdB04528dc8bD63DA4e17156);
    
    address public fund2Address = address(0xFef78ca26B4860031107E36E1767c57F250C96e3);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _inviterFee + _fund1Fee + _fund2Fee;
        }
