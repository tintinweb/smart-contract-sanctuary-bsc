...
─────────▀▀▀▀────────▀▀▀▀
    ...
    Official Community : https://t.me/miniontwo
    Twitter Account : https://twitter.com/miniontwo_bsc
    Official Website : https://miniontwo.wtf
...
contract MINIONTWO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0418E9435E3b9467466A6c3A32133ceC0Ffd1Bf2); 
    address payable private Wallet_Dev = payable(0x06Ff069B9a4a4AD46B063775F612D234B911B109);
    ...
    string private constant _name = "MINION 2.0 "; 
    string private constant _symbol = unicode"MINION 2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x06Ff069B9a4a4AD46B063775F612D234B911B109;
