...
// https://t.me/SpaceDogeX_Official

// https://twitter.com/0xspacedogex
...
contract SpaceDogeX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb213FeCdD508ce84C06BAc6D80007728dF88d075); 
    address payable public Wallet_Team = payable(0x0ff5f3C21be7215C7Ba03a45c7E1cb6420A64Ef1);
    address payable public constant Wallet_Zero = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x60e917fecCDE442ACf5e79Fae855c3604160bC7f); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "SpaceDogeX"; 
    string private constant _symbol = unicode"SDOGEX"; 
    ...
    uint256 public Percent_Team = 25;
    uint256 public Percent_Zero = 0;
    uint256 public Percent_Liquidity = 15; 
    ...
    constructor () {
        ...
        _owner = 0x60e917fecCDE442ACf5e79Fae855c3604160bC7f;
