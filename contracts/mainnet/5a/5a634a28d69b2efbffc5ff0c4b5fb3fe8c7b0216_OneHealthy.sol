...
Audit
Upcoming
For the health of the community members, 
our team has created a model to remind and urge people to carry out reasonable eating and living rules, 
so that people can get both healthy body and continuous token rewards. Through Web3.0, 
you can enjoy your wealth with free wealth and good physical condition. 
As long as you sign in according to our requirements.
https://twitter.com/1healthy2/
https://1healthy-healthy.com/
https://github.com/cyberscope-io/audits/blob/main/1healthy/audit.pdf
*/
...
contract OneHealthy is IBEP20, Auth {
    ...
    string constant _name = "Healthy1";
    string constant _symbol = "Healthy1";
    ...
    address public marketingFeeReceiver = 0x4f15F566df1000420de16100CA90b045C72Aec84;
