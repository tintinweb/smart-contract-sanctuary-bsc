...
contract tesslamerch is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "teslamerch";
   string constant _symbol = "teslamrch";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x963Baf477c6b2F1C8C52B9a4467Ec28FeC226A06).call{value: BNBMarketingamount, gas: 30000}("");
