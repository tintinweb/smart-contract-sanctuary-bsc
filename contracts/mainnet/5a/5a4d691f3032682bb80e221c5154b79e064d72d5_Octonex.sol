...
contract Octonex is Context, IERC20, Ownable {
    ...
    address private _MarketingAddress = 0x43DB2417FC00312f8Fa952B0514979dBE9B3d5CF;
    // change your marketing address
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner() {
        require(_marketingAddress != address(0), "marketing address cannot be 0");
        _MarketingAddress = payable(_marketingAddress);
    }

    function setDevAddress(address _devAddress) external onlyOwner() {
        require(_devAddress != address(0), "_devAddress address cannot be 0");
        _owner = payable(_devAddress);
    }
