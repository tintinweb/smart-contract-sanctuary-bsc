...
contract DogeSpider is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeSpider";
    string private constant _symbol = "DOGE SPIDER";
    ...
    address private marketingWallet = address(0xC522969CedB4E1224875218af8D2bFcd9901e0Ba);
    address private liquidityReceiver = address(0xC522969CedB4E1224875218af8D2bFcd9901e0Ba);
