...
contract RatBoyMerge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatBoy Merge";
    string private _symbol = "The WENTXN Merge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD875d5fD6C088D10cC77CDe3f759757d17841982); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD875d5fD6C088D10cC77CDe3f759757d17841982); // buyback Address
