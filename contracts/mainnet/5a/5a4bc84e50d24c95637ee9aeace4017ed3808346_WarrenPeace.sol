...
contract WarrenPeace is Context, IERC20, Ownable {
    ...
    string private constant _name = "Warren Peace"; // 
    string private constant _symbol = "$WAPEA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x290CE431a1e1E6C7ac936aCCD2A95Fd245A0ea66;
