...
/**
 ...
 #TwitterDOGE
   ...
   #TwitterDOGE features:
   1% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders
   I created a black hole so #TwitterDOGE token will deflate itself in supply with every transaction
...
contract TwitterDOGE is TokenBEP20 {
