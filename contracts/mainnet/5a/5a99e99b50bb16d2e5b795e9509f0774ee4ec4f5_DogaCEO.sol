...
contract DogaCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xD91d42b2C3Cb813663cAFc91e62c5122BdAcD2Fd;

    string private constant _name = "DogaCEO";
    string private constant _symbol = "DogaCEO";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // default is tax 5% reflection, 5% marketing
