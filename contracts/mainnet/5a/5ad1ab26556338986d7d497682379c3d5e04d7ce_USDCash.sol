...
contract USDCash is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "USDCash";
    string private constant _symbol = "USDC";
    uint8 private constant _decimals = 9;
    uint private _totalSupply = 10000000000 * 10 ** _decimals;
    ...
    constructor () {
        ...
        emit Transfer(address(0), Admin, _totalSupply);
              ...
              uint burnamount = _totalSupply.mul(40).div(100);
