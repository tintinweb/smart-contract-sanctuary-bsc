...
contract Coupledoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Coupledoge";
    string private _symbol = "Coupledoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F3235a6d8a008Dc4C7d096F5985547174BaaEa4);
    address payable public teamWalletAddress = payable(0xFF18411346Cba73eaBfB7adE986cAd1D1BEcAbCe);
