...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = " Sincere Cat ";
    string private _symbol = " sCat ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x316accC4d7DbD9c7A35430629E3E2896CfF86A0A);
    address payable public teamWalletAddress = payable(0x316accC4d7DbD9c7A35430629E3E2896CfF86A0A);
