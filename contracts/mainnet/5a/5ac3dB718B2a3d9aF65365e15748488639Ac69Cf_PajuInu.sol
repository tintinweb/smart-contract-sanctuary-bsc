...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9aC5ab024D101869641A78871EE0b29F2521750a; // owner address
...
contract PajuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Paju Inu";
    string private _symbol = "PAJUINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9aC5ab024D101869641A78871EE0b29F2521750a); // Marketing Address
    address payable public teamWalletAddress = payable(0x9aC5ab024D101869641A78871EE0b29F2521750a); // Team Address
