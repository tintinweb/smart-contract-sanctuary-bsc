...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x925142B6d65c56AFfbEc7350079c690389aEcc13; // owner address
...
contract POR is Context, IERC20, Ownable {
    ...
    string private _name = "Proof Of Reserves";
    string private _symbol = "POR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x925142B6d65c56AFfbEc7350079c690389aEcc13); // Marketing Address
    address payable public teamWalletAddress = payable(0x925142B6d65c56AFfbEc7350079c690389aEcc13); // Team Address
