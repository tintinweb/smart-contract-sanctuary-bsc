...
contract ZedFlow is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 2000000 * 10**3 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Zed Flow';
    string private _symbol = 'ZFLOW';
