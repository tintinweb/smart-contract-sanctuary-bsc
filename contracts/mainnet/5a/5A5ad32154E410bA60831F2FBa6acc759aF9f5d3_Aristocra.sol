...
contract Aristocra is AristocraDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private AristocraTeam;
    address private CharityAristocra;
    ...
    string public override name = "Aristocrats ";
    string public override symbol = "Aristocra";
    ...
    constructor(uint totalSupplyValue, address AristocraTeamAddress, address CharityAristocraAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        AristocraTeam = AristocraTeamAddress;
        CharityAristocra = CharityAristocraAddress;
       
        // split the tokens according to agreed upon percentages
        balances[AristocraTeam] =  totalSupply * 4 / 100;
        balances[CharityAristocra] = totalSupply * 4 / 100;
