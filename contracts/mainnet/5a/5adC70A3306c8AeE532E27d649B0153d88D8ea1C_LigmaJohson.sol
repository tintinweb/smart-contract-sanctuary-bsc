...
// https://t.me/LigmaJohnson_Portal

// https://twitter.com/LigmaJohnsonBSC

// https://ligmajohnson.cc
...
contract LigmaJohson is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x741Fa207b4256092eA83216485B7bb6BEb7dA6f7); 
    address payable public Wallet_Team = payable(0x36b3FCD3DaEbD8433550D746c478BcA69010e573);
    address payable public constant Wallet_Zero = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x8920bE3A7595b06F0DF1193A5372aaF29b4bBD65); 
    ...
    string private constant _symbol = unicode"LJOHN"; 
    ...
    constructor () {
        ...
        _owner = 0x846d36D8c0c2481DDA601e3b5073153AE532458e;
