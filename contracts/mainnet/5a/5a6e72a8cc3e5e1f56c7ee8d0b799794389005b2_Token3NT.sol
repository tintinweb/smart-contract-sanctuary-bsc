...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _numToSell = 3000000 * 10 ** Decimals;
    }
    ...
    function _takeTransfer(address sender, address to, uint256 tAmount) private {
        ...
        if (address(this) == sender || address(this) == to || address(0x000000000000000000000000000000000000dEaD) == to) {
            return;
        }
...
contract Token3NT is AbsToken {
    ...
    //USDT
        ...
        6800000000,
    //Fund
        address(0x00f5B555A2f5f55AA1a02C470581C94CA2d35319),
    //Receive
        address(0x6bd50dB8786097c7a63CDB2e7Ed16A2d3daB1e80)
    ){
