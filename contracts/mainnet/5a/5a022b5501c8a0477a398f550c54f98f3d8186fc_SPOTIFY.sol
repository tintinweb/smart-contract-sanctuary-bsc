...
contract SPOTIFY is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD1dd001913018ff37F089Bf440ecb14f3f92be7f;

    string private constant _name = "FUCK SPOTIFY";
    string private constant _symbol = "SPOTIFY";
    ...
    Taxes public taxes = Taxes(0,13,2,0);
