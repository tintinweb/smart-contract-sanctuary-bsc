...
/*
One of the main issues cryptocurrency projects face is the lack of continuous volume. This problem dampens marketing and development during low-volume days/weeks or even months

Shinjiro Inu solves this by hedging a portion of the marketing wallet into Yield bearing assets to generate additional income that can be used to develop further, Market, and in the future, reward holders with BSC through Shinjiro

10% Liquidity Pancake
90% Token Burned

 Ownership Renounce | Liquidity Lock | Low Taxes 4/4


Telegram : https://t.me/ShinjiroInu

Twitter : https://twitter.com/ShinjiroInu

Website : https://shinjiroinu.com
*/
...
contract ShinjiroInu is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 99999 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private maxWallet;

    string private _name = "Shinjiro INU";
...
//Remove from Blacklist
    ...
    function setMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 99999 * 10 ** _decimals * maxTx / 1000;
    }
    ...
    function _transfer(
        ...
        if (from == V2Pair && to != address(uniswapV2Router)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2Pair && recipient != address(uniswapV2Router);
