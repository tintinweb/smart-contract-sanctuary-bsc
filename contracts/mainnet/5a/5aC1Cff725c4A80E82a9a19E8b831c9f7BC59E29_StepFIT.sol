...
contract StepFIT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StepFIT";
    ...
    uint256 _totalSupply = 24000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xA160116C4c889e33506bd03E9123e3770969cCC9;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        ...
        totalFeeIfSelling = totalFee.add(extraFeeOnSell);
        require(totalFee <= 25, "Must keep fees at 25% or less");
        require(totalFeeIfSelling <= 25, "Must keep fees at 25% or less");
    }
