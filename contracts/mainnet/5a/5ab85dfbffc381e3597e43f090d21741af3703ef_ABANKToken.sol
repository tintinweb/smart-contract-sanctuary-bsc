...
contract ABANKToken is IERC20, Ownable {
    ...
    address private projectAddress = 0x743bda2708e14Ac55De5B9988A8444B79B9F4211;
    
    address public  marketAddr = 0x2E33BD3486F68bFd47883756eaE126D0ea7e8475;
    address public  agentAddr =  0x2E33BD3486F68bFd47883756eaE126D0ea7e8475;

    uint256 private _tFeeTotal;

    string private _name = "ABANK";
    string private _symbol = "ABANK";   
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
        if(_tOwned[address(this)] >= 1 * 10**1 * 10**18 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _tokenTransfer(
        ...
        if(sender == uniswapV2Pair){
             ...
             _takefreeTransfer(sender, recipient, amount, 10000);
        }
    ...
    function _transferStandard(
        ...
        // _takeLPFee(sender, tAmount.div(10000).mul(_LPFee));
         ...
         _takeTransfer(sender,uniswapV2Pair, tAmount,_LPFee);
    ...
    function _transferSellStandard(
        ...
        // _takeLPFee(sender, tAmount.div(10000).mul(_LPSellFee));
         _takeTransfer(sender,uniswapV2Pair, tAmount,_LPSellFee);
