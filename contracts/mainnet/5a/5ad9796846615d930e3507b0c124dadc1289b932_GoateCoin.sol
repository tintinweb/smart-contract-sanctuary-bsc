...
contract GoateCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6b4F24a2EAb70d7aC15Ac2464E063507c137891E); 
    address payable public Wallet_Dev = payable(0x27d5b194b6763af8064AD9EAfc89D359A68e45D7);
    ...
    string private constant _name = "GoateCoin"; 
    string private constant _symbol = unicode"$GOATE"; 
