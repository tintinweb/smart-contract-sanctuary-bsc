...
contract ApesGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Apes Grow";
    string private _symbol = "APEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x590741945B4277C59A2062e8ab4bf6c37a867a05); 
    address payable public buyBackWalletAddress = payable(0x590741945B4277C59A2062e8ab4bf6c37a867a05); 
