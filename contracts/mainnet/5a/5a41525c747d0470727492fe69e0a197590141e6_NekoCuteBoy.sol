...
contract NekoCuteBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NekoCuteBoy";
    string private _symbol = "NekoBoy";
