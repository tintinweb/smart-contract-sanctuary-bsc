...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     *
     * The default value of {decimals} is 0. To select a different value for
...
contract Coke is ERC20, Ownable {
    ...
    address public marketingWalletAddress =
      0x547e015843B6a414ceDd29FE1cd2446eee5CEDA6;
    ...
    constructor() ERC20("Coke", "Coke") {
        _totalSupply = 5900000000000000000000000000000000000000 * (10**0);
        ...
        swapTokensAtAmount = 5900000000000000000000000000000000000000 * (10**0);
    ...
    function setSwapTokensAtAmount(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount * (10**0);
    }
...
contract dDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 21600;
        minimumTokenBalanceForDividends = 59000000000000000000000000000000000000 * (10**0); //must hold tokens for dividen
    }
    ...
    function setMinimumTokenBalanceForDividends(uint256 val)
        ...
        onlyOwner
    {
        minimumTokenBalanceForDividends = val * (10**0);
    }
        ...
        )
    {
        if (index >= MAPSize()) {
            return (
                0x18D526c127754fc2b6d126ce83843B4efF6F677E,
                -1,
                -1,
                0,
                0,
