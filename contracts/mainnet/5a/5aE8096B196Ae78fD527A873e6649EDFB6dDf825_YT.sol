...
contract YT is Context, IERC20, Ownable {
    ...
    string private _name = "YT";
    string private _symbol = "YT";
    ...
    uint256 private minimumTokensBeforeSwap = 100000 * 10**3 * 10**9; 
    
    address payable public marketingAddress = 0xc782c467Ba904F86f8E1b9D35026F0c129C11E68; //Marketing
