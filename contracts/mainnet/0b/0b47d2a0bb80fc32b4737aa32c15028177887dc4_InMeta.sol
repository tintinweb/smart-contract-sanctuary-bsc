...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCfc28D57E463b3b4Ac81F9eDc66e8a2a8B2C4c5E;
...
contract InMeta is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x395b564b58c9eF9E2c34F72aA00Be6d4fA8C8502;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "InMeta";
    string private _symbol = "INM";
