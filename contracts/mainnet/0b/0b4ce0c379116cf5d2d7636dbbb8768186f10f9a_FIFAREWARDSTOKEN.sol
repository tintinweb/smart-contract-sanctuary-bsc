...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2671a68b45DbeDf4cC199044571CC81FE620659A;
...
contract FIFAREWARDSTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6Cf4931172f3169F510cE121fe3c03874bB3008B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FIFA REWARDS TOKEN";
    string private _symbol = "FIFA RWD";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 35;
    ...
    uint256 private numTokensSellToAddToLiquidity = 150000000000000 * 10**18;
