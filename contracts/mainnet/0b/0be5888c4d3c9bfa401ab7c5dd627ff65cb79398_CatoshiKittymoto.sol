...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x0fcA66D0B66755e85a98B7644beff95eC7250000;
...
contract CatoshiKittymoto is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Taxcollector = payable(0x0fcA66D0B66755e85a98B7644beff95eC7250000);
    ...
    string private constant _name = unicode"CatoshiKittymoto"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Taxcollector, BNB_Tot);
