...
contract OPTILLA is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("Optimus Zilla", "OPTILLA") payable
    {
        ...
        // Buy Taxes
        buyTaxes["marketing"] = 700;
        buyTaxes["dev"] = 50;
        buyTaxes["liquidity"] = 50;

        // Sell Taxes
        sellTaxes["marketing"] = 800;
        sellTaxes["dev"] = 50;
        sellTaxes["liquidity"] = 50;

        // External wallets 
        taxWallets["marketing"] = 0x4b4Af67264AD7f448b784B97DdC4B4B31d23B43C;
        taxWallets["dev"] = 0xfc58273Fda5cB2615A4DBbF142b9BFf8309128F7;
