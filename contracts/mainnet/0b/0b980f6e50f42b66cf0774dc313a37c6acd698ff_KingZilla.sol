...
contract KingZilla is ERC20 {
	...
	address payable _receive = payable(address(0xbC1003B5901D6B838D19d5D16fA439020938bC9F));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("KingZilla", "KingZilla") {

        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf2B7Ad29dED190a6bA75C5BEd0660D0331d0607c);
