...
contract BKB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Keiko bsc";
    string constant _symbol = "BKB";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xe7C44Bf6D6eA9294530143A434915574828155aB;
