...
contract CZNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZNB";
    string private _symbol = "CZNB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB881c444D8aEd5a5BcFFCb02823abf48Ec376B10); 
    address payable private teamWalletAddress = payable(0xE0508547961313561A2867C8a10fD5675e2c6019); 
    ...
    uint256 public _walletMax = 1 * 10**8* 10**_decimals;
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            100000000000000000 == serviceFee_ ,
