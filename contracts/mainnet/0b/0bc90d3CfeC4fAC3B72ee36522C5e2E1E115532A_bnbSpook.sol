...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x39C40Da80DA21BFe4eE1D379f8afe9c0157b73c9;
...
contract bnbSpook is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"bnb-o-spook"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x39C40Da80DA21BFe4eE1D379f8afe9c0157b73c9), BNB_Tot);
            }
