...
The Chinese trickster god known as the Monkey King is coming to the ERC network. Born from a magical rock, he was thrown out of the Jade Emperor’s court for his impertinence, but eventually achieved enlightenment
 Socials:
 🦍Telegram: Https://t.me/SunwuKong_Erc
 🦍Twitter: Https://twitter.com/SunwuKong_Erc
 🦍Medium: https://medium.com/@SunwuKongEth
 🦍Tax 0%
 🦍Danger Trade High Bots snipping
*/
...
contract SunwuKong is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'SunwuKong';
    string private _symbol = 'SunwuKong';
