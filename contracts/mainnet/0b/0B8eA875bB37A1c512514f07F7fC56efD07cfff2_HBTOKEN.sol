...
contract HBTOKEN is Context, IERC20, Ownable {
  ...
  address public mainacc=0x5B022d6716aF42BdBb82D4c881331324Aa2F05aD;
...
//   address public mainacc=msg.sender;
  ...
  address public yxacc = address(0x5B022d6716aF42BdBb82D4c881331324Aa2F05aD);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if((sender==lp1 || sender==lp2) && _whiteaddress[recipient]!=true  && recipient!=autoaddress){
        _tokenTransfer(sender,autoaddress,amount.mul(5).div(100));
        _tokenTransfer(sender,yxacc,amount.mul(3).div(100));
