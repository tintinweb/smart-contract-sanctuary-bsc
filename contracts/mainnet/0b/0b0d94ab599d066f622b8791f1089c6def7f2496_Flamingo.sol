...
contract Flamingo is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "HLN";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xDf131C23DB9d05f15D897abCBa0d045178899DB8);
    address payable private _marketingAddress = payable(0xDf131C23DB9d05f15D897abCBa0d045178899DB8);
