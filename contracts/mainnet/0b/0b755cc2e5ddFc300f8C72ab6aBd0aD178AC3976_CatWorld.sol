...
contract CatWorld is Ownable, ERC721, ERC721Enumerable {
    ...
    // mint shares
    uint private _mintSharesTeam = 870;
    uint private _mintSharesReflect = 130;
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0x6ac366C4c18EBAaC22425cEAbF6fCc1f70D7370D).transfer((p*1000)/1000);
        _balanceTeam = 0;
    }
