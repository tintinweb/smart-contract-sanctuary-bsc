...
contract WinIphone is BEP20, Ownable {
    ...
    address public marketingWallet = 0x51D3D5690ce19a9fe9dC6E6b4E4965e19f35aAe5;
    address private buyBackWallet = 0x0B86F814D4227309999c74977045301d9815ce22;
    address public devWallet = 0xd1399AA795A60dC91c59FF51dAA0c29b01fE77dC;
    ...
    Taxes private taxes = Taxes(4, 3, 4, 1);
    Taxes private sellTaxes = Taxes(4, 3, 4, 1);
    ...
    constructor(address routerAdd) BEP20("WIN IPHONE", "WINIPHONE") {
    ...
    function updateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _buyBack, _liquidity, _dev);
        require((_marketing + _buyBack + _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _buyBack, _liquidity, _dev);
        require((_marketing + _buyBack + _liquidity + _dev) <= 30, "Must keep fees at 30% or less");
    }
