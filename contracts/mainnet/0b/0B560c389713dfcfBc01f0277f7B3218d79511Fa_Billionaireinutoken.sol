...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3DB46cF5F1c05e04CC18276E746C7884a124F724;
...
contract Billionaireinutoken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeF38814867aA828CB0f1769CfF3FCfB56e0a122a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Billionare INU";
    string private _symbol = "$Billions";
