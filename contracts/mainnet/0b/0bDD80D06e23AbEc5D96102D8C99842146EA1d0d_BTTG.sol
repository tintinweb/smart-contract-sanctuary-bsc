...
contract BTTG is IERC20, Ownable {
    ...
    uint256 public _buyswapFee = 10;
    uint256 public _sellswapFee = 10;
    ...
    constructor(address tokenOwner,address fundAddressA ) {
        _name = "BTTG";
        _symbol = "BTTG";
        _decimals = 18;
    ...
    function setMaxBuyAmount(uint256 newMax) public onlyOwner(){
     ...
     function kaishi(bool _kaishi)  public onlyOwner(){
         tradingIsEnabled=_kaishi;
    }
