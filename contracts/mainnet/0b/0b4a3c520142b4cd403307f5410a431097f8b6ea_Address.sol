...
// Telegram https://t.me/+8qyRQp9v8vRiNmVk
// WE CAN UPDATE THE NAME AND TICKER TO MATCH ELONS TWEET ABOUT FATHERS DAY
// NO marketing will be done before the tweet
// Chat will be closed and Opened a few hours before fathers day
...
contract TWEETTOKEN is Context, IERC20, Ownable {
    ...
    //
    string private _name = "TWEETTOKEN";
    string private _symbol = "TWT";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;
    //
    address payable public marketingAddress = payable(0x520d3E92e7B447C277bbEFB51bD7F2E9eE229Cf1);
    //
