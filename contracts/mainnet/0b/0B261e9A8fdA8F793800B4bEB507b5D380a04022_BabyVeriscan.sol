...
//https://t.me/OfficialBabyVeriscan
...
contract BabyVeriscan is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50 / 1000; // 5%
    ...
    string constant _name = "BabyVeriscan";
    string constant _symbol = "BVERISCAN";
    ...
    address public autoLiquidityReceiver = 0xCa3Fde259736dc270c06BD1bF92dDdd50645EDEB;
    address public marketingWallet =0xCa3Fde259736dc270c06BD1bF92dDdd50645EDEB;
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0xCa3Fde259736dc270c06BD1bF92dDdd50645EDEB;
        marketingWallet = 0xCa3Fde259736dc270c06BD1bF92dDdd50645EDEB;
