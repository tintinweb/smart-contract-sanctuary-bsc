...
/**
TG: https://t.me/+NXCfrz3-OoVhODE1
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF09e915AE261dfA2C277D5C380DB072B50dE9E47; // owner address
...
contract Dogevine is Context, IERC20, Ownable {
    ...
    string private _name = "DogeVine";
    string private _symbol = "$Dvine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe5B2699fd974371BDECD48fb37D6556b543a9Ea8); // Marketing Address
    address payable public teamWalletAddress = payable(0xe5B2699fd974371BDECD48fb37D6556b543a9Ea8); // Team Address
