...
/*
    ROYAL BOY INU - THE NEW KING IS HERE
    telegram      : https://t.me/RoyalBoyInu
    twitter       : https://twitter.com/RoyalBoyInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9347954081A2F056C42f477D0064B86b6ff9213A; // owner address
...
contract RoyalBoyInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ROYAL BOY INU";
    string private _symbol = "RoyalBoyInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9347954081A2F056C42f477D0064B86b6ff9213A); // Marketing Address
    address payable public teamWalletAddress = payable(0x9347954081A2F056C42f477D0064B86b6ff9213A); // Team Address
