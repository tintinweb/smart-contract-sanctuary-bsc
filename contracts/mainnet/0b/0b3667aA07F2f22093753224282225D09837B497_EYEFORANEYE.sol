...
contract EYEFORANEYE is IBEP20, Auth {
    ...
    string constant _name = "Eye for an Eye";
    string constant _symbol = "Elon";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 100;  // 8% max tx
    ...
    address private marketingFeeReceiver = 0x5385F3E30AEcC7c43a0da8b442A01E89C2d132A6;
    address private teamFeeReceiver = 0x3af2B576c46732e1cd112793D38FEa1C7cD442d6;
