...
contract LTCKING is ERC20 {
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("LTCKING", "LTCKING") {
        ...
        doge = IERC20(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94);
        uint256 total = 10**33;
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94);
