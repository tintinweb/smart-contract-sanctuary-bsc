...
// Telegram : https://t.me/bscrecoverplease   
...
contract RECOVER is Context, IERC20, Ownable {
    ...
    string private constant _name = "come on recover BSC.  we want to go back to All Time High, fuck the fed, the one that destroyed the market, fuck do kwon, fuck luna.  Bitcoin wasn't the only cryptocurrency to feel the initial effects, with most of the top 10 all experiencing dips in value.  we can definitely come back to all time high again, even more.  I hope so"; // 
    string private constant _symbol = "RECOVER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xc8B4CC29734d072Bb0C7671264bA6E1a508a6F81;
