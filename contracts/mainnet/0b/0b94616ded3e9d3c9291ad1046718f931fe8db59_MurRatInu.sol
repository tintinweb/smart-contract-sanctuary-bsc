...
contract MurRatInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MURRAT INU";
    string private _symbol = "WENTXN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x23e48B786cef5a00c67c7D7123A266c4946876c0);
