...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 500 * 10 ** IERC20(FISTAddress).decimals();
...
contract BABYCCGDS is AbsToken {
    constructor() AbsToken(
        ...
        unicode"BABY CCGDS",//Name
        unicode"BBCCGDS",//Symbol
        9,//Decimals
        10000,//Supply
        address(0x4426a63f538DB266a6991866Cf0d6ab00786F618),//FundAddress
        address(0x4426a63f538DB266a6991866Cf0d6ab00786F618)//ReceiveAddress
    ){
    }
}