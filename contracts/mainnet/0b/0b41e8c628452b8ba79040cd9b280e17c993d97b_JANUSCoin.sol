...
contract JANUSCoin is JANUSDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private JANUSTeam;
    address private CharityJANUS;
    ...
    string public override name = "JanusSpans";
    string public override symbol = "JANUS";
    ...
    constructor(uint totalSupplyValue, address JANUSTeamAddress, address CharityJANUSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        JANUSTeam = JANUSTeamAddress;
        CharityJANUS = CharityJANUSAddress;
       
        // split the tokens according to agreed upon percentages
        balances[JANUSTeam] =  totalSupply * 4 / 100;
        balances[CharityJANUS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's JANUSTeam pot
