...
/*
TELEGRAM : https://t.me/satoshinekomotoofc
*/
...
contract SatoshyNekomoto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Satoshi Nekomoto ";
    string private _symbol = "satoshinekomoto";
