...
contract XRPSHIBA is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5_000_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xc51D4e1c26c732262e5b571B73633e78Fe1BCc1E;
    address public donationWallet = 0xc51D4e1c26c732262e5b571B73633e78Fe1BCc1E;



    string private constant _name = "XRP SHIBA";
    string private constant _symbol = "XRPS";
    ...
    Taxes public taxes = Taxes(0, 9, 3, 0);
    Taxes public sellTaxes = Taxes(0, 9, 3, 0);
