...
//Brooklynholdingscoin.sol

contract Brooklynholdingscoin  is Context, IERC20, IERC20Metadata, Ownable{
    ...
    constructor () {
        _name = "Brooklyn holdings coin";
        _symbol = "BHC";
        _totalSupply;
        _mint(owner(), 17830000 * 10 ** (decimals()) ); 
