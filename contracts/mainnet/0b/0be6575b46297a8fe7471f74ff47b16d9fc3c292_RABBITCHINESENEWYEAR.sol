...
Telegram https://t.me/rabbitchinesenewyear
Website 
*/
...
contract RABBITCHINESENEWYEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RABBIT CHINESE";
    string private _symbol = "$RABC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5a770BA4A8A7128AcA926415591f33B6e0f777f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD5a770BA4A8A7128AcA926415591f33B6e0f777f); // BuyBack Address
