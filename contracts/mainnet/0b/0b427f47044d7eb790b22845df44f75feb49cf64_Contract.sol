...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunar New Year Inu"; //
    string private constant _symbol = "LNY Inu"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x163c0E0AbeB604bB17750EaaC78424d9c576c37D;
