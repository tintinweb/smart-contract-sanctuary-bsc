...
/**
 PROT DAO will be the first project to carry out reviving legendary 
 games engraved in the minds of fans. The legendary PROT DAO GameFi will 
 be launched by us soon, to become one of the fastest growing cryptocurrencies today. 
 Prot Dao is revival, revolution, development. Let’s be a warrior with Prot Dao, 
 fight battles you can win, think of it as a revival of the old and ruined world. Potential Prot 
 DAO project with NFT mint, NFT Marketplace, Dapp for NFT and earning, swap and more to come.
 https://protdao.us/
 PROT DAO
@ProtDao

🔥PROT DAO NFT-TO-EARN🔥
 
We revive the PROT DAO and Thaddeus 'Thunderbolt' Ross is one of the warriors of the PROT Community
 
PROT DAO HIGHLIGHT
🔸NFT to earn
🔸NFT mint, NFT Marketplace
🔸Dapp for NFT and earning, swap
🔸Big Partner & KOLs
*/
...
contract PROTDAO is NFTDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private NFTTeam;
    address private CharityNFT;
    ...
    string public override name = "PROT DAO";
    string public override symbol = "PRD";
    ...
    constructor(uint totalSupplyValue, address NFTTeamAddress, address CharityNFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        NFTTeam = NFTTeamAddress;
        CharityNFT = CharityNFTAddress;
       
        // split the tokens according to agreed upon percentages
        balances[NFTTeam] =  totalSupply * 45 / 100;
        balances[CharityNFT] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's NFTTeam pot
