...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x681b7B2165c944b89A0E114B636442Ce253e5f37; // 
...
contract EcuadorInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ecuador Inu";
    string private _symbol = "$EINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x681b7B2165c944b89A0E114B636442Ce253e5f37); // Marketing Address
    address payable public teamWalletAddress = payable(0x681b7B2165c944b89A0E114B636442Ce253e5f37); // Team Address
