...
contract OSKDW is ERC20 {
    ...
    uint256 public lpDivdendFee = 20;
    ...
    uint256 public totalFee = lpDivdendFee+marketingFee;

    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IERC20 public OSK = IERC20(0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da);
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketAddress = 0x24cAA4ae1352cbBECfA34CabBb59701220afcE42 ;
    ...
    constructor() ERC20("OSK-DW", "OSK-DW") {
        ...
        _tokenOwner = address(0x6ccE4695D4803CDCfAed4CDAaA90a9c92A8601e4);
    ...
    function setFees(uint256 _lpDivdendFee,uint256 _marketingFee) external onlyOwner{
        lpDivdendFee = _lpDivdendFee;
        marketingFee = _marketingFee;
        totalFee = lpDivdendFee+marketingFee;
    }
    ...
    function _transfer(
        ...
        if (takeFee) { 
            if(ammPairs[to] || ammPairs[from]){
                ...
                super._transfer(from, address(this), rate.mul(totalFee));
                feeAmount = feeAmount.add(rate.mul(totalFee));
                amount = amount.sub(rate.mul(totalFee));
            }
        }
