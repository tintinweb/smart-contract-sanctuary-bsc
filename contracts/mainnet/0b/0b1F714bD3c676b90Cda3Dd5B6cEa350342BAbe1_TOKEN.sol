...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0xD29A84f98AB11F9b1fe4df78d978C29C5Ddf11cA;
    }
}
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 900000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "Burnt Hair";
    string private _symbol   = "BURNT";
