...
/*
Binance Smart Chain charts have been on complete fire lately
but is Binance back and ready to take over again?
Are the Bullish communities back in control like the 
old days? Lets give it a test run! Im gonna launch and lock 
for 3 days at 2,000, 25,000 7 days, 50,000 14 days and take it from there!
No Telegram set up I want to see if the old Binance Smart Chain is back and the community
does a take over! Are the horns back on the BULLS of Binance!
*/
...
contract BscReborn is IBEP20, Auth {
    ...
    string constant _symbol = "BscReborn";
    ...
    address private marketingFeeReceiver = 0x262Ef99052Ee4b779e884547bdFBf74a08a12863;
    address private buybackFeeReceiver = 0xF22160C7496cC2776EE939C10FC6bA2A8a0Db536;
    address private DevFeeReceiver = 0xE8eCbEA83c0754c4751dF21Beff730226FC1d34C;
