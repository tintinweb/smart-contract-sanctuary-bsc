...
//Telegram : https://t.me/Hamstersarabianbsc
...
contract HamstersArabian is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc8469c1e3a228e9867a9a2265BF7C9bACb6912e0); 
    address payable public Wallet_Dev = payable(0x228aA2dF7cA1e20844835C27372E3927B3161B22);
    ...
    string private constant _name = "Hamsters Arabian"; 
    string private constant _symbol = unicode"hamsters arabian"; 
    ...
    constructor () {
        ...
        _owner = 0x228aA2dF7cA1e20844835C27372E3927B3161B22;
        ...
        uniSwapV2Pair = payable(0x228aA2dF7cA1e20844835C27372E3927B3161B22);
