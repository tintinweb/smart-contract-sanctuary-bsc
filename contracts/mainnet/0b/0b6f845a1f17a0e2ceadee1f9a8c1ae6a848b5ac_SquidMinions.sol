...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Rewards Token if activated
...
contract SquidMinions is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Minions";
    string constant _symbol = "SQUIDMINIONS";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 420 * 10**18 * 10**_decimals; 
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 10000; // 2%    
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x678e4bE8804F572D01DFe798c9F69a897b750b04;
        marketingFeeReceiver = 0xBe2567a7235a2A5C4D9f6A0E2B10CD16c2670BCc;
        teamFeeReceiver = 0x98d35ac2B08B25D2b42e3BEEA7e6114ad18B40ed;
        charityFeeReceiver = 0x98d35ac2B08B25D2b42e3BEEA7e6114ad18B40ed;
