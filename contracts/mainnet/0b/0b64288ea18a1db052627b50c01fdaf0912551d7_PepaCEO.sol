...
contract PepaCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepa CEO";
    string private constant _symbol = "PEPACEO";
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if(launched && !phaseOne && block.timestamp > launchEpoch + 4) {
                buyFee.liquidity = 1;
                buyFee.marketing = 3;
    ...
    function swapBack(uint256 tokenAmount) private {
        uint256 contractBalance = tokenAmount;
