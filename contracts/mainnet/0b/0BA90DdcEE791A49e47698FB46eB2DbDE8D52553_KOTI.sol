...
contract KOTI{
    ...
    uint public currentPrice=0.18 * 1 ether;
    uint public boughtAtPrice=0.09 * 1 ether;
    string public string1;
    string public string2;
    address payable public currentOwner=payable(0xF8A78024B04C95325b4eDeD0AD0F3FDc2938557a);
