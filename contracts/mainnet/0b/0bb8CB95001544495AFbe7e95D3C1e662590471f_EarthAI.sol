...
contract EarthAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "EarthAI";
    string private constant _symbol = "EAI";

    address public _PancakeSwapV1RouterUniswap = 0x03F9Df6D42bD21A9761165Ed6ea297247F88e3C2; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x03F9Df6D42bD21A9761165Ed6ea297247F88e3C2; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x03F9Df6D42bD21A9761165Ed6ea297247F88e3C2)] = true; //uniswap router liquidity
