...
contract JumpnUnstakeToken is IBEP20, Auth {
    using SafeMath for uint256;

    address public REWARD = 0x156ab3346823B651294766e23e6Cf87254d68962; //LUNA
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MKT  = 0xe7E21bCf8F021d77c34dBfedbc026afC2809D6bD;   

    string constant _name = "Jumpn Unstake Token";
    string constant _symbol = "JUT";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && buyCooldownEnabled && !isTimelockExempt[sender]) {
            require(cooldownTimer[sender] < block.number,"Please allow time between sales");
    ...
    function clearBalance(address _tokenAddress) external onlyOwner {
        ...
        IBEP20(_tokenAddress).transfer(marketingFeeReceiver, amount);
    }
