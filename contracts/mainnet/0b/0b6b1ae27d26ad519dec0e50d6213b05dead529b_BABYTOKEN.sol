...
/**   // SPDX-License-Identifier: MIT
     ...
     Telegram : https://t.me/RabbitCoinCh
     
     Rabbit Coin ; RBBT
     Supply 88.000.000.000
     Decimals 9
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    string private _symbol = "RBBT";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 88 * 10**9 * 10**_decimals;

    address payable private marketingaddresswallet =
        payable(0xe56BB116f51f72607745cee206455bbeFF4C7B6D);
