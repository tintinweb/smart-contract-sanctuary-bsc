...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd7741b96C4519b5bdb04d4DBb20579Af6fBffeaD;
...
contract DLKM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x97a070db7aBef161C4f2547afE991ba4dF62B619;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DLKM NOW";
    string private _symbol = "DLKM";
