...
contract MOONSLOTH is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MOONSLOTH";
    ...
    address private MSdevelopmentwallet;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4900595959e5B26e727604d178cB0dFA6be48e54;
        marketingWallet = 0xB416d413a330287953d0902b0956ADA6e96c935D;
        MSdevelopmentwallet = 0xB416d413a330287953d0902b0956ADA6e96c935D;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newMSdevelopmentwallet) external authorized {
        autoLiquidityReceiver = newLiquidityReceiver;
        marketingWallet = newMarketingWallet;
        MSdevelopmentwallet = newMSdevelopmentwallet;
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(MSdevelopmentwallet).call{value: anothermarketingShare, gas: 30000}("");
