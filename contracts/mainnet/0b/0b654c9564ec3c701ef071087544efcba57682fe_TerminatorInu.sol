...
/* Token contract */
contract TerminatorInu  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x9a8D1548a8e85c166865089969cdC8e137Afe1dD;
    ...
    // Name and symbol
    string constant _name = "Terminator Inu";
    string constant _symbol = "TERMINATOR";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (200 mill)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mill)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (200 mill)
