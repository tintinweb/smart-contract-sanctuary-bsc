...
/**
Welcome to Queen Elizabeth Statements https://t.me/QueenElizabethStatements
*/
...
contract QueenElizabethStatements is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "QueenElizabethStatements";
    string constant _symbol = "QUEENS";
