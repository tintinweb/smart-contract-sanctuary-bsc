...
contract GNA is Context, IERC20, Ownable {
	...
	address public lpAddress = address(0xd10b74684863E297796Ed9fD6c1f630efaa176a3);

    address public lpAddress2 = address(0xd10b74684863E297796Ed9fD6c1f630efaa176a3);
	
	address public nftAddress = address(0xDBce9a1D644765F2b198E79376987c587c992319);

    address public oskAddress = address(0xC5db5aFee4C55DfAD5F2b8226C6ac882E6956a0A);

    address public backAddress = address(0xcB3546122dD9C81B06aE3712d40E9F5350820FE0);
