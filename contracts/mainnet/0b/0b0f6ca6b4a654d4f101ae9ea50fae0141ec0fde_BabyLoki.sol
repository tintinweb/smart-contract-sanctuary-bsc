...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 loki = IBEP20(0xF7fDFb8454E900294dDbe06E84821f8B787217cD);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = loki.balanceOf(address(this));
        ...
        uint256 amount = loki.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            loki.transfer(shareholder, amount);
...
contract BabyLoki is IBEP20, Auth {
    using SafeMath for uint256;

    address loki = 0xF7fDFb8454E900294dDbe06E84821f8B787217cD;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Loki";
    string constant _symbol = "Boki";
