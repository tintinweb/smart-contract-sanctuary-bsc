...
https://t.me/QatarNomics2022

Launch by @DegenHubCalls
...
contract $QTNC is Context, IERC20, Ownable {
    ...
    string private constant _name = "QatarNomics";
    string private constant _symbol = "$QNOMS";
    ...
    address private marketingWallet = address(0x426e56C8204f18982674a9f644B95C109424627a);
