...
// telegram : https://t.me/StarlinkPow
...
contract StarlinkPow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x49Db0cCa2FAfD68322DDB1d12095e7E3ED920c49); 
    address payable public Wallet_Dev = payable(0xe6239b4240cF704c316F788d8062C2db606B6713);
    ...
    string private constant _name = "StarLink Pow"; 
    string private constant _symbol = unicode"SLPw"; 
    ...
    constructor () {
        ...
        _owner = 0x3A78E02B0A0948bCB42b890308F3148dF33E310F;
