...
contract ToscaMuskCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tosca Musk Coin";
    string private _symbol = "TMC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5a1C8971396060aDcf345fcD269DEe8e9A3336aF);
