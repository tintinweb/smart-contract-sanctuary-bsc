...
contract NOWKOD is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "NOWKOD";
    string private constant _symbol = unicode"NOWKOD";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0x7407501778a79132029d33B390e25f26D7225336);
    address payable private MarketingWallet = payable(0x7407501778a79132029d33B390e25f26D7225336);
