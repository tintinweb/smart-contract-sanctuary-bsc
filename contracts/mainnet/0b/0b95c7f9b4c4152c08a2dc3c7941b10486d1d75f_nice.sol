...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x722576642fe0FC8274200A1e4D5cB1531f899a2A;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x722576642fe0FC8274200A1e4D5cB1531f899a2A),//fund 

        address(0x722576642fe0FC8274200A1e4D5cB1531f899a2A)//dev 
    ){
