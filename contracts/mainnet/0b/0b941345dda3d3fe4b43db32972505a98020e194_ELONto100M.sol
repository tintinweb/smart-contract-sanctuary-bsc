...
*/
 ...
 /** Elon to 100M Followers

 https://www.youtube.com/watch?v=OIPD4nZVfqA
 
 /** Elon Musk is about to reach 100 million Twitter followers.

    Chances are, he’ll tweet this milestone…
    And we’re early for it!
    "Elon to 100M" is a 100% safe BSC project launched by a based team.
    ...
    Total Supply: 100,000,000,000
    Max Tx/Wallet :    3% (3,000,000,000)


// TG: https://t.me/ELONto100Mportal
...
contract ELONto100M is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON TO 100M";
    ...
    address private marketingWallet = address(0xc1BA99678AAcE31672C9A0FDA310f7641B4ca7Ed);
    address private liquidityReceiver = address(0xc1BA99678AAcE31672C9A0FDA310f7641B4ca7Ed);
