  ...
  , IERC20Metadata
{
  ...
  string private _name = "421";
  string private _symbol = "421";
  uint8 private _decimals = 18;
  uint256 private _totalSupply;
  uint256 private _taxBuy = 1;
  uint256 private _taxSell = 1;
  uint256 public _taxDivider = 100;
  uint256 public _taxSellTokenLimit = 10000000000000000000;
  uint256 public _maxTaxPercentage = 10;
  ...
  address public _rndWallet = 0x73dF4FE3099d87C4d00E3474b0c972a3ca9d64ab;
  address public _mktWallet = 0x8BA781D4e3fa50cfCBc426d9ff6ec2245C9362b5;
  ...
  constructor() {
    ...
    _mint(_msgSender(), 4210 * 10 ** uint256(_decimals));
  }
