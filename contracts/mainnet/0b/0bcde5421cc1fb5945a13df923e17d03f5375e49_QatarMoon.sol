...
contract QatarMoon
 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA7AD4dD1d4DD6cB2E7994176Ed6A83f5A1C227C0);
    address payable public teamWalletAddress = payable(0xA7AD4dD1d4DD6cB2E7994176Ed6A83f5A1C227C0);
    address public immutable deadAddress =0xA7AD4dD1d4DD6cB2E7994176Ed6A83f5A1C227C0;
