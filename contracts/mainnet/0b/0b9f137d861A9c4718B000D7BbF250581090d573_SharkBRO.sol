...
contract SharkBRO is Context, IERC20 { 
    ...
    uint256 private _tTotal = 5 * 10**15 * 10**_decimals;
    string private constant _name = "SharkBRO"; 
    string private constant _symbol = "$SharkBRO"; 
