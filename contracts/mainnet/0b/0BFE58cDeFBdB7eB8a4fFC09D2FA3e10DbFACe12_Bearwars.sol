...
TG : https://t.me/bearwars



WEBSITE: https://bearwars.online/



TWITTER :https://twitter.com/bearwarstoken
...
contract Bearwars is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x01c405203e2B23da196D926750b17515BeCe6517;



    string private constant _name = "Bear Wars";

    string private constant _symbol = "BWARS";
    ...
    Taxes public taxes = Taxes(0, 7, 2, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (to != pair && to != owner() && to != routerAddress && isLocked) {
    ...
    function blacklistAddress(address addr, bool block) external onlyOwner {

        blacklist[addr] = block;
