...
contract minimuuinu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x27e3CA6F164F7f3d5f01310C6465aAdeaAbDbA2e); // Marketing Address
    ...
    string private _name = "minimuuinu Token";
    ...
    uint256 private minimumTokensBeforeSwap = 3124000000005780 * 10**6 * 10**9; 
