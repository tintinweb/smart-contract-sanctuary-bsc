...
contract SquidClassic is IBEP20, Auth {
    ...
    string constant _name = "Squid Classic";
    string constant _symbol = "CSquid";
    ...
    address public marketingFeeReceiver = 0x6892f5A09dCb1E64d9B69bC0ce1B86B9FF1E2fF8;
