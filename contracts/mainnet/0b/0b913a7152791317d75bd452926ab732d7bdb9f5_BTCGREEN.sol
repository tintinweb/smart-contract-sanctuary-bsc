...
contract BTCGREEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC GREEN";
    string private _symbol = "BTC GREEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7d44bc9Bb1BD4693C876F65D54A207d307B44F1E); 
    address payable public DevelopmentWalletAddress = payable(0xb68AacC47f1d3810f8A7606ad0b7bD8557662f94); 
