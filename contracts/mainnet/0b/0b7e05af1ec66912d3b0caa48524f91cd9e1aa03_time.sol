...
contract time is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xbDC3bde605Dde52A7A0dcd5Ceb6624544925B95D); 
    address payable public marketingAddress2 = payable(0xEe7126E2Ba091844853dF926bAC549812b727b7b); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xD4c31fb869BC32ffb86E9B5Bd49809C7A6CF1fd8);
    ...
    uint256 private _totalSupply = 5100* 10**8 * 10**_decimals;
