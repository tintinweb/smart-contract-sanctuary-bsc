...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x953Ae4BDE5D8b1c92a82A27A5708B7Fe35BCda27; // owner address
...
contract DOGE1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge 1996";
    string private _symbol = "DOGE1996";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x84f1E43a40109de37a655E52d0CcFA780107b86A); // Marketing Address
    address payable public teamWalletAddress = payable(0xA7b766f7D9ac7F2D701B8e226ec63Bc57f5F97Ba); // Team Address
