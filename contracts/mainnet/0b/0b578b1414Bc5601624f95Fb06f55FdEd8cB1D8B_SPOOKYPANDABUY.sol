...
contract SPOOKYPANDABUY is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPOOKY PANDA BUY"; // Edit name
    string private constant _symbol = "SPOOKY PANDA"; // Edit Symbol
