...
1% Marketing
1% Dev
3% Liquidity - To Sustain PUMPS!

Sells
2% Marketing
2% Dev
5% Liquidity - To Sustain PUMPS!
*/
...
contract AutoRise is IERC20, Ownable {
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (lpFee, marketingFeeVariable, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _lpFee, uint256 _reflectionFee, uint256 _marketingFeeVariable, uint256 _giveawayFee) external onlyOwner {
        lpFee = _lpFee;
        reflectionFee = _reflectionFee;
        marketingFeeVariable = _marketingFeeVariable;
        giveawayFee = _giveawayFee;
        totalFee = lpFee.add(reflectionFee).add(marketingFeeVariable).add(giveawayFee);
