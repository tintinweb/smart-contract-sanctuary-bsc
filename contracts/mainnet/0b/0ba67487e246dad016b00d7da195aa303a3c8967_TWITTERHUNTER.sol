...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 DK = IBEP20(0x695C7fB304B06EA27A02305250AEc1D78C9DD939);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = DK.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = DK.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           DK.transfer(shareholder, amount);
...
contract TWITTERHUNTER is IBEP20, Auth {
   using SafeMath for uint256;
 
   address DK = 0x695C7fB304B06EA27A02305250AEc1D78C9DD939;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "TwitterHunter";
   string constant _symbol = "TwtHnt";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x0440b303C9DC2a0b0480B883b068947765273cAd).call{value: BNBMarketingamount, gas: 30000}("");
