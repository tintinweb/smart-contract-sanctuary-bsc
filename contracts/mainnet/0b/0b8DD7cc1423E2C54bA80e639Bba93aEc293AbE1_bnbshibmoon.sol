...
contract bnbshibmoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "bnbshibmoon";
    string private _symbol = "bnbshibmoon";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x8C87939a30BDD7f321729B91899089e8a0aEeaA7); 
    address payable public ttWal = payable(0x8C87939a30BDD7f321729B91899089e8a0aEeaA7); 
