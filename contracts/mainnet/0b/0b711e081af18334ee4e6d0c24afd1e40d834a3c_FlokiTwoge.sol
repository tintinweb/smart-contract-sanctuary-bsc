...
TWOGE (🐦TWITTER+🐶DOGE)
Twoge is an innovative deflationary token aiming to revolutionize Defi,
building its own Twoge Blockchain,
introducing a multi-chain swap (TwogeSwap) across Binance, Ethereum.

TG: https://t.me/Flokitwoge
*/
...
contract FlokiTwoge is IERC20, Ownable {
