...
contract Meta is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "MOVE TO EARN";
    string public _symbol= "META";
     bool balances1 = true;

    address payable public charityAddress = payable(0x328AE00B142058783A37F721629Dde9ca8a4CE8D); // Marketing Address
