...
// SPDX-Licnse-Identifier: NOLICENSE
...
library Address{
  ...
  contract KinderEggInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2000 * 10**9;
    uint256 public maxBuyLimit = 4000 * 10**9;  // 0.4%
    uint256 public maxSellLimit = 4000 * 10**9;  // 0.4%
    uint256 public maxWalletLimit = 20000 * 10**9;  // 2%
    
    uint256 public genesis_block;

    address public marketingWallet = 0x99d5d24DE90e79BB1EF15525F603f88713DeebC6;
    address public devwallet = 0x71F799186129f8B355cB0DA8Af33FBcbc1A42B53;

    string private constant _name = "Kinder Egg Inu";
    string private constant _symbol = "KINDEREGG";
    ...
    Taxes public taxes = Taxes(0, 3, 2, 1);
    Taxes public sellTaxes = Taxes(0, 3, 2, 1);
