...
contract CheemaceInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheemace Inu";
    string private _symbol = "CMINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB1eA69C8B74891793d381D2ef53d1dD98119331E);
    address payable public teamWalletAddress = payable(0xB1eA69C8B74891793d381D2ef53d1dD98119331E);
