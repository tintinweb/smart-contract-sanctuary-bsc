...
contract VitaliksBoner is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "VitaliksBoner";
    string constant _symbol = "$VBONER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x34996446fd92365c85481b06058C37dFAF36BA06;
        buybackWallet = 0x92Db60F0BeDBCc95d0527ECd6E40872758498d7f;
