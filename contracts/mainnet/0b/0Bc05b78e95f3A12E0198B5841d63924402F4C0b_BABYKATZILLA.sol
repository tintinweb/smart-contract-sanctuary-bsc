...
/**
Earn $FLOKI token by holding $BKZILLA 🤑
It couldn’t be much more easier 🥞

💫Hold $BKZILLA and earn 7% FLOKI reflection!
...
contract BABYKATZILLA is Context, IERC20, Ownable {
    ...
    string private _name = 'BABY KATZILLA';

    string private _symbol = 'BKZILLA';

    uint8 private _decimals = 9;

    uint8 public reflectFees = 3;
