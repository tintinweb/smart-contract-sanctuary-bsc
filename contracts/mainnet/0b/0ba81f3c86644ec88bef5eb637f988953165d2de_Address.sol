...
contract WineConnectSwap is Context, Ownable {
    ...
    function setWineConnectAddress(address nWineConnectAddr) public onlyOwner {
        wineConnectAddr = nWineConnectAddr;
    }
