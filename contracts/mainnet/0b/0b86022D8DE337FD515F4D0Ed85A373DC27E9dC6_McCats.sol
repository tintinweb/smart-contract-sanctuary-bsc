...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C584E41bb34c61F3c0247e335330562e6F5c3f8; // owner address
...
contract McCats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McCats";
    string private _symbol = "McCats";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCc5E6459Fa127bE97939626AC4931D74A2527F1B); // Marketing Address
    address payable public teamWalletAddress = payable(0x9C584E41bb34c61F3c0247e335330562e6F5c3f8); // Team Address
