...
/**
   #EthRiseArt(ERA)
   - 1,000,000 total supply’s
   - 50,000 supply (5%) burn allocations
   - 20,000 supply (2%) marketing allocations
   - 10,000 supply (1%) send to zero at launch
   - 920,000 supply on DEX
*/
//SITE:     https://EthRise.art/

//TELEGRAM: https://t.me/EthRisePortal
...
contract EthRiseArt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EthRiseArt";
    string constant _symbol = "ERA";
    uint8 constant _decimals = 18;
   
    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 50; // 
    uint256 public _maxWallet = 30000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x3D366d356643810401253adD8AeaBaEA1bDc3772; //change;
