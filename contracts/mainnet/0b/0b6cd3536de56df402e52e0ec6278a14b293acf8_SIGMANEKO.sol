...
contract SIGMANEKO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Sigma Neko";
    string constant _symbol = "$SN";
    ...
    address public marketingFeeReceiver = 0x2c18741e08900a4cd0445Bd5Db5b66f1d5876342;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x2c18741e08900a4cd0445Bd5Db5b66f1d5876342] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x2c18741e08900a4cd0445Bd5Db5b66f1d5876342] = true;
