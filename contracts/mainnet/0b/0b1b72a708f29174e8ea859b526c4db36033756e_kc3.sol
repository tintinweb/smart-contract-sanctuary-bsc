...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xeda9aC199945E841Ad1f7f2eA681Eafbb42488EF;
...
contract kc3 is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public deployer = payable(0xeda9aC199945E841Ad1f7f2eA681Eafbb42488EF);
    ...
    string private constant _name = unicode"King Cheems III"; 
    string private constant _symbol = unicode"KCIII"; 
