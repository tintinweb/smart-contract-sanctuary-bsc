...
contract Lesbian_Fish_BSC_Contract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Lesbian Fish BSC Contract";
    string constant _symbol = " LESBiAN_FISH ";
