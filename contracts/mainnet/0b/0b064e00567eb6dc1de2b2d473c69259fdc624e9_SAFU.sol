...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97715cfC2Da3d26d87C91e8fDaf6181f38039bb9;
...
contract SAFU is Context, IERC20, Ownable {
    ...
    string private _name = "TUZI2k3";
    string private _symbol = "TUZI2K3";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97715cfC2Da3d26d87C91e8fDaf6181f38039bb9);
    address payable public teamWalletAddress = payable(0x97715cfC2Da3d26d87C91e8fDaf6181f38039bb9);
