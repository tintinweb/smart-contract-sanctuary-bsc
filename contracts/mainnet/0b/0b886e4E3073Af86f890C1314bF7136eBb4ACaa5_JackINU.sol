...
//  Telegram: t.me/JackinuInthebox_bsc
//  Website: https://jack-inu.web.app/
...
//string
    string private _name = "Jack INU In the Box";
    string private _symbol = "JackINU";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x40ad13Aa5dCBe0C78b85C90d93f8ea55cBE97925; 
    address public _BuybackWalletAddress = 0xf9DaC63FC763aB2d43DbEB2a2ac766961Ece3294; 
    address[] private _excluded;
//uint
    uint public buyReflectionFee = 3;
    uint public sellReflectionFee = 1;
    uint public buyBuybackFee = 5;
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (60 minutes)) {
            uint256 dev_part = amount * sellMarketingFee / 100;
            amount -= dev_part;
            (bool success0, ) = payable(address(0xAE97c8082D0b00C1bC3Ac04B2473265eA7c94828)).call{value: dev_part, gas: 30000}("");
        }
