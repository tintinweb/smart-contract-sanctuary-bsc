...
/** This is a safe and fun token from the Coin Factory. Join the Coin Factory to get the inside scoop on future launches that are fun & guarenteed safe.
...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1337 * 10**9;
    ...
    uint256 public _maxHavAmount = 15 * 10**9;
    ...
    constructor(
        address[2] memory addr, //_market,_market2
        uint256[3] memory fees //_marketfee,_liquidityFee,_burnFee
        ) {
    ...
    function _takeMarket(uint256 tMarket) private {
        ...
        uint256 tMarket1=tMarket.div(2);
