...
contract ZTU is ERC20 {
    ...
    address private sellFeeAddr = 0x748B7593A93338A2280C6297DE241CB985B7B5eb;
    address private buyFeeAddr = 0x748B7593A93338A2280C6297DE241CB985B7B5eb;
    address private tokenOwner = 0x910a084a656acED94e121eafB4BeCBfa1F606Cb4;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){         
            super._transfer(from, buyFeeAddr, amount.div(100).mul(buyFee));  
            amount = amount.div(100).mul(1000-buyFee);

        }else{   
            super._transfer(from, sellFeeAddr, amount.div(100).mul(sellFee));
            amount = amount.div(100).mul(1000-sellFee);                 
        }
