...
contract TokenLocker is SafeOwnable {
    using SafeERC20 for IERC20;

    bool public turnOnWithdrawal;
    ...
    function setTurnOnWithdrawal(bool _turnOn) external onlyOwner {
        turnOnWithdrawal = _turnOn;
    }
    ...
    function withdraw() external {
        require(turnOnWithdrawal, "Withdrawal not enabled");
