...
// CHANGE
contract PinkCEO is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Pink CEO";
    string constant _symbol = "Pink CEO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; // .5% MAX
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1000; // 0.5% MAX
