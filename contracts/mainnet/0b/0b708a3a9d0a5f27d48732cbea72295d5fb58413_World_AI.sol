...
contract World_AI is Context, IERC20, Ownable {
    ...
    string private constant _name = "World AI"; // 
    string private constant _symbol = "WAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1874f2bDC752a07901cbA2361dc1ba816CC609Ab;
