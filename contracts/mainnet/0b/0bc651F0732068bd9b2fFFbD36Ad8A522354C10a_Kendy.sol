...
contract Kendy is Context, IERC20, IERC20Metadata, Ownable, Operator {
    ...
    string private _name = "Veaglse Kendy"; // test Veaglse Kendy
    string private _symbol = "KENDY"; // Kendy
    ...
    uint256 public _autoNftDividendAmount = 100 * 10**18;// prod nft dividend share to save gas
    ...
    function setAutoNftDividendAmount(uint256 amount) public onlyOperator{
        _autoNftDividendAmount = amount;
    }
