...
// 3% $LUNA Reward
// Portal https://t.me/LunanomicsBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 lunaRewards = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = lunaRewards.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(lunaRewards);
        ...
        uint256 amount = lunaRewards.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            lunaRewards.transfer(shareholder, amount);
...
contract LUNANOMICS is IBEP20, Auth {
    ...
    address lunaRewards = 0x156ab3346823B651294766e23e6Cf87254d68962;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
