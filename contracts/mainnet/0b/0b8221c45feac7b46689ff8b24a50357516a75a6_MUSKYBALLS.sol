...
contract MUSKYBALLS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MUSKYBALLS";
    string constant _symbol = "MSKYBALLS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 80 / 10000; 
