...
contract  MadMeerkatFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mad Meerkat Finance";
    string private _symbol = "MMF";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xCdF2b6fb3aD5A2D94358314B1DFA2669a7e0AB0f);
