...
Join Us Now!: https://t.me/BushidoRat
...
contract BushidoRat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bushido Rat";
    string private constant _symbol = "BushidoRat";
    ...
    address public marketingWallet = address(0xdFb9c960F8e494634218F8100756250040Eb3201);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 60 && !readyToLaunch) {
            _maxWalletAmount = 10_000_000 * 10**_decimals;
