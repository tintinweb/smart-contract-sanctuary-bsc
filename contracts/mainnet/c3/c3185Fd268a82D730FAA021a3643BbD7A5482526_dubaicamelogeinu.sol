...
contract dubaicamelogeinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "dubaicameloge Inu";
    string private _symbol = "DubaiCameloge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2747Ff0C1a02D685D66fcD3Dc2A751AB035c3382); 
    address payable public buyBackWalletAddress = payable(0x2747Ff0C1a02D685D66fcD3Dc2A751AB035c3382); 
    ...
    uint256 private _totalSupply = 896000000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 3500000000000000000000 * 10**9; 
    uint256 public _walletMax = 3500000000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 100000000000000000 * 10**9; 
