...
contract Transaction is Ownable {
  ...
  address public MXNToken;
    constructor () public {
        USDTToken=0x55d398326f99059fF775485246999027B3197955;
        MXNToken=0xd7f8f8EA52887fDE3D0F6afb128ee84152472471;
    }
    function buy(uint _mxn)public{
      ERC20(USDTToken).transferFrom(_msgSender(),address(this),_mxn);
      ERC20(MXNToken).transfer(_msgSender(),_mxn);
    }
    function sell(uint _mxn)public{
      ERC20(MXNToken).transferFrom(_msgSender(),address(this),_mxn);
      ERC20(USDTToken).transfer(_msgSender(),_mxn);
    }
    function withdrawBNB(address payable addr,uint256 _bnb)public onlyOwner{
      addr.transfer(_bnb);
    }
    function withdrawToken(address token,address payable addr,uint256 _value)public onlyOwner{
      ERC20(token).transfer(addr,_value);
    }
}
library SafeMath {
