...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a78Bdc786f5230666252b95a3EdAf8417c399EE; // owner address
...
contract BnbFather is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bnb Father";
    string private _symbol = "Bnb Father";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable (0xF8d9032AdBEaE93b1d3F971589A5dD035F4d6FF0); // Marketing Address
    address payable public teamWalletAddress = payable (0x2086Cc0fCDc745bC0425d5caBE33142A36A6265b); // Team Address
