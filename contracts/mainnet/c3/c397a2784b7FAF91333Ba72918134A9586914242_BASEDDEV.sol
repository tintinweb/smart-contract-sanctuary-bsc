...
contract BASEDDEV is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x90A545BE280476d65A36BC80Ac611a075c0C3434)); // MarketingWallet
    ...
    constructor() ERC20("Pepe Crazy", "PEPEc") {
