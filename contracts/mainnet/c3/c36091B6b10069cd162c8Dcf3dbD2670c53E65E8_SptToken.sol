...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    uint internal taxPer=100;
    uint internal transPer=50;

    IUniswapV2Router02 public uniswapV2Router;
    address public busd = 0x55d398326f99059fF775485246999027B3197955;
    address public hold = 0x33AC474203aCAD9397E2E842b3576f5A30Bbd2F1;
    address public SUV = 0x06f3910ff421902A839f737c46C830eeFAeef8F3;


    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public preAddress = 0xd433441931aaC344f6cC4A7B3966Cc3c662F2Ad9 ; 
    ...
    uint internal deNum=90000*10**18;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if (tax > 0) {
            ...
            uint256 burnT=tax.div(2);
            uint256 LP=tax.div(2);
            if(totalBurn<deNum){
                _balances[address(0)] = _balances[address(0)].add(burnT);
                totalBurn = totalBurn.add(burnT);
                _totalSupply = _totalSupply.sub(burnT);
                emit Transfer(sender, address(0), burnT);
            }else{
                LP=tax;
            }
            _balances[preAddress] = _balances[preAddress].add(LP);
            emit Transfer(sender, preAddress, LP); 
...
contract SptToken is BEP20Detailed {

    constructor() BEP20Detailed("SPT", "SPT", 18) public {
        deployTime = block.timestamp;
        _totalSupply = 100000 * (10**18);
	    _balances[hold] = _totalSupply;
	    emit Transfer(address(0), hold, _totalSupply);
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet 

        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
             .createPair(address(this), SUV);
