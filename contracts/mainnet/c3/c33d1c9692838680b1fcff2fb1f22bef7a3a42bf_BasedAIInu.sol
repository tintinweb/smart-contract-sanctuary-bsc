...
/**
    ...
    HYPE BY ELON'S TWEET!

    TG: https://t.me/BasedAIInuPortal
    TWITTER : https://twitter.com/BasedAIInuOfc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDdfbEe993970b039640eCd2695880f2F2d53266B;
...
contract BasedAIInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xDdfbEe993970b039640eCd2695880f2F2d53266B); //
    address payable public teamWalletAddress = payable(0xDdfbEe993970b039640eCd2695880f2F2d53266B); //
