...
contract LOVESHIBAINU is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'LOVE SHIBA INU';
    ...
    //DevWallets
    address public Development=payable(0xE305992ba198838fA8bE0ffC9176A8B2AE0684E6);
    address public Marketing=payable(0xE305992ba198838fA8bE0ffC9176A8B2AE0684E6);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BUSD Rewards
