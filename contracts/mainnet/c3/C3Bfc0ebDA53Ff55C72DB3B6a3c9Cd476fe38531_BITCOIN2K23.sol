...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEE8503e9AfAf2238e6627802289AbA053ed8f8FB; // owner address
...
contract BITCOIN2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BITCOIN2K23";
    string private _symbol = unicode"BTC2K23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEE8503e9AfAf2238e6627802289AbA053ed8f8FB); // Marketing Address
    address payable public teamWalletAddress = payable(0xEE8503e9AfAf2238e6627802289AbA053ed8f8FB); // Team Address
