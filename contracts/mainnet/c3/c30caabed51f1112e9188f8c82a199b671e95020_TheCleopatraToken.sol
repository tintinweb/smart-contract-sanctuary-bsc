...
/*
    ...
    The Cleopatra Inu is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable cleopatra in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $CLEOPATRA a household name.

    Telegram : https://t.me/thecleopatrabsc
...
contract TheCleopatraToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Cleopatra"; //
    string private constant _symbol = "CLEOPATRA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x31B15881059D51e91a699713335E2BF0D1E92B48;
