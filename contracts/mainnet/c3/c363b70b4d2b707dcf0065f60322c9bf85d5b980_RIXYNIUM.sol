...
contract RIXYNIUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "RIXYNIUM";
    string private constant _symbol = "RXY";
    ...
    address payable public DonationsAddress = payable(0x519b69c43d4C0833d74b5882a6d5618C8d18de75);
    ...
    address public DonationsWallet = 0x519b69c43d4C0833d74b5882a6d5618C8d18de75;
    ...
    uint256 public _maxTxAmount = 5 * 10**40  * 10**_decimals;  
