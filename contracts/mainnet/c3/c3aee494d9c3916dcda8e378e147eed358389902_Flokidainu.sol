...
/**
   ...
   I make this #FLINU to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/FlokidainuBSC
   ...
   I will renounce the ownership to burn addresses to transfer #FLINU to the community and ensure it's 100% safe.

   I will add 1 BNB and 99% of the total supply to the pool
   Can you make #FLINU 10000000X? 
...
contract Flokidainu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb03B15Ad686d863a4CE8bDbcF6DF4111585aa3E1); 
    address payable public Wallet_Dev = payable(0xb03B15Ad686d863a4CE8bDbcF6DF4111585aa3E1);
    ...
    string private constant _name = "Flokida inu"; 
    string private constant _symbol = unicode"FLINU"; 
    ...
    constructor () {
        ...
        _owner = 0x30FFD7a9280F8dDfeccdB489bB83fCADc4d209De;
