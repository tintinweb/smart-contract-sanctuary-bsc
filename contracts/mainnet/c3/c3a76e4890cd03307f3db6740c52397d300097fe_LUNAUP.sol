...
contract LUNAUP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public minMxTxPercentage = 100; //1% divisor is 10**4
    uint8 public minMxWalletPercentage = 100; //1% divisor is 10**4
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        numTokensSellToAddToLiquidity = amountOfTokenWei.mul(1).div(50000);
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent >= minMxTxPercentage && maxTxPercent <=10000,"err"); //divisor being 10**4 or 10000
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) external onlyOwner() {
        require(maxWalletPercent >= minMxWalletPercentage && maxWalletPercent <=10000,"err"); //divisor being 10**4 or 10000
