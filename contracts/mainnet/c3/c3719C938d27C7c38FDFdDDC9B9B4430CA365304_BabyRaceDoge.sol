...
contract BabyRaceDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyRaceDoge";
    string constant _symbol = "BabyRaceDoge";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**15 * 10**_decimals;
