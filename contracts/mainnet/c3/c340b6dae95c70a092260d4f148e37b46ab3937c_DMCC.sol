...
contract DMCC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DMCC";
    string private _symbol = "DMCC";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x3cab5515d723b7F346848fbA2Dd088BFd604EB6a); 
    address payable public teamWalletAddress = payable(0x3cab5515d723b7F346848fbA2Dd088BFd604EB6a); 
