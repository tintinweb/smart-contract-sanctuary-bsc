...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb121Cd765312703593c9196dA57AF75f9E810a42;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb121Cd765312703593c9196dA57AF75f9E810a42;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ShareAllWorld";
    string private _symbol = "SHALO";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xb121Cd765312703593c9196dA57AF75f9E810a42);
