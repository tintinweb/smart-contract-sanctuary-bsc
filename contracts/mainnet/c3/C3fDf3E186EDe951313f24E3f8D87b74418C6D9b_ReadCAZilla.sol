...
// Community runned project ( NO TELEGRAM ) MAKE ONE AND SPREAD WORD

// WILL HAVE 5% FEE FOR MARKETING WALLET INCASE THIS MOONS SO CAN USE IT FOR MARKETING AT HIGHER MCAP

// ALSO 2% FEE FOR LP

// MAX BUY AND WALLET IS 2%
...
contract ReadCAZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ReadCAZilla";
    string constant _symbol = "ReadCAZilla";
