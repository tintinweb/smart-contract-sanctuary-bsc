...
contract InitialHeart is ERC20 {
    using SafeMath for uint256;
	...
	address payable _receive = payable(address(0x4a4016eb4CF0E65CB40006e573BD29cd58A6BeDA));
    ...
    constructor(address tokenOwner) ERC20("Initial Heart", "IH") {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                swapAndLiquifyV3(haveAmount.div(2));
                swapping = false;
            }
        }
        ...
        if (takeFee) {
            super._transfer(from, _receive, amount.div(100));
