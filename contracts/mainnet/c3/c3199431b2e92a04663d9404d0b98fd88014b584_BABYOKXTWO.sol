...
contract BABYOKXTWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABYOKX 2.0"; // 
    string private constant _symbol = "BABYOKXTWO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x5b2dDb2310076979DEc56C97F5Fc4413982AD1de;
