...
TELEGRAM: https://t.me/tomboysupremacybsc

TWITTER: https://twitter.com/tomboy_bsc

WEBSITE: https://tomboysupremacybsc.com/
...
contract TomboyBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "TOMBOY BSC";  
    string private constant _symbol = "TOMBOY";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 8; 
    uint256 public _CommunityTax = 1; 
    address public  _marketing = 0x5C1c87A36A259F0aF720268250eC3C1d469223e2;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _CommunityTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _CommunityTax / (_marketingAndLiquidityFee + _CommunityTax);
