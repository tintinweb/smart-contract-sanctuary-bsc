...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private fund1Address = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor (
        ...
        maxBuyAmount = 18888 * 10** Decimals;
        walletLimit =  18888 * 10** Decimals;
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 97 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, fund1Address, block.timestamp
                );
            }
        }
    }
    ...
    function setFund1Address(address addr) external onlyFunder {
        fund1Address = addr;
        _feeWhiteList[addr] = true;
    }
...
contract SKY is AbsToken {
    constructor() AbsToken(
        ...
        address(0xF63cBb3D6EDea8241db1f6C46E60c079526436Ba)//ReceiveAddress
    ){
