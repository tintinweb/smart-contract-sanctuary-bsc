...
contract WHYFORME is Context, IERC20, Ownable {
    ...
    string private _name     = "WHYFORME";
    string private _symbol   = "WFM";  
    ...
    uint256 public totalFees = taxFee + liquidityFee + marketingFee;
