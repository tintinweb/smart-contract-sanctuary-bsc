...
contract ATK is IERC20, Ownable {
    ...
    address public fund1Address = address(0xcA2A742ED0cfE9D00d2a6081Df748ae4A0bB5133);
    ...
    constructor(address tokenOwner) {
        ...
        _tTotal = 4200000000 * 10**_decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee + _liquidityFee + _inviterFee + _fund1Fee;
        }
