...
/* Token contract */
contract BabyDogeBurn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address marketingFeeReceiver = 0xb5b167D93f86f89f1747886b2840Dc81B1bD0f94;
    address LOTTO = 0x90fad3a279d96135a82d168A10668a2B0cc5568E;

    address public autoLiquidityReceiver;

    // Name and symbol
    string constant _name = "BabyDogeBurn";
    string constant _symbol = "BDB";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 4200000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply / 250; // 0.2% of supply
