...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb1bFeB04395e0C57A0Db79C25a501a49006016a6; 
...
contract FourteenDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "14DOGE";
    string private _symbol = "14DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb1bFeB04395e0C57A0Db79C25a501a49006016a6); 
    address payable public teamWalletAddress = payable(0x8330b4Cb59E12F2CC826Ba7383919Da3c8E33308); 
