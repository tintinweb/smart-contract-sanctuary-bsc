...
contract Tculs is IERC20, Ownable {
    ...
    address private fundAddress = address(0xfbC53323ea8d5016D90045637BB54692FA68d44c);
    address private fundAddress2 = address(0xb46c25846A5472Ff96c3f9743FA351d571bB6C96);
    address private lpAddress = address(0x2191B53D2DE18008507CE4E4263fFe25A4A82E4c);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                _funTotal=_funTotal.add(tAmount.div(1000).mul(_lpFee));
