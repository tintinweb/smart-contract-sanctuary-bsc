...
contract ellanetworkbsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ella The Heart"; // 
    string private constant _symbol = "ELLA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x5B41E68234E512482259C67a3C6F5f7dBc68552F;
