...
contract zhuti is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "zhuti";
    string private _symbol = "zhuti";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90cDFFe3eDE6462996F6cDa4734c89463b1DA671); 
    address payable public teamWalletAddress = payable(0x271324fa7d4Ff8FD5F440bbB6014F644d6c46ccd); 
    ...
    uint256 private _totalSupply = 100000 *  10**4 * 10**_decimals;
