...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function goMoon(uint256 a) external onlyOwner {
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000000,//Supply
        address(0xB24080337295f9965301a3cc1ac061d45ffe6113 ),//FundAddress
        address(0xF67e74eDc1Db63770c7E20FFaCB87B94F3086666)//ReceiveAddress
    ){
    }
}