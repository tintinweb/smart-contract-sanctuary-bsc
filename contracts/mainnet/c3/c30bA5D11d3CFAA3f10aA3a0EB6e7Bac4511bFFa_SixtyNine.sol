...
Telegram: https://t.me/SixtyNineOfficial
...
contract SixtyNine is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 172_500_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 69_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 69_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 69_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xDd4930e69990Ebf49264808f660f72370e53d15C;
    address public devAddress = 0xEe059f00866E8b1dDa1bA864Ab6e21F3A9E4FFB2;

    string private constant _name = "69Token";
    ...
    // Owner cannot transfer out 69Token from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out 69Token!");
