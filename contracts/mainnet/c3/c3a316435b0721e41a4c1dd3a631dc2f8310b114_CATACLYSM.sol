...
-C-A-T-A-C-L-Y-S-M     -N-E-T-W-O-R-K-
...
Telegram: https://t.me/CataclysmNetwork
Website:  https://cataclysmnetwork.com (under development) 
...
contract CATACLYSM is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 100; // 100% of supply
    ...
    string private constant _name = "Cataclysm Network";
    string private constant _symbol = "CATACLYSM";
