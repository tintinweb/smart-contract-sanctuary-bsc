...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 2022 * 10**18;
    string private _name = "TWX";
    string private _symbol = "TWX";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x421Cc5f3671E5Aeb170c58C8Dd546124eCF13BD2);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 2022 * 10**18;
