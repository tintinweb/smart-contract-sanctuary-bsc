...
//https://t.me/GorillaHands

//The GorillaHands token is a strictly a meme token in any jurisdiction and is not and can not be considered as a security or
//otherwise a regulated token of any kind, is not in any way e-money and/or a fiat or asset backed stablecoin, whether global or limited in scope. 
...
contract GorillaHands is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"GorillaHands"; 
