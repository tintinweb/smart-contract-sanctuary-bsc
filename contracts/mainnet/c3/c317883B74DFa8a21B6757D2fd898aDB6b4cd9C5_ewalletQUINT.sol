...
contract ewalletQUINT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "e-QUINT";

    string private _symbol = "e-QUINT";

    uint8 private _decimals = 18;

    address public _marketingWallet = 0x02d3b390F5cC8418825Ea8B59e48E0596f6dBeE0;
