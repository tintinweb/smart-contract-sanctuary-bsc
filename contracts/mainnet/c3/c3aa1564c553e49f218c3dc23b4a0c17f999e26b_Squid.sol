...
contract Squid is Context, IERC20, Ownable {
    ...
    string private _symbol = "$QUIDCLAUS"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc2e6d31FD71B1D25CBe83A63E1362A79AC7C00fc); 
    address payable public teamWalletAddress = payable(0xc2e6d31FD71B1D25CBe83A63E1362A79AC7C00fc); 
