...
contract KuromaruInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x80BFE11B98A38F6b9aeC51dA784eDE9DEc98FEaD); 
    address payable private Wallet_Dev = payable(0x80BFE11B98A38F6b9aeC51dA784eDE9DEc98FEaD);
    ...
    string private constant _symbol = unicode"$KUROMARU"; 
    ...
    constructor () {
        ...
        _owner = 0x80BFE11B98A38F6b9aeC51dA784eDE9DEc98FEaD;
