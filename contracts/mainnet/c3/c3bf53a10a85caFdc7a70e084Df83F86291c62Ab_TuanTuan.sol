...
contract TuanTuan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TuanTuan";
    string private _symbol = "TuanTuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40723F685631517C5B946D8Ae6bBDc4563054B07);
    address payable public teamWalletAddress = payable(0x6De99ee53EaAa83059923C155Ac65D1112E42fcD);
