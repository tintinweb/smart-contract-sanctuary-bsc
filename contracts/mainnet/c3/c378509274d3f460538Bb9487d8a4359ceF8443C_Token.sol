...
contract Token is ERC20, Ownable {
    ...
    address public _devAddress1 = 0xAfF6D364bD866706f1b945F7280c3F795AcCcA05;//地址1
    address public _devAddress2 = 0xF8A322A8B1c6Ea7FC3C71ea8a4971c2D3Af5f396;//地址2
    ...
    constructor() payable ERC20("FAC", "FAC") {
        uint256 totalSupply = 99999 * (10**18);
    ...
    function _transfer(
        ...
        uint256 a = 99999 * (10**18);
        uint256 b = 99999 * (10**17);
        uint256 c = balanceOf(deadWallet);
    ...
    function takeBuyFee(address sender,address recipient,uint256 amount) private returns(uint256 amountAfter) {
        ...
        if(DFee > 0) super._transfer(sender, _devAddress1, DFee);
        ...
        uint256 deads= amount.mul(deadFee).div(100);
         if(deads > 0) super._transfer(sender, deadWallet, deads);
        amountAfter = amountAfter.sub(deads);
        ...
        if(sxNum>0){
            super._transfer(sender, _devAddress1, sxNum);
        }
    }
