...
contract KINGCZ is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC17212350cF5bc1b02FD24bD906CDf9ff8Ba1075); // Marketing Address
    ...
    uint256 private _totalSupply = 1 * 10**6* 10**3 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**4 * 10**3* 10**_decimals; 
    uint256 public _walletMax = 4 * 10**4 * 10**3* 10**_decimals;
