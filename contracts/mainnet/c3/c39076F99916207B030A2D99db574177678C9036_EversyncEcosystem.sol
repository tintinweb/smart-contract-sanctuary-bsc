...
TG: https://t.me/EversyncEcosystem
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42462929F566C7d079C0baF8Ba9B55FD683651E7; // owner address
...
contract EversyncEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Eversync Ecosystem";
    string private _symbol = unicode"EvSync";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42462929F566C7d079C0baF8Ba9B55FD683651E7); // Marketing Address
    address payable public teamWalletAddress = payable(0x42462929F566C7d079C0baF8Ba9B55FD683651E7); // Team Address
