...
contract SquidGrowGold is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xBD581066FDec033622756f67C03B0F45d877d07c); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0AE7fb5BDa15Ca3c63DE04469EC2699479111159); // Team Address
        
    address payable public liquidityAddress =
        payable(0xBD581066FDec033622756f67C03B0F45d877d07c); // Liquidity Address
