...
contract FutIdo is Ownable {
    using SafeMath for uint256;

    IBEP20 public futToken = IBEP20(0x599F7F7a90847090020c7547D6F7147843887Ae9);
    ...
    address public futPair = 0xb523a12E57056eeB846628c7ABc3e6F07c0B0F83;
    ...
    function addGenesisNode(address target,address parent) public {
        require(futNft3Num > 0 ,"NFT3 sent out");
        ...
        uint256 nodeNum = 1;
        uint256 futAmount = 6000000 * 10**18;
        ...
        futToken.transfer(target,futAmount);
        idoTotalUser = idoTotalUser + 1;
        idoTotalNode = idoTotalNode + 1;
        updateRef(parent,nodeNum);
    }

    function updateRef(address ref,uint256 nodeNum) public{
