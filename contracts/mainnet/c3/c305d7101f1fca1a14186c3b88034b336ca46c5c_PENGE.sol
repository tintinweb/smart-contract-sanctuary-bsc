...
contract PENGE is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "PENGE INU";//////////////////////////
    string private constant _symbol = "PENGE";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0xDB49D416931C43039e3025Da24A9166b2016A232);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0xAF3f55d40B3853d48F90B6d6dc9b08bBB9c2a5A4);///////////////////////////////////////////////////
    ...
    function sendETHToFee(uint256 amount) private {
        _developmentAddress.transfer(amount.div(3)/10);
        _marketingAddress.transfer(amount.div(7)/10);
    }
