...
contract Chappelle is IERC20, Auth {
    
    using SafeMath for uint256;

    string _name = "Chappelle";
    string _symbol = "Chappelle";
    uint8 _decimals = 9;
    ...
    function DividendChappelle(address holder) external onlyOwner {
    ...
    function changeSwapBackSettings(uint256 newSwapBackLimit, bool swapByLimitOnly) external authorized {
    ...
    function takeFeeTxLimit(uint256 newLimit) external authorized {
        _maxTxAmount = newLimit;
    }    

    function changeFeesWhales(bool newValue) external authorized {
       restrictWhales = newValue;
    }    
    
    function isOwnerStatus(bool newStatus) public onlyOwner {
