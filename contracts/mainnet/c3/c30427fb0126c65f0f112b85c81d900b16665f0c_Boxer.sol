...
contract Boxer is Context, ITRC20, Ownable {
    ...
    string private _name = 'Boxer Token';
    string private _symbol = 'Boxer';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 8800 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 880 * 10**uint256(_decimals);
