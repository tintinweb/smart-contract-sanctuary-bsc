...
/**
   ...
   With the nuclear bombings of Hiroshima and Nagasaki and the Lucky Dragon 5 incident still fresh in the Japanese consciousness, 
   Godzilla was conceived as a metaphor for nuclear weapons.
   We will Burn LP and Renounced Ownership
   Join our Community https://t.me/zillachain
   */
...
contract ZILLACHAIN is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "ZILLACHAIN";
   string constant _symbol = "$ZILLACHAIN$";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 100000000 * (1 ** _decimals);
