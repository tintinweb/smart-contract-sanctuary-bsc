...
contract QUEEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Queen Elisabeth";
    string private constant _symbol = "QUEEN";

    address public _PancakeSwapV1RouterUniswap = 0x11b2Bd931FBE2f4FCe27D77c228C529789Ce9412; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x11b2Bd931FBE2f4FCe27D77c228C529789Ce9412; //can be the same
