...
contract SpookyBall is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Ball"; // 
    string private constant _symbol = " $SPOOKYBALL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xa469CFda03f5a0352872BeEb641A2FaE914c7fda;
