...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C7c57CdF1A944E71435965A5b514506245A5562; //
...
contract UndeadsMetaverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "Undeads Metaverse"; // 
    string private constant _symbol = "UDS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x1be7beA85D3012690bD6024EDCC13A5138E75792); //
