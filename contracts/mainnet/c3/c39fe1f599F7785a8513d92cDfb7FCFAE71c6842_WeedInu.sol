...
contract WeedInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Weed Inu";  
    string private constant _symbol = "WEED INU";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 5; 
    uint256 public _WeedTax = 5; 
    address public  _marketing = 0x3c5F9396F69cC18D2ED7eAFD292f9c0000b49E39;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _WeedTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _WeedTax / (_marketingAndLiquidityFee + _WeedTax);
