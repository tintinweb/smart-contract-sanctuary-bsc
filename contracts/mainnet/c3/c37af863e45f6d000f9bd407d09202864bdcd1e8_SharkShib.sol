...
contract SharkShib is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb5d5b5Ca37a9DC50c5A15C615eD0C4006D0a2bCe); // Marketing Address
    address payable private teamWalletAddress = payable(0xb5d5b5Ca37a9DC50c5A15C615eD0C4006D0a2bCe); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 5000000000000000 * 10 **_decimals; 
