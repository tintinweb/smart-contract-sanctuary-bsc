...
contract AkameGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AKAME GROW";
    string private _symbol = "AKAME";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x410D1DEEF0Ea5f91cDe91866131C668DeF27fd2D);
