...
/*
    ...
    電信: https://t.me/Sashimibsc
    
    刺身は洗練、幸運、幸福を象徴する料理です
    Sashimi は BSC の暗号ミームです。
    低税率を提供しているため、低手数料で取引でき、
    所有権を手放しても安心です。この宝石をお見逃しなく
*/
...
contract SASHIMI is ERC20, Ownable {
    ...
    constructor() ERC20("Sashimi", "SASHIMI") {
        ...
        devWallet = address(0xc4E3a572afCdeB154fa9EC3da71fd3a601aC2ee9); 
