...
contract Dogegrow is Context, IERC20, Ownable {
    ...
    string private _name = "Dogegrow";
    string private _symbol = "Dogegrow";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0C36Cbb3d1bd5D9d2576a5faa09aC979e8Dd0D11); // Marketing Address
    address payable public teamWalletAddress = payable(0x0C36Cbb3d1bd5D9d2576a5faa09aC979e8Dd0D11); // Team Address
