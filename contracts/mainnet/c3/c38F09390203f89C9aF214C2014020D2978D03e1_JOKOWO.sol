...
contract JOKOWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "JOKOW";
    string private constant _symbol = "JOKOWO";
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(to == uniswapV2Pair && from != owner() && from != _marketingWallet)
            require(balanceOf(from) <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
