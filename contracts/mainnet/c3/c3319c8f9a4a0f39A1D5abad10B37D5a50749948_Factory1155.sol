...
import "./AifaworldUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new AifaworldUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AifaworldUser1155Token token = AifaworldUser1155Token(address(addr));
...
contract AifaworldUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
