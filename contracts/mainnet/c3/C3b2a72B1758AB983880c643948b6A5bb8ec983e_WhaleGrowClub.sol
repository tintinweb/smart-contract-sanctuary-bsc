...
TG Portal: https://t.me/WhaleGrowClub
...
contract WhaleGrowClub  is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WhaleGrowClub";
    string constant _symbol = "WGC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 *10**9* 10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply/30;
    uint256 public _maxSellTxAmount = _totalSupply/30;
