...
contract GrimaceValentineCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grimace Valentine";
    string private _symbol = "GV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC30b82B98da4a75297b9e6F5f87A9576c264Dbe1); // 营销钱包
    address payable public teamWalletAddress = payable(0xC30b82B98da4a75297b9e6F5f87A9576c264Dbe1); // 团队钱包
