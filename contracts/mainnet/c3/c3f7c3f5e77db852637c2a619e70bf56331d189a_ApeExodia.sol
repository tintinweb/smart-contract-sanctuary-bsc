...
//APE EXODIA - DO NOT SNIPE - @ApeExodia
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0x8878A4fF4d4F5d62519516D1c4874B937041C38e;
        _token = msg.sender;
    }
...
contract ApeExodia is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x242B3eC10C35E0BD301598101972913706FDBD74;
    address DevWallet       = 0x242B3eC10C35E0BD301598101972913706FDBD74;

    string constant _name = "ApeExodia";
    ...
    address PAIR = 0x8878A4fF4d4F5d62519516D1c4874B937041C38e;
