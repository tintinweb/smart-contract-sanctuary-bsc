...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BBW = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // WBNB BuyBack
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BBW.balanceOf(address(this));
        ...
        uint256 amount = BBW.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BBW.transfer(shareholder, amount);
...
contract RocketINU is IBEP20, Auth {
    using SafeMath for uint256;

    address BBW = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB BUYBACK
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Rocket INU";
    string constant _symbol = "ROKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4efe7522FF647BB59a3C84B10050E16D83ae8081;
        teamFeeReceiver = 0x4efe7522FF647BB59a3C84B10050E16D83ae8081;
        giveawayFeeReceiver = 0x4efe7522FF647BB59a3C84B10050E16D83ae8081;
