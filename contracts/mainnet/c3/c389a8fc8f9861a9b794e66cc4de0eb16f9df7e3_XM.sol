...
contract XM is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x6e6b5AB0EC7d220F879226A09275ef4Bf7101723;

    string constant _name = "XM";
    string constant _symbol = "XM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5 * 10**3 * (10 ** _decimals);
