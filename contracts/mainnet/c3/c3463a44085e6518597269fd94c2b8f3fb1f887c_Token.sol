...
contract Token is ERC20, Ownable {
    ...
    address public Shib = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    uint256 public swapTokensAtAmount;

    mapping(address => bool) public _isBot;

    uint256 public ShibRewardsFee = 1;
    ...
    0x55fb410992AB730Da590EdD7Ea779FAE22789c3c;
    address public _liquidityReceiver = 0x60159d9C3a3Ad5575a56644D2c06498F59b80644;
    ...
    constructor() public ERC20("TUC", "TUC") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SpaceCatDividendTracker newDividendTracker = SpaceCatDividendTracker(
            payable(newAddress)
        );
...
contract SpaceCatDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    public
    DividendPayingToken(
        "SpaceCat_Dividen_Tracker",
        "SpaceCat_Dividend_Tracker"
    )
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 15 * 10**13;
    }
