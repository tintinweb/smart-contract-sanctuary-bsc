...
CAT RIDER BSC is a cat who loves to drive he has the characteristics of being brave and ruling the streets. 
in that we aim to build a cryptocurrency project for the long term not just 
a project that just dies in one day. We aim to prosper the cryptocurrency community and 
we want to be a part of one of the projects that can make investors rich. 
with the strength of our community, we believe we can achieve it all quickly. 
because for us the power of community is everything. for now we will be born on the 
Binance Smart Chain Network. and maybe for the future we will be in various networks.

Join Our Community :

Telegram : https://t.me/catriderbsc/
Website  : https://www.catrider.net/
Twitter  : https://twitter.com/catriderbsc
...
contract CatRider is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CAT RIDER";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x14045533b5e059bCE2ebB7616d7d8c19691A54F5;
