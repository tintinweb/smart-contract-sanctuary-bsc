...
Telegram : https://t.me/HentaiSenpaiOfficial
...
contract HentaiSenpai is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = (_tTotal * 3) / 100; // 3%
    uint256 public maxSellLimit = (_tTotal * 3) / 100; // 3%
    uint256 public maxWalletLimit = (_tTotal * 3) / 100; // 3%
    
    uint256 private tTimer;
    
    address public marketingWallet = 0x47dCdA0D36F0457DF77350B632a9714a825673F5;
    address public devWallet = 0x47dCdA0D36F0457DF77350B632a9714a825673F5; 
    ...
    string private constant _name = "Hentai Senpai";
    string private constant _symbol = "HenSen";
    ...
    Taxes public taxes = Taxes(0, 8, 2, 0, 0, 0); // 10%
    Taxes public sellTaxes = Taxes(0, 8, 2, 0, 0, 0);// 10%
