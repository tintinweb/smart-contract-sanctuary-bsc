...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0xED192aD93Dc15E4cA2391393e2D2e94F1e83085F;
...
contract Forte is Context, IERC20, Ownable {
    ...
    string private _name = "Forte";
    string private _symbol = "FORTE";
    ...
    constructor () public {
        _rOwned[0xED192aD93Dc15E4cA2391393e2D2e94F1e83085F] = _rTotal;
        ...
        _isExcludedFromFee[0xED192aD93Dc15E4cA2391393e2D2e94F1e83085F] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0xED192aD93Dc15E4cA2391393e2D2e94F1e83085F, _tTotal);
    }
