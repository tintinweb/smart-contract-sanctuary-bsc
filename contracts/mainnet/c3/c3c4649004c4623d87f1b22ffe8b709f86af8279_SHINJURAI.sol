...
contract SHINJURAI is SHINJURAIDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SHINJURAITeam;
    address private CharitySHINJURAI;
    ...
    string public override name = "Shinjurai";
    string public override symbol = "SHINJURAI";
    ...
    constructor(uint totalSupplyValue, address SHINJURAITeamAddress, address CharitySHINJURAIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SHINJURAITeam = SHINJURAITeamAddress;
        CharitySHINJURAI = CharitySHINJURAIAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SHINJURAITeam] =  totalSupply * 4 / 100;
        balances[CharitySHINJURAI] = totalSupply * 4 / 100;
