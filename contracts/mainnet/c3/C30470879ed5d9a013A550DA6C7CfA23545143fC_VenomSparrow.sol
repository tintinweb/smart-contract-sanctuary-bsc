...
/*
VenomSparrow
BSC Gem Token with NFT Marketplace
VenomSparrow is one in thousand rare token on BSC, which have mission to become of the top NFT marketplace.

Tokenomics:
~ 1,000,000,000,000 (1 Trillion Supply)
~ 3% Buy Tax & 8% Sell Tax
~ Starting with low MC : $300

Join us & be one of the earliest to own this gem token!
TG : https://t.me/VenomSparrow
*/
...
contract VenomSparrow is Context, IERC20 { 
    ...
    string private constant _name = "VenomSparrow"; 
    string private constant _symbol = "$VenomSparrow"; 
