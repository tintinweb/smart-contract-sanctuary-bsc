...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7695Bf40bF56350Bae249A2D0BFfD2617324e27f; // owner address
...
contract TeachBeta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeachBeta";
    string private _symbol = "TBT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FB905c8E5abCE35B84e540236Fd1088C8F1917D); // Marketing Address
    address payable public teamWalletAddress = payable(0xfb3C54f73F98B4c1eB578D0629BD5c16206f808E); // Team Address
