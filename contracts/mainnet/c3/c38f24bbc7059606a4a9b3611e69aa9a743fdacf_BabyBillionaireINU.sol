...
/**
-----------------------Baby Billionaire INU-----------------------

- Stealth Launch today‼️
...
Join our Telegram : https://t.me/babybillionaireINU
...
contract BabyBillionaireINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyBillionaireINU"; //
    string private constant _symbol = "BILLINU"; //
