...
Baby Dungeon TG: https://t.me/BabyDungeonToken
Main Project TG: https://t.me/dungeontoken
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xDe3CE2a1577167FC9a3A21256d1d1Bc9EbCc3bA2); 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            MarketingWallet = 0x566C7CA2eC2a738413A79E21f22f8a160408632D;
            DevWallet       = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Dividend.transfer(DevWallet, totMk * gasCount / 100);   
          totMk = 0;
...
contract BABYDUNGEON is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x566C7CA2eC2a738413A79E21f22f8a160408632D;
    address DevWallet       = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;

    string constant _name = "Baby Dungeon";
    ...
    address PAIR = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;
