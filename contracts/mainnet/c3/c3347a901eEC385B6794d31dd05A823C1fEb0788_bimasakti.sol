...
contract bimasakti is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bima Sakti Token"; // 
    string private constant _symbol = "$BST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xD80D9bbBa061941f77FF9f9A347a2eC6A393137C;
