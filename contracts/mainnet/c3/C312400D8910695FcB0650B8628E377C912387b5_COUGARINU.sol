...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC82A32db94Fc7930dF1B3734b132525ad23DeE35;
...
contract COUGARINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x05eA23AD69CAa454F920Db5E3797f3A937A73051;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cougar Inu";
    string private _symbol = "COUGNU";
