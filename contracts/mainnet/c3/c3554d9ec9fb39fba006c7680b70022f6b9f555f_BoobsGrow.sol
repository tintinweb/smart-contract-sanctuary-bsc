...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC428cCEc1519d0e279Db31b3cEaf1667eFe31335; // owner address
...
contract BoobsGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boobs Grow";
    string private _symbol = "BG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC428cCEc1519d0e279Db31b3cEaf1667eFe31335); // Marketing Address
    address payable public teamWalletAddress = payable(0xC428cCEc1519d0e279Db31b3cEaf1667eFe31335); // Team Address
