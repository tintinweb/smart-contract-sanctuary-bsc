...
contract EAzyChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EAzyChain";
    ...
    address payable public marketingWalletAddress = payable(0x05f4259eFE37faE533eB6088630C70ae3adcBbbB); // Marketing Address
    address payable public teamWalletAddress = payable(0x69BbE3d6624b59477E8F51Abd762D17a2df9fee4); // Team Address
