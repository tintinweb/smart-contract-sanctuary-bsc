...
contract WOLFIENS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wolfiens";
    string private _symbol = "WLFN";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0xb0B52A79082f686189bEcCeF68258B4455D24bC6);
    address payable public DevFee = payable(0x5b059a4CB1DC311Da629A5E4382CDEC6D19B9b63);
    ...
    uint256 private _totalSupply = 1 * 10**8 * 10**4;
    uint256 public _maxTxAmount = 1 * 10**7 * 10**4;
    uint256 public _walletMax = 1 * 10**7 * 10**4;
