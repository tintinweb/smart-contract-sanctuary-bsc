...
// __________  _____    ___________________        ________  
// \______   \/     \  /   _____/\______   \ ___  _\_____  \ 
//  |     ___/  \ /  \ \_____  \  |     ___/ \  \/ / _(__  < 
//  |    |  /    Y    \/        \ |    |      \   / /       \
//  |____|  \____|__  /_______  / |____|       \_/ /______  /
//                  \/        \/                          \/ 
...
//Peacock Mantis Shrimp Token V3

//PMSP FINANCE  :  https://mantisshrimp.finance
//PMPS OFFICIAL :  https://www.mantisshrimptoken.com
...
contract PMSPv3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Peacock Mantis Shrimp";
    string private _symbol = "PMSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x534F516Cb72760759537A602F2ba6b4A9b28ed30); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x534F516Cb72760759537A602F2ba6b4A9b28ed30); // BuyBack Address
    ...
    uint256 public _walletMax = 30000000 * 10**6 * 10**9;
