...
*/
// Telegram : https://t.me/pixelangeldust
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x0D536B28Cb33226DBab5B3B086b2c257F859E16B);
    PCSRouter router;
...
contract PixelAngelDust is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Pixel Angel Dust";
    string constant public symbol = "PAD";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 3 / 1000;
    uint256 public _maxWalletToken = totalSupply * 3 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x0000000000000000000000000000000000000000;
  ...
  function update_fees() internal {
        require(totalFee.mul(buyMultiplier).div(100) <= 30, "Buy tax cannot be more than 30%");
        require(totalFee.mul(sellMultiplier).div(100) <= 30, "Sell tax cannot be more than 30%");
        require(totalFee.mul(sellMultiplier+buyMultiplier).div(100) <= 60, "Buy+Sell tax cannot be more than 60%");
