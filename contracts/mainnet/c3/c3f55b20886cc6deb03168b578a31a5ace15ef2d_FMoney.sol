...
/**
$FMON, larp play in ETH with potential of being SAITAMA team!

https://dexscreener.com/ethereum/0xdd59b09356c052bf1747bf98fed93090a10f7ce1

Telegram: https://t.me/FMoneyBSC
...
contract FMoney is BEP20, Auth {
    ...
    string public constant name = "FMONEY TOKEN";
    string public constant symbol = "FMON";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 1 * 10**6 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb1a1C9DCe53e892bEe5be482d4d1774273066d7E;
