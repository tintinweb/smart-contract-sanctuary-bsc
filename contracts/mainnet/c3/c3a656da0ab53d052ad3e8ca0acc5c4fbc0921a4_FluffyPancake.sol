...
contract FluffyPancake {
    address private _owner;
    string private _name = "FluffyPancake";
    string private _symbol = "FLUF";
    ...
    function transferFrom(
        ...
        // Check if sells are allowed yet, this will block instant sell bots
          if (_to == uniswapV2Pair && !_excluded[_from]) {
              ...
              // After the first and second block there is a cooldown
              if (block.timestamp > lpAddedAt + 6) {
                  require(block.timestamp > lpAddedAt + 30 * c);
              }
           }
