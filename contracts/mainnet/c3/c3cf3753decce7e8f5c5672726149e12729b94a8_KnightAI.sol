...
contract KnightAI is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xF3AF06c2e896B86140521fB6cc2A7eDa3a7FC5CB);
    address payable private _twdmkt = payable(0xF3AF06c2e896B86140521fB6cc2A7eDa3a7FC5CB);
    
    string private constant _name = "KNIGHT AI";
