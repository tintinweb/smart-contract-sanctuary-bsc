...
/*
Croogle
A comprehensive search engine covering entire cryptocurrency and blockchain activities.
Our platform  serves as a one-stop resource for individuals looking for information on coin prices, 
trading strategies, industry news, and more. With advanced search capabilities and a user-friendly interface, 
Croogle makes it easy for cryptocurrency enthusiasts to find the information they need to make informed decisions and stay up-to-date on industry developments.⠀⠀
*/    
...
contract CROGLBSC  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Croogle';
    string private _symbol = 'CROGL';
