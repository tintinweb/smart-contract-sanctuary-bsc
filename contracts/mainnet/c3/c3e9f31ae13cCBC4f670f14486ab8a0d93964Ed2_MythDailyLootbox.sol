...
contract MythDailyLootbox {
    ...
    uint256 public prizeCount;
    mapping(uint256 => prize) public prizes;
    uint256 public minPlaced = 2 * 10**18;
    struct prize {
        uint256 lowticket;
        uint256 highticket;
        uint256 lootboxID;
    ...
    constructor() {
        owner = msg.sender;
        prizes[0] = prize(0, 49, 0, 0);
        prizes[1] = prize(50, 64, 1, 1);
        prizes[2] = prize(65, 80, 1, 2);
        prizes[3] = prize(81, 90, 1, 3);
        prizes[4] = prize(91, 99, 2, 1);
