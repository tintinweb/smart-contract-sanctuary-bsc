...
contract INTStaking is Ownable, ReentrancyGuard {
    ...
    // The staked token
    IERC20 public stakingToken = IERC20(0xbB72E492cb7169ab7936505B32e9BBE538Ce0C51);
    // The earned token
    IERC20 public earnedToken = IERC20(0xbB72E492cb7169ab7936505B32e9BBE538Ce0C51);
    // The dividend token of staking token
    IERC20 public BTCdividendToken = IERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    IERC20 public SFMdividendToken = IERC20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5);
    IERC20 public GRVdividendToken = IERC20(0xF33893DE6eB6aE9A67442E066aE9aBd228f5290c);
    ...
    struct Stake {
        ...
        uint256 BTCreflectionDebt; //BTC Reflection debt
        uint256 SFMreflectionDebt; //SFM Reflection debt
        uint256 GRVreflectionDebt; //GRV Reflection debt
    }
     ...
     * @param _BTCdividendToken: reflection token address
     * @param _SFMdividendToken: reflection token address
     * @param _GRVdividendToken: reflection token address
    ...
    function initialize() external {
        ...
        if(address(BTCdividendToken) != address(0x0)) {
            ...
            require(decimalsBTCdividendToken < 30, "Must be inferior to 30");
        }
        ...
        if(address(SFMdividendToken) != address(0x0)) {
            ...
            require(decimalsSFMdividendToken < 30, "Must be inferior to 30");
        }
        ...
        if(address(GRVdividendToken) != address(0x0)) {
            ...
            require(decimalsGRVdividendToken < 30, "Must be inferior to 30");
        }
    ...
    function deposit(uint256 _amount, uint8 _stakeType) external nonReentrant {
        ...
        uint256 pendingBTCReflection = 0;
        uint256 pendingSFMReflection = 0;
        uint256 pendingGRVReflection = 0;
    ...
    function emergencyWithdraw(uint8 _stakeType) external nonReentrant {
        ...
        for(uint256 j = 0; j < stakes.length; j++) {
            ...
            stake.amount = 0;
            stake.rewardDebt = 0;
            stake.BTCreflectionDebt = 0;
            stake.SFMreflectionDebt = 0;
            stake.GRVreflectionDebt = 0;
    ...
    /**
     * @notice Available amount of BTC reflection token
     */
    ...
    /**
     * @notice Available amount of GRV reflection token
     */
