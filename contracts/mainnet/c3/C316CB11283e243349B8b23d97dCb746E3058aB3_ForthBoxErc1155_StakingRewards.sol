...
contract ForthBoxErc1155_StakingRewards is Ownable, ReentrancyGuard,IERC721Receiver {
    ...
    uint256[5] public maxTokenNum =[900,500,300,150,50];
    uint256[5] public minTokenNum =[0,0,0,0,0];
    uint256[5] public tokenDegree =[5,6,7,8,0];
    uint256[5] public tokenCost =[6,10,16,24,50];

    //---write---//
    function buy(uint256 tType) external nonReentrant {
        ...
        stakingToken.safeTransferFrom(msg.sender, address(0),erc1155TokenId, tokenCost[tType-1],"");
    ...
    //---write onlyOwner---//
    function setTokens(address _rewardNFTsToken,address _stakingToken) external onlyOwner {
