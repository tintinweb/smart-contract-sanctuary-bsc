...
contract MoneyPrinter is IERC20, Ownable {
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x059d96907f32Aa22E58bbca10dbe7208e44de70c);
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _developmentFee, uint256 _marketingFee, uint256 newExtraSellFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        developmentFee = _developmentFee;
        marketingFee = marketingFee;
        extraFeeOnSell = newExtraSellFee;
        totalFee = _liquidityFee.add(_devFee).add(_developmentFee).add(_marketingFee);
