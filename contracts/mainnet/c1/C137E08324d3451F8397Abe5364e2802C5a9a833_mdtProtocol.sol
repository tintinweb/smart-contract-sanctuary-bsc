...
contract mdtProtocol is Initializable, ReentrancyGuard, Context {
    using SafeERC20 for mdtCredit;
...
import "./ImdtProtocol.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract mdtCredit is Ownable, ERC20 {
    ImdtProtocol internal mdtProtocol;

    constructor() ERC20("mdtCredit", "MC") {
        mdtProtocol = ImdtProtocol(owner());
    }
    ...
    function _approve(
        ...
        require(_spender == owner(), "Not mdtProtocol");
    ...
    function _beforeTokenTransfer(
        ...
        bool allowedFrom = _from == address(0) || _from == mdtProtocol.gnosis();
        bool allowedTo = _to == address(0) || _to == mdtProtocol.gnosis();
