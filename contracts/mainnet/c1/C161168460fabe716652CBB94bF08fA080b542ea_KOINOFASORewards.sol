...
contract  KOINOFASORewards  is  Context ,Ownable {
   ...
   /*Get BNB IN Owner Wallet - Working */
    ...
    function setStore(address[] memory _winnerAddresses) external  onlyOwner {
        winnerAddresses = _winnerAddresses;
    }

   function addRewardHolder(address  RewardHolder) external  onlyOwner  {
...
function clearAllRewardHOlder() external  onlyOwner  {
 ...
 function removeSingleAdress(uint index) external  onlyOwner  {
