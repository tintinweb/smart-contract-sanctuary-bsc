...
// TG: https://t.me/activetradingbsc
// Join the group just to watch buy bot
...
contract ActiveTrading is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ACTIVE TRADING";
    string private _symbol = "ACTIVETRADING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x44Fc18CEE7c4097415b80B767922368a6313C663); // Development Address
