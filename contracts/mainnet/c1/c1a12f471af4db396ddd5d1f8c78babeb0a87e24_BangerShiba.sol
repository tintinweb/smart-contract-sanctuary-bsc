...
https://t.me/BangerShiba
https://www.bangerShiba.live
...
contract BangerShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BangerShiba";
    string private _symbol = "$BSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48306BA4a156D1a39b1681b46a0A172a79AfCB1E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x48306BA4a156D1a39b1681b46a0A172a79AfCB1E); // BuyBack Address
