...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x173612a63B6F3860D2435d91D875de0A504e9890; // owner address
...
contract SAUDIMUU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Muu";
    string private _symbol = "SMUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x173612a63B6F3860D2435d91D875de0A504e9890);
    address payable public teamWalletAddress = payable(0x173612a63B6F3860D2435d91D875de0A504e9890); 
