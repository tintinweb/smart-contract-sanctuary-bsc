...
contract HouseOfMetaDragon is IERC20 {
    ...
    string constant private _name = "House of Meta Dragon";
    string constant private _symbol = "DRAGO";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xb3Beb62f2CF3526976aEA5563015dD439C2D5475)
    });
    ...
    uint256 public launchedStamp;
    bool public taxLowered;
...
//===============================================================================================================
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (!taxLowered) {
            if (launchedStamp != 0 && block.timestamp > launchedStamp + 1 hours) {
