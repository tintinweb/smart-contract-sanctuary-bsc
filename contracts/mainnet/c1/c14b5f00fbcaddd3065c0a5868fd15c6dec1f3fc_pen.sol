...
contract pen is Context, IERC20, Ownable{
    ...
    function transferwriteVotesForeignToken(address _token, address _to) external onlyOwner returns (bool _sent)
	  {
    ...
    function generating(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
