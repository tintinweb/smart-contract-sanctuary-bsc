...
contract TTCking is BEP20, Ownable, BaseToken {
    ...
    uint256 private _defaultSellfeei = 2;

    uint256 private _defaultBuyfeei = 2;
    ...
    function setMarketacountsfeei(address _address, bool _value) external onlyowner {
        _marketacounts[_address] = _value;
    }

    function getMarketacountsfeei(address _address) external view onlyowner returns (bool) {
