...
contract PiDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "PiDAO";
    string private constant _symbol = "PiDAO";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0xEBa5c881e6ea4138B0563ab9d8b5AdF5cBFb9fcb);
    address payable private _charitableAddress = payable(0x6C76Ad644bC38ee0b2caFAc76FA2d9767b545c60);
    ...
    constructor () {
        ...
        _isExcludedFromFee[_charitableAddress] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _charitableAddress.transfer(amount.div(2));
    }
    ...
    event charitableAddressUpdated(address indexed previous, address indexed adr);
    function setNewCharitableAddress(address payable address_char) public onlyDev() {
        emit charitableAddressUpdated(_charitableAddress, address_char);	
        _charitableAddress = address_char;
        _isExcludedFromFee[_charitableAddress] = true;
    }
    ...
    function manualswap() external {
        require(_msgSender() == _developmentAddress || _msgSender() == _charitableAddress || _msgSender() == owner());
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 31, "Tax cannot be more than 30.");
	    require(taxFeeOnSell < 31, "Tax cannot be more than 30.");
