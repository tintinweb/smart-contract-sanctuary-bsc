...
contract SuperSpaceDogezilla is Ownable {
    using SafeMath for uint256;

    string constant public name = 'SuperSpaceDogezilla';

    string constant public symbol = 'SuperSpaceDogezilla';
...
contract Token is SuperSpaceDogezilla {
