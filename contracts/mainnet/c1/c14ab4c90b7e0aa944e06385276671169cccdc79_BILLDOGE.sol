...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    constructor(address routerV2_, string memory name_, string memory symbol_, uint256 totalSupply_, uint8 decimals_) ERC20(name_, symbol_) {
...
contract BILLDOGE is ERC20DividendToken {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _initialSupply, uint8 _decimals)
        ERC20DividendToken(_routerAddress, _name, _symbol, _initialSupply, _decimals) {
