...
/**
 *OrigRover Coin from www.origrover.com by INSTING
*/
...
contract OrigRoverToken is BEP20 ("OrigRover Coin", "OR") {

  using SafeMath for uint256;
  // Constants
  uint256 constant public MAX_SUPPLY = 28 * 10 ** 24; //30 million tokens are the max Supply
