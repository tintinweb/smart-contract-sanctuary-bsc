    ...
    OwnableUpgradeable
{
    ...
    function setDestination(address _newDest)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        destination = _newDest;
    }
    ...
    function buy(uint256 amount) external {
        BUSD.transferFrom(msg.sender, destination, amount);
        uint256 amountToMint = (amount * 1 ether) / price;
        admx.mint(msg.sender, amountToMint);

        emit Buy(msg.sender, amountToMint);
    }
