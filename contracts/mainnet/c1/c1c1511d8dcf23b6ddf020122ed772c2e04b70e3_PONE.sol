...
// File: contracts/Project1.sol

pragma solidity ^0.8.0;

contract PONE is ERC20, Ownable {
    ...
    constructor() ERC20("Project One", "PONE") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                devAccrued += (fees * sellTeamFee) / sellTotalFees;
                marketingAccrued += (fees * sellMarketingFee) / sellTotalFees;
            }
            // on buy or transfer
                ...
                marketingAccrued += (fees * buyMarketingFee) / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        uint256 liquidityTokens = (contractBalance * tokensForLiquidity) /
            totalTokensToSwap;
        uint256 marketingAmount = (contractBalance * marketingAccrued) /
            totalTokensToSwap;
        ...
        safeTransferBNB(
            marketingWallet,
            (bnbBalance * marketingAmount) / amountToSwapForBNB
        );
        safeTransferBNB(
            teamWallet,
