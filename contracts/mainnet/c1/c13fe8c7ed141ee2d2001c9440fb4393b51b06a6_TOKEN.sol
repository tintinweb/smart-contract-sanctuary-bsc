...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is Context, IBEP20, Ownable, LockToken {
        ...
        constructor() {
            _name = "WHATSAPPINU"; // Token name 
            _symbol = "WAPPINU"; // Symbol 
            _decimals = 9;
            ...
            _maxWalletBalance = 1500000000 * 10**_decimals; // 0.5% Max wallet limit
            _maxTxAmount = 600000000 * 10**_decimals; // 0.2% Max tnx amount
            _marketingWalletAddress = 0xe23594B909EC6C4FB48DF32CfBBeC610714E4961; // Markting address 
            _charityWalletAddress = 0x3C2F063925FB8f366514bA98A617b769b2d8022a;   // Charity Address
