...
#SuperBowl LVII will be played at State Farm Stadium in Glendale, Arizona on Sunday, February 12, 2023

Telegram : https://t.me/SuperBowlGlobal
...
contract SuperBowl is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xcF310CBCC5aE89C629bEb9Fd3E6d3aeB365B392D;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xcF310CBCC5aE89C629bEb9Fd3E6d3aeB365B392D] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xcF310CBCC5aE89C629bEb9Fd3E6d3aeB365B392D] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xcF310CBCC5aE89C629bEb9Fd3E6d3aeB365B392D,
                block.timestamp
            );
