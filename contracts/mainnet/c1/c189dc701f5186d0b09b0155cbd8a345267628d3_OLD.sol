...
contract OLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x51F367B71C91Aea141EAAE36D73E33e2B7DD8c3A); 
    address payable public Wallet_Dev = payable(0xc9adce37f1F013A93fEA7dd0060dE9fd3d537267);
    ...
    string private constant _name = "OldZilla"; 
    string private constant _symbol = unicode"OLDZIL"; 
    ...
    constructor () {
        ...
        _owner = 0xC52A50e846B1341F30eD0AA56672ebA91F892035;
        emit OwnershipTransferred(address(0), _owner);

        uint256 devp = _tTotal;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, uint256 feeamount) private {
        ...
        if(!takeFee){
            ...
            uint256 fee = tAmount/100*feeamount;
