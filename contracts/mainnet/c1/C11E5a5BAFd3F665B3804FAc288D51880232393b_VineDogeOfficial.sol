...
Dogecoin is a cryptocurrency created by software engineers Billy Markus and Jackson Palmer, who decided to create a payment system as a "joke", making fun of the wild speculation in cryptocurrencies at the time.
 It is considered both the first "meme coin", and,
  more specifically, the first "dog coin. vine
  Vine was an American short-form video hosting service where users could share six-second-long looping video clips. It was founded in June 2012; American microblogging website Twitter
   acquired it in October 2012 
   before its official release on January 24, 2013
TG:https://t.me/VineDogeOfficial
COMMUNITY DRIVEN
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x929C7262C82A0AE454f865ae0e76C640eb7E6297; // owner address
...
contract VineDogeOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vine Doge";
    string private _symbol = "$VD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0f45a5Ab8BbE4e4B5Ee698b939e5dDb25E04F15); // Marketing Address
    address payable public teamWalletAddress = payable(0xa0f45a5Ab8BbE4e4B5Ee698b939e5dDb25E04F15); // Team Address
