...
contract Ownable is Context {
    address private _owner = 0xF0ebF7bA9e42DEe3F546Da504762ba2d75De7A7A;
...
contract Token is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x4cE62146AF523Fa2aED30Dec6EC5dE6eA180E191); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FT"; // token name
    string private _symbol = "FT"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
