...
contract tottsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = " Trick or Treat Tsuka"; // 
    string private constant _symbol = " TOTTSUKA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xA92D6b235B3C2320A48600AdEE6008C59F9eb5Eb;
