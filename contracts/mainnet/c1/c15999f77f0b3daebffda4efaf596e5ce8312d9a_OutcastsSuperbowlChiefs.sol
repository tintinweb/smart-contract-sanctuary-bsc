...
// File: OutcastsSuperbowlChiefs.sol
pragma solidity >=0.8.9 <0.9.0;

contract OutcastsSuperbowlChiefs is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("LOST Outcasts Superbowl: Chiefs", "LOST") {
      setHiddenUri("ipfs://QmR5uzfX8bvHu3wZMLABdCDVKPkyEvAMJGpLrNzTQwVgPU/1.json");
