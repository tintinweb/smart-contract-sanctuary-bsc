...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb904e636734D8E8f989e2fd0da2d0538DDC5A0dD; // owner address
...
contract eightzeroeight is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "808";
    string private _symbol = "808";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb904e636734D8E8f989e2fd0da2d0538DDC5A0dD); // 
    address payable public teamWalletAddress = payable(0xb904e636734D8E8f989e2fd0da2d0538DDC5A0dD); // 
    ...
    uint256 private _totalSupply = 8080 * 10**_decimals;
    uint256 public _maxTxAmount = 42 * 10**_decimals; 
    uint256 public _walletMax = 42 * 10**_decimals;
