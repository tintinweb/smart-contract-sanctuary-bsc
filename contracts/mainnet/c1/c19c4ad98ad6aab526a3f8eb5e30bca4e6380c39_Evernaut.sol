...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x475bFaa1848591ae0E6aB69600f48d828f61a80E);
    IDEXRouter router;
...
contract Evernaut is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB;
    address RWRD = 0x475bFaa1848591ae0E6aB69600f48d828f61a80E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Evernaut";
    string constant _symbol = "EVRN";
    ...
    bool public total_eREKTion = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xcFbdF6389A212C9AF9542089f9BdB52B1db48203;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        devFeeReceiver = 0x4004b54F68d19560391263f71E0aA0395f49C32E;
    ...
    function rekkBitches(bool _status) public onlyOwner {
         total_eREKTion = _status;
    }
    ...
    function enable_eREKTion(bool _status) public onlyOwner {
        eREKTionMode = _status;
    }

    function manage_eREKTion(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
