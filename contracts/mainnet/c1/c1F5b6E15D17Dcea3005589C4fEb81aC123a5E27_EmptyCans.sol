...
// ___________               __          _________                        _________        .__        
// \_   _____/ _____ _______/  |_ ___.__.\_   ___ \_____    ____   ______ \_   ___ \  ____ |__| ____  
//  |    __)_ /     \\____ \   __<   |  |/    \  \/\__  \  /    \ /  ___/ /    \  \/ /  _ \|  |/    \ 
//  |        \  Y Y  \  |_> >  |  \___  |\     \____/ __ \|   |  \\___ \  \     \___(  <_> )  |   |  \
// /_______  /__|_|  /   __/|__|  / ____| \______  (____  /___|  /____  >  \______  /\____/|__|___|  /
//         \/      \/|__|         \/             \/     \/     \/     \/          \/               \/ 
...
contract EmptyCans is Context, IERC20, Ownable {
    ...
    string private _name = "EmptyCans Coin";
    ...
    address payable public marketingWalletAddress = payable(0x4bF36a2cfF8dbbBC73EEc49bf23B3905563eCae6); // Marketing Address
    address payable public teamWalletAddress = payable(0x12c7d189718fDEd9D5C489AA4B84AE9F74216B0B); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x01a9F567AA6deCdcB810fcAB1D27e4d8910Cc159),
            block.timestamp
        );
    }
