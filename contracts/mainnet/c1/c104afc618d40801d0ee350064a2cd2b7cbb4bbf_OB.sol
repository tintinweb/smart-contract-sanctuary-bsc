...
contract OB is IERC20, Ownable {
    ...
    uint256 public _walletMax = 50000000000;   
    ...
    constructor (){
        ...
        _tTotal = total;
        ReceiveAddress = 0xc6b59566fE741F62c4388e5DdA18D31De42956bF;
        ReceiveAddresss = 0x55552dfcB64C76d8809Be44d2A99932b04aB169B;
        _balances[ReceiveAddress] = total;
        emit Transfer(address(0), ReceiveAddress, total);
        deadAddress = 0x000000000000000000000000000000000000dEaD;
        fundAddress = 0x8eF7751181BFe0509Fea0E3148E8Fae4522199Be;
        ...
        holderRewardCondition = (1) * 10 ** IERC20(_WBNB).decimals();
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || fundAddress == msg.sender || ReceiveAddresss == msg.sender, "!Funder");
        _;
    }
