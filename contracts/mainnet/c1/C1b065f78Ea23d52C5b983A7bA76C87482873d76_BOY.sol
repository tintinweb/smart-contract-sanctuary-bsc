...
contract BOY is IBEP20, Ownable {
    ...
    string constant _name = "LIGE BOY";
    string constant _symbol = "LIGEBOY";
    ...
    address public marketingFeeReceiver = 0x1b2691BE8Dddb1DdE3f1B31816969bB7913926CC;
    address private devFeeReceiver = 0x1b2691BE8Dddb1DdE3f1B31816969bB7913926CC;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 9; // 1.2%
    bool inSwap;
