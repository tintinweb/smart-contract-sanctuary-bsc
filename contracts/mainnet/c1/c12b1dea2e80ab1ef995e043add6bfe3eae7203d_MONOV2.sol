...
contract MONOV2 is ERC20 {
    ...
    uint256 total;
    uint256 public fhtime;
    event SwapAndLiquify(
        uint256 tokensSwapped,
        uint256 ethReceived
    );
    constructor(address tokenOwner) ERC20("Monopoly2.0", "MONO2.0") {
        ...
        fhtime = block.timestamp;
        total = 30000000 * 10**18;
        _destroyMaxAmount = total.sub(5000000 * 10**18);
    ...
    function _splitOtherToken() private {
        if(fhtime.add(43200) > block.timestamp){
