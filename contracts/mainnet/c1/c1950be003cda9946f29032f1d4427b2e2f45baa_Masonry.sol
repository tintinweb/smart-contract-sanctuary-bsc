...
interface ITreasury {
    ...
    function getFoldPrice() external view returns (uint256);
...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        tri.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        tri.safeTransfer(msg.sender, amount);
    }
}
...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            fold.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        fold.safeTransferFrom(msg.sender, address(this), amount);
        emit RewardAdded(msg.sender, amount);
    }

    function governanceRecoverUnsupported(IERC20 _token, uint256 _amount, address _to) external onlyOperator {
        // do not allow to drain core tokens
        require(address(_token) != address(fold), "fold");
        require(address(_token) != address(tri), "tri");
