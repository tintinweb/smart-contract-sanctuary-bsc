...
// 
//
// 📱 Telegram:https::https://t.me/LunaBake
...
contract $LUNABAKE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("LUNA BAKE", "LUNABAKE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "LUNABAKE";
    string private _symbol = "LUNABAKE";
