...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xa1611E8D4070dee36EF308952CF34255c92a01c5);
    address POOP = 0xa1611E8D4070dee36EF308952CF34255c92a01c5;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xEA261d1eE90D0F9E205845A7d2205c2AB358f29d);
        _token = msg.sender;
    }
...
contract PooDex is IBEP20, Auth {
    using SafeMath for uint256;

    address POOP = 0xa1611E8D4070dee36EF308952CF34255c92a01c5;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xE56A041b9bC031C2077B2C5Cf330839601b13b8d;

    string constant _name = "POODEX";
    string constant _symbol = "PDex";
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(POOP, address(this));
