...
contract GuMing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GuMing";
    string private _symbol = "GuMing";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x7ed280fb266b1EE9fDC051faf806DE5622cbd8e1); 
    address payable public marketingAddress2 = payable(0x32FFa7e72B9E053d10BDeB2A2ABed6024800dD74); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xbb4829B27F6c2f95b3Efe4dDb5603c3e2f3CC255);
    ...
    uint256 public _buyLpFenhongFee = 0;
