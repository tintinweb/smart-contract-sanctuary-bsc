...
contract DOGELABS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTransactionAmount = 450000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 450000000000000 * (10**18);
    ...
    address payable public  marketingWallet = payable(0x9CeBea77A93bA0aF2B7a3C2E969bC83736f48770);
    ...
    constructor() ERC20("DOGECOINLABS", "DOGELABS") {
        ...
        */
        _mint(owner(), 450000000000000 * (10**18));
    }
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function updateFees(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        require(_bnbRewardFee.add(_liquidityFee).add(_marketingFee) <= 16, "total fees must be less than or equal to 16%");
    ...
    function setMaxtxAmount(uint256 _maxBuyTxAmount, uint256 _maxSellTxAmount) public onlyOwner {
        require(_maxBuyTxAmount >= (totalSupply() * 1 / 1000)/1e18, "Cannot set maxBuyTxAmount lower than 0.1%");
        maxBuyTransactionAmount = _maxBuyTxAmount * (10**18);
        require(_maxSellTxAmount >= (totalSupply() * 1 / 1000)/1e18, "Cannot set maxSellTxAmount lower than 0.1%");
