...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCe8aAfA70195d5209140D4753b148a34C4133490; // owner address
...
contract fifafox is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA FOX";
    string private _symbol = "FF";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xCe8aAfA70195d5209140D4753b148a34C4133490); // Marketing Address
    address payable public teamWalletAddress = payable(0xCe8aAfA70195d5209140D4753b148a34C4133490); // Team Address
