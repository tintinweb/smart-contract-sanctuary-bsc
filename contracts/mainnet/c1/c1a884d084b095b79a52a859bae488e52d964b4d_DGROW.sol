...
library Address{
 ...
 contract DGROW is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3_000_000 * 10*12;
    uint256 public maxBuyLimit = 10_000_000 * 10**12;
    uint256 public maxSellLimit = 5_000_000 * 10**12;
    uint256 public maxWalletLimit = 10_000_000 * 10**12;
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0x917c1B827eCb9b9432Af0711954A9F1d126c336d;
    address private donationWallet = 0x917c1B827eCb9b9432Af0711954A9F1d126c336d;
    address private buybackWallet = 0x917c1B827eCb9b9432Af0711954A9F1d126c336d;

    string private constant _name = "Doge Grow";
    string private constant _symbol = "DGROW";
    ...
    Taxes private taxes = Taxes(0, 8, 0, 0, 0);
    Taxes private sellTaxes = Taxes(0, 12, 0, 0, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(to == pair) isSell = true;
        		...
        		if(!tradingEnabled) {
		    require(_canTransferBeforeTradingIsEnabled[from], "Trading not open yet");
		}
    ...
    function updateSwapTokensBalance(uint256 weiAmount, address _to) external onlyOwner{
