...
contract EqualityDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EqualityDAO";
    string private _symbol = "EqualityDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x257394e5D4FB499058cc377Ea2D22c9d6Ccf5F35);
    address payable public teamWalletAddress = payable(0x7E54dB88539D88b7a788B3b319cBc96564c7d9B4);
