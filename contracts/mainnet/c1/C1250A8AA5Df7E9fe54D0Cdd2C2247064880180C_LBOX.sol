...
/** https://t.me/lockboxtoken website : http://www.lockboxtoken.com/
 *
*/
...
contract LBOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lock Box token";
    string private _symbol = "LockBoxToken";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA4Fb8Edb45917078a5e505eD3564F5fff35230de); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xcedfE48cBc4A5D0497910c7c5F9ed0c005B63D3C); // Development Address
