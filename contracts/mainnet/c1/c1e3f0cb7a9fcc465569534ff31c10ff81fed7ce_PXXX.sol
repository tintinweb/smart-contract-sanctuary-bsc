...
contract PXXX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x77688551E642425E4A028C52f1Cd45DdAAF56797); // Marketing Address
    ...
    string private _name = "Project XX";
    string private _symbol = "PXXX";
