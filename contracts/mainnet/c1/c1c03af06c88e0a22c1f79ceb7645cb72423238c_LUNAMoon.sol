...
contract LUNAMoon
 is Context, IERC20, Ownable {
    ...
    string private _name = "LUNAMoon";
    string private _symbol = "LUNAM";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x611f713d91F14EF338cFEd4140DC8cAA794258C8));
        _anotherA = payable(address(0x611f713d91F14EF338cFEd4140DC8cAA794258C8));
