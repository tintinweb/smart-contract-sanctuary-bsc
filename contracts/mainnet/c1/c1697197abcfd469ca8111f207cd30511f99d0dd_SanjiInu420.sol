...
contract SanjiInu420 is Context, IERC20, Ownable {
    ...
    string private constant _name = "SANJI INU 420"; // 
    string private constant _symbol = "S420"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xeA2f7e6EA9aFd00C8cCE5ED7f37d5D5ec8fbB641;
