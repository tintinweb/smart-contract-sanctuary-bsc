...
/** WhalesChinese 是我们在中国的鲸鱼社区令牌，我们正在为所有加密社区制作它，它将在 Pancake Fair 上推出！我们将把它发送给数百万的市值，并将快速跟踪 CG/CMC。如果您能早点加入我们，稍后享受利润，我们很高兴 #ToTheMoon

WhalesChinese is our whale community token in China and we are making this for all crypto community and it will be launched at Pancake Fair! we will send this to millions marketcap and will Fast Track CG/CMC. 
We are happy if you can join us early to enjoy profits later #ToTheMoon
https://t.me/WhalesChinese
...
contract WhalesChinese is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whales Chinese";
    string private _symbol = "WHACIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97c1E7Cc13F892d1438025cD3BC4B463642209f2); // whales
    address payable public teamWalletAddress = payable(0x97c1E7Cc13F892d1438025cD3BC4B463642209f2); // whales
    ...
    uint256 public _maxTxAmount = 38540 * 10**_decimals; 
    uint256 public _walletMax = 38540 * 10**_decimals;
