...
Gala Games
@GoGalaGames
Empowering players all over the world. This is the only Twitter for the Gala Games ecosystem
...
contract KAIKGALA is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'KAIKGALA';
    string private _symbol = 'KAIKGALA';
