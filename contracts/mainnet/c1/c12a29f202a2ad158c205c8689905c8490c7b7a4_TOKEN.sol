...
abstract contract AbsToken is IERC20, Ownable {
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _buylLPFee + _sellFundFee + _sellLPDividendFee + _sellLPFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                swapFee = _buyFundFee + _buyLPDividendFee + _buylLPFee;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        swapFee += swapFee;
        uint256 lpFee = _buylLPFee + _sellLPFee;
    ...
    function setBuylLPFee(uint256 lpFee) external onlyOwner {
        _buylLPFee = lpFee;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        2000000,//Supply
        address(0x41eE3462b349440a648D741Ea69341D972cBCB94),//FundAddress
        address(0x5035E598B3B25F31BBa9E220ca2Df85a425E987b)//ReceiveAddress
    ){
    }
}