...
contract Healing is Context, IERC20, Ownable {   
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The world needs healing";  
    string private _symbol = "Healing";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5fC00d0BFc3f0De948bF977DF63128EAe98Fe85A); 
    address payable private teamWalletAddress = payable(0x17A05B6aCbef05d0Af35fCBaAc408A758271fE77); 
