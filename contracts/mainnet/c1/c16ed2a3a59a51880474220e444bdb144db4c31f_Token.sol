...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mustard Inu";
    string private constant _symbol = "HEINZ";
    ...
    Taxes public taxes = Taxes(2, 10, 1, 4, 1);
    Taxes public sellTaxes = Taxes(2, 10, 1, 4, 1);
