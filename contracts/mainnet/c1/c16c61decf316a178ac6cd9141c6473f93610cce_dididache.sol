...
contract dididache is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "dididache";
    string private _symbol = "dididache";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21Cd9Cd952fFDc53407c97b61463C04B5a574bc0);
    address payable public teamWalletAddress = payable(0x105A0D1fFc5213d79BF0F668e94269604149Fe3E);
    ...
    uint256 private _totalSupply =  314159265358 * 10**_decimals;
    uint256 public _maxTxAmount =   314159265358 * 10**_decimals;     
    uint256 public _walletMax =     314159265358 * 10**_decimals;      
