...
contract AmaeaoiWieiiSiidiiee is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 3.5e8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Dallas Dog City";
    ...
    uint256 public numTokensSellToAddToLiquidity = 3.5e4 * 10**9;
