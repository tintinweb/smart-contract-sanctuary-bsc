...
contract TokenFactory is Context, IERC20, Ownable {
    ...
    uint256 public _sellDestroyFee = 15;
    ...
    constructor (
        ...
        uniswapPair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), pairToken);
        _name = tName;
        _symbol = tSymbol;
        _decimals = tDecimals;
        _owner = _msgSender();
    ...
    function changeRouterVersion(address newRouterAddress, address pairToken) public onlyOwner returns(address newPairAddress) {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(newRouterAddress);

        newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(address(this), pairToken);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(_marketingAddress, amountBNBMarketing);
