...
// File: PyeSwap/PyeSwap_farming/contracts/interfaces/IERC20.sol
...
// File: PyeSwap/PyeSwap_farming/contracts/interfaces/IBEP20.sol
...
// File: PyeSwap/PyeSwap_farming/contracts/libs/SafeBEP20.sol
...
// File: PyeSwap/PyeSwap_farming/contracts/libs/BEP20.sol
...
// File: PyeSwap/PyeSwap_farming/contracts/Apple.sol
...
// File: PyeSwap/PyeSwap_farming/contracts/SmartChefWBNB.sol
...
contract SmartChefWBNB is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function emergencyWithdraw() external nonReentrant {
        ...
        if(!isBountyExempt[msg.sender]){ setShare(msg.sender, 0); }
    ...
    function depositWBNB(uint256 _amount) external onlyOwner {
        uint256 balanceBefore = IERC20(address(WBNB)).balanceOf(address(this));

        IERC20(WBNB).transferFrom(address(msg.sender), address(this), _amount);
...
// File: PyeSwap/PyeSwap_farming/contracts/SmartChefFactoryWBNB.sol
...
contract SmartChefFactoryWBNB is Ownable {
    event NewSmartChefWBNBContract(address indexed smartChefWBNB);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SmartChefWBNB).creationCode;
        ...
        SmartChefWBNB(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewSmartChefWBNBContract(smartChefAddress);
    }
}