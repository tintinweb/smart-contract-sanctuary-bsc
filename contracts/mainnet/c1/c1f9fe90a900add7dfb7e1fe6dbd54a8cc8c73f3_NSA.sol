...
contract NSA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NSA";
    string private _symbol = "NSA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb3d758115cAFC06Af8a59D37580659ca7c0BC916); 
    address payable public BurnedWalletAddress = payable(0xb3d758115cAFC06Af8a59D37580659ca7c0BC916); 
