...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF2C369B270c7e4A74Fc82Fb73ac1B3A6281b4C53; // owner address
...
contract ASTRO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF2C369B270c7e4A74Fc82Fb73ac1B3A6281b4C53); // 
    address payable public teamWalletAddress = payable(0xF2C369B270c7e4A74Fc82Fb73ac1B3A6281b4C53); // 
