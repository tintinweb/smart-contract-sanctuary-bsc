...
contract METAFINANCETOKEN {
    ...
    {
         require(istransfer, "Transfer token di!");
        require(!isBlocklisted[msg.sender], "Address is bl!");
    ...
    function transferFrom(
        ...
        uint256 _value
         ...
         require(istransfer, "Transfer token di!");
        require(!isBlocklisted[msg.sender], "Address is blo!");
