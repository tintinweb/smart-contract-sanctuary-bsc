 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/KingDogeBNB
 * 
 * 
 * KingDogeBNB token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract KingDogeBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KingDogeBNB";
    string constant _symbol = "KINGDBNB";
