...
/**
   Graphic 3.0 Network
   It is a project that offers an alternative graphics card created by using the power
   of the blockchain with the development of the Web3 sector and technology.
   www.graphic3.network
*/
...
contract Graphic3Network is Context, IERC20, Ownable {
    ...
    string private _name = "Graphic 3.0";
    string private _symbol = "G3N";
    ...
    address public charityWallet = 0x893C3A1902E67b47f0Ae496f24eE9f69E1e1ce06;
