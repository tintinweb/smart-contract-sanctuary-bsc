...
Telegram community https://t.me/rubycornchannel
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RUBYCORNBUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    uint256 public minimumTokenBalanceForDividends = 5000000000 * (10**9); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RUBYCORNBUSD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(RUBYCORNBUSD);
        ...
        uint256 amount = RUBYCORNBUSD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RUBYCORNBUSD.transfer(shareholder, amount);
...
contract LockToken is Ownable {
    ...
    function RUBYCORNTRADE() external onlyOwner {
        isOpen = !isOpen;
    }

    function RUBYCORNMOON(address[] calldata _users) external onlyOwner {
...
contract RUBYCORN is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "RUBYCORN";
    string constant _symbol = "RUBYCORN";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(100); 
    uint256 public _maxWalletHold = 20000000000;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            payable(devWallet).call{value: amountBNBDev, gas: 3000}("");
