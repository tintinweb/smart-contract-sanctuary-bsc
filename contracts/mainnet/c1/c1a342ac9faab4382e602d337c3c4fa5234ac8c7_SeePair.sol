...
contract SeePair {
    address public coinbs = address(0xfC7E3E600B0a8472c6A12903D4f75c502Da295C0); // dot 18
    uint256 public burnbs; // dot 4, burn 14% = 1400
    address public addrFeeBuy = address(0xec4d7b54444Fe6EB714a0F4e95Eb5f8ca4694b49);
    address public addrFeeSell = address(0xb3331de42b22888ecEc1e662fF96b9B89ca16229);
    ...
    function sendBuyFee() public {
        IERC20(coinbs).transfer(addrFeeBuy, allfee);
        allfee = 0;
    }

    function sendSellFee() public {
    ...
    public view returns(uint256, uint256) {
        ...
        uint256 usdtAmount = coins * pAvg / 10 ** _n[addr][3];
        return (usdtAmount, pStep);
    }
