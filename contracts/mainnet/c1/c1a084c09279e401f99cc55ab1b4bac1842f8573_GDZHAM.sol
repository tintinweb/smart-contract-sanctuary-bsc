...
contract GDZHAM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GODZIHAM";
    string private _symbol = "GDZHAM";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x682596Bf58ab13e9112F2D2682A0CD36F2f809B8); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x682596Bf58ab13e9112F2D2682A0CD36F2f809B8); // Team Address
