...
contract OlympusChain is BEP20, Auth {
    ...
    string public constant name = "Olympus Chain";
    string public constant symbol = "OLYC";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + ecosystemFee + stakingFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xE7DEAE0EA889aee8Bc83C191f4644b9bAdB18760;
        marketingFeeReceiver = 0xE7DEAE0EA889aee8Bc83C191f4644b9bAdB18760;
        ecosystemFeeReceiver = 0xE7DEAE0EA889aee8Bc83C191f4644b9bAdB18760;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(ecosystemFee).div(totalETHFee);

        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(ecosystemFeeReceiver).transfer(amountBNBDev);
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _stakingFee, uint256 _ecosystemFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        stakingFee = _stakingFee;
        ecosystemFee = _ecosystemFee;
        totalFee = _liquidityFee + _marketingFee + ecosystemFee + _stakingFee;
        
        _updatefees();
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemFeeReceiver, address _stakingFeeReceiver) external onlyOwner {
        require(_marketingFeeReceiver != address(0),"Marketing fee address cannot be zero address");
        require(_ecosystemFeeReceiver != address(0),"Dev fee address cannot be zero address");
