...
contract RUGSINC is ERC20, Ownable {
    ...
    address public marketingWallet = 0x33BB6925B85e7408beFedf9a5A9215D0d6ADb294;
    address public devWallet = 0x33BB6925B85e7408beFedf9a5A9215D0d6ADb294;
    address public operationsWallet = 0xc4258F6a1fBD9113AaeaD76e7f369f84D7cc4321;
    address public charityWallet = 0x33BB6925B85e7408beFedf9a5A9215D0d6ADb294;
    ...
    Taxes public taxes = Taxes(4, 4, 0, 1, 0, 0);
    Taxes public sellTaxes = Taxes(4, 4, 0, 1, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Rugs INC", "RINC") {
