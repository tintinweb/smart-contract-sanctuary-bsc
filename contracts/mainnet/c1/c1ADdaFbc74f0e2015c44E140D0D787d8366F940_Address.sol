...
contract IDE is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 420000 * 10e9;
    
    address public marketingWallet = 0x527Da2a18413B9Acd9A9c3B8baDf92eB56EE5a76;
    ...
    Taxes public sellTaxes = Taxes(5,3);
    ...
    constructor() ERC20("Lucky 7's", "777") {
        _mint(msg.sender, 21000000 * 9 ** decimals());
    ...
    function swapForFees() private inSwap {
        ...
        if (contractBalance >= swapThreshold) {
            ...
            uint256 denominator = (sellTaxes.marketing + sellTaxes.liquidity) * 7;
