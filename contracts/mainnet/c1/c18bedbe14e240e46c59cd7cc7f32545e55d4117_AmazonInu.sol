...
contract AmazonInu is IBEP20, Auth {
    ...
    address DevWallet       = 0xf1f4dc9fb29184e69cF39C09e19bA0F154E3AE5a;

    string constant _name = "AMAZON INU";
    string constant _symbol = "AMAZONU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 300 * (10 ** _decimals);
    uint256 public _maxWalletToken = 300 * (10 ** _decimals);
