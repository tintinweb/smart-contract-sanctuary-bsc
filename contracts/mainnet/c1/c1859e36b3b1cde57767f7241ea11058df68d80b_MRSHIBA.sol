...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x45d4404A30E8c53890a6639cc846B23f8B0f2A0f;
...
contract MRSHIBA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MRSHIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x45d4404A30E8c53890a6639cc846B23f8B0f2A0f);
