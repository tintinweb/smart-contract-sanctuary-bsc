...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 1 * 1 * 1;
...
contract sixsixsix is IBEP20, Auth {
    ...
    string constant _name = "Six Six Six";
    string constant _symbol = "666";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 666**1 * 10**_decimals;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB * (totalBNBFee) / (totalBNBFee);
