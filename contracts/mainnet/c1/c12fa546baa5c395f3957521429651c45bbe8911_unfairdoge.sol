...
contract unfairdoge is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 20_000_00000 * 10 ** _decimals;

    uint256 public maxBuyAmount = 100_000_000000 * 10 ** _decimals;
    uint256 public maxWalletBalance = 3000_000_000 * 10 ** _decimals;

    address public marketingAddress = 0x2a00d63Ee02b3a7Cf0b4ec921a30B68676B87a1e;
    address public devAddress = 0x2a00d63Ee02b3a7Cf0b4ec921a30B68676B87a1e;

    string private constant _name = "unfairdoge";
    string private constant _symbol = "ufdoge";
    ...
    Taxes public taxes = Taxes(1, 1, 6);
