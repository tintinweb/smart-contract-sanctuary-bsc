...
contract Bulli$hDestiny  is ERC20, Ownable {
    ...
    constructor() ERC20("Bulli$h Destiny", "@BDE") {
        ...
        swapTokensAtAmount = totalTokenSupply / 600; //
    ...
    function updateFees(
        ...
        require(totalSellFees <= 25 && totalBuyFees <= 5, "total fees cannot exceed 25% sell or 5% buy");
