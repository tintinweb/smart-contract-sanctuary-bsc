...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x639CF44b66D02F822c57F97dabAF3547462f0CE9);
...
/* Token contract */
contract HurricaneIanInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x639CF44b66D02F822c57F97dabAF3547462f0CE9; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x7d5AAB1F3bD85865C342473e8b4277fbd278Cc52;
    ...
    // Name and symbol
    string constant _name = "Hurricane Ian Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 75000 / 10000; // 1.5% on launch or 15000 tokens
    uint256 public _maxSellTxAmount = _totalSupply * 25000 / 10000; // 1% or  10000 tokens
    uint256 public _maxWalletToken = ( _totalSupply * 75000 ) / 10000; // 1.5 % or 15000 tokens
    ...
    uint256 public swapThreshold = _totalSupply * 25000 / 10000; // 1% of supply
