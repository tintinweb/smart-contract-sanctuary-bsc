...
Mr.BullBTC 2023 - bullish name and GEM

Join: https://t.me/MrBull2023portal
...
contract MrBullBTC2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mr BullBTC 2023";
    string private _symbol = "MrBull";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x0b9CFb48286917867902649237D8F11e76c5b1b8);
    address payable public teamWalletAddress = payable(0x05dc13DCF100C5b9bc43B759836C08E70D5459B0);
