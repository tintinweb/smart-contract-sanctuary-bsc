...
contract GeniusesAreOftenRejectedBySociety is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GeniusesAreOftenRejectedBySociety Inu";
    string private _symbol = "ELON";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x576bc10C10325EF81594156766322f82F75361a6);
