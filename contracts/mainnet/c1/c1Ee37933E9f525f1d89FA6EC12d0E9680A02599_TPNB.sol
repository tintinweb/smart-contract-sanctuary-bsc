...
contract TPNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TPNB";
    string private _symbol = "TPNB";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xEE674482E4900AB9d4BB401fBEA0737a2Fd91Eb4); // Marketing Address
    address payable private teamWalletAddress = payable(0x0843b49aC372fBB7fd8153fC5FF1f7a1d18DfBFc); // Team Address
