...
abstract contract SquidGrow is Context, IERC20, Ownable {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function pendingSquidgrow(uint256 _pid, address _user) external view returns (uint256) {
        ...
        return user.amount.mul(accSquidgrowPerShare).div(1e19).sub(user.rewardDebt);
    }
