...
contract santagirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santa Girl";
    string private constant _symbol = unicode"圣诞老人女孩";
