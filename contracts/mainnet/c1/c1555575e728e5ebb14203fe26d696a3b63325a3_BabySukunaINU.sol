...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46f5C56555dd79ACb153F8584C800f422198e8c1; // owner address
...
contract BabySukunaINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySukunaINU";
    string private _symbol = "BabySukunaInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46f5C56555dd79ACb153F8584C800f422198e8c1); // Marketing Address
    address payable public teamWalletAddress = payable(0x46f5C56555dd79ACb153F8584C800f422198e8c1); // Team Address
    ...
    uint256 public _teamShare =0 ; // original 10
