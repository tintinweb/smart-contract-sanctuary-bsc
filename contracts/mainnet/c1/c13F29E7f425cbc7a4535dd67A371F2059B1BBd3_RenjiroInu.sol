...
*/
/**
WELCOME EVERYONE TO RENJIRO INU

We will be doing a stealth launch so keep an eye on the chat. 

RENJIRO INU

RENJIRO INU is the next evolution of tokens on the Binance Smart Chain. Renjiro Inu will reward the holders with many utilites coming soon.
...
contract RenjiroInu is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 1e9; // Renjiro Inu Kill Zero
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Renjiro Inu"; // token name
    string private _symbol = "RINU"; // token ticker
    ...
    uint256 public marketWalletFeeOnSelling = 120;
