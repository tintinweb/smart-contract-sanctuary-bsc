...
contract himawariinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x187Fadc3eA142a4dA97D5Ae8765Ef107Df9a755C); 
    address payable public Wallet_Dev = payable(0x717Fe22d1Ff659259884B13e6e822ecB1b8E261b);
    ...
    string private constant _name = "Himawari Inu"; 
    string private constant _symbol = "$HimawariInu"; 
