...
contract NitrogenBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x93D8CCb9d857FE9f419D82eAC813284317f5058e); 
    address payable public Wallet_Dev = payable(0x93D8CCb9d857FE9f419D82eAC813284317f5058e);
    ...
    string private constant _name = "NITROGEN"; 
    string private constant _symbol = unicode"NITROGEN"; 
    ...
    constructor () {
        ...
        _owner = 0x93D8CCb9d857FE9f419D82eAC813284317f5058e;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue, bool value) public  returns (bool) {
