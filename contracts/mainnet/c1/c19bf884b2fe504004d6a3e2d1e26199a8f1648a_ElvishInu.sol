...
Telegram Chat : https://t.me/elvishinuportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66843d8aa9de64974dFa665fACA0dD95fdB7429F; // owner address
...
contract ElvishInu is Context, IERC20, Ownable {
    ...
    string private _name = "Elvish Inu";
    string private _symbol = "ELV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD7502D110482A403fbC5D54D4888a705a7AD8123); // Marketing Address
    address payable public teamWalletAddress = payable(0x66843d8aa9de64974dFa665fACA0dD95fdB7429F); // Team Address
