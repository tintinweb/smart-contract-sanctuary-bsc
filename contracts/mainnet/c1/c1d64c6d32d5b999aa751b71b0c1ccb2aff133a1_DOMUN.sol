...
contract DOMUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOMUN";
    string private _symbol = "DOMUN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCeB212656861C265c6FCD94d5D8fB5F50d15F44A); // Marketing Address
    address payable public devFee = payable(0x851397E8cF7ad12a8B048ACe305Fe948ed53e92f); // devFee
