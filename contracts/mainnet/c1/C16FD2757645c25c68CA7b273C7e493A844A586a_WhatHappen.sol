...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x410c3B684F3535e335495d421FCd5713a0A4db10;
...
contract WhatHappen is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x33A50D1B0F24D2cAf1F0f7A2f2C8734FaB1a5300;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "What Happen";
    string private _symbol = "WHN";
