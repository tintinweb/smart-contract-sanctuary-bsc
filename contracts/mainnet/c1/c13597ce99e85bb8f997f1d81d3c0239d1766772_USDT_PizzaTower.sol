...
contract USDT_PizzaTower {
    ...
    constructor(address manager1_,address manager2_) {
       marketing1 = manager1_;
       marketing2 = manager2_;
    }
    ...
    function addCoins(address ref, uint256 value) initialized external {
        ...
        uint256 manager1_ = (value * 2) / 100;
        uint256 manager2_ = (value * 2) / 100;
        USDT_TOKEN.transferFrom(msg.sender, manager, valueToManager - manager1_ - manager2_);
        USDT_TOKEN.transferFrom(msg.sender, address(this), value - valueToManager - manager1_ - manager2_);
    }
