...
contract DEFIPrivateSale is Owned {
    ...
    uint256 public tokenRatePerEth = 1500e18;
    uint256 public rateDecimals = 0;
    
    uint256 public minEthLimit = 1e17; // 0.1 BNB
    uint256 public maxEthLimit = 1e18; // 1 BNB

    uint256 public maxTier2EthLimit = 7e17; // 0.7 BNB
