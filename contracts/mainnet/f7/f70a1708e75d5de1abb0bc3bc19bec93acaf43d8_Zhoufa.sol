...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5b1B339d33e94750DFB099402C02C94b775723d8;
...
contract Zhoufa is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Zhoufa"; 
    string private constant _symbol = unicode"ZHF"; 
    ...
    uint256 public _lastblockcount = 5; 
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5b1B339d33e94750DFB099402C02C94b775723d8); 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5b1B339d33e94750DFB099402C02C94b775723d8), BNB_Tot);
