...
/*    
Telegram : https://t.me/chihuahuagrow_bsc
...
contract chihuahuagrow is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x742F729c244eAcF070473f63b2ba8b8b7dAba315);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5 * 10**9 * 10**_decimals;
