...
/**
** This is a community token with 1% LIQUIDITY TAX 
** NO MARKETING WALLET, NO DEV WALLET - Creator has provided 1BNB Liquidity and has 1% Tokens

** LP BURN & CONTRACT RENOUNCED! MAX WALLET IS 1%

** CREATE A TELEGRAM CALLED:  https://t.me/renouncedbtc (it is available RIGHT NOW)
** BUILD A COMMUNITY!!! - GOOD LUCK

** USE FREE CALLS, CALL IT FOR FREE, GRAB A BAG AND SHILL IT!!!
...
contract RenouncedBTC is IBEP20, Auth {
    ...
    string constant _name = "RenouncedBTC";
    ...
    address private marketingFeeReceiver =0x0000000000000000000000000000000000000000; //NO MARKETING WALLET
    address private teamFeeReceiver =0x0000000000000000000000000000000000000000; // NO TEAM WALLET
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xc99001471b27D6F9053120e9f6C270A32FF9E742;
