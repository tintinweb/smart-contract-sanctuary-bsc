...
contract Dogedo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dogedo Inu";
    string private _symbol = "Dogedo";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x6EAA641D2Dae3F2E66E13008F530FE0E7D1Be8C5);
