...
contract ProofofStake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof of Stake";
    string private _symbol = "Proof of Stake";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7Bb681e49b4a1B3404Ae0DA6dCac8fEB6Cd1892B); 
