...
contract KINGSHIBA is IBEP20, Auth {
   ...
   string constant _name = "King Shiba";
   string constant _symbol = "KSHIBA";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 2 ) / 1000; // 
    uint256 public _maxSellTxAmount = ( _totalSupply * 2 ) / 1000; // 
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0xb1C78c2C3A294c1f0524b824534684658A5a9D4e;
       marketingFeeReceiver = 0xb1C78c2C3A294c1f0524b824534684658A5a9D4e;
