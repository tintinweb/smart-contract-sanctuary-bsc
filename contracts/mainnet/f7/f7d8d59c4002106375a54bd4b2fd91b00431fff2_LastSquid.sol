...
contract LastSquid is IBEP20, Auth {
    ...
    string constant private _name = "The Last Squid";
    string constant private _symbol = "LastSquid";
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function setcooldownTimer(bool _status, uint8 _interval) public authorized {
