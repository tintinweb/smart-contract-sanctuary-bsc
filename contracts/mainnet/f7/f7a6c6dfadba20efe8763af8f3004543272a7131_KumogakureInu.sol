...
library Address{
 ...
 contract KumogakureInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD4beb03d1cFf22675215918a15332F204f72E4dD;
    address public donationWallet = 0xD4beb03d1cFf22675215918a15332F204f72E4dD;

    string private constant _name = "Kumogakure Inu";
    string private constant _symbol = "KUMONU";
    ...
    function setSellTaxes(uint256 reflectFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) public onlyOwner {
       sellTaxes = Taxes(reflectFee,liquidityFee,marketingFee,burnFee);
        emit FeesChanged();
    }
