...
contract KatakuriInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x1b1F7c21022724705BAFa25DC6cEbC6f0a6463DE;
    string constant _name = "Katakuri Inu";
    string constant _symbol = "KATAKURI";
