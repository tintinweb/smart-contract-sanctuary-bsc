...
But that doesn't mean you can't be blissed
With our token, Santa Claus DoesntExist,
You'll find all the joy and fun you'll miss
Without old Saint Nick. Don't be a skeptic,
Buy our token and see the magic!

https://t.me/santadoesntexist
...
contract SantaDoesntExist is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaDoesntExist";
    string private _symbol = "SDE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB82aB76ec0EF0Cf046fcbFd349AcDF7845dC7168); // Marketing Address
    address payable public devFee = payable(0xB82aB76ec0EF0Cf046fcbFd349AcDF7845dC7168); // devFee
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(devFee, amountBNBBuyBack);
