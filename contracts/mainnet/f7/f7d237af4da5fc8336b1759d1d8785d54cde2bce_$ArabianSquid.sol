...
██║  ██║██║  ██║██║  ██║██████╔╝██║██║  ██║██║ ╚████║███████║╚██████╔╝╚██████╔╝██║██████╔╝
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝ ╚══▀▀═╝  ╚═════╝ ╚═╝╚═════╝ 
 TG https://t.me/+whffL1jZEww3YzYx  

🦑☀️ ARABIAN SQUID ☀️🦑

- Initial Supply: 
100,000,000,000,000,000 ARS

- MaxTxAmount:
2,000,000,000,000,000 ARS
...
🤩 Semi-Stealth
😎 Based Dev
📈 5BNB Starting Liquidity
🔐 Liquidity Locked for 2 Days, extending more and more!
💰 Max Wallet 2%
*/
...
contract $ArabianSquid is IBEP20, Auth {
    ...
    string constant _name = "ArabianSquid";
    string constant _symbol = "ARS";
