...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x741Da95C1113f294e9332891b125291669638291; // owner address
...
contract BASICCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Basic chain";
    string private _symbol = "BCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF03E40848f284EA789A7f3b005d0D2800DA1d4a7); // Marketing Address
    address payable public developmentWalletAddress = payable(0x741Da95C1113f294e9332891b125291669638291); // Development Address
