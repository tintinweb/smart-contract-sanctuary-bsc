...
contract GSS is IBEP20, Auth {
    ...
    string constant _name = "Green Sensei Shib";
    string constant _symbol = "GSS";
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(200).div(1000);
