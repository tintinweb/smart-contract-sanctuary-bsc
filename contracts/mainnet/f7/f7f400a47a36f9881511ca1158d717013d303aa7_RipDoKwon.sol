...
//contract created by 69RATZ DEV/
/**
...
/* Token contract */
contract RipDoKwon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xB2b99322Fac3B93a399CBa93baD6B96bb747c750;
    ...
    // Name and symbol
    string constant _name = "RIP DO KWON";
    string constant _symbol = "$RIPKWON";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 10TH

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000000 / 1000000;
    uint256 public _maxSellTxAmount = _totalSupply * 1000000 / 1000000;
    uint256 public _maxWalletToken = ( _totalSupply * 1000000 ) / 1000000;
