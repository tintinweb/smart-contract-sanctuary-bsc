...
contract BNBEX_BUSD {
	...
	uint256 public INVEST_MIN_AMOUNT = 50 ether; // 50 BUSD
	uint256[] public REFERRAL_PERCENTS = [120, 30, 10];
	uint256 constant public DEV_FEE = 100;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
    
    /*! anti-whale */
    uint256 public MAX_WITHDRAW = 2000 ether; // 2000 BUSD MAX
    uint256 public limit = 50 ether;
	...
	constructor(address payable wallet) {
        ...
        plans.push(Plan(120, 50)); // 120 days 5% daily // 600%
        plans.push(Plan(45, 100)); // 45 days 10% daily // 450%
        plans.push(Plan(25, 120)); // 25 days 12% daily // 300%
        plans.push(Plan(13, 150)); // 13 days 15% daily // ~ 200%
	}
