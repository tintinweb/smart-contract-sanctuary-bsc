...
contract KOLE is Operator {
    ...
    string private _name = "KOLE";//#币名
    string private _symbol = "KOLE";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 1000000000000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 1000000000000000000000 * 1e9);

        IUniswapV2Factory factory = IUniswapV2Factory(0x31392170C12033fcb74F0c450FBE0E7a2D311aFF);
        address pair = factory.createPair(address(this),address(0xa9b236efCf252b3cdE17E2C5adcD4B885A12A5b6)); 
        setFeeList(pair,true);

        setWhiteList(address(0xc0D28EdF191f0eb1a075B49CFa115E24d78f8Bad),true);
    }
