...
/**
TOKEN NAME: IOKBAN502 Network
TICKER: IOKBAN502


Tokenomics:

TOTAL SUPPLY: 100,000,000 (of course)

Buy Tax : 8% 
4% Marketing Wallet/Community, Giveaways, Contests, Supporting Partnerships
3% Developer Wallet (Dev salary, to keep developer motivated to continue pushing the project at all times!)
1% Liquidity 

5% (SET ASIDE FOR SERIOUS TEAM MEMBER AIRDROPS, EXTRA MARKETING IF NEEDED & BURNS; TBA) 

Sell Tax : 8%
4% Marketing Wallet/Community, Giveaways, Contests, Supporting Partnerships
2% Developer Wallet (Dev salary, to keep developer motivated to continue pushing the project at all times!)
2% Liquidity

Buy/Sell Tax May Be Reduced Overtime

No Max Transaction - 2% Max Wallet 

Social Media Links: (Changes May Occur Overtime) 

Telegram: https://t.me/IOKBAN502Network
Twitter:  https://twitter.com/IOKBAN502Network
Website:  https://IOKBAN502Network.app or  https://IOKBAN502.app (Community will have the option to vote on which domain they think is best for IOKBAN502 Network)
*/
...
contract IOKBAN502 is Context, IERC20, Ownable {
    ...
    string private constant _name = "IOKBAN502";
    string private constant _symbol = "IOKBAN502";
    ...
    function closeTrading() private {
        boughtEarly = true;
        blocksToWait = 666666;
    }
    function closeTradingx() external onlyOwner(){
        closeTrading();
    }
