...
Telegram : https://t.me/Pupienus_maximus
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdB9D6524ba931C9601d4D57F4dE0E6F7b7ebc127;
...
contract Pupienus_Maximus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pupienus Maximus"; // 
    string private constant _symbol = "$POOPY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xdB9D6524ba931C9601d4D57F4dE0E6F7b7ebc127);
