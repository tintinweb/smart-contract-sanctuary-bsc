 ...
 *                          
 *      
 *      Reward: Pleasure Coin 
 *      Reward address: 0xaA076B62EFC6f357882E07665157A271aB46A063
*/         
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xaA076B62EFC6f357882E07665157A271aB46A063); // Pleasure Coin
...
contract BABYcontract is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Pleasure Coin", "bNSFW") {
        
        address newOwner = address(0x8493d4242298d3E7f3D212ec6E0b7BafE35F56a1);
    
        uint256 totalSupply = 6900000 * 10**18;
        ...
        rewardsSellFee = 3;
        marketingSellFee = 4; //marketing + creator tax 2-2%
        liquiditySellFee = 3;
        totalSellFees = rewardsSellFee + marketingSellFee + liquiditySellFee;
        
        rewardsBuyFee = 3;
        marketingBuyFee = 4; //marketing + creator tax 2-2%
        liquidityBuyFee = 3;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0x1082c0121fB0B5060Ea47c96Cf423800e61C3df3); // set as creator wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x8493d4242298d3E7f3D212ec6E0b7BafE35F56a1),
            block.timestamp
        );
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 34500 * (10**18); //must hold 34,500 (0,5%) tokens
    }
