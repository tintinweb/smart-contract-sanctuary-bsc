...
contract Gen1 {
 ...
 plans.push(Plan(3, 50, 800));
    ...
    function invest( uint8 plan,  uint256 _amount) public {
		...
		user.deposits.push(Deposit(plan, percent, _amount, profit, block.timestamp, finish, ( block.timestamp+(plans[plan].withdrawl/**60*60*/))));
