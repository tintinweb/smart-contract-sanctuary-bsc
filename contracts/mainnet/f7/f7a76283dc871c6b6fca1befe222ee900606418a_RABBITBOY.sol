...
// File: RABBITBOY_flat.sol


// File: contracts/RABBITBOY.sol
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2fb1F59B47E7C24a0815499DD235114e00ac6E0f; // owner address
...
contract RABBITBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Boy";
    string private _symbol = "$RABBITBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2fb1F59B47E7C24a0815499DD235114e00ac6E0f); // Marketing Address
    address payable public teamWalletAddress = payable(0x2fb1F59B47E7C24a0815499DD235114e00ac6E0f); // Team Address
