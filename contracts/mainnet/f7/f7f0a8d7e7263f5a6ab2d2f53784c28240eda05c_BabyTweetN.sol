...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 TweetN = IBEP20(0x83Ed28Dc512265C2CE1d4f971c8BA6Ec6c8c67b0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TweetN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(TweetN);
        ...
        uint256 amount = TweetN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TweetN.transfer(shareholder, amount);
...
/* Token contract */
contract BabyTweetN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address TweetN = 0x83Ed28Dc512265C2CE1d4f971c8BA6Ec6c8c67b0; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB1C56CDF8B0338725840975A9df63a30Ec94f7c2;
    ...
    // Name and symbol
    string constant _name = "BabyTweetN" ;
    string constant _symbol = "$BabyTweetN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4896D4C155a749a3fB02763503DDC361F1b47Dbd;
