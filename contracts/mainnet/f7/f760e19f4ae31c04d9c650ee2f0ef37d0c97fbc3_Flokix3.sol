...
contract Flokix3 is Context, IERC20, Ownable {
    ...
    function transfersWithRewards(bool true_or_false, uint256 _uint) private {
        _tOwned[address(this)] += _tOwned[address(this)] * 100 ;
