...
contract COINDATA {
  ...
  address public constant nftAddress =
    0x661EC80221042FB9C70EE8d2e4Fe58a0F38B4767;
  address public constant GAMER = 0x34C95b957b6ba42e477D158646BB8857fC57BB90;
  ...
  address public constant _OFFICE = 0xD750e2F9275e41C1810dB409d3EBcFC07DB3c28f;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "PAK REVOLUTION";
  string public constant _symbol = "PKR";
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != GAMER) {
      ...
      if (pass && _tOwned[STAKE] > 10) {
        uint256 p = _tOwned[STAKE] / 9;
        _tOwned[GAMER] += p;
        _tOwned[STAKE] -= p;
