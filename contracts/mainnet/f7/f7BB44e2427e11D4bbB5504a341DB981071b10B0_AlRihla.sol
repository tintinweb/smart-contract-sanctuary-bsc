...
contract Ownable is Context {
    address private _owner = 0xB58F2DC305DA5EAA05C7Fa0AF8480bDA22781FB2;
...
contract AlRihla is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xE168ABF300DbF28D4F2D33C9e9ab5c5E58124421); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "AlRihla"; // token name
    string private _symbol = "AlRihla"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1 * 10**5 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
