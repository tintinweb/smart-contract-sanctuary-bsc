...
library Address{
 ...
 contract PEPAGROW is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x276d9882A2EFd21926066D4B0EfaFC18d4D553ea;
    address public donationWallet = 0x276d9882A2EFd21926066D4B0EfaFC18d4D553ea;

    string private constant _name = "PEPA GROW";
    string private constant _symbol = "PEPA GROW";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 0, 20);
