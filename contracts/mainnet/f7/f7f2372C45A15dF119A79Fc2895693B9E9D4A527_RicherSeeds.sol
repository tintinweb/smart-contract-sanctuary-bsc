...
contract Ownable is Context {
    address private _owner = 0x5B499C5E58415Dd25cab3d402896Ee03Ad7C4394;
...
contract RicherSeeds is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x5B499C5E58415Dd25cab3d402896Ee03Ad7C4394); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "RicherSeeds"; // token name
    string private _symbol = "SEEDS"; // token symbol
    ...
    uint256 public _marketingBNBFee = 50; // marketing BNB fee 5%
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 public _liquidityFee = 70; // liquidity fee 7%
