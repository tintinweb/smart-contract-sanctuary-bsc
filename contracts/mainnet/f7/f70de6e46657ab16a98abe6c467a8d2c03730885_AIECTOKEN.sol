...
contract AIECTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "AIEC Token";
    string private _symbol = "AIEC";
    uint8 private _decimals = 18;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10 ** 7 * 10 ** _decimals;//1 Cr
    ...
    address public _ownerAddress = 0xdC5EDB9A8bdCde2B2A244D67C4A7AC5D614cA6bE;
    address public _liquidityAddress = 0xdC5EDB9A8bdCde2B2A244D67C4A7AC5D614cA6bE;

    address public constant _deadAdderess = address(0xdead);

    uint256 private numTokensSellToAddToLiquidity = _tTotal / 500;
    uint256 public _maxTxAmount = 10000000000000000000000000000;
