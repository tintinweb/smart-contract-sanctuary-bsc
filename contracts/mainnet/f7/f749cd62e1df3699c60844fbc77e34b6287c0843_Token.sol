...
contract Token is IBEP20, Ownable {
    string constant _name = "H2O Token";
    ...
    constructor (uint256 supply, uint256 reservedForAirdrop) {
        _totalSupply = supply;
        ...
        _balances[address(this)] = reservedForAirdrop;
        _balances[msg.sender] = supply - reservedForAirdrop;
        emit Transfer(address(0), address(this), reservedForAirdrop);
        emit Transfer(address(0), msg.sender, supply - reservedForAirdrop);
    }
    ...
    function Airdrop (address[] memory airdropees, uint256[] memory amts) public onlyOwner {
