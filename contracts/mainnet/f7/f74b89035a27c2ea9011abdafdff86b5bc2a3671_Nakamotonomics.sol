...
contract Nakamotonomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xBE4c203d317598C81Cf1dBF3631C3813dF6A5824;
    string constant _name = "Nakamotonomics";
    string constant _symbol = "Nakamotonomics";
