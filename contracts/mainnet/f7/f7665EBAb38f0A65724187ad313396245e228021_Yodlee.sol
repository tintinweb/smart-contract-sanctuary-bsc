...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2DBAA853FA047cBFe7697295e5832A521eBF5576;
...
contract Yodlee is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4edA2F0579cb3100F44E421Fb6548d0F85856401;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 210000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Yodlee";
    string private _symbol = "YDLE";
    ...
    uint256 public _maxTxAmount = 210000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 210000000 * 10**8;
