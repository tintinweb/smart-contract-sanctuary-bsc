...
contract MintableToken is StandardToken, Ownable {
     ...
     * @param _trans The transaction id of the RTM transfer.
...
contract BurnableToken is BasicToken {
    ...
    function _burn(
        ...
        require(_addr.length <= 70, "Bad Addr format");
        require(_addr.length >= 33, "Bad Addr format");
...
contract WRTM is
StandardToken,
DetailedERC20("Wrapped RTM", "wRTM", 8),
MintableToken,
BurnableToken
{
    function renounceOwnership() public onlyOwner {
