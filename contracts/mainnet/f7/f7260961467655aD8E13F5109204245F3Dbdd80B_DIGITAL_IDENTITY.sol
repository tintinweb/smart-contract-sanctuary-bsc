    ...
    returns (string memory)
  {
    ...
    */
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(false, "is digital information cannot Transfer");
    ...
    function mint(address _to,uint256 _tokenId) external override onlyManager(){
        require(player[_to] == 0, "1");
    ...
    function setURI(string memory _baseUR) external onlyOwner{
        _setBaseURI( _baseUR); 
    }
...
contract DIGITAL_IDENTITY  is ERC721    {
 
    constructor() public ERC721("DIGITAL IDENTITY", "DIGITAL IDENTITY") {
    }
