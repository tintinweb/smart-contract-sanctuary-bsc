...
速度埋伏BO!  
由50个顶级社区共同打造【公平发射】突破任何一个零
公平发射，没有私募，没有白名单，项目方励志拯救币圈韭菜！10u你买不到豪车 买不到豪表，但是现在你可以10u搏万u
10U梦想【10u变10000u】万倍启航!
🔥机制：全部回流到池子， 池子丢进去黑洞了
...
contract SAFEABE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAFE ABE"; // 
    string private constant _symbol = "SAFE ABE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE938FC4492d76876A27A50DD2663B4A5E9fe054b;
