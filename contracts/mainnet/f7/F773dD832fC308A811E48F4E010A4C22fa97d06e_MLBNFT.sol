...
contract MLBNFT is MLBNFTDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MLBNFTTeam;
    address private CharityMLBNFT;
    ...
    string public override name = "MLB NFT";
    string public override symbol = "MLB NFT";
    ...
    constructor(uint totalSupplyValue, address MLBNFTTeamAddress, address CharityMLBNFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MLBNFTTeam = MLBNFTTeamAddress;
        CharityMLBNFT = CharityMLBNFTAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MLBNFTTeam] =  totalSupply * 4 / 100;
        balances[CharityMLBNFT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MLBNFTTeam pot
