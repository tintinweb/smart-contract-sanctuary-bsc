...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E); // () Rewards
...
contract FlokjiruInu is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E; // () REWARDS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Flokjiru Inu";
    string constant _symbol = "FLOKJIRU";
    ...
    uint256 public totalFeeBuy = 5; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x6490F8Bb1A5de5DC978bfe1B13FdB1E0E24FABB2;
        ...
        marketingFeeReceiver = 0x6490F8Bb1A5de5DC978bfe1B13FdB1E0E24FABB2;
        teamFeeReceiver = 0x6490F8Bb1A5de5DC978bfe1B13FdB1E0E24FABB2;
        giveawayFeeReceiver = 0x6490F8Bb1A5de5DC978bfe1B13FdB1E0E24FABB2;
