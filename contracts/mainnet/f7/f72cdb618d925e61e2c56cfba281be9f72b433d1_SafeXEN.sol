...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4194eD50Ba4798eF227BA5613e44c69D89f059D5;
...
contract SafeXEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x40A04e989626655185e0Aa354111232B50C3dF0A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Safe Xen";
    string private _symbol = "SXen";
