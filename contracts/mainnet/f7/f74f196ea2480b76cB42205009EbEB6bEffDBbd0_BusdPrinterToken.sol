...
Miner Contract 0xd45Ce196Ad15F2577427f11d86DAA3FD615439B4
 */
...
contract BusdPrinterToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BusdPrinterToken";
    string constant _symbol = "BUSDPRINTER";
    ...
    address public Owner=0x4774660AF1f55AB4ac85cDB451a1D0fb1B6b5dA3; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver =0x245D11f1429b0b616F5e7e05dE2E4AFEc587eC5C;
