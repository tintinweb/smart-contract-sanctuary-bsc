...
/**
Milota Chain (Decentralized Locker & Launchpad)

🔐 Project Description:
Milota Chain is described to be a decentralized 
liquidity custody, audit group, token sale 
organizing service, dapp incubator and secure 
launchpad for new projects.

https://t.me/Milotachain
...
contract MILOTACHAIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Milotachain ";
    string private _symbol = "Milota";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x404Ee0A31A0D472cCEF9B867286b0ff747C83Fa9);
