...
contract Test is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress    = payable(0xF882731f7a1c5Cf1E6eaBBc580C9BB5Afc9af25A);
    address payable public _burnAddress      = payable(0xF882731f7a1c5Cf1E6eaBBc580C9BB5Afc9af25A);
    ...
    uint256 private _crctLiquidityFee = 1;
    ...
    uint256 public _ExtraSellFee = 5;
    ...
    function setExtraSellFeePercent(uint256 Fee) external onlyOwner() {
        _ExtraSellFee = Fee;
    }
    ...
    function removeAllFee() private {
        ...
        _marketingFee == 0 && _reflectionFee == 0 && _crctLiquidityFee == 0 && _ExtraSellFee == 0) return;
    ...
    function _transfer(
        ...
        if(takeFee) {
            uint256 fees = amount * (_liquidityFee) / (100);
            if(to == uniswapV2Pair){
