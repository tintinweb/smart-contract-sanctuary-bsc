...
contract SNAKEPOWER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snake Power";
    string private _symbol = "SNAKEPOWER";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x0802eD878b00808e396bAe3F029F4D39639417e3); 
