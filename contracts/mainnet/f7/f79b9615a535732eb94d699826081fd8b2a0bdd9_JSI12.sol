  ...
  struct UserData {
    ...
    function register(uint256 userid,uint256 upline) public {
        ...
        if(user.userid==0){
            ...
            balance[uplinedata.upline1] = balance[uplinedata.upline1].add(amount.div(120).mul(50));
            balance[uplinedata.upline2] = balance[uplinedata.upline2].add(amount.div(120).mul(20));
            balance[uplinedata.upline3] = balance[uplinedata.upline3].add(amount.div(120).mul(10));
            balance[uplinedata.upline4] = balance[uplinedata.upline4].add(amount.div(120).mul(5));
            balance[uplinedata.upline5] = balance[uplinedata.upline5].add(amount.div(120).mul(5));
            balance[uplinedata.upline6] = balance[uplinedata.upline6].add(amount.div(120).mul(5));
            balance[uplinedata.upline7] = balance[uplinedata.upline7].add(amount.div(120).mul(5));
