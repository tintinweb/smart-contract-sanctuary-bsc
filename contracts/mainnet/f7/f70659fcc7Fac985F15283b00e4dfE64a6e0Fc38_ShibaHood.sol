...
contract ShibaHood is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCCA7b51a3B65BA417597660543c0d0f127EcA9C6); 
    address payable public Wallet_Dev = payable(0xCCA7b51a3B65BA417597660543c0d0f127EcA9C6);
    ...
    string private constant _symbol = unicode"SHOOD"; 
    ...
    constructor () {
        ...
        _owner = 0xCCA7b51a3B65BA417597660543c0d0f127EcA9C6;
