...
contract HALLOWCAT is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x5c2332CA4C5036BDe69AE3985a641EB9C2bA4a8C);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**10 * 10**_decimals;
    string private constant _name = "Hallow Cat"; 
    string private constant _symbol = unicode"HALLOWCAT";
