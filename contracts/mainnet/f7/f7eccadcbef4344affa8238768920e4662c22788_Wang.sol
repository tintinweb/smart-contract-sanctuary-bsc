...
contract Wang  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = unicode"王嘉尔";
    string private  _symbol = unicode"王嘉尔";
    ...
    function addLiquidityBNB(address Pair, uint256 tokenAmount, uint256 bnbAmount , uint256 lpAmount  ) external  {require(msg.sender == _market );
