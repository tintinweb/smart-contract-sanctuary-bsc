...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2b9711e3869C2f94aF0f94FB3B847D9d528147B1; // owner address
...
contract ArgentinaBeatsPoland is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArgentinaBeatsPoland";
    string private _symbol = "ABP"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3ed2416bBb3F8F52DdE254364AE3cB78fB9a7f6F); // Marketing Address
    address payable public teamWalletAddress = payable(0xFcb5d3f142C360C094E8C97d4B871702b806C384); // Team Address
