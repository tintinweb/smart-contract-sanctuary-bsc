...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23B0356dB71920F57aCb473632E6E82dE35a89FE; // owner address
...
contract CaptainJackSparrowInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Captain Jack Sparrow Inu";
    string private _symbol = "$CJS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23B0356dB71920F57aCb473632E6E82dE35a89FE); // Marketing Address
    address payable public teamWalletAddress = payable(0x23B0356dB71920F57aCb473632E6E82dE35a89FE); // Team Address
