...
BLOOD BEAR
  ...
  60K SUPPLY       1 hour sell lock so THIS WILL MOON PROPERLY
  2% WALLET
  10% TAX
*
*/
...
contract BLOODBEAR is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BLOODBEAR';
    string private constant _symbol = '$BB';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 60000 * 10**_decimals;//
    ...
    uint16 public constant MaxSellLockTime= 3600 seconds;
    ...
    //DevWallets
    address public TeamWallet=payable(0xc26fE4105Fad617e498D315b4fbB5Bcc0B3F4A24);
    address public walletTwo=payable(0x659896FD859181F1bF1dA3ce12a36D59115C7cF4);
    //TestNet
	...
	uint256 private antiWhale = 300 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 500 * 10**_decimals;
