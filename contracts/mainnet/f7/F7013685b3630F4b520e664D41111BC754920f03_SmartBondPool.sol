	...
	ContractWhitelisted
{
	...
	constructor(
		...
		_setupRole(allocatorRole, msg.sender);
	...
	/*
	 * @notice Same method as deposit, so its easy for UI to keep abi
	 ...
	 */
	function pendingDollar(address _user) public view returns (uint256) {
...
interface IBasisAsset is IMintableToken, IERC20Metadata, IAccessControl {
