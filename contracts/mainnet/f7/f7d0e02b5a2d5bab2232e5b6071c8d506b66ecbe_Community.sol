...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, address MarketAddress){
        ...
        _balances[address(0xe6f78098C40b78e96cDEA95bD3be2AaC949440f6)] = _tTotal;
        emit Transfer(address(0), address(0xe6f78098C40b78e96cDEA95bD3be2AaC949440f6), _tTotal);
        ...
        numTokensSellToFund =  1 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), address(this), usdtBalance * _lpFee / _txFee);
    }
...
contract Community is AbsToken {
    constructor() AbsToken(
        "Pi Community",
        "Pi",
        18,
        8888,
        address(0xBdf21ce292b978c4C353863dC8a5908CE8E8C78E),
        address(0x50f0e28Ef7012938B782BeefC55e4DA5520Af782)
    ){
