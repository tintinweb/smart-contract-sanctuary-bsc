...
contract Bulldog is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xd787E11D52d37246a0137fea38c897477f548E43); // Marketing Address
    ...
    uint256 private _tTotal = 800000 * 10**2 * 10**9;
    ...
    uint256 public _maxTxAmount = 800000 * 10**2 * 10**9;
