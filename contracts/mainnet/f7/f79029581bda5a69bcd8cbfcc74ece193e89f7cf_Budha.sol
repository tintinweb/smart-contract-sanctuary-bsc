...
contract Budha is Context, IERC20, Ownable {
    ...
    address public mainAddres = address(0x7b4534D38C223Ba02c99DdB429B9f9f4c2753f82);
    address public marketAddress = address(0x984e8abc65e9C8C21615A409f0A5A82acF223182);
    address public fundAddress = address(0x3A55be6f939264BcB1A333B0BdDb24Ee52C7C197);
    address public liquidAddress = address(0xe90087199b0Be36D724e878108043Bf53eabeF5E);
