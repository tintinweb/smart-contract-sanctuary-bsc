...
// This is the original Fan Token token of Sandwich Network (https://sandwich.network)
...
contract SandwichNetworkFANTOKEN {
    ...
    constructor() {
        owner = msg.sender;
        name = 'Sandwich Network Fan Token';
        symbol = 'Sandwich Network';
        decimals = 18;
