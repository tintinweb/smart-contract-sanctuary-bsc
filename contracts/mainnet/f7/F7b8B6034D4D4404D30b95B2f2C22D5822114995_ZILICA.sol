...
contract ZILICA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZILICA";
    string private _symbol = "$ZIL";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xFd8f878Ee969e94D115828d4207DBc307EA3FD31);
    address payable public teamWalletAddress = payable(0xFd8f878Ee969e94D115828d4207DBc307EA3FD31);
