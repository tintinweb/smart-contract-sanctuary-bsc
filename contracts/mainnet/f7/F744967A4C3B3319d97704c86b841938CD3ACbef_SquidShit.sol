...
contract SquidShit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SquidShit 3.0";

    string private _symbol = "SQUIDS";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xc48C1F29F75d80DA464852dee3b7BD6F471345bf;
