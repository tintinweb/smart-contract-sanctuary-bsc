...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC7979426755828D10c7f394ECc70B0ef0f82D118;
...
contract BabyBitfinex is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3dFF953478Ff5810d8d9a866421d5e882B7846B1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyBitfinex";
    string private _symbol = "BabyBitfinex";
