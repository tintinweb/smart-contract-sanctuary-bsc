...
contract Gas is IBEP20, Auth {
    ...
    uint256 public swapThreshold = 100000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(address(0xaC4F4Cd78854715edf969ef72f2544Ae23AFA333));
        devFeeReceiver = payable(address(0xaC4F4Cd78854715edf969ef72f2544Ae23AFA333));
