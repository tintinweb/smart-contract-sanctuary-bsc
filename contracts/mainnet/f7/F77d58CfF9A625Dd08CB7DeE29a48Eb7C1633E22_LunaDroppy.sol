...
/**
 ...
 Luna Droppy - Earn $LUNA while holding $LDPY ! it will take 3% of every transactions and send it into  %RewardsPool that converts into luna and redistribute to $LDPY Holders! 
...
//Telegram : https://t.me/LunaDroppy Safe Contract Detected 🟢
    ...
    contract LunaDroppy  is IBEP20, Ownable
    {
        ...
        string private constant _name = "LunaDroppy";
        string private constant _symbol = "LDPY";
        ...
        address public constant MarketingWallet=0x63dB0e95a34EF579aBF8Cb6b44643E4654192470; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function BUSDAddressReceivedRewards(address[] calldata addresses) external onlyOwner {
