...
🟠 BSC to 🟣 DOGECHAIN How does it work? (Now available)
https://dogebridge.online/

1️⃣ Connect your wallet at the top of the page.
2️⃣ Approve the smart bridge contract (Approve button)
3️⃣Select the amount of DOGE and click "send to DOGEChain"
...
contract DogeChain is Ownable {
    ...
    string private _name = "Doge Chain";
