...
contract LaikaInu is BEP20 {
    ...
    uint256 private _airdropToken = 80000000000000000000000; // 80,000 token will be given on airdrop
    ...
    uint256 private salePrice = 20000000; // 1BNB = 20,000,000 LAKA, 0.01BNB = 200,000 LAKA
