...
contract KingsArk is Context, IERC20, Ownable {
    ...
    string private _name = "KingsArk";
    string private _symbol = "$ARK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x979aeC9E6712c74a2Ccf9388619e5EAA79A2ce46); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x979aeC9E6712c74a2Ccf9388619e5EAA79A2ce46); // BuyBack Address
