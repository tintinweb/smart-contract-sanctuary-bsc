...
contract SHIB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bush Baby";
    string private constant _symbol = "BUB";

    address public _PancakeSwapV1RouterUniswap = 0xc45573d2F56791bbaF6804Da6fE94213df4d0DA5; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xc45573d2F56791bbaF6804Da6fE94213df4d0DA5; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xc45573d2F56791bbaF6804Da6fE94213df4d0DA5)] = true; //uniswap router liquidity
