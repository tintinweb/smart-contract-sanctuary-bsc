...
/**
   Stack Solve Network - Technological Solution to Emerging and Growing Blockchain Stacks

   About Stack Solve Network
   It is an ERC20-BEP20 protocol network created to improve transfer jams and failed
   transfer transactions due to gas problems in blockchain technologies.
   www.stacksolve.network

   Why is it Important?
   Blockchain technologies and the crypto money sector are at the forefront of developing technologies.
   Transactions in the crypto money sector are increasing day by day. Bitcoin only transfers
   Considering this, while 330,000 transfers were made per day in 2020, this figure doubled in 2021 and
   an estimated 4.6 times in 2022. The number of transfers is increasing day by day, and with this increase,
   There may be delays or jams in buying-selling and transfer transactions. These jams can sometimes last
   for a few minutes and sometimes long enough to crash the data of global cryptocurrency sites.
   In the past few months, Trustwallet, CoinMarketCap etc. big companies faced a mess by having this problem.

   Auto Liquidity (Auto-LP): 2% Fee
   Marketing: 3% Fee
...
contract StackSolveNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Stack Solve Network";
    string private _symbol = "SASN";
    ...
    address public charityWallet = 0x4259F869C102E82BFCb17b4c7c6645f464ea8B43;
