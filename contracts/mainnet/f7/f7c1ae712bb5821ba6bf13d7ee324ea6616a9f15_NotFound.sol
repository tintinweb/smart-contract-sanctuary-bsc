...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3632bfDBFD7d5A53c3765926A2421b94E6A28f0E; // owner address
...
contract NotFound is Context, IERC20, Ownable {
    ...
    string private _name = "404";
    string private _symbol = "Error";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE45dc2bA19168007439B3a95Ae6966Ad4Ce3dA78); // Marketing Address
    address payable public teamWalletAddress = payable(0x3632bfDBFD7d5A53c3765926A2421b94E6A28f0E); // Team Address
