...
contract kitkat20 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x82D2b127C9530DBEa99B07D542894bcF4b1B3244); 
    ...
    string private constant _name = "KITKAT 2.0"; 
    string private constant _symbol = unicode"KIT2.0"; 
    ...
    */
    ...
    function whitelist_Add_Wallet(address addresses) external onlyOwner {
    ...
    function whitelist_Remove_Wallet(address addresses) external onlyOwner {
