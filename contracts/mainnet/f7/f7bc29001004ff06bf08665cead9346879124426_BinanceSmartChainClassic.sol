...
contract BinanceSmartChainClassic is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BinanceSmartChainClassic";
    string private _symbol = "BSCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe1Bd452EC19B736aF05228bd0FeD7Fa0fA7496b4);
    address payable public teamWalletAddress = payable(0xe1Bd452EC19B736aF05228bd0FeD7Fa0fA7496b4);
