...
/* Token contract */
contract QueenElizbethBurialToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Queen Elizabeth Burial Token";
    string constant _symbol = "QUEEN ELIZ";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000 * (10 ** _decimals); // 10TH
