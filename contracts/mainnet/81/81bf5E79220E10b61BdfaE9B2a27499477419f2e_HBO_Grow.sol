...
contract HBO_Grow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x29E0A6634Af267b45f5BC3b105EfCCf0fF6b9E6C); // Marketing Address
    address payable public devWalletAddress = payable(0x29E0A6634Af267b45f5BC3b105EfCCf0fF6b9E6C); // Dev Address
    ...
    string private _name = "HBO Grow";
    string private _symbol = "HBO Grow";
