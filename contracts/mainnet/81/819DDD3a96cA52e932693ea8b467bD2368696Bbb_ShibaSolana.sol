...
contract ShibaSolana is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Solana"; //
    string private constant _symbol = "Shilana Coin"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x6aDB3000e2A99C5e1Fd2b83C8cBE8147Aec8CCFA;
