...
contract kill is ERC20, Ownable {
    ...
    uint256 public  marketingTaxOnBuy = 7;
    uint256 public  marketingTaxOnSell = 7;
    ...
    constructor (address newOwner, address router_)ERC20("kill",  "kill"){  

        _mint(newOwner, 1_000_000_000_000_000 * (10 ** 18));

        marketingWallet = 0xA70f11df9589648362b4fea647e0D4C6F587F600;// Address to collect marketing taxes in BNB
