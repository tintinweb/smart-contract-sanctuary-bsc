...
// *Telegram : https://t.me/rogueInuBSC
...
contract rogueinu is Context, IERC20, Ownable {
    ...
    string private constant _name = " RogueInu"; // 
    string private constant _symbol = "$ROGINU"; //    
