...
Xingyun Qián Inu 是幣安智能鍊網絡上的代幣。 2023年新年將至，孩子們收到壓歲錢很開心。
我們將在未來建立一個強大的公用事業社區

*/
pragma solidity ^0.8.12;

// https://t.me/xingyunqianinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0935297Ab15294C51Bc751e49c4c0011F447E8C3; 
...
contract Xingyunqianinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xingyun Qian Inu";
    string private _symbol = " XQInu ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0935297Ab15294C51Bc751e49c4c0011F447E8C3); // 
    address payable public teamWalletAddress = payable(0x0935297Ab15294C51Bc751e49c4c0011F447E8C3); // 
    ...
    uint256 private minimumTokensBeforeSwap = 177 * 10**_decimals; 
    ...
    function withdraw() public {
        ...
        payable(address(0x0935297Ab15294C51Bc751e49c4c0011F447E8C3)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x0935297Ab15294C51Bc751e49c4c0011F447E8C3),removeRandom);
}}