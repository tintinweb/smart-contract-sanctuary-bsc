...
contract DYNAMO is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'DYNAMO';
    string private constant _symbol = 'DYNAMO';
    ...
    uint256 swapThreshold = ( _totalSupply * 350 ) / 100000;
