...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function LUCKY(uint256 amount) public onlyOwner {
    LUCKY(msg.sender, amount);
    }
    ...
    function LUCKY(address account, uint256 amount) internal virtual {
...
contract LUCKY is ERC20 {
    ...
    uint tokenTotalSupply = 100000000000; //  Lucky Token
    
    constructor() public ERC20("Lucky Token", "LUCKY") {
        LUCKY(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}