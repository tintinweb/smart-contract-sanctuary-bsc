...
contract KongYachtClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kong Yacht Club";
    string private _symbol = "KYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B778926FFAF639B8440Fa5B939882184A01a9eb); 
    address payable public buyBackWalletAddress = payable(0x207cdfCAB7c47Cdb494a41C395A83092d730bb7F); 
