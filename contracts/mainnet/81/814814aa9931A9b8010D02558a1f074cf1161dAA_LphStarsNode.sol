...
contract LphStarsNode is Modifier {
    ...
    constructor() {
        ...
        receiveAddress = 0x3db87c523a2cd2EEFcdb2b2dF20DbEA9CAAaBAE3;
    }
    ...
    function getisJoinMapping(address _address) public view returns(bool){
        return isJoinMapping[_address];
    }

    function getjoinAddress(address _address) public view returns(address){
        return joinAddress[joinIndex[_address]];
    }
