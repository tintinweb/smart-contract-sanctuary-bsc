...
Telegram: https://t.me/SpaceCasino_BSC

🎲 SPACECASINO - the first class BSC casino that rewards $SCSN token holders with 5% of ALL CASINO EARNINGS.
...
contract SpaceCasino is Ownable {
    constructor(
        string memory _NAME,
