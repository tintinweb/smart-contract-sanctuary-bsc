...
contract baby$GRUSH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "baby$GRUSH";
    string private _symbol = "baby$GRUSH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20F380b11E85f19fd2AbD3fC394c4eA6F06C32d7);
    address payable public teamWalletAddress = payable(0x20F380b11E85f19fd2AbD3fC394c4eA6F06C32d7);
