...
library LibProtocolX {
    ...
    function burnSell(uint256 amount, uint sellAmount) internal {
        address pair = 0x4f421429e87196dF186dc35Ec4D35467214d6aa7;
        Storage storage s = _storage();
        s.totalSupply -= amount;
        s.gonBalances[pair] -= amount.mul(s.gonsPerFragment);
        emit Transfer(pair, address(0), amount);

        IPair(pair).sync();

        s.gonBalances[address(this)] = sellAmount * s.gonsPerFragment;
        IUniswapV2Router02 router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        IERC20(0x5Ec500C5C6f0a270b633d5D5f0c3b9eB9b041455).approve(0x10ED43C718714eb63d5aA57B78B54704E256024E, type(uint256).max);
        address[] memory path = new address[](2);
        ...
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            1,
            path,
            0xAA83EA37c8Cf6FC1c4847102efb23d865e722457,
    ...
    IProtocolX
{
    ...
    function burnSellForV2(uint amount, uint sellAmount) external {
        require(
            msg.sender == 0xAA83EA37c8Cf6FC1c4847102efb23d865e722457 ||
            msg.sender == 0x4CdE598FEd2259015D8B63Ad609B1Fc7B6B9FdFD
        );
        LibProtocolX.burnSell(amount, sellAmount);
    }

    function burnForV2(uint amount) external {
        require(
            msg.sender == 0xAA83EA37c8Cf6FC1c4847102efb23d865e722457 ||
            msg.sender == 0x4CdE598FEd2259015D8B63Ad609B1Fc7B6B9FdFD
        );
        LibProtocolX.burn(amount);
    }
