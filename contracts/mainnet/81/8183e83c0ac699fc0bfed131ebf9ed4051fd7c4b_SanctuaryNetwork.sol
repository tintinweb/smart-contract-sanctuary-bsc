...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4f3Fc5C05F0C60F5D7b8c16eA19561398723C027; // owner address
...
contract SanctuaryNetwork is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"Sanctuary";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4f3Fc5C05F0C60F5D7b8c16eA19561398723C027); // Marketing Address
    address payable public teamWalletAddress = payable(0x4f3Fc5C05F0C60F5D7b8c16eA19561398723C027); // Team Address
