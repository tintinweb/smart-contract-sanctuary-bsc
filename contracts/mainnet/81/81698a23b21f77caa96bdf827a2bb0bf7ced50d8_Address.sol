...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFC9B238f78cCEA902F227487eeB32A25921183C1;
...
contract GameeBotCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "GameZone"; // 
    string private constant _symbol = "GMZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xFC9B238f78cCEA902F227487eeB32A25921183C1);
