 ...
 * paying for may not be the actual sender (as far as an application
 * is concerned).
 *
...
contract  NewCommunityHoldersClub                                is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("NewCommunityHoldersClub", "NCHC") {
