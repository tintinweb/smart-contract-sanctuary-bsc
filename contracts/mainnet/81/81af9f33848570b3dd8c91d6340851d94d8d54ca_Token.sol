...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 10_0000 ether;

    uint256 public _maxSwap = 0;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public swapTokensAtAmount = 30 ether;
    ...
    uint256 public txBuyFee = 800;
    uint256 public txSellFee = 800;
    ...
    uint256 public _keepHold = 15 ether;

    mapping(address => bool) public _excludedFromHolder;
    ...
    constructor() ERC20("SZ", "SZ") {
        ...
        _marketWallet = 0xaa36e72389E36659eB0318f4C19D06A295fa9f10;
        ...
        _excludedFromHolder[uniswapV2Pair] = true;
    ...
    function excludedFromHolder(address account, bool excluded) public onlyOwner {
        _excludedFromHolder[account] = excluded;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (!_excludedFromHolder[to]) {
                require(balanceOf(to).add(amount) <= _keepHold, "max hold");
            }
