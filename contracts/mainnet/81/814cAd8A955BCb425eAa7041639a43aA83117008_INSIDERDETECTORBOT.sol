...
TG: https://t.me/InsiderDetectorBot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcb80a1043dAfdEAF0f267dBCAde31F7cfa936508; // owner address
...
contract INSIDERDETECTORBOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"INSIDER DETECTOR BOT";
    string private _symbol = unicode"IDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcb80a1043dAfdEAF0f267dBCAde31F7cfa936508); // Marketing Address
    address payable public teamWalletAddress = payable(0xcb80a1043dAfdEAF0f267dBCAde31F7cfa936508); // Team Address
