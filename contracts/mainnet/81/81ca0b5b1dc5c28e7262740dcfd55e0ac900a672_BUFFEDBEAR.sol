...
contract BUFFEDBEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buffed Bear";
    string private _symbol = "BBEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x79751B4768Ba022e8d9886713A58D3BfDa19b6C3); // Marketing Address
    address payable private developmentWalletAddress = payable(0xe097d90C9cDaEd34781d80De420082Dc6Ce30098); // Development Address
    ...
    uint256 private _maxTxAmount = 1 * 10**12 * 10**9;
    uint256 public _walletMax = 20 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2 * 10**6; 
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**12 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
