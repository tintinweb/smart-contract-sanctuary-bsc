...
contract CakeEater is ERC20, Auth {
  using SafeMath for uint256;

  address public constant DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "CakeEater";
  string constant _symbol = "$CE";
  ...
  FeeRatios public _fees =
    FeeRatios({liquidity: 3, marketing: 5, dev: 2, total: 10, divisor: 100});
  ...
  FeeWallets public _feeWallets =
    FeeWallets({
      marketing: payable(0x736D28E03CE9ac7DB62422Be597d73AdFbfa442a),
      dev: payable(0x7dfa90d7749981a10417c604f2A4573f627e14b4)
    });
