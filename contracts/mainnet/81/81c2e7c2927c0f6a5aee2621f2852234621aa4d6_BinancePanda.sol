...
contract Ownable is Context {
    ...
    address private _marketingAddress = 0xDEe5b66798477dca69056978e51Fc49fB0AE2134;
...
contract BinancePanda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BinancePanda";
    string private _symbol = "BPanda";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDEe5b66798477dca69056978e51Fc49fB0AE2134); // Marketing Address
    address payable public teamWalletAddress = payable(0xc575F0587072A8318E53cf95E99399789D83D7a4); // Team Address
