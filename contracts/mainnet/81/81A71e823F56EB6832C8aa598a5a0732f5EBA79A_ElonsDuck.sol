...
contract ElonsDuck is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Elons Duck";
    string constant _symbol = "QUACK";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 20000000 * (10 ** _decimals);     // 3%
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);  // 3%
