...
Join us on TG : https://t.me/BabyProDevInu
*/
...
contract BabyProDevInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyProDevInu";
    string private _symbol = unicode"BPRO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x2Ef48746Cccc191AFAde218AE420a8069d6AebfD);
    address payable public developmentWalletAddress = payable(0x113e4F1dcD694AFFE12E90CBf751F6bFE8347faB);
