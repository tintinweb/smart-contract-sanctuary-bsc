...
contract Doge is Context, IERC20, Ownable {
    ...
    string private _name = "OSK SWAP";
    string private _symbol = "OSK SWAP";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1a649420C7E38952D0c8ebB9DcA844c36037506A));
        marketingWalletAddress = payable(address(0x1a649420C7E38952D0c8ebB9DcA844c36037506A));
