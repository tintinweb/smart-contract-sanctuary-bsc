...
contract CLOUD2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CloudTwo";
    string private _symbol = "Cloud2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x837Ad6752387aAA7D96081A9A502Dee95a87586e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x837Ad6752387aAA7D96081A9A502Dee95a87586e); // BuyBack Address
    ...
    uint256 private _totalSupply = 9000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 9000 * 10**6 * 10**9;
    uint256 public _walletMax = 9000 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (9000 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
