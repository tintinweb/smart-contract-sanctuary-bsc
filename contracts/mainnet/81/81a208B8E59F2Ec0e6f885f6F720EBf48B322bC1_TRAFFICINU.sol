...
contract TRAFFICINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA5B61682A25488Eb7898FaF9F53C07f5CA868F81); // Marketing Address
    address payable public airdropAddress = payable(0xF5C66CCF17D4873F1B42E62D45FcF0ddd4411F2d); // Airdrop Address
    ...
    string private _name = "Traffic Inu";
    string private _symbol = "TFCINU";
    ...
    uint256 public airdropDivisor = 5;
