...
//https://t.me/NewCommunityBLST_BSC
...
contract NewCommunityBLSTBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Bloodstone";
    string private constant _symbol = "$cBLST";
    ...
    constructor() {
        ...
        treasuryAddress = payable(0x466553A22B08539aFe7Ec6cab2DC482508Db5591);
        devAddress = payable(0x466553A22B08539aFe7Ec6cab2DC482508Db5591);
        wAddress = payable(0x466553A22B08539aFe7Ec6cab2DC482508Db5591);
