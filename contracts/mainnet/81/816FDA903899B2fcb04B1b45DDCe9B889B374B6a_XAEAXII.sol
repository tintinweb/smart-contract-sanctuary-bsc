...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC4c82929a665627E0F8941Ed76Ddc86e54f12a6D;
...
contract XAEAXII is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6c275ed924B3e900eDe5074327024C24979B177B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "[X AE A-XII]";
    string private _symbol = "[XAEA-XII]";
