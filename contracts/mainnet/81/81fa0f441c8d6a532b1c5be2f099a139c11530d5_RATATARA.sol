...
contract RATATARA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RATATARA";
    string private _symbol = "RATATARA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Da6BDbcCDF5d6CdB0f4b2cF42f9c067f28cced1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5Da6BDbcCDF5d6CdB0f4b2cF42f9c067f28cced1); // BuyBack Address
