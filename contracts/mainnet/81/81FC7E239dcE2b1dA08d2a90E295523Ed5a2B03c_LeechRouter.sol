    ...
    ReentrancyGuardUpgradeable
{
    ...
    ///@notice Switcher for the sign based input validation
     ...
     *@param _uniV2Address Uniswap based exchange address.
     */
    function initialize(
        address _baseToken,
    ...
    function deposit(
        ...
        if (whitelistEnabled) {
            ...
            bytes32 msgHash = keccak256(
                abi.encode(msg.sender, maxBlockNumber, amount, chainId)
            );
            require(
    ...
    /**
     *@notice User create withdrawal access.
    ...
    function withdraw(
        ...
        if (whitelistEnabled) {
            ...
            //Signature verification
            bytes32 msgHash = keccak256(
                abi.encode(msg.sender, maxBlockNumber, amount)
            );
