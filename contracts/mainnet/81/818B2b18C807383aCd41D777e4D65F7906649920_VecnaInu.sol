...
What we try to do with the utility part is because we are a community project, we want to create utilities together with the community that's why we will introduce VecnaLabs. VecnaLabs is a platform were the community members, developers, and marketeers come together and build new utility and release it

TWT: https://twitter.com/vecna_inu
WEB: https://www.vecnainu.com
TG: https://t.me/VecnaInuPortal
*/
...
contract VecnaInu is IERC20, Ownable {
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x49c471B18932c2Ef0DF4F1A7Ab0A07135FBC179b;
    ...
    function _setMaxTx(uint256 maxTx) external onlyOwner {
