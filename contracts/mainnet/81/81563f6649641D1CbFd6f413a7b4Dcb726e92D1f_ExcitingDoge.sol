...
contract ExcitingDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ExcitingDoge";
    string private _symbol = "Exciting";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x348a32063423cD9B34bc6286e230F8BE9678f66C);
    address payable public teamWalletAddress = payable(0x2bbB05da84b04a28F09040c9a511B98B09D68578);
