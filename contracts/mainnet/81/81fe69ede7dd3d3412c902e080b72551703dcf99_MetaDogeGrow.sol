...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0408F25Ae5Fc4CBe9C57961C86e326BF9452572; // owner address
...
contract MetaDogeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Meta Doge Grow";
    string private constant _symbol = unicode"MDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc0408F25Ae5Fc4CBe9C57961C86e326BF9452572); // Marketing Address
    address payable public teamWalletAddress = payable(0xc0408F25Ae5Fc4CBe9C57961C86e326BF9452572); // Team Address
    ...
    uint256 public _maxTxAmount = 1e12 * 10**_decimals; 
    uint256 public _walletMax = 1e12 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1e12 * 10**_decimals; 
