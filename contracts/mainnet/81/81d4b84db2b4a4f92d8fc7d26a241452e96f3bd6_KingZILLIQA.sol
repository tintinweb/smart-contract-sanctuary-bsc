...
🚀 King ZILLIQA 🚀
This is a Very Easy Community Token 🚀.
No Scam Codes inside the contract, you can verify it.
When Liquidity will be Locked, Liquidity cannot be removed untill the unlock time comes.
Therefore NO RUG & NO SCAM.
DYOR / NFA.
Buy / Shill / HODL / son't sell early, sell only when you see you have made a Huge Profit 🚀.
LOW MC / DON'T MISS IT / JOIN NOW !!!

Telegram: https://t.me/KingZilliqa
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42934D61cfE35ca44cB11eC549245913d6e2d46a;
...
contract KingZILLIQA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeF602e7c955A54e92926507854334957A52e17A0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "King ZILLIQA";
    string private _symbol = "KINGZIL";
    ...
    function _transfer(
        ...
        if (to != uniswapV2Pair) {
                require(
                    balanceOf(to).add(amount) <= _WalletMax,
                    "Transfer exceeds max"
                );
            }
