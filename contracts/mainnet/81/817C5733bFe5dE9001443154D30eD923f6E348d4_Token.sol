...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x55d398326f99059fF775485246999027B3197955); //USDT 奖
    ...
    uint256 public minPeriod = 20 minutes ; //奖
...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "MAO ";
    string constant _symbol = unicode" Tse-tung ";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x55d398326f99059fF775485246999027B3197955; //USDT 奖

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 18000000000000 * (10 ** _decimals);
    uint256 public _walletMax = 18000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x88Cac7e81195805F635Aa8F896608690A47552D5;
        marketingWallet = 0x88Cac7e81195805F635Aa8F896608690A47552D5;
        devWallet = 0x88Cac7e81195805F635Aa8F896608690A47552D5;
    ...
    function changeRestrictWhales(bool newValue) private authorized {
