...
contract KolAutomizerVault is Initializable, UUPSUpgradeable, ERC20Upgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("Kol Automizer Receipient", "KOL_LIB-BNB");
        IStrategy _strategy = IStrategy(0xcd50B8C5002Bef5c07Bf86002eC8e80F1F861092);
        strategy = _strategy;
    ...
    */
    ...
    function changeStrategy(IStrategy _newStrategy) external onlyOwner {
        strategy.withdraw(totalSupply());
