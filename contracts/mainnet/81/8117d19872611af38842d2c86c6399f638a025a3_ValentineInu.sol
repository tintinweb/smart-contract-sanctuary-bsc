...
contract ValentineInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Valentine Inu";
    string private constant _symbol = "VI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x947948d7A480C2f4eD181706f7a9Aa799514eFE2);
    address payable private _marketingAddress = payable(0x947948d7A480C2f4eD181706f7a9Aa799514eFE2);
