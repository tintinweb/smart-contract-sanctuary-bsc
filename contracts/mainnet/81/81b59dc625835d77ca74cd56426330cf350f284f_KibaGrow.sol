...
contract KibaGrow is IBEP20, Auth {
    ...
    string constant _name = "KibaGrow";
    string constant _symbol = "Kibagrow";
    ...
    uint256 public swapThreshold = (_totalSupply * 6) / 1000; // 0.2% of supply
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingAmountReceiver = 0x49A88fd729f9d93B061212E8D967C140e11382Eb;
        projectMaintenanceReceiver = 0x49A88fd729f9d93B061212E8D967C140e11382Eb;
