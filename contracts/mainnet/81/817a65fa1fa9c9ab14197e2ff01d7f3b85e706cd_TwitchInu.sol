...
Twitch Inu is token following the hype social media meta, along with a bullish concept
that let holders choose which streamers should be rewarded.
Streamers will be tipped in real time, and we'll get their reaction
and make them promote our token on their livestream!

Telegram: https://t.me/TwitchInuPortal
Website: https://twitchinu.site/
...
contract TwitchInu is Ownable, IBEP20 {
    ...
    string constant _name = "Twitch Inu";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x19314164e959EC005730CCbf437A3401B7565257;
        marketingWallet = 0x09BA00d1C273d8C74e5074CB465bDF1A5C91c361;

        totalFee = 10;
        totalFeeIfSelling = 15;
