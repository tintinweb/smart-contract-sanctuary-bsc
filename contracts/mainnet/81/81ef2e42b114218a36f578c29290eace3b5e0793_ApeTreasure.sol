...
contract ApeTreasure is ERC20, Ownable {
    ...
    uint256 public buytreasureFee;
    
    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellLiquidityFee;
    uint256 public selltreasureFee;
    
    uint256 public tokensForMarketing;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTreasure;
   ...
   mapping(address => bool) public _isBlacklisted;
    ...
    event treasureWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("APE TREASURE", "APE TREASURE") {
        ...
        uint256 _buytreasureFee = 6;
        
        uint256 _sellMarketingFee = 6;
        uint256 _sellLiquidityFee = 5;
        uint256 _selltreasureFee = 7;
        
        uint256 totalSupply = 1000000000000 * (10**18);
        
        maxTransactionAmount =  1000000000000 * (10**18);
        swapTokensAtAmount =  10000000000 * (10**18);
        maxWallet =  1000000000000 * (10**18);

        buyMarketingFee = _buyMarketingFee;
        buyLiquidityFee = _buyLiquidityFee;
        buytreasureFee = _buytreasureFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buytreasureFee;
        
        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        selltreasureFee = _selltreasureFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + selltreasureFee;
        

    	marketingWallet = 0x9A278a8c26174eb9e4D4f305C4861f8CE35A45D3;
    	treasureWallet = 0xDEAc88fCeD4f208567Ff6968D1f2Cd3FFe69b74d; 
        ...
        excludeFromMaxTransaction(treasureWallet, true);
    ...
    function Bots(address account, bool value) external onlyOwner{
    ...
    function setBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyTreasureFee) external onlyOwner {
    ...
    function setSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _sellTreasureFee) external onlyOwner {
    ...
    function settreasureWallet(address newWallet) external onlyOwner {
        emit treasureWalletUpdated(newWallet, treasureWallet);
        treasureWallet = newWallet;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForTreasure += fees * selltreasureFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForTreasure += fees * buytreasureFee / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForTreasure;
        ...
        uint256 ethForTreasure = ethBalance.mul(tokensForTreasure).div(totalTokensToSwap);
        
        
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForTreasure;
