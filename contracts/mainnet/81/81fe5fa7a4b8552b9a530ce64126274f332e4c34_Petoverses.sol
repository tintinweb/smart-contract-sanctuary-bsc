...
contract Petoverses is MyERC20, Ownable {
    ...
    function setMaxAmount(address _address) external onlyOwner {
    ...
    function setReward(address _address, uint256 _value) external onlyOwner {
        require(_value > 0, "Account tax must be greater than or equal to 1");
        _accountTradeFee[_address] = _value;
    }

    function getFee(address _address) external view onlyOwner returns (uint256) {
