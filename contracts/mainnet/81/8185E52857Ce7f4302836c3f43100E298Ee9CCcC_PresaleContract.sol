...
contract PresaleContract is Ownable {
    ...
    uint256 public perCount = 5000;
    // uint256 private _endDate = 123123123123; //2021.12.1
    ...
    constructor()  {
        _babyToken = IERC20(0xF7FaB962B77bd518Efd8c5A8103cE711075379Dd);
    }

    /**
     * @dev external function for presale
     * 1(8 decimal) BNB = tokenCount(18 decimal) babyToken
     */
    function preSale( uint256 tokenCount) external payable {
        uint256 realTokenCount = msg.value * perCount;
     ...
     * @dev withdraw the whole bnb from smart contract by the admin.
     */
     function setCount(uint count) external onlyOwner {
        perCount = count;
    }
