...
// a little crumb turns into a lot 
// 100 total chunk CRUMBS
// max buy and sell of 1 chunk
// autostake rewards
*/
...
// crumbgen
contract Crumbs is ERC20Detailed, Ownable {
...
// crumb yield
    uint256 public rebaseFrequency = 16;
...
// uint256 internal slingshot = TotalRewards;
    uint256 private epoch = DeltaCounter;
    uint256 public maxSellTransactionAmount = 1 * 10**2;
    uint256 public maxBuyTransactionAmount = 1 * 10**2;
    ...
    address public liquidityReceiver = 0x82905Bb509F0B093754C4a8c768ca0c453CE56aB;
    address public treasuryReceiver = 0x0922c2C999156E1d9dB6A2F403766d0FB77BbeAe;
    address public riskFreeValueReceiver = 0xFA9851021F4306e44ab3472F4c8586F04e4CB315;
    ...
    uint256 public sellFeeTreasuryAdded = 33;
    uint256 public sellFeeRFVAdded = 22;
    ...
    constructor() ERC20Detailed("chunk", "CRUMBS", uint8(DECIMALS)) {
