...
//Telegram: https://t.me/MOONoclockbsc
...
contract MoonOClock
 is Context, IERC20, Ownable {
    ...
    string private _name = "Moon O'Clock";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x580abC3A05b753de08A4AbeB35B89FBE677883F3));
        _anotherA = payable(address(0x580abC3A05b753de08A4AbeB35B89FBE677883F3));
