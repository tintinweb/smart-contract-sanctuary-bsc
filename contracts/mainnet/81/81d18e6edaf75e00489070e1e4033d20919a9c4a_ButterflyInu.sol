...
* Hi Guys i m jack from Pitbull deployer team , we created new team for new token and new story
* Believe us and go to moon 
* Before the Launch i will call some channel , after launch also there is some suprise call 
* I trust you for 1000x , we can do it together 
*
* Ownership Renounced 
* Lp lock 2-3 months or more on Pinksale
* 
* BUY AND HODL 
* 4% HOLDER - 3% MKT - 3% DEV

 *TG : https://t.me/butterflyInu_portal
 * website : https://butterflyinu.com/
*/
...
contract ButterflyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Butterfly Inu";
    string private constant _symbol = "BFI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xd4FE087672C7856F8aa39c5ed84964794a962136);
    address payable private _marketingAddress = payable(0x648A3447d1D30B95b96C7f8a653Cf511D124EB52);
