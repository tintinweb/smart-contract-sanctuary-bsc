...
Our telegram: http://t.me/babyshidoinuportal
...
contract BabyShidoInu is Ownable, IERC20 {
    ...
    uint public _marketingSellFee = 5;
    ...
    string private _name = unicode"Baby Shido Inu";
    string private _symbol = unicode"SHIDOINU";
    ...
    function setFees(uint256 marketing, uint256 liquidity) external onlyOwner {
        require(marketing < 10);
        require(liquidity < 10);
