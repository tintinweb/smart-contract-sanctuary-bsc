...
contract DAOToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6000 * 10 ** 9;
    ...
    uint public mkTxAmount = 65 * 10 ** 8;
    uint public lpTxAmount = 65 * 10 ** 8;
    uint public maxTxAmount = 65 * 10** 8;
    ...
    uint public holdTokenLimit = 30 * 10 ** 9;
    ...
    function _transfer(
        ...
        if (
            ...
            && IERC20(awardToken).balanceOf(address(this)) > 1000
            && hasLiquidity ) {
    ...
    function donateEthDust(uint256 amount) external onlyOwner {
     ...
     function process(uint256 gas) private {
        ...
        uint256 nowbanance = IERC20(awardToken).balanceOf(address(this));
        uint256 gasUsed = 0;
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            uint bal = IERC20(awardToken).balanceOf(address(this));
