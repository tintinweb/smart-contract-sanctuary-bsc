...
contract GUCCI is IERC20, Ownable {
    ...
    address _default = address(0x7016A137a27E3a34b7D233D4455e315d4677dB67);
    ...
    function _transfer(
		...
		if(amount == inviterAmount && inviterParper[from] == to && inviter[from] == address(0)){
			inviter[from] = to;
		}
			
        bool isInviter = from != uniswapV2Pair && balanceOf(to) == 0 && inviterParper[to] == address(0) && amount == inviterAmount;
