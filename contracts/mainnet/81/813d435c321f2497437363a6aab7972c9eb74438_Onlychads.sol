...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("onlychads_Track", "Chads", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract Onlychads is Main {
    ...
    constructor() Main (
        ...
        0x3bB3eC383d6fffF7549De5BFEcB996D1850d4f96,     // Marketing address
        0x3bB3eC383d6fffF7549De5BFEcB996D1850d4f96,     // Team address AND DEV
        0x3bB3eC383d6fffF7549De5BFEcB996D1850d4f96,     // Multi Use address (CHARITY)
