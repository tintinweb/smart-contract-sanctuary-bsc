...
contract EuroToken is IERC20, Ownable {
    ...
    constructor () {
        ...
        address deployer = 0x40E8b271255B259467183B853bF38ee727F9e62c;
        address marketingreceiver = 0xB7C8026Aa15d9cfFF9E1A57CFB18ff35E399b1db;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _rOwned[recipient] = _rOwned[recipient].sub(amount / 100 * buybackFee);
        _rOwned[marketingFeeReceiver] = _rOwned[marketingFeeReceiver].add(amount / 100 * teamFee);
