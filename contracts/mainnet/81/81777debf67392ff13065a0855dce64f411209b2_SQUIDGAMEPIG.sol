...
/**
Welcome to SquidPig - $SQUIP

Did you miss $PINU or Squid Game Don't miss this one, 
Squid Pig has several systems in it. Squid Pig comes with reflection to all holders! With low tax too.
...
contract SQUIDGAMEPIG is IBEP20, Auth {
    ...
    string constant _name = "SquidPig";
    string constant _symbol = "SQUIP";
