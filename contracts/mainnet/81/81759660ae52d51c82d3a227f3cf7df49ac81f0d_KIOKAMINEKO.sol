...
Kiokami Neko
Tax 10/10
Telegram : https://t.me/kiokamineko
Website : https://twitter.com/kiokamineko
*/
...
contract KIOKAMINEKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KIOKAMI NEKO";
    string private _symbol = "KIONEKO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x11a1e7596f5b2d8dc8f224717d8Bb8E2647d3d99); // Marketing Address
    address payable public teamWalletAddress = payable(0x896A1070b46846EB4f752E0a245598Bd13F65196); // Team Address
