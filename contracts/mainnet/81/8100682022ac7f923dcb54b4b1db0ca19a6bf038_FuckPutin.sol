...
contract FuckPutin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckPutin";
    string constant _symbol = "FuckPutin";
    ...
    uint256 public ukrainesupportwallet      = 5;
    uint256 public burnFee         			 = 0;
    uint256 public totalFee        			 = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + ukrainesupportwallet;
    ...
    address public ukrainesupportwalletReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd90fC59711Cf3F4A6D2fe6010ce5a45B7dE03cf9;
        teamFeeReceiver = 0xd90fC59711Cf3F4A6D2fe6010ce5a45B7dE03cf9;
        ukrainesupportwalletReceiver = 0x4cA1042F2516E352552545e9B3Cb7F9119DAdE11;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBUtility = amountBNB.mul(ukrainesupportwallet).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
        (tmpSuccess,) = payable(ukrainesupportwalletReceiver).call{value: amountBNBUtility, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _ukrainesupportwallet, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        ukrainesupportwallet = _ukrainesupportwallet;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee + _ukrainesupportwallet;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _ukrainesupportwalletReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        burnFeeReceiver = _burnFeeReceiver;
        ukrainesupportwalletReceiver = _ukrainesupportwalletReceiver;
    }
