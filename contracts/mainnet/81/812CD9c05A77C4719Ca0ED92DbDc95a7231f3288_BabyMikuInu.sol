...
https://t.me/BabyMikuInuOfficial
...
contract BabyMikuInu  is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xbfD4FEEA4D99f22e07E1a5A8a0d559972A87AD21); 
    address payable public Wallet_Dev = payable(0xF2653dc1A935B28CB145650f10bA2A39b1eD8D41);
    ...
    string private constant _name = "BabyMikuInu"; 
    string private constant _symbol = unicode"$BabyMikuInu"; 
    ...
    constructor () {
        ...
        _owner = 0xF2653dc1A935B28CB145650f10bA2A39b1eD8D41;
