...
abstract contract Ownable is Context {
     ...
     */
    constructor() {
        _setOwner(0x9037D91cC45d385685D9EcE739e82cb34BE73755);
    }
...
contract Lottery is Ownable {
  ...
  IERC20 public immutable token = IERC20(0x7B86f5ca09Dc00502E342b0FeF5117E1c32222Ce); // SOLCash token instance.
  uint256 public lotteryFundCollected = 0; // amount of funds collected in each lottery will saved here till before it ends.
  IERC20 public immutable cardano = IERC20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); // Solana token instance to collect rewards and withdraw them.
  ...
  IPancakeRouter02 public immutable pancakeV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // pancake router instance.
  ...
  function enter() public payable {
    ...
    lotteryFundCollected = token.balanceOf(address(this));
  }
  ...
  function withdrawRewardedTokens(address _address) public onlyOwner {
    uint256 extraTokens = token.balanceOf(address(this));
