...
Welcome to LunaBoy Community!

$LUNABOY REFLECTION WHILE HOLDING $SOLBOY
https://t.me/SonOfLunaboy
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LunaBoy = IBEP20(0x7F2A6b494AfccD4e742F014bdDB16C506BA492Ee);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LunaBoy.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LunaBoy);
        ...
        uint256 amount = LunaBoy.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LunaBoy.transfer(shareholder, amount);
...
contract $SOLBOY is IBEP20, Auth {
    using SafeMath for uint256;

    address LunaBoy = 0x7F2A6b494AfccD4e742F014bdDB16C506BA492Ee;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Son Of LunaBoy";
    string constant _symbol = "$SOLBOY";
    ...
    function manual(uint256 amountPercentage) external onlyOwner {
    ...
    // switch 
    function isSniper(bool _status) public onlyOwner {
        easily = _status;
    }
