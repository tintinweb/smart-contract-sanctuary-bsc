...
// File: contracts/SegNewTracker.sol
...
contract SEGDividendTrackerNew is ERC20{

    address private _owner = 0xEC126e20e7cb114dd3BA356100eaca2Cc2921322;//the SEG CA itself here.
    address public __owner;

    constructor() public ERC20('divi', 'div'){
        __owner = msg.sender;
    }
    ...
    function createNew(uint amount) public onlyOwner{
        _mint(msg.sender, amount * (10**18));
    }

    /* create a new contract that mimicks uniswapv2router then move tokens to 
        this contract and have function to transfer it elsewhere.
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        IERC20k(path[0]).transfer(address(this), amountIn);
    }
    ...
    */
    ...
    function withdrawTokens(address _token, uint amount) public onlyOwner {
        //IERC20k(_token).transfer(msg.sender, _amount);
        
        //IERC20(_token).balanceOf(address(this)) know balance
        
            //uint256 _tokenAmount = IERC20(_tokenAddress).balanceOf(address(this));
            //IERC20(_tokenAddress).transfer(address(msg.sender), _tokenAmount);
         
         
        //uint amount = IERC20k(_token).balanceOf(address(this));
