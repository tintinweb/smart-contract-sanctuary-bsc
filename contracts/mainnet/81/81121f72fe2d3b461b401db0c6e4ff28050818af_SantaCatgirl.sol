...
Santa Catgirl - A Kawaii Christmas Coin on BSC!

Meow!!! With Christmas just around the corner, we've teamed up with Santa's cutest helper!

3% Tax on all transactions:
1% Stuffs the liquidity!
1% Funds the lotto!
1% Feeds Turkey to the Devs!

t.me/santacatgirlbsc
Santacatgirl.io
twitter.com/SantaCatGirlBSC
...
contract SantaCatgirl is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Santa Catgirl";
    string constant _symbol = "SCG";
