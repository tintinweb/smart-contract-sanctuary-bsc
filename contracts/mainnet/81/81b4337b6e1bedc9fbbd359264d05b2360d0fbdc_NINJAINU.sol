...
contract NINJAINU is IBEP20, Auth {
    ...
    string constant private _name = "Ninja Inu ";
    string constant private _symbol = "NINJAINU";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function _setFeeReceiver(address _marketingFeeReceiver, address _devFeeReceiver) external authorized {
