...
contract test is IBEP20, Auth {
    ...
    uint256 public sustainabilityFee      = 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0x21710fE6874e29F7939d1233D6EBaCD73f41764C;
        sustainabilityFeeReceiver = 0x42b7131A4F1416b9C17cAc4CeB284421370E4350; 
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _treasuryFee, uint256 _sustainabilityFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/5, "Fees cannot be more than 5.18%");
    }
