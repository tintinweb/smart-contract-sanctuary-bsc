...
contract BOKUNOPICO is Context, IERC20, Ownable {
    ...
    string private _name = "BOKU NO PICO";
    string private _symbol =unicode"キューキング";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Af4AC01307Ea6a036125e11575f3B30D8C7d39A);
    address payable public teamWalletAddress = payable(0x5Af4AC01307Ea6a036125e11575f3B30D8C7d39A);
