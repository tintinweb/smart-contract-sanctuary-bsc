...
contract MUSLIMTATE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3_500 * 10**9;
    ...
    address public treasuryWallet = 0x64a47083bdDFc7Dc47E0F374da772054743fCbA3;

    string private constant _name = "Abu-Andrew Tate";
    string private constant _symbol = "MUSLIM TATE";
    ...
    Taxes public taxes = Taxes(0, 8, 2);
    Taxes public sellTaxes = Taxes(0, 8, 2);
