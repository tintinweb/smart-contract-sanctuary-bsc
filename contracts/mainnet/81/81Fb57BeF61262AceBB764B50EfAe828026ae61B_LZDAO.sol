...
contract LZDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LZDAO";
    string private _symbol = "LZDAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xA7c35D9a12b82aDD5dfD08b30C70e7025c58147d); 
    address payable private teamWalletAddress = payable(0x25d7D3125E2c565FAA4A2E7E11aF7187f5Cc6b93); 
