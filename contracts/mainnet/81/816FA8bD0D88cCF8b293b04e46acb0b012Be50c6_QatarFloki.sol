...
contract QatarFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "QatarFloki";
    string private constant _symbol = "QFloki";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0xF5DD09f1849164C784c76788A41085EB58F9De25);
    address payable private _marketingAddress = payable(0xeCB315029975b77dcb49Cff991C79FD92595f8D7);
    address payable private _buybackAddress = payable(0x9a1E4942356EEd12d68593c2E83677E90A3DE334);
    address payable private _burnAddress = payable(0x4105dCd4623EDaC038afC9f2CfEA67dC55Ed74Db);
    ...
    payable(0xf9931C3648Be713EbF118f8227Ad2453b4e42FFd);
