...
/**
 * @title Voyager Token
 * @dev Voyager Network's token contract.
 */
contract CelerToken is PausableToken, SuccinctWhitelist {
  string public constant name = "Voyager Token";
  string public constant symbol = "VGX";
  uint256 public constant decimals = 8;

  // 10 billion tokens with 18 decimals
  uint256 public constant INITIAL_SUPPLY = 28802285200000000;
