...
contract HuaXiaDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HuaXiaDAO";
    string private _symbol = "HuaXiaDAO";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xc4bcDb1f54743423C86f7e700e9e6000a9801bde); 
    address payable public ttWal = payable(0xc4bcDb1f54743423C86f7e700e9e6000a9801bde); 
