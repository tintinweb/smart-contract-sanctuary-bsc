...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA004Fd6d14c2ef3BC1083db783a7eA3fD894D1F4; // owner address
...
contract FableOfThePepa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Fable Of The Pepa";
    string private _symbol = unicode"PEPS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA004Fd6d14c2ef3BC1083db783a7eA3fD894D1F4); // Marketing Address
    address payable public teamWalletAddress = payable(0xA004Fd6d14c2ef3BC1083db783a7eA3fD894D1F4); // Team Address
