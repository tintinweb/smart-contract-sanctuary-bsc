...
contract ReflectionBEP20 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Shiba Reflections";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xc159370f1bCFa56D56C21da79aBeA9180754ce8E;
        marketingWallet = 0xc159370f1bCFa56D56C21da79aBeA9180754ce8E;
        devWallet = 0xc159370f1bCFa56D56C21da79aBeA9180754ce8E;
    ...
    function changeTxLimit(uint256 newLimit) public authorized {
        _maxTxAmount = newLimit;
    }

    function changeWalletLimit(uint256 newLimit) public authorized {
        _walletMax  = newLimit;
    }
    ...
    function changeIsFeeExempt(address holder, bool exempt) private authorized {
    ...
    function changeIsDividendExempt(address holder, bool exempt) private authorized {
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountSHIB);
