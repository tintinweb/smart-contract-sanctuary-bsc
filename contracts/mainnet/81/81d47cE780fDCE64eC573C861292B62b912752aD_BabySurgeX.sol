...
/*Telegram 
https://t.me/babysurgexportal

Twitter
https://twitter.com/BabySurgeX
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x9f19c8e321bD14345b797d43E01f0eED030F5Bff);
...
/* Token contract */
contract BabySurgeX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1CDD5F2C874D3f0f35dfF468985ba466EB04264F;
    ...
    // Name and symbol
    string constant _name = "BabySurgeX";
    string constant _symbol = "BBYSRGX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1 Million

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 33 / 1000; // 3% on launch 
    uint256 public _maxSellTxAmount = _totalSupply * 33 / 1000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 33 ) / 1000; // 3% 
    ...
    // NOTE: 3% = 100
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        _maxWalletToken = _totalSupply.mul(maxWallPercent).div(3333);
