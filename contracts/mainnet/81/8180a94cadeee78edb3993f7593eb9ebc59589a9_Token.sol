...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyFundFee = 0;    //买进营销
    uint256 private _buyLPDividendFee = 0;   //买进LP分红 不要就写0
    uint256 public _buyLPFee = 5;  //LP回流    /   
    uint256 public _buyBlackFee = 0;  //销毁

    uint256 private _sellFundFee = 0;     //下面就是卖出税收
    uint256 private _sellLPDividendFee = 0;
    uint256 public _sellLPFee = 0;
    uint256 public _sellBlackFee = 0;
    
    uint256 public numTokensSellToFund = 1;   //回流阈值，一般发行量初一10000的数量
    ...
    constructor (
        ...
        maxTXAmount = 888 * 10 ** Decimals;   //单笔限购
        walletLimit = 10 * 10** Decimals;   //钱包限购
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x18725a828caDe3Ed0Dc6EcFadFd46aeD86c78b29), //营销地址
    
        address(0xD8A22A43c32CA08d739666BD38287D587CF00048)  //收币地址   
    ){
