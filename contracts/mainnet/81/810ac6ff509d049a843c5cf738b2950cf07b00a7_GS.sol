...
contract GS is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("Golden September", "GS") {
	...
	uint256 public ldxRate = 6;
	uint256 public fundRate = 4;
    function changeRate(uint256 _ldxRate,uint256 _fundRate) public onlyOwner {
        ldxRate = _ldxRate;
		fundRate = _fundRate;
    }
	
	uint256 public oneTimeAmount = 1 * 10**20;
