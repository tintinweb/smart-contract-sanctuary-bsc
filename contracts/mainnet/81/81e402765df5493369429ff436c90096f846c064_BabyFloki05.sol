...
contract BabyFloki05 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyFloki05";
    string private _symbol = "$B_FLOKI05";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xcffcd89A099074Ce8Bc860c370430a3d44762974); // Marketing Address
    address payable public teamWalletAddress = payable(0xcffcd89A099074Ce8Bc860c370430a3d44762974); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 5 * 10**_decimals; 
