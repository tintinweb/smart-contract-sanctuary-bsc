...
contract SuperSafu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperSafu"; 
    string private _symbol = "SSafu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58034683d8D3b8B5977265Ae4f5144c8FE4edfF4
);
    address payable public teamWalletAddress = payable(0x58034683d8D3b8B5977265Ae4f5144c8FE4edfF4
);
