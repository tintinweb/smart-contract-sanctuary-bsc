...
888b         d888              ,d                 d8"    
88`8b       d8'88              88                 88     
88 `8b     d8' 88  ,adPPYba, MM88MMM ,adPPYYba, MM88MMM  
88  `8b   d8'  88 a8P_____88   88    ""     `Y8   88     
88   `8b d8'   88 8PP"""""""   88    ,adPPPPP88   88     
88    `888'    88 "8b,   ,aa   88,   88,    ,88   88     
88     `8'     88  `"Ybbd8"'   "Y888 `"8bbdP"Y8   88     
...
contract Metaf is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0x56Cf5C4698eca7A61758fA1aFcD650F12CdDfB7D); 
    address payable public developmentAddress = payable(0x87d5a02d2914cE7A0b2ce15Cedc11ba636C1F906); 
    address payable public charityAddress = payable(0x8A8bc210f9aA604f5C2E1F82026DeA9946c092AE); 
    address payable public vaultRewardAddress = payable(0xc5a356822C25467cDb45D25Ae95B0df624391b57); 
    ...
    string private constant _name = "Metaverse Futture";
    string private constant _symbol = "Metaf";
    ...
    //Create additional liquidity using Metaverse Future tokens in contract
