...
contract MegurineLukaBSC is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MegurineLuka";
    string private _symbol = "$ML";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xad3B9131430502BD99295096D4beD9fbF9F313a4); // Marketing Address
    address payable teamWalletAddress = payable(0xad3B9131430502BD99295096D4beD9fbF9F313a4); // Team Address
    ...
    uint256 public _maxTxAmount = 2 * 10**6 * 10**9; //1 * 10**6 * 10**9;
