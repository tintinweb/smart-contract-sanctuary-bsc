...
contract TeteGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBae247A6e12B80faFfeeb9A8ced36Cd7109F3B0a); 
    address payable public Wallet_Dev = payable(0xF6B707CDF53b5C3Aa2f1C945F18Baa93643523fF);
    ...
    string private constant _name = "Tete Grow"; 
    string private constant _symbol = unicode"GTETE"; 
    ...
    constructor () {
        ...
        _owner = 0xF6B707CDF53b5C3Aa2f1C945F18Baa93643523fF;
