...
//🐮MuunBag💰 Comes here to satisfy some needs🥛kek! 
//its a token based on Muu hype  and with some unique utilityes.
//This is going to be the stealthiest launch you've ever seen on the BSC so feel free to shill your friends and family
// https://t.me/MuunBag
/*
          .=     ,        =.
  _  _   /'/    )\,/,/(_   \ \
...
contract MuunBag is IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Muun Bag";
    string constant _symbol = "$MuuB"; 
    ...
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000; //Initial 1.0%
    uint256 public _maxWalletSize = _totalSupply * 200 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0xCd6015050F15C08B64aa30B3aE6789a14e8712e2;
    address public marketingFeeReceiver = 0xCd6015050F15C08B64aa30B3aE6789a14e8712e2;
    address public charityFeeReceiver = 0xCd6015050F15C08B64aa30B3aE6789a14e8712e2;
