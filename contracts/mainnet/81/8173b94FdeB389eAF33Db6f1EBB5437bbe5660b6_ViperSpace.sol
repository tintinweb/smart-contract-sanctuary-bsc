...
contract ViperSpace is Context, IERC20, Ownable {
    ...
    string private constant _name = "Viper Space!!!";
    string private constant _symbol = "VIPER!!!";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100_000_000_000_000 * 10**_decimals;
    uint256 public _maxWalletAmount = 3_000_000_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 1_000_000_000_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 200_000_000_000 * 10**_decimals;

    address public liquidityReceiver;
    address public marketingWallet = address(0x544362586D73D39071Dfa9B56E41ddba1b166C9B);
