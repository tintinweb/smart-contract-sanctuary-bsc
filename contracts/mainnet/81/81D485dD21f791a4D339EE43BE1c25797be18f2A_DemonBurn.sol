...
contract DemonBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Demon Burn";
    string private constant _symbol = "DEMON";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 666 * 10**_decimals;
    uint256 public _maxTxAmount = 1998 * 10**7;
    uint256 public _maxWalletAmount = 1998 * 10**7;
