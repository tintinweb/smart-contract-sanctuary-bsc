...
contract Ethereum2023 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf87db72FCF4c9c9122bf8C082BBeEE6aE236c47A); // Marketing Address
    ...
    string private _name = "Ethereum2023";
    string private _symbol = "$ETH23";
    ...
    uint256 public _maxTxAmount = 20 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
