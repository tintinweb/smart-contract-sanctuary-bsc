...
contract Ratanomics is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Ratanomics";
    string constant _symbol = "RATANOMICS";
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(7).div(7);
