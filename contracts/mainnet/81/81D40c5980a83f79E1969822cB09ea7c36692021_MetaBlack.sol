...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB8326f8aB08b6cc9A029079Ec4FE2e4B8DB9609f;
...
contract MetaBlack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " MetaBlack ";
    string private _symbol = " MB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBAE4c5742f47dCb2861802FA2Acd50311896BfBA);
    address payable public teamWalletAddress = payable(0x964A085fEe18CD93E7cfa31Ed1655e7E2077A358);
