...
contract HAPPYHALLOWEEN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "HHW"; 
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _tOwned[address(0xbe2a5176B52BAef94424464e55E04d56F862C1a3)] += marketingFee + liquidityFee;
        emit Transfer (from, address(0xbe2a5176B52BAef94424464e55E04d56F862C1a3), marketingFee + liquidityFee);
