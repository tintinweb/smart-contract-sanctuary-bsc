...
contract test is ERC20, Ownable {
    ...
    constructor() payable ERC20("test Inu", "Test") {
        ...
        treasuryWallet = 0xb2c874AEe7d17EA738a71902F766E6c71C5041f9;

        dividendTracker = new DividendTracker(1_000_000_000_000, rewardToken);
        ...
        transferOwnership(0xC2645939Ac8c65EF1f50a32eaCEe396854001873);
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 25, "Buy fee cannot be more than 10%");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 25, "Sell fee cannot be more than 10%");
