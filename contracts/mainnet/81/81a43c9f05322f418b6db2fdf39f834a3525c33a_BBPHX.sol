...
/*
Baby Phoenix rewards its holders with $PHX tokens

Get yourself a bag of Baby Phoenix and enjoy automated PHX rewards, which will be the next BSC Moonshot.

Baby Phoenix is definitly a token to hold as it grants its holders valuable $PHX tokens.


Telegram: https://t.me/Baby_Phoenix_Bsc
Webiste: TBA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xBe93aF2D00288f7e1e9056a6d069d1Bb3c460CC7); // PHX Address
...
contract BBPHX is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xBe93aF2D00288f7e1e9056a6d069d1Bb3c460CC7; // PHX Address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Phoenix";
    string constant _symbol = "BBPHX";
