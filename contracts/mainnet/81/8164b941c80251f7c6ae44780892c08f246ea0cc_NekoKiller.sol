...
contract NekoKiller is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000; //100 Millions, underscores aid readability
    ...
    string private _name = "Neko Killer";
    string private _symbol = "NekoKiller";
