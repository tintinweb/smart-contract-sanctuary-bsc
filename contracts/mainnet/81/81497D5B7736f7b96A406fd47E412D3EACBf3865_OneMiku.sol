...
library Address{
 ...
 contract OneMiku is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 40000000000 * 10**9;
    uint256 public maxSellLimit = 40000000000 * 10**9;
    uint256 public maxWalletLimit = 40000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x548Ad2354A9029e950a8791F91DCA7eff95CB084;
    address public treasuryWallet = 0x548Ad2354A9029e950a8791F91DCA7eff95CB084;

    string private constant _name = "OneMiku";
    string private constant _symbol = "1MIKU";
    ...
    Taxes public taxes = Taxes(0, 6, 5, 0);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _treasury) public onlyOwner {
       taxes = Taxes(_rfi,_marketing,_liquidity,_treasury);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _treasury) public onlyOwner {
       sellTaxes = Taxes(_rfi,_marketing,_liquidity,_treasury);
        emit FeesChanged();
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.tRfi-s.tMarketing-s.tLiquidity-s.ttreasury;
        return s;
    }
    ...
    function _getRValues1(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi,uint256 rMarketing, uint256 rLiquidity){
        ...
        rTransferAmount =  rAmount-rRfi-rMarketing-rLiquidity-rtreasury;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(sender, address(this), s.tLiquidity + s.tMarketing + s.ttreasury);
        }
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.treasury) * 2;
