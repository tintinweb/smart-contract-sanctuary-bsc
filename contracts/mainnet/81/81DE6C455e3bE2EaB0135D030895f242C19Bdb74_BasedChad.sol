...
contract BasedChad is IBEP20, Auth {
    ...
    string constant _name = "Based Chad";
    string constant _symbol = "BC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 200;  //2% max tx
    uint256 public _maxWalletSize = (_totalSupply * 2) / 200;  //2% max wallet
    ...
    address private marketingFeeReceiver = 0x397CC406656dB0B64E24F72fbAC0612983fc02C1;
    address private teamFeeReceiver = 0xd44bD8E295dfBA26E430B5b3175199805424383E;
