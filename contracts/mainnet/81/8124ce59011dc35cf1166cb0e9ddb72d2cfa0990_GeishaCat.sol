...
contract GeishaCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Geisha Cat";
    string private constant _symbol = "GEISHACAT";
