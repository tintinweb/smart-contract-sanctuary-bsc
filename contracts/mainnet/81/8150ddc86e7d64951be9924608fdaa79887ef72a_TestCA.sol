...
contract TestCA is IBEP20, Ownable {
    ...
    string constant _name = "Test Bar"; // 
    ...
    // Fees receivers
    address public autoLiquidityReceiver = 0x5d3201B06e22212Eb06b017eFc55Ba20bEC01C82;
    address public marketingFeeReceiver = 0xBA2bAc0FE754B92C57ff186F3b1c4039F181110D;
    address public devFeeReceiver = 0x5d3201B06e22212Eb06b017eFc55Ba20bEC01C82;
    address public buybackFeeReceiver = 0x5d3201B06e22212Eb06b017eFc55Ba20bEC01C82;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!_isBlackList[sender] && !_isBlackList[recipient],"You are blacklisted");
        return true;
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 1000}("");
        require(MarketingSuccess, "receiver rejected WBNB transfer");
        (bool buybackSuccess,) = payable(buybackFeeReceiver).call{value: amountBNBbuyback, gas: 1000}("");
        require(buybackSuccess, "receiver rejected WBNB transfer");
        (bool devSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 1000}("");
