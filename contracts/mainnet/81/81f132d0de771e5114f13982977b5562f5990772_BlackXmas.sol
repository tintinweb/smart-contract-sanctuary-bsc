...
contract BlackXmas is Context, IBEP20, Ownable {
    ...
    string private _name = "Black Xmas"; // token name
    string private _symbol = "$BXMAS"; // token ticker
    ...
    uint256 public maxBuyLimit = 1000000 * 1e9;
