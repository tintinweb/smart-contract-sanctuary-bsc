...
contract SnapInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xf00c3cE41F9aC4ec534C62B60dE63fd4c376D850;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "SnapChatInu";
    string constant _symbol = "SCI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 10000000000000000000000000 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 5 / 10000; 
    uint256 public _maxWalletToken = ( _totalSupply * 10000000000000000000000 ) / 10000;  
