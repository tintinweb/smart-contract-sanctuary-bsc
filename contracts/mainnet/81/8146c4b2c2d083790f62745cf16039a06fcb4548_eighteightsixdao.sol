...
/**
Telegram : https://t.me/token996bsc*
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE3705a00d00680907EE6F0b9566DF0C680Cc4465; // owner address
...
contract eighteightsixdao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "886 DAO";
    string private _symbol = "886";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3705a00d00680907EE6F0b9566DF0C680Cc4465); // 
    address payable public teamWalletAddress = payable(0xE3705a00d00680907EE6F0b9566DF0C680Cc4465); // 
    ...
    uint256 private _totalSupply = 8660 * 10**_decimals;
    uint256 public _maxTxAmount = 175 * 10**_decimals; 
    uint256 public _walletMax = 175 * 10**_decimals;
