...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x014DfCc87B954070dd9A90834f84Ec950DAAEa4f; // owner address
...
contract CapGoMeh is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cap Go Meh";
    string private _symbol = "CGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x014DfCc87B954070dd9A90834f84Ec950DAAEa4f); // Marketing Address
    address payable public teamWalletAddress = payable(0x014DfCc87B954070dd9A90834f84Ec950DAAEa4f); // Team Address
