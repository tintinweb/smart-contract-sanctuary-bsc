...
contract LunaGirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luna Girl";
    string private _symbol = "LUNAGIRL";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0x28E93FEbd2fd59Bc0908fD421E27D53F351C4A23);
    address payable public teamWalletAddress = payable(0x28E93FEbd2fd59Bc0908fD421E27D53F351C4A23);
    ...
    uint256 private minimumTokensBeforeSwap = 50000000 * 5 **_decimals; 
