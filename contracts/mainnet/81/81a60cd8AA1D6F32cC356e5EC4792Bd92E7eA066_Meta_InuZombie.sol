...
contract Meta_InuZombie is Context, IERC20, Ownable {
    ...
    string private _name = unicode"MetaInuZombie";
    string private _symbol = unicode"InuZombie";
