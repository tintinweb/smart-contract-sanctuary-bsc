...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4c57F852D0b0aEffE8D0607C5c01Fe6Ae80d6f8; 
...
contract shibajiru is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAJIRU";
    string private _symbol = "SHIRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4c57F852D0b0aEffE8D0607C5c01Fe6Ae80d6f8); 
    address payable public teamWalletAddress = payable(0xD4c57F852D0b0aEffE8D0607C5c01Fe6Ae80d6f8); 
