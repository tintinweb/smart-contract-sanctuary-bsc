...
Many Callers Have Joined 
Previos Good Project 200X

We are happy to see you all here. We will tell you more about this project, wait for the results of the WORLD CUP 🏆 and enjoy the journey 🔥

https://t.me/arabianworldcup
*/
...
contract Arabian_Worldcup is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "ARABIAN WORLDCUP";
