...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    address public pegRegulationAddress;
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "Boardroom: Caller must be operator");
        _;
    }
    modifier memberExists() {
        require(balanceOf(msg.sender) > 0, "Boardroom: Member does not exist?");
        _;
    }
    ...
    function initialize(
        ...
        initialized = true;
        operator = msg.sender;
        pegRegulationAddress = msg.sender;
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            akusd.safeTransfer(pegRegulationAddress, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        akusd.safeTransferFrom(msg.sender, address(this), amount);
