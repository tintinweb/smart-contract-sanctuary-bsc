...
Telegram : https://t.me/PARLERXTRUTHSOCIALBSC
...
contract ParlerXTruthSocial is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0aE3Fadd9d76CbDD689596F6338778Dfef5e4569); 
    address payable public Wallet_Utility = payable(0x769173144997a90B9b306d6C3FFa7c447852C95d);
    ...
    string private constant _name = "Parler X Truth Social"; 
    string private constant _symbol = unicode"PXT"; 
    ...
    constructor () {
        ...
        _owner = 0x769173144997a90B9b306d6C3FFa7c447852C95d;
