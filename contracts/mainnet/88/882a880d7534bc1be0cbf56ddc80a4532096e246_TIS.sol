...
contract TIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "This Is Soccer";
    string private _symbol = "$TIS";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xE2c1FFfEcCe03A6Cc9C20c3b04998f1C56670a3d;
    address public developerWallet = 0x48778D009902641686137C1Df6C2e1c47De79e6C;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(30).div(denominator);     //2%
    uint256 public _walletMax = _totalSupply.mul(30).div(denominator);    //2%
