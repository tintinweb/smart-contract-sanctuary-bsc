...
contract HungryKishu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HungryKishu";
    string private _symbol = "HK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x45a958a9348fD10F8054Ea57b2b406CdA5d70f21); // 
    address payable private teamWalletAddress = payable(0x45a958a9348fD10F8054Ea57b2b406CdA5d70f21); // 
