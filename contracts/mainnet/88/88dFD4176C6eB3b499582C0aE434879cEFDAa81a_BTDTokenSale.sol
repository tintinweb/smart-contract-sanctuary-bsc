...
contract BTDToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "BTD";
    string private _name= "BLACK TORNADO COIN";
...
contract BTDTokenSale {
    address payable admin;
    BTDToken public tokenContract;
    ...
    constructor(BTDToken _tokenContract, uint256 _tokensSold)  {
