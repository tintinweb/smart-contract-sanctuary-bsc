...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7574Cf0D79825692fEF43e2aCe6443A3ee0FD6B6; // owner address
...
contract shibaiershisi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "424";
    string private _symbol = "424";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7574Cf0D79825692fEF43e2aCe6443A3ee0FD6B6); // 
    address payable public teamWalletAddress = payable(0x7574Cf0D79825692fEF43e2aCe6443A3ee0FD6B6); // 
    ...
    uint256 private _totalSupply = 424 * 10**_decimals;
