...
Welcome to APEOFTARZAN
   ...
   I will renounce the ownership to burn addresses to transfer #APEOFTARZAN to the community, make sure it's 100% safe.

   I will add .1 BNB and all the left 50% total supply to the pool
   Can you make #APEOFTARZAN 10000X? 
   ...
   it's the best part of the #5G idea, increasing the liquidity pool automatically, 
...
library Address{
 ...
 contract APEOFTARZAN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x645357322b90e5E35A8E667855540ae9FFD6C023;
    address public donationWallet = 0xe3AC0490c04a48fbDA0B13ce127ed8211E76720E; 

    string private constant _name = "APEOFTARZAN";
    string private constant _symbol = "TARZANAPE";
