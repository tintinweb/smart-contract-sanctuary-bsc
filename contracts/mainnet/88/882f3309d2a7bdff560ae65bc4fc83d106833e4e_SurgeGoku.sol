...
*              𝓢𝓤𝓡𝓖𝓔 𝓖𝓞𝓚𝓤
*
*  \ Telegram : https://t.me/SurgeGoku /
*   \ Website : https://Surgegoku.com/ /
*   
 */
...
contract SurgeGoku is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeGoku";
    ...
    //Tax wallets
    address public teamWallet = 0xB6aD69D70403d1a4FF4cFc39076574DC7554520E;
    address public treasuryWallet = 0xB6aD69D70403d1a4FF4cFc39076574DC7554520E;

    // Tax Split
    uint256 public teamShare = 94;
    uint256 public treasuryShare = 94;
