...
contract token is ERC20 {
    ...
    uint256 public IntervalTime = 24 * 60;
    ...
    address public marketAddress = address(0xb3F2Dc6624a23D535a5808c30f8c1e2E6916a562);
    ...
    uint256 public sellMarketFee = 30;

    uint256 public maxWalletAmount = 999 * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "Angel";
    string internal tokenSymbol = "Angel";
    uint256 constant total  = 999 * 10**18;
