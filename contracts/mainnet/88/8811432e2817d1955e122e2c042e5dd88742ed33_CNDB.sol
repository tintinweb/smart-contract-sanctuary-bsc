...
library Address{
 ...
 contract CNDB is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 15000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 15000000 * 10**9;
    uint256 public maxBuyLimit = 15000000 * 10**9;
    uint256 public maxSellLimit = 15000000 * 10**9;
    uint256 public maxWalletLimit = 15000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xBBE4A94314e53fB4D9E3B5ec8218590f7f22e4aD;
    address public developmentWallet = 0xBBE4A94314e53fB4D9E3B5ec8218590f7f22e4aD;

    string private constant _name = "CN Detector Bot";
    string private constant _symbol = "CNDB";
