    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0xB5DFCc4dE7456cF3eD67ab08F6310a0348C57850)); // WEALTH - 1
    ...
    function findRewardsToken(address _token) internal view returns(bool){
     ...
     function removeRewardToken(address _token) external onlyOwner{
        ...
        require(totalRewardsToken() > 1, "Cannot have 0 reward tokens");
          ...
          for (uint index = 0; index < rewardTokens.length; index++) {
...
contract SquidWealthGrow is ERC20, Ownable {
    ...
    function viewRewardsToken(uint256 indexToView) public view returns(address){
   ...
   function removeRewardsToken(address tokenToRemove) external onlyOwner(){
    ...
    uint256 public sellCooldownperiod = 2 minutes; //1 hour cooldown
