...
contract byeMOTO is IBEP20, Auth {
    ...
    string constant _name = "byeMISTA";
    string constant _symbol = "byeMISTA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5D0146c4Efe2B5cfa339C96cbd546371C8ae8d73;
        teamFeeReceiver = 0x945A888751Ad50D7c41dA6Cb3B74F5208BF5c3f7;
        buybackFeeReceiver = 0xA345F246636De2ed1C8D06460be1Ff9f0420f8bd;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _buybackFeeReceiver) external onlyOwner {
