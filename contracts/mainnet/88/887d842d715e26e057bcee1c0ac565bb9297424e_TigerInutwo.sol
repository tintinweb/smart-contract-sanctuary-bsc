...
contract TigerInutwo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tiger Inu 2.0";
    string constant _symbol = "Tiger Inu 2.0";
    ...
    uint256 public _maxTxAmount = 0.3 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        devWallet = 0x696D4f4bA6faD8A18EB57b194a10713690153a91;
