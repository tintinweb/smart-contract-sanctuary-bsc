...
/**
TWITTER 0.5
It aims to create a unique NFT market, to establish an E-Commerce system that will be in the near future in NFT shopping production with the Mobile application it will target.

With a project specific to the mobile game world, GriffonGuccicoin aims to ensure that all its investors have a fun time and at the same time generate income.
...
contract TWITTER05 is IERC20, Ownable {
    ...
    string _name = "Twitter 0.5 ";
    string _symbol = "tweet05";
