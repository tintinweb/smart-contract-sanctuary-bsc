...
contract Tensho is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tensho";
    string private _symbol = "Tensho";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb8A9dA3e7f00158A4ed138cc3F1440cE9bb2aB52);
    address payable public teamWalletAddress = payable(0xb8A9dA3e7f00158A4ed138cc3F1440cE9bb2aB52);
