...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51B59AA1d5B5155630f275dF26FCeA17B705d4aB;
...
contract TIKTOKGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "TIKTOK Grow"; // 
    string private constant _symbol = "$TIKTOKG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x51B59AA1d5B5155630f275dF26FCeA17B705d4aB);
