...
contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress2 = 0x614b266789e2dbefbb77fD05c7fa23882C727b4E;
    address public fundAddress3 = 0xCDe72814209F8FdB6a5A1E3362aFBbBa5377A9A4;
    address public fundAddress4 = 0x0Bba364898DC3F66A4b89FddA03d6d6558481f93;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundEach = fundAmount / 4;
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundEach);
        fundAmount -= fundEach;
        FIST.transferFrom(address(_tokenDistributor), fundAddress2, fundEach);
        fundAmount -= fundEach;
        FIST.transferFrom(address(_tokenDistributor), fundAddress3, fundEach);
        fundAmount -= fundEach;
        FIST.transferFrom(address(_tokenDistributor), fundAddress4, fundAmount);
