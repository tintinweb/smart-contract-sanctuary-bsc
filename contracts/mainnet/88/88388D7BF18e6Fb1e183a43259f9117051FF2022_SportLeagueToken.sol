...
contract SportLeagueToken is GasHelper, ERC20 {
  address constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address constant ZERO = 0x0000000000000000000000000000000000000000;
  address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
  address constant PANCAKE_ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

  string constant _name = "NFT SPORT LEAGUE";
  string constant _symbol = "NFTSL";

  string public constant url = "www.nftsportleague.com/";
  ...
  // Fees
  uint public feePool = 200;
  uint public feeBurnRate = 0;
  uint public feeAdministrationWallet = 800;
  uint public feeMarketingWallet = 300;

  uint constant maxTotalFee = 1300;
  ...
  function setFees(
    ...
    require(getFeeTotal() <= maxTotalFee, "All fee together must be lower than 13%");
  }
  ...
  function setSpecialWalletFee(
    ...
    require(total <= maxTotalFee, "All rates and fee together must be lower than 13%");
  ...
  function multiTransfer(address[] calldata wallets, uint112[] calldata amounts) external returns (bool) {
    require(wallets.length == amounts.length, "Invalid list sizes");
    for (uint i = 0; i < wallets.length; i++) _transfer(_msgSender(), wallets[i], amounts[i]);
    return true;
  }
