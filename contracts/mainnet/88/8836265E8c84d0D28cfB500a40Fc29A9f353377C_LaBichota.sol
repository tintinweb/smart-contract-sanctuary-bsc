...
contract LaBichota {
    string public constant name = 'LaBichota';
    string public constant symbol = 'BICHOTA';
    ...
    constructor() {
        PancakeRouter = address(uint160(669446582126765849758220603166373883288500661453));
