...
contract XENOVIACOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xenovia Coin";
    string private _symbol = "XENOVIA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x778A1DAd9baEC508D4fE0BA275D026E2C3Cb9B82); 
    address payable public DevelopmentalWalletAddress = payable(0xB19d077d5d81B9c083Cb222148C8D7773090782b); 
