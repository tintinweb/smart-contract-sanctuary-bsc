...
contract saisihei is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "saisihei";
    string constant _symbol = "SSH";
    ...
    function Lasttoken(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function recalledaddress(uint8 _target, uint8 _denominator) external authorized {
        targetLiq = _target;
   ...
   function gasleftremove(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
