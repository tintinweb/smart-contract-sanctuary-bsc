...
contract Shaolinu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 300_000_000 * 10**9;
    uint256 public maxSellLimit = 300_000_000 * 10**9;
    uint256 public maxWalletLimit = 1_500_000_000 * 10**9;
    
    uint256 public genesis_block;
    uint256 private deadline;
    
    address public marketingWallet = 0x2C0E6014890CE67846dfBCD103291C526069AB51;

    string private constant _name = "Shaolinu";
    ...
    Taxes public taxes = Taxes(0, 0, 50);
    Taxes public sellTaxes = Taxes(0, 0, 50);
