...
/**
🚀 Welcome to MoonverseKitten 🚀

$MoonverseKitten  is a community driven crypto currency, with real world use. we seek to maximize the benefits for coin holders 
...
contract Moonversekitten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonversekitten"; 
    string private _symbol = "Moonversekitten";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaab39B193ab2112c847E84d3D57C89d3A18fDb53);
    address payable public teamWalletAddress = payable(0xaab39B193ab2112c847E84d3D57C89d3A18fDb53);
