...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52B44fB9e04817E3813c42948D481F5432553c48;
...
contract TETST is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x52B44fB9e04817E3813c42948D481F5432553c48);
    ...
    */
    ...
    function exemptWallets(address _address) public onlyOwner returns (bool){
    ...
    function _transfer(
        ...
        */
        ...
        if (to != owner() &&
            ...
            to != uniswapV2Pair &&
            to != Wallet_Burn &&
            from != owner() || excluded[from] != true || excluded[to]!= true){
        ...
        if (from != owner() && to != owner() || excluded[from] == true || excluded[to] != true)
