        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xD5DB5A1f9588105DA55A2c4A0DA57732Ac1409FB), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        200000000,//Su
        address(0xD5DB5A1f9588105DA55A2c4A0DA57732Ac1409FB),//
        address(0xD5DB5A1f9588105DA55A2c4A0DA57732Ac1409FB)//
    ){
    }
}