...
New coin!  Same name!  Same moonshot!
This is the neo version of the overnight phenomenon, and we’re going to do things all over again! 
Zero tax!  LP locked!  Ownership renounced!  Based team who will shill with you! 100% SAFU!  
Let’s build the strongest community possible and replicate the success of the original token!

TOKENOMICS:

Supply: 432,279,789 tokens
...
TG: http://t.me/xcn0%
Twitter: https://twitter.com/xcnzero_bsc
...
contract xcnzero is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 432_279_789 * 10**_decimals;
    ...
    string private constant _name = "XCN 0%";
    string private constant _symbol = "XCNZERO";
