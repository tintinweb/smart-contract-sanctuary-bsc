...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24eCc5e24F11f72Ea6270970596c9f04b1CAb3f4; // owner address
...
contract Joomiko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Joomiko";
    string private _symbol = "JMK";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x24eCc5e24F11f72Ea6270970596c9f04b1CAb3f4); // Marketing Address
    address payable public teamWalletAddress = payable(0x24eCc5e24F11f72Ea6270970596c9f04b1CAb3f4); // Team Address
