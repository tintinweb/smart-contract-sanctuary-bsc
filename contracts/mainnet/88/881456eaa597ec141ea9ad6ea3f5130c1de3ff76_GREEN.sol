...
contract GREEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x432C6d281948448B31812dDF49bf4a1E7A0F3A11); 
    address payable public Wallet_Dev = payable(0x432C6d281948448B31812dDF49bf4a1E7A0F3A11);
    ...
    constructor () {
        ...
        _owner = 0x432C6d281948448B31812dDF49bf4a1E7A0F3A11;
