...
contract PitbullGrow is Context, IERC20, Ownable {
    ...
    string private _name = "PitbullGrow";
    string private _symbol = "PitbullGrow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE4488A41F3E1E04e3C3901b632967533FEbD9115));
        ________ = payable(address(0xE4488A41F3E1E04e3C3901b632967533FEbD9115));

        _asdjiowf[_msSender()] = _totalSupply;
        emit Transfer(address(0xb815cBFBC404472DF032D911368F75cAC02fe88D), _msgSender(), _totalSupply);
    }
