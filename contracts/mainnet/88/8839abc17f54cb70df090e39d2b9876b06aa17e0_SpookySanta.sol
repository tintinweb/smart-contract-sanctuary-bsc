...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f333134932f0A592C4d8Ed4DA3a93751e7a96db;
...
contract SpookySanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Santa";
    string private _symbol = "SPOOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9025B29c7246b7012ce10542cC230A5Ad8636ec9);
    address payable public teamWalletAddress = payable(0x9025B29c7246b7012ce10542cC230A5Ad8636ec9);
