...
version 1.7
minter: https://nftminterbsc.tresleches.finance
...
contract TresLechesNFTStakeV2 is Ownable, ReentrancyGuard {
...
//end of variables for dapp
  ...
  mapping (address => uint256) public ownerToNFTokenCount;
    ...
    constructor() {
        ...
        nftCollection = IERC721(0x0cFdB195a36bb0ce7D5fEFcCBa4BaE11D4B0D1d3);
        rewardsToken = IERC20(0x97B846DB4E521A07185d3da4408a12897316b618);
        } else if (block.chainid == 97) {
        nftCollection = IERC721(0x84729A43cB0CF0B36813360De3F544bFF9b0dA71);
...
//need to add unstake
    ...
    returns (uint256)
  {
    ...
    function getUpdateRewards(address _staker)
        external
        view
        returns (uint256 _rewards)
    {
