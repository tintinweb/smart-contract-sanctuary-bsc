...
contract ApeGrow is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xA72B2DCE65625fD6834c3c9B082b6A2DF2f355e7;
    address public devWallet = 0xA72B2DCE65625fD6834c3c9B082b6A2DF2f355e7;
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 1e8, "Cannot set max buy amount lower than 0.1% of tokens");
        require(maxSell >= 1e8, "Cannot set max sell amount lower than 0.1% of tokens%");
        require(maxWallet >= 1e9, "Cannot set max wallet amount lower than 1% of tokens");
