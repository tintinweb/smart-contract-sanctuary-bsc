...
contract KEMONO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kemono";
    string private _symbol = "KEMONO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbFEEF6BC2323D4dECd7a49cd551F6aEca17dde6C); // Marketing Address
    address payable private teamWalletAddress = payable(0xF2DB02FeD221A4349bbe00bE5d4b9a2d35fa1656); // Team Address
    ...
    uint256 public _walletMax = 3 * 10**3 * 10**6* 10**_decimals;
