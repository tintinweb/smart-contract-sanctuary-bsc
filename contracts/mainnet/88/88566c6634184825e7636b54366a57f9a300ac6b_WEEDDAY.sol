...
contract WEEDDAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WEED DAY"; // TODO change
    string private _symbol = "420"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x021dC963fB99C117fc721Ac8FE8353A40781F34B); // Marketing Address
    address payable public buybackWalletAddress = payable(0x021dC963fB99C117fc721Ac8FE8353A40781F34B); // Buyback Address
