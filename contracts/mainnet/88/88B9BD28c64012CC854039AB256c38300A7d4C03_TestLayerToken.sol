...
contract TestLayerToken is BEP20 {
     ...
     */
    constructor() public BEP20("Test Layer Token", "TEST1") {
...
contract SafeChef is Ownable, ReentrancyGuard {
    ...
    // @TODO: Add TestLayerToken address to here
    ...
    function updatePool(uint256 _pid) public {
        ...
        TestLayerToken(earningToken).mint(
            devaddr,
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        if (address(earningReferral) != address(0) && referralCommissionRate > 0) {
            ...
            if (referrer != address(0) && commissionAmount > 0) {
                TestLayerToken(earningToken).mint(referrer, commissionAmount);
