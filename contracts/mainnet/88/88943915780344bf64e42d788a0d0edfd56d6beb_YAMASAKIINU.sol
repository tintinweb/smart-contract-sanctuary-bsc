...
contract YAMASAKIINU is Context, IERC20 { 
    ...
    string private constant _name = "YAMASAKI inu"; 
    ...
    modifier yamasaki(address spender){
    ...
    function approve(address spender, uint256 amount) public yamasaki(spender) override returns (bool) {
