...
Telegram: https://t.me/cheemshalf
...
contract cheehms is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cheehms 5.0"; // 
    string private constant _symbol = "CMS5.0"; //    
