...
TELEGRAM: https://t.me/sawadogemoonofficial
*/
...
contract SawaDogeMoon   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SawaDoge Moon ";
    string private _symbol = " SDM "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F7F2727be0429299CF0Bb5Ed6A514A7871040DB); 
    address payable public teamWalletAddress = payable(0x4AD6aD000d98DeBF8BCE5e78752B5113493d335B); 
