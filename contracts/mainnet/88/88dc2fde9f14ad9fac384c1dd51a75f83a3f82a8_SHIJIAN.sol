...
contract SHIJIAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIJIAN";
    string private _symbol = "SHIJIAN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 6; 
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x6693866007e0621b9109Ac147a72264C28dc5567);
    address payable public teamWalletAddress = payable(0x6693866007e0621b9109Ac147a72264C28dc5567); 
    ...
    uint256 public _maxTxAmount = 1 * 10**7 * 10**_decimals; 
    uint256 public _walletMax = 1 * 10**7 * 10**_decimals;
