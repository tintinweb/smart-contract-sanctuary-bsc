...
contract MuskDog is ERC20 {
	...
	address private _destroyAddress = address(0x373A71fed6A5D122121AAc8c3b662d2ac39f3B0c);
	...
	function getCanSendAmount(address account) public view returns (uint256) {
		...
		uint256 lastDay = block.timestamp.sub(userTime).div(600);
        uint256 daySellAmount = haveAmount.mul(lastDay).div(50);
