...
contract METAWEBFIVEToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "BUSD";
    string private _name= "Binance-Peg BUSD Token";
...
contract METAWEBFIVEBUSD {
    address payable admin;
    METAWEBFIVEToken public tokenContract;
    ...
    constructor(METAWEBFIVEToken _tokenContract, uint256 _tokensSold)  {
