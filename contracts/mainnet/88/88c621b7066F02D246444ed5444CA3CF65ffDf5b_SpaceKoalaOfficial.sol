...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xd8cd5d4cCb8Fe47E6273bbfDbc504c3506Be7585); //$KOI
...
contract SpaceKoalaOfficial is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Space Koala";
    string  _symbol = "SpaceKOI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xD5f9b5da20677bb140522a668176428ABcBE5CF8;
        teamFeeReceiver = 0xD5f9b5da20677bb140522a668176428ABcBE5CF8;
        devFeeReceiver = 0xD5f9b5da20677bb140522a668176428ABcBE5CF8;
