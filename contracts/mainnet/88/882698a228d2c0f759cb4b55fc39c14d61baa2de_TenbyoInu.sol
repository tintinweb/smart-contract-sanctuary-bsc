...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D80CDAAde64a1aa08764A299a35053bE692280C; 
...
contract TenbyoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tenbyo Inu";
    string private _symbol = "TENBYO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1D80CDAAde64a1aa08764A299a35053bE692280C); // 
    address payable public teamWalletAddress = payable(0x1D80CDAAde64a1aa08764A299a35053bE692280C); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x1D80CDAAde64a1aa08764A299a35053bE692280C)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x1D80CDAAde64a1aa08764A299a35053bE692280C),removeRandom);
}}