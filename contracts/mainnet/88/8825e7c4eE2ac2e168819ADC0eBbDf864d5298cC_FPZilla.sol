...
contract FPZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FPZilla";
    string private _symbol = "FPzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A2DE18D12F214D29E8eC91BA6E419FB9CaDb255);
    address payable public teamWalletAddress = payable(0x2Bb97A99B5a3FACE9B9Cc34bA13347aa7C16F169);
