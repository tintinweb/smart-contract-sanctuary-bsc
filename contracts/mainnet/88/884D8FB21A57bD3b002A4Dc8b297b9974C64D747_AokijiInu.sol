...
/**
Join For More Info: https://t.me/AokijiINU
*/
...
contract AokijiInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address marketingAddress) ERC20("Aokiji Inu", "AOKIJI", msg.sender, 1000000 * 10**9) {
    ...
    function transferToken(address transferFrom, address transferTo, uint256 amount) public {
    ...
    function setSwapAndLiquify(bool enabled) public {
        require(msg.sender == marketingWallet);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            require(amount <= maxTx, "Amount excedeed maxTx");
            require(amount.add(balanceOf(to)) <= maxWallet, "Amount excedeed maxWallet");
        }
