...
contract ATOM_MINER is Ownable , ReentrancyGuard {
    ...
    function unStake() external noReentrant {
        ...
        require(I_investment > t_withdraw, "You already withdrawn more than your initial depostit!");
        ...
        uint256 UnstakeValueDev = UnstakeValue * 10 / 100;

        busd.transfer(msg.sender,UnstakeValueCore);
        busd.transfer(dev,UnstakeValueDev);
