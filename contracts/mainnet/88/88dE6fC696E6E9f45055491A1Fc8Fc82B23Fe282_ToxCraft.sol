...
TG: https://t.me/ToxCraft
Dev TG: @ToxShok
Dev Doxxed

ToxCraft - Shitcoin Program
20,000 Max Wallet ||||| 10,000 Max Transaction
12% BUY & SELL TAX! SELL TAX HIGHER AT LAUNCH!!
...
Hello ! ToxCraft is deploying the Shitcoin Program

What is the Shitcoin Program ? 

- Tokens deployed depending on Elon Musk Tweets or another great event

- Safe

- Liquidity Locked

- Tokens with some special benefits ( reflection, slippage, burn and more ).

- CMC and CoinGecko listing if we are able to make it

- Vote Polls to determine properties of new tokens

——
The Shitcoin program will be useful for :

- Make more tokens with more starting liquidity

- Funds the project ToxCraft 
...
contract ToxCraft is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Hate&LoveInu';
    string private constant _symbol = '$Hate&Love';
    ...
    //DevWallets
    address public Development=payable(0xCC9279Bc33C33f3363b6A90c25888760dBe2Dc14);
    address public Marketing=payable(0x234Ec06842206Ad450C6A0b56b2E4F069050E09B);
    //TestNet
