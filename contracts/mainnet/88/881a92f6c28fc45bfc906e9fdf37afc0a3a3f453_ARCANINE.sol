...
contract ARCANINE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"ARCANINE";
    string private _symbol = "ARCA";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xE2c7f9ae65d7A7A32102BC6e66E6eCef6cc7819f); 
    address payable public teamWalletAddress = payable(0xE2c7f9ae65d7A7A32102BC6e66E6eCef6cc7819f); 
