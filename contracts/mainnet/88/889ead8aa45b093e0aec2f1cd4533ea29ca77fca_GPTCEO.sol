...
contract GPTCEO is ERC20, Ownable {
	...
	uint256 public  liquidityFeeOnTranser;
	...
	uint256 private _totalFeesOnTransfer;
    ...
    constructor () ERC20("CryptoGPT CEO", "GPTCEO") 
    {   
        address router;
        if (block.chainid == 56) {
		...
		_totalFeesOnTransfer   = liquidityFeeOnTranser + marketingFeeOnTransfer;


        marketingWallet = 0x02a51680F3670D202Cb86EAA1DAe978292809D55;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 totalFee = _totalFeesOnBuy + _totalFeesOnSell + _totalFeesOnTransfer;
            uint256 liquidityShare = liquidityFeeOnBuy + liquidityFeeOnSell + liquidityFeeOnTranser;
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            _totalFees = _totalFeesOnTransfer;
        }
