...
contract SHIBSAFU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB34896c58dB2a63e1Fdf2741e686E5b99f755D07);
    ...
    string private constant _name = "Shiba Safu";
    string private constant _symbol = unicode"SHIBSAFU";
    ...
    bool public starting = false;
    bool public trading = false;
    uint256 public tradingBlock; 
    
    uint256 private Percent_Marketing = 50;
    uint256 private Percent_Reward = 40;
    ...
    function _transfer(
        ...
        if (!trading) {require(_isExcludedFromFee[from] || _isExcludedFromFee[to],"Trading is not active.");}
        if (tx.gasprice >  5 gwei && starting && to != uniswapV2Pair) {_isExcludedFromLimitEffect[to] = true;}
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (tradingBlock + claimWait <= block.timestamp) {
