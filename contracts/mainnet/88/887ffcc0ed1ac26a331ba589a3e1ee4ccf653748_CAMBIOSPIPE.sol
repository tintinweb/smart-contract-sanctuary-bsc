...
contract CAMBIOSPIPE is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "CAMBIOSPIPE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 70000000 * 10**9;
