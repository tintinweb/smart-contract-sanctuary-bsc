...
🌙 Based Team
🌙 Safu Project
🌙Telegram: ✅https://t.me/KaoriToken

🌙Kaori BSC🌙 $KAORI🌙 1% tax 🌙Renounce🌙LP LOCK

🌙Kaori introduced at the same time as Buddhism, to protect sacred texts from the damage mice can cause and symbolizes the crescent moon on the forhead symbolizes a magical dreams and fertility. Officially heading towards the space on Binance BlockChain to give magical and prosperity. 

🌙Tap below to begin human verification🌙
...
contract KaoriToken is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Kaori';
    string private _symbol = '$Kaori';
