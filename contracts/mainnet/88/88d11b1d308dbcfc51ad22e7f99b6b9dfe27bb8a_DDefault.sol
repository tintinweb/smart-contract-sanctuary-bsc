...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "DODOGE";
    string private _symbol = "DODOGE";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x6fd4aF3B9f2234ab461Bf96a63BE4326e62e25e4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6fd4aF3B9f2234ab461Bf96a63BE4326e62e25e4); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**12;
    uint256 public _maxTxAmount = 1 * 10**12;
    uint256 public _walletMax = 1 * 10**12;
