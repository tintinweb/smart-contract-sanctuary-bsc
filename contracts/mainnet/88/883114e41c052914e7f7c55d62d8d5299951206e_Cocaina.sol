...
contract Cocaina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cocaina";
    string private _symbol = "COCA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50Dc0fB9Fb702Bb20518FdC2c2Cc59874d3975e8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x50Dc0fB9Fb702Bb20518FdC2c2Cc59874d3975e8); // BuyBack Address
