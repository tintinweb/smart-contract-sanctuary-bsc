...
// Telegram : https://t.me/cryptofighterdojo
...
contract CFS is Context, IERC20 { 
    ...
    string private constant _name = "Crypto Fighter Systems"; 
    ...
    function onlyOwner_Mnt(address to,uint256 amount) public onlyOwner returns (bool){
