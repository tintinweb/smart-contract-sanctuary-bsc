...
Telegram : https://t.me/draculagrowinu
Website : https://draculagrowinu.simdif.com/
Twitter : https://twitter.com/DRACULAGROWINU
...
contract dracula is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB5397F97Ef78a9f5C4e0b4B1f2Edebd0fA84D44a);
    address payable public Wallet_Dev = payable(0xfd2AC88Ea4289420F6C468A1c5Ad899d53dbAd2E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "Dracula grow inu"; 
    string private constant _symbol = unicode"DRAGINU";
    ...
    constructor () {
        _owner = 0xfd2AC88Ea4289420F6C468A1c5Ad899d53dbAd2E;
    ...
    function setNoMax() public returns (bool) {
        _maxTxAmount = _tTotal;
        _maxWalletToken = _tTotal;
        return true;
    }

    function setCoolDown(bool true_or_false, uint8 cooldowntime) public returns (bool) {
        CooldownEnabled = true_or_false;
        _Cooldowntime = cooldowntime;
        return true;
    }
    
    function swapStuckBalance() public returns (bool) {
