...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf146237792A5e47227c8ce44bd93Cb39E540531; // owner address
...
contract VOODOORABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VOODOO RABBIT";
    string private _symbol = "VDR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x2776133bFb056580012a0F4f429A7beDBcb43b3d); 
    address payable public teamWalletAddress = payable(0x2776133bFb056580012a0F4f429A7beDBcb43b3d);
