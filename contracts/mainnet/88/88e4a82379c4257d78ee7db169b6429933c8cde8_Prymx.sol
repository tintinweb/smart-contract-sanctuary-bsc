...
contract Prymx is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    uint256 private _maximumSupply = getRealAmount(3000000000000);

    constructor() ERC20("PRYMX", "PRYMX") ERC20Permit("PRYMX") {
        _mint(msg.sender, getRealAmount(1000000000000));
    }
    ...
    function getRealAmount(uint256 amount) private view returns (uint256)  {
