...
contract SoldierBoston is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SOLDIER BOSTON";
    string private _symbol = "SoldierBoston";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67A1e0b39778eFd4CECC00182ab8B51aFcCeeEA2);
    address payable public teamWalletAddress = payable(0x67A1e0b39778eFd4CECC00182ab8B51aFcCeeEA2);
