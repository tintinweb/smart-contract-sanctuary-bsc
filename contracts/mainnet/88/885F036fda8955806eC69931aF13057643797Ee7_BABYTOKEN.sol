...
HuanZhu是bsc唯一真正的，流動性由眾多早期用戶自行添加並銷毀LP，開發者也沒有任何特權或額外收入
...
contract BABYTOKEN is IBEP20, Auth {
    ...
    string constant _name = "HuanZhu";
    string constant _symbol = "HuanZhu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 8800 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAFce646Bf1067863fe51900df4B75f6DAd04C66E;
