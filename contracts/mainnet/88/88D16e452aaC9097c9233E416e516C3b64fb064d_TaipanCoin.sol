...
contract TaipanCoin is ERC20, Ownable {
    ...
    TAIPANDividendTracker public dividendTracker;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    address public marketingWallet = 0x04ae6Cf1f00f67219b77b2f29FE5c1a89c13c92b;
    address public devWallet = 0x5B684A4948B713b7176457CfB2f81FA2af7BE1aB;

    uint256 public swapTokensAtAmount = 2_000_000 * 10**9;
    uint256 public maxWalletAmount = 12e5 * 10**9;
    uint256 public maxTxAmount = 6e5 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(1,3,4,1);
    Taxes public sellTaxes = Taxes(1,2,5,4);

    uint256 public totalBuyTax = 9;
    uint256 public totalSellTax = 12;
    ...
    constructor() ERC20("TaipanCoin", "TPAN") {

    	dividendTracker = new TAIPANDividendTracker();
        ...
        */
        _mint(owner(), 4e7* (10**9));
    }

    receive() external payable {}
    function updateDividendTracker(address newAddress) public onlyOwner {
        TAIPANDividendTracker newDividendTracker = TAIPANDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TAIPAN: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "TAIPAN: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TAIPAN: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TAIPAN: Cannot update gasForProcessing to same value");
...
contract TAIPANDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("TAIPAN_Dividen_Tracker", "TAIPAN_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10_000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "TAIPAN_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TAIPAN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TAIPAN_Dividend_Tracker: Cannot update claimWait to same value");
