...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x85157fa625B6a6cfDc977c3DBD01Dd8241682b11;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x85157fa625B6a6cfDc977c3DBD01Dd8241682b11),//fund address
    
        address(0x85157fa625B6a6cfDc977c3DBD01Dd8241682b11)//dev address
    ){
