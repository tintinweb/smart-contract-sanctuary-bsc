...
Telegram : https://t.me/NOGOALNOPARTY
Twitter  : https://twitter.com/NoGoalNoParty_
...
contract NoGoalNoParty  is Ownable, IBEP20 {
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x6DcE4e18504403B696f0F51B19B3b6724bdC5269;
        marketingWallet =0x6DcE4e18504403B696f0F51B19B3b6724bdC5269;
        NGNPTeamwallet = 0x786FFD181324e01972f5360a0a07c615013B06fe;
        
        totalFee = liquidityFee.add(marketingFee).add(NGNPTeamFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(NGNPTeamFee.div(2));

        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBMarketing = amountBNB.mul(NGNPTeamFee).div(totalBNBFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newNGNPTeamFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        NGNPTeamFee = newNGNPTeamFee;
    
        totalFee = liquidityFee.add(marketingFee).add(NGNPTeamFee);
        require (totalFee < 99);
        totalFeeIfSelling = totalFee;
    }
    function sellFees(uint256 newsellFee) external onlyOwner {
