...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA777A756A7CEBe56aEC7b05c2e441f13d563fd94; // owner address
...
contract Galagrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gala Grow";
    string private _symbol = "$GGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3EB427042D04cC8Cb6e372B2beE8C4ea6FB31b11); // Marketing Address
    address payable public teamWalletAddress = payable(0x3EB427042D04cC8Cb6e372B2beE8C4ea6FB31b11); // Team Address
