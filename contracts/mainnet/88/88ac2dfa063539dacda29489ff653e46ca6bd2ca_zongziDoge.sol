...
contract zongziDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "zongziDoge";
    string private _symbol = "zongziDoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 4;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xCD732cB35e2844f83C70E289D1CB7cDe799FCC3b); // Marketing Address
    address payable public teamWalletAddress = payable(0xCD732cB35e2844f83C70E289D1CB7cDe799FCC3b); // Team Address
