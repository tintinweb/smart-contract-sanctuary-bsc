...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3caF6b26c2FDcf54c18ced289fa15C82df52A051;
...
contract TERAKToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x71c79b98FDC3C2A4578703571940576670160F76;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TERAKToken";
    string private _symbol = "TERAK";
