...
The Parkstar ecosystem consists of the Parkstar APP and the project token. The application connects the B2B platform for individual parking space use with the Blockchain technology.

The users of the app can offer their parking spaces via the APP and pay with crypto currency. The PSTAR token is not just a means of payment but also a reward system for the users. A lot and good user behavior is rewarded with the ecosystem token. But there are also many other advantages within the application that make use of the PSTARtoken attractive.

Park Star protocol is a decentralized finance (DeFi) token. According to the Parkstar website.


Telegram : https://t.me/ParkStarApp
Website  : https://coinmarketcap.com/currencies/park-star/
Twitter  : https://twitter.com/ParkStarToken
...
contract ParkStar is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xE17b041807330b7e2B90fA6f198B3487AA4E03Bd);
    ...
    string private constant _name = "Park Star"; 
    string private constant _symbol = unicode"P-S-T-A-R"; 
    ...
    constructor () {
        ...
        _owner = 0xE17b041807330b7e2B90fA6f198B3487AA4E03Bd;
