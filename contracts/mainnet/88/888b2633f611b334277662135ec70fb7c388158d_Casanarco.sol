...
contract Casanarco is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "CASANARCO";
    string private _symbol = "NARC";
    ...
    uint256 public _marketFee = 20;  // 0% will go to wallet2fee 
