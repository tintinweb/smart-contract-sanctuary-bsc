...
contract StandartBEP20  is Context, IERC20 {
    ...
    string private _name = "DOGE 2K23";

    string private _symbol = "D2K23";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xdc8b56aEEa8940ebA63c43e5b8f43945Cf83145b); //MARKETING WALLET
    ...
    function setTax(uint256  buyTax,  uint256 sellTax,
