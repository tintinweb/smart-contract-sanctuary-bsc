...
/**
SAFE DEV ASK FOR PREVIOUS ON TG / TG: T.me/SadShiba
13% TAX BUY AND SELL
*/
...
contract SADSHIBAINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x62D56dc5f6B3f7Fe1A9FE40e3ff898cDd794779b); 
    address payable public Wallet_Dev = payable(0x62D56dc5f6B3f7Fe1A9FE40e3ff898cDd794779b);
    ...
    string private constant _name = "Sad Shiba Inu"; 
    string private constant _symbol = unicode"SADSHIB"; 
    ...
    constructor () {
        ...
        _owner = 0x62D56dc5f6B3f7Fe1A9FE40e3ff898cDd794779b;
