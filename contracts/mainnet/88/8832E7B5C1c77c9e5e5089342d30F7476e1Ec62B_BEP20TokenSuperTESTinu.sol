...
contract BEP20TokenSuperTESTinu is Context, IERC20 { 
    ...
    string private constant _name = "BEP20TokenSuperTESTinu kjsdfoajhdf"; 
    string private constant _symbol = unicode"SuperTEST"; 
