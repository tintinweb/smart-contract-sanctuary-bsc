...
contract NCWCI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community World Cup Inu";
    string private _symbol = "$NCWCI";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x584C56711e33f5C4B71f5b67f689E75f9033B97D); // Buy Back Address
