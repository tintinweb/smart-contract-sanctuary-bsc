...
/*
    ...
    The next GROW MOONSHOT on the Binance Smart Chain! 
...
contract SMEEHCWROG is Context, IERC20, Ownable {
    ...
    string private constant _name = "smeehCwroG";
    string private constant _symbol = "SMEEHCWROG";
