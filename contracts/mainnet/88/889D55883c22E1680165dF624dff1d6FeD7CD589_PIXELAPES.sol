...
contract PIXELAPES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIXELAPES";
    string private _symbol = "$PIXAPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0A525F0892ec7eF19375B1A282Cc09FcD6e092E0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0A525F0892ec7eF19375B1A282Cc09FcD6e092E0); // BuyBack Address
