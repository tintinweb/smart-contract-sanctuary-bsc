...
/*
Welcome:
LIGHT Minner is a cryptographic asset created on the BSC (Binance SmartChain) BEP20 and and it is predicted the interoperability of the token via Cross-chain to the Ethereum network. It was created with the proposal of Mining through renewable energy, bringing together concepts of Decentralized Finance and Sustainability (DeFi), combined with Mining Rigs, Trading, Metaverse, NTFs and other blockchain-based initiatives for better usability of your system.

https://lightminner.io/
https://brillacom.org/
...
contract LightMinner is Context, IERC20, Ownable {
    ...
    string private _name = "LIGHT Minner";
    string private _symbol = "MINNER";
    ...
    address public charityWallet = 0x26AA8e5c56c25127c5E62BE9D4157Ca6017f3832;
