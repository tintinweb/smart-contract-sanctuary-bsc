...
contract GreenChartTwo is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1f189578F899a64EEBB0e84faF16C9CCfE4EFC6B;
    address public devWallet = 0x8EAEca3b0eB607a262897C38355e898073aBC6F7;
    address public treasuryWallet = 0x1f189578F899a64EEBB0e84faF16C9CCfE4EFC6B;

    string private constant _name = "Green Chart 2.0";
    string private constant _symbol = "GreenChartTwo";
    ...
    Taxes public taxes = Taxes(0, 3, 3, 3, 0);
    Taxes public sellTaxes = Taxes(0, 3, 3, 3, 0);
