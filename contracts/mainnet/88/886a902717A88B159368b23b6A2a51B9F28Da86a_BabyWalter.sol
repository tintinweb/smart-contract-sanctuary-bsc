...
/*
BabyWalter is a project based on the Binance smart chain, developed by degens who want to change the world! 🚀

Join our family with buying your own bag! 💰

Telegram - @BabyWalterBSC
*/
...
contract BabyWalter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyWalter";
    string constant _symbol = "BWL";
