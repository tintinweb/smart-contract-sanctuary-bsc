...
contract PANDAOToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    uint256 public MIN_SUPPLY = 2100000 * 1e18;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 swapTokens = contractTokenBalance.mul(buyLiquidityFee.add(sellLiquidityFee)).div(
                buyLiquidityFee.add(sellLiquidityFee).add(sellTokenRewardsFee).add(buyTokenRewardsFee)
            );
