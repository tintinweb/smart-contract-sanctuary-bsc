...
contract BabyOkinami is BEP20Deployer, Context, Ownable {
    ...
    string public override name = "BabyOkinami Coin";
    string public override symbol = "BabyOkinami";
    ...
    constructor(uint totalSupplyValue, address StakingPoolAddress, address RewardPoolAddress) {
        ...
        balances[StakingPool] =  totalSupply * 4 / 100;
        balances[RewardPool] = totalSupply * 4 / 100;
