...
| |    | |  _  \|___    ___|\\        //|  ____||  _  \ |  _  |  ___|
 |_____/|________|____ /|__________|     \/     |\\\\\\|||   \_\ __
...
contract utopytoken is Context, IERC20, Ownable {
    //TresFlames
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "UTPOYC";
    string private constant _symbol = "UTOPY";
    ...
    address payable private _devwallet = payable(address(0xcB4f108153b4582adb905beE70738beEf41E4E28));
    ...
    constructor() {
        ...
        multisig = 0x1Eb5df87701848d334df960d4ac5BBf4915e10D8;
    ...
    function setFees(
        ...
        require(buy_tax + buy_marketing + buy_liquidity + buy_dev <= 20);
        require(sell_tax + sell_marketing + sell_liquidity + sell_dev <= 25);
        buyFee.tax = buy_tax;
