...
$Lion Finance
The Lion Community!
Our mission is to create an environment that encourages diversity, 
appreciation, cooperation, and connection among all members of our community.
One of the ours objectives is to be the first Lion meme community on shibarium chain , 
and we are already working on a our personal bridge and more utilities .
Please take some time to familiarize yourself with the guidelines 
and values that define the Lion Community.
*/
...
contract LionFinance  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Lion Finance';
