...
contract BLACKHALF is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Black Half";
    string private constant _symbol = unicode"BLACKHALF";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0x742ec8170b3865bf4a360BD9eC9FdC6BDa940e95);
    address payable private MarketingWallet = payable(0x742ec8170b3865bf4a360BD9eC9FdC6BDa940e95);
