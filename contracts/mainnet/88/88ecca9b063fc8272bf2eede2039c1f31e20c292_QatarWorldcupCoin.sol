...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x21d4E728d7d900ce52c808CAE2C0c331E3Fd5179;
        _owner = msgSender;
...
contract QatarWorldcupCoin is Context, IBEP20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x51f94402f77BFE5f6BAf2cd12902dc69331c4f7D); 
    ...
    string private _name = "Qatar Worldcup Coin";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal.div(100_000); 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        uint256 bnbForLiquidity = ethBalance.mul(_liquidityFee).div(_swapableFee).div(2);
    ...
    external onlyOwner
    {
        ...
        uint256 _totalFee = _saleTaxFee.add(_saleLiquidityFee).add(_saleMarketingFee).add(_saleBurnFee);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() 
    {
        ...
        require(_maxTxAmount>_tTotal.div(1000), "Too low limit");
    }
    ...
    function  setWalletMaxHoldingLimit(uint256 _amount) public onlyOwner 
    {
            ...
            require(_walletHoldingMaxLimit>_tTotal.div(1000), "Too low limit.");
    }
