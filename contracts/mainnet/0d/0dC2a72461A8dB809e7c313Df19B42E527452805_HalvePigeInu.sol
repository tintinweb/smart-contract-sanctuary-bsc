...
contract HalvePigeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PigeInu 0.5";
    string constant _symbol = "HALVEPINU";
    ...
    uint256 public swapThreshold = _totalSupply * 30000000 / 10000000000; // 0.15% of supply
    bool inSwap;
