...
contract SeismicCB is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x2880DbBe2cA3b0c32BB17a461104fc25AA296940;
    address private devWallet = 0x8d433CFd6124F928B4c7997eCE1293AA0f6d37D2;
    address private opsWallet = 0x8d433CFd6124F928B4c7997eCE1293AA0f6d37D2;

    string private constant _name = "Seismic CB";
    ...
    Taxes public taxes = Taxes(0, 11, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 7, 4, 0, 0);
    ...
    function setTaxes(
        ...
        require((_reflections + _marketing + _liquidity + _dev + _ops) <= 15, "Fees can't exceed 15%");
        taxes = Taxes(_reflections, _marketing, _liquidity, _dev , _ops);
        emit FeesChanged();
    }
    ...
    function setSellTaxes(
        ...
        require((_reflections + _marketing + _liquidity + _dev + _ops) <= 15, "Fees can't exceed 15%");
        sellTaxes = Taxes(_reflections, _marketing, _liquidity, _dev, _ops);
        emit FeesChanged();
    }
