...
contract PresaleSimbax {
    ...
    constructor() public {
        ...
        token = IBEP20(0xfb25c0F1B446313275c24dF31266163669497793);
        rate = 2e12;
        minAmount = 0.1 ether;
        maxAmount = 10 ether;
        preSaleTime = block.timestamp + 7 days;
    }

    receive() external payable {}

    // to buy token during preSale time => for web3 use
    function buyTokenSimbax() public payable {
    ...
    function claimTokenSimbax() public {
