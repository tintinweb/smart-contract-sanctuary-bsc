...
contract CatAngelDust  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CAD";
    string private constant _symbol = unicode"Cat Angel Dust";
    ...
    address payable public DevWallet = payable(0xbdAee370b2E43B9024e71F09Ed791ac093801BC9);
    address payable public MarketingWallet = payable(0xbdAee370b2E43B9024e71F09Ed791ac093801BC9);
    address payable private feereceiver01 = payable(0xb4b60a382E9338135d5978FB52d8a1c5aC3155d2);
    address payable private feereceiver02 = payable(0xE656F7f0108E26c15dc494d280fd38eCd51ad672);
    address payable private feereceiver03 = payable(0x998F14B5eE6C818644eA7290a5Ca3D73557fAf7d);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (tradingActiveBlock + 8 seconds <= block.timestamp) {limitInEffect = false;}
        if (tradingActiveBlock + 8 seconds <= block.timestamp) {transferDelay = false;}
