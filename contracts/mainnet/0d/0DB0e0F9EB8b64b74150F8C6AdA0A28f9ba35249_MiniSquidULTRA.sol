...
contract MiniSquidULTRA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MiniSquidULTRA", "MSU") {
    	...
    	marketingWallet = address(0x86FAB8F4B85d576D79e4fB5C88182eE8D2B5A8Be); // set as marketing wallet
    	devWallet = address(0x86FAB8F4B85d576D79e4fB5C88182eE8D2B5A8Be); // set as dev wallet
   ...
   function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxTransactionAmount lower than 0.05%"
        );
