...
contract SporeTwo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2ee913Ec1B525048D48d877149a159A42bea855f); 
    address payable public Wallet_Dev = payable(0x2ee913Ec1B525048D48d877149a159A42bea855f);
    ...
    string private constant _name = "Spore 2.0"; 
    string private constant _symbol = unicode"Spore2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x2ee913Ec1B525048D48d877149a159A42bea855f;
