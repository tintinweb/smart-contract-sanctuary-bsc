...
contract ShibasWife is ShibasWifeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibasWifeTeam;
    address private CharityShibasWife;
    ...
    string public override name = "ShibasWife";
    string public override symbol = "ShibasWife";
    ...
    constructor(uint totalSupplyValue, address ShibasWifeTeamAddress, address CharityShibasWifeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibasWifeTeam = ShibasWifeTeamAddress;
        CharityShibasWife = CharityShibasWifeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibasWifeTeam] =  totalSupply * 4 / 100;
        balances[CharityShibasWife] = totalSupply * 4 / 100;
