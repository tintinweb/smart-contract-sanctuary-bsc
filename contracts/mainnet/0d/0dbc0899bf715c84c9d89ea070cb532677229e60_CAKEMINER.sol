...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RewardToken = BEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // Rewards Token
...
contract CAKEMINER is BEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Cake Miner 2.0";
    ...
    uint256 public _walletMax = 15_000_000 * (10 ** _decimals);
    ...
    address public marketingWallet = 0x1baFD1BC01c62E3721B4B2969380FBCf33FeE06C;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        require(newLiqFee+(newRewardFee)+(newMarketingFee) <=20);
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell) external authorized {
        require(newLiqFeeSell+(newRewardFeeSell)+(newMarketingFeeSell) <=20);
