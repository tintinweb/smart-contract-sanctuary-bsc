...
contract Tokentest {
    ...
    address busd = 0x6c9D481ba4146E3c5e50b893725c3dE4ab19dE16;
    uint256 public constant INVEST_MIN_AMOUNT = 25000000 ether;//10 BUSD minimum deposit 
    uint256[] public REFERRAL_PERCENTS = [100, 50, 30];//10% referal reward
    ...
    constructor(address payable wallet) public {
        ...
        OwnerAddress = wallet;
        plans.push(Plan(30, 10));
        plans.push(Plan(60, 15));
