...
contract LienhuaQionglin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shui Hu Zhuan";
    string private _symbol = "Shuihuzhuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5f47979b79551a9B6B06BA828c36bf200CB1881); 
    address payable public teamWalletAddress = payable(0xFF7481720816b0FA87030cd7263BAAC1426D965A); 
