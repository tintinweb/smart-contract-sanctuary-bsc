...
contract GoldXOfficialToken is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 72580646 * 2**decimals();
    uint256 public maxWalletLimit = 362903231 * 2**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0xc20f08462C87D536EB40910b36adeF0795de7DDa;
    address private devWallet = 0xc20f08462C87D536EB40910b36adeF0795de7DDa;
    ...
    Taxes public sellTaxes = Taxes(3, 2, 5);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("GoldX Official Token", "GoldX") payable {
        _tokengeneration(msg.sender, 7258064617 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        tokenLiquidityThreshold = new_amount * 2**decimals();
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 7258065, "Cannot set max wallet amount lower than 0.1%");
        maxWalletLimit = amount * 2**decimals();
    }    
