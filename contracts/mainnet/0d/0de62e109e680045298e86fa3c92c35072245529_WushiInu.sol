...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1114d1BCdBc2553F0ae8F2960862453C685214C1; // owner address
...
contract WushiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Wushi Inu";
    string private _symbol = "WINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1114d1BCdBc2553F0ae8F2960862453C685214C1); // 
    address payable public teamWalletAddress = payable(0x1114d1BCdBc2553F0ae8F2960862453C685214C1); // 
