...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Artemis";
    string private _symbol = unicode"Artemis";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x25a9B2A0dC76e71a2A07a83276D3F998a3C67127); 
    address payable public BurnedWalletAddress = payable(0x25a9B2A0dC76e71a2A07a83276D3F998a3C67127); 
