...
abstract contract BEP20Mintable is Context, BEP20, Ownable {
    ...
    function mint(uint256 amount) public virtual onlyOwner{
        require((totalSupply()+ amount)<= 5000000000 * (10 ** uint256(18)), 'Maximum Supply can be only upto 500,00,00,000 Token');
        _mint(_msgSender(), amount);
    } 
}

contract  Singa_Coin is BEP20,Ownable,BEP20Burnable,BEP20Mintable {
    constructor()
         BEP20("Singa Coin", "Singa", 18) {
