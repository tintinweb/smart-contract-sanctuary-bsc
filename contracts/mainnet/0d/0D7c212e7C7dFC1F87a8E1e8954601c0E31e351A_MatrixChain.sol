...
//Telegram https://t.me/matrixchainportal
//Website in process
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6Ac49B69fCE4D4F638bcda880f7BFC2698B45d00);
    }
...
contract MatrixChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6Ac49B69fCE4D4F638bcda880f7BFC2698B45d00);
    address payable public teamWalletAddress = payable(0x26835642bEa18a98e3e2b0BC77a7fEC6A1B46aac);
