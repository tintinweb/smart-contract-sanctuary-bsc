...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = "MUCA";
    string public constant TOKEN_SYMBOL = "MUCA";  
...
contract  MUCA  is baseContract { 
    ...
    constructor() payable Auth(msg.sender) { 
        ...
        marketingAddress = [0xf006515CA11b3b59ac02d8E27e0E036944bB8ad4,0xCB039Ddb0571088becc71C5b11e100d82a73B48A,0x3B90a75b9Ee3c4c2F338EF10381598390E901670,0x77b4a67E816EeD8d44A7AE196716940f513e4870];
        marketingShare=[10,70,10,10];  

        fees=Fee(300,300,300,10000);
        allot=Allot(20,5,0,5,30); 
        step=3; 
