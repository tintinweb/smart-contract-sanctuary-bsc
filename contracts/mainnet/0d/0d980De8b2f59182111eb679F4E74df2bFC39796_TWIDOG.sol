...
contract TWIDOG is Context, IBEP20, Ownable {
    ...
    string public _name = "Twidog"; // token name
    string public _symbol = "TWIDOG"; // token ticker
    ...
    uint256 public minTokenToSwap = 10000 * 1e9; // 100k amount will trigger the swap and add liquidity
    ...
    uint256 private burnFeeOnBuying = 1;

    // sell tax fee
    uint256 private reflectionFeeOnSelling = 1;
    uint256 private liquidityFeeOnSelling = 1;
    uint256 private marketWalletFeeOnSelling = 20;
    uint256 private burnFeeOnSelling = 1;
