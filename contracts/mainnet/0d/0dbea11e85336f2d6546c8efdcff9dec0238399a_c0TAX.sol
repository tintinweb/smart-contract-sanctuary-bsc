...
/**
   #c0TAX The New Community of ZERO TAX Token
    
   I make this #cOTAX to hand it over to the community.
   I suggest a Telegram group name for you to create: https://t.me/c0TAX

    **** NO TAX FEE
   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #c0TAX to the community and ensure it's 100% safe.

   Can we make #c0TAX 10000000X ?
*/
...
contract c0TAX is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Zero Tax";
    string private constant _symbol = "c0TAX";
    ...
    address payable public charityAddress = payable(0xfc8E8fAd195C546a22c1235847BdCA46c1145f63);
    ...
    address public charityWallet = 0xfc8E8fAd195C546a22c1235847BdCA46c1145f63;
