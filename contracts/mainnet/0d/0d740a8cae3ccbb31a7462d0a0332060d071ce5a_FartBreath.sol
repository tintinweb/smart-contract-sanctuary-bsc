...
contract FartBreath is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 1e9; // 10 million total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FartBreath"; // token name
    string private _symbol = "FrBr"; // token ticker
    ...
    uint256 public minTokenToSwap = 10 * 1e9; // Amount will trigger the swap and add liquidity
