...
library Address{
 ...
 contract AmazyInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC2aaBD972FB719b8CD585f4484469615a733523B;
    address public donationWallet = 0xC2aaBD972FB719b8CD585f4484469615a733523B;
    string private constant _name = "Amazy Inu";
    string private constant _symbol = "AMAZY";
    ...
    Taxes public taxes = Taxes(1, 4, 1, 2);
    Taxes public sellTaxes = Taxes(1, 4, 1, 2);
