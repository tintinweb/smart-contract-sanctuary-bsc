...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xC34c85a3D7a84212b6234146773f7939a931a8AF);  //TRIBE
    ...
    uint256 public minDistribution = 100 / 10 * (10 ** 18);
...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "Baby Tribe";
    string constant _symbol = "BTRIBEX";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xC34c85a3D7a84212b6234146773f7939a931a8AF; //TRIBE

    uint256 _totalSupply = 50000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 1700000 * (10 ** _decimals);
    uint256 public _walletMax = 1700000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xdF88aACbf069F4298B95183E6901af24615014E5;
        marketingWallet = 0xdF88aACbf069F4298B95183E6901af24615014E5;
        devWallet = 0xdF88aACbf069F4298B95183E6901af24615014E5;
