...
// Telegram: https://t.me/ShinraiFloki
...
contract ShinraiFloki is Context, IERC20 { 
    ...
    string private constant _name = "Shinrai Floki"; 
    string private constant _symbol = "$Shinki"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 500 / 100; 
