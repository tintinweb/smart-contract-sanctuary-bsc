...
contract VendettaFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vendetta Finance";
    string private constant _symbol = "VEN";

    address public _PancakeSwapV1RouterUniswap = 0xB4C9a1E7Aa46b087cDeA30643C1C2dE9463f54E0; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xB4C9a1E7Aa46b087cDeA30643C1C2dE9463f54E0; //can be the same

    uint256 private _tTotal = 111222333 * 10**_decimals;
