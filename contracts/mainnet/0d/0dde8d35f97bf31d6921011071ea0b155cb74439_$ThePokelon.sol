...
contract $ThePokelon is Context, IERC20, Ownable {
    ...
    string private constant _name = "$ThePokelon"; 
    string private constant _symbol = "$ThePokelon"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x75e0Dee7d9dEAe859280bE5E10C609fAF9ac9B97; 
