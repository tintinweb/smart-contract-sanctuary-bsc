...
contract FigitalToken is Context, IERC20, Ownable {
    ...
    address public _charityAddress = _msgSender();    
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = MAX - (MAX % _tTotal);
    uint256 private _tFeeTotal;
    string private _name = "Figital Token";
    string private _symbol = "FIL";
    ...
    uint256 constant public _maxTxAmount = 200000000 * 10**18; // 10%
    uint256 public numTokensSellToAddToLiquidity = 20000000 * 10**18; // 1%
    ...
    function setCharityWalletAddress(address _addr) public onlyOwner {
        _charityAddress = _addr;
    }
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tCharity.mul(currentRate);
        _rOwned[_charityAddress] = _rOwned[_charityAddress].add(rDev);
