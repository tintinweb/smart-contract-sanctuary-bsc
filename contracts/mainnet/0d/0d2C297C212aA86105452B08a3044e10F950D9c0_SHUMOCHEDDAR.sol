...
/**
Chat Lounge: https://t.me/shumocheddarBSC
Website: https://cheddar.shumo.online/
TAX 7%
MAX Wallet 2%
*/
...
/**
ZOORIUM 
Zoorium is designed to offer complete interoperability 
between both the zoorium. Interoperability is not limited
to digital assets as it also includes cross-chain 
interoperability for data sets. Data can be shared
across different types of blockchains, including 
private, permissioned and public chains.
...
contract SHUMOCHEDDAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHUMO CHEDDAR";
    string private _symbol = "SHUMO";
    uint8 private _decimals = 9;

    address payable public treasuryWallet = payable(0xEf39E92cF9B4d9323385b5AdD1df0846BE63A121);
    ...
    uint256 public _TreasuryFeeBuy = 6;
    ...
    uint256 public rewardEndSupply = 100000000000000;
