...
https://t.me/Tashirojimaneko

田代島猫は私たちにとって天国です。この島を宣伝し、
コミュニティと政府と共により美しい楽園を構築することを目的として、
ブロックチェーンを使用します。
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE8e7602A076B2801eD61013e4eB89347Fe9B6300; // owner address
...
contract Tashirojimaneko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Tashirojima Neko ";
    string private _symbol = "TANEKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8e7602A076B2801eD61013e4eB89347Fe9B6300); // 
    address payable public teamWalletAddress = payable(0xE8e7602A076B2801eD61013e4eB89347Fe9B6300); // 
