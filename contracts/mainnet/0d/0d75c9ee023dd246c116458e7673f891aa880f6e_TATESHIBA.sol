...
contract TATESHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TateShiba";
    string private _symbol = "TSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64623AE7ABD0E851799C00cA5A4E338640DdBA1f); 
    address payable public buyBackWalletAddress = payable(0x47e5a4CC28b85A67438625fE6cEabCd93797334d); 
