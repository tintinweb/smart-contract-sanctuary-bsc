...
Telegram: https://t.me/GreenmaceCoin
...
contract Greenmace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreenmaceCoin";
    string constant _symbol = "Greenmace";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300000000 * 1**9 * (10 ** _decimals);
