...
contract Shibaito is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibaito";
    string private _symbol = "SBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x304be1A9CFcCF9F6d9a06A5410C8D9384186352F); // Marketing Address
