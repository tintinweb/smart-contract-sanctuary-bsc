...
contract AnhuiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf8f50C42eC2B0D01863cE35C15a284bc5D8FfD8D); 
    address payable public Wallet_Dev = payable(0xf8f50C42eC2B0D01863cE35C15a284bc5D8FfD8D);
    ...
    string private constant _name = "Anhui Inu"; 
    string private constant _symbol = unicode"ANHUIINU"; 
    ...
    constructor () {
        ...
        _owner = 0xf8f50C42eC2B0D01863cE35C15a284bc5D8FfD8D;
