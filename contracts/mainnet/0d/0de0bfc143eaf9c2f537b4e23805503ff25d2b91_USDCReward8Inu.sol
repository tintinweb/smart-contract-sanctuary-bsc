...
contract USDCReward8Inu is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; //reward setting
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "USDC Reward8% Inu";
    //change the token symbol
    string constant _symbol = "USDC Inu";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x5d260730E17A851b15c9736CeCd1AdB3bAf05126;
