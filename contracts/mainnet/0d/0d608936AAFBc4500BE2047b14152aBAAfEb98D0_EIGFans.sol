...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_oc == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract EIGFans is Context, IERC20, Ownable {
    ...
    string private _name = "Eileen Gu";
    string private _symbol = "EIGFans";
    ...
    address public devAddress = address(0x753c00b9389E4Bf2a7B05B7E7A2bb887bCc3dcF3);
