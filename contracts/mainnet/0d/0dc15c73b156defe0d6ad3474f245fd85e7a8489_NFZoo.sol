...
/*
Hello Everyone, New fans Zoo (NFZ) 🐻‍❄🐨🐯🦁🦊🐶🐭
____
🕸️We will launch the $NFZ token, and set up a staking system for prize holders. We want the $NFZ token to be a utility token so that there is a real use, it will be usable throughout both virtual and real zoo visits.
___
Telegram $NFZ : https://t.me/NewFansZoo
Twitter  $NFZ :  https://twitter.com/newfanszoo
*/
...
contract NFZoo is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "NFZoo";
    string private _symbol = "NFZ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xea211D39977478Ce714A494aa642138eB21682e8);
    address payable public liqWalletAddress = payable(0xea211D39977478Ce714A494aa642138eB21682e8);
