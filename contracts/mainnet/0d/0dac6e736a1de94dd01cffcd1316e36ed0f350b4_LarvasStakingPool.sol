...
// File: LarvasStakingPool.sol
contract LarvasStakingPool is Ownable {
    using SafeMath for uint256;
    ...
    uint constant rewardDuration = 60; 
    uint private calculationFactor = 10**5;
    uint private minimumBalance = 10**5;
    string constant public lockPeriod = '2 Days';  
    uint256 private contractLockPeriod = 172800; 
    address private poolUnusedRewardAddress; 
    uint256 private poolLostRewardTotalAmount; 
