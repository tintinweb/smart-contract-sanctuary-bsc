...
contract FRAG is Authorized, ERC20 {
  address constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address constant ZERO = 0x0000000000000000000000000000000000000000;
  address constant BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
  address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

  string constant _name = "FRAGA";
  string constant _symbol = "FRAG";
  ...
  // Fees
  uint256 public feeDevelopmentWallet = 30; // 0.3%
  uint256 public feeDevelopmentWallet2 = 70; // 0.7%
  ...
  function getFeeTotal() public view returns(uint256) { return feeDevelopmentWallet + feeDevelopmentWallet2; }
  ...
  constructor()ERC20(_name, _symbol) {
    ...
    developingWallet = 0x1757507B8695aA36caa965351F143a63281e3ea7; // FRAGUISMO
    developingWallet2 = 0x1757507B8695aA36caa965351F143a63281e3ea7; //ALTERAR PARA STAKING POOL DEPOIS
  ...
  function exchangeFeeParts(uint256 incomingFeeTokenAmount) private returns (bool){
    ...
    // Deep Stack problem avoid
    {
      ...
      if (feeDevelopmentWallet2 > 0) tokenTransfer(busdAddress, developingWallet2, (busdAmount * feeDevelopmentWallet2) / totalFee);
    }
    return true;
  }
