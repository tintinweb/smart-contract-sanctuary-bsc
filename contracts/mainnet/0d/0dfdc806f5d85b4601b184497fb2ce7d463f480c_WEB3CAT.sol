...
Telegram: https://t.me/WEB3CatBSC
...
contract WEB3CAT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WEB3 Cat";
    string constant _symbol = "WEB3CAT";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 500;
    ...
    uint256 public swapThreshold = _totalSupply * 6 / 50000;
    bool inSwap;
