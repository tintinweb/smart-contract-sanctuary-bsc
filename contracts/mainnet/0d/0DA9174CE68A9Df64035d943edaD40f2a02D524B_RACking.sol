...
contract RACking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RACking";
    string private _symbol = "RACking";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x245fc9dC2406b5A22F1089BEBDdf8Dbd70C1f6a9); 
    address payable private teamWalletAddress = payable(0x245fc9dC2406b5A22F1089BEBDdf8Dbd70C1f6a9); 
