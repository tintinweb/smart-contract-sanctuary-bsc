...
contract SOA is IERC20, Ownable {
    ...
    address private _inviterAddress = address(0x6854248f094E134DEf1095d7dA3F7C5C835a9B9C);
	...
	function _takeInviterFee(
        ...
        for (int256 i = 0; i < 7; i++) {
            ...
            cur = inviter[cur];
            if (cur != address(0) && !_isExcludedFromInviter[cur] && balanceOf(cur) >= 10**18) {
                recieveD = cur;
            }else{
