...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdF530e15D220C812DBAa5D07ba65a852167b8711; // owner address
...
contract Wario is Context, IERC20, Ownable {
    ...
    string private _name = "Wario";
    string private _symbol = "$WO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77ae28157Bf90B3ABC2DB8Fa3E1A9c6D879774d4); // Marketing Address
    address payable public teamWalletAddress = payable(0x77ae28157Bf90B3ABC2DB8Fa3E1A9c6D879774d4); // Team Address
