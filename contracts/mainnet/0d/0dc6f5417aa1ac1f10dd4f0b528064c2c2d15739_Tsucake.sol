...
contract Tsucake is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Tsuka Cake";
    string private constant _symbol = unicode"$Tsucake";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xFA3A8333941F5EBCD738F11c3131170cFB22Ff25);
    address payable public MarketingWallet = payable(0xFA3A8333941F5EBCD738F11c3131170cFB22Ff25);
