...
contract ShibaDogGpt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaDogGpt";
    string private _symbol = "SDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2CF910D290A72416C7ef62A50F3d16BB393dd2fE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2CF910D290A72416C7ef62A50F3d16BB393dd2fE); // BuyBack Address
