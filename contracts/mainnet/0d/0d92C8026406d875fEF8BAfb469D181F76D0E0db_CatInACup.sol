...
$CatCup is the new nanocap, community-driven , meme/degen Token.

ANTI BOT ON
DYOR before buying in!
ANY FUD WILL BE INSTABANNED!

🐱 StealthLaunch
☕ LP LOCKED
🐱 Getting calls, but you also have to shill you own bags until we build up a budget.


Tokenomics

🐱 Marketing 5% so we can maximize exposure as early as possible and keep momentum up in order to hopefully moon!
☕ Donation 4% I'll do a poll so our community can decide where we can donate 4% of our marketing fund.
🐱 Auto Liquidity 4%
...
contract CatInACup is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat In A Cup"; 
    string private constant _symbol = "CatCup"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x8Ae906695238E190d19D9D290d8D6f3467DCd409; 
