...
// WELCOME TO RAMADHAN FAIR TOKEN BSC
...
contract fair is Context, IERC20, Ownable {
    ...
    string private constant _name = "RAMADHAN FAIR"; // 
    string private constant _symbol = "$FAIR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xF2031d7Ca53E9e7e513B64ac5653d7AB94f8A0eB;
