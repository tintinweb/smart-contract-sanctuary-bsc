...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1370 * 10**9;
    uint256 public _maxTxAmount = 1370 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "137"; // 
    string private constant _symbol = "137"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xC944101BfC713D9CF15Bd651098e62a5c29908a8;
