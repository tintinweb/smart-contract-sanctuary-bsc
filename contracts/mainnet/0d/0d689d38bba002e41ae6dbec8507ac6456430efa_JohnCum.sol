...
contract JohnCum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "JohnCum";

    string private _symbol = "JohnCum";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x51cc5A5b124537A3699D154a4724e3cA8d35b5D9;
