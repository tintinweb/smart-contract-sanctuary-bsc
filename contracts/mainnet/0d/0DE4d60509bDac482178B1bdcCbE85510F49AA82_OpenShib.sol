...
Telegram: t.me/OpenShib
Website: OpenShib.io
Twitter: twitter.com/OpenShib
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd33f793a92655d1d036353A36585C03B714b9E45; // owner address
...
contract OpenShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OpenShib";
    string private _symbol = "OShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd33f793a92655d1d036353A36585C03B714b9E45); // Marketing
    address payable public teamWalletAddress = payable(0xd33f793a92655d1d036353A36585C03B714b9E45); // Team
