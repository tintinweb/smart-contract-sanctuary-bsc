...
contract WENGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatGrow";
    string private _symbol = "WENGROW";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x8E19079233b8e5C83c5b4cA98697FD7589425b05); // Team Address
