...
/**
 * Contract: SRG20 Dividend 
 * Developed by: SafeSurge
 * Team: t.me/safesurge
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SAFESURGE = IERC20(0x4ceaCF951294f78bde6B51863aF8fDC03d54728e);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SAFESURGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = SURGE;
        path[1] = address(SAFESURGE);
        ...
        uint256 amount = SAFESURGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SAFESURGE.transfer(shareholder, amount);
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    IERC20 private constant pair = IERC20(SRG); //interace to interact with SRG
   


    uint256 private _srgDecimals = pair.decimals();
    ...
    uint256 public treasuryShare =40;
     uint256 public RewardsShare = 20;
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(SRG);
        distributorAddress = address(SRG);
    ...
    function _buy(
        ...
        bool s = pair.transferFrom(msg.sender, address(this), buyAmount);
    ...
    function _sell(
        ...
        bool successful = isFeeExempt[msg.sender]
            ? pair.transfer(msg.sender, amountSRG)
            : pair.transfer(msg.sender, SRGtoSend);
    ...
    function withdrawTaxBalance() external nonReentrant onlyOwner {
        bool temp1 = pair.transfer(
            teamWallet,
            (taxBalance * teamShare) / SHAREDIVISOR
        );
        bool temp2 = pair.transfer(
            treasuryWallet,
    ...
    function addLiquidity(uint256 amountSRGLiq) external onlyOwner {
        ...
        bool sLiq = pair.transfer(address(this), amountSRGLiq);
