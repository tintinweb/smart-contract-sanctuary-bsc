...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "love";       //Full name
    string public symbol_ = "love";      //abbreviation
    ...
    uint256 public lpRewardFee = 30;       //Add LP dividends
    ...
    constructor(
        ...
        uint256 totalSupply = 100000 * (10**18);       //Supply
        ...
        marketingWalletAddress = 0x592A1C662e1b182BC3a38D999496f5768Bb9dca0;    //Marketing address
        ...
        excludeFromFees(0x46b0Cc7118d3fc2fC2c68EBA97562eC8bAe904A5, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0x46b0Cc7118d3fc2fC2c68EBA97562eC8bAe904A5, totalSupply);
    }
