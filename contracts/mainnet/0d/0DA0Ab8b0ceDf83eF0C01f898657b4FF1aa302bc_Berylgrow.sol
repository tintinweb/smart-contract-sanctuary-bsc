...
contract Berylgrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beryl grow";
    string private _symbol = "BRBGROW";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x107eAaF55C4dc339949F30a1125db59168762005);
