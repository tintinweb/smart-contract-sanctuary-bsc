...
ZEROX
@ZeroX_Social
Write-to-Earn protocol which brings a new way of earning crypto for writers and readers.
zerox.social
✍️💴 Write-to-Earn protocol which brings a new way of earning crypto for writers and readers. 
💴✍️ 🚀Tell your story about crypto, react, comment or just share stories via ZeroX 
and earn $ZEROX. 🚀 ✅Audited by InterFi ✅Low tax (5-5),
 limited by contract ✅Staking APY up to 1000% ✅CEX listing ✅CMC&CG Fast track 
 ✅Marketing campaign on Twitter, Telegram and Hackernoon
 https://t.me/zerox_social
...
contract ZEROX is ZEROXDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ZEROXTeam;
    address private CharityZEROX;
    ...
    string public override name = "ZeroX";
    string public override symbol = "ZEROX";
    ...
    constructor(uint totalSupplyValue, address ZEROXTeamAddress, address CharityZEROXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ZEROXTeam = ZEROXTeamAddress;
        CharityZEROX = CharityZEROXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ZEROXTeam] =  totalSupply * 4 / 100;
        balances[CharityZEROX] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ZEROXTeam pot
