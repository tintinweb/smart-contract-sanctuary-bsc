...
/* 
⚡️ Loga Verse Fan Token ⚡️
🏆Loga Verse ARMY BSC🏆
🏆Loga Verse Fan Token NFT🏆
Are u ready for LGV2  launch?🤯🤠
#logaverse nfts coming soon be ready #bsc 

#bnb #ETH #Qatar2022 #Messi𓃵 #Binance
https://t.me/LogaverseV2

Join the #VerseARMY.
🏰TG Group🏰https://t.me/LogaverseV2
🏰Website 🏰https://logavers.com/
🏰Twitter 🏰https://twitter.com/LogaverseBsc
...
🚀LOW MC TAX Gem
🛡️Safe team
⚡️ CA VERIFIED & RENOUNCED
⚡️ 100% SAFU DEV

TOKENOMICS :
💠 Supply - 10 Q
💠 0 TAX % Keep What you buy
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.9;

abstract contract ContextVerse {
...
contract OwnableVerse is ContextVerse {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableVerse: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableVerse: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract LogaVerseMeme is ContextVerse, USDTBEP20, OwnableVerse {
    ...
    string private _name = 'LogaVerse';
    string private _symbol = '$LGV2';
