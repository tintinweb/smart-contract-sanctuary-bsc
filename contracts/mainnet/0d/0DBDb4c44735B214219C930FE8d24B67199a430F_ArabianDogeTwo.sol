...
//Telegram : https://t.me/ArabianDogeTwo
...
contract ArabianDogeTwo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc0B0EFC1B10A8d6d3eCeeA75615437fe7993f59d); 
    address payable public Wallet_Dev = payable(0xc0B0EFC1B10A8d6d3eCeeA75615437fe7993f59d);
    ...
    string private constant _name = "ArabianDoge2.0"; 
    string private constant _symbol = unicode"$Arbige"; 
    ...
    constructor () {
        ...
        _owner = 0xc0B0EFC1B10A8d6d3eCeeA75615437fe7993f59d;
