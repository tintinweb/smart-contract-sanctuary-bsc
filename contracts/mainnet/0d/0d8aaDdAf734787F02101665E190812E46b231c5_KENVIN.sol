...
contract KENVIN is ERC20, Ownable {
   
    constructor() public ERC20("GGOGO", "GGOGO") {
    ...
    function _transfer(
        ...
        require(!blueAnti.getPair(from),"ERC20: This is zero address");
