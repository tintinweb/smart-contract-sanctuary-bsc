...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x892bC5887473564e8e04b22414aD983A58EA2aDC;
...
contract PRINT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2D79d9133A03Be123912B6F694edCb7062f39183;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PRINT";
    string private _symbol = "PRNT";
