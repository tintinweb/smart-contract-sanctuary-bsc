...
contract AGToken is Context, IERC20, Ownable {
    ...
    uint256 public startTime = 1661947200; // 2022-08-31 20:00:00
    mapping (address => UserIDO) public userTokenIDO;
    ...
    address public  oldToNewAddr; 
    address public  _devWallet =  0x5D1747d3D37329CCA8196C1f32429bEcF870DF98; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!takeFee)
          ...
          UserIDO storage user = userTokenIDO[sender];
            uint256 countDay;
    ...
    function setUser(address _user,uint256 _amount) public {
        require(msg.sender == oldToNewAddr, "ERC20: Address already attended"); 
         UserIDO storage user = userTokenIDO[_user];
         user.ISIDO= true;
