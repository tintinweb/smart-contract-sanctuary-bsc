...
contract PegInu is Context, IERC20, Ownable {
    ...
    string private _name = "PegInu";
    string private _symbol = "PEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4D7B5457014366E5ED6e77Ebf95c1795FC9A5b68); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x84f165e09cdf13E71e088e5E38C890BCD325BbE7); // BuyBack Address
