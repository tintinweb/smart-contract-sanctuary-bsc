...
contract MagicaCoin{
     ...
     */
    function _presale(address account, uint256 amount) internal {
        require(account != address(0), "ERC20: presale to the zero address");
