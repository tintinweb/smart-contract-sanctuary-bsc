...
contract FOMOTWO is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FOMO 2.0"; // 
    string constant _symbol = "FM2"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (200) * (4); 
    uint256 public _maxSellTxAmount = _totalSupply / (200) * (4); 
    uint256 public _maxWalletToken = _totalSupply / (200) * (4); 

    address private autoLiquidityReceiver = 0xD659A186d234EAbeB92004765c030dC4180BD6DC; 
    address private marketingFeeReceiver = 0xD659A186d234EAbeB92004765c030dC4180BD6DC; 
    address private devFeeReceiver = 0xD659A186d234EAbeB92004765c030dC4180BD6DC; 
    address private teamFeeReceiver = 0xD659A186d234EAbeB92004765c030dC4180BD6DC; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xD659A186d234EAbeB92004765c030dC4180BD6DC;
