...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe73A9c6F40959CFa23bC76a750e69401B1C3f0f2; 
...
contract CandorCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x50cdBe9f5a01483B7646665186aD02710b6897bA; 
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 80000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CandorCoin";
    ...
    /*
    TOKENOMICS for CandorCoin $CAN
    TOTAL COINS: 80 000 000 000 (BILLION)
    MARKETING AND DEVELOPMENT: 4 + 2%
    LIQUIDITY POOL: 3%
    REWARDS BACK TO HOLDERS: 5% in $CAN
    */
