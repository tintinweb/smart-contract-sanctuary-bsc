...
contract ApolloMiner {
    ...
    uint256[] public REFERRAL_PERCENTS_BUY = [2, 2, 1, 2, 2]; 
    uint256[] public REFERRAL_PERCENTS_SELL = [0, 0, 0, 1, 1]; 
...
struct User {
    ...
    function reinvest() public {
        ...
        uint256 bonus = (getMyTokens(msg.sender) / 100) * 2; // bonus
    ...
    function devFee2(uint256 amount) public pure returns (uint256) { //Delevoper and Partners
