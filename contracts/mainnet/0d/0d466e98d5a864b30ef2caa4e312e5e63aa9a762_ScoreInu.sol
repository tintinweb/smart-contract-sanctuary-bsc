...
contract ScoreInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Score Inu";
    ...
    uint256 private _totalSupply = 653000000 * 10**_decimals;
    uint256 public _maxTxAmount = 6530000 * 10**_decimals; 
    uint256 public _walletMax = 6530000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 653000 * 10**_decimals; 
