...
contract PoodleInu is ERC20, Ownable {
    ...
    PICTOKENDividendTracker public dividendTracker;
    ...
    uint256 public swapTokensAtAmount = 25 * 10**3 * (10**18); //25000 tokens
    ...
    address public marketingWallet = address(0x7F06bdfbcD813EDF1F03818B51f4734c76FD440A);
    address public buybackWallet = address(0xa63854A7d1f2723749Aca0D1d1a2991013De5f54);
    ...
    constructor() ERC20("Poodle Inu", "PIC") {
        dividendTracker = new PICTOKENDividendTracker(RewardToken);
    ...
    function updateRewardToken(address newToken) public onlyOwner {
        PICTOKENDividendTracker newDividendTracker = new PICTOKENDividendTracker(
            newToken
        );
    ...
    function claimOldDividend(address tracker) external {
        PICTOKENDividendTracker oldTracker = PICTOKENDividendTracker(tracker);
...
contract PICTOKENDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(address rewardToken)
        DividendPayingToken(
            "PICTOKEN_Dividen_Tracker",
            "PICTOKEN_Dividend_Tracker",
            rewardToken
        )
    {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "PICTOKEN_Dividend_Tracker: claimWait must be updated to between 8 and 24 hours"
        );
