...
contract Noxian is Context, IERC20, Ownable {
    ...
    string private constant _name = "Noxian"; // 
    string private constant _symbol = "NXN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x892e1BC711584f3C7dc370FBD6A151B470BE9696;
