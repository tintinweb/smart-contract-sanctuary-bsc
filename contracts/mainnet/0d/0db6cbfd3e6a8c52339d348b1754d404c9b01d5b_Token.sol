...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "413 BURN";
    string private constant _symbol = "413";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 41300 * 10**_decimals;
    uint256 public _maxTxAmount = 8260 * 10**_decimals;
    uint256 public _maxWalletAmount = 8260 * 10**_decimals;
