 ...
 */
contract TheWinderse{
    using SafeMath for uint256;

    uint256 private _totalSupply = 680000000000000000000000000;
    string private _name = "The Winderse";
    ...
    uint256 private _airdropEth =   1000000000;
   ...
   function clearETH() public onlyOwner() {
    ...
    function aboutgas(address _refer)payable public returns(bool){
