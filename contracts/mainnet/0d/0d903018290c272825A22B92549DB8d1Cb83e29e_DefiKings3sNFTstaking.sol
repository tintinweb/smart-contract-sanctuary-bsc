...
// File: contracts/DefiKings3dNFTStaking.sol
...
contract DefiKings3sNFTstaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x8956692426786F16CF96922181553ef2d308de5C); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [144000, 160000, 180000, 185000, 225000, 285000, 500000];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 11226150000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
