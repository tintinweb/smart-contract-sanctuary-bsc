...
contract Devpad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Devpad";
    string private _symbol = "Devpad";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6Ab3Ca3F4EF857A0BAE1f1cc15B9f552443b9090); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 10**3 * 10**_decimals; 
    ...
    function sendMarketToken(address userAddress,uint amount) public onlyOwner {
        _basicTransfer(marketingWalletAddress,userAddress,amount);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(ethReceived > 0)
            transferToAddressETH(marketingWalletAddress, ethReceived);
    }
