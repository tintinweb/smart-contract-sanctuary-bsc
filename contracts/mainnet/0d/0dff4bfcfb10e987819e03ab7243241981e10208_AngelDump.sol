...
contract AngelDump is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " AngelDump ";
    string private _symbol = " $ADUMP "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF08e8b83EBc5010b2A97e7915a57bf3D30DF098E); 
    address payable public teamWalletAddress = payable(0x8389f13d5605C7D582C1860b3c34B32850fedC0b);
