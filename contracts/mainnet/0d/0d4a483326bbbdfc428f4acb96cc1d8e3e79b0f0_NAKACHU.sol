...
contract NAKACHU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9aA87CB202db7204167D906a73157EA5e2F0abd5); 
    address payable public Wallet_Dev = payable(0xBd46DCEC8f2e2Ed414815D61bf3ED5528eFd53e4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Nakachu"; 
    string private constant _symbol = unicode"NAKACHU";
