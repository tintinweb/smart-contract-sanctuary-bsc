...
library Address{
 ...
 contract AndroMeta is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5b726207c24932304998d81310614d92f1e32cb3;
    address public donationWallet = 0x5b726207c24932304998d81310614d92f1e32cb3;

    string private constant _name = "AndroMeta";
    string private constant _symbol = "ADMT";
    ...
    Taxes public sellTaxes = Taxes(3, 4, 3, 2);
