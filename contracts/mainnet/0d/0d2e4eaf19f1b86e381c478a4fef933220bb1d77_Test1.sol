...
contract Test1 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x705DEA28FC835769aA15B6B46D64f98bDeECd5d3);
    address payable public TeamWalletAddress = payable(0x705DEA28FC835769aA15B6B46D64f98bDeECd5d3);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {		
        ...
        else
        {
            if(sender == uniswapPair) {
                require(amount <= _maxBuyTxAmount || isTxLimitExempt[recipient], "Transfer amount exceeds the maxBuyTxAmount.");
            } 

            if(recipient == uniswapPair) {
                require(amount <= _maxSellTxAmount || isTxLimitExempt[sender], "Transfer amount exceeds the maxSellTxAmount.");
            }          
