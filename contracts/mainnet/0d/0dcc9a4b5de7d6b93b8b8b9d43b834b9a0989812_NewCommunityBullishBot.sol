...
// Telegram : https://t.me/NewCommunityBullishBot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3BCDb9C0FD05612B265B0be65dCF41d6E63AC470; // owner address
...
contract NewCommunityBullishBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Bullish Bot";
    string private _symbol = "NewCommunityBB";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3BCDb9C0FD05612B265B0be65dCF41d6E63AC470); // Marketing Address
    address payable public teamWalletAddress = payable(0x3BCDb9C0FD05612B265B0be65dCF41d6E63AC470); // Team Address
