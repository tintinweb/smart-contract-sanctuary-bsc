...
✨🐶💜🧬 #SHIBARIUM
PROJECT
The youngest of a respected Shiba Inu family, determined to prove herself. Now a friendly, accessible meme token for all holders. 
Proving age is just a number. $SHIMEKA INU TOKEN 
*/
...
contract ShimekaInu  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Shimeka Inu';
    string private _symbol = 'SHIMEKA';
