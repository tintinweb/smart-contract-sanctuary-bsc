...
contract GrowGold is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0xbA55fd4C0B02edb19eb0061A41f4b2F617aEB01E);
        teamWallet= payable(0xbA55fd4C0B02edb19eb0061A41f4b2F617aEB01E);
        ...
        _maxOnceEat = 90000000 * 10**_decimals;
        _maxTotalEat = 90000000 * 10**_decimals;
