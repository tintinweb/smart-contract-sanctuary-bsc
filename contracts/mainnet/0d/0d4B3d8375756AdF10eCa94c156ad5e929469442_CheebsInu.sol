...
/*
    ...
    The CheebsINU- Stealth Launch
    Driving by ShibARMY team ( Last project was 4.3 million mcap )
    Welcome To
    The CheebsINU
    CheebsINU is a new era of crypto for Investment, Safety, Games & Entertainment!
    Cheebs #Gaming
    CheebsInu is not only a utility focused token with a purpose but also is here to ensure its holders are engaged and rewarded.
    Our initial game will be focused on the community’s competitive side, by implementing a leaderboard which will coincide with weekly giveaways and rewards.
    Cheebs #Plus
    CheebInuPlus covers a wide range of products from ”Tale of Cheebs” all the way to our unique in house NFChee‘s.
    We will provide not only weekly to monthly entertainment to keep our community content and flourishing, but also deliver unique merchandise with a purpose.
    Cheebs #Sure
    CheebInuSure is a platform for all investors inside of crypto, this platform provides a peace of mind in any investment you may look to go into.
    We not only verify statements and promises projects make but also provide a rating and stamp on each project that goes through the platform.
    🌍Web ; https://Cheebsinu.com
    🔎Telegram ; https://t.me/Cheebsinu
    🕊Twitter: https://www.twitter.com/Cheebsinu
    🖼️ Instagram : https://instagram.com/Cheebsinu
    🎮 Discord : https://discord.gg/Y68HVSHQzW
...
contract CheebsInu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Cheebs INU";
    string private constant _symbol   = "CHEEBS";
...
subtractedValue) public virtual returns (bool) {
    ...
    //Remove from sniperBot
        function removeFromSniperBot(address account) external {
            require(owner() == _msgSender(), "Ownable: caller is not the owner");
            _isSniperBot[account] = false;
    }

    //adding multiple addresses to the sniperBot
    function sniperBot(address[] calldata addresses) external {
        require(owner() == _msgSender(), "Ownable: caller is not the owner");
