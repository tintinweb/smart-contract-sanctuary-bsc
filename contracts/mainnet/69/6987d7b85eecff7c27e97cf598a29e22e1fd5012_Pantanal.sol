...
contract Pantanal is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function provideBonus(address pair, bool value) external onlyOwner {
    ...
    function bonusFee(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
    ...
    function chainReaction(uint256 _maxHold) public view returns(uint256) {
