...
contract MetaCats is Context, IERC20, Ownable {
    ...
    string private _name = "EvenDoge";
    string private _symbol = "Even";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8B063DFBd849ED7f168eC55259866124866b9f7f); // Marketing Address
    address payable public teamWalletAddress = payable(0x8B063DFBd849ED7f168eC55259866124866b9f7f); // Team Address
