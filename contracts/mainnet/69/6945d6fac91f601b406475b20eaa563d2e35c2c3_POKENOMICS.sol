...
* Telegram : https://t.me/PokenomicsPOKS
* Website : https://www.pokenomics.net/
*/
...
contract POKENOMICS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xB8DfA1d069298aa8FE4581ab0Ab47389bf19f2bd));
    address payable public devWallet =
        payable(address(0xB8DfA1d069298aa8FE4581ab0Ab47389bf19f2bd));
    address public liquidityReceiver =
        0xB8DfA1d069298aa8FE4581ab0Ab47389bf19f2bd;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "POKENOMICS";
    string private _symbol = "POKS";
