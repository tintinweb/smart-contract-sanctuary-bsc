...
contract WaterToken is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function setBuyTax(uint16 _buyTax) public onlyOwner {
        buyTax = _buyTax;
    }

    function setSellTax(uint16 _sellTax) public onlyOwner {
        sellTax = _sellTax;
    }
    ...
    function setWhitelist(address user, bool isWhitelist) public onlyOwner {
    ...
    function setAutomatedMarketMakerPairs(address user, bool isMarketPairs) public onlyOwner {
        automatedMarketMakerPairs[user] = isMarketPairs;
    }
    ...
    function _transfer(
        ...
        if (whitelist[from] == false && whitelist[to] == false) {
            ...
            if (automatedMarketMakerPairs[from] && buyTax != 0) {
                ...
                require (amount == taxAmount.add(sendAmount), "invalid Tax Amount");
                super._transfer(from, devWallet, taxAmount);
