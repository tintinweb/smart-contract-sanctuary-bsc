...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFE48Dce2067dd7c5027EC3FF5a4fA0b4c7d248CE; 
...
contract SHIBJI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBJI Inu";
    string private _symbol = "SHIBJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFE48Dce2067dd7c5027EC3FF5a4fA0b4c7d248CE); // Marketing Address
    address payable public teamWalletAddress = payable(0xFE48Dce2067dd7c5027EC3FF5a4fA0b4c7d248CE); // Team Address
