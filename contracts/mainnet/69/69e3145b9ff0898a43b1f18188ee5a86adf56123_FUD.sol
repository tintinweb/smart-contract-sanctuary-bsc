...
contract FUD is Context, IERC20, Ownable {
    ...
    string private _name = "FUD TOKEN";
    string private _symbol = "FUD";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xDE778f61906ad5a223a8F1Cd89168970aAd5Dd51); 
    address payable public teamWalletAddress = payable(0xDE778f61906ad5a223a8F1Cd89168970aAd5Dd51); 
