...
Initial sell tax 35 percent for 10 minutes to discourage bots
https://t.me/+SyBobaH7Ev8zOTRh
*/
...
contract KingDragonInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "King Dragon Inu";    
    string constant _symbol = "$KDI";
    ...
    uint256 public sT = _totalSupply * 92 / 100000;
