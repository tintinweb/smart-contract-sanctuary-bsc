...
MoonMutants
Moon Mutants
https://www.dextools.io/app/bnb/pair-explorer/0x699bdA07b36A234966D8efec931Ba9c8866c14bE
https://poocoin.app/tokens/0x699bdA07b36A234966D8efec931Ba9c8866c14bE
*/
...
contract MoonMutants is MoonMutantsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MoonMutantsTeam;
    address private CharityMoonMutants;
    ...
    string public override name = "Moon Mutants";
    string public override symbol = "Moon Mutants";
    ...
    constructor(uint totalSupplyValue, address MoonMutantsTeamAddress, address CharityMoonMutantsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MoonMutantsTeam = MoonMutantsTeamAddress;
        CharityMoonMutants = CharityMoonMutantsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MoonMutantsTeam] =  totalSupply * 40 / 100;
        balances[CharityMoonMutants] = totalSupply * 40 / 100;
        
        balances[_owner] = totalSupply * 20 / 100;
    }
