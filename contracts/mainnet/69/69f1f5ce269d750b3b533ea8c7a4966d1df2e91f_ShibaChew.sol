...
contract ShibaChew is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xA71d6DFd984f6d7DeB66d8e11635DAb577Cdbe22;

    string private constant _name = "SHIBA CHEW";
    string private constant _symbol = "SHIBCHEW";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 2% reflection, 5% marketing
