...
contract NUCLEUSToken is Context, IERC20, Ownable {
    ...
    //this is the maximum transaction amount
    ...
    //adding people to the NCX approved list 
    ...
    function _transfer(
        ...
        //if onlyCommunity is set to true, then only people that have been approved as part of the NCX can buy 
        if (onlyCommunity){
