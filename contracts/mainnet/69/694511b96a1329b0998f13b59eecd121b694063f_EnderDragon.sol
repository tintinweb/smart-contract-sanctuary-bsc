...
contract EnderDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ender Dragon";
    string private _symbol = "Ender Dragon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56Df25ae9eE6aBAB6BeC72936538046FAE929777); 
    address payable public DevelopmentWalletAddress = payable(0xE6A7D4A49a587e86F87B0043f6E7Cc747c177d3d); 
