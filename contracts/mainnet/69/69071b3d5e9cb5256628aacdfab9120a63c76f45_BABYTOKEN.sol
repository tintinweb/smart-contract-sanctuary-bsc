...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xCF4CBf717798C65e643117a13Ef9E5e392aF86F2;//
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"test888",//Name
        unicode"test888",//Symbol
        9,//Decimals
        888,//Supply
        address(0x0000000000F5A3cdd25f02A305eC348e6B518fFf),//FundAddress
        address(0x0000000000F5A3cdd25f02A305eC348e6B518fFf)//ReceiveAddress
    ){
    }
}