...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD904c0CCd52762aBe3342d61CCca319bEB425F1f; // owner address
...
contract Itaewon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Itaewon";
    string private _symbol = "Itaewon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD904c0CCd52762aBe3342d61CCca319bEB425F1f); 
    address payable public teamWalletAddress = payable(0xD904c0CCd52762aBe3342d61CCca319bEB425F1f); 
