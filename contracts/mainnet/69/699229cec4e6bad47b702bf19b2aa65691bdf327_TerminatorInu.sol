...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a8D1548a8e85c166865089969cdC8e137Afe1dD; // owner address
...
contract TerminatorInu is Context, IERC20, Ownable {
    ...
    string private _name = "Terminator Inu";
    string private _symbol = "TMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a8D1548a8e85c166865089969cdC8e137Afe1dD); // Marketing Address
    address payable public teamWalletAddress = payable(0x9a8D1548a8e85c166865089969cdC8e137Afe1dD); // Team Address
