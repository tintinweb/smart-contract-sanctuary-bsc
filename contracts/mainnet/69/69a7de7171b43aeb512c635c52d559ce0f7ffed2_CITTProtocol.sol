...
contract CITTProtocol is Ownable, IERC20Metadata {

    using SafeMath for uint256;
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public constant MAX_UINT256 = type(uint256).max;
    uint256 private constant MAX_SUPPLY = 333333 * 1e18;
    ...
    string private _name = "XBT Protocol";
    ...
    uint256 private _maxDeals = 100 * 10 ** _decimals;
