...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTC
...
contract TEST123 is ERC20, Ownable {
    ...
    constructor() ERC20("TEST123", "TEST1") {
    ...
    function enableTrading(uint256 deadBlocks, uint256 _blocksUntilMaxTxnIncrease, uint256 _gasPriceLimit) external onlyOwner {
        require(!tradingActive, "Cannot reenable trading");
        require(deadBlocks <= 50, "Cannot set more than 50 deadblocks");
        tradingActive = true;
        swapEnabled = true;
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if (maxTransactionAmount < totalSupply() * 5 / 1000 && block.number >= maxTxnIncreaseBlock){
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForTeam - ethForRewards;
