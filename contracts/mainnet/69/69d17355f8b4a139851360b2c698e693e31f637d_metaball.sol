...
contract metaball is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MarketingKing";
    string private _symbol = "MarketingKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1760F27e18275Adf4Ce58ecC819d7DDF7862Ce93);
    address payable public teamWalletAddress = payable(0x59092172027d6aCbB08dc02c42c098c011D6A1b9);
