...
//  telegram : https://t.me/lovelyinugrow
...
contract LOVIG is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 90_000_000 * 10**9;
    uint256 public maxSellLimit = 50_000_000 * 10**9;
    uint256 public maxWalletLimit = 2_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public Lovig_Marketing = 0xB4D429E8B15e993D4cBeCC9cE38Ec897b05798D0;
    address public Lovig_Team = 0xB4D429E8B15e993D4cBeCC9cE38Ec897b05798D0;


    string private constant _name = "Lovely Inu Grow";
    string private constant _symbol = "LOVIG";
    ...
    Taxes public sellTaxes = Taxes(0,9,0,2);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Lovig_Marketing] = true;
        _isExcludedFromFee[Lovig_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Lovig_Marketing] = true;
        allowedTransfer[Lovig_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Lovig_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Lovig_Team).sendValue(teamAmt);
        }
    }
    ...
    function Lovig_MpdateMarWallet(address newWallet) external onlyOwner{
        Lovig_Marketing = newWallet;
    }
    
    function updateLovig_Team(address newWallet) external onlyOwner{
        Lovig_Team = newWallet;
    }
