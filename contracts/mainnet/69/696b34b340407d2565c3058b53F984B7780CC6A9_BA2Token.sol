...
contract BA2Token is IERC20, Ownable {
    ...
    address private DK = 0x641EC142E67ab213539815f67e4276975c2f8D50;
    address private projectAddress = 0x23bEad8f7f3433ee0df66983dFBa17aE5DB0eEf0;
    ...
    uint256 private _tTotal = 14.13 * 10**8 * 10**9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 12 * 10**8 * 10**9)_burnFee = 0;
    ...
    function swapEthForToken(uint256 ethAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 TestE = IERC20(0x641EC142E67ab213539815f67e4276975c2f8D50);//DK代币地址--
    ...
    function swapThisTokenForToken(uint256 thisTokenAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 DK1 = IERC20(0x641EC142E67ab213539815f67e4276975c2f8D50);//DK代币地址--
        path[0] = address(this);//本币地址
        path[1] = address(DK1);//代币地址
