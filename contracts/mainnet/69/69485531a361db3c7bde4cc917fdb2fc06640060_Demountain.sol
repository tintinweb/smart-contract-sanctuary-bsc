...
contract Demountain is ERC20, Ownable {
    ...
    address payable public paramountMarketAndBuyBack =
        payable(0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7); // 4%
    ...
    address payable public paramountTeamAddr3 =
        payable(0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7); // 0.5%
    address payable public paramountTeamAddr4 =
        payable(0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7); // 0.5%
    address payable public paramountTeamAddr5 =
        payable(0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7); // 0.4%
    ...
    function _sendDevShare() internal nonReentrant {
        ...
        paramountTeamAddr3.transfer(lobbyEntry[currentDay - 1] * 5 / 1000);
        paramountTeamAddr4.transfer(lobbyEntry[currentDay - 1] * 5 / 1000);
