...
/*
Welcome to Safe Moon 2.0

SafeMoon2.0’s mission is to bring new cryptocurrency concepts to mainstream investors. Unlike older, comparable projects, SafeMoon2.0 introduces holders to next-generation concepts such as Staking & Farming, NFTs with utility and rewards and more
...
contract Safemoon20 is Context, IBEP20, Ownable {
    ...
    string private _name = "SafeMoon2.0";
    string private _symbol = "SMF2";
