...
contract ArabMoney is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ArabMoney";
    string constant _symbol = "ARM";
    ...
    uint256 public totalFee = 8; //Total Fee
