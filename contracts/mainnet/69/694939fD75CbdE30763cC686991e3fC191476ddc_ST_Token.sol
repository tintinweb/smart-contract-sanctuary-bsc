...
contract ST_Token is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "ST_token";       //Full name
    string public symbol_ = "ST";      //abbreviation
    ...
    uint256 public maxburn = 1000000 * (10**18); //max burn
    ...
    constructor(
        ...
        uint256 totalSupply = 1000000 * (10**18);       //Supply
