...
contract MXMGAME is Ownable {
  ...
  address public warrior;//战士
  address public Archer;//弓箭手
  address public master;//法师
  ...
  mapping(uint256=>address)public tokens;
    ...
    function buyNFT(uint256 _mxm)public{
      uint256 value=getMXM(100 ether);
    ...
    function getIsNFT(address addr)public view returns(uint256,uint256,uint256,uint256,uint256){
