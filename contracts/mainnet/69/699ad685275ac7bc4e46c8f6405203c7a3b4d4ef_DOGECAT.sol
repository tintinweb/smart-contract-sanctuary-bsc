...
contract DOGECAT is IERC20 {
    ...
    string constant private _name = "DOGECAT";
    string constant private _symbol = "DC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x547F342072E6153f07ADF433D7F5F3D0A6FC8C37),
        charity: payable(0x8916a8c12A2E5EBF0DEc337600efc49b3B821B55),
        development: payable(0x13f232D9052B1c65c2721429FB7a43852fd3734A)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 charity, uint16 development, uint16 buyback) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.development = development;
        _ratios.buyback = buyback;
        _ratios.totalSwap = liquidity + marketing + charity + development + buyback;
    ...
    function setWallets(address payable marketing, address payable charity, address payable development) external onlyOwner {
        require(marketing != address(0) && charity != address(0) && development != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (developmentBalance + buybackBalance + charityBalance);
