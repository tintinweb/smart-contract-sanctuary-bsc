...
contract AFINA is ERC20, Ownable {
   ...
   function setMarketingWallet(address payable _newMarketingWallet) public onlyOwner {
    ...
    constructor() ERC20("TET BSC", "TET") {
        BNBRewardsFee = 1;
        liquidityFee = 3;
        marketingFee = 3;
        DAOFee = 3;

        marketingWallet = payable(0x300865e92c9c0E533E164d7BA5c3F28D8A20D34d);
        DAOWallet = payable(0x870c7126bE16b2F990d9D443b51C69f1d9085172);
