...
contract ThreeOneFour is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xb0093F77119d7c026057b3aC7F4677E5Cb4A8Bfe);
    address payable public Wallet_Dev =
        payable(0xa597973AC19FeBe30D239FCfb03CcA32B0347a3c);
    address payable public constant Wallet_Burn =
        payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 3140**1 * 10**_decimals;
    string private constant _name = "314";
    string private constant _symbol = unicode"314";
    ...
    constructor() {
        _owner = 0x6681C704D95c1Aacde86F090Ae2a3394a1A2bA0a;
