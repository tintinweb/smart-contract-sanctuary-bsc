...
Telegram : https://t.me/DogeElizabeth
...
contract DogeElizabeth is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE85C0C1C48C099297f57318543f5DAEb0141e895); 
    address payable public Wallet_Dev = payable(0xE85C0C1C48C099297f57318543f5DAEb0141e895);
    ...
    string private constant _name = "Doge Elizabeth"; 
    string private constant _symbol = unicode"Dogebeth"; 
    ...
    uint256 public FeeforLiquidity = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public FeeforBurning = 0;             
    ...
    constructor () {
        ...
        _owner = 0xE85C0C1C48C099297f57318543f5DAEb0141e895;
   ...
   function setNoMaxTransaction() public returns (bool) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * FeeforBurning / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * FeeforLiquidity / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (FeeforLiquidity + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (FeeforLiquidity + Percent_Marketing + Percent_Dev);
