...
contract WorldCup is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 66666 * 10**_decimals;
    uint256 public _maxTxAmount = 66666 * 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4d032a1479Aebb66bdB3eC9C6393f868A69B47CA));
        marketingWalletAddress = payable(address(0xF5F8A8A89EE96032Db9c71316Ac67481b5764ac9));
