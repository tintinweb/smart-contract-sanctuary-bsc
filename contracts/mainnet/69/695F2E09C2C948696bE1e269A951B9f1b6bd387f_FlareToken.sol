...
contract FlareToken is IERC20, Ownable {
    ...
    uint256 amountMarkingRewardFee;
    ...
    function _transfer(
        ...
        if(canSwap &&
            ...
            if(amountMarkingRewardFee >= swapTokensAtAmount){
                swapTokensForUSDT(amountMarkingRewardFee, markingWallet);
                amountMarkingRewardFee = 0;
            }
            swapping = false;
        }
    ...
    function _takeMarkingFee(
        ...
        _tOwned[address(this)] = _tOwned[address(this)].add(tAmount);
        amountMarkingRewardFee += tAmount;
        emit Transfer(sender, address(this), tAmount);
    }
    ...
    function setDigList(address account, bool _state) public onlyOwner {
        _digList[account] = _state;
    }

    function setDividendExempt(address account, bool _state) public onlyOwner {
    ...
    function withdrawBNB(address addr, uint256 amount) public onlyOwner {
