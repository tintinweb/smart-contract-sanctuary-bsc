...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9e75e844398B94B7d073c786c7F8d2552101960;
...
contract AlanMusk is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1D5699Ba7e3ac20950ffc8F8305603ab126443eF;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Alan Musk";
    string private _symbol = "ALAN";
