...
contract HuskyDoge is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "Husky Doge";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[burnaddress] += feeAmount;
    ...
    function setliquidityPair(address liquiditypair) public onlyOwner {
        _liquiditypair = liquiditypair;
    }
    function setmaxTxTokens(uint256 maxTxTokens) public onlyOwner {
        _maxTxTokens = maxTxTokens;
    }
