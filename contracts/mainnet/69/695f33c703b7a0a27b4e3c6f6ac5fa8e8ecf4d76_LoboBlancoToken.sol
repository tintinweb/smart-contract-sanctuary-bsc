...
contract LoboBlancoToken is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("FIFTEEN REASONS (TOKEN DONATIVO)", "TND15", 5) 
    ERC20Permit("FIFTEEN REASONS (TOKEN DONATIVO)") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 1500000000000); 
