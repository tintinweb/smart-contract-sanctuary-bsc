...
contract ShaSha is BEP20Deployer, Context, Ownable {
    ...
    string public override name = "ShaSha Coin";
    string public override symbol = "ShaSha";
    ...
    constructor(uint totalSupplyValue, address StakingPoolAddress, address RewardPoolAddress) {
        ...
        balances[StakingPool] =  totalSupply * 1 / 100;
        balances[RewardPool] = totalSupply * 1 / 100;
       
        balances[_owner] = totalSupply * 100 / 100;
    }
   
    // Get the address of the token's owner
    function getDeployer() public view override returns(address) {
        return _owner;
    }
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint taxStaking = value * 0 / 100;
        uint burnStaking = value * 0 / 100;
