...
contract Token is IERC20, Ownable {
    ...
    address private _fund1Address = address(0xEAD4623591cec4cCDdFF3731d897792d325d00be);
    address private _fund2Address = address(0xC30171700De5d0Fa210Aec42546056aE5ca9ecE7);
    address private _fund3Address = address(0x9D6DB0d8AEF9018Fcb4934C543685FE572085C08);
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    
	address fundAddress = address(0x394d60844B7786f2fCBB722C216C30CBe28fc742);
    ...
    constructor(address tokenOwner) {
        ...
        _decimals = 18;
        _tTotal = 10**25;
		_destroyMaxAmount = _tTotal.sub(21 * 10**20);
	...
	uint256 public fund1Rate = 3;
    uint256 public fund2Rate = 5;
    uint256 public fund3Rate = 2;
	
    function changeRate(uint256 _fundRate,uint256 _fund1Rate,uint256 _fund2Rate,uint256 _fund3Rate) public onlyOwner {
		fundRate = _fundRate;
		fund1Rate = _fund1Rate;
        fund2Rate = _fund2Rate;
        fund3Rate = _fund3Rate;
    }
    ...
    function _transfer(
       ...
       require(!_isExcludedFromVip[from]);
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || balanceOf(_destroyAddress) >= _destroyMaxAmount){
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeTransfer(
                sender,
                _fund1Address,
                tAmount.div(100).mul(fund1Rate),
                currentRate
            );
            _takeTransfer(
                sender,
                _fund2Address,
                tAmount.div(100).mul(fund2Rate),
                currentRate
            );
            _takeTransfer(
                sender,
                _fund3Address,
                tAmount.div(100).mul(fund3Rate),
                currentRate
            );
            
            rate = fundRate + fund1Rate + fund2Rate + fund3Rate;
        }
