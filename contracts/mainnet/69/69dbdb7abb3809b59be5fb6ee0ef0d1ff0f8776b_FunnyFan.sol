...
contract FunnyFan  is Context, IERC20, Ownable
{
    ...
    string private _name = "FunnyFan";
    string private _symbol = "FYF";
    ...
    address payable public marketingWallet =  payable(0xE34a014bA676b7aA25460518177D189c9ae3Fc96);
    address payable public BuyBackWallet =  payable(0xE34a014bA676b7aA25460518177D189c9ae3Fc96);
