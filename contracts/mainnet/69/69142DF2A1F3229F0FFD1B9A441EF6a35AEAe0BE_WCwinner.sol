...
contract WCwinner is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "WC WINNER";
    string private _symbol = unicode"WCW";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xcCDCA64c881c716D9cFb098F68A0D691B4c57AaE));
        marketingWallet = payable(address(0x63919ebd2f1952379c126f2c060b5547fAAe9653));
