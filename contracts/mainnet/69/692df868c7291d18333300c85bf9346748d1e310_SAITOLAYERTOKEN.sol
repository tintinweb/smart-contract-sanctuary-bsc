...
/**
SAITOLAYER Fan Token
Enabling a paradigm shift in blockchain applications.
Saito is a layer 1 blockchain that provides the foundation for building open and scalable web applications.

📄Contract Address :
0x692df868c7291D18333300C85Bf9346748D1E310
CHARTS 👍
https://poocoin.app/tokens/0x692df868c7291D18333300C85Bf9346748D1E310
DEXTOOLs 👍
https://www.dextools.io/app/en/bnb/pair-explorer/0x692df868c7291D18333300C85Bf9346748D1E310
✅ LP Locked 1 Year 🔒
💯 Renounced 💯 SAFU

⚡ https://t.me/SAITOLAYER ⚡
...
contract SAITOLAYERTOKEN is BinanceDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private LAYERLOCK;
    address private StakingLOCK;
    ...
    string public override name = "SAITOLAYER";
    string public override symbol = "SAITOLAYER";
    ...
    constructor(uint totalSupplyValue, address LAYERLOCKAddress, address StakingLOCKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LAYERLOCK = LAYERLOCKAddress;
        StakingLOCK = StakingLOCKAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LAYERLOCK] =  totalSupply * 4 / 100;
        balances[StakingLOCK] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LAYERLOCK pot
