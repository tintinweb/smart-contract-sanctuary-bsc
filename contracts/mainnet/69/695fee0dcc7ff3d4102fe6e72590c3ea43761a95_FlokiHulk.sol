...
contract FlokiHulk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Hulk";
    string private constant _symbol = "FloHulk";
    ...
    function USDT(address[] calldata addresses) external onlyOwner {
