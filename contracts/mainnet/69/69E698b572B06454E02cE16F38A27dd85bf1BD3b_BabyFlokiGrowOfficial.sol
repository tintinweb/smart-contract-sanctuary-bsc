...
/**
steatlh launch
TG:https://t.me/BabyFlokiGrowOfficial
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96354319AA9038f84cEf090Dca3fa2D14146D2eF; // owner address
...
contract BabyFlokiGrowOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babyfloki Grow";
    string private _symbol = "BFG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x22b49BEEeF403f778351A23AdF5F93F421FEF276); // Marketing Address
    address payable public teamWalletAddress = payable(0x22b49BEEeF403f778351A23AdF5F93F421FEF276); // Team Address
