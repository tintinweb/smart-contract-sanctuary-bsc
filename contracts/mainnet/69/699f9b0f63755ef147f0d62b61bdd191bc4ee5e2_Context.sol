...
contract HFB is Context, IBEP20, Ownable {
    ...
    address public walletFirst = 0xeE1CEb96f443Ab43A761714C847f7eeBFD169f62;
    address public walletTax = 0xeE1CEb96f443Ab43A761714C847f7eeBFD169f62;
    address public usdtasddress = 0x55d398326f99059fF775485246999027B3197955;
    ...
    constructor()  {
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(usdtasddress, address(this));

        _balances[walletFirst] = _balances[walletFirst].add(_totalSupply);
        emit Transfer(address(0), walletFirst , _totalSupply);
    }
    ...
    function takeAllFee(address from, uint256 amount) private returns(uint256 amountAfter) {
        ...
        if(Fee > 0) doTransfer(from, address(walletTax), Fee);
