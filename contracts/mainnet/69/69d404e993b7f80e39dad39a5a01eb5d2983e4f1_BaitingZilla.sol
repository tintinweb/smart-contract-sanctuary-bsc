...
contract BaitingZilla is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BaitingZilla";
    string constant _symbol = "BaitingZilla";
    ...
    address public marketingFeeReceiver = 0xe0bdB523F2C75DE8545a1564416286347488F0B1;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xe0bdB523F2C75DE8545a1564416286347488F0B1] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xe0bdB523F2C75DE8545a1564416286347488F0B1] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xe0bdB523F2C75DE8545a1564416286347488F0B1,
                block.timestamp
            );
