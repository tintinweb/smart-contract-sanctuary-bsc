...
* VISIT: https://t.me/shibabnbtoken
...
contract shibabnb is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingAddress = payable(0xe8df1d06776bF9a50378A47898c2C3D66BF37418);

    uint256 public swapTokensAtAmount = 200 * (10**18);

    uint256 private marketingBuyFees = 8;
    uint256 private marketingSellFees = 8;
    ...
    uint256 private BNBRewardsBuyFee = 3;
    uint256 private BNBRewardsSellFee = 3;
    uint256 private BNBRewardsTransferFee = 3;
    ...
    constructor() ERC20("SHIBAbnb", "Sbnb") {
