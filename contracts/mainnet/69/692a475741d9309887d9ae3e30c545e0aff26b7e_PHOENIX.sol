...
//|  _/ | __ || (_) || _| | .` | | |   >  <    | |  |   /| |_| || _|   | _ \| |_| ||   / | .` | 
//|_|   |_||_| \___/ |___||_|\_||___| /_/\_\   |_|  |_|_\ \___/ |___|  |___/ \___/ |_|_\ |_|\_|  
//
//            _/|       |\_
//           /  |       |  \
//          |    \     /    |
...
// Web: https://phoenixtrueburn.com/
// TG: https://phoenixtrueburn.com/
// Twitter: https://twitter.com/PHOENIXTRUEBURN
...
//Contract
contract PHOENIX is IBEP20, Ownable {
    ...
    uint8 private constant MaxWalletDivider=50; //2% = 20,000
    uint16 private constant SellLimitDivider=50; //2% = 20,000
    uint8 public constant MaxTax=20;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    uint8 private _devTax=0;
    uint8 private _burnTax=30;
    ...
    uint8 private _sellTax=7;
    uint8 private _transferTax=7;
