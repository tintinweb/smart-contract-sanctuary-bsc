...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29603d4268BE717108Aa4F4aE15e1DC54B40b0D4; // owner address
...
contract BabyCatGrow is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCat Grow";
    string private _symbol = "BCatGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29603d4268BE717108Aa4F4aE15e1DC54B40b0D4); // Marketing Address
    address payable public teamWalletAddress = payable(0x29603d4268BE717108Aa4F4aE15e1DC54B40b0D4); // Team Address
