...
Telegram : https://t.me/dogelegrambsc
Website  : TBA
...
contract Dogelegram is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa8C5f69D0aBBFA3CbcBe068F067B1EAE9a39f246); 
    address payable public Wallet_Dev = payable(0x15e5711dfeb3d623059cb7EC52c3F5474fDbB54c);
    ...
    string private constant _name = "Dogelegram"; 
    string private constant _symbol = unicode"$DOGRAM"; 
    ...
    constructor () {
        ...
        _owner = 0x15e5711dfeb3d623059cb7EC52c3F5474fDbB54c;
