...
contract LJDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcC224a36A703f2b0115402771be68EF0559851Fb); // Marketing Address
    ...
    string private _name = "LJDOG";
    string private _symbol = "LJDOG";
