...
/**
PawChain Portal (PAWc) Stealth Launch
💹 Telegram https://t.me/PawChainPortal
💹 Verified Contract 0x698807b6a088197f73e8cffdce1b977eebe0d11c

Explore The New Blockchain.
PawChain relies on a system of PoA consensus that can support short block time and lower fees. The most bonded validator candidates of staking will become validators and produce blocks. The double-sign detection and other slashing logic guarantee security, stability, and chain finality.
...
More info : Website: https://www.pawchain.org/
...
contract PawChainPortal is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'PawChain Portal';
    string private _symbol = 'PAWc';
