...
// Begin sauce.
contract testMpop is Context, IERC20, Ownable {
    ...
    string private  _name               = "tesMpop";
    string private  _symbol             = "testmp";
    ...
    address payable public _wallet_marketing = payable(0xA883C01C7Dd97c4FA21dE9b16F2b38948F294B14);
    ...
    address payable public _wallet_buyback = payable(0x12f67Ed54B4A5E123028644B631d8858A2B4f6b2);
...
// Liquidity functions
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0,
            0,
            0x7aaB4eba269407f96Cc74B7aa1f1503f87460c46,
            block.timestamp
        );
    }
