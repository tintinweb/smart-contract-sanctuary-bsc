...
contract CryptoLemonToken is Context, IERC20, Ownable {
    ...
    address public _pancakeswapV2LiquidityPair;  // The address of the PancakeSwap V2 liquidity pairing for {TOKEN}/WBNB
    ...
    bool public isSwapingEnabled = true;
     ...
     // General Info
    string private _name        =   "Crypto Lemon";
   ...
   /**
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from == _pancakeswapV2LiquidityPair || to == _pancakeswapV2LiquidityPair) 
        {
            ...
            // TODO: ISSUE HERE 
            if(isSwapingEnabled) swapTokensForBNB(tFee, _feesCollectingAddress);          
        }
        else 
        {
            _balances[from] = _balances[from].sub(amount, "BEP20: Transfer amount exceeds balance");
    ...
    function swapTokensForBNB(uint256 tokenAmount, address payable recipient) private {
