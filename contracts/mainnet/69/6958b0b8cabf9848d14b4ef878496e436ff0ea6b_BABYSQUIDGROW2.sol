...
https://t.me/BabySquidGrowTwoZero
...
contract BABYSQUIDGROW2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Squidgrow 2.0";
    string private _symbol = "BSG 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81F86cc3aC3425CE7F0145b9cFf033F251a6AD8d); 
    address payable public buyBackWalletAddress = payable(0x700406436e9fa60A0dD4603Fd40A868DB632F067); 
