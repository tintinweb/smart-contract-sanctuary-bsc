...
contract AIKABOZU is ReentrancyGuard, BEP20, AccessControl, Taxable   {
    ...
    constructor(
        ...
        _mint(_msgSender(), 7000000e18);
        _mint(0xB1cfd4aEB87FFB54Aa8f8A40c30B24047358f3f9, 250000e18);
        _mint(0x1C8aD3082C682834d0Fe8f96817619523ccf0bB6, 250000e18);
