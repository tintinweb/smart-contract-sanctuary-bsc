...
contract Travelix is Context, IERC20 { 
    ...
    address payable private Wallet_Dev = payable(0xd123d4AF47F238d3951eEF24A71b14Df3aE37AA6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Travelix"; 
    ...
    constructor () {
        ...
        _owner = 0xC98b36743F0c371747Af45145e4da3b4863A6adc;
