...
/**
Pigmart Coin is a community-driven token and decentralized meme coin with low-tax and setting a new trend in the oriental crypto space.
...
contract PMART is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 777 * 10**9; 
    string private constant _name = "Pigmart";  
    string private constant _symbol = "PMART";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xFe5ae171FD975947bA1d9295B6E63d342f5b7ff7;
