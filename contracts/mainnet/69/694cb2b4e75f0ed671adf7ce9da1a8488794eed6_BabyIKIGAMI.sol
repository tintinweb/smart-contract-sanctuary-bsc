...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x96412902aa9aFf61E13f085e70D3152C6ef2a817); 
...
contract BabyIKIGAMI is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c ;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x2FCD2e52ae371cD71d12B915613Aa2931DFC2364;

    string constant _name = "BabyIKIGAMI";
    string constant _symbol = "BABYIKI";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5000000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 5000000000000000 * (10 ** _decimals);
