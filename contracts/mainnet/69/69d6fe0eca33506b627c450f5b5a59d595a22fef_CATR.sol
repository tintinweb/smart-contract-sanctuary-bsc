...
contract CATR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Reaper";
    string private _symbol = "CATR";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xe0cDfaC0336F8e4CFB351EE05B5e820f593e4Bb6); // Buy Back Address
