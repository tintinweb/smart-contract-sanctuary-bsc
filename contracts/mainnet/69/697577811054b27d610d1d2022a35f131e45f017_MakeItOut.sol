...
contract MakeItOut is ERC20, Ownable {
    ...
    constructor() ERC20("Make It Out", "MAKE") {
        ...
        maxTransactionAmount = 5000000 * 10**18;
        maxWallet = 20000000 * 10**18;
        swapTokensAtAmount = 8000000 * 10**18;
        ...
        marketingWallet = 0x01f942EFbbDB29b33ED7c61937F3C5Ebbf05D68B;
    ...
    function setMaxTransactionAmount(uint256 newNum) external onlyOwner {
        require(newNum >= 10, "Max transaction too small");
        maxTransactionAmount = newNum * (10**18);
    }

    function setMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= 10, "Max wallet too small");
