...
This is Dev Detector Bot

Are you tired of aping at tokens without knowing the Team?

Want to track a team for future launches?

Wait no longer and join DevDetectorBot

DDB Functionality

- Track dev wallets up to 20 layers deep.
- Show which previous token deployments are related to the wallet
- Show any airdrops done pre and post launch
- Dev Launch Alert System
- Rug Counter
- Honeypot Counter
- Dev Liquidity Calculator

https://t.me/DevDetectorBot
...
contract DDB is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Dev Detector Bot"; // 
    string constant _symbol = "DDB"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (8); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (1); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (8); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0xCc00D943509CD088B19cc38976e5bFD8827101e2; //LP receiver
    address private marketingFeeReceiver = 0x1C2F5F2E80A9E59831F5238b33ED642C5D4138E8; //mkt
    address private devFeeReceiver = 0xCc00D943509CD088B19cc38976e5bFD8827101e2; //31 BuyBack
    address private teamFeeReceiver = 0xBb1Ad95e0bcA000417A374D8E382542cD281311C; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x2F9Cb5d8D1e2e11EBec89bD2c0E2689B010fF9e5;
