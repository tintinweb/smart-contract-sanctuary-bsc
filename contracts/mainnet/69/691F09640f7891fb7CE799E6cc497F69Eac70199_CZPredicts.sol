...
/* 
t.me/czpredicts
A collection of blockchain based games and activities. 
...
contract CZPredicts is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CZPredicts", "CZP") {
        ...
        maxBuyAmount = totalSupply / 200; // 1% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 200; // 1% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x06835BfF740A4128E72ab1B4D9E2abAc254fB082); // set as marketing wallet
