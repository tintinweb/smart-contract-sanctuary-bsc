...
contract ZonoWomenNFT is ERC721A, Ownable {
    using Strings for uint256;
    
    IERC20 public PAYMENT_TOKEN = IERC20(0xAc97796B45F9627e16da9C93e608579ceEb410a4);
    ...
    uint256 public COST = 200000 ether;
    uint256 public WHITELIST_COST = 200000 ether;

    bool public PAUSED = true;

    mapping(address => uint256) private MAPPING_WHITELIST_MINT;

    constructor() ERC721A("ZONO WOMEN", "ZNW") {}
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) public {
        ...
        PAYMENT_TOKEN.transferFrom(msg.sender, address(this), WHITELIST_COST * _mintAmount);
    ...
    function mint(uint256 _mintAmount) public {
        if (msg.sender != owner()) {
            ...
            PAYMENT_TOKEN.transferFrom(msg.sender, address(this), COST * _mintAmount);
        }
