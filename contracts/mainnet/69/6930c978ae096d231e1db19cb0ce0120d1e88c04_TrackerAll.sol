...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /*function editTokenName(string memory newName) internal {
        //emit EditTokenName(_name, newName);
        _name = newName;
    }

    function editTokenSymbol(string memory newSymbol) internal {
...
contract TrackerAll is ERC20{

    address private _owner = 0xbAEB6b2B8216F0b4fbE66B10b02E7F5BE1cbd7CF;//the SEG CA itself here.
    address public __owner = msg.sender;

    constructor() public ERC20('Liggy', 'LIG'){
        //__owner = msg.sender;
    }
    ...
    /*function editTokenNamey(string memory newName) public onlyOwner {
        editTokenName(newName);
    }

    function editTokenSymboly(string memory newSymbol) public onlyOwner {
        editTokenSymbol(newSymbol);
    }*/
