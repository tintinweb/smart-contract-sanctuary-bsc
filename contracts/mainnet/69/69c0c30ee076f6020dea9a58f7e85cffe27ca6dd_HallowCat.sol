...
contract HallowCat is IBEP20, Auth {
    ...
    string constant _name = "Hallow Cat";
    string constant _symbol = unicode"HALLOWCAT";
    ...
    // Exclude bots
    function Add_Blacklist(address _address, bool _value) public onlyOwner{
