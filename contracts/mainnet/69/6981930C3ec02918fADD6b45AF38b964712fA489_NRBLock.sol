...
contract NRBLock is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 7, 0, 50, 23782117, 0, 0, 0)); // 1.25% liquidity
        lockups.push(Lockup(1, 30, 0, 30, 25684686, 0, 0, 0)); // 1.35% liquidity
        lockups.push(Lockup(2, 90, 0, 10, 31392394, 0, 0, 0)); // 1.65% liquidity
        lockups.push(Lockup(3, 180, 0, 0, 38051387, 0, 0, 0)); // 2% liquidity
        _resetAllowances();
    }
