...
contract EverAi is IBEP20, Auth {
    ...
    string constant _name = "Ever Ai";
    string constant _symbol = "EVAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 21000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x920893d9fF258A7025f3C8CA10fE78C7a9763f7B;
