...
// Telegram : https://t.me/DieHardLUNA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1398021E9058fF234E18cc5B030F1f6A03aa082; // owner address
...
contract DHL is Context, IERC20, Ownable {
    ...
    string private _name = "DIE HARD LUNA";
    string private _symbol = "$DHL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9E355E4EB423FC2473031b5D9ff3BA02fea17F11); // Marketing Address
    address payable public teamWalletAddress = payable(0x9E355E4EB423FC2473031b5D9ff3BA02fea17F11); // Team Address
    ...
    uint256 public _maxTxxxAmount = 5_000_000 * 10**_decimals; 
    uint256 public _walllletMax = 5_000_000 * 10**_decimals;
