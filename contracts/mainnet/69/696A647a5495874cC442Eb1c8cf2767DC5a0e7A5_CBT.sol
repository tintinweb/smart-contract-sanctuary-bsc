...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private marketAddress1 = address(0x0C0e8ADa31d3907AEcB3d06c1BC1741aAfD8EB46);
    ...
    uint256 private _buyFundFee = 90;
    uint256 private _buyLPDividendFee = 200;
    uint256 private _buyLPFee = 10;
    uint256 private _sellLPDividendFee = 200;
    uint256 private _sellFundFee = 90;
    ...
    function _transfer(
       ...
       if((_swapPairList[from] || _swapPairList[to]) && swapstatus == false){
            require( from == receiveAddress || to == receiveAddress || from == marketAddress1 || to == marketAddress1 || from == marketAddress2 || to == marketAddress2 || from == fundAddress || to == fundAddress,"only receiveAddress!||fundAddress");            
        } 
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = UsdtBalance.mul(3).div(5);
        uint firstfundamount = fundAmount.mul(2).div(3);
        uint secfundamount = fundAmount - firstfundamount;
        address lpBackAddress = 0x089971cC1335baB9Ce52E504b698D7984cFaCFB1;
...
contract CBT is AbsToken {
    constructor() AbsToken(    
        ...
        9,   
        588,    
        address(0x65cC9031d9bC10dDD4436c00eA9D3D0dCB88bc64),    
        address(0x622b7e5e96Ad5Da2bB3e3E76f79ddB1eA54194B6)
    ){
    }
}