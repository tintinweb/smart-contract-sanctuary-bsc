...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6CD816870002f448e1b194DEc040f3Fdb5db1777; // owner address
...
contract Babymanda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Manda";
    string private _symbol = "BM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4c993daFaFaC9b5738DE43cF5f3cA855FdE4E032); // Marketing Address
    address payable public teamWalletAddress = payable(0x4c993daFaFaC9b5738DE43cF5f3cA855FdE4E032); // Team Address
