...
// // 水瓶座（24万个）
        require(_totalSupply[1] <= 240000, "aquarius Limit 240000");
        // 双鱼座（18万个）
        require(_totalSupply[2] <= 180000, "Pisces Limit 180000");
        // // 白羊座（12万个）
        require(_totalSupply[3] <= 120000, "Aries  Limit 120000");
        // // 金牛座（6万个）
        require(_totalSupply[4] <= 60000, "Taurus  Limit 60000");
        // 双子座（2.4万个）
        require(_totalSupply[5] <= 24000, "Gemini  Limit 24000");
        // 巨蟹座（1.8万个）
        require(_totalSupply[6] <= 18000, "cancer  Limit 18000");
        // 狮子座（1.2万个）
        require(_totalSupply[7] <= 12000, "Leo  Limit 12000");
        // 处女座（0.6万个）
        require(_totalSupply[8] <= 6000, "Virgo  Limit 6000");
        // 天秤座（2400个）
        require(_totalSupply[9] <= 2400, "Libra  Limit 2400");
        // // 天蝎座（1800个）
        require(_totalSupply[10] <= 1800, "Scorpio  Limit 1800");
        // 射手座（1200个）
        require(_totalSupply[11] <= 1200, "Sagittarius   Limit 1200");
        // 魔羯座（600个）
        require(_totalSupply[12] <= 600, "Capricorn  Limit 600");
        // 火星勋章（6000个）
        require(_totalSupply[13] <= 6000, "Order of Mars Limit 6000");
        // 金星勋章（600个）
        require(_totalSupply[14] <= 600, "Order of Venus Limit 600");
        // // 进化水晶10万枚
        require(_totalSupply[15] <= 100000, "Evolution crystal Limit 100000");
        // 青铜史诗熊猫（5.4万个）
        require(_totalSupply[16] <= 54000, "bronze Limit 54000");
        // 白银创奇熊猫（0.6万个）
        require(_totalSupply[17] <= 6000, "silver Limit 6000");
        // 黄金神话熊猫（600个）
        require(_totalSupply[18] <= 600, "gold Limit 600");
