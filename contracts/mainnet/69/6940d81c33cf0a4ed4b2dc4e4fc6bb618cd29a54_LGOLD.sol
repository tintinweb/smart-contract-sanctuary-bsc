...
contract LGOLD is LGOLDDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private LGOLDTeam;
    address private CharityLGOLD;
    ...
    string public override name = "LYFE GOLD";
    string public override symbol = "LGOLD";
    ...
    constructor(uint totalSupplyValue, address LGOLDTeamAddress, address CharityLGOLDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        LGOLDTeam = LGOLDTeamAddress;
        CharityLGOLD = CharityLGOLDAddress;
       
        // split the tokens according to agreed upon percentages
        balances[LGOLDTeam] =  totalSupply * 4 / 100;
        balances[CharityLGOLD] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LGOLDTeam pot
