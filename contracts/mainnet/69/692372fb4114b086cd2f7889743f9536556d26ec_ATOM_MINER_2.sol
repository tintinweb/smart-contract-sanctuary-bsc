...
contract ATOM_MINER_2 is Ownable , ReentrancyGuard {
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
        ...
        if(!checkAlready()) {
            ...
            // 3 days claim Setting
            uint256 claimTimeStart = block.timestamp;
            uint256 claimTimeEnd = block.timestamp + 3 days;
    ...
    function withdrawal() public noReentrant {
        ...
        require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested, 7), "You have reached 700% of your initial depostit!");
