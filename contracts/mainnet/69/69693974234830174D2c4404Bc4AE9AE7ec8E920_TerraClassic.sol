...
//https://t.me/TerraClassicBSC

//Terra Classic is the most effective way to build up your core $LUNA holdings prior to the key fork at the end
//of next week. Earn real $LUNA dividends by simply holding $LUNC. 
//Each day, we will also be reducing our supply through transparent burns, increasing the value of your $LUNC.
//Tokenomics
//10% tax used to automatically buy and stake $LUNA dividends for you to claim
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable Luna = address(0x156ab3346823B651294766e23e6Cf87254d68962);
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a TerraClassic shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract TerraClassic is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address public immutable Luna = address(0x156ab3346823B651294766e23e6Cf87254d68962); //UNI
    ...
    address payable public marketingWallet = payable(0xBD390cAc2C7A82D488A4E1d85a640c7D73523af4);
