...
contract SantaGrowInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x00B696c361640222895b8816FbC31dA829C9A9b4); 
    address payable public Wallet_Dev = payable(0x00B696c361640222895b8816FbC31dA829C9A9b4);
    ...
    string private constant _name = "SantaGrowInu"; 
    string private constant _symbol = unicode"$SAGI"; 
    ...
    constructor () {
        ...
        _owner = 0x00B696c361640222895b8816FbC31dA829C9A9b4;
