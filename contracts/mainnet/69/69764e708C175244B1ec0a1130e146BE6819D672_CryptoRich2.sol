...
/*
TG : https://t.me/cryptorichorg

CryptoRich2.0
CRYPTORICH has return to make all the holders to be rich again! A BSC Token with 100% liquidity, no dev wallet, no rug and no bullshit. Just Buy, Trade, HODL, and be CryptoRich for the 2nd time.
*/
...
contract CryptoRich2 is Context, IERC20 { 
    ...
    string private constant _name = "CryptoRich2.0"; 
    string private constant _symbol = "CRICH2.0"; 
