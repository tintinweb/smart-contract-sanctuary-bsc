...
contract BLV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Legions Bloodstone v2";
    string private _symbol = "BLV2.0";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xb20112c0B4bacA160Ff206e974090fb3f3fF0Dc8); 
    address payable public ttWal = payable(0xb20112c0B4bacA160Ff206e974090fb3f3fF0Dc8); 
