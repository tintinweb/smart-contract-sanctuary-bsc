...
contract PantherGirl is ERC20, Ownable {
    ...
    address DEV = 0x5BCb82013f6195cC4F5Dc49bf03b80EbE8048D68;
    ...
    constructor () Ownable() {
        ...
        distributor = new DividendDistributor(address(router),router.WETH(),30 minutes,1 * 10 ** 9,_totalSupply.div(1000));
