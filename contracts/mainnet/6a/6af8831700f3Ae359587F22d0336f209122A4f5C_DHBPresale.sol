...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\IBEP20.sol
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\math\SafeMath.sol
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\Address.sol
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\SafeBEP20.sol


// pragma solidity ^0.6.0;

// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\IBEP20.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\math\SafeMath.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\Address.sol';
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\ReentrancyGuard.sol
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\GSN\Context.sol
...
// Dependency file: node_modules\@pancakeswap\pancake-swap-lib\contracts\access\Ownable.sol


// pragma solidity >=0.4.0;

// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\GSN\Context.sol';
...
// Root file: contracts\DHBPresale.sol
...
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\IBEP20.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\token\BEP20\SafeBEP20.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\math\SafeMath.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\Address.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\utils\ReentrancyGuard.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\GSN\Context.sol';
// import 'node_modules\@pancakeswap\pancake-swap-lib\contracts\access\Ownable.sol';
pragma experimental ABIEncoderV2;

contract DHBPresale is ReentrancyGuard, Context, Ownable {
    using SafeMath for uint256;
    ...
    function init_data(purchaseInfo[] calldata _presale_init) external onlyOwner nonReentrant {
        require(_init_data == false, "only once call is possible");
        purchaseInfo memory info; 
        for (uint256 i = 0; i < _presale_init.length; i++) {
            info = _presale_init[i];
            require(validPurchase(info.value, info.valueToken), 'not valid purchase');
            require(availableBalance() >= info.amount, 'insufficient tokens balance');
            _balances[info.purchaser].push(lockInfo(info.amount, info.endDate));
            totalsByTokens[info.valueToken] = totalsByTokens[info.valueToken].add(info.value);
            totalsSold = totalsSold.add(info.amount);
            totalLocked = totalLocked.add(info.amount);
        }
        _init_data = true;
    }
    ...
    function updateStepDuration(uint256 _stepDuration) external onlyOwner nonReentrant {
        require(_stepDuration > 0);
        stepDuration = _stepDuration;
    }

    function updateLockDuration(uint256 _lockDuration) external onlyOwner nonReentrant {
        require(_lockDuration > 0);
        lockDuration = _lockDuration;
    }
