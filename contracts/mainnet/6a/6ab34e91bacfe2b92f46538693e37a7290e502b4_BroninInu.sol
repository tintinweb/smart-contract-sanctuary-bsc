...
contract BroninInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 1000 * 10**9 * 10**9; // 1,000,000,000 Tokens
    ...
    string private constant _name = unicode"Bronin Inu";
    string private constant _symbol = unicode"BRONINU";
    ...
    uint256 private _maxBuyAmount = 50 * 10**9 * 10**9;  // 5%
    uint256 private _maxSellAmount = 10 * 10**9 * 10**9; // 1%
