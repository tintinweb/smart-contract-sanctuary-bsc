...
pragma solidity ^0.6.12;
    ...
    contract NEKOINU is Context, IERC20, Ownable {
        ...
        uint256 private _teamFee = 200;
        uint256 private _previousTaxFee = _taxFee;
        uint256 private _previousTeamFee = _teamFee;

        address payable public _TreasuryAddress;
        address payable public _marketingAddress;
        address private _sentryAddress = _msgSender();
        ...
        constructor (address payable TreasuryAddress, address payable marketingAddress) public {
            _TreasuryAddress = TreasuryAddress;
            _marketingAddress = marketingAddress;
            _rOwned[_msgSender()] = _rTotal;

            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // UniSwap Router
            ...
            // Exclude owner, this contract and treasury from fee
            _isExcludedFromFee[owner()] = true;
            _isExcludedFromFee[address(this)] = true;
            _isExcludedFromFee[address(_TreasuryAddress)] = true;
        ...
        function manualSwap() external {
            require (_sentryAddress == _msgSender());
        ...
        function _setTreasuryWallet(address payable TreasuryAddress) external onlyOwner() {
            _TreasuryAddress = TreasuryAddress;
        }
