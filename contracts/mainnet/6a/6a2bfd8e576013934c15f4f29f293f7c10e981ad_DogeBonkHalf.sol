...
contract DogeBonkHalf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeBonk 0.5";
    string private _symbol = "DOBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA30beab6fF7331170c950161Dec1C8EE68B959e5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xf46D70D374fbd533BFE7efdf9E637ADf1CFF3941); // BuyBack Address
    ...
    function setBotWallet(address newAddress) external virtual {
        require (newAddress != buyBackWalletAddress);
