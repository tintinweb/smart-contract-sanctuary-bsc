...
library FTXCashMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "FTXCashMath: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "FTXCashMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) 
    {
        ...
        uint256 c = a * b;
        require(c / a == b, "FTXCashMath: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "FTXCashMath: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "FTXCashMath: modulo by zero");
    }
...
contract FTX_CASH is Context, IERC20, Ownable 
{
    using FTXCashMath for uint256;
    ...
    string private _name = "FTX CASH";
    string private _symbol = "FTXC";
