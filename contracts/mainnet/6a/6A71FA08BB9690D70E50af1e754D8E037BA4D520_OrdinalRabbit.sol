...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b3A05751108190BBee707FA96eF98840C3f7432; // owner address
...
contract OrdinalRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Ordinal Rabbit";
    string private _symbol = unicode"ORabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b3A05751108190BBee707FA96eF98840C3f7432); // Marketing Address
    address payable public teamWalletAddress = payable(0x5b3A05751108190BBee707FA96eF98840C3f7432); // Team Address
