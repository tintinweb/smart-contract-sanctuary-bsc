...
// File: Digital_Health_Identification.sol
...
contract DHI is BEP20, BEP20Burnable, Pausable, Ownable {
    constructor() BEP20("Digital Health Identification", "DHI") {
        _mint(msg.sender, 100000000000 * 10 ** decimals()); // 100,000,000,000 initial supply
    }
     ...
     function claimStuckedTokensAndBNB(address _token) external onlyOwner {
        ...
        if (_token == address(0x0)) {
            ...
            return;
             ...
             require(balanceOf(address(this))> 0, "DHI: Contract balance should be greator than zero");
