...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80A085967831717AE3b03b4Bc7A44718a360bEb4; // LM10
...
contract LionelMessiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lionel Messi Token";
    string private _symbol = "LM10";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80A085967831717AE3b03b4Bc7A44718a360bEb4); // Marketing Address
    address payable public teamWalletAddress = payable(0x90297040cE58241dD69501197b7877B6633DdCc0); // Team Address
