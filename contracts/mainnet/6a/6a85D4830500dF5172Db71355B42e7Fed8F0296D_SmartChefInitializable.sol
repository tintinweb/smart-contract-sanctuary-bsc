...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    function whitelst(address _token, bool _isWhitelisted) public onlyOwner {
        require(isWhitelisted[_token] != _isWhitelisted);
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        require(isWhitelisted[msg.sender] && onlyWhitelisted, "I'm sorry, You are not in the whitelist");
        UserInfo storage user = userInfo[msg.sender];
        uint256 remainLock = remainLockTime(msg.sender);
