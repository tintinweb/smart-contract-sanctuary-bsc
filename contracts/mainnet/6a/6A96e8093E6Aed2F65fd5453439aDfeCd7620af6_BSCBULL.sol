...
contract BSCBULL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BSCBULL";

    string private _symbol = "BSCBULL";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xFb188CA63288831b597E0932A1e13bD7a93727e8;
