...
/**
    I make this #oDOGE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/OrdinalDogebsc
   ...
   I will renounce the ownership to burn addresses to transfer #oDOGE to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #oDOGE 10000000X? 
   ...
   it's the best part of the #oDOGE idea, increasing the liquidity pool automatically, 
...
contract OrdinalDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Ordinal Doge";
