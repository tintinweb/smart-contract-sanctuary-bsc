...
contract Marketis is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory _newbaseURI, address _acceptedToken) ERC721('Marketis', 'MTIS') {
    // URL Base
