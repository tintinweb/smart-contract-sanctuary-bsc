...
contract DiskmanInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = (_tTotal * 4) / 100; // 4%
    uint256 public maxSellLimit = (_tTotal * 4) / 100; // 4%
    uint256 public maxWalletLimit = (_tTotal * 4) / 100; // 4%
    
    uint256 private tTimer;
    
    address public marketingWallet = 0x0E856d31A2C8bf8b8715db48226F4Cfbd628756D;
    address public devWallet = 0x0E856d31A2C8bf8b8715db48226F4Cfbd628756D; 
    ...
    string private constant _name = "Diskman Inu";
    ...
    Taxes public taxes = Taxes(0, 9, 1, 0, 0, 0); // 10%
    Taxes public sellTaxes = Taxes(0, 9, 1, 0, 0, 0);// 10%
