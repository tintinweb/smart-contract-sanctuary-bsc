...
contract ShibaVillage is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7331Ebf35c11A4C5e01dfb90F4E66fED307527a7;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Shiba Village";
    string constant _symbol = "$SHIBV";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x0EF10c73ab4434A9aAC4d65f94dB3711576C95CB;
