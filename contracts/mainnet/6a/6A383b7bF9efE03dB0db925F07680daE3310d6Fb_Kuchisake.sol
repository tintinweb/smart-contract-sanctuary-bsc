...
/**
    Kuchisake-onna (口裂け女, "Slit-Mouthed Woman") is a malevolent figure in Japanese urban legends and folklore. Described as the malicious spirit, or onryō, of a woman.

    🩸 Contract made for the community (Renounced)
    🩸 Liquidity Pool forever locked (100% Burned)
    🩸 Safe from Honeypot
...
contract Kuchisake is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kuchisake-onna 口裂け女"; // 
    string private constant _symbol = "KuchOnna"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x42F22Ccf8ba633ee198fff4312109BB7A05b46d0;
