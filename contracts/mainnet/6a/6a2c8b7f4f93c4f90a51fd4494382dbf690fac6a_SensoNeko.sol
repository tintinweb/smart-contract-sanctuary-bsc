...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x34DbCae91DEA986Def99B2C1281a0BD8643282Ee; // owner address
...
contract SensoNeko is Context, IERC20, Ownable {
    ...
    string private _name = "SensoNeko";
    string private _symbol = "SENKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34DbCae91DEA986Def99B2C1281a0BD8643282Ee); // 
    address payable public teamWalletAddress = payable(0x34DbCae91DEA986Def99B2C1281a0BD8643282Ee); // 
