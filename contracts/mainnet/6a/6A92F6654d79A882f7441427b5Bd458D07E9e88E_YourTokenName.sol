...
contract YourTokenName is IBEP20, Ownable
{
    ...
    string private constant _symbol = "DOLP";
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        if(isContractTransfer || isLiquidityTransfer || isExcluded){
            ...
            // require(tradingEnabled,"trading not yet enabled"); trading can no longer be enabeld/disabled
    ...
    function SetupDisableTrading() public onlyOwner{
        tradingEnabled=false; //disables trading
    }*/
    ...
    */
    ...
    function burn(address account, uint256 amount) public virtual { 
        ...
        require(msg.sender == TeamWallet, "only the team is able to burn tokens");
