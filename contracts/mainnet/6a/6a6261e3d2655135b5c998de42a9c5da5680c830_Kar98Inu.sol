...
contract Kar98Inu is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _isRoyaltyReflect;

    string private constant _name = "Kar98 Inu";
    string private constant _symbol = "KAR98INU";
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isRoyaltyReflect[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isRoyaltyReflect[to] = block.timestamp;
        }
