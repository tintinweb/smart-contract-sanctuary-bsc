...
/*
MaticHeist ~ The Evolution of Matic
Inspired by the current trending tokens, MaticHeist is born on BSC to take the market into the next level. MaticHeist aim to become the bridge between BSC network & Polygon network. By holding MaticHeist, you can receive multiple benefits from the token:
1) MaticHeist reflection
2) Served as payment token for bridge across BSC & Polygon network
3) Grant access to higher level marketing program in MaticHeist

Tokenomics:
~ 1,000,000,000,000,000 Supply (1 quadrillion)
~ 5% tax fees
~ Starting with $240 marketcap

TG : https://t.me/MaticHeist
*/
...
contract MaticHeist is Context, IERC20 { 
    ...
    string private constant _name = "MaticHeist"; 
    string private constant _symbol = "$MH"; 
