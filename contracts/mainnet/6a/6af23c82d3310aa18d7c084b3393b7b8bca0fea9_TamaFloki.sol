...
contract TamaFloki  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tama Floki"; // 
    string private constant _symbol = "TAMAFLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2670cAB89cd87CF23f9C274a1CE7Eb8184239Da7;
