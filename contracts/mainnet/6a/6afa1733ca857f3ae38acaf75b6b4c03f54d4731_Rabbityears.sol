...
/**
Telegram :https://t.me/Rabbityears23
*/
...
contract Rabbityears is ERC20 {

    uint tokenTotalSupply = 1000000; // 1000000 token supply

    constructor() public ERC20("RabbitYears", "RabbitYears") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit Years";
    string private _symbol = "Rabbit Years";
