...
/**
https://twitter.com/elonmusk/status/1619489842785837056
Portal: https://t.me/ancientwisdombsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F9455D1C3167D99045BcDC7365a1709cF3D78DD; // owner address
...
contract ancientwisdom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ancient Wisdom";
    string private _symbol = "Wisdom";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3F9455D1C3167D99045BcDC7365a1709cF3D78DD); // Marketing Address
    address payable public teamWalletAddress = payable(0x3F9455D1C3167D99045BcDC7365a1709cF3D78DD); // Team Address
    ...
    uint256 private _totalSupply = 396492234692362 * 10**_decimals;
    uint256 public _maxTxAmount = 7929844693847 * 10**_decimals; 
    uint256 public _walletMax = 7929844693847 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 792984469384 * 10**_decimals; 
