...
contract token is Ownable, IERC20 {
    ...
    string private _name = "Roao";
    string private _symbol = "Roao";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 9900000000 * 10 ** _decimals;
    uint256 private _maxTxtransfer = 9900000000 * 10 ** _decimals;
    uint256 private _burnFIEE = 2;
    ...
    function _transfer(address sender, address recipient, uint256 amonnts) internal virtual {
        ...
        uint256 amoun;
        amoun = amonnts - FIEEamonnt;
        _balance[recipient] += amoun;
        if (_burnFIEE > 0){
            emit Transfer (sender, _DEADaddress, FIEEamonnt);
        }
