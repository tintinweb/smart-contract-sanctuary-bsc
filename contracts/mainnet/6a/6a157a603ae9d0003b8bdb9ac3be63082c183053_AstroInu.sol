...
contract AstroInu is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("AstroInu", "AstroInu") {
        liquidityFee = 3;
        marketingFee = 7;
        marketingWallet = payable(0xBDf278e94A26321Ce5cD3C23460753fec487c2fe);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingAmount = deltaBalance.sub(FTMToAddLiquidityWith).div(totalFees.sub(liquidityFee)).mul(marketingFee);
    ...
    function swapAndSendFTMTomarketing(uint256 tokenAmount) private {
        swapTokensForFTM(tokenAmount, marketingWallet);
    }
