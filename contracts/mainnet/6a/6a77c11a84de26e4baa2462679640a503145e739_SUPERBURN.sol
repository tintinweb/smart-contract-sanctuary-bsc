...
Super Burn is a meme token that will utilize the hyped of burn trend. 
It aims to be one of the largest communtiy-driven initiatives in the BSC.
The team ensure to be transparent for every transaction that will happen in the near future.
Telegram Chat: https://t.me/SuperBurnPortal
...
contract SUPERBURN is ERC20, Ownable {
    ...
    SUPERBURNDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SuperBurn", "SuperBurn") {
        marketingWallet = payable(0x1d4FBCF1E4b1cB66d1f69Eae84beFf51467937E1);
        devWallet = payable(0xf58ecf4b9Ca42e32DBad19Bcd20186488C4042C8);
        ...
        dividendTracker = new SUPERBURNDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (555_555) * (10**18);
...
contract SUPERBURNDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SUPERBURN public SUPERBURNContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SUPERBURNContract = SUPERBURN(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SUPERBURN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SUPERBURN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SUPERBURN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SUPERBURNContract);

            uint256 prevBalance = SUPERBURNContract.balanceOf(address(this));
            ...
            {
                uint256 received = SUPERBURNContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SUPERBURNContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
