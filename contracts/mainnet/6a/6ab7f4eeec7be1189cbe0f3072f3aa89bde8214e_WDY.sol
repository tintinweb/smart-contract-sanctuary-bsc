...
contract WDY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WDY";
    ...
    address payable public marketingWalletAddress = payable(0x3f47ba02C9140869Db9060b599227d8E11bEB81C); // Marketing Address
    address payable public teamWalletAddress = payable(0x3f47ba02C9140869Db9060b599227d8E11bEB81C); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x3f47ba02C9140869Db9060b599227d8E11bEB81C),
            block.timestamp
        );
    }
