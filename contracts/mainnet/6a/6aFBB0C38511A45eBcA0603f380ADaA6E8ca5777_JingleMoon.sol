...
contract  JingleMoon  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JingleMoon"; // 
    string private constant _symbol = unicode"JingleMoon"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x21F631c12dE372d51142A5970efd4a21ffAEA6fd;
