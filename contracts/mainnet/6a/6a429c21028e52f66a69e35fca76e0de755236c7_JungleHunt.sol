...
contract JungleHunt is Context, Ownable, IBEP20 {
    ...
    uint16[3] private ref_bonuses = [2500, 250, 100]; 
    ...
    constructor() {
        ...
        _balances[address(this)] = 6_000_000_000 * 10**uint(_decimals); 
		emit Transfer(address(0), address(this), _balances[address(this)]);    
		_balances[msg.sender] = 4_000_000_000 * 10**uint(_decimals); 
    ...
    function HuntRelics(address referral) public payable {
        ...
        uint256 shares = SafeMath.div(msg.value,100); 
        payable(dev).transfer(shares.mul(9)); 
        payable(ceo).transfer(shares);        
        
        player.total_invested += msg.value;
        
        invested += msg.value;
        withdrawn += shares.mul(10);
    ...
    function ShareLoots(uint startno, uint256 count) public payable {   
