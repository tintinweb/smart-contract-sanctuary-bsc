...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xC12A601724b388bf8c16DdA9DA3DaAc08643DE85); // Zilla Coin CA
...
contract BabyZillaCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Zilla Coin";
    string constant _symbol = "$BZC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xC12A601724b388bf8c16DdA9DA3DaAc08643DE85;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x5A694f2c507C3b178a336faC411A4a4De9bCd5F4;
        marketingWallet = 0x5A694f2c507C3b178a336faC411A4a4De9bCd5F4;  // marketingwallet
        teamWallet = 0x5A694f2c507C3b178a336faC411A4a4De9bCd5F4;  // team
