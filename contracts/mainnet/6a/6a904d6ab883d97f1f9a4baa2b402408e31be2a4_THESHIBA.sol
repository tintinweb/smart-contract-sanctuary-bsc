...
/**
    ...
    The Shiba. just shiba and only shiba !!!

    Website :

    Tg      :https://t.me/TheShibabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e94B14A4d01be322b1a017e2Abf8306A94F7FAB; // owner address
...
contract THESHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Shiba";
    string private _symbol = "$THESHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdAA16F68138c18E5B8ae0EBA189487215350C26b); // Marketing Address
    address payable public teamWalletAddress = payable(0xdAA16F68138c18E5B8ae0EBA189487215350C26b); // Team Address
