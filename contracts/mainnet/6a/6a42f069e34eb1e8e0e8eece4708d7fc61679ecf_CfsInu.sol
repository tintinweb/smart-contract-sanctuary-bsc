...
contract CfsInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x195546fD5A9F93EA2f67F27797dCaf9e9b79d41c); 
    address payable public Wallet_Dev = payable(0x195546fD5A9F93EA2f67F27797dCaf9e9b79d41c);
    ...
    string private constant _name = "CFS Inu";
    string private constant _symbol = unicode"$CFS"; 
