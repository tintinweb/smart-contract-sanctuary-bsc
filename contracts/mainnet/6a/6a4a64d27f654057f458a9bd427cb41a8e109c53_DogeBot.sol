...
contract DogeBot is Context, IERC20, Ownable {
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee + liquidityFee;
        require(totalFees <= 10, "Total fees must be less than 25%");
    }
