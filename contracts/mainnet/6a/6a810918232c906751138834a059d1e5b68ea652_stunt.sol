...
contract stunt is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7c456152a60590cC960437A8bE7f6A4669c43240;

    string private constant _name = "stunt";
    ...
    Taxes public transferTaxes = Taxes(1,1,1);
