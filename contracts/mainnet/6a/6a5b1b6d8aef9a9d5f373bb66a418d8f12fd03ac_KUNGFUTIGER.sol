...
📍买入：12%（4%营销，5%回流池子，3%团队）
📍卖出：12%（4%营销，5%回流池子，3%团队）

中文社区：https://t.me/KUNGFUTIGERCN01
*/
...
contract KUNGFUTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KUNGFUTIGER";
    string private _symbol = "KUNGFU TIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3771a86cea78EE5e47Ef6c436eC53acCA35BD7c9); // Marketing Address
    address payable public teamWalletAddress = payable(0x3771a86cea78EE5e47Ef6c436eC53acCA35BD7c9); // Team Address
    ...
    uint256 private _totalSupply = 300 * 10**8 * 10**_decimals;
    uint256 public _maxTxAmount = 300 * 10**8 * 10**_decimals; 
    uint256 public _walletMax = 300 * 10**8 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 300 * 10**8 * 10**3; 
