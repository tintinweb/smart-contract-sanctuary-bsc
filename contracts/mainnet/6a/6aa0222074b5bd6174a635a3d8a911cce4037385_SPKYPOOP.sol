...
contract SPKYPOOP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPOOKY POOP";
    string private _symbol = "SPKYPOOP";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x866eC610b9584C06dd65CD3641bc062b3B6ef5A0); // Marketing Address
    address payable private TeamWallet = payable(0x866eC610b9584C06dd65CD3641bc062b3B6ef5A0); // Buy Back Address
