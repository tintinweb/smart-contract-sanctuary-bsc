...
// To ride the hype of XRP and GROVE,
// We are Stealth launching XRPg in few hours
// Degen Play as of now. depends on how strong the community will come aboard.
// Safu Devs and great plans huge influencers friends for this project you will see big names coming here onboard on the next few hours or days from now.
...
contract XRPGROVE is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 7_200_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 7_200_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 7_200_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xb87F1eD1D755B7C3F38e449dF45E09aE718ED444;
    address public devAddress = 0x886d76BA8188f1C2149E3b1c380b543061847475;

    string private constant _name = "XRPGROVE";
