...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Token", "Token") {
        address newOwner = address(0xb42E0d0b87c1c83Da062546e8C3Ae0D2c3ECd720);
    
        uint256 totalSupply = 8888 * 1e18;
        
        maxTransactionAmount = 1 * 1e18; // 0.5% maxTransactionAmountTxn
        ...
        buyBackWallet = address(0xC1C26D985Bf01f5766B8461B14Fcc51d6210E1fa); // set as marketing wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 100, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 100, "Must keep fees at 30% or less");
    }
