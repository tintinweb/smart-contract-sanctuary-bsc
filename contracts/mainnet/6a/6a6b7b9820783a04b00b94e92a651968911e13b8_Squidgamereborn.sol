...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6854ee1838577f7e5feed02C7ff314ABAcbE60aa;
...
contract Squidgamereborn is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x6854ee1838577f7e5feed02C7ff314ABAcbE60aa);
    address payable private Wallet_Burn = payable(0x6854ee1838577f7e5feed02C7ff314ABAcbE60aa); 
    address payable private Wallet_zero = payable(0x6854ee1838577f7e5feed02C7ff314ABAcbE60aa); 
    ...
    */
    ...
    string private _name = "Squidgame Reborn"; 
