...
interface IRouter01 {
    ...
    function addLiquidityETH(
        ...
        address to,
        uint deadline
    ) external payable returns (uint amountToken, uint amountETH, uint charity);
    function addLiquidity(
        ...
        address to,
        uint deadline
    ) external returns (uint amountA, uint amountB, uint charity);
...
contract BabyShark is IERC20 {
    ...
    uint256 constant private startingSupply = 10_000_000_000_000_000;
    string constant private _name = "Baby Shark";
    string constant private _symbol = "BShark";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xC880Ff7ff8eD2DEbBB3BCF3fe12bb69A0b1eC83d),
        charity: payable(0xd81d56356f4f9DD49d787EeA7Dff706d3Bb751d5)
    });
...
//===============================================================================================================
    ...
    function setNewRouter(address newRouter) external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot change after charity.");
    ...
    function sweepContingency() external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot call after charity.");
    ...
    function finalizeTransfer(address from, address to, uint256 tAmount, bool buy, bool sell, bool other) internal returns (bool) {
        ...
        if (!_hasLiqBeenAdded) {
            ...
            if (!_hasLiqBeenAdded && _hasLimits(from, to) && !_isExcludedFromProtection[from] && !_isExcludedFromProtection[to] && !other) {
                revert("Pre-charity transfer protection.");
            }
        }
