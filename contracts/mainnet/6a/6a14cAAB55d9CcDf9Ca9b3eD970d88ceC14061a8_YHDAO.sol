...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
       ...
       if((_swapPairList[from] || _swapPairList[to]) && swapstatus == false){
            require( from == receiveAddress || to == receiveAddress || from == marketAddress1 || to == marketAddress1 || from == fundAddress || to == fundAddress,"only receiveAddress!||fundAddress");            
        } 
...
contract YHDAO is AbsToken {
    constructor() AbsToken(      
        ...
        address(0xae1627A56f096e3c09184478CA2e4f5Ec010872C)
    ){
    }
}