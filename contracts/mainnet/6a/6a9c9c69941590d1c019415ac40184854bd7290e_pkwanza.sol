...
abstract contract RGBEP20 is Context, IBEP20, Ownable {
   ...
   // Burn address
    ...
    address public marketingWallet = 0xc14BDC4E5947A0D74dCDC338DE58C6454eF1A063;
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        if (maxTransferAmount() > 0) {
            if (
                ...
                require(amount <= maxTransferAmount(), "PKWANZA::antiWhale: Transfer amount exceeds the maxTransferAmount");
            }
        }
        _;
    }
