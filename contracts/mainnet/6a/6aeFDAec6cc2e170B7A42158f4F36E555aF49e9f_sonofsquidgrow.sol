...
/**
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
NAME: Son of SquidGrow
TICKER: SONOFSQUID

Son of Squidgrow is a BSC project that offers rewards in the form of the phenomenol SquidGrow token.  Earn in two ways: by watching the value of your Son of SquidGame investments grow and by accumulating SquidGrow tokens for as long as you hold on to your coins.

Based Dev
LP Locked
Backed by many influencers
Auto-Rewards in SquidGrow tokens
Planned utilites

Tokenomics:
Total Supply: 100,000,000
Max Wallet and TX: 2% (max TX 1% at launch, will be lifted after launch to 2%)
Buy/Sell Tax: 10% (4% Marketing, 4% Rewards, 2% LP)

Important Links:
Website:  https://sonofsquidgrow.com
Telegram:  https://t.me/sonofsquidgrow
Twitter: https://twitter.com/sonofsquidgrow
###################################################################################
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SquidGrow = IERC20(0x88479186BAC914E4313389a64881F5ed0153C765);
...
contract sonofsquidgrow is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Son of SquidGrow";
    string constant _symbol = "SONOFSQUID";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xA500393C312B3CA2ca10e63D8168c7d6eB196E53);
        marketingFeeReceiver = address(0xA500393C312B3CA2ca10e63D8168c7d6eB196E53);
