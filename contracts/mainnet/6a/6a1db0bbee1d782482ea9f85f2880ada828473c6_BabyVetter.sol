...
MOST BULLISH BABY TOKENS.
https://t.me/babyvetterofficial_BSC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  VETTER = IBEP20(0xf6493A3cBE587c7Fa891E9828C5C9072616595b2);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = VETTER.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(VETTER);
        ...
        uint256 amount = VETTER.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            VETTER.transfer(shareholder, amount);
...
contract BabyVetter is IBEP20, Auth {
    ...
    address VETTER = 0xf6493A3cBE587c7Fa891E9828C5C9072616595b2; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "BabyVetter";
