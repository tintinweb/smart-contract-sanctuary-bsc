...
contract BEP20Token is MintableToken {
    ...
    function recoverBEP20(address addr) public onlyOwner {
      IBEP20 tokenBep20 = IBEP20(addr);
      uint256 tokenBalance = tokenBep20.balanceOf(address(this));
      tokenBep20.transfer(msg.sender,tokenBalance);
