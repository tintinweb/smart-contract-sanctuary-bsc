...
contract  NIU39Token is IERC20, Ownable {
   ...
   constructor() {
            ...
            _symbol = "NIU39";
            _decimals= 18;
            _tTotal = 5000* (10**uint256(_decimals));//数量
            _burnFee = 500;
            _marketingFee = 200;
            _LPFee = 300;
            marketAddr = 0xfA06a48C06f2303cC260F1F2978aA8A5890d9d69; //营销钱包
            insurance = 0xF99Bea0F1f391ABb49381B868a7b8f4377a4Db65; //保险地址
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount;
         ...
         if(canSwap &&from != address(this) &&from != uniswapV2Pair  &&from != owner() && to != owner() ){
                ...
                uint256 market =  tokenBal.mul(_marketingFee).div(_LPFee.add(_marketingFee));
                IERC20(_token).transfer(marketAddr, market/2);
                IERC20(_token).transfer(insurance, market/2);
