...
/*
修改 https://bscscan.com/address/0xD68a9936Bd48A0BD9274eB4e2BF0542822630De0#code
此合约 代理子合约  并没有 权限检查  可能会出现恶意调用 别人可以call 生成的proxy
*/
...
contract BatchClaimXEN {
	...
	function withdrawToken(address token) external {
		IXEN(token).transfer(deployer, IXEN(token).balanceOf(address(this)));
    }
