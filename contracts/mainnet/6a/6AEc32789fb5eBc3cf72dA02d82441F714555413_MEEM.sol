...
contract MEEM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Me encanta el mariachi";
    string constant _symbol = "MEEM";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xd25caB8B1586dBbefee1Bc5616FD47ed799f0be6;
