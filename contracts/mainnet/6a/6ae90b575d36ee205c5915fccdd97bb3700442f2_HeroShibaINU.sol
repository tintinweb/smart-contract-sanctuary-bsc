...
Hero Shiba INU - $HEROSHINU Is a token for safe degen seekers.
 with auto redistribution utility for $HEROSHINU holders.
 Hero Shiba INU - $HEROSHINU A token meme that the shiba inu community and dog lovers will control.🔥
...
Telegram : https://t.me/OfficialHeroShibaINU
Twitter : https://twitter.com/HeroShiba_INU
...
contract HeroShibaINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hero Shiba INU"; //
    string private constant _symbol = "HEROSHINU"; //
