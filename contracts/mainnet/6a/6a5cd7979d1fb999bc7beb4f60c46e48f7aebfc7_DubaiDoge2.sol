...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9402B2Bf12Fc1e76DBdF59aa3311377C45fCeF9A;
...
contract DubaiDoge2 is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xAb593585d32E489255c4Fb1a527d099e0E66Be62;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100 * 10**7 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DubaiDoge 2.0";
    string private _symbol = "DubaiDoge2.0";
