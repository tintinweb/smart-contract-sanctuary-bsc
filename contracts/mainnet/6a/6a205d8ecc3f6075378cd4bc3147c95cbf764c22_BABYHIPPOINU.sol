...
contract BABYHIPPOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Baby Hippo Inu";
    string private _symbol = "Baby HINU";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x1303f73D763DE932DF0f12Fe0cf17bf4d69FAEd8;
