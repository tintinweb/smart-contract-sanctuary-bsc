...
/* Token contract */
contract CAKEinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd39d0069439Bcd73913409960c1f502b408d0B45;
    ...
    // Name and symbol
    string constant _name = "Cake Monster Inu";
    string constant _symbol = "CAKEinu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xd39d0069439Bcd73913409960c1f502b408d0B45;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).mul(75).div(50);
        uint256 amountBNBReflection = amountBNB.mul(reflectionFee).div(totalBNBFee).mul(75).div(100);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).mul(75).div(100);
        uint256 amountBNBDev = amountBNB.mul(totalFee).div(totalBNBFee).mul(25).div(100); 
    ...
    function manualSend() external authorized {
        ...
        uint256 contractETHBalancea = contractETHBalance.mul(75).div(100);
        uint256 contractETHBalanceb = contractETHBalance.mul(25).div(100);
