...
pragma solidity ^0.8.5;
   ...
   // https://t.me/SteyrInuBSC
   // https://twitter.com/Steyr_Inu_BSC
...
contract STEYRINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Steyr Inu";
    string private _symbol = "STEYR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFD08E7c7e44C163B8435802C4971442aA5a9a738); 
    address payable public buyBackWalletAddress = payable(0x531e495f9B22200b7cf4e45e1B71fFac8D65Ffb7); 
