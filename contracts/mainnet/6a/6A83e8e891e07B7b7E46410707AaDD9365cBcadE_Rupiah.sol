...
contract Rupiah is BEP20, Auth {
    ...
    string public constant name = "Rupiah";
    string public constant symbol = "CBDC";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 1000 * 10**4 * 10**decimals;
