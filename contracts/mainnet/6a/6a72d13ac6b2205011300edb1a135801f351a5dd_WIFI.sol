...
contract WIFI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x0989f24d50aa287cAbBA8a5b93aBc71C7FD28b15); 
    address payable public developmentAddress = payable(0x0989f24d50aa287cAbBA8a5b93aBc71C7FD28b15); 
    address payable public charityAddress = payable(0x0989f24d50aa287cAbBA8a5b93aBc71C7FD28b15); 
    address payable public vaultRewardAddress = payable(0x0989f24d50aa287cAbBA8a5b93aBc71C7FD28b15); 
    address payable public liquidityWallet = payable(0x0989f24d50aa287cAbBA8a5b93aBc71C7FD28b15); 
    ...
    string private constant _name = "WIFI Map";
    string private constant _symbol = "WIFI";
    ...
    uint256 public _sellVaultFee = 5;
    ...
    uint256 public _sMaxTxAmount = 1000  * 10**2;
    uint256 private _trigger = 1000000000  * 10**2;
    uint256 private minimumTokensBeforeSwap = 1000  * 10**2; 
