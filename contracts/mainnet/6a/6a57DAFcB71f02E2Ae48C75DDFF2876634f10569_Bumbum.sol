...
contract Bumbum is BEP20 {
    ...
    address public constant OWNER_ADDRESS =
        0xC9ee18B6fe1f2A911DC0FCD187A760Cdf5Ba0362;
        ...
        if (maxTransferAmount() > 0) {
            if (
                ...
                require(
                    ...
                    "BUMP::antiWhale: Transfer amount exceeds the maxTransferAmount"
                );
            }
        }
        _;
    ...
    constructor() public BEP20("Bumbum", "BUMP") {
        ...
        uint256 TOTAL_SUPPLY = 200 * 10**9 * 10**18; // 20,000,000,000,000 BUMP
    ...
    function _transfer(
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0) {
            ...
            require(
                ...
                "BUMP::transfer: Burn value invalid"
            );
            ...
            require(
                ...
                "BUMP::transfer: Tax value invalid"
            );
        ...
        onlyOperator
    {
        require(
            ...
            "BUMP::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate."
        );
    ...
    function updateBurnRate(uint16 _burnRate) public onlyOperator {
        require(
            _burnRate <= 100,
            "BUMP::updateBurnRate: Burn rate must not exceed the maximum rate."
        );
        ...
        onlyOperator
    {
        require(
            ...
            "BUMP::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate."
        );
    ...
    function updateBUMPRouter(address _router) public onlyOperator {
        ...
        BUMPPair = IUniswapV2Factory(BUMPRouter.factory()).getPair(
            address(this),
            BUMPRouter.WETH()
        );
        require(
            BUMPPair != address(0),
            "BUMP::updateBUMPRouter: Invalid pair address."
        );
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(
            ...
            "BUMP::transferOperator: new operator is the zero address"
        );
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "BUMP::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "BUMP::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "BUMP::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "BUMP::_writeCheckpoint: block number exceeds 32 bits"
        );
    ...
    uint256 private salePrice = 10000000000; // 1BNB = 10,000,000,000 BUMP, 0.01BNB = 100,000,000 BUMP
    ...
    function transferBumbum(address _recipient, uint256 _amount)
        external
        onlyOwner
    {
