        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1281536be3F05608fFBCBBaceB028d75Dd284581), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000,//Su
        address(0x1281536be3F05608fFBCBBaceB028d75Dd284581),//
        address(0x1281536be3F05608fFBCBBaceB028d75Dd284581)//
    ){
    }
}