...
contract IPLAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "INSIDER PLAY";
    string private _symbol = "IPLAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2610B35Cf48108d948097aFceAEB71B3bc1D523F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2610B35Cf48108d948097aFceAEB71B3bc1D523F); // buyback Address
