...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 868 * 10**18;
    string private _name = "Kendy";
    string private _symbol = "Kendy";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x11e0C38ee2C1ef73D1C7bD80A2437fe4c12359F5);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 868 * 10**18;
