...
contract  ICA is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xcBdd8106eb3c70EAA31CC92c6627c9bdBCC83DCd;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 2125 * 10**9;
    ...
    constructor() public ERC20("Ice Cream Assassin", "ICA",9) {
        ...
        _totalSupply = (425000) * (10**9);
        _balances[owner()] = (425000) * (10**9);
          emit Transfer(address(0), owner(), (425000) * (10**9));
    }
