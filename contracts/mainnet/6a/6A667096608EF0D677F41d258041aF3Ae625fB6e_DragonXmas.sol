...
/*
  ...
  //Telegram : https://t.me/DragonXmas
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7342Cf7B8a3Ae007b8e5bb14F5a38C70075DC9A0;
...
contract DragonXmas is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dragon Xmas"; // 
    string private constant _symbol = "DragonXmas"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0x61B872B768D71683ff04C1E8D9Afa9a6F7119717);
    ...
    // switch Trading
    function trading(bool _status) public onlyOwner {
        trading (_status);
    }
