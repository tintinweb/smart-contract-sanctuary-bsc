...
contract SXD is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "SXD";       //Full name
    string public symbol_ = "SXD";      //abbreviation

    uint256 public deadFee = 0;       //Destroyed
    uint256 public liquidityFee = 0;      //LP reflow
    uint256 public marketingFee = 60;      //marketing
    ...
    address public marketingWalletAddress = 0x9903b2bba82a1469c22f07286700527117897DA4;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 16666 * (10**18);       //Supply
