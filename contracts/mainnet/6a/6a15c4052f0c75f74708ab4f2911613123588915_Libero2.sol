...
/*
🟢Libero 2.0 |FAIRLAUNCH

Libero 2.0 ( Libero2 ) is a new hype meme token that build on Binance smart Chain as a 
Decentrallized and autonomous sytem that build and run for community. Our Main target fo are 
to make big utility that govern our farm and our new chain in upcoming future.
...
contract Libero2 is Context, IERC20, Ownable,Signed {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0fb135D1fd41492375C817b0C6d83b1Dfa09bdCe); // Marketing Address
    ...
    string private _name = "Libero 2.0";
    string private _symbol = "Libero2";
    ...
    constructor () {
        ...
        marketingwallet =0x0fb135D1fd41492375C817b0C6d83b1Dfa09bdCe;
