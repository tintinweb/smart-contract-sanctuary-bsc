...
contract FlokiCOIN is IBEP20, Auth {
    ...
    string constant _name = "FlokiCoin";
    string constant _symbol = "FLOKI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //4% max tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100;  //4% max wallet
    ...
    address private marketingFeeReceiver =0xdF696BDE6836385aAa76047155B2413bc9140D37;
    address private teamFeeReceiver =0xdF696BDE6836385aAa76047155B2413bc9140D37;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xdF696BDE6836385aAa76047155B2413bc9140D37;
