...
contract FrontRunTrackerBot is Context, IERC20, Ownable {
    ...
    string private constant _name = "FrontRun Tracker Bot";
    string private constant _symbol = "FrontRun";
