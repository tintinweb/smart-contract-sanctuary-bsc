...
contract Apecore is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "APECORE";
    string private _symbol = "APECORE";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xfDB980384d0441124669aF9613eB4343Fed8DD88); 
    address payable public teamWalletAddress = payable(0x9e2b67701b058Edc609D1A6093EF244AB47d0520); 
