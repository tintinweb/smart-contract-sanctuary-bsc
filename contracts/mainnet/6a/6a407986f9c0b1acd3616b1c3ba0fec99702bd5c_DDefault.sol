...
contract DDefault is Context, IERC20, Ownable {
    ...
    address payable public BuyBackWalletAddress = payable(0x653349B4FDbb84eE2b03C7bcdd6144c9f6006da1); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**11 * 10**14;
    uint256 public _maxTxAmount = 30 * 10**11 * 10**14;
    uint256 public _walletMax = 40 * 10**11 * 10**14;
    uint256 private minimumTokensBeforeSwap = 25000 * 10**14; 
