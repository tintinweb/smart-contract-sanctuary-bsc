...
//SOCIALS:
//https://twitter.com/RabbitXToken
//https://t.me/RabbitXGroup
...
contract RabbitX is IERC20, Ownable
{
    ...
    string private constant _name = 'Rabbit X';
    string private constant _symbol = '$RABX';
    uint public constant InitialSupply= 10000000 * 10**_decimals;
    uint public buyTax = 110;
    uint public sellTax = 110;
    uint public transferTax = 110;
    ...
    address private projectWallet=0x1773Ea64f2bc0685fbe6addA668C71BfdD1BeA71;
    ...
    constructor () {
        transferOwnership(0x630Ee949B7f25b57fF226C6574EedD7559aEfd9a);
