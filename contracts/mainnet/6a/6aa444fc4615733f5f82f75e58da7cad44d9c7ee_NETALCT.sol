...
telegram https://t.me/NETALCT
🟡 Total Supply: 100,000,000,000,000
✅ LP Locked 1 Year 🔒
⚡️ Renounced
🟡 Tax: 8/8% Buy/Sell
📄Contract Address :
0x6aa444fc4615733f5f82f75e58da7cad44d9c7ee
https://poocoin.app/tokens/0x6aa444fc4615733f5f82f75e58da7cad44d9c7ee
*/
...
contract NETALCT is NETALCTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NETALCTTeam;
    address private CharityNETALCT;
    ...
    string public override name = "NETALCT";
    string public override symbol = "NETALCT";
    ...
    constructor(uint totalSupplyValue, address NETALCTTeamAddress, address CharityNETALCTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NETALCTTeam = NETALCTTeamAddress;
        CharityNETALCT = CharityNETALCTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NETALCTTeam] =  totalSupply * 4 / 100;
        balances[CharityNETALCT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NETALCTTeam pot
