...
contract NYDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "$NY DOGE";
    string private constant _symbol = "$NYDOGE";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 8000 * 10**_decimals;
    uint256 public _maxTxAmount = 240 * 10**_decimals;
    uint256 public _maxWalletAmount = 240 * 10**_decimals;
