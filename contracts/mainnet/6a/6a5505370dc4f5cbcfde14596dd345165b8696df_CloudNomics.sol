...
CloudNomics ($CN) is an inspired token of CloudChat ($CC) that went sky rocket to moon.
This is the perfect timing to join us to moon and make some good x's.
Telegram: https://t.me/CloudNomics
...
contract CloudNomics is Context, IERC20 { 
    ...
    string private constant _name = "CloudNomics"; 
