...
Telegram : https://t.me/babydogeclassic
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        _owner = 0x47A89A6E65E09F5836d031868DcC526e831a6C39;
        owner = _owner;
...
contract BabyDogeClassic is IBEP20, Auth {
    ...
    string  _name = "Baby Doge Classic";
    string  _symbol = "$BABYDOGEC";
    ...
    address private marketingFeeReceiver = payable (0xeC2bD83f470FD1a8C5D15c6768ba78Fc8B73A935);
    address private buybackFeeReceiver = payable (0xeC2bD83f470FD1a8C5D15c6768ba78Fc8B73A935);
    ...
    uint256 public swapThreshold = _totalSupply / 4000000 * 1; // 0.4%
    bool inSwap;
