...
contract PIGEINUV2 is Context, IERC20, Ownable {
    ...
    string private _name = "Pige Inu 2.0";
    string private _symbol = "PINU2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e8a0C68517c59357B780Ae04E4787546e2751df); 
    address payable public buyBackWalletAddress = payable(0xD4A17554acb7C6a334B74227510571E445CAb90D); 
