...
contract METABABY is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000000;   //10 ASGARD tokens
    // Trading bool
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if (sender == owner() || recipient == owner() || isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
            ...
            require(isBlocked[sender] == false, "The sender address is blocked");
    ...
    function setBlockList(address _account, bool _blocked) public onlyOperator {
