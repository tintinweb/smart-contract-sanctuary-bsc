...
contract MEGATRON is IBEP20, Auth {
    ...
    string constant _symbol = "mTRON";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; //1,000,000

        //max wallet holding of 5%
    uint256 public _maxWalletToken = _totalSupply  / 20; //5,000,000
    ...
    uint256 public swapThreshold = _totalSupply / 125; //800,000
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x0128F0D67E6f49Fc1094A54Fd39A363aF161a9ac; 
