...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18cE38ef665228B880ee02063528eD83DB96254C; // owner address
...
contract Mosquito is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2Dc2BAF8bC77822b227000b4d323cE512Ea2000F); // Marketing Address
    address payable public teamWalletAddress = payable(0x2Dc2BAF8bC77822b227000b4d323cE512Ea2000F); // Team Address
    ...
    uint256 private _totalSupply = 4000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 4000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 4000000000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 4000000000000000000000000 * 10**3; 
