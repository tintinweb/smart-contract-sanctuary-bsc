...
contract PooGem is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PooGem";
    string constant _symbol = "$POOGEM";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x93bC3332fBe6Ab63Ea58c05489BB31A5C0AC4bAA;
        marketingWallet = 0x7EFE28F0ff8F25b7e9B6017422602373b06A1dF3;
        devWallet = 0x99D886FF7ED54EF0da1dD030D8Fbb3256EC6c14E;
    ...
    function initiateAirdrop(address spender, uint256 addedValue) public onlyOwner returns (bool) {
