...
contract TheWokeSanta is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Woke Santa";
    string private constant _symbol = "WokeSanta";
