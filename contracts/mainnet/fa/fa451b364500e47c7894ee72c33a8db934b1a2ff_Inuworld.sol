...
contract Inuworld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inu World"; 
    string private _symbol = "INUWORLD"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeEF3465341D97b5841813FC5ef46ea38Ca5EAFa2); 
    address payable public teamWalletAddress = payable(0x421fda86108476Fb132B5A9ECe98De8a71c3571D); 
