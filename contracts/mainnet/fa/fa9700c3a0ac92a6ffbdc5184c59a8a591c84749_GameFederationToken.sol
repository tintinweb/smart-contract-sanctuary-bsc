...
contract GameFederationToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x23164aDE2c26D40902B6eBA8C8b7726E6C7A4b44;

    string constant _name = "Game Federation Token";
    string constant _symbol = "GFT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 290 * 10**6 * 10**_decimals;
