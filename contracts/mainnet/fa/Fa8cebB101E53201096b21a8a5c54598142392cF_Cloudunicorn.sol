...
// File: contracts/CloudUnicorn.sol
...
contract Cloudunicorn is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 80_000_000 * 10 ** _decimals;
    ...
    address public marketingWallet = 0xbFA0A6D18F1A39cD42754610F7A8622C8C4344A4;



    string private constant _name = "Cloud Unicorn";

    string private constant _symbol = "CU";
    ...
    Taxes public taxes = Taxes(0, 7, 1, 0);
