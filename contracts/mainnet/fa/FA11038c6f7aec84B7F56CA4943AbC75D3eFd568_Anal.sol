...
Telegram : https://t.me/AnalDusttwopoint0
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBabd83B9e6Bb6430Dd5E466Dc30377f1b68B4220;
...
contract Anal is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANAL DUST 2.0"; // 
    string private constant _symbol = "$ANALDUST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xBabd83B9e6Bb6430Dd5E466Dc30377f1b68B4220);
