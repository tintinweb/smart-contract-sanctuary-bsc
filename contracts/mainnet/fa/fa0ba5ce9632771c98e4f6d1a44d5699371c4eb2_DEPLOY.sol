...
contract DividendDistributor is IDividendDistributor {
    ...
    // Dinoland Metaverse Rewads
    IERC20 HDV = IERC20(0x8Cd0d76C0ad377378aB6Ce878a7BE686223497eE);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 balanceBefore = HDV.balanceOf(address(this));
        ...
        uint256 amount = HDV.balanceOf(address(this)) - balanceBefore;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            HDV.transfer(shareholder, amount);
        }
    }
...
contract DEPLOY is Context, IERC20 { 
    ...
    */
    ...
    function Rewards_DistroTrigger_Time(uint256 Minutes_Between_Payments) external onlyOwner {
        ...
        // Max Wait is 8 hours
        require(Minutes_Between_Payments <= 61,"Max time to wait between reward distribution is 8 hours (480 mins)");
