...
/**
Official contract of Zig INU.
Join our TG for get more information.
...
Degen Play but we will push this to make the new meta token.Last project went go x100 from dip
with 150k marketcap.

Telegram: https://t.me/zigINUcoinPortal
Website: https://www.ziginu.play
Twitter: https://twitter.com/zig_inuofficial
...
contract ZigINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x986f7a227498f977C65fA6E1A57F73d3778fC1F8); 
    address payable public Wallet_Dev = payable(0x986f7a227498f977C65fA6E1A57F73d3778fC1F8);
    ...
    string private constant _name = "ZigINU"; 
    string private constant _symbol = unicode"Zig"; 
    ...
    uint256 public _maxWalletToken = 10**9 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x986f7a227498f977C65fA6E1A57F73d3778fC1F8;
