...
Telegram : https://t.me/teamfinancetwo

website  : TBA

Welcome to TeamFinance 2.0!

You will have seen team finance everywhere… good and the bad! It’s Team Finance 2.0 we really want to see 👀!

Join us as we work towards finding the Team Finance 2.0. Remember, Team Finance 2.0 gives you moon and gains…. Let’s use to them to take us to the moon!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42Db55efA20a2bCdE137A1594E061d274D0193c5; // owner address
...
contract teamfinancetwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Team Finance 2.0";
    string private _symbol = "TF 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe212C17cc6EE7aF87345e441e23043Af58d14BC5); // Marketing Address
    address payable public teamWalletAddress = payable(0x42Db55efA20a2bCdE137A1594E061d274D0193c5); // Team Address
