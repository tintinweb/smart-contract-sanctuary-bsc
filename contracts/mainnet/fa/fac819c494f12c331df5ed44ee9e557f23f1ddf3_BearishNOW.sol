...
contract EXCHANGER is STOPALLNOW {
...
contract BearishNOW is STOPALLNOW, CLOSEALLNOW, EXCHANGER {
  ...
  string public _name;
  constructor() public {
    _name = 'BTC Extremely Bearish';
    _symbol = 'BTCEB';
    _decimals = 9;
    _AlltotalSupply = 2100000000000000000;
