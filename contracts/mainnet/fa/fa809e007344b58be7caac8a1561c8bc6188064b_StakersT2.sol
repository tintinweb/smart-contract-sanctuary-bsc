...
contract StakersT2 {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 100000 ether;//100 000 tokens minimum deposit 
    uint256 public INVEST_LIMIT_AMOUNT = 1000000000 ether;//limit tokens for buy BNB
