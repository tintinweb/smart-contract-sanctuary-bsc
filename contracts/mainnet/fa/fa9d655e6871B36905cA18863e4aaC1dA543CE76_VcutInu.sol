...
/*
Vcut potato chips safe project under binance launching 1st April
Initial Mc would be 1-5 bnb 
Contract will renounce and Lp would be locked launch soon ❤️
...
contract VcutInu is IBEP20, Auth {
    ...
    address constant DEV = 0x4B7842f8CD7AF423BeA2F5761C313C6EB31aC157;


    string constant _name = "Vcut Inu";
    string constant _symbol = "$VCINU";
