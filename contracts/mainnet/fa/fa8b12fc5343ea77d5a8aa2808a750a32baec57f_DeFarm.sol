...
contract DeFarm is IERC20 {
    ...
    uint256 constant public maxBuyTaxes = 1300;
    uint256 constant public maxSellTaxes = 1300;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        treasury: payable(0x000000000000000000000000000000000000dEaD)
        });
    ...
    constructor () payable {
        ...
        _isExcludedFromFees[_taxWallets.treasury] = true;
        _isExcludedFromFees[_taxWallets.tokens] = true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (sell) 
        {
            ...
            if (buyBackEnabled && tradingEnabled) {
