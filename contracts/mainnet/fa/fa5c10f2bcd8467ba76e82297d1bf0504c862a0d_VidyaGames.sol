...
contract VidyaGames is ERC20, ERC20Burnable, Ownable {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = totalSupply() * 200 / 10000; // 2%
    uint256 public _maxSellTxAmount = totalSupply() * 100 / 10000; // 1%
    uint256 public _maxWalletToken = ( totalSupply() * 200 ) / 10000; // 2%
