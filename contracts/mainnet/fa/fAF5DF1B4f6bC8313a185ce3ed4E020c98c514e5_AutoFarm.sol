...
contract AutoFarm is Ownable, Pausable {
    ...
    constructor(IERC20 _stakingToken, IMasterchef _masterchef, gSTEEMFIToken _govToken, address _treasury, uint256 _depositFee, uint256 _minDeposit, uint256 _poolId) {
    ...
    function deposit(uint256 _amount) public whenNotPaused notContract{
        ...
        gSTEEMFI.mint(msg.sender, currentShares);
    ...
    function withdraw(uint256 _shares) public notContract {
        ...
        gSTEEMFI.burn(msg.sender, _shares);
