...
*/
// telegram : https://t.me/clubofceos
// Developer : @StarsLocker
...
contract BattleOfBear is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private limitBurn = 100000000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 50000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 20000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 20000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 500000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Battle Of Bears";
