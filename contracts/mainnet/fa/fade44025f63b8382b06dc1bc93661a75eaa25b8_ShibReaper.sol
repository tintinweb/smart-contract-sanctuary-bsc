...
Telegram Link: https://t.me/shibreaper

Shib Reaper has risen from the underworld to conquer the meme space and execute the rest!
...
/* Token contract */
contract ShibReaper is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x92149FcBA4D35258b8032E87246B7f356dBfCFCF;
    ...
    // Name and symbol
    string constant _name = "Shib Reaper";
    string constant _symbol = "SHREAPER";
