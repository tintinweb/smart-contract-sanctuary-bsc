...
contract BSC is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0xD3CEA05E9B1fB3800F54B192184f7b1fB50E7C06);
        teamWallet= payable(0x7Ca2147d968B7fB4A09950eBd7489D2415Dc69a7);

        marketingFee = 1;
        liquidityFee = 2;
        _totalTax = marketingFee + liquidityFee; 

        _totalSupply = 413000000000 * 10**_decimals;
        _maxOnceEat = 413000000000 * 10**_decimals;
        _maxTotalEat = 413000000000 * 10**_decimals;
