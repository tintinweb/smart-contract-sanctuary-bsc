...
contract QUEENCATS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd13735FF1BE6533BE6863ddB1D193229660cc4F0); 
    address payable public Wallet_Dev = payable(0xd13735FF1BE6533BE6863ddB1D193229660cc4F0);
    ...
    string private constant _name = "Queen Cats"; 
    string private constant _symbol = "QUEENCATS"; 
    ...
    constructor () {
        ...
        _owner = 0xd13735FF1BE6533BE6863ddB1D193229660cc4F0;
