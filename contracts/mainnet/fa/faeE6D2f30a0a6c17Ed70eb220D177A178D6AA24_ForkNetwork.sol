...
contract ForkNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xA66C31D9230F1277185aD14B32C9FFe0c54Acc41);
    ...
    */
    ...
    uint256 public _max_WalletToken = _tTotal.mul(1).div(1000);
    uint256 private _previousMaxWalletToken = _max_WalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _max_TxAmount = _tTotal.mul(1).div(1000); 
    uint256 private _previousMaxTxAmount = _max_TxAmount;
    ...
    */
    ...
    function _set_Fees(uint256 Tax_Buy, uint256 Tax_Sell) external onlyOwner() {

        require((Tax_Buy + Tax_Sell) <= maxPossibleFee, "Fee is too high!");
        _sellTax = Tax_Sell;
        _buyTax = Tax_Buy;
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _max_TxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _max_WalletToken = _tTotal*maxWallPercent_x100/10000;
    }
