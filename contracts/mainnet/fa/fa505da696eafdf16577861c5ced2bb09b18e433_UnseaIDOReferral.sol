...
// File: contracts\UnseaIDOReferral.sol

pragma solidity ^0.8.0;

contract UnseaIDOReferral is IIDOReferral, Ownable {
     ...
     * @notice Check if a user has referrer
     */
    function hasReferrer(address _user)
        external
        view
        override
        returns (bool)
    {
        return !(referrers[_user] == _user || referrers[_user] == address(0));
    }
