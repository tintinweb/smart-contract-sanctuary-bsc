...
// 
//
// 📱 Telegram:https::https://t.me/HOMESquid
/*
...
contract HOMESQUID is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("HOME SQUID", "HOMESQUID") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "HOMESQUID";
    string private _symbol = "HOMESQUID";
