...
https://www.asumainu.com/

4/4 Taxes

No premade community telegram, we want you to build your own community to learn what it means to sacrifice your time in order to plant the seeds to grow as a unit.
...
pragma solidity ^0.6.12;
    ...
    contract Asuma is Context, IERC20, Ownable {
        ...
        string private _name = 'Asuma Inu';
        string private _symbol = 'ASUMA';
