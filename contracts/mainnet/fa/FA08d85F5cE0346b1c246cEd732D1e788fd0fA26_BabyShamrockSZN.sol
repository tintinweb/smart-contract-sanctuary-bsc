...
contract BabyShamrockSZN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyShamrockSZN";
    string private _symbol = "ShamrockSZN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49D4Bd408441d1a901225ac703181D8eCdab85b6);
    address payable public teamWalletAddress = payable(0x49D4Bd408441d1a901225ac703181D8eCdab85b6);
