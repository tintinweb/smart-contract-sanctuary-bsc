...
contract Wine is ERC20, Ownable {
    ...
    constructor() ERC20("Wine Protocol", "WINE") {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256) external onlyOwner {
