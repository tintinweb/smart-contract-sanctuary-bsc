...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC4b0b813A68727534D4C951A7543d2e798117041;
...
contract GodZemmour is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x42a5f19cA09c936d26AF996AD8AcF095062B2154;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GodZemmour";
    string private _symbol = "GZR";
