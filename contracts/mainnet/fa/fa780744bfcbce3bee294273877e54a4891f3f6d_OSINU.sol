...
contract OSINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08bd1e49EA114a14fd6864cB1EE08Ec5be639cF8);
    address payable public Wallet_Dev = payable(0x54959dB097848664987C18ea25225f4C18B4b62b);
