...
https://t.me/MoonZeroBSC

ZEROOOOOOOOOOOOOOOOOOOOO PERCENT TAX, 100% MOONSHOT!!!

MoonZero is project that is created on the Binance Smart Chain which is formed to deliver a solid MOON MISSION with ZERO PERCENT TAX on both Buys and Sells.
...
contract MoonZero  is IBEP20, Auth {
    ...
    //MoonZero is destined to be a no tax MoonShot!
}