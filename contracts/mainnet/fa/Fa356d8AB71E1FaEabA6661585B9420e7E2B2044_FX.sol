...
contract FX is ERC20 {
    ...
    constructor() ERC20("FX", "FX") {
        ...
        marketAddress = address(0x041570Ce51193fb80aD288D490b76837EcF508a1);
        uniswapV2Pair = IUniswapV2Pair(IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address(OSK)));
        IUniswapV2Pair uniswapV2PairUSDT = IUniswapV2Pair(IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address(usdt)));
