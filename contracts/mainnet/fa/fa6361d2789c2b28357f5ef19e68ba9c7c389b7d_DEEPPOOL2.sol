...
contract DEEPPOOL2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAcc5be242bAbd59245b1645eCbD4Ad4Bd8BfcE8d); 
    address payable public Wallet_Dev = payable(0xAcc5be242bAbd59245b1645eCbD4Ad4Bd8BfcE8d);
    ...
    string private constant _name = "DEEPPOOL2"; 
    string private constant _symbol = "DEEPPOOL2"; 
    ...
    constructor () {
        ...
        _owner = 0xAcc5be242bAbd59245b1645eCbD4Ad4Bd8BfcE8d;
    ...
    function setFeeBuySell(uint256 value)   public{
