...
//SPDX-License-Identifier: MIT   Website: http://projectdogefighter.com 
...
contract DogeFighter is IBEP20, Auth {
    ...
    address DEV = 0x8c02d7dd25Efe742A384F033C057D66A2D0eb892;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 600 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 800 ) / 10000; // 4% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5a933FE8fd0598001ef8833c1e767523E762edcd;
