...
contract StormCOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3BBA65B70b0A950b8Ec9f93eB3D969FB9F68Ffe1); 
    ...
    string private constant _name = "Storm Coin"; 
    string private constant _symbol = unicode"$TOCOI"; 
