...
contract QueenElizabethShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Queen Elizabeth Shib";
    string private _symbol = " $QES "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59eDE6b2C38c8BB04406Ab904ee3F2360CeB30A7); 
    address payable public teamWalletAddress = payable(0x59eDE6b2C38c8BB04406Ab904ee3F2360CeB30A7);
    ...
    uint256 private minimumTokensBeforeSwap = 300000000  * 10**_decimals;
