...
* | $$  \ $$| $$\  $$$| $$  \ $$| $$  \ $$| $$  | $$| $$  | $$| $$\  $$$
* | $$$$$$$/| $$ \  $$| $$$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/| $$ \  $$
* |_______/ |__/  \__/|_______/ |_______/  \______/  \______/ |__/  \__/
...
*                                                                                     
* BNBBOON WORLD - New BNB Miner Game
* H2E (Hire to Earn)
*
* Get GOLD, Earn BNB

* Website  : https://bnbboon.finance
*
*/
...
contract BNBBOON is ReentrancyGuard {
    ...
    function hireMoreBaboons(bool isCompound) public nonReentrant {
    ...
    function hireBaboons(address ref) public payable {
        require(contractStarted, "Contract not yet Started.");
        User storage user = users[msg.sender];
