        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xb217468345F149D24241BBF1f2979b9B58588718), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x04c9F5Fc474f197e5FC0EA2914E980446C8aBf6B),//FundAddress
        address(0x4Ce3F2286E4aC8447CB103EfA81F38Ee89C95F21)//ReceiveAddress
    ){
    }
}