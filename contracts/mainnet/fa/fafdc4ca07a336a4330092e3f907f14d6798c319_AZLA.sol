...
contract AZLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "AZLA";
    string private constant _symbol = "AZLA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xE2AE786E0493e657B5Fc5380CEC05a37b59Db9E3);
    address payable private _marketingAddress = payable(0xE2AE786E0493e657B5Fc5380CEC05a37b59Db9E3);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 98, "Redis cannot be more than 98.");
	    require(taxFeeOnBuy < 10, "Tax cannot be more than 10.");
	    require(taxFeeOnSell < 98, "Tax cannot be more than 98.");
