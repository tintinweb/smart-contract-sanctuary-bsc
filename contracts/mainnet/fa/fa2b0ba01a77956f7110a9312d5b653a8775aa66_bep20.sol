...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEE6cC73Ed237c0f131c4f5184aCF9a0f8aA47867; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Santa Moon 2023";
    string private _symbol = "sm2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEE6cC73Ed237c0f131c4f5184aCF9a0f8aA47867); // Marketing Address
    address payable public teamWalletAddress = payable(0xEE6cC73Ed237c0f131c4f5184aCF9a0f8aA47867); // Team Address
