...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 USDT = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF);
...
/* Token contract */
contract SkyLands is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address USDT = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xaD34318066Aa40e8c9215CA991Cfef0CfB081c38;
    ...
    // Name and symbol
    string constant _name = "SkyLands";
    string constant _symbol = "SKY";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000 * (10 ** _decimals); // 1000
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA4ab8c7a6ea771C184e801A8142C07e2F669D63A;
