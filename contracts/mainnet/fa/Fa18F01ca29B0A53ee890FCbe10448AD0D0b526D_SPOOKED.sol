...
/**
 * Telegram: https://t.me/spookedinu
...
/* Token contract */
contract  SPOOKED is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x4f74CbC540Fa4282F0Fd0BE0957E806E6A7E095e;
    ...
    // Name and symbol
    string constant _name = "Spooked Inu";
    string constant _symbol = "SPOOKED";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 200000000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 600 / 1000; // 3% 
    uint256 private _maxSellTxAmount = _totalSupply * 600 / 1000; // 3% 
    uint256 private _maxWalletToken = ( _totalSupply * 10000 ) / 1000; // No max wallet
    ...
    uint256 private marketingFeeSell = 15;
    uint256 private autoburnsell = 4;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4f74CbC540Fa4282F0Fd0BE0957E806E6A7E095e;
