...
contract Dogek is IERC20, Ownable {
    ...
    uint256 public _inviterFee = 75;
    address public inviterAddress = address(0xe77e26FB8Cce4FF29ACED00c645Bf0108825FddB);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public receiveReward1Token = address(0xe77e26FB8Cce4FF29ACED00c645Bf0108825FddB);
    ...
    constructor(address tokenOwner) {
        ...
        uint256 leftAmount = 100000 * 10**_decimals;
