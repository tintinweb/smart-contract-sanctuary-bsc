...
contract Holland is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Holland";
    string private _symbol = "Holland";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3cd93Fb499D640D2ABc34270124e92E0e4eB1E1); 
    address payable public BurnedWalletAddress = payable(0xa3cd93Fb499D640D2ABc34270124e92E0e4eB1E1); 
