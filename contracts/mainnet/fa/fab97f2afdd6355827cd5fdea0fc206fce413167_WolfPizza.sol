...
contract WolfPizza is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wolf Pizza";
    string private _symbol = "WolfPizza";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xaF979721d3aBA6B2a757e33Cf6bDC3C9ba3A4392);
