...
contract LASTOR is LASTORDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private LASTORTeam;
    address private CharityLASTOR;
    ...
    string public override name = "THE LASTOR";
    string public override symbol = "LASTOR";
    ...
    constructor(uint totalSupplyValue, address LASTORTeamAddress, address CharityLASTORAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        LASTORTeam = LASTORTeamAddress;
        CharityLASTOR = CharityLASTORAddress;
       
        // split the tokens according to agreed upon percentages
        balances[LASTORTeam] =  totalSupply * 4 / 100;
        balances[CharityLASTOR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LASTORTeam pot
