...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFccB4F1E432269EA902C14017B01b2e8b7852102; // owner address
...
contract CCPCToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCPC";
    string private _symbol = "$CCPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFccB4F1E432269EA902C14017B01b2e8b7852102); // 
    address payable public teamWalletAddress = payable(0xFccB4F1E432269EA902C14017B01b2e8b7852102); // 
