...
contract Fortuneum is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xe660e3465c49EfA0c972aBC251954b460325f8A9;

    string constant _name = "FORTUNEUM";
    string constant _symbol = "FORTUNE";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(SniperMode){
            require(!isSniper[sender] && !isSniper[recipient],"Oops! Sniper");    
        }
    ...
    function set_Sniper(address[] calldata addresses, bool status) public onlyOwner {
