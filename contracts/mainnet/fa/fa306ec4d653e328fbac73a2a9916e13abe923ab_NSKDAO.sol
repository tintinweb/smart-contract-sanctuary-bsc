...
contract NSKDAO is Context, ITRC20, Ownable {
    ...
    string private _name = 'NSKDAO Token';
    string private _symbol = 'NSKDAO';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 1111 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 111 * 10**uint256(_decimals);
