...
contract BusdCrops {
    ...
    constructor(address _dev1, address _dev2, address _dev3, address _dev4, address _dev5, address _mkt) {
		require(!isContract(_dev1) && !isContract(_dev2) && !isContract(_dev3) && !isContract(_dev4) &&  !isContract(_dev5) && !isContract(_mkt));
        owner = msg.sender;
        dev1 = _dev1;
        dev2 = _dev2;
        dev3 = _dev3;
