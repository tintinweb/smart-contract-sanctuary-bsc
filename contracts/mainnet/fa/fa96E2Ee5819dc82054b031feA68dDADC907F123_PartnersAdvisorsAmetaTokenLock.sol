 ...
 */
contract PartnersAdvisorsAmetaTokenLock {
    using SafeERC20 for IERC20;

    string public name = "Partners and Advisors Token Lock";
    ...
    // total lock 50M token
    uint256 public totalAllocation = uint256(50_000_000 * 10**18);
