...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0548910aF66aF9B6024eb6cff32f7315915c0B7;
...
contract PESO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xEA844cA54f40B3dD6ce875Fe6e293d42Be4Faa1A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PESO";
    string private _symbol = "PESO";
