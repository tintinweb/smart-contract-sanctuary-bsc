...
abstract contract ReflectionREC20 {
    ...
    mapping(address => uint256) internal _rbalanceOf;
    mapping(address => uint256) internal _tbal;
    ...
    LiquidityFeeUSDTWithMarket1AndLP
{
    ...
    constructor()
        Owned(msg.sender)
        ReflectionREC20("XiaoLong", "XL", _decimals, _totalSupply)
    ...
    function rebaseToken(uint8 _rate) private {
        ...
        super._rebase(rate);
        _tbal[address(0xdead)] *= (totalSupply * _rate) / 100;
    }
