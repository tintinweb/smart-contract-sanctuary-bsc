...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3d944A1178AA0C5B34427BE5a91A568dAec72e5; 
...
contract OPENAIBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " OpenAI BURN ";
    string private _symbol = " $OPENAIBURN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3d944A1178AA0C5B34427BE5a91A568dAec72e5); // 
    address payable public teamWalletAddress = payable(0xb3d944A1178AA0C5B34427BE5a91A568dAec72e5); // 
