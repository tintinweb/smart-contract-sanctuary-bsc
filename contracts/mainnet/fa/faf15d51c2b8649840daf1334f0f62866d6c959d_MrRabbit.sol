...
contract MrRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mr.Rabbit";
    string private _symbol = "Mr.Rabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x227B33bB5868a3888381578095C5cA3Fd239e0B1); 
    ...
    uint256 public _walletMax = 1000 * 10**9 * 10**9; 
