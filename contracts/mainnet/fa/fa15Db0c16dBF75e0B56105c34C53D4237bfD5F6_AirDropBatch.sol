...
contract AirDropBatch is math{
    ...
    function AirDropBatchToken(address _airdropTokenaddr, uint _airdropAmounts, address[] memory _deliveryAddrs) public onlyManager returns (bool) {
        uint _addressAmount = _deliveryAddrs.length;
