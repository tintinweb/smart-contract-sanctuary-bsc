...
The technological CHIPINU is a hypothetical point in time at which technological growth will become radically faster and uncontrollable, resulting in unforeseeable changes to human civilization. According to the most popular version of the CHIPINU hypothesis, an upgradable intelligent agent will eventually enter a “runaway reaction” of self-improvement cycles, each new and more intelligent generation appearing more and more rapidly, causing an “explosion” in intelligence and resulting in a powerful superintelligence that qualitatively far surpasses all human intelligence.
$CHIPINU will be marked by exponential growth through technological innovation.
...
contract CHIPINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CHIPINU", "CHIPINU") {
