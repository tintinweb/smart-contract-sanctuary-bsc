...
contract Qatar is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, AccessControl {
    ...
    string public tokenURIPrefix = "https://melimarketplace.s3.ap-east-1.amazonaws.com/nft/token_";
    
    string public tokenURISuffix = ".json";

    constructor() ERC721("Fever Pitch Qatar2022"," Qatar") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(PAUSER_ROLE, msg.sender);
    }
    
    event LotteryBirth(address indexed owner,uint256 indexed tokenId);
    ...
    function lotteryBirth(address _owner)  
        ...
        external 
    {
        ...
        emit LotteryBirth(_owner,tokenId);
    }
