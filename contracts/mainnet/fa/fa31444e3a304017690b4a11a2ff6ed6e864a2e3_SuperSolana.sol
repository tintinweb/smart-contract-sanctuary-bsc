...
contract SuperSolana is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Solana";
    string private constant _symbol = "SuperSol";
