...
contract SHJ is Context, IERC20, Ownable {
    ...
    uint256 public buyTotalFee = 400;
    ...
    uint256 public maxFistAmount = 5 * 10 ** 17;
    ...
    function setCurrentTime(uint ct)external onlyFunder{
        currentTime = ct;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            && IERC20(roToken).balanceOf(address(this)) > maxFistAmount
