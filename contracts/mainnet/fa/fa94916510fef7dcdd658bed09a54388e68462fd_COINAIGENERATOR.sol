...
contract COINAIGENERATOR is Context, IERC20, Ownable {
    ...
    constructor (string memory userinput_token_symbol,string memory userinput_token_name,address userinput_marketingWallet,address userinput_teamWallet, uint256 userinput_totalsupply) {

        _name = userinput_token_name;
        _symbol = userinput_token_symbol;
        marketingWalletAddress = payable(userinput_marketingWallet);
        teamWalletAddress = payable(userinput_teamWallet);
