...
library Address{
 ...
 contract SMOON2 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9bbC4c69b629542406C37107890453549df900a1;
    address public donationWallet = 0x77eeaDb635AdcB9E0D90a3174c6225B743eC8cF3;

    string private constant _name = "StakeMoon 2.0";
    string private constant _symbol = "SMOON2";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 0, 10);
