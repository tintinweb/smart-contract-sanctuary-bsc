...
contract SUCGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUC Grow"; // 

    string private constant _symbol = "SUCGROW"; // 
    ...
    address public  _marketingWallet = 0xA5Be43ca4dCDB4f688cd654CfCE339ceFeFD24fc;
