...
library Address{
 ...
 contract BabyVicStep is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby VicStep";
    string private constant _symbol = "BVIC";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 2, 0);
