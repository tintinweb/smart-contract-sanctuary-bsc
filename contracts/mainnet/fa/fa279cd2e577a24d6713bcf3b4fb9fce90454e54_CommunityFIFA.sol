...
contract CommunityFIFA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Community FIFA";
    string private _symbol = "FIFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x512cbf6F67EDbD7a2A5b08170F7640cde4e045b6);
    address payable public BuyBackWalletAddress = payable(0xcef66A852b0f35E712A7b292eE530BB1CBeb8ab1); 
