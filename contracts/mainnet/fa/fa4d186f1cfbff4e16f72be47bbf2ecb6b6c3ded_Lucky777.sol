...
/**
WELCOME TO 777 (Fork from 413)
Welcome to 777!

777 is a community based deflationary token. We will start the life journey of this token with a very small LP and tax as we continue to grow all the time.
*/
...
contract Lucky777 is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0xa88A3173468FD5fF5DCaBf1f9228e00f0c1c9D4d); 
    ...
    address private _destroyAddress =
        address(0x000000000000000000000000000000000000dEaD); //deadaddress
    ...
    function FeePercent(uint256 burnFee) external onlyOwner {
        _burnfee = burnFee;
    }
    ...
    function TaxFee(uint256 taxFee, uint256 liquidityFee)
        public
        onlyOwner
    {
        _taxFee = taxFee;
    ...
    function _transferStandard(
        ...
        _takeDestroyFee(sender, tAmount.div(1000).mul(_burnfee), currentRate);
