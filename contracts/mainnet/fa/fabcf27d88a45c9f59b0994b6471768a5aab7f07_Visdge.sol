...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a68aceaDd1B9F8351fed76A5f67Ff1b151912b9;
        // owner address
...
contract Visdge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "VisionDoge";
    string private _symbol = "Visdge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8a68aceaDd1B9F8351fed76A5f67Ff1b151912b9); // Marketing Address
    address payable public teamWalletAddress = payable(0x8a68aceaDd1B9F8351fed76A5f67Ff1b151912b9); // Team Address
    ...
    function setDLVisdge(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEVisdge(uint256 fe) external onlyOwner {
