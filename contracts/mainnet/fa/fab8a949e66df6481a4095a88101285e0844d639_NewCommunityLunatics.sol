...
/**
🌔 NEW COMMUNITY LUNATICS 🌔

#cLunatics The New Community Luna Token
...
✅  Ownership Renounce
✅  LP lock 1001 day On Pinksale
✅  Low Tax Buy and Sell 3%

Tokenomics

60% Liquidity Pancake

40% Burn Token 

Telegram
https://t.me/NewCommunityLunatics

Twitter
https://twitter.com/NewCLunatics

Website on Progress, Live Soon ♨️♨️
*/
...
contract NewCommunityLunatics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "New Community Lunatics";
    string constant _symbol = "NCL";
    ...
    uint256 private _tTotal = 100000 * 10**18 * 10**18;
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 1000000000 * 10**6 * 10**9;
