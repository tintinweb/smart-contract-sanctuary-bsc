...
contract TToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Lang Coin";
    string private _symbol = "LangLaiLe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7600a7a1fB5477663B65dAA149f27b4bca89bD16);
