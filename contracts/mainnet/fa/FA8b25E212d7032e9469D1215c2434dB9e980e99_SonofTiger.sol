...
contract SonofTiger is Context, IERC20, Ownable {
    ...
    string private _name = "LonelyCat";
    string private _symbol = "LonelyCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCeB65654f0C8bB254d7bA823410B269Bd58D3406); // Marketing Address
    address payable public teamWalletAddress = payable(0x8D1bbB4557224fe23551dace064E0C1Db7537635); // Team Address
    ...
    uint256 private _totalSupply = 1000000 * 10**2 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000 * 10**2 * 10**_decimals; 
    uint256 public _walletMax = 1000000 * 10**2 * 10**_decimals;
