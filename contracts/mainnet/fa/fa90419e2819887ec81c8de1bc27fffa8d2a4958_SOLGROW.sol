...
SOLANA GROW
10/10
Telegram : https://t.me/solananomadgrow
*/
...
contract SOLGROW is Context, IERC20, Ownable {
    ...
    string private _name = "SOLANAGROW";
    string private _symbol = "SOLGROW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x07BAE5D87675aD010c362291E98E099b1C736F7f); // Marketing Address
    address payable public teamWalletAddress = payable(0x76d970A61eE1ec9aBF469e432c78143c5D656E8f); // Team Address
