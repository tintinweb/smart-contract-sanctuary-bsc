...
contract ElizabethGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "ElizabethGrow";

    string private _symbol = "ElizabethGrow";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x2b68e8e19D6e655c04a95eAAa9c9A83bFD4985fe;
