...
library DateTimeLibrary {
    ...
    function timestampToDate(uint timestamp) internal pure returns(uint day_str) { 
        ...
        day_str = year * 100 * 100 + month * 100 + day * 10;
    }
...
contract GAME is Owner {
    ...
    address public token_addr = 0xe1b5a0Fb86a13aa1FB70654b2FC4D69B30323f30;
	...
	uint public base_output_amount=10;
	uint public speed_output_amount=60;
    ...
    function speed_output(uint cur_id) external payable lock returns(bool) {
        ...
        require(is_no_out[msg.sender] == true, 'NO OUT');
        ...
        day_speed_out_lists[msg.sender]++;
