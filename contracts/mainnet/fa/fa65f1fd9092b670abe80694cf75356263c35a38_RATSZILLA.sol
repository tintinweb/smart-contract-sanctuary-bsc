...
contract RATSZILLA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RATSZILLA";
    string private _symbol = "RATSZILLA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x28A227E5C328EE5fc6423B9c473a1aed7124C47B);
