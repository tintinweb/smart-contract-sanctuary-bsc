...
/*
    ...
    $AG token is specifically the new and only token in the BSC network.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5E2A6Ed7785FEBc4C25233Cd5cB94934cCDcBcb8; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "Albedo Grow";
    string private _symbol = "$AG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5E2A6Ed7785FEBc4C25233Cd5cB94934cCDcBcb8); // Marketing Address
    address payable public teamWalletAddress = payable(0x5E2A6Ed7785FEBc4C25233Cd5cB94934cCDcBcb8); // Team Address
