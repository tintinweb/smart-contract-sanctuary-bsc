...
┃╰━╯┃╰┫╰╯┃╰╯┃╰╯┃╰╮╭╮╭┫╰╯┃┃┃╰┫╰╯┃┃╰━╯┃┃┃┃╭╮┃╰╮
╰━━━┻━┻━━┻━━┻━━╯╱╰╯╰╯╰━━┻╯╰━┻━━╯╰━━━┻╯╰┻╯╰┻━╯
Telegram: https://t.me/CloudWorldChat
...
/* Token contract */
contract CloudWorldChat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xD24aA27486D2f5C38afe416ED014bFB7FEC3D6F7;
    ...
    // Name and symbol
    string constant _name = "Cloud World Chat";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 20000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 5000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 20000; // 1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x4Bd07161087d68ed930f11E86D5D162bcef5601f;
