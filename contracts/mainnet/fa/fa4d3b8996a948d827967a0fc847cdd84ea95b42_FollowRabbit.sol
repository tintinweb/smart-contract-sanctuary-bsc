...
contract FollowRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "FollowRabbit";
    string private _symbol = "FollowRabbit";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0xCa0d0239549aF4261606a1dCB8B82C9a22ef732F);
    address payable public teamWalletAddress = payable(0xCa0d0239549aF4261606a1dCB8B82C9a22ef732F);
