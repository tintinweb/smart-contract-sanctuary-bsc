...
//  ♥ c0nd3tz leaked p00r ♥  Website: https://c0ndetzleaked.com
...
contract c0nd3tz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "c0ndetzleaked";
    string private _symbol = "LEAK";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x972971e3BD2D07B8756571E3902847BD1A4F15df);
    address payable public teamWalletAddress = payable(0x972971e3BD2D07B8756571E3902847BD1A4F15df);
