...
We all know Aetherius Token is changing lives currently and the Son is here to Be more like the father. As we know, THE APPLE 🍏DOES NOT FALL FAR FROM ITS TREE 🌴 The Son is Fully Doxxed.
...
TG 💎 @sonofaetherius
Twitter💎 twitter.com/Aetheriusson 
Website💎 in progress 
...
contract SETH is  Context, IERC20, Ownable {
    ...
    string private constant _name = "SonOfAetherius"; // 
