...
contract stinkysocks  is IBEP20, Ownable {
    ...
    string constant _name = "stinky socks";
    string constant _symbol = "stinky socks";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1112 * (3 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x7Fb115e369Ae80785068d7f52bAEBA69dB884DB2;
