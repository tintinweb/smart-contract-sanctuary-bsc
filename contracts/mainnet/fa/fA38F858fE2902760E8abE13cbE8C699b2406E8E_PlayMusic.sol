...
contract PlayMusic is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x080F5e7EAe16c267EB4F9cA8750288dCEE2f29d5); // Marketing Wallet Address
    address payable public teamWalletAddress =
        payable(0x05642129d0B3Ba176eabedb68F61a264F577bEA2); // team Wallet Address
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address private PlayMusicDeployer = 0xCbB1674aCE1D76eF38Dde1873D408f1ec208605B;
