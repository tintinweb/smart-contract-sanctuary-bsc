...
EVER PI is a community-focused, open source, peer-to-peer digital asset, on the SMART CHAIN,


ABOUT

Whether you have a good eye for the charts or not it doesn’t matter if  community is strong everyone make money.

EVER PI will keep up this tradition and go straight to the moon.

Why would you choose ?

SMART CHAIN 

EVER PI Wants to Dominate DeFi TVL. With a community roadmap for 2022, the network aims to be one of the top 5 public blockchains by TVL by the end of the year. It has already devised a way to do this: providing better infrastructure for developers, better interoperability, and expansion of its DeFi, Metaverse, GameFi, and NFT ecosystems.

Crypto revolution!

The cryptocurrency revolution is taking place right before our eyes and generational wealth is all the buzz. But what if you missed out on Elon tweets? Guess you'll have to be consoled with the fact that you're not going to miss out on 2022 EVER PI
//https://t.me/EverPi
*/
...
contract EVERPI is Context, IERC20, Ownable {
    ...
    string private constant _name = "EVER PI"; // 
    string private constant _symbol = "EVPI"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x9D1E060df88B2cb868650BB447069eca58ab566a;
