...
contract MiloTwo  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFrom[form] && !_isExcludedFrom[to] ) { _dead = amount.mul(2).div(100);}
