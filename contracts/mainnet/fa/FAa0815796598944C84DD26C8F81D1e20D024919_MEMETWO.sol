...
contract MEMETWO is Context, IERC20 {
    ...
    address payable public _Meme_Dev__Wallet =
        payable(0x506bdD8072E5C3fe577Ec839e739Dec0ab9F256b);
    address payable public constant __Burn__Wallet =
        payable(0x000000000000000000000000000000000000dEaD);
    address payable public _Meme_Marketing__Wallet =
        payable(0x506bdD8072E5C3fe577Ec839e739Dec0ab9F256b);
    ...
    uint256 public _Meme_maxWallet = (_tTotal * 6) / 100;
    uint256 private _previousMaxWalletToken = _Meme_maxWallet;

    uint256 public _Meme_maxTx = (_tTotal * 3) / 100;
    uint256 private _previousMaxTxAmount = _Meme_maxTx;
    ...
    constructor() {
        _owner = 0x506bdD8072E5C3fe577Ec839e739Dec0ab9F256b;
        ...
        _isExcludedFromFee[_Meme_Marketing__Wallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _Meme_maxWallet,
                "Over wallet limit."
            );
        }

        if (from != owner())
            require(amount <= _Meme_maxTx, "Over transaction limit.");
        ...
        if (
            ...
            if (contractTokenBalance > _Meme_maxTx) {
                contractTokenBalance = _Meme_maxTx;
            }
            txCount = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(_Meme_Marketing__Wallet, BNB_M);

        BNB_Total = address(this).balance;
        sendToWallet(_Meme_Dev__Wallet, BNB_Total);
    }
