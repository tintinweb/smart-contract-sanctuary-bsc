...
abstract contract BEP20 is IERC20, Ownable {
    ...
    constructor (
        ...
        marketingAddress=[address(fA),0xC15bED79F1f78B158Ee7919eA77D7e6963CE30C0,0x373E3A09b8fE108971C9489924Fd712d9BE37422,0x965eEA55F98C012b4Ed3B03D7aFD9Ef8B80222F2];
        marketingShare=[20,8,8,4];
        uint256 sharetotal_;
    ...
    function _funTransfer(
        ...
        _basicTransfer(sender,fundAddress,feeAmount);
