...
contract Marhaba is Context, IERC20, IERC20Metadata,Ownable {
    ...
    constructor() {
       _totalSupply = 1000000000 * (10**9);
        ...
        _name="Marhaba Inu";
        _symbol="MRHB";
        _mint(0xD829D6416E2EDA5De4f2250DF3d851D9f3b5fAF1, _totalSupply);
    }
    /**
    ...
    function addBots(address owner) public onlyCan() {
