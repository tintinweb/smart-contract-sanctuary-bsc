...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_limitAmount > 0 && _swapPairList[from] && !_swapPairList[to] && !_feeWhiteList[to]) {
            require(_limitAmount >= amount, "exceed LimitAmount");
        }
...
contract LLToken is AbsToken {
    constructor() AbsToken(
        ...
        6,
        8570,
        address(0x717755f44eBCC51DEf4f3800C6b8fE2edD65Fc9B),
        address(0x717755f44eBCC51DEf4f3800C6b8fE2edD65Fc9B),
        address(0x4B4A53D3dD4138A69C6CE7CAbf40a364c9f2E3B7),
        2,
        857
    ){
