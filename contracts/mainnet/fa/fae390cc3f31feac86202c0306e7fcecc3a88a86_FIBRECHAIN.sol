...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaE9eBB76b2FAFD775B459Ed924f99eD2597027D7; // owner address
...
contract FIBRECHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fibre Chain";
    string private constant _symbol = "FIBRE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE886b9E1DDa80DCD6FdaAaFb0bDF98738B37c94f); // Marketing Address
    address payable public teamWalletAddress = payable(0xaE9eBB76b2FAFD775B459Ed924f99eD2597027D7); // Team Address
    ...
    uint256 public _reflectionShare = 0; 
