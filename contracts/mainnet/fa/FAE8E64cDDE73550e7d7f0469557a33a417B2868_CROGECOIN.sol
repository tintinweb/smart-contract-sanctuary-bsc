...
contract CROGECOIN is IBEP20, Auth {
    ...
    address private marketingFeeReceiver = 0x770AcBf0A2Fe9091756A94ECb898a519c96aA72d;
    ...
    constructor (address _bridge) Auth(msg.sender) {
        ...
        isTxLimitExempt[_bridge] = true;

        _balances[_bridge] = _totalSupply;
        emit Transfer(address(0), _bridge, _totalSupply);
    }
