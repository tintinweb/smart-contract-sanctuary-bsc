...
🎖 $5000 for anyone who spread this project to Elon Musk and tweet Elon Musk, they are entitled to show proof and get $5000 Reward

🎖Give and share this to Elon on twitter :
https://twitter.com/PRESIDENMARS8/status/1632643869128167425?s=20

🎖So that elon links and likes, and get your Reward

join us : t.me/MarsPresident
*/
...
contract MarsPresident is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mars President";
    string private _symbol = "MP1";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xc57E6935e7cA211411B1a18b4fAC94f21c179551);
