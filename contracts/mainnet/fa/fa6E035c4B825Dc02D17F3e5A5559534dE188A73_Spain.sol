...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xa56CbF5393377b7a81b6522C36128D1c6364d4D4;
...
contract Spain  is AbsToken {
    constructor() AbsToken(
        ...
        address(0xF86a653448065F7bdb0453453EfEcdfc01a1feE4),
    
        address(0xb5E4Bd71748169fC168b3Be4A9CC32E09ae61828)
    ){
