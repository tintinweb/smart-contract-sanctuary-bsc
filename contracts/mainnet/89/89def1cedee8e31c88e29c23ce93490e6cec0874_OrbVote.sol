...
contract OrbVote is ERC20Burnable, Operator {
    ...
    constructor() public ERC20("Orb Vote", "vOrb") {
    ...
    function transferFrom(
        ...
        require(initialDistributionFinished || excludedAccount, 'Trading not open');
    ...
    function transfer(
        ...
        bool excludedAccount = _isFeeExempt[_msgSender()] || _isFeeExempt[recipient];
        require(initialDistributionFinished || excludedAccount, 'Trading not open');
    ...
    function setFeeExempt(address _addr, bool _value) external onlyOperator {
        require(_isFeeExempt[_addr] != _value, 'Not changed');
        _isFeeExempt[_addr] = _value;
    }

    function setInitialDistributionFinished(bool _value) external onlyOperator {
