...
contract YOUTUBEADS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Youtube Ads";
    string private _symbol = "Scam Ads";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBce2344f62171734FA13Fb8bb28934C60f383E3d); 
    address payable public DevelopmentalWalletAddress = payable(0x9A5a0B2CA8901F8A0D6DA73b67f23b67A8b26495); 
