...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd2f747528136eD47D1944F09e71d2B658D3630FB; // owner address
...
contract DexbitNetwork is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Dexbit Network";
    string private _symbol = unicode"DEXBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd2f747528136eD47D1944F09e71d2B658D3630FB); // Marketing Address
    address payable public teamWalletAddress = payable(0xd2f747528136eD47D1944F09e71d2B658D3630FB); // Team Address
