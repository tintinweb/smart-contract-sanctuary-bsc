...
// t.me/BShibPortal will reach 100 mill
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x4693983B0d0C1d5Ef6692F799A5DD4f6CfA3fEe4);
...
contract BShib100xBaby is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x05c57cc9F4C8b2152Ab804E0ede716eB78f821a0;

    string constant _name = "Baby BookShib";
    string constant _symbol = "BABYBOOKSHIB";
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) * 20 / 1000;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) * 20 / 1000;
    }
