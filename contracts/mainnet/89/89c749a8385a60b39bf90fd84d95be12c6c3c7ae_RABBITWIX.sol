...
/**
 RabbitWix Project is focused on achieving virality through exposure. 
 Its unique design, Roasting Telegram Bot and consistent branding and style will make it easy for people to share and spread the word about the token.

Telegram: https://t.me/RabbitWix
...
contract RABBITWIX is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RABBITWIX";
    string private constant _symbol = unicode"RTW";
    ...
    address payable public DevWallet = payable(0xf0CE686B980e3d8b4bB2e39F772F672b88a70Cb5);
    address payable public MarketingWallet = payable(0xBc4FAE3FBDc9bd7B2904573DE0d8eef8440dc860);
