...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    contract PLANET is BEP20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "Planet 9";
        string private  _symbol = "PLNT9";
   ...
   address payable maintenanceWallet = payable(0x338Fd9dc1a6A479752464eF527ED6337504DbB2a);
