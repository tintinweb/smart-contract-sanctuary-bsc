...
contract PoolCrossChain is Ownable, ReentrancyGuard, Pausable, Core, IPoolCrossChainL0 {
        ...
        returns (uint256 actualToAmount, uint256 haircut)
    {
        ...
        require(router.isApprovedAsset(requestParams_.destinationChain, requestParams_.destinationAsset), "DEST_CHAIN_NOT_APPROVED");
    ...
    function receiveSwapCrossChain(ICSMCrossChainRouterL0.CCReceiveParams memory params)
        external
        override
        onlyRouter
    {
