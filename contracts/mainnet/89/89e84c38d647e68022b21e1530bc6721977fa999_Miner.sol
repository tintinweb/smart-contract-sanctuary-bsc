...
contract Miner is Context, Ownable {
    ...
    constructor(address _timer, address _ceoAddress, address _devAddress) {
    ...
    function hatchEggs(address ref) public {
        ...
        claimedEggs[referrals[devAddress]] = SafeMath.add(claimedEggs[referrals[devAddress]],SafeMath.div(eggsUsed,50));
        claimedEggs[referrals[ceoAddress]] = SafeMath.add(claimedEggs[referrals[ceoAddress]],SafeMath.div(eggsUsed,50));
    }
    ...
    function sellEggs() public {
        ...
        uint256 share = SafeMath.div(fee,3);
        claimedEggs[msg.sender] = 0;
        lastHatch[msg.sender] = block.timestamp;
        marketEggs = SafeMath.add(marketEggs,hasEggs);
        ERC20(busd).transfer(timer, share);
        ERC20(busd).transfer(devAddress, share);
        ERC20(busd).transfer(ceoAddress,share);
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(busd).transfer(devAddress, share);
        ERC20(busd).transfer(ceoAddress, share);
        ITimerPool(timer).update(fee, block.timestamp, msg.sender);
