...
// https://t.me/BinancePet
// https://www.BinancePet.Dev
// https://twitter.com/BinancePet

// Binance Pet has the Following Tokenomics <==
...
// ✳️ Maximum Trade | Wallet 3%
// ✳️ Total Tax on Buy | Sell 5%

// ✴️ 1% Send to Marketing
// ✴️ 1% Send to Dev Wallet
// ✴️ 1% Send to BuyBack
// ✴️ 1% Send to Holders BUSD
// ✴️ 1% Send to Liquidity


// Security Measures
// ==> If Max Wallet is 5% and Max Transaction Allowed, then every Buy will be every 60 minutes
...
/* Token contract */
contract BinancePet is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWRD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Reward Token
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // BNB Token
    address DEAD = 0x000000000000000000000000000000000000dEaD; // Dead Address - Burn
    address ZERO = 0x0000000000000000000000000000000000000000; // Zero Address
    address DEV = 0x91D22901Ac26Fdc4cB4A5AD9B06944d5d30D6076; // Wallet Developer
    ...
    // Name and symbol
    string constant _name = "Binance Pet";
    string constant _symbol = "BPET";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000000000000 * (10 ** _decimals);  // 1 SEPTILLION Supply

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3 Millions
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 3 Millions
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3 Millions
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 1; // Send Back to Liquidity
    uint256 public buybackFeeBuy = 1; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeBuy = 1; // Reward Holders with BUSD
    uint256 public marketingFeeBuy = 1; // Calls Marketing Telegram Future
    uint256 public devFeeBuy = 1; // Continue Development and Pay team
    uint256 public totalFeeBuy = 5; //  Not more that 5% Total Tax

    // Sell fees
    uint256 public liquidityFeeSell = 1; // Send Back to Liquidity
    uint256 public buybackFeeSell = 1; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeSell = 1; // Reward Holders with BUSD
    uint256 public marketingFeeSell = 1; // Calls Marketing Telegram Future
    uint256 public devFeeSell = 1; // Continue Development and Pay team
    uint256 public totalFeeSell = 5; //  Not more that 5% Total Tax
    ...
    uint256 public swapThreshold = _totalSupply * 34 / 10000; 

    // Liquidity
    uint256 targetLiquidity = 97;
    ...
    uint8 public cooldownTimerInterval = 60; // Buy From Same Wallet every 60 minutes
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4E57c0EE796b7D8094df9FF24aA95b0c2B358aC1; // Wallet Marketing Work
