...
contract WENLONCH is Context, IERC20, Ownable {
    ...
    string private _name = "WEN LONCH";
    ...
    constructor() {
        ...
        transferFee.tax = 1;
        transferFee.liquidity = 2;
        transferFee.buyback = 3;
        transferFee.marketing = 6;
        transferFee.dev = 1;
