...
/*      SHIBROKI
            // Telegram : https://t.me/ShibrokiBSC
            Webiste : https://Shibrokitoken.com/
*/
...
contract ShibaRoki is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x60Cc3192107d6723e8459fBDAC48998AD08a371B);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100 * 10**9 * 10**_decimals;
    string private constant _name = "SHIBROKI"; 
    string private constant _symbol = unicode"SHIBROKI";
