...
contract DV is ERC20, ERC20Burnable, Pausable, Ownable {
  ...
  mapping(address => bool) public donatorClaimed;
  ...
  SignatureRewardsWithDividend public lpRewardPool;
  ...
  constructor() ERC20("DV", "DV") {
    
    nftTax = 1;
    foundationTax = 1;
    burnTax = 1;
    tradeCooldown = 0;
    airdropThreshold = 3 * 10 ** 17;    //5u

    foundation = 0xa7F487Ff03880823033F274aCdd400C07dbB4aB2;
    uniswapRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    usdt = 0x55d398326f99059fF775485246999027B3197955;
    donate = 0x444FD73D2814773D03517e127Ca41B425DCABEC7;
    ...
    lpRewardPool = new SignatureRewardsWithDividend(address(0x1fb9Ab830bDc0391B1b2f8903d0aF08759003323), address(this));
    ...
    _mint(msg.sender, 1_000_000_000_000 * 1000000);
  ...
  function donatorClaim() external {
    uint256 donatorAirdrop = 5_000_000 * 10 ** 6;

    if( IDPDonation(donate).donated(msg.sender) && !donatorClaimed[msg.sender] ){
      super._transfer(address(this), msg.sender, donatorAirdrop);
      donatorClaimed[msg.sender] = true;
    }
  }
...
interface IDPDonation {

    function donated(address donator) external view returns (bool);
}
...
contract SignatureRewardsWithDividend is Ownable {
  ...
  uint8[] public dividendRate = [85,15];
  ...
  function distributeDividend(address from, uint256 amount) internal {
    address[] memory inviters = DV(reward).getInviter(from, 1);
