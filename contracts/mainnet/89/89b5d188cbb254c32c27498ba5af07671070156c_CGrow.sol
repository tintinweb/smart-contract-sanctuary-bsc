...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Cake_Dividen_Tracker", "Cake_Dividen_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "Cake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main  contract.");
    }
...
contract CGrow is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public rewardToken = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // Cake
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address payable public _marketingWalletAddress = payable(0xD40E28390578173E9d9aA62632Be0241ED2d65AE);
    ...
    uint256 public swapTokensAtAmount = 40000000 * (10**18); // swap limit
    ...
    constructor() ERC20("Cake Grow", "CGrow") {
