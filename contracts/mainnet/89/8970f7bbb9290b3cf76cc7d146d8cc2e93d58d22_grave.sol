...
contract grave is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "grave";
    string private _symbol = "grave";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBf00bB5A20240dB20E2AC3DeE57D8Ec3D6D36f25); 
    address payable public BurnedWalletAddress = payable(0xBf00bB5A20240dB20E2AC3DeE57D8Ec3D6D36f25); 
