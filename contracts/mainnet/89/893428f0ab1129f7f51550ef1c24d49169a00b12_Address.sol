...
// File: contracts/BonkTheMeme.sol
...
contract BonkTheMeme is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BonkTheMeme";
    string private _symbol = "BonkTheMeme";
    uint8 private _decimals = 18;

    //to marketing and team wallets

    address payable public marketingWalletAddress = payable(0x2a4BdF9C5DFB35545EF2FcacEcAdf301199549B1); 
    address payable public teamWalletAddress = payable(0xeA6280c9E8590DfaD46b67aF4B5Ede194088A0b4); 
