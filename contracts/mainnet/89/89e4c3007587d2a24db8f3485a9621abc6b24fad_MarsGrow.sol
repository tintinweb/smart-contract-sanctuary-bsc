...
contract MarsGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mars Grow";
    string private _symbol = "MSG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb20D4555F888364CDe10f700aFe6FC7bd52E4be5);
    address payable public BuyBackWalletAddress = payable(0xb20D4555F888364CDe10f700aFe6FC7bd52E4be5);
