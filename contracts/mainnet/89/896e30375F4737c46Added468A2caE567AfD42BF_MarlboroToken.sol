...
contract MarlboroToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xBdb8FE6C4de7ABADf2360628C38828584A76FB19));
    address payable public devWallet =
        payable(address(0x92e774583102e8d8D2B7e05ff242EBA2E4700b0f));
    address public liquidityReceiver =
        0xBdb8FE6C4de7ABADf2360628C38828584A76FB19;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Web 3.0 Marlboro";
    string private _symbol = "W3M";
