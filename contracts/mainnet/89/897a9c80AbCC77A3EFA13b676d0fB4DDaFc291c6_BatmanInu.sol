...
contract BatmanInu is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BatmanInu", "BMI") {
        BNBRewardsFee = 7;
        liquidityFee = 2;
        extraFeeOnSell = 1; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0xb5ADc274fa85fCC6649dc04156BfCdA49B85DA7B);
