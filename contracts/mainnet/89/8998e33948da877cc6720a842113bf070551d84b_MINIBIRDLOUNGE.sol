...
contract MINIBIRDLOUNGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI BIRD LOUNGE";
    string private _symbol = "MINI BIRD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x486cD95bccAdfA3e2E21436C3F71e41b016D8a09); 
    address payable public buyBackWalletAddress = payable(0x486cD95bccAdfA3e2E21436C3F71e41b016D8a09); 
