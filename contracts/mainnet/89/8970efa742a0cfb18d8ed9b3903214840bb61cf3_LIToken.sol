...
/*  https://t.me/LiToken_BSC
黎族是中国最大的氏族之一，共有 92,760,000 名居民。
我们在 BSC CHAIN 中推出这个是为了向我们介绍更广阔的世界。
我们为此准备了一些很好的营销目标，因此我们可以成为加密货币行业的一部分。
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa5433703a566959D0DcE400BFd7C840e9083E3Cc; 
...
contract LIToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LI Token";
    string private _symbol = "LI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5433703a566959D0DcE400BFd7C840e9083E3Cc); 
    address payable public teamWalletAddress = payable(0xa5433703a566959D0DcE400BFd7C840e9083E3Cc); 
    ...
    uint256 private _totalSupply = 92760000 * 10**_decimals;
    uint256 public _maxTxAmount = 1855200 * 10**_decimals; 
    uint256 public _walletMax = 1855200 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 9276 * 10**_decimals; 
