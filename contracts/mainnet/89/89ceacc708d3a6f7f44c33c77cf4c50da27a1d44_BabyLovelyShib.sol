...
contract BabyLovelyShib is Ownable, IERC20 {
    ...
    uint public _marketingSellFee = 9;

    string private _name = "BabyLovelyShib";
    string private _symbol = "BabyLovelyShib";
    ...
    function enableSwap(bool val) external onlyOwner {
        swapEnabled = val;
    }
