...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xa566d1De78AD00Ea30Cdb56bD8b240bcf08b71F4;
...
contract TwitterInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Twitter Inu"; 
    string private constant _symbol = unicode"Twitter Inu"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xa566d1De78AD00Ea30Cdb56bD8b240bcf08b71F4), BNB_Tot);
            }
