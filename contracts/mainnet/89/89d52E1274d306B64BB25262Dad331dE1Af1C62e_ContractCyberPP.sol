...
contract ContractCyberPP is ERC721 {
  ...
  constructor(
    ...
    ERC721("CYBERPP PPCARDS S3", "CYBERPP PPCARDS S3")
   {
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        charAttributes.name,
        '", "description": "CYBERPP PPCARDS S3 # www.psykotikpanda.com',
        Strings.toString(_tokenId),
        '", "image": "',
        charAttributes.imageURI,
        '", "clan":"cyberpp", "defense":"',strPoints,'", "attaque":"',strStars,'", "attributes": [ { "trait_type": "defense", "value": "',strPoints,'"},  { "trait_type": "attaque", "value": "',strStars,'"},  {"trait_type": "maxCollectionId", "value": "',strMaxCollectionId,'"}, { "trait_type": "collectionId", "value": "',strCollectionId,'"} ]}'
      )
    );
