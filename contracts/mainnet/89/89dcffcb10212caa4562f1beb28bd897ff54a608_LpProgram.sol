...
contract LpProgram is Ownable{
    ...
    function addLP(uint256 _amount) public{
        ...
        (uint256 _amtUsdt,uint256 _amtTld,uint256 liquidity) = router.addLiquidity(address(usdtToken), address(tldToken),_amount,amtToken,1,1,address(this), block.timestamp);
