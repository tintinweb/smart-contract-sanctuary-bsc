...
// File contracts/interfaces/IRegulationStats.sol
...
// File contracts/Treasury/TreasuryBOMB.sol
...
*/
contract TreasuryBOMB is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x1C0fe21E10fE1c1F3a1f23ecC5017f1b353499BC) // TokenGenesisPool
    ];
    ...
    function initialize(
        ...
        maxExpansionTiers = [200, 200, 200, 200, 200, 200];
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochTokenPrice > tokenPriceCeiling) {
                ...
                emit Seigniorage(epoch, previousEpochTokenPrice, 0);
            }
        }
    }
