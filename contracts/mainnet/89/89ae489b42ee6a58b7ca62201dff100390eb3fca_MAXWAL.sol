...
pragma solidity ^0.6.12;
    ...
    contract MAXWAL is Context, IERC20, Ownable {
        ...
        string private _name = 'MAXWAL';
        string private _symbol = 'MAXWAL';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x5074B8730Bc087dFaf9f53Ec53f39cf76Fb8AD8E, 'We can not exclude Uniswap router.');
