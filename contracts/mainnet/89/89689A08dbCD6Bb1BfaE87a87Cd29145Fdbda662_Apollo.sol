...
/**
 *  Contract: Apollo - Powered by XUSD
 ...
 */
contract Apollo is IERC20, Ownable, ReentrancyGuard {
    ...
    // Fee Recipient
    address public feeRecipient = 0x37D9C0065D70F6446e2C045Fc54e41F7B19856cB;
    address public feeRecipientSetter;
    uint256 public feeRecipientPercentage = 625;
    ...
    */
    ...
    function _takeFee(uint mFee) internal {
        ...
        if (fee > 0) {
            uint uFee = amountOut(fee);
            if (uFee > 0 && feeRecipient != address(0)) {
                underlying.transfer(feeRecipient, uFee);
            }
        }
    }
