...
/*
❤️BONK MOM is a fully decentralized community token. Buying and selling tax 3%!

❤️BONK MOM was founded on many of the same principles that the cryptocurrency Community loves: Decentralization, Community, Financial Freedom. These principles remain the foundation of BONK MOM and always will be.

🔥Total Supply - 3500 $BONKMOM
💸Buy&Sell - 3%
❤️Token name - BONK MOM
❤️Symbol - $BONKMOM
📌Chain - BSC
...
contract BONKMOM is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "BONK MOM";
    string private _symbol = "BONKMOM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3e849E8F5807F132a0FB4bde772a387C3A9decf1);
    address payable public liqWalletAddress = payable(0x3e849E8F5807F132a0FB4bde772a387C3A9decf1);
    ...
    uint256 private _totalSupply =  3500 * 10**_decimals;
    uint256 public _maxTxAmount =   70 * 10**_decimals;
    uint256 public _walletMax =     70 * 10**_decimals;
