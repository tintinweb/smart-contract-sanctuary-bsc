...
➡️ NFT Marketplace
GOGROW COIN will introduce an NFT Market Place whereby creators are invited to compete to have their NFT listed on the Official GOGROW COIN Marketplace.
➡️ GROW Staking
With auto deflationary tokens there will always come a point where the burns overtake the reflections.
➡️ Multi Wallet & Cros Chain
Swap gives you all the information from all your wallets in one integrated experience.
➡️ GROW Swap
Swap is a revolutionary new idea that will bring tokenomics to all of crypto on its platform. We call this Cryptonomics.

TAX FEE🔥
🚀 BUY & SELL 8%

🚀 MARKETING 4%
With any project the Marketing Fee determines how big a project can grow. Marketing will be on all social networks as well as adverts on well known crypto sites.
🚀 REFLECTIONS 2%
The heart of GO GROW COIN, super high reflection rates reward holders with incredibly high passive income giving everyone an incentive to HODL.
🚀 DEVELOPMENT UTILITY 2%
GO GROW COIN development projects Swap, Staking, NFT Marketplace & Multi Wallet & Cros Chain.
...
Twitter: https://twitter.com/Gogrow
*/
...
contract  GOGROW is IBEP20, Auth {
    ...
    address DEV =  0xF22AF649f5f05f268EAd3208d38351056eCbE523;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF22AF649f5f05f268EAd3208d38351056eCbE523;
