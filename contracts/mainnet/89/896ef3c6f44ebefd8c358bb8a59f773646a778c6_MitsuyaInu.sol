...
STEALTHLAUNCH TODAY AT 2PM UTC

🟢 TOKENOMICS 

Token Supply :100.000.000
97% Token Liquidity Pancake
3%    Marketing Token 
...
contract MitsuyaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0xE08775376ca38D594B67E2431852c4cAec3A72f6); // Marketing Address

    address payable private devAddress =
        payable(0xE08775376ca38D594B67E2431852c4cAec3A72f6); // Buyback Address

    address payable private liquidityAddress =
        payable(0xE08775376ca38D594B67E2431852c4cAec3A72f6); // Liquidity Address
    ...
    string private constant _name = "MITSUYA INU";
