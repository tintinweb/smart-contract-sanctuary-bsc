...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD74A89579ebA21543B8Fb16089e597AeA36edbB4; 
...
contract JAPANSOCCER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Japan Soccer";
    string private _symbol = "JS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD74A89579ebA21543B8Fb16089e597AeA36edbB4); 
    address payable public teamWalletAddress = payable(0x6A09e48C00A9956B521cAf2355EF865670aD2E43); 
