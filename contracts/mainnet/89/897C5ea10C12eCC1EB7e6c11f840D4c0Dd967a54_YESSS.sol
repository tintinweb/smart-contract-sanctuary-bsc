...
contract YESSS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "\u2665\uFE0F Yesss!!!\u2665\uFE0F";
    string private _symbol = "YESSS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xEa609ea9c7a80Cd85c45BfCE9aAc0bB856215a45);
