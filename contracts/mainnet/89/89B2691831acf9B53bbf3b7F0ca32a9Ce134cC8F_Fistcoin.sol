...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Doge = IBEP20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);
...
contract Fistcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Fistcoin";
    string private _symbol = "Fistcoin";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 99 * 10**29 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x84Fe1F4ED2DFFe9748F3Ada5c0B100199113DA06; 
