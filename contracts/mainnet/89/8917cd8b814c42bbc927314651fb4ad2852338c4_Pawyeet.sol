...
contract Pawyeet   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " pawyeet ";
    string private _symbol = "PYEET "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5209732273910A0dc1ece1b84CD52A755e855095); 
    address payable public teamWalletAddress = payable(0x5209732273910A0dc1ece1b84CD52A755e855095); 
