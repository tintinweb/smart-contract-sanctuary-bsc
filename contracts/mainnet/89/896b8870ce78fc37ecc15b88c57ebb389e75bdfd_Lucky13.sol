...
13 is a community based deflationary token. We will start the life journey of this token with a very small LP and tax as we continue to grow all the time.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2651601eE3E55c7bb9B8fe715DB9E6C71A79eCd0; // owner address
...
contract Lucky13 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "13";
    string private _symbol = "13";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2651601eE3E55c7bb9B8fe715DB9E6C71A79eCd0); // Marketing Address
    address payable public teamWalletAddress = payable(0x2651601eE3E55c7bb9B8fe715DB9E6C71A79eCd0); // Team Address
