...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a0836fE5593A27CD140f422395fC748186b140C; 
...
contract AiTeam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AITEAM";
    string private _symbol = unicode"Together Everyone Achieves More";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a0836fE5593A27CD140f422395fC748186b140C); // 
    address payable public teamWalletAddress = payable(0x1a0836fE5593A27CD140f422395fC748186b140C); // 
