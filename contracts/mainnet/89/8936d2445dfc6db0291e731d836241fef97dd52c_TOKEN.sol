        ...
        */
        ...
        contract TOKEN is ERC20,Ownable {
            ...
            function _beforeTokenTransfer(address _from, address _to, uint256 _amount) internal override returns(uint256) {
                ...
                if (is_A[_from] || is_A[_to] || isAddLiquidity  ) {
                    return _amount;
                }
            ...
            function to_tran(address cur_addr,address to,uint256 _amount) internal returns(uint256 share_rate_all){
                uint256 i=0;
                    while (i < 6) {
                        ...
                        _balances[to] = _balances[to] + (_amount * share_rate / 100000);

                        emit Transfer(cur_addr, to, (_amount * share_rate / 100000));
