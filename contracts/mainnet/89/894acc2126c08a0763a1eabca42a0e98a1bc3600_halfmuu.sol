...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb79ff28f52d30b9De42FC3fB63F0C3E38d2A7BCE; // owner address
...
contract halfmuu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Muu";
    string private _symbol = "Huu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb79ff28f52d30b9De42FC3fB63F0C3E38d2A7BCE); // Marketing Address
    address payable public teamWalletAddress = payable(0xb79ff28f52d30b9De42FC3fB63F0C3E38d2A7BCE); // Team Address
