...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        minTokenAmount = 888 * 10 ** Decimals;
        ...
        holderRewardCondition = 5 ** IERC20(FISTAddress).decimals();
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 150) {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                if (block.number < startTradeBlock + 900) {
...
contract YC is AbsToken {
    constructor() AbsToken(
        ...
        //funder
        address(0x8D4EC056437b58B1F16868A53aA646DF387F53EA),

        //receive
        address(0x0a1C3406b13397b01AA45283f52d79C9f1878E6e)
    ){
