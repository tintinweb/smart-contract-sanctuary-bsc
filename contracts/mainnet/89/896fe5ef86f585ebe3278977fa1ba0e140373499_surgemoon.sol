...
🚀Welcome to SurgeMoon, the hottest new crypto on the market! 

🔥Earn a whopping 3% in SRG just for holding* onto our token. 
🔥But that's not all, we've implemented a deflationary mechanism that burns tokens, ensuring scarcity and driving up value for our holders.
 🌕Don't miss out on the moon shot opportunity of a lifetime with SurgeMoon! 
🚀HODL tight, the surge is coming!

https://t.me/SURGEMOON_bsc
...
contract surgemoon is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SURGE MOON";
    string private constant _symbol = "SRGM";
    ...
    uint256 public maxBag = _totalSupply * 4 / 100;
    ...
    //Tax wallets
    address public teamWallet = 0x1fA606DB9B0BF63363F6556f2adAeCfE2d25F50d;
    address public treasuryWallet = 0x294FBA83CcafEBdCc916fcC0cAbCc759cAB94063;
