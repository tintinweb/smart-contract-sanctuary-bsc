...
The Next Grow Moonshot.

1% USDT Reflections on all transactions.

This is another Meme Factory launch. 

We are a legit, safe team that strives to make great launches. We always push our launches to the hardest potential. 
You can expect to make profits with us. 

Join us and learn more, and why we are the best team to work with. 

We love to make great projects, and deliver profits to investors. 


GUNDAM GROW TG: https://t.me/GUNDAM_GROW
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract GUNDAMGROW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GUNDAM GROW";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1999;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x65edc1723F277F15651A0d04f441888c93819Ba9;
        ecosystemfeeReceiver = 0x65edc1723F277F15651A0d04f441888c93819Ba9; 
