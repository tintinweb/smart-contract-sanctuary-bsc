...
contract Test is Context, IERC20, Ownable {
    ...
    address payable private _appAddress = payable(0x0552683F5df70B8c3cEc759bB699ACe92Bfa63c2);
    address payable private _marketingAddress = payable(0xa611CEd0FbD6AfCfB64400164AB8799D1f13F2CB);
    address payable private _buybackAddress = payable(0xaA1fBCB50dA8fEF233161352bB0B4C53e49B3C91);
    address payable private _burnAddress = payable(0x3068b6966D818a302c26FA0E33328b1EbB3d1045);
