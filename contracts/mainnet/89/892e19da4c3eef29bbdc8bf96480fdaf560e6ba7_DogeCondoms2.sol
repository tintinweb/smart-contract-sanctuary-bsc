...
contract DogeCondoms2 is Context, IBEP20, Ownable {
    ...
    string private _name = "DogeCondoms2.0";
    string private _symbol = "DoCo2";
    ...
    uint256 public div2 = 80;

    uint256 public _startTimeForSwap;
    uint256 public _intervalSecondsForSwap = 1 * 30 seconds;

    // Fee per address
    uint256 public _maxWallet = 5000 * 10**6 * 10**9;
    ...
    address payable public buybackAddress = payable(0x6C0b4E27D299599ae925Ea88B9759E4762E9C2d8);
    address payable public marketingAddress = payable(0x1318b4787b3904170bA6b9ca8c6A734cF5872849);
    address payable public lpAddress = payable(0x42C160fF0247B02ea337Ea5C49F4A6c5919bBba7);
    ...
    function addressChange(address payable _lpAddress, address payable _marketingAddress, address payable _buybackAddress) external onlyOwner{
    ...
    function buyBack() public payable {
        ...
        path[1] = address(this);
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value : msg.value}(0,path,deadAddress,block.timestamp.add(10));
    }
