...
/**
        DOGE WORLD CUP
        Telegram: https://t.me/DogeWorldCupOfficial
        Low Tax 2%
*/
...
contract DOGEWC is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Doge World Cup";
    string constant _symbol = "DOGE WC";
    ...
    address public marketingFeeReceiver = 0xc9a60aAf9d2E309840562c3aC535a945a526605b;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 200;
    bool inSwap;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xc9a60aAf9d2E309840562c3aC535a945a526605b] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xc9a60aAf9d2E309840562c3aC535a945a526605b] = true;
