...
/**
          ...
          Telegram - https://t.me/swiggyinu

          Twitter - https://twitter.com/swiggyinu
 * SAFEMATH LIBRARY
 */
library SafeMath {
...
contract SWIGGYINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Swiggy Inu";
    ...
    address public marketingFeeReceiver =
        0xA7Ea94d4cbCFE14c656BE47B64bd2Cc0DFfcd6dC;
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched for SWINU");
        launchedAt = block.timestamp + 5 minutes;
    }
