...
contract ArgenNomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Argentina Nomics";
    string private _symbol = "ArgenNomics";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE1E77075ca5a5c2cde960e4fC92033353b438D15); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xE1E77075ca5a5c2cde960e4fC92033353b438D15); // buyback Address
