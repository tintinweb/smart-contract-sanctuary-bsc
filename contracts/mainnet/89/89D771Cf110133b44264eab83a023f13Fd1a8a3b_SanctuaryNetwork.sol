...
TG: https://t.me/SanctuaryNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBE75C527d1B6C69AfCD9F93A78767C97691cED14; // owner address
...
contract SanctuaryNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SanctuaryNetwork";
    string private _symbol = unicode"SANET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBE75C527d1B6C69AfCD9F93A78767C97691cED14); // Marketing Address
    address payable public teamWalletAddress = payable(0xBE75C527d1B6C69AfCD9F93A78767C97691cED14); // Team Address
