...
contract PUMPKING is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 1e9; // 10 m total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PumpKing"; // token name
    string private _symbol = "PUMP"; // token ticker
    ...
    uint256 public maxHoldingAmount = 50000 * 1e9;
    uint256 public maxBuyLimit = 25000 * 1e9;
