...
/**
TG : https://t.me/elonpetsofficial

ElonPets is a decentralized ecosystem that provides the cutest NFTs on the Binance Smart Chain We’ve carried all famous memes and packaged them up into lovable pets you can stake them or even can sell them on our marketplace
don't buy it first if the certik audit has not been completed
*/
...
contract ElonPets is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonPets"; // 
    string private constant _symbol = "ElonPets"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 5;
    address private  _marketingWallet = 0xD5c76349e7e47D1Eec594ac658c3eBC80632fC6F;
