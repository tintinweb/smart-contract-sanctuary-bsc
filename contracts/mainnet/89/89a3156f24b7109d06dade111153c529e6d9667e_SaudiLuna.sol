...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa9C86aa67AF98c1C549004d63Dd4968351F88Af5;
...
contract SaudiLuna is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF4e7392957692FB18d74997312c72CF5EB99f2Fa;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SAUDI LUNA";
    string private _symbol = "$SLUNA";
