...
/**
 ...
 PEAKY DOGE
 Telegram : https://t.me/PeakyDogePortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5BD9fFb7A6c6D65f74F1A266Ea4745FdDa2107C5; // owner address
...
contract PEAKYDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Peaky Doge";
    string private _symbol = "PDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5BD9fFb7A6c6D65f74F1A266Ea4745FdDa2107C5); // Marketing Address
    address payable public buybackWalletAddress = payable(0x5BD9fFb7A6c6D65f74F1A266Ea4745FdDa2107C5); // Buyback Address
