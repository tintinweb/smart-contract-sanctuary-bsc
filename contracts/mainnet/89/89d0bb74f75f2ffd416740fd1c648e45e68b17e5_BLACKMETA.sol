...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3DdFe0d9C5b0AE3B113609715825bba02e6E3F5D;
...
contract BLACKMETA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x217C659e7d7b8e14D3806D94764EA8A8AEC6525a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Black meta";
    string private _symbol = "Bmeta";
