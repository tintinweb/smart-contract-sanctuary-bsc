...
contract elonponzi is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonPonzi";
    ...
    Taxes public taxes = Taxes(7, 3, 1, 1, 1);
    Taxes public sellTaxes = Taxes(7, 3, 1, 1, 1);
