...
/* Token contract */
contract PROTOCOLKEK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 25) / 10000; // 2%
    uint256 public _maxSellTxAmount = (_totalSupply * 25) / 10000; // 2%
