...
/**
Telegram: https://t.me/twitterlock
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5e7C2133FD1Bf0F23f66bFA463CaDb5B8A816eca; // owner address
...
contract twitterlock is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Lock";
    string private _symbol = "TWL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB4E8f90F014CDb8412aB9C7928c74625A09380a9); // Marketing Address
    address payable public teamWalletAddress = payable(0xB4E8f90F014CDb8412aB9C7928c74625A09380a9); // Team Address
