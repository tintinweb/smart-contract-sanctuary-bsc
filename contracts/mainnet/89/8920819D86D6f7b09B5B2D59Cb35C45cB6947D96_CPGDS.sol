...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 5000000 * 10** Decimals;
        minBindAmount = 400 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x51812C8658fEee83D8a6746Fdb2a84f62227776c), block.timestamp
                );
            }
        }
    }
...
contract CPGDS is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        150000000,//Supply
        address(0x2ED32aD8E8811005Ab059eF00B7Bd8f45E0bA7e7),//FundAddress
        address(0x95F5bC074609785418045229F1eD9D8Aff545372)//ReceiveAddress
    ){
