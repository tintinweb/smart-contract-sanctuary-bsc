...
contract Lottery {
    ...
    constructor() {
     ...
     // set duration
    function setDuration(uint256 _duration) public isOperator {
        duration = _duration;
    }
    ...
    function BuyTickets() public payable {
        require(msg.value % ticketPrice == 0, (string.concat("the value must be multiple of ", Strings.toString(ticketPrice), " Ether")));        
