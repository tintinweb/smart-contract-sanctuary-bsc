...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xfD41c1D0313985795f11827D4161B921Df88785D;
        _token = msg.sender;
    }
...
contract CatBeachClub is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xebD2dAD5baB3435955f57457f6f2CF76Fe2ee28F;
    address DevWallet       = 0xebD2dAD5baB3435955f57457f6f2CF76Fe2ee28F;

    string constant _name = "CatBeachClub";
    string constant _symbol = "$CATBEACH";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100 * (10 ** _decimals);
    uint256 public _maxTxAmount = 3 * (10 ** _decimals);
    uint256 public _maxWalletToken = 3 * (10 ** _decimals);
    ...
    address Distributor = 0xfD41c1D0313985795f11827D4161B921Df88785D;
