...
contract ApeConnectStaking is ReentrancyGuard {
    string public name = "ApeConnect Staking";
    address public apeConnect;
    ...
    function stakeTokens(uint256 _amount, uint256 _days) public nonReentrant {
        ...
        IBEP20(apeConnect).transferFrom(msg.sender, address(this), transferAmount);
    ...
    function unstakeTokens() public nonReentrant {
        ...
        IBEP20(apeConnect).transfer(msg.sender, transferAmount); 
    ...
    function withdraw(address _reciever ,uint _vaultNumber) public nonReentrant {
        if(_vaultNumber == 1) {
            ...
            IBEP20(apeConnect).transfer(_reciever, transferAmount); 
