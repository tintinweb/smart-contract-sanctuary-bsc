...
/**
The finest Auto-Staking & Auto-Compounding Defi 3.0 Protocol with 383,025.80% Fixed APY. 
Through its exceptional protocol, an investment of 1000 $TRESOR gives 3,830,258.00 $TRESOR in just 12 months. 
With intensely driven & crypto-enthusiast team, KYC'd developers and audited contract, get ready to make generational wealth out of $TRESOR.

*/


/**
 Telegram: https://t.me/+-YS_kmyQ0kQ0M2Nl
...
contract TresorFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "TRESOR Finance"; // 
    string private constant _symbol = "TRESOR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 9;
    address public  _marketingWallet = 0x9325ACB39061aA5Bae2522eb31cce99F6749c3e7;
