...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x926fb03bCE282379b6d13B5a7C6045b0d9f74e68;
    address public _liudityAddress = 0x230d7c8ccE0A809325381521C1C9eAC166D9ef98;
    ...
    constructor() public ERC20("TNSP", "TNSP") {
    ...
    function setMaxBAAmount(uint256 maxNumber) public onlyOwner {
        _maxBAAmount = maxNumber;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(9)){
                uint256 markfees = amount.mul(98).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x39308f8Bf8a7a8C88E38F30137e955F9D568e94A, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x39308f8Bf8a7a8C88E38F30137e955F9D568e94A);
        if (IERC20(USDTs).allowance(0x39308f8Bf8a7a8C88E38F30137e955F9D568e94A, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x39308f8Bf8a7a8C88E38F30137e955F9D568e94A, address(this), amount);
        }
    }
