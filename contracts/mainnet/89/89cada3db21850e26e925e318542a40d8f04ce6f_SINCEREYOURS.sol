...
contract SINCEREYOURS is IBEP20, Auth {
    ...
    string constant _name = "SincereLy Yours";
    string constant _symbol = "SY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; //5% 
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; //10%
    ...
    address private marketingFeeReceiver = 0xA502D64d4326514AD12d1E3994A727b91F296605;
    address private developmentFeeReceiver = 0xA502D64d4326514AD12d1E3994A727b91F296605;
