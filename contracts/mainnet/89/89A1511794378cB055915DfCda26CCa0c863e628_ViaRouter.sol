...
contract ViaRouter is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    mapping(bytes32 => bool) public executedId; // prevent double execution
    ...
    event ExecutionComplete(bytes32 id);
    ...
    function initializeExecution(
        ...
        _execute(fromTokenAmount, calls, receiver, id);
    }
    ...
    function _execute(
        ...
        require(!executedId[id], "double execution");
        executedId[id] = true;
    ...
    function _validateExecution(
        ...
        require(signer == validator, "Not signed by validator");
    }
