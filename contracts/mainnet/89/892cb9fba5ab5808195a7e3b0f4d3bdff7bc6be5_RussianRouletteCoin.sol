...
/**
    🇺🇦 ☮️ 🇷🇺
        ...
        With all due respect to ukraine and russia.
        I'm not siding with any of you, I'm just siding with peace.
        This has nothing to do with the current conflict,
        I'm just reminding you that this is just a game.
        not everyone will survive Russian roulette, or it could mean DYOR!
...
contract RussianRouletteCoin is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxSellTransactionAmount = 246 * (10**18);
    uint256 public maxBuyTransactionAmount = 617 * (10**18);
    uint256 public swapTokensAtAmount = 1 * (10**18);

    uint256 public liquidityFee;
    uint256 public BulletFee;
    uint256 public totalFees;
    address payable public  BulletWallet;
    ...
    function setFee(uint256 _liquidityFee, uint256 _BulletFee) public onlyOwner {
        liquidityFee = _liquidityFee;
        BulletFee = _BulletFee;

        totalFees = liquidityFee.add(BulletFee); // total fee transfer and buy
    }
    ...
    constructor() ERC20("Russian Roulette Coin", "RRC") {
        liquidityFee = 2;
        BulletFee = 7;
        BulletWallet = payable(0x96A2F86e43D2a778bb64d8Fe1103e2124d1211EC);
        ...
        excludeFromFees(BulletWallet, true);
        excludeFromFees(address(this), true);
        
        // exclude from max tx
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(this)] = true;
        _isExcludedFromMaxTx[BulletWallet] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // worthy Bullet fee
        uint256 BulletAmount = deltaBalance.sub(BNBToAddLiquidityWith).div(totalFees.sub(liquidityFee)).mul(BulletFee);
        BulletWallet.transfer(BulletAmount);
    ...
    function swapAndSendBNBToBullet(uint256 tokenAmount) private {
        swapTokensForBNB(tokenAmount, BulletWallet);
    }
