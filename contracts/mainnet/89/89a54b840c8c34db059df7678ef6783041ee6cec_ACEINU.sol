...
contract ACEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x38a5eB1f806521f1Ef3bF47832EeCC63A781b249); 
    address payable public Wallet_Dev = payable(0xD73007959F52d295EE446582944A339F4Eab9D77);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Ace Inu"; 
    string private constant _symbol = unicode"ACEINU";
