...
contract BUSDGenius {
    ...
    uint256 public constant TIME_STEP2 = 1 days;
    ...
    constructor() public {
        token = IBEP20(busd);
        commissionWallet = 0x6B83C9bA1fA4559A5C332a1e7B0b8F35f730Dec0;
        ceoWallet = 0x6B83C9bA1fA4559A5C332a1e7B0b8F35f730Dec0;
        plans.push(Plan(2, 190));
        plans.push(Plan(3, 140));
	...
	function withdraw(uint8 plan) public {
        ...
        require(TIME_STEP2 >= 1, "Invalid TIME");
