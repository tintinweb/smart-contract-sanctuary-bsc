...
contract SquidGrowCrow is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 10000 * 10**_decimals;
    uint256 public maxSellLimit = 10000 * 10**_decimals;
    uint256 public maxWalletLimit = 10000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet =0x3Cc3D820A1EF9C4985f7D22c26dC22E062b95D8D;
    address public devWallet = 0x8FBc6321fcC0900345355bc5048f2eCc7f8C81b5; 
    address public operationWallet = 0x06d841CdeFba5933414668235d4c6c9E7709db6d;
    address public charityWallet = 0x06d841CdeFba5933414668235d4c6c9E7709db6d; 

    string private constant _name = "SquidGrowCrow";
    ...
    Taxes public taxes = Taxes(0, 6, 2, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 7, 2, 2, 0, 0);
