...
🔥Real Degen V3🔥
DYOR / NFA.
This Token is a Normal, Standard, Simple, and Very Easy Token.
This is a Community-Driven Token.
FREE MODS & FREE ADMINS.
I am making this Token to create my strong Diamond Holders Community for future projects.
Let's join and make a Challenge to make this Token to Moon 10 Million MC, if not get jeeted.
This Token has No Utility Projects, No Use Case Projects, No ITOs Projects, No ICO Projects, No IPO Projects, No STO Projects, No Presale Projects, No Private Sale projects, No Raisings Funds, No Payment can be done with this Token and Nothing Special. 
This Token cannot be exchanged with Fiat Currencies or any other Crypto.
This Token can only be buy and sell with BNB in Pancakeswap with Trust wallet or MetaMask.

Telegram: https://t.me/RealDegenV3
...
contract RealDegenV3 is Context, IERC20, Ownable {
    ...
    string private _name = "Real Degen V3";
    string private _symbol = "RDV3";
