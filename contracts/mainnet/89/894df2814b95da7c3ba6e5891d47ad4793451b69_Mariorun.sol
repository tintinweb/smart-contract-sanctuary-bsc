...
contract Mariorun is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xB52C5062fC6993Ec776250f0D211dD03BEEC7126); // Marketing Address
        
    address payable public teamAddress =
        payable(0xB52C5062fC6993Ec776250f0D211dD03BEEC7126); // Team Address

    address payable public liquidityAddress =
        payable(0xB52C5062fC6993Ec776250f0D211dD03BEEC7126); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xB52C5062fC6993Ec776250f0D211dD03BEEC7126).call{value: bnbForDev}("");
