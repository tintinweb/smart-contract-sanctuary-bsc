...
/**
 Do you miss for Ape Trends ? so, dont missed for the baby.
 
 Telgram. https://t.me/BabyApeKing
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSDReward = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract BabyApeKing is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSDReward = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyApeKing";
    string constant _symbol = "$BAK";
    ...
    // turn On Anti Bot
    function botTime(bool _status) public onlyOwner {
        swapBaby = _status;
    }
