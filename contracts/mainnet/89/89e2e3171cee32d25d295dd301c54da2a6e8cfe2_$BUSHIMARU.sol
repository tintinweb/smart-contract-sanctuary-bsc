...
Stealth launch soon At 15-30 Subscriber

Same Team As ShinjiruINU
After Launch You Can Check Contract.
...
95% (Locked 4 Month)
5% Marketing Token 
Tax: 6/6 (3% liq + 3% marketing)
Low MC

Telegram: 
https://t.me/bushimaruinu
*/
...
contract $BUSHIMARU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x432D61229A12AfB0777a79fEE1d48ac009b52233); // Marketing Address

    address payable public devAddress =
        payable(0x432D61229A12AfB0777a79fEE1d48ac009b52233); // Buyback Address

    address payable public liquidityAddress =
        payable(0x432D61229A12AfB0777a79fEE1d48ac009b52233); // Liquidity Address
    ...
    string private constant _name = "BUSHIMARU INU";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1000 / 1000; // 3% maxTransactionAmountTxn
