...
TG : https://t.me/ argentinachampionportal
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe446058299593AAFCb7cBcf5911fF2982740dcdF;
...
contract ARGENTINA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Argentina Champion"; // 
    string private constant _symbol = "ARGENTINA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xe446058299593AAFCb7cBcf5911fF2982740dcdF);
