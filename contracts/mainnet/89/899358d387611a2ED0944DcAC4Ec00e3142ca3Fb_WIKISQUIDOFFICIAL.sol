...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x074B570393995B5003CFf048C44a78aE068bC6B8; // owner address
...
contract WIKISQUIDOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Squid";
    string private _symbol = "WS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1B4E92Ca8EF3067A088d353C523126B0E39e75A); // Marketing Address
    address payable public teamWalletAddress = payable(0xd1B4E92Ca8EF3067A088d353C523126B0E39e75A); // Team Address
