...
contract AlaskaKing is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**4 * 10**4;
    ...
    string private constant _name ="AlaskaKing";
    string private constant _symbol = "AlaskaKing";
