...
uint256 constant distributefee = 0; 
uint256 constant liquidityFee = 5; 
uint256 constant marketFee = 12; 
uint256 constant burnFee = 0; 

address constant marketAddr = 0x39fD41fD5daD99830a444D85Ae211FeED236e2A3; 
...
abstract contract DexBaseUSDT {
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(SHIB, 100, 100000000 * 1e18 ether);
    }
}

abstract contract DividendFee is Ownable, DexBaseUSDT, ERC20 {
    bool public swapToDividend = true;
    uint256 public numTokenToDividend = 100000000 * 1e18;
...
abstract contract InviteFee is Ownable, ERC20 {
    ...
    uint256 public minInvite = 10000 * 1e18;
    ...
    function _takeInviterFee(
        ...
        uint8[3] memory inviteRate = [1, 1, 1];
        address cur = sender;
    ...
    InviteFee
{
    ...
    constructor()
        ERC20("KengGod", "KengGod", 18)
        DividendFee(_totalSupply / 1_0000000, true)
        LiquidityFeeUSDT(_totalSupply / 1_00000000, true)
        MarketAndBurn()
        InviteFee()
    {
