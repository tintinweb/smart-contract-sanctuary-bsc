...
STEALTH LAUNCH BY @cryptofqLix

Freed Bird Protocol 🐣

Telegram - @FreedBirdProtocol
...
contract FreedBirdProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Freed Bird Protocol";
    string constant _symbol = "FBP";
