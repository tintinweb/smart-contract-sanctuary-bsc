...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multi_Whitelist(address[] calldata addresses, bool value) public onlyOwner{
...
contract superhare is AbsToken {
    constructor() AbsToken(
        ...
        address(0x7faE642A2512B503af821C1E4a736Cecb8888888),//FundAddress
        address(0xf7979c3dC530BFa5771aE7C7945532101a762999)//ReceiveAddress
    ){
    }
}