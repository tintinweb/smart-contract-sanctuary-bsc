...
contract ShiBaInuDao is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0xCEF3297DE83a178591FB2FcD56C8e634b6999A0f;
    address public receiveSellFeeWallet = 0x8c4ADCf5c6775c07ed546b59D6a69723B78B0A68;
    IWrap public wrap = IWrap(0x1dF9CAC7DB4C6004Dcb8d095910D52fBf1a4C5b3);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Shiba Inu Dao", "SHIBDAO", 18, 589000000000000 * 10 ** 18){
        address msgSender = _msgSender();
