...
We are the ILLUmemeNATI
MAKING MEMES THAT DESTROY THE FABRIC OF SOCIETY
...
contract ILLUmemeNATIE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ILLUmemeNATIE";
    string private constant _symbol = "ILLmeme";
