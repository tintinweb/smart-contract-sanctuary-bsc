...
/**
tg:https://t.me/BscRebornOfficial

This project aims to revive hype in Bsc and stop stupid people from trading in different blockchains. Not only Bsc hosts one of the most Dapps in the cryptospace, it has very low gas fee, high network speed, etc. Bsc will always be the King!
 */
...
/* Token contract */
contract BscReborn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7a4F3ec91dCeE789005acA5673ea2245F17306e7;
    ...
    // Name and symbol
    string constant _name = "BscReborn";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 4% or 2m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 2% of supply, 0.7%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7a4F3ec91dCeE789005acA5673ea2245F17306e7;
