...
// File: contracts/SharpChedda.sol
...
contract SharpChedda is ERC20 {
        ...
        returns (address)
    {
        require(
            ...
            "SharpChedda says: No bots allowed!"
        );
    ...
    function ensureOneTxPerBlock(address addr) internal virtual {
        ...
        require(isNewBlock, "SharpChedda says: Only one transaction per block!");
    }
