...
contract ShibaCondoms is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Condoms";
    string private _symbol = "SC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xF669a466d6DF0e8Eea1a52c5414E827654FA0d52);
