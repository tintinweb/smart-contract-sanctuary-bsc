...
contract milads is miladsDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private miladsTeam;
    address private Charitymilads;
    ...
    string public override name = "milads";
    string public override symbol = "asdas";
    ...
    constructor(uint totalSupplyValue, address miladsTeamAddress, address CharitymiladsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        miladsTeam = miladsTeamAddress;
        Charitymilads = CharitymiladsAddress;
       
        // split the tokens according to agreed upon percentages
        balances[miladsTeam] =  totalSupply * 4 / 100;
        balances[Charitymilads] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's miladsTeam pot
