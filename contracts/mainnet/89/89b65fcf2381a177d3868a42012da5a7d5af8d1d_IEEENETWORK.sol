...
// Telegram : https://t.me/ieeenetwork
...
contract IEEENETWORK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xde2ECE88F9684E5075bdA3F43c370E50f2C023b6));
    address payable public devWallet =
        payable(address(0xde2ECE88F9684E5075bdA3F43c370E50f2C023b6));
    address public liquidityReceiver =
        0xde2ECE88F9684E5075bdA3F43c370E50f2C023b6;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "IEEE NETWORK";
    string private _symbol = "IEEE";
