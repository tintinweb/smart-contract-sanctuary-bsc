...
contract redgrimace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RED GRIMACE";
    string private _symbol = "$RGRIMACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46647856278D70EbEbA5b5aAa9ce139500cc1A53); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x46647856278D70EbEbA5b5aAa9ce139500cc1A53); // buyback Address
