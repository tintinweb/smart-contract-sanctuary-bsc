...
/**
    ...
    Telegram: https://t.me/babyshibaeggbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B09333227d861420CA401996510AaED4f037744; // owner address
...
contract BABYSHIBAEGG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY SHIBA EGG";
    string private _symbol = "BASHIBEGG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B09333227d861420CA401996510AaED4f037744); // Marketing Address
    address payable public teamWalletAddress = payable(0x4B09333227d861420CA401996510AaED4f037744); // Team Address
