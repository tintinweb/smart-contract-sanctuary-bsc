...
contract WINToken is Token {
    ...
    uint8[] private REF_BONUSES             = [100, 80, 50];
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0xd38C6AC392a8b2DE6993546E07daa3E903939B15;  // N
        ADV_1 = 0xCa6b3b7C69f368c96473cF252697356701146F69;  // 0         
        ADV_2 = 0xfC6194331c61C8d5575eC570D9bD56024C0AAcD2;  // E        
        ADV_3 = 0x109Ee1e865011Cc6696d45f422C7db5DdFb2ac67;  // o 
        ADV_4 = 0xeD59e648fb7C31C27c44653775fa3CadF0C0e526;  // au    
        FIN_1 = 0x4Ab78587B7126c5143dA29fC49318Ad45BeED032;  // S   -1
        FIND_1 = 0x9804bB5d60D56EBf9e1059ed2b13AF7402E0fdB6; // ll
        MAR_1 = 0x27658B1FB266C2828164843Cbd673370F9Ce8746;  // DESB      
