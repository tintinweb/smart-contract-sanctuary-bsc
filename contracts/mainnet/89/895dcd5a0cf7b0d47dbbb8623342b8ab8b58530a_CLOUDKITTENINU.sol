...
// CHANGE
contract CLOUDKITTENINU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Cloud Kitten Inu";
    string constant _symbol = "CKL";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x036801d4E61EE735a9ec4DFA8c7e63adDf50bB56);
