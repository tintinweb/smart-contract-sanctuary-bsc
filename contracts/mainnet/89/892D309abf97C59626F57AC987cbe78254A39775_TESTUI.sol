...
contract TESTUI is IBEP20, Auth {
    ...
    address private boosterWallet = 0x78ACE7EC2bf72f3F2bf913fEC6B6CbEC72Ea9353;
    ...
    string constant _name = "TESTUI";
    string constant _symbol = "$TUI";
  ...
  StaticValuesStruct public staticVals = StaticValuesStruct({
    ...
    function toggleAntiBot(bool toggleStatus) external onlyOwner() {
        ...
        if(antiBotEnabled){
            _startTimeForSwap = block.timestamp + 10;    
        }
