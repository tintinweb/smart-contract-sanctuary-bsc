...
contract CAT is Context, IERC20, Ownable {
    ...
    string private _name = "CAT0.5";
    string private _symbol = "CAT0.5";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x9c19b435de86dFC25c5384eaCb4925CC2A875e29); 
    address payable private teamWalletAddress = payable(0x2A205Fba8a970daA676B82f52cA23eBdb55728a0); 
