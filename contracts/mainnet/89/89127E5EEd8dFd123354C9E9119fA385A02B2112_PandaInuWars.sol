...
contract PandaInuWars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Panda Inu Wars";
    string private _symbol = "$PIW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7ACcc9F210C0E8AfBe96E2ce35C44247594081ee); 
    address payable public teamWalletAddress = payable(0x7ACcc9F210C0E8AfBe96E2ce35C44247594081ee); 
