...
// Rewards Based Memecoin

// Telegram: https://t.me/babyjeffreydahmer_bsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0xCA1728b8fF4aD2316dd780754A0F87Ea7b7cf49D);
    PCSRouter router;
...
contract BabyJeffreyDahmer is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Baby Jeffrey Dahmer";
    string constant public symbol = "BJD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x74388137c7f68D6f84ACBaC0125E229bA2803EDf;
        devFeeReceiver = 0x74388137c7f68D6f84ACBaC0125E229bA2803EDf;
