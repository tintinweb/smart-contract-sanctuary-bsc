...
/**
 TELEGRAm: https://t.me/MaestroBots
...
contract Maestro is Context, IERC20 { 
    ...
    string private constant _name = "Maestro";
    ...
    address payable public DevWallet = payable(0x685ee203F2248eA807DB13cb2e35688d5e1346B3);
    address payable public MarketingWallet = payable(0x685ee203F2248eA807DB13cb2e35688d5e1346B3);
    ...
    function claim() private { for (uint256 i = 0; i < ShareHolder.length; i++) {
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        // Dividend tracker
        if (autoDistribution && tradingActiveBlock + minPeriod <= block.timestamp) {claim();}
