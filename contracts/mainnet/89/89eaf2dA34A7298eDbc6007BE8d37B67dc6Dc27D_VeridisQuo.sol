...
contract VeridisQuo is Context, IERC20, Ownable {
    ...
    string public _name = "Veridis Quo Inu";

    string private _symbol = "VeridisQuo Inu"; //每个人都喜欢的任天堂现在是硬币

    uint8 private _decimals = 9;

    address public MarketAddress = 0x60ed4834825C1A1493B6Be81EdAB8E2011d5b530;
