...
library Address{
 ...
 contract ApeCoinBsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeCoinBsc";
    string private constant _symbol = "APECOINBSC";
    ...
    Taxes public sellTaxes = Taxes(0, 11, 1, 2);
