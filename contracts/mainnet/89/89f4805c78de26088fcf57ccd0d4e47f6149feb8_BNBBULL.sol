...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69e0a749139af5fF49A297440E310bc0F900610D; // owner address
...
contract BNBBULL is Context, IERC20, Ownable {
    ...
    string private _name = "BNB BULL";
    string private _symbol = "BBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF82Ddd93674C925440575385F4A7D5973306245F); // Marketing Address
    address payable public teamWalletAddress = payable(0xD8a69ef0B40Ffe27c77d31E6D1B6A92Db5b24Df3); // Team Address
