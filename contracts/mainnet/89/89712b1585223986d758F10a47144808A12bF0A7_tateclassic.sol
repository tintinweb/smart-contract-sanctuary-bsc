...
contract tateclassic is Context, IERC20, Ownable {
    ...
    string private constant _name = " TateClassic"; // 
    string private constant _symbol = "$TATEC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x723Ec1A8FD585456c34f19f9a0fe599590b88F16;
