...
contract GoblinInu is Context, IERC20, Ownable {
    ...
    address payable public DonationsAddress = payable(0xb048B307547915B4DcEF359795da99a1fBD59C64);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 0;
    uint256 private liquidityTax = 4;
    uint256 private DonationsTax =  8;
    ...
    address public DonationsWallet = 0xb048B307547915B4DcEF359795da99a1fBD59C64;
    ...
    uint256 public numTokensSellToAddToLiquidity = 4 * 10**14 * 10**_decimals;  
