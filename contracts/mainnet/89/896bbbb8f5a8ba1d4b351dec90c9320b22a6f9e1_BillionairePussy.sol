...
contract BillionairePussy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BillionairePussy";
    string private _symbol = "BP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeBE0707cDa2CF0bA1BD61030222bd98eE2e16208); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeBE0707cDa2CF0bA1BD61030222bd98eE2e16208); // BuyBack Address
