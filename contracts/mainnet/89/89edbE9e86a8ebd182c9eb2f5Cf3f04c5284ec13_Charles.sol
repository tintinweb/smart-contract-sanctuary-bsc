...
contract Charles is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BritishIronThrone";
    string constant _symbol = "CHARLES III";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xfA0C8c45E6d8D54aE192cCE9eF904786f90C2f8e ;
