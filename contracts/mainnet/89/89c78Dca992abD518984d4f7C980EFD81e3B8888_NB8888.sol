...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _destroyFee = 800;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapAmount = tAmount * _fundFee / 10000;
            if (swapAmount > 0) {
...
contract NB8888 is AbsToken {
    constructor() AbsToken(
        ...
        18,
        8888,
        address(0x13a0a85cf619F71f832b3ec683Eb69b36427159C),
        address(0xE7E038ec87C14a4223E73fC197eBeC5735cA441a)
    ){
