...
Telegram   :  https://t.me/MonkeypoxPortal
Twitter   :  https://twitter.com/BSC_Monkeypox
...
contract Monkeypox is IBEP20, Auth {
    ...
    string constant _name = "MonkeyPox";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "MKYPOX";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xC1e4F7CCf9163BDFF1F83Bb6A6c53cCE2b97F7a1;
        marketingFeeReceiver = 0x2997cf4BB806c4DC39d541e283100Ea34314F07B;
