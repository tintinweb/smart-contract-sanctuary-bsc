...
/**
Hatchan,[6] nicknamed "Hachi" (ハチ Hachi?), 
is an octopus fish-man who was an officer of the Arlong Pirates before their defeat,[1] and a member of the Sun Pirates before that

*Telegram: https://t.me/HatchanInu
*/
...
contract HatchanInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hatchan Inu"; //
    string private constant _symbol = "Hatchan"; //
