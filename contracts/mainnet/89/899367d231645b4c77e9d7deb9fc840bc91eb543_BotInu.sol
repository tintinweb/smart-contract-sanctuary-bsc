...
library Address{
  ...
  contract BotInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF29c82a86a13284433CE53BfEF55aBA0Fea688b3;
    address public devwallet = 0x20458254eaE7fbd26bBCc0f6bb865F2E1c1C41E1;
    ...
    Taxes public taxes = Taxes(0, 4, 3, 2);
    Taxes public sellTaxes = Taxes(0, 4, 3, 2);
