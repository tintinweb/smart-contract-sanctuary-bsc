...
contract ChineseDream is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChineseDream";
    string private _symbol = "ChineseDream";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50E8cb6E2aFE48DD4de613615404C9d9097B24cb); // Marketing Address
    address payable public teamWalletAddress = payable(0x6cDa819e2bf0CdDfc287f638c1b662C9c24BD711); // Team Address
