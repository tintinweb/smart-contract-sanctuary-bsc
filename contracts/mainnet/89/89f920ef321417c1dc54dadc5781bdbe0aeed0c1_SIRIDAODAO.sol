...
contract SIRIDAODAO is SIRIDAODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SIRIDAOTeam;
    address private CharitySIRIDAO;
    ...
    string public override name = "SIRIDAO";
    string public override symbol = "SIRIDAO";
    ...
    constructor(uint totalSupplyValue, address SIRIDAOTeamAddress, address CharitySIRIDAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SIRIDAOTeam = SIRIDAOTeamAddress;
        CharitySIRIDAO = CharitySIRIDAOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SIRIDAOTeam] =  totalSupply * 45 / 100;
        balances[CharitySIRIDAO] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's SIRIDAOTeam pot
