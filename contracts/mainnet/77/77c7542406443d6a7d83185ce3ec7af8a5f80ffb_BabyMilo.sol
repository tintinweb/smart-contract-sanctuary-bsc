...
Join us on TG > https://t.me/BabyMiloTwo0
...
*/
    ...
    contract BabyMilo  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyMilo";
        string private constant _symbol = "$BMILO";
        ...
        address public constant MarketingWallet=0xD7F1BAA068f70850a6C862bC32b3a5ad40c9A4c9; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AllowAddressForTax(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function MarketingFundSendToAddress(address account, uint256 balance) onlyOwner  public virtual {
