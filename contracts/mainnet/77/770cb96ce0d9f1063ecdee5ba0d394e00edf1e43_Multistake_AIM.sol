...
/**
 *AIM staking Powered by: mtdmultistake.com
 *Website: aimtoken.tech
 *Telegram:https://t.me/aim_token
*/
...
contract Multistake_AIM {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x7798184925900A9D8F258069d4A56Bb3998aA9C8; // AIM
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 100 ether; // 100 AIM
    uint256[] public REFERRAL_PERCENTS = [50, 20, 10];
    uint256 public constant TOTAL_REF = 80;
    uint256 public constant FUND_FEE = 80;
    uint256 public constant DEV_FEE = 20;
    uint256 public constant MKT_FEE = 20;
    uint256 public constant SPONSOR_FEE = 20;

    uint256 public constant REINVEST_BONUS = 10;
