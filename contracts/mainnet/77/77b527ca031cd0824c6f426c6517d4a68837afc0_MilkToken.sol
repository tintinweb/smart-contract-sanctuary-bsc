...
contract MilkToken is Context, IERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0x39B1babD1843Da6e93f970b576431b6A3638C77C); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x39B1babD1843Da6e93f970b576431b6A3638C77C); // Team Address
