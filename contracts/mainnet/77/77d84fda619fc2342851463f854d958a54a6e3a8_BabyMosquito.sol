...
contract BabyMosquito is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ABEK0";
    string private _symbol = "ABEK0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14c008E5c738762c63897b157EF71A1662B7F8A1); 
    address payable public teamWalletAddress = payable(0x14c008E5c738762c63897b157EF71A1662B7F8A1); 
    ...
    uint256 private _totalSupply = 1* 10**30 * 10**_decimals;
