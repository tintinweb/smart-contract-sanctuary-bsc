...
Fair/Stealth launches on BSC

Ape fomo launch

https://t.me/lilapeInu
*/
...
contract LilApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lil Ape";
    string private _symbol = "LAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAA54DE29b4243DB1b7DA0c7209714589Cd8013C4); // 营销钱包
    address payable public teamWalletAddress = payable(0xAA54DE29b4243DB1b7DA0c7209714589Cd8013C4); // 团队钱包
