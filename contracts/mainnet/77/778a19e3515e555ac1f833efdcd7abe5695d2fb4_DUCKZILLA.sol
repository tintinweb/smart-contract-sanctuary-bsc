...
contract DUCKZILLA is Context, IERC20, Ownable {
    ...
    string private _name = "Duck Zilla";
    string private _symbol = "DUCKZILLA";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x9146417937Ed4422Dd93E657c971b3f3378e72C8); // Marketing Address sgw2
    address payable private TeamWallet = payable(0x7511d2a5DA6d229235b3B2923298128efC133409); // Team Address
