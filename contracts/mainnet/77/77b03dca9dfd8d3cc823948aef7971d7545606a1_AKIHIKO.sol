...
contract AKIHIKO is ERC20, Ownable {
    ...
    string constant _name = "Akihiko Inu";
    string constant _symbol = "AKIHIKO";
    ...
    address public marketingFeeReceiver = 0x5807E0d3e0a34F06A9D8F033F1Cab4ce69A0E5e8;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 35;
    bool inSwap;
   ...
   function BLBots(address[] memory bots_) public onlyOwner {
    ...
    function setFees(uint256 _MarketingFee,uint256 _liquidityFee) external onlyOwner {
         ...
         require (totalFee <= 15,"Fees cant be more than 15%");
