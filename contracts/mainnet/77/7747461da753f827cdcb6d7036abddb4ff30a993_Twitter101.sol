...
contract Twitter101 is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter101";
    string private _symbol = "Twitter101";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x97a73c4BA36Cb362FD0Fa592400fAeB90387ac0D); // Marketing Address
    ...
    address payable private IUniswapV2Address = payable(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
