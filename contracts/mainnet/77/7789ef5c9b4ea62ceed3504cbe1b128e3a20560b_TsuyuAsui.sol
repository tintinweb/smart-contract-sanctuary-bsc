...
contract TsuyuAsui is Context, IERC20, Ownable {
    ...
    modifier antiBot(address account){
        require(_define || allowedTransfer[account], "Trading not enabled yet");
        _;
    }
    ...
    uint256 public swapTokensAtAmount = 750 * 10**_decimals;
    uint256 public maxBuyLimit = 2000 * 10**_decimals;
    uint256 public maxSellLimit = 2000 * 10**_decimals;
    uint256 public maxWalletLimit = 2000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0x5d5C02d3F2587aD53C56cc2485c2ae4C087D232A;
    address public devWallet = 0x5d5C02d3F2587aD53C56cc2485c2ae4C087D232A; 
    address public operationWallet = 0x5d5C02d3F2587aD53C56cc2485c2ae4C087D232A;
    address public charityWallet = 0x5d5C02d3F2587aD53C56cc2485c2ae4C087D232A; 
    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Tsuyu Asui";
    string private constant _symbol = "TSUYU";
    ...
    Taxes public taxes = Taxes(0, 5, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 6, 2, 0, 0, 0);
    ...
    constructor (address deployer,uint256 antiSnipeSeconds) {
        ...
        _approve(owner(), address(router), MAX);
        ...
        emit Transfer(deployer, owner(), _tTotal);
    }
...
//================================================
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            require(_define, "Trading not active");
        }
...
//================================================
    function _updateSwapStatus(bool state) external onlyOwner{
        _define = state;
        swapEnabled = state;
    ...
    function updateWallets(address marketing, address dev, address operation, address charity) external onlyOwner{
        marketingWallet = marketing;
        devWallet = dev;
        charityWallet = charity;
        operationWallet = operation;
    }
