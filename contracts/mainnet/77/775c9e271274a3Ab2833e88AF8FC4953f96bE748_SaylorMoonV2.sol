...
contract SaylorMoonV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SaylorMoonV2";
    string private _symbol = "SMOONV2";
    uint8 private _decimals = 9;

    address payable public marketingAddress = payable(0x6A567E45Aa12c71C4665aBC6e3770b1f4B993109);
    address payable public devAddress = payable(0x6A567E45Aa12c71C4665aBC6e3770b1f4B993109);
