...
contract parrotinu is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "ParrotInu";
    string constant _symbol = "Parrot";
    ...
    uint256 public _maxTxAmount = 3000000 * (10 ** _decimals); //0.3%
    uint256 public _walletMax = 10000000 * (10 ** _decimals); //1%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x489d1111c79B5079bE14b79D40A0D685BA8c6e49;
        marketingWallet = 0x489d1111c79B5079bE14b79D40A0D685BA8c6e49;
        devWallet = 0x489d1111c79B5079bE14b79D40A0D685BA8c6e49;
