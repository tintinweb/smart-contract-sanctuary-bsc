...
contract finaltest is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "final s";
    string constant _symbol = "finaltest";
    ...
    address payable public liquidityFeeReceiver = payable(0x5078efC58a3013A1f6DF3231A76759306DE80479);
    address payable public marketingFeeReceiver = payable(0x5078efC58a3013A1f6DF3231A76759306DE80479);
