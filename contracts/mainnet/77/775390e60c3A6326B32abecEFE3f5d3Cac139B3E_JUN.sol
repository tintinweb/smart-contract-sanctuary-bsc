...
contract JUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"80军";
    string private _symbol = unicode"80军";
    ...
    function setMultipuleBlacklist(address[] calldata accounts, bool value) public onlyOwner {
