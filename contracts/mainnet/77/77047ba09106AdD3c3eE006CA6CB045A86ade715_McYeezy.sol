...
library Address{
 ...
 contract McYeezy is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0e56672483A738aaBF47dDB28D010fF12525502A;
    address public donationWallet = 0x0e56672483A738aaBF47dDB28D010fF12525502A;

    string private constant _name = "Mc Yeezy";
    string private constant _symbol = "MY";
