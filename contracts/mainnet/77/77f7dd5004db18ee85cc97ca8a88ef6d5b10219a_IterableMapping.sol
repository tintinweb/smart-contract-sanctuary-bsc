...
contract TestDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(newClaimWait != claimWait, "Test: Cannot update claimWait to same value");
...
contract Test is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setHODLFee(uint256 _HODLFee) public onlyOwner {
        HODLFee = _HODLFee; // extra fee on sell
    }
    ...
    constructor() ERC20("TestBNB", "Test") {
        BNBRewardsFee = 13;
        liquidityFee = 1;
        HODLFee = 0; 
        marketingFee = 1;
        marketingWallet = payable(0x07BE5D699Ee773E108222286Fdab34ED7D6C8768);
