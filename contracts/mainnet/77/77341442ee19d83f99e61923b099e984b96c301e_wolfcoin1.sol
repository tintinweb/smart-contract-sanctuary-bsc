...
contract wolfcoin1 is ERC20, Auth {
    ...
    string constant private _name = "wolfcoin1";
    string constant private _symbol = "wolfcoin1";
    ...
    address private marketingFeeReceiver = 0xAfa87a4B127Ff435beE47ccAf4bD9fe8dB6a4aF6;
    address private opsFeeReceiver = 0x6B9D4271CEe1F6A43984AaCe90b571FDc3f3167e;
    address private stakingFeeReceiver = 0x016D8947Ea7C26945f45Eb00F28E93D6e4f05fd3;
    address private devFeeReceiver = 0xB8Ab4B4E86740b5C0fC639Aa6b9d3c9ba9344e09;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBOps = amountBNB.sub(amountBNBLiquidity).sub(amountBNBMarketing).sub(amountBNBDev);
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _opsFee, uint256 _devFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        ...
        totalBuyFee = _liquidityFee.add(_marketingFee).add(_opsFee).add(_devFee).add(_stakingFee);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _opsFeeReceiver, address _devFeeReceiver, address _stakingFeeReceiver) external authorized {
        require(_autoLiquidityReceiver != address(0) && _marketingFeeReceiver != address(0) && _opsFeeReceiver != address(0)  && _devFeeReceiver != address(0) && _stakingFeeReceiver != address(0), "Zero Address validation" );
        ...
        emit SetFeeReceivers(_autoLiquidityReceiver, _marketingFeeReceiver, _opsFeeReceiver,_devFeeReceiver, _stakingFeeReceiver);
    }
