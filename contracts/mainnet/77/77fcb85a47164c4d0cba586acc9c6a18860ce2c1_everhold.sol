...
contract everhold is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EverHold";
    //change the token symbol
    string constant _symbol = "EVH";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xe9590Dbd97A3d3e299AE0f82A9c95215C6edB194;
