...
contract CHRISTMASDAY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25122022 * 10**9;
    uint256 public _maxTxAmount = 25122022 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "CHRISTMAS DAY"; // 
    string private constant _symbol = "XMASDAY"; //    
