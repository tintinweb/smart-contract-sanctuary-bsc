...
/**
         APE KING is trending on twitter, and now on the BSC to go to the moon!!!!
...
contract ApeKing is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x9A46D69B13E3631679F0D00aBB58764CeB3f0daa));


    string private _name = "APE KING";
    string private _symbol = "APE KING";
