...
contract Billion is Context, IERC20, Ownable {
    ...
    string private _name = "8 Billion";
    string private _symbol = "8B";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0239D9D8fb9FaC9e70f3CcDD15415c007EEb2A13); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x0239D9D8fb9FaC9e70f3CcDD15415c007EEb2A13); // buyback Address
    ...
    uint256 private _totalSupply = 8000000000 * 10**9;
    uint256 public _maxTxAmount = 80000000 * 10**9; 
    uint256 public _walletMax = 80000000 * 10**9; 
