...
contract APIConsumer is ChainlinkClient {
    ...
    constructor() {
        ...
        fee = 0.04 * 10 ** 18; // (Varies by network and job)
    }
     ...
     */
    function requestVolumeData(string memory api, string memory path) public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest("c734c40b377544f08a7324f36bda4940", address(this), this.fulfill.selector);
    ...
    function requestHexData(string memory api, string memory path) public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest("ce039030ac69497cbb9615b9b1d7b363", address(this), this.fulfillHex.selector);
    ...
    function fulfillHex(bytes32 _requestId, bytes32 _hexV) public recordChainlinkFulfillment(_requestId)
    {
        hexV = _hexV;
    }
