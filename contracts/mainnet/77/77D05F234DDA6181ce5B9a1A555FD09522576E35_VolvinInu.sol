...
contract VolvinInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Volvin Inu";
    string private _symbol = "VOLVINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb00F1B41A6A9B1C393505a1E4d89023745D19dC3); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xb00F1B41A6A9B1C393505a1E4d89023745D19dC3); // Team Address
