...
//                                      LP Burned, Ownership renounced + Auto-burn mechanism
...
contract Hemorrhiode is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3d0B1d6b59038C4150e9C325651CC1974C24487a); 
    address payable public Wallet_Dev = payable(0x3d0B1d6b59038C4150e9C325651CC1974C24487a);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5**10 * 10**_decimals;
    string private constant _name = "Hemorrhiode"; 
    string private constant _symbol = unicode"Hemorrhiode"; 
    ...
    uint256 public Percent_Burn = 100;
    ...
    constructor () {
        ...
        _owner = 0x3d0B1d6b59038C4150e9C325651CC1974C24487a;
