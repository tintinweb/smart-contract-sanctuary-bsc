...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFb4188883520A97D338Ed5deD15f59Ea2e7642F0; // owner address
...
contract Qatar is Context, IERC20, Ownable {
    ...
    string private _name = "Qatar Whale Club";
    string private _symbol = "QWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xca123623AAC015dbcF069DD094120e0cBadc7F42); // Marketing Address
    address payable public teamWalletAddress = payable(0xca123623AAC015dbcF069DD094120e0cBadc7F42); // Team Address
