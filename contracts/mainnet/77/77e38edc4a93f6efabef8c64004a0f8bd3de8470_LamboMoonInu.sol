...
contract LamboMoonInu is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Lambo Moon Inu";
    string constant _symbol = "LAMBOINU";
    uint8 constant _decimals = 9;

    uint256 constant _totalSupply = 1_000_000_000 * (10 ** _decimals);


    uint256 public _maxTxAmount = (_totalSupply * 1) / 1250; //~0.125%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 2500; //0.25%
