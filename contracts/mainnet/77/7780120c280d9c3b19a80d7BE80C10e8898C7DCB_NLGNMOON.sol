...
contract NLGNMOON is Context, IERC20, Ownable {
    ...
    string private _name = "a cow monn";
    string private _symbol = "NLGN MOON";
    ...
    address public ownerAddres = address(0x00493588fB4ace9Aa82365004DFD751e018Db526);
    address public devAddress = address(0x6685B7d2692d9E4233D5A889D864A44EEAC80784);
