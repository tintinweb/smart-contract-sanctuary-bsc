...
/**
WELCOME TO 🟠 Swipe Bot Token  🟠
A unique trading bot that enables anyone to competently invest into their tokens of choice, earlier than the competition.

Trust transformed
🥇Bullish Unique
🥇Tax 2%  Rewards 2% as  $SWIBOT
🥇Base Team
🥇FairLaunch
🥇Renounce Lock LP

Telegram
https://t.me/SwipeBotToken
...
abstract contract ContextERC20 {
...
contract OwnableERC20 is ContextERC20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableERC20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableERC20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SwipeBotToken  is ContextERC20, ERC20, OwnableERC20 {
    ...
    string private _name = 'Swipe Bot Token';
    string private _symbol = 'SWIBOT';
