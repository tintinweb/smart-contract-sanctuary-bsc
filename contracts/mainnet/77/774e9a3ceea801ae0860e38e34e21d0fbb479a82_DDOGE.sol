...
contract DDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xD52Dc53d5F0AF841907acE08946CE3B45AeCf8DF); // Marketing Address

    address payable public StakeAddress =
        payable(0xD52Dc53d5F0AF841907acE08946CE3B45AeCf8DF); //  Development Address

    address payable public liquidityAddress =
        payable(0x0a3688f273aa9472ba545dC244aBcD4693067C1B); // Liquidity Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 10 / 1000; // 2% maxTransactionAmountTxn
