...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "TUDOGE";
    string private _symbol = "TUDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0A651f181DcC3dA1CE7a1F501cF7b211052B5496); // Marketing Address
