...
contract DogeriumAI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DOGERIUM AI";
    ...
    address payable public DevWallet = payable(0x44b3B39B14967ab030B17493A11864B90837499f);
    address payable public MarketingWallet = payable(0xaD86764b1FF39D9b50FBab70A126bED01BC7b799);
