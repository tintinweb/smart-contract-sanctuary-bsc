...
contract CCC is IERC20, Ownable {
    ...
    constructor() {
        ...
        _tTotal = 365000000 * 10 ** _decimals;
    ...
    function setAddr(address addr1,address addr2) public onlyOwner {
        fundAddress=addr1;
        fundAddress2=addr2;
    }
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                _takeTransfer(
                    sender,
                    fundAddress2,
                    tAmount.sub(tAmount.div(200).mul(_fundFee)),
                    currentRate
                );
