...
contract Learntohold is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("CZ TWEET", "Learn To Hold") {
        liquidityFee = 3;
        charityFee = 7;
        charityWallet = payable(0x856494ca22f3a04fFfd066770aCfEca36A53558d);
