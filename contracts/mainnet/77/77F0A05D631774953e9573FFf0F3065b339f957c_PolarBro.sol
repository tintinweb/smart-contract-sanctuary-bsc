...
/* Token contract */
contract PolarBro is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x004d76d461e46D4461AB147E6aA0e6A164E71560;
    ...
    // Name and symbol
    string constant _name = "Polar Bro";
    string constant _symbol = "Polar Bro";
    ...
    uint256 public swapThreshold = _totalSupply * 10000 / 10000; // 0.25%
