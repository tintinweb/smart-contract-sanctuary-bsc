...
contract CoinMatchAi is ERC20, Ownable {
    ...
    constructor () ERC20("CoinMatch Ai", "CMAI") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x376B8f2e086FEa3C9C9D066C6612af1aAA858390;
        developmentWallet = 0xD3083aAaBC4092c844F3AA926Fd5D66FB1C1D9CE;
