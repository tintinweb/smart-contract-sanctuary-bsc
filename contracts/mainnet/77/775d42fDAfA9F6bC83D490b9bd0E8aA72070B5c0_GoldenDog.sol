...
contract GoldenDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Golden Dog";
    string private _symbol = "Golden Dog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcEe23c57Cc5c020ae1603d60f6968e2856A281A5); // Marketing Address
