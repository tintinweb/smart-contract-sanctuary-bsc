...
5% BUSD-BEP20 rewards with masisve buybacks
...
contract EVEREST is ERC20, Ownable {
    ...
    EVERESTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("EVEREST INU", "EREST") {
        marketingWallet = payable(0x564a4ac87aB4556d9F4Dc1bD3898BF1339B230fB);
        devWallet = payable(0x5C044A852CD3ba24098c4075cA27ef9A756C5028);
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new EVERESTDividendTracker(
            payable(this),
            router,
...
contract EVERESTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EVEREST public EVERESTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EVERESTContract = EVEREST(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EVEREST_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EVEREST_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EVEREST contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EVERESTContract);

            uint256 prevBalance = EVERESTContract.balanceOf(address(this));
            ...
            {
                uint256 received = EVERESTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EVERESTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
