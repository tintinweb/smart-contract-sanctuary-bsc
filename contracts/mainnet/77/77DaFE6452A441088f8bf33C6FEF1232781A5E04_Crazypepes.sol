...
contract Crazypepes is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CrazyPepes";
    string private _symbol = "CrazyPepes";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83Cba7893E31DAB307176d37B5dEd159195889e3); // Marketing Address
    address payable public teamWalletAddress = payable(0x11110227C89193e26e20f5394930666Dc55F78a3); // Team Address
