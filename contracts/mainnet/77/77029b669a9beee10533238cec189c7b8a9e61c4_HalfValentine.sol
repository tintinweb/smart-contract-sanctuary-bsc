...
// $HALV is a meme token launched for valentine's day celebration on BSC network. 
// This day is dedicated to expressing love and affection towards your significant other, friends, and family. It can be a time to reflect on the past six months and reignite the love and passion in your relationships. 
// People usually celebrate by exchanging gifts, sending greeting cards, or planning a romantic date or getaway. It's a way to show appreciation and gratitude for those close to you and to celebrate the love that exists in your life.

// Submitted for Telegram: https://t.me/HALFValentineEntry
...
contract  HalfValentine  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Half Valentine's";
    string private _symbol = "HALV";
