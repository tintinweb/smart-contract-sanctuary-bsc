...
/*
    ...
    Telegram    : https://t.me/ratboymurray
    Website     : https://ratboymurray.us/

    Come and join us
    Dont you miss this one
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4db9cB42907cbAbA69eAf316d24A03B224051365; // owner address
...
contract RatBoyMurrayToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rat Boy Murray";
    string private _symbol = "$RBM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33c76a8c60ba91c1FC2A1D8af1De5Fb463288691); // Marketing Address
    address payable public teamWalletAddress = payable(0x33c76a8c60ba91c1FC2A1D8af1De5Fb463288691); // Team Address
