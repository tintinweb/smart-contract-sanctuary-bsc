...
contract AuspiciousFinance is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**6 * 10**9; // one billion
    ...
    address payable private _developmentAddress = payable(0x5393D02D3724dB1aB2aaa69812ab0Cfe2cF5Eab4);
    address payable private _marketingAddress = payable(0x8723156fC5cf8296d263000c1BA881BaB9442FE5);
    
    string private constant _name = "auspicious.finance";
    string private constant _symbol = "auspicious.finance";
