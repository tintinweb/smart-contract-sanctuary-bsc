...
contract Solana2go  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Solana2go"; //
    string private constant _symbol = "Sol2go"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 3;
    address private _marketingWallet = 0x313e1e8d352C511bc7D10A7011Afb28F2790e7b2 ;
