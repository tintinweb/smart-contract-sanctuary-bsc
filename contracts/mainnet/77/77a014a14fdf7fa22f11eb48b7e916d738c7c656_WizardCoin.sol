...
contract WizardCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "WizardCoin";
    ...
    address private marketingWallet = address(0xACe6ae26aABc5B83F8E274beB1fFf988A99db9d8);
    ...
    function readyCheck() public onlyOwner { 
