...
contract LOL is IERC20, Ownable {
    ...
    address public inviterAddress = address(0xbbfc53811aF589793310A320801f1F351BD4FC0C);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;
    
    address public fund1Address = address(0xedFf5FfD12d57fFBa9918e0Ea21d22ef32f0F137);
    
    address public fund2Address = address(0x58c251BDCA9C66265199112c85Ab3E4ED443f432);
    ...
    constructor(address tokenOwner) {
        ...
        uint256 leftAmount = 21000000 * 10**_decimals;
