...
contract CatSoccer is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Soccer";
    string private constant _symbol = "CatSoccer";
