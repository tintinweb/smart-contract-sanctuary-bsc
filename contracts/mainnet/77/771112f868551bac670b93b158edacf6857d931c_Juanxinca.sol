...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0EDd5d1EE02199DAE3610C1109A1c1aA9Faf811a; // owner address
...
contract Juanxinca is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Juanxinca";
    string private _symbol = "Juanxinca";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0EDd5d1EE02199DAE3610C1109A1c1aA9Faf811a); // 
    address payable public teamWalletAddress = payable(0x0EDd5d1EE02199DAE3610C1109A1c1aA9Faf811a); // 
