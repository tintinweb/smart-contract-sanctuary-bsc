...
Welcome to a true stealth launch that will give everyone an equal 
opportunity from launch. Max wallet will increase over a period of time 
as the project develops to avoid whales at launch. 8 is lucky and if you've
found this consider yourself luck. 

We are $0.8

https://t.me/EightPortal
...
contract ZeroPointEight is IBEP20, Auth {
    ...
    string constant _name = "$0.8";
    string constant _symbol = "$0.8";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 8000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 1000; //0.8% 
    uint256 public _maxWalletSize = (_totalSupply * 8) / 1000; //0.8%
    ...
    address private marketingFeeReceiver = 0x95f8329479D442Ac2F3189f7692bc0d2D81859f0;
    address private developmentFeeReceiver = 0x95f8329479D442Ac2F3189f7692bc0d2D81859f0;
