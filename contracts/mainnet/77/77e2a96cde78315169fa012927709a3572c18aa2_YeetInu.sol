...
contract YeetInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2DEB9aD5E8E843F044BA070F9694C635883f4839); 
    address payable public Wallet_Dev = payable(0x43932E99A9C05ddb1fFc59C1bFF007f8f89abFD2);
    ...
    string private constant _symbol = unicode"YEETINU"; 
    ...
    constructor () {
        ...
        _owner = 0x2DEB9aD5E8E843F044BA070F9694C635883f4839;
