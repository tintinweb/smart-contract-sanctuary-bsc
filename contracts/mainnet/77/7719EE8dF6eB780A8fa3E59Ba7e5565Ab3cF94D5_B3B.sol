...
contract B3B is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21000000000 * 10**9; //CHANGE_OPTIONAL: total supply of token. Recommended to keep unchanged
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "B3B";      //CHANGE_REQUIRED: name of token
    string private _symbol = "B3B";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
