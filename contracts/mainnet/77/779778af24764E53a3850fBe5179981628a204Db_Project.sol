    ...
    ReentrancyGuardUpgradeable
{
    ...
    event SetConfigBlockNumber(
        uint256 indexed projectId,
        uint256 indexed stakingBlockStart,
        uint256 stakingBlockEnd,
        uint256 indexed fundingBlockStart,
        uint256 fundingBlockEnd,
        uint256 claimBackBlock
    );
    ...
    function createProject(
        ...
        require(
            _stakingStartBlockNumber > block.number &&
                ...
                _fundingEndBlockNumber < _claimBackStartBlockNumber,
    ...
    function setConfigBlockNumber(
        uint256 _projectId,
        uint256 _stakingBlockStart,
        uint256 _stakingBlockEnd,
        uint256 _fundingBlockStart,
        uint256 _fundingBlockEnd,
        uint256 _claimBackBlock
    ) external onlyAdmin validProject(_projectId) {
        ProjectInfo storage project = projects[_projectId];
        require(
            _stakingBlockStart > 0 &&
        ...
        validProject(_projectId)
    {
        ...
        require(
            block.number >= stakeInfo.startBlockNumber,
    ...
    {
        require(
            block.number >= projects[_projectId].claimBackInfo.startBlockNumber,
        ...
        validProject(_projectId)
    {
        ...
        require(
            block.number >= fundingInfo.startBlockNumber,
            "Funding has not started yet"
        );
        require(
            block.number <= fundingInfo.endBlockNumber,
            "Funding has ended"
        );
