...
https://t.me/Freemason_Inu

https://www.freemasoninu.org/
...
contract FreeMasonInu is Context, IERC20, Ownable {
    ...
    string private _name = "FreeMasonInu";
    string private _symbol = "$FMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA1007e024aABbA7539e574b91036F7E5de83Be15); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA1007e024aABbA7539e574b91036F7E5de83Be15); // BuyBack Address
