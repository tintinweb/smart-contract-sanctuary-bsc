...
library Address{
 ...
 contract TagnaInu is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 50 seconds;
    ...
    address public marketingWallet = 0xF71a553d96C4d58F1800b2f32985A8c2108366a6;
    address public donationWallet = 0xF71a553d96C4d58F1800b2f32985A8c2108366a6;

    string private constant _name = "TagnaInu";
    string private constant _symbol = "TAGINU";
    ...
    Taxes public taxes = Taxes(0, 98, 1, 0);
    Taxes public sellTaxes = Taxes(0, 9, 1, 0);
