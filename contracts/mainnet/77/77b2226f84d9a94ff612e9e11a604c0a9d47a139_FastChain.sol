...
Fast Chain Exchange will change DeFi as we know it today into what we know it could be. Our goal is to create a massive change for crypto and web3. The fastest and most secured blockchain in crypto is now in the making. The evolution starts here with Fast Chain Exchange.
The fastest and most secured blockchain in crypto is now in the making. The evolution starts here with Fast Chain Exchange.
...
contract FastChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "FastChain Exchange"; // 
    string private constant _symbol = "FastChain"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xF2D0f5F3FE608b1d7e27cc878b322f1b79352627;
