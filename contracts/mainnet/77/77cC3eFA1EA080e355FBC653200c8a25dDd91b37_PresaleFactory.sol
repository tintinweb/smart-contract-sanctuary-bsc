...
contract PresaleFactory is Ownable {
    ...
    function buyTokensByBUSD(uint256 _amountPrice) external {
        ...
        uint256 tokenAmount = _amountPrice * 10 ** 18 / pTokenPrice_BUSD;
    ...
    function buyTokensByBNB() external payable {
        ...
        // token amount user want to buy
        uint256 tokenAmount = amountPrice * 10 ** 18 / pTokenPrice_BUSD;
    ...
    function getPresaleOwnerAddress() public view returns (address) {
        return presaleOwnerAddress;
    }
