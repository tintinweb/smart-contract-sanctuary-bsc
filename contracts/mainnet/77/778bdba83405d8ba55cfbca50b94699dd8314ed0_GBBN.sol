...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x2509B528b46d486a4B82fdee6B4850A5Ed816f4a ;
...
contract GBBN is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = 1200000 * 10**5;

    address public charityWallet = 0x4FAEA5B8025E8732b6928275bAB1fB87b5A71A56;
    address public marketingWallet =  0xEbE6664793c0bf7a5060371A91030C313Ff10247;
  
    constructor () BEP20Detailed("The Global Barber Beauty Network", "GBBN", 5) {
    _totalSupply = 40000000000 * (10**5);
    ...
    function setCharityFeePercent(uint256 updatedCharityFee) external onlyOwner() {
        charityFee = updatedCharityFee;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(takeFee)
        {
            ...
            uint256 TotalSent = amount.sub(charityAmount);
