...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Af3DD79139C850C6AEed4cA2BD60896BB09bA89; // owner address
...
contract PawCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Paw Cat";
    string private _symbol = unicode"$Pawcat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7Af3DD79139C850C6AEed4cA2BD60896BB09bA89); // Marketing Address
    address payable public teamWalletAddress = payable(0x7Af3DD79139C850C6AEed4cA2BD60896BB09bA89); // Team Address
