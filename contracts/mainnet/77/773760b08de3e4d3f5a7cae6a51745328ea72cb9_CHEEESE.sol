...
contract CHEEESE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CHEEESEDividendTracker public dividendTracker;

    address payable public MarketingAndCHEESETrading;
    ...
    uint256 public sellMarketingAndCHEESETradingFees;
    uint256 public sellLiquidityFee;
    uint256 public buyDeadFees;
    uint256 public buyMarketingAndCHEESETradingFees;
    ...
    event UpdateFees(
        ...
        uint256 sellMarketingAndCHEESETradingFees,
        uint256 sellLiquidityFee,
        uint256 sellRewardsFee,
        uint256 buyDeadFees,
        uint256 buyMarketingAndCHEESETradingFees,
    ...
    constructor() ERC20("CHEEESE", "CHEESE") {
        MarketingAndCHEESETrading = payable(0x716F65e68c3c9468a02Fa4fF2f15D2605F94A6b6);
        devWallet = payable(0xeeD89403B8df20AA1B0330822453d40908890Db5);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 2;
        sellDeadFees = 2;
        buyMarketingAndCHEESETradingFees = 4;
        sellMarketingAndCHEESETradingFees = 4;
        buyLiquidityFee = 2;
        sellLiquidityFee = 2;
        buyRewardsFee = 4;
        sellRewardsFee = 4;
        ...
        totalBuyFees = buyRewardsFee
            .add(buyLiquidityFee)
            .add(buyMarketingAndCHEESETradingFees)
            .add(buyDevFee);
        totalSellFees = sellRewardsFee
            .add(sellLiquidityFee)
            .add(sellMarketingAndCHEESETradingFees)
            .add(sellDevFee);

         dividendTracker = new CHEEESEDividendTracker(
            payable(this),
            router,
        ...
        dividendTracker.excludeFromDividends(MarketingAndCHEESETrading);
        dividendTracker.excludeFromDividends(owner());

        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(dividendTracker)] = true;
        _isExcludedFromFees[address(MarketingAndCHEESETrading)] = true;
        ...
        maxWallet = totalTokenSupply / 50; // 20 mil tokens
        swapTokensAtAmount = totalTokenSupply / 1000; // 1 mil tokens;
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 50, "max wallet cannot be set to less than 20 million");
        maxWallet = value;
    }
    ...
    function updateFees(
        uint256 deadBuy,
        uint256 deadSell,
        uint256 MarketingAndCHEESETradingBuy,
        uint256 MarketingAndCHEESETradingSell,
        ...
        buyDeadFees = deadBuy;
        buyMarketingAndCHEESETradingFees = MarketingAndCHEESETradingBuy;
        buyLiquidityFee = liquidityBuy;
        buyRewardsFee = RewardsBuy;
        sellDeadFees = deadSell;
        sellMarketingAndCHEESETradingFees = MarketingAndCHEESETradingSell;
        ...
        emit UpdateFees(
            sellDeadFees,
            sellMarketingAndCHEESETradingFees,
            sellLiquidityFee,
            sellRewardsFee,
            buyDeadFees,
            buyMarketingAndCHEESETradingFees,
            buyLiquidityFee,
            buyRewardsFee,
            buyDevFee,
            sellDevFee
    ...
    function _transfer(
        ...
        uint256 RewardsFee;
        uint256 deadFees;
        uint256 MarketingAndCHEESETradingFees;
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                MarketingAndCHEESETradingFees = sellMarketingAndCHEESETradingFees;
                ...
                MarketingAndCHEESETradingFees = buyMarketingAndCHEESETradingFees;
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + MarketingAndCHEESETradingFees + devFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyMarketingAndCHEESETradingFees + buyDevFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellMarketingAndCHEESETradingFees + sellDevFee);
        }
        ...
        uint256 _completeFees = sellMarketingAndCHEESETradingFees.add(sellDevFee) +
            buyMarketingAndCHEESETradingFees.add(buyDevFee);

        uint256 feePortions;
        if (_completeFees > 0) {
            feePortions = address(this).balance.div(_completeFees);
        }
        uint256 MarketingAndCHEESETradingPayout = buyMarketingAndCHEESETradingFees.add(sellMarketingAndCHEESETradingFees) * feePortions;
        uint256 devPayout = buyDevFee.add(sellDevFee) * feePortions;

        if (MarketingAndCHEESETradingPayout > 0) {
            (successOp1, ) = address(MarketingAndCHEESETrading).call{value: MarketingAndCHEESETradingPayout}("");
        }
        if (devPayout > 0) {
        ...
        emit SendDividends(
            dividends,
            MarketingAndCHEESETradingPayout + devPayout,
...
contract CHEEESEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CHEEESE public CHEEESEContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CHEEESEContract = CHEEESE(mainContract);
        minimumTokenBalanceForAutoDividends = 10000_000000000000000000; // 100 tokens
    ...
    function _transfer(
        ...
        require(false, "CHEEESE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CHEEESE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CHEEESE contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CHEEESEContract);

            uint256 prevBalance = CHEEESEContract.balanceOf(address(this));
            ...
            {
                uint256 received = CHEEESEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CHEEESEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
