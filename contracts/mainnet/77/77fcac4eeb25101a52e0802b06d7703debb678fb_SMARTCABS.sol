...
// Telegram: https://t.me/SmartCabsBSC
...
contract SMARTCABS is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SmartCabs";
   string constant _symbol = "SMARTCABS";
