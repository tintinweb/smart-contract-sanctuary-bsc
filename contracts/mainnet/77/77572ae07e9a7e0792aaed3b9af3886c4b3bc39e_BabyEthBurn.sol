...
contract BabyEthBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyEthBurnDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyEthBurn", "BBBURNING") {
        ...
        dividendTracker = new BabyEthBurnDividendTracker(
            payable(this),
            router,
            0xB560F05a0efe629cdF6C8Cb9313A3c31E06831Ae,
            "BabyEthBurnTRACKER",
            "BBBURNINGTRACKER"
        );
...
contract BabyEthBurnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyEthBurn public BabyEthBurnContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyEthBurnContract = BabyEthBurn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyEthBurn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyEthBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyEthBurn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyEthBurnContract);

            uint256 prevBalance = BabyEthBurnContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyEthBurnContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyEthBurnContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
