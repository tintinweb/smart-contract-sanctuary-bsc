...
contract CAW2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3091364Fc72b847adAA8D0db3E2eC2B5bf637dDC); 
    address payable public Wallet_Dev = payable(0x8b29bf016c3AB3f80f8400e699AfAB128faCA3d2);
    ...
    string private constant _symbol = unicode"CAW2"; 
    ...
    constructor () {
        ...
        _owner = 0x8b29bf016c3AB3f80f8400e699AfAB128faCA3d2;
