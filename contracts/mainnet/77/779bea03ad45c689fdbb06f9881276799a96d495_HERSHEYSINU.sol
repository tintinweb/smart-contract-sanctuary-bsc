...
Telegram: https://t.me/hersheysbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x041ca41283FEdcd469cD27191Bc858D81261a961;
...
contract HERSHEYSINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "HERSHYES INU"; // 
    string private constant _symbol = "$Hersheys Inu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x041ca41283FEdcd469cD27191Bc858D81261a961);
