...
contract BabyVeriScan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby VeriScan";
    string private constant _symbol = "Baby VS";
    ...
    address public liquidityReceiver = address (0x00312c656F3De0074f23139634B68Ef7C956fFe2);
    address public marketingWallet = address(0x00312c656F3De0074f23139634B68Ef7C956fFe2);
