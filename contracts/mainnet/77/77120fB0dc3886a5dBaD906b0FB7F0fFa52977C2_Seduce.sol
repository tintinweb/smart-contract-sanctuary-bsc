...
contract Seduce is IERC20 {
    ...
    string constant private _name = "SEDUCE";
    string constant private _symbol = "SEDUCE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        buyback: payable(0xE178B095C18064EEc65b1CF9CB467692c31957ae)
        });
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint16 reflect, uint16 rewards, uint16 liquidity, uint16 marketing, uint16 buyback) external onlyOwner {
        uint16 check = reflect + rewards + liquidity + marketing + buyback;
    ...
    function setTaxesSell(uint16 reflect, uint16 rewards, uint16 liquidity, uint16 marketing, uint16 buyback) external onlyOwner {
        uint16 check = reflect + rewards + liquidity + marketing + buyback;
    ...
    function setTaxesTransfer(uint16 reflect, uint16 rewards, uint16 liquidity, uint16 marketing, uint16 buyback) external onlyOwner {
        uint16 check = reflect + rewards + liquidity + marketing + buyback;
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 buyback) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.buyback = buyback;
        _ratios.total = rewards + liquidity + marketing + buyback;
    }
