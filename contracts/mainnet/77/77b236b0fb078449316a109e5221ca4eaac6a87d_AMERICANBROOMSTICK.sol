...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a86e40FBa01DA279b75e2E5ad81661013C40176;
...
contract AMERICANBROOMSTICK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5Cab1Db94cCa57C103E4D56C71aca6B5d1BEf8da;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AMERICAN BROOMSTICK";
    string private _symbol = "$AMERICAN";
