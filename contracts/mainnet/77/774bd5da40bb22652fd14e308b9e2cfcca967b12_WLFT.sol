...
contract WLFT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x474dcB3a343bd8EdB54de3385b17FFbD0e6695ec);
    address payable public buyBackWalletAddress = payable(0x474dcB3a343bd8EdB54de3385b17FFbD0e6695ec);
