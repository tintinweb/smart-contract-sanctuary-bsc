...
contract DishuiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dishui Inu";
    string private _symbol = "DINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6acdC7d5a68DB93794A318F55a978fd82DFA6F8f);
    address payable public BuyBackWalletAddress = payable(0x6acdC7d5a68DB93794A318F55a978fd82DFA6F8f);
