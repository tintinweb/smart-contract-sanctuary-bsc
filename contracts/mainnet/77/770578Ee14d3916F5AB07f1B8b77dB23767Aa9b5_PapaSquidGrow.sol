...
PapaSquidGrow - Auto-stake PapaSquidGrow , Increase your tokens overtime while holding $PSQUID with the minimum amount of 0.1 bnb 
to auto-stake this is to keep the liquidity fat and strong while redistributing $PSQUID reflections.
 3% for Reflections and 2% for Liquidity and 2% goes to Marketing Wallet. 

https://t.me/PapaSquidGrow ( Portal to prevent bots )
http://papasquidgrow.com/
...
*/
    ...
    contract PapaSquidGrow   is IBEP20, Ownable
    {
        ...
        string private constant _name = "PapaSquidGrow";
        string private constant _symbol = "PSQUID";
        ...
        address public constant MarketingWallet=0x64a16eE2835743B8F85AA16F7656A1BEaD9Ab09c; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function SendToReflections(address[] calldata addresses) external onlyOwner {
