...
contract  LaEebToken is IERC20, Ownable {
    ...
    uint256 public minDistribution = 50 * (10 ** 8); // TODO 50token的持有人才可以参与分红
    uint256 public minLPDividendToken =  500 * (10 ** 8); // TODO 500* (10 ** 8)
    ...
    constructor(
        ...
        pundasAddr = 0x8e517c12688ccbcB2A52351A8566e9C29c725328;
        swapTokensAtAmount = 500* (10**18); // TODO 500* (10**18)
    ...
    function _transfer(
        ...
        if(pairInited>0 && totalDivider>0&&from != address(this) &&!isDividendExempt[to] &&!isDividendExempt[from] && !_tokenSwapCenter.inSwap()){
