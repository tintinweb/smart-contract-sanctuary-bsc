...
contract SaudiCake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SaudiCake";
    string private _symbol = "SAUDICAKE";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xD18c43b72bAB2f4D1474569D022c3de4D3285Cb8);
    address payable public devWallet = payable(0xD18c43b72bAB2f4D1474569D022c3de4D3285Cb8);
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
