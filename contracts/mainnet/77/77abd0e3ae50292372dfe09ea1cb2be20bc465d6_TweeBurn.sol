...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3a7043Af05D72ed4146fb8FBb7813bC7174fAea6; // owner address
...
contract TweeBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TweeBurn";
    string private _symbol = "TWB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cACD03b95a3A36F3e10F776555133cAB4f40f07); // Marketing Address
    address payable public teamWalletAddress = payable(0x7cACD03b95a3A36F3e10F776555133cAB4f40f07); // Team Address
