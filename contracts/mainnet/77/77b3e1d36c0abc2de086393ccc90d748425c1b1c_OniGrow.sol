...
/**
    ...
    Twitter: https://twitter.com/OniGrow
    Telegram:  https://t.me/onigrowportal
...
contract  OniGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oni Grow";
    string private _symbol = "ONIGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x485458682ad8AD444d7E37dcf571106332185704);
    address payable public teamWalletAddress = payable(0x1f99150af9bd7B9b0bbDA457A9209B08C5D2c489); 
