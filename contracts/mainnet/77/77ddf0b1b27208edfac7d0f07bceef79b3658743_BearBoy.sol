...
contract BearBoy is Context, IBEP20, Ownable {
    ...
    string private _name = "BearBoy"; // token name
    string private _symbol = "BEARBOY"; // token ticker
    ...
    uint256 public minTokenToSwap = 1 * 1e9; // 5k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 100000 * 1e9;
    uint256 public minBuyLimit = 1 * 1e9;
    ...
    uint256 public liquidityFeeOnBuying = 3;
    uint256 public marketWalletFeeOnBuying = 6;
    uint256 public burnFeeOnBuying = 1;

    // sell tax fee
    uint256 public reflectionFeeOnSelling = 0;
    uint256 public liquidityFeeOnSelling = 3;
    uint256 public marketWalletFeeOnSelling = 6;
    uint256 public burnFeeOnSelling = 1;
