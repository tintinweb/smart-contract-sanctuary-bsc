...
contract ButterMintNFT is Ownable, ERC165, IERC721, IERC721Metadata {
    ...
    // Token name
    string private _name = "M&B Artwork NFT";

    // Token symbol
    string private _symbol = "MBART";
    ...
    function claimToken(string memory uri) public
    {
