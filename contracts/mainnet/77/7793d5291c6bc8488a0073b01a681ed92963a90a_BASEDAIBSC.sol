...
contract BASEDAIBSC is Ownable, IBEP20 {
    ...
    string constant _name = "BASED AI BSC";
    string constant _symbol = "BASEDBSC";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xcC405313Aa606053C7d78EC02EE0aF8c73838c6a;
        devFeeReceiver = 0xcC405313Aa606053C7d78EC02EE0aF8c73838c6a;
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator/5, "Buy Fees cannot be more than 10%");
    }
