...
contract  PEPECZ is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE CZ";
    string private _symbol = "PEPECZ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe7C82A13DC120F2ddcb922CbFA3b44dF27291D90); 
    address payable public teamWalletAddress = payable(0x8133b6EF3ba7b9E6BC1E887d372dbE1fFF84537F); 
