...
contract Test_INU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Test INU";
    ...
    uint256 public numTokensSellToAddToLiquidity = 60 * 10**14;
    ...
    function _transferStandard(
        ...
        // _getTValues
        uint256 tFee = tAmount.mul(currentFee).mul(1).div(200);
        uint256 tLiquidityFee = tAmount.mul(currentFee).mul(5).div(1000);
