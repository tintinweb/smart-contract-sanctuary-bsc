...
/**
    ...
    Telegram : https://t.me/KaidoInuTwo
    Twitter  : https://twitter.com/KaidoInuTwo

    IF YOU MISS IT? YOU WILL BE SAD
    CAUSE YOU MISS 100X
    BIG MARKETING ALREADY BEFORE START
*/
...
contract KaidoInu20 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4935fD095c1cBbF5C01681772a1ebcAC41574B15);
    address payable public DevelopmentWalletAddress = payable(0x4935fD095c1cBbF5C01681772a1ebcAC41574B15);
    ...
    uint256 private _totalSupply = 2222222 * 10**9;
    uint256 public _maxTxAmount = 2222222 * 10**9;
    uint256 public _walletMax = 2222222 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2222222 * 10**9;
