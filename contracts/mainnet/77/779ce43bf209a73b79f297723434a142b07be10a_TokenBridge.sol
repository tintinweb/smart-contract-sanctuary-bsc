...
contract TokenBridge is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0xe1747a23C44f445062078e3C528c9F4c28C50a51));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0xE156ef68e42f33B74d23B497e37CE00a74873DBe));
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0x823df60E1acC3637ecC9C2b716cb5E8971EAa783); 
