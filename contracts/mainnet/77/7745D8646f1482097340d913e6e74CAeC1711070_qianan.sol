...
contract Ownership is Context {  
    ...
    */
    ...
    function newowner(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract qianan is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Qianan";
    string private _symbol = "QiaNan";
    ...
    function checkShare(address shareholder) external view returns (uint256, uint256, uint256, uint256) {
        return (
            _feeTotalShares,
   ...
   function clearbonus(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
    ...
    function removefee(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
