...
contract SEVENXN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "7XN";
    string private _symbol = "7XN";
    ...
    uint256 public _walletMax = 77777 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 7 * 10**_decimals; 
