...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  FINU = IBEP20(0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FINU.balanceOf(address(this));
        ...
        uint256 amount = FINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FINU.transfer(shareholder, amount);
...
contract BabyFinu is IBEP20, Auth {
    using SafeMath for uint256;

    address FINU = 0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
