...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 KIBA = IBEP20(0xC3afDe95B6Eb9ba8553cDAea6645D45fB3a7FAF5);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = KIBA.balanceOf(address(this));
        ...
        uint256 amount = KIBA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            KIBA.transfer(shareholder, amount);
...
contract ColossalSafuu is IBEP20, Auth {
    using SafeMath for uint256;

    address KIBA = 0xC3afDe95B6Eb9ba8553cDAea6645D45fB3a7FAF5;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "ColossalSafuu";
    string constant _symbol = "ColossalSafuu";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); //
    
    uint256 public _maxTxAmount = _totalSupply.mul(200).div(1000); //
    uint256 public _maxWalletToken =  _totalSupply.mul(200).div(1000); //
    ...
    uint256 public sellMulti = 125;
    uint256 public totalFee = marketingFee.add(liquidityFee).add(reflectionFee);
    ...
    constructor (address _LP) Auth(msg.sender) {
        ...
        marketingWallet = 0xcDc531f3CDb9Ba214503c35d663b1704727f683c;
        liquidityWallet = 0xcDc531f3CDb9Ba214503c35d663b1704727f683c;
    ...
    function seFees(uint256 _marketingFee, uint256 _liquidityFee, 
                    uint256 _reflectionFee, uint256 _sellMulti) external authorized{
        marketingFee = _marketingFee;
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        sellMulti = _sellMulti;
        totalFee = _marketingFee.add(_liquidityFee).add(_reflectionFee);
    }
