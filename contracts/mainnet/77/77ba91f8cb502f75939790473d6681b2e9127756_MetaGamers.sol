...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8e245515d46B6457e82cAE272c1F78AFe86ee1c;
...
contract MetaGamers is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe7d52bEEBB8315007133A137649E749295800d3B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MetaGamers";
    string private _symbol = "METAGAMERS";
