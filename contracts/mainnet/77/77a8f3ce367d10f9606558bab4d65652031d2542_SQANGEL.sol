...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31C8B6cd230c2bE3b16563935F6bD15CAf2f6bAA; 
...
contract SQANGEL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Squid Angel";
    string private constant _symbol = unicode"SQANGEL";
