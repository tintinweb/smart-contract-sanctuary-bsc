...
contract Apple is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_000_000_000_00 * 10**9;
    uint256 public _maxTxAmount = 1_000_000_000_00 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**9; //
    string private constant _name = "Apple (Binemon)"; //
    string private constant _symbol = "AMB"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x6616FC46BC2b439123836Fb2Ae13e0de35bf2F83 ;
