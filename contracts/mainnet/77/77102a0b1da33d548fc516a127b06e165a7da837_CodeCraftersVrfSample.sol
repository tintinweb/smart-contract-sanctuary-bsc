...
contract CodeCraftersVrfSample {
    ...
    ICCVRF public randomnessSupplier = ICCVRF(0xc0dec05bc2ccB8215724411210E151952313c0de);
    ...
    function startGame(uint256 randomnessFrom, uint256 randomnessTo) external payable {
