...
contract LuckyDraw is ReentrancyGuard{
    ...
    address private TrexBusd = 0xcC67a5CC58209FFacff0AD77b7fc496b1f574eB5;
    address private dev = 0xf36dbB2fA0b31481300639C55f1B7B048937116B;
...
uint256 private maxParticipantNumbers1;
    ...
    constructor()  {  
        ...
        ticketPrice1 = 3 ether;

         maxParticipantNumbers2 = 10;
...
for (uint i=0; i<arrayLength2; i++) {
  ...
  if (participants[i]==ad){
    ...
    function pickwinner() internal {
        ...
        uint256 TrexBusdFee = SafeMath.div(SafeMath.mul(contractBalance,26),100);
        uint256 devFee = SafeMath.div(SafeMath.mul(contractBalance,4),100);
      
        BusdInterface.transfer(TrexBusd,TrexBusdFee);
        uint256 winnerAmount = SafeMath.sub(contractBalance,TrexBusdFee);
        winnerAmount -= devFee;
