...
contract SixOneNine is IBEP20, Auth {
    ...
    string constant _name = "619";
    string constant _symbol = "619";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 619 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000;  // 1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 10) / 1000;  // 1% max wallet
    ...
    address private marketingFeeReceiver = 0xe12F6011596C22bF68039cFaA08964fdA86A16F6;
    address private teamFeeReceiver = 0xe12F6011596C22bF68039cFaA08964fdA86A16F6;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 30; // 3%
    bool inSwap;
