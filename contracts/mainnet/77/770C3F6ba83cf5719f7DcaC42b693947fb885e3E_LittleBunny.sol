...
Telegram :     https://t.me/LittleBunnyOfficial
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x282282a0cd902C3f4F404dc957C0E329021ca5bf;
...
contract LittleBunny is Context, IERC20, Ownable {
    ...
    string private constant _name = "LITTLE BUNNY"; // 
    string private constant _symbol = "lBUNNY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x282282a0cd902C3f4F404dc957C0E329021ca5bf);
