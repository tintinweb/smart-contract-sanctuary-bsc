...
contract TOYO is TOYODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private TOYOTeam;
    address private CharityTOYO;
    ...
    string public override name = "Toyotomi Inu";
    string public override symbol = "TOYO";
    ...
    constructor(uint totalSupplyValue, address TOYOTeamAddress, address CharityTOYOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        TOYOTeam = TOYOTeamAddress;
        CharityTOYO = CharityTOYOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[TOYOTeam] =  totalSupply * 4 / 100;
        balances[CharityTOYO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TOYOTeam pot
