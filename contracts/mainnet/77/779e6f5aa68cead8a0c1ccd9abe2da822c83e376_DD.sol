...
contract DD is ERC20, Ownable {
    ...
    constructor() ERC20("Dev Dev", "DD") {
        ...
        marketingWallet = address(0xA4741D2e699931470678496254276B7Ab7c09eC7); // set as marketing wallet
        devWallet = address(0x775d7E7127b9b9Cad40052b059e7359647eFB6Fd); // set as dev wallet
