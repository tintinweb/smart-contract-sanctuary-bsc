...
contract Invicta is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Invicta";
    string private constant _symbol = "Invicta";
    uint8 private constant _decimals = 9;
    uint private _totalSupply = 1900000000 * 10 ** _decimals;
