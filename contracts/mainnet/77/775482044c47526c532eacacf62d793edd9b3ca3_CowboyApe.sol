...
/* Token contract */
contract CowboyApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd52572119D47718C63bBe40385778CB72B270a51;
    ...
    // Name and symbol
    string constant _name = "CowboyApe";
    string constant _symbol = "$COWBOYAPE";
    ...
    uint256 private buybackFeeBuy = 2;
    ...
    uint256 private buybackFeeSell = 2;
    ...
    uint256 buybackMultiplierLength = 20 minutes;
