...
/*
    ...
    LGBT TOKEN ON BSC NETWORK

    Telegram    : t.me/RagilInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2B175185C541D5eA2E8661cA3667C2B736EEC83a; // owner address
...
contract RAGILINU is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "RAGIL INU";
    string private _symbol = "RAGIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B175185C541D5eA2E8661cA3667C2B736EEC83a); // Marketing Address
    address payable public teamWalletAddress = payable(0x2B175185C541D5eA2E8661cA3667C2B736EEC83a); // Team Address
