...
Telegram: https://t.me/dollcoin_official
Website: https://dollcoin.me

Feature and Tokenomics:
8% USDC Reward Fee
4% Marketing Fee
1% Liquidity Fee

USDC Reward auto distribution every hour
Minimum token to receive USDC is 100 Million (100.000.000)
Initial Liquidity/MCAP is 2.5 BNB/$930
Slippage on Buy or Sell 16% - 20%
50% of supply will be burned to death address
Initial LP Lock 1 Week will be extended on 20K Marketcap
Dapp creation for reward tracker will be released on 100K marketcap
*/
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address _rewardTokenAddress, uint256 _minimumTokenBalanceForDividends) DividendPayingToken("DOLL_Dividen_Tracker", "DOLL_Dividend_Tracker", _rewardTokenAddress) {
        claimWait = 3600;
...
contract DollCoin is ERC20, Ownable {
    using SafeMath for uint256;
