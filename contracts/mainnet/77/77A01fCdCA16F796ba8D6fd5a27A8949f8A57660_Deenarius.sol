...
/* Denarius~ (Cross-chain Automated Market Maker)

This gives anyone the ability to create a market by depositing their crypto assets into a liquidity pool.

Deenarius is a cross-chain automated market maker (“AMM”) on Binance chain that enables two tokens to be exchanged on the Binance Smart Chain. Different tokens are traded on our platform.

The Automated Market Maker (AMM) model simply implies that while trading digital assets on the exchange/platform, there is typically no order book where you are paired with another person.

Alternatively, you trade against a liquidity pool. Those pools are filled with funds from other users. They deposit into the pool, receiving liquidity provider (or LP) tokens in return. 

The basic trading functionality of Deenarius comes directly from the pankcakeswap codebase. Liquidity providers are incentivized for providing liquidity to trading pairs with rewards drawn from the fees paid by users swapping among the paired assets.

Telegram : https://t.me/Deenarius
 Website : https://deenarius.com (Live soon) */
...
contract Deenarius is IBEP20, Auth {
    ...
    string constant _name = "Deenarius";
    ...
    address public marketingFeeReceiver = 0x074969301fDF9756D72D4432ac2C551D38578efE;
    address public devFeeReceiver = 0xbfAb6E4dD25cDb10814AE1D57C20536293d88ce4;
