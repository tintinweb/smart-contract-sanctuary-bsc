...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97583144C3778947be0d5E8b92B19d8f2DAdf087; // owner address
...
contract whatthefloki is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x97583144C3778947be0d5E8b92B19d8f2DAdf087); // Marketing Address
    address payable public teamWalletAddress = payable(0x97583144C3778947be0d5E8b92B19d8f2DAdf087); // Team Address
