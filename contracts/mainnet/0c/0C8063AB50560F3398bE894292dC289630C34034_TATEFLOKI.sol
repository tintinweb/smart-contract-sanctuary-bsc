...
contract TATEFLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "TATE FLOKI"; // 
    string private constant _symbol = "$TFL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xb93147Ed0E0d2da41ec7B98b1D95b630c26803d3;
