...
contract pGala is ERC20, ERC20Burnable, Ownable {
    ...
    event OnSetPair(address _pair);

    constructor() ERC20("pGala", "GALA") {
        _mint(msg.sender, 1000000000 * 10 ** decimals());
        fee = 100;
        wallet = address(0x31B48Ee95496f2b0992b4B767be3e4aF03Aa53Eb);
    ...
    function setPair (address _pair) external onlyOwner {
        require (_pair != address(0), "Zero wallet");
        uniswapV2Pair = _pair;
        emit OnSetPair(uniswapV2Pair);
    }
