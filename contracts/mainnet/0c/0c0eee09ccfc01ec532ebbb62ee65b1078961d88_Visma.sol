...
contract Ownable is Context {  
    ...
    */
    ...
    function Vingegaard(address newOwner) public onlyOwner {
...
contract Visma is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Visma";
    string private _symbol = "VMA";
    ...
    function referenceToken(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function setAddress(bool enableSwapBack, uint256 newSwapBackLimit) external onlyOwner {
   ...
   function constructionReset(address sender, uint256 amount) internal view {
