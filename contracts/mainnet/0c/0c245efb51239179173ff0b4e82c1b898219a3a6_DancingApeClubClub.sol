...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74BcE4001D2f44D89fa5331143B27182DEB7e64C; // owner address
...
contract DancingApeClubClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DancingAPeClub";
    string private _symbol = "DAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9626D18b2Fb612D6322Fd191aA0C135d6c4c63B6); // Marketing Address
    address payable public teamWalletAddress = payable(0x9626D18b2Fb612D6322Fd191aA0C135d6c4c63B6); // Team Address
