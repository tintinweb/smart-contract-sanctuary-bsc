...
contract LOGANPAUL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOGAN PAUL COIN";
    string private _symbol = "$LPC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x6EE680672528A2EB3e62fa1cdCb34F80b0CcC702);
