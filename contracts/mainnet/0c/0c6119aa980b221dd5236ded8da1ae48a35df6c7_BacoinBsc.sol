...
BACOIN IS HERE! 
sizzling hot grilled bacoin!

A true Degen With Bitcoin rewards on every transaction!
...
Unique Feature: GREEDMODE
First 60 mins after launch  GREEDMODE will be enabled.
Lowering buy taxes to 5%✅
Upping sell taxes to 27%❌



Rewarding holders and incentivizing to hold for those tasty $BTC rewards!


https://t.me/Bacoinbsc
https://twitter.com/BacoinBsc
...
/* Token contract */
contract BacoinBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x068Cf2D642671BfeA2fd74C2F5b47b1c07887c47;
    ...
    // Name and symbol
    string constant _name = "BACOINBSC";
    string constant _symbol = "BACOIN";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 4% on launch or 1M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xB2ec13720E6FaC6397165639186B4434B73076E4;
        marketingFeeReceiver = 0xB46088F57705616228BA0aDEDCaa53bad7915417;
