...
//https://t.me/ArabianShibaSaudiGrow
...
contract ArabianShibaSaudiGrow is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"ArabianShibaSaudiGrow"; 
    string private constant _symbol = unicode"ARIBAS"; 
    ...
    uint256 public _maxWalletToken = _tTotal.div(29);
