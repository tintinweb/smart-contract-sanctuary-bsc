...
/**
  _____                       _____       _   _       
 |  __ \                     |  __ \     | | (_)      
 | |__) |   _ ___ ___ _   _  | |__) |   _| |_ _ _ __  
 |  ___/ | | / __/ __| | | | |  ___/ | | | __| | '_ \ 
 | |   | |_| \__ \__ \ |_| | | |   | |_| | |_| | | | |
 |_|    \__,_|___/___/\__, | |_|    \__,_|\__|_|_| |_|
                       __/ |                          
                      |___/    
*/
...
contract PussyPutin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFCD761A8088ABDa4903be9e35600FEc7093a0fa8); // Marketing Address
    address payable public teamAddress = payable(0x4E09bf747d31C9155CF3eF5e7c426906889A4115); // Team Address
    ...
    uint256 private _tTotal = 10000 * 10**7 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PussyPutin";
    ...
    uint256 public maxWalletToken = 10000 * 10**6 * 10**9;
    ...
    function setContractLockEnabled() public onlyOwner {
        contractLockEnabled = false;
        emit ContractLockEnabledUpdated(false);
    }
