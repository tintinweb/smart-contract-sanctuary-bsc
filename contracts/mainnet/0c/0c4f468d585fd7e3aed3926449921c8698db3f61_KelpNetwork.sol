...
// KelpNetwork with Governance.
contract KelpNetwork is BEP20 ('Kelp Network', 'KELP'), MinterRole {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "KELP::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "KELP::delegateBySig: invalid nonce");
        require(now <= expiry, "KELP::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "KELP::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying KELPs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "KELP::_writeCheckpoint: block number exceeds 32 bits");
