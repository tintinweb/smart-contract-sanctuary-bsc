...
contract SENGOKU20 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SENGOKU 2.0";
    string private _symbol = "SENGOKU 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x526df813eE5f274af9d4ac03d22a048F0a9f1baF);
    address payable public DevelopmentWalletAddress = payable(0x526df813eE5f274af9d4ac03d22a048F0a9f1baF);
    ...
    uint256 private _totalSupply = 350000 * 10**9;
    uint256 public _maxTxAmount = 350000 * 10**9;
    uint256 public _walletMax = 350000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 350000 * 10**9;
