...
contract ArabianBear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian Bear";
    string private _symbol = "Arbear";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe5aF967753a6d4dC136ed7fD377e8F7Edc3C839);
    address payable public BuyBackWalletAddress = payable(0xEe5aF967753a6d4dC136ed7fD377e8F7Edc3C839);
