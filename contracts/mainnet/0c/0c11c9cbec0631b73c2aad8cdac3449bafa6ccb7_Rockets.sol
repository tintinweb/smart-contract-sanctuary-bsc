...
contract Rockets is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rockets";
    string private _symbol = "Rockets";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a22B956c35B9F3Cc0c2456a3909b48a26F92C5e); // Marketing Address
    address payable public teamWalletAddress = payable(0x4a22B956c35B9F3Cc0c2456a3909b48a26F92C5e); // Team Address
