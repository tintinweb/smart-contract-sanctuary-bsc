...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinchan Christmas"; //
    string private constant _symbol = "Shinchan"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x6D27a73190AF99E7eFb272bD6C4b4B1d2a94332B;
