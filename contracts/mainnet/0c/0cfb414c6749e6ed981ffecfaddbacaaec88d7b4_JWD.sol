...
contract JWD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "John Wick Dog";
    string constant _symbol = "$JWD";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xE15388cB592AAbEc78e81793b9ebba35A7d5a015;
