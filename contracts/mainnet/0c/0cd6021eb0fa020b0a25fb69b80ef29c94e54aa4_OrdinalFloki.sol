...
contract OrdinalFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x94373e3cA6CAE49ADFb95d5aD3d4761E14d02918); 
    address payable public Wallet_Dev = payable(0x3f537C73B6ec68C5D568790eBc52c4b8aaf0bDD3);
    address payable public W_Deployer = payable(0x3f537C73B6ec68C5D568790eBc52c4b8aaf0bDD3);
    ...
    constructor () {
        ...
        _owner = 0x3f537C73B6ec68C5D568790eBc52c4b8aaf0bDD3;
