...
🥳🥇THE FIRST & ORIGINAL! MemeFamilyHoliday PRESENTS Nabbit AI Official 2023!  
ITS 100% custom BUILT with super DOPE functions installed! We have our name changing abilities, 
an Internal Buy Back & Burn mechanisms, the Charity & every holder get 3 REWARDS all done in ONE TRANSACTION!
(, BUSD, BNB, & DOGE)

🤑BIG marketing plans

Are you ready to take this ride with us?
*/
...
contract NABBITAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "NABBIT AI";
    string private constant _symbol = "NABBITAI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x2aDD6f3339cEc62e1246f90999FF40e1F507Cb26);
    address payable private _marketingAddress = payable(0x2aDD6f3339cEc62e1246f90999FF40e1F507Cb26);
