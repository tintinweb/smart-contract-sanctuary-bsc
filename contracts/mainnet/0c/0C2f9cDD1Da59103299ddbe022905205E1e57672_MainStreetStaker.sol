...
contract MainStreetStaker is Ownable, ReentrancyGuard {
    ...
    function harvestAndReStake() public onlyOwner() nonReentrant() {
        ...
        sendTokensToDistributor(buyBackMainstreet(IBEP20(BANANA_TOKEN).balanceOf(address(this))));
    }
    ...
    function sendTokensToDistributor(uint amount) private {
        IBEP20(MAINST_TOKEN).transfer(DISTRIBUTOR, amount);
    }
