...
/*
The Boar Inu was fumed up. He'd sharpened his fangs against the bark of the tree and ready that will take over the Meme World

Portal : https://t.me/BoarInu
Twitter : @BoarInuBSC
Website : www.BoarInu.app
...
contract BoarInu is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Boar Inu";
    string constant _symbol = "Boarrr"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 1 * 10**12 * 10**_decimals;
    ...
    uint256 public _maxTxAmount = _tTotal * 200 / 10000; //Initial 2%
    uint256 public _maxWalletSize = _tTotal * 400 / 10000; //Initial 4%

    // Fees Receivers
    address public devFeeReceiver = 0x1C255727655081DE7Cf23e04099dDC0ea4ec6E4b;
    address public marketingFeeReceiver = 0x1C255727655081DE7Cf23e04099dDC0ea4ec6E4b;
    address public liquidityFeeReceiver = 0x1C255727655081DE7Cf23e04099dDC0ea4ec6E4b;
    ...
    uint256 public maxSwapSize = _tTotal * 100 / 10000; //0.01%
