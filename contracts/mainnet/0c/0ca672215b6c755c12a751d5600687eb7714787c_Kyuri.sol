...
contract Kyuri is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kyuri Inu";
    string private _symbol = "KYURI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x28C9E5c9A631cb3f356B12Bd1fEd68127294EC65);
