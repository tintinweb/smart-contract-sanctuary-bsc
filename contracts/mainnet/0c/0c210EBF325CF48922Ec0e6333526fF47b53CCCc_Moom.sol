...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee2 = 800;
    ...
    constructor (
        ...
        holderCondition = 45000 * 10 ** Decimals;
    ...
    function Loc(address addr) external onlyOwner {
        fundAddress = addr;
...
contract Moom is AbsToken {
    constructor() AbsToken(
        ...
        address(0xD6Cb92134685a0e855889E05230Fdeb66dC7E609),

        address(0xD6Cb92134685a0e855889E05230Fdeb66dC7E609),

        address(0x918067E1b2B929cd4070eA8cDA8289bcd23AdF8b)
    ){
