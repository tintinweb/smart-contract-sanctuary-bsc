...
contract squidelonika is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squidelonika";
    string private constant _symbol = "SQUIDELONIKA";
    ...
    uint256 public swapTokenAtAmount = 225000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x3391FaFC0663927A459380fE75791a449b3d04BA);
    address private liquidityReceiver = address(0x3391FaFC0663927A459380fE75791a449b3d04BA);
