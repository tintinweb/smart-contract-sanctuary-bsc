...
/**
 🅱️🧑‍🌾🥭🦀 Project Serum BSC  🅱️🧑‍🌾🥭🦀

Blazingly fast trading on the world's first fully decentralized and open liquidity infrastructure.

(💙,🧡)(:D,:D)(🌸, 🌿)
https://t.me/ProjectSerum
https://wormhole.com/
https://twitter.com/projectserum
...
interface ProjectSerumBSCDeployer {
...
contract ProjectSerumBSC is ProjectSerumBSCDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ProjectSerumBSCTeam;
    address private CharityProjectSerumBSC;
    ...
    string public override name = "Project Serum BSC";
    string public override symbol = "Serum BSC";
    ...
    constructor(uint totalSupplyValue, address ProjectSerumBSCTeamAddress, address CharityProjectSerumBSCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ProjectSerumBSCTeam = ProjectSerumBSCTeamAddress;
        CharityProjectSerumBSC = CharityProjectSerumBSCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ProjectSerumBSCTeam] =  totalSupply * 4 / 100;
        balances[CharityProjectSerumBSC] = totalSupply * 4 / 100;
