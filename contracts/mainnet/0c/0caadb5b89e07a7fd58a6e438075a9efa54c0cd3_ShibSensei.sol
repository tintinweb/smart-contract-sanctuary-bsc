...
contract ShibSensei is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0x24951759d4e056254a5e7b6252515130Ccee8C6B);
