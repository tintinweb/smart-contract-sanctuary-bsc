...
// CHANGE
contract Shibalentine is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Shibalentine";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xD4A4eEeA20DAeB45d392b8880b422e7ed8468195);
