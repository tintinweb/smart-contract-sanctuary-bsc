 ...
 * Contract Code
 */
contract DSHIB is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Dungeon Shiba";
    ...
    address public marketingWallet = 0xACF0a9cBE936d61430873ffF75e2aD3169AbEf94; // 
    address public teamWallet = 0xACF0a9cBE936d61430873ffF75e2aD3169AbEf94;  //  
    address public gameWallet = 0xACF0a9cBE936d61430873ffF75e2aD3169AbEf94;     //   
...
// Owner Functions
    function ownerEnableTrading(uint256 _deadBlocks) public onlyOwner {
        ...
        require(_deadBlocks <=9,"Cannot set more than 9 deadBlocks");
        tradingEnabled=true;
	...
	require(game+team+marketing+liquidity<=20,"Cannot set Buy Fees over 20%");
        _buy.game=game;
        _buy.team=team;
	...
	require(game+team+marketing+liquidity<=20,"Cannot set Sell Fees over 20%");
        _sell.game=game;
        _sell.team=team;
