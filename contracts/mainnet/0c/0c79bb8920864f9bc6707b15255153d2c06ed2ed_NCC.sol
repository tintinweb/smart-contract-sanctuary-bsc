...
// Website: https://nekomatacatcoin.space/
// Telegram: https://t.me/NekomataCatcoin
...
contract NCC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc438bAb4f47Cd204D0118124d76b6CC32dB1bBb5); 
    address payable public Wallet_Dev = payable(0x28Fa68e386F1F900d13141e0546375620bf38023);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    string private constant _symbol = unicode"NCC"; 
    string private constant _name = "Nekomata Cat Coin";
