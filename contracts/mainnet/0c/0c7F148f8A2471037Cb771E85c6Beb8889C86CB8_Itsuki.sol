...
//TG: https://t.me/itsuki_channel
//WB:   http://itsukifans.com
//TW:      https://twitter.com/Itsuki_fans
...
contract Itsuki is Context, IERC20, Ownable {
    ...
    address public Itsuki_Marketing = 0x0cD963bd9A376d6Ca48b6873Fd547659dc0D77ef;
    address public Itsuki_Team = 0xC3CAF95C4B69E6787708f82Ed5Fcf81F760EeFBB;


    string private constant _name = "Itsuki";
    string private constant _symbol = "ITSUKI";
    ...
    Taxes public sellTaxes = Taxes(0,9,0,1);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Itsuki_Marketing] = true;
        _isExcludedFromFee[Itsuki_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Itsuki_Marketing] = true;
        allowedTransfer[Itsuki_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Itsuki_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Itsuki_Team).sendValue(teamAmt);
        }
    }
    ...
    function Itsuki_MpdateMarWallet(address newWallet) external onlyOwner{
        Itsuki_Marketing = newWallet;
    }
    
    function updateItsuki_Team(address newWallet) external onlyOwner{
        Itsuki_Team = newWallet;
    }
