...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcE147854dbb3f3A6F2a229278c3938C25e7ba0A0;
...
contract HamburgerKing is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcE147854dbb3f3A6F2a229278c3938C25e7ba0A0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HamburgerKing";
    string private _symbol = "HamburgerKing";
