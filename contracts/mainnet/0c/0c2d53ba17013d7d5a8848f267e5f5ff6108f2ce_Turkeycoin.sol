...
contract Turkeycoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Turkey Coin"; 
    string private _symbol = "Turkey Coin"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB9A58d838990643088dc2017d7d97c7E5042ace4); // Marketing Address
    address payable public teamWalletAddress = payable(0x3303D3096D878fcd926Cb392D65aAA5C3a845db6); //  Team Address
