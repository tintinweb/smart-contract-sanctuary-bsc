...
contract DOGEMIRA is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeMira";
    string private constant _symbol = "DMIRA";
    ...
    address private marketingWallet = address(0xB7DB66E7Cb7d7841F011B464c3c5CF64c9870002);
    address private liquidityReceiver = address(0xB7DB66E7Cb7d7841F011B464c3c5CF64c9870002);
