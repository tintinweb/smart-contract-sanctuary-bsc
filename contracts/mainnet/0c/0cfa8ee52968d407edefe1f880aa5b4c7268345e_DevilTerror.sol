...
*/
// TG: @DevilTerrorInu
// TWITTER: https://twitter.com/DevilTerrorInu
// WEBSITE: SOONNNN!!!!
/**
Tokenomics:
100% Supply to LP
...
"TerrorBlade appear in BSC network!!!!

This is my first token and i want to hype this and become succesful project, 
lot of markerting comes after launch, HOLD YOUR BAGS AND READY TO TAKE OFF!!!!!"
...
contract DevilTerror is IBEP20, Auth {
    ...
    string constant _name = "DevilTerror Inu";
    string constant _symbol = "DT";
    ...
    address private marketingFeeReceiver = 0x42638b782097Be7Af729706eAf5D2642387F8EAb;
    address private devFeeReceiver = 0x42638b782097Be7Af729706eAf5D2642387F8EAb;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);// mainet
