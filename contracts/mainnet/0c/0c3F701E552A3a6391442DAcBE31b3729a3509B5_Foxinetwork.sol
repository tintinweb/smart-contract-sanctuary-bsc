...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2D1CF77746Fb04b6369004F24648Fb98084f81cC; // owner address
...
contract Foxinetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Foxi Network";
    string private _symbol = unicode"FOXNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2D1CF77746Fb04b6369004F24648Fb98084f81cC); // Marketing Address
    address payable public teamWalletAddress = payable(0x2D1CF77746Fb04b6369004F24648Fb98084f81cC); // Team Address
