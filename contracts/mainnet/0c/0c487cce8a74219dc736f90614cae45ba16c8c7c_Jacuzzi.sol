...
contract Jacuzzi is Context, IERC20, Ownable, SafeMaths {
    ...
    uint256 private _tTotal = 20_000_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Jacuzzi';
    string private _symbol = 'JCZ';
    ...
    uint256 public _HoldLimit = 25_000_000 * 10**18;
    ...
    function setAntiBotLimitedEnabled(bool enabled) external {
        require(
            msg.sender == owner() || msg.sender == antiManager,
            'Only admin or anti manager allowed'
        );
        AntiBotLimited = enabled;
    }
