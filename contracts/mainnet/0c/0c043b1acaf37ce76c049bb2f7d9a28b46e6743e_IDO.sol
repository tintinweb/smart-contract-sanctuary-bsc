...
contract IDO is ReentrancyGuard, Context, Ownable {
    ...
    // Note : to set 20 BUSD , rate = 200 & divisor = 10, to set 2.8 BUSD, rate = 28 & divisor = 10
    constructor (uint256 rate, uint256 rateDivisor, address wallet, IERC20 token, IERC20 busdtoken)  {
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        return (weiAmount * _rate)/_rateDivisor;
    }
