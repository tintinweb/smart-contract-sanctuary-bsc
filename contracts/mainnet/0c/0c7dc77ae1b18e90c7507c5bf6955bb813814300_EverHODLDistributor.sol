...
/*
 * EverHODL is a new generation of APY protocols designed for sustainability and longevity.
 *
 * EverHODL (HODL) is a cryptocurrency launched in Q4 2022 built on BNB Smart Chain aiming to create the first decentralized marketplace for tokenized and NFT assets enabling exchanges between users.
 *
 * EverHODL (HODL) is an innovative form of funds that serves as a store of value and a payment method for services and products which will be added into the ecosystem gradually.
 *
...
contract EverHODLDistributor is IDividendDistributor {
...
contract EverHODL is ERC20Detailed, Ownable {
    ...
    uint256 public USDTDividendFee = 60;
    ...
    EverHODLDistributor distributor;
    address public HODLDividendReceiver;
    ...
    constructor() ERC20Detailed("EverHODL", "HODL", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x82f76e4f67f5Ed446A295f542b46d1223166e9d9;
        ...
        distributor = new EverHODLDistributor(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        HODLDividendReceiver = address(distributor);
        ...
        isDividendExempt[HODLDividendReceiver] = true;
 ...
 function swapBack() internal swapping {
    ...
    function setMaxHoldPercentage(uint256 percent) external onlyOwner {
        ...
        require(percent >= 1, "Must keep at 0.5% or more"); // 1% is 0.5%.
    }    
