...
contract worGmuu is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "worGmuu";
   string constant _symbol = "WRGMU";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x2eB1b697208DE40b79B218D26F76389f90567B3d).call{value: BNBMarketingamount, gas: 30000}("");
