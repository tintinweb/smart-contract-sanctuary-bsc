...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        maxWalletAmount = 100000 * 10**Decimals;
        _tTotal = total;
    ...
    uint256 public rewardThreshold = 10000 * (10 ** 6);
...
contract AAAA is AbsToken {
    constructor()
        AbsToken(
            ...
            6,
            100000000,
            address(0x161de6Bd02ac01C256a18993b069e00c10d33D25),
            address(0x407CbA21165c552C1cF1Ee4BaB7312Fe6b46Cf8c)
            //0x95CC1546b7Fae050f129201B3e516Ca14de1945f
        )
    {}
}