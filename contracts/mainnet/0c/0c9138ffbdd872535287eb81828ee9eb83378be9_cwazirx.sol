...
/**
 Telegram : https://t.me/NewCommunityWazirX
Tokenomics : 
Tax : 5/5
Marketing 4%
lp 1%
...
contract cwazirx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community WazirX";
    string private _symbol = "cWazirX";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x544AC80e18e93864F4A2B4A0be694B0eb6e805F3); // MARKETING Address
    address payable public teamWalletAddress = payable(0x544AC80e18e93864F4A2B4A0be694B0eb6e805F3); 
