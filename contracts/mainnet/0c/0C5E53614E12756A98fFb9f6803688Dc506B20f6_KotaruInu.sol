...
contract KotaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "KotaruInu";

    string private _symbol = "KOTARU";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0xEA6E430fF8ac0b8b89C378aBc845ec1de0ca6730;
    ...
    uint256 public _totalSupply =  992264837585959* 10**_decimals;
