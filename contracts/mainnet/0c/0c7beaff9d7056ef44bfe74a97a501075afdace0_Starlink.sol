...
contract Starlink is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    address payable public _buybackWalletAddress = payable(0x6e27085CbfD2db42341700583Dd895b7c1D08E2b);
    ...
    constructor() BEP20("Starlink", "Starlink") 
    {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Starlink: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
...
contract StarlinkDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Starlink_Dividend_Tracker", "Starlink_Dividend_Tracker") {
        claimWait = 3600;
