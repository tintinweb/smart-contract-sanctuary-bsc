...
contract SpaceKidzilla is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3600000000000000000000 * 10**9 * 10**9;
    uint256 public _maxTxAmount = _tTotal; 
    uint256 private SWAP_TOKENS_AT_AMOUNT = _tTotal/100;
    string public constant _name = "Space Kidzilla"; 
    string private constant _symbol = "SPACEKIDZILLA";   
    uint8 private constant _decimals = 0; 
    
    uint256 public _marketingFee = 1;
    uint256 private _liquidityFee = 1;

    address private  _marketingWallet = 0x9ab1012c844d71BE16633105C9e4334939d53Ce9;
