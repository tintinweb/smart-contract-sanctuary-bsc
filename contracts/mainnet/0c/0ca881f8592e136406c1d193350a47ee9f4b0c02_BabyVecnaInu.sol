...
BabyvecnaInu next hype on binance smart chain with low taxes and based dev (buy 0% sell 0 %)
...
contract BabyVecnaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyVecna Inu"; // 
    string private constant _symbol = "$VCN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xAc3bC5968A3E5F6e08276890575Ff537369e3662;
