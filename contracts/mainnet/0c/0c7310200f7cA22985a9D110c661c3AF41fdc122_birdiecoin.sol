...
Welcome to Birdie Coin (BIRDIE)!

Inspired by the McDonald's mascot for its chicken products, Birdie Coin is a charity token that aims to feed those in need by purchasing and distributing fried chicken meals all over the world.

Our goal is to make a difference, one drumstick at a time.  It's our way of giving back for all the blessings we have received in the world of crypto.

Come share our vision today!
...
Website: https://birdiecoinbsc.com
TG: https://t.me/birdiecoin_bsc
Twitter: https://twitter.com/birdiecoin_bsc
Tiktok: https://www.tiktok.com/@birdiecoin
FB: https://www.facebook.com/Birdie-Coin-107690072003420
...
contract birdiecoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Birdie Coin";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            charity: 2, // charity fee in %
            lp: 2, // lp rate in %
            toSwap: 9 // charity + dev + lp
        });
    ...
    event charityAndDevFeesAdded(uint256 devFee, uint256 charityFee);
    ...
    function setBuyFees(
        ...
        buyRates.dev = _dev;
        buyRates.lp = _lp;
        buyRates.toSwap = _charity + _dev + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.dev = _dev;
        sellRates.lp = _lp;
        sellRates.toSwap = _charity + _dev + _lp;
    }
    ...
    function rescueBNB(uint256 weiAmount) external onlyOwner{
        ...
        charityAddress.sendValue(weiAmount);
    }
