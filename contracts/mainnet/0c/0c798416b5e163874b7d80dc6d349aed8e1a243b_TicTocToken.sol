...
contract TicTocToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TicToc Token";
    string private _symbol = "$TCTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e97bA1afFF9acc9beF1aF06785E897Be5818393); // Marketing Address
