...
https://t.me/WalrusToken

Walrus Token is Joining the ”sea” hype on BSC, with cool tax and sweet tokenomics, this is the next moonshot!
...
Insider play from the Meme Father and the Get Down Low Boyz
...
contract WalrusToken  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Walrus Token';
    string private constant _symbol = 'WalrusToken';
