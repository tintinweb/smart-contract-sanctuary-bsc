...
contract NOKIAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nokia Inu";
    ...
    Taxes public buyTaxes = Taxes(1, 6, 1, 2);
    Taxes public sellTaxes = Taxes(0, 10, 35, 4);
    ...
    require(_Reflections+(_Marketing)+(_Liquidity)+(_Operations) <=49, "Sell Taxes cannot be higher than 49%");
