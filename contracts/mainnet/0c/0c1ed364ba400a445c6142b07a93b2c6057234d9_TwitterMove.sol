...
// Telegram : https://t.me/twittermove
...
contract TwitterMove is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Move";
    string private _symbol = "TM";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xFE2ADebb5D0b7f6d720BC9410bFc7516330aB43f); // Marketing Address
    address payable public teamWalletAddress = payable(0xFE2ADebb5D0b7f6d720BC9410bFc7516330aB43f); // Team Address
