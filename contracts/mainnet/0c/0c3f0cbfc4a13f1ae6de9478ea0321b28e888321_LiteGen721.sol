...
contract LiteGen721 is ERC721Enumerable, PaynodeEx, Ownable {
  ...
  constructor(
    ...
    uint256 _maxSupply
  	...
  	PaynodeEx(payable(address(0xa43Aafc5f8A9E0F84A2344E32df7a91c5518FAe7)), "ERC721Lite")
      payable
  {
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xa43Aafc5f8A9E0F84A2344E32df7a91c5518FAe7).call{value: address(this).balance * 5 / 100}("");
    require(hs);
