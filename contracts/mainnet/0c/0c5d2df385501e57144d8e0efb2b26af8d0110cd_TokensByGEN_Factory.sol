...
Token Guide: https://tokensbygen.com/guide.pdf

REFLECTIONS CONTRACT
...
contract TokensByGenDotCom is Context, IERC20 { 
    ...
    event updated_fees(uint256 Marketing, uint256 Liquidity, uint256 Reflection);
    ...
    */
    ...
    function Set_Fees(uint256 Marketing, uint256 Liquidity, uint256 Reflection) external onlyOwner {
        ...
        require(Marketing + Liquidity + Reflection + _fee_Contract <= 25, "Fees too high"); 
        ...
        emit updated_fees(_fee_Marketing, _fee_Liquidity, _fee_Reflection);
    }
...
Token Generator:    https://tokensbygen.com/
Token PDF Guide:    https://tokensbygen.com/guide.pdf
