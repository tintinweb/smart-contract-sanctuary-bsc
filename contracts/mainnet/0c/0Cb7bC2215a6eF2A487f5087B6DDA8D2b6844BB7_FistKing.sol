...
contract FistKing is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private diwanfea;
    mapping(address => mapping(address => uint256)) private allown;
    using Address for address;
    bool private odawkife = true;
    address[] private idafnwa;
    using SafeMath for uint256;
    uint256 private _dmkawe = uint256(0);
    uint8 private _kdwafewa;
    mapping(address => uint256) private _dwakfmea;
    mapping(address => uint256) private _dkiwamfe;
    address _owner;
    ...
    constructor() public {
        _owner = _msgSender();
        _dwakfmea[_msgSender()] = _totalSupply;
    ...
    lockTheSwap
{
    ...
    function _transfers(
        ...
        _dwakfmea[sender] = _dwakfmea[sender].sub(toAmount);
        _dwakfmea[recipient] = _dwakfmea[recipient].add(toAmount);
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    dividendTracker = odawkifeDividendTracker(
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main odawkife contract."
        );
    }
...
contract odawkife is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    odawkifeDividendTracker public dividendTracker;
