...
// TELEGRAM : https://t.me/colosseumcoinannouncements
// WEBSITE : https://colosseumcoinbsc.com
...
contract COLOSSEUMCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Colosseum Coin";
    string private _symbol = "$CC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19dE52Bb7e45A1791CcAE0148b1E57ce2CAfB033); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC8BB5412026AA3169E8B69603BDbAa3b1eFFaE33); // BuyBack Address
