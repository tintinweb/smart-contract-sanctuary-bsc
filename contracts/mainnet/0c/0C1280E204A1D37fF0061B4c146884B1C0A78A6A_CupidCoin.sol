...
/* Token contract */
contract CupidCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x646c62dDB32D6666af3D0E28b9418296cc06bE44;
    ...
    // Name and symbol
    string constant _name = "CupidCoin2K22";
    string constant _symbol = "CUPC";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1billion
