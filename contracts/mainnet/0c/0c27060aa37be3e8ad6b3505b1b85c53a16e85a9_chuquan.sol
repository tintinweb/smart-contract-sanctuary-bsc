...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee2 = 299;
    ...
    constructor (
        ...
        _inviteFee[7] = 0;
        _inviteFee[8] = 0;
        _invitorCondition = 1 * usdtUnit;
        _binderCondition = usdtUnit;
    }
    ...
    function setBinderCondition(uint256 usdtUnit) external onlyOwner {
        _binderCondition = usdtUnit;
    }
...
contract chuquan is AbsToken {
    constructor() AbsToken(
        ...
        8,
        16000,
        address(0x9F3d8C4d7C3982d5EAceDcEe09781424Ce962485),
        address(0x9F3d8C4d7C3982d5EAceDcEe09781424Ce962485),
        address(0x9F3d8C4d7C3982d5EAceDcEe09781424Ce962485),
        0,
        0,
