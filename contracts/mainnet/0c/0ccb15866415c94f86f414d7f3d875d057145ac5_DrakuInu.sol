...
/**
    ...
    $PIZZILLA Low tax community driven coin 3/3
    Join us, sit back and enjoy the burns, utilities and memes 🔥
    Telegram: https://t.me/DrakuInu
    Tax: 3% Tax Buy/Sell
...
contract DrakuInu is IBEP20, Auth {
    ...
    string constant _name = "Draku Inu";
    string constant _symbol = "DRAKINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;     //5%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;   //10%
    ...
    address private marketingFeeReceiver = 0xAC7Ca3008ec4ee3c244A5bf36C890c84c67bE36b;
    address private teamFeeReceiver = 0xAC7Ca3008ec4ee3c244A5bf36C890c84c67bE36b;
