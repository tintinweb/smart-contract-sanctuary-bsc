...
contract FLINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FLOKI LIBERTARIAN INU";
    string constant _symbol = "FLINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xe58a8bbf5d37E4EAe3A4201f63820bae041ACaC6;
        marketingWallet = 0xe58a8bbf5d37E4EAe3A4201f63820bae041ACaC6;  //marketingwallet
        rewardWallet = 0xe58a8bbf5d37E4EAe3A4201f63820bae041ACaC6; //reward wallet
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address RewardWallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(rewardWallet).call{value: anothermarketingShare, gas: 30000}("");
    ...
    function AirdropInvestors(address from, address[] calldata addresses, uint256[] calldata tokens) external authorized {
        ...
        for(uint i=0; i < addresses.length; i++){
            ...
            if(!isDividendExempt[addresses[i]]) {
                try dividendDistributor.setShare(addresses[i], balanceOf(addresses[i])) {} catch {} 
            }
    }
