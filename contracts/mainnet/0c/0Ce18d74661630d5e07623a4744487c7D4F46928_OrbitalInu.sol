...
/*
TG : https://t.me/OrbitalInu

OrbitalInu ~ A New Gem Token with 100x Potential
Brought to you by Based Dev, CryptoSpace
Aim to become one of the top token that has payment utility, OrbitalInu is ready to launch on BSC. By having a team with an experienced Dev, and talented DApps programmer, we will definitely hype on BSC.

Tokenomics:
1) A total of 1 quadrillion supply
2) 2% buy tax & 9% sell tax
3) Brought to you by experienced based Dev, CryptoSpace
4) Payment utility
5) Bullish name
*/
...
contract OrbitalInu is Context, IERC20 { 
    ...
    string private constant _name = "OrbitalInu"; 
    string private constant _symbol = "$OrbitalInu"; 
