...
contract SilverMembershipKeyCard is JOCSpeakEasyERC721 {

    constructor()
        JOCSpeakEasyERC721(
            "SilverMembershipKeyCard",
            "SMKC",
            "ipfs://Qmc4RSoJV55Ew5A9qPLBpb3EvATHjbVM46nnE49fPaaA5k"
        )
    {}
}
    ...
    ERC2981
{
    ...
    uint256 internal mintedCount = _tokenIdCounter.current();
    ...
    address internal speakEasyContractAddress;
    address internal mintingContractAddress;
