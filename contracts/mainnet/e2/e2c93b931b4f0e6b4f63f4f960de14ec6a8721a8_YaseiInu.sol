...
contract YaseiInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Yasei Inu";
    string private constant _symbol = unicode"YAINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevAddress = payable(0x419BA0A271b86F34d6BA874F6d331Be7CA1fFb73);
    address payable private MarketingAddress = payable(0x88568d0c4798b28BDf8a4683F20ef726EE13B6Da);
