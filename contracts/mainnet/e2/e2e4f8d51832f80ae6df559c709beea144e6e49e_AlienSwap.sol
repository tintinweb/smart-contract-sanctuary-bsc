...
contract AlienSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x87Dfa0A837114417300Fc0c0f405AD85Cfb8cAb6); // Marketing Address
    ...
    string private _name = "AlienSwap";
    string private _symbol = "ALS";
