...
contract seXRP is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xb0c7bd20c4aeDf1D25CcEe82F32FD85c6AD6C39D;
    address public donationWallet = 0x398865A070aB5dA14e5B652a737B04C8dd2f28CC;



    string private constant _name = "seXRP";
    string private constant _symbol = "XXXRP";
    ...
    Taxes public taxes = Taxes(0, 8, 2, 2);
    Taxes public sellTaxes = Taxes(0, 8, 2, 2);
