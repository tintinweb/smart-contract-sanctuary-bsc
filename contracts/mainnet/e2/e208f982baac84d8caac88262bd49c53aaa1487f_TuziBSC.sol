...
contract TuziBSC is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("TuziBSC", "TUZI") {
        liquidityFee = 3;
        marketingFee = 8;
        marketingWallet = payable(0x61eDF5a00705e6cE411ec1654d005f8c0188CbA0);
