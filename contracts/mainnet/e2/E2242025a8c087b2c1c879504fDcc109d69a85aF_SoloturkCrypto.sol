...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E0Df1300f326A6Ec2987Bff131921bAc2c843E7; // owner address
...
contract SoloturkCrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Soloturkcrypto";
    string private _symbol = "$SOLOTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70C6134E4bC76136a1709adf501CDd1f9718fc4A); // Marketing Address
    address payable public teamWalletAddress = payable(0x092cce8D232d90e251a242d9DD8F4b9c705328E4); // Team Address
