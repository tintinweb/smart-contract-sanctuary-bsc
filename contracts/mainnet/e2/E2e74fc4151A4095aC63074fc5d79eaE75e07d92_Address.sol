...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb0a746221C6C2655eD4DB8B48102e199Da55B8E7; // owner address
...
contract ShibaMove is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaMove";
    string private _symbol = "SHIBM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0a746221C6C2655eD4DB8B48102e199Da55B8E7); // Marketing Address
    address payable public teamWalletAddress = payable(0xb0a746221C6C2655eD4DB8B48102e199Da55B8E7); // Team Address
