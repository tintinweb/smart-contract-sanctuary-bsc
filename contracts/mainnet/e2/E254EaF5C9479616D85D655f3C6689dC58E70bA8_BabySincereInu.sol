...
/* Token contract */
contract BabySincereInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd8065736C05b2ED073f06eCf0E0C301e6ae83155;
    ...
    // Name and symbol
    string constant _name = "BabySincereInu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2.0% on launch or 2M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 20 / 10000; // 1% or 1M tokens
