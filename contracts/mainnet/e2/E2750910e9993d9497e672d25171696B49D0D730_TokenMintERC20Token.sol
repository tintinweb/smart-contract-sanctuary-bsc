 ...
 */
contract TokenMintERC20Token is IERC20 {
    ...
    constructor(string names, string symbol, uint8 decimals, uint256 totalSupply, address tokenOwnerAddress, address zeroAddress) public payable {
        _name = names;
        _symbol = symbol;
        _decimals = decimals;
