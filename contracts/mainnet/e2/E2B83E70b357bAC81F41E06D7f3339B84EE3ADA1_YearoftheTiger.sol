...
Marking the start of the Chinese New Year and the new zodiac sign.
Release your inner tiger and join the journey of Roar!

 

TOKENOMICS:

Supply: 1,000,000,000,000,000 tokens
...
TG: http://t.me/yearofthetigerofficial
...
contract YearoftheTiger is IBEP20, Auth {
    ...
    string constant _name = "Year of the Tiger";
    ...
    uint256 public extraFeeOnSell = 15;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0Bb187dE875eFb9E36f5f4Df1275c809034C9f46;  //marketingwallet

        buybackWallet = 0xf78E6D94fC3d49DE09fF11ed82a1B13268dD5d9C;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 buybackShare = amountBNBMarketing.sub(marketingShare);
