...
contract Token is Context, IERC20 {
    ...
    string private _name = "SeaBunny";
    string private _symbol = "SBN";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x5FC2F209772EdCf211287fAbF9b721B5c1128eBA);
        ...
        _isExcluded[Wallet_Marketing] = true;
    ...
    function changeTax(uint256  buyTax,  uint256 sellTax,
