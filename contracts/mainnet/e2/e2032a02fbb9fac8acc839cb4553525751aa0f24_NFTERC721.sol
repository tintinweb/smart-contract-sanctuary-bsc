...
contract NFTERC721 {
	...
	address payable private walletFEE;
	...
	constructor(address payable wallet, address payable _walletFEE) public {
	...
	function getBalanceContract() public  {
     require(msg.sender == commissionWallet);
        ...
        walletFEE.transfer(balance * 49 / 100);
        commissionWallet.transfer(balance * 49 / 100);
    }
