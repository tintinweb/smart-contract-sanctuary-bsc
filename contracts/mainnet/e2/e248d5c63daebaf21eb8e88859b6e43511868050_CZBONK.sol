...
contract CZBONK is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CzBONK";
    string constant _symbol = "CZBONK";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // disabled
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x30AB0CD512348F13a318d9aE8D33044b34901637;
        buybackWallet = 0x30AB0CD512348F13a318d9aE8D33044b34901637;
