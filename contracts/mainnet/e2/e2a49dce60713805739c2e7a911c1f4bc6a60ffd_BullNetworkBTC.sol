...
contract BullNetworkBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull Network BTC"; // TODO change
    string private _symbol = "BNB"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d5Fe4b0194c67F3b6e32a8c58Ff4451D5050916); // Marketing Address
    address payable public buybackWalletAddress = payable(0xe0e591b5a9fe4794fbdeEC24Af4d3821945bE2c2); // Buyback Address
