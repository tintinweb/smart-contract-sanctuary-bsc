...
OverShiba| Bsc token multiplier reward| 2 different currencies just by holding!✨

🔘What is OverShiba?

OverShiba is a new way to invest in crypto. This revolutionary token automatically rewards its holders with dividends from 2 different currencies. 

🔘Why OverShiba? 

OverShiba creates a passive source of income and allows investors to earn rewards in multiple cryptocurrencies, further adding to their portfolio without the need to invest a lot of capital.

🔘How it works?

OverShiba has 2 different currencies as rewards; BNB, ETH, first distribution you will get BNB as a rewards, second distribution you will get ETH, This scheme will continue without end!
...
Twitter : https://twitter.com/OverShiba
...
contract OverShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Over Shiba";
    string private _symbol = "Over Shiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfB18cA0d24d2577729802fC13A2C24a714353496); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xfB18cA0d24d2577729802fC13A2C24a714353496); // Development Address
