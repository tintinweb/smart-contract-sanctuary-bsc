...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public  maxWalletAmount = 30 * 10 ** _decimals;
    ...
    constructor (
        ...
        maxWalletAmount = 30 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xFafB95071E9e25e7580D7dE59b21A8E8c0189D41;
...
contract SB is AbsToken {
    constructor() AbsToken(
        ...
        address(0x16F6Fcb1f3f98923d33327499f5822bB9B93e864),
    
        address(0x844D003cad5a9902c261fb055d2976081564dFC2)
    ){
