...
contract RyoshiToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "RYOSHI Token"; // 
    string private constant _symbol = " $RYOSHITOKEN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x30056C5Db2bD48b1270AEdcE65758D3d8d3cC9Cd;
