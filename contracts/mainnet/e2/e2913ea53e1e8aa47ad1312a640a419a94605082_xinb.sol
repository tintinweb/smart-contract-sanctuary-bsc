        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x4Ad4a25501b594b183334f859dBB183Bb1b31384), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        10000000,//Su
        address(0x4Ad4a25501b594b183334f859dBB183Bb1b31384),//
        address(0x4Ad4a25501b594b183334f859dBB183Bb1b31384)//
    ){
    }
}