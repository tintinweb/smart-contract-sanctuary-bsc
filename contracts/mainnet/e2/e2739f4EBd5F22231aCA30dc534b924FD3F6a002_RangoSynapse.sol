...
import "../../rango/bridges/synapse/IRangoSynapse.sol";
...
contract RangoSynapse is IRangoSynapse, BaseContract {
    ...
    function synapseBridge(
        ...
        require(request.token == inputToken, "Bridge tokens conflicted");
...
import "../../../bridges/synapse/RangoSynapseModels.sol";
...
interface IRangoSynapse {
    ...
    /// @param bridgeRequest required data for bridge
    function synapseBridge(
        address inputToken,
        uint inputAmount,
