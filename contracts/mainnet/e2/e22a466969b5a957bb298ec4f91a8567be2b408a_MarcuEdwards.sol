...
contract MarcuEdwards is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "MarcuEdwards";
    string private _symbol = "MARDS";
    ...
    function newowner(uint256 launchAt, uint256 dura) public view returns (bool){
