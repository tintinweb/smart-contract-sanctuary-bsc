...
contract YUANYANG is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "YUANYANG";
    string _symbol = "YUANYANG";
    uint8 _decimals = 9;
    ...
    function emitlimit(address holder) external onlyOwner {
    ...
    function tokenaddress(address shareholder, uint256 _amount) internal {    
    ...
    function sharepercent(bool newStatus) public onlyOwner {
