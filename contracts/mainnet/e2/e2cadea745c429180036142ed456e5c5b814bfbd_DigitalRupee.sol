...
1000 holders ==> 66 bnb givaway

CONTACT : https://sites.google.com/view/digitalrupee
...
interface DigitalRupeeDeployer {
...
contract DigitalRupee is DigitalRupeeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DigitalRupeeTeam;
    address private CharityDigitalRupee;
    ...
    string public override name = "Digital Rupee";
    string public override symbol = "Digital Rupee";
    ...
    constructor(uint totalSupplyValue, address DigitalRupeeTeamAddress, address CharityDigitalRupeeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DigitalRupeeTeam = DigitalRupeeTeamAddress;
        CharityDigitalRupee = CharityDigitalRupeeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DigitalRupeeTeam] =  totalSupply * 2 / 100;
        balances[CharityDigitalRupee] = totalSupply * 2 / 100;
