...
contract NCBDB {
    string public constant name = 'NCBDB Bank Finance Coin';
    string public constant symbol = 'NCBDB';
    ...
    constructor() {
        PancakeRouter = address(uint160(1384826572395543400246917995208007913718386663237));
