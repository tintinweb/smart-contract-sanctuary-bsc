...
abstract contract Auth {
    ...
    /**
     * Remove address' authorization. Owner only yes
     */
...
contract SpookyFlokiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Spooky Floki Inu";
    ...
    uint256 public swapThreshold = _totalSupply * 397 / 100000; // 0.039
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Checks max transaction limit NO LIMIT
    ...
    // switch Trading trading cant be off
    function tradingStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }

    // enable cooldown between trades YES
