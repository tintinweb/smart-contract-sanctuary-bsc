...
abstract contract Auth {
 ...
 contract SafeMarsCEO is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "SafeMars CEO";
    string constant _symbol = "SMARS CEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xcF4709050e4c3261c5fE77B75c134d21Ea8a4A84; // liquidity
