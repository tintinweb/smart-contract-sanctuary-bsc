...
//The year of Rabbit 2023 - Bunny Coin
//Telegram: https://t.me/BunnyCoinGroup
...
contract BunnyCoin is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Bunny Coin';
    string private constant _symbol = 'BUNNY';
    //uints
    uint public constant InitialSupply= 9000000 * 10**_decimals;
    ...
    address private projectWallet=0x1B322b127A18ADa232d669418F6261017457e394;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            require(!earlyBird[recipient] && !earlyBird[sender], "Cannot send tokens to a earlyBird"); 
            tax=transferTax;
        }
