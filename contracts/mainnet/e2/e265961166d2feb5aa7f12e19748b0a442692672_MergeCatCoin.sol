...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA2E7AfeEc6C06a2923cd13D01f87638aDD4B79a4;
...
contract MergeCatCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x11d294E4BF9Cb61C37E51cbc1fD61A3e4F1ED5B0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Merge Cat Coin";
    string private _symbol = "$MCCoin";
