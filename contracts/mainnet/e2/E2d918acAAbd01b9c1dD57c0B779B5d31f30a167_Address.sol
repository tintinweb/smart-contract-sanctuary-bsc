...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TWEETIES is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "TWEETIES";
        string private  _symbol = "TWII";
    ...
    uint256 public _maintenanceFee = 8; 
   ...
   address payable maintenanceWallet = payable(0xbEa0711b28f067052E51477C7f816eF08b22D4DC);
