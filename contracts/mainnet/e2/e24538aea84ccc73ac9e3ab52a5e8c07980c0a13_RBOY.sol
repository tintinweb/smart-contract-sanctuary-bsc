...
contract RBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatBoy!!!";
    string private _symbol = "RBOY!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03AdF246FbB87f06DEeF69668e891A9Cad73C978);
    address payable public BuyBackWalletAddress = payable(0x03AdF246FbB87f06DEeF69668e891A9Cad73C978);
