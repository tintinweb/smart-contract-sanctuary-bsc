...
contract Crostini is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Crostini";
    string constant _symbol = "TINI";
    ...
    function restAnalysis(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
    function removefee(uint8 _target, uint8 _denominator) external authorized {
        targetLiq = _target;
    ...
    function limitfee(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
        liqFee = liquidityFee;
