...
/*
MotherofCats 🐱 with our main avatar called Katleesi is a GOT-themed, a reflection-based token on the Binance Smartchain which will give you $MCats reflections as a way of rewarding it's holders

11% BUY TAX
5% of the sales is going to fund the Marketing/Operations Wallet to further fund the marketing and operational development of Mcat. 3% will be added to the LP. 2% is distributed to holders while 1% goes to the Dev wallet

13% SELL TAX
7% of the sales is going to fund the Marketing/Operations Wallet to further fund the marketing and operational development of Mcat. 3% will be added to the LP. 2% is distributed to holders while 1% goes to the Dev wallet

Max buy: 2%
Max wallet: 4%

https://t.me/motherofcatsbsc
https://www.katleesi.com/
*/
...
contract MotherOfCats is Context, IBEP20, Ownable {
    ...
    string private _name = "Mother of Cats";
...
//Remove from Blacklist
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == Pair && recipient != address(uniswapv2router);
