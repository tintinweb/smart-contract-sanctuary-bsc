...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x0000000000000000000000000000000000000000); 
...
contract MOM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StepMom";
    ...
    uint256 public _maxTxAmount = _totalSupply * 100000000 / 100;
    uint256 public _walletMax = _totalSupply * 20000 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1b9dbA9Aef1F6Ba5c551658BF96caF564FC627A5;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) public {
    ...
    function tradingStatus(bool newStatus) public {
