...
Telegram https://t.me/whenhotbit
*/
...
contract WHEN_HOTBIT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x20BAF2aAe7D30bE10E7df8357482740168d520a7); 
    address payable public Wallet_Dev = payable(0x6de7d46B67225D8ae0b6Ba3b2aF6EF76F9c2E866);
    ...
    string private constant _name = "WHEN HOTBIT"; 
    string private constant _symbol = unicode"WHOTBIT"; 
    ...
    constructor () {
        ...
        _owner = 0x6de7d46B67225D8ae0b6Ba3b2aF6EF76F9c2E866;
