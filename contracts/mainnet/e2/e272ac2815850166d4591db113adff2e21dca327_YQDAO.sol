...
contract YQDAO is Ownable {
 ...
 ///////////////////////////////// constant /////////////////////////////////
    ...
    address FUND_ADDRESS = 0xa812D173E4a36E34c4E32C51D6a6e6FCa313dE97;
    address MARKET_ADDRESS = 0x096F899B957D27a53F6310987cE18Bd0fCc61921;
    ...
    function mintNFT(uint _type, uint _oder)external{
        ...
        require(!_oderState[_oder], "Not yet open");
    ...
    function transferNFT(uint _oderId, address _to, uint _amount, uint8 _v, bytes32 _r, bytes32 _s) external payable {
