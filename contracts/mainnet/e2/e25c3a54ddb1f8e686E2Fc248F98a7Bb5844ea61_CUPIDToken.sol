...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 888 * 10**18;
    string private _name = "SOWL";
    string private _symbol = "SOWL";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x17dc1CD8C77720BcC0a0fF9CE300AEF7026D1CA1);
    address public pointAddress = address(0xe8ddac2dBA2cA93392259D3B08Fc93a766B3038d);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 888 * 10**18;
