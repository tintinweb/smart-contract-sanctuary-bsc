...
contract FootballCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FootballCat";
    string private _symbol = "FootballCat";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1b300fE19D28C4f14DE45AfAbddb8Fb1721A7eeE); 
    address payable public BurnedWalletAddress = payable(0x1b300fE19D28C4f14DE45AfAbddb8Fb1721A7eeE); 
    ...
    uint256 private _totalSupply = 1000 * 10**10 * 10**_decimals;
