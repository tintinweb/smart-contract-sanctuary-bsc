...
contract SafeOneChainStakingPool is ReentrancyGuard {
   ...
   /* ========== MUTATIVE FUNCTIONS ========== */
    ...
    function emergencyRecoverBeans() external onlyOwner {
        uint balance = address(this).balance;
        (bool success, ) = msg.sender.call{value: balance}("");
        require(success, "Transfer failed.");
    }

    function emergencyRecoverBep20(IERC20 _token) external onlyOwner {
