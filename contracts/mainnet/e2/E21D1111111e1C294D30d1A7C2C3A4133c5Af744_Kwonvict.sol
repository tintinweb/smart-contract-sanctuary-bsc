...
contract Kwonvict is IERC20, Ownable {
    using SafeMath for uint256;

    string constant _name = "KwonVict Inu";
    string constant _symbol = "KwonVict";
    ...
    uint256 public biggestBuy = 1;
    uint256 public lastWhaleChange = 3;
    ...
    uint256 private totalFeeIfSelling = 13;
    address public autoLiquidityReceiver;
    address public marketingWallet;
    address public Whale;
    address public _payOutAddress;

    bool public _isLaunched = true;
    uint256 _launchTime;
