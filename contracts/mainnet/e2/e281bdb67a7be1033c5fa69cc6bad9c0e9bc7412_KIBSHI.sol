...
contract KIBSHI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KiboShib";
    string private _symbol = "KIBSHI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9DC7F89111EdD5f8a3e7b70A856A53f58dd354fa); 
    address payable public BurnedWalletAddress = payable(0x9DC7F89111EdD5f8a3e7b70A856A53f58dd354fa); 
