...
/**
 Cat Heist Stealth Launch

Cat Heist - is your next BSC moonshot and a rare BSC gem. Cat Heist  is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. 
...
We are the team behind it, and this new project named Cat Heist could go millions too! Mark Our Words

Safeeth 2.0 have beautiful chart and PitJupiter break 1 Million Market Cap

Benefits to Top 3 holders

Every 5 Days Top 1 - Top 3 will get .15 BNB
We will send the proof so that you will know that I'm not blaming you all.
...
pragma solidity ^0.6.12;
    ...
    contract Catheist is Context, IERC20, Ownable {
        ...
        string private _name = 'Cat heist';
        string private _symbol = 'Catheist';
