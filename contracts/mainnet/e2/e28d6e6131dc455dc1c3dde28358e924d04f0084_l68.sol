...
/**
 https://journeys.dartmouth.edu/folklorearchive/2018/03/09/lucky-number-168-chinese/ 

 168 (pinyin: yī liù bā; Cantonese Yale: yāt luhk baat) sounds like "一路发" (pinyin: yī lù fā;
 Cantonese Yale: yāt louh faat) meaning "fortune all the way".
 
 https://t.me/onehundredsixtyeight
 tax fee 5/5 for buy back add liquidity*/
...
contract l68 is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0xDb1A0874734e0337747BAb2162f987C3639bb854;
        developmentWallet = 0x1F379df0678E6C0A6348Ea8eD7C35bEA9B5e53D7;
        ...
        _mint(owner(), 1680 * (10 ** decimals()));
        swapTokensAtAmount = totalSupply() / 1680;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 1, "SwapTokensAtAmount must be greater than 0.0001% of total supply");
