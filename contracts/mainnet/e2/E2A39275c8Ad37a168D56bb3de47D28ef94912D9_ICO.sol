...
contract ICO is Ownable{
    ...
    function updatePresaleMax(uint256 _newMaxAmount) external onlyOwner{
        presaleMaxAmount = _newMaxAmount;
    }

    function updatePublicsaleMax(uint256 _newMaxAmount) external onlyOwner{
        publicMaxAmount = _newMaxAmount;
    }
