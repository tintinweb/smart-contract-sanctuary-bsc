...
contract DunkinDonuts is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dunkin Donuts";
    ...
    uint256 private numTokensSellToAddToLiquidity = 9_000_000 * 10**9;
