...
/**
https://t.me/DogeUniversityofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5034D2194234Ad895b928dD2b7C56116124c83E4; // owner address
...
contract DogeUniversityofficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge University";
    string private _symbol = "DogeUniv";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76852f468CEFc7C223988D06e5dd8249E1De185F); // Marketing Address
    address payable public teamWalletAddress = payable(0x76852f468CEFc7C223988D06e5dd8249E1De185F); // Team Address
