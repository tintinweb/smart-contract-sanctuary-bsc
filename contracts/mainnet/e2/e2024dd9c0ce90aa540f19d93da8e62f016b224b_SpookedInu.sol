...
/* Token contract */
contract  SpookedInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xA21738EC2aE8a01Cc0881cbbC6729951e8A4e657;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 1000; // 3% 
    uint256 public _maxSellTxAmount = _totalSupply * 600 / 1000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 1000; // No max wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA21738EC2aE8a01Cc0881cbbC6729951e8A4e657;
