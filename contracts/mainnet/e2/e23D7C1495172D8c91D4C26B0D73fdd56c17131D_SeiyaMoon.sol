...
contract SeiyaMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SeiyaMoon";
    string private _symbol = "SEIMOON";
    uint8 private _decimals = 9;

    address payable public marketingAddress = payable(0x29F99B29D2291eb1C2568416B1DCE92bd4FE3522);
    address payable public devAddress = payable(0x29F99B29D2291eb1C2568416B1DCE92bd4FE3522);
