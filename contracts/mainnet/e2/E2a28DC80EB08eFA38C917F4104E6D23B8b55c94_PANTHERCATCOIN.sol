...
//ABOUT US
//CAT IS BACK TO RULE THE WORLD join the ride with PANTHER CAT COIN. Supported by big Teams and Callers, and soon bigger influencers. PANTHER CAT COIN is on the way to millions. Get your position now!
//I know many of you have missed so I'm sure you don't want to miss another chance, especially when you have the opportunity to become a whale at such a low price.
//Don't miss this Big project PANTHER CAT COIN Everyone is looking for that 1000x gem


pragma solidity ^0.8.5;
//JOIN:https://t.me/PantherCatCoinOfficial

//TWITTER:https://twitter.com/1000XPROJECTPCC/status/1550298092888805376?s=20&t=nnfsJvLfo-hyy6FprbzimQ
...
contract PANTHERCATCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "$PANTHER CAT COIN"; // 
    string private constant _symbol = "$PCATCOIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xA98E06524Fad9eF86B60c896ad77DE8fcF5ed8d1;
