 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/KingSafu
 * 
 * 
 * KingSafu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract KingSafu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KingSafu";
    string constant _symbol = "KingSafu";
