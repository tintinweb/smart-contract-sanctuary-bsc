...
|  $$$$$$ | $$  | $$| $$  | $$  | $$  | $$  | $$      | $$      | $$  | $$| $$      | $$   
 ...
 /$$  \ $$| $$/$$ $$| $$  | $$  | $$  | $$  | $$      | $$    $$| $$  | $$| $$      | $$   
|  $$$$$$/|  $$$$$$/|  $$$$$$/ /$$$$$$| $$$$$$$/      |  $$$$$$/|  $$$$$$/| $$$$$$$$| $$   
 \______/  \____ $$$ \______/ |______/|_______/        \______/  \______/ |________/|__/   
                \__/                                                                       
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
...
contract SquidCult is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Cult";
    string constant _symbol = "CULT";
    ...
    uint256 public totalFeeBuy = 8; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xf9E6c72cA9D64b9f72bE99eADE9e7D35ef43240A;
        ...
        marketingFeeReceiver = 0xd66Aa89Bb6c7EbB837e25C9B4273DB0657D810A6;
        teamFeeReceiver = 0xb46185f17b936FE7EA7E9fAC73a7747c430F4CD2;
        giveawayFeeReceiver = 0xb46185f17b936FE7EA7E9fAC73a7747c430F4CD2;
