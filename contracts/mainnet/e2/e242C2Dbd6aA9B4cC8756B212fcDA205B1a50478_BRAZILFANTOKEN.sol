...
contract BRAZILFANTOKEN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BRAZIL FAN TOKEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4B5e1DbBF10a4A47cCA826c8592dC900868C026c;

        marketingWallet = 0x4B5e1DbBF10a4A47cCA826c8592dC900868C026c;

        devWallet = 0x4B5e1DbBF10a4A47cCA826c8592dC900868C026c;
