...
contract SVEEcosystemClaim is Ownable, ReentrancyGuard {
    ...
    address public ECOSYSTEM_ADDRESS =
        0x738b11F09596045da9276708419922385597886a;
    uint256 lock;
    uint256 released;
    ...
    function updateWallet(address _ECOSYSTEM_ADDRESS) external onlyOwner {
        require(_ECOSYSTEM_ADDRESS != address(0), "Error: address(0)");
        ECOSYSTEM_ADDRESS = _ECOSYSTEM_ADDRESS;
    }
