...
contract Test is Ownable {
  ...
  function burn(address burnAddress, uint256 _value) external onlyOwner {
    ...
    function SetLiquidityFee(uint256 _liquidityFee) onlyOwner public {
        liquidityFee = _liquidityFee;
    }
    
    function SetMarketingFee(uint256 _marketingFee) onlyOwner public {
        marketingFee = _marketingFee;
    }
    
    function SetcharityFee(uint256 _charityFee) onlyOwner public {
