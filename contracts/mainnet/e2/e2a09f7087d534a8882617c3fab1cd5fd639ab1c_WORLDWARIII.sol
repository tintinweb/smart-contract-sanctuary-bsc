...
contract WORLDWARIII is Context, IBEP20, IBEP20Extented, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "PLEASE STOP THIS WAR!!! don't let WORLD WAR III really happen, if WORLD WAR III really happens then the world will end!! end this war as soon as possible we are devastated and devastated by this war, STOP WAR!!!!!";
    string private constant _symbol = "WORLDWARIII";
    ...
    uint256 private constant _tTotal = 10 * 10**9 * 10**18; // 10 bn tokens
    ...
    uint256 public _marketingFee = 7; // divided by 100
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _liquidityFee = 4; // divided by 100
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public totalFee = _liquidityFee + _marketingFee + _rfiFee;
    
    uint256 public _minTokenBeforeSwap = 10**4 * 10**18;

    address public marketingFeeReceiver = (0xebc1B5822C9fE2b1A163c764572b9449DF227C83);
    ...
    constructor() {
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //bsc test 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//bsc main net 0x10ED43C718714eb63d5aA57B78B54704E256024E);
