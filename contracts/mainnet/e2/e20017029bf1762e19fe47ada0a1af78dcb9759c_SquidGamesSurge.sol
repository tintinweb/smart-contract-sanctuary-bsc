...
/**
    ...
    It is only available to purchase using Surge through Surge Protocol at https://swap.surgeprotocol.io/
...
contract SquidGamesSurge is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Squid Game Surge";
    ...
    //Tax wallets
    address public teamWallet = 0x6484aD96A604fAccF9D79EfC66Db90E36A024dc4;
    address public treasuryWallet = 0x35AfC3249d8449FAb4E2207c2C57C53991376843;
