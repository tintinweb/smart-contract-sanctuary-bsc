...
Telegram Group: https://t.me/WhaleDetectorBot

Whale Detector Bot is a telegram bot that detects whales wallets when they buy a token and pushes a notification in a crypto telegram community! 🐋

In crypto there are whales no matter where you go, what community or token you go to they are there watching and buying. So what better way to bring hype to your community when they see whales are there and apart of the community!

The WDB will have different levels of whales starting from Dwarf whales ones to humpbacks 🐋 

$WDB taxes are low and will be 6 buy 6 sell as we believe we will not have to do much marketing as the bot being used in various communities is free marketing itself 🗣
...
/* Token contract */
contract WhaleDetectorBot is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0E8e29CF436Da532BBADe01B1Aa0ec74584Ff8BC;
    ...
    // Name and symbol
    string constant _name = "Whale Detector Bot";
    string constant _symbol = "WDB";
