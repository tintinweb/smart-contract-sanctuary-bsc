...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2B72ef9cd769866dd6d94a9cc270Fc4945c85b80; // owner address
...
contract rabbitmusket is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Musket";
    string private _symbol = "RAMUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72cbef05B956EcEbe9f2cc48Fdb4aAFB2d44D6c0); // Marketing Address
    address payable public teamWalletAddress = payable(0x2B72ef9cd769866dd6d94a9cc270Fc4945c85b80); // Team Address
