...
library Address{
  ...
  contract GreenMachine is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf905e99109B53eBB3c2d0Ed185A5314EB708445F;
    address public devwallet = 0xBB3CC8Ef1eC0E7E917e2Be58f3c2E23D3Aaf3b58;

    string private constant _name = "GreenMachine";
    ...
    Taxes public taxes = Taxes(0, 9, 2, 0);
    Taxes public sellTaxes = Taxes(0, 9, 2, 0);
