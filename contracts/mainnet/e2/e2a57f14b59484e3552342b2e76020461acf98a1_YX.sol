...
contract YX is Context, IERC20, Ownable {
    ...
    string private _name = "YX";
    string private _symbol = "YX";
    ...
    address public ownerAddres = address(0x2E788bf0eC1a59a9DeA55291991858A4660F4D41);
    ...
    uint256 private numTokensSellToAddToLiquidity = 6 * 10 **17;
    uint256 public  maxBurn = 1000 * 10 **18;
