...
Final Message of Andrew Tate
https://www.freetopg.com/
...
library Address{
 ...
 contract BringBackTopG is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 100_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 100_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 100_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xe20E77EC5ddd8d880c3829b531CeD9861565f1c9;
    address public donationWallet = 0xe20E77EC5ddd8d880c3829b531CeD9861565f1c9;

    string private constant _name = "Goodbye Tate";
    string private constant _symbol = "BYETATE";
    ...
    Taxes public taxes = Taxes(0, 5, 1, 2);
    Taxes public sellTaxes = Taxes(0, 5, 1, 2);
