...
contract BTE_SingleStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() public {
        stakedToken = IBEP20(0x7faAf8d4C411218415d9d3f82D56214658349dbb);
        rewardPerBlock = 10**18; // 1 token per block
