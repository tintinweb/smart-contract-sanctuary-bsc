...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCF12A204Fc21FD69ee711cC9edbbFD2b5DfD5C33; //
...
contract CEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ceo Inu"; // 
    string private constant _symbol = "CEO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xCF12A204Fc21FD69ee711cC9edbbFD2b5DfD5C33); //
