...
*SPDX-License-Identifier: MIT
     fat pepe 新元即將大肆宣傳！我們能夠讓這個構建堅實的社區和簡單的 moonshotx1000
            low tax 低稅 5/5
*/
...
contract FATPEPE   is Context, IERC20, Ownable {
    ...
    string private _name = " FAT PEPE ";
    string private _symbol = " FPEPE "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x349737B753847C3556A398295634b3Cd66b1A224); 
    address payable public teamWalletAddress = payable(0x349737B753847C3556A398295634b3Cd66b1A224); 
