...
DESKRIPTION: Think about it everyone, 
how many times a day do you spend money on fast food 
or something like that and never ever have a chance at 
getting that money back, but with DuckBanana, you’re spending 
money with way more confidence of getting a huge ROI

TG: https://t.me/duckbananabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdA33C3b8FCE1A1d502786Da85d3888594EE384d4;
...
contract DUCKBANANA is Context, IERC20, Ownable { 
    ...
    string private _name = "Duck Banana"; 
    string private _symbol = "DBanana";  
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0xd9978dcE6889298119D8552c854BA4FE11340570);
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/30000;
    }
