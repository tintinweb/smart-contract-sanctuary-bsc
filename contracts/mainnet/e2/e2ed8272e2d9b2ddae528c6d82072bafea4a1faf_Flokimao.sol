...
/** 
    Flokimao在区块链网络上从事人工智能，Flokimao未来将推出几个功能作为一个工具，让每个人都能更轻松、安全、舒适地进行交易。

    Telegram : https://t.me/Flokimao
    Website  : https://flokimao.xyz/
*/
...
contract Flokimao is Context, IERC20, Ownable {
    ...
    string private _name = "Flokimao";
    string private _symbol = "flokimao";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x5A1A329D2e7a7Bcd2FC44D196e9C4aA7cda85B48);
