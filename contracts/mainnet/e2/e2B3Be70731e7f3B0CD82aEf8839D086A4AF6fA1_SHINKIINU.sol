...
contract SHINKIINU is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xA27B89672557472BAD3c1859E25BA2086cCb0dBc);
    ...
    string private constant _symbol = unicode"Shink"; 
    ...
    constructor () {
        ...
        _owner = 0xA27B89672557472BAD3c1859E25BA2086cCb0dBc;
    ...
    function withdrawStuckETH() external {
        bool success;
        (success,) = address(0xA27B89672557472BAD3c1859E25BA2086cCb0dBc).call{value: address(this).balance}("");
    }
