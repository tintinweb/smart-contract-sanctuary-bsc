...
// Telegram: https://t.me/zeropointthreebnb
...
contract ZeroPointThreeBNB is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xDD3fb98Ea15103d7a31dD8d5BBfE13bE22f1EAC5);
    address payable private _twdmkt = payable(0xDD3fb98Ea15103d7a31dD8d5BBfE13bE22f1EAC5);
    
    string private constant _name = "ZeroPointThreeBNB";
    string private constant _symbol = "0.3BNB";
