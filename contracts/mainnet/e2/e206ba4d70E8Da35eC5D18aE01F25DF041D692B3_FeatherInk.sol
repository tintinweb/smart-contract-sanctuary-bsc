...
// Fixed Safemath, ReentrancyGuard addon
...
contract FeatherInk is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Ink Finance";
    string private _symbol = "INK";
    uint8 private _decimals = 18;
    uint256 public _bReward = 0; 
    uint256 public _bDevfee = 20; 
    uint256 public _bRfuel = 20;
    uint256 public _sReward = 0; 
    uint256 public _sDevfee = 40; 
    uint256 public _sRfuel = 40; 
    ...
    address public devWallet = payable(0x66618d2C6a182Fa8018Da5ad49801012fF887668);
    ...
    function setBuyFeePercent(uint256 reflect, uint256 dev, uint256 liquid) public onlyOwner {
        require(reflect.add(dev).add(liquid) <= 10, "Fee limitation is 10% anti rugged, you're in good hand");
        _bReward = reflect;
        _bDevfee = dev;
        _bRfuel = liquid;
    }
    ...
    function setSellFeePercent(uint256 reflect, uint256 dev, uint256 liquid) public onlyOwner {
        require(reflect.add(dev).add(liquid) <= 12, "Fee limitation is 12% anti rugged, you're in good hand");
        _sReward = reflect;
        _sDevfee = dev;
        _sRfuel = liquid;
    }
    ...
    function _takeLiquidNDevFee(uint256 tLiquidNDevFee,address sender) private {
        ...
        _sendFee(sender, address(this), tDev);
...
uint256 contractTokenBalance = balanceOf(address(this));
        ...
        contractTokenBalance = numTokensSellToAddToLiquidity;
            uint256 toDev = contractTokenBalance
                .mul(_bDevfee + _sDevfee)
                .div(
                        _bRfuel +
                        _sRfuel
                );
            ...
            swapAndLiquify(contractTokenBalance - toDev);
        }
    ...
    function swapFee(uint256 amount) private lockTheSwap {
        uint256 initialBalance = address(this).balance;
    ...
    function stuckTokens(address _token) nonReentrant external onlyOwner {
