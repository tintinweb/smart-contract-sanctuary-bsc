...
contract JBD is IERC20, Ownable {
    ...
    address private projectAddress = 0xb34386075FCDB67Bb892B61520A0b7E69DAFfFfc;
   

    uint256 private _tFeeTotal;

    string private _name = "JBD";
    string private _symbol = "JBD";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 3000;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takesatFee (
        ...
        // uint256 newBalance_eth = address(this).balance.sub(initialBalance_eth);

        // swapEthForToken(newBalance_eth,getsat); 
    ...
    function swapEthForToken(uint256 ethAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 TestE = IERC20(0x641EC142E67ab213539815f67e4276975c2f8D50);
    ...
    function swapThisTokenForToken(uint256 thisTokenAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 DK1 = IERC20(0x641EC142E67ab213539815f67e4276975c2f8D50);
        path[0] = address(this);
        path[1] = address(DK1);
