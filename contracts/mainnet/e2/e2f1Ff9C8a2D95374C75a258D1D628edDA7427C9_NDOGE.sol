...
contract NDOGE is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 10000000 * 10**3 * 10**18;
    uint256 public swapTokensAtAmount = 30 * 10**3 * 10**18;
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0xdFF1475313027C2051faBaF8567365C41cDAB7e2;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Native Doge";
