...
/// @title This contract locks uniswap v2 liquidity tokens
/// @notice Used to give investors peace of mind a token team has locked liquidity
...
contract UniswapV2Locker is Ownable, ReentrancyGuard {
  ...
  function lockLiquidity (
    ...
    lockLPToken(pair, totalLPTokensMinted, unlock_date, _withdrawer);
  }
