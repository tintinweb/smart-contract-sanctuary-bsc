...
Pure Degen Play
1 mill total supply
9% buy and 9% sell tax (6% marketing, 2% LP, 1% dev)
no rewards, no reflections, Old school BSC HYPE
...
contract McSaudi is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() BEP20("McSaudi", "MCS") {
        marketingWallet = payable(0x854C208a934bae8a2a6db6caC35235c82EffC1fA);
        devWallet = payable(0xDF8A948eFf76bc7783fAd4F7262784cfDeBfc4f2);
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 liquidityBuy,
        ...
        require(liquidityBuy <= 6 && liquiditySell <= 6, "Liquidity fees can't exceed 6%");
