...
contract TheWeekndInu  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "The Weeknd Inu";
    string constant _symbol = "Weeknd";
