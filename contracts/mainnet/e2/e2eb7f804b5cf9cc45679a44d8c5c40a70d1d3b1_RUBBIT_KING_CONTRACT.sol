...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1b77290d85d1A47841409c236D30441095B87fFb; 
...
contract RUBBIT_KING_CONTRACT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RUBBIT KING";
    string private _symbol = "RUBKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1b77290d85d1A47841409c236D30441095B87fFb); 
    address payable public teamWalletAddress = payable(0x409B291ca9C7f6F09167A93c8091Af36bC87c3A9); 
