...
What is Doordash Token? 
Doordash token will serve as a crypto intermediary between the web 2 application of the famed food delivery service and our DAPP that leverages the anonymity of cryptocurrency.

什么是 Doordash 令牌？
Doordash 代币将作为著名食品配送服务的 Web 2 应用程序与我们利用加密货币匿名性的 DAPP 之间的加密中介。

Telegram: https://t.me/DoordashToken
Twitter: https://twitter.com/doordashtoken?s=21&t=C_V6Mj7ka8O0hFRZM6p6Og
Website: https://dashcrypto.app/
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
contract DASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doordash";
