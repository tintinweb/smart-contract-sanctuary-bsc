...
contract ETHBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHBOY";
    string private _symbol = "ETHBOY";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xe5118C85982D5a517a371774Acef4181E2B15815); 
