...
/**
Welcome to the Rabbit Hole Club !

TOKENOMICS:
Supply: 1,000,000 tokens

Buy Tax 10% / Sell Taxes will be 15% at launch, and reduce to 10% after two hours
5 / 8 % marketing
3 / 5 % Rabbit Hole Prize
2 / 2 % LP

2% max TRX, 2% max wallet

TG: https://t.me/RabbitHoleClub
Happy digging!
*/
...
contract AreYouReady is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rabbit Hole Club";
    string private constant _symbol = "RAHC";
