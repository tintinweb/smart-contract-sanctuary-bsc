...
contract jiaoinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " jiao inu ";
    string private _symbol = " JION "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x604ED244702f2624352D930dc3f5d4DE20Cdf064); 
    address payable public teamWalletAddress = payable(0x604ED244702f2624352D930dc3f5d4DE20Cdf064); 
