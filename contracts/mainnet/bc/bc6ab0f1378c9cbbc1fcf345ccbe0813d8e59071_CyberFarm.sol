...
contract CyberFarm is Ownable {
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0x2033eA377c29921bF7058B68f13A63ECE285d33D);

    
    address payable constant public MARKETING_ADDRESS = payable(0xEfE3eBC847d8B8b9eB6eCeb44fFcC439D46F077b);
    uint256 constant public MARKETING_FEE = 500;
    address payable constant public PROMOTION_ADDRESS = payable(0x7D46161e074d28D43C2247A35BF9AF752EEdE77D);
