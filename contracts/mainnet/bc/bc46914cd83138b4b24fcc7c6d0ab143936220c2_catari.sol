...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x69306623ce4B65eF2f2106ef85E8691Ee1840369;
...
contract catari is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Wallet_Dev = payable(0x69306623ce4B65eF2f2106ef85E8691Ee1840369);
    ...
    string private constant _name = unicode"(=^◡^=)Catari(=^◡^=)"; 
    string private constant _symbol = unicode"CATARI"; 

    uint256 public P_DevReward = 90;
    uint256 public Part_AutoLiquidity = 10; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 64; 

    uint256 public _BuyFee = 1;
    uint256 public _SellFee = 1;
    uint256 public _moonbag_percentage=1;

    uint256 public _maxWalletToken = _tTotal.div(30);
