...
contract BabyGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Grow";
    string private _symbol = "BBW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x241f1225b2185C87300F6D23A635dD5443f85E6f);
    address payable public BuyBackWalletAddress = payable(0x241f1225b2185C87300F6D23A635dD5443f85E6f);
