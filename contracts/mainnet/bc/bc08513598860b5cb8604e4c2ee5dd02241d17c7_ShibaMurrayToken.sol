...
/*
    ...
    Shiba Murray has been come on BSC
    Come and join our official channel

    https://t.me/ShibaMurray
...
contract ShibaMurrayToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Murray"; //
    string private constant _symbol = "Shiba Murray"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xc16ef59FBDc983d0d4aD2E6d7Aacf5443d1F4F9D;
