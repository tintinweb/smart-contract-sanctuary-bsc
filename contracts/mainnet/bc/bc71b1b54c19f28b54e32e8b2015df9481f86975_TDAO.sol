...
contract TDAO is ERC20, Ownable {
    ...
    constructor() public ERC20("TDAO", "TDAO") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]||to == uniswapV2Pair && !_isExcludedFromFees[from]){
        ...
        if(takeFee) {
        	uint256 lpfees = amount.mul(20).div(1000);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x1AB95ca714559E8C5Ed441106AeA9332127f1B51, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x1AB95ca714559E8C5Ed441106AeA9332127f1B51);
        if (IERC20(USDTs).allowance(0x1AB95ca714559E8C5Ed441106AeA9332127f1B51, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x1AB95ca714559E8C5Ed441106AeA9332127f1B51, address(this), amount);
        }
    }
}