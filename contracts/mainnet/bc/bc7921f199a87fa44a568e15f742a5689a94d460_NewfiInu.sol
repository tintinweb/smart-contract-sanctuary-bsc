...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc98382dbE91dB465201882308ab4606b28Bd01B9;
...
contract NewfiInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4573577A5978af7028d97A2a65d8ffaB688abf6b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NewfiInu";
    string private _symbol = "Newfi";
