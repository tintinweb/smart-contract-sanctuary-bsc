...
Lucky Floki 2.0 ($LUKI2) is a meme token that guarantees every element of being able to go to the moon. 
The project is safe when it comes to renouncing owner, locking in liquidity, has a long-term marketing plan, and specifically kills snipers.

Our official links:

Website: https://luckyfloki2.space/
Telegram: https://t.me/LuckyFloki2Portal
Twitter: https://twitter.com/LuckyFloki_2
...
contract LuckyFlokiTwo is IERC20, Ownable {
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 3000000000000 * 10**_decimals;
