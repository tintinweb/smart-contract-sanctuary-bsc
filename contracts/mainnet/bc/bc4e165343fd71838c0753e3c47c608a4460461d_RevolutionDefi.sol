...
contract RevolutionDefi is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    RevolutionDefiDividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0xAfaaDD4dE290B187bA067b76CF4E1c5AD0e7F543);
    address payable public _buybackWalletAddress = payable(0xBAD0A21Ca69BDa7EBaB5c549aecdd5B568e89792);
    ...
    constructor() BEP20("Revolution Defi", "Revolt") 
    {
        dividendTracker = new RevolutionDefiDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "RevolutionDefi: The dividend tracker already has that address");
        RevolutionDefiDividendTracker newDividendTracker = RevolutionDefiDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "RevolutionDefi: The new dividend tracker must be owned by the RevolutionDefi token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "RevolutionDefi: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "RevolutionDefi: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "RevolutionDefi: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "RevolutionDefi: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "RevolutionDefi: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "RevolutionDefi: Cannot update gasForProcessing to same value");
...
contract RevolutionDefiDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("RevolutionDefi_Dividend_Tracker", "RevolutionDefi_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "RevolutionDefi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "RevolutionDefi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RevolutionDefi contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "RevolutionDefi_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "RevolutionDefi_Dividend_Tracker: Cannot update claimWait to same value");
