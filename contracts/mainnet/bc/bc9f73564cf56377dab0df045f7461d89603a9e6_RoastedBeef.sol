...
contract RoastedBeef is Ownable{
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=129600;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function hatchEggs(address ref) public{
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]]=SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(SafeMath.mul(eggsUsed,25),100));
