...
contract DiamondHoldKiller is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DiamondHoldKiller";
    string private _symbol = "DiamondHoldKiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb319Cb5aCfD1ebfDaF3DB9C08f5CF1e837Bb425F);
    address public immutable deadAddress = 0xb319Cb5aCfD1ebfDaF3DB9C08f5CF1e837Bb425F;
