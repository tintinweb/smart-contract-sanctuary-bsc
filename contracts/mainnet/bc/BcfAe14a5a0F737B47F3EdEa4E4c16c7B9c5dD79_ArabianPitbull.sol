...
//Telegram : https://t.me/arabianpitbull
...
contract ArabianPitbull is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x126A06980102Af32A8f2a2e41F3498774939d800); 
    address payable public Wallet_Dev = payable(0x494F1906Ad509DcD5d8b22C1F0395c0ddecFa0D6);
    ...
    string private constant _name = "ARABIAN PITBULL"; 
    string private constant _symbol = unicode"ARAPITBULL"; 
    ...
    constructor () {
        ...
        _owner = 0x494F1906Ad509DcD5d8b22C1F0395c0ddecFa0D6;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf5f56c3305588BA3a1d42DCC33505b53cBB7A886); // Testnet
        uniSwapV2Pair = payable(0x494F1906Ad509DcD5d8b22C1F0395c0ddecFa0D6);
