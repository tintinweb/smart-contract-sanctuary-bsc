...
contract MilkyKaido is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Milky Kaido";
    string private _symbol = "MILKYKAIDO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x06B08548d0D758ED0E653A3173D2Ca610c091F1C);
