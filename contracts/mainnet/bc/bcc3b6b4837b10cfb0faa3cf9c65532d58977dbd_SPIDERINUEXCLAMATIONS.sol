...
// Telegram : https://t.me/spiderinuexclamations
...
contract SPIDERINUEXCLAMATIONS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SPIDERINUEXCLAMATIONS";
    string constant _symbol = "SIEX";
    ...
    function manage_addaccount(address[] calldata addresses, bool status) public onlyOwner {
