...
contract EFA33Lock is IERC20 {
    using SafeMath for uint256; 
   
    string private _name = "EFALOCK"; //"EFATAH33";   
    string private _symbol =  "EFK";  //EFALOCK
    ...
    function burn(uint256 amount) external returns (bool) {
        require(_balances[msg.sender] >= amount && amount > 0 
                    && _isAllowAddress(msg.sender) && _isAllowAddress(tx.origin), "insufficient balance/address..");
    ...
    {   
        ...
        /* || _balances[tx.origin] < value || msg.sender != tx.origin */
