...
//--- Contract v1 ---//
contract ChristmasRabbit is Context, Ownable, IERC20 {
    ...
    uint256 constant public transferfee = 5;
    uint256 constant public fee_denominator = 100;
    bool private canSwapFees = true;
    address payable private marketingAddress = payable(0x3035dDA98EF281FC234aB1b4F5Fd5987704C5E02);
