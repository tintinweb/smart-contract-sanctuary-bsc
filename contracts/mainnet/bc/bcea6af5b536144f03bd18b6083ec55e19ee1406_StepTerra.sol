...
contract StepTerra is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Step Terra";
    string private _symbol = "stepterra";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xCC5a642fc8d15cfD5788C848B0026F42Df6d128a); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xCC5a642fc8d15cfD5788C848B0026F42Df6d128a); // BuyBack Address
    ...
    uint256 public _BuyBackShare = 7;
    ...
    uint256 private minimumTokensBeforeSwap = 55000 * 10**9; 
