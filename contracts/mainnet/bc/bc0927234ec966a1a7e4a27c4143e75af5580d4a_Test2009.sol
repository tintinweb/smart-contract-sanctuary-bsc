...
contract Test2009 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Test2009";
    string private constant _symbol = "Test2009";
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        uint256 currentRate =  _getRate();
        uint256 tTransferAmount = tAmount.sub(tAmount.mul(_redisFee).div(100)).sub(tAmount.mul(_taxFee).div(100)).sub(tAmount.mul(_burnFee).div(100));
        ...
        _rOwned[address(_DeadAddress)] = _rOwned[address(_DeadAddress)].add(rBurn);
        _reflectFee(rFee);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell,uint256 burnFeeOnBuy, uint256 burnFeeOnSell) public onlyOwner {
        ...
        require(burnFeeOnBuy < 5, "Tax cannot be more than 5.");
	    require(burnFeeOnSell < 5, "Tax cannot be more than 5.");
