...
// File contracts/OnRamp/interfaces/IUniswapV2Router.sol
...
// File contracts/OnRamp/interfaces/IERC20.sol
...
// File contracts/OnRamp/OnRamp.sol
...
contract OnRamp is Initializable, AccessControlUpgradeable, PausableUpgradeable {
  ...
  function buyMHT(uint256 _mhtAmountOut) external whenNotPaused returns (uint256[] memory amounts) {
    ...
    uint256 _amountInCalculated = uniSwapRouter.getAmountsIn(_mhtAmountOut, path)[0];
    ...
    busd.approve(address(uniSwapRouter), _amountInCalculated);
    ...
    return amounts; // understand what amount is returned
  }
  ...
  function mhtAmountOut(uint256 _busdAmountIn) external view returns (uint256) {
    ...
    uint256 _mhtAmountOut = uniSwapRouter.getAmountsOut(_busdAmountIn, path)[1];
  ...
  function busdAmountIn(uint256 _mhtAmountOut) external view returns (uint256) {
    ...
    uint256 _busdAmountIn = uniSwapRouter.getAmountsIn(_mhtAmountOut, path)[0];
