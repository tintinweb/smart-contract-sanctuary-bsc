...
contract MetaApeClubInu is IBEP20, Auth {
    ...
    string constant _name = "Meta ApeClub Inu";
    string constant _symbol = "Meta ApeClub Inu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; //20% max tnx
