...
contract Ceocat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ceo Cat";
    string private _symbol = "CEOCAT";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xfF2384292217f2E47f1AD04bBf601fF68cd04781);
    address payable public teamWalletAddress = payable(0x619C30e2FDd14A6B547F9c34e61ba25d4fb3B671);
