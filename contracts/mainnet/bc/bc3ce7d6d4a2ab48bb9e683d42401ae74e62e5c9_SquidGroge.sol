...
contract SquidGroge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGroge";
    string private _symbol = "$SG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d684292d3D7D8018E9De546BD84E6155AE96df0); // Marketing Address
    address payable public devWalletAddress = payable(0x0d684292d3D7D8018E9De546BD84E6155AE96df0); // Dev Address
    ...
    uint256 private _maxSellTxAmount = 100 * 10**6 * 10**9;
