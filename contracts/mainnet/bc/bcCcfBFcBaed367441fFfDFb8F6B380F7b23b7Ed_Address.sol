...
contract FPC is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x9BF52B4E0d50E5C7c2653C3df839c010e60E5D5e);

    uint256 public _charityFee = 6;
    uint256 private _previousCharityFee = _charityFee;
    address payable public charityWallet = payable(0xb1951332de0616AeCcB2e85EE70F9DC40756a67C);
