...
contract Whitelist is Ownable {
 ...
 function approve() external {
   require(!isWhitelisted[msg.sender], "Whitelist: already approved");
   isWhitelisted[msg.sender] = true;
   emit AddWhitelist(msg.sender);
 }

 function approveByAdmin(address addr) external onlyOwner {
   require(!isWhitelisted[addr], "Whitelist: already approved");
 ...
 function isStatus() external view  returns(bool){
   return isEnabled;
 }
}
