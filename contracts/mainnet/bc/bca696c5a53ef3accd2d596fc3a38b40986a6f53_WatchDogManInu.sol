...
contract WatchDogManInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WatchDogMan Inu", "WDMI") {
        marketingWallet = payable(0x99223194AcC50457dEa5B0Fd713551854e628EC7);
        devWallet = payable(0x99223194AcC50457dEa5B0Fd713551854e628EC7);
...
contract BusdDividendTracker is DividendPayingToken, Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;
     ...
     WatchDogManInu public BusdContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BusdContract = WatchDogManInu(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Busd contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            uint256 prevBalance = BusdContract.balanceOf(address(this));
            ...
            {
                uint256 received = BusdContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BusdContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
