...
/*
MeMe Network (MNET)
Supply: 1.000.000 MNET

Telegram: https://t.me/MemeNetwork_Bsc
*/
...
contract MeMeNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MeMe Network";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "MNET";
...
uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // will start swapping once 0.01% of supply is in the swap wallet
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3D05883766594202958C4EA0DBEEbe53D88f67aC;
        marketingFeeReceiver = 0x3D05883766594202958C4EA0DBEEbe53D88f67aC;
