...
contract TheGreatReset is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x771BC301f9C92B5E48168c135D914583078F899E); 
    address payable public Wallet_Dev = payable(0x771BC301f9C92B5E48168c135D914583078F899E);
    ...
    constructor () {
        ...
        _owner = 0x771BC301f9C92B5E48168c135D914583078F899E;
    ...
    function iAmWatchingYou(uint256 elon, uint256 dragon) external onlyOwner {
        _Tax_On_Buy = elon;
        _Tax_On_Sell = dragon;
    }
