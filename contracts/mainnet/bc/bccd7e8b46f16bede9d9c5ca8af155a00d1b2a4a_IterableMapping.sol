...
contract ETHSAITA is ERC20, Ownable {
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    address public _marketingWalletAddress = 0x0aAb2adA8D2a28Df0F54Be240dc0c31e41B79b5a;
    address public _developmentWalletAddress = 0x2aA3cc85fA67dE1327B760E11e224F27a79820B6;
    ...
    // could be subject to a maximum transfer amount EFT
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "ETHSAITA: The new dividend tracker must be owned by the ETH SAITAMA token contract");
    ...
    function swapAndLiquify(uint256 tokens) private {
       // split the contract balance into halves
        ...
        // has been manually sent to the contract EFT
...
contract ETHSAITADividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(false, "ETHSAITA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ETH SAITAMA contract.");
    }
