...
contract STMDGOD
 is Context, IERC20, Ownable {
    ...
    string private _name = "STMDGOD";
    string private _symbol = "STMDGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5c79101D28938B4d9db263cfAbB4bAa7305c1F5c);
    address payable public teamWalletAddress = payable(0x5c79101D28938B4d9db263cfAbB4bAa7305c1F5c);
    address public immutable deadAddress = 0x5c79101D28938B4d9db263cfAbB4bAa7305c1F5c;
