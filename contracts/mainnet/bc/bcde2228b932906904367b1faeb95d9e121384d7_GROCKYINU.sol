...
/**
    Welcome to Groky the next token that’s aim to create a fully sustainable ecosystem wich benefit their holders receiving BUSD directly on their wallets just by holding!
    We are community driven - the biggest utility meme on Binance smart chain. Dapp/nft/swap will be delivered.
    Tax: 8/8
    🌎Global: https://t.me/GrokyInu
    🇨🇳CHINESE: https://t.me/GrokyInuCN
...
contract GROCKYINU is IBEP20, Auth {
    ...
    string constant _name = "Groky Inu";
    string constant _symbol = "$GROKY";
    ...
    address private marketingFeeReceiver = 0x569a78AFCfB08e51cdA14e1438447aA010F5A04E;
    address private teamFeeReceiver = 0x569a78AFCfB08e51cdA14e1438447aA010F5A04E;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function blacklistMultiple(address[] memory users, bool value) public {
        for (uint256 index = 0; index < users.length; index++) {
            _isBlacklisted[users[index]] = value;
        }
    }
