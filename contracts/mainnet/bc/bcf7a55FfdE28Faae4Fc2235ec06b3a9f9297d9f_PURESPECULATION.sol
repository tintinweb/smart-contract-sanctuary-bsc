...
/**
PPPPP              SSSS    PPPPP    EEEE      CCC
P        P            S       S   P         P  E            C      C
P        P             S           P         P  E           C     
PPPPP    ------     SS      PPPPP    EEE      C
P                              S    P              E           C     
P                      S       S   P             E             C      C
P                       SSSS    P             EEEEE     CCC
*/
...
contract PURESPECULATION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pure Speculation"; // 
    string private constant _symbol = "P-SPEC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x0C5b3FF38Ee2B1D03384252e297a810b498F88c5;
