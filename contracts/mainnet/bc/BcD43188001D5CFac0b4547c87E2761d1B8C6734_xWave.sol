...
contract xWave is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "xWave"; // 
    string constant _symbol = "XWV"; // 
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (10); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (10); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0xC46D7240d4045f337620221e0B01d909E4f92352; //LP receiver
    address private marketingFeeReceiver = 0xC46D7240d4045f337620221e0B01d909E4f92352; //mkt
    address private devFeeReceiver = 0xC46D7240d4045f337620221e0B01d909E4f92352; //31 BuyBack
    address private teamFeeReceiver = 0xC46D7240d4045f337620221e0B01d909E4f92352; //32 
    ...
    uint256 public maxSwapSize = _totalSupply / 250 * 1; //1%
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x688bBAB3cfd1F55AB031252A95e1a85fc021da2A;
