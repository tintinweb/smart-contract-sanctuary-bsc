...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x266cfD76505075e11E3244a97b4C45886b0332A0; // owner address
...
contract EtherBONK is Context, IERC20, Ownable {
    ...
    string private _name = "EtherBONK";
    string private _symbol = "ETHBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x266cfD76505075e11E3244a97b4C45886b0332A0); // Marketing Address
    address payable public teamWalletAddress = payable(0x266cfD76505075e11E3244a97b4C45886b0332A0); // Team Address
