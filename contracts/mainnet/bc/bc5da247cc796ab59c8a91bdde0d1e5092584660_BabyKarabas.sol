...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB75c3C0d08b95Ef94753BA85ce3b0092CC4B2B17; // owner address
...
contract BabyKarabas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Karabas";
    string private _symbol = "BK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB75c3C0d08b95Ef94753BA85ce3b0092CC4B2B17); // Marketing Address
    address payable public teamWalletAddress = payable(0xB75c3C0d08b95Ef94753BA85ce3b0092CC4B2B17); // Team Address
