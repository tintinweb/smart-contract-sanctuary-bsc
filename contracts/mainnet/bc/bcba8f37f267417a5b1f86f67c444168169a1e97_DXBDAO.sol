...
📱Telegram group: https://t.me/DXBDAO
 
🌟 CA .  0xbCBa8f37F267417A5B1f86f67c444168169A1e97
📊Tokenomics :
🟡Burn 0%
🟡Tax 2% Taxless
🟡Friendly Whales
...
abstract contract ContextBEP20DXBDAO {
...
contract OwnableBEP20DXBDAO is ContextBEP20DXBDAO {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20DXBDAO: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20DXBDAO: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DXBDAO is ContextBEP20DXBDAO, BEP20DXBDAO, OwnableBEP20DXBDAO {
    ...
    string private _name = 'DXB DAO';
    string private _symbol = 'DXB DAO';
