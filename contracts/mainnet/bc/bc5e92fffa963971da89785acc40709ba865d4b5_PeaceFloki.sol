...
🟢With all the rumors of wars happening in the world, let's join together and unite with peace by supporting this project. SAFU DEV and has connections with many influencers!

🎁50% of the marketing wallet will be donated and pictures will be posted on the TG. Sharing is caring in difficult times.

Fair Launch - 02/24/2022 3PM UTC 

BUY&SELL TAX 13%

✅2% BUSD Reflection 
✅3% Liquidity 
✅8% Marketing and Donation wallet 

💠No Dev and Team wallet! 

📲TG: https://t.me/PeaceFloki
🌐Website: TBA
...
contract PeaceFloki is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //Input the token address of whatever your reward is 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = (msg.sender);

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "PeaceFloki";
    string constant _symbol = "$PF";
