...
contract circlerain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "circlerain";
    ...
    function changeholder(address holder, bool exempt)
        external
        onlyOwner
    {
