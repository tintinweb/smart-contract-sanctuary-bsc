...
contract ShogatsuTyrant is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "Shogatsu Tyrant";
        _symbol = "SHORANT";
        _decimals = 9;

        marketWallet = payable(0xdf35C6754C73A522A3a3FBE0796E3b2010b1875F);
        teamWallet= payable(0x53672cFEC6F6dAF75D6B883253c515cf68345efE);
        ...
        _maxWalletSize = 1000000 * 10**_decimals;
