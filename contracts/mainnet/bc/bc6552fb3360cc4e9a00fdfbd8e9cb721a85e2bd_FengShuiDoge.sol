...
contract FengShuiDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88_888_888 * 10**9;
    uint256 public _maxTxAmount = 1_777_777 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Feng Shui Doge"; // 
    string private constant _symbol = "FSDoge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x02E4AcBEEB28D26022a0754963AB6046A16f7D7F;
