...
contract WarCatInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xd357a92B07Dd41cc265E25274a3c2812D29e2b94);
    address payable private _marketingAddress = payable(0xd357a92B07Dd41cc265E25274a3c2812D29e2b94);
    
    string private constant _name = "WarCat Inu";
    string private constant _symbol = "WARCAT";
    ...
    uint256 public _maxTxAmount = _tTotal; //0.6%
    uint256 public _maxWalletSize = _tTotal; //0.1%
