...
IMAGINE PINNOCHIO AND DOGE HAD A BABY IT WOULD BE A PINOGE!
WOODEN DOG OR DOGBOY GOOD QUESTIONS WE NEED ANSWERED ASAP!
*/
...
contract PINOGEINU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'PINOGE INU';
