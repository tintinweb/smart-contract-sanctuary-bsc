...
// Telegram : https://t.me/AIFLOKIbsc
...
contract AIFloki is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "A.I Floki";
    string private constant _symbol = unicode"AIFI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xd9255641df0df2Cdd6cf6b0c2ccCfbB8F14ed26d);
    address payable public MarketingWallet = payable(0x55d6eFa33329026AD574d0247EAF60E6C195cD8a);
