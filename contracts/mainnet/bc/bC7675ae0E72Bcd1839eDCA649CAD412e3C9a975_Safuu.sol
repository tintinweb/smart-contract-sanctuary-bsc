...
contract Safuu is ERC20Detailed, Ownable {
    ...
    string public _name = "TESTSF";
    string public _symbol = "TESTSF";
    ...
    constructor() ERC20Detailed("TESTSF", "TESTSF", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x1aD8005a756d4BE4D380A466a8e1E674d0e9744a; 
        safuuInsuranceFundReceiver = 0x80FE9ee7f713964F9dDF5B4004528c83f26AD0C2;
        firePit = address(0xdead);
