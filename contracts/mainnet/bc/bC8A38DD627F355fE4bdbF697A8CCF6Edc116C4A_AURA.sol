...
contract AURA is ERC1155Supply, Ownable  {
    ...
    uint private PriceWL = 0.25 ether; //BNB
    ...
    address public w1 = 0xcF7A0055f13fE11E15c9e820913274872D9ef9c5;
    address public w2 = 0xb3a3610832Ecf7dEf03b1C388838DC066789259C;
    address wDev;
    address public wStat = 0x522708719570420385B20e17ABdA57D127dAe615;
...
//Auto 
function autoR (uint _num, bool select) external payable { 
    require(msg.sender != wStat, "Error! The address is intended for collecting statistics!");
...
//withdraw BNB for owner
   function withdrawAll() public payable onlyOwner {
    ...
    user._dynrew.push(user.balance);
    user._type.push(86);
    require(payable(w1).send(_part1)); //65%
    require(payable(w2).send(_part2)); //35%
  }
