...
/**
        Cheemina Inu (CHEEMINA)
        Telegram: https://t.me/Cheemina
...
contract CheeminaInu is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Cheemina Inu";
    string constant _symbol = "CHEEMINA";
    ...
    address public marketingFeeReceiver = 0xE2515AEaAAC1c20e169670bFBCF659886bc1A5b1;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xE2515AEaAAC1c20e169670bFBCF659886bc1A5b1] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xE2515AEaAAC1c20e169670bFBCF659886bc1A5b1] = true;
