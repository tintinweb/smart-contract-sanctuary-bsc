...
contract EDGEGPT is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'EDGEGPT: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'EDGEGPT: incorrect fee percent');
        require(owner != address(0), 'EDGEGPT: incorrect owner address');
        require(mintToAddr != address(0), 'EDGEGPT: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'EDGEGPT: transfer from the zero address');
        require(recipient != address(0), 'EDGEGPT: transfer to the zero address');
