...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9460D2314c9eb5817A4Edaf390bc59a8116A0B0F;
...
contract MANT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8be4C2373d5B18752756c5a7585e0eD80b2090f0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mannee Token";
    string private _symbol = "MANT";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 940;
