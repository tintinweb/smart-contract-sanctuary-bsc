...
// MetaRace P2E VirtualGame
// Building a new space for virtual competitions in Metaverse.
...
contract MetaRace is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaRace";
    string private _symbol = "MRACE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xcCfAf20Fbb3A4ba122eb0E0a539f3FE17C18880d);
