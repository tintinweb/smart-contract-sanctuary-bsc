...
/* Token contract */
contract TheGivenToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xeD7f6cAee2b02D9B4a5467996858040De198e27E;
    ...
    // Name and symbol
    string constant _name = "The Given Token";
    string constant _symbol = "TGT";
    ...
    uint256 public charityFeeBuy = 2;
    ...
    uint256 public charityFeeSell = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0830C792569f586b9EC58Aa6b6ef0e60bBdeB627;  
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(charityFee).div(totalBNBFee);
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _charityFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        charityFeeBuy = _charityFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        devFeeBuy = _devFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_charityFeeBuy).add(_marketingFeeBuy).add(_devFeeBuy);
