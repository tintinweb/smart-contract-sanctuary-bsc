...
contract ChechenInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chechen Inu"; // TODO change
    string private _symbol = "CHECHEN INU"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b0feD694DFBD665A2529ae819ed03159790c5aE); // Marketing Address
    address payable public buybackWalletAddress = payable(0x2b0feD694DFBD665A2529ae819ed03159790c5aE); // Buyback Address
