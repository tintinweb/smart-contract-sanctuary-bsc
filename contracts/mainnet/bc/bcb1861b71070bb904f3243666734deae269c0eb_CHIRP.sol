...
/**
  ...
  CHIRP $CHIRP
  Tax: 2% LP  10% Marketing
  Telegram: https://t.me/CHIRPTokenPortal
  Twitter: https://twitter.com/CHIRPToken
...
contract CHIRP is IBEP20, Auth {
    ...
    string constant _name = "CHIRP";
    string constant _symbol = "$CHIRP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 50;     //8%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 25;   //16%
    ...
    address private marketingFeeReceiver = 0x6C2484461dAA18d206A11826296Ff4cE179ae477;
    address private teamFeeReceiver = 0x726e692E21F7B929527193B357B1d15FacAD65AD;
