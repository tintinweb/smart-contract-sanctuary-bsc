...
contract Bep20BurnedContract is IERC20, Ownable
{
    ...
    mapping (address => bool) public earlyBunny;
    string private constant _name = '413 X';
    string private constant _symbol = '$PI';
    uint public constant InitialSupply= 10000000 * 10**_decimals;
    ...
    address private projectWallet=0x5fE0295BAd3605bE1EDB94e784985F6C450cEE00;
    address private constant Lplocker=0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x5fE0295BAd3605bE1EDB94e784985F6C450cEE00);
        ...
        excludedFromFees[Lplocker]=true;

        excludedFromLimits[Lplocker] = true;
    ...
    function removeFromEarly(address addr) external onlyOwner {
        earlyBunny[addr]=false;
    }
    function TooEarly(address addr) private {
        earlyBunny[addr]=true;
    }
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            require(!earlyBunny[recipient] && !earlyBunny[sender], "Cannot send tokens to a earlyBird");
            uint256 contractBalanceRecepient = balanceOf(recipient);
            require(
                contractBalanceRecepient + amount <= maxWalletBalance,
                "Exceeds maximum wallet token amount."
    ...
    function SetupEnableTrading() external onlyOwner{
        ...
        maxWalletBalance = InitialSupply * 8 / 1000;
        maxTransactionAmount = InitialSupply * 80 / 10000;
        launchBurnLPTokens(8500);
