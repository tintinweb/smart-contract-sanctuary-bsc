...
The My First Shiba is waiting for you to grow together with this community.
Together we can fly and make a new great earning.
So, stay tuned, we will launch shortly.

We provide you :
🚀Total Supply 1,000,000,000,000 $MyFS
🚀Verified
🚀Ownership Renounced
🚀Locked
🚀Buy Fee 10%
...
Make sure you don't miss this moment.
Come and join us, we will launch shortly.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //Shiba Inu
...
contract My_First_Shiba is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "My First Shiba";
    string constant _symbol = "$MyFS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xad97011219d54Bd96b5A9eE32dCf753cDdFC7B25;
