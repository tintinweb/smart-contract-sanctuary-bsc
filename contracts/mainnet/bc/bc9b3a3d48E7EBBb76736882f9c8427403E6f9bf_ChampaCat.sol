...
contract ChampaCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Champa Cat";
    string constant _symbol = "CHAMPACAT";
    ...
    function rek_bots(address[] calldata addresses, bool status) public onlyOwner {
