...
contract MGENESISNFTStaking is NFTStaking {
    ...
    constructor(address _stakingToken, address _rewardToken) NFTStaking(_stakingToken, _rewardToken) {
        plans[0].rewardsPerNFTPerDay = 5000;
        plans[0].apr = plans[0].rewardsPerNFTPerDay * periodicTime * 100;
    ...
    function setRewardsPerNFTPerDay(uint256 _stakingId, uint256 _rewards) external onlyOwner {
        ...
        plans[_stakingId].apr = plans[_stakingId].rewardsPerNFTPerDay * periodicTime * 100;
