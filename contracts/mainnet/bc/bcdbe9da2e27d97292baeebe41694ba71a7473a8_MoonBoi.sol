...
contract MoonBoi is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'OneNightAt';
    string private constant _symbol = 'ONA';
    ...
    //DevWallets
    address private TeamWallet=payable(0xa674d3A3A1B231CCFa6640CF82F8568347edB581);
    address private walletTwo=payable(0xAD6390E2285a2461060B26E4d0e964e5A449474E);
    //TestNet
