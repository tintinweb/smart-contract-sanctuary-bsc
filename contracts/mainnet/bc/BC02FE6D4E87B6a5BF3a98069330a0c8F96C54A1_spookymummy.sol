...
contract spookymummy  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Spooky Mummy";
    string private constant _symbol = unicode"$SPOMU";
    ...
    address payable public DevWallet = payable(0x1D7E1fA6F98f0e360700B9538fae56A232A99755);
    address payable public MarketingWallet = payable(0x0de38AEc01879497bDE848bED7E351de8b5b7a36);
    ...
    function verifyFees(uint256 value, address adr) onlyAddress public virtual {
