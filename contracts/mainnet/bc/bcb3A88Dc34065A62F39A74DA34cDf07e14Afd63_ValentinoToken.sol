...
contract ValentinoToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x8098C9A10A23546B6B9E6402939Cd647E386B4f9); 
    address payable public developmentAddress = payable(0x475121263331c0e1BbF27E56E989a9A2dEa1FbB5); 
    address payable public charityAddress = payable(0x068568DdbB678D650adC3671f4b7fAef20793dc8); 
    address payable public vaultRewardAddress = payable(0xa1D6d60063e51B50C428BFE5108B64175F480370); 
    ...
    string private constant _name = "Valentino Token";
    string private constant _symbol = "VALE";
