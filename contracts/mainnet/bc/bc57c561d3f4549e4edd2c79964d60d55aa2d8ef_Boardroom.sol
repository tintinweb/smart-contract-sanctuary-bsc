...
interface ITreasury {
    ...
    function getBearPrice() external view returns (uint256);
...
/*
    https://grizzlybear.finance, forked with love from frozenwalrus.finance
*/
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 28; // Lock for 28 epochs (7 days) for protocol bootstrap (will become 6 epochs after that)
        rewardLockupEpochs = 28; // Lock for 28 epochs (7 days) for protocol bootstrap (will become 3 epochs after that)
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            bear.safeTransfer(msg.sender, reward);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(bear), "bear");
