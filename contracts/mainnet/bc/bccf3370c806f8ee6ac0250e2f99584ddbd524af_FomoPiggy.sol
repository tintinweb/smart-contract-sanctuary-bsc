...
contract FomoPiggy is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fomo Piggy";
    string private _symbol = "FP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC590342e5Cc283346D5883f6A1d6f8b7286eFeED); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC590342e5Cc283346D5883f6A1d6f8b7286eFeED); // BuyBack Address
