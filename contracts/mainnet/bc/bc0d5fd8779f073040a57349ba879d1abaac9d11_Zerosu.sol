...
// Zerosu Project Token
// https://t.me/zerosutoken
...
contract Zerosu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x93492a36db7f98db666b338655143c0a9FA816Da); 
    ...
    uint256 private _tTotal = 10000000000000000000000 * 10**_decimals;
    string private constant _name = "Zerosu Coin"; 
    string private constant _symbol = unicode"ZEC"; 
