...
contract RabbitBully is ERC20 {
	...
	address payable _receive = payable(address(0x51e73284633881aD14BDc6d2BBd88Ff5374A19EA));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("RabbitBully", "RabbitBully") {
    ...
    function isIn3minter() public view returns (bool) {
        return startTime.add(10) > block.timestamp;
    }
