...
contract SHIB05 is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("SHIB0.5", "SHIB0.5") {
        ceo = _msgSender();
        address _baseToken = 0x55d398326f99059fF775485246999027B3197955; //usdt
        address _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        address _initMarketAddress = 0x50B3b3456f821AB81b020080E1342CfB9904CECa;
        ...
        address _initHolder = 0xC50eaa3C4634EDef7B27076A09d18671B7dF0557;
