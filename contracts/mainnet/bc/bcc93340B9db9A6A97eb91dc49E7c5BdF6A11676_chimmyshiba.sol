...
contract chimmyshiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chimmy Shiba Inu";
    string private _symbol = "CHIMSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x015558B9987378954439eB37f31970d2950E87E2);
    address payable public teamWalletAddress = payable(0x015558B9987378954439eB37f31970d2950E87E2);
