...
TG: https://t.me/Enewnet

*/

/*

The E-New Network is an Evolutionary Blockchain Network aiming to provide speed and security to its users around the World. 

Also create utilities with E-New designs, such as wallets with modern designs and are fast and easy to use, E-New Staking features, and many more utilities that will be created to form the E-New ecosystem Blockchain.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAAf0fE466b4469c015Fe7CEe0dEcDD0afB77c2A6; // owner address
...
contract ENewNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"E-New Network";
    string private _symbol = "Enet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAAf0fE466b4469c015Fe7CEe0dEcDD0afB77c2A6); // Marketing Address
    address payable public teamWalletAddress = payable(0xAAf0fE466b4469c015Fe7CEe0dEcDD0afB77c2A6); // Team Address
