...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract KollabToken is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "Kollab";
        string private  _symbol = "KOLLAB";
   ...
   address payable maintenanceWallet = payable(0xf0a7F47c571f9082a9BfbedF16282bA9d52D5a0B);
