...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55d8AC104A1145aC38ef6Fba9331fE75f3BaEf31; // owner address
...
contract ShikoraiINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikorai INU";
    string private _symbol = "SI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdF3b6b6D602C80936d37BD42d594A94Cc7f0BE74); // Marketing Address
    address payable public teamWalletAddress = payable(0xdF3b6b6D602C80936d37BD42d594A94Cc7f0BE74); // Team Address
