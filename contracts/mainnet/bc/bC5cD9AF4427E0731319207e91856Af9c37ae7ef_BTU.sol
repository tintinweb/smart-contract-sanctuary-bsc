...
contract BTU is IERC20, Ownable {
    ...
    address private fundAddress = address(0x3Bca9640a831da1C37BC18f71Cdc816E1f3184f3);
    address private fundAddress2 = address(0xF022C9eb16E59BBAacF52887E62011574D37E898);
    address private fundAddress3 = address(0x3d8D663B4Cfb9FF176d97c8a731b58D2e5b984b4);
    address private lpAddress = address(0x2a39d5c47C98aC25401Bf35beD0706721Cb82369);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (liquifyEnabled && newBalanceusdt>0) {
            addLiquidity(otherHalf, newBalanceusdt);
        }

        emit SwapAndLiquify(half, newBalanceusdt, otherHalf);
    }
    ...
    function _takeInviterFee(
        ...
        for (uint256 i = 1; i <= 2; i++) {
            ...
            if (cur == address(0)) {
                ...
                _rOwned[lpAddress] = _rOwned[lpAddress].add(curRAmount);
                emit Transfer(sender, lpAddress, curTAmount);
                cur = address(0);
            }else{
                uint256 curTAmount = tAmount.div(10000).mul(rate);
                uint256 curRAmount = curTAmount.mul(currentRate);
