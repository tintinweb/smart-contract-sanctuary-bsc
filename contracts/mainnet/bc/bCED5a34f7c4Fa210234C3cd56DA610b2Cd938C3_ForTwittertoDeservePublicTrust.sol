...
contract ForTwittertoDeservePublicTrust is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "For Twitter to Deserve Public Trust";
    string constant _symbol = "FWTDPT";
