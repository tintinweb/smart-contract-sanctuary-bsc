...
contract PUMPLUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUMP LUNA";
    string private _symbol = "PLUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x935904ad672559Aa1932E088CD4477ebAC16Ff0e); // Marketing Address
    ...
    uint256 public _maxTxAmount = 20 * 10**9 * 10**9; //5 * 10**6 * 10**9 1% max tnx
