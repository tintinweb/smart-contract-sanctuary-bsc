...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x03D7cc407cB5313F8e09b6d9007A69BF56A8EaD4;
...
contract RabbitGirlInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "RABBIT GIRL INU"; // 
    string private constant _symbol = "RGI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x03D7cc407cB5313F8e09b6d9007A69BF56A8EaD4);
