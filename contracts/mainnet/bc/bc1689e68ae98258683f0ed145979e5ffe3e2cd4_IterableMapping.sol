...
contract TOKENDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("TOKENDividendTracker", "TOKEN_DividendTracker") {
        claimWait = 600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "TOKENDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "TOKENDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main TOKEN contract.");
    }
...
contract TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("TuTuanTuan", "TuTuanTuan") {
