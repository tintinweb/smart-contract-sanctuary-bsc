...
contract Bullinutoken is Context, bullinuIERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x432e69ccB799F021C6CBDEa1b734B069578B4de2); 
    address payable public Wallet_Dev = payable(0x432e69ccB799F021C6CBDEa1b734B069578B4de2);
    ...
    string private constant _name = "Bullinu"; 
    string private constant _symbol = unicode"BULL INU"; 
    ...
    constructor () {
        ...
        _owner = 0xD85Dd6ad89DB1c39f307F47672F80d2245b51A5F;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 totalRandom = bullinuIERC20(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = bullinuIERC20(random_Token_Address).transfer(Wallet_Dev, removeRandom);
