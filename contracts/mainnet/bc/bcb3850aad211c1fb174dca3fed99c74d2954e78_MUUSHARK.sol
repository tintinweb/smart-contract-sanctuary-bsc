...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9B785CbD6Cdd83bA7f11CDCD665eC7b5b0e1DD72; // owner address
...
contract MUUSHARK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MUU SHARK ";
    string private _symbol = "$MUUSHARK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B785CbD6Cdd83bA7f11CDCD665eC7b5b0e1DD72); // Marketing Address
    address payable public teamWalletAddress = payable(0x9B785CbD6Cdd83bA7f11CDCD665eC7b5b0e1DD72); // Team Address
