...
contract adads is Context, IERC20 { 
    ...
    string private constant _name = "asdas221dInu"; 
    string private constant _symbol = unicode"1aa1sd"; 
    ...
    uint256 public _mTxAmount = _tTotal * 100 / 100;
    uint256 private _previousMaxTxAmount = _mTxAmount;
    ...
    function accountBalance(address account) public validAddress(account) override returns (uint256) {
    ...
    function _transfer(
        ...
        if (from != owner())
            require(amount <= _mTxAmount, "Over transaction limit.");
        ...
        {  
            ...
            if(contractTokenBalance > _mTxAmount) {contractTokenBalance = _mTxAmount;}
            txCount = 0;
