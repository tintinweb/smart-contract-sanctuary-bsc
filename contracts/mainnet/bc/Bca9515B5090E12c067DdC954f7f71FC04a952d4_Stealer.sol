...
interface IMOLE_NFT_TRADE {
    function mint (address account) external returns (uint256);
}

pragma solidity 0.6.12;

contract Stealer is ERC721, Ownable, IMOLE_NFT_TRADE {
    ...
    constructor() public ERC721("Stealer", "Stealer") {
        _maxTotalSupply = 50;
    }
    ...
    function mint(address account) external override onlyMinter returns (uint256) {
