...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b7047c7F5dF4a08C2B1F66056761de365d16eE5; // owner address
...
contract STINGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STINGER";
    string private _symbol = "$STINGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b7047c7F5dF4a08C2B1F66056761de365d16eE5); // Marketing Address
    address payable public teamWalletAddress = payable(0x7b7047c7F5dF4a08C2B1F66056761de365d16eE5); // Team Address
