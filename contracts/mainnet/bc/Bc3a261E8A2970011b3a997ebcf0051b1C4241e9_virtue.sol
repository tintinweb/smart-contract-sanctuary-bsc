...
contract virtue is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "virtue";
    string private _symbol = "virtue";
    uint8 private _decimals = 9;

    address payable public teamWalletAddress = payable(0xc3Ae780441b594FB5BA3e7246d63C2EedFD47286); 
