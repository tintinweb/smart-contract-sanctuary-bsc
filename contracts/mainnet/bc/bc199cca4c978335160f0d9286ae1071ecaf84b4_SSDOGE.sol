...
contract SSDOGE is SSDOGEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SSDOGETeam;
    address private CharitySSDOGE;
    ...
    string public override name = "SSDOGE";
    string public override symbol = "SSDOGE";
    ...
    constructor(uint totalSupplyValue, address SSDOGETeamAddress, address CharitySSDOGEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SSDOGETeam = SSDOGETeamAddress;
        CharitySSDOGE = CharitySSDOGEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SSDOGETeam] =  totalSupply * 4 / 100;
        balances[CharitySSDOGE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SSDOGETeam pot
