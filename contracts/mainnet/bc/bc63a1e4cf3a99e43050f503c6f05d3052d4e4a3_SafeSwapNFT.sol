...
contract SafeSwapNFT is ERC721Enumerable, IERC2981, Ownable {
    ...
    uint256 public PURCHASE_LIMIT;
    uint256 public MINT_LIMIT = MAX_SUPPLY;
    uint256 public ROYALTY = 750;
    uint256 public SWAP_BUYBACK = 0; // 0%
    ...
    constructor(
        ...
        require(paymentReceiver != address(0), "Error: wrong payment receiver");
        MAX_SUPPLY = maxSupply;
        MINT_LIMIT = MAX_SUPPLY;
        PRICE = nftPrice;
        PURCHASE_LIMIT = purchaseLimit;
        _paymentReceiver = payable(paymentReceiver);
        royaltyAddress = _paymentReceiver;
    }
    ...
    function setPurchaseLimit(uint256 purchaseLimit, uint256 mintLimit) external onlyOwner {
        PURCHASE_LIMIT = purchaseLimit;
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        if (msg.sender != owner()) {
            require(numberOfTokens <= PURCHASE_LIMIT, "Error: LIMIT PER TX");
            ...
            require(_mappingPublicMintCount[msg.sender] <= MINT_LIMIT, "Error: LIMIT PER USER");
