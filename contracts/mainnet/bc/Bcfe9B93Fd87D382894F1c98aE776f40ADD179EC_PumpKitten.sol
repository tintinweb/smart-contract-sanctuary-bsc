...
/**
   WELCOME TO PUMP KITTEN

$PUMPKITTEN is a community-driven venture,DeFi Token with valuable mechanism that benefits our investors. A new-created kawaii token will come to our hands and let us experience the this explosive project in Binance Smart Chain ecosystem! This potential token will surely involve, intensify, and blast to the moon! Earn big time, while having fun!

WHAT IS PUMP KITTEN TOKEN?

✓ $PUMPKITTEN is an open-source community project built on Binance Smart Chain. Take advantage of the rewards mechanism and earn valuable profits. 

🔰Tokenomics:

✅Total supply: 1,000,000,000
🔥Burn Supply: 400,000,000
...
📱TELEGRAM: https://t.me/PumpKittenPortal

🌐WEBSITE: https://www.pumpkittenbsc.com/

📈TWITTER:https://twitter.com/pumpkitten
...
pragma solidity ^0.6.12;
    ...
    contract PumpKitten is Context, IERC20, Ownable {
        ...
        string private _name = 'PUMP KITTEN';
        string private _symbol = 'PumpKitten';
