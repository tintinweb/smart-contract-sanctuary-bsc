...
contract PigeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "Pige Moon";
    string private _symbol = "PMOON";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xD1be8D25a2b45C5dD14C25Bf5723aA8bf4116d5b); 
    address payable public teamWalletAddress = payable(0x9d3A9c62C32E7041C0fd511e5D67f565Dc102b39); 
