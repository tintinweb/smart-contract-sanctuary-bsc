...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xc68213d66FbAeC13d50442982C3ba408a6695793;
...
contract Xchain is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"XCHAIN"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xc68213d66FbAeC13d50442982C3ba408a6695793), BNB_Tot);
            }
