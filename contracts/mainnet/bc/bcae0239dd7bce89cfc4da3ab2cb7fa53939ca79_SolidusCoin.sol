...
contract SolidusCoin is ERC20, ERC20Burnable, ERC20Snapshot, ERC20Pausable, Ownable {
    
    uint8 private constant _decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 41e4 * (10**uint256(_decimals));

    mapping(address => bool) public isBlacklisted;

    event Blacklisted(address indexed account, bool value);

    constructor() ERC20("Kia Coin", "KIA") 
    {
