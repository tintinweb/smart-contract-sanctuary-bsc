...
TELEGRAM - https://t.me/GamblerShibOfficial
*/
...
contract GamblerShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Gambler Shib ";
    string private _symbol = " $GS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12d0C43b95a2B2FA94e972B69dA53eE737303682); 
    address payable public teamWalletAddress = payable(0x12d0C43b95a2B2FA94e972B69dA53eE737303682);
