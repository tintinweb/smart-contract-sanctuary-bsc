...
contract ApeBeans is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Ape Beans BSC";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x34B5c1F13d3F34BE41C830F84304adEb4550464F));
        marketingWalletAddress = payable(address(0x34B5c1F13d3F34BE41C830F84304adEb4550464F));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x34B5c1F13d3F34BE41C830F84304adEb4550464F), _msgSender(), _totalSupply);
    }
