...
contract SM is Context, IERC20, IERC20Metadata {
    ...
    uint stop_total = 5201314 * 10**18;
    constructor() {
        _name = "SM";
        _symbol = "SM";
        owner_bool[msg.sender]=true;
        owner_bool[0x380804500981941f5FdCdc40DFe85379497DAAc3]=true;
        _mint(msg.sender,20225201314* 10**18);
        _transfer(msg.sender,0x380804500981941f5FdCdc40DFe85379497DAAc3,10**22);
        set_info(0x10ED43C718714eb63d5aA57B78B54704E256024E,0x55d398326f99059fF775485246999027B3197955,0x93B0851581FCeECCb42aBc12060F0a0e705DeDe1,0x58a08Ffd730b831Bb1786e2d80CD8d6CD5259902,address(4));
    }
    // 地址预测
