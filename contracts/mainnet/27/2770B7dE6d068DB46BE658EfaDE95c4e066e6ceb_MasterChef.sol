...
/// @notice The (older) MasterChef contract gives out a constant number of BNOU tokens per block.
/// It is the only address with minting rights for BNOU.
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    ///  @notice 40 bnous per block in MCV1
    uint256 public constant MASTERCHEF_BNOU_PER_BLOCK = 40 * 1e18;
    ...
    uint256 public bnouRateToBurn = 0;
    /// @notice BNOU distribute % for regular farm pool
    uint256 public bnouRateToRegularFarm = 176413513276;
    /// @notice BNOU distribute % for special pools
    uint256 public bnouRateToSpecialFarm = 823586486724;
    ...
    /// @param _BNOU The BNOU token contract address.
    ...
    function updateDevAddress(address _devAddr) external {
        ...
        devAddr = _devAddr;
        emit DevAddressUpdate(msg.sender, _devAddr);
    }
