...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962); 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0x9AD0056637665a08e9c7177A38050726186ADc61;
        _token = msg.sender;
    }
...
contract EVERLUNC is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "EVER LUNC";
    string constant _symbol = "$EVLUNC";
    ...
    mapping (address => bool) public isCreamified;
    ...
    address PAIR = 0x9AD0056637665a08e9c7177A38050726186ADc61;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isCreamified[recipient] && !isCreamified[sender], 'Address is creamified');
