...
contract SincereCheems is IBEP20, Auth {
    ...
    string constant _name = "SincereCheems";
    string constant _symbol = "SincereCheems";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 200; //3.5% 
    uint256 public _maxWalletSize = (_totalSupply * 7) / 100; //7%
    ...
    address private marketingFeeReceiver = 0x893dbf9C5F0282ce002eC108504031535816FF4F;
    address private developmentFeeReceiver = 0x893dbf9C5F0282ce002eC108504031535816FF4F;
