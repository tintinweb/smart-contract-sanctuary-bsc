...
contract silverqueeninu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Silver Queen Inu"; // 
    string private constant _symbol = "$silverqueeninu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xfA6a8690BD9F7164AFedEA369b2Bf56A01abA463;
