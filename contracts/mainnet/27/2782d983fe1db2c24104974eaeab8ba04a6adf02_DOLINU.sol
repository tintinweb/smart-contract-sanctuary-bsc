...
contract DOLINU is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "DOLLAR INU";
string private _symbol = "DOLINU";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xa81E64f20c3929C83005B7A9F958893E236fa9ea); // Marketing Address
