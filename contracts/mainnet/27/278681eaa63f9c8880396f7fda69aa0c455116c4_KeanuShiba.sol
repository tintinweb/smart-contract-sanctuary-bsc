...
// Telegram: https://t.me/KeanuShiba
...
contract KeanuShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Keanu Shiba";
    string private _symbol = "KeanuShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27fE89391B94C79D401D315B4c25FE21Dd9D02D3); // Marketing Address
    address payable public devWalletAddress = payable(0x62aBCa667c732C9b5b12A18d95c96d584B3EeeFF); // dev and team Address
    ...
    uint256 public _maxTxAmount = 0; //10 * 10**6 * 10**9
