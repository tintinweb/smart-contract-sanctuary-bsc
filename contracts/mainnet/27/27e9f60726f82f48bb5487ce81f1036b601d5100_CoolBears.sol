...
contract CoolBears is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 public nextTokenId = 0;
    uint256 public MAX_MINT_ETHEREUM = 3333;
    uint256 public  Mintprice = 80000000000000000;   
    uint public     MaxMintPerTx = 20; 
    bool public     IsSalesStart = false;
    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("Cool Bears", "CoolBears") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM, "Can not mint more than TotalCollectionSize");    
