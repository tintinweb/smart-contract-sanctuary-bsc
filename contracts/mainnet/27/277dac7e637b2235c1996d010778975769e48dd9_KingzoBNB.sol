...
contract KingzoBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = " Kingzo BNB "; // 
    string private constant _symbol = " $KINGZOBNB "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x75aa9E0Fc51ecc731bCfd3cAcEB1d9c24ffB908f;
