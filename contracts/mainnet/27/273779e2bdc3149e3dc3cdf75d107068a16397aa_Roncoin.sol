...
contract Roncoin is IBEP20, Auth {//名前を定義
    using SafeMath for uint256;
    ...
    string constant _name = "Ron Coin";//表示される名前
    string constant _symbol = "RON";//表示されるシンボル
    ...
    uint256 public liquidityFee    = 2;//流動性手数料
    uint256 public reflectionFee   = 3;//反射税
    uint256 public marketingFee    = 6;//マーケティング税
