...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 STINK = IBEP20(0xc216E4B28e7aCE067f076D0f5Ef3094676a134d7); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = STINK.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(STINK);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = STINK.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           STINK.transfer(shareholder, amount);
...
contract Stinksale is IBEP20, Auth {
   ...
   address STINK = 0xc216E4B28e7aCE067f076D0f5Ef3094676a134d7; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "StinkSale 2.0";
   string constant _symbol = "STINK 2.0";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x380A779da8210Bc09D39DB9670aa4D1e6918eD7b; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x380A779da8210Bc09D39DB9670aa4D1e6918eD7b; //Can be change to any wallet you want
       marketingFeeReceiver = 0x380A779da8210Bc09D39DB9670aa4D1e6918eD7b; //Can be change to any wallet you want
