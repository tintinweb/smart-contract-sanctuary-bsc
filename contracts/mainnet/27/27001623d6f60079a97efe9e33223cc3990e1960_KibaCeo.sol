...
contract KibaCeo is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kiba Ceo";
    string private _symbol = "KIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeec2734825865430f271A75dBf810c11488796f1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeec2734825865430f271A75dBf810c11488796f1); // BuyBack Address
    ...
    uint256 private minimumTokensBeforeSwap = 7000 * 10**_decimals; 
