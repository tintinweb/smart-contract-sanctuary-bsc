...
contract Viewium is ERC20, Ownable {
    ...
    event UpdateBuyFees(uint256 developmentFeeOnBuy, uint256 marketingFeeOnBuy);
    event UpdateSellFees(uint256 developmentFeeOnSell, uint256 marketingFeeOnSell);
    event SwapAndSendFee(uint256 tokensSwapped, uint256 bnbSend);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("Viewium", "$View") 
    {   
        ...
        _totalFeesOnBuy    = developmentFeeOnBuy  + marketingFeeOnBuy;
        _totalFeesOnSell   = developmentFeeOnSell + marketingFeeOnSell;

        marketingWallet = 0x0457ac7fe9b0ac05C4370C0C873b12966C4d8554;
        developmentWallet = 0xB07b796d3cC91ea8b7836A15c4BFC19227e95E64;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _developmentFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        emit UpdateBuyFees(developmentFeeOnBuy, marketingFeeOnBuy);
    }

    function updateSellFees(uint256 _developmentFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        emit UpdateSellFees(developmentFeeOnSell, marketingFeeOnSell);
    }
...
//------------------Swap------------------//
    ...
    function swapAndSendFee(uint256 amount) private {
        ...
        uint marketingShare = marketingFeeOnBuy + marketingFeeOnSell;
