...
// TG:      https://t.me/HALLOWDOGEPORTALBSC
...
contract HALLOWEENDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x096DE1A605c55f59C98806564C1Ea8DE43F48746); 
    address payable public Wallet_Dev = payable(0x096DE1A605c55f59C98806564C1Ea8DE43F48746);
    ...
    string private constant _name = "HallowDoge"; 
    string private constant _symbol = unicode"HALLOWDOGE"; 
    ...
    constructor () {
        ...
        _owner = 0x096DE1A605c55f59C98806564C1Ea8DE43F48746;
