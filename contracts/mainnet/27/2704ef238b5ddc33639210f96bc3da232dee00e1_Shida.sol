...
contract Shida is Context, IERC20, Ownable {
    ...
    string private _name = "Shida";
    string private _symbol = "Shida";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x31b5Ef92E23D7f642BEa0756bD1393F7C8793A44);
    address payable public liqWalletAddress = payable(0x31b5Ef92E23D7f642BEa0756bD1393F7C8793A44);
    ...
    uint256 private _totalSupply =  1800000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   1800000000000 * 10**_decimals;
    uint256 public _walletMax =     1800000000000 * 10**_decimals;
