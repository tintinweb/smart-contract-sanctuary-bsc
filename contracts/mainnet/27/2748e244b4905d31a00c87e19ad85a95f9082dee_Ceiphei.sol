...
// https://t.me/Cepheicapital
// 8/8 Taxes
// FaaS & Futures trading fund with monthly dividends
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9Fa87aaEa4AB681558Fe446b387b1d0A1b441E3e;
...
contract Ceiphei is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Treasury = payable(0x21D88F9b18f801bFE0A27d3b1891FE7694d5b5c3);
    ...
    */
    ...
    string private _name = "Ceiphei Capital"; 
    string private _symbol = "$Ceiphei";  
    ...
    */
    ...
    // Update main wallet
    function Wallet_Update_treasury(address payable wallet) public onlyOwner() {
    ...
    */
    ...
    One wallet is used for ALL fees. This includes liquidity, marketing, treasuryelopment costs etc.
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Treasury,contractBNB);
    }
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 ttreasury) = _getValues(tAmount);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 ttreasury = tAmount*_TotalFee/100;
        uint256 tTransferAmount = tAmount.sub(ttreasury);
