...
/**
Portal: https://t.me/SafeLunaClassic
Follow Twitter: https://twitter.com/sluncBSC
*/
...
contract SafeLunaClassic is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "SLUNC";
    string private constant _name = "Safe Luna Classic";

    uint256 public MaxBuy = 10000000000 * 10**9;
    uint256 public MaxSell = 10000000000 * 10**9;

    address public MarketingWallet = 0xfcBe6C0D490EE8197fa9CbA2C2fD0FcEace3a544;
    address public TeamWallet = 0xfcBe6C0D490EE8197fa9CbA2C2fD0FcEace3a544;

    uint256 public MaxWallet = 20000000000 * 10**9;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from == pair && !_isExcludedFromFee[to] && !swapping){
            ...
            require(balanceOf(to) + amount <= MaxWallet, "You are exceeding MaxWallet");
        }
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        MaxBuy = maxBuy * 10**decimals();
        MaxSell = maxSell * 10**decimals();
    }
