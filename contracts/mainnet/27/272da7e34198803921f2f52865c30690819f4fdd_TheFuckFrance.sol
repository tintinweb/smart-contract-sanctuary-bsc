...
contract TheFuckFrance is Context, FUCKYOUFRANCE, Ownable {
    ...
    string private _name = 'The Fuck France';
    string private _symbol = 'WTF FRANCE';
