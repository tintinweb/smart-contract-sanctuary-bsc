...
contract MaoFei is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mao Fei";
    string private _symbol = "MaoFei";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xa9ad614F6939D17Ddc28871b07171aAf0EB5DFb8); // Marketing Address
    address payable public teamWalletAddress = payable(0x062a46A496E20110947D07E87E0A2bA4DEd8992a); // Team Address
