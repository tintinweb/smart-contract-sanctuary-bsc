...
contract Safemoon is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"$SAFEMOON2023";
    ...
    address payable public DevWallet = payable(0x4d37db83E0322A2A2Cc24016f5Aace300906e843);
    address payable public MarketingWallet = payable(0xC371e81d26D2316B183d78fbd08bbc099996c2fA);
