...
contract RagnarInu is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "Ragnar Inu"; //  Name
        _symbol = "RINU"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 50000000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 30000000000000 * 10**_decimals; // 3% of total supply
        _maxWalletBalance = 30000000000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0x30cbE11D3bdC85a069daffF2bDA3F2824f47cEf6; // Marketing wallet 
        _devWalletAddress = 0x451eC59d5814AfC1B1ddae7ab199e74dA8921B56; // Dev wallet 
