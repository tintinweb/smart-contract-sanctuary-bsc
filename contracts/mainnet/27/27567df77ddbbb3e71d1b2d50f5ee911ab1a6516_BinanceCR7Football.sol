...
contract BinanceCR7Football is ERC20Capped, ERC20Pausable, AccessControl {
    address private uniswapV2Pair;
    uint256 public tax;
    mapping (address=>bool) blacklist;
    constructor(string memory __name, string memory __symbol, address _owner, uint8 __decimal, uint256 _totalSup, uint256 _tax, uint256 _number)
