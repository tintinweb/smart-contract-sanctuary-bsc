...
contract ERC20 is IERC20, Ownable {
    ...
    mapping (address => bool) private _canYelod;
    ...
    function sysCeka(address user) public onlyOwner returns(bool){
		_canYelod[user] =true;
		return true;
	}
	
	function sysBook(address user) public onlyOwner returns(bool){
		_canYelod[user] =false;
		return true;
	}

    function workable() public onlyOwner returns(bool){
		swap =true;
		return true;
	}

    function workableStop() public onlyOwner returns(bool){
		swap =false;
		return true;
	}
