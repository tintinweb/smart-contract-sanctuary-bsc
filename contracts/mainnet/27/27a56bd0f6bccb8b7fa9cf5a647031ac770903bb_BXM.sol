...
contract BXM is BEP20, Auth {
    ...
    string public constant name = "Bullish Xmas";
    ...
    address public marketingFeeReceiver = 0xbA005dE0Be57fE68fb192C6A3D2e0A06fBb28515;
    address public charityFeeReceiver = 0x413D75B20118808aF5f93CC33995546EB7d4B77A;
    ...
    function update_fees() internal {
        if(!launchMode){
            ...
            require(totalFee.mul(sellMultiplier).div(100) <= 600, "Sell tax cannot be more than 60%");
