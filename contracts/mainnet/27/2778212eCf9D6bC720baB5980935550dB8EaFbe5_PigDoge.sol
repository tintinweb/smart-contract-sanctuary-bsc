...
/**
Pigdoge a token that burns 1% on every transactions, Increasing your holdings value to the moon! 

Portal : https://t.me/PigDoge
...
*/
    ...
    contract PigDoge   is IBEP20, Ownable
    {
        ...
        string private constant _name = "PigDoge";
        string private constant _symbol = "PigDoge";
        ...
        address public constant MarketingWallet=0x592Fa0a81E2De435360F3f40171a3C125B930fC7; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function AllowTaxBurn(address[] calldata addresses) external onlyOwner {
