...
// will be transferred to a governance smart contract once BFT is sufficiently
// distributed and the community can show to govern itself.
//
// Have fun reading it. Hopefully it's bug-free. God bless.
contract BFTLPFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of BFT
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;         // How many allocation points assigned to this pool. BFT to distribute per block.
        uint256 lastRewardBlock;    // Last block number that BFT distribution occurs.
        uint256 accTokenPerShare;   // Accumulated BFT per share, times 1e12. See below.
    ...
    // The block number when BFT mining starts.
    ...
    constructor() {
        token = IBEP20(0x2Bc8c2Ae9dAD57948FA4168E56E177A29AE0c0b1);
        startBlock = block.number;
        tokenPerBlock = 40 ether;
    ...
    // Update the given pool's BFT allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending BFT on frontend.
    ...
    // View function to see if user can harvest BFT.
    ...
    // Deposit LP tokens to Farm for BFT allocation.
    ...
    // Safe token transfer function, just in case if rounding error causes pool to not have enough BFT.
