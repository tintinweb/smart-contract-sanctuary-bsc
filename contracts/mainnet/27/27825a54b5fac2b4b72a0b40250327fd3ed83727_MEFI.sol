...
contract MEFI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public minTokensBeforeSwap = 1000000 * 10**18; // 1 million mininum

    uint32 public _devFee = 100;
    uint32 public _burnFee = 100;
    ...
    constructor(
        ...
        _mint(0x37fb1ecc3C602DF685416Bb7FE71F9575Fd28C31, 500000000 * 10**18);
        
        _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // PancakeV2 Main

        // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        
        _burnWallet = 0xbaC0594591CEb9b784bd963b9c4cA4CF6ED88B13;
        _devWallet = 0x59e16e2a2373e87a200271EdcCbd8c7ba70D705d;
    ...
    */
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && !_feesDisabled && !inSwapAndLiquify && _isSell(from , to)) {
            ...
            super._transfer(from, _burnWallet, burnAmount);
    ...
    */
    ...
    function setBurnFee(uint32 newFee)
        public
        onlyOwner
    {
        _burnFee = newFee;
    ...
    function changeBurnWallet(address payable newAddress) public onlyOwner{
        _burnWallet = newAddress;
    }

    function changeDevWallet(address newAddress) public onlyOwner{
    ...
    function withdrawAnyToken(address _recipient, address _ERC20address, uint256 _amount) public onlyOwner returns(bool) {
        require(_ERC20address != address(this) , "Can't Withdraw Native Tokens");
        IERC20(_ERC20address).transfer(_recipient, _amount); //use of the _ERC20 traditional transfer for extra tokens
        return true;
    }
