...
contract GBLN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Goblin Mode";
    string constant _symbol = "GBLN";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xdAA7D850abb1d99d15df027f8ADDa6a327E1eEfb;
