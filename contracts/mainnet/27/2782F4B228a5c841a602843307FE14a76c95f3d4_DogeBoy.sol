...
contract DogeBoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xeADD151C0433e801A998e36F0ecD939C291A484d); // Marketing Address
    ...
    string private _name = "DogeBoy";
    string private _symbol = "DOBE";
