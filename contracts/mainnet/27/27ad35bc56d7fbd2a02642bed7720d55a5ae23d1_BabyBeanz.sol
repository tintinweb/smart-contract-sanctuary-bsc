...
//Contract
contract BabyBeanz is IBEP20, Ownable {
    ...
    string private constant _name = 'Baby Beanz';  
    string private constant _symbol = 'BBNZ';    
    ...
    address public MainReward=0x1446A6562625257Ac3a1e92a8090E34ae3116b26;   //change this address to desired reward token
    address public MiscReward=0x1446A6562625257Ac3a1e92a8090E34ae3116b26;   //Only MiscReward can be changed to BNB
