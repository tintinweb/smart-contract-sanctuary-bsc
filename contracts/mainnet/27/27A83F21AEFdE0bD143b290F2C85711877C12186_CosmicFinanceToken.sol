...
contract CosmicFinanceToken is ERC20Detailed, Ownable {
    ...
    uint256 public cosmikVaultFundFee = 50;
    ...
    constructor() ERC20Detailed("Cosmik Finance", "COSMIK", uint8(DECIMALS)) Ownable() {
        ...
        address _owner = 0x9AE76A02bEE3f5a4Da95414a798f4429a18ca132;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_cosmikTrustFee.add(cosmikVaultFundFee))
        );
