...
//Telegram: https://t.me/MortalShibaKombat
//Twitter: https://twitter.com/MortalShibaKom
...
contract MortalShibaKombat is Context, IBEP20, Ownable {
    ...
    string private _name = "Mortal Shiba Kombat";
    string private _symbol = "$MSK";
    ...
    address payable public gameWallet;
    ...
    constructor(address payable _marketWallet, address payable _gameWallet) {
    ...
    function distributeAndLiquify(address from, address to) private {
        ...
        if (
            ...
            if (bnbForDev > 0) gameWallet.transfer(bnbForDev);
