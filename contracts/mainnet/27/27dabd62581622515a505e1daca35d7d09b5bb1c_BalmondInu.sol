...
contract BalmondInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x90386322C13aB3cfD8Dd6A361f1a43FC3F010067));


    string private _name = "Balmond Inu ";
    string private _symbol = "BALMOND";
