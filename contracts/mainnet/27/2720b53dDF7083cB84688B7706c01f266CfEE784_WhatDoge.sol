...
/*
telegram : https://t.me/WHATDOGEBSC

Twitter : https://twitter.com/whatdogebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8253b0B98B74dDac310043c48c8306e2348389d0; // whatDOGE
...
contract WhatDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "What DOGE";
    string private _symbol = "WDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8253b0B98B74dDac310043c48c8306e2348389d0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8253b0B98B74dDac310043c48c8306e2348389d0); // Team Address
