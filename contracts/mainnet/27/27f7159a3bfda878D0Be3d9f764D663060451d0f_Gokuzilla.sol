...
Telegram - https://t.me/Gokuuzilla
...
contract Gokuzilla is IBEP20, Auth {
    ...
    string constant _symbol = "Gokuzilla";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 900 / 10000; //2%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 900 ) / 10000; // 2%
