...
contract Doge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x77a464D5Acb019A87A06bbF0868c2E171e5d9AfD); // Marketing Address
    ...
    uint256 private _tTotal = 3220000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Doge Baby Floki AI Inu";
    string private _symbol = "DogeBabyFlokiAiInu";
    ...
    uint256 private minimumTokensBeforeSwap = 100 * 10**1 * 10**18; 
    uint256 public buyBackSellLimit = 100 * 10**14;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xE57d7C14c4be50F05051d03DF3366eB0011b3209)] = true;
