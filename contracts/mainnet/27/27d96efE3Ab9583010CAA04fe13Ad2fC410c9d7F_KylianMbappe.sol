...
contract KylianMbappe is Context, IBEP20, Ownable {
    ...
    string private _name = "Kylian Mbappe"; // token name
    string private _symbol = "MBP"; // token ticker
