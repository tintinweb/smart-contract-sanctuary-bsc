...
contract WinterDogeFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WinterDogeFloki";
    string private _symbol = "$WDF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa2337Dc31DE6B865135f2491a039C1fdB5F4AA8E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xa2337Dc31DE6B865135f2491a039C1fdB5F4AA8E); // BuyBack Address
