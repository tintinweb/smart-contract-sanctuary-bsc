...
contract TaxBoy is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TaxBoy';
    string private constant _symbol = '$Boy';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000 * 10**_decimals;//equals 500B tokens
    uint256 public swap_threshold = (InitialSupply * 15) / 10;
    ...
    //DevWallets
    address public TeamWallet=payable(0xEe6eBfd49784D1F0C431773d08C61f2D43851918);
    address public walletTwo=payable(0xB458ABb9dC4A5FAcE9a5ee3Cb671466B417CB47c);
    //TestNet
