...
/**
 * Renounced community contract I suggest you create a TG called "supermoonshot"
 * 2% tax, 1% to LP. 1% to marketing. I will use it to buyback and burn
 * Lp locked will extend continuously if we moon and will reveal myself. Goodluck. 
*/
...
contract SuperMoonShot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperMoonShot";
    string private _symbol = "SMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x499dcdEB0882A513D44668587835332f99cE9BE3); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x499dcdEB0882A513D44668587835332f99cE9BE3); // buyback Address
    ...
    uint256 public _walletMax = 7500000000000 * 10**9; // 
