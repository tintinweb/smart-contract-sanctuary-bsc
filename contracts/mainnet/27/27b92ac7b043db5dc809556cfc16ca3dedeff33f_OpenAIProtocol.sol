...
contract OpenAIProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x844956180cC549320e2010634bbFB533ec07C1Fd); // Marketing Address
        
    address payable public teamAddress =
        payable(0xE4A04C08064Ba1039bc1d10034a55287Da2f4483); // Team Address
        
    address payable public liquidityAddress =
        payable(0xE4A04C08064Ba1039bc1d10034a55287Da2f4483); // Liquidity Address
    ...
    string private constant _name = "OpenAI Protocol";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 3 / 100; 
