...
contract HunterXStaker is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public constant min = 0.005 ether;
    ...
    constructor() {
        dev = payable(0x47C67336cf1Bfc86b585056628C797e54daF1B7A);
        startDate = 1665537336; //Oct 12, 2022
    }
    ...
    function deposit(address _ref) public payable noReentrant  {
        ...
        uint256 deadline_weekly = block.timestamp + (TIME_STEP * 1);
