...
contract MemeRusher is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xEB0dAfcba965E84D76777062cb773602207e4a0f); // Marketing Address

    address payable public buyAddress =
        payable(0x23E3Ec8890B44ebc1A04153A060BdB42480D0469); // BuyBack Address

    address payable public liquidityAddress =
        payable(0xEE8f51Cfd6b0D798B8e5bd64c57BfF303559D7a0); // Liquidity Address
    ...
    string private constant _name = "MemeRusher";
    string private constant _symbol = "$RUSHER";
