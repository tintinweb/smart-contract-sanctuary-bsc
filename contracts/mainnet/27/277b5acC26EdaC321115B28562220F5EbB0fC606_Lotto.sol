...
contract Lotto is Initializable, AccessControlUpgradeable, PausableUpgradeable,   UUPSUpgradeable{
    ...
    function initialize(address _L, address _priceFeed) initializer public {
        __AccessControl_init();
        __Pausable_init();
        __UUPSUpgradeable_init();
         _safe = 0x960A6eE1b2719513F1f47Fee36983c9467E08B39;
        priceFeed = AggregatorV3Interface(_priceFeed); //BNB mainnet price USD
    ...
    function GetWinner() public returns(address) {
        require(_win == true, "Lottery hasn't ended yet");
        return winner;
    }
