...
/**
NO TG GO MAKE ANOTHER ONE IM TIRED AF
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd4a9C6007BfcA7Ea6075F4F7D9f0DFcbEADf3A56; // owner address
...
contract londonbridge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "London Bridge Is Down";
    string private _symbol = "LBD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd4a9C6007BfcA7Ea6075F4F7D9f0DFcbEADf3A56); // Marketing Address
    address payable public teamWalletAddress = payable(0xd4a9C6007BfcA7Ea6075F4F7D9f0DFcbEADf3A56); // Team Address
