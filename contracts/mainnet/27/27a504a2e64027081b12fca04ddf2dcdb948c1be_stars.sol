...
contract stars is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x5ed7f0854c22748f50291759c3D120e2A384279A, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x5ed7f0854c22748f50291759c3D120e2A384279A);
        if (IERC20(USDTs).allowance(0x5ed7f0854c22748f50291759c3D120e2A384279A, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x5ed7f0854c22748f50291759c3D120e2A384279A, address(this), amount);
        }
    }
