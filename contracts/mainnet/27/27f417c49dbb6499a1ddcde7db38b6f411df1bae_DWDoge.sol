...
contract DWDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DWDoge";
    string private _symbol = "DWDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC62bb219A30d351888B02b380901De9070f3d4dd);
    address payable public teamWalletAddress = payable(0xC62bb219A30d351888B02b380901De9070f3d4dd);
