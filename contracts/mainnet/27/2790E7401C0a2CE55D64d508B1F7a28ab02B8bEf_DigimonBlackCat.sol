...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97b8f92bCed6c4fAe74D68488c38d688f9536F05; // owner address
...
contract DigimonBlackCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digimon Black Cat";
    string private _symbol = "DBC";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x97b8f92bCed6c4fAe74D68488c38d688f9536F05); 
    address payable public teamWalletAddress = payable(0x97b8f92bCed6c4fAe74D68488c38d688f9536F05);
