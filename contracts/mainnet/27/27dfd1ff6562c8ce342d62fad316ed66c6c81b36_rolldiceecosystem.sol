...
Telegram https://t.me/rolldiceecosystem
Website https://rolldiceecosystem.org
*/
...
contract rolldiceecosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ROLLDICE ECOSYSTEM";
    string private _symbol = "$RDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa023C065584f06850AaB7612fe825eC36f1D5465); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe959c8B4be416ED14aDeFf9118CAA7567f9115ef); // BuyBack Address
