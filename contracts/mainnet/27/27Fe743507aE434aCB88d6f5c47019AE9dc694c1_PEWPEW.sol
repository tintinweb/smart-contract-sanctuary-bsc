...
contract PEWPEW is IERC20Metadata, Ownable, ReentrancyGuard {
    ...
    address private charityWallet = 0x65d5363F0bEa6b71bA9d16b947EE58F709254738;
    
    string constant _name = "PEWPEW";
    string constant _symbol = "PEWPEW";
    ...
    uint256 private charityFee = 25; // 2.5%
    uint256 public lpFee = 5; // 0.5%
    uint256 private totalFee;
    
    // Total = 100% (1000)
    uint256 public marketingPortionOfSwap = 600; // 60%
    uint256 private charityPortionOfSwap = 300; // 30%
