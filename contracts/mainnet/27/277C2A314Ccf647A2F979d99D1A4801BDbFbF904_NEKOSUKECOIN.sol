...
Telegram: https://t.me/nekosukecoin

Nekosuke Coin is an Anime fan based community token with a hype of
Yu Yu Hakusho Neko Adaptation that will bring luck for all investors
with verified contract and locked liquidity.  
...
contract NEKOSUKECOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nekosuke Coin"; //
    string private constant _symbol = "$NC"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x89C56a4F996d466756E95E7Da1754acaDFB0f15F ;
