...
abstract contract ContextDeepwatersBep20 {
...
contract OwnableDeepwatersBep20 is ContextDeepwatersBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableDeepwatersBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableDeepwatersBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DeepwatersToken is ContextDeepwatersBep20, DeepwatersBep20, OwnableDeepwatersBep20 {
    ...
    string private _name = 'Deepwaters';
    string private _symbol = 'Deepwaters';
