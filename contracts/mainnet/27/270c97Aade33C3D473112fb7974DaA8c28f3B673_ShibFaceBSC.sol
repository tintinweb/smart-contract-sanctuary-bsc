...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14d158E03b1aA9e876e4B38230B3D754302a53a1; // owner address
...
contract ShibFaceBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shib Face";
    string private _symbol = "SF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x14d158E03b1aA9e876e4B38230B3D754302a53a1); // Marketing Address
    address payable public teamWalletAddress = payable(0x14d158E03b1aA9e876e4B38230B3D754302a53a1); // Team Address
