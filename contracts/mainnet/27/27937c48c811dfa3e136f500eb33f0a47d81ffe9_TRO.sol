...
/* ternio.art Binance launch Pad- BNB Reward Token

website: https://ternio.art
Listing 1 TRO = 1.2 USD
...
contract TRO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc00d673c348b48a338Db4889206240180D667932); // Marketing Address
    address payable public charityAddress = payable(0xc00d673c348b48a338Db4889206240180D667932); // Charity/Dev Address
    ...
    string private _name = "Ternio Token";
