...
contract ShikUpDown is Ownable, Pausable, ReentrancyGuard {
    ...
    IRouter public oracle;

    bool public genesisLockOnce = false;
    bool public genesisStartOnce = false;
    bool public coverEmpty = false;
     ...
     * @param _tokenAddress: tokenAddress to bet on
    ...
    function getPrice() internal view returns (uint256) {
        return oracle.getAmountsOut(1 ether, path)[path.length-1];
    }
     ...
     * @dev Callable by admin
     */
    function setExecutionFee(uint256 _executionFee) external whenPaused onlyAdminOrOperator {
        executionFee = _executionFee;
    }
     ...
     * @dev Callable by admin
     */
    function setCoverEmpty(bool _coverEmpty) external onlyAdminOrOperator {
     ...
     * @dev Callable by admin
     */
    function setCoverEmptyThreshold(uint256 _threshold) external whenPaused onlyAdminOrOperator {
     ...
     * @dev Callable by admin
     */
    function resetEmptyRoundFees() external onlyAdminOrOperator {
        emptyRoundFees = 0;
    }
     ...
     * @dev Callable by admin
     */
    function setRouter(address _oracle) external whenPaused onlyAdminOrOperator {
        require(_oracle != address(0), "Cannot be zero address");
        oracle = IRouter(_oracle);
     ...
     * @dev Callable by admin
     */
    function setToken(address[] calldata _path, string calldata _tokenName, string calldata _tokenSymbol, string calldata _symbolURI, address _tokenAddress) external whenPaused onlyAdminOrOperator {
        path = _path;
