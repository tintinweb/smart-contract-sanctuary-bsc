...
contract nanwangjinxiao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "nanwangjinxiao";
    string private _symbol = "nanwangjinxiao";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x925bbf2272E8f66d854b41773cC4393dFF6f8BE0);
