...
// File: contracts\SingleFitswapNftAuction.sol

// SingleFitswapNft Auction Contract 
...
contract SingleFitswapNftAuction is Ownable, ERC721Holder {
    ...
    {   
        ...
        ISingleFitswapNft nft = ISingleFitswapNft(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            ISingleFitswapNft(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = ISingleFitswapNft(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = ISingleFitswapNft(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            ISingleFitswapNft(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
