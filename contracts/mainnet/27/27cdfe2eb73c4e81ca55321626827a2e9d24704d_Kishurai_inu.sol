...
/**
TOKEN NAME: Kishurai Inu
TICKER: $KSRAI

$KSRAI - Kishurai Inu 

Community Cryptocurrency Project With An Incredible Story Behind It. WE LOVE AND SUPPORT KISHURAI INU. The developer of volt inu changed my life and so many others, I hope to do the same.

Tokenomics:

TOTAL SUPPLY: 10,000,000,000 (of course)
...
1.0% max TRX, 1.0% max wallet (possible increase overtime)

TG:
Twitter:  https://twitter.com/Kishuraiinu
Website: TBA
*/
...
abstract contract Ownable is Context {
    ...
    function _setOwner(address newOwner) private {
        address oldOwner = 0x343D4dad45582eA58ecB7f73F2a30b1E0E13899f;
        _owner = newOwner;
...
contract Kishurai_inu is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 66; // 1.0% of supply
    uint256 public maxTxAmountSell = _tTotal / 66; // 1.0% of supply
    uint256 public maxWalletAmount = _tTotal / 66; // 1.0% of supply
    ...
    string private constant _name = "Kishurai Inu";
    string private constant _symbol = "$KSRAI";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            treasury: 15, // treasury fee in %
            lp: 2, // lp rate in %
            toSwap: 32 // treasury + dev + lp
        });
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            treasury: 16, // treasury fee in %
            lp: 3, // lp rate in %
            toSwap: 21 // treasury + dev + lp
        });
