...
contract WJRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WJRABBIT";
    string private _symbol = "WJRABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC114C93108B7fa0519d30544EA082a81bA6E2856);
    address payable public teamWalletAddress = payable(0xC114C93108B7fa0519d30544EA082a81bA6E2856);
    address public immutable deadAddress = 0xC114C93108B7fa0519d30544EA082a81bA6E2856;
