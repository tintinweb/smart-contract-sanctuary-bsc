...
| $$$    /$$$            | $$               /$$__  $$                                | $$    
| $$$$  /$$$$  /$$$$$$  /$$$$$$    /$$$$$$ | $$  \ $$ /$$   /$$  /$$$$$$   /$$$$$$$ /$$$$$$  
| $$ $$/$$ $$ /$$__  $$|_  $$_/   |____  $$| $$  | $$| $$  | $$ /$$__  $$ /$$_____/|_  $$_/  
| $$  $$$| $$| $$$$$$$$  | $$      /$$$$$$$| $$  | $$| $$  | $$| $$$$$$$$|  $$$$$$   | $$    
| $$\  $ | $$| $$_____/  | $$ /$$ /$$__  $$| $$/$$ $$| $$  | $$| $$_____/ \____  $$  | $$ /$$
| $$ \/  | $$|  $$$$$$$  |  $$$$/|  $$$$$$$|  $$$$$$/|  $$$$$$/|  $$$$$$$ /$$$$$$$/  |  $$$$/
|__/     |__/ \_______/   \___/   \_______/ \____ $$$ \______/  \_______/|_______/    \___/  
                                                 \__/     
 ...
 ) /    |_   ) / ____)(/_(_|__/(_(__/ )(_(_(_/ (_   ) /     (_(/_) (/_(/_
(_/         (_/ (                                  (_/                   
                                                                         

WEB: https://MetaQuest-Game.com
TG:  https://t.me/MetaQuestP2E
*/
...
contract MetaQuest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaQuest";
    string private _symbol = "MQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFEBE3540E36E82985c7450DAdb970c7dd1C1DDfA); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3793F20BeB61Be94F11bB6fB7b82093c1688cf91); // Treasury / Buyback
    ...
    uint256 private _totalSupply = 300 * 10**6 * 10**9; // 300 Million
