...
contract INUINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "INUINU";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 0; //(2% liquidityAddition + 2% marketing  + 2% Development)
    ...
    constructor () public {
        ...
        marketingWallet = payable(0x49fe8Ff91117423F07C71E67B1fa0C5a8Ea28a52);
        developmentWallet = payable(0x760aa7fbF4EdA7E6C5bCE7929c92765e15AF7fC1);
