...
/**
Conflux New Official Token
🅲🅵🆇
Blockchain Without Barriers
Conflux enables creators, communities, and markets to connect across borders and protocol
Conflux Hydra hard fork is now live on mainnet
...
contract ConfluxOfficialNewToken is Context, IERC20 { 
    ...
    string private constant _name = unicode"Conflux New Official Token"; 
    string private constant _symbol = unicode"Conflux Hydra"; 
    ...
    constructor () {
        ...
        _owner = 0x8508CF275D48CE93A396E5a0ac514276220bE5d7;
