 ...
 * 
 * TG: https://t.me/DeathlyHallowsNFT
 * 
 *☠⚡DEATHLY HALLOWS NFT⚡☠
          ⚡⚡Avada Kedavra⚡⚡

aims to become the world’s premier community-run non-fungible token (NFT) marketplace. Join our all-inclusive environment of artists, investors, collectors, and tech enthusiasts. Buy $NFT — our native token — and take part in our governance process.

Deathly Hallows NFT is the world’s most community-centric NFT marketplace, where artists and art collectors can easily find each other while simultaneously managing the limitless potential of their own marketplace. Our vision is to put the power back in the hands of art and content creators so the true value of their work is realized.
--------------------------------------------------
Token Name: DEATHLY HALLOWS NFT
Token Symbol: $DH
Decimal: 18
Total Supply
1,000,000,000,000 $DH
...
Telegram : https://t.me/DeathlyHallowsNFT
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e5D5918D00Ffe61006a171326D588B890788873;
...
contract DeathlyHallowsNFT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd564063DD0B90A3CD1df3AAC46C84b14Ced665dd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Deathly Hallows NFT";
