...
contract CATANK is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000; // underscores aid readability
    ...
    string private _name = "Catank";
    string private _symbol = "CATANK";
    ...
    address payable private _marketingWallet = payable(0x123d1271B64d061Ef9f128f96CB8288CA85F643d);
    address payable private _devWallet = payable(0x123d1271B64d061Ef9f128f96CB8288CA85F643d);
