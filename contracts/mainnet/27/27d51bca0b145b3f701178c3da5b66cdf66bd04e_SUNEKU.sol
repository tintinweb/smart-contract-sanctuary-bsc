...
contract SUNEKU is Context, IBEP20, Ownable {
    ...
    string private _name = "Suneku"; // token name
    string private _symbol = "SUNEKU"; // token ticker
