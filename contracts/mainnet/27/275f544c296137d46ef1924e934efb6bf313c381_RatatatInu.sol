...
/*
   ...
   I will renounce the ownership to burn addresses to transfer #Ratatat Inu to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #RatatatInu 10000X? 
   ...
   it's the best part of the #RatatatInu idea, increasing the liquidity pool automatically, 
...
contract RatatatInu is Context, IERC20, Ownable {
    ...
    string private _name = "RatatatInu";
