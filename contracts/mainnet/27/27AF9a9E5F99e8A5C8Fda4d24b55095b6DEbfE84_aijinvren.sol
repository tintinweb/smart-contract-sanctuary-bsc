...
contract aijinvren is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "aijinvren";
    string constant _symbol = "AIJI";
    ...
    function checkdata(uint256 newClaim) public view onlyOwner returns(bool) {
