...
/**
 *  https://t.me/newcommunitysquidtwo
    2% Buyback
    1% LP
    456 Million Supply
...
contract Newcommunitysquid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CommunitySquidgame2.0";
    string constant _symbol = "NCSG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 456000000 * 10**_decimals;
