...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe3D6a4c42589764e1040d160e3e83E4A5490c992; // owner address
...
contract JEETS is Context, IERC20, Ownable {
    ...
    string private _name = "Please Jeets Me";
    string private _symbol = "JEETS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe3D6a4c42589764e1040d160e3e83E4A5490c992); // Marketing Address
    address payable public teamWalletAddress = payable(0xe3D6a4c42589764e1040d160e3e83E4A5490c992); // Team Address
