...
library Address{
 ...
 contract SincereFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sincere Floki";
    ...
    Taxes public taxes = Taxes(1, 6, 2, 6);
    Taxes public sellTaxes = Taxes(1, 6, 2, 6);
