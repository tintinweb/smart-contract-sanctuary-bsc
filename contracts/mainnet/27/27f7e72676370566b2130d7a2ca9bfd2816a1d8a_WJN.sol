...
contract WJN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WJN";
    string private _symbol = "WJN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf692602B2FCBBFdDa686c7C177D32Dc4dAA881f8); // Marketing Address
    address payable public teamWalletAddress = payable(0xf692602B2FCBBFdDa686c7C177D32Dc4dAA881f8); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xf692602B2FCBBFdDa686c7C177D32Dc4dAA881f8),
            block.timestamp
        );
    }
