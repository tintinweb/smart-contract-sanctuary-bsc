...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xab0C96687571019F1A2679dcAA1a93AB06CE3668;
...
contract SNOWRABBIT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SNWRBT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xab0C96687571019F1A2679dcAA1a93AB06CE3668);
