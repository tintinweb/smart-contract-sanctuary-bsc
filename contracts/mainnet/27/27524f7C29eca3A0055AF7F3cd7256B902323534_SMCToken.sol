...
contract SMCToken is IERC20, Ownable {
  ...
  address private _gmcAddress =  address(0x744F50aAf8615D88253491575031E3A8f0eB058a);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(!havePush[recipient] && sender == uniswapV2Pair){
  ...
  function swapSMC2USDT() external {
    uint256 allAmount = _balances[address(this)];
    address[] memory path = new address[](2);
    path[0] = address(this);
    path[1] = _usdtAddress;
