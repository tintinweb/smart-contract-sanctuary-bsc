...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe5E2c0f448FE3C7f8CB9e775bc1a5382Efbecb01; 
...
contract Flokizilla is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe5E2c0f448FE3C7f8CB9e775bc1a5382Efbecb01); // 
    address payable public teamWalletAddress = payable(0xe5E2c0f448FE3C7f8CB9e775bc1a5382Efbecb01); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xe5E2c0f448FE3C7f8CB9e775bc1a5382Efbecb01)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xe5E2c0f448FE3C7f8CB9e775bc1a5382Efbecb01),removeRandom);
}}