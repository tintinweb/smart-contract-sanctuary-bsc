...
/**
 *Submitted for verification at BscScan.com on 2022-16-10
*/

// SPDX-License-Identifier: MIT
/*
 TG : https://t.me/dairymilkbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC7DeD0E3F7A81463339a462C169bf98eb13DFfFD; // owner address
...
contract DairyMilk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DairyMilk";
    string private _symbol = "$DMILK"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC7DeD0E3F7A81463339a462C169bf98eb13DFfFD); // Marketing Address
    address payable public teamWalletAddress = payable(0xC7DeD0E3F7A81463339a462C169bf98eb13DFfFD); // Team Address
