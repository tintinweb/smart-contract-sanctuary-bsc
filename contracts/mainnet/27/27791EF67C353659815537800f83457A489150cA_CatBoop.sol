...
//          `-.-' \ )-`( , o o)
//                 `-    \`_`"'-
// CAT BOOP IS A CAT BOOP TOKEN OF CATS GETTING BOOPED, BOOP AT OWN RISK
//                     https://t.me/Catboopcoin
...
contract CatBoop is IBEP20, Ownable {
    ...
    string _name = "Cat Boop";
    string _symbol = "BOOP";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1 * 5**12 * (10 ** _decimals);
