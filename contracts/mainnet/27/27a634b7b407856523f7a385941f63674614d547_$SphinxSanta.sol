...
// 
//
// 📱 Telegram:https::https://t.me/+9ov1AuEaTVU2OWM1
/*
...
contract $SphinxSanta is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$Sphinx Santa", "$SphinxSanta") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "$SphinxSanta";
    string private _symbol = "$SphinxSanta";
