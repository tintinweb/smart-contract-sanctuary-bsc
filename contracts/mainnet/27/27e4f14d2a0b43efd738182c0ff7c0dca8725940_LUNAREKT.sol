...
contract LUNAREKT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9d749BE89b21cE956baA86c399697Fcb47484B8a); // Marketing Address
    address payable public featurePaymentAddress =
        payable(0x9d749BE89b21cE956baA86c399697Fcb47484B8a); // Address for paying for product features.
    address payable public constant airDropAddress =
        payable(0x9d749BE89b21cE956baA86c399697Fcb47484B8a); // AirDrop Address
    ...
    string private constant _name = "LunaRekt";
    ...
    uint256 public _maxTxAmount = 3000 * 10**6 * 10**9; // 3,000,000,000 LUNAREKT
