...
// telegram : https://t.me/lunagreenchart
...
contract LunaGreenChart is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Green Chart"; // 
    string private constant _symbol = "$LGC"; //    
