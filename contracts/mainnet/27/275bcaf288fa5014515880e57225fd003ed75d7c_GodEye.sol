...
// telegram : https://t.me/godeyeprotocolbsc
...
contract GodEye is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02A393e1F8A76B4e0D15FA2729b96c517c96379A); 
    address payable public Wallet_Dev = payable(0x02A393e1F8A76B4e0D15FA2729b96c517c96379A);
    ...
    string private constant _name = "godeye protocol"; 
    ...
    constructor () {
        ...
        _owner = 0x02A393e1F8A76B4e0D15FA2729b96c517c96379A;
