...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public airDropNumbs = 2; //自动空投数量
    ...
    constructor (
        ...
        maxTXAmount = 1500 * 10 ** Decimals;
        walletLimit = 1500 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x01e0C4Fab93bEa92fF7788669CA830e1C8f4C1Fc;
...
contract KF is AbsToken {
    constructor() AbsToken(
        ...
        address(0xa8Cd844D165160D5bB9Da904AFEb1bC6fE9D5fF6),
    
        address(0xF7AD641961e520FCb34EAf463b32b35127005F3C)
    ){
