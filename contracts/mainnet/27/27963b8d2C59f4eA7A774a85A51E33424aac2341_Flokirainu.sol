...
/**
Flokira  inu stealth launch

Flokirainu is your next BSC moonshot and a rare BSC gem. Flokirainu is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.
...
pragma solidity ^0.6.12;
    ...
    contract Flokirainu is Context, IERC20, Ownable {
        ...
        string private _name = 'Flokira inu';
        string private _symbol = 'Flokira inu';
