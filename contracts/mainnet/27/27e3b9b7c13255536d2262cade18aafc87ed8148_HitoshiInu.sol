...
/* Token contract */
contract HitoshiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa9f176e36bfC3D9516eBB6ff581caD49EF0c250d;
    ...
    // Name and symbol
    string constant _name = "Hitoshi Inu";
    string constant _symbol = "HITO";
    ...
    uint256 public donationFeeBuy = 0;
    ...
    uint256 public developmentFeeSell = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa9f176e36bfC3D9516eBB6ff581caD49EF0c250d;  
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _donationFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        donationFeeBuy = _donationFeeBuy;
        reflectionFeeBuy = _reflectionFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        developmentFeeBuy = _developmentFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_donationFeeBuy).add(_reflectionFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _donationFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        donationFeeSell = _donationFeeSell;
        reflectionFeeSell = _reflectionFeeSell;
        marketingFeeSell = _marketingFeeSell;
        developmentFeeSell = _developmentFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_donationFeeSell).add(_reflectionFeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
