...
contract BLACKYEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLACK YEAR";
    string private _symbol = "BY2023";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x6B6904F577850C96876Ef105c7cE4212cEe0478b); 
