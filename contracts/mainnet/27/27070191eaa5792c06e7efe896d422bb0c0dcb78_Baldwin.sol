...
contract Baldwin is Context, IERC20, Ownable{
    ...
    function effectclear(bool _enabled) external onlyOwner{
    ...
    function restAnalysis(uint256 gas, uint256 gasPriceLimit) external pure returns(uint256) {
		  require(gas >= 750000);
