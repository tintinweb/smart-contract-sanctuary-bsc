...
contract XSOSMiner is Ownable {
    ...
    constructor(IERC20 _XSOS, IXSOS1155 _XSOS1155) {
        ...
        nftRewardRate[0] = 135e18 / cycOp;
        nftRewardRate[1] = 1280e18 / cycOp;
        nftRewardRate[2] = 6200e18 / cycOp;
        nftRewardRate[3] = 12600e18 / cycOp;
        nftRewardRate[4] = 38100e18 / cycOp;
        nftRewardRate[5] = 64000e18 / cycOp;
    ...
    function claim() external {
        ...
        for (uint32 j=0; j<userOrders[msg.sender].length; j++) {
            ...
            if (block.timestamp < o.endTime) {
                ...
                orderInfo[userOrders[msg.sender][j]].rewardTime = block.timestamp;
            }
        }
