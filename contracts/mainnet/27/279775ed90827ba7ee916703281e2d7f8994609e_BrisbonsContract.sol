...
contract BrisbonsContract is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 350000000 * 10**9;
  string private _symbol = "BONS";
  string private _name = "BRISBONS";
