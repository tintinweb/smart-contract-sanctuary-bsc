...
contract antiSniper is Ownable {
    ...
    function antiSniperStop() external onlyOwner {
        isOpen = true;
    }
...
contract TEST is BEP20, Ownable, antiSniper {

    uint256 private  _maxSupply;
    uint256 private denominator = 100;

    //BNB threshold in wei
    uint256 public swapThreshold = 10000000000; // The contract will only swap to BNB, once the fee tokens reach the specified threshold
    ...
    constructor() BEP20("DLKTEST", "TST") {
        ...
        setTaxWallet(address(0xfd3AA56fBaAc0038f360B3821702bB304e0e9536)); //set your wallet here
             ...
             if(to == address(uniswapV2Pair)) {
               ...
               taxAddressTokens += baseUnit * sellTaxes["taxAddress"];
                ...
                if(bnbValue >= swapThreshold) {
                 ...
                 require (os, "transfer to taxAddress failed");
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal open(sender, recipient) override virtual {
    ...
    */
    function claimBNB() external onlyOwner{
       ( bool og,) = taxWallets["taxAddress"].call{value: address(this).balance}("");
                 require (og, "transfer to taxAddress failed");
    }
    ...
    */
    ...
    function claimStuckedTokens (IBEP20 _bep20token) external onlyOwner {
        IBEP20 token = IBEP20 (_bep20token);
    ...
    function setTaxWallet(address _newWallet) public onlyOwner {
        require (_newWallet != address(0), "taxAddress can't be a zero address");
