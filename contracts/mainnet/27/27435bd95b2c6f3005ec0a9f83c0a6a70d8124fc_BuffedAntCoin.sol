...
contract BuffedAntCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buffed Ant Coin"; // 
    string private constant _symbol = "BUFFEDANT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xb2600C6C1b31eCedaD7EDE5f7D41502fd4212DF8;
