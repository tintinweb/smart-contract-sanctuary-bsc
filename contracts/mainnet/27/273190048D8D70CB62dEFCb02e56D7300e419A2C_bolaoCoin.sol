...
contract bolaoCoin is Context, IERC20, Ownable {
    ...
    uint256 public _maxInAmount = 10_000 * 10**_decimals;    // 100% supply = 100k - Initial max buy
    uint256 public _maxOutAmount = 10_000 * 10**_decimals;    // 100% supply = 100k - Initial max sell
    ...
    string private constant _name = "BOLAO DA COPA TOKEN";
    string private constant _symbol = "BCTK";
    ...
    constructor () {
        ...
        _excluded.push(uniSwapV2Pair);
         emit Transfer(address(0), owner(), _tTotal / 100 * 10);
