...
/*
//Telegram: https://t.me/Spookinomics
...
contract Spookinomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spookinomics"; 
    string private constant _symbol = "Spookinomics";
    ...
    Tax public buyTax = Tax(6,2,2);
    Tax public sellTax = Tax(10,4,4);
    
    address private marketingWallet = 0xa111F1E3c6640fe074bDdBFC4B1DdFE3D58D4F02;
    address private devWallet = 0xa111F1E3c6640fe074bDdBFC4B1DdFE3D58D4F02;
    address private LPWallet = 0xa111F1E3c6640fe074bDdBFC4B1DdFE3D58D4F02;
...
// ============ View Functions ============== //
    ...
    function taxWallets() public view returns(address marketing,address developer,address LP){
        return(marketingWallet,devWallet,LPWallet);
    }
...
//============== Owner Functions ===========//
    ...
    function owner_setSellTaxes(uint8 marketingTax, uint8 devTax, uint8 lpTax) external onlyOwner{
        uint tTax = marketingTax + devTax + lpTax;
        require(tTax <= 95, "Can't set tax too high");
    ...
    function owner_setWallets(address newMarketingWallet, address newDevWallet, address newLPWallet) public onlyOwner{
