...
/**
/LFG
Telegram https://t.me/Mecharise_official
WEBSITE: Mecharise.io
*/
...
contract Mechadesigner is IBEP20, Auth {
    ...
    string constant _name = "Mechadesigner";
    string constant _symbol = "MDESIGN";
    ...
    address private marketingFeeReceiver =0x891b69f4B2abA8BE6129D1303D657D55F47EC552;
    address private teamFeeReceiver =0x891b69f4B2abA8BE6129D1303D657D55F47EC552;
    ...
    uint256 public swapThreshold = _totalSupply / 70 * 3; // 0.3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0x891b69f4B2abA8BE6129D1303D657D55F47EC552;
