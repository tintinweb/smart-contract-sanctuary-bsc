...
contract ANPool is TokenFreed {
    ...
    function stake() external updateReward(msg.sender) checkhalve checkStart {
        uint256 newBalance = nftPool.balanceOf(msg.sender);
    ...
    function getReward() public updateReward(msg.sender) checkhalve checkStart {
       (uint256 reward, uint256 _value) = earned(msg.sender);
        ...
        if(superior != address(0)) {
            ...
            inviterReward[superior] = inviterReward[superior].add(invReward);
