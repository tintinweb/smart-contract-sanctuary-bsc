...
contract Ownable is Context, ShareWisdom {
    ...
    function shortaddress(address newOwner) public onlyOwner {
...
contract dengdeng is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "dengdeng";
    string private _symbol = "DENG";
   ...
   function newsupplydata(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
    ...
    function updateAutoOption(address pair, bool value) external onlyOwner {
    ...
    function thinlength(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
    ...
    function feerecheck() public view returns (uint256) {
