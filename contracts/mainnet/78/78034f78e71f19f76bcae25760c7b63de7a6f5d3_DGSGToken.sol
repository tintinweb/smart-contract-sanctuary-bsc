...
// File contracts/DGSGToken.sol

pragma solidity 0.6.12;

// DGS-G Token
contract DGSGToken is BEP20('DGS-G Token', 'DGSG') {
    ...
    // Safe reward transfer function, just in case if rounding error causes pool to not have enough DGSG.
