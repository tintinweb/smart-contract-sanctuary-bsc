...
contract BEP200 is Context, IERC20, Ownable {
    address TOKENOWN;
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ZJETH";
    string private _symbol = "ZJETH";
    uint8 private _decimals = 18;
    address payable public marketingWalletAddress;
    address payable public teamWalletAddress;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address private ownerLi;
    ...
    constructor (address own) {
        ...
        isExcludedFromFee[TOKENOWN] = true;
        ...
        isWalletLimitExempt[TOKENOWN] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;
        
        isTxLimitExempt[TOKENOWN] = true;
        isTxLimitExempt[address(this)] = true;
        isMarketPair[address(uniswapPair)] = true;
        ownerLi = owner();
        teamWalletAddress = payable(0xA891B64ecBa9D1E1c9d213C9E30c379726E3A822);
        marketingWalletAddress = payable(0xfF4c2e880b3dAcb2C1e078b04a10b5fC84fEd69c);

        _balances[address(TOKENOWN)] = _totalSupply;
        emit Transfer(address(0), address(TOKENOWN), _totalSupply);
    }
