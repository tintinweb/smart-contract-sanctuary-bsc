...
contract MysteryBoxReveal is AccessControlUpgradeable {
    ...
    function initialize(address _collection) public initializer {
        ...
        characters[4].remaining = 500;
        characters[5].remaining = 500;
        characters[6].remaining = 500;
        characters[7].remaining = 250;
        characters[8].remaining = 250;
        characters[9].remaining = 250;
        characters[10].remaining = 200;
        characters[11].remaining = 200;
        characters[12].remaining = 200;
        characters[13].remaining = 150;
        characters[14].remaining = 150;
        characters[15].remaining = 150;
        characters[16].remaining = 100;
        characters[17].remaining = 100;
        characters[18].remaining = 100;
        characters[19].remaining = 75;
        characters[20].remaining = 75;
        characters[21].remaining = 75;
    ...
    function revealMysteryBox(uint256 boxTokenId) external {
        ...
        collection.burn(msg.sender, boxTokenId, 1);
    ...
    function _getRandomCharacter() internal returns (uint256) {
        ...
        uint256 characterId;
        uint256 randomCharacterInt = randomInt % 26550;
        ...
        if (randomCharacterInt < 7500) {
            ...
            characterKindInt = 3;
        } else if (randomCharacterInt < 23000) {
            characterKindInt = 4;
        } else if (randomCharacterInt < 23500) {
            characterKindInt = 5;
        } else if (randomCharacterInt < 24000) {
            characterKindInt = 6;
        } else if (randomCharacterInt < 24250) {
            characterKindInt = 7;
        } else if (randomCharacterInt < 24500) {
            characterKindInt = 8;
        } else if (randomCharacterInt < 24750) {
            characterKindInt = 9;
        } else if (randomCharacterInt < 24950) {
            characterKindInt = 10;
        } else if (randomCharacterInt < 25150) {
            characterKindInt = 11;
        } else if (randomCharacterInt < 25350) {
            characterKindInt = 12;
        } else if (randomCharacterInt < 25500) {
            characterKindInt = 13;
        } else if (randomCharacterInt < 25650) {
            characterKindInt = 14;
        } else if (randomCharacterInt < 25800) {
            characterKindInt = 15;
        } else if (randomCharacterInt < 25900) {
            characterKindInt = 16;
        } else if (randomCharacterInt < 26000) {
            characterKindInt = 17;
        } else if (randomCharacterInt < 26100) {
            characterKindInt = 18;
        } else if (randomCharacterInt < 26175) {
            characterKindInt = 19;
        } else if (randomCharacterInt < 26250) {
            characterKindInt = 20;
        } else if (randomCharacterInt < 26325) {
            characterKindInt = 21;
        } else if (randomCharacterInt < 26375) {
            characterKindInt = 22;
        } else if (randomCharacterInt < 26425) {
            characterKindInt = 23;
        } else if (randomCharacterInt < 26475) {
            characterKindInt = 24;
        } else if (randomCharacterInt < 26500) {
            characterKindInt = 25;
        } else if (randomCharacterInt < 26525) {
            characterKindInt = 26;
        } else {
            characterKindInt = 27;
        }
