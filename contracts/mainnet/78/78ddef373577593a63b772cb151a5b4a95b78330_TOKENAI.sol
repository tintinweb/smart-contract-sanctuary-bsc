...
contract TOKENAI is Context, IERC20, Ownable {
    ...
    string private _name = "TOKEN AI";
    string private _symbol = "$TAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x135A8097B3869122B1e4a408f533aD3602Ec864e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x135A8097B3869122B1e4a408f533aD3602Ec864e); // BuyBack Address
