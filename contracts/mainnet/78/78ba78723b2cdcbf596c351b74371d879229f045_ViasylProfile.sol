...
*/
contract ViasylProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IERC20 public pykaToken;
    ...
    uint256 public numberPykaToReactivate;
    uint256 public numberPykaToRegister;
    uint256 public numberPykaToUpdate;
    ...
    constructor(
        IERC20 _pykaToken,
        uint256 _numberPykaToReactivate,
        uint256 _numberPykaToRegister,
        uint256 _numberPykaToUpdate
    )
    {
        pykaToken = _pykaToken;
        numberPykaToReactivate = _numberPykaToReactivate;
        numberPykaToRegister = _numberPykaToRegister;
        numberPykaToUpdate = _numberPykaToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends PYKA to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer PYKA tokens to this contract
        pykaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberPykaToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer PYKA token to this address
        pykaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberPykaToUpdate
    ...
    /**
     * @dev Claim PYKA to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        pykaToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of PYKA to register
     * Callable only by owner admins.
     */
    function updateNumberPyka(
        uint256 _newNumberPykaToReactivate,
        uint256 _newNumberPykaToRegister,
        uint256 _newNumberPykaToUpdate
    ) external onlyOwner {
        numberPykaToReactivate = _newNumberPykaToReactivate;
        numberPykaToRegister = _newNumberPykaToRegister;
        numberPykaToUpdate = _newNumberPykaToUpdate;
    }
