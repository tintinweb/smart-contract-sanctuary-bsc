...
contract LITTLESNAKE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LITTLE SNAKE"; // 
    string private constant _symbol = unicode"LILSNAKE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x9ff3A610c1A65EdaAFed73fE18b1fac69e6A8AE9;
