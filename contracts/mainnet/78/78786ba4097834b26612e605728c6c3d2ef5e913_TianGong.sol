...
contract TianGong is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "TianGong";
  string constant _symbol = "TianGong";
  ...
  uint256 public _maxTxAmount = ( INITIAL_FRAGMENTS_SUPPLY * 1 )  / 100;
  uint256 public _maxWalletToken = ( INITIAL_FRAGMENTS_SUPPLY * 1 )  / 100;
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0xF5D129F919698CD374bdEaC430B04A5C3e3D11F7;
  ...
  function setTxLimit(uint256 maxTxPercent) external authorized() {
