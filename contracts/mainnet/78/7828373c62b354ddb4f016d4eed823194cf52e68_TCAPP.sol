...
contract TCAPP is BEP20, Ownable {
    ...
    address public treasuryWallet = 0x36D3170a6CE49EfcE19682210F3B92D65B76A2Dd;
    address public devWallet = 0x36D3170a6CE49EfcE19682210F3B92D65B76A2Dd;
    ...
    Taxes public taxes = Taxes(6, 2, 0);
    ...
    constructor() BEP20("Tournamental Crypto", "TCAPP") {
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_treasury, _liquidity, _dev);
        require((_treasury + _liquidity + _dev) <= 12, "Must keep fees at 12% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_treasury, _liquidity, _dev);
        require((_treasury + _liquidity + _dev) <= 12, "Must keep fees at 12% or less");
    }
