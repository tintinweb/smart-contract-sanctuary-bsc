...
contract ShinjiraInu is IBEP20, Auth {
    ...
    string constant _name = "Shinjira Inu";
    string constant _symbol = "ShinjiraInu";
    ...
    function KILLBOTS() external onlyOwner{
