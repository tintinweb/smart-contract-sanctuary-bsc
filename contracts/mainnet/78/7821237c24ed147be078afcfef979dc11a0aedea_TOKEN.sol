...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 20000 * 10** Decimals;
        maxSellAmount = 20000 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x46317306558613fADe9f797bC21a916154DDC3C7;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"ShibKing Dao",//Name
        unicode"ShibDao",//Symbol
        9,//Decimals
        1000000,//Supply
        address(0x46317306558613fADe9f797bC21a916154DDC3C7),//FundAddress
        address(0x46317306558613fADe9f797bC21a916154DDC3C7)//ReceiveAddress
    ){
    }
}