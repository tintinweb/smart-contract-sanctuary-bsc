...
//
//
//   📱Telegram::https://t.me/WikiDoge
//   📱Website :: https://WikiDoge.io
/*
...
contract WikiDoge is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("WikiDoge", "WikiDoge") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WikiDoge";
    string private _symbol = "WikiDoge";
