...
contract TeddyDoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TeddyDoge";
    string private _symbol = "TeddyDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDa3AA667ABda7f89Cf3A1C429F8C7C62453a59C3);
