...
Dione Protocol
@DioneProtocol
DIONE Wallet, DIONE Swap, DIONE Blockchain | A New Power in Charge | Powering the Crypto Revolution with Renewable Energy
Shib
@Shibtoken
Welcome to the Official Twitter Account for the Shiba Inu Ecosystem. $SHIB $LEASH $BONE #SHIBOSHIS
*/
...
contract DioneBONE is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Dione BONE';
    string private _symbol = '$DioneBONE';
