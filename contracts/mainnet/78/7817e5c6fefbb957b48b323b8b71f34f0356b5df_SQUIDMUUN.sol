...
contract SQUIDMUUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidMuun";
    string private _symbol = "SQUIDMUUN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xAF08E8B61799ef5b4a914284F7D9D80eCE28c475); 
    address payable public BurnedWalletAddress = payable(0xAF08E8B61799ef5b4a914284F7D9D80eCE28c475); 
    ...
    function setTax(uint256 value) onlyOwner public {
         _totalTaxIfSelling = value;
        } 
