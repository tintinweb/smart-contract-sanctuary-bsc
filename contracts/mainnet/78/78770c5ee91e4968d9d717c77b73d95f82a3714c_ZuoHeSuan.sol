...
contract  ZuoHeSuan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZuoHeSuan" ;
    string private _symbol = "ZuoHeSuan";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF9B342046B7AF6F610aEaa7ae1026c59FeDFa5c6);
    address payable public teamWalletAddress = payable(0x2886487fd3A46b7f2D412BCd169D82CC47B13c66);
