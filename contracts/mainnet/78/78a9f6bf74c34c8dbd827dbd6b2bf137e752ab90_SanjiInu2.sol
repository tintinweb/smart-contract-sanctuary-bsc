...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x092717f905526f4cff4D51d76a62f8D591B7acf2; 
...
contract SanjiInu2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Sanji Inu 2.0 ";
    string private _symbol = " Sanji2.0 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x092717f905526f4cff4D51d76a62f8D591B7acf2); // 
    address payable public teamWalletAddress = payable(0x092717f905526f4cff4D51d76a62f8D591B7acf2); // 
