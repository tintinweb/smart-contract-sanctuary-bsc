...
contract SQPAMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidPamp"; // 
    string private constant _symbol = "SQPAMP "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x99dB0B62D050F1CFd2e8bAfF653C46CE3701cDAc;
