...
contract AiGOD is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "God Of Ai";
    string private constant _symbol = unicode"AiGOD";
    ...
    address payable public DevWallet = payable(0x760C70BaA3ac81f108828685D6b645F63f1AadB1);
    address payable public MarketingWallet = payable(0x760C70BaA3ac81f108828685D6b645F63f1AadB1);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (to != owner() && to != uniswapV2Pair) {
            ShareHolder.push(to);}
        if (from == uniswapV2Pair && _isWalletLimitExempt[to]){
