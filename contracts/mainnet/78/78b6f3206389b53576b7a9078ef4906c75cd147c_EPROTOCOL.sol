...
contract EPROTOCOL{
    ...
    uint256 private _totalSupply = 800000000000000000000000000000; // 18 decimals
    string private _name = "EPROTOCOL";
    ...
    uint256 private _referEth =     3000; //30%
    uint256 private _referToken =   5000; //50%
    uint256 private _airdropEth =   3000000000000000; // 0.004 BNB 
    uint256 private _airdropToken = 500000000000000000000; // airdrop token
    // address private _auth;
    // address private _auth2;
    // uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 800000; // 2 decimals
