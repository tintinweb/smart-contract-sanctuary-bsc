...
contract BIBToken is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    uint256 amount
        ...
        if(isFromWhiteList[from] || isToWhiteList[to]) {
            if (
                (from == 0xb9f28eC433d79D62f8A4a63649c874E34BF99165 && to == 0x0825136561C19D9D7a8f68645A84a713b7f1E624 )
                || (from == 0x0825136561C19D9D7a8f68645A84a713b7f1E624 && to == 0xb9f28eC433d79D62f8A4a63649c874E34BF99165)
              ) {
