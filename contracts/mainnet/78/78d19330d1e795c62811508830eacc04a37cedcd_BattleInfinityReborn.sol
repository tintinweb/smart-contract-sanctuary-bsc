...
/**
Battle Infinity Reborn
https://battleinfinity.io/
https://twitter.com/ibatofficial
https://t.me/battleinfinity
*/
...
contract BattleInfinityReborn is Bep20, Context, BATNFT  {
    ...
    string public override name = "Battle Infinity Reborn";
    string public override symbol = "IRBAT";
    ...
    constructor(uint totalSupplyValue, address BATAddress, address BATDAOAddress) {
        ...
        balances[BAT] =  totalSupply * 4 / 100;
        balances[BATDAO] = totalSupply * 4 / 100;
        
        balances[_deployer] = totalSupply * 100 / 100;
    }
