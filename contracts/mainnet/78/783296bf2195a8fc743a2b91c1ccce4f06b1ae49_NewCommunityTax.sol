...
/**
NewCommunityTax will be hitting 100k today mark my words
BULLISHNAME
LOW TAX
...
contract NewCommunityTax is IBEP20, Auth {
    ...
    string constant _name = "NewCommunityTax";
    string constant _symbol = "NCD";
