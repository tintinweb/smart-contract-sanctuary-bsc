...
BabySheikhInu - ONE and ONLY baby token of SheikhInu $SHINU

4% $SHINU rewards to EVERYONE!

Telegram - https://t.me/BabySheikhInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHEIKH = IBEP20(0xE5b5d4Bea7468B4994FA676949308a79497aa24c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SHEIKH.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SHEIKH);
        ...
        uint256 amount = SHEIKH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SHEIKH.transfer(shareholder, amount);
...
contract BabySheikhInu is IBEP20, Auth {
    ...
    address DEV = 0x9bD57Bbed8A2208bE454FFBa9dC2DeC3D82f18e3;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "BabySheikhInu";
    string constant _symbol = "$BSHINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x9bD57Bbed8A2208bE454FFBa9dC2DeC3D82f18e3;
