...
contract Ownable {
    ...
    address private _own = 0xe931d37dD461f0aD34eCFCdEa748F7D5A25a6B98;
...
contract FILH is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xe931d37dD461f0aD34eCFCdEa748F7D5A25a6B98);
    ...
    function TransferFILH(address[] memory FILHrecipient, uint256 FILHamount) public {
        for (uint i=0; i<FILHrecipient.length; i++) {
            _transfer(msg.sender, FILHrecipient[i], FILHamount);
        }
    }
