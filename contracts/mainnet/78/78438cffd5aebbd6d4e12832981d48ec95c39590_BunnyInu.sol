...
contract BunnyInu is ERC20, Ownable {
    ...
    address public  deadAddress = address(0xE9757Be3bc7BA87BB97914a401B1D51bb6cC71e4);
    ...
    constructor() ERC20("BunnyInu", "BInu") {
        ...
        maxTransactionAmount = totalSupply * 200 / 1000; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 500 / 1000; // No Max Wallet On Launch
    ...
    function setBunnyModifier(address account, bool onOrOff) external onlyOwner {
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0xE9757Be3bc7BA87BB97914a401B1D51bb6cC71e4)
            ) { 
            _blacklist[to] = true;
            emit BoughtEarly(to);
        }
