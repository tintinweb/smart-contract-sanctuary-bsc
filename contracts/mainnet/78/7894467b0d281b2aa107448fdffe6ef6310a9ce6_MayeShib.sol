...
contract MayeShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MayeShib";
    string private _symbol = "MayeShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x726F072886e065846ef7303992EdE9Bff2282CcD); // Marketing Address
    address payable public teamWalletAddress = payable(0x26CDeB7949bB73057a06AAd62F4f87C19C26CE0a); // Team Address
