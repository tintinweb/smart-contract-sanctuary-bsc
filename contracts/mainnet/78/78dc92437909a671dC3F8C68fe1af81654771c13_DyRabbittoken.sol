...
contract DyRabbittoken is Context, IERC20, Ownable {
	...
	constructor (address _ceoadd, address _cfoAddress, address _dyzRadd, address _bnbRadd) {
		CeoAddress = _ceoadd;
	...
	function setdyzRadd(address _dyzRadd) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		dyzRadd = _dyzRadd;
	}
	function setbnbRadd(address _bnbRadd) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		bnbRadd = _bnbRadd;
	}  
	...
	function setBnbFee(uint256 _value) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		require(_value>0, "Err: error value");
		require(_value<100, "Err: error value");
		_swapbnb = _value;
	}
	function setDyzFee(uint256 _value) public {
		require(msg.sender==CeoAddress, "Err: error ceo");
		require(_value>0, "Err: error value");
		require(_value<100, "Err: error value");
		_swapdyz = _value;
