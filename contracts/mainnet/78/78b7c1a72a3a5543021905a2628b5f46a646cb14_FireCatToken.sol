 ...
 */
contract FireCatToken is Ownable, ERC20 {
    constructor(
        address safeAccount,
    ...
    * @dev these tokens are deposited into the owner address.
    ...
    */
    function issue(uint256 amount) external onlyOwner {
        ...
        require(totalSupply() + _amount > totalSupply(), "issue overflow");
        require(balanceOf(owner()) + _amount > balanceOf(owner()), "issue overflow");
