...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xACce3162Fc2A59232F973a34f3FecFD4CeD9c625;
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract YDMProtocol is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA793B702D6EB450ab954114295ACEdC38E259102;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "YDM Protocol";
    string private _symbol = "YDMP";
