...
contract  BabyDefi is ERC20 {
   ...
   bool public swappingTwo;
    ...
    mapping(address => bool) public isbook;
      uint256 private _maxTxAmount = 1 * 10**10 * 10**2;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     address public owe = 0x257De903945b1ea4a1d9451FDE09187E6E671457;
   ...
   address  private ererer = 0x80E1D6d9063C3C0CE159F387773A52F33C890b63;
    ...
    constructor() public ERC20("BabyDefi", "BabyDefi",2) {
