...
Kawaii and Waifu become one! There will be a huge marketing with upcoming utility where you can stake your own token $Kawaiifu! 
...
Tokenomics -
3% Kawaii Reflections
4% Marketing
3% Liquidity

Telegram : https://t.me/KawaiiWaifuBSC
Website : Kawaiifu.org (Viewable on July 8, 2022 | 13:00 UTC)
...
*/
    ...
    contract Kawaiifu  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Kawaii-Waifu";
        string private constant _symbol = "Kawaiifu";
        ...
        address public constant MarketingWallet=0xcD453751f3c027F6c44510B0b61f94bcDe4E3143; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function KawaiiReflections(address[] calldata addresses) external onlyOwner {
