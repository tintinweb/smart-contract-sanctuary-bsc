...
contract Socialsquid is Context, IERC20, Ownable {
    ...
    string private _name = "Socialsquid";
    string private _symbol = "SCS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb210289de74AC2E708255Dbb6Cc4b4EDcE63146E);
    address payable public liqWalletAddress = payable(0xb210289de74AC2E708255Dbb6Cc4b4EDcE63146E);
