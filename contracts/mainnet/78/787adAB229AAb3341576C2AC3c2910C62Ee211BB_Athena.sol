...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x5f8E012aA0d280ec15Aa141b6B25Eb7C19925B65;    
...
contract Athena   is AbsToken {
    constructor() AbsToken(
        ...
        address(0x5f8E012aA0d280ec15Aa141b6B25Eb7C19925B65),  //营销
    
        address(0x7121eE9C8f75d16047a635D5d16A85Be639a9958) //代币接收地址
    ){
