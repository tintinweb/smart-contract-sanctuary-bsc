...
/**
Have a strong family community building and deep committed desire to Pika Bat again 
*/
...
contract PikaBat  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pika Bat";
    string private _symbol = "PIKABAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3bb272AbF0F98cB5FD229c39c24c0a7537C95498);
    address payable public teamWalletAddress = payable(0x2B03De44710376be283e784CD05f620183cB1D9d); 
