...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdAc9637f4939cCAD2DDCF5a30A2Dd61C0B7733d7;
...
contract GALAHYPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "GALA HYPE"; // 
    string private constant _symbol = "GALA HYPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xdAc9637f4939cCAD2DDCF5a30A2Dd61C0B7733d7);
