...
contract Kabosu is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x5A2a647605656D06aDEF2Cc9535a8D8AF95e849c); 
    address payable private teamWalletAddress = payable(0x391FcbBbec3A798c5A3b143d2A1F91CF0b83926B); 
    ...
    function sB(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
	   require(newLiquidityTax <= 3, "Total fee is over 3%");
	   require(newMarketingTax <= 3, "Total fee is over 3%");
	   require(newTeamTax <= 3, "Total fee is over 3%");
        _buyLiquidityFee = newLiquidityTax;
        _buyMarketingFee = newMarketingTax;
        _buyTeamFee = newTeamTax;
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyTeamFee);
        require(_totalTaxIfBuying <= 8, "Total fee is over 8%");
    }
    ...
    function sS(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
	   ...
	   require(newTeamTax <= 3, "Total fee is over 3%");
        ...
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee);
        require(_totalTaxIfSelling <= 8, "Total fee is over 8%");
    }
