...
contract TweemsInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tweems Inu";
    string private _symbol = "TWINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x731f78149F84F8FB81269481c36cDe2E1fBD5625); 
    address payable public DevWalletAddress = payable(0x731f78149F84F8FB81269481c36cDe2E1fBD5625); 
