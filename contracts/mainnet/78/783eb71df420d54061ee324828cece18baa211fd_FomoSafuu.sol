...
contract FomoSafuu is ERC20Detailed, Ownable {
    ...
    string public _name = "FomoSafuu";
    string public _symbol = "FOMOS";
    ...
    constructor() ERC20Detailed("FomoSafuu", "FOMOS", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x609a74459ACf3053D20542eD648b18138Ad90dE0;
        treasuryReceiver = 0x296E755D2622A253D5BaaFA582d40aA7879b87bb; 
        safuuInsuranceFundReceiver = 0xd17Bc6123A197642D3944d0DA106342CEFBB7009;
        firePit = DEAD;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            if (_isBot[sender]) {
                ...
                _treasuryFee = _treasuryFee.add(botFee);
            }
            _totalFee = _totalFee.add(sellFee);
            _treasuryFee = _treasuryFee.add(sellFee);
        }
