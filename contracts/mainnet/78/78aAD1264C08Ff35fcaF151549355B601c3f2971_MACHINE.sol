...
Telegram : https://t.me/machineelvesofficial
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10CAB6F9e2E9C57f0538593EBBD27B700F5c81c5;
...
contract MACHINE is Context, IERC20, Ownable {
    ...
    string private constant _name = "MACHINE ELVES"; // 
    string private constant _symbol = "$MACHINE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x10CAB6F9e2E9C57f0538593EBBD27B700F5c81c5);
