...
/* ! ./---       ! https://t.me/squidgrow2k23official
   !  ! \   \    ! 
   !  ! ?   /    ! 
   !      /      !
   !   \  \      !
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x181Fdd39D18361197A13232432f217c28e34B0d0; // whatDOGE
...
contract Squidgrow2k23 is Context, IERC20, Ownable {
    ...
    string private _name = "Squidgrow 2k23";
    string private _symbol = "SG2k23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x181Fdd39D18361197A13232432f217c28e34B0d0); // Marketing Address
    address payable public teamWalletAddress = payable(0xfe1b29446FbA59c4Dcd7eb25088aC27b9373762a); // 
