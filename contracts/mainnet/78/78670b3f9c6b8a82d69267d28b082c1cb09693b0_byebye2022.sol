...
*/
//2022 coming to an end, this coin is to remember all the good moments and memories that we lived this year. 
//https://t.me/byebye2022BSC
//
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x50D0869388a840cA0BF928e868D04115C69A11d2;
...
contract byebye2022 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Bye Bye 2022"; 
    string private constant _symbol = unicode"BB2022"; 
    ...
    uint256 public _maxWalletToken = 100 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x50D0869388a840cA0BF928e868D04115C69A11d2), BNB_Tot);
            }
