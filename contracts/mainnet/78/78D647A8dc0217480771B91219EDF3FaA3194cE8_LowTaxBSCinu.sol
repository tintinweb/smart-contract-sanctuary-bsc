...
/**
 Telegram: https://t.me/LowTaxBSCinuPortal
*/
...
contract LowTaxBSCinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6847FF446434d18b7AE7bA7394A488521231F03F); 
    address payable public Wallet_Dev = payable(0x70E6616700f12dCBad902c809548B9159EEb964a);
    ...
    string private constant _name = "LowTaxBSCinu"; 
    string private constant _symbol = unicode"LOWTAXINU"; 
