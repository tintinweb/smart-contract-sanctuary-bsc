...
contract LEARN is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public rewardYield = 24000000;
    uint256 public rewardYieldDenominator = 10000000000;
    uint256 public rebaseFrequency = 10800;
    ...
    constructor() ERC20Detailed("Let\'s Earn", "LEARN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x3D0b414AA47358c7217384E1dd7874D961Df5E7c;
        TreasuryReceiver = 0x07CA5360365e0C4A66617d898d330BC2A08c328f;
        RiskFreeValueReceiver = 0xe2a35593613f8e6cA8c7746678F261c4C166D6BD;
