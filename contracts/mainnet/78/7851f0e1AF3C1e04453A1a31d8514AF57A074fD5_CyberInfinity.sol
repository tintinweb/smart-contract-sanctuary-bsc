...
Telegram : https://t.me/CyberInfinityOfficial
*/
...
contract CyberInfinity is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CyberInfinityDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CyberInfinity", "INFINITY") {
        marketingWallet = payable(0x939684D4ef65F1445165940576a4d09e515dfDAA);
        ...
        dividendTracker = new CyberInfinityDividendTracker(
            payable(this),
            router,
            0xdAC17F958D2ee523a2206206994597C13D831ec7,
            "CyberInfinityTRACKER",
            "CyberInfinityTRACKER"
        );
...
contract CyberInfinityDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CyberInfinity public CyberInfinityContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CyberInfinityContract = CyberInfinity(mainContract);
    ...
    function _transfer(
        ...
        require(false, "CyberInfinity_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CyberInfinity_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CyberInfinity contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CyberInfinityContract);

            uint256 prevBalance = CyberInfinityContract.balanceOf(address(this));
            ...
            {
                uint256 received = CyberInfinityContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CyberInfinityContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
