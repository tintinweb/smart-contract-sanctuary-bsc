...
library Address{
 ...
 contract zerox51  is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4e81CFd98F341d770fc409148B3BaB5e7c6bd580;
    address public donationWallet = 0x4e81CFd98F341d770fc409148B3BaB5e7c6bd580;

    string private constant _name = "0X51";
    string private constant _symbol = "0X51";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 5, 15);
