...
contract lamian is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "lamian";
    string constant _symbol = "LAMIAN";
   ...
   function takeaddressTransfer(
    ...
    function timestamp(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
