...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5db5fe6086d8cBbB5671F171B35C88A48b5cb374; // owner address
...
contract SuperTateInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Super Tate Inu";
    string private _symbol = "STATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5db5fe6086d8cBbB5671F171B35C88A48b5cb374); // Marketing Address
    address payable public teamWalletAddress = payable(0x5db5fe6086d8cBbB5671F171B35C88A48b5cb374); // Team Address
