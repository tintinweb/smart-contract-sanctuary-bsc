...
/**
    ...
    We are community driven - the biggest utility meme on Binance smart chain.
    We will be delivering the very first automated security bot for Discord and NFT projects.

    tg      : https://t.me/MegamanInuBsc2
*/
...
contract MegamanInuTwo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF827Aa35d26379dfeFB43233e3fAAB1aaB81f3ed);
    address payable public teamWalletAddress = payable(0xF827Aa35d26379dfeFB43233e3fAAB1aaB81f3ed);
    ...
    string private _name = "Megaman Inu 2.0";
    string private _symbol = "MegamanInuTwo";
