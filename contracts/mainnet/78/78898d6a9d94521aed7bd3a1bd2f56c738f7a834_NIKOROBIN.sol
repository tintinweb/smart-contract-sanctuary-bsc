...
contract NIKOROBIN is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 51234 * 10**_decimals;
    uint256 public maxTxAmount = 500000 * 10**_decimals;
    uint256 public maxWalletAmount = 500000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x6BdF53D1216007FfB57b782582198b4c3CC2884D ;

    string private constant _name = "NIKO ROBIN INU";
    string private constant _symbol = "NIKOROBIN";
