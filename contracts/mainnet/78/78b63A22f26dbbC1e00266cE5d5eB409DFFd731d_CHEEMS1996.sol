...
contract CHEEMS1996 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9A5315adF1070991A943a60E9B373933B2dE4403); 
    address payable public Wallet_Dev = payable(0xdc0E58264125Da42C00f541E6333646f723061C3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Cheems 1996"; 
    string private constant _symbol = unicode"CHEEMS96";
