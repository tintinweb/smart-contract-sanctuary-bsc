...
contract Milobabydoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Milobabydoge";
    string private _symbol = "Milobabydoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87180Aa0a176864015942CfdaE22D6D3d999315b); // Marketing Address
    address payable public teamWalletAddress = payable(0xb49A3B6E768aeF37Fd7fa2B6b8e5EBA2ce1D5d4A); // Team Address
