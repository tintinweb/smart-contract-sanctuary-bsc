...
Tax distribution: Buy 3% / Sell 3%
*/

//Telegram : https://t.me/Wildislandhispanoamerica
//Website : https://www.wildislandnft.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xc355030f2E344ec9Bb259099DE92551B36268B63;
...
contract WildIslandGame is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Wild Island Game"; 
    string private constant _symbol = unicode"WILD"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xc355030f2E344ec9Bb259099DE92551B36268B63), BNB_Tot);
            }
