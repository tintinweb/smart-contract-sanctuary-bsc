...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBD58477D5596446A351E8D4B80e0Ba56Fe949F18; // owner address
...
contract Kfcpepes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KFCPepes";
    string private _symbol = "PEPES";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x59B7B296648e1D729f7e240E094736C1AE54a66b); // Marketing Address
    address payable private teamWalletAddress = payable(0x59B7B296648e1D729f7e240E094736C1AE54a66b); // Team Address
