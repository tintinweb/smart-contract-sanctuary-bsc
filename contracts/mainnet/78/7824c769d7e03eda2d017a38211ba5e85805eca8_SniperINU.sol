...
/**
Sniper INU is a decentralized virtual world building game that supports NFT
creation and trading and Play To Earn mode.
Anyone can own virtual land in the Sniper INU world, design and create various buildings and virtual items,
and realize the auction and exchange of virtual items through NFT.

Telegram : https://t.me/SniperINU
Website : https://sniperinu.website/
*/
...
contract SniperINU is Context, IERC20, Ownable {
    ...
    string private _name = "Sniper INU";
    string private _symbol = "SNINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB9f29ff0fAFE97E31D86CB06A02AC40eE4fafD6); 
    address payable public buyBackWalletAddress = payable(0xeB9f29ff0fAFE97E31D86CB06A02AC40eE4fafD6); 
