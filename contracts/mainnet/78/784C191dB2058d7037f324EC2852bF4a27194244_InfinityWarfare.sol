...
/**     
Name - INFINITY WARFARE
Symbol - IW                
Telegram : https://t.me/InfinityWarfareFPS
Website : tba 
...
contract InfinityWarfare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    InfinityWarfareDividendTracker public dividendTracker;
    ...
    constructor() ERC20("INFINITY WARFARE", "IW") {
        marketingWallet = payable(0xEC5f8a13Da182f8fEf796006d7730F7290544b64);
        devWallet = payable(0xEC5f8a13Da182f8fEf796006d7730F7290544b64);
        ...
        dividendTracker = new InfinityWarfareDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "InfinityWarfareTRACKER",
            "InfinityWarfareTRACKER"
        );
...
contract InfinityWarfareDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    InfinityWarfare public InfinityWarfareContract;
    ...
    constructor(
        ...
        defaultToken = token;
        InfinityWarfareContract = InfinityWarfare(mainContract);
    ...
    function _transfer(
        ...
        require(false, "InfinityWarfare_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "InfinityWarfare_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main InfinityWarfare contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(InfinityWarfareContract);

            uint256 prevBalance = InfinityWarfareContract.balanceOf(address(this));
            ...
            {
                uint256 received = InfinityWarfareContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    InfinityWarfareContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
