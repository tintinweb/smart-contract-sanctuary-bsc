...
contract FireDemon
 is Context, IERC20, Ownable {
    ...
    string private _name = "FireDemon";
    string private _symbol = "FireDemon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6dF802fA29f6eB847d66D4929C02519C8d6196B8);
    address payable public teamWalletAddress = payable(0x6dF802fA29f6eB847d66D4929C02519C8d6196B8);
    address public immutable deadAddress = 0x6dF802fA29f6eB847d66D4929C02519C8d6196B8;
