...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x319C71C535521D1B6b63fac8D10A65dc124152D5); 
...
contract newcommunitbnx is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x319C71C535521D1B6b63fac8D10A65dc124152D5; //mw dj
    address DevWallet       = 0x319C71C535521D1B6b63fac8D10A65dc124152D5; //dw sfz

    string constant _name = "New Community BNX";
    string constant _symbol = unicode"cBNX";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);
    uint256 public _maxSell = 20000000 * (10 ** _decimals);
    ...
    address PAIR = 0xA191E854Cb5E348FcCF7f000Bdd6318A87B7B6EE;
