...
contract BABYBAPE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7Ef696B806828a1D35e3A1572E6937C76e00296B;

    string private constant _name = "BabyBAPE";
    string private constant _symbol = "BBAPE";
    ...
    Taxes public taxes = Taxes(0,90,2,0);
