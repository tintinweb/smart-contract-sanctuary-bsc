...
//https://t.me/CatBoyChain
//All rats will go hiding when they see CatBoy! 
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x115b5b5Fa123c4e536934537CF4ac60Dd2acB1E1;
...
contract catboy is Context, IERC20, Ownable { 
    ...
    address payable public catboychainwallet = payable(0x2133d829A085CA084B0813C92F758e557e64Cabc);
    ...
    string private constant _name = unicode"CatBoyChain"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(catboychainwallet, BNB_Tot);
