...
/*
Σ OmegaCoin
TG : https://t.me/OmegaCoinOfficial

OmegaCoin is a new BSC ambitious token that aims to become a center of all the potential tokens in BSC by filter & list it on OmegaCoin official website.

OmegaCoin will soon fairlaunch in the next few hours, official contract & exact timing will be announce 5 minutes before our launch.

Tokenomics:
1) Supply : 1,000,000,000,000 (1 Trillion)
2) Tax : 8%
3) Initial LP : 1 BNB
*/
...
contract OmegaCoin is Context, IERC20 { 
    ...
    string private constant _name = "OmegaCoin"; 
    string private constant _symbol = "OmegaCoin"; 
