...
contract Sotrue is Context, IERC20, Ownable {
    ...
    string private _name = "So true";
    string private _symbol = "SoTrue";
    ...
    constructor () public {
        ...
        maxTxAmountSell = totalSupply() * 50 / 1000; // 5% maxTx for sell
        _maxWalletSize = totalSupply() * 50 / 1000; // 5% maxWallet
