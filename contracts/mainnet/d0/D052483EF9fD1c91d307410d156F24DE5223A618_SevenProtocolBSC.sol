...
/**
*
Telegram: https://t.me/sevenprotocolbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89900e776506AAaC1aDA27c149FFa13287AFc1d1; // owner address
...
contract SevenProtocolBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "7Protocol BSC";
    string private _symbol = "7PROB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89900e776506AAaC1aDA27c149FFa13287AFc1d1); // Marketing Address
    address payable public teamWalletAddress = payable(0x89900e776506AAaC1aDA27c149FFa13287AFc1d1); // Team Address
