...
/* Token contract */
contract ChristmasRabbit is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x6B00EAa9412Ee24b4169767C8bb0bF855BCfFBae;
    ...
    // Name and symbol
    string constant _name = "Christmas Rabbit";
    string constant _symbol = "CHRABBIT";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 50 / 10000;  // 1% max or 1M
