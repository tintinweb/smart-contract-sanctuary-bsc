 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract DIGITAL_IDENTITY is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable,Ownable {
    using SafeMath for uint256;
     ...
     */
    constructor () public {
        _name = "DIGITAL IDENTITY";
        _symbol = "DIGITAL IDENTITY";
 ...
 function mint(
        address _to,
        uint8 _UBId
    ) external onlyManager() override returns (uint256) {
