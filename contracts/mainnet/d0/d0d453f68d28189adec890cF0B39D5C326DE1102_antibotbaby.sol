...
library Address{
 ...
 contract antibotbaby is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD0EB6801AF0734b20b96Aedf429136fB51D0C341;
    address public donationWallet = 0xD0EB6801AF0734b20b96Aedf429136fB51D0C341;

    string private constant _name = "CRYPTO STRANGE";
    ...
    function setTaxes(uint256 _reflection, uint256 _marketing, uint256 _liquidity, uint256 _donation) public onlyOwner {
       taxes = Taxes(_reflection,_marketing,_liquidity,_donation);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _reflection, uint256 _marketing, uint256 _liquidity, uint256 _donation) public onlyOwner {
       sellTaxes = Taxes(_reflection,_marketing,_liquidity,_donation);
        emit FeesChanged();
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.treflection-s.tMarketing-s.tLiquidity-s.tdonation;
        return s;
    }
    ...
    function _getRValues1(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rreflection,uint256 rMarketing, uint256 rLiquidity){
        ...
        rTransferAmount =  rAmount-rreflection-rMarketing-rLiquidity-rdonation;
