...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x44316F9422E5b79D0C0b5F6d1BDCD0ef993c4215;
...
/* Token contract */
contract SHORTEYE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x44316F9422E5b79D0C0b5F6d1BDCD0ef993c4215;
    ...
    // Name and symbol
    string constant _name = "Short Eye";
    string constant _symbol = "Short";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch or 1B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 2B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% or 2B tokens
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000; // 12% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x44316F9422E5b79D0C0b5F6d1BDCD0ef993c4215;
