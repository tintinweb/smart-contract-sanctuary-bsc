...
contract stake_sT1 {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 100_000 ether;//100 000 tokens minimum deposit 
    uint256 public INVEST_LIMIT_AMOUNT = 1_000_000_000 ether;//limit tokens for buy BNB
