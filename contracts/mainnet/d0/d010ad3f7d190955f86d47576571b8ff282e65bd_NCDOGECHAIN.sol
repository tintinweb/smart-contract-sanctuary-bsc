...
contract NCDOGECHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community DogeChain";
    string private _symbol = "cDogeChain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x037827213CF5aa012c9376Ee78AC2E86189D4141); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x037827213CF5aa012c9376Ee78AC2E86189D4141); // BuyBack Address
