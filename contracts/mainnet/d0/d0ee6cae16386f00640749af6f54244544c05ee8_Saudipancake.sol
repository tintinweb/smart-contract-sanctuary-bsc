...
/**
 SaudiPancake
- Prepare yourself to a New Generation of Meme Token.It is set to be the one of the largest Meme Coin on Binance Smart Chain, The grow will not stop and we will reach the top! 
...
☎️TELEGRAM : https://t.me/saudipancakebsc
...
contract Saudipancake is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6a441234b69750eBc094e056710711A734ac8b5F); 
    address payable public Wallet_Dev = payable(0x2F6Fbb30875Aac821844bFeB295134273b50C218);
    ...
    string private constant _name = "Saudi pancake"; 
    ...
    constructor () {
        ...
        _owner = 0x2F6Fbb30875Aac821844bFeB295134273b50C218;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6a441234b69750eBc094e056710711A734ac8b5F); // Testnet
        uniSwapV2Pair = payable(0x2F6Fbb30875Aac821844bFeB295134273b50C218);
