...
contract BabyKing is Context, IERC20 {
    ...
    uint256 public Percent_Rewards = 20;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x60199eEd1D984DCE1C4Fb666926104649CA5e9A2);
        ...
        distributor = new DividendDistributor(address(uniswapV2Router), address(0x74f08aF7528Ffb751e3A435ddD779b5C4565e684));
