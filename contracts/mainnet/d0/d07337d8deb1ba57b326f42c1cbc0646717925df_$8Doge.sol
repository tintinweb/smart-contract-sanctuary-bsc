...
contract $8Doge is Context, IERC20, Ownable {
    ...
    string private _name = "$8Doge";

    string private _symbol = "$8Doge";
    ...
    address payable public marketAddress = 0x2B0C54Bbac29a7A37BA09da79B523b50f54Fc1eC ; //Marketing
