...
/**
   Welcome to Ape Millionaire

Telegram Group: https://t.me/apemillionaire
...
contract ApeMillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ApeMillionaire"; 
    string private _symbol = "MILLIONAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76c687c31EDb487ac1553cd4E1b6D1E982aF100f
);
    address payable public teamWalletAddress = payable(0x7622859C967Cc25fd1b8a155274A0Cabe219f071
);
