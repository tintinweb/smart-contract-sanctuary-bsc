...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBC837e11B197128D56b29Cbd5E07587911cfd837; // owner address
...
contract GUCCISHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "GUCCI SHIBA";
    string private _symbol = "GCCS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDacd9f96AE9bad214Cf90b1a80e036FBC6e8aDee); // Marketing Address
    address payable public teamWalletAddress = payable(0x72679343ba1942F8ED111925322AC6743f245F37); // Team Address
    ...
    uint256 public _maxTxAmount = 3000000000000000000 * 10**_decimals; 
