...
contract Waifu is Context, IERC20, Ownable {
    ...
    address payable public devWallet = payable(0xDC98ec297a9B962E40359738A9cB9aFbb74e528B);
    
    bool public swapAndLiquifyEnabled = true;
    bool inSwapAndLiquify;
    
    uint256 public swapTokensAtAmount = 40000 * 10**18;
    uint256 public _maxTxAmount = 69000000 * 10**18;
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity and swap for dev and marketing
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_devFee));
        ...
        //swap for dev and marketing
        swapTokensForEth(contractTokenBalance.sub(liquidityShare), devWallet);
    ...
    function updateFee(uint256 taxFee, uint256 liquidityFee, uint256 devFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(devFee) <= 5, "tax too high");
        _taxFee = taxFee;
    ...
    // use this function to change uniswap router address
