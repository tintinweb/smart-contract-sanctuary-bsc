...
// File: contracts/CerberusHell.sol

pragma solidity 0.6.12;


contract VizslaPool is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the cerberus hell factory
    address public VIZSLA_FACTORY;
    ...
    // The block number when CERBERUS mining ends.
    ...
    uint256 public constant MAXIMUM_WITHDRAWAL_INTERVAL = 365 days;
    ...
    function initialize(
        ...
        require(msg.sender == VIZSLA_FACTORY, "Not factory");
