...
Bokkusu Neko - ボックス猫
Telegram : https://t.me/BokkusuNeko
...
contract BokkusuNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bokkusu Neko";
    string private _symbol = "Bokkusu Neko";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5bF5088fA5481044BE6125788880857f3CA0d4AB); // MARKETING Address
    address payable public teamWalletAddress = payable(0x5bF5088fA5481044BE6125788880857f3CA0d4AB); // BUYBACK Address
