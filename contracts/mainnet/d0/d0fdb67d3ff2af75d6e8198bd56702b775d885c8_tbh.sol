...
contract tbh is Context, IERC20, Ownable {
    ...
    string private _name = "tbh";
    string private _symbol = "tbh";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb4d9211c6Eb3328f2C93dfE0ba1028AF4d75f638); 
    address payable public BurnedWalletAddress = payable(0xb4d9211c6Eb3328f2C93dfE0ba1028AF4d75f638); 
