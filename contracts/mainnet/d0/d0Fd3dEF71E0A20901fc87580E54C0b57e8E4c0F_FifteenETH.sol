...
contract FifteenETH is ERC20, Ownable {
    ...
    constructor() ERC20("15ETH", "15ETH") {

        starting = true;
        end = 25;
        maxWallet = 10 * 10 ** 9 * 10 ** decimals();
        maxTransaction = 10 * 10 ** 9 * 10 ** decimals();
        maxWalletTimer = 1667440800;
