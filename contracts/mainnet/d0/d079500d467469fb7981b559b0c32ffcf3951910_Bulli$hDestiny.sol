...
/**
 ...
 Telegram: https://t.me/BullishDestiny
...
contract Bulli$hDestiny  is ERC20, Ownable {
    ...
    constructor() ERC20("Bulli$h Destiny", "Destiny") {
        ...
        swapTokensAtAmount = totalTokenSupply / 200; //
    ...
    function updateFees(
        ...
        require(totalSellFees <= 10 && totalBuyFees <= 5, "total fees cannot exceed 10% sell or 5% buy");
...
contract Bulli$hDestinyDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        minimumTokenBalanceForAutoDividends = 100000000000_000000000000000000; // 100;000,000,000 tokens
