...
contract RonaldMcdonald is IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**7 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    // Basic Contract Info
    string private constant _name = "Ronald McDonald";
    string private constant _symbol = "RonaldMCD";
    ...
    // Transaction Limits
    uint256 private _maxTxAmount = _tTotal / 190 * 1; //changed
    uint256 private _maxWalletSize = _tTotal / 190 * 1; //changed
