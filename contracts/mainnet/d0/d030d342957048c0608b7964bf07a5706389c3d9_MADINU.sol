...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x403181BCfC70285F21C7E8C1A170ee1eeF09b560;
...
contract MADINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "MAD INU"; // 
    string private constant _symbol = "MAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x403181BCfC70285F21C7E8C1A170ee1eeF09b560);
