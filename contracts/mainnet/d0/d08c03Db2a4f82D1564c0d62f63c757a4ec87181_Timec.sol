...
contract Timec is ERC20, Ownable {
    ...
    uint256 public lockTime = 20 minutes;
    ...
    constructor(
        ...
        address _USDTV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(0x39F47645250f208A71E1b0e25Bb1Bc20cEe0e3B9));
    ...
    function _isLiquidity()internal view returns(bool){
        ...
        if(token0 == address(0x39F47645250f208A71E1b0e25Bb1Bc20cEe0e3B9)){
            if(  bal0 > r0 ){
                return true;
        }
        }
        if(token1 == address(0x39F47645250f208A71E1b0e25Bb1Bc20cEe0e3B9)){
            if(  bal1 > r1 ){
