...
contract UniDao is Context, IBEP20, Ownable, PancakeTool {
    ...
    uint256 private _maxDeals = 1000000 * size;
    uint256 private _maxHold = 100000000 * size;
    ...
    function _beforeTransfer(
        ...
        if (sender == PancakePair && recipient == _PancakeRouter) {
            ...
            require(
                aBalance <= _maxHold,
                "The maximum number of holdings is 100000000"
            );
            ...
            require(amount <= _maxDeals, "The maximum number of deals is 1000000");
        } else {
            require(amount <= _maxDeals, "The maximum number of deals is 1000000");
            uint256 aBalance = _balances[recipient] + amount;
            require(
