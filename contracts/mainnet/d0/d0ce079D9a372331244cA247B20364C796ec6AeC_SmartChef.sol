...
contract SmartChef is Ownable, ReentrancyGuard {
   ...
   // The pool limit (0 if none)
    ...
    uint256[] public withdrawalFeeIntervals = [100, 200, 300];
    uint16[] public withdrawalFeeBP = [400, 600, 800, 1000];
    ...
    function getWithdrawFee(address _user) public view returns (uint16) {
        ...
        uint256 blockElapsed = 1 - user.lastDepositBlock;
        uint i = 0;
