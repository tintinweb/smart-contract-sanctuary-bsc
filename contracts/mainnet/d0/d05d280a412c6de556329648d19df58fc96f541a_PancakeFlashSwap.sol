...
contract PancakeFlashSwap {
    ...
    address private constant BAKE = 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5;
    ...
    function startArbitrage(address _tokenBorrow, uint256 _amount) external {
        ...
        IERC20(BAKE).safeApprove(address(PANCAKE_ROUTER), MAX_INT);
    ...
    function pancakeCall(
        ...
        // Place Trades
        uint256 trade1AcquiredCoin = placeTrade(BUSD, BAKE, loanAmount);
        uint256 trade2AcquiredCoin = placeTrade(BAKE, CAKE, trade1AcquiredCoin);
