...
contract ArabianYooshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Yooshi";
    string private constant _symbol = "ARABYO";
