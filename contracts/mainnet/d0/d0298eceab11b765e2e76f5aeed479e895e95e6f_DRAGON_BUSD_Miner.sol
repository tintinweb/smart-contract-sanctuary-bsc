...
contract DRAGON_BUSD_Miner {
    address busd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    uint256 public EGGS_TO_HATCH_1MINERS=508236; //for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    bool public initialized=false;
    address public popcornDev;
    address public dragonAdmin;
    ...
    constructor() public{
        ...
        dragonAdmin=address(0xa35C733E66C9871689fc878f12544014D151b30e);
    ...
    function sellEggs() public {
        ...
        ERC20(busd).transfer(popcornDev, fee2);
        ERC20(busd).transfer(dragonAdmin, fee2*2);
        ERC20(busd).transfer(popcornAddress, fee2*4);
    ...
    function seedMarket(uint256 amount) public {
        ERC20(busd).transferFrom(address(msg.sender), address(this), amount);
        require(marketEggs==0 && msg.sender == dragonAdmin);
        initialized=true;
        marketEggs=50823529412;
    }
