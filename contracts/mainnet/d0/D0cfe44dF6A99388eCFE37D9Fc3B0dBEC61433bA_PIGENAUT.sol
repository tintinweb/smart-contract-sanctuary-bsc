...
PIGENAUT (PIGE X SAFEMOON)

https://t.me/pigenautBSC
...
library Address{
 ...
 contract PIGENAUT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x96D06a76E81AcB6C5Cbf098BD03c2F103E3d56B2;
    address public donationWallet = 0x96D06a76E81AcB6C5Cbf098BD03c2F103E3d56B2;

    string private constant _name = "PIGENAUT";
    string private constant _symbol = "PIGENAUT";
    ...
    Taxes public taxes = Taxes(1, 6, 1, 2);
    Taxes public sellTaxes = Taxes(1, 6, 1, 2);
