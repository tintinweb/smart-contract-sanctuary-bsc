...
contract AlbumToken is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 40000000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 4000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 4000000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 400000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "ALBUM TOKEN";
