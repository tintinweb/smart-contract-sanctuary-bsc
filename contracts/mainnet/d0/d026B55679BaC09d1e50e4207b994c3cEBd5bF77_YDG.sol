...
contract YDG is Context, IERC20, Ownable, BlackList {
    ...
    string private _name = "YDEFIGAME";
    string private _symbol = "YDG";
    ...
    function deliver(uint256 tAmount) public {
        ...
        (uint256 rAmount,,) = _getRValues(tAmount, tFee, tBurn, currentRate);
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        ...
        if (!deductTransferFee) {
            ...
            (, uint256 tFee, uint256 tBurn) = _getTValues(tAmount);
            uint256 currentRate = _getRate();
            (, uint256 rTransferAmount,) = _getRValues(tAmount, tFee, tBurn, currentRate);
