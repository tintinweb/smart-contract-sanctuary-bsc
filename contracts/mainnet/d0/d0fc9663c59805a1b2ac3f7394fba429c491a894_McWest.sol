...
MCDONALDS WILL BE ANNOUNCING THEIR PARTNERSHIP WITH KANYE WEST! COME JOIN US ON THE JOURNEY WHILE MCDONALDS
THEY WILL MAKE THE MCWest
MCYE WILL BE THE BEST BURGER TO GRACE MCDONALDS
WE WILL MOON
WE ARE McWest!!!
...
✴️ Sell tax = 15% (at launch )

✴️ Telegram  https://t.me/McWestbsc
...
/* Token contract */
contract McWest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "McWest";
    string constant _symbol = "McWest";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000;  // 2% max or 2M
