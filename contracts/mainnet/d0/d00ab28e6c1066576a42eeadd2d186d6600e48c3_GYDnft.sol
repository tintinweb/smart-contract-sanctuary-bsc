...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintAdminOneWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/jsongy/1");
        return true;
    }
    function mintAdminTwoWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/jsongy/2");
        return true;
    }
    function mintThreeWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/jsongy/3");
        return true;
    }
}
...
contract GYDnft is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("Green energy NFT", "GYDnft") {
