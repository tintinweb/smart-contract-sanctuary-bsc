...
contract SantaBoy is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  // Lists 
  uint256[600] public remainingIds;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
        wallet1 = 0x48696f83dF00c81B15BCFc304587a68831Fa2DC2;
        wallet2 = 0x199B8A8b686EE6492f78a6d8dC11d708338ADA50;
        wallet3 = 0x48696f83dF00c81B15BCFc304587a68831Fa2DC2;
        wallet4 = 0x48696f83dF00c81B15BCFc304587a68831Fa2DC2;
        wallet5 = 0x48696f83dF00c81B15BCFc304587a68831Fa2DC2;
        wallet6 = 0x48696f83dF00c81B15BCFc304587a68831Fa2DC2;
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "SantaBoy: minting has not started yet");
    require(_mintAmount > 0, "SantaBoy: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "SantaBoy: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "SantaBoy: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "SantaBoy: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "SantaBoy: zero address");
    require(_amount > 0, "SantaBoy: you have to mint at least one");
    require(lastSupply != 0,  "SantaBoy: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"SantaBoy: URI query for nonexistent token");
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 wallet1Share = _amount.mul(40).div(100);
      uint256 wallet2Share = _amount.mul(20).div(100);
