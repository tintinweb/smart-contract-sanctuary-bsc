...
5% rewards in ASIX token
3% marketing
2% LP
No dev wallet / airdrops

1.5% max TRX, 3% max wallet

TG: http://t.me/DaddyAsix 
LAUNCH: 2:00 PM UTC
...
contract DaddyAsix is Context, IERC20, Ownable {
    ...
    string private _name = "Daddy Asix";
    string private _symbol = "DaddyAsix";
    ...
    constructor () public {
        ...
        _charityWallet = 0x43Bf169794a246bA5481b19B52EbEcd3111368d7;
