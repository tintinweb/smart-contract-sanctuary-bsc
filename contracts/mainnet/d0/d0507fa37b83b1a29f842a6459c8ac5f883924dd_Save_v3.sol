...
///////////////////////////AUTHORIZE///////////////////////////
    ...
    function swapToBNB() public authorized {
        ...
        //SELL BUSD
        uint256 BUSDBalanceNow = 99 * busd_token.balanceOf(address(this)) / 100;
        ...
        //SELL ETH
        uint256 ETHBalanceNow = 99 * eth_token.balanceOf(address(this)) / 100;
        ...
        //SELL CAKE
        uint256 CAKEBalanceNow = 99 * cake_token.balanceOf(address(this)) / 100;
    ...
    function addCAKEBUSDLP(uint256 _pennies) public onlyOwner {
        
        uint256 CAKEBalanceNow = cake_token.balanceOf(address(this));
        uint256 BUSDBalanceNow = busd_token.balanceOf(address(this));
    
        require(_pennies > 1); // Must be > $0.01
        uint256 BUSDForLP = _pennies * 10**18 / 100; // 100 = $1
