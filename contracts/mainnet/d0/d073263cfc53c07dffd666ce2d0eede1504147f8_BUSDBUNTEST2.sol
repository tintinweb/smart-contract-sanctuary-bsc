...
/* Token contract */
contract BUSDBUNTEST2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x51e5a04489A4a6F2f9142a2CF31eB9AF22677FA4;
    ...
    // Name and symbol
    string constant _name = "BUSDBUNTEST";
    string constant _symbol = "BUNTEST";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 2M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x580133e97C8CBEcB66Be9008E1B6124bCd556Baf;
