...
contract BabyChihuahuaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Chihuahua Inu";
    string private constant _symbol = "BCI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3b30f53fC415350a21c922b4fcda95763325e6ee);
    address payable private _marketingAddress = payable(0x3b30f53fC415350a21c922b4fcda95763325e6ee);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_blackList[from], "blackList for bot");
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 10 , "Redis cannot be more than 8.");
	    require(redisFeeOnSell < 10, "Redis cannot be more than 8.");
	    require(taxFeeOnBuy < 10, "Tax cannot be more than 8.");
	    require(taxFeeOnSell < 10, "Tax cannot be more than 8.");
    ...
    function setBlackList(address addr, bool enable) external onlyDev {
