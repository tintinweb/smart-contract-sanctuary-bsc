...
//string
    string private _name = "FOMOge";
    string private _symbol = "$FMGE";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x7843206e6C878CA2cF010B5a518fd3AE409D60E6; // 4% Buy 6% Sell
    address public _BuybackWalletAddress = 0x7843206e6C878CA2cF010B5a518fd3AE409D60E6; // Mixture of Lotto + Buyback
...
// constructor
    constructor() {
        ...
        uint total_supply = 1 * 1e7 * 10 ** decimals();
        // set gvars
    ...
    function setSwapStatus(bool liq, bool swap) external onlyOwner {
        addLiq = liq;
        swapBnbActive = swap;
    }
