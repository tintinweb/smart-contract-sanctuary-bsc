...
My Community Still trying to make a token with a lot of potential and make history in BSC. 
The first project was DogexShiba which managed to touch the Million Cap.

Join Our Telegram Official : https://t.me/HALLOWEENSHIBADOGE
...
contract HalloweenShibaDoge is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Halloween Shiba Doge";
    string constant public symbol = "$HSD";
