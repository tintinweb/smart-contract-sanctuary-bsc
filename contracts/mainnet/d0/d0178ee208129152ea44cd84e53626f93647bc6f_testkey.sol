...
contract testkey is IERC20, Ownable {
    ...
    address public _fundAddress = address(0x8D31Bc51484b5d6A9Cb615C4534e60196E19254C);
    address tokenOwner = address(0x9FC351bec6abbfBF2d7Fa9C1B853F1325AFBd1cD);
    constructor() {
        _name = "test key";
        _symbol = "tkey";
        _decimals = 18;
