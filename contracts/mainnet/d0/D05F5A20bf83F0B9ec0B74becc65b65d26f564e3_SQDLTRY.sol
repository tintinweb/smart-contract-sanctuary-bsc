...
Telegram: https://t.me/SquidLotto
Website: http://squidlotto.finance
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SQD = IBEP20(0xA8A35Ac880E9754D2df8803f3A7D637e245dcC85);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = SQD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SQD.transfer(shareholder, amount);
...
contract SQDLTRY is IBEP20, Auth {
    using SafeMath for uint256;

    address SQD = 0xA8A35Ac880E9754D2df8803f3A7D637e245dcC85;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SQDLTTRY";
    string constant _symbol = "SQDLTTRY";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x37c9682D9F40033e61Bf67C4FF268F81ABC595a6;
