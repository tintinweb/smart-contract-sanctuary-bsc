...
contract JMarketplace is AccessControlUpgradeable, ERC1155HolderUpgradeable
{
        ...
        external
    {
        ...
        jnft.safeTransferFrom(address(this), msg.sender, _listing.tokenId, _listing.amount, "");
        ...
        payable external
    {
        ...
        uint256 _royaltyFee = jnft.calculateRoyaltyFee(_listing.tokenId, _buyValue);
        ...
        jnft.safeTransferFrom(address(this), msg.sender, _listing.tokenId, _amount, "");
        ...
        external
    {
        ...
        uint256 _royaltyFee = jnft.calculateRoyaltyFee(_offer.tokenId, _sellValue);
        ...
        jnft.safeTransferFrom(msg.sender, _offer.owner, _offer.tokenId, _amount, "");
