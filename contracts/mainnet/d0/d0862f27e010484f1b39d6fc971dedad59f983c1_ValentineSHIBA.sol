...
contract ValentineSHIBA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Valentine SHIBA"; // TOKENS NAME
    string constant _symbol = "ValentineSHIBA"; // SYMBOL
    ...
    uint256 public _maxTxAmount = _totalSupply * 3 / 200; // MAX TX 3%
    uint256 public _walletMax = _totalSupply * 4 / 100; // MAX WALLET 4%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xE76e5c44602D6Af14c64dDDb555a38580C21405B;
        marketingWallet = 0xC34a036d80371566806159F534aA61e89e6C8223; // to 1mill mcap
        buybackwallet = 0xC34a036d80371566806159F534aA61e89e6C8223; // Buyback manually
