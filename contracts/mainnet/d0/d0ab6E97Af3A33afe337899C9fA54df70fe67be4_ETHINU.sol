...
contract ETHINU is ERC20, Ownable {
    ...
    ETHINUDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ETHINU", "ETHI") {
        marketingWallet = payable(0xBF5251912bFc4c0E314E1F3B79026d938779d7dD);
        devWallet = payable(0x7802742767d46AC5c4965F6876E3705DCBF875Cc);
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new ETHINUDividendTracker(
            payable(this),
            router,
...
contract ETHINUDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        ETHINUContract = ETHINU(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ETHINU_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ETHINU_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ETHINU contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ETHINUContract);

            uint256 prevBalance = ETHINUContract.balanceOf(address(this));
            ...
            {
                uint256 received = ETHINUContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ETHINUContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
