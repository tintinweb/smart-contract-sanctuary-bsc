...
contract MyPurpleUni is Context, IERC20, Ownable {
    ...
    string private constant _name = "My Purple Uni"; // 
    string private constant _symbol = "$MYUNI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x995B465E7B9623715535102E1a4C67171a77908F;
