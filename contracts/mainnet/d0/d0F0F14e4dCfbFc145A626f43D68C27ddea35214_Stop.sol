...
library Address{
 ...
 contract Stop is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x913A3a95ba022AD55579E27dd3E9145086ABB8A5;
    address public donationWallet = 0xcdD31765D497C7398A5DB2aaC99739F126B243F6;

    string private constant _name = "FvckApe";
    string private constant _symbol = " FVCK APE ";
    ...
    Taxes public taxes = Taxes(1, 11, 1, 0);
    Taxes public sellTaxes = Taxes(1, 15, 1, 0);
