...
contract Tuzi2023 is ERC20, Ownable {
    ...
    Tuzi2023DividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x980BA4b68D1944C16F5dFadf9C2bAF8721c6670d;
    address public devWallet = 0x980BA4b68D1944C16F5dFadf9C2bAF8721c6670d;
    ...
    Taxes public buyTaxes = Taxes(2, 3, 0, 1);
    Taxes public sellTaxes = Taxes(2, 5, 0, 2);
    ...
    constructor() ERC20("Tuzi2023", "T2023") {
        dividendTracker = new Tuzi2023DividendTracker();
        ...
        /*
            ...
            and CANNOT be called ever again
        */
        _tokengeneration(owner(), 1e12 * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        Tuzi2023DividendTracker newDividendTracker = Tuzi2023DividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Tuzi2023: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount < 1e10,"Swap Threshold should be less than 1% of total supply");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "Tuzi2023: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "Tuzi2023: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Tuzi2023: Cannot update gasForProcessing to same value"
        );
...
contract Tuzi2023DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("Tuzi2023_Dividen_Tracker", "Tuzi2023_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100000 * (10**decimals()); 
    }
    ...
    function _transfer(
        ...
        require(false, "Tuzi2023_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Tuzi2023_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Tuzi2023_Dividend_Tracker: Cannot update claimWait to same value"
        );
