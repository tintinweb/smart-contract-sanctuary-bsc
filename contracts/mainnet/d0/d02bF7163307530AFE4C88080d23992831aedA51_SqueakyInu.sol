...
/**
There's been a cow, there's been a pig, but there hasn't been arguably the most important animal of all, the chicken.
Squeaky Inu seeks to be the great new inu meme of the BSC.
*/
...
contract SqueakyInu is IBEP20, Auth {
    ...
    string constant _name = "SQUEAKYINU";
    string constant _symbol = "SQUEAKYINU";
