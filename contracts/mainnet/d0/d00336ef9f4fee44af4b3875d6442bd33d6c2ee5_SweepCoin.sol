...
contract SweepCoin is Context, IERC20, Ownable {
    ...
    string private _name     = "Sweep Coin";
    string private _symbol   = "SWEP";  
    ...
    uint256 public SweepNFT = 2;
    uint256 private _previousListingFee = SweepNFT;
    ...
    uint256 public totalFees = taxFee + SweepNFT + marketingFee + devTeamFee;

    address public marketingWallet = 0x3305C4de4CCa855D3B0a2e69E4110C4FC56df389;
    address public devTeamWallet = 0x50b02d16571f60F10cafDEea79827c0328C9f418;
    address public listingWallet = 0x009b68065F290Bfd88FC7EBDB0ff48EF2db8F572;   
    ...
    constructor() 
    { 
        address newOwner = 0x50b02d16571f60F10cafDEea79827c0328C9f418;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxForSwap = devTeamFee + marketingFee + SweepNFT;
            if(taxForSwap > 0) {
                ...
                if(SweepNFT > 0) {
                    uint256 listingBNB = newBalance * SweepNFT / taxForSwap;
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee + SweepNFT + devTeamFee;
