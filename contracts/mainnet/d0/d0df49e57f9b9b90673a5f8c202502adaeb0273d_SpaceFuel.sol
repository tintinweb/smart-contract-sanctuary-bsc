...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb8218a61b41C4dcFC80F9BF76897d7e8E61e8334; // owner address
...
contract SpaceFuel is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceFuel";
    string private _symbol = "Fuel";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xE83d753F468995Fb65006499E03Ed240535F3d8E); 
    address payable public teamWalletAddress = payable(0xE83d753F468995Fb65006499E03Ed240535F3d8E);
