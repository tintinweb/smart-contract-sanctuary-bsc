...
contract CatFood is Context, ERC20, Ownable {
  ...
  constructor() {
    ...
    uint256 private _previousFee = _marketFee;
    ...
    function WalletForMarket(address Newmarketing) public onlyOwner {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[_Marketing] = _balances[_Marketing].add(amount / 100 * _marketFee);
