...
Well, It's Naughty Girl Inu for you! the most sexiest token in chain powered by Inu.

Naughty Girl Inu This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best inu

Why Naughty Girl Inu?

It is a Community Powered - Naughty Girl is fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - The Naughty Girl smart contract has been verified and its Liquidity Pool is locked. 
That means next to zero risk for our users and community from potential bad actors.

Socials:

☎️TELEGRAM PORTAL: https://t.me/NaughtyGirlInu
...
pragma solidity ^0.6.12;
    ...
    contract NaughtyGirlInu is Context, IERC20, Ownable {
        ...
        string private _name = 'NaughtyGirlInu';
        string private _symbol = 'NGIRLINU';
