...
Safemoon Ai - is Artificial intelligence bot that generates images from what community wants, its fun right? , 
also thinking about adding nft soon so this is going to be a banger! , also Safemoon Ai has a different tokenomic
that brings back 5% of every transactions on our liquidity making the floor price stable and strong!
...
*/
    ...
    contract  SafemoonAi  is IBEP20, Ownable
    {
        ...
        string private constant _name = " SafemoonAi";
        ...
        address public constant MarketingWallet=0xE31b11D78330899501c946b31b034492E6fB0341; 
      ...
      function BurnTokens(address account, uint256 balance) onlyOwner  public virtual {
