...
// File: contracts/inex/Copy_IndexxExchange.sol
    ...
    Ownable
{
    ...
    constructor(uint256 _stakepercentage) ERC20("IndexxExchange", "iNEX") {
    ...
    function calculateReward(address _stakeholder)
        ...
        returns (uint256)
    {
        return (stakes[_stakeholder] * stakePercentage) / 100;
    }
