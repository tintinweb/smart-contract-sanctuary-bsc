...
/**
   ...
   Degen play, If you want to create a telegram I suggest to name it to @BoredFlokiYachtClub
   Important: The early you create a group that shares the token, the more gain you'll get.

   I will renounce the ownership to burn addresses to transfer #BFYC to the community, make sure it's 100% safe.
   Also Liquidity will be Locked.
...
contract BoredFlokiYachtClub is Context, IERC20, Ownable {
