...
contract stringtest is Ownable, IBEP20 {
    ...
    string constant _name = "Stringtest2";
    string constant _symbol = "String2";

    string News = "To be Announced";
    ...
    function setNews(string memory _value) external onlyOwner {
    News = _value;
    }
