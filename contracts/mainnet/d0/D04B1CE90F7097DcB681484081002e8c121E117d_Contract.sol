...
Development and Marketing wallet: 7%


Anti-Whale: Each wallet holder can only purchase up to 2% of total supply. Each transaction is a maximum of 0.5% of the supply.
...
contract Contract is Context, IBEP20, Ownable { 
    ...
    uint256 public _maxTxAmount = 50000 * 10**12 * 10**9;
