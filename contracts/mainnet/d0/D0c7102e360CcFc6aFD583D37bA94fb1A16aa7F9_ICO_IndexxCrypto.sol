...
// File: contracts/prod_ic/ChainlinkIndexxCrypto.sol
...
// File: contracts/prod_ic/IndexxCrypto.sol
...
// File: contracts/prod_ic/TimeLock_IndexxIC.sol
...
// File: contracts/prod_ic/ICO_IndexxCrypto.sol
...
contract ICO_IndexxCrypto is ChainlinkIndexxCrypto {
    ...
    constructor() {
        ...
        timelockContract = address(0x946c1563F2819E43Ebc50252cFF2B3fF0aB60413);
        token = address(0x7325E062EA31E7b977fbEBBcC45De30c3e894988);
        closingTime = 1663185600;
        openingTime = 1664541000;
        discount = 12;
        icoAdmin = msg.sender;
        ...
        returns (uint256)
    {
        ...
        uint256 rate = uint256(price.div(indexxCryptoPriceUSD));   // number of wei indexx token for each wei payment token * 10 ** 4
     ...
     */
    function _setIndexxCryptoPrice()
        external onlyIcoAdmin
    {
