...
telegram : https://t.me/qatarwinnerbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x357050d8a2F99d3F00928C2aC0c23618e84fc072; // whatDOGE
...
contract QATARWINNER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QATAR Winner";
    string private _symbol = "QFAWIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x357050d8a2F99d3F00928C2aC0c23618e84fc072); // Marketing Address
    address payable public teamWalletAddress = payable(0x357050d8a2F99d3F00928C2aC0c23618e84fc072); // Team Address
    ...
    uint256 public _marketingShare = 57;
