...
contract K0Father is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kill 0 Father";
    string private _symbol = "K0Father";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa32225e3BA19cB00e50A1733257b6C5Fb5b0Fb60); 
    address payable private teamWalletAddress = payable(0x52d02aB8Ebb2022aE9aFCf3938B1450cA1Feb02D); 
