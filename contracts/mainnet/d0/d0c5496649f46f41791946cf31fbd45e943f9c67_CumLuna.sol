...
contract CumLuna is Context, IERC20, Ownable {
    ...
    string private constant _name = "CumLuna"; // 
    string private constant _symbol = "$CLUNA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xb36d9B6056910da264bd33a105ece81C814fE7D4;
