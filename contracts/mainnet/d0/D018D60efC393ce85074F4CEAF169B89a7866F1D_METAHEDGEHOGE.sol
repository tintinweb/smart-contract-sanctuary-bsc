...
contract METAHEDGEHOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METAHEDGEHOGE";
    string private _symbol = "METAHEDGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4394ff70C65d5b79C954B31Cea610fEdd4ad555b);
    address payable public teamWalletAddress = payable(0x4394ff70C65d5b79C954B31Cea610fEdd4ad555b);
