...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Deviden = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract NekoBTC is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "NEKO BTC";
    string constant _symbol = "NekoBTC";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000; //Max tx 
    uint256 public _maxWalletHold = 100000000;// Maxwallet
    ...
    function setFees(uint256 _burnFee, uint256 _devFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalFee = _burnFee.add(_reflectionFee).add(_marketingFee).add(_devFee).add(_buybackFee);
