...
// File: contracts\SinglePHCFinanceNftAuction.sol

// SinglePHCFinanceNft Auction Contract 
...
interface ISinglePHCFinanceNft {
...
contract SinglePHCFinanceNftAuction is Ownable, ERC721Holder {
    ...
    {   
        ...
        ISinglePHCFinanceNft nft = ISinglePHCFinanceNft(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            ISinglePHCFinanceNft(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = ISinglePHCFinanceNft(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = ISinglePHCFinanceNft(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            if (myAuction.tokenAdr == address(0x0)) {
                ...
                totalEarnedBNB = totalEarnedBNB + _feeValue;
            } else {
                IBEP20 governanceToken = IBEP20(myAuction.tokenAdr);
            ...
            ISinglePHCFinanceNft(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
