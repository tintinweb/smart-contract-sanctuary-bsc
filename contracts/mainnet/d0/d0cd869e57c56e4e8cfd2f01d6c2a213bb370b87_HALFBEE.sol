...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72434C252E5386e9Ed345E46D3a04d234F7cc00c; 
...
contract HALFBEE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HALF BEE";
    string private _symbol = "HALFBEE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72434C252E5386e9Ed345E46D3a04d234F7cc00c); // 
    address payable public teamWalletAddress = payable(0x72434C252E5386e9Ed345E46D3a04d234F7cc00c); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x72434C252E5386e9Ed345E46D3a04d234F7cc00c)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x72434C252E5386e9Ed345E46D3a04d234F7cc00c),removeRandom);
}}