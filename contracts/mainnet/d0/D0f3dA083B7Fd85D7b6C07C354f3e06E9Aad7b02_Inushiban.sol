...
// Submitted for Telegram: https://t.me/inushibanbsc
...
contract  Inushiban  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Inushiban Token";
    string private _symbol = "Inushiban";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 33000 * 10 ** _decimals;
