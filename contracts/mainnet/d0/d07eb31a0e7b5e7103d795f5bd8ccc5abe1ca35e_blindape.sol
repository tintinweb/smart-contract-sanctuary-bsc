...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xE6b3D143A5d234b46a1157809cbD1b4753429964;
...
contract blindape is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BlindApe"; 
    ...
    uint256 public _maxWalletToken = 49 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xE6b3D143A5d234b46a1157809cbD1b4753429964), BNB_Tot);
            }
