...
contract PROXYDEPLOYER is Auth {
    ...
    function resetVotingTimes() external authorized {
        DAOcontract.resetVotingTimes();
    }

    function resetVotingAmts() external authorized {
        DAOcontract.resetVotingAmts();
    }
    ...
    function archiveVoting() external authorized {
        DAOcontract.archiveVoting();
    }

    function startInitialVoting(uint256 endTime, string memory _header, string memory _subheader) external authorized {
        DAOcontract.startInitialVoting(endTime, _header, _subheader);
    }

    function startNewVoting(uint256 endTime, string memory _header, string memory _subheader) external authorized {
        DAOcontract.startNewVoting(endTime, _header, _subheader);
    }
}
...
interface IPROXY {
    ...
    function resetVotingTimes() external;
    function resetVotingAmts() external;
    function setVotingActive(bool _bool) external;
    function archiveVoting() external;
    function startInitialVoting(uint256 endTime, string memory _header, string memory _subheader) external;
    function startNewVoting(uint256 endTime, string memory _header, string memory _subheader) external;
}
...
contract DAO is IBEP20, IPROXY, Auth {
    ...
    bool public whitelistVoting = true;
    ...
    function viewPastVoteCount() public view returns (uint256) {
        return pastVoteCount;
    }
    ...
    function viewPastVoteStats(uint256 voteNumber) public view returns (string memory, string memory, uint256, uint256, uint256, uint256) {
    ...
    function resetVotingTimes() external override authorized {
        VoteStart = block.timestamp;
        VoteEnd = block.timestamp;
        votingActive = false;
    }

    function resetVotingAmts() external override authorized {
        VotesYes = 0;
        VotesNo = 0;
    }
    ...
    function archiveVotingNow() internal {
        pastVoteCount = pastVoteCount.add(1);
        pastVoting storage pvote = pastVote[pastVoteCount];
        pvote.header = header;
    ...
    function archiveVoting() external override authorized {
    ...
    function startNewVoting(uint256 endTime, string memory _header, string memory _subheader) external override authorized {
        require(block.timestamp >= VoteEnd);
        archiveVotingNow();
        header = _header;
        subheader = _subheader;
    ...
    function startInitialVoting(uint256 endTime, string memory _header, string memory _subheader) external override authorized {
        require(block.timestamp >= VoteEnd);
        header = _header;
        subheader = _subheader;
        VoteStart = block.timestamp;
