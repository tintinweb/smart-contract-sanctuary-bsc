...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe9dC17bC758dcdC86D8C27e505bD9E7de17197b0;
...
contract shas is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x57af216E351DcBE68549827FAC883aef1A17a615;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "shas";
    string private _symbol = "sah";
