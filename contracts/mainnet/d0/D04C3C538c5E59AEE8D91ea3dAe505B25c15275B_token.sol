...
contract token is ERC20 {
    ...
    address public marketAddress = address(0x11557dA9abc7173F0146effa474AA557DAA1c618);
    ...
    uint256 public sellLpFee = 40;
    uint256 public sellMarketFee = 20;

    uint256 public maxWalletAmount = 110 * 100000000 * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "Tibetan dog";
    string internal tokenSymbol = "Tibetan dog";
    uint256 constant total  = 20000 * 100000000 * 10**18;
