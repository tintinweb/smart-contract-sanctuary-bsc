...
contract UpDogeCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UpDogeCoin";
    string constant _symbol = "DOGE";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10 * 10**14 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;

    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 37 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 399 / 100000; 
    bool inSwap;
