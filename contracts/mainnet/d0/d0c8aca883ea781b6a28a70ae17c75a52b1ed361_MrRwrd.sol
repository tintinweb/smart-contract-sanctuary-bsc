...
abstract contract Project {
    ...
    string constant _name = "MrRwrd";
    string constant _symbol = "MrRwrd";
...
contract DividendDistributor is IDividendDistributor  {
    ...
    function setShare (address shareholder, uint256 _tokenBalance, uint256 _lockedBalance) external override onlyToken {
        ...
        if(_lockedBalance == 0 && _tokenBalance == 0) {
            ...
            // Remove the excluding ... we shouldnt be doing that here. 
 ...
 * MainContract
 */
contract MrRwrd is Project, IBEP20, Ownable {
    using SafeMath for uint256;
...
// *** 
    ...
    function getMyLockedTokens(address holder) public view returns (uint256) {
        return lockedTokens[holder];
    }
