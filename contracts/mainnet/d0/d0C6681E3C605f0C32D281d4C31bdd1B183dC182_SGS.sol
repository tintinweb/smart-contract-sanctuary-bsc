...
contract SGS is SGSDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SGSTeam;
    address private CharitySGS;
    ...
    string public override name = "Somegirl Society";
    string public override symbol = "SGS";
    ...
    constructor(uint totalSupplyValue, address SGSTeamAddress, address CharitySGSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SGSTeam = SGSTeamAddress;
        CharitySGS = CharitySGSAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SGSTeam] =  totalSupply * 4 / 100;
        balances[CharitySGS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SGSTeam pot
