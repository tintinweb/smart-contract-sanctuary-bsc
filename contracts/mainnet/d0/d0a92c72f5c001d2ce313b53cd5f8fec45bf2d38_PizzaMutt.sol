...
contract PizzaMutt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pizza Mutt";
    string private _symbol = "PizzaMutt";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xe4E52AC92D259A77eC2e9F907784edb830BCC7a1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xcE87dC6b39cF3B05890fb0e846C538602aa1277F); // BuyBack Address
