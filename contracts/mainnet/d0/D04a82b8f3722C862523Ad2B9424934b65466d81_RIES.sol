...
contract RIES is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x71EA51C967f6274DA69027d101867064FA5D3B47);
    ...
    string private constant _name = "Aries Network"; 
    string private constant _symbol = unicode"RIES"; 
