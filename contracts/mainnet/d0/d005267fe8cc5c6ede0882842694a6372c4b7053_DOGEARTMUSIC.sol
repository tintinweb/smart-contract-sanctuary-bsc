...
contract DOGEARTMUSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEARTMUSIC";
    string private _symbol = "DAM";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100000 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
