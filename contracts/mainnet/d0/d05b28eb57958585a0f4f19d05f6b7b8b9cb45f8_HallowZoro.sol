...
contract HallowZoro is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"HALLOW ZORO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0xf88cf6059d65144eA2937Ae9759428ee6Ae2B940);
    address payable private MarketingWallet = payable(0x9f127188e9fA969630a163d2bA286C2C2A3Acf15);
