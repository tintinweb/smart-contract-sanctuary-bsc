...
WarCat is the ultimate ADA Rewards token. 
...
- 10 second cooldown between buys
- 2% max wallet size
...
contract WarCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WarCat";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "WarCat";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
