...
contract EDS is Context, IERC20, Ownable {
    ...
    string private _name = "ExaDarkSiderael";
    ...
    address payable public marketingWallet = payable(0x0bDE679a4914a737Ad0E03A32B13E04399bDb357);
    uint256 private _previousmarketingFee = _marketingFee;

    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public maxBuyTransactionAmount = 5000000000 * (10**18); // 5%
    uint256 public maxSellTransactionAmount = 2000000000 * (10**18); // 2%
    uint256 public maxWalletToken = 5000000000 * (10**18); // 5%
