...
/**
🇺🇸 10,000 Americans are here to become the wealthiest group in the world
https://discord.com/invite/theamericans
https://theamericans.io/nft/
 USACOIN
*/
...
contract Ownable is ContextBNB {
...
contract USACOIN is USACOINDeployer, ContextBNB, Ownable {
 
    // common addresses
    address private _owner;
    address private USACOINTeam;
    address private CharityUSACOIN;
    ...
    string public override name = "USACOIN";
    string public override symbol = "USACOIN";
    ...
    constructor(uint totalSupplyValue, address USACOINTeamAddress, address CharityUSACOINAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        USACOINTeam = USACOINTeamAddress;
        CharityUSACOIN = CharityUSACOINAddress;
       
        // split the tokens according to agreed upon percentages
        balances[USACOINTeam] =  totalSupply * 5 / 100;
        balances[CharityUSACOIN] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's USACOINTeam pot
