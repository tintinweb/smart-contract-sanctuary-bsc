...
contract CORE is ERC20 {
    ...
    address private _MarketAddress1 = address(0xB3E00Cc427fF0D253af31C52165B7B7d1B828585);
    address private _MarketAddress2 = address(0xB3E00Cc427fF0D253af31C52165B7B7d1B828585);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("CORE", "CORE") {
        ...
        uint256 total = 1000000000000000000 * 10**decimals();
