...
// *Telegram : https://t.me/Metadrift_bsc
...
contract metadrift is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x2DB440525EC99E08ec6c3B495e7B4dE86aC66288));
    address payable public devWallet =
        payable(address(0x2DB440525EC99E08ec6c3B495e7B4dE86aC66288));
    address public liquidityReceiver =
        0x2DB440525EC99E08ec6c3B495e7B4dE86aC66288;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Meta Drift";
    string private _symbol = "mDRIFT";
