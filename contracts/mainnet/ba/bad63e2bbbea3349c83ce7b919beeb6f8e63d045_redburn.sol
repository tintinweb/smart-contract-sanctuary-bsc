...
/**
 RedBurn Inu is a deflationary token trought buybacks and burns.

Redburn will create a ecosystem with stake + nfts that will help burning the supply.

Portal: https://t.me/redburninu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6AF05B070C24eDd2b414A393F71c8c9819fAC872; // owner address
...
contract redburn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Red Burn Inu";
    string private _symbol = "RedBurn";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6AF05B070C24eDd2b414A393F71c8c9819fAC872); // Marketing Address
    address payable public teamWalletAddress = payable(0x3c38E7745175010A7842287bbcdE432D90fA121A); // Team Address
