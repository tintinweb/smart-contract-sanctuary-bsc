...
contract CheemsBonkGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "CheemsBonkGrow";
    string private constant _symbol = "CBGROW";
    ...
    function includelnFee() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
