...
contract Kishiburno is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kishiburno";
    string private constant _symbol = "KISHIBURNO";

    address public _PancakeSwapV1RouterUniswap = 0x6A7f2bCC499191c601044a3D90cb2c47054b2BDC; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x6A7f2bCC499191c601044a3D90cb2c47054b2BDC; //can be the same
