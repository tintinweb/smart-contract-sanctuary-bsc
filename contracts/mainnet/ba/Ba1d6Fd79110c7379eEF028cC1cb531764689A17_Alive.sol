...
contract Alive is IERC20 {
    ...
    uint256 constant private startingSupply = 2_568_364_489;
    string constant private _name = "alive.vn";
    string constant private _symbol = "ALIVE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x818013c8f498A113E1E27635076A0c646b3D0Fbd),
        ops: payable(0x818013c8f498A113E1E27635076A0c646b3D0Fbd),
        staking: 0x818013c8f498A113E1E27635076A0c646b3D0Fbd
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 staking, uint16 ops, uint16 marketing) external onlyOwner {
        _ratios.ops = ops;
        _ratios.marketing = marketing;
        _ratios.staking = staking;
        _ratios.totalSwap = ops + marketing;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap + _ratios.staking <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable ops, address staking) external onlyOwner {
        require(marketing != address(0) && staking != address(0) && ops != address(0), "Cannot be zero address.");
        _taxWallets.marketing = payable(marketing);
        _taxWallets.ops = payable(ops);
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 opsBalance = (amtBalance * ratios.ops) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - opsBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: marketingBalance, gas: 55000}("");
        }
        if (ratios.ops > 0) {
            (success,) = _taxWallets.ops.call{value: opsBalance, gas: 55000}("");
        }
    }
