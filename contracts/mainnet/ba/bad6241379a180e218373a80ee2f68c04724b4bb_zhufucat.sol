...
contract zhufucat is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Zhufu Cat";
    string private _symbol = "ZhufuCat";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8C3518a7bE7509ecd08364d7F1a02F481b5d9317);
    address payable public liqWalletAddress = payable(0x8C3518a7bE7509ecd08364d7F1a02F481b5d9317);
