...
contract BabyCyberPunk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCyberPunk";
    string private _symbol = "BabyCyberPunk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A3F99C298609da68B76358BdF0c1104E17d6A01);
    address payable public teamWalletAddress = payable(0x1A3F99C298609da68B76358BdF0c1104E17d6A01);
