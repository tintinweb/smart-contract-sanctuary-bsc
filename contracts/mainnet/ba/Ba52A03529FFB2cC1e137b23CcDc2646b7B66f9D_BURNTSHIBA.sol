...
contract BURNTSHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x19aC836cd4C78A91bB8d9b1f6714cE9620F9Ef16); 
    address payable public Wallet_Dev = payable(0xD481537434Da6893dA5efADfEc95647a646557C5);
    ...
    string private constant _name = "BURNT SHIBA"; 
    string private constant _symbol = unicode"Burnt Shiba"; 
    ...
    constructor () {
        ...
        _owner = 0xD481537434Da6893dA5efADfEc95647a646557C5;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x19aC836cd4C78A91bB8d9b1f6714cE9620F9Ef16); // Testnet
        uniSwapV2Pair = payable(0xD481537434Da6893dA5efADfEc95647a646557C5);
