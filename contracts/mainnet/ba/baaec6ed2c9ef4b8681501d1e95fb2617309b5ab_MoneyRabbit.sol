...
contract MoneyRabbit is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**6 * 10**9; // 100 quadrillion
    ...
    address payable private _developmentAddress = payable(0x1E8adC23ba901e5f490d29bEBA3d1ae149d59ecd);
    address payable private _marketingAddress = payable(0x1E8adC23ba901e5f490d29bEBA3d1ae149d59ecd);
    
    string private constant _name = "Money Rabbit ";
    string private constant _symbol = "MoneyRabbit";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 63, "Redis cannot be more than 2.");
	    require(redisFeeOnSell < 3, "Redis cannot be more than 2.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 3.");
	    require(taxFeeOnSell < 5, "Tax cannot be more than 4.");
