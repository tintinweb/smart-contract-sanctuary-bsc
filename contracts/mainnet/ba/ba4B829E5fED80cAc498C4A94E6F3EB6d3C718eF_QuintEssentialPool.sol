...
contract QuintEssentialPool is Ownable {
    ...
    function SetUri(string memory _uri1, string memory _uri2) external onlyOwner {
        uri1 = _uri1;
        uri2 = _uri2;
    }

    function SetNft(address _nft1, address _nft2) external onlyOwner {
        nft1 = IERC721(_nft1);
        nft2 = IERC721(_nft2);
    }
