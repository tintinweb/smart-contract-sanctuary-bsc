...
contract DOGEFIGHTER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Fighter";
    string private _symbol = "DF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x678bCB0eF5d7DF31b94b7055a0652A92e0FE0f88); // 营销钱包
    address payable public teamWalletAddress = payable(0x678bCB0eF5d7DF31b94b7055a0652A92e0FE0f88); // 团队钱包
