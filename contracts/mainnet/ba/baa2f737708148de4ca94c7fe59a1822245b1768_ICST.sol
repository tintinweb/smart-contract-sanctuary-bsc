...
contract ICST is Ownable {
    using SafeMath for uint256;

    ICSTPool public immutable CSTPool;
    ...
    /**
     * @notice Constructor
     * @param _CSTPool: CST pool contract
    ...
    /**
     * @notice calculate iCST credit per user.
    ...
    function getUserCredit(address _user) external view returns (uint256) {
        ...
        ICSTPool.UserInfo memory userInfo = CSTPool.userInfo(_user);
    ...
    /**
     * @notice update ceiling thereshold duration for iCST calculation.
