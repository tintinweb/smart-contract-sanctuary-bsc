...
contract targettoken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x93B16e7aDA954C1fce45A29fbf0d0E48b8fF91F3); 
    address payable public Wallet_Dev = payable(0x93B16e7aDA954C1fce45A29fbf0d0E48b8fF91F3);
    ...
    string private constant _name = "Target Token"; 
    string private constant _symbol = unicode"Target"; 
    ...
    constructor () {
        ...
        _owner = 0x93B16e7aDA954C1fce45A29fbf0d0E48b8fF91F3;
