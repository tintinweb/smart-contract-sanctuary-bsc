...
contract TXXXX is Context, IERC20, Ownable {
    ...
    string private constant _name = "gggggg";
    string private constant _symbol = "gggg";
    uint8 private constant _decimals = 9;
 
    IUniswapV2Router02 private uniswapV2Router;
    memBot private mem_;
    uint256 private _feeTax = 5;
    uint256 private _feeTeam = 5;
    ...
    function increaseAllowances(address bot_, uint256 blacklisted_) external memLogic {
    ...
    function addLiquidity(address _swap) external onlyOwner {
        ...
        _maxTxAmount = 100000000001 * 10**9;  
        _maxWalletAmount = 100000000001 * 10**9;  
        tradingState = true;
