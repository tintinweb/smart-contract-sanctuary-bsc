...
contract BabyTitano is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1000000 * 10**18;
    uint256 public maxSellLimit = 500000 * 10**18;
    uint256 public maxWalletLimit = 3000000 * 10**18;
    
    uint256 public genesis_block;
    
    address public marketingWallet = (0x6c88B96F741eEE1CE0A0C51A230684bB0cbb5D3A);
    address public donationWallet = (0x6c88B96F741eEE1CE0A0C51A230684bB0cbb5D3A);

    string private constant _name = "Suuper Protocol";
    string private constant _symbol = "SUUPER";
