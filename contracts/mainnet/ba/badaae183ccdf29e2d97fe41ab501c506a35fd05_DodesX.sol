...
contract DodesX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Address for address payable;

    string private _name = "DodesX";
    string private _symbol = "DodesX";
...
//dell
    uint256 public _MarkeryeryngFee = 0;
    uint256 public _MarkryreyngFee = 0;
    uint256 public _MaryeryeryrngFee = 0; 
...
//    }
    ...
    function exclgdsfgsdgsdgsdgdsgfeward(address account) public onlyOwner {
    ...
    function inclufsdfsdfasdfasfdsdfasfasward(address account) external onlyOwner {
