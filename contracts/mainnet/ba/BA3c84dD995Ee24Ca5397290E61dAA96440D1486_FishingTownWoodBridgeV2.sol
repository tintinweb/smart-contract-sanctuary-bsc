...
// File: contracts/FishingTownWoodBridge.sol


pragma solidity 0.8.10;


contract FishingTownWoodBridgeV2 is BridgeBase {
    constructor(address _token) BridgeBase(_token) EIP712("FishingTownWoodBridge","1") {}
}