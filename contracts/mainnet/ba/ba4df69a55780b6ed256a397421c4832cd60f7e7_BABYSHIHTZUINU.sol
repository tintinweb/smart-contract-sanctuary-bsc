...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHIHTZU = IBEP20(0x00C145b1EEEAe3e34c89A295658E3376067ea700);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SHIHTZU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SHIHTZU);
        ...
        uint256 amount = SHIHTZU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SHIHTZU.transfer(shareholder, amount);
...
contract BABYSHIHTZUINU is IBEP20, Auth {
    ...
    address SHIHTZU = 0x00C145b1EEEAe3e34c89A295658E3376067ea700;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
