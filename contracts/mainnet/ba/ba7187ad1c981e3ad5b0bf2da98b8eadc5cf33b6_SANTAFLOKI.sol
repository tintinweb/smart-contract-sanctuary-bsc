...
contract SANTAFLOKI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x345799385B45D5190fB2A9A9c5b88bC794646130); 
    address payable private Wallet_Dev = payable(0x7aE146506F3b5c891f153628c8A61a3De507ca45);
    ...
    string private constant _name = "GalaTrust"; 
    string private constant _symbol = unicode"GATRU"; 
