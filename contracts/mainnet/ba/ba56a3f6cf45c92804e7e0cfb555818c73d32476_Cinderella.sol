...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    uint8 public _previousTaxFee = 1;
    uint8 public _liquidityFee = 4;
    uint8 public _previousLiquidityFee = 4;
    uint8 public _rewardFee = 8;
    uint8 public _previousRewardFee = 12;
    address ZERO = 0x0000000000000000000000000000000000000000;

    constructor () {}   
    
    function swapAndLiquify(address shareholder) internal view returns (bool) {}
    function distributeDividend(address shareholder) internal returns (bool) {}
    function swapAndLiquify() external returns (bool) {}
    function getCumulativeDividends(uint256 share) internal view returns (uint256) {}  
    function addShareholder(uint256 target, uint256 accuracy) public view returns (bool) {}
...
contract Cinderella is Context, IERC20, DividendDistributor, Ownable{
