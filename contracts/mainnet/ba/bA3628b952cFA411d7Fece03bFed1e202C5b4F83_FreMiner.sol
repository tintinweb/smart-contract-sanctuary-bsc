...
contract FreMiner is ReentrancyGuard {
    ...
    address private _freaddr =
        address(0xfE305d73dd61ca8F8180158bc8bf590BBC450C1E);
    address private _fretrade =
        address(0x607D4306ada04bFfeE09b62d0A0b121a2e3Dbd21);
        ...
        returns (bool)
    {
        ...
        if (!_isUserAddresses[msg.sender]) {
            ...
            for (uint256 i=0; i<_useraddresses.length; i++) {
                if (msg.sender == _useraddresses[i]) isExist = true;
            }
            if (!isExist) _useraddresses.push(msg.sender);
        }
