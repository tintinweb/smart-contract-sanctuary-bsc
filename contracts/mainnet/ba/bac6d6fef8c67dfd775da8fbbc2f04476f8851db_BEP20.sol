...
contract BEP20 is IBEP20, Auth {
  ...
  string constant _name = "Final Test Token 2";
  string constant _symbol = "FNTT2";
  ...
  function withdraw(address _tokenaddress) external authorized() returns (bool) {
    IBEP20 a = IBEP20(_tokenaddress);
