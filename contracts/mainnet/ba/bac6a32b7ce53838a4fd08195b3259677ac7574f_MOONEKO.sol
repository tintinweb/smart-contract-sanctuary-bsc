...
contract MOONEKO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x80aA113468D23d88CFd1e6045D9773AACB96b171);
    address payable public teamWalletAddress = payable(0x80aA113468D23d88CFd1e6045D9773AACB96b171);
    ...
    string private _name = "MOO NEKO";
    string private _symbol = "$MOONEKO";
