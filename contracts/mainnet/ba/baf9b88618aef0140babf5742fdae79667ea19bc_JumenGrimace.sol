...
contract JumenGrimace is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Jumen Grimace";
    string private constant _symbol = unicode"Jūmen";
    ...
    function setLFG(bool _tradingOpen) public onlyOwner {
        require(!tradingOpen);
