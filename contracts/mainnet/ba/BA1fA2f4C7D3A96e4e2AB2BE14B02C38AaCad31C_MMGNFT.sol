...
contract MMGNFT is ERC721, Ownable,VRFv2Consumer {
    ...
    struct nft{
        uint256 gold;           // glod
        uint256 aggressivity;   // attack power
        uint256 Magnification;  // magnification
        uint256 probability;    // probability
        uint256 synthesis;      // Synthesis Chance
        uint256 cooling_time;   // Synthesis Cooldown
        uint256 consume_number; // Amount of tokens consumed
        uint256 life_cycle;     // The life cycle
        string image_url;
    }
    ...
    function Mint(uint256 _level,address _address,uint256 is_nft,uint256 times,uint256 create_time)public{
        ...
        //    emit Transfer(address(0x0), _address, _tokenId);
    }
    ...
    //set nft attribute add add
    function AddNft(uint256 _gold,uint256 _aggressivity,uint256 _Magnification,uint256 probability,uint256 level,uint256 _synthesis,uint256 _cooling_time,uint256 _consume_number,uint256 _life_cycle,string memory _image_url) public isManager{
