        ...
        if (takeFee) {
            if (isSell) {
                ...
                if (sellFundFee > 0) {
                    ...
                    _takeTransfer(sender, receiveAddress, sellFundFee);
                }
            } else {
...
contract BOTCCion is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        "BOTC Cion",//Name
        "BOTC",//Symbol
        15000000 * 10**18,//Supply
        address(0x9c5185D21c1f936F339450ad1a0315DFeFF6bFA5),//FundAddress
        address(0x5545D8EF86eeC19593bA8E92DDCBe0a88a4a40D3),//ReceiveAddress
        address(0xfC0Eb3820e24B8Dc439861b0bCbC377BCe254527)//LPAddress
    ){
