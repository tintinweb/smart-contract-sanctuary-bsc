...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBB2E0Ce7f12FbceFD7037a1943A18400B910335e;
...
contract VecnaInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xBB2E0Ce7f12FbceFD7037a1943A18400B910335e);
    ...
    */
    ...
    string private _symbol = "$VecnaInu";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/500;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/500;
    }
