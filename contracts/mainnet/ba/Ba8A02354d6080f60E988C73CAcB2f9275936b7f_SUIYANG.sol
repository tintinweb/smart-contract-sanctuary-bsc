...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function transferaddress(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract SUIYANG is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "SUIYANG";
    string private _symbol = "SUIYANG";
   ...
   function list(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
