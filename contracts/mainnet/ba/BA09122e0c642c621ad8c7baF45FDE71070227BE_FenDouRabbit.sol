...
contract FenDouRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FenDouRabbit";
    string private _symbol = "FenDouRabbit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xbbB8838AafE71ba2e6331e5656EcdbE96adDeaB8); 
    address payable private teamWalletAddress = payable(0x7029EF8912C2830D0d90f2eA6bF63FAf369B9f64); 
