...
contract DividendDistributor  {
    ...
    // Tshare Token; 
    IERC20 EP = IERC20(0xB0D502E938ed5f4df2E681fE6E419ff29631d62b); // STARGATE FINANCE TOKEN

    // WFTM;
    address WFTM = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
...
pragma solidity ^0.8.7;
contract babyStarGateToken is Auth {
  ...
  string constant _name =  "Baby Stargate";    
  string constant _symbol = "BSTG"; // wen moon ?        
  uint8 constant _decimals = 9;

  uint256 _totalSupply = 1_000_000 * 10 * (10 ** _decimals);
  ...
  address public WFTM = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
