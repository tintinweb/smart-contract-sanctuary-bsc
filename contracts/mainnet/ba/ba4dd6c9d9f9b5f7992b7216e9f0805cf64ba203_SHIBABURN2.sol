...
\__ \ | __ | | |  | _ \  / _ \    | _ \| |_| ||   / | .` |  / /  _| () |  
|___/ |_||_||___| |___/ /_/ \_\   |___/ \___/ |_|_\ |_|\_| /___|(_)\__/
...
Hello world. Expect x's on this one. ;) 

ur 1 & only,
developer: @onelifedev
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract SHIBABURN2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA BURN 2.0";
    string constant _symbol = "SHIBABURN2";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF82992A60Ac86eCa18B3fE353Ec89B84227fC031;
        ecosystemfeeReceiver = 0xF82992A60Ac86eCa18B3fE353Ec89B84227fC031;
