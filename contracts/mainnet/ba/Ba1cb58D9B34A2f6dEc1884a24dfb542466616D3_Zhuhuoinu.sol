...
Zhuhuo referred to the highest members of the nobility of the Zhou period 周 (11th cent.-221 BCE)
*/
...
contract Zhuhuoinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zhuhuoinu";
    string private _symbol = "Zhuhuoinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x583f934E3063a8A91AA7302B76a43D0C6e2200c8); // Marketing Address
    address payable public teamWalletAddress = payable(0x75537539c4bc941a3d8594Ca6871CCf2fE24e439); // Team Address
