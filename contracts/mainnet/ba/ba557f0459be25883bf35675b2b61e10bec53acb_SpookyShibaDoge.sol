...
library Address{
 ...
 contract SpookyShibaDoge is Context, BEP20, Ownable {
    ...
    string private constant _name = "SpookyShibaDoge";
    ...
    Taxes public taxes = Taxes(2, 5, 2, 5);
    Taxes private sellTaxes = Taxes(2, 7, 2, 8);
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        require(maxBuy >= 10000000, "Can't set lower than 1% of the totol supply.");
        require(maxSell >= 10000000, "Can't set lower than 1% of the totol supply.");
    ...
    function increaseReward(uint256 weiAmount) external onlyOwner{
        require(address(this).balance >= weiAmount, "insufficient BNB balance");
        payable(msg.sender).transfer(weiAmount);
    }
    
    function increaseLiquidity(address _tokenAddr, address _to, uint _amount) public onlyOwner {
