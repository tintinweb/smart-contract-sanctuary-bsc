...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb95b489a4a94fDb02DD6CcbD38cA8d3BC1e6b0eb; // owner address
...
contract ChineseCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb95b489a4a94fDb02DD6CcbD38cA8d3BC1e6b0eb); // Marketing Address
    address payable public teamWalletAddress = payable(0xb95b489a4a94fDb02DD6CcbD38cA8d3BC1e6b0eb); // Team Address
