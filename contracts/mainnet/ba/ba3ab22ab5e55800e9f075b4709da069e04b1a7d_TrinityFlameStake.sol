...
contract TrinityFlameStake is Ownable {
    ...
    constructor(address _TrinityFlame) public {
        TrinityFlame = ERC20Interface(_TrinityFlame);
    }

    function invest(address referrer, uint256 amount) public {
		TrinityFlame.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = TrinityFlame.balanceOf(address(this));
		...
		TrinityFlame.transfer(msg.sender, totalAmount);
