...
contract myeggsinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MY EGGS INU"; // 
    string private constant _symbol = "EGGS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x811BEf982e29F18269FEEDCAA319577b7645B4Ef;
