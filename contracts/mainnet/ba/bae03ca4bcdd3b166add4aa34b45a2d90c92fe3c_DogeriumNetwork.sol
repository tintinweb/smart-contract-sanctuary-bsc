...
/**
   ...
   Dogerium is a decentralized project that is on the BSC network, 
Dogerium will also build an ecosystem for the benefit of the project and the community
    telegram portal calsil : https://t.me/dogeriumnetwork
*/
...
contract DogeriumNetwork is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x8B201AE459a054a1245E6Fc30Ce40D2A0Eb34deA));


    string private _name = "Dogerium Network";
    string private _symbol = "DRIUM";
