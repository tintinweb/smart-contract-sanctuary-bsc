...
// File: contracts/ERC20LateInit.sol
...
abstract contract ERC20LateInit is Context, IERC20, IERC20Metadata{
    ...
    /**
     * @dev Sets the symbol of the token, usually a shorter version of the
     * name.
     */
...
// File: contracts/ERC20LateBurnable.sol


pragma solidity ^0.8.0;

abstract contract ERC20LateBurnable is Context, ERC20LateInit {
    /**
...
// File: contracts/ERC20LatePausable.sol
...
// File: contracts/ERC20LateMinterPauser.sol


pragma solidity ^0.8.0;


contract ERC20LatePresetMinterPauser is Context, AccessControlEnumerable, ERC20LateBurnable, ERC20LatePausable {
     ...
     */
    constructor(string memory name, string memory symbol) ERC20LateInit(name, symbol) {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20LateInit, ERC20LatePausable) {
        super._beforeTokenTransfer(from, to, amount);
    }
}

// File: contracts/BridgeCoin.sol
...
// File: contracts/TacBridgeCoinFactory.sol
...
contract TacBridgeCoinFactory is Ownable {
    ...
    public onlyOwner {
//        address clone = createClone(libraryAddress, _name, _symbol);
        address clone = Clones.clone(libraryAddress);
         //= createClone(libraryAddress, _name, _symbol);
    ...
    function addBridgeCoin(string memory _name, string memory _symbol, uint256 _fee, address _coinAddr)
    public onlyOwner {
