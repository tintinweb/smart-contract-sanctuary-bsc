...
/*
$TSUBASA
TSUBASA OOZORA FAN TOKEN
LEGENDARY SOCCER ANIME CHARACTER
NOVEMBER 20th 2022 FIRST WORLD KICK-OFF 
------------------------------------------
...
telegram    : https://t.me/tsubasabsc
twitter     : https://twitter.com/tsubasabsctoken
DEV         : OxDudu
*/
...
contract TSUBASA is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("TSUBASA OOZORA", "TSUBASA") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x0D55066058Bc1016a8f2A024fB67DF354d1C987A); // CHANGE THIS TO YOURS
        devWallet = payable(0x59F3712D74eFa2D5d8d9C78FA122c99AaaB3756d); // CHANGE THIS TO YOURS
