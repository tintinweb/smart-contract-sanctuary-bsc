...
contract META2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Metaverse2.0";
    string private _symbol = "META2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE8FF4F3766FA547c94a55DFE14221f1516300817); 
    address payable public BurnedWalletAddress = payable(0xE8FF4F3766FA547c94a55DFE14221f1516300817); 
