...
/**
 * Website: https://www.catomicbomb.com/
 * Telegram : https://t.me/catomicbomb
 */
...
pragma solidity ^0.8.0;
contract CatomicBomb is ERC20, Ownable {
    ...
    constructor() ERC20("CatomicBomb", "CATBOMB") {
        _mint(msg.sender, 150000000*10**decimals());
        _mint(address(this), 850000000*10**decimals());
        startSale(block.number, 999999999, 0,2500*10**decimals(), 2000000000000);
