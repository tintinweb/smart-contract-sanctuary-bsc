...
/**
Welcome to Baby Ape Milk $BAM 

Baby Ape Milk $BAM is a meme token, 
this token is made for safe token seekers with auto reflection utility for holders.
Baby Ape Milk $BAM Will become a hype token by forming a strong community and supported by developers,
let's create a hype token

Telegram : https://t.me/BabyMilkyApe

Twitter : https://twitter.com/BabyMilkyApe
...
contract BabyMilkyApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Milky Ape"; //
