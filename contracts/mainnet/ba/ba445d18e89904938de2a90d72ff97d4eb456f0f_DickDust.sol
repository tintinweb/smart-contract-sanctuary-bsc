...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBBD932B38BAb6d01dB2a11D65d6aDeAf1cBE546A; // owner address
...
contract DickDust  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dick Dust";
    string private _symbol = "DD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02b0D6A39572b8bE2757bFD74546407B5bC1e673); 
    address payable public lotteryWalletAddress = payable(0x02b0D6A39572b8bE2757bFD74546407B5bC1e673); 
    ...
    uint256 public _lotteryShare = 10; 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBLiquidity).sub(amountBNBlottery);
