...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x187d9d124d00aa1d3Af7797850cD26f35ba7a7df;
...
contract SOLT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x42b0886d497B8D332D7F0E4C14D914669760E401;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SOLT Gaming";
 ...
 function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    ...
    function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
         ...
         require(developmentFee <= 20, "developmentFee is over 20%");
