...
contract NftMarket is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        require(_ttcToken.allowance(msg.sender,address(this))>getTokenFee(),'Insufficient authorization TTC');
         //划转手续费
        require(_ttcToken.transferFrom(msg.sender, _feeAddress,getTokenFee()),'TTC deduction failed') ;
