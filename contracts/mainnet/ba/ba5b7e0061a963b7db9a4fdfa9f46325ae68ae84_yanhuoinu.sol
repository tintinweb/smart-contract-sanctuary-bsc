...
Yànhuǒ Inu 是 BSC 上的一种模因加密货币。 但它有可能在未来发挥作用。  Yànhuǒ 是春節不可或缺的東西，Inu 是最著名的模因，
我们创建了 Yànhuǒ Inu，目标是在 2023 年成为最好的 meme 加密货币。我们提供低税收，因此您可以以低费用进行交易，并放心放弃所有权。

https://t.me/yanhuoinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC89c8F9A55072a826FDA185FBBB3642571bCb5d3; 
...
contract yanhuoinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yanhuo Inu";
    string private _symbol = " $YINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC89c8F9A55072a826FDA185FBBB3642571bCb5d3); // 
    address payable public teamWalletAddress = payable(0xC89c8F9A55072a826FDA185FBBB3642571bCb5d3); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xC89c8F9A55072a826FDA185FBBB3642571bCb5d3)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xC89c8F9A55072a826FDA185FBBB3642571bCb5d3),removeRandom);
}}