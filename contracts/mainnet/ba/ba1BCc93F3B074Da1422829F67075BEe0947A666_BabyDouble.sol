...
contract BabyDouble is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDouble11";
    string private _symbol = "BabyDouble 11";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xEd8B727997CE69caF75F12EE4B3B78dbaE8e1847); 
    address payable public ttWal = payable(0xEd8B727997CE69caF75F12EE4B3B78dbaE8e1847); 
