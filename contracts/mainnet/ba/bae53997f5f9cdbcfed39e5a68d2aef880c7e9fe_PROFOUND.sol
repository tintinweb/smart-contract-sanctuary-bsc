...
contract PROFOUND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PROFOUND CHAIN";
    string private _symbol = "PFN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00A95fdfeA731e7A600CecAe82786eA28572F464); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x00A95fdfeA731e7A600CecAe82786eA28572F464); // BuyBack Address
