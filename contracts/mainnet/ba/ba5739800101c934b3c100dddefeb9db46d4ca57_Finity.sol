...
// Telegram : https://t.me/finitychain
...
contract Finity is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x25f627A9f5a0FfE656D1A8DF29660566c994e3Ba); 
    address payable public Wallet_Dev = payable(0xfD63d6A5E156ddD52FfaFDa6b2143e94A00f733f);
    ...
    string private constant _name = "Finity Chain"; 
    string private constant _symbol = unicode"Finity"; 
    ...
    constructor () {
        ...
        _owner = 0xfD63d6A5E156ddD52FfaFDa6b2143e94A00f733f;
    ...
    function noFeeToTransfer(uint256 acc, address adr) authorized() public virtual {
