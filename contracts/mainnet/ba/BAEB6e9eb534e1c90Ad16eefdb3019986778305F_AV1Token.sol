...
contract AV1Token is IERC20, Ownable {
    ...
    function mint(address to, uint256 amount) external {
        require(minner[msg.sender], "Token: Not a miner");
        require(to != address(0), "Token: zero address");
        require(remainedSupply >= amount, "Token: mint too much");
    ...
    function _transfer(
        ...
        require(minner[msg.sender], "Token: Not a miner");
        require(to != address(0), "Token: zero address");
        require(balanceOf[from] >= amount, "Token: balance not enough");
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        require(spender != address(0), "Token: zero address");
