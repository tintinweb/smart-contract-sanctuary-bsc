...
contract Kineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kineko Coin";
    string private _symbol = "Kineko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e0e3714806DA417f5c03a5414a57848990C07e1);
    address payable public DevWalletAddress = payable(0x9e0e3714806DA417f5c03a5414a57848990C07e1);
