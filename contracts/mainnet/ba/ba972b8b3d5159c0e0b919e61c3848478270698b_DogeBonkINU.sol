...
contract DogeBonkINU is Ownable, IERC20 {
    ...
    string private _name = "DogeBonk INU";
    string private _symbol = "DOBOINU";
    ...
    uint256 public _totalSupply = 98500000 * 10 ** _decimals;
