...
contract elonged is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10_000_000_000 * (10 ** _decimals);
    uint256 _launchWalletMax = 100_000_000 * (10 ** _decimals);
    uint256 _launchmaxTxAmount = 100_000_000 * (10 ** _decimals);
    ...
    string constant _name = "ElonCUm";
    string constant _symbol = "eCUM";
    ...
    constructor() {
        ...
        marketingWallet = 0xc85408c0865E14A0825a6c19211e15D89eD12E31;
