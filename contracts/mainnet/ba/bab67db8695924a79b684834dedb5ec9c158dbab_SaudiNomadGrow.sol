...
contract SaudiNomadGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Nomad Grow";
    string private _symbol = "$SNG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F1CC042F108FefbF8B116Af3117DDd739F195e5);
    address payable public BuyBackWalletAddress = payable(0x5F1CC042F108FefbF8B116Af3117DDd739F195e5);
