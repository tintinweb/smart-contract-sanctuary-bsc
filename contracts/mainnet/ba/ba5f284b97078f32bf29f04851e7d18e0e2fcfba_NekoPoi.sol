...
Telegram : https://t.me/NekoPoi_Portal
Website  : TBA
...
contract NekoPoi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7E9e2d807F863f9274693719E33aAC9A83889a06); 
    address payable public Wallet_Dev = payable(0xDe94d8fB67f812adC911a7cEB71a5b4Fd172bE8D);
    ...
    string private constant _name = "NekoPoi"; 
    string private constant _symbol = unicode"$NEPOI"; 
    ...
    constructor () {
        ...
        _owner = 0xDe94d8fB67f812adC911a7cEB71a5b4Fd172bE8D;
