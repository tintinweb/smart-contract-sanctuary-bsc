...
contract BUSD_SpaceRobot {
    ...
    constructor() public {
        token = IBEP20(busd);
        commissionWallet = 0x11C658bC419ba6efF4fb8f73E7Fc876E75a89740;
        ceoWallet = 0x11C658bC419ba6efF4fb8f73E7Fc876E75a89740;
        plans.push(Plan(9, 170));
        plans.push(Plan(12, 150));
        plans.push(Plan(24, 120));
    ...
    function withdraw() public {
        ...
        emit Withdrawn(msg.sender, totalAmount);
         ...
         uint256 fee= SafeMath.div(SafeMath.mul(totalAmount,20),100);
         uint256 fee2=fee;
