...
/**
Hold2Earn Token - $H2O
is a deflation token on BSC Network, designed for earning passive income for holder by holding H2O token.

Total supply - 1,000,000,000

Token allocation:
- 50% supply on pancakeswap
- 10% supply Burn on launch
- 20% supply Next burn 
- 20% supply on Private Sale
...
Telegram : https://t.me/hold2earntoken

Website: https://holdtoearn.one/
*/
...
contract Hold2Earn is Context, Ownable, IERC20, IERC20Metadata {
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Hold2Earn: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "Hold2Earn: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "Hold2Earn: transfer to the zero address"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "Hold2Earn: mint to the zero address"
        );
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "Hold2Earn: burn from the zero address"
        );

        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "Hold2Earn: burn amount exceeds balance"
        );
        unchecked {
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "Hold2Earn: approve from the zero address"
        );
        require(
            spender != address(0),
            "Hold2Earn: approve to the zero address"
        );
