...
contract FomoMiner is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public constant min = 50 ether; //min deposite 50 busd
    uint256 public constant max = 5000 ether; //max deposite 5000 busd
    uint256 public roi = 16; //16% fixed daily reward
    uint256 public constant fee = 1; //4% marketing fee, 2% popcorn V2 fee = Total 6% Deposite Fee
    uint256 public constant withdraw_fee = 1; //Total 10% Withdraw Fee
    uint256 public constant ref_fee = 11; //referral reward 11%
    ...
    address public marketing = 0xF6f0deb1046932f51abE86A4E206A4330935238d;
    address public popV2 = 0x0Ba9f9A7273caab71D5FbF53992C001325594689;
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
       ...
       // fees 
        ...
        uint256 total_contract = SafeMath.sub(_amount,total_fee*6);
        BusdInterface.transferFrom(msg.sender,marketing,total_fee*4);
        BusdInterface.transferFrom(msg.sender,popV2,total_fee*2);
 ...
 function withdrawal() public noReentrant {
    ...
    require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,5), "You cant withdraw you have collected 5 times Already"); 
    ...
    uint256 totalAmountToWithdraw = SafeMath.sub(aval_withdraw2,wFee*10); 
    BusdInterface.transfer(msg.sender,totalAmountToWithdraw);
    BusdInterface.transfer(dev,wFee*5);
    BusdInterface.transfer(dev2,wFee*5);
    ...
    function unStake() external noReentrant {
        ...
        BusdInterface.transfer(marketing,UnstakeValueCore);
