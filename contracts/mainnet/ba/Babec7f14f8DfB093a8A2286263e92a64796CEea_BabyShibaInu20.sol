...
contract BabyShibaInu20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Baby Shiba Inu 2.0";

    string private _symbol = "BabyShibaInu2.0";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0x3c167965cE39026EECa1c52fa7142eB27e52E85C;
