...
// Only 1 community to the Mooooooon
pragma solidity ^0.8.4;
import "./Libraries.sol";
contract GreenWhaleS is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'GreenWhaleS';
    string private constant _symbol = 'GWHALES';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply= 1 * 10**_decimals;// Only 1 TOKEN  (1)
    ...
    uint public sellTax = 450;
    uint public transferTax = 0;
    uint public burnTax=0;
    uint public liquidityTax=750;
    uint public marketingTax=250;
    uint constant TAX_DENOMINATOR=1000;
    uint constant MAXTAXDENOMINATOR=10;
    uint public LimitV = 1;
    uint public LimitSell = 2;
