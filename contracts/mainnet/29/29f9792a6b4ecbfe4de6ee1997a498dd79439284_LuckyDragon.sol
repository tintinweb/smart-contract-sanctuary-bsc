...
contract LuckyDragon is ERC20, Ownable {
    ...
    constructor() ERC20("Lucky Dragon", "LUCKY") {
    	...
    	marketingWallet = address(0xD6858f54E1eBeF66448eDD34020AF214A6976D4A); // set as marketing wallet

    	devWallet = address(0xD6858f54E1eBeF66448eDD34020AF214A6976D4A); // set as developer wallet
