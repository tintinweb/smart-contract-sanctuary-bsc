...
contract Coindao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Coindao";
    string private _symbol = "Coindao";
    ...
    uint256 private _ruinShare = 2;
    uint256 private _teamShare = 4;

    uint256 private _airDropFee = 0;

    uint256 private _totalTaxIfBuying = 6;
    uint256 private _totalTaxIfSelling = 6;
    uint256 private _totalDistributionShares = 12;

    uint256 private _totalSupply = 15000 * 10**_decimals;
    uint256 public _maxTxAmount = 15000 * 10**_decimals; 
    uint256 public _walletMax = 15000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 15 * 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8970157F351a14DB2bce76CA805658A0B88E4777));
        ruinWalletAddress = payable(address(0xEaB6658055EE344E6EC4D5F22aD4Ef127eEb0000));
