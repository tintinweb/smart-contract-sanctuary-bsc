...
contract Ghost is Context, IERC20, Ownable {
    ...
    string private _name = "The Ghost of Kyiv";
    string private _symbol = "GHOST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12Eec2b2D41eCD66C7F337dA86204655FB963Ed7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb47a5F21ec18467ea0579e072eEEEa3DcD6A4Cf3); // Team Address
