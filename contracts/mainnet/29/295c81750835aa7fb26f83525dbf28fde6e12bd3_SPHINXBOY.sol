...
// 
//
// 📱 Telegram:https::https://t.me/+Ku862WVWvIY4MDQ1
...
contract SPHINXBOY is ERC20 {

    uint tokenTotalSupply = 800000; // 100 Million Token Supply

    constructor() public ERC20("SPHINX BOY", "SPHINXBOY") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SPHINXBOY";
    string private _symbol = "SPHINXBOY";
