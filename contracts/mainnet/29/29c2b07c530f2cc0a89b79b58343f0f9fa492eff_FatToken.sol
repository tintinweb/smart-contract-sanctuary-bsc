...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D981D6FdED9326569DD7558aE0B491b839fbB59; // owner address
...
contract FatToken is Context, IERC20, Ownable {
    ...
    string private _name = "789";
    string private _symbol = "789";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D981D6FdED9326569DD7558aE0B491b839fbB59); // 
    address payable public teamWalletAddress = payable(0x6D981D6FdED9326569DD7558aE0B491b839fbB59); // 
    ...
    uint256 private _totalSupply = 789 * 10**_decimals;
    uint256 public _maxTxAmount = 789 * 10**_decimals; 
    uint256 public _walletMax = 7 * 10**_decimals;
