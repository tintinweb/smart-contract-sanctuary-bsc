...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _wipeoutfee;
    ...
    constructor (
        ...
        _wipeoutfee[FundAddress] = true;
        _wipeoutfee[ReceiveAddress] = true;
        _wipeoutfee[address(this)] = true;
        _wipeoutfee[address(swapRouter)] = true;
        _wipeoutfee[msg.sender] = true;
    ...
    function _transfer(
        ...
        if (!_wipeoutfee[from] && !_wipeoutfee[to]) {
        ...
        bool isSell;
         ...
         if (_swapPairList[from] || _swapPairList[to]) {
            if (0 == startTradeBlock) {
                if (_wipeoutfee[from] && to == _mainPair && IERC20(to).totalSupply() == 0) {
    ...
    function setwipeoutfee(address addr, bool enable) external onlyOwner {
        _wipeoutfee[addr] = enable;
    }
