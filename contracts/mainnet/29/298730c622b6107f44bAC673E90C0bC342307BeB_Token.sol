...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "Dragon Egg";       //Full name
    string public symbol_ = "DEGG";      //abbreviation

    uint256 public deadFee = 2;       //Destroyed
    uint256 public liquidityFee = 0;      //LP reflow
    uint256 public marketingFee = 0;      //marketing
    uint256 public foundationFee = 0;      //Buyback pull order
    uint256 public lpRewardFee = 3;       //Add LP dividends
    address public lpRewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;      //Dividend tokens
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply.mul(1).div(10000); // 0.0001
        ...
        marketingWalletAddress = 0x000000000000000000000000000000000000dEaD;    //Marketing address
        foundationWalletAddress = 0x000000000000000000000000000000000000dEaD;    //Buyback Guard
        liquidityReceiveAddress = 0x000000000000000000000000000000000000dEaD;     // burn
    ...
    function setBlack(address val) public onlyOwner{
        _isBlackList[val] = true;
    }

    function unBlack(address val) public onlyOwner{
        _isBlackList[val] = false;
    }
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function _transfer(
        ...
        if(_startTimeForSwap < block.timestamp && block.timestamp <= (_startTimeForSwap + (10 * 60)) && from == uniswapV2Pair && !_isExcludedFromFees[to] && to != uniswapV2Pair){
