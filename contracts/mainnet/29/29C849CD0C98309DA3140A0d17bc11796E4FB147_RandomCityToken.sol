...
contract RandomCityToken is Initializable, ERC20Upgradeable {
    // ADDRESSESS -------------------------------------------------------------------------------------------
...
// 0x23E87E1793B17725a0c241b659A3b5fb89aE4914 remember to remove liq 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function initialize() public initializer {
       ...
       __ERC20_init("RandomCityToken", "RCT");
        ...
        //addresses
        zAddress = 0x4886848d7991b04DB9F959AcEdD9D15Fb3A7fc53; // fee wallet address
        blockchainDevelopmentTreasuryAddress = 0x4886848d7991b04DB9F959AcEdD9D15Fb3A7fc53; // fee wallet address
        utilityDevelopmentTreasuryAddress = 0x4886848d7991b04DB9F959AcEdD9D15Fb3A7fc53; // fee wallet address
        BUSDStakingRewardsTreasuryAddress = 0x4886848d7991b04DB9F959AcEdD9D15Fb3A7fc53; // fee wallet address
        // exclude from fees
        ...
        address currentRouter =  0x10ED43C718714eb63d5aA57B78B54704E256024E; //mainnet router
    ...
    // uint256 BUSDStakingRewardsTreasuryPercent;
        ...
        //zPercent
        uint256 zfShare = (currentBalanceBUSD * zPercent) / _feesRates;
        IERC20Upgradeable(BUSD).transfer(zAddress, zfShare);
