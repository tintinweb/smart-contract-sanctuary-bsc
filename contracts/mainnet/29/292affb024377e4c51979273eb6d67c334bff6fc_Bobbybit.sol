...
/** 
 ...
 Doxed Boy is riding the 8 bits with the safest possible contract ~
...
contract Bobbybit is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x927ef05A8615D8596575769405376C42d257bEF8;
 
    string constant _name = "Bobbybit";
    string constant _symbol = "$BOBIT";
