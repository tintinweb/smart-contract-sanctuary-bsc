...
contract ELONJUNE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_tTotal * 3) / 100; // 1% of total supply
    uint256 public _maxWalletSize = (_tTotal * 3) / 100; // 1% of total supply
    uint256 private SWAP_TOKENS_AT_AMOUNT = (_tTotal * 5) / 10000; // 0.05% of total supply
    string private constant _name = "ELONJUNE"; // 
    string private constant _symbol = "ELON6"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public eventTime = 0;

    uint256 public _marketingFee = 3; //5% tax fee
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xe919f7485C5c00b6824913A728C7AC2722C6a82b;
