...
//Telegram: https://t.me/TwelveDaysofChristmasBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd2AF8653114113D71a2fe04FE7AC0eAA2c552E8b; // owner address
...
contract TwelveDaysOfChristmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "12 Days of Christmas";
    string private _symbol = "GIFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xccdd63ceF70626fc940e070890c32AC083a96495); // Marketing Address
    address payable public teamWalletAddress = payable(0xccdd63ceF70626fc940e070890c32AC083a96495); // Team Address
