...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is BEP20 {
        ...
        constructor () BEP20("TWEETIES", "$TWII"){

            _marketingWalletAddress = 0xbEa0711b28f067052E51477C7f816eF08b22D4DC;
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (from == uniswapV2Pair) {
                ...
                super._transfer(from, _marketingWalletAddress,marketingTokens.add(liquidityTokens));
                super._transfer(from, to, amount);
