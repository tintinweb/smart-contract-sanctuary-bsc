...
/**
 *Multistake Powered by: Metadroidtoken.com
*/
...
contract Multistake_CREAP {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x2C9A2F2282C81ed4761E2792def9bE99d9A3e032; // MTD
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 10000 ether; // 10000 MTD
    ...
    uint256 public constant SPONSOR_FEE = 10;
