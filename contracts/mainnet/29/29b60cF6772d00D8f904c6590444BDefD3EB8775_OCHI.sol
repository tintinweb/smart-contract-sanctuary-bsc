...
// ORIGINAL OROCHI CODE

// https://orochi.fun
// https://t.me/OrochiCoin
// https://twitter.com/OrochiCoin
// https://medium.com/@orochicoin
...
contract OCHI is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 1e18; // KILL ZERO OROCHI
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Orochi"; // token name
    string public _symbol = "OCHI"; // token ticker
    ...
    uint256 private minTokenToSwap = 10000000 * 1e18; 
