...
contract Token is IERC20, Ownable {
    ...
    address private _fund1Address = address(0xb232632AE7869468faf92fD9c3cb0679f5aA2C46);
    
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    
	address fundAddress = address(0x73458c679213E496Dd9ddAA953aA3e1B6C0bD4B2);
    ...
    function changeRate(uint256 _fundRate,uint256 _fund1Rate) public onlyOwner {
		fundRate = _fundRate;
