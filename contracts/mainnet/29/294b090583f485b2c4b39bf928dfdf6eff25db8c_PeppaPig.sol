...
/**
    ...
    I make this # PeppaPig to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/PIGPEPPABSC
   ...
   I will renounce the ownership to burn addresses to transfer #PeppaPig to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #PeppaPig 10000000X? 
   ...
   it's the best part of the #PeppaPig idea, increasing the liquidity pool automatically, 
