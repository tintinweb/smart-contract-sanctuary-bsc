...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbb0850F7FAa540360Dc0d6429bE44961e0d912b4;
...
contract Teeds is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6F82ee6c7c07206841F29F9063B2c64CC747Ba61;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 680000000 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Teeds Token";
    string private _symbol = "TEEDS";
    ...
    uint256 public _maxTxAmount = 680000000 * 10**4;
    uint256 private numTokensSellToAddToLiquidity = 680000000 * 10**4;
