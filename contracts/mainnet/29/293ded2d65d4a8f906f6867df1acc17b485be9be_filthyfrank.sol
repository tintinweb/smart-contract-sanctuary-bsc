...
contract filthyfrank is Context, IERC20, Ownable {
    ...
    string private _name = "FilthyFrank";

    string private _symbol = "$KILLYOURSELF";
    ...
    address payable public marketingWalletAddress = payable(0xfa1DbE18d046cd827b23CeD28e5E8e16C7642CA9); // Marketing Address
    ...
    uint256 public _maxTxAmount = 50 * 10**6 * 10**9; //5%

    uint256 public _walletMax = 50 * 10**6 * 10**9; // 5%
