...
contract HELLUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HELLUNA";
    string private _symbol = "HELL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73b3a044c2E0EFc95a0B0C7b978f1C2992743d24); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x73b3a044c2E0EFc95a0B0C7b978f1C2992743d24); // Team Address
