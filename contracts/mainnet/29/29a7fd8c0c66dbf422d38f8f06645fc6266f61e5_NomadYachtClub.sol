...
contract NomadYachtClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nomad Yacht Club";
    string private _symbol = "$NYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE5442c211103a872ac4C48794B921cEA8987d689);
    address payable public BuyBackWalletAddress = payable(0xE5442c211103a872ac4C48794B921cEA8987d689);
