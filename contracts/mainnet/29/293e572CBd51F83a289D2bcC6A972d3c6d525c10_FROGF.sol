...
contract FROGF is BEP20Detailed, Ownable, WhitelistedRole {
    ...
    address public fmarketingValueReceiver;
 ...
 uint256 public maxSellTransactionAmount = INITIAL_FRAGMENTS_SUPPLY;
    ...
    constructor() BEP20Detailed("Frog Family", "FROGF", uint8(DECIMALS)) {
...
fmarketingValueReceiver=msg.sender;
        ...
        _isFeeExempt[fmarketingValueReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToRFV > 0){
            _swapTokensForBusd(amountToRFV, fmarketingValueReceiver);
        }
    ...
    function setFeeReceivers(address _liquidityReceiver, address _DevelopmentReceiver, address _fmarketingValueReceiver) external onlyOwner {
        liquidityReceiver = _liquidityReceiver;
        DevelopmentReceiver = _DevelopmentReceiver;
        fmarketingValueReceiver = _fmarketingValueReceiver;
    }
