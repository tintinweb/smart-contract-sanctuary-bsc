...
contract miya is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function iniOwnership(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
    ...
    function getchangeTxSet(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function getchangeDistributionSet(
    ...
    function getchangeMultiplierSet(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
