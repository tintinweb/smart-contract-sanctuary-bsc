...
contract Hiruzen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hiruzen BSC";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "HRZ";
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xc564c18140A4E176b486287a899B7fda173264f3;
        marketingFeeReceiver = 0xc564c18140A4E176b486287a899B7fda173264f3;
