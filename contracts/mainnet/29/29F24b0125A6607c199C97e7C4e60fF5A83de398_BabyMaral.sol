...
Telegram: https://t.me/BabyMaralOfficial
...
contract BabyMaral  is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_666_666_666 * 10**_decimals;
    
    uint256 public maxSellAmount = 125_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 1_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 1_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x4cF5dCB497A93917f357636421ADf47033252996;
    address public devAddress = 0x4707a547E8eE4F9573c5F2A026C702661714EA58;

    string private constant _name = "Baby Maral";
    string private constant _symbol = "BMRL";
    ...
    // Owner cannot transfer out BMRAL from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out BMRAL!");
