...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x67206c97Edc7fA7A1D3D97A2826bC41163170092; // owner address
...
contract NoLimitsSystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"No Limits System";
    string private _symbol = unicode"NLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67206c97Edc7fA7A1D3D97A2826bC41163170092); // Marketing Address
    address payable public teamWalletAddress = payable(0x67206c97Edc7fA7A1D3D97A2826bC41163170092); // Team Address
