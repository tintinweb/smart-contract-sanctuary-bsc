...
contract Asprx is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe7A911CEEcABC2385aeb1F437805027ED4b7bAD5); 
    address payable public marketingAddress2 = payable(0xe7A911CEEcABC2385aeb1F437805027ED4b7bAD5); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xe7A911CEEcABC2385aeb1F437805027ED4b7bAD5);
    ...
    uint256 private minimumTokensBeforeSwap = 2800 * 10**_decimals; 
