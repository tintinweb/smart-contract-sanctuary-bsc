...
contract TokenInformation {
  ...
  function getInfoTokens(address[] calldata tokens, address user, address tokenSwapOne, address tokenSwapTwo, address router) public view returns (SecondTokenInfomationStruct[] memory){
      SecondTokenInfomationStruct[] memory secondtokeninfostruct;
