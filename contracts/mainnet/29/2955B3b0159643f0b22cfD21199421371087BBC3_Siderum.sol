...
contract Siderum is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Siderum";
    string private constant _symbol   = "SDRM";
    uint8  private constant _decimals = 18;
    
    uint256 public _taxFee       = 400; // 4% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 400; // 4% of every transaction will be converted into BNB
    uint256 public _marketingFee      = 200; // 2% of every transaction is marketing

    uint256 public _maxTxAmount                   = 10000000000 * 10**18;
    uint256 public _numTokensSellToAddToLiquidity = 10000000 * 10**18;
    ...
    function setMarketingFeePercent(uint256 burnFee) external onlyOwner {
        _marketingFee = burnFee;
    }
