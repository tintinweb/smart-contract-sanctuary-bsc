...
//address
    ...
    address public marketingAddress = 0xd31017C4E38d2EE5E5E6A59B9335F59595c43D88;
    address public devAddress = 0x3dA8733A541C15ce2210Aee3ff2D615AfEAa704c;
    address public teamAddress = 0x033B124f4cA6710b6d6c2E7856c13EF02715eA42;
    address public liquidityAddress = 0xd31017C4E38d2EE5E5E6A59B9335F59595c43D88;
//uint
...
// constructor
    constructor() ERC20("Grow Up", "GROWUP") {
        ...
        maxWalletAmount =  total_supply / 100; // 1% supply
        //spawn pair
...
//set functions
    ...
    function setMaxSellTxAmount(uint _value) external onlyOwner {
        ...
        require(maxSellTxAmount >= totalSupply() / 100,"maxSellTxAmount should be at least 0.5% of total supply.");
        emit MaxSellChanged(_value);
    }
    function setMaxBuyTxAmount(uint _value) external onlyOwner {
        maxBuyTxAmount = _value*10**decimals();
        require(maxBuyTxAmount >= totalSupply() / 100,"maxBuyTxAmount should be at least 0.5% of total supply.");
