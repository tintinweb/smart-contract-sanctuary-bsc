...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C699957cb27BaC87127FAf78154941026e39A7C; //
...
contract WolfDAO is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 9500 * 10**9; //
    string private constant _name = "Wolf DAO"; // 
    string private constant _symbol = "$wDao"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x0C699957cb27BaC87127FAf78154941026e39A7C); //
