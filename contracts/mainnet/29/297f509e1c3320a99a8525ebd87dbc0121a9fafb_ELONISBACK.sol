...
Community is free to make their own TG for discussion.
Simple tokenomics, 7% in, 12% out. 
Taxes are used for buy backs.
Apart from 2% to LP.
Tokens will then be used for burns/lp adds/giveaways via BSCSCAN only.

Telegram Channel only, buybacks in unknown intervals.

https://twitter.com/FreeSpeechBSC
https://t.me/FREESPEECH_BSC


ELON'S BUY OVER TWITTER HAS STARTED A FRESH NEW BULLRUN. IT'S TIME TO SEND ALL THINGS MEME TO THE MOON.
...
contract ELONISBACK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON'S BULLRUN";
    string private _symbol = "FREESPEECH";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4581be18cD63c562CD28f4FB82AC6a4E51f7B93f); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x4581be18cD63c562CD28f4FB82AC6a4E51f7B93f); // Buyback Wallet Address
    ...
    uint256 public _walletMax = 3000000000 * 10**9; // 3%
