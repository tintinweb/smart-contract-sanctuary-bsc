...
contract GALA is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0xCFf600cA14Fea4f08D4FE1027F6BE50CCC49b36C)); // MarketingWallet
    ...
    constructor() ERC20("GALA 2.0", "GALA2") {
