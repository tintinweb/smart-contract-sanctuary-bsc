...
contract DinosaurBSC  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7732AeFD46e4A9F7c9080c240d82692df2010dC0); // Marketing Address
    ...
    string private _name = "DinosaurBSC";
    string private _symbol = "DBSC";
