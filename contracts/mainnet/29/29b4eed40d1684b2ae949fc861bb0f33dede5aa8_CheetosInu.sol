...
/**
*
Telegram: https://t.me/cheetosinuportal
Twitter: https://twitter.com/cheetosinu
...
contract CheetosInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheetos Inu";
    string private _symbol = "CHEETOS";
