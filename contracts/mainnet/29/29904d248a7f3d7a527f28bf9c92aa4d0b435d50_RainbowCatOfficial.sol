...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1F65700d8092339A2b734fDE9C352E5F583795d; // owner address
...
contract RainbowCatOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RainbowCat";
    string private _symbol = "RC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA1F65700d8092339A2b734fDE9C352E5F583795d); // Marketing Address
    address payable public teamWalletAddress = payable(0xA1F65700d8092339A2b734fDE9C352E5F583795d); // Team Address
