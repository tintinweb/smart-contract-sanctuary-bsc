...
contract ERC20 is Context, IERC20, Ownable{
    ...
    constructor(address router)  {    
        ...
        previousDevelopmentFee = 24;
        liquidityFee = 16;
        previousLiquidityFee = 8;        
...
contract CarlosCorrea is ERC20{    
	using SafeMath for uint256;
    ...
    constructor(address router) ERC20(router)  { 
        ...
        buybackNumerator = 10;
        buybackDenominator = 10;
        buybackTriggeredAt = 15;
        buybackMultiplier = 33;
