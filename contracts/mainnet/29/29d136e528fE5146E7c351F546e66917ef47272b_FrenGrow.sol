...
Frens grow together
Join us as we launch the frienliest token on the binance smart chain
...
contract FrenGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "FrenGrow";

    string private _symbol = "FRENGROW";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xBFBeC35527F848baF2C41da5BC3288Cc2Ef23A9b;
