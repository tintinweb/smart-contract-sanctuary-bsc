...
contract ALLYToken is ERC20("ALLY", "ALLY"), Ownable {
    ...
    uint256 private _totalSupply = 4999 * (10**_decimals);
    ...
    address public foundtionWallet = 0x198bA256cdCBaEDD62a8D380fa8D0B7DcaDBeC67;
    ...
    constructor() {
        ...
        liquidityWallet = 0x6Cd96DCb8231dD74F4Bf138AF9de7B0Be72555f3;
    ...
    function _takeFees(address sender, address recipient, FeeInfo memory _feeInfo) private {
        if (_feeInfo.rBurn > 0) {
            uint256 endTotal =  1299 * 10**decimals();
    ...
    function _tokenTransferWithFee(
        ...
        if (!limitExcluded[recipient]) {
            require(balanceOf(recipient) <= 30 * 10 ** decimals(), "LIMIT REACHED");
        }
