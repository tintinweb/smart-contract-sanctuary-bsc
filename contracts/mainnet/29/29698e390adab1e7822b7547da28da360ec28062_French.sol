...
contract French is Context, IERC20, Ownable {
    ...
    string private _name = "French Token";
    string private _symbol = "French";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2e0C81384226aaEe53dc8530297d8a910F82A3FF); 
    address payable public BurnedWalletAddress = payable(0x2e0C81384226aaEe53dc8530297d8a910F82A3FF); 
