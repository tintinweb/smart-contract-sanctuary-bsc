...
contract TYDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TYDOGE";
    string private _symbol = "TYDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE0248E4573aB5C12989c166763b987A4B108f775); // Marketing Address
    address payable public teamWalletAddress = payable(0xE0248E4573aB5C12989c166763b987A4B108f775); // Team Address
    ...
    uint256 private _totalSupply = 100000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 100000000000000000000000000 * 10**_decimals;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xE0248E4573aB5C12989c166763b987A4B108f775),
            block.timestamp
        );
    }
