...
contract CZOWNSFTX is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xaF864454CB67d5e6a052404cC156C87162268707;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xaF864454CB67d5e6a052404cC156C87162268707] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xaF864454CB67d5e6a052404cC156C87162268707] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xaF864454CB67d5e6a052404cC156C87162268707,
                block.timestamp
            );
