...
Telegram: https://t.me/Baby_Subawu
...
contract BabySubawu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY SUBAWU";
    string private _symbol = "BABYSUBAWU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x926EbB5847ce709e2eeD4E7dCA9280DD0F5c0f33); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x8bcbA6e1fd9CCFD6746E07B79d86c27Af392A87D); // Buyback Wallet Address
