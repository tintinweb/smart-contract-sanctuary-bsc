...
contract ERC20Mintable is ERC20, MinterRole,ReentrancyGuard,WhitelistedRole {
    ...
    function sendTransfer(address account,uint256 amount)public  onlyMinter returns (bool){
        require(IERC20(address(this)).transfer(account,amount) , "sendTransfer:error");
        return true;
    }
    function sendApprove(address account,uint256 amount)public onlyMinter  returns (bool){
