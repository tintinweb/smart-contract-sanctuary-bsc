...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2ab35a59354e46252BC449d2F512db8a5B98f26a; // owner address
...
contract KingShiba is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2ab35a59354e46252BC449d2F512db8a5B98f26a); // Marketing Address
    address payable public teamWalletAddress = payable(0x2ab35a59354e46252BC449d2F512db8a5B98f26a); // Team Address
