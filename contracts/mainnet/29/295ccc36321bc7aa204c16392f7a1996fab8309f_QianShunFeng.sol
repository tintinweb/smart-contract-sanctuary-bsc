...
contract QianShunFeng is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "QianShunFeng";
    string private _symbol = "QSF";
    uint8 private _decimals = 9;

    uint8 public liquidityQianShunFengBuy;
    uint8 public liquidityQianShunFengSell;
    uint8 public liquidityQianShunFengBurn;
    uint8 public liquidityQianShunFengBuyBack;
    ...
    constructor(address _view) Ownable(_view) {
        ...
        liquidityQianShunFengBuy = 5;
        liquidityQianShunFengSell = 2;
        liquidityQianShunFengBurn = 1;
        liquidityQianShunFengBuyBack = 8;
