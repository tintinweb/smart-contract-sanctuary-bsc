...
contract Portugal is ERC20 {
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) public blackList;
    address public tokenOwner =
        address(0xa452794Bf14CCc320Ae42FE0Ffe2B8a3612FDf7a);
    address public fundAddr =
        address(0xeC36a0dAC260750e9D4D8c15313d9A7d2afEbb37);

    uint256 public marketPercent = 1000;

    constructor() ERC20("Portugal", "Portugal") {
