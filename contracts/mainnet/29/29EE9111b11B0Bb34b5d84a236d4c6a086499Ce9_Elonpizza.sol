...
/**
   ...
   #Elonpizza will list on #BSC 

   I make this #Elonpizza to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/Elonpizzabsc

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #Elonpizza to the community and ensure it's 100% safe.

   I will burn 60% of the supply to dead address
   I will add 2 BNB and 40% of the total supply to the pool
   Can you make #Elonpizza 10000000X? 
...
pragma solidity ^0.6.12;
    ...
    contract Elonpizza is Context, IERC20, Ownable {
        ...
        string private _name = 'Elonpizza';
        string private _symbol = 'Elonpizza';
