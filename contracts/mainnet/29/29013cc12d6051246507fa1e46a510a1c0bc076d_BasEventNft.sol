...
// File: contracts/BAS/NFTs/BasNft/BasNft.sol
...
contract BasEventNft is ERC721Enumerable, Ownable {
    ...
    constructor(string memory name, string memory symbol, string memory _tokenURIString) ERC721(name, symbol) {
