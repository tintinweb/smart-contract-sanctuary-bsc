...
contract USDT_PizzaTower {
    ...
    function addCoins(address ref, uint256 value) initialized external {
        ...
        uint256 valueToManager = (value * 4) / 100;        //Manager fee 4%
        ...
        USDT_TOKEN.transferFrom(msg.sender, manager, valueTomarketing1_);
        USDT_TOKEN.transferFrom(msg.sender, manager, valueTomarketing2_);
