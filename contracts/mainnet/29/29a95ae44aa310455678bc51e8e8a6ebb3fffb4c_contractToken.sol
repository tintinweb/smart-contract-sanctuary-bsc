...
contract BEP20 is Context, Ownable, IBEP20 {
	...
	constructor ()  {
        ...
        isExcludedFee[0xBd7775aFe205D5d9d6A0E4b30455FE9BAC805C40] = true;
	...
	function swapBack() internal swapping {
        ...
        IBEP20(USDT).transfer(0xa8d23fACB034D142eC6C6d45e311d0a6b122feDf,m1);
        IBEP20(USDT).transfer(0xf9D94F296f942040D7ea087d9f5264dC5eD435dE,m1);
        IBEP20(USDT).transfer(0x71fB54F04a9f58aCe4Bf677e6a212C3df9Df1BAC,u_balance - (2 * m1));
	}
    ...
    function _transfer(address sender, address recipient, uint _amount) internal {
        ...
        if(block.timestamp < startTime){
            require(isExcludedFee[sender] || isExcludedFee[recipient],'');
        }
...
contract contractToken is BEP20Detailed {
    ...
    constructor() BEP20Detailed("SXZ", "SXZ", 9)  {
        deployTime = block.timestamp;
        _totalSupplyA = 66666  * (10**9);
		_totalSupplyB = 66666  * (10**9);
        _totalSupplyC = 66666  * (10**9);
        T = 0xFcD7b37fc6971cDE0Ab3C866310C104db2940D72;
