...
contract MuuInuTwo is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuuInuTwo";
    string private _symbol = "MINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfd57351Ea437F95DeD3666449D151c32eE100436); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xfd57351Ea437F95DeD3666449D151c32eE100436); // BuyBack Address
