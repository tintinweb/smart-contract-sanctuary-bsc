...
//*
/* This is Like 1000x - More than a meme coin.
...
contract like1000x is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x79E97B3C8D202E297565739B37B526ca7442Fedb; 
    address MARKET = 0x923A97Fe783D442682cFb7b4cdF30e09F73Bfe6A;

    string constant _name = "Like 1000x";
    string constant _symbol = "LIKE";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10000 * 10**5 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = address(MARKET);
