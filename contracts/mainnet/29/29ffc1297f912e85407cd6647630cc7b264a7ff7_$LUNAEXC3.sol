...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LunaRWD = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LunaRWD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LunaRWD);
        ...
        uint256 amount = LunaRWD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LunaRWD.transfer(shareholder, amount);
...
contract $LUNAEXC3 is IBEP20, Auth {
    using SafeMath for uint256;

    address LunaRWD = 0x156ab3346823B651294766e23e6Cf87254d68962;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
