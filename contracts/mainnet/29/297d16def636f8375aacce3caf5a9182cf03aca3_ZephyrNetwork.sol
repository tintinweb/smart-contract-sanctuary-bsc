...
contract ZephyrNetwork is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x4146C5C0ef1c1563aCB103919816B1d74a54DeCc);
    address payable private _marketingAddress = payable(0x4146C5C0ef1c1563aCB103919816B1d74a54DeCc);
