...
contract LohHieTuzi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Loh Hei Tuzi"; // 
    string private constant _symbol = "TUZI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x53d9A0fdCEf25ce899F47f97a195884533552eD5; 
