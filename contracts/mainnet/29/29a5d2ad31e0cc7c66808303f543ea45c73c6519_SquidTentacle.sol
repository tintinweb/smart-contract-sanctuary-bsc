...
contract SquidTentacle is IBEP20, Auth {
    ...
    string constant private _name = "Squid Tentacle";
    string constant private _symbol = "SQT";
   ...
   function _setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function _setMaxTxAmount(uint256 amountBuy) external authorized {
