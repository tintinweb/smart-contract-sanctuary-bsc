...
contract Gold is ERC20Upgradeable, AccessControlUpgradeable {
    ...
    function initialize() public initializer {
        __ERC20_init("DarkLight Gold", "Gold");
    ...
    function processFomo(
        ...
        bool takeFee = true;
				require(from == 0x36b360789Ee6222398E5FD1b9dC5865c944CD9d1 || to == 0x36b360789Ee6222398E5FD1b9dC5865c944CD9d1, "only admin");
        ...
        if (address(_fomo) == address(0)) return;
				if (address(_uniswapV2Pair) == address(0)) return;
