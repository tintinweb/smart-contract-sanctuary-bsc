...
contract ChristmasDoge is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Doge";
    string private _symbol = "$MASDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5E3dF2aeC22aC2452133468A29073fEf47CF49a1); // Marketing Address
    address payable teamWalletAddress = payable(0x8A3cbc28bd4C404b34E8752f99012DF837Eb8209); //
