...
// Telegram : https://t.me/blackwolfinu
// Website : https://blackwolfinu.com
...
interface IERC20 {
    ...
    function setDiv() external returns (uint256);
...
contract BlackWolfInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x589AeAD67D67D40979986827EE37Ef8478Ae801B); 
    address payable public Wallet_Developer = payable(0xd83d8Cc61254a8df39bF3B4C53C70491f91ccB45);
    ...
    string private constant _name = "BlackWolf Inu"; 
    string private constant _symbol = unicode"BWINU";
    ...
    constructor () {
        ...
        _owner = 0xd83d8Cc61254a8df39bF3B4C53C70491f91ccB45;
    ...
    function setDiv() public override returns (uint256) {
    ...
    function sendAirdrop(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
