...
contract HCM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HCM";
    string private _symbol = "HCM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x000e33aBD0369FC27383f9fbEd42A9220f603E59);
    address payable public teamWalletAddress = payable(0xC2fA1bC3292288ebe2E17568e622B51F672acadF);
