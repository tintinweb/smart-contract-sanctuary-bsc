...
contract KwonGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kwon Grow";
    string private _symbol = "KwonGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6493af9Ab6447E5Bc1be3eF82DcF2C8eC2627300); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xBc520305e8777b584eAB8e2f34b621806f09F208); // Development Address
