...
contract NewUniswapV2Router is AugustusStorage, IRouter {
    ...
    function _swap(
        ...
        bool tokensBoughtEth = transferTokenFromUserToPair(
            tokenIn, 
            amountIn, 
            weth, 
    ...
    function crossChainSend(
        ...
        uint256 valueToSend = IFeeCalculator(address(this)).getDeBridgeFee();
