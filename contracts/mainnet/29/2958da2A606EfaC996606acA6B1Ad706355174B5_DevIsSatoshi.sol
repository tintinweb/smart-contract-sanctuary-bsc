...
Telegram: https://t.me/DevisSatoshiBtc
*/
...
contract DevIsSatoshi is IBEP20, Auth {
    ...
    string constant _symbol = "DEVSATOSHI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 2 ) / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9792F09DDD894A5E50D5b5F92Adb8c051F07a596;
