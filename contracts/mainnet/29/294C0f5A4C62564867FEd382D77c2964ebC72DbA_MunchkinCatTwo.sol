...
contract MunchkinCatTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Munchkin Cat 2.0";
    string private constant _symbol = "MunchkinCat 2.0";
