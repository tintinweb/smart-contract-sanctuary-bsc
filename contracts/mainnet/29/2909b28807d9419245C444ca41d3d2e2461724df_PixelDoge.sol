...
contract PixelDoge  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 1000000000 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x26b0941bD159f63E07398F7abB46A429cEC778d1)); //marketing wallet
...
uint256 public gasForProcessing = 300000;
    ...
    constructor() ERC20("Pixel Doge", "Pixel Doge") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Pixel Doge_Dividend_Tracker", "Pixel Doge_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 20000000000 * (10**9); //must hold 20000000000+ tokens
    }
