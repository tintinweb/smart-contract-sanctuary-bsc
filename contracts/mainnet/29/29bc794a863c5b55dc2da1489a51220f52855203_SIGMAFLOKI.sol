...
contract SIGMAFLOKI is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Sigma Floki";
    string constant _symbol = "SIGMAFLOKI";
    ...
    address public marketingFeeReceiver = 0x2e438195f67AF28297e93Eb699B4b4045195b661;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 700;
    bool inSwap;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x2e438195f67AF28297e93Eb699B4b4045195b661] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x2e438195f67AF28297e93Eb699B4b4045195b661] = true;
