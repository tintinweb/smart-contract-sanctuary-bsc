...
contract Imperial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Imperial Cat";
    string private _symbol = "THEcat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14040cf81c77193E978998d1c33706fdEBf60a98); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x477c751E95F420cB4F006fC8caF41DC48D865850); // BuyBack Address
