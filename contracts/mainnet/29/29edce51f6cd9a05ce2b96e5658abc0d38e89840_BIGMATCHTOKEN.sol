...
contract BIGMATCHTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIG MATCH TOKEN";
    string private _symbol = "BMT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEab9B1F69d4376fd9a3b1cB169F6E6D31506a644);
    address payable public teamWalletAddress = payable(0xEab9B1F69d4376fd9a3b1cB169F6E6D31506a644);
