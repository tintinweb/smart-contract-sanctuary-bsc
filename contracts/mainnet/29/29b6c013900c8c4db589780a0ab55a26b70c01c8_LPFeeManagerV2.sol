...
contract LPFeeManagerV2 is SweeperUpgradeable {
    ...
    function initialize(
        ...
        __Ownable_init();
        router = IGlobalRouter02(_router);
        factory = IGlobalFactory(router.factory());
    ...
    function removeLiquidityTokens(
        ...
        for (uint256 i = 0; i < _lpTokens.length; i++) {
            IGlobalPair pair = IGlobalPair(_lpTokens[i]);
