...
contract ArabianShibaGrow is Context, IBEP20, Ownable {
    ...
    string private _name = "ARABIAN SHIBA GROW"; // token name
    string private _symbol = "ASHG"; // token ticker
    ...
    uint256 public marketWalletFeeOnSelling = 14;
