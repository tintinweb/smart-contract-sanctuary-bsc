...
contract Follow is Context, IERC20, Ownable {
    ...
    string private _name = "Follow";
    string private _symbol = unicode"Follow🐰";
    ...
    uint256 private _maxTxAmount = 1000000000000000000000000000000000000000000000 * 10**_decimals;
    uint256 private _maxWalletSize = 1000000000000000000000000000000000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xCa0d0239549aF4261606a1dCB8B82C9a22ef732F));
        marketingWallet = payable(address(0xCa0d0239549aF4261606a1dCB8B82C9a22ef732F));
