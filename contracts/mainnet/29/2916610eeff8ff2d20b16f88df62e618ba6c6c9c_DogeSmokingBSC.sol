...
Welcome to DogeSmokingBSC! 
DogeSmokingBSC is a  project based on the Binance Smart Chain. Also, this project is Elon Tweet inspired. We build cool and useful utility. Soon, you will be able to manage your rewards in our own User Dashboard! Lottery will be also added! 
 
With based/experienced Dev and marketing plans before and after launch.  
  
🔱TOKENOMICS🔱  
🔥Token name: DogeSmokingBSC
🔥Symbol: $DSB
🔥Supply: 6,000,000,000.
...
contract DogeSmokingBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeSmokingBSC";
    string private constant _symbol = "DSB";
