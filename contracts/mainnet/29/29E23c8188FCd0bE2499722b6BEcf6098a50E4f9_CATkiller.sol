...
contract CATkiller is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x90579cc8DF6b2DD48c8c87C8eC909011b6cCa47D);
    address payable public teamWalletAddress = payable(0x598F2c5E4e900A4cEc82E4CFb639596C5f4fA000);
    ...
    uint256 private _totalSupply =  312000000 * 10**_decimals;
    uint256 public _maxTxAmount =   312000000 * 10**_decimals;     
    uint256 public _walletMax =     312000000 * 10**_decimals;      
