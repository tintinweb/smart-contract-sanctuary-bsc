...
contract Token is ERC20, Ownable {
    ...
    address public usdt;
    address public marketingAddress = 0x335c56e9beD7a9EBe8552D29c4427B0Bec86F437;
    address public receiveAddress = 0x8E83202C5787091Fd0ea5B9f72ed975CA0D10a7E;
    ...
    function setSellFee(uint256 _sellFeeFee) external onlyOwner {
        sellFee = _sellFeeFee;
    }

    function setBuyFeeAndSellFee(
        uint256 _buyFee,
        uint256 _sellFeeFee
    ) external onlyOwner {
        buyFee = _buyFee;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if (!_isExcludedFromFees[from])
                if (amount >= balanceOf(from)) amount = amount.sub(1);
        }
        ...
        if (takeFee) {
            ...
            if (from == pancakePair) {
                ...
                if(buyFee != 0){
                    ...
                    super._transfer(from, address(marketingAddress), fees);
                }
