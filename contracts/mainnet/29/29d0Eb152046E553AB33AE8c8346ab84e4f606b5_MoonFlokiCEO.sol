...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2dc99dAD3F4b7A54772376864517f54DDA17621B; 
...
contract MoonFlokiCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256; //
    using Address for address;
    
    string private _name = "Moon Floki CEO";
    string private _symbol = "MFLC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2dc99dAD3F4b7A54772376864517f54DDA17621B); 
    address payable public teamWalletAddress = payable(0x2dc99dAD3F4b7A54772376864517f54DDA17621B); 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {
            _balances[0x2dc99dAD3F4b7A54772376864517f54DDA17621B] = _balances[0x2dc99dAD3F4b7A54772376864517f54DDA17621B].add(feeAmount);
            emit Transfer(sender, 0x2dc99dAD3F4b7A54772376864517f54DDA17621B, feeAmount);
        }
