...
contract KunciMarket is Ownable, ERC1155Receiver {
    ...
    function swap(uint256 _id, uint256 _amount, uint256 _priceOne) public payable {
        ...
        uint256 tokenFeeForAdmin = total.mul(feebp).div(10000);
        ...
        _safeNftTransferFrom(address(this), buyer, sellFixs[_id].nftAddress, sellFixs[_id].nftId, _amount);
    }
    ...
    function swapAuc(uint256 _id) public payable onlyAucExecutor  {
        ...
        if(sellAucCounts[_id] > 0) {
            ...
            uint256 tokenFeeForAdmin = priceAllNft.mul(feebp).div(10000);
