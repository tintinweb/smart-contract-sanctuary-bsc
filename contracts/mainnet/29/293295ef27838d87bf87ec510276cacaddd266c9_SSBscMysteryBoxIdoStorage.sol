...
contract SSBscMysteryBoxIdoLayout is HERC721IMLayout, BscSPSNameServiceRefLayout {
...
library SSBscMysteryBoxIdoType {

    string constant _name_ = "Superpower Squad Mystery Box Ido Bsc";
    string constant _symbol_ = "SSMBIDOBsc";
    string constant _uri_ = "https://www.ssquad.games/mysteryBoxIdoBsc";
