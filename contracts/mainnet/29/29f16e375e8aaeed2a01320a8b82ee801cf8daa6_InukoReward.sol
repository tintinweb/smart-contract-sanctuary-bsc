...
// %3 INUKO REWARD + %8 BUSD REWARD = %11 REWARD

// https://t.me/INUKOREWARD
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x5F8203DFBBE6F883C54F68eeaeF4Ef6f706bA083);
...
contract InukoReward is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "InukoReward";
    string constant _symbol = "IRWRD";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**20 * 10**_decimals;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        uint256 multiplier = isSell ? 100 : 100;
