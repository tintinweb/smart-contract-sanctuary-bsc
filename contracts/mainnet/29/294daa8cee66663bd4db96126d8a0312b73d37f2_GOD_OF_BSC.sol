...
contract GOD_OF_BSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GODOFBSC";
    string private _symbol = "BSCGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64cA815b2c0DfED1380460C166c8cef5Da67a7AD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x64cA815b2c0DfED1380460C166c8cef5Da67a7AD); // BuyBack Address
