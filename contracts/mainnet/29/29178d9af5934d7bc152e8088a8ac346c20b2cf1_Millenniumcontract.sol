...
contract Millenniumcontract {
    ...
    //Token price in BNB
    uint256 public _price = 0.0018 ether;
    // Token price in USD
    uint256 public _usdPrice = 0.5 ether;
    // Price Denominator
    ...
    uint256 public minSaleAmount = 20e18;
    uint256 public minSaleAmountBNB = 20;
    ...
    function change_minSaleAmountBNB(uint256 saleMin) public onlyOwner() {
        minSaleAmountBNB = saleMin;
    }
