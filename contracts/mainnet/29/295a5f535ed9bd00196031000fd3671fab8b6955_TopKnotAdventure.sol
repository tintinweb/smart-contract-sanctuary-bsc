...
/**
TOPKNOT is a hyper-deflationary token built to generate liquidity and yield for holders.
There are periodic $TOPKNOT burn and buy-back events with the logical consequence of a never ending increase in the price floor.

Official Telegram Global : https://t.me/TopKnotAdventure
Official Website : https://topknotadventure.site/
*/
...
contract TopKnotAdventure is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Top Knot Adventure";
    string private _symbol = "TOPKNOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10D92B7E2b3577c862D361f2FcB6f935682A85DD); 
    address payable public buyBackWalletAddress = payable(0x10D92B7E2b3577c862D361f2FcB6f935682A85DD); 
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000; 
