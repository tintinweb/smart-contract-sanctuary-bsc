...
contract SquidRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Rat";
    string private _symbol = "SQRAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc4aa400A09f067C5e8a7A09B7d54c5f9FcE160bA);
    address payable public BuyBackWalletAddress = payable(0xc4aa400A09f067C5e8a7A09B7d54c5f9FcE160bA);
