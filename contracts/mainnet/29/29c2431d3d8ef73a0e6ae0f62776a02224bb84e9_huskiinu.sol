...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb99e4E98DFE2C7AB9b3Ea1A1E9188F8B01c8FF1D; // owner address
...
contract huskiinu is Context, IERC20, Ownable {
    ...
    string private _name = "Huski Inu";
    string private _symbol = " HINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb99e4E98DFE2C7AB9b3Ea1A1E9188F8B01c8FF1D); // Marketing Address
    address payable public teamWalletAddress = payable(0xb99e4E98DFE2C7AB9b3Ea1A1E9188F8B01c8FF1D); // Team Address
