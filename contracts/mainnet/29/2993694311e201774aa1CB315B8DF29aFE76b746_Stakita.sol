...
A low fee token on the Binance Smart Chain utilizing deflationary properties, secure safety functions, and community drive!

website: https://www.stakita.net/
Telegram: https://t.me/Stakita
Twitter: https://twitter.com/StakitaBSC
...
library Address{
 ...
 contract Stakita is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 100000000000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 300000000000 * 10**18;
    uint256 public maxBuyLimit = 2000000000000 * 10**18;
    uint256 public maxSellLimit = 2000000000000 * 10**18;
    uint256 public maxWalletLimit = 3000000000000 * 10**18;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xAbA25717f7A77EE83E36a0E6C82264075102CB15;
    address public burnWallet = 0xAbA25717f7A77EE83E36a0E6C82264075102CB15;

    string private constant _name = "Stakita";
