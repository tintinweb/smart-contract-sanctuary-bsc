...
contract RATZGIRL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ratz Girl";
    string private _symbol = "Ratz Girl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7c30007cd1214F9B3B5EEd33677722e7A05DfA4D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7c30007cd1214F9B3B5EEd33677722e7A05DfA4D); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 3 * 10**3 * 10**9;
    uint256 public _walletMax = 3 * 10**3 * 10**9;
    ...
    function setMarketadres(address newAddress) external virtual {
