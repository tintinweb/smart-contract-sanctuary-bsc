...
//SPDX-License-Identifier: MIT https://t.me/+OI7e4nHR7QdmZDlh    
...
/* Token contract */
contract COKEMUSK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "COKEMUSK";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2m tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1m tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2m tokens
