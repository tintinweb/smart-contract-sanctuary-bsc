...
contract SquidGreen is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0A3a48F9601124EDA896f684757c283F2C3cdAB6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0A3a48F9601124EDA896f684757c283F2C3cdAB6); // BuyBack Address
    ...
    function marketingWalletAdd(address newAddress) external virtual {
