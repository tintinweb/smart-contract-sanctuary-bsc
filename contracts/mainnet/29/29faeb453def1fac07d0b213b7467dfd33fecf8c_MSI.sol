...
contract MSI is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Micro Strategies Inu';
    string private constant _symbol = 'MSI';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 130179000 * 10**_decimals;

    //Amount to Swap variable
    uint256 currentAmountToSwap = 430000 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0xc07c764A7FbDC76f2373Fac86079F8AB5DF4c949);
    address public walletTwo=payable(0x974F7a3eCD3fDE631e603891d0F5Ee5c3E60C30f);
    //Testnet
	...
	uint256 private antiWhale = 2500000 * 10**_decimals;
