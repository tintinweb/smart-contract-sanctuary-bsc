...
contract GoogleProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Google Protocol"; // 
    string private constant _symbol = "$GOOGLEPRO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xC79ca9f8D92fF18f844A9D556272fE7e23c2D350;
