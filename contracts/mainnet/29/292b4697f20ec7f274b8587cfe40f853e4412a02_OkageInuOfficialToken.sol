...
contract OkageInuOfficialToken is OkageInuOfficial {
    ...
    string public override name = unicode"Okage Inu Official";
    string public override symbol = unicode"Okage Inu";
