...
contract HAALAND is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Haaland Fan Token";
    string private constant _symbol = unicode"HAALAND";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 22000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x96e308E76cb1bAddd8cA194e275270b1F5864656);
    address payable public MarketingWallet = payable(0x34bab75C012CB114dF8ae8a01737EC0504f3436D);
    address payable private feereceiver01 = payable(0x7F0b33FCD5F3D31C8bA9CaBFB0EDb77A2Fd0df29);
    address payable private feereceiver02 = payable(0xAb5B3BBb33fB272198887E7C8312c02d1Cf0cC8A);
