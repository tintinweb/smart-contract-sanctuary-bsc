 ...
 */
contract GuDi is Context, IERC20, Ownable, IERC20Metadata {
    ...
    address payable private _marketingAddress =
        payable(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13);
    ...
    function sendETHToFee(uint256 amount) private {
        _charityAddress.transfer(amount.mul(70).div(100));
