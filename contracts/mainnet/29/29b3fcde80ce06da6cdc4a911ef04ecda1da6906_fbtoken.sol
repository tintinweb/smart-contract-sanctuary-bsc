...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8460ce1DEA77B04fcD7BA0A86eb83ac53Ab7467b;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x8460ce1DEA77B04fcD7BA0A86eb83ac53Ab7467b),//fund address
    
        address(0x8460ce1DEA77B04fcD7BA0A86eb83ac53Ab7467b)//dev address
    ){
