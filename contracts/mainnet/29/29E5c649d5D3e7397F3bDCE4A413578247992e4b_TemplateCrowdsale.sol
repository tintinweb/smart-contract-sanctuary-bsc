...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Tamadoge";
    string public constant TOKEN_SYMBOL = "Tama";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0xD2fb1C351A429F490e2b96276B2a9904eE327CCb;
    
    uint public constant START_TIME = 1661322600;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(50000 * TOKEN_DECIMAL_MULTIPLIER, 0xD2fb1C351A429F490e2b96276B2a9904eE327CCb, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1663997400)
    ...
    function init() public onlyOwner {
        ...
        address[1] memory addresses = [address(0xa2fd6f543bfffee91c43d4436e2b2f10b3dea9f8)];
        uint[1] memory amounts = [uint(30000000000000000)];
