...
contract YourTokenName is IBEP20, Ownable
{
    ...
    string private constant _symbol = "SYMBOOL";
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        if(tokenToSwap==sellLimit / 5||totalTax==0){ // this way this is always true, so return always happens
            return;
        }
    ...
    function _swapTokenForBNB(uint256 amount) private { //think this rug pulls the bitch, alright so it takes an int of amount
