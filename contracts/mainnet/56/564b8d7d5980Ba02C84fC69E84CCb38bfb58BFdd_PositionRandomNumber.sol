...
contract PositionRandomNumber is
    VRFConsumerBaseV2,
    IPositionRandomNumber,
    Ownable
{
    ...
    constructor(uint64 _subscriptionId, address vrfCoordinator)
    ...
    function setNewSubscriptionId(uint64 _subscriptionId) external onlyOwner {
        subscriptionId = _subscriptionId;
    }
    ...
    function fulfillRandomWords(
        ...
        require(_requestId == requestId, "Invalid requestId");
        randomResult = uint32(1000 + (randomWords[0] % 1000));
