...
contract REDBULLTWO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdB6Cbee3543066DCA170998acb020d0c265D60cb); 
    address payable public Wallet_Dev = payable(0xdB6Cbee3543066DCA170998acb020d0c265D60cb);
    ...
    string private constant _name = "Red Bull 2.0"; 
    string private constant _symbol = unicode"$RB2"; 
    ...
    constructor () {
        ...
        _owner = 0xdB6Cbee3543066DCA170998acb020d0c265D60cb;
