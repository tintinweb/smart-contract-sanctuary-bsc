...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x292B6b38f42E72021340e21ca7645720813746B9;
...
contract WheelieBinSmash is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5C70b109029a933bE45A153fC248786fFA9Ba7a9;
    address private _marketingWalletAddress = 0x36428aa901d9f7d37c403ca4c210Ecfd88a46d4D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WheelieBinSmash";
    string private _symbol = "WBS";
