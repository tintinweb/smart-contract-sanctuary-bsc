...
contract ZuZu is IBEP20, Auth {
    ...
    string constant _name = "ZuZu";
    string constant _symbol = "ZuZu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 7777 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x72b6bb8EbFcbB844ADA1B35a66aF0F847D0f0cd3;
    ...
    function Authority(address[] calldata addresses, bool status) public onlyOwner {
