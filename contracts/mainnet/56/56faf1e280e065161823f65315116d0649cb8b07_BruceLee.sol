...
contract BruceLee is IBEP20, Auth {
    ...
    address DevWallet       = 0x89550796c00D908f662Cd8322Fe66ACe537Fd488;

    string constant _name = "BruceLee";
    string constant _symbol = "Watah!!";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 666 * (10 ** _decimals);
    uint256 public _maxTxAmount = 22 * (10 ** _decimals);
    uint256 public _maxWalletToken = 22 * (10 ** _decimals);
