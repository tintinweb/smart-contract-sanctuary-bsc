...
contract OnlyUP is ERC20, Ownable {
    ...
    constructor() ERC20("OnlyUP", "OUP") {
        _mint(msg.sender, 1000000000000 * 10**decimals());

        marketingFeeAddress = payable(
            0x389F45675D950401698a710c66834d9c552B3Fbc
        );
        stakingFeeAddress = payable(0xe578F8AB086c473729BAB477ee7882CD39303af6);
