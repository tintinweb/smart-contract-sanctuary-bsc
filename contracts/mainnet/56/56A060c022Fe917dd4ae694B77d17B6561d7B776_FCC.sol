...
contract FCC is ERC20, ERC20Detailed, Pausable {

    using SafeMath for uint256;
    uint256 tokenBalance;
    uint256 deployTime;
    uint256 maxSlotTime = 2628000;
    ...
    uint256 public Duration = 2628000 minutes; 
    ...
    constructor()
    ERC20Detailed("FENICE CLASSIC COIN", "FCC",18)
    {
        ...
        _mint(address(this), 18900000*(10**18));
        RemainingReward = 18900000*(10**18);
    ...
    public
    onlyOwner
    {maxsSellingAmount=_amount.mul(1E18);}

    function setPerDayTransferLimit(uint256 _amount)
    public
    onlyOwner
    {maxTrPerDay=_amount.mul(1E18);}

    function setMaxMultiSendPday(uint256 _amount)
    public
    onlyOwner
    {maxMultisendPday=_amount.mul(1E18);}
