...
contract LqjToken is IERC20, CommunityRole {
    ...
    uint256 private _tTotal = 688 * 10**18;
    string private _name = "Look Qiji";
    string private _symbol = "LQJ";
    uint8 private _decimals = 18;
    uint256 public _maxTxAmount = 3 * 10**18;
    

    address deadWallet = 0xE2D4A68381670E4702C9f1eFd496D4CBCa04140C;

    address USDT = 0x55d398326f99059fF775485246999027B3197955;
    IERC20 che = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    IERC20 hby = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    

    address marketingWalletAddress = 0x000000000000000000000000000000000000dEaD; 
    address communityAddress = 0x362e9E46185Dc5F991CCeb0a2a3cba951A4c2269;
    ...
    uint256 private  _marketingFee = 10000;
    ...
    constructor() {
        ...
        swapTokensAtAmount = _tTotal.mul(1).div(100000);
    ...
    function allFees() private view returns (uint256,uint256,uint256) {
