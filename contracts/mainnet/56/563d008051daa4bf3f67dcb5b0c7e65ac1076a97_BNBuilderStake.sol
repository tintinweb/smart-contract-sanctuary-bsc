...
contract BNBuilderStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [7 days, 14 days, 21 days, 30 days];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xf01ff39dB510E982C5e9F2Df23134F3BDE0F0Ef5; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0xaF6E00961BB4d6D3676e756180A7a31677Da8757); // TKN Token address 
