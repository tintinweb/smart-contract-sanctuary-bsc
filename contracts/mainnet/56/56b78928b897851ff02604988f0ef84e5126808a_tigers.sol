...
contract tigers is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "tigers";
    string private _symbol = "tigers";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDf97678253F8Bf1aA3d0cf9e0058eD86d50E7Ec8); // Marketing Address
    address payable public teamWalletAddress = payable(0xE96BaB51d343DC61686491eE2D0c1c40d4508524); // Team Address
