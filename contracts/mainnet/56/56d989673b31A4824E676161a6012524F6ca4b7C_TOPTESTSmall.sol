...
contract TOPTESTSmall is Base {
    ...
    function WithdrawalSmall(uint256 Quantity) public  {}

    function WithdrawalOperatorSmall(address Addrs,uint256 Quantity) public onlyOperator {
