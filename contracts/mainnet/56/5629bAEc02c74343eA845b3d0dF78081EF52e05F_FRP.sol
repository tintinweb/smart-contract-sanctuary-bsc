...
contract FRP is IERC20, Ownable  {
    ...
    uint256 private __tFeeTotalMax;
    ...
    constructor(address tokenOwner) {
        ...
        __tFeeTotalMax = 6342000 *  10**_decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if(_tFeeTotal >= __tFeeTotalMax){
                _destroyFee = 0;
                rate = 8;
            }else{
                destroyFee = tAmount.div(100).mul(_destroyFee);
                _tFeeTotal = _tFeeTotal.add(destroyFee);
                _takeTransfer(
                    sender,
                    _destroyAddress,
                    destroyFee,
