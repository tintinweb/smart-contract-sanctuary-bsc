...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        /** @dev Set max supply amount
     */
    function _setMaxSupply(uint256 amount) internal virtual {
        require(amount != 0, "ERC20: max supply must not be zero");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_maxSupply >= (_totalSupply + amount), "ERC20: Max supply amount exceeded");
...
contract CrossChainASTA is Pausable, Ownable, Burnable, Lockable, ERC20 {
