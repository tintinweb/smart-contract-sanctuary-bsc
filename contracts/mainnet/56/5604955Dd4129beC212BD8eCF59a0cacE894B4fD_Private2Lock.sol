...
contract Private2Lock is Ownable {
    using SafeERC20 for IERC20;
    mapping(address => uint256) public balance;
    mapping(address => uint256) public claimedByUser;
    mapping(address => uint256) public balanceInBUSD;
    uint256 public tokenPriceBUSD = 14e14;
    uint256 public maxBusdAmount = 4000e18;
    uint256 public minBusdAmount = 700e18;
    uint256 public avalableToClaimGlobal = 0;
    uint256 public unlockPeriod = 2592000; // 2592000 - 30 days in seconds
    uint256 public unlockPercent = 0; // 0 its 5%
    uint256 public cliff = 2;
    ...
    uint256 public marketingPercent = 143;
    uint256 public teamPercent = 143;
    uint256 public liquidityPercent = 714;
    ...
    function claim() public {
        ...
        if (block.timestamp > nextUnlock) {
            level += 1;
            if (level == 1) unlockPercent = 50;
            if (level == 2) unlockPercent = 60;
            if (level == 7) unlockPercent = 65;
            avalableToClaimGlobal += unlockPercent;
