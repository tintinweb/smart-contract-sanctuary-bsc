...
Telegram: https://t.me/richshibax1000
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2831f5db3418a199d7a3dB64fE9C142aB85a1571;
...
contract RICHSHIBA is Context, IERC20, Ownable {
    ...
    string private constant _name = "RICH SHIBA"; // 
    string private constant _symbol = "RichShiba"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x2831f5db3418a199d7a3dB64fE9C142aB85a1571);
