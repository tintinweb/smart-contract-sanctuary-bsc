...
contract BabyLuckyFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Lucky Floki";
    string private constant _symbol = "BLF";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x2544111E1Ca36b9f9963B200D11D2FD30820c74e);
    address payable private _marketingAddress = payable(0xc441C6756269aC488a99C9c407F317E629e651B4);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 25, "Redis cannot be more than 24.");
	    require(redisFeeOnSell < 25, "Redis cannot be more than 24.");
	    require(taxFeeOnBuy < 25, "Tax cannot be more than 24.");
	    require(taxFeeOnSell < 25, "Tax cannot be more than 24.");
