...
contract DOGEGONGINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEgong Inu";
    string private _symbol = "DOGEgong";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBce2344f62171734FA13Fb8bb28934C60f383E3d); 
    address payable public buyBackWalletAddress = payable(0x2F186975A05874b0CC88754016c3F43Ce04f9A2d); 
