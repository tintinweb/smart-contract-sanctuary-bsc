...
contract NINJACAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3e5f111823718868355917b9803d9756FBB1151f); 
    address payable public Wallet_Dev = payable(0xEdC5181a8c37AcE26a07AF17B890B3420E217c00);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Ninja Cat"; 
    string private constant _symbol = unicode"NINJA CAT";
