...
contract GoDrive is Ownable {
    ...
    uint256 public serviceUSDT = 5 * (10**18);
    uint256 public refuelUSDT = 10 * (10**18);
    uint256 public roadtaxUSDT = 10 * (10**18);
    ...
    function buyCar() public{
        ...
        user.amount=user.amount+carPriceUSDT;
    ...
    function service() public{
        ...
        UserInfo storage user = userInfo[msg.sender];
        user.service=user.service+serviceUSDT;
