...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is BEP20 {
        ...
        uint256 public _buyLiquidityFee = 2;   // buy liquidity fee
        uint256 public _buyMarketingFee = 6;   // buy marketing fee

        uint256 public _sellLiquidityFee = 4;  // sell liquidity fee
        uint256 public _sellMarketingFee = 8;  // sell marketing fee
        ...
        constructor () BEP20("China Shiba Inu", "CHINASHIB"){ // Token Name and Symbol

            numTokensSellToAddToLiquidity = 100000000 * 10 ** decimals();  // Number of tokens to add liquidity
            _marketingWalletAddress = 0x435bA6a5c869bD49F33e1f6679fF12830F94127a; // Marketing Address
            ...
            */
            _mint(owner(), 1000000000000 * 10 ** decimals());	// Total Supply	
            _maxWalletBalance = (totalSupply() * 1 ) / 100;   // Max wallet balance 1% of total supply
            _maxTxAmount = (totalSupply() * 1 ) / 100;       // Max tnx amount 1% of total supply 
        ...
        function setMaxWalletBalance(uint256 maxBalancePBEPent) external onlyOwner {
        _maxWalletBalance = maxBalancePBEPent * 10** decimals();
        }
