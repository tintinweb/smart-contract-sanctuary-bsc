...
contract SHIBPAY is Context, IERC20, Ownable {
    ...
    string private _name = "ShiBPay";
    string private _symbol = "ShiBPay";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xfa9f6A8c093E6c555e2e9A9B2560861b16A0F2AD));
        marketingWalletAddress = payable(address(0xfa9f6A8c093E6c555e2e9A9B2560861b16A0F2AD));
