...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45Dd5A543284ffC63efab3E1290BDCA66c3Ba7e9; // 
...
contract WorldCupTwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "World Cup Twitter";
    string private _symbol = "$WCUT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45Dd5A543284ffC63efab3E1290BDCA66c3Ba7e9); // Marketing Address
    address payable public teamWalletAddress = payable(0x45Dd5A543284ffC63efab3E1290BDCA66c3Ba7e9); // Team Address
