...
/*SNICKERS INU
https://t.me/snickers_inu
https://twitter.com/snickers_inu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE82A4cd3eA6b47C399D4A4174f2f1d50e37F2eEA; 
...
contract SnickersInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "SNU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE82A4cd3eA6b47C399D4A4174f2f1d50e37F2eEA); 
    address payable public teamWalletAddress = payable(0xE82A4cd3eA6b47C399D4A4174f2f1d50e37F2eEA); 
    ...
    uint256 public _marketingShare = 145;
    ...
    uint256 private _totalSupply = 12345678 * 10**_decimals;
    uint256 public _maxTxAmount = 12345678 * 10**_decimals; 
    uint256 public _walletMax = 12345678 * 10**_decimals;
