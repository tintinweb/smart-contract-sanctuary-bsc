...
In other cultures around the world, it’s a sign of good luck if you dream about a black cat, see one walking towards you,
or if you happen to find a stray white hair on its gleaming ebony fur.
====================================

Website: https://blackcatbsc.us
Telegram: https://t.me/BlackCat_binance
Twitter: https://twitter.com/blackcat__bsc
...
contract Black_Cat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLACK CAT";
    string private _symbol = "$BCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8016C6ECC5D86b410B22774136adba7B1107817A); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xf5AFc275c60111B5A60632da968b9816A87e604d); // Development Address
