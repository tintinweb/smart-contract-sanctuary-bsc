...
abstract contract baseContract is  IBEP20 , Ownable {
    ...
    function setPair(address _token) public { 
        ...
        if(pair==address(0))pair = IDEXFactory(router.factory()).createPair(router.WETH(), address(this));
...
contract Brazil is baseContract { 
    constructor() baseContract(address(0x10ED43C718714eb63d5aA57B78B54704E256024E),"Brazil","Brazil",0,1 * 10 ** 15){
    } 
}