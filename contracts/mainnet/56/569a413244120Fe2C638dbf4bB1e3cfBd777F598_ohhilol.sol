...
contract ohhilol is Context, IERC20, Ownable {
    ...
    string private _name = "Oh HiLol 2GO";
    string private _symbol = "COLA2GO";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable public marketing =
        payable(0x2C5a69107BC6989209caFe9fF96C072eBAF8F391);
    ...
    uint256 public constant _maxFees = 9;
    ...
    function setMarket() public lockTheSwap {
