...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe7B7b5594b648F0017418057Dcb853cE60Dc1A66; // owner address
...
contract PulseShiba is Context, IERC20, Ownable {
    ...
    string private _name = "PulseShiba";
    string private _symbol = "PSHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe7B7b5594b648F0017418057Dcb853cE60Dc1A66); // Marketing Address
    address payable public teamWalletAddress = payable(0xe7B7b5594b648F0017418057Dcb853cE60Dc1A66); // Team Address
