...
contract SantaBUSD {
    ...
    uint256 constant launch = 1672358400;  // 30th DEC 00:00 GMT
    ...
    constructor() {
            owner = address(0xeB826806cE7A3153BB219f514b781775DF052Ecc);
            dev = address(0xd37711185Ef5165b4eBDF5fA6632e54114E6a595);
            PercsKey[10] = DivPercs(864000, 40);
            PercsKey[20] = DivPercs(1728000, 50);
            PercsKey[30] = DivPercs(2592000, 60);
            PercsKey[40] = DivPercs(3456000, 50);
            PercsKey[50] = DivPercs(4320000, 40);
            FeesKey[10] = FeesPercs(864000, 150);
            FeesKey[20] = FeesPercs(1728000, 100);
            FeesKey[30] = FeesPercs(3456000, 50);
            FeesKey[40] = FeesPercs(4320000, 50);
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        BUSD.safeTransfer(owner, stakeFee * 4/5);
        BUSD.safeTransfer(dev, stakeFee * 1/5);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        BUSD.safeTransfer(owner, withdrawFee * 4/5);
        BUSD.safeTransfer(dev, withdrawFee * 1/5);
