...
contract AntNetworX is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANTnetworX"; // 
    string private constant _symbol = " $ANTNETWORX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x8f9EEA70FE1f859c3835Ac29b69F1d4693A7A55B;
