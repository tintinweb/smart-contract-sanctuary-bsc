...
contract Cindy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cindy";
    string private _symbol = "Cyndi";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4aEbD815Aad0b1a79d36713E2f7aa6226f2C8314); // Marketing Address
    ...
    address payable private teamWalletAddress = payable(0x4aEbD815Aad0b1a79d36713E2f7aa6226f2C8314); // Team Address
