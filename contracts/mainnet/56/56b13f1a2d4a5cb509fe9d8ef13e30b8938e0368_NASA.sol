...
contract NASA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x72aFcbA29E64112E5C95b365d7F96ed8010575d4); // Marketing Address
    address payable public teamWalletAddress = payable(0x72aFcbA29E64112E5C95b365d7F96ed8010575d4); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x72aFcbA29E64112E5C95b365d7F96ed8010575d4),
            block.timestamp
        );
    }
