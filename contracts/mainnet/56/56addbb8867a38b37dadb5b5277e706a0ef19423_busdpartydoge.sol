...
// TG: https://t.me/BusdPartyDOGE

// Website : https://busdpartydoge.wixsite.com/busdpartydoge     10% buy sell tax with Busd rewards
...
contract busdpartydoge is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BusdPDoge";
   string constant _symbol = "BPDOGE";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 300; // 3%
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xf5aA24DC27C0809C3c79Ca8742b880Bb1ffb442E).call{value: BNBMarketingamount, gas: 30000}("");
