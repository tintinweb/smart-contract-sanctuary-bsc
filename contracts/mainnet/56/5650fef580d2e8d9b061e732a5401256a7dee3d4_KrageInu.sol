...
contract KrageInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9ddCAc5bcaE15392414E5357A777524e091805f3); 
    address payable public Wallet_Dev = payable(0x9ddCAc5bcaE15392414E5357A777524e091805f3);
    ...
    string private constant _name = "Krage Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x9ddCAc5bcaE15392414E5357A777524e091805f3;
