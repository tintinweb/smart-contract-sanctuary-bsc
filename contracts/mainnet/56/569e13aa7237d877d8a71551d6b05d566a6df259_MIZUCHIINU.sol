...
/**
 *MIZUCHI INU
  THE NEWEST DRAGON TOKEN ON THE BINANCE SMART CHAIN NETWORK.
  WE ARE TO EXPLODE TO BSC NETWORK
  TELEGRAM-https://t.me/MizuchiInu
*/
...
contract MIZUCHIINU is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MIZUCHI INU";
    string constant _symbol = "$MZI";
