...
contract BlackDragonSociety is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Dragon Society";
    string private constant _symbol = "BDS";

    address public _PancakeSwapV1RouterUniswap = 0x98cDA3c6d9eD0fdf548A382558F88Fd176664f72; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x98cDA3c6d9eD0fdf548A382558F88Fd176664f72; //can be the same
