...
contract Pugpug is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PugpugInu";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x038C342f5DAde251ae0267b6cc96cf13cD27e8De); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x5499f7fA65E31df86dfEAD31915870dC6aF70741); // Buyback Address
