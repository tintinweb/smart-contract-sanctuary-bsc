...
// Telegram: https://t.me/BobbyDogeToken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfEdA9f539bC1f9A03b0126d4bC3181149584E7cc; // owner address
...
contract BOBBYDOGETOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bobby Doge";
    string private _symbol = "$DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfEdA9f539bC1f9A03b0126d4bC3181149584E7cc);
    address payable public teamWalletAddress = payable(0xfEdA9f539bC1f9A03b0126d4bC3181149584E7cc); 
