...
contract BiYanNanShou is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "BiYanNanShou";
    string private _symbol = "BIYAN";
    ...
    function referenceTokenaddition(uint256 rLiquidity) external onlyOwner {       
    ...
    function getbonusFeeGasMaxLimit(uint256 gas, uint256 gasPriceLimit) external pure returns(uint256) {
		  require(gas >= 750000);
