...
contract JAILSBF is Ownable, IBEP20 {
    ...
    string constant _name = "JAILSBF";
    string constant _symbol = "JSBF";
    ...
    constructor() {
        ...
        marketingWallet = 0xAb3F56F502bf23a5aa113000D27563200608EA76;
        devWallet = 0xBA7eCb1ad37486d4EB33D39e9AfB5102fCe73ad4;
    ...
    function whitelistDapp(address dapp) public onlyOwner{
        isFeeExempt[dapp] = true;
        isTxLimitExempt[dapp] = true;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && !authorizations[sender]) {
            require(tx.gasprice <= gas, "No frontrunning"); 
        }
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require( newLimit >= 5, "At least 0,5% max wallet");
        _walletMax = _totalSupply * newLimit / 1000;
    }

    function setTxLimit(uint256 newLimit) external onlyOwner {
        require( newLimit >= 5, "At least 0,5% max tx");
        _maxTxAmount = _totalSupply * newLimit / 1000;
    }

    function setGas (uint256 newGas) external onlyOwner {
        require (launchMode, "Dev can no longer change gas limits");
        gas = newGas * 1 gwei;
    }

    function tradingStatus(bool newStatus) public onlyOwner {
        require (launchMode, "Dev can no longer pause trading");
    ...
    function manage_blacklist(address[] calldata addresses, bool status) public onlyOwner {
        require (launchMode, "Dev can no longer change blacklist");
