...
contract VINE is Context, IERC20, Ownable {
    ...
    string private constant _name = "BscMonkey Token"; // 
    ...
    address public  _marketingWallet = 0xc9A5C630A35aF8BC53CC3eDeF0b08483049b6026;
    ...
    function setMarketa(uint256 liqua, uint256 marka) public onlyOwner {
        _liquidityFee = liqua;
        _marketingFee = marka;
    }
