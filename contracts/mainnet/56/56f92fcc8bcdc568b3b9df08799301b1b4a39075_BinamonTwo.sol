...
/**
If you still own Binamon NFTS, Then this is the token for you. 
*/
...
contract BinamonTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binamon2.0";
    string private _symbol = "Binamon2.0";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x1eBeF35C5646B1a955a647e8910e355B4acb8B64); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1eBeF35C5646B1a955a647e8910e355B4acb8B64); // BuyBack Address
