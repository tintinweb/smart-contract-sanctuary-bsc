...
contract WCG is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "WIKI CAT GROW";
string private _symbol = "WCG";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
address payable private TeamWallet = payable(0x7A0dAe7A54c49cCA7d99452F3D578A51c1434dB2); // Buy Back Address
