...
contract DualMiner is Initializable, OwnableUpgradeable {
    ...
    uint256 private Seas_TO_HATCH_1MINERS; //for final version should be seconds in a day
    uint256 private PSN;
    ...
    function store() public initializer {
        ...
        initialized = false;
        repeatneeded = true;
        Moceans = 0xf8Ccc8Cd36cf25a192F1f076b0F16038F2D7Dc24;
        wizard = 0xa001320E6c7388D5D560cB2aE4f90B4Ad030769A;
    }
    ...
    function setMoceans(address _adr) public onlyOwner {
        Moceans = _adr;
    }
