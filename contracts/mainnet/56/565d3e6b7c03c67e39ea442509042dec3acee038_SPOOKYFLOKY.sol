...
contract SPOOKYFLOKY is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF102638F3502003Fa6Fe5E2c782795C5b9a0D46a; //

    string private constant _name = "Spooky Penis"; //
    string private constant _symbol = "sPENIS"; //
