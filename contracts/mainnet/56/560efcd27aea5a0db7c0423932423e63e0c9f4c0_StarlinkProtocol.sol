...
contract StarlinkProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6AB0Db7E35527354d3F0f4c02a06Bf3458287E6F); 
    address payable public Wallet_Dev = payable(0x6AB0Db7E35527354d3F0f4c02a06Bf3458287E6F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 2*10**7 * 10**_decimals;
    string private constant _name = "StarlinkProtocol"; 
    string private constant _symbol = unicode"StarPro"; 
    ...
    constructor () {
        ...
        _owner = 0x6AB0Db7E35527354d3F0f4c02a06Bf3458287E6F;
