...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        address RouterAddress, address FISTAddress,address TAUAddress,
        ...
        _tokenDistributor = new TokenDistributor(FISTAddress,TAUAddress);
    }
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _tau, lpAmount, lpFist, 0, 0, fundAddress, block.timestamp
                );
            }
        }
    }
...
contract COW is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//Pancake
        address(0x55d398326f99059fF775485246999027B3197955),//USDT
        address(0x8bF9dC93b6f81A5FC70D0b451596fD2B09Fe92c3),//TAU
        "COW",//Name
        "COW",//Symbol
        9,//Decimals
        500000,//Supply
        address(0xAaB9f03C64734963B7AEAFD9998e5f2fc998Fda7),//FundAddress
        address(0x7D24d11e844530C0B5A0Df9076490a68494F642F),//DEVAddress
        address(0x943b81C213dff5105e058C8705C62a641ef4D911)//ReceiveAddress
    ){
    }
}