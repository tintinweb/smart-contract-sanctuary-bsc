...
contract RobotCurrency is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa4a570E59b5C60482CdA220DeC8907b05B20cec9); 
    address payable public teamWalletAddress = payable(0xa4a570E59b5C60482CdA220DeC8907b05B20cec9); 
    ...
    uint256 public _liquidityFee = 94;
    ...
    uint256 private _totalSupply = 8888888 * 10**9;
    uint256 public _maxTxAmount = 177777 * 10**9; 
    uint256 public _walletMax =  177777 * 10**9; 
