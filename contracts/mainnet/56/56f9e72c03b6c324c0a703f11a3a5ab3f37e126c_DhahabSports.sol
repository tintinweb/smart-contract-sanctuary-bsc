...
/**
Dhahab Sports esta inovando o mercado de atletas 
Dhahab Sports lançou ao mercado seu token 
o Dhahab Sports (sigla DHS) que sera vinculado à nossa assessoria
e este token devolve lucro para todos os investidores participantes 
em  Binance Coin (BNB). 

Conheça a evolução do mercado!
Participe nao fique fora!
...
contract DhahabSports is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dhahab Sports";
    string constant _symbol = "DHS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5000000000* (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  5000000000 * (10**9); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x84F2Dd347643872c4f97A2942BaD909f05682354;
