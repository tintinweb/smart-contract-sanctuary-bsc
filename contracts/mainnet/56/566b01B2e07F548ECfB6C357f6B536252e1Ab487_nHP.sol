...
contract nHP is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "Testing HoneyPot";
    string constant _symbol = "MBF";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 150 / 10000; // 150 Trillions 1.5% Supply
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 150 Trillions 1.5% Supply
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 10000; // 150 Trillions 1.5% Supply
    ...
    // Sell fees 10%
    uint256 public liquidityFeeSell = 2; // Send Back to Liquidity
    uint256 public buybackFeeSell = 2; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeSell = 2; // Reward Holders with BUSD
    ...
    uint256 public totalFeeSell = 10; //  Not more that 10% Total Tax
