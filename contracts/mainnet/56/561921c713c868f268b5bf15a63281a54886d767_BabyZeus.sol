...
interface IUniswapV2Pair {
    ...
    event Buyback(address indexed sender, uint amount0, uint amount1, address indexed to);
    event Swap(
    ...
    function buyback(address to) external returns (uint amount0, uint amount1);
...
contract BabyZeus is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7485f5B43c4374E5998B9c859efc418B09455d68); 
    address payable public Wallet_Dev = payable(0xF2A7D221B9Cc93DC06E37Bb434d65B61e88a63Fc);
    address payable public constant Wallet_Buyback = payable(0xB5c6ad722054855BFFE31CCf1e4B7506bC3083bD); 
