...
sphynx Catcoin is a meme token and presented to the community.
...
Telegram Group: https://t.me/sphynx_Catcoin
Website : https://sphynx_Catcoin.club
...
contract sphynxCatcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sphynx Catcoin"; 
    string private _symbol = "sphynx Catcoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e78bce2906650F7Bfc151a146f123f0ec3B6c19);
    address payable public teamWalletAddress = payable(0x2e78bce2906650F7Bfc151a146f123f0ec3B6c19);
