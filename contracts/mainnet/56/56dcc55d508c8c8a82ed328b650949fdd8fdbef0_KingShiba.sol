...
contract KingShiba is IBEP20, Auth {
    ...
    string constant _name = "King Shiba";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x0EC2a27812249A548b5ea9f47d655f2961A40944;
        marketingFeeReceiver = 0x0EC2a27812249A548b5ea9f47d655f2961A40944;
