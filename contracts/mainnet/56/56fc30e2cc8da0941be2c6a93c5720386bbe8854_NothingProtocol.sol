...
contract NothingProtocol is IBEP20, Ownable {
    ...
    string constant _symbol = "$NOTHIN";
    ...
    address public marketingFeeReceiver = 0x71F08beB8D72ab3E2Df13Fe9379C64fBb21DD0d2;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 20; // 0.3%
    bool inSwap;
