...
contract Ratqueen is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x1236f03B21e12FA2Af89118076751C47877956E9;
 
    string constant _name = "RatQueen";
    string constant _symbol = "RQ";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //3% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 3) / 100;  //3% max wallet
