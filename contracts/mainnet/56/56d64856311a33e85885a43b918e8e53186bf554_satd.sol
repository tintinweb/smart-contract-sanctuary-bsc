...
Shiba And The Dragon | $SATD 
A forced relationship between the shiba inu hype and dragon trend built on the binance smart chain.
tax - 3/3

Socials:
Telegram - https://t.me/ShibaAndTheDragon
*/
...
contract satd is BEP20, Auth {
    ...
    string public constant name = "ShibaAndTheDragon";
    string public constant symbol = "$SATD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4259e9643f99cd92B9F9c09a226797AF0f66663e;
        marketerFeeReceiver = 0x4259e9643f99cd92B9F9c09a226797AF0f66663e;
        teamFeeReceiver = 0xF08FEAE83Ce3cc0F9610E1e763FfbA05A7b4c527;
        devFeeReceiver = 0xF08FEAE83Ce3cc0F9610E1e763FfbA05A7b4c527;
    ...
    function update_fees() internal {
        require(totalFee.mul(buyMultiplier).div(100) <= 900, "Buy tax cannot be more than 9%");
        require(totalFee.mul(sellMultiplier).div(100) <= 990, "Sell tax cannot be more than 9%");
