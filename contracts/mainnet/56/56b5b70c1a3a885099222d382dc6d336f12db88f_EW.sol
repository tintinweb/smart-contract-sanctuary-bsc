...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress, address EWPAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        EWPPool = EWPAddress;
        maxBuyAmount = 30 * 10** Decimals;
        walletLimit =  30 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 liquidityAmount = fistBalance * (_buyLiquidityFee) * 2 / swapFee;
        uint256 EWPAmount = fistBalance * (_sellLiquidityFee) * 2 / swapFee;
        ...
        address[] memory pathEWP = new address[](2);
        pathEWP[0] = _fist;
        pathEWP[1] = EWPPool;
        _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            EWPAmount,
        ...
        // FIST.transferFrom(address(_tokenDistributor), EWPPool, EWPAmount);
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAmount - liquidityAmount - EWPAmount);
...
contract EW is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        50000,//Supply
        address(0xFc3475442C3615F8d1C4F27B0Be82Ee6E692969F),//FundAddress
        address(0xFc3475442C3615F8d1C4F27B0Be82Ee6E692969F),//LiquidityAddress
        address(0x48D77DCdaC008204038787579A87453c9Fe605FE) //EWPAddress
    ){
