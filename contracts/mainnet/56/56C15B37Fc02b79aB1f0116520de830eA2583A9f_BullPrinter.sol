...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x21309A90CCDD675461C7735bF24177678B8d707E; // owner address
...
contract BullPrinter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull Printer";
    string private _symbol = "BP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21309A90CCDD675461C7735bF24177678B8d707E); // Marketing Address
    address payable public teamWalletAddress = payable(0x21309A90CCDD675461C7735bF24177678B8d707E); // Team Address
