...
#MetaDoge fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MetaDoge!
...
contract MetaDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'Meta Doge token';
