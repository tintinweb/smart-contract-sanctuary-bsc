...
contract DEGENALVEY is IBEP20, Auth {
    ...
    string constant _name = "DEGEN ALVEY";
    string constant _symbol = "$DALVEY";
    ...
    address public marketingFeeReceiver = 0x7F01173BE23748dEE01A0e6B46E3D8e652364EaD;
