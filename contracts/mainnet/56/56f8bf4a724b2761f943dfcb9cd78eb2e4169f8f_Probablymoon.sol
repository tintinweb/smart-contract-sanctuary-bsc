...
contract Probablymoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 725000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Probably Moon";
    string private _symbol = "PROB";
