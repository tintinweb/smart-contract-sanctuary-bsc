...
contract LuckyWorld{
    ...
    string private _name = "LuckyWorld";
    ...
    function GetLUCK(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 LUCKamt, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
