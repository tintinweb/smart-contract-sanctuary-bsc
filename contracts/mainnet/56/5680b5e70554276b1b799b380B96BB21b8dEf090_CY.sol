...
contract CY is Token {
    constructor() ERC20(
        ...
        address _marketing = address(0xD9bc6Fd68414e9e2916aCFBA927c8e74c8132337); // 
        address _receive = address(0xD9bc6Fd68414e9e2916aCFBA927c8e74c8132337);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0xD9bc6Fd68414e9e2916aCFBA927c8e74c8132337)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(15 ether);  
        setInitPrice(10 ether); 
        feeMarketingTo2 = address(0xD9bc6Fd68414e9e2916aCFBA927c8e74c8132337);   
        feeEarn = 1500; 
    }
}