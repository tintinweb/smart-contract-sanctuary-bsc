...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9324788D5fc5e6af1F24aE1dDAe8Bc88dEDeA96E;
...
contract TatalCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x913dc013dE38Ea3f09951a2ad48a879D149f8D22;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tatal Coin";
    string private _symbol = "Tatal";
