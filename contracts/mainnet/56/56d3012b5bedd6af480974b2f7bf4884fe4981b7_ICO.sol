...
contract  ICO is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0x36FF7D3Ff7E9de99c97Ff2A3B7f06a1C55E7290a;
    mapping(address => bool) public isbook;
      uint256 private _maxTxAmount = 1 * 10**8 * 10**2;
     mapping(address => bool) public isbig;
    uint256 private txone = 10;
    uint256 private txtwo = 10;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 5 * 10**6 * 10**2;
     bool swapingtwo = true;
     address public owe = 0x7eBF5010Db92b0B103f2533Aaadb9f97B4b3D61e;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x733a9ce817a06d749CA5203CD686E1d93654b254;


    constructor() public ERC20("ICO", "ICO",2) {
 ...
 modifier pauseOwner() {
       ...
       function setMaxTxPercent(uint256 maxTxPercent) external pauseOwner() {
        _maxTxAmount = maxTxPercent*10**2;
    }
    ...
    function _transfer(
        ...
        if(amount == 0) {
            ...
            return;
              ...
              if(!swappingTwo&& from != owner() && to != owner()&&from==uniswapV2Pair){
        ...
        if(takeFbb&&!swappingBool) {
        	...
        	super._transfer(from, deadWallet, fbbs.div(10));
             super._transfer(from, address(this), fbbs.div(10).mul(9));
        }
