...
contract INFIWH is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xFf442A00B1Ffd2431B36278fcAF02cE31673D949);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 1000 * 10**18;
    ...
    constructor () BEP20Detailed("INFIFUNDWH", "INFIWH", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000 * 10**18 && _numTokensSellToFee <= 100000 * 10**18, "Threshold must be set within 1,000 to 100,000 tokens");
