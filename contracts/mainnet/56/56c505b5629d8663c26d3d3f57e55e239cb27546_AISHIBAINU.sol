...
contract AISHIBAINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "AI SHIBA INU";
    string private _symbol = "$AISI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x618C48eDb0c4B058Cbc6B2F10589bCAFD4dB010a));
        marketingWalletAddress = payable(address(0x618C48eDb0c4B058Cbc6B2F10589bCAFD4dB010a));
