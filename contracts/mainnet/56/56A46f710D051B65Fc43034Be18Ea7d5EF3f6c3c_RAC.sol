...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multi_wl(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
...
contract RAC is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000,
        address(0xd0c7f4CCE55d172375b6AF3C2E11374BF38c612A),
        address(0xD982154126575e0F557339c4b1668D3108879177)
    ){
