...
contract BEP20Airdrop is Ownable {
    ...
    function batchPayout(PaymentInfo[] calldata info) external onlyOwner {
        ...
        require(
            length <= maxWallets,
            "You have exceeded the payout wallets limit."
        );
    ...
    function setMaxWallets(uint256 _maxWallets) external onlyOwner {
...
contract BEP20Token is ERC20, Ownable {
    constructor(uint256 initialSupply) ERC20("HEW", "HEW") {
