...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0DF28FF811B4637e03aA0Af68D4B901Db0408D02; // owner address
...
contract CentraNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Centra Network";
    string private _symbol = "$CENTRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0DF28FF811B4637e03aA0Af68D4B901Db0408D02); // 
    address payable public teamWalletAddress = payable(0x0DF28FF811B4637e03aA0Af68D4B901Db0408D02); // 
    ...
    uint256 public _totalTaxIfBuying = 36;
