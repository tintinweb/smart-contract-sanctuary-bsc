...
contract LiangXi is Context, IERC20, Ownable {
    ...
    string private _name = unicode"凉兮币";
    string private _symbol = "LiangXi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF65edf1A96158C355B7CA80a37a56eF84aE3bf27);
    address payable public BurnedWalletAddress = payable(0xF65edf1A96158C355B7CA80a37a56eF84aE3bf27);
