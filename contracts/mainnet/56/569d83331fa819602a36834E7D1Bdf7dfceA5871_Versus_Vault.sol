...
contract Versus_Vault {
    ...
    address public devPayReceiver = owner;
    address public mktMngrPayReceiver = owner;
    address public webMngrPayReceiver = owner;
    ...
    function _2_LaunchVERSUSTokens() public onlyOwner {
        ...
        vtoken.approve(address(this), 1000000000000000000000000000000000000);
        stoken.approve(address(this), 1000000000000000000000000000000000000);
    }
    ...
    function Winner_VVV() public payable onlyOwner {
        //Dev team payout
        ...
        //Send Funds for V Token Buyback
        uint256 VAULTBnBBalance = address(this).balance;
        payable(V_Token).transfer(VAULTBnBBalance.mul(99).div(100));
    }

    function Winner_SSS() public payable onlyOwner {
        ...
        //Send Funds for S Token Buyback
        uint256 VAULTBnBBalance = address(this).balance;
        payable(V_Token).transfer(VAULTBnBBalance.mul(99).div(100));
    }
