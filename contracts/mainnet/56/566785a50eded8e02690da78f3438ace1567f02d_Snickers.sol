...
contract Snickers is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Snickers";
    string constant _symbol = "SNICKERS";
    ...
    */
    ...
    function LaunchUtilities(address holder, bool exempt) external authorized {
    ...
    function LockTokens(address holder, bool exempt) external authorized {
