...
contract DogeSatoshi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4CB9aA1659d6e5f8FD3776C6e0406c9B2b0E753A);
    address payable public liqWalletAddress = payable(0x4CB9aA1659d6e5f8FD3776C6e0406c9B2b0E753A);
    ...
    uint256 private _totalSupply =  1627000 * 10**_decimals;
    uint256 public _maxTxAmount =   49000 * 10**_decimals;
    uint256 public _walletMax =     66000 * 10**_decimals;
