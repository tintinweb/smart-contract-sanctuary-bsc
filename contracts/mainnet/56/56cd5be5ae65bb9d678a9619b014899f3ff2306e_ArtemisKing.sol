...
contract ArtemisKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Artemis King";
    string private _symbol = "ARTKING";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD405BbbB049Bf473063477F1de356b73540Ced5f); 
    address payable public buyBackWalletAddress = payable(0xD405BbbB049Bf473063477F1de356b73540Ced5f); 
