...
/**
    https://t.me/Letsgetbacktotumblr

    LGBT - Let's Go Back to Tumblr

    A good hype brewing for the tumblr platform since Elon acquired twitter and started banning comics: shadow banning unverified users. 

    Few known actors already left twitter to go back to tumblr and pretty sure many more will follow. 
...
contract LGBT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Let Go Back to Tumblr"; // 
    string private constant _symbol = "LGBT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 15;
    address public  _marketingWallet = 0x7AA67296E1522dcC9F2bF33EF2Dcc2e0D3794d6b;
