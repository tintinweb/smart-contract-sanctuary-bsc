...
contract  CCTVMeta   is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CCTVMeta";
    string private _symbol = "CCTVMeta";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x83B2f12d469Eb6a6e363902C5665BCe82c8bdB56);
