...
contract Dogwars is IERC20 {
    ...
    string constant private _name = "Dogwars";
    string constant private _symbol = "DOWA";
    ...
    address payable public marketingWallet = payable(0x2c4721DB159901aCB3d1838Ee12FA29685E65591);
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing) external onlyOwner {
