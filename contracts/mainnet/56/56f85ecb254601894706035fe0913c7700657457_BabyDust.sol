...
contract BabyDust is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Baby Dust";
    string constant _symbol = "BDU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 49) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 49) / 100; 
