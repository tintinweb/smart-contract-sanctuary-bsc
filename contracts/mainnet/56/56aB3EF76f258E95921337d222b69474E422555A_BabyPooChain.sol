...
.##.....#.##.....#.##.....#....##.....##.......##.....#.##.....#...##....#.##.....#.##.....#..##.##...###
.########.##.....#.########....##.....##........#######..#######....######.##.....#.##.....#.###.##....##
 Telegram : https://t.me/BabyPooChain
*/
...
contract BabyPooChain is Context, IERC20, Ownable {
    ...
    uint256 _tTotal = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _tTotal * 3 ) / 100; // 3%

    uint256 public _maxWalletToken = ( _tTotal * 3 ) / 100; // 3%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "BabyPooChain"; // 
    string private constant _symbol = "BABYPOOP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xF494d60FdFCe931567cF1186c789d88C3F5B78DB;
