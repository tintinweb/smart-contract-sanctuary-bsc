...
contract GDANK is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Giga Dank Diamond Army", "GDANK")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifdelkwyvvgap22zgzfqtkan7j5tx6emjcct6awtiutcbu4iszeyi/", Strings.toString(tokenId), ".json")
            );
    }
