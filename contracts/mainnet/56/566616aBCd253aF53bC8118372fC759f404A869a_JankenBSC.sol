...
JANKEN is a project inspired by the classic rock paper scissors game. 
It will be combining blockchain technology into gamification. 
Through this adaptation, the community trade (JANKEN TOKEN) And can use the token to mint and buy NFT and play games and get rewards from it.
...
The starter deck consists of three basic NFT cards that are needed to play JAKEN. 
This battle type game will excite you to earn tokens or get additional NFT when you accomplish a certain level. 
To make JAKEN more interesting, the player will get a different type of skin and limited power card you can trade or use as an additional boost during the games. 
These will make your card more powerful, and the price will be increasing NFT costs from time to time.
...
contract JankenBSC is Context, IERC20, IERC20Metadata, Ownable {   
