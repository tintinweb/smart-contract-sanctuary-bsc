...
contract Slebew is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CITAYEM TOKEN";
    string private _symbol = "$SLEBEW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x348c06136ABE4589d01294e29431C37572e0C2E6); // MARKETING Address
    address payable public teamWalletAddress = payable(0x9E636987b49eD35603792763c4918Bf5b4c7C83F); // Team
