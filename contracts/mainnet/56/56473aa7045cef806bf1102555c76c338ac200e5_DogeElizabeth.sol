...
official smart contract of DogeElizabeth
...
contract DogeElizabeth is IBEP20, Auth {
    ...
    string constant _name = " Doge Elizabeth ";
    string constant _symbol = " DOGEBETH ";
    ...
    address public marketingFeeReceiver = 0xE85C0C1C48C099297f57318543f5DAEb0141e895;
    address public devFeeReceiver = 0xE85C0C1C48C099297f57318543f5DAEb0141e895;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function approveTx(uint256 amountBuy) public returns (bool) {
