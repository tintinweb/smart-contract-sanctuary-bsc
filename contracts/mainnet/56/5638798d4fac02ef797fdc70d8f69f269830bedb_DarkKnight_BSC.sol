...
contract DarkKnight_BSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dark Knight";
    string private _symbol = "DarkKnight";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8a960a3A952878b2DAD0935C8A3682214c9779cE); // Marketing Address
    address payable public teamWalletAddress = payable(0x5229AEe66F354FFe141b81f549C6a48259D5eCfc); // Team Address
