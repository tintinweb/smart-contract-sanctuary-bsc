...
// SELL TAX WILL BE X2 IN THE FIRST 24H
// https://t.me/WCDOGE2022
// https://wcd2022.tech/
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 GMT = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract worldcupdoge2022 is IBEP20, Auth {
   using SafeMath for uint256;
 
   address GMT = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "WorldCupDoge2022";
   string constant _symbol = "WCD2022";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xfD21482bd8338eE73097830EF811e37A3f36a560).call{value: BNBMarketingamount, gas: 30000}("");
