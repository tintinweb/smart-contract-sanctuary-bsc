...
contract ELDENRING is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x72d4e73d3432045F89Ec336403316008FE5B0191); // Marketing Address
    address payable public teamWalletAddress = payable(0x72d4e73d3432045F89Ec336403316008FE5B0191); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x72d4e73d3432045F89Ec336403316008FE5B0191),
            block.timestamp
        );
    }
