...
contract WineKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WineKing";
    string private _symbol = "WineKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDf83eA3c3bcd056F2Bf1EcE74d0bAF93F8495215);
    address payable public teamWalletAddress = payable(0xDf83eA3c3bcd056F2Bf1EcE74d0bAF93F8495215);
