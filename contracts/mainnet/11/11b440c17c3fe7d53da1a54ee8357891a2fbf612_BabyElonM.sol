...
/**
 *Submitted for verification at testnet.bscscan.com/ on 2022-05-05
*/
...
contract BabyElonM is IBEP20, Auth { // This is just contract name 
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Elon M"; // Name for token here
    string constant _symbol = "BEM"; // Symbol for token 
    ...
    uint256 public totalFee = 3; //Total Fee
    ...
    uint256 public totalFeeBuy = 5; //Total Fee can be whatever u want
    ...
    uint256 public totalFeeSell = 5; //Total Fee can be whatever u want
