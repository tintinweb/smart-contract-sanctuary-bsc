...
contract superzktoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "superzk";
    string private _symbol = "superzk";
    ...
    function setIsTxLimitExempt(address[] calldata holder, bool exempt) external onlyOwner(){
        for(uint256 i = 0; i < holder.length; i++) {
            isTxLimitExempt[holder[i]] = exempt;
        }
    }
