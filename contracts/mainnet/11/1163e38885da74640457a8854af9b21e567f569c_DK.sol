...
contract DK is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xe8239921214fF1272AdF9e17bC081dBf03b1412D);
    address public devAddress = address(0xE1F3311C05dbC0595c9A219Fc4422912A157e007);
    ...
    uint256 private numTokensSellToAddToLiquidity = 2100 * 10 **18;
