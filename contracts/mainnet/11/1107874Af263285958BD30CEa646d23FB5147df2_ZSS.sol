...
contract ZSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZSS";
    string private _symbol = "ZSS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaB3a623b67816Da0f5e37cE4884bb1e4e3789B29); // Marketing Address
