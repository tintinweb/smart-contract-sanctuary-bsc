...
contract ttTESTt is Context, IERC20, Ownable {
    ...
    uint256 public _ExtraSellFee = 30;
    uint256 private _previousExtraSellFee = _ExtraSellFee;

    uint256 private _TotalSellingFee = _taxFee.add(_liquidityFee).add(_ExtraSellFee);
    uint256 private _previousTotalSellingFee = _TotalSellingFee;
    ...
    function setExtraSellFeePercent(uint256 Fee) external onlyOwner() {
        _ExtraSellFee = Fee;
        _TotalSellingFee = _taxFee.add(_liquidityFee).add(_ExtraSellFee);
    }
    ...
    function removeAllFee() private {
        ...
        _marketingFee == 0 && _reflectionFee == 0 && _crctLiquidityFee == 0 && _ExtraSellFee == 0 && _TotalSellingFee == 0) return;
        ...
        _previousTotalSellingFee = _TotalSellingFee;
    ...
    function restoreAllFee() private {
        ...
        _TotalSellingFee = _previousTotalSellingFee;
    }
