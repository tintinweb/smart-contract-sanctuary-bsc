...
/*
    ...
    Rekt Boris Jonhshon   
    https://t.me/RektBorisJohnson
    Dont ape before we post the CA in the official TG, bots will be rekt like the prime Minister.
...
contract RektBoris is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x265551BCa7fF8516D46DeCC1437Ef3F49e6194fE;
    address public devWallet = 0x87ce5B3312eECe0d5617Fd1e7c8e0F2F53409C7a; 
    ...
    string private constant _name = "REKT BORIS JOHNSON";
    string private constant _symbol = "RBJ";
    ...
    Taxes public taxes = Taxes(0, 5, 5, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 20, 2, 0, 0, 0);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 7 minutes;
    }
