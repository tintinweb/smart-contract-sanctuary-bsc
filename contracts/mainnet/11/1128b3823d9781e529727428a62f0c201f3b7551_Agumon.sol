...
https://t.me/AgumonBsc
https://twitter.com/agumonbsc
Contract V2.8 
...
contract Agumon is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x20AA1fa1aBE9C54A33B679ECbc1429a6B3267F3a;
    address public devWallet = 0xE5d0a782E0818b9F8305ef72da9Bcb64D18a720C; 
    address public operationWallet = 0x20AA1fa1aBE9C54A33B679ECbc1429a6B3267F3a;
    address public charityWallet = 0x20AA1fa1aBE9C54A33B679ECbc1429a6B3267F3a; 
    ...
    Taxes public taxes = Taxes(0, 8, 1, 3, 0, 0);
    Taxes public sellTaxes = Taxes(0, 14, 1, 5, 0, 0);
