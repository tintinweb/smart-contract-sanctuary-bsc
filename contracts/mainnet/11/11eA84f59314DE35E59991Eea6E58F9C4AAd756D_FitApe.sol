...
contract FitApe is Context, IERC20, Ownable {
    ...
    string private _name = "FitApe";
    string private _symbol = "FitApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa9af8CeFe43b117eC8faDD51CB8e0D7670bf77d3);
    address payable public teamWalletAddress = payable(0xa9af8CeFe43b117eC8faDD51CB8e0D7670bf77d3);
