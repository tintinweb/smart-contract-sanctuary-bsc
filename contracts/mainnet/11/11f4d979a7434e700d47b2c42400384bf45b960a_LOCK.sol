...
// SPDX-License-Identifier: Unlicensed
    ...
    //TELEGRAM: https://t.me/LOCK
    //WEBSITE: https://lock.com/
    ...
    contract LOCK is ERC20 {
        ...
        constructor () ERC20("LOCK", "$LOCK"){
            ...
            _marketingWalletAddress = 0xaFBd84B9476Ba944E3dFE3C8ac407F72e16EACF2;
        ...
        function isExcludedFromMaxWallet(address account) private view returns(bool){
            return _isExcludedFromMaxWallet[account];
        }

        function isExcludedFromMaxTnxLimit(address account) private view returns(bool) {
