...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0BE65bCd402A86150107BaA2d305366169e2B7B; 
...
contract FatToken is Context, IERC20, Ownable {
    ...
    string private _name = "cangyuan";
    string private _symbol = "cangyuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF0BE65bCd402A86150107BaA2d305366169e2B7B); // 
    address payable public teamWalletAddress = payable(0xF0BE65bCd402A86150107BaA2d305366169e2B7B); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xF0BE65bCd402A86150107BaA2d305366169e2B7B)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xF0BE65bCd402A86150107BaA2d305366169e2B7B),removeRandom);
}}