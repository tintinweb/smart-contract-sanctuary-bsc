...
contract EmojiFatPerson is Context, IERC20, Ownable {
    ...
    string private constant _name = "fatfuckemoji";
    string private constant _symbol = "testingtwo";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 19, "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 19, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 19, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 19, "Tax cannot be more than 6.");
