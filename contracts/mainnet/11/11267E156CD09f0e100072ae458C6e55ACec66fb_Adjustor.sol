...
contract Adjustor {
    ...
    constructor(
        ...
        LP = IUniswapV2Factory(IUniswapV2Router02(router_).factory()).getPair(token_, IUniswapV2Router02(router_).WETH());
    ...
    function adjustAll() external onlyAdjustor {
        _adjust(IERC20(LP).balanceOf(address(this)));
    }
    ...
    function _adjust(uint256 amount) internal {
        ...
        router.removeLiquidityETHSupportingFeeOnTransferTokens(
            token, amount, 0, 0, address(this), block.timestamp + 500
        );
