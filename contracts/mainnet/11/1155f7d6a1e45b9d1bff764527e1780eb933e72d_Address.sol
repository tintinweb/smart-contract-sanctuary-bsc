...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf8db8efcE7Fa405C1A718906Dd7340625ce4a32E;
...
contract CAKESWAP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x65dF07860eA0CD0Ba5f6338C072682f4929206f3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CAKESWAP";
    string private _symbol = "CAKS";
