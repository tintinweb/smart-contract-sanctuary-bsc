...
contract SharkJumping is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x866636675874b7131ea2D00843E8D6027a7d2734;
    ...
    constructor () public {
        ...
        maxTxAmountSell = totalSupply() * 100 / 1000; // 10% maxTx for sell
        _maxWalletSize = totalSupply() * 100 / 1000; // 10% maxWallet
