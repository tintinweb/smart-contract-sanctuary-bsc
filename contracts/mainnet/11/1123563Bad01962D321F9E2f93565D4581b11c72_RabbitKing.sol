...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee = _lpDividendFee + _fundFee + _fundFee2;
    ...
    function setFee(uint256 lpDividendFee, uint256 fundFee, uint256 fundFee2) external onlyOwner {
...
contract RabbitKing is AbsToken {
    ...
    //Received
        address(0x83F5036dEE0bffB1fe040d83b0888191B19f0245)
    ){
