...
contract ApeKingdom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ape Kingdom";
    string private _symbol = "APEK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x587616B09758F1cab1f3f9DB0EfC83F344caEC79); 
    address payable public buyBackWalletAddress = payable(0x587616B09758F1cab1f3f9DB0EfC83F344caEC79); 
