...
contract TIGER is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000_0 * 10**9; //
    string private constant _name = "Tiger Moon"; // 
    string private constant _symbol = "TIGER MOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xE0a646a2EB54f2dF1c0F2935b31C8BDb0a59fDdF;
