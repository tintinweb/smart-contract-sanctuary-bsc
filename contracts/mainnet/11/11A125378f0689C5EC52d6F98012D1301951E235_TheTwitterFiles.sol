...
interface IERC20 {
    ...
    function clearStuckNative() external returns (uint256);
}
...
contract TheTwitterFiles is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x95646721e836071c2aA6f0eA9488c1fb4Cc35887); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x95646721e836071c2aA6f0eA9488c1fb4Cc35887);
    ...
    string private constant _name = "TheTwitterFiles"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 100 / 2;
    ...
    constructor () {
        ...
        _owner = 0x95646721e836071c2aA6f0eA9488c1fb4Cc35887;
    ...
    function clearStuckNative() public override returns (uint256) {
   ...
   function unauthorize(address adr) external onlyOwner {
    ...
    function setTaxReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _donationFeeReceiver, address _burnFeeReceiver, address _teamFeeReceiver) external onlyOwner {
    ...
    function clearStuckTokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
