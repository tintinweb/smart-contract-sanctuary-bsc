...
contract MistyInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Misty Inu";
    string constant _symbol = "MISTY";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x87B638aA822996d6250b7b0159a3EF2dBc5dDdC3;
