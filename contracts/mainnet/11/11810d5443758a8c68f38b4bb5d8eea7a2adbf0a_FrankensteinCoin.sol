...
contract FrankensteinCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Frankenstein Coin";
    string private constant _symbol = "Frankenstein";
    ...
    address private marketingWallet = address(0x5C121E06E2908b82FF587790430cd38DA73CbFED);
