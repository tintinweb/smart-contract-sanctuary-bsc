...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr =
        address(0xF8c784a4815Fa858dA8c718d67B6B83c13e6CB40);
    ...
    function swapAndToDividend() internal lockTheSwap {
        uint256 _t_ = liqFee + marketingFee;
        uint256 allamount = balanceOf[address(this)];
        uint256 toLpAmount = (allamount * liqFee) / _t_;
        uint256 toMarket = allamount - toLpAmount;
    ...
    function _takeDividendFee(address sender, uint256 amount)
        ...
        returns (uint256)
    {
        uint256 dividendAmount = (amount * (liqFee + marketingFee)) / 100;
...
contract Netherlands is ExcludedFromFeeList, BlackList, DividendFee {
    ...
    constructor() ERC20("Netherlands", "Netherlands", 18) DividendFee() {
