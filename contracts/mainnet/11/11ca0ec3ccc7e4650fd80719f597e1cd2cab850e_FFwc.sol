...
contract FFwc is FFwcDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private FFwcTeam;
    address private CharityFFwc;
    ...
    string public override name = "QATAR 2022 FAN TOKEN";
    string public override symbol = "FFwc";
    ...
    constructor(uint totalSupplyValue, address FFwcTeamAddress, address CharityFFwcAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        FFwcTeam = FFwcTeamAddress;
        CharityFFwc = CharityFFwcAddress;
       
        // split the tokens according to agreed upon percentages
        balances[FFwcTeam] =  totalSupply * 4 / 100;
        balances[CharityFFwc] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's FFwcTeam pot
