...
contract TokenContract is ERC20, Ownable, Token{
    ...
    constructor() ERC20("Reward Hunters Token V2", "RHT") {
        
        address newOwner = 0x70E7Cd2680a4811508806CB3a6C62980a6DeCDC2; // can leave alone if owner is deployer.
        ...
        // update these!
        devAddress = address(0x70E7Cd2680a4811508806CB3a6C62980a6DeCDC2);
        rewardsAddress = address(msg.sender);
        extraAddress = address(0x70E7Cd2680a4811508806CB3a6C62980a6DeCDC2);
        liquidityAddress = address(msg.sender);
        futureOwnerAddress = address(0x70E7Cd2680a4811508806CB3a6C62980a6DeCDC2);
