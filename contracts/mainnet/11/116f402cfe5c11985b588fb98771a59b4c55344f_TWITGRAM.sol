...
contract TWITGRAM is IBEP20, Auth {
    ...
    string constant _name = "TwitGram";
    string constant _symbol = unicode"TWITGRAM";
    ...
    function AddBlakcklist() external onlyOwner{
    ...
    // Exclude bots
    function AddBlakcklist(address _address, bool _value) public onlyOwner{
