...
contract Waifu is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x25EB395dD007675F4bad90cDFe000c99ECFd88a2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!_isExcluded[sender] && !_isExcluded[recipient],"Account is blacklisted");
    ...
    function setExclude(address addr, bool value) external authorized {
        _isExcluded[addr] = value;
    }
