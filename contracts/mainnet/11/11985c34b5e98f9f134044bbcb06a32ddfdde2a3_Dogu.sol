...
/*
tax 4/4
this is pure community driven coin 
i suggest telegram name is @dogubsc
*/
...
abstract contract Token is IERC20, Ownable {
    ...
    uint256 public _sellLPFee = 100;    //不要设置
...
contract Dogu is Token {
    constructor() Token(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E), //路由
    
        address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43),  //u
        "Dogu",
        "Dogu",
        18,  //不要改
        ...
        address(0x27E3AD6f0d39d9673fc91a56347B959Ba13AE5d0),//fund address
    
        address(0x27E3AD6f0d39d9673fc91a56347B959Ba13AE5d0)//dev address
    ){
