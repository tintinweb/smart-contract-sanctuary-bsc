...
//Baby Crocodile is built upon the fundamentals of Buyback and increasing the investor's value. On every transaction devs will buyback tokens.
...
//• Burned: 50% 🔥
//• Liquidity Locked on Mudra 🔐
//• Anti-Whale for the first 24 Hours 🐳🚫
//• Renounced Ownership ‼️  
//• Liquidity locked for 2 months  💥

//Telegram📢: t.me/bbcrocbsccoin
...
contract BabyCrocodileCoin is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BABY CROCODILE COIN";
    string private constant _symbol = "BABYCROCODILE";
    ...
    address payable private _developmentAddress = payable(0xc41a8986447B1BB6D4edA5982E088B0609DA0520); 
    address payable private _marketingAddress = payable(0xc41a8986447B1BB6D4edA5982E088B0609DA0520);
