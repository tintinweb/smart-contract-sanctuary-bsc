...
// *Telegram : https://t.me/cosmos1000
...
contract Cosmos is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x229268A99b7d23c17661f09592f6697EC5609498));
    address payable public devWallet =
        payable(address(0x391cC97a7ee42D80026FD2f5c0BFf10eba7e0D77));
    address public liquidityReceiver =
        0x391cC97a7ee42D80026FD2f5c0BFf10eba7e0D77;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "COSMOS NETWORK";
    ...
    uint256 private numTokensSellToAddToLiquidity = 15600 * 10**9;
