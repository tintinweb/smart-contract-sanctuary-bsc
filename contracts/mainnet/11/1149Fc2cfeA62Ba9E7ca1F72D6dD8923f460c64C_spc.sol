...
contract spc is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xD65088b0D2ac4d69f447dee2564fA06D8BE9B97B;
    ...
    constructor(address receiveAddress) public ERC20("Stephen Chow", "Stephen Chow") {
        ...
        */
        _mint(address(receiveAddress), 3888 * (10**18));
    }
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5 * (10**18); //must hold 200000+ tokens
    }
