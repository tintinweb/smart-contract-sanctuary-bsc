...
pragma solidity ^0.8.16;
contract BOOb1 is ERC20, Ownable {
    ...
    address public Funding=address(0x697418EB688db1B0822D21C78C022912581C0388);
    address public FeeAddr=address(0x1379c278004240cC9E7dA85cb0C493a4612CE757);
    uint256 public REF_PERCENTS = 5;//5% referal rewards
    uint256 public PERCENTS_Fee = 5;//5% fee
	event FeePayed(address indexed user, uint256 _tkns);

    constructor() ERC20("BOOb1", "bob1") {
