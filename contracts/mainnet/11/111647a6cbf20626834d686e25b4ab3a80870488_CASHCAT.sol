...
contract CASHCAT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2467d7d11970d1989ed0A732F40A41abb1C97DC7;
    address public donationWallet = 0x152b9F0F9Dc4EbbD1906eF6Ce7B13E9E461228ff;

    string private constant _name = "CASHCAT";
    ...
    Taxes public taxes = Taxes(0, 9, 2, 2);
    Taxes public sellTaxes = Taxes(0, 9, 2, 4);
