...
About Meta Game Space 
Meta Game Space is a BEP20 cryptocurrency that rewards holders with 4% rewards on the BUSD stablecoin.

👇 Don't miss...
💥⏳ Launch Today (March 4th) - 23:00 Utc

Slippage buy/sell 10-12%:
💹 5% Liquidity
💵 5% BUSD Rewards

🌐 Telegram: https://t.me/metagamespacebsc
...
contract metagamespacebsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Meta Game Space";
    string constant _symbol = "METAGAMESPACE";
    ...
    address public marketingFeeReceiver = 0x7388C21933b9690575a486fE42FB1a9B20e56aF8;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 50; // 2% of supply
    bool inSwap;
