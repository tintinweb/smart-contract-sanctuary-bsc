...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x595eeC3Da614072133679b504b4893BBBDb6fe1B;
...
contract HALLOBEANS is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"HALLOBEANS"; 
    string private constant _symbol = unicode"$HBS"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x595eeC3Da614072133679b504b4893BBBDb6fe1B), BNB_Tot);
            }
