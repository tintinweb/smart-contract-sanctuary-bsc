...
contract HUT is HUTaild, Context {
 ...
 function getP2() public view returns(uint256 ){
   ...
   function isContract(address account) internal view returns (bool) {
    ...
    function _topcheck(
        address recipient, uint256 amounts
         ...
         uint256 pp= getP2(); 
        uint256 uu =amounts.mul(1e18).div(pp);
        usrbuys[recipient]+=uu;
        require(usrbuys[recipient]<=200*1e18, " out 200");
    }
  ...
  mapping (address => bool) public hxkers;
   ...
   address public all =0xc4E84a2585d6cbb5e8Fb682338E9746e80b5013C;// 
    address public burnAddress = address(0);

   address public backropadress =0x7315e0EFaB17C038c13A1d4dfdf648Fb6B790972;// 
   address public marketadress =0x0d88d98E90A9BDF29C1Ea659573A4855c094cEdC;// 

   address public lpadress =0x8A63C796523E3F128340Dbe228b0c66cF6Be7082;// 
