...
contract BABYTOKENDividendReward is Ownable{

    IBABYTOKEN public babyToken;
    IBABYTOKENReward public babyTokenReward;
    uint256 public lastAmountTokenRewardsFee;
    ...
    function record(uint256 amountTokenRewardsFee) public onlyOwner {
        lastAmountTokenRewardsFee = amountTokenRewardsFee;
    }
    ...
    function getNumberOfTokenHolders() public view returns (uint256){
        return babyTokenReward.getNumberOfTokenHolders();
    }

    function AmountTokenRewardsFee() public view returns (uint256){
        return babyToken.AmountTokenRewardsFee();
    }

    function batchTransfer(address[] memory addrArr, uint256[] memory amountArr) public payable onlyOwner{
