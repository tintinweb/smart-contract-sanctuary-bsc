...
contract OwnableINU is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableINU: caller is not the owner");
        _;
    }
     /**
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableINU: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract EnergiseInu is IERC20INU, OwnableINU {
    ...
    string _name = "Energise Inu";
    string _symbol = "ENINU";
