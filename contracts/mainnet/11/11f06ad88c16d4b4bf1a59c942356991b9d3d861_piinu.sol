...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc508CF2067b640d80DA52dbC36602B0827B827b8; // owner address
...
contract piinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pi Inu";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Ba7a21EB8cd157232Db6f4cD4377762B3d02140); // Marketing Address
    address payable public teamWalletAddress = payable(0x5CEd1eAE549123A2dB705d6741b3cB533d9D351c); // Team Address
