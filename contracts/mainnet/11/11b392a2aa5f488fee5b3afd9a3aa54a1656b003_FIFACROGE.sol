...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x879b3E553A0025A29d35B8E4f6FdD182B051bDAf; // owner address
...
contract FIFACROGE is Context, IERC20, Ownable {
    ...
    string private _symbol = "FICRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x879b3E553A0025A29d35B8E4f6FdD182B051bDAf); // Marketing Address
    address payable public teamWalletAddress = payable(0x879b3E553A0025A29d35B8E4f6FdD182B051bDAf); // Team Address
