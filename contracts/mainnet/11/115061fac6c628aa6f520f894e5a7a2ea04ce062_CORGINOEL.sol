...
// telegram : https://t.me/Corginoel  --> Copy Link and send any to any folder and join the group
...
contract CORGINOEL is IBEP20, Auth {
    ...
    string constant _name = "Corgi Noel";
    string constant _symbol = unicode"CNOEL";
    ...
    // Exclude bots
    function Blacklist_Add_Wallet(address _address, bool _value) public onlyOwner{
