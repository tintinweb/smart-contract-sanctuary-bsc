...
/**
TWERK RACE 3D 
Utility Token with Bet Telegram Bot ✅
🤝 Low tax - 7% Buy/Sell
      5% - Marketing
      2% - Auto LP
📈 Renounced
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA76EDB6E58d5134F6b9bC8f9490be138544496fd;
...
contract TwerkRace3D is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twerk Race 3D"; // 
    string private constant _symbol = "$TRC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xcc6A86EC1533fFe95A71C503d39096524B8CF544);
