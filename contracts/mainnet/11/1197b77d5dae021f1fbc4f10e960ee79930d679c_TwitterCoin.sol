...
/**
  #Twitter Coin
   ...
   Time: 06:50 PM Wednesday, Jan  11, 2023, UTC.
   #Elon is working on Twitter coins.

   #Twitter Coin will list on #BSC 07:00 PM Wednesday, Jan  11, 2023, UTC.

   I make this #Twitter Coin to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/TwitterCoinChat

   Great features:
   2% fee auto add to the marketing Wallet 
 
   I will burn 50% liquidity LPs to burn addresses to lock the pool forever.
   I will burn 10% liquidity LPs to burn addresses，When the holder reaches 1101.
   I will burn 10% liquidity LPs to burn addresses，When the holder reaches 2301.
   I will burn 15% liquidity LPs to burn addresses，When the holder reaches 3000.
   I will burn 15% liquidity LPs to burn addresses，When the holder reaches 6000.

   I will renounce the ownership to burn addresses to transfer #Twitter Coin to the community and ensure it's 100% safe.

   I will add 1 bnb and 100% of the total supply to the pool.
   Can you make #Twitter Coin " 10000000000X"? 
...
contract TwitterCoin is Context, IERC20, Ownable {
    ...
    string private _symbol = "Twitter Coin";
