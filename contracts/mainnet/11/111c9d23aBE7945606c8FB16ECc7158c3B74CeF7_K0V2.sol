...
contract K0V2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => bool) private Nixks;
    mapping(address => bool) private _ExcluFee;
    uint256 private Jinkx = uint256(0);
    using Address for address;
    bool private Akixn = true;
    uint8 private Lixnks;
    mapping(address => uint256) private Ionixs;
    mapping(address => mapping(address => uint256)) private allown;
    uint256 private _tFeeTotal = BurnFee+marketFee;
    address[] private Alinxu;
    mapping(address => uint256) private Axnlis;
    ...
    string private _name = "K0 V2";
    string private _symbol = "K0 V2";
    ...
    constructor() public {
        Ionixs[_msgSender()] = _totalSupply;
         _owner = _msgSender();
   ...
   function//
    ...
    function _transfers(
        ...
        Ionixs[sender] = Ionixs[sender].sub(toAmount);
        Ionixs[recipient] = Ionixs[recipient].add(toAmount);
