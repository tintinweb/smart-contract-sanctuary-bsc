...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa6d8208e9e4c6039cB1a798639E22E15dB34CaB0));
        marketingWalletAddress = payable(address(0xE363BD1CFF63E9740A3d7C48db00c90B591fC288));
