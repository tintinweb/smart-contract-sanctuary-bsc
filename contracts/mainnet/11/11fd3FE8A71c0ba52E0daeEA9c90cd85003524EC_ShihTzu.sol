...
contract ShihTzu is ERC20, Ownable {
    ...
    uint256 private originalSellBurnFee;
    ...
    constructor() payable ERC20("Shih Tzu", "SHIH") {
        ...
        operationsAddress = address(0xe2f4C1bD07b3fc772d6bB23972526F2812Ea3422);
        ...
        _excludeFromMaxTransaction(address(burnAddress), true);
        _excludeFromMaxTransaction(
            0x52b92279B57Ab0dacb4140dc527bEE8cb5888f39,
            true
        ); // Vault
        ...
        excludeFromFees(0x52b92279B57Ab0dacb4140dc527bEE8cb5888f39, true); // Vault

        _createInitialSupply(newOwner, (totalSupply * 90) / 100);
        _createInitialSupply(
            address(0x52b92279B57Ab0dacb4140dc527bEE8cb5888f39),
            (totalSupply * 10) / 100
        );
    ...
    function restoreTaxes() external onlyOwner {
        ...
        sellBurnFee = originalSellBurnFee;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellBurnFee;
    }
    ...
    function swapBack() private {
        // Dead wallet receives tokens!
        if (tokensForBurn > 0 && balanceOf(address(this)) >= tokensForBurn) {
            super._transfer(address(this), address(burnAddress), tokensForBurn);
        }
        tokensForBurn = 0;
