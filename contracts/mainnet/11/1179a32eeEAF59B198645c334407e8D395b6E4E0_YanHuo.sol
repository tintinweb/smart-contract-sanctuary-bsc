...
contract YanHuo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Yan Huo";
    string private _symbol = "YanHuo";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x26142b0f5Fc33Fc484cF345145f507b3EC058369);
