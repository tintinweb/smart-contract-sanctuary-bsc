...
contract YUGIOHSHIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"YU GI OH";
    ...
    function CoinToShadowRealm(bool booly) public onlyOwner {
    SHADOWREALM = booly;
  }
}