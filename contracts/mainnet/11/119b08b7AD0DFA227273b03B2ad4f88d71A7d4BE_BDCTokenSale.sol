...
contract BDCToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "BDC";
    string private _name= "BIDCAPS COIN";
...
contract BDCTokenSale {
    address payable admin;
    BDCToken public tokenContract;
    ...
    constructor(BDCToken _tokenContract, uint256 _tokensSold)  {
