...
library Address{
 ...
 contract BooInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x26a79BDCa1a9F9E2eaBDF9bD8dE1094EC2bFd9f1;
    address public donationWallet = 0x7Ac785a454d0Da746B432BCC76B50282AcCDC46c;
    ...
    Taxes public taxes = Taxes(0, 5, 0, 3);
    Taxes public sellTaxes = Taxes(0, 47, 0, 3);
