...
contract TOKENS is Context, IERC20, Ownable {
    ...
    string private _name = "Trabbit";
    string private _symbol = "Trabbit";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 1;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0x93474A3C79BadCe85e6791C4D90fB8697a49CdFC);
    address payable private teamWalletAddress = payable(0x93474A3C79BadCe85e6791C4D90fB8697a49CdFC);
