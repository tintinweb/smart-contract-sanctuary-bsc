...
contract INBOX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420_000_000 * 10**9;
    uint256 public _maxTxAmount = 12_600_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; //
    string private constant _name = "INBOX"; // 
    string private constant _symbol = "IBX"; //    
