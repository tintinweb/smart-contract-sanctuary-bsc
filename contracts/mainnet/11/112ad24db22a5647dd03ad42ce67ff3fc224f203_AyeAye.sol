...
contract AyeAye is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aye-Aye CEO";
    string private _symbol = "$AYECEO";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xd9b883B87fB02400837d2A2B44882FF5C7fb3724;
    address public developerWallet = 0xd6a4164C68C94c0F4E86161def648C4b06Ef7529;
