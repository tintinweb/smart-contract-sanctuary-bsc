...
10% Buy Tax
10% Sell Tax (HIGHER (90%) AT LAUNCH)
...
contract CIVILIZATION is Ownable, IERC20 {
    ...
    string private _name = "Single biggest threat to future";
    string private _symbol = "CIVILIZATION";
