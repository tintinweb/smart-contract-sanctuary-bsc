...
contract PetDogToken is IERC20, Ownable {
    ...
    address private projectAddress = 0x052b2039EF8f20644F4B06Af772581f32f108a07;
    address private Marketing = 0x7bF2ECF7B1c9DaFAE224A0af2281571805Eb224a;

    
    string private _name = "PetDogeCoin";
    string private _symbol = "PetDoge";
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        bool shouldSetInviter = balanceOf(to) == 0 && !isContract(from) && !isContract(to);
          
        _tokenTransfer(from, to, amount, takeFee);
        if(shouldSetInviter && inviter[to] == address(0) ) {
            inviter[to] = from;
        }
    ...
    function _takeburnFee(
        ...
        if (_tOwned[address(0)] >= _tTotal.div(10000)) _burnFee == 0;
