...
abstract contract BscSPSNameServiceRefLayout is NameServiceRefLayout {
...
library SSBscMysteryBoxThreeGreenType {

    string constant _name_ = "Superpower Squad Mystery Box Three Green Bsc";
    string constant _symbol_ = "SSMB3GBsc";
    string constant _uri_ = "https://www.ssquad.games/mysteryBoxThreeGreenBsc";
...
abstract contract ContextLayout {
...
import "./ContextLayout.sol";

//this is a leaf module
contract ContextStorage is ContextLayout {
...
abstract contract HERC165Layout {
    /*
...
abstract contract HERC721Layout is HERC165Layout, ContextLayout {
...
//this is a leaf module
contract ReentrancyStorage is ReentrancyLayout {
