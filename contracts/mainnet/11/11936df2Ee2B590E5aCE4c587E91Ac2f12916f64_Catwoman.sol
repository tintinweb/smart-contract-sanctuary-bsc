...
_________         __                                       
\_   ___ \_____ _/  |___  _  ______   _____ _____    ____  
/    \  \/\__  \\   __\ \/ \/ /  _ \ /     \\__  \  /    \ 
\     \____/ __ \|  |  \     (  <_> )  Y Y  \/ __ \|   |  \
 \______  (____  /__|   \/\_/ \____/|__|_|  (____  /___|  /
        \/     \/                         \/     \/     \/ 
...
contract Catwoman is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xc027f70FD77BD880173c95a7703F3104485A1a0A;
        liquidityWallet = 0x901396d48F078D9c18eaB0F376705C46F7581d29;
        devWallet = 0xA20b94Eb71dAD9D16DC5A279fC5Ad552c549FDcE;
    ...
    function manualSwap(uint256 _amount) external swapping authorized{
        ...
        uint256 devFee = amountBNBMarketing.div(marketingFee);
        payable(devWallet).transfer(devFee);
        payable(marketingWallet).transfer(amountBNBMarketing.sub(devFee));
    ...
    function tokenSwap() internal swapping {
        ...
        uint256 devFee = amountBNBMarketing.mul(10).div(30);
        payable(devWallet).transfer(devFee);
        payable(marketingWallet).transfer(amountBNBMarketing.sub(devFee));
