...
/*
Coletiva Crypto Rendimentos - ECCR
https://coletivacrypto.com.br/
...
contract ColetivaCryptoRendimentos {
    
    mapping(address => uint) public balances;
    mapping(address => mapping(address => uint)) public allowance;
    
    string public name = "Coletiva Crypto Rendimentos"; // Nome do Token
    string public symbol = "ECCR"; // Simbolo do Token
    
    uint public numberOfTokens = 1000000000000; // Numero de tokens
    uint public decimalPlaces = 13; // Casas Decimais
