...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88451619c7Db19eaF2FF841031406eC7F56be137;
...
contract MIICHAN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x07973Ce016378D01044f2bDa3cc70E3837BeE2ae;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MII-CHAN CATCOIN";
    string private _symbol = "MIICHAN";
