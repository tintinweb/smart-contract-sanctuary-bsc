...
// Telegram : https://t.me/BscFinance_Trade
// Website : https://bscfinance.trade
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x299F63c887b41c4e7e437107750B5b989478c8A4; // owner address
...
contract bscfinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC FINANCE TRADE";
    string private _symbol = "BSC FINANCE TRADE";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x299F63c887b41c4e7e437107750B5b989478c8A4); // Marketing Address
    address payable public teamWalletAddress = payable(0x299F63c887b41c4e7e437107750B5b989478c8A4); // Team Address
