...
contract LockedStaking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xb059C380ee92C6641844414AdC5a9A2204C6A440);
    ...
    function updateApy(uint256 newApy) external onlyOwner {
        require(newApy <= 1000000, "APY must be below 10000%");
        updatePool(0);
        apy = newApy;
    }
    ...
    function updateExitPenalty(uint256 newPenaltyPerc) external onlyOwner {
        require(newPenaltyPerc <= 50, "May not set higher than 50%");
