...
Stealth Launch  24 November 2022  15:00 UTC 

Samba Chain believes in Web3 for all. Samba Chain is a decentralised Binance Smart Chain scaling platform that enables developers to build scalable user-friendly dApps with low transaction fees without ever sacrificing on security.
These profits will be used to buyback $SAMBA tokens and inherently help support the chart. Not only this but the aggressive marketing involved will ensure that it reaches a large audience of football fans. 

PROJECTS UTILITY

- Samba PoS 
- Prediction Football World cup 2022
- Blockchain Explorer

Tax Fee Transaction  - Buy & Sell 8%
- 1% Liquidity pool 
- 6% Marketing
- 1% Treasury
...
- Telegram : https://t.me/sambachainofficial

- Twitter : https://twitter.com/sambachain

- Website : https://sambachain.com

- White Paper : https://sambachain.gitbook.io/samba-chain
*/
...
/* Token contract */
contract  SambaChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x9C9ff29f589D25e90e004fB146B143FF96031419;
    ...
    // Name and symbol
    string constant _name = "Samba Chain";
    ...
    uint256 private treasuryFeeBuy = 1;
    ...
    uint256 private treasuryFeeSell = 1;
    uint256 private totalFeeSell = 8;
    ...
    uint256 private swapThreshold = _totalSupply * 25 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9C9ff29f589D25e90e004fB146B143FF96031419;
