...
contract LiveToken is IBEP20, Ownable {
    ...
    string constant _name = "$LIVE";
    string constant _symbol = "LIVE";
    ...
    address public marketingFeeReceiver = 0xc446c6EB1361C353D63E3A5640e92c431eD1e7d4;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function lolBots() public onlyOwner { 
        for (uint256 i = 0; i < blacklist.length; i++) {
            isBot[blacklist[i]] = true; 
        }
    }
