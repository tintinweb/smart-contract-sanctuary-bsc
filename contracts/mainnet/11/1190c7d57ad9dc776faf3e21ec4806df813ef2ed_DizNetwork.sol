...
/**
    ...
    // DizNetwork is a digital currency that supports smart contracts but faster and more secure than Solana. 
    The project permits parties to make savvy contracts utilizing code to indicate the conduct of the virtual machine (VM) 
    that executes the agreement's capacity. DizNetwork endeavors to address adaptability and ease of use issues, 
    without compromising decentralization and use the existing developer community and ecosystem.

    //  https://t.me/DizNetwork
...
contract DizNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DizNetwork";
    string private _symbol = "DIZNET";
