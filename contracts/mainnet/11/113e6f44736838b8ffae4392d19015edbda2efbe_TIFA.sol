...
contract TIFA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x50165b673876f1A91B12a45D253dF5C70c360EA0); 
    address payable private Wallet_Dev = payable(0x50165b673876f1A91B12a45D253dF5C70c360EA0);
    ...
    string private constant _symbol = unicode"TIFA"; 
    ...
    constructor () {
        ...
        _owner = 0x50dBf1c0E83B746122C2C0930C4A35efB5960ECd;
