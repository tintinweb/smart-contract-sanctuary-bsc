...
// File: GoldDragonCoin.sol

// contracts/GoldDragonCoin.sol
...
contract GoldDragonCoin is ERC20, Ownable {
    ...
    //address public constant MDC = 0x0ca5127599D164431Bdf930d81591e9Bd784deC0;
    ...
    //Gold Dragon Coin
    //GDC
    //2100000000 000000000000000000
    constructor(string memory name_, string memory symbol_, uint256 total_) ERC20(name_, symbol_){

        DESTROY = address(1);
        SWAP_PAIR = IUniswapV2Factory(IUniswapV2Router01(ROUTER).factory()).createPair(address(this), MDC);
    ...
    function _handleTransferFeeWhenTokenTransfer(
        ...
        if (s2 == 2) {
            //sell or add
            _standardTransfer(from, DESTROY, fee * 5);
            return amount - fee * 5;
        }
        //buy or remove
        _standardTransfer(from, DESTROY, fee * 3);
        return amount - fee * 3;
    }
