...
contract PumpInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pump Inu Token";
    string private constant _symbol = "Pump Inu";
    ...
    address private marketingWallet = address(0xeaC63A2D03a97aeaCa8e26e4410361109237f9E6);
