...
contract LuenCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAdD2042E56b88081AA3C8f17bf48da28Dd87087c); 
    ...
    uint256 public _maxTxAmount = 55000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 4500000000 * 10**9; 
    uint256 private buyBackUpperLimit = 55000000000 * 10**18;
