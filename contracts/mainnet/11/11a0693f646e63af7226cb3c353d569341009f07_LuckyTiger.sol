...
contract LuckyTiger is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x67DcCd85BB895C6884ef147B716cA72715D24137); // Marketing Address
    address payable public teamWalletAddress = payable(0x67DcCd85BB895C6884ef147B716cA72715D24137); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 666 * 10**3;
