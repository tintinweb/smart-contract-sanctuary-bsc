...
/**
Great Dane Inu🐕‍ 
👉The English name of the Great Dane Inu is translated from the French name "giant Dane Inu". Also known as the German Mastiff in mainland Germany, it is known as the "Sun God" among dogs. The Great Dane Inu is largest dog in the world. 👈
...
💪 Great Dane Inu will set up a unique anti-war fund, the anti-war fund association will organize to help the oppressed weak and neutral countries.💪
...
contract GreatDaneInu is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0x4aaE6a1b256ef728953ee788D6d0Fbb346E1A2Ec;
    address private CEXWallet = 0x97947D98DbD713289caF0BD7532F11Af39d6F64d;
    address public Charity = 0x966eDB03D4B72d3156F8fBFa8A609b5e4CE51fe2;

    string private constant _name = "GreatDaneInu";
    string private constant _symbol = "GreatDaneInu";
    ...
    Taxes public taxes = Taxes(1, 3, 1, 0, 0);
    Taxes public sellTaxes = Taxes(1, 3, 1, 0, 0);
