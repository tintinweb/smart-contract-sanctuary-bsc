...
/*
Project name - DEX BUILDER CEO
Dev - @majorbenzs
Time - 20 UTC (universal time coordinate)

Telegram chat - https://t.me/DexBuilderCeo
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DexBuilderCeo is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DEX BUILDER CEO";
    string private _symbol = "$DBCEO";
    uint8 private _decimals =  6;

    address payable public marketingWalletAddress = payable(0x0B68D8a31c802a89CE70FBf8644A1EB80F8432FE);
    address payable public devWalletAddress = payable(0x3Ec786e83Ea6D1D75AC11C8a4e22416FEFb662A1);
