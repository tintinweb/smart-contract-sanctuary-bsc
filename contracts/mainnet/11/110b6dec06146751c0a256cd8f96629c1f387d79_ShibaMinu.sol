...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66C147f533D3FD1CCE6AA17bF3d3227dED9Cd163;
...
contract ShibaMinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x87fbB94010C9b4D3d0ab5a147Ee95d212CfB02eD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shiba Minu";
    ...
    uint256 public totalFee                     = _taxFee + _developmentFee + _liquidityFee;
    uint256 public totalSellFee                 = _sellTaxFee + _sellDevelopmentFee + _sellLiquidityFee;
    ...
    function setFees(uint256 taxFee, uint256 sellTaxFee, uint256 developmentFee, uint256 sellDevelopmentFee, uint256 liquidityFee, uint256 sellLiquidityFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalFee             = _taxFee + _developmentFee + _liquidityFee;
        totalSellFee         = _sellTaxFee + _sellDevelopmentFee + _sellLiquidityFee;
