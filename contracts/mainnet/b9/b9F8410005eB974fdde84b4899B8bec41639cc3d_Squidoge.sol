...
contract Squidoge is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 15 * 10**14 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 30 * 10**_decimals;
    string private constant _name = "SQUID DOGE";
    string private constant _symbol = "SQUIDOGE";
