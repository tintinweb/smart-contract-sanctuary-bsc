...
MIKU COIN 2.0 : THE POWER OF WINGS!
...
Don't miss this next hyped coin in BSC! 
...
contract MIKUCOINTWO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x018689c71742C47f37929D39611A90060804803B); 
    address payable public Wallet_Dev = payable(0xB5079294C83dF69Fe3b9aef60d3EE6ca0461C9b9);
    ...
    string private constant _name = "MikuCoin 2.0"; 
    ...
    constructor () {
        ...
        _owner = 0xB5079294C83dF69Fe3b9aef60d3EE6ca0461C9b9;
