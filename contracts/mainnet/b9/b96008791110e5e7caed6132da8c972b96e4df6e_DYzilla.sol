...
contract DYzilla is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"DYzilla";
    ...
    uint256 private _maxTxAmount = 10000000000000000000000000000000000000000 * 10**_decimals;
    uint256 private _maxWalletSize = 1000000000001000000000000000000000000000000  * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x96512c314e76D4057A2B101D4E444D12d7594bC6));
        marketingWallet = payable(address(0x96512c314e76D4057A2B101D4E444D12d7594bC6));
