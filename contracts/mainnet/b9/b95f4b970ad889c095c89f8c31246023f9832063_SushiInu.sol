...
TG Community - https://t.me/SushiInuProject

What can do with one dollar, can he become a millionaire?
Yes he can when a community of believers come together to support it.

Join the telegram read the pinned before you buy it. 

Dont buy more than 1% = 10 Billion of supply from 1 wallet else you will be blacklisted. 
...
contract SushiInu is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable private _marketingAddress = payable(0x710c86273aAe8bF991c69D0b264513F809a2913a);
    address payable private _teamAddress = payable(0x710c86273aAe8bF991c69D0b264513F809a2913a);
    address payable private _ecosystemAddress = payable(0x710c86273aAe8bF991c69D0b264513F809a2913a);
    address payable private _lpRecipient = payable(0x710c86273aAe8bF991c69D0b264513F809a2913a);
