...
Baby Web3 Finance ($BABYWEB) was born as a little secret project to celebrate our main token's listing on CMC: https://coinmarketcap.com/currencies/web3-finance/
...
contract BabyWeb is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Web3 Finance";
    string private constant _symbol = "BABYWEB";
