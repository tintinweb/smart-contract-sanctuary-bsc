...
/*
Tg: https://t.me/Apemania
Web: https://www.apemaniacoin.com/

10% for buys 10% for sells
*/
...
contract APEMANIA is Context, IBEP20, Ownable {
    ...
    string private _name = "APEMANIA";
    string private _symbol = "APEMANIA";
    ...
    function setlsFeeExempt(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _lpFeeBuy = lpFee;
    }

    function setLiqFee(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _lpFeeSell = lpFee;
    }
...
//adding multiple addresses to the blacklist - Used to manually block known bots and scammers
    function setblacklistAddress(address[] calldata addresses) external onlyOwner {
