...
contract DOgeZilla2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " DOgeZilla 2023 ";
    string private _symbol = " DZ ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85C357A188949e954e95087251EDEfB0FA078C3A);
    address payable public teamWalletAddress = payable(0x85C357A188949e954e95087251EDEfB0FA078C3A);
    ...
    uint256 public _maxTxAmount = 69000000000000 * 10**_decimals; 
    uint256 public _walletMax = 69000000000000 * 10**_decimals;
