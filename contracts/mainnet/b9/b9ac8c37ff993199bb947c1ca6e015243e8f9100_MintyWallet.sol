...
/** 
 *  SourceUnit: /home/dos/dev/softblock/MintyMarket_Contracts/contracts/Wallet.sol
*/
...
contract MintyWallet {
  ...
  function withdraw(uint256 _amount) external onlyOwner {
    require(_amount > 0, "amount = 0");
    require(_amount <= MMT_Total, "The amount is greater than what is in the users account");
    MMT_Total -= _amount;
