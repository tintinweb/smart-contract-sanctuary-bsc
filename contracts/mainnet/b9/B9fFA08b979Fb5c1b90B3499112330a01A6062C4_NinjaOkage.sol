...
contract NinjaOkage is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Ninja Okage";

    string private _symbol = "$NO";

    uint8 private _decimals = 9;

    address public feeAddress = 0xD38dC6709d47A854a2D3bB1035f7Ec79Ab0fC10e;
