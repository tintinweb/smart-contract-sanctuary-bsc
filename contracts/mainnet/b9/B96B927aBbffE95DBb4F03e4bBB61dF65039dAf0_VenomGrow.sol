...
//VENOMGROW LIVE ON BSC DON'T MISS IT OUT! YOU ARE WARNED
...
contract VenomGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xF59A58a76528A8077100DeA745B2Efd177fE7eC8);
    ...
    string private constant _name = "VenomGrow"; 
    string private constant _symbol = unicode"VENOMGROW"; 
    ...
    constructor () {
        ...
        _owner = 0xF59A58a76528A8077100DeA745B2Efd177fE7eC8;
        ...
        uniSwapV2Pair = payable(0xF59A58a76528A8077100DeA745B2Efd177fE7eC8);
