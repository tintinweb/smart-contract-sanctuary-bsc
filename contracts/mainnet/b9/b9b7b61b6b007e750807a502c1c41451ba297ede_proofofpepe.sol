...
interface IDEXRouter {
 ...
 contract proofofpepe  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Proof of Pepe";
    string constant _symbol = "PEPE";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 999) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 999) / 100; 
    ...
    address public devFeeReceiver =0x53629A3527dFb1e08D2e0CaE0f6B2692737528dd; 
    address public buybackFeeReceiver = 0x53629A3527dFb1e08D2e0CaE0f6B2692737528dd;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 999; // 999%
    bool inSwap;
