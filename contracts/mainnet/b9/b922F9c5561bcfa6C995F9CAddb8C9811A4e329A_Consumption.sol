...
contract Consumption is Ownable {
    ...
    IConsumptionNFT nft = IConsumptionNFT(0xcf2883c592254b63B1dD4679B49935BED717C424);
    ...
    function purchase(uint pay) external {
        ...
        require(pay == 1 * 10 ** 18 ||
            pay == 50 * 10 ** 18 ||
            pay == 100 * 10 ** 18, "Error pay amount");
    ...
    function burn(uint amount) external {
        ...
        nft.safeTransferFrom(msg.sender, market,  0, amount, "");
