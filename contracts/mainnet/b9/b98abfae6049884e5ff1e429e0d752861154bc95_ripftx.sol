...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf3957903e06788e19B2acd88fBb03663f1Eda244; // owner address
...
contract ripftx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "R.I.P FTX";
    string private _symbol = "R.I.P FTX";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xf3957903e06788e19B2acd88fBb03663f1Eda244); // Marketing Address
    address payable public teamWalletAddress = payable(0xf3957903e06788e19B2acd88fBb03663f1Eda244); // Team Address
