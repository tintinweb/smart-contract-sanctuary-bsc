...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b3aa53D6c747d062C716649dfB8a307bF2B8c28; // owner address
...
contract FreddyDoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string constant _name = "Freddy Doge";
    string constant _symbol = "FREDDYD";
    uint8 constant _decimals =  18;

    address payable public marketingWalletAddress = payable(0x4b3aa53D6c747d062C716649dfB8a307bF2B8c28); // Marketing Address
    address payable public teamWalletAddress = payable(0x4b3aa53D6c747d062C716649dfB8a307bF2B8c28); // Team Address
    ...
    uint256 public _maxTxAmount = 5 * 1000000 * (10 ** _decimals) / 100;
    uint256 public _walletMax = 15 * 1000000 * (10 ** _decimals) / 100;
