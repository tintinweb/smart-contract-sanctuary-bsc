...
*/
/**
Join Community Telegram: https://t.me/newrabbits
Our Website: https://newrabbits-app.tech Will be live TODAY
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9Acd081B2FeAA416424D83bA03a2587e3D095896; // owner address
...
contract NewRabbitsApp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Rabbits";
    string private _symbol = "$NRB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9Acd081B2FeAA416424D83bA03a2587e3D095896); // 
    address payable public teamWalletAddress = payable(0x9Acd081B2FeAA416424D83bA03a2587e3D095896); // 
