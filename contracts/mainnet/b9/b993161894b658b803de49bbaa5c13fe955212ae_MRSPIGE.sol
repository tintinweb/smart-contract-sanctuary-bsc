...
contract MRSPIGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mrs Pige";
    string private _symbol = "MRSPIGE";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xB628180261cA32aa8e495Cf017BE0b78C525C430); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf0353be325fe483876Bd6856FE486Ae555e5E875); // BuyBack Address
