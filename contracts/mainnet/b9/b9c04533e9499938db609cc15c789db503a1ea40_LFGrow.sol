...
library Address{
  ...
  contract LFGrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5037901fD0F46361d8d02Dd1c671dB012308fb23;
    address public teamwallet = 0xeA4a8f98c12D433197253E8413e9b3DF10d26395;

    string private constant _name = "LFGrow";
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(teamwallet).sendValue(donationAmt);
        }
    }
