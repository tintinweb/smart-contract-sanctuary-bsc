...
contract Bermuda is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Triangle", "Bermuda") {
    ...
    function _transfer(
        ...
        // regardless of buy / sell we will reset the sell total fees based on the early sell tax above. Should not be an issue.
