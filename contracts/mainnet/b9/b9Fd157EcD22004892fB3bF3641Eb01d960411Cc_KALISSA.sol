...
contract KALISSA is ERC20, Ownable {
    ...
    constructor (address newOwner ) payable ERC20("KALISSA","KALI")
    {   
        ...
        liquidityShare  = 50;
        marketingShare  = 50;
        marketingWallet = 0x935AfeDF0245Ce87916083B95BB790E22B1D2F66;
        ...
        swapTokensAtAmount = 500_000_000 * (10 ** 18) / 5000;
        _mint(owner(), 500_000_000 * (10 ** 18));
        require(buyFee <= 10 && sellFee <= 10, "Fees must be less than 10%");
        require(marketingShare + liquidityShare == 100, "Marketing share and liquidity share must add up to 100");
    }
