...
contract MicroCats is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x1E0DC8D36B9B464aab541967F81F7d84580C304c;
    address public devAddress = 0x39630986076843F522795D91f96d48526ea1d4e5;

    string private constant _name = "MicroCats 0x0A7DCCe2a8CDC696e3451407E7209d9B26473Dd8";
    ...
    // Owner cannot transfer out MicroCats from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out MicroCats!");
