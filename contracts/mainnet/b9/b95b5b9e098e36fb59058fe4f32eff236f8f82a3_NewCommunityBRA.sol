...
contract NewCommunityBRA is Context, IERC20, Ownable {
    ...
    string private _symbol = "$nBRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x79196bfD7fB2e447fA0cf4eeeaC0108BC640CC27); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x79196bfD7fB2e447fA0cf4eeeaC0108BC640CC27); // Team Address
