...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _fund1 = 200;
    uint256 public _fund2 = 300;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (fund1amount > 0) {
                ...
                _takeTransfer(sender, address(0xAd4ac609B7Bf6fE6b9503905C3232C9AC920B166), fund1amount);
            }
               uint256 fund2amount = tAmount * _fund2 / 10000;
            if (fund2amount > 0) {
                feeAmount += fund2amount;
                _takeTransfer(sender, address(0x45b1D03335FE239525ebeAff034a2165eaaAF425), fund2amount);
            }
...
contract Dsvn is AbsToken {
    ...
    //0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        4000000,
    //Receive
        address(0x56dd53e72aC0b542A1A7F8780ca7050252C91e05)
    ){
