...
/*
SHINJIRAI INU
 Portal: https://t.me/ShinjiraiInu
...
contract ShinjiraiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x37e0a3Ab9741D7aC337F801956E0455B43b723A9); 
    address payable public Wallet_Dev = payable(0x37e0a3Ab9741D7aC337F801956E0455B43b723A9);
    ...
    string private constant _name = "Shinjirai Inu"; 
    string private constant _symbol = unicode"ShinjiraiInu"; 
    ...
    uint256 public _maxTransactionAmount = _tTotal * 20 / 100; 
    ...
    constructor () {
        ...
        _owner = 0xb18e2A444be92C4B7aF57790526F5F823b50e3b2;
