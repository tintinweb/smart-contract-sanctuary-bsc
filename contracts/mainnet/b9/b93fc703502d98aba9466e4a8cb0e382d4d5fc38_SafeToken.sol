...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 21 * (10**9); // user must hold 21 token
...
contract SafeGreenEarth is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x595CB0658055bfeD1674be7B3f1cBCd6e25D5032;
    address ZERO = 0x0000000000000000000000000000000000000000;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) _allowances;

    string constant _name = "SaveGreenEarth";
    string constant _symbol = "SGE";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(recipient == pair && extraFeeOnSell != 0) {
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            (bool success, ) = payable(marketing).call{value: amountBNBMarketing, gas: 30000} ("");
