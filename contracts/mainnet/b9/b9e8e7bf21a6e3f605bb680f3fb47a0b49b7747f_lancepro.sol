...
contract lancepro is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Crypto Lance Pro";
    string private _symbol = "CLP";
