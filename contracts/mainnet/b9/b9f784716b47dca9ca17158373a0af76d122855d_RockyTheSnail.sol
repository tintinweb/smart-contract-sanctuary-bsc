...
/**
Telegram    : t.me/rockythesnail
Website     : https://rockythesnail.fun
 **/
...
/* Token contract */
contract RockyTheSnail is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x9BB9B3D8559a482ff7aad55B03e6A213f503EEc5;
    ...
    // Name and symbol
    string constant _name = "Rocky The Snail";
    string constant _symbol = "ROCKY";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 480000000 * (10 ** _decimals); // 480m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x929e76270fEAce29f18d35c253e68eD33B511Acd;
