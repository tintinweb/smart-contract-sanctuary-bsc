...
contract EasterBunny is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1000000000000 * 10**18; // 0.1%
    uint256 public maxBuyLimit = 50000000000000 * 10**18; // 5%
    uint256 public maxSellLimit = 20000000000000 * 10**18; // 2%
    uint256 public maxWalletLimit = 50000000000000 * 10**18; // 5%
    ...
    constructor() BEP20("Easter Bunny", "EBUNNY") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 10000000000000, "Swap threshold amount should be lower or equal to 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 1000000000000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 1000000000000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 10000000000000, "Cannot set max wallet amount lower than 1%");
