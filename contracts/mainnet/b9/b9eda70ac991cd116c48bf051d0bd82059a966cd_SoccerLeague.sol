...
// SPDX-License-Identifier: Unlicensed
    ...
    contract SoccerLeague is Context, IERC20, Ownable {
        
        using SafeMath for uint256;
        using Address for address;
        
        string private _name = "SoccerLeague";
        string private _symbol = "SLG";
        uint8 private _decimals = 18;

        address payable public marketingWalletAddress = payable(0x62E0BCEa0787d6bF9a97dE05e9dD46A9C0f92Bec);
        address payable public teamWalletAddress = payable(0xd98C6E1119A34e41c7d90f63ee4805E254fd3073);
        address public OwnerAddress = 0x511b14d70E694B5bf32B4CC12414046e1d8C1954;
        ...
        uint256 private minimumTokensBeforeSwap = 5 * 10**3 * 10**_decimals; 
