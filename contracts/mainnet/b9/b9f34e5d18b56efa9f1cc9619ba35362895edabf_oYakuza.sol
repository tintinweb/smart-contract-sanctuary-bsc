...
contract oYakuza is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "oYakuza";
    string private _symbol = "oYakuza";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x393db4Cbf1aAe546861E964002d28034098bac98); // Marketing Address
    address payable public teamWalletAddress = payable(0x94c288adBC99d7fC14A5826B22CA56d52F84577D); // Team Address
