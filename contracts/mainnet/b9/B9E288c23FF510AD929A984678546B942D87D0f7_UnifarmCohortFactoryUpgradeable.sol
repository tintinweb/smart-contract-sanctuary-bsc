...
contract UnifarmCohort is IUnifarmCohort {
    ...
    function computeRValue(
        ...
        uint256 notZeroPriorEpochTVL = 0;
        while (i < currentEpoch) {
            ...
            if (isBoosterBuyed == false) {
                ...
                notZeroPriorEpochTVL = priorTotalStaking > 0 ? priorTotalStaking : notZeroPriorEpochTVL;
                uint256 priorEpochATotalStaking = notZeroPriorEpochTVL > 0 ? notZeroPriorEpochTVL : totalStaking[farmId];
