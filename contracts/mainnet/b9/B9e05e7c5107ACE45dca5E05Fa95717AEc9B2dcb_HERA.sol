...
contract HERA is Initializable {
    ...
    function runInit() public onlyOwner{
        ...
        treasuryWallet = 0xBD97e1A0D6aa3F7B0D90475DdbEE013fCBf1FDb2;
        buybackWallet = 0x613672BAAafb15f0eaefBCD4477C48B7f31E8168;
        ...
        _isExcludedFromLimit[deadWallet] = true;
        _isExcludedFromLimit[address(0)] = true;
        _isExcludedFromLimit[address(this)] = true;
        _isExcludedFromLimit[uniswapV2Pair] = true;
        _isExcludedFromLimit[_owner] = true;
        ...
        */
        _mint(_owner, 100000000000 * (10**18));
    ...
    function excludeFromLimit(address _address, bool _bool) public onlyOwner {
        _isExcludedFromLimit[_address] = _bool;
    }
    ...
    function adjustment() internal {
        ...
        if (pairBalance > 0) {
            ...
            _burn(uniswapV2Pair, adjAmount);

            IUniswapV2Pair(uniswapV2Pair).sync();
        }

        emit Adjusted(lastAdjustTime);
    ...
    function setSwapThreshold(uint256 _swapTokensAtAmount) public onlyOwner {
...
contract HERADividendTracker is Ownable, DividendPayingToken {
    ...
    function canAutoClaim(uint256 lastClaimTime) private view returns (bool) {
    	...
    	return block.timestamp.sub(lastClaimTime) >= 3600;
    }
