...
contract MichelleIceCity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Michelle Ice City";
    string private _symbol = "MIC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xEc674b4cc72491d0bB24A76f5de819Be8E3C25AB); 
    address payable public BurnedWalletAddress = payable(0x91CF9528C005f0F0763D414F7Eeac90BA6A08888); 
