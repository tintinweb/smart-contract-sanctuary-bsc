...
contract TylerdaGay is Context, IERC20, Ownable {
    ...
    string private constant _name = "TylerdaGay";
    string private constant _symbol = "TDGay";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x99943CceE901789BFAFa8F86a8179049d5121F47);
    address payable private _marketingAddress = payable(0x6C4AF2693B01C6F3f20C97dA6e304e3783DCdfe3);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 11, "Redis cannot be more than 12.");
	    require(redisFeeOnSell < 11, "Redis cannot be more than 12.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 9.");
	    require(taxFeeOnSell < 7, "Tax cannot be more than 9.");
