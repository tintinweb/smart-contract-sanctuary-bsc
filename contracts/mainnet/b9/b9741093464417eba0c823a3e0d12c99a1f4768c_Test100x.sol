...
library Address{
 ...
 contract Test100x  is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 500_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 500_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xf53366DEf6CFAc109D85e9F05AD22a19b568c279;
    address public donationWallet = 0xf53366DEf6CFAc109D85e9F05AD22a19b568c279;

    string private constant _name = "Test100x";
    string private constant _symbol = "Test100x";
    ...
    Taxes public taxes = Taxes(0, 4, 3, 4);
