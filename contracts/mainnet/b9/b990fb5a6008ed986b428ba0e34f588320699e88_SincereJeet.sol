...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6F363396875363c0111f9A888ff5Fb8B2a1cb71;
...
contract SincereJeet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe6F363396875363c0111f9A888ff5Fb8B2a1cb71;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Sincere Jeet";
    string private _symbol = "sJeet";
