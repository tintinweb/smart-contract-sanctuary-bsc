...
contract HypeGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hype Gold";
    string private _symbol = "HYPEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7016509e6b936987e4cBdfD70606B18BcBcF469F);
    address payable public BuyBackWalletAddress = payable(0x7016509e6b936987e4cBdfD70606B18BcBcF469F);
