...
contract mechazillastartship is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mechazilla Starship"; // 
    string private constant _symbol = "MZS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x7d3a1E0fD65aeaC9C2e6A26212c0832BC155166a;
