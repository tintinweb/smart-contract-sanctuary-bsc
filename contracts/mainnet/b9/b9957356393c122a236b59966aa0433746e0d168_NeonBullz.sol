...
contract NeonBullz is IBEP20, Auth {
    ...
    string constant _name = "NeonBullz";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "NBZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1faCB108187B0AB8C4415FAf0ecde637ADC3e0AE;
        marketingFeeReceiver = 0xd220DA50aE68e036A006623af03a16bd9F36C4Ee;
