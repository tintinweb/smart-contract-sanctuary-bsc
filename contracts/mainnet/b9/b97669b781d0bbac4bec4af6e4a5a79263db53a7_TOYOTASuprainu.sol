...
// Telegram : https://t.me/TOYOTASuprainu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6f00F8EA23bCA6F02b1eEBa582624665d690159; // owner address
...
contract TOYOTASuprainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TOYOTA Supra inu";
    string private _symbol = "SUPRA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xe6f00F8EA23bCA6F02b1eEBa582624665d690159); // Marketing Address
    address payable public teamWalletAddress = payable(0xe6f00F8EA23bCA6F02b1eEBa582624665d690159); // Team Address
