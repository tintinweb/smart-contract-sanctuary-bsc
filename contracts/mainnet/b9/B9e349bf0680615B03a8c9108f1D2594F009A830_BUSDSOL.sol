...
contract BUSDSOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUSD Solana";
    string private _symbol = "BSOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcE540cF37AC6C95B20E79cfdCcb09C21ba176cBb);
    address payable public teamWalletAddress = payable(0xc09072629eA2D3d2563c24e70a4274779dE13ffE);
