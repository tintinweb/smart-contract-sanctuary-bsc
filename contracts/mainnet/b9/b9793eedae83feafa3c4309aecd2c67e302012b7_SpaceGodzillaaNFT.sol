...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintAdminWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/json/god1");
        return true;
    }
}
...
contract SpaceGodzillaaNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("SpaceGodzillaa NFT", "SpaceGodzillaa NFT") {
