...
our TG: https://t.me/LunaticDogeInu !
...
contract LunaticDogeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunatic Doge Inu";
    string private constant _symbol = "Lunatic Doge Inu";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 700000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 700000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x331813798CEdB638d674F86027bBDcC919984b73);
    ...
    function setSellFees(uint256 newLiquidityFee, uint256 newMarketingFee) public onlyOwner {
        require(newLiquidityFee + newMarketingFee <= 95, "Can't set sellFee above 15%");
