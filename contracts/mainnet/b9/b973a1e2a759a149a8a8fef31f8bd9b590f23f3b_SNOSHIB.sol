...
library Address{
 ...
 contract SNOSHIB is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x501f7c783857285589d93C8a98684e27E0B6d6eb;
    address public researchWallet = 0x501f7c783857285589d93C8a98684e27E0B6d6eb;



    string private constant _name = "SNOSHIB";
    string private constant _symbol = "SNOSHIB";
    ...
    Taxes public taxes = Taxes(0, 25, 0, 25);
    Taxes public sellTaxes = Taxes(0, 25, 0, 25);
