...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract HolyCronosBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Holy Cronos ";
    string private _symbol = " HOLYC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2D65D154D9926D5e252b7284890F0C0A6D389776);
    address payable public teamWalletAddress = payable(0xEf67335af998995225bD334a30b799C4eeCdd786);
    ...
    uint256 private _totalSupply = 1 * 10000000 * 10**_decimals;
