...
contract BABYSNM is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "BABYSNMCOIN";
    ...
    address payable public marketingWallet =  payable(0x9EA6fD84f9936aC3705f0E0B00B6897AD8C5D53b); //Define Marketing Wallet
	address payable public CharityWallet =  payable(0xeA1614b759dbb3E2A79E33374C980F84F4962D7d); //Define Charity Wallet
