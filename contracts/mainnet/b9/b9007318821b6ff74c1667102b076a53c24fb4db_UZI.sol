...
contract UZI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Uzi Inu";
    string private _symbol = "UZI";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address OBD
    address payable public BuyBackWallet = payable(0x3E2aE13D28f74970E2e2365B626e201f02798941); // Team Address
