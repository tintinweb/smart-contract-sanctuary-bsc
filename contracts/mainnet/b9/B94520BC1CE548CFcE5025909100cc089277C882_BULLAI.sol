...
contract BULLAI is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'BULL AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'BULL AI: incorrect fee percent');
        require(owner != address(0), 'BULL AI: incorrect owner address');
        require(mintToAddr != address(0), 'BULL AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'BULL AI: transfer from the zero address');
        require(recipient != address(0), 'BULL AI: transfer to the zero address');
