...
contract MRDOGE is IERC20, Auth {
    ...
    uint256 public _maxTokenPerWallet = ( _totalSupply * 50 ) / 100;
    ...
    address payable public marketingWallet = payable(0xE851345E98E17EF6f3Ed18346111463DCDda0062);
    ...
    //max buy of 50%
    uint256 private maxBuyTransaction = ( _totalSupply * 500 ) / 1000;
