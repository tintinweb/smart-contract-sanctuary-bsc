...
contract ShibDogCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ShibDogCoin";
    string private _symbol = "SDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53AD34257dE549f736AB08aFE08b9F0DF8a1AA17);
    address payable public teamWalletAddress = payable(0x53AD34257dE549f736AB08aFE08b9F0DF8a1AA17);
