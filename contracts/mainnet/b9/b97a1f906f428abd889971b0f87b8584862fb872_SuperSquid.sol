...
contract SuperSquid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SuperSquid", "SuperSquid") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SuperSquid";
    string private _symbol = "SuperSquid";
