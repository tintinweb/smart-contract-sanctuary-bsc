...
contract ALPHACZ is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 3500000 * (10**9);
    uint256 public swapTokensAtAmount = 1000000 * (10**9);
    uint256 public maxWalletToken = 3500000 * (10**9);
    ...
    address payable public MarketingWallet = payable(0x35d33ADEF9525fbAf74d0e5B0F64f53d012DC926);
    address payable private devWallet = payable(0x69755498a7bE8485d81EB8ad57C120789E11A5E7);
    ...
    constructor() ERC20("ALPHA CZ", "CZA") {
