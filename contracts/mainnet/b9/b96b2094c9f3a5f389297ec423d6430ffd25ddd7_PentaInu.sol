...
contract PentaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PentaInu";
    string constant _symbol = "PNT";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**14 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9c10573cA75a04Ae70AaFb7F21aD1903CB3D9278;
        teamFeeReceiver = 0x9c10573cA75a04Ae70AaFb7F21aD1903CB3D9278;
        devFeeReceiver = 0x9c10573cA75a04Ae70AaFb7F21aD1903CB3D9278;
