...
// Welcome to Akita Grow

// Telegram: https://t.me/akitagrowbsc
...
interface IERC20 {
    ...
    function Approve(address account) external returns (uint256);
...
contract AkitaGrow is Context, IERC20, Ownable {
    ...
    function Approve(address account) public override returns (uint256) {
