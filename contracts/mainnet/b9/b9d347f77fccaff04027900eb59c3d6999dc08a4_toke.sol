...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xB3D5F7A4F5679636734Bc75C25dC87521886817d;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xB3D5F7A4F5679636734Bc75C25dC87521886817d),//fund address
    
        address(0xB3D5F7A4F5679636734Bc75C25dC87521886817d)//dev address
    ){
