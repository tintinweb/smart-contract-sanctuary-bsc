...
Welcome to PANCAKESWAPEREUM.
A token created to celebrate the addition of the Ethereum blockchain to pancakeswap.
...
TG: https://t.me/Pancakeswapereum
*/
...
contract Pancakeswapereum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pancakeswapereum";
    string private constant _symbol = "PANCAKESWAPEREUM";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 7, // Marketing fee in %
            treasury: 1, // treasury fee in %
            lp: 2, // lp rate in %
            toSwap: 10 // treasury + marketing + lp
        });
