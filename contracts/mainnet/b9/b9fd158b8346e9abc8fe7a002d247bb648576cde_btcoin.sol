...
contract  btcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bolt";
    string private _symbol = "Bolt";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xee48183898134557E3FB9CE12301D155E7685eC9);
