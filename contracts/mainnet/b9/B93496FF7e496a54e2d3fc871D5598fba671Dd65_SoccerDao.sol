...
/**
Telegram : https://t.me/SoccerDaoBSC
Website  : http://soccerdaobsc.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x950F16089fE9f65ef53188622100FB28eb12C792; // owner address
...
contract SoccerDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SoccerDao";
    string private _symbol = "sDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf98964E0a531d1263a36C0ABE970a308d1c6710C); // Marketing Address
    address payable public teamWalletAddress = payable(0xf98964E0a531d1263a36C0ABE970a308d1c6710C); // Team Address
