...
contract WEDIVEN is Context, IERC20 {
    ...
    string private _name = "Wednesday Heaven";
    string private _symbol = "WEDIVEN";
    ...
    constructor (address _abb)  {
        ...
        Wallet_Marketing = payable(0x50C0b254DE8F997d8eAfabD3412abf4F15196A9c);
        abb = BHT(_abb);
