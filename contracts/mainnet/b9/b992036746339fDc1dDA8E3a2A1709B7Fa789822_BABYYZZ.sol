...
contract Ownable is Context {
    address private _owner = 0xd9a534db05593701794269abaAbc77e4A4149dd1;
...
contract BABYYZZ is Context, IBEP20, Ownable { 
    ...
    address payable private _marketingAddress = payable(0xe073E9B5A6058384877B71b9B5999F3d5BCf1415); // Marketing Address
    ...
    uint256 private _tTotal = 5 * 10**5 * 10**_decimals;
    uint256 private previousBuyBackTime = block.timestamp; 
    uint256 private durationBetweenEachBuyback = 7 days; 
    uint256 private _tokenFee = 0; 
    uint256 private _previousTokenFee = _tokenFee; 
    uint256 private _buyBackFee = 0; 
    uint256 private _previousBuyBackFee = _buyBackFee; 
    uint256 private _marketingBNBFee =50; 
    ...
    uint256 private _minTokensSwapToAndTransferTo = 2 * 10**3 * 10**_decimals; 
    uint256 private _maxTokensPerAddress          = _tTotal; 
    ...
    function excludedFromAntiWhale(address account) private onlyOwner {
        _isExcludedFromAntiWhale[account] = true;
    }

    function includeInAntiWhale(address account) private onlyOwner {
