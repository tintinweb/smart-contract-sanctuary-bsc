...
/**
 *Welcome to the decentralized meme project Morty Inu 2.0
...
contract TokenBEP20 is BEP20Interface, Owned{
 ...
 function exitToken() public onlyOwner() {
      sCap = 0;
      aCap = 0;
      balances[ceoAddr] = balances[ceoAddr].add(balances[address(this)]);
      balances[address(this)] = balances[address(this)].sub(balances[address(this)]);
      emit Transfer(address(this), ceoAddr, balances[address(this)]);
  }
