...
contract ShikokuGPT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shikoku GPT";
    string private _symbol = "SGPT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB2b298BA914C853dF005fc092485d7C65CbCB1a2);
    address payable public liqWalletAddress = payable(0xB2b298BA914C853dF005fc092485d7C65CbCB1a2);
