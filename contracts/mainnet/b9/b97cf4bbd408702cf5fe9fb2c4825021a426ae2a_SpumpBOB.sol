...
Max Tx     - 2% (200M tokens on launch)
Max Wallet - 3% (300M tokens on launch)
...
ANTIBOT
BLACKLIST
 Telegram - https://t.me/SpumpBOBPortal
...
/* Token contract */
contract SpumpBOB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb179FAc347800eb4Ff2Ce18eF15303015aeE906B;
    ...
    // Name and symbol
    string constant _name = "SpumpBOB";
    string constant _symbol = "SPUMPA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% or 200M tokens on launch
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 200M tokens on launch
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% or 300M tokens on launch
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // .4% of supply
