...
/**
   Telegram : https://t.me/petreleumchain
*/
...
contract Petreleum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Petreleumchain";
    string private _symbol = "Petreleum";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d9318141BA7B81EB8E5C17cb620fea460A0D5CF); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2d9318141BA7B81EB8E5C17cb620fea460A0D5CF); // BuyBack Address
