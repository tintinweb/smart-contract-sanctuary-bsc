...
interface ISMBSwapV2Factory {
    function getPair(IERC20 tokenA, IERC20 tokenB) external view returns (ISMBSwapV2Exchange pair);
}
...
library SMBSwapV2ExchangeLib {
    using Math for uint256;
    using UniERC20 for IERC20;

    function getReturn(
        ISMBSwapV2Exchange exchange,
        IERC20 srcToken,
        IERC20 dstToken,
        uint256 amountIn
    )
...
contract SMBSwapSmartRouter is Ownable, ReentrancyGuard {
    using UniERC20 for IERC20;
    using SafeERC20 for IERC20;
    using SMBSwapV2ExchangeLib for ISMBSwapV2Exchange;
    ...
    address public immutable SMBSwapV2;
     ...
     * @param _SMBFactory: address of the SMBFactory
     * @param _stableswapFactory: address of the SMBStableSwapFactory
     */
    constructor(
    ...
    function _swapOnV2ExactIn(
        ...
        ISMBSwapV2Exchange exchange = ISMBSwapV2Factory(SMBSwapV2).getPair(srcTokenReal, dstTokenReal);
