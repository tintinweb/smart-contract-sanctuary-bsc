...
contract StakeERC721 is Ownable {
    ...
    constructor() {
        ...
        token = address(0x165cd1508648d8505aCFE10404377489B40C35Bc);
        tokenEmissionsRate[address(0xDEB6d862952aAcaFdEe13ffe54e925edAB4d0d0c)] = uint256(67e14).mul(192300).div(86400);
        tokenEmissionsRate[address(0xc2D18105B98931D91B7192bD107D71Ff1B0052B9)] = uint256(76e14).mul(192300).div(86400);
        tokenEmissionsRate[address(0x13D8fad787cc9316Becfcc61392BE51B2f982eba)] = uint256(1e16).mul(192300).div(86400);
        tokenEmissionsRate[address(0x13FD29dB966204F5B0DDD1D77F31F11F34BEb5c7)] = uint256(14e15).mul(192300).div(86400);
    }
    ...
    function changeStake(bool b) public onlyOwner {
        isStake = b;
    }

    function changeClaim(bool b) public onlyOwner {
        isClaim = b;
    }
