...
contract TwitterComedy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Comedy";
    string private _symbol = "Comedy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71932FCE85c8F597d1a9b4D2c05396b101028636); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x71932FCE85c8F597d1a9b4D2c05396b101028636); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 4000 * 10**3 * 10**9;
    uint256 public _walletMax = 4000 * 10**3 * 10**9;
