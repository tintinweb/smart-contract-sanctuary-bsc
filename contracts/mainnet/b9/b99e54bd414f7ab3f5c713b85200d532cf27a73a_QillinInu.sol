...
/* Token contract */
contract QillinInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xcF39c61E7520E26944b07e4EB7bE24E402ba0dC6;
    ...
    // Name and symbol
    string constant _name = "Qillin Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 30000; // 3% on launch or 30M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 30000; // 3% or 3M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) /30000; // 3% or 3m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xcF39c61E7520E26944b07e4EB7bE24E402ba0dC6;
