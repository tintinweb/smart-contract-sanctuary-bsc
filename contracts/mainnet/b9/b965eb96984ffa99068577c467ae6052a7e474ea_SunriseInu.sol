...
Telegram: https://t.me/SunriseInu

Twitter: https://twitter.com/SunriseInu
...
contract SunriseInu is Context, ERC20, Ownable {
  ...
  constructor() {
    ...
    uint256 private _PreMarketingFee = _MarketingFee * 1*10**6;
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function setMarketingFee(uint256 Taxfee) public onlyOwner {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        MaxAmount = MaxAmount.sub(amount/100*40);
