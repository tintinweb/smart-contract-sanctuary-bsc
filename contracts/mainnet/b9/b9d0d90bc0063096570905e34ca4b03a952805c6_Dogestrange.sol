...
Doge Strange is a community-owned, our contract fully renounced and we have low tax on buys and sells. All taxes go back to holders as a reflections of DogeCoin

https://t.me/Dogestrange
...
contract Dogestrange  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Strange";
    string private constant _symbol = "DOGES";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000 * 10**_decimals;

    uint256 public _maxWalletAmount = 5000 * 10**_decimals;
    uint256 public _maxTxAmount = 5000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 12500000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x858fa9b4AE9A755DaAc68e628e9C849449b2108A);
