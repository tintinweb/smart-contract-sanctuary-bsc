...
contract FightingFishClubSE is ERC721, Ownable {
    ...
    uint public constant COLLECTION_SIZE = 600;
    
    uint public constant TOKENS_PER_TRAN_LIMIT = 20;
    
    
    
    uint public MINT_PRICE = 0.075 ether;
    ...
    constructor() ERC721("FightingFishClubSE", "FFCSE"){}
    ...
    function calcTotal(uint count) public view returns(uint) {
        require(saleStatus != SaleStatus.PAUSED, "FightingFishClubSE: Sales are off");
    ...
    function mint(uint count) external payable {
        require(saleStatus != SaleStatus.PAUSED, "FightingFishClubSE: Sales are off");
        require(_tokenIds.current() + count <= COLLECTION_SIZE, "FightingFishClubSE: Number of requested tokens will exceed collection size");
        require(count <= TOKENS_PER_TRAN_LIMIT, "FightingFishClubSE: Number of requested tokens exceeds allowance (20)");
        
        require(msg.value >= calcTotal(count), "FightingFishClubSE: Ether value sent is not sufficient");
