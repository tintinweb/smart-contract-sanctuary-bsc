...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45e3E786083f4906C73B6DF0b699477d276A988b;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x45e3E786083f4906C73B6DF0b699477d276A988b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "F16";
    string private _symbol = "F16";
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1000000000000000000000000000 * 10**18;
