...
/* Deine Token name */
contract CINDINC is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private _tTotal = 100000000  * 10**9; /*Schriben sie Heir Total Supply zum beispiel ein million "1000000"*/
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _launchTime;  
    bool public _tradingOpen = false;

    string private _name = "CINDINC"; /* Name das token */
    string private _symbol = "CDC"; /* Symbol zum beispiel "BTC" */
    ...
    uint256 public _maxTxAmount = 100000000 * 10**9; /* Total Supply Weider*/
    uint256 private minTokenNumberToSell =  1000000 * 10**9; // this tx amount will trigger swap and add liquidity
    ...
    uint256 public _taxFee = 0; // 2% werden unter den Inhabern neu verteilt

    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 0; // 6% Automatische Liquiditätsgenerierung
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    
    uint256 public _marketFee = 0;  // 0% Marketinggebühren  
    uint256 private _previousMarketFee = _marketFee;
    
    uint256 public _devFee = 0;  // 2% Belohnungen für Inhaber
