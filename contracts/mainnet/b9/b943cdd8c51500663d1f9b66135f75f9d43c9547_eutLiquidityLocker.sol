...
// Forked from Ethereum mainnet for Pancakeswap on Binance Smart Chain

// This contract locks Pancakeswap v2 liquidity tokens. Used to give investors peace of mind a token team has locked liquidity
// and that the univ2 tokens cannot be removed from Pancakeswap until the specified unlock date has been reached.
