...
//  Teslaa Mining One of The Best Miner
...
contract TeslaMining {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;
    
    IERC20 public token = IERC20(0xA5370A84855EEC0Ed728A758D2A276884007cFBa);

	uint256 constant public INVEST_MIN_AMOUNT = 1000000 ether; // 
    ...
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 10000000000000 ether; // 
	...
	constructor(address payable wallet ) public {
       ...
       plans.push(Plan(180, 30)); // 180 days 3% daily // 
        plans.push(Plan(90, 50)); // 90 days 5% daily // 
        plans.push(Plan(60, 60)); // 60 days 6% daily // 
        plans.push(Plan(30, 40)); // 30 days 4% daily // 
	}
