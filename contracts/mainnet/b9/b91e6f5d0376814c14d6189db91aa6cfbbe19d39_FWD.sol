 ...
 * 
 */
contract FWD is IERC20 {
    
    using SafeMath for uint256;
    
    //FWD token, creator will take 0.6% fee
    address public feeTo = 0x14bCa363445462082101164Eff599F83fbBEbab1;

    string public name = "firewalld";
    string public symbol = "FWD";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 100000000;
    
    //FWD Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 FWD
