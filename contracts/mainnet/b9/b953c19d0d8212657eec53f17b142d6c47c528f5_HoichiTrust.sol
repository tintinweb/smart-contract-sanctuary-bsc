...
contract HoichiTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HoichiTrust";
    string private _symbol = unicode"芳 Trust";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x598184424b4d85c6c5e1Be2Cff645e30C429cAe2); // Marketing Address
