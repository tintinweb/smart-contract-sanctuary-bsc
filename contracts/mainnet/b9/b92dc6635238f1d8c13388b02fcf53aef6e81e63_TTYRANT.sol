...
contract TTYRANT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TTYRANT";
    string private _symbol = "TTRYANT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64019d18B10F7d85CC91BC06680f4F6505503f43); // Marketing Address
    address payable public teamWalletAddress = payable(0x64019d18B10F7d85CC91BC06680f4F6505503f43); // Team Address
