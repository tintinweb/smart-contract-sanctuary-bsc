...
contract TAHW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "tahW unI";
    string private _symbol = "TAHW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 1;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x0F242112d22610C7d5d2782a4Ed53278E9e8a623); // Marketing Address
    address payable public teamWalletAddress = payable(0x0F242112d22610C7d5d2782a4Ed53278E9e8a623); // Team Address
