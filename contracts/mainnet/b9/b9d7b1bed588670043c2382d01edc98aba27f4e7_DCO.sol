...
/** 
 *  SourceUnit: d:\dev\projects\dco\dco-contract\contracts\Dco malai.sol
*/
...
contract DCO is ERC20, ERC20Burnable, OwnableContract {
    ...
    constructor(
        ...
        marketingFee = 3;
        superAdminAddress = _superAdminAddress; // testing purpose wallet address, may set actual wallet address to override
        ratio = [50, 50]; // example split half to `splitAddresses` -> ratio = [50,50]
        splitAddresses = _splitAddresses; // testing purpose wallet address, may set actual wallet address to override
