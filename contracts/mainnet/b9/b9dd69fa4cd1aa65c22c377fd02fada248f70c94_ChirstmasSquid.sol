...
library Address{
 ...
 contract ChirstmasSquid is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x738CABc34be9FbA13a8D4CeF57f969797d972F2D;
    address public donationWallet = 0x738CABc34be9FbA13a8D4CeF57f969797d972F2D;

    string private constant _name = "Christmas Squid";
    string private constant _symbol = "XMASQUID";
    ...
    Taxes public taxes = Taxes(0, 5, 0, 5);
    Taxes public sellTaxes = Taxes(0, 5, 0, 5);
