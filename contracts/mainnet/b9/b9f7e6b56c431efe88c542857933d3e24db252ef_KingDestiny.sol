...
contract KingDestiny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KingDestiny";
    string private _symbol = "KDY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC68f18aFe1A4153df14807d2074bdfBb525b4E40); 
    address payable public buyBackWalletAddress = payable(0x24570f2564EAE64125127f8DbF34D749b7C6e8F1); 
    ...
    uint256 private minimumTokensBeforeSwap = 3000000 * 10**9; 
