...
*/
/*
Telegram: t.me/marshallroganinuofficialchat
...
contract MarshallRoganInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MarshallRoganInu";
    string private _symbol = "$MRI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32fAc581837cf08c177d68aB3e306E96f7C91676); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x32fAc581837cf08c177d68aB3e306E96f7C91676); // BuyBack Address
