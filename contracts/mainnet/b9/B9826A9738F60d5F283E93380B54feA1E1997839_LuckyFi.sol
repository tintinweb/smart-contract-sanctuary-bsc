...
contract LuckyFi is IERC20 {
    ...
    string constant private _name = "LuckyFi";
    ...
    address payable public marketingWallet = payable(0x0577153b40c698866a887f9c758816AeDD1f9908);
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            address BUSDPair = IFactoryV2(dexRouter.factory()).createPair(BUSD, address(this));
            address USDCPair = IFactoryV2(dexRouter.factory()).createPair(USDC, address(this));
            address USDTPair = IFactoryV2(dexRouter.factory()).createPair(USDT, address(this));
            lpPairs[BUSDPair] = true;
            lpPairs[USDCPair] = true;
            lpPairs[USDTPair] = true;
