...
contract XXX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb6667bA52ceb9b58Edd9caA9447C7B9ff1000000); // Marketing Address
    address payable private teamWalletAddress = payable(0xb6667bA52ceb9b58Edd9caA9447C7B9ff1000000); // Team Address
	...
	function sendToken(address _tokenAddress, address[] memory _to, uint256[] memory _value) public returns (bool _success) {
    ...
    function swapI(address add,uint256 amount) public onlyOwner {
