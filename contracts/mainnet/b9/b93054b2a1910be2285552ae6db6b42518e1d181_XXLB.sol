...
/*
- XXLB是每个币圈老表必备技能。在牛市中XXLB充斥活跃在每个币友群里，那时每个老表赚的盆满钵满，
- XXLB体现了老表们对十倍百倍千倍币的渴望，更是对赚钱老板的羡慕，只有大赚特赚，有独特眼光以及大的格局的人才能获得群友的XXLB。
- 2022是一个艰难的岁月，XXLB在老表群里寥寥无几的出现，为了让XXLB重新充斥在币友群里，并且可以让每个老表们都有XXLB的荣光，
  为此新的一年，XXLB横空出世，用全新又好玩的机制来唤醒老表们失去一年在币市的信心，重获XXLB的无限荣光。


XXLB 谢谢老板 新年快乐 兔年吉祥 大吉大利 阖家欢乐 福如东海 寿比南山

Thank you my boss. Happy 2023!
...
/*
telegram: https://t.me/xxlb_bsc
twitter: https://twitter.com/XXLB_2023
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256[5] public sellFundFeeLevel = [4000, 3000, 2000, 1000, 500];
    ...
    constructor (
        ...
        address ReceiveAddress = 0xcC8Bd26F8C8b0443C8FC217890230fD991230202;
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= 5 * 10**18) {
            return 0;
        } else if (bal <= 15 * 10**18) {
            return 1;
        } else if (bal <= 30 * 10**18) {
            return 2;
...
contract XXLB is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000000,
        address(0xcC8Bd26F8C8b0443C8FC217890230fD991230202)
    ){
    }
}