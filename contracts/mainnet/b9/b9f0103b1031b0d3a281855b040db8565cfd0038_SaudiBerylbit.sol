...
contract SaudiBerylbit is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Berylbit";
    string private _symbol = "SBRB";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xAf2e2575744d20C2850aBb18ee4dF5Dd757c2d2B);
