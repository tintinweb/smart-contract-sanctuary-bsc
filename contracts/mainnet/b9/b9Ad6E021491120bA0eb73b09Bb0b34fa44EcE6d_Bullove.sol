...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9FF81af8818C63656678d0Cb331d696587EE8dE8; // owner address
...
contract Bullove is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BULLOVE";
    string private _symbol = "BULLOVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9FF81af8818C63656678d0Cb331d696587EE8dE8); // Marketing Address
    address payable public teamWalletAddress = payable(0x9FF81af8818C63656678d0Cb331d696587EE8dE8); // Team Address
