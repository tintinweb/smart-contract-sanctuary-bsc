...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d130CcA9f3526C2019bdE1f51153BCc97d5FE28; // owner address
...
contract MetabitNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"MetabitNetwork";
    string private _symbol = unicode"MBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d130CcA9f3526C2019bdE1f51153BCc97d5FE28); // Marketing Address
    address payable public teamWalletAddress = payable(0x2d130CcA9f3526C2019bdE1f51153BCc97d5FE28); // Team Address
