...
contract SHIB is ERC20, Ownable {
    ...
    address public marketingWallet = 0x597e55b9a85c27554196Dbba4E6b7df7faCE1327;
    address public devWallet = 0x597e55b9a85c27554196Dbba4E6b7df7faCE1327;
    address public utilityWallet = 0x597e55b9a85c27554196Dbba4E6b7df7faCE1327;
    address public charityWallet = 0x597e55b9a85c27554196Dbba4E6b7df7faCE1327;
    ...
    constructor(address routerAdd) ERC20("SHIBA INU", "SHIB") {
        ...
        exemptFee[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; // add addresses here devWallet+utilityWallet etc.
        exemptFee[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; //
        exemptFee[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; //
        ...
        allowedTransfer[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; // add addresses here devWallet+utilityWallet etc.
        allowedTransfer[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; // add addresses here devWallet+utilityWallet etc.
        allowedTransfer[0x597e55b9a85c27554196Dbba4E6b7df7faCE1327] = true; // add addresses here devWallet+utilityWallet etc.
    ...
    function updateLiquidityProvider(bool state) external onlyOwner {
