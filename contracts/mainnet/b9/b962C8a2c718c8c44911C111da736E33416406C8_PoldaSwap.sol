...
contract PoldaSwap is IBEP20, Auth {
    ...
    string constant _name = "PoldaSwap";
    string constant _symbol = "POLDA";
    ...
    uint256 buyTransitionFee = 100;

    uint256 sellInviterFee = 0;
    uint256 sellReflectionFee = 700;
    uint256 sellMarketFee = 300;
    uint256 sellTransitionFee = 200;

    uint256 feeUnit = 500;
    uint256 feeDenominator = 10000;

    address public marketFeeReceiver = 0x97e66c362CAD8777583bf23Afe796A163CAC44cD;
    address public transitionFeeReceiver = 0xF108FD03fB159aeB61A558A743f0DA2412C8359B;
