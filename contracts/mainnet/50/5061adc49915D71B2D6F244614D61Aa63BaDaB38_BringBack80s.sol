...
contract BringBack80s is IERC20, Ownable {
    ...
    string private _name = "Bring Back 80s";
    string private _symbol = "BB80";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require (maxTxAmount >= 500000000, "invalid max tx amount");
    ...
    function updateSellFee(uint256 _fee) external onlyOwner {
        require (_fee <= 7, "Sell fee must be under 7%");
        _sellFee = _fee;
