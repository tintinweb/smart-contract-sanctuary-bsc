...
/**
 Welcome to TSE Coin.
 'TSE = The Social Experiment'.
 No Details. No Website. No doxxed team. No team holdings. 

 Telegram - t.me/TSE_Coin

 Contract will be renounced. 
 This is for the community. How far can the public take TSE? We will kickstart the marketing, before handing the project over to the community. 
 With the global economy getting rekt, and politicians/economists/leaders destroying every country, it's time to show what the people can do. 
 The Great Social Experiment of 2022. Will you be a part of the revolution? Or will you sit on the sidelines.

 The tokenomics ensure sustainability and allow the project to continue. 
 2% Of every sell is burnt. 
 5% is added to the liquidity pool, to continue the price increase.
 5% of every sell is sent to the marketing fund. 
...
contract TSE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1aC4c4AE4F508805fb8066550a5919907bcfa229); 
    address payable public Wallet_Dev = payable(0x1aC4c4AE4F508805fb8066550a5919907bcfa229);
    ...
    string private constant _name = "TSE"; 
    ...
    constructor () {
        ...
        _owner = 0xdbf1954694963727d76B8240ab9b505E5A4784d7;
