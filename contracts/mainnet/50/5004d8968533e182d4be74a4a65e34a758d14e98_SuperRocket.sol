...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 100 * 10 ** Decimals;
        maxWalletAmount = 100 * 10 ** Decimals;
        thA = msg.sender;
        _tTotal = total;
...
contract SuperRocket is AbsToken {
    constructor() AbsToken(
        ...
        address(0x732AAad1be230F551520D06024F49f76BBf91D2c),
        address(0x2C60925c130bAeF23Dab4DCAe7B601496247deeD),
    
        address(0x00B96bd98FcEd4f727FFf38Bff8cD521bf48c9eb)
    ){
