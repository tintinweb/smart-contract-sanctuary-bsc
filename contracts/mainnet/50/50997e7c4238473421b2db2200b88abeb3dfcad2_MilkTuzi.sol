...
/**
/*  
在Pancake Fair推出！有 1M 的供应和 2/2 的营销税和流动性税被烧毁。
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD407BADa7fcb66Ad84F72296a222b1d57c2E78AC; 
...
contract MilkTuzi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Milk Tuzi";
    string private _symbol = "MTZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD407BADa7fcb66Ad84F72296a222b1d57c2E78AC); // 
    address payable public teamWalletAddress = payable(0xD407BADa7fcb66Ad84F72296a222b1d57c2E78AC); // 
