...
contract OceanPool is IOceanPool, Context, Ownable  {
    ...
    function claimOCash(address account, uint256 amount) external override {
        ...
        require(amount <= ocashToken.balanceOf(account), "Amount is exceeded");
...
interface IOceanPool {  

  function claimOCash(address account, uint256 amount) external; // TODO: changed
}
