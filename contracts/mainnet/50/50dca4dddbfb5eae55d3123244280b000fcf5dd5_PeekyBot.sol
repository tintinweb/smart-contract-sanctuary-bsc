...
// telegram : https://t.me/peekybotportal
...
contract PeekyBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEEKY BOT";
    string private _symbol = "Peeky Bot";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9899C007A05C387bC154223A31f469e60b4aBD98); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9899C007A05C387bC154223A31f469e60b4aBD98); // buyback Address
