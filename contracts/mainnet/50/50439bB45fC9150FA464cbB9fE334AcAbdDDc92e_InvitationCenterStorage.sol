...
contract InvitationCenterStorage is Proxy, InvitationCenterLayout, OwnableStorage, CrownNameServiceRefStorage {
    ...
    CrownNameServiceRefStorage(nameService_){
        _inviterRecursiveLoop = 3;
