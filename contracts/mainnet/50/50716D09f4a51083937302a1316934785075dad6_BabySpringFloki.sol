...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xD0e5e51A4456399f11296534f72882B1D8af8B0d); // WBNB
...
contract BabySpringFloki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Spring Floki";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xD0e5e51A4456399f11296534f72882B1D8af8B0d; // 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB030d0f9e58145fF0d5485D4e881787F2c8b6E9c;
        buybackWallet = 0xB030d0f9e58145fF0d5485D4e881787F2c8b6E9c;
