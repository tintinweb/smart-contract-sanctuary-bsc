...
// SPDX-License-Identifier: Unlicensed
    // VV Finance Start From Here
  // Dual Elements - VV Powered - Dual Liquidity
// Let's Get Onboard °°°°°°°°°°°°°°°°°°°°°
...
contract VV is Context, IERC20, Ownable, ReentrancyGuard {
...
// Cold Cranking - Hot Start - Hold On Tight
    ...
    uint256 private numTokensSellToAddToLiquidity =_tTotal / 4000;
    ...
    function _transfer(
        ...
        uint256 toDev = contractTokenBalance.div(2);
        uint256 toLiquidity = contractTokenBalance.sub(toDev);
         swapAndSendFee(toDev);
    ...
    function swapAndSendFee(uint256 amount) private lockTheSwap {
        ...
        payable(dev_future).transfer(newBalance);
    }
