...
// telegram : https://t.me/botanti_scam
...
contract BOTANTISCAM is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x0855c5eD56367b2e36c272B78f5fb95Dbec9Af16); 
    address payable private Wallet_Dev = payable(0x0855c5eD56367b2e36c272B78f5fb95Dbec9Af16);
    ...
    string private constant _name = "BOT ANTI SCAM"; 
    ...
    uint256 public _Tax_On_Sell = 10;
     function _set_Taxes(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

       _Tax_On_Sell = Sell_Fee;
       _Tax_On_Buy = Buy_Fee;
    }

    uint256 private Percent_Marketing = 99;
    ...
    constructor () {
        ...
        _owner = 0x0855c5eD56367b2e36c272B78f5fb95Dbec9Af16;
    ...
    function Tradingview_start(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function Blacklist(address addresses) external onlyOwner {
    ...
    function OnlyWL(address addresses) external onlyOwner {
    ...
    function WL_rmve(address addresses) external onlyOwner {
    ...
    function set_limitB(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_limitW(uint256 maxWallPercent_x100) external onlyOwner() {
