...
contract VolcanoMigration{
    ...
    constructor() {
     ...
     _activeTokenAddress = 0x533961F073F06A82E45E47A769F135B661f4Ae41;
    }
    ...
    function recover() external lock onlyClaimers{
        uint256 amt = IERC20(_activeTokenAddress).balanceOf(address(this));
