...
/**
 *Scroll 是一个开发 zkEVM 的 zk-Rollups（ZKR），目标是构建一个与 EVM 兼容的 ZK-Rollups 并具有强大的证明网络。Scroll Alpha 测试网已经在 Goerli 上线，目前有超 18 万的独立钱包参与测试，已经完成了 66.5 万的交易。团队表示主网预计会在未来 3-4 个月上线。STL是Scroll 旗下新的开发技术，目前已有近两万名粉丝进行关注。
*/
...
contract Scroll is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x864c648aFd69721F6E22e2f46c9BB79ED4f25126);
    address payable private _marketingAddress = payable(0x864c648aFd69721F6E22e2f46c9BB79ED4f25126);
