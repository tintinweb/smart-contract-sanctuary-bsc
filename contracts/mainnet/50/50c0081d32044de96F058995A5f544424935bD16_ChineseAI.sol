...
contract ChineseAI is Context, IERC20, Ownable {
    ...
    string private _name = unicode"中国人工智能";
    string private _symbol = "ChineseAI";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x6Fa4676771562EDF6eC67D6cbb6bbf86Dbaf24ef); 
    address payable public teamWalletAddress = payable(0x6Fa4676771562EDF6eC67D6cbb6bbf86Dbaf24ef); 
