...
contract UND is ERC20 {
	...
	address private _fund1Address = address(0x4a76740eDFB5B12d5562eB4928fECF009C44dC00);
	address private _fund2Address = address(0xac20a14d3aF37Cd1a7B67cA1eA438476138a9d59);
    ...
    constructor(address tokenOwner) ERC20("UND", "UND") {
		...
		nftContract = UsdtWarp(0x50078C85c7eD6D8ede941Bd5D3936AA92db57Ba0);//nft;
    ...
    function splitOtherTokenNft() private {
        ...
        if(thisAmount > nftRemain && nftRemain >= 2 * 10**20){
