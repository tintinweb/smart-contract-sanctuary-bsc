...
library Address{
 ...
 contract Putin is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 1 seconds;
    ...
    uint256 private initialsupply = 1_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 10 * 10**3;
    uint256 public maxBuyLimit = 10 * 10**3;
    uint256 public maxSellLimit = 10 * 10**3;
    uint256 public maxWalletLimit = 20 * 10**3;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xCcA1dAD6A92392758bF8d70DaD15e19473d24D5b;
    address public donationWallet = 0xCcA1dAD6A92392758bF8d70DaD15e19473d24D5b;

    string private constant _name = "Putin";
    ...
    Taxes public taxes = Taxes(0, 8, 6, 0);
    Taxes public sellTaxes = Taxes(0, 8, 6, 0);
