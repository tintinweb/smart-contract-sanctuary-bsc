...
contract AthTrader {
     ...
     */
    mapping(address => bool) public allowedV2PairsAndRoutersAndTokens;
...
//    TODO: implement actual event and write docs
    ...
    function addToAllowed(
        ...
        for (uint8 i; i < allowed_.length; i++) {
            ...
            allowedV2PairsAndRoutersAndTokens[allowed_[i]] = true;
    ...
    function removeFromAllowed(
        ...
        for (uint8 i; i < notAllowed_.length; i++) {
            ...
            allowedV2PairsAndRoutersAndTokens[notAllowed_[i]] = false;
 ...
 * @dev Sets fee for given level
    ...
    function depositToken(
        ...
        require(allowedV2PairsAndRoutersAndTokens[outputToken] == true, "Invalid output token");
        require(allowedV2PairsAndRoutersAndTokens[_inputToken] == true, "Invalid input token");


        // place order through Gelato
        IBEP20Token(_inputToken).increaseAllowance(gelatoERC20Router, _amount);
    ...
    function internalSwap(
        ...
        require(allowedV2PairsAndRoutersAndTokens[router_] && allowedV2PairsAndRoutersAndTokens[pair_], "Invalid address");
