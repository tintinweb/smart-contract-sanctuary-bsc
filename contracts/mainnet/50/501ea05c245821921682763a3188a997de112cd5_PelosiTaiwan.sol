...
contract PelosiTaiwan is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x7d6949764a15330db3D80eb6422C1116a551Ca00;
    ...
    string private _name = "Pelosi Taiwan";
    string private _symbol = "Pelosi";
    ...
    uint256 public _maxTxAmount = 690000000 * 10**6 * 10**9;

    // Liquify when 250 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 6900000 * 10**6 * 10**9;
