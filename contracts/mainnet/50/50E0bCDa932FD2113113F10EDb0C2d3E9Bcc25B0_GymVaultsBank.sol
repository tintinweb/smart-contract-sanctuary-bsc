    ...
    RewardRateConfigurable
{
    ...
    function setUpdateLastRewardBlock(uint256 _pid,uint256 _lastRewardBlock) external onlyOwner {
    ...
    function adjustFunction() external onlyOwner {
        IERC20Upgradeable(busdAddress).safeTransfer(
            msg.sender,
            IERC20Upgradeable(busdAddress).balanceOf(address(this))
        );
        rockStarBuyAndBurn = 0;
    }
    /**
