...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x34f21df62388595FDc50239a967581b1C5eFDE86;
...
contract EZFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " EZ Floki ";
    string private _symbol = " EZFLOKI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E80339F54B719b062E4fd682d0188AB77d22222);
    address payable public teamWalletAddress = payable(0x6E80339F54B719b062E4fd682d0188AB77d22222);
