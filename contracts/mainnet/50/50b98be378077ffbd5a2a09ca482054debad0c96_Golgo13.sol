...
/**
Telegram: https://t.me/Golgo13Official
BUY TAX: 6% 
SELL TAX: 10%
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6ae618F7c47eC6A0D73ba7bB4e2E00080FF16B00;
...
contract Golgo13 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Golgo 13";
    string private _symbol = "GOLGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ae618F7c47eC6A0D73ba7bB4e2E00080FF16B00); // Marketing Address
    address payable public teamWalletAddress = payable(0x6ae618F7c47eC6A0D73ba7bB4e2E00080FF16B00); // Team Address
    ...
    uint256 public _maxTxAmount = 390000 * 10**_decimals; 
    uint256 public _walletMax = 780000 * 10**_decimals;
