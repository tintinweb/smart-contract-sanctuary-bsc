...
contract Gamertoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 11 * 10**6 * 10**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "GamerToken";
    ...
    address public charityWallet = 0xc3bA0395ff719513eb367f6639601bA8730d871b;
    ...
    uint256 public _maxTxAmount = 210 * 10**2 * 10**3;
    uint256 private numTokensSellToAddToLiquidity = 210 * 10**1 * 10**3;
    ...
    function setGTXCharityWallet(address newWallet) external onlyOwner() {
