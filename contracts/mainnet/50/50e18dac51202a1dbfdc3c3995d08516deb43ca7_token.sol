...
contract token is ERC20 {
    ...
    string internal tokenName = "PiNetwork";
    string internal tokenSymbol = "PiNetwork";
    uint256 constant total  =  1000000000 * 10**18;
    address public marketAddress = address(0x20c86A9A1AB1A05f59591fD9f5987cE3Dd49EC76);
    uint256 buyFee = 20;
    uint256 sellFee = 960;
