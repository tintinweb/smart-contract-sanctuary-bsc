...
// Welcome to Spooky Doge Gold!
// The haunting starts in October so join us for this spooky holiday season.
// Our vision is to create Halloween themed Tokens and a vibrant community to support!

// Tax : 8/8 (4% Doge Reward, 3% Marketing and 1% LP)
// Tele : https://t.me/SpookyDogeGold
// Web: https://spooky.dogegold.site/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWD = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
/* Token contract */
contract SpookyDogeGold is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5c454F019d08E3105f3f3593eE86947D5749768c;
    ...
    // Name and symbol
    string constant _name = "Spooky Doge Gold";
    string constant _symbol = "SDG";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1B 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xAc957afA82F21bBEbb5F7062d45c42CB9b4F831e;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).mul(65).div(50);
        uint256 amountBNBReflection = amountBNB.mul(reflectionFee).div(totalBNBFee).mul(65).div(100);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).mul(65).div(100);
        uint256 amountBNBDev = amountBNB.mul(totalFee).div(totalBNBFee).mul(35).div(100); 
