...
Tg:https://t.me/Albertinuofficial                                                                
...
contract AlbertInu is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'AlbertInu';   // Name
	string constant _symbol = 'Albinu';    // Symbol
	uint8 constant _decimals = 18;         // Decimals

    uint256 private constant _totalSupply = 100_000_000 * (10 ** _decimals); 
    uint256 public  constant _maxWalletLimit = 3_000_000 * (10 ** _decimals); 
    ...
    uint256 constant marketingFeeBuy  = 500;
    uint256 constant totalFeeBuy      = 800;

    // Sell Fees
    uint256 constant reflectionFeeSell = 0;
    uint256 constant liquidityFeeSell  = 300;
    uint256 constant marketingFeeSell  = 500;
    uint256 constant totalFeeSell      = 800;
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0x70A09eB01cEc1738586f8b28c7f2245C809D974F;
        marketingFeeReceiver = 0x70A09eB01cEc1738586f8b28c7f2245C809D974F;
