...
contract TritonFinancial is Context, IERC20, Ownable {
    ...
    string private _name = "TritonFinancial";     
    string private _symbol = "TRIFI";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 300 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x218Ee3bd94Fe65b7e79D63Abd61baDDE311aa1e7); // MARKETING WALLET
    address public marketingWalletToken = 0xd4c9d8D3c5759f2c0c0f86e8F445f087c3206816; // BNB ADDRESS
    ...
    constructor () {
        ...
        _liquifyThreshhold = 300 * 10**9 * 10**_decimals;
        _maxBalance = 6 * 10**9 * 10**_decimals;
