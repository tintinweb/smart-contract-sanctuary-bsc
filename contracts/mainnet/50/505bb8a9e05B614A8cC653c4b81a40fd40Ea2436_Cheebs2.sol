...
/**
   Welcome to Cheebs 2.0 token

   I make this #Cheebs2.0 to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/cheebstwo

   Great features:
   2% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders
   2% fee for the development

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #Cheebs2.0 to the community and ensure it's 100% safe.

   I will add 2 BNB and 99% of the total supply to the pool
   Can you make #Cheebs2.0 10000000X? 
...
library Address{
 ...
 contract Cheebs2 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 7_000_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0x1225B0C11e8049379f77A499595DbFE012ab9a54;
    address public donationWallet = 0x1225B0C11e8049379f77A499595DbFE012ab9a54;

    string private constant _name = "Cheebs2.0";
    string private constant _symbol = "Cheebs2.0";
