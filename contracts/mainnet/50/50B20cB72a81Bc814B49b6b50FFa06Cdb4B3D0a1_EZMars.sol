...
contract EZMars is Context, IERC20, Ownable {
    ...
    string private constant _name = "EZMars"; // 
    string private constant _symbol = unicode"$EZMars"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _CreatorWallet = 0xFf2b4fA59484b28CE68f1206667F3CDE28Cc7ce0;
