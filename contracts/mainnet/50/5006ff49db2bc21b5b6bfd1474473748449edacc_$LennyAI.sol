...
contract $LennyAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$LennyAI";
    string private _symbol = "$LennyAI";
    ...
    uint256 public _marketingShare = 56;
    ...
    uint256 private minimumTokensBeforeSwap = 500000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
