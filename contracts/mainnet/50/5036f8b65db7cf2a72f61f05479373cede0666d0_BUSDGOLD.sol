...
Welcome to BUSD GOLD. A community driven token that rewards holders with BUSD.

Features:

✅ $BUSD rewards passively for holders
✅ Continuous buyback and burn function
✅ Low LP for higher market cap capability

Come and join the community and show your support as we together send this to the moon

Telegram: https://t.me/Busdgoldofficial
...
contract BUSDGOLD is Context, IERC20, Ownable {
    ...
    string private _symbol = "BUSDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2dfB8Caf5099FBecdeb5E07f5e7C9a5beb1cE19D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xFD08E7c7e44C163B8435802C4971442aA5a9a738); // buyback Address
