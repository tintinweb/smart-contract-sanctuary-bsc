...
contract SmartPoolRenewable is Ownable, ReentrancyGuard {
    ...
    function setSubFeeAndTreasury(address _treasury, uint256 _subFee, uint256 _subLength) external onlyOwner {
...
contract SmartPoolFactory is Ownable {
    ...
    IBEP20 FG = IBEP20(0x4492cA0AFF6D603e18Aea5075B49A5ff76b9Ea06);
