...
contract BonfireNight is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonfire Night"; 
    string private _symbol = unicode"BONFIRE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcC0a686DAD48b3ea1AA380429Db3221e30C38f9e); // Marketing Address
    address payable public teamWalletAddress = payable(0xcC0a686DAD48b3ea1AA380429Db3221e30C38f9e); // Team Address
