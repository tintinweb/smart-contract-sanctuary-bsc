...
contract Dogecoinceo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogecoinceo";
    string private constant _symbol = "Dogecoinceo";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x588fC858F381A91a763d5e185d3b17ee6e6D3F6b);
    address payable private _marketingAddress = payable(0x588fC858F381A91a763d5e185d3b17ee6e6D3F6b);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 89, "Redis cannot be more than 89.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 4.");
	    require(taxFeeOnSell < 89, "Tax cannot be more than 89.");
