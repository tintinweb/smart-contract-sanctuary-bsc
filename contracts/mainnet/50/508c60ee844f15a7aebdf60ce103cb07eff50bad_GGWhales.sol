...
GGW is the token association of the whales.  which is in the bsc network, 
with GGW all whales will be happy to invest here to create a bright future together. 
 with such a strong community,
 we believe we will go to the moon together
https://t.me/ggwhales
https://ggwhales.co
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x576108EAf4635E706eaCb9EFf5C725705e9a7183; 
...
contract GGWhales is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GG Whales";
    string private _symbol = "GGW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x576108EAf4635E706eaCb9EFf5C725705e9a7183); 
    address payable public teamWalletAddress = payable(0x576108EAf4635E706eaCb9EFf5C725705e9a7183); 
    ...
    uint256 public _walletMax = 990000000 * 10**_decimals;
