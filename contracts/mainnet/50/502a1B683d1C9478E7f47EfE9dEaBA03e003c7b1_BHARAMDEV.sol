...
contract BHARAMDEV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BHARAMDEV";
    string private _symbol = "BDEV";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x73509bD78AbAFE482083e3785aC18c760fc86219); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x73509bD78AbAFE482083e3785aC18c760fc86219); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 80 * 10**6 * 10**9;
