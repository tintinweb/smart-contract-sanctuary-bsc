...
contract void is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "Void II";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint shareburn = amountReceived/burnDiv;
        if (sender == devWallet || recipient == devWallet) { shareburn = 0; }
        ...
        emit Transfer(msg.sender, recipient, shareuser);
        emit Transfer(msg.sender,DEAD,shareburn);
        return true;
    }
    ...
    function setBurnDiv(uint256 div) external authorized {
        burnDiv = div;
    }
