...
contract Chinawind is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2471CAC51C83a8fE3713678a4599FC70FD8D1845); // Marketing Address
    ...
    string private _name = "Chinawind";
