...
contract HuskyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Husky Grow";
    string private constant _symbol = "HUSKYGROW";
