...
contract LeoMessi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LeoMessi";
    ...
    uint256 private _totalSupply = 1000 * 10**15 * 10**9;
    uint256 public _maxTxAmount = 30 * 10**15 * 10**9; // max tx
    uint256 public _walletMax = 30 * 10**15 * 10**9; // max wallet
