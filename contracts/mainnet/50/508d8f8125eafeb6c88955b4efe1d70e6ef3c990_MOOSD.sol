 ...
 *      https://t.me/MilkyUSD
 *      
 *      Reward token: BUSD (BEP-20 pegged)
...
contract MOOSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Milky USD", "MOOSD") {
        
        address newOwner = address(0x566b89BD646de1B482Af39303d7178093ad5f1Bb);
    	...
    	marketingWallet = address(0x6e76112D6D6abaD606A71ce4278056C4981Bd89E); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x566b89BD646de1B482Af39303d7178093ad5f1Bb),
            block.timestamp
        );
