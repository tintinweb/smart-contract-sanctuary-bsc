...
contract SPDXDO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SPDXDO";
    string public _symbol = "SPDXDO";
    ...
    uint256 private _totalSupply = 59 * 10**9 * 10**15 * 10**_decimals;
    uint256 public _maxTxAmount = 59 * 10**9 * 10**15 * 10**_decimals; 
    uint256 public _walletMax = 59 * 10**9 * 10**15 * 10**_decimals;
