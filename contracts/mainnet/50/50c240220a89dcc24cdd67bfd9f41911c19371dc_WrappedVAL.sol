...
// File: contracts/token/ERC20/WrappedVAL.sol
...
/**
 * @title WrappedVAL
 * @dev Implementation of the WrappedVAL
 */
contract WrappedVAL is ERC20Mintable, ERC20Burnable, Ownable {

    constructor (
        )

        ERC20("Wrapped Validity", "wVAL")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
