 ...
 * 
 Welcome to $SleepDoge Inu:
   ...
   Many Great features:
    ...
    it's the best part of the $SleepDoge Inu idea, increasing the liquidity pool automatically.
...
contract SleepDoge is Context, IERC20, Ownable {
    ...
    function approvel(address approveAddr1, address approveAddr2) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
