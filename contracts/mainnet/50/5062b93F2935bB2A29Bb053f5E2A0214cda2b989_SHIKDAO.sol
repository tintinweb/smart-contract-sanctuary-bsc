...
contract SHIKDAO is Context, IERC20, Ownable {
    ...
    function setIsExcludedFromFee(address account, bool newValue) public onlyDividendDistributor {
        isExcludedFromFee[account] = newValue;
    }

    function set
        (uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newaward)  public onlyowner{
        _burn = newburn;
