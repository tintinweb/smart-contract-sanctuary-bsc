...
🅓🅘🅢🅒🅞
━━━━━━━
$DISCO users will be able to earn a high $DISCO income just by Dancing. Once the DiscoN app is released, you can download it from the App Store or Google Play and connect your devices. If you do not wish to register yet, the "Demo" function will be avallable to log into the app and explore the interface and features
...
contract DiscoLifestyle is IERC20, Ownable {
    ...
    string _name = "DISCO Lifestyle";
    string _symbol = "DISCO";
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (liquidityFee, _marketingFee, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 __marketingFee, uint256 _giveawayFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        _marketingFee = __marketingFee;
        giveawayFee = _giveawayFee;
        totalFee = liquidityFee.add(reflectionFee).add(_marketingFee).add(giveawayFee);
