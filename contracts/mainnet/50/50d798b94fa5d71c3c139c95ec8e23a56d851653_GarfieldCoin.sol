...
contract GarfieldCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GarfieldCoin";
    string private _symbol = "GC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x560A95Bfa50EB1037894E9B035d6e9Aa3Cc199c6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x560A95Bfa50EB1037894E9B035d6e9Aa3Cc199c6); // BuyBack Address
