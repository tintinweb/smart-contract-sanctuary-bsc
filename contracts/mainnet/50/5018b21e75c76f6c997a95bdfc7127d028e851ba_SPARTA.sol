...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0961e11F1815Fea033466c9D7EA61BE6703d3441;
...
contract SPARTA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPARTA GROW"; // 
    string private constant _symbol = "$SPAG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x0961e11F1815Fea033466c9D7EA61BE6703d3441);
