...
Telegram:  https://t.me/YearofrabbitBSC
...
contract YEAROFRABBITBSC is IBEP20, Auth {
    ...
    string constant _name = "Year of Rabbit";
    string constant _symbol = "YOR";
    ...
    uint256 public totalFee        = devFee + marketingFee + liquidityFee + ecoFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3C7FEce5226409DbBAc7ee6b8Db406336401917e;
        ecoFeeReceiver = 0x54aFC3A583BEbf10Fd7656A588Aa739f89F87Bdd;
        devFeeReceiver = 0x54aFC3A583BEbf10Fd7656A588Aa739f89F87Bdd;
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _ecoFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        marketingFee = _marketingFee;
        ecoFee = _ecoFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_devFee).add(_marketingFee).add(_ecoFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecoFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver) external authorized {
