...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x964df7eFE0fA4A578675c4D729d4ba17F02f8992;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x964df7eFE0fA4A578675c4D729d4ba17F02f8992),//fund address
    
        address(0x964df7eFE0fA4A578675c4D729d4ba17F02f8992)//dev address
    ){
