...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 private RWRD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    constructor (address _dexRouter) {
        _token = msg.sender;
        dexRouter = _dexRouter != address(0) ? IRouter02(_dexRouter) : IRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
contract BabyInu is IERC20, Ownable {
    ...
    uint256 public _totalSupply = 100_000_000_000_000_000 * 10**_decimals;
