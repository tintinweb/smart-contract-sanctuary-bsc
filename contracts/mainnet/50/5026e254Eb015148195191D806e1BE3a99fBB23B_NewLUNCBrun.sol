...
Telegram: https://t.me/NewLuncBURN
*/
...
contract NewLUNCBrun is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NewLuncBurn";
    string constant _symbol = "New LUNC";
    ...
    address public Owner=0x77b6784a09C5A7421cDdf93d443275D95C0C8E4B; // owner address
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 500; // 2% of supply
    bool inSwap;
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x77b6784a09C5A7421cDdf93d443275D95C0C8E4B;
