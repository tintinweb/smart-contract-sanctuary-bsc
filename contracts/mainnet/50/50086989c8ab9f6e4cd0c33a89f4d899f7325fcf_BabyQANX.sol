...
contract BabyQANX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyQANX";
    string private _symbol = "BabyQANX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x619a618d8bf5a2E937a867B415AD2A72B0e8b5DC); 
    address payable public BurnedWalletAddress = payable(0x619a618d8bf5a2E937a867B415AD2A72B0e8b5DC); 
