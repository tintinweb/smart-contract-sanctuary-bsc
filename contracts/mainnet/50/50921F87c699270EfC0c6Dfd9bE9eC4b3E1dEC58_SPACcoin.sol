...
contract SPACcoin is ERC20 {
    ...
    constructor() ERC20("SPACcoin", "SPACcoin") {    
        ...
        _fundAddress = address(0x4f547fE87aD901D45AD278104f2Fb5bb0530187D);   
        _setAutomatedMarketMakerPair(_uniswapV2Pair, true);

        // exclude from paying fees or having max transaction amount
        excludeFromFees(msg.sender, true);
        excludeFromFees(address(this), true);
        spac = IERC20(0x81cAd0ab645A1792F585cE93c5f955Ff3eCC3951);   
        uint256 total = 10**23;
    ...
    function _splitOtherToken() public {
        uint256 thisAmount = spac.balanceOf(address(this));
        if(thisAmount >= 10**8){
                ...
                if(buySize >10){
                    for(uint256 i=0;i<10;i++){
                        ...
                        if(balanceOf(user) >= 10**16){
                            ...
                            if(rate>0){
                                spac.transfer(user,thisAmount.mul(rate).div(10000));
                            }
                        }
