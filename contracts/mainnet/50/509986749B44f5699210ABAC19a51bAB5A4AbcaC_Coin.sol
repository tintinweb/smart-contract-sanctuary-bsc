...
contract Coin {
    string public constant name = "Bloomberg Finance";
    string public constant symbol = "Bloomberg";
    ...
    constructor() {
        PancakeRouter = address(uint160(520677472320044927039258084538238602511467942743));
