...
/**
Telegram : https://t.me/OnlyPumpPortal
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB0811A642d2562175351513d2643431df0BDF638; // owner address
...
contract OnlyPump is Context, IERC20, Ownable {
    ...
    string private _symbol = "ONLY PUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB0811A642d2562175351513d2643431df0BDF638); // Marketing Address
    address payable public teamWalletAddress = payable(0xB0811A642d2562175351513d2643431df0BDF638); // Team Address
