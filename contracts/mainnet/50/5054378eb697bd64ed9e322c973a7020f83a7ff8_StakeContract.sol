...
contract StakeContract {
    ...
    uint early_withdraw_percentage_comission = 80;
    ...
    constructor(string memory _name, address _businessOwner, address _token) {
        ...
        set_multiplier(86400 * 7, 1000);
        set_multiplier(86400 * 30, 4000);
        set_multiplier(86400 * 30, 10000);

        set_time_allowed(86400 * 7, true, false, 1000);
        set_time_allowed(86400 * 30, true, false, 4000);
        set_time_allowed(86400 * 60, true, false, 10000);
