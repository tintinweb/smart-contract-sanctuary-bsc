...
contract StableFarms is IERC20 {
    ...
    string constant private _name = "Stable Farms";
    ...
    uint256 constant public maxTaxes = 2500;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        development: payable(0xC1D8a4b2f2dF781CCe6FCB886fAceFb22AE2F300)
    });
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        require(buyFee + sellFee <= maxTaxes, "Cannot exceed roundtrip maximum.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if (balance > 0) {
            (success,) = _taxWallets.development.call{value: balance, gas: 35000}("");
        }
    }
