...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f835104A0D85Dae753caaA9eb9ca68763901c75; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Safemoon 1996";
    string private _symbol = "bSafemoon1996";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f835104A0D85Dae753caaA9eb9ca68763901c75); // Marketing Address
    address payable public teamWalletAddress = payable(0x7f835104A0D85Dae753caaA9eb9ca68763901c75); // Team Address
