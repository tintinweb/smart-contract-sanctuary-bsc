...
contract Token is ERC20, Ownable {
    ...
    LaborDogeDividendTracker public dividendTracker;
    ...
    address public _marketingAddress =
        0x7DD5DE0EDF311B2e7F38C6229197E6f46885B1a2;
    address public _liquidityReceiver = 0xa0e76eddefA916eE1410b921258A4eA2462449bF;
    ...
    constructor() public ERC20("LaborDoge", "LaborDoge") {
        dividendTracker = new LaborDogeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        LaborDogeDividendTracker newDividendTracker = LaborDogeDividendTracker(
            payable(newAddress)
        );
...
contract LaborDogeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor()
        public
        DividendPayingToken(
            "LaborDoge_Dividen_Tracker",
            "LaborDoge_Dividend_Tracker"
        )
    {
        claimWait = 3600;
