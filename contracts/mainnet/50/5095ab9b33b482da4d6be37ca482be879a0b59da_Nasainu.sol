...
contract Nasainu is Context, IERC20, Ownable {
    ...
    string private _name = "NASA INU";
    string private _symbol = "NASA INU";
    ...
    uint256 public _boostedMarketingFee = 2200;
    ...
    uint256 public _boostedDevFee = 100;
    ...
    address payable private _marketingWallet = payable(0xebDe7a0382986EB91AbA9176d0EA527b27819a88);
    ...
    uint256 private maxTxPercent = 40; // Less fields to edit
    ...
    uint256 private maxWalletPercent = 40; // Less fields to edit
