...
contract BabyGrowMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby GrowMoon"; 
    string private _symbol = "$BGM"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59e86F78E7A2eCE66946E7d23416Ed19AcC426F2); 
    address payable public teamWalletAddress = payable(0xa92D66b81Fc04FA4F78B2daF1FB70C80E9307A3a); 
