...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// ETH on BSC Mainnet ===============================================================
	//
	address private constant TOKEN_ADDRESS = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 1000000000000; // default 0.00001 ETH, worth 0.16c ATM.
    ...
    uint256 minDeposit = 100000000000000; // default 0.0001 ETH, worth 16c ATM.
