...
Introducing Surge Trinity, the revolutionary cryptocurrency that offers a triple threat of benefits

SRG Rewards
SRG Token Burn
Buybacks

With Surge Trinity, you'll earn rewards just for holding the, watch as tokens are burned to increase value, and enjoy buybacks that further boost the value of your $TRNT. 

Don't miss out on this unique opportunity to get in on the ground floor of a currency that's sure to soar. 

Invest in Surge Trinity today!"

Supply           - 1.000.000 $TRNT
Trax                - 30.000 $TRNT
Wallet              - 30.000 $TRNT

Total Trinity Taxes - 9%
...
contract trinity is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SURGE TRINITY";
    string private constant _symbol = "TRNT";
    ...
    //Tax wallets
    address public teamWallet = 0x488175d3Eb72509Ac5E58bA01472fE01850b928a;
    address public treasuryWallet = 0x488175d3Eb72509Ac5E58bA01472fE01850b928a;

    // Tax Split
    uint256 public teamShare = 0;
    uint256 public treasuryShare = 300;
    uint256 public rewardShare = 300;
    uint256 public burnShare = 300;
    ...
    //trading parameters
    uint256 public liquidity = 10**4 * 25**_srgDecimals;
