...
contract moonshot is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1f02F8Ff7a16f380C5ED7e1df22B4CB3Ae18e134;
    ...
    string private constant _name = "Yhwach Inu";
    string private constant _symbol = "YHWACH";
    ...
    Taxes public taxes = Taxes(0, 5, 5, 1, 0);
    Taxes public sellTaxes = Taxes(0, 5, 5, 1, 0);
...
/**
 * bots and snipers will be blacklisted / liquidity will be removed if heavily sniped
*/