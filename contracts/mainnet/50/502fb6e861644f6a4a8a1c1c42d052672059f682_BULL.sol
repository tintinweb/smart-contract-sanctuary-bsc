...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa71199c4c40Adbd99C32fEc3b597114Cb9a9D1CA;
...
contract BULL is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 81 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 40 * 10**9; //
    string private constant _name = "BullRun 2023"; // 
    string private constant _symbol = "BULL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xa71199c4c40Adbd99C32fEc3b597114Cb9a9D1CA);
