...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5cD6af7c18CE964AF7712B385156d8bfE1Bd413c; // owner address
...
contract DrLiveseyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dr. Livesey Inu";
    string private _symbol = "CHAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa621364aBEF05f23c22F0527a5dFAac0d4ae2bf0); // Marketing Address
    address payable public teamWalletAddress = payable(0xa621364aBEF05f23c22F0527a5dFAac0d4ae2bf0); // Team Address
