...
// Telegram : https://t.me/CatoMiaoussBSC
...
contract Cat is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x920eeE7b77c7EC2D967a48384f31404e6914bb7a;

    string private constant _name = "CatoMiaouss";
    string private constant _symbol = "$Miaouss";
    ...
    Taxes public taxes = Taxes(0,4,8,0);
