...
/**
 +-+-+-+-+-+ +-+-+-+-+-+-+-+-+
 |S|h|i|b|a| |F|o|o|t|b|a|l|l|
 +-+-+-+-+-+ +-+-+-+-+-+-+-+-+

Shiball (Shiba Football) - The most striking project on the Binance Smart Chain!

Telegram: t.me/shiballofficial

Stealth launched. No presale, no dev wallets, no insiders.
...
contract Shiball is IBEP20, Auth {
    ...
    string constant _name = "Shiba Football";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x96c40a08175f261E96d5430dA4d2c517F2ec777B; // liquidity
        marketingWallet = 0x5D25d46c85cB4a8C9B1f9A329aCC21cA2377f25E;  // marketing
