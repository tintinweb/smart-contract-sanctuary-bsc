...
contract HoldToEarn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = address(0x48C6A257fA03B469E37641e3B247AC1B41b5405a); //marketing wallet
    address public developmentWallet = address(0x48C6A257fA03B469E37641e3B247AC1B41b5405a); //development wallet
    ...
    uint16 public rewardsFee = 600; // 6% fee
    uint16 public liquidityFee = 500; // 5% fee
    uint16 public marketingFee = 100; // 1% fee
    uint16 public developmentFee = 0; // 0% fee
    uint16 public buybackFee = 0; // 0% fee
    ...
    constructor() ERC20("HoldToEarn", "HTE") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("HoldToEarn_Dividend_Tracker", "HoldToEarn_Dividend_Tracker")
    {
        claimWait = 3600;
