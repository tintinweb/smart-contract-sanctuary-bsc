...
/*
Telegram: https://t.me/wakandainuportal
*/
...
contract WakandaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WakandaInu";
    string private _symbol = "WAKANDA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18FE4C934097dcD18f2Fb5C7fe2EA3c4BD858C94); // Marketing Address
    address payable public devWalletAddress = payable(0x1Da479d885908e64dcEfBD8F27d6A2cED8BeA0FC); // Dev Address
