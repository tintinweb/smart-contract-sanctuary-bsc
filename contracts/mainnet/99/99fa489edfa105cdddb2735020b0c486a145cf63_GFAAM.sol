...
contract GFAAM is Context, IERC20, Ownable {
    ...
    string private constant _name = "GFIFA MOON"; //
    string private constant _symbol = "GFAAM"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x337e53b27143b8fc4915aB2628805ab515193D1c;
    ...
    function setFB(address addr,bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }
