...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D)); // shiba inu - 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D
...
contract NotAScam is ERC20, Ownable {
    ...
    constructor() ERC20("NotAScam", "NAS") {
        ...
        uint256 totalSupply = 100000000 * 1e18; //100000000
    	...
    	marketingWallet = address(0x10944724f2F180bF7860197e74DeE1ee6aCA4Cc6); // set as operations wallet
    ...
    function addAddressForExclusions(address _Address) external onlyOwner {
