...
contract Infinity is IBEP20, Ownable {
    string private constant _name = "888"; // Name
    string private constant _symbol = "888"; // Symbol
    ...
    constructor() {
        ...
        liquedityReceiver = address(0xC97e4881Ca050dc62ccC4ceE70f2bDfc97cF56E8);
        marketFeeReceiver = address(0xC97e4881Ca050dc62ccC4ceE70f2bDfc97cF56E8);
        devFeeReceiver = address(0xC97e4881Ca050dc62ccC4ceE70f2bDfc97cF56E8);
    ...
    function _transfer(
        ...
        if (
            ...
            if (sender == pcsPair) {
                ...
                amountReceived = amount - (totalAmount);
