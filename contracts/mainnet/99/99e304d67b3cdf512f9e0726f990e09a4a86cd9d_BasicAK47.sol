...
contract BasicAK47 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic AK47";
    string private constant _symbol = "BASICAK47";
