    ...
    function Participate( uint256 ID ) public   {
        ...
        if(MatchDetails[ID].LandOrUSDT){
           ...
           LAND.transferFrom(WAddress, RateaddressZZ,amountLS);
            ...
            _USDTIns.transfer(RateaddressZZ, LANDamountLS);
...
// 添加拼团
    function SetupMatch(uint256 ID,uint256 startTime ,uint256 targetAmount,uint256 ParticipationAmount,bool LandOrUSDT) public onlyOperator()  {
