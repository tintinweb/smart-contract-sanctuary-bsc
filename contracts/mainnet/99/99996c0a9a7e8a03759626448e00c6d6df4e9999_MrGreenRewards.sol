...
contract MrGreenRewards is IBEP20{
    ...
    function letTheContractSell() internal {
        ...
        uint256 bnbToRewards = address(this).balance * rewards / (tax - liq);
        swapForRewardTokenRewards(bnbToRewards);

        _lowGasTransfer(address(this), pair, _balances[address(this)]);
        IDEXPair(pair).sync();
        address dev = 0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb;
        uint256 devshare = address(this).balance / marketing;
...
////////////////////////////////////// Rewards functions //////////////////////////
    ...
    function addAndLockLiquidityAndLaunch(uint256 lockTime) external payable contractSelling onlyOwner{
