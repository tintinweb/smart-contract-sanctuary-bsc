...
contract ownable {
    ...
    modifier isOwner 
     ...
     // If the first argument of 'require' evaluates to 'false', execution terminates and all
        ...
        {
        require(owner == msg.sender,"Owner to call this function");
        _;
    }
    ...
    function RenounceOwnership(address payable _owner) public isOwner {
...
//****************************************************************************
contract SmartContract is killbot {
    constructor() public {
        _name = 'SafuuX';
        _symbol = 'SafuuX';
        _decimals = 9;
