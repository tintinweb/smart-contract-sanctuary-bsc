 ...
 * Standard SafeMath, stripped down to just add/sub/mul/div
  ...
  ___  __  __   ___  ____  _  _  __  __  __ __ ____   ___ 
 // \\ ||\ ||  // \\ || \\ \\// (( \ ||  || || || )) // \\
 ||=|| ||\\|| (( ___ ||_//  )/   \\  ||==|| || ||=)  ||=||
 || || || \||  \\_|| || \\ //   \_)) ||  || || ||_)) || ||
WEBSITE: https://www.angryshiba.fun/
TELEGRAM:https://t.me/AngryShibaToken                                                       
 * 
 */
library SafeMath {
...
contract AngryShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AngryShiba";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xaa41CFd244F72c940dDF2c222ecC0bD30A876AB1; //MARKETING WALLET
