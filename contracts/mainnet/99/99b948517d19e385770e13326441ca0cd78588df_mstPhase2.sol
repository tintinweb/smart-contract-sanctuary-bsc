...
contract mstPhase2 is Ownable, ReentrancyGuard {
    ...
    uint256 public isClaimV1 = block.timestamp + 186 days;
    uint256 public isClaimV2 = block.timestamp + 216 days;
    uint256 public isClaimV3 = block.timestamp + 246 days;
    uint256 public isClaimV4 = block.timestamp + 276 days;
    uint256 public isClaimV5 = block.timestamp + 306 days;
    uint256 public isClaimV6 = block.timestamp + 336 days;

    uint256 public tokenPerUsd = 0.08 * 1e18;
    uint256 constant MIN_BUSD = 50 * 1e18;
    ...
    //Wallet
    //0xe37AFc9e492Ab1fBc5950967c90Dee3b1C5A640d
    ...
    constructor(IERC20 _token, IERC20 _busd, IERC20 _usdt)  {
        require(
    ...
    function buyWithBNB(uint256 amount) public payable nonReentrant {
        ...
        uint256 tokenToReceived = amount.div(tokenPerUsd).mul(1e9);
