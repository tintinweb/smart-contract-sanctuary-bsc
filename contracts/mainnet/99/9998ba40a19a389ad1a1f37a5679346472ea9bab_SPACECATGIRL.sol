...
/**
Telegram: https://t.me/spacecatgirlbsc

LOW TAX HYPE MEME ON BINANCE SMART CHAIN
SAFE DEV
TAX 8/8
VERIFIED CONTRACT
AWSOME UTILITY ON PROGRESS
*/
...
contract SPACECATGIRL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2e457FCB28405fD9AA00902b9F0b4d7CD79C29e3); 
    address payable public Wallet_Dev = payable(0x46571DfFf5C47a1E32d1A0D5A779AdB88D24f53F);
    ...
    string private constant _name = "Space Cat Girl"; 
    string private constant _symbol = unicode"$SCG"; 
    ...
    constructor () {
        ...
        _owner = 0x46571DfFf5C47a1E32d1A0D5A779AdB88D24f53F;
