...
contract RoninINU is IBEP20, Auth {
    ...
    string constant _name = "RoninINU";
    string constant _symbol = "$Ronin";
   ...
   // sell fee
    ...
    address public Owner=0x3036800F9C4fc26eCDB6CA82921A88c82F44D7ea; // owner address
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1600; // 1% of supply
    bool inSwap;
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3036800F9C4fc26eCDB6CA82921A88c82F44D7ea; // marketing address
