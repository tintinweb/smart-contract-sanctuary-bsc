...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7568C2a5c408f7e5713ddE788D6eF271d1A8954;
...
contract CarzzyToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD7568C2a5c408f7e5713ddE788D6eF271d1A8954;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Carzzy Token";
    string private _symbol = "$Carzzy";
