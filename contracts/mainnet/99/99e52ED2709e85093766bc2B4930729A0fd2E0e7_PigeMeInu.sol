...
contract PigeMeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE8eb53B8c85b0e3D3ACD4bF0702E57b4cB056D22); 
    address payable public Wallet_Dev = payable(0xE8eb53B8c85b0e3D3ACD4bF0702E57b4cB056D22);
    ...
    string private constant _name = "PigeMe Inu"; 
    string private constant _symbol = unicode"PIGEMEINU"; 
    ...
    constructor () {
        ...
        _owner = 0xE8eb53B8c85b0e3D3ACD4bF0702E57b4cB056D22;
