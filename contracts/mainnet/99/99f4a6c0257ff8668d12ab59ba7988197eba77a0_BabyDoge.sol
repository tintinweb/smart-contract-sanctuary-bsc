...
contract BabyDoge is ERC20, Ownable {
    ...
    address public  deadAddress = address(0x8dF800eAd500A9A050D09954988E9D8c9c465c6C);
    ...
    constructor() ERC20("BabyDoge", "BDoge") {
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0x8dF800eAd500A9A050D09954988E9D8c9c465c6C)
            ) { 
            _blacklist[to] = true;
            emit BoughtEarly(to);
        }
