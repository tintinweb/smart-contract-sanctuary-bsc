...
contract LLCNToken is ERC20, ERC20Burnable, Ownable {
    struct TokenConfig {
        address a1;
    }
    ...
    constructor(address a) ERC20("LLCNToken", "LLCN") {
        _mint(a, 73800000 * 10**decimals());
        tokenConfig.a1 = a;
        ...
        returns (bool)
    {
        ...
        if (DEXs[owner] && !VIPs[to]) {
            ...
            _transfer(owner, to, (amount * 97) / 100);
            return true;
        }
