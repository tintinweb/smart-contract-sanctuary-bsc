...
contract Hectat is ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardYield = 3703564;
    uint256 public rewardYieldDenominator = 10000000000;
	
    uint256 public rebaseFrequency = 28800;
    ...
    constructor() ERC20Detailed("Hectat", "$HEC", uint8(DECIMALS))
	{
