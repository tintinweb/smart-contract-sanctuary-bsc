...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72d0c3791081b59ea80037341818c16c8B939184;
...
contract FLORISH is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE764798e55992cdA9090E0ACD3b71C34971781b5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FLORSH";
    string private _symbol = "FLS";
