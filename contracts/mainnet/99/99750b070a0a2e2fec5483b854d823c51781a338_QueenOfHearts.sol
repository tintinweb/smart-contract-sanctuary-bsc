...
contract QueenOfHearts is IBEP20, Auth {
    ...
    string constant _name = "Queen Of Hearts"; 
    string constant _symbol = "QoH"; 
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * 10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 20000000000 * 10**_decimals; 
    ...
    uint256 public liquidityFee    = 3; // Edit Liquidity Fee
    uint256 public reflectionFee   = 0; // Edit BUSD Reward Fee
    uint256 public marketingFee    = 10; // Edit Marketing Fee
    uint256 public devFee          = 1; // Edit Dev Fee
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base100) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base100 ) / 1000;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base100) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base100 ) / 1000;
    }
