...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE354961bf3a4E33153989d47Bca9ea1337741ce7; // owner address
...
contract HalfShinkoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Shinko";
    string private _symbol = "HS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1AF21764D3Db4e5Dc9DAC1052a026Bb2625C42a8); // Marketing Address
    address payable public teamWalletAddress = payable(0xE354961bf3a4E33153989d47Bca9ea1337741ce7); // Team Address
