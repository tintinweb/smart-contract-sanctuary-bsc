...
contract KOI is IBEP20, Auth {
    ...
    uint256 public totalFee = marketingFee + burnFee + liquidityFee + rewardFee;
    ...
    function setFees(uint256 _liquidityFee, uint256 _burnFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        burnFee = _burnFee;
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_burnFee).add(_rewardFee).add(_marketingFee);
