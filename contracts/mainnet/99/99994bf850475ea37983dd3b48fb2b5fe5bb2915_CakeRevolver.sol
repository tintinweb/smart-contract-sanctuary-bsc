...
contract CakeRevolver is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cake Revolver";
    string private constant _symbol = "CakeRevolver";
