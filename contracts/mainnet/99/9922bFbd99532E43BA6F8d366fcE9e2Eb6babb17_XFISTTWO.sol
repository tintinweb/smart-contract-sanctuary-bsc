...
contract XFISTTWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "X-FIST 2.0";
    string private constant _symbol = "X-FIST2.0";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 21000000 * 10**_decimals;
    uint256 public _maxTxAmount = 840000 * 10**_decimals;
    uint256 public _maxWalletAmount = 840000 * 10**_decimals;
