...
contract MoonDuck is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MoonDuck";
    string private _symbol = "MoonDuck";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6Edbd32b4d0035eBf809B51ac4a5E571Dd234127));
        marketingWalletAddress = payable(address(0x6Edbd32b4d0035eBf809B51ac4a5E571Dd234127));
