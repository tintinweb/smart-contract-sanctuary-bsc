...
///   Welcome to iGrow community! We will grow even without fertiliser!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90);
    IDEXRouter router;
...
contract iGrow is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCEEB43575b667204209Ffff544871A275944D4C0;
