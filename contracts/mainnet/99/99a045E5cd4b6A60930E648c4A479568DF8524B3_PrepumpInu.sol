...
https://t.me/PREPUMPINU

https://prepumpinu.xyz/

THIS ORIGINATED FROM A GIVEAWAY POST. DEV IS KYC ON COINSNIPER.

a Social Experiment by @MRBASEDFARMER @GOLDENTICKETBSC @SHEEBINU PREVIOUS PROJECTS

AFTER CAREFUL CONSIDERATION, WE HAVE DECIDED AS A COMMUNITY TO PREPUMP ON 99% SELLTAX

DAY 1 (PREPUMP) 99% sell
DAY 2 50% sell
DAY 3 40% sell
DAY 4 30% sell
DAY 5 20% sell
...
LP LOCKED FOR 1 WEEK TO BEGIN, WILL INCREASE IF WE'RE STILL LOOKING ALIVE NEARER DAY 7!!!!
...
contract PrepumpInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Prepump Inu";
    string constant _symbol = "PREPUMP";
    ...
    uint256 public extraFeeOnSell = 89;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xA92aEAb1754d15f916D4e074b78902aEc401aeA1;  
        anothermarketingWallet = 0xCdC885048EE910Fd9A64D01a7a6e1899fc17BBFe;
