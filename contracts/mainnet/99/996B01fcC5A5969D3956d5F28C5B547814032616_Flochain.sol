...
//tg:https://t.me/FlochainOfficial
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x515D33409d4d793251e1DAe3B3a710128461e1e8;
...
contract Flochain is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOCHAIN BSC"; // 
    string private constant _symbol = "FLOCHAIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x515D33409d4d793251e1DAe3B3a710128461e1e8);
