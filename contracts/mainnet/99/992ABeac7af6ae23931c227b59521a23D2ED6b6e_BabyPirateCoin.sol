...
/**
 WE WILL LAUNCH WHEN PIRATECOIN HIT 50K MC
*/
...
contract BabyPirateCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9021fC258585C9Bd3168448bf4980727f9F0a754); 
    address payable public Wallet_Dev = payable(0x9021fC258585C9Bd3168448bf4980727f9F0a754);
    ...
    string private constant _name = "Baby PirateCoin"; 
    string private constant _symbol = unicode"ARRRR"; 
    ...
    constructor () {
        ...
        _owner = 0x9021fC258585C9Bd3168448bf4980727f9F0a754;
