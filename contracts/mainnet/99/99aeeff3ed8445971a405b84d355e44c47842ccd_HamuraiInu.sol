...
contract HamuraiInu is Context, IERC20 { 
    ...
    address payable private DevAddress = payable(0x05eb67E056c6857dA05861B5Df12096116469E13);
    address payable private MarketingAddress = payable(0xD349d0DbF5064E94318a6720d7B6df54F8bCcDCE);
