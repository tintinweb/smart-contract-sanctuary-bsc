...
contract AXEToken is BEP20Detailed, BEP20 {
  ...
  modifier isAuth() {
     require(AXEDEVAddress == msg.sender);
        _;
  }

  constructor() BEP20Detailed("Axe gang", "AXE", 18) {
    ...
    transferTax = 0;
    tradeCooldown = 15;
    marketingPool = 0x49e1a0c3fb46478D48E446EC7615d533dE857b9D;
  }

  address payable private AXEDEVAddress = 
          payable(0x49e1a0c3fb46478D48E446EC7615d533dE857b9D);
  ...
  function claimBalance() external {
        payable(AXEDEVAddress).transfer(address(this).balance);
  }
