...
// Telegram: https://t.me/lunav2channel
...
contract LUNAVER2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "LUNA 2.0 (Wormhole)"; // 
    string private constant _symbol = "LUNA"; //    
    uint256 private _tTotal = 268834016026 * 10**9;
    uint256 public _maxWalletSize = (_tTotal * 5) / 100; // % of total supply
    uint256 public _maxTxAmount = (_tTotal * 5) / 100; // % of total supply
    uint8 private constant _decimals = 9; // 
    uint256 private SWAP_TOKENS_AT_AMOUNT = (_tTotal * 5) / 10000; // 0.05% of total supply
    
    uint256 public eventTime = 0;
    uint256 public _marketingFee = 12; //% tax fee
    uint256 public _liquidityFee = 0;
    
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => uint256) private _tOwned;
    address public  _marketingWallet = 0x3Eb12cce008D4cF7aB3df7F28fBf8982124c68c6;
