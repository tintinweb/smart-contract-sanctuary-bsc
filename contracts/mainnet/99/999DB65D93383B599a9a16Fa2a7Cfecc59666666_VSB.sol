...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function processReward(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (_userInfo[shareHolder].activeBinderLength >= activeLength && balanceOf(shareHolder) >= dividendCondition && !excludeHolder[shareHolder]) {
...
contract VSB is AbsToken {
    ...
    //USDT
        ...
        100000000,
    //Fund
        address(0xAD930f205006A626222D4aa55F08101E3b4D3003),
    //Receive
        address(0x7DC71F1cDd99ddD00CdF4C11dbd22CEe953BE3c9),
        21000
    ){
