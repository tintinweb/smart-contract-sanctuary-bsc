...
contract Pro69Token {
    ...
    constructor() {
        name = "Pro69"; // Sets the name of the token, 
        symbol = "PRO69"; // Sets the symbol of the token,
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 400000000 * (10**uint256(decimals)); // Holds an initial supply of coins

        /* Sets the owner of the token*/
        owner = payable(0x50c8e0169Ce9b80225167Ab3Da3fE5FE18987734);
