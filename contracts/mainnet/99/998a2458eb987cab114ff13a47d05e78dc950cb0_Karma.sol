...
contract Karma is ERC20, Ownable {
    ...
    // Dates
    uint256 public sellStartDate = 0;
    uint256 public sellEndDate = 1;
    ...
    function setBurnFee(uint8 newBurnFee) external onlyOwner {
        require(newBurnFee <= 10 && newBurnFee >=0,"KARMA: Burn fee must be between 0 and 10");
    ...
    function setMaxSellLimit(uint256 amount) external onlyOwner {
        require(amount >= 1000 && amount <= 1_000_000_000, "KARMA: Amount must be bewteen 1000 and 1 000 000 000");
