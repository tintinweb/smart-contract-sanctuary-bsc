...
contract BullGrow is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BullGrow";
    string constant _symbol = "BullGrow";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x618bC1a39e6870999fc4E96d3155859b43BE1271;
