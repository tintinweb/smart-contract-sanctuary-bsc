...
contract VillaCoin is ERC20, Ownable {

    bool public canBurn;

    constructor(string memory name_, string memory symbol_, uint256 supply_, uint8 decimals_, bool canBurn_, address addr_) ERC20(name_, symbol_, decimals_, addr_) payable {
