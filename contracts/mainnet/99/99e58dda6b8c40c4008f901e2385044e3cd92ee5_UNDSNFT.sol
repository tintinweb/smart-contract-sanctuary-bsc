...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
		...
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/Qmdcmo6UhkrmbjkGDctMCbt89HckXDdqjYxhRCbhykYfmA");
        return true;
    }
}
...
contract UNDSNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("UNDS NFT", "UNDSNFT") {
