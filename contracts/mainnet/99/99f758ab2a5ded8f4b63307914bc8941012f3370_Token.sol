...
contract Token is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8bd5546c27a9A5a99aF16B7dEF3e3A489Bb7be2D); 
    address payable public Wallet_Dev = payable(0x8bd5546c27a9A5a99aF16B7dEF3e3A489Bb7be2D);
    ...
    string private constant _name = "Yukari Yakumo";
    string private constant _symbol = unicode"八雲 紫"; 
