...
contract RocketCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rocket Coin";
    string private _symbol = "Rocket Coin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4FF54F4a95dC737ec839F551Bc2B6870272551F5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xeA20c80F388C4247B4Fb4E719621400ea2D2AaF1); // buyback Address
