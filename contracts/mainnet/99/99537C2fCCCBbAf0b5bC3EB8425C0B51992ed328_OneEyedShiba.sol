...
contract OneEyedShiba is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"OES";
    ...
    address payable private _developmentAddress = payable(0xD5E36a90d0aA50E3A3088e5A785fE0416a5C8E53);
    address payable private _marketingAddress = payable(0xD5E36a90d0aA50E3A3088e5A785fE0416a5C8E53);
