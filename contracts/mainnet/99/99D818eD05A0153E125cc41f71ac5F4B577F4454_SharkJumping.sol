...
/*
    ...
    Based on latest ELon tweet
    LP will be locked after launch.  

  TG  : https://t.me/SharkJumping_official
...
contract SharkJumping is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shark Jumping";
    string constant _symbol = "SJ";
    ...
    address public Owner=0x26b144214B01d7762f6F6F1ED7211144FdF2FE22; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x26b144214B01d7762f6F6F1ED7211144FdF2FE22;
