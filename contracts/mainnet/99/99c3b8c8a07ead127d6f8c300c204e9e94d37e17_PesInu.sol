...
interface IDEXRouter {
 ...
 contract PesInu is IBEP20, Auth { using SafeMath for uint256;
    ...
    uint256 buybackFee = 7; // Marketing Wallet
    uint256 devFee = 1;  
    uint256 totalFee = 10;  
    uint256 feeDenominator = 100;
    uint256 public _sellMultiplier = 1;
 
    address public devFeeReceiver = 0xFFd35f939Df76EF14840b87a4922d3D1d0fDfC60;
