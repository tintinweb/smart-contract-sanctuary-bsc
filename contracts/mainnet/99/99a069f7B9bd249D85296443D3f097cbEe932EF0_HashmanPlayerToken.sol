...
interface IBEP20 {
     ...
     * @dev update website
     */
    function updateWebsite(string memory newWebsite) external;
...
contract HashmanPlayerToken is Context, IBEP20 {
    ...
    constructor() {
        _owner = msg.sender;
        _website = "https://www.hashman.io/";
        _name = "Hashman Player Token";
        _symbol = "HPT";
        _decimals = 18;
        _totalSupply = 9 * 10**28;
     ...
     * @dev update website
     */
    function updateWebsite(string memory newWebsite) external virtual override {
