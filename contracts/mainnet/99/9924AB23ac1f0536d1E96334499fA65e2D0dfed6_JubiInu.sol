...
contract JubiInu is IBEP20, Ownable {
    ...
    address TEAM = 0x09fC45895bd4b82684E18fb22A44827c836C83Bf;
    ...
    constructor () Ownable(msg.sender) {
        ...
        totalFee = FeeLiquidity.add(_marketingFee).add(rewardsFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeApplicable = pair == recipient ? _marketingFee : FeeLiquidity;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(FeeLiquidity).div(totalFee).div(2);
