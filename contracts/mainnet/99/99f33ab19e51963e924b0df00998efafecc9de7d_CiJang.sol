...
contract CiJang is Context, IERC20, Ownable {
    ...
    string private constant _name = " CiJang "; // 
    string private constant _symbol = " $CIJANG "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x311cE747BD4acFD1321B32F6aFC172f8230Fa99d;
