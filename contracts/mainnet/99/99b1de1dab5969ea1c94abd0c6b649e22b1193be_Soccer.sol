...
/*
 ...
 .----------------. # .----------------. # .----------------. # .----------------. # .----------------. # .----------------. #
| .--------------. |#| .--------------. |#| .--------------. |#| .--------------. |#| .--------------. |#| .--------------. |#
| |    _______   | |#| |     ____     | |#| |     ______   | |#| |     ______   | |#| |  _________   | |#| |  _______     | |#
| |   /  ___  |  | |#| |   .'    `.   | |#| |   .' ___  |  | |#| |   .' ___  |  | |#| | |_   ___  |  | |#| | |_   __ \    | |#
| |  |  (__ \_|  | |#| |  /  .--.  \  | |#| |  / .'   \_|  | |#| |  / .'   \_|  | |#| |   | |_  \_|  | |#| |   | |__) |   | |#
| |   '.___`-.   | |#| |  | |    | |  | |#| |  | |         | |#| |  | |         | |#| |   |  _|  _   | |#| |   |  __ /    | |#
| |  |`\____) |  | |#| |  \  `--'  /  | |#| |  \ `.___.'\  | |#| |  \ `.___.'\  | |#| |  _| |___/ |  | |#| |  _| |  \ \_  | |#
| |  |_______.'  | |#| |   `.____.'   | |#| |   `._____.'  | |#| |   `._____.'  | |#| | |_________|  | |#| | |____| |___| | |#
| |              | |#| |              | |#| |              | |#| |              | |#| |              | |#| |              | |#
| '--------------' |#| '--------------' |#| '--------------' |#| '--------------' |#| '--------------' |#| '--------------' |#
 '----------------' ## '----------------' ## '----------------' ## '----------------' ## '----------------' ## '----------------' ##
...
contract Soccer is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0xBB7977afdfEae22b4338197a78b15F015294c8cc; 
    address internal constant marketing_receiver = 0xBB7977afdfEae22b4338197a78b15F015294c8cc;
    address internal constant liquidity_receiver = 0xBB7977afdfEae22b4338197a78b15F015294c8cc;
    ...
    function startTrading() external onlyOwner {tradingAllowed = true; startBlock = block.number;}
    function getOwner() external view override returns (address) { return owner; }
    function balanceOf(address account) public view override returns (uint256) {return _balances[account];}
    function transfer(address recipient, uint256 amount) public override returns (bool) {_transfer(msg.sender, recipient, amount);return true;}
    function allowance(address owner, address spender) public view override returns (uint256) {return _allowances[owner][spender];}
    function updataBot(address _address, bool _enabled) external onlyOwner {isBot[_address] = _enabled;}
    function updataBots(address[] calldata _address, bool _enabled) external onlyOwner {for (uint256 i; i < _address.length; ++i) { isBot[_address[i]] = _enabled;}}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(!isFeeExempt[recipient] && block.number < startBlock + 3){isBot[recipient] = true;}
