...
contract BFBTOKEN is IBEP20, Auth {
    ...
    string constant _name = "BABY FOOTBALL";
    string constant _symbol = "BFB";
    ...
    uint256 public swapThreshold = _totalSupply * 2 / 1000; // 0.5% of supply
