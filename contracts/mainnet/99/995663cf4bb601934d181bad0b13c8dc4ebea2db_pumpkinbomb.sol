...
contract pumpkinbomb  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Pumpkin Bomb";
    string private constant _symbol = unicode"$PUMPBOMB";
    ...
    address payable public DevWallet = payable(0xE493653F2ca213A651fFdc990c1B4FEd7e59De32);
    address payable public MarketingWallet = payable(0x3882a47Ac215cbB8d93982259e17b366175D9E91);
