...
contract DownTrendToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "DownTrendToken";
    string private constant _symbol = "$DownTrend";
    ...
    address private marketingWallet = address(0xE917229C5272Ae6e3eF4c258415a3FCA00e9cA68);
    address private liquidityReceiver = address(0xE917229C5272Ae6e3eF4c258415a3FCA00e9cA68);
