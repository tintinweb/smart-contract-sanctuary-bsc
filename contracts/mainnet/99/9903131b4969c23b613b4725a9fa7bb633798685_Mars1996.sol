...
https://t.me/MarsToken1996


    __  ______    ____  _____    _______  ____  _____
   /  |/  /   |  / __ \/ ___/   <  / __ \/ __ \/ ___/
  / /|_/ / /| | / /_/ /\__ \    / / /_/ / /_/ / __ \ 
 / /  / / ___ |/ _, _/___/ /   / /\__, /\__, / /_/ / 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x44743F0D8d9748cF0dafABA1e6EB6D68B15Afcd6; // owner address
...
contract Mars1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mars1996";
    string private _symbol = "$MARS96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x44743F0D8d9748cF0dafABA1e6EB6D68B15Afcd6); // Marketing Address
    address payable public teamWalletAddress = payable(0x44743F0D8d9748cF0dafABA1e6EB6D68B15Afcd6); // Team Address
