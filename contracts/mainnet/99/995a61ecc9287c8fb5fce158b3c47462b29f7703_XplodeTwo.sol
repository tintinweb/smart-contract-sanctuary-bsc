...
contract XplodeTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xplode 2.0";
    string private _symbol = "Xplode Two";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8cb5c8cc67D8f1b9FDe915CE0B3639466c04F4eC); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x8cb5c8cc67D8f1b9FDe915CE0B3639466c04F4eC); // Developmental Address
