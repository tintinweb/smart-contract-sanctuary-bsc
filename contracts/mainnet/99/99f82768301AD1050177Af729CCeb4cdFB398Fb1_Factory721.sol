...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new DogeBNBUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DogeBNBUser721Token token = DogeBNBUser721Token(address(addr));
...
contract DogeBNBUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
