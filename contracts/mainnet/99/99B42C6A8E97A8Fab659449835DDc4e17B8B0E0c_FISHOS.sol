...
contract FISHOS is Context, IERC20, Ownable {
    ...
    uint256 private _Total = _tTotal * 10 * 10 ;


    string private _name = 'FISHOS';

    string private _symbol = 'FISHOS';
