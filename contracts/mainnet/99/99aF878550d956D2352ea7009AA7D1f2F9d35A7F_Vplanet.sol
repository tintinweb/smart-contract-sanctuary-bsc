...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable,Pausable {
 ...
 mapping (address => bool) private _isBlackListedBot;
	...
	function setMaxTxPercent(uint256 _setMaxTxPercent) external onlyOwner{
  	   _maxTxAmount = _setMaxTxPercent;
  	}

	function setWalletBalance(uint256 _maxWalletBalance) external onlyOwner{
  	    _maxWalletSize = _maxWalletBalance;
  	}
...
//Vplanet.sol
contract Vplanet is ERC20 {
    constructor(address tomint_) ERC20("Vplanet", "Vpt") {
        _mint(tomint_ , 200000000 * 10 ** decimals());
    }
}