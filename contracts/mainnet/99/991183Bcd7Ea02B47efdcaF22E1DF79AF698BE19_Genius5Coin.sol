...
contract Genius5Coin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Genius5Coin";
    string private _symbol = "G5C";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdE0527259D28C78AcD5b8934ac99bf26948F64AD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdE0527259D28C78AcD5b8934ac99bf26948F64AD); // BuyBack Address
