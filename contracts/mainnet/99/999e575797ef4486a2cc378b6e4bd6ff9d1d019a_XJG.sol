...
contract XJG is ERC20 {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    address _tokenOwner;
	address _baseToken = address(0xcdD8Dc24a5a71134Dc0d79a0333581996ae615D4);
    bool private swapping;
	bool private swapStats;
    uint256 public swapTokensAtAmount;
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
	address payable _fundAddress = payable(address(0x2Eb31654eBCC922672691440eA6fAac37E24ED23));
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;
    mapping(address => bool) public automatedMarketMakerPairs;
    bool public swapAndLiquifyEnabled = true;

    constructor(address tokenOwner) ERC20("XJG", "XJG") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WETH());
		uint256 total = 65 * 10**22;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair || to == uniswapV2Pair){
            ...
            if(haveAmount > swapTokensAtAmount){
                if (
                    !swapping &&
                    _tokenOwner != from &&
                    _tokenOwner != to &&
                    ...
                    swapping = true;
                    swapAndLiquifyDW2(haveAmount.div(6).mul(5));
					swapAndLiquifyBNB(haveAmount.div(6));
                    swapping = false;
                }
            }
        }
	...
	function swapAndLiquifyDW2(uint256 swapAmount) public {
		if(swapAmount > 10**19){
			swapTokensForOther(swapAmount);
		}
    }
	
	function swapAndLiquifyBNB(uint256 swapAmount) public {
		if(swapAmount > 10**19){
