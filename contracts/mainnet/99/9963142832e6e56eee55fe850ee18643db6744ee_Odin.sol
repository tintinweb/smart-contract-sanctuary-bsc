...
/* odinpresale.com Binance launch Pad- BNB Reward Token

website: odinpresale.com
Listing 1 Odin = 1.2 USD
...
contract Odin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xe3E6F28fEa78Ac4d078aAE9F2241cD855f05CEea); // Marketing Address
    address payable public charityAddress = payable(0xe3E6F28fEa78Ac4d078aAE9F2241cD855f05CEea); // Charity/Dev Address
    ...
    string private _name = "Odin Presale";
