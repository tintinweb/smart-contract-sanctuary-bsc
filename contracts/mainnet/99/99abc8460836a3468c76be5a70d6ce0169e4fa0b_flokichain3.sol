...
contract flokichain3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Chain3"; // 
    string private constant _symbol = "$flokiChain3"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x3fAaB118D5C5d1DA8813ac4cd5e1c6dCeC8f9e1f;
