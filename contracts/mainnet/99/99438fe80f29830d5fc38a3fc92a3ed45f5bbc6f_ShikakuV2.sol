...
contract ShikakuV2 is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "ShikakuV2";
    string private constant _symbol = "ShikakuV2";
    ...
    address internal constant development_receiver = 0x0D78475081b7dC539bBCF7B832aAbf731C3f568b; 
    address internal constant marketing_receiver = 0x0D78475081b7dC539bBCF7B832aAbf731C3f568b;
    address internal constant liquidity_receiver = 0x0D78475081b7dC539bBCF7B832aAbf731C3f568b;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        checkAllowToTrade(sender, recipient);
        checkMaxBag(sender, recipient, amount); 
    ...
    function checkAllowToTrade(address sender, address recipient) internal view {
        if(!isFeeExempt[sender] && !isFeeExempt[recipient]){require(tradingAllowed, "tradingAllowed");}
    }
    
    function checkMaxBag(address sender, address recipient, uint256 amount) internal view {
