...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7Beaf4e3f2a740884B7Eb487633C50c412cb554;
...
contract UKC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x15C02f9c8ABE9Ea4a4dC0D548BBa2244b4641dCD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ukraine cat";
    string private _symbol = "UKC";
