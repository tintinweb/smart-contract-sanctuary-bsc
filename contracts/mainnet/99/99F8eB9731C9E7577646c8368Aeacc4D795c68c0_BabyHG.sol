...
contract BabyHG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "BabyHG";
    string private _symbol = "BabyHG";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 95 * 10**22 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xBAE8553319155d4b62531fe4Ded7D24978b9679a; 
