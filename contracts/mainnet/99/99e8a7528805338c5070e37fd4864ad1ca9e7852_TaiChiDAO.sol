...
contract TaiChiDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TaiChi DAO";
    string private _symbol = "TaiChi DAO";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x8d1D717E61Cf223FadEEEeebADC264a6e1E1Af1a); 
    address payable public ttWal = payable(0x8d1D717E61Cf223FadEEEeebADC264a6e1E1Af1a); 
