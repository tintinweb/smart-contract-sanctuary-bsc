...
contract KursToken is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;
    //Add Wallet adress that collect the BNB Taxes
    address payable public marketingAddress = payable(0x0e6d9cf976a97C395c213D690DF25A8a5b8D14bf);
    address payable public charityAddress =   payable(0x0e6d9cf976a97C395c213D690DF25A8a5b8D14bf); 
    address payable public liquidityAddress = payable(0x0e6d9cf976a97C395c213D690DF25A8a5b8D14bf);
    ...
    string private _name = "KursToken";
