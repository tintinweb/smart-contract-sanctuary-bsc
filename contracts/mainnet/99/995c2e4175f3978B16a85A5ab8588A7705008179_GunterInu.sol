...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA5C55648De4bC96Ec60D3783fbDB6805f48a1d7c;
...
contract GunterInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe561e798e90A9D96430a9AB136128Ac9dbE5cBcA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Gunter Inu";
    string private _symbol = "Gunter";
