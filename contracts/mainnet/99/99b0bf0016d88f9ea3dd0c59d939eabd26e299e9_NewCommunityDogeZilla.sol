...
contract NewCommunityDogeZilla is IBEP20, Auth {
    ...
    address DEV = 0x12E20f1CD6389719dD9D88F0aA6b4886f17e9bcC;
    ...
    // Name and symbol
    string constant _name = "New Community DogeZilla";
    string constant _symbol = "cDogezilla";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 25 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 25 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 25 ) / 10000; // 1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0521c20f0Df94fA299a7c7BEAAe665DA85b837F3;
