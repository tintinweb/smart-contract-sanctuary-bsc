...
/**
Telegram : https://t.me/StarlinkDogePortal
*/
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x44EC1fCb9A93EB75fD3CA22D0E12B6CC97a3A6Cc;
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  OP = IBEP20(0xd51CB10cc1607e86A5def54EE3bE806A7df8528b);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = OP.balanceOf(address(this));
        ...
        uint256 amount = OP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            OP.transfer(shareholder, amount);
...
/* Token contract */
contract STARLINKDOGE is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address OP = 0xd51CB10cc1607e86A5def54EE3bE806A7df8528b; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x44EC1fCb9A93EB75fD3CA22D0E12B6CC97a3A6Cc;
    ...
    // Name and symbol
    string constant _name = "STARLINK DOGE";
    string constant _symbol = "SDOGE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 5% on launch or 50k tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 5% or 50k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 5% or 50k tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x18f822748c0934Dbced558B1AAaE866dcB8E93cf;
