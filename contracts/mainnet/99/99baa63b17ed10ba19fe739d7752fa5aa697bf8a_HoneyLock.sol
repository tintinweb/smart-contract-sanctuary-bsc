...
contract HoneyLock is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Honey Lock";
    string constant _symbol = "HNLK";
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        uint256 totaFee = sender == pair ? totalFee : (totalFee + BuyBack);
