...
contract SHITGROW2 is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private _name = "ShitGrow2";
    string private _symbol = "SHITGROW2";
    uint8 private _decimals = 9;
    address payable public marketingWL = payable(0x3773cC91bF842017170a35adD4b9fFb606fc9732);
