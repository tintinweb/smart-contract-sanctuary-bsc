...
//SPDX-License-Identifier: MIT    VIC3 TOK3N PROMO
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  $VICE = IBEP20(0xA2644C6A6bdF27004a82Af7977cf614db5EB0c65);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = $VICE.balanceOf(address(this));
        ...
        uint256 amount = $VICE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            $VICE.transfer(shareholder, amount);
...
/* Token contract */
contract MIRACLEGROBSC is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address $VICE = 0xA2644C6A6bdF27004a82Af7977cf614db5EB0c65; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xD9092731cd8F9Cf9b259ACc4A118D909E282a045;
    ...
    // Name and symbol
    string constant _name = "MIRACLE GRO BSC";
    string constant _symbol = "MIRACLE GRO BSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDd54D210F68F7619B7180E5C0c41C898adc48eB8;
