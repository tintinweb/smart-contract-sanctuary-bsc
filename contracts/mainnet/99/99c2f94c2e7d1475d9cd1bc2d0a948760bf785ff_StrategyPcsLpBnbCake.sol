...
interface IProfitDistributor {
    function pullRewards(uint256 _vvsAmount) external;
}
...
contract StrategyPcsLpBnbCake is Ownable, ReentrancyGuard, Pausable, IStrategy {
    ...
    constructor(address _controller, address _want, address _farmingToken, address _farmingPool, uint256 _farmingPoolId, address _usdc) {
