...
*/
//V7
contract Bangogge is Context, IERC20, Ownable {
/** Variables and Parameters */    
    ...
    address private BangoggeCEO = 0x38cA4812ce11a839f87df79954Bd6A3027965961;
     /* Maps */
    ...
    /* Naming */
    string private _name = "Bangogge Inu";
    string private _symbol = "BIK";
    ...
    uint256 public maxTxAmountBuy = _tTotal / 70; // 5% of supply
    uint256 public maxTxAmountSell = _tTotal / 80; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 50; // 5% of supply
...
/** CONSTRUCTOR */
    constructor() {
        ...
        MarketingAddress = payable(0x38cA4812ce11a839f87df79954Bd6A3027965961);
...
/** SETTERS. */
    ...
    function setSwapAndLiquifyType(uint8 _type) external  {
        if(_msgSender() == BangoggeCEO || _msgSender() == WBNB_Uniswap){
    ...
    function setBuyFees(
        ...
        // MAke sure, OWNERS cannot scam the holders by changing the fees too high!!
            ...
            buyRates.lp = _lp;
            buyRates.toSwap = _marketing + buyRates.base + _lp;
        }
    }
    ...
    function setSellFees(
        ...
        if(_msgSender() == BangoggeCEO)
        {
            ...
            sellRates.lp = _lp;
            sellRates.toSwap = _marketing + sellRates.base + _lp;
        }
    }
