...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pororo Inu"; //
    string private constant _symbol = "PoIn"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0C27fb531bd5d0bc81f8bee1F2b363aD34F274c3;
