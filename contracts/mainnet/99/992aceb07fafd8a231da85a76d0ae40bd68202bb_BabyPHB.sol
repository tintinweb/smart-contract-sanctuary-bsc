...
contract BabyPHB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyPHB";
    string private _symbol = "BPHB";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x24953F3649e8D34663bE7d720902D2a659771360); 
    address payable public BurnedWalletAddress = payable(0x24953F3649e8D34663bE7d720902D2a659771360); 
