...
contract JackFrost is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Happy Token";
    ...
    address payable public marketingWalletAddress = payable(0x6999d3f68B9E5E17bD25eBB7C6fc02b3a832dF29); // Marketing Address
    address payable public teamWalletAddress = payable(0xfdA3a3bc7f18a5be834BF45Aefd436f3b7A79C46); // Team Address
