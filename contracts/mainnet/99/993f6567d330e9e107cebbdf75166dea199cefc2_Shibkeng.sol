...
contract Shibkeng is ERC20, Ownable {
    ...
    constructor() payable {
        ...
        uint256 totalSupply = 1e12 * 10 * 1e18;
        _name="Shibkeng";
        _symbol="ShibK";
        maxTxnAmount = totalSupply * 3 / 1000;
        ...
        super._transfer(address(this), owner(), (totalSupply*5)/100);
    }
