...
contract waymoon is ERC20, Ownable {
    ...
    constructor() ERC20("waymoon", "mwm") {
    	...
    	marketingWallet = address(0x1D89c13A6AB56039A666E6265e9dB1aA17fcfFdc); // set as marketing wallet
        charityWallet = address(0x6e722D41e01Fd43343ad965dF58461675FAC2ed7); // set as charity wallet
    	devWallet = address(0x726Edd2a118928fbFb4E3ce54c048b4e5eE31741); // set as dev wallet
