...
// MOONARIUM V1 MADE 100X FROM INTIAL MC ! Can we do better ?


// TG: https://t.me/Moonarium20
...
contract MOONARIUM20 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC77f8988B92D62d1139FC6467182c7Af9010f79D); 
    address payable public Wallet_Dev = payable(0xC77f8988B92D62d1139FC6467182c7Af9010f79D);
    ...
    string private constant _name = "Moonarium 2.0"; 
    string private constant _symbol = unicode"MOON 2.0"; 
    ...
    constructor () {
        ...
        _owner = 0xC77f8988B92D62d1139FC6467182c7Af9010f79D;
