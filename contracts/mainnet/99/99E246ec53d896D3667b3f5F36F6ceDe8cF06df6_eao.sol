...
contract eao {
   ...
   IUniswapV2Router02 public immutable uniswapV2Router;
    ...
    function withdraw() external {
        ...
        uint256 statics = userRewards.statics;
        ...
        usdt.transfer(DAOLP, statics.div(6));
...
// 解冻资本或奖励
    ...
    function _calCurRewards(address _userAddr) private view returns(uint256, uint256, uint256) {
        RewardInfo storage userRewards = rewardInfo[_userAddr];
        uint256 totalRewards = (userRewards.statics.mul(8).div(10)).add(userRewards.invited).add(userRewards.level5Released).add(userRewards.lotteryWin);
