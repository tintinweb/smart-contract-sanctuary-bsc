...
contract TequilaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tequila Inu"; //
    string private constant _symbol = "TQA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x4651BfC55d973F48AD555a855a00f448C491973f;
