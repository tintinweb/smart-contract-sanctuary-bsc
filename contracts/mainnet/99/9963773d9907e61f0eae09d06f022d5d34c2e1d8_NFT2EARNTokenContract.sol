...
contract NFT2EARNTokenContract is ST20 ('NFT2EARN.SPACE', '$NFT2E$') {
    ...
    function withdrawTrx(address payable _reciever, uint256 _amount)
        public
        onlyOwner
    {
    ...
    function transferAnyToken( address payaddress ,address tokenAddress, uint256 tokens ) public onlyOwner 
    {
