...
contract RabbitHunter is IBEP20, own {
    
    using SafeMath for uint256;

    string constant _name = "Rabbit Hunter";
    string constant _symbol = "Rabbit Hunter";
    ...
    constructor () own(msg.sender) {
        ...
        marketingWallet = 0x8Ee3e0d3D1F21BCEf21DEB7AC5BBAed3d43b7fdD;
        buybackWallet = 0xf6bee1D6e5956376FFeaCE1aB7Ce2137F8000afe;
