...
/**
Telegram : https://t.me/Proofofmemesfloki
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB86Ef1797ee3DBD53c98D78FBD2e0f093c65B574; // owner address
...
contract ProofofMemesFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof of Memes Floki";
    string private _symbol = "POMF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB86Ef1797ee3DBD53c98D78FBD2e0f093c65B574); // Marketing Address
    address payable public teamWalletAddress = payable(0xB86Ef1797ee3DBD53c98D78FBD2e0f093c65B574); // Team Address
