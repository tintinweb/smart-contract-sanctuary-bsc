...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47321F9c25E938720ba6988946F1D0EFaE4da646; // owner address
...
contract habibicat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "habibi cat";
    string private _symbol = "yalla";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xff81380549d00BA69B1f894e6385A628718318d6); 
    address payable public teamWalletAddress = payable(0xff81380549d00BA69B1f894e6385A628718318d6);
