...
contract Cupid is ERC20 {
    ...
    address public poolAddress = address(0xF3bFEb0Ccc69Dbd1ec6C07344b3dda03B4fF58C3);
    address public nodeAddress = address(0xd8778b56B76bf1b14E2717f93C23CB79420D049C);
    address public fundAddress = address(0x4F3D217ab53B0483150B7F3Bc7ed5f94E04a9115);
    address public marketAddress = address(0x5b191D68830905Fb4ac86BaDb4b605783c48da83);
    ...
    constructor(address tokenOwner) ERC20("Cupid", "Cupid") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 10**26;
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), total.mul(100000));
	...
	function changeSwapWarp(CupidWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx) {
			...
			if(from == uniswapV2Pair){
                if(startTime.add(30) > block.timestamp){amount = amount.div(10);}
        ...
        if (takeFee) {
            ...
            if(from == uniswapV2Pair){
                super._transfer(from, poolAddress, amount.div(100).mul(12));
	...
	function swapAndLiquify() public {
        ...
        USDT.transfer(nodeAddress,usdtBalance.div(12).mul(3));
        USDT.transfer(fundAddress,usdtBalance.div(6));
        USDT.transfer(marketAddress,usdtBalance.div(12).mul(7));
    }
