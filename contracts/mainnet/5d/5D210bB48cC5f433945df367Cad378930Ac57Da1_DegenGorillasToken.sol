...
contract DegenGorillasToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0x676FdBc235F2871d84350789Ffa34afCa2fbDef6;

    string constant _name = "DegenGorillasToken";    
    string constant _symbol = "DGT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);

    uint256 public _maxTxAmount = ( _totalSupply * 49 ) / 100;

    uint256 public _maxWalletToken = ( _totalSupply * 49 ) / 100;  
