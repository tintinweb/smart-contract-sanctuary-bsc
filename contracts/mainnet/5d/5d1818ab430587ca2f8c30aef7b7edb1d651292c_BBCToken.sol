...
/* BBCToken -   Best reflection Meme token with massive rewards on BSC.
...
contract BBCToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x562a33FaBfB4aC3D4cD0070811012A0Fc60AFB6c); // Marketing Address
    address payable public charityAddress = payable(0x562a33FaBfB4aC3D4cD0070811012A0Fc60AFB6c); // Charity/Dev Address
