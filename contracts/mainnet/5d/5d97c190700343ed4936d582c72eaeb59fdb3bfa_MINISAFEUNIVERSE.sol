...
contract MINISAFEUNIVERSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Safe Universe";
    string private _symbol = "MSFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9167faaBf863108f6F97A6e2c6bf06579d2bc87b); 
    address payable public buyBackWalletAddress = payable(0xceCb5c7B7Ec0C15483A890aE4343Ba59Cb95b180);
