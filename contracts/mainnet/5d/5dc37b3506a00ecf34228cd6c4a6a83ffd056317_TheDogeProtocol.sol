...
The next Doge is here in BSC Space.
Aiming to be a community-driven project with bullish utilities on-board.
...
contract TheDogeProtocol is IBEP20, Auth {
    ...
    string constant _name = "The Doge Protocol";
    string constant _symbol = "TDP";
