...
contract SHINJIFLOKI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shinjiru Floki";
    string constant _symbol = "SHINJIFLOKI";
