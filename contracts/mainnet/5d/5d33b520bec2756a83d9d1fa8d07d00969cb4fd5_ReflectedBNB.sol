...
contract ReflectedBNB is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ReflectedBNB", "$RBNB") {
        BNBRewardsFee = 5;
        liquidityFee = 2;
        extraFeeOnSell = 1;
        marketingFee = 3;
        marketingWallet = payable(0x3FC7bCd8fc5fE1D45d100160406bDA1e37fDEC3A);
