...
contract MoDaShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoDaShib";
    string private _symbol = "MoDaShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x94FC855FC1f27BB8083A7FA0C2A113ba6cDcA364);
    address payable public teamWalletAddress = payable(0x94FC855FC1f27BB8083A7FA0C2A113ba6cDcA364);
