...
contract MikuShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mikushiba";
    string private _symbol = "Mikushiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA7C5a766FbBBc789B871FDa3abD547E34aB5759E);
    address payable public BuyBackWalletAddress = payable(0xA7C5a766FbBBc789B871FDa3abD547E34aB5759E);
