...
contract Fedoracoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x478fbC68bE43A6267d38FAd2D3490968d1E730B8); // Marketing Address
    ...
    uint256 private _tTotal = 5000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fedoracoin";
    ...
    uint256 public _maxTxAmount = 5000000000 * 10**2 * 10**9;
