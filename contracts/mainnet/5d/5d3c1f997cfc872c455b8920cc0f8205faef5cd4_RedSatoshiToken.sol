...
contract RedSatoshiToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "RedSatoshiToken"; // 
    string private constant _symbol = "$RST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x81899f11C37b02E5148951C0604018fA408262c6;
