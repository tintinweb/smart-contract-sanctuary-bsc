...
contract BMWFLOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BMW Floki";
    string private _symbol = "BMWFLOKI";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xa3954a700842b84cF7e377A08928AB9d4d1083b3); // Buy Back Address
