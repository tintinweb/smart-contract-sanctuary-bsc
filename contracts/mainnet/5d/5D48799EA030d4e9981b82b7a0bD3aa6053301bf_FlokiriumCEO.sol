...
contract FlokiriumCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flokirium CEO";
    string private constant _symbol = "FLOKIRIUMCEO";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 420000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 12600000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 12600000000000000 * 10**_decimals;
