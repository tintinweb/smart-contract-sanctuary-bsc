...
contract streetshark is Context, IERC20, Ownable {
    ...
    string private constant _name = "Street Shark"; // 
    string private constant _symbol = "$Street Shark"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x03B54745Fa30AADa3dc978998F8986DcBC51b499;
