...
contract KanyaWestBear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KanyaWestBear ";
    ...
    address payable private marketingWalletAddress = payable(0x3A7B8773a9Fb7f444b48bd23D8251CdC16E4dB64);
    address payable public KanyaWestWalletAddress = payable(0x3A7B8773a9Fb7f444b48bd23D8251CdC16E4dB64);
    ...
    function setTeamWalletAddress(address newAddress) external onlyOwner() {
        KanyaWestWalletAddress = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(KanyaWestWalletAddress, amountBNBTeam);
