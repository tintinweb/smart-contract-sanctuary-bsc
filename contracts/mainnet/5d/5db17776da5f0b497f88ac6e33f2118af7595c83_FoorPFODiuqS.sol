...
Website: https://www.foorpfodiuqs.net/

Alpha Play.
ThE tEam is prEparEd for a big gamE.Our tEam, which has madE many launchEs bEforE, is strongEr this timE.WE carEfully arrangE all thE dEtails so that you can makE rEliablE purchasEs and salEs.No prE-salEs no tEam wallEts.All wE want is for you to support us and sprEad it.WE wish you all a good timE. WElcomE to thE gamE.
...
contract FoorPFODiuqS is IBEP20, Auth {
    ...
    address DEV = 0x07D78462909951c7df98BeAc59F21Ab7D4603808;
    ...
    string constant _symbol = "FoorPFoDiuqS";
