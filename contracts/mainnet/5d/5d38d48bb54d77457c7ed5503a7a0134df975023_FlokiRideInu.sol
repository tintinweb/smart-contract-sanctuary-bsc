...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe0066d3393D168F75Cb38e3EEc05712BC808049A; // owner address
...
contract FlokiRideInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiRide Inu";
    string private _symbol = "$FRI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a7A40EE18bE08DF1B699E4c92ff473A194F38ED); // Marketing Address
    address payable public teamWalletAddress = payable(0x9a7A40EE18bE08DF1B699E4c92ff473A194F38ED); // Team Address
