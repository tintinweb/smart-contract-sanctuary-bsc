...
contract YHToken is Ownable, ERC20 {
    ...
    function init() public onlyOwner {
        ...
        _walletConsensusFunds = 0x656754F222d982953FF9D92e9649295621A06004;
        _walletSuperNode = 0x097dBDb47c45EfA40140E4EfE112ED0aC635656b;
    ...
    function _transferWithBuyFee(
        ...
        for(uint8 i = 0; i < 5; i ++) {
            ...
            if(recommender == address(0)) {
                _transfer(from, 0xB6786EEd71C98ad362e6B964fd9effe46cD94258, feeAmounts[i]);
            } else {
