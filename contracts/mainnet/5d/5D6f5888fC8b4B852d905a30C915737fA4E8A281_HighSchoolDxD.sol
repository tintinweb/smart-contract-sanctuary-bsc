...
contract HighSchoolDxD is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8974812cdbB29eFc4b6Fc5A4F5b76D1FFaDdcf50;

    string private constant _name = "High School DxD";
    string private constant _symbol = "DxD";
    ...
    Taxes public taxes = Taxes(2,4,3,0);
