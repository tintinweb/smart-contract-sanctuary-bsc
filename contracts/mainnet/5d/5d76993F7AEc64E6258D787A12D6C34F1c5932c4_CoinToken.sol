...
/*        CoinToken 
            Telegram : https://t.me/Goatgoldcoin
            Webiste : https://goatgold.org/
*/
...
contract CoinToken is Context, IERC20 { 
    ...
    modifier onlyOwner() {
        require(Dev_Wallet == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    address payable public Marketing_Wallet = payable(0x9b40B7E6318A7F98765A7B39F17149b042745996);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**9 * 10**_decimals;
    string private constant _name = "Goat Gold"; 
    ...
    function TradingOption() public onlyOwner virtual {
