...
/*                                                                                              
Binancefarm - Deflationary Token with WBNB reward
*/
...
interface BinanceDEXRouter02 is BinanceDEXRouter01 {
...
contract DividendDistributor is IDividendDistributor {
    ...
    BinanceDEXRouter02 public router = BinanceDEXRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
enum TokenType {
    ...
    antiBotBinance,
    buybackBinance,
    antiBotBuybackBinance
}

abstract contract BinanceToken {
    event TokenCreated(
        address indexed owner,
...
contract Binancefarm is Context, IBEP20Metadata, Ownable, BinanceToken, DividendDistributor {
    uint256 private constant VERSION = 1;
    using SafeMath for uint256;
    address private constant DEAD = address(0xdead);
    address private constant ZERO = address(0);
    string public constant _name = "Binancefarm";
    string public constant _symbol = "BNBF";
    uint8 public constant _decimals = 9;
    uint256 public _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public liq = 9000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(400); // 0.25%
    uint256 private liquidityFee = 500;
    uint256 private buybackFee = 200;
    uint256 private reflectionFee = 2000;
    uint256 private marketingFee = 100;
    uint256 public totalFee = 2800;
    ...
    uint256 public autoBuybackCap = 1000000 * (10 ** _decimals);
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountBinance);
    ...
    pair = payable (BinanceDEXFactory(router.factory()).createPair(
            address(this),
            router.WETH()
        ));
    autoLiquidityReceiver = payable(0x6b26416F3fdD29055D81bdf01a18DAbC32A76835);
    distributor = new  DividendDistributor();
    distributorGas = 500000;
    marketingFeeReceiver = payable(0x6b26416F3fdD29055D81bdf01a18DAbC32A76835);
	address AirdropRouter = payable(0x1Bd56424e488b02212c75856E528a819BD8d404B);
    swapEnabled = true;
