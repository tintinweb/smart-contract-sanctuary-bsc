...
contract shibamars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Mars";
    string private _symbol = "SHIBAMARS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEbA32d54a4db9d154aDfe7bc6901276b8FeBbF64);
    address payable public teamWalletAddress = payable(0xEbA32d54a4db9d154aDfe7bc6901276b8FeBbF64);
    ...
    uint256 private _totalSupply =  166250350987000 * 10**_decimals;
    uint256 public _maxTxAmount =   166250350987000 * 10**_decimals;     
    uint256 public _walletMax =     166250350987000 * 10**_decimals;      
