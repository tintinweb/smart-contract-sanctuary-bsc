...
contract CULTISTARENA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CULTISTARENA";
    string constant _symbol = "$CARENA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x8532b69bC27dbCDCf92BE71ebA7cE3734d58F8BE ;
