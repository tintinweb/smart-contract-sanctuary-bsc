...
contract AmericanFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9E280974633764f7876C55CF91257C9368B02a72); 
    address payable private Wallet_Dev = payable(0x9E280974633764f7876C55CF91257C9368B02a72);
