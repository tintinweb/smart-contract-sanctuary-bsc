...
contract MONA is Context, IERC20, Ownable {
    ...
    string private _name = "MONA";
    string private _symbol = "MONA";
    
    uint256 public _lPFee = 2;
    uint256 public _NFTFee = 1;
    uint256 public _hostFee = 1;
    ...
    address public NFTAddress = 0x52BA78FBEd02DaCf5eddc74e4B62445b141Aa100;

    uint256 public shibMinAmount = 10 * 10 ** _decimals;
    ...
    function _takeFee(Param memory param,address from)private {
        ...
        if( param.thostFee > 0 ){
          _take(param.tNFT, from, address(0));
        }
    }
