...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5991277779AD799E7B33C175541ed80668A3D602; // owner address
...
contract SHIBALLIONAIRE is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIBALLIONAIRE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5991277779AD799E7B33C175541ed80668A3D602); // Marketing Address
    address payable public teamWalletAddress = payable(0x5991277779AD799E7B33C175541ed80668A3D602); // Team Address
