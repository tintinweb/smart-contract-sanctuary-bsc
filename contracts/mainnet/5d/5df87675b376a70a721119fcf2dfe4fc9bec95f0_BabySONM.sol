...
contract BabySONM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySONM";
    string private _symbol = "BSNM";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x3E23c1C9Ab0C8CBc2b5E4983b4D30F49AfeedE5F); 
    address payable public BurnedWalletAddress = payable(0x3E23c1C9Ab0C8CBc2b5E4983b4D30F49AfeedE5F); 
    ...
    uint256 private _totalSupply = 44400000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 4440 * 10**_decimals; 
