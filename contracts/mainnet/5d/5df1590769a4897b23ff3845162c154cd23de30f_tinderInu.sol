...
// tinderInu - show your love and go 69!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $BUSD reward asset
...
contract tinderInu is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD                            = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // $BUSD reward asset
    address WBNB                            = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD                            = 0x000000000000000000000000000000000000dEaD;
    address ZERO                            = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver     = 0x1E8e24dDeB810a47D137F085DA31c5374A401f28;

    address private autoLiquidityReceiver;
    address private devFeeReceiver;

    string constant _name                   = "tinderInu";
    string constant _symbol                 = "TININU";
    uint8 constant _decimals                = 9;

    uint256 _totalSupply                    = 69 * (10 ** _decimals); 

    uint256 public _maxBuyTxAmount          = _totalSupply / 50;    // 2%
    uint256 public _maxSellTxAmount         = _totalSupply / 50;    // 2%
    ...
    function swapBack() internal swapping {
        ...
        require(successMarketing, "marketing receiver rejected BNB transfer");
        require(successDev, "dev receiver rejected BNB transfer");
    ...
    function triggerManualBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
        uint256 amountWithDecimals = amount * (10 ** 9);
    ...
    function setBuyTxLimitInPercent(uint256 amount) external authorized {
        _maxBuyTxAmount = amount.mul(10**_decimals);
    }

    function setSellTxLimitInPercent(uint256 amount) external authorized {
        _maxSellTxAmount = amount.mul(10**_decimals);
    }
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy,  uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        require(totalFeeBuy < feeDenominator/5, "Fees cannot be more than 20%");
    }
