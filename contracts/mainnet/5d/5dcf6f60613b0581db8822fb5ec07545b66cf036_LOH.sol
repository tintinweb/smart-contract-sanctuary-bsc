...
contract LOH is ERC20 {
	...
	address payable _fundAddress = payable(address(0xBc14e51D4bAdfD9bBeF60e5C37f6FD8e204EA01B));
    ...
    constructor(address tokenOwner) ERC20("Light of hope", "LOH") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, _fundAddress, amount.div(50));
