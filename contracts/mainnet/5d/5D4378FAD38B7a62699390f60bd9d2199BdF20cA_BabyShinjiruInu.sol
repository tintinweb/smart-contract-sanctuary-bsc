...
contract BabyShinjiruInu is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 800000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 24000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 24000000000000 * 10**_decimals;
