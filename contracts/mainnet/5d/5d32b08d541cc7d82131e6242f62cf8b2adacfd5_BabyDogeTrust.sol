...
contract BabyDogeTrust is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Baby DogeTrust';
    string private constant _symbol = 'BabyDT';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals;//equals 100 000 000 tokens
    ...
    uint256 public gasLimit = 8100000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0xBdd214C5FCDAd471a82cc6e24FFfF8234eD02BE9);
    address public Marketing=payable(0x3c425510ABA3FF347BA6Fb2170a9CcDCba302690);
    //MainNet
	...
	uint256 private MaxBuy = 15 * 10**_decimals;
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0xBdd214C5FCDAd471a82cc6e24FFfF8234eD02BE9; //CAKE Rewards
    ...
    uint256 currentAmountToSwap = 3 * 10**_decimals;
