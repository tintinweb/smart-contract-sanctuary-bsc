...
contract FreeSpeech is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 1_200_000_000 * 10**9; //1.2 Billion
    ...
    address payable public marketingWallet =  payable(0xB73B7B1EEdAfeE70D18bc76c9423E0bAc4E1C3c2);
    address payable public TeamWallet =  payable(0x5Ce7Ff59629f6625Cc4D0B5D4d004E45dcfB7d3A);
