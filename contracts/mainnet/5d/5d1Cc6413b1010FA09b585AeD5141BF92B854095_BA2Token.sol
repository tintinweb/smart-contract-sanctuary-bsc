...
contract BA2Token is IERC20, Ownable {
    ...
    address private projectAddress = 0x60D67C8Ec97fc008184de58D89df561D03C89792;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        toAddress = to;  
        // LP分红
         if(_tOwned[address(this)] >= 1 * 100 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 999 * 10**4 * 10**9)_burnFee = 0;
