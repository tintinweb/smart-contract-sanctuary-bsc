...
/**
 * 
    Token : Make Memes Not War
    Website : https://www.makememesnotwar.org/
...
contract Ownable is Context {
    ...
    // MMNW - Received from core Constructor
    constructor (address initialOwner) {
        _owner = initialOwner;
        emit OwnershipTransferred(address(0), initialOwner);
    }

    // Initialized by MMNW constructor
...
contract MMNW is Context, IBEP20, Ownable {
    ...
    address public _marketWallet = 0xBDE69C61ED73398bdDeceA31C73824e06Ea247ba;
    address public _devWallet = 0x44CB53C97c5B69E8b45A905AA509047F9dDe930e;
    address public _reliefWallet = 0x9A2dF923Cb0509bebD6F1A8dB3b807AC36F8844B;
    ...
    string private _name     = "MakeMemesNotWar";
    string private _symbol   = "MMNW";
    uint8 private  _decimals = 9;
    bool public _reliefDay = false;
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        _isExcludedFromFee[_reliefWallet]     = true;
    ...
    function setReliefWallet(address reliefWallet) external onlyOwner {
        _reliefWallet = reliefWallet;
    }
    ...
    function setReliefDay(bool _val) external onlyOwner {
        _reliefDay = _val;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        bnbForLiquidity = bnbForLiquidity.sub(devFee);
