...
contract KAKICEO is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("KAKICEO", "KAKICEO") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
			...
			if(from == uniswapV2Pair){
                ...
                if(startTime.add(60) > block.timestamp){require(balanceOf(to).add(amount) <= 20000 * 10**26,"max amount");}
