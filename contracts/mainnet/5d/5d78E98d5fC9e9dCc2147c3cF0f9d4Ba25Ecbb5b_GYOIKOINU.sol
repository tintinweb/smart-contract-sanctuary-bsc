...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f54c654D5813e94835Dd67c8BC0C2DA6047D49a; // owner address
...
contract GYOIKOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GYOIKO INU";
    string private _symbol = "GYOIKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f54c654D5813e94835Dd67c8BC0C2DA6047D49a); // Marketing Address
    address payable public teamWalletAddress = payable(0xC4385474Ca7C36a0278A9b6CE735Af372fc7F353); // Team Address
