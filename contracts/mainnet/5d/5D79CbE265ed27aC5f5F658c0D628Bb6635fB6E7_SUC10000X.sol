...
contract SUC10000X is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUC 10000X";
    string private _symbol = "SUC 10000X";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeFaa3f9856DF5B4DC18041199fCc28eE151A24b1);
    address payable public teamWalletAddress = payable(0x16DFE4412D71EfaE8BE2429634CDF9643E6A05F1);
