...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xE85aFCcDaFBE7F2B096f268e31ccE3da8dA2990A); // aBNBc rewards
...
contract cankr is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "New Community ankr";
    string constant _symbol = "cankr";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xE85aFCcDaFBE7F2B096f268e31ccE3da8dA2990A; // aBNBc rewards
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x753757ceB12AF2bFf1793158cA538b705e7d4149;  
        anothermarketingWallet = 0x753757ceB12AF2bFf1793158cA538b705e7d4149;
