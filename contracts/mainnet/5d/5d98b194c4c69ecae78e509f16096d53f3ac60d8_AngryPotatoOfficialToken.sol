...
// https://t.me/AngryPotatoPortal
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface AngryPotatoOfficial {
...
contract AngryPotatoOfficialToken is AngryPotatoOfficial {
    ...
    string public override name = unicode"Angry Potato 🥔";
    string public override symbol = unicode"AngryPotato";
