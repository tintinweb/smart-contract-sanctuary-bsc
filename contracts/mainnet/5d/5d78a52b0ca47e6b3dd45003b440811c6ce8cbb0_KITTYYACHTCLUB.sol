...
contract KITTYYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KITTY YACHT CLUB";
    string private _symbol = "KYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F41749f6756A3d91d19e04080cC16Da31335FEC); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x45b9D80F64313f15C05A7dC932E4b30EDC70Fe2F); // Developmental Address
