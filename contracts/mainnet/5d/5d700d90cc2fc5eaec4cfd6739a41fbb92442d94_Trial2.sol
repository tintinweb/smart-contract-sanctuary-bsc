...
contract Trial2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hardereer";
    string private constant _symbol = "Tryy";
    ...
    function _transfer(
        ...
        if (takeFee) {
            require(
                        tradingOpen = true, "Trading not open yet"
                );
