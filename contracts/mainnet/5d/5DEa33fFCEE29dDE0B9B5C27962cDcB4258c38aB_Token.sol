...
contract Token is Context, ITRC20, Ownable {
    ...
    constructor () public {
        ...
        _fundAddress = 0xbEf5F731B1249e0f0330b54a1B775BccdFb9686c;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[0xbEf5F731B1249e0f0330b54a1B775BccdFb9686c] = true;
        _isExcludedFromFee[0x152a91b937392581f38fEA80cA58DE24d82C6397] = true;

        _balances[0x152a91b937392581f38fEA80cA58DE24d82C6397] = _totalSupply;

        emit Transfer(address(0), 0x152a91b937392581f38fEA80cA58DE24d82C6397, _totalSupply);
    }
