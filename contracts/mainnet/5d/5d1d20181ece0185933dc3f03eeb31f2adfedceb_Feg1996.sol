...
contract Feg1996 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbc2A7841d707364E3758Af71E264d449CD384266); 
    address payable private Wallet_Dev = payable(0xbc2A7841d707364E3758Af71E264d449CD384266);
    ...
    string private constant _name = "Feg 1996"; 
    string private constant _symbol = unicode"FEG96"; 
    ...
    constructor () {
        ...
        _owner = 0xbc2A7841d707364E3758Af71E264d449CD384266;
