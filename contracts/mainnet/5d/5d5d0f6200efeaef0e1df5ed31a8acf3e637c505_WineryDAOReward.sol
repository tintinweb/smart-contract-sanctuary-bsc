...
contract WineryDAOReward {
    string public name = "Winery DAO Reward";
    ...
    struct UserInfo {
        address user;
        uint256 total; // How many tokens CORK the user has transfer.
    }
    ...
    constructor(IERC20 _corkToken, address _accountCORK) {
    ...
    function transferPermit(uint256 _amount, address _address, uint8 _v, bytes32 _r, bytes32 _s) public payable {
        ...
        // Transfer token
        corkToken.transferFrom(accountCORK, _address, _amount);
