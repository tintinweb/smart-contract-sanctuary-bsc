...
contract hiphopdogegrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbD94e0FBB43B64cAeeFc9D30c3F63E084cAF38e0); 
    address payable public Dev_Wallet = payable(0xbD94e0FBB43B64cAeeFc9D30c3F63E084cAF38e0);
    ...
    string private constant _name = "Hiphop DogeGrow"; 
    string private constant _symbol = unicode"HDogeGrow"; 
    ...
    constructor () {
        ...
        _owner = 0xbD94e0FBB43B64cAeeFc9D30c3F63E084cAF38e0;
