...
contract HeroStake is Ownable, ReentrancyGuard {
    ...
    function setRANDNUM(uint256 _number) public onlyOwner {
      RANDNUM = _number;
    }
    ...
    function bindParent(address parent) public returns (bool) {
      ...
      require(_isCardFromFee[parent] || parent == owner(), "ERROR The superior did not participate in IDO");
