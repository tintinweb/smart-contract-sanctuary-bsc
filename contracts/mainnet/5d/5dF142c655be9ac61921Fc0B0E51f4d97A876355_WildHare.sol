...
contract WildHare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address _ma) public ERC20("WildHare", "WildHare") {
    ...
    function SetSwapTokensAtAmount(uint amount) public {
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("HAM_Dividend_Tracker", "HAM_Dividend_Tracker") {
        claimWait = 1200;
