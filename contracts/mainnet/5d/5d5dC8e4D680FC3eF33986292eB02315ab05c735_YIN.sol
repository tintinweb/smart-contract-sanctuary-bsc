...
contract YIN is ERC20, Ownable {
    ...
    YINDividendTracker public dividendTracker;
    ...
    constructor() ERC20("YIN", "YIN") {
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new YINDividendTracker(
            payable(this),
            router,
...
contract YINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "YIN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "YIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main YIN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(YINContract);

            uint256 prevBalance = YINContract.balanceOf(address(this));
            ...
            {
                uint256 received = YINContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    YINContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
