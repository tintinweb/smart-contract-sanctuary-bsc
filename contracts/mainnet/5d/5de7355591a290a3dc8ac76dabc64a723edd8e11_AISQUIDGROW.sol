...
Telegram: https://t.me/AISquidGrow_official
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x4C8E4a1AfA4464B5459A121C7ed86f7CFB1be0eA;
...
contract AISQUIDGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI Squid Grow"; // 
    string private constant _symbol = "$AISG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x4C8E4a1AfA4464B5459A121C7ed86f7CFB1be0eA);
