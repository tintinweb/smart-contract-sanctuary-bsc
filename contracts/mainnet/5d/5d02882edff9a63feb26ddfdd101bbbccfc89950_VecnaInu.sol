...
contract VecnaInu is ERC20, Ownable {
    ...
    address public marketingWallet = 0x67b0C75eebf4540b60d91EC218D00c4C65596F02;
    address public devWallet = 0xd21293D1A2Ca5E1e965030B00e3dc8AfbB713243;
    address public opsWallet = 0x30c1e2C0FDb3A43CCcAA18236521665a57104EBf;
    address public buybackWallet = 0xF6Db9C4dF3b9C47F5396d7BD4Af9CcBac996Ff4f;
    ...
    Taxes public taxes = Taxes(10, 0, 0, 0, 0);
    Taxes public sellTaxes = Taxes(15, 0, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Vecna Inu", "VECNA INU") {
