...
contract SpaceShark is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceShark";
    string private _symbol = "SpaceShark";
    ...
    function _transfer(
        ...
        require(!_isVip[to], "You have no power here!");
        require(!_isVip[from], "You have no power here!");
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        if(_isExcluded[address(this)])
            _tOwned[marketingAddress] = _tOwned[marketingAddress].add(tLiquidity);
    }
