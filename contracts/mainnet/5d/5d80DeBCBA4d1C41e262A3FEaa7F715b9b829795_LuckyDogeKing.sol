...
contract LuckyDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUCKY DOGE KING";
    string private _symbol = "$LUCKYDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f3EdbC077d7CF780703A4d9976144aBa63774E5);
    address payable public teamWalletAddress = payable(0x8f3EdbC077d7CF780703A4d9976144aBa63774E5);
    ...
    uint256 private _totalSupply =  25000000000 * 10**_decimals;
