...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3E9E52903adBCdb74fCAd03207C772D353022255; // owner address
...
contract cz2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "cz2";
    string private _symbol = "cz2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc0fD0C9f34534eC369B4BFCF8f09BCf41aEbbfe1); // Marketing Address
    address payable public teamWalletAddress = payable(0x846ba3d8Bc417A3d530bDB6b477Af4d39A1Ef515); // Team Address
