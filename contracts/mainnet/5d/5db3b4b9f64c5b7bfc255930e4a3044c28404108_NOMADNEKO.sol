...
Welcome to Nomad Neko
A Decentralized Meme Token with a hype of Nomad That Evolves into a Vibrant Ecosystem.
...
Telegram: https://t.me/NomadNekobsc
*/
...
contract NOMADNEKO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nomad Neko"; // 
    string private constant _symbol = "$NN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x88F09C8e4Fb8F78beF2Fa0cbF778a964d057bD9D;
