...
contract FUEL is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xB97c682795D9800410c9Bd311F526ca030088888);
    ...
    constructor() ERC20("Carrera Cartel", "Fuel") {
        ...
        */
        _createTokens(owner(), 10000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(overMinTokenBalance && !inSwap && to == uniswapV2Pair && swapEnabled) {
         ...
         // remove the fee if any account belongs to _isExcludedFromFee account
    ...
    function updateFee(uint256 _buyTax, uint256 _sellTax) public onlyOwner {
        require(_buyTax <= 6, "buy tax too high");
        buyTax = _buyTax;
        require(_sellTax <= 9, "sell tax too high");
        sellTax = _sellTax;
    }
