...
contract Super51 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x78C4936245bE92dB5e04c4Ab282Df064df1Abd9d;

    string constant _name = "Super 51";
    string constant _symbol = "SUPER51";
    ...
    uint256 public swapThreshold = _totalSupply * 92 / 10000;
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 70000}("");
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 70000}("");
