...
/* Token contract */
contract BabySDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x04CD4e55D3c278Ff773B933b8fb5620c09942357;
    ...
    // Name and symbol
    string constant _name = "BABY SAKURA DOGE";
    string constant _symbol = "BabySDoge";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100000 / 10000; // 100% 
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 100% 
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 100% 
