...
contract Honestlyfrog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Honestly frog";
    string private _symbol = "Honestly";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbf1522D9dED1bfaf2369366607F0594229ECEAAD); 
    address payable public BurnedWalletAddress = payable(0xbf1522D9dED1bfaf2369366607F0594229ECEAAD); 
