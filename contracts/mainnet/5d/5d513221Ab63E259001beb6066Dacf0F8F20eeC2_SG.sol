...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xF747B91a64BFD8D80909D766C46a9203FFD885f3;
...
contract SG is AbsToken {
    constructor() AbsToken(
        ...
        9,
        8888,
        address(0x3b4D25883f04576569391FB4484d81c6C3CD1d42),
        address(0xF747B91a64BFD8D80909D766C46a9203FFD885f3)
    ){
