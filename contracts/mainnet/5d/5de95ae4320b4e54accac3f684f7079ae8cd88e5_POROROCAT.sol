...
*/
 /** 
    PORORO CAT
    PORORO CAT is a new trendy on Twitter and TikTok!

    https://twitter.com/hashtag/PororoHilang?src=hashtag_click

    This cat is named Pororo, cute cat will list 3 items tonight, wait for it to come and grab it fast

    PororoCat is the next evolutionary Decentralized Finance (DeFi) with Twitter/Tiktok hyped token.

    Tokenomics
    Tax fee buy&sell 3% - Community driven!

    🔒Liquidty 1%
    💦Marketing 2%

// TG: https://t.me/PororoCatPortal
...
contract POROROCAT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x043c5Da7AAeC17615f72749a461A569B77AfDeA0;
 
    string constant _name = "PORORO CAT";
    string constant _symbol = "$PORORO";
