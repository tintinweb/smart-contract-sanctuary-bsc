...
/**
    ...
    DEGEN PLAY BASED ON HYPED APE COIN - 100% SAFU
    
 * Telegram: https://t.me/MegaApeCoin
*/
...
contract CieloCoin is IBEP20, Auth {
    ...
    string constant _name = "CieloCoin";
    string constant _symbol = "$CIELO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 4; 
    uint256 public _maxWalletSize = (_totalSupply * 3) / 4; 
    ...
    address private marketingFeeReceiver = 0x556DA422aDD52b4d2316EeF74DDB938F8A4FcD7C;
    address private buybackFeeReceiver = 0x556DA422aDD52b4d2316EeF74DDB938F8A4FcD7C;
    address private DevFeeReceiver = 0x556DA422aDD52b4d2316EeF74DDB938F8A4FcD7C;
    ...
    uint256 public swapThreshold = _totalSupply / 1 * 2; // 0.3%
    bool inSwap;
