...
contract SantaBoyStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xb8C10Ead5E4ADBb5Cc021f113bD6903a38D74338);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 25940778, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 25940778){
            return 0;
        }
    ...
    function updateApy(uint256 newApy) external onlyOwner {
        require(newApy <= 1000000000000, "APY must be below 10000%");
        updatePool(0);
        apy = newApy;
    }
