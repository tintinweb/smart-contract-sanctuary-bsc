...
Deflationary community token deployed in smart chain network to
Restore confidence back to Bsc space and prove bad devs wrong.
Charity token for all
...
Chat: https://t.me/SMT_01
Twitter: https://twitter.com/SmoothMoonToken/status/1546845308537249793?s=20&t=0lUbRbP8_JAehDLj4RnhYQ
*/
...
contract SMOOTHMOON is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xED4037371D671eeaB6A6879D84fA5f9DafE94aE6); 
    address payable public Wallet_Dev = payable(0x11141979c64c64F00015273Bd9E9449E6D39DD94);
    ...
    string private constant _name = "SMOOTH MOON TOKEN"; 
    ...
    constructor () {
        ...
        _owner = 0x11141979c64c64F00015273Bd9E9449E6D39DD94;
