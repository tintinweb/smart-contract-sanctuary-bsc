...
/*
🐇🐇🐰🐰WIKI RABBIT🐇🐇🐰🐰
YOUR FRIENDLY ONLINE WIKI ENCYCLOPEDIA
Join the Wiki Rabbit’s mission of providing 
reliable information that is both accurate and up-to-date.
*/
...
contract WIKIRABBIT is Context, WIKIRABBITBNB, Ownable {
    ...
    string private _name = 'WIKI RABBIT';
    string private _symbol = 'WIKI RABBIT';
