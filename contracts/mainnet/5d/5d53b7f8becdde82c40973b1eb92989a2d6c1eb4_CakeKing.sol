...
library Address{
 ...
 contract CakeKing is Context, IERC20, Ownable {
    ...
    string private constant _name = "CakeKing";
    string private constant _symbol = "CAKEKING";
    ...
    Taxes public sellTaxes = Taxes(0, 7, 2, 1);
