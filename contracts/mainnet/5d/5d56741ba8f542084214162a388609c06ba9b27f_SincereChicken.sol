...
contract SincereChicken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sincere Chicken";
    string private _symbol = "SChicken";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x349bEBbb7DcCa48277fb0242f3865f6b7bcd2085);
    address payable public teamWalletAddress = payable(0x1d4229F18657e712B4b5Cc0973DE6756591E5409);
