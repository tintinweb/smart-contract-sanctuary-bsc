...
/**
  ...
  Garlic Network - GARLIC Token
  The Garlic Project is a community-built library that uses Javascript and NodeJS software infrastructures.
  There are UI KIT and Backend practical codes created with Web3 and blockchain infrastructures in the library.
  www.garlic.network

  Twitter: @GarlicNetwork
  Telegram: @GarlicNetworkCommunity

  Fee Details;
  Auto Liquidity (LP Pool): 1%
  Marketing & Charity: 2%
...
contract GarlicNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Garlic Network";
    string private _symbol = "GARLIC";
    ...
    address public charityWallet = 0x6d351178A38Ed287cC04956B23904CB9CdC07f62;
