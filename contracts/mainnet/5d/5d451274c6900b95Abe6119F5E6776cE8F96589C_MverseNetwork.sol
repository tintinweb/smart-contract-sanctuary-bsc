...
Telegram : https://t.me/mversenetwork
Website : http://www.mverse.org/
*/
...
contract MverseNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mverse Network";
    string private _symbol = "MV";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x57556D43f913b2bC691Cd1e86fe088bEADaa2A3E); // Marketing Address
    address payable public teamWalletAddress = payable(0x57556D43f913b2bC691Cd1e86fe088bEADaa2A3E); // Team Address
