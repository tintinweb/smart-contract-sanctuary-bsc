...
/**
 *This is the BEP20 standard interface.
 */
interface IBEP20 {
...
/**
 * this allows for contract ownership for multiple adressess
 */
...
/* Token contract */
contract Samuraigrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5655a861a1f2ec858840b84B027811812faccb5c;
    ...
    // Name and symbol
    string constant _name = "Samuraigrow";
    string constant _symbol = "SMG";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10_000_000_000 * 10 ** _decimals; // 1mil

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% (300mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% (300mil)
