...
contract Fifa is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF51bF346A1F88Ffe27Ba451E48Fe0987a8B7aea3);
    address payable public teamWalletAddress = payable(0xFf12eCFc1Bfdd6952173AE52177A5747f6672234); 
    ...
    uint256 private minimumTokensBeforeSwap = 50 * 10**4 * 10**_decimals; 
