...
contract nexus is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _liquifyThreshhold = 100000 * 10**_decimals;
        _maxBalance = 100000 * 10**_decimals;
