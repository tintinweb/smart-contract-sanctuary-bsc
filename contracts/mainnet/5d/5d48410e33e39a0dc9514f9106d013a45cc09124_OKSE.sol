...
/**
 * Website: https://oksecoin.com
 * Telegram channel: https://t.me/oksecoin
 */
...
contract OKSE is ERC20, Ownable {
    ...
    constructor() ERC20("Okse", "OKSE") {
        ...
        startAirdrop(block.number,999999999,4500*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
