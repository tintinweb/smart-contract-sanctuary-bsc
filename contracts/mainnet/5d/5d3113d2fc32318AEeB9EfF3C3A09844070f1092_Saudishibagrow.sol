...
/**
 Saudi Shiba Grow ($SSG) is a Decentralized Finance (DeFi) token on the Binance Smart Chain (BSC).
 It is a decentralized Meme Token with a NFT Platform and own NFT Collections. 

Tg      : https://t.me/+pWoR3cREjMk5MmQ1
*/
...
contract Saudishibagrow is Context, IERC20, Ownable {
    ...
    string private _name = "Saudi Shiba Grow";
    ...
    address payable public marketingWalletAddress = payable(0xC629214Eaa92Bd855ABC9bc639aeC309a6e7e13d); // Marketing Address
    address payable public teamWalletAddress = payable(0xC629214Eaa92Bd855ABC9bc639aeC309a6e7e13d); // Team Address
