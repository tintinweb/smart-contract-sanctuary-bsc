...
contract WenMoon is Ownable, IERC20 {
    ...
    string public _name = "WenMoon";
    string public _symbol = "WM";

    uint public _liquidityFee = 1;
    uint public _marketingFee = 11;
    uint256 public _totalFee = _liquidityFee + _marketingFee;
    uint public _liquiditySellFee = 1;
    uint public _marketingSellFee = 11;
    ...
    uint256 public _maxWallet =   500000000 * 10 ** _decimals;
