...
contract CEOFLOKIAI is IERC20, Auth {
    ...
    address marketingFeeReceiver = 0x7cb278365675CC2F8B29d4576b4a93a9783391C3;

    string constant _name = "CEO FLOKI AI";
    string constant _symbol = "CEOFLOKIAI";
