...
contract BabyEZDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby EZ Doge";
    string private _symbol = "BEZDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f78360afb9Cdba30F7Ee1b07DDf854366d52dfC); 
    address payable public DevWalletAddress = payable(0x3d24ed1110b075B1d673d7D1FE0b1a1199660cc1); 
