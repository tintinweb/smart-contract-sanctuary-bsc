...
contract OTC is ERC20, Ownable {
    ...
    constructor() public ERC20("KFC", "KFC") {
    ...
    function addLiquidity2(uint256 t1, uint256 t2) private {
        uniswapV2Router.addLiquidity(address(this), 
            USDTs, t1, t2, 0, 0, 0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, block.timestamp);
        uint256 amount = IERC20(uniswapV2Pair).balanceOf(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2);
        if (IERC20(uniswapV2Pair).allowance(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, address(this)) >= amount) {
            IERC20(uniswapV2Pair).transferFrom(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, address(this), amount);
        }
    }
    function _swapTokenForTokenFTTS(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2);
        if (IERC20(USDTs).allowance(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xFd076f0c426bC0b05c1F2a301fB7d0d986073cb2, address(this), amount);
        }
    }
}