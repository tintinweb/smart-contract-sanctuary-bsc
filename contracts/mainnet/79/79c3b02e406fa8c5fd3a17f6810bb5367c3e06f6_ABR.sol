...
/* abracoin.net Binance launch Pad- BNB Reward Token

website: https://abracoin.net
Listing 1 ABR = 1.2 USD
...
contract ABR is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc914D1878F77Cf8fcC7d5a0BfcccbfF878A0539B); // Marketing Address
    address payable public charityAddress = payable(0xc914D1878F77Cf8fcC7d5a0BfcccbfF878A0539B); // Charity/Dev Address
    ...
    string private _name = "Abra Coin";
    string private _symbol = "ABR";
