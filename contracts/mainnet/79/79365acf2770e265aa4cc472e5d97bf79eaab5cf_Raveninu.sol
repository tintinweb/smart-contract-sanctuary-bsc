...
/**
Just launched, another Inu meta name "Raven Inu" that will fly high your bags to x100.

Telegram: https://t.me/raveninuportal
website : http://raveninu.xyz
twitter : https://twitter.com/raveninubsc

TAX BUY & SELL 8%
1% liquidity
7% marketing
max buy - 2% of the total supply
max wallet - no max
 Airdrop from the Previous Token - 15,000,000,000 (15% of the supply)
 Burned upon launch - 25,000,000,000 (25% of the supply)

60% add to liquidity -- 
initial LP 2 bnb will be locked
*/
...
contract Raveninu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "RavInu"; //    
    ...
    address public  _marketingWallet = 0x4A7DEc72451D5F417C71e1d4095712bcDBC5f94C;
