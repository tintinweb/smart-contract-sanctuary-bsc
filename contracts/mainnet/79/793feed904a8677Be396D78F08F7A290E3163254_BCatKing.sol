...
contract BCatKing
 is Context, IERC20, Ownable {
    ...
    string private _name = "BCatKing";
    string private _symbol = "BCatKing";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA28c8ADaE4C587CffEbd13B8Fe5731baf5414890));
        _anotherA = payable(address(0xA28c8ADaE4C587CffEbd13B8Fe5731baf5414890));
