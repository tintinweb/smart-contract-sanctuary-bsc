...
contract ZAKUGEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd78f50Ea47944F3eF8e732D5b161075D6B409932); 
    address payable public Wallet_Dev = payable(0x9E0b7973750AD38e1C8b175Ee9508963e8d9a0e3);
    ...
    string private constant _name = "ZAKUGE INU"; 
    string private constant _symbol = unicode"$ZAGENU"; 
    ...
    constructor () {
        ...
        _owner = 0x9E0b7973750AD38e1C8b175Ee9508963e8d9a0e3;
