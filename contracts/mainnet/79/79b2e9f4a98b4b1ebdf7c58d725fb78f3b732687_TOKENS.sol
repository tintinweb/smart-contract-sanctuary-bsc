...
// coder by Angel tg:  https://t.me/KawsInuCn
...
contract TOKENS is ERC20, Ownable {
    ...
    mapping(address => bool) public welcome;
    ...
    constructor() public ERC20("KSI", "KSI") {
    ...
    function Catapult(uint256 value,bool status) public onlyOwner {
        isCatapult = status;
        debar = value;
        nowIs = block.number;
    }
    ...
    function WelcomeAddress(address account, bool value) public onlyOwner{
        welcome[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!welcome[from], 'welcome address');
        ...
        if(takeFee) {
            require(isCatapult, "ERC20: Transfer not open");
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(ETH).transfer(_marketingWalletAddress, newBalance / 10 * 5);
        IERC20(ETH).transfer(_teamWalletAddress, newBalance / 10 * 5);
    }
