...
// Dependency file: contracts/vrf/CryptoDropSelectV4.sol
...
contract CryptoDropSelectV4 is VRFElementIdUint256 {
    using SafeERC20 for IERC20;
    using Address for address;
    ...
    function placeBet(Select _select, uint256 _vrfFee) external payable virtual nonReentrant whenNotPaused {
        require(uint8(_select) < 4, "CryptoDrop V4: invalid envelope");
        ...
        require(
            ...
            string(
                abi.encodePacked(
                    "CryptoDrop V4: Bet amount should be greater or equal than ",
        ...
        Bet memory bet = Bet("", block.number - 1, betAmount, _vrfFee, 0, "", _select);
...
// Root file: contracts/test/TestDropSelectV4.sol


pragma solidity ^0.8.0;

// import "contracts/vrf/CryptoDropSelectV4.sol";

contract TestDropSelectV4 is CryptoDropSelectV4 {
    constructor(address _vrfCoordinator, address _linkToken) CryptoDropSelectV4(_vrfCoordinator, _linkToken) {}
}