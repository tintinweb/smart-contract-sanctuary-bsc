...
contract MoiToken is ERC20, Ownable {
    ...
    uint256 public marketing1;
    uint256 public marketing2;
    uint256 public marketing3;
    ...
    constructor(
        ...
        receiveAddress = 0xD81D64cC4C16cC4439d0A21E42EB800FB9189618; 
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 shibAmoount = IERC20(address(this)).balanceOf(address(this));
    ...
    function lpDividendProcess(uint256 dividendAmount) internal {
        ...
        for (uint256 i = 0; i < lpHolderSet.length(); i++) {
            ...
            if(amount > 0){ 
                IERC20(address(this)).transfer(holder, amount ); 
