...
/__   \___  _ __   /   \___   __ _ 
 ...
 \/   \___/| .__/___,' \___/ \__, |
    ...
    Telegram: https://t.me/TopDogPortal
    Website : https://www.top-dog.tech/
*/
...
/* Token contract */
contract TopDog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "TopDog";
    string constant _symbol = "TopDog";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1Billion Token

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2 / 100; // 2% or 20000000 tokens
    uint256 public _maxSellTxAmount = _totalSupply * 2 / 100; // 2% or  20000000 tokens
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // 2% or 20000000 tokens
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require (amount <= balanceOf(msg.sender), "Insufficient Token");
