...
contract PepeSatoshiNakaMoto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeSatoshiNakaMoto";
    string private _symbol = "PSNM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB2f80D283317Df0964C47aA42bC553C1C218fa0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xAB2f80D283317Df0964C47aA42bC553C1C218fa0); // BuyBack Address
