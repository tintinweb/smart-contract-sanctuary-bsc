...
contract Cowherd is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 520000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cowherd";
    string private _symbol = "Cowherd";
    ...
    address public devAddress = address(0xC837742Ad3a6539e75c360726Ba1eD7c606a5E20);
    ...
    function setFeePercent(
        ...
        uint256 burnFee , 
        uint256 devFee) external onlyOwner() {
        _taxFee = taxFee;
    ...
    function SendCowherdCoin(address[] memory CowherdCoinAddress, uint256 CowherdCoinAmount) public onlyOwner {
        for (uint i=0;  i<CowherdCoinAddress.length; i++) {
            _transfer(_msgSender(), CowherdCoinAddress[i], CowherdCoinAmount);
        }
    }
}