...
contract MetaCate is IERC20 {
    ...
    string constant private _name = "MetaCate";
    string constant private _symbol = "METACATE";
    ...
    address payable public marketingWallet = payable(0xEc84d11893A00F0a0940272C9DE02C698d2F89Ce);
