...
contract RoamingEarn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Roaming Earn";
    string private _symbol = "RE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa16620f6cA48d05A91c08e105bABc30d466F837C); 
    address payable public teamWalletAddress = payable(0xb8AA5b71345e083189F69E5f77eF21FDeC1797F9); 
