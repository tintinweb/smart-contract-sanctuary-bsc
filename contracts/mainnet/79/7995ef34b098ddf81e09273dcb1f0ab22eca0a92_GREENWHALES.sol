...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE189763FFC26D273717543960B5e1f7298cfE43C; // owner address
...
contract GREENWHALES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GREEN WHALES";
    string private _symbol = "GW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbF93341cdBa7f9621cfDEe4b80C5c1Cd660C102B); // Marketing Address
    address payable public teamWalletAddress = payable(0x04B29fE89417412FA9D84d77b873c42baFf553D1); // Team Address
