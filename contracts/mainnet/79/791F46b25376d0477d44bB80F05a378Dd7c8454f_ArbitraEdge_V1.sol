...
contract ArbitraEdge_V1 is Ownable {
	...
	function checkSpenderApprovedToken(address _token, address _spender) external view returns (bool) {
	...
	function approveMaxSpender(address _token, address _spender, uint _amount) external onlyAdmin {
		require(_spenderTokenList[_token][_spender] == false, "ALREADY_APPROVED");
		...
		_spenderTokenList[_token][_spender] = true;
	}
