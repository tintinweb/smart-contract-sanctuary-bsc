...
SPDX-License-Identifier: UNLICENSED
 #BinancePizza
   ...
   Official channel https://t.me/binancepizza

   2% fee auto add to the liquidity pool to locked forever when selling
   3% fee Marketing

   
  Ownership to burn addresses to transfer #BinancePizza to the community and ensure it's 100% safe.
...
contract binancepizza is Context, IERC20, Ownable {
    ...
    address private _promoWallet = 0x027b5fc2dB3B9c6CA52690239Cd50809E07f104B;
