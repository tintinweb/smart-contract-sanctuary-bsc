...
/**
   DOGESHIBACHAIN is a decentralized autonomous organization of memecoin fans built on the newly created Binance Smart Chain.

   The DOGESHIBACHAIN will decide on buybacks, burns and liquidity pool additions in a decentralized manner.

   DOGESHIBACHAIN taxes will provide for marketing, buybacks and the liquidity pool.

   Taxes are 2% in and 40% out, In the First 30 Minutes. We will reduce the tax 5% every 1 hour

   THE FIRST DOGESHIBACHAIN Fairlaunch on Pinksale. 
   */
