...
contract Hub  is Context, IERC20, Ownable {
   ...
   // mapping(address => uint256) private _tOwned;
    ...
    address payable private _developmentAddress = payable(0x556770301F2c44ba143A355439C9Dc979C99e798); 
    address payable private _marketingAddress = payable(0x556770301F2c44ba143A355439C9Dc979C99e798);
    ...
    function removeLimits() external onlyOwner{
        _maxTxAmount = _tTotal *_decimals;
        _maxWalletSize = _tTotal *_decimals;
    }
