...
contract YGB is ERC20Detailed, Ownable {
    ...
    string public _name = "Yingbi";
    string public _symbol = "YGB";
    ...
    uint256 public clockInsuranceFundFee = 20;
    uint256 public sellFeel = 20;
    uint256 public sellFeet = 20;
    uint256 public sellFees = 20;
    uint256 public sellFeef = 20;
    ...
    constructor() ERC20Detailed("Yingbi", "YGB", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration	
        ...
        autoLiquidityReceiver = 0xEB37B1cbFBe3484E796bd68b8656D2A52b4dB94D; //Wallet 1
        treasuryReceiver = 0x34C4127488DD37F93cc6De61b19b72BC0Ba41C86; //Wallet 2
        clockInsuranceFundReceiver = 0x897abB406Eb3c4A224f6e66175ee872627FfDc4f; //Wallet 3
        firePit =0x5ef582801135CeB4B3da10e0b2Ee1C347434808f; //Wallet 4
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no YGB token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
