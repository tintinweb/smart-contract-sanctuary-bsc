...
/**
New Year’s day of 2022 still feels like yesterday. And now here we are, closing in on the end of the year.
With a new year comes new hope. And year-end is the best time to set new goals and intentions. 
MMXXIII will come as the biggest degen setting the bullrun as a new meta in BSC Space.
*/
...
contract MMXXIII is Context, IERC20, Ownable {
    ...
    string private _name = "MMXXIII";
    string private _symbol = unicode"𝕄𝕄𝕏𝕏𝕀𝕀𝕀";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x479Ee08B2C036b4d73EC13b5Ac63556535cf186f);
    address payable public teamWalletAddress = payable(0xa88A3173468FD5fF5DCaBf1f9228e00f0c1c9D4d);
    ...
    uint256 public _walletMax = 40 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2023 * 5 **_decimals; 
