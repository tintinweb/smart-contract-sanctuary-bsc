...
/**
    ...
    * **https://github.com/interfinetwork/smart-contract-audits/blob/audit-updates/TokenRunner_0xF023fc3f0418B1DE24178Fa7D21802daBA7FB49A.pdf
    * http://t.me/tokenrunner
    https://twitter.com/tokenrunner_net
    * WebSite: https://tokenrunner.net/
    * English Telegram group:https://twitter.com/tokenrunner_net
    * Chinese Telegram group:https://twitter.com/tokenrunner_net
    */
    ...
    * Chinese Telegram group:https://twitter.com/tokenrunner_net
    */
    contract TKRN is Context, IERC20, IERC20Metadata {
        using SafeMath for uint256;

        mapping(address => uint) private _balances;
        mapping(address => mapping(address => uint)) private _allowances;
        string private constant _name = "Token Runner";
        string private constant _symbol = "TKRN";
        uint8 private constant _decimals = 18;
        uint private _totalSupply = 15000000 * 10 ** _decimals;
