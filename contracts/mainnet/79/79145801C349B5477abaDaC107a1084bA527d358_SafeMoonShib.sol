...
contract SafeMoonShib is ERC20, Ownable {
    ...
    SafeMoonShibDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SafeMoonShib", "MOONSHIB") {
        marketingWallet = payable(0x6714741d64C0082E460E96aB2B80AcEe7f0aFF0a);
        devWallet = payable(0x6714741d64C0082E460E96aB2B80AcEe7f0aFF0a);
        ...
        dividendTracker = new SafeMoonShibDividendTracker(
            payable(this),
            router,
...
contract SafeMoonShibDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SafeMoonShib public SafeMoonShibContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SafeMoonShibContract = SafeMoonShib(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SafeMoonShib_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SafeMoonShib_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SafeMoonShib contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SafeMoonShibContract);

            uint256 prevBalance = SafeMoonShibContract.balanceOf(address(this));
            ...
            {
                uint256 received = SafeMoonShibContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SafeMoonShibContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
