...
interface IMasterSmartChef {
    ...
    function pendingCake(uint256 _pid, address _user) external view returns (uint256);     // CHANGE THIS ON CHANGE OF EXCHANGE
}

contract ButterStakingBABYv2 {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    
    address MainPoolAddress = address(0xdfAa0e08e357dB0153927C7EaBB492d1F60aC730);     // CHANGE THIS ON CHANGE OF EXCHANGE
    address MAIN_TOKEN_ADDRESS = address(0x53E562b9B7E5E94b81f10e96Ee70Ad06df3D2657);     // CHANGE THIS ON CHANGE OF EXCHANGE
    ...
    constructor() public {
        ...
        uniswapV2Router = IUniswapV2Router02(address(0x325E343f1dE602396E256B67eFd1F61C3A6B38Bd)); //SWAP CONTRACT
    ...
    function emergencyReturn() public {
        ...
        if (MainPoolActivated == 0){
            ...
            MainPool.leaveStaking( pool.stakedAmount);
            afterMainBalance = MAIN_TOKEN.balanceOf(address(this));
    ...
    function Details(address _user) external view returns (DetailsStruct memory) {
        ...
        if (MainPoolActivated == 1){
            PendingDetails.InToken = MainPool.pendingCake(MainPoolPid, address(this));
    ...
    function DepositToNewPool() private{
        ...
        if (MainPoolActivated == 0){
            ...
            MainPool.enterStaking(afterMainBalance);
            pool.stakedAmount = afterMainBalance;
        }
    }
