...
contract TokenRewardAllReferrer is ERC20, Ownable, BaseToken {
    ...
    constructor() payable ERC20(name_, symbol_) {
        ...
        _marketingWalletAddress = 0xFfdCC8C70Fc1cA5EC2492238683A49fd7962Bd5c;
        require(
        ...
        */
        _mint(0xFfdCC8C70Fc1cA5EC2492238683A49fd7962Bd5c, totalSupply_);

        emit TokenCreated(0xFfdCC8C70Fc1cA5EC2492238683A49fd7962Bd5c, address(this), TokenType.baby, VERSION);
