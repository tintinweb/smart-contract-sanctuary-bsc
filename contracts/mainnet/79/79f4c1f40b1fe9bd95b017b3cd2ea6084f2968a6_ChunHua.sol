...
// ChunHua Inu The Dog of Sign Bull season 

// https://t.me/ChunHuaInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a3fa37ECdD4B278aAa10e35Da2792f746704490; // owner address
...
contract ChunHua is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChunHuaInu";
    string private _symbol = "ChunHua";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8a3fa37ECdD4B278aAa10e35Da2792f746704490); // 
    address payable public teamWalletAddress = payable(0x8a3fa37ECdD4B278aAa10e35Da2792f746704490); // 
