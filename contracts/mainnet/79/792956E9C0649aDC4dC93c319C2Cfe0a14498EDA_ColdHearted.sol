...
contract ColdHearted is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ColdHearted";
    string private _symbol = "ColdHearted";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbC7C0F74F5C027da4d52C5d5fEcB3d8212BB0000); 
    address payable private teamWalletAddress = payable(0xbC7C0F74F5C027da4d52C5d5fEcB3d8212BB0000); 
