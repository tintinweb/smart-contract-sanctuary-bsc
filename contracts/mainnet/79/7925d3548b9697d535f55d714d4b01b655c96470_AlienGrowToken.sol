...
// SPDX-License-Identifier: GPL-3.0 or later
 /**
    ...
    5% fee automatically move to AlienGrow Investment fund
    ...
    Official site: https://AlienGrow.land
 */
...
contract AlienGrowToken is Context, IERC20, Ownable {
    ...
    address private _AlienGrowInvestmentFund = 0x93fBD96FD8c708Fb4f5e44572A54a3ad7A6C7CA7;
    address private _donationWalletAddress = 0xA3b4288328A4A6a0d5e02F1174B34F060FbA5011;
    address private _AlienGrowArGameWalletAddress = 0x7AC095e7060529A5fd2edb002a389a11b1554CBa;
    address private _serviceWalletAddress = 0xC0cbd71419E1C8BC68271818799f270740f5A52b;
    ...
    string private _name = "AlienGrow";
    ...
    constructor () {
        ...
        _isExcludedFromFee[_AlienGrowInvestmentFund] = true;
        _isExcludedFromFee[_donationWalletAddress] = true;
        _isExcludedFromFee[_AlienGrowArGameWalletAddress] = true;
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_AlienGrowInvestmentFund] = _rOwned[_AlienGrowInvestmentFund].add(rDev);
        if(_isExcluded[_AlienGrowInvestmentFund])
            _tOwned[_AlienGrowInvestmentFund] = _tOwned[_AlienGrowInvestmentFund].add(tDev);
    }
