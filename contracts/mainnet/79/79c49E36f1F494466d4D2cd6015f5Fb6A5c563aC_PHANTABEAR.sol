...
contract PHANTABEAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PHANTABEAR";
    string private _symbol = "Phantabear";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x08709C49633c03bd50De9e1C66E2581728536666));
        ruinWalletAddress = payable(address(0xa0C36E68873399305919686EB1517f7EbAeeB777));
