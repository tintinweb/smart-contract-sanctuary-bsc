...
contract TheGreatBSC is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x28CA511d504E169DbDF2C13760Dafd5D1536436f;

    string private constant _name = "The Great BSC";
    ...
    Taxes public taxes = Taxes(0, 5, 5);
    Taxes public sellTaxes = Taxes(0, 10, 5);
    ...
    function setbuyTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity) public onlyOwner {
       require((_rfi + _marketing + _liquidity) <= 20, "Fees can't exceed 20%");
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity) public onlyOwner {
       require((_rfi + _marketing + _liquidity) <= 20, "Sellfees can't exceed 20%");
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner{
        require(amount >= _tTotal * 1 / 400, "Cannot set max wallet amount lower than 0.25% of total supply");
