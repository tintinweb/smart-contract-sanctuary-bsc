...
/**
Telegram:https://t.me/btctwentythousand
Website: Coming soon
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xad4081b1FFcd417cB4F97D6603F380c1d9EEaD35; // owner address
...
contract BTC20K is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC20K";
    string private _symbol = "20K";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x320A99f7407C0d38F3FbC5E04b4FF8b6872F8D31); // Marketing Address
    address payable public teamWalletAddress = payable(0xad4081b1FFcd417cB4F97D6603F380c1d9EEaD35); // Team Address
