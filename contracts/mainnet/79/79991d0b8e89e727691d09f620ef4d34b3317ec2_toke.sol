...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xddFD7aD2541750e90CCCB8723c2947d9b78C4b18;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xddFD7aD2541750e90CCCB8723c2947d9b78C4b18),//fund address
    
        address(0xddFD7aD2541750e90CCCB8723c2947d9b78C4b18)//dev address
    ){
