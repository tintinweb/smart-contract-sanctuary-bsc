...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7BC93B636A89C5A3006f73CB0EFcE4B071C50257; // owner address
...
contract Uruguay is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7BC93B636A89C5A3006f73CB0EFcE4B071C50257); // Marketing Address
    address payable public teamWalletAddress = payable(0x7BC93B636A89C5A3006f73CB0EFcE4B071C50257); // Team Address
