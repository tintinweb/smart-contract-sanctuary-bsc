...
contract BRC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * change admin user;
     */
    function transferAdmin(address admin_) public onlyAdmin {
         _admin = admin_;
    }
...
contract SkinNFT is BRC721Enumerable, Pausable {
    using Strings for uint256;
    ...
    function mint(address account, uint256 tokenId) external onlyAdmin {
