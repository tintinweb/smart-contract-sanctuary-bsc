...
/*
    TG: http://t.me/Kujousaratoken
    WEB: http://kujousara.com
    TW: http://twitter.com/Kujousaratoken
*/
...
contract KujouSara is Context, IERC20, Ownable {
    ...
    string private constant _name = "KujouSara";
    string private constant _symbol = "$KSARA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x264117996F16a77b0AE7851815635df7585D7867);
        _feeAddrWallet2 = payable(0xb5593546FEBBBF71B9d7d5B19BE201a95D20c590);
        _liquidityWallet = payable(0xae76aBEC48A9F79E5A1226FBa935D3cA9B39DEb6);
