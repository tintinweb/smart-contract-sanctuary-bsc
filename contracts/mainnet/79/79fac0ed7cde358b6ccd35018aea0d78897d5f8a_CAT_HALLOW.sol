...
contract CAT_HALLOW is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x52db931BD47Ad071eD47578A753b17968E63f7EF); 
    address payable private Wallet_Dev = payable(0x7e9B93795dA405e5389142b3eB10F151E7755Ac7);
    ...
    string private constant _name = "CAT HALLOW"; 
    string private constant _symbol = unicode"CATHL"; 
    ...
    constructor () {
        ...
        _owner = 0x7e9B93795dA405e5389142b3eB10F151E7755Ac7;
    ...
    function StartOP(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function turnOn_Antibot() public onlyOwner {
        isAntibotModeEnabled = false;
    }

    function turnOffAntibot() public onlyOwner {
    ...
    */
    ...
    function wlandtxh(address addresses) external onlyOwner {
    ...
    function MaxLimit_txh(uint256 maxTxPercent_x100) external onlyOwner() {
