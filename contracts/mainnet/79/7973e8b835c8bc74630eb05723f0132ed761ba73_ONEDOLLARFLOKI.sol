...
contract ONEDOLLARFLOKI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**4;
    uint256 public _maxTxAmount = 40 * 10**4; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**_decimals; //
    string private constant _name = unicode"ONE DOLLAR FLOKI"; // 
    string private constant _symbol = unicode"1$ FLOKI"; //    
    uint8 private constant _decimals = 4; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x94C6920CAF360dB16e720057A9aA17703921c681;
