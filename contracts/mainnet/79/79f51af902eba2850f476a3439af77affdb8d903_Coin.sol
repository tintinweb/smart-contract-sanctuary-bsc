...
contract Coin is ERC20Interface, SafeMath {
    string public name = "FASTERPECOIN";
    string public symbol = "FPC";
    uint8 public decimals = 18;
    uint256 public _totalSupply = 500000000000000000000000000; // 500 million FPC in supply
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        uint256 amountToBurn = safeDiv(tokens, 20); // 0% of the transaction shall be burned
