...
AUGUST 8 2022 12-1PM UTC LAUNCH

MY LAST PROJECT X20 ONLY FOR FAST BUYER. JOIN THE TELEGRAM FOR EARLY CA SOON X100 OR MORE. SLOW BUYER WAIT FOR DIP 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA648C603eFfc50D17ffdd8d43e9bE2E894F6c0A1; // owner address
...
contract RUSSIANDOGEGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Russian Doge Grow";
    string private _symbol = "RDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA648C603eFfc50D17ffdd8d43e9bE2E894F6c0A1);
    address payable public teamWalletAddress = payable(0xA648C603eFfc50D17ffdd8d43e9bE2E894F6c0A1); 
