...
// https://t.me/AikoWorldOfficial
// https://twitter.com/aikoIofficial
// https://aikoworld.net/
...
contract AikoWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aiko World";
    string private _symbol = "$AW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCaD3764c355De05BBF2CFF6c87d26Ee77a110342); // Marketing Address
    address payable public DevWalletAddress = payable(0x65f9Eb2C9905868DAE2486a856F480dc8Cd7d38E); // Dev Address
