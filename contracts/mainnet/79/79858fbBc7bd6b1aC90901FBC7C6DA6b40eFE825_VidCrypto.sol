...
VidCrypto has been designed to try to fix the phenomena of the pump and dumps that we 
...
There is a max 30% daily sell limit in effect on this contract; 
...
Both whale and small investors alike are protected by the VidCrypto mechanism hardcoded into the smart contract. 
The moon mission for VidCrypto is in the code.

VidCrypto TOKENOMICS & TAXES
Total supply: 50,000,000 or 50 Millions VidCrypto tokens
Decimals: 9
Liquidty: 2% 
Marketing: 4%
Auto-buy backs: 4%
...
contract VidCrypto is IERC20 {
    ...
    string constant private _name = "VidCrypto";
    string constant private _symbol = "VCT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x86D981e1529319D7d81e34D5788A4D628ee772D8)
        });
    ...
    uint256 public dailySellPercent = 2000;
