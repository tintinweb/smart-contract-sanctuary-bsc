...
//Join our telegram: @DOGEPAY_BSCOFFICIAL
...
contract DPAY is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "DOGE PAY";
    string constant _symbol = "DPAY";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // .5% on launch or 500k tokens
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // .5% or 500k tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x495513eE3fa5b3cdb189885ba2C53d0B0012d523;
