...
/*
 _____ _________________  ___  ______  ___   _   _  _   __
...
contract TerraBank  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'TerraBank';
    string private constant _symbol = 'TERR';
    ...
    function setstartSwap(uint256 _input) external authorized {startSwap = true; botOn = false; startedTime = block.timestamp.add(_input);}
