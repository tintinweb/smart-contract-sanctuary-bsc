...
Telegram : https://t.me/senrencoin
Website  : https://twitter.com/senrencoin

Senren coin is an anime character from Senren Banka who 
has a beautiful and cute appearance. we are affiliated in 
the Binance Smart Chain network. and we have very secure contracts 
to use as convenient investments in the world of cryptocurrencies.
...
contract SenrenCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x49Fae06dEa4b8cBC23F037690953b2597f10BF2D); 
    address payable public Wallet_Dev = payable(0x49Fae06dEa4b8cBC23F037690953b2597f10BF2D);
    ...
    string private constant _name = "Senren Coin"; 
    string private constant _symbol = unicode"SENREN"; 
    ...
    constructor () {
        ...
        _owner = 0x49Fae06dEa4b8cBC23F037690953b2597f10BF2D;
