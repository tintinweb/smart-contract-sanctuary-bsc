...
contract Token is ERC20, Ownable {
    ...
    mapping (address => bool) _taxExclude;
    ...
    string _name = "Algodao";
    string _symbol = "Algodao";
    uint256 _total = 10000*10**8;
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        _taxExclude[msg.sender] = true;
        _taxExclude[address(uniswapV2Router)] = true;
    }

    function upPair(address pair, bool enabled) public onlyOwner {
        _pairs[pair] = enabled;
    }
    ...
    function isTaxExlude(address account) public view returns (bool) {
        return _taxExclude[account];
    }

    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        if (isTaxExlude(sender) || isTaxExlude(recipient)) {
        ...
        uint256 marketingTokens = amount.div(100);
        super._transfer(sender, address(this), marketingTokens);
    ...
    function _swap() internal {
        ...
        if (balance == 0) return;
        swapTokensForTokenB(balance, address(this));
    }
