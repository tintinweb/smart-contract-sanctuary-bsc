...
/**
🚴 Satoru - Mumen Raidā Inu 🚴🚵 サトル - 無免ライダー 🚵

Degen based on a character full of potential to attain to a moonshot. Responsable team and community driven based project. Don't miss this ride 🚴
...
contract MumenRaidaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MumenRaidaInu"; // 
    string private constant _symbol = "MumenRaidaInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x9A35FE2A6cbb09C1C82a7E48da2d1614eE676dC9;
