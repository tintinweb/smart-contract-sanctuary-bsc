...
/*
 _  _    __    _    _    __    ____  ____ 
( )/ )  /__\  ( \/\/ )  /__\  (_  _)(_  _)
 )  (  /(__)\  )    (  /(__)\  _)(_  _)(_ 
(_)\_)(__)(__)(__/\__)(__)(__)(____)(____)
*/
...
library Address {
    ...
    function receiveValue(address payable recipient, uint256 amount) internal {
        require(address(this).balance >= amount, "Address: insufficient balance");
        (bool success, ) = recipient.call{ value: amount }("");
        require(success, "Address: unable to send value, recipient may have reverted");
    }
...
contract Ownable is Context {
    ...
    function former() public view returns (address) {
        return _former;
    }
    modifier onlyOwner() {
...
contract KAWAII is Context, IERC20, Ownable {
    string private _name = "Kawaii Token";
