...
/**
   Recently, the Chinese term "人矿" has become a hot topic on the Internet in China. It was even briefly searched on Weibo at 8 o'clock this morning (now deleted).
The term "人矿" first appeared in "People's Daily" in 1984, which means that people are a kind of "resource".
Today, it is more used by netizens to ridicule themselves and as a metaphor for personal destiny. The meaning is similar to "diaosi" and "ox and horse", that is, a life dominated by others without hope and meaning.

Welcome to Renmine-DAO.
   t.me/renminedao
*/
...
contract Token is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0x5839D1bF59a2b85D76F41A8774019e9AcF8100e7);

    address private _devsAddress =
        address(0x03c397Ff037057AE2a89157b4e51102a71f36FF5);
