...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0xc748673057861a797275CD8A068AbB95A902e8de);
...
contract BurnBaby is IBEP20, Auth {
    using SafeMath for uint256;
   
    address REWARD   = 0xc748673057861a797275CD8A068AbB95A902e8de;
    address WBNB     = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "Burn Baby Doge";
    string constant _symbol = "BurnBBD";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 500000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 5,000

        //max wallet holding of 5%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 25,000
    ...
    uint256 public swapThreshold = _totalSupply / 100; //5,000
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x83a97a68CAC311eF8d8255b57aD337BCef9Fa3bE; 
