...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDFf321c0423A3bBF860ea23aa280FBB4C3BfFDb6; // owner address
...
contract HumantonInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Humanton Inu";
    string private _symbol = "HINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDFf321c0423A3bBF860ea23aa280FBB4C3BfFDb6); // Marketing Address
    address payable public teamWalletAddress = payable(0xDFf321c0423A3bBF860ea23aa280FBB4C3BfFDb6); // Team Address
