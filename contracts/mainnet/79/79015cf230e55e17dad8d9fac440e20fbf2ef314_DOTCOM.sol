...
contract DOTCOM is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOTCOM";
    string private constant _symbol = "DTCM";
    ...
    address payable public DTCMdevWallet = payable(0x5A1CF710e9CF193Ca585E5E5d3F409C97E0F3A99);
    address payable public DTCMrewardWallet = payable(0x839205f1368dB7d631733B03cf69DB2F5616044F);
    ...
    function setBuyFee(uint256 newBuyDevFee, uint256 newBuyRewardFee) public onlyOwner {
        require(newBuyDevFee.add(newBuyRewardFee) <= 11, "Must keep buy taxes below 11%");
    ...
    function setSellFee(uint256 newSellDevFee, uint256 newSellRewardFee) public onlyOwner {
        require(newSellDevFee.add(newSellRewardFee) <= 11, "Must keep sell taxes below 11%");
