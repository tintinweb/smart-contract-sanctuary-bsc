...
// Dev @robdbeme official telegram https://t.me/mineswapdex
...
contract MineSwap is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    MineSwapDividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0xf2b4f285E862Dc74D8c499bF343566eE2872437F);
    ...
    constructor() BEP20("Mine Swap", "MINE SWAP") 
    {
        dividendTracker = new MineSwapDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "MineSwap: The dividend tracker already has that address");
        MineSwapDividendTracker newDividendTracker = MineSwapDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "MineSwap: The new dividend tracker must be owned by the MineSwap token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MineSwap: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MineSwap: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MineSwap: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MineSwap: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MineSwap: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MineSwap: Cannot update gasForProcessing to same value");
...
contract MineSwapDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("MineSwap_Dividend_Tracker", "MineSwap_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MineSwap_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "MineSwap_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MineSwap contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MineSwap_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MineSwap_Dividend_Tracker: Cannot update claimWait to same value");
