...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2DEB9aD5E8E843F044BA070F9694C635883f4839; // owner address
...
contract YeetInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yeet Inu";
    string private _symbol = "YEETINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x78b7981C5953F4335A14b8b1A8DCBbDC5b031d8f); // Marketing Address
    address payable private teamWalletAddress = payable(0x43932E99A9C05ddb1fFc59C1bFF007f8f89abFD2); // Team Address
