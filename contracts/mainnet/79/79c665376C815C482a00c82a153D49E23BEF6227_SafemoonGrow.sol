...
contract SafemoonGrow is Ownable, IERC20 {
    ...
    string public _name = "Safemoon Grow";

    string public _symbol = "Safemoon Grow";
    ...
    uint256 public _maxWallet =   40000000000000 * 10 ** _decimals;
