...
contract Vault is Ownable, Signers, VerifySigEIP712 {
    ...
    event Bridge(address user, uint64 chainId, address srcToken, address toDstToken, bytes32 transferId, string bridge);
    ...
    function _cBridgeStart(uint256 dstAmount, CBridgeDescription calldata bdesc) internal {
        ...
        emit Bridge(tif.user, tif.chainId, tif.dstToken, bDesc.toDstToken, transferId, tif.bridge);
    }
    ...
    function _polyBridgeStart(uint256 dstAmount, PolyBridgeDescription calldata _pDesc) private {
        ...
        emit Bridge(tif.user, tif.chainId, tif.dstToken, pDesc.toDstToken, transferId, tif.bridge);
    }
    ...
    function _multiChainBridgeStart(uint256 dstAmount, MultiChainDescription calldata mDesc) internal {
        ...
        emit Bridge(tif.user, tif.chainId, tif.dstToken, mDesc.toDstToken, transferId, tif.bridge);
    }
