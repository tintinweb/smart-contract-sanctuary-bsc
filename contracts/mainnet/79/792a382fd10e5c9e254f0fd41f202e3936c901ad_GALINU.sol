...
contract GALINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GALAXY INU";
    string private _symbol = "GALINU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xF0a9E647570A0a2Aa0eadef4d0B9C98a81225618); // Marketing Address
    address payable public BuyBackWallet = payable(0xF0a9E647570A0a2Aa0eadef4d0B9C98a81225618); // Team Address
