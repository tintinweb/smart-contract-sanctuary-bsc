...
contract GLORIA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x09ba152eF510f8fEa4d3C50e123F9385b3A0DE77); // Marketing Address
    address payable public teamWalletAddress = payable(0x09ba152eF510f8fEa4d3C50e123F9385b3A0DE77); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x09ba152eF510f8fEa4d3C50e123F9385b3A0DE77),
            block.timestamp
        );
    }
