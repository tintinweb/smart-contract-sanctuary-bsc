...
/* 
❄️🐕Suikoden Shiba🐕 ❄️
🟢 Relax, Suikoden Santa Is Bringing You Safe Moon For the holiday 🟢
...
🟢 Safe Contract
🟢 Transparent
🟢 Lock Liquidity Long Time
🟢 No dev Tokens Or locked Team wallets

Info of Project
🟢 Safe Team
🟢 Website in Development
🟢 BASED
🟢 Looking to build Community (Slow Moon)

🟢🟢 JOIN For Launch 🟢🟢

👉 Telegram  @SuikodenShiba
*/
...
contract SuikodenShibaInu is Context, ShibaDeployer, Ownable {
    ...
    string private _name = 'Suikoden Shiba Inu';
    string private _symbol = 'Suikoden';
