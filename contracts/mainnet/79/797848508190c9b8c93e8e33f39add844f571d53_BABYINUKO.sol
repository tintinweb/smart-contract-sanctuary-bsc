...
contract BABYINUKO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Inuko Coin";
    string constant _symbol = "BABYINUKO";
    ...
    address public marketingFeeReceiver = 0x422746add163a4cF1a4b510adAfCA842C7E8EeB7;

    IDEXRouter public router;
    address public pair;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 10000000 * 300;
    bool inSwap;
