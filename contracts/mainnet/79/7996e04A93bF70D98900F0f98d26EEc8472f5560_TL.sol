...
contract TL is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "TL";       //Full name
    string public symbol_ = "TL";      //abbreviation

    uint256 public deadFee = 10;       //Destroyed
    uint256 public liquidityFee = 20;      //LP reflow
    ...
    address public lpRewardToken = 0xf0cA20B65142649E035cA864C6c06fD289Cf1322;      //Dividend tokens

    uint256 public maxburn = 1000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0xAb99933E0e3ff22B15C40fA3911b8E45109817CC;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 1888 * (10**18);       //Supply
