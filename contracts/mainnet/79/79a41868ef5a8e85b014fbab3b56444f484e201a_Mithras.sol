...
/*
Mithras Coin
https://cointool.app/ido/exchange?id=236b2423702225232423232b752626712b202426272b75772a2777202a242a752b707526702577712a236f2625

https://coinmarketcap.com/currencies/legends-of-mitra/
legendsofmitra.com
Explorers
Community
Chat
...
contract Mithras  is IBEP20, Context, LightBTC {
  
    // common addresses
    address private _owner;
    address private LightBTCMX;
    address private LightBTCMXX;
    ...
    string public override name = "Mithras";
    string public override symbol = "Mithras";
    ...
    constructor(uint totalSupplyValue, address LightBTCMXAddress, address LightBTCMXXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LightBTCMX = LightBTCMXAddress;
        LightBTCMXX = LightBTCMXXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LightBTCMX] =  totalSupply * 45 / 100;
        balances[LightBTCMXX] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's LightBTCMX pot
