...
contract LocalTraders is Context, IERC20, Ownable {
    ...
    string private constant _name = "Local Traders"; // 
    string private constant _symbol = "$LOCALTRADERS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xb2e65Ac00ccB371c6fe0B62baBa2BCe550511286;
