...
contract Starlink
 is Context, IERC20, Ownable {
    ...
    string private _name = "Starlink V2";
    string private _symbol = "Starlink V2";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD032B341fdF1Be2377BC8755cd885Fb7E2e0f132));
        _anotherA = payable(address(0xD032B341fdF1Be2377BC8755cd885Fb7E2e0f132));
