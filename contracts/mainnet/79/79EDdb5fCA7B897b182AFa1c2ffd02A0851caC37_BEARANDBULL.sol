...
/**
https://t.me/BearAndBullPortal
https://t.me/BearAndBullOfficial
*/
...
contract BEARANDBULL is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x65a78dE95cBD693E96091Ea6c5b63F7CfE4C85AD;
    address DevWallet       = 0x257133996ed78e0Ba73097A23B10EbfdeaBa1814;

    string constant _name = "BearAndBull";
    string constant _symbol = "BNB";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 4000 * (10 ** _decimals);
