...
pragma solidity ^0.6.2;
contract GJ is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    address public USDTs = address(0x55d398326f99059fF775485246999027B3197955); 
    address public Shark = address(0x28E45b837f61D8289D2cfb726c6505db6fe824c9); 
    ...
    constructor() public ERC20("GJ", "GJ") {
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), Shark);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        path[0] = address(this);path[1] = Shark;path[2] = USDTs;
