...
//address
    ...
    address public marketingAddress = 0xD8Dac4558A16149454683eE65013362723A9A917;
    address public devAddress = 0xD8Dac4558A16149454683eE65013362723A9A917;
    address public teamAddress = 0xD8Dac4558A16149454683eE65013362723A9A917;
    address public liquidityAddress = 0xD8Dac4558A16149454683eE65013362723A9A917;
//uint
                ...
                if(!excludedFromFees[to]) {
                    ...
                    if(limitBuys) {
                        ...
                        if(marketActiveAt + 0 < block.timestamp) {
                            ...
                            require(userLastTradeData[to].lastBuyTime + 0 <= block.timestamp,"You cannot do multi-buy orders.");
