...
contract Catson is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Cat son";
    string private _symbol = "Cat son";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2F403bEDf1f73834b5766E9453d3450c24084363));
        ________ = payable(address(0x2F403bEDf1f73834b5766E9453d3450c24084363));
