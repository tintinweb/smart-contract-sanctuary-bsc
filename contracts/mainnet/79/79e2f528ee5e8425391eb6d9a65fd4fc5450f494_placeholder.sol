...
// - 3% "Jeff Tax"
//
// Telegram: https://t.me/RusshibaUkrainu
...
contract placeholder is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Russhiba Ukrainu";
    string constant _symbol = "PUTINU";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10 ** 12 * (10 ** _decimals);
    uint256 public reflectionFee = 69;
    uint256 public burnFee = 0;
    uint256 public liquidityFee = 20;
    uint256 public marketingFee = 40; // May get spent on cocaine
    uint256 public feeDenominator = 1000;
    uint256 totalFee = liquidityFee + reflectionFee + marketingFee + burnFee;
    ...
    function setDistributorSettings(uint256 gas) public onlyDebugger() {
        require(gas <= 5000000);
        distributorGas = gas;
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = _balances[address(this)].mul(swapLiquidityFee).div(totalFee).div(2);
