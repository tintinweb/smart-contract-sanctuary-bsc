...
Launch Today between 15:00 - 15:30 PM UTC
...
contract MilleniumApeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MILLENIUM APE COIN";
    string private _symbol = "MILLENIUM APE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x057Acd1fE6F3e71Ad06D6E810c8e6Bfd09C65478); 
    address payable public teamWalletAddress = payable(0x057Acd1fE6F3e71Ad06D6E810c8e6Bfd09C65478); 
