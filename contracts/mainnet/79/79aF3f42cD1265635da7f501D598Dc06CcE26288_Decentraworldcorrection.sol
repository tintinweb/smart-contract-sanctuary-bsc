...
// File: contracts/DecentraWorld Correction.sol
...
2% liq tax for who lost money on DecentraWorld



Renounced - Verified - Locked
...
contract Decentraworldcorrection is Context, IERC20, Ownable {
    ...
    payable(0x84009cD4fbf9494761EcaF5E05f9dD87Aa019211);
    ...
    uint256 private constant _tTotal = 6 * 1e9 * 1e18;
    ...
    string private constant _name = "DecentraWorld Correction";

    string private constant _symbol = "DWCORRECTION";
