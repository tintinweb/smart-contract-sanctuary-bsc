...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF8d9032AdBEaE93b1d3F971589A5dD035F4d6FF0; // owner address
...
contract BleedingDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bleeding Doge";
    string private _symbol = "Bleeding Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable (0x2086Cc0fCDc745bC0425d5caBE33142A36A6265b); // Marketing Address
    address payable public teamWalletAddress = payable (0xf73013c07DD58C3b7d860bC38ee03c6C07dE0Ea3); // Team Address
