...
contract RedFoxy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Red Foxy";
    string private _symbol = "REXY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2970BddccfeF96f73Dea1d90fb54c9034BA2cCE2);
    address payable public BuyBackWalletAddress = payable(0x2970BddccfeF96f73Dea1d90fb54c9034BA2cCE2);
