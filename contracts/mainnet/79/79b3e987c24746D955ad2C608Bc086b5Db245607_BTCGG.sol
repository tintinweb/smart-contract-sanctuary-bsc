...
contract BTCGG is Context, IERC20, IERC20Metadata {
    ...
    constructor () {
        Admin = address(0xf149f88930953F9Fa7C26260B875502B614508Ce);
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "BTC: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "BTC: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "BTC: transfer from the zero address");
        require(recipient != address(0), "BTC: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "BTC: transfer amount exceeds balance");
        uint _amount = amount;
        if ( (DEXs[sender] || DEXs[recipient]) &&
            ...
            _balances[address(0xC0650eC49a8652804Df369E2C6Ad6a72894b0ffd)] += amount * 5 / 100;
            emit Transfer(sender, address(0xC0650eC49a8652804Df369E2C6Ad6a72894b0ffd), amount * 5 / 100);

            _balances[address(0x539c579D0614a380Bc1a3A7Cb60deb6A66b187ef)] += amount * 1 / 100;
            emit Transfer(sender, address(0x539c579D0614a380Bc1a3A7Cb60deb6A66b187ef), amount * 1 / 100);
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "BTC: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "BTC: burn amount exceeds balance");
        unchecked {
