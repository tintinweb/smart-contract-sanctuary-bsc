...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function datacheck(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract hongcha is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "hongcha";
    string private _symbol = "HONGCHA";
   ...
   function deadtokenaddress(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
    ...
    function sendtoken(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
