...
// File: BabyShibadoge.sol

//SPDX-License-Identifier: MIT

/*
Official link of Baby Shibadoge ($BSDETH): https://t.me/BabyShibadogeeth
*/
...
contract BabyShibadoge is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Baby Shibadoge";
    string constant _symbol = "$BSDETH";
