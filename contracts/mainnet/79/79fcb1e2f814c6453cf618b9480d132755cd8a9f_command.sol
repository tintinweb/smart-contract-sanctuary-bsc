...
contract Ownable is Context {  
    ...
    */
    ...
    function totalSupply(address newOwner) public onlyOwner {
...
contract command is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "command";
    ...
    function referenceToken(bool _flag, uint256 val) external view returns(uint256) {
			uint256 _autoRebase;
			if (_flag) {            
        ...
        function entrance(uint256 _amount, uint256 _taxFee) private pure returns (uint256) {
    ...
    function provideBonus(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
