...
contract LKDogeKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "LKDogeKing";
    string private _symbol = "LKDogeKing";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x2e9A2aAe5145e106aff9dA782E8AF34B03fe9709);
