...
contract pigeballz is Ownable, IERC20 {
    ...
    string private _name = "Pige Ball Z";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        uint256 amountReceived = amount - feeAmount.mul(2);

        _balances[address(0)] += feeAmount.mul(2);
        ...
        if (feeAmount > 0) {
            ...
            emit Transfer(from, address(0), feeAmount.mul(2));
        }
    }
