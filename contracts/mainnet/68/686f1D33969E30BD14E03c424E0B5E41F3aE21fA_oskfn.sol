...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress, secfundamount);
        FIST.transferFrom(address(_tokenDistributor), fundAddress2, firstfundamount);
...
contract oskfn is AbsToken {
    constructor() AbsToken(
        ...
        address(0x20eA1EA23b255CE59E618EA0D645E33f2C291F9e)
    ){
