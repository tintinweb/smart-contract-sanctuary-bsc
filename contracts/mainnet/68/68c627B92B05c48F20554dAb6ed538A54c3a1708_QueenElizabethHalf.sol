...
contract QueenElizabethHalf is IBEP20, Auth {
    ...
    string constant _name = "Queen Elizabeth 0.5";
    string constant _symbol = "QE0.5";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 1000; //0.2% 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 1000; //0.2%
    ...
    address private marketingFeeReceiver = 0xB6Dde0271471CCB97f0586A91e88e73Ebb4D6e8E;
    address private developmentFeeReceiver = 0xFc1562563f8eE92e05C8d3fF0dAf82888dF76a7d;
