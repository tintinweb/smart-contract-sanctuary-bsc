...
contract LaEebComm is IERC20{
    ...
    function setLaeebToken(address _addr) public {
    ...
    function transfer(address _to, uint256 _value) external override returns(bool success){
        ...
        if (_value == (1* (10 ** 18))) {
            ILaEebToken(laeebToken).setCommAuthor(msg.sender,_to);
        }
