...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE2514D63F9b7aD643DC0a4E2a42644727f974306; // owner address
...
contract MEME  is Context, IERC20, Ownable {
    ...
    string private _name = "MEME GAME";
    string private _symbol = "MG"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE2514D63F9b7aD643DC0a4E2a42644727f974306); // Marketing Address
    address payable public teamWalletAddress = payable(0xE2514D63F9b7aD643DC0a4E2a42644727f974306); // Team Address
    ...
    uint256 public _sellLiquidityFee = 95;
    ...
    uint256 public _totalTaxIfBuying = 6;  // original 6
    uint256 public _totalTaxIfSelling = 6;  // original 6
    uint256 public _totalDistributionShares = 6;  // original 6
