...
contract RyoshiAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RyoshiAIDividendTracker public dividendTracker;
    ...
    constructor() ERC20("RyoshiAI", "RyoshiAI") {
        marketingWallet = payable(0x8F95bA7020C23b30f3e9c0c286c13015Ca467B70);
        devWallet = payable(0x8F95bA7020C23b30f3e9c0c286c13015Ca467B70);
        ...
        dividendTracker = new RyoshiAIDividendTracker(
            payable(this),
            router,
...
contract RyoshiAIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    RyoshiAI public RyoshiAIContract;
    ...
    constructor(
        ...
        defaultToken = token;
        RyoshiAIContract = RyoshiAI(mainContract);
    ...
    function _transfer(
        ...
        require(false, "RyoshiAI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "RyoshiAI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RyoshiAI contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(RyoshiAIContract);

            uint256 prevBalance = RyoshiAIContract.balanceOf(address(this));
            ...
            {
                uint256 received = RyoshiAIContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RyoshiAIContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
