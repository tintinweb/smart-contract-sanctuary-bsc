...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dyker Heights NYC"; //
    string private constant _symbol = "Dyker Heights"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3C04d29C69d6dB755ACA12dBD2031153e31cA2F5;
