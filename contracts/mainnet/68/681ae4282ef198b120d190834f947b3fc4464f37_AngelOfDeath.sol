...
contract AngelOfDeath is IBEP20, RSunAuth {
    ...
    uint256 public _maxTxAmount = _totalSupply / 2000; // 0.2%
    ...
    uint256 liquidityFee =4; //2%
    uint256 buybackFee = 1;  //2%
    uint256 reflectionFee = 2; //2%
    uint256 marketingFee = 4;  //2%
    uint256 developmentFee = 4;
    uint256 totalBuyFee = 15;
    uint256 totalSellFee = 15;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee,uint256 _developmentFee , uint256 _feeDenominator, uint256 _totalSellFee) external authorizedFor(Permission.AdjustContractVariables) {
        ...
        require(totalBuyFee <= feeDenominator / 17, "Buy fee too high");
        require(totalSellFee <= feeDenominator / 17, "Sell fee too high");
    }
