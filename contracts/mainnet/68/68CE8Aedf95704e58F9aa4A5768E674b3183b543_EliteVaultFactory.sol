...
contract EliteVaultFactory {
    ...
    function createVault(address _asset, string memory _name, string memory _symbol, string memory _description) public {
        require(!vaultExists[_asset], "VAULT_EXISTS");

        vaultExists[_asset] = true;
        vaultIndex[totalVaults] = address(new EliteVault(_asset, _name, _symbol));
