...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99B70096dddFe5fDD79E6634656FDB4F2E823857; // owner address
...
contract DOLLARSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DollarShib";
    string private _symbol = "$DSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99B70096dddFe5fDD79E6634656FDB4F2E823857); // Marketing Address
    address payable public teamWalletAddress = payable(0x99B70096dddFe5fDD79E6634656FDB4F2E823857); // Team Address
