...
contract Geisha is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x83c1639e2eDe02809b9a43975179c2b31601224B); 
    address payable public Wallet_Dev = payable(0xC7B44cF2aB8a5b10625875C213923f9fb63b3a8a);
