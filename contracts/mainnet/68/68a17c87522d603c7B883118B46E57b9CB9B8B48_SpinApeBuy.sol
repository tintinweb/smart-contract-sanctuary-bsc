...
contract SpinApeBuy is ReentrancyGuard, Ownable {
    ...
    function buy(uint256 amount, address refBy) public nonReentrant {
        ...
        require(amount >= 50,"Error: Minimum allocation is $50 and max allocation is 100$");
        require(
        ...
        require(
            currentBuy + nextBuy <= maxBuy,
            "Error: Minimum allocation is $50 and max allocation is 100$"
        );
        ...
        usdtToken.transferFrom(msg.sender, fundAddress, (amount * 1 ether) - totalUsdNeed);
