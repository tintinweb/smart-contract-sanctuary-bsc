...
contract BunnyGold  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x359F2eCbe221590E9CE007a56d9A86255bCE9443); 
    address payable public Wallet_Dev = payable(0x359F2eCbe221590E9CE007a56d9A86255bCE9443);
    ...
    string private constant _name = "Bunny Gold"; 
    ...
    constructor () {
        ...
        _owner = 0x359F2eCbe221590E9CE007a56d9A86255bCE9443;
