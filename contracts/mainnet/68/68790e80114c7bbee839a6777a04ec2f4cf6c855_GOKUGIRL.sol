...
TELEGRAM:  https://t.me/BlackGokuGirlInu
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe16dD1eBD0FAA1C803829F8f2163B9625433dc9E;
...
contract GOKUGIRL is Context, IERC20, Ownable {
    ...
    string private constant _name = "BLACK GOKU GIRL INU"; // 
    string private constant _symbol = "GOKUGIRL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xe16dD1eBD0FAA1C803829F8f2163B9625433dc9E);
