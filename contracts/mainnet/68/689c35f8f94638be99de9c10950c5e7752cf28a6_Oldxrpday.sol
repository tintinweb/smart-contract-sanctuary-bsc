...
contract Oldxrpday   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Old Xrp day ";
    string private _symbol = " OLDXD "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12830a9bfD52c5f0aEF4E0525aDb42453771cEc3); 
    address payable public teamWalletAddress = payable(0x12830a9bfD52c5f0aEF4E0525aDb42453771cEc3); 
