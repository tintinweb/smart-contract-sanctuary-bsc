...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A3697343dCA82bf6579c4B89e903195B0BA3d70; // owner address
...
contract BullBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull Burn";
    string private _symbol = "BB";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x3A3697343dCA82bf6579c4B89e903195B0BA3d70); 
    address payable public teamWalletAddress = payable(0x3A3697343dCA82bf6579c4B89e903195B0BA3d70);
