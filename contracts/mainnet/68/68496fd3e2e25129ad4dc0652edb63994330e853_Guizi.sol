...
contract Guizi is Context, IERC20, Ownable {
    ...
    string private constant _name = "GUIZI INU"; // 
    string private constant _symbol = "GUI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xD3Fa078e3528B7e7E48D9b9ca3D66079a3A0a949;
