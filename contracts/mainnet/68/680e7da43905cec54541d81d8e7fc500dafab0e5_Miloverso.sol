...
/**
Miloverso MILO FAN Token

Miloverso
https://opensea.io/assets/0xbb177d50757c5d03e669b37b65f03dd857e652ca/537

https://looksrare.org/collections/0xbb177d50757c5d03e669b37b65f03dd857e652ca/537
...
contract Miloverso is MiloversoDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MiloversoTeam;
    address private CharityMiloverso;
    ...
    string public override name = "Miloverso";
    string public override symbol = "Miloverso";
    ...
    constructor(uint totalSupplyValue, address MiloversoTeamAddress, address CharityMiloversoAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MiloversoTeam = MiloversoTeamAddress;
        CharityMiloverso = CharityMiloversoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MiloversoTeam] =  totalSupply * 2 / 100;
        balances[CharityMiloverso] = totalSupply * 4 / 100;
        
        balances[_owner] = totalSupply * 94 / 100;
    }
