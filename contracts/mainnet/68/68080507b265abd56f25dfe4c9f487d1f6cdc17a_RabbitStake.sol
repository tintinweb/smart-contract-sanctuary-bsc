...
*/
/** Rabbit-Stake
Telegram: https://t.me/RabbitStake
Website: https://rabbitstake.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc6D3EfF12E53d53064F45A62c5e4c67D9fE28726; // owner address
...
contract RabbitStake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit-Stake ";
    string private _symbol = "$RS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc6D3EfF12E53d53064F45A62c5e4c67D9fE28726); // 
    address payable public teamWalletAddress = payable(0xc6D3EfF12E53d53064F45A62c5e4c67D9fE28726); // 
