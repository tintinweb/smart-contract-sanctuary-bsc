...
/**
    Surge Burn $SBURN //  The only Burn and Reward token for the SURGE Protocol (SRG20)
    ...
    Please buy $SBURN tokens ONLY via https://swap.surgeprotocol.io/ or directly from bscscan.com.
    Visit our website or telegram for more information and tutorial videos for purchasing SRG20 tokens.
    https://surgeburn.com
    https://twitter.com/surgeburn
    https://t.me/surgeburn
 */
...
contract SurgeBurn is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
