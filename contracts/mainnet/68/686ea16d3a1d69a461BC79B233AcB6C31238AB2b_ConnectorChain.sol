...
contract ConnectorChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "ConnectorChain";

    string private _symbol = "CC";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xd7Ee9A03F7f07953f379e5d07c0318240c805b17;
