...
contract HomeboyInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF2E8B8900A61697ef14fc8Fa08DF8b9EFe6c6f17); // Marketing Address
    ...
    string private _name = "HomeBoy Inu";
