...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        walletLimit = 100000000000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x255047067359C3EE848bd9c0D9470f3BAA730c1E;
...
contract BabyGreatDane is AbsToken {
    constructor() AbsToken(
        ...
        address(0x74268bF01B1Ffa900abb4FfDCED7430516De25bE),
    
        address(0x13F650160A068456813eEe0e1BAb281381050e70)
    ){
