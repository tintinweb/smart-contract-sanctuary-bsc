...
contract KTrump is Context, IERC20, Ownable {
    ...
    string private _name = "K-Trump";
    string private _symbol = "K-Trump";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x927EE6B1507f8B431Edb1815A15ABbf9C6385678);
