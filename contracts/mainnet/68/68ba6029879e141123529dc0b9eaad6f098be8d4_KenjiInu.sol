...
/**
Telegram https://t.me/KenjiInuBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18235E47317BA4764Ae2Cd97BACC29ff287FdB79; // owner address
...
contract KenjiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kenji Inu";
    string private _symbol = "$KINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18235E47317BA4764Ae2Cd97BACC29ff287FdB79); // Marketing Address
    address payable public teamWalletAddress = payable(0x18235E47317BA4764Ae2Cd97BACC29ff287FdB79); // Team Address
