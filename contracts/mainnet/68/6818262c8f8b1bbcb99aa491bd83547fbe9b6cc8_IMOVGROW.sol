...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEBBf7e5012436fc40e458193979cB7797F56c13e; // owner address
...
contract IMOVGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IMOVGROW";
    string private _symbol = "IMOVGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB074d0951ddfb4fa11A7f1227E3D190e3DEBeeD9); // Marketing Address
    address payable public teamWalletAddress = payable(0xB074d0951ddfb4fa11A7f1227E3D190e3DEBeeD9); // Team Address
