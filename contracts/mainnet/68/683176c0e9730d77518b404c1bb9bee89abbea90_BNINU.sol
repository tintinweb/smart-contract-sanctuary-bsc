...
contract BNINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x87DB37452C689364DA4799A1025F6Fdb63A01218);
    address payable public Wallet_Dev = payable(0x603C713d593637360744f2A627fC750C8a7cf52E);
    ...
    string private constant _symbol = unicode"BNINU";
