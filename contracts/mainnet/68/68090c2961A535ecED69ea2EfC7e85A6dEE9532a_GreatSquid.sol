...
contract GreatSquid
 is Context, IERC20, Ownable {
    ...
    string private _name = "GreatSquid";
    string private _symbol = "GreatSquid";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa36a47db87983db4622c6e994DA1C0D02Fc4D987));
        _anotherA = payable(address(0xa36a47db87983db4622c6e994DA1C0D02Fc4D987));
