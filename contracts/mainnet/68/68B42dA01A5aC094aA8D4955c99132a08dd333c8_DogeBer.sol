...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0xcEBfAF5178a989dF76ddcbAAfD8e3453551315D4, "Only owner");
...
contract DogeBer is ERC20, Ownable {
    ...
    address public marketingAddress = 0x2BB6D595B693731466C88F77D467eFFE8EF4b8eC;
    address public reserveAddress = 0xbdf91D291182f3E6e34b3bE5149bB1C16A4D8321;
    ...
    uint256 private reserveBuyFees = 1;
    uint256 private reserveSellFees = 3;
    uint256 private reserveTransferFees = 3;
    ...
    uint256 public totalBuyFees = reserveBuyFees.add(marketingBuyFees).add(liquidityBuyFee).add(RewardsBuyFee);
    uint256 public totalSellFees = reserveSellFees.add(marketingSellFees).add(liquiditySellFee).add(RewardsSellFee);
    uint256 public totalTransferFees = reserveTransferFees.add(marketingTransferFees).add(liquidityTransferFee).add(RewardsTransferFee);
    
    uint256 private countLiquidityFees = 0;
    uint256 private countReserveFees = 0;
    ...
    constructor() ERC20("Doge Ber", "DOGEBER") {
    ...
    function updateBuyFees(
        ...
        reserveBuyFees = newReserveFee;
        totalBuyFees = marketingBuyFees.add(liquidityBuyFee).add(RewardsBuyFee).add(reserveBuyFees);
    ...
    function updateSellFees(
        ...
        totalSellFees = marketingSellFees.add(liquiditySellFee).add(RewardsSellFee).add(reserveSellFees);
    ...
    function updateTransferFees(
        ...
        reserveTransferFees = newReserveFee;
        liquidityTransferFee = newLiquidityFee;
        RewardsTransferFee = newRewardsFee;
        totalTransferFees = marketingTransferFees.add(liquidityTransferFee).add(RewardsTransferFee).add(reserveTransferFees);
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            if (
                ...
                reserveFeeActual = reserveSellFees;
                ...
                to != address(uniswapV2Router)
                 ...
                 reserveFeeActual = reserveBuyFees;
                ...
                reserveFeeActual = reserveTransferFees;
            ...
            if (canSwap && !automatedMarketMakerPairs[from]) {
                ...
                swapAndSendReserveBNB(countReserveFees);
            ...
            uint256 fees = marketingFeeAmount + liquidityFeeAmount + RewardsFeeAmount + reserveFeeAmount;
    ...
    function swapTokensForBNB(uint256 tokenAmount, address account) private {
        if(tokenAmount <= 0){
            return;
        }
