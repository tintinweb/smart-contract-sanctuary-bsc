...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7cc5FCFF2ed8777d9e0b0890d2452502AFD2D3D;
...
contract Despartan is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa7cc5FCFF2ed8777d9e0b0890d2452502AFD2D3D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Despartan";
    string private _symbol = "DSN";
