...
contract DevGenious is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x82f41d9751ce99F32C3AbDE81C8a35DFD902f082); 
    address payable public Wallet_Dev = payable(0x841C02Be17c956998C6a322A07200C6F094d3A0E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x841C02Be17c956998C6a322A07200C6F094d3A0E); 
    ...
    constructor () {
        ...
        _owner = 0x841C02Be17c956998C6a322A07200C6F094d3A0E;
