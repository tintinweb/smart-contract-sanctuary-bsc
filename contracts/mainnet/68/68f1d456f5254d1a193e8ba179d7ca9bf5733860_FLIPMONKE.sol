...
/*
    like monke to etheerium da donke to beeinbee

    hee haw for busd rewardz

    this ass haz no home so me hopes yous makes one fer all ze donkes to lib in
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)); // BUSD - 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
...
contract FLIPMONKE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ILLUMINATE", "DONKE") {
