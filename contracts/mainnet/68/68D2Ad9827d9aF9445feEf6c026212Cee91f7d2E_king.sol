...
contract king is Context, IERC20, Ownable {
    ...
    string private _name = "\u82cd\u4e95\u7a7a";
    string private _symbol = "\u82cd\u8001\u5e08";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57b9275226C17249d9D1bD0572Af4253c77b567E);
    ...
    uint256 private _totalSupply =  4100 * 10**_decimals;
    uint256 public _maxTxAmount =   4100 * 10**_decimals; 
    uint256 public _walletMax =     4100 * 10**_decimals;
