...
contract TryGPT is IERC20, Ownable {
    ...
    string constant _name = "Try GPT";
    string constant _symbol = "TryGpt";
 ...
 transfer(address recipient, uint256 amount) external override returns (bool) {
    ...
    function setIsFeeExempt(address holder, bool exempt) external onlyOwner {
        ...
        emit UpdatedSettings(exempt
 ? 'Fees Removed' : 'Fees Enforced', [Log(toString(abi.encodePacked(holder)), 1), Log('', 0), Log('', 0)]);
    }
