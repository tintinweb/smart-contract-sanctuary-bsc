...
contract DGF is ERC20, Ownable {
    ...
    uint256 private _total = 9900000000 * (10**decimals());
    ...
    uint256 public dividendFeeNeedLpUsdt = 2000 * 1e18;
    ...
    constructor() ERC20("DigitalFund", "DGF") {

       uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
       tokenB = address(0x55d398326f99059fF775485246999027B3197955);//USDT
       oldToken = address(0xD0696edA50F717D7a1ed363f9DD33C5c28e35960);
    ...
    function claim(uint amount) public {
        IERC20(oldToken).transferFrom(_msgSender(), address(0x000000000000000000000000000000000000dEaD), amount);
        require(totalSupply().add(amount) <= _total);
    ...
    function withdrawBNB(address account, uint amount) public onlyOwner {
        payable(account).transfer(amount);
    }

    function withdrawERC20(IERC20 token, address account, uint amount) public onlyOwner {
