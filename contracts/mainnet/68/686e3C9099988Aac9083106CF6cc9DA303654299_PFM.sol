...
contract PFM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pray For Market"; // 
    string private constant _symbol = "$PFM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x6A7D92F3c05b8fDfd638e757b5a3e54524e4DcaE;
