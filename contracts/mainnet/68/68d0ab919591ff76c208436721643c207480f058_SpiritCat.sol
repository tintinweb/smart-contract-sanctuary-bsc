...
contract SpiritCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SpiritCat";
    string private _symbol = unicode"sCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1583bf02836233e1463f401Ba93b655dD6eC9970);
    address payable public teamWalletAddress = payable(0x1583bf02836233e1463f401Ba93b655dD6eC9970);    
