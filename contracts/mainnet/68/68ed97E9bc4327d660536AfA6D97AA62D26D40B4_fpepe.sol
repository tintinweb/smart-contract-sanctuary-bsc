...
/*
  ...
  TELEGRAM: https://t.me/FlokiPepe
  WEBSITE: https://FlokiPepe.com
  TWITTER: https://twitter.com/FlokiPepe
*/
...
contract fpepe is Ownable, IBEP20 {
    ...
    string constant _name = "Floki Pepe";
    string constant _symbol = "FPEPE";
    uint8 constant _decimals = 8;

     // Mystery Functions

    uint256 _totalSupply = 420000000000 * 1**_decimals;
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x84c96374cCf27747cA23a5121586A440c2FE0A99;
        marketingFeeReceiver = 0x84c96374cCf27747cA23a5121586A440c2FE0A99;
    ...
    function setTaxes(uint256 _liquidityFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setReceiverWallets(address _autoLiquidityReceiver, address _marketingFeeReceiver) external onlyOwner {
