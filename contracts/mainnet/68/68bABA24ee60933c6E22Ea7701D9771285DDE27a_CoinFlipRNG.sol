...
// File: contracts/interfaces/ICoinFlip.sol
...
// File: contracts/CoinFlipRNG.sol
...
contract CoinFlipRNG is VRFConsumerBaseV2 {
  ...
  address vrfCoordinator = 0xc587d9053cd1118f25F645F9E08BB98c9712A4EE; // for bsc testnet
  bytes32 keyHash = 0x114f3da0a805b6a67d6e9cd2ec746f7028f1b7376365af575cfea3550dd1aa04; // for bsc testnet
  uint64 s_subscriptionId; //  on BSC Testnet
  ...
  function requestRandomWords(uint256 session) external onlyCoinFlipContract {
  ...
  function flipCoin() external view onlyCoinFlipContract returns (uint256 result) {
  ...
  function flipAndClose(uint256 session, uint256 seed) internal {
    ...
    CoinFlip.autoFlip(session, uint8(result));
  }
