...
contract NestleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NestleInu";
    string constant _symbol = "NESTLE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 3 ) / 300; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x113eF627E729170046afA52520808C7F27C3900a;
