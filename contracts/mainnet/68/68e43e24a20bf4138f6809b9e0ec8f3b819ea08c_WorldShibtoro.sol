...
World shibtoro is NFT MEME METAVERSE FOR THE https://www.shibtoro.com/
https://twitter.com/Shibtoro

We have an official partnership with @ZachBoychuk . #Shibtoro in his bio. Probably nothing 🤫🚀🔥
https://twitter.com/ZachBoychuk
🏒Pro Hockey Player & Part time Meme/NFT Trader 💰🚀Ethereum Maxi 💎Proud Ambassador to $LOCKER $SHIBTORO & OvermoonBSC 🌌| (not financial advice) 📈🚀#Bitcoin

https://t.me/s/shibtoro
LP LOCK 
RO
3% MAXTX
 ...
 * the owner.
 */
contract OwnableWorldShibtoro is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableWorldShibtoro: caller is not the owner");
        _;
    }
    ...
    */
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableWorldShibtoro: new owner is the zero address");
...
contract WorldShibtoro is Context, IBEP20, OwnableWorldShibtoro {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WorldShibtoro";
    string private _symbol = "WSHIBTORO";
    ...
    address payable private _marketingWallet = payable(0x0D45b846566Ad5d1a92E89812e7c2D79461B4785);
