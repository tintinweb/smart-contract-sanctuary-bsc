...
contract BEMYLOVE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BE MY LOVE";
    string private _symbol = "BEMYLOVE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5CaAba9E0508D759908F4Aa98bf6234b7c246C7E);
