...
contract BitcoinAI is ERC20, Ownable {
    ...
    BitcoinAIDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BitcoinAI", "BTCAI") {
        marketingWallet = payable(0x510159Cda4daC670f79Ac380E8Cd5e46230a0689);
        devWallet = payable(0x510159Cda4daC670f79Ac380E8Cd5e46230a0689);
        ...
        dividendTracker = new BitcoinAIDividendTracker(
            payable(this),
            router,
...
contract BitcoinAIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BitcoinAI public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BitcoinAI(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BitcoinAI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BitcoinAI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BitcoinAI contract."
        );
    }
