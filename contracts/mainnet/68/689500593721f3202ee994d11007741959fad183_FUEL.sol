...
contract FUEL is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000 * 10**18; // 0.1%
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        ...
        require(_taxFee + _liquidityFee + _marketingFee <= 20,"Taxes can't be set more then 20%" );
    }
    ...
    function setNumOfTokensSellToAddLiquidity(uint256 _newAmount) external onlyOwner() {
        numTokensSellToAddToLiquidity = _newAmount *10**18;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        //Temporarily remove fees to transfer to marketing address
        removeAllFee();
