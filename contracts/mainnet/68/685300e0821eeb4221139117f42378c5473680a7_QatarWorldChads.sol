...
TELEGRAM : https://t.me/qatarworldchads
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9EafFeB13d140a1CBC99381e5B87608f3fe5AfaC; // owner address
...
contract QatarWorldChads is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Qatar World Chads ";
    string private _symbol = " QWC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9EafFeB13d140a1CBC99381e5B87608f3fe5AfaC); // Marketing Address
    address payable public teamWalletAddress = payable(0x9EafFeB13d140a1CBC99381e5B87608f3fe5AfaC); // Team Address
