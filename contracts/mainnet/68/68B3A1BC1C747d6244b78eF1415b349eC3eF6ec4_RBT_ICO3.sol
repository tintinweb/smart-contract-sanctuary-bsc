...
contract RBT_ICO3 is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public  RATE = 33000000;
  uint256 public  CAP = 4760; // Cap in BNB
  uint256 public  START = 1660746599; //Aug 17 2022
  ...
  uint256 public constant initialTokens = 100000000000000 * 10**16; // Initial number of tokens available
