...
// Community Token Made By Liquidity Generator Contract
...
contract SaudiBTC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi BTC";
    ...
    address marketingAddress = 0xCBc38489230fcD67eB16d33224677234B96A5bec;
    ...
    constructor () {
        ...
        _isTxLimitExempt[marketingAddress] = true;
    ...
    function proportionThisToken(uint256 tokens) private {
        _tOwned[marketingAddress] = _tOwned[marketingAddress]+tokens;
    }
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(marketingAddress).transfer(ethToSend);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(marketingAddress).sendValue (ethAmount - ethFromLiquidity);
    }
