...
/**
BossDoge
The top leader of all the Doges, BossDoge will soon launch in BSC.
BossDoge is a low tax gem token that everybody's looking for, and tax that is collected from all the transactions also goes for community. BossDoge is building a strong & powerful community with mission to go for long term.

BossDoge Tokenomics
Supply : 10,000,000,000,000 (10 Trillion)
Initial LP : 1 BNB ( ± $270 )
Tax : 5%
- 2% for Marketing
- 1% for Reflection
- 2% for LP

Fairlaunch at 8th September, 2:50 PM UTC.
Contract address to be announce.

TG: https://t.me/BossDogeInu
*/
...
contract BossDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "BOSSDOGE"; // 
    string private constant _symbol = "BOSSDOGE"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xc934787a48A427e5E4A2147293a6b624378e6e37;
