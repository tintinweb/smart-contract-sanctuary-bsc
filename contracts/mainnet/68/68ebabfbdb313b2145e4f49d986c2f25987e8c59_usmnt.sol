...
contract usmnt is ERC20, Ownable {
    ...
    constructor() ERC20("USMNT", "USMNT") 
    {
        ...
        taxWallets["liquidity"] = address(0xee73d02d537287f3e8e2e8Aa4B021673C84f627d); //
        setBuyTax(4,2); //marketing tax, liquidity tax
        setSellTax(4,2); //marketing tax, liquidity tax
        setEarlyTax(6, 4); // early sell marketing tax, early sell liquidity tax
        
        setTaxWallet(address(0xee73d02d537287f3e8e2e8Aa4B021673C84f627d)); // 
        exclude(msg.sender);
    ...
    function setSellTax(uint256 marketing, uint256 liquidity) public onlyOwner {
        require (marketing + liquidity <= 10, "Max Sell Tax limit is 10%");
    ...
    function setEarlyTax (uint256 marketing, uint256 liquidity) public onlyOwner {
        require (marketing + liquidity <= 15, "Max early Sell Tax limit is 15%");
