...
/**
 ...
 Telegram : https://t.me/ShibaBullishToken
...
contract ShibaBullishToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaBullish"; //
    string private constant _symbol = "$SBullish"; //
