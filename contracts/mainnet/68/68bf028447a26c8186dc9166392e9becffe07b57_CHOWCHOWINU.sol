...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe63eE679d74bF3B43fe21fEB150D091819Ac9FE1; // owner address
...
contract CHOWCHOWINU is Context, IERC20, Ownable {
    ...
    string private _name = "Chow Chow INU";
    string private _symbol = "CHW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9Fd638c9Ad887accAE922D73Ba03a6692363F712); // Marketing Address
    address payable public teamWalletAddress = payable(0x2130f4bFD2e56D6404f1ec6Fe27321Ff92E1838B); // Team Address
