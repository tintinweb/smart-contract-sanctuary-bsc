...
contract AVOTEO is IBEP20, Ownable
{
    ...
    string private constant _name = "AVOTEO";
    ...
    address public constant TeamWallet=0xeED961d1df5489202c1bfe4B261e2e1FD9EBec86;
    ...
    uint8 private _buyTax=100;
    uint8 private _sellTax=100;
    uint8 private _transferTax=100;
