...
contract SHIBNEKOKX is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibNekokx"; // 
    string private constant _symbol = "$SHIBNEKOKX"; //    
