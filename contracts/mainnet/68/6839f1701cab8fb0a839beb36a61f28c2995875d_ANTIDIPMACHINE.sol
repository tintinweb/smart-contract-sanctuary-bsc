...
contract ANTIDIPMACHINE is Context, Ownable {
    address busd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address private feeAddress = 0x3B5D7fd7a81A45BDC4d1305767Ba91d1fD68C581;
    ...
    function withdraw() public {
        ...
        require(users[msg.sender].withdraw <= users[msg.sender].deposit * 500 / 100, "err: shouldn't withdraw more than 500%");
    ...
    function deposit(address ref, uint256 amount) public {
        ...
        if (users[msg.sender].lastTime != 0) {
            require(users[msg.sender].lastTime + 3600 * 24 * 1 < block.timestamp, "err: not in time");
        }
        require(amount >= 5 * 10**18, "err: should greater than 5");
        ...
        {
            uint256 referralFee = amount * 12 / 100;
    ...
    function getRewardsSinceLastDeposit(address adr) public view returns(uint256) {
        uint256 secondsPassed=min(86400, block.timestamp - users[adr].lastTime);
        return secondsPassed * users[adr].deposit / 1080000;
    }
