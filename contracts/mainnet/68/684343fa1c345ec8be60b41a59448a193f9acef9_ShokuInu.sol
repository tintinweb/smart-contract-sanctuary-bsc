...
contract ShokuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shoku Inu";
    string private _symbol = "SHOKUINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Ab35813Fa194026DCCf2D20A291284e6b7C4904);
    address payable public BuyBackWalletAddress = payable(0x0Ab35813Fa194026DCCf2D20A291284e6b7C4904);
