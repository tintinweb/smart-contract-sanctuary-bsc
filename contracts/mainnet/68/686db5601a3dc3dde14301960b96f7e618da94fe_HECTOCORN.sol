...
Telegram https://t.me/HectocornChainBsc
Website https://hectocornchain.com/
*/
...
contract HECTOCORN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HECTOCORN CHAIN";
    string private _symbol = "$HECTO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68C8dC93D3c2685FEF046A37038ECE4b8a3220d7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x10bD02174BeF2B1f62EacF7f82DE876A6ED0Bf72); // BuyBack Address
