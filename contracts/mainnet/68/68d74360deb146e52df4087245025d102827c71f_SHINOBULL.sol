...
contract SHINOBULL is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0xBb621A50E71f02ce94Bd1d4CB721e0e9fBc1b90F);
    address public DevelopmentWallet =
        0xfD0D9f05A90a888308f595f0D5cB0777166AB3ca;
    ...
    string private constant _name = "Shinobull Inu";
    string private constant _symbol = "SHINOBULL";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**9 * 10**18;
    uint256 public _maxTxAmount = 1 * 10**10 * 10**18;
    uint256 public _maxWalletHoldingLimit = 2 * 10**10 * 10**18;
