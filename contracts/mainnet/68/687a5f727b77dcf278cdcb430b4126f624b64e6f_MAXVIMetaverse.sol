...
💎 MAXVI 💎
Exclusive KTV and lounge

We are the metaverse based in Hanoi, ViệtNam. Our company was growing and we needed support holder to raise MAXVI. We have cafes and thriving in the blockchain world. On progress soon
...
contract MAXVIMetaverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "MAXVI Metaverse"; // 
    string private constant _symbol = "MAX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x16C549AEd028666266B9932EAd1B0C7E02504285;
