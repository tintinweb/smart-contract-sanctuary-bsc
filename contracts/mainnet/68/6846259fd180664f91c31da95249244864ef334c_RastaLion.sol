...
/** 
BSC MEME COIN HYPE IS BACK! 

Introducing Rasta Lion, a meme token that will set a new trend.

💰 TAX 7/7
💰 RENOUNCED OWNERSHIP
💰 100% LP BURNED (LOCKED FOREVER)
💰 EXPERIENCED DEV.
💰 PREVIOUS PROJECTS HIT 50K.
💰 HUGE MARKETING BACKGROUND

TELEGRAM: https://t.me/rastalionofficial

| WEBSITE IN PROGRESS |
| UTILITIES BEING DISCUSSED |
...
contract RastaLion is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rasta Lion"; // 
    string private constant _symbol = "RLion"; //    
    uint8 private constant _decimals = 9; // 
    bool private trading = true;
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x6635f0d1E6e3C7A021d00DAb32612562DACEeCca;
