...
contract XRPg is ERC20, Ownable {
    ...
    XRPgDividendTracker public dividendTracker;

    address public immutable XRP = address(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); //XRP

    address public marketingWallet = 0xc5FC8FD6734D4496092F699241C2e1A7A913Cad3;
    address public devWallet = 0xe218aD2022a20fC884E3Af3fac282d9B889c0F4C;

    uint256 public swapTokensAtAmount = 840_000_000_000_000 * 10**9;
    uint256 public maxWalletAmount = 7e15 * 10**9;
    uint256 public maxBuyAmount = 7e15 * 10**9;
    uint256 public maxSellAmount = 420e15 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(3,5,0,2);
    Taxes public sellTaxes = Taxes(3,5,0,2);
    ...
    constructor() ERC20("XRP GROVE TOKEN", "XRPg") {

    	dividendTracker = new XRPgDividendTracker();
        ...
        */
        _mint(owner(), 420e15* (10**9));
    }

    receive() external payable {}
    function updateDividendTracker(address newAddress) public onlyOwner {
        XRPgDividendTracker newDividendTracker = XRPgDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "XRPg: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "XRPg: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "XRPg: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "XRPg: Cannot update gasForProcessing to same value");
   ...
   ////////////////////////
    ...
    function swapTokensForXRP() private {
...
contract XRPgDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("XRPg_Dividen_Tracker", "XRPg_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 1000000000000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "XRPg_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "XRPg_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "XRPg_Dividend_Tracker: Cannot update claimWait to same value");
