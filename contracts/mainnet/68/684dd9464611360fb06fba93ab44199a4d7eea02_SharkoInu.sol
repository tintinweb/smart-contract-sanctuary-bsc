...
WEBSITE: under development ...
 ...
 Tokenomics: 
  ...
  Dev: 3%
  Max wallet: 3%
  Tax at launch: BUY/SELL: 2%/20% (1% lp both and 1%/19% $BUSD rewards)
...
contract SharkoInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sharko Inu";
    string constant _symbol = "SHARKO";
    ...
    uint256 public _walletMax = ( _totalSupply * 3 ) / 100; // 3% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x78Fa07081c5c4cA9486217EB68945f2Aa40Cd8F7; // DEV WALLET
        marketingWallet = 0x78Fa07081c5c4cA9486217EB68945f2Aa40Cd8F7;  // MARKETING WALLET
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountSHARKO);
