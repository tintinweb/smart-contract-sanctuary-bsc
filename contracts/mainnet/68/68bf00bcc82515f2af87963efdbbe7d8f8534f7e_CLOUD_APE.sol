 ...
 * ✅ 1% Developer
 * ✅ 100% Liquidity CLOA-BNB: 5 BNB
 * ✅ Fair Launch
 * 
 * 🔥 On Every Transaction
 * ✅ 1% fee auto add to the liquidity pool with each and every transaction
...
contract CLOUD_APE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cloud Ape";
    string private constant _symbol = "CLOA";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x593B2Dcd57692d8A9eD44E27b0Db41c08D66E4a4;
