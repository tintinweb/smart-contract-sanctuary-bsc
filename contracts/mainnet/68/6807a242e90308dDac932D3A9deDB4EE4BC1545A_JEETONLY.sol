...
contract JEETONLY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x41A62c20022947A387F33ab768C7535A15dC1064); // Marketing Address
        
    address payable public teamAddress =
        payable(0x41A62c20022947A387F33ab768C7535A15dC1064); // BuyBack Address
    ...
    string private constant _name = "JEETONLY";
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(teamAddress).call{value: bnbForBuyBack}("");
        (success,) = address(marketingAddress).call{value: bnbForMarketing}("");
        (success,) = address(0x41A62c20022947A387F33ab768C7535A15dC1064).call{value: bnbForDev}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBuybackFee <= 30, "Must keep taxes below 30%");
