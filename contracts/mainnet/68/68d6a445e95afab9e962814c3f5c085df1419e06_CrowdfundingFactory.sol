...
contract CrowdfundingFactory {
    ...
    event Campaign(address indexed contractAddress, address indexed payment, address indexed owner, uint128 start, uint128 ended, uint256 sale);
    ...
    function createContract(uint128 _start, uint128 _ended, uint256 _sale) public onlyOwner {
        ...
        // emit event
        emit Campaign(newContract, payment, owner, _start, _ended, _sale);
    }
