...
contract FSDCanadaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FSDCanadaCoin";
    string private _symbol = "FSDCanadaCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F52794Bc488f1FDeF014c0A9fDFBe78B1e0CE0a); 
    address payable public buyBackWalletAddress = payable(0x5F52794Bc488f1FDeF014c0A9fDFBe78B1e0CE0a); 
    ...
    uint256 public _walletMax =  50 * 10**9 * 10**9; 
