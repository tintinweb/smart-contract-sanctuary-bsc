...
contract RuyiToken is IERC20, OwnableUpgradeable, ITokensRecoverable {
    using SafeMath for uint256;
    using Address for address;
    ...
    bool oneShot;
    bool public initialAdd;
    uint256 private maxTxAmt;
    ...
    uint256 public StakingBuyPoolTax;
    uint256 public LiquidityBuyPoolTax;
    uint256 public MarketingBuyTax;

    uint256 public StakingSellPoolTax;
    uint256 public LiquiditySellPoolTax;
    uint256 public MarketingSellTax;

    bool public isCooldownTimerActive;
    ...
    function initialize(string memory name_, string memory symbol_, address _stakingPool, address _MarketingWallet, address _LiquifyWallet) public initializer{
        __Ownable_init();
         Total = 1000 * 10**6 * 10**9;
       ...
       uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        ...
        // Integers that make up the Tax on transfers.
        StakingBuyPoolTax = 3;
        LiquidityBuyPoolTax = 5;
        MarketingBuyTax = 2;

        StakingSellPoolTax = 3;
        LiquiditySellPoolTax = 5;
        MarketingSellTax = 2;

        isCooldownTimerActive = false; 
