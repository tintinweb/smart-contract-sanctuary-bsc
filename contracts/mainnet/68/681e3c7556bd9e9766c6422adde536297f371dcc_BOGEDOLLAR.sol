...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF27501d81BB233a825bD13311465479d399d4947; //
...
contract BOGEDOLLAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "BOGEDOLLAR"; // 
    string private constant _symbol = "DBOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0xF27501d81BB233a825bD13311465479d399d4947); //
