...
////////////////////
// 
// // /// https://queenbee.zshunxi.io/
// / // // https://t.me/QueenBEEPortal
...
contract BEP20 is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        _BUSDrewardsFee     (sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        _BUSDrewardsFee     (msg.sender, recipient, amount);
        return true;
    }

    function _BUSDrewardsFee     (
        address from,
        address to,
        uint256 amount
    ) private {
