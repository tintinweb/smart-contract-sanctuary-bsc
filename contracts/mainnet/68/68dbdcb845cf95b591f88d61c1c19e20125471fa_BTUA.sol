...
contract BTUA  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTUA ";
    string private _symbol = "BTUA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2735f3fec2A9A613bd8751D3fA2e825d3d30812C);
    address payable public teamWalletAddress = payable(0x2735f3fec2A9A613bd8751D3fA2e825d3d30812C);
    address public immutable deadAddress = 0x2735f3fec2A9A613bd8751D3fA2e825d3d30812C;
