...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdF3A3B8edabc6B8d7c3af26c389D6981fB7B9a7D; // owner address
...
contract ShibaQUEENII is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Queen II";
    string private _symbol = "SHIBQUEEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdF3A3B8edabc6B8d7c3af26c389D6981fB7B9a7D); // Marketing Address
    address payable public teamWalletAddress = payable(0xdF3A3B8edabc6B8d7c3af26c389D6981fB7B9a7D); // Team Address
