...
contract TWITTERCEOINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Twitter CEO Inu";
    string private constant _symbol = unicode"CEOINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**12 * 10**_decimals;

    address payable public DevWallet = payable(0x0160dB5deb8b70A5ba552C093b9228311920E054);
    address payable public MarketingWallet = payable(0x0160dB5deb8b70A5ba552C093b9228311920E054);
