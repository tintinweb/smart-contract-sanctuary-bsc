...
// Telegram: https://t.me/MessiahFanToken
// Twitter: https://twitter.com/MessiahFanToken
// Messiah Fan Token
...
contract MessiahFanToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Messiah Fan Token";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xC543Ed16970c705cC79069BD49A6CffD1096eE9B;
