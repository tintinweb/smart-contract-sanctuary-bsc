...
contract TOKEN is IERC20, Ownable {
    ...
    uint256 private _totalSupply = 4200 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 420; // 10000;
    uint256 private _maxTransferPercent = 420;
    uint256 private _maxWalletPercent = 420;
    ...
    uint256 private swapThreshold = ( _totalSupply * 75 ) / 420;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 420;
    modifier lockTheSwap {swapping = true; _; swapping = false;}


    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0xec4ad2F39b4a9E17B25626f435f67656e74ee9f4; 
    address internal constant marketing_receiver = 0xec4ad2F39b4a9E17B25626f435f67656e74ee9f4;
    address internal constant liquidity_receiver = 0xec4ad2F39b4a9E17B25626f435f67656e74ee9f4;
