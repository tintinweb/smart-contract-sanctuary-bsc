...
contract KittyBNB is IPYE, Context, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public {
        ...
        _defaultFees = Fees(
            ...
            0,
            0,
            0xE92D9018015df29C5cEd5F9bF4e4b21389e962c1,
            0xE92D9018015df29C5cEd5F9bF4e4b21389e962c1
        );

        IPYESwapPair(pyeSwapPair).updateTotalFee(0);
        
        emit Transfer(address(0), _msgSender(), _tTotal);
    }

    function isBOT(address addressToBlacklist) public onlyOwner {
        require(!isBlacklisted[addressToBlacklist] , "Address is already blacklisted!");
        isBlacklisted[addressToBlacklist] = true;
    }

    function isNotBot(address addressToRemove) public onlyOwner {
