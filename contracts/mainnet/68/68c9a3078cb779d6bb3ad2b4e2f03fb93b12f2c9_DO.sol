...
contract DO is Context, IERC20, Ownable {
    ...
    string private _name = "DO ";
    string private _symbol = "DO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6912F7a7a4578748a85f6045110c6920fD388d32));
        marketingWalletAddress = payable(address(0x6912F7a7a4578748a85f6045110c6920fD388d32));
