...
contract babyrabbitzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babyrabbitzilla";
    string private _symbol = "babyrabbitzilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xABB119092dD9D07130FA8603b04A1f2D274E3e98); 
    address payable public ttWal = payable(0xABB119092dD9D07130FA8603b04A1f2D274E3e98); 
