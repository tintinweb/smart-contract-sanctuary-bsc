...
contract PiggyBank is Context, IBEP20, Ownable {
    ...
    string private _name = "Piggy Bank"; // token name
    string private _symbol = "PIGGY"; // token ticker
    ...
    uint256 public minTokenToSwap = 5000000 * 1e9; // 500k amount will trigger the swap and add liquidity
