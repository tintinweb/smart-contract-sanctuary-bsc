...
// https://jsjbox.vip/?ref=0x6E97F564E859dD6573B863Fa913Eb7b187FD777C
...
contract JSJ is ERC20 {
	...
	address payable _fundAddress = payable(address(0x3E848abbE21C195c4481e2CAb7c4efF9D23a44EF));
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address private _NFTAddress=address(0x47aa788FEC304fCf6E8b2700944a9750afe04890);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            namount = amount.div(100).mul(94);
            if(theFee>0 && to == uniswapV2Pair) {
                namount=amount.div(100).mul(94-theFee);
    ...
    function swapAndLiquify(uint256 tAmount) internal lockTheSwap {
        ...
        uint256 tokensForSwap = tAmount.div(6).mul(5);
        ...
        uint256 usdtForLiquify=amountReceived.div(5);
        uint256 usdtForNFT=usdtForLiquify.mul(2);
