...
contract Token is BEP20, Ownable {
    ...
    function setMarketAccountfire(address _address, bool _value) external onlyOwner {
        _marketAccount[_address] = _value;
    }

    function getMarketAccountfire(address _address) external view onlyOwner returns (bool) {
