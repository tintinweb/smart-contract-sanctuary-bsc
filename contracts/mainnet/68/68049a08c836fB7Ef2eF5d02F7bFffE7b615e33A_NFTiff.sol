...
contract NFTiff is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NFTiff";
    string private _symbol = "NFTiff";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xCA8E5b2323bF1Ade25838CC2c13101c9723a4b00);
    address payable public teamWalletAddress = payable(0xCA8E5b2323bF1Ade25838CC2c13101c9723a4b00);
