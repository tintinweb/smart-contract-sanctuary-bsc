...
contract Krishna is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x6DfE7CaBdcD32594f657430ADD330b6eFd3b9Ff1);

    string private _name = "CATSking";
    string private _symbol = "CATSKing";
