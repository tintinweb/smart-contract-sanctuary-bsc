...
contract used is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function isTxPercentage(uint256 maxTXPercentage) external onlyOwner {
