...
//Iriomote cat is a subspecies of the leopard cat that lives exclusively on the Japanese island of Iriomote. It has been listed as critically endangered on the IUCN Red List since 2008, as the only population comprises fewer than 250 adult individuals and is considered declining

//our goal is to protect the population of every animal no matter what breed it is so that it doesn't run out we will donate what they need to protect each breed
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79C47cCF76Fed5ac31e096003BEBcfC9DE9752a4;
...
contract IriomoteGirlCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Iriomote Girl Cat"; // 
    string private constant _symbol = "IGCAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x79C47cCF76Fed5ac31e096003BEBcfC9DE9752a4);
