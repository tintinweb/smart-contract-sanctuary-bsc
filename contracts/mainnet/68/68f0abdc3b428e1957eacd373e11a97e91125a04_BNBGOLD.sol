...
contract BNBGOLD is Context, IERC20, Ownable {
    ...
    string private _name = "Binance Gold";
    string private _symbol = "BNBGOLD";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x42b9bF68708eB55C897bCBd3Ea59b50eD6b3C46C));
        marketingWalletAddress = payable(address(0x42b9bF68708eB55C897bCBd3Ea59b50eD6b3C46C));
