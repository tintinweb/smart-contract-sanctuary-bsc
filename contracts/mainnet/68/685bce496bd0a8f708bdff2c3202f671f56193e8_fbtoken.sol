...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xaCDb44aD1a84327bDC2C06f4e177d3C722C1ee05;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xaCDb44aD1a84327bDC2C06f4e177d3C722C1ee05),//fund address
    
        address(0xaCDb44aD1a84327bDC2C06f4e177d3C722C1ee05)//dev address
    ){
