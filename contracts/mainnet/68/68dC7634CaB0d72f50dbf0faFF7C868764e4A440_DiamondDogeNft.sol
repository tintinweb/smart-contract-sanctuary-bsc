...
contract DiamondDogeNft is ERC721Enumerable, Ownable {
    ...
    address public marketingWallet = 0xE64bF571Ba0EbFE11656A962164c66866d048C77;
    string public baseTokenURI; // Can be combined with the tokenId to create the metadata URI
    uint256 public MINT_PRICE = 0.5 ether; // Public mint price
    uint256 public MAX_TOTAL_SUPPLY = 100; // The maximum total supply of tokens
    bool public _enableMint = true;

    uint256 public mint_num_per_action = 100;
    uint256 public mint_num_per_wallet = 100;
    ...
    constructor(string memory _baseUri) ERC721("Diamond Doge", "DD") {
    ...
    function mint(uint256 _amount) external payable {
        ...
        uint256 mintPrice = MINT_PRICE * _amount;
