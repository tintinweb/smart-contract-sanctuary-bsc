...
contract POKECH is Context, IBEP20, Ownable {
...
//adding multiple addresses to the blacklist - Used to manually block known bots and scammers
    function setBlacklist(address[] calldata addresses) external onlyOwner {
