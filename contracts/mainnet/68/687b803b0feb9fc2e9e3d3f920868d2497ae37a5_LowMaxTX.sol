...
contract LowMaxTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Low Max TX & Fee";
    string private _symbol = "LowMax&Fee";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2422710e6764Fb49401Bc0Cc3E187AC5fA2e929B); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x2422710e6764Fb49401Bc0Cc3E187AC5fA2e929B); // Developmental Address
