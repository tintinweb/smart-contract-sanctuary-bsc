...
Telegram :     https://t.me/BabyZakumiFi
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x117AcC7b64588b0dD1f75a1b01b3a4c46A095294;
...
contract BabyZakumiFi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby ZakumiFi"; // 
    string private constant _symbol = "BBZakumiFi"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x117AcC7b64588b0dD1f75a1b01b3a4c46A095294);
