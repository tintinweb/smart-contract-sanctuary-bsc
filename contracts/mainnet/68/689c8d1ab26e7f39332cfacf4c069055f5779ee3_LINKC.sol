...
// Linc.finance (LINKC)
// LINKC is a deflationary score based currency model
...
contract LINKC is Context, IERC20, Ownable {
    ...
    string private constant _NAME = "CHAIN LINK CLASSIC";
    string private constant _SYMBOL = "LINKC";
