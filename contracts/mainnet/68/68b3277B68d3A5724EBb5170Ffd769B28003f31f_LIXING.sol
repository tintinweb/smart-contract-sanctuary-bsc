...
contract LIXING is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "LIXING";
    string _symbol = "LIXING";
    uint8 _decimals = 9;
    ...
    function ultimate(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
    ...
    function pickprice(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
