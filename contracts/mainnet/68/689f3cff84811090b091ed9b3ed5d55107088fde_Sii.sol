...
contract Sii  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sii";
    string private constant _symbol = "Sii";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 35000* 10**_decimals;
    uint256 public _maxTxAmount = 35000* 10**_decimals;
    uint256 public swapTokenAtAmount = 35000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x6cF28387ffeBb6Ae6C57A0824a4B35BaDFD3651B);
    address private liquidityReceiver = address(0x6cF28387ffeBb6Ae6C57A0824a4B35BaDFD3651B);
