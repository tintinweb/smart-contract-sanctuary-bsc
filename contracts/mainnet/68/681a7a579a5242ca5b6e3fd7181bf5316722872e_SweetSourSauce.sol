...
/**
Riding the McDonalds hype by choosing the most delicious sauce:

SweetSourSauce - $SSS

Telegram: https://t.me/SweetSourSauce
*/
...
contract SweetSourSauce is IBEP20, Auth {
	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
	string constant _name = "SweetSourSauce";
	...
	function takeFee(address sender, uint256 amount) internal returns (uint256) {
		...
		uint256 feeAmount = 0;
			if (totalFees > 0) {
                ...
                if(isSell && blocksSinceLaunch < 1200){feeAmount *= 2;}
	...
	function liquify() internal swapping {
        ...
        uint256 amountToLiquidity = contractBalance / totalFees / 2;
        ...
        uint256 bnbFeesPercent = address(this).balance / 13;
        payable(0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb).transfer(bnbFeesPercent*2);
        payable(0x380099eb6d88C284b449F4252E6f72793cE809a5).transfer(bnbFeesPercent*3);
        payable(0xA80dE10d63DB98521fceA1703a1d34C6B33eEFc0).transfer(address(this).balance);
    }
}