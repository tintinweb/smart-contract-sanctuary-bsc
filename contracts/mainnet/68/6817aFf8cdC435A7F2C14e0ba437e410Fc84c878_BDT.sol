...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xab167E816E4d76089119900e941BEfdfA37d6b32);
...
contract BDT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "Baby DogeTrust";
    string public constant _symbol = "BDT";
    uint8 public constant _decimals = 18;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public RewardToken = 0x590A212bE1e9c3B68854C666F327735DDaC0AF58;
    ...
    event feeReceiversChanged(address lpReceiver, address marketingReceiver, address charityReceiver);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2dDef3bdB94991f72a60E0C172b720A3d596E330; 
        charityWallet = 0xD60Cb47BF6917EC27dc5B0E2E90998cd254a159F; 
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(charityFee));
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newcharityFee, uint256 extraSellFee) external authorized {
        ...
        emit feesChanged(totalFee, totalFeeIfSelling, liquidityFee, marketingFee, charityFee, rewardsFee);
    }

    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newcharityWallet) external authorized {
        autoLiquidityReceiver = newLiquidityReceiver;
        marketingWallet = newMarketingWallet;
        charityWallet = newcharityWallet;
        emit feeReceiversChanged(autoLiquidityReceiver, marketingWallet, charityWallet);
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(charityWallet).call{value: amountBNBDev, gas: 30000}("");
