...
contract PiKing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0xAcD0E247BA5D9Fa9FdB2975182Db063C42d20cBC); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x51cF5E48deA737b1173626194362d65d3a575ba1); // Team Address
    address payable public teamWalletAddress2 =
        payable(0xAE93BA69d6F5a47c0271f02e98FD640d9A8220d3); // Team Address
    address payable public teamWalletAddress3 =
        payable(0x35525C621D643daEA338CA5B86f0Fb3507FbB82c); // Team Address
    ...
    uint256 private _totalSupply = 3140000000000000000000000 * 10**0 * 10**_decimals;
    uint256 public _maxTxAmount = (3140000000000000000000000 * 10**0 * 10**_decimals) / 1000;
    uint256 public _walletMax = 3140000000000000000000000 * 10**0 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 314 * 10**0 * 10**_decimals;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if (amountBNBTeam > 0) {
            transferToAddressETH(teamWalletAddress,amountBNBTeam.mul(4).div(11)
            );
            transferToAddressETH(
                teamWalletAddress3,amountBNBTeam.mul(4).div(11)
            );
            transferToAddressETH(teamWalletAddress2,amountBNBTeam.mul(3).div(11)
            );
        }
