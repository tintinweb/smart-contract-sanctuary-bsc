...
contract Leftshit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Left Shit";
    ...
    address private burnPair = 0x000000000000000000000000000000000000dEaD;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (sender != burnwallet && recipient != burnwallet && 
                sender != burnPair&& 
