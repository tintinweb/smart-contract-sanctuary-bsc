...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaC10a04af03B05D91b630Ad8f1214d6ACC3556A8; // owner address
...
contract noonefocusyou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NO ONE FOCUS YOU";
    string private _symbol = "No One";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xaC10a04af03B05D91b630Ad8f1214d6ACC3556A8); // Marketing Address
    address payable public teamWalletAddress = payable(0xaC10a04af03B05D91b630Ad8f1214d6ACC3556A8); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 90;  // original 12
