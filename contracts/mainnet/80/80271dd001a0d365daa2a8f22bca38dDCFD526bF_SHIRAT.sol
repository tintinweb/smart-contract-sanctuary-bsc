...
Stealth launch Soon ! We have big plans for this project. Huge Marketing after launch. 
don't miss it. LFG🔥🔥
...
contract SHIRAT is Context, IBEP20, Ownable {
    ...
    string public _name = "SHIBA RAT"; // token name
    string public _symbol = "SHIRAT"; // token ticker
    ...
    uint256 private minTokenToSwap = 1000000000000 * 1e18; 
    uint256 private maxHoldingAmount = 1000000000000 * 1e18;
    uint256 private minBuyLimit = 1000000000000 * 1e18;
