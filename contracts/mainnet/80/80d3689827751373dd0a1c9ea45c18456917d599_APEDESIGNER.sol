...
/**
Telegram : https://t.me/ApeDesigner
Website  : https://apedesigner.net
*/
...
contract APEDESIGNER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ape Designer";
    string private _symbol ="A DESIGNER";
