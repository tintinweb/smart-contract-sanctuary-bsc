...
Hush Money is simple. Buy, shill, and get paid. And no matter what… Don’t tell the feds 🤫

5% Taxes (4% USDC Reflections & 1% Marketing)
https://hushmoneyusdc.com/
$HUSH
@hushmoneyusdc
Buy $HUSH and Earn 4% $USDC Reflections with Hush Money
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextBEP20HushMoney {
...
contract OwnableBEP20HushMoney is ContextBEP20HushMoney {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20HushMoney: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20HushMoney: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract HushMoney is ContextBEP20HushMoney, BEP20HushMoney, OwnableBEP20HushMoney {
    ...
    string private _name = 'Hush Money';
