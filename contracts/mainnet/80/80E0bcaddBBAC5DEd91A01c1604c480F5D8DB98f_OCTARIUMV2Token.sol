...
contract OCTARIUMV2Token is IBEP20, Auth {
    ...
    address DEV =  0x3faA460E64901eE594757F25f83ED770dDAE50D4;
    ...
    // Total supply
    uint256 _totalSupply = 200000000 * (10 ** _decimals); // $OCTA V2

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 1000; // $OCTA V2
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000; // $OCTA V2
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 1000; // $OCTA V2
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3faA460E64901eE594757F25f83ED770dDAE50D4;
