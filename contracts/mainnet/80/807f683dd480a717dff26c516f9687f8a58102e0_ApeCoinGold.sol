...
abstract contract Auth {
    ...
    address BuyBackWallet = 0x26F499AeA3BbF2666e2049B82B1f14C1DbB3aDaB;
...
contract ApeCoinGold is BEP20, Auth {
    ...
    string public constant name = "APECOINGOLD";
    string public constant symbol = "APEGOLD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6c2532A6457f77beB7330E7b80fda87687739753;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x6c2532A6457f77beB7330E7b80fda87687739753;
        devFeeReceiver = 0x6c2532A6457f77beB7330E7b80fda87687739753;
