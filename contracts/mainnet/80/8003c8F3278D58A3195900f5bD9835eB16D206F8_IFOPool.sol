...
contract IFOPool is Ownable, Pausable {
    ...
    struct UserIFOInfo {
        ...
        uint256 lastActionBalance; // staked cham numbers (not include compoud cham) at last action
        uint256 lastValidActionBalance; // staked cham numbers in ifo valid period
    ...
    * @notice calculate user IFO latest avgBalance.
     ...
     * @param _lastValidActionBalance: staked cham number at last action.
     ...
     * @param _amount:the cham amount that need be add or sub
    ...
    /**
     * @notice original Withdraws implementation from funds, the logic same as Cham Vault withdraw
