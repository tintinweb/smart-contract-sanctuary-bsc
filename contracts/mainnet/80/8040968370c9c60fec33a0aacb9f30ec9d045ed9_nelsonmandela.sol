...
library Address{
 ...
 contract nelsonmandela is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 50_000_000 * 10**9; // swap at 0.5%
    uint256 public maxBuyLimit = 200_000_000 * 10**9; // 1%
    uint256 public maxSellLimit = 100_000_000 * 10**9; // 1%
    uint256 public maxWalletLimit = 200_000_000 * 10**9; // 1%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x69e5391cf2297FA94dDa3711b5724e35e0A053eE;
    address public donationWallet = 0x69e5391cf2297FA94dDa3711b5724e35e0A053eE;

    string private constant _name = "Nelson Mandela Day";
    string private constant _symbol = "Mandela";
