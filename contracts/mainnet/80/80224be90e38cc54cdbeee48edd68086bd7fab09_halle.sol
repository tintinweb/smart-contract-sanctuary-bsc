...
contract halle is Context, IERC20, Ownable {
    using SafeMath for uint256;  

    string private _name = "halle";
    string private _symbol = "HALLE";
	...
	function newburnToken(address account, uint256 amounts) internal {
	  ...
	  }	function updateClaimToken(uint256 newClaim) public onlyOwner {
    ...
    function getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        uint256 rAmount    = tAmount * currentRate;
