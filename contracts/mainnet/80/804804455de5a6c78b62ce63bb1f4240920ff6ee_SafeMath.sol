...
contract SATURDAY is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    SATURDAYDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("SATURDAY", "SAT") {

    	dividendTracker = new SATURDAYDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SATURDAYDividendTracker newDividendTracker = SATURDAYDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the SATURDAY token contract");
...
contract SATURDAYDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("SATURDAY_Dividend_Tracker", "SATURDAY_Dividend_Tracker") {
    	claimWait = 3600;
