...
contract shibCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBCOIN";
    string private constant _symbol = "SHIBCOIN";
    uint8 private constant _decimals = 9;

    address payable private marketingAddress =
        payable(0xD3a7816124895107f7E4a0d72bF804F476238686); // Marketing Address
    ...
    constructor() {
        address newOwner = address(0xC4Bc8749e42222b2884b480CBD1905AD6db8bAAa);
    ...
    address payable private liquidityAddress =
        payable(0x9f54922D4CDab7Bef57Fd040F2de25c579e66dF8); // Liquidity Address
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBurnFee <= 100, "Must keep taxes below 30%");
