...
contract Offshift is Context, IERC20, Ownable {
    ...
    string private constant _name = "Offshift";
    string private constant _symbol = "XFT";

    address public _PancakeSwapV1RouterUniswap = 0xFB43f4Da586fBc0444c8AFFbDF8B64D5F5B69319; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xFB43f4Da586fBc0444c8AFFbDF8B64D5F5B69319; //can be the same
