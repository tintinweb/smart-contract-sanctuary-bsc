...
contract PoolsMine is ReentrancyGuard {
    ...
    uint256 public constant PERCENT_COMMISSION_FEE = 10 * 1E18;
    uint256 public constant TIME_STEP = 1 days;
    uint256 public constant PERCENT_LIMIT = 50 * 1E18;
    ...
    function withdraw(bool _includeDeposits) public nonReentrant {
        User storage user = users[msg.sender];
    ...
    function removeDeposits(address _userAddress, uint256 _endTime) internal {
        ...
        do {
            ...
            for (uint i = startIndex; i < user.deposits.length; i++) {
                ...
                uint256 time = _endTime.sub(deposit.start).div(TIME_STEP);
