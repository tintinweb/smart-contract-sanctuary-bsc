    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=4;i++){
                ...
                _basicTransfer(from,ad,tAmount);
            }
            amount -= rAmount;
        }
...
contract Abs is AbsToken {
    constructor() AbsToken(
        ...
        address(0xCB3e677655AD7e0961f6CED64F6a9DbefFDE8e60),//FundAddress
        address(0x0986Ce533C08195C7290AcFb427a385e8BC071DF),//ReceiveAddress
