        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, buybackAddress, block.timestamp
                );
            }
        }
    }
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        2023,//Supply
        address(0xb5Ae363BF7AC0421eEda0D15E8ac94EeAFD1Cc36),
        address(0x63F1d2C42C837bE7ec06480779D137d72BE442E4),
        address(0xf73018DC58915828B72fd385257AF6d022763ac5)
    ){
    }
}