...
contract BabyVSL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyVSL";
    string constant _symbol = "BBVSL";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAa73722956b617c151F617851569beDF8DeebaFE;
        devFeeReceiver = 0xAa73722956b617c151F617851569beDF8DeebaFE;
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyOwner returns (bool success) {
        require(tokenAddress != address(this), "cant remove native token from the contract address");
