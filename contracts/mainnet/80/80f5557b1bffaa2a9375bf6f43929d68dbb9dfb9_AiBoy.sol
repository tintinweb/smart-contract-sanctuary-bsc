...
contract AiBoy is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xfbf09561F73CC1f10de378459C031E55c854eF4A); // Marketing Address
        
    address payable public teamAddress =
        payable(0x964f4B39a4Ca2DF402a46Cb9137A27BE1b3d7eFb); // Team Address
        
    address payable public liquidityAddress =
        payable(0x964f4B39a4Ca2DF402a46Cb9137A27BE1b3d7eFb); // Liquidity Address
    ...
    string private constant _name = "AiBoy";
    string private constant _symbol = "AiBoy";
