...
library Address{
 ...
 contract BetInu is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(buybackAmt > 0){
            payable(developmentWallet).sendValue(buybackAmt);
        }
