...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 31415926 * 10** Decimals;
        walletLimit =  31415926 * 10** Decimals;
...
contract pi is AbsToken {
    constructor() AbsToken(
       ...
       "3.1415926",//Symbol
        18,//Decimals
        31415926,//Supply
        address(0x561C78E7547F4b6c693923f8A743c1c09eEA1717),//FundAddress
        address(0x5166369378d5D98775D459DFD50cAa460d0D1188)//ReceiveAddress
    ){
