...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8fdc7c1e05b6F34E3c571Bb25943E97abCd91695; // owner address
...
contract JackieChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jackie Chain";
    string private _symbol = "JackieC"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc6965310D1701D502224169ba3D7d0462aa3e678); // Marketing Address
    address payable public teamWalletAddress = payable(0x0334538A6fD5E627225E60063B6016dD78a1cDDB); // Team Address
