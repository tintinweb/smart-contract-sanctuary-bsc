...
contract AAPE is IBEP20, Auth {
    ...
    address charityWallet = 0xC1D7EbF62B095bCD3Fd5F483dDA1993621592015; 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 rewardFee = feeApplicable - marketingFee - charityFee;
        if (feeApplicable == totalFeeIfSelling)
        {
            rewardFee = feeApplicable - charityFee - marketingFee;
        }
