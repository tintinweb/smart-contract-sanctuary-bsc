...
contract UKRAINEDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "UKRAINE DOGE";
    ...
    address public marketingWallet = 0x9a32bB020dd645ae5932D1C59cFC4aCEDc22F0c7;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee) <= 25, "can't set more than 25% ");
        _taxFee = taxFee;
