...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xf004B1D5b2e216bda45DD1B5c7f8982aAE0806dA;
...
contract hdb is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Hacker Detector Bot"; 
    string private constant _symbol = "HDBOT"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xf004B1D5b2e216bda45DD1B5c7f8982aAE0806dA), BNB_Tot);
            }
