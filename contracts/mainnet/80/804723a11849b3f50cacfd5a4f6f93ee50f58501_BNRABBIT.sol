...
contract BNRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNRABBIT";
    string private _symbol = "BNRABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58675F3E080621e2Ca44EC3e62953C87F17FF805);
    address payable public teamWalletAddress = payable(0x58675F3E080621e2Ca44EC3e62953C87F17FF805);
    address public immutable deadAddress = 0x58675F3E080621e2Ca44EC3e62953C87F17FF805;
