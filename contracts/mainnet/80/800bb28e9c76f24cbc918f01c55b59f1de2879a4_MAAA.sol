...
contract MAAA is IERC20, Ownable {
    ...
    address _fundAddress = address(0x0E68aF9Ad0E84969C034F5CC917273EE61FdBa43);//指定地址
    address _default = address(0x87399437372ecA1a8F645bebe5A3516863D4e0c2);//没有推荐人默认地址
	address _backAddress = address(0x87399437372ecA1a8F645bebe5A3516863D4e0c2);
    uint256 public price;
    bool public isSellDown = true;
    address public uniswapV2Pair;
	
	uint256 public startTime;
    uint256 public lpDtime;

    uint256 public userNum;
    mapping(address => bool) userMap; 
    ...
    constructor(address tokenOwner) {
        ...
        _symbol = "MAAA";
        _decimals = 10;
        _tTotal = 980000 * 10**_decimals;
		uint256 leaveAmount = 58000 * 10**_decimals;
    ...
    function changeIsSellDown() public onlyOwner {
    ...
    function _transfer(
        ...
        if(lpDtime.add(300) > block.timestamp){
            if(balanceOf(address(this)) > 0 ){
                _splitOtherToken(balanceOf(address(this)));
                lpDtime = block.timestamp;
            }
        }
    }
                ...
                if(totalAmount>0){
                    ...
                    for(uint256 i=0;i<buySize;i++){
                        ...
                        if(rate>0){
                            ...
                            _tokenTransfer(address(this), user, damount, false);
                        }
