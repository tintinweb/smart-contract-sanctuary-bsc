...
contract LabToken1 is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _wallet1Fee, uint256 _wallet2Fee) external onlyOwner {
    ...
    function setSellFees(uint256 _wallet1Fee, uint256 _wallet2Fee) external onlyOwner {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.wallet1).sub(values.wallet2);
        return values;
    }
