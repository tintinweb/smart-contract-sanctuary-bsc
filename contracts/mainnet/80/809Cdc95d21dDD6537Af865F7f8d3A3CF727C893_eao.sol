...
contract eao {
    ...
    uint256[8] private balFreezeStatic = [20,18,15,13,13,12,12,12];
    uint256[8] private balFreezeDynamic = [30,35,35,35,36,37,37,37];
    uint256[8] private balFreezeAll = [40,45,46,47,48,49,50,50];
    ...
    address  private DAOLP = 0xDf173A664D3E700f0C1B07b495123453ac511606;
   ...
   IUniswapV2Router02 public immutable uniswapV2Router;
    ...
    function deposit(uint256 _amount) external {
        ...
        // usdt.transfer(DAOLP, _amount.mul(1).div(100));
            ...
            if(upline != address(0)){
                ...
                (userInfo[upline].unfreezedDynamic && !freezeDynamicReward)
                    ...
                    if(!freezeAllReward){
                        ...
                        if(newAmount > 0 && userInfo[upline].totalFreezed.mul(3) > userInfo[upline].totalRevenue ){
