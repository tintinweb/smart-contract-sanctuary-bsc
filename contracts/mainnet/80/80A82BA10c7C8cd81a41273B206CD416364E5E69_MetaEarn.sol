...
/*
gET a bag and don't jeet my calls.
let's hit 1mil mc if you're bullish
Loadsome of callers are on this. ape if you beleive my push'

TG: t.me/metaNn
bullish Cassino Dapp utility.

max buy : 300million $MTE
*/
...
/* Token contract */
contract MetaEarn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "MetaEarn";
    string constant _symbol = "MTE";
