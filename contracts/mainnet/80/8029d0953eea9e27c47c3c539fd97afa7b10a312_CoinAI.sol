...
contract CoinAI is IERC20, Context, Ownable {
    ...
    string private constant _name = "Coin AI";

    uint256 public __Max_BuySze = 10000000 * 10**9;
    uint256 public __Max_SellSze = 10000000 * 10**9;

    address private __Marketing_Wallet = 0xa293F6F145cE13d29629AB8dc948A1900dB91cB3;
    address private __Team_Wallet = 0x2F55de9FD9e442f6dfE0C406221E9B1462AcF0ee;
    ...
    Taxes public sellTaxes = Taxes(0, 20, 2, 3);
    Taxes public taxes = Taxes(0, 20, 2, 3);
