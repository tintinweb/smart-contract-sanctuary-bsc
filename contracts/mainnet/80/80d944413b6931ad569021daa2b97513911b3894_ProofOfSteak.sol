...
/**
ProofOfSteak
$🥩 - Proof Of Steak, the first memecoin on POS BSC!

t.me/proofofsteaktokenbsc
twitter.com/proofofsteakPOSbsc
...
interface ProofOfSteakDeployer {
...
contract ProofOfSteak is ProofOfSteakDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ProofOfSteakTeam;
    address private CharityProofOfSteak;
    ...
    string public override name = "Proof Of Steak";
    string public override symbol = "Proof Of Steak";
    ...
    constructor(uint totalSupplyValue, address ProofOfSteakTeamAddress, address CharityProofOfSteakAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ProofOfSteakTeam = ProofOfSteakTeamAddress;
        CharityProofOfSteak = CharityProofOfSteakAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ProofOfSteakTeam] =  totalSupply * 5 / 100;
        balances[CharityProofOfSteak] = totalSupply * 15 / 100;
