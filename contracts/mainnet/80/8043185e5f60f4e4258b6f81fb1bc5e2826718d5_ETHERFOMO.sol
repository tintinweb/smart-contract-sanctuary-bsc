...
███████╗   ██║   ██║  ██║███████╗██║  ██║██║     ╚██████╔╝██║ ╚═╝ ██║╚██████╔╝
╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝      ╚═════╝ ╚═╝     ╚═╝ ╚═════╝ 
TG: https://t.me/EtherFomoToken
E T H E R F O M O 
BSC  ETH FOMO  USDC Rewards

The EtherFomo is a brand-new BEP20 token, which not only reward its holders with USDC stablecoin, but also brings together a large number of like-minded people who believe in the infinite rise of ETH after the Merge.


📈 TOKENOMICS: 

Max Wallet 5%.
4 BNB Initial LP Locked at launch for 6 months.
4% Tax Buy / 4% Tax Sell.

USDC Rewards staking your tokens in the Dapp (available 09/24 18h UTC)
Strong Community - Expert Team - Huge Marketing

https://EtherFomo.Online                                                                          
*/
...
contract ETHERFOMO is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "ETHERFOMO"; 
    string private _symbol = "EFOMO";  
