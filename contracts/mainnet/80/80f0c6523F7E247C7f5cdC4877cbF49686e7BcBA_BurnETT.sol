...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, 'BurnETT: owner error');
        _;
    }
...
// Burn ETT
contract BurnETT is Ownable {
    using SafeMath for uint256;
    address private zeroAddress = address(0);  // 销毁收币地址
    uint256 private everyDaySecond = 86400;       // 86400 // 不同比例的秒，测试网10，主网86400
    ...
    // 管理员取出里面的币
    function ownerTake(address _token, address _to, uint256 _value) public onlyOwner {
