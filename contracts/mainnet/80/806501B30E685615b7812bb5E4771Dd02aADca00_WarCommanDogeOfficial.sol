...
// ⚔️STEALTH LAUNCH INCOMING⚔️

// WarCommanDOGE ⚔️💣🗡

// We can't really predict when will be our call for service! So here we present the WarCommanDOGE!

// WarCommanDOGE is a decentralized based token which comprises an automatic buyback function in the contract!

// The tokenomic system aims to maintain the floor creation and chart momentum along the course of launching! 

// WarCommanDOGE envisions an actual deployment of a P2E Game, which features overwhelming NFTs, and huge investment return in a shortest time possible!

// The upcoming game will comprise playable WarCommanDOGE characters, with variety of classes or roles that is essential in the warfare!
...
contract WarCommanDogeOfficial is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "War CommanDoge"; // 
    string constant _symbol = "$WCD"; // 
