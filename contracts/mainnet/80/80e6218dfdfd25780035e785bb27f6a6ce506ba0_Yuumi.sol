...
A magical cat from Bandle City. When her master disappeared, Yuumi became the Keeper of Norra's sentient Book, 
traveling through portals in its pages to search for her.

|FAN BASED MEME TOKEN|
...
contract Yuumi is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Yuumi';
    string private constant _symbol = 'YUUMI';
    ...
    uint256 private swapThreshold = ( _totalSupply * 420 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0xaa44f3A92042316eBb0bAa62Ee15655D6c4Ec03C; 
    address internal constant marketing_receiver = 0xb61c139848b70F99896C9A9Bf834A64a5825a0a1;
    address internal constant liquidity_receiver = 0xaa44f3A92042316eBb0bAa62Ee15655D6c4Ec03C;
