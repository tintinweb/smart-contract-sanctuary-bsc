...
contract LockToken is Ownable {
    ...
    mapping(address => bool) private _whiteList;
     modifier open(address from, address to) {
        require(!pause || _whiteList[from] || _whiteList[to], "Not Open");
        _;
    }
    ...
    function updatePauseTrade(bool _enableDisable) external onlyOwner {
        pause = _enableDisable;
    }
...
contract Metapets is ERC20, Ownable, LockToken {
    using SafeMath for uint256;
    ...
    address payable public  devWallet = payable(0x41A048f1c41365AC1e42d9a9Ec01c0767225F0fF);
    address private immutable BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD token address
    ...
    constructor() ERC20("Metapets", "Metapets")  {
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address _to) private lockTheSwap {
    ...
    function setDevWallet(address payable _newAddress) external onlyOwner() {
        devWallet = _newAddress;
    }
    
    function setFee(uint256 _devFee, uint256 _burnFee) public onlyOwner {
        require(_devFee.add(_burnFee) <= 10, "tax tooo high");
        devFee = _devFee;
        burnFee = _burnFee;
    }
    ...
    function setMaxTransaction(uint256 _maxTxAmount) public onlyOwner {
        ...
        require(maxTransactionAmount >= totalSupply().div(500), "value too low");
    }
