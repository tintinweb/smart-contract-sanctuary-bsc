...
contract waldogebsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Waldoge"; // 
    string private constant _symbol = "WDoge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xbDdC0e167dA90cC4F998B5Fdb9CFAb878ff48d2B;
