...
/**
 * @title SmartVault
 * @dev 用于储存卖出的USDT,需要添加流动池时转入主合约
 */
contract SmartVault is Owner {
    IERC20 public usdtToken;
    IERC20 public dorToken;

    function initialize(IERC20 _usdtToken, IERC20 _dorToken) public isOwner {
    ...
    constructor() {
        initialize(IERC20(0x55d398326f99059fF775485246999027B3197955), IERC20(0xB9927aFfF4BA9E9bEd986a4aDB6c70e049F93a3f));
    }
}