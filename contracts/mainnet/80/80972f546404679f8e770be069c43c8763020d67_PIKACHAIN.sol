...
contract PIKACHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "PikaChain BSC"; // 
    string private constant _symbol = "PKCH"; //    
