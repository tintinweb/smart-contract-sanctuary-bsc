...
contract MoonerCheems is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MoonerCheems";                                          // name
    string private _symbol = "MCheems";                                             // symbol
    ...
    uint256 public _liquidityFee4Buyers = 7;
    uint256 private _previousLiquidityFee4Buyers = _liquidityFee4Buyers;

    uint256 public _liquidityFee4Sellers = 8;
