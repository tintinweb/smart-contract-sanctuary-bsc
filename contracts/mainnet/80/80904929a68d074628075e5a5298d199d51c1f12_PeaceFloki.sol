...
contract PeaceFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PeaceFloki";
    string private _symbol = "PeaceFloki";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x13ef17865258677FE7aBFd3C81ce325c6eEa7eE1); 
    address payable public donationWalletAddress = payable(0xE0604ca4AB3E1a7eF33e1d055F3A843c06db44B0); 
