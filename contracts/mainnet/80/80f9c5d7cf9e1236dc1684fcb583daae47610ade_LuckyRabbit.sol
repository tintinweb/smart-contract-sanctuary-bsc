...
contract LuckyRabbit is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"LuckyRabbit";
    ...
    uint256 private minimumTokensBeforeSwap = 500000 * 10**7; 
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xEdd933d328504194372b843f09BCaf7AA8eE4d1b));
        marketingWallet = payable(address(0xa7fB30D92006863a9902E24b2e7CeDfCFade0cE5));
