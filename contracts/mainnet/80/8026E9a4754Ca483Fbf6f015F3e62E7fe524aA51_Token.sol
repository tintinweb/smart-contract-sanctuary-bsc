...
contract Token is ERC20, Ownable {
    ...
    uint256 public txMarketFee = 600;
    ...
    uint256 public _salePT = 30 minutes;
    uint256 public _salePTFee = 2400;
    ...
    constructor() ERC20("Thor1", "Thor1") {
        if (block.chainid == 56) {
            uniswapV2Router = IUniswapV2Router02(
                0x10ED43C718714eb63d5aA57B78B54704E256024E
            );
            // tokenB = address(0x55d398326f99059fF775485246999027B3197955);
            tokenB = address(0x0cE9e89169Bf2D72d9e0b36bdC9F8dFd736C4eC1);
            ...
            tokenB = address(0x7100907E4Ca43974176633881E530f45114eEdF0);
            // tokenB = uniswapV2Router.WETH();
        }
        ...
        excludeFromFees(address(_marketWallet2), true);
    ...
    function setMarketingWallet2(address wallet) external onlyOwner {
        _marketWallet2 = wallet;
    }
    ...
    function updateSalePT(uint256 value) public onlyOwner {
        _salePT = value;
    }

    function updateSalePTFee(uint256 value) public onlyOwner {
        _salePTFee = value;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (!automatedMarketMakerPairs[to]) {
                ...
                _more(3, amount, from, to);
                if (launchedAtTime + _salePT >= block.timestamp) {
                    uint256 rewardTokens = amount.mul(_salePTFee).div(10000);
                    tokens = tokens.sub(rewardTokens);
                    super._transfer(from, address(this), rewardTokens);
                }
            }
    ...
    function _swap() private lockSwap {
        ...
        */
        ...
        IERC20(tokenB).transfer(_marketWallet, bBalance.div(2));
        IERC20(tokenB).transfer(_marketWallet2, IERC20(tokenB).balanceOf(address(this)));
