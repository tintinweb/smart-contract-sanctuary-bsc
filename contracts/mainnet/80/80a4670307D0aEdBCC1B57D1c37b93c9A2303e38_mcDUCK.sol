...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x778107fe568a9B902fFE6718678d893ec56ac801; // owner address
...
contract mcDUCK is Context, IERC20, Ownable {
    ...
    string private _name = "mcDUCK COIN";
    string private _symbol = "mcDUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x778107fe568a9B902fFE6718678d893ec56ac801); // Marketing Address
    address payable public teamWalletAddress = payable(0x778107fe568a9B902fFE6718678d893ec56ac801); // Team Address
