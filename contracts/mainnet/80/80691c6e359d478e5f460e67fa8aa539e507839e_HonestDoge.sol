...
Telegram: https://t.me/HonestDoge

Website: https://honestdoge.xyz

Twitter: https://twitter.com/HonestDogeToken
...
contract HonestDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HonestDoge";
    string private _symbol = "HDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEBf0f8B0ed3A1Aa74449f0ee741B12C3E32C0202);
    address payable public teamWalletAddress = payable(0xEBf0f8B0ed3A1Aa74449f0ee741B12C3E32C0202);
