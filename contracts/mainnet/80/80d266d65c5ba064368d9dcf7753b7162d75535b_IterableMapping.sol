...
contract BNBcoin is ERC20, Ownable, SafeToken, LockToken {
    ...
    constructor() ERC20("BNBcoin", "BNBcoin") {
        BNBRewardsFee = 3;
        liquidityFee = 1;
        burnFee = 1;
        extraFeeOnSell = 3; // extra fee on sell
        marketingFee = 1;
        marketingWallet = payable(0x364a2749C791F566f5209D2925B127D300C5163e);
