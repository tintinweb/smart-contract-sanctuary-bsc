...
contract BCASH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    IBinancePay internal binancePay;
    ...
    uint256 public maxBuyAmount = 5 * 10**6 * 10**18;
    uint256 public maxSellAmount = 1 * 10**6 * 10**18;
    uint256 public maxWalletAmount = 1 * 10**9 * 10**18;

    uint256 internal constant maxSupply = 5 * 10**14 * 10**18; //500 trillion

    address public marketingWallet =
        address(0xD6D6B7517949E829A03c0a2bcb0f81650D3B732A);
    address public buybackWallet =
        address(0x5D0A8eB793D770168D84c3e14fFCA8ba003b0CE5);
    ...
    constructor(address _binancePay) ERC20("BINANCE CASH v2", "BCASHv2") {
