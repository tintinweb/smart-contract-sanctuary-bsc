...
contract YoshiGems {
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 1 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 BUSD  **/

	uint256 public COMPOUND_BONUS = 50; /** 2.5% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 5; /** 10 times / 5 days. **/
