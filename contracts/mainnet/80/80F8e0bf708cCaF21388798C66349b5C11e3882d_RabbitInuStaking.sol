...
contract RabbitInuStaking is Pausable, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant MAX_UNSTAKE_FEE = 1000;
    uint256 public constant MAX_OPERATIONS_FEE = 100;

    uint256 public earlyUnstakeFee = 1000;
    ...
    constructor (
        ...
        stakeAdmin = 0xD8eB865fDF1421Ce9EEEF4434FCb18620e5CeFA4;
    }
    ...
    function setOperationsFee(uint256 newFee) external onlyOwner{
        require(newFee <= MAX_OPERATIONS_FEE, "earlyUnstakeFee cannot be more than MAX_OPERATIONS_FEE");
