...
contract BabyTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyTest", "BURNINGTest") {
        ...
        dividendTracker = new BabyTestDividendTracker(
            payable(this),
            router,
...
contract BabyTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyTest public BabyTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyTestContract = BabyTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyTestContract);

            uint256 prevBalance = BabyTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
