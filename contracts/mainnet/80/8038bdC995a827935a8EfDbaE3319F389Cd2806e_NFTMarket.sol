...
abstract contract NFTMarketReserveAuction is NFTMarketFees {
     ...
     */
    function updateMinAuctionDuration(uint minAuctionDuration)
        public
        onlyAdmin
    {
        require(
     ...
     */
    function updateMaxAuctionDuration(uint maxAuctionDuration)
        public
        onlyAdmin
    {
        require(
...
abstract contract NFTMarketListing is NFTMarketFees {
    ...
    function updateMinListingDuration(uint minListingDuration)
        external
        onlyAdmin
    {
        require(
    ...
    function updateMaxListingDuration(uint maxListingDuration)
        external
        onlyAdmin
    {
        require(
