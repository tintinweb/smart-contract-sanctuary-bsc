...
contract InuMooneri is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCB8159abdFF42752584024B1D1F1629B18B24864); 
    ...
    string private constant _name = "Inu Mooneri"; 
    string private constant _symbol = unicode"$IMOON"; 
