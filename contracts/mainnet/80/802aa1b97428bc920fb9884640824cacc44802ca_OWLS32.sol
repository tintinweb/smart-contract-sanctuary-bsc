...
contract OWLS32 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "OGSAFEMARS";
    string constant _symbol = "OGS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAmount = 15_000_000_000_000 * (10 ** _decimals);  
    ...
    address public marketingFeeReceiver = 0x3958724AbEf77bd616d5dFe69d90205e0fad1bCE;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isTxLimitExempt[0x3958724AbEf77bd616d5dFe69d90205e0fad1bCE] = true;
