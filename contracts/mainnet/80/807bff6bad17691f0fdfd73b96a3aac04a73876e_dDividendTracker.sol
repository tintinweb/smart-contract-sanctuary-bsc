    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public immutable dToken =
        address(0x19e016190a07Ad2ECDfb9041912fE5bC13DE35E6);
...
contract Pelosi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWalletAddress =
        0x7ad894BbF9de0aEc1BDB1E95B1FaAF3e0A350A48;
    address public immutable dToken =
    ...
    constructor() ERC20("Pelosi", "Pelosi") {
        ...
        swapTokensAtAmount = 10000000000 * (10**18);
...
contract dDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100 * (10**18); //must hold tokens for dividen
    }
