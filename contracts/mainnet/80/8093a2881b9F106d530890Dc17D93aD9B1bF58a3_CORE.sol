...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc8a564e9fee5Bd1065777F4beb351F611a9C6369; // owner address
...
contract CORE is Context, IERC20, Ownable {
    ...
    string private _name = "100CORE";
    string private _symbol = "CORE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc8a564e9fee5Bd1065777F4beb351F611a9C6369); // Marketing Address
    address payable public teamWalletAddress = payable(0xc8a564e9fee5Bd1065777F4beb351F611a9C6369); // Team Address
