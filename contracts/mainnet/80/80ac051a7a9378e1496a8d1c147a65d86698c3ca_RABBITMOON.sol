...
contract RABBITMOON is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("RABBITMOON", "RABBITMOON") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xE86f0418455ffC10CF6cc90318A4C324F8e4F040, 'We can not exclude Uniswap router.');
