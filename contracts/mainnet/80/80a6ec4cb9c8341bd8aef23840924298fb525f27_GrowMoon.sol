...
contract GrowMoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xebd0D5C7b0E2952d4818355588cBe1c06B6ce964); 
    address payable public Wallet_Dev = payable(0xebd0D5C7b0E2952d4818355588cBe1c06B6ce964);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000**1 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0xebd0D5C7b0E2952d4818355588cBe1c06B6ce964;
