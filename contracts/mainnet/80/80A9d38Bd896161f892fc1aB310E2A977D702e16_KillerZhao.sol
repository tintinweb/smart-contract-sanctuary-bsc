...
contract KillerZhao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kill0Zhao";
    string private _symbol = "KillerZhao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8d09c64Fe54dCd89C17f935498BAB3e8fc7f14B5); 
    address payable public buyBackWalletAddress = payable(0x8d09c64Fe54dCd89C17f935498BAB3e8fc7f14B5); 
    ...
    uint256 private _totalSupply = 100000000000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 2000000000000000000000000 * 10**9; 
    uint256 public _walletMax = 5000000000000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 10000000000000000000 * 10**9; 
