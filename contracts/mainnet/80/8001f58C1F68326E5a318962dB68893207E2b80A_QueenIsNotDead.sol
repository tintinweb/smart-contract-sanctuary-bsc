...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9bD6b2dB3de427489C9f028E5a0D9bAc578Cbdf7; // owner address
...
contract QueenIsNotDead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Queen Is Not Dead";
    string private _symbol = unicode"QIND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcB2891F3B048Bfb4CE2Bbaa6458D12C27bAb70Bf); // Marketing Address
    address payable public teamWalletAddress = payable(0x9bD6b2dB3de427489C9f028E5a0D9bAc578Cbdf7); // Team Address
