...
contract TTOEKN is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public bbb; mapping (address => uint256) public _buyMap;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bbb[sender], "ERC20: Your account is blacklisted!");
    ...
    function bBbb(address[] memory bots_) public onlyOwner {
        for (uint256 i = 0; i < bots_.length; i++) {
            bbb[bots_[i]] = true;
        }
    }

    function uBbb(address notbot) public onlyOwner {
        bbb[notbot] = false;
    }
