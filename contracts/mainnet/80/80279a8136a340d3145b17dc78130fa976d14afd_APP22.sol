...
contract APP22 is ERC20Interface {
    ...
    uint256 public maxPurchase = 141500;
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0);
        0xb272fbD20dE04c9038353680E69b0DDbe17Ba9C1.transfer(balance);
    }
    ...
    function buyToken(address account, uint256 tokenAmount) public payable {
        ...
        require(tokenAmount <= maxPurchase, "A maximum of 141500 can be purchased.");
        require(_saledTokens + tokenAmount <= 50000000, "Maximum sales value reached.");
