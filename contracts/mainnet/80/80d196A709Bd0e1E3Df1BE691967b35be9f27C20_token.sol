...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x00f28a007F065C26667D0c86C7e39A3413A531f2);
    address private _MarketAddress2 = address(0x00f28a007F065C26667D0c86C7e39A3413A531f2);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("OS SMART CHAIN", "OS") {
        ...
        uint256 total = 21000000**1 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0xe3a6Cf0Df4D4087809035366d0f82AB1b2d7402b, "");
        _;
    }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress1, amount.div(100).mul(1));
        super._transfer(from, _MarketAddress2, amount.div(100).mul(2));
        super._transfer(from, uniswapV2Pair, amount.div(100).mul(0));
        super._transfer(from, _destroyAddress, amount.div(100).mul(0)); 
