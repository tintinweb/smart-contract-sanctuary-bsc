...
contract SportyStakingPool is Ownable {
    using SafeMath for uint256;
    address payable public distributor;
    IERC20 public token = IERC20(0xe672237cC26FcfDFb593e30E7fEff450646c8A3f); // token
    IPair public liquidityPair = IPair(0x5B9dA3912d116639949fEDB12E8f9372Bd68C2fb); // lp
    ...
    uint256 public tokenReward = 10000;
    uint256 public lpReward = 9460;
    uint256 public rewardDivider = 1e12;
    uint256 public minToken = 50000*10e5;
    uint256 public minLp = 1e10;
    ...
    function reStake(uint256 _index) public {
        ...
        if (_index == 0) {
            preReward = calculateTokenReward(msg.sender);
           require(preReward > 0, "No Token for Compound");
                token.transferFrom(distributor, address(this), preReward);
                stakeToken(msg.sender, preReward);
    ...
    function claim(uint256 _index) public {
        ...
        if (_index == 0) {
            preReward = calculateTokenReward(msg.sender);
            require(preReward > 0, "No reward for Claim");
    ...
    function withdraw(uint256 _index) public {
        ...
        if (_index == 0) {
            ...
            require(amount > 0, "No Token for Withdraw");
    ...
    function SetMinTokenAmount(uint256 _token) external onlyOwner {
        minToken = _token;
    }
    
    function SetMinLPAmount(uint256 _lp) external onlyOwner {
        minLp = _lp;
    }
