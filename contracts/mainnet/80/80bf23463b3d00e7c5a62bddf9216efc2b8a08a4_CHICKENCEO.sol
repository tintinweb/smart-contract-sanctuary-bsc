...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE69A71437c4C06fB9fC877816120Ec93f3ffF3B8; // owner address
...
contract CHICKENCEO is Context, IERC20, Ownable {
    ...
    string private _name = "CHICKEN CEO";
    string private _symbol = "CEO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xE69A71437c4C06fB9fC877816120Ec93f3ffF3B8); 
    address payable public teamWalletAddress = payable(0xE69A71437c4C06fB9fC877816120Ec93f3ffF3B8);
