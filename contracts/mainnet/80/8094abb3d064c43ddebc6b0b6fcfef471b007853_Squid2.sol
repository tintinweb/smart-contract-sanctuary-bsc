...
contract Squid2
 is Context, IERC20, Ownable {
    ...
    string private _name = "Squid2.0";
    string private _symbol = "Squid2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF69D4f7b668D2761CF965DC2e357bA31F5E978B7);
    address payable public teamWalletAddress = payable(0xF69D4f7b668D2761CF965DC2e357bA31F5E978B7);
    address public immutable deadAddress = 0xF69D4f7b668D2761CF965DC2e357bA31F5E978B7;
