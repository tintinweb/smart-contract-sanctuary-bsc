...
/* 
Dream Factory Dao ($DFD) is a crypto DAO programme which aims 
to benefit the members within the DAO community with real profits & crypto inside resources. To enable and make it happens for what's being said above, 
Dream Factory Dao (DFD) will create a DAO ecosystem which contains: Voting, Incubator, partnership, DAO VC, Gamefi/Web3.0/NFT techinical support and more.
🔸Verified Contract
...
contract $DFDToken is Context, Bep2022$DFD, Ownable {
    ...
    string private _name = 'DreamFactoryDao';
