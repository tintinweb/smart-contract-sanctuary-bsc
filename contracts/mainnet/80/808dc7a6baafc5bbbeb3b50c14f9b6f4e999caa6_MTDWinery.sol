...
contract MTDWinery {
    ...
    uint256 public MIN_INVEST_LIMIT = 100000 ether; /** min. 100000 MTD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 5000000000 ether; /** max. 5000000000 MTD  **/

	uint256 public COMPOUND_BONUS_MAX_TIMES = 6; /** 6 Times Compound every 24 Hours / 6 days. **/

    uint256 public WITHDRAWAL_TAX = 900; // 90% tax for For Early Withdrawals - Penalties
