...
contract KedamaInu is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "KedamaInu";
    string private _symbol = "KedamaINU";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _burnTokenfee = 2;
    address private _burnaaddress = 0xF7B546c2DB491a2008ec52C4C781EBaddF5C5E69;
