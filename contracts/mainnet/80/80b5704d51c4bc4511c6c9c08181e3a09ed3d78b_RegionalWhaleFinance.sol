...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3CFD252d3d0A409692a7Daca55Ce2d56994928A9;
...
contract RegionalWhaleFinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3CFD252d3d0A409692a7Daca55Ce2d56994928A9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Regional Whale Finance";
    string private _symbol = unicode"RGF🐋";
