...
interface IERC20 {
     ...
     * that someone may use both the old and the new allowance by unHua Mulante
...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 5000 * (10**18);
    ...
    uint256 public TokenRewardsFee = 390;
    ...
    constructor() ERC20("Hua Mulan", "Hua Mulan") {
    ...
    function updateRewardCoin(address newRewardCoin) public onlyOwner {
        ...
        require(RewardCoin != newRewardCoin, "Hua Mulan: The RewardCoin already has that address");
    ...
    function updateUniswapV2Router(address newAddress, address newTokenB) public onlyOwner {
        require(
            ...
            "Hua Mulan: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Hua Mulan: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Hua Mulan: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Hua Mulan: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Hua Mulan: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Hua Mulan: Cannot update gasForProcessing to same value"
        );
