...
contract BabyCaturdayFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Caturday Finance";
    string private _symbol = "$BCF";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x59594C01BF329A377F6905131F5A80B9bB9b92Cd); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x27F7E2125c78aCd6069C58a434ab77fa47A8756b); // Team Address
