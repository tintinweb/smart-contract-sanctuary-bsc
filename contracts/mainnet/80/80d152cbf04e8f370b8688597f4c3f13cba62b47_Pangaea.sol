...
contract Pangaea is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pangaea Coin"; //
    string private constant _symbol = "Pangaea"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x7B73f3b015ffcd90EB8dA3e12093CBCBa98F19EE ;
