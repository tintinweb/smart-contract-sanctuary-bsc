...
contract SoulmetaFingerPlay is DivestorUpgradeable {
    ...
    function setMeta(address serverAddr_, address soulToken_, address fishPondBonus_, address timeBank_, address aSm3d_, bool isOpen_) public onlyOwner {
        serverAddr = serverAddr_;
        soulTokenAddr = ISoulToken(soulToken_);
        aFishPondBonus = fishPondBonus_;
        aTimeBank = timeBank_;
    ...
    function settleGame(uint roomId_, address winner_) public {
        ...
        uint extractCount = totalSoulCount * 5 / 100; // 抽取
        ...
        uint winCount = totalSoulCount - extractCount - bonusSoulCount - timeBankSoulCount;
