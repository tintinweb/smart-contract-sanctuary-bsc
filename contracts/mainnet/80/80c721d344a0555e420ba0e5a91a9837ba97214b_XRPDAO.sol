...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe531DeBfd6100B57f22B1AA8FE03AB87b1fcc47e; // owner address
...
contract XRPDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XRP DAO";
    string private _symbol = "XRPDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe531DeBfd6100B57f22B1AA8FE03AB87b1fcc47e); // Marketing Address
    address payable public teamWalletAddress = payable(0xe531DeBfd6100B57f22B1AA8FE03AB87b1fcc47e); // Team Address
