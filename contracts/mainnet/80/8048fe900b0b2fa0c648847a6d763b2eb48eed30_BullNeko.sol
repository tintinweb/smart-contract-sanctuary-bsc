...
contract BullNeko is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0ECf6B71Dfb1101D9bc50BA877889825ee8660bB); 
    address payable public Wallet_Dev = payable(0xDa32C7A211c5B688746f63Ec18d824b42a1a780C);
    address payable public W_Deployer = payable(0xDa32C7A211c5B688746f63Ec18d824b42a1a780C);
    ...
    string private constant _name = "Bull Neko"; 
    string private constant _symbol = unicode"BULLNEKO"; 
    ...
    constructor () {
        ...
        _owner = 0xDa32C7A211c5B688746f63Ec18d824b42a1a780C;
