...
contract Khabzilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x06afeCA169ED63E97915865CC708C0078AC8D7e1); 
    ...
    string private constant _name = "KhabyZilla"; 
    string private constant _symbol = unicode"KHABYZILLA"; 
    ...
    constructor () {
        ...
        _owner = 0xbdDcc1baB8dc0dDB76F78ebEA0a361a76Adc5287;
