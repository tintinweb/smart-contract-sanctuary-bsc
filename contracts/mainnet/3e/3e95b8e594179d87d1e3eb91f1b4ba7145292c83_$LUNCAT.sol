...
contract $LUNCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNA CAT";
    string private _symbol = "LUCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeD9A7724882124E8B1e0DC640ac8277aE3122f9B); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xAf0767E32dDfbB9658a0f8Ab88Caaccc283834AF); // Development Address
