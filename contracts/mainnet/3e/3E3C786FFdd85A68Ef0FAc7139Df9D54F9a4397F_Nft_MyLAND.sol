...
contract Nft_MyLAND is ERC721Enumerable {
	...
	constructor() ERC721("FarmNFT-Tian", "Tian") {
		owner = msg.sender;
	}
...
*/
	function mint() public {
		...
		ERC20(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7).transferFrom(msg.sender, address(this), (mintPricec6_f32f5e8a / (uint256(10) ** uint256(0))));
