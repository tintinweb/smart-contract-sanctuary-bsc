...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function summary(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract BAYUE is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "BAYUE";
    string private _symbol = "BAYUE";
    ...
    function checkowneraddress() external view returns (uint256, uint256) {
   ...
   function dismissgas(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
