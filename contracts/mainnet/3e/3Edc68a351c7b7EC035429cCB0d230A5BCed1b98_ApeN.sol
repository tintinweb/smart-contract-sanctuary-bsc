...
Ape'N is a Defi Protocol that allows you to 
earn rewards through staking,
games, NFT's, community events and more.

Stealth Launched! 
https://t.me/APENOfficial
...
contract ApeN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ape'N";
    string private constant _symbol = "APE";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 50000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 900000* 10**_decimals; 
    ...
    address private marketingWallet = address(0x1b5bccc058c5570Aa59Cc5355b8a270868eDc012);
    address private liquidityReceiver = address(0x1b5bccc058c5570Aa59Cc5355b8a270868eDc012);
