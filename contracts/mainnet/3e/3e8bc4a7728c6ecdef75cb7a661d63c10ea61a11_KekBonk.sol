...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58db78022F84522CBD49EBB68198F231A579b3d7;
...
contract KekBonk is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x58db78022F84522CBD49EBB68198F231A579b3d7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KekBonk";
    string private _symbol = "KekBonk";
