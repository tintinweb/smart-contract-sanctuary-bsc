...
Hyped name token with actual USE CASE probabililty behind it just hodl!
...
contract HypeInu is IBEP20, Ownable
{
    ...
    string private constant _symbol = 'HypeInu';
    ...
    //DevWallets
    address public Development=payable(0xCE0D2710882246de813599203BA218B5d8d5f129);
    address public Marketing=payable(0xCE0D2710882246de813599203BA218B5d8d5f129);
    //TestNet
