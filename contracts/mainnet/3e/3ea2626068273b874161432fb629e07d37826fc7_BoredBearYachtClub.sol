...
contract BoredBearYachtClub  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Bored Bear Yacht Club";
    string constant _symbol = "BBYC";
