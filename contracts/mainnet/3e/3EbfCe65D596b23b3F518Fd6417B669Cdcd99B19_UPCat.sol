...
contract Ownable is Context {
    address private _owner = 0xbbf26932f6f322CE770fE0858aA4303B6B81694c;
...
contract UPCat is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0x5a9d97bcd4F6b6AC98d1A07fA08Cf3D8316598fE); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "UPCat"; 
    string private _symbol = "UPCat";
    ...
    uint256 public _minTokensSwapToAndTransferTo = 4900 * 10**6 * 10**_decimals; 
