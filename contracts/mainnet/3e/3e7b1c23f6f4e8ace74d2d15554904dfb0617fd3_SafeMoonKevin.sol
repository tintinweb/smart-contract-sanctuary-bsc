...
contract SafeMoonKevin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafeMoonKevin";
    string private _symbol = "$SMK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x228cC21EB8318b23e31C3e6d657650fBBdB8C91B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x228cC21EB8318b23e31C3e6d657650fBBdB8C91B); // BuyBack Address
