...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCDe749F87D9B9b8Ac846934463895B653e667bD6;
...
contract LivaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Liva Chain ";
    string private _symbol = " LIVA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCb6976D96cD9a384Fb7d7b986b8A63b5A0DE5697);
