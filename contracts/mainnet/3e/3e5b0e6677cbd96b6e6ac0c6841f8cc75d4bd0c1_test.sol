...
contract test is IBEP20, Auth {
    ...
    string constant _name = "Baby Test";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3F06C0A079861f8038F29FD005492f73B14Cb817;
        marketingFeeReceiver = 0x3F06C0A079861f8038F29FD005492f73B14Cb817;
