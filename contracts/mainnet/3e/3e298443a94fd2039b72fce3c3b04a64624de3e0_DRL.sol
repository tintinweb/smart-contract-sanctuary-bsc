...
contract DRL is BEP20, Auth {
    ...
    string public constant name = "FRIGHTINU";
    string public constant symbol = "FTINU";
    ...
    address public marketingFeeReceiver = 0x3881048E66c62DE6324C394645aEc9f52345Cf55;
    ...
    function update_fees() internal {
        if(!launchMode){
            require(totalFee.mul(buyMultiplier).div(100) <= 90, "Buy tax cannot be more than 9%");
            require(totalFee.mul(sellMultiplier).div(100) <= 140, "Sell tax cannot be more than 90%");
            require(totalFee.mul(transferMultiplier).div(100) <= 140, "Transfer Tax cannot be more than 14%");    
        }
