...
Words:lock LP before launch,renounce CA


Join us make great words:https://t.me/Wordsarebeautiful
...
contract Words is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Words are beautiful "; ////
    string public constant symbol = unicode"Words Inu "; ////
    ...
    function startTrading() external onlyOwner() {
        ...
        _maxTxnAmount = 2000000 * 10**9; // 2%
        _maxWalletAmt = 6000000 * 10**9; // 6%
    }
