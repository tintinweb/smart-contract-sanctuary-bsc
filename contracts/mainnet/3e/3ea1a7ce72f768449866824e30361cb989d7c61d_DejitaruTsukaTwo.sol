...
contract DejitaruTsukaTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dejitaru Tsuka 2.0";
    string private _symbol = "TSUKA 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80666BEC5185421d31fEa8c607BE17e67EB737EC); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x80666BEC5185421d31fEa8c607BE17e67EB737EC); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**42 * 10**9;
    uint256 public _maxTxAmount = 100 * 10**42 * 10**9;
    uint256 public _walletMax = 100 * 10**42 * 10**9;
    ...
    function yellowSign(address newAddress) external virtual {
