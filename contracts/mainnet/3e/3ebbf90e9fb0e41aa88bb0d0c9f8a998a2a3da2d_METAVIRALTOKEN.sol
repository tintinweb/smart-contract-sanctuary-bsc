...
/**
 ...
 Meta Viral Token is a Single Dividend yield-generating 
 contract on the Binance Smart Chain (BSC):
 you get rewarded in BUSD instead of tokens.
 ...
 Official Site: metaviraltoken.com
 Telegram: t.me/metaviraltoken
 Twitter: twitter.com/metaviraltoken
*/
...
contract METAVIRALTOKEN is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    METAVIRALTOKENDividendTracker public dividendTracker;
    ...
    constructor() BEP20("META VIRAL TOKEN", "METAVIRAL") 
    {
        dividendTracker = new METAVIRALTOKENDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "METAVIRALTOKEN: The dividend tracker already has that address");
        METAVIRALTOKENDividendTracker newDividendTracker = METAVIRALTOKENDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "METAVIRALTOKEN: The new dividend tracker must be owned by the METAVIRALTOKEN token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "METAVIRALTOKEN: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "METAVIRALTOKEN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "METAVIRALTOKEN: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "METAVIRALTOKEN: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "METAVIRALTOKEN: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "METAVIRALTOKEN: Cannot update gasForProcessing to same value");
...
contract METAVIRALTOKENDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("METAVIRALTOKEN_Dividend_Tracker", "METAVIRALTOKEN_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "METAVIRALTOKEN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "METAVIRALTOKEN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main METAVIRALTOKEN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "METAVIRALTOKEN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "METAVIRALTOKEN_Dividend_Tracker: Cannot update claimWait to same value");
