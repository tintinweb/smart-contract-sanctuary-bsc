...
contract STARBUFF is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf61482781595c242aaC27304D2Dc5595243A6cf8); 
    address payable public Wallet_Dev = payable(0xf61482781595c242aaC27304D2Dc5595243A6cf8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "STARBUFF"; 
    string private constant _symbol = unicode"STARBUFF";
