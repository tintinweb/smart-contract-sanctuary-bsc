...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11392FB44928A7A1fb0aEAc2d59F53A0B09aEdFb; // Baby FTX
...
contract BABYFTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYFTX";
    string private _symbol = "BABYFTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11392FB44928A7A1fb0aEAc2d59F53A0B09aEdFb); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x876Ea0558DfD05f0CD1E05d1e2041294c90bbe3B); // Team Wallet
