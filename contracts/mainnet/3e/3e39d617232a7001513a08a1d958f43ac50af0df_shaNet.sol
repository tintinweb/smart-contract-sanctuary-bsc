...
contract shaNet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "shaNet";
    string private _symbol = "Sha";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD0ae0C716036De89A8a097E9a760E7DA3A95d86A);
