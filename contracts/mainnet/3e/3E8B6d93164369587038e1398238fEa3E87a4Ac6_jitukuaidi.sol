...
contract jitukuaidi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "jitukuaidi";
    string private _symbol = "jitukuaidi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x4B6e7588fE8FcABCbe2db0279f7b27e63e082869);
