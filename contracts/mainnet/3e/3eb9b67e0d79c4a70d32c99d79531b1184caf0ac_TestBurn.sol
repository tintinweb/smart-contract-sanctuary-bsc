...
contract TestBurn is Context, IERC20, Ownable {
    ...
    string private _symbol = "TestBurn";
    ...
    address payable public MarketingAddress = payable(0xef5B518D28534A3f4f9aD59d36F1f0E75B857b48); // Marketing Address
    address payable public EcoAddress = payable(0xce7625b31F90cCeE26E4ecd1918BA2e09b1460Ae); // Ecosystem Address
    address public OwnerAddress = 0x423c42F9f233B910a02140275525eD8046ee0a0e; // Ecosystem Address
    bool public StartMaxWallet = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            ...
            if (from != OwnerAddress && from != address(this))    
                if (StartMaxWallet != false)
    ...
    function MaxwalletStartStop(bool truefalse) external onlyOwner() {
        StartMaxWallet = truefalse;
    }
