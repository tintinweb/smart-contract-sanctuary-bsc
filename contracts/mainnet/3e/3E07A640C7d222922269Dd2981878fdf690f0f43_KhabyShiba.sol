...
KhabyShiba: Prepare yourself to a New Generation of Meme Token.It is set to be the one of the largest Meme Coin on Binance Smart Chain, The grow will not stop and we will reach the top! 
...
contract KhabyShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "KhabyShiba"; 
    string private constant _symbol = "KhabyShiba"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0x8e622363417aABbe706AB8cB3Ac42f99338cCE3d; 
