...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is Context, IBEP20, Ownable, LockToken {
        ...
        constructor() {
            _name = "TiktokTate"; // Token name 
            _symbol = "TTTATE"; // Symbol 
            _decimals = 9;
            _tTotal = 300000000000 * 10**_decimals; // total supply
            _rTotal = (MAX - (MAX % _tTotal));
            numTokensSellToAddToLiquidity = 30000000 * 10**_decimals; // token to add liquidity and send fees 
            _maxWalletBalance = 15000000000 * 10**_decimals; // 5% Max wallet limit
            _maxTxAmount = 15000000000 * 10**_decimals; // 5% Max tnx amount
            _marketingWalletAddress = 0x875108bbf69856f9DEBb4811C4755E2A57004f9c; // Markting address 
            _charityWalletAddress = 0xc124b767df146CEF1Ad5226D0658D436972f8239;   // Charity Address
