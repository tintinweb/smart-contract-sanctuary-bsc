...
contract Rocket {
    ...
    mapping (address => uint256) public start;//记录前8888个购买人
    address public owner;
    uint256 public start8888;//前8888个博饼购买ID
    address public pir;
    // Events
    ...
    constructor () public {
        ...
        _symbol = "RKT";
        _decimals = 18;
        _totalSupply = 1000000000000000000000000000000000000;// 10_00000000.mul(10 ** uint256(18));
        balances[0x78E8a36bFBBC8Ac7c50Bcac94794a67Bcfb7E8F3] = _totalSupply;
        emit Transfer(address(this), 0x78E8a36bFBBC8Ac7c50Bcac94794a67Bcfb7E8F3, _totalSupply);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require((start[_recipient]==0 && _sender == pir) || start8888 >=8888 || _sender != pir);//前8888个购买人限购一次,如果卖出，这个地址就不能购买，需要满8888个地址后才能购买
