...
/*
    Bear King Inu - https://t.me/koalaworld
...
contract KoanasClub is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5000 * 10**6 * 10**9;
    ...
    string private constant _name = "Koalas Club";
    string private constant _symbol = "KWOR";
    uint8 private constant _decimals = 9;
    
    address payable public _developmentAddress = payable(0x56063baf3C6F261C8645448272dD9a2A977BD83A);
    address payable public _marketingAddress = payable(0xeC9E1C0Aa18899eEc6df8542F9145e9b72807cf5);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (antiBotEnabled) {
            pinkAntiBot.onPreTransferCheck(from, to, amount); // PINK ANTI-BOT
        }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 5, "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 5, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 14, "Tax cannot be more than 6.");
    ...
    function setUsingAntiBot(bool enabled_, address pinkAntiBot_) external onlyOwner {
