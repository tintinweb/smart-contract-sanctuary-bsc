...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F0DD3d54E818C9D6C661277436F501dF582B290; 
...
contract MuuSale is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuuSale";
    string private _symbol = "MuuSale";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2F0DD3d54E818C9D6C661277436F501dF582B290); // 
    address payable public teamWalletAddress = payable(0x2F0DD3d54E818C9D6C661277436F501dF582B290); // 
