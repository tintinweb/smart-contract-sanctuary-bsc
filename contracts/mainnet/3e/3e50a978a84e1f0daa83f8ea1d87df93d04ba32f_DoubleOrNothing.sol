...
Double... Or Nothing. Send 0.1, Get 0.2 back
@DoubleorNothingbsc
...
contract DoubleOrNothing {
    ...
    string public constant symbol = "2or0";
    string public constant name = "DoubleOrNothing";
    ...
    receive() external payable {
        ...
        if(address(this).balance >= payout + payout/90){
            (bool sent, ) = list[index].sender.call{value: payout}("");
            (bool sentDev, ) = dev.call{value: payout/90}("");
            index++;
        }
    }
}