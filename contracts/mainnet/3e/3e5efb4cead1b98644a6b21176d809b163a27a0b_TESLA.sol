...
contract TESLA is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x34946e52E2619b0e05Ab9dCAb5D33bDC88084D2B));
        marketingWalletAddress = payable(address(0x34946e52E2619b0e05Ab9dCAb5D33bDC88084D2B));
