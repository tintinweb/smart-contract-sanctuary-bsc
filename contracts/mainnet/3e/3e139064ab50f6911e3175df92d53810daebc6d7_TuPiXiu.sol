...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE3bF3574d3008ce6c532A48B3e469852335e7Ce7; // owner address
...
contract TuPiXiu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TuPiXiu";
    string private _symbol = "TuPiXiu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3bF3574d3008ce6c532A48B3e469852335e7Ce7); // 
    address payable public teamWalletAddress = payable(0xE3bF3574d3008ce6c532A48B3e469852335e7Ce7); // 
    ...
    uint256 private _totalSupply = 2774000 * 10**_decimals;
    uint256 public _maxTxAmount = 55480 * 10**_decimals; 
    uint256 public _walletMax = 55480 * 10**_decimals;
