...
contract PriceFeedTWAP {

    using SafeMath for uint256;
    using FixedPoint for *;

    address owner;
    address public marketPairAddressBUSD = address(0x57FA15D373cBBD3141A13f8baB10c380aC2B14D5); // CHANGE THIS

    uint256 public PERIOD = 4 minutes;
