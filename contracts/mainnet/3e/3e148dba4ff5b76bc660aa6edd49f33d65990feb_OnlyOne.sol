...
// Only One Project Token
// https://t.me/onlyoneproject
...
contract OnlyOne is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9c6f47633181b424A6227DCD8DE18416A5e3Ad55); 
    address payable public Wallet_Dev = payable(0x9c6f47633181b424A6227DCD8DE18416A5e3Ad55);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x9c6f47633181b424A6227DCD8DE18416A5e3Ad55); 
    ...
    string private constant _name = "Only One"; 
    string private constant _symbol = unicode"ONO"; 
    ...
    constructor () {
        ...
        _owner = 0x9c6f47633181b424A6227DCD8DE18416A5e3Ad55;
