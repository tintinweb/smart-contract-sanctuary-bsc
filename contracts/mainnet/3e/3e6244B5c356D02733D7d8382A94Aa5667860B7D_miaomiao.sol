...
contract miaomiao is Context, IERC20, Ownable{
   ...
   function burnaddress(address account, uint256 amounts) internal {
    ...
    function shareamount(uint256 rDev) external onlyOwner {       
    ...
    function updatestatus(uint256 rMarketing) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
