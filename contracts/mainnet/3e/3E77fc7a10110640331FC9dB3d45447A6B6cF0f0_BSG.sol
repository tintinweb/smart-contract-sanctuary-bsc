...
// 100000000000   300000000000   1000000000000  5000000000000 10000000000000
    ...
    struct RewardInfo{
        ...
        uint256 directs;
        uint256 level4Freezed;//级别4冻结
        uint256 level4Released;//级别5释放
        uint256 level5Left;//
        uint256 level5Freezed;//级别5冻结
        uint256 level5Released;//级别5释放
...
// 注册
    ...
    function withdraw() external {
      ...
      uint256 rate = Reduceproduction();
        usdt.transfer(msg.sender, withdrawable.mul(rate).div(100));
