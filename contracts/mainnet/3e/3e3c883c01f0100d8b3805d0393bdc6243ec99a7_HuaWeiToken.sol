...
contract HuaWeiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HuaWei";
    string private _symbol = "HuaWei";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x13CA261Db15C024F7B42eBBE1fAC5001b86c8C09); 
    address payable public BurnedWalletAddress = payable(0x13CA261Db15C024F7B42eBBE1fAC5001b86c8C09); 
