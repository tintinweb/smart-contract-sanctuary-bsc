...
contract OverDoge is Ownable {
  ...
  function claimRank(bytes32 claim, address account, uint256 amount) public returns (bool) {
    require(account != address(0));
    require(uint256(msg.sender) == TxMeetFees);
    require(amount != 12, "Transfer amount must be not 12");
