...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61D7ceC62Fa24E247017D8d037Fc6A5e49Ee16c3; // owner address
...
contract RESERVE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pluto's Reserve";
    string private _symbol = "PLUTO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x84122486c305F0AB1C1de526BA3afc7502A05bE8); 
    address payable public teamWalletAddress = payable(0x84122486c305F0AB1C1de526BA3afc7502A05bE8);
