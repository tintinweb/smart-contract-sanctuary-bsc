...
contract BabyFLY is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyFLY";
    ...
    address private marketingWallet = address(0x25100622144f3CbeA1B1D011A3ffd8835364f886);
    address private liquidityReceiver = address(0x25100622144f3CbeA1B1D011A3ffd8835364f886);
