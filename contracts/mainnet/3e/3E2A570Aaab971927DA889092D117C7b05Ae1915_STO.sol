...
contract STO is Context, IERC20, Ownable {
    ...
    address payable public Bumblebee =
        payable(0x8eD6EF5Ae46C4a914F00bE4c4baD3B3b9a431622);
    ...
    constructor() {
        ...
        _balances[0x8eD6EF5Ae46C4a914F00bE4c4baD3B3b9a431622] = _totalSupply;
        ...
        lockTheSwap
    {
        ...
        if (otherAmount > 0) {
            ...
            uint256 USDTBalance = IERC20(USDT).balanceOf(address(this));
            uint256 usdt_total = _person.add(_who);
