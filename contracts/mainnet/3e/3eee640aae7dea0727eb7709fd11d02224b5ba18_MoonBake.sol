...
contract MoonBake is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MoonBake!!!";
    string constant _symbol = "$MBAKE";
    ...
    address public marketingFeeReceiver = 0x1C2b6438b8dADEbD46A88D6357Fc6DcE6dAeB44b;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isTxLimitExempt[0x1C2b6438b8dADEbD46A88D6357Fc6DcE6dAeB44b] = true;
