...
contract BETCOINCHAIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdb7302B3F3A2F8011BBa01ce4Ae3CB29D111c467); 
    address payable public Wallet_Dev = payable(0xf3DCCaae6cE2f0Ce0C35f657892639Dc69d30911);
    ...
    string private constant _name = "Betcoin Chain"; 
    string private constant _symbol = unicode"BETCHAIN"; 
    ...
    constructor () {
        ...
        _owner = 0xf3DCCaae6cE2f0Ce0C35f657892639Dc69d30911;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xdb7302B3F3A2F8011BBa01ce4Ae3CB29D111c467); // Testnet
