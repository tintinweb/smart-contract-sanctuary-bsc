...
contract INDT is IERC20, Blacklistable {
    ...
    uint256 internal _totalSupply;
     ...
     /**
     * @dev initialize name, symbol, currency and decimal of the token
     * only once when the contract is deployed.
     */
    constructor(string memory name, string memory symbol, string memory currency, uint8 decimals) {
        _name = name;
        _symbol = symbol;
        _currency = currency;
        _decimals = decimals;
    ...
    /**
     * @dev Returns the tokenSymbol of the token,usually a shorter version of the
     * name.
     */
    ...
    /**
     * @dev Returns the currency of the token.
     */
