...
╚══██╔══╝██╔═══██╗██╔══██╗    ██╔══██╗██╔═══██╗██╔════╝ 
   ...
   ██║   ╚██████╔╝██║         ██████╔╝╚██████╔╝╚██████╔╝
   ╚═╝    ╚═════╝ ╚═╝         ╚═════╝  ╚═════╝  ╚═════╝     
   TOPCAT IS MOONING HARD, KNOW WHAT'S NEXT ? TOPDOG   
   🐶 Top Dog🐶 
Our brother Top Cat  just launched their token and have a trip to the moon, why can't we do the same ?

🧑‍🚀 Low starting market cap allowing you to get multiple x's.
👨‍🚀 Contract copied from TopCat, so it’s safe.
👩‍🚀 Liquidity will be locked for 1  week.
👩‍🚀 Contract forked from Dogcoin which now sits at 300k.

https://t.me/TOPDOG_bsc
*/
...
contract TopDog is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xFBB63A3Bb01E6fd26E563289A586C663F5DB8697;
    address public devFeeReceiver = 0x58dD018d7C71d05c3A814f9adBA2B719f15E89b0;
