...
/**
   #NewCommunityTornado The New Community of Ape Token
    
   I make this #nTornado to hand it over to the community.
   I suggest a Telegram group name for you to create: https://t.me/nTornadoBSC
...
contract NewCommunityTornado is Context, IERC20, Ownable {
    ...
    string private constant _name = "NewCommunityTornado";
    string private constant _symbol = "nTornado";
