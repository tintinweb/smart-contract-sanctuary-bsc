...
contract PANDOGE is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xC9589406420a82660C64Ed863c0CA1c65C4C9969;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xC9589406420a82660C64Ed863c0CA1c65C4C9969] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xC9589406420a82660C64Ed863c0CA1c65C4C9969] = true;
    ...
    function stopBot(address botAddress, bool status) external onlyOwner {      
