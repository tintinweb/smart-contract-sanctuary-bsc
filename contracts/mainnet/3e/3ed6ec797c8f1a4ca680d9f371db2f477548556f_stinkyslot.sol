...
/**
*/
// Telegram : https://t.me/stinkyslotportalbsc
// Website  : 
...
contract stinkyslot is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xBb29220F9328A5ACca94C260746b4d6243f92229));
    address payable public devWallet =
        payable(address(0x279D844721cb6A67D7CBc6643aA257706f56edF4));
    address public liquidityReceiver =
        0xBb29220F9328A5ACca94C260746b4d6243f92229;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Stinky Slot";
    string private _symbol = "StinkySlot";
