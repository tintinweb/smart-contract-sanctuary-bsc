...
// Shiba Battle
// Telegram https://t.me/ShibaBattle
// There is no glory in battle worth the blood it costs. Shiba Battle will bring peace to the world! 
...
contract ShibaBattle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaBattle";
    string private _symbol = "ShibaBattle";
