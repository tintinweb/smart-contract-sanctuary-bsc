...
// Telegram : https://t.me/BabyShrimpGrow
...
contract BabyShrimpGrow is Context, IERC20 { 
    ...
    address payable public MakerOfMarketing = payable(0x913ee1C6691C12c06D4c4f74E27b6BFA756a0301); 
    address payable public MakerOfProject = payable(0xe6351802b79E348afEB9fd080cd7251606354CC6);
    ...
    string private constant _name = "Baby ShrimpGrow"; 
    string private constant _symbol = unicode"BSGROW"; 
    ...
    constructor (uint256 numeric) {
        ...
        _owner = 0xe6351802b79E348afEB9fd080cd7251606354CC6;
