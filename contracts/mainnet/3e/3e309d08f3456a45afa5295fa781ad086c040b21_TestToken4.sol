...
contract TestToken4 is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "TestToken4";
	string private _symbol = "TT4";
    ...
    function _getMaxHolding() internal view returns (uint256) {
        return  (totalSupply() * holdingCapPercent) / 100 / 10;
    }
