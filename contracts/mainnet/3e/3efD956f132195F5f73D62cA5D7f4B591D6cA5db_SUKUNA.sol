...
contract SUKUNA is ERC20, Ownable {
    ...
    address public marketingDevRewardsReceiver = 0xA0E87A804D09Ae5154eab05015AD759ECc37ABB3;
    address public autoLiquidityReceiver = 0x7b7107AD17f92A575F5c1faDefa0eDc85967Aa55;
    
    string private constant NAME = "SUKUNA";
    string private constant SYMBOL = "SKN";
    uint8 private constant DECIMALS = 9;
    uint256 private constant TOTAL_SUPPLY = 50 * 1e6 * 10**DECIMALS; // 50 million tokens
    
    uint256 public swapTokensAtAmount = 2 * TOTAL_SUPPLY / 1000000;  // 0.2% of total supply, 100  tokens 
