        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xC9d20249d1946Cd5916024E5044AE93539C28303), block.timestamp
                );
            }
        }
    }
...
contract Galaxy is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xC9d20249d1946Cd5916024E5044AE93539C28303),//FundAddress
        address(0x35447590c8af0d255365029727FcC3A01c46e70b)//ReceiveAddress
    ){
    }
}