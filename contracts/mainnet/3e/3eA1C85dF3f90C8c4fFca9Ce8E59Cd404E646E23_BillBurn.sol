...
contract BillBurn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bill Murray Inu Burn";
    string constant _symbol = "BILLMURRAY";
    ...
    uint256 public charityburnFee  = 3;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + charityburnFee;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(charityburnFee).div(totalBNBFee);
