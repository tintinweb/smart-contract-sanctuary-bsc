...
Telegram    : https://t.me/spookygala
Website     : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50E6B7209AA4a046060546B0b39BcF9C499E9Ef5; // owner address
...
contract SG is Context, IERC20, Ownable {
    ...
    string private _name = " Spooky Gala ";
    string private _symbol = " SG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50E6B7209AA4a046060546B0b39BcF9C499E9Ef5); // Marketing Address
    address payable public teamWalletAddress = payable(0x50E6B7209AA4a046060546B0b39BcF9C499E9Ef5); // Team Address
