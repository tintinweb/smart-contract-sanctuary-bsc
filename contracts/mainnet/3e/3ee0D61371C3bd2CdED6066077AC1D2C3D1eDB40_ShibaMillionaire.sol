...
contract ShibaMillionaire  is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x2e473BD08Bee1525908EF0e297EeBdc7C636184d);
    ...
    string private constant _name = "Shiba Millionaire"; 
    ...
    function UpdateFeeBuy (uint256 NewFeeBuy) external  onlyOwner {
        _FeeBuy = NewFeeBuy;
    }

    function UpdateFeeSell (uint256 NewFeeSell) external  onlyOwner {
        _FeeSell = NewFeeSell;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_FeeBuy/100;
            uint256 sellFEE = tAmount*_FeeSell/100;
