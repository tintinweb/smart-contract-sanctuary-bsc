...
contract WATERLUNA is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 5e7 * 10**18;
    uint256 public maxSellLimit = 5e7 * 10**18;
    ...
    constructor() BEP20("WATERLUNA", "WTL") {
