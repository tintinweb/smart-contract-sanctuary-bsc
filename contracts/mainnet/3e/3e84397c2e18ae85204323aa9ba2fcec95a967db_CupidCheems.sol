...
* Telegram:CupidCheemsToken

Tokenomics:TBA in TG
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  CHEEMS = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract CupidCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x74d4c0F11FB97596022A7B840cAA7a8f673DF096;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "CupidCheems";
    string constant _symbol = "CCHEEMS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100m 

    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 4% on launch or 4M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 1.5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x73Ff7c44220fd01eD0EcA2FFe660b88eEe726BC2;
