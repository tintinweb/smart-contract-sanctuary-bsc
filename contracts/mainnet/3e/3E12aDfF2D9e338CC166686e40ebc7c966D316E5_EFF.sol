...
contract EFF is IERC20, Ownable {
    ...
    uint256 public lotterySwap = 3;
    uint256 public burnSwap = 4;
    ...
    uint256 public sellTaxMultiplier = 2;
    ...
    constructor() {
        ...
        lotteryFeeReceiver = 0xb7f5601627CA28f329DB96918d93133F3d6554A8;
        gameWallet = 0xA912351b67123C3D8d7405EE0781E41A571c0224;
    ...
    function updateBuyFees(
        ...
        // if trading enable owner can not set fees more than 20%
        if (tradingOpen) {
            require(buyTotalFees <= 20, "Fees can not be greater than 20%");
        }
    }
