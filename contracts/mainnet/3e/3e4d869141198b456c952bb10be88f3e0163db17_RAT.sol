...
contract RAT is Context, IERC20, Ownable {
    ...
    string private _name = "Rescue agreement";
    string private _symbol = "RAT";
    uint8 private _decimals = 18;
    
    uint256 public _devSellFee = 10;
    uint256 public _burnSellFee = 0;
    uint256 public _poolSellFee = 0;
    uint256 public _lpSeellFee = 0;
    
    uint256 public _invitBuyFee = 5;
    uint256 public _poolBuyFee = 5;
    
    uint256 public _transferFee = 10;
    
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public ownerAddres = address(0x355bd3388E90A010b6E35de5048E29A587bdd5ed);
    address public devAddress = address(0xA4709509ea1148D5d935D06982B1AE6150be1C78);
    ...
    ExternalToken public externalToken = ExternalToken(address(0x510b077E3aB729bDE44AbdC8b982eb9486e9a46e));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if (sender == uniswapV2Pair) {  // 购买
            ...
            if (_feeFlag) {
                ...
                uint256 invitBuyAmount = amount.mul(5).div(100);
    ...
    function buyFeeDist(address sender,address recipient,uint256 invitBuyAmount) private {
        uint256 currentRate =  _getRate();
        uint256 oneAmount = invitBuyAmount.div(5);
    ...
    function rewardSuper() private {
        if (block.timestamp >= upRewardTime.add(rewardJg)) {
            uint256 rewardValue = _tTotal.sub(_pairValue).mul(rewardApr).div(100).div(16).div(4);
