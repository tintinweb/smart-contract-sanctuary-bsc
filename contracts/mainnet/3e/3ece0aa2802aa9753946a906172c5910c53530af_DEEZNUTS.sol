...
contract DEEZNUTS is IBEP20, Auth {
    ...
    string constant _name = "stopbuyingimtesting";
    string constant _symbol = "$WG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 4000000000000;     //100%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 200000000000;   //100%
    ...
    address public marketingFeeReceiver = 0x775DC27fE07e87e796105d0b746E20d9c9DA4fa0;
    address public teamFeeReceiver = 0xbfB1E1D668E7dbBDF4CCa0EcFA08B9457A0034Be;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000 * 10; // 100%
    bool inSwap;
