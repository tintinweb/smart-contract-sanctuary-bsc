...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 1 * 10 ** IERC20(FISTAddress).decimals() / 10000000;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= txlimit,"over max amount");
            }
    ...
    function setMaxAmount(uint256 newtx, uint256 newwalletlimit) public onlyOwner{
        txlimit = newtx;
        walletLimit = newwalletlimit;
    }

    event swapFailed(uint256);
    ...
    function setBuyCustom(uint256 newFundFee, uint256 newLpFee, uint256 newRewardFee) public onlyOwner{
        _buyFundFee = newFundFee;
        _buyLPFee = newLpFee;
        _buyLPDividendFee = newRewardFee;
    }

    function setSellCustom(uint256 newFundFee, uint256 newLpFee, uint256 newRewardFee) public onlyOwner{
        _sellFundFee = newFundFee;
        _sellLPFee = newLpFee;
        _sellLPDividendFee = newRewardFee;
    }


    uint256 public startAddLPBlock;

    function toAddLP() external onlyOwner {
    ...
    uint256 public rewardWaitBlock = 5;
...
contract MetaCat is AbsToken {
    constructor() AbsToken(
        ...
        6,
        20230000,
        address(0x3a94b7F1567EFB65C7bA9D0E95513FEE7A06f4b7),
        address(msg.sender)
    ){
