...
contract GQ is Context, IERC20, Ownable {
    ...
    string private _name = "Galactic Quadrant";
    string private _symbol = "$GQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9eba7Bc17ca7e2867e31C727F71E1e11E0803a14); // Marketing Address
    address payable public DevWalletAddress = payable(0x9eba7Bc17ca7e2867e31C727F71E1e11E0803a14); // Dev Address
    ...
    uint256 private _totalSupply = 600000 * 10**6 * 10**9;
