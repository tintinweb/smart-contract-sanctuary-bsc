...
contract BabySDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BabySincereDoge";
    ...
    address public ownerAddres = address(0xcEB600F2194dCD367DC0F2CbdFb2F2Bf4e5a0592);
    address public devAddress = address(0xcEB600F2194dCD367DC0F2CbdFb2F2Bf4e5a0592);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        if (IERC20(fistToken).balanceOf(address(this)) >= 1) {
