...
/*
Telegram: https://t.me/SquidVersee
...
contract Squidverse is Context, IBEP20, Ownable {
    ...
    string private _name = "SquidVerse";
    string private _symbol = "SQUIDVERSE";
...
//Remove from Blacklist
    ...
    function _transfer(
        ...
        if (from == V2Pair && to != address(pancakev2router)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2Pair && recipient != address(pancakev2router);
