...
contract Radhay is Context, Ownable, IERC20 {
    ...
    uint256 private _tTotal = 1111122 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Radhay_Radhay";
    string private _symbol = "RADHAY";
    ...
    address payable public burnWallet = payable(0xB0cB61722B10E80e4E12DdE543E682b98be4fA10);
    address payable public marketingWallet = payable(0xB0cB61722B10E80e4E12DdE543E682b98be4fA10);
    address payable public liquidityWallet = payable(0xB0cB61722B10E80e4E12DdE543E682b98be4fA10);
    address payable public airdropWallet = payable(0xB0cB61722B10E80e4E12DdE543E682b98be4fA10);
