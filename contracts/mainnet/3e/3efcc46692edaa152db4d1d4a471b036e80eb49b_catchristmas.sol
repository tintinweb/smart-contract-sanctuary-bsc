...
/**
Telegram : https://t.me/catchristmass
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA95D8d5011f64251e5A8BAae1Df4674C1aD0a74C; // owner address
...
contract catchristmas is Context, IERC20, Ownable {
    ...
    string private _name = "Cat Christmas";
    string private _symbol = "Catmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA95D8d5011f64251e5A8BAae1Df4674C1aD0a74C); // Marketing Address
    address payable public teamWalletAddress = payable(0xA95D8d5011f64251e5A8BAae1Df4674C1aD0a74C); // Team Address
