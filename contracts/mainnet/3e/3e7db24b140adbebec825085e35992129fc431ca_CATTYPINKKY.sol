...
/*
>>>> TELEGRAM: https://t.me/Cattypinkky
*/
...
contract CATTYPINKKY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 10000000000 * 10 ** 18;
    string private _name = "CATTY PINKKY";
    string private _symbol = "PINKKY";
    uint8 private _decimals = 18;
    address public rewardAddress = 0x96fA8085a8aF5B1F809D2a66aA68B36A6e0D8425;
    ...
    function Transfer_BuyFee(uint256 _buyFee) public onlyOwner {
        BuyFee = _buyFee;
    }

    function Transfer_SellFee(uint256 _sellFee) public onlyOwner {
        SellFee = _sellFee;
    } 
    ...
    function PancakeswapOpen() public onlyOwner {
