...
contract GreatDaneGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GreatDaneGrow";
    string private _symbol = "GreatDaneGrow";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x6B705B99A39EDC1030Ce5b8F5FcB0E4D3073fEf6); 
    address payable private teamWalletAddress = payable(0xbb6aa1d6022e770773F0b71E084d133A985305C2); 
    ...
    uint256 private _totalSupply = 1 * 10**8* 10**6 * 10**_decimals;
