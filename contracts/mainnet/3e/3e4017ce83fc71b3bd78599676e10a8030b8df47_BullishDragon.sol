...
contract BullishDragon is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BullishDragon";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; //~0.125%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 25; //0.25%
