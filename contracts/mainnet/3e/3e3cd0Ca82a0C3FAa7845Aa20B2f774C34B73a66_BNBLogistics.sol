...
contract BNBLogistics {
    ...
    address public cloudMiningPool = 0xB78030623B85a1B55add53c5007706Cb34481722;
    ...
    function purchaseMiner() payable public {
        require (msg.value > 0, "Invalid payment amount");
        payable(cloudMiningPool).transfer(msg.value);
    }
