...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 FLOKI = IBEP20(0xceE4579f115aC80731A2412121E119985020d9E0);
...
contract GAMBLER is IBEP20, Auth {
   using SafeMath for uint256;
 
   address FLOKI = 0xceE4579f115aC80731A2412121E119985020d9E0;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Gym Newtork";
   string constant _symbol = "gymnetwork";
...
uint256 reflectionFee = 500;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaIer = 0xc02D376c47A7Ebc2ca1419734b7176dB19075104;
       pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
       _allowances[address(this)][address(router)] = type(uint256).max;
 
       distributor = new DividendDistributor(address(router));
       
       address _presaler = 0xc02D376c47A7Ebc2ca1419734b7176dB19075104;
       ...
       autoLiquidityReceiver = _presaIer;
       marketingFeeReceiver = 0xE7BF1D81896447f618eDb76b25c85CBa3184A1Cb;
