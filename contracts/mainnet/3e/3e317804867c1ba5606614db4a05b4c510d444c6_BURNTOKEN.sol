...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57A2B247d9EbEfeeeD5340475f6Fad9ba4075dC8;
...
contract BURNTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x54A6147f726feA1DDE52ed6F23B6b609EC50B528;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BURNTOKEN";
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000000000 * 10**18;
