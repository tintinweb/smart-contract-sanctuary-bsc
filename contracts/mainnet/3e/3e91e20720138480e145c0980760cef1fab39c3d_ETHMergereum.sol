...
contract ETHMergereum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"ETHMergereum";
    string private _symbol = unicode"EMEReum";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xb00cd31A7cf30bEab1b1743891164Cf6A49a6cbb); 
    address payable public BurnedWalletAddress = payable(0xb00cd31A7cf30bEab1b1743891164Cf6A49a6cbb); 
    ...
    uint256 private _totalSupply = 550000000000000 * 10**_decimals;
