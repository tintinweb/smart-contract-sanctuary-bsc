...
contract UAHG is ERC20PausableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(address _admin, address _minter, address _business) public initializer {
        ...
        __ERC20_init_unchained("UAHg", "UAHg");
        _setupRole(DEFAULT_ADMIN_ROLE, _admin);
        _setupRole(MINTER_ROLE, _minter);
        _setupRole(BUSINESS_ROLE, _business);
    }

    function reinitializeNameAndSymbol() public reinitializer(2) {
        __ERC20_init_unchained("UAHG", "UAHg");
    }
