...
contract NEWCOMMUNITY_TERRALUNA is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress =
        payable(address(0x9cb7B0Ff5b29885B1f4B317a95987a735fd1A47f));


    string private _name = "NEWCOMMUNITYTERRALUNA";
    string private _symbol = "$CTLUNA";
