...
contract BabyVicMove is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby VicMove";
    string private _symbol = "BABYVIM";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x8e2C094033c8e2c74379dF15109ec47157404697); // Marketing Address
    address payable public teamWalletAddress = payable(0x8e2C094033c8e2c74379dF15109ec47157404697); // Team Address
    ...
    uint256 private _totalSupply = 50 *  10**8 * 10**_decimals;
