 ...
 * t.me/CoinbirdHONKERS - Community Group
 ...
 * You are interacting with and using this smart contract at your own risk. Use responsibly.
 */
...
contract Coinbird is ferocious, feathery
{
    ...
    {
        require((value >= 10)&&(value <= 400)); // 0.10% to 4.00% - gradually decrease this as liquidity increases to protect investors and ensure longevity
    ...
    function freshsoil(uint amount) public safe goose  // reminder: adapted Pareto Optimality notion, very dangerous, ask Goose for exact calculation using the mathematical formula
    {
