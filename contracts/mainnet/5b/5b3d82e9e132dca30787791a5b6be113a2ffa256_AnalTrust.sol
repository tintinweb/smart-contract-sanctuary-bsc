...
contract AnalTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anal Trust";
    string private _symbol = "AT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD59b24b6046b49AD618cd1C93cC82EbA54E63eCe); // Marketing Address
