...
contract LunaDoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFd49a3133eb512523Eb68d30A6C1C3B4baCe72B4); 
    address payable public Wallet_Dev = payable(0xFd49a3133eb512523Eb68d30A6C1C3B4baCe72B4);
    ...
    string private constant _symbol = unicode"LunaDoge"; 
    ...
    constructor () {
        ...
        _owner = 0xFd49a3133eb512523Eb68d30A6C1C3B4baCe72B4;
