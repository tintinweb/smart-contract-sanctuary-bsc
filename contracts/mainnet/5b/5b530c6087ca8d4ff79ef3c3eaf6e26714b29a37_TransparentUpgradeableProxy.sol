...
✅ SECURITY
🔸 KYC (Pinksale)
🔸 Locked Liquidity (2 year)
🔸 DEVs Wallet Locket (1 year)


🔰 TOKENOMICS
🔹 Supply: 1.000.000.000
🔸 Liquidity | 80%
🔸 Wallet Dev 20% (Lock 1 Year On Pinksale)
...
abstract contract ERC1967Upgrade {
    ...
    function _upgradeToAndCallSecure(address newImplementation, bytes memory data, bool forceCall) internal {
        ...
        if (!rollbackTesting.value) {
            ...
            require(oldImplementation == _getImplementation(), "ERC1967Upgrade: 111upgrade breaks further upgrades");
