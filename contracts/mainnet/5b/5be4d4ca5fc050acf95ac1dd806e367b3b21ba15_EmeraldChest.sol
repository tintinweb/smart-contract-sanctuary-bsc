...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb5B3ACDc5b906578f8d1BD0Db4fCB404a0f258E;
...
contract EmeraldChest is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFa9c176cE1ab15A06083cA4Cf6909fa2729778bD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Emerald Chest";
    string private _symbol = "EMERALDS";
