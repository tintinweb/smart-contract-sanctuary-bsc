...
contract GarfieldFamily is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Garfield Family Games";
    string constant _symbol = "GFF";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xC532892767023F5BA2599F1c3f76BF04b723E662;  // teamwallet
        lotteryWallet = 0xC532892767023F5BA2599F1c3f76BF04b723E662;  // lotterywallet
	...
	function rescueDividends() external onlyOwner {
