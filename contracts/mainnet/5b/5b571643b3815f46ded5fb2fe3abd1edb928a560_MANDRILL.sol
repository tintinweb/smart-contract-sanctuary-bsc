...
contract MANDRILL is BEP20, Auth {
    ...
    string public constant name = "Mandrill";
    string public constant symbol = "MAND";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + devFee + utilityFee + teamFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x68e91Ff6dc303F78033151dA707431bB7820aF85;
        devFeeReceiver = 0x277BdadF7A82Ab1a9C5Cac664abfdF748aFF3486;
        teamFeeReceiver = 0xF79E940970AC386108442d460F06b941895F90dF;
    ...
    function setFeeReceiver_dev(address _adr) external {
        require(msg.sender == devFeeReceiver, "Can only be called by Dev");
        devFeeReceiver = _adr;
    }

    function setFeeReceivers(address _marketingFeeReceiver, address _teamFeeReceiver, address _utilityFeeReceiver) external onlyOwner {
