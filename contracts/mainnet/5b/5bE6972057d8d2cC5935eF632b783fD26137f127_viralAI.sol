...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9D65B5f599848EB11Df68964ec1C0154FB80B905;
...
contract viralAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "VIRAL AI"; // 
    string private constant _symbol = "VIRAL AI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x9D65B5f599848EB11Df68964ec1C0154FB80B905);
