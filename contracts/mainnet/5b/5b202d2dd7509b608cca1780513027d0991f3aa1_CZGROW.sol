...
contract CZGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZ GROW"; //
    string private constant _symbol = "$CZGrow"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xd9D5fA81e1245aE2cc350Baf5C5dEfD4661E247B ;
