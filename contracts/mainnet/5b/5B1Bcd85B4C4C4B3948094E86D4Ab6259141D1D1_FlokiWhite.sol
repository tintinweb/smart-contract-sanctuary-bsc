...
contract FlokiWhite is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xab58b63806132372f859B2B675371De851aF6B0C); 
    address payable public Wallet_Dev = payable(0xab58b63806132372f859B2B675371De851aF6B0C);
    ...
    string private constant _name = "Floki White"; 
    string private constant _symbol = unicode"FLOKWHITE"; 
    ...
    constructor () {
        ...
        _owner = 0xab58b63806132372f859B2B675371De851aF6B0C;
