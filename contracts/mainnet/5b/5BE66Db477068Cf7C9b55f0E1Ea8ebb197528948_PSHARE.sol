...
contract PSHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 65,000 PSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 60000 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 2500 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 2500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PSHARE Token", "PSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 SCT Pshare for initial pools deployment
