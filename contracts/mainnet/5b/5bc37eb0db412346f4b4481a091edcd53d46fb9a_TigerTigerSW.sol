...
contract TigerTigerSW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TigerTigerSW";
    string private _symbol = "TigerTigerSW";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xB0e180323514c2C59CFcfCadDE97F8A49c302513);
    address payable public teamWalletAddress = payable(0x3C5952451F65C37276B026B31DD642B3f0d33EA6);
