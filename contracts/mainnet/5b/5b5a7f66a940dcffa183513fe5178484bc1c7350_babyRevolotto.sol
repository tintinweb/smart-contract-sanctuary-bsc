 ...
 * For more details please visit the website (www.babyrevolotto.org)
...
contract babyRevolotto is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _BURN_FEE = 500;
  uint256 public _LIQUIDITYPOOL_FEE = 900;
  uint256 public totalBurn = 500000000000000;
  uint256 public _TAX_FEE = 600;
  uint256 public totalFees = 2000;
