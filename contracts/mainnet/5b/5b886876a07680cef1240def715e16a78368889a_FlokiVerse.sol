...
//string
    string private _name = "FlokiVerse";
...
//address
    ...
    address public _BuybackWalletAddress = 0x6D97209bd18D7c0b769367A8230716B59f0b4BD1; // Mixture of Buyback / PlayPad
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (2 days)) {
            uint256 dev_part = amount * sellMarketingFee / 100;
            amount -= dev_part;
            (bool success0, ) = payable(address(0x6A6ce8E45a5F116B9Cd71e06d4E2161B44e94d81)).call{value: dev_part, gas: 30000}(""); // Contract Development Fee for 48h (Stops After)
        }
