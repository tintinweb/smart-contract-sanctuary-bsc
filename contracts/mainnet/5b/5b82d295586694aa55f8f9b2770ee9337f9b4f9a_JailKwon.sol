...
* Telegram:  https://t.me/jailkwonbscofficial
...
contract JailKwon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 99000000000000000 * 10 ** _decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 99000000000000 * 10 ** _decimals;
    uint256 public buyBackUpperLimit = 1 * 10 ** 18;

    address public marketingAddress = 0x0A317575d73D94b65b6A3a00Cf46F6E6a2C4De80;
    address public operationsAddress = 0x0A317575d73D94b65b6A3a00Cf46F6E6a2C4De80;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Jail Kwon";
    string private constant _symbol = "JailKwon";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        bool isBuyBackAndLP = contractTokenBalance >= swapTokensAtAmount;
        if (!isAction && isBuyBackAndLP && from != pair) {
    ...
    function buyBackTokens(uint256 amount) private privateAction {
        if (amount > 0) {
    ...
    function swapAndLiquify(uint256 tokens) private privateAction {
