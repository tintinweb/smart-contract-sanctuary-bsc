...
contract VoxInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Vox Inu";
    ...
    address payable public DevWallet = payable(0x6d569645aA60715B09Bc759E54Acdde18d3B8381);
    address payable public MarketingWallet = payable(0x719177D8AE9216105e5ff99B92A4e4A4744B8Bd0);
    address payable private TeamWallet01 = payable(0x2F9DCC8577Fc1a8006bB743Cc3e1C15A91266D49);
    address payable private TeamWallet02 = payable(0x2F9DCC8577Fc1a8006bB743Cc3e1C15A91266D49);
    address payable private TeamWallet03 = payable(0x2F9DCC8577Fc1a8006bB743Cc3e1C15A91266D49);
