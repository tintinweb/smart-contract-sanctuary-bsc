...
// File: contracts/CrazyPandaManager.sol
...
contract CrazyPandaManager is Ownable{
    ...
    uint256 public pricePanda;
    address public feeAddress;
    uint256 public ownableMaxSize;
    uint256 public nftMaxSize;

    constructor () {
        feeAddress = address(0x6CE29834d95515bbe98975cc9C6D82c0D5a304bd);
        pricePanda = 150000000000000000;
        ownableMaxSize = 10;
        nftMaxSize = 3500;
    }
    ...
    function setPricePanda(uint256 newPrice) public onlyOwner {
        pricePanda = newPrice;
    }
