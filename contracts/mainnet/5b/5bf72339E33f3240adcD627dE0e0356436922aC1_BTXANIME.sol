...
contract BTXANIME is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTX ANIME";
    string private _symbol = "BTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x194056797631D09d2D57F9f0348c6707133c0623); 
    address payable public buyBackWalletAddress = payable(0x194056797631D09d2D57F9f0348c6707133c0623); 
