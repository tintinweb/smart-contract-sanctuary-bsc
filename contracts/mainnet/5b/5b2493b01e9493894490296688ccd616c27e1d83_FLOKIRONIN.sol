...
contract FLOKIRONIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiRonin";
    string private _symbol = "FRONIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30fAB4cf167b32975adC5b4A0E33eb58014C86a3); 
    address payable public DevelopmentalWalletAddress = payable(0xcBB2EaBb5F209cfCb8E59A877B08De3c029E6758); 
