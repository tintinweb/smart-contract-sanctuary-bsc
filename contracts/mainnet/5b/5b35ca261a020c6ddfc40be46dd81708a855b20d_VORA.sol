...
/**
 *VORA NETWORK | The First Blockchain Freelance Service Marketplace for Business
 *https://vora.network
*/
...
contract VORA is Context, IERC20, Ownable {
    ...
    address payable public _taxPool =
        payable(address(0x0085Ca18847287941Fc749A2522b2E7B5669521E));

    string private _name = "VORA NETWORK";
    string private _symbol = "VORA";
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**18; // 5% of total supply
    uint256 public _maxWalletSize = 50 * 10**6 * 10**18; // 10% of total supply
