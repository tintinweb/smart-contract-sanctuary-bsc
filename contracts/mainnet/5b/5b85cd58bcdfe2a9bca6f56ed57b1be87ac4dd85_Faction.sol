...
| $$     | $$  | $$| $$    $$   | $$     | $$  | $$  | $$| $$\  $$$
| $$     | $$  | $$|  $$$$$$/   | $$    /$$$$$$|  $$$$$$/| $$ \  $$
|__/     |__/  |__/ \______/    |__/   |______/ \______/ |__/  \__/
...
contract Faction is Context, IERC20, Ownable {
    ...
    string private _name = "Faction";
    string private _symbol = "$FACTION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56C88D323ECC6C52D055cd363Fb9b424d0401879); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x56C88D323ECC6C52D055cd363Fb9b424d0401879); // BuyBack Address
