...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xE84e3b1Afb6eE96cF1A97A79663bf80b36680f95] = _marketingwallet;
    }
...
contract FLONAINU is ERC20, Ownable {
    ...
    constructor() ERC20("FLONA INU", "FLONA") {
        ...
        excludeFromFees(address(0xE84e3b1Afb6eE96cF1A97A79663bf80b36680f95), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xE84e3b1Afb6eE96cF1A97A79663bf80b36680f95), true);
