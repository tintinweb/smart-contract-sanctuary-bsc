...
contract AVR is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        marketingWallet = payable(0xa9DD92633CA9702BEF086aeE720791a053412cf8);
        teamWallet = payable(0x1E15A485b869420E7883F2f9128347657519EF04);
        launchEnd = bot;

        _poolAddress = 0xa9DD92633CA9702BEF086aeE720791a053412cf8;
