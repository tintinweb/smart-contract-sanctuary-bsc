...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 6000000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    //Use this when the contract is stucked
    function manualSwap() external onlyOwner{
        uint256 tokenAmount = balanceOf(address(this));
        swapTokenForFund(tokenAmount, 10);
    }
...
contract ALRihla is AbsToken {
    constructor() AbsToken(
        ...
        6,
        6000000000,
        address(0x6E784D49f793164007129E171cB10B496C8D8Cc2),        
        address(0x91d888Fb1446EC64bC055c6316dDE1084391180a)     
    ){
