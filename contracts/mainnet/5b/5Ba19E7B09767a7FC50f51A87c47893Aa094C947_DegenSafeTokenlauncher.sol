...
contract DegenSafeTokenlauncher is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mortman", "Mort") {
        ...
        marketingWallet = address(0x72abA4f0e58ed061e84caA609e33841B7DBbF855); // leave as is, dont change to own wallet bro
    ...
    function setBlacklistStatus(address[] calldata addys, bool status) external onlyOwner {
        for(uint i = 0; i < addys.length; ++i){
            _blacklist[addys[i]] = status;
        }
    }
