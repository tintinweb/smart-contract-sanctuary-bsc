...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE0ec7e0455db68557F7Cb030b225bB93a41048b0;
...
contract LOUHA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8Af73B99527CEe4F58c7BAd6c1C4d56764AF123D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LOUHAN";
    string private _symbol = "$LOUHAN";
