...
// File: contracts\SingleIASMetaverseAuction.sol

// SingleIASMetaverse Auction Contract 
...
contract SingleIASMetaverseAuction is Ownable, ERC721Holder {
    ...
    {   
        ...
        ISingleIASMetaverse nft = ISingleIASMetaverse(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            ISingleIASMetaverse(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = ISingleIASMetaverse(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = ISingleIASMetaverse(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            ISingleIASMetaverse(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
