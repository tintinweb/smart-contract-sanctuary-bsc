...
import {ERC20_Swap2_Own_AutoBB_Liq} from './ERC20_Swap2_Own_AutoBB_Liq.sol'; 
import './libraries/Ownable.sol';
import './interfaces/ITokenFactory.sol';

contract TokenGen2 is Ownable {
    ...
    function createToken(
        ...
        ERC20_Swap2_Own_AutoBB_Liq newtok = new ERC20_Swap2_Own_AutoBB_Liq(name, symbol, decimals, totalSupply, owner, raddr, bbbfee, bbsfee, lbfee, lsfee);
...
// Swap 2.0, Ownable, autoBB, liquify

contract ERC20_Swap2_Own_AutoBB_Liq is IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.buyBack).sub(values.liquify);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.buybackFee.add(_defaultFees.liquifyFee);
        }
    }
