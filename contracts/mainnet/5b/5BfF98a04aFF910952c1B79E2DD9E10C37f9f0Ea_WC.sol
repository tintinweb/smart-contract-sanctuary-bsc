...
contract WC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x39172eF7DfEfa2CBe187ADFd4F0442C9bE78888d); // Marketing Address
    ...
    uint256 private _totalTaxIfBuying = 2;
    uint256 private _totalTaxIfSelling = 2;
    ...
    address payable private teamWalletAddress = payable(0x39172eF7DfEfa2CBe187ADFd4F0442C9bE78888d); // Team Address
