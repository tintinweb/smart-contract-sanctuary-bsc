...
contract SpaceAbeZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperCNMoon";
    string private _symbol = "SuperCNMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f6B1b0b86037a20b79A0756BceE058D48438A59); 
    address payable public teamWalletAddress = payable(0x3f6B1b0b86037a20b79A0756BceE058D48438A59); 
