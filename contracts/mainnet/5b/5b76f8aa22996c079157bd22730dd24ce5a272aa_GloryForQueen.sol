...
contract GloryForQueen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Glory For Queen";
    string private _symbol = "GFQueen";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe07b10aF9829787d577b944c1Dc763f49387fA39);
    address payable public teamWalletAddress = payable(0xbD37e5917d5866F989c19929063023989C0BDf50);
