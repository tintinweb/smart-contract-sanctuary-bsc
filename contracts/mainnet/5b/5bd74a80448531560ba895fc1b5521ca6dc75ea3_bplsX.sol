 ...
 */
contract bplsX is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**8 * 12**DECIMALS;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("BabyPulseX", "bplsX", uint8(DECIMALS))
        payable
        public
    {
