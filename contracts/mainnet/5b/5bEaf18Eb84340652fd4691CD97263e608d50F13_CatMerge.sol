...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1d202d79738842855D325eDFe47ffb11F2326e1; // owner address
...
contract CatMerge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Merge";
    string private _symbol = "CATMARGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbA258e6b3a52CCbB57Da269c254A79776B1cd664); // Marketing Address
    address payable public teamWalletAddress = payable(0xE1d202d79738842855D325eDFe47ffb11F2326e1); // Team Address
