...
// OFFCIAL CODE Grow Dejitaru Tsuka
// https://t.me/GrowTsuka
...
contract GrowDejitaruTsuka is Context, IBEP20, Ownable {
    ...
    string public _name = "Grow Dejitaru Tsuka"; // token name
    string public _symbol = "GTSUKA"; // token ticker
