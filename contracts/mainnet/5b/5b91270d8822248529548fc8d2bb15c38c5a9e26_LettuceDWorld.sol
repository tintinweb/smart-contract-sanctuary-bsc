...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7c058c953d37044298df26C1a9547B40265BDdC7;
...
contract LettuceDWorld is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5954F0e5765a8fbD579b3E7e17a5FaCea3ca209D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lettuce DWorld";
    string private _symbol = "LDW";
