...
contract Kinetix is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kinetix";
    string private constant _symbol = "KNX";
    ...
    uint256 private constant _tTotal = 11000000 * 10**18;
    ...
    address payable private _developmentAddress = payable(0x2dc882658454A48188b5901f4B45CD0BD97C096a); 
    address payable private _marketingAddress = payable(0x2dc882658454A48188b5901f4B45CD0BD97C096a);
