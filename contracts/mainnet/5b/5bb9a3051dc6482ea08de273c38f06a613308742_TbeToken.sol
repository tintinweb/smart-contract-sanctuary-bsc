...
abstract contract TbeTokenBase is TbeTokenStore {
    ...
    //transferState
    bool  internal transferState;

    function setTransferState() public onlyOwner{
    ...
    function _transferTakeFee(
        ...
        if (isBuy_) {
            ...
            if (feeMarket > 0 && feeToMarketReceiver != address(0)) {
                ...
                super._transfer(from_, feeToMarketReceiver, feeMarket);
            }
            // buy fee to invitor
            ...
            if (feeInvitor > 0) {
                ...
                super._transfer(from_, inviteUsdtRewardPool, feeInvitor);
...
contract TbeToken is TbeTokenAdmin {
    ...
    constructor() ERC20("test", "test") {
        ...
        setSwapTokensAtAmount(totalSupply().mul(2).div(1e8));
        setDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        setUsdt(0x55d398326f99059fF775485246999027B3197955);       
        setFeeToMarketReceiver(address(0x819251E7191857165Dc3a6C2093c42B0b5A5DCCb));       
        setInviteUsdtRewardPool(address(0xC2cC6a87E3c5Bd8525e0248dd546e9e329564DC3));   
        setHolderUsdtRewardPool(address(0xbA49dfc62E0BA91222540b896FFEF1B492889821));
