...
contract USDNTToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0e4789a0b1fd8Ffd1D43f674651e68DDF185A78F); // Marketing Address
    address payable public charityAddress = payable(0x0e4789a0b1fd8Ffd1D43f674651e68DDF185A78F); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   200000000000000; //0.001 BNB Airdrop fee
