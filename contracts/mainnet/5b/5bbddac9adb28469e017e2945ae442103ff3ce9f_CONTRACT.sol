...
/**
*Telegram: https://t.me/nydoge_bsc
...
contract CONTRACT is  IBEP20, Auth {
    ...
    string constant _name = "New Year Doge";
    string constant _symbol = "NYDOGE";
    ...
    address private marketingFeeReceiver = 0x938958Aeb5151FaC05B4BBdCB8971432Cbf85d8B;
    address private buybackFeeReceiver = 0x938958Aeb5151FaC05B4BBdCB8971432Cbf85d8B;
    ...
    uint256 public swapThreshold = 30 * 10**1 * (10 ** _decimals); // 0.3%
    bool inSwap;
