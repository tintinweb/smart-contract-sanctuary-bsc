...
contract Smart_Binary is Context {
    ...
    function Reward() public {
        ...
        // if (block.timestamp > lastRun + 48 hours) {
...

        {
            ...
            // mapping(address => Node) memory _usersTest = _users;
    ...
    function Lottery_Reward() private {
        ...
        if (_count_Lottery_Candida > Numer_Win) {
            ...
            for (uint256 i = 1; i < _count_Lottery_Candida; i = unsafe_inc(i)) {
