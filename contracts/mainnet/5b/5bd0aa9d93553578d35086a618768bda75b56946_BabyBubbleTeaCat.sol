...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7F6194e7d8dFaD8aC2f00036761e0cA982BF0dFc); //BUBCAT
...
contract BabyBubbleTeaCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Bubble Tea Cat";
    string constant _symbol = "BABYBUBCAT";
    uint8 constant _decimals = 3;

    uint256 _totalSupply = 3000 * 10**3 * 10**_decimals;
