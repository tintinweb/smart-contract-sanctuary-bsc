...
Telegram : https://t.me/sanjigrowbusdrewards
...
contract Sanjigrow is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "SANJI GROW";
    string constant _symbol = "$SAGROW";
