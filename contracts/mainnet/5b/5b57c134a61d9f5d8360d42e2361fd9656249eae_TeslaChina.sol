...
/* Token contract */
contract TeslaChina is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xA6982E69073c2AcAf681871046c18B558Bfb0705;
    ...
    // Name and symbol
    string constant _name = "Tesla China";
    string constant _symbol = "Tesla China";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 3% or 3m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 1% of supply
