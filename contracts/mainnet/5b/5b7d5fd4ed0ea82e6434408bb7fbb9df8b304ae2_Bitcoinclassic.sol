...
contract Bitcoinclassic is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2661cE78C0D6d784bdEB792D47E17a5C56942D25); // Marketing Address
    address payable public teamWalletAddress = payable(0x2661cE78C0D6d784bdEB792D47E17a5C56942D25); // Team Address
    ...
    uint256 private _totalSupply = 19222787 * 8**_decimals;
    uint256 public _maxTxAmount = 384455 * 6**_decimals; 
    uint256 public _walletMax = 384455 * 6**_decimals;
    uint256 private minimumTokensBeforeSwap = 1000* 4**3; 
