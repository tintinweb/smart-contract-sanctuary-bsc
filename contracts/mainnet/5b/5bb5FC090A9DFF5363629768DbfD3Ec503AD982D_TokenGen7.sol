...
import {ERC20_Swap2_Own_Liq} from './ERC20_Swap2_Own_Liq.sol';
import './libraries/Ownable.sol';
import './interfaces/ITokenFactory.sol';

contract TokenGen7 is Ownable {
    ...
    function createToken(
        ...
        ERC20_Swap2_Own_Liq newtok = new ERC20_Swap2_Own_Liq(name, symbol, decimals, totalSupply, owner, raddr, lbfee, lsfee);
...
// Swap 2.0, Ownable, liquify.

contract ERC20_Swap2_Own_Liq is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _liquifyFee) external onlyOwner {
    ...
    function setSellFees(uint256 _liquifyFee) external onlyOwner {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.liquify);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return (_defaultFees.liquifyFee);
        }
    }
