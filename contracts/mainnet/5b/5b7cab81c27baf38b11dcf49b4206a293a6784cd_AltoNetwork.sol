...
/**
Telegram : https://t.me/altonetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9f12fB1FF857453a0511D697C321338Bf14DF942; // owner address
...
contract AltoNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alto Network";
    string private _symbol = "Alto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9f12fB1FF857453a0511D697C321338Bf14DF942); // Marketing Address
    address payable public teamWalletAddress = payable(0x9f12fB1FF857453a0511D697C321338Bf14DF942); // Team Address
