...
/**
  ___   __   __    ____    ____   __    ___  ____ 
 / __) /  \ (  )  (    \  (    \ /  \  / __)(  __)
( (_ \(  O )/ (_/\ ) D (   ) D ((  O )( (_ \ ) _) 
 \___/ \__/ \____/(____/  (____/ \__/  \___/(____)
...
contract GOLDDOGE is ERC20 {
	...
	address payable _receive = payable(address(0x4ff239847ebd1b4f1ad0125A13a959F219Bb417B));
    ...
    constructor(address tokenOwner) ERC20("GOLD DOGE", "GOLDDOGE") {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > 0){
            if (
                ...
                swapAndLiquifyV1(haveAmount.div(3));
                swapAndLiquifyV3(haveAmount.div(3).mul(2));
                swapping = false;
            }
        }
