...
contract Hornetsinu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Hornets inu";
    string constant _symbol = "HORNETS";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // address routerAddress = 0x4e19501EEdBDFaFc6142069ca75155dF889521A0; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x4e19501EEdBDFaFc6142069ca75155dF889521A0;
        solor = msg.sender;
...
contract StandarToken is Hornetsinu {
    constructor() {}
}