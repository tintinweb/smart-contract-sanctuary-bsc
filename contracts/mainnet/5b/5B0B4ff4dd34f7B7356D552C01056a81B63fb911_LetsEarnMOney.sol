...
// Rebase - Rebase also known as elastic supply works in a way that increases or decrease the circulating supply through a function called rebasing. When a rebase occurs your tokens
// may decrease however they will stay relative to the market cap of the token and the value of
// your tokens will remain the same. The rebase will be used when there are dips in the char
// to counter every dip and keep the chart looking healthy. 

// Telegram: https://t.me/LetsEarnMoneyBSC
// Website: https://www.letsearnmoney.finance/

/* Buy & Sell - 12%
    6% - Usdt Reflection Rewards
    4% - Marketing
    2% - Liquidity
...
contract LetsEarnMOney is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LetsEarnMoney";
    string constant _symbol = "LEM";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000000 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7935c2194d11460ef19Ff71BD853824023a21d6F;
        devFeeReceiver = 0xaF8068f3babAdF15D0493C32e943FFbba6e574b0;
