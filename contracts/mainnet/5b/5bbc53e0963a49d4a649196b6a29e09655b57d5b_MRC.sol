...
// File: contracts/MRC.sol 


contract MRC is BEP20 {
    uint256 private initialSupply;
    uint256 private max_supply = 19000000 * (10**18);

    using SafeMath for uint256;
    uint256 public totalMint;

    constructor() BEP20("Mark Plus", "MRC", 18) {
        initialSupply = 19000000 * (10**18);
        _mint(owner(), initialSupply);
    }

    function mint(uint256 amount) public onlyOwner {
        require(
            totalMint < 19000000000000000000000000,
