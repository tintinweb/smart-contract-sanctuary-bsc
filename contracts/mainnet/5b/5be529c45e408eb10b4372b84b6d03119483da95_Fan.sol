...
contract Fan is Context, IERC20, Ownable {
    ...
    string private constant _name = "6IX9INE FAN TOKEN"; // 
    string private constant _symbol = "$69FAN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xB50B337ADF7A05e67f91064060a25B6Ba393c5EF;
