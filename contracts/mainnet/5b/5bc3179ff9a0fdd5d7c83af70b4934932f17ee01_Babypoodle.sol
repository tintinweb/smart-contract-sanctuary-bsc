...
/**
 ...
 Telegram: https://t.me/babypoodlefibsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xc9dBCff0448D330AAF1Dd78fc204370E5e54a797);
...
/* Token contract */
contract Babypoodle is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC = 0xc9dBCff0448D330AAF1Dd78fc204370E5e54a797; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x4c69ccA0Bd29aBA1AcAA7E93cEF16D8A4BE25A10;
    ...
    // Name and symbol
    string constant _name = "Baby PoodleFi";
    string constant _symbol = "BPFI";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 1m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xe556E0FEfeE5610065aC5bbb12572509f6De439D;
