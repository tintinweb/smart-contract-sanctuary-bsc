...
contract  ERAGONIA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dragon Girl"; // 
    string private constant _symbol = unicode"$ERAGONIA"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x23F0917133Fd7ce5BC55B322caB154FF0971f64d;
