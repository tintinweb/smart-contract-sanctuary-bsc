...
/* 
 🕮 The Walm project is a start-up project created as a utility for Blockchain fundamentals. The Walm project, which is still in the funding and growth phase,
  offers a more convenient and readable ledger technology for all users who transact on the Blockchain by Organizing Distributed Blockchain Ledgers.

  Thanks to the regulated registry technology, the Blockchain aims to provide a much faster and more detailed access to the transfers desired 
  to be searched in the ledger records.

  Accessing the Transfer you want among thousands of Transfers will be presented to you very quickly in a Categorized and historically filtered way.

  It's possible that your search in a standard blockchain ledger is 800% faster and more streamlined.

  With its special Premium Filtering options, Walm Project provides a great benefit to Blockchain ledger technology.

  Owner Wallet :  0xaFC7b5198f8AC16e70A9227fc1C18A7213B373b8
  Marketing Wallet : 0x95e1223d8272c634d5Dc3d2809eB1933289a81cc


    https://t.me/Walmorg
    https://twitter.com/Walm_org
    http://walm.org/
...
contract Walm is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 550000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Walm";
    string private _symbol = "WALM";
    ...
    address public charityWallet = 0x95e1223d8272c634d5Dc3d2809eB1933289a81cc;
    ...
    uint256 public numTokensSellToAddToLiquidity = 5500000 * 10**9;
