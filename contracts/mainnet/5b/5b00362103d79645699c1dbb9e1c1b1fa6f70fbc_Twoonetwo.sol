...
contract Twoonetwo is ERC20 {
    ...
    uint tokenTotalSupply = 212; // 212 token supply

    constructor() public ERC20("212", "212") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 212 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "212";
    string private _symbol = "212";
    ...
    uint256 public _maxTxAmount = 212 * 10**6 * 10**9;
