...
contract DiamondDog is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("Diamond", "Diamond") {
        rewardToken = 0x0e0360E9E01Ff76Ebf7927c3a30136Debd1cC50c;
        _marketingWalletAddress = 0x4C8F2384CD1630A687fF9eCf86c58260ab686686;
        require(
        ...
        liquidityFee = 2;
        marketingFee = 1;
        uint256 totalsupply_=2100*10**8*10**18;
    ...
    function _transfer(
        ...
        // require(!balanceOutOfLimit(to),"The balance held exceeds the limit");
    }
