...
/**
Incinerator Token V2 Upgrade // Website - https://incinerator.app // Telegram - https://t.me/IncineratorBSCPortal // Twitter, Medium, Instagram - @IncinerateBSC 
*/
...
contract Incinerator is ERC20, Ownable {
    ...
    constructor() ERC20("Incinerator", "BURNT") {
        ...
        dividendTracker = new IncineratorDividendTracker(payable(this), router, 0x0000000000000000000000000000000000000000,
                                                   "IncineratorTRACKER", "BURNTTRACKER");
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 26000, "max wallet cannot be set to less than 0.1%");
        maxWallet = value;
    }
    ...
    function updateFees(uint256 deadBuy, uint256 deadSell, uint256 marketingBuy, uint256 marketingSell,
        ...
        require(totalSellFees <= 16 && totalBuyFees <= 16, "total fees cannot exceed 16% sell or buy");
...
contract IncineratorDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(false, "withdrawDividend disabled. Use the 'claim' function on the main Incinerator contract.");
    }
    ...
    function _reinvestDividendOfUser(address account) private returns (uint256) {
        ...
        if (_withdrawableDividend > 0) {
            ...
            {
                uint256 received = IncineratorContract.balanceOf(address(this)).sub(prevBalance);
                if (received > 0) {
                    success = true;
