 ...
 * @title Prediction
 */
contract Prediction is Ownable, Pausable, Initializable {
     ...
     */
    function startRound(uint256 startTimestamp, uint256 lockTimestamp, address rewardToken) external whenNotPaused {
