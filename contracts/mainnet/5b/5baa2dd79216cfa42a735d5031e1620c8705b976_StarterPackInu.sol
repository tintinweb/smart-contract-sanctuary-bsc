...
contract StarterPackInu  is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Starter Pack Inu";
  string constant tokenSymbol = "Starter Pack Inu";
...
//LP WILL BE REMOVED, DON'T PUT MONEY HERE
