...
contract SLASH is SLASHDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SLASHTeam;
    address private CharitySLASH;
    ...
    string public override name = "CryptoSlash";
    string public override symbol = "SLASH";
    ...
    constructor(uint totalSupplyValue, address SLASHTeamAddress, address CharitySLASHAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SLASHTeam = SLASHTeamAddress;
        CharitySLASH = CharitySLASHAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SLASHTeam] =  totalSupply * 4 / 100;
        balances[CharitySLASH] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SLASHTeam pot
