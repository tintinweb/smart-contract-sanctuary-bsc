...
contract DividendDistributor is IDividendDistributor { 
    ...
    IDEXRouter router; 
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //CroMeerkat router 
    ...
    function shouldDistribute(address shareholder) internal view returns (bool) {return shareholderClaims[shareholder] + minPeriod < block.timestamp 
...
//HIER 
contract BNBChamp is IBEP20, Auth { 
     
    using SafeMath for uint256; 
//HIER 
    string constant _name = "BNBChamp"; 
    ...
    constructor () Auth(msg.sender) { 
        ...
        autoLiquidityReceiver = address(0xf6C4DbEbBcD049F3B36342Cb825377fB1b07A42b); 
        marketingWallet = address(0x3a5443c5097A47c5863dD464fb7Fa8bAb1c1Be54); 
...
function changeWalletLimit(uint256 newLimit) external authorized { 
    ...
    function swapBack() internal lockTheSwap { 
        ...
        (bool tmpSuccess1,) = payable(buybackWallet).call{value: devShare, gas: 30000}(""); 
