...
/**
MARS PI TOKEN on BSC! a community-driven, decentralized cryptocurrency with instant rewards for holders.

Telegram: https://t.me/MarsPiToken
Website: http://marspitoken.com/
Twitter: https://twitter.com/marspitoken
Tax: 0%

  __  __                  ____  _   _____     _              
 |  \/  | __ _ _ __ ___  |  _ \(_) |_   _|__ | | _____ _ __  
 | |\/| |/ _` | '__/ __| | |_) | |   | |/ _ \| |/ / _ \ '_ \ 
 | |  | | (_| | |  \__ \ |  __/| |   | | (_) |   <  __/ | | |
 |_|  |_|\__,_|_|  |___/ |_|   |_|   |_|\___/|_|\_\___|_| |_|
...
contract MarsPi is Ownable, IERC20 {
    ...
    string private _name = "MARS PI TOKEN";

    string private _symbol = "MarsPi";
