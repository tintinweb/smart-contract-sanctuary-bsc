...
contract CREDITstake {
    ...
    uint256[4] public Duration = [360 days, 540 days, 720 days, 1440 days];
    uint256[4] public Bonus = [100, 150, 200, 500];
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 rewardtokenPrice = (amount.mul(CREDITVAL)).div(1e9);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address CREDIT_WBNB = 0x7417cb46466E9006EF44d133Ce36F879aD1d7cc0;
        IERC20 CREDITTOKEN = IERC20(0xc9308bCF5Fa46d728422753D2D5afBc5cDb66b03);

        uint256 WBNBSUPPLYINCREDIT_WBNB =(WBNBTOKEN.balanceOf(CREDIT_WBNB));
        uint256 CREDITSUPPLYINCREDIT_WBNB = (CREDITTOKEN.balanceOf(CREDIT_WBNB));

        uint256 CREDITUSDVAL = (((WBNBSUPPLYINCREDIT_WBNB.mul(1e9)).div((CREDITSUPPLYINCREDIT_WBNB))).mul(BNBPRICE)).div(1e18);
        return CREDITUSDVAL;
    }
