...
contract Testmax is ST20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    event LogRebase(uint256 indexed epoch, uint256 totalSupply);
    string public _name = "Testmax";
    string public _symbol = "TESTMAX";
    ...
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(insuranceFee).add(firePitFee);
    ...
    uint256 private constant MAX_SUPPLY = 3250000000 * 10**9;
    ...
    constructor() ST20("Testmax", "TESTMAX", uint8(DECIMALS)) Ownable() {
        router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        pair = IPancakeSwapFactory(router.factory()).createPair(router.WETH(), address(this));
        autoLiquidityReceiver = 0x00947cBC8D188b527f8BB674CC6aC297E5d34008;
        treasuryReceiver = 0xd4ce9ECbd1Ac69e3DD96C5D2bd176D17C34E092a; 
        insuranceReceiver = 0xcfF1ac6BfceA71F3aA05122C9c9a742cde5A4316;
        firePit = 0x21E5D3d9A961FBfe25505C1FAE69ca57d32AB00c;
    ...
    function shouldRebase() internal view returns (bool) {
        return
            _autoRebase && (_totalSupply < MAX_SUPPLY) && msg.sender != pair  && !inSwap && block.timestamp >= (_lastRebasedTime + 15 minutes);
    }
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _treasuryReceiver, address _insuranceReceiver, address _firePit) external onlyOwner {
