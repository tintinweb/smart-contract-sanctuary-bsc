...
contract AUTOC is IERC20, Ownable {
    ...
    // token data
    string private constant _name = "Automated City";
    string private constant _symbol = "AUTOC";
    uint8  private constant _decimals = 18;
    uint256 public constant MAX_TOTAL_SUPPLY = 7000000 * 10**_decimals; 
