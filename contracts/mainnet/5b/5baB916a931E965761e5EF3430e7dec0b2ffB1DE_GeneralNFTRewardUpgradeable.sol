...
contract GeneralNFTRewardUpgradeable is IPool,GovernanceUpgradeable, IMigratable {
    ...
    function __GeneralNFTRewardUpgradeable_init_unchained(
        ...
        _fixRateBase = 100000;
        _maxStakedDego = 2000000000000000;
    }
    ...
    function earnedInternal(address account) private view returns (uint256) {
        ...
        return reward.div(1e9).add(_rewards[account]);
    }
    ...
    /*
    1   quality	2.1+ 0.1*quality/5000
    2	quality	2.2+ 0.1*(quality-5000)/3000
    3	quality	2.3+ 0.1*(quality-8000/1000
    4	quality	2.4+ 0.2*(quality-9000)/800
    5	quality	2.6+ 0.2*(quality-9800)/180
    6	quality	2.8+ 0.2*(quality-9980)/20
    */
