...
contract LUNATRUST is Context, IERC20, Ownable {
    ...
    string private _name = "Luna Trust";
    string private _symbol = "LUNATRUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27aDb1369cFD46c369c0C6cA330DfE1aFD06d646); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xe8fdBBebf2Dc7eE66Bd9Ca763db48100f741423B); // Development Address
