...
contract PeaceGigaFactory is Ownable,ERC1155Receiver {
    ...
    constructor(address _nftAddress) {
        ...
        royaltyInfo.treasuryPercent = 300;
        addressInfo.treasuryAddress = payable(0x8E3B8f5E3d8fDdfdF09e0ED231187EeD4F3fE3E0);
        royaltyInfo.teamPercent = 100;
        addressInfo.teamAddress = payable(0x935C0b053a120Ed058004984c59705a3F2b3Fa0c);
        royaltyInfo.tradingPercent = 100;
    ...
    function claimByNFT(uint256 _tokenID) external onlyNFTOwner(_tokenID) {
        ...
        _busdToken.transfer(msg.sender, nftReward * (royaltyInfo.totalPercent - royaltyInfo.teamPercent / 2) / royaltyInfo.totalPercent);
        _busdToken.transfer(addressInfo.teamAddress, nftReward * royaltyInfo.teamPercent / 2 / royaltyInfo.totalPercent);
    ...
    function claimAll() external {
        ...
        _busdToken.transfer(msg.sender, rewards * (royaltyInfo.totalPercent - royaltyInfo.teamPercent / 2) / royaltyInfo.totalPercent);
        _busdToken.transfer(addressInfo.teamAddress, rewards * royaltyInfo.teamPercent / 2 / royaltyInfo.totalPercent);
