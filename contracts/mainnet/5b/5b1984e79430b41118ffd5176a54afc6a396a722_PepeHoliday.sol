...
Pepe Holiday
Tax 10/10
Telegram : https://t.me/PepeHoliday
*/
...
contract PepeHoliday is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeHoliday";
    string private _symbol = "Pholy";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x2d4a3cEA8C47292b4DEDedB2DC09eA08ab0F3B95); // Marketing Address
    address payable public teamWalletAddress = payable(0xC342E000519d5225c8B9A8BBBcfc56282111513f); // Team Address
