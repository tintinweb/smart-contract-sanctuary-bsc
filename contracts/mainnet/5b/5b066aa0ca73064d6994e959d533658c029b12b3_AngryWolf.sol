...
contract AngryWolf is Context, IERC20, Ownable {
    ...
    string private constant _name = "Angry Wolf"; // 
    string private constant _symbol = "$AWOLF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x55b34723173b1b778AFECEcD2559cB43CB1200ff;
