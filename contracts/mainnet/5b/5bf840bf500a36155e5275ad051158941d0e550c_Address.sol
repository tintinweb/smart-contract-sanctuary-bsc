...
//
// Copyright of The $BSFTest Team
// 
// $BSFT has 7% tax split across 7 protocols
// (Sells have doubled tax)
// 
// Yield Harvest    1%: $BSF Share Pool
// Cultivate        1%: Buyback
// Holders Harvest  1%: Reflected
// Crop Weeding     1%: Burn
// Pollinate        1%: Liquidity
// Breeding         1%: Community Investment
// Homestead        1%: Marketing & Development
...
/**
 * @dev The official $BSFTest smart contract
 */
contract $BSFTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "$BSFTest";
    string private _symbol   = "$BSFT";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for $BSFT/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xf0208E4c9b3450869E0581BAC741e79c10A70BB5); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $$BSFT will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-$BSFT tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts $BSFT balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns $BSFT tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of $BSFT tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from $BSFT)
