...
contract SHIBDAO is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
       ...
       // IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0xFFDbC48C95c4A3552B475A053f48B0596A86DdC3);     
        pancakeswapV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory())
            .createPair(address(this), _pancakeswapV2Router.WETH());

        _Token = IToken(0xFFDbC48C95c4A3552B475A053f48B0596A86DdC3);
