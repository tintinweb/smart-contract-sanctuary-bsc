...
contract Galareum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Galareum";
    string private constant _symbol = "Galareum";
    ...
    address public liquidityReceiver = address(0x1e84437a3360484eE509a2fB213E553b9399D188);
    address public marketingWallet = address(0xD3792cB23503ab0140147B404205Ed5cD4FB5305);
    address public bbWallet = address(0x1e84437a3360484eE509a2fB213E553b9399D188);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 3600 && !phaseOne) {
