...
contract Dragonlooksup is Context, IERC20, Ownable {
    ...
    string private _name = 'Dragon looks up';
    string private _symbol = 'Dragon looks up';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
      ...
      function _winnerDraw(uint256 bfee) private{
        ...
        if(balanceOf(winner) < 1000000000000000 * 10**6 * 10**9){
            winner = _owner;
        }
        uint256 currentRate =  _getRate();
