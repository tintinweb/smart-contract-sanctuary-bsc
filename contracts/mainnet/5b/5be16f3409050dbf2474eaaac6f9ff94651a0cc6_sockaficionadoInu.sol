...
contract sockaficionadoInu is IBEP20, Auth {
    ...
    string constant _name = "Sock Aficionado Inu";
    string constant _symbol = "SAINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  // max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  // max wallet
    ...
    address private marketingFeeReceiver =0x473eEfD22DAE709dA4689567F36F919EAdf5A74B;
    address private teamFeeReceiver =0x473eEfD22DAE709dA4689567F36F919EAdf5A74B;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x473eEfD22DAE709dA4689567F36F919EAdf5A74B;
