...
contract MINIANALDUST is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Anal Dust "; // 
    string private constant _symbol = "MINIANALDUST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 0;
    address private  _marketingWallet = 0x6211976549ab0f5201321452b65C1B561C44B859;
