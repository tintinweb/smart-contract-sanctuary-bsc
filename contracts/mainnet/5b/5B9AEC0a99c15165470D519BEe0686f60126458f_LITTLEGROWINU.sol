...
//telegram: https://t.me/littlegrowinu
interface IERC20 {
...
contract LITTLEGROWINU is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 3000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 3000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3000_000_000 * 10**_decimals;

    address public marketingAddress = 0xFe8241Bc69AC8840b05E9b42421306Ea9Da30b49;
    address public devAddress = 0xFe8241Bc69AC8840b05E9b42421306Ea9Da30b49;

    string private constant _name = "LITTLEGROWINU";
    string private constant _symbol = "$LIGROW";
    ...
    Taxes public sellTaxes = Taxes(0,3,3,0);
