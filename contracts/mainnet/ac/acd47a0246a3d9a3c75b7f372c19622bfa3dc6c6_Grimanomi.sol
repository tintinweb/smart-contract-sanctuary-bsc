...
/**
你好 歡迎來到 Grimanomi，我們的目標是通過我們下一次秘密推出實用代幣來席捲 BSC 鏈，營銷已經提前計劃並將在發布後不久開始，這將是一個長期存在的實用代幣計劃代幣為了在當前和未來的 BSC 空間中前進，我們不僅僅是一個代幣，我們還代表交易平台、未來的質押 , 我們自己的 P2E 視頻遊戲以及即將發布的更多內容。 
...
contract Grimanomi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grimanomi";
    string private constant _symbol = "GRIMANOMI";
