...
// Telegram: https://t.me/freefoodproject

// Website: https://freefoodproject.samcart.com/products/free-food-course
...
contract FREEFOODPROJECT is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   // Buy Fees
    ...
    uint256 buybackFeeBuy = 400; // buys and burns(go buyback section for dead address)
    ...
    uint256 buybackFeeSell = 400; // buys and burns(go buyback section for dead address)
    uint256 reflectionFeeSell = 0;
    uint256 marketingFeeSell = 3100; // first 12 hours, then 8%
