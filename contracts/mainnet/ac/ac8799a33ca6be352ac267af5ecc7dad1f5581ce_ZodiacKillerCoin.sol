...
contract ZodiacKillerCoin is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Zodiac Killer Coin";
    string private _symbol = "ZKC";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xce7e3D25A4c798aD61DB3f79eBEBe3cB1ccBFA8a);
    address payable public DevelopmentWalletAddress = payable(0xce7e3D25A4c798aD61DB3f79eBEBe3cB1ccBFA8a);
