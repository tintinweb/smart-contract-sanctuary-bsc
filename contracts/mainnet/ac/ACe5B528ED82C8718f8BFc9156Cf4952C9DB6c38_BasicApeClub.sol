...
contract BasicApeClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Basic Ape Club";
    ...
    address public Owner=0x266c4561B33b399b0DfE2844E77852df4d56A06F; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3e2d758e416c96BC286eCDc775068525A13C5da3;
