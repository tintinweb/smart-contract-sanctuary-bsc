...
contract ZonoPoolFactory is Ownable {
    event NewZonoPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(ZonoPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        ZonoPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewZonoPoolContract(smartChefAddress);
    }
}