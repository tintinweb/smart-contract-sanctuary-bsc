...
contract TokageInuNFTS is Auth, ERC721, ERC721Enumerable {
    ...
    uint256 opl_delta = 150;
    //uint256 opp_delta = 200;
    //uint256 opr_delta = 150;
    uint256 den_delta = 800;
    ...
    uint private _mintSharesDistributor = 800;
    uint private _mintSharesAllotment = 200;
