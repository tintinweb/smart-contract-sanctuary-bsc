...
contract CheemsBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheems Boy";
    string private _symbol = "CheemsBoy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEBECda532cAF336bD5a17EB108E81db1C14Ec0f1);
    address payable public BuyBackWalletAddress = payable(0xEBECda532cAF336bD5a17EB108E81db1C14Ec0f1);
