...
/*
TG PORTAL https://t.me/visantalik
**/
...
contract ViSantalik is Ownable, IERC20 {
    ...
    string constant _name = "Vitalik as Santa";
    string constant _symbol = "ViSantalik";
    ...
    uint256 public totalFee        = liquidityFee + ecoFee + marketingFee + burnFee;
    ...
    constructor () {
        ...
        isTimelockExempt[ecoFeeReceiver] = true;
        ...
        ecoFeeReceiver = 0x04cfcEc4D98f7055b3529B1a9120c31f5651E420;
        marketingFeeReceiver = 0x04cfcEc4D98f7055b3529B1a9120c31f5651E420;
    ...
    function setMaxWallet(uint256 maxWalletAmount) external onlyOwner {
        require(maxWalletAmount >= 5,"Cannot set max wallet less than 0.5%");
        _maxWalletAmount = (_totalSupply * maxWalletAmount ) / 1000;
    }


    function setMaxTxnAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= 1,"Cannot set max transaction less than 0.1%");
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != burnFeeReceiver && recipient != ecoFeeReceiver && recipient != marketingFeeReceiver && !isTxLimitExempt[recipient]){
    ...
    function clearCryptoAssets(uint256 amountPercentage) external onlyOwner { 
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHEco = amountETH.mul(ecoFee).div(totalETHFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing}("");
        (tmpSuccess,) = payable(ecoFeeReceiver).call{value: amountETHEco}("");
    ...
    function prepareLaunch(bool _status) external onlyOwner {
        launchMode = _status;
    }


    function manageBot(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function updateG(uint256 _maxG) public onlyOwner {
               maxG = _maxG * 1 gwei; 
    }
