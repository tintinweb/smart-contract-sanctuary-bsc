...
//Telegram: https://t.me/mysterylaunchportal

/*
A little about us. 
             ✅ Do you regret that you missed a lot of NFT collections, which now have a large floor? One of these collections was created by our team. 
             ✅ You know our collection very well. Believe me. 
             ✅ Now we are releasing the second collection. It is needed for the next game. You have a chance to buy our token now at a very low price. What is it for? You will need a ticket for the second collection mint. And this ticket can only be bought for this token. Buying a ticket, you will receive a "whitelist" for our second collection. 
             ✅ You won't want to miss this. And you can transfer the remaining tokens through our bridge and use it in the game. Just trust me. 
            ✅ After the launch, we will reveal all the details. You will be greatly surprised.
...
⁉️ Tax 3% LP
               5% Marketing
               2% Buyback & burn
⁉️ Total tax 10% BUY/SELL
⁉️ Supply at launch
⁉️ Max buy at launch
⁉️ LP/mcap at launch
⁉️ Token name at launch (but hyped)
⁉️ Antibot: YES
⁉️ Anti-whale: YES
*/
...
contract Mystery  is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal * 7 / 100;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5000000000 * 10**9; 
    string private constant _name = "Mystery @mysterylaunchportal"; 
    string private constant _symbol = "DontBuy"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7D57dBB2f5407Bf0A2839d819B0Dc5029f8a39FA;
