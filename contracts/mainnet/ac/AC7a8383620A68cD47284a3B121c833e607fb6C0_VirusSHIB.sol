...
contract VirusSHIB is ERC20 {
    ...
    constructor() ERC20("VirusSHIB", "VirusSHIB") {
        ...
        _fundAddress = address(0xccCD99448d5d5465ec2925676CFf88379BF76367);
        _setAutomatedMarketMakerPair(_uniswapV2Pair, true);

        // exclude from paying fees or having max transaction amount
        excludeFromFees(msg.sender, true);
        excludeFromFees(address(this), true);
        doge = IERC20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
        uint256 total = 10**23;
