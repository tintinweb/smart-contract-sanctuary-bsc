...
contract ShibDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibDogeKing";
    string private _symbol = "ShibDogeKing";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x25A6C2366eCB1e46177c28E274f97cFfb5ba5ee2); // Marketing Address
    address payable public teamWalletAddress = payable(0xeA719b0dbF3217A36Df9eBe98348F7713729C7C9); // Team Address
