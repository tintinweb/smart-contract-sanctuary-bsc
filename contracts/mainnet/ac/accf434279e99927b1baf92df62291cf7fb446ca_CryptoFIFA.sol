...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x98C71B1CA5c8AaC7DfB82297BC446FB51FB79E6A; // owner address
...
contract CryptoFIFA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto FIFA";
    string private _symbol = "CFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98C71B1CA5c8AaC7DfB82297BC446FB51FB79E6A); // Marketing Address
    address payable public teamWalletAddress = payable(0x98C71B1CA5c8AaC7DfB82297BC446FB51FB79E6A); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 44000 * 10**_decimals; 
