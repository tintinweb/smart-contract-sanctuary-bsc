...
// SPDX-License-Identifier: shib4.0
...
contract shib   is IERC20 {
    ...
    //shib4.0, creator will take 8% fee
    address public feeTo = 0xb64C0967C5dd6772AeD050177E9734Ebe6197767;

    string public name = "shib4.0";
    string public symbol = "shib4.0";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //shib4.0 supply max length
    ...
    constructor() {
       mint(msg.sender,  (10 ** decimals) * 1000000000);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 shib4.0
