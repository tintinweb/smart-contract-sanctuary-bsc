...
TG Community - do not buy we fucking bot
...
contract Test is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable private _marketingAddress = payable(0x90281293c787d61b2cb9aA09e231e1531744B3F3);
    address payable private _teamAddress = payable(0x90281293c787d61b2cb9aA09e231e1531744B3F3);
    address payable private _ecosystemAddress = payable(0x90281293c787d61b2cb9aA09e231e1531744B3F3);
    address payable private _lpRecipient = payable(0x90281293c787d61b2cb9aA09e231e1531744B3F3);
