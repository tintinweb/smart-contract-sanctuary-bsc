...
//t.me/RatBoyJrOfficial - HUG ME DADDY VENOM AND BOSSY !!!!!
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd);
...
/* Token contract */
contract RATBOYJR is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x05214f023287e083ffe4bFd96206A90833aF573d;
    ...
    // Name and symbol
    string constant _name = "RatBoy JR";
    string constant _symbol = "$RBJ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf94d5Fa1EbA91770Ec8A90365A15c17F2Fe316b2;
