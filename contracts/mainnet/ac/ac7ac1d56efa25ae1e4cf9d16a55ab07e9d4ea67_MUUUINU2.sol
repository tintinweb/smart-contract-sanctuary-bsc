...
contract MUUUINU2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MUUU INU 2.0";
    string constant _symbol = "MUUU";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 4 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD9FF4C6FfC2E82364713eE99072700f97a21BaD1;
        marketingFeeReceiver = 0x14F1eA22736225B15b7189cF6F46e0e378F71fFf;
        teamFeeReceiver = 0xD9FF4C6FfC2E82364713eE99072700f97a21BaD1;
        charityFeeReceiver = 0xD9FF4C6FfC2E82364713eE99072700f97a21BaD1;
