...
contract  GoblinModeCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoblinModeCoin";
    string private _symbol = "GMC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xb167BF2A03EA19a6e0012c2af29EE8Af5cb064e0);
