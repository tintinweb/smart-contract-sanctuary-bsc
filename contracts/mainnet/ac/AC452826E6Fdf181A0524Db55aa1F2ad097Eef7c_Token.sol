...
contract Token is Context, IBEP20, Ownable {
	...
	_marketingWallet = 0x13bc6D04ce027025a39Ac1344611Bf4ec07C8795;
        ...
        burn(_burn);
        uint256 publicAmount = balanceOf(_msgSender());
        _totalOffer = publicAmount.add(privateSaleAmount);
        _hasLimit = true;
    }
