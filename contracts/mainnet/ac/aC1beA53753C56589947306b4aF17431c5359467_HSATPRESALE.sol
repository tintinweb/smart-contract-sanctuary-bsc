...
contract HSATPRESALE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21_000_000 * 10 **_decimals;     // Supply do Token = 100m
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxInAmount = 21_000_000 * 10**_decimals;    // 100%
	//saque ate dia 10/01 limitados  20k por saque 
    uint256 public _maxOutAmount = 1;    //  (0,0000000000010)
	uint256 public _maxWallet = 21_000_000 * 10**_decimals;    // 100%
    uint256 public numTokensToSwap = 21_000_000 * 10**_decimals;    // 100%
    uint256 public numTokensToSwapLiquidity = 21_000_000 * 10**_decimals;    // 100%
    ...
    string private constant _name = "PERSALE HSAT";
    string private constant _symbol = "HSATPRESALE";
    ...
    address private walletPresaleAddress;
    ...
    constructor () {
        ...
        walletPresaleAddress = address(0xFe8499aA6BCA75C2D973420D084DEC43e82E8B2A); 
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[walletPresaleAddress] = true;
    ...
    function setwalletPresaleAddress(address payable  _walletPresaleAddress) public onlyOwner {
        _isExcludedFromFee[_walletPresaleAddress] = true;
        walletPresaleAddress = _walletPresaleAddress;

    }
    function getwalletPresaleAddress() public view returns (address) {
        return walletPresaleAddress;
    }
