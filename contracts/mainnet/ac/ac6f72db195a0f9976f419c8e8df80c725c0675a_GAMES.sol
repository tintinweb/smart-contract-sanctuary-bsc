...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Gaming Stars';

    string constant public symbol = 'GAMES';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 800000000000*10**uint256(decimals);
