...
contract BattlefieldOfRenegades is ERC20, ERC1363, ERC2612, ERC20Burnable, ERC20TokenRecover, IBattlefieldOfRenegades {
    ...
    uint256 public override swapTokensAtAmount = 10000 * (10**18);
...
interface IBattlefieldOfRenegades is IBEP20, IERC1363, IERC2612, IERC20Burnable, IERC20TokenRecover {
    ...
    function RBA() external view returns (address);
    ...
    function dividendTracker() external view returns (IBattlefieldOfRenegadesDividendTracker);
    ...
    function buyGameVaultFee() external view returns (uint256);

    function buySafetyVaultFee() external view returns (uint256);

    function sellSafetyVaultFee() external view returns (uint256);
    ...
    function sellGameVaultFee() external view returns (uint256);
    ...
    event vault2Updated(address indexed newVault2, address indexed vault2);

    event vault1Updated(address indexed newVault1, address indexed vault1);
    ...
    function initializeDividendTracker(IBattlefieldOfRenegadesDividendTracker _dividendTracker) external;
    ...
    function updateVault1(address newVault1) external;

    function updateVault2(address newVault2) external;
...
interface IBattlefieldOfRenegadesDividendTracker is
    IBEP20,
