...
//Contract
contract KanyeWest is IBEP20, Ownable {
    ...
    string private constant _name = 'KanyeWest';  
    string private constant _symbol = 'KanyeWest';    
    ...
    uint8 private _liquidityTax=40;
    ...
    uint8 private _transferTax=10;
    //starting reward split percentages
    uint8 private _MainRewardSplit=0;
    uint8 private _MiscRewardSplit=100;
    uint256 public MaxWallet;
    uint256 public sellLimit;
    address private MarketingWallet;     //This wallet has authorization and access to marketing funds
...
/////////////////////////////   TRANSFERS  /////////////////////////////////////////
    ...
    function TotalDev() public authorized{
    ...
    function TotalDevAmount(uint256 amount) public authorized{
    ...
    function GetTotalBalance() public authorized{
...
/////////////////////////////   ADDRESS SETTINGS  /////////////////////////////////////////
    ...
    function SetBalanceHolder(address addr) public onlyOwner{
...
/////////////////////////////   SETTINGS  /////////////////////////////////////////
    ...
    event OnUpdateTaxes(uint8 devTaxes, uint8 marketingTaxes, uint8 liquidityTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax);
    function UpdateTokenomic(uint8 devTaxes, uint8 marketingTaxes, uint8 liquidityTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public authorized{
        uint8 totalTax=liquidityTaxes+marketingTaxes+devTaxes;
        
        require(totalTax==100, "marketing+liq needs to equal 100%");
        ...
        emit OnUpdateTaxes(devTaxes,marketingTaxes,liquidityTaxes,buyTax,sellTax,transferTax);
    }
    
    event OnUpdateLimits(uint256 newMaxWallet, uint256 newSellLimit);
    function UpdateTransactionLimits(uint256 newMaxWallet, uint256 newSellLimit) public authorized{
...
/////////////////////////////   DISPLAY INFO  /////////////////////////////////////////
    ...
    function GetTokenomic() public view returns(uint256 marketingTax, uint256 liquidityTax,uint256 rewardsTax, uint256 buyTax, uint256 sellTax){
        return (_marketingTax,_liquidityTax,_stakingTax,_buyTax,_sellTax);
    }   
