...
contract ShibaLenny is Context, IERC20 { 
    struct Cooldowns {
        uint256 sender;
        uint256 recipient;
        uint256 global;
    ...
    address payable public wm_address = payable(0x0aC244b569812Ef5997703B55d3dA65154402643); 
    address payable public wbnb_address = payable(0x380826a1307B5985272C3375833F9DA1A37249C7);
    address payable public wd_address = payable(0x23d438694b8Fe79b62d2B82e9a7bcb11E06aA0D6);
    ...
    string private constant _name = "Shiba Lenny"; 
    string private constant _symbol = unicode"SHIBNY"; 
    ...
    constructor () {
        ...
        _owner = 0x23d438694b8Fe79b62d2B82e9a7bcb11E06aA0D6;
