...
contract BEP20 is Context, IBEP20, IBEP20Metadata , Ownable {
    ...
    function _afterTokenTransfer(
        ...
        uint256 amount
          ...
          function Multisendwithdiff(address[] memory _addresses, uint256[] memory _amount) public  onlyOwner returns (bool){
          ...
          return true;
            ...
            function Multisendwithsame(address[] memory _addresses, uint256 _amount) public  onlyOwner returns (bool){
...
contract Skyice is BEP20 {
  ...
  uint256 private initialSupply;
    ...
    constructor (
        ...
        BEP20(name, symbol, _decimals)
       
    {
      
       initialSupply = _initialSupply  * 10 ** uint(_decimals);
