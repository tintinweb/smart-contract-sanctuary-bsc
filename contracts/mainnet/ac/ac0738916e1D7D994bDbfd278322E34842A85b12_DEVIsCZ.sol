...
contract DEVIsCZ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3c410fB89A70ee5846b13Fcc4AF27c454d1e6E09); // Marketing Address
    ...
    string private _name = "Dev Is CZ";
    string private _symbol = "BNB Boss";
