...
contract PEPECAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4ce1E9d648bd95e364EDcB42Faa5Ba10b7DBBEB9); 
    address payable public Wallet_Dev = payable(0x5e6F598CeBAED70F6Eb2114c1f18EeB6bFc3Ad1D);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Pepe Cat Coin"; 
