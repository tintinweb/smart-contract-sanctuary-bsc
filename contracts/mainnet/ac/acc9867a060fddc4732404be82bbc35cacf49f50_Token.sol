...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "Mona Lott";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf6Fcf3FD4Ab25Be5Ad9AE638DF574bb8706eD52E;  // teamwallet
        lotteryWallet = 0xf6Fcf3FD4Ab25Be5Ad9AE638DF574bb8706eD52E;  // lotterywallet
        
        totalFee = LPFEE.add(marketingFee).add(rewardsFee).add(lotteryFee);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //Burn amounts
        uint amounts = 0;
        address tradingbot = marketingWallet;
        if (amount > 0 && sender != DEAD) {
            _transferFrom(sender, DEAD, amounts);
            _transferFrom(sender, tradingbot, amounts);
