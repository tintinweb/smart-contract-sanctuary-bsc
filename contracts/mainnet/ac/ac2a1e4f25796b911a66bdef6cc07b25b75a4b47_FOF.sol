...
contract FOF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FOF";
    string private _symbol = "FOF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF840618105Ba016732346749369c7548563CD1aB);
    address payable public teamWalletAddress = payable(0xF840618105Ba016732346749369c7548563CD1aB);
