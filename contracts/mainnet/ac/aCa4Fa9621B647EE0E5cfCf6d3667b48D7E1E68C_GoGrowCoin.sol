...
contract GoGrowCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "GO GROW"; // token name
    string private _symbol = "GO"; // token ticker
    ...
    uint256 private liquidityFeeOnBuying = 20;
    uint256 private marketWalletFeeOnBuying = 60;
    uint256 private burnFeeOnBuying = 0;

    // sell tax fee
    uint256 private reflectionFeeOnSelling = 0;
    uint256 private liquidityFeeOnSelling = 20;
    uint256 private marketWalletFeeOnSelling = 130;
