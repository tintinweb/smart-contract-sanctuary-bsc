...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf97B7c2F7502d722cB23F882b99b8389DF2aA42B; // owner address
...
contract Dodo is Context, IERC20, Ownable {
    ...
    string private _name = "Dodo Inu";
    string private _symbol = "DODO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8112ED3f446BCDce6C44DE22af358e35C1D16706); // Marketing Address
    address payable public teamWalletAddress = payable(0x263D00e5330F34F916dAdE4d8570b0b368B636a2); // Team Address
