...
contract NINJAINU is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"NINI";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x0915AD3e56eAD2dA6A4753d8a521B079C16301a3));
        marketingWallet = payable(address(0x0915AD3e56eAD2dA6A4753d8a521B079C16301a3));
