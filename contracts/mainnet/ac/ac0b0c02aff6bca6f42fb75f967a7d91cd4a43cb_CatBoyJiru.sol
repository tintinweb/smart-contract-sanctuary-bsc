...
contract CatBoyJiru is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Boy Jiru"; //
    string private constant _symbol = "CBOY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xe57D2e0595AD873aF0FdfDefDdD47575fC84fD7A;
