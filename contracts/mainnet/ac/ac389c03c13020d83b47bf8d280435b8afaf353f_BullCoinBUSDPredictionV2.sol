...
// File: Bulc/prediction_busd/AggregatorV3Interface.sol
...
// File: Bulc/prediction_busd/Address.sol
...
// File: Bulc/prediction_busd/IERC20.sol
...
// File: Bulc/prediction_busd/SafeERC20.sol
...
// File: Bulc/prediction_busd/ReentrancyGuard.sol
...
// File: Bulc/prediction_busd/Context.sol
...
// File: Bulc/prediction_busd/Pausable.sol
...
// File: Bulc/prediction_busd/Ownable.sol
...
// File: Bulc/prediction_busd/contract.sol
...
/**
 * @title BullCoinPredictionV2
 * fork of PancakePrediction
 */
contract BullCoinBUSDPredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public minBetAmount = 5000000000000000000; // minimum betting amount (denominated in wei)
    ...
    constructor(
        ...
        BUSD = IERC20(address(_busdtoken));
    ...
    function betBear(uint256 epoch , uint256 amount) external whenNotPaused notContract{
        require(epoch == currentEpoch, "Bet is too early/late");
        require(_bettable(epoch), "Round not bettable");
        require(ledger[epoch][msg.sender].amount == 0, "Can only bet once per round");
        return _betBear(epoch, amount);
    }

    function _betBear(uint256 epoch, uint256 _amount) internal whenNotPaused {
     ...
     * @param epoch: epoch
     */
     function betBull(uint256 epoch , uint256 amount) external whenNotPaused notContract {
        require(epoch == currentEpoch, "Bet is too early/late");
        require(_bettable(epoch), "Round not bettable");
        require(ledger[epoch][msg.sender].amount == 0, "Can only bet once per round");
        return _betBull(epoch, amount);
    }


    function _betBull(uint256 epoch, uint256 _amount) internal whenNotPaused {
        uint256 balancebefore = BUSD.balanceOf(address(this));
    ...
    function claimTreasury() external onlyAdmin {
        ...
        treasuryAmount = 0;
        BUSD.safeTransfer(adminAddress, currentTreasuryAmount);
