...
contract YakeDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "YakeDoge";
    string private _symbol = "YakeDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x999381659E24c1FEC4f05C2333F04E505DbEcE01));
        marketingWalletAddress = payable(address(0xEE4D5F7b47b942555853a7A00Ecd97e86fB81Bfe));
