...
contract  FollowRabbit  is Ownable, IERC20 {
    ...
    string private  _name = "Follow Rabbit";
    string private  _symbol = "FollowRabbit";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if (    Buyser[from] + 300  <= block.timestamp )    {   burnfee = amount.mul(bf).div(100); }     }  }
