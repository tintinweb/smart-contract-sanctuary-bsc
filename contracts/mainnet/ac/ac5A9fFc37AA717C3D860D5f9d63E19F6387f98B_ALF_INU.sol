...
/*
Alien Life Form on the BNB Chain.

Visit out Telegram group @AlfInuPortal
This token By @CallsByCrayak

WARNING!!!!!! 
i'll always guarante that our project gonna be FAIR!!!
SO DON'T TRY TO SNIPE !!! 
*/
...
contract ALF_INU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alf Inu";
    string private _symbol = "ALFINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBd24552D49e7592a4F1CeFe8A7aF49e16B22132c);
    address payable public teamWalletAddress = payable(0x7Ff6D7fa2C689853C23B81d63CeC6F7938c6AD0A); 
