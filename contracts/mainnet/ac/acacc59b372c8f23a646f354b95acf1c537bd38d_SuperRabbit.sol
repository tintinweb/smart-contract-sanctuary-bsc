...
contract SuperRabbit
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "SuperRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc9b0fc1123F9EB45C5a51db77de93c5167a13442);
    address payable public teamWalletAddress = payable(0xc9b0fc1123F9EB45C5a51db77de93c5167a13442);
    address public immutable deadAddress =0xc9b0fc1123F9EB45C5a51db77de93c5167a13442;
