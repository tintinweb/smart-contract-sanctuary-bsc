...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa97Cc9126a6B432Fd811676f7fe3c525BdAD52Fb;
...
contract BabyLunc is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xEe7a04615BbAF4284f3D73B8BAc32E4198837BBa;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyLunc";
    string private _symbol = "BabyLunc";
