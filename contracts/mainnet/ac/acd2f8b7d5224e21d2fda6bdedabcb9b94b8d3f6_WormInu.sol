...
contract WormInu is Context, IERC20, Ownable {
    ...
    string private _name = "Worm Inu";
    string private _symbol = "WORM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB1D8311fDC9dDE1d5A006886f82fC6c27411677); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xbB1D8311fDC9dDE1d5A006886f82fC6c27411677); // Development Address
