...
contract FATELON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FATELON";
    string constant _symbol = "FATE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaDD04D7cD520eB3AF947BA27081dC98B960bE8e2;
        developmentFeeReceiver = 0xa6F0e509e8fe0f7f31da5A6b38BaA587c5997cBb;
    ...
    function triggerLoveBuyback(uint256 amount, bool triggerBuybackMultiplier) external onlyOwner {
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _developmentFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        developmentFee = _developmentFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_rewardFee).add(_marketingFee).add(_developmentFee);
