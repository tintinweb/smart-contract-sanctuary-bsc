...
contract FRONTIER is IERC20, Context, Ownable {
    ...
    string private constant _name = "Frontier";

    uint256 public __Max_BuySze = 10000000 * 10**9;
    uint256 public __Max_SellSze = 10000000 * 10**9;

    address private __Marketing_Wallet = 0xBB0dd9B9bC37DD052E7bD5A2EbB2882D19A7abcd;
    address private __Team_Wallet = 0x63B69F2d4A15ddFbB238025b82Ac5c1aD424f3b5;
    ...
    Taxes public sellTaxes = Taxes(0, 30, 2, 5);
    Taxes public taxes = Taxes(0, 30, 2, 8);
