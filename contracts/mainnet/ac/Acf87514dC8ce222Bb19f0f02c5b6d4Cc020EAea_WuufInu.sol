...
/**
 * Wuuf inu is a coin dedicated to all the dog memecoins that got us together here. 🐾
 
 ( IMPORTANT: Don't snipe or you will be rekt!!! Wait till the telegram group is opened and you will find the contract Pinned! )

   Telegram: https://t.me/WuufInu
   Website: http://wuufinu.com/
   Twitter: https://twitter.com/Wuufinu
...
contract WuufInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Wuuf Inu";
    string constant _symbol = "WUUF";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x181B2E6fa3da93e881Cd6feAbD179Bfc198Aa735;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
