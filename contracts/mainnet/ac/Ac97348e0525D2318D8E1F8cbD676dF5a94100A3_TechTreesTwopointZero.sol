...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x6A684b3578f5B07c0Aa02fAFc33ED248AE0c2dB2); //TTC
...
contract TechTreesTwopointZero is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Tech Trees 2.0";
    string  _symbol = "TTTWO";
    ...
    uint256 public swapThreshold = _totalSupply * 48 / 10000;
    bool inSwap;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xE79794d310bfdFB1c585d12B3e1d3d6684492B7D;
        teamFeeReceiver = 0xE79794d310bfdFB1c585d12B3e1d3d6684492B7D;
        devFeeReceiver = 0xE79794d310bfdFB1c585d12B3e1d3d6684492B7D;
