...
TELEGRAM : https://t.me/mamoruinuBSC
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4CCDEaa057dcA703A557F0703d3082E2A5252f61; // owner address
...
contract MORINU is Context, IERC20, Ownable {
    ...
    string private _name = " Mamoru Inu ";
    string private _symbol = " MORINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4CCDEaa057dcA703A557F0703d3082E2A5252f61); // Marketing Address
    address payable public teamWalletAddress = payable(0x4CCDEaa057dcA703A557F0703d3082E2A5252f61); // Team Address
