...
/** Telegram:  https://t.me/StarryMeta
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19611B6780fEd2F9FA1F5Bf226DC9530a3D5a11C; // owner address
...
contract starrymeta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starry Meta";
    string private _symbol = "$StarryMeta"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19611B6780fEd2F9FA1F5Bf226DC9530a3D5a11C); // Marketing Address
    address payable public teamWalletAddress = payable(0x19611B6780fEd2F9FA1F5Bf226DC9530a3D5a11C); // Team Address
