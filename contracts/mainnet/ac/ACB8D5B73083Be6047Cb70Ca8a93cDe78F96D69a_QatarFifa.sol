...
contract QatarFifa is Context, IBEP20, Ownable {
    ...
    string private _name = "Qatar fifa";
    string private _symbol = "Qatar fifa";

    uint256 private buyMarketFee = 0;
    uint256 private sellMarketFee = 15;
    ...
    address public _marketingWalletAddress =
        0x13928Ddb6d1b669082874cd0d08dB6E6322D9658;
    ...
    function withdrawUSDTMarket() public {
        IBEP20(_USDT).transfer(
            _marketingWalletAddress,
            IBEP20(_USDT).balanceOf(address(this))
        );
    }
