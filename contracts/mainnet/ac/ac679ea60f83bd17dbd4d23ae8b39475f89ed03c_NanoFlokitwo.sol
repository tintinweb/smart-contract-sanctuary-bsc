...
contract NanoFlokitwo is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 7_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 30_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x0EaCE02FFf3A4339C1FAc62039AE3Df3e63c342F;
    address public devWallet = 0xc2F84523FB31283cD8bFd8fc7f627fb53f6c1aE0;
    address public buybackWallet = 0xCA71101deefd54d27ea7Aba1b9C5E0be815882ee;

    string private constant _name = "Nano Floki 2.0";
    string private constant _symbol = "NanoFlokitwo";
    ...
    Taxes public taxes = Taxes(0, 6, 4, 0, 2);
    Taxes public sellTaxes = Taxes(0, 6, 4, 0, 3);
