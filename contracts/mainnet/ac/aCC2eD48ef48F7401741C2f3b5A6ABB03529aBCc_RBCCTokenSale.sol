...
contract RBCCToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "RBCC";
    string private _name= "RBCC COIN";
...
contract RBCCTokenSale {
    address payable admin;
    RBCCToken public tokenContract;
    ...
    constructor(RBCCToken _tokenContract, uint256 _tokensSold)  {
