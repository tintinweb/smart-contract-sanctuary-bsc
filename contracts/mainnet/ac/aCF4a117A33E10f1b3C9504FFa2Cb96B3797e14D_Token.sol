...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby 413";
    string private constant _symbol = "B413";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 41300 * 10**_decimals;
    uint256 public _maxTxAmount = 1239 * 10**_decimals;
    uint256 public _maxWalletAmount = 1239 * 10**_decimals;
