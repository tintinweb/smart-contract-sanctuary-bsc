...
CatSpy is a harmonious blend of offline, online, B2B, B2C, C2C transactions, 
real underline retail systems (point of sales), advertising, NFT Arcade.

Telegram : https://t.me/catspy_bsc
Website :www.catspy.io
...
contract CatSpy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Spy"; // 
    string private constant _symbol = "$CATS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x4F076B1092Ae308DDca8680E73e4e7C6ad8E0beC;
