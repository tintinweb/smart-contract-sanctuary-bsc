...
contract BabySquid is Context, IERC20, Ownable {
    ...
    string private _name = "BabySquidGame2.0";
    string private _symbol = "BabySquid2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3f5183aD7A3eDEA5D8F7eB7b3D3F777FffEFFf59); 
    address payable private teamWalletAddress = payable(0xFb924542bAF672BcC3cF5166075Dd9aE1679bbC1); 
