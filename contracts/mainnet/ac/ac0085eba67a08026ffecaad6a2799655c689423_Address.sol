...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8481e37CA32Bd592E7F859Ca434a7133119B2457;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0E47cA949d92690E6517e9f750bf69c2e5658BA4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WolfPig";
    string private _symbol = "WFPig";
