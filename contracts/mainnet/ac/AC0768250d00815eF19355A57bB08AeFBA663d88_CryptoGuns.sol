...
contract CryptoGuns is AccessControlUpgradeable, ERC721URIStorageUpgradeable, VRFConsumerBaseUpgradable,EIP712Upgradeable{
...
function addAdmin(address account) public virtual {
 ...
 //    * Requests randomness
 //    */
   function requestNewSwat() public returns (bytes32 requestId) {
...
//
  ...
  _mintSwat(randName2, requestAddress);
  _mintSwat(randName3, requestAddress);
  _mintSwat(randName4, requestAddress);
  _mintSwat(randName5, requestAddress);
...
function duplicateUpgrade(uint _swatId, uint _targetId) public{
  ...
  Swat memory mySwat = swats[_swatId];
  Swat memory mySwat2 = swats[_targetId];
  require(mySwat.upgradeCount < 4);
