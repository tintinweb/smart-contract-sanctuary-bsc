...
contract BabyNFT is ERC721, ReentrancyGuard, Ownable {
	...
	onlyOwner
    {
	uint256 aStartIndex = startIndex.add(nftMinted);
	require(aStartIndex.add(100) <= endIndex, "exceeds max limit");
    ...
    function tokenURI(uint256 tokenId) override public pure returns (string memory) {
        ...
        parts[0] = 'https://econft.market/service/babymeta.php?id=';

	uint256 ind = tokenId.sub(1).div(100);

        parts[1] = string(ind.toString());
