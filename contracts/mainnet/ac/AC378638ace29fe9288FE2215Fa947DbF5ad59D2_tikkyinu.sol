...
----------------------------------------------------------------------------------------------------------------
Welcome To Tikky Inu, the World's First TikTok To Earn Application!

Tikky Inu is a true defi platform that brings the power back to TikTok users by incentivizing every video they upload in the world's biggest social media platform. 
...
contract tikkyinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tikky Inu";
    string private constant _symbol = "TIKKY";
