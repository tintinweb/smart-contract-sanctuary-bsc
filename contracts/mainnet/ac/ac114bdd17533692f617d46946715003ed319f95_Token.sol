...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xfC81Cc96fc3517d6eAe970a14c16057A3deeD6A1);
    string private _name = "LEO2.0";
    string private _symbol = "LEO2.0";
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                takeFee = true;
                if (0 == startTradeBlock) {takeFee=false;}
            }
            if (_swapPairList[to]) {
                isSell = true;
            }
    ...
    function setMaxTxAmount(uint256 max2) public onlyOwner {
        maxWalletAmount = max2;
    }
