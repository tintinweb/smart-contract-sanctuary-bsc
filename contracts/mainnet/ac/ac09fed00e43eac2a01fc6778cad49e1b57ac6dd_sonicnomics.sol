...
contract sonicnomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "SONICNOMICS"; // 
    string private constant _symbol = "$SONICS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x138251835aB33270AD3e1bfdEf3B4185fbCB0100;
