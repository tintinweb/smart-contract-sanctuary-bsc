...
contract Rocks  is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xA1B1613B3F6F3fb9A6d4295f349F79375984d53B);
    address private liquidityReceiver = address(0xA1B1613B3F6F3fb9A6d4295f349F79375984d53B);
