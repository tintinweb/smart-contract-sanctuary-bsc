...
contract CZW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZ Win";
    string private _symbol = "CZW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x2A8893848819f2F90bF63a87a5ad5B5e4CeEd0d0); // Marketing Address
    address payable public teamWalletAddress = payable(0x599e977F61Ff69984188A9c8B779C6B439468e8D); // Team Address
