...
--------------------------------------------------------------------------------------------------------------
WELCOME TO Angeldust!!! is a true defi platform that brings the power back to swapping, Bridge , Staiking and more. 
...
Website: https://t.me/GabeesMoonshot
Telegram : https://t.me/AngelDust3xExclamation
Twitter: 
-----------------------------------------------------------------------------------------------------------------
*/
...
contract Angeldust is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANGEL DUST!!!";
    string private constant _symbol = "ANGELDUST!!!";
