...
telegram: https://t.me/ShibaGlass
...
contract ShibaGlass is Context, IERC20 {
    ...
    address payable public constant _Burn =
        payable(0x0393d30BffEc6B03adE4a057AE20855B04919fE1);
    address payable public _Marketing =
        payable(0x0393d30BffEc6B03adE4a057AE20855B04919fE1);
    address payable public _Dev =
        payable(0x0393d30BffEc6B03adE4a057AE20855B04919fE1);

    string private constant _name = "ShibaGlass";
    string private constant _symbol = unicode"ShibaGlass";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    uint256 public _Buy__Fee = 8;
    uint256 public _Sell__Fee = 10;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    uint256 public _Auto_Burn = 10;
    uint256 public _Auto_LP = 20;
    uint256 public _Auto_Marketing = 60;
    ...
    constructor() {
        _owner = 0x0393d30BffEc6B03adE4a057AE20855B04919fE1;
