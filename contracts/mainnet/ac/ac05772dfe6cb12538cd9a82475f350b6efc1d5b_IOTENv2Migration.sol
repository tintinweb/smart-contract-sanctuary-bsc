...
// Main Contract
contract IOTENv2Migration is Ownable, ReentrancyGuard {
    ...
    IBEP20 public tokenV1 = IBEP20(0xBAAe1192b9A115391Ed2062B3a5f5d3509461CCb);
    IBEP20 public tokenV2 = IBEP20(0xfdd4F0281fdB8C685FD7af6EDD30Bb5d3836F6Ae);
    address public tokenV2Pair = 0x5aBE76C40cE29BEFf6969B1FdB7e79cc863aBaBe;
    ...
    function claimV2() public nonReentrant{
        ...
        uint256 claimAmount = userInfo[msg.sender].depositeddAmountV1.div(rate);
