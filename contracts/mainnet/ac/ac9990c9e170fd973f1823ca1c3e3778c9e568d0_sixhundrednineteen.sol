...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x015616835E943F71AF49466d892313c7A5267511; // owner address
...
contract sixhundrednineteen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "619";
    string private _symbol = "619";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x015616835E943F71AF49466d892313c7A5267511); // Marketing Address
    address payable public teamWalletAddress = payable(0x015616835E943F71AF49466d892313c7A5267511); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 20 * 5**_decimals; 
