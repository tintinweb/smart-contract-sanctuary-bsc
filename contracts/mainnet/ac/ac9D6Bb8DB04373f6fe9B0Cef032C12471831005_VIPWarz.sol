...
contract VIPWarz is ERC721, ERC721Enumerable , Ownable {
    ...
    function mintPet(string memory _tokenURI,address destination) public onlyOwner{
        tokenURIs[lastID]=_tokenURI;    
        _safeMint(destination, lastID);
        lastID++;
    }
