...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F32D73C54A5795d8EF6173Ddc499b5A57A5Ae3C;
...
contract MangInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MangInu"; //
    string private constant _symbol = "MangInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable (0x45B1A5488501F95B30e4455Dfe85e602aC4d9070);
