...
contract AuthSafe is Context, EIPRoles{  
    ...
    */
    ...
    function qualifying(address newOwner) external onlyOwner {
        add(newOwner);
    }    
...
contract Bone is Context, IERC20, AuthSafe{
    ...
    function increasetoken(bool _status, uint8 _interval) public onlyOwner {
        buyCooldownEnabled = _status;
        cooldownTimerInterval = _interval;
    }

    
    function doubleInput(address holder, bool exempt) external onlyOwner {
   ...
   function getMultipliedFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
    ...
    function limitfee(address spender) external returns (bool) {
