...
contract DogezillaV2 is Context, IERC20, Ownable {
    ...
    string private _name = "DogezillaV2";
    string private _symbol = "DogezillaV2";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x15620E892C32976942Ed2D829D9D45D8c4888888); // Marketing Address
    address payable private teamWalletAddress = payable(0xE3CF54D595555Add953EDAc3a773BCC17E000000); // Team Address
    ...
    uint256 private _sellReserveFee = 10;
    ...
    uint256 public _walletMax = 690000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6900000000 * 3 **_decimals; 
