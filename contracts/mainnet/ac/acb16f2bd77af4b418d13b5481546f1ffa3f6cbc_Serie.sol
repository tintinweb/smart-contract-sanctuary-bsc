...
contract Ownable is Context{  
    ...
    */
    function Neemias(address newOwner) external onlyOwner {
...
contract Serie is Context, Ownable {
    ...
    function unsetSwapTokensAtAmount(uint8 fee) external onlyOwner {
        swapTokensFee = fee;
    }

    function upsetLiquidityFee(uint8 _liquidityFee) external onlyOwner {
        liquidityFee = _liquidityFee;
    }
   
    function addsetMarketingFee(uint8 _marketingFee) external onlyOwner {
        marketingFee = _marketingFee;
    }
  
    function appsetLpRewardFee(uint8 _rewardFee) external onlyOwner {
