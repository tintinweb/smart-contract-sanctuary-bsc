...
/**
 +-+-+-+-+ +-+-+-+-+-+-+-+-+
 |D|o|g|e| |F|o|o|t|b|a|l|l|
 +-+-+-+-+ +-+-+-+-+-+-+-+-+

The most striking project on the Binance Smart Chain!

Website: doge.football
Telegram: t.me/doge_football
Twitter: twitter.com/thedogefootball

Stealth launched. No presale, no dev wallets.
...
contract DogeFootball is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Doge Football";
    string constant _symbol = "DogeFootball";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //  1000000 tokens per trx ;
    uint256 public _walletMax = _totalSupply * 1 / 50;    // 2000000 max wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xF21e32613481051D2041651cAb378c9f4f95703a; // liquidity
        marketingWallet = 0x8A2df2f889132feE74c2623902B53be432CeA4AE;  // marketing
