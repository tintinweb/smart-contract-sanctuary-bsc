...
// If you are reading this and you found the Contract that early, you can call yourselfe lucky
// TG: TBA
// HP: TBA
// no shit, dont ape if you are a quick PnD gambler
// no renounce since we will offer something special
// liq Locked 1 month for now
// more infos soon
...
contract Zeta is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x9Fa87aaEa4AB681558Fe446b387b1d0A1b441E3e);
    ...
    */
    ...
    string private _name = "ZetaRatio"; 
