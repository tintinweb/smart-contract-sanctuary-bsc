...
Lion is the king of jungle. So do LionKing, our ambition as dev is to make it the best project in BSC/BNB chain network.

Dev is experienced and based, bringing more than 500x gain for investors since RacaVerse.

Join LionKing and moon with us.

TG : https://t.me/LionKingBNB
*/
...
contract LionKing is Context, IERC20 { 
    ...
    uint256 private _tTotal = 1 * 10**18 * 10**_decimals;
    string private constant _name = "LionKing"; 
    string private constant _symbol = "$LK"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 3;
    uint256 public _Tax_On_Sell = 17;
