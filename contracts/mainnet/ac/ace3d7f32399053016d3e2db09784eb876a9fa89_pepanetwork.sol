...
contract pepanetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPA NETWORK";
    string private _symbol = "PENET";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x9a3bDE528F2ef2E013072e4DD129A37bB8BC02D0); // Marketing Address
    address payable public teamWalletAddress = payable(0x9a3bDE528F2ef2E013072e4DD129A37bB8BC02D0); // Team Address
    ...
    uint256 public _marketingShare = 39;
