...
contract Merryfloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcE9EB6be60A8CC6498982440400994aF5d92125a); 
    address payable public Wallet_Dev = payable(0xcE9EB6be60A8CC6498982440400994aF5d92125a);
    ...
    string private constant _name = "MERRYFLOKI"; 
    ...
    constructor () {
        ...
        _owner = 0xcE9EB6be60A8CC6498982440400994aF5d92125a;
