...
contract GlodDwenDwen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GlodDwenDwen";
    string private _symbol = "GlodDwenDwen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58B277276c8afD0960e95c2f996bBC5ce89Ec735); 
