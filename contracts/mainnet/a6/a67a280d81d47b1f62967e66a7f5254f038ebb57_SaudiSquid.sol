...
contract SaudiSquid is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3382b583deeb90B0C2d891d92001A3532Cf5f561));
        marketingWalletAddress = payable(address(0x3382b583deeb90B0C2d891d92001A3532Cf5f561));
