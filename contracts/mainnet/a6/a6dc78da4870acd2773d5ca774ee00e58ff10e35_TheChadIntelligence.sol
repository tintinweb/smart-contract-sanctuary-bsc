...
/**
The Chad Intelligence
poocoin
https://poocoin.app/tokens/0xa6dc78da4870acd2773d5ca774ee00e58ff10e35
Trade like a chad. Win like a chad.
Phase One
Launching $CHADAI
Locking the LP on unicrypt
Renounce CA
Reach 100 Holders
...
abstract contract Contextbep20CHADAI {
...
contract Ownablebep20CHADAI is Contextbep20CHADAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20CHADAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20CHADAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TheChadIntelligence  is Contextbep20CHADAI, bep20CHADAI, Ownablebep20CHADAI {
    ...
    string private _name = 'The Chad Intelligence';
    string private _symbol = 'CHADAI';
