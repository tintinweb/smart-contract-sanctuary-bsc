...
contract Bitcoge is IBEP20, Auth {
    ...
    string constant private _name = "BitCoge";
    string constant private _symbol = "BCG";
    ...
    address public _sellFeeReceiver = 0xCeE94FBD6d1F203Db10534b855F1D4FFbbdad246;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _liqForFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        liqForFee = _liqForFee;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _liqForFee.add(__sellFee).add(_devFee);
