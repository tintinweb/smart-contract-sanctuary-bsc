...
contract SNAKEDOGE is IERC20, Ownable {
    ...
    string _name = "Space Snake Doge";
    string _symbol = "SNOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;   // 2%
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;     // nomaxtx%
