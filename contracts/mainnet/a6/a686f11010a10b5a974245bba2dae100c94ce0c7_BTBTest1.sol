...
contract BTBTest1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BTBTest1DividendTracker public dividendTracker;
    ...
    constructor() ERC20("BTBTest1", "BTBT1") {
        marketingWallet = payable(0x8eECDCC495B6931F74ACCbbe6d66b451AD3e7CaA);
        devWallet = payable(0x26e2a6471BAC1C339deD840B14856D0d4616A584);
        ...
        dividendTracker = new BTBTest1DividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 500; // 0.2%
...
contract BTBTest1DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BTBTest1 public BTBTest1Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        BTBTest1Contract = BTBTest1(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BTBTest1_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BTBTest1_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BTBTest1 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BTBTest1Contract);

            uint256 prevBalance = BTBTest1Contract.balanceOf(address(this));
            ...
            {
                uint256 received = BTBTest1Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BTBTest1Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
