...
contract SpaceLuna is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "SpaceLuna";
    string private _symbol = "SpaceLuna";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD1e171a3e81B25e9e6Fe0D72d269237621409e39));
        marketWall = payable(address(0xD1e171a3e81B25e9e6Fe0D72d269237621409e39));
