...
/**
Telegram : https://t.me/avaxinubsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD25125bF8a2f2EaD198151E7De47dE855D66FA3A; // owner address
...
contract AvaxInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "AVINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD25125bF8a2f2EaD198151E7De47dE855D66FA3A); // 
    address payable public teamWalletAddress = payable(0xD25125bF8a2f2EaD198151E7De47dE855D66FA3A); // 
