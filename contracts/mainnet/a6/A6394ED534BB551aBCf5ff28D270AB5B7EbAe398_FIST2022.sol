...
contract FIST2022 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _total = 1000000000000000 * (10**18);
    ...
    uint256 public maxSwapTokensAtAmount = 1000 * 10**12 * (10**18);
    
    bool public swapAndLiquifyEnabled = true;
    
    mapping(address => bool) public _isBlacklisted;

    uint256 public TokenRewardsFee = 50;
    ...
    uint256 public genFee = 2;
    uint256[8] public genFeeList = [30, 20, 15, 12, 8, 5, 5, 5];
    ...
    constructor() ERC20("2022FIST", "2022FIST") public{
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "2022FIST: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "2022FIST: The new dividend tracker must be owned by the 2022FIST token contract"
        );
    ...
    function updateRewardCoin(address newRewardCoin) public onlyOwner {
        ...
        require(RewardCoin != newRewardCoin, "2022FIST: The RewardCoin already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "2022FIST: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "2022FIST: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "2022FIST: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "2022FIST: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            newValue >= 200000 && newValue <= 750000,
            "2022FIST: gasForProcessing must be between 200,000 and 750,000"
        );
        require(
            newValue != gasForProcessing,
            "2022FIST: Cannot update gasForProcessing to same value"
        );
