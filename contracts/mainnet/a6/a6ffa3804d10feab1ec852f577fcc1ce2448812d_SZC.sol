...
contract SZC is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 internal finalSupply;

    address public marketingWallet = 0xD531bAB996536710937DB5A2F8e11A32d33E65eA;
    ...
    constructor () BEP20Detailed("Simzo Coin", "SZC", 9) {
    ...
    function setFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner() {
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(!_isExcludedFromFee[sender])
        {
            ...
            amount = amount.sub(marketingAmount.add(liquidityAmount));
    ...
    function _mint(address account, uint amount) public onlyOwner {
        ...
        require(totalSupply() <= finalSupply, "Supply limit reached");
