...
/*
 * Glow Token - Distributor
 * Brought to you by the dynamic duo of TotesCaptain
 */

contract GlowDistributor is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function distributeDividend(address shareholder_) internal {
        ...
        if(amount > 0){
            bool rwdSent = IERC20(rewardToken).transfer(shareholder_, amount);
            if(rwdSent) {
