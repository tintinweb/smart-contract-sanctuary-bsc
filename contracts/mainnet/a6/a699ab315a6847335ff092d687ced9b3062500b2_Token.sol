...
/**
 *https://t.me/BluebirdDoge123
 https://bluebirddoge.org
*/
...
library Address{
 ...
 contract Token is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500_000 * 10**6; // 0.50%
    uint256 public maxBuyLimit = 1_000_000 * 10**6; // 1%
    uint256 public maxSellLimit = 1_000_000 * 10**6; // 1%
    uint256 public maxWalletLimit = 1_000_000 * 10**6; // 1%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xbeaCe1E5739928287e7fC07f63c4537D0dC367Bc;
    address public developmentWallet = 0x059d79EB23Dd75036887ce55a2495e7222550c38;

    string private constant _name = "Bluebird Doge";
    ...
    Taxes public taxes = Taxes(0, 1, 1, 5);
    Taxes public sellTaxes = Taxes(0, 1, 1, 5);
