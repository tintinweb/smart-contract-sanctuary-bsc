...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3014308a2d8f66dCd44Eb376113872113F471a99; // owner address
...
contract PussyCatDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PussyCatDust";
    string private _symbol = "PCD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3014308a2d8f66dCd44Eb376113872113F471a99); // Marketing Address
    address payable public teamWalletAddress = payable(0x3014308a2d8f66dCd44Eb376113872113F471a99); // Team Address
