...
contract PokeDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "POKEDOGE"; // 
    string private constant _symbol = "PDE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xB1409a519694A1cbaCBc76129B4bF85AD05d0ee6;
