...
// https://oraclecapital.finance
// https://t.me/oraclecapitalfi
...
contract OracleCapital is Ownable {
  using SafeMath for uint256;

  // standard ERC20 variables. 
  string public constant name = "Oracle Capital";
  string public constant symbol = "OC";
  uint256 public constant decimals = 18;
  // the supply will not exceed 300,000 OC
  uint256 private constant _maximumSupply = 310000 * 10 ** decimals;
  uint256 private constant _maximumPresaleBurnAmount = 48000 * 10 ** decimals;
