...
contract DF001 is ExcludedFromFeeList, DividendFee {
    ...
    uint256 public constant antiRate = 30;
    ...
    constructor()
        ERC20("DF001", "DF001", 18)
        DividendFee(0x8B3163c4Bf1C1059db7d57b33015Ed203189A907)
    {
        _mint(msg.sender, 1999 * 1e18);
