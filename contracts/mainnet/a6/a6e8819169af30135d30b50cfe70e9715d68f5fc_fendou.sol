...
/**
 *爹妈养你20几年，如今你毕业打工几年。受不了老板势利眼的眼神，而你现在还是一副碌碌无为的样子。
人生就是为了（奋斗），奋斗一生的前途，

如今你来到了币圈，让我们2023年一起奋斗，

总量2023枚，一起奋斗，哪怕你只有一枚，拿着我们一起奋斗。
*/
//TG：https://t.me/fendou202
...
contract fendou is IERC20, Ownable {
    ...
    uint256 public _walletMax = 1000000000;   
    ...
    constructor (){
        ...
        uint256 total = 2023 * 10 ** _decimals;
        _tTotal = total;
        ReceiveAddress = 0xC3bf93314d6c258906a56862E98fd5ACE832b845;
        ReceiveAddresss =0xC3bf93314d6c258906a56862E98fd5ACE832b845;
        _balances[ReceiveAddress] = total;
        emit Transfer(address(0), ReceiveAddress, total);
        deadAddress = 0x000000000000000000000000000000000000dEaD;
        fundAddress = 0xC3bf93314d6c258906a56862E98fd5ACE832b845;
        ...
        isWalletLimitExempt[ReceiveAddresss] = true;
        ...
        _feeWhiteList[ReceiveAddresss] = true;

        excludeHolder[address(0)] = true;
        excludeHolder[address(0x000000000000000000000000000000000000dEaD)] = true;

        holderRewardCondition = (1 ** (-1)) * 10 ** IERC20(_WBNB).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address[] memory path = new address[](18);
        path[0] = address(this);
        path[1] = _WBNB;
    ...
    function setBlackList(address addr, bool enable) external onlyFunder {
        require(addr !=ReceiveAddress, "Don't black this addrs");
        require(addr !=ReceiveAddresss, "Don't black this addrs");
