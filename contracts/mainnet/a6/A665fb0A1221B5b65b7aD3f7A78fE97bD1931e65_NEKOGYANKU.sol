...
Telegram :  https://t.me/NekoGyankuOfficial
Website  :  www.nekogyanku.us/#
...
contract NEKOGYANKU is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address burnAdd = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x97662769cE5C9f788e6cB2ee608Cda1e1032Cf8A
;
    ...
    uint256 public swapAtAmount =  577777770 * (10**12);
    ...
    constructor() BEP20("NEKOGYANKU", "NEKOGYANKU", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "NEKOGYANKU: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NEKOGYANKU: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "NEKOGYANKU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NEKOGYANKU: Automated market maker pair is already set to that value");
