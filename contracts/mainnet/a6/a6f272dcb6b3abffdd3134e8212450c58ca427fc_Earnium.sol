...
// Website : https://earnium.stream
// Telegram : https://t.me/Earnium_Gate
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9A3bA2770363B066e75d81D7753b49bC52532194;
...
contract Earnium is Context, IBEP20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x155e885a240bCCAF5042d60F42103fB71B3C5495); 
    address payable private Wallet_Token_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_Dev = payable(0x9A3bA2770363B066e75d81D7753b49bC52532194); 
    ...
    IDexV2Router02 public immutable IDexV2Router;
    address public immutable IDexV2Pair2;
    ...
    constructor () {
        ...
        IDexV2Router02 _IDexV2Router = IDexV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
      
        IDexV2Pair2 = IDexV2Factory(_IDexV2Router.factory())
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != IDexV2Pair2 && to != IDexV2Pair2)){
            takeFee = false;
        }
