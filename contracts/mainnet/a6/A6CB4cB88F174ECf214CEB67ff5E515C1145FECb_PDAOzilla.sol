...
contract PDAOzilla is IERC20, Ownable {
   ...
   address public team = 0x1daaa42A8CE963dD218f725018D867AE971Abfe9;
    ...
    address public liquidityWallet = 0xcf5f0068a336c952304F395fc9038c1836ec85aA;

    address public uniswapV2Pair;
    ReceiveUsdt public receiveUsdt;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 50 * 1e18;

    uint256 public burnPct = 2;
    uint256 public lpPct = 4;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(pairList[recipient]){
            require(canSell, 'Can\'t sell now!');
        }

//        if(pairList[recipient]){
//            require(amount<=balanceOf(sender).div(2),'Can\'t sell more than 50%');
//            require(amount.div(1e17).mod(10)==3,'Sold quantity must be x.3xx');
//        }
        uint256 toBurn = amount.mul(burnPct).div(100);
        _basicTransfer(sender, dead, toBurn);
        uint256 toLP = amount.mul(lpPct).div(100);
        _basicTransfer(sender, address(this), toLP);
        amount = amount.sub(toBurn).sub(toLP);
        _basicTransfer(sender, recipient, amount);
    }
    ...
    function changeState(bool _canBuy, bool _canSell) public onlyOwner(){
        canBuy = _canBuy;
        canSell = _canSell;
    }
