...
contract DUBAIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dubai Inu"; //
    string private constant _symbol = "DUBAI"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x8358A6b22647509F44F1ea3426439a82bFC6D1cc ;
