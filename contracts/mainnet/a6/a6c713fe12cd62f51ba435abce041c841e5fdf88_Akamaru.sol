...
interface IRouter {
    ...
    uint256 public tokenLiquidityThreshold = 250_000 * 10**18;
    ...
    address public marketingWallet = 0xF92ee536793Ce3812761831C2813CC98908625e6;
    address private devWallet = 0x045067cd9Bb5AB1108d6E7102720700780dd9745;
    address public opsWallet = 0xad34E6Ba6Ad6C783038F4102de1B0b6D9a5537C6;
    ...
    Taxes private taxes = Taxes(0, 0, 0, 11);
    Taxes private sellTaxes = Taxes(0, 0, 0, 11);
    ...
    constructor(address routerAdd) ERC20("AKAMARU INU", "AKAI") {
