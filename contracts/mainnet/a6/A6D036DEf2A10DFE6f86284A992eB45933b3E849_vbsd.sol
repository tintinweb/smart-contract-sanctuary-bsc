...
contract vbsd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "vbsd";
    string private _symbol = "vbsd";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F3235a6d8a008Dc4C7d096F5985547174BaaEa4);
    address payable public teamWalletAddress = payable(0x27287B15094e0b5D2f44BC2979E21e8D356E7a8b);
