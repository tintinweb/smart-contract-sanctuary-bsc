...
contract GRIcoin is Context, IBEP20, Ownable {
    ...
    uint256 public _percentageOfLiquidityForMarketing = 500;
    uint256 public _percentageOfLiquidityForinvesting = 800;
    ...
    function setPercentageOfLiquidityForinvesting(uint256 investingFee) external onlyOwner {
        _percentageOfLiquidityForinvesting = investingFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        uint256 feeOne = marketingFee / 500;
        uint256 feeTow = marketingFee - 800;
