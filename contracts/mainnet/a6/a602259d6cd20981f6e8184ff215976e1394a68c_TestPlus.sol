...
contract TestPlus is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public token1DividendRewardsFee = 3;
    uint256 public previoustoken1DividendRewardsFee;
    uint256 public token2DividendRewardsFee = 3;
     ...
     */
     ...
     uint timeForSellTotalMaxTxAmount = 120 seconds;
    ...
    constructor(address _newOwner) ERC20("TestPlusV'", "TPlusV2") {
    	token1DividendTracker = new Token1DividendTracker();
    	token2DividendTracker = new Token2DividendTracker();
 
    	marketingWallet = 0xb67c05906fb18A081EcE593d4F00757429D73564;
    	liquidityWallet = _newOwner;

    	token1DividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
        token2DividendToken = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5;
    ...
    function addReferral(address referr) public {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "TestPlus: The marketing wallet is already this address");
        excludeFromFees(_newWallet, true);
        emit MarketingWalletUpdated(marketingWallet, _newWallet);
  	    marketingWallet = _newWallet;
  	}
  	function updateLiquidityWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != liquidityWallet, "TestPlus: The liquidity wallet is already this address");
        excludeFromFees(_newWallet, true);
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "TestPlus: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TestPlus: The PanadaSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "TestPlus: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "TestPlus: Trading has not started yet");
...
contract Token2DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("SafePlus_Token2_Dividend_Tracker", "SafePlus_Token2_Dividend_Tracker", 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 2000000+ tokens
    }
