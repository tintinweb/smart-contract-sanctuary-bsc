...
contract Safemoon1995 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8AF9295FffB17EB04391cC29F20Ec7E7DD60DCa0); // Marketing Address
    address payable private teamWalletAddress = payable(0x28E032f13F3BE43a7d1e7BC6d7935f81F684D28f); // Team Address
    ...
    uint256 public _maxTxAmount = 1 * 10**2 * 10**5* 10**_decimals; 
