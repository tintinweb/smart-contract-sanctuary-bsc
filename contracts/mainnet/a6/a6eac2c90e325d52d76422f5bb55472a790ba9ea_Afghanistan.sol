...
/**
Afghanistan National Fan Token
*/
...
contract Afghanistan is AfghanistanDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AfghanistanTeam;
    address private CharityAfghanistan;
    ...
    string public override name = "Afghanistan National Fan Token";
    string public override symbol = "Afghanistan National Fan Token";
    ...
    constructor(uint totalSupplyValue, address AfghanistanTeamAddress, address CharityAfghanistanAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AfghanistanTeam = AfghanistanTeamAddress;
        CharityAfghanistan = CharityAfghanistanAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AfghanistanTeam] =  totalSupply * 49 / 1000;
        balances[CharityAfghanistan] = totalSupply * 49 / 1000;
        
        balances[_owner] = totalSupply * 902 / 1000;
    }
