...
/**
2% buy & sell tax
Telegram: https://t.me/BabyEchelonCoin
*/
...
contract BabyEchelonCoin is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "BabyEchelon";
    string private _symbol = "babyECH";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _marketingfee = 2;
    address private _marketingaddress = 0x1a1E263F1e42fC619E7fa23941782eBD1A0AA927;
