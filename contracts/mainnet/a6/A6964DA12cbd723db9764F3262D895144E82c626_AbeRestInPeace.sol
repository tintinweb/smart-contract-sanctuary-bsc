...
contract AbeRestInPeace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AbeRestInPeace";
    string private _symbol = "AbeRIP";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1d0c3a48CEC0D1Ab0b756129e209d426f0762718); // Marketing Address
    address payable public teamWalletAddress = payable(0x1d0c3a48CEC0D1Ab0b756129e209d426f0762718); // Team Address
