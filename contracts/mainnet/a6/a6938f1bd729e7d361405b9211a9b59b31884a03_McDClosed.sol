...
contract McDClosed is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0A5E54B7f0A8A832a67C909780eF44E7Eec274f0); // Marketing Address
    ...
    string private _name = "McD Closed";
    string private _symbol = "McDClosed";
