...
contract DINUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " DRAGON SNAKE INU  ";
    string private _symbol = " $DINUS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16d64763055bF984d6717fE4aD7048a22B6E67Be); 
    address payable public teamWalletAddress = payable(0x16d64763055bF984d6717fE4aD7048a22B6E67Be);
