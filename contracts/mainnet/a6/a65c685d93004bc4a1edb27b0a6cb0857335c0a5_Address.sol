...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A7b0306FCE456aF2A50Cafbea62eeB342fcDAC6;
...
contract SNTS is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x676d0f3a4E71CD65691E65A0fC7656BB971446b0;
    uint256 public constant MAX = ~uint256(0);
    uint256 public _tTotal = 1000000000000 * 10**18;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;
    string public _name = "SAINTS INu";
    string public _symbol = "SNTS";
    uint8 public _decimals = 18;
    uint256 public _taxFee = 90;
    uint256 public _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 400;
    uint256 public _previousDevelopmentFee = _developmentFee;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tDevelopment, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
    ...
    function _takeDevelopment(uint256 tDevelopment) public {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
    ...
    function calculateDevelopmentFee(uint256 _amount) public view returns (uint256) {
