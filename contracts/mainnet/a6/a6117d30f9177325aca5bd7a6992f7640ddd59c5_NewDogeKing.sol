...
contract NewDogeKing is ERC20 {
	...
	address payable _receive = payable(address(0xedFf5FfD12d57fFBa9918e0Ea21d22ef32f0F137));
    ...
    constructor(address tokenOwner) ERC20("NewDogeKing", "NewDogeKing") {
    ...
    function _transfer(
        ...
        require(amount > 0, "ERC20: transfer 0");
