...
contract Four_hundred_thirty_Three is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "433";
    string constant _symbol = "Four Hundred Thirty Three";
    ...
    uint256 _totalSupply = 433 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x36d66088aaAfB83C1B8B8fbEB2ACD4F14B9C43Ae;
        marketingWallet = 0x36d66088aaAfB83C1B8B8fbEB2ACD4F14B9C43Ae;
        devWallet = 0x36d66088aaAfB83C1B8B8fbEB2ACD4F14B9C43Ae;
