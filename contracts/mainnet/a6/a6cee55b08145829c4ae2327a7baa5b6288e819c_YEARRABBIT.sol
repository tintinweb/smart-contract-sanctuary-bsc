...
contract YEARRABBIT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "YEAR RABBIT";
    string private _symbol = "YRB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4135209B55C90f7d06d206a73d72B3D143b331bE);
    address payable public liqWalletAddress = payable(0x4135209B55C90f7d06d206a73d72B3D143b331bE);
