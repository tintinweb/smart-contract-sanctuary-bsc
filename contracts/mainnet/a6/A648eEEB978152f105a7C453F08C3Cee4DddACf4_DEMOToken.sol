...
contract BaseToken is Ownable {
    ...
    string constant public name = 'SEAKING Token';
    string constant public symbol = 'SEAKING';
    uint8 constant public decimals = 18;
    uint256 public totalSupply =  1000000000*10**uint256(decimals);
    uint256 public constant MAXSupply = 1000000000000000000000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0xcCA63560C692F5E5703eECEA6F155B28a48D9326;
