...
contract MFLK is Ownable, IBEP20 {
    ...
    string constant _name = "MOTHAFLOKI";
    string constant _symbol = "MFLK";
    ...
    constructor() {
        ...
        mfWallet = 0x6F9F64698bE7F900Cd4c47CE5b483757C151E39c;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(mfFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBmf = amountBNB.mul(mfFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(mfWallet).call{value : amountBNBmf, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newMfFee, uint256 extraSellFee) external onlyOwner {
