...
contract  Hare413 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4130000 * 10**3;
    uint256 public _maxTxAmount = 4130000 * 10**3; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**3; //
    string private constant _name = unicode"413Hare"; // 
    string private constant _symbol = unicode"413Hare"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xDCDf582Be7E55882461d3a3A898965Cfb95D078F;
