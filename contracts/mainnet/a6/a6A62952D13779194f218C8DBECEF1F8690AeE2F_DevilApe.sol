...
Devil Ape Solidity Contract
t.me/devilapeofficial
            ._                                            ,
             (`)..                                    ,.-')
              (',.)-..                            ,.-(..`)         
               (,.' ,.)-..                    ,.-(. `.. )                    
...
contract DevilApe is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Devil Ape";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x1d1568ce4D732501c0274849C02A3e564DC35802);
