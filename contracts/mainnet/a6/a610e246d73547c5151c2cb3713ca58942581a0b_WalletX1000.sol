...
contract WalletX1000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WalletX1000";
    string private _symbol = "WX1000";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd6267a38311d5725EA3eCc59D70e13C26276E886); // Marketing Address
    address payable public devFee = payable(0xd6267a38311d5725EA3eCc59D70e13C26276E886); // devFee
