...
contract AIXIN is Context, Ownable {
    using SafeMath for uint256;

    string _name = "AIXIN";
    string _symbol = "AIXIN";
    uint8 _decimals = 9;
    ...
    function restAnalysis(uint8 rewardFee) external onlyOwner {
        lpRewardFees = rewardFee;
    }

    function effectclear(uint256 maxTxPercent) external onlyOwner {
	...
	function constructionReset() public view returns (uint256) {
