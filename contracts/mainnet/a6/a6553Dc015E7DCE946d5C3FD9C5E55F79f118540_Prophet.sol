...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf669E82eAdF4db38A1Fc0eB704C041d6F2A905bE;
...
contract Prophet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x29bBA4A9142729B3FF482C32d8b13fB5b2Ebbf10;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 42000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Prophet Coin";
    ...
    uint256 private numTokensSellToAddToLiquidity = 42000000 * 10**9;
