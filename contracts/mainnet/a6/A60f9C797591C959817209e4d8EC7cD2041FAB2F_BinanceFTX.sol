...
/* Token contract */
contract BinanceFTX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BinanceFTX";
    string constant _symbol = "BFTX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 328895113 * (10 ** _decimals);
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 70;
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 10000; // 0.25% of supply
