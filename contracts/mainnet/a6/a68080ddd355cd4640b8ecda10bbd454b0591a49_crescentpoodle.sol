...
contract crescentpoodle is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Crescent Poodle";
    string private constant _symbol = unicode"$COOD";
    ...
    address payable public DevWallet = payable(0x74e4f2899D0928bc8579e55a433282628423aA51);
    address payable public MarketingWallet = payable(0x38f8cDa946Ab3ebd95CE326A07690628b6dDEdaD);
    ...
    function balanceTaxes(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
