...
contract TestSeedifyNFTSpace is ERC20, ERC20Burnable {
    constructor(address sfundSnapshot, address liquidity, address stakeFarm, address operationTreasury, address nftTreasury, address teamIncentives) ERC20("TestSeedifyNFTSpace", "tSNFTS") {
