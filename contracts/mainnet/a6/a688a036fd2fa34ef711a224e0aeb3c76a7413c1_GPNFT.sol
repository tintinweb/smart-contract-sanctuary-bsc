...
https://420.game 
https://opensea.io/collection/420-game/
https://discord.com/invite/looklabs
...
contract GPNFT is GPNFTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GPNFTTeam;
    address private CharityGPNFT;
    ...
    string public override name = "420.game Green Pass";
    string public override symbol = "420GP";
    ...
    constructor(uint totalSupplyValue, address GPNFTTeamAddress, address CharityGPNFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GPNFTTeam = GPNFTTeamAddress;
        CharityGPNFT = CharityGPNFTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GPNFTTeam] =  totalSupply * 4 / 100;
        balances[CharityGPNFT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GPNFTTeam pot
