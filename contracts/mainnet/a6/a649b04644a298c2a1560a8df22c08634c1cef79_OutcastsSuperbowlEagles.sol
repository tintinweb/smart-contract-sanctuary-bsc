...
// File: OutcastsSuperbowlEagles.sol
pragma solidity >=0.8.9 <0.9.0;

contract OutcastsSuperbowlEagles is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("LOST Outcasts Superbowl: Eagles", "LOST") {
      setHiddenUri("ipfs://Qmcwh8ivzmTpxVwyXKPoAkHsy24KoWvdVocGD2LkhLs6vw/1.json");
