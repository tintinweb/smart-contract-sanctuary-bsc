...
contract Spillways is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spillways";
    string private constant _symbol = "SPILLWAYS";

    address public _PancakeSwapV1RouterUniswap = 0x178668cAEF2F9beaE25cc4D0c2D5600cde65A3B1; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x178668cAEF2F9beaE25cc4D0c2D5600cde65A3B1; //can be the same
