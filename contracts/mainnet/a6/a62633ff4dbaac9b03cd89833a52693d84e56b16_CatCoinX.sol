...
library Address{
 ...
 contract CatCoinX is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC3c39Ac08B27f88E4F7906b1Ea37C7D9D22eC3FF;
    address public donationWallet = 0xC3c39Ac08B27f88E4F7906b1Ea37C7D9D22eC3FF;

    string private constant _name = "CatCoinX";
    string private constant _symbol = "CATCOINX";
    ...
    Taxes public sellTaxes = Taxes(1, 8, 1, 2);
