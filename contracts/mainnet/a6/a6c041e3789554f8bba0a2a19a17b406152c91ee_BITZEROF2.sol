...
/*
Zero project. Zero ideas. Zero marketing. Zero utility.
COME JOIN US FOR THE BIGGEST BNB LAUNCH OF THE YEAR.
https://www.bitzerotoken.com/
https://t.me/BITZERO_BNB
https://twitter.com/bitzerobsc
...
contract BITZEROF2 is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    uint256 public cooldowntimer = 15; // DEFAULT COOLDOWN TIMER
    ...
    constructor() BEP20("BITZERO", "BITZ") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x6e152bFdA68244e4F15F776443579C4b860C0Ceb); // CHANGE THIS TO YOURS
