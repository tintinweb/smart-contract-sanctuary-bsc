...
Telegram:
https://t.me/metalunatokenchannel
...
contract METALUNA is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = (_tTotal * 3) / 100; // 3% of total supply
    uint256 private SWAP_TOKENS_AT_AMOUNT = (_tTotal * 5) / 10000; // 0.05% of total supply
    string private constant _name = "META LUNA TOKEN"; // 
    string private constant _symbol = "METALUNA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public eventTime = 0;

    uint256 public _marketingFee = 10; //10% tax fee
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xCC0EE0855Bb683654489d2AAD628C2444DD77af8;
    ...
    function SetEvent(uint256 marketingFee, uint256 liquidityFee) public onlyOwner {
        eventTime = 1 hours;
    ...
    function lift_max_txnwallet() public onlyOwner
    {
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         {
            require(balanceOf(to) + amount <= _maxWalletSize, "Transfer amount exceeds the Max Wallet.");
            require(amount <= _maxTxAmount, "Transfer amount exceeds the Max TX.");
         }
