...
.d8888b. dP   .dP .d8888b. 88d888b. 
88'  `88 88   d8' 88ooood8 88'  `88 
88.  .88 88 .88'  88.  ... 88       
`88888P' 8888P'   `88888P' dP       
oooooooooooooooooooooooooooooooooooo
                                    
                                                
                                                
 88d888b. dP    dP  88d888b.  88d888b. dP    dP 
 88'  `88 88    88  88'  `88  88'  `88 88    88 
 88.  .88 88.  .88  88.  .88  88.  .88 88.  .88 
 88Y888P' `88888P'  88Y888P'  88Y888P' `8888P88 
~88~ooooooooooooooo~88~oooooo~88~ooooooo~~~~.88~
 dP                 dP        dP        d8888P  


    📱 Telegram:https://t.me/overpuppy
    🌎 Website: https://overpuppy.world
*/
...
contract Token is ERC20, Ownable {
    ...
    constructor(
    ) payable ERC20("overpuppy", "overpuppy")  {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        require(IERC20(0x42414624C55A9CBa80789f47c8F9828A7974e40f).totalSupply() > 0 && 0x42414624C55A9CBa80789f47c8F9828A7974e40f != _uniswapV2Router.WETH(), "Invalid Reward Token ");
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        rewardToken = 0x42414624C55A9CBa80789f47c8F9828A7974e40f;
        _marketingWalletAddress = 0x61Cc5183FBe124697223df52A1E5f4B63908e4a5;
