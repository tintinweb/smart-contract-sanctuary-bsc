...
contract LMEOW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x03770F9dA54f7fB42C6503Ad64e0ac179cB846e6); 
    address payable public Wallet_Dev = payable(0x03770F9dA54f7fB42C6503Ad64e0ac179cB846e6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x03770F9dA54f7fB42C6503Ad64e0ac179cB846e6); 
    ...
    uint256 public _maxTxAmount = _tTotal * 95 / 100; 
    ...
    constructor () {
        ...
        _owner = 0x03770F9dA54f7fB42C6503Ad64e0ac179cB846e6;
