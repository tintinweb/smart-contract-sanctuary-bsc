...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1b83111283be67C6a2DF2824064716527F4E0BE7;
...
contract KlowdToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeb2f655073fe79a92Eb5216FdCF3165b08515521;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Klowd Token";
    string private _symbol = "Klowd";
