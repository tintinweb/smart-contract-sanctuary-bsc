...
contract Cbaby is IERC20 {
    
    using SafeMath for uint256;
    
    
    address public feeTo = 0x04e35bb87191850aF3B03b415a60D3417ef2b508;

    string public name = "Cbaby";
    string public symbol = "Cbaby";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 Cbaby
