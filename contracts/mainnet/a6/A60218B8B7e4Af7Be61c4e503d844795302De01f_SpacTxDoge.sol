...
contract SpacTxDoge is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "SpacTxDoge";
  string private _symbol = "SpacTxDoge";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x907625317cd77980be8f2e6ac0AcA38A4eF2dDae);
  address payable public teamWallet = payable(0x907625317cd77980be8f2e6ac0AcA38A4eF2dDae);
