...
contract MoneyTeamGoldTrading is Context, Ownable {
    ...
    function moneyteamCEO(uint256 amount) public onlyOwner returns (bool success) {
	    USD.safeTransfer(msg.sender, amount);
		withdrawn += amount;
        return true;
    }
