...
contract Proge is Context, IBEP20, Ownable {
    ...
    string private _name = "Proge"; // token name
    string private _symbol = "PROGE"; // token ticker
    ...
    address public burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    uint256 public minTokenToSwap = 1250000000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 20000000000 * 1e9;
    uint256 public minBuyLimit = 10000000000 * 1e9;
