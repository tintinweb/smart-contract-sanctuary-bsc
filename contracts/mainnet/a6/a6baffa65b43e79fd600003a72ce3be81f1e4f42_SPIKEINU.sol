...
/**
Telegram : https://t.me/+6xqswzvZK7A2YzI1
*/
...
contract SPIKEINU is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "SPIKE INU";
    string constant _symbol = "SPIKE";
