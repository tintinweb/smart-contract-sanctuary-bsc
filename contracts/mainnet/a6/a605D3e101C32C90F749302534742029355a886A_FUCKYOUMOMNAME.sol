...
contract FUCKYOUMOMNAME is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCK YOU MOM NAME";
    string private _symbol = "FUCK NAME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDf88C14d8521341616eAB6E3d2c32e143141f352); 
    ...
    uint256 private _totalSupply = 2 *  10**7 * 10**_decimals;
