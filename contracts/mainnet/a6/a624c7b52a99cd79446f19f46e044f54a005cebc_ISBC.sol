...
interface IERC20 {
    ...
    contract ISBC is Context, IERC20 {
    ...
    constructor ()  {
        _name = 'INTERNATIONAL SMART BLOCKCHAIN COIN';
        _symbol = 'ISBC';
        _totalSupply =36660e18;
        _decimals = 18;
...
//////////////////////////////////////////////////////////////////////////////////////
   ...
   function getotherTokens(address _token_ ,uint256 _amount, address toadd) onlyOwner public whenNotPaused
     {   
             IERC20  OtherToken = IERC20(_token_);
             OtherToken.transfer( toadd, _amount);
