...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55D43e3B14de193bE082AA2956Ea123343B0b7F5;
...
contract FUDOTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5Ddec26a5245847614161B1C5cD37F37bE5BB8dE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FUDO TOKEN";
    string private _symbol = "FUDO";
