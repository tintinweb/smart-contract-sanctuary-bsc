...
AI INU:lock LP renounce CA before launch,


Join us AI DAY:https://t.me/aiDAYBETTER
...
contract AIDAY is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"AI DAY BETTER"; ////
    string public constant symbol = unicode"AI DAY "; ////
    ...
    function startTrading() external onlyOwner() {
        ...
        _maxTxnAmount = 8000000 * 10**9; // 8%
        _maxWalletAmt = 16000000 * 10**9; // 16%
    }
