...
contract DawnDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DawnDoge";
    string private _symbol = "DawnDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa54C461492C176BC215062673fF6da2c28b9C9aa);
    ...
    uint256 public _buyMarketingFee = 78;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 78;

    uint256 public _liquidityShare = 4;
    uint256 public _marketingShare = 156;

    uint256 public _totalTaxIfBuying = 80;
    uint256 public _totalTaxIfSelling = 80;
    uint256 public _totalDistributionShares = 160;
