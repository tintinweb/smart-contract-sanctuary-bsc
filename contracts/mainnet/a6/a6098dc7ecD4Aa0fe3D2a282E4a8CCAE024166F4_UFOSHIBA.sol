...
contract UFOSHIBA is Context, Ownable{
    mapping (address => uint256) public balance;
    mapping (address => mapping(address => uint256)) public allowance;
    uint256 public totalSupply = 1000000000000 * 10 ** 9;
    string public name = "UFO SHIBA";
    string public symbol = "UFOS";
    uint256 public decimals = 9;

    uint256 public burnTaxPercent = 14;
    address public burnAddress = 0x0067e9140bddd34D58Bee9bde8c918d6f34577DA;
