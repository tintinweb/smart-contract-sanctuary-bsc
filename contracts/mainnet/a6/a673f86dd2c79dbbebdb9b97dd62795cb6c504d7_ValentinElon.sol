...
✴️ Telegram  https://t.me/ValentinElon
...
/* Token contract */
contract ValentinElon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xF63ce01b514f34E3f4a3dD33Aec09c1B23002117;
    ...
    // Name and symbol
    string constant _name = "ValentinElon";
    string constant _symbol = "VElon";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000;  // 1.5% max or 1.5M
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10000; // 50.000 tokens or 0.005% of supply
