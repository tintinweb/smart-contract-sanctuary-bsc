...
contract FlokiRisu is Context, IERC20, Ownable {
    ...
    address payable public teamAddress =
        payable(0xD0e5e51A4456399f11296534f72882B1D8af8B0d); // Team Address
    ...
    string private constant _name = "FLOKI RISU";
    string private constant _symbol = "FRISU";
