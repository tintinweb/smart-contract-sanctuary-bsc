...
/*
Telegram: https://t.me/DollarPaw20
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x533c0504328DE5cc55408f8989058F98f0e1c058;
...
contract DollarPaw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dollar Paw";
    string private _symbol = "$PAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x533c0504328DE5cc55408f8989058F98f0e1c058);
    address payable public teamWalletAddress = payable(0x533c0504328DE5cc55408f8989058F98f0e1c058);
