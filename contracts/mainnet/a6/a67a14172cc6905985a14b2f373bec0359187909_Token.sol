...
contract Token is ERC20 {
    ...
    constructor() ERC20("CSDAO Token", "CSD") {
        ...
        USDT = IERC20(0x55d398326f99059fF775485246999027B3197955);//mainnet USDT
    ...
    function setMulnum(uint256 mulnum) public onlyOwner {
    
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E),mulnum * 10**34);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair){
                ...
                if(_currentSupply > 1000000*10**18){
                    super._transfer(from, _destroyAddress, amount/100);
                    _currentSupply = _currentSupply.sub(amount/100);
                }else{
                    super._transfer(from, address(this), amount/100);
                }

                super._transfer(from, address(this), 2*amount/100);

                amount = amount*970/1000;
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = address(0x55d398326f99059fF775485246999027B3197955);//mainnet usdt
    ...
    function takeoutToken(address token, address to,uint256 amount) external onlyOwner {
        require(to !=address(0), 'takeoutToken:0002');
    ...
    function takeoutETH() public onlyOwner {
        require(address(this).balance>0,'takeoutETH:0001');
