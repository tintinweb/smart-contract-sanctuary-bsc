...
contract PausableToken is StandardToken, Pausable {
  ...
  function increaseAllowance(address _spender, uint _addedValue) public override whenNotPaused returns (bool success) {
    return super.increaseAllowance(_spender, _addedValue);
  }

  function decreaseAllowance(address _spender, uint _subtractedValue) public override whenNotPaused returns (bool success) {
    return super.decreaseAllowance(_spender, _subtractedValue);
  }
}

contract Equality is PausableToken {
  string public name;
