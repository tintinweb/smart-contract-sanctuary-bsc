...
contract LunaGrow is IBEP20, Ownable {
 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    string constant _name = "Luna Grow"; // 
    string constant _symbol = "LUNAGR0W"; // 
    ...
    uint256 public _maxWalletToken = _totalSupply / (200) * (2); // 1%

    // Fees receivers
    address public autoLiquidityReceiver = 0x0351A0Ea95deC408aAb0495620AaC507842A3013;
    address public marketingFeeReceiver = 0x0351A0Ea95deC408aAb0495620AaC507842A3013;
    address public devFeeReceiver = 0x0351A0Ea95deC408aAb0495620AaC507842A3013;
    address public buybackFeeReceiver = 0x0351A0Ea95deC408aAb0495620AaC507842A3013;
    ...
    if(tokenAmount > 0){
            router.addLiquidityWBNB{value: WBNBAmount}(
                address(this),
                tokenAmount,
                0,
                0,
        ...
        emit AutoLiquify(WBNBAmount, tokenAmount);
        }
    }
