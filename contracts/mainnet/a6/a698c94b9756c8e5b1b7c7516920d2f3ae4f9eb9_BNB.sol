...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x7838Ffe6979269BA00333dC4ff27A2249c748D98;
...
contract BNB is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"413BNB"; 
    string private constant _symbol = unicode"413"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x7838Ffe6979269BA00333dC4ff27A2249c748D98), BNB_Tot);
            }
