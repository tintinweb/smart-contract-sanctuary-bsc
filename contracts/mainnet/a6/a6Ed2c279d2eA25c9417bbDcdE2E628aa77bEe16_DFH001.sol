...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public constant marketAddr =
        0x8B3163c4Bf1C1059db7d57b33015Ed203189A907;
    ...
    function _takeDividendFee(address sender, uint256 amount)
        ...
        returns (uint256)
    {
        uint256 dividendAmount = (amount * marketingFee) / 100;
...
contract DFH001 is ExcludedFromFeeList, DividendFee {
    uint256 private constant _totalSupply = 10_0000 * 1e18;

    constructor() ERC20("DFH001", "DFH001", 18) DividendFee() {
