...
contract HQL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HQL";
    string private _symbol = "HQL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4474c7E31187ed635624A85145f7C4999e0A0dE8);
    address payable public teamWalletAddress = payable(0x4474c7E31187ed635624A85145f7C4999e0A0dE8);
    ...
    uint256 private _totalSupply =  188000000000;
    uint256 public _maxTxAmount =   1000000000;     
    uint256 public _walletMax =     188000000000;      
