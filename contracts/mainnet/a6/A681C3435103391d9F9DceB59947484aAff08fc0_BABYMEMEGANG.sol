...
contract DividendDistributor is IDividendDistributor, Auth {
    ...
    IBEP20 RWDS = IBEP20(0xF8C8239E8929760Ac4d9086Bee60172DD7b91416);
    address REWARDS;
    IRouter router;
...
contract BABYMEMEGANG is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'BABY MEMEGANG';
    string private constant _symbol = '$BMGANG';
