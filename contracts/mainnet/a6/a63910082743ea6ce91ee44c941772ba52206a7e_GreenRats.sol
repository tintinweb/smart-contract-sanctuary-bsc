...
contract GreenRats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GreenRats";
    string private _symbol = "GRATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA13fb7ee6d04333076B38a93dAe9241aB17CD3b9); 
    address payable public buyBackWalletAddress = payable(0xA13fb7ee6d04333076B38a93dAe9241aB17CD3b9); 
