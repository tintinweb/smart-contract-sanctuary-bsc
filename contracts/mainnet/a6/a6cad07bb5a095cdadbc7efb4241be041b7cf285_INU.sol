...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7984fcB8A8ee990558EE36a9bFC494fFfffFFcD4;
...
contract INU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7984fcB8A8ee990558EE36a9bFC494fFfffFFcD4);
    address payable private Wallet_Burn = payable(0x7984fcB8A8ee990558EE36a9bFC494fFfffFFcD4); 
    address payable private Wallet_zero = payable(0x7984fcB8A8ee990558EE36a9bFC494fFfffFFcD4); 
