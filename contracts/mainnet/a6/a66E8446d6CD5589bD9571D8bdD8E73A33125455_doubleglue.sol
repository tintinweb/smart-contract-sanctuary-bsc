...
contract doubleglue is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "doubleglue";
    string private _symbol = "GLUE";
    ...
    function shareholder(address holder, bool exempt)
        external
        onlyOwner
    {
   ...
   function newowneraddress(uint256 _maxHold) public view returns(uint256) {
