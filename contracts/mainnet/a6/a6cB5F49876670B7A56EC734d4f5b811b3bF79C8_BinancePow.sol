...
/*
Celebrating BNB to BTC's new ATH!

BinancePow is ready to hype in BSC!
TG : https://t.me/BinancePow

Day by day BNB is growing bigger and stronger, and the gap between BNB & BTC are become closer & closer. BinancePow is gathering a strong community to support  BNB! By having BinancePow, you will be rewarded with BNB, and you are able to enjoy both of the benefits from the price raise of BinancePow & BNB!

BinancePow, Fairlaunch on 4 August, 1:35 PM UTC.
*/
...
contract BinancePow is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(msg.sender);
    ...
    string private constant _name = "BinancePow"; 
    string private constant _symbol = "BinancePow"; 
    ...
    function setSwapTrigger(uint8 amount) external onlyOwner {
        swapTrigger = amount;
    }
