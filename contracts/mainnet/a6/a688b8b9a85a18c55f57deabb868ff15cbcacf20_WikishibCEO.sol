...
contract WikishibCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WIKISHIB CEO"; 
    string private _symbol = "WSHIBCEO"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB70228781b6548523995fEf2A77a71Bd3060a17E); 
    address payable public teamWalletAddress = payable(0xB70228781b6548523995fEf2A77a71Bd3060a17E); 
