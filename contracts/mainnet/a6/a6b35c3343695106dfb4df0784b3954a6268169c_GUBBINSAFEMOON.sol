...
contract GUBBINSAFEMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Gubbin Safemoon 1996 ";
    string private _symbol = " $GS1996 "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x119063278cE55C789001c5eC4b0C39D3853DfdA3); 
    address payable public teamWalletAddress = payable(0x119063278cE55C789001c5eC4b0C39D3853DfdA3); 
