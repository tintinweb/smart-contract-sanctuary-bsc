...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        emit OwnerSet(_owner, _previousOwner);
...
contract MetaToken is ERC20,Ownable{
    using SafeMath for uint256;
    string private _token = "Meta Token";
    string private _coin = "META";

    // ERC-20
    constructor () ERC20 (_token,_coin) {
		_mint(msg.sender,2_100_000_000 * (10 ** uint256(decimals())));
	}
 }