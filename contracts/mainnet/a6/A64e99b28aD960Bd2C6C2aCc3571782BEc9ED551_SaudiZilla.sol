...
contract SaudiZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x108046Cc38746EdA9AfF2483E800F199c01A2c7C); // Marketing Address
    address payable public devWalletAddress = payable(0x108046Cc38746EdA9AfF2483E800F199c01A2c7C); // Dev Address
    ...
    string private _name = "SaudiZilla";
    string private _symbol = "SaudiZilla";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x108046Cc38746EdA9AfF2483E800F199c01A2c7C, 'We can not exclude Uniswap router.');
