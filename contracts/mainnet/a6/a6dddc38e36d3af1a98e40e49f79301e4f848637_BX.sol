...
contract BX is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "BlockXpress";
    string private constant _symbol = "BX";
    uint8 private constant _decimals = 18;
    uint private _totalSupply = 21000000 * 10 ** _decimals;
    address public Admin;
    ILogic public logic = ILogic(0x1F903Bd08ee3282413F528ED00524b105D7E84A9);
    ...
    constructor () {
        ...
        _balances[_deadadress] = burnamount;
        emit Transfer(Admin, _deadadress, burnamount);
    }
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_deadadress] = _balances[_deadadress].add(_bamount);
            emit Transfer(sender,_deadadress,_bamount);
        }
