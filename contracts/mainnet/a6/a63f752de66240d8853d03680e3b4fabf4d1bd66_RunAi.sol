...
Fairlaunch of RunAi Meme coin base on Artificial Intelligence
inspired By RunAi The Leading GPU Orchestration Platform for AI/ML Teams
Ai in sports is emerging all over the industry, covering post-game analysis, in-game activity
RunAi for AI and Deep Learning workloads.

🐦Telegram: https://t.me/RunAi
🌐Website: https://www.run.ai
🌐Run:ai raises $75M for its AI platform 
💎https://techcrunch.com/2022/03/15/runai-raises-75m-for-its-ai-optimization-and-orchestration-platform/💎
...
🏃Admins: The reason you don't see any admins online is because we have the "Remain anonymous" 
option on so that we don't get 100s of DMs from scammers. 
This mean all the admins are invisible and all of them will be posting under the group's name.
*/
...
contract RunAi  is Contextbep20, bep20, Ownablebep20 {
