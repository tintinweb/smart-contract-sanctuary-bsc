...
// https://t.me/ArticFoxBsc

// https://t.me/CharzaCalls
...
contract Artic is IBEP20, Auth {
    ...
    string constant _name = "Artic Fox";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "ArticFox";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x67747879733F6f191988c28580489092D466491f;
        marketingFeeReceiver = 0x67747879733F6f191988c28580489092D466491f;
