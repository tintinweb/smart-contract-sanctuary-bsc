...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #PIGKING

    I make this #PIGKING to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/PIGKINGofficial
   ...
   I will renounce the ownership to burn addresses to transfer #PIGKING to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #PIGKING 10000000X? 
   ...
   it's the best part of the #PIGKING idea, increasing the liquidity pool automatically, 
...
contract PIGKING is Context, IERC20, Ownable {
    ...
    string private _name = "PIGKING";
    string private _symbol = "PIGK";
