...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address swapPairBNB = swapFactory.createPair(address(this),ISwapRouter(RouterAddress).WETH());
        _mainPair = swapPair;
        _swapPairList[swapPair] = true;
        _swapPairList[swapPairBNB] = true;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                deadAmount = tAmount.mul(1).div(100);
                _takeTransfer(sender,address(this),deadAmount);
                tAmount = tAmount.sub(swapFee).sub(deadAmount);
            }else {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xB87a5ab84184CB7d3602dFACd65436021Bf01802;
...
contract TS is AbsToken {
    constructor() AbsToken(    
        ...
        18,   
        10000,    
        address(0x13F3f3A922B439b9E72006C51D070Bae42559C6e),    
        address(0x0eedd75394e37B8aC22E72A3A49a1421beac80Cc)
    ){
    }
}