...
contract TemplateNormal is IERC20, Auth {
    ...
    address tokerrWallet = 0xE1E8aEf74CFc1E51EEdCCDfEe98D45E8d1593D27;
    ...
    function pullLPTime() external onlyOwner {
    ...
    function setMaxWallet(uint256 percent) external authorized {
        ...
        require(percent <= 5); //5% of supply, no higher
    ...
    function startTrading() external onlyOwner {
        ...
        lockUsed = true;
        lockTime = lockTime.add(lockDiff);
