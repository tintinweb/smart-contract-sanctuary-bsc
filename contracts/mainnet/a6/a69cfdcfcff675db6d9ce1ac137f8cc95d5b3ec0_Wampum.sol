...
contract Wampum is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SecondDividendTracker public dividendTrackerSecond;
    ...
    constructor() ERC20 ("Wampum", "Wampum") {
		...
		marketingWallet = payable(0x965E7b285E5B52b6a8793dBc9B4aAf24674b6697);
        _devWallet1 = payable(0x80070762aB62FAfe48457d69Ae2bF74Ba952De34);
        _devWallet2 = payable(0x63a69f02d3F162DA37aE07df97b05707070e71E7);
    ...
    function updateDividendTrackerFirst(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerFirst), "Wampum The dividend tracker already has that address");

        FirstDividendTracker newDividendTrackerFirst = FirstDividendTracker(payable(newAddress));

        require(newDividendTrackerFirst.owner() == address(this), "Wampum: The new dividend tracker must be owned by the Wampum token contract");
    ...
    function updateDividendTrackerSecond(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerSecond), "Wampum The dividend tracker already has that address");

        SecondDividendTracker newDividendTrackerSecond = SecondDividendTracker(payable(newAddress));

        require(newDividendTrackerSecond.owner() == address(this), "Wampum: The new dividend tracker must be owned by the Wampum token contract");
    ...
    function updateFirstDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenFirst), "Wampum: The router already has that address");
    ...
    function updateSecondDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenSecond), "Wampum: The router already has that address");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Wampum: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Wampum: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Wampum: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Wampum: The marketing wallet is already this address");
