...
//SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract ScroogeMchustle is IBEP20, Auth {
        ...
        // Name and symbol
        string constant _name = "Scrooge Mchustle";
        ...
        // Max wallet and TX
        uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // 1.5% 
        uint256 public _maxSellTxAmount = _totalSupply * 10 / 10000; // 0.2% 
        uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 10000; // 1.5% 
        ...
        constructor () Auth(msg.sender) {
            ...
            marketingFeeReceiver = 0x8Fa63A0371059b8D6503d85a095519B46771f130;
