...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCD0012E562C3E3a934cf3B7C5a0047da98600c51; // owner address
...
contract SANTARABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Rabbit";
    string private _symbol = "SARAB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCD0012E562C3E3a934cf3B7C5a0047da98600c51); // Marketing Address
    address payable public teamWalletAddress = payable(0xCD0012E562C3E3a934cf3B7C5a0047da98600c51); // Team Address
