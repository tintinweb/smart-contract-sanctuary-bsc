...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7d708B06BdBF1CFccB566F1B57C5b7F284e82574;
...
contract TestV is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa12a7c6afE95198CFd45f4C48C58De96274Fd83E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TestingV";
    string private _symbol = "TstV";
