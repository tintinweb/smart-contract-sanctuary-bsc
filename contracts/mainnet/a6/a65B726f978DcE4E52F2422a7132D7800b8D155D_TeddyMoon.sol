...
/*
TEDDYMOON || CRYPTO COMMUNITY
TG : https://t.me/TeddyMoonCom

TeddyMoon is a new BSC community token that is build to gather peoples with positive vibes & share crypto experiences in the community. 

By having support from our positive community, TeddyMoon will become one of the most anticipate long term project.

TOKENOMICS
1) 1,000,000,000,000 of Supply (1 Trillion)
2) 10% of Tax
3) $240 as Initial MC

Stealth launch, contract will be share on launch.
Launch estimation : 1:30 - 3:00 PM UTC
*/
...
contract TeddyMoon is Context, IERC20 { 
    ...
    string private constant _name = "TeddyMoon"; 
