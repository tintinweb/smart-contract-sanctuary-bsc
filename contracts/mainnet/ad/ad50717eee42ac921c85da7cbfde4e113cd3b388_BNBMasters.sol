...
BNB Masters provides a high passive income by offering a 15% BNB reward and introduces a high quality, 3D animated, and high 
reward claiming P2E game. ✅ KYC team ✅ Audited contract ✅ 15% BNB reward to holders ✅ 3D play to earn game ( P2E ) 
✅ Game NFT shop and giveaway ✅ Locked Liquidity for 10 year ✅ CMC and CG listing ✅Aggressive marketing campaigns
 ✅ Join our social Media channels to get more information.

https://twitter.com/MastersBNB
https://facebook.com/BNBMasters
https://www.instagram.com/bnb_masters/
https://discord.com/invite/xRvMCZet89
https://www.reddit.com/r/BNB_Masters/
*/
...
contract BNBMasters is _IBEP20, ANTIBOTS {
    ...
    string _name = "BNB Masters";
    string _symbol = "BNBMA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAMOUNT = 200_000_000 * (10 ** _decimals);   // 100% 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD && !isTxLimitExempt[recipient]) {
            require(balanceOf(recipient) + amount <= _maxWalletAMOUNT, "Max Wallet Exceeded");
        }
    ...
    function changeMaxWallet(uint256 percent, uint256 denominator) external onlyOwner {
        ...
        _maxWalletAMOUNT = _totalSupply.mul(percent).div(denominator);
    }
