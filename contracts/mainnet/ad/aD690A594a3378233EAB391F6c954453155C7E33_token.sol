...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 988655533333333 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "贝塔狗";
    ...
    address public ownerAddres = address(0x9Ed3f4C0B639d6A5ca55D4b3E9d94d537620eA40);
    address public devAddress = address(0x9Ed3f4C0B639d6A5ca55D4b3E9d94d537620eA40);
    ...
    uint256 public _maxTxAmount = 988655533333333 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 988655533333333 * 10 **18;
