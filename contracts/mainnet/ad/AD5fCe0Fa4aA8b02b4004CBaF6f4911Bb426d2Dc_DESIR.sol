        ...
        function _transfer(
            ...
            if(!isExcludedFromFees[_from] && !isExcludedFromFees[_to] && (_from == _uniswapV2Pair || _to == _uniswapV2Pair)){
                if(!transOpen) {
                    ...
                    require(_amount < maxBuy + 1,"Beyond the scope of purchase");
                } else {
