...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "DogeDAD";
    string private _symbol = "DogeDAD";
    ...
    address payable public marketingWalletAddress = payable(0x56da582e64Ac20b016E1EC20fbe263568589647F); // Marketing Address
    address payable public teamWalletAddress = payable(0x56da582e64Ac20b016E1EC20fbe263568589647F); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x56da582e64Ac20b016E1EC20fbe263568589647F),
            block.timestamp
        );
    }
