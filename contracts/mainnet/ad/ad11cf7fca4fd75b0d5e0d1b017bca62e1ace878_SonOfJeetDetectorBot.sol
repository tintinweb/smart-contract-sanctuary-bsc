...
Jeet Detector Bot has a son and his name is:
Son of Jeet Detector Bot

https://t.me/SonOfJDB
https://twitter.com/JDBsonBSC

5% JDB rewards ;)
Starting with a nano cap, easy to become a whale.
...
contract SonOfJeetDetectorBot is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfJeetDetectorBot";
    string constant _symbol = "SonOfJDB";
