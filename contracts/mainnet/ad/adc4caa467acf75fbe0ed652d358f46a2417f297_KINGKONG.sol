...
contract KINGKONG is ERC20, ERC20Burnable, Ownable {
    ...
    address public _fundAddress = 0xECd0DE09ed9b6f08Ee616B80D1DE8edE273D1e76;

    constructor() ERC20("KINGKONG", "KINGKONG"){
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[0xC110A45ea566b2C99A88ADBfaabd0959F1CD4d42] = true;
    
        _mint(0xC110A45ea566b2C99A88ADBfaabd0959F1CD4d42, 21000 * 10 ** decimals());  
    ...
    function _transfers(address from,address to,uint256 amount) private {
        ...
        if(_feePair[from] || _feePair[to]){
            ...
            if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
                ...
                _transfer(from, _destroyAddress, feeAmount.mul(3));
                _transfer(from, _fundAddress, feeAmount.mul(2));
                _transfer(from, to, amount.sub(feeAmount.mul(5)));
            }
        }else{
            _transfer(from, to, amount);
        }
