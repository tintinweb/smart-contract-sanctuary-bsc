...
Search no further. Yahoo Inu.

https://t.me/YahooInuToken
...
contract YahooInu is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Yahoo Inu"; // 
    string constant _symbol = "YNU"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (4); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (4); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (4); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0x978dd0d842dC1CA3103dc95C29bE0f6392aeA9b9; //LP receiver
    address private marketingFeeReceiver = 0xa6CAf3608d48e0Cee0aeed6291EC32c9A9281DF2; //mkt
    address private devFeeReceiver = 0xa6CAf3608d48e0Cee0aeed6291EC32c9A9281DF2; //31 BuyBack
    address private teamFeeReceiver = 0xa6CAf3608d48e0Cee0aeed6291EC32c9A9281DF2; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xeD9F8f4f9bDf6E3487963229d239Afc474B4c9dc;
