...
contract CCCM is BEP20, BEP20Burnable, Ownable {
    constructor() BEP20("California Carbon Credit Market", "CCCM") {}
    ...
    **/
    ...
    /**
    * @dev claim stucked bep20 tokens if accidently sent by someone to this smartcontract
    **/

    function claimStuckedTokens (IBEP20 token) external onlyOwner {
