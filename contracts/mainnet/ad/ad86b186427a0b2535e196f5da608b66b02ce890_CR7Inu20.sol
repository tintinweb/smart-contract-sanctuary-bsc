...
contract CR7Inu20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn
    ...
    string private _symbol = "Siiuuu 2.0";
    ...
    uint256 private minimumTokensBeforeSwap = 2154251 * 10**6 * 10**9; 
