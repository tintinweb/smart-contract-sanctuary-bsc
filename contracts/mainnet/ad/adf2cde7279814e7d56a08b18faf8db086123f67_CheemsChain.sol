...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4eCf4eE4B3B091aAe48d1A89Ee31261e080E5ec1;
...
contract CheemsChain is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x7A17811B1F0c225A04054B3cf75dcF6Bd6d46723;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 6900000000000000* 1**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cheems Chain";
    string private _symbol = "CheemsChain";
