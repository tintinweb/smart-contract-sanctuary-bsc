...
/**
Let's celebrate Christiano Ronaldo joining Binance as well as the World becoming home to 8 billion people.

RONALDO 8 BILLION ($CR8) Tokenomics:
Supply: 8 Billion
Initial LP: 1.5BNB
Buy Tax: 7%
Sell Tax: 7%
Liquidity Lock: 1 month on PinkLock
*/
...
contract RonaldoEightBillionBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "RONALDO 8 BILLION";
    string private constant _symbol = "CR8";
