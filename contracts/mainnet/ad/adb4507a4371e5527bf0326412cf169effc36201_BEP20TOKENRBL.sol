...
contract BEP20TOKENRBL is Context, IBEP20, Ownable {
    ...
    string public _name;
    address[11] _addresses;
    uint256[11] _percents;
    ...
    constructor() {
        ...
        _totalSupply = 6*10**6*10**uint(_decimals);
         ...
         uniswapV2Router = IPancakeRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);

        _routerAddress = address(uniswapV2Router);

        //walletAddess
        _addresses[0]=0x54300bb29B0445cA32A91f1626B8b53E37e21D47;//0 Technology
        _addresses[1]=0xf9CdBf59D1606728d3d5d78BeD2DaA6E0A72EDce;//1 Airdrop
        _addresses[2]=0x7E69799065b49Ab6d37D180f4F3a34854B701Fcd;//2 Ecosystem
        _addresses[3]=0xF8172C091F826BD440A8164c78e89A77b954f958;//3 Rainbow Funds
        _addresses[4]=0xcb6f2aD79cDbD45c64148dd967634CfD09429a83;//4 Pre-sale
        _addresses[5]=0x39158cE57214DE1C949A45A6AA9295f94076fe43;//5 lP rewards
        _addresses[6]=0x54221DF8cb75443b4a828E54D6A41DD771e9EC80;//6 General NFT
        _addresses[7]=0xF621fEe06D186c81b51a610d3BB4716e06E61c22;//7 Knight NFT
        _addresses[8]=0x39E848b5be6686D4904940D329f26cDC952DF3a0;//8 MP3
        _addresses[9]=0x1D2c3be4f7c033C0BBE582AE2F8a923098657438;//9 Sales rewards
        _addresses[10]=0xb88546cA877A614a9751D85483433EAAC3283B28;//10 Environmental Protection Ambassador NFT
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_swapNowStatus==true){
            ...
            if(_pairAddress[sender]==true&&_whites[recipient]==false){
                ...
                _tokenTransfer(sender, _addresses[10], amount.mul(_percents[10]).div(100));
