...
If you missed TATE Like me😀 Don't miss Saudi TATE
I was in whales group of TATE I know all the strategy and plans behind success of TATE we are Going to Repeat History..
...
contract SaudiTate is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB03feE89C82F8E5a8f1cf99331cB17ef74F55d5b); 
    address payable public Wallet_Dev = payable(0x303d4c82c524d7c1bfBa50cd1cC1213ffd98f616);
    ...
    string constant _symbol = unicode"SaudiTate";
    ...
    constructor () {
        ...
        _owner = 0x303d4c82c524d7c1bfBa50cd1cC1213ffd98f616;
