...
contract MysteryToken is Context, IERC20, Ownable {
    ...
    string private _name = "SaveUkraine";
    string private _symbol = "SU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x043B1B9436c5Ac8e204eC2E1da5cD9147afEce31); // 
    address payable private teamWalletAddress = payable(0x043B1B9436c5Ac8e204eC2E1da5cD9147afEce31); // 
