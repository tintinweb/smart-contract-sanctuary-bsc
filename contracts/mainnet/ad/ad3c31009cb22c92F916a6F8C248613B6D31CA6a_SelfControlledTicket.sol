...
import "./NonTransferableTicket.sol";

contract SelfControlledTicket is
    ...
    Ownable
{
    ...
    constructor(string memory _name, string memory _symbol)
        NonTransferableTicket(_name, _symbol, this)
    {}


    function airdropTickets(address[] calldata owners, uint256[] calldata balances) external onlyOwner {
        require(owners.length == balances.length, "invalid data");
        for (uint256 i = 0; i < owners.length; ++i) {
            _mint(owners[i], balances[i]);
        }
    }
