...
contract BNB_INSTANT {
	...
	uint[] public					REFERRAL_PERCENTS				= [5, 5, 5, 5, 5];	// 0.05% 0.05% 0.05% 0.05% 0.05%
	uint constant public			PROJECT_FEE						= 100;					// project fee 1% of deposit
    uint constant public			PROJECT_REINVEST_FEE			= 100;					// project fee 1% of reinvest
	...
	uint constant public			INSURANCE_PERCENT				= 100;					// insurance fee 2% of claim
	...
	constructor() {
		...
		WALLET_PROJECT = payable(0x554472D18830641fF7256B60b4f4E14b0E88D1Ba);
		WALLET_DEV     = payable(0x554472D18830641fF7256B60b4f4E14b0E88D1Ba);

		PLANS.push( TPlan(1,10300) );
	...
	function invest(address _referrer, uint8 _planIdx) public payable {
        ...
        require(msg.value <= INVEST_MAX_AMOUNT, "Maximum amount is 100 BNB");
