...
/**
 *
 * GoldenShib (GSHIB) is here to set the gold standard for meme coins on the Binance Smart Chain!
 * https://t.me/GoldenShib
 *
 */
...
contract GoldenShib is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldenShib";
