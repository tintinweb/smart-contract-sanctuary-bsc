...
contract TsukaGrowUp is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x54535156E75c2918dfbf5C1F34BE64E789078Da0); 
    address payable public Wallet_Dev = payable(0x54535156E75c2918dfbf5C1F34BE64E789078Da0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 12**_decimals;
    string private constant _name = "Tsuka GrowUp"; 
    string private constant _symbol = unicode"TSUKAGUP"; 
    ...
    constructor () {
        ...
        _owner = 0x54535156E75c2918dfbf5C1F34BE64E789078Da0;
