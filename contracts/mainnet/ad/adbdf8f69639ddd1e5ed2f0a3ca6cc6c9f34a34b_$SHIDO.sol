...
// Telegram: https://t.me/ShidoInuBSC
...
contract $SHIDO is Context, IERC20, Ownable {
    ...
    string private _name = "Shido Inu"; 
    string private _symbol = "$Shido"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x722F84Be222bfcC6d62D04344c430Ba9db9A0281); 
    address payable public teamWalletAddress = payable(0x722F84Be222bfcC6d62D04344c430Ba9db9A0281); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 63 / 10000;
