...
contract Ownable is Context {
    address private _owner = 0x48cb8bE259fDb8D0c0054Ee56631b33b69482b30;
...
contract Dogeping is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x48cb8bE259fDb8D0c0054Ee56631b33b69482b30); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "DOGE PI KING"; // token name
    string private _symbol = "Doge Pi"; // token symbol
    uint8 private _decimals = 18; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 100000000000 * 10**6 * 10**_decimals;
    ...
    uint256 public _liquidityFee = 20; // liquidity fee 5%
	...
	uint256 private _transactionLockTime = 600000; //Cool down time between each transaction per address
    ...
    uint256 public _minTokensSwapToAndTransferTo = 100000000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(1); // Max number of tokens that an address can hold 5% of total supply
