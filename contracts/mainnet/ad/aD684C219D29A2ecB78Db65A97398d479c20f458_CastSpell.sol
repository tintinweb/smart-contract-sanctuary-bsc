...
contract CastSpell is IBEP20, Auth {
    ...
    string constant _name = "Cast Spell";
    string constant _symbol = "$CAST";
    ...
    address public marketingFeeReceiver = 0xE41122C2e845A03ab5C4748527e2adf19CE4e810;
