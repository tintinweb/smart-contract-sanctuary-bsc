...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8bE015a0B0C424568E0F3Bc99d6A4E0Cb4ffAeD9;
...
contract KOA is Context, IERC20, Ownable {
    ...
    string private constant _name = "KOA"; // 
    string private constant _symbol = "KOA"; //    
    uint8 private constant _decimals = 9; // 
    uint256 public _feeMarketPool = 3;
    uint256 public _LiquidFeeValue = 0;
    address payable public  _DevTeam = payable(0x8bE015a0B0C424568E0F3Bc99d6A4E0Cb4ffAeD9);
