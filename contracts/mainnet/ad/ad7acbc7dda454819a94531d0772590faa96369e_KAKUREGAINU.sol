...
/**
 ...
 Telegram: https://t.me/KakuregaInu
 
 Twitter: https://twitter.com/KakuregaInu
...
contract KAKUREGAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kakurega Inu";
    string private _symbol = "KUREGA";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x323d10a11da8f6612159ac96D337c9910a8003CB);
    address payable public teamWalletAddress = payable(0xd8a593E96020f0178C38323942E3262ad22B755d);
