...
contract OCTAGON is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0xaE023810fF263bdedB98aE723Ff0d4224BA6A5ED;
    uint256 private _previousMarketingFee = _MarketingFee;
    
    uint256 public _ProjectFee = 2;
    address public ProjectWallet = 0x86bFcaBAa0a4B0fd9be7c3BF315e9B9fEcE74a91;
    ...
    function setProjectFeePercent(uint256 projectFee) external onlyOwner() {
        require(projectFee >= 1 && projectFee <= 25, 'projectFee should be in 1 - 25');
