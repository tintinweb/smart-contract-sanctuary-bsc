...
contract DinoArm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dino Arm";
    string private _symbol = "DinoArm";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9C1beFC480B34341C5a582fEf274B64BFa5B60b9);
    address payable public DevWalletAddress = payable(0x3d005236Bb910E895102F50f0257f548e2028886);
