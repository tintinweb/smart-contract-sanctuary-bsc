...
contract SquidSoldier is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Soldier";
    string private _symbol = "SSoldier";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xF03A735d75621c24392aB1A22b1DB95B7616560f); // Marketing Address
    address payable public teamWalletAddress = payable(0xFc6C60e0E7176eb6f9b7df81C644b3EBACe1C0e8); // Team Address
