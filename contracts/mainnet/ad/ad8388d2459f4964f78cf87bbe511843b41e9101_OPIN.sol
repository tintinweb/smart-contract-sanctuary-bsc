...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    address public MarketingWallet = 0x3C0B275Cf0f23d6764EC451F14777255fa5ec3B1; //2% for marketing 
    ...
    uint256 public _maxTxAmount = 5*10**7 * 10**9; //1% of total supply   //ANTIDUMP
 ...
 function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    ...
    function setBurnfeePercent (uint burnFee) external onlyOwner() {
        _burnFee = burnFee;
        require (burnFee <10,"Cannot set burn fee more than 10%!");
    }
   
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner() {
        _marketingFee = marketingFee;

        require (marketingFee <5 , "Cannot set marketing fee more than 5%!");
    }
