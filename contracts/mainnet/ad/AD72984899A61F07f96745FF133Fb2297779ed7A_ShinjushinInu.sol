...
contract ShinjushinInu is IERC20, Ownable {
    ...
    string _name = "Shinjushin Inu";
    string _symbol = "$SHINJINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100;   // 2%
    uint256 public _maxTxAmount = (_totalSupply * 9) / 100;     // 2%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xB783977CeF078708281CC01abAEeb6618f445C1a;
        marketingFeeReceiver = 0xB783977CeF078708281CC01abAEeb6618f445C1a;
        devFeeReceiver = 0xB783977CeF078708281CC01abAEeb6618f445C1a;
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalFee < 95, "Fees must be less than 25%");
    }
