...
contract BabyElonHippo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _tTotal = 10**9 * 10**18;                         // 1 billion
    uint256 public swapAtAmount = _tTotal.mul(100).div(10000);       // 1.00% of total supply
    uint256 public maxTxLimit = _tTotal.mul(500).div(10000);         // 5.00% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(1000).div(10000);    // 10.00% of total supply
    ...
    constructor(address _dev) public ERC20("BabyElonHippo", "BEH") {
