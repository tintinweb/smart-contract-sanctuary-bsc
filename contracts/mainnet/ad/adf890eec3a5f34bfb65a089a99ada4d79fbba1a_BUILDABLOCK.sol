...
contract BUILDABLOCK is IBEP20, Auth {
   ...
   string constant _symbol = "BuildABlock";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 500; // 3% Marketing , 2% Utility Development
    ...
    uint256 marketingFeeSell = 500; // 3% Marketing , 2% Utility Development
