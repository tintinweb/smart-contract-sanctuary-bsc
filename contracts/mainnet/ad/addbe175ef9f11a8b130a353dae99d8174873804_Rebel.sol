...
contract Rebel is IERC20 {
    ...
    uint256 constant private startingSupply = 1 * 1e12;
    string constant private _name = "We Are Rebels";
    string constant private _symbol = "REBEL";
    ...
    address payable public marketingWallet = payable(0x3057a8Bb8FDe26EE93Ed7Cf61D9194D5FA7401bB);
...
//===============================================================================================================
    ...
    function setSwapSettings(uint256 thresholdPercent, uint256 thresholdDivisor, uint256 amountPercent, uint256 amountDivisor) external onlyOwner {
        ...
        require(swapAmount >= _tTotal / 1 * 1e12, "Cannot be lower than 0.00001% of total supply.");
        require(swapThreshold >= _tTotal / 1 * 1e12, "Cannot be lower than 0.00001% of total supply.");
    }
    ...
    function batchTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner {
