...
contract MiniStarBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xced7a81b1725f815aA150B891Ca72b1f68B7eBd0); // Marketing Address
    address payable public devWalletAddress = payable(0xced7a81b1725f815aA150B891Ca72b1f68B7eBd0); // Dev Address
    ...
    string private _name = "MiniStarBoy";
    string private _symbol = "MiniRats";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xced7a81b1725f815aA150B891Ca72b1f68B7eBd0, 'We can not exclude Uniswap router.');
