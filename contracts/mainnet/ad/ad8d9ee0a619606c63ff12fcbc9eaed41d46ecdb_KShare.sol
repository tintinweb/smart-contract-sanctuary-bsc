...
contract KShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 61,000 kSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("KSHARE Token", "KSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 KSHARE Share for initial pools deployment
