...
contract Betaforce is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Betaforce";
    string private _symbol = "Betaforce";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9659C4589354Ec267420045E2A7b0e1336eD0f8);
    address payable public teamWalletAddress = payable(0xBc1948aDc61FdB08065658C690acAF9B6E820a7E);
