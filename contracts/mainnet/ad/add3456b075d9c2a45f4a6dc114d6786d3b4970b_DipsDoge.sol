...
contract DipsDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Dips Doge";

    string private _symbol = "Dips Doge";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x40834DC33297E857EcC5e9FF58aF45DF8eD88E9F;
