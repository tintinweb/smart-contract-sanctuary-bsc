...
// Telegram : https://t.me/ra8bitNFT
// Website  : https://ra8bit.xyz/
...
contract Ra8Bit  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1814A9c7c9d766c88b0dB3D06C03344FBf21dF8f); 
    address payable public Wallet_Dev = payable(0x7f60B69AB522D87a6AF1F28e0b5802C95CBf5460);
    ...
    string private constant _name = "Ra8Bit Token"; 
    string private constant _symbol = unicode"Ra8Bit"; 
    ...
    constructor () {
        ...
        _owner = 0x7f60B69AB522D87a6AF1F28e0b5802C95CBf5460;
