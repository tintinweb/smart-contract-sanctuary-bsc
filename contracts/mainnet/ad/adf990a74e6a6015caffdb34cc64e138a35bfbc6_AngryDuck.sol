...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcC09056B6eD1dd5537a8Fa4486E775d16f023BA0; // owner address
...
contract AngryDuck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angry Duck";
    string private _symbol = "AD"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xea4A8fE15Dc75f91d4C521f777b15EfdF28A442C); // Marketing Address
    address payable public teamWalletAddress = payable(0x27daC29Fc4131Ac268CA3f1690F0961FB7199CcB); // Team Address
