...
contract StarElon is IBEP20, Auth {
    ...
    string constant _name = "StarElon";
    string constant _symbol = unicode"SLE";
    ...
    function approveMax(address spender) external returns (bool) { // SI PUO LEVARE
