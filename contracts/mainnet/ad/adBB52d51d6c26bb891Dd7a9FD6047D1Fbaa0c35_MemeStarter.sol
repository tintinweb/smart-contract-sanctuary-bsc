...
contract MemeStarter is Context, IERC20, Ownable {
    ...
    string private constant _name = "MemeStarter"; // 
    ...
    address public  _marketingWallet = 0x7C509521Fc6f4BFfFA34c78aa49Ab6CF9D45Eeb2;
	address public  _markWallet = 0x94b365143E523C992f1abFeBf3311Dc93AE73882;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 100; 
		 uint256 markFee = amount * _markFee / 100;
        uint256 liquidityFee = amount * _liquidityFee / 100; 
        _tOwned[address(this)] += marketingFee + markFee + liquidityFee;
        emit Transfer (from, address(this), marketingFee + markFee + liquidityFee);
        return (amount - marketingFee - markFee - liquidityFee);
    }
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _liquidityFee / (_marketingFee + _markFee + _liquidityFee);
