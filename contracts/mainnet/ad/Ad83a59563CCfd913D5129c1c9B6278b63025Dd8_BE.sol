...
contract BE is Context, IERC20, Ownable {
    ...
    uint256 public xDirect_Inject = 10000;
  //  uint256 public Sandwich = 1; // prevent sandwich attack
    ...
    string  public Initial_Command = "Hello World!!!";
    ...
    // Provide additional access to contract after renounced ownership 
  // For future setting if needed 
    modifier onlyXboost() {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "COBE: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "COBE: decreased allowance below zero"));
        return true;
    }
    ...
    function setBuyFeePercent(uint256 reflect, uint256 dev, uint256 liquid) public onlyXboost {
        require(reflect.add(dev).add(liquid) <= 150, "Fee limitation is 15% anti rugged");
        _bReward = reflect;
        _bDevfee = dev;
        _bRfuel = liquid;
    }
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyXboost {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "COBE: approve from the zero address");
        require(spender != address(0), "COBE: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "COBE: transfer from the zero address");
        require(to != address(0), "COBE: transfer to the zero address");
