 ...
 contract HYToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (_swapPairList[sender]) {//Buy
            ...
            //5%营销运营直推奖励兑换为USDT1:2:2
            uint256 Amount = tAmount * 5/ 100;
            if (Amount > 0) {
            ...
            uint256 lpAmount = Amount * 10/100;
            uint256 usdtBalance = USDT.balanceOf(TokenDistributor);
            if(usdtBalance > 0){
            uint256 lpUSDT = usdtBalance * 10 /90;
            ...
            uint256 RewardAmount = usdtBalance * 40/90;
            uint256 YXAmount = usdtBalance * 40/90;
            ...
            //到账
            _takeTransfer(sender, recipient,tAmount*94/100);
    ...
    function swapTokenForFund() private lockTheSwap {
            ...
            uint256 lpAmount = tokenBalance * 10/100;
