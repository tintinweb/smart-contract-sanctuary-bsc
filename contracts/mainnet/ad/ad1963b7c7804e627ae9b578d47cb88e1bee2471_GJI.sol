...
/**
   ____                   _             _                  ___             
  / ___|_ __ ___  ___  __| |_   _      | |_/\____      __ |_ _|_ __  _   _ 
 | |  _| '__/ _ \/ _ \/ _` | | | |  _  | \    /\ \ /\ / /  | || '_ \| | | |
 | |_| | | |  __/  __/ (_| | |_| | | |_| /_  _\ \ V  V /   | || | | | |_| |
  \____|_|  \___|\___|\__,_|\__, |  \___/  \/    \_/\_/   |___|_| |_|\__,_|
                            |___/                                          

Greedy Jew Inu is a community driven meme token created in order to help you subdue your greedy nature in this harsh avid world of capabilities.

✅ NFTs
✅ P2S Game (Play to Steal)
✅ Giveaways
✅ Meme Competitions
✅ Big plans
...
Telegram: https://t.me/GreedyJewInu
Website: https://greedyjewinu.fun
Twitter: https://twitter.com/greedyjewinu
...
contract GJI is Context, IERC20, Ownable {
    ...
    //max wallet holding  
    uint256 public _maxWalletToken = ( _tTotal * 50 ) / 1000;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 25000 * 10**9; //
    string private constant _name = "Greedy Jew Inu"; // 
    string private constant _symbol = "GJI"; //    
    ...
    address private  _marketingWallet = 0x7404438f36b62Cd09ba5d353a1a28e6854487E2F;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            ...
            payable(0x7404438f36b62Cd09ba5d353a1a28e6854487E2F).transfer((ethToSend).mul(3).div(10));
    }
