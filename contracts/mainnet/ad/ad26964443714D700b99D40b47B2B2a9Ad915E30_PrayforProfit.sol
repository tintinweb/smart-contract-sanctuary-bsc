...
// https://t.me/PrayForProfitPortal
...
contract PrayforProfit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pray for Profit";
    string private constant _symbol = unicode"$PFP";
