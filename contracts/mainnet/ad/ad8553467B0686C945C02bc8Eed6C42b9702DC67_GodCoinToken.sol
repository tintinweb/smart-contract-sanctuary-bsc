...
contract GodCoinToken is ERC20, Ownable {
    ...
    uint256 internal buybackFee = 20;
    uint256 internal fundFee = 80;
    ...
    constructor( 
        ...
        _isExcludedFromFees[_receiveAddress] = true;
        _isExcludedFromFees[_fundAddress] = true;

        _mint(_receiveAddress, 1314 * 10 ** 16);
    }
