...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1fD05363B83c5F29282Be773111A12f27288c786; // owner address
...
contract TheWeekndInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "WEEKND INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4599bE6DF11a1F57979900b1965a9df61894503F); // Marketing Address
    address payable public teamWalletAddress = payable(0xE42946F0709477f6864f9e8c8e7a8B36Bfa07916); // Team Address
    ...
    uint256 public _liquidityShare = 5; // original 10
