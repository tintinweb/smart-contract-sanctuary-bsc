...
contract NEBWORIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEBWORIUM";
    string private _symbol = "NEBWORIUM";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x40eeb23C0baf901E6882a8C12C627b343f3A2EB7); // Marketing Address
