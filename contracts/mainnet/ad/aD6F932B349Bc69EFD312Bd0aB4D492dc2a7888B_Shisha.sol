...
/**
 Shisha SHEESH!!
 With all the Arabic and Saudi coins I think we all need some Sheesha!
...
library Address{
 ...
 contract Shisha is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 250_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 250_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 250_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x5Dad9eEF433d6d6bC9174b58fc0636fb6E4E520e;
    address public donationWallet = 0x5Dad9eEF433d6d6bC9174b58fc0636fb6E4E520e;

    string private constant _name = "Shisha";
    string private constant _symbol = "SHISHA";
    ...
    Taxes public taxes = Taxes(0, 9, 1, 2);
    Taxes public sellTaxes = Taxes(0, 9, 1, 4);
