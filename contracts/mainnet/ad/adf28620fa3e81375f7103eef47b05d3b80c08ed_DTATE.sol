...
/*
* Telegram: https://t.me/+9VL2_ylMXRxjMTM1
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DTATE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dubai TATE";
    string private _symbol = "DUBAI TATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9cF2018ce22a959260ce4DD135C83eDe2885C6F3);
    address payable public teamWalletAddress = payable(0x51345E35a9bcFe2a4e9Efc46564183a3b64B77af);
