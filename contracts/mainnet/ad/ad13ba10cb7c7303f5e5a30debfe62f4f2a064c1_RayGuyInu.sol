...
contract RayGuyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RayGuyInu";
    string private _symbol = "$RAYGUY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4149E0F4b443082c5Ff326519515A59DB0F2752A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4149E0F4b443082c5Ff326519515A59DB0F2752A); // BuyBack Address
