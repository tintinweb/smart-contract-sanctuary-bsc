...
contract Ironbank is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ironbank Reserve";
    string constant _symbol = "IBR";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //MN:0x10ED43C718714eb63d5aA57B78B54704E256024E TN: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        ...
        address _initial = msg.sender; //change;
        isFeeExempt[_initial] = true;
        isTxLimitExempt[_initial] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        developmentReceiver = msg.sender;
        marketingFeeReceiver = msg.sender;
        _balances[_initial] = _totalSupply;
        emit Transfer(address(0), _initial, _totalSupply);
    }
