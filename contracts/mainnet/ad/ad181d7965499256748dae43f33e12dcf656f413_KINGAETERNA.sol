...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbF426b12Af343ebf8abd3d84C786dbF070d7BA90;
...
contract KINGAETERNA is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x1f4806A35C14060B6222D7e9F56Fb5058d7a8fFA;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "King Aeterna";
    string private _symbol = "KING AETERNA";
