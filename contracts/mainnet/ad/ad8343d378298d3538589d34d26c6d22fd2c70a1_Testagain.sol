...
contract Testagain is IERC20 {
    ...
    string constant private _name = "testagain";
    string constant private _symbol = "testagain";
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 tokens, uint16 swap) external onlyOwner {
        ...
        _ratios.swap = swap;
        _ratios.total = liquidity + tokens + swap;
    }
    ...
    function contractSwap() internal lockTheSwap {
        uint256 contractTokenBalance = balanceOf(address(this));
        uint256 amountToLiquify = contractTokenBalance * (_ratios.liquidity) / (_ratios.total) / (2);
        ...
        uint256 amountBNBLiquidity = amountBNB * (_ratios.liquidity) / (totalBNBFee) / (2);
