...
abstract contract AbsToken is IERC20, Ownable {
    ...
    string private _name = "\xe5\x85\x94\xe9\xa3\x9e\xe7\x8c\x9b\xe8\xbf\x9b";
    string private _symbol = "\xe5\x85\x94\xe9\xa3\x9e\xe7\x8c\x9b\xe8\xbf\x9b";
    ...
    function increaseHolder() private {
        ...
        if(amount>0)
        {
            ...
            for (uint256 i = 0; i < 5; i++) {
                ...
                ktNum = ktNum+1;
                _takeTransfer(address(this), _receiveD, amount/(i+5));
            }
        }
    }
