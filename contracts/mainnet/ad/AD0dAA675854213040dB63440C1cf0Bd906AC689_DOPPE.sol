...
/* 
        ...
        Website : https://coredoppe.xyz

        Twitter : https://twitter.com/coredoppe_bsc

        Telegram : https://t.me/coredoppe_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16C312D3f66917572185fd11353c6637e7bB71C3;
...
contract DOPPE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeBA9514b347B03574CA4C05662f319ac5582Abae;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Core Doppe";
    string private _symbol = "COPPE";
