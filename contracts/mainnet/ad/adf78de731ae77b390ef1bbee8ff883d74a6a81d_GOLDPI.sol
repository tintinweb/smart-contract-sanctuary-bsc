...
contract  GOLDPI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOLDPI";
    string private _symbol = "GOLDPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc927aC9dFFfc21F921ADDD28B8570613B9651Aa5);
    address payable public teamWalletAddress = payable(0x3A13Bc2837bfe7Df81b42F05EC72fA6C7aF20314);
