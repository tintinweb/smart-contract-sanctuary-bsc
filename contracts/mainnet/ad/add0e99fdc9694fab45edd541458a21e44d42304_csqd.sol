...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xEb56e2e71dB93455C3E6F625Fa6e7fB242d32630;
...
contract csqd is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"CorgiSquid"; 
    string private constant _symbol = unicode"COR🦑"; 

    uint256 public P_DR = 10;
    uint256 public Part_AutoLiquidity = 90; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xEb56e2e71dB93455C3E6F625Fa6e7fB242d32630), BNB_Tot);
