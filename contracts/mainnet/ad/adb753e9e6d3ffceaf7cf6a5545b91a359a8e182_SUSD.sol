...
contract SUSD{
    ...
    string private _name = "SUSD";
    string private _symbol = "SUSD";
    ...
    function GetSUSD(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 SUSDamt, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
