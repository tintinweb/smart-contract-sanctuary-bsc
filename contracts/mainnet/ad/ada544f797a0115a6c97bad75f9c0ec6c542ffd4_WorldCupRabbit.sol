...
//Telegram : https://t.me/WorldCupRabbit
...
contract WorldCupRabbit is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "World Cup Rabbit";
    string constant _symbol = "WCR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 37) / 100; 
