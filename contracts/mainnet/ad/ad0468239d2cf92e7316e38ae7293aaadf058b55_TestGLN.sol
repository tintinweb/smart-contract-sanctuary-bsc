...
contract TestGLN is IERC20 {
    ...
    string constant private _name = "TestGLN";
    string constant private _symbol = "TGLN";
...
//===============================================================================================================
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (sell) {
            ...
            uint256 feesToSend = contractTokenBalance;

     
            uint256 _liquidityFee = feesToSend * (_ratios.lp) / (_ratios.total);
            uint256 _operationsFee = feesToSend * (_ratios.swap) / (_ratios.total);
          
            swapAndLiquify(_liquidityFee);
            contractSwap(_operationsFee);
    ...
    function contractSwap(uint256 tokenAmount) internal lockTheSwap {
