...
contract kenghuo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Keng Huo";
    string private _symbol = "Keng Huo";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x4c438E8eD58a0001868De41B95f00A58acCa9E14);
