...
contract CreepyElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CreepyElon";
    string private _symbol = "$CREEPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5dDEa62C1dAB21B0b00Bfd76B4Fd6E06bB7482A);
    address payable public BuyBackWalletAddress = payable(0xD5dDEa62C1dAB21B0b00Bfd76B4Fd6E06bB7482A); 
