...
contract FUTR is ERC20Detailed, Ownable {
    ...
    string public _name = "Future";
    string public _symbol = "FUTR";
    ...
    constructor() ERC20Detailed("Future", "FUTR", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration	
        ...
        autoLiquidityReceiver = 0x923C7e1772ab3E7Bc9096c6F1567889fd8bDb1A0; //Wallet 1
        treasuryReceiver = 0xf49eBC7Ffc3231Ad1D9AcF08e2bd81E9e318a7cB; //Wallet 2
        clockInsuranceFundReceiver = 0xaEdD661325Ba984fbcCdf07650F6DA41A8c0bb79; //Wallet 3
        firePit =0xAc3bB31F9dE8647a01fD0499C1F6806e62fd1864; //Wallet 4
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no FUTR token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
