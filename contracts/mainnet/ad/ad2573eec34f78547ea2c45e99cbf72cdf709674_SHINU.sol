...
WE STAND BY WOMEN
SHINU
They say girls are smarter than boys and She Inu is no exception... Shinu 
is a cute, female-guided community coin with 0% tax, 
built for the people. Shinu cares about her degens, and feels our suffering in the current bear... 
Now she’s here to turn things around for everyone.
*/
...
contract SHINU is SHINUDeployer, ContextETH, Ownable {
  
    // common addresses
    address private _owner;
    address private SHINUTeam;
    address private CharitySHINU;
    ...
    string public override name = "SHINU";
    string public override symbol = "SHINU";
    ...
    constructor(uint totalSupplyValue, address SHINUTeamAddress, address CharitySHINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SHINUTeam = SHINUTeamAddress;
        CharitySHINU = CharitySHINUAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SHINUTeam] =  totalSupply * 4 / 100;
        balances[CharitySHINU] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's SHINUTeam pot
