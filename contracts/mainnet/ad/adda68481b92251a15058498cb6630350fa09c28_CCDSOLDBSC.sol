...
/**
 *Submitted for verification at BscScan.com on 2022-16-12
*/

// *Telegram : https://t.me/ccdsoldbsc
// 

// SPDX-License-Identifier: MIT
/*
    CCDS- OLD BSC Token
    10% tax for buy and sell - 3% LP 7% marketing wallet!  NO DEV FEES
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcEcD9c1d237fFdE8C80dE51ccF98B170b460b722; // owner address
...
contract CCDSOLDBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDS";
    string private _symbol = "OLDBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04987f83fd89b95275EA213Bf95b90D62f529CeF); // Marketing Address
    address payable public teamWalletAddress = payable(0xcEcD9c1d237fFdE8C80dE51ccF98B170b460b722); // Team Address
