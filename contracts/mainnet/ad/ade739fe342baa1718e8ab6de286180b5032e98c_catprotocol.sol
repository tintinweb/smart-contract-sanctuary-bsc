...
/**
Telegram : https://t.me/catprotocoll
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfCAc2d0c55E49aB0c844047642Cf747c2cC5275b; // owner address
...
contract catprotocol is Context, IERC20, Ownable {
    ...
    string private _name = "Cat Protocol";
    string private _symbol = "CatPro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfCAc2d0c55E49aB0c844047642Cf747c2cC5275b); // Marketing Address
    address payable public teamWalletAddress = payable(0xfCAc2d0c55E49aB0c844047642Cf747c2cC5275b); // Team Address
