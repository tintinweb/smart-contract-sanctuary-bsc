...
/**
 ...
 |____/   \___/  |____/  |____/  |____/    |_|   /_/   \_\  \____| |_|\_\ |___| |_| \_|  \____|  
...
contract BusdStacking {
    ...
    function CHANGE_DEV1(address value) external {
        require(msg.sender == dev1, "Team use only.");
        dev1 = value;
    }

    function CHANGE_DEV2(address value) external {
        require(msg.sender == dev2, "Team use only.");
        dev2 = value;
    }

    function CHANGE_DEV3(address value) external {
        require(msg.sender == dev3, "Team use only.");
        dev3 = value;
    }

    function CHANGE_MKT_WALLET(address value) external {
        require(msg.sender == mkt, "Team use only.");
        mkt = value;
    }
