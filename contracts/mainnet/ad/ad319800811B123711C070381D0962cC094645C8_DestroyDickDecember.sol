...
// No Nut November is over! Our time begins now! Welcome to Destroy Dick December 🔥

//TELEGRAM :https://t.me/Destroy_Dick_Dec
...
contract DestroyDickDecember is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Destroy Dick December";
