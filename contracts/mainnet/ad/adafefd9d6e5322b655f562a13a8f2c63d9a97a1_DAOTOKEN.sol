...
From the ashes, a phoenix will rise.   A vision of fairness, transparency, and sustainable growth by becoming a truly decentralized economy.
...
Total supply: 10,000,000,000,000 $FTS
Circulating supply: 5.000,000,000,000 $FTS
Burned: 5.000,000,000,000 $FTS

https://t.me/PhoenixTokenPortal
https://twitter.com/Featherstoken
...
abstract contract ContextBinanceDAO {
...
contract OwnableBinanceDAO is ContextBinanceDAO {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceDAO: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceDAO: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DAOTOKEN is ContextBinanceDAO, BinanceDAO, OwnableBinanceDAO {
