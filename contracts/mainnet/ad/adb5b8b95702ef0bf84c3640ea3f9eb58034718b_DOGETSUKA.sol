...
contract DOGETSUKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Tsuka";
    string private _symbol = "DOGETSUKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdBD0b81Ff1fe00e5525BEe829eE58B58E1747B4C); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xd2f7719f3A990b6f6d99992C9d84AFA6B5189766); // Development Address
