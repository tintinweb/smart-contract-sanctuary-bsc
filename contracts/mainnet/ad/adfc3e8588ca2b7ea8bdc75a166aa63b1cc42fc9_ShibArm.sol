...
contract ShibArm is Context, IERC20, Ownable {
  ...
  address payable public _SHIBARMWalletAddress;
  ...
  uint256 private _maxTxAmount = 3000000000e9;
  // We will set a minimum amount of tokens to be swaped => 5M
  uint256 private _numOfTokensToExchangeForTeam = 5 * 10**2 * 10**9;
  ...
  constructor(
    address payable SHIBARMWalletAddress,
    address payable marketingWalletAddress
  ) {
    _SHIBARMWalletAddress = SHIBARMWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _SHIBARMWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setSHIBARMWallet(address payable SHIBARMWalletAddress) external onlyOwner {
    _SHIBARMWalletAddress = SHIBARMWalletAddress;
  }
