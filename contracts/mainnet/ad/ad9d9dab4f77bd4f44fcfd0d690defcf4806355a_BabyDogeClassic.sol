...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb680918cD79b4387ca0770f38c18201BEb6598c4;
...
contract BabyDogeClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Doge Classic"; // 
    string private constant _symbol = "$BabyDogeClassic"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x2dcd2Fa273C27f36a641291DAb4Aa97dD3c9be42);
