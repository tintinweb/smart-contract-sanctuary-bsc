...
contract Neptune is NeptuneDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NeptuneTeam;
    address private CharityNeptune;
    ...
    string public override name = "Neptune Mutual";
    string public override symbol = "Neptune Mutual";
    ...
    constructor(uint totalSupplyValue, address NeptuneTeamAddress, address CharityNeptuneAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NeptuneTeam = NeptuneTeamAddress;
        CharityNeptune = CharityNeptuneAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NeptuneTeam] =  totalSupply * 0 / 100;
        balances[CharityNeptune] = totalSupply * 0 / 100;
    ...
    // Get the address of the token's NeptuneTeam pot
