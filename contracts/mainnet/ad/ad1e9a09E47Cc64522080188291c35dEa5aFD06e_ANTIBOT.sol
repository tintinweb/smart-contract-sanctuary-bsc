...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMath: division by REWARD");
    }
...
contract ANTIBOT is IBEP20, Auth {
    ...
    address REWARD = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;

    string constant _name = "FEGBURN";
    string constant _symbol = "FEGBURN";
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(DEAD)).sub(balanceOf(REWARD));
    }
