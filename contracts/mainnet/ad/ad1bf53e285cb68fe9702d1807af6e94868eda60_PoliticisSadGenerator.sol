...
// https://t.me/PoliticisSadnessGenerator
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1Cf7010B19C9414B95c313665618B9c7D21a446;
...
contract PoliticisSadGenerator is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xE1Cf7010B19C9414B95c313665618B9c7D21a446;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 316 * 3**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Politic is Sadness Generator";
    string private _symbol = "PiSG";
