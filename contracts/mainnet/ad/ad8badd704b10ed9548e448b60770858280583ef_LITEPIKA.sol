...
contract LITEPIKA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Lite Pika";
    string private constant _symbol = unicode"LITEPIKA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xC4af3462672192c72babA5447B004240eb4162f5);
    address payable public MarketingWallet = payable(0xC4af3462672192c72babA5447B004240eb4162f5);
