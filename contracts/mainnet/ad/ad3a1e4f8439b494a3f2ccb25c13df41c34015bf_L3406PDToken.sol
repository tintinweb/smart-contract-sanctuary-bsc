...
/**
 * @title L3406PD | Landshare Holdings LLC - Landshare Parkview Drive - Series 2
 * @author Stobox Technologies Inc.
 * @dev L3406PD BER20 Token | This contract is opt for digital securities management.
 */
 
contract L3406PDToken is IERC20, Roles {
    ...
    modifier onlyWhitelisted(address _account) {
        if (_isDisabledWitelist) {
            require(
                ...
                "L3406PD: not whitelisted address."
            );
        }
        _;
    }
    ...
    modifier onlyWithUnfrozenFunds(address _account) {
        require(
            ...
            "L3406PD: funds are frozen."
        );
        _;
    }

    /**
     * @notice L3406PDToken simply implements a ERC20 token.
     */
    constructor() public Roles(msg.sender) {
        _name = "Landshare 3406 Parkview Drive Security Token";
        _symbol = "L3406PD";
        _decimals = 0;
        _kDecimals = 18;
        _k = 10**_kDecimals;
     ...
     * @param _value L3406PDg that enables or disables the whitelist.
     */
     ...
     * @param _value L3406PDg that enables or disables the transactions limit.
     */
    ...
    function burn(address _account, uint256 _amount) external onlySuperAdmin {
        require(balanceOf(_account) >= _amount, "L3406PD: balance too low");
    ...
    function transferFunds(
        ...
        require(balanceOf(_from) >= _amount, "L3406PD: not enough tokens");
    ...
    function splitOrMerge(uint256 _x, uint256 _y) external onlySuperAdmin {
        require(_x != _y, "L3406PD: _x must not be equal to _y");
        require(_x > 0, "L3406PD: _x must be greater than 0");
        require(_y > 0, "L3406PD: _y must be greater than 0");
    ...
    */
        ...
        returns (bool)
    {
        ...
        _approve(
            ...
            _allowances[_sender][msg.sender].sub(
                ...
                "L3406PD: transfer amount exceeds allowance"
            )
        );
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[msg.sender][_spender].sub(
                ...
                "L3406PD: decreased allowance below zero"
            )
        );
    ...
    function _transfer(
        ...
        require(_sender != address(0), "L3406PD: transfer from the zero address");
        require(_recipient != address(0), "L3406PD: transfer to the zero address");

        _beforeTokenTransfer(_sender, _recipient, _amount);

        _balances[_sender] = _balances[_sender].sub(
            _amount,
            "L3406PD: transfer amount exceeds balance"
        );
    ...
    function _mint(address _account, uint256 _amount) internal virtual {
        require(_account != address(0), "L3406PD: mint to the zero address");
    ...
    function _burn(address _account, uint256 _amount) internal virtual {
        require(_account != address(0), "L3406PD: burn from the zero address");

        _beforeTokenTransfer(_account, address(0), _amount);

        _balances[_account] = _balances[_account].sub(
            _amount,
            "L3406PD: burn amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(_owner != address(0), "L3406PD: approve from the zero address");
        require(_spender != address(0), "L3406PD: approve to the zero address");
    ...
    function _updateTransferLimit(address _account, uint256 _amount) private {
        ...
        _transferLimits[_account].allowedToTransfer = _transferLimits[_account]
            .allowedToTransfer
            .sub(_amount, "L3406PD: transfer exceeds your transfer limit");
    }
    ...
    function _updateTransactionCountLimit(address _account) private {
        if (_isEnabledTransactionCount) {
            ...
            _transactionCountLimits[_account]
                ...
                .sub(1, "L3406PD: transfer exceeds your transaction count limit");
        }
    }
}