...
contract SantaDoge is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x7e5C2221A3C99cAef6F8FC1AFA6C361dA6983208);
    address payable public MarketingWallet = payable(0x7e5C2221A3C99cAef6F8FC1AFA6C361dA6983208);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (_sTxCount > 0) {transferDelay = true;
