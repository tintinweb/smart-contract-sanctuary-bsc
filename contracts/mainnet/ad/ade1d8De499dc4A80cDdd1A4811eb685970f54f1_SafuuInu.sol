...
contract SafuuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafuuInu";
    string private _symbol = "SafInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61A5D5751D4b689d43DDf979061CeafCa6BaFEE9); 
    address payable public buyBackWalletAddress = payable(0x300474eF349da09D12364C0D0bbb67644E4f5349); 
    ...
    uint256 private _totalSupply = 500_000_000_000_000 * 10**9;
    uint256 public _maxTxAmount = 50_000_000_000_000 * 10**9; 
    uint256 public _walletMax = 100_000_000_000_000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 40_000_000_000_000 * 10**9; 
