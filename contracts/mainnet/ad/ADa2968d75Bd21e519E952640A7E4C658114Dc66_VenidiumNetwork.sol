...
// Twitter: https://twitter.com/VenidiumNetwork
*/
...
contract VenidiumNetwork is Context, IERC20 { 
    ...
    string private constant _name = "Venidium Network"; 
    string private constant _symbol = "$VENI"; 
