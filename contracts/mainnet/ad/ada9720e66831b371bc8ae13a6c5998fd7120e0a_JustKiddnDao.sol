...
/* Just Kidd'n DAO
 ...
 - $KIDDN DAPP.  Where humor meets money. Get paid for best jokes, memes, funny videos and even anecdotes. 
   Each of the holders gets a chance to vote for best of the best. And no, we are not rewarding only 1st place, 
   we reward TOP10 funniest things made, sent by community. 

   Please note that self made jokes, memes, videos, etc will be prioritized.

-  We are aiming to find the funniest people on blockchain, and to get them noticed by stand up comedians. 
   Like who wouldn't like to learn from the best. That's why we at launch have onboarded 2 well known stand up comedians, 
   that will take part of our project and will scout for those talents.

-  Weekly and monthly rewards for funniest people. as DAO we will gather all information from voters and reward those who are considered as funniest ones.

   Show Your creativity and let's make this bear market filled with smiles and laughs.

   Telegram - https://t.me/Kiddn_Announcements
...
library Address{
 ...
 contract JustKiddnDao is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xca16AE8759280cc49ffF57f15E53AaF777383270;
    address public donationWallet = 0xca16AE8759280cc49ffF57f15E53AaF777383270;

    string private constant _name = "Just Kiddn DAO";
    string private constant _symbol = "KIDDN";
    ...
    Taxes public taxes = Taxes(0, 2, 2, 2);
    Taxes public sellTaxes = Taxes(0, 2, 2, 2);
