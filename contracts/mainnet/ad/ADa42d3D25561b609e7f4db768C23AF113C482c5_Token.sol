...
contract BaseToken is Ownable {
    ...
    string constant public name = 'CoreDaoCash';

    string constant public symbol = 'CoreCash';
    ...
    uint256 public _burnfeesd = 2;
    uint256 private _previousBurnfeesd = _burnfeesd;


    address public projectAddress = 0x4793a439C6dBB9d431fD548030df760f2a4e43Aa;
