...
contract Test is ERC20, Ownable { //replace ''test with your projects name. No Spaces!
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTranscationAmount = 100000000 * (10**18); //max buy
    uint256 public maxSellTransactionAmount = 100000000 * (10**18); //max sell
    uint256 public maxWalletBalance = 2000000 * (10**18); //max hold
    uint256 public swapTokensAtAmount = 20000 * (10**18); //when contract reaches this amout collected from fees, it will swap to bnb/busd and send rewards/lp/marketing fees
    ...
    uint256 public _busdDividendRewardsFeeBuy = 5; //rewards fee on buy
  ...
  //fees on sell
    ...
    uint256 public sellFeeIncreaseFactor = 100; //marketing fee on buy, set to 1 so this function is not working
    ...
    constructor() ERC20("TRIALTOKEN1", "TRIAL1") { 
        	
    	marketingWallet = 0xA2DA6Cca6c1D107Dee7755932Ce5ccF311f63eb6;  //set your wallet
