...
contract JINSHUINU is Context, IBEP20, Ownable, LockToken {
    ...
    constructor() {
        ...
        _maxWalletBalance = 15000000000 * 10**_decimals; // 1.5% 
        _maxTxAmount = 15000000000 * 10**_decimals; // 1.5%
        _marketingWalletAddress = 0x6c3b23dF3B696Cc8fb7292cfc6DBA025A18157a2; 
        _charityWalletAddress = 0x323d10a11da8f6612159ac96D337c9910a8003CB; 
    ...
    function setSellFeePercent(
        ...
        require(totalSellFee <= 95, "Must keep fees at 20% or less");
    }
    ...
    function setBuyFeePercent(
        ...
        require(totalBuyFee <= 95, "Must keep fees at 20% or less");
    }
