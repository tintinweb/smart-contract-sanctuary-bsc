        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x19B83a6f14F6d71DC1Cc6de1C8dC326927adAe1b), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        10000000000,//Su
        address(0x19B83a6f14F6d71DC1Cc6de1C8dC326927adAe1b),//
        address(0x19B83a6f14F6d71DC1Cc6de1C8dC326927adAe1b)//
    ){
    }
}