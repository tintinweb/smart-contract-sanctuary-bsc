...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1700000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MGAT";
    string private _symbol = "MGAT";
    ...
    address public ownerAddres = address(0xc05BcfAa2C7A493f7c8885e8A25631fE1E1966e2);
    address public devAddress = address(0x9b559cf875fc08FE4A89d49DdDF979F1e80e5407);
    address public foundAddress = address(0xEAff0aC796A9A99e201706574A55fF237281C3C5);
