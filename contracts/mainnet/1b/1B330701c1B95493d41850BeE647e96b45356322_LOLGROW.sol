 ...
 * L O L G R O W 😀😄😂🤑😎
    ...
    LOL is an acronym for the commonly known "Laughing Out Loud"😂
    A popular chat term, familiar to the public😀
    Our project LOL is a meme token, and we want to bring a positive effect that is friendly and brings laughter😄
 
   Telegram: https://t.me/LOLBSC2022
   Twitter: https://twitter.com/LOLBSC2022
   Website: http://lollollol.shop
   Dapp: https://lollollol.us
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x05F4E65d482fc2DAdDcE5d23162DbED35238a47a); //LOL Rewards
...
contract LOLGROW is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "LOLGROW";
    string constant _symbol = "LOLGROW";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x41777E8d6204cb678D5799e77f8d403e6A320eD2;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x05F4E65d482fc2DAdDcE5d23162DbED35238a47a;
