...
contract EnvoMiner is Context, IERC20, Ownable {  
    ...
    address payable public devlopmentWalOne;
    address payable public devlopmentwalleTwo;
    address payable public devlopmentwaletThree;
    address payable public devlopmentwalletFour;
    ...
    constructor () public {
        ...
        devlopmentWalOne=0x277cba1DAE0e6E5267db922E78864D1762B54ce6;
        devlopmentwalleTwo=0xe19ceE233cBF96065eCBF0384BabA8A7093e5F21;
        devlopmentwaletThree=0x4244c4978Ab786c4D74B53Bd5Fff6472c03C5f40;
        devlopmentwalletFour=0x7309C052C40E335DF48FF00737FAA32CF615933c;
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        pancakePair = IPancakeFactory(_pancakeRouter.factory()).createPair(address(this), _pancakeRouter.WETH());
        pancakeRouter = _pancakeRouter;       
        _isExcludedFromFee[devlopmentWalOne] = true;
        _isExcludedFromFee[devlopmentwalleTwo] = true;
        _isExcludedFromFee[devlopmentwaletThree] = true;
        _isExcludedFromFee[devlopmentwalletFour] = true;
         takeMain=_msgSender();
