...
Asther Wallet es una billetera descentralizada que se ejecuta en la red de Binance Smart Chain (BSC). 
Esta billetera le permite almacenar y administrar sus activos digitales de manera segura y confiable, 
sin tener que depender de intermediarios como bancos u otras instituciones financieras.

Una de las características más destacadas de Asther Wallet es su capacidad para proporcionar
a los usuarios un control total sobre sus claves privadas. Esto significa que los usuarios 
son los únicos responsables de la seguridad de sus activos digitales, y no tienen que confiar 
en terceros para mantener su información segura. Además, Asther Wallet utiliza tecnología de 
cifrado de vanguardia para garantizar que sus claves privadas y sus transacciones 
estén protegidas contra el robo y la manipulación.

Otra gran ventaja de Asther Wallet es su facilidad de uso. 
La interfaz de usuario intuitiva y amigable de la billetera
hace que sea fácil para cualquier persona, incluso aquellos
que no tienen experiencia en criptomonedas, acceder y
administrar sus activos digitales. Además, Asther Wallet es
compatible con una amplia gama de criptomonedas y tokens de
la red de Binance Smart Chain, lo que significa que los usuarios
pueden almacenar y administrar todas sus monedas digitales en un solo lugar. 
...
contract astherwallet is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8000 * 10**_decimals;
    uint256 public _maxWalletSize = 420000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x99E3f554FA252CDe9FFdf30c04614b124886c28D;
    address public operationsAddress = 0x99E3f554FA252CDe9FFdf30c04614b124886c28D;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "ASTHER WALLET";
    string private constant _symbol = "ASET";
