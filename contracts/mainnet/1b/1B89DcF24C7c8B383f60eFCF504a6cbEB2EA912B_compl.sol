...
contract compl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PeacePig";
    string private _symbol = "PeacePig";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe63BaECaffC3c072336d2Edb8dac5550AfafaAd1));
        marketingWalletAddress = payable(address(0xe63BaECaffC3c072336d2Edb8dac5550AfafaAd1));
