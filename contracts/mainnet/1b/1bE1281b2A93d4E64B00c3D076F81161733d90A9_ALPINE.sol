...
contract ALPINE is Context, IERC20, Ownable {
    ...
    string private _name = "Alpine F1 Team Fan Token";
    string private _symbol = "ALPINE";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xB55F9fb5512a64ABd4313FFFD78475c0EB52501B);
    address payable public teamWalletAddress = payable(0xB55F9fb5512a64ABd4313FFFD78475c0EB52501B);
