...
contract TokenCompass {
    /*=================================
    =            MODIFIERS            =
    =================================*/
    // only people with tokens
    modifier compassholders () {
        require(myTokens() > 0);
        _;
    }
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "TokenCompassExchange";
    string public symbol = "COMPASS";
    ...
    */
        ...
        returns(uint256)
    {
        ...
        // is the user referred by a Token Compass?
        if(
