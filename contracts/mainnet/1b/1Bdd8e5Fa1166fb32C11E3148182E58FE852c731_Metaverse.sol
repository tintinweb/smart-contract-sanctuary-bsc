...
contract Metaverse {
    ...
    uint public totalSupply = 16180339887000000000000000000 * 10 ** 18; //Coin Supply
    string public name = "BAD Verse"; //Coin Name
    string public symbol = "BAD"; //Coin Symbol 
