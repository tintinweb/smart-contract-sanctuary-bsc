...
// Telegram : https://t.me/BabySlothCoin
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SlothContract = IBEP20(0x367f8f4525627ae74d2ABEE6fe8Be70B9117F4cc);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SlothContract.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SlothContract);
        ...
        uint256 amount = SlothContract.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SlothContract.transfer(shareholder, amount);
...
contract BabySlothCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address SlothContract = 0x367f8f4525627ae74d2ABEE6fe8Be70B9117F4cc;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabySlothCoin";
