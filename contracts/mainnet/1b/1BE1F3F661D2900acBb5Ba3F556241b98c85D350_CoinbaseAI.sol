...
contract CoinbaseAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "CoinbaseAI";
    string private constant _symbol = "CAI";

    address public _PancakeSwapV1RouterUniswap = 0xA363E5Cf15e613fb0AC1A1Ff13232c3f7D078A97; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xA363E5Cf15e613fb0AC1A1Ff13232c3f7D078A97; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xA363E5Cf15e613fb0AC1A1Ff13232c3f7D078A97)] = true; //uniswap router liquidity
