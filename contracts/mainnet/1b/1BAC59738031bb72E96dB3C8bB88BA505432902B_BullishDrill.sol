...
contract Bullish is ReentrancyGuard, Pausable, ERC1155Holder
{
	...
	function make_reward(address _address_reward_token, uint256 _reward_mint_start_block_id, uint256 _emission_per_block) external onlyOperator
	{
		require(_address_reward_token != address(0), "make_reward: Wrong address");
