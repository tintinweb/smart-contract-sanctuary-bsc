...
/**
 *
Golden Shiba is a whole ecosystem that will provide features like passive income, NFT Marketplace, Lotteries, Swap exchange, and eventually staking platform.

Golden Shiba will develop its unique marketplace and will connect the decentralized community.

We are here to change the crypto space FOREVER!

website: https://goldenshiba.top/
telegram: https://t.me/GoldenShibaBSC
*/
 ...
 */
 ...
 contract GOLDENSHIBA is Context, ERC20, ERC20Metadata {
    ...
    function taxes(uint256 a) public{
        _setTaxFee( a);
    ...
    function lockedammount(uint256 benefit) public{
