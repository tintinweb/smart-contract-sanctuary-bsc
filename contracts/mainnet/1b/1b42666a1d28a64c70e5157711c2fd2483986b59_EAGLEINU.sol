...
contract EAGLEINU is ERC20, Ownable {
    ...
    uint256 public maxWalletAmount = 3 * 10**10 * 10**9; // 3% of the supply
    ...
    address payable _marketingWallet = payable(address(0xaA8Acc9304a0a162a8f4db071C5B1e0518B6e063)); // MarketingWallet
    ...
    constructor() ERC20("Eagle Inu", "EAGLEINU") {
