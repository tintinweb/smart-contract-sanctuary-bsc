...
contract Lunomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunomics";
    string private _symbol = "LUNO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0xC36f109FED7A4ECf0Ff45C413DDDf17125B0b42f);
    address payable public teamWalletAddress = payable(0xC36f109FED7A4ECf0Ff45C413DDDf17125B0b42f);
