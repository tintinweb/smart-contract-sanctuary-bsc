...
contract BaseToken is Ownable {
    ...
    string constant public symbol = 'TLABS';
    ...
    function thiccilabsino(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function reroutethichi(address account) public view returns (bool) {
...
contract ThicciLabsCt is BaseToken {
