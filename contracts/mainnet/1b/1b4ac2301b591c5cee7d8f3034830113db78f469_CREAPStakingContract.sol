...
// File: contracts/CREAPPoolInitializable.sol

pragma solidity 0.6.12;

contract CREAPStakingContract is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public CREAP_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == CREAP_POOL_FACTORY, "Not factory");
