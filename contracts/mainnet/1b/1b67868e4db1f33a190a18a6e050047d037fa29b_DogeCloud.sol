...
contract DogeCloud is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeCloud";
    string private _symbol = "DogeCloud";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD161FcB5dD5190B72C1d65bB2325C6465Dc90C0F); // Marketing Address
    address payable public teamWalletAddress = payable(0x7f7167a89339fE1Ec2A2682960c1835a7Df553ec); // Team Address
