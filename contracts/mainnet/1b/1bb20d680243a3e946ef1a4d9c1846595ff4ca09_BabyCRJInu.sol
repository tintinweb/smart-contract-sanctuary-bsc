...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x4E9e342C29ffFCf9f3060A012345e29E3D56359d);
...
contract BabyCRJInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby CR7Inu"; // BabyCRJInu NAME
    string constant _symbol = "Baby Siuuu"; // BabyCRJInu SYMBOL
    uint8 constant _decimals = 9; // DECIMALS

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x4E9e342C29ffFCf9f3060A012345e29E3D56359d;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xfb223e7b50FaD359871ebc6bccee1FaCCc93343c;
        marketingWallet = 0xfb223e7b50FaD359871ebc6bccee1FaCCc93343c; 
        developmentwallet = 0xfb223e7b50FaD359871ebc6bccee1FaCCc93343c;
