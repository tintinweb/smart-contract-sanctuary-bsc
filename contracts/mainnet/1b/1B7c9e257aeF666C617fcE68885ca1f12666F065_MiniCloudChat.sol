...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x0c2bfA54d6d4231b6213803dF616a504767020eA);
...
contract MiniCloudChat is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Mini CloudChat';
    string private constant _symbol = 'Mini CloudChat';
