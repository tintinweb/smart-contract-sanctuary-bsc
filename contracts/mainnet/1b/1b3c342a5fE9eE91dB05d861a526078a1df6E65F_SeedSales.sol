...
contract SeedSales is Ownable, Pausable, ReentrancyGuard {
    ...
    IERC20 public busd;
    address public constant receiverWallet = 0x970997f9dB368246BE9297FB26c66cD4f5532979;
    ...
    function buymehgToken(uint256 _amount) public payable whenNotPaused {
        ...
        require(_amount <= 5000, "BuymehgToken: Amount is greater than maximum purchase of 1500 busd");
        require(MAX_TOKEN_CAP > 0, "Private Sales token is not available");
        require(mehgToken.balanceOf(_msgSender()) <= 125000 * 1e18, "You have already purchased approved tokens limit per wallet");
        ...
        mehgToken.firstBuyTokenHolder(_msgSender(), tokenCalculator * 5/100, true, block.timestamp, block.timestamp, false); // send 7% of the tokens to the buyer
