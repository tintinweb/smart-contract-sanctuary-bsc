...
/**
Shibarium Launchpad Stealth Launch
💹 Telegram https://t.me/shibariumlp
💹 Verified Contract 0x1B039c4641C6e4d0F85848A091fBb9CfE28774d5

Shibarium Launchpad is a cutting-edge NFT minting platform that allows creators to mint, 
sell, and trade unique and valuable NFTs in a user-friendly and secure environment. 
The platform will be built for the upcoming SHIBARIUM blockchain, ensuring that all 
NFTs are secure, decentralized, and verifiable.
...
💹Tax 1%  Buy/Sell  1% Rewards 1% LP Burn
💹Max 1% TXS /Wallet

More info : https://shilaunchpad.com/
🐾 DYOR 🐾Bullish 🐾Degen
*/
...
contract ShibariumLaunchpad is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000000 * 10**5 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Shibarium Launchpad';
    string private _symbol = 'SHILA';
