...
/**           
		...
		10% BUSD rewards (30min) / 2% liquidity. Hold full bag and be Rewarded.
		Will keep liq for 24hrs, non locked. Then either lock or remove.             
...
contract GrandExchange is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FAIL-ZILLA";
    string constant _symbol = "9ZEROES";
    ...
    uint256 _totalSupply = 2_147_483_647 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5c74D83fbe6d295f9f2C8E9FaBE865c0f2acD773;  // teamwallet
        lotteryWallet = 0x5c74D83fbe6d295f9f2C8E9FaBE865c0f2acD773;  // lotterywallet
