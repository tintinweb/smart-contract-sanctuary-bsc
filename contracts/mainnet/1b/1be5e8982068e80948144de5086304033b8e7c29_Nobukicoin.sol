...
contract Nobukicoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nobukicoin";
    string private _symbol = "Nobuki";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4A8a3Abd69A3d43907DFc0488baD2a49ADAe2B72); 
    address payable public BurnedWalletAddress = payable(0x4A8a3Abd69A3d43907DFc0488baD2a49ADAe2B72); 
    ...
    uint256 private minimumTokensBeforeSwap = 48800 * 10**_decimals; 
