...
contract PRT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9A07697274e151383B68C14A58FB86a10b2BBFD8); 
    address payable public Wallet_Dev = payable(0x9A07697274e151383B68C14A58FB86a10b2BBFD8);
    ...
    string private constant _name = "Perrito Inu"; 
    string private constant _symbol = unicode"PRT"; 
    ...
    constructor () {
        ...
        _owner = 0x9A07697274e151383B68C14A58FB86a10b2BBFD8;
