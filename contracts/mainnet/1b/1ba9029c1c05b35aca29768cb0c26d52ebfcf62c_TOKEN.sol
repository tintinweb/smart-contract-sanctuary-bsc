...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxSellAmount = 1000000 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x6d0399bE4f13B6774adDA7961B4dDbB8C007B5E8;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"QianZhuang",//Name
        unicode"QZ",//Symbol
        9,//Decimals
        6188,//Supply
        address(0x6d0399bE4f13B6774adDA7961B4dDbB8C007B5E8),//FundAddress
        address(0x1E5f2592180A7553c6B4Fb4A8344a970251173a7)//ReceiveAddress
    ){
    }
}