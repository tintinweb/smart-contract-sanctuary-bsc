...
contract BABYFGI is ERC20 {
	...
	address payable _fundAddress = payable(address(0x742FaB25Ba7eFc88dd73b3f2DC7400F468E62179));
    ...
    constructor(address tokenOwner) ERC20("BABY Frog Inu", "BABY FGI") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WETH());
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 115792089237316195423570985008687907853269984665640564039457584007913129639935);
