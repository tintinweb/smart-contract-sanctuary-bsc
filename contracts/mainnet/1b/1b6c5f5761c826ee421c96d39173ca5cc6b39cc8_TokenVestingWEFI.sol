...
contract TokenVestingWEFI is IERC20, Context, ReentrancyGuard {
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "TokenVestingWEFI: approve from the zero address"
        );
        require(
            spender != address(0),
            "TokenVestingWEFI: approve to the zero address"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "TokenVestingWEFI: insufficient allowance"
        );
    ...
    function _transfer(
        ...
        require(
            from != address(0),
            "TokenVestingWEFI: transfer from the zero address"
        );
        require(
            to != address(0),
            "TokenVestingWEFI: transfer to the zero address"
        );
        require(
            _balances[from] >= amount,
            "TokenVestingWEFI: transfer amount exceeds balance"
        );
    ...
    function createVestingSchedule(
        ...
        require(
            ...
            "TokenVestingWEFI: token WEFI transferFrom not succeeded"
        );
        _createVestingSchedule(
            _beneficiary,
            _start,
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "TokenVestingWEFI: token WEFI rewards transfer to beneficiary not succeeded"
        );
