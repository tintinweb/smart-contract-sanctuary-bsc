...
contract Elizabeth is Context, IERC20, Ownable {
    ...
    string private _name = "Elizabeth ll";
    string private _symbol = "Elizabeth ll";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xbB4C928FE565bd762D4e0b92054ceB8BD0EcE064); // Marketing Address
    address payable public teamWalletAddress = payable(0xbB4C928FE565bd762D4e0b92054ceB8BD0EcE064); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xbB4C928FE565bd762D4e0b92054ceB8BD0EcE064),
            block.timestamp
        );
    }
