...
contract KekZilla is IBEP20, Auth {
    ...
    address DEV = 0xce28c931bDb5bcac77dBcb82D94e5711fe70E526;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 9000 / 10000; //2%
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 9000 ) / 10000; // 2%
