...
/* Blame Aleek For This Moonshot. Grimace Rewards For Holding.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  GRIM = IBEP20(0x0B92741315Ce565849b440354a010Ed346Cf2Fb7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GRIM.balanceOf(address(this));
        ...
        uint256 amount = GRIM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GRIM.transfer(shareholder, amount);
...
/* Token contract */
contract ForExample is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address GRIM = 0x0B92741315Ce565849b440354a010Ed346Cf2Fb7; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0C214Eb48Cf5e044Ad186aA2Bf0F13bAd1E7dB10;
    ...
    // Name and symbol
    string constant _name = "For Example";
    string constant _symbol = "FOREXAMPLE";
