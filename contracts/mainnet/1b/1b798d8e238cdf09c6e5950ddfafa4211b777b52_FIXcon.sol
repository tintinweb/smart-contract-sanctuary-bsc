...
contract FIXcon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fix";
    string private _symbol = "Fix";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2556F37A36D9295a75e97B3308C8C77498BC04cB); 
    address payable public BurnedWalletAddress = payable(0x2556F37A36D9295a75e97B3308C8C77498BC04cB); 
