...
contract JokerCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x179DFCA4186D72bD355bDAFA7851c5e2d2332E95); 
    address payable public Wallet_Dev = payable(0x179DFCA4186D72bD355bDAFA7851c5e2d2332E95);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x179DFCA4186D72bD355bDAFA7851c5e2d2332E95); 
    ...
    string private constant _name = "JokerCat"; 
    ...
    constructor () {
        ...
        _owner = 0x179DFCA4186D72bD355bDAFA7851c5e2d2332E95;
