...
contract USDCMINER {
    ...
    uint256 constant launch = 1678197600;  // 7th Mar 2023 UTC: 2 PM UTC
    ...
    constructor() {
            owner = address(0xF24362C2be0E2d397d0fb7D5fb4269A2DBd0b8B2);
            dev = address(0xF24362C2be0E2d397d0fb7D5fb4269A2DBd0b8B2);
            PercsKey[10] = DivPercs(864000, 40);
            PercsKey[20] = DivPercs(1728000, 50);
            PercsKey[30] = DivPercs(2592000, 60);
            PercsKey[40] = DivPercs(3456000, 70);
            PercsKey[50] = DivPercs(4320000, 80);
            FeesKey[10] = FeesPercs(864000, 600);
            FeesKey[20] = FeesPercs(1728000, 500);
            FeesKey[30] = FeesPercs(3456000, 400);
            FeesKey[40] = FeesPercs(4320000, 300);
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        USDC.safeTransfer(owner, stakeFee * 8/10);
        USDC.safeTransfer(dev, stakeFee * 2/10);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        USDC.safeTransfer(owner, withdrawFee * 8/10);
        USDC.safeTransfer(dev, withdrawFee * 2/10);
