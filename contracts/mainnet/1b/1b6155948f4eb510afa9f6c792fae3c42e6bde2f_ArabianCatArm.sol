...
contract ArabianCatArm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian Cat Arm";
    string private _symbol = "Arcarm";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5B87E51A8408AC126F203Da3098913bdF987310B);
    address payable public BuyBackWalletAddress = payable(0x5B87E51A8408AC126F203Da3098913bdF987310B);
