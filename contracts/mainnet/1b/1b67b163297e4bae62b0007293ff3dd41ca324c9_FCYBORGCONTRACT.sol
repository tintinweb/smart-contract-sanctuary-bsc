...
/**
Telegram :
https://t.me/FlokiCyborg
Twitter :
https://twitter.com/FlokiCyborg
Website :
https://flokicyborgswap.finance
*/
...
contract FCYBORGCONTRACT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Cyborg";
    string private _symbol = "FCYBORG";
