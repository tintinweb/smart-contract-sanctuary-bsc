...
function requestTokens(uint8 _slice) public {
  require(gasleft() > 200000, "Not enough gas to execute the function");
    ...
    tokenInstance.transfer{gas: 210000}(msg.sender, tokenAmount);
    lastAccessTime[msg.sender] = block.timestamp + waitTime;
}

function allowedToWithdraw(address _address) public view returns (bool) {
    require(gasleft() > 20000, "Not enough gas to execute the function");
