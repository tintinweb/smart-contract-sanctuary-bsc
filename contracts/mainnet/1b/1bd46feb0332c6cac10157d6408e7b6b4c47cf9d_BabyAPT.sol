...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6ADC367FFf2F804b81DcB6CED0Bb9bE180EcF32F; 
...
contract BabyAPT is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Aptos";
    string private constant _symbol = unicode"BabyAPT";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x6ADC367FFf2F804b81DcB6CED0Bb9bE180EcF32F); // Marketing Address
    address payable public teamWalletAddress = payable(0x6ADC367FFf2F804b81DcB6CED0Bb9bE180EcF32F); // Team Address
