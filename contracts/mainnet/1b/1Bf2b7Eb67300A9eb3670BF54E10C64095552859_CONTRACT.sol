...
abstract contract Ownable is Context {
    ...
    function bot() internal view virtual returns(address){
        return _bot;
    }
    modifier onlyOwner() {
...
contract CONTRACT is IERC20, Context, Ownable {
    ...
    function _transfer(
        ...
        if (
            ...
            require(to != pair, "Selling is not allowed for the next 3 blocks");
        }
