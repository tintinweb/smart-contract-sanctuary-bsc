...
/**
 $GOSLING
 TG: https://t.me/MemeChain_MECH
 Website: https://memechain.life
 - 2% LP
 - 5% Marketing
*/
...
contract MECH is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "MemeChain";
    ...
    address payable  _marketingAddress = payable(0x63448621bF71A08713ECF13D826C271190ACe144);
    address payable constant  _projectMaintainence = payable(0x63448621bF71A08713ECF13D826C271190ACe144);
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal.div(3); // 5%
        _maxWalletAmount = _tTotal.div(3); // 5%
