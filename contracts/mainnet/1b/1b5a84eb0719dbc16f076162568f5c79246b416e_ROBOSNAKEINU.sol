...
abstract contract Ownable is Context {
     ...
     */    
    constructor () {
        _owner = 0x56E0a8AdA9123C1998BC348A2EFd0c5682571E2d;
...
contract ROBOSNAKEINU is Context, IERC20, Ownable { 
    ...
    string private _name = "RoboSnake Inu"; 
    string private _symbol = "ROBOSNAKE";  
    ...
    address payable private Wallet_Dev = payable(0x56E0a8AdA9123C1998BC348A2EFd0c5682571E2d);
    ...
    function setStatusON() external onlyOwner() {
        getRewards = true;
    }
    
        function setStatusOFF() external onlyOwner() {
        getRewards = false;
    }
