...
contract greenfrog is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "green frog";
   string constant _symbol = "gf";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 2000; // 0.5%
...
uint256 reflectionFee = 0;
   ...
   uint256 public swapThreshold = _totalSupply / 100; // 0.5%
   bool inSwap;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x93f971A4f63eC2909dB832A1A14Ffe16A53b1A11; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x93f971A4f63eC2909dB832A1A14Ffe16A53b1A11; //Can be change to any wallet you want
       marketingFeeReceiver = 0x93f971A4f63eC2909dB832A1A14Ffe16A53b1A11; //Can be change to any wallet you want
