...
contract WORLDCUPFLOKI is ERC20, Ownable {
    ...
    constructor() ERC20("WORLD CUP FLOKI", "QATAR") {
        address newOwner = 0xdff76E3A68A516B68054938636a78cc279568862;
        ...
        TeamAddress1 = 0xCD7fcE6AF33c6Ea9a31346E08E88F296646Fe287;
        TeamAddress2 = 0x9E5FE3A8cB5FDCf88A5Ccd92FB2A76f8c8c14322;
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _team4Fee, uint256 _devFee, uint256 _communityeventsFee, uint256 _speacialeventsFee, uint256 _team1Fee, uint256 _team2Fee, uint256 _team3Fee) external onlyOwner {
        ...
        sellTeam1Fee = _team1Fee;
        sellDevFee = _devFee;
        sellCommunityEventsFee = _communityeventsFee;
        sellSpeacialEventsFee = _speacialeventsFee;
        sellTeam2Fee = _team2Fee;
        sellTeam3Fee = _team3Fee;
        sellTeam4Fee = _team4Fee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on buy
                ...
                tokensForTeam2 += fees * buyTeamFee2 / buyTotalFees;
                tokensForTeam3 += fees * buyTeamFee3 / buyTotalFees;
                tokensForTeam4 += fees * buyTeam4Fee / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForTeam4 = ethBalance * tokensForTeam4 / totalTokensToSwap;
        uint256 ethForCommunityEvents = ethBalance * tokensForCommunityEvents / totalTokensToSwap;
        uint256 ethForSpeacialEvents = ethBalance * tokensForSpeacialEvents / totalTokensToSwap;

        ethForLiquidity -= ethForMarketing + ethForDev + ethForTeam4 + ethForSpeacialEvents + ethForCommunityEvents;

        uint256 ethForTeam = ethBalance * tokensForTeam1 / totalTokensToSwap;
        (success,) = address(TeamAddress1).call{value: ethForTeam}("");
        ethForLiquidity -= ethForTeam;

        ethForTeam = ethBalance * tokensForTeam2 / totalTokensToSwap;
