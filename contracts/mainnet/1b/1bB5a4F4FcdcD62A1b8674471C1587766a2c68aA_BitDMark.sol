...
contract BitDMark is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 30 * 10**6 * 10**9; // 30 Million
    ...
    uint256 public _maxTxAmount = 20 * 10**6 * 10**9; // Max Transaction: 10 Million
    uint256 public _numTokensSellToAddToLiquidity = 138000840 * 10**3;
    uint256 public _maxWalletToken = 20 * 10**6 * 10**9; // Max Wallet: 10 Million
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'BitDMark';
    string private _symbol = 'BDMC';
