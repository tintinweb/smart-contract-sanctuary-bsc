...
contract XRPBoy is IBEP20, Auth {
    ...
    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1t 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 3 / 100; // 1.5% on launch or 15000 tokens
    uint256 public _maxSellTxAmount = _totalSupply * 3 / 100; // 1% or  10000 tokens
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100; // 1.5 % or 15000 tokens
