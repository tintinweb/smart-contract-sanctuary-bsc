...
/**  // SPDX-License-Identifier: Unlicensed
     Telegram : https://t.me/smurfwizard
...
contract SmurfWizard is Context, IERC20, Ownable {
    ...
    string private _name = "Smurf Wizard";
    string private _symbol = "SWizard";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0x409B959B5dAfCf99663406C6588A35ca713C8B50);
