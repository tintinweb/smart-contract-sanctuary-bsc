...
/**
Telegram : https://t.me/WorldPeaceInuBsc

DADDY WORLD PEACE INU ON ETH SITTING AT 2 MILLIONS RN. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B5E8698Ea552c0782C3827E1F35B37588a4F9b0; // owner address
...
contract WorldPeaceInu is Context, IERC20, Ownable {
    ...
    string private _name = "World Peace Inu";
    string private _symbol = "WPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB4F31b18752876Ed76BC92B69ae448877977471); 
    address payable public teamWalletAddress = payable(0xbB4F31b18752876Ed76BC92B69ae448877977471); 
