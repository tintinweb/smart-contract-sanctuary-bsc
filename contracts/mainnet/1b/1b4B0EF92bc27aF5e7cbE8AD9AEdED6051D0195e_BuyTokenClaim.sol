...
contract BuyTokenClaim is Owned {
    ...
    constructor(){
        //Buy
        address _token_address = address(0x905f536f399F016348F0D6eCb95dbaAE6BcB99A4);
        uint256 _min_value = 1;
        uint256 _price = 1000000;
        uint256 _receive_buy = 6;
        uint256 div_price = 1;
        ...
        initBuyToken(_token_address, _min_value, _price, div_price,_receive_buy, time_start, time_end);
    }
 
    function initBuyToken(address _token_address, uint256 _min_value, uint256 _price, uint256 div_price, uint256 _receive_buy,uint256 time_start, uint256 time_end) public onlyOwner{
        token_address = _token_address;
        receive_buy=_receive_buy;
    ...
    function buyToken(address _token_address, uint256 referral_code) payable public returns(bool) {
        ...
        token.transferFrom(address_owner, msg.sender, amount_buy*receive_buy / 100);
