...
contract SafeMoonTv   is Context, IERC20, Ownable {
    ...
    string private _name = " SafeMoon Tv ";
    string private _symbol = " SMT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2959B7d405b3a5B69099792AE0Ae5b0289baB05f); 
    address payable public teamWalletAddress = payable(0x2959B7d405b3a5B69099792AE0Ae5b0289baB05f); 
