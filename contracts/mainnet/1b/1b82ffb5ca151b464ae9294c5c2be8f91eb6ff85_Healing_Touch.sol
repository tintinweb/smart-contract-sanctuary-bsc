...
contract Healing_Touch is Context, Ownable, IERC20 {
    ...
    string private _name = "Healing Touch Token";
    ...
    address payable public burnWallet = payable(0x2b6CD297e328Eff5Da523aBF2a884906Dfc90f06);
    address payable public marketingWallet = payable(0x2b6CD297e328Eff5Da523aBF2a884906Dfc90f06);
    address payable public liquidityWallet = payable(0x2b6CD297e328Eff5Da523aBF2a884906Dfc90f06);
    address payable public airdropWallet = payable(0x2b6CD297e328Eff5Da523aBF2a884906Dfc90f06);
