...
contract SpaceCake is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Space Cake";
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x955aB89358F5F5151ccc83C64627b40f4be531D8;  
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(5).div(8);
