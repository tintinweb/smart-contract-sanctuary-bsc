...
interface IRewarder {
    using BoringERC20 for IERC20;
    function onBonusReward(uint256 pid, address user, address recipient, uint256 sushiAmount, uint256 newLpAmount) external;
...
contract RewarderMock is IRewarder {
    ...
    function onBonusReward (uint256, address user, address to, uint256 sushiAmount, uint256) onlyMCV2 override external {
...
contract RewarderBrokenMock is IRewarder {
    ...
    function onBonusReward (uint256, address, address, uint256, uint256) override external {
        revert();
    }
