...
/*
.::.  :~!^.  ...
                                  !5PP555Y5P555PY5PPPPJ:
                                ^B&GGB#BG5JPBBG?JPGBBGB#Y55J^
                               [email protected]&@@@@@@@@@@@@@@@@@@@&&@@@@@^
                               .#@@@@@@@@@@@@@@@@@@@@@@@@@@@#:
                                [email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@G.
                                 ^5#@@@@@&@@@@@@@@@@@@@@@@@@@G.
                                   ...
                                   .^!YG#@@&   .^7YG&@@G  .&@@:[email protected]@G
                                ~?P#@@@@@@@#!JP#@@@@@@@B^^~&@@[email protected]@B^
                               :&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#:
                               :&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&:
                               :&@@@@Y.:[email protected]@@@@@@Y.:[email protected]@@@@P.:[email protected]@@&:
                               :&@@@@[email protected]@@@@@@[email protected]@@@@[email protected]@@&:
                               :&@@@@[email protected]@@@@@@[email protected]@@@@#[email protected]@@&:
                               :&@@@@Y . [email protected]@@@@@@J . [email protected]@@@@P . [email protected]@@&:
                               .&@@@@&#&#&@@@@@@@&#&#&@@@@@&#&#&@@@&.
                               ^&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&^
                              P&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&P
                              ~!~~~~~~~~!~
...
Token: Magic Internet Beans
A FACT Reward Token. Coin Factory: Where Safe Meme Coins Are Born.
Ticker: BEANS
Max Wallet: 1% at launch.
Telegram: https://t.me/magicinternetbeans
Twitter: https://twitter.com/MagicBeansbsc
Website: https://www.magicbeansbsc.com/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x261CA43C7a39f761581ed810c3A6759eC10945dd);
...
contract MagicInternetBeans is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x261CA43C7a39f761581ed810c3A6759eC10945dd;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Magic Internet Beans";
    ...
    //max wallet holding of 1% for launch
