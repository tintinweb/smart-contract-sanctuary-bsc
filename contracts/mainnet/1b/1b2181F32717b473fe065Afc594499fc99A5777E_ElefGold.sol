...
contract ElefGold is ERC20, Ownable, ReentrancyGuard {
    ...
    function release(uint256 reward) internal {
        require(totalSupply() + reward <= maxSupply, "Cannot release more tokens!");
    ...
    function stake50() public {
        ...
        require(totalSupply() < maxSupply, "You cant stake anymore!");
