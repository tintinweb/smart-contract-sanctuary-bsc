...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbF4706D1393388DDD4C8193989f287Cc3Ce99913; // owner address
...
contract SquidGrinch is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGrinch";
    string private _symbol = "SquidGrinch";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbF4706D1393388DDD4C8193989f287Cc3Ce99913); // Marketing Address
    address payable public teamWalletAddress = payable(0xbF4706D1393388DDD4C8193989f287Cc3Ce99913); // Team Address
