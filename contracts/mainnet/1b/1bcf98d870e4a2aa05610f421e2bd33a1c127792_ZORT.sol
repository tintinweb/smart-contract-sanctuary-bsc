...
/**
 * @title ZORT ERC20 token
 * @dev  
 *      The goal of ZORT is to Go Up Higher in price over time.
 *      Based on the Ampleforth protocol.
 */
contract ZORT is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("Zart Zort", "ZORT", uint8(DECIMALS))
        public
    {
