...
library Address{
 ...
 contract WeenMoon is Context, IERC20, Ownable {
    ...
    address public devwallet = 0xfB5EACB7beB4e1c6d74598693Beda5a49176536d;
    address public marketingWallet = 0x71f8FF9502D2eB6F96BF1e1325Dc75458065Be84;
    address public donationWallet = 0x0836DAc348019fe475FdB2C6a7b6011E4d10764e;

    string private constant _name = "WeenMoon";
    string private constant _symbol = "WEENMOON";
    ...
    Taxes public taxes = Taxes(2, 4, 1, 2);
    Taxes public sellTaxes = Taxes(2, 4, 1, 2);
