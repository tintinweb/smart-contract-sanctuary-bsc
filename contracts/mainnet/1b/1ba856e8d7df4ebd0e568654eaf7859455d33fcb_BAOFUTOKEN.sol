...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0x1877C28C9222E87658323EBE47B7533bd7aE7436);
...
contract BAOFUTOKEN is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 588 * 1e18;
    ...
    constructor() ERC20("BAOFU TOKEN", "BF", 18) DividendFee() {
