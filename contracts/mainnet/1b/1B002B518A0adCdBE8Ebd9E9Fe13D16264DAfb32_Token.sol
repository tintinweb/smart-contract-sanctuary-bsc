        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x9eB941acaC409F39183f2806203542f972B5A8E0), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        "Chinese Football Association",//Name
        "CFA",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address(0xD5CAfA30eEF80fBb404d2Df757f308Ecbf9d35aB),//FundAddress
        address(0x14237994381ab02221ffE2841c695cCE950E0B26)//ReceiveAddress
    ){
    }
}