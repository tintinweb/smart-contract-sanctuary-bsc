...
contract Sphynx is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD24ed0cd5dE9E0e55C1B254e260F5AEf69d4981E); 
    address payable public Wallet_Dev = payable(0xD24ed0cd5dE9E0e55C1B254e260F5AEf69d4981E);
    ...
    string private constant _name = "Sphynx Inu"; 
    ...
    constructor () {
        ...
        _owner = 0xD24ed0cd5dE9E0e55C1B254e260F5AEf69d4981E;
