...
🐱 2% LP
🐶 1% Dev Wallet 
🐈‍⬛ Renounced, Verified and Locked. (Links at launch)

📱 TG: https://t.me/DogeVSCats
...
contract _DOGEvsCATS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x318df1acaEc7a85c6fEce79e209DBAA9F8ce8869); 
    address payable public Wallet_Dev = payable(0x318df1acaEc7a85c6fEce79e209DBAA9F8ce8869);
    ...
    string private constant _name = "DOGEvsCATS"; 
    string private constant _symbol = unicode"DOGE VS CATS"; 
    ...
    constructor () {
        ...
        _owner = 0x318df1acaEc7a85c6fEce79e209DBAA9F8ce8869;
