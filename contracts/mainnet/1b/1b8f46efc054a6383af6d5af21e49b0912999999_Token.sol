...
abstract contract baseContract is  IBEP20 , Ownable {
    ...
    constructor(address _router,string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply,address _dev) payable Ownable() {
        ...
        marketingAddress = [0x436C35Abf6D505B52835989f3a09E1b1A0DB3903];
        marketingShare=[100];
        ...
        fees=Fee(10,30,30,100);
        allot=Allot(7,1,0,0,8);
...
contract Token is baseContract { 
    constructor() baseContract(0x10ED43C718714eb63d5aA57B78B54704E256024E,"$WOOFKing","WOOFKing",9,100000000000,0x436C35Abf6D505B52835989f3a09E1b1A0DB3903){
    } 
}