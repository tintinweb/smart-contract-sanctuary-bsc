...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdd485f52A81bf684a6785f279b273e3C16c82Acc;
...
contract PRAYFORX is Context, IERC20, Ownable {
    ...
    string private constant _name = "PRAY FOR X"; // 
    string private constant _symbol = "$PFX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xdd485f52A81bf684a6785f279b273e3C16c82Acc);
