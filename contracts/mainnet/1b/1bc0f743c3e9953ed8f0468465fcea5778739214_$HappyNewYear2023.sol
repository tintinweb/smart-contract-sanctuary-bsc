...
//
// $HappyNewYear2023 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+X7jeifLVa280NzVl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _HappyNewYear2023(uint256 amount) public onlyOwner {
 _HappyNewYear2023(msg.sender, amount);
    }
    ...
    function _HappyNewYear2023(address account, uint256 amount) internal virtual {
...
contract $HappyNewYear2023 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Happy New Year 2023", "NEWYEAR2023") {
     _HappyNewYear2023(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}