...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCc23f4f53A13d47dD6D808d343d8CFcb2255Fa0F; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Moon Mechazilla";
    string private _symbol = "smMechazilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5aF00602E53aBa64FF1304DEB635a1023Fef18a); // Marketing Address
    address payable public teamWalletAddress = payable(0xC5aF00602E53aBa64FF1304DEB635a1023Fef18a); // Team Address
