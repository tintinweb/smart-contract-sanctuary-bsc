...
contract Anoge is Context, IERC20, Ownable, Pausable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anoge Token";
    string private _symbol = "Anoge";
    ...
    address payable public treasuryAddress = payable(0x4D65D7eC56438873638C1780b3Bd5b7E4eaBBFa1);
    address payable public burnAddress = payable(0xB2aE5f8447A879a1BD60bA99401C778882a51a08);
