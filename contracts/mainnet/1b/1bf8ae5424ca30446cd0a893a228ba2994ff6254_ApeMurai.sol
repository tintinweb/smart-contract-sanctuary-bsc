...
ApeSamurai Bullish name ready to shake BinanceSmartChainnnn
...
contract ApeMurai is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7626e8c22c07CEe965A82f45E2db6C2D6fdB08eE); 
    address payable public Wallet_Dev = payable(0xFb944AF80e3caAfcb723FB19212cbcc4730ebE76);
    ...
    string private constant _name = "ApeMurai"; 
    string private constant _symbol = unicode"APEM"; 
    ...
    constructor () {
        ...
        _owner = 0xFb944AF80e3caAfcb723FB19212cbcc4730ebE76;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xFb944AF80e3caAfcb723FB19212cbcc4730ebE76); // Testnet
