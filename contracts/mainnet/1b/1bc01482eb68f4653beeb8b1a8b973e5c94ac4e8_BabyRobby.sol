...
contract BabyRobby is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Robby";
    string private _symbol = "BabyRobby";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDd2AcD3E583457c73A5EEa76735565086C39Bb7A); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xDd2AcD3E583457c73A5EEa76735565086C39Bb7A); // Team Address
