...
/* 
	* Crypto Monsters
	* Tokenomics:
	* 4% Tax (2% Liquidity, 2% Distributed to Investors)
	*
	* Total Supply: 200
	* Max Buy: 200 (~1.0% of Total Supply)
	* Max Hold: 200 (~1.0% of Total Supply)
	*/
	...
	contract CryptoMonsters is Context, IBEP20, Ownable {
	    ...
	    uint256 private constant _tTotal = 2 * 10**5 * 10**6; // 200
	    ...
	    uint256 public _maxTxAmount = 2 * 10**5 * 10**4; // Max Transaction: 2 Million (1%)
	    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**5 * 10**4;
	    uint256 public _maxWalletToken = 2 * 10**5 * 10**4; // Max Wallet: 2 Million (1%)
	    
	    IPancakeRouter02 public immutable pcsV2Router;
	    address public immutable pcsV2Pair;
	
	    string private _name = 'Crypto Monsters';
	    string private _symbol = 'Monsters';
