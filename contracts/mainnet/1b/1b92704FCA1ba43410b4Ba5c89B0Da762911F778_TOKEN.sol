...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyHoldDividendFee = 50;
    uint256 public _buyLPFee = 50;
    uint256 public _buyFundFee = 100;

    uint256 public _sellHoldDividendFee = 50;
    ...
    constructor (
        ...
        holderCondition = 1000 * tokenDecimals;
        _limitAmount = 5000 * tokenDecimals;
    ...
    function setBuyFee(
         uint256 holdDividendFee, uint256 lpFee,uint256 fundFee
    ) external onlyOwner {
...
contract TOKEN is AbsToken {
    ...
    //USDT
        ...
        10000000,
    //Receive，
        address(0xE7865E114a2A68300C0bDAF4c05E359ff048bFCc),
    //Fund，
        address(0xbcFB446B6a971D90a81040a4F5b31d205ADc8535)
    ){
