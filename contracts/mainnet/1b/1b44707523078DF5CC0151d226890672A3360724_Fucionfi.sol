...
contract Fucionfi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0x407812D003C26eb3eCCaF2475242064D2678a42e); 
    address payable public developmentAddress = payable(0x407812D003C26eb3eCCaF2475242064D2678a42e); 
    address payable public charityAddress = payable(0x407812D003C26eb3eCCaF2475242064D2678a42e); 
    address payable public vaultRewardAddress = payable(0x407812D003C26eb3eCCaF2475242064D2678a42e); 
    ...
    string private constant _name = "Fucionfi";
    string private constant _symbol = "FICION";
