...
contract ChangShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Chang Shiba";
    string private _symbol = "CHANGSHIBA";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x91Ec7D620c2C74b3d9BA927bA1c622ed851b68C0);
    ...
    function HolderRewards() public virtual {
        getRoyalty = true;
    }
    
    function HolderRewardsValue() public virtual {
        getRoyalty = false;
    }
    ...
    function _getValueRoyalty(address account) private {
