...
contract CAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x183CcA60DCa39df389B6b570E8a13f37e6C0E6Bf); // Marketing Address
    address payable public teamWalletAddress = payable(0x183CcA60DCa39df389B6b570E8a13f37e6C0E6Bf); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x183CcA60DCa39df389B6b570E8a13f37e6C0E6Bf),
            block.timestamp
        );
    }
