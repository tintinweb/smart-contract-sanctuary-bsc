...
contract bababa is Context, IERC20, Ownable {
    ...
    function setprocesTanChuangIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
    ...
    function safeTransfer(uint256 maxWallPercent) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxWallPercent) / 1280;
    }
    ...
    function totalfeeMultiplied() public view returns (uint256) {
