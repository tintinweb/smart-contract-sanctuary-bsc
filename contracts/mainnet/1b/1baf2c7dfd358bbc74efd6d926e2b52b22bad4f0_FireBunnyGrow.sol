...
contract FireBunnyGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FireBunnyGrow";
    string private _symbol = "$FBGrw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x711C0e0e71787F6D26814579C251b3f0F8d34C15); // Marketing Address
    address payable public devWalletAddress = payable(0x711C0e0e71787F6D26814579C251b3f0F8d34C15); // Dev Address
