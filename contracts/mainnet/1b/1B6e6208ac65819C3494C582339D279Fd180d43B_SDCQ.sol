...
contract SDCQ is IERC20, Ownable {
    ...
    string private _name = "SDCQ";
    string private _symbol = "SDCQ";
    ...
    uint256 public processAmount = 1 * 10**9;
    

    uint256 currentIndex;  
    uint256 private _tTotal = 2139688 * 10**18;
    ...
    constructor() {
        address should = 0x438a131d9CE91eD125375C33bEf3043F1929d0C5;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function setProcessAmount(uint256 number) public onlyOwner {
    ...
    function _tokenToTransfer(
        ...
        _takewlletFee(sender,deadAddress , amount.div(10000).mul(_burnFee),_burnFee);
        uint256 recipientRate = 10000 - _burnFee;
    ...
    function _takeInviterFee(
        ...
        if (sender == uniswapV2Pair) {
            ...
            _tOwned[deadAddress] = _tOwned[deadAddress].add(tAmount.div(10000).mul(_inviterFee));
            emit Transfer(sender, deadAddress, tAmount.div(10000).mul(_inviterFee));
            return;
        }

        uint256 accurRate;
		uint16[2] memory inviteRate = [300, 200];
    ...
    function _transferStandard(
        ...
        uint256 recipientRate = 10000 - _LPFee - _inviterFee;
