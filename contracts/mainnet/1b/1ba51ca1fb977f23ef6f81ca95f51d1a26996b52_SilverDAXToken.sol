...
/* 
SilverDAX Token
SilverDAX token of the year
☎️Telegram ✨ t.me/SilverDAX
...
abstract contract ContextSilverDAXBep20 {
...
contract OwnableSilverDAXBep20 is ContextSilverDAXBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableSilverDAXBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSilverDAXBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SilverDAXToken is ContextSilverDAXBep20, SilverDAXBep20, OwnableSilverDAXBep20 {
    ...
    string private _name = 'Silver DAX';
    string private _symbol = 'Silver DAX';
