...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'NiaoB';
    string private _symbol = 'NiaoB';
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000000000000 * 10**uint256(_decimals);

    address private _fundAddress = 0x38DcAB1F980D99F193D5a1263500A75B3e2afb5f;
    ...
    constructor () public {
        ...
        _isExcludedFromFee[0x38DcAB1F980D99F193D5a1263500A75B3e2afb5f] = true;
        _isExcludedFromFee[0x8a9e7031FA7A293f54Aa9Fb7bAce0f361d277Ef5] = true;
        _isExcludedFromFee[0x175A29FacB5F2A8bec44Be95feD7E907c6d7f2e1] = true;

        _balances[0x8a9e7031FA7A293f54Aa9Fb7bAce0f361d277Ef5] = _totalSupply;

        emit Transfer(address(0), 0x8a9e7031FA7A293f54Aa9Fb7bAce0f361d277Ef5, _totalSupply);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
       ...
       if(sender != uniswapV2Pair && !_isExcludedFromFee[sender]){
        uint256 minHolderAmount = balanceOf(sender).mul(9999).div(10000);
