...
contract ETH9527 is Context, Ownable {
    using SafeMath for uint256;

    string _name = "ETH9527";
    string _symbol = "ETH9527";
    uint8 _decimals = 9;
    ...
    function whileETH9527(uint8 liquidityFee) external onlyOwner {
        liquidityFees = liquidityFee;
    }
   
    function Autostorage(uint8 marketingFee) external onlyOwner {
        marketingFees = marketingFee;
    }
  
    function Zoomkeccak256(uint8 rewardFee) external onlyOwner {
