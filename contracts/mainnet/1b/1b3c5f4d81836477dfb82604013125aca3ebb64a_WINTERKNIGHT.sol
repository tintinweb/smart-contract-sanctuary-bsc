...
contract WINTERKNIGHT is IBEP20, Auth {
    ...
    string constant _name = "Winter Knight";
    string constant _symbol = unicode"WKNIGHT";
    ...
    // Exclude bots
    function BulkIsBlacklisted(address _address, bool _value) public onlyOwner{
