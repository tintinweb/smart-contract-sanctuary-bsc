...
contract BootstrapReward is Ownable {
    using SafeERC20 for IERC20;

    IERC20 public immutable rewardToken;
    bytes32 public immutable merkleRoot;
    mapping(address => uint256) public rewardReceived;
    uint256 public immutable endRewardTime;
    ...
    function claimRewards(
        ...
        require(_isValid, "BootstrappingReward::claimRewards: Incorrect proof");
        require(_claimableRewards > 0, "BootstrappingReward::claimRewards: No reward");
