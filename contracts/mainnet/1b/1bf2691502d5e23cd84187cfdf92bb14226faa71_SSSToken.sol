...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        // emit Transfer(address(0), address(0xf2E796B0Fe9634c060FC27B3D06130A9D2a51B75), total * (25) / (100);
        // emit Transfer(address(0), address(0xf2E796B0Fe9634c060FC27B3D06130A9D2a51B75), total * (15) / (100));
        // emit Transfer(address(0), address(0xf2E796B0Fe9634c060FC27B3D06130A9D2a51B75),  total * (5) / (100));
        // emit Transfer(address(0), address(0xf2E796B0Fe9634c060FC27B3D06130A9D2a51B75), total * (30) / (100));
        // emit Transfer(address(0), address(0xf2E796B0Fe9634c060FC27B3D06130A9D2a51B75), total * (25) / (100));
