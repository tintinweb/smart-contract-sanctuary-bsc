...
contract FIFAFLOKI is IBEP20, Ownable {
    ...
    string constant _name = "FIFAFLOKI";
    string constant _symbol = unicode"FFF";
    ...
    address private marketingWallet = 0x930266b4Cbf2731eDe324e0A4D2f1138a1c89982;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 2, 6, 0);
    Fees public sellFees    = Fees(1, 2, 6, 0);
    ...
    function IncludeFee() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
    ...
    function Launched() external onlyOwner {
