...
contract ElonsTweetGem is Ownable, IERC20 {
    ...
    string private _name = unicode"Excited to hand over the first production cars made by Giga Berlin-Brandenburg tomorrow!";
    string private _symbol = unicode"GIGA BERLIN";
