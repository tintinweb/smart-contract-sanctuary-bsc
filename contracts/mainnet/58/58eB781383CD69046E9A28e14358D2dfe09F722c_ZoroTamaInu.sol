...
contract ZoroTamaInu is Context, IERC20, Ownable {
    ...
    uint256 private maxTxAmount = 100_000 * (10**_decimals);
    uint256 private maxWallet =  200_000 * (10**_decimals);
    uint256 private _swapThreshold = 50_000 * (10**_decimals); 

    string private constant _name = "ZoroTama Inu"; 
    string private constant _symbol = "ZOTA";    
    ...
    address public treasuryWallet = 0xF81Af63D37E13A3B553DdDBB9ed0Afd6924718f5;
