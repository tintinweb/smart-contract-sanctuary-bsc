...
contract LSDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LSDoge";
    string private _symbol = "LSDD";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x225b827a81b7d45b671C283316BaF9cC1B4EEC8C); // Marketing Address
    address payable public teamWalletAddress = payable(0x225b827a81b7d45b671C283316BaF9cC1B4EEC8C); // Team Address
