...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = " SuperDollar";
    string public constant TOKEN_SYMBOL = "SuperDollar ";  
...
contract SuperDollar is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
    ...
    string public tokenType=" SuperDollar ";
