...
contract HamsterTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hamster 2.0";
    string private _symbol = "HMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F5dC530482C55C3Ed2EAa3d2FC3c92b8b8c8969);
