...
contract LunoGrim is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "LunoGrim";
    string private _symbol = "LGRI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8268F80FE9DBDe71f1716aA733F32559cE2Ec53e);
    address payable public teamWalletAddress = payable(0x37dB25434e8572BB0c472a531DcA3f7761b01953);
    ...
    uint256 public _marketingShare = 198;
