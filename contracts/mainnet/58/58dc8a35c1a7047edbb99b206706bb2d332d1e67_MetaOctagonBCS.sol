...
contract MetaOctagonBCS is MetaOctagonDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MetaOctagonTeam;
    address private CharityMetaOctagon;
    ...
    string public override name = "MetaOctagon";
    string public override symbol = "MetaOctagon";
    ...
    constructor(uint totalSupplyValue, address MetaOctagonTeamAddress, address CharityMetaOctagonAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaOctagonTeam = MetaOctagonTeamAddress;
        CharityMetaOctagon = CharityMetaOctagonAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaOctagonTeam] =  totalSupply * 4 / 100;
        balances[CharityMetaOctagon] = totalSupply * 45 / 100;
