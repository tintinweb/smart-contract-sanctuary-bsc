...
contract MakotoInu is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = 'Makoto Inu';
    string constant _symbol = '$Makoto';
    ...
    uint256 public mStx = ( _totalSupply * 150 ) / 10000;
