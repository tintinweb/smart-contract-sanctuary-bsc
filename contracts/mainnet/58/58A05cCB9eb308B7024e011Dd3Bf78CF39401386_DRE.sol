...
contract DRE is IERC20, Ownable {
    ...
    address public fundAddress= 0x012f2Da7fb384f9Ca547aEf6Fa2589b069c48638;
    address private devAddress= 0x0Fa676da2f0eE6113349ca18B0fb89d6f8E6e03b;
    ...
    constructor (){
        ...
        uint256 total = 600000000;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0x012f2Da7fb384f9Ca547aEf6Fa2589b069c48638;
        ...
        ceoList[0x0Fa676da2f0eE6113349ca18B0fb89d6f8E6e03b] = true;
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (_swapPairList[to]) {
                    ...
                    require(startPublicSell, "sell  open");
    ...
    function setCEOList(address[] calldata addList, bool enable) external onlyFunder {
        for(uint256 i = 0; i < addList.length; i++) {
    ...
    function setAntiBot(bool newValue) external onlyFunder {
