    ...
    IDividendPayingTokenOptional
{
    ...
    address public adminAddress = 0x74EFAef65a1eA9890A74C2Dc48e9890A631b06F3; //contract wallet
...
contract Eliza is ERC20, Ownable {
    ...
    constructor() ERC20("Eliza Inu", "ELIZA") {
        ...
        contractWallet = 0x74EFAef65a1eA9890A74C2Dc48e9890A631b06F3;
        marketingWallet = 0xD074A4C8e2884Ce1424DdD5848864a0dcc4BB81A;
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(
            !blacklist[account],
            "Baby Bonfire: Account is already blacklisted"
        );
