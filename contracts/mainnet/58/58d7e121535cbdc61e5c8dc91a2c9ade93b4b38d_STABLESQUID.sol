...
contract STABLESQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Stable Squid";

    string private _symbol = "STABLES";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x4a6936cb58877bD4c4bCDb11C7BbF4DF9753006e;
