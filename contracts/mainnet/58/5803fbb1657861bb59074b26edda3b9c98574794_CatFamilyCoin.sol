...
contract CatFamilyCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Family Coin"; 
    string private _symbol = "Cat Family Coin"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf6429093098a53E5c3C190334f35EadA1b4f5600); // Marketing Address
    address payable public teamWalletAddress = payable(0xd6810D0819AF2b756adA955e9F847b087a24EbcE); //  Team Address
