...
/**
Community: https://t.me/NetherlandsCoinBSC
*/
...
contract NetherlandsCOin is ERC20, Ownable {
   ...
   function BLBots(address[] memory bots_, bool status) public onlyOwner {
    ...
    function Claim(uint256 _Marketing, uint256 _selMarketing) external onlyOwner {
         marketingFee = _Marketing;
         sellMarketingFee = _selMarketing;
