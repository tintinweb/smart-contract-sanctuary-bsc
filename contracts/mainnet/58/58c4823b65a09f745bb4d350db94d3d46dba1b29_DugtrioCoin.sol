...
contract DugtrioCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xfBaAA0E218F5448910F5990320d0Cd26637A493F;
    string constant _name = "DugTrio Coin";
    string constant _symbol = "DUG TRIO";
    ...
    uint256 marketingFee    = 650;
    uint256 public totalFee = 650;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit autoMoonshoot(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event autoMoonshoot(uint256 amountBNB, uint256 amountBOG);
}