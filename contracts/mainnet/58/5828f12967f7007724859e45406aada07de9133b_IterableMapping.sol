...
contract LUNAZ is ERC20, Ownable {
    ...
    address public marketingWallet = 0x5277078f9210E163611a29B4025c409B0E2F7064;
    ...
    address public rewardToken = 0xECCF35F941Ab67FfcAA9A1265C2fF88865caA005; // LUNC
    ...
    constructor() ERC20("LUNA Zombie", "LUNAZ") 
    {
    ...
    function updateFees(uint256 _marketingFee, uint256 _rewardFee) external onlyOwner {
        ...
        require(totalFees <= 25, "Fees cannot exceed 25%");
