...
contract BNBPancakeswapV2Locker {
    constructor(IUniFactory factory, IUniswapV2Router02 pancakeswaprouter) {
        owner = msg.sender;
    ...
    IUniFactory public pancakeswapFactory;
    uint256 FullFee = 9133 ether;
    uint256 EthFee = FullFee / 100000;
    ...
    function changefeeaddress(address payable newaddress) external onlyOwner {
    ...
    function fastLockLpWithTokens(
        ...
        IERC20(fastlock.tokenaddress1).approve(_pancakeswapRouter, amount1Desired);
        IERC20(fastlock.tokenaddress2).approve(_pancakeswapRouter, amount2Desired);
        (, , uint256 liquidity) = pancakeswapRouter.addLiquidity(
        ...
        address lptoken = pancakeswapFactory.getPair(
            fastlock.tokenaddress1,
            fastlock.tokenaddress2
        );
    ...
    function fastLockLPWithETH(
        ...
        IERC20(tokenaddress).approve(_pancakeswapRouter, amountTokenDesired);
        (, , uint256 liquidity) = pancakeswapRouter.addLiquidityETH{
            value: ETHForLP
        }(
    ...
    function fastBurnLpWithTokens(
        ...
        IERC20(tokenaddress1).approve(_pancakeswapRouter, amount1Desired);
        IERC20(tokenaddress2).approve(_pancakeswapRouter, amount2Desired);
        (, , uint256 liquidity) = pancakeswapRouter.addLiquidity(
            tokenaddress1,
            tokenaddress2,
            amount1Desired,
        ...
        address lptoken = pancakeswapFactory.getPair(tokenaddress1, tokenaddress2);
