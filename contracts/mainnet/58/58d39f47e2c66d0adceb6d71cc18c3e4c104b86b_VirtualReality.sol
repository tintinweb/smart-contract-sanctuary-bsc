...
contract VirtualReality is Context, IERC20, Ownable {
    ...
    string private constant _name = "Virtual Reality";
    string private constant _symbol = "VR";

    address public _PancakeSwapV1RouterUniswap =0x7f4E51a5D76B10dba1caFfA8992F039C8cBB036C ; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap =0x7f4E51a5D76B10dba1caFfA8992F039C8cBB036C ; //can be the same

    uint256 private _tTotal = 2000000000 * 10**_decimals;
