...
Baby Squid 2.0
The next generation of Baby Squid token.
______________
...
Telegram : https://t.me/BabySquid2BSC
*/
...
contract BabySquid2point0 is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 50_000_000_000 * 10**9; //
    string private constant _name = "Baby Squid 2.0"; // 
    string private constant _symbol = "BABYSQUID2.0"; //    
