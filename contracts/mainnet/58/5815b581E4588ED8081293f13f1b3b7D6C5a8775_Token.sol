...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("CSC-DAO", "CSC-DAO") {

        address main = 0x12d924b6d23C8098944B222c29D8Eeff87f89384;
        _mint(main, 1000000 * 1e18);
        ...
        lpWallet = 0x648ED3579D24828e17c50cd5644A59E5bF8888c1;
        otherWallet = 0x3754887064670a27a01a431f432464B57d2E8eb7;


        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[msg.sender] = true;
        _isExcludedFromFees[lpWallet] = true;
        _isExcludedFromFees[otherWallet] = true;
    ...
    function setOtherFee(uint256 value) public onlyOwner {other = value;}
    function setSellFee(uint256 value) public onlyOwner {sell = value;}
    function setlpWallet(address addr) public onlyOwner{
        lpWallet = addr;
    }

     function setotherWallet(address addr) public onlyOwner{
        otherWallet = addr;
    }
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if (from == address(uniswapV2Pair) && to == _router){
                ...
                if (to == address(uniswapV2Pair)){ // sell
                    ...
                    super._transfer(from, lpWallet, fee);

                    otherFee = amount.mul(other).div(1000);
                    super._transfer(from, otherWallet, otherFee);
