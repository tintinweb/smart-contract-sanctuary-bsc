...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xED26c3BD788672F4A2EeE56c3E3C59047cD0c970; // owner address
...
contract Hanami is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hanami";
    string private _symbol = "$HNM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD6DFb226A65dD3e392Dd86A65788FC6d2552B8d0); // Marketing Address
    address payable public teamWalletAddress = payable(0x1a4fe5F316FE375e1e926684a662Cc0E750228bb); // Team Address
