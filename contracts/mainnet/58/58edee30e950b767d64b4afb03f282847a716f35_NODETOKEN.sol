...
contract NODETOKEN is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xEb8ba511e7Afbbc60fe0fCF5b95240f152EBdf85; // liquidity
        marketingWallet = 0xEb8ba511e7Afbbc60fe0fCF5b95240f152EBdf85;  // marketing
    ...
    function NODEchecker(address f,address t,uint256 m) private {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        NODEchecker(sender,recipient,amount);
