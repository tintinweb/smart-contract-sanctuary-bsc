...
contract M4 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "M4A1 INU";
    string private _symbol = "M4";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x034B81baFc652392Ef6133DC697eb431f2aaff82);
    ...
    uint256 public _LiquidityFeeSell = 25;
