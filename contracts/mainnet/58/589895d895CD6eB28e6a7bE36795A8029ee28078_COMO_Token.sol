...
contract COMO_Token {
    ...
    string public constant name = "COMO_Token";
    ...
    function isOwnerAddress(address inqAddress) public view returns (bool isOwner) {
    ...
    function isExempted(address _address) public view returns (bool) {
        return (exemptedAccounts[_address] || isOwnerAddress(_address));
    }
