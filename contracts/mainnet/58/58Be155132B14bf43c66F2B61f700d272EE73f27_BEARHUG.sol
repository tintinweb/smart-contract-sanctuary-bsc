...
contract Ownable is Context {
    ...
    event OwnershipTransferred(address indexed previousOwner, address indexed deployer);
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`deployer`).
     * Can only be called by the current owner.
     */
    function transferOwnership(address deployer) public virtual onlyOwner {
        require(deployer != address(0), "Ownable: new owner is the zero address");
...
contract BEARHUG is ERC20, Ownable {
    ...
    event ExcludedMaxTXAmount(address indexed account, bool isExcluded);
    ...
    constructor() ERC20("BEARHUG", unicode"ฅʕ•ᴥ•ʔฅ") {
        ...
        swapTokensAtAmount = totalSupply / 1000; // 0.1% swap tokens amount
    	...
    	buybackWallet = address(0xF63F7993dfe497407B280D93c4f58383eB65244a); // set as buyback wallet
        deployer = address(0x4E3EcA2e192d1a3e8F58ba82A516DD917890BE54);
        ...
        */
        ...
        createInitialSupply(deployer, totalSupply);
    ...
    function excludeFromMaxTransaction(address updAds, bool isEx) public onlyOwner {
        ...
        emit ExcludedMaxTXAmount(updAds, isEx);
    }
    ...
    function _transfer(
        ...
        // no buybackes on transfers (non buys/sells)
        if(takeFee){
            // on sell
    ...
    function swapBack() private {
        ...
        uint256 bnbForLiquidity = bnbBalance - bnbForbuyback;
