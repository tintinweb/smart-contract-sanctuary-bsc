...
contract YYDS is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0xD8bB6a97f75Bc17EC8A5EbDFa7bCDe6f3e6e59b5),//营销钱包地址
    
        address(0xD8bB6a97f75Bc17EC8A5EbDFa7bCDe6f3e6e59b5)//部署代币接收地址（部署的代币发送到这个钱包地址）
    ){
