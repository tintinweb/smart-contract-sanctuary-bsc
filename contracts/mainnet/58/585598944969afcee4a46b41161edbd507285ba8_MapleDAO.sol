...
contract MapleDAO is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 148370 * 10**_decimals;

    string private _name = "MapleDAO";
    string private _symbol = "MapleDAO";
    ...
    address public _market = 0x8a9e708dee13b68F11597F6DC1c9B2FbA8B1Db9a;
