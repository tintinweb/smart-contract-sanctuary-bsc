...
Our universe as we knew it are full of secrets and mysteries, so as the metaverse. Join our community as we unfold each of the secret of the metaverse and mysteries within it. We will take you to a magical journey to unfold the truth about metaverse and all the worlds within, the “multiverse of metaverse”. Metaverse open up a new world of possibilities for everyone to unlock the full potential of the decentralized crypto space and blockchain

FEATURES
Take a look at all of the Features of “Crypto Strange” project have for you:

NFT ART MARKETPLACE
Complete the Crypto Strange "Spell" by collecting all CRYPTO STRANGE NFT Art Collections. Buy and sell any NFT arts and earn profit within Crypto Strange space on a completely decentralized NFT open market.

FARMING
Who said crypto farming are just for NFTs? Within this space you can Farm our very own “Crypto Strange Token”. It will generate “Crypto Strange Token (CST)” for you every block.

STAKING REWARDS
Crypto Strange Token (CST) can be used in the platform that we will launch to earn staking rewards. It is designed to encourage users to hold tokens and support the ecosystem.

🗡 2% - LP
🏹 5% - Marketing/Dev
🛡 1% - Artist Donation (Charity)

📬TG : https://t.me/CryptoStrangeOfficialX

🐦Twitter : https://twitter.com/Cryptostrange00

🌐Website : https://cryptostrange.club/
*/
...
contract CryptoStrange is IBEP20, Auth {
    ...
    string constant private _name = "Crypto Strange";
    ...
    address public _marketingFeeReceiver = 0x7dB3F867a575a7AC962e1966E5a7227322B4139a;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __marketingFee, uint256 _lpFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        lpFee = _lpFee;
        _marketingFee = __marketingFee;
        devFee = _devFee;
        totalFee = _lpFee.add(__marketingFee).add(_devFee);
