...
contract Mycoin is ERC20, Ownable  {
    ...
    uint256 private _maxTradeVolume = 5000000 * 1e18;
    uint256 private _maxWalletVolume = 5000000 * 1e18;

    address public constant marketAddress = 0x9505A9FBC87780b2991C3429E0E1497729443D2f;
    address public constant devAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 private constant total =   100000000 * 1e18 ;

    uint256 public _liquidityFee = 10; //回流
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketFee =1; //营销
    uint256 private _previousMarketFeeFee = _marketFee;

    uint256 public _devFee = 2; //开发
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 1e17;
    ...
    constructor() ERC20("RichMoonKiller", "RichMoonKiller") {
