...
contract Partisia is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0xCd97ceB7313E6dB52E867BEe3d6d7FbF7616aadF); 
    address payable public developmentAddress = payable(0xCd97ceB7313E6dB52E867BEe3d6d7FbF7616aadF); 
    address payable public charityAddress = payable(0xCd97ceB7313E6dB52E867BEe3d6d7FbF7616aadF); 
    address payable public vaultRewardAddress = payable(0xCd97ceB7313E6dB52E867BEe3d6d7FbF7616aadF); 
    ...
    string private constant _name = "Partisia Blockchain";
    string private constant _symbol = "Partisia";
    ...
    //Create additional liquidity using Security Bridge tokens in contract
