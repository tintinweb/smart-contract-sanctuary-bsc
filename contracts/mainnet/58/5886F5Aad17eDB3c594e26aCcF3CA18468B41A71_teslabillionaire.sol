...
// Tesla Billionaire Token
// https://t.me/teslaBillionairebsc
...
contract teslabillionaire is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77010a8e044c8f80099f95c0C8E59dF65a5C738C); 
    address payable public Wallet_Dev = payable(0x195910eF8ffff38E5E9EaD5a6ADc64Aa5e367C12);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x195910eF8ffff38E5E9EaD5a6ADc64Aa5e367C12); 
    ...
    string private constant _name = "Tesla Billionaire"; 
    string private constant _symbol = unicode"TLB"; 
    ...
    constructor () {
        ...
        _owner = 0x195910eF8ffff38E5E9EaD5a6ADc64Aa5e367C12;
