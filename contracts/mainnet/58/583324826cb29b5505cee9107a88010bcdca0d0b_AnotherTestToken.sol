...
contract AnotherTestToken is ERC20, Ownable {
    ...
    constructor() ERC20("AnotherTestToken", "ATT") {
    ...
    //If the contract gets launched with fees above the feeLimit use this function to update them
    function updateFees(
        uint256 _feeLimit
    ) external onlyOwner {
        feeLimit = _feeLimit;
