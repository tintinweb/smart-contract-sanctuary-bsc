...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb8641A98e85f009B8e893d696a65b79618DF1b79; // owner address
...
contract racaqatar is Context, IERC20, Ownable {
    ...
    string private _name = "RACA QATAR";
    string private _symbol = "RACAQATAR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xb8641A98e85f009B8e893d696a65b79618DF1b79); // Marketing Address
    address payable public teamWalletAddress = payable(0xb8641A98e85f009B8e893d696a65b79618DF1b79); // Team Address
