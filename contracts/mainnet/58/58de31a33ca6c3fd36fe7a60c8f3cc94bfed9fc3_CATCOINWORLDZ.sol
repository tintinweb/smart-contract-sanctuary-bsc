...
contract CATCOINWORLDZ is Context, IERC20, Ownable {
    ...
    string private _name = "Cat Coin Worldz";
    string private _symbol = "CATWORLD";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xE174C9AeaDfF3B7ae36784c3505974B062CC25Ec); // Marketing Address
    address payable public BuyBackWallet = payable(0x3772A67E24a65f412633484082dBafD05872Ce4b); // Team Address
