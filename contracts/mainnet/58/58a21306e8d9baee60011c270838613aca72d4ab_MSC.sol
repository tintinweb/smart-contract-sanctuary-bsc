...
contract MSC is ERC20 {
	...
	address payable _fundAddress = payable(address(0x000000000000000000000000000000000000dEaD));
	address private _destroyAddress = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);
    ...
    address _luckAddress = address(0x58c251BDCA9C66265199112c85Ab3E4ED443f432);
    constructor(address tokenOwner) ERC20("MESOS TOKEN", "MSC") {
        ...
        uint256 total = 75 * 10**24;
        _mint(tokenOwner, total.div(100).mul(88));
        _mint(_luckAddress, total.div(100).mul(12));
    }
    ...
    function _splitOtherToken() private {
        ...
        if(thisAmount >= 10**12){
            _splitOtherTokenSecond(thisAmount.div(10).mul(7));
        }
    }
