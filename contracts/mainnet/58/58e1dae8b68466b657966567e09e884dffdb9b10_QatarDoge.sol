...
contract QatarDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000000000000 * 10**9;
    ...
    string private _name = "QatarDoge";

    string private _symbol = "QatarDoge";
    ...
    address payable public marketAddress = 0x5fE9EA69c2449C7dbaE56f8a4b2D24cb765f6cBE ; //Marketing
