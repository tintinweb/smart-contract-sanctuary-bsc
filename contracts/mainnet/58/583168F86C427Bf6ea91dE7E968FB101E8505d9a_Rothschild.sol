...
contract Rothschild is ERC20, Ownable {
    ...
    constructor() payable ERC20("Rothschild", "BANK") {
        ...
        operationsAddress = address(0xADBA3Bf0a790352D5c7d45E7E9608B843F84BEB1);
        treasuryAddress = address(0xADBA3Bf0a790352D5c7d45E7E9608B843F84BEB1);
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 40) / 100); // Burn
    ...
    function restoreTaxesToNormal() external onlyOwner {
