...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe59426166576EBA4aF5AA8894B156CAf14361497; // owner address
...
contract BabyPochInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyPochInu";
    string private _symbol = "$BPOCH"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe59426166576EBA4aF5AA8894B156CAf14361497); // Marketing Address
    address payable public teamWalletAddress = payable(0xe59426166576EBA4aF5AA8894B156CAf14361497); // Team Address
