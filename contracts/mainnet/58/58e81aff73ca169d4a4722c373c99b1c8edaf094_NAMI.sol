...
contract NAMI is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 15 / 1000; //Sell Only
    ...
    string constant private _name = "NAMI";
    string constant private _symbol = "NAMI";
    ...
    constructor() {
        ...
        marketingWallet = 0x1Deb277FF2bfF1185081C6b44bc84DC466198eE5;
        devWallet = 0x1Deb277FF2bfF1185081C6b44bc84DC466198eE5;
    ...
    function extractFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeApplicable > 0 && burnFee >0){
            ...
            _balances[DEAD_WALLET] = _balances[DEAD_WALLET].add(burnAmount);
            emit Transfer(sender, DEAD_WALLET, burnAmount);
        }
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(burnFee).sub(liquidityFee.div(2));
