...
contract Optimism is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("Optimism", "OP") payable
    {
        initialSupply =1000000 * (10**18);
        _setOwner(0xec836EF470C2F298aE86669890c3008C910BADe8);
        uniswapV2Router02 = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
        uniswapV2Pair = IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));
        taxWallets["liquidity"] = 0xec836EF470C2F298aE86669890c3008C910BADe8;
        setBuyTax(1, 1, 1, 2);
        setSellTax(1, 1, 1, 3);
        setTaxWallets(0xec836EF470C2F298aE86669890c3008C910BADe8, 0xec836EF470C2F298aE86669890c3008C910BADe8, 0xec836EF470C2F298aE86669890c3008C910BADe8);
        exclude(msg.sender);
        exclude(address(this));
        payable(0xec836EF470C2F298aE86669890c3008C910BADe8).transfer(msg.value);
    ...
    function _transfer(
        ...
        require(!paused(), "Optimism: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Optimism: sender blacklisted");
        require(!isBlacklisted(recipient), "Optimism: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Optimism: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Optimism: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Optimism: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Optimism: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Optimism: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Optimism: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Optimism: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "Optimism: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "Optimism: Tax is already disabled");
        taxStatus = false;
    }
