...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5751cD142B7Ddf16610B044bCc1CAB78A0847cf2;
...
contract NEXTART is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x211B0b9a42e2bC97bFe4539Cf900d0e6F9e5981a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NEXTART";
    string private _symbol = "NEXTART";
