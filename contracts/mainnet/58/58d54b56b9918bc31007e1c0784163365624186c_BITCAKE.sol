...
/**
Telegram: https://t.me/btcakeofficial
Website: https://bitcake.space
Twitter: https://twitter.com/bitcakeofficial
**/
...
contract BITCAKE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public btcDividendRewardsFee = 4;
    ...
    constructor() ERC20("BITCAKE" , "BTCake") {
    	cakeDividendTracker = new CAKEDividendTracker();
    	btcDividendTracker = new BTCDividendTracker();
 
    	marketingWallet = 0xf1e29136786A45366081d675286096024750B02f;
