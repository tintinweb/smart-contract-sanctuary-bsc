...
contract ZMDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZMDOGE";
    string private constant _symbol = "ZMDOGE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xc61d8Ac460FbEC4C3b56e1468BeD7a2065960B02);
    address payable private _marketingAddress = payable(0xc61d8Ac460FbEC4C3b56e1468BeD7a2065960B02);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 4, "Redis cannot be more than 4.");
	    require(redisFeeOnSell < 40, "Redis cannot be more than 40.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 4.");
	    require(taxFeeOnSell < 40, "Tax cannot be more than 40.");
