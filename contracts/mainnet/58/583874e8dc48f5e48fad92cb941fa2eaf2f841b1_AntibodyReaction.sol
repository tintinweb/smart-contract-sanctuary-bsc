...
contract AntibodyReaction is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AntibodyReaction";
    string private _symbol = "AR";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xE569baD8D2AC7ec284DF4074BAF4f89b350Adf1C);
