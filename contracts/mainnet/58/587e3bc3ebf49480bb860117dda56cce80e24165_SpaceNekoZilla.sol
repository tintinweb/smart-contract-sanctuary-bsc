...
contract SpaceNekoZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "Space Neko Zilla"; //
    string private constant _symbol = "SNZL"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xCa4D1FDfF5656B94A5B9D22650BF40DbB1E281B1;
