...
contract f1erfoxgrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "F1erFox Grow"; // 
    string private constant _symbol = "$f1erfoxgrow"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x9D1872a20011a7305ed0DadFe44B293C71A2ca9a;
