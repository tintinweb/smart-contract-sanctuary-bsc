...
contract fifteenfourtyfive is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1545 * 10**9;
    uint256 public _maxTxAmount = 3* 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "1545"; // 
    string private constant _symbol = "1545"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x784B2349826580Cd82EF3e1924b698045a13F18a;
