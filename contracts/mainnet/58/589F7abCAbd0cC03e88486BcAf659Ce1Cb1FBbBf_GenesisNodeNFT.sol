...
contract GenesisNodeNFT is Ownable, ERC721Enumerable {
    ...
    function airdrop(address[] memory _userAddressList) external onlyOwner {
        require(_userAddressList.length > 0, "empty userAddressList");
        require(totalSupply() + _userAddressList.length <= MAX_SUPPLY, "Exceeded max supply");
    ...
    event Airdrop(address[] userAddressList);
