...
contract YachtGod is Context, IBEP20, Ownable {
    ...
    string private _name = "Yacht God";
    string private _symbol = "YGOD";
    ...
    constructor () {
        ...
        _isExcludedFromAutoLiquidity[address(pancakeswapV2Router)] = true;
    ...
    function setUniswapRouter(address r) external onlyOwner {
        IUniswapV2Router02 _pancakeswapV2Router = IUniswapV2Router02(r);
        pancakeswapV2Router = _pancakeswapV2Router;
    }
    ...
    function _transfer(
        ...
        if (from == V2pair && to != address(pancakeswapV2Router)) {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private returns (uint256, uint256) {
        ...
        (uint amountToken, uint amountETH, ) = pancakeswapV2Router.addLiquidityETH{value: bnbAmount}(
            address(this),
            tokenAmount,
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2pair && recipient != address(pancakeswapV2Router);
