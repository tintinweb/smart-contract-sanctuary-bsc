...
contract EasterDoge is Context, IERC20, Ownable {
    ...
    string private _name = "EasterDoge King";
    string private _symbol = "EASTERDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37a0DbAd9B7A103Ca832c1e7A32dEbbF8Bb223e8); 
    address payable public buyBackWalletAddress = payable(0x37a0DbAd9B7A103Ca832c1e7A32dEbbF8Bb223e8); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
            ...
            if (recipient == uniswapV2Pair && !isExcludedFromFee[sender]) 
        {
			    ...
			    revert("Transfer amount must be greater than fee");
            }
		}
