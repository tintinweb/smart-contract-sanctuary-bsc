...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x621Ea15d5fE22FDe3b41158508Ef3376d45F9C4E ;//fund address
...
contract BAH is Token {
    constructor() Token(
        ...
        address(0x879BC6d332Ae41A5dB98a54Fc38dB274147eEa77),//fund address
    
        address(0xC4301a4a05E58711598A8a4EAA5D7ED79AC0dB29)//dev address
    ){
