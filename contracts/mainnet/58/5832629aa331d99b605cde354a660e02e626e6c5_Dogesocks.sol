...
contract Dogesocks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dogesocks";
    string private _symbol = "Dogesocks";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0bcbE7a5CfBe1553F03d9Fa6db89d28D7244AB9D);
