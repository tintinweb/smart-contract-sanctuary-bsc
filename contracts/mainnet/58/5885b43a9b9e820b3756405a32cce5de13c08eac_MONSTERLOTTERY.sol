...
/* Token contract */
contract MONSTERLOTTERY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xF06e4daC3Df4D2554dAF76A3761975b0483d80Fa;
    ...
    // Name and symbol
    string constant _name = "Monster Lottery";
    string constant _symbol = "MLOTTERY";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 20000000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 5% 
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 5% 
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 5% 
