...
contract ARTICDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Artic Doge"; // 
    string private constant _symbol = "ARTICDOGE"; //    
