...
contract EustassKidInu is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000 * 10**5 * 10**8;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Eustass Kid Inu';
