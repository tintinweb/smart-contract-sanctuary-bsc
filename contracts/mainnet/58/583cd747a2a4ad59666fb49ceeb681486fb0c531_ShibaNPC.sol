...
contract ShibaNPC is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shiba NPC";
    string constant _symbol = "SNPC";
    ...
    address public marketingFeeReceiver = 0x53927fedfBeaBFDF5adC861cb346131426942feA;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x53927fedfBeaBFDF5adC861cb346131426942feA] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x53927fedfBeaBFDF5adC861cb346131426942feA] = true;
