...
contract PENSION_PRIVATE is Ownable {
    ...
    uint256 public newTokenSupply = 20000 * 10**18;

    address public devWallet = 0x405Da2C01BAAeCC9aC2E561179738a8bffB4FEdd;
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorMinCap = 0.1 ether; // 0.1 bnb
        uint256 public investorMaxCap = 3 * 10**18; // 2 bnb
        uint256 public investorHardCap = 100 * 10**18; // 50 bnb
