...
abstract contract AbsToken is IERC20, Ownable {
    ...
    TokenDistributor public _lpDividendDistributor;
    ...
    constructor (
        ...
        _lpDividendDistributor = new TokenDistributor(USDTAddress);

        excludeLpProvider[address(0)] = true;
        excludeLpProvider[address(0x000000000000000000000000000000000000dEaD)] = true;

        lpRewardCondition = 20000000 * tokenDecimals;

        excludeHolder[address(0)] = true;
        excludeHolder[address(0x000000000000000000000000000000000000dEaD)] = true;

        holderRewardCondition = 10000000 * tokenDecimals;
        holderCondition = 20000000 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                ...
                uint256 holdDividendAmount = tAmount * _buyHoldDividendFee / 10000;
                ...
                if (lpDividendAmount > 0) {
                    ...
                    _takeTransfer(sender, address(_lpDividendDistributor), lpDividendAmount);
                }
            } else {//Sell
                isSell = true;
                ...
                uint256 holdDividendAmount = tAmount * _sellHoldDividendFee / 10000;
                if (holdDividendAmount > 0) {
                    feeAmount += holdDividendAmount;
                    _takeTransfer(sender, address(_tokenDistributor), holdDividendAmount);
                }
    ...
    function setBuyFee(uint256 lpFee, uint256 holdDividendFee, uint256 lpDividendFee) external onlyOwner {
        _buyLPFee = lpFee;
        _buyHoldDividendFee = holdDividendFee;
        _buyLPDividendFee = lpDividendFee;
    }

    function setSellFee(uint256 destroyFee, uint256 holdDividendFee, uint256 lpDividendFee) external onlyOwner {
...
contract KMC is AbsToken {
    constructor() AbsToken(
        ...
        10000000000,
    //Receive
        address(0xa10AfC63628A2be75560a5fa70Ae7ceE0894aE24),
    //Fund
        address(0x030d9269d31eEA608d0D575f2bD5c6f4655089B9)
    ){
