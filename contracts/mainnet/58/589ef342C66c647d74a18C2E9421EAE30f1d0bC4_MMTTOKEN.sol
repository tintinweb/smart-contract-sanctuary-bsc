...
contract MMTTOKEN is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    _balances[sender] = _balances[sender].sub(amount, "MMT: transfer amount exceeds balance");
  ...
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "MMT: burn from the zero address");

    _balances[account] = _balances[account].sub(amount, "MMT: burn amount exceeds balance");
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    _approve(account, _msgSender(), _allowances[account][_msgSender()].sub(amount, "MMT: burn amount exceeds allowance"));
  }
}