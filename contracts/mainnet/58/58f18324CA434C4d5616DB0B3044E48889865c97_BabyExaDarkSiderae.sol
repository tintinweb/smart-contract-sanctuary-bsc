...
contract BabyExaDarkSiderae is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby ExaDarkSiderae"; 
    string private constant _symbol = "BabyExaDarkSiderae"; 
