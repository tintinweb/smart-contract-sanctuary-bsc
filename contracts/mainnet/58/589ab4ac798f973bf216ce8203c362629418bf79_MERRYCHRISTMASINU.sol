...
/**
Telegram : https://t.me/merrychristmasinu
Website  : https://twitter.com/elonmusk/status/1474836752619741188?t=acli7OloccqYsky2TruF4A&s=19
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6555866C1D0463C43B12347A049dba490512f8bF;  // owner address
...
contract MERRYCHRISTMASINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MERRY CHRISTMAS INU";
    string private _symbol = "$MCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6555866C1D0463C43B12347A049dba490512f8bF); // Marketing Address
    address payable public teamWalletAddress = payable(0x6555866C1D0463C43B12347A049dba490512f8bF); // Team Address
    ...
    uint256 public _buyLiquidityFee = 33;
    uint256 public _buyMarketingFee = 33;
    uint256 public _buyTeamFee = 33;
    
    uint256 public _sellLiquidityFee = 33;
    uint256 public _sellMarketingFee = 33;
    uint256 public _sellTeamFee = 33;

    uint256 public _liquidityShare = 66; 
    uint256 public _marketingShare = 66;
    uint256 public _teamShare = 66; 
