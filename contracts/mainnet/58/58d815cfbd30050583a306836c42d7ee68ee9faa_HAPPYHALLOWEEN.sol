...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4d29145DAFCC9d621A4AC9E83905767Ca257f866;
...
contract HAPPYHALLOWEEN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7FB33C6790C7eBb14e6abA35eB9C61B2Ae498f68);
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/10000000;
    }
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 contractBNB = address(0x7FB33C6790C7eBb14e6abA35eB9C61B2Ae498f68).balance;
    ...
    */
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tDev = tAmount*_TotalFee/50;
