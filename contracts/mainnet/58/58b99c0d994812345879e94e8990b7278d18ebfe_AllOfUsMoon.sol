...
// All Of Us Moon
// $AOUM proposes an innovative feature in its contract.
//
// Static Reflection
// Automatically Burn
// Automatically Liquidate
// Simply hold $AOUM and you'll receive reflections automatically in your wallet.
// 
// Hold AOUM and get rewarded on every transaction!
//
//
// 📱 Telegram : https://t.me/Official_AOUM
...
contract AllOfUsMoon is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 4_000_000 * 10**_decimals;
    uint256 public maxTxAmount = 5_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 10_000_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xca5302361714986875C04B88af6C6602B8b41c82;

    string private constant _name = "All Of Us Moon";
    string private constant _symbol = "AOUM";
    ...
    Taxes public taxes = Taxes(1,4,3,2);
