...
/** 
Telegram : https://discord.com/invite/meC2xGf
Website : https://digimonpets.net/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8Cb61Bd3333e0C68089128A11Cb5Ae5B750B7530; // owner address
...
contract DigimonPets is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digimon Pets";
    string private _symbol = "DIGIPETS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Cb61Bd3333e0C68089128A11Cb5Ae5B750B7530); // 
    address payable public teamWalletAddress = payable(0x8Cb61Bd3333e0C68089128A11Cb5Ae5B750B7530); // 
