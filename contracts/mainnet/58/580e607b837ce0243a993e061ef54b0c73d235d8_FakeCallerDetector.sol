...
/**
TG : https://t.me/fakecallersdetector
*/
...
interface IDEXRouter {
    ...
    contract FakeCallerDetector is IBEP20, Auth {
    ...
    string constant _name = "Fake Caller Detector";
    string constant _symbol = "FCD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply =1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply *1 ) / 400; 
    uint256 public _maxWalletSize = (_totalSupply * 1) / 400; 
    ...
    address public marketingFeeReceiver = 0x1b93969F7482AE2605D21B13f9018EdEb8be76E3;
    address public devFeeReceiver = 0xDECA83a18682F4396131e4B4C6718424dBf0b49D;
