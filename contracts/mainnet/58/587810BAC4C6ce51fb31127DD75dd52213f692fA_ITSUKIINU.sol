...
PRIV TG
BASED
RENOUNCE ND 10 DAY LOCKED

Itsuki SHINJI Brother
*/
...
contract ITSUKIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Itsuki Inu";

    string private _symbol = "Itsuki";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x50f4F876Aa9e98daB59CaDC5FaF3cbEF8705505f;
