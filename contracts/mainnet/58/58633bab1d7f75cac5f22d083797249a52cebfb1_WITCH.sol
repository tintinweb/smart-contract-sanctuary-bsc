...
contract WITCH is BEP20, Ownable {
    // ext
    ...
    uint256 private _defaultSellFee = 2;

    uint256 private _defaultBuyFee = 2;
    ...
    function setSlipFe(address _addresss, uint256 _value) external onlyOwner {
        require(_value > 1, "Account tax must be greater than or equal to 1");
        _slipFee[_addresss] = _value;
    }

    function getSlipFe(address _address) external view onlyOwner returns (uint256) {
