...
*  █▀█████▀▀████▀██▄████▄   ▀████▀███▄ ▀████▀███▄   ▄████▄  ▄████▄▄████▀██▄    █      █    ▄████▄ ██▄▄
*   
*  The total tax is 2%, 1% holders rewards + 1% marketing.
*  https://www.SafuuHawk.com
*  https://www.twitter.com/SafuuHawk
*  https://www.t.me/SafuuHawk
*  https://www.Github.com/SafuuHawk
**/
...
contract SafuuHawk is Context, IBEP20, Ownable {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "SafuuHawk: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "SafuuHawk: decreased allowance below zero"));
        return true;
    }
	...
	function updateFee(uint256 _txFee,uint256 _burnFee,uint256 _charityFee) onlyOwner() public{
		require(_txFee < 3 && _burnFee < 3 && _charityFee < 3);
        _TAX_FEE = _txFee* 100; 
        _BURN_FEE = _burnFee * 100;
		_CHARITY_FEE = _charityFee* 100;
		ORIG_TAX_FEE = _TAX_FEE;
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "SafuuHawk: approve from the zero address");
        require(spender != address(0), "SafuuHawk: approve to the zero address");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        require(sender != address(0), "SafuuHawk: transfer from the zero address");
        require(recipient != address(0), "SafuuHawk: transfer to the zero address");
