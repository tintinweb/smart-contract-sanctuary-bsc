...
Baby Yuki Inu here, we aim to shake up the BSC with yet another stealth launch that turns into something massive. With a safe & transparent team, solid & verified contract, 100% transparency about the marketing & token progress, & most importantly an amazing community - there truly is no end to where we can go! 

Baby Yuki Inu will be launching with a low member count, allowing strong community to grow!
...
📱https://t.me/BabyYukiInuPortal
🐤https://twitter.com/BabyYukiInuBsc
*/
...
contract BabyYukiInu is Context, IERC20, Ownable {
    ...
    string private _name = "BabyYukiInu";
    string private _symbol = "BabyYINU";
