...
contract token is ERC20 {
    ...
    string internal tokenName = "LLT";
    string internal tokenSymbol = "LLT";
    uint256 constant total  =  50000 * 10**18;
    address public marketAddress = address(0x0d3D6Afc7ece142c27Fa6bD73Ef7c9B730223a3C);
    uint256 buyFee = 20;
    uint256 sellFee = 960;
