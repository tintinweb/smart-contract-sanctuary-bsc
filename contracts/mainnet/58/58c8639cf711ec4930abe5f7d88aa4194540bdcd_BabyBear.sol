...
// ENGLISH TG PORTAL: https://t.me/babybscbear
// CHINESE TG: @babybearchinese
//WEBSITE: https://babybear3.godaddysites.com/
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("BabyBear_Track", "Bbear", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract BabyBear is Main {
    ...
    constructor() Main (
        ...
        0x990fe1a0BaeBFAdb6190EE74f314Ea3E752a7AD3,     // Marketing address
        0x990fe1a0BaeBFAdb6190EE74f314Ea3E752a7AD3,     // Team address
        0x990fe1a0BaeBFAdb6190EE74f314Ea3E752a7AD3,     // Multi Use address
