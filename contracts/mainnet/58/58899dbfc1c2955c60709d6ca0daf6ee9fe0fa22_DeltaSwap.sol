...
/* DeltaSwap -   A decentralized trading protocol on BSC.
...
contract DeltaSwap is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb29BC892A6bC3fc9739A0aBa182E775B6Af96cB4); // Marketing Address
    address payable public charityAddress = payable(0xb29BC892A6bC3fc9739A0aBa182E775B6Af96cB4); // Charity/Dev Address
    ...
    string private _name = "DeltaSwap";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 900000000000000000000000000; // 900,000,000; token will be given on airdrop
