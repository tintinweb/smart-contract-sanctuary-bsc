...
=== 'Trust Worthy Fund' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards Trust Worthy Fund
-------------------------------------------------------------------
*/ 
...
contract Trust_Worthy_Fund is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Trust Worthy Fund";
    string constant private _symbol = "TRUST";
    ...
    constructor(address _admin) public{
        ...
        _totalSupply = maxSupply.mul(10).div(100);
        _balanceOf[_admin] = _balanceOf[_admin].add(_totalSupply); 
