...
contract IDOL is Context, IBEP20, Ownable {
    ...
    string private _name = "MarketingIdolCoin";
    ...
    uint256 public _maxWallet = 15 * 10**5 * 10**9;
    ...
    address payable public buybackAddress = payable(0xaf32B49363855951797b17A779C778CAB5A426a8);
    address payable public devAddress = payable(0xFb1281f847d3dE36AB0051a16AF513405E672A10);
    address payable public lpAddress = payable(0x897941e0F96fDf950cb10b2a04F2906f21BF6d2c);
    address payable public stakingAddress = payable(0xc3b7DA98a4251927931e4CDBEF3c9CD72AD7E101);
