...
contract BATINU is BATINUDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BATINUTeam;
    address private CharityBATINU;
    ...
    string public override name = "Batinu";
    string public override symbol = "BATINU";
    ...
    constructor(uint totalSupplyValue, address BATINUTeamAddress, address CharityBATINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BATINUTeam = BATINUTeamAddress;
        CharityBATINU = CharityBATINUAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BATINUTeam] =  totalSupply * 4 / 100;
        balances[CharityBATINU] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BATINUTeam pot
