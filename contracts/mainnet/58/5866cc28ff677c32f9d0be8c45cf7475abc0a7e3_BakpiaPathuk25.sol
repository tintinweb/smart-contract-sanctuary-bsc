...
contract BakpiaPathuk25 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BakpiaPathuk25";
    string private _symbol = "$BAKPIA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x086121B10cceC5Bf7827aE4C9d778BBb2e7Be085); // Marketing Address
    address payable public teamWalletAddress = payable(0x086121B10cceC5Bf7827aE4C9d778BBb2e7Be085); // Team Address
