...
/*
ItalianPizza Official
Aim to become one of the most popular utility token that served as a bridge across network, ItalianPizza will launch soon on 15th of August.

As the first step towards our dream, ItalianPizza will launch on BSC network, and soon will be follow up to Ethereum, Polygon, Cronos and so on.

Our official TG : https://t.me/ItalianPizzaOfficial

ItalianPizza will have 1 Trillion of supply, with 10% tax fees which allocated into:
1) 3% to Marketing
2) 3% to Development
3) 2% to LP
4) 2% for Buy Back
...
contract ItalianPizza is Context, IERC20 { 
    ...
    string private constant _name = "ITALIANPIZZA"; 
    string private constant _symbol = "IPIZZA"; 
