...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x2FFEf6F778c4910f9267e2fb8Ec1cec83347DA8A; // owner address
...
contract WLLETAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WalletAI";
    string private _symbol = "WaI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2FFEf6F778c4910f9267e2fb8Ec1cec83347DA8A); // Marketing Address
    address payable public teamWalletAddress = payable(0x2FFEf6F778c4910f9267e2fb8Ec1cec83347DA8A); // Team Address
