...
contract SEKIROToken is SEKIROTokenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SEKIROTokenTeam;
    address private CharitySEKIROToken;
    ...
    string public override name = "SEKIRO Token";
    string public override symbol = "SEKIRO";
    ...
    constructor(uint totalSupplyValue, address SEKIROTokenTeamAddress, address CharitySEKIROTokenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SEKIROTokenTeam = SEKIROTokenTeamAddress;
        CharitySEKIROToken = CharitySEKIROTokenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SEKIROTokenTeam] =  totalSupply * 45 / 100;
        balances[CharitySEKIROToken] = totalSupply * 45 / 100;
