...
/**
 ...
 WHEN MOON ? WHEN LAMBO ? STEALTH LAUNCH SOON !!
 
 1% MAX TX
 2% MAX WALLET
 11% TAX

 https://t.me/LamborghiniTokenBSC
...
contract LAMBO  is Context, IERC20, Ownable {
    ...
    string private _name = "Lamborghini Token";
    string private _symbol = "LAMBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd13e818975540369c74E68D1b0faeAFD1B4e56CA);
    address payable public teamWalletAddress = payable(0xd13e818975540369c74E68D1b0faeAFD1B4e56CA); 
