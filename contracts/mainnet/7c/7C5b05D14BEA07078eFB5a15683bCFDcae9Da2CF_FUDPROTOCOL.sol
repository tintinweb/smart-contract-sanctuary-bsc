...
/**
Telegram: https://t.me/FUDProtocol
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48b71894A3931951C9df7CE78ed56aE6A2ba3212; 
...
contract FUDPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUD PROTOCOL";
    string private _symbol = "$FUD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48b71894A3931951C9df7CE78ed56aE6A2ba3212);
    address payable public teamWalletAddress = payable(0x48b71894A3931951C9df7CE78ed56aE6A2ba3212); 
