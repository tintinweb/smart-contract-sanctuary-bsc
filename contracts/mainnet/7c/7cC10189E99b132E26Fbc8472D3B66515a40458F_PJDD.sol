...
contract PJDD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PJDD";
    string private _symbol = "PJDD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9e8A6DCC6973C8C7266E600c4aB3C613cFC3Af6);
