...
❗️ TEAM IS ACTIVE, AVAILABLE, AND READY TO ANSWER ALL QUESTIONS/CONCERNS! 

🔥 DON'T MISS OUT ON THIS AMAZING OPPORTUNITY TO BE APART OF THE DISNEY'S MIRRORVERSE FAMILY! 🔥
...
🔥 Burn  = 50% 
🔒 LP Locked
✨ Redistribution To ALL holders = 6% $BUSD 
💧 MARKETING = 3%
💥 Liquidity Pool = 3%
❗️ Charity = 2%
💨 TX Fee = 12%-18%

📌 READ THE PINS 📌 for Updates

Telegram : t.me/DisneysMirrorverse
 BLOG    : http://disneysmv.home.blog
Website : coming soon
TWITTER : coming soon
MEDIUM: coming soon
...
contract DISNEYSMIRRORVERSE is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DISNEYS MIRRORVERSE";
    string constant _symbol = "$DSMV";
