...
contract DW is Context, IERC20, Ownable {
    ...
    string private _name = "Drone War I";
    string private _symbol = "Drone War I";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE2136A9a1b6C395Ba0F377e1EE2a6e76C19EB7A2); // Marketing Address
    address payable private teamWalletAddress = payable(0xE2136A9a1b6C395Ba0F377e1EE2a6e76C19EB7A2); // Team Address
