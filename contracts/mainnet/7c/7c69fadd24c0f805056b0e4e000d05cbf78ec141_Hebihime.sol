...
contract Hebihime is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1_500_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000 * 10**9; //
    string private constant _name = "Hebihime Inu"; //
    string private constant _symbol = "Hebihime Inu"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x76818f10db4e9e017308Fd48f2a5E1b7fCB58FA2 ;
