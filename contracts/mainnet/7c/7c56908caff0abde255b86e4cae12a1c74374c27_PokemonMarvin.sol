...
/**
Once upon a time, in the city of Palo Alto, there lived a famous billionaire named Elon Musk and his loyal dog, Marvin. Marvin was no ordinary dog, he was a Pokemon.
One day, while on a walk with Elon, Marvin suddenly started to glow. Elon was amazed and couldn't believe his eyes. 
Marvin then evolved into a Pikachu and shocked Elon with a thunderbolt.
Elon quickly realized that Marvin was special and that he had a unique talent - the ability to control electricity. 
From that day forward, Elon and Marvin embarked on many adventures, traveling to different cities to battle
other Pokemon and becoming known as the powerful duo of "okemonMarvin.
Despite their success, Marvin never forgot his humble beginnings as a regular dog and always remained loyal to Elon. 

Together, they continued to dominate the Pokemon world, inspiring many young trainers to follow in their footsteps.

The story of PokemonMarvin spread far and wide, becoming a legend that would never be forgotten.
*/
...
contract PokemonMarvin is IBEP20, Ownable {
    ...
    string constant _name = "PokemonMarvin";
    ...
    address public marketingFeeReceiver = 0x40F1bB8a5294Aa391aB7620422AD61Fb11677e0a;
