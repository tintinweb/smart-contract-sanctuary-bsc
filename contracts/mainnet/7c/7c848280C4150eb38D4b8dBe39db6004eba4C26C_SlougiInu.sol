...
contract SlougiInu is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "SLOUGI INU";
    string constant _symbol = "SLOUGI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xC9B64DcF968c505Cf8aD57cEC9ae7e9285400428;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0xC9B64DcF968c505Cf8aD57cEC9ae7e9285400428;
