...
/*
tg.me/shibaaabsc
  ______   __    __  ______  _______       ______          ______          ______     
 /      \ |  \  |  \|      \|       \    _/      \_      _/      \_      _/      \_   
|  $$$$$$\| $$  | $$ \$$$$$$| $$$$$$$\  /   $$$$$$ \    /   $$$$$$ \    /   $$$$$$ \  
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 1_234_567_890;
    ...
    uint256 public _maxTxAmount = 12_345_678 * 10**9;
    uint256 public _maxWalletAmount = 24_691_356 * 10**9;

    uint256 private numTokensSellToAddToLiquidity = 123_456 * 10**9;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != address(this) && from != address(this)) {
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");

            if (to == uniswapV2Pair) {
                require(amount.add(balanceOf(address(from))) <= _maxWalletAmount, "Transfer amount exceeds the maxWalletAmount.");
            }
    ...
    function setBotProtectStatus(bool value) external onlyOwner
    {
        BPEnabled = value;
    }

    function initBotProtection(address _bpAddr) external onlyOwner
    {
