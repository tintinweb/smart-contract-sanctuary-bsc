...
// solhint-disable
contract SATAKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xac0AAD821b2117c7E5a0931F5116aAc636eAA0dd);
    ...
    string private constant _name = "Sataken Inu";
    string private constant _symbol = "SATAKEN";
