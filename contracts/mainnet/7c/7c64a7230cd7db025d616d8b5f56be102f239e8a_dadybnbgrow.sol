...
contract dadybnbgrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xacbc4dA7Ad8e72FD54eBBFbf6E239617B36EE919); 

    address payable public Dev_Wallet = payable(0xeC1178121460f39302F4a1d688E504C816CA7d20);
    ...
    string private constant _name = "Dady BNB Grow"; 

    string private constant _symbol = unicode"bGrow"; 
    ...
    constructor () {
        ...
        _owner = 0xeC1178121460f39302F4a1d688E504C816CA7d20; 
