...
/**
        Tanuki Inu (TANUKI)
        Telegram: t.me/TanukiInuPortal
        Tanuki is a Japanese Racoon Dog. Experienced and safe dev. Let's band together to create a strong community and work our way to success.
*/
...
contract TANUKIINU is ERC20, Ownable {
    ...
    string constant _name = "Tanuki Inu";
    string constant _symbol = "TANUKI";
    ...
    address public marketingFeeReceiver = 0x2F4219cb0384edEF5299f1C5946c6f7B753a8737;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x2F4219cb0384edEF5299f1C5946c6f7B753a8737] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x2F4219cb0384edEF5299f1C5946c6f7B753a8737] = true;
