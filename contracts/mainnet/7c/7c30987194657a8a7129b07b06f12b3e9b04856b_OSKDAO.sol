...
contract OSKDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x4f1C0e948D735efDD9ab93c7E7D8CC027c5Ddb4b;
    address public receiveSellFeeWallet = 0x4Eb900A7beBB1A313F880FB83ab25eEcccf76f24;
    IWrap public wrap = IWrap(0xFfaB00B4172457258E871B974166095B8CD399b6);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("OSK Coin DAO", "OSKDAO", 8, 10000000 * 10 ** 8){
        address msgSender = _msgSender();
