...
contract GRUSHKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "GRUSHKing";
    string private _symbol = "GRUSHKing";
    ...
    constructor () {
        ...
        _________[uniswapPair] = true;

        teamWalletAddress = payable(address(0x804a35285025637eCA112466e5744e5087F7FdFD));
        ________ = payable(address(0x804a35285025637eCA112466e5744e5087F7FdFD));
