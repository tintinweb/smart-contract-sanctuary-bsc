...
contract BabyBMB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyBMB";
    string private _symbol = "BabyBMB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2EDd879397047e1df760a64f308dF13a0652B992); 
    address payable private teamWalletAddress = payable(0x1276c7944822F895C8A94656BF9Fb375Fdd28418); 
