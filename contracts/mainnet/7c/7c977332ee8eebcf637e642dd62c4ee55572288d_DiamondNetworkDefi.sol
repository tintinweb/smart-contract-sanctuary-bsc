...
Diamond Network  In the Scalability Trilemma, blockchain project developers must rack their brains to optimize 
and balance the three main aspects of blockchain, namely decentralization, security, and scalability

   telegram official : https://t.me/diamondnetworkdefi
...
contract DiamondNetworkDefi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x0AE5c50F70960DA8028b9702461702dCa0fEA6a0));


    string private _name = "Diamond Network Defi";
