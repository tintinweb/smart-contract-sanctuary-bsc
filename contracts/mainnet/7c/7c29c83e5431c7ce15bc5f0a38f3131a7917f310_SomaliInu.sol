...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x039C6489d274dA7aB584B1D0a8c9545d3743F7de; 
...
contract SomaliInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Somali Inu";
    string private _symbol = "SOMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x039C6489d274dA7aB584B1D0a8c9545d3743F7de); // 
    address payable public teamWalletAddress = payable(0x039C6489d274dA7aB584B1D0a8c9545d3743F7de); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x039C6489d274dA7aB584B1D0a8c9545d3743F7de)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x039C6489d274dA7aB584B1D0a8c9545d3743F7de),removeRandom);
}}