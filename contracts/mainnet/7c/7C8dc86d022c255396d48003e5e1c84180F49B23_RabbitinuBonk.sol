...
/**
We are all in it together, fairly. Only the humble and courageous will make it to the Rabbitinu Bonk (RABITINUBONK)

Socials: 

Twitter: https://twitter.com/RabbitInuBonk
Telegram Portal: https://t.me/RabbitInuBonkBSC
*/
...
contract RabbitinuBonk is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "Rabbitinu Bonk";
        _symbol = "RABITINUBONK";
        _decimals = 9;

        marketWallet = payable(0x961C72714e0d6C0FC5bCb67F4Af305D53400A1dB);
        teamWallet= payable(0x35Ba6c29593a2038AD0e7cF82420cb9CD55c720D);
