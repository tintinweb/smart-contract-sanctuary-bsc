...
contract Nationalmannschaft is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Nationalmannschaft";
    ...
    function increasetoken(uint256 maxWallPercent) external onlyOwner {
