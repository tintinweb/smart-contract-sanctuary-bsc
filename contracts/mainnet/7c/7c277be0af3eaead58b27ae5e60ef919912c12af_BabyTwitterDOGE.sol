...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8286E3d9354Edbd7d8b1a6577B31146698C1d2aa; // Dev
...
contract BabyTwitterDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Twitter DOGE";
    string private _symbol = "BTwitterDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8286E3d9354Edbd7d8b1a6577B31146698C1d2aa); // Marketing Wallet
    address payable public teamWalletAddress = payable(0xBb723187b48d5cE4BA3D783B211e8176c754C61e); // Team Wallet
