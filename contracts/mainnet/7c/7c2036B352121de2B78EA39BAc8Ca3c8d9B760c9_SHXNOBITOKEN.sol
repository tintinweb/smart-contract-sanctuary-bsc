...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x255745535932a34bD7c95f2b3706252ebf409dc7; // owner address
...
contract SHXNOBITOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHXNOBI TOKEN";
    string private _symbol = "SHXNOBI"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x255745535932a34bD7c95f2b3706252ebf409dc7);
    address payable public teamWalletAddress = payable(0x255745535932a34bD7c95f2b3706252ebf409dc7); 
