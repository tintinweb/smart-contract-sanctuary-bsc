...
contract BorutoInu is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x2Bd8a2Cd6f53aBdDa75Fc6b4a5fC1246B2df73C6); 
    address payable private Wallet_Dev = payable(0x2Bd8a2Cd6f53aBdDa75Fc6b4a5fC1246B2df73C6);
    ...
    string private constant _name = "BORUTO INU"; 
    ...
    constructor () {
        ...
        _owner = 0x2Bd8a2Cd6f53aBdDa75Fc6b4a5fC1246B2df73C6;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2Bd8a2Cd6f53aBdDa75Fc6b4a5fC1246B2df73C6); // Testnet
