...
contract RoastBeefBusd{
    ...
    function sellEggs() public{
        ...
        busd.transfer(ceoAddress, fee);
        busd.transfer(msg.sender, SafeMath.sub(eggValue,fee));
    }
    function buyEggs(uint256 amount, address ref) public {
        require(initialized);
        busd.transferFrom(msg.sender,address(this), amount);

        uint256 eggsBought=calculateEggBuy(amount,SafeMath.sub(busd.balanceOf(address(this)),amount));
