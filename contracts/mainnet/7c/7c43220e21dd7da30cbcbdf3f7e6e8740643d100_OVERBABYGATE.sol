...
contract OVERBABYGATE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OverBabyGate";
    string private _symbol = "OverBabyGate";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf0548929318Cb7786dBDF2Cac28596F5eCc65E2E); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0xc7af4e00f836243Acd134908FeA2e0b34fEDEeC6); // Developmental Address
