...
/**
https://t.me/penisgrow

Come watch and join the ever growing penis as it climaxes at milestone MCs and unleashes the whole climax wallet out on the chart and holders. 
...
contract PenisGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x953173578E68642931a43672B2734661784C8030); 
    address payable public Wallet_Climax = payable(0xcdE55102F94b6067aE996d7D1f388DC4Af728FC6);
    ...
    string private constant _symbol = unicode"Climax"; 
    ...
    uint256 public Percent_Climax = 30;
    uint256 public Percent_Burn = 0;
    uint256 public Percent_AutoLP = 0; 

    uint256 public _maxWalletToken = _tTotal / 33;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal / 33; 
    ...
    constructor () {
        ...
        _owner = 0xcdE55102F94b6067aE996d7D1f388DC4Af728FC6;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Climax / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Climax);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Climax * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Climax);
            ...
            sendToWallet(Wallet_Climax, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Climax, removeRandom);
