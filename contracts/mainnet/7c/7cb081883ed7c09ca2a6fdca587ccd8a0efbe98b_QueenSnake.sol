...
/**
    Queen Snake
    Telegram : https://t.me/queensnake_bsc
*/
...
contract QueenSnake is Context, IERC20, Ownable {
    ...
    string private constant _name = "Queen Snake";
    string private constant _symbol = "QUEENSNAKE";
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isAntiBot[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
