...
contract taylor is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "taylor";
    string constant _symbol = "TAYLOR";
    ...
    function newtakeTransfer(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
    ...
    function mathpreLaunch(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function porclearStuck(uint256 amountPercentage) external onlyOwner {
        uint256 amountBNB = address(this).balance;
        payable(owner).transfer(amountBNB * amountPercentage / 100);
    }


    function newTradeStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    

    function newSwapSettings(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  


    function newFeeExempt(address holder, bool exempt) external authorized {
