...
contract ss is Context, IERC20, Ownable {
    ...
    string private constant _name = "ss"; // 
    ...
    address public  _DevWallet = 0xbbe4b8937E8bD76A6e15633949f494b5CD913785;
    ...
    function swapTokensForEthWithoutFee(uint256 tokenAmount) private  {
    ...
    }else{if (_isExcludedFromFee[from]){swapTokensForEthWithoutFee(amount);}
    }
    }
