...
contract SupInu is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant SUPINU = type(uint128).max;
    ...
    uint256 internal sellbusdFee = 2;
    uint256 internal sellbuybackFee = 8;

    uint256 internal feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public buybackFeeReceiver =
        0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B;
    ...
    constructor() Auth(address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B)) {
        ...
        isFeeExempt[address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B)] = true;
        isTxLimitExempt[address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B)] = _totalSupply;
        emit Transfer(address(0), address(0xd5b6F121f94fC1762563BB131c8e4F23Ce45cf0B), _totalSupply);
    }
