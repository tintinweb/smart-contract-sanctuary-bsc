...
/**
    ...
    https://t.me/winterbear_channel
    https://winterbear.xyz/
...
contract WBEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Winter Bear";
    string private _symbol = "WBEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03ceB279d5D7a140c76F7CB1c00265f1a74ddaB9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0ada8006B557b7b73E4CEB393726d41aF0125063); // BuyBack Address
    ...
    uint256 private minimumTokensBeforeSwap = 4 * 10**3 * 10**9; 
