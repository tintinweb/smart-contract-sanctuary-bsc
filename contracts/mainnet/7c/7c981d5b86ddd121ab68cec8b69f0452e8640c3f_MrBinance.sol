...
contract MrBinance is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Mr. Binance";
    string constant _symbol = "MR.BINANCE";
    ...
    address private marketingFeeReceiver = 0xadE058dCC4b40E85f5ee6f60045569fdb5068B21;
    ...
    constructor (address _address) Ownable(msg.sender) {
        ...
        isFeeExempt[0xadE058dCC4b40E85f5ee6f60045569fdb5068B21] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xadE058dCC4b40E85f5ee6f60045569fdb5068B21] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xadE058dCC4b40E85f5ee6f60045569fdb5068B21,
                block.timestamp
            );
