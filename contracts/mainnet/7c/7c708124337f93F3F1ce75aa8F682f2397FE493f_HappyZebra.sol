...
contract HappyZebra is Context, IERC20, Ownable {
    ...
    // 10% Buy tax 
    uint256 private _buyTaxFee = 1;   // Reflection fee 1%
    uint256 private _buyLiquidityFee = 3;  // Liquidity fee 3%
    ...
    uint256 private _sellMarketingFee = 6;   // Markting fee 6%
    uint256 private _sellDevFee = 2; // Dev fee 2%
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0xA951C11420Abe9DCb63566EDCAc00c8ac3fB0836; // Marketing wallet 
        _devWalletAddress = 0xbB3b07e4ab744A1b361327334a61490cB5328b87; // Dev wallet 
