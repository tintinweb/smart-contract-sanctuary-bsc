...
contract EverWealth is Context, IERC20, Ownable {
    ...
    string private _name = "EverWealth";

    string private _symbol = "EWEALTH";
    ...
    address payable public marketAddress = 0x8454B6f70035cFC413054D2E8385c53A9A6EBA5c; //Marketing
   
    address payable public BTCAddress = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
