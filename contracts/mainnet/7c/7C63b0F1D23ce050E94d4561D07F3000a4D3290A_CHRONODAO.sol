...
contract CHRONODAO is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 15;
    uint256 public rewardYieldDenominator = 100000;
    uint256 public rebaseFrequency = 480;
   ...
   antiBotEnabled = _enable;
    ...
    function setFees(
        ...
        totalFee = liquidityFee.add(marketingFee).add(firePitFee);
