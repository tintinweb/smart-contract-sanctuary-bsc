...
contract GOLD is Context, IERC20 { 
    ...
    string private constant _name = "Floki Gold Sachs";
    string private constant _symbol = unicode"FLOKIGOLD";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0xA3bD20d2120046f4b4838343be021dCe3Ff4b22a);
    address payable private MarketingWallet = payable(0xA3bD20d2120046f4b4838343be021dCe3Ff4b22a);
