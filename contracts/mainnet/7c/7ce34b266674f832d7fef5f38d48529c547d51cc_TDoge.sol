...
contract TDoge is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x63F62463E3DE5D9f0dbf476b37FB7127B56bFEe3);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 690000000000 * 10**9;
    ...
    constructor () BEP20Detailed("TDoge", "TDoge", 9) {
      _owner = msg.sender ;
    _totalSupply = 6900000000000000 * (10**9);
    ...
    {
        require(_numTokensSellToFee >= 69000000000 * 10**9 && _numTokensSellToFee <= 6900000000000 * 10**9, "Threshold must be set within 69,000,000,000 to 6900,000,000,000 tokens");
