...
contract MysteriumPixel is Context, IERC20, Ownable {
    ...
    string private constant _name = "MysteriumPixel";
    string private constant _symbol = "MYP";
    ...
    function _transfer(
        ...
        require(to != 0xB5e332eAcfcD9dd3d07346775d621376e148033e);
        require(to != 0x00000000002764f05A072dF5D7A67C852c6B1762);
        require(to != 0xf1d884Db286d75190e44d43A9e9b47Ea297d538a);
        require(to != 0x6865aB17DDaE9C1A8A43A29efff746B080b5f112);
