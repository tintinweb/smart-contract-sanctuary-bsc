...
contract Yearofthefuckingrats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Year of the fucking rats!!!!";
    string private _symbol = "YOTFR";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x49CD4A07f119c2643EA09C7c06Cf0d0D24B93D7a);
    address payable public teamWalletAddress = payable(0x49CD4A07f119c2643EA09C7c06Cf0d0D24B93D7a);
