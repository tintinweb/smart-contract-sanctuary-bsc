...
The community is highly excited for this NFT project!

✅ NFTs are minted! 1K more are on its way. Part of revenues from NFT Sales go to holders, token buy back and burn.

✅ NFT Marketplace is almost ready. All transactions are in $PV, giving you more PV reflections!

✅ Partial-Marketing Roadmap will be released on a weekly basis.

💰 HUGE marketing budget are all to hit right after the launch. This will be going for 1000X! 🚀🚀🚀🌕

Together, let’s use the network power effect to build an amazing Alpha community!
*/
...
contract MD3X is Context, IERC20, Ownable {
