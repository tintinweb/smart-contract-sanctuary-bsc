...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA2a3d6346e16ac5b5Cdb6a2A0F66907Ce64673c8; // owner address
...
contract MUUCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MUUCAT";
    string private _symbol = "$MUUCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2a3d6346e16ac5b5Cdb6a2A0F66907Ce64673c8); // Marketing Address
    address payable public teamWalletAddress = payable(0xA2a3d6346e16ac5b5Cdb6a2A0F66907Ce64673c8); // Team Address
