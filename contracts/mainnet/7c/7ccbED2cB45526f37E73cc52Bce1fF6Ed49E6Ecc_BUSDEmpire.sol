...
contract BUSDEmpire {
    ...
    function getUpgradePrice(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [600, 3150, 15000, 64000, 200000][towerId];
        if (chefId == 2) return [900, 4000, 20000, 67500, 210000][towerId];
        if (chefId == 3) return [1250, 5900, 27500, 74000, 222500][towerId];
        if (chefId == 4) return [1750, 7600, 37500, 81000, 235000][towerId];
        if (chefId == 5) return [2150, 8350, 41000, 97500, 250000][towerId];
        if (chefId == 6) return [2400, 9050, 47500, 115000, 275000][towerId];
        revert("Incorrect chefId");
    }

    function getYield(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [5, 26, 125, 532, 1665][towerId];
        if (chefId == 2) return [8, 36, 180, 604, 1880][towerId];
        if (chefId == 3) return [12, 56, 263, 710, 2130][towerId];
        if (chefId == 4) return [18, 78, 383, 828, 2400][towerId];
        if (chefId == 5) return [24, 96, 461, 1095, 2810][towerId];
        if (chefId == 6) return [30, 113, 495, 1320, 3440][towerId];
        revert("Incorrect chefId");
    }
    ...
    function getStable(uint256 stableId) internal pure returns (uint256, uint256, uint256 ) {
        ...
        if(stableId == 2) return (75000, 40000, 3);
        if(stableId == 3) return (100000, 55000, 4);
