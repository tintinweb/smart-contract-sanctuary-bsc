...
contract RBT is BEP20, Ownable {
    ...
    address public marketingWallet = 0x44d2947Bf8BCab1275B7427b1f6a483DD0B01796;
    address public devWallet = 0xBCEb5a55C2A9376Bf77d9153FD5A4519FDc939c4;
    ...
    Taxes public taxes = Taxes(2, 0, 3);
    Taxes public sellTaxes = Taxes(2, 0, 3);
    ...
    constructor() BEP20("Run&Burn", "RBT") {
