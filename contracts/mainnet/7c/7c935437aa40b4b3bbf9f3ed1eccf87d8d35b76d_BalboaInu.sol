...
contract BalboaInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bolboa Inu";
    string private _symbol = "BL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1D0A8a17A69542580d8a5C2A57EA263d8a47aEc); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xd1D0A8a17A69542580d8a5C2A57EA263d8a47aEc); // BuyBack Address
