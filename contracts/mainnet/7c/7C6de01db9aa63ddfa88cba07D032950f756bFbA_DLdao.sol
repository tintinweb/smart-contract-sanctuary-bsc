...
contract DLdao is Context, IERC20, Ownable {
    ...
    address public OSKDAO = 0x55d398326f99059fF775485246999027B3197955;
    ...
    function setDistributionSettings(uint256 newLPShare, uint256 newMarketingShare, uint256 newNFTShare) external onlyOwner() {
        _lpShare = newLPShare;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {
            ...
            if(isMarketPair[sender]){
                _burnAmount = amount.mul(_buyBurnFee).div(_totalTaxIfBuying);
                _basicTransfer(sender, deadAddress, _burnAmount);
