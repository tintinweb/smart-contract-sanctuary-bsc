...
// SPDX-License-Identifier: MIT Llicensed
...
contract SHIHTZUINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIHTZU INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x84C053A6B572E7d87EeB5560bdfDEBFF17C149D3); // Marketing Address
    ...
    uint256 public _maxTxAmount = 2 * 10**10 * 10**9; // 2% max tnx
    uint256 public _walletMax = 3 * 10**10 * 10**9; // 3% max wallet
    uint256 private minimumTokensBeforeSwap = 500000000 * 10**9; // 0.05%
