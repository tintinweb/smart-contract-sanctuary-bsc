...
// File: contracts/StrategyAddBaseTokenOnlyWombat.sol
...
contract StrategyAddBaseTokenOnlyWombat is Ownable, ReentrancyGuard, Strategy {
        ...
        nonReentrant
    {
        ...
        (address baseToken, address fToken, uint256 minLPAmount, address fLpToken) = abi.decode(data, (address, address, uint256, address));
        ...
        fLpToken.safeTransfer(msg.sender, fLpToken.balanceOf(address(this)));
    }
