...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract BoredBullYachtClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x26f73844C3934c33f8845d3f05F7090122B4ec69); // Marketing Address

    address payable public teamAddress =
        payable(0x6d52cc4E6c15dC5093d75972A15368181608461B); // Team Address

    address payable public liquidityAddress =
        payable(0x880ad2fB532Fd21968Ea963a1806B5c32F32125A); // Liquidity Address
    ...
    string private constant _name = "Bored Bull Yacht Club";
