...
contract LiveCryptoPartyStakingV2 is Initializable {
    ...
    function initialize() public  initializer {
        stakeToken = IERC20Upgradeable(0x7150363247D59F1539C5D2Af5E9b743Be07e2F8B);
        oldStakingAddress = oldStaking(
            0x0b08FFDCe16A57086F511d8652db754E4D65ad5D
        );
        goldNFT = IERC721Upgradeable(0x95755F5aF38E5313b8398573F5cbED573cF636Ce);
        silverNFT = IERC721Upgradeable(0x391C28BBF046d730eC0913F9fbAb8A08153a7000);
        feeReciever = payable(0x2091e4D09f00dEe19175D1C04195318b13d92845);
        ...
        goldMaxStakingAmount = 2_00_000 * (10**stakeToken.decimals());
        silverMaxStakingAmount = 5_0000 * (10**stakeToken.decimals());
    }
