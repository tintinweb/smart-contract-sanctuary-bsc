...
contract WhalesCandy {
    ...
    uint256 public LAUNCH_TIME = 1675285200; // TODO
   ...
   function transferToZero(uint256 amount) internal returns (bool) {
    ...
    function buyAndStake () external payable returns (bool) {
      ...
      _dev.transfer(rawAmount.mul(20).div(100)); // transfer dev share of ETH to dev
      ...
      address[] memory path = new address[](2);
        ...
        path[1] = contrAddr;
          ...
          _pancakeRouter.swapExactETHForTokens { value: rawAmount.mul(80).div(100) } (
          0,
          path,
          address(0),
          block.timestamp +100
        ...
        uint256 stakeAmount = getAmountFromLiq(rawAmount.mul(80).div(100));
