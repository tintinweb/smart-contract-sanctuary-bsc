...
contract BeefBurglar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beef Burglar";
    string private _symbol = "Beeflar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFeB4A7004350617E77bb6E07314B1ce5c0861159);
    address payable public BuyBackWalletAddress = payable(0xFeB4A7004350617E77bb6E07314B1ce5c0861159);
