...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x69A2f86f76B5C5aE4F7415A1A6ac82Ab8b4E19b0); 
...
contract BabyBitcorn is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Baby Bitcorn";
    string constant _symbol = "BABYBITCORN";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0x69A2f86f76B5C5aE4F7415A1A6ac82Ab8b4E19b0 ; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x444283d07e6f92f3E8c17f42BDd1Ec083B20B7a8;  
        anothermarketingWallet = 0x444283d07e6f92f3E8c17f42BDd1Ec083B20B7a8;
