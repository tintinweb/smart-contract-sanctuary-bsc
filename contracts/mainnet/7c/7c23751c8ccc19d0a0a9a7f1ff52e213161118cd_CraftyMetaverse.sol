...
contract CraftyMetaverseDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("CraftyMetaverse_Dividend_Tracker", "CraftyMetaverse_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "CraftyMetaverse_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "CraftyMetaverse_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CraftyMetaverse contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(newClaimWait != claimWait, "CraftyMetaverse_Dividend_Tracker: Cannot update claimWait to same value");
...
contract CraftyMetaverse is BEP20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    CraftyMetaverseDividendTracker public dividendTracker;
    ...
    constructor() BEP20("Crafty Metaverse", "CMETA") 
    {
        BNBRewardsFee = 1;
        liquidityFee = 3;
        marketingFee = 6;
        ...
        dividendTracker = new CraftyMetaverseDividendTracker();
    ...
    function updateRouterAddress(address _router) public onlyOwner
    {
        ...
        {
            v2pairAddress = IUniswapV2Factory(uniswapV2Router.factory()).getPair(address(this), uniswapV2Router.WETH());
        }

        uniswapV2Pair = v2pairAddress;
