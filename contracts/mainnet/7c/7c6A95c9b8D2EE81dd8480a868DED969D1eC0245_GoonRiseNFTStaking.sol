...
contract GoonRiseNFTStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [3600, 0, 0, 0, 0];
    }
