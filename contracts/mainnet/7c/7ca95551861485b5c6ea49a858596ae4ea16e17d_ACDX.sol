...
contract ACDX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ACDX";
    string private _symbol = "$ACDX";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x59594C01BF329A377F6905131F5A80B9bB9b92Cd); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xA5fD0FA2eD100F7e5CcA7df5171E34Fe733B4158); // Team Address
