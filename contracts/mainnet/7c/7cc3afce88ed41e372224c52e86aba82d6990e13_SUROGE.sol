...
contract SUROGE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SUROGE";
    string private constant _symbol = "SUROGE";
    ...
    //Tax wallets
    address public teamWallet = msg.sender;
