...
/*
Telegram: https://t.me/shibaking_en
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4791446FD5B25628f3e3a9A29DB47072A40FB99a;
...
contract SHIBAKING is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x4791446FD5B25628f3e3a9A29DB47072A40FB99a);
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/70000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/70000;
    }
