...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb53efC2fe72bB71c6FE2116252e74Ff0780DeB5D; // owner address
...
contract retrocat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Retro Cat";
    string private _symbol = "RETROCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb53efC2fe72bB71c6FE2116252e74Ff0780DeB5D); // Marketing Address
    address payable public teamWalletAddress = payable(0xb53efC2fe72bB71c6FE2116252e74Ff0780DeB5D); // Team Address
