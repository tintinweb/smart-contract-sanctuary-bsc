...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x443d3aeDCBfdF3C00469FDd6f9fb5197EcD3a41e; // owner address
...
contract BlackHold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Black Hold ";
    string private _symbol = " BH ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x443d3aeDCBfdF3C00469FDd6f9fb5197EcD3a41e); // Marketing Address
    address payable public teamWalletAddress = payable(0x6134435E3E2f6Bb79b81D500Ea8175B88493224b); // Team Address
