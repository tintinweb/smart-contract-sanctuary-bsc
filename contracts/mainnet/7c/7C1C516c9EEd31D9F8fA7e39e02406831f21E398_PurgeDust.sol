...
/**
ALPHA PLAY - PurgeDust
Telegram : https://t.me/PurgeDust
Twitter: https://twitter.com/PurgeDust
Channel: https://t.me/PurgeDustChannel
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN Rewards
    IBEP20  PURGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PURGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(PURGE);
        ...
        uint256 amount = PURGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PURGE.transfer(shareholder, amount);
...
/* Token contract */
contract PurgeDust is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x9584432339057897A867752736D76625637C582B;

    // These are owner by default
    address private autoLiquidityReceiver = 0x0A735BcA4cF10810d5CE02885e326c272D74fe93;
    address private marketingFeeReceiver  = 0x0A735BcA4cF10810d5CE02885e326c272D74fe93;

    // Name and symbol
    string constant _name = "PurgeDust";
    string constant _symbol = "PDUST";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 5000 / 10000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 10000; // 2%
