...
/**
 * SURGE FLOW
 * Taxes: 6% (2% Dev, 2% Marketing, 2% Manual Buyback)
 * Max Wallet: 1% (1'000'000 $SFLOW)
 * Telegram: https://t.me/SurgeFLOW
 * Twitter: https://twitter.com/SurgeFlow_
 */
...
contract SurgeFlow is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Surge Flow";
    string private constant _symbol = "$SFLOW";
    ...
    //Tax wallets
    address public teamWallet = 0xB63426BD760566381770e4C060633dDcc4Ce0b93;
    address public treasuryWallet = 0x9033056955161D3182537640147d409d6ABab149;
    address public buybackWallet = 0x0D687856E90C3dA98C913748C533989df700c548;

    address private _pcsAddress= 0x10ED43C718714eb63d5aA57B78B54704E256024E;


    // Tax Split
    uint256 public teamShare = 34;
    uint256 public treasuryShare = 33;
    uint256 public buybackShare = 33;
    ...
    //trading parameters
    uint256 public liquidity = 2 * 10**5 * 10**_srgDecimals;
    ...
    function _transferFrom(
        ...
        require(
            recipient != address(0) && recipient != address(this) && recipient != _pcsAddress,
    ...
    function changeTaxDistribution(
        ...
        require(
            newteamShare + newtreasuryShare + newbuybackShare == SHAREDIVISOR,
    ...
    function changeFeeReceivers(
        ...
        require(
            newTeamWallet != address(0) && newTreasuryWallet != address(0)&& newBuybackWallet != address(0),
