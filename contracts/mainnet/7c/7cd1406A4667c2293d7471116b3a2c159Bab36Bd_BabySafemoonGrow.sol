...
contract BabySafemoonGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Safemoon Grow";
    string private constant _symbol = "BSMGROW";
