...
Pink Shiba Inu is the world’s most accessible NFT platform for creators, HODLers, and normies alike. 
From JPEGs, to music, and of course, all-things-meme.

🖌⚙️ 2% Automatic additional liquidity for each transaction to develop the market cap so that it continues to grow.

🖌💎 A generous 3% reflections for our holders, making sure your bags adds up in value over time from the trading volume. Hold to grow!

🖌🪙 Marketing & Development 5% from each transaction is deducted that adds up in the marketing wallet to make sure we never run out of the fuel to propel the $Pinu rocket.

Join Us :
 Tg : https://t.me/pinkshibainuofficial
 Web: https://circuscoin.simdif.com/
...
contract PinkShibaInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "PINK SHIBA INU"; // 
    string private constant _symbol = "PinkshibaInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x51099a36533dd58260687B80e4fd2eE3130d7381;
