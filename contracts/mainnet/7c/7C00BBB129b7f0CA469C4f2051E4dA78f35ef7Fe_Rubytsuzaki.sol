...
/**
 Welcome to the next trend in BSC Ruby tsuzaki inu

 Rubytsuzaki is a token on the Binance Smart Chain that never stops growing through TRUE deflationary techniques and 
further income generation for its ecosystem. Our contract is fully renounced.
Everyone can participate in every step of Rubytsuzaki growth. As Rubytsuzaki explores the BSC world to fight rugpulls and scams,
he hopes to finally seek the peace he long waiting for.
...
//ORIGANALY CODE BY RUBY TSUZAKI INU
interface IERC20 {
...
library Address{
 ...
 contract Rubytsuzaki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ruby tsuzaki inu";
    string private constant _symbol = "Ruby tsuzaki";
