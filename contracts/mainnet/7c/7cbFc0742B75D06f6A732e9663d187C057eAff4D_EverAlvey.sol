...
contract EverAlvey is Context, IERC20, Ownable {
    ...
    string private constant _name = "EverAlvey"; // 
    string private constant _symbol = "$EverALVEY "; //    
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xAE39F6978f7bcC3Fc8E4602fA97D8C9DD1E81bEC;
