...
contract LaunchPadAmaltheus is Ownable {
    ...
    uint256 public round1Duration = 3600; // in secondes 3600 = 60min
    ...
    uint256 public NFTTarget = 200;
    uint256 public NFTPrice = 180 * 1E18;
    ...
    function buyRound1Stable(uint256 _amount) external {
        ...
        require(
            round1Allowance[msg.sender] >= _amount.mul(NFTPrice),
