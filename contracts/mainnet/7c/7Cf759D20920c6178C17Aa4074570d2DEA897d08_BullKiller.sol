...
contract BullKiller is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xf7aABf94049f510ab72E13feae158b3Db82C0147); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x7cFbC6c91DabC77812f3356f75Fdb53e1EBB495c); // Liquidity Address
    ...
    uint256 private constant _tTotal = 1000000000000000000000000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "BullKiller";
    string private constant _symbol = "BullKiller";
    ...
    constructor() {
        address newOwner = address(0x7cFbC6c91DabC77812f3356f75Fdb53e1EBB495c);
        ...
        minimumTokensBeforeSwap = _tTotal * 1 / 10000; // 0.02% swap tokens amount
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(boughtEarly[from]  && earlyBuyPenaltyEnd >= block.number){
                    _taxFee = _taxFee * 10;
                    _liquidityFee = _liquidityFee * 20;
                }
