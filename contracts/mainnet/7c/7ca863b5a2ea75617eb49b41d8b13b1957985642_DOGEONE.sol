...
// Custom contract by https://gentokens.com/ created for DOGEONE only
...
contract DOGEONE is Context, IERC20 { 
    ...
    */
    ...
    address payable public Wallet_SolidityDev = payable(0xde491C65E507d281B6a3688d11e8fC222eee0975);    // Solidity Developer
    ...
    uint256 public Fee_Buy          = 0;  // After Presale will be set to 10
    uint256 public Fee_Sell         = 0;  // After Presale will be set to 15
    uint256 public Fee_P2P          = 0;  // After Presale will be set to 10

    // Reflection amount for Buys/Sells/Transfers (These must be included in the above TOTAL fees!)

    uint256 public Reflect_Buy      = 0;
    uint256 public Reflect_Sell     = 0;  // After Presale will be set to 2%
    ...
    Max wallet holding will be limited to 0.05% for the first block - Anti Snipe
