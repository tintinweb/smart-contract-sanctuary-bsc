...
/**
 欢迎来到兔子女王！ TùzǐQueen 是 BSC 上为庆祝农历新年而推出的新 COIN 加密货币！ TùzǐQueen 是一个社区代币，第一个小时的税率为 20/20。 下一个小时税率将是 5/5。 流动性将被锁定在 UNICRYPT 中，所有权将被放弃。

https://t.me/tuziqueenCN
*/
...
contract TuziQueen is Context, IERC20 {
    ...
    string private _name = "TuziQueen";
    string private _symbol = "TuziQueen";

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    uint256 public _Tax_On_Buy = 19;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x1C31053830cAbF5c2E11315468552ca0f6F2Ca65);
