...
/**
Telegram: https://t.me/BabyPixelUniverse
*/
...
contract BabyPixelUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xb16FacC7A750A1C6948fee26e9F099DbB1178efF); // Marketing Address
        
    address payable public teamAddress =
        payable(0x52E96c0dFD0616832f4BBa7cA2D336bA6A7a786e); // Team Address
        
    address payable public liquidityAddress =
        payable(0x52E96c0dFD0616832f4BBa7cA2D336bA6A7a786e); // Liquidity Address
    ...
    string private constant _name = "Baby Pixel Universe";
    string private constant _symbol = "BABY PIXEL";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 8 / 1000; 
        maxWallet = 1.5 * 1e6 * 1e18;
        blackListFee = 99;
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 10, "Must keep taxes below 10%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 10, "Must keep taxes below 10%");
