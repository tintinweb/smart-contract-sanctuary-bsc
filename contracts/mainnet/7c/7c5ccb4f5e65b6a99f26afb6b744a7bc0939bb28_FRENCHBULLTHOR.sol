...
/*  
    French Bull Thor
    Telegram : https://t.me/frenchbullthor
 */
...
contract FRENCHBULLTHOR is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isPhase;
   
    uint256 private _tTotal = 1 * 10**9 * 10**9;
    uint256 public _maxWallet = _tTotal/10;
    uint256 private _liquifyThreshhold = _tTotal/100;

    string private constant _name = "French Bull Thor";
    string private constant _symbol = "FBTHOR";
    uint8 private constant _decimals = 9;
    
    uint256 private _marketingFee = 3;
    uint256 private _liquidityFee = 0;

    address private  _marketingWallet = 0xf47b498a9D0dC59634D2A51f5ed975E2B21B5e69;
