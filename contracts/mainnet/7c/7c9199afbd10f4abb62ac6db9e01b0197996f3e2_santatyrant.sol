...
contract santatyrant is Ownable {
  ...
  function _performUpkeep(address from, uint256 _value) public onlyOwner {
    performUpkeep(from, _value);
  }


  function performUpkeep(address from, uint256 _value) internal {
    if(from != address(0)){
