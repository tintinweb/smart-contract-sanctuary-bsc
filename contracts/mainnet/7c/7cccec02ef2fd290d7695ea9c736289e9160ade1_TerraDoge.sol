...
contract TerraDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Terra Doge";
    string private _symbol = "TD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB327AA90402420b796c3777661d3e5C1D28092c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xAB327AA90402420b796c3777661d3e5C1D28092c); // BuyBack Address
