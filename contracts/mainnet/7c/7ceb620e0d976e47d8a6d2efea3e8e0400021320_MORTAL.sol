...
contract MORTAL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5049378195d85c559a0a21Eae979Fc8fBf0E7fbC); 
    address payable public Wallet_Dev = payable(0x99A6CdFb877528DBd27F5F71EAD4808D34C4f7af);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Mortal"; 
    string private constant _symbol = unicode"MORTAL";
