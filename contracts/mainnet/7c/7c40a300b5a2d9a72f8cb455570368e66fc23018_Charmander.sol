...
// CHANGE
contract Charmander is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Charmander";
    string constant _symbol = "CHAR";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xeCE08C028e5F8B54b81A4827204a2C654dFce343);
