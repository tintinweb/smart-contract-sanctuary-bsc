...
contract KandyChef is Ownable {
    ...
    IKandyStaking public rewardMinter;
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "KandyChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(
            ...
            "KandyChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND"
        );
        massUpdatePools();
    ...
    function setRewardMinter(IKandyStaking _rewardMinter) external {
        require(
            address(rewardMinter) == address(0),
            "KandyChef::setRewardMinter: Cannot redefine rewardMinter"
        );
