...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "killbabyokx";
    string private _symbol = "killbabyokx";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x2d5Ca841d82aead23A641D468556a9Cc9A0dDa28);
    address payable public teamWalletAddress = payable(0x2d5Ca841d82aead23A641D468556a9Cc9A0dDa28);
