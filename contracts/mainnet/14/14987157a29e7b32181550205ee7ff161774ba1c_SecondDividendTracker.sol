...
/**
 SquidFarm aims to be the only basket, worthy of your Eggs.
 SquidFarm is a 100% community driven token meant to reduce the risks in this degen space!
 Purchasing and Holding SquidFarm could be your final chance to secure financial Success. Period.
 https://t.me/squidfarmbsc
*/
...
contract SquidFarm is Context, ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public DividendsTokenFirst = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    address public DividendsTokenSecond = address(0x88479186BAC914E4313389a64881F5ed0153C765);
   ...
   SecondDividendTracker public dividendTrackerSecond;
    ...
    constructor() ERC20 ("SquidFarm", "SquidFarm") {
        _buyRewardsFeeFirst = 1;
        _buyRewardsFeeSecond = 3;
        _buyLiquidityFee = 5;
		_buyMarketingFee = 4;
        _buyDevFee = 2;

        _sellRewardsFeeFirst = 1;
        _sellRewardsFeeSecond = 3;
        _sellLiquidityFee = 5;
		_sellMarketingFee = 4;
        _sellDevFee = 1;
        ...
        _maxWallet = 100000000000 * (10**18);
        _maxBuy = 100000000000 * (10**18);
        _maxSell = 100000000000 * (10**18);
		...
		marketingWallet = payable(0x4447Ba84C9593976DC6d62D9d4545fEC0aE84B50);
        _devWallet1 = payable(0x5238c2F23C0AeEF4C9A8E573F461b4cA77Dd8c6c);
        _devWallet2 = payable(0xCee9Aa269f0a076efde039c4a99D47b8EBECe65F);
        _devWallet3 = payable(0xf70b80d5bd9EDDC9b9Fe3e00D24AaA07f570B7c3);
        _devWallet4 = payable(0x17126979466D0db6673F9502E5B2B8D717e2496D);
        _devWallet5 = payable(0x67b9Fa3583094fd61078255A97cC57bB950C8774);
    ...
    function updateDividendTrackerFirst(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerFirst), "SquidFarm The dividend tracker already has that address");

        FirstDividendTracker newDividendTrackerFirst = FirstDividendTracker(payable(newAddress));

        require(newDividendTrackerFirst.owner() == address(this), "SquidFarm: The new dividend tracker must be owned by the SquidFarm token contract");
    ...
    function updateDividendTrackerSecond(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerSecond), "SquidFarm The dividend tracker already has that address");

        SecondDividendTracker newDividendTrackerSecond = SecondDividendTracker(payable(newAddress));

        require(newDividendTrackerSecond.owner() == address(this), "SquidFarm: The new dividend tracker must be owned by the SquidFarm token contract");
    ...
    function updateFirstDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenFirst), "SquidFarm: The router already has that address");
    ...
    function updateSecondDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenSecond), "SquidFarm: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SquidFarm: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SquidFarm: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "SquidFarm: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SquidFarm: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SquidFarm: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SquidFarm: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "SquidFarm: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SquidFarm: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SquidFarm: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
		...
		if(canSwap && !swapping && !automatedMarketMakerPairs[from] && from != liquidityWallet && to != liquidityWallet && from != marketingWallet && to != marketingWallet && !_isExcludedFromFees[to] && !_isExcludedFromFees[from]) {
            ...
            devAmount = devAmount.sub(devSplit).sub(devSplit).sub(devSplit).sub(devSplit);
            ...
            transferToWallet(payable(_devWallet4), devSplit);
            transferToWallet(payable(_devWallet5), devAmount);
            ...
            emit Transfer(address(this), _devWallet4, devSplit);
            emit Transfer(address(this), _devWallet5, devAmount);
            }
    ...
    function v2RelauncAirdrop() internal {

        // This is an Airdrop for the v1 investors.  This functio is only called in the
        // Constructor and can never be called again.
...
contract FirstDividendTracker is Ownable, DividendPayingToken {
    ...
    address private DividendToken = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    constructor() DividendPayingToken("First_Dividend_Tracker", "First_Dividend_Tracker", DividendToken) {
        ...
        isAuth[owner()] = true;
        isAuth[address(0xbE53AE18b3FF7126576D6618c64a347a478278A8)];
    }
...
contract SecondDividendTracker is Ownable, DividendPayingToken {
    ...
    address private DividendToken = address(0x88479186BAC914E4313389a64881F5ed0153C765);
