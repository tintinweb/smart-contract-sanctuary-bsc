...
interface IDividendDistributor {
    ...
    function  setRewardToken ( IBEP20 _Inch) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public Inch = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    ...
    function setRewardToken (IBEP20 _Inch) external override onlyToken {
        Inch = IBEP20(_Inch);
    }
...
/* Token contract */
contract Testicle is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address Inch = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Testicle";
    string constant _symbol = "$TESTIS";
...
*/
    ...
    //New function to set the Reward
    function setRewardToken(IBEP20 _Inch) external authorized {
        distributor.setRewardToken(_Inch);
    }
