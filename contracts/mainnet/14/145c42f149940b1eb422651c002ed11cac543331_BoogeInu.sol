...
This is the most mysterious token on the BSC! We aim to shake up the BSC with yet another stealth launch that turns into slaughter house of jeet sells.
...
This project is a Quest and this is the first riddle. Guess the website link! I wont be hard.

Website link:
What does ghost say + Doge without Do + Japanese word for a dog + dot + last 3 letters in English alphabet 

Once you solve that and find the website in order to join Telegram group you have to find hidden link to it. It's one the website :-)
...
contract BoogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BoogeInu";
