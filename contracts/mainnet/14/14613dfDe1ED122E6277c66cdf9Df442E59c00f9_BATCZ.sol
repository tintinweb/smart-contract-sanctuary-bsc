...
/**
CZBAT - Tell CZ to stop eat bat. Make it moon at @KingHozCalls

I will make daily degen without promotion!

Liquidity Add 15 Minutes after deployed
...
contract BATCZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZ EAT BAT";
    string private constant _symbol = "BATCZ";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 100000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000 * 10**_decimals;

    address public liquidityReceiver;
    address public marketingWallet = address(0x5B5d270F0Ffb4dF53015dcBd5b347f85e2764360);
