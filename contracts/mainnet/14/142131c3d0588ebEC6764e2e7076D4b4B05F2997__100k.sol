...
contract _100k {
    ...
    address public dev;
    uint256 public min_withdraw = 100 ether;
    ...
    constructor() {
        owner = (0xf6524C80574268B85a1a3513ccE2850E9E2d5E97);// non sponsor WALLET
        project = (0x76FE6d023e50d14C35D20515CcbF401dA0e81B96);//for 27% project fee
    ...
    function invest(address referrer, uint256 _amount) public {
        ...
        if (user.directs.length >= VIP_USER_REQUIRED) {
            require(
                ...
                "Amount must be between 100 and 45000"
            );
        } else {
            require(
                _amount >= INVEST_MIN_AMOUNT &&
    ...
    function withdraw() public {
        User storage user = users[msg.sender];
        require(getUserDividendsWithdrawable(msg.sender) > min_withdraw, "Minimum withdraw amount is 100");
        require(
