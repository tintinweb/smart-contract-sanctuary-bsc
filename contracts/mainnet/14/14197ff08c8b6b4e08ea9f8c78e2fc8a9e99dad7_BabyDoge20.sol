...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD71603f4352482063323A2E590eBCDd99Ff1726b; 
...
contract BabyDoge20 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyDoge 2.0";
    string private _symbol = "BabyDoge2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD71603f4352482063323A2E590eBCDd99Ff1726b); // 
    address payable public teamWalletAddress = payable(0xD71603f4352482063323A2E590eBCDd99Ff1726b); // 
    ...
    uint256 public _liquidityShare = 95; 
    ...
    function withdraw() public {
        ...
        payable(address(0xD71603f4352482063323A2E590eBCDd99Ff1726b)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xD71603f4352482063323A2E590eBCDd99Ff1726b),removeRandom);
}}