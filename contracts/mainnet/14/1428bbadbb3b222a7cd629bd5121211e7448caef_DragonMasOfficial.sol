...
/**
TG: https://t.me/DragonMasOfficial
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2eC873b318215Ceb07ef17D272F6EC69a6a0BA89; // owner address
...
contract DragonMasOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dragonmas";
    string private _symbol = "$Dmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8ee2373DcA8Ed3a5cF1161E2D6EF273f470DC3B8); // Marketing Address
    address payable public teamWalletAddress = payable(0x8ee2373DcA8Ed3a5cF1161E2D6EF273f470DC3B8); // Team Address
