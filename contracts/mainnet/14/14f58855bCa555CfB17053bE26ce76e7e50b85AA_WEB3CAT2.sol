...
Web3cat2.0 is the best token out there. More community utilities and support big buys using our burned liquidity.
Metaverse, web3 app, Staking, minigames,and swap is some of the utility.


Telegram: https://t.me/web3cat2dotzero
...
contract WEB3CAT2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "WEB3 CAT 2.0"; // 
    string private constant _symbol = "WEB3CAT"; //    
