...
contract GoldDRogerInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldDRogerInu";
    string private _symbol = "GOLDDROGER";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5AE651eFE40B288B982a7d1df6CDaE225E96e867);
