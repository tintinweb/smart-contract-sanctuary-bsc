...
Liquidity
Website: Coming
TG: https://t.me/ShengxiaoPortal
TWITTER: https://twitter.com/TheShengxiao
-----------------------------------------------------------------------------------------------------------------
*/
...
contract Shengxiao is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shengxiao";
    string private constant _symbol = "SHENGAO";
