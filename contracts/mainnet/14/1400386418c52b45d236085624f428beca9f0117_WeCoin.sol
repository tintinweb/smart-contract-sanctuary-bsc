...
*      ░    ░   ░      ░ ░         ░ ░    ░           ░ 
*    
*  The total Tax is 10%, 5% rewards for holders, 5% marketing and development.
*  https://CoinWe.org
*  https://twitter.com/CoinWeOrg
*  https://t.me/CoinWeOrg
*  https://discord.gg/mabdbTt2te
*  https://www.reddit.com/r/CoinWeOrg
*  https://www.linkedin.com/company/we-coin
*  https://github.com/CoinWeOrg
*/
...
contract WeCoin is Context, IBEP20, Ownable {
	...
	function updateFee(uint256 _txFee,uint256 _burnFee,uint256 _charityFee) onlyOwner() public{
		require(_txFee < 6 && _burnFee < 1 && _charityFee < 6);
        _TAX_FEE = _txFee* 100; 
        _BURN_FEE = _burnFee * 100;
		_CHARITY_FEE = _charityFee* 100;
		ORIG_TAX_FEE = _TAX_FEE;
