...
contract SANTASBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SANTAS BUSD";
    string constant _symbol = "S-BUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; 
