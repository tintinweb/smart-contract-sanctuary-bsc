...
contract MUMBAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mumba Inu"; // 
    string private constant _symbol = "MINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xded4f6542233d4b17CA65EC7A91faCBdb21650d2;
