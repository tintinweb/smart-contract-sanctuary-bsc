...
contract SuperXRP is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x73808191B77E59D3cC007e39769998F1d59a46Aa); 
    address payable public Wallet_Dev = payable(0x73808191B77E59D3cC007e39769998F1d59a46Aa);
    ...
    string private constant _name = "Super XRP"; 
    string private constant _symbol = unicode"SXRP"; 

    uint256 public _LPtax = 0;
    ...
    constructor () {
        ...
        _owner = 0x73808191B77E59D3cC007e39769998F1d59a46Aa;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _FeeTax / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _LPtax / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_LPtax + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_LPtax + Percent_Marketing + Percent_Dev);
