...
/**
Welcome to babyshiba rocket . Together we will celebrate the  Days!
Join the TG https://t.me/babyrocketshiba
...
contract babyshibarocket is Context, IERC20, Ownable {
    ...
    string private _symbol = "babyshibaR";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x94302b975187Cc10554525611b296Fa5027c0f60); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x94302b975187Cc10554525611b296Fa5027c0f60); // BuyBack Address
