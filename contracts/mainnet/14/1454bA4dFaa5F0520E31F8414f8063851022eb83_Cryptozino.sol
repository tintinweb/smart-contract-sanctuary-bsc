...
Best Crypto Casino in the Metaverse

https://t.me/cryptozinobsc
...
contract Cryptozino is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cryptozino";
    string constant _symbol = "CZ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 35 ) / 100; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 40 ) / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xb1ec6d2673ECb1bca398A205EBA77b5B7F0D318f;
