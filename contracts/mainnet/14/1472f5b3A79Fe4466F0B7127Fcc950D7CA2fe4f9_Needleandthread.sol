...
contract Needleandthread is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Needle and thread";
    string constant _symbol = "NAT";
    ...
    uint256 _totalSupply = 100000000 * (8 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x6d25B164fCC7Fbb50486AA40b9c4243460949531;
