...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9a597C8C6e2bB11da362C32eCcA5715E8EF8B45; 
...
contract FATDOGE is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xE9a597C8C6e2bB11da362C32eCcA5715E8EF8B45); // 
