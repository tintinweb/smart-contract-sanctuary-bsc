...
contract FPN is Context, IERC20, Ownable {
    ...
    address payable inviterAddress = payable(address(0xF993135A8c98924178d226d33B8b33855f400573));
    address _marketAddress = address(0xB8C188440B83ae372c028C8f91E8B78B76Cc49F6);
    address _jsAddress = address(0xBB76127f4bCe594E1332769EBDF45EDff0a79850);
    address _fundAddress = address(0x68fBeCDC78564528Ba21264829400d86bC3cfb67);
    address[] buyUser;
    ...
    constructor (address tokenOwner){
        _decimals = 18;    
        _tTotal = 1111111 * 10**_decimals;
        _destroyMaxAmount = 1109590 * 10**_decimals;
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount >= 10**8){
            USDT.transfer(_marketAddress,thisAmount.div(2));
            USDT.transfer(_jsAddress,thisAmount.div(2));
        }
    }
}