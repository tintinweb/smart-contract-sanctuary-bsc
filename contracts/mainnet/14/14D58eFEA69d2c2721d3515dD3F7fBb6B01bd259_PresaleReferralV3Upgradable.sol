    ...
    UUPSUpgradeable
{
    ...
    function setMaxBonusLevels(uint8 _value) external onlyOwner returns (bool) {
    ...
    function setMinReferredCount(uint256 _value) external onlyOwner {
    ...
    function setMaxReferredCount(uint256 _value) external onlyOwner {
    ...
    function addReferrer(address _referrer)
        external
        returns (bool)
    {
    ...
    function _addReferrer(address _referrer)
        private
        returns (bool)
    {
    ...
    function _addParent(address _parent)
        private
        returns (bool)
    {
        ...
        if (parent == address(0)) {
            ...
            isCircularReference(parent, msg.sender)
        ) {
            emit RegisterRefererFailed(
                msg.sender,
                parent,
            ...
            accounts[msg.sender].parent != address(0)
        ) {
            emit RegisterRefererFailed(
                msg.sender,
                parent,
        ...
        returns (uint256)
    {
        ...
        for (uint256 i; i < levelRate.length; i++) {
            ...
            if (referrer == address(0) || parent == address(0)) {
                break;
            }
