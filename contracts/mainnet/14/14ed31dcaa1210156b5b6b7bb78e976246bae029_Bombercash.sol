...
╚═════╝░░╚════╝░╚═╝░░░░░╚═╝╚═════╝░╚══════╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝
  ...
  //Play to earn
  //Of Cryptonia Metaverse: https://t.me/cryptoniametaverse
  
  MATIC//REWARDS BEP20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD)

  Contact us: 
 🟣 Telegram:https://t.me/bombercashgame
 🟣 Website: http://Bombercash.com
 🟣 Twitter: https://twitter.com/bomb_cash


  ----TOKENOMICS-----

 🟣Total circulating supply: 2,000,000,000.

 Taxfee fee 15%:
    🔹  3% rewards Matic
    🔹  7% marketing(4%)+buyback(3%)
    🔹  2% liquidity
    🔹  3% development
...
contract Bombercash is ERC20, Ownable {
    ...
    BombercashDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address transferredOwner = address(0xC76aB266878B78cD7da92E82A7b2e8c968280990);

    address public immutable MATIC = address(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);

    uint256 public swapTokensAtAmount = 40 * (10**6) * (10**18);
    uint256 public maxTokensToSwap = 250000 * (10**6) * (10**18);
    ...
    uint256 public dividendsFee = 3; //rewards MATIC
    uint256 public marketingFee = 7; //marketing4% + buyback3%
    uint256 public coreFee = 3; //project
    uint256 public liquidityFee = 2;
    uint256 public totalFees = dividendsFee.add(marketingFee).add(coreFee).add(liquidityFee);

    address payable public marketingWalletAddress = 0x3BDA62C589Ac2134045afcAe46Ec1388cA1D1940;
    address payable public coreWalletAddress = 0x6e0FDff9e4caa777F303C9bE536031f0e664fcD7;
    ...
    uint256 public maxTxAmount = 500000 * (10**6) * (10**18);
    ...
    constructor() public ERC20("Bombercash Token", "BOMB") {

    	dividendTracker = new BombercashDividendTracker();
        ...
        */
        _mint(transferredOwner, 2000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Bombercash: The dividend tracker already has that address");

        BombercashDividendTracker newDividendTracker = BombercashDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Bombercash: The new dividend tracker must be owned by the Bombercash token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Bombercash: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Bombercash: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Bombercash: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Bombercash: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "Bombercash: gasForProcessing must be between 200,000 and 600,000");
        require(newValue != gasForProcessing, "Bombercash: Cannot update gasForProcessing to same value");
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        swapBnbForMatic(bnbForDividends);
    ...
    function swapBnbForMatic(uint256 bnbAmount) private {
...
contract BombercashDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("Bombercash_Dividen_Tracker", "Bombercash_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 4000000 * (10**18); //must hold 400000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "Bombercash_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "Bombercash_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Bombercash contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Bombercash_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Bombercash_Dividend_Tracker: Cannot update claimWait to same value");
