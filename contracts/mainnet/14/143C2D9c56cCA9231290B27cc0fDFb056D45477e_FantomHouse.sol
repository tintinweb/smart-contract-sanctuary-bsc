...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// Eshare on BSC Mainnet ============================================================
	//
	address private constant TOKEN_ADDRESS = 0xDB20F6A8665432CE895D724b417f77EcAC956550;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 10000000000000; // default 0.0001 Eshare, worth 0.3 Cents ATM.
    ...
    uint256 minDeposit = 10000000000000000; // default 0.01 Eshare, worth 3 Dollar ATM.
