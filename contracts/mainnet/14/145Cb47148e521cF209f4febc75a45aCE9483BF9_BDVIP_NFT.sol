...
contract BDVIP_NFT is ERC721EnumerableUpgradeable, PausableUpgradeable, AccessControlUpgradeable
{   
...
//*************** USER FUNCTIONS ******************************* */
    ...
    function tokenMint(address _to) external returns(uint256){
        require(msg.sender == coreContract, "Only CoreContract can mint NFTs");
        
        uint256 _mintedTokenID = totalSupply()+1;
...
//*************** ADMIN FUNCTIONS ******************************* */
    ...
    function setBaseURI(string memory _baseURIStr) public onlyRole(DEFAULT_ADMIN_ROLE){
