...
/*
Baked Pozza - The BNB Mining Pool With 10% Daily Return And Highest Referral Reward.
*/
...
contract BakedPozza{
    ...
    function rebakePozza(address ref) public{
        require(initialized);
    ...
    function bakePozza(address ref) public payable{
        require(initialized);
