...
contract BabyDaoDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDaoDoge";
    string private _symbol = "BDDoge";
    uint8 private _decimals = 9;

    address payable public marketingAddress = payable(0x932Ba5eab694A2D76Db029DEf53BD7eAbbf44eaF);
    address payable public devAddress = payable(0x932Ba5eab694A2D76Db029DEf53BD7eAbbf44eaF);
