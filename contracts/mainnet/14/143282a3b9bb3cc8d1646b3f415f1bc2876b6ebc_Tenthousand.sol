...
contract Tenthousand is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x23C6aAA40a3C7B9CeaEb485009C1013Eb8e0E79D); // Marketing Address
    ...
    uint256 private _tTotal = 100 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Tenthousand";
    string private _symbol = "Tenthousand";
