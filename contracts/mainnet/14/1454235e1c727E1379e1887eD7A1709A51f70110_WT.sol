...
contract WT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "W1T";
    string private _symbol = "W1T";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4b6016848bD91803c2eA319302d2acFD6080cE87); // Marketing Address
    address payable public teamWalletAddress = payable(0x4b6016848bD91803c2eA319302d2acFD6080cE87); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x4b6016848bD91803c2eA319302d2acFD6080cE87),
            block.timestamp
        );
    }
