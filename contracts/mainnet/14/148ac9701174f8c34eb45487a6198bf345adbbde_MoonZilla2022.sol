...
contract MoonZilla2022 is Context, IERC20, Ownable {
    ...
    string private constant _name = " Moon Zilla 2022 "; // 
    string private constant _symbol = " $MOONZ22 "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x0d0e0d3aF9bC51DB2B7C054858Ff0576Ea9f9093;
