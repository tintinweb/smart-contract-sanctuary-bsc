...
contract DegenFinancial  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x70024B3Ce080722AE6a9CFaeC9caBadCA4096B59); 
    address payable public Wallet_Dev = payable(0x70024B3Ce080722AE6a9CFaeC9caBadCA4096B59);
    ...
    string private constant _name = "Degen Financial"; 
    ...
    constructor () {
        ...
        _owner = 0x70024B3Ce080722AE6a9CFaeC9caBadCA4096B59;
