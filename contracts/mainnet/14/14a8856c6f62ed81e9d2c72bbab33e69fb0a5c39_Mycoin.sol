...
contract Mycoin is ERC20, Ownable  {
    ...
    uint256 private _maxTradeVolume = 1 * 1e18;
    uint256 private _maxWalletVolume = 2 * 1e18;

    address public constant marketAddress = 0xEfcc3de24C3e66272aebD32ebf2A3d918ed74906;
    address public constant devAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 private constant total =  200 * 1e18;

    uint256 public _liquidityFee = 6; //回流
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketFee = 3; //营销
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     function SwapEnabled(bool _enabled) public onlyOwner {
    ...
    function _transfer(
        ...
        if(!swapEnabled && recipient == pancakeswapV2Pair)
        {
