...
contract PiCoreTeamVesting is Ownable, ReentrancyGuard {
    ...
    constructor() {
        // Token RUN
        token = IERC20(0x45b19b46Be1B9006F388873E2C460FCcc7d00F15);
        // 12 months
        cliff = 12 * 30 * 24 * 3600;
        // 24 months
        duration = 24 * 30 * 24 * 3600;
        // 1 month
