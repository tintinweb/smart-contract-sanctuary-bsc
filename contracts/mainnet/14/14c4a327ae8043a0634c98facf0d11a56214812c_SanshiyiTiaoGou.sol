...
contract SanshiyiTiaoGou is IBEP20, Auth {
    ...
    string constant _name = "31 Inu";
    string constant _symbol = "31 INU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 31 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver =0x80A085967831717AE3b03b4Bc7A44718a360bEb4;
