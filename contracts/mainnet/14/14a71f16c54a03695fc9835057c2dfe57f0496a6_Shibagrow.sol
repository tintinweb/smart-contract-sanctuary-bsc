...
contract Shibagrow is ERC20 {
 ...
 string public constant name = "Shiba Grow inu";
 string public constant symbol = "ShibGrinu";
 uint public constant decimals = 8;
 uint public deadline = now + 70 * 1 days;
 uint public round2 = now + 30 * 1 days;
 uint public round1 = now + 60 * 1 days;
 
 uint256 public totalSupply = 1500000000000000e8;
 ...
 address multisig = 0xEcdaAa7F1B23f41081FE751bfB241a6FC455dD31;
 ...
 constructor() public {
 uint256 teamFund = 1500000000000000e8;
 owner = msg.sender;
