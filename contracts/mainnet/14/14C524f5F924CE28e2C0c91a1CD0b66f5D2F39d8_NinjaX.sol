...
contract NinjaX is BEP20, Ownable {
    ...
    address public marketingWallet = 0x0Ef5B444593Cb0fEDb1aAD2b2295a4be6B6c791F;
    address private teamWallet = 0x51C48A02aC9F29758F9FE0dCaFbCC73CCb5944d1;
    address public devWallet = 0xFc30Df91a50188c47a826d666D4644F0dBe994cf;
    ...
    Taxes private taxes = Taxes(3, 2, 1, 1);
    Taxes private sellTaxes = Taxes(3, 2, 1, 1);
    ...
    constructor(address routerAdd) BEP20("NinjaX", "NINX") {
    ...
    function updateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _team, _liquidity, _dev);
        require((_marketing + _team + _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _team, _liquidity, _dev);
        require((_marketing + _team + _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
    }
   ...
   function enableTrading() external onlyOwner {
    ...
    function rescueBSC20(address tokenAdd, uint256 amount) external onlyOwner {
        IBEP20(tokenAdd).transfer(devWallet, amount);
    }
