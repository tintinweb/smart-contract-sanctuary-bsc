...
contract CRYPTICMUBARAK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x5fcB75F477e8863F6718AD9B402253a4Df446C25));
    address payable public devWallet =
        payable(address(0x5fcB75F477e8863F6718AD9B402253a4Df446C25)); 
    address public liquidityReceiver =
        0x5fcB75F477e8863F6718AD9B402253a4Df446C25;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Cryptic Mubarak";
    string private _symbol = "$MUBARAK";
