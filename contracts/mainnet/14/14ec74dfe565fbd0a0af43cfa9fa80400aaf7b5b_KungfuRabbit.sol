...
/**
Telegram https://t.me/kungfurabbitcommunitytoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x688412326acBF4C8541fcC4Bf833F05DE5601a75; // owner address
...
contract KungfuRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kungfu Rabbit";
    string private _symbol = "KRABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x688412326acBF4C8541fcC4Bf833F05DE5601a75); // Marketing Address
    address payable public teamWalletAddress = payable(0x688412326acBF4C8541fcC4Bf833F05DE5601a75); // Team Address
