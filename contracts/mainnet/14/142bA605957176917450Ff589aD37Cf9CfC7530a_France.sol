...
contract France is ERC20 {
    ...
    mapping(address => bool) public bk;
    address public tokenOwner =
        address(0xFC89E7a11F4f53A67473aDd22D0DA9F07b3d517b);
    address public fundAddr =
        address(0x147123cDcbf332069dC7bcdc8a1d66c72CB2a607);

    uint256 public marketPercent = 1000;
    ...
    function _transfer(
        ...
        require(!bk[sender], "You're banned");
    ...
    function setFundAddr(address _address) public onlyOwner {
        fundAddr = _address;
    }

    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        marketPercent = taxFee;
    }
