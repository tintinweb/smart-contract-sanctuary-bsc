...
contract AlveySquid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvey Squid";
    string private _symbol = "ALVEYSQUID";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x097b0149248E2FA0E7B7d8c52E1C2f66cB2981FD);
