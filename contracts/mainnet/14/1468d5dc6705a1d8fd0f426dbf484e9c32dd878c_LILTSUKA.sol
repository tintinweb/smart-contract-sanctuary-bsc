...
contract LILTSUKA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x86Ae3E3E0748081d9967ECf04CcEa818101Cd2e7); 
    address payable public Wallet_Dev = payable(0x1BbE9CA51431F24498a6F11785df69c2213954F4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Lil Tsuka"; 
    string private constant _symbol = unicode"LIL TSUKA";
