...
contract IDO is Ownable{
    ...
    address constant public _invitation = 0x9Cd3136722dE74baF2CFF6DD1D9CFAc829C18136;
    address constant public _nft = 0x564CF426a6A14FbdAbbfeb4ED20737f7A0e97020;
    address public conAddress = 0x97D84D68cc18c25B04794553DDf63B0d23dCDd99;
    address public _sat;
    ...
    uint public _amount  = 100e18;

    uint public _startTime;

    uint public _upTime = 2 days;
    ...
    function invest1() external {
        ...
        IERC20(_usdt).transferFrom(msg.sender,conAddress, amo()*95/100);
        IERC20(_usdt).transferFrom(msg.sender, inviter, amo()*5/100);
        user.invest += _amount;
    ...
    function invest2() external {
        ...
        IERC20(_usdt).transferFrom(msg.sender,conAddress, 200e18);
        user.invest += 200e18;
    ...
    function stakeUsdt() external {
        ...
        IERC20(_usdt).transferFrom(msg.sender, conAddress, 300e18);
    ...
    function setSatAddress(address sat) external onlyOwner {
     ...
     function setTime(uint startTime_,uint upTime_) external onlyOwner {
    ...
    function amo() public view returns(uint invest){
        return  _amount + ((block.timestamp- _startTime)/_upTime)*5e18;
    }
