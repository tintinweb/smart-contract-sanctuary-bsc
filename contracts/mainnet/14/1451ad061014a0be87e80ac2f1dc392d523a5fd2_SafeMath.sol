...
abstract contract Project {
    address public marketingWallet = 0x72DF56f319CB1353511858d5458D982e46F00c9f;
    address public devWallet = 0x72DF56f319CB1353511858d5458D982e46F00c9f;

    string constant _name = "Trying blues";
    string constant _symbol = "Trying";
 ...
 * MainContract
 */
contract tryingbluesContract is Project, ERC20, Ownable {
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x72DF56f319CB1353511858d5458D982e46F00c9f); //Mainnet & Testnet ETH
