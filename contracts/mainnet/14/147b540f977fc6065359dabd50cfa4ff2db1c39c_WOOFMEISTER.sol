...
/*
WOOFMEISTER
WOOFMEISTER serves as a Bridge, Launchpad, and Swap for Shibarium, 
allowing users to easily move their assets across different chains, participate in token sale
*/
...
contract WOOFMEISTER  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'WOOFMEISTER';
    string private _symbol = 'WOOFME';
