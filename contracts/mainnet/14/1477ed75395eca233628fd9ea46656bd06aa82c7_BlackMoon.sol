...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0A6a2F2ff3EA0B3D72C5621850898275adcC612A; // owner address
...
contract BlackMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe9F1907b339244fe3Abd90CC5357229325A69aD5); // Marketing Address
    address payable public teamWalletAddress = payable(0xb46736154C6F7Ba273b8dd58dfF11E311056bC31); // Team Address
