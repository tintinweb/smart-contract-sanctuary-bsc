...
contract nvwacommunity is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 16000 * 10**18;
    ...
    string private constant _name = "nvwacommunity";
    string private constant _symbol = "nvwa";
    uint8 private constant _decimals = 18;

    address payable private _developmentAddress = payable(0xFc147008A51151795c2A1B33f69B536be0000000);
    address payable private _marketingAddress = payable(0xFc147008A51151795c2A1B33f69B536be0000000);
