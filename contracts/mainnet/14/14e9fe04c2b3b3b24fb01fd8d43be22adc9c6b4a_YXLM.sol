...
contract YXLM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YXLM ";
    string private _symbol = "YXLM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3a8c1800eE81678AD7438624Cebe00C74888888);
    address payable public teamWalletAddress = payable(0xb3a8c1800eE81678AD7438624Cebe00C74888888);
