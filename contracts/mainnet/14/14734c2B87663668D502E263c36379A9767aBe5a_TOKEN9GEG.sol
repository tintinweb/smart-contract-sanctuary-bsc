...
//Telegram: https://t.me/Portal9GEG
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA6047FD98D2A3D82F6Be494F5F723131EB152140; // owner address
...
contract TOKEN9GEG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "9Geg";
    string private _symbol = "$9GEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6047FD98D2A3D82F6Be494F5F723131EB152140);
    address payable public buybackWalletAddress = payable(0xA6047FD98D2A3D82F6Be494F5F723131EB152140); 
