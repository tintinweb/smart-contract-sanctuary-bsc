...
contract Sihasiha is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sihasiha";
    string private _symbol = "Sihasiha";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x911608ff372B987EE88137F3010a14d4e4100ABE); 
    ...
    uint256 private _totalSupply = 10 *  10**18 * 10**_decimals;
