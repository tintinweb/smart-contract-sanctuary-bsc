...
Join us, because this is the first step to progress :
...
contract EtherMailBsc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD9fD05840b7FD6D91855fA2d0b0Ee02d742d7bA9); // Marketing Address
    ...
    string private _name = "Ether Mail Bsc";
