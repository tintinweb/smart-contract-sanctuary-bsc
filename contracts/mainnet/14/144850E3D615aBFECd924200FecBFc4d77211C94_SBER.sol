...
contract SBER is IBEP20, Auth {
    ...
    string constant _name = "SBER";
    string constant _symbol = "SBER";
    ...
    bool public distributorSwitch = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0x52a6AbA4DEAf7a802520E03141961a357599C4EA;
        sustainabilityFeeReceiver = 0x9F14bFB15cb9690da52E4C5bCf73786B242cE491; 
    ...
    function updateDistributorSwitch(bool _distributorSwitch) external onlyOwner{
        distributorSwitch = _distributorSwitch;
    }
