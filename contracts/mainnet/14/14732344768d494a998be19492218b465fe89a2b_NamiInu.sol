...
/**   // SPDX-License-Identifier: MIT
    ...
    Welcome to Nami Inu BSC
    Nami Inu - NAMIINU

    Telegram : https://t.me/namiinu_bsc
    Website : https://www.namiinu.org/
*/
...
contract NamiInu is Context, IERC20, Ownable {
    ...
    string private _name = "NamiInu";
    string private _symbol = "NAMIINU";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 100 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xf085E1fa5074E40729C0252B1f7513959B9a0e62);
