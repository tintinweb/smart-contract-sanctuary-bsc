...
contract PinkBet is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0x78146a4F21C6CBA009E3cDDbb1F167dFCB1CBaab;
    ...
    event UpdateTax(uint256 buyTax, uint256 sellTax, uint256 transferTax);
    ...
    constructor() ERC20("Pink BET", "PinkBET") {
    ...
    function updateBuyTax(uint256 _buyTax) external onlyOwner {
        require(_buyTax <= 1500, "Fees cannot exceed 15%");
        buyTax = _buyTax;

        emit UpdateTax(buyTax, sellTax, transferTax);
    }

    function updateSellTax(uint256 _sellTax) external onlyOwner {
        require(_sellTax <= 1500, "Fees cannot exceed 15%");
        sellTax = _sellTax;
    ...
    function updateTransferTax(uint256 _transferTax) external onlyOwner {
        require(_transferTax <= 1000, "Fees cannot exceed 10%");
        ...
        onlyOwner
    {
        ...
        emit marketingWalletChanged(oldMarketingWallet, _marketingWallet);
    }
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        ...
        require(
            ...
            "Amount must be equal or greater than 1 Wei"
        );
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (_isAutomatedMarketMakerPair[from]) {
                ...
                fees = (amount * transferTax) / taxDenominator;
            }
