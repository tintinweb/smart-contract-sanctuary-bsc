...
contract InfinityPro is Context, Ownable, IBEP20 {
    ...
    uint16[5] private ref_bonuses = [1100, 100, 100, 100, 100]; 
    ...
    constructor() {
	    ...
	    _name = "Infinity Pro Token Shares";
        _symbol = "INF";
        _decimals = 18;
        _totalSupply =  10_000_000_000 * 10**uint(_decimals); // 10B
        _balances[address(this)] = 8_000_000_000 * 10**uint(_decimals); 
		emit Transfer(address(0), address(this), _balances[address(this)]);    
		_balances[msg.sender] = 2_000_000_000 * 10**uint(_decimals); 
		emit Transfer(address(0), msg.sender, _balances[msg.sender]);    
		
        tarifs[20] = Tarif(20, 120); //6% daily for 20 days => 120% ROI
        tarifs[30] = Tarif(30, 180); //6% daily for 30 days => 180% ROI
        tarifs[45] = Tarif(45, 270); //6% daily for 45 days => 270% ROI
    
    }
        
    function Invest(address referral, uint256 tarif) public payable {
        
        require(msg.value >= 0.025 ether, "Minimum Deposit is 0.025 BNB!");
