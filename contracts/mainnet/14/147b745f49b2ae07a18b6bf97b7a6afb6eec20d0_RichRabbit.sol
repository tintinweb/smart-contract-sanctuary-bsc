...
contract RichRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rich Rabbit";
    string private _symbol = "Rich Rabbit";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x670F1D263F9c0eb14766C5132179E16cc0eaABa6);
    address payable public teamWalletAddress = payable(0x670F1D263F9c0eb14766C5132179E16cc0eaABa6);
