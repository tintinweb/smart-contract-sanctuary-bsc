...
contract qiihuan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "qiihuan";
    string private _symbol = "QII";
    ...
    function response(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
