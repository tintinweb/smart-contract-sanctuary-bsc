...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36ddc10B02A85eF656c2D86A06c5b7748489BB94; // owner address
...
contract ShanjiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Shanjiru Inu";
    string private _symbol = unicode"Shanji";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x36ddc10B02A85eF656c2D86A06c5b7748489BB94); // Marketing Address
    address payable public teamWalletAddress = payable(0x36ddc10B02A85eF656c2D86A06c5b7748489BB94); // Team Address
