...
/* 
🧸ORDINAL NOMICS🧸 $oNOMICS🧸
As the hype of the Ordinals new protocol that allows NFTs to be stored on the Bitcoin blockchain.
we happy to launch a new meme coin named $oNomics

📜Tax 2% 🪕Reflection 1% 🪕 LP Adder 1% 
📜Renounced Contract
📜Secure Liquidty Pool Locker
📜Low BSC Gem MC 

🔭Telegram https://t.me/NomicsToken

📜WHAT IS ORDINAL NOMICS ?
📜ORDINAL NOMICS is an meme coin NFT base on the Ordinal utility In economics, an ordinal utility function is a function representing the preferences of an agent on an ordinal scale. Ordinal utility theory claims that it is only meaningful to ask which option is better than the other, but it is meaningless to ask how much better it is or how good it is. All of the theory of consumer decision-making under conditions of certainty can be, and typically is, expressed in terms of ordinal utility.

📜ORDINAL NOMICS future vision :

🔭Ordinal utility nft swap multichain
🔭Ordinal show platforme of content creators
🔭Ordinal School platforme of education
*/
...
contract ORDINALNOMICS is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'ORDINAL NOMICS';
