...
contract UTAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UTA INU";
    string private _symbol = "UTA";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x685D7E5Ee44e8838083B1A9Cb73afBa49e6bDE23); // Marketing Address
    address payable private TeamWallet = payable(0x685D7E5Ee44e8838083B1A9Cb73afBa49e6bDE23); // Buy Back Address
