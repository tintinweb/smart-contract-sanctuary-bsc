...
contract KAINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Kakashi Inu";
    string private constant _symbol = unicode"KAINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable private DevWallet = payable(0x93dEf7511B38895A006A444EFA0ECA545B0ff956);
    address payable private MarketingWallet = payable(0xBDBBadA0C13123b3280BDc0B933a068577beD20B);
    address payable private TeamWallet01 = payable(0xe59ac6bfD9B2fFec14410083c83e60BF690E5059);
    address payable private TeamWallet02 = payable(0x55B60b2867C82a6Db812056C7F141ee6395DE531);
    address payable private TeamWallet03 = payable(0x57fc87533b4cF9eC4CACf6D39fA83c96E4b243eB);
