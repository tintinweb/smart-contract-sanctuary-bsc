...
// Nike Inu is the new meta and the new moonshot
// TG: https://t.me/NikeInuBSC
...
contract NikeInu  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "NikeInu";
    string constant _symbol = "$NikeInu";
