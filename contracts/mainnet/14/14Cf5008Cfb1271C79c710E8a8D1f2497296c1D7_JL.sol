...
contract JL is Context, IBEP20, Ownable, PancakeTool {
    ...
    address private _marketing = 0x98129e3e4f62B2b4BF4FBCf00053CdAFBE178A47; //Token to marketing the address
    address private _blackHole = address(0x0); //Token to destroy the address
    uint8 private _cPercent = 9; //capitalPool percentage
    uint8 private _mPercent = 1; //Marketing percentage
    uint8 private _bPercent = 0; //BlackHole percentage
    uint256 private _maxHold = 10000 * size; //The biggest hold
    uint256 private _maxDeals = 10000 * size; //The biggest deals
    //514997058
    ...
    function _beforeTransfer(
        ...
        if (
            ...
            require(amount <= _maxDeals, "The maximum number of deals is 10000");
            uint256 aBalance = _balances[recipient] + amount;
            require(aBalance <= _maxHold, "The maximum number of holdings is 10000");
        }else{
            require(amount <= _maxDeals, "The maximum number of deals is 10000");
        }
    }
