...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xea39F329047E84C3882f7F41717D29eb8906f060; 
...
contract FatInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fat Inu";
    string private _symbol = "FINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaf5EFE1B9f310e7d1ce043e71017513D39dd716d); // 
    address payable public teamWalletAddress = payable(0xea39F329047E84C3882f7F41717D29eb8906f060); // 
    ...
    uint256 public _totalDistributionShares = 51;  
