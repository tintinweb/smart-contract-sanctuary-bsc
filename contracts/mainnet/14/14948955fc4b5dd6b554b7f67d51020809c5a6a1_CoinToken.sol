...
contract CoinToken is IERC20, Ownable {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _Antibot = IAntibot(0x1f8b21d2d632E4f178cf4dBAAA88F9081f2DC720);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            updateBalances(from, pancakeswapV2Pair, amount.mul(2).div(100));//回流1%
            updateBalances(from, _fundAddress, amount.mul(2).div(100));//1%营销
            updateBalances(from, address(this), amount.mul(4).div(100));//分红6%
