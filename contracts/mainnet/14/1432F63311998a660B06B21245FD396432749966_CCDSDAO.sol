...
contract CCDSDAO is ERC20, Ownable {
    ...
    constructor () ERC20("CCDS DAO", "CCDSDAO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x3dFA39D6f6B9414CB22E7B3C039Ad759CB71040F;
        developmentWallet = 0xD16aE09d97aE9748fc3b826CFcF141c07b35a8e8;
