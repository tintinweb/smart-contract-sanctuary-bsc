...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10A85021BC2298b6C0De7CEc84294cc70C086275; // owner address
...
contract WorldCupProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "World Cup Protocol";
    string private _symbol = "WCP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf73C99F3b7141A4725d7A77F45F1B846D58A890a); // Marketing Address
    address payable public teamWalletAddress = payable(0xf73C99F3b7141A4725d7A77F45F1B846D58A890a); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 23;  // original 12
