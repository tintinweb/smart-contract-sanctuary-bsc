...
contract FOXFLOKI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5255db20210C979E6aa0ddd9bF55956aEfEc616b; //

    string private constant _name = "FOXFLOKI"; //
    string private constant _symbol = "FOXFLOKI"; //
