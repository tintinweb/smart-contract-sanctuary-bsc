...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x9E2D9D6B2BA0c6dA59A384aacF38b74a5c42CD3E); //SHILA
...
contract BabyShila is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x9E2D9D6B2BA0c6dA59A384aacF38b74a5c42CD3E;
    address RouterV2 = 0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string  _name = "Baby Shila";
    string  _symbol = "BABY SHI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x88895325B563a3C852B7Eacb62C5dd31b7F74f3a;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0xD70299c6D29BfB8dd2c6B85c584DC0abCe4fD08A;
