...
contract PitStarbaseTexas is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pit Starbase Texas"; 
    string private constant _symbol = "PSTARBASETEXAS"; 
