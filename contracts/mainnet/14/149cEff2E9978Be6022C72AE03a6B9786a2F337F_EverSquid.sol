...
contract EverSquid is Context, IERC20, Ownable {
    ...
    string private _name = "Ever Squid"; 
    string private _symbol = "EVERSQUID"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8DDCCA654d82868A7E1Df12994fB203e1B1E1C2); 
    address payable public teamWalletAddress = payable(0xAac3E2d19f22910e45A7f15A54aE70F0781FbD07); 
