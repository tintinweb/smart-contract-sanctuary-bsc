...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa67C8cE78ff20f0AC235Ed543f1dD7359edcBc83; // owner address
...
contract ThreeRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ThreeRabbit";
    string private _symbol = "ThreeRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa67C8cE78ff20f0AC235Ed543f1dD7359edcBc83); // 
    address payable public teamWalletAddress = payable(0xa67C8cE78ff20f0AC235Ed543f1dD7359edcBc83); // 
