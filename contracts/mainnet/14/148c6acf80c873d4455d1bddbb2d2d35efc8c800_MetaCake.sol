...
contract MetaCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MetaCake", "MECA"){
        address newOwner = address(0x820c410e15D1D252b66F717c5496139Ed49bEc2C); // OWNER ADDRESS
        ...
        marketingPenaltySellFee = 0;
        liquidityPenaltySellFee = 0;
    	...
    	marketingWallet = address(0x845e805778156bf284594ecd2dd0F4eF70D4c970); // TEAM WALLET
        charityWallet = address(0x995D1f89e4096304aE76B016219ba367D0beBCCA); // JACKPOT WALLET
        liquidityWallet = address(0xEcAD6baDe1465a739a2b61976FCeeD622BEa59da); // LIQUIDITY WALLET
