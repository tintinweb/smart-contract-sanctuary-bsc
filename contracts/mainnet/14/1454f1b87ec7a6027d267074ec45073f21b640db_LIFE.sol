...
contract LIFE is Context, IERC20, Ownable {
    ...
    string private _name = "Life Changer";
    ...
    address public marketingWallet = 0xF26E246f0AA98ED522Bc8916149B027ebF876932;
    ...
    uint256 public _maxTxAmount = 1 * 10**7 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**5 * 10**18; // 0.1%
