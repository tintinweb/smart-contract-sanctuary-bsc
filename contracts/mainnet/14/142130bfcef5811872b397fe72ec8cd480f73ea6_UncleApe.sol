...
contract UncleApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Uncle Ape";
    ...
    uint256 public _totalTaxIfSelling = 13;  // original 13
    uint256 public _totalDistributionShares = 13;  // original 13
