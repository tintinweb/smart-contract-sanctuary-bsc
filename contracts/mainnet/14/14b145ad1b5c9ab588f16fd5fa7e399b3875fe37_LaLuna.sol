...
//无忧出品 SAFUU PROTOCOL COPYRIGHT (C) 2022
...
contract LaLuna is ERC20, Ownable {                 //Contract name
   using SafeMath for uint256;
    ...
    string public name_ = "LaLuna";       //Full name
    string public symbol_ = "LaLuna";      //abbreviation

    uint256 public deadFee = 0;       //Destroyed
    uint256 public liquidityFee = 10;      //LP reflow
    uint256 public marketingFee = 0;      //marketing
    uint256 public foundationFee = 20;      //Buyback pull order
    uint256 public lpRewardFee = 20;       //Add LP dividends
    address public lpRewardToken = 0x156ab3346823B651294766e23e6Cf87254d68962;      //Dividend tokens

    uint256 public maxburn = 100000000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x0000000000000000000000000000000000000000;  //Marketing address
    address private foundationWalletAddress = 0x5292ACC7be139d4f78090ADfe489A38680dBA152;  //Buyback Guard
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply.mul(10000).div(10000); 
