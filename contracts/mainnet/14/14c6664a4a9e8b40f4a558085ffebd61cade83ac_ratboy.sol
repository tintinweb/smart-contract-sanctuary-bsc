...
contract ratboy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatBoy!!!";
    string private _symbol = "RATBOY!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe0056f5D32e7E830CB90F556Dc6963634A0C84c7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe0056f5D32e7E830CB90F556Dc6963634A0C84c7); // BuyBack Address
