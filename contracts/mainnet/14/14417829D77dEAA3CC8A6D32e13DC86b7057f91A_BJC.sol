...
/**
LOW TAX FOR YOU JEET LP BURN OWNERSHIP RENOUNCE
...
contract BJC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BinanceJeetsChain";

    string private _symbol = "BJC";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xB67442E39F4ded6626eccB786E86a4414d6CfbD3;
