...
contract BTCMINERBSC is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BTC MINER';
    string private constant _symbol = 'BMINER';
    ...
    //DevWallets
    address public Development=payable(0xad73560946CDc34fEcee2AE7E28624E5fC65F935);
    address public Marketing=payable(0xad73560946CDc34fEcee2AE7E28624E5fC65F935);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //WBTC Rewards
