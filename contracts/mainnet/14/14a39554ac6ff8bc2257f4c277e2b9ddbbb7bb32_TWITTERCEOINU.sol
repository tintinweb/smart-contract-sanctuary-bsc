...
contract TWITTERCEOINU is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"TWITTERCEOINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**12 * 10**_decimals;

    address payable public DevWallet = payable(0x0CCAFBba4c703F107848d146C16fcBb1Cd07EE7d);
    address payable public MarketingWallet = payable(0x0CCAFBba4c703F107848d146C16fcBb1Cd07EE7d);
