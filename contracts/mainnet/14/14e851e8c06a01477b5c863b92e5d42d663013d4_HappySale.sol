...
HappySale helps everyone to create their own tokens and token sales in few seconds.

Tokens created on PinkSale will be verified and published on explorer websites.

Web : https://HappySale.io
Telegram : https://t.me/HappySale

#Launch and #contract details: I will add LP as soon as possible Increase slippage please. VOICE CHAT LIVE!
- Initial #LP will be #10BNB and #LP will lock along 10 years and wii renounce Ownership.
- #TaxFee '3' - Low Transactions 
...
contract HappySale is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "HappySale";
