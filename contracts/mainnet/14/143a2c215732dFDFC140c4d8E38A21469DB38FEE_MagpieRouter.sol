...
library LibBytes {
        ...
        returns (IMagpieBridge.ValidationOutPayload memory payload)
    {
        ...
        payload.intermediaryDecimals = self.toUint8(i);
        i += 1;
...
interface IMagpieCore {
    struct Config {
        ...
        address[] wormholeIntermediaries;
        address[] hyphenIntermediaries;
    ...
    event SwappedOut(SwapOutArgs args, uint256[] amountOuts, uint64 coreSequence, address caller);
