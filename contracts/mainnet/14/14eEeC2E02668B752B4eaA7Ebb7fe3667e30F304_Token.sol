...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Goog Right AI";
    ...
    address public ownerAddres = address(0x9b21589d64F89584Cf71fc136b3700162A5dadce);
    address public devAddress = address(0x9b21589d64F89584Cf71fc136b3700162A5dadce);
    address public foundAddress = address(0x9b21589d64F89584Cf71fc136b3700162A5dadce);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 9000000 * 10 ** 18 && !_isExcludedFromFee[sender]) {
