...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community 413";
    string private constant _symbol = "NC413";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 4130 * 10**_decimals;
    uint256 public _maxTxAmount = 826 * 10**8;
    uint256 public _maxWalletAmount = 826 * 10**8;
