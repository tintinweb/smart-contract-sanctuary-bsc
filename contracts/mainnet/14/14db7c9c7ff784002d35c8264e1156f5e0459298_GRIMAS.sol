...
contract GRIMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grimace Xmas";
    string private _symbol = "GRIMAS";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xc55482B43d4a58B0bBD8A3c79C09deeA918f3c48); // Buy Back Address
