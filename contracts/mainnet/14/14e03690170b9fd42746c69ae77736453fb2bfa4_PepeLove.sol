...
// PepeLove comes into the bsc space to distribute love to all holders. 0% buy tax and sell tax depending trading volume. 🧲

// Innovation token with good features coming. Like Nfts, P2E game but we need your support to make it possible. ⚗️🎭

// TG: t.me/pepelove_official 

// Website: Pepelove.net
...
pragma solidity ^0.6.12;
    ...
    contract PepeLove is Context, IERC20, Ownable {
        ...
        string private _name = 'PepeLove2.0';
        string private _symbol = 'PLOVE';
