...
contract VotePower is Ownable {
    ...
    event NewIFOContract(address IFOContract);
    ...
    address public IFO_POOL = 0x000000000000000000000000000000000000dEaD; // ifo pool.
     ...
     */
    function setIFOContract(address _IFOContract) external onlyOwner 
    {
        require(_IFOContract != address(0), "Cannot be zero address");
        IFO_POOL = _IFOContract;
        emit NewIFOContract(IFO_POOL);
    }
