...
contract SpiderCheemsInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x262250FE7ea0655138CcEc1d25Cbdfde70540E30); // Marketing Address
    ...
    string private _name = "Spider Cheems Inu";
