...
contract SquidCat is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Cat";
    string private _symbol = "SCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3dD27c5dF47C3862b59C2856E7B9199EC8976CFC); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3dD27c5dF47C3862b59C2856E7B9199EC8976CFC); // BuyBack Address
