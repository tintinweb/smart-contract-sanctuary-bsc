...
contract Libertarian is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Libertarian Vitalik";
    string private _symbol = "LIBER";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x89f8e25168F8F457499b4358cF64D4707aaC49ac); // Marketing Address
    address payable public teamWalletAddress = payable(0x89f8e25168F8F457499b4358cF64D4707aaC49ac); // Team Address
