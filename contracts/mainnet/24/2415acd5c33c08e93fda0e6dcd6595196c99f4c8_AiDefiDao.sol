...
contract AiDefiDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AiDefiDao";
    string private _symbol = "AiDefiDao";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x58a281A6EF3Db64C4cBc5F800dfa701f224420C4);
    address payable public teamWalletAddress = payable(0x7f5aE9F2Aa71EFdFC1bb42F17B427c3A4f045853); 
