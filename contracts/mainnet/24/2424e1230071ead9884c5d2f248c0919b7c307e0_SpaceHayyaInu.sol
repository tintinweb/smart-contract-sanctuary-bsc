...
contract SpaceHayyaInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 800000000000000000000 * 10**9; //
    string private constant _name = "Space Hayya INU"; // 
    string private constant _symbol = "SHINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xeC081F89aD7397f3089C94D80604EDB2A9233254);
