...
France FAN TOKEN 
France National Fan Token
☎️Telegram : @FranceFANTOKENCUP
...
contract France is FranceDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FranceTeam;
    address private CharityFrance;
    ...
    string public override name = "France";
    string public override symbol = "France";
    ...
    constructor(uint totalSupplyValue, address FranceTeamAddress, address CharityFranceAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FranceTeam = FranceTeamAddress;
        CharityFrance = CharityFranceAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FranceTeam] =  totalSupply * 4 / 100;
        balances[CharityFrance] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's FranceTeam pot
