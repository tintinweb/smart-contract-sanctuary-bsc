...
*TELEGRAM: https://t.me/SquidTentacle
*/
...
contract SqT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SquidTentacle  ";
    string private _symbol = " $SqT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f2E44b5cF42f2bc3b0Da4dE791C6FbECd0Cdb0A); 
    address payable public teamWalletAddress = payable(0x8f2E44b5cF42f2bc3b0Da4dE791C6FbECd0Cdb0A); 
