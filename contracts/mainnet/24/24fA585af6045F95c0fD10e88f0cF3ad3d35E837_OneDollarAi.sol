...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B41256010FF4751b73E44585aba00E8234E8CBb;
...
contract OneDollarAi is Context, IERC20, Ownable {
    ...
    string private constant _name = "OneDollar.Ai"; // 
    string private constant _symbol = "1$AI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x1B41256010FF4751b73E44585aba00E8234E8CBb);
