...
contract EC is IERC20, Ownable {
    ...
    address public fund1Address = address(0xac8721432BAF64A9F176C124B92fA4D223636B6a);
    
    address public fund2Address = address(0x1Ec70a9a77339bafA0Ffb00092719c2bAa32fD2d);
    address public fund3Address = address(0x927178AC8d9eAf2692a907aB7D82657332F138d4);
    
    uint256 public _fund1Fee = 1;
    
    uint256 public _fund2Fee = 2;
    uint256 public _fund3Fee = 3;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate =  _liquidityFee  + _inviterFee + _fund1Fee + _fund2Fee + _fund3Fee;
        }
