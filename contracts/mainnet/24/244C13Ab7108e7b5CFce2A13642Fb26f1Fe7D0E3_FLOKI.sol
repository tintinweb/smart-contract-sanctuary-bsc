...
Telegram : https://t.me/FlokiWaterBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x642ED836C0B9e2D3EE0f0F78d3e3a9Eb093dEd91;
...
contract FLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKI WATER"; // 
    string private constant _symbol = "$FLOWATER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x642ED836C0B9e2D3EE0f0F78d3e3a9Eb093dEd91);
