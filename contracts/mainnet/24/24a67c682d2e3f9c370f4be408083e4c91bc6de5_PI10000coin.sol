...
contract PI10000coin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pi10000";
    string private _symbol = "Pi10000";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68bFF7fFb51585dE43B9Ce3971EB8c94709DeD81); 
    address payable public BurnedWalletAddress = payable(0x68bFF7fFb51585dE43B9Ce3971EB8c94709DeD81); 
