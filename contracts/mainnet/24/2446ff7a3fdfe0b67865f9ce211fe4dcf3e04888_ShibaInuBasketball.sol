...
interface IDEXRouter {
 ...
 contract ShibaInuBasketball is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Shiba Inu Basketball";
    string constant _symbol = "ShiBasketball";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 23000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; 
    ...
    address public devFeeReceiver = 0x952bBCeb4Fd7e9bA8c7C431e1adB759d18EdAF21;
    address public buybackFeeReceiver = 0x952bBCeb4Fd7e9bA8c7C431e1adB759d18EdAF21;
