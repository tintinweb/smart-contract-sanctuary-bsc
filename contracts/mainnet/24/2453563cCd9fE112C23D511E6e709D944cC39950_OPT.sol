...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 4 / 100;
            if (burnAmount > 0) {
                feeAmount += burnAmount;
                _takeTransfer(
                    sender,
                    address(0xe202f4c0e9AD9D3ADEe59d484845B933868470Ee),
                    burnAmount
                );
            }
        }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x1E534DCc12F5292b81C22363a18B474CD445db88;
...
contract OPT is AbsToken {
    constructor() AbsToken(
        ...
        address(0x300cfdb9922CFDc1AaDE89132bFC0788db7A5d88),
    
        address(0xB12Bf970b757721f501C344484D7285DD1b0dd4c)
    ){
