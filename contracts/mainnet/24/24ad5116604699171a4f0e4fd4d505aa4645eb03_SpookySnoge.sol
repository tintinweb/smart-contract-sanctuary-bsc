...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5a22fcC9F89139EAeFaDa2EF2f1e70F1BF25C65e;
...
contract SpookySnoge is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SpookySnoge"; 
    string private constant _symbol = unicode"$SSnoge"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5a22fcC9F89139EAeFaDa2EF2f1e70F1BF25C65e), BNB_Tot);
            }
