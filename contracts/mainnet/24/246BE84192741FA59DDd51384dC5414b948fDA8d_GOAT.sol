...
contract GOAT is Context, IERC20, Ownable {
    ...
    string private _name = "Greatest Of All Time";
    string private _symbol = "GOAT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3d4bc99B6A036B6659956eb54D2617C7B3f1DCd5); 
    address payable private teamWalletAddress = payable(0x0422884fe97c69f8FF9ec078074223746CEf76ab); 
    ...
    uint256 public _maxTxAmount = 5  * 10**2* 10**_decimals; 
