...
contract SquidNewYear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid New Year"; // 
    string private _symbol = "$SNY"; // 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA5889aF694E70D954302a60EE343563239B218Ff); // 
    address payable public teamWalletAddress = payable(0x478995706606c1f7d68dF4d542f2E7fb60345083); // 
