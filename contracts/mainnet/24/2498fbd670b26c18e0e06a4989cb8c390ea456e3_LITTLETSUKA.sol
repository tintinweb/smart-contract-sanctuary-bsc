...
contract LITTLETSUKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Little Tsuka";
    ...
    address payable public buyBackWalletAddress = payable(0x23AA56F5317F4f3e0E17d23004bF66703Db6abcc); 
