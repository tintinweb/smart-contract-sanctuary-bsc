...
contract Cashback is Context, IERC20, Ownable {
    ...
    string private _name = "Cashback Coin";
    string private _symbol = "CSB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xccD32e6A4A6e14058F651523811979cc0ee10192);
    address payable public liqWalletAddress = payable(0xccD32e6A4A6e14058F651523811979cc0ee10192);
