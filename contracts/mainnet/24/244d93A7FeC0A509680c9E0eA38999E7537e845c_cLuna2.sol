...
contract cLuna2 is IBEP20, Auth {
    ...
    string constant _name = "cLuna2.0";
    string constant _symbol = "cLuna2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 6907376873996 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1062bA2a0c334a7271aCb2155a09114b401b9281;
