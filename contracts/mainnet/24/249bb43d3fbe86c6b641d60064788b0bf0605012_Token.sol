...
contract Token is IERC20, Ownable {
    ...
    address private _taxAddress = address(0x859b80ad607cc78D42B6bC23a44bbfD99EB4042d);
    address private _devsAddress = address(0xAEc7A8Cb3A58b7f66d7d8944eED4aE6E192d2A71);
    ...
    function operateBot(address account, bool value) external onlyOwner{
        _bot[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!_bot[from] && !_bot[to], 'bot address');
    ...
    function _takeDevFee(
        ...
        _rOwned[_devsAddress] = _rOwned[_devsAddress].add(rAmount);
        emit Transfer(sender, _devsAddress, tAmount);
    }
    ...
    function _transferStandard(
        ...
        _takeDevFee(sender, tAmount.div(1000).mul(_devFee), currentRate);

        uint256 recipientRate = 1000 - _liquidityFee - _taxFee -_destroyFee - _devFee;
