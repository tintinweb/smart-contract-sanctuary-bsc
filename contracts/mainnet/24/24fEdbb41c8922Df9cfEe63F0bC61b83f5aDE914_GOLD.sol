...
Telegram : https://t.me/GoldRoninInu
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbdFc924F501ABa8BE72A6078AC642c2a62F55c9C;
...
contract GOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOLD RONIN INU"; // 
    string private constant _symbol = "$GROI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0xEE16d7E880c9006833aBD76F41Ab95d743C97cB4);
