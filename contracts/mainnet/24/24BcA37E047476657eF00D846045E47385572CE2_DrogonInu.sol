...
/**
 *Commemorating the release of House of the Dragon!
 * 
 */
...
contract DrogonInu is Context, IERC20, Ownable {
    ...
    string private _name = "Drogon Inu";
    string private _symbol = "Drogon Inu";
