...
By @Rogerz10x // Pink Partner

JOIN THE TELEGRAM AND HELP TAKE THIS TO THE MOON. LP LOCKED. ANTI-BOT, ANTI-WHALE, ANTI-DUMP. SAFU.
THOSE TRYING TO MANIPULATE THE CHART REKT-ING OTHERS MAY FIND THEIR WALLETS BLACKLISTED THIS IS A SAFU COMMUNITY PROJECT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 JACKPOT = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = JACKPOT.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(JACKPOT);
        ...
        uint256 amount = JACKPOT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JACKPOT.transfer(shareholder, amount);
...
contract RatPot is IBEP20, Auth {
    using SafeMath for uint256;

    address JACKPOT = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RatPot";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(JackPotFee).div(totalBNBFee);
