...
contract SATOSHISBEATS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SATOSHISBEATS";
    ...
    uint256 public _maxWalletToken = 2 * 10**5 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xF589ccB68DdA1F245E68a5EBE12c1162dA5ac498;
        marketingFeeReceiver = 0xF589ccB68DdA1F245E68a5EBE12c1162dA5ac498;
        teamFeeReceiver = 0xF589ccB68DdA1F245E68a5EBE12c1162dA5ac498;
        utilityFeeReceiver = 0xF589ccB68DdA1F245E68a5EBE12c1162dA5ac498;
