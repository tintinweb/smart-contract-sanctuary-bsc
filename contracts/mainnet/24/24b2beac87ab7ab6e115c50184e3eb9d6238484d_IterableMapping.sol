...
contract ApeZilla is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 690000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 690000000000 * (10**18);
    uint256 public swapTokensAtAmount = 2000 * (10**18);
    uint256 public maxWalletToken = 1380000000000 * (10**18);
    ...
    address payable public  marketingWallet = payable(0x24E4C994a699DA1EBfDc29d08Fd84716f7E11D17);
    ...
    constructor() ERC20("ApeZilla", "ApeZ") {
