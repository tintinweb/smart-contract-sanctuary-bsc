...
contract KanameInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Kaname Inu";
    string private constant _symbol = unicode"KANAMEINU";
    ...
    uint256 public _maxBuy = _tTotal * 2 / 100;
    uint256 public _maxSell = _tTotal * 2 / 100;
    uint256 public _maxWalletToken = _tTotal * 4 / 100;

    uint256 public _swapTrigger = 5;
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 200;

    address payable public DevWallet = payable(0x25Ed52d2deAd3D32720FFf03aB92a0bA8F672c77);
    address payable public MarketingWallet = payable(0x28DbEC296248dD69165948704F00685edd9846b5);
