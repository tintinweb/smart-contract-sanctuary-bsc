...
// SPDX-License-Identifier: Unlicensed
    ...
    /// Asuna INU is meme coin, we will add some utilities as this coin grows,we need a strong community to help us develop this, we don't want this coin to die in just a few days or even hours, we will develop it, but we need the support of the community and investors, joint https://t.me/+5Ih8EbAM0WQyZGVl
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x971d7b6A62f49cDeD96be96cC72dD50a57F72B2F;
...
contract ASUNAINU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xF0bBD7A3E0AC2af407f8B4c97Ac581CbedB600FC);
    ...
    */
    ...
    string private _name = "ASUNA INU"; 
    string private _symbol = "ASUNA";  
