...
/**
Amemiya Nazuna is a Japanese language VTuber affiliated with VShojo 
as part of it's Japanese unit "Vshojo NEXT" alongside Kson. She debuted on 16 July 2022.

A community is created to support this VTuber as it grows. 
Giving a 5 tax in each transactions for marketing and autoliquidity.

Telegram: https://t.me/anazunacoin
*/
...
contract ANAZUNA is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANAZUNA COIN"; // 
    string private constant _symbol = unicode"飴宮なずな"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xf8B09483541c83cd913eCcb119478CF5D3eF308f;
