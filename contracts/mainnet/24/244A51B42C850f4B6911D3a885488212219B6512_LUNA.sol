...
contract LUNA is ExtendedReflections {

    uint256 private _tokenSupply = 1_000_000_000;

    uint32 private _taxMarketing = 0;
    uint32 private _taxBuyBack = 0;
    uint32 private _taxRewardWallet = 0;
    uint32 private _taxDev = 10;
    ...
    constructor (address _marketingAddress, address _buyBackAddress, address _rewardAddress, address _devAddress) ExtendedReflections("LUNA (Wormhole) 2.0", "LUNA", _decimals, _tokenSupply, _busd) {
