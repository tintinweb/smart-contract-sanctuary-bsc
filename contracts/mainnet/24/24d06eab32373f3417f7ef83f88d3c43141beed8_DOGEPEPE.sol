...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9256D13483302355df3F9DAaD48625614EA4e872; // owner address
...
contract DOGEPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEPEPE";
    string private _symbol = "PEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x465Dde1D5c1700CebCfddBe7abd374e5a7fe3c84); // Marketing Address
    address payable private teamWalletAddress = payable(0x9256D13483302355df3F9DAaD48625614EA4e872); // Team Address
