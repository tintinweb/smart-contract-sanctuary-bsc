...
//https://t.me/fitscryptverification
...
contract FitScryptToken is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 15 * 10**8 * 10**9; // 1.5% of the supply
    uint256 public maxTxAmount = 25 * 10**7 * 10**9; // 0.25% of the supply
    ...
    constructor() ERC20("FitScrypt", "$FIT") {
        ...
        */
        _mint(owner(), 100 * 10**9 * (10**9)); // 1,000,000,000,000 Tokens
    }
