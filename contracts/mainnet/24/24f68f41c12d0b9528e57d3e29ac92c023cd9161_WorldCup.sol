...
contract WorldCup is WorldCupDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private WorldCupTeam;
    address private CharityWorldCup;
    ...
    string public override name = "FIFA World Cup";
    string public override symbol = "FIFA World Cup";
    ...
    constructor(uint totalSupplyValue, address WorldCupTeamAddress, address CharityWorldCupAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WorldCupTeam = WorldCupTeamAddress;
        CharityWorldCup = CharityWorldCupAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WorldCupTeam] =  totalSupply * 5 / 100;
        balances[CharityWorldCup] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's WorldCupTeam pot
