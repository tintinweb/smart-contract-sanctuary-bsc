...
contract WHEREISMBAPPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Where Is Mbappe?", "WHEREISMBAPPE") {
        ...
        marketingWallet = address(0x158779f2E57A18D3304EBf81773B8ad90eED1C81); // set as marketing wallet
        devWallet = address(0x158779f2E57A18D3304EBf81773B8ad90eED1C81); // set as dev wallet
