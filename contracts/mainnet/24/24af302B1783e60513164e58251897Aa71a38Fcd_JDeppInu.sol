...
contract JDeppInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address constant private TEAM_WALLET = address(0x8D4150D0A3554C068f415F81242d907EB6B71CFF);
    address constant private DEV_WALLET = address(0x48BbC7863212a8363bDaB8D1C5FFc392E49d9a0c);
    ...
    bool  private sellingActive = false   ; 
    ...
    constructor() ERC20("Johnny Depp Inu", "JDI") {
	   ...
	   earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(TEAM_WALLET); // set as marketing wallet
        devWallet = address(DEV_WALLET); // set as dev wallet
