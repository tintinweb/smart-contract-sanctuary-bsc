...
/**
 * MoonKnight BSC
 * https://twitter.com/MoonKnight_BSC
 * https://t.me/MoonKnight_BSC
 */
...
contract MoonKnight is IERC20, Ownable {
    ...
    string constant _name = "MoonKnight";
    string constant _symbol = "MK9";
    ...
    function takeFee(
        ...
        uint256 feeAmount = amount.mul(getTotalFee(recipient == pair)).div(feeDenominator);
    ...
    function swapBack() private swapping {
        ...
        uint256 totalBNBFee = totalBuyFee.sub(liquidityFee.div(2));
    ...
    function setFees(
        ...
        totalBuyFee = _liquidityFee.add(_marketingFee);
