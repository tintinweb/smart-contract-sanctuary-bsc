...
contract Raptor2Go is Context, IERC20, Ownable {
    ...
    string private _name = "Raptor 2 Go";
    string private _symbol = "Raptor2go";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x5D421bAfaa6F0e5E44464Ad6117D15cdf2503DbE);
