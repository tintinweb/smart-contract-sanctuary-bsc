...
contract DADDYFROGINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Daddy Frog Inu";

    string private _symbol = "Daddy Frog Inu";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x8Cae7de2523Ee4995fcAcb2935D11A08f0458b4c;
    ...
    uint256 public _totalSupply =  40000000 * 10**_decimals;
