...
/*
DogeInuChain
To celebrate the newly-launched blockchain platform, Dogechain; DogeInuChain will soon launch on BSC to gather all the Doge lovers & build a strong community. 

DogeInuChain will burn 10% of token before launch, and from each of the buy & sell transaction, it will also burn a small amount of DogeInuChain to make it more rare & pump the price.

Tokenomics:
~ 100,000,000,000 of Supply (100 Billion)
~ 4% Low Tax Fees
~ 1 BNB as Initial LP

Join DogeInuChain on : https://t.me/DogeInuChain
*/
...
contract DogeInuChain is Context, IERC20 { 
    ...
    string private constant _name = "DOGEINUCHAIN"; 
    string private constant _symbol = "$DOGEIC"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 4;
    uint256 public _Tax_On_Sell = 18;
