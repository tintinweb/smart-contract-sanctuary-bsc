...
=== 'BeechTree' Token contract with following features ===
    => ERC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2020 onwards Beechtree Inc. 
 Contract designed with ❤ by Beechtree 
-------------------------------------------------------------------
*/ 
...
contract BT_Token is owned {
    ...
    string constant private _name = "BEECH TREE Token";
