...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90c9a7dDdEeF29F987671BaEF0aE3E81d5f426B5; // 所有者地址
...
contract SucShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Suc Shiba";
    string private _symbol = "SUCSHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90c9a7dDdEeF29F987671BaEF0aE3E81d5f426B5); // 营销地址
    address payable public teamWalletAddress = payable(0x56ba8942D0D95f1836EA88cbeC5F8e98ca09Db40); // 团队地址
