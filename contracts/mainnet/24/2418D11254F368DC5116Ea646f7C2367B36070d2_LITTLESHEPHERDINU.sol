...
contract LITTLESHEPHERDINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LITTLESHEPHERDINU";
    string constant _symbol = "LSINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0x060A4B3f39579477f1f814A59E21a71297b94c1a  ;
