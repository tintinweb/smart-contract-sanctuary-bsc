...
contract Shirohige is Context, IERC20 {
    ...
    string private constant _name = "Shirohige";
    string private constant _symbol = unicode"SHIROHIGE";
    ...
    uint256 public _Shiro_maxWallet = (_tTotal * 2) / 100;
    uint256 private _previousMaxWalletToken = _Shiro_maxWallet;

    uint256 public _Shiro_maxTx = (_tTotal * 2) / 100;
    uint256 private _previousMaxTxAmount = _Shiro_maxTx;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    address payable public _Shiro_Own__Wallet =
        payable(0x07A909511E6C6F3a0910f5eae9E337a2c1d3f031);
    address payable public constant __Burn__Wallet =
        payable(0x000000000000000000000000000000000000dEaD);
    address payable public _Shiro_Open__Wallet =
        payable(0x07A909511E6C6F3a0910f5eae9E337a2c1d3f031);
    ...
    constructor() {
        _owner = 0x07A909511E6C6F3a0910f5eae9E337a2c1d3f031;
        ...
        _isExcludedFromFee[_Shiro_Open__Wallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _Shiro_maxWallet,
                "Over wallet limit."
            );
        }

        if (from != owner())
            require(amount <= _Shiro_maxTx, "Over transaction limit.");
        ...
        if (
            ...
            if (contractTokenBalance > _Shiro_maxTx) {
                contractTokenBalance = _Shiro_maxTx;
            }
            txCount = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(_Shiro_Open__Wallet, BNB_M);

        BNB_Total = address(this).balance;
        sendToWallet(_Shiro_Own__Wallet, BNB_Total);
    }
