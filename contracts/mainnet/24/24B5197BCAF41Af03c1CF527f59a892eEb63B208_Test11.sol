...
contract Test11 is Context, IERC20, Ownable {
    ...
    string private _symbol = "Test11";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9fBC3DB52541EAb94c34133D310830379eE7C71D);
    address payable public teamWalletAddress = payable(0xfB0d0595C3eE5F4C8EAfD9be0df1E5B64c7Ad96C);
