...
contract  JAILKWON is Context, IBEP20, Ownable {
    ...
    uint256 private constant _MAX_FEE_LIMIT = 25;
    ...
    function changeFeesForNormalBuy(uint8 _liquidityFeeOnBuy, uint8 _marketingFeeOnBuy, uint8 _EtrondistributionFeeOnBuy) external onlyOwner {
        require(_liquidityFeeOnBuy <= _MAX_FEE_LIMIT, "LiquidityFeeOnBuy can't exceed 25%!");
        require(_marketingFeeOnBuy <= _MAX_FEE_LIMIT, "MarketingFeeOnBuy can't exceed 25%!");
        require(_EtrondistributionFeeOnBuy <= _MAX_FEE_LIMIT, "EtrondistributionFeeOnBuy can't exceed 25%!");
    ...
    function changeFeesForNormalSell(uint8 _liquidityFeeOnSell, uint8 _marketingFeeOnSell, uint8 _EtrondistributionFeeOnSell) external onlyOwner {
        require(_liquidityFeeOnSell <= _MAX_FEE_LIMIT, "LiquidityFeeOnSell can't exceed 25%!");
        require(_marketingFeeOnSell <= _MAX_FEE_LIMIT, "MarketingFeeOnSell can't exceed 25%!");
        require(_EtrondistributionFeeOnSell <= _MAX_FEE_LIMIT, "EtrondistributionFeeOnSell can't exceed 25%!");
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        require(maxTxPercent != 0, "Can't set max tx percentage to zero!");
