...
contract TYCToken is ERC20, Ownable {
    ...
    function setLiquidityDividendFee(uint256 value) external onlyOwner {
        liquidityDividendFee = value;
    }
    ...
    function setProjectManagerFee(uint256 value) external onlyOwner {
        projectManagerFee = value;
    }

    function setClubFee(uint256 value) external onlyOwner {
        clubFee = value;
    }
