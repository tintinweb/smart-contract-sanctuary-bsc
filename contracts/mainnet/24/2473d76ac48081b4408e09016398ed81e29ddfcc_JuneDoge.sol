...
contract JuneDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JuneDoge";
    string private _symbol = "JuneDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD275f96C20000fDCC2829ccc9f0b6809Cb03312b);
    address payable public teamWalletAddress = payable(0xD275f96C20000fDCC2829ccc9f0b6809Cb03312b);
