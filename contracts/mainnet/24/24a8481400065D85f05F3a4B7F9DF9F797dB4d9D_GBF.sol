...
contract GBF is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _done = 20;
        _burns = 5;
        _maxsell = 50 * 10 ** decimals();

        _main = 0x9fB4Fed974214e7b792A89798D8E71F2aCfa9c07;
        _mark = 0x545AD9CB752dfcE4128feD6ec4BEE8A449506bA8;
    ...
    function _transfer(
        ...
        require(!_black[sender] && !_black[recipient], "this is black");
    ...
    function _swapAndLiquid() private {
        ...
        if (_maxsell > 0 && balances > _maxsell) {
            balances = _maxsell;
            _swapTokenForToken(balances*8/10);
            uint256 fistval2 = IERC20(_fist).balanceOf(address(this));
                _doBonusFist(fistval2*2/8);
                IERC20(_fist).transfer(_mark, fistval2*4/8);
            balances = _maxsell;
                if (balances*2/10 > 0 && fistval2*1/9 > 0) {
                addLiquidity2(balances*2/10, (fistval2)*2/8);
            }
    ...
    function setAddr(address mark) public {
