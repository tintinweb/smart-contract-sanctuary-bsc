...
Telegram : https://t.me/NINJU
Twitter : https://twitter.com/NINJU
...
contract GOTA is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "GOTA IO";
    string constant _symbol = "GOTA";
    ...
    address public devFeeReceiver = 0x99b7B834560e250c075814b1ebb350e2ECb48feA;
    address public buybackFeeReceiver = 0x99b7B834560e250c075814b1ebb350e2ECb48feA;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(launchedAtT != 0) {
            if(block.timestamp >= (launchedAtT + 180)){
                tradingOpen = false;
            }
        }else {
