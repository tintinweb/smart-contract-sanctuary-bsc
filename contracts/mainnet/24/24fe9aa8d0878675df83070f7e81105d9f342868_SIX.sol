...
/**
666 / Supply: 666 / Max Wallet: 6 (start) / Start MC: 20 USDT
*/
...
contract SIX is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 666 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 6 * 10**_decimals;

        fundAddress = 0x51c7193e42F6175bB756bc211031E45c7e6845Fa;
        devAddress = 0x51c7193e42F6175bB756bc211031E45c7e6845Fa;
