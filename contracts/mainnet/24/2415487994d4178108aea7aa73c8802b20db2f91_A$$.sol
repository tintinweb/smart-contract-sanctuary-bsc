...
contract A$$ is IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 2) / 1000;  // 0,2 max tx 
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 1000;  // 0,2 max wallet
    ...
    address public marketingFeeReceiver = 0x00B5e84feda2bcDB5bf3bD80682d7459F194DE02;
    address public teamFeeReceiver = 0xbefea0e13d22Eac90505d03A491950f14dB36b65;
