...
contract MozanoChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mozano Chain";
    string private _symbol = "MZNO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xE9b778cb50e0E14f06B4814973Ba002998fCc7E8);
