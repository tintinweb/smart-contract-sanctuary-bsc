...
contract NEWYEARSHIBA is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x248f3B410647E0DD56c125bAFf8D9F41A9E45eE9;

    string constant _name = "New Year Shiba Token";
    string constant _symbol = "NYST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = 5000000000000000;
    uint256 public _maxWalletToken = 10000000000000000;
