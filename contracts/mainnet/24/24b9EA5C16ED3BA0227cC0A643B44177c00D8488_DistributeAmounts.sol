...
contract DistributeAmounts is OwnableUpgradeable, ReentrancyGuardUpgradeable, IAmountsDistributor {
    ...
    function _buyAndBurnGYMNET(uint256 _buyAndBurnAmountGYM) private {
        // IERC20Upgradeable(busdAddress).safeTransfer(buyAndBurnAddress, _buyAndBurnAmountGYM / 2);
        ...
        //     _buyAndBurnAmountGYM / 2,
        //     uint256(0),
        //     uint256(block.timestamp + 100)
        // );

        // uint256 BNBAmount = _convertBUSDtoBNB(_buyAndBurnAmountGYM / 2);
