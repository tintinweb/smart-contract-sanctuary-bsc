...
contract RatBoyTrippleDollar  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x216A774942F423e01D0514dBCF74a56088beF888); 
    address payable public Wallet_Dev = payable(0xAED7B633F454Ed49ECa9bCb9f865080917f6FE24);
    ...
    string private constant _name = "RatBoyTrippleDollar"; 
    string private constant _symbol = unicode"WENTXN$$$"; 
    ...
    constructor () {
        ...
        _owner = 0xAED7B633F454Ed49ECa9bCb9f865080917f6FE24;
