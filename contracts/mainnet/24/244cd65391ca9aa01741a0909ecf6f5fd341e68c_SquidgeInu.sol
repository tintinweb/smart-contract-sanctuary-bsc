...
/**
 ...
 Squidge Inu is a New Inu Token on BSC and will join the Web 3.0 hype, bringing DEX Exchange to BSC. 

 TELEGRAM PORTAL= https://t.me/SquidgeInuPortal

 WEBSITE= https://squidgeinu.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1DeEA7c0436D78EF683329DEA40C0912f5b9a3B8; // owner address
...
contract SquidgeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidgeInu";
    string private _symbol = "$SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1DeEA7c0436D78EF683329DEA40C0912f5b9a3B8); // 
    address payable public teamWalletAddress = payable(0x1DeEA7c0436D78EF683329DEA40C0912f5b9a3B8); // 
