...
contract Energyfi is Context, IERC20, Ownable {
    ...
    address payable public _marketingWallet =
        payable(0xC48fA79712B5fd485b6f11E7C8EC2ce2F67e469d);

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 2 * 10**6 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**5 * 10**18;
    ...
    function _takeBurnAndMarketing(uint256 tBurn, uint256 tMarketing) private {
        ...
        if (tBurn > 0) {
            emit Transfer(msg.sender, address(0xdead), tBurn);
        }
    }
    ...
    function _transfer(
        ...
        if (
            ...
            swapTokensForEth(contractTokenBalance, _marketingWallet);
        }
    ...
    function swapTokensForEth(uint256 tokenAmount, address recepient)
        private
        lockTheSwap
    {
