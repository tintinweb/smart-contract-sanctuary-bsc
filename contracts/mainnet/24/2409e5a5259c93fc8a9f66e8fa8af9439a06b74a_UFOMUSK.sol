...
🕳Welcome to UFO MUSK🕳
Elon Tweet :  https://twitter.com/elonmusk/status/1624839280270131200?s=20&t=9gkiJMc5OjNOEd_Z-rsc3w

TG : https://t.me/UFOMUSK
...
contract UFOMUSK is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "UFO MUSK";
    string private _symbol = "UFOMUSK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8b7E959c9F47c4A73285Cf0Afa0D4DF08e1f1646);
    address payable public liqWalletAddress = payable(0x8b7E959c9F47c4A73285Cf0Afa0D4DF08e1f1646);
    ...
    uint256 private _totalSupply =  7425 * 10**_decimals;
    uint256 public _maxTxAmount =    222 * 10**_decimals;
    uint256 public _walletMax =      222 * 10**_decimals;
