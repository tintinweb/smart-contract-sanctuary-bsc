...
contract FFFFFFFF is Context, IERC20, Ownable {
    ...
    string private _name = "SuperMax";
    string private _symbol = "SuperMax";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0xfA0Ac84962ACfFd8ff896E5679B691105DE12345);
    address payable public teamWalletAddress = payable(0xfA0Ac84962ACfFd8ff896E5679B691105DE12345);
