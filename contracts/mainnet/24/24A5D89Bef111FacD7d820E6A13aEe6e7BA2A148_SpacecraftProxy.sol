...
contract SpacecraftProxy is Proxy, ProxyOwnable {
    using Address for address;

    bytes32 private constant _IMPLEMENT_ADDRESS_POSITION = keccak256("YOLO-FOX-NFT.impl.address.84c2ce47");
    bytes32 private constant _OWNER_POSITION = keccak256("YOLO-FOX-NFT-Proxy.owner.7e2efd65");
