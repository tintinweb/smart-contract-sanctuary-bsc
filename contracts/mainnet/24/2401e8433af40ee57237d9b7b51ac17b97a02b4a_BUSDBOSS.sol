...
contract BUSDBOSS is ERC20, Ownable {
    ...
    address public marketingWallet = 0x2008d0723aB60A112F07079D2049E46eb11b133a;
    ...
    constructor() ERC20("BUSD BOSS", "BBOSS") {
    ...
    function updateMaxBuyTxLimit(uint256 maxBuy) external onlyOwner {
        ...
        require(maxBuy >= 30_000_000, "Cannot set max buy amount lower than 0.1%");
    }
