...
contract SAP is Context, IERC20, Ownable {
    ...
    string private constant _name ="SAP";
    string private constant _symbol =unicode"SAP";
    uint8 private constant _decimals = 0;
    mapping (address => bool) private _isSniper;
    address payable private _marketingAddress = payable(0x92b906f41f9C88381F4c472df766EaBb8C4f1111);
    address payable private _marketingAddress2 = payable(0x92b906f41f9C88381F4c472df766EaBb8C4f1111);
