...
Bonk!Bonk!
Lp Burnt and Renounced
Telegram Chat: https://t.me/catbonkofficial
...
contract  CatBonk is IBEP20, Auth {
    ...
    address DEV =  0x76ca324ad2162a36A7aA8546f3aB45612549dd76;
    ...
    string constant _symbol = "CatBonk";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // CatBonk KILL ZERO

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 1000; // 3% 
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 1000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 1000; // 3% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x76ca324ad2162a36A7aA8546f3aB45612549dd76;
