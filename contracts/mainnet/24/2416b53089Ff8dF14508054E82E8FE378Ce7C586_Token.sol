...
contract Token is Context, ITRC20, Ownable {
    ...
    address private _fundAddress = 0x00a17f28A568c2c52E0B436288B3ACE78A32bF1F;
    ...
    constructor (address fundAddress) public {
        ...
        _isExcludedFromFee[0x0656c1fDeBd71153dcf23332Bc68373c9e6A6152] = true;

        _balances[0x0656c1fDeBd71153dcf23332Bc68373c9e6A6152] = _totalSupply;

        emit Transfer(address(0), 0x0656c1fDeBd71153dcf23332Bc68373c9e6A6152, _totalSupply);
    }
