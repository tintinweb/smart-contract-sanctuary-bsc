...
Name    : Baby ShrimpGrow
Symbol  : $BSGROW

Rewards in ShrimpGrow, $SGROW
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20  RWRD = IERC20(0x9B911E0eFD7B7e9D781C8d20a6a6B32612EceA88); // $SGROW reward asset
...
contract BabyShrimpGrow is IERC20, Auth {
    using SafeMath for uint256;

    address RWRD                            = 0x9B911E0eFD7B7e9D781C8d20a6a6B32612EceA88; // $SGROW reward asset
    address WBNB                            = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD                            = 0x000000000000000000000000000000000000dEaD;
    address ZERO                            = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver     = 0x18C8baD090A5cEd7A470e599EfD1599367fbEB3E;
    ...
    uint256 public _maxBuyTxAmount          = _totalSupply * 100 / 10000;   // 1% = 10,000,000 tokens
    uint256 public _maxSellTxAmount         = _totalSupply * 100 / 10000;   // 1% = 10,000,000 tokens
    uint256 public _maxWalletToken          = _totalSupply * 200 / 10000;   // 2% = 120,000,000 tokens
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy,  uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        require(totalFeeBuy < feeDenominator/4, "Fees cannot be more than 20%");
    }
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
        ...
        feeDenominator      = _feeDenominator;
        require(totalFeeSell < feeDenominator/4, "Fees cannot be more than 20%");
    }
    ...
    function setSwapBackSettings(bool _enabled, uint256 swapbackPercent) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _totalSupply.mul(swapbackPercent).div(10000);         
    }
