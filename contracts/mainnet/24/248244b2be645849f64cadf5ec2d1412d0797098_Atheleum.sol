...
// File: @openzeppelin/contr[email protected]/proxy/utils/UUPSUpgradeable.sol
...
contract Atheleum is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("Atheleum", "ATE");
        __ERC20Permit_init("Atheleum");
        __Ownable_init();
