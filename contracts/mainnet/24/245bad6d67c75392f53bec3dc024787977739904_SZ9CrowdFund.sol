...
contract SZ9CrowdFund is Ownable {
    ...
    address public funder = address(0x68526035AB133E9FBE272Db16D3293d19238E7Ae);
    uint256[] public prices = [0.2 ether, 1 ether];
    // TODO
//    uint256[] public prices = [200 ether, 1000 ether];
    uint256[] public pieces = [500, 50];
    ...
    function addPrices(uint256 _price) public onlyOwner {
        prices.push(_price);
    }
    ...
    function addPieces(uint256 _piece) public onlyOwner {
        pieces.push(_piece);
    }
