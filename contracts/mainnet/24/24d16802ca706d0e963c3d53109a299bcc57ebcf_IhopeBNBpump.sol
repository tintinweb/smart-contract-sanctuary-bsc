...
contract IhopeBNBpump is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8000000000000 * 10**9;
    uint256 public _maxTxAmount = 8000000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000 * 10**9; //
    string private constant _name = "I Hope BNB PUMP"; // 
    string private constant _symbol = "PLEASEPUMPBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xef430032EB9b89dCBA1A916917103AB826B1398b;
