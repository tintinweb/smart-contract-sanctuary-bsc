...
contract NewFarmCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewFarmCoin";
    string private _symbol = "NewFarmCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x619379030e5255deF0cb2C4d73001df418eAAd49);
    address payable public teamWalletAddress = payable(0x619379030e5255deF0cb2C4d73001df418eAAd49);
