...
contract  DraculaElon is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dracula Elon";
    string private _symbol = "DRACULA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa216D87d1B9C3FFD8e461cE44E0Db14eE7Dfa0B6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xa216D87d1B9C3FFD8e461cE44E0Db14eE7Dfa0B6); // BuyBack Address
