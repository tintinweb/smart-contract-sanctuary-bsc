...
contract  LC is IERC20, Ownable {
    ...
    constructor(){
            address adminAddress = 0x0F048294EDD43AD032Ba2dEbe9DE31EB06C521Be;
            ...
            _marketingFee = 200;
            _LPFee = 0;
            marketAddr =  0x0c280493dcEe8F03a33958C1E7DAd23D6f9048A8;
            ...
            maxTax = 10* (10**uint256(_decimals));
            maxHave = 5 * (10**uint256(_decimals));
            burnEndNumber = 0* (10**uint256(_decimals));
        
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
                0x87992C12d4a57Bff88d8C82B51315D674B63a52d
            );
