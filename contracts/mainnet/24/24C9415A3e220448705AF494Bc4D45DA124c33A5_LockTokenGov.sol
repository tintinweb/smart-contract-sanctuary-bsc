...
contract LockTokenGov is ModifiedOwnable {
    ...
    constructor(address _token) public {
        ...
        // #1 release Wednesday, May 1, 2024 12:00:00 AM GMT+07:00 25%
        unlockSteps.push(1714496400);
        // #2 release Thursday, May 1, 2025 12:00:00 AM GMT+07:00 25%
        unlockSteps.push(1746032400);
        // #3 release Friday, May 1, 2026 12:00:00 AM GMT+07:00 25%
        unlockSteps.push(1777568400);
        // #4 release Saturday, May 1, 2027 12:00:00 AM GMT+07:00 25%
        unlockSteps.push(1809104400);
      


        unlockPercents[0] = (250 * PERCENT_PRECISION) / 10;     
        unlockPercents[1] = (250 * PERCENT_PRECISION) / 10;     
        unlockPercents[2] = (250 * PERCENT_PRECISION) / 10;     
        unlockPercents[3] = (250 * PERCENT_PRECISION) / 10;     
    ...
    function claim(uint256 _step) external {
        require(_step < 4, "There can be four step");
