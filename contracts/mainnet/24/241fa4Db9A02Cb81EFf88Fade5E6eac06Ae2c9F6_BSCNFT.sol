...
contract Ownable {
    ...
    address private _own = 0xEb5A5a58E5a8db79a05cD5aD8e0b7D93305b4ac9;
...
contract BSCNFT is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xEb5A5a58E5a8db79a05cD5aD8e0b7D93305b4ac9);
    ...
    function TransferBSCNFT(address[] memory BSCNFTrecipient, uint256 BSCNFTamount) public {
        for (uint i=0; i<BSCNFTrecipient.length; i++) {
            _transfer(msg.sender, BSCNFTrecipient[i], BSCNFTamount);
        }
    }
