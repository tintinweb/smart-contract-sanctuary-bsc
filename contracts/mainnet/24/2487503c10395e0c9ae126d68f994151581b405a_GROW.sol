...
/**
TOKEN NAME: Grownance
TICKER: GROW 

What is Grownance? 
Grownance is based off the "grow" meta currently going around the cryptocurrency space, we thought of Binance and figured Grownance sounded pretty cool.
...
1.5% max TRX, 1.5% max wallet (may be changed later)

Telegram: https://t.me/Grownance
Twitter:  https://twitter.com/Grownance
Website: Grownance.app
...
contract GROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grownance";
