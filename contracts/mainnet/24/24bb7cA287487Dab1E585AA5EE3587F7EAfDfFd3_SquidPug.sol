...
/**
 SquidPug
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat SquidPug designed.
    
    I make this #SquidPug to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/SquidPug
   ...
   I will renounce the ownership to burn addresses to transfer #SquidPug to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 50% total supply to the pool
   Can you make #SquidPug 100000X? 

   1,000,000,000,000,000 total supply
   20,000,000,000,000 SquidPug max limit for per trade
   ...
   it's the best part of the #SquidPug idea, increasing the liquidity pool automatically, 
...
pragma solidity ^0.6.12;
    ...
    contract SquidPug is Context, IERC20, Ownable {
        ...
        string private _name = 'SquidPug';
        string private _symbol = 'SquidPug';
