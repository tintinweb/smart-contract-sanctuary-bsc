...
contract Dogdaughter is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1D963493EBf5611E987477ccAfB52053D955CC43); // Marketing Address
    ...
    string private _name = "Dogdaughter";
    string private _symbol = "Dogdaughter";
