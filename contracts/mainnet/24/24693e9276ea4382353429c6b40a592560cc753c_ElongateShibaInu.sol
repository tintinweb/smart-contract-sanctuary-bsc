...
contract ElongateShibaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elongate Shiba Inu";
    string private _symbol = "ESI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x9548dF02Ac30AFc3A19658dCc984Cd2a802347A4);
