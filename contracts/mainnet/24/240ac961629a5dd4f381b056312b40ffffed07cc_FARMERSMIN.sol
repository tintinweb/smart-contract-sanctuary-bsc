...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46531CC2f2306D46376501d314f1d8B40d4bc6dF; // owner address
...
contract FARMERSMIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FARMER SMIN";
    string private _symbol = "FSMIN";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xe65c95523d1C707011f74b124624d10f5C5B97a4); 
    address payable public teamWalletAddress = payable(0xe65c95523d1C707011f74b124624d10f5C5B97a4);
