...
contract September11 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdBE10703b0D82FB077AFE82AD1aDeF55Ab220bEb); 
    address payable public Wallet_Dev = payable(0xe9619eEBe0a033850A0f7f31ed5dA3985AAdaC4c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 11092001 * 10**_decimals;
    string private constant _name = "11 September"; 
