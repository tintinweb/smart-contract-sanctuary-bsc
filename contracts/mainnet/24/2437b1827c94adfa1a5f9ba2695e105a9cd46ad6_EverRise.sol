...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xce3d95b6e5e33C650a2848afc7863Fe260F1798e); // Marketing Address
    ...
    string private _name = "A001";
    string private _symbol = "A001";
