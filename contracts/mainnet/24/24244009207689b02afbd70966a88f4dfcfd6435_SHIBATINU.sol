...
contract SHIBATINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBAT INU"; // 
    string private constant _symbol = "SHIBAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x61F3a7c0cEE0b0B03CB73287807884C3A1D7E4d9;
