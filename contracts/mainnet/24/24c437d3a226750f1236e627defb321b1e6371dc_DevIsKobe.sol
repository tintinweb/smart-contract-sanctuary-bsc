...
contract DevIsKobe is Context, IERC20, Ownable {
    ...
    uint256 private maxTxAmount = 10_000 * (10**_decimals);
    uint256 private maxWallet =  20_000 * (10**_decimals);
    uint256 private _swapThreshold = 1 * (10**_decimals); 

    string private constant _name = "Dev Is Kobe"; 
    string private constant _symbol = "DEVKOBE";    
    
    uint256 private _buyTax = 3;
    uint256 private _sellTax = 10;
    uint8 private _treasuryRatio = 8;
    uint8 private _lpRatio = 2; 
    address public treasuryWallet = 0xDa0250dF49027259a5Fc9d7B65D0A9abCf8B8B65;
...
//============== Owner Functions ===========//
    ...
    function owner_setWatchDogSettings(uint duration, bool isEnded) external onlyOwner{
        _wDuration = duration;
        _watchDogEnded = isEnded;
    }
