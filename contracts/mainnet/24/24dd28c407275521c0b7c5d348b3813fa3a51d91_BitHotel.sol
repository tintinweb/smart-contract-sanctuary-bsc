...
contract BitHotel is ERC721URIStorage, ERC2981PerTokenRoyalties, AccessControl {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal virtual override(ERC721) onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function mint(
        ...
        require(
            _tokenIds.current() < replicas,
            "The token can not mint anymore."
        );
        _tokenIds.increment();
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC165, AccessControl)
        returns (bool)
    {
