...
// File: contracts/Lunacash.sol


// LunaCash is a rewarding token that is rewarding its holders with LUNA, as it is having its own DEX and having a lot of utilities coming further to heavy marketing.
//Website: https://www.terra.money/
//Telegram: https://t.me/lunacashbsc
...
contract LuquidgeneratorToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Luna Cash";
    string constant _symbol = "$L-Cash";
