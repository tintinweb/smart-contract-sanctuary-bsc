...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xD5EdE27899c52A6BedF6B8B1881B8b1A9701592A; // owner address
...
contract SS is Context, IERC20, Ownable {
    ...
    string private _name = "StinkSale";
    string private _symbol = "SS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaDedFbcBBb7c16C5D0091FB6411E180131852b64); // Marketing Address
    address payable public teamWalletAddress = payable(0xaDedFbcBBb7c16C5D0091FB6411E180131852b64); // Team Address
