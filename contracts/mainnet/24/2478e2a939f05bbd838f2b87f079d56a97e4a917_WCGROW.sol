...
contract WCGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8dc69B12eE5dBDC1ADa57b9f1Eb2C7C5359e4a99); 
    address payable public Wallet_Dev = payable(0x14AfF441f66b395db4e291A955F144De649a916D);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0xbed67D8aD83d23aB4C1EeAd5A9920FE2449B42bA); 
    


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 0;
    uint256 private _tTotal = 690000000000 * 10**24;
    string private constant _name = "World Cup Grow"; 
    string private constant _symbol = unicode"SQI"; 
    ...
    constructor () {
        ...
        _owner = 0x14AfF441f66b395db4e291A955F144De649a916D;
