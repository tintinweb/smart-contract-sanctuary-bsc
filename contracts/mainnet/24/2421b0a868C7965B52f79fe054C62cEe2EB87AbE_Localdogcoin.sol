...
contract Localdogcoin is Context, IERC20, Ownable {
    ...
    string private _name = "X-Sports";
    string private _symbol = "X-Sports";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04EB35166d151aE7742801255B33a137F639ec44);
    address payable public teamWalletAddress = payable(0xAb59e890F70dBd439807a6D56A8AfffCb18Bc65c);
