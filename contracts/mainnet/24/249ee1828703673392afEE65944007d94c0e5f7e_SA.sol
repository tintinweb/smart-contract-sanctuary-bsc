...
contract SA is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0x63345Fa1661054d074C2659783cA6a31ffa4630d);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0xB6f2AD28592C5dB9b257a42507541Af8e7456889);
    address private inviteAddress = address(0xB6f2AD28592C5dB9b257a42507541Af8e7456889);
