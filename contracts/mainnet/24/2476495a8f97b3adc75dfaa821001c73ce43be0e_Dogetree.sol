...
contract Dogetree is ERC20, Auth {
    ...
    string constant private _name = "DogeTree";
    string constant private _symbol = "$DTREE";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isContract(sender), "Error: Snipping bot detected");
