...
/*
PiFinance
Leading Pi Economy Ecosystem
As the world becomes increasingly digital, 
cryptocurrencies are the next natural step in the evolution of money. 
Pi is the first digital currency available to the general public and represents an important step forward in the global adoption of cryptocurrencies.

🙆🏻‍♀️ Pi Finance Swap: https://pifinance.tech/swap
🌐 Official website:https://pifinance.tech/
🐦 Twitter:https://twitter.com/PiFiToken
*/
...
contract PiFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "PiFinance";
    string private constant _symbol = "PIFI";
