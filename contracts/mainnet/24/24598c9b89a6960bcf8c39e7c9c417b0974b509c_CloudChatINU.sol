...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x98F8Fa03FdCb69C2880297c77FB16ca027CE3632; // owner address
...
contract CloudChatINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cloud Chat Inu";
    string private _symbol = "CLCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf618E7D512F1295FA4676005901F86A0fD531C68); // Marketing Address
    address payable public teamWalletAddress = payable(0xf618E7D512F1295FA4676005901F86A0fD531C68); // Team Address
