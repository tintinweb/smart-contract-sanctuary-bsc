...
contract ChupaChups  is IBEP20, Chup {
    using SafeMath for uint256;
    string private constant _name = 'ChupaChups';
    string private constant _symbol = 'Chup';
