...
contract AndyLauCoin is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Andy Lau";
    string constant _symbol = "Andy Lau";
    ...
    function setAndyFees(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
        liqFee = liquidityFee;
        marketFee = marketingFee;
        feeDenominator = denominator;
    }

    function setLauExempt(address holder, bool exempt) external authorized {
