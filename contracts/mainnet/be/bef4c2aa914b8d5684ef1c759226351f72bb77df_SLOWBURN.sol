...
$SLOWBURN
BASED ON ELON TWEET
SLOW BURN LOW TAX AND SAFU CODE
1% BURN 2% MARKETING
DYOR AND ASK OTHERS WHO CAN READ CODE
https://t.me/slowburnlowtax
*/
...
contract SLOWBURN is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("SLOWBURN LOWTAX", "SLOWBURN") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x46196498d6Ca15FFBf909e7d3895526813fE72ec); // CHANGE THIS TO YOURS
