...
contract GalaPurge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gala Purge"; // 
    string private constant _symbol = unicode"GALAPURGE"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _CreatorWallet = 0xc32D44b9d44DD683d7E9649EaE7eD034Af57687f;
