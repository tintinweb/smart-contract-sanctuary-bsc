...
contract DividendDistributor is IDividendDistributor {
    ...
    // BTCB Mainnet 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c
    IBEP20 RWRD = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTCB pegged
    address WBNB;
    IDEXRouter router;
...
contract DogeGangToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x20Cb490FbbeFD0284110eAD48FB09671ACe5F2E4;
    address MARKETING = 0x20Cb490FbbeFD0284110eAD48FB09671ACe5F2E4;
    address LIQUIDITY = 0x20Cb490FbbeFD0284110eAD48FB09671ACe5F2E4;
    string constant _name = "Doge Gang Token";
    string constant _symbol = "GANG";
    ...
    constructor() Auth(msg.sender) {
        ...
        autoLiquidityReceiver = address(LIQUIDITY);
        marketingFeeReceiver = address(MARKETING);
        devFeeReceiver = address(MARKETING);
    ...
    function burn(uint256 amount) external override authorized {
        _balances[msg.sender] = _balances[msg.sender].trySub(amount);
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountGANG);
}