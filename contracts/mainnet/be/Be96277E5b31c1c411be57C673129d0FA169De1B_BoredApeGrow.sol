...
contract BoredApeGrow is Context, IERC20, Ownable {
    ...
    string private _name = "BoredApe Grow";
    string private _symbol = "BoredApe";
    ...
    uint256 private _totalSupply = 30000000 * 8**_decimals;
    uint256 public _maxTxAmount = 20000000000 * 8**_decimals; 
    uint256 public _walletMax = 200000000000 * 8**_decimals;
    uint256 private minimumTokensBeforeSwap = 30000000 * 5 **_decimals; 
