...
Telegram : https://t.me/OuriKroniiInu
...
contract OURI is Context, IERC20, Ownable {
    ...
    string private constant _name = "OURI KRONII INU"; // 
    string private constant _symbol = "$OURI"; //    
