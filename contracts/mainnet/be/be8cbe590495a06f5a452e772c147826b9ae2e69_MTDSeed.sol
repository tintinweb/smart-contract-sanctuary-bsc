...
contract MTDSeed {
    ...
    IERC20 public token = IERC20(0x096D25018a4900cAA2271B2FF72b752E6b64BdCc); 
	uint256 constant public INVEST_MIN_AMOUNT = 10000 ether; // 10000 MTD
	uint256[] public REFERRAL_PERCENTS 	= [400, 200, 200, 100, 100, 50, 50, 50, 25, 25];
	uint256[] public SEED_PERCENTS 		= [800, 500, 300, 200, 100, 50, 75, 50, 25, 25];
	...
	constructor(address payable wallet) public {
		...
		plans.push(Plan(360, 120));
		plans.push(Plan(180, 160));
