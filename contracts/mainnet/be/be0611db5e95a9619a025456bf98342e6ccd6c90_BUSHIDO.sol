...
/**
 *Telegram: https://t.me/bushidocode1
 *Fair launch
 *Initial liquidity=1BNB
 *Buyback and burn=0.55BNB+4% buy/sell tax
 *Buy/Sell 8% (4% Liquidity 4% Buyback and burn)
 *LP locked
 *Ownership Renounced
 *Max wallet=5%
*/
...
contract BUSHIDO is Context, IERC20, Ownable {
    ...
    string private _name = "Bushido";
    string private _symbol = "CODE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDf8C790305e0F5C154BfA92B39b72A9BC9CAF84d); 
    address payable public teamWalletAddress = payable(0x8650a423e13e1296578691e7dCEceD1ddD194943); 
