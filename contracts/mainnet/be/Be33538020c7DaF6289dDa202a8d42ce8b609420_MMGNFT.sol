...
abstract contract VRFv2Consumer is VRFConsumerBaseV2 {
  ...
  contract MMGNFT is ERC721, Ownable,VRFv2Consumer{
   ...
   mapping (uint256 => nft_struct) public token_nft;
    ...
    function set_subscriptionId(uint64 _id)external onlyOwner{
    ...
    function set_address(address _mmg_address,address _mmc_address) public onlyOwner {
        Mmg_contract = _mmg_address;
        Mmc_contract = _mmc_address;
    }
    function open_nft(uint256 start_tokenId,uint256 end_tokenId,uint256 size)public onlyOwner{
    ...
    function owner_open_nft(uint256 start_tokenId,uint256 end_tokenId,uint256 size)public onlyOwner{
        require(start_tokenId != 0 && end_tokenId != 0 && size != 0);
   ...
   function setPrice(uint256 _price) public onlyOwner{
    ...
    function setBaseURI(string memory baseURI) public onlyOwner {
     ...
     //设置nft属性  加添加
    function AddNft(uint256 _gold,uint256 _aggressivity,uint256 _Magnification,uint256 probability,uint256 level,uint256 _synthesis,uint256 _cooling_time,uint256 _consume_number,uint256 _life_cycle,uint256 _total,string memory _image_url) public onlyOwner{
