...
contract UphoriaProtocol is Initializable, IBEP20 {
    ...
    function setRefWallet(address _newRefWallet) external onlyOwner {
        _refWallet = _newRefWallet;
    }
