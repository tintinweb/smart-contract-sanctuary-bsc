...
contract FomoRabbitToken is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x22961ecf050088986EA3197d8c937Aedd17932e1));
    address payable private devWallet =
        payable(address(0xBF848f02d0328E4ac3A3c413E863d8Ca304497AA));
    address private liquidityReceiver =
        0xBF848f02d0328E4ac3A3c413E863d8Ca304497AA;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "FOMO Rabbit";
    string private _symbol = "FORBIT";
