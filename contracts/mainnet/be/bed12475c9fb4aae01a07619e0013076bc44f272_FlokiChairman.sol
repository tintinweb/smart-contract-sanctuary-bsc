...
contract Ownable is Context {
    ...
    function removeManagerRole() public virtual onlyManager {
        emit RevokeManagerRole(_manager, address(0));
        _manager = payable(address(0));
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor(address router_) {
        ...
        WBNB = IERC20Extended(router.WETH());
    }
...
// main contract
contract FlokiChairman is IERC20Extended, Ownable {
    using SafeMath for uint256;
    using Address for address payable;
    ...
    uint256 public prevTotalBuyFee = 80;
    ...
    function setBulkIsBot(address[] memory bots, bool exempt) external onlyOwner
    {
    ...
    //happy hour
    function activateHH(bool status) 
    ...
    function setBuyFees(
        ...
        prevTotalBuyFee = _liquidityFee.add(_reflectionFee).add(_marketingFee);
