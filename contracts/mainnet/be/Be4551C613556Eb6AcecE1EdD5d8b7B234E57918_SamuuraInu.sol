...
contract SamuuraInu is IBEP20, Auth {
    ...
    string constant _name = "Samuurai Inu";
    string constant _symbol = "SMRI";
    ...
    constructor (address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _buybackFeeReceiver) Auth(msg.sender) {
    ...
    function tradingStatus(bool _status) external onlyOwner {
        require(tradingOpen == false);//Once set true, can't be turned false.
        tradingOpen = _status;
    }
