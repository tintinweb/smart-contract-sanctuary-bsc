...
contract KINGDOGB is ERC20, Ownable {
    ...
    constructor() ERC20("KingDOGB", "KDOGB") {
        _mint(msg.sender, 1000000000000000000 * 10**decimals());

        marketingFeeAddress = payable(
            0xeeF4De43E6263a2A9fE6FCbb94B81B66DAC3906f
        );
        stakingFeeAddress = payable(0x0eBe572622647C9cB720aC67eE41C73136886D03);
