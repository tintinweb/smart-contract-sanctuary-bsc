...
contract RTRT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RTRT";
    string private _symbol = "RTRT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30dDA382a852e3F02184C1878120990fFdeE9552);
    address payable public teamWalletAddress = payable(0x30dDA382a852e3F02184C1878120990fFdeE9552);
