...
contract Hashflow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2A401e34511Df98eb68BA27730dC30a102EF1f6E); // Marketing Address
    ...
    string private _name = "Hashflow";
    string private _symbol = "HFT";
