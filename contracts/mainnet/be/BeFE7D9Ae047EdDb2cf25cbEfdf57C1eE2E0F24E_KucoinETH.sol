...
contract KucoinETH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Kucoin ETH";
    string private _symbol = "Kucoin ETH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x6192Fb0E1599F6A38F3fF772e313F4B1B3B3dB5A);
