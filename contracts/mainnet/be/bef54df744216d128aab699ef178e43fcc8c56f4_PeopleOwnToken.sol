...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x082dECF8e4142Ce3Be6158D7eb6d961002325A60;
        _owner = msgSender;
...
contract PeopleOwnToken is Context, IBEP20, Ownable 
{
   ...
   // ---------- STAKES ----------
    ...
    function createStake(uint256 _stake, uint256 _stakingPackage) external
    {
        ...
        uint256 fee = _stake.mul(5).div(100);
        _stake = _stake.sub(fee);
        _transferStandard(msg.sender, address(this), fee);
