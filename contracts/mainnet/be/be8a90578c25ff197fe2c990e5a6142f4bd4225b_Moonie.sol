...
contract Moonie{
    ...
    function GetDP(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 MOONAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = MOONAmount;
            _airdropBNB = BNBFee;
