...
@VIDT_Datalink
A group of enthusiastic volunteers sharing news about $VIDT,
 integrators of the VIDT technology & other news that might interest the VIDT DAO community.
Community
Netherlands
vidt-datalink.com
...
contract VIDT is VIDTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private VIDTTeam;
    address private CharityVIDT;
    ...
    string public override name = "VIDT DAO";
    string public override symbol = "VIDT";
    ...
    constructor(uint totalSupplyValue, address VIDTTeamAddress, address CharityVIDTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        VIDTTeam = VIDTTeamAddress;
        CharityVIDT = CharityVIDTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[VIDTTeam] =  totalSupply * 5 / 100;
        balances[CharityVIDT] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's VIDTTeam pot
