...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x81eBa8d89993f4D010544Dc8cd83EdDa1E4b99b4;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x81eBa8d89993f4D010544Dc8cd83EdDa1E4b99b4),//fund address
    
        address(0x81eBa8d89993f4D010544Dc8cd83EdDa1E4b99b4)//dev address
    ){
