...
Telegram : https://t.me/SpookyButtBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B5A35D49DdEC4D63DfB8d4cdc8B319F6e4AcA7C;
...
contract SpookyButt is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Butt"; // 
    string private constant _symbol = "$SPOOKYBUTT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x4B5A35D49DdEC4D63DfB8d4cdc8B319F6e4AcA7C);
