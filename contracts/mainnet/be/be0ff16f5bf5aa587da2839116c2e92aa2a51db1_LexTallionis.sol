...
Twitter: https://twitter.com/LexTallionisBSC
Website: https://lextallionis.space/
Medium:  https://lextallionis.medium.com/
Official telegram: @LextallionisBSC
...
contract LexTallionis is IBEP20, Auth {
    ...
    string constant _name = "Lex Tallionis";
    string constant _symbol = unicode"$LEX";
