...
contract AIDOGE is IBEP20, Ownable {
    ...
    string constant _name = "AI Doge"; // To Do
    string constant _symbol = "$AID"; // To Do
    ...
    uint256 public _maxWalletToken = _totalSupply / (100) * (100); // 3%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0xD6FD2317CaCB347442a745b7b68d9D5d8BEfDdC0;
    address public devFeeReceiver = 0xD6FD2317CaCB347442a745b7b68d9D5d8BEfDdC0;
    address public buybackFeeReceiver = 0xD6FD2317CaCB347442a745b7b68d9D5d8BEfDdC0;
