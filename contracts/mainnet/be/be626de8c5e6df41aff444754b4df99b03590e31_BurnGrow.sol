...
contract BurnGrow is Context, IERC20, Ownable {
    ...
    string private _name = "BurnGrow";
    string private _symbol = "$BGROW";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x1A6187542d72042Cd225EcEd4D87705C9B0ac91b); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x1A6187542d72042Cd225EcEd4D87705C9B0ac91b); // Team Address
