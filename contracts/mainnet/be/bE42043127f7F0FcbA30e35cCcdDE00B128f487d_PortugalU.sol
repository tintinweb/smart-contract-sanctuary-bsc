...
/**
STEALTH LAUNCH 
TG: https://t.me/+5KVroCQF1mg5NmM1
TAX: 
BUY : 5% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa2Eb2BCAcd6E07B3c9087d4e23e5BEe4D5dF98CD; // owner address
...
contract PortugalU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PortugalU";
    string private _symbol = "$TugalU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa2Eb2BCAcd6E07B3c9087d4e23e5BEe4D5dF98CD); // Marketing Address
    address payable public teamWalletAddress = payable(0xa2Eb2BCAcd6E07B3c9087d4e23e5BEe4D5dF98CD); // Team Address
