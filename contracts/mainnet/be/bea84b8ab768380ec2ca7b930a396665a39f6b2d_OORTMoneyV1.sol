...
/**
            OORT.MONEY(R2E) V1->V2
 This is the community lead project (SocialFi + GreenFi + GameFi)  in combining real world experience with a commitment to change, 
  embracing ESG (Environment, Social and Governance) concept with the sole objective to invite millions toward a healthier lifestyle and
  promote green and sustainability concept.
  
  Lets recycle-to-earn (R2E) and do our part for sustainable ecosystem!!!

  For More Information -  https://oortverse.xyz/  and join TG : https://t.me/oortverse  ; https://twitter.com/VerseOort
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x55d398326f99059fF775485246999027B3197955);// USDT Rewards
    IDEXRouter router;
...
contract OORTMoneyV1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OORT.Money";
    string constant _symbol = "R2E";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x10B4E9c92B405571aa4C8DCe666B0b3Ce76684B6;//mkt
        buybackFeeReceiver = 0x10B4E9c92B405571aa4C8DCe666B0b3Ce76684B6;//
        teamFeeReceiver = 0x674e1e6B3a902e0797463997A691e83Bb475FE87;//
    ...
    function dowesojobots(bool _status) public onlyOwner {
         sojoBots = _status;
    }
