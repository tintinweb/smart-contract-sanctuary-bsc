...
contract BritishDoge is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0x4C8C88E71f83342cd453887C752edb77ed2b5ECf;

    string private constant _name = "British Doge";
    ...
    Taxes public taxes = Taxes(0, 1, 1);
    Taxes public sellTaxes = Taxes(1, 0, 98);
