...
contract FlokiMarvin  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKIMARVIN"; // 
    string private constant _symbol = "FLKMRVN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x39a5CAD15A9B5e8d947288eCbaEd75832d00958a;
