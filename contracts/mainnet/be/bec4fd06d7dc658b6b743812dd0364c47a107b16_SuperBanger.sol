...
There is no tg or socials from the deployer. Let the community create all socials.

The LP will be burned. FOREVER

There is no max transaction or max wallets. Buy it all if you want.

Shill it. Share it. This is yours.
...
contract SuperBanger  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'SuperBanger';
    string private constant _symbol = 'SuperBanger';
