...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61Ee0cd0FD0435a45D9EB263B69a8EEB573dAf87; // owner address
...
contract MuuCeo is Context, IERC20, Ownable {
    ...
    string private _name = "MuuCeo";
    string private _symbol = "$MC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4bB8540fD7e9af43BBC34430b5C8a12ccd02cb9C); // Marketing Address
    address payable private teamWalletAddress = payable(0x61Ee0cd0FD0435a45D9EB263B69a8EEB573dAf87); // Team Address
