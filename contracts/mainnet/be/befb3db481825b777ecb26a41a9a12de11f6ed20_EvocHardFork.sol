...
contract EvocHardFork is Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _feeCreateProject) {
        ...
        feeCreateProject = _feeCreateProject * (10**18);
    }
    ...
    function changeFork(uint256 tokenAmount, address contractAdd) public {
    ...
    function createHardFork(
        ...
        HardForkRegister[_contractAdd]._OwnerAdd = msg.sender;
    ...
    function updateHardFork(
        ...
        require(
            address(msg.sender) ==
                address(HardForkRegister[_contractAdd]._OwnerAdd) ||
        ...
        HardForkRegister[_contractAdd]._simbol = _simbol;
        HardForkRegister[_contractAdd]._bonusPercent = _bonusPercent;
        HardForkRegister[_contractAdd]._OwnerAdd = _OwnerAddr;
        HardForkRegister[_contractAdd]._contractAdd = _contractAdd;
        HardForkRegister[_contractAdd]._contractOldAdd = _contractOldAdd;
        HardForkRegister[_contractAdd]
            ._contractAddReceive = _contractAddReceive;
        ...
        emit UpdateHardFork(msg.sender, _contractAdd, _name);
    }
    ...
    function withdTokens(address _contractAddr, address _withdAddr) public {
        require(
            msg.sender == _owner ||
                msg.sender == HardForkRegister[_contractAddr]._OwnerAdd,
            "Only the Project Administrator or the platform owner can make withdrawals."
        );
        require(
