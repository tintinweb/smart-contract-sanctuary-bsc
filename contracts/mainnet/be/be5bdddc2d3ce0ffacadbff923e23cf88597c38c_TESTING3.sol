...
// TESTING3 IS HERE, MAKE MONEY WHILE SLEEPING
...
contract TESTING3 is IBP20, Ownable {
    ...
    string constant _name = "TESTING3";
    ...
    uint256 sellPeriod = 1 minutes;

    uint256 antiDumpTax = 10;
    uint256 antiDumpPeriod = 1 minutes;
    uint256 antiDumpThreshold = 100000;
