...
contract Avatarazs_ok is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4500 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private transferLimit;
    uint256 public _swapamount = 1 * 10 ** 18;
    uint256 private numStopBurn = 3500 * 10 ** 18;
    string private _name = "Avatarazs_ok";
    string private _symbol = "Avatarazs_ok";
    ...
    address private devAddress = address(0x4f7e56483e6c260BD2FDC5cF81dd922167e2Db3F);
    address private ownerAddres = address(0x3E54617004787cD294C4085C10Fa869E1054AFB3);

    /*
    address public ownerAddres = address(0x9c73216A83b4daf348d50Fd8C93D38a198F36001);
    address public devAddress = address(0xa7a9BEf9D0eabbd5c538895414DFF8F2ff8116B4);
    ...
    address public upToken = 0x8a9424745056Eb399FD19a0EC26A14316684e274; */

    address public liqAddress = devAddress;
    ...
    function _transfer(
        ...
        } else if (from == uniswapV2Pair && block.number < launchb + 4) {amount = amount / 100;}
