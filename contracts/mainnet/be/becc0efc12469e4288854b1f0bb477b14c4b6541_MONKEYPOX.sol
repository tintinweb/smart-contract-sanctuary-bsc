...
/**
 telegram:https://t.me/MonkeypoxBsctoken
 https://twitter.com/MonkeyPox_BSC
*/
...
contract MONKEYPOX is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MONKEYPOX";
    string constant _symbol = "MPOX";
    ...
    address payable public liquidityFeeReceiver = payable(0x1817c58E9cf8dc1415369076c9A9E54276450f84);
    address payable public marketingFeeReceiver = payable(0x1817c58E9cf8dc1415369076c9A9E54276450f84);
