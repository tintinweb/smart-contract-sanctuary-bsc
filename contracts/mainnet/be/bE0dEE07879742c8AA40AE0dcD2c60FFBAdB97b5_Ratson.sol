...
TG: https://t.me/+G2WJlnNddfA3NjI1
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7383cfFCc07C46a7E0b719ab1d0B2978D3d9151; // owner address
...
contract Ratson is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatSon";
    string private _symbol = "RS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x958C73B9e3b91d5FA0F2BAC8F19368EC72FFe52f); // Marketing Address
    address payable public teamWalletAddress = payable(0x958C73B9e3b91d5FA0F2BAC8F19368EC72FFe52f); // Team Address
