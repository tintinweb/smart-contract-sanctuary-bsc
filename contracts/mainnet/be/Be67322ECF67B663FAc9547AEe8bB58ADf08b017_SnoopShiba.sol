...
contract SnoopShiba is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 4; // Fee is initially set to 99% to avoid sniperbots
    uint16 public feeliq_sell = 20; // Fee is initially set to 99% to avoid sniperbots
    ...
    constructor() ERC20("Snoop Shiba", "SNSH") {
