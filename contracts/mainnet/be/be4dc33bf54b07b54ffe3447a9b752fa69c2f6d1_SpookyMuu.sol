...
/*
 Find us on TG: https://t.me/spookymuuofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15d7D387C4657bbC7A1A9F61b88F35F4426B58B9; // owner address
...
contract SpookyMuu is Context, IERC20, Ownable {
    ...
    string private _name = "SpookyMuu";
    string private _symbol = "SPKM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15d7D387C4657bbC7A1A9F61b88F35F4426B58B9); // Marketing Address
    address payable private teamWalletAddress = payable(0x47b67ff2aA19F0d1689eF56ACE9f2a1547446f17); // Team Address
    ...
    uint256 private _liquidityShare = 4; // original 5
    uint256 private _marketingShare = 8;
    uint256 private _teamShare = 0; // original 12

    uint256 private _totalTaxIfBuying = 6;  // original 12
    uint256 private _totalTaxIfSelling = 6;  // original 12
    uint256 private _totalDistributionShares = 12;  // original 12
