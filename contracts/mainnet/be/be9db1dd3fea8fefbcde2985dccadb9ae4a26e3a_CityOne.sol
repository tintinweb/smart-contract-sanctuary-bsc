...
contract CityOne {
    ...
    function invest(address payable referrer,uint256 token_quantity) public payable beforeStarted() {
        ...
        tokenUSDT.transfer(marketingAddress,tokenWei.mul(1000).div(PERCENTS_DIVIDER));
    ...
    function token_price(uint256 _amountIn) public view  returns(uint[] memory amounts) {
        ...
        path[0] = 0x55d398326f99059fF775485246999027B3197955; // this will be usdt address
        path[1] = 0x7CfF374484e560cf2eEEb8922be025bf7f0c82d2; // this wil be c1 token address  
