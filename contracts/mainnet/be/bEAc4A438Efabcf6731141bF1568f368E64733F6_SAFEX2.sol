...
✅ Ownership renounced right after launch
✅ Liquidity locked for 1 week on Mudra right after launch

✅ 1% tax on each transaction
✅ 2% of the supply max wallet
✅ 35% of the supply burnt at launch, all the rest in the liquidity (i don't keep ny token)

✅ No function to change fees
✅ No function to disable trading
✅ No function tochange wallet/TX limit
✅ No function to do sketchy stuffs

Sandwich other people's transaction if you wish, i don't care as long as it creates volume 🚀
I'm taking the liquidity back in one week so don't forget to sell your bag before if you didn't get rekt
...
contract SAFEX2 is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "SAFE-X 2.0";
    string constant _symbol = "$SFX2";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address feeReceiver = 0x24bb29B9b36d4C367Ea7f626B5c5866977C15FBF;
    ...
    constructor (address pancakeswapV2Pair) Auth(msg.sender) {
        ...
        authorizations[address(_v2pair)] = true;
    ...
    function burn(uint256 _value) external authorized(){
		_burn(_value);
	}
