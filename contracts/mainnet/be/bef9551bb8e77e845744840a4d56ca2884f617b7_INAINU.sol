...
contract INAINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB4349Ce7b26984BFbd1e1Db488994Dcb044076eD);
    address payable public Wallet_Dev = payable(0xBff3111C494dFa001a900673A3BCdE11f6e3675D);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "INARI INU"; 
    string private constant _symbol = unicode"INAINU";
