...
contract NETHERLANDSWORLDCUP is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x944EF1aD491CaBfF32533F546755212Cf3F691e5); 
    address payable private Wallet_Dev = payable(0xB9A65e5Af389f84a3A5dD0c0582B774e2E2bAC8b);
    ...
    string private constant _symbol = unicode"NLWC"; 
    ...
    constructor () {
        ...
        _owner = 0xB9A65e5Af389f84a3A5dD0c0582B774e2E2bAC8b;
