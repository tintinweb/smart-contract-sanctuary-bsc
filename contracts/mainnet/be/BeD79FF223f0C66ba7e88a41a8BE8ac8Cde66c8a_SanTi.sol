...
2020年4月，列入《教育部基础教育课程教材发展中心 中小学生阅读指导目录（2020年版）》高中段文学阅读。 [2] 
2022年9月，《三体》入选2021十大年度国家IP。 [67] 
*/
...
contract SanTi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"三体";
    string private _symbol = unicode"SanTi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xD5865a0cCAF63c9922A749294b97b1654675f931);
    ...
    uint256 private _totalSupply = 3333333333 * 10**8 * 10**_decimals;
