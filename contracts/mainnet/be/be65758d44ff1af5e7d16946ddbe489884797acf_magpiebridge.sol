...
contract magpiebridge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5b0b21a1B9f96F03dcecB2803e2a323CfDA0b1eb); // Marketing Address
    address payable public teamWalletAddress = payable(0x5b0b21a1B9f96F03dcecB2803e2a323CfDA0b1eb); // Team Address
