...
/**
 Earn passive income with BonkeyKong! - BUSD Rewards!!
 Join our community on Telegram: @bonkey_kong
*/
...
contract BonkeyKong is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BonkeyKong";
    string constant _symbol = "BKONG";
    ...
    uint256 public sellMultiplier  = 900; //change to 100 when launch!
