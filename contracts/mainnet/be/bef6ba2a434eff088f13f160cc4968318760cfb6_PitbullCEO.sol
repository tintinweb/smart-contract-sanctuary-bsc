...
contract PitbullCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pitbull CEO";
    string private constant _symbol = "PCEO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3332DF2a3A1b0a260269d96dC0103490209529e2);
    address payable private _marketingAddress = payable(0x3332DF2a3A1b0a260269d96dC0103490209529e2);
