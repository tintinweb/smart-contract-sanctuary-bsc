...
contract AIRobot is Context, IERC20, Ownable {
    ...
    string private _name = "Virtual Robot CEO";
    string private _symbol = "AIRobotCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f01CD2E65fE4d8b4d717A528410c54f0d73652C);
    address payable public teamWalletAddress = payable(0x8f01CD2E65fE4d8b4d717A528410c54f0d73652C);
