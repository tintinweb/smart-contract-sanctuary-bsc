...
// File: contracts/JCAKEDividendPayingToken.sol
pragma solidity ^0.7.6;
...
contract JCAKE is ERC20, Ownable {
    ...
    constructor() public ERC20("Jolly Cake", "JCAKE") {
   ...
   function blacklistAddress(address account, bool excluded) public onlyOwner {
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "JCAKE: This account cannot send tokens until trading is enabled");
        }
...
contract JCAKEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("JCAKE_Dividend_Tracker", "JCAKE_Dividend_Tracker") {
        claimWait = 3600;
