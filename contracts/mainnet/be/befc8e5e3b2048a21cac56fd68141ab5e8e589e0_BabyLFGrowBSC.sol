...
contract BabyLFGrowBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby LFGrow BSC";
    string private constant _symbol = "BABY LFG BSC";
