...
/**
🤖PRELAUNCH DETECTOR BOT 🤖
Tracking All activities on Contract Owner/Developer/Wallets (full transaction) making you know Dev/Team next move


👍Know what you’re buying before you spend that bsc! 👍

📱Telegram : https://t.me/PrelaunchDetector
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55F8F3Eb0dF6359288c8e756F928e915a93524d5; // OWNER MUST BE SELECT
...
contract PreLaunchDetector is Context, IERC20, Ownable {
    ...
    string private constant _name = "PreLaunch Detector Bot"; // 
    string private constant _symbol = "PDB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0x397F3E79dd4E4665F2AFFaD7b42C01340580944d);
