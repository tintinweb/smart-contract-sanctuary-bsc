...
contract DefiDoge is ERC20, Ownable {
    ...
    constructor() ERC20("DefiDoge", "DefiDoge") {
        _totalSupply = 210000000000000 * (10**18);

        dividendTracker = new DefiDogeDividendTracker();

        _marketingWalletAddress = 0x166dF0c0A2d8b6D5f9306085E6f659985dB7Dbda;
        _liquidityAddress = 0x3eBABD8E752722c23125514b41318d227D7C42B4;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DefiDoge: The dividend tracker already has that address"
        );

        DefiDogeDividendTracker newDividendTracker = DefiDogeDividendTracker(
                payable(newAddress)
            );

        require(
            newDividendTracker.owner() == address(this),
            "DefiDoge: The new dividend tracker must be owned by the DefiDoge token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "DefiDoge: The router already has that address"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DefiDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DefiDoge: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DefiDoge: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DefiDoge: Cannot update gasForProcessing to same value"
        );
...
contract DefiDogeDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken(
            "DefiDoge_Dividen_Tracker",
            "DefiDoge_Dividend_Tracker"
        )
    {
        claimWait = 86400;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DefiDoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DefiDoge contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DefiDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "DefiDoge_Dividend_Tracker: Cannot update claimWait to same value"
        );
