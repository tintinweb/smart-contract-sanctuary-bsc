...
contract Ai2023 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "Year Of Ai";
    string private constant _symbol = unicode"Ai2023";
    ...
    address payable public DevWallet = payable(0x88FFCba8D16E91dDc9491b8069Db61D34d82c249);
    address payable public MarketingWallet = payable(0x88FFCba8D16E91dDc9491b8069Db61D34d82c249);
    ...
    function setautoDistribution(bool _autoDistribution) external onlyOwner {
