...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd4A7448b036318EdefB1140a584c2fA15C8e1D37;
...
contract Solshiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solshiba Inu";
    string private _symbol = "SolShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd4A7448b036318EdefB1140a584c2fA15C8e1D37);
    address payable public teamWalletAddress = payable(0xd4A7448b036318EdefB1140a584c2fA15C8e1D37);
