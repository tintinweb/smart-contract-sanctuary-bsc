...
contract EverTomCoin is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "EverTom";
    string constant _symbol = "EverTom";
    ...
    function setEverTomStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
    function setTargetEverTomFee(uint8 _target, uint8 _denominator) external authorized {
        _targetLiq = _target;
        _targetLiqDenominator = _denominator;
    }    

    function setSwapFeeEverTom(bool _enabled, uint256 _amount) external authorized {
