...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09859ec77302dc91Da2b462c88587Ec248db6E71;
...
contract GalaxyBlitz is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0271f59E5Aa4b299ffe5585c478796a303D16E58;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Galaxy Blitz";
    ...
    uint256 public _liquidityFee = 950;
