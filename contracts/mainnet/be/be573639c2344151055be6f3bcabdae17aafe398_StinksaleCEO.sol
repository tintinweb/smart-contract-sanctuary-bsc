...
//Telegram: https://t.me/stinksale_ceo
...
contract StinksaleCEO is Context, IERC20, Ownable {
    ...
    string private _name = "Stinksale CEO";
    string private _symbol = "STINK";
    ...
    uint256 public marketFeeOnBuying = 40; // 2% will be added to the market address
    uint256 public devFeeOnBuying = 10; // 2% will be added to the development address
    uint256 public liquidityFeeOnBuying = 20; // 1% will be added to the liquidity

    uint256 public marketFeeOnSelling = 40; // 2% will be added to the market address
    ...
    constructor() {
        marketWallet = payable(0x4A5FB15b93F91384F9d3134a09E0e97A3c265Ec1);
        devWallet = payable(0x8aA78b79254Db73BAF637c869B5432E0c8184ac8);
