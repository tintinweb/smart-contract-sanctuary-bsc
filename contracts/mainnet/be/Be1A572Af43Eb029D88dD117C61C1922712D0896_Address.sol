...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2A80b5926620DFaDaD539813DcD6A898ac899E70;
...
contract metasealink is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2A80b5926620DFaDaD539813DcD6A898ac899E70;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3690000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "metasealink";
    string private _symbol = "metx";
    ...
    uint256 public _maxTxAmount = 3690000000 * 10**18;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x18825c6a9C9e5DBf24D3E4C90F90Ec2B2ff6CCCf);
