...
contract Doge is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1000000000 * 10**5 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000000 * 10**5 * 10**_decimals;
    uint256 public _walletMax = 1000000000 * 10**5 * 10**_decimals;
