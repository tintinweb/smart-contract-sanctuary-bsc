...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdae3EC419d1Db49535fF5bdef4515D8a386d9B9b; // owner address
...
contract HEXBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HexBit Network";
    string private _symbol = "HEXBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC4933413D451FF2Ce2B75548E04Accff046e71a0); // Marketing Address
    address payable public teamWalletAddress = payable(0xdae3EC419d1Db49535fF5bdef4515D8a386d9B9b); // Team Address
