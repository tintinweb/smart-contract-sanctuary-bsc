...
// File: RealEstateVirtualAssets.sol


pragma solidity ^0.8.17;


contract RealEstateVirtualAssets is BEP20, Ownable {
    constructor() BEP20("Real Estate Virtual Assets", "REVA") {
   ...
   function claimForeginTokens (address _token) external onlyOwner {
