...
contract CBDC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE892DB3EcEA60F5D37a25d9474722C58C6698463); // Marketing Address
    address payable public teamWalletAddress = payable(0xE892DB3EcEA60F5D37a25d9474722C58C6698463); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 8888 * 10**3; 
