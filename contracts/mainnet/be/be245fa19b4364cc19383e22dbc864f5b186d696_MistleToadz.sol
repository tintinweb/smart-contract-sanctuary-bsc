...
contract MistleToadz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mistle Toadz";
    string private _symbol = "MISTLETOADZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD76a8c3783C45b075995648e0c1dE75f0636517C); 
    address payable public buyBackWalletAddress = payable(0xD76a8c3783C45b075995648e0c1dE75f0636517C); 
