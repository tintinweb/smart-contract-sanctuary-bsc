...
/*
Queen is Dead Coin $QID - Stealth Launch - Jackpot Coin
QID > QUID

Owner is Dev of Baby Squid Game (646X Coin, BscScan Verified Alpha Deployer) 

Website dApp: https://www.queenisdeadcoin.com
Twitter: https://twitter.com/Queenisdeadcoin
Telegram: https://t.me/Queenisdeadcoin

Every Buy and Sell will feed the Jackpot Fund!
...
contract QueenisDead is Context, IERC20, Ownable {
    ...
    // We don't add to liquidity unless we have at least 1 QID token
    ...
    string private constant _name = "Queen is Dead Coin";
    string private constant _symbol = "QID";
        ...
        )
    {
        ...
        // Either 0 or 1+ QID to prevent PCS errors on liq swap
