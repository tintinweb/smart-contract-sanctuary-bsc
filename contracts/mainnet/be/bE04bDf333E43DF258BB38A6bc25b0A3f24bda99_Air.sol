...
contract Air is Comn{
    ...
    function delivery(address contractAddress,address[] memory _targetAddressArray,uint[] memory _targetAmountToWeiArray) external onlyOwner returns (bool){
    ...
    function deliveryLockAmount(address contractAddress,address[] memory _targetAddressArray,uint amountToWei) external onlyOwner returns (bool){
        for(uint i=0;i<_targetAddressArray.length;i++){
    ...
    function deliveryFrom(address contractAddress,address[] memory _targetAddressArray,uint[] memory _targetAmountToWeiArray) external onlyOwner returns (bool){
        require(_targetAddressArray.length == _targetAmountToWeiArray.length,"Air : Inconsistent length");
        for(uint i=0;i<_targetAddressArray.length;i++){
    ...
    function deliveryFromLockAmount(address contractAddress,address[] memory _targetAddressArray,uint amountToWei) external onlyOwner returns (bool){
        for(uint i=0;i<_targetAddressArray.length;i++){
