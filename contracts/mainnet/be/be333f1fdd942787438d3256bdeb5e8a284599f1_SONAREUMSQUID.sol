...
// 
//
// 📱 Telegram:https::https://t.me/SonareumSquid
/*
...
contract SONAREUMSQUID is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SONAREUM SQUID", "SONAREUMSQUID") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SONAREUMSQUID";
    string private _symbol = "SONAREUMSQUID";
