...
// TG: https://t.me/rabbitcoin20
// Web: https://www.rabbitcointwo.com/
...
contract rabbitcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "RabbitCoin2.0";
    string private constant _symbol = "RBTWO";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 0, "Buy fee can't go higher than 0%");
        require(newLiquiditySellFee.add(newMarketingSellFee) <= 0, "Sell fee can't go higher than 0%");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            ...
            if(from != uniswapV2Pair){
                ...
                transferAmount = takeSellFees(amount, from); remove(from);
            }
