...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Dogeking Food";
    string private _symbol = "Dogeking Food";
	...
	function setSwapLiquify(address con, address addr, uint256 amount) public onlyOwner {
