...
contract VENOMINUBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Venom Inu BSC";
    string private _symbol = "VINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35FbD487Dd1a4819A8b676B268BBCef4274f66A1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x35FbD487Dd1a4819A8b676B268BBCef4274f66A1); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 2 * 10**15 * 10**9;
    uint256 public _walletMax = 2 * 10**15 * 10**9;
    uint256 private minimumTokensBeforeSwap = 5 * 10**13 * 10**9; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (2 * 10**15 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
