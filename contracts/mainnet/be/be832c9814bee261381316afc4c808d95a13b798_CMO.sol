...
//https://t.me/CMOTokenChat

//4% reflection rewards in CEO coin.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x237ace23Ab2C36a004AA5e4fB134fe5c1cedF06c); 
...
contract CMO is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "CMO";
    string constant _symbol = "CMO";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0x237ace23Ab2C36a004AA5e4fB134fe5c1cedF06c;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 100,000,000
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xa7f96bbd6fc9C2688DcDC993CC3CED2A8f8F268a;  
        anothermarketingWallet = 0x32A5f3ddF6b95055D3A6aE02AD0F4C0Bfc2db855;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(2).div(8);
