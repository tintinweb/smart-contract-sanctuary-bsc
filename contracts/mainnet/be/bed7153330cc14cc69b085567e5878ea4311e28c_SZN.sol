...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = " SHAMROCK ";
    string private _symbol = " SZN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25Ec2a76041f8dc0ffFeB5bE2BEF1791a3F33249);
    address payable public teamWalletAddress = payable(0x25Ec2a76041f8dc0ffFeB5bE2BEF1791a3F33249);
