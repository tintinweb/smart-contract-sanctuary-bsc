...
//
//
//   📱Telegram::https://t.me/+RJPltrc3hC5lM2R9
/*
...
contract BoneRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BoneRabbit", "BoneRabbit") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BoneRabbit";
    string private _symbol = "BoneRabbit";
