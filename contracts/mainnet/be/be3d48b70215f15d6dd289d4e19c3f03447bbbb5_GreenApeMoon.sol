...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x18da41E66f30bB0EcB11E6ec23ccfE0B7913e6D2);
    IDEXRouter router;
...
contract GreenApeMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Green Ape Moon";
    string constant _symbol = "GAM";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + burnFee + devFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(0x18da41E66f30bB0EcB11E6ec23ccfE0B7913e6D2, msg.sender);
        ...
        marketingFeeReceiver = 0x2CfBF29403fA850D0Aa54b69dcddc8646f27a852;
        devFeeReceiver = 0x2CfBF29403fA850D0Aa54b69dcddc8646f27a852;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) external authorized {
