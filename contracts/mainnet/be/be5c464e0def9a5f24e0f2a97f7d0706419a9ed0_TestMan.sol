...
contract TestMan is ERC20Detailed, Ownable {
    ...
    string public _name = "TestMan";
    string public _symbol = "MAN";
    ...
    constructor() ERC20Detailed("Test End2", "TEST2", uint8(DECIMALS)) Ownable() {
