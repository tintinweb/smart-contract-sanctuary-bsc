...
/** GǒuMine 狗
是 BSC 网络上的社区代币，我们肯定会推动它，为这里的所有投资者带来快乐。希望您对我们以后的努力感到满意
https://t.me/goumine
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x03911bC0449d8b9694D5F6D9c14DA4Dc644bc59c; // owner address
...
contract GouMine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GouMine ";
    string private _symbol = "GOU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03911bC0449d8b9694D5F6D9c14DA4Dc644bc59c); // 
    address payable public teamWalletAddress = payable(0x03911bC0449d8b9694D5F6D9c14DA4Dc644bc59c); // 
