...
//Telegram : https://t.me/SquidDemonportal
...
contract squiddemon is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Squid Demon";
    string constant _symbol = "SUD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 17) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *17) / 100; 
