...
contract RoadMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Road Moon";
    string private _symbol = "RadMoonToken";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6cEc3A6A9FE3a1b5cc25DEB4c43dD677b9Ae764f);
    address payable public TeamWalletAddress = payable(0xCE85b5AF44D11834C0a4FbeA6983375BB7B592B5);
    ...
    uint256 private _totalSupply = 90000000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 100000000000000000000 * 10**9; 
    uint256 public _walletMax = 8000000000000000000000 * 10**9; 
