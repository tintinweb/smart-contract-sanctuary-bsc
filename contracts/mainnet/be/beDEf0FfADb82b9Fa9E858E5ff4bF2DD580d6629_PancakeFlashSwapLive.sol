...
contract PancakeFlashSwapLive {
    ...
    function startArbitrage(uint256 _amount, address[4] calldata coins) external {
        ...
        address pair = IUniswapV2Factory(PANCAKE_FACTORY).getPair(COIN_ONE, COIN_ZERO);
