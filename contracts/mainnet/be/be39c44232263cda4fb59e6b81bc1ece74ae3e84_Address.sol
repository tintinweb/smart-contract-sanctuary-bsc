...
contract LiquidityGeneratorToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        address owner_ = 0x3ea68A791d3250039E7a9a09d098A8Bb80b4Df45;
        string memory name_ = "Zplane";
        string memory symbol_ = "ZPL";
        uint256 totalSupply_ = 100000000 * 10 ** _decimals;
        address router_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address charityAddress_ = 0x3ea68A791d3250039E7a9a09d098A8Bb80b4Df45;
        uint16 taxFeeBps_ = 990; 
        uint16 liquidityFeeBps_ = 990;
        uint16 charityFeeBps_ = 990;
        uint16 maxTxBps_ = 990;
