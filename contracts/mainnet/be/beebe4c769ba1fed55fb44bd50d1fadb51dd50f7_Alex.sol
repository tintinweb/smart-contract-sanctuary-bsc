...
contract Alex is ERC721, Ownable {
  ...
  uint256 public MAX_SUPPLY = 1777;
  uint256 public maximumAllowedTokensPerPurchase = 50;
  uint256 public maximumAllowedTokensPerWallet = 200;
  uint256 public allowListMaxMint = 30;
  ...
  constructor(string memory baseURI) ERC721("Alextestici", "MB") {
    setBaseURI(baseURI);
  }
