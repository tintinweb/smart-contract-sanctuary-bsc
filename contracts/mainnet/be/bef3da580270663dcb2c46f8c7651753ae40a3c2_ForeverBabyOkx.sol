...
📝 Token Information :
♦️Name : ForeverBabyOKX
♦️Blockchain : Binance Smart Chain (BEP20)
...
ForeverBabyOKX Swap will be Launch on Alpha Test next week

*Our token at the initial stage will perform three important aspects, namely:
- ForeverBabyOKX  Game
- ForeverBabyOKX NFTs
- Play to Earn Game

Together we can! Moon Mission 1000x

Telegram : https://t.me/foreverbabyokx
*/
...
contract ForeverBabyOkx is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 45_000_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "ForeverBabyOkx"; //
    string private constant _symbol = "ForeverBabyOkx"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x358CBD8242e1EE6EAee1597630548f051798A64E ;
