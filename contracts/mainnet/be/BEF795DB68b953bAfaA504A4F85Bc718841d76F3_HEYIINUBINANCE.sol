...
contract HEYIINUBINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HeYi Inu Binance";
    string private _symbol = "HEYIINUBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d3E31F8Af6F1860c6d6b54dEC6c50Ce1CDa668A); 
    address payable public buyBackWalletAddress = payable(0x0d3E31F8Af6F1860c6d6b54dEC6c50Ce1CDa668A); 
    ...
    uint256 private _totalSupply = 1000000000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 200000000000000000000000 * 10**9; 
    uint256 public _walletMax = 300000000000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000000000000000000000 * 10**9; 
