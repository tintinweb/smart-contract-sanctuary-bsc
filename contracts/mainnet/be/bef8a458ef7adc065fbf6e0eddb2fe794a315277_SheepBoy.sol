...
contract SheepBoy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x7e2EBD0841828F157718241e8B8460389ADb9f28;
    string constant _name = "SheepBoy";
    string constant _symbol = "SHEEP BOY";
