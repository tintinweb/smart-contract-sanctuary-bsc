...
/**
PAPI INU - A Utility Based Meme Token  

Hold PAPI, EARN REWARD
Stake PAPI, EARN REWARD
Buy PAPI NFT, EARN REWARD

PAPI is Here To Make All Friends HAPPY & RICH

Telegram:  https://t.me/PAPINU
Twitter:   https://twitter.com/PapiInuBSC 
*/
...
/* Token contract */
contract PAPINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0FD5DC6F524Ec6C8Ec479D5dCB54aB54F4e7656c; // Wallet Developer
    ...
    // Name and symbol
    string constant _name = "PAPI INU";
    string constant _symbol = "PAPINU";
    uint8 constant _decimals = 8;

    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals);  // 100 Millions

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1 Millions
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // .5 Millions
    ...
    uint256 public devFeeBuy = 0; // Continue Development and Pay team
    uint256 public totalFeeBuy = 10;

    // Sell fees
    uint256 public liquidityFeeSell = 1;
    uint256 public buybackFeeSell = 0;
    uint256 public reflectionFeeSell = 4; // Rewards Holders
    uint256 public marketingFeeSell = 5; // Calls Marketing Telegram Future
    uint256 public devFeeSell = 0; // Continue Development and Pay team
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0FD5DC6F524Ec6C8Ec479D5dCB54aB54F4e7656c; // Wallet Marketing Work
