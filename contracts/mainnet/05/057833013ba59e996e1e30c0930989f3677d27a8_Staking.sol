...
contract Staking is Context, Pausable, Ownable {
    ...
    mapping(address => bool) private updatingRewards;
    ...
    address public FeeCollector = 0x58C656E6f4a5f819946E5FA44D22E7D10e8cCAbb;
    address public FeeCollector2 = 0x0AA6F6df82bBf488143BaCA8452668849B9Ee14D;
    address public Locker = 0xa45B0BA2d45B9ee7f990CC541e3B5A579CE148dA;
    address public constant ProjectOwner = 0x6C31F27ca4FF1624C9E0aCac7f592BdE5c8Ef6b2;
    ...
    constructor (
        ...
        FeesExcluded[Locker] = true;
        FeesExcluded[ProjectOwner] = true;
    ...
    function changeLockerWallet(address newLocker) external onlyDev {
    ...
    function takeFee(uint256 amount) internal returns (uint256) {
        ...
        Token.transfer(Locker, ((feeAmount * 10 / 100)));
    ...
    function stake(uint256 amount, uint256 poolID) external whenNotPaused {
        ...
        require(AcceptedTermsAndConditions[msg.sender] == true);
    ...
    function withdraw(uint256 amount) external whenNotPaused {
        ...
        if(feesNo() || block.timestamp >= quandoStake[msg.sender] + timeFee) {
            ...
            Token.transfer(Locker, ((tempFees * 10 / 100)));
    ...
    function calculateRewards() private {
        ...
        if(updatingRewards[msg.sender] == false) { feemath(); }
    }
    ...
    function updateRewards() external whenNotPaused {
        require(msg.sender != address(0));
        updatingRewards[msg.sender] = true;
        calculateRewards();
        updatingRewards[msg.sender] = false;
    }
