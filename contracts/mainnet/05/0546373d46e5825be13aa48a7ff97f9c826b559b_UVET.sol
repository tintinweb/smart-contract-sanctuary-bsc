...
/*
 Telegram : https://t.me/UniverNetwork
 Website : https://univernetwork.com
*/
...
contract UVET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UniverNetwork";
    string private _symbol = "UVET";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA66683CCC6e1DFBB2A42eaD148F671638cE12861); // Marketing Address
    address payable public teamWalletAddress = payable(0xA66683CCC6e1DFBB2A42eaD148F671638cE12861); // Team Address
