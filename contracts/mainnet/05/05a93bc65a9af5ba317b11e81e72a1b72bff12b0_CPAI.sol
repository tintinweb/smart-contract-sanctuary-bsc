...
contract CPAI is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3 * 1e18; // 1 * 1e4 * 1e18; 10000 tokens min for swap
    ...
    constructor() ERC20("CPIA Token", "CPAI") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            _isExcludedFromFees[account] != excluded); //"CPAI: Account is already excluded"
   ...
   function setWallets(address _dev, address _game ) external onlyOwner {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CPAI: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address rewardToken)
        DividendPayingToken("CPAI_Dividend_Tracker", "CPAI_Dividend_Tracker", rewardToken)
    {
        claimWait = 3600;
