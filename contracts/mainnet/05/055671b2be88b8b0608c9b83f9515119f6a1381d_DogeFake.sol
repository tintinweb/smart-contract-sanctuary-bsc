...
library Address{
 ...
 contract DogeFake is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 555_656_555_666 * 10**9;
    ...
    address public marketingWallet = 0x3fBe101846961464296B51Fd0FEE1fe8A604944F;
    address public donationWallet = 0x3fBe101846961464296B51Fd0FEE1fe8A604944F;

    string private constant _name = "DogeFake";
    string private constant _symbol = "DF";
    ...
    Taxes public taxes = Taxes(1, 4, 4, 1);
    Taxes public sellTaxes = Taxes(1, 4, 4, 1);
