...
contract JINGLEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " JINGLE INU ";
    string private _symbol = " $JINU "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B27d25AaAA224A34A9F74C590728A5f15F8C740); 
    address payable public teamWalletAddress = payable(0x6B27d25AaAA224A34A9F74C590728A5f15F8C740); 
