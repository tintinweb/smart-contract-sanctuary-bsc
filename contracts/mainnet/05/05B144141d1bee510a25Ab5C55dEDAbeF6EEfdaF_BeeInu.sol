...
contract BeeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4E6AF8e0c50C597260d05DAea41566E82B662e57); 
    address payable public Dev_Wallet = payable(0x4200014cECE91fDE2Da6a933E4ce96421190aee2);
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0x4200014cECE91fDE2Da6a933E4ce96421190aee2;
