...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb789081a4dD14490C287fdF32aadD9DCEa59195B; // owner address
...
contract ShibMas is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb789081a4dD14490C287fdF32aadD9DCEa59195B); // Marketing Address
    address payable public teamWalletAddress = payable(0x509E0F7CDdC5e69801e3aBe7eD487C69c1601E11); // Team Address
