...
contract PREMIERLEAGUE
 is Context, IERC20, Ownable {
    ...
    string private _name = "PREMIERLEAGUE";
    string private _symbol = "PLEAGUE";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xbB56b7613677ae7c2CC031ed3b5af8470D2B0C93));
        _anotherA = payable(address(0xbB56b7613677ae7c2CC031ed3b5af8470D2B0C93));
