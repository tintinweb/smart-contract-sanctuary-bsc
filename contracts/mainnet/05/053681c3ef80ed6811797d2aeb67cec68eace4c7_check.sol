...
contract check is Context, IERC20, Ownable {
    ...
    string private _name = "check";
    string private _symbol = "check";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B2abCEfE89d77c4FfB9271991Ed7b8964d93E7E); // Marketing Address
    address payable private developmentWalletAddress = payable(0x3B2abCEfE89d77c4FfB9271991Ed7b8964d93E7E); // Development Address
    ...
    uint256 public _maxTxAmount = 15 * 10**12 * 10**9;
    uint256 public _walletMax = 15 * 10**12 * 10**9;
