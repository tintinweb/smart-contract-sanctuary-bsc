...
contract PRODEX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2090a78c3e27C8ce667aD0A61aaA2ffC0D97a71a); 
    address payable public Wallet_Dev = payable(0x2090a78c3e27C8ce667aD0A61aaA2ffC0D97a71a);
    ...
    string private constant _name = "Prodex Chain"; 
    string private constant _symbol = unicode"$PRODEX"; 
    ...
    constructor () {
        ...
        _owner = 0x2090a78c3e27C8ce667aD0A61aaA2ffC0D97a71a;
