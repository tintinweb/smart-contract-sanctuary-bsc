...
contract Apevitalikmoneyheisteth  is IBEP20, Auth {
    ...
    string constant _name = "Apevitalikmoneyheisteth ";
    string constant _symbol = unicode"APE VITALIK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 97635605 * (10 ** _decimals);
