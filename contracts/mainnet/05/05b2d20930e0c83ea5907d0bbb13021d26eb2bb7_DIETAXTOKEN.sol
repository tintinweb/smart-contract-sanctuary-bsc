...
Telegram: https://t.me/dietaxtokenbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7EC877dD003c8b25efC719365ac57818DE7Fc30; // owner address
...
contract DIETAXTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DIE TAX TOKEN";
    string private _symbol = "$DTT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7EC877dD003c8b25efC719365ac57818DE7Fc30); // Marketing Address
    address payable public teamWalletAddress = payable(0x9737dC8C9Ee89039E0522E875d8362a8c23b149b); // Team Address
