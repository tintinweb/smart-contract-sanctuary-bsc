...
/**
🐕DOGELON2K23 [$DOGLON]🐕
Telegram : https://t.me/dogelon2k23
*/
...
contract Dogelon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DOGELON 2K23";
    string private constant _symbol = unicode"$DOGLON";
    ...
    address payable public DevWallet = payable(0x949203A20FDa69B0826516c4EE011eBbfdBb7e13);
    address payable public MarketingWallet = payable(0x52d3417f5d241aDD2360faD54837e0FDd6629eca);
