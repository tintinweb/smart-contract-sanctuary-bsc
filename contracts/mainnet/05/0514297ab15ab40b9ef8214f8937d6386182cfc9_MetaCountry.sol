...
contract MetaCountry is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x24dB48558e8547493aDBED87Cff3cb2bBE0E0962)); // MarketingWallet
    ...
    constructor() ERC20("Meta Country", "COUNTRY") {
