...
// main contract
contract SaveUkraineAndFuckPutinToken is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "SUFP TOKEN";
    string private constant _symbol = "$SUFP";
