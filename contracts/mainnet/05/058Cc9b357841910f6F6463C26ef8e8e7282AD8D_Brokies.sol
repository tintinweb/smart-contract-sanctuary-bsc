...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
/* Token contract */
contract Brokies is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8D191695A3689dEa088161dcb0695C1087AF0661;
    ...
    // Name and symbol
    string constant _name = "Brokies";
    string constant _symbol = "A Toxic Masculinity";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 100T

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% on launch or 50B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 2.5% or 25B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 5000; // 5% or 50B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x73A82734D8FcF879b82165c8D7b793b093891F94;
