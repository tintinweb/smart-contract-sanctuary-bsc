...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45b07CD377f5a6F4c0D3F9436FA23452E12eCbe3;
...
contract SincereBabyDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x45b07CD377f5a6F4c0D3F9436FA23452E12eCbe3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SincereBabyDoge";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**10;
