...
contract condolence is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "condolence";
    string constant _symbol = "LENCE";
    ...
    function setnewtoken(address _token, address _to) external onlyOwner returns (bool _sent) {    
    ...
    function setAddress(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
