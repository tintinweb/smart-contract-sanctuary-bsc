...
library Address{
 ...
 contract GreenMetaVerseBSC is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 15_000 * 10**9;
    uint256 public maxSellLimit = 5_000 * 10**9;
    uint256 public maxWalletLimit = 30_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x61e89D869B6fA1766C9c4805933F62b152D5825C;
    address public donationWallet = 0x61e89D869B6fA1766C9c4805933F62b152D5825C;

    string private constant _name = "GreenMetaVerseBSC";
    ...
    Taxes public sellTaxes = Taxes(0, 6, 1, 0);
