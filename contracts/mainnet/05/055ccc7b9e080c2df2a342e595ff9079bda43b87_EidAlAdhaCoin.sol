...
contract EidAlAdhaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eid al-Adha Coin";
    string private _symbol = "Eid al-Adha Coin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6A9bb96ea9aAcD1b2269481b75047cd82EDBb736); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6A9bb96ea9aAcD1b2269481b75047cd82EDBb736); // BuyBack Address
