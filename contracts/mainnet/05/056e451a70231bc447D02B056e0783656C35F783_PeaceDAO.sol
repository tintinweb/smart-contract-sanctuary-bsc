...
contract PeaceDAO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBB8EA11707155e450B4c947B17e82b2d10D289Fb);
    address payable public teamWalletAddress = payable(0x4Be711468f93933D52f10CaAb0bf6016f370D808);
    ...
    uint256 private _totalSupply =  840000000 * 10**_decimals;
    uint256 public _maxTxAmount =   840000000 * 10**_decimals;     
    uint256 public _walletMax =     840000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 1 * 8**_decimals; 
