...
contract ChimeTrust is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chimera Trust "; // 
    string private constant _symbol = " $ChimeTrust"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x22255B4A36a7A7C1085B1caAd927E841c222475b;
