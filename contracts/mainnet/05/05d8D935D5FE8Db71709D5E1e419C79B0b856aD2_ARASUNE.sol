...
contract ARASUNE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Suneku"; // 
    string private constant _symbol = "$ARASUNE "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x8A77e2af48eF4f992c401F9ED7783cb0e8a2cC09;
