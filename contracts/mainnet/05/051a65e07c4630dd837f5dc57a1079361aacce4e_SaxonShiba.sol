...
// https://t.me/SaxonShibaBsc
/**
new token will be liquid locked after 10 minutes
*/
...
contract SaxonShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saxon Shiba";
    string private constant _symbol = "$AXSONSHIBA";
    ...
    address private marketingWallet = address(0xF4D2588666de5868C9423A3257A51A8C1C0A3076);
