...
library SHIKAFINANCE {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "ShikaFinance: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "ShikaFinance: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "ShikaFinance: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "ShikaFinance: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "ShikaFinance: modulo by zero");
    }
 ...
 */
contract SHIKA is IBEP20, HasForeignAsset {
    using SHIKAFINANCE for uint256;
