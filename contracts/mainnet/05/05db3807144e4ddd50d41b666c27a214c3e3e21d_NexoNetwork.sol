...
//TELEGRAM : https://t.me/nexonetworkBSC
//WEBSITE  : https://nexo-network.gitbook.io/what-is-nexo-network/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2a02CdC98001EF53BBc641067836643A79A603da; // owner address
...
contract NexoNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nexo Network";
    string private _symbol = "$NEXO"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2a02CdC98001EF53BBc641067836643A79A603da); // Marketing Address
    address payable public teamWalletAddress = payable(0x2a02CdC98001EF53BBc641067836643A79A603da); // Team Address
