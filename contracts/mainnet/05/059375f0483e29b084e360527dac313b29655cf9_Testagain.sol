...
contract Testagain is IERC20 {
    ...
    string constant private _name = "11testagain";
    string constant private _symbol = "11testagain";
...
//===============================================================================================================
    ...
    function contractSwap() internal lockTheSwap {
        ...
        _approve(address(this), address(dexRouter), amountToLiquify);
    ...
    function enableTrading() public onlyOwner {
        ...
        tradingEnabled = true;
        swapThreshold = (balanceOf(lpPair) * 1) / 10000;
