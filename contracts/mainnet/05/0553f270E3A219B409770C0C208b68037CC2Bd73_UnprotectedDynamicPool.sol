...
/// Don't deploy this deprecated pool to production
contract OriginalPool is
    Initializable,
    IPool,
    OwnableUpgradeable,
...
/// Don't deploy this deprecated dynamic pool to production
contract OriginalDynamicPool is OriginalPool {
    using DSMath for uint256;
    using SignedSafeMath for int256;
...
/**
 * @title Unprotected Dynamic Pool
 ...
 */
contract UnprotectedDynamicPool is OriginalDynamicPool {
    using DSMath for uint256;
