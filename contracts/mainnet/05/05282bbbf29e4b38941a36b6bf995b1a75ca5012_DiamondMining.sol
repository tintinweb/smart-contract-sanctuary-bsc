...
//  Diamond Mining One of The Best Miner
...
contract DiamondMining {
    ...
    IERC20 public token = IERC20(0x6D18a376163871c3e7bB925Ecd3Fb01705154325);

	uint256 constant public INVEST_MIN_AMOUNT = 1000000000 ether; // 
	...
	constructor(address payable wallet ) public {
       ...
       plans.push(Plan(180, 50)); // 180 days 5% daily // 
        plans.push(Plan(90, 50)); // 90 days 5% daily // 
        plans.push(Plan(60, 45)); // 60 days 4.5% daily // 
