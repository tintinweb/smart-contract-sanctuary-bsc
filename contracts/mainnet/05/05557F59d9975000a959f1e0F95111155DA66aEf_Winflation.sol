...
contract Winflation is IBEP20, Auth {
    ...
    string constant _name = "Winflation";
    string constant _symbol = "Winflation";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0x9A4FB1D9a651b4fCe6c6b94D9E8e4D86550EEa1F;
    address private teamFeeReceiver =0x9A4FB1D9a651b4fCe6c6b94D9E8e4D86550EEa1F;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x63d8359444652Cd5df508BE65c4F2Ae334A65053;
