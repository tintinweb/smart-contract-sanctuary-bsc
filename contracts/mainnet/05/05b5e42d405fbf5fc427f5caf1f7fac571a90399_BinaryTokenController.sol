...
contract BinaryTokenController is Ownable {
    ...
    string constant public binaryA_Symbol = "RZRONALDO";

    uint8 public binaryB_Id = 2;
    string constant public binaryB_Name = "Ryz3 Messi";
    string constant public binaryB_Symbol = "RZMESSI";
    ...
    function setAllBuyFees (
        ...
        buyTotalFees = allReward.add(allmarketingDev).add(allLiquidity).add(allCommunity).add(allBurn);
    ...
    function setAllSellFees (
        ...
        sellTotalFees = allReward.add(allmarketingDev).add(allLiquidity).add(allCommunity).add(allBurn);
