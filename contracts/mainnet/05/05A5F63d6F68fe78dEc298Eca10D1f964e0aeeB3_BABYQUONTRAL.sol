...
contract BABYQUONTRAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY QUONTRAL";
    string private constant _symbol = "$BQUON";
