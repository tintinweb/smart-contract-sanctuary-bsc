...
contract SnailTravelers is Initializable, ERC721Upgradeable {
  ...
  function initialize(
    ...
    // Travelers
    tierConfig[Tier.Traveler].maxSupply = 150;
    tierConfig[Tier.Traveler].totalSupply = 0;
    //    Genesis
    ...
    // Trainers
    tierConfig[Tier.Trainer].maxSupply = 10000;
    tierConfig[Tier.Trainer].totalSupply = 0;
    //    Free
  ...
  modifier ensureAvailabilityFor(Tier tier) {
    require(
      1 + tierConfig[tier].totalSupply <= tierConfig[tier].maxSupply,
      "SOLD_OUT"
    );
    _;
  }
  ...
  function mintFromPreSale(
    ...
    ensureAvailabilityFor(Tier.Traveler)
  ...
  function _transfer(
    ...
    emit TravelersEvent(
      from,
      to,
      from == address(0) ? ActionType.Mint : ActionType.Transfer,
      tokenId,
  ...
  function setMaxSupply(uint256 maxSupply_, Tier tier) external onlyOwner {
