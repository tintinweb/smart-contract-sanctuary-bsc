...
TG: https://t.me/Firenetworkglobal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcF523e5cC6388a65176De97448321d5cA35eF7C8; // owner address
...
contract Firenetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fire Network";
    string private _symbol = "FINET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcF523e5cC6388a65176De97448321d5cA35eF7C8); // Marketing Address
    address payable public teamWalletAddress = payable(0xcF523e5cC6388a65176De97448321d5cA35eF7C8); // Team Address
