...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x585458E8b8240BcE9BCD940e4EC208635C03d1c4; // owner address
...
contract RubbitShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"RubbitShiba";
    string private _symbol = unicode"RSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x585458E8b8240BcE9BCD940e4EC208635C03d1c4); // Marketing Address
    address payable public teamWalletAddress = payable(0x585458E8b8240BcE9BCD940e4EC208635C03d1c4); // Team Address
