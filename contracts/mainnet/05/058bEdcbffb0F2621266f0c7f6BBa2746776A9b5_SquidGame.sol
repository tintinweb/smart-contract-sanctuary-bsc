...
/**
Squid Game 3.0 is community operation, encompassing Defi, NFT copyright, online games, etc. Its unique token-holding BSC distribution mechanism that can allow you to acquire more stable income in an interesting way.

✅ Each transaction has a variable 8% tax fee, governed by our $SG3 holders. Currently, there’s a total 8% fee, out of which 5% for marketing and development and the other 2% goes to Liquidity pool and 1% for reflection. 
✅ SQUIDGAME GROW INU is a new BSC token with $SGI rewards. 
✅ All holders of $SG3 automatically rewarded SSC as buys and sells take place.
...
🦑 HYPE NAME
🦑 RENOUNCE 
🦑 WEBSITE RELEASED AT LAUNCH
🦑 LIQUIDITY LOCK 100%
*/
// TG: https://t.me/squidgame_3
...
contract SquidGame is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SG3";
