...
contract Sweden is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sweden";
    string private _symbol = "Sweden";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a2cC3FF23119ABF603C9737d75cd38EA2F743f3); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3a2cC3FF23119ABF603C9737d75cd38EA2F743f3); // buyback Address
