...
contract NOBUYTHISTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NO BUY THIS TOKEN";
    string private constant _symbol = "NBTT";
