...
contract MINIKATNIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Katnip";
    string private _symbol = "MINIPURR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x862dFBC825AAaA05dc5C15D678dEFA0067a2f9D9);
    address payable public teamWalletAddress = payable(0x862dFBC825AAaA05dc5C15D678dEFA0067a2f9D9);
