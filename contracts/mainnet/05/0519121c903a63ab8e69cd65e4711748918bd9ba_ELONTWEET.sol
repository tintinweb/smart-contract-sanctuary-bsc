...
/**
 *  ELON TWEET WE ARE THE FIRST AND OFFICIAL ONE! 
 *  6% TAX, RENOUNCED! 1% reflections LFG!!!!! 
*/
...
contract ELONTWEET is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1000_000 * 10**9;
    uint256 public maxSellLimit = 1000_000 * 10**9;
    uint256 public maxWalletLimit = 200_000 * 10**9;
    
    uint256 private genesis_block;
    uint256 private deadline;
    
    address public marketingWallet = 0x37171FfC01fe153adE00906Eba4B97B6918a1067;

    string private constant _name = "Elon Musk: oh hi lol Inu";
    string private constant _symbol = "ElonTweet";
    ...
    Taxes public taxes = Taxes(1, 3, 2);
    Taxes public sellTaxes = Taxes(1, 3, 2);
