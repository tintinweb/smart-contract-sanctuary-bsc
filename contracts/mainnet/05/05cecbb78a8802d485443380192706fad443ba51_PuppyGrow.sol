...
contract PuppyGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Puppy Grow";
    string private _symbol = "PUPG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5312b179A31650F03dF1C1D5fDEF1167429a26CC);
    address payable public BuyBackWalletAddress = payable(0x5312b179A31650F03dF1C1D5fDEF1167429a26CC);
