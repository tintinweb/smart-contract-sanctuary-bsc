...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3215fE9afd71549C7129AD546c870B3f183C1bbC; // owner address
...
contract RatCatBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatCatBoy";
    string private _symbol = "RCB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4EE9337d652Ef340C04ae194Be4f08599977e54); // Marketing Address
    address payable public buybackWalletAddress = payable(0x3215fE9afd71549C7129AD546c870B3f183C1bbC); // Buyback Address
