 ...
 *
/**   
/     Telegram :  https://t.me/FuckElonDoge
 *  
 *     100% SAFU launch with 100% locked liquidity and renounced contract ownership.
 *    
 /  Tokenomic
/*     -10M of Binancearmy
/*     -10% max transactions;1,000,000
/*     -Anti-Whale & Anti-Snipe code embedded contract
/*     -10% Buy/Sell Tax:
/*        {3% Reflections, 3% Dev & Marketing , 2% Liquidity}
...
contract FUCKELONDOGE is IERC20, Ownable {
    using SafeMath for uint256;

    address BNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FUCKELONDOGE";
    string constant _symbol = "FED";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 10; // 10% of total supply
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("0x9B596333a2C475171888d18544fD7BD239da3B26");
