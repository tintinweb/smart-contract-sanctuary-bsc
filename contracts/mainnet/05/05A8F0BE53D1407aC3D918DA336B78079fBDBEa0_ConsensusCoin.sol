...
contract ConsensusCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Consensus Coin";
    string private _symbol = "CC";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x5A4a5f65cd020b1578cad128e5596891B05eAF74); 
    ...
    uint256 private _totalSupply = 2 *  10**3 * 10**_decimals;
