...
contract MiniQuizDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Quiz Doge";
    string private _symbol = "MQDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE39f8Db892b0b9cB30ECF7D0658541652d313b80); 
    address payable public buyBackWalletAddress = payable(0xE39f8Db892b0b9cB30ECF7D0658541652d313b80); 
