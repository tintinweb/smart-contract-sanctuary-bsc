...
// File: @SMBswap/SMB-swap-lib/contracts/token/BEP20/IBEP20.sol
...
*/
contract SMBProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public SELFToken;
    ...
    uint256 public numberSELFToReactivate;
    uint256 public numberSELFToRegister;
    uint256 public numberSELFToUpdate;
    ...
    constructor(
        IBEP20 _SELFToken,
        uint256 _numberSELFToReactivate,
        uint256 _numberSELFToRegister,
        uint256 _numberSELFToUpdate
    ) public {
        SELFToken = _SELFToken;
        numberSELFToReactivate = _numberSELFToReactivate;
        numberSELFToRegister = _numberSELFToRegister;
        numberSELFToUpdate = _numberSELFToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends SELF to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        SELFToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSELFToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer SELF token to this address
        SELFToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberSELFToUpdate
    ...
    /**
     * @dev Claim SELF to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        SELFToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of SELF to register
     * Callable only by owner admins.
     */
    function updateNumberSELF(
        uint256 _newNumberSELFToReactivate,
        uint256 _newNumberSELFToRegister,
        uint256 _newNumberSELFToUpdate
    ) external onlyOwner {
        numberSELFToReactivate = _newNumberSELFToReactivate;
        numberSELFToRegister = _newNumberSELFToRegister;
        numberSELFToUpdate = _newNumberSELFToUpdate;
    }
