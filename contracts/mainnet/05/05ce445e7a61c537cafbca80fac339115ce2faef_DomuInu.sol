...
contract DomuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Domu Inu";
    string private constant _symbol = "Domu Inu";
    ...
    address private marketingWallet = address(0xE8B3e9A7540BaaDD33eE0466d7f9635fee72874A);
    ...
    function Bots() public onlyOwner {
