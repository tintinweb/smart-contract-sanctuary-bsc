...
contract FFC is Context, IERC20, Ownable {
    ...
    string private _name = "FireFlameChain";
    ...
    address public burnAddress = address(0xE093cF7BAAdeaCC14c6d5CB471d862D8A022614B);
    
    address public ownerAddres = address(0x49881E0E9e2033dF0727d50e1FB9B668d67fa81C);
    address public devAddress = address(0x26acF16c8124d9b6Ce3762724CC08A3bEa5cBE76);
    address public foundAddress = address(0xE9FE82e9F11AcD15B2C76e33171f4c309eBF31fD);
