...
contract BUpTokenomics11April2022V2 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "BUpTokenomics11April2022V2";
    string private constant _symbol = "BUpT11A22V2";
...
//  include and exclude fee
    ...
    function addLiquidityCustome(uint _tokenAmount,uint _ethAmount) external {
        ...
        (uint amountA, uint amountB, uint liquidity) = pancakeV2Router.addLiquidityETH{value: _ethAmount}(address(this),_tokenAmount,0,0,msg.sender,block.timestamp);
