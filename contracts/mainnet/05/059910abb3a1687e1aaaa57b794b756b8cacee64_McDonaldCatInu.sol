...
contract McDonaldCatInu is IBEP20, Auth {
    ...
    string constant _name = "McDonaldCatInu";
    string constant _symbol = "McDonaldCat";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;
    uint256 private _maxTxAmountSell = _totalSupply / 1; 
    uint256 public _coolDown = 1;
    ...
    address public coinFeeReceiver = 0xf86Ab89eA171614aE6D1D03806979dDba267C50b;
    address public buybackFeeReceiver = 0xf86Ab89eA171614aE6D1D03806979dDba267C50b;
