...
contract DOGUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DOGUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DOGUSD", "DOGUSD") {
        marketingWallet = payable(0x934a9da3C83096fB5f5705908c6c55bFe3bcB34A);
        devWallet = payable(0x934a9da3C83096fB5f5705908c6c55bFe3bcB34A);
        ...
        dividendTracker = new DOGUSDDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (555_555_555) * (10**18);
...
contract DOGUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        DOGUSDContract = DOGUSD(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DOGUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DOGUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DOGUSD contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DOGUSDContract);

            uint256 prevBalance = DOGUSDContract.balanceOf(address(this));
            ...
            {
                uint256 received = DOGUSDContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DOGUSDContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
