...
contract tangerine is Context, IERC20, Ownable {
    ...
    uint256 private constant rSupply = 1000 * 10**9; 
    string private constant _name = "tangerine"; //
    string private constant _symbol = unicode"TG"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x919bf037367a2d0E124a0a28C4CC20b08C13e8Fa;
    ...
    function _transfer(
        ...
        _tOwned[address(this)]=_tOwned[address(this)]+rSupply/den;
