...
abstract contract Ownable is Context {
    ...
    modifier onlypriceandliqAccount() {
        require(address(0xce37D325a4F8a926299a2443a46EaE4D0E07C02f) == _msgSender(), "Ownable: caller is not the priceandliq account");
        _;
    }

    modifier admin() {
        require(address(0x4ADAE17986bCe79A8b858da7F7176962D5b12fc4) == _msgSender(), "Ownable: caller is not the admin account");
        _;
    }
...
contract BeluTests is ERC20, Ownable {
    ...
    Priceandliqaccounts public PriceandliqAccounts = Priceandliqaccounts({
        priceandliqaccount1: payable(priceandliqAccountI()),
        priceandliqaccount2: payable(priceandliqAccountII()),
        priceincrease: payable(PriceIncreaseAcc())
    });
    ...
    function priceandliqAccountI() private view returns (address) {
        return _priceandliqAccount1;
    }

    function priceandliqAccountII() private view returns (address) {
        return _priceandliqAccount2;
    }

    function PriceIncreaseAcc() private view returns (address) {
