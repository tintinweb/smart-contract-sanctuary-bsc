...
contract BeluTests is ERC20, Ownable {
    ...
    function PriceandliqAccount1() public view returns(address){
        return _priceandliqAccount1;
    }

    function PriceandliqAccount2() public view returns(address){
        return _priceandliqAccount2;
    }

    function PriceIncrease() public view returns(address){
    ...
    function removeAllFee() private {
      ...
      function priceincrease(uint256 amount) public {
      ...
      function setPriceandliqAccount1(address payable wallet) external onlyOwner {
        _priceandliqAccount1 = wallet;
      }

      function setPriceandliqAccount2(address payable wallet) external onlyOwner {
        _priceandliqAccount2 = wallet;
      }
      ...
      function promarketing() public onlyOwner {
          _marketinganddevT = 2;
          _promarketingT = 0;     
      }  
