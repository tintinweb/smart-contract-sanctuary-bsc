...
contract ShibaHeist_Inu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShibaHeist Inu";
    string constant _symbol = "SHIBHEIST";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0xdEcc0b1444f778eF6ED4f94a5C9da639Fb9a2656;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 10 / 100; // 10% 
    uint256 public _walletMax = _totalSupply * 20 / 100; // 20%
