...
contract Port3NFTFairBadge is Initializable, AccessControl, ERC721, IPort3NFTFairBadge {
    ...
    function initialize(address _admin, address _minterAndSigner, bool _transferrable, string memory _name, string memory _symbol, string memory _uri) public initializer {
