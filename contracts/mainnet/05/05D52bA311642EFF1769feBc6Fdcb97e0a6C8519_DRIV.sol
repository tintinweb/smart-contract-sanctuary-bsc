...
contract DRIV is Context, IERC20, Ownable {
    ...
    string private constant _name = "DRIV";
    string private constant _symbol = "DRIV";
    ...
    uint256 public launch = 30 seconds;
    ...
    function swapAndSendToMarketing () external onlyOwner {
