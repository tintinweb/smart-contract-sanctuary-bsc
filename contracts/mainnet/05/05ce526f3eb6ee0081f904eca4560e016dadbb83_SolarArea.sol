...
contract SolarArea is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SolarArea";
    string private _symbol = "$SolarArea";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAf50a3B7B3125832205dBD78b29415E56f942FF8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xAf50a3B7B3125832205dBD78b29415E56f942FF8); // BuyBack Address
