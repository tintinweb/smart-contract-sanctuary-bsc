...
// 
//
// 📱 Telegram:https::https://t.me/+nahwBmeVxxo5YTg1
...
contract $SPACESNAKERAT is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SPACESNAKERAT ", "SPACESNAKERAT ") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SPACESNAKERAT ";
    string private _symbol = "SPACESNAKERAT ";
