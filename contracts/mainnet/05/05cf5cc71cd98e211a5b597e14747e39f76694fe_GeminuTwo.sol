...
pragma solidity ^0.6.12;
    ...
    contract GeminuTwo is Context, IERC20, Ownable {
        ...
        string private _name = 'GemInu 2.0';
        string private _symbol = 'GemInu 2.0';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x6B7995Ce4533c4DA32227F1Bf0a7f567809E68A1, 'We can not exclude Uniswap router.');
