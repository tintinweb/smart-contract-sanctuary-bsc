...
Website  : https://piggybozz.one/
Twitter  : twitter.com/piggyboz

PiggyBozz has a swap coming allowing users to swap $PGB for BNB or any other BEP20 Token , 
release date will be confirmed in our White Paper

It will be powered by PancakeSwap, the safest and most trusted DEX in the world. 
Furthermore, it acts as the foundation upon which many of PGB’s ongoing community development 
efforts will build additional features and functionality exclusive to PGB holders
...
contract PiggyBozz is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x49F3D086835a72602C8aF002AFe653b5C2bfb202); 
    address payable public Wallet_Dev = payable(0x49F3D086835a72602C8aF002AFe653b5C2bfb202);
    ...
    string private constant _symbol = unicode"$PGB"; 
    ...
    constructor () {
        ...
        _owner = 0x49F3D086835a72602C8aF002AFe653b5C2bfb202;
