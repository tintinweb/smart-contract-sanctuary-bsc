...
contract ShammrockFINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShamrockFINANCE";
    string private _symbol = "SROCKFINANCE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14F7e793eD0E8dBEfC6A0349c61F36cdCAdc2105);
    address payable public teamWalletAddress = payable(0x14F7e793eD0E8dBEfC6A0349c61F36cdCAdc2105);
