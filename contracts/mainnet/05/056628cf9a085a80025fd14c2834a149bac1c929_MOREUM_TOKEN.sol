...
// MOREUM TOKEN! 4% Tax w/ 2% ETH Rewards!  Join the Telegram - https://t.me/MoreumTokenBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);  // ETHEREUM
    PCSRouter router;
...
contract MOREUM_TOKEN is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Moreum Token";
    string constant public symbol = "MORE";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 35 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7D5E61C62DF2B0aBBf0e209f789A2F1182Ca1093;
        devFeeReceiver = 0x7D5E61C62DF2B0aBBf0e209f789A2F1182Ca1093;
    ...
    function tradingStatus_launchmode(uint256 confirm) external onlyOwner {
        require(confirm == 611711811,"Accidental Press");
