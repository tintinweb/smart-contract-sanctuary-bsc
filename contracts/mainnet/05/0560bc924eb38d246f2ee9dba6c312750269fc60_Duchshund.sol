...
contract Duchshund is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Duchshund";
    string private _symbol = "DSCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x696C8b4677c7f69df32d3349C4363b2779CAE95e);
    address payable public teamWalletAddress = payable(0x696C8b4677c7f69df32d3349C4363b2779CAE95e);
