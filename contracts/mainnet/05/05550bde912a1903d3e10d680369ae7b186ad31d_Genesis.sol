...
contract Genesis is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf2378884dcb694cfD22910FF26278a7910ED12D6); 
    address payable public Wallet_Dev = payable(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 21000000;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Percent_Burn / 500;
            ...
            uint256 tokens_to_M = contractTokenBalance * Percent_Marketing / 10;
            uint256 tokens_to_D = contractTokenBalance * Percent_Dev / 430;
            uint256 tokens_to_LP_Half = contractTokenBalance * Percent_AutoLP / 10;
            ...
            uint256 split_M = Percent_Marketing * 10 / (Percent_AutoLP + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 10;

            uint256 split_D = Percent_Dev * 10 / (Percent_AutoLP + Percent_Marketing + Percent_Dev);
            uint256 BNB_D = BNB_Total * split_D / 10;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 removeRandom = totalRandom*percent_of_Tokens/10;
