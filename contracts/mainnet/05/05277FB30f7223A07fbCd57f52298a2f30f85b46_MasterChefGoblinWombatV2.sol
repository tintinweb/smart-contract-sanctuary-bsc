...
contract MasterChefGoblinWombatV2 is Initializable, ReentrancyGuardUpgradeSafe, OwnableUpgradeable, Goblin {
    ...
    function swapSecondReward() internal {
        IERC20 secondRewardToken = IERC20(0x3BC5AC0dFdC871B365d159f728dd1B9A0B5481E8);
        if (secondRewardToken.balanceOf(address(this)) > 0) {
            ...
            secondRewardToken.approve(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7, uint256(-1));
            IUniswapV2Router02(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7).swapExactTokensForETH(secondRewardToken.balanceOf(address(this)), 0, rewardPath, address(this), now);
