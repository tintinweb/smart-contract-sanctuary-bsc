...
contract CAP_COIN is Context, IERC20 { 
    ...
    address payable private constant feeCollector = payable(0x5657b46cb72E1f0f0c12c59678ddf0d84f3b2e1A);
    ...
    */
    ...
    // Remember the Decimals - $0.10 EMI is 1 and 18 zeroes
