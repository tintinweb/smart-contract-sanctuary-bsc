...
contract ninju is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0xdaCC0bd85E84d9aE907405fcbCbDd7B4D8cC17f7;
    address public devAddress = 0xdaCC0bd85E84d9aE907405fcbCbDd7B4D8cC17f7;
    address public liquidityAddress = 0xd9A370de9fD7830d7942a8E17A4623F985895a95;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 4;
    uint public sellMarketingFee = 4;
    uint public buyDevFee = 4;
    uint public sellDevFee = 4;
...
// constructor
    constructor() ERC20("ninja shiba", "NINJU") {
