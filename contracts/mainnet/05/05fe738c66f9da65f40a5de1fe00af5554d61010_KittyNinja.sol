...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD);
...
/* Token contract */
contract KittyNinja is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4795e427C72579775486Bbe80C144519D56C6eA8;
    ...
    // Name and symbol
    string constant _name = "KittyNinja";
    string constant _symbol = "$KINJA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100000000 / 100000000; // 100% 
    uint256 public _maxSellTxAmount = _totalSupply * 100000000 / 100000000; // 100% 
    uint256 public _maxWalletToken = ( _totalSupply * 100000000 ) / 100000000; // 100% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4795e427C72579775486Bbe80C144519D56C6eA8;
