...
/**
 *MARSCAKE 2022 - WWW.MARSCAKE.INFO
*/
...
contract Marscake is Context, IERC20, Ownable {
  ...
  string private _name = 'MarsCake';
  string private _symbol = 'MARSCAKE';
 ...
 uint256 public reflectFeeSell = 4;
  ...
  address private _marketingWalletAddress = 0xAa5631424306133bAe86E460425af239FD0834b4; //Affixed and created dynamically by the smart contract on construction time.
  address public _buybackWallet = 0x85B85058D1D48172A6F5D1aFfC314abc77938A3f;
  ...
  constructor() {
      address _newOwner = 0x85B85058D1D48172A6F5D1aFfC314abc77938A3f;
