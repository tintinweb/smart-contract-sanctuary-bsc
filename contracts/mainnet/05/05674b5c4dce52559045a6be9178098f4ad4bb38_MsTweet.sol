...
contract MsTweet is Context, IERC20 { 
    ...
    address[] w_L = [payable(0xedE0381630C019F1811b8e7C46206d364AD78B8b)];

    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0x09B155456D5a3C9C7509922C439C298d3153dc5a); 
    address payable public Wallet_Dev = payable(0x376b12C8Ed89DE33785266B746564d7062DdB5B4);
    ...
    constructor () {
        ...
        _owner = 0x376b12C8Ed89DE33785266B746564d7062DdB5B4;
