...
contract  BXZS is IBEP20 , Auth { 
    using SafeMath for uint256;
    string internal _name;
    string internal _symbol;
    uint8   internal _decimals;
    uint256 internal _totalSupply;
    string public tokenType="KG";
    ...
    constructor(  
        ...
        marketingAddress = [0x72D9E436562fd0CA4fb35eF38ee447a9acc58001,0x819c1C534F26372Eb7529Cba8EBf6B40d2695399];
        marketingShare=[60,60];  

        fees=Fee(500,800,0,10000);
        allot=Allot(120,10,0,130); 
