...
contract CoinFlip is Ownable {
    ...
    uint256 public amountToSendAt = 1000000000000000000000;
    uint256 public feesCollected;
    uint256 public quickBetAmount = 100000000000000000000;
    ...
    function maxBetAllowed() public view returns (uint256){
        return IERC20(gameToken).balanceOf(address(this)) / 4;
    }
