...
pragma solidity ^0.6.12;
    ...
    contract BitDATAProCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'BitDATA Pro Coin';
        string private _symbol = 'BPC';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x2dB1A65fA26d07f18cf54448EB8556C3630Da9B1, 'We can not exclude Uniswap router.');
