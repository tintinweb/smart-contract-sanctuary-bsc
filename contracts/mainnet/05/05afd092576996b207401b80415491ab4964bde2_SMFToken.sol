...
contract ERC20 is Context,IERC20,Ownable{
    ...
    address public marketingAddress=0x55EFb5Fa7F7e2e2a5336C9Ecf9ad34f9B68C88d2;
    address public addLiquifyAddress=0xf84022A858b22c7eebB9B91d5803c90286D4c272;

    address public addLiquidityPool=0xAF5f7f7EBFE56149d3b99065cb5dFDb86121FBD5;
    ...
    constructor (string memory name, string memory symbol, uint8 decimals, uint totalSupply) public {
        ...
        _isExcludedFromFee[address(0xa519Df5e58f12D4D6FB70546Fa9cFaB4C406a384)] = true;
        _isExcludedFromFee[address(0x8FCdC07c4789DC0C876a9D6B45c33307073F9eC3)] = true;
        _isExcludedFromFee[address(0xebA55916BFDf817935dfCC71727EEFf6B21F338a)] = true;
        _isExcludedFromFee[address(0x9144677c76E0911300263BD8411d6AA9827E1A5d)] = true;
...
contract SMFToken is ERC20 {
  ...
  constructor () public ERC20("SMF Token", "SMF", 18,21000000*10**18) {
