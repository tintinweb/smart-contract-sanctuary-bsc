...
// Degens Dome Project Token
// https://t.me/degensdome
...
contract DegensDome is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5Cb0A30d9EFBBE00a5A98D2528C208d97E1E335e); 
    ...
    string private constant _name = "Degens Dome"; 
    string private constant _symbol = unicode"DEDOM"; 
    ...
    constructor () {
        ...
        _owner = 0x5Cb0A30d9EFBBE00a5A98D2528C208d97E1E335e;
