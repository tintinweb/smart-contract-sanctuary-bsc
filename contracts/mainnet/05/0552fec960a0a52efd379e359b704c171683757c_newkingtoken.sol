...
contract newkingtoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "NewKing";
    string private _symbol = "NewKing";
    ...
    function changePercentSetting(uint256 maxTXPercentage) external onlyOwner {
