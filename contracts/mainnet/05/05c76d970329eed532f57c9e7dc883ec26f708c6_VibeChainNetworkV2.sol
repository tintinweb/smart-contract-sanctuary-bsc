...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract VibeChainNetworkV2 is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**7 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Vibe Chain Network V2";
    string private _symbol = "VCNv2";
    uint8 private _decimals = 7;
    
    uint256 public _taxFee = 0; // 0% reflections
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 1; // 1% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 0;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _devFee = 1;  // 1% to liquidity
    address public devWallet = 0xFe56eC0fFBD2F5A302952dee92784e4CF7C1b268; // development wallet
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**7; 
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**7 * 10**7;
    uint256 public _maxWalletToken = 300 * 10**7 * 10**7; 
