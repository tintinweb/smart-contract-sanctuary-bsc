...
library Address{
 ...
 contract BabyGizmoInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0AC4ec354FCD2441eC164a900A6DC64AECeBE689;
    address public donationWallet = 0x0AC4ec354FCD2441eC164a900A6DC64AECeBE689;

    string private constant _name = "BabyGizmoInu";
    string private constant _symbol = "BabyGizmoInu";
    ...
    Taxes public taxes = Taxes(0,10, 2, 1);
    Taxes public sellTaxes = Taxes(0, 10, 2, 1);
