...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE3dBAa676786Eb989D6254856ADC02BaeEdA69e7; // owner address
...
contract XRPMine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XRPMine ";
    string private _symbol = "XRPMine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3dBAa676786Eb989D6254856ADC02BaeEdA69e7); // 
    address payable public teamWalletAddress = payable(0xE3dBAa676786Eb989D6254856ADC02BaeEdA69e7); // 
