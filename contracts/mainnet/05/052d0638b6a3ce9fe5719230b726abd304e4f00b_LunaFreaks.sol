...
contract _LUNADividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Luna_Tracker", "Luna_Tracker",_dividentToken) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 1_000 * (10**9);
    }
...
//address
    ...
    address public marketingWallet = 0x163C8930931982884228Ac60321a3e2de233a080;
    address public lunaBurnWallet = 0x08E90F5ddbbcb2C96DA42954095B22a503368B4b;
    address public liqWallet = 0x266eeef80306F264f3D5942fE4Ae57c787C72edb; 
 ...
 //uint
    ...
    uint256 public minimumTokensBeforeSwap = 1_000 *10**decimals();
...
//struct
 ...
 //event
    ...
    constructor() ERC20("Luna Freaks", "LUNDF") {
        uint256 _total_supply = 100_000 * (10**9);
    ...
    function swapTokens(uint256 minTknBfSwap) private {
        ...
        if(ProcessDividendStatus){
            if(balancez > 1000) {// 0,00000001 BNB
