...
contract TheKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "The King";
    string private _symbol = "The King";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x75786fe50B68f65E0AD7F8a7BF8414c0a7C77555));
        ruinWalletAddress = payable(address(0x265D2d15D486Dc93cd07fc07627f644BF69E0100));
