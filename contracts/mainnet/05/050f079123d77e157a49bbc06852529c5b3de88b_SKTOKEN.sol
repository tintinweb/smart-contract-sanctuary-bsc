...
contract SKTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SKTOKEN contract."
        );
    }
...
contract SKTOKEN is ERC20, Ownable {
    ...
    SKTOKENDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = SKTOKENDividendTracker(
