...
contract DO is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xD32CFF06dbAB934D44ae4EeA1B8CFf0103453492;
    mapping (address => bool) private _isExcludedFromFees;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("DO", "DO") {
    ...
    function setMarkfees(uint256 value) external onlyOwner{
        markfee = value;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
        	uint256 lpfees = amount.mul(markfee).div(100);
