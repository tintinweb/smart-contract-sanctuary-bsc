...
contract T1 is Context, IERC20, Ownable {
    ...
    address payable private _appAddress = payable(0x362e2bC7d662E4Ae1180c467d2B11fD0C0B08a12);
    address payable private _marketingAddress = payable(0x2408d52d4b68Bf21FE90d4325B2AcE3D6Be9F5bd);
    address payable private _buybackAddress = payable(0x359fbc7FB5ed94F2EC4987F893428eE56148F772);
    address payable private _burnAddress = payable(0xb742Cc7580C94bb9DFEF8e325C2c08Df6d6982e0);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 devAmount = amount.mul(0).div(4);
        uint256 mktAmount = amount.mul(2).div(4);
        uint256 buybackAmount = amount.mul(2).div(4);
