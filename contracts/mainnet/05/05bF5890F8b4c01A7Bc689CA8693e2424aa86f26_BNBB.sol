...
contract BNBB is ERC20 {
	...
	address public _fundAddress = address(0x16d5bA0Eb03FBa295f21e2bc1142A7Fd7dE42eE7);
	address public _luckAddress = address(0x576405bd91Ac8B7AB93D824ee2C1Eb5E24b97341);
    ...
    constructor(address tokenOwner) ERC20("BNBB", "BNBB") {
	...
	uint256 public fundRate = 80;
    function changeRate(uint256 _ldxRate,uint256 _fundRate) public onlyOwner {
        ldxRate = _ldxRate;
		fundRate = _fundRate;
    }
	
	uint256 public oneTimeAmount = 2 * 10**22;
	uint256 public maxAmount = 2 * 10**22;
	...
	function changeSwapWarp(BNBWarp _warp) public onlyOwner {
        warp = _warp;
