...
contract FlokiCORN is Ownable, IERC20 {
    ...
    string constant private _name = "Floki Corn";
    string constant private _symbol = "FLOCORN";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x3633D0A5409c1A3C29478f37dcDDB58aaFd0389C;
        refundWallet = 0x3633D0A5409c1A3C29478f37dcDDB58aaFd0389C;
