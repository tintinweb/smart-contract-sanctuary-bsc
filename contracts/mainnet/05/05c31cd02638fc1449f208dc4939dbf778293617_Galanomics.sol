...
contract Galanomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Galanomics";
    string private _symbol = "Galanomics";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xCC242A9a5167Bf7266E8B472B861b5Bf87Ed1541); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCC242A9a5167Bf7266E8B472B861b5Bf87Ed1541); // BuyBack Address
