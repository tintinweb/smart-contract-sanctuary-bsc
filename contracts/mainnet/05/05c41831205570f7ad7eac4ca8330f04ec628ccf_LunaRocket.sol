...
contract LunaRocket is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LunaRocket";
    string private _symbol = "LR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xad263Cf8c3B5407efaD426CC9887c6e213203028); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xad263Cf8c3B5407efaD426CC9887c6e213203028); // BuyBack Address
