...
/*
 GermanyInu Token
Germany_CZ
https://poocoin.app/tokens/0xd29ac08263e43d5de9de36755d8a679483bf1208
*/
...
contract GermanyInu is GermanyInuDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GermanyInuTeam;
    address private CharityGermanyInu;
    ...
    string public override name = "Germany Inu ";
    string public override symbol = "Germany Inu";
    ...
    constructor(uint totalSupplyValue, address GermanyInuTeamAddress, address CharityGermanyInuAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GermanyInuTeam = GermanyInuTeamAddress;
        CharityGermanyInu = CharityGermanyInuAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GermanyInuTeam] =  totalSupply * 4 / 100;
        balances[CharityGermanyInu] = totalSupply * 45 / 100;
