...
contract ARATE is Context, IERC20, Ownable {
    ...
    string private _name = "Arabian Tate";
    string private _symbol = "ARATE";
    ...
    constructor () {
        ...
        _isCommunity[address(0x53FE859a8c7c674855eFcb6Cf0e0EDFA2641a2A4)] = true;
        _isCommunity[address(0xF1A59d47F0A3ba79cF088fa327141971521B2F86)] = true;
    ...
    //set Only ARATE Community Members 
    function setOnlyARATECommunity(bool _enabled) public onlyOwner {
    ...
    //adding people to the  Community approved list - these people are the only ones that will be able to buy at launch! 
