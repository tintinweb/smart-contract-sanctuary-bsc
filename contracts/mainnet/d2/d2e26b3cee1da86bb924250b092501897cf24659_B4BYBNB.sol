...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5bb0E7C74dC13eE671b4883Ec637C8A085930132; 
...
contract B4BYBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "B4BY BNB";
    string private _symbol = "B4BYBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5bb0E7C74dC13eE671b4883Ec637C8A085930132); 
    address payable public teamWalletAddress = payable(0x13577B5653D6b0D1916027702da107B5dC0d2080); 
