...
contract SpaceX is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xb4825F562188288bd1bca21870b652dd43F9B3EC); // Marketing Address
    address payable private teamWalletAddress = payable(0xb4825F562188288bd1bca21870b652dd43F9B3EC); // Team Address
    address payable private blackAddress = payable(0xb4825F562188288bd1bca21870b652dd43F9B3EC); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 999999 * 8 **_decimals; 
