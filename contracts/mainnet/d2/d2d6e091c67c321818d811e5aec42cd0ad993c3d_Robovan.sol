...
contract Robovan is Context, IERC20, Ownable {
   
    using SafeMath for uint256;
    using Address for address;
   
    string private _name = "Robovan";
    string private _symbol = "RBV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeBB5e8Bb6eE39C73ccf3e8bf7E5Fca385000eb99); // Marketing Address
    address payable public teamWalletAddress = payable(0xeBB5e8Bb6eE39C73ccf3e8bf7E5Fca385000eb99); // Team Address
    ...
    uint256 public _maxTxAmount =  1000 *  10**5 * 10**_decimals;
    uint256 public _walletMax =  1000 *  10**5 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap =  1000 *  10**1 * 10**_decimals;
