...
*TELEGRAM: https://t.me/squidwardofficials
*/
...
contract SQUIDWARD is Context, IERC20, Ownable {
    ...
    string private _name = " SQUID WARD "; 
    string private _symbol = " SQUIDWARD "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFe23824e431B2C37ad5E0cef8c8A65e6a8434bd6); 
    address payable public teamWalletAddress = payable(0xFe23824e431B2C37ad5E0cef8c8A65e6a8434bd6); 
    ...
    uint256 private minimumTokensBeforeSwap = 3123443 * 10**_decimals;
