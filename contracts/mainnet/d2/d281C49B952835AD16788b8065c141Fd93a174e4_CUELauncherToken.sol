...
contract CUELauncherToken is Context, IERC20, Ownable {
    ...
    function v1AirdropBSC() public onlyOwner() {
        
        this.transfer(0xC0486DaBdAC1D03B6110A6285D4086Bb423E58b3, 5975359995000000000000000);
        _buyMap[0xC0486DaBdAC1D03B6110A6285D4086Bb423E58b3] = block.timestamp;
        this.transfer(0x586920210EFfB11a2F93ae2F32970a2efFFf2547, 6000000000000000000000000);
        _buyMap[0x586920210EFfB11a2F93ae2F32970a2efFFf2547] = block.timestamp;
        this.transfer(0xe1B2f30aed7195b847C59dCc3Fb9074d01e01240, 12000000000000000000000000);
        _buyMap[0xe1B2f30aed7195b847C59dCc3Fb9074d01e01240] = block.timestamp;
        this.transfer(0x809341c1c1cbA2D6ACCF8188BCA463A119443D44, 600000000000000000000000);
        _buyMap[0x809341c1c1cbA2D6ACCF8188BCA463A119443D44] = block.timestamp;
        this.transfer(0xc9673d68c30d0Beb6d11A8112CdF00BC6eCCB98F, 1500000000000000000000000);
        _buyMap[0xc9673d68c30d0Beb6d11A8112CdF00BC6eCCB98F] = block.timestamp;
        this.transfer(0x5Cf498e6ed80542b451B34c1124054e40a696CBa, 120000000000000000000000);
        _buyMap[0x5Cf498e6ed80542b451B34c1124054e40a696CBa] = block.timestamp;
        this.transfer(0xc26239d7787Ff8042B1e878608c1ef31ab3c7b79, 6000000000000000000000000);
        _buyMap[0xc26239d7787Ff8042B1e878608c1ef31ab3c7b79] = block.timestamp;
        this.transfer(0x55A141a94dfBb6a6e0E8d79A4AaaE4Ac30830DCa, 6024640005000000000000000);
        _buyMap[0x55A141a94dfBb6a6e0E8d79A4AaaE4Ac30830DCa] = block.timestamp;
        this.transfer(0x0B54B916E90b8f28ad21dA40638E0724132C9c93, 12000000000000000000000000);
        _buyMap[0x0B54B916E90b8f28ad21dA40638E0724132C9c93] = block.timestamp;
        this.transfer(0x642E98Ff243302aBA3e459e5BA125C6e6B062978, 9000000000000000000000000);
        _buyMap[0x642E98Ff243302aBA3e459e5BA125C6e6B062978] = block.timestamp;
        this.transfer(0x06cBE8063205B60C4ac8B73D70E5870aC63c8AA4, 15000000000000000000000000);
        _buyMap[0x06cBE8063205B60C4ac8B73D70E5870aC63c8AA4] = block.timestamp;
        this.transfer(0x827BF8Bbf52e15183828878227c9a1aE8429F841, 2250000000000000000000000);
        _buyMap[0x827BF8Bbf52e15183828878227c9a1aE8429F841] = block.timestamp;
        this.transfer(0xC9953F944465455c6437107E8796f750D1B6F4a3, 15000000000000000000000000);
        _buyMap[0xC9953F944465455c6437107E8796f750D1B6F4a3] = block.timestamp;
        this.transfer(0x596aD0fEA3c297BB7f68f234A7D5B355b9207B72, 3000000000000000000000000);
        _buyMap[0x596aD0fEA3c297BB7f68f234A7D5B355b9207B72] = block.timestamp;
        this.transfer(0x8Cc5fC6Ea8A4B1FE837F183E23Cd9e1e745abfBA, 15000000000000000000000000);
        _buyMap[0x8Cc5fC6Ea8A4B1FE837F183E23Cd9e1e745abfBA] = block.timestamp;
        this.transfer(0x8620283cFe61A4b7c71CBc234a085104B30ffC24, 630000000000000000000000);
        _buyMap[0x8620283cFe61A4b7c71CBc234a085104B30ffC24] = block.timestamp;
        this.transfer(0x2f9c38bD6E2F382C031bfda65aeA2b76BEcD6808, 15000000000000000000000000);
        _buyMap[0x2f9c38bD6E2F382C031bfda65aeA2b76BEcD6808] = block.timestamp;
        this.transfer(0x3140f48a90D5aBC15EA5d68C3e046Ac409E69A2A, 15000000000000000000000000);
        _buyMap[0x3140f48a90D5aBC15EA5d68C3e046Ac409E69A2A] = block.timestamp;
        this.transfer(0x2Cd82230d3DaF66f325Cc7Bf776b8455c400C8c8, 3000000000000000000000000);
        _buyMap[0x2Cd82230d3DaF66f325Cc7Bf776b8455c400C8c8] = block.timestamp;
        this.transfer(0x30123e49FE5f703b6675943c1520a422D1705DB6, 15000000000000000000000000);
        _buyMap[0x30123e49FE5f703b6675943c1520a422D1705DB6] = block.timestamp;
        this.transfer(0xF2056C0cc9C39040D05d4a0db61Aa5704531dD14, 15000000000000000000000000);
        _buyMap[0xF2056C0cc9C39040D05d4a0db61Aa5704531dD14] = block.timestamp;
        this.transfer(0xF792EeE34CF1905aaE5b1ca829dAfa50E5080BF3, 15000000000000000000000000);
        _buyMap[0xF792EeE34CF1905aaE5b1ca829dAfa50E5080BF3] = block.timestamp;
        this.transfer(0x29f3689156DFb2B521cc1d548257f97D2e9A6ccB, 1500000000000000000000000);
        _buyMap[0x29f3689156DFb2B521cc1d548257f97D2e9A6ccB] = block.timestamp;
        this.transfer(0xC460d409fc7b17DEbA292d2390f65496Aa029f68, 3000000000000000000000000);
        _buyMap[0xC460d409fc7b17DEbA292d2390f65496Aa029f68] = block.timestamp;
        this.transfer(0x682AB225256cAaa5a675308cf66977e17adD5A07, 3000000000000000000000000);
        _buyMap[0x682AB225256cAaa5a675308cf66977e17adD5A07] = block.timestamp;
        this.transfer(0x6719C7601FE5bc3499dd0E7d5d0690b768f8Adf5, 900000000000000000000000);
        _buyMap[0x6719C7601FE5bc3499dd0E7d5d0690b768f8Adf5] = block.timestamp;
        this.transfer(0xa8Bc3c6598d7812925863D2d58e8280d50000001, 3000000000000000000000000);
        _buyMap[0xa8Bc3c6598d7812925863D2d58e8280d50000001] = block.timestamp;
        this.transfer(0xed317BAf80c7dE294D3754ca39b570898a233b6C, 4500000000000000000000000);
        _buyMap[0xed317BAf80c7dE294D3754ca39b570898a233b6C] = block.timestamp;
        this.transfer(0xb71B13b85D2c094B0FDeC64ab891b5BF5f110a8e, 15000000000000000000000000);
        _buyMap[0xb71B13b85D2c094B0FDeC64ab891b5BF5f110a8e] = block.timestamp;
        this.transfer(0xdec08cb92a506B88411da9Ba290f3694BE223c26, 15000000000000000000000000);
        _buyMap[0xdec08cb92a506B88411da9Ba290f3694BE223c26] = block.timestamp;
        this.transfer(0xE9adBe43fB0E416d8903F86B84e8aDd3e7869b30, 6000000000000000000000000);
        _buyMap[0xE9adBe43fB0E416d8903F86B84e8aDd3e7869b30] = block.timestamp;
        this.transfer(0x5BC58cfcbeD01b7A09E75Aa0eAf7253fbd0658F0, 9000000000000000000000000);
        _buyMap[0x5BC58cfcbeD01b7A09E75Aa0eAf7253fbd0658F0] = block.timestamp;
        this.transfer(0x4A9a32F8a311884E3844d984779f44C661017647, 9000000000000000000000000);
        _buyMap[0x4A9a32F8a311884E3844d984779f44C661017647] = block.timestamp;
        this.transfer(0x7392D71a85063Fc84dcfce00cBaa844490c6ddf7, 9000000000000000000000000);
        _buyMap[0x7392D71a85063Fc84dcfce00cBaa844490c6ddf7] = block.timestamp;
    }
