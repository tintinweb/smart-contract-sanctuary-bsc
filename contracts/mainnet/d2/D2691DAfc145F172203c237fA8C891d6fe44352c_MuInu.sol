...
contract MuInu is IERC20 {
    ...
    string constant private _name = "MU Inu";
    string constant private _symbol = "MUINU";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xE48B2527D5045A4fD010DDB3231E55bD310b6AEb),
        charity: payable(0x6a7a0092e1e7960E13024c1f99D275b3cC48DD85)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 marketing, uint16 charity) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.totalSwap = marketing + charity;
