...
contract DKH is IERC20, Ownable {
    ...
    address public _fundAddress = address(0x4AD70dab44072e08e2013d17A3A5c1a37Cbdf172);
    address private _inviterAddress = address(0x644a2061d1F404Ee6DcE388D1Fbd8bad7Cb1f8E2);
    ...
    constructor(address tokenOwner) {
        ...
        _decimals = 18;
        _tTotal = 18888 * 10**18;
        uint256 leaveAmount = 1888 * 10**18;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || _destroyAmount > _destroyMaxAmount){
            ...
            if(from == uniswapV2Pair){
                ...
                require(balanceOf(to).add(amount) <= 10**19);
                _tokenTransferBuy(from, to, amount, true);
            }else if(to == uniswapV2Pair){
                require(balanceOf(from).sub(amount) > balanceOf(from).div(1000));
