...
contract JellyBeanCash is BEP20('JellyBeanCash', 'JellyBean') {
...
// MasterChef is the master of JellyBeanCash. He can make JellyBeanCash and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once JellyBeanCash is sufficiently
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of JellyBeanCash
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. JellyBeanCash to distribute per block.
        uint256 lastRewardBlock;  // Last block number that JellyBeanCash distribution occurs.
        uint256 accMilkPerShare;   // Accumulated JellyBeanCash per share, times 1e12. See below.
        uint16 depositFeeBP;      // Deposit fee in basis points
        uint256 lpSupply;
    }

    // The JellyBeanCash TOKEN!
    JellyBeanCash public milk;
    // Dev address.
    address public devaddr;
    // JellyBeanCash  created per block.
    ...
    // Update the given pool's JellyBeanCash allocation point and deposit fee. Can only be called by the owner.
    ...
    function updatePool(uint256 _pid) public {
        ...
        /*
        Example to calculate JellyBeanCash Reward

        With 1 JellyBeanCash per block
        ...
        1 * 3(multiplier) * 2500 = (7500) / 10000(totalAllocPoint) = 0.75 JellyBeanCash tokens to be minted
        */
        uint256 milkReward = multiplier.mul(MilkPerBlock).mul(pool.allocPoint).div(totalAllocPoint); 
    ...
    // Deposit LP tokens to MasterChef for JellyBeanCash allocation.
    ...
    // Safe JellyBeanCash transfer function, just in case if rounding error causes pool to not have enough JellyBeanCash.
