...
contract DogeNakamoto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeNakamoto";
    string private _symbol = "DOGEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B5d7917c84f4968E17Aa31E2361354a734E66C5);
