...
/**
 ...
 ______   _______ _________ _______  _______   _________ _                
...
library Address{
 ...
 contract BATGEINU is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 1000_000_000_000;
    ...
    address public marketingWallet = 0xaf8091611f5bFe0494C6AEED0bd1E575582a4FA4;
    address public teamWallet = 0xaf8091611f5bFe0494C6AEED0bd1E575582a4FA4;

    string private constant _name = "Batge Inu ";
    ...
    Taxes public taxes = Taxes(1, 2, 2, 2);
    Taxes public sellTaxes = Taxes(1, 2, 2, 2);
