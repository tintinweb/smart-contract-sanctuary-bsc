...
contract CSAToken is ERC20, Ownable {
    ...
    csaInviter public Inviter = csaInviter(0xD4ffCE0fA95182bc6919Be10FaC59e70Cf82C589);
    exchequerLike public vault = exchequerLike(0xA6487Ca369BE9328CDDaCD6acEe517a9D1a5F472);
    ...
    address public doante = 0x7A768C85efeB016Fb379516e0F474C08B2FF533F;
    ...
    function _transfer(address from,address to,uint256 amount) internal override {
        ...
        if (Inviter.inviter(to) == address(0) && Inviter.count(to) == 0) try Inviter.setLevel(to,from) {} catch {}
