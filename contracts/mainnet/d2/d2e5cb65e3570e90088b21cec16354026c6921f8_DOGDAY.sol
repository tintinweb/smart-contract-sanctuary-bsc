...
/**
DOGDAY  was created in order to celebrate INTERNATIONAL DOG DAY which is takes place on 26 August every year
Lp is locked for 7Day to start...Tax  10/10 
TG https://t.me/dogdaybsc
Twitter https://twitter.com/Dogdaybsc
...
contract DOGDAY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DOG DAY";
    string constant _symbol = "$DOGDAY";
