...
/*
Change does not occur without backlash--at least any change worth having--and that backlash is an indicator 
that the change is so powerful that the opposing forces resist that change with everything they have. 
CODE 200013 total supply. Founded 2013
https://ascii.co.uk/art/fist
*/
...
contract BLM is ERC20, Ownable {
    ...
    uint256 public commDAOFee = 1;
    uint256 private totalFees = liquidityFee.add(marketingFee).add(operationsFee).add(commDAOFee);

    address payable public marketingWallet = payable(0x388da4d86eE9D64C244e8050Cd323435720a84A4);
    address payable public operationsWallet = payable(0xEe4Dd69979406a3035204752868CB47F4A2C3FD9);
    address payable public commDAOWallet = payable(0x0C75d840Ef181c385343b079C2c6b9610c632233);
    ...
    constructor() ERC20("Black Lives Matter", "$BLM") {
        ...
        excludeFromFees(commDAOWallet, true);
        ...
        */
        _createSupply(owner(), 2000000013 * (10**18));
    }
    ...
    function _transfer(
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        operationsWallet.transfer(address(this).balance.mul(operationsFee).div(totalFees.sub(liquidityFee)));
        commDAOWallet.transfer(address(this).balance);
