...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeD9358573cbF5b3f4a432EAC9400FA9028ccbad6;
...
contract ApesUnited is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x099CA089d1305A76cA4852997C8DC93bD139d23c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000001 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ApesUnited";
    string private _symbol = "DGENS";
