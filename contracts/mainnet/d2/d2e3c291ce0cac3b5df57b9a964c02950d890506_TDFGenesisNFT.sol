...
// TDFGenesisNFT.sol
contract TDFGenesisNFT is ERC721Consecutive {
    address private _creator;
    uint256 private _supply;

    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        _creator = _msgSender();
        _mintConsecutive(0x8601e92e12619C02F5aC3Af0AafE9043D7C2D551, 1009);
        _burn(0);
        _supply = 1008;
    }
    ...
    function bulkTransferConsecutiveFrom(address from, address to, uint256 startingId, uint256 quantity ) public {
        for (uint256 i ; i < quantity;) {
            _transfer(from, to, startingId + i);
            unchecked { i++; }
        }
    }

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft.tradefighter.io/genesis/";
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://nft.tradefighter.io/genesis/collection.json";
    }
