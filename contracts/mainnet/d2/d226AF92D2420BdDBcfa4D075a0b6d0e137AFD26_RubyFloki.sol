...
library Address{
 ...
 contract RubyFloki is Context, IERC20, Ownable {
    ...
    modifier antiBot(address account){
        require(KillBots || allowedTransfer[account], "Trading not enabled yet");
        _;
    }
    ...
    uint256 public swapTokensAtAmount = 696_969_696 * 10**9;
    ...
    address public marketingWallet = 0x8200191A15865dB4586295098d7E3EDDb768CC76;
    address public donationWallet = 0x8200191A15865dB4586295098d7E3EDDb768CC76;
    ...
    Taxes public taxes = Taxes(0, 6, 1, 2);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            require(KillBots, "Trading not active");
        }
