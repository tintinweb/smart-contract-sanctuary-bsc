...
// 
//
// 📱 Telegram:https::https://t.me/TsukaApe
...
contract $TsukaApe is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka Ape", "TsukaAPE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TsukaAPE";
    string private _symbol = "TsukaAPE";
