...
/**
 *Bringing the Treats Back to Halloween with Halloweenie. BUSD rewards 
*/
...
/* Token contract */
contract Halloweenie is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Halloweenie";
    string constant _symbol = "Weenie";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 20 / 10000; // 2% on launch or 200k tokens
    uint256 public _maxSellTxAmount = _totalSupply * 5 / 10000; // .5% or 50k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 20 ) / 10000; // 2% or 200k tokens
