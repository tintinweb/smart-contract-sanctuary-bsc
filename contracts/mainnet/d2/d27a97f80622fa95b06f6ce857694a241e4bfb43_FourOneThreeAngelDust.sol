...
/* Token contract */
contract FourOneThreeAngelDust is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x837E66de0b976CB111a2f1196dEC4eB73030000C;
    ...
    // Name and symbol
    string constant _name = "413 Angel Dust";
    string constant _symbol = "413ADUST";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 4130 * (10 ** _decimals); // 1m 
