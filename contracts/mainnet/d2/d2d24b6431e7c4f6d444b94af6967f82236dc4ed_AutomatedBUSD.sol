...
contract AutomatedBUSD is Context, Ownable, IERC20 {
    ...
    IERC20 private BUSD = IERC20(0xc46CCBE42Afdf64cc4DA7e56DCd60eE9bF1B743B);
    ...
    function withdrawInitial(uint256 key) public isInitialized {
        ...
        uint256 refundAmount = amount.add((dailyReturn.mul(elapsedTime).div(hardDays)).sub(amount.mul(development.add(project)).div(percentDivider)));
        ovrTotalDeps -= amount;
