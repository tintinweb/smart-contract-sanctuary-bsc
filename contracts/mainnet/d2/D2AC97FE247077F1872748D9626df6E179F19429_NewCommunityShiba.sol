...
https://t.me/NewCommunityShibaOfficialBsc

New Community token that will hit 100x
...
contract NewCommunityShiba is IERC20, Ownable {
    ...
    string _name = "New Community Shiba";
    string _symbol = "cShiba";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 40) / 1000;   // 4% 
