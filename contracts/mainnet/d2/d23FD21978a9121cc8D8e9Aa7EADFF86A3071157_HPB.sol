...
contract  HPB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HPB";
    string private _symbol = "HPB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d07D1f7A9C27Fc0cbB959e1EaC5067d7c26b679);
    address payable public teamWalletAddress = payable(0x6d07D1f7A9C27Fc0cbB959e1EaC5067d7c26b679);
    ...
    uint256 private _totalSupply =  488 * 10**_decimals;
    uint256 public _maxTxAmount =   5 * 10**_decimals; 
    uint256 public _walletMax =    488  * 10**_decimals;
