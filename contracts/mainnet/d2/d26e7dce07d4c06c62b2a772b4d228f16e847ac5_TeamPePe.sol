...
contract TeamPePe is Context, IERC20, Ownable {
    ...
    string private _name = "Team PePe";
    string private _symbol = "$TPePe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7972a2BAF44295d3b9173541b4d64D92254F8737); // Marketing Address
    address payable public teamWalletAddress = payable(0x7972a2BAF44295d3b9173541b4d64D92254F8737); // Team Address
...
uint256 public _liquidityShare = 5;
    ...
    uint256 private _totalSupply = 45000000 * 10**_decimals;
    uint256 public _maxTxAmount = 1350000 * 10**_decimals; 
    uint256 public _walletMax = 1350000 * 10**_decimals;
