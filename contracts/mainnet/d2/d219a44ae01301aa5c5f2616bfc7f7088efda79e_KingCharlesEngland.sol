...
*By now you have probably noticed that I have Locked Lp / burnt liquidity if reach MC and renounced the contract. Being a token with cheap taxes, it is now up to you as a community to take the reign’s and drive us forward as I work on development.
...
contract KingCharlesEngland is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "KingCharlesEngland";
