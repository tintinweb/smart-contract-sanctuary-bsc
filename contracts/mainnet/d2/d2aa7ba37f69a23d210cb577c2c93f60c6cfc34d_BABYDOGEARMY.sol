...
/*
Telegram :https://t.me/BabyDogeArmyBsc
...
contract BABYDOGEARMY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB1A5a84baD2B615b8Aa22261195ee66f2e2450f1); 
    address payable public Wallet_Dev = payable(0xB1A5a84baD2B615b8Aa22261195ee66f2e2450f1);
    address payable public W_Deployer = payable(0xB1A5a84baD2B615b8Aa22261195ee66f2e2450f1);
    ...
    string private constant _name = "BABBY DOGE ARMY"; 
    string private constant _symbol = unicode"BDA"; 
    ...
    constructor () {
        ...
        _owner = 0xB1A5a84baD2B615b8Aa22261195ee66f2e2450f1;
