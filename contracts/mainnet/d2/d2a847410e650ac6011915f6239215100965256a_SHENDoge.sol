...
contract SHENDoge is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name="SHENDoge";
    string public _symbol="SHENDoge";
    ...
    uint256 public _totalSupply=10**15 * 10**_decimals;

    uint256 public  _maxTxAmount=10**15 * 10**_decimals;
    uint256 public  _walletMax=10**15 * 10**_decimals;
    ...
    address public marketingWallet=0x6b26611F4bEAEbBa83FeF41fDd68Fc95e42170D7;
