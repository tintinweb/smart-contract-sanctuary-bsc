...
abstract contract Ownable is Context {
    ...
    constructor() {
        //0xF850bdE876084D60EB2f79a80a1991918A01102e
        _owner = _msgSender();
...
contract SantaZilla is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Santa Zilla";
    string private _symbol = "Sanza";
    uint256 private _initSupply = 100000000 * 10**18;

    uint256 private buyTokenThreshold;
    uint256 private sellTokenThreshold;

    uint256 public buyFee = 100; // 10% init buyFee
    uint256 public sellFee = 100; // 10% init sellFee

    // Fees

    uint256 public buyMarketingFee = 40; // 4%
    ...
    uint256 public sellMarketingFee = 40; // 4%
    ...
    constructor() {
        _mint(0xF850bdE876084D60EB2f79a80a1991918A01102e, _initSupply); // alt owner()

        taxAddress = 0xF850bdE876084D60EB2f79a80a1991918A01102e; // alt 0xF850bdE876084D60EB2f79a80a1991918A01102e
        marketingWallet = 0xF850bdE876084D60EB2f79a80a1991918A01102e;
        SantaPresentWallet = 0xF850bdE876084D60EB2f79a80a1991918A01102e;
        TeamWallet = 0xF850bdE876084D60EB2f79a80a1991918A01102e;

        maxTokenPercentage = 300; // initial 3% of total supply.
        maxTokenAllowance = _totalSupply.mul(maxTokenPercentage).div(10000);

        buyTokenThreshold = maxTokenAllowance.mul(1).div(2000); // 0.002% of maxTokenAllowance
        sellTokenThreshold = maxTokenAllowance.mul(1).div(2000); // 0.002% of maxTokenAllowance
    ...
    function modifyMaxTokenPercentage(uint256 _newPercent) public onlyOwner {
        ...
        maxTokenAllowance = _totalSupply.mul(maxTokenPercentage).div(10000);
        uint256 inPercent = maxTokenPercentage.div(2000); // 2000
    ...
    function setBuyFee(uint256 _newFee) public onlyOwner {
        buyFee = _newFee;
        require(buyFee <= 200, "buyFee cannot be greater than 20%");
    }

    function setSellFee(uint256 _newFee) public onlyOwner {
        sellFee = _newFee;
        require(sellFee <= 200, "sellFee cannot be greater than 20%");
    }
    ...
    function setBuyTotalTax() internal {
        ...
        require(
            dexBuyFeeTotal <= 200,
            "Sum of Fees cannot be greater than 20%"
        );
    }
