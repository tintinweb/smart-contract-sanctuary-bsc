...
contract Data is Base {
    address _tmTokenAddress;
    IERC20  _tmToken;
    address _nftAddress;
    address _miningAddress;
    address _nftMiningAddress;
    constructor() {

    }

    function setTmToken(address _address) public onlyOwner {
        _tmTokenAddress = _address;
        _tmToken        = IERC20(_address);
    }
    ...
    function setMining(address _address) public onlyOwner {
        _miningAddress = _address;
    }
    ...
    function setNftMining(address _address) public onlyOwner {
        _nftMiningAddress = _address;
    }

    function getNftMining() view external returns(address) {
        return _nftMiningAddress;
    }
}