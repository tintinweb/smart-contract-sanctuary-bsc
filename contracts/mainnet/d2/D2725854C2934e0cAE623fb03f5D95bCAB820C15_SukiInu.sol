...
/**
 ...
 Doge started it all. Next we have Shiba Inu. 
Further peeling back those layers brought us the likes of Floki & Cheems. 
Finally a more fine detailed search through the history of doge memes introduced us to Kabosu. 
Now the only world famous doge yet to enter the blockchain is Suki. 
Suki is the yin to Kabosu’s yang.
   .-'''-.   ___    _ .--.   .--. .-./`)  
  / _     \.'   |  | ||  | _/  /  \ .-.') 
 (`' )/`--'|   .'  | || (`' ) /   / `-' \ 
(_ o _).   .'  '_  | ||(_ ()_)     `-'`"` 
