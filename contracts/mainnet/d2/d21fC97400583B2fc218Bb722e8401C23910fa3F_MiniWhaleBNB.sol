 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/MiniWhaleBNB
 * 
 * 
 * MiniWhaleBNB token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract MiniWhaleBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniWhaleBNB";
    string constant _symbol = "MWBNB";
