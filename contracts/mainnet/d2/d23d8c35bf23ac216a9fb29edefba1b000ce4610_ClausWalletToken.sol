...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdb12949bB8bAe25AD48de2657a9260c95326e026;
...
contract ClausWalletToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25122023 * 10**9;
    uint256 public _maxTxAmount = 25122023 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 25122023 * 10**9; //
    string private constant _name = "Claus Wallet Token"; // 
    string private constant _symbol = "CWT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xdb12949bB8bAe25AD48de2657a9260c95326e026);
