...
contract LPBalanceChecker is Ownable {
    ...
    function getBalance(address user, address lp)
        public
        view
        returns (
    ...
    {
        walletBalance = IApePair(lp).balanceOf(user);
        totalBalance += walletBalance;
        balances = new uint256[](stakingContracts.length);
    ...
    function removeStakingContract(uint256 index) public onlyOwner {
