...
contract testToken is IERC20,Context,Ownable{
    ...
    address public _TechnologyAddress = address(0x7474901ab187e1C6fe9279277f1Aa440CC72E2eA);         
    address public _SpreadAddress=address(0x0B79B27E614f4F605C2A2ED1Dc730d11AB3234B4) ;
    address public _FoundationAddress=address(0xcaEc10f2d5352c79970e7e405e1a1c534f63619b) ;
    address public _DaoAddress=address(0x5fe5BEA7ec6B886587C2C0F109DF2B37c4C8f1ab) ;
    ...
    uint public _MinAmountLimit=100000000000000000;
    ...
    uint256 private _sTotal =  (1*3500)* 10**18;    
    string private _name = "Dcoin";
