...
contract Ecuadorsupporters is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ecuador supporters";
    string private _symbol = "ECS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB9B00262560169B13a7D12DbAa9022f18Be0B932);
    address payable public teamWalletAddress = payable(0xB9B00262560169B13a7D12DbAa9022f18Be0B932);
