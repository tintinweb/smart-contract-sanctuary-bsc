...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public nftAddress = address(0x3334d4c6242893573b72f2eac28b03BdBaD1ce80);
    ...
    constructor (
        ...
        holderRewardCondition = 1000000 * 10 ** Decimals;
        numSellToFund = 200000 * 10 ** Decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 nftFeeAmount = _nftFee * tAmount / 10000;
            if (nftFeeAmount > 0) {
...
contract LGT is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000000,
        address(0xF975b22DE5B2ee27043729f3CdD35fBb51eeDe0D),
        address(0xF975b22DE5B2ee27043729f3CdD35fBb51eeDe0D)
    ){
