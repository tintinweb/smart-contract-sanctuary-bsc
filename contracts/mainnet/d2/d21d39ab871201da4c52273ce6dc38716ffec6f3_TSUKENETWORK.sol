...
// 
//
// 📱 Telegram:https::https://t.me/TSUKENETWORK
/*
...
contract TSUKENETWORK is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("TSUKENETWORK", "TSUKENETWORK") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TSUKENETWORK";
    string private _symbol = "TSUKENETWORK";
