...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyFundFee = 180;
    uint256 private _buyLPDividendFee = 200;
    uint256 private _buyLPFee = 20;
    uint256 private _sellLPDividendFee = 200;
    uint256 private _sellFundFee = 180;
    uint256 private _sellLPFee = 20;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address thiFundAddress = 0x7D7d7b4311422A1e0af2e177C0ec851dF287dd37;
...
contract TSP is AbsToken {
    constructor() AbsToken(    
        ...
        "the seed of prometheus 2.0",
        "TSP II",
        18,   
        8122,    
        address(0x92AA819E4b1e34519D0c2f331AD177E9C85a858A),    
        address(0xFEe3b82f270A1363766e8Cd6321f273871c7f19A)
    ){
    }
}