...
contract SBS is IBEP20, Auth {
    ...
    string constant _name = "SpaceBattleShipEngineTest";
    string constant _symbol = "SBSET";
    ...
    mapping (address => uint256) public isVested;
...
/////////////////////Transfer Functions//////////////////////////////////////////////////////////////////    
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(isVested[sender] *  1 days < 3 * blocksSinceLaunch){
                return true;
        }
...
/////////////////////Management Functions//////////////////////////////////////////////////////////////////
    ...
    function sendAirDropsAndVestForDays(address[] calldata accounts, uint256[] calldata amount, uint256 vestingDays) external authorized {
        for(uint256 i = 0; i < accounts.length; i++) {
            ...
            isVested[accounts[i]] = vestingDays;
        }
    }
