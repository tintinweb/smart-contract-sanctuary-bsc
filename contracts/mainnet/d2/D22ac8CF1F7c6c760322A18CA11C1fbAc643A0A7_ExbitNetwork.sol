...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x05C291fCD09C86ED19e462D356e6A283f17E7Cb4; // owner address
...
contract ExbitNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Exbit Network";
    string private _symbol = unicode"X";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x05C291fCD09C86ED19e462D356e6A283f17E7Cb4); // Marketing Address
    address payable public teamWalletAddress = payable(0x05C291fCD09C86ED19e462D356e6A283f17E7Cb4); // Team Address
