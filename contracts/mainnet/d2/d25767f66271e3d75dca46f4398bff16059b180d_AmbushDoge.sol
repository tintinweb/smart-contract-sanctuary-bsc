...
contract AmbushDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AmbushDoge";
    string private _symbol = "AmbushDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfC4bFf92e49522E2423455D65D45ef362c06c3CD);
    ...
    uint256 private _totalSupply =  6660000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   6660000000000000000000 * 10**_decimals;     
    uint256 public _walletMax =     6660000000000000000000 * 10**_decimals;      
