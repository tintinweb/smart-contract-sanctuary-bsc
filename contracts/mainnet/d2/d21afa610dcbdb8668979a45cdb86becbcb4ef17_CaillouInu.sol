...
contract CaillouInu is Context, IERC20, Ownable {
    ...
    address private _rwdtoken = 0xEb01Cd54C7E5C3C619a1F0039ACca9c35179CC1f;
    
    string private constant _name = "Caillou Inu";
    string private constant _symbol = "Caillou";
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance > 0) {
                ...
                if(contractETHBalance > 0) {
                    swapHOHOHO(address(this).balance);
                }
            }
    ...
    function swapHOHOHO(uint256 amount) private {
        address[] memory path = new address[](2);
