...
contract BBM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BBM";
    string private _symbol = "BBM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF74Da59Eb322FeeAB356FAd55dD16a6E3968eE98); 
    address payable public teamWalletAddress = payable(0x6cF4651B865644a5b5a7D336863A838Ed90C8b28); 
