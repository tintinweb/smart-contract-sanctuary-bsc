...
contract yutu is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xdadCd1E7cA44E6811abE83Cb3123890Fd2Dea0Fb); 
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newTeamTax) external onlyOwner() {
