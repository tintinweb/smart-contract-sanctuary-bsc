...
contract RABBOGEINU is IERC20 {
    ...
    string constant private _name = "RABBOGE INU";
    string constant private _symbol = "RABBOGE";
    ...
    // SHIBA INU ETH MAINNET TOKEN CONTRACT ADDRESS
    address public SHIBA = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE;
    // DOGE BSC MAINNET TOKEN CONTRACT ADDRESS
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xAE5b2FA96d2d60B33d936Aea3f8328e88D05925F),
        staking: payable(0x15f699135455469ca603467493BcA8924270267d)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 staking, uint16 marketing) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.staking = staking;
        _ratios.marketing = marketing;
        _ratios.total = rewards + staking + marketing;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + stakingBalance);
