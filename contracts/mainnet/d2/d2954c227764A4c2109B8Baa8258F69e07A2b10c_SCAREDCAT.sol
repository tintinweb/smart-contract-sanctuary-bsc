...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x00B5c208bfFB5C3Ed644a9876777aF4760B059Cb;
...
contract SCAREDCAT is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xe6d4bDA81973B5ba07020C9D36800D27608b069F);
    ...
    string private _name = "SCAREDCAT"; 
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= maxPossibleFee, "Fee is low!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
