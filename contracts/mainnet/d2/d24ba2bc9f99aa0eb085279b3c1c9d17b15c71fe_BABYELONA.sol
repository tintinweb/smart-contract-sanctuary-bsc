...
/**
 Welcome to BABY ELONA!
 Telegram: https://t.me/babyelonaofficial
...
contract BABYELONA  is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABYELONA";
    ...
    address public marketingWallet = 0xC3776DFEbe2d6F8d91d51a0D0b3F6e8f7df469F1;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        //require(account != 0x959275907dA95457798D78D04a16D1Ea1646d916, 'We can not exclude Pancake router.');
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 1000000000000 * 10**9){
