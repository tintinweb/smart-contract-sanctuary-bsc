...
//Tianzhu is the historical East Asian name for India, Originally pronounced as l̥induk or *qʰl'iːn tuɡ 天竺 in Old Chinese,
// it comes from the Chinese transliteration of unattested Old Persian diminutive *Hinduka-, which is from attested 𐏃𐎡𐎯𐎢𐏁 h-i-du-u-š (Hindu), 
//which is itself derived from the Proto-Indo-Iranian *síndʰuš, the etymon also of Sanskrit Sindhu, the native name of the Indus River.
//LFG!!!!
...
contract TianZhuInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TianZhu Inu";
    string constant _symbol = "TianZhu";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xa1d6EC4a32Ea7461aba97d7B05c5f7BcaF9d7FC7;
