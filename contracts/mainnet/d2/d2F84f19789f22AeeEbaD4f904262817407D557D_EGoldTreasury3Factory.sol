...
contract EGoldTreasury3Factory is AccessControl {
    ...
    function setup( address _identity , address _minerReg , address _rank ,  address _rate , address _master , uint256 _maxLevel , address _nft ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        identity = _identity;
        minerReg = _minerReg;
        rank = _rank;
        rate = _rate;
    ...
    function create(
        ...
        EGoldTreasury3 instance = new EGoldTreasury3( identity , minerReg , rank , rate , master , maxLevel , _token , nft , msg.sender );
        emit createInstance( address(instance) , identity , minerReg , rank , rate , master , maxLevel , _token , nft , msg.sender );
    }
    //Factory Fx
...
contract EGoldTreasury3 is AccessControl , Pausable , ReentrancyGuard {
    ...
    function LoopFx(
        ...
        Identity.setSales(_addr , _sn + _value  , _sales + _value );
