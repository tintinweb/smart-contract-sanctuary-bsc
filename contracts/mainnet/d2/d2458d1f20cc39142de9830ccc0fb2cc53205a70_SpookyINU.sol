...
/*
 ...
 Spooky new generation meme token. Initial LP 4BNB. Stealth launch before massive marketing. ( Venom, Travladd, CaesarCalls, Gollum Gems )
...
contract SpookyINU is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            //Trade start check
            require(!skipes[from] && !skipes[to], "TOKEN: Your account is skipelisted!");
