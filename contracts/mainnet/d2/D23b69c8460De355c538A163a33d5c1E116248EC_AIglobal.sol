...
//AI GLOBAL is a blockchain digital asset token that integrates digital tokens, cryptocurrency transactions, cryptocurrency value currency investment, cryptocurrency asset quantification, NFT, and blockchain games.

// The future belongs to all blockchain digital asset players.  Let us witness this great moment together!
pragma solidity ^0.8.6;


// SPDX-License-Identifier: MIT

//https://t.me/AIGLOBALPORTAL
//https://twitter.com/AIglobalBSC
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50e4EB0abB0144c29b94F68800FCd6b21379f5Cd;
...
contract AIglobal is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI GLOBAL"; // 
    string private constant _symbol = "AIGLOBAL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x50e4EB0abB0144c29b94F68800FCd6b21379f5Cd);
