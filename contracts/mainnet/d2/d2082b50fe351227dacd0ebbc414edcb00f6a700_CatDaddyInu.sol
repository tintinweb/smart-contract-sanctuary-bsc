...
🔥🔥🔥🔥🔥🔥🔥
BUY TAX   5% 
 SELL TAX 16%  8 and 24 at launch for 5 minutes

 Hot Meme play off the latest trends !!  Cat Daddy Inu
...
contract CatDaddyInu is IBEP20, Auth {
        using SafeMath for uint256;
    ...
    string constant _name = "Cat Daddy Inu";    
    ...
    uint256 public mStx = ( _totalSupply * 250 ) / 10000;
    ...
    uint256 public sT = _totalSupply * 91 / 100000;
