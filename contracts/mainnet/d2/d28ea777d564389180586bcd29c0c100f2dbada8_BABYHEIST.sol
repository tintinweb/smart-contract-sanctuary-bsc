...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  HEIST = IBEP20(0x223963cb59B1B0a0345365958146FD44cde2B7D1);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = HEIST.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(HEIST);
        ...
        uint256 amount = HEIST.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            HEIST.transfer(shareholder, amount);
...
/* Token contract */
contract BABYHEIST is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address HEIST = 0x223963cb59B1B0a0345365958146FD44cde2B7D1; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC861fA0b1113E4b41B21a6c4f7e633E336E95f82;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x257Dc507d4f33AEb925B779c8e004dA5952098F2;
