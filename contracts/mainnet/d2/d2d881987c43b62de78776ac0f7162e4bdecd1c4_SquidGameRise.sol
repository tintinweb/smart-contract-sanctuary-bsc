...
contract SquidGameRise is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SquidGameRiseDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Squid Game Rise", "Squid Game Rise") {
        ...
        dividendTracker = new SquidGameRiseDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "SquidGameRiseTRACKER",
            "SquidGameRiseTRACKER"
        );
        ...
        uint256 totalTokenSupply = (11_111_111) * (10**18);
    ...
    function updateFees(
        ...
        require(totalSellFees <= 5 && totalBuyFees <= 5, "total Fees cannot exceed 5% sell/buy");
...
contract SquidGameRiseDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SquidGameRise public SquidGameRiseContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SquidGameRiseContract = SquidGameRise(mainContract);
        minimumTokenBalanceForAutoDividends = 44444_000000000000000000; // 44,444 tokens
    ...
    function _transfer(
        ...
        require(false, "SquidGameRise_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SquidGameRise_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Squid Game Rise contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SquidGameRiseContract);

            uint256 prevBalance = SquidGameRiseContract.balanceOf(address(this));
            ...
            {
                uint256 received = SquidGameRiseContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SquidGameRiseContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
