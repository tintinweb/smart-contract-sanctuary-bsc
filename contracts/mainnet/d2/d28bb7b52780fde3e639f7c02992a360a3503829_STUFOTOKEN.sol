...
contract STUFOTOKEN is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 10000000 * 10**9;
    uint256 public maxSellLimit = 10000000 * 10**9;

    uint256 public swapTokensAtAmount = 5000000 * 10**9;

    string private constant _name = "STUFO TOKEN";
    string private constant _symbol = "STUFO";
    ...
    Taxes public sellTaxes = Taxes(0, 9, 0, 6);

    address public Stufo_Marketing_Wallet = 0xb0c29451b27339580B1f12cf5B8AF973e14AB188;
    address public Stufo_Buyback_Wallet = 0xBA16a86979DB868CD7CF285b63417Ee614061EDD;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Stufo_Marketing_Wallet] = true;
        _isExcludedFromFee[Stufo_Buyback_Wallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Stufo_Marketing_Wallet] = true;
        allowedTransfer[Stufo_Buyback_Wallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Stufo_Marketing_Wallet).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Stufo_Buyback_Wallet).sendValue(teamAmt);
        }
    }
    ...
    function Stufo_Update_Marketing_Wallet(address newWallet) external onlyOwner{
        Stufo_Marketing_Wallet = newWallet;
    }
    
    function Stufo_Update_Buyback_Wallet(address newWallet) external onlyOwner{
        Stufo_Buyback_Wallet = newWallet;
    }
