...
contract Shitdoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x827024E1d333E9CeE487E07B3A9b0eA8D101735D); 
    address payable public Wallet_Dev = payable(0x827024E1d333E9CeE487E07B3A9b0eA8D101735D);
    ...
    string private constant _name = "Shitdoge"; 
    string private constant _symbol = unicode"Shitdoge"; 
    ...
    uint256 public Percent_Marketing = 180;
    ...
    constructor () {
        ...
        _owner = 0xa3053369ddbd1102cCDdAb50A792ACf00fDe0D85;
