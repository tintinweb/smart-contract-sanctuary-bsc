...
Telegram : https://t.me/ConcerningAIOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x83Ae8726e152560f34A6452Da0ff6d4C451d7fE8; // owner address
...
contract ConcerningAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ConcerningAI";
    string private _symbol = "CAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83Ae8726e152560f34A6452Da0ff6d4C451d7fE8); // Marketing Address
    address payable public teamWalletAddress = payable(0x83Ae8726e152560f34A6452Da0ff6d4C451d7fE8); // Team Address
