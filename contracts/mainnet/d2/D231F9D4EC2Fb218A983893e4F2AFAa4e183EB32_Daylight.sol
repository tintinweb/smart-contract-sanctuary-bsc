...
contract Daylight is ReentrancyGuard {
    ...
    function claimReward() public noReentry {
        ...
        if (currentTime - stakedAmounts[msg.sender].startStake < 1 weeks) {
            withdrawFee = 90;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 2 weeks) { 
            withdrawFee = 80;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 3 weeks) { 
            withdrawFee = 70;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 4 weeks) { 
            withdrawFee = 60;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 5 weeks) { 
            withdrawFee = 50;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 6 weeks) { 
            withdrawFee = 40;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 7 weeks) { 
            withdrawFee = 30;
        } else if (currentTime - stakedAmounts[msg.sender].startStake < 8 weeks) { 
            withdrawFee = 20;
        }
    ...
    function displayEstimatedReward(address user) public view returns (uint256) {
        ...
        uint256 maxWithdrawal = stakedAmounts[msg.sender].initialDeposit.mul(3);
