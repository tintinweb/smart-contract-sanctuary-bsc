...
abstract contract CCBSToken is IERC20, Ownable {
    ...
    uint256 public _LPDividendsFee = 4;//lp分红
    ...
    //修改交易滑点
    function setTxFee(uint256 fee, uint256 LPDividendsFee) external onlyOwner {
        _txFee = fee;
...
contract CCBS is CCBSToken {
    constructor() CCBSToken(
    //名称
        "CCBS",
    //符号
        "CCBS",
    ...
    //总量 10000
        10000,
    //营销钱包
        address(0x4b9a43a2C20fE2C570922c52dd15015e534A2010)
    ){
