...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠁⠀⠀⠀⠀⠀⠀⠆⣇⣀⣀⠀⠀⠀⠰⣶⣦⣴⣾⣼⣷⣾⣿⡿⠔⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢈⣳⣽⣷⣾⢿⣾⣻⣿⣿⣟⣛⣚⣋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
   I make this DOGE... Tzu Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: DOGE...  is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract DOGE  is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0x43D118Fc5E3857A1631C3ad1949a4207EB55Fcdd);
