...
/**
🇭🇷 Croatia Fan Token 🇭🇷
🥇 Vjerujte nam - nikada vas nećemo iznevjeriti 🥇

⚡ https://t.me/Croatia_5 ⚡

📄Contract Address :
0xD280b7d9092C16a67b1A05D8Fc3909df0a236421
CHARTS 👍
https://poocoin.app/tokens/0xd280b7d9092c16a67b1a05d8fc3909df0a236421
DEXTOOLs 👍
https://www.dextools.io/app/en/bnb/pair-explorer/0xd280b7d9092c16a67b1a05d8fc3909df0a236421
...
contract Croatia is CroatiaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CroatiaTeam;
    address private CharityCroatia;
    ...
    string public override name = "Croatia Fan Token";
    string public override symbol = "Croatia Fan Token";
    ...
    constructor(uint totalSupplyValue, address CroatiaTeamAddress, address CharityCroatiaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CroatiaTeam = CroatiaTeamAddress;
        CharityCroatia = CharityCroatiaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CroatiaTeam] =  totalSupply * 4 / 100;
        balances[CharityCroatia] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's CroatiaTeam pot
