...
contract drogcoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7C21A4D997ba30f26e73B5E96150D0C487D454De;
    address public developmentWallet = 0x7C21A4D997ba30f26e73B5E96150D0C487D454De;
    address public buybackWallet = 0x7C21A4D997ba30f26e73B5E96150D0C487D454De;

    string private constant _name = "drog coin";
    ...
    Taxes public buyTaxes = Taxes(0, 5, 1, 1, 1);
    Taxes public sellTaxes = Taxes(1, 4, 1, 1, 1);
