...
contract DogePi is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 17) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 19) / 100; //2%
    ...
    address private marketingFeeReceiver = 0xfaaD962dD866c792d6B872C9EA5595b96cB9F02b;
    address private developmentFeeReceiver = 0xe719Bf1DA9586EB0A9BB1A2A02f3f030983A85b3;
