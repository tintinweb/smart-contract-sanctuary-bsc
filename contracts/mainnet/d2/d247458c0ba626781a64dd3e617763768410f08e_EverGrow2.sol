...
https://t.me/Evergrowtwopointzero
https://twitter.com/EverGrowTwo
...
contract   EverGrow2 is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 30_000 * (10**_decimals);
    uint256 public maxSellLimit = 30_000 * (10**_decimals);
    uint256 public maxWalletLimit = 30_000 * (10**_decimals);
    
    uint256 private asTime;
    uint256 private tTimer;
    address public marketingWallet = 0x13b8cd556bD9C888Dfbc01270B7D1ac8d7C8e6cA;
    address public devWallet = 0x13b8cd556bD9C888Dfbc01270B7D1ac8d7C8e6cA; 
    address public operationWallet = 0x13b8cd556bD9C888Dfbc01270B7D1ac8d7C8e6cA;
    address public charityWallet = 0x13b8cd556bD9C888Dfbc01270B7D1ac8d7C8e6cA; 

    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "EverGrow2.0";
    string private constant _symbol = "$EGC2";
    ...
    Taxes public taxes = Taxes(0, 5, 0, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 0, 0, 0, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            ...
            if(gasLimitEnabled)
                require(tx.gasprice <= gasLimit, "Follow gas limits");
        }
    ...
    function updateGasSettings(uint gasLimitEXACT, bool isEnabled) external onlyOwner{
        gasLimitEnabled = isEnabled;
        gasLimit = gasLimitEXACT * 1 gwei;
    }
