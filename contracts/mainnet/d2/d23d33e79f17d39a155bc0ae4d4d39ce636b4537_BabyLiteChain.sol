...
contract BabyLiteChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby LiteChain"; //
    string private constant _symbol = "BLCHAIN"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x120d8F7516701530E84983393a8d19Fd4442831a;
