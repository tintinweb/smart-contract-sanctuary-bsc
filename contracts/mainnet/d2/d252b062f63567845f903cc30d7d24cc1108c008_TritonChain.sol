...
Telegram chat : https://t.me/tritonchaincommunity
Website : https://tritonchain.com/
...
contract TritonChain is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 5**9; //
    string private constant _name = "Triton Chain"; // 
    string private constant _symbol = "TNT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x01700d5dcDCB88993B196413885f7Fb47A7aF1D2;
