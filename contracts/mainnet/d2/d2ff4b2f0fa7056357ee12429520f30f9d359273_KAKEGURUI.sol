...
*TELEGRAM: https://t.me/KakeguruiBNB
...
contract KAKEGURUI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " KAKEGURUI ";
    string private _symbol = " KAKEGURUI BSC "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC21F2e00402C35b7dbFAFC7EC520316590203c4a);
    address payable public teamWalletAddress = payable(0xC21F2e00402C35b7dbFAFC7EC520316590203c4a);
    ...
    uint256 private minimumTokensBeforeSwap = 333 * 10**_decimals;
