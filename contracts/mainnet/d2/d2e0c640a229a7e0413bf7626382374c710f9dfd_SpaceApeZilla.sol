...
library Address{
 ...
 contract SpaceApeZilla is Context, IERC20, Ownable {
    ...
    address public donationWallet = 0xD6f62d5A31E0D8a6C62E4cA90a403cDC69C0660B;

    string private constant _name = "SpaceApeZilla";
    string private constant _symbol = "SAPEZILLA";
    ...
    Taxes public taxes = Taxes(0, 99, 0, 0);
    Taxes public sellTaxes = Taxes(0, 10, 1, 5);
