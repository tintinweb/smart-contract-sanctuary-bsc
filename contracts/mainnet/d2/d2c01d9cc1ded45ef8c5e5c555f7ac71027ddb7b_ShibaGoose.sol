...
Welcome to ShibaGoose
ShibaGoose token is a 100% decentralized, community-focused project. Each transaction will contribute towards 
$SHIBGO growth. One of the goals of ShibaGoose creators and the community is to adopt animals and to protect precious habitats around the world and all the species which rely on them. A part of the tax collected will be contributed to where the funding is most needed, which includes adopting and protecting habitats of animals like Mongoose, penguins, elephants, and gorillas.

TG:https://t.me/shibagooseportal

Website:http://shibagoose.online/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa51B3350a44D22dF020344F07ED1318698EfA461;
...
contract ShibaGoose is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xa51B3350a44D22dF020344F07ED1318698EfA461);
    ...
    address private _authorized = 0xa51B3350a44D22dF020344F07ED1318698EfA461;
    ...
    */
    ...
    string private _name = "ShibaGoose"; 
    string private _symbol = "SHIBGO";  
