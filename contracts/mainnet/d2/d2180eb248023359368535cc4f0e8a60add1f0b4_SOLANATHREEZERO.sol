...
/**
STEALTH LAUNCHING
https://t.me/SolanaThreePointZero
...
contract SOLANATHREEZERO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solana 3.0";
    string private _symbol = "SOL 3.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6254F9CcAbD6BffBCD80b92D326cB2be2ca3830a); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x278f4DF8D34D587ef6EE65D87Ea7FAed733956ba); // Developmental Address
    ...
    uint256 public _walletMax = 20000000 * 10**9; // 4%
