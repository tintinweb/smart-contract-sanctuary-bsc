...
contract BRAVO_Token {
    string public constant name = "BRAVO DEX TOKEN";
    string public constant symbol = "BRAVO";
    ...
    // Blacklisted addresses will not be allowed to aqire new token.
    // They can still move / sell token if they already have aquired it.
