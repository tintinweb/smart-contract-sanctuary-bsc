...
contract BOMBSHIBA is IBEP20, Ownable {
    ...
    string constant _name = "Bomb Shiba!!!";
    string constant _symbol = unicode"BombShiba!!!";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply     = 100000000000 * 10**_decimals;
    uint256 public _maxTxAmount     = 6660000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 6660000000 * 10**_decimals;

    address private deadWallet      = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0xc218B82f1B97dED0058824638b76cf96b0609B4C;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(2, 3, 1, 0);
    Fees public sellFees    = Fees(2, 3, 1, 0);
