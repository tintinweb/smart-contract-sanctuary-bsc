...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C4b370C285D89781cb8B6f2746CFA5bEECeDf71;
...
contract Amiable is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdFBf8850a639CB447066083cb528EB28171d716A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AmiableFinance";
    string private _symbol = "AmFi";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 98;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 98;
