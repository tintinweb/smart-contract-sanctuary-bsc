...
/*   BNB Double - Yield Farming Smart Contract built on BNB Smart Chain.
 *   The only official platform of original BNB DOUBLE team! All other platforms with the same contract code are FAKE!
 *
 *   [OFFICIAL LINKS]
 * 
 *   ┌────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbdouble.net                           │
 *   │                                                            │
 *   │   Twitter: https://twitter.com/bnbdouble                   │
 *   │   Telegram: https://t.me/bnbdouble_tg                      │
 *   │                                                            │
...
contract BNBDOUBLE is Context, Ownable {
