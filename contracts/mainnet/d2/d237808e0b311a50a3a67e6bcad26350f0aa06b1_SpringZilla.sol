...
contract SpringZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spring Zilla";
    string private _symbol = "sZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9f7fA780EB1E1e32819647Ab937A68F0B2fe4BbA);
    address payable public BuyBackWalletAddress = payable(0x9f7fA780EB1E1e32819647Ab937A68F0B2fe4BbA);
