...
contract MCCAT is ERC20, Ownable {
    uint256 private constant initialSupply = 1_000_000 * 10**18;
    ...
    constructor(address _router) ERC20("MC CAT", "MCCAT") payable
    {
        ...
        // External wallets 
        taxWallets["marketing"] = 0x50E40675d780c3A51E12E2C20e59A13a1ba9BC05;
        taxWallets["dev"] = 0x6e3F9F420C42595376aB6df78485b411cFE1541E;
