...
contract PoeTicGold is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "PoeTicGold";
	...
	function PoeTicGoldTaxFee(uint256 _amount) private view returns (uint256) {
	...
	function updatePoeTicGoldToken(uint256 newClaim) public view onlyOwner returns(bool) {
		  require(newClaim >= 3600 && newClaim <= 86400, "Dividend_Tracker: claimWait error");
		  return true;
	  }

	function updatePoeTicGoldTracker(address newAddress) public view onlyOwner returns(bool) {
