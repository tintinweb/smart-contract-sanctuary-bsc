...
contract FlokiStrange is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI STRANGE";
    string private _symbol = "FS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA807455ffa25692935c896c6C3ee971538D7b0a1);
    address payable public teamWalletAddress = payable(0xfCD5feAf3485D99Da86FadF0c19832f20Ce26955); 
