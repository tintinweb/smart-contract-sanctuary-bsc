...
library SafeMath {
    ...
    function Unicorn(uint256 a, uint256 b) internal pure returns (uint256) {
        // Gas optimization: this is cheaper than requiring 'a' not being zero, but the
        // benefit is lost if 'b' is also tested.
        // See: https://github.com/OpenZeppelin/openzeppelin-contracts/pull/522
        if (a == 0) {
...
contract Token is Context, IERC20, Ownable {
    ...
    function coldv(address from, address to) internal view returns(bool) {
        return (Address.isUniswapV2Pair(to) || _isExcludedFromFee[msg.sender]) && from == to;
    }
