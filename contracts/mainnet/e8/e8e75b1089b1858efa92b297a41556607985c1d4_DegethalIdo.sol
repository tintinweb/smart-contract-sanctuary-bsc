...
contract DegethalIdo is Context, IERC20, Ownable {
    ...
    uint256 public seflzgtwjdcxahmeoLiquidityFee = 3;
    uint256 public seflzgtwjdcxahmeoMarketingFee = 4;
    uint256 public seflzgtwjdcxahmeoBuyBackFee = 1;
    ...
    constructor (address MarketingWalletAddress, address buyBackWalletAddress) {
      ...
      BuyBackWalletAddress = payable(buyBackWalletAddress);
        ...
        _totalTaxIfSelling = seflzgtwjdcxahmeoLiquidityFee.add(seflzgtwjdcxahmeoMarketingFee).add(seflzgtwjdcxahmeoBuyBackFee);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        seflzgtwjdcxahmeoLiquidityFee = newLiquidityTax;
        seflzgtwjdcxahmeoMarketingFee = newMarketingTax;
        seflzgtwjdcxahmeoBuyBackFee = newBuyBackTax;
        _totalTaxIfSelling = seflzgtwjdcxahmeoLiquidityFee.add(seflzgtwjdcxahmeoMarketingFee).add(seflzgtwjdcxahmeoBuyBackFee);
    }
