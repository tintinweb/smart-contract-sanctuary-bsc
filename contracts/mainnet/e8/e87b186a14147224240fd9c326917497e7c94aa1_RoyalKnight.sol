...
Please join : https://t.me/RoyalKnightBSC
...
contract RoyalKnight is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDCOIN = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RoyalKnight";
    string constant _symbol = "$RoyalKnight";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 25) / 1000; // 2.5% 25,000,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 5% 50,000,000
    ...
    uint256 liquidityFee = 500000; // 5%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 300000; // 3%
    uint256 devFee = 400000; // 4%
    uint256 totalFee = 1200000; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x7Eae76dFfEe2Aaf73d33795697AD72679dfE93Df);
