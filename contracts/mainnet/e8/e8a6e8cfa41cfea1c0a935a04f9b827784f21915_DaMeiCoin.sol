...
contract DaMeiCoin is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "DaMeiCoin";
    string constant _symbol = "DMC";
    ...
    function setDMCSwapFee(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        _swapThreshold = _amount;
    }  

    function setAllDMCFees(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
        _liqFee = liquidityFee;
        _marketFee = marketingFee;
        _feeDenominator = denominator;
    }

	function DaMeiCoinRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
