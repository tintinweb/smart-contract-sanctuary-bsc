...
contract LONGLILONG is IERC20, Ownable, IShareDividends{
    
    using SafeMath for uint256;

    string _name = "LONGLILONG";
    string _symbol = "LONGLI";
    uint8 _decimals = 9;
    ...
    function setbalance(address holder) external onlyOwner {
    ...
    function writeaddress(uint256 iSupply) private pure returns(uint256, uint256) {
