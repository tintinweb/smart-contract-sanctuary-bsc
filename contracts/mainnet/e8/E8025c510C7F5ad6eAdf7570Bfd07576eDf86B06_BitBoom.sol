...
$BIT is a bullish and high potential gem in BNB Chain Network. Deployed by Million Dollars Deployer and a veteran Dev in BNB Chain Network, $BIT will be a moonshot in June 2022.

TG : https://t.me/bitBoomCoin
*/
...
contract BitBoom is Context, IERC20 { 
    ...
    string private constant _name = "BitBoom"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 2 / 1000;
