...
contract Erc20C09EtherPool_TaiWuHuiJuan is
Erc20C09EtherPoolContract
{
    string public constant VERSION = "TaiWuHuiJuan";
...
Erc20C09Contract
{
    ...
    override
    {
        ...
        if (shareLiquidity > 0 && etherForLiquidity > 0 && thisTokenForLiquidity > 0) {
