...
contract MiniPigeInu is IBEP20, Auth {
    ...
    string constant _name = "Mini Pige Inu";
    string constant _symbol = "MPINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //2% max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  //4% max wallet
    ...
    address private marketingFeeReceiver =0x3945683633792C5EeE11d44CbA179c98742C11cB;
    address private teamFeeReceiver =0x3945683633792C5EeE11d44CbA179c98742C11cB;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x3945683633792C5EeE11d44CbA179c98742C11cB;
