...
contract NEKOX100 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NEKO X100";
    string constant _symbol = "NEKO X100";
    ...
    address public marketingFeeReceiver = 0x6B491663dD9B8C2Bb218bba095C0d6c3d83e7FA7;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x6B491663dD9B8C2Bb218bba095C0d6c3d83e7FA7] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x6B491663dD9B8C2Bb218bba095C0d6c3d83e7FA7] = true;
