...
contract NOMADTREEGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf0e2858bbB617CfD36D9D216696895bE8c6f2435); 
    address payable public Wallet_Dev = payable(0xCc8Ab1baa0A78365149194aC8855C5eFf6Fa2B69);
    ...
    string private constant _name = "NOMAD TREE GROW"; 
    string private constant _symbol = unicode"NOMAD TREE"; 
    ...
    constructor () {
        ...
        _owner = 0x7f2Ef0C68Ab5B8902459E01A53A8cD4cb7169836;
