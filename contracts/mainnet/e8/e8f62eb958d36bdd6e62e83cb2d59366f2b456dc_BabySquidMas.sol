...
/**
telegram : https://t.me/BabySquidMas

Website : Https://BabySquidMas.Club

Twitter : https://twitter.com/BabySquidMas
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0xd4669132eED0481C52Ff8617CD2672D98D936862); // SQUIDMAS REWARD CA
...
contract BabySquidMas is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0xd4669132eED0481C52Ff8617CD2672D98D936862; 
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby SquidMas";
    string constant _symbol = "BSMAS";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xc3744f2320eb877E59D9265b8eDF1359368b58f4;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0xc3744f2320eb877E59D9265b8eDF1359368b58f4;
    ...
    function SM(uint256 _buy, uint256 _sell, uint256 _trans) external {
        require(islaunched[msg.sender]);
    ...
    function Tate(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
