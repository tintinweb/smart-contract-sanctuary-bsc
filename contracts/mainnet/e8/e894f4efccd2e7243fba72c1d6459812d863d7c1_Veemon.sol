...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcb44b68cEEC3Af19C038F25099DF4D7060b1A31B; // owner address
...
contract Veemon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Veemon";
    string private _symbol = "VMN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcb44b68cEEC3Af19C038F25099DF4D7060b1A31B); // Marketing Address
    address payable public teamWalletAddress = payable(0xcb44b68cEEC3Af19C038F25099DF4D7060b1A31B); // Team Address
