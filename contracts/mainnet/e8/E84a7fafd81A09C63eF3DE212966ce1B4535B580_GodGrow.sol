...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7A6167D10B80725695F98280e014a88Fcc734ecB; // owner address
...
contract GodGrow is Context, IERC20, Ownable {
    ...
    string private _name = "God Grow";
    string private _symbol = "GODGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5191C6CA3D8C00085fC075a3BB4D3e5b3d3C0b51); // Marketing Address
    address payable public teamWalletAddress = payable(0x4e17aBEa32dEa8feDD8A8F919Df55Ac1d561C01a); // Team Address
