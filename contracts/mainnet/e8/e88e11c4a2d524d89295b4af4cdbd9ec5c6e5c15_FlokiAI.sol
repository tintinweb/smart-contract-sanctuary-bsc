...
/*
    ...
    Floki AI is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable floki in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $FAI a household name.
...
contract FlokiAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki AI"; //
    string private constant _symbol = "FAI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xE3871ef05F31a749ec5Ffc4637E73C253c61B456;
