...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 15 / 1000;
            if (burnAmount > 0) {
                feeAmount += burnAmount;
                _takeTransfer(
                    sender,
                    address(0xA78544BeD4CE84AF182dE20478768C3D9532CdE6),
                    burnAmount
                );
            }
        }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x366205Dfc4D2AF043A692ff562488b6f146B880A;
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x366205Dfc4D2AF043A692ff562488b6f146B880A),
    
        address(0x3314fe27B40eB844B98F90b8b561986c2Df71bf8)
    ){
