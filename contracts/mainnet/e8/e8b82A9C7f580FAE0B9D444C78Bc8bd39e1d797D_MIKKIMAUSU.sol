...
// Telegram: https://t.me/MikkiMausu
...
contract MIKKIMAUSU is Context, IERC20 { 
    ...
    string private constant _name = "MikkiMausu"; 
    string private constant _symbol = "$Mikki"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 200 / 100;
