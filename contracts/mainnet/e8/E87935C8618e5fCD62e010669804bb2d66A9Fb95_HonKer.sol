...
contract HonKer is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string private constant _name = "HonKer"; // TO DO -- ADD NAME
    string private constant _symbol = "HonKer"; // TO DO -- ADD SYMBOL
    ...
    // Fee Receiver
    address public marketingFeeReceiver = 0x40c93459aF735be0aA985126281Bde9f5F79468B; // 
    ...
    uint256 public snipeBlocks = 3; // Number of blocks for the antisnipe function, any buy transaction in these blocks will be automatically blacklisted
    ...
    */
    ...
    function setMaxWallet(uint256 _maxWallet) external onlyOwner {
        require(_maxWallet * (10 **_decimals) >= _tTotal &&
    ...
    function setMaxTX(uint256 _maxTX) external onlyOwner {        
        require(_maxTX * (10 **_decimals) >= _tTotal &&
