...
contract KrampusNFTs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address private TeamReceiver = 0x103B70B6a246f9cb3A3bC2Fd002C9403996bfC35;
    ...
    function tokenURI(uint256 _id)
        ...
        returns (string memory)
    {
        require(_exists(_id), "Krampus: URI query for nonexistent token");
  ...
  function withdraw() public payable onlyOwner {
    ...
    function claimRewards() public {
        require(!paysInTokens, "Krampus: rewards are paid in tokens");
