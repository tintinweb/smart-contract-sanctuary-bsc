...
contract BGRUSH is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 999 * 10**9;
    string private constant _name = "Baby GoldRush";
    string private constant _symbol = "$BGRUSH";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x49a71F5d17631ea0717a99e29770d0e536834CcD;
