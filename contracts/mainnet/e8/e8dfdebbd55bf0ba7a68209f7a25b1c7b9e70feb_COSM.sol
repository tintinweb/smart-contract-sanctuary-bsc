...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x0Eb3a705fc54725037CC9e008bDede697f62F335); // ATOM
...
contract COSM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Cosmopolitan Coin";
    string constant _symbol = "COSM";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x0Eb3a705fc54725037CC9e008bDede697f62F335; // ATOM
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4894D9F832C4468F1651339a61f5E899a267d921;
