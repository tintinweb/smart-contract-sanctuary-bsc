...
/**
 *Telegram: CatWorldBSC
 *Website: https://CatWorld.live
*/
...
library Address{
 ...
 contract CatWorld is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0xf5F202D6fbd6567fd048330fAc3590EE6a634af2;
    address private donationWallet = 0xf5F202D6fbd6567fd048330fAc3590EE6a634af2;

    string private constant _name = "CatWorld";
    string private constant _symbol = "CWD";
    ...
    Taxes private taxes = Taxes(0, 13, 1, 0);
    Taxes private sellTaxes = Taxes(0, 14, 1, 0);
