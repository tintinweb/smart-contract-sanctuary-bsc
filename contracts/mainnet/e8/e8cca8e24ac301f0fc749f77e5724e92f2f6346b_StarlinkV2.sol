...
contract StarlinkV2 is ERC20, Ownable {
    ...
    address public marketingWalletAddress = 0x7ef409ec3204f5a0FdEbb63f929c15A0CFAB7D4f;
    address public lpReceiveWallet = 0x7ef409ec3204f5a0FdEbb63f929c15A0CFAB7D4f;

    uint256 public maxTxBuyAmount = 10000000000 * 10 ** 18;
    uint256 public maxHolderAmount = 50000000 * 10 ** 18;

    uint256 public airdropAccountEveryTrade = 5;
