...
contract MoonlightMetaverse is ERC20, Ownable {
    ...
    constructor () ERC20("Moonlight Metaverse", "$MLM") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xCFF3A81819637Cdf162ebfc3F6F7D978eC08F7f2;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy <= 12, "MarketingFeeOnBuy should be less than or equal to 12");
        marketingFeeOnBuy = _marketingFeeOnBuy;
        emit UpdateBuyFees(marketingFeeOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnSell <= 12, "MarketingFeeOnSell should be less than or equal to 12");
