...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE09af981174BE7532c9Ec2DA59fc26a913D1c25A; // owner address
...
contract RipQueenElizabeth is Context, IERC20, Ownable {
    ...
    string private _name = "RipQueenElizabeth";
    string private _symbol = "RQE"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb828FF7adC48265f01565663933AE7F33BD0b1bf); // Marketing Address
    address payable public teamWalletAddress = payable(0xF231586152bC79A6f08AbD58e334b1c096426141); // Team Address
