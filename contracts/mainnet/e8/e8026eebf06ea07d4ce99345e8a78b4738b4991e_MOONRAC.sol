...
contract MOONRAC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonRAC";
    string private _symbol = "MoonRAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24C07DA3A29dBbA6625d8A267edB9DA934b4BE01); 
    address payable public teamWalletAddress = payable(0x1f041C343eaC388B657d6410A53ed504895c8A93); 
