...
/*
    ...
    Suzaku 2.0 is very giving and is designed to reward long term holders.
    Community is first and foremost.
    We proud to run with transparency and fairness to the community.
...
contract SuzakuToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Suzaku 2.0"; //
    string private constant _symbol = "Suzaku 2.0"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x95554Ef6fc78e8815aA87d6253AD35cE43b50a81;
