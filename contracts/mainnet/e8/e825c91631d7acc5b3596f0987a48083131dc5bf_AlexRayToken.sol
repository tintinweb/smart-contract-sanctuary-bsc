...
contract AlexRayToken is ERC20, Ownable {
    ...
    address public receiveFeeWallet = 0x885D52aB36EeE6435C1eFE0bDA4b8DED8EDC7e1A;
    ...
    constructor () ERC20("AlexRayToken", "ART", 8, 10000 * 10 ** 8){
        address msgSender = _msgSender();
