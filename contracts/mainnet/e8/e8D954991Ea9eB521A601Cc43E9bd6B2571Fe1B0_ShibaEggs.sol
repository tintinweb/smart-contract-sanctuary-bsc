...
contract ShibaEggs is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaEggs", "ShibEggs") {
        ...
        mktgWallet = address(0x00F55510CB8cC88648a87F041166C97724A74ccd); 
        devWallet = address(0xFC3ECc4e48755c68C90B682Ff75F304Aa2A979CC); 
        liqWallet = address(0xd72Ff18Ce7590F5aADC330EE8C0e0a0058859710); 
        operationsWallet = address(0x00F55510CB8cC88648a87F041166C97724A74ccd);
