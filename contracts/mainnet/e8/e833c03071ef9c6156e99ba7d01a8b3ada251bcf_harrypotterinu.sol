...
contract harrypotterinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa8060f4C845234264128f98a2A6dCeB14517D4bC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "harrypotterinu";
    string private _symbol = "HPI";
