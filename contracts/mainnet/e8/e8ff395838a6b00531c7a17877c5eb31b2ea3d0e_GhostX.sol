...
contract GhostX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ghost X";
    string constant _symbol = "GHOSTX";
    ...
    address public marketingFeeReceiver = 0xc3aF163C2a5f6b4474564F0896E8a3F9D01dBBf9;
    ...
    function getMultipliedFee() public view returns (uint256) {
        if (launchedAtTimestamp + 5 days > block.timestamp) {
            return totalFee.mul(25000).div(feeDenominator);
    ...
    function triggerGHOSTBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
