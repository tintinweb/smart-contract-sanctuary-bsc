...
contract bsc is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit hole";
    string private _symbol = "Rabbit hole";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xAC4D5f87274DFb6cBC997107F1E8f6D78676296b); // Marketing Address
    address payable private teamWalletAddress = payable(0xAC4D5f87274DFb6cBC997107F1E8f6D78676296b); // Team Address
