...
contract SquidLuna is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SLUNA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3c22d1B54558455aDc9e2f7254140377D6722Fcc);
    address payable private _marketingAddress = payable(0x3c22d1B54558455aDc9e2f7254140377D6722Fcc);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 41, "Tax cannot be more than 20.");
	    require(taxFeeOnSell < 41, "Tax cannot be more than 20.");
