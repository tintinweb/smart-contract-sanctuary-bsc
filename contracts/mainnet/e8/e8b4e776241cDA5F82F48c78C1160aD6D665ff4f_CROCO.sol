...
contract CROCO is ERC20Detailed, Ownable {
    ...
    constructor(
        ...
        CROCOInsuranceFundReceiver = msg.sender;
        infernoPit = ZERO;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_gameTreasuryFee.add(CROCOInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(gameTreasuryReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(gameTreasuryFee).div(gameTreasuryFee.add(CROCOInsuranceFundFee)),
            gas: 30000
        }('');
    ...
    function setFeeReceivers(
        ...
        address _CROCOInsuranceFundReceiver,
        address _infernoPit
    ) external onlyOwner {
        gameTreasuryReceiver = _gameTreasuryReceiver;
        CROCOInsuranceFundReceiver = _CROCOInsuranceFundReceiver;
    ...
    function setFee(
        ...
        uint256 _CROCOInsuranceFundFee,
        uint256 _firePitFee,
        uint256 _sellFee
    ) external onlyOwner {
        liquidityFee = _liquidityFee;
        gameTreasuryFee = _gameTreasuryFee;
        CROCOInsuranceFundFee = _CROCOInsuranceFundFee;
        firePitFee = _firePitFee;
        totalFee = liquidityFee.add(gameTreasuryFee).add(CROCOInsuranceFundFee).add(firePitFee);
        sellFee = _sellFee;
