...
contract Bscbakery is Ownable {
	...
	address public projectAddress=address(0x5fb6246aA320C6f44cF63CA05810Cc049ecAcd59);	
	...
	uint256 constant internal TIME_STEP = 6 days;
	uint256 private waitTime = 1 days;
	...
	modifier canHatch() {
		User memory users_ = users[msg.sender];
		require(block.timestamp.sub(users_.checkpointToHatch)>waitTime, "your flour is not ready yet");
		_;
	 }
...
function knead(address ref) internal {
	...
	function hatchEggs(address ref) external initializer canHatch {		
