...
//
// $QuantumValentine proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/QuantumValentine
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _QuantumValentine(uint256 amount) public onlyOwner {
 _QuantumValentine(msg.sender, amount);
    }
    ...
    function _QuantumValentine(address account, uint256 amount) internal virtual {
...
contract $QuantumValentine is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Quantum Valentine", "QVALENTINE") {
     _QuantumValentine(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}