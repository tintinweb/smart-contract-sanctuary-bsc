...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdc2FF4d25995b8e545E71Db24aF4B82D2984CF53; 
...
contract ELONFACE is Context, IERC20, Ownable {
    ...
    string private _name = "ELON FACE";
    string private _symbol = "ELONFACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdc2FF4d25995b8e545E71Db24aF4B82D2984CF53); 
    address payable public teamWalletAddress = payable(0xdc2FF4d25995b8e545E71Db24aF4B82D2984CF53); 
