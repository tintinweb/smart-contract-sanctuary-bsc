...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public partnerAddress = address(0x72C9B239d85da36BAa1516397347a76477B2E0eD);
    ...
    function setFee(uint256 lpDividendFee, uint256 destroyFee) external onlyOwner {
        _lpDividendFee = lpDividendFee;
        _destroyFee = destroyFee;
    }
}

contract LaFiDAO is AbsToken {
    ...
    //USDT
        ...
        5888,
    //Fund
        address(0x601a78Da8B4d82f3B98613Cfc2774478e65bd16a),
    //Receive
        address(0x601a78Da8B4d82f3B98613Cfc2774478e65bd16a)
    ){
