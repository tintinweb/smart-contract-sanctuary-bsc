...
// *Telegram : https://t.me/lunarise1000
...
contract LunaRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x96C66B855a732F622922B4Ea0a4c924d80517837));
    address payable public devWallet =
        payable(address(0x57387f37712c0c7a6D4FEF0D4644619f6Dc6B3B4));
    address public liquidityReceiver =
        0x57387f37712c0c7a6D4FEF0D4644619f6Dc6B3B4;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "LUNA RISE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 7550000000 * 10**9;
