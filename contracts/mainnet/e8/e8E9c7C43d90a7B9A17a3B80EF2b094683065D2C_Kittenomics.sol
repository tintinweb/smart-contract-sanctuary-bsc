...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x3B3691d4C3EC75660f203F41adC6296a494404d0);
    ...
    uint256 public minDistribution = 1000000 * (10 ** 8);
...
contract Kittenomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kittenomics";
    string constant _symbol = "$KTTNS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd2001d56867598Bb8a9000a47f6f5557Ef93366c;
        devFeeReceiver = 0x95A44261e58A2a790Cb9D8E204F0aA692b772dBd;
    ...
    function set_max_roomrent(uint256 _rent_withoutdecimal) public onlyOwner {
        maxRoomRent = _rent_withoutdecimal * 10**10;
    }
