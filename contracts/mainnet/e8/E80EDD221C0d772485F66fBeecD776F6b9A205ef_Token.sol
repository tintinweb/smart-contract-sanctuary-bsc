...
contract A  {
    ...
    function setRate(uint _rate) external {
        require(msg.sender == 0x07deF3e1a4F9c6Fc42dD669e50825B1728cfe339,"no admin");
        rate  =_rate;
    }
...
contract Token is Ownable, IERC20Metadata {
    ...
    function init()external {
        ...
        is_init = true;
        _mint(0x88f15FaB9757295528c153Db4B61e65337cc75A0,10000000e18);
