...
contract MUUNBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuunBoy";
    string private _symbol = "MuunBoy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3FD43930aD2D86f8E95Aff1672DD65caEa5B5fD); 
    address payable public buyBackWalletAddress = payable(0x257F448aD79F8BBAA382212E58a3b8F50Cafd8B2); 
    ...
    uint256 private minimumTokensBeforeSwap = 80000 * 10**9; 
