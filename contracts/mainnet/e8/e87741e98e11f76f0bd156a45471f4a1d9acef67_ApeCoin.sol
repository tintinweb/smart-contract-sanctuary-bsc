...
contract ApeCoin is ApeCoinDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ApeCoinTeam;
    address private CharityApeCoin;
    ...
    string public override name = "ApeCoin";
    string public override symbol = "ApeCoin";
    ...
    constructor(uint totalSupplyValue, address ApeCoinTeamAddress, address CharityApeCoinAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ApeCoinTeam = ApeCoinTeamAddress;
        CharityApeCoin = CharityApeCoinAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ApeCoinTeam] =  totalSupply * 4 / 100;
        balances[CharityApeCoin] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ApeCoinTeam pot
