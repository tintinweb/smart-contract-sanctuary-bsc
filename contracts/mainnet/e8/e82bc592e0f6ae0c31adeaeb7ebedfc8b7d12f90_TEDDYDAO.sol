...
contract TEDDYDAO is ERC20, Ownable {
    ...
    uint256 private _total = 1_0000_0000_0000 ether;

    uint256 public _maxSwap = 0;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public swapTokensAtAmount = 10000 ether;
    ...
    constructor() ERC20("TEDDY DAO", "TEDDY DAO") {
        if (block.chainid == 56) {
        ...
        _marketWallet = 0xbdAd8153057CD53772Bf25B2A22089529fDF5172;
    ...
    function _swap() private lockSwap {
        ...
        swapTokensForTokenB(balanceOf(address(this)), _marketWallet);
    }
