...
/**
 *Submitted for verification at BscScan.com on 06.04.2022
*/
...
contract HST is IBEP20, Auth {
    ...
    address MARK  = 0x114eba21a90ca3916126212C3a85eDD5f75b35e7;
    address IMOV = 0x30C61e9c297a34fC87A74bD7a2489676E30AB915;

    string constant _name = "HASTA Coin";
    string constant _symbol = "HST";
    ...
    address public IMOVFeeReceiver = IMOV;
    address public autoLiquidityReceiver = DEAD;
    address public marketingFeeReceiver = MARK;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBIMOV = amountBNB.mul(IMOVFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool tmpIMOVSuccess,) = payable(IMOVFeeReceiver).call{value: amountBNBIMOV, gas: 30000}("");

        // only to supress warning msg
        tmpSuccess = false;
        tmpIMOVSuccess = false;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _IMOVFee, uint256 _marketingFee,  uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        IMOVFee = _IMOVFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_IMOVFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _IMOVFeeReceiver) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        IMOVFeeReceiver = _IMOVFeeReceiver;
    }
