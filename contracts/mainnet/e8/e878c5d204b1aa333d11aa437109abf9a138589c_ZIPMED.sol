...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x114b6650C98B9d5844BBC6A2D3fcD017D0Aab66D; // owner address
...
contract ZIPMED is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZIPMED";
    string private _symbol = "ZIPMED"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49d08c4E9DeFd2d9712D5749054DEd805fAaf6B1); // Marketing Address
    address payable public teamWalletAddress = payable(0xbf609D17BFcC8A52AE588B81271468b8dE410FA9); // Team Address
