...
contract GenesisAptos is Context, IERC20, Ownable {
    ...
    string private constant _name = " Genesis Aptos "; // 
    string private constant _symbol = " $GA "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x4bF7aEc3e41a4f19B7FDb85609b137EfB2Ba7206;
