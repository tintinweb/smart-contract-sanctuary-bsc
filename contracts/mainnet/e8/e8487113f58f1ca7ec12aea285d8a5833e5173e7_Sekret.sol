...
contract DividendDistributor is IDividendDistributor {
    ...
    address BUS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    IDEXRouter router;
...
contract Sekret is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Sekret Projekt";
    string constant _symbol = "SKRT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 1) / 66;
    ...
    constructor () {
        ...
        pair = IDEXFactory(router.factory()).createPair(BUS, address(this));
