...
contract MMT is MMTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MMTTeam;
    address private CharityMMT;
    ...
    string public override name = "MetaMask Token";
    ...
    constructor(uint totalSupplyValue, address MMTTeamAddress, address CharityMMTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MMTTeam = MMTTeamAddress;
        CharityMMT = CharityMMTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MMTTeam] =  totalSupply * 4 / 100;
        balances[CharityMMT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MMTTeam pot
