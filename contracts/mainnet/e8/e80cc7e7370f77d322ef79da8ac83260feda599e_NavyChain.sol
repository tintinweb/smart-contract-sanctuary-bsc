...
Navy Chain is an innovative and forward-looking
decentralized blockchain and ecosystem built on 
the Delegated Proof of Stake (DPoS) protocol. 
The performance of the blockchain is designed 
to scale with widespread adoption of the currency
and platforms in mind. By combining the lightning 
fast processing times and fee-less transactions,
Navychain is positioned to become one of the 
leading blockchain technologies used by people around the world.


https://twitter.com/navychain
https://t.me/navychain
...
contract NavyChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Navy Chain";
    string private _symbol = "Nav";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x142A696aE7130671122b36f96c39B7493C4DacA6);
