...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsubasa World Cup Inu"; //
    string private constant _symbol = "TWCI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xB8Aa6A2feAd2C418692680126fEc4598D76E8Bd7;
