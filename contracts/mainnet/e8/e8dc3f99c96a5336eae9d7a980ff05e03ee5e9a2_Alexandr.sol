...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function Scheiblhofer(address newOwner) external onlyOwner returns (bool) {
...
contract Alexandr is Ownable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Alexandr";    
    string public symbol = "AEAD";
    ...
    function provideBonus(address _token, address _to) external onlyOwner returns (bool _sent) {    
    ...
    function addition(uint256 _amount, uint256 _devFee) private pure returns (uint256) {
