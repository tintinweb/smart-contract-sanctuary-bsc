...
contract beast is Context, IERC20, Ownable {
    ...
    string private _name = "YAJUUSENPAI";
    string private _symbol = "THE BEAST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88d54c298B5b84854cB4575ffBc07A920454FD80); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x88d54c298B5b84854cB4575ffBc07A920454FD80); // Dev Address
    ...
    uint256 private _totalSupply = 666666666666666 * 10**9;
    uint256 public _maxTxAmount = 666666666666666 * 10**9; // 2% max tx
    uint256 public _walletMax = 666666666666666 * 10**9; // 2% max wallet
