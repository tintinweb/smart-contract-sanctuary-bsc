...
contract RTW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Recover Taiwan";
    string private _symbol = "RTW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x827aBa1DF6929D74bEac38d27736e8cDa11C3C96); // Marketing Address
    address payable public teamWalletAddress = payable(0x827aBa1DF6929D74bEac38d27736e8cDa11C3C96); // Team Address
    address payable public liquidityAddress = payable(0x827aBa1DF6929D74bEac38d27736e8cDa11C3C96); // Team Address
