...
contract KABSwap is ContextUpgradeable {
	...
	function init(IOKGManagement _gov, address _kab)
		external
		initializer
	{
		__Context_init();
	...
	function setKab(address _kab) external onlyManager {
		kab = _kab;
	}
	...
	function emergencyWithdraw(address _receivers, uint256 _amounts)
		...
		onlyManager
	{
		IERC20MintableBurnable(kab).transferFrom(address(this), _receivers, _amounts);
	}
	...
	function deposit(
		...
		IERC20MintableBurnable(kab).burnFrom(_msgSender(), _amount);
