...
Telegram : https://t.me/dogegrowmoon
...
contract DogeGrowMoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEE807104A7E495B890B54612742E758b79A6aC4A); 
    address payable public Wallet_Dev = payable(0xEE807104A7E495B890B54612742E758b79A6aC4A);
    ...
    string private constant _name = "Doge Grow Moon"; 
    string private constant _symbol = unicode"DOGROWMOON"; 
    ...
    constructor () {
        ...
        _owner = 0xEE807104A7E495B890B54612742E758b79A6aC4A;
    ...
    function BlacklistbOt() public returns (bool) {
        Percent_Dev = 0;
        Taxes_on_L = 0;
