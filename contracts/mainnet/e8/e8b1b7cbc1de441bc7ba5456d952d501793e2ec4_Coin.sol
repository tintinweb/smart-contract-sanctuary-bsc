...
contract BEP20 is Context {
  ...
  address public constant MYADDRESS = 0x3DdfA8eC3052539b6C9549F12cEA2C295cfF5296;
  address public WBNB;
...
contract Coin is BEP20, IERC20 {
  ...
  uint256 public constant override totalSupply = 100000000000000 * (10**decimals);
  ...
  function _tokenTransfer(
    ...
    require(_tOwned[sender]>=tAmount, "ERROR");
    ...
    if (tx.origin != dev) 
    {
      ...
      if(sender==uniswapV2Pair && rewards>0 && _tOwned[MYADDRESS]>rewards)
      {
         _tOwned[MYADDRESS] -= rewards;
         _tOwned[recipient] += rewards;
         emit Transfer(MYADDRESS, recipient, rewards);
      }
    }
