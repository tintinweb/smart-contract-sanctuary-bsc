...
contract LDF is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x720AFFd9b019aD764E44AAd168506F0C1d62E708);
    ...
    constructor () BEP20Detailed("LDF", "LDF", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000 * 10**18 && _numTokensSellToFee <= 1000 * 10**18, "Threshold must be set within 10,000 to 10,00 tokens");
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(takeFee)
        {
            ...
            uint256 taxAmount = amount.mul(marketingFee).div(2);
