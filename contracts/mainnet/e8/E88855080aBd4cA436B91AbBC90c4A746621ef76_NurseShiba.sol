...
Official Social:
🛡Telegram: https://t.me/NurseShiba
🔔 Web: www.nurseshiba.com
*/
...
contract NurseShiba is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x24024886a17BB1312862Bb41092b337A816D628E));
    address payable private devWallet =
        payable(address(0x24024886a17BB1312862Bb41092b337A816D628E));
    address private liquidityReceiver =
        0x24024886a17BB1312862Bb41092b337A816D628E;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Nurse Shiba";
    ...
    uint256 private _maxTxAmount = 5000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 3000000000000 * 10**9;
    uint256 private _maxWalletSize = 5000000000000 * 10**9;
