...
//Telegram : https://t.me/nitrosantaboy
...
contract nitrosantaboy is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Nitro Santa Boy";
    string constant _symbol = "NSB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 28) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *28) / 100; 
