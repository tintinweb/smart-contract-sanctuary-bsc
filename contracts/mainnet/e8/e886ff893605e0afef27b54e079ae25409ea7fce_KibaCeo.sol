...
TG Community - https://t.me/kibaceo
...
contract KibaCeo is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Kibaceo";
    string private constant _symbol = "kibaceo";
    ...
    address payable private _marketingAddress = payable(0x2B78f8CCD1021aD03c79520BAAdB9cC5E51F639f);
    address payable private _teamAddress = payable(0x2B78f8CCD1021aD03c79520BAAdB9cC5E51F639f);
    address payable private _ecosystemAddress = payable(0x2B78f8CCD1021aD03c79520BAAdB9cC5E51F639f);
    address payable private _lpRecipient = payable(0x2B78f8CCD1021aD03c79520BAAdB9cC5E51F639f);
