...
contract GoldFLOKI
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "GoldFLOKI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6009e5AC59A463f0C756BDCC8fBc1Af11ECD6c04));
        _anotherA = payable(address(0x6009e5AC59A463f0C756BDCC8fBc1Af11ECD6c04));
