...
contract BabyTwogeInu is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x97a8c51B0080F8bD11Ba6F03C7471c3522Bd3F7E;

    string constant _name = "BabyTwogeInu";
    string constant _symbol = "BABYTWOGEINU";
    ...
    uint256 _BUYtotalFee = 5;

    uint256 _SELLliquidityFee = 1;
    uint256 _SELLmarketingFee = 11;
    uint256 _SELLtotalFee = 12;
