...
contract BuffApeCoin is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x7C9F367bB67a95541D337aF9B516174eC12aBbc6);

    string private _name = "BuffApeCoin";
    string private _symbol = "$BUFFAPE";
