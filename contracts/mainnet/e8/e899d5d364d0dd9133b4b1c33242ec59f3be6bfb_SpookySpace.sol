...
/**
Telegram : https://t.me/SpookySpaceBSC
*/
...
contract SpookySpace is Context, IERC20, Ownable {
    ...
    string private _name = "SpookySpace";
    string private _symbol = "SpookySpace";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x261C920d5177BC963C58ed42BDCf3152a1d4e9E9); // Marketing Address
    address payable public teamWalletAddress = payable(0x261C920d5177BC963C58ed42BDCf3152a1d4e9E9); // Team Address
