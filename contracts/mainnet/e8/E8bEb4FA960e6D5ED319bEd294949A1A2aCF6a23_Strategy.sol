...
contract Strategy is BaseStrategy {
	...
	address internal constant ankr = address(0xf307910A4c7bbc79691fD374889b36d8531B08e3); // ANKR
	...
	/**
	 * @notice
	 *  Swaps half of the wBNB for ANKR.
	 */
	function _convertToIntermediate() internal {
		route[] memory wbnbToAnkrRoute = new route[](1);
		wbnbToAnkrRoute[0] = route(wbnb, ankr, false);
	...
	/**
	 * @notice
	 *  Swaps half of the ANKR for token0 and token1 and adds liquidity.
	 */
	function _convertToLpToken() internal {
		route[] memory ankrToToken0Route = new route[](1);
		ankrToToken0Route[0] = route(ankr, address(token0), false);

		route[] memory ankrToToken1Route = new route[](1);
		ankrToToken1Route[0] = route(ankr, address(token1), false);
	...
	function _giveAllowances() internal {
		...
		IERC20(ankr).safeApprove(router, 0);
		IERC20(ankr).safeApprove(router, MAX);
