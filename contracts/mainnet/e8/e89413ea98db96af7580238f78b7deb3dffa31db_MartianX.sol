...
contract MartianX is Context, IERC20, Ownable {  
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1F6A95085A1E4ef42c6349d4945D42280BEaCccF); // Marketing Address
    ...
    uint256 private _maxWalletTotal = 10* 10**9;
    uint256 private _tFeeTotal;

    string private _name = "MartianX";
    string private _symbol = "MartianX";
