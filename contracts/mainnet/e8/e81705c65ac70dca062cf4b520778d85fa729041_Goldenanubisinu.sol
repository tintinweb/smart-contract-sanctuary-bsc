...
contract Goldenanubisinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Golden anubis inu";
    string private _symbol = "$ANUBIS";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x72B4F7f01476F4140f35FDbD6a93d1039F7321CE;
    address public developerWallet = 0x4690A4Ea78a25929bDd194D46Ac2387115658835;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(50).div(denominator);     //5%
    uint256 public _walletMax = _totalSupply.mul(50).div(denominator);    //5%
