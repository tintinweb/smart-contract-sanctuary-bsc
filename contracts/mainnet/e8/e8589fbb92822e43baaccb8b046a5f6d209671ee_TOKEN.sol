...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "PepeApe"; //  Name
        _symbol = "PepeApe"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 2000000000000 * 10**_decimals;  // 0.2% of total supply
        _maxTxAmount = 5000000000000 * 10**_decimals; // 0.5% of total supply
        _maxWalletBalance = 5000000000000 * 10**_decimals; // 0.5% of total supply
