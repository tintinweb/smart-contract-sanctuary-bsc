 ...
 contract JintuToken is IBEP20, OwnAdmin
{
    ...
    uint256 public minFenHongLP =  5* 10**_decimals; //最低持有LP数量
    ...
    uint256 public _tranferLpFenhongFee = 15; //Lp滑点
    uint256 public _tranferHolderFenhongFee = 1; //五个地址

    uint256 public maxbuy = 2023*10**_decimals;
    uint256 nonce;
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    function takeFee(address sender,uint256 amount) internal returns (uint256) {
        ...
        uint256 Lpnum = amount.mul(_tranferLpFenhongFee).div(1000); //LP滑点
