...
contract BabyKARABAS is Context, IERC20 { 
    ...
    address payable public projectWallet = payable(0x1a51ec99885878b868F29AC09582C626D70531C4);    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 3* 10**6 * 10**_decimals;
    string private constant _name = "BabyKARABAS"; 
    string private constant _symbol = unicode"BKARABAS";
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0xfaFACD7BB3E7cAe585B6E078a02c1D751f94a59d;
