...
contract PCSFeeHandler is UUPSUpgradeable, OwnableUpgradeable {
     ...
     * @dev Callable by owner
     */
    function withdraw(address tokenAddr,  address payable to) external nonReentrant onlyOwner {
        ...
        if (tokenAddr == address(0)) {
            ...
            uint256 balance = IERC20Upgradeable(tokenAddr).balanceOf(address(this));
            if (balance != 0) {
                IERC20Upgradeable(tokenAddr).safeTransfer(to, balance);
            }
        }
    }
