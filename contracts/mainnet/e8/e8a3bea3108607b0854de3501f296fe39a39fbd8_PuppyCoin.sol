...
//https://t.me/puppycoinportal     

//PuppyCoin guarantees to have our liquidity locked and provide a rug-proof environment throughout the process. $ Ruff will seek to provide the investors a verified contract at a very low tax!
...
contract PuppyCoin is Context, IERC20, Ownable {
    ...
    string private _name = "PuppyCoin";
    string private _symbol = "$ RUFF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FC46A302f2C766F168eF908f461E9aD011C4505); // Marketing Address
    address payable public teamWalletAddress = payable(0x6FC46A302f2C766F168eF908f461E9aD011C4505); // Team Address
