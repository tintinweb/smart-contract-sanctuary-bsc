...
/**
   #GoldenFrogInu The New Community of Ape Token
    
   I make this #Golden Frog Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: GoldenFrogInu is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/GoldenFrogInu
...
contract BabyGoldenFrogInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Golden Frog Inu";
    string private constant _symbol = "BGFI";
