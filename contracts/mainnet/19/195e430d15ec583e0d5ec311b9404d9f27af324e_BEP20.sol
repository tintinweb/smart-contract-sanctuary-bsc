...
contract BEP20 is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0xF51553393814745eeF9DFb8Bd8894045Eb835141);
        TeamAddress= payable(0x509dABB5dd315a03455f63218F29F0a12CB37Eac);
        ...
        _maxOnceEat = 1000000000 * 10**_decimals;
        _maxTotalEat = 1000000000 * 10**_decimals;
