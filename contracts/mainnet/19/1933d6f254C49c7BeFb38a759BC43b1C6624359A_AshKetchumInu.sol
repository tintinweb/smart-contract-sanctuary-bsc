...
//https://t.me/AshKetchumInuPortal
...
contract AshKetchumInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AshKetchum Inu";
    ...
    uint256 public _maxTxAmount = _totalSupply * 20 / 200;
    uint256 public _walletMax = _totalSupply * 20 / 200;
