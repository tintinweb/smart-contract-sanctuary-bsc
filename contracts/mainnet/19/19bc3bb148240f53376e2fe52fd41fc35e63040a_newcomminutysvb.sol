...
/*
https://t.me/NewCommunitySVB_Bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xECbD3D81a46f1f8d0746F240F56aA4f71E453a20; 
...
contract newcomminutysvb is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY SVB";
    string private _symbol = "CSVBANK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xECbD3D81a46f1f8d0746F240F56aA4f71E453a20); 
    address payable public teamWalletAddress = payable(0xECbD3D81a46f1f8d0746F240F56aA4f71E453a20); 
