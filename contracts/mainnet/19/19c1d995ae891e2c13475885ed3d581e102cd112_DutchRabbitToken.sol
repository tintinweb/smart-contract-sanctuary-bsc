...
contract DutchRabbitToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x810673449614682A3f37761D3098064D46D1411e); 
    address payable public Wallet_Dev = payable(0x553A04BEdB2EDb31d5a9815feD29ECa476cD9bB0);
    ...
    string private constant _symbol = unicode"DURT"; 
    ...
    constructor () {
        ...
        _owner = 0x553A04BEdB2EDb31d5a9815feD29ECa476cD9bB0;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_Tax_On_Buy/90;
            ...
            uint256 sellFEE = tAmount*_Tax_On_Sell/90;
