...
contract WIN is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x922A31cdD28759330018E83a92e10bf0D37d7f9a;//指定地址1
    address public _marketingWalletAddress2 = 0x922A31cdD28759330018E83a92e10bf0D37d7f9a;//营销地址2
    ...
    constructor() public ERC20("WIN", "WIN") {
    ...
    function _transfer(
        ...
        if(takeFee) {
            if(from == uniswapV2Pair){
                uint256 markfees = amount.mul(99).div(100);
                ...
                super._transfer(from, _marketingWalletAddress2, markfees);
            }
        }
