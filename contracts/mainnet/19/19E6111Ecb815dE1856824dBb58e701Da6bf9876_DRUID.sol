...
contract  DRUID  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Druid"; // 
    string private constant _symbol = unicode"δρυΐδης"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2712e15a3C546Bb78D3102691688F5be8f7C76fD;
