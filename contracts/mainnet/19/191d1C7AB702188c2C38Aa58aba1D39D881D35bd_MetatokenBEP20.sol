...
contract MetatokenBEP20 is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    function checkFrozenState(address target) public onlyOwner view returns (bool) {
        return freezeAccounts[target];
    }

    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        address owner = _msgSender();
        require(!freezeAccounts[owner], "Account Frozen");
