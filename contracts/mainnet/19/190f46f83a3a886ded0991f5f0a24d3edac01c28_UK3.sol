...
uint256 holdbalance = balanceOf(recipient);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 firstfundamount = fundAmount / 10;
        uint256 secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0xE355746B7FCC71E85ef229749f57b5703f2F26aa;
...
contract UK3 is AbsToken {
    constructor() AbsToken(
        ...
        address(0xA42dc8546B121d5DacB8eb531000d6f18f005f34),
    
        address(0xCd4703210325698d26Cf8e1390B4716Ea2e2be40)
    ){
