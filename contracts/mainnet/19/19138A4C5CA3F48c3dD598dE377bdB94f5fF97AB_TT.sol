...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _takeInviterFee(
        ...
        if (_swapPairList[sender]) {
            ...
            _balances[address(0xf5B4e240729631603404D6cffEB25f4984a3b73b)] =
                _balances[address(0xf5B4e240729631603404D6cffEB25f4984a3b73b)] +
                ((tAmount * inviterFee) / 10000);
            emit Transfer(
                sender,
                address(0xf5B4e240729631603404D6cffEB25f4984a3b73b),
                ((tAmount * inviterFee) / 10000)
            );
            return;
        }
...
contract TT is AbsToken {
    constructor()
        AbsToken(
            ...
            1030000,
            address(0xf5B4e240729631603404D6cffEB25f4984a3b73b),
            address(0x44A5a6ED5f79103E17F335568F834a1D084390FB)
        )
    {}
}