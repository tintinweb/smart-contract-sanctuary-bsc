...
// File: contracts/HuskeDog.sol

/**
 *月亮代表着圆满和幸福！ 那么（Huske Dog）就要和元宵节一起来啦！
以中国节日命名，又名“元宵节”，像一盏灯笼，拥有央视和各大平台的流量支持，包括Dev（元宵狗）有经验和格局，将成为BSC Dogs上的佼佼者，将 点亮区块链堪称币圈的元宵节！ ！
*/
...
contract HuskeDog is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'HuskeDog';
    string private _symbol = '$Huske';
