...
contract TokenL is Ownable, ERC20 {
    using Address for address;

    IRouter public uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "TokenL"; //London Gold";
    string private constant _symbol = "TokenL"; //XUA2";
    ...
    address public dividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //0x45804880De22913dAFE09f4980848ECE6EcbAf78;
    ...
    function setBaseFeesOnBuy(uint8 _liquidityFeeOnBuy,uint8 _operationsFeeOnBuy,uint8 _buyBackFeeOnBuy, uint8 _holdersFeeOnBuy) external onlyOwner {
        require(_liquidityFeeOnBuy + _operationsFeeOnBuy + _buyBackFeeOnBuy + _holdersFeeOnBuy <= 10, "LondonGold: Fees must be less or equal to 10%");
    ...
    function setBaseFeesOnSell(uint8 _liquidityFeeOnSell,uint8 _operationsFeeOnSell,uint8 _buyBackFeeOnSell, uint8 _holdersFeeOnSell) external onlyOwner {
        require(_liquidityFeeOnSell + _operationsFeeOnSell + _buyBackFeeOnSell + _holdersFeeOnSell <= 10, "LondonGold: Fees must be less or equal to 10%");
