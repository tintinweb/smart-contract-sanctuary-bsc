...
/*
Join our Wednesday Addams themed crypto and NFT group for fun discussions and market insights. Nevermore alone in your journey!

Details for Tax on Buying and Selling:

    5% for Development and Investment portfolio
    5% for Marketing
    5% for distribution to holders

Security Measures:

    LP tokens burned
    Contract renounced
    Purchase limit of 2% of total supply
    Selling limit of 5% of total supply
    Anti-bot algorithm in place

Social:
Twitter: https://twitter.com/w_addams_coin
Telegram: https://t.me/wednesday_addams_coin
*/
...
contract Wednesday is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Wednesday Addams Coin";
