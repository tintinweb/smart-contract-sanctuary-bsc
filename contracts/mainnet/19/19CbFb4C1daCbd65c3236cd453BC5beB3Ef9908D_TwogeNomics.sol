...
contract TwogeNomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwogeNomics";
    string private constant _symbol = "$Twnomics";
