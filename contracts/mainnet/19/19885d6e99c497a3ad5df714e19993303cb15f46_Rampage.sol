...
contract Rampage is IBEP20, Ownable
{
    ...
    string private constant _name = 'RAMPAGE';
    string private constant _symbol = 'RAMPAGE';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 400000000000000 * 10**_decimals;
    ...
    uint256 contractTokensToSell = 400000000000 * 10**_decimals;

    address public devAccount1=payable(0xd6879baFB7a978C40c06dCA997F487C179485A62);
    address public devAccount2=payable(0xF494c2E16a4F0e0c1990769779A6b7A14D09b4e2);

    uint256 private tradeStartedAt; 
    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = _circulatingSupply;
    uint256 public  sellLimit = _circulatingSupply;
	uint256 private maxBuyAmount = 4000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        balanceLimit=8000000000000 * 10**_decimals;
        sellLimit=2000000000000 * 10**_decimals;
    ...
    function changeTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 devTaxes, uint8 buyTax, uint8 sellTax, uint8 transferTax) external onlyOwner{
        ...
        require(buyTax <= 20,
        "bTax cannot exceed 20.");
        require(sellTax <= 20,
        "sTax cannot exceed 20.");
        require(transferTax <= 20,
        "tTax cannot exceed 20.");
