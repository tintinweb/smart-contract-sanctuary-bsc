...
/**
 *        WELCOME TO HAGAKURE INU

 *        TG :  https://t.me/hagakureinu
 ...
 *        MAX WALLET 3%
 *        
 *    After the Tokugawa shogunate suppressed the Shimabara Rebellion in 1638, 
 *    Japan experienced no warfare for about two centuries. 
 *    private feuding and dueling between samurai was also suppressed.
 *    Yamamoto Tsunetomo was born in 1659, after the end of officially sanctioned samurai fighting. 
 *    He had no personal combat experience and when he was employed, he worked as a scribe. 
 *    By the late 1600s and early 1700s, samurai faced the dilemma of maintaining a warrior class in the absence of war,
 *    and Hagakure reflects this uncertainty.      
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xECCF35F941Ab67FfcAA9A1265C2fF88865caA005); //
...
contract HAGAKUREINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HAGAKURE INU";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x94CfA020D33c8A11F3445ACbA7b2f1b15A3a580F;
