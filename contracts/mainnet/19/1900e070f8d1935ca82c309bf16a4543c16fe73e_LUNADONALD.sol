...
contract LUNADONALD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUNA DONALD"; // TODO change
    string private _symbol = "LUDO"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92457b0bA15e0c131d84202142651091e8806572); // Marketing Address
