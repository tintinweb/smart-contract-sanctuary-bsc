...
contract TigerBoy is Ownable, IERC20 {
    ...
    string private _name = "Tiger Boy";

    string private _symbol = "TigerBoy";
    ...
    function _trx(address from, address to, uint256 amount) internal virtual {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _trx(_msgSender(), recipient, amount);
        return true;
    }
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _trx(sender, recipient, amount);
