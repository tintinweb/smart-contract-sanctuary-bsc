...
Telegram: https://t.me/pootrustofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb4f94DB298fe17231553FE5b6eaB8b5ebd197F3e;
...
contract POOTRUST is Context, IERC20, Ownable {
    ...
    string private constant _name = "POO TRUST"; // 
    string private constant _symbol = "$PTRUST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xb4f94DB298fe17231553FE5b6eaB8b5ebd197F3e);
