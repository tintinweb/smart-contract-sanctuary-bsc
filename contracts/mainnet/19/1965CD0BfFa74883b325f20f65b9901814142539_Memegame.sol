...
Transaction Tax
Buy/Sell 7%
3% of each transaction goes to marketing wallet
1% of each transaction goes to liquidity pool
3% of each transaction goes to dev
...
contract Memegame is IBEP20, Auth {
    ...
    string constant private _name = "MEMEGAME";
    ...
    address public _marketingFeeReceiver = 0xfbf2D907e2bFF2Dc397b927b6339323130C01dD9;
    address public devFeeReceiver = 0x932eB3428e7647b66d5900dFb1170bCeDC5b4f3E;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(taxFeeVar).div(totalFee).div(2);
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __marketingFee, uint256 _taxFeeVar, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxFeeVar = _taxFeeVar;
        _marketingFee = __marketingFee;
        devFee = _devFee;
        totalFee = _taxFeeVar.add(__marketingFee).add(_devFee);
