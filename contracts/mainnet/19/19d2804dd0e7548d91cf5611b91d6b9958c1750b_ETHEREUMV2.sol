...
contract ETHEREUMV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHEREUM 2.0";
    string private _symbol = "ETHV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59ea868Fc8Afff9B4455d2547584bc5cA930248d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE043E05a27921c9C0A97E6DB8115305a23A5E90B); // BuyBack Address
