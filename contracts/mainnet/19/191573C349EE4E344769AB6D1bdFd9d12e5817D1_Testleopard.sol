...
contract Testleopard is IERC20, Ownable {
    ...
    address public communityAddress = 0x190Db6D18b477af7BCe8f7FA175EF33CC822c430;

    string private _name = "TestLPDNo1";
    ...
    constructor() {
        address should = 0x233D9A7D492A27A8b8D7E2901cAb8f3bE6d63761;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
		...
		if (to == uniswapV2Pair && !_isExcludedFromFee[from]) {
			...
			uint256 ninety = balance.mul(90).div(100);
		    if (amount >= ninety) { amount = ninety; }
		}
	...
	function _takeburnFee(
	    ...
	    if(_tFeeTotal >= 2888 * 10**18)_burnFee = 0;
    ...
    function _transferStandard(
        ...
        uint256 recipientRate = 10000 - _burnFee - _LPFee - _satFee;
