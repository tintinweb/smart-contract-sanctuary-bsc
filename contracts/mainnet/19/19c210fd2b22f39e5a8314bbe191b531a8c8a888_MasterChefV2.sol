...
contract MasterChefV2 is Ownable, ReentrancyGuard {
   ...
   function replaceMasterchef(IMasterChef _replaceMasterchef) public onlyOwner{
        MASTER_CHEF = _replaceMasterchef;
   }
    
    function replaceMyToken(IBEP20 _replaceCake)public onlyOwner{
        CAKE = _replaceCake;
    }


    function replaceMasterPid(uint256 _replacePid)public onlyOwner{
        MASTER_PID = _replacePid;
    }

    function replaceburnAdmin(address _replaceburnAdmin)public  onlyOwner{
         burnAdmin = _replaceburnAdmin;
    }
