...
contract REALTYTOKEN is Context, IERC20, Ownable {
    ...
    address public _charityAddress = 0xc0e699B4af76942084E239892C9eEdd5d0a652C3;    
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000 * 10**18;
    uint256 private _rTotal = MAX - (MAX % _tTotal);
    uint256 private _tFeeTotal;
    string private _name = "Realty Token";
