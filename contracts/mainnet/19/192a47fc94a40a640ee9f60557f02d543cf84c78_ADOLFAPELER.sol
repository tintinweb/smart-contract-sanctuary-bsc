...
/*ADOLFAPELER (BASED DEV)

Telegram - https://t.me/AdolfApelerBSC
*/
...
contract ADOLFAPELER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ADOLFAPELER";
    string constant _symbol = "GAZ";
