...
contract ULASBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ULAS";
    string private _symbol = "ULAS";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x0BC580c166dE9C79D46321eD3540511aB10dc341);
    address payable public buyBackWalletAddress =
        payable(0x0C4FE0F28f93185Adeb5eB5aB86bCdCA6576B291);
