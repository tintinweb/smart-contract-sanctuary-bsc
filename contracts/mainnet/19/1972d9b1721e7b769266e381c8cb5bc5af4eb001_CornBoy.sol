...
contract CornBoy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999999 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = _tTotal / 50; // totalsupply divided with 200
    ...
    string private constant _name = "CornBoy!!!";
    ...
    //No current rfi - Tiered Rewarding Feature possibly later
