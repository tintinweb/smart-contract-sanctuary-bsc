...
contract MonkeyChefInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the monkey chef factory
    address public MONKEY_CHEF_FACTORY;
    ...
    constructor() public {
        MONKEY_CHEF_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == MONKEY_CHEF_FACTORY, "Not factory");
