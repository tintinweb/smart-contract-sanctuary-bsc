...
contract BabySilentHillInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Silent Hill Inu";
    string private _symbol = "BSHINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5b78C819b6c0929C40D2fD860ab9B59E7d06BeBe);
