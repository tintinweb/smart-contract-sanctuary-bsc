...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC480a96b31e5427410a554827A4E6fE509Da445d; // owner address
...
contract DejitaruTsuka is Context, IERC20, Ownable {
    ...
    string private _name = "DejitaruTsuka";
    string private _symbol = "DJT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C7EF1B302813FC753FE3244c70FC961Be2d4116); // Marketing Address
    address payable public teamWalletAddress = payable(0xeDf1848Ad962c15417eDbC62a7Cd8B2be9716300); // Team Address
