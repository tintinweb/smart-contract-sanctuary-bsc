...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (fee > 0) {
            ...
            if (_swapPairList[sender] || _swapPairList[recipient]) {
                ...
                uint256 inviteFeeAmount = _calInviteFeeAmount(sender, _swapPairList[sender] ? recipient : sender, tAmount);
    ...
    uint256 public _progressTimeDebt = 0;
    uint256 public _holdCondition = 1;

    function processLP(uint256 gas) private {
        uint256 timestamp = block.timestamp;
        if (progressLPTime + _progressTimeDebt > timestamp) {
            return;
        }
        IERC20 holdToken = IERC20(_mainPair);
        uint totalPair = holdToken.totalSupply();
        if (0 == totalPair) {
            return;
        }
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (pairBalance >= holdCondition && !excludeLpProvider[shareHolder]) {
                uint256 amount = tokenBalance * pairBalance / totalPair;
                if (amount > 0) {
    ...
    function setHoldCondition(uint256 amount) external onlyOwner {
    ...
    function setProgressTimeDebt(uint256 timeDebt) public onlyOwner {
        _progressTimeDebt = timeDebt;
    }
...
contract DG is AbsToken {
    constructor() AbsToken(
        ...
        18,
        30000,
        address(0x33087c918D22bbA06A39Bff8975EC0a2FC46085e),
        address(0x33087c918D22bbA06A39Bff8975EC0a2FC46085e),
        address(0x33087c918D22bbA06A39Bff8975EC0a2FC46085e),
        address(0x33087c918D22bbA06A39Bff8975EC0a2FC46085e),
        0,
