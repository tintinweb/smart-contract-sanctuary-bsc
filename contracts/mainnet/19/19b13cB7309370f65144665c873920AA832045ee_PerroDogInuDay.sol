...
contract PerroDogInuDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xE21b180F09de4AE1582f1d93d0625631Ce9f2221); // Marketing Address
    address payable public devWalletAddress = payable(0x88Af2093687Fd018c784C1E0E8E4646a907B339b); // Dev Address
    ...
    string private _name = "Perro Dog Inu Day";
    string private _symbol = "PerroDogInuDay";
