...
/**
Improve your trading with CandyScan!
Diamond Hands are rewarded with insane BUSD rewards.
Utilities coming soon....

All locked for 6 month:
Marketing Wallet: 0xC179F20b0baf93515F28315Cb5f374b8e5852BA2
NFT Reward Wallet: 0xC22cbC3755003Be2185d57D799132dDc36101F3c
Dev Wallet: 0x2BbE1775eb171Aae321EE34e9e762dFe38357869
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTCB = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
/* Token contract */
contract CandyScan is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2BbE1775eb171Aae321EE34e9e762dFe38357869;
    ...
    // Name and symbol
    string constant _name = " CandyScan";
    string constant _symbol = "SCAN";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10 milionen

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 25 / 10000; // 0.25% (200 k)
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.5% (100 k)
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 10000; // 0.5% (100 k)
    ...
    uint256 public swapThreshold = _totalSupply * 35 / 10000; // .35% of supply
