...
/**
Nvidia AI
Telegram: https://t.me/NvidiaAiBNB
...
abstract contract Contextbep20NvidiaAI {
...
contract Ownablebep20NvidiaAI is Contextbep20NvidiaAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20NvidiaAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20NvidiaAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract NvidiaAIToken  is Contextbep20NvidiaAI, bep20NvidiaAI, Ownablebep20NvidiaAI {
