...
contract PLAND is Context, IERC20, Ownable {
    ...
    address payable public DevelopmentWalletAddress = payable(0xbce51C2D3607e85401d8c5045239D9a25422756A);
    address payable public MarketingWalletAddress = payable(0xa3B936eA9c7620bb775a018071AeF7F773577746);
    ...
    uint256 public _DevelopmentShare = 100;
        ...
        onlyOwner
    {
        ...
        require(_buyLiquidityFee + _buyDevelopmentFee + _buyMarketingFee <= 150, "Must keep taxes below 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellLiquidityFee + _sellDevelopmentFee + _sellMarketingFee <= 150, "Must keep taxes below 25%");
    }
}