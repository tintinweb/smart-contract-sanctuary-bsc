...
contract hamtaromoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "hamtaromoon"; // 
    string private constant _symbol = "hamtaromoon"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x30F88C66eA47d4b0DcBb039db9cfa762EA5A2EF2;
