...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd61E928997BD2CA3bdC7a77113498E0e12C3B24E;
...
contract GREDDYSHIB is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA1E59Fc92D70C3dF135E7463Bf2F092a6bEF2A48;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Greddy Shib";
    string private _symbol = "$GRDSHIB";
