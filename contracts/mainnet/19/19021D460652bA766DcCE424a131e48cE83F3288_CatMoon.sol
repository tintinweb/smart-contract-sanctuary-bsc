...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x1067f78Ee4543E95a0B5b3AA0d6a38f091E41E4e;
        _owner = msgSender;
...
contract CatMoon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**8 * 10**9; // 100 quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _redisFeeOnBuy = 9;
    ...
    address payable private _developmentAddress = payable(0x1D4Ac006fBCc5742fc5Dc139E16dc110a1DA5EB5);
    address payable private _marketingAddress = payable(0x054233DF470Ce48c57447f7a2116d119caF98141);
    
    string private constant _name = "Tiger King";
    string private constant _symbol = "Tiger King";
    ...
    constructor () {
        _rOwned[0x1067f78Ee4543E95a0B5b3AA0d6a38f091E41E4e] = _rTotal;
        ...
        emit Transfer(address(0x0000000000000000000000000000000000000000), 0x1067f78Ee4543E95a0B5b3AA0d6a38f091E41E4e, _tTotal);
    }
