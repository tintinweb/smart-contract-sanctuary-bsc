...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AAA = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AAA.balanceOf(address(this));
        ...
        uint256 amount = AAA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AAA.transfer(shareholder, amount);
...
contract MACBNB is IBEP20, Auth {
    using SafeMath for uint256;

    address AAA = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BNBMAC (t.me/bnbmacbsc)";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x55fac05e088a1f44fA25fe3D5027dAEcF6e96E2e;
