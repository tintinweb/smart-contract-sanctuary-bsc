...
contract BabyKoneko is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyKonekoCoin";
    string constant _symbol = "$BabyKoneko";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3e8F4b8749a17f9345e48135e35CC5721eea1D18;
