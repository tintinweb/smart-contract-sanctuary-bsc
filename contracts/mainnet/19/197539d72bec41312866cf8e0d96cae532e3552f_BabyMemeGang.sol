...
contract BabyMemeGang  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Baby Meme Gang";
    string constant _symbol = "BabyMemeG";
