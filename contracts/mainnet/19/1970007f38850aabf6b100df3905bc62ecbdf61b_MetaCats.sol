...
contract MetaCats is Context, IERC20, Ownable {
    ...
    string private _name = "Msoca";
    string private _symbol = "Msoca";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x496606A2Cc3d524F8038BA0A1D4F7917dE8302d7); // Marketing Address
    address payable public teamWalletAddress = payable(0x496606A2Cc3d524F8038BA0A1D4F7917dE8302d7); // Team Address
