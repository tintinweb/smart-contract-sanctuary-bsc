...
contract EmptyCans is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCBa338b4863B7219c5c0E17a0c203Fe4d09A3460); // Marketing Address
    address payable public teamWalletAddress = payable(0xCBa338b4863B7219c5c0E17a0c203Fe4d09A3460); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x0c822C6edBe3Ae20A956467F3E3c0DA2bCA2a8F9),
            block.timestamp
        );
    }
