...
contract Taptano is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TAPTANO";
    string private _symbol = "Taptano";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4f1E02FA7Df15d291A21473663270288360796f5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC1030ABB481461E5BfbEa18dd61495A72427Dd19); // buyback Address
    ...
    uint256 public _walletMax = 60000 * 10**6 * 10**9;
