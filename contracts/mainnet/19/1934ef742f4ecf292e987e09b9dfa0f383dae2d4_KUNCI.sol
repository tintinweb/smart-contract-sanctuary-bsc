...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Kunci Coin';

    string constant public symbol = 'KUNCI';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 60000000000*10**uint256(decimals);
