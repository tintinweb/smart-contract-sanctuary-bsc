...
contract BARDOCK_INU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bardock Inu"; // 
    string private constant _symbol = "$BardockInu"; //    
