...
/*
HEXAINU (EXINU) is a utility token designed on the Binance smart chain (BEP20). 
Smart Contracts are deployed in bscscan. Contracts are verified and published for all.
*/
...
contract HexaInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xd1CEFeE1055f8C03ef5167E3F59f23fd39Db2521);
