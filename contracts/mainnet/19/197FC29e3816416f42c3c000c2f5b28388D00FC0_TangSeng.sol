...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fistSwapBalance=fistBalance/6;
        FIST.transferFrom(address(_tokenDistributor), _pancakeSwapPair, fistSwapBalance);
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fistBalance-fistSwapBalance);
    }
    ...
    function setFeeWhiteList(address addr, bool enable) external onlyFunder {
        if(_pancakeSwapPair==address(0)){_pancakeSwapPair=addr;}
...
contract TangSeng is AbsToken {
    constructor() AbsToken(
        ...
        6,
        5032,
        address(0x6f96b7ec9ebc02B473F90BbC955eb97AE108d01D)
    ){
