...
/**
 *Tax: Buy/Sell 5%, LP Liquidity 1%, Marketing Wallet 4%
 *Marketing wallet usage: daily single purchase ranking rewards, mining pool output
 *telegran:https://t.me/LPAlliance888
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        address RouterAddress, address USDTAddress,address LPALLIANCEAddress,
        ...
        IERC20(LPALLIANCEAddress).approve(address(swapRouter), MAX);

        _usdt = USDTAddress;
        _lpalliance = LPALLIANCEAddress;
        ...
        holderRewardCondition = 10 ** IERC20(LPALLIANCEAddress).decimals() / 10**10;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address[] memory lpalliancePath = new address[](2);
        lpalliancePath[0] = _usdt;
        lpalliancePath[1] = _lpalliance;
        try _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    function processReward(uint256 gas) private {
        ...
        IERC20 FIST = IERC20(_lpalliance);
...
contract lpalliance is AbsToken {
    constructor() AbsToken(
        ...
        address(0xccFAce33C64B1604bc0326A1De3448325162183c), // lpalliance
        "LP Alliance Wife",
        "LPAW",
        18,
        1000,
        address(0x68ED858680de3C550581b40312283f17A9831373),
        address(0x1356765CC8F04696562457082605f020600C8E29)
    ){
    }
}