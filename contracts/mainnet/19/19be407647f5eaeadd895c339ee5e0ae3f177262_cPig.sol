 ...
 *Submitted for verification at BscScan.com on 2022-05-14
 cPig The New Community BSC Token
    
   #cPig has taken a beat, and millions of investors in crypto got hurt, will you wait for the #BSC slow revival? Or will you join a new #BSC community to give it a second new life?

   #cPig will list on #cPig at 4:45 PM est Wednesday, May 18, 2022, UTC.

   I make this #cPig to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityPigToken
   ...
   Can you make #cPig 10000000X? 

   1% tokens for dev

   My Past Project was BleuFi on Binance Smart Chain
*/
...
contract cPig is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Pig token";
    string private constant _symbol = "cPig";
