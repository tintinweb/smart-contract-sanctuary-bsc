...
contract LUNACLASSICV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "LUNA CLASSIC V2";

    string private _symbol = "LUNCV2";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x54716b8cDeD1248Fb513E3777DE8D1813aF7e0Ac;
