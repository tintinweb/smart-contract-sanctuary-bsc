...
// Telegram : https://t.me/ILovePeopleBSC
...
contract ILOVEPEOPLE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6399dB38109EC072f9145B50FDde9B226A4c2d57); 
    address payable public Wallet_Developer = payable(0x9D8C6Fc2C04f4d473C8a07d0E2521B8D03C9Ba65);
    ...
    string private constant _name = "I LOVE PEOPLE"; 
    ...
    constructor () {
        ...
        _owner = 0x9D8C6Fc2C04f4d473C8a07d0E2521B8D03C9Ba65;
