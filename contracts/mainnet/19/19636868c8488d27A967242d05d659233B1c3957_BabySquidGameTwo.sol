...
contract BabySquidGameTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Squid Game 2.0";
    string private _symbol = "BSQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa554E50ad65983533b914618Cd4d82D558290619); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa554E50ad65983533b914618Cd4d82D558290619); // Team Address
