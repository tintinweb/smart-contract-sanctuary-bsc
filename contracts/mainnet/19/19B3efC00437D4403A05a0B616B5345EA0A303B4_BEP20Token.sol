...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7;
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    string private _name = "OrrUPay";
    string private _symbol = "ORCPay";
    ...
    constructor () public {
        _rOwned[0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7] = _rTotal;
        ...
        _isExcludedFromFee[0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7, _tTotal);
    }
