...
contract CryptoBullsGame is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public LAUNCH_MAX_SUPPLY = 3000;
    ...
    string private BASE_URI = 'https://cryptobulls.tech/collection/';
    ...
    constructor(address launchpad) ERC721("CryptoBullsGame", "CRB") {
        LAUNCHPAD = launchpad;
    }
