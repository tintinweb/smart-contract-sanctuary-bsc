...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _symbol = "Koenigsegg";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x71321f4d116dA99c126A3445E0DAD6aF0B56b48F);
    address payable public teamWalletAddress = payable(0xD20715435faBCF02230C3BD3c217A795246927dc);
