...
TELEGRAM: https://t.me/LynxChainOfficial
*/
...
contract LynxChain is IBEP20, Ownable {
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0x56695C8AD94B5060E7825BA59503e065d77d85f1,
        Dev: 0x56695C8AD94B5060E7825BA59503e065d77d85f1,
        marketing: 0x56695C8AD94B5060E7825BA59503e065d77d85f1
    });
    ...
    uint8 private constant BLACKLIST_BLOCKS = 40; //number of blocks that will be included in auto blacklist
...
///// AUTHORIZED FUNCTIONS /////
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newTeam + newLiquidity + newDev + newmarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newTeam, newLiquidity, newDev, newmarketing, newRewards);
    }
    ...
    function withdrawTeam() external authorized {
        ...
        TeamBalance = 0;
        _sendBnb(_taxWallet.Team, amount);
    } 
...
///// OWNER FUNCTIONS /////  
    ...
    function setTeamWallet(address payable addr) external onlyOwner {
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Team, uint256 Dev, uint256 marketing) {
        return (buybackBalance, TeamBalance, DevBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 TeamSplit = (bnbAmount*_taxRatios.Team) / distributeRatio;
