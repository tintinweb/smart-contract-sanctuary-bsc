    ...
    ReentrancyGuard
{
    ...
    string public constant override name = "Mone Staking";
    string public constant override symbol = "MSTK";
    ...
    constructor(IERC721Enumerable _nftCollection, IERC20 _xpToken) {
    ...
    function transferLockedTokens(IERC20 token, uint256 amount) public onlyOwner {
    ...
    function userStakeInfo(address _user)
        public
        view
        returns (uint256 tokensStaked, uint256 _availableRewards)
    {
