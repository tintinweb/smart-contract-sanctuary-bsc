...
contract FOMOSANTA is IERC20 {
    ...
    string constant private _name = "FOMO SANTA";
    string constant private _symbol = "FSANTA";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xc337dbEED58332D4a59A7FE4B4a4978538F0180f),
        team: payable(0x8A2A425388D8405EbEb136b61beF16841f3E6875),
        development: payable(0x5CbE91bB2C3Bd4c02936Cc857627d228f1a848e6)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable team, address payable development) external onlyOwner {
        require(marketing != address(0) && team != address(0) && development != address(0), "Cannot be zero address.");
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 team, uint16 development) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.development = development;
        _ratios.total = rewards + liquidity + marketing + team + development;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + teamBalance + developmentBalance);
