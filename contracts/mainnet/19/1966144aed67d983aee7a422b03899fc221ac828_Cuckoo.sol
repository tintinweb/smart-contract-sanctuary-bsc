...
contract Cuckoo  is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x5FFd55e3131BF337b862F0a8B9974AfBdfBFA139);
    address payable private _marketingAddress = payable(0x5FFd55e3131BF337b862F0a8B9974AfBdfBFA139);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnSell < 96, "Tax cannot be more than 96.");
