...
contract Altimatum is ERC20, Ownable {
    IDexRouter public constant ROUTER = IDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    uint256 public jackpotShare = 110;
    uint256 public rewardShare = 450;
    uint256 public liquidityShare = 110;
    uint256 public marketingShare = 330;
    ...
    constructor(address marketing) ERC20("Altimatum", "$ALTI") {
