...
contract POPKToken is Context,IERC20,Ownable{
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = "POPKupoon";
    string private _symbol = "POPK";
    
    uint8 private _decimals = 18;
    address payable private marketingWalletAddress = payable(0x260C1d9396Ec4F395761153509981E6136EADe61); // Marketing Address
    address payable public teamWalletAddress = payable(0xc8EA8F84B275dE5621215c0dd221B27DFb432F43); // Team Address
    ...
    constructor (address NewOwner,address recipient,address other){
        ...
        //test net
        // ISwapRouter _swapRouter = ISwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); 

        swapPair = ISwapFactory(_swapRouter.factory())
