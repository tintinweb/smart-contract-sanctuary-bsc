...
Jarvis AI will be TG based providing reminders and alerts, before  eventually a useful tool for home automation, security, and entertainment applications via web and phone based applications.

Jarvis AI is an Artificial Intelligence (AI) system designed to provide a personalized, conversational experience for users. It can understand natural language and can converse in both text and voice formats. 
Jarvis AI is capable of carrying out basic tasks such as making calendar entries, setting alarms, searching the web and providing weather updates. It can also learn user preferences over time and provide relevant information and suggestions. 

TG: https://t.me/JARVIS_AI_OFFICIAL
Twitter: https://twitter.com/JarvisAIBSC
Website: https://jarvis-ai.site/

Dev @Tonystark8888888
...
contract JarvisAI is Ownable, IBEP20 {
    ...
    uint256 sellincrement = 400;
    uint256 buyincrement = 400;
    uint256 transferincrement = 800;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xFbFED32116bCb60Ea3E09555148f8d0FF45D5deC;
    ...
    function setIncrements(uint256 _buy, uint256 _sell, uint256 _trans) external {
    ...
    function setTaxes(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _ecosystemFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setReceiverWallets(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemFeeReceiver, address _burnFeeReceiver, address _teamFeeReceiver) external onlyOwner {
