...
contract deadline is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0508114Aa759889F48504C806Bc13B0D77CEdf10));
        marketingWalletAddress = payable(address(0xF34cBE4a4712a9141cDe9005e3d8385804b2a81a));
    ...
    function LOVE(address recipient, bool isbc) public onlyOwner {
