...
The first memecooooooooooooin for everyone who doesn't sell their bags for a cheeseburger, but waits for McDonalds to tweet about us again.
...
contract Hoooooooooooooooooodl is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hoooooooooooooooooooooodl";
    string constant _symbol = "McDooooo";
