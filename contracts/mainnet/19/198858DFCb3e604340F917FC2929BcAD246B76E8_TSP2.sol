...
contract TSP2 is ERC20 {
    ...
    uint256 public _walletMax = 500 *10**18;
    ...
    constructor() ERC20("the seed of prometheus 2.0", "TSP2") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x857036c884ce0881A05efa0afa05A36352Ba958E);
        marketAddress = address(0x210012d102B0A0519b73117FE3da586C345507d6);
        teamAddress= address(0x7d47e715Df7afBc346d9890b3Cc6aa673690Db47);
    ...
    function _transfer(
        ...
        if((ammPairs[from]  || ammPairs[to]) && swapstatus == false){
            require( from == address(_tokenOwner) || to == address(_tokenOwner),"only _tokenOwner!");
        }
        ...
        if (takeFee) {
            ...
            if(ammPairs[to] ){
                ...
                amount = amount.sub(amount.mul(A).div(100)).sub(amount.mul(1).div(1000));
            }                        
        }
