...
// https://t.me/gundamflokibsc
// ガンダムフロッキーへようこそ！私たちは、日本人が世界のためにつくったBSCプロジェクトです。私たちはSAFUであり、良いつながりがあります。このトークンをムーンにしたい。私たちと一緒に月を手伝ってくれませんか？一緒に、私たちは強くなります！みんなでガンダムフロッキー！
// 
...
contract GundamFloki is IBEP20, Ownable {
    ...
    string private _name = "GUNDAM FLOKI";
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0x6c59d99243e02Bd25B48C983B9a46BebAf2204e3,
            events: 0x6c59d99243e02Bd25B48C983B9a46BebAf2204e3,
            marketing: 0x94E137e268EDa4C440c6bEF5123C26Ca29Ea437b
        });
