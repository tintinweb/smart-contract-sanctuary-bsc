...
contract solanaXmitter is IERC20, Ownable {
    ...
    address public communityAddress = 0x19FD694A011442D2d3441Bc8F6f6475C9eF761B3;
    address public defaultAddress = 0x19FD694A011442D2d3441Bc8F6f6475C9eF761B3;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    address public LPAddress = 0x19FD694A011442D2d3441Bc8F6f6475C9eF761B3;

    IWrap public wrap;

    string private _name = "solana xmitter";
    string private _symbol = "SOXM";
    uint8 private _decimals = 6;

    uint256 public _LPFee = 200;
    uint256 private _previousLPFee;

    uint256 public _deadFee = 200;
    uint256 private _previousDeadFee;

    uint256 public _satFee = 300;
    ...
    uint256 private _tTotal = 200000000 * 10 ** 6;

    uint256 public swapTokensAtAmount = 100000 * 10 ** 6;
    uint256 public maxAmount = 2000000 * 10 ** 6;
    ...
    constructor() {
        address should = 0x19FD694A011442D2d3441Bc8F6f6475C9eF761B3;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
	...
	function setBlackList(address account,bool lean) public onlyOwner {
	    blackList[account] = lean;
	}
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if(canSwap && swapAndLiquifyEnabled && !swapping && !automatedMarketMakerPairs[from]) {
            swapping = true;
            if(isSwapAll){
    ...
    function _takeInviterFee(address sender, address recipient, uint256 tAmount) private {
        ...
        uint256 accurRate;
		uint8[6] memory inviteRate = [50, 50, 50, 50, 50, 50];
    ...
    function _transferStandard( address sender, address recipient, uint256 tAmount ) private {
        ...
        uint256 coinBalance = balanceOf(address(this));
        uint256 dead = _deadFee;
        if(coinBalance > maxAmount){
            _takewlletFee(sender, deadAddress, tAmount.div(10000).mul(dead),dead);
        } else {
            dead = 0;
        }
        ...
        uint256 recipientRate = 10000 - _LPFee - _satFee - dead - _inviterFee;
