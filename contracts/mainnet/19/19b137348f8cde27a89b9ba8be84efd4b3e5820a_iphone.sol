...
contract iphone is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3b0b8e2E6C98845655F30412Ac7f6204C24Da612); 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(marketingWalletAddress, amountBNBMarketing*5/6);
            IWETH( uniswapV2Router.WETH()).deposit{value: amountBNBMarketing/6}();
