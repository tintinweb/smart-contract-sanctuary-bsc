...
contract TunaDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("Tuna Doge Token","TDOGE")  {
        rewardToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;
        _marketingWalletAddress = 0x58fd2Fa93A329907B0fDA1F133Ded02665753122;
        deadWallet = 0xB3175d2191590C74175a02BD314336B1D7531809;

        buyTokenRewardsFee = 4;
        buyLiquidityFee = 3;
        buyMarketingFee = 5;
        buyDeadFee = 1;
        ...
        _node = owner();
        dividendTracker = new TokenDividendTracker(rewardToken, 10000000 * 10**18);
