...
contract BNBBondDepository is Ownable {
    ...
    address public immutable treasury; // mints Kronos when receives principle
    ...
    struct Bond {
        uint payout; // Kronos remaining to be paid
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 Kronos ( underflow protection )
    ...
    /**
     *  @notice calculate current ratio of debt to Kronos supply
     *  @return debtRatio_ uint
     */
    function debtRatio() public view returns ( uint debtRatio_ ) {   
        uint supply = IERC20( Kronos ).totalSupply();
    ...
    /**
     *  @notice calculate amount of Kronos available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or Kronos) to the DAO
     *  @return bool
     */
