...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57C34305FEc04A47DbC66EA1A3E629E4f747a175; // owner address
...
contract Blueishwhaleinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blueish Whale Inu";
    string private _symbol = "BWI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5EEA8C8eE111D6e8BBAb64290eb39910a774F5B0); // Marketing Address
    address payable public teamWalletAddress = payable(0x5EEA8C8eE111D6e8BBAb64290eb39910a774F5B0); // Team Address
