...
contract BURN100BNB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BURN100BNB", "BURN100BNB") {
        ...
        marketingWallet = payable(0x05925a231a6C7F15C536b124384014dD86cEac6d);
        devWallet = payable(0x05925a231a6C7F15C536b124384014dD86cEac6d);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= maxfee, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= maxfee, "Must keep fees at 25% or less");
    }
