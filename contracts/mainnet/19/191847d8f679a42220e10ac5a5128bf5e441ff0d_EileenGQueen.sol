...
contract EileenGQueen is Context, Ownable, IERC20 {
    ...
    string private _name = "EileenGQueen";
    ...
    uint public buyBurnTax = 3;
    uint256 _destroyMaxAmount = _totalSupply.div(10).mul(9);
    uint public denominatorSell = 100;
    uint public sellMarketTax = 3;
    uint public sellBurnTax = 3;
