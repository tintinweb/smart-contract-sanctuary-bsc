...
Telegram: https://t.me/geishaofficial20
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x6d91d2bac11Bb0d1917CE0D509044D9810F0A003;
...
contract GEISHA20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "GEISHA 2.0"; // 
    string private constant _symbol = "$Geisha 2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x6d91d2bac11Bb0d1917CE0D509044D9810F0A003);
