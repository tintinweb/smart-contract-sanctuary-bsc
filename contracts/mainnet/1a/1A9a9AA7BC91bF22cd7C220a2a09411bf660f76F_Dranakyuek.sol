...
contract Dranakyuek is IBEP20, Auth {
    ...
    string constant _name = "Dra'nakyuek Destroyer of Worlds";
    string constant _symbol = "DRA'NAKYUEK";
    ...
    address public marketingFeeReceiver = 0xdf377C5CA60bE2Eff68984b1037CFCcfb81Da7BB;
    ...
    uint256 public swapThreshold = _totalSupply / 5000 * 100; // 0,3.00%
    bool inSwap;
