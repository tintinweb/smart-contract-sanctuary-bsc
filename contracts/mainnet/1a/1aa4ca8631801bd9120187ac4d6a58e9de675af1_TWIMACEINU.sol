...
contract TWIMACEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twimace Inu";
    string private _symbol = "TWIMACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x247949cB5C0A3C1b5d5484d84826e6F14D0aD1b4); 
    address payable public TeamWalletAddress = payable(0xefB27d0744e1eb1D0c9421b0E52923F536A00dDc); 
