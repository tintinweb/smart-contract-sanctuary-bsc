...
contract test is IBEP20, Auth {
    ...
    uint256 public constant TEST = type(uint128).max;
    ...
    uint256 internal busdFee = 2;
    uint256 internal buybackFee = 8;
    uint256 internal totalFee = 10;

    uint256 internal sellliquidityFee = 2;
    uint256 internal sellbusdFee = 1;
    uint256 internal sellbuybackFee = 12;

    uint256 internal feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public buybackFeeReceiver =
        0x6d1E035b8a4cE2aac0261784a7b9635c14861652;
    ...
    constructor() Auth(address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652)) {
        ...
        isFeeExempt[address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652)] = true;
        isTxLimitExempt[address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652)] = _totalSupply;
        emit Transfer(address(0), address(0x6d1E035b8a4cE2aac0261784a7b9635c14861652), _totalSupply);
    }
    ...
    function getTotalFee(bool selling) internal returns (uint256) {
        if (selling) {
            totalFee = sellliquidityFee.add(sellbuybackFee).add(
                sellbusdFee
            );
            return totalFee;
        }
        if (!selling) {
            totalFee = liquidityFee.add(buybackFee).add(busdFee);
            return totalFee;
        }
        return totalFee;
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB
            ...
            .div(totalBNBFee)
            .div(2);
        uint256 amountBNBbusd = amountBNB.mul(busdFee).div(
            totalBNBFee
        );
        ...
        try distributor.deposit{value: amountBNBbusd}() {} catch {}
    ...
    function setSellFees(
        ...
        uint256 _SellbusdFee,
        uint256 _SellbuybackFee,
        uint256 _feeDenominator
    ) external authorized {
        sellliquidityFee = _SellliquidityFee;
        sellbusdFee = _SellbusdFee;
