...
contract ShillMeIn is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 2;  // Liquidity fee 2%
    uint256 private _buyMarketingFee = 0;  // Markting fee 0%
    uint256 private _buyDevFee = 0;  // Dev fee 0% 

    // 2% Sell tax
    uint256 private _sellTaxFee = 0; // Reflection fee 0%
    uint256 private _sellLiquidityFee = 2;  // Liquidity fee 2%
    uint256 private _sellMarketingFee = 0;   // Markting fee 0%
    ...
    constructor() {
        _name = "ShillMeIn"; //  Name
        _symbol = "SHILL"; //  Symbol
        ...
        _marketingWalletAddress = 0x0DA797cCB3e5774B2b35C792a7c235e8dBdC3A92; // Marketing wallet 
    ...
    _isAntiBot[account] = false;
    }

     //Add to AntiBot
    function addToAntiBot(address account) external onlyOwner {
    require(account != owner(),"Owner address can not Antibot");
    _isAntiBot[account] = true;
    }
    ...
    function _transfer(
        ...
        require(!_isAntiBot[from] && !_isAntiBot[to], "This address is Antibot");
