...
contract RatBack is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RatBack";
    string constant _symbol = "RATB";
    ...
    uint256 public _walletMax = 5 * 10**7 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xeeCC7E47be8DF195F82D906F2e1A96Ab2a45Bbb5;
        marketingWallet = 0xeeCC7E47be8DF195F82D906F2e1A96Ab2a45Bbb5;
        devWallet = 0x7872Bd8E794Bb07f26dAAC187E6f8c1E8947f9Af;
