  ...
  IERC721Enumerable
{
  ...
  function tokenByIndex(uint256 index) public view override returns (uint256) {
    require(index != 0, "ERC721A: global index out of bounds");
  ...
  function tokenOfOwnerByIndex(address owner, uint256 index)
    ...
    returns (uint256)
  {
    require(index != 0, "ERC721A: owner index out of bounds");
    ...
    returns (TokenOwnership memory)
  {
    ...
    if (tokenId >= totalSupply()) {
      lowestTokenToCheck = tokenId - totalSupply() + 1;
    }
...
contract VIPPass is Ownable, ERC721A, ReentrancyGuard {
