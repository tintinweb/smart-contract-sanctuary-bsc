...
contract I is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x8B12e98c4698C333a75d802b219A80F2432B7a85);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public receiveReward1Token = address(0xe21E8641C8c74440556D905D01de4156595199a9);
    ...
    constructor() {
        ...
        _symbol = "I";
        _decimals = 4;
        address tokenOwner = 0x8B12e98c4698C333a75d802b219A80F2432B7a85;
        _tTotal = 1100000 * 10**_decimals;
        uint256 leftAmount = 1100000 * 10**_decimals;
