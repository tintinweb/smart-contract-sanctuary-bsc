...
contract Fixt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fixt";
    string private _symbol = "Fixt";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x7b0F21a87644786419f2a34aeb67F7D5DB50adF8);
    address payable public teamWalletAddress = payable(0x7b0F21a87644786419f2a34aeb67F7D5DB50adF8);
