...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPFee = 3000;
    ...
    constructor (
        ...
        maxBuyAmount = 1024000000 * 10** Decimals;
        walletLimit =  1024000000 * 10** Decimals;
...
contract yles is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        1024,//Supply
        address(0xf439A32e10CfDF3036006995AF1abaf583569552),//FundAddress
        address(0xf439A32e10CfDF3036006995AF1abaf583569552)//ReceiveAddress
    ){
