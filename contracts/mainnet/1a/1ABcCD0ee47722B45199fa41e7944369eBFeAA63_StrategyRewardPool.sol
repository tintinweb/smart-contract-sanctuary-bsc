...
// INTERNAL FUNCTIONS
    ...
    function _harvestReward(uint256 amount) internal override  {
...
// PUBLIC VIEW FUNCTIONS
    ...
    function balance() public view returns (uint256) {
        return balanceOfWant() + balanceOf() + (pendingReward() * (MAX_FEE - poolFee) / MAX_FEE);
    }
...
// VIRTUAL
    ...
    function _harvestReward(uint256 amount) internal virtual {}
