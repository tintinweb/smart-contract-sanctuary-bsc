...
contract HaroldCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Harold CEO";
    string private _symbol = "$HEO";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xD512eBBf560A9Fa7f2D387f4c7A8b94eabc6e037;
    address public developerWallet = 0xAbB794FCf457cabEB1289C8dAA1d5343ab36A83b;
