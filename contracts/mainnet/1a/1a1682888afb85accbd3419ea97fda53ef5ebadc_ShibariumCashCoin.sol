...
https://t.me/ShibariumCashToken

 $SHIBCHi is an BEP20 token releasing on the BSC Network. The verified contract will be renounced, 
 and the liquidity will be locked shortly after deployment. Buy/Sell taxes will be elevated prior 
 to the contract being renounced. The taxes will be lowered to 3/2 (2% Tax, 1% LP Burn) afterwards.  
...
contract ShibariumCashCoin is Context, ierc20, Ownable {
    ...
    string private _name = 'Shibarium Cash Coin';
    string private _symbol = 'SHIBCHi';
