...
/*
GoGrow || Plant, Grow & Harvest
A BSC Token with simple, yet fun DApp that will fill your pocket.
TG : https://t.me/GoGrowToken

Simply by buying GoGrow, you are able to use it to buy fertilizer and grow your plant. After your plant grows into a certain level, you are able to harvest the fruit of your plant in the form of BNB.

Other than that, having the token will also gain you GoGrow reflection. Full DApp information will be shared after launch.

Tokenomics:
1) 12% of Tax
2) 3.5% of Max Wallet
3) 1 BNB as Initial LP
*/
...
contract GoGrow is Context, IERC20 { 
    ...
    string private constant _name = "GoGrow"; 
    string private constant _symbol = "GoGrow"; 
