...
// It all started wtih a V shaped chart... 0xVee
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                                                  ^
...
contract VeeCoin is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 22 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name     = "-V+";
    string private constant _symbol   = "0xVee";
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x9c0aA0A3A684937eF783a69eB6F9A445Bc9a3e1B;
        _marketingWallet = 0x3FfB9805A7b532b93012163704255152c709bf1c;
