...
contract SquidHalf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid 0.5";
    string private _symbol = "Squid Half";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xf03FCe97291C605bAFF3e2541a8225F71d963A00); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf03FCe97291C605bAFF3e2541a8225F71d963A00); // BuyBack Address
