...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 210000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xa4d0850610F7b312fc27c352c7fa26d21B2265a8;
...
contract XShenHua is AbsToken {
    constructor() AbsToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
    
        address(0x5a75D88b15cA79E1687C38ce1335168Dd0f5B191),
        "XSH",
        "XSH",
        18,
        ...
        address(0xAB50F2C5E5fD8B872baFCAea60fC6f2D67CEa1a2),
    
        address(0x4F4272Ea66a23a14b4CCd18A23d87635c97e3149)
    ){
