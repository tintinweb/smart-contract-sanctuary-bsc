...
contract SpaceDogKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceDogKing3.0";
    string private _symbol = "SpaceDogKing3.0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xF606Fc49DB755F9142c087890ef355966F4db280); // Marketing Address
    address payable public teamWalletAddress = payable(0xF606Fc49DB755F9142c087890ef355966F4db280); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xF606Fc49DB755F9142c087890ef355966F4db280),
            block.timestamp
        );
    }
