...
contract SLV2 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5797194e9337fBB7933f7c2b3769Ea5C7F103152); // Marketing Address
    address payable private teamWalletAddress = payable(0x5797194e9337fBB7933f7c2b3769Ea5C7F103152); // Team Address
    ...
    uint256 public _walletMax = 2 * 10**3 * 10**6* 10**_decimals;
