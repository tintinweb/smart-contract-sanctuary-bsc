...
Baby Mama Saitama - Gamblers Dog Of Good Fortune!
...
https://t.me/BabyMama_Saitama

NFT Usecase On Its Way! Staking & Lottery! Access to Yuki's Dog House!
...
contract BabyMamaSaitama is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyMamaSaitama';
    string private constant _symbol = '$BMSA';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x2Ea9C66df844862f100B937ca7eDa10dF32Fd5bB);
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==MarketingWallet||addr==TeamWallet;
    }
