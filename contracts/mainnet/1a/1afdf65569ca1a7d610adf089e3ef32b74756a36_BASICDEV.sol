...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52C59F7Ffa5599FFc9bE3432517D0B4637e0706D;
...
contract BASICDEV is Context, IERC20, Ownable {
    ...
    string private constant _name = "BasicDev"; // 
    string private constant _symbol = "BASICDEV"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x52C59F7Ffa5599FFc9bE3432517D0B4637e0706D);
