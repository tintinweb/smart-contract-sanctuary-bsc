 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/WhyTheHeck
 * 
 * 
 * WhyTheHeck token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract WhyTheHeck is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WhyTheHeck";
    string constant _symbol = "WHYTH";
