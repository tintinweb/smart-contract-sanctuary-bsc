...
contract NMAD is Context, IERC20, Ownable {
    ...
    string private _name = "Digital Nomad Coin";
    string private _symbol = "NMAD";
    ...
    address public marketingWallet = 0x7d927D7474001c9a9ae8cDE402eEBEE117f3d2E3;
    ...
    function setSwapTokensForLiquidity(uint256 newAmount) external onlyOwner() {
    ...
    function decreaseFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
