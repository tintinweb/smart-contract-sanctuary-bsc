...
/**
Telegram: https://t.me/qixiwanhui
Website : http://qixiparty.fit/
...
contract QixiParty  is Ownable, IERC20 {
    ...
    uint256 public _maxTxAmount = 950000000 * 10 ** _decimals;

    uint256 public _fee = 5;

    string private _name = " QixiParty ";

    string private _symbol = "QixiParty";
