...
/**
Telegram : https://t.me/HashtagAnal
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4282A2a63F4a494a87BbaF4D0b26142B26b0Adb4; // owner address
...
contract HashtagAnal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "#Anal";
    string private _symbol = "#ANAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4282A2a63F4a494a87BbaF4D0b26142B26b0Adb4); // Marketing Address
    address payable public teamWalletAddress = payable(0x4282A2a63F4a494a87BbaF4D0b26142B26b0Adb4); // Team Address
