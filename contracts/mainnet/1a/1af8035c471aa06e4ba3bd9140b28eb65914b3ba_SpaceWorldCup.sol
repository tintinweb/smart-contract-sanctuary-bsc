...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF077F97fcDcc30ff301d424fc069b394e491E4A1; // owner address
...
contract SpaceWorldCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space World Cup";
    string private _symbol = "SWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6dBAc19571493c2fa1F8C08D9481F764537C5e7); // Marketing Address
    address payable public teamWalletAddress = payable(0xF6dBAc19571493c2fa1F8C08D9481F764537C5e7); // Team Address
