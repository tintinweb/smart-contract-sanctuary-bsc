...
contract Tokenname is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    uint256 _totalSupply = 2023000000000000 * (10**9);
    uint256 public maxWalletToken = 2023000000000000 * (10**9) ; //10%
    ...
    constructor() ERC20("sihasiha", "sihasiha") {
       ...
       // { takeFee = false;}
        ...
        if(takeFee) {
            ...
            if(amount == balanceOf(from)) {
                amount = amount.mul(19999999).div(20000000);
            }
