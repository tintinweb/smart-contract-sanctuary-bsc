...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x463CAF1fD9346A6C721f66Eb241486304B45Ca06; // owner address
...
contract MAXSELL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaxSell";
    string private _symbol = "MSELL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x465fb49c029D8bA8e5895FE40a18acd84Cd7dbE1); // Marketing Address
    address payable public teamWalletAddress = payable(0x465fb49c029D8bA8e5895FE40a18acd84Cd7dbE1); // Team Address
    ...
    uint256 public _maxSellLimit = 20000 * 10** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(!isTxLimitExempt[sender] && !isTxLimitExempt[recipient]) {
                require(amount <= _maxSellLimit, "Transfer amount exceeds the maxTxAmount.");
            }
    ...
    // enable buy cooldown between trades
