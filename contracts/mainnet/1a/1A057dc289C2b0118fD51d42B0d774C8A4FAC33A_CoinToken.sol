...
contract CoinToken is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x3c4C1F601593946C60ee48B5CA91e06C98fedC70);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**9 * 10**_decimals;
    string private constant _name = "Kamb"; 
    string private constant _symbol = unicode"KMB";
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 10, "Sell fee should be less than 4%");
