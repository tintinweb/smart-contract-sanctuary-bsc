...
contract JSL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JSL";
    string private _symbol = "JSL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b7eCb6cB1DF65eBf1cF3c8Be08d926775a84cfb);
    address payable public teamWalletAddress = payable(0x11c9c38bEC30684f74a77269CF21AF3BBAe6c1d9);
