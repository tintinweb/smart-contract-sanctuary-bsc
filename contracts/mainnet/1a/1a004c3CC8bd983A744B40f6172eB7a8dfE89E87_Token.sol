...
contract Token is ERC20, Ownable, ERC20Burnable {
    ...
    uint256 public feeHolder; // fee amount expected to be divided by 1000, 10 feeAmount is 1% fee
    uint256 public feeBurn; // fee amount expected to be divided by 1000, 10 feeBurn is 1% fee to burn
