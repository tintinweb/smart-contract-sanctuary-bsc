...
contract StratX_biswapLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress =
        0x97a68a7949EE30849D273b0c4450314ae26235b1;
    address public constant earnedAddress =
        0xDB20F6A8665432CE895D724b417f77EcAC956550; //bsw
    ...
    address public constant masterchef =
        address(0x97a68a7949EE30849D273b0c4450314ae26235b1);
    ...
    address public constant receiveFee =
        address(0x2b6C058Dd1751658CFDc58c6C06c0B0A2421B234); //

    address public  fundManager = address(0x236dD901D609c296b3187b6296c985638472bf2b);
    address public  fundManager2 = address(0xe588dDd13a8bDBee578eAa7c4Fd9780180b2f10C); 
    ...
    uint256 public controllerFee = 3500;
    uint256 public constant controllerFeeMax = 10000; // 100 = 1%
    uint256 public constant controllerFeeUL = 6000;

    uint256 public buyBackRate = 4800;
    ...
    constructor() public {
        wantAddress = 0x1747AF98EBF0B22d500014c7dd52985d736337d2;
        pid = 0;
    ...
    function earn() public whenNotPaused {
        ...
        IBiswapfarm(masterchef).withdraw(pid, 0);
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(wbnb).safeTransfer(fundManager, fee.mul(50).div(100));
                IERC20(wbnb).safeTransfer(fundManager2, fee.mul(12).div(100));
                IERC20(wbnb).safeTransfer(receiveFee, fee.mul(38).div(100));
