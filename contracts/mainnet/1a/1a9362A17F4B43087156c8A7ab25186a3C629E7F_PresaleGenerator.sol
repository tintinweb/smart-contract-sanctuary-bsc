...
contract PresaleGenerator is Ownable {
    ...
    function createPresale (
      ...
      uint256[12] memory uint_params
        ...
        params.listingRate = uint_params[8];
        params.startTime = uint_params[9];
        params.endTime = uint_params[10];
        params.lockPeriod = uint_params[11];
        ...
        newPresale.init1(_presaleOwner, params.amount, params.tokenPrice, params.minSpendPerBuyer, params.maxSpendPerBuyer, params.hardcap, params.softcap, 
