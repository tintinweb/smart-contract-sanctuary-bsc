...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function newholder(address newOwner) external onlyOwner returns (bool) {
...
contract WUQI is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "WUQI";    
    string public symbol = "WUQI";
    uint8 public decimals = 9;   

   
    uint8 public exchange;
    uint8 public chargefee;   
    ...
    function removefee(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }
    
    function together(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
