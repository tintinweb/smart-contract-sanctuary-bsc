...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7de65e870972B888Afb9eBa0BEA7423b97C57C24; 
...
contract MrKhaby00 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mr.Khaby00";
    string private _symbol = "$KHABY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7de65e870972B888Afb9eBa0BEA7423b97C57C24); // 
    address payable public teamWalletAddress = payable(0x7de65e870972B888Afb9eBa0BEA7423b97C57C24); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x7de65e870972B888Afb9eBa0BEA7423b97C57C24)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x7de65e870972B888Afb9eBa0BEA7423b97C57C24),removeRandom);
}}