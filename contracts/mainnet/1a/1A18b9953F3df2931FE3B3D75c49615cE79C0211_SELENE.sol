...
contract SELENE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAFEMOON PROTECTOR";//
    ...
    //Liquidity Fee Buy
    uint256 private _devFeeBuy = 0;

    //Liquidity Fee Marketing
    uint256 private _marketingFeeBuy = 0;
    ...
    //Sell Fee
    uint256 private _taxFeeOnSell = _liquidityFeeSell + _devFeeSell + _marketingFeeSell;//
    ...
    address payable private _developmentAddress = payable(0x4037d6A0F76Dd144fe55Ca06EE97921981591bf8);//
    address payable private _marketingAddress = payable(0x4037d6A0F76Dd144fe55Ca06EE97921981591bf8);//
    ...
    function setFee(uint256 liquidityFeeBuy, uint256 devFeeBuy, uint256 marketingFeeBuy, uint256 liquidityFeeSell, uint256 devFeeSell, uint256 marketingFeeSell) public onlyOwner {
        ...
        _taxFeeOnBuy = _liquidityFeeBuy + _devFeeBuy + _marketingFeeBuy;
