...
contract SocksToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Socks";
    string private _symbol = "Socks";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDFAFfcc9C69De63d89734e2F25ABcF9C4Ccd5C9d); 
    address payable public BurnedWalletAddress = payable(0xDFAFfcc9C69De63d89734e2F25ABcF9C4Ccd5C9d); 
