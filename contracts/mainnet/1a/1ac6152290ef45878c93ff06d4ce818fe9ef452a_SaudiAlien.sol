...
contract SaudiAlien is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Alien"; // 
    string private constant _symbol = "SA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xcfE28044706cd19d77c5e0D6b1ac52C63dB08944;
