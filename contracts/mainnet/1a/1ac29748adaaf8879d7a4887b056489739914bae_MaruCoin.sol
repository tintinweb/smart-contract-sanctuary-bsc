...
contract MaruCoin is Context, IERC20, Ownable {
    ...
    string private _name = "MaruCoin";
    string private _symbol = "MCoin";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x98F287499d662b7f2888bB466Aec3677baeA4d68); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x09AF0Dcc1991999Ba74bbd2a5C2617b68e8cA535); // buyback Address
    ...
    uint256 public _maxTxAmount = 5000 * 10**9; // 0.1%
    uint256 public _walletMax = 10000 * 10**9; // 2%
