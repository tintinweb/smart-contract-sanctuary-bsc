...
Telegram Chat: https://t.me/Piglet2Go
...
contract Piglet2Go is Context, IERC20, Ownable {
    ...
    string private constant _name = "Piglet2Go"; //
    string private constant _symbol = "$Pig2GO"; //
