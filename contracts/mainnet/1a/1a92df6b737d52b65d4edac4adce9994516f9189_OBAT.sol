...
contract OBAT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "OBAT";
    string private _symbol = "OBAT";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9D8a0E50f2db11A667F62B6ac303378c191a74e2
));
        marketingWalletAddress = payable(address(0x9D8a0E50f2db11A667F62B6ac303378c191a74e2
));
