...
contract FlokiAI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3e13e5D31b1d79Dd754bDf25ce18BC1a562bd00d);
    address payable public BuyBackWalletAddress = payable(0x3e13e5D31b1d79Dd754bDf25ce18BC1a562bd00d);
