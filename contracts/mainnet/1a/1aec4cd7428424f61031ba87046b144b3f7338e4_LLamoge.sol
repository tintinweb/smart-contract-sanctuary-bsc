...
/**
 *Submitted for verification at testnet.bscscan.com/ on 2022-05-02
*/
...
contract LLamoge is IBEP20, Auth { // This is just contract name 
    using SafeMath for uint256;
    ...
    string constant _name = "LLamoge"; // Name for token here
    string constant _symbol = "LLamoge"; // Symbol for token 
    ...
    uint256 public totalFeeSell = 20; //Total Fee can be whatever u want
