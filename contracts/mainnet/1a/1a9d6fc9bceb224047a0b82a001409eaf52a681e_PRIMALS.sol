...
contract PRIMALS is Context, ierc20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 9000000 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'PRIMAL SHIB';
    string private _symbol = 'PRIMALS';
