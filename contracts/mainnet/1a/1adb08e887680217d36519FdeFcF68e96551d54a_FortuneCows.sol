...
contract FortuneCows is Token {
    
     // Configurables
    uint public startTime = 1645812000000; // FRIDAY, February 25, 2022 18:00:00 GMT
    uint public MIN_INVEST_AMOUNT = 10 ether;
    uint public SELL_LIMIT        = 40000 ether; 
    uint public BUSD_DAILYPROFIT  = 50;
    ...
    uint private constant ADV_FEE           = 33;                   
    uint private constant ADV_FEESM         = 34; 
    uint private constant LIMIT_AIRDROP     = 140000 ether;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = 0xaBEbdFd43EbAF5B159969FFABf9A566ea7aF5D6C;                                  
        DEV_2 = 0x4bD41f99e7D05dd59Ca73C3eDeF38bfD8900D98D; 
        _mint(msg.sender, 2e4 ether);
        _mint(DEV_1, 2e4 ether);
        _mint(DEV_2, 2e4 ether);  
    }       
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > startTime);                // FRIDAY, February 25, 2022 18:00:00 GMT
