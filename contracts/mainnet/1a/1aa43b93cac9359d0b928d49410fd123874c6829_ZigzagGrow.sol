...
Telegram: https://t.me/ZigzagGrow

🎢 ZIGZAG GROW - is a new gem on BSC. Low tax(2/2), renounced ownership and locked liquidity. 

Everyone knows that zigzag indicator is the main sign of a growth. 
〰️ZIGZAG Grow combine grow hype + Zigzag that is a bullish sign on it's own.
...
contract ZigzagGrow is Ownable {
    constructor(
        string memory _NAME,
