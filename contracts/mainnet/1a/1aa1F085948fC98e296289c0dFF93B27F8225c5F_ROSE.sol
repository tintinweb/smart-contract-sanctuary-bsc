...
contract ROSE is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe2456bAE5df5a2519DF8D58102C627C787063676);
    address payable private _marketingAddress = payable(0xe2456bAE5df5a2519DF8D58102C627C787063676);
    
    string private constant _name = "ROSEKING";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 99, "Tax cannot be more than 100.");
	    require(taxFeeOnSell < 99, "Tax cannot be more than 100.");
