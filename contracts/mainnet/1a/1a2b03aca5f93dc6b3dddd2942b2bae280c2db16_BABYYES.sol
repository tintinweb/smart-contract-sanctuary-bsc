...
contract BABYYES is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY YES";
    string private constant _symbol = "BABYYES";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 9640000 * 10**6 * 10**6;
