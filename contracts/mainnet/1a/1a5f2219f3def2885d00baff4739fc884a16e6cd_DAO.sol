...
contract DAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0xb3Eea72BF2c506CD279a6dF1C7495D9f10A69406;
    address public receiveSellFeeWallet = 0xA7A29a5E63370A512532A4fd295c60EA79ddA5e7;
    IWrap public wrap = IWrap(0xAE598b8F35DBb98CE18De10AE7c40BF1EBA70B99);
    IERC20 public usdt = IERC20(0x30CC843668A9cA20Eb41E4a18CC7554Db55cdb34);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("DAO", "DAO", 8, 1000000 * 10 ** 8){
        address msgSender = _msgSender();
