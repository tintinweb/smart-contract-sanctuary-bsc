...
// TELEGRAM : https://t.me/italyofficialBSC
...
contract ITALYCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ITALY";
    string private _symbol = "$ITY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA3F972d4fFB52695402dC29E286D64F610266036); // MARKETING Address
    address payable public teamWalletAddress = payable(0xA3F972d4fFB52695402dC29E286D64F610266036); // BUYBACK Address
