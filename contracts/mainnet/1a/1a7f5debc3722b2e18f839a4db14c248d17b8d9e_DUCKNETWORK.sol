...
contract ERC20 is IERC20 {
    ...
    address busd = 0xfA75692e171fe75BcA9D8B2150f4831E30269312; // live busd
...
contract DUCKNETWORK is Token {
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x783750c0f371dC2eFa01BC69B2864baEC1C9c0e5;  // N
        ADV_1 = 0x4E5941C9f781AE7d3681654FB6490Ed6cfd67Cd5;  // 0         
        ADV_2 = 0xc72F8e6eC441A35ECE011E89c2e11f4C057af562;  // E        
        ADV_3 = 0xD0FaD5C0A74B46d2B092aAf8d803dF3C0d9293EF;  // o     
        FIN_1 = 0x526FaC03aa09Ca90F4fcA90522a494fb5CD6a25E;  // S   
        MAR_1 = 0x5688505fDAdE96A5DD8fEBE60F0E5358a06E6d2d;  // DESB      
