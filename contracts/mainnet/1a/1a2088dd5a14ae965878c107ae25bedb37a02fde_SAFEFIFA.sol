...
contract SAFEFIFA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safefifa";
    string private _symbol = "$SFA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5C12Ef8fE78AFa660ab7a0ABA3D5E57A026DB0A6); // Marketing Address
    address payable public teamWalletAddress = payable(0x5C12Ef8fE78AFa660ab7a0ABA3D5E57A026DB0A6); // Team Address
