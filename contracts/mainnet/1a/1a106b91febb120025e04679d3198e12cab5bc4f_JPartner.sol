...
contract JPartner is Auth {
    ...
    function setInfo(string calldata _telegram, string calldata _chart, string calldata _twitter, string calldata _website, string calldata _description, string calldata _picture)
        external
        onlyAuthorized
    {
        telegram = _telegram;
    ...
    function getInfo() external view returns (string memory, string memory, string memory, string memory, string memory, string memory) {
        return (telegram, chart, twitter, website, description, picture);
    }
}