...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setkillMulti(bool status) public onlyOwner{
        killMulti = status;
    }
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                //
                if (_swapPairList[from] && block.number < goMoonBlock + 100 && killMulti){
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1314,
        address(0xb50741A22F90031258772C0ca26bF4461C87422A),
        address(0xeAC91df1580041b9772c74a1F99335B6A41Ebc06)
    ){
    }
}