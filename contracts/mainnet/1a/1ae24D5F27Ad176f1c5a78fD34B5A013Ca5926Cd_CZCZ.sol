...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x084eF7009C72fe5E5B34b4fCFA92a22f23e88888; // owner address
...
contract CZCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZCZ";
    string private _symbol = "CZCZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83FCc0Ca8A210f3Ced308A3c2CC1134Dded7362c); // Marketing Address
    address payable public teamWalletAddress = payable(0x605D351a952C19e113F38A504818FA501aFdA09E); // Team Address
