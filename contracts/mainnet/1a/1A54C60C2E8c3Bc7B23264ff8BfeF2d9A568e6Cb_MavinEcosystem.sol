...
/**
  *1st memecoin built by Marvin Inu Ecosystem
...
contract MavinEcosystem is IBEP20, Auth {
    ...
    string constant _name = "Marvin GT";
    string constant _symbol = "MARVINGT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 100000000 * 10**_decimals;
