...
contract CloudShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CloudShiba";
    string private _symbol = "$CSHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27E3F1f2E65005Abb0e8e45d982E29bB056BE7B6); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x27E3F1f2E65005Abb0e8e45d982E29bB056BE7B6); // Team Address
