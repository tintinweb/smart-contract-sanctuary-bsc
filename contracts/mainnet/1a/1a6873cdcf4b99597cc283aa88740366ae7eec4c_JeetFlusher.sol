...
contract  JeetFlusher is Context, IERC20, Ownable {
    ...
    string private _symbol = "JFH";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xb47910795B2A0ebF469e537671F354ebD7733850);
    address payable public teamWalletAddress = payable(0xF36ec9cC048eA3C618DE9aABE56a78Dde81B0661); 
