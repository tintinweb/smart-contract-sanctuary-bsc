...
contract EthAll is Context, IERC20, Ownable {
    ...
    string private constant _name = "ETH CHAIN ALL BEST ICO"; // 
    string private constant _symbol = "ETHALLBI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xf6BC4b5B6AB582cDaB0993Cc43cf9f3b3102b73f;
