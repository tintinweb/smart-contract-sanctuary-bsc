 ...
 * 3RCrypto + Safuu Protocol = EverSAFU Dual Reward with BUSD Dividend
 * TripleR Token
 * First Dual Reward with Auto-Staking, Auto-Compounding & BUSD Reflection
 *
 * Website : 3rcrypto.com
 * Whitepaper : docs.3rcrypto.com
 * Twitter : twitter.com/3Rcrypto
 * Telegram : t.me/crypto3r
 */
...
contract TripleR is ERC20Detailed, Ownable {
    ...
    uint256 public tripleRDividendFee = 80;
    ...
    function takeFee(
        ...
        uint256 _tripleRDividendFee = tripleRDividendFee;
        uint256 _sell = 10;

        if (recipient == pair) {
            _totalFee = totalFee.add(sellFee);
            _treasuryFee = treasuryFee.add(_sell);
            _tripleRDividendFee = tripleRDividendFee.add(_sell);
        }
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(_tripleRDividendFee))
        );
