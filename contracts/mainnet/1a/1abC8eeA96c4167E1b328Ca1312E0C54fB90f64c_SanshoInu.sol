...
contract SanshoInu is Context, IERC20, Ownable {
    ...
    string private _name = "Sansho Inu";
    string private _symbol = "SANSHO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCee6a3A3BdA8dB7a5315ba621B2322FA4F274389); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xCee6a3A3BdA8dB7a5315ba621B2322FA4F274389); // Team Address
