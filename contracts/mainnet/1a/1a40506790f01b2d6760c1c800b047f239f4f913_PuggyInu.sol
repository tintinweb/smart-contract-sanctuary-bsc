...
telegram: https://t.me/Puggyinuportal
...
/* Token contract */
contract PuggyInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x468de3338218cFD7b94D1679131687AA77eC5435;
    ...
    // Name and symbol
    string constant _name = "Puggy Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% (50 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% (50 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% (50 mil)
