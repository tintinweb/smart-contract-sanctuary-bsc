...
contract Unicorn is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2e3 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 5;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x10d0037289eD7D7f6f88947A1FA8590a027043c9;
    ...
    constructor() BEP20("Unicorn 2023 Token", "U2T") {
        _tokengeneration(msg.sender, 2e6 * 10**decimals());
