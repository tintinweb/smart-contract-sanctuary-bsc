...
contract ProsperityGemMining is Context, Ownable {
    ...
    function Deposit(address _upline, uint256 amount) external {
        require(amount >= 1 ether, "Minimum Deposit is 1 USDT!");
    ...
    function Reinvest() external {   
        ...
        require(player.dividends >= 1 ether, "Minimum reinvest is 1 USDT.");
    ...
    function Payout() external {      
        ...
        require(player.dividends >= 1 ether, "Minimum payout is 1 USDT.");
