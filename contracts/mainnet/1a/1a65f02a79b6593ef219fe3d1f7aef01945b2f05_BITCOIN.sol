...
/**
   B!TCO!N The New Community of Ape Token
    
   I make this  INUBurn  to hand it over to the community.
   I suggest a Telegram group name for you to create:  B!TCO!N is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
I will lock the pool for 5 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..

   Can we make  B!TCO!N 100X ?
*/
...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "B!TCO!N BURN !!!";
