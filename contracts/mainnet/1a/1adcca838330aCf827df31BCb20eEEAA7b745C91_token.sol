...
contract token is ERC20 {
    ...
    uint256 public bmarketFee = 25;
    uint256 public bliquidFee = 25;

    uint256 public smarketFee = 25;
    uint256 public sliquidFee = 25;
    
    uint256 public transferFee = 300;

    address public burnAddress = address(0xdead);
    address public liquidAddress = 0x71633AA98A9E533eaFce8f38b511Dd7a1946529A;
    address public marketAddress = 0x2DC0c3ede65dcCDf89b5b29Df3eF9bC0885d3A8D;

    uint256 public liquidCount;
    uint256 public marketCount;

    string internal tokenName = "1413191";
    string internal tokenSymbol = "1413191";
    uint256 constant total  =  1413191 * 10**18;
    ...
    function setBuyFee( uint256 _liquidFee, uint256 _marketFee) public onlyOwner {
        bliquidFee = _liquidFee;
        bmarketFee = _marketFee;
    }

    function setSellFee(uint256 _liquidFee, uint256 _marketFee) public onlyOwner {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair ){
            if(startTime.add(1800) > block.timestamp && !_isExcludedFromFees[to]){
                require(balanceOf(to).add(amount) <= 3000 * 10**18, "amount exceeds max limit");  
            }         
        }
