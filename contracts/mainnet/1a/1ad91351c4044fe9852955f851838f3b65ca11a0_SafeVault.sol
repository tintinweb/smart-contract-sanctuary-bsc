...
contract SafeVault is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 155000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SafeVault";
    string private _symbol = "SFVLT";
    ...
    address payable public marketingWallet = payable(0x619ae10D1188D810F03d1d707E4eb7227431CeC8);
