...
/**
 *                
 *          Check out the tg for more info!!!        
 *      Fees on Buy: 12%   Sell:12% 
 *                          
 *      https://t.me/McYeOfficial
 *         
 * 
*/         
...
contract McYeWest is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MCYE West";
    string constant _symbol = "McYe";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x0BfAb9DE5b0C0c9a002fEE4c7cE123078a7f7253;
