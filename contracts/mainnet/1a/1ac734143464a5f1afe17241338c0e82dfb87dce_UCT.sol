...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7DE37DaBd484DFC2c4c37DB944438b5b3C0802b7;
...
contract UCT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2bA9f673a74C63A87A0Eb1dfE94C1eeA7db73B94;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 9000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "UXCORD TOKEN";
    string private _symbol = "UCT";
    ...
    uint256 public _maxTxAmount = 9000000000 * 10**18;
