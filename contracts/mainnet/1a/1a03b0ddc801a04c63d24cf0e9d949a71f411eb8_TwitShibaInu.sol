...
contract TwitShibaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Twit Shiba Inu";
    string private _symbol = "TSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95E0EF2e802Eaa0D95098A8363259a3C463EeA58);
    address payable public teamWalletAddress = payable(0x95E0EF2e802Eaa0D95098A8363259a3C463EeA58);
