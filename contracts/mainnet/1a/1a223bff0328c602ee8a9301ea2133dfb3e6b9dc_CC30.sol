...
contract CC30 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingAddress = 0x1183D323f0F81eaEB2905aEDdEF11515b51c76aE;
    ...
    constructor() ERC20("CC30", "CC30") {
        uint256 totalSupply = 800000 * (10**18);
    ...
    function takeSellFee(address from, uint256 amount) private returns (uint256 amountAfter) {
        ...
        if (burnFee > 0) super._transfer(from, deadWallet, burnFee);
