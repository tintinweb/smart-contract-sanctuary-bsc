...
contract teenagemutantninjadoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x26Dc423317a35d8E2b58a06E9E0d603ddd38F68c); 
    address payable private Wallet_Dev = payable(0x26Dc423317a35d8E2b58a06E9E0d603ddd38F68c);
    ...
    string private constant _name = "Teenage Mutant Ninja Doge"; 
    string private constant _symbol = unicode"$TMND"; 
