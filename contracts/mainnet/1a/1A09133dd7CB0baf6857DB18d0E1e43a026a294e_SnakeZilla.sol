...
contract SnakeZilla
 is Context, IERC20, Ownable {
    ...
    string private _name = "SnakeZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd453F959b92102D102C230751B8ca7eB8C59b827));
        _ketmatwallet = payable(address(0xd453F959b92102D102C230751B8ca7eB8C59b827));
