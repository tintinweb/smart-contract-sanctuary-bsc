...
/* slopecoin.org Binance launch Pad- BNB Reward Token

website: https://slopecoin.org
Listing 1 SPC = 1.2 USD
...
contract SPC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA05D4c0231637AF52Ad6C8188650f5bb3459Aa5A); // Marketing Address
    address payable public charityAddress = payable(0xA05D4c0231637AF52Ad6C8188650f5bb3459Aa5A); // Charity/Dev Address
    ...
    string private _name = "Slope Coin";
