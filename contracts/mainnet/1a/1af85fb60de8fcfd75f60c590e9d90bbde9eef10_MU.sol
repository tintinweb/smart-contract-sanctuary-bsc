...
contract MU is ERC20 {
	...
	address payable _receive = payable(address(0xfF745e5E157f4EbE3aE2DC0295B50f3376C200F4));
    ...
    constructor(address tokenOwner) ERC20("Miracle Universe", "MU1") {
