...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x8d8a42ebbf161d612203400397ad1bfd4016441fc0f69f6f698e6b96ced454d2 is returned
...
contract Oogear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oogear";
    string private _symbol = "OG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66C02DEB90Ca2855e326e76143fBd66535FA0E59); 
    address payable public buyBackWalletAddress = payable(0xBA5DCAB99fF6f7943c55c8230560e15C8773A274); 
