...
contract Goros is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC3e5636F0feE2C98E1d340b731fB3eE17065114c;
    address public StakingPool = 0x3179D3875bc3d1eeA154d36b5CE2965AA1559752;
    address public DappRewardsPool = 0xc1a70314AD873134f16BE9736354a23b7F21680b;

    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);

    string private constant _name = "Goros";
    string private constant _symbol = "Goros";
    ...
    uint256 totalBuyFee = 10;
    uint256 totalSellFee = 10;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        swapTokensForUsdt(toSwap);

        uint256 deltaBalance = address(this).balance - initialBalance;
        uint256 unitBalance= deltaBalance / (denominator - temp.liquidity);
        uint256 usdtToAddLiquidityWith = unitBalance * temp.liquidity;

        if(usdtToAddLiquidityWith > 0){
            // Add liquidity to pancake
            addLiquidity(tokensToAddLiquidityWith, usdtToAddLiquidityWith);
        }
