...
contract TokenRewardAllReferrer is ERC20, Ownable, BaseToken {
    ...
    constructor() payable ERC20(name_, symbol_) {
        ...
        excludeFromFees(0x3E5BA2d476f0E5782a9265685B5137f942A9cC4c, true);
        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _mint(0x3E5BA2d476f0E5782a9265685B5137f942A9cC4c, totalSupply_);

        emit TokenCreated(0x3E5BA2d476f0E5782a9265685B5137f942A9cC4c, address(this), TokenType.baby, VERSION);
