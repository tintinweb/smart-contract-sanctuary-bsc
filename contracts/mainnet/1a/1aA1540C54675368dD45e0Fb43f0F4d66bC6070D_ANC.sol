...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ANC(uint256 amount) public onlyOwner {
    ANC(msg.sender, amount);
    }
    ...
    function ANC(address account, uint256 amount) internal virtual {
...
contract ANC is ERC20 {
    ...
    uint tokenTotalSupply = 100000000; //   Anchor Network ANC
    
    constructor() public ERC20("Anchor Network", "ANC") {
        ANC(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}