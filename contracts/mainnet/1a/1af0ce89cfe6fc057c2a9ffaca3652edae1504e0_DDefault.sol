...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Giga Berlin";
    string private _symbol = "GB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6Cf0263fe4b2b768d5038a75fBA3BfBb9B55A274); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6Cf0263fe4b2b768d5038a75fBA3BfBb9B55A274); // BuyBack Address
    ...
    uint256 private _totalSupply = 2100 * 10**4 * 10**9;
    uint256 public _maxTxAmount = 42 * 10**4 * 10**9;
    uint256 public _walletMax = 42 * 10**4 * 10**9;
