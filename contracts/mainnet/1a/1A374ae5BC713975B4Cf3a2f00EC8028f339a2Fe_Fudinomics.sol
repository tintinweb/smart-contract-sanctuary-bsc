...
/* Token contract */
contract Fudinomics  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x58D062998F5caeab1905a0722F4c5944c58E02a2;
    ...
    // Name and symbol
    string constant _name = "Fudinomics";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (20 mill)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (10 mill)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (20 mill)
