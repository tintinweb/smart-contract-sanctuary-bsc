...
contract NFTStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xd633BFcAB889C4A50b6256Bd4c4ebF1E55114B1f); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [200, 300, 400, 500];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 100000000000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
