...
contract FirstHacker is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FirstHacker";
    string private _symbol = "FirstHacker";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xEB65f9284b844fc71880473Eb1b96007e405916a); 
    address payable public ttWal = payable(0xEB65f9284b844fc71880473Eb1b96007e405916a); 
