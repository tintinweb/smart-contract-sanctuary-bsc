...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0dd2388F57050970fEEf8a849bb741F0A0fd5CF6; 
...
contract ShiboruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiboru Inu";
    string private _symbol = "$shiboru";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dd2388F57050970fEEf8a849bb741F0A0fd5CF6); // 
    address payable public teamWalletAddress = payable(0x0dd2388F57050970fEEf8a849bb741F0A0fd5CF6); // 
