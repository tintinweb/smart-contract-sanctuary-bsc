...
contract MoonLaunch is ERC20, Ownable {
    ...
    event UpdateBuyFees(uint256 liquidityFeeOnBuy, uint256 devFeeOnBuy);
    event UpdateSellFees(uint256 liquidityFeeOnSell, uint256 devFeeOnSell);
    ...
    constructor () ERC20("Moon Launch 1.0", "MOONLAUNCH01") 
    {   
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + devFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + devFeeOnSell;

        walletToWalletTransferFee = 0;

        devWallet       = 0x18338D06B13C1F79F046D21DD9DB569fd2eF7E6A;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _devFeeOnBuy ) external onlyOwner {
        liquidityFeeOnBuy = _liquidityFeeOnBuy;
        devFeeOnBuy       = _devFeeOnBuy;

        _totalFeesOnBuy   = liquidityFeeOnBuy + devFeeOnBuy;

        require(_totalFeesOnBuy + _totalFeesOnSell <= 9, "Total Fees cannot be more than 9%");

        emit UpdateBuyFees(liquidityFeeOnBuy, devFeeOnBuy);
    }

    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _devFeeOnSell) external onlyOwner {
        ...
        emit UpdateSellFees(liquidityFeeOnSell, devFeeOnSell);
    }
