...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xD0765CFd57780E359f15a40d15F74f22d96b8C58;
...
contract DZDcoin is AbsToken {
    constructor() AbsToken(
        ...
        9,
        5200,
        address(0x6Be11Ac951961776Aeb671a17A7FEA404C500437),
        address(0x9521d8443eD42dA6D155aA3BEDBa62CEe92C9439)
    ){
