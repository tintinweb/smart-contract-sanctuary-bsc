...
/**
      Telegram - https://t.me/squidgronomics_bsc
...
contract SquidGroNomics is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address constant SquidGrow = 0x88479186BAC914E4313389a64881F5ed0153C765;
    ...
    string constant _name = "SquidGroNomics";
    string constant _symbol = "SQUIG";
    ...
    address public marketingFeeReceiver =
        0xf0cB6E1FF681F35319A5aF3695CCA25B256ed117;
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched for tst");
