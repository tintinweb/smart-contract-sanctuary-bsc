...
abstract contract AbsToken is IERC20, Ownable {
    ...
    TokenDistributor immutable public _tokenDistributor;
    ...
    constructor (
        ...
        holderCondition = 266 * tokenUnit;
        uint256 dividendTokenUnit = 10 ** IERC20(DividendToken).decimals();
        holderRewardCondition = 1 * dividendTokenUnit;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                ...
                swapFeeAmount = tAmount * (_buyHolderDividendFee + _buyLPFee) / 10000;
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                fundFeeAmount = tAmount * _sellFundFee / 10000;
                swapFeeAmount = tAmount * (_sellHolderDividendFee + _sellLPFee) / 10000;
            } else {//Transfer
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = holderDividendFee + lpFee;
        totalFee += totalFee;
        ...
        uint256 dividendUsdt = usdtBalance - lpUsdt;
        if (dividendUsdt > 0) {
            path[0] = usdt;
...
contract GSSDAO is AbsToken {
    ...
    //DividendToken
        address(0x8185f8242d76cfD8aFe02955Bd42C32411737777),
    //Name
        "GSSDAO",
    //Symbol
        "GSSDAO",
    ...
    //Total
        88888,
    //Fund
        address(0x67eB6db84880A99bF5d959a6E2Ea1BB9a471a541),
    //Received
        address(0x49098D609fACb9ad1BE5D2C0ff4934D312A35f29)
    ){
