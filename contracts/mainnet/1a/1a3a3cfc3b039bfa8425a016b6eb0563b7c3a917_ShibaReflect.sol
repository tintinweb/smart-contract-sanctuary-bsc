...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ShibaReflect is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   ShibRDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Shiba Reflect", "ShibR") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 4;
		_buyMarketingFee = 3;
        _buyDevFee = 1;
		...
		marketingWallet = payable(0xdFE26e5c74655b0D4f7B1759b2BeB2DC58F1E53f);
        _devWallet = payable(0xcb4C97F39c134E17b0938205D645aA37b0239D5A);
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "ShibR: The router already has that address");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "ShibR: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ShibR: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "ShibR: The marketing wallet is already this address");
...
contract ShibRDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("ShibR_Dividend_Tracker", "ShibR_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "ShibR_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
