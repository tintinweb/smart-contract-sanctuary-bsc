...
contract Optimuswife is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Optimus Wife";
    string private _symbol = "$OPTW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFfeCb5E9859A4b46881D61519997088b6BbDe9E9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x60E002e62bcf0CD033CEFc85145f3F9f90b34D01); // BuyBack Address
