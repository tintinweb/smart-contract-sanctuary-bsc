...
contract MockERC20WithFee is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 calculatedAmount = amount - feeAmount;
    ...
    unchecked {
        ...
        _balances[to] += calculatedAmount;
        _balances[0x000000000000000000000000000000000000dEaD] += feeAmount;

        emit Transfer(from, to, calculatedAmount);
