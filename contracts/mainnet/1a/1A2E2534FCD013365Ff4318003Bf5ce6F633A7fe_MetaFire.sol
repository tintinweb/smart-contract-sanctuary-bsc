...
/*
MetaFire
TG : https://t.me/MetaFireEssential

BSC essential token with auto burn feature, MetaFire will launch soon! Every week, smart contract will burn MetaFire token based on the transaction volume until the supply reached 50% from its original total supply. MetaFire will go farther & pump high after having a limited amount of supply.

1) 1 Trillion of Supply
2) 9% of Tax Fees 
3) Starting with 1 BNB

Fair launch soon, contract to be announce.
*/
...
contract MetaFire is Context, IERC20 { 
    ...
    string private constant _name = "MetaFire"; 
    string private constant _symbol = "MetaFire"; 
