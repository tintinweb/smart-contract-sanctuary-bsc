...
contract KengKing is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 11000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 11000000000000 * 10**_decimals; 
    uint256 public _walletMax = 11000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 11000000 * 10**_decimals; 
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x402ac891E856bb299Ed124e642f7b6059C9FAc07));
        ruinWalletAddress = payable(address(0x402ac891E856bb299Ed124e642f7b6059C9FAc07));
        _name = coinName;
       _symbol = coinSymbol;
