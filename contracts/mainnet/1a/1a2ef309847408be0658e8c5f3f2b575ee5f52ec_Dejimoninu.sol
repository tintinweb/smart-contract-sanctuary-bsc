...
https://t.me/dejimoninu
https://dejimoninu.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x00EEA589be9B8DbDc68AF7485c58A4e5f73A6C57; 
...
contract Dejimoninu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dejimon Inu";
    string private _symbol = "DEJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00EEA589be9B8DbDc68AF7485c58A4e5f73A6C57); 
    address payable public teamWalletAddress = payable(0x00EEA589be9B8DbDc68AF7485c58A4e5f73A6C57); 
    ...
    uint256 private _totalSupply = 1997 * 10**_decimals;
    uint256 public _maxTxAmount = 53 * 10**_decimals; 
    uint256 public _walletMax = 53 * 10**_decimals;
