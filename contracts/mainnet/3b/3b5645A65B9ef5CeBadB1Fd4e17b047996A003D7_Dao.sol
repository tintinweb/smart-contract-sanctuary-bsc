...
contract Dao {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x76B2EaaB9B5Fb0c93639fF040D6F9A6933028Ff5);
        validTokens = [0x76B2EaaB9B5Fb0c93639fF040D6F9A6933028Ff5_abcd];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote) public {
        require(checkProposalEligibility(msg.sender), "Only Holders can create proposals");
