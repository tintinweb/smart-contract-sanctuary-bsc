...
contract METABANK is Context, IERC20, Ownable {
    ...
    string private _name = unicode"META🚀BANK";
    string private _symbol = unicode"META🚀BANK";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x082Bf3C634f34CF4Df538745acd0fB55a9535a7B));
