...
contract RastaFloki is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"RastaFloki"; ////
    string public constant symbol = unicode"RastaFloki"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTradeAmount = 2000000000000000 * 10**9; // .5% for first 2 minutes after launch
