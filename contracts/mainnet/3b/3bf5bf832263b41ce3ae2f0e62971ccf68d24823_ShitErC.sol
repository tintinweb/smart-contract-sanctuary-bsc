...
contract ShitErC is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShitErC";
    string private constant _symbol = "SHERC";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x435756a1Cd96A37673538930c86Aa2d2172af31e);
        _feeAddrWallet2 = payable(0x7D3bef28D3E9cb9891101450ce2294D3C3032935);
        _buyTax = 20;
        _sellTax = 5;
        ...
        emit Transfer(address(0x84B1Cb06200e9bF50E9C94dbaE9d62694C9500Ef), _msgSender(), _tTotal);
    }
