...
contract SHIBAVINE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Vine";
    string private _symbol = "SHIBV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e7C2133FD1Bf0F23f66bFA463CaDb5B8A816eca); // Marketing Address
    address payable public teamWalletAddress = payable(0x5e7C2133FD1Bf0F23f66bFA463CaDb5B8A816eca); // Team Address
