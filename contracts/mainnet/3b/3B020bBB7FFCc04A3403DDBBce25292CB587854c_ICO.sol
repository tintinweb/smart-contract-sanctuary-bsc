...
contract ICO is Ownable{
    ...
    constructor(address _stakingToken,address _stakingFromToken,address addr) payable {
    ...
    function _buy(address sender, uint256 amount) internal {
        ...
        uint256 tokens = (amount * ratePerToken)  / div;

        stakingToken.transfer(sender, tokens);
