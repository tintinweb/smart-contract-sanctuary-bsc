...
// File: SpookyDalmatian.sol

pragma solidity ^0.8.10;

contract SpookyDalmatian is Context, IERC20, Ownable {
    ...
    string internal constant _name = "Spooky Dalmatian";
    string internal constant _symbol = "$SD";
    ...
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9; // 10% Of the supply
    uint256 public numTokensSellToGetBnb = 2 * 10**6 * 10**9; //2000000 Tokens
    ...
    constructor() {
        ...
        _isExcluded[address(0x99947dC46978e50000ACE0c79130d1C5A39E466f)] = true;
