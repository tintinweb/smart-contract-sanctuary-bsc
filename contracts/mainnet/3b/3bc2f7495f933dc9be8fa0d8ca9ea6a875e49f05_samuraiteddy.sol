...
/*
Teddy Hype,Samurai Teddy  will follow Teddy successful. 
Samurai Teddy  is the leader of greatest meme token in 
BSC with huge plan and funds in team wallet. 
Dont missed another successful meme token in BSC

Telegram : https://t.me/SamuraiTeddy
*/
...
contract samuraiteddy is Context, IERC20, Ownable {
    ...
    string private constant _name = "SamuraiTeddy"; // 
    string private constant _symbol = "$STEDDY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xFf7818497f3bE56C1b94d96a96e9c700dB4D49df;
