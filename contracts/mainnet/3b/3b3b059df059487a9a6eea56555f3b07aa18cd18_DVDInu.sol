...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa17033636075eC78c0455E684fd4b850C2048C39; // owner address
...
contract DVDInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DVD Inu";
    string private _symbol = "DVDINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46A85315D28404fBda177aA5a69B9b21ddF8221b); // Marketing Address
    address payable public teamWalletAddress = payable(0xa630a348614dA2fBb3cee470C4dFF34E8c879a5f); // Team Address
