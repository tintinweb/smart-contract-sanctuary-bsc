...
abstract contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0), "newOwner must not be tate");
...
contract AndrewTateGrow is IBEP20, Ownable {
    ...
    string private _name = "ANDREW TATE GROW";
    string private _symbol = "ATG";
    uint256 private constant INITIAL_SUPPLY = 1_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //tate can never set tax higher than this value
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 4,
        rewards: 0
        //@tate. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        tate: 0x3DD4beA82b1A31FeD49d7cc05CF88B6C35100312,
        dev: 0x8112ED3f446BCDce6C44DE22af358e35C1D16706,
        marketing: 0xFba2D58A7cdB1c05175a2870AA1A6526D6bFcF7C
    });
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdatetateWallet(address newtateWallet);
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on tate's chosen ratios
    ...
    //allows tate to change token name and symbol. 
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "Approve from tate");
        require(spender != address(0), "Approve to tate");
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external onlyOwner {
        ...
        //tate can never set sells below 0.1% of circulating/initial supply
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newtate + newLiquidity + newdev + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newtate, newLiquidity, newdev, newMarketing, newRewards);
    }
    ...
    function withdrawtate() external authorized {
        ...
        uint256 amount = lostBalance ? tateBalance + remaining : tateBalance;
        tateBalance = 0;
        _sendBnb(_taxWallet.tate, amount);
    } 
    ...
    //Impossible to release LP unless LP lock time is tate
    ...
    //Impossible to remove LP unless lock time is tate
    ...
    function settateWallet(address payable addr) external authorized {
        address prevtate = _taxWallet.tate;
        _excluded.remove(prevtate);
        _taxWallet.tate = addr;
        _excluded.add(_taxWallet.tate);
        emit UpdatetateWallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 tate, uint256 dev, uint256 marketing) {
        return (buybackBalance, tateBalance, devBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 tateSplit = (bnbAmount*_taxRatios.tate) / distributeRatio;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        require(sender != address(0), "Transfer from tate");
        require(recipient != address(0), "Transfer to tate");
