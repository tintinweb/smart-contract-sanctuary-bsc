...
contract Ronin is ERC20, Ownable {
    ...
    RoninDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Ronin", "RONIN") {
        marketingWallet = payable(0x8BaFDFaF7ccA9DE2d9c0BAC941268A6ea93ab2D6);
        devWallet = payable(0x349Fc0f9e09A203d672e0b84e47A28f52a8789CF);
        ...
        dividendTracker = new RoninDividendTracker(
            payable(this),
            router,
...
contract RoninDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        RoninContract = Ronin(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Ronin_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Ronin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Ronin contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(RoninContract);

            uint256 prevBalance = RoninContract.balanceOf(address(this));
            ...
            {
                uint256 received = RoninContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RoninContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
