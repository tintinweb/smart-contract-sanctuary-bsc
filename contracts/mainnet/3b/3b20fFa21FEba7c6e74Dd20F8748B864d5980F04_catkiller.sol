...
contract catkiller is Context, IERC20, Ownable {
    ...
    string private _name = "cat killer";
    string private _symbol = "cat killer";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99692255C9d5947046380396813DC3d2D1C98952);
    address payable public teamWalletAddress = payable(0x3579F1d71319C130D5C7F6AaD1738c223E0D0290);
    ...
    uint256 private _totalSupply =  521 * 10**_decimals;
