...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdA7eA638e8A7c4a2F28B6fD7F310dCF8A8A08481;
...
contract Devak47 is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEVak47"; // 
    string private constant _symbol = "DEVak47"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xdA7eA638e8A7c4a2F28B6fD7F310dCF8A8A08481);
