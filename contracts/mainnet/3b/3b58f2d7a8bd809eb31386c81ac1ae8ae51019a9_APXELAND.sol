...
🔀 0x3B58F2d7a8Bd809eB31386C81Ac1ae8Ae51019a9
...
contract APXELAND is APXELANDDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private APXELANDTeam;
    address private CharityAPXELAND;
    ...
    string public override name = "APXELAND";
    string public override symbol = "APXELAND";
    ...
    constructor(uint totalSupplyValue, address APXELANDTeamAddress, address CharityAPXELANDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        APXELANDTeam = APXELANDTeamAddress;
        CharityAPXELAND = CharityAPXELANDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[APXELANDTeam] =  totalSupply * 4 / 100;
        balances[CharityAPXELAND] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's APXELANDTeam pot
