...
contract AM is ERC20 {
    ...
    address private _fund2Address = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			USDT.transfer(_fundAddress,newAmount.div(5).mul(1));
			USDT.transfer(_fund1Address,newAmount.div(5).mul(2));
			USDT.transfer(_fund2Address,newAmount.div(5).mul(2));
		}
    }
