...
Telegram Chat: https://t.me/tInuOfficial
...
contract TikTokInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tik Tok Inu"; //
    string private constant _symbol = "TInu"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x6f75834A47a148180C44A80f46AC246d9333A2d2;
    ...
    function setFee(uint256 newmarketFee) public onlyOwner {
       _marketingFee = newmarketFee;
    }
