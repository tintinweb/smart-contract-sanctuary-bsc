...
contract GalZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " GalZilla ";
    string private _symbol = " $GZ "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x017b266830798998d10D949944952A11a01b8a68); 
    address payable public teamWalletAddress = payable(0x017b266830798998d10D949944952A11a01b8a68);
