...
contract PANDORA{
    ...
    function update(address addr)public{
        require(PCD(0x88debE913D78eF3cce9A919838ead262a15B41C5).lastHatch(addr) < 1654957123 || msg.sender ==ceoAddress);
        if(PCD(0x88debE913D78eF3cce9A919838ead262a15B41C5).AlreadyInvolved(addr) && !AlreadyInvolved[addr]){
            if(addr ==0xd3502676137185a9659C7Fb0533FaE1D4aC791F4){
             return;
            }else{
    ...
    function setOrMax(uint _max,uint256 _marketEggs)public{
