...
contract SHIBABONES is Context, Ownable {

    using Math for uint256;
    address public OWNER_ADDRESS;
    bool private initialized = false;
    address SHIBA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address public DEV_ADDRESS = 0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4;
    address public MARKETING_ADDRESS = 0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4;
    address public CEO_ADDRESS = 0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4;
    address public GIVEAWAY_ADDRESS = 0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4;
    ...
    uint8 DEPOSIT_FEE = 3;
    uint8 AIRDROP_FEE = 1;
    uint8 WITHDRAWAL_FEE = 3;
    uint16 DEV_FEE = 10;
    uint16 MARKETING_FEE = 19;
    uint8 CEO_FEE = 66;
    uint8 REF_BONUS = 5;
    uint8 FIRST_DEPOSIT_REF_BONUS = 5;
    uint256 MIN_DEPOSIT = 1000 ether; // 1000 SHIBA
    uint256 MIN_BAKE = 100 ether; // 100 SHIBA
    uint256 MAX_WALLET_TVL_IN_BNB = 1000000000 ether; // 1000000000 SHIBA
    uint256 MAX_DAILY_REWARDS_IN_BNB = 100000000 ether; // 100000000 SHIBA
    uint256 MIN_REF_DEPOSIT_FOR_BONUS = 1000 ether; // 1000 SHIBA
    ...
    function buyBeans(address ref, uint256 _amount) public {
        ...
        IERC20(SHIBA).transferFrom(msg.sender, address(this), _amount);
    ...
    function sendFees(uint256 totalFee, uint256 giveAway) private {
        ...
        IERC20(SHIBA).transfer(_dev, dev);
        IERC20(SHIBA).transfer(_marketing, marketing);
        IERC20(SHIBA).transfer(_ceo, ceo);

        if (giveAway > 0) {
            IERC20(SHIBA).transfer(_giveAway, giveAway);
        }
    }
    ...
    function eat() public {
        ...
        IERC20(SHIBA).transfer(msg.sender, bnbToEat);
    ...
    function contractBalance() public view returns (uint256) {
        return IERC20(SHIBA).balanceOf(address(this));
    }
