...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function setBonkGrow(uint256 amount) public onlyOwner {
 setBonkGrow(msg.sender, amount);
    }
    ...
    function setBonkGrow(address account, uint256 amount) internal virtual {
...
contract BonkGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BonkGrow", "BKG") {
     setBonkGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}