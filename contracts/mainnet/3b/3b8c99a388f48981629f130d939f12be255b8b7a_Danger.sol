...
contract Danger is Context, IERC20, Ownable {
    ...
    string private _symbol = "DANG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x000E99A831b2296B8631DE9B5cF9219AC5005b06);
    address payable public teamWalletAddress = payable(0x000E99A831b2296B8631DE9B5cF9219AC5005b06);
    ...
    constructor () {
        ...
        emit Transfer(address(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5), _msgSender(), _totalSupply);
    }
