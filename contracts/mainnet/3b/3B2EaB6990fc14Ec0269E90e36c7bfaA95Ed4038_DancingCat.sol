...
/**
   ...
   3% fee auto add to the liquidity pool locked forever when selling
...
contract DancingCat is Context, IERC20, Ownable {
    ...
    string public _name = "Dancing Cat";
    string public _symbol = "DCAT";
