...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x409EA759D6bD0cA25DaDB77934840E0d56b4FEE5;
...
contract Tesla is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9934D626f3d5116d1838d0D1E519040193763313;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Teslanomics";
    string private _symbol = "Teslanomics";
    ...
    uint256 public _maxTxAmount = 35000000000 * 10**18;
