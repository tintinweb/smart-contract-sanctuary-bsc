...
contract BABYBULLSWORLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Bulls World";
    string private _symbol = "$BBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC43c9fcBcb39a4282Ed58C91424756754Cf101C2); 
    address payable public buyBackWalletAddress = payable(0xb93Da4493E110461Ad853Cf546d7Eee50b3f2B8d); 
    ...
    uint256 private minimumTokensBeforeSwap = 7000000 * 10**9; 
