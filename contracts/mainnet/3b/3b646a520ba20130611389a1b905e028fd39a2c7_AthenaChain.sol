...
ATHENACHAIN ​​Is A Blockchain Built On Bsc Network And Will Be The Fastest Blockchain With Lowest Cost, And Build An Ecosystem With Projects Covering DeFi, NFT, Web3 And More
...
✅  Ownership Renounce
✅  LP Burn
✅  Low Tax Buy and Sell 1%

Tokenomics

35% Liquidity Pancake
5%   Marketing Token Lock 3 
        Months
60% Burn Token 

Telegram : https://t.me/athenachainofficial

Twitter : https://twitter.com/athenachain

Website : Under Construction(will live in 6 hours)
*/
...
contract AthenaChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Athena Chain";
    string constant _symbol = "ACHAIN";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 69000 * 10**6 * 10**18;
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 69000 * 10**6 * 10**18;
