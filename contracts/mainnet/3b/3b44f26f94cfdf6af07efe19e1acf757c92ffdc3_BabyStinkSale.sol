...
/*
 *  Taxes : 6% Buy | 6% Sell
 *  Telegram : @BabyStinksale
 *
 *  Welcome to Baby Stink Sale
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xc216E4B28e7aCE067f076D0f5Ef3094676a134d7); //Not gonna use
...
contract BabyStinkSale is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Baby Stink Sale";
    string constant _symbol = "BabySS";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xc216E4B28e7aCE067f076D0f5Ef3094676a134d7;
    ...
    constructor() Auth(msg.sender) {
        ...
        //MARKETING FEES ARE BEING SENT TO ANOTHER WALLET SO THE MARKETING TEAM CAN USE IT
        //AND WE ARE 100% TRANSPARENT WITH OUR USAGE
        marketingWallet = 0x58B233721e0e55B5B70113838AF76DBA5176dF49; //marketingwallet 1
        anothermarketingWallet = 0x58B233721e0e55B5B70113838AF76DBA5176dF49; //marketing wallet 2
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1, ) = payable(anothermarketingWallet).call{
            value: anothermarketingShare,
            gas: 30000
        }("");
