...
contract SpaceEagle is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFeA6081eed4BA57CAaE615f7729b5D2dd15a0216); // Marketing Address
    ...
    string private _name = "SpaceEagle";
    string private _symbol = "SEAGLE";
