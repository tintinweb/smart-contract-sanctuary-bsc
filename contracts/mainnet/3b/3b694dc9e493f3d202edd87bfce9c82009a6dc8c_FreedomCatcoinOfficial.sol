...
contract FreedomCatcoinOfficial is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "FreedomCatCoin";
    string _symbol = "FCC";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxWallet = _totalSupply.mul(6).div(200); 
    uint256 public _maxTxAmount = _totalSupply.mul(3).div(200);
    ...
    address private marketing = address(0x39791217fB01Fb8640D3910b2B7997e699d9642F);
    address private liquidity = address(0x42f9Ad2DCd4F11DE2eFc32b46a8712B91568f3D8);
