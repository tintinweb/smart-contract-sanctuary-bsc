...
contract FTXSAFU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX SAFU";
    string private _symbol = "FTXSAFU";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x5E73C4553C0030a9B32ceaF063196342Ff58E74A); // Marketing Address
    address payable private TeamWallet = payable(0x5E73C4553C0030a9B32ceaF063196342Ff58E74A); // Buy Back Address
