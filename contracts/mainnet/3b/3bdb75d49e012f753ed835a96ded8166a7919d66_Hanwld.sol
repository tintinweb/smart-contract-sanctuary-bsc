...
contract Hanwld is IBEP20, Admin{
    ...
    string constant _name = "Happy New World";
    string constant _symbol = "Hanwld";
    ...
    function setBMHanwld(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMHanwld(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
