...
contract DevisGirl is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "DevisGirl";
   string constant _symbol = "DVISGRL";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x4ccC77Bc1B71726C6D8B7BaC4c9c8b3bD908CF4e).call{value: BNBMarketingamount, gas: 30000}("");
