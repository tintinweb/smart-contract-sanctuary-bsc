...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner =0xa615d1E1f1F57caC6687f958bA8805C1533C162e ;
...
/* Token contract */
contract SERTAN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x0174f03DA6a98227980E0B8258547C633610C8Ae;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch or 200M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 100M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% or 200M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver=0x0174f03DA6a98227980E0B8258547C633610C8Ae;
