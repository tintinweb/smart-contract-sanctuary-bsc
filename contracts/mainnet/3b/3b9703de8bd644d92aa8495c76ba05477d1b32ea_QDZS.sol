...
contract QDZS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public lpFeeSell = 4;
    uint256 public lpFeeBuy = 2;

    uint256 public marketFeeSell = 2;
    uint256 public marketFeeBuy = 2;
    ...
    function _transfer(
        ...
        if(uniswapV2Pair[from]){
           ...
           if(block.number < launchTime + 4)
            ...
            if(!isWalletLimitExempt[to] && block.number < launchTime + 200)
