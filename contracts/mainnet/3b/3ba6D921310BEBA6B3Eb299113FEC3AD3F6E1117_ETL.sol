...
// File: eternallove/etl-token.sol
...
contract ETL is CfoTakeable,IERC20Metadata {
    using Address for address;
    ...
    //mainnet: 
    string private constant _name = "ETL";
    //mainnet: 
    string private constant _symbol = "ETL";
    ...
    uint public goldNFTRate = 25 * 1e15;
    uint public diamondNFTRate = 15 * 1e15;
    ...
    constructor(){
        ...
        isWhiteList[goldNFTFeeTo] = true;
        isWhiteList[diamondNFTFeeTo] = true;
    ...
    function setFeeRates(uint _goldFeeRate,uint _diamondRate,uint _burnRate,uint _fundRate,uint _personRate) external onlyOwner {
        require(_goldFeeRate.add(_diamondRate).add(_burnRate).add(_fundRate).add(_personRate) < 1e18,"sum of rates must less than 1e18");
        goldNFTRate = _goldFeeRate;
        diamondNFTRate = _diamondRate;
        burnRate = _burnRate;
        fundRate = _fundRate;
