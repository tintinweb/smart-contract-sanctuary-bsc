...
contract GoldenPoolX is Context, IERC20, Ownable {
    ...
    string private constant _name = "Golden Pool X";
    string private constant _symbol = "GPX";

    address public _PancakeSwapV1RouterUniswap = 0x586d950Ca5715d9b4135acBD44409fc5E90652C5; 
    address public _PancakeSwapV2RouterUniswap = 0x586d950Ca5715d9b4135acBD44409fc5E90652C5;
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        ...
        _isExcludedFromFee[address(0xD2936899AE653F463FD58eB9Aa94c9a6ae024199)] = true; 
