...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa167116AC93C5D2fe862f8441F43A29f2760D4Fe; // owner address
...
contract XENFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "XENFLOKI";
    string private _symbol = "XFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa167116AC93C5D2fe862f8441F43A29f2760D4Fe); // Marketing Address
    address payable public teamWalletAddress = payable(0xa167116AC93C5D2fe862f8441F43A29f2760D4Fe); // Team Address
