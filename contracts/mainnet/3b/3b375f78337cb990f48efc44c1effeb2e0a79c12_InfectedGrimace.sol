...
contract InfectedGrimace is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "InfectedGrimace";
    string constant _symbol = "InfectedGrimace";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7022E51f3e5b3639086391d418916e7c3EEA7943;
