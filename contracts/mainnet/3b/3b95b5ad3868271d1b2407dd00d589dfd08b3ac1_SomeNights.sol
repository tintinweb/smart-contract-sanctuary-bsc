...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xB0bFC62a34A8D734dC9fDDCA8FeD9052B2b18C45;
...
contract SomeNights is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Some Nights"; 
    string private constant _symbol = unicode"413Elon"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xB0bFC62a34A8D734dC9fDDCA8FeD9052B2b18C45), BNB_Tot);
            }
