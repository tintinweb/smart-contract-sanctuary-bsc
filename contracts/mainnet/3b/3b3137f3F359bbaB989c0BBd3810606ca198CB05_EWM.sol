...
contract EWM is IBEP20, Auth {
    ...
    string constant _name = "TESLA OWNERS INU";
    string constant _symbol = "ELON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; //1% 
    ...
    address private developmentFeeReceiver = 0x79E62A2DdCB576a86831Ab20eC26b26d13F02eAf;
