...
Telegram https://t.me/MarvChainBSC
Twitter https://twitter.com/MarvChain_Offc
*/
...
contract MARV is Context, IERC20, Ownable {
    ...
    string private _name = "MARV CHAIN";
    string private _symbol = "MARVCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC0253e9A92A741421090B3eed72a885C9AEeCA12); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC0253e9A92A741421090B3eed72a885C9AEeCA12); // BuyBack Address
    ...
    uint256 private _totalSupply = 125 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 250 * 10**4 * 10**9;
    uint256 public _walletMax = 125 * 10**5 * 10**9;
