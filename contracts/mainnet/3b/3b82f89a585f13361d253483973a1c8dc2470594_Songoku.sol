...
contract Songoku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC79D34d2848E7d22f6aBe3Cf31F330454f92B830); 
    address payable public Wallet_Dev = payable(0x39dC36d049F4E4Cd40a50E2b7443e791a6A6E390);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Songoku"; 
    ...
    constructor () {
        _owner = 0x39dC36d049F4E4Cd40a50E2b7443e791a6A6E390;
