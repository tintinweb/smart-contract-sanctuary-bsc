...
/**
//----------------------------------------------\\
TELEGRAM GROUP   : https://t.me/CACTASSTOKEN
WEBSITE          : https://www.cactass.org/
TWITTER          : https://twitter.com/Cactass_Token
//----------------------------------------------\\
*/
...
contract CactASS is Context, IERC20, Ownable {
    ...
    string private constant _name = "CactASS"; // 
    string private constant _symbol = unicode"CactASS🌵"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x46ec17eDfE607B20a2e943e1DB278c36f67f00b6;
