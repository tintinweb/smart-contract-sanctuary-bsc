...
Japanese Terrier is Meme token Buy or Poor
*/
...
contract JapaneseTerrier is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$JPYDOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x3DBAd2fa2D29077a6D055FdBc8899C40a55d41E8;
