...
// NanoSquidGrow nano version of SquidGrow
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52b4097556E25F0914b9313817874F0c8c84baB6; // owner address
...
contract NanoSquidGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NanoSquidGrow";
    string private _symbol = "NSG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb9f83B9f9349873958914989460483Ed10822F07); // Marketing Address
    address payable public teamWalletAddress = payable(0xb9f83B9f9349873958914989460483Ed10822F07); // Team Address
