...
If you sell any tokens at all at any point you can never be the TaxCat again.
The TaxCat is set via biggest buy in BNB.
...
contract TaxCat is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "TaxCat";
    string constant _symbol = "TaxCat";
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x4017E431d3a373464c82421497d875Ef82397ba4; //LP receiver
        marketingWallet = 0x4017E431d3a373464c82421497d875Ef82397ba4;  //marketing wallet
        taxMan = 0x4017E431d3a373464c82421497d875Ef82397ba4;  //tax collector wallet
