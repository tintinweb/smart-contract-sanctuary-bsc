...
contract VIDEOGAMES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Video Games";
    ...
    address payable public DevelopmentalWalletAddress = payable(0xa92B459C09F67963d8d25aD158eb9f4AcF6aE3C9);
