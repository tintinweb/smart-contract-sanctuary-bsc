...
contract RottweilerInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Rottweiler Inu", "ROTTINU") {
        ...
        //maxTransactionAmount = totalSupply * 50 / 1000; // 0.90% maxTransactionAmountTxn
        maxTransactionAmount = 9000000000 * 1e18;
        maxWallet = totalSupply * 9 / 1000; // 0.90% maxWallet
