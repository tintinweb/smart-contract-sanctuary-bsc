...
contract BEP20Token is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kaptain Kishu";
    ...
    uint256 marketingFeeBuy    = 25;
    uint256 teamFeeBuy         = 25;
    uint256 giveawayFeeBuy     = 25;
    uint256 public totalFeeBuy = 95; //Total Fee
    uint256 feeDenominatorBuy  = 100;

    uint256 liquidityFeeSell    = 20;
    uint256 reflectionFeeSell   = 0;
    uint256 marketingFeeSell    = 25;
    uint256 teamFeeSell         = 25;
    uint256 giveawayFeeSell     = 25;
    uint256 public totalFeeSell = 95; //Total Fee
