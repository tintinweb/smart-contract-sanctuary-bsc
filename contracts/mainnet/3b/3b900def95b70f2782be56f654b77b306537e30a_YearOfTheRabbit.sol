...
contract YearOfTheRabbit is Context, IERC20, Ownable {
    ...
    string private _symbol = "YOTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf656B779717444d0EB57f1afdE2A0C1FcFbb81A4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8fC45d4f11e247440bDdF1e0055C94783b360eD9); // BuyBack Address
