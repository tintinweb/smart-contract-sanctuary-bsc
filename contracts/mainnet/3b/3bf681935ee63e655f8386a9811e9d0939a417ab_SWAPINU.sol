...
Swap Inu - The Next Swap On Inu Meta
...
contract SWAPINU is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"SWAP INU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**5 * 10**_decimals;

    address payable private DevWallet = payable(0x99A1489394ac15B462bd2576dD5e8378F2978272);
    address payable private MarketingWallet = payable(0xf8aaCe6358eA36B630af100BE0440679Dc401d5d);
    address payable private TeamWallet01 = payable(0x64755dF5b7398de16f52ec10A394171C2A2cBE40);
    address payable private TeamWallet02 = payable(0x507F166e6Cc571a6D1fA5CA790fa9957fD49A667);
    address payable private TeamWallet03 = payable(0x82e4E9E3441AAb0D89708bc78B8bbCBFD1f99025);
