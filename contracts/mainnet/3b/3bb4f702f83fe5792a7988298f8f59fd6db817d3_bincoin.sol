...
contract bincoin is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFFd1D3FE1570748a2c139BB2e3DD552C274E9773); //nice
    address payable public charityAddress = payable(0xFFd1D3FE1570748a2c139BB2e3DD552C274E9773); //nice
    ...
    uint256 private _tTotal = 1700000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Bin Coin"; //CC
    string private _symbol = "BIN";  //nice
    ...
    uint256 public _maxTxAmount = 25500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 25500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 17000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 25500;// 0.01*255 token for 0.01 bnb (set as per requirements)
