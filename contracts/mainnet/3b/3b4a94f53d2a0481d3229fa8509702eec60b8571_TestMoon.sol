...
contract TestMoon is IBEP20, Auth {
    ...
    string constant _name = "TestMoon Token";
    string constant _symbol = "TestMoon";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1;  //1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1;  //1% max wallet
    ...
    address private marketingFeeReceiver = 0x01081c3f3d355688B2D09D9A086904E9CD8e1744;
    address private teamFeeReceiver = 0x19EAD195Ea725d71A5d501553a779f0ba152bB3e;
