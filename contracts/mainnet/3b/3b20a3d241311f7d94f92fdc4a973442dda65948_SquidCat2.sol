...
contract SquidCat2 is Context, IBEP20, Ownable {
    ...
    string private _name = "Squid Cat 2.0"; // token name
    string private _symbol = "SCAT"; // token ticker
    ...
    uint256 public maxBuyLimit = 50000000 * 1e9;
