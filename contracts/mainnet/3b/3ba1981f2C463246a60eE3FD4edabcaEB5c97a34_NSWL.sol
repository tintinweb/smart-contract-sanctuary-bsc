...
contract NSWL is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("NSWLSwap", "NSWL") {
        ...
        uint256 total = 2000000000000000000000;
    ...
    function changeBonus(bool _Bonus) public onlyOwner {
        bonusEnabled = _Bonus;
    }
    ...
    function _splitOtherToken() public {
        ...
        if(bonusEnabled && thisAmount >= 10**14){
