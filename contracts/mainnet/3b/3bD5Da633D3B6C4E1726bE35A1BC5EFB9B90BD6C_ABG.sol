...
contract ABG is IERC20, Ownable {
    ...
    address private fundAddress = address(0xD40463fD6174064a3C82219FdE09c39C9693dFdC);
    address private fundAddress2 = address(0xD40463fD6174064a3C82219FdE09c39C9693dFdC);
    address private fundAddress3 = address(0xD40463fD6174064a3C82219FdE09c39C9693dFdC);
    address private fundAddress4 = address(0xD40463fD6174064a3C82219FdE09c39C9693dFdC);
    ...
    function getPrice2() public view returns(uint256){
        ...
        path[0] = USDT;
        path[1] = address(this);
        uint256[] memory amounts = uniswapV2Router.getAmountsIn(1*10**16,path);
        return amounts[0];
