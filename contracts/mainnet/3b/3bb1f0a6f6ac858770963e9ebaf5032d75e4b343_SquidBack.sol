...
contract SquidBack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidBack Token";
    string private _symbol = "Squidback";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48409055e528d47Ced1712257de25BC25d8b489c);
    address payable public BuyBackWalletAddress = payable(0x48409055e528d47Ced1712257de25BC25d8b489c);
