...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06617eA3d53aF528De7Ca64Afb7d0296B6643E4F; // owner address
...
contract KingCup2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " King Cup 2022 ";
    string private _symbol = " $KINGCUP2022 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06617eA3d53aF528De7Ca64Afb7d0296B6643E4F); // Marketing Address
    address payable public teamWalletAddress = payable(0x06617eA3d53aF528De7Ca64Afb7d0296B6643E4F); // Team Address
