...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xFA50b4055f265c00eE9c7f8cc27C0Ce2A0CF0e23;
...
contract ETHVS is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3F924Fb357FdF59e41245bafE38e9AfBCF80D2ef),
    
        address(0x17c3330BeE0E04e638d92a83662aF94E7fC56B3D)
    ){
