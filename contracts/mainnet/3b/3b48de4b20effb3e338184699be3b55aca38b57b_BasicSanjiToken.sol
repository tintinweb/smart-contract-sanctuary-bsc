...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75ff869C089845A6617fd64b57779579a5A5640B; // owner address
...
contract BasicSanjiToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x75ff869C089845A6617fd64b57779579a5A5640B); // Marketing Address
    address payable public teamWalletAddress = payable(0x75ff869C089845A6617fd64b57779579a5A5640B); // Team Address
