...
contract RatsGala is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 56000000000 * 10**9;
    uint256 public _maxTxAmount = 1680000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**9; //
    string private constant _name = "Rats Gala"; // 
    string private constant _symbol = "rGALA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xa9cBEb12329B7c9873Aa0CdcAB2B12AdccF00FB5;
