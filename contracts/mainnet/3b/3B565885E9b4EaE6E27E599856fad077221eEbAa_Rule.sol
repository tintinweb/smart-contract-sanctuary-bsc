...
contract Rule is Context, Ownable {
    ...
    address public _fundAddress = address(0x748299A5DdE7ed8A5Dc14Af8670ECcD16cfB231b);

    address public _tokenAddr=address(0x036856195b8fD7C4d0d08b8Cf11913E51fCCd0d9);
    address public _uniswapV2Pair=address(0xe17cf3D900d3c98125C1e65F2724408e68819884);
