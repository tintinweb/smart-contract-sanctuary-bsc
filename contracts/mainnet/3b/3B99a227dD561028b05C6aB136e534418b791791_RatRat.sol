...
contract RatRat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE8D502B1ba237CdD9Db42c09915c2E0f2fAb3147); 
    address payable public Wallet_Dev = payable(0xE8D502B1ba237CdD9Db42c09915c2E0f2fAb3147);
    ...
    string private constant _name = "Rat Rat!!!"; 
    string private constant _symbol = unicode"RATRAT!!!"; 
    ...
    uint256 public Fees_Liqratrat = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Fees_Brnratrat = 0;             
    ...
    constructor () {
        ...
        _owner = 0xE8D502B1ba237CdD9Db42c09915c2E0f2fAb3147;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Fees_Brnratrat / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Fees_Liqratrat / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Fees_Liqratrat + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Fees_Liqratrat + Percent_Marketing + Percent_Dev);
