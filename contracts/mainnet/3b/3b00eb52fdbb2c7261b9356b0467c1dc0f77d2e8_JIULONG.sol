...
contract JIULONG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = 'JIULONG';
    string private _symbol = 'JIULONG';
    ...
    address public _ownerAddress = address(0x6470360eb5Ece39d80554e4F70CA5039BA491009);
    address public _devAddress = address(0x2b842AcaB2d3cb47cd03DE85dF6C4A6755391009);
