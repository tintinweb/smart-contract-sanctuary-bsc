...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86cbF80ccC5CCECb63E0Bf470776510e883bB3E9; // owner address
...
contract ScoobishuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Scoobishu Inu";
    string private _symbol = "SCOOBISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA5d5DEa6E6EA33442E6A6dDcA34B12CEea733135); // Marketing Address
    address payable public teamWalletAddress = payable(0xA5d5DEa6E6EA33442E6A6dDcA34B12CEea733135); // Team Address
