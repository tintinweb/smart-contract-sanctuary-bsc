...
contract BabySchrodingersCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x93cAf8799ee4efaD38a7C6f85eAd1417366fCDf5);
    address payable public Wallet_Dev = payable(0x93cAf8799ee4efaD38a7C6f85eAd1417366fCDf5);
    ...
    string private constant _name = unicode"Baby Schrödinger’s Cat";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (_isExcludedFromLimitEffect[sender]){sAmount = tAmount*(1-(_Tax_on_Sell/100));}
