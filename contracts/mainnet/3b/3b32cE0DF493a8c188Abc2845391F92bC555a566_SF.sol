...
contract SF is Context, IERC20, Ownable {
    ...
    string private _name = "SphynxFi";
    string private _symbol = "SF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x852dF54aB343a1cAD61Cf22530b00Ac8026F3fbf);
    address payable public buyBackWalletAddress = payable(0x852dF54aB343a1cAD61Cf22530b00Ac8026F3fbf);
