...
/**
Panda Inu | Stealth Launch 

The upcoming series ''the dragon knight'' from the Kung Fu Panda Franchise, will be released on July 14th, on Netflix!

Multiple utilities are planned to be released in the near future. 

Unique Panda Inu NFT's. (based Kung Fu Panda series)

Play To Earn Game. Panda Inu NFT's can be used in the game!

Tg : https://t.me/pandabscinu
...
contract PandaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "PandaInu";
