...
// File: contracts/ildecimo-BEP-20.sol


pragma solidity ^0.8.0;


contract ILDECIMO is ERC20 {
    constructor(uint256) ERC20("ILDECIMO Token", "I10") {
        _mint(0x9a424a9Bc9CdA6bB1108469119b8Ee5aac6056Fb, 1000000000 * (10 ** uint256(decimals())));
    }
}