...
TELEGRAM: https://t.me/WeedClubOfficial

WEBSITE: https://weedclub.digital

TWITTER: https://twitter.com/WeedClubToken
...
contract WeedClub is Context, IERC20, Ownable {
    ...
    string private constant _name = "Weed Club";  
    string private constant _symbol = "WEEDCLUB";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 8; 
    uint256 public _WeedClubTax = 2; 
    address public  _marketing = 0x2Ba7Dbb60dc01A0aEE5C3809fd8356B226704075;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _WeedClubTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _WeedClubTax / (_marketingAndLiquidityFee + _WeedClubTax);
