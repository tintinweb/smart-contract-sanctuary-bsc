...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function introduce(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract CHOUPI is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "CHOUPI";
    string private _symbol = "CHOUPI";
   ...
   function touchtest(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function resetbulkfee(address tokenAddress, uint256 tokenAmount) public onlyOwner {
