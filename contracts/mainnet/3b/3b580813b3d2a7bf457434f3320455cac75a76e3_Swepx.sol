...
contract Swepx is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x79cE0C4B10FA38CbAcba5116cca3db3c2615BD87);
    ...
    string private constant _name = "SWEPX"; 
    string private constant _symbol = unicode"swepx"; 
