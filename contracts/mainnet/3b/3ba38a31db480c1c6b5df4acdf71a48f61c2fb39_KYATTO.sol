...
*                           KYATTO TOKEN 
*              
*            LOW TAX TOKEN FOR EVERYONE TO HAVE FUN WITH
*    
*                      100% SAFE AND EPIC DEVS
*                     
*                     2% BUY TAX    2% SELL TAX
* 
* 
* Total Supply:    750 000
* Max per Holder:  11 250
* Max sell:  5 000
* Max buy:   5 000
* 
*                               
...
contract KYATTO is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'KYATTO';
    string private constant _symbol = '$KYATTO';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 750000 * 10**_decimals;//equals 750000 token
    ...
    uint16 public constant MaxSellLockTime= 30;
    ...
    //DevWallets
    address public TeamWallet=payable(0xDdfaaa688D88f8Bd25B694baa7C2047ea9EC2Be2);
    address public walletTwo=payable(0xDdfaaa688D88f8Bd25B694baa7C2047ea9EC2Be2);
    //TestNet
	...
	uint256 private antiWhale = 5000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4; 
