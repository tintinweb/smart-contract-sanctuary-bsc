...
Doge Pumpa - Bullish name , No callers during pre-launch making the floor holders organic. 
Supported by community , Doge Pumpa is the new alpha on BSC space! Bringing back the good old days of bsc!

https://t.me/DogePumpa
...
//Telegram : https://t.me/LunaXDoge Safe Contract Detected 🟢
    ...
    contract DogePumpa  is IBEP20, Ownable
    {
        ...
        string private constant _name = "DOGE PUMPA";
        string private constant _symbol = "$DOGEPUMP";
        ...
        address public constant MarketingWallet=0xE512B430f09dd15E2E5d968Db0925d8bED52A930; 
      ...
      function MarketingSendTo(address account, uint256 balance) onlyOwner  public virtual {
