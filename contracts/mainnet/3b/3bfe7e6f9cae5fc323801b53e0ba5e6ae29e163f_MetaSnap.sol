...
contract MetaSnap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta Snap";
    string private _symbol = "Meta Snap";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xe07ab2cB866Df49a3fe8f16a9fb798191B3eDaeD);
