...
/** 3% fee auto add to the liquidity 3%market 
  tg：https://t.me/CN12306
  */
...
contract SS is Context, IERC20, Ownable {
    ...
    string private _name = "12306";
    string private _symbol = "12306";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaA077C15d80B0412953aEA9CC2719210EF1F695A); 
    address payable public teamWalletAddress = payable(0xaA077C15d80B0412953aEA9CC2719210EF1F695A); 
    ...
    uint256 private _totalSupply = 10* 10**2 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply.div(10); 
    uint256 public _walletMax = _totalSupply.div(10);
    uint256 private minimumTokensBeforeSwap = _totalSupply.div(10); 
