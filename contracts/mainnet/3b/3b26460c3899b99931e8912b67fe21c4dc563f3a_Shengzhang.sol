...
contract Shengzhang is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shengzhang";
    string private _symbol = "GROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15DA5350359e1b976fe33b2256FCE89c17CC4371); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x15DA5350359e1b976fe33b2256FCE89c17CC4371); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 60 * 10**6 * 10**9;
    uint256 public _walletMax = 60 * 10**6 * 10**9;
