...
contract GasDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GasDoge";
    string private _symbol = "GasDoge";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe73eA2DAAB3C459ed8FCddDfbDA677238B14adc5); // Marketing Address
    address payable private ruinWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // fuel Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
      
    uint256 public genesisBlock;
    uint256 public coolBlock = 1000000000000;
    ...
    uint256 public _buyruinFee = 5;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 3;
    uint256 public _sellruinFee = 5 ;

    uint256 public _liquidityShare = 4;
    uint256 public _marketingShare = 25;
    uint256 public _ruinShare = 25;
    ...
    uint256 private _totalSupply = 100000 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 100000 * 10**6 * 10**_decimals; 
    uint256 public _walletMax = 100000 * 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyruinFee);
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellruinFee);
        _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_ruinShare);
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newruinTax) external onlyOwner() {
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newruinTax) external onlyOwner() {
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newruinShare) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBruin = amountReceived.mul(_ruinShare).div(totalBNBFee);
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBLiquidity).sub(amountBNBruin);
