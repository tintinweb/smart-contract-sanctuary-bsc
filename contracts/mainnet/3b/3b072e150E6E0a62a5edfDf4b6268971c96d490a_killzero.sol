...
/* Token contract */
contract  killzero is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Kill Zero";
    string constant _symbol = "KILLZERO";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // KILL ZERO
