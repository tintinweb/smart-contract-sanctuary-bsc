...
/**   
       ...
       Telegram Group : https://t.me/CZ_Covid
...
contract BUFFKAIDO is Context, IERC20, Ownable {
    ...
    string private _name = "BUFF KAIDO";
    string private _symbol = "BUFFKAIDO";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0x12f87794C30D488339c7A5B7ca233bac0FAc3789);
