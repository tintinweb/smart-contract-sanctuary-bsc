...
contract miniKaka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "miniKaka";
    string private _symbol = "miniKaka";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEF5e140de49c8d4089dB443D7514a84e9eA9cE6a); 
    ...
    uint256 private _buyburnedFee;
    
    uint256 private _sellLiquidityFee;
    uint256 private _sellMarketingFee;
    uint256 private _sellburnedFee;
    ...
    uint256 private _totalSupply = 20 *  10**6 * 10**_decimals;
