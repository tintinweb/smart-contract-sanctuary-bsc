...
contract LiquidityInjection is LPSwapSupport  {
    ...
    uint256 public minBNBForProcessing;
    ...
    receive() external payable {
        if(address(this).balance >= minBNBForProcessing){
            forceProcess();
        }
    }
    ...
    function updateMinBNBForProcessing(uint256 _minBNB) external onlyOwner {
        minBNBForProcessing = _minBNB;
    }
}
