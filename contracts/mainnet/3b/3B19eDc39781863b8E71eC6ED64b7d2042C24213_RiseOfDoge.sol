...
Rise of Doge - going to be the next moonshot on bsc! 
Bringing back the old bsc hype and also we're going to release our own utility 
We're everyone can earn passive income by staking $ROD to earn more $ROD via Riseofdoge.io (Soon to be publish )
With Low tax and LP Locked for 1 MONTH ,Yes you read that right 1month lock and we're going to extend that further more. 

3% Marketing 
2% Liquidity 
2% Holders ( $ROD ) 

https://t.me/RiseOfDoge
https://riseofdoge.io/
...
*/
    ...
    contract  RiseOfDoge  is IBEP20, Ownable
    {
        ...
        string private constant _name = " RiseOfDoge";
        ...
        address public constant MarketingWallet=0x7e8b561FF90CC30e8D8a6b6ccBbe799776b2502C; 
