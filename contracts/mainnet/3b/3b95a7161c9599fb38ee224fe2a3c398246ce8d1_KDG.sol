...
contract KDG is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "KingdomGrow";
...
address payable private TeamWallet = payable(0x9A47CC4b08B7DE2C151e13d7e5cC03efA1B54094); // Buy Back Address
