...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "HAG";
    string private _symbol = "HAG";
    ...
    address public _market = 0x338089A4EFa2AFba720159CF0A16a5B519959de1;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x338089A4EFa2AFba720159CF0A16a5B519959de1),
            _msgSender(),
            _tTotal
        );
    }
