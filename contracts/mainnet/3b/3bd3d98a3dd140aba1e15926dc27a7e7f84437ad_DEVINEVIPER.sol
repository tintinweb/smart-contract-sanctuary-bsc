...
contract DEVINEVIPER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DEVINEVIPER";
    string constant _symbol = "$DVR";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x90043835AD1d11666Fa835718cd82F63C1961016;
