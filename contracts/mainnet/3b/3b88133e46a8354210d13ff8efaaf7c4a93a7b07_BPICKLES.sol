...
contract BPICKLES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pickle Inu";
    string private _symbol = "BPICKLE";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xFc5De423f5bf124CB361D2470B30094141E71486); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x97703d746363b8736A0A0B8DA0956367fF0e4277); // BuyBack Address
