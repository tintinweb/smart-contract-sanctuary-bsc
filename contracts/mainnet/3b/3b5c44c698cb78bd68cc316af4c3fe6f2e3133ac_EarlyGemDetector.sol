...
Telegram: https://t.me/EarlyGemDetector

🤖Early GEM Detector bot helps you to get access to early contract. 
Our bot analyses the data from well-known websites like Moonarch, 2100+ public, 150+ private TG groups and gives you EARLY contract. 

Try the bot here @EarlyGEM_detector_bot 
...
contract EarlyGemDetector is Ownable {
    constructor(
        string memory _NAME,
