...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x338f4D4383869f155D0567E67E671dED8393FD8B; 
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 880 * 10**9; //
    uint256 public _maxTxAmount = _tTotal * 1 / 100; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "8jiu"; // 
    string private constant _symbol = "8jiu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x338f4D4383869f155D0567E67E671dED8393FD8B); 
