...
/*
  Forfeit (FFT) Token
  Forfeit Game is a blockchain game metaverse created by the best gaming team in the market.
  By creating their own world, players can customize the entire game and offer weapons of
  their own creation for sale. They will compete using their customized teams in Play and Win games.
  Our goal is to create a long-term sustainable world and platform for the next generation of
  gamers where they have in-game assets and can shape the direction of the project.
  www.forfeit.io
...
contract ForfeitToken is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x78A879828F0C96F6cE951166F1E07287126E73cf;
