...
contract LGBTQ is Context, IERC20, Ownable {
    ...
    string private _name = "LGBTQ";
    string private _symbol = "LGBTQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBB60200ae0750459c75d18A1b62350A3b1C1Ecc3); // Marketing Address
    address payable public teamWalletAddress = payable(0xBB60200ae0750459c75d18A1b62350A3b1C1Ecc3); // Team Address
    ...
    uint256 private _totalSupply = 10 * 10**3* 10**3 * 10**3 * 10**_decimals;
    uint256 public _maxTxAmount = 10 * 10**3 * 10**3* 10**3 * 10**_decimals; 
    uint256 public _walletMax = 10 * 10**3 * 10**3* 10**3 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10 * 10**3* 10**3 * 10**_decimals; 
