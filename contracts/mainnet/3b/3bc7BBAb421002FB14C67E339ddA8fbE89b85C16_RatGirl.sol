...
contract RatGirl
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "RatGirl";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7C36Bb8beE32dD394C3e393b4Fffe8f758637926));
        _anotherA = payable(address(0x7C36Bb8beE32dD394C3e393b4Fffe8f758637926));
