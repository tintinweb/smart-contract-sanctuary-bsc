...
contract KIMROCKET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KIM ROCKET";
    string private _symbol = "$KIMROCKET";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**9;
    
    address payable public marketingWalletAddress = payable(0x3647FDfeE92404A0Ef3b55026fD10895F7025171); 
    address payable public rewardsWalletAddress = payable(0xb43563Cd13D41000161cF6DAA09A5771D35DeC5C); 
    ...
    uint256 public _maxTxAmount = 4 * 10**11 * 10**9;
    uint256 public _walletMax = 4 * 10**11 * 10**9;
    ...
    constructor () {
        ...
        _totalValue = _totalTax.add(_BurnFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = recipient == uniswapV2Pair ? amount.mul(_totalValue).div(100) 
