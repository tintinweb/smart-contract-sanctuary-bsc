...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa83Bc8640A7Cc54E5BffEcdc78C50D4F8C9790B7;
...
contract MemoShiba is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa83Bc8640A7Cc54E5BffEcdc78C50D4F8C9790B7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MemoShiba";
    string private _symbol = "MMSHIB";
