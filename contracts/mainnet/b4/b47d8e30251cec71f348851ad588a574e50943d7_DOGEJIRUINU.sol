...
contract DOGEJIRUINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dogejiru Inu";
    string private _symbol = "Dogejiru";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xbfc10cC2d5895f59dEb98c5092EB0e500C4E2a14);
