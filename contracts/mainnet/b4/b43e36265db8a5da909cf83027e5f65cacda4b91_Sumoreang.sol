...
contract Sumoreang is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUMOREANG"; // 
    string private constant _symbol = "SMRG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xE8EbA602C21A14b660A0dbC318494Ccee3A1aE4c;
