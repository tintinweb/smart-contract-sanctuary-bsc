...
contract Dutch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xB7Ea92E08CA11d1fB28DaBA26f2EdB8cc3e4ea73); // Marketing Wallet
    address payable private devWallet = payable (0x6AF095a2fcf06343fB04b5E9edfE4cF3aF08e4F3); // dev Wallet
    ...
    uint256 private _tTotal = 20 * 10**6  * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dutch farm";
    string private _symbol = "DFM";
    

    uint256 public _maxWalletToken = _tTotal.div(1000).mul(1); //0.1% for first few mins
    ...
    uint256 public swapThreshold = _tTotal.div(100000).mul(5); //0.005%
    ...
    function withdrawStuckTokenAmount(IERC20 token, address to,uint256 amount) public onlyOwner {
        token.transfer(to, amount*10**_decimals);
    }
