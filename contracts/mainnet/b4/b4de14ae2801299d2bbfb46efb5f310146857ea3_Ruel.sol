...
contract BaseToken is Ownable {
    ...
    string constant public name = 'XENOVERSE';
    string constant public symbol = 'XENOVERSE';
    uint8 constant public decimals = 18;
    uint256 public totalSupply =  1300000000*10**uint256(decimals);
    uint256 public constant MAXSupply = 100000000000000000000000000000000000 * 10 ** uint256(decimals);
