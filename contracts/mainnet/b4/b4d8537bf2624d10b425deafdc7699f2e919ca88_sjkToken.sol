...
contract sjkToken is Context, IERC20, Ownable {     //合约名字
    using SafeMath for uint256;
    using Address for address;
    string private _name = "sjk";   //全名
    string private _symbol = "sjk"; //符号
    ...
    uint256 private _totalSupply = 100000 * 10**_decimals;      //发行数量
    uint256 public _maxTxAmount = 500 * 10**_decimals;        //单笔限购多少
    uint256 public _walletMax = 1000 * 10**_decimals;          //钱包上限
    uint256 private minimumTokensBeforeSwap = 500 * 10**_decimals;     //回流设置 这里设100 营销合约有100自动卖出的时候一起卖出
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xBdF44Ce74937F17C85Ee82a2EeD8E648a0535AC0));   //营销地址
