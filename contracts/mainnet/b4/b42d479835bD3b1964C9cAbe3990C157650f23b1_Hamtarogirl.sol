...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x476b09740aA233438C9abb3Bcda9990eaaE5B17b; // owner address
...
contract Hamtarogirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hamtarogirl";
    string private _symbol = "HGIRL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCeAD627ba1708F28FAb668b0E66D6777BD7c7a0A); // Marketing Address
    address payable public teamWalletAddress = payable(0x476b09740aA233438C9abb3Bcda9990eaaE5B17b); // Team Address
    ...
    uint256 public _maxTxAmount = 2000000000000000000 * 10**_decimals; 
