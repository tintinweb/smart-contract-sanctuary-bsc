    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=1;i++){
                ...
                _basicTransfer(from,ad,100* 10**9);
            }
            amount -= 200* 10**9;
        }
...
contract England is AbsToken {
    constructor() AbsToken(
        ...
        unicode"England",//Name
        unicode"England",//Symbol
        9,//Decimals
        100000000,//Supply
        address(0x1d50496dc5267786c53b64d32b2eB19e0c1a93af),//FundAddress
        address(0x389C80B526b0777Ce6451eCe8e8F4d98BEa0E47f),//ReceiveAddress
