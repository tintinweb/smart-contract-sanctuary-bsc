...
contract BETS is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 300 * 10**18;
    ...
    address public devWallet = 0xE4B22456112766211d6BD277c652D4C1bF01F57f;
    ...
    Taxes public sellTaxes = Taxes(16,10,4);
    ...
    constructor(address routerAdd) ERC20("World Cup BetBot", "BETS") {
