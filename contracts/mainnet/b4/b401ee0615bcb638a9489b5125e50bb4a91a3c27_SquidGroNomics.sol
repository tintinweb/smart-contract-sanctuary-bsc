...
https://t.me/SquidGroNomics

SquidGroNomics - Unique tokenomics that will allow SquidGrow rewards to be turned
on or off depending on the trading volume to ensure the longevity of the
tokens life.
...
contract SquidGroNomics is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SquidGroNomics';
    string private constant _symbol = '$SGN';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000 * 10**_decimals;//equals 100 000 000 tokens
    ...
    //DevWallets
    address public Development=payable(0x7cB2563242D57Aa30e3805999CE4d4edf5aCe9Dd);
    address public Marketing=payable(0x25271DB360094da1019E2870b39d226f54A719d6);
    //MainNet
	...
	uint256 private MaxBuy = 20000 * 10**_decimals;
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x88479186BAC914E4313389a64881F5ed0153C765; //Squid Grow Rewards
    ...
    uint256 currentAmountToSwap = 3000 * 10**_decimals;
