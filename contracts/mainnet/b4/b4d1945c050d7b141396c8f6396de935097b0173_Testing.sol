...
contract DividendDistributor is IDividendDistributor {
 ...
 contract Testing is IBEP20, Auth {
    ...
    string constant _name = "TestTesttest";
    ...
    uint256 private totalFeeSell        = marketingFeeSell + reflectionFeeSell + liquidityFeeSell + ecosystemfeeSell + burnFeeSell;
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _ecosystemfeeSell, uint256 _burnFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        reflectionFeeSell = _reflectionFeeSell;
        marketingFeeSell = _marketingFeeSell;
        ecosystemfeeSell = _ecosystemfeeSell;
        burnFeeSell = _burnFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_reflectionFeeSell).add(_marketingFeeSell).add(_ecosystemfeeSell).add(_burnFeeSell);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }
