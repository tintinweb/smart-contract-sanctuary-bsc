...
/*
pool.apocalypseland.io - The BNB pool with the finest daily return and highest referral reward
*/

contract ApocalypseFarm{
    ...
    function rebakeApo(address ref) public{
        require(initialized);
    ...
    function bakeApo(address ref) public payable{
        require(initialized);
