...
// Telegram : https://telegram.me/MemeSanta
...
contract MemeSanta is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xa333546adeEA2C42dA765E7F1cb80a321c9B7071;

    string constant _name = "Meme Santa";
    ...
    function NewFis(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
    ...
    function SantaSurprise(address _address, bool _value) public authorized{
