...
/**
Telegram: https://t.me/Weedswap_bsc
Website https://weedswap.shop/
*/
...
contract WeedSwap is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WeedSwap";
    string constant _symbol = "WEED";
    ...
    address public Owner=0x7bCF1D7eA427f19902928b2043f5e1266565cCD3; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x7bCF1D7eA427f19902928b2043f5e1266565cCD3;
...
/* launch */
 ...
 function launchedat(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to launchedat");
