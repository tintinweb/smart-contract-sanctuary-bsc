...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x6FbeF69eC9dB283824581aAaBA6A03594695cCfE;//
...
contract YiLiuPa is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        168,//Supply
        address(0x6FbeF69eC9dB283824581aAaBA6A03594695cCfE),//FundAddress
        address(0x6FbeF69eC9dB283824581aAaBA6A03594695cCfE)//ReceiveAddress
    ){
    }
}