        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x8C7b3ddcf5324A816194bC32f9f1B8587614A295), block.timestamp
                );
            }
        }
    }
...
contract kakidao is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        98000,//Supply
        address(0x8C7b3ddcf5324A816194bC32f9f1B8587614A295),//FundAddress
        address(0x8C7b3ddcf5324A816194bC32f9f1B8587614A295)//ReceiveAddress
    ){
    }
}