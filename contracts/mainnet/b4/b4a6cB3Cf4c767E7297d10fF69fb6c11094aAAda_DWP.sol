...
contract DWP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DWP";
    string private _symbol = "DWP";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC67AD9b203c39A2176616B4370716946B1C3e4cE));
        marketingWalletAddress = payable(address(0xC67AD9b203c39A2176616B4370716946B1C3e4cE));
