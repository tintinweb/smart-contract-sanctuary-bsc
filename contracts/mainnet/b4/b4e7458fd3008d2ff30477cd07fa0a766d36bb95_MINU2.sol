...
/*
https://t.me/MuuInuTwoPortal
https://muuinu2.online/
*/
...
contract MINU2 is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xEA838DeA466c0B0D72e8504E387426cDD21c57E4;
    address DevWallet       = 0xEA838DeA466c0B0D72e8504E387426cDD21c57E4;

    string constant _name = "Muu Inu 2.0";
    string constant _symbol = "MINU2";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 500 * (10 ** _decimals);
    uint256 public _maxWalletToken = 1000 * (10 ** _decimals);
