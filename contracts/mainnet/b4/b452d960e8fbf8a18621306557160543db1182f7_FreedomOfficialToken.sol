...
// https://t.me/FreedomProt_Group
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface FreedomOfficial {
...
contract FreedomOfficialToken is FreedomOfficial {
    ...
    string public override name = unicode"声出し解禁";
    string public override symbol = unicode"Freedom Official";
