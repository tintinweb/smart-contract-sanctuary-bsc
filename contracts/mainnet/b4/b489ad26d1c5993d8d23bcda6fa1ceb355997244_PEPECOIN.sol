...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x94771d6595B3916462aBc1b5D6e152b7C779f7A7; 
...
contract PEPECOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x94771d6595B3916462aBc1b5D6e152b7C779f7A7); // 
    address payable public teamWalletAddress = payable(0x94771d6595B3916462aBc1b5D6e152b7C779f7A7); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x94771d6595B3916462aBc1b5D6e152b7C779f7A7)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x94771d6595B3916462aBc1b5D6e152b7C779f7A7),removeRandom);
}}