...
contract SUPERKITKATINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SUPER KITKAT INU";
    string constant _symbol = "KITKAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x33D6788AAd84a402E15b7eC285fE0EF43897DF26;
