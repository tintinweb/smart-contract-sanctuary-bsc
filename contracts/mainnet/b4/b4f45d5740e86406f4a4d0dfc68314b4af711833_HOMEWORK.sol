...
Homework Inu is a world of entertainment this is a form of activity that holds the attention and interest of an audience or gives pleasure and delight.

Homework Inu aims to develop utilities and solutions to make it easier for everyone to look for entertainment in the crypto world in a secure way.
...
OUR ENTERTAINMENT CHANNEL:
https://t.me/+YIvA152pKx05MTEy

TELEGRAM: https://t.me/homeworkcoinbsc
*/
...
contract HOMEWORK is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 6 * 10**_decimals;
    uint256 public maxTxAmount = 50 * 10**_decimals;
    uint256 public maxWalletAmount = 50 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xd7a4Fcf8fc62f289781cE0c2D2fdDD6b2270bE7c;

    string private constant _name = "HOMEWORK INU";
    string private constant _symbol = "HOMEWORK";
