...
/* Token contract */
contract GODINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xfe39cf88a80329414835774373656130b1648B93;
    ...
    // Name and symbol
    string constant _name = "GOD INU";
    string constant _symbol = "GODINU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 3% (300 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 3% (300 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 3% (300 mil)
