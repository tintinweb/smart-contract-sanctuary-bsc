...
contract HolySHIB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HolySHIB";
    string constant _symbol = "holySHIB";
    ...
    */
    ...
    function setIsLockToken(address holder, bool exempt) external authorized {
