...
contract TWITTERBUNNY is Context, IERC20, Ownable {
    ...
    string private constant _name = "TWITTERBUNNY";
    string private constant _symbol = "TBUNNY";
    uint8 private constant _decimals = 0;
    uint256 private _tTotal = 100000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 6000000000* 10**_decimals;
    uint256 public _maxTxAmount = 6000000000* 10**_decimals;
    uint256 public swapTokenAtAmount = 600000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x6C01749C4f7b12828ACC16946f5287Acc11db2E2);
    address private liquidityReceiver = address(0x6C01749C4f7b12828ACC16946f5287Acc11db2E2);
