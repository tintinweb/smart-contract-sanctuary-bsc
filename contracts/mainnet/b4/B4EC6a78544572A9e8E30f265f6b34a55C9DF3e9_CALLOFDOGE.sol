...
Call_Of_Doge is an upcoming meme token on the Binance Smart Chain network. Inspired by the popular crypto meme of the same name, the Call_Of_Doge token aims to bring humor and entertainment to the crypto space. Its unique design and community-driven approach are expected to attract a wide audience of meme enthusiasts and crypto investors. 
...
contract CALLOFDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "CALL_OF_DOGE";
