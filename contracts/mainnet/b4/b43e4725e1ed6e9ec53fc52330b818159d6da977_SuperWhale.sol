...
/**
Telegram: https://t.me/superwhalebscportal
Super Whale | Max Tax 0.3% | Max Wallet 3% | SAFU
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC1822cA98A98eAE1B73758665607faAC696e3743; // owner address
...
contract SuperWhale is Context, IERC20, Ownable {
    ...
    string private _name = "Super Whale Token";
    string private _symbol = "SWT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1822cA98A98eAE1B73758665607faAC696e3743); // 
    address payable public teamWalletAddress = payable(0xC1822cA98A98eAE1B73758665607faAC696e3743); // 
