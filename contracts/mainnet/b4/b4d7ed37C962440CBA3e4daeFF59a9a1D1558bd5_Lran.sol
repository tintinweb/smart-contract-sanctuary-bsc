...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 20221121 * 10 ** Decimals;
        walletLimit = 20221121 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x24098C0e0A784f2619590EFcB3BE1a2522ba6269;
...
contract Lran is AbsToken {
    constructor() AbsToken(
        ...
        address(0x28B86709F584c629Fbf132FC3352506C540fFfeE),
    
        address(0x8F6aE3A3f7A3635B2457492Cc00188836e84C679)
    ){
