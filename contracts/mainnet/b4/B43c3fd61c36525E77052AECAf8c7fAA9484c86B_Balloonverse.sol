...
contract Balloonverse is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.062 ether;
    uint256 public maxMints = 55;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmZx5jxTG9ixv6JUgm2iTEGaFt8PByptaQU828pQ8pB8LU/", Strings.toString(tokenId), ".json")
            );
    }
