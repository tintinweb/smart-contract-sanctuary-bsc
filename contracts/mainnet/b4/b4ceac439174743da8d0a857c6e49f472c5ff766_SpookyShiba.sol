...
contract SpookyShiba is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"SPKY";
    ...
    address private marketingWallet = 0x34Bb515617fC74F4a9519ae02c66B532c9BFe799;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 6, 3, 0);
    Fees public sellFees    = Fees(1, 6, 3, 0);
