...
contract ShortSelling is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Short selling";
    string private _symbol = "SHORT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x67Bf514E9e07b2F95C8805f9a035f60512384d1c);
