...
contract SAPEGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUID APE GROW";
    string private _symbol = "SAPEGROW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x40cF29a1fa5A886e58595461d5Dcbf8DdCBE441F); // Marketing Address BHC2
    address payable private TeamWallet = payable(0x40cF29a1fa5A886e58595461d5Dcbf8DdCBE441F); // Buy Back Address
