...
contract BamiStaking is Ownable, ReentrancyGuard {
  using SafeMath for uint256;

  // The address of the smart chef factory
  address public BAMI_STAKING_FACTORY;
  ...
  // The block number when BAMI mining ends.
  ...
  constructor() {
    BAMI_STAKING_FACTORY = msg.sender;
  }
  ...
  function initialize(
    ...
    require(msg.sender == BAMI_STAKING_FACTORY, "Not factory");
