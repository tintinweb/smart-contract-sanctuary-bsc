...
contract PaymalToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x82A65Bb61b2a0a9fD78dEd8B4274C64e79398A7f); // Marketing Address
    address payable public charityAddress = payable(0x82A65Bb61b2a0a9fD78dEd8B4274C64e79398A7f); // Charity/Dev Address
    ...
    uint256 private _tTotal = 10000000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Paymal Token";
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 1000000000000000000000000000; // 1,000,000,000; token will be given on airdrop
