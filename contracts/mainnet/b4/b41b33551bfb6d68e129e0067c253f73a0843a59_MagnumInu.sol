...
contract MagnumInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Magnum Inu"; // 
    string private constant _symbol = " $MAGNUMINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x3F5488e29B8FF185e42b6Cb9BB9eB4A6b43e839C;
