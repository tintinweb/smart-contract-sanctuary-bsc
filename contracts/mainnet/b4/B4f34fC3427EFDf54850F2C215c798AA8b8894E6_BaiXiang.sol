...
contract BaiXiang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BaiXiang";
    string private _symbol = "BaiXiang";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72DF0474EF9EBf1Af717Fe615A0d4d00f6cAEd15);
    address payable public teamWalletAddress = payable(0x72DF0474EF9EBf1Af717Fe615A0d4d00f6cAEd15);
