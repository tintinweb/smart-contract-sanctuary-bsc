...
contract SAFEMOONx3 is Context, IERC20, Ownable {
    ...
    address private x3_Marketing_Wallet = 0x6c340cb9fFC33Bf4D7059E2E8337DA4635E2566b;
    address private x3_Team_Wallet = 0x6c340cb9fFC33Bf4D7059E2E8337DA4635E2566b;

    uint256 private _max_WalletLimit = 20000000000 * 10**9;
    uint256 private swapTokensAtAmount = 3000000000 * 10**9;
    uint256 private _max_BuyLimit = 10000000000 * 10**9;
    uint256 private _max_SellLimit = 10000000000 * 10**9;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[x3_Marketing_Wallet] = true;
        _isExcludedFromFee[x3_Team_Wallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[x3_Marketing_Wallet] = true;
        allowedTransfer[x3_Team_Wallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(x3_Marketing_Wallet).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(x3_Team_Wallet).sendValue(teamAmt);
        }
    }
