...
Is a new meme token basicly from the anime RAGNAROK

Telegram : https://t.me/RagnarokINU
Website  : https://ragnarokinu.finance
*/
...
contract RAGNAROKCONTRACT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ragnarok INU";
    ...
    uint256 public _maxTxAmount = 900 * 10**7 * 10**9;
    uint256 public _walletMax = 900 * 10**7 * 10**9;
