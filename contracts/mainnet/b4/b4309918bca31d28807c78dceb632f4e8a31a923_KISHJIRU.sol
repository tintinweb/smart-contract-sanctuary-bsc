...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2a48D8696196381F41B051d8e6811FE96527C0d4;
...
contract KISHJIRU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2a48D8696196381F41B051d8e6811FE96527C0d4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**16;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KishjiruInu";
    string private _symbol = "KISHJIRU";
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**16;
    uint256 private numTokensSellToAddToLiquidity = 1000000000000000 * 10**16;
