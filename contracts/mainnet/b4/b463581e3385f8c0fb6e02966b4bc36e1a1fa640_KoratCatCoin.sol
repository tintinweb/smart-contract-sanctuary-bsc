...
contract KoratCatCoin is Context, IERC20, Ownable {
    ...
    string private _name = "KoratCatCoin";
    string private _symbol = "KCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x383c2f6607E48547370BcAf7e5145a6A72df7F81); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x383c2f6607E48547370BcAf7e5145a6A72df7F81); // buyback Address
