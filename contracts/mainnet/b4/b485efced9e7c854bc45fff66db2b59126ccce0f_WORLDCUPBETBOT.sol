...
contract WORLDCUPBETBOT is IBEP20, Auth {
    ...
    string constant _name = "World Cup BetBot";
    string constant _symbol = unicode"WCBETBOT";
    ...
    // Exclude bots
    function updateIsBlacklisted(address _address, bool _value) public onlyOwner{
