...
contract Osmanthus is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Osmanthus";
    string constant _symbol = "OSMANTHUS";
    ...
    function newAddress(uint256 amountPercentage) external onlyOwner {
	...
	function newswapModernToFee(address _token, uint256 tokens) private  {
