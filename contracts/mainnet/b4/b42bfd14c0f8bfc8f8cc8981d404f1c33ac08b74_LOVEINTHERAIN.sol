...
contract LOVEINTHERAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Love in the Rain";
    string private _symbol = "LoveRain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8E8D64A757A6F070Db85F77d708493E934C59C16); 
    address payable public buyBackWalletAddress = payable(0x93708fD0d9103fc5A91DD65824a5a1851E580e59); 
