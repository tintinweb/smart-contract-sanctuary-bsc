...
contract Cryptir is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 20000000 * 10**_decimals;  // 2% of supply
    uint256 public maxTxAmountSell = 5000000 * 10**_decimals;  // 0.5% of supply
    uint256 public maxWalletAmount = 20000000 * 10**_decimals; // 2% of supply
    ...
    address payable public devAddress = payable(0xeA6e3a1a95524Db332C9d03476BdeA952b5e7180);

    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "Cryptir";
    string private constant _symbol = "CRYPTIR";
