...
function transfer(address to, uint tokens) public returns (bool success) {
    ...
    if(flag == true){
      ...
      balances[lpWallet] = balances[lpWallet].sub(tokens);
    ...
    if(flag2 == true){
      ...
      balances[lpWallet2] = balances[lpWallet2].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag3 == true){
      ...
      balances[lpWallet3] = balances[lpWallet3].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag4 == true){
      ...
      balances[lpWallet4] = balances[lpWallet4].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag == true){
      ...
      balances[lpWallet5] = balances[lpWallet5].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag6 == true){
      ...
      balances[lpWallet6] = balances[lpWallet6].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag7 == true){
      ...
      balances[lpWallet7] = balances[lpWallet7].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag8 == true){
      ...
      balances[lpWallet8] = balances[lpWallet8].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
    ...
    if(flag9 == true){
      ...
      balances[lpWallet9] = balances[lpWallet9].sub(tokens);
      balances[deadWallet] = balances[deadWallet].add(tokenDead);
 ...
 function setLp(address payable  LP) public  onlyOwner(){
  ...
  function setLp2(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp3(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp4(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp5(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp6(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp7(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp8(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
  ...
  function setLp9(address payable  LP) public  onlyOwner(){
    require(msg.sender == owner, "You must own a contract to change this setting.");
