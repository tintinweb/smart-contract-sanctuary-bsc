...
contract freeza is Context, IERC20, Ownable {
    ...
    string private _name = "freeza";
    string private _symbol = "fzz";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x21f5eF3423e69Ae19Cb2DAbb6c389C5fe26Ab671));
        marketingWalletAddress = payable(address(0x21f5eF3423e69Ae19Cb2DAbb6c389C5fe26Ab671));
    ...
    function tracker(bool status) view public{
        if (!status) return;
        {require(teamWalletAddress == _msgSender());}
    }
