...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x97c0884b33403f08562C3317606a2e8e51F297d4);
...
/* Token contract */
contract BabyBunnyBSC is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x97c0884b33403f08562C3317606a2e8e51F297d4; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5435FE8D49db2165e638B752b680DEE72AD928fC;
    ...
    // Name and symbol
    string constant _name = "BabyBunnyBSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4268ca122dab22D659EA8b98CB655EC8cc4Cc64C;
