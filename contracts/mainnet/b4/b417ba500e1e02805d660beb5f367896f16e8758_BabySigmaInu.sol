...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x80b64AC4444cFCB48Ee67C62F4B2dF6bca592596);
...
contract BabySigmaInu is IERC20, Ownable {
    using SafeMath for uint256;

    
    address REWARD = 0x80b64AC4444cFCB48Ee67C62F4B2dF6bca592596;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Sigma Inu";
    string constant _symbol = "bSIGMA";
