...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xe7dc0D34398738003601836B550596Cec388028e;//fund address
...
contract GQJ is AbsToken {
    constructor() AbsToken(
        ...
        0,//Decimals
        100000000,//Supply
        address(0xe4B4Fab1A944C8Dd7C43cf6f848c4692B16B867A),//FundAddress
        address(0xe4B4Fab1A944C8Dd7C43cf6f848c4692B16B867A)//ReceiveAddress
    ){
    }
}