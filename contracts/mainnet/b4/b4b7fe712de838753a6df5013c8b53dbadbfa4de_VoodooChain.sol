...
contract VoodooChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Voodoo Chain"; // 
    ...
    address public  _marketingWallet = 0x8F1Dcb02b593d44577E6246Dac9404AA733988f8;
    ...
    function setTF(uint256 liFee, uint256 maFee) public onlyOwner {
        _liquidityFee = liFee;
        _marketingFee = maFee;
    }
