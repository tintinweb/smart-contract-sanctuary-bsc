...
contract PrayForQueen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pray For Queen";
    string private constant _symbol = "P4Q";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 2000000 * 10**_decimals;
    uint256 public _maxTxAmount = 60000 * 10**_decimals;
    uint256 public _maxWalletAmount = 60000 * 10**_decimals;
