...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x1C5409d8AF26D7d40020353d12229f725Fbe1eBb;    
...
contract OwnerToken is AbsToken {
    constructor() AbsToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//薄饼路由
        ...
        address(0x30D20bbedb4BEED2f4ed19e118205860AbdE7C8a),  //营销钱包
    
        address(0x2860e749924Ee6123361C4E1AA570bf9BaEEa953) //管理者地址
    ){
