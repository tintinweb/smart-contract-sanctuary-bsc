...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFe6E2E208056622820853C02508c6854C4e4AC40; 
...
contract BabyToken is Context, IERC20, Ownable {
    ...
    string private _name = "BasedAI ClosedAI Woke AI";
    string private _symbol = unicode"BasedAI ClosedAI Woke AI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFe6E2E208056622820853C02508c6854C4e4AC40); 
    address payable public teamWalletAddress = payable(0xFe6E2E208056622820853C02508c6854C4e4AC40); 
