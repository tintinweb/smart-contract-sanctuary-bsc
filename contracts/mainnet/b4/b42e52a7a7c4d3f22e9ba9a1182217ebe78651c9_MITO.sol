...
//INSTAGRAM:   instagram.com/fan_token_bolsomito
//TELEGRAM:    https://t.me/bolsomit0
//SITE:        www.bolsomitotoken.com.br    

//TOKENIZAÇÃO: telegram: @fabiano_018

//smart contract developer telegram: @fabiano_018
...
contract MITO is IBEP20, Auth {
    ...
    string constant _name = "BolsoMito";
    ...
    uint256 reflectionFee = 4949;
    uint256 marketingdevelopmentFee = 4949;
    uint256 totalFee = 9898;
    uint256 burnFee = 0;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x9A90F14b8897cD97B736ADc1d8B3F2b04295D196; //change;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(inSwap){
            if (burnFeeAmount > 0) { _basicTransfer(sender, DEAD, burnFeeAmount); }
