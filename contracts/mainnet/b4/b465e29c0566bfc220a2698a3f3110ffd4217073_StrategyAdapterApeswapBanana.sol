...
contract StrategyAdapterApeswapBanana is AlphaStrategyApeswap {
    function initialize(
        ...
        AlphaStrategyApeswap.initializeAlphaStrategy(
            ...
            _underlying,
            _vault,
            address(0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9), // Masterchef
...
contract AlphaStrategyApeswap is AlphaStrategyBase {
    ...
    function pendingXToken() public view virtual override returns (uint256) {
        ...
        (stakedToken, ) = IMasterChef(masterChef).userInfo(
            pidSecond,
            address(this)
        );
        ...
        return
            balance +
            stakedToken +
            IMasterChef(xBaseToken).pendingCake(pidSecond, address(this)) +
            IMasterChef(xBaseToken).pendingCake(pidLp, address(this));
    }
