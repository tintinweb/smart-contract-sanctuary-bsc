...
/**
C̷o̷n̷g̷r̷a̷t̷u̷l̷i̷o̷n̷s̷ o̷n̷ f̷i̷n̷d̷i̷n̷g̷ o̷u̷r̷ l̷i̷t̷t̷l̷e̷ s̷i̷d̷e̷ p̷r̷o̷j̷e̷c̷t̷
*/
...
contract BabyLucro is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY LUCRO";
    string private constant _symbol = "BABYLCR";
