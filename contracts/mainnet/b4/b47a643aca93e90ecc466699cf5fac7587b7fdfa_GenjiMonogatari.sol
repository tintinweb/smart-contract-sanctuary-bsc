...
🥁On the occasion of the GenjiMonogatari IDO on the GAGARIN
✔️LP LOCK
✔️Renounce
✔️Degen BSC Play
🥁GenjiMonogatari.io Play-To-Earn in minutes!
🥁https://GenjiMonogatari.io/
...
interface GenjiMonogatariDeployer {
...
contract GenjiMonogatari is GenjiMonogatariDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GenjiMonogatariTeam;
    address private CharityGenjiMonogatari;
    ...
    string public override name = "Genji Monogatari";
    string public override symbol = "GENJI";
    ...
    constructor(uint totalSupplyValue, address GenjiMonogatariTeamAddress, address CharityGenjiMonogatariAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GenjiMonogatariTeam = GenjiMonogatariTeamAddress;
        CharityGenjiMonogatari = CharityGenjiMonogatariAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GenjiMonogatariTeam] =  totalSupply * 45 / 100;
        balances[CharityGenjiMonogatari] = totalSupply * 45 / 100;
