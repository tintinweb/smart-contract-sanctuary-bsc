...
contract Hare
 is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x499930Cf208169766357d8B7cca3c5DEc49Eb892));
        _anotherA = payable(address(0x499930Cf208169766357d8B7cca3c5DEc49Eb892));
