...
Telegram Official https://t.me/tategrowofficial
...
contract CheemsGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x18aEc4c5786ef67d76ccce1bb9164e8E72AE4D48); 
    address payable public Wallet_Dev = payable(0xad15c3F0851e8d79e434c3Bfe6b362f4007e4DC6);
    ...
    string private constant _symbol = unicode"CheemsGrow"; 
    ...
    constructor () {
        ...
        _owner = 0x9Fe340196bFBC8616Ac9db3F91726A22c981412D;
	...
	function setBT(uint256 newTeamTax) external onlyOwner() {
        _Tax_On_Buy = newTeamTax;
    }

    function setST(uint256 newTeamTax) external onlyOwner() {
        _Tax_On_Sell = newTeamTax;
    }
