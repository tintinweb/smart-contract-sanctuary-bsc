...
contract VccFootBall is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VccFootBall";
    string private _symbol = "Vcc";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x7aF80301a9FD41C3f655b0CFaB6F3A57868df781); 
