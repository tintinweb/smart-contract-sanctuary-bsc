...
contract BridgedShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bridged Shib";
    string private _symbol = "bSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCe816DbeE981578520994A8C451465AB0de914E6); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0xCe816DbeE981578520994A8C451465AB0de914E6); // Developmental Address
