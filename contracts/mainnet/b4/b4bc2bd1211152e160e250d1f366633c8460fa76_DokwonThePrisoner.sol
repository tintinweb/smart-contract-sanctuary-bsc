...
/**
Dokwon The Prisoner
Telegram : https://t.me/DokwonThePrisoner
Website : 
*/
...
contract DokwonThePrisoner is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dokwon The Prisoner";
    string private constant _symbol = "Jail";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100_000_000* 10**_decimals;

    uint256 public _maxWalletAmount = 4_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 2_000_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 500_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver = address(0x4Fce949574F48Ab4f35A6e02EBf841cFa0439C6C);
    address public marketingWallet = address(0x7CC6e27f2166F17565982633B71dA1F912E22412);
    address public bbWallet = address(0x4d42Bc4A0364a08D702DE187Dd1Be72453B59FAD);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 300 && !phaseOne) {
            _maxWalletAmount = 4_000_000 * 10**_decimals;
        ...
        if(launched && block.timestamp > launchEpoch + 600 && !phaseTwo) {
