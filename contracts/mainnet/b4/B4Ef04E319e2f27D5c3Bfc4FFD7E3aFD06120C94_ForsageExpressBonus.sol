...
interface IForsageExpress {
    ...
    function isUsersLevelActive(address userAddress, uint8 level) external view returns(bool);
}
...
contract ForsageExpressBonus {
    ...
    function useBonus() public {
        ...
        require(!forsageExpress.isUsersLevelActive(msg.sender, 1), "levelAlreadyActivated");
