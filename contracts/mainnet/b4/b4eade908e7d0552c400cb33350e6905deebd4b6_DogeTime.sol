...
contract DogeTime is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeTime"; 
    string private _symbol = "DogeTime"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0C081175A306cFa52BE6B7FFe981F5876311212); // Marketing Address
    address payable public teamWalletAddress = payable(0x2bA927ac951245260D05B1d075eb1288a43E899e); //  Team Address
