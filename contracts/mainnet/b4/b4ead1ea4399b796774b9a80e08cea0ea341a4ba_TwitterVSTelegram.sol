...
contract TwitterVSTelegram is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterVSTelegram"; // TODO change
    string private _symbol = "TwitterVSTelegram"; // TODO change
