...
contract SquidGrowBSCBridgeContract is Ownable {
    ...
    IERC20 immutable public squidGrow;
    ...
    constructor(address _squidGrow) {
        ...
        // chainID : ETH mainnet => 1
        _processFees[1] = 0.01 ether;
        supportedTargetChains[1] = true;

        squidGrow = IERC20(_squidGrow);
        emit TargetChainAdded(1, block.timestamp);
    }
