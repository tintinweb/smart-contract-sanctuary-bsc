...
contract BEAR is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Hibernation';
    string private constant _symbol = 'BEAR';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000000 * 10**_decimals;//equals 10 000 tokens
    ...
    uint256 public gasLimit = 7000000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0x0271079556d6B0Fb49FfD5c44c2B00C15C6283e8);
    address public Marketing=payable(0x0271079556d6B0Fb49FfD5c44c2B00C15C6283e8);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTC Rewards
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Development).transfer((amount*5) / 100);
        payable(Marketing).transfer((amount*95) / 100);
    } 
    ...
    function getAlreadyPaidSharesForHolder(address holder) public view returns (uint256) {
        return alreadyPaidShares[holder];
    }


    function getToBePaidAmountForHolder(address holder) public view returns (uint256) {
        return toBePaid[holder];
    }
