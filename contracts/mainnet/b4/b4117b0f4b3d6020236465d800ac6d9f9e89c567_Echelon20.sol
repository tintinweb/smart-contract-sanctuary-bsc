...
/**
    ...
    Low tax 2.0 hype. Community driven coin 3/3. 

    TG: https://t.me/echelon2point0
...
contract Echelon20 is IBEP20, Auth {
    ...
    string constant _name = "Echelon 2.0";
    string constant _symbol = "ECH2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;     //2%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 50;   //4%
    ...
    address private marketingFeeReceiver = 0xFa176a6F62F424DE0231f1D15408d7401e9186aD;
    address private teamFeeReceiver = 0xFa176a6F62F424DE0231f1D15408d7401e9186aD;
