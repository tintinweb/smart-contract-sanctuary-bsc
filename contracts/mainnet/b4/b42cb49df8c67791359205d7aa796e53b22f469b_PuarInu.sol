...
Telegram: https://t.me/puarinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0dA26972ED4A3cCBD9D2Cf5B8A7A4A7a76297086; // owner address
...
contract PuarInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Puar Inu";
    string private _symbol = "$PINU"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dA26972ED4A3cCBD9D2Cf5B8A7A4A7a76297086); // Marketing Address
    address payable public teamWalletAddress = payable(0x2F6E818f746BCbd8cAC9d413A4C98DBCD0C8fe05); // Team Address
