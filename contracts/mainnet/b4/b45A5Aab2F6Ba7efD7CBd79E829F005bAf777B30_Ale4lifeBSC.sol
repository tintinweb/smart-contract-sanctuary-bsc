...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x54dc2baAA4b42353bD308CEe7b7AcFF5Ed6F904a;
...
contract Ale4lifeBSC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x68b49Cb49199f9c0662a378239a6Cdf67a4b543b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ale4lifeBSC";
    string private _symbol = "Ale4lifeBSC";
