...
contract StakePool is Wrapper, Ownable, Adminable {
    ...
    function setBounsTreasury(address _boundTreasury) external onlyMaster {
        BoundTreasury = _boundTreasury;
    }
    ...
    checkStart
    {
        ...
        inToken.safeTransfer(BoundTreasury, bonusAmount);
    ...
    function processReward(uint256 gas) private {
        ...
        uint256 balance = inToken.balanceOf(BoundTreasury);
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (tokenBalance > 0 ) {
                ...
                if (amount > 0) {
                    inToken.safeTransferFrom(BoundTreasury,shareHolder,amount);
                }
            }
