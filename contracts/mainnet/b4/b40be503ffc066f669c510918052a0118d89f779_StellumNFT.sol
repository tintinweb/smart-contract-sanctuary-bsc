...
contract StellumNFT is ERC721, Ownable {
  ...
  address immutable public BNB_RECEIVER_ADDRESS;
  ...
  constructor(
    ...
    BNB_RECEIVER_ADDRESS = bnbReceiverAddress;
  }

  function buy() external payable {
    require(totalSupply < Constants.NFT_MAX_SUPPLY, "NFT mux supply reached");
    require(msg.value == Constants.NFT_PRICE, "Invalid BNB amount");
    ...
    payable(BNB_RECEIVER_ADDRESS).transfer(address(this).balance);
