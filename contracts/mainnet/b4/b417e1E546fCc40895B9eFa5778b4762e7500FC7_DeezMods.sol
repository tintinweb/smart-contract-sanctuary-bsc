...
contract DeezModsDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DeezMods_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DeezMods contract."
        );
    }
 ...
 */
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "DeezMods: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DeezMods: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DeezMods: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DeezMods: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
