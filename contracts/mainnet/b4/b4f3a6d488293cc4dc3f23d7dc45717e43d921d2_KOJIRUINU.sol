...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9605E8eE3bf70531e6C837aba67319Ebb13E9cd; 
...
contract KOJIRUINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE9605E8eE3bf70531e6C837aba67319Ebb13E9cd); 
    address payable public teamWalletAddress = payable(0xE9605E8eE3bf70531e6C837aba67319Ebb13E9cd); 
    ...
    uint256 private _totalSupply = 272727 * 10**_decimals;
    uint256 public _maxTxAmount = 5800 * 10**_decimals; 
