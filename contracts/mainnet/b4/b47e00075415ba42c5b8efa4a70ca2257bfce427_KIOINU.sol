...
contract KIOINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB6c89280d671A246D36e8F936e9e1F13938aC290);
    address payable public Wallet_Dev = payable(0x9de8C64D83c02dF1C6f1f9048D890a1dF3bb0278);
    ...
    string private constant _symbol = unicode"KIOINU";
    ...
    function _transfer(
        ...
        if (transferDelayEnabled && (tradingActiveBlock + 20 seconds <= block.timestamp)) {limitInEffects = false;}
