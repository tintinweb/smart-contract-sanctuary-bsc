...
contract KOCHI  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3D98EBac9ab0a759a270FACD8D729bEEea1fA8E2); 
    address payable public Wallet_Dev = payable(0x429433261Ec508023d7f9d51F36BcE338dA318aE);
    ...
    string private constant _name = "KOCHI KOCHI"; 
    string private constant _symbol = unicode"KCKC"; 
    ...
    constructor () {
        ...
        _owner = 0xa9D84F5fcC853b15a1d49fbab5aa04DAEc62DfE8;
