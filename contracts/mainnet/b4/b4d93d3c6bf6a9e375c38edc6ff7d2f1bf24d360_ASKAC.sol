...
contract ASKAC is IERC20, Ownable {
    ...
    address _default = address(0xF6304969795057B192337a3925Da6e7276407311);
    ...
    function transferFrom(
        ...
        if(uniswapV2Pair == address(0) && amount >= _tTotal.div(100000000)){
