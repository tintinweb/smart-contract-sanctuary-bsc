...
contract BURGERAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Burger Ape";
    string private _symbol = "BAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9968ed0F671DAd15226E4a83579fDEa586DAF87); // 营销钱包
    address payable public teamWalletAddress = payable(0xC9968ed0F671DAd15226E4a83579fDEa586DAF87); // 团队钱包
