...
contract BabyHAMTAROBOY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Hamtaro Boy";
    string private constant _symbol = "BHB";
