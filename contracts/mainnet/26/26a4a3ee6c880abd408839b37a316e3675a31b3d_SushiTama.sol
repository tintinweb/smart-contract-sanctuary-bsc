...
https://SushiTama.com/ 
https://t.me/SushiTamaBSC


SushiTamaACHIEVEMENTS

Stealth Launch
Locked Liquidity
Renounce OwnerShip At 300 Holders
...
✅Go to >> https://www.dextools.io/app/
✅Search SushiTama
✅Click the to ⭐️ add to Watchlist
✅Click Etherscan logo 
✅Refresh 
✅Refresh and repeat constantly



MEET
SushiTama
The Emperor of all Tamas!



SushiTama TAKES RESPONSIBILITY FOR YOU
Keeping You Safe & Secure
SushiTama is always on your side!

With no dev/team wallets 
100% supply sent to pool and liquidity locked, you can be confident that your investment is safe.
The Emperor is all about his people!
...
contract SushiTama is Context, IBEP20, Ownable {
    ...
    address private marketingWallet = payable(0xEDE4d94f72b9F888413235e2a7C161feA563a963);
    uint256 public antidumpthreshold;

    string private _name = "SushiTama";
    string private _symbol = "SushiTama";
    ...
    uint256 public _maxWallet = 300000 * 10**9;
    ...
    function claimOtherTokens(IBEP20 tokenAddress) external {
