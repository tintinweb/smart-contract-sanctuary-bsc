...
contract RANSHAOINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x22505fDD037d03d6e956f73bce54fdF611649deb); 
    address payable public Wallet_Dev = payable(0x22505fDD037d03d6e956f73bce54fdF611649deb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 20**1 * 10**_decimals;
    string private constant _name = "RanShao Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x8646dF7264001093A1383D6557f19De17bBb3893;
