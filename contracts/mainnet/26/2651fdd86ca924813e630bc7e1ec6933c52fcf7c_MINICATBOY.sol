...
contract MINICATBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniCatBoy";
    string private _symbol = "MCATBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x728ca13F0AEdF888bd4AF0C328e881495196F795); // Marketing Address
    address payable public TeamWalletAddress = payable(0xc07B8CB33093831a63d62afAd069497Fd091C17C); // Team fee
