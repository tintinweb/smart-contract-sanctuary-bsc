...
{   
    ...
    uint256 public  pkgNo = 4000e18;
    uint256 public firstprize = 10e18;
    uint256 public second_prize = 7e18;
    uint256 public third_prize = 5e18;
    ...
    mapping(address => uint256) public NFTStakeBy;
...
function stakedIds(address add) public view  returns(uint256  [] memory)
{
    ...
    {
        UserInfo[_item].pkgNotoID += 4200;
        token.transferFrom(msg.sender,address(this),2000e18);
    }
    ...
    {  
        require(NFTStakeBy[msg.sender] == id , "you are not stake this id");
        NFT.transferFrom(address(this),msg.sender,id);
        itemNo[nftcontractaddress][id]  = 0;
        UserInfo[itemNo[nftcontractaddress][id]].pkgNotoID = 0;
        UserInfo[itemNo[nftcontractaddress][id]].activate = false;
        checkID[UserNFTIds[nftcontractaddress][id]] = false;
    }



    function enableForRace(uint256 a,uint256 b, uint256 c) public onlyOwner{
        uint id;
...
// ..............................................onlyOwner...........................................................
    ...
    function withdrawbnb(uint256 _amount ) public onlyOwner{
        ...
        function withdrawNFTbyowner(uint256 id ) public onlyOwner
    {  
        NFT.transferFrom(address(this),msg.sender,id);
    }   
function settimetoRace(uint256 a) public onlyOwner
{
    timetoRace = a;
    
}
function setpricetime(uint256 a) public onlyOwner
{
    pricetime = a;
    
}
function setPricein_token(uint256 a) public onlyOwner
{
    Pricein_token = a;
    
}
function setpkgNo(uint256 a) public onlyOwner
{
    pkgNo = a;
    
}
function setPrice(uint256 a,uint256 b,uint256 c) public onlyOwner
{
    firstprize = a;
    second_prize = b;
    third_prize = c;   
