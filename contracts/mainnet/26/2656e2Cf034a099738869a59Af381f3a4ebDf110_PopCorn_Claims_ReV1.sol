...
contract PopCorn_Claims_ReV1 is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public launchTime = 1661803200; // Mon Aug 29 2022 20:00:00 UTC+0
    uint256 public constant min = 5 ether;
    uint256 public constant max = 10000 ether;
    uint256 public roi = 22;
    ...
    constructor(address _dev,address _dev1,address _dev2) {
