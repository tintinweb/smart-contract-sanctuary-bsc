...
contract LUNCINU is Context, IERC20, Ownable {
    ...
    string private _name = "Lunc Inu";
    string private _symbol = "LUNCINU";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0x549765a6db81BFC0D728670339B624b4d9BE6024;
