...
contract ShibPoW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shib PoW";
    string private _symbol = "ShibPoW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1167f5f82D628bF99EFbBddD2116daBB3Eb51BF2); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1167f5f82D628bF99EFbBddD2116daBB3Eb51BF2); // buyback Address
