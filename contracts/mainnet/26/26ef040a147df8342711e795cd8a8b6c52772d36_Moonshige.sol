...
contract Moonshige is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonshige";
    string private _symbol = "Moonshige";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x6C0CEa1Bf296fAB92C30De8DD8DaACE7D397CbBF); // Marketing Address
