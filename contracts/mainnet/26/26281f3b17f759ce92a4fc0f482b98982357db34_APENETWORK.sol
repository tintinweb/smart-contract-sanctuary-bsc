...
contract APENETWORK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "APE NETWORK";
    ...
    address public Owner=0xAE5627510af4e254136f16e8C56A9dF056396EbC; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xAE5627510af4e254136f16e8C56A9dF056396EbC;
