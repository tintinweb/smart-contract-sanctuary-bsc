...
contract ForeverTerra is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ForeverTerra"; //name of token
    string constant _symbol = "TERRA"; //ticker of token
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3A07d14de28Ff4A3bE946b7e57Be177879d51018;
