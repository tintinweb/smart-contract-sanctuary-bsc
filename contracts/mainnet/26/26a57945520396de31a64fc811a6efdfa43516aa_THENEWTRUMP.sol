...
contract THENEWTRUMP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "THENEWTRUMP";
    //change the token symbol
    string constant _symbol = "NEWTRUMP";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xe6E54fa66dd16f54fDe353AC1c08410b9E6B46a7;
