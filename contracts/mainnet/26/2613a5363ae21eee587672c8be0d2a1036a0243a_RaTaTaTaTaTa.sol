...
//RaTaTaTaTaTa Contract //

contract RaTaTaTaTaTa is IBEP20, Ownable
{
    ...
    string private constant _name = 'RaTaTaTaTaTa';
    string private constant _symbol = '$RATATA';
    ...
    //
    address public TeamWallet=payable(0xc4049d4EB18b1306eB2853059426Fd417c06b11f);
    address public walletTwo=payable(0xd02b2269319e2c3C10cd35b42936bE5A5df75600);
    //
    //
    //
	...
	uint256 private antiWhale = 8000000 * 10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimNAN(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    //distributes bnb between marketing share 
    ...
    event OnWithdrawNAN(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimNAN(address addr) private{
        ...
        emit OnWithdrawNAN(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 12000000 * 10**_decimals;
