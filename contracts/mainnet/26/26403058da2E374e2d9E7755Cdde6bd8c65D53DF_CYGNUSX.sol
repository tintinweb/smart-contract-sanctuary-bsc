...
contract CYGNUSX is Context, IBEP20, Ownable, LockToken {
    ...
    constructor() {
        ...
        _maxWalletBalance = 15000000 * 10**_decimals; // 5% 
        _maxTxAmount = 6000000 * 10**_decimals; // 2%
        _marketingWalletAddress = 0x440a90EfbaBd86a6268736cB964C7642CeB39e34; 
        _charityWalletAddress = 0x506a1C1188b26541807Cca25172b0AB60Ea129a6; 
