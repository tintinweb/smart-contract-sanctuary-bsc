...
contract DEXIT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF56b650fB251f4d9136Cb6951279e4F4a5C7472e); // Marketing Wallet Address
    address payable public devWalletAddress = payable(0x96e56Da667F56A605c782BA9a6D4a83dA2c9dC9E); // dev Wallet Address
    ...
    string private constant _name = "DEXIT";
    ...
    constructor () {
        address _owner = 0x6b86c17f04Edb60c66C546c5305C67EF93360858;
        ...
        } else if (block.chainid == 877) {
            currentRouter = 0xCDF41F9A0e4ee47A24678fEb2a32BC5b381e5061; // Dexit Mainnet
