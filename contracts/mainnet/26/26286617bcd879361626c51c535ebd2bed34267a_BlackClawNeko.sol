...
contract BlackClawNeko is Context, IERC20, Ownable {
 
   using SafeMath for uint256;
   using Address for address;
 
   string private _name = "Black Claw Neko";
   string private _symbol = "$BCN";
   uint8 private _decimals = 9;
 
   address payable public marketingWalletAddress = payable(0xD82Ebd02e930fC16018453E41F4B34C2d3C22D8F); // Marketing Address
   address payable public DevelopmentWalletAddress = payable(0xD82Ebd02e930fC16018453E41F4B34C2d3C22D8F); // Development Address
