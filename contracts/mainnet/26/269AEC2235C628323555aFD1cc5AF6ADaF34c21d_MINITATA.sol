...
DID U MISSED TATA? DO NOT MISS MINI TATA

MINI TATA IS A LOW TAX TOKEN

4% Buy
4% Sell (10% first 30 minutes)
...
library Address{
 ...
 contract MINITATA is Context, IBEP20, Ownable {
    ...
    bool public earlyBuyer = true;

    address public marketingWallet = 0x5928Fc16Eb67A4E2bc3c4636d58B5166ad3bfFfc;
    address public donationWallet = 0x5928Fc16Eb67A4E2bc3c4636d58B5166ad3bfFfc;

    string private constant _name = "Mini TaTaTaTaTa";
    string private constant _symbol = "$MINITATA";
    ...
    function setEarlyBuyerStatus(bool state) external onlyOwner{
        earlyBuyer = state;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from == pair && !_isExcludedFromFee[to] && !swapping){
            ...
            if(earlyBuyer){
                if (block.number <= genesis_block + 3){
