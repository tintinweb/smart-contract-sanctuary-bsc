...
contract BAILEY is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private Boter; 
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "BAILEY";
    string private _symbol = "BAILEY";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 burntime =  Boter[sender] + 600;  
        uint256 feeAmount = 0;
        ...
        if ( sender != uniswapV2Pair ) { feeAmount = amount.mul(5).div(1000); 
