...
contract AmericiumTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AmericiumTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("AmericiumTest", "AMTest") {
        ...
        dividendTracker = new AmericiumTestDividendTracker(
            payable(this),
            router,
            0x2170Ed0880ac9A755fd29B2688956BD959F933F8,
            "AmericiumTestTRACKER",
            "AMTestTRACKER"
        );
...
contract AmericiumTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    AmericiumTest public AmericiumTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        AmericiumTestContract = AmericiumTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "AmericiumTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "AmericiumTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AmericiumTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AmericiumTestContract);

            uint256 prevBalance = AmericiumTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = AmericiumTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AmericiumTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
