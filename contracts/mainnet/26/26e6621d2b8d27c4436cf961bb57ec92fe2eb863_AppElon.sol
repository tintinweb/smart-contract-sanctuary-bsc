...
AppElon is the new memetrend based on Elon vs Apple fight recently.
Portal: https://t.me/AppElonBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2317167509f38bF7c5257320e3cf192c7Dbcaf76; // owner address
...
contract AppElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AppElon";
    string private _symbol = "AppElon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A6b195a223d695b620Bcb494E45ee3eeED46075); // Marketing Address
    address payable public teamWalletAddress = payable(0x5A6b195a223d695b620Bcb494E45ee3eeED46075); // Team Address
