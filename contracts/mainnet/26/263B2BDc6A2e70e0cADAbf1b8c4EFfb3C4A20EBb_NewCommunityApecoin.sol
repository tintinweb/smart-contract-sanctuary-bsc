...
/**
    #cApecoin The New Community Apecoin

   I make this #cApecoin to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/newcommunityapecoinportal

   Great features:
   2% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders

   I will add 1 BNB and 30% of the total supply to the pool
   Can you make #cApecoin 10000000X? 

   1,000,000,000,000,000 total supply
   10,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply 
   1% tokens for dev
*/
...
pragma solidity ^0.6.12;
    ...
    contract NewCommunityApecoin is Context, IERC20, Ownable {
        ...
        string private _name = 'New Community Apecoin';
        string private _symbol = 'cApecoin';
