...
/**
 * Website: https://tactus.finance
 * Telegram channel: https://t.me/tactustokenofficial
 */
...
pragma solidity ^0.8.0;
contract TACTUS is ERC20, Ownable {
    ...
    constructor() ERC20("TACTUS", "TACTUS") {
        _mint(msg.sender, 850000000000000*10**decimals());
        _mint(address(this), 150000000000000*10**decimals());
        startSale(block.number, 999999999, 0,15000000*10**decimals(), 20000000000);
        startAirdrop(block.number,999999999,1000000*10**decimals(),20000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
