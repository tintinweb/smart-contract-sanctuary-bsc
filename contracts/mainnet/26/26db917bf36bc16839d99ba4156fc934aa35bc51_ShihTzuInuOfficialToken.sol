...
// https://t.me/ShihTzuInuGlobal
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface ShihTzuInuOfficial {
...
contract ShihTzuInuOfficialToken is ShihTzuInuOfficial {
    ...
    string public override name = unicode"Shih-Tzu 🐶 Official";
    string public override symbol = unicode"Shih-Tzu 🐶";
