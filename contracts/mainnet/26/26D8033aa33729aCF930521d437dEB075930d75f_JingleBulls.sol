...
contract JingleBulls is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Jingle Bulls";
    string constant _symbol = "JINGLE";
    ...
    uint256 public extraFeeOnSell = 40;

    uint256 public totalFee = 8;
    uint256 public totalFeeIfSelling = 48;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x9C3B8B1d8787713C09f8632A71a28d7844d61453;  
        anothermarketingWallet = 0x138960b031eEF5e7CCE6290A921F1c4afb5384E7;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(4).div(8);
