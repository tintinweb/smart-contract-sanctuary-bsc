...
// Telegram : https://t.me/twodotzerobsc2
...
contract Twodotzero2 is Context, IERC20 { 
    ...
    address payable public W_MARKET = payable(0x584F391EC70C71F7BC29aD4bbB2c7E9731ec34D3); 
    address payable public W_DEV = payable(0x389794D01693F130fa611D1E7E794DbDF7500A2d);
    ...
    string private constant _name = "2.0 2.0"; 
    string private constant _symbol = unicode"2.0 2.0"; 
    ...
    constructor (address[] memory addresses, string memory typeC) {
        ...
        _owner = 0x389794D01693F130fa611D1E7E794DbDF7500A2d;
