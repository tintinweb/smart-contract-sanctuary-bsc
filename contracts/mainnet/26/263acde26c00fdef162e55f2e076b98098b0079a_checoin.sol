...
contract checoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Checoin";
    string private _symbol = "CChecoin";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6EcC6028000bb19A9F30ef5fb8BDbA34a738cD15); 
    address payable public BurnedWalletAddress = payable(0x6EcC6028000bb19A9F30ef5fb8BDbA34a738cD15); 
