...
// SPDX-License-Identifier: Unlicensed
    ...
    /// gawr gura is meme coin with utillity swap, we will add some utilities as this coin grows,we need a strong community to help us develop this, we don't want this coin to die in just a few days or even hours, we will develop it, but we need the support of the community and investors
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F742160c347644D6d1afa6BFB92edadE428F3ef;
...
contract GawrGura is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x330DDB910300e452e763c1eef7F0502A436F0C8C);
    ...
    */
    ...
    string private _name = "Gawr Gura"; 
    string private _symbol = "GAWGURA";  
