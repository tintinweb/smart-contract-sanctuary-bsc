...
contract CrogeBSC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBB4eaC3052a25982835fd463268396052D1a4E99); 
    address payable public buyBackWalletAddress = payable(0xEc557b7829F6df439065967ccD2D9D2D2E963876); 
    ...
    constructor () {
        ...
        _totalTaxIfSelling = _totalTaxIfBuying.add(_buyBackFee);
