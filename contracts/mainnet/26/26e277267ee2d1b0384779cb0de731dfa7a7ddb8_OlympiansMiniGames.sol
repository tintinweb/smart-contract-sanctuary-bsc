...
// * Olympians Mini games - fair games that pay BNB. Version 1.
//
//
...
//
// * Refer to our whitepaper for detailed description and proofs.

contract OlympiansMiniGames {
    /// *** Constants section

    // Each bet is deducted 5% in favour of the house, but no less than some minimum.
    // The lower bound is dictated by gas costs of the settleBet transaction, providing
    // headroom for up to 10 Gwei prices.
    uint constant HOUSE_EDGE_PERCENT = 5;
    uint constant HOUSE_EDGE_MINIMUM_AMOUNT = 0.0015 ether;
    ...
    uint constant MAX_AMOUNT = 1 ether;
    ...
    // 4 and 6; for games with modulos higher than threshold (Ólympians), a simple
    ...
    // threshold. On rare occasions minigames croupier may fail to invoke
    ...
    //                    by the olympians croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the olympians support, however nothing
