...
// CHANGE
contract SafeMoonBUSD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeMoonBUSD";
    string constant _symbol = "SFBUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100; // Max 4% 40,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // Max 4% 40,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xD4524156591F1C7735864423ea4593393751b5eB);
