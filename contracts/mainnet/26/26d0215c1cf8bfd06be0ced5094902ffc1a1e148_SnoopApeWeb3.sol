...
contract SnoopApeWeb3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snoop Ape Web3";
    string private _symbol = "SAPEWEB3";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe3f17DE67cBBBaDE9728Cf1dd9c0404196CBEAbB); 
    address payable public buyBackWalletAddress = payable(0xe3f17DE67cBBBaDE9728Cf1dd9c0404196CBEAbB); 
