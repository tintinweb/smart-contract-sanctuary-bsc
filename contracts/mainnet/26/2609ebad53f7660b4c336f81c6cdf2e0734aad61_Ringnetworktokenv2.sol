...
/**
 * Ring Network
 * https://t.me/RingNetwork_discussion
 * https://ringnetwork.io
 * https://twitter.com/ringnetworkbsc
*/
...
contract Ringnetworktokenv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RING NETWORK TOKEN V2";
    string constant _symbol = "RNT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5 * 10**11 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 1000; // 0.5% of supply
