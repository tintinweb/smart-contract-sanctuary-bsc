...
/*
TG: https://t.me/MetamaskInuu
WEB: https://metamuskinu.com/
*/
...
contract MetamuskInu is Context, IBEP20, Ownable {
    ...
    string private _name = "MetaMusk Inu";
    ...
    // auto liquidity
    IUniswapV2Router02 public routert;
    ...
    constructor () {
        ...
        // uniswap
        IUniswapV2Router02 _routert = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        V2pair = IUniswapV2Factory(_routert.factory())
            .createPair(address(this), _routert.WETH());
        routert = _routert;
        ...
        _isExcludedFromAutoLiquidity[address(routert)] = true;

        _isExcludedFromAntiWhale[owner()]                  = true;
        _isExcludedFromAntiWhale[address(this)]            = true;
        _isExcludedFromAntiWhale[V2pair]            = true;
        _isExcludedFromAntiWhale[address(routert)] = true;
    ...
    function setUniswapRouter(address r) external onlyOwner {
        IUniswapV2Router02 _routert = IUniswapV2Router02(r);
        routert = _routert;
    }
    ...
    function _transfer(
        ...
        if (from == V2pair && to != address(routert)) {
    ...
    function swapTokensForBnb(uint256 tokenAmount) private {
        ...
        _approve(address(this), address(routert), tokenAmount);

        // make the swap
        routert.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private returns (uint256, uint256) {
        ...
        // add the liquidity
        (uint amountToken, uint amountETH, ) = routert.addLiquidityETH{value: bnbAmount}(
            address(this),
            tokenAmount,
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2pair && recipient != address(routert);
