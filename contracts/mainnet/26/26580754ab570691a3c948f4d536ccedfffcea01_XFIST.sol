...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_, address initMarketAddress_) {
        ...
        autoSell = autoConfig(true, 5, 50000, 4000000);
...
contract XFIST is ERC20, ERC20Burnable, IDividendDistributor, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("X-FIST", "X-FIST") {
        ...
        address _initHolder = 0xaCB6e78Cb6C2f5f1c675DFD80b2f12092939699A;
        uint256 total_ = 21000000;
        _mint(_initHolder, total_ * 10 **decimals());

        fees = Fees(300, 300, 9900, 10000);
