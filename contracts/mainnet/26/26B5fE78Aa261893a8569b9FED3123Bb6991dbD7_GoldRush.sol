...
contract GoldRush is ERC20, Ownable {
    ...
    GoldRushDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Gold Rush TestTD", "GRCTestTD") {
        ...
        dividendTracker = new GoldRushDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "GoldRushTRACKERTestTD",
            "GRCTRACKERTestTD"
        );
...
contract GoldRushDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    GoldRush public GoldRushContract;
    ...
    constructor(
        ...
        defaultToken = token;
        GoldRushContract = GoldRush(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GoldRush_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GoldRush_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GoldRush contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GoldRushContract);

            uint256 prevBalance = GoldRushContract.balanceOf(address(this));
            ...
            {
                uint256 received = GoldRushContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GoldRushContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
