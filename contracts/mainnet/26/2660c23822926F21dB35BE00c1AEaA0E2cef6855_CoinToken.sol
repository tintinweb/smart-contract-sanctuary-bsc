...
contract CoinToken is IBEP20, Auth {
    ...
    string constant _name = "PI GDS";
    string constant _symbol = "PIGDS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 600000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x83c671688BB0D958F222960D29124c3Ae0e75f4f;
