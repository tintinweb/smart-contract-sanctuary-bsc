...
contract WhiteShib is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 1000; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 10; // 2% of supply
