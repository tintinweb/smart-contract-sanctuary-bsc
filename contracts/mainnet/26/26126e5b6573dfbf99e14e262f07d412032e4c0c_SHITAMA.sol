...
// Telegram : https://t.me/shitama_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39bD828557aCB0e140BCace9c571a28Ef0dB5Df5; // owner address
...
contract SHITAMA is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA SAITAMA";
    string private _symbol = "SHITAMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x072881d2c2c81fF6f6b476dc2639919277cf3f90); // Marketing Address
    address payable public teamWalletAddress = payable(0x072881d2c2c81fF6f6b476dc2639919277cf3f90); // Team Address
    ...
    uint256 public _maxTxxxAmount = 3_000_000 * 10**_decimals; 
    uint256 public _walllletMax = 9_000_000 * 10**_decimals;
