...
contract Fractest is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x83f31aefcf18BB9b1EAdCFC3f66e7B21B1E291B6));
    address payable public treasuryWallet =
        payable(address(0x7D99F46F7B2412E1a78Fa238A466134FD6407386)); 
    address public liquidityReceiver =
        0xf897ca20a7EbA29F77b36F7cb3036e95b5f53efF;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Fractest";
    ...
    constructor() {
        ...
        _isExcludedFromLimit[marketingAddress] = true;
        _isExcludedFromLimit[treasuryWallet] = true;
    ...
    function updatetreasuryWallet(address payable newAddress) external onlyOwner {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 treasuryAmt = unitBalance * 2 * (buyFee.treasury + sellFee.treasury) >
            address(this).balance
            ? address(this).balance
            : unitBalance * 2 * (buyFee.treasury + sellFee.treasury);
        ...
        if (treasuryAmt > 0) {
            treasuryWallet.transfer(treasuryAmt);
        }
    }
