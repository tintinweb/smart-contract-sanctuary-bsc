...
contract funu is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 1000000 *  10**9;  
    string private _name = "funu";
    string private _symbol = "FUNU";
    ...
    function changeowner (uint256 _number) external onlyOwner {
        require(_number < 50, "Can't go that high");
        deadblocks = _number;        
    }

    function addtokenowner() external onlyOwner {
    ...
    function blockfee(bool _enabled) external onlyOwner{
