...
contract SatomoNagatoshi is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Satomo Nagatoshi";
    string private constant _symbol   = "SaToNaGa";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 600 / 10000; // 6% of total supply
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0xfB4801922243F401866C4e16bE69D947Dbe4082C;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // categorizing the tokens before liquifying
        uint256 TokensforTeam = contractTokenBalance / 10000 * _percentageOfLiquidityForTeam;
        uint256 TokensforMarketing = contractTokenBalance / 10000 * _percentageOfLiquidityForMarketing;
        uint256 TokensForLiquidity = contractTokenBalance - TokensforTeam - TokensforMarketing;
        
        // split TokensForLiquidity balance into halves
        uint256 half      = TokensForLiquidity / 2;
        uint256 otherHalf = TokensForLiquidity - half;
        
        //checking the ratio of Tokens that will be Swaped vs the total amount
        uint256 TokensforSwap = half + TokensforTeam + TokensforMarketing;
        uint256 SwapRatio = TokensforSwap / contractTokenBalance;
        uint256 initialBalance = address(this).balance;

        swapTokensForBnb(TokensforSwap);

        uint256 newBalance = address(this).balance - initialBalance;
        uint256 bnbForTeam       = newBalance / 10000 * _percentageOfLiquidityForTeam/SwapRatio;
        uint256 bnbForMarketing = newBalance / 10000 * _percentageOfLiquidityForMarketing/SwapRatio;
        ...
        emit SwapAndLiquify(TokensforSwap, bnbAdded, tokenAdded);
    }
