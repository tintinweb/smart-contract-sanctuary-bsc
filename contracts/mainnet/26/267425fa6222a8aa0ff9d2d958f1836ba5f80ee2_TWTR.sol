...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7730ac665114c0e343B141dAaaeB097197191F8a); //DOGE
...
contract TWTR is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TWTR MUSK";
    string constant _symbol = "TWTR";
    ...
    uint256 public _walletMax = _totalSupply * 3 / 1;
