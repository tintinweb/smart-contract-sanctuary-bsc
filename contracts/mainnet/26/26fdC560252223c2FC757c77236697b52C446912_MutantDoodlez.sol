...
contract MutantDoodlez is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function airDropInitial(address _to, uint256 _mintAmount) public onlyOwner() {
    uint256 supply = totalSupply();
  ...
  function airdropMutant(IERC721 _token, address[] calldata _to, uint256[] calldata _id) public {
