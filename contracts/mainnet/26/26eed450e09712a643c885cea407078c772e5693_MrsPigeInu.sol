...
contract MrsPigeInu is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxSellTransactionAmount = 30000000000000 * (10**18);
    ...
    constructor() ERC20("MrsPigeInu", "MrsPINU") {
        liquidityFee = 2;
        TeamFee = 3;
        ...
        TeamWallet = payable(0x1e4aDfDc6B4d923D43e0c935181D82612BBE4306);
