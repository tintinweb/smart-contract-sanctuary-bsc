...
/**
BunnyHeist - is a memecoin with amazing utility as the website and its dapp continue to grow!
...
contract BunnyHeist is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BunnyHeist";
    string private _symbol = "$BHEIST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42197f195E9843e02d28c605b2C7699821c0D355); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x42197f195E9843e02d28c605b2C7699821c0D355); // BuyBack Address
