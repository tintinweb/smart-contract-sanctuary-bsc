...
contract BabyPi is Context, IBEP20, Ownable  {
    ...
    string public _name = "Babi Pi";
    string public _symbol = "bPI";
...
//web3tokeninfo
    ...
    function CirculatingSupply() external view  returns (uint256){
        return (totalSupply()  - (balanceOf(stakeWallet) + balanceOf(rewardWallet) + balanceOf(address(this))) - balanceOf(owner()) - balanceOf(presaleWallet)-balanceOf(0x77e443932A780a825e10C547454F034982523b4C))/decimal;
        //totalsupply  - staking - owner - presale -burn -unicrypt lock
    }
