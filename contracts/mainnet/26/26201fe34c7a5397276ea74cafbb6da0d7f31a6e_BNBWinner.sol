...
contract BNBWinner{
	...
	uint256 constant public CEO_FEE2 = 10;
	...
	constructor(address payable ceoAddr,address payable  ceoWallet2Addr, uint256 start) public {
		require(!isContract(ceoAddr));
		ceoWallet = ceoAddr;
		ceoWallet2 = ceoWallet2Addr;
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		uint256 ceo2 = msg.value.mul(CEO_FEE2).div(PERCENTS_DIVIDER);
		ceoWallet.transfer(ceo);
		ceoWallet2.transfer(ceo2);
