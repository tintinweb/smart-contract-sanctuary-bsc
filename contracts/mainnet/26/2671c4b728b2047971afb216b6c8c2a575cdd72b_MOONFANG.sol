...
Telegram: https://t.me/moonfangofficial
...
contract MOONFANG is Context, IERC20, Ownable {
    ...
    string private constant _name = "MOONFANG"; // 
    string private constant _symbol = "$Mfang"; //    
