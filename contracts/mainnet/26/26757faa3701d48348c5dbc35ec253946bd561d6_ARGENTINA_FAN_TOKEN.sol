...
contract ARGENTINA_FAN_TOKEN is Context, IERC20, Ownable {
    ...
    string private _name     = "ARGENTINA FAN TOKEN (BSC)";
    string private _symbol   = "AFT";  
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 20_000_000 * (10 ** _decimals);
    ...
    address public marketingWallet = 0x80D2504f7DC10Ea69d30a23EB772ddB6fCa4C853;
    address public devWallet = 0xe266133f2af66cc5be3D7511e4b25aeF60167ca6;

    address public newOwner = 0x8E45D276327752D05f250a9dA73BaE7Cc7D401c9;
