...
contract goldenchipdoge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Golden Chip Doge";
    string private constant _symbol = unicode"$GCDOGE";
    ...
    address payable public DevWallet = payable(0x09FDb820915bA64e53588c4a37d6d2D51a4dE576);
    address payable public MarketingWallet = payable(0xafBc08311847D59b889adD52D0F46333B8308C31);
