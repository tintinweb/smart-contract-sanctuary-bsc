...
*/
// THE NEWEST DRAGON MEME TOKEN ON THE BINANCE SMART CHAIN
// Telegram:https:t.me/WawelPro
...
contract WAWELPRO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WAWELPRO";
    string constant _symbol = "$WWP";
