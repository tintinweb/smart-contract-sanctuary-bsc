...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 30 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market =0x96e3Df2FE15AC5Dc63a4140C06c8CbA2731be1C0;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x96e3Df2FE15AC5Dc63a4140C06c8CbA2731be1C0),
            _msgSender(),
            _tTotal
        );
    }
