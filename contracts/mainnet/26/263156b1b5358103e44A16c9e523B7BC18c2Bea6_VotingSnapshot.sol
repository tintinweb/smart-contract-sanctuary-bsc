    ...
    ProxyImplementation
{
    ...
    bool public isClearVotesRequired;
    ...
    function setIsClearVotesRequired(bool _isClearVotesRequired)
        external
        onlyGovernance
    {
        isClearVotesRequired = _isClearVotesRequired;
    }
