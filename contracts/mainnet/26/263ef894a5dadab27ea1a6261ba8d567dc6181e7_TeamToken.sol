...
contract TeamToken is Context, IERC20, Ownable {
    ...
    string private _name = "Hmm";
    string private _symbol = unicode"Hmm";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xE78C209a16AB5Ff868D9E3592ce8A94f5BE0Dead));
        marketingWallet = payable(address(0xE78C209a16AB5Ff868D9E3592ce8A94f5BE0Dead));
