...
// We are giving Sus as a prize that's why it is called SUSprise!

// Join us: https://t.me/SUSpriseLaunch
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 SUS = IBEP20(0x30fa51fEa5536d24773E0026FB38e437cf11A33E);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = SUS.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = SUS.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           SUS.transfer(shareholder, amount);
...
contract SUSprise is IBEP20, Auth {
   using SafeMath for uint256;
 
   address SUS = 0x30fa51fEa5536d24773E0026FB38e437cf11A33E;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "SUSprise";
   string constant _symbol = "SUSPRISE";
