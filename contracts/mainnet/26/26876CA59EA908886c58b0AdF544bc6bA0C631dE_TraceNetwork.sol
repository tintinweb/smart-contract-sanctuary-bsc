...
Trace Network is a unique business model that is packaged as an enterprise-grade,
 proof-of-stake, permissionless protocol for supply chain, data management, 
 trade settlement and financing powered by DeFi and NFTs.

 https://trace.network
 https://twitter.com/trace_network
 https://t.me/tracenetwork
 https://medium.com/trace-network
...
interface TraceNetworkDeployer {
...
contract TraceNetwork is TraceNetworkDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TraceNetworkTeam;
    address private CharityTraceNetwork;
    ...
    string public override name = "Trace Network";
    string public override symbol = "Trace Network";
    ...
    constructor(uint totalSupplyValue, address TraceNetworkTeamAddress, address CharityTraceNetworkAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TraceNetworkTeam = TraceNetworkTeamAddress;
        CharityTraceNetwork = CharityTraceNetworkAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TraceNetworkTeam] =  totalSupply * 4 / 100;
        balances[CharityTraceNetwork] = totalSupply * 4 / 100;
