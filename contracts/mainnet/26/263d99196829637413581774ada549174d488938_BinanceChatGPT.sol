...
/** 
 ...
 https://t.me/BinanceChatGPT

 BinanceChatGPT is a new born meme-token based on news, $BCG will be the next top trending on BiggestBuyBot.

 We are not just a meme-token, we will develop an utility if community blow up, stay with us.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Ae08807b07dBEbc9c741D2E83675919Fec864F5; // owner address
...
contract BinanceChatGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BinanceChatGPT";
    string private _symbol = "$BCG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3Ae08807b07dBEbc9c741D2E83675919Fec864F5); // 
    address payable public teamWalletAddress = payable(0x3Ae08807b07dBEbc9c741D2E83675919Fec864F5); // 
