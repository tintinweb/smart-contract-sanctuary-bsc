...
contract UNIIKOLF is Context, IERC20, Ownable {
    ...
    string private constant _name = "UNI IKOLF"; // 
    string private constant _symbol = "IKOLF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x6330421f701c1c2D37b6Cd592eF7DDcC4981C8db;
    
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    
    bool private tStatus = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()){
            require(tStatus,"contract not ready");
        }
