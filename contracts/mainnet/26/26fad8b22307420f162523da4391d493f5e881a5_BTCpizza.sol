...
/**
As we know back in may 22, 2010. A guy named Laszlo Hanyecz, bought 2 large pizza's from Papa 
John's for 10,000 BTC! It was the first 
time ever Crypto Currency got traded for something physical in the real world! 
Ever since that day has been known as " Bitcoin Pizza Day "
So it's almost that time of the date we celebrate it again! As a celebration we decided to 
come up with a token in remembrance to that event!
 *
*/
...
contract BTCpizza is IBEP20, Auth {
    ...
    string constant _name = "BTCpizza";
