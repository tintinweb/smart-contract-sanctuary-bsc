...
Persian cat is a community-owned, our contract fully renounced and we have low tax on buys and sells. 
All taxes go back to Marketing Wallet as a reflections

Telegram : https://t.me/persiancatbsc
website : http://persiancat.ws
...
contract PersianCat is ERC20 {
    using SafeMath for uint256;
    using Address for address;
    uint256 public constant maxSupply = 100000000000 * 10**6 * 10**9;
    ...
    address public constant marketingAddress = 0x5C3736591599a06a416588456Cf0a1A9A9Cc7DC9; // Marketing Wallet
