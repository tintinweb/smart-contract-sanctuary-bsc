...
/**
🟢a new era where the real meets the virtual. Not only delivering the best 3D-game experience, MOODGE also empowers its players to roleplay and make their characters exclusively theirs in this fantasy world
...
contract MOODOGE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MOODOGE";
    string constant _symbol = "Moodoge";
