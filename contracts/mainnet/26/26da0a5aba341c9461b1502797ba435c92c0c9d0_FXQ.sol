...
contract FXQ is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "France X Qutar";
    string constant _symbol = "FXQ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5de395f6D2c1A90cfc14b474eCC85bfCdE054dc7;  // teamwallet
        lotteryWallet = 0x8065f48339900aa6A1bCA7Fa73C3AD5788EEc821;  // lotterywallet
