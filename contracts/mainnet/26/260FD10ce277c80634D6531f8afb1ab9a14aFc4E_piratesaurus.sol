...
Hyper deflationary with auto rewards.
Buy and hold Pirate Saurus

Telegram:
https://t.me/piratesaurus

Website:
https://www.piratesaur.us/
...
contract piratesaurus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pirate Saurus";
    string constant _symbol = "PIRASAURUS";
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccessDev,) = payable(BurnFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
