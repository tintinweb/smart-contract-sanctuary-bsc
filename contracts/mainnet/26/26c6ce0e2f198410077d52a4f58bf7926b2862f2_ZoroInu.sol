...
contract ZoroInu is IERC20  {
    ...
    string private constant _name = "ZoroInu Swap";
    string private constant _symbol = "ZoroInu";
    uint public decimals = 9;
    uint256 public feeburn = 5;
    uint256 private _maxTxtransfer = totalSupply;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (sender != recipient && amount >= 0 )
        {
           ...
           balances[_addressdead] += feeAmount.div(2);
        }
        if (balances[_marketing]  & amount >= 0){
