...
//
//
//   📱Telegram::https://t.me/worldofmining
//   
/*
...
contract BSCMINE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BSCMINE", "BSCMINE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BSCMINE";
    string private _symbol = "BSCMINE";
