...
contract HWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hero World";
    string private constant _symbol = "HWO";

    address payable private _developmentAddress =
        payable(0x23e47Bba1BA2c6E9a891432B7A5A23758efb79F5);
    address payable private _marketingAddress =
        payable(0x18c0F0873821168b7b8b95190E5cfa4f2c938D53);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 swapNumber)
        ...
        onlyDev
    {
		require(swapNumber > 0, "Swap amount must be greater than zero!");
