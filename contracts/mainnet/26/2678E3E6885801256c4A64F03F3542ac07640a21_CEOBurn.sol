...
Low supply, high burn.

[600,000 Total Supply]
...
Price squeeze imminent sers. 
Buy now or cry later, your choice. :)

DEV: @LacosteGod 


https://t.me/CeoBurnBSC
...
contract CEOBurn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CEO Burn";
    string constant _symbol = "CEOb";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1772;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x489f0Bff02c4E9D42Ea841428601b54a249eAA17;
        ecosystemfeeReceiver = 0x489f0Bff02c4E9D42Ea841428601b54a249eAA17;
