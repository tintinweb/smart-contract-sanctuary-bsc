...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x34A1ad1ad2f0A427E5d4a1013ACd7DC9af8B11FE;
...
contract nwnl_final is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"❌👰 No Waifu No Laifu 👰❌"; 
    string private constant _symbol = unicode"❌W❌L"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x34A1ad1ad2f0A427E5d4a1013ACd7DC9af8B11FE), BNB_Tot);
