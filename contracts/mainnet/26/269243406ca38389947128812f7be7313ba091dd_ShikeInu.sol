...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b8A6d7f80f7C1F31cE0A6F5fc293C80E0F13c6D; 
...
contract ShikeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shike Inu";
    string private _symbol = "SHIKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b8A6d7f80f7C1F31cE0A6F5fc293C80E0F13c6D); // 
    address payable public teamWalletAddress = payable(0x7b8A6d7f80f7C1F31cE0A6F5fc293C80E0F13c6D); // 
    ...
    uint256 private _totalSupply = 22222 * 10**_decimals;
