...
contract BLACKWL is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "BLACKWL";
    string constant _symbol = "BLACKWL";
    ...
    address public marketingFeeReceiver = 0x92cf908577B0303f98C4c8Ee6e48e3C81cAf24FB;
    address public buybackFeeReceiver = 0x92cf908577B0303f98C4c8Ee6e48e3C81cAf24FB;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 MAX = (_totalSupply.mul(8)).div(100);
        if (!isTxLimitExempt[sender] && amount > MAX){
