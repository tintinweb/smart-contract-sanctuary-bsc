...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5041242264F1663AC0A611bD2b971E6e1AA5DC67; 
...
contract Royce is Context, IERC20, Ownable {
    ...
    string private _name = "Rolls Royce Inu";
    string private _symbol = "Royce";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C8B3c16ECD6D910d126128AD01f8591a959B9a2); // 
    address payable public teamWalletAddress = payable(0x1C8B3c16ECD6D910d126128AD01f8591a959B9a2); // 
