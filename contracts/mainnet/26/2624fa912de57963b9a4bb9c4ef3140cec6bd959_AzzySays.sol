...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x233B55C356456693D1d14456A05DcE186a2178C0; // owner address
...
contract AzzySays is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Azzy Finance";
    string private _symbol = "AzzySays";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x233B55C356456693D1d14456A05DcE186a2178C0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C080eD46b4D6d7a4aE51E0F6761D0368Be97F7E); // Team Address
