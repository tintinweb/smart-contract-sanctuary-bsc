...
contract MoonRock is Context, IERC20, Ownable {
    ...
    string private constant _name = "Moon Rock"; // 
    string private constant _symbol = "MOONROCK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xc90414078C21a8a71714b7CC87667e11202B74fd;
