...
contract SPDXDJ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SPDXDJ";
    string public _symbol = "SPDXDJ";
    ...
    uint256 private _totalSupply = 59 * 10**18* 10**12 * 10**_decimals;
    uint256 public _maxTxAmount = 59 * 10**18 * 10**12 * 10**_decimals; 
    uint256 public _walletMax = 59 * 10**18 * 10**12 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 59 * 10**23 * 10**_decimals; 
