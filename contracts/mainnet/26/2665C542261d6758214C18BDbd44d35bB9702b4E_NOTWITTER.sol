...
contract NOTWITTER is Context, IERC20, Ownable {
    ...
    string private constant _name = "No Twitter Coin";
    string private constant _symbol = "NOTWITTER";
