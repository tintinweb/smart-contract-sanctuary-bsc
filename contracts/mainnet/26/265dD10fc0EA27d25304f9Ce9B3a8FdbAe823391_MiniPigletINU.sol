...
contract MiniPigletINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniPiglet INU ";
    string private _symbol = "MPI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xC5b65369adD0f3b3b4ccFFF7be59A348A9387f28);
