...
contract BabyDuckyInu is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _symbol = "BDuck";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 76 * 10**6 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xba8E073d0C903E81BF77eaFD8b7AF910209C89AD;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0x1d6772D3cdFE04ACF9e6f38e42Ca4d123DD45691;
