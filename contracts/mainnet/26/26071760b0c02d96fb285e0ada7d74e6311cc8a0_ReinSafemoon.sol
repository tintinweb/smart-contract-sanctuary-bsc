...
TELEGRAM : https://t.me/reinsafemoonBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7643A194455B48495a1170dB8a1c51b193a689aC; // owner address
...
contract ReinSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Rein Safemoon ";
    string private _symbol = " REINSFM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7643A194455B48495a1170dB8a1c51b193a689aC); // Marketing Address
    address payable public teamWalletAddress = payable(0x7643A194455B48495a1170dB8a1c51b193a689aC); // Team Address
