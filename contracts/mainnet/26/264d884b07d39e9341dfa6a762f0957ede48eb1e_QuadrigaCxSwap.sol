...
contract QuadrigaCxSwap is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "QuadrigaCx Swap"; // Edit Name
    string constant _symbol = "QDRGCXSWP"; // Edit Symbol
    ...
    uint256 public devFee          = 3; // Edit Dev Fee
