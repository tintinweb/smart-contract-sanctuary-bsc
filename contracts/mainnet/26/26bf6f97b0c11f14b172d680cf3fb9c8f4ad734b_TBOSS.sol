...
contract TBOSS is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee =
        teamFee.add(marketingFee).add(DividendFee).add(
            burnFee
        );
    ...
    constructor() ERC20Detailed("Twittelon Boss", "TBOSS", uint8(DECIMALS)) Ownable() {
        ...
        teamReceiver = 0x8133528e5611313C681524A332F658D49A1B014B;
        marketingReceiver = 0x973De6AbDFE3C3ed2e9194bb8B2F4F076836Fe94;  
        burnAddress = 0x000000000000000000000000000000000000dEaD;
        admin = 0x40F6E75Be215b1B3E038B333256De51098F371a6;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(marketingReceiver).call{
            value: amountETH.mul(marketingFee).div(
                marketingFee.add(DividendFee).add(teamFee)
            ),
            gas: 30000
        }("");
        ...
        try distributor.deposit {
            value: amountETH.mul(DividendFee).div(marketingFee.add(DividendFee).add(teamFee))
        } () {} catch {}        
    }
