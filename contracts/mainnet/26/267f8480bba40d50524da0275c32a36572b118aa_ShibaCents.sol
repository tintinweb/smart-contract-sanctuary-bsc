...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82E5A618cB8C27bb00E356f71bECdDd2Dbfee52B;
...
contract ShibaCents is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x82E5A618cB8C27bb00E356f71bECdDd2Dbfee52B);
    address payable private Wallet_Burn = payable(0x82E5A618cB8C27bb00E356f71bECdDd2Dbfee52B); 
    address payable private Wallet_zero = payable(0x82E5A618cB8C27bb00E356f71bECdDd2Dbfee52B); 
    ...
    */
    ...
    string private _name = "SHIBA CENTS"; 
    string private _symbol = "SHITS";  
