...
/*
芝二
✨Al Shiba Two 是一个革命性的加密项目，它结合了金融 (DeFi) 的力量和易于使用的平台的便利性。
...
contract ALSHIBA2 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "AL SHIBA2";
    string private _symbol = "ALSHIB2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xfAF08191B227dc7a9068c6fC18dbdc909E9C6f1E);
    address payable public liqWalletAddress = payable(0xfAF08191B227dc7a9068c6fC18dbdc909E9C6f1E);
