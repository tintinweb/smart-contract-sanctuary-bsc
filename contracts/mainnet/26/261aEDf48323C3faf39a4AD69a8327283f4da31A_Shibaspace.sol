...
contract Shibaspace
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "Shibaspace";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x39Ee31CD3712F32063cC8fE8F9B2789a87f755B5));
        _anotherA = payable(address(0x39Ee31CD3712F32063cC8fE8F9B2789a87f755B5));
