...
contract Ban is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,600 BAN
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1, address _devFund2, address _devFund3, address _devFund4) public ERC20("BAN", "BAN") {
        _mint(msg.sender, 1 ether); // mint 1 BAN for initial pools deployment
