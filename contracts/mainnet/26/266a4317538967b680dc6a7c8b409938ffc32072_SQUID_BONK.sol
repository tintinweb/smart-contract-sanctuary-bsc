...
Telegram : https://t.me/SQUIDBONK_BSC
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17B24e2D440dCf4b8A82598DFC53eF14cf1F8262;
...
contract SQUID_BONK is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3000 * 10**9; //
    string private constant _name = "SQUID BONK"; // 
    string private constant _symbol = "$QUIDBONK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x17B24e2D440dCf4b8A82598DFC53eF14cf1F8262);
