...
contract FUCKFTX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf6375b54b551e8Ca08638fad425cc6a98f8ebc36); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x3C82676c88121D47508603f7eC9db6ca39b30Ae2); // Reserve Wallet Address
    address payable public daoWalletAddress = payable(0x6D8AfcB1C8558eDa3a27EAaDF5EbB6b908beDcc5); // DAO Wallet Address
    address payable public devWalletAddress = payable(0xFb7FE8bD0e62B6158bd61Ca01F57EF94aa428413); // Dev Wallet Address
    ...
    string private constant _name = "FUCKFTX";
    string private constant _symbol = "FUCKFTX";
    ...
    constructor () {
        address _owner = 0x9Ed40da44cBCda4c2a17FD8dCBc226bb48656376;
