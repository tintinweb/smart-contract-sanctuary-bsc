...
/* BGMT has highly reflective GMT, the representative of WEB3.0, has a green and environmentally friendly GMT mining machine, a new generation of currency-holding GMT mining machine!
     */
      /* name_: BGMT Token  */
      /* symbol_: BGMT  */
      /* totalSupply_: 1000000000000000  */
      /* rewardAddr_GMT: 0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1  */
      /* marketingWalletAddr_: 0xAA4412b923AC71f54CbCA959B223aAf82B2768e4  */
      /* buyFeeSetting_: [10,1,1,0] (buyTokenRewardsFee、buyLiquidityFee、buyMarketingFee、buyDeadFee) */
      /* sellFeeSetting_: [10,1,1,0] (sellTokenRewardsFee、sellLiquidityFee、sellMarketingFee、sellDeadFee) */
      /* tokenBalanceForReward_: 100000000.000000000000000000  */
...
contract BGMT is ERC20, Ownable {
    using SafeMath for uint256;
