...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaA96052CbEFc4d9c8daEB069884A99E2cEFFB371;
...
contract IndependenceDayInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 6_000_000_000 * 10**9;
    uint256 public maxSellLimit = 12_000_000_000 * 10**9;
    ...
    address public DevelopmentWallet = 0xd848e42c09C509cC53F05C367c36cBB2E7E2039d;

    string private constant _name = "IndependenceDayInu";
    string private constant _symbol = "IDI";
    ...
    Taxes public taxes = Taxes(30, 30, 20, 8, 0);
    Taxes public sellTaxes = Taxes(40, 50, 30, 12, 0);
