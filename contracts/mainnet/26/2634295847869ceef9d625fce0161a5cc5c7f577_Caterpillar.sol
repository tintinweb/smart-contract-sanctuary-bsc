...
Telegram : https://t.me/CryptoBellz
...
contract Caterpillar is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xED3Ab36263809825214c0647460f7cd92f980502;
    address public donationWallet = 0xED3Ab36263809825214c0647460f7cd92f980502;


    string private constant _name = "Caterpillar";
    ...
    Taxes public taxes = Taxes(0, 0, 0, 3);
    Taxes public sellTaxes = Taxes(0, 0, 0, 3);
