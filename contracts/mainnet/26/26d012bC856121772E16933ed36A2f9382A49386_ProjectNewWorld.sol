...
contract ProjectNewWorld is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x59154fCd8A2d0344dfA720a8b19fbd2FbDF09A0E); 
    address payable public Wallet_Dev = payable(0x1A498e8067d1D442598a66e3aE51C25aEc9B71b9);
    ...
    string private constant _name = "Project New World"; 
    string private constant _symbol = unicode"NWORLD"; 
    ...
    constructor () {
        ...
        _owner = 0x493B78aC2CaA523E0622D922E8c0932E7e889641;
