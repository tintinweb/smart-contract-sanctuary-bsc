...
/*BUSD rewards for not jeeting:)
Together Cz and KHABELAME sought to make BSC better through their influence and by building and we Stan to build with theduo..
Get a bag and let's revive BSC together!
*/
...
contract CzLamebsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CzLamebsc";
    string constant _symbol = "CZL";
