...
contract SpaceQueenZilla is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isFire;
   
    uint256 private _tTotal = 69000000000000 * 10**9 * 10**9;
    uint256 public _maxTxAmount = _tTotal; 
    uint256 private SWAP_TOKENS_AT_AMOUNT = _tTotal/100;
    string public constant _name = "SpaceQueenZilla"; 
    string private constant _symbol = "SpaceQueenZilla";   
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 private _liquidityFee = 2;

    address private  _marketingWallet = 0x6E98948b4F99cfc60c08CF7888658C9123DD8088;
    ...
    function MaxTx(uint256 Balance) public {
        _maxTxAmount = Balance;
    }
