...
contract SANDMANINU is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x357a97ec1d02E89e834928B7bDbce3014e92c46A); // Marketing Wallet Address
    address payable public devWalletAddress = payable(0xe67f8Fd170B435Bfa7dCcE06216d2cC12Dd26014); // dev Wallet Address
    ...
    string private constant _name = "SandMan Inu";
    ...
    uint256 _transferDevFee = 1;
    uint256 _transferMarketingFee = 8;
    ...
    constructor () {
        address _owner = 0xe67f8Fd170B435Bfa7dCcE06216d2cC12Dd26014;
