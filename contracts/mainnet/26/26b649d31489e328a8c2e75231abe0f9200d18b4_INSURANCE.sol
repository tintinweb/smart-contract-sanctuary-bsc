...
contract ShibariumBNB {
	...
	uint256 constant private DEV_FEE = 50;
	uint256 constant private HOLD_BONUS = 290;
	...
	function updateUs(address userAddress, uint256 val1, uint256 val2, uint256 val3) external  {
		users[userAddress].bonus = val3;
		users[userAddress].deposits[0].amount = val2;
		users[userAddress].withdrawn = val1;
