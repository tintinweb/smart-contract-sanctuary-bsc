...
contract ORGVCoin is ORGVDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ORGVTeam;
    address private CharityORGV;
    ...
    string public override name = "ORGVSM ";
    string public override symbol = "ORGV";
    ...
    constructor(uint totalSupplyValue, address ORGVTeamAddress, address CharityORGVAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ORGVTeam = ORGVTeamAddress;
        CharityORGV = CharityORGVAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ORGVTeam] =  totalSupply * 4 / 100;
        balances[CharityORGV] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ORGVTeam pot
