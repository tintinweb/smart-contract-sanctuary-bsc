...
contract SNP2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SNP2";
    string private _symbol = "SNP2";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xED43aaf152a77EE79e0969eFBb45A9c5ff337b44); // Marketing Address
    address payable public teamWalletAddress = payable(0xED43aaf152a77EE79e0969eFBb45A9c5ff337b44); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xED43aaf152a77EE79e0969eFBb45A9c5ff337b44),
            block.timestamp
        );
    }
