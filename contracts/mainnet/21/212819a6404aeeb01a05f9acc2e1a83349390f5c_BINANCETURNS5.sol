...
Happy anniversary for asdasd

Twitter: https://t.me/asdasd
Telegram: https://twitter.com/asdasd
...
contract BINANCETURNS5 is Context, IERC20, Ownable {
    ...
    address private MarketingWallet=0x2bEA855a8a0b16398c03d8C30cB1418699905d45;
    ...
    string private constant _name = "BINasdS 5";
    string private constant _symbol = "BIasd5";
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _tOwned[MarketingWallet] += marketingFee + liquidityFee;
        emit Transfer (from,MarketingWallet, marketingFee + liquidityFee);
