...
Lechonk is the newest addition to the Pokemon universe, + the grow trend! Together we can make this the next meme moonshot!
...
contract LechonkGrow is Context, IERC20 { 
    ...
    string private constant _symbol = "LeGrow"; 
