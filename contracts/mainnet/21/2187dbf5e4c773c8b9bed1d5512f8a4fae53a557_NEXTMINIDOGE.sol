...
contract NEXTMINIDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEXT MINI DOGE";
    string private _symbol = "NBD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB6431151F29fA1CF6E5D3410f5E31A2Ed1b758DF); // Marketing Address
    address payable public teamWalletAddress = payable(0xB6431151F29fA1CF6E5D3410f5E31A2Ed1b758DF); // Team Address
