...
contract ElephantInu is IBEP20, Auth { // This is just contract name 
    using SafeMath for uint256;
    ...
    string constant _name = "Elephant Inu"; // Name for token here
    string constant _symbol = "EINU"; // Symbol for token 
    ...
    uint256 public totalFeeBuy = 10; //Total Fee can be whatever u want
    ...
    uint256 public totalFeeSell = 10; //Total Fee can be whatever u want
