...
contract DECENTRAWORLD30 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DECENTRAWORLD 3.0";
    string private _symbol = "DECENTRAWORLD 3.0";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd914D98b8176cc3dF7EEd1511649908c74800251));
        marketingWalletAddress = payable(address(0xd914D98b8176cc3dF7EEd1511649908c74800251));
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBLiquidity > 0 && tokensForLP > 0)
            tianjiaLiquidity(tokensForLP, amountBNBLiquidity);
    }
    ...
    function tianjiaLiquidity(uint256 daibiAmount, uint256 ethAmount) private {
