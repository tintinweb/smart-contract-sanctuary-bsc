...
contract Shaiapouf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shaiapouf";
    string private _symbol = "Shaiapouf";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeD3a2973395F7EFad6e3eeA9985E25F40Ea32012);
    address payable public BuyBackWalletAddress = payable(0xeD3a2973395F7EFad6e3eeA9985E25F40Ea32012);
