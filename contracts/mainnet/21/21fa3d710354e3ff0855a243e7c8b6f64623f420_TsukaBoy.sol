...
contract TsukaBoy is Context, IERC20, Ownable {
    ...
    string private _name = "TsukaBoy";
    string private _symbol = "TsukaBoy";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x21Aefe1489c0DE6794666015Ff2C51Fa8559c305); // Marketing Address
    address payable public teamWalletAddress = payable(0x21Aefe1489c0DE6794666015Ff2C51Fa8559c305); // Team Address
