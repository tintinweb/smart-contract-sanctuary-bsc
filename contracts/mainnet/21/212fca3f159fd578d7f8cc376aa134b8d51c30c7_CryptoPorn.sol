...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF912d3A7C3e5a644f1BA41Df11C78fC0c7D711e1; // owner address
...
contract CryptoPorn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Porn";
    string private _symbol = "Cporn";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F74fac6388dB9a9daDA33a9783784f513564588); // Marketing Address
    address payable public teamWalletAddress = payable(0x5962e7b0ae65207C2E3B1e3B5DB26FfDb131af8A); // Team Address
