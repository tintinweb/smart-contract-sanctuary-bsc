...
// Telegram : https://t.me/+OI7e4nHR7QdmZDlh
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEe65bA5132fE0C0925232374F90da970f6f88ad7; // owner address
...
contract COKEMUSSK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COKE MUSK";
    string private _symbol = "COKEMUSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C947dC25BDf75167eD1728ff1A60E4eF38c6F9c); // Marketing Address
    address payable public teamWalletAddress = payable(0x7C947dC25BDf75167eD1728ff1A60E4eF38c6F9c); // Team Address
