...
contract TwentyFourHours is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwentyFourHours"; //
    string private constant _symbol = "24Hours Coin"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x2D16e9612760a70f7B58f3f22055002fB835F80f;
