...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x032BEf8439Ca9ACA033FF43d28fA212897e9CeF5; // owner address
...
contract XYZCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x032BEf8439Ca9ACA033FF43d28fA212897e9CeF5); // Marketing Address
    address payable public teamWalletAddress = payable(0x032BEf8439Ca9ACA033FF43d28fA212897e9CeF5); // Team Address
