...
contract  Duguyue is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " Duguyue";
    string private _symbol = " Duguyue";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x3057f6fAAC7Ce3B745f62e710362e5d7B3e2cCbb);
    address payable public buyBackWalletAddress =
        payable(0xE81E2b038189a90A5B115D9DF11fa1fc6E161074);
