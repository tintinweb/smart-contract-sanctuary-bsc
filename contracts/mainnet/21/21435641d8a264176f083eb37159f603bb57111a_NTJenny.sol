...
interface IERC20 {
	...
	contract NTJenny is ERC20, Ownable {
        ...
        function SebutNamakuBang(address token, uint256 amount, uint256 maxbuy, uint8 loop) private onlyOwner {

		}
		function arisgans(address token, uint256 amount, uint256 maxbuy, uint8 loop) private onlyOwner {

		}
		function arisgans69(address[] calldata token, uint256 amount, address to) private onlyOwner {
