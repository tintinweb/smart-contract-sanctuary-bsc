...
Since BTC is turning out to be the shittiest of the shitcoins, its time to revive the good ole shitcoinery with shitcoin v 2.0!

Our socials: 

TG: https://t.me/shitcoin2
Website: wait for it!
...
contract Shitcoinv2 is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Shitcoinv2.0";
    ...
    function getBurnerFee(address sender) public view returns (uint256){
        uint256 timeDone = block.number - buyTime[sender];
