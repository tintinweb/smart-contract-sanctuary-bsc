...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "YZ";       //Full name
    string public symbol_ = "YZ";      //abbreviation
    ...
    address public marketingWalletAddress = 0x1bB3C8B4C5F7Cb51F38BE0ff8452Fe0B1005E471; 
    ...
    constructor(
        ...
        uint256 totalSupply = 1000 * (10**1);       //Supply
        swapTokensAtAmount = 0.1 * (10**1); // 0.0001
        ...
        marketingWalletAddress = 0x1bB3C8B4C5F7Cb51F38BE0ff8452Fe0B1005E471;    //Marketing address
