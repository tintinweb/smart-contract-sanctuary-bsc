...
/* Token contract */
contract loveshibainu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7A44C77C68D3d64b1D7A91b7aEE32F4d720a7011;
    ...
    // Name and symbol
    string constant _name = "LOVE SHIBA INU";
    string constant _symbol = "LOVESHIBAINU";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 134520 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 200)/1000; // 2% on launch
    uint256 public _maxSellTxAmount = (_totalSupply * 200)/1000 ; // 2% 
    uint256 public _maxWalletToken = (_totalSupply * 500)/1000; // 5%
    ...
    function Botnotsell(address _address, bool _value) public authorized{
