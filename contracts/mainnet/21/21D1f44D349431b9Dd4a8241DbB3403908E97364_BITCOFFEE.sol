...
contract BEP20 is BEPContext, IBEP20, BEPPausable {
  ...
  function _transfer(
    ...
    uint256 valueToBurn = (amount * burnRate) / 100;

    _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance") - valueToBurn;
...
contract BITCOFFEE is BEP20Detailed, BEP20 {
  constructor() BEP20Detailed("BitCoffee", "BCOFFEE", 18) {
