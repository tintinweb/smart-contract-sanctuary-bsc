...
Telegram chat : https://t.me/victorydis
...
contract VictoryDiscussCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900000000000 * 10**9;
    uint256 public _maxTxAmount = 36000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 15 * 15**9; //
    string private constant _name = "Victory Discuss Coin"; // 
    string private constant _symbol = "VII"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x455F2e3fC5fe27b6f0468Eb3697A2aa0a5188888;
