...
/**
Ape'N is a Defi Protocol that allows you to earn rewards
through staking, games, NFT's, 
...
contract test is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000 * 10**_decimals;

    uint256 public _maxWalletAmount = 900* 10**_decimals; 
