    ...
    ReentrancyGuardUpgradeable
{
    ...
    mapping(address => bool) public isAcceptableCurrency;

    function initialize() public initializer {
        __Ownable_init();
        __ReentrancyGuard_init();
        treasury = payable(0x579Fc3d837bD9B5A70F82aB42cC22671432a9265);
        fee = 10;
        _addCollectionEnumerable(0x1A76A513aaA1EC2A28feb05be181C13301d97aBa); // ghosper gen1
        _addCollectionEnumerable(0x06A9C249DB464a4441BcB5948fFE5b4B5B2f66e8); // ghosper gen2
        isAcceptableCurrency[address(0)] = true;
        isAcceptableCurrency[0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56] = true; // busd
        // isAcceptableCurrency[0x4a0Cc0876EC16428A4Fa4a7C4c300dE2DB73b75b] = true; // ghosper
    }

    function addAcceptableCurrency(address _currency) external onlyOwner {
        require(
            isAcceptableCurrency[_currency] == false,
            "ACu: Already acceptable currency"
        );
        isAcceptableCurrency[_currency] = true;
    }

    function removeAcceptableCurrency(address _currency) external onlyOwner {
        require(
            isAcceptableCurrency[_currency] == true,
            "ACu: Not acceptable currency"
        );
        isAcceptableCurrency[_currency] = false;
    }
    ...
    function _createOrder(
        ...
        require(
            isAcceptableCurrency[_currency] == true || msg.sender == owner(),
            "COd: Not acceptable currency"
        );
        require(
    ...
    function _cancelOffer(
        ...
        require(
            offer.currency == _currency && offer.price == _price,
            "XOf: Data is not sync"
        );
    ...
    function cancelOffer(
        ...
        _cancelOffer(_collection, _tokenId, _myOfferIndex, _currency, _price);
    }
    ...
    function _acceptOffer(
        ...
        if (offer.currency == address(0)) {
            ...
            IERC20(offer.currency).transfer(msg.sender, originPrice);
    ...
    function acceptOffer(
        ...
        _acceptOffer(_collection, _tokenId, _offerIndex, _currency, _price);
    }
