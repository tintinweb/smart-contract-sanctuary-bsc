...
/** 
*Bull Run Commencing....
*Telegram: https://t.me/CommunityBullRun
*/
/**
...
// File contracts/CommunityBullRun.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract CommunityBullRun is ERC20, Ownable {
    ...
    event DevTriggered(uint256 amount);

    constructor() ERC20("Community Bull Run", "CBR") {
    ...
    function DevTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        emit DevTriggered(bnbAmountInWei);
    }
}