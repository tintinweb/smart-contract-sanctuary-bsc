...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = " LonelyDoge";
    string public constant TOKEN_SYMBOL = "LonelyDoge ";  
...
contract LonelyDoge is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
    ...
    string public tokenType=" LonelyDoge ";
