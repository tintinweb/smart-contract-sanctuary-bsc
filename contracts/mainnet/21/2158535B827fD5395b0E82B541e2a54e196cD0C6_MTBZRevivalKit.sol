...
contract MTBZRevivalKit is AccessControl {
    ...
    uint256 public kitPurchaseLimit = 10000000000;
    ...
    uint256 public price_common = 0.0173121784 ether;
    uint256 public price_rare = 0.021640223 ether;
    uint256 public price_epic = 0.043280446 ether;
    uint256 public price_legendary = 0.086560892 ether;
    uint256 public price_divine = 0.129841338 ether;
    uint256 public price_immortal = 0.24963223822047875 ether;
    ...
    function retKits(address walletAddress) external view returns (uint256 _KIT_COUNT,uint256 _COMMON_KITS, uint256 _RARE_KITS,uint256 _EPIC_KITS,uint256 _LEGENDARY_KITS,uint256 _DIVINE_KITZ, uint256 _IMMORTAL_KITZ){
        return (KIT_COUNT[walletAddress],COMMON_KITS[walletAddress],RARE_KITS[walletAddress],EPIC_KITS[walletAddress],LEGENDARY_KITS[walletAddress],DIVINE_KITZ[walletAddress],IMMORTAL_KITZ[walletAddress]);
    }
    function retKitCount() external view returns(Counters.Counter memory  _kitCounter,Counters.Counter memory  _kitCounterCommon, Counters.Counter memory  _kitCounterRare, Counters.Counter memory  _kitCounterEpic, Counters.Counter memory  _kitCounterLegendary, Counters.Counter memory  _kitCounterDivine, Counters.Counter memory  _kitCounterImmortal){
        return (kitCounter,kitCounterCommon, kitCounterRare, kitCounterEpic,kitCounterLegendary, kitCounterDivine, kitCounterImmortal);
    }
