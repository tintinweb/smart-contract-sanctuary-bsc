...
contract BasicKingCobra
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Basic King Cobra";
    string private _symbol = "KingCobra";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x590B414ac7b2a50D94d5b4b31E392d8809F52ac2));
        _anotherA = payable(address(0x590B414ac7b2a50D94d5b4b31E392d8809F52ac2));
