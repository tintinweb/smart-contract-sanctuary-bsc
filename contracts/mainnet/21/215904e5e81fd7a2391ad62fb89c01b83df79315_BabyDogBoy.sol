...
contract BabyDogBoy is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1/1000 * 10**12; 
    string private constant _name = "BabyDogBoy"; 
    string private constant _symbol = "BabyDogBoy"; 
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xFE213a07A6CAe8df3e96Fdb45664f246e6380aeA;
    ...
    function excludedFromFee(address account) public returns (bool) {
