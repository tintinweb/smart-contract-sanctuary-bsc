...
contract doge is ERC20, Ownable {
    ...
    constructor() ERC20("Doge", "Doge") {
        ...
        maxTransactionAmount =  totalSupply * 1 / 100; // 100% from total supply maxTransactionAmountTxn
        maxWallet = totalSupply * 1 / 100; // 100% from total supply maxWallet
        ...
        marketingWallet = 0x575585973a79e312CFfCa0bC26189b7B9C44149F; 
