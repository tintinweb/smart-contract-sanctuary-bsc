...
// Telegram : https://t.me/AprilFoolsInuOfficial
...
contract AprilFoolsInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x701Bc9Ac06E7093186E1D3AfeaF82477688678b8); 
    address payable public Wallet_Dev = payable(0x701Bc9Ac06E7093186E1D3AfeaF82477688678b8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "April Fools Inu"; 
    string private constant _symbol = unicode"APINU"; 
