...
/**
   #🔜Pug The New Community of Ape Token
    
   I make this #🔜Pug to hand it over to the community.
   I suggest a Telegram group name for you to create: Soon Pug is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/SoonPug
...
contract SooNPug is Context, IERC20, Ownable {
    ...
    string private constant _name = "SooN Pug";
