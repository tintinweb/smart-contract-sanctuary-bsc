...
contract Quokkainu is Context, IERC20, Ownable {
    ...
    payable(0xA2048d86B523690859208fE3553308037e32d6b7);
    ...
    string private constant _name = "Quokka Inu";

    string private constant _symbol = "QUO";
...
maxTransactionAmount = _tTotal * 20 / 1000; // 20% maxTransactionAmountTxn

maxWalletAmount = _tTotal * 30 / 1000; // 30% maxWalletToken
