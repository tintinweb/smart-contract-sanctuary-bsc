...
contract LunaVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LunaVerse";
    string private _symbol = "LV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCC551A7F9d8405a84D86A9b33046303C4b72a5CE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCC551A7F9d8405a84D86A9b33046303C4b72a5CE); // BuyBack Address
