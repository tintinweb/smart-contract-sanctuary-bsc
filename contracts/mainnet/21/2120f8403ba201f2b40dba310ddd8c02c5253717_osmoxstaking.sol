...
contract osmoxstaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xc46869c706293A0F732aAc532825888Cc11F4807);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 23145031, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 23145031){
            return 0;
        }
