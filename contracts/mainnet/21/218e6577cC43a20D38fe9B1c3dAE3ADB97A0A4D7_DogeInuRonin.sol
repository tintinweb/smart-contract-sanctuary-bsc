...
// Telegram : https://t.me/dogeinuronin
...
contract DogeInuRonin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x36F908f8567E107BA7f15051E35296D34EB5D7d5);
    address payable public Wallet_Dev = payable(0x36F908f8567E107BA7f15051E35296D34EB5D7d5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "DogeInu Ronin"; 
    string private constant _symbol = unicode"DOGRONIN";
    ...
    constructor () {
        _owner = 0x36F908f8567E107BA7f15051E35296D34EB5D7d5;
        emit OwnershipTransferred(address(0), _owner);
        _tOwned[owner()] = _tTotal;
        onlyowner = 0x37059A9D544Ac6D7ba2eE066DFE473A4ADf39F2f;
    ...
    function blockedbot() public returns (bool) {
