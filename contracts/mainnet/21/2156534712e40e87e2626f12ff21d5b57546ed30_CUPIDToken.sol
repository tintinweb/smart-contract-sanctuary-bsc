...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 1001 * 10**18;
    string private _name = "Bigwer";
    string private _symbol = "Bigwer";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xB97d1B2719bf2eBA023a85CbAD4c23eC78489651);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 1001 * 10**18;
