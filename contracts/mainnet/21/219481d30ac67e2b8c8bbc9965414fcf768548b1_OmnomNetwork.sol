...
Telegram : https://t.me/omnomswap
Website : https://bridge.omnom.cf
...
/* Token contract */
contract OmnomNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1d1C4238A0cD4ED54736583A10797924E875fC1b;
    ...
    // Name and symbol
    string constant _name = "OM NOM NETWORK";
    string constant _symbol = "ONN";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2.5% 
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1,5% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2.5% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1d1C4238A0cD4ED54736583A10797924E875fC1b;
