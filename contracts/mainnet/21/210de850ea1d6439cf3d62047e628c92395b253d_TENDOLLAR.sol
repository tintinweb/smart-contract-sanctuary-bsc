...
contract TENDOLLAR is IBEP20, Ownable {
    ...
    string constant _name = "10 Dollar"; // 
    ...
    uint256 public SellteamFee         = 29;
    uint256 public SelltotalFee        = SellliquidityFee + SelldevFee + SellmarketingFee + SellteamFee;

    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (50); 
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (50); 
    uint256 public _maxWalletToken = _totalSupply / (100) * (50); 

    address private autoLiquidityReceiver = 0xAF9430308fa0a0aAB4D113F2cE2E4577DEA8E1b0; 
    address private marketingFeeReceiver = 0xAF9430308fa0a0aAB4D113F2cE2E4577DEA8E1b0; 
    address private devFeeReceiver = 0xAF9430308fa0a0aAB4D113F2cE2E4577DEA8E1b0; 
    address private teamFeeReceiver = 0xAF9430308fa0a0aAB4D113F2cE2E4577DEA8E1b0; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xAF9430308fa0a0aAB4D113F2cE2E4577DEA8E1b0;
