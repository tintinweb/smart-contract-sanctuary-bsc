...
contract OLDIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OLDIC";
    string private _symbol = "OLDIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13ed33172788D16BDe28E08a0e759Bc513d29a41); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x13ed33172788D16BDe28E08a0e759Bc513d29a41); // Development Address
