...
contract MUSKBUCK is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MUSK BUCK";
    string private _symbol = "MUSK BUCK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xebEdA58E351d8a19255E7D9F4F64E065147724B4);
    address payable public liqWalletAddress = payable(0xebEdA58E351d8a19255E7D9F4F64E065147724B4);
    ...
    uint256 public _maxTxAmount =   26666 * 10**_decimals;
    uint256 public _walletMax =     35555 * 10**_decimals;
