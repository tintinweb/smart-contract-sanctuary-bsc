...
/**
 * @title Wrapped IQ.Cash
 * @dev Implementation of the Wrapped IQ.Cash
 */
contract OortDigital is Ownable, Blacklistable, BEP20Mintable, BEP20Burnable {

    constructor (
    )
        BEP20("Oort Digital", "ORT")
    {
        _setupDecimals(18);
        _mint(_msgSender(), 22000000000000000000000000);
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        require(!isBlacklisted(from), "BEP20WithSafeTransfer: invalid sender");
        require(!isBlacklisted(to), "BEP20WithSafeTransfer: invalid recipient");
    }
}