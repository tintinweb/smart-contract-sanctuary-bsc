...
contract TheWeb3Project is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "The Web3 Project";
    string private constant _symbol   = "$WEB3";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 2500; //LP tax is whatever is left remaining of 10,000, if marketing is 4000 and team is 4000, auto LP would be 2000
    uint256 private  _percentageOfLiquidityForMarketing = 5500;
...
//Remove from Blacklist 
    ...
    function setProtection(address _protection, bool _call) external onlyOwner {
        ...
        if (_call)
             antisnipe.setTokenOwner(msg.sender, uniswapV2Pair);
    }
