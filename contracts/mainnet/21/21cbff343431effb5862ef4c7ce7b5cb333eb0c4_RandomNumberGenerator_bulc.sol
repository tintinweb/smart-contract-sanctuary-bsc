...
// File: bullcoin/pred/RandomNumberGenerator.sol
...
// File: contracts/interfaces/IBULCLottery.sol

pragma solidity ^0.8.4;

interface IBULCLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in BULC per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in BULC token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInBulc: price of a ticket in BULC
...
contract RandomNumberGenerator_bulc is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    using SafeERC20 for IERC20;

    address public BULCLottery;
     ...
     * @param _seed: seed provided by the BULCLottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == BULCLottery, "Only BULCLottery");
    ...
    /**
     * @notice Set the address for the BULCLottery
     * @param _BULCLottery: address of the BULCLottery
     */
    function setLotteryAddress(address _BULCLottery) external onlyOwner {
        BULCLottery = _BULCLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBULCLottery(BULCLottery).viewCurrentLotteryId();
    }
}