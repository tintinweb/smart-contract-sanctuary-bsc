...
contract ZoaVesting1Seed is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting1Seed: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting1Seed: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting1Seed: wrong TGE timestamp");
        ...
        // rounds settings
        // (80000 + 76667 * 12) / 1e6 = 1.000004 ==> 1.0
