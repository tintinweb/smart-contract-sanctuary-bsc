...
contract T214 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "214";
    string private _symbol = "214";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x8e02BB78B37630A43694A90B06717D429b15bf04); 
    address payable public teamWalletAddress = payable(0x8e02BB78B37630A43694A90B06717D429b15bf04); 
   ...
   uint256 public _airDropFee = 6;
    ...
    uint256 private _totalSupply =  2140 * 10**_decimals;
    uint256 public _maxTxAmount =   2140 * 10**_decimals; 
