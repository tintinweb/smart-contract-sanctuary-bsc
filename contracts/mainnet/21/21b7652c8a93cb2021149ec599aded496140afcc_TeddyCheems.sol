...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7Aac3484f3fFca31f52fc0De05C49ecEc4F42F9; // owner address
...
contract TeddyCheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teddy Cheems";
    string private _symbol = "TCheems";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c7C08Fa8151336b94E69034c355322564290d64); // Marketing Address
    address payable public teamWalletAddress = payable(0x6c7C08Fa8151336b94E69034c355322564290d64); // Team Address
