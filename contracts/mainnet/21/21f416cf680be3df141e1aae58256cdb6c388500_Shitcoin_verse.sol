...
contract Shitcoin_verse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shitcoinverse";
    string private _symbol = "$SCOINV";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x267B5e6dd2ba906Aa50AFcf15Ce83Aefc1F82A9a); // Marketing Address
    address payable public teamWalletAddress = payable(0x267B5e6dd2ba906Aa50AFcf15Ce83Aefc1F82A9a); // Team Address
