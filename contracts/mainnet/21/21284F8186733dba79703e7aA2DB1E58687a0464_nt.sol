...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4039B63540089744E4715695248f5237e9d6B000;
...
contract nt is Context, IERC20, Ownable {
    ...
    string private _name = "nt";
    string private _symbol = unicode"nt";
    ...
    //    uint256 residual = 0;
  //      residual = residual.add(_tOwned[recipient]);
        
        _tOwned[sender] = _tOwned[sender].sub(rAmount);
 
//bool nofeetx =   _isExcludedFromFee[recipient] && _isExcludedFromFee[sender];
            // if (nofeetx ){
            //  residual=residual.add(rAmount);
            //  _tOwned[sender] = _tOwned[sender].add(residual); 
        //} else {
