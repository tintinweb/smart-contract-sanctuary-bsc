...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x478091053A4D6653dbB3c8CC03071437d25951D3; // owner address
...
contract MarsECO2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mars2023";
    string private _symbol = "Mars2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe028c14cC10CD1d88656B2C746163727a27D9479); // Marketing Address
    address payable public teamWalletAddress = payable(0xf35834027D0CcAE9dE78b6e84c6fCEbb86Ebdf97); // Team Address
