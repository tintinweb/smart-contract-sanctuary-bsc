...
contract TFISTQ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TFISTQ";
    string private _symbol = "TFISTQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4A36814bc3374517c6b32EcAE07EAbf676cc1FA); // Marketing Address
    address payable public teamWalletAddress = payable(0xf4A36814bc3374517c6b32EcAE07EAbf676cc1FA); // Team Address
