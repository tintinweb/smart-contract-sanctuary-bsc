...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        fundAddress = 0x2FA38c1464C4884B9957335C72aC07522c340D76;
        ...
        holderRewardCondition = IERC20(USDTAddress).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x2FA38c1464C4884B9957335C72aC07522c340D76;
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        6,
        1000000,
        address(0xd67CB4Aca10E048C8E605fAA111aE5a9143B218e)
    ){
