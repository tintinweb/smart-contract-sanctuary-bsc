...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //SHIB
...
contract BabyShibChain is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby ShibChain";
    string constant _symbol = "BSC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerFactory = 0xaf531851672d868B1e273a02D9B998B069BE8573;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken =   0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; //SHIB
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x96b4458a1f1A2515c9711708aB8E67BEe77F1Cd0;  // teamwallet
        lotteryWallet = 0x96b4458a1f1A2515c9711708aB8E67BEe77F1Cd0;  // lotterywallet
