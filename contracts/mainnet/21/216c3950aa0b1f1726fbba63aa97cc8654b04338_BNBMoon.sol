...
contract  BNBMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**22;
    uint256 public _maxTxAmount = 1000000 * 10**22; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**22; //
    string private constant _name = unicode"BNB Moon"; // 
    string private constant _symbol = unicode"BNB Moon"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x80538E09e382dfD2b1Ea3FaDc675447B9F00305e;
