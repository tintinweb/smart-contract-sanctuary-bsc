...
contract PiYYDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pi YYDS";
    string private _symbol = "Pi YYDS";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xad9aEa32FF2BC8DBF62d040DBA79539f7Da6C8dC); 
    address payable public BurnedWalletAddress = payable(0xad9aEa32FF2BC8DBF62d040DBA79539f7Da6C8dC); 
