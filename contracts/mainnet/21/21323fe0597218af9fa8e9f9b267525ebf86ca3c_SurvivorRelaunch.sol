    ...
    IERC20MetadataUpgradeable
{
    ...
    function _fixOne() external onlyOwner {
        address[5] memory holders = [
            0x5Cd1C35fF2fb682a3299D507158fdBEE54161540,
            0x95da242C0D589D101023E35064c8d847D7EA3982,
            0x000000000000000000000000000000000000dEaD,
            0x56Cb0196AF5466A758459e80a10aF3fEBC2B98a4,
            0xEF43539D183C0c5E11880683d6ceE1Ade484d7F9
        ];

        for (uint256 i = 0; i <= 10; i++) {
            if (_tierShares[i] > 0) {
                _tierShares[i] /= 10**18;
                _sharesPerFragment[i] = _tierShares[i] / _tierSupply[i];
            }
        }

        for (uint256 j = 0; j <= 4; j++) {
            _shareBalances[holders[j]] /= 10**18;
        }
    }
