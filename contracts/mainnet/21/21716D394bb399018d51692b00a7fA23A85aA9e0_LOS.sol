...
contract  LOS is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xC816CEC9ae7Fbe50454Cbe8fd2eaF714f4CCc4ee;
    address public reward = 0x78C35f9941CA7845FDD2Da593D12dE50Ec26B334;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 3*10**4 * 10**18;
    ...
    constructor() public ERC20("Legend Of Spark", "LOS",18) {
        ...
        _balances[owner()] = (1*10**7) * (10**18);
          emit Transfer(address(0), owner(), (1*10**7) * (10**18));
    }
  ...
  function  setswapTokensAtAmount(uint256 amount)public onlyOwner(){
    ...
    function swapTokensForUSDC(uint256 tokenAmount) private {
        ...
        uC.backUsdt();
        uC.destroy();
        uint allBalance = IERC20(USDT).balanceOf(address(this));
        IERC20(USDT).transfer(reward,allBalance.mul(liquidityFee).div(totalFees));
        IERC20(USDT).transfer(market,allBalance.mul(marketingFee).div(totalFees));
    }
