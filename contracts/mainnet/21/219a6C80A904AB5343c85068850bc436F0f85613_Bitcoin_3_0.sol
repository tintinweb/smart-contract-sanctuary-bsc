...
/**
 * https://t.me/FlokiInu20
 * If you missed all the other Flokis that mooned then don't miss this one.
 */
...
contract Bitcoin_3_0 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0x97e506974f35a202A1ac7fbcf20E5CBe674980De;

    string constant _name = "BTC 3.0";    
    string constant _symbol = "BTC 3.0";
