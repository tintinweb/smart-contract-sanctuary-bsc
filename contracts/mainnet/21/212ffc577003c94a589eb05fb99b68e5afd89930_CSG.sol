...
contract CSG is ERC20 {
	...
	address _fundAddress = address(0x90b17860272eC9BF41c920245E5CF9AF8A0Fe663);
	address _noshareAddress = address(0x5e232Ec84e4552aab59Ba320BAC2E97A0224992B);
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
			...
			if(isDelLdx){
				if(startTime.add(21 * 86400) > block.timestamp){
					delldxRate = 84;
				}
			}else{
			}
