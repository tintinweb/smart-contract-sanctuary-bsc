...
contract BNBReborn is Ownable {
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0xFeb5C52b772f5e60c8A4E0920444E2d1AEC77F94);

    
    address payable constant public MARKETING_ADDRESS = payable(0x9F6E98562Dcb0195F415edEA0126A7503def2d73);
    uint256 constant public MARKETING_FEE = 1000;
    address payable constant public PROMOTION_ADDRESS = payable(0x74b84549e9a24D649164A42c9AeE747b308f07B4);
