...
contract DogeVerified is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6528AEDba43a46c8E4ebA0473ccEBcbC4174C08a); 
    ...
    string private constant _name = "Doge Verified"; 
    string private constant _symbol = unicode"DOGE VERIFIED FOR $8";
    ...
    address payable public pancakeRouterLockedLP = payable(0x4AdDfa33D98F7EcD7f5Bc7BF7C7627679C0b12A0);
    ...
    constructor () {
        ...
        _owner = 0x4AdDfa33D98F7EcD7f5Bc7BF7C7627679C0b12A0;
