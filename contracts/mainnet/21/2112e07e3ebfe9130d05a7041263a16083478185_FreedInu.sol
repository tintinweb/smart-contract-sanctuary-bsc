...
contract FreedInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Freed Inu";
    string private _symbol = "FreedInu";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1126c3De94F10E3Cb22CfcA04Dc7574b57c2ef99);
    address payable public developmentWalletAddress = payable(0x1126c3De94F10E3Cb22CfcA04Dc7574b57c2ef99);
