...
contract CuteBotic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x467F92998E1128b0834742F60E9a5f36C6f9EaaC); // Marketing Address
    ...
    string private _name = "CuteBotic";
