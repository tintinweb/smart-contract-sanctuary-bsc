...
//https://t.me/meowgicalbsc
//https://twitter.com/meowgical_bsc
//https://meowgical.site
...
contract MeowGical is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MeowGical";
    string private _symbol = "MeowG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14cb840822B84E95eA1ecd72438d6DAd940ec4C4); 
    address payable public teamWalletAddress = payable(0x14cb840822B84E95eA1ecd72438d6DAd940ec4C4); 
