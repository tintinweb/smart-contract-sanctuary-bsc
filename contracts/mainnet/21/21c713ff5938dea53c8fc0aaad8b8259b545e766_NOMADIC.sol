...
contract NOMADIC is Context, IBEP20, Ownable, ReentrancyGuard{ 
    using SafeMath for uint256;

    address RWRD                                = (0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
    address WBNB                                = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address ecosystemReceiver                   = 0xc708993cbED370D8F2374d3cA1A3260267375B1F;
    address developmentReceiver                 = 0xD01e6B3eC7aF119418ACb2b23d8985c4044374BF;

    string constant _name                       = "NOMADIC";
    string constant _symbol                     = "NOMADI"; 
    ...
    uint256 public ecosystemFee                 = 500;
    ...
    uint256 public totalFee                     = rewardFee + ecosystemFee + developmentFee + liquidityFee;
    uint256 public totalSellFee                 = sellRewardFee + sellEcosystemFee + sellDevelopmentFee + sellLiquidityFee;
    ...
    constructor () {
        ...
        isFeeExempt[ecosystemReceiver]              = true;
        isFeeExempt[developmentReceiver]            = true;

        isTxLimitExempt[msg.sender]                 = true;
        isTxLimitExempt[address(this)]              = true;
        isTxLimitExempt[ecosystemReceiver]          = true;
        isTxLimitExempt[developmentReceiver]        = true;
        ...
        isBuyCooldownExempt[ecosystemReceiver]      = true;
        isBuyCooldownExempt[developmentReceiver]    = true;
        ...
        isMaxWalletExempt[ecosystemReceiver]        = true;
        isMaxWalletExempt[developmentReceiver]      = true;
    ...
    function setFees(uint256 _rewardFee, uint256 _sellRewardFee, uint256 _ecosystemFee, uint256 _sellEcosystemFee, uint256 _developmentFee, uint256 _sellDevelopmentFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalFee                = _rewardFee + _ecosystemFee + _developmentFee + _liquidityFee;
        totalSellFee            = _sellRewardFee + _sellEcosystemFee + _sellDevelopmentFee + _sellLiquidityFee;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _ecosystemReceiver, address _developmentReceiver) external onlyOwner {
