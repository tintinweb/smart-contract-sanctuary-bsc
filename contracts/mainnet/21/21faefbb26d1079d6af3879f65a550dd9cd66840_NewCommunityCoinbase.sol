...
https://t.me/NEWCOMMUNITYCOINBASE
...
contract NewCommunityCoinbase is IBEP20, Auth {
    ...
    address DEV = 0xFC9B75767524B00bBFeA5E35adD52B5a1c7BF333;
    ...
    // Name and symbol
    string constant _name = "New Community Coinbase";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2.5% on launch or 2M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2.5% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2dD448B930410B442d5b4749e9d2F3F3b9d339A5;
