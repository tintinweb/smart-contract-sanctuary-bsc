...
Welcome to Baby Chimmy Inu

Join our telegram community at-> https://t.me/babychimmyinuofficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x1788ecc78c12B2d78db9c352e1379e02e61A4B5E); // Chimmy Inu
...
contract BabyChimmyInu is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x1788ecc78c12B2d78db9c352e1379e02e61A4B5E; // Chimmy Inu
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Chimmy Inu";
    string constant _symbol = "bCHIMMY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 6 )  / 300; // 2%
    ...
    uint256 public totalFeeSell = 15; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x5e85EDCB6f84c1CA764d7a00700De9e8369e94Ef;
        ...
        marketingFeeReceiver = 0x01af59E9a8d5512BA1F1d0E1dBFDf2Bf8B94402F;
        teamFeeReceiver = 0xdFd1029B67ECE745eA2a286D12fFDbf25890aEA6;
        giveawayFeeReceiver = 0x01af59E9a8d5512BA1F1d0E1dBFDf2Bf8B94402F;
