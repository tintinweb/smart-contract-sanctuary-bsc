...
/**
 Coomer Inu
 TICKER: COOM
 "He is not a man, he is the darkness that dwells within men"
...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d); //the reward token you want distributed 
...
contract CoomerInu is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x16FDFf9d30C4850695861fEd9478B1821dA85Ac4;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string _name = "NullUntitled";
 string _symbol = "NULL";
...
internalThreshold.mul(dynamicLiquidityFee).div(totalFee).div(2);
...
external authorized {
 ...
 function setTokenName(string calldata _newName, string calldata _newSymbol) external onlyOwner {
 _name = _newName;
 _symbol = _newSymbol;
 }
