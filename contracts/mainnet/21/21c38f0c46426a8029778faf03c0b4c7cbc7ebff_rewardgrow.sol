...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWRD = IBEP20(0xaFb64E73dEf6fAa8B6Ef9a6fb7312d5C4C15ebDB);
...
/* Token contract */
contract rewardgrow is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWRD = 0xaFb64E73dEf6fAa8B6Ef9a6fb7312d5C4C15ebDB; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xE5e3B6BE2754578a176728ccFbfA796AA88e3525;
    ...
    // Name and symbol
    string constant _name = "reward grow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // .1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x476B9d217648B33906610D96af685e2b7662ee2D;
