...
contract Flokimooni  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Flokimooni';
    string private constant _symbol = 'Flokim';
    ...
    uint256 _minTokenAmount = ( _totalSupply * 30 ) / 100000;
