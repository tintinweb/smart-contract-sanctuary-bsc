...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB6af289261580aC0D9b55d8d9E11253f3546546B; // owner address
...
contract Kojiro is Context, IERC20, Ownable {
    ...
    string private _name = "Kojiro";
    string private _symbol = "KOJIRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93a62743cedCdae504F9AafCE768AEEB998616a2); // Marketing Address
    address payable public teamWalletAddress = payable(0x93a62743cedCdae504F9AafCE768AEEB998616a2); // Team Address
