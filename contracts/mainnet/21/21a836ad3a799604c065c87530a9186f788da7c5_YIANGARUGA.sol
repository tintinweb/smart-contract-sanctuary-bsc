...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5C71EeC962Eff0bcaC083cFd19D9c64F541dF245;
...
contract YIANGARUGA is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Yian Garuga"; 
    string private constant _symbol = unicode"$YGA"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5C71EeC962Eff0bcaC083cFd19D9c64F541dF245), BNB_Tot);
            }
