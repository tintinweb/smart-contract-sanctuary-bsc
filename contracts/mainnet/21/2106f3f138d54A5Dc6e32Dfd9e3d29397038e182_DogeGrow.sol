...
/**
     DOGE GROW
    Doge Grow is The next evolution of a reflection token on the Binance Smart Chain.
Doge Grow will reward 2% of the transactions in awesome rewards on Dogecoin.
    This utilities and others to-be-announced will bring the Crypto Community together,
and will provide an unbelievable passive income to new investors.

Other Utilities Doge Grow
*Doge Swap
*Staking (APY 999%)
*Nft Marketplace
*Multi Wallet

 * Telegram: https://t.me/dogegrowPortal
 * Website : http://dogegrowtoken.com
 * Twitter : https://twitter.com/doge_grow
...
contract  DogeGrow is IBEP20, Auth {
    ...
    address DEV =  0x2c2847f1Db47517C4b36649fd4BBdD1d1D9e9725;
    ...
    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals); // KILL ZERO
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2c2847f1Db47517C4b36649fd4BBdD1d1D9e9725;
