...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD6bdB676bAB69C49C9b599002f113f350C2CaF5; // owner address
...
contract ShoryuKen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shoryuken Inu";
    string private _symbol = "ShoryuKen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x080ff196C47E83Fe430abe60faaf84b9F0a29b8c); // Marketing Address
    address payable public teamWalletAddress = payable(0xcD6bdB676bAB69C49C9b599002f113f350C2CaF5); // Team Address
