...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF56853c4D121779346dD1caf6C4be9c7746F1f2d; // Dev
...
contract ELECTRANETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELECTRA NETWORK";
    string private _symbol = "$ELECTRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF56853c4D121779346dD1caf6C4be9c7746F1f2d); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x3c3C7E8C6ac638136CfC55D34d7a7f4d37dbdB27); // Team Wallet
