...
/**
🐅BigCatCoin - Launching Soon!🐅

😿Why get all those small pussy tokens when you can hold

 🐅BIGCATCOIN 🐅

⚠️Aggressive Marketing Tax
💯Chunky LP Tax
💠Honest Team Tax (no dev wallets or marketing wallet rug!)

🔊Launch VC
🔒LP Locked (extended at treshold)
🗿Team is Solid! (CareBearBTC)

🚧Join this launch now for a secure degen play and real moonshot potential!🚧
...
contract BIGCATCOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x80270aD466E4dc7801547d2D05207d58863D409E;
    ...
    // Name and symbol
    string constant _name = "BIGCATCOIN";
    string constant _symbol = "BIGCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x46172D153d7A94C7dE50b921c305aE742682E355;
