...
Telegram : https://t.me/Fifa_WinnerBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6BdaE4dF5e1608D806a0a49F83803D1237d5a85; // owner address
...
contract FifaWinner is Context, IERC20, Ownable {
    ...
    string private _symbol = "$FIFAWIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6BdaE4dF5e1608D806a0a49F83803D1237d5a85); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6BdaE4dF5e1608D806a0a49F83803D1237d5a85); // Team Address
