...
library Address{
 ...
 contract VendettaDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vendetta DAO";
    ...
    Taxes public taxes = Taxes(0, 6, 1, 3);
    Taxes public sellTaxes = Taxes(0, 6, 1, 3);
