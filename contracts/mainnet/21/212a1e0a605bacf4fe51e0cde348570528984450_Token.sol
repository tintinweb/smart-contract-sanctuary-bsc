...
contract Token is ERC20Detailed, Ownable {
    ...
    address public _marketingWallet = 0x994253007b13Bb734467880759a92661c9C858ac;
    address public _foundationWallet = 0x994253007b13Bb734467880759a92661c9C858ac;
    address public _holder = 0x994253007b13Bb734467880759a92661c9C858ac;
    ...
    constructor() ERC20Detailed(_name,_symbol, uint8(DECIMALS)) {
        ...
        _owner = 0x0CAC27d7d414E240382b12102344880735244106;
    ...
    function takeFee(
        ...
        // uint256 public burnFee = 10;//1% 
        // uint256 public foundationFee = 20;//2% 
         _totalFee = liquidityFee.add(marketingFee).add(tokenRewardFee).add(foundationFee);//when sell token .
         if (marketingFee > 0) {
