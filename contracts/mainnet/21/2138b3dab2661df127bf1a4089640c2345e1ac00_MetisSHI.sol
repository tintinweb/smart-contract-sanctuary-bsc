...
Metis 🌿
@MetisDAO
Powering the Web3 Economy through trustless and decentralized collaboration.
Shina
@ShinaToken
Hi! My name is Shina and I have a crush on Shiba! No tax, Shib clone, burned liquidity pool, 29% supply burned and incredible community! 💕 Join the movement!
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextBep20BNB {
...
contract OwnableBep20BNB is ContextBep20BNB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBep20BNB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBep20BNB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract MetisSHI is ContextBep20BNB, Bep20BNB, OwnableBep20BNB {
    ...
    string private _name = 'Metis SHI';
    string private _symbol = '$MetisSHI';
