...
contract ZillaDogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ZillaDogeDividendTracker", "ZillaDoge_DividendTracker") {
        claimWait = 600;
        minimumTokenBalanceForDividends = 1000 * (10**decimals()); //must hold 10000+ tokens
    }
...
contract LaeebKing is ERC20, Ownable {
    ...
    address public marketingWallet = 0xEF2745768af42aE13e9f551AF9810A1A66F97b92;
    address public buybackWallet = 0xEF2745768af42aE13e9f551AF9810A1A66F97b92;
    ...
    uint256 public accBuybackFee = 0;
    ...
    constructor() ERC20("LaeebKing", "LaeebKing") {
        ...
        address tokenOwner = 0x339782eECaac0e026F7aE18BE382fF5eA2Af2E26;
        ...
        _isExcludedFromMaxHoldLimit[address(0xdead)] = true;

        excludeFromAllLimits(owner(), true);
        excludeFromAllLimits(tokenOwner, true);
        
        excludeFromAllLimits(address(this), true);

        canTransferBeforeTradingIsEnabled[owner()] = true;
        canTransferBeforeTradingIsEnabled[tokenOwner] = true;

        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _mint(tokenOwner, 1000000 * (10**decimals()));
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || pancakePair == from) {
            takeFee = false;
        }
        if(takeFee) {
            uint256 forBuyback;
