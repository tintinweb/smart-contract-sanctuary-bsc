...
contract CUBEToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CUBE";
    string private _symbol = "CUBE";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xF4b27bef964a62ed40da700F00b682fD374870ea); 
    address payable public marketingAddress2 = payable(0xF4b27bef964a62ed40da700F00b682fD374870ea); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xF4b27bef964a62ed40da700F00b682fD374870ea);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
    address DOGEAddress = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    uint256 private minimumTokensBeforeSwap = 20000*10**8 * 10**_decimals; 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            fromAddress = sender;
            toAddress = recipient;  
           if(IERC20(DOGEAddress).balanceOf(address(this)) >= minDOGEVal && LPFeefenhongTime.add(minPeriod) <= block.timestamp) {
    ...
    function process(uint256 gas) private {
        ...
        uint256 nowbananceEth = IERC20(DOGEAddress).balanceOf(address(this));
        uint256 gasUsed = 0;
        ...
        uint256 amount   = balanceOf(shareholders[currentIndex]).mul(divper).div(magnitude);
         ...
         if(IERC20(DOGEAddress).balanceOf(address(this))  < amount )return;
    ...
    function distributeDividend(address shareholder ,uint256 amount) internal {
        IERC20(DOGEAddress).transfer(shareholder, amount);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 backLpTokenNum = tAmount.mul(0).div(1000);
        uint256 fenhongTokenNum = tAmount.mul(600).div(1000);
        uint256 marketNum1 =  tAmount.mul(200).div(1000);
        uint256 marketNum2 =  tAmount.mul(200).div(1000);
        ...
        uint256 markentBNB = amountBNB.mul(4000).div(10000);
        uint256 fenhongBNB = amountBNB.mul(6000).div(10000);
