...
contract HippoSwap is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HippoSwap";
    string constant _symbol = "HSW";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7385DD66CCfB66Fb2304BfC37f6BA4c2618a88e1;
