...
contract AmericanGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "American Grow";
    string private _symbol = "AmericanGrow";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e); // Marketing Address
    address payable public DevWallet = payable(0x13452671C9F7bda3CE05df7a879bF46567E3BA96); // Team Address
    ...
    mapping (address => bool) public isNotAllowed;
    ...
    uint256 public _maxTxAmount = _totalSupply.div(33); 
    uint256 public _walletMax = _totalSupply.div(33);
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _devFeeReceiver) external onlyOwner() {
        ...
        DevWallet = payable(_devFeeReceiver); 
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isbot[sender], "account is bot");
        //check bots
        ...
        require(!isNotAllowed[recipient] && !isNotAllowed[sender], 'Address is Declined');
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(DevWallet, amountBNBTeam);
    ...
    //manage address
    function AddressNotAllow(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isNotAllowed[addresses[i]] = status;
        }
    }
