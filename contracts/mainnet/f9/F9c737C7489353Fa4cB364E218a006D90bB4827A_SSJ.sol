...
contract SSJ is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "SSJ";       //Full name
    string public symbol_ = "SSJ";      //abbreviation

    uint256 public deadFee = 5;       //Destroyed
    uint256 public liquidityFee = 10;      //LP reflow
    uint256 public marketingFee = 25;      //marketing
    ...
    uint256 public maxburn = 887 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x61185b38B624Ef681a5e07b3438659D2A55053D7;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 888 * (10**18);       //Supply
