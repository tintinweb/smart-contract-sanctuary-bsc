...
/**
Telegram: t.me/BeanzFactory
Website: www.BeanzFactory.com
*/
...
contract BeanzFactoryToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beanz Factory";
    string private _symbol = "Beanz";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xc8c83711a1Af0ED7725cf1Df2a0d3Ee5f8373356);
    address payable public teamWalletAddress = payable(0xc8c83711a1Af0ED7725cf1Df2a0d3Ee5f8373356);
