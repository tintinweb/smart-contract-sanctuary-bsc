...
Telegram https://t.me/QIUSTREAM
Website http://qiustream.com
*/
...
contract QIUSTREAM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QIUSTREAM";
    string private _symbol = "$QIUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFF0Ca8A703AAa15B5D751eB5B1A7245eA0e25c7e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFF0Ca8A703AAa15B5D751eB5B1A7245eA0e25c7e); // BuyBack Address
