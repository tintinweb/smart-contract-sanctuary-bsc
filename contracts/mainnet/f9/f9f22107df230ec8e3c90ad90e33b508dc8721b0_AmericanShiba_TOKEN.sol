...
/**
Welcome to AmericanShiba TOKEN!
...
contract AmericanShiba_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "AmericanShiba";
    string private constant _symbol = "AMSHIBA";
