...
//https://t.me/KABOSUCryptoBSC
//https://twitter.com/kabosumama/status/1587573927995674624/photo/1
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAFE7FA9AeAC80B3d5B23869ec1608e3de1a4DFEb; 
...
contract KABOSU  is Context, IERC20, Ownable {
    ...
    string private _symbol = "KBSU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE84FB2778C92FDC6093e14279971191e1E7C1BeB); 
    address payable public teamWalletAddress = payable(0xAFE7FA9AeAC80B3d5B23869ec1608e3de1a4DFEb); 
    ...
    uint256 public _totalTaxIfSelling = 46;  
