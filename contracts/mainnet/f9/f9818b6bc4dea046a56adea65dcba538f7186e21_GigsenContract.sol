...
contract GigsenContract is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 70000000 * 10**9;
  string private _symbol = "GIGSEN";
  string private _name = "Gigsen";
