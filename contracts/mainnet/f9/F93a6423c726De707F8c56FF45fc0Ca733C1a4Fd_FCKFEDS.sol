...
library Address{
 ...
 contract FCKFEDS is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 15000 * 10**9;
    uint256 public maxWalletLimit = 30000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xb0b7d0BA4faA25f574C62EDBA35aedBeE9d3d857;
    address public donationWallet = 0xb0b7d0BA4faA25f574C62EDBA35aedBeE9d3d857;

    string private constant _name = "FCKFEDS";
    string private constant _symbol = "$FCKF";
