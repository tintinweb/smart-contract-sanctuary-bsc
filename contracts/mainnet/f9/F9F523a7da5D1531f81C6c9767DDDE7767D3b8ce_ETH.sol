...
contract ETH
 is Context, IERC20, Ownable {
    ...
    string private _name = "TSUKAv2";
    string private _symbol = "TSUKAv2";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x28F18f5D36087Ba46EBa3bCAe12A43a36CDb885b));
        _metawallet = payable(address(0x28F18f5D36087Ba46EBa3bCAe12A43a36CDb885b));
