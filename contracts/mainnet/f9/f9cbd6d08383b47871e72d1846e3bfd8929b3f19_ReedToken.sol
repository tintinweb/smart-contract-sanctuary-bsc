...
contract ReedToken is Context, IBEP20, Ownable {
    ...
    string private _name = "ReedToken";
   ...
   //* function rescueBNBFromContract() external onlyOwner {address _owner = _msgSender();_owner.transfer(address(this).balance);}
