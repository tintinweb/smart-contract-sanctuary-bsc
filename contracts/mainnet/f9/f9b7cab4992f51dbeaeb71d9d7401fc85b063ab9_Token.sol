...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 3310*(10**_decimals);
    ...
    uint256 public txBuyFee = 600;
    uint256 public txSellFee = 600;
    uint256 public rewardBuyFee = 300;
    uint256 public rewardSellFee = 300;
    uint256 public txFee = txBuyFee.add(txSellFee);
    ...
    address public _marketWallet = 0x81499596214B9de65837AFA3c7aC5Ae58BAd08e7;
    address public _ecoWallet = 0x18Ab9eabe358cfe23d878eb2872f229c9bBFDd75;
    address public _marketWallet2 = 0xCD3b975B59506CD3568ca59bfbbe92952CB958C7;
    ...
    constructor() ERC20("T331", "T331") {
        if (block.chainid == 56) {
            ...
            tokenB = address(0xBF315cc904A85e0a2CCD5a3ad848cF063Fea93D5);
            // tokenB = uniswapV2Router.WETH();
        }
        ...
        excludeFromFees(address(_ecoWallet), true);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[from]) {
                ...
                if (transferFee > 0) {
                    uint256 rewardTokens = amount.mul(transferFee).div(10000);
                    tokens = tokens.sub(rewardTokens);
    ...
    function _swap() private lockSwap {
        ...
        uint256 tt = IERC20(tokenB).balanceOf(address(this));
        if (tt == 0) {
            return;
        }


        IERC20(tokenB).transfer(_ecoWallet, tt.mul(100).div(txBuyFee));
        IERC20(tokenB).transfer(_marketWallet, tt.mul(70).div(txBuyFee));
        IERC20(tokenB).transfer(_marketWallet2, tt.mul(130).div(txBuyFee));
