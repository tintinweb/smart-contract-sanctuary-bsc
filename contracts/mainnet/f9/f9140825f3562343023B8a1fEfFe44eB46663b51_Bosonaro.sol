...
contract Bosonaro
 is Context, IERC20, Ownable {
    ...
    string private _name = "Bosonaro";
    string private _symbol = "Bosonaro";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xf9dE75b8A51AE91304Bd808A238eb0bBcc60DBaB));
        _anotherA = payable(address(0xf9dE75b8A51AE91304Bd808A238eb0bBcc60DBaB));
