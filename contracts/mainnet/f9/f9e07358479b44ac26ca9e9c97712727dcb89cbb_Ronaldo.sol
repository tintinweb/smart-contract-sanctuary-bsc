...
contract Ronaldo is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xD0E66d781dd0F474DCda080cc4a7653d92d78e3b;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1961063170;
    mapping(address => address) public inviter;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("Ronaldo", "Ronaldo") {
    ...
    function _transfer(
        ...
        if(takeFee && !isSw) {
        	...
        	amount = amount.sub(lpfees).sub(invitefees).sub(invitefees).sub(invitefees);
