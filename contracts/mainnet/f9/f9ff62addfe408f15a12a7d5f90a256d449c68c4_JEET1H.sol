...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        emit OwnershipTransferred(address(0x1F81E86B8806a0c0fF313E8c5cdD122A5b1C9c95), msgSender);
    }
...
contract JEET1H is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jeeted in 1 hour";
    string private _symbol = "JEET1H";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA63377b85B982F2ae0b961b7D742c74b1fCF82F0); 
    address payable public teamWalletAddress = payable(0x1F81E86B8806a0c0fF313E8c5cdD122A5b1C9c95); 
    ...
    uint256 public _walletMax =  40000000 * 10**9; 
