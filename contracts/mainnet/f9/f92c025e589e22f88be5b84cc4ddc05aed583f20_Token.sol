...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1588 * 10**9;

    string private _name = "KH";
    string private _symbol = "KH";
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x1bFFcd2dB7d868c004CE2AFcfcDE1aF53C821b09),
            _msgSender(),
            _tTotal
        );
    }
