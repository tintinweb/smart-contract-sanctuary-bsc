...
library Address{
 ...
 contract ANTIBOT is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1000000000 * 10**9;
    uint256 public maxSellLimit = 1000000000 * 10**9;
    uint256 public maxWalletLimit = 1000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x824EA4051CD431CCae9ff4eE4cF50F5B195a8043;
    address public developmentWallet = 0x824EA4051CD431CCae9ff4eE4cF50F5B195a8043;
    ...
    Taxes public sellTaxes = Taxes(0, 2, 4, 0);
    ...
    function multitransferTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
