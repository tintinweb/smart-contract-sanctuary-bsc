    ...
    OwnableUpgradeable
{
    ...
    uint256 private _currentStartTokenId;
    ...
    event ERC721BatchMintStartTokenIdUpdated(uint256 value);
    // ------------------------------------------------------------------------
    // Initializer
    // ------------------------------------------------------------------------
    ...
    function updateStartTokenId(uint256 newStartTokenId) external onlyOwner {
        require(_currentIndex == 0,'Mint Started.');
        _currentStartTokenId = newStartTokenId;
        _currentIndex = _currentStartTokenId;
        emit ERC721BatchMintStartTokenIdUpdated(_currentStartTokenId);
    }
