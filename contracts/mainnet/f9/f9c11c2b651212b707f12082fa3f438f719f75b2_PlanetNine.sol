...
/**
 *Submitted for verification at BscScan.com on 2022 March 06
*/
...
contract PlanetNine is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 9000000000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Planet Nine";
    string private _symbol = "Planet9";
    ...
    uint256 public _maxTxAmount = 9000000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 900000 * 10**9 * 10**9;
