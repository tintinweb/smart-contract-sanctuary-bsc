...
It's a new day filled with new possibilities!
With this new dawn comes new promises of earnings beyond compare.
Low tax. Based team.  LP locked.  Ownership renounced.
This is a community-driven token that has every potential to succeed.
Together, we can emerge triumphant in a season when bulls have hibernated and bears have come out to prowl.
UST Two Point Zero is going To The Moon!
...
TG: https://t.me/USTtwopointzero
Twitter : https://twitter.com/USTtwopointzero
...
contract UST2   is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UST2.0";
    string private _symbol = " UST2";
    ...
    uint256 private numTokensSellToAddToLiquidity = 900 * 10**9;
