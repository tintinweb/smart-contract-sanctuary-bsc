...
/**
 * TELEGRAM: HTTPS://T.ME/MYAToken
  
 * TWITTER INFLUENCERS MARKETING After Launch
 * REWARD
 * 4% BTC REWARD - 5% MARKETING - 4% DEVELOPEMENT
 * TOKENOMICS
...
contract MYATOKEN is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "MYA TOKEN";
    string constant _symbol = "MYA";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 52) / 100; 

    // Detailed Fees
    uint256 liquidityFee = 1;
    uint256 reflectionFee = 4;
    uint256 marketingFee = 9;
    uint256 totalFee = liquidityFee + reflectionFee + marketingFee; //Total Fee 14%
    
    // Fee Receiver
    address private marketingFeeReceiver = 0x59C6480cD0d04B4B9738474B73926C241260c15a;
