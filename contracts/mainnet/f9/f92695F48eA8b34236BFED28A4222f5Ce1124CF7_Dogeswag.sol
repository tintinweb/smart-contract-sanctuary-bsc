...
contract Dogeswag is IBEP20, Auth {
    ...
    string constant private _name = "DogeSwag";
    ...
    address public marketingFeeReceiver = 0xa2112D6F57b6f9617b11d395025f9d11A52a5a61;
    address public devFeeReceiver = 0x137CD38Ad631491e9Fc89C0CcD47345e5F833A0c;
   ...
   function UpdateMaxWalletBalance(uint256 amount) external onlyOwner() {
    ...
    function UpdateMaxTxAmount(uint256 amountBuy) external authorized {
