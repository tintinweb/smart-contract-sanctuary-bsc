...
Telegram : https://t.me/ramboak47official
...
contract RAMBOAK47 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x45DA3E0AF4ABA20a6b5816Ee3081c977C343AfA1); 
    address payable public Wallet_Dev = payable(0x45DA3E0AF4ABA20a6b5816Ee3081c977C343AfA1);
    ...
    string private constant _name = "RAMBO AK47"; 
    string private constant _symbol = unicode"RAMBOAK47"; 
    ...
    uint256 public Tax_on_liqdt = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Tax_on_Brn = 0;             
    ...
    constructor () {
        ...
        _owner = 0x45DA3E0AF4ABA20a6b5816Ee3081c977C343AfA1;
    ...
    function xautoblockedBots() public returns (bool) {
        Percent_Dev = 0;
        Tax_on_liqdt = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Tax_on_Brn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Tax_on_liqdt / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Tax_on_liqdt + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Tax_on_liqdt + Percent_Marketing + Percent_Dev);
