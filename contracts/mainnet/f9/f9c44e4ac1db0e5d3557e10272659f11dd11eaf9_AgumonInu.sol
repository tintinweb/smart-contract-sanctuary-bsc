...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63097e0C9572df33C31E55ec91746122D45Dc787; 
...
contract AgumonInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "AGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50F214A104402501c29776dA099AA7f29Da4643f); // 
    address payable public teamWalletAddress = payable(0x63097e0C9572df33C31E55ec91746122D45Dc787); // 
