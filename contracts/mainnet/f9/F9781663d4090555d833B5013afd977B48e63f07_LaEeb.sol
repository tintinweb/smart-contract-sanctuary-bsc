...
contract LaEeb is IERC20, Ownable {
    ...
    address public marketAddress = 0x2d6B4Cc0fcB0D93619177B80F7F29F5bA4fA881b;
    ...
    mapping (address => bool) public isBlist;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(!isBlist[sender] && !isBlist[recipient], "in blist");
    ...
    function setBlist(address a, bool b) external onlyOwner {
        isBlist[a] = b;
    }
