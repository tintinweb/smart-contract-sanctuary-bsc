...
contract MicroPenisInu is IERC20, Ownable
{
    //@TresFlames
    //mapping
    ...
    //strings
    string private constant _name = 'MicroPenis Inu';
    string private constant _symbol = '$MPI';
    //uints
    uint private constant DefaultLiquidityLockTime=7 days;
    uint public constant InitialSupply= 1_000_000_000_000 * 10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=55 seconds;          
    ...
    function SetProjectWallet(address _address) public onlyOwner{
