...
/*
BNBRising envisions a release of a website that would help theinvestor manage and take account of their funds every now and then.

This vision promotes a total transparency between the developerand the investors. Through this, positive community relationshipwill prevail.

Our main goal is to put up a renowned token in cryptospace and toprovide a growing fund investment for our holders, through vastmarketing expansion!
*/
...
contract BNBRising is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BNBRising"; // TODO change
    string private _symbol = "$BNBR"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdd8FAD6CcEF80294e90728F0CE336Ae972b42630); // Marketing Address
    address payable public buybackWalletAddress = payable(0xdd8FAD6CcEF80294e90728F0CE336Ae972b42630); // Buyback Address
