...
interface IERC20 {
  /**
   * @dev Returns the amount of tokens in existence. Recoded for Bep-20 By BlockChainGuru
   */
...
contract BitLibra is Context, IERC20 {
    ...
    uint256 private startingSupply = 200_000_000;

    string private _name = "BitLibra";
