...
/*
    Batman Grow
    https://t.me/BatmanGrow
    $BAT token is specifically the new and only token in the BSC network.
    The team's previous projects have reached Million Mcap despite the current market conditions.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x081f1ECf5468B0F8Ba1D3AeF517Dd64722597C51; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x081f1ECf5468B0F8Ba1D3AeF517Dd64722597C51); // Marketing Address
    address payable public teamWalletAddress = payable(0x081f1ECf5468B0F8Ba1D3AeF517Dd64722597C51); // Team Address
