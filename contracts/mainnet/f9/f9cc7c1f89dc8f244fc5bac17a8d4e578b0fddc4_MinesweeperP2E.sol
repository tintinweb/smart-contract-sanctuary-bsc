...
/*
    ...
    __  ________   ______________       __________________  __________          ___      
   /  |/  /  _/ | / / ____/ ___/ |     / / ____/ ____/ __ \/ ____/ __ \   ____ |__ \ ___ 
  / /|_/ // //  |/ / __/  \__ \| | /| / / __/ / __/ / /_/ / __/ / /_/ /  / __ \__/ // _ \
 / /  / // // /|  / /___ ___/ /| |/ |/ / /___/ /___/ ____/ /___/ _, _/  / /_/ / __//  __/
/_/  /_/___/_/ |_/_____//____/ |__/|__/_____/_____/_/   /_____/_/ |_|  / .___/____/\___/ 
                                                                      /_/                

                                                                            
TELEGRAM https://t.me/minesweeperbsc                                                                      
...
contract MinesweeperP2E is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'Minesweeper P2E';   // Name
	string constant _symbol = 'MINE';    // Symbol
	uint8 constant _decimals = 18;         // Decimals

    uint256 private constant _totalSupply = 1_000_000_000 * (10 ** _decimals); 
    uint256 public  constant _maxWalletLimit = 500_000_000 * (10 ** _decimals); 
    ...
    uint256 constant marketingFeeSell  = 1500;
    uint256 constant totalFeeSell      = 1500;
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0xE0bA70d5173973Abe3A88f88cB7aF91d8c6Ce66C;
        marketingFeeReceiver = 0xE0bA70d5173973Abe3A88f88cB7aF91d8c6Ce66C;
