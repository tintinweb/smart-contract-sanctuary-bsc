...
contract BabyMrTweet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Mr.Tweet";
    string private constant _symbol = "BMTweet";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 10000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 300000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 300000000000 * 10**_decimals;
