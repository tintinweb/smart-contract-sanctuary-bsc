...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7dfdb6816ae8BBbcc42f22528413452D8e5B6e22; // owner address
...
contract AlphaGrow is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa2Aaa8F2b1f7e7098A4a098999Ee90301f296bB8); // Marketing Address
    address payable public teamWalletAddress = payable(0xa2Aaa8F2b1f7e7098A4a098999Ee90301f296bB8); // Team Address
