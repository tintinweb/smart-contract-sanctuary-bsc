...
`MM\     `M'                         `MM\     `M'                          
 MMM\     M                           MMM\     M                           
 M\MM\    M ___   ___ ___  __    __   M\MM\    M ___   ___ ___  __    __   
 M \MM\   M `MM    MM `MM 6MMb  6MMb  M \MM\   M `MM    MM `MM 6MMb  6MMb  
 M  \MM\  M  MM    MM  MM69 `MM69 `Mb M  \MM\  M  MM    MM  MM69 `MM69 `Mb 
 M   \MM\ M  MM    MM  MM'   MM'   MM M   \MM\ M  MM    MM  MM'   MM'   MM 
 M    \MM\M  MM    MM  MM    MM    MM M    \MM\M  MM    MM  MM    MM    MM 
 M     \MMM  MM    MM  MM    MM    MM M     \MMM  MM    MM  MM    MM    MM 
 M      \MM  YM.   MM  MM    MM    MM M      \MM  YM.   MM  MM    MM    MM 
_M_      \M   YMMM9MM__MM_  _MM_  _MM_M_      \M   YMMM9MM__MM_  _MM_  _MM_
___________________________________________________________________________

NumNum Cat was born after a youtube video made by TheKiffness ! 
She is a cute cat with a bullish name, born on the BSC. Lets raise her to a big strong cat together !
https://t.me/NumNumCat
*/
 ...
 */
contract NumNumCat {
    string  private _name = 'NumNum Cat';
    string  private _symbol = 'NumNum';
