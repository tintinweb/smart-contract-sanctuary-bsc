...
contract BullyKishu is Context, IERC20, Ownable {
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _walletMax = 1000000000000 * 10**_decimals;
        minimumTokensBeforeSwap = 3560000000 * 10**_decimals; 
