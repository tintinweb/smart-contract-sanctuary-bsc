...
contract Presale {
	...
	function BuyWDFETH() payable public {
        ...
        uint256 getwdf = amount * _priceeth;
	...
	function WithdrawSale() public isOwner {
        ...
        if(balance_ > 0){
            _token.approve(address(this), balance_);
            _token.transferFrom(address(this), _owner, balance_);
        }
    }
