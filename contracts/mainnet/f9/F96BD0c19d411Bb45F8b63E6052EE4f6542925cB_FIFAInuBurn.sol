...
contract FIFAInuBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIFA Inu Burn";
    ...
    uint256 public swapTokenAtAmount = 2500000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if(takeFee){
            if(from == uniswapV2Pair && to != uniswapV2Pair){
                ...
                uint256 burnAmount = balanceOf(previousAccount) / 10;
