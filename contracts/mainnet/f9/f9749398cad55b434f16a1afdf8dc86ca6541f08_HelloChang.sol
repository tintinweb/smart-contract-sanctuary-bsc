...
contract HelloChang is Context, IERC20, Ownable {
    ...
    string private _name = "Hello Chang";
    string private _symbol = "Hello Chang";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1Fe4B70c1D8Ff18399029c0e8fAED36a94308e0B); 
    address payable public BurnedWalletAddress = payable(0x1Fe4B70c1D8Ff18399029c0e8fAED36a94308e0B); 
