...
/**
TG: https://t.me/busdbank_network
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BUSDBankNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUSD Bank Network";
    string private _symbol = "BUSD BANK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x790Cc0467E85cF89760183251a60240D4936Aa73);
    address payable public devWalletAddress = payable(0x790Cc0467E85cF89760183251a60240D4936Aa73);
