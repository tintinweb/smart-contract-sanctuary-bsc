...
contract BabySnoki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabySnoki";
    string constant _symbol = "BABYSNOKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x4d3abEA1204fb684150c8829e83Da6CEC50f20aD;
