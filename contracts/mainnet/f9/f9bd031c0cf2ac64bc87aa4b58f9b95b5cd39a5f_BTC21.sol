...
contract BTC21 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC21";
    string private _symbol = "BTC21";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa03f91f2191fbAC481CB94298cf97E105Ab812EC); 
    address payable public DevelopmentWalletAddress = payable(0x6FcE7F584F6ac47E6B0A8c952BCec549BBE172bF); 
