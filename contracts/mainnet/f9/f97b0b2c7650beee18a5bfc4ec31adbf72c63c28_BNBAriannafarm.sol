...
Website: https://bnb.arianna.farm
Official Telegram: https://t.me/ariannafarm
Official Twitter: https://twitter.com/ariannafarm
...
contract BNBAriannafarm {
	using SafeMath for uint256;

	uint256  public INVEST_MIN_AMOUNT; 
	uint256[] public REFERRAL_PERCENTS 	= [450, 200, 100, 75, 50, 50, 50, 25, 25, 25]; // Total Referral Bonus 10.5%
	uint256[] public SEED_PERCENTS 		= [600, 400, 200, 200, 100, 100, 50, 50, 50, 50]; // Total Seed Income 18 %
	...
	constructor(address payable wallet, address payable mrk) public {
	...
	function SET_INVEST_MIN_AMOUNT(uint256 MIN_INVEST) external {
		require(msg.sender == commissionWallet, "Admin use only");
