...
contract OMNIBEARS is OMNIBEARSDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private OMNIBEARSTeam;
    address private CharityOMNIBEARS;
    ...
    string public override name = "Omni Bears";
    string public override symbol = "OMNIBEARS";
    ...
    constructor(uint totalSupplyValue, address OMNIBEARSTeamAddress, address CharityOMNIBEARSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        OMNIBEARSTeam = OMNIBEARSTeamAddress;
        CharityOMNIBEARS = CharityOMNIBEARSAddress;
       
        // split the tokens according to agreed upon percentages
        balances[OMNIBEARSTeam] =  totalSupply * 4 / 100;
        balances[CharityOMNIBEARS] = totalSupply * 4 / 100;
