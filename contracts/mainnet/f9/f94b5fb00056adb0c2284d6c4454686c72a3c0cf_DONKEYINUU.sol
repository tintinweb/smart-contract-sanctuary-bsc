...
contract DONKEYINUU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DonKey Inu";
    string constant _symbol = "DONKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9D179349896468dFC5202C3f464b885018538E1D;  // teamwallet
        lotteryWallet = 0x9D179349896468dFC5202C3f464b885018538E1D;  // lotterywallet
