...
// Telegram : https://t.me/harukaamami
...
contract Harukaamamitoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Haruka Amami";
    string private _symbol = "$HAMI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xfA0b9F0BCD1F794807fAb92B67f8781Fa656B64C); // Marketing Address
    address payable public teamWalletAddress = payable(0xfA0b9F0BCD1F794807fAb92B67f8781Fa656B64C); // Team Address
