...
/**
    ...
    * Ape Legends Club ($APELEGEND) - We are trying to provide the highest $BUSD rewards (10%) on the BSC!
    * Get in time to join the new Apes trend wave!

    * Telegram: https://t.me/ApeLegendsClub
    * Website:  https://apelegendsclub.com/
    * Twitter:  https://twitter.com/ape_legendsclub
...
contract ApeLegendsClub is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Ape Legends Club";
    string constant _symbol = "APELEGEND";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x6b89B8ae034D77F8Dd1a2bef52bff666C4313D20;
        marketingWallet = 0x29BE15f0cFeE4F14D66B7baDB4FC05eC694e117A;
