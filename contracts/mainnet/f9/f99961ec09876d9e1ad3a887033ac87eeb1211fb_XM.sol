...
contract XM is BEP20, Auth {
    ...
    string public constant name = "XMAS MIRACLE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x32f742e202f4c2b3F596D9F6998a642878B83AbE;
    ...
    function tradingStatus_launchmode(uint256 confirm) external onlyOwner {
        require(confirm == 911911911,"Accidental Press"); // required execution post launch
    ...
    function _updatefees() internal {
        ...
        require(totalFee.mul(sellMultiplier).div(100) < 16, "Sell tax cannot be more than 15%");
        require(totalFee.mul(transferMultiplier).div(100) < 16, "Transfer tax cannot be more than 15%");
