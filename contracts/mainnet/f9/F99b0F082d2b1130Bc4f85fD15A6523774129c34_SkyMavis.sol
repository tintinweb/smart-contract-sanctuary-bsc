...
contract SkyMavis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sky Mavis";
    string private _symbol = "Sky Mavis";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4e6d2d980a2bD9BAEe869ACF227b35a670b47c1);
