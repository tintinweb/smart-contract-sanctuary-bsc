...
/**
Twitter Doge🐕‍ 
👉The English name of the Twitter Doge is translated from the French name "Twitter Doge". Also known as the German Mastiff in mainland Germany, it is known as the "Sun God" among dogs. The Twitter Doge is largest dog in the world. 👈
...
💪 Twitter Doge will set up a unique anti-war fund, the anti-war fund association will organize to help the oppressed weak and neutral countries.💪
...
contract TwDoge is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0xa7f19589f6D4C031e425523556aFb0F1223A7A9B;
    address private CEXWallet = 0x7444dED2a38eEb7bAA40B2e5c0D94072d841513f;
    address public Charity = 0x2eE7F5699e4F76Ac0C86cb732493Df19A6eFbDC6;

    string private constant _name = "Twitter Doge";
    string private constant _symbol = "TWDOGE";
    ...
    Taxes public taxes = Taxes(1, 4, 1, 0, 0);
    Taxes public sellTaxes = Taxes(1, 4, 1, 0, 0);
