...
contract Spoink is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Spoink Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "SPOINK";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xF06a058BE180C397f5B90D2F9514FafE1698E94c;
        marketingFeeReceiver = 0xF06a058BE180C397f5B90D2F9514FafE1698E94c;
