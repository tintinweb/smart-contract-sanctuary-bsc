...
=== 'Gold BlockChain' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards Gold_BlockChain
-------------------------------------------------------------------
*/ 
...
contract Gold_BlockChain_token is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Gold_BlockChain";
    string constant private _symbol = "GBC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 12500000 * (10**_decimals);
