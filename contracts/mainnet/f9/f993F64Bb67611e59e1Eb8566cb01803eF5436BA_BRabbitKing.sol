...
contract BRabbitKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackRabbitKing";
    string private _symbol = "BRabbitKing";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x4190c0Cc03812FDfAEf1dE4b69bCc4aca1F3Da00); 
    address payable private teamWalletAddress = payable(0xc59843Bb7AD1cDf429dc8580033901a2216c0b23); 
