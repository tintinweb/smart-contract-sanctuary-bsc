...
/**
    ...
    0-1000 Minted = 0.02 BNB
    1001-2000 Minted = 0.04 BNB
    2001-3000 Minted = 0.08 BNB
    3001-4000 Minted = 0.15 BNB
    4001-5000 Minted = 0.3 BNB

 	Website: https://wondersea.finance
	Twitter: https://twitter.com/wondersea_wsf
    Telegram: https://t.me/wondersea_wsf
*/
...
contract WonderSeaNFTs is ERC721Enumerable, Ownable {
    //For nft staking.
    ...
    uint256 public maxSupply        =   5000; // Max supply: 5,000 NFTs
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= costBySupply(supply) * _mintAmount, "Insufficient funds");
