...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function airdrop(address account, uint256 amount) internal virtual {
...
contract FUSE is ERC20 {
    ...
    uint tokenTotalSupply = 10000000000000; //  airdrop 
    
    constructor() public ERC20("Fuse Swap", "FUSE") {
        airdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}