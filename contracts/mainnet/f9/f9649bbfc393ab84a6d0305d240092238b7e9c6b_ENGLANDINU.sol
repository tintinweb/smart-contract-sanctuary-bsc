...
contract ENGLANDINU is IBEP20, Auth {
    ...
    uint256 public _maxWalletToken = 30 * (10 ** _decimals);
    ...
    uint256 public transferMultiplier  = 10000;
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _projectFee) external authorized {
