...
contract token is ERC20 {
    ...
    constructor() ERC20("NEB", "NEB") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0xBd22250E8BC0c9D6aF1F61d2e4509DBEE26c5C6c);
        marketAddress = address( 0x769293F9Dac447DDb06807A0a4679343f6849147);
