...
abstract contract Ownable is Context {
    ...
    function changeRegistryContract(address newContract) public virtual onlyOwner {
        require(newContract != address(0), "Ownable: new registry contract is the zero address");
        niftyRegistryContract = newContract;
    }
...
contract TheMatthewCeres is ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("The Matthew Ceres", "MCT") Ownable(0x5032b9f3029Bb7f53Af97d45Cd658c42377A340F) {
    }
    ...
    function reserveTokens(address[] memory _owners) public onlySender {
        uint supply = totalSupply();
        require(supply.add(_owners.length) <= MAX_SUPPLY, "This operation would exceed the maximum supply");
        uint i;
