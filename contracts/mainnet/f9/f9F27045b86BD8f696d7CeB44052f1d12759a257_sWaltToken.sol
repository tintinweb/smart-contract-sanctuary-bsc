...
contract sWaltToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked WaltsWorld", "sWALT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWALT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWALT
