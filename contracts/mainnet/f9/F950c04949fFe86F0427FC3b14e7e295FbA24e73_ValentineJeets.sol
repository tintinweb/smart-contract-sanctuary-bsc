...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**SHIB.decimals());
...
// main contract
contract ValentineJeets is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "ValentineJeets";
