...
contract QuarterShiba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25 * 10**9;
    uint256 public _maxTxAmount = 25 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "QuarterShiba"; // 
    string private constant _symbol = "025Shib"; //    
