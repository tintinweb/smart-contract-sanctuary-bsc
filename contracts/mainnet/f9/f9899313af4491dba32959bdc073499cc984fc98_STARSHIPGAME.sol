 ...
 */
contract STARSHIPGAME{
    using SafeMath for uint256;

    uint256 private _totalSupply = 5000000000000000000000000000; // 18 decimals
    string private _name = "STARSHIPGAME";
    ...
    uint256 private _referEth =     2500; //40%
    uint256 private _referToken =   2500; //60%
