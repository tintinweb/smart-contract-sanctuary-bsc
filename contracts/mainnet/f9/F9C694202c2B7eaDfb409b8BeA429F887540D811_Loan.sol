...
contract Loan is ERC721Holder, AccessControlEnumerable, ReentrancyGuard {
    ...
    address public lp = 0xb2ec7226ed276b496C0372a828FCE06D37f5AD0F;
    ...
    address public medals = 0xD7Ffad9775379D72C766F4796EDAcD9973584B6B;
    address public gasStake = 0x28B3FE907820F7d162dD2D6466cfe772d891D306;

    uint256 public maxLevel;
    uint256 public creatorRatio = 2e17;
    uint256 public gasStakeRatio = 8e17;
    uint256 public repayTimes = 1;
    uint256 public INTERVAL = 2 * 60;
    ...
    function init(address _lp, address _token, address _usdt, address _medals, address _gasStake) external onlyRole(OPERATER_ROLE) {
        lp = _lp;
        token = _token;
        usdt = _usdt;
        medals = _medals;
