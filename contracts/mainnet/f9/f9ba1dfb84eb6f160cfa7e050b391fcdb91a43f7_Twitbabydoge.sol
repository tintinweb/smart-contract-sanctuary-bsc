...
contract Twitbabydoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitbabydoge";
    string private _symbol = "Twitbabydoge";
    ...
    uint256 public _walletMax =     80000000000 * 10**_decimals;
