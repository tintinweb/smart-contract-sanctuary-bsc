...
contract FullStratTest {
    ...
    string public strategyTitle = "FullStratTest";
    ...
    function getStepDetails(uint256 _step) public view returns (StepDetails memory) {
        return steps[_step];
    }
    ...
    function getTokens() public view returns (address[] memory) {
        ...
        tokens[0] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        tokens[1] = 0x431e0cD023a32532BF3969CddFc002c00E98429d;
        return tokens;
    }

    function func_9(string memory _funcToCall, bytes[1] memory _arguments) public onlyExecutor {
    ...
    function func_10(string memory _funcToCall, bytes[1] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x68Cc90351a79A4c10078FE021bE430b7a12aaA09;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
    ...
    function func_14(string memory _funcToCall, bytes[5] memory _arguments) public onlyExecutor {
    ...
    function func_11(string memory _funcToCall, bytes[1] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x68Cc90351a79A4c10078FE021bE430b7a12aaA09;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
    ...
    function func_17(string memory _funcToCall, bytes[5] memory _arguments) public onlyExecutor {
        address currentFunctionAddress = 0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE;
        bool useCustomParams = keccak256(_arguments[0]) == keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
    ...
    uint256[] public reverseFunctions = [11, 17, 10];
    uint256[] public reverseSteps = [3, 2, 1];
}