...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x0000000000000000000000000000000000000000);
...
contract KaidoGrow is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x0000000000000000000000000000000000000000;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Kaido Grow";
    string constant _symbol = "KDG";
