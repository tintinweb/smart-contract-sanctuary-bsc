...
contract MEEPUNK is MEEPUNKDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MEEPUNKTeam;
    address private CharityMEEPUNK;
    ...
    string public override name = "Yuga MeePunk";
    string public override symbol = "MEEPUNK";
    ...
    constructor(uint totalSupplyValue, address MEEPUNKTeamAddress, address CharityMEEPUNKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MEEPUNKTeam = MEEPUNKTeamAddress;
        CharityMEEPUNK = CharityMEEPUNKAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MEEPUNKTeam] =  totalSupply * 4 / 100;
        balances[CharityMEEPUNK] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MEEPUNKTeam pot
