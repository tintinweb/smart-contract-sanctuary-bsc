...
/**
 * join DAOFection and get infected! t.me/DAOFection 
 * need atleast 1 token to be able to buy, read tg for more info
*/
...
contract DAOFection is IBEP20, Auth {
    ...
    string constant _name = "DAOFection";
    string constant _symbol = "DAOFECTION";
    ...
    address private marketingFeeReceiver = 0x530D402D4CC6C3AbfFEeE889359C4126259df1ED;
    address private devFeeReceiver = 0xBcF72422170AB38Bf5fB9133bf2f4d7a080dE8f9;
