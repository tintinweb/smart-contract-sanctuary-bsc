...
contract CLEPO is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x6379157A2abef766615438be7565aEb216281a70;
    ...
    string private _name = "CLEPO";
    string private _symbol = "CLEP";
    ...
    uint256 public maxWalletToken = 19800000000 * (10**9);
    ...
    uint256 public _maxTxAmount = 4950000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 49500000 * 10**9;
