...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33CCCafd6E03c3978798C84D6ACd0249eA4361A1; // owner address
...
contract RyoshiTsuka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ryoshi Tsuka";
    string private _symbol = "RYT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33CCCafd6E03c3978798C84D6ACd0249eA4361A1); // Marketing Address
    address payable public teamWalletAddress = payable(0x33CCCafd6E03c3978798C84D6ACd0249eA4361A1); // Team Address
    ...
    uint256 public _maxTxAmount = 10000000 * 30**_decimals; 
    uint256 public _walletMax = 10000000 * 30**_decimals;
