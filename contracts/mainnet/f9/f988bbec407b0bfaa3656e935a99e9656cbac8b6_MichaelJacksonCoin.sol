...
/*
MichaelJacksonCoin is a innovative new kind of money, and store of value with the vision of 
one day helping those who are battling against a noob time in in life with incredible gains.

Name: MichaelJacksonCoin
Ticker: MJC
...
* Website: https://MichaelJacksonCoin.online
...
contract MichaelJacksonCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "MichaelJacksonCointest";
    string private _symbol = "MJCtest";
    uint8 private _decimals = 8;
    uint256 private _totalSupply = 1000 * 1e6 * 1e8; // 1000 Million
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "MJC: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "MJC: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function startTrading() external onlyOwner {
        require(!_tradingOpen, "MJC: Already enabled");
        _tradingOpen = true;
    ...
    function _approve(
        ...
        require(owner != address(0), "MJC: approve from the zero address");
        require(spender != address(0), "MJC: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "MJC: transfer from the zero address");
        require(to != address(0), "MJC: transfer to the zero address");
        require(amount > 0, "MJC: Amount must be greater than zero");
        ...
        if (
            ...
            if (!_tradingOpen) {
                require(
                    ...
                    "MJC: Trading is not enabled yet"
                );
            }
        }
