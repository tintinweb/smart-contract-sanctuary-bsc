...
contract Crogeshi is IBEP20, Auth {
    ...
    string constant _name = "Crogeshi ";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x7A02Be6828E8B8f156174a4483a5bfde8D1913f1;
        marketingFeeReceiver = 0x7A02Be6828E8B8f156174a4483a5bfde8D1913f1;
