...
/* Token contract */
contract JeetimusBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "JeetimusBTC";
    string constant _symbol = "JBTC";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 400 / 10000; // 4% on launch or 1M tokens
    uint256 _maxBuyTxAmount = _totalSupply * 400 / 10000; // 4% on launch or 1M tokens
    uint256 _maxSellTxAmount = _totalSupply * 400 / 10000; // 4% or 5M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x2C0a04C027329d8502b8CB408083b7E0CF0b46b2;
        marketingFeeReceiver = 0x2C0a04C027329d8502b8CB408083b7E0CF0b46b2;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, uint256 AJMode) internal returns (uint256) {
        ...
        } else if ((AJMode == 2) && (amount >= (_maxWalletToken).div(4).mul(3))) {
            if(isSell) {
