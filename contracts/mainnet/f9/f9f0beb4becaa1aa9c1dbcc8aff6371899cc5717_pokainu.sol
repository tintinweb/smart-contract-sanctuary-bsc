...
POKA INU contract created by "Cyero"
Community Meme Token on Binance Smart Chain

NEXT SHIBA MISSION X
...
contract pokainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POKA INU";
    string private _symbol = "POKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f56FAdC386feAf073d72Fb2B1f7F60148E8eC6b); 
    address payable public teamWalletAddress = payable(0xeBee632FDd4340a76302d4BdF4e694446286B19F); 
