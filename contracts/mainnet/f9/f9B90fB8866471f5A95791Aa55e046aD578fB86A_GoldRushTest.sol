...
contract GoldRushTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GoldRushTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Gold Rush Test", "GRCTest") {
        ...
        dividendTracker = new GoldRushTestDividendTracker(
            payable(this),
            router,
...
contract GoldRushTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    GoldRushTest public GoldRushTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        GoldRushTestContract = GoldRushTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GoldRushTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GoldRushTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GoldRushTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GoldRushTestContract);

            uint256 prevBalance = GoldRushTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = GoldRushTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GoldRushTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
