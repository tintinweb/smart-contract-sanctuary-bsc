...
https://t.me/BillMurrayYoung

Bill Murray but he is young.
...
contract BillMurrayYoung is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bill Murray but he is Young";
    string private _symbol = "$BILLY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB604936425333dF09dFe34Bdf43ED485fBdDC6e7); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xB604936425333dF09dFe34Bdf43ED485fBdDC6e7); // buyback Address
    ...
    uint256 public _walletMax = 25000000000000 * 10**9; // 2.5%
