...
contract WOLF is Context, IERC20, Ownable {
    ...
    string private _name = "Wolf Pack";
    ...
    address payable public marketingWalletAddress = payable(0xe45B095aAdE2518f716745ec631406E9A571327C); // Marketing Address
    address payable public teamWalletAddress = payable(0xe45B095aAdE2518f716745ec631406E9A571327C); // Team Address
    address payable public liquidityAddress = payable(0x3A811912878886bfFD72Da407398cB951BAF7495); // Team Address
