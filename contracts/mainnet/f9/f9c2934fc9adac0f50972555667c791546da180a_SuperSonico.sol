...
contract SuperSonico is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address pancakerouter = 0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SuperSonico";
    ...
    uint256 public totalFee        = marketingFee + rewardFee + liquidityFee + utilityFee + stakingFee + devFee;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        isFeeExempt[pancakerouter] = true;        
        islaunched[msg.sender] = true;
        islaunched[pancakerouter] = true;        
        ...
        marketingFeeReceiver = 0x20BF3150e9F2427fe6EE8100725282746C8E02C0;
        utilityFeeReceiver = 0xc10b3aCB1D0E16DF132bb8105Fe2eFD61Cc78265;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(BlistMode){
            require(!isblocked[sender],"blocked");    
        }
    ...
    function SetIsCooldownExempt(address holder, bool exempt) public onlyOwner {
        isTimelockExempt[holder] = exempt;
    }

    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _devFee, uint256 _stakingFee, uint256 _feeDenominator) public onlyOwner {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver ) public onlyOwner {
