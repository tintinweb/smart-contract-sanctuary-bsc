...
contract $QUEENLI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Queen Luna Inu";
    string private _symbol = "QUEENLI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x746D5D7689d9608a66e0E893f8A176EB438A0674); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x237607f4905C768BB5233743A9b2b63E22122B36); // Development Address
