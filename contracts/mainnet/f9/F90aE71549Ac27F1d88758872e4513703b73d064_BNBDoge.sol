...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferFee = 500;  //转账扣百分之5
    ...
    constructor (
        ...
        holderRewardCondition = 1000 * 10 ** IERC20(DividendToken).decimals();   //分红达到1千个就开始分红
        holderCondition = 1 * tokenDecimals;   //持币1个就可以分红

        addLpProvider(ReceiveAddress);
        _limitAmount = 5 * tokenDecimals;   //限购
