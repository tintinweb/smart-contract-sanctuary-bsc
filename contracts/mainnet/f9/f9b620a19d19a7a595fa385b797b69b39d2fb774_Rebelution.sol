...
contract Rebelution is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x55416Ce3a2410eD7e852b0199EF45c3e7e93f140));
    address payable public devWallet =
        payable(address(0x58789306a8Bdb27290A12bf16792823BDe0F0DA3));
    address public liquidityReceiver =
        0x23d35a90b76eE2998326e66064f5395427e82060;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "REBELUTIONTOKEN";
