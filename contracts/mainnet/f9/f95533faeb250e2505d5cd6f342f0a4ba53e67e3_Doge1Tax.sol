...
Doge memecoin on BSC network, 1% version, 1 BNB initial liquidity.
...
contract Doge1Tax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge1Tax";
    string constant _symbol = "Doge1Tax";
