...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4975fd21F9977Dc52edF12DcC084Be2f3615617B; 
...
contract BNB777 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB777";
    string private _symbol = "BNB777";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4975fd21F9977Dc52edF12DcC084Be2f3615617B); 
    address payable public teamWalletAddress = payable(0x483a6ce6b4CE0f1a296Aee9214F76e236576ED83); 
