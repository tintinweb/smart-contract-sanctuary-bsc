...
contract BeanLabs is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BeanLabs";
    string private constant _symbol = "$LAB";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 108 * 10**9 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xC4a1237c0d31131A6849F5FA414002446fcA5e00);
    address payable public MarketingWallet = payable(0xC4a1237c0d31131A6849F5FA414002446fcA5e00);
