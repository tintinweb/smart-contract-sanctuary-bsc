...
// 
//
// 📱 Telegram:https::https://t.me/RatsGoldx1000
//
...
contract $RATSGOLD is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("RATS GOLD", "RATSGOLD") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RATSGOLD";
    string private _symbol = "RATSGOLD";
