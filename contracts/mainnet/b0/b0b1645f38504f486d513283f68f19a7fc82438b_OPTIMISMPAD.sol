...
contract OPTIMISMPAD is IERC20, Context, Ownable {
    ...
    function addPlayer(string memory gmail) public {
        
        players[msg.sender]=Player(msg.sender,Level.Beginner,gmail,block.timestamp);
        playerCount += 1;
    ...
    function getGmail(address playerAddress) public view returns (string memory) {
         return players[playerAddress].gmail;
    }
    function changePlayerLevel(address playerAddress) public onlyOwner {

        Player storage player = players[playerAddress];
        if(block.timestamp >= player.createTime + 9072000){
