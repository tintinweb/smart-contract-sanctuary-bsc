...
/**
STEALTH SOON
following the dog hype, PITQUIDITY NETWORK a bullish name with great tokenomics is here for easy moonshot!
...
// File contracts/pitquidity.sol
pragma solidity ^0.8.0;

contract pitquiditynetwork is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000000000 * 10**9 * 10**_decimals;
    ...
    string private constant _name = "PITQUIDITY NETWORK";
    string private constant _symbol = "PITQUIDITYNET";
