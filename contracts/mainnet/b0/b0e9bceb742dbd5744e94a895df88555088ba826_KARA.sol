...
contract KARA is Context, IERC20, Ownable {
    ...
    string private _name = "KARA BLOC";
    ...
    address payable public marketingWalletAddress = payable(0xa3aE70040B089a5f6759A8f689F06376fA650745); // Marketing Address
    address payable public teamWalletAddress = payable(0x0932B2df17A1E606f2F5727c7E1bAB74Ad6757dC); // Team Address
