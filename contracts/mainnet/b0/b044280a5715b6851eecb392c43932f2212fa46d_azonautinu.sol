...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3E6b9b9a58dD66848A12D38151F56D4112aC6Dc6;
...
contract azonautinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x86500E614e01A28A6974eF217A1886eC89d7439F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "azonautinu";
    string private _symbol = "azi";
