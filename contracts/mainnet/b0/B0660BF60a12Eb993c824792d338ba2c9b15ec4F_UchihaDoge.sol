...
abstract contract Auth {
    ...
    function getOwner() external view returns (address) { return owner; } //qwer
...
contract UchihaDoge is IERC20, Auth {
    ...
    string _name = "Uchiha Doge";
    string _symbol = "UDOGE";
    ...
    uint256 gweiLimitBlocksAffected = 4;//qwer
    ...
    uint256 AB1 = 8 * 1 gwei; // qwer
    address autoLiquidityReceiver;
    address marketingFeeReceiver;
    uint256 public launchBlock; // qwer
    ...
    constructor () Auth(msg.sender){
        ...
        address marketingreceiver = 0x7F8c9a50d8959F879473d4079Dc73FA0A8029700;
