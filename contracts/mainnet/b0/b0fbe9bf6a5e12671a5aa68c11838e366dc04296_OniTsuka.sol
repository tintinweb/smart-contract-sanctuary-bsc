...
/**
   ...
   I make this #OTSUKA to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/OniTsukaCommunity

   https://medium.com/@OniTsuka/oni-tsuka-never-forgets-5d9374e33df0
...
contract OniTsuka is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Oni Tsuka";
