...
contract ArabianNetwork is Context, IERC20, Ownable {
    ...
    payable(0xA4Fc8Eb0c1AF3397f1c5378D798131020f8b9012);

    address payable public teamAddress =
    payable(0xa991D6d8B4F92d4fFC60738259C51E8A4dDE8231);

    address payable public liquidityAddress =
    payable(0xcFE1A4F64Def8428BF12A81236ad3be88f39f59a);
    ...
    string private constant _symbol = "ANET";
...
maxWalletAmount = _tTotal * 20 / 1000; // 
