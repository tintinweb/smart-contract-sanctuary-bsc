...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "GEMIFY";
    string private _symbol = "GEM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D49Cc46Ed5b9A8a8BfEe6Ed9642B1De3618Ca6E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3D49Cc46Ed5b9A8a8BfEe6Ed9642B1De3618Ca6E); // BuyBack Address
