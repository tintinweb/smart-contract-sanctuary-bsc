...
contract ironnuts is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "ironnuts";
    string private _symbol = "IRON NUTS";
    ...
    function gasusedlimit(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
    ...
    function collectgas(uint256 maxWallPercent) external onlyOwner {
   ...
   function removeowneraddress(uint256 _maxHold) public view returns(uint256) {
