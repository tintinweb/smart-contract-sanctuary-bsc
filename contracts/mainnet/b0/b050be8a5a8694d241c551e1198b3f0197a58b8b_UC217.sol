...
contract UC217 is IERC20, Ownable, IShareDividends{
    
    using SafeMath for uint256;

    string _name = "UC217";
    string _symbol = "UC217";
    uint8 _decimals = 9;
    ...
    function setUC217(address holder) external onlyOwner {
	...
	function swapUC217ToFee(address _token, uint256 tokens) private  {
	...
	function tokenUC217Contract() public view virtual returns (address) {
			return address(this);
		}
		
	function calUC217Supply(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
