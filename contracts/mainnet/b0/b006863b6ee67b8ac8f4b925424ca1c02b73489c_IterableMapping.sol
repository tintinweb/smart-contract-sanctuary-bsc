...
// https://babyshido.mottaverse.com
...
contract BabyShidoInu is IBEP20, Ownable {
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x9Ac93A6a304f448a590dE627F2407E7E6019b90B,
        lottery: 0xF240437a05a94421A6e798aF83a21C839eD279Fc,
        marketing: 0x93E4d3614cD1c4BA6d13f4C933645deFeb0403e3
    });
    ...
    bool public autoDistribute = true; //Rewards can be either auto or manual claim

    uint256 private _liquidityUnlockTime;

    //Antibot variables
    uint256 private liquidityBlock;
    uint8 private constant BLACKLIST_BLOCKS = 5; //number of blocks that will be included in auto blacklist
    ...
    address public mainReward = 0x733Af324146DCfe743515D8D77DC25140a07F9e0;
    address private defaultMisc = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    uint256 public minBalanceForDividends = INITIAL_SUPPLY / 2000; //must hold at least 0.05% supply to receive rewards
