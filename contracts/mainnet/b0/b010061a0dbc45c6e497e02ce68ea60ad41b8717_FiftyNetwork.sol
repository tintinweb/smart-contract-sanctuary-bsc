...
contract FiftyNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifty Network";
    string private _symbol = "FIFTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13d139eC362271a6D56aE22803BEeBCCB8765D3D); // Marketing Address
    address payable public teamWalletAddress = payable(0x13d139eC362271a6D56aE22803BEeBCCB8765D3D); // Team Address
