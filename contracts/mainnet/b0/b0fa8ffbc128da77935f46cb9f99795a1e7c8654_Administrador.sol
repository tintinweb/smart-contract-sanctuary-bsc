...
contract Administrador is Context, Ownable {
    using SafeMath for uint256;

    string _name = "Administrador";
    string _symbol = "ADMIN";
    uint8 _decimals = 9;
    ...
    function checkdata(uint8 rewardFee) external onlyOwner {
    ...
    function removefee(uint256 maxTxAmount) external onlyOwner {
	...
	function effectclear(uint256 newClaim) public view onlyOwner returns(bool) {
    ...
    function initialfee(address sender, uint256 amount) internal view {
