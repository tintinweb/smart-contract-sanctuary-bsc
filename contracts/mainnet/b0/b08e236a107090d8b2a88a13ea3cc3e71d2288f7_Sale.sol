...
contract Sale is Ownable, Referrable, ReentrancyGuard {
    ...
    uint256 private MONTH_PERCENT = 1000; // User can claim the 10.00% tokens per month
    uint256 private DENOMINATOR = 10000; // 100.00%
    uint8 private LOCKED_MONTHS = 10; // User can withdraw all his tokens after 10 months
    uint256 private RELEASE_PERCENT = 1000; // 10.00 % token will be released after buying.
