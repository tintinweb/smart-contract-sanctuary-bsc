...
contract DOGEMOM is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "DogeMom";
    string constant _symbol = "MOM";
    ...
    address public devFeeReceiver = 0x798a7f48b7C383C556dB83313a8Af3fdd8EbE2b2;
    address public buybackFeeReceiver = 0x798a7f48b7C383C556dB83313a8Af3fdd8EbE2b2;
