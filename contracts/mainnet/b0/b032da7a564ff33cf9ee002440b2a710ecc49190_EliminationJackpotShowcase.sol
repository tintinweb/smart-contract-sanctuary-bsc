...
Telegran: https://t.me/EjackS

Website: https://EJshowcase.com

Twitter: https://twitter.com/EjackS
...
contract EliminationJackpotShowcase is IBEP20, Auth {
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBUSDFee = totalFee.sub(liquidityFee.div(2));
        uint256 amountBUSDLiquidity = amountBUSD.mul(liquidityFee).div(totalBUSDFee).div(2);
        uint256 amountBUSDbuyback = amountBUSD.mul(buybackFee).div(totalBUSDFee);
        uint256 amountBUSDMarketing = amountBUSD.mul(marketingFee).div(totalBUSDFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBUSDMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool BuyBackSuccess, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: amountBUSDbuyback, gas: 30000}("");
