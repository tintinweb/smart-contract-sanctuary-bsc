...
contract NomadDogelon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NomadDogelon";
    string private _symbol = "NomadDogelon";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xB6AefA3DA7d8fce8138F29BA94eB0d6bD6456BBF);
