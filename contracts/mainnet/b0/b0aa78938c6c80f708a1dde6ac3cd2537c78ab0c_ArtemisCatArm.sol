...
contract ArtemisCatArm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Artemis CatArm";
    string private _symbol = "ArtCatArm";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD041eE6B9997141476BaDABEfc8aeA11e4D805F); 
    address payable public buyBackWalletAddress = payable(0xdD041eE6B9997141476BaDABEfc8aeA11e4D805F); 
    ...
    uint256 private minimumTokensBeforeSwap = 300000000000 * 10**9; 
