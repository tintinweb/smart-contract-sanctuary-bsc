...
contract MDD is Context, IERC20, Ownable {
    ...
    string private _name = "moon dog dao";
    ...
    address public ownerAddres = address(0xD5cdef5A7B5764a64458819AD5F6D447676A0531);
    address public devAddress = address(0x68639F33bbeb2d60336bDCaa3d03Ec24a4F252C7);
    
    address public hbtcToken = 0xD5cdef5A7B5764a64458819AD5F6D447676A0531;
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000000 * 10 **18;
