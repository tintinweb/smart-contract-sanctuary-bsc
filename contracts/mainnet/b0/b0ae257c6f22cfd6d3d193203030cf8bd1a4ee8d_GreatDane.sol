...
contract GreatDane  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd126819aBcE8B4a3Bd72FD71869c37dCa90F377F);
    address payable public liquidityWalletAddress = payable(0xd126819aBcE8B4a3Bd72FD71869c37dCa90F377F);
    ...
    uint256 private _totalSupply = 6900000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 6900000000000000 * 10**_decimals; 
    uint256 public _walletMax = 6900000000000000 * 10**_decimals;
