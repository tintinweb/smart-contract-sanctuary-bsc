...
// File: ContractFlashOfLightningsale.sol
...
contract FlashOfLightningSale {
    ...
    constructor(address _token) {
        owner = msg.sender;
        token = IERC20(_token);
        buyPrice = 0.000000001 * 10**18;
        currentPhaseIndex = 0;
        sold = 0;
        toSold = __amount(300000000000);

        for(uint i=1; i<=10; i++){
            phases.push(Phase(30000000000, i*buyPrice, i));
        }
    }
