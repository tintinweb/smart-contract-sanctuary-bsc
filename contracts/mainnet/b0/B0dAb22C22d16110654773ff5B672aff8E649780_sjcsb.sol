...
contract sjcsb is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sjcsb";
    string private _symbol = "sjcsb";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50A32138D90De624F1db2ae2960503006A11F524);
    address payable public teamWalletAddress = payable(0x2D5d7fCAc4845fB669cbEB0f76De2F954F60fE8c);
