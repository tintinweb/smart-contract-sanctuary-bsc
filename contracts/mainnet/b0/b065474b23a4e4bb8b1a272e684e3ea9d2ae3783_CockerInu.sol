...
*/
// Cocker Inu - First British Meme Token
//Join our Tg: t.me/cockerinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F4C8e73100abd8d8642f227b1F92158a44B05bE; // owner address
...
contract CockerInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CockerInu";
    string private _symbol = "COCKER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Cb8CF316d9Ae77cBf1529DECFad6a11106195f1); // Marketing Address
    address payable public teamWalletAddress = payable(0x2F4C8e73100abd8d8642f227b1F92158a44B05bE); // Team Address
