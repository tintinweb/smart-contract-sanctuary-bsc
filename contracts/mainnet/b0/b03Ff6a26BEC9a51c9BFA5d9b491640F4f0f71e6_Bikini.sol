...
contract Bikini is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 18000000000 * (1e9);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Bikini";
    string private _symbol = "BIK";
    uint8 private _decimals = 9;

    uint256 public lpDividendFee = 2;
    uint256 private previousLpDividendFee = lpDividendFee;
    uint256 public holdersDividendFee = 2;
    ...
    address public marketingAddr = 0xbD6A920858a01bF53a0dEB1722D05662a51CDBDA;
    address public lpDividendWallet = 0x445542c24487bc3Cf9b3Bc5E057f6bE40BC7b118;
