...
/**
SenseiCoin
A new BSC token that reward holders with BNB, SenseiCoin is launching soon on BSC. 
SenseiCoin is symbolized with prosperity & believed to bringing luck for all its believers.  

Sensai is built with strong & powerful tokenomics:
1) 100,000,000,000 of supply & will burn gradually from each of the transactions
2) 10% of buy & sell tax
3) Starting with low MC : 1 BNB
4) Brought to you by experienced dev

Join SenseiCoin on TG : https://t.me/SenseiCoinBSC
*/
...
contract SenseiCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "SenseiCoin"; // 
    string private constant _symbol = "$SENSEI"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x793C577795383ed365C7C2FD72E6440FD37459a9;
