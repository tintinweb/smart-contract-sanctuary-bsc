...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C80aD799F69A2d7C3A1B5Cf06FbcD14094Cf9D3; // owner address
...
contract SQUIDBRO is Context, IERC20, Ownable {
    ...
    string private _name = "SQUID BRO";
    string private _symbol = "SQBR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3736bCBE4122DC5C73ba88Dab308450D95762906); 
    address payable public teamWalletAddress = payable(0x3736bCBE4122DC5C73ba88Dab308450D95762906);
