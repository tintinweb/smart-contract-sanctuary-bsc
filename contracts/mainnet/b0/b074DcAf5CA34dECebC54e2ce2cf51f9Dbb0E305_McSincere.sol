...
/**
 * https://t.me/McSincere
 * Fair launch of a new trending token McSincere! Next stop, MOON!
 * Experienced Dev and Marketing Team - Website coming later today!
 * Fees on Buy: 10%
 * Fees on Sell: 10%
 * 
*/    
...
contract McSincere is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McSincere";
