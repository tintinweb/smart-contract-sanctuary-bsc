...
contract DogzInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogz Inu";
    string private _symbol = "DOGZINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17999a9D3bEeafBA1e2A64E172eB4ce4E0c792F4); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x17999a9D3bEeafBA1e2A64E172eB4ce4E0c792F4); // buyback Address
    ...
    uint256 public _maxTxAmount = 4000000000000 * 10**9; // 0.1%
    uint256 public _walletMax = 4000000000000 * 10**9; // 2%
