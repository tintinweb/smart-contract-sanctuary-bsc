...
contract SOCCERchain is Context, IERC20 { 
    ...
    address payable public Wallet_collaterals = payable(0xA8106E51100B78CFC2c1236054E9613Be99C1Abe); 
    ...
    string private constant _name = "Soccer Chain"; 
    ...
    constructor () {
        ...
        _owner = 0xA8106E51100B78CFC2c1236054E9613Be99C1Abe;
    ...
    function BuyFees(uint256 _nTax_On_Buy) external onlyOwner {
        _Tax_On_Buy = _nTax_On_Buy;
        require(_Tax_On_Buy <= 20, "Must keep fees at 20% or less");
    }
    
    function SellFees(uint256 _nTax_On_Sell) external onlyOwner {
        _Tax_On_Sell = _nTax_On_Sell;
        require(_Tax_On_Sell <= 20, "Must keep fees at 20% or less");
    } 
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: BNBAmount}(
            ...
            0, 
            0,
            address(0xA8106E51100B78CFC2c1236054E9613Be99C1Abe), 
            block.timestamp
        );
    } 
