...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97a0c331128d9530510a1024c87C2a534f8EDf07; // owner address
...
contract KAIGAKUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kaigaku inu";
    string private _symbol = "KAIGAKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbd78c73bF2990731BeaE8AF36b22C935fA401BeD); // Marketing Address
    address payable public buybackWalletAddress = payable(0xbd78c73bF2990731BeaE8AF36b22C935fA401BeD); // Buyback Address
