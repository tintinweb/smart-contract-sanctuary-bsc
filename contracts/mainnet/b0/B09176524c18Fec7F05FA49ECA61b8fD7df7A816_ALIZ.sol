...
contract ALIZ is IERC20, Ownable {
    ...
    uint256 public InviterMinAmount;
    ...
    constructor(address tokenOwner) {
        ...
        LPFeeTarget = 300 * 10 ** _decimals;
        InviterMinAmount = 1 * 10 ** _decimals;
    ...
    function setInviterMinAmount(uint256 newInviterMinAmount) public onlyOwner {
        InviterMinAmount = newInviterMinAmount;
    }
    ...
    function setIsStart(bool newIsStart) public onlyOwner {
        isStart = newIsStart;
    }
    ...
    function _transfer(
        ...
        bool canInviter = from != uniswapV2Pair &&
            to != uniswapV2Pair &&
            (minAmount == 0 && amount >= InviterMinAmount) &&
            balanceOf(to) == 0 &&
