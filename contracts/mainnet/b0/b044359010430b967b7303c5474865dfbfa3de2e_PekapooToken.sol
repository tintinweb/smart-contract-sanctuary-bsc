...
/**
 * @dev The official PekapooToken smart contract
 */
contract PekapooToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "PekapooToken";
    string private _symbol   = "Pekapoo";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for Pekapoo/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x04A34DC90fc134C0A5e008f8B9d58DFDB8394684); // Marketing address used to pay for marketing
    ...
    uint256 public  _sellTaxFee       = 8; // 8% tax 
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $Pekapoo will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-Pekapoo tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts Pekapoo balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns Pekapoo tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of Pekapoo tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from Pekapoo)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of Pekapoo
            path,
