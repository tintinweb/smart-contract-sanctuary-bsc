...
contract SVB is ERC20, Ownable {
    ...
    address public developmentWallet = 0x59684b5341336D7Abcec239a878ecb37e4B0ecDf;
    ...
    constructor() ERC20("SVB", "SVB") {
        _mint(msg.sender, 10000000000 * DECIMALS);
