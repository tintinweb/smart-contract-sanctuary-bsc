...
Baby Cake 3 是与他一起飞行的 Baby Cake 2 代币的继承者

    Official Website
    https://t.me/babycake30
...
contract BabyCake30 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x0A5A8C73f72ef6998f40848edC4901B58Eb63617));


    string private _name = "Baby Cake 3";
    string private _symbol = "BCAKE3";
