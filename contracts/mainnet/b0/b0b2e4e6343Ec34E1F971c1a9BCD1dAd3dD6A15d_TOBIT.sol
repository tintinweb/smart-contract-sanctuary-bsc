...
contract TOBIT is IERC20 {
    ...
    address public dividendAddr = 0x0000000000000000000000000000000000000000; //持币分红派发地址
    address public capitalPoolAddr = 0xAa19d4609E4bd72531F196E16AB2b8050bcF47ED; //资金池地址
    ...
    constructor (uint256 initialAmount, string tokenName, uint8 decimalUnits, string tokenSymbol) public {
        ...
        // agentRate[0] = 50; //1代分红比例
        // agentRate[1] = 30; //2代分红比例
        // agentRate[2] = 20;
