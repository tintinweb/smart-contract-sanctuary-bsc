...
// File: lution_bnb_distrib.sol

//SPDX-License-Identifier: MIT

/*
 * Lution - BNB Distributor
...
contract Lution_BNB_Distributor is UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function initialize(address parentToken_, string memory distributorName_) public initializer {
        ...
        minPeriod = 1 hours;
        minDistribution = .01 * (10 ** 18);
        swapBNBThreshold = 10 * (10 ** 18);
    }
