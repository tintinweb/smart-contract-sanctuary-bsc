...
contract Ruptly  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ruptly ";
    string private _symbol = "Ruptly";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfE8BDB3145A8B08C455CD9Ab33f62c3701a580B1); // Marketing Address
    address payable public teamWalletAddress = payable(0xfE8BDB3145A8B08C455CD9Ab33f62c3701a580B1); // Team Address
