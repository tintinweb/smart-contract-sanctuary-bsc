...
contract ACTA is ACTADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ACTATeam;
    address private CharityACTA;
    ...
    string public override name = "ACTA";
    string public override symbol = "ACTA";
    ...
    constructor(uint totalSupplyValue, address ACTATeamAddress, address CharityACTAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ACTATeam = ACTATeamAddress;
        CharityACTA = CharityACTAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ACTATeam] =  totalSupply * 4 / 100;
        balances[CharityACTA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ACTATeam pot
