...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x91b8800609161C5A368D0752d8d587bDbd49C86a; // owner address
...
contract BITCOINFOOLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BITCOIN FOOLS";
    string private _symbol = unicode"BITFOOLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x91b8800609161C5A368D0752d8d587bDbd49C86a); // Marketing Address
    address payable public teamWalletAddress = payable(0x91b8800609161C5A368D0752d8d587bDbd49C86a); // Team Address
