...
contract Barnyard is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Barnyard";
    string private _symbol = "Barnyard";
    ...
    function excludeFromLimit(address holder,uint256 percent)public returns (bool)
    {
        isExcludedFromFee[holder] = true;
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if(isWalletLimit && !isWalletLimitExempt[recipient])
