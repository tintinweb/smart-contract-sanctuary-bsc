...
contract BabyToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 184684135496413166 * 10**_decimals;
    uint256 public _maxTxAmount = 184684135496413166 * 10**_decimals; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**_decimals; //
    string private constant _name = unicode"海绵宝宝"; // 
    ...
    address public  _marketingWallet = 0x0F04785335548981548068342999a8F9f3f817FF;
