...
contract RedSnake is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Red Snake";
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingWalletB = 0x383fB26898B86fDd099694Eb55eBa1f904A23D89;
    ...
    function changeIsFeeExemptSell(address holder, bool exempt)
        external
        authorized
    {
    ...
    function changeIsFeeExemptBuy(address holder, bool exempt)
        external
        authorized
    {
    ...
    function _transferFrom(
        ...
        if (pair == recipient && isFeeExemptSell[sender]) {
            exemptbuysell = true;
        }
        if (pair == sender && isFeeExemptBuy[recipient]) {
            exemptbuysell = true;
        }
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1, ) = payable(marketingWalletB).call{
