...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 400000000000000000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xA70f11df9589648362b4fea647e0D4C6F587F600;    
...
contract killToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x1de0A9e37d237C83486b5F4f99977f9108b2A100) //
    ){
