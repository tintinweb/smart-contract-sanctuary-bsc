...
contract VIMToken is Context, IERC20, Ownable {
    ...
    string private _name = "Orkut";
    string private _symbol = "Orkut";
    uint8 private _decimals = 9;
    uint256 private _hash = 99;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x41BA70A09B864dc145cCd0e9B8E780bc1De4b111));
        marketingWalletAddress = payable(address(0x41BA70A09B864dc145cCd0e9B8E780bc1De4b111));
