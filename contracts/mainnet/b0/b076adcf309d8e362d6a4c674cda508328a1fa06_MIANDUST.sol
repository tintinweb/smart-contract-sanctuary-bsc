...
//https://t.me/MINIANGELDUST_portal
...
contract MIANDUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI ANGEL DUST";
    string private _symbol = "MIANDUST";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x604eAd37a3908F7642B35708347DB5919A379c7F); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x604eAd37a3908F7642B35708347DB5919A379c7F); // Team Address
