...
function toByte(uint8 _uint8) public pure returns (bytes1) {
   ...
   function getSpecHash(string calldata basestring) public view returns (string memory) {
    ...
    function joinPyramid(string calldata passcode, string calldata newpass) public payable returns (uint256) {
        ...
        require (msg.value >= 1050000000000000000, "Incorrect amount of BNB sent");
        ...
        uint distrubtedbnb = 1000000000000000000; 
         ...
         earnedBnb[originalentrant] += ((2 * distrubtedbnb)/rewardMultiplier) + 50000000000000000;
         totalearned[originalentrant] += ((2 * distrubtedbnb)/rewardMultiplier) + 50000000000000000;
         return 55;
