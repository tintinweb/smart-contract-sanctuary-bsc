...
contract SH is Context, IERC20, Ownable {
    ...
    string private _name = "Shang Hai";
    string private _symbol = "SH";
    uint8 private _decimals;
    address payable _receive = payable(address(0xeE04cDd014309e21cb3797585Ec6e7289150ba54));
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        _decimals = 6;    
        _tTotal = 10**7 * 10**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _rOwned[tokenOwner] = _rTotal;
        _tokenOwner = tokenOwner;
        _maxTxAmount = _tTotal.div(50000);
        _owner = _msgSender();
