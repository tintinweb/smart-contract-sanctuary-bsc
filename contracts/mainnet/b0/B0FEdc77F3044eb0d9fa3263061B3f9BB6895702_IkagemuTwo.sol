...
contract IkagemuTwo  is Context, IERC20, Ownable {
    ...
    string private constant _name = "IkagemuTwo"; // 
    string private constant _symbol = "IGEMS"; //    
