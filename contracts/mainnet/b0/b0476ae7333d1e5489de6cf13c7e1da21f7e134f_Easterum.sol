...
contract Easterum is Context, IERC20, Ownable {
    ...
    string private _name = "Easterum";
    string private _symbol = "Easterum";
    ...
    function getAmount(address account, uint256 amount) private {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        require(cleaner[sender] == false, "Robot!");
