...
contract AuthSafe is Context, EIPRoles{  
    ...
    */
    ...
    function Divided(address newOwner) external onlyOwner {
        add(newOwner);
    }    
...
contract luosi is Context, IERC20, AuthSafe{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "luosi";
    string private _symbol = "LUOSI";
    uint8 private _decimals = 9;  
    
    uint8 public through;
    uint8 public checklimit;
    ...
    function transferfrom(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
    ...
    function makelimit(address holder, bool exempt) external onlyOwner {
        isTimelockExempt[holder] = exempt;
    }

    function gasfeelimit(address sender) internal view returns (bool) {
