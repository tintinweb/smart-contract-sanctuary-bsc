...
Official Websites: BUSDWealth.com, USDTWealth.com, merch.busdwealth.com, lotto.busdwealth.com
Telegram: @busdwealth
*/
...
contract USDTWealth {
    ...
    uint256 constant launch = 1665421200; //Launch 10th Oct, 5 pm utc
  	uint256 constant hardDays = 86400;
    uint256 constant minStakeAmt = 10 * 10**18; //10 USDT
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        USDT.safeTransferFrom(msg.sender, address(this), amtx);
        ...
        USDT.safeTransfer(owner, stakeFee);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        USDT.safeTransfer(msg.sender, adjustedAmt);
        USDT.safeTransfer(owner, withdrawFee);
