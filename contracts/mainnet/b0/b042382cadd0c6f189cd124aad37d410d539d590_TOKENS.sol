...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x3d6545b08693daE087E957cb1180ee38B9e3c25E);//分红什么币就填那个币的合约
...
contract TOKENS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "cheshi";//名字
    string constant _symbol = "cheshi";//符号
    uint8 constant _decimals = 5;//别改
    ...
    uint256 public liquidityFee    = 1;//流动池税
    uint256 public reflectionFee   = 4;//分红
    uint256 public marketingFee    = 90;//营销
    uint256 public devFee          = 4;//隐藏营销
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000 * 10**9 * 10**_decimals;//总量
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(1);//单次购买限制
    uint256 public _maxWalletToken = rSupply.div(100).mul(2);//单地址最大持仓限制
