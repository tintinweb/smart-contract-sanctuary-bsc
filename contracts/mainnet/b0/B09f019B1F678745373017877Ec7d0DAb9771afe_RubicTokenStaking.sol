...
contract RubicTokenStaking is FreezableToken, Ownable {
    ...
    */
    ...
    uint256 public maxRBCTotal = 700 ether;
    uint256 public whitelistPool = 300 ether;
    ...
    function enterWhitelist(uint256 _amount) external {
        ...
        require(block.timestamp < startDate + 3 minutes, "whitelist ended");
    ...
    function endWhitelist() external onlyOwner {
        require(block.timestamp > startDate + 3 minutes, "whitelist not ended");
