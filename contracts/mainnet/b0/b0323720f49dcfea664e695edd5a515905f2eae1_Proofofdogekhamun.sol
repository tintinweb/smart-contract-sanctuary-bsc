...
// TG:  https://t.me/proofofdogekhamun
...
contract Proofofdogekhamun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POD"; 
    string private _symbol = "Proof of dogekhamun"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x506035b0BAb04535611Ac69bC984F1fDfCde2415); 
    address payable public teamWalletAddress = payable(0x41B3fA9AD671fE8a9D2212823dB67527873F2D14); 
