...
contract Test is ERC20Detailed, Ownable {
    ...
    uint256 public liquidityFee = 20; //5%  only for buy
    uint256 public inviteFee = 80;//10% //only for buy
    uint256[] public REFERRAL_PERCENTS = [40, 20, 5, 5, 5, 5, 5, 5, 5, 5];

    uint256 public treasuryFee = 40;//5% only for sell
    uint256 public consensusFundFee = 0;//2.5% only for sell
    uint256 public daoFee = 60;//5% dao fee.only for sell
    uint256 public firePitFee = 20;//2.5% only for sell
