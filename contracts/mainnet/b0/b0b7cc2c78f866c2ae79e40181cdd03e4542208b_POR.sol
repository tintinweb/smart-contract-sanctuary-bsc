...
// Join our community at https://t.me/PortugalFanTokenBSC
...
contract POR is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "Portugal Fan Token";
    ...
    constructor (IUniRouterV2 _router) Auth(msg.sender) {
        ...
        //Wallets
        autoLiquidityReceiver = address(0x08da91e8af5d4D552890bC2514A9f73eF25D7D81);
        marketingWallet = address(0xD54218fEb44Ea1C216Bbf845127Bcced5D61899D);
        developmentWallet = address(0x08da91e8af5d4D552890bC2514A9f73eF25D7D81);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Blacklist
        if(blacklistMode){
            require(!isBlacklisted[sender] && !isBlacklisted[recipient],"Blacklisted, trade impossilbe.");    
        }
