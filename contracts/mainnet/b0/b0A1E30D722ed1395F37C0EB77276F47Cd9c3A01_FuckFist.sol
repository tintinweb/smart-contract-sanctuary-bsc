...
abstract contract ParentToken is ERC20, uniSwapTool {
    ...
    uint256 internal rewardSwapThreshold = 0.2 ether;
    ...
    function aliasReward() internal {
        ...
        if (amount == 0) return;
        uint256 prize = 400 * amount / divBases;
        handRewards(prize);
...
contract FuckFist is Ownable, ERC20, ParentToken, ReentrancyGuard, System {
    ...
    constructor(address _router, address _reward, address[] memory addrs) ERC20("Fuck Fist DAO", "FuckFist") {
