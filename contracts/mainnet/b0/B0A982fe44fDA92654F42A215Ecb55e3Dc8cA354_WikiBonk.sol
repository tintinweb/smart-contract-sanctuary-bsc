...
contract WikiBonk is Context, IERC20, Ownable {
    ...
    string private _name = "Wiki Bonk";
    string private _symbol = "WikiBonk";
    ...
    uint256 private _liquidFee = 7;
    uint256 private _previousLiquidFee = _liquidFee;
    
    uint256 private maxBuyTranscationAmount = 500000000 * 10**6 * 10**9;
    uint256 public maxSellTransactionAmount = 500000000 * 10**6 * 10**9;
    uint256 private _maxWalletToken = 1000000000 * 10**6 * 10**9;
