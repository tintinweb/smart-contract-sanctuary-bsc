...
contract Numberten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Number ten";
    string private _symbol = "Number ten";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x295FE6e5F46798232F28D071DE73a66E4D4cB23c);
    address payable public teamWalletAddress = payable(0xFEb3B13B1d453477c1180B215862FF02474FC8F8);
