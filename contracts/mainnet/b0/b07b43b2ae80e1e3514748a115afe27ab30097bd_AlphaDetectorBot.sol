...
contract AlphaDetectorBot is ERC20, Ownable {
    uint256 public buyFee               = 9;
    uint256 public sellFee              = 9;
    uint256 public walletToWalletFee    = 9;

    uint256 public projectShare         = 50;
    uint256 public marketingShare       = 50;

    address public marketingWallet = 0x4D926b499493d067153C76A9F0C9598d663DC969;
    address private projectWallet = 0x89d004B070bB3d9f578ED6316aB63bbE7F6112e3;
    ...
    constructor () ERC20("Alpha Detector Bot", "$ALPHABOT") 
    {   
        address newOwner = 0x4D926b499493d067153C76A9F0C9598d663DC969;
    ...
    function updateBuyFees(uint256 _buyFee) external onlyOwner {
        require(_buyFee<= 20, "Fees cannot be more than 20%");
        buyFee = _buyFee;
        emit BuyFeesUpdated(buyFee);
    }

    function updateSellFees(uint256 _sellFee) external onlyOwner {
        require(_sellFee<= 20, "Fees cannot be more than 20%");
        sellFee = _sellFee;
