...
interface IUfxLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in GGRAIN per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in GGRAIN token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInGGrain: price of a ticket in GGRAIN
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Ufx lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == ufx, "Only UfxLottery");
    ...
    /**
     * @notice Set the address for the UfxLottery
     * @param _ufx: address of the Ufx lottery
     */
    function setLotteryAddress(address _ufx) external onlyOwner {
        ufx = _ufx;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IUfxLottery(ufx).viewCurrentLotteryId();
    }
}