...
contract Apollo is IERC20, Ownable {
    ...
    address _fund1Address = address(0xCaC63b25db09214B32C780dFa1a0A0db280299E2);
    
    address _default1 = address(0x000000000000000000000000000000000000dEaD);
    ...
    function _takeInviterFee(
        ...
        for (int256 i = 0; i < 2; i++) {
            ...
            if (cur != address(0) && !_isExcludedFromInviter[cur]) {
                ...
                uint256 curTAmount = tAmount.div(1000).mul(rate);
                uint256 curRAmount = curTAmount.mul(currentRate);
                _rOwned[_default1] = _rOwned[_default1].add(curRAmount);
                
                emit Transfer(sender, _default1, curTAmount);
