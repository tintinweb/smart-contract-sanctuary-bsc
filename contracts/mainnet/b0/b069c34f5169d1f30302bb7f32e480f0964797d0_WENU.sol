...
contract WENU is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x9B36D1647e638Dbd9502f4d7889936f13C20deFf);
    ...
    string private constant _symbol = unicode"WENU";
