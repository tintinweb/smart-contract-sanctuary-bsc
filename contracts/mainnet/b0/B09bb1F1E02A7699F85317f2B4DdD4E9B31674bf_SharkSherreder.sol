...
Shark Sherreder is a community driven token on BSC, simply hold and watch your SHARK grow value every moment, we present this token to build a new meme token for community. Degen play & safe play
...
💬Telegram : https://t.me/sharksherreder
*/
...
contract SharkSherreder is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1000000000 * 1e9; // 10.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Shark Sherreder";
    ...
    uint256 public maxBuyAmount = (_tTotal / 10000) * 75; // 1,5% of Supply
    uint256 public maxSellAmount = (_tTotal / 10000) * 75; // 1,5% of Supply
    uint256 public maxWallet = (_tTotal / 10000) * 150; // 1,5% of Supply
    ...
    constructor() {
        ...
        marketingAddress = payable(0x21FcD951708911c57B2E8e173bCF2f2a5462d838); // Marketing Address
