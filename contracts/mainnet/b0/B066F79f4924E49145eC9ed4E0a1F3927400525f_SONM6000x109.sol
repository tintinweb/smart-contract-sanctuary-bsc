...
contract SONM6000x109 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5C8AC4E6c3eAD84096eBdd24ea32D5F33179A87B); 
    address payable public Wallet_Dev = payable(0x5C8AC4E6c3eAD84096eBdd24ea32D5F33179A87B);
    ...
    string private constant _name = "SONM6000x"; 
    string private constant _symbol = unicode"SNM"; 
    ...
    constructor () {
        ...
        _owner = 0x5C8AC4E6c3eAD84096eBdd24ea32D5F33179A87B;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        require(random_Token_Address != address(this), "Can remove native token");
