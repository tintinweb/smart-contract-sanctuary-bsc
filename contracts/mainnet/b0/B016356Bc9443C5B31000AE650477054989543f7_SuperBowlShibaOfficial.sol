...
// Trying something different today for the super bowl. 
// I will say this. I do not plan to have a high sell tax. It will be fair but not outrageous. 
// This wont be the hotel california, you will be able to leave at will. 
// I am considering 7% buy & 21%  Sell at launch. 7% Buy and 14% after the first 30 minutes. 
// At kickoff i will switch taxes to 0% Buy and 21% Sell for the entire first quarter. There will 
// be buy contests throughout the entire day but the prizes will be higher during the game. At halftime i will set taxes to whatever the score is. After halftime taxes will reset back to 7% buy and 14% Sell until our next buy contest.

// * I will be manually buying back every touch down 

// * After every turnover i will burn 1% of the supply. (fumble or interception)

// * If there is a “safety.” I will set taxes to 0% Buy & 2% Sell tax until the next kick off. (roughly 10 minutes)

// * If there is a successful kick return or a punt return. I will do a massive buy back: %50 of whatever is in the marketing wallet. 🏈

// 📱 Telegram: https://t.me/superbowlshiba
// WIZARD / KOROMARU INU
...
contract SuperBowlShibaOfficial is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xa9952e76Dd54B1780DFc8e9Ab1218eff054f1ff5); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xedF0016C3AE45121FB3E6FD15d65aF8fB5eA0850); // Ecosystem Wallet
    address payable private devWallet = payable (0xd828b046fA056E179A68291F09e03396Fb78Baf3); // dev Wallet
    ...
    string private _name = "Super Bowl Shiba";
    string private _symbol = "SuperBShiba";
