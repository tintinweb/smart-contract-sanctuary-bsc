...
contract TFMN is Context, IERC20, Ownable {
    ...
    string private constant _name = "TO FIFA MOON"; //
    string private constant _symbol = "TFMN"; //
    ...
    function setFBTFMN(address addr, bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }

    function setFETFMN(uint256 fe) external onlyOwner {
        _fbbe = fe;
    }
