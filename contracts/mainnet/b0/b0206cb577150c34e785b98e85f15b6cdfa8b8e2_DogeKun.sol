...
contract DogeKun is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Doge Kun";
    string private constant _symbol = unicode"DOGEKUN";
    ...
    address payable public DevWallet = payable(0x32ca7bFf235FBD8e0B1Afc14612acfB7428c916D);
    address payable public MarketingWallet = payable(0xcCb4c85a5a339cD70E0C2E836F9fcC7776C5A937);
