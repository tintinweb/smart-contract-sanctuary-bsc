...
/**
 Telegram: https://t.me/BurnMuuInu
*/
...
contract BurnMuuInu is IBEP20, Auth {
    ...
    string constant _name = "BurnMuuInu";
    string constant _symbol = "BMinu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 9) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0xc81e84A7d2B399cc0676973e20CA01ae2a88D1E7;
    address private teamFeeReceiver =0xc81e84A7d2B399cc0676973e20CA01ae2a88D1E7;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 9; // 0.3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0xc81e84A7d2B399cc0676973e20CA01ae2a88D1E7;
