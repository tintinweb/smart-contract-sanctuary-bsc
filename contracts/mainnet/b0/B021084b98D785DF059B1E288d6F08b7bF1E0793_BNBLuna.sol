...
library Address{
 ...
 contract BNBLuna is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 500000000000 * 10**9;
    uint256 public maxBuyLimit = 500000000000 * 10**9;
    uint256 public maxSellLimit = 500000000000 * 10**9;
    uint256 public maxWalletLimit = 1000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xa1a9b20B8c6a269Eb6EaBe2FceDE0307C2151C3E;
    address public donationWallet = 0xa1a9b20B8c6a269Eb6EaBe2FceDE0307C2151C3E;

    string private constant _name = "BNBLuna";
    string private constant _symbol = "BNBLuna";
