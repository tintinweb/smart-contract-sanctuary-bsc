...
contract surgethorge is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "THORGE";
    string private constant _symbol = "THORGE";
    ...
    //Tax wallets
    address public teamWallet = 0x24a47c5f7696287657a2a6c28D0aC3CA26141983;
    address public treasuryWallet = 0x1401d9c1C78d7e7CEbe633bCCa2de1a0dA351abE;
