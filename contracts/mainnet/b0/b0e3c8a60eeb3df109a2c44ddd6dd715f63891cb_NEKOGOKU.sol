...
/**
 * NEKOGOKU (¡Kame hame ha!)
 * ¡Kame hame ha!
 * Max Tx 9%
 * 9000000000 ¡Kame hame ha!
 * Total Tax: 14%
 * https://t.me/NEKOGOKU
 */
...
contract NEKOGOKU is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 9 * 10**9 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**_decimals;
    string private constant _name = "NEKOGOKU";
    string private constant _symbol = "Kame hame ha";
    uint8 private constant _decimals = 9;

    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0x7a37F3A061B72b200B7211B6ebF7A9eED30FFd8F;
