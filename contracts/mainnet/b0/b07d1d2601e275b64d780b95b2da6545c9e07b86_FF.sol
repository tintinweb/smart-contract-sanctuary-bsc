...
contract FF is Context, IERC20, Ownable {
    ...
    string private _name = "Financial Freedom";
    string private _symbol = "FF";
    uint8 private _decimals = 10;
    
    uint256 public _taxFee = 200; // 2%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 200; // 2%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 100; // 1%
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _treasuryFee = 0; // 0%
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000 * 10**10;
    uint256 public minNumTokensSellToAddToLiquidity = 50 * 10**10;
