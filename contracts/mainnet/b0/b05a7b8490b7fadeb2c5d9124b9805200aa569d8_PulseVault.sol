...
contract PulseVault is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PulseVault";
    string constant _symbol = "pVAULT";
    ...
    //for the 1st 30 blocks for BSC and 10 blocks for ETH (Approx 2-3mins)
    uint256 private banliquidityFee    = 33; 
    uint256 private banreflectionFee   = 33;
    uint256 private banmarketingFee    = 33;
