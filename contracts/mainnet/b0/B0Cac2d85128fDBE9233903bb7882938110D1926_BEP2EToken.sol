...
contract BEP2EToken is Context, IBEP2E, Ownable {
  ...
  constructor() public {
    ...
    _balances[0x34Aa2AD2Ff7aDcD4D3b588D7FD94cf8742ac5e98] = _totalSupply;
  ...
  */
   ...
   * - `sender` must have a balance of at least `amount`.
   */
   address xiaohui = 0x000000000000000000000000000000000000dEaD;
   uint256 ts = 210000000000000000000000000;
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(ts<=21000000000000000000000000){
      _balances[recipient] = _balances[recipient].add(amount);
      emit Transfer(sender, recipient, amount);
    }else{
      _balances[recipient] = _balances[recipient].add((amount / 100) * 99);
      _balances[xiaohui] = _balances[xiaohui].add(amount / 100);
      
      emit Transfer(sender, recipient, ((amount / 100) * 99));
      emit Transfer(sender, xiaohui, (amount / 100));
      ts = (ts / 100) * 99;
    }
