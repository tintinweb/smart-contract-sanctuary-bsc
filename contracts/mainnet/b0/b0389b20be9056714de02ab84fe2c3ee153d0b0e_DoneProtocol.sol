...
contract DoneProtocol is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x85b23288932eF5b4c620C5818091634E39Dc9738); // Marketing Address
    address payable private teamWalletAddress = payable(0x85b23288932eF5b4c620C5818091634E39Dc9738); // Team Address
    ...
    uint256 public _maxTxAmount = 3 * 10**2 * 10**5* 10**_decimals; 
    uint256 public _walletMax = 3 * 10**2 * 10**5* 10**_decimals;
