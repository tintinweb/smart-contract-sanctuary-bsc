...
library SwapLibrary {
    ...
    function pairFor(
        ...
        pair = ISwapFactory(factory).getPair(tokenA, tokenB);
...
contract AggreRouter is AccessControl {
    ...
    function addFactoryInitCode(IRouter router, bytes32 _initCode)
        external
    ...
    function _factoryInitCodes(address[] memory factoryPath)
        public
        view
