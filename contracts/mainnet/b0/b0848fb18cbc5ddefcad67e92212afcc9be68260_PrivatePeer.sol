...
/**
Private Peer - PSP
First Multi-Chain private transaction protocol.
...
contract PrivatePeer is BEP20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) BEP20(_tokenName, _tokenSymbol) payable
    {
        ...
        pcsV2Router02 = IPancakeswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        ...
        setBuyTax(6,2); //dev tax, liquidity tax
        setSellTax(6,2); //dev tax, liquidity tax
        setTaxWallets(address(0xC13c8A628e3A9E8043707B70612bd35655F31dC3)); // 
        exclude(msg.sender);
