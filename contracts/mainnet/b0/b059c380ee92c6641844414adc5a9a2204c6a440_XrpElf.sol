...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("XrpElf_Track", "XRPELF", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract XrpElf is Main {
    ...
    constructor() Main (
        ...
        0xccc616C7C5e44B47C9DC73cc796a78A3ea25A5cF,     // Marketing address
        0xccc616C7C5e44B47C9DC73cc796a78A3ea25A5cF,     // Team address AND DEV
        0xccc616C7C5e44B47C9DC73cc796a78A3ea25A5cF,     // Multi Use address (CHARITY)
