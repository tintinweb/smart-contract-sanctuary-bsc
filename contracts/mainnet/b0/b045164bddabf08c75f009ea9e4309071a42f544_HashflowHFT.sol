...
Genesis Token Supply: 1,000,000,000 HFT (Planning a 5% issuance to 
the DAO treasury per year after 4 years upon token launch, or this can be disabled by DAO voting)
Launchpool Token Rewards: 15,000,000 HFT (1.5% of genesis token supply)
Initial Circulating Supply: 175,229,156 HFT (17.52% of genesis token supply)
...
Farming Period: 2022-11-01 00:00 (UTC) to 2022-11-30 23:59 (UTC).
Hashflow FAN TOKEN
*/
...
contract HashflowHFT is HashflowDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HashflowTeam;
    address private CharityHashflow;
    ...
    string public override name = "Hashflow HFT";
    string public override symbol = "Hashflow";
    ...
    constructor(uint totalSupplyValue, address HashflowTeamAddress, address CharityHashflowAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HashflowTeam = HashflowTeamAddress;
        CharityHashflow = CharityHashflowAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HashflowTeam] =  totalSupply * 5 / 100;
        balances[CharityHashflow] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's HashflowTeam pot
