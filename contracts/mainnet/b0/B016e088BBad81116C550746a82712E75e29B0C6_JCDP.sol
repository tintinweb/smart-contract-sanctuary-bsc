...
contract JCDP is ERC20 {
    ...
    constructor() ERC20("JCDP", "JCDP") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x845eFFF8F277D402476EE5884223A0B436D91f5d);
        marketAddress = address(0xc1e3f3f0D7bfB38F56a8a739A4A272E131c26ECb);
        teamAddress= address(0x58DD70a9f7e067fEE9Af64b9b2257F5aC8916ca2);
        ...
        if (takeFee) {
            ...
            if(ammPairs[to] ){//卖出
                   uint256 share = amount.div(100);
                    ...
                    super._transfer(from, deadAddress, amount.div(100).mul(1));//1%销毁             
                    super._transfer(from, address(this), amount.div(100).mul(3));//分红营销3%                   
                    _takeInviterFeeKt(amount.div(10000)); //0.01%空投

                    feeAmount = feeAmount.add(share.mul(3));  
                    amount = amount.div(100).mul(96);//96%
                
            }else if(ammPairs[from]){// 买入
                uint256 share = amount.div(100);

                super._transfer(from, address(this), amount.div(100).mul(4));//分红营销4%
                 _takeInviterFeeKt(amount.div(10000)); //0.01%空投
