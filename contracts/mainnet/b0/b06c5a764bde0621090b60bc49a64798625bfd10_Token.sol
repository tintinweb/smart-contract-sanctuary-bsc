...
POTFOLIO
THE FIRST DECENTRALIZED CRYPTO ETF!
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Potfolio", "PTF") {

        address _owner = 0x89E6ff0F25a02e1fFD878c2930b274BC16248E7d;
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _maintenanceFee, uint256 _portfolioFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _maintenanceFee, uint256 _portfolioFee) external onlyOwner {
