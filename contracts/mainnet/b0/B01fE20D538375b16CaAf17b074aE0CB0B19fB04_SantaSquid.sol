...
/**
Telegram : https://t.me/SantaSquid
*/
...
contract SantaSquid is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Santa Squid";
    string constant _symbol = "SASQ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 33) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 33) / 100; 
    ...
    address public devFeeReceiver = 0xEc991320dC7e45003855eA0b26cc3BAD69E88d20;
    address public buybackFeeReceiver = 0xEc991320dC7e45003855eA0b26cc3BAD69E88d20;
