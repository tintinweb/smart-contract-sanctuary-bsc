...
💰 对于在发布开始时不出售的持有者，将获得价值 1 BNB 的赠品

TG : https://t.me/polarisprograminucn
*/
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also POLARISINUed.
...
// File: contracts/POLARISINUDividendPayingToken.sol
...
contract POLARISINU  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0x36f044b31b33302c64d0e505F2dc6B3B3d13Cd5f);
    ...
    POLARISINUDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("POLARISINU", "POLARISINU") {
        ...
        dividendTracker = new POLARISINUDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "POLARISINU: The dividend tracker already has that address");

        POLARISINUDividendTracker newDividendTracker = POLARISINUDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "POLARISINU: The new dividend tracker must be owned by the POLARISINU token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "POLARISINU: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "POLARISINU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "POLARISINU: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "POLARISINU: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "POLARISINU: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "POLARISINU: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "POLARISINUBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "POLARISINU: This account cannot send tokens until trading is enabled");
        }
...
contract POLARISINUDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("POLARISINU_Dividend_Tracker", "POLARISINU_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "POLARISINU_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "POLARISINU_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main POLARISINU contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "POLARISINU_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "POLARISINU_Dividend_Tracker: Cannot update claimWait to same value");
