...
contract MT123 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MT123";
    string private _symbol = "MT123";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD3c74B75Bc9942fc14B2F322AEeBB92F6ED832F0);
    address payable public liquidityContractAddress = payable(0x520AE3261D5Af8912791f7902ADB39814af300A9);
    ...
    constructor () {
        ...
        _balances[0x02C280546902CC8e95035e9a572f79C51Ed01731] = _totalSupply;
