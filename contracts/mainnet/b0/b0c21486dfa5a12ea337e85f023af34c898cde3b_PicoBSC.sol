...
TELEGRAM: t.me/picobsc
Picobsc is a meme token based on popular flash game "Pico's school" created by Tom Flup on 1999.
At the time of its release,it was "one of the most sophisticated" browser games, 
exhibiting a complexity of design and polish in presentation that was virtually unseen in amateur flash game development.

Let's bring the legendary pico to its life.
...
contract PicoBSC is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'PicoBSC';
    string private constant _symbol = 'Pico';
    ...
    //DevWallets
    address public Development=payable(0x1DF8dDc205FCe12E604CbBcfb30d6837819655f5);
    address public Marketing=payable(0x1DF8dDc205FCe12E604CbBcfb30d6837819655f5);
    //TestNet
