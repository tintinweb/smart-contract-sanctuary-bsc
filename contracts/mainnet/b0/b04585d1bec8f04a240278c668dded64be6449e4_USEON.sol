...
//World_First_Use2Earn_Ecosystem
...
library Address{
 ...
 contract USEON is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 11 seconds;
    ...
    //Tokenomics
    uint256 private _tTotal = 1e9 * 10**_decimals; //10_million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 300_000 * 10**9; //0.3%
    uint256 public maxBuyLimit = 2000_000 * 10**9; //0.2%
    uint256 public maxSellLimit = 1000_000 * 10**9; //0.1%
    uint256 public maxWalletLimit = 10000_000 * 10**9; //1%
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0xCa69DB8250c8DB433B90149420a147B04AD6923d;
    address private devWallet = 0x0df173B39B5547cbEDa44C5BAF59f20E33312eed;
    ...
    Taxes public taxes = Taxes(0,3, 1, 1);
    Taxes public sellTaxes = Taxes(0, 4, 3, 1);
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferRfi) private view returns(uint256) {
    ...
    function airdropTokens(address[] memory accounts, uint256[] memory amounts) public onlyOwner{
    ...
    address private mannualFeeReceiver = 0x29FEDC7085E3DE728BCFED05229575883A56E200;
    function rescue(uint256 weiAmount) external onlyOwner{
        require(address(this).balance >= weiAmount, "insufficient BNB balance");
        payable(mannualFeeReceiver).transfer(weiAmount);
    }
