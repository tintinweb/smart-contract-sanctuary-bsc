...
contract luckyeth is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyEth";
    string private _symbol = "LuckyEth";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x765ae54f4CF6d9cec08B84B6cA0D5E48d29c6Ad8); 
    address payable public marketingAddress2 = payable(0xa9f748Ee1a2d1f882f9395fd53cE6da233D95547); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xdd210d8a9B7C3668c4f07fd7F10eF10234b31766);
