...
contract DocatINU is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Docat INU";
    string private _symbol = "DOG CAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x65CC3f69BA6356Ad2523EcA1c5A86b3BeFBa26Ac); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x65CC3f69BA6356Ad2523EcA1c5A86b3BeFBa26Ac); // BuyBack Address
