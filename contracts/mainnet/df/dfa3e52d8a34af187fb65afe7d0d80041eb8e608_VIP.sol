...
/**
SquidGold Lion $VIP
Telegram https://t.me/SquidGoldLion
website https://squidgoldlion.finance
*/
...
contract VIP is Context, IERC20, Ownable {
    ...
    string private _name = "Squid Gold Lion";
    ...
    uint256 public _maxTxAmount = 800 * 10**6 * 10**9;
    uint256 public _walletMax = 800 * 10**6 * 10**9;
