...
contract SHINJUROINU is IERC20, Ownable {
    ...
    string _name = "Shinjuro Inu";
    string _symbol = "ShinjuroInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 15) / 100;   // 2%
    uint256 public _maxTxAmount = (_totalSupply * 15) / 100;     // 2%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x09fd3A61001549068335e818c460225A9C51d21E;
        marketingFeeReceiver = 0x09fd3A61001549068335e818c460225A9C51d21E;
        devFeeReceiver = 0x09fd3A61001549068335e818c460225A9C51d21E;
