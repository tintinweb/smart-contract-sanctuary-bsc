...
// TG : https://t.me/MarsNetworkBSC

// SAFE
// 🪐 Website Soon
// 🌍 Chain Creation In plans
// ✅ Locked LP
// 🌘 Low Market Cap
// 🤫 Stealth launch
// 🍃 Organic Floor
...
contract MARSNETWORK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MARS NETWORK";
    string private constant _symbol = unicode"MARSNET";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x8313188630BC7ffBD9CF961FE849027e1D64402a);
    address payable public MarketingWallet = payable(0xa06E4B4f288F3c0fB7907f9C8e79C2C34E94d447);
