...
// Shib Dealer 摸索了袋子，我们不在这里做
//  在微信上找到我们，@flokidealer
...
contract FlokiDealer is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Floki Dealer";
    string constant _symbol = "FlokiDealer";
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0xFf04EA2C489903BECaa939A2EF16af36be6aE5fF;
    address private buybackFeeReceiver = 0xFf04EA2C489903BECaa939A2EF16af36be6aE5fF;
