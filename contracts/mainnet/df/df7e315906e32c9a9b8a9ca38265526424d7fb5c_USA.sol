...
/**
USA FAN TOKEN
Official Fan Token of USA national football team 🚀
...
contract USA is USADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private USATeam;
    address private CharityUSA;
    ...
    string public override name = "USA Fan Token";
    string public override symbol = "USA Fan Token";
    ...
    constructor(uint totalSupplyValue, address USATeamAddress, address CharityUSAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        USATeam = USATeamAddress;
        CharityUSA = CharityUSAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[USATeam] =  totalSupply * 4 / 100;
        balances[CharityUSA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's USATeam pot
