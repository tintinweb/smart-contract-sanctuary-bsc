...
// File: SUPERMOONDOGEINU.sol

//SPDX-License-Identifier: Unlicensed
//Join Telegram to discover more!
//Telegram: t.me/supermoondogeinu
//FEES: 10% on Buy for Marketing/Buyback/Liquidity + 2% extra on Sell
//LIQUIDITY LOCKED! THIS IS A COMMUNITY PROJECT!
...
contract SUPERMOONDOGEINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SUPER MOON DOGE INU";
    string constant _symbol = "SMDI";
    ...
    uint256 _totalSupply = 1000000 * 10**4 * (10 ** _decimals);
    uint256 public _maxTxAmount = 500000 * 10**4 * (10 ** _decimals);
    uint256 public _walletMax = 500000 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1428E87Cc5923B929d019C3281E3a96cA41A0B7f;
        marketingWallet = 0x07979Db6f2181F4804803B3CFDD4013f163E0370;
        devWallet = 0x1428E87Cc5923B929d019C3281E3a96cA41A0B7f;
