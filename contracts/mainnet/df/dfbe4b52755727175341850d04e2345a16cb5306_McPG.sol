...
contract McPG is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "McPepes Grow";
string private _symbol = "McPG";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0x282edfd3C832Bb4490616076d8AE3ed6FB6BCE3b); // Marketing Address
address payable private TeamWallet = payable(0x282edfd3C832Bb4490616076d8AE3ed6FB6BCE3b); // Buy Back Address
