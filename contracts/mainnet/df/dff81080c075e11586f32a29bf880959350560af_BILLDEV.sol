...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x187317cba3DCe62296B74d19604db06f94D3B39e;
...
contract BILLDEV is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0x187317cba3DCe62296B74d19604db06f94D3B39e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BILLDEV";
    string private _symbol = "BILLDEV";
