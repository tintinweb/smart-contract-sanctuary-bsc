...
contract Halloween is IBEP20, Auth {
    ...
    string constant _name = "TRICKorTREAT";
    ...
    uint256 public trickortreatFee  = 1;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + trickortreatFee;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(trickortreatFee).div(totalBNBFee);
