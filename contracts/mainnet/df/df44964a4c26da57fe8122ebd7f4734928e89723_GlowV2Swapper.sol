...
contract GlowV2Swapper is ReentrancyGuard {
    address public owner;
    IPancakeRouter02 router;
    address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant glowToken = 0x606379220AB266bBE4b0FeF8469e6E602f295a84; // Glow Token
    ...
    function buyWithToken(uint amt, IBEP20 token) external nonReentrant {
        ...
        try
            router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                amt,
                0,
                getPath(address(token), glowToken),
                msg.sender,
                block.timestamp
            ) {
