...
contract KANPAIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "KANPAI INU"; // 
    string private constant _symbol = "KANPAI"; //    
