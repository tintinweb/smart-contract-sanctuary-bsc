...
contract MAOBULI is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "MAOBULI";
    string _symbol = "MBLI";
    uint8 _decimals = 9;
    ...
    function lowertrading(address holder) external onlyOwner {
    ...
    function average(uint256 iSupply) private pure returns(uint256, uint256) {
