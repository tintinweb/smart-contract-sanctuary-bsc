...
Telegram Chat: https://t.me/pluszerozeroseven

*/
// Following the trend,  +007 is number jackpot , we gonna make +007 the best number of the trend.
// It will fully give back to the community as it will be a community fully backed up project based on community hype of the early BSC stages.
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "+007"; //
    string private constant _symbol = "+007"; //
    uint8 private constant _decimals = 9; //
    
    uint256 private _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x58fC505B91dbc28a8900567556A3DAEaf4d2865B ;
