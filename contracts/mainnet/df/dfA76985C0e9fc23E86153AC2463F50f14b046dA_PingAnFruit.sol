...
contract PingAnFruit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PingAnFruit";
    string private _symbol = "PingAnFruit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9131f1623805F758EAA11Af52C322F98f66c47D4); // Marketing Address
    address payable public teamWalletAddress = payable(0x9131f1623805F758EAA11Af52C322F98f66c47D4); // Team Address
    ...
    uint256 private _totalSupply = 1381224 * 10**_decimals;
    uint256 public _maxTxAmount = 1381224 * 10**_decimals; 
    uint256 public _walletMax =1381224 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1381224 * 10**3; 
