...
/**
 * Squid Grimace
 * Join the most exciting meme token on BSC!
 *
 * 1,000,000 units
 * 20,000 max wallet
 *
 * https://t.me/squidgrimace
 */
...
contract SquidGrimace is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 2 * 10**4 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2 * 10**_decimals;
    string private constant _name = "Squid Grimace";
    string private constant _symbol = "SQUIDGRIM";
