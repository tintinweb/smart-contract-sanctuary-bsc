...
contract DogeBull is Context, IERC20, Ownable {
    ...
    string private _name = "DogeBull Inu";
    string private _symbol = "$DBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF96A2E34F0B522618A7A18f9C0F823AC141235b5); 
    address payable public buyBackWalletAddress = payable(0x17Ed2848172DA0087a5e2a89666d1e57626FA7C2); 
