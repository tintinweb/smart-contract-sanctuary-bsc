...
/**
*YOREUM NETWORK
Telegram: https://t.me/YOREUMNETWORK
Twitter: https://twitter.com/yoreumnetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6DAb5B68f54FC90D4ef8C56B2005B6FEbbfD2F45; // owner address
...
contract YOREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yoreum Network";
    string private _symbol = "YOREUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6DAb5B68f54FC90D4ef8C56B2005B6FEbbfD2F45); // Marketing Address
    address payable public teamWalletAddress = payable(0x6DAb5B68f54FC90D4ef8C56B2005B6FEbbfD2F45); // Team Address
