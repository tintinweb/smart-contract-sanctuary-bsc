...
contract BabyInuko is IBEP20, Auth {
    ...
    string constant _name = "BABY INUKO";
    string constant _symbol = "BABY INUKO";
    ...
    address public marketingFeeReceiver = 0x1440EeA557EDF0805f444f64632d7DAB1E5E1367;
    address public devFeeReceiver = 0xA8e5638dBB36d24d65CAA29F75A7E0C9691C26d6;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 25; // 0.25%
    bool inSwap;
