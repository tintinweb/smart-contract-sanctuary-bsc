...
/**
                        ­­┌──────────────────────┬────────────────────────────────────┐
                        │ DADBOD Tokens on BSC │  DadsAreFat.com In-Browser Mining  │
                        ├──────────────────────┼────────────────┬───────────────────┤
                        │ Web-Based CPU Mining │ NO GPU or ASIC │ NO CROWDFUND EVER │
                        ├──────────────────────┴────────────────┴───────────────────┤
                        │ DADBOD Total Mining Points Reset Monthly - Keep Earning!  │
                        │ No website registration or identity verifications needed  │
                        │ Total Accumulated Points get paid every week on Sundays   │
                        │ ALL Points earned will continue rewarding DADBOD Tokens   │
                        │ Points earned today will get paid for the entire month!   │
                        │ Mine DADBOD through your browser using only a BSC Address │
                        └───────────────────────────────────────────────────────────┘
*/
