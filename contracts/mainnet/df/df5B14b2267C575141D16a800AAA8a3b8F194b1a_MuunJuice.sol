...
https://t.me/MuunJuice
0%TAX 
Ownership renounced 
LP Burned 
100% community moon ;) (or muun?)
...
contract MuunJuice is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "MuunJuice";
    string private _symbol = "MuunJuice";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _burnTokenfee = 0;
    address private _burnaaddress = 0xE2ab7C6C31F62fB2945fBD3e45889bE7D7E4e16A;
