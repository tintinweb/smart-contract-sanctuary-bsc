...
contract BabyWater is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyWater";
    string private constant _symbol = "BabyWater";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 450000* 10**_decimals;
    uint256 public _maxTxAmount = 450000* 10**_decimals;
    uint256 public swapTokenAtAmount = 450000* 10**_decimals;
    ...
    address private marketingWallet = address(0x91b1363395d0a5E4aD1F849D67F159D24B4ADDcA);
    address private liquidityReceiver = address(0x91b1363395d0a5E4aD1F849D67F159D24B4ADDcA);
