...
import "./YoPlexNewToken.sol";

contract YoPlexNew {
    using SafeMath for uint256;

    IBEP20 private _YoPlexNewToken;
    ...
    constructor(IBEP20 YoPlexNewToken_) public {
        ...
        _YoPlexNewToken = YoPlexNewToken_;
    }
    ...
    function invest(address referrer) public payable {
        ...
        user.tokenBalance = user.tokenBalance.add(msg.value.mul(5000));
    ...
    function withdrawToken() public {
        ...
        _YoPlexNewToken.transfer(msg.sender, user.tokenBalance);
        user.lastDepositDate = block.timestamp;
        user.tokenBalance = 0;
    }
    ...
    function getUserTokenBalanceAndLockTill(address userAddress)
        public
        view
...
contract YoPlexNewToken is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public {
        _name = "YoPlexNewToken";
        _symbol = "YPLX";
        _decimals = 18;
        _totalSupply = 840000000000 * 10**18;
