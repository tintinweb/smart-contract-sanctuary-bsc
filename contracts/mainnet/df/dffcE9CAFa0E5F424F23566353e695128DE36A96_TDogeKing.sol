...
contract TDogeKing is IERC20, Ownable {
    ...
    address private funAddress = address(0x742665a88772fAc6cb2C28D954d90e87c3F6018C);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]  || balanceOf(_destroyAddress)>=999900000000000 * 10**18) {
            takeFee = false;
        }
