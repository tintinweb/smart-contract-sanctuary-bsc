...
contract Twabbit is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x9F97C7A1Ca4fEF71Acd8D0F61c6963794C9Ff7cb);
    
    string private constant _name = "Twitter Rabbit";
    string private constant _symbol = "Twabbit";
