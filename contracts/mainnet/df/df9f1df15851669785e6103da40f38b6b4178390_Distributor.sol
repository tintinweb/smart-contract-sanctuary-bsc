...
contract Distributor is IDistributor {
    ...
    uint256 public resetTime = 48 hours;
    uint256 public runTime = 7 days;
    uint256 public minPeriod = 7 days;
    uint256 public ticker = 1 minutes;
    uint256 public emergencyRate = 150;
    ...
    uint256 public maxStake = 20000 * (10 ** 18);

    bool public open = true;

    bool public initialized;

    Distributor public previous;
