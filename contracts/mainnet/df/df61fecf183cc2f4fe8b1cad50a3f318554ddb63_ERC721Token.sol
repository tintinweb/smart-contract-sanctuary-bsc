...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
          require(
            _checkOnERC721Received(from, to, tokenId, data) || _checkOnKIP17Received(from, to, tokenId, data),
            "ERC721: transfer to non ERC721Receiver/KIP17Receiver implementer"
        );
    }
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            _checkOnERC721Received(address(0), to, tokenId, data) || _checkOnKIP17Received(address(0), to, tokenId, data),
            "ERC721: transfer to non ERC721Receiver/KIP17Receiver implementer"
        );
    }
...
contract ERC721Token is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, Ownable {
    ...
    // for legacy
    function mintWithTokenURI(address to, uint256 tokenId, string memory uri) public onlyRole(MINTER_ROLE) returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, uri);
        return true;
    }
