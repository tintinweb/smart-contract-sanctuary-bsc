...
/**
//tg: https://t.me/BabySunekuCoinbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Suneku = IBEP20(0x27d51bcA0B145b3F701178c3Da5b66cDF66bD04E); //Suneku
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Suneku.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Suneku);
        ...
        uint256 amount = Suneku.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Suneku.transfer(shareholder, amount);
...
contract BabySunekuCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address Suneku = 0x27d51bcA0B145b3F701178c3Da5b66cDF66bD04E; //Suneku
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabySunekuCoin";
