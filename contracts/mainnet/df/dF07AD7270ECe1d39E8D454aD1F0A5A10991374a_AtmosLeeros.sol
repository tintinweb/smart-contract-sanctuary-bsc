...
contract AtmosLeeros is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Atmos Leeros";
    string private _symbol = "$AL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3C574f78DE1cEe866a85d2E8A533Fc3983046c4); // Wallet Marketing
    address payable public buyBackWalletAddress = payable(0xE3C574f78DE1cEe866a85d2E8A533Fc3983046c4); // Team Address
