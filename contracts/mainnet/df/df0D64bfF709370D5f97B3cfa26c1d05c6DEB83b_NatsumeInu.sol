...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25a36bAD597dF2E283bCFb57aC1A9EE24e28e326; // owner address
...
contract NatsumeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Natsume Inu";
    string private _symbol = "NATSUME";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x25a36bAD597dF2E283bCFb57aC1A9EE24e28e326); // Marketing Address
    address payable public teamWalletAddress = payable(0x25a36bAD597dF2E283bCFb57aC1A9EE24e28e326); // Team Address
