...
contract KingOfSinger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KingOfSinger";
    string private _symbol = "KOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf6d4C2e5a72B1c906D9a8F2f364968918c8A184B);
    address payable public teamWalletAddress = payable(0xFdf1725b7fb430b2c50ad86B29D9d174ea170714);
