...
contract Bullishbee is IERC20, Ownable {
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x3695ee845A08f7317E76b57e8e13538C8413aBEf;
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (liquidityFee, marketingFeeVariable, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFeeVariable, uint256 _giveawayFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFeeVariable = _marketingFeeVariable;
        giveawayFee = _giveawayFee;
        totalFee = liquidityFee.add(reflectionFee).add(marketingFeeVariable).add(giveawayFee);
