...
contract GoldenSparrow is Context, IERC20, Ownable {  
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount,uint TaxType) private {
        (uint256 rAmount, uint256 rTransferAmount,uint256 tTransferAmount, uint256 tFee) = _getValues(tAmount,TaxType);
    ...
    function _getValues(uint256 tAmount,uint TaxType) private view returns (uint256, uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount,tTransferAmount,tFee);
    }
