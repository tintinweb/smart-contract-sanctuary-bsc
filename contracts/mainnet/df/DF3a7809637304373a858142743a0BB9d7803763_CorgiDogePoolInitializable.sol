...
contract CorgiDogePoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public CORGI_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == CORGI_POOL_FACTORY, "Not factory");
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            require(stakedToken.balanceOf(msg.sender) >= 25000000000000000000000, "at least 25k tokens in wallet required");
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            //     stakedToken.safeTransfer(address(msg.sender), _amount.sub(_depositFee));
        ...
        if (pending > 0) {
            // rewardToken.safeTransfer(address(msg.sender), pending);
            uint256 _depositFee = pending.mul(depositFee).div(100);
