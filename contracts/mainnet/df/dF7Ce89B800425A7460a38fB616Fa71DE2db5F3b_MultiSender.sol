...
contract MultiSender is StandardToken {
   ...
   */
    ...
    *  VIP list
    */
    function addToVIPList(  address[] memory _vipList) public {
    ...
    */
    function removeFromVIPList(address[] memory _vipList) public {
        for (uint i =0;i<_vipList.length;i++){
    ...
    */
    ...
    /*
       * set vip fee
   */
    function setVIPFee(uint _fee) public {
        VIPFee = _fee;
    }
    ...
    /*
        * set tx fee
    */
    function setTxFee(uint _fee) public {
        txFee = _fee;
    }
