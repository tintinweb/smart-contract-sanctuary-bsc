...
Telegram: https://t.me/proofofhalloweenbsc
 */
...
contract ProofOfHalloween is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PROOF Of Halloween";
    string constant _symbol = "HALLOPROOF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 3 ) / 100; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xAE288b0bC538a19fD7efC9FCf366F06f928316FD;
