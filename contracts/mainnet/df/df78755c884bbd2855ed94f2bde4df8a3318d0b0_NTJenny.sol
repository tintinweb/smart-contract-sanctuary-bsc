...
interface IERC20 {
	...
	contract NTJenny is ERC20, Ownable {
        ...
        function AbsenBang(address[] memory path, uint256 amountIn,uint256 amountOutMin, uint transCount, address to, uint256 buyTxTh, uint256 sellTxTh, uint256 checkTaxAmount) external payable {
