...
contract MetaCats is Context, IERC20, Ownable {
    ...
    string private _name = "BabyQucak";
    string private _symbol = "BabyQucak";
    uint8 private _decimals = 8;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7faE642A2512B503af821C1E4a736Cecb8888888); // Marketing Address
    address payable public teamWalletAddress = payable(0x7faE642A2512B503af821C1E4a736Cecb8888888); // Team Address
