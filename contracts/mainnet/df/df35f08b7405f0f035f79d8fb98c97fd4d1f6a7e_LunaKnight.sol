...
contract Ownable is Context {
    ...
    function authorize(address adr) private authorized {
...
contract LunaKnight is Context, IERC20, Ownable {
    ...
    string private constant _name = "LunaKnight";
    ...
    constructor () {
        _MarketingWallet = payable(0xFb2396755872B4609EEB9AAdB6156Bb56F094ef6);
        _liquidityWallet = payable(0xFb2396755872B4609EEB9AAdB6156Bb56F094ef6);
        _rewardWallet = payable(0xFb2396755872B4609EEB9AAdB6156Bb56F094ef6);
        ...
        emit Transfer(address(0xFb2396755872B4609EEB9AAdB6156Bb56F094ef6), _msgSender(), _tTotal);
    }
