...
contract DND is DNDDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private DNDTeam;
    address private CharityDND;
    ...
    string public override name = "Dildonildos";
    string public override symbol = "DND";
    ...
    constructor(uint totalSupplyValue, address DNDTeamAddress, address CharityDNDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        DNDTeam = DNDTeamAddress;
        CharityDND = CharityDNDAddress;
       
        // split the tokens according to agreed upon percentages
        balances[DNDTeam] =  totalSupply * 4 / 100;
        balances[CharityDND] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's DNDTeam pot
