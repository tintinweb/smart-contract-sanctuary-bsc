...
/*
DoberInu
A new born BSC token with low tax & reflection, DoberInu is ready to dive into BSC. By having only 4% of tax, DoberInu is building a solid community & going for long term!

Join DoberInu TG : https://t.me/DoberInu

Tokenomics
1) 100,000,000,000 of supply (100 Billion)
2) Low tax fee : 4%
3) Maximum wallet : 3%
4) Initial LP : 1 BNB

Stealth launch soon in few hours, don't miss it!
*/
...
contract DoberInu is Context, IERC20 { 
    ...
    string private constant _name = "DOBERINU"; 
    string private constant _symbol = "DOBERINU"; 
