...
abstract contract ContextCNYuanDBep20 {
...
contract OwnableCNYuanDBep20 is ContextCNYuanDBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableCNYuanDBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableCNYuanDBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract YuanDigitalTokenCN is ContextCNYuanDBep20, CNYuanDBep20, OwnableCNYuanDBep20 {
    ...
    string private _symbol = 'DigitalYuan';
