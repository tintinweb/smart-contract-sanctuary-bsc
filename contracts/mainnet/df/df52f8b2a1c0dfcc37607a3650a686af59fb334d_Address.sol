...
/**
World's first project on bringing real world application to blockchain! Including DeFi products, NFT, Web3, and more

PRIME is a utility token to support our ecosystem of dapps

Telegram : https://t.me/PRIME_META
Website : https://primemetaverse.net/
Twitter : https://twitter.com/PrimeMETA
*/
...
contract COMF is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.BUSD());
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        uniswapV2Router.addLiquidityBUSD{value: ethAmount}(
            address(this),
            tokenAmount,
            0,
            0,
