...
contract dLegend is Context, IERC20, IERC20Metadata, Ownable, Operator {
    ...
    string private _name = "dLegend Dao"; // Legend Dao
    string private _symbol = "dLegend"; // Legend
    ...
    function excludeWhiteList(address account) public onlyOwner {
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if(!transferLock){
            flag =true;
        }else if(_isWhiteList[from] || _isWhiteList[to]){
            flag = true;
        }
        ...
        if(flag){
            ...
            revert("Transfer cannot be allowed");
        }
    }
