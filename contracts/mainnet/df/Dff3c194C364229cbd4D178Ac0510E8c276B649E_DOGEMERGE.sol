...
/**
 Doge Merge is this year's marvelous coin celebrating the Ethereum Merge and the next step of crypto along with the greatest memecoin of the world DOGECOIN.

 The ETH merge which many are calling the most important crypto event since Ethereum's launch, many people are confused, 
 scared or clueless as to what exactly to expect from this historical event for Ethereum.
 Whatever it may be but it is surely the most exciting event of crypto in this year.

 Come celebrate this remarkable moment in history with - DOGE MERGE

 Telegram: https://t.me/DogeMerge_Official
 Twitter: https://twitter.com/DogeMerge
 Website: https://dogemerge.com/
*/
...
contract DOGEMERGE is Ownable, IBEP20 {
    ...
    string constant _name = "DOGE MERGE";
    string constant _symbol = "DOME";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xAff57f47AFa96174DA1f9C1DB17D3cf81cb90214;
        marketingWallet = 0xC27fcb00b6e70cE7C4410C32Ba606EddBd0a4f97;
        devWallet = 0xAff57f47AFa96174DA1f9C1DB17D3cf81cb90214;
