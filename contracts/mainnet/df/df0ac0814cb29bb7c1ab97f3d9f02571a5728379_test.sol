...
contract test is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x5078efC58a3013A1f6DF3231A76759306DE80479); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x5078efC58a3013A1f6DF3231A76759306DE80479); // Ecosystem Wallet
    address payable private devWallet = payable (0x5078efC58a3013A1f6DF3231A76759306DE80479); // dev Wallet
    ...
    uint256 public _buyMarketingFee = 10;   //4%
    uint256 public _buyReflectionFee = 0;

    uint256 public _sellLiquidityFee = 10; //6%
    uint256 public _sellMarketingFee = 10;  //9%
    uint256 public _sellDevFee = 10;   //0%
    uint256 public _sellReflectionFee = 0;
    
    uint256 private ecosystemFee = 10;   //2% same for buys and sells
