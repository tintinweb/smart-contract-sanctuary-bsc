...
contract LookingForTeam is Context, IERC20, Ownable {
    ...
    string private constant _name = "LookingForTeam";
    string private constant _symbol = "LFT";
    ...
    address private marketingWallet = address(0x662A02842E23524E00fc8f70A32f416Cb6561f88);
    ...
    function blBots() public onlyOwner { 
