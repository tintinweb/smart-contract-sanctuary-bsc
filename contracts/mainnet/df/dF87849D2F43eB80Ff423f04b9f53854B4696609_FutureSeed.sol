...
contract FutureSeed {
	...
	constructor(address payable wallet,address payable  _DeveloperWallet,address payable _OwnerWallet) public {
        ...
        plans.push(Plan(1000, 2));	//20000/10000=2%
		plans.push(Plan(200, 3));	//30000/10000=3%
		plans.push(Plan(80, 5));	//30000/10000=5%
		plans.push(Plan(30,10));	//100000/10000=10%
		}
 ...
 referralLevel74Address[_customerAddress]                    = referralLevel73Address[_referredBy];
	...
	function withdraw() public {
		...
		require(totalAmount > 0, "User has no dividends");
		 ...
		 require ( user.withcheckpoint<=now,"connat withdraw before 24 hours complete"); 
	...
	function Checkupdate(uint256 WithAmt) public {
	...
	function ChangeOwnership(address payable _newOwner) public{
		   require(msg.sender == OwnerWallet, "Only owner can change");
