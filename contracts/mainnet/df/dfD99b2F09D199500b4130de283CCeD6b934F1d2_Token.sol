...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "KillAllZero";
    string private _symbol = "KillAllZero";
    ...
    constructor (address _marketingWalletAddress,address _teamWalletAddress) {
        ...
        _ownerAddress =_teamWalletAddress;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!botAddresses[sender],"you are a bot");
        ...
        else
        {
            ...
            if(_balances[recipient]>_walletMax){
