...
contract BTCB is IBEP20, Auth {
    ...
    string constant _name = "BITCOIN BLACK"; // Edit Name
    string constant _symbol = "BTCB"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 30000000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public marketingFee    = 7; // Edit Marketing Fee
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000; // Adjust Auto-Sell (10 = 1%)
    bool inSwap;
