...
contract Kodas is KodasDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private KodasTeam;
    address private CharityKodas;
    ...
    string public override name = "Kodas";
    string public override symbol = "Kodas";
    ...
    constructor(uint totalSupplyValue, address KodasTeamAddress, address CharityKodasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        KodasTeam = KodasTeamAddress;
        CharityKodas = CharityKodasAddress;
       
        // split the tokens according to agreed upon percentages
        balances[KodasTeam] =  totalSupply * 4 / 100;
        balances[CharityKodas] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KodasTeam pot
