...
interface IUniswapV2Factory {
    ...
    function gSPAR19air(address tokenA, address tokenB) external view returns (address pair);
...
contract SPAR19 is ERC20, Ownable {
    ...
    constructor (address newOwner) ERC20("SPAR19", "SPAR19") 
    {   
        transferOwnership(newOwner);
        operator = msg.sender;
        swapTokensAtAmount = 19_000_000 * (10 ** 18) / 5000;
        marketingWallet = newOwner;
        _mint(owner(), 19_000_000 * (10 ** 18));
        sellFee = 0; 
