...
contract BEP20 is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x000CaE12b3aAd400C9C569D1EbE20df5E3c0ebfB);
        teamAddress= payable(0xF7Ac9463d0013B980241b7CaD9Dd963fBb5041f5);
        ...
        _maxOnceEat = 50000000000 * 10**_decimals;
        _maxTotalEat = 50000000000 * 10**_decimals;
