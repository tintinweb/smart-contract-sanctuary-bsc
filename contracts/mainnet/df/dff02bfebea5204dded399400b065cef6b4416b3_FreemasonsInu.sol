...
contract FreemasonsInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "FREEMASONS INU";
    ...
    address private marketingWallet = address(0x0cf34B1730786EA3416C1045B8A976021378585f);
    address private liquidityReceiver = address(0x0cf34B1730786EA3416C1045B8A976021378585f);
