...
contract Token is ERC20 {
	...
	address private _fund1Address = address(0x54D7F896Aa6c10a30dddeD7D4a2f45d581892F47);
	address private _fund2Address = address(0x11bae6e088AF23A63Dfe9ed527AAE15e6Cb51664);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
			...
			if(from == uniswapV2Pair){
				...
				_userSellTime[from] = block.timestamp.div(86400);
			}else{
				require(amount <= getUserCanSell(from),"max out");
				_userSellTime[from] = block.timestamp.div(86400);
				takeFee = false;
