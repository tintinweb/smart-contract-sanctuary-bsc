...
contract LyftStock is IERC20, Auth {
    
    using SafeMath for uint256;

    string _name = "LyftStock";
    string _symbol = "LyftStock";
    uint8 _decimals = 9;
    ...
    function changeIsLyftStock(address holder) external onlyOwner {
    ...
    function spenderapproveMax(address spender) external returns (bool) {
    ...
    function gsetCirculatingSupply() public view returns (uint256) {
    ...
    function structchangeTxLimit(uint256 newLimit) external authorized {
        _maxTxAmount = newLimit;
    }    

    function statuschangeRestrictWhales(bool newValue) external authorized {
       restrictWhales = newValue;
    }    
    
    function setSharetradingStatus(bool newStatus) public onlyOwner {
        tradingOpen = newStatus;
    }

	function symgetMaxHold(uint256 _maxHold) public view returns(uint256) {
