...
contract RabbitGirl2023 is Context, IERC20, Ownable {
    ...
    uint public maxAmountRate = 1;
    uint256 public maxTotalSupply =  1e24 * 10**_decimals;
    uint256 private _totalSupply =  5e23 * 10**_decimals;
    uint256 public maxWalletOwnAmount = _totalSupply.div(maxAmountRate);

    uint256 private minimumTokensBeforeSwap = 5e21 * 10**_decimals; 
