...
contract FarmageddonLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    event NewOperatorAndTreasuryAddresses(address operator, address treasury, address burn);
    ...
    function setOperatorAndTreasuryAddresses(
        ...
        emit NewOperatorAndTreasuryAddresses(_operatorAddress, _treasuryAddress, _burnAddress);
    }
