...
abstract contract Contextbep20EgyptAI {
...
contract Ownablebep20EgyptAI is Contextbep20EgyptAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20EgyptAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20EgyptAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract EgyptAI  is Contextbep20EgyptAI, bep20EgyptAI, Ownablebep20EgyptAI {
    ...
    string private _name = unicode'🤖EgyptAI🤖';
    string private _symbol = 'EgyptAI';
