...
contract DigimonGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "DIGIMON GROW"; //
    string private constant _symbol = "$DG"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x492482324e9CF6BA190F1dB682A6d00f628D5f1a;
