...
contract SAITAMA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500 * 10**15 * 10**9;
    ...
    uint256 public _maxTxAmount = 500 * 10**15 * 10**9;
    uint256 private minimumTokensBeforeSwap = 5 * 10**14 * 10**9; 
    
    address payable public charityAddress = 0x5944eea6B3849DA41F3B509e27a47Be7D1b5b702; // Charity Address
