...
// File contracts/ElonAPE.sol

pragma solidity 0.6.12;

// ElonAPE
contract ElonAPE is ERC20("Elon APE", "ELONAPE") {
    ...
    constructor(address _treasuryAddr) public {
        ...
        _mint(treasuryAddr, 16e18);
        _totalMinted = _totalMinted.add(16e18);
        emit Mint(msg.sender, treasuryAddr, 16e18);
    }
