...
contract DAOHAKUNAMATATA is ERC20, ERC20Snapshot, Ownable {
    constructor() ERC20("DAOHAKUNAMATATA", "DAOHM") {
        _mint(msg.sender, 7777777 * 18 ** decimals());
    }
