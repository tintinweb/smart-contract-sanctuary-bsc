...
contract Ticket is Ownable, ERC721 {
     ...
     */
    function createPub(address _marketplace) external onlyOwner {
        // Create the new asset and allow marketplace to manage it
        // Use this to override the msg.sender here.
        this.approve(_marketplace, _create(address(this)));
    ...
    function _create(address _owner) internal returns (uint256 tokenId) {
        require(mintStep > 0, "presale not started");
        require(_totalSupply < 5000, "ticket sold out");
