...
contract SVB is Context, IERC20, Ownable {
    ...
    string private constant _name = "SVB";
    string private constant _symbol = "SVB";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xcB0B564eda977bcA43700eDd0D0a94C762c55472);
    address payable private _marketingAddress = payable(0xcB0B564eda977bcA43700eDd0D0a94C762c55472);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 80, "Redis cannot be more than 80.");
	    require(redisFeeOnSell < 80, "Redis cannot be more than 80.");
	    require(taxFeeOnBuy < 80, "Tax cannot be more than 80.");
	    require(taxFeeOnSell < 80, "Tax cannot be more than 80.");
