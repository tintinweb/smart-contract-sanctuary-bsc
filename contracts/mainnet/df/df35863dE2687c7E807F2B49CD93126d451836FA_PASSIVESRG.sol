...
contract Ownable is Context {
    ...
    constructor() {
        _owner = 0x82bfA19352C088daDd814678687402852a7611CA;
...
contract PASSIVESRG is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "PASSIVESRG";
    string private constant _symbol = "PSRG";
    ...
    //Tax wallets
    address public teamWallet = 0x82bfA19352C088daDd814678687402852a7611CA;
    address public treasuryWallet = 0x614e12245a0f3435046A46753f68696CecE2b1de;
