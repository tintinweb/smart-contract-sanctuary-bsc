...
Telegram :     https://t.me/BarbaraStreisandBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76DFE60f224A73269a3437630ccfa11F6Abd64c5;
...
contract BarbaraStreisandBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Barbara Streisand BSC"; // 
    string private constant _symbol = "$BSB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x76DFE60f224A73269a3437630ccfa11F6Abd64c5);
