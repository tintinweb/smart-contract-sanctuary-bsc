...
contract CO2 is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "CO2";       //Full name
    string public symbol_ = "CO2";      //abbreviation

    uint256 private deadFee = 0;       //Destroyed
    uint256 private liquidityFee = 0;      //LP reflow
    uint256 private marketingFee = 25;      //marketing
    uint256 private foundationFee = 0;      //Buyback pull order
    uint256 private lpRewardFee = 15;       //Add LP dividends
    ...
    address public marketingWalletAddress = 0xeC67547FFE5bc73496B5C95FdAaecB1A492e9A96;  //Marketing address
