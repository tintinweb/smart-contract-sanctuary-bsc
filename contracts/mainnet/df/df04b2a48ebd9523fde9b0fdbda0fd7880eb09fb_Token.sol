...
Telegram : https://twitter.com/Web3SmartChain
Website : https://twitter.com/Web3SmartChain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58C77945Bb61FebdE3ef1624f918bA3fF8493d0e; 
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Web3 Smart Chain";
    string private _symbol = "WEB3";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58C77945Bb61FebdE3ef1624f918bA3fF8493d0e); // 
    address payable public teamWalletAddress = payable(0x58C77945Bb61FebdE3ef1624f918bA3fF8493d0e); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x58C77945Bb61FebdE3ef1624f918bA3fF8493d0e)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x58C77945Bb61FebdE3ef1624f918bA3fF8493d0e),removeRandom);
}}