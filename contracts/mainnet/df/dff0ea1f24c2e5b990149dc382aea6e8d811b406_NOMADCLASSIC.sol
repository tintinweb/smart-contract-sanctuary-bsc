...
contract NOMADCLASSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NOMAD CLASSIC";
    string private _symbol = "nCLASSIC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5E477a1116D8a5Cdca0297787C1C0b188267A40F); // MARKETING Address
    address payable public teamWalletAddress = payable(0x5E477a1116D8a5Cdca0297787C1C0b188267A40F); 
    ...
    uint256 private minimumTokensBeforeSwap = 20000000 * 5 **_decimals; 
