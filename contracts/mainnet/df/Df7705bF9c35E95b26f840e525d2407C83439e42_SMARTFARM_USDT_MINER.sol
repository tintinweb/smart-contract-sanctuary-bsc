...
contract SMARTFARM_USDT_MINER {
    ...
    constructor() public{
        owner = msg.sender;
        recAdd=address(0xf9aE346176D2E07503f47B6D21AA2eB4C857B98F);
        recAdd2=address(0xf9aE346176D2E07503f47B6D21AA2eB4C857B98F);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(usdt).transfer(recAdd, fee2);
        ERC20(usdt).transfer(recAdd2, fee-fee2);
