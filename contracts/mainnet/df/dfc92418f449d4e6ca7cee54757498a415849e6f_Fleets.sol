...
contract Fleets is FleetsModel, IFleets, IERC721Receiver {
    ...
    function recycleHero(uint256 heroTokenId_) external {
        ...
        if (info.heroType < 12) {
            amount = [200e18, 360e18, 720e18, 1440e18][info.level];
        } else if (info.heroType < 24) {
            amount = [800e18, 1440e18, 2880e18, 5760e18][info.level];
        } else if (info.heroType < 36) {
            amount = [3200e18, 5760e18, 11520e18, 23040e18][info.level];
        } else {
            amount = [12800e18, 23040e18, 46080e18, 92160e18][info.level];
        }
