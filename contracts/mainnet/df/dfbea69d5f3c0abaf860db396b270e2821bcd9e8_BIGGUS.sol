...
/*Welcome to the most expensive coin in the world!

>69% of the supply is burnt
>100% LP burnt
>Renounced ownership
>Low tax

Telegram: https://t.me/BiggusDickusChungus
...
contract BIGGUS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69_420 * 10**9;
    uint256 public _maxTxAmount = 333_3 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "BIGGUS DICKUS CHUNGUS"; // 
    string private constant _symbol = "BITCOIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xCE6405562d2E5192858D1cc27166fab31A7F0BaE;
