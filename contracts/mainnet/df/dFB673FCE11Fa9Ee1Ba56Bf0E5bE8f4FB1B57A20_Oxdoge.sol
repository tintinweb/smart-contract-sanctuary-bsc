...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBcBF5e4C96c7eA6f57abc19866C7C5D20357E533; // owner address
...
contract Oxdoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1684a48B7Bd8F180F6e6b7Ae829237A95639Ea06); // Marketing Address
    address payable public teamWalletAddress = payable(0x1684a48B7Bd8F180F6e6b7Ae829237A95639Ea06); // Team Address
