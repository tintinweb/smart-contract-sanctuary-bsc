...
TELEGRAM: https://t.me/+qTZzjV_WNScwNjJl
*/
...
contract SQUIDAIBOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SQUID A.I BOT  ";
    string private _symbol = " SAI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38a046037Bea0ff65ea3ccbBaBc1b6619ea15088); 
    address payable public teamWalletAddress = payable(0x38a046037Bea0ff65ea3ccbBaBc1b6619ea15088); 
