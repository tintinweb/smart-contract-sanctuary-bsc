...
/* Token contract */
contract  BSHIBDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x70cA41Fcb2c2aE38612F6b516623c05ff96c1AE2;
    ...
    // Name and symbol
    string constant _name = "BABY SHIBA INU DAO";
    string constant _symbol = "BSHIBDAO";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 996553252663 * (10 ** _decimals); 
    ...
    uint256 private swapThreshold = _totalSupply * 30 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x70cA41Fcb2c2aE38612F6b516623c05ff96c1AE2;
