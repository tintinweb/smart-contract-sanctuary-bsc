...
contract ApeSachs is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ape Sachs"; // 
    string private constant _symbol = " $APESACHS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x968Aa66cdb71aEe3869D51494E2Da7Faab32a4F7;
