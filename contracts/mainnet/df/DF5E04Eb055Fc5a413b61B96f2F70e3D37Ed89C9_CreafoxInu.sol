...
Telegram : https://t.me/CreafoxInu
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDCdDC9e4cC494f1e8401B85f496261315Dde90ef;
...
contract CreafoxInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Creafox Inu"; // 
    string private constant _symbol = "CREA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xDCdDC9e4cC494f1e8401B85f496261315Dde90ef);
