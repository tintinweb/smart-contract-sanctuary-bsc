...
// Telegram: https://t.me/NewCommunityPortugal
...
contract portugal is IBEP20, Auth {
    ...
    string constant _name = "New Community Portugal";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x58348604F20b1B0a7Ff9D88449be7459dC039528;
        marketingFeeReceiver = 0x58348604F20b1B0a7Ff9D88449be7459dC039528;
