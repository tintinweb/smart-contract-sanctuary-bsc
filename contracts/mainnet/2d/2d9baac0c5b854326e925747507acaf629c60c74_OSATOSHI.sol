...
/*
💎0-SATOSHI (SATOSHI ORDER ) BEP-20💎

Satoshi orders are Satoshi REWARD TOKEN Total BNB Return of 10+% distributed to holders with each transaction. The more you HOLD, the more you EARN!
Satoshi orders are made on the Binance Network, Mining Coin Order satoshi you can check on our website:
https://app.ordersatoshi.com 
0-Satoshi gives you a great community🔥
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2111970899ecB1c2B946a3b4A59c6f1BA5E1b08b;
...
contract OSATOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "0-SATOSHI"; // 
    string private constant _symbol = "0-SATOSHI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x2111970899ecB1c2B946a3b4A59c6f1BA5E1b08b);
