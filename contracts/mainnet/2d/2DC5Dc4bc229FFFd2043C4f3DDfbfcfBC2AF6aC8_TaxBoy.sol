...
If you make the biggest buy (in tokens) you become the TaxBuy, and collect 5% fees (in BNB) the same way marketing does.
If you sell any tokens at all at any point you can never be the TaxBuy.
If someone beats your record, they become the TaxBuy.
If you sell while the TaxBuy, the marketing wallet becomes TaxBuy and the record is reset to 0, this way no one can buy a ton and then sell and keep collecting tax fees.
The TaxBuy is set via biggest buy in tokens.
...
The point is to reward big buys. There are no punishments other than disallowing sellers to be the TaxBuy.
*/
...
contract TaxBoy is Ownable, IERC20 {
    ...
    string private _name = "TaxBoy";
    string private _symbol = "TAX";

    uint public _biggestBuyFee = 5;
    uint public _marketingFee = 5;
    uint public _biggestBuySellFee = 5;
    uint public _marketingSellFee = 5;
    uint256 public _fee = _biggestBuyFee + _marketingFee;
    uint256 public _sellFee = _biggestBuySellFee + _marketingSellFee;

    uint256 public _decimals = 18;
    uint256 public _totalSupply = 10000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 10000 * 10 ** _decimals;
    uint256 public _maxWallet = 10 * 10 ** _decimals;
    uint256 public _record = 0;
    mapping (address => bool) public hasSold;

    address public _marketingAddress;
    address public taxBoy;
