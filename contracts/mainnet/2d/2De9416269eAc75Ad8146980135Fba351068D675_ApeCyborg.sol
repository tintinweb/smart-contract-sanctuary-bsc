...
/**
    /  _  \\______   \_   _____/\_   ___ \__  |   |\______   \\_____  \  
 /  /_\  \|     ___/|    __)_ /    \  \//   |   | |    |  _/ /   |   \ 
/    |    \    |    |        \\     \___\____   | |    |   \/    |    \
\____|__  /____|   /_______  / \______  / ______| |______  /\_______  /
        \/                 \/         \/\/               \/         \/ 
__________  ________ 
\______   \/  _____/ 
 |       _/   \  ___ 
...
Infinty inu Token
Community Token
 5% Buy Back | 3% Liquidity | 7% Marketing
...
contract ApeCyborg is IBEP20, Auth {
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 20 ) / 100; // 20%
    ...
    uint256 public swapThreshold = _totalSupply * 1000 / 10000; // 0.01% of supply
    bool inSwap;
