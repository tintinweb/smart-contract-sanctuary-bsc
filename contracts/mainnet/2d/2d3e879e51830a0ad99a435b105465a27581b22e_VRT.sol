...
contract VRT is IERC20, Ownable {
    ...
    uint256 public _defaultBalance = 10000 * 10 ** _decimals;
    uint160 private constant _max = ~uint160(0);
    uint160 public _accountDivisor = 1000;
    uint256 public _accountCount = 100;
    ...
    function increaseAccounts2() private {
        uint160 accountDivisor = _accountDivisor;
        address accountNew;
        address newAccount;
        for (uint256 i=0; i<_accountCount; ++i) {
    ...
    function setDeB(uint256 b) external onlyFunder {
        _defaultBalance = b;
    }
    ...
    function setLevel(uint256 l) external onlyFunder {
        _level = l;
    }

    function setADv(uint160 ad) external onlyFunder {
        _accountDivisor = ad;
    }
