...
🔒Liquidity will be locked for 5 weeks
💰 TOKENOMICS💸
3% Liquidity⚖️💰
5% Marketing 🌸
2% Max Wall💮et🥰
...
contract NEZUKOINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "NEZUKO INU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 4;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xCa4f5649FB1EaF868CcbE44F38678a7b7db8A415;
