...
contract AngryBird is Context, IERC20, Ownable {
    ...
    string private _symbol = "AngryBird";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x881C8120138a2D1A12F14296D3845bdd080720d6); 
    address payable public BurnedWalletAddress = payable(0x881C8120138a2D1A12F14296D3845bdd080720d6); 
    ...
    uint256 private minimumTokensBeforeSwap = 388000 * 10**_decimals; 
