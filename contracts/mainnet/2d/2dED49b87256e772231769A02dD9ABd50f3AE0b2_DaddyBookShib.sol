...
contract DaddyBookShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Daddy BookShib";
    string constant _symbol = "DADDYBOOKSHIB";
    ...
    uint256 public swapThreshold = _totalSupply * 70834766 / 10000000000; // 0.15% of supply
    bool inSwap;
