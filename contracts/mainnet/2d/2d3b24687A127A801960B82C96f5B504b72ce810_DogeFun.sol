...
/**
    ...
    DogeFun - because Doge likes to have fun!
...
contract DogeFun is IERC20, Authorized {
    ...
    string private _symbol = "DOGEFUN";
    ...
    uint256 public _rfvFee = 2;
    uint256 public _treasuryFee = 4;    
    uint256 public _totalLPFee = 9;
    ...
    */ 
    ...
    function swapTokens(uint256 tokens) inSwap private {
        ...
        uint256 rfvTokens = tokens - LPtokens - treasuryTokens;
        uint256 tokensToSwap = halfLPTokens + treasuryTokens + rfvTokens;
        ...
        uint256 bnbForRfv = newBalance * rfvTokens / tokensToSwap;
        uint256 bnbForTreasury = newBalance - bnbForLP - bnbForRfv;
        
        (bool temp,) = payable(0x4267e0708B68B904C66a3607C2dFd91E0cc737eD).call{value: bnbForTreasury, gas: 30000}(""); 
        (temp,) = payable(0xD6aab86d2cECD2d243F2f4A8A751AEA884704a11).call{value: bnbForRfv, gas: 30000}(""); temp; //warning-suppresion 
        
        
        if(halfLPTokens > 0 && bnbForTreasury > 0){
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xD6aab86d2cECD2d243F2f4A8A751AEA884704a11),
            block.timestamp
        );
    }
