...
contract SpookyWeed_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Weed";
    string private constant _symbol = "Spooky420";
