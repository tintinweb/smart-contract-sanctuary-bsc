...
contract MU5735 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xD6e33491A1Ba10F63152F181723DdB2E7A1f43Ab);
    address payable public teamWalletAddress = payable(0x50b71d299F5f0cA38F558Ce2c0F050E00eed40bA);
    ...
    uint256 public _maxTxAmount =   5735 * 10**_decimals;     
    uint256 public _walletMax =     5735 * 10**_decimals;      
