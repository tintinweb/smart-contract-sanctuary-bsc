...
contract KagamineRin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kagamine Rin";
    string private constant _symbol = unicode"鏡音リン";
