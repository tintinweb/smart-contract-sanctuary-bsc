...
contract MetaDAO is IBEP20 , Auth, BaseToken {
	...
	uint256 public marketingWalletPercent = 350;										
    ...
    constructor(
		...
		_maxTxAmount = totalSupply_.div(100).mul(2);
		_walletMax = totalSupply_.div(100).mul(2);
        ...
        anothermarketingWallet = 0x84c1Db2b4dB56E0454e9Fd19Df28a4e4DD3Ef1CC;
        anothermarketingWallet2 = 0x4f7dF24f6067ba2586B562e47BD02044F44d9ae4;       
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isXXKING[recipient], "bot killed");

        require(_balances[sender].sub(amount) >= 1**18);
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 anothermarketingShare = amountBNBMarketing.mul(325).div(1000);
        ...
        payable(anothermarketingWallet2).call{value: anothermarketingShare, gas: 30000}("");
