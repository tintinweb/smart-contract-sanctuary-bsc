...
contract DividendDistributor is IDividendDistributor {
    ...
    contract Moonbag is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Moonbag";
    string constant _symbol = "$Moonbag";
    ...
    uint256 rewardFeeBuy = 0;      //Reward might be turned on later
    uint256 marketingFeeBuy = 2;   //Marketing 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2699898A52288e3A6cc41dd60aa6f8c2425C084C; //Marketing wallet
        devFeeReceiver = 0x2699898A52288e3A6cc41dd60aa6f8c2425C084C; //Dev fee
