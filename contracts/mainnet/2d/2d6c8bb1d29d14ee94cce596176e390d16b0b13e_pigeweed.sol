...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xaA9e31dF469738B261371144a8ec5fe63Bf50420;
...
contract pigeweed is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"PigeWeed.com"; 
    string private constant _symbol = unicode"PigeWeed"; 
    ...
    uint256 public _maxWalletToken = 42 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xaA9e31dF469738B261371144a8ec5fe63Bf50420), BNB_Tot);
