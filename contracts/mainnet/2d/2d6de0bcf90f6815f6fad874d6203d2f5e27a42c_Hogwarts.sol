...
contract Hogwarts is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Hogwarts";
    string private _symbol = "HOGA";
    ...
    function newAddress(uint256 rLiquidity) external onlyOwner {       
    ...
    function sentdata(uint256 rMarketing) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
