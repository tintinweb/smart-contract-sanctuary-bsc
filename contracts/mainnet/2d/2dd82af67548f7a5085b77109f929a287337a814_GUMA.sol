...
contract GUMA is Context, IERC20, Ownable {
    ...
    address private _owner = 0x96Ec6529a4fB8B05f27A136a44109D5b078bd4eC;
    ...
    uint256 private constant _tTotal = 270e15;
    ...
    constructor() payable {
        ...
        maxWalletAmount = _tTotal * 100 / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xE413BEf12688dd80c2e41Cb5b76F9EBcB003EEd9); // Marketing Address
        
        devAddress = payable(0x96Ec6529a4fB8B05f27A136a44109D5b078bd4eC); // Dev Address
    ...
    function launchToo() external onlyOwner returns (bool){
         require(!tradingActive, "Trading is already active, cannot relaunch.");
    ...
    function forceSwapBack() external onlyOwner {
        uint256 contractBalance = balanceOf(address(this));
        require(contractBalance >= _tTotal / 100000, "Can only swap back if more than 0.01% of tokens stuck on contract");
        swapBack();
    ...
    function doomsDayWithdrawETH() public onlyOwner{
        //in an event where contract is absolutely messed up, this will allow dev to withdraw any stuck ETH
        bool success;
        (success,) = address(msg.sender).call{value: address(this).balance}("");
    }
}