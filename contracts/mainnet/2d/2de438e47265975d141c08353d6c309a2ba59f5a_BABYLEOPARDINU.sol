...
contract BABYLEOPARDINU is ERC20 {

    uint tokenTotalSupply = 1000000; // 100 Million Token Supply

    constructor() public ERC20("BABYLEOPARD INU", "BABYLEOPARDINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BABYLEOPARDINU";
    string private _symbol = "BABYLEOPARDINU";
