...
contract Inumaru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inumaru";
    string private _symbol = "$Inumaru";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf4718259083670082e0Cd97558F7F9755c5AcAD8); // Marketing Address
    address payable public teamWalletAddress = payable(0xf4718259083670082e0Cd97558F7F9755c5AcAD8); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2000000 * 5 **_decimals; 
