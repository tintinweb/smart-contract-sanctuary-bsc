...
contract MommyDogeGrow  is Context, IERC20, Ownable {
    ...
    string private constant _name = "MommyDogeGrow"; // 
    string private constant _symbol = "MDGrow"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x187422ed328750b7ba14f2C5C282915d93470ABE;
