...
contract YZT is ERC20, Ownable {
    ...
    constructor() ERC20("YZT TEST Token", "YZTT", 18) {
    ...
    function _transfer(
        ...
        if(!amountWhiteList[recipient]){
            require(balanceOf(recipient).add(amount) <= 100000*10**18, "balance of recipient exceed limit");
        }
