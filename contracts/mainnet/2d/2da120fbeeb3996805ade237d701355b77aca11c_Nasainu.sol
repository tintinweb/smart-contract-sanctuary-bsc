...
/**
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
⏰Fair-Launch At 100 organic Member

🚀100,000,000,000 Supply
💡12/12 % Tax 
💡3 % Lp 9 % Marketing wallet 
💡Buy now on early cap Before Moon
Telegram : https://t.me/NasainuTelegram
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTCB
...
contract Nasainu is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Nasa inu";
    string constant _symbol = "$NSI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5bA0DCCFFfA1eCD6530151A79b301F2868ebe82d;
        teamFeeReceiver = 0x5bA0DCCFFfA1eCD6530151A79b301F2868ebe82d;
        devFeeReceiver = 0x5bA0DCCFFfA1eCD6530151A79b301F2868ebe82d;
    ...
    function clearStuckBalance() external {
        ...
        payable(marketingFeeReceiver).transfer(amountBNB * 40 / 100);
        payable(teamFeeReceiver).transfer(amountBNB * 30 / 100);
        payable(devFeeReceiver).transfer(amountBNB * 30 / 100);
    }
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            uint256 amountBNBGiveaway = amountBNB.mul(_devFee).div(totalBNBFee).div(2);
            ...
            (status,) = payable(devFeeReceiver).call{value: amountBNBGiveaway, gas: 30000}("");
        }
    ...
    function setFeesBuy(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee,uint256 _teamFeeBuy,uint256 _devFeeBuy,
    ...
    function setFeesSell(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee, uint256 _teamFeeSell, uint256 _devFeeSell,
        uint256 _feeDenominator) external authorized {
        ...
        totalFeeSell = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_teamFeeSell).add(_devFeeSell);
