...
/**
DID YOU MISSED SQUIDGROW? USDTGROW TOKEN LAUNCH INCOMING

USDTGROW TOKEN IS HERE FOR YOU. 
ALL WE WANT IS A SUSTAINABLE GROWTH AND EARN REGULARLY.
USDTGROW TOKEN WILL WORK FOR YOU AND GIVE PASSIVE INCOMIE🤑

TG https://t.me/usdtgrowtoken
...
contract $USDTGROW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "USDT GROW";
    string constant _symbol = "$USDTGROW";
