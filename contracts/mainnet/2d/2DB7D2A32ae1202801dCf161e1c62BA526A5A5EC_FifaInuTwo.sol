...
contract FifaInuTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fifa Inu Two";
    string private constant _symbol = "FIFAINU2.0";
