...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //BABY ETHER
...
contract BETHER  is ERC20, Ownable {
    ...
    address private constant ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //BABY ETHER

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0xAbf97c420Edd3987b7105552879BC49166e53874)); //marketing wallet
    ...
    constructor() ERC20("Baby Ether", "BETHER") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("BETHER_Dividend_Tracker", "BETHER_Dividend_Tracker")
    {
        claimWait = 3600;
