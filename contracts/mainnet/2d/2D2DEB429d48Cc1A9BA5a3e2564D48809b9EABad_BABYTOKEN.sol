...
contract BABYTOKEN is ERC20, Ownable {
    ...
    uint256 public sellTokenRewardsFee = 15;
    uint256 public transferRewardsFee = 20;
    ...
    // LP
    uint256 public buyTokenLpFee = 30;
    uint256 public sellTokenLpFee = 40;
    

    address public _marketingWalletAddress = 0xd20165253077f88a53b2120a206aD16232BaFbc3;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address private pairAddress = 0xd5b121F7723B9e63c60809388FfA284E2d893d40;
    ...
    function setSelTaxes(uint256 lpFee, uint256 rewardsFee, uint256 marketingFee) external onlyOwner {
        sellTokenLpFee = lpFee;
        sellTokenRewardsFee = rewardsFee;
        sellMarketingFee = marketingFee;
    }

    function setTransferTaxes(uint256 rewardsFee, uint256 marketingFee) external onlyOwner {
        transferRewardsFee = rewardsFee;
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(RFee > 0){
                ...
                dividendTracker.distributeCAKEDividends(RFee);
                emit SendDividends(RFee, RFee);
        ...
        // LP Process
        if(!swapping) {
            if(IERC20(address(this)).balanceOf(address(this)) >= minEthVal && LPFeefenhongTime.add(minPeriod) <= block.timestamp) {
    ...
    function process(uint256 gas) private {
        uint256 tokens = IERC20(address(this)).balanceOf(address(this));
