...
// Telegram : https://t.me/HaalandFanToken
...
contract HAALAND is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 22000000 * 1e9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Haaland Fan Token"; // token name
    string public _symbol = "HAALAND"; // token ticker
    ...
    uint256 private minTokenToSwap = 22000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 22000000 * 1e9;
    uint256 private minBuyLimit = 22000000 * 1e9;
