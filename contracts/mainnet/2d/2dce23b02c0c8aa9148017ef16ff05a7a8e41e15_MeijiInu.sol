...
/**
 *Main Tg: https://t.me/+syZqUsnGMjwzYjE5 (Meiji Inu) [Number 1 Choc bar in Japan) {join if u want eca will be posted 30 seconds prior} (tg will be changed to @Meiji_Inu)
...
contract MeijiInu is IBEP20, Auth {
    ...
    string constant _name = "Meiji Inu";
    string constant _symbol = "IJI";
