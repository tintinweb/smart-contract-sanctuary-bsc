...
contract spidergrowEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spider GROW"; // 
    string private constant _symbol = "Spider GROW"; //    
