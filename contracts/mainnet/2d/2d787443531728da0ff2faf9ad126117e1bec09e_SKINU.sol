...
contract SKINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Skeleton Inu";
    string private _symbol = "SKINU";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xceeFa15147F553335E8EbE4e3765B852EE7E2563); // Marketing Address
    address payable private TeamWallet = payable(0xCDdb25834f9cfDB405d05d480feBE463263903cc); // Buy Back Address
