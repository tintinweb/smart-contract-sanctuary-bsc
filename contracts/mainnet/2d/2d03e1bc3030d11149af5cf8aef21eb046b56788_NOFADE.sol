...
contract NOFADE is NOFADEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NOFADETeam;
    address private CharityNOFADE;
    ...
    string public override name = "FadeMeNot";
    string public override symbol = "NOFADE";
    ...
    constructor(uint totalSupplyValue, address NOFADETeamAddress, address CharityNOFADEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NOFADETeam = NOFADETeamAddress;
        CharityNOFADE = CharityNOFADEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NOFADETeam] =  totalSupply * 5 / 100;
        balances[CharityNOFADE] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's NOFADETeam pot
