...
/**
 *  
MechBoi Finance aims to be the first and market leader in the development of DeFi Grid Trading Bots, along with a Defi Rebalancing bot for both native and wrapped tokens.
 * 
 */
...
contract MechBoiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Mech Boi Inu";
    string private _symbol = "Mech Boi";
