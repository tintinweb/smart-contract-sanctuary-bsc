...
contract SpookyTamaDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpookyTamaDoge";
    string constant _symbol = "$SPKTD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x62a6D07b0060896F69aaa7e3b9f3399791456531;
        teamFeeReceiver = 0x8DBBc9A4F22578287fF89313Ea862cf0969B2551;
        buybackFeeReceiver = 0xE8F0e6a548a3f9Bd9e36e3D25C38Bd9c3c2B8477;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _buybackFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
