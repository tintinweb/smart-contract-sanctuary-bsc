...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Reflection = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BUSD
...
contract RowletCoin is IBEP20, Auth {
    using SafeMath for uint256;
    address Reflection = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;  
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address balanceAddresss = 0x2829F3e6Cde7E127ad0A11dEb92377E157cd8305;
    string constant _name = "Rowlet Coin";
    string constant _symbol = "ROWLET";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = balanceAddresss;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit autoBurnLiquidity(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event autoBurnLiquidity(uint256 amountBNB, uint256 amountBOG);
}