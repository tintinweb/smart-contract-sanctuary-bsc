...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A3dF9575D689f5cE075F97E19FEB319FeF165e8; // owner address
...
contract Catlenny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Lenny";
    string private _symbol = "CL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x58E387e06D9706e9f86820a0115fe3A04166037E); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A3dF9575D689f5cE075F97E19FEB319FeF165e8); // Team Address
