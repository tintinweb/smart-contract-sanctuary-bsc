...
/*
   ...
   _____    _______ _________ _______  _        _______  _______  _______  _______  _______          
  / ___ \  (  ____ \\__   __/(  ___  )( (    /|(  ____ \(  ____ )(  ____ \(  ____ )(  ___  )|\     /|
 / / _ \ \ | (    \/   ) (   | (   ) ||  \  ( || (    \/| (    )|| (    \/| (    )|| (   ) || )   ( |
( ( / \ ) )| (_____    | |   | |   | ||   \ | || (__    | (____)|| |      | (____)|| |   | || | _ | |
| |(()// / (_____  )   | |   | |   | || (\ \) ||  __)   |     __)| | ____ |     __)| |   | || |( )| |
( ( \___/        ) |   | |   | |   | || | \   || (      | (\ (   | | \_  )| (\ (   | |   | || || || |
 \ \____/\ /\____) |   | |   | (___) || )  \  || (____/\| ) \ \__| (___) || ) \ \__| (___) || () () |
  \______/ \_______)   )_(   (_______)|/    )_)(_______/|/   \__/(_______)|/   \__/(_______)(_______)
...
contract SGROW is Ownable, SecureLaunch {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 5_000_000_000 * (10 ** _decimals);
    uint256 _launchWalletMax = 150_000_000 * (10 ** _decimals);
    uint256 _launchmaxTxAmount = 75_000_000 * (10 ** _decimals);
    ...
    string constant _name = "StonerGrow";
    string constant _symbol = "StonerGrow";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x10c90da3947Bd138fA89Ac05698Bb5A860926A8A;
        FeeReceiver = 0x10c90da3947Bd138fA89Ac05698Bb5A860926A8A; 

        totalFee = liquidityFee.add(BuybackFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(FeeReceiver).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newBuybackFee) external onlyOwner {
    ...
    function removeBL(address add) public onlyOwner { 
		mark(add, false);
	}
}