...
Just a bunch of CHADS riding in their $CHADILLAC

Telegram t.me/ChadillacBSC
...
contract Chadillac is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xa88812fd1D7308Fc76D0566385D9af4B131fcA49;

    string constant _name = "Chadillac";
    string constant _symbol = "Chadillac";
    ...
    uint256 public swapThreshold = _totalSupply * 95 / 10000;
    bool inSwap;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/3, "Fees cannot be more than 100%");
    }
