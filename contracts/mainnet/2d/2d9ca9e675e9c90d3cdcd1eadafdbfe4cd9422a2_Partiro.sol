...
contract Partiro is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x2812a5def99e73d51c7D575891905F501866bA8A);
        
    address payable public teamAddress =
        payable(0x2812a5def99e73d51c7D575891905F501866bA8A);
        
    address payable public liquidityAddress =
        payable(0x49bA0f62efF422438AdEEc191e2CD96BC58cf489);
    ...
    uint256 private constant _tTotal = 420 * 1e6 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "Partiro";
    string private constant _symbol = "PartiroElon";
