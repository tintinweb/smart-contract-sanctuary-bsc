...
contract ZJFC is IBEP20, Auth {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**35 * 10**_decimals;
    uint256 public swapThreshold = 10**31;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(address(0x8599F76fDe713cC510C2bdAAB2417327226264ce));
        devFeeReceiver = payable(address(0x8599F76fDe713cC510C2bdAAB2417327226264ce));
