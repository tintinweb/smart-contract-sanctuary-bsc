...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBcE41798010368700839a078dE1658bd8bAeBD4F; // owner address
...
contract NORIINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBcE41798010368700839a078dE1658bd8bAeBD4F);
    address payable public teamWalletAddress = payable(0xBcE41798010368700839a078dE1658bd8bAeBD4F); 
