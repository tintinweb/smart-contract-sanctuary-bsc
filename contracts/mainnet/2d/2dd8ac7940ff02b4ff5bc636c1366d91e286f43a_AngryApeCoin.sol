...
contract AngryApeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AngryApeCoin";
    string private _symbol = "AngryApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2FE9a028CAF62B6770fa3B354BeACf1D221BF307); 
    address payable public buyBackWalletAddress = payable(0x2FE9a028CAF62B6770fa3B354BeACf1D221BF307); 
