...
contract CuJu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CuJu";
    string private _symbol = "CuJu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF90606725Eb0B32daB68539455B784C321DF6E70);
    address payable public teamWalletAddress = payable(0xF90606725Eb0B32daB68539455B784C321DF6E70);
