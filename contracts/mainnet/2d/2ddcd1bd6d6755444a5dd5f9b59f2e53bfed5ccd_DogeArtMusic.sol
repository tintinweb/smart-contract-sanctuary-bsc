...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAB4732925908bb809ef804d1901ee4f346fe4d39;
...
contract DogeArtMusic is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAB4732925908bb809ef804d1901ee4f346fe4d39;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**7;
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 100000000000 * 10**7;
