...
contract KurimoonCat is Context, IERC20, Ownable {
    ...
    string private _symbol = "KurimoonCat";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb5057293B7C45a0579DFe879Ca8FF2f4a2E53745);
    address payable public liqWalletAddress = payable(0xb5057293B7C45a0579DFe879Ca8FF2f4a2E53745);
