...
contract  muskman is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuskMan";
    string private _symbol = "MM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5109f43Bc20B68a6c32805C7B021590845dcd35B);
    address payable public teamWalletAddress = payable(0x7Eed098E83b2AE2B38A4417Ce1705C502fFe6d80); 
