        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7903960DAC72Be4dC46f558Ee5f1851adcd20C20), block.timestamp
                );
            }
        }
    }
...
contract OSKZILLA is AbsToken {
    constructor() AbsToken(
        ...
        address(0x0FC831dF4569e4FEf4D8ec197BFF68e11D00366A)//ReceiveAddress
    ){
    }
}