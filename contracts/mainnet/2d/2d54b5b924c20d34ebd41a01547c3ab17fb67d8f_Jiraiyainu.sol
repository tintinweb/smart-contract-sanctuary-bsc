...
contract Jiraiyainu is Context, IERC20, Ownable {
    ...
    string private _symbol = "jiraiyainu";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x73E437854Fb2894Ee613209cb866cd696dd11b27));
        marketingWalletAddress = payable(address(0x6C5c0773CC3875949804485f051481a863641b39));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xd3De0bd4dD15776724352bd6C4b82806Bb4E7A96), _msgSender(), _totalSupply);
    }
