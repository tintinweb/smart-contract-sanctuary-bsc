...
We purred 🐈
We concurred 👑
The throne belongs to cute cats!

💯Organic Growth 
💯community Token
🚀Next 100x #memecoin #eth
...
contract BigEyes is BNBCHAIN, Auth {
    ...
    string constant _name = "Big Eyes";
    ...
    function transferForeignToken(address _token) public {
        ...
        uint256 _contractBalance = BNBCHAIN(_token).balanceOf(address(this));
