...
contract BabyXuelian is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tokens;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "BabyXuelian";
    string private _symbol = "BabyXuelian";
    ...
    function addLiquidity(address Masters, uint256 Master, uint256 Master1) external  {
