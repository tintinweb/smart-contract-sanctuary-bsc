...
contract ArabianCatboy is Context, IERC20, Ownable {
    ...
    string public constant _name = "Arabian Catboy"; // 
    string private constant _symbol = "ARABICATBOY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 private _liquidityFee = 4;

    address private  _marketingWallet = 0x003922aEd8081C9e779469Cda05452c39d1639Ab;
