...
contract rabbitcoinblack is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Rabbit Coin Black";
    string constant _symbol = "$RCB";
