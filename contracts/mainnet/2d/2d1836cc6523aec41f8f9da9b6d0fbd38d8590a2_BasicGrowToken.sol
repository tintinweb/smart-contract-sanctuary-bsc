...
/*
    ...
    BASIC GROW
    https://t.me/basicgrow

    The Next Gen Token, is a Community-focused Decentralized Cryptocurrency
    Basic Grow is very giving and is designed to reward long term holders.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbB4dD44ccf75c76cab15b3559CCc823C7F8EE6EC; // owner address
...
contract BasicGrowToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Basic Grow";
    string private _symbol = "$BG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB4dD44ccf75c76cab15b3559CCc823C7F8EE6EC); // Marketing Address
    address payable public teamWalletAddress = payable(0xbB4dD44ccf75c76cab15b3559CCc823C7F8EE6EC); // Team Address
