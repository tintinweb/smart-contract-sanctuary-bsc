...
/**
 *Submitted for verification at BscScan.com on 2022-14-09
*/
...
/* Token contract */
contract KwonGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Kwon Grow";
    string constant _symbol = "KWNGRW";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% or 100M tokens on launch
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 100M tokens on launch
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% or 100M tokens on launch
