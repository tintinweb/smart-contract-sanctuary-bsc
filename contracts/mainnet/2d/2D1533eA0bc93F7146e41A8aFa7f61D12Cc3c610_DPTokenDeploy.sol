...
contract DPToken is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    uint256 public marketFeePercent = (9 * BASE_RATIO) / 100;
    uint256 public devFeePercent = (0 * BASE_RATIO) / 100;
    uint256 public deadFeePercent = (0 * BASE_RATIO) / 100;
    uint256 public liquidityFeePercent = (0 * BASE_RATIO) / 100;
    uint256 public nftPoolFeePercent = (0 * BASE_RATIO) / 100; 
    ...
    function _transfer(
        ...
        if ( !whitelist[from] && !whitelist[to]) {
            ...
            require(from != liquidity,"only whitelist can buy");
...
contract DPTokenDeploy is DPToken{
    constructor() DPToken(
        "DPToken",
        "DP",
        18,
        address(0x2F9aa680d1d90443B2dDe5545a4497127F1F63CC), 
        address(0x1bA05c9836E5DD94fc279FE316F15A37128b4e90), 
        address(0x4FF04c511031B49F76299C599BecB7927209e1A9), 
        address(0x4FF04c511031B49F76299C599BecB7927209e1A9), 
        address(0x4FF04c511031B49F76299C599BecB7927209e1A9), 
        address(0x55d398326f99059fF775485246999027B3197955), 
        IFactory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73), 
        IRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E)) 
        ){}
}