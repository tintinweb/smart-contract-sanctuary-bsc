...
FUCK PREPUMPS. ITS TIME TO MAKE COMMUNITY TOKENS GREAT AGAIN
0% TAX TOKEN
I SUGGEST U GUYS TO MAKE A TG CALLED @FUCKPREPUMPBSC
LETS SHOW THOSE GREEDY CALLERS WHO WE ARE 

2% MAX TX AND MAX WALLET 
...
contract FUCKPREPUMP is IBEP20, Auth {
    ...
    string constant _name = "Im so sick of the insider games. And the constant scamming by callers. Having early CA and your a caller is indicative of prepump friends and family. They shared the CA in private chats. They knew it and lined the pockets of callers and friends in insidor private chats. The sickest part is they have all of these followers in their call channels and they are literally trying to steal from them. Thats it. No other excuse for this";
    string constant _symbol = "FUCKPREPUMPS";
    ...
    address private marketingFeeReceiver =0xA74d18463258bAcbEB6fAcbf9B44C03F51daeAFb;
    address private teamFeeReceiver =0xA74d18463258bAcbEB6fAcbf9B44C03F51daeAFb;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xA74d18463258bAcbEB6fAcbf9B44C03F51daeAFb;
