...
//   📱Website ::https://squidgame2.0.tech/
/*
...
contract SquidGame20 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SquidGame 2.0", "SquidGame2.0") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SquidGame2.0";
    string private _symbol = "SquidGame2.0";
