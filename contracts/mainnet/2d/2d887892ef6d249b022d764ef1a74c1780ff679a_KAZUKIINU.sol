...
contract KAZUKIINU is Context, IERC20, Ownable {
    ...
    string private _name = "Kazukiinu";
    string private _symbol = "KAZINU";
    ...
    uint256 private _totalSupply = 9633609591 * 10**_decimals;
    uint256 public _maxTxAmount = 481680479 * 10**_decimals; 
    uint256 public _walletMax = 192672191 * 10**_decimals;
