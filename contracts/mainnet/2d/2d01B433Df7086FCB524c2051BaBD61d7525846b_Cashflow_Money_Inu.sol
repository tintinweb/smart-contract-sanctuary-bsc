...
// intializing the addresses
    ...
    constructor(
        ...
        liquedityReceiver = 0x3Ff3A0A15496e71aeb0A6c7377a41C14d5B446DD;
        marketFeeReceiver = address(0x48b9b9Ff4b7103b81b24212E2c5139FD66258304);
        devFeeReceiver = address(0x3Ff3A0A15496e71aeb0A6c7377a41C14d5B446DD);
    ...
    function _transfer(
        ...
        if (!isLimitExempt[recipient]) {
            require(balanceOf(recipient)+amountReceived <= maxHoldAmount, "Max Hold Limit exceeds");
        }
