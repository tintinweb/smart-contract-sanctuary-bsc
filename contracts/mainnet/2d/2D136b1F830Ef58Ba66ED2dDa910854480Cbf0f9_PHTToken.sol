...
contract PHTToken is ERC20, SafeOwnable {
   ...
   */
    ...
    address public initIdo = 0xf7F06885ddDDD800422d69eBa728958BbE0b2cEF;
    address public initEco = 0xC7D3A19C2535B25fa2cFeEf97225FAd79d408Fae;
    constructor(
        string memory _name,
        ...
        setRewardBlacklist(initEco, true);
        setRewardBlacklist(initIdo, true);
        ...
        uint256 total = 10000000 * BASE_RATIO;
        _totalSupply = _totalSupply.add(total);
        
        uint256 amount10 = total.mul(10).div(100);
        _balances[initIdo] = _balances[initIdo].add(amount10);
        emit Transfer(address(0), initIdo, amount10);
        _balances[initEco] = _balances[initEco].add(total.sub(amount10));
        emit Transfer(address(0), initEco, total.sub(amount10));
