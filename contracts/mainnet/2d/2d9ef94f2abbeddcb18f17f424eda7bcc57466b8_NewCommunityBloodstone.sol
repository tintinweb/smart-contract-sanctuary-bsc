...
//https://t.me/NewCommunityBloodstoneBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x10cb66ce2969d8c8193707A9dCD559D2243B8b37);
...
contract NewCommunityBloodstone is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "New Community Bloodstone";
    string constant _symbol = "$NCB";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x10cb66ce2969d8c8193707A9dCD559D2243B8b37;
    ...
    uint256 public swapThreshold = 5 * 10**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0x1c881BaFd2804677FDdDA23e4827Eb79426eeEaD;
        marketingWallet = 0x1c881BaFd2804677FDdDA23e4827Eb79426eeEaD;
        devWallet = 0x1c881BaFd2804677FDdDA23e4827Eb79426eeEaD;
