...
contract Hackstar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "HackStar";

    string private _symbol = "Hackstar";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xa165eF89f60eB46CbE247d65e9d4DA43D52b55Bc;
