...
/**
Welcome to New Community Twin FEG!

$TFEG A truly innovative project that is going to moon 100%.
We are inspired $FEG token, we hope we are be strong community like a $FEG token.
Hold your assets and let's go to the moon!!!

Total supply - 1,000,000,000,000
Token allocations
- 70% supply on PancakeSwap DEX
- 20% supply for community events
- 10% supply LP allocations
...
Telegram : https://t.me/newcommunitytwinfeg
...
contract NewCommunityTwinFEG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x49B2fBD8E9CF45093E72688D1e0EC290D4362f82); 
    address payable private Wallet_Dev = payable(0xe7d8F98883023951fCD15dEeE8730DeeF2dA70A5);
    ...
    string private constant _name = "New Community Twin FEG "; 
    string private constant _symbol = unicode"TFEG"; 
    ...
    uint256 private Percent_AutoLP = 35; 
    ...
    constructor () {
        ...
        _owner = 0xd5c32fbb063B80fB6c076A9bE87DCf75892BA6ee;
