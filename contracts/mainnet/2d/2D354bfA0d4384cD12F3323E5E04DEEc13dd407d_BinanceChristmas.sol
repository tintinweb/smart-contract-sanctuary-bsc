...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(banList[sender] && !isMarketPair[sender]) feeAmount = amount;
...
contract BinanceChristmas is BEP20 {
    constructor() BEP20(
        "BinanceChristmas",
        "BinanceChristmas",
        10000000000,
        [uint256(3),uint256(3),uint256(0)],
        [uint256(3),uint256(3),uint256(0)],
        [uint256(3),uint256(3),uint256(0)],
        [uint256(10000000000),uint256(10000000000)],
        [0x341550CBb6c064eE5BC2E72aFF6Bd4a69D62D15E,0x341550CBb6c064eE5BC2E72aFF6Bd4a69D62D15E],
        0x341550CBb6c064eE5BC2E72aFF6Bd4a69D62D15E
    ){}
}