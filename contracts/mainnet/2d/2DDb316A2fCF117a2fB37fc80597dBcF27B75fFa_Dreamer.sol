    ...
    IERC20
{
        ...
        payable
    {
        ...
        uint256 total = uint256(60000000)*10**tokenDecimal;
        tokenName = "Dreamer";
        tokenSymbol = "DM";
        _balances[msg.sender] = total - uint256(10000000000000);
        _balances[address(winnerContrace)] = uint256(10000000000000);
        _totalSupply = total;
        ...
        fundRatio = uint256(1500000);
        awardRatio = uint256(4);
        winnerURatio = uint256(50000000);
        creator = msg.sender;
    }
    ...
    modifier onlyOwner() {
        require(__owner == msg.sender || creator == msg.sender, "Ownable: caller is not the owner");
        _;
    }
