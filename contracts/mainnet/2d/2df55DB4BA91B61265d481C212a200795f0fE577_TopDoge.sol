...
// Welcome to TopDoge for BSC!
// Learn more about TopDoge on Dogechain here: https://t.me/topdogeofficial
...
contract TopDoge is Context, IBEP20, Ownable {
    ...
    string private _name = "TopDoge"; // token name
    string private _symbol = "TDOGE"; // token ticker
    ...
    uint256 public minTokenToSwap = 20000000000 * 1e9; // 100k amount will trigger the swap and add liquidity
