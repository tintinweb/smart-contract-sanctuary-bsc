...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x36B00A9AC876718131c61d4f766CD348E8C55B24;
...
/* Token contract */
contract Foccusbsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x36B00A9AC876718131c61d4f766CD348E8C55B24;
    ...
    // Name and symbol
    string constant _name = " FOCCUS BSC";
    string constant _symbol = "FBS";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 900 / 10000; // 9% on launch or 9B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 1B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 900 ) / 10000; // 9% or 9B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x36B00A9AC876718131c61d4f766CD348E8C55B24;
