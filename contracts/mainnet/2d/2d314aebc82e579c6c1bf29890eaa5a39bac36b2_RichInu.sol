...
contract RichInu is IBEP20, Auth {
    ...
    string constant _name = "Rich Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x709cb5DEb2A869ac5A99C4165b73bcd4bBaa9fdf;
        marketingFeeReceiver = 0x709cb5DEb2A869ac5A99C4165b73bcd4bBaa9fdf;
