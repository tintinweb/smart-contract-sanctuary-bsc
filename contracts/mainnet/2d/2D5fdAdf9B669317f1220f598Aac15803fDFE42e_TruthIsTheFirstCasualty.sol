...
/**
Telegram; https://t.me/TruthIsTheFirstCasualty
*/
...
contract TruthIsTheFirstCasualty is IBEP20, Auth {
    ...
    string constant _name = "Truth is the first casualty.";
    string constant _symbol = "Truth is the first casualty.";
