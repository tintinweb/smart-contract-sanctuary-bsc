...
abstract contract AbsToken is IERC20, Ownable {
    ...
    //转账不需要手续费，买卖的时候，都将币放到合约中，等合约中的币达到一定的数量，统一进行处理分配
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        // address secFundAddress = 0x634b82124C89A6813C0628Ed8003F1c7BE2d5b80;
...
contract TL is AbsToken {
    constructor() AbsToken(
        ...
        address(0x76546b6b8f6C94df647CcBe64e04B6d259bEC5EB),
    
        address(0x71a95c7a59E29661e270F00778dDA6a2E9A86835)
    ){
