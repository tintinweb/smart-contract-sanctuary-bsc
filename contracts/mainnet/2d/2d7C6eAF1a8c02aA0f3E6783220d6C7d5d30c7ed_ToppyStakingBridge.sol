...
contract ToppyStakingBridge is Ownable, ReentrancyGuard, ERC20 {
    
    using SafeERC20 for IERC20;

    IERC20 public rewardsToken = IERC20(address(0xd88ca08d8eec1E9E09562213Ae83A7853ebB5d28));
    xWinDefi public _xwinDefi = xWinDefi(address(0x1Bf7fe7568211ecfF68B6bC7CCAd31eCd8fe8092));
    address public adminExecutor;  
    address public polygonReceiver = address(0x171a9377C5013bb06Bca8CfE22B9C007f2C319F1);      
    uint public xwinpid;
    ...
    function farmTokenByAdmin() public onlyOwner {
        IERC20(address(this)).safeApprove(address(_xwinDefi), totalSupply());
    ...
    {
        adminExecutor = _adminExecutor;
        polygonReceiver = _polygonReceiver;
    }

    function updateSmartContract(uint _xwinpid, address _xwinDefiaddr) public onlyOwner {
    ...
    // executor call to transfer the tokens to the polygon pool
    function transferToBridge() public onlyAdminExecutor {

        _xwinDefi.DepositFarm(xwinpid, 0);
        rewardsToken.safeTransfer(polygonReceiver, rewardsToken.balanceOf(address(this)));
    }

    function getPendingRewards() public view returns (uint) {
         return _xwinDefi.pendingXwin(xwinpid, address(this));
    }
