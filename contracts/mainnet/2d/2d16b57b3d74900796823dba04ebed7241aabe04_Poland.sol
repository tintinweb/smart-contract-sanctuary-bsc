...
contract Poland is ERC20 {
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) public blackList;
    address public tokenOwner =
        address(0x4A882eE0cbAca14736f61333E174565079F32E76);
    address public fundAddr =
        address(0x7304d79Ff587CE568ab8f0085d29E1C9e7328cFa);

    uint256 public marketPercent = 1000;

    constructor() ERC20("Poland", "Poland") {
