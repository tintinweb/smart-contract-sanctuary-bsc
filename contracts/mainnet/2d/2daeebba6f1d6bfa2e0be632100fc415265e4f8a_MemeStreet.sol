...
contract MemeStreet is IBEP20, Ownable
{
    ...
    string private constant _symbol = '$MemeST';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000 * 10**_decimals;//total
    ...
    //DevWallets
    address public MarketingWallet=payable(0x62F788e94B02317a9D40e9647bA3B1BdF3FDC5Bb);
    address public Development=payable(0x62F788e94B02317a9D40e9647bA3B1BdF3FDC5Bb);
    //TestNet
	...
	uint256 private MaxBuy = 200000 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 25000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*50) / 100);
