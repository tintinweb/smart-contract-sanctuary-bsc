...
contract FLONIK is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42520 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FLONIK";
    string private _symbol = "FLONIK";
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**6 * 10**8;
