...
contract WolyFinance is TokenBEP20 {
  ...
  function ClaimWLF(address _refer) payable public returns (bool success){
    ...
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
      ...
      emit Transfer(address(this), _refer, AWLFamt / 1);
    }
  ...
  function BuyWLF(address _refer) public payable returns (bool success){
  ...
  function WLFAirdrop() public view returns(uint256 StartBlock, uint256 EndBlock, uint256 DropCap, uint256 DropCount, uint256 DropAmount){
    return(ASWolyFi, AEWolyFi, ACap, ATotal, AWLFamt);
  }
  function WLFSale() public view returns(uint256 StartBlock, uint256 EndBlock, uint256 SaleCap, uint256 SaleCount, uint256 ChunkSize, uint256 SalePrice){
  ...
  function WithdrawWLF() public onlyOwner() {
