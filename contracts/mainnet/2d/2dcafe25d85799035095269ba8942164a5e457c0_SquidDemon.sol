...
contract SquidDemon is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SquidDemon", "SquidDemon") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SquidDemon";
    string private _symbol = "SquidDemon";
