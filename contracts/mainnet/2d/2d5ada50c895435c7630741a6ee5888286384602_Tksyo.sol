...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbDa8C8A9976E104a861D37F61af98AC71519eAdb;
        // owner address
...
contract Tksyo is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TionKingsYo";
    string private _symbol = "Tksyo";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbDa8C8A9976E104a861D37F61af98AC71519eAdb); // Marketing Address
    address payable public teamWalletAddress = payable(0xbDa8C8A9976E104a861D37F61af98AC71519eAdb); // Team Address
    ...
    function setDLTksyo(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDETksyo(uint256 fe) external onlyOwner {
