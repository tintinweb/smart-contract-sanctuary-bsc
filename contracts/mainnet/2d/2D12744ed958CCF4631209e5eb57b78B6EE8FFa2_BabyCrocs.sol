...
contract BabyCrocs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Crocs";
    string private _symbol = "Baby Crocs";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E1EDD1B6Ce3253b67312c402f8bc5086cFa6EEA);
    address payable public teamWalletAddress = payable(0x6E1EDD1B6Ce3253b67312c402f8bc5086cFa6EEA);
