...
contract lettera is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2d97d235cA3B33AbD35832015fda726688547efa); 
    address payable public Wallet_Dev = payable(0x2d97d235cA3B33AbD35832015fda726688547efa);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 2*10**11 * 10**_decimals;
    string private constant _name = "Letter A"; 
    ...
    constructor () {
        ...
        _owner = 0x2d97d235cA3B33AbD35832015fda726688547efa;
