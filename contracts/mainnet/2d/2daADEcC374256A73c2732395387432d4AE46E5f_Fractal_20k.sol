...
contract Fractal_20k is Ownable, ReentrancyGuard {
    ...
    function stakingInitial() public payable nonReentrant returns (bool) {
        ...
        infoVesting[msg.sender].firstBalance = 0*10**18;
