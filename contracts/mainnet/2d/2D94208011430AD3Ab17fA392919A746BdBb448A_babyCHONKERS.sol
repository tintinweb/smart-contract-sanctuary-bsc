...
10% $CHONK REWARDS JUST FOR HOLDING
...
Add this adress to you wallet to see rewards
0xC283821179Bf5226012c6b1051ec5A4b873Ca699

https://t.me/babychonkersbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  CHONK = IBEP20(0xC283821179Bf5226012c6b1051ec5A4b873Ca699);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CHONK.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CHONK);
        ...
        uint256 amount = CHONK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHONK.transfer(shareholder, amount);
...
/* Token contract */
contract babyCHONKERS is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CHONK = 0xC283821179Bf5226012c6b1051ec5A4b873Ca699; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xE94420903726e9bA07321c7ba3b3aafdc553A302;
    ...
    // Name and symbol
    string constant _name = "babyCHONKERS";
    string constant _symbol = "bCHONK";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x30C1A175fC47C21a9E7d2b3EdA27234880598975;
        marketingFeeReceiver = 0x088EAE9873c30e54bF9cFB3f3E74aD4061fF9c56;
