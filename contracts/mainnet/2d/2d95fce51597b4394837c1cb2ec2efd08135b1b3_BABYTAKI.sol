...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb05fAc378663377a6E2486aaB7c33A177b826822; 
...
contract BABYTAKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY TAKIBI INU";
    string private _symbol = "BABYTAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95866fFb1d6b4413BA71575dda1959A0118Df6b9); 
    address payable public teamWalletAddress = payable(0xb05fAc378663377a6E2486aaB7c33A177b826822); 
