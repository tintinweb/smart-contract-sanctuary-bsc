...
// Telegram: https://t.me/twittersmartchain 
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 GMT = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract TwitterSmartChain is IBEP20, Auth {
   using SafeMath for uint256;
 
   address GMT = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "TwitterSmartChain";
   string constant _symbol = "TNB";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool succes, /* bytes memory data */) = payable(0xa6A32D4aB9eCf8AfFca21E4a205e5a20170e3473).call{value: BNBMarketingamount, gas: 30000}("");
