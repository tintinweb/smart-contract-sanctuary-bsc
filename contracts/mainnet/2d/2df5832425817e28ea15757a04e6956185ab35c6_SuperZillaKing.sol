...
contract SuperZillaKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperZillaKing";
    string private _symbol = "SuperZillaKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEdEf313F1610062040c827dEa2bB4d81407B9A83);
    address payable public teamWalletAddress = payable(0xEdEf313F1610062040c827dEa2bB4d81407B9A83);
