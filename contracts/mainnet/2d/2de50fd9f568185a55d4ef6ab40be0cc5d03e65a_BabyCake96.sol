...
contract BabyCake96 is Context, IERC20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100 * 10**12 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Baby Cake 1996';
    string private _symbol = 'BABYCAKE96';
