...
contract  VisualChain  is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000000000000000000 * 10**9; //
    string private constant _name = "VISUAL CHAIN"; // 
    string private constant _symbol = unicode"$VSC"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x295fFf0955B50B379C6ad4641FDC206D98e5A96c;
