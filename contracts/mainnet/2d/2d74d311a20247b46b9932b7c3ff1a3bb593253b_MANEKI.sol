...
contract MANEKI {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 50e18; // 50 USDT
	uint256[] public REFERRAL_PERCENTS 	= [1000, 200, 100, 75, 50];
	uint256[] public SEED_PERCENTS 		= [100, 75, 50, 25, 25];
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(83, 120));
		plans.push(Plan(62, 160));
		plans.push(Plan(71, 140));
