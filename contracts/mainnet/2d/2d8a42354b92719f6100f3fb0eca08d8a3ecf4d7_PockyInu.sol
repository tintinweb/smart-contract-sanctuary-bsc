...
/**
Telegram : https://t.me/PockyInu
Website  : TBA
We are Clone KitKat Inu With Same Contract
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD09Fe3407869BDA4084A90f44c44891e5578d2a1; // owner address
...
contract PockyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pocky Inu";
    string private _symbol = "POCKY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD09Fe3407869BDA4084A90f44c44891e5578d2a1); // Marketing Address
    address payable public teamWalletAddress = payable(0xf1F4CbCd92FaaD050A2eF731043508663b0A6689); // Team Address
