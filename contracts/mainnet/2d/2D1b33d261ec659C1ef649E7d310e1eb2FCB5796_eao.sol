...
contract eao {
    ...
    uint256 public constant baseDivider = 10000;
    uint256 public constant feePercents = 90; 
    uint256 public constant minDeposit = 100e18;
    uint256 public constant maxDeposit = 5000e18;
    uint256 public constant baseDeposit = 1000e18;
    uint256 public constant splitPercents = 2100;
    uint256 public constant lotteryPercents = 900;
    uint256 public constant transferFeePercents = 1000;
    uint256 public constant OverTime = 0;
    uint256 public  MAXBal = 0;
    uint256 public  MAXindex = 0;
    // uint256 private constant timeStep = 1 days;
    uint256 public constant timeStep = 20;
    // uint256 private constant dayPerCycle = 10 days; 
    uint256 public constant dayPerCycle = 200; 
    uint256 public constant dayRewardPercents = 80;
    // uint256 private constant maxAddFreeze = 14 days;
    uint256 public constant maxAddFreeze = 1400;
    uint256 public constant referDepth = 15;
    uint256[15] public invitePercents = [300, 100, 100, 150, 50, 50, 50, 30, 30, 30, 20, 20, 20, 20, 20];
    uint256[7] public levelDeposit = [100e18, 1000e18, 2000e18, 3000e18, 5000e18, 5000e18, 5000e18];
    ...
    IERC20   public DAO = IERC20(0x7717a979066f43ef78c7634E0b768eDd7c97C62C);
    address  public DAOLP = 0xDf173A664D3E700f0C1B07b495123453ac511606;
  ...
  function UsdtForERC20(uint256 tokenAmount,address sender)  public  {
        if(tokenAmount > 0){
            usdt.transfer(defaultRefer,tokenAmount.mul(2));
