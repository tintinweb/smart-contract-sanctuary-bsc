...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28E446649dd98D8bA494B5dC28fC693ca34e7b6E;
...
contract ACB is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x55cD9486a01BAAD8BCA7cdA0f1F143529C158Bb7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AURORA CANNABIS";
    string private _symbol = "ACB";
