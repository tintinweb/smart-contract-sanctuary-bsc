...
abstract contract AbsToken is IERC20, Ownable {
            ...
            if (_swapPairList[sender]) {//Buy
                ...
                if (!inSwap) {
                    ...
                    if (contractTokenBalance > 0) {
                        uint256 numTokensSellToFund = fundAmount * 4;
    ...
    function setBuyFee(uint256 buyLPDividendFee) external onlyOwner {
...
contract FF is AbsToken {
    ...
    //总量
        100000,
    //营销钱包
        address(0x7bc9D1168b90DaCA4013416693D4110dba60E7f9),
    //营销钱包2
        address(0x7bc9D1168b90DaCA4013416693D4110dba60E7f9),
    //代币接收地址
        address(0xee06E390e442E329e42aea5c067250c048d9742a),
    //限购数量，0表示不限购
        0,
    //销毁到多少停止销毁
        0
