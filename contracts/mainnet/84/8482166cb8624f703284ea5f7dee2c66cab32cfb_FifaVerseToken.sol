...
/*
🏆 FiFA VERSE  Token  $VeFIFA

🔥Welcome to VeFIFA 🔥 a brand new  #BSC token  revolving around the famous FIFA 2022 World Cup🔥

🏆 Locked Liquidity
🏆 Renounced Ownership
🏆 Low Tax 5% Buy/Sell 2%


#bsc #moonshot

https://t.me/fifaversetoken

==========
VeFIFA GROWTH
The World Cup hype continues and we are here to provide a new trend, namely gifts for investors who take part in our events tax "GUESS WHO SCORE".
Each Day 1 Event == 5 Winners == Each Winner get 30$ == High MC High Rewards
Winner is the closest results.
The condition for receiving prize is own 0.5% tokens.
==========
*/
...
contract FifaVerseToken is Context, WorldCup, Ownable {
    ...
    string private _name = 'FIFA VERSE Token';
    string private _symbol = 'VeFIFA';
