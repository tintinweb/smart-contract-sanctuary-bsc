...
/**
 ALL INFO ABOUT US, READ CAREFULLY!

Bringing the world to Binance Smart Chain Network (BEP20) On Chain

Elactix is a decentralised Binance Smart Chain scaling platform that enables developers to build scalable user-friendly dApps with No fees without ever sacrificing on security.

Built by developers, for developers
Elactix combines the best of Binance Smart Chain and sovereign Blockchain into a full-fledged multi-chain system.

PROJECT FOCUSSED : 
✅ Swap & Bridge Chain
✅ Launchpad Ecosystem
✅ dApps Wallet Elactix
✅ Scan Transaction Hash
✅ Building Token On ELX20
*/

// Telegram : https://t.me/elactixprotocol
// Website : https://elactixprotocol.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc2140f7f0528390Ba36FeBd6BcEf81d492F22582;
...
contract ElactixProtocol is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xc2140f7f0528390Ba36FeBd6BcEf81d492F22582);
    ...
    */
    ...
    string private _name = "Elactix Protocol"; 
