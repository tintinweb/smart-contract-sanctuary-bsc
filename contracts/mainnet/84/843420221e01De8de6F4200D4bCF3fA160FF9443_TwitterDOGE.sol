...
contract TwitterDOGE  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TwitterDOGE";
    ...
    address private marketingWallet = address(0x2a9e12B11bb8e3f59C09e0E0e4dDe352C42a9DEc);
    address private liquidityReceiver = address(0x2a9e12B11bb8e3f59C09e0E0e4dDe352C42a9DEc);
