...
contract SQUIDGROWMINE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SQUID GROW MINE"; // 
    string private constant _symbol = "$SGM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3896Dd2F1456D3481f38b886455bF1987a98209f;
