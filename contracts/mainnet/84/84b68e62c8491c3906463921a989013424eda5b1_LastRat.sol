...
contract LastRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LastRat BSC";
    string private _symbol = "LastRat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8634543646e0D5bD01cA7b43afc7Efa25eF44a86);
    address payable public BuyBackWalletAddress = payable(0x8634543646e0D5bD01cA7b43afc7Efa25eF44a86);
