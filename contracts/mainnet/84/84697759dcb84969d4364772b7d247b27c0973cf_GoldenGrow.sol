...
/**
    ...
    ╰━━━┻━━┻━┻━━┻━━┻╯╰╯╰━━━┻╯╰━━╯╰╯╰╯
    Golden Grow
    Telegram : https://t.me/goldengrow
*/
...
contract GoldenGrow is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _isgetReflection;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetReflection[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetReflection[to] = block.timestamp;
        }
