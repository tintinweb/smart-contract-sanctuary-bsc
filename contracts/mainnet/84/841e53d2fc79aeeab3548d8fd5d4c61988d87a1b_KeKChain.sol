...
contract KeKChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "KeKChain";
    string private constant _symbol = "KEK";

    address public _PancakeSwapV1RouterUniswap = 0x87ef719306933d51b0F2DD7F0A3963727B50034d; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x87ef719306933d51b0F2DD7F0A3963727B50034d; //can be the same
