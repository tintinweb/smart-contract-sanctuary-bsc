...
contract CatpillarToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catpillar Token";
    string private _symbol = "Catpillar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x211d59979EfB9BD4e0c106E814aF41450b35995D); 
    address payable public buyBackWalletAddress = payable(0x5581eB0B19B006236aC82f8fBEcdfA91cd5A33e9); 
