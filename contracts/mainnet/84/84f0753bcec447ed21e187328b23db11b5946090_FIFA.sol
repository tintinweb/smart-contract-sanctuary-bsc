...
contract BaseToken is Ownable {
    ...
    string constant public name = 'FIFA TOKEN';

    string constant public symbol = 'FIFA';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 49000000000*10**uint256(decimals);
