...
contract WereAllGonnaDie is Context, IERC20, Ownable {
    ...
    string private _name = "WereAllGonnaDie";
    string private _symbol = "WAGDIE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 6666 * 1**1 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xab75FD7A7fCFc0680847235Ed325601Ad8e6e94F);
