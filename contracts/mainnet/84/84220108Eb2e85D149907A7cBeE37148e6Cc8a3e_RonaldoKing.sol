...
contract RonaldoKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RonaldoKing";
    string private _symbol = "CR7King";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xe7FcEFc812ea3DB76eBD8e51da6511dE9FF24a73); 
    address payable private teamWalletAddress = payable(0xCb7BAdff0e127D4b813214f3085556190bcf0D0d); 
