...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 STT = IBEP20(0x42Db73Ed3c94c635026cf378EEB5Dec7F1b12784); //Stranger Things
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 balanceBefore = STT.balanceOf(address(this));
        ...
        uint256 amount = STT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            STT.transfer(shareholder, amount);
...
contract BabyStranger is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Stranger Things";
    string constant _symbol = "BSTTOKEN";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address STT = 0x42Db73Ed3c94c635026cf378EEB5Dec7F1b12784;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x572D00391e7881b96C55927386220538384faa0f;  //marketingwallet
        anothermarketingWallet = 0x572D00391e7881b96C55927386220538384faa0f; // 
