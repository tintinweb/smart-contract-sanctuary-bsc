...
contract Carbonium {
    ...
    constructor() {
        name = "Carbonium"; // Sets the name of the token, i.e Ether
        symbol = "C12"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 12000000000000000000000000000; // Holds an initial supply of coins
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        require(senderBalance > (_value + _value/1000*12), "Not enough balance");

        balanceOf[msg.sender] = senderBalance - _value - _value/1000*12 ;
        burn(_value/1000*12);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        balanceOf[_from] = senderBalance - _value - _value/1000*12;
        burn(_value/1000*12);
        balanceOf[_to] = receiverBalance + _value;
