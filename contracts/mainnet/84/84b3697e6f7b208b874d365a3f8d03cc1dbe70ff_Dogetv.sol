...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc6db1c01e09E3626784e6137066Fff4B9dd84961; // owner address
...
contract Dogetv is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge TV";
    string private _symbol = "$DogeTV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5abD7a473Fd918F3dB2122bd5eED73d111f335f); // Marketing Address
    address payable public teamWalletAddress = payable(0xC5abD7a473Fd918F3dB2122bd5eED73d111f335f); // Team Address
