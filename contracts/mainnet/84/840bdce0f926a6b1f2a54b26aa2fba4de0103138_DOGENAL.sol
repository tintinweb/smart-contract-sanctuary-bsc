...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8bd58b2D1AC2951152a52BbD1bb54ef9F09CDaf0; // owner address
...
contract DOGENAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGENAL";
    string private _symbol = "$DOGENAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8bd58b2D1AC2951152a52BbD1bb54ef9F09CDaf0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8bd58b2D1AC2951152a52BbD1bb54ef9F09CDaf0); // Team Address
