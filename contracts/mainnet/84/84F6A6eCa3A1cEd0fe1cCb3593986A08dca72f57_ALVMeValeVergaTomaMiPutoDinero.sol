...
https://t.me/ALaVergaCoin

Tax 10% Para marketing, drogas, alcohol y putas, si llegamos lejos les mando el pack con las putas
...
contract ALVMeValeVergaTomaMiPutoDinero is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALVMeValeVergaTomaMiPutoDinero"; // 
    string private constant _symbol = "$ALV"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x8972DFd96b691d32A4Ce8d2C3ebA917a6e046cC1;
