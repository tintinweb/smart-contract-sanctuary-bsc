...
// New Baby Doge Coin is Born 👶🐶
// We just born for Dog Charity 👶🐶
// And We'll give holders a Big Reflections if you can Hold 💎
// 5% your token will be increasing every each transactions 💎

// Elon will watching this 🐳


// https://t.me/NewBabyDogeCoin_BSC
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x3c6E7308592a55f6F67Ba4B4a178095C7b345321;
...
contract NewBabyDogeCoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x1cfb2631977A52Fdf4842DD7c5c7d0064860EB19;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 4200000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "New Baby Doge Coin";
    string private _symbol = "$NBDC";
