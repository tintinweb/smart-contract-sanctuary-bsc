...
pragma solidity 0.8.17;
  ...
  library SafeMath {
    ...
    string public name = unicode"TERA";
    string public symbol = unicode"IERA";
    ...
    address chex = 0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B;

    constructor()  {
    Nii[msg.sender] = totalSupply;
    emit Transfer(address(0), chex, totalSupply); }
