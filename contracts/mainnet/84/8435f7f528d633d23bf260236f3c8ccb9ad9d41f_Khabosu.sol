...
/*
    ...
    + 1% Liquidity
    + 2% Buybacks & Development
    + 7% Marketing
    = 10% Total Tax
    Twitter: https://twitter.com/Khabosu_BSC
    Telegram: https://t.me/Khabosu 
...
contract Khabosu is IERC20, Ownable {
    ...
    string constant _name = "Khabosu";
    string constant _symbol = "$KHAB";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(307493726).div(100000000000); // ~0.3%
    uint256 largeSwapThreshold = _totalSupply.mul(427445130).div(100000000000); // ~0.4%
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x043012a0036a251DAEF44197D228bbeD56Fc2c8E;
