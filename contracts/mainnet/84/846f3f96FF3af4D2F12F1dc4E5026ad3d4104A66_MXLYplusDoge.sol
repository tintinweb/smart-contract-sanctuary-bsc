...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0xF9ff1C5e1F03268Eefe6059137f8b2B7088E6C6F);//DogeKing分红币
...
contract MXLYplusDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MXLYplusDoge";
    string constant _symbol = "MXLYplusDoge";
