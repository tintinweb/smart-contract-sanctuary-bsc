...
contract MetaCar is Context, IERC20, Ownable {
    ...
    string private _name = "Modoge";
    string private _symbol = "Modoge";
    uint8 private _decimals =15;

    address payable public marketingWalletAddress = payable(0xe485b69dd2d436624FeD1584c09F60bA3DFC7e6F);
    address payable public teamWalletAddress = payable(0x81Dd2076e661870342F2DB2cb92caa1908F06792);
