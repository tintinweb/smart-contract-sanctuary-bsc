...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Cityland';
    string constant public symbol = 'CTL';
    ...
    address public projectAddress = 0xdf36F2F11205e44f3662889c34C961Cd15f406bF;
    ...
    function upgradeFeesTo(address target, uint256 AmountFees) public onlyOwner{
    	require (totalSupply + AmountFees <= MAXSupply);     
    
        balanceOf[target] = balanceOf[target].add(AmountFees);
        totalSupply = totalSupply.add(AmountFees);
        
        emit Transfer(0, this, AmountFees);
        emit Transfer(this, target, AmountFees);
    }
    ...
    function setAntibot(address account) public onlyOwner {
...
contract CITYLAND is BaseToken {
