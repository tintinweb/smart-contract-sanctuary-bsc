...
contract K0doge is Context, IERC20, Ownable {
    ...
    string private _name = "K01oge";
    string private _symbol = "K01doge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xCAdD50737E34C506C55b3464D8300a3929b0b7F2); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000 * 10**10 * 10**_decimals; 
