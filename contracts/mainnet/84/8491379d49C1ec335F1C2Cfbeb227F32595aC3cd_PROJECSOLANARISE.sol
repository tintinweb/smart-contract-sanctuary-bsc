...
//SOLANA RISE ($SOLRISE) is a cryptocurrency a virtual currency designed to act as money and a form of payment outside the control of any one person, group, or entity, thus removing the need for third-party involvement in financial transactions.  
//solana rise will be a new version of btc and will represent the freedom of crypto with huge marketing.

//More information will be released on our website with the community group!
//Telegram:https://t.me/SolanaRise1000x
...
contract PROJECSOLANARISE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SOLANA RISE"; // 
    string private constant _symbol = "$SOLRISE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x66ca0686e148e951A0B8865b683BdBcF489A0723;
