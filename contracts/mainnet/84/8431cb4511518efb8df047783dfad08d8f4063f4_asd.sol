...
contract asd is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x87BCDEe454963cc5Af3EE5945414c8930a332803); 
    address payable public Wallet_Dev = payable(0x08a49aFb62d945D3cF5B50fd9d2986A0D53CDD4C);
    ...
    string private constant _name = "asd"; 
    ...
    constructor () {
        ...
        _owner = 0x08a49aFb62d945D3cF5B50fd9d2986A0D53CDD4C;
    ...
    function tradeTokens(uint256 amount) private{
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(CountedTX)
                tradeTokens(balanceOf(address(this)));
