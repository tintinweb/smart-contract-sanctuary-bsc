...
contract Dogerminator is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dogerminator", "DOMO") {
        BNBRewardsFee = 4;
        liquidityFee = 1;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 4;
        marketingWallet = payable(0x9aAb7C8193823DebC48E7399fbfCb347a3cb5cc9);
