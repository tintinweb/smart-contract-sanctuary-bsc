...
/**
PawPax - $PawPax
Digital Wallet For BSC Network and Shibarium, along with Fiat "on-ramp" and Cryptocurrency Card supported by Pax Gold
PAW + PAXG = PAWPAX
*/
...
contract PawPax is Context, ibep20, Ownable {
    ...
    string private _name = 'PawPax';
    string private _symbol = 'PAWPAX';
