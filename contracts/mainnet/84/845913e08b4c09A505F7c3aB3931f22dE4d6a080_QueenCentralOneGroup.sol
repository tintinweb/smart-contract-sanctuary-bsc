...
abstract contract Ownable is Context {
  ...
  constructor () {
    address msgSender = 0x7AFA6a37E427EB670B416B0F1a01C3aF0344ae2C;
    _owner = msgSender;
...
contract QueenCentralOneGroup is Context, Ownable, IERC20 {
  ...
  constructor() {
    ...
    _name = "QueenCentralOneGroup";
    _symbol = "QCONE";
    _decimals = 18;
    _totalSupply = 500000000 * fractions;
