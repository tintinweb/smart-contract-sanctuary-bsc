...
//Telegram : https://t.me/WinteroftheDragon
...
contract WinteroftheDragon is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Winter Of Dragon";
    string constant _symbol = "WODR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 18) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *18) / 100; 
