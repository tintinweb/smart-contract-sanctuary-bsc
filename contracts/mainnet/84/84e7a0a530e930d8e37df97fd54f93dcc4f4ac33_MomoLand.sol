...
contract MomoLand is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Momo Land";
    string private _symbol = "MOMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd7bAB2C7ca1A2909f8c4FA634a94f330f92b70ab); 
    address payable public teamWalletAddress = payable(0xd7bAB2C7ca1A2909f8c4FA634a94f330f92b70ab); 
