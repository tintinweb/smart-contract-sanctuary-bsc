...
contract HATANAKA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HTNK";
    string constant _symbol = "$HATANAKA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =  0xA7DD49499030495bE1a372b285F611BE433C6B11 ;
