...
contract Oasis is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x00Bee48E6187cba509b973CA0A9Cf723C0e32BE0);
    address payable public teamWalletAddress = payable(0x00Bee48E6187cba509b973CA0A9Cf723C0e32BE0);
    ...
    uint256 private _totalSupply = 4096 * 10**_decimals;
    uint256 public _maxTxAmount = 4096* 10**_decimals; 
    uint256 public _walletMax = 4096 * 10**_decimals;
