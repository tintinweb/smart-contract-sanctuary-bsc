...
contract BabyDOGS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDOGS";
    string private _symbol = "BabyDOGS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x255697F9Da560f8D6256C24C8613531B662b3aEa); // Marketing Address
    address payable public teamWalletAddress = payable(0x3a2950f0dc9F669E139A19D80933cD560562019E); // Team Address
