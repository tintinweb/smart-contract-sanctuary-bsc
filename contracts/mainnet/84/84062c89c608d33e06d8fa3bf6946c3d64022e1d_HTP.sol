...
contract HTP is Context, IERC20, Ownable {
    ...
    function setRate(uint256 _rate,uint256 _bRate) public onlyOwner {
        rate = _rate;
        bRate = _bRate;
    }
