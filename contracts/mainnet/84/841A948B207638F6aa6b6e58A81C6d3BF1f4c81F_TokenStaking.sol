...
// File: contracts/RadiusToken.sol
...
contract RadiusToken is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
...
contract TokenStaking {
    ...
    RadiusToken public radiusToken;

    
    address public owner;

    
    uint256 public defaultAPY = 137;
    ...
    constructor(RadiusToken _radiusToken)  payable {
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        radiusToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        radiusToken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                radiusToken.transfer(recipient, balance);
            }
        }
    }
