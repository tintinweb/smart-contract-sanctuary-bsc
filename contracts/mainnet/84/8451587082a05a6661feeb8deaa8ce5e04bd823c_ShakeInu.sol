...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA34cDeED8133EBEf4b5183250a3d0a564c39C754;
...
contract ShakeInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9AbFD453a48f854632b638B2F0fD56C7C65157B5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shake Inu";
    string private _symbol = "Shake inu";
