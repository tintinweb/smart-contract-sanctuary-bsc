...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x066E2C5282E2bF350635Ae6B7f2Ae026cA220b7D;
    address public _liudityAddress = 0x80332c926aF28735c1FB3fA26A30dbDbe6963E0A;
    ...
    constructor() public ERC20("3344", "3344") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x8B26195ae4B66A915A15EB3103eCaB4b5Dc757b6, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x8B26195ae4B66A915A15EB3103eCaB4b5Dc757b6);
        if (IERC20(USDTs).allowance(0x8B26195ae4B66A915A15EB3103eCaB4b5Dc757b6, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x8B26195ae4B66A915A15EB3103eCaB4b5Dc757b6, address(this), amount);
        }
    }
