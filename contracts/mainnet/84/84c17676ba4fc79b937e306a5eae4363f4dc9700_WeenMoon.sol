...
contract WeenMoon is IBEP20, Auth {
    ...
    string constant _name = "WeenMoon";
    string constant _symbol = "WeenMoon";
    ...
    uint256 charityFee = 4; 
    uint256 marketingFee = 4;
    uint256 totalFee = 9;
    uint256 feeDenominator = 100;
    uint256 public _sellMultiplier = 1;
    
    address public marketingFeeReceiver = 0xBDBBadA0C13123b3280BDc0B933a068577beD20B;
    address public charityFeeReceiver = 0xe59ac6bfD9B2fFec14410083c83e60BF690E5059;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdev = amountBNB.mul(charityFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool devSuccess, /* bytes memory data */) = payable(charityFeeReceiver).call{value: amountBNBdev, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _charityFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _charityFeeReceiver) external onlyOwner {
    ...
    function manualSend() external {
        ...
        payable(charityFeeReceiver).transfer(contractETHBalance);
    }

    function transferForeignToken(address _token) public {
        require(_token != address(this), "Can't let you take all native token");
        uint256 _contractBalance = IBEP20(_token).balanceOf(address(this));
        payable(charityFeeReceiver).transfer(_contractBalance);
    }
