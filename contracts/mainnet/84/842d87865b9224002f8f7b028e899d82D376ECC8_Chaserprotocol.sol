...
contract Chaserprotocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chaser Protocol";
    string private _symbol = "Chaser";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95046CA92537cE0987f0c7089ec1B04eA9CF34c7); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x95046CA92537cE0987f0c7089ec1B04eA9CF34c7); // Development Address
    ...
    uint256 public _DevelopmentShare = 7;
