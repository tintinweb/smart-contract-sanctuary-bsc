...
contract FireToken is ERC20, ERC20Detailed  {
    ...
    constructor ()  ERC20Detailed("Fp", "Fp", 18) {

        // governance = msg.sender;
        uint256 totalSupply = 210000000*10**18;
        _mint(rewardAddr, totalSupply.mul(9000).div(10000));
        _mint(0x920b574B25Bf6185649daF61517fAef104611cf8, totalSupply.mul(1000).div(10000));
    ...
    function uamount(uint256 amount) internal view returns (uint256) {
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(from == teamAddr) { 
                ...
                uint256 userAutoAmount1 = (getAutoSellAmountList(to)).add(MFee);
                setAutoSellAmountList(to, userAutoAmount1);
            ...
            if(to == teamAddr){
                ...
                if(balance.sub(amount) < totalBuyAmount) {
                    ...
                    uint256 burnamount = amount1.mul(300).div(9100);
        ...
        uint256 burnamount1 = amount.mul(300).div(9100);
        ...
        if(balance1.sub(amount) < totalBuyAmount1 && to != blackHoleAddr) {
            if(fireshare1 >= burnamount1) {
                ...
                uint256 afterDecrAmount1 = fireshare1.sub(burnamount1);
            ...
            if(fireshare1>0 && fireshare1<burnamount1) {
    ...
    function buy(address _address) public returns(bool){   
        ...
        super._transfer(bReceveAddr, address(this), totalAmount);
