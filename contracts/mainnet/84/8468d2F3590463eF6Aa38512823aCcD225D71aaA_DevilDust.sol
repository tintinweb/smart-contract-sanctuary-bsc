...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb0D97Eab11247A620D26650b4af75abd40772384; // owner address
...
contract DevilDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevilDust";
    string private _symbol = "DD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0D97Eab11247A620D26650b4af75abd40772384); // Marketing Address
    address payable public teamWalletAddress = payable(0xb0D97Eab11247A620D26650b4af75abd40772384); // Team Address
