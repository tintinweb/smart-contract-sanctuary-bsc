...
contract BNBMiner is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNBMiner";
    string private constant _symbol = "BNBMiner";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9a3674F201d07BC7c9e96d28936a9B81538e32a7);
    address payable private _marketingAddress = payable(0x9a3674F201d07BC7c9e96d28936a9B81538e32a7);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 88, "Redis cannot be more than 88.");
	    require(redisFeeOnSell < 88, "Redis cannot be more than 88.");
	    require(taxFeeOnBuy < 88, "Tax cannot be more than 88.");
	    require(taxFeeOnSell < 88, "Tax cannot be more than 88.");
