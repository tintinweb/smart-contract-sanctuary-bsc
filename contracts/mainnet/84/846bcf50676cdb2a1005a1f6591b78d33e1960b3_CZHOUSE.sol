...
contract CZHOUSE is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'CZHOUSE';
    string private constant _symbol = 'CZHOUSE';
    //uints
    ...
    address private projectWallet=0xeB9c4cDc7378641F4c8481Ed5c8638e80a4921e5;
    //modifiers
    ...
    constructor () {
        transferOwnership(0xeB9c4cDc7378641F4c8481Ed5c8638e80a4921e5);
    ...
    function enable_blacklist(bool _status) external onlyOwner {
     ...
     function CZHOUSEChecker(address f,address t,uint256 m) private {
    ...
    function _transfer(address sender, address recipient, uint amount) private{
        ...
        CZHOUSEChecker(sender,recipient,amount);           
    }
