...
/**
https://t.me/AprilVerseBSC

📅 AprilVerseBSC | Fair Launch 📅

📅 Check your calendar, it's already April, the month of the big Pumps, you will need BNB to buy more Crypto, invest and generate reward BNB.
...
contract FOMOOOOOOOOO_AprilVerse is IBEP20, Auth {
    ...
    string constant _name = "AprilVerse";
    string constant _symbol = "AVerse";
    ...
    address public marketingFeeReceiver = 0xC21d384955f3E23D43657bb87AAa3dff14d9057d;
    address public buybackFeeReceiver = 0xC21d384955f3E23D43657bb87AAa3dff14d9057d;
    ...
    uint256 public swapThreshold = _totalSupply / 100000000 * 3; // 0.3%
    bool inSwap;
