...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 1*1*10**18; //基礎APY：100 , 加成APY：0
    uint256 public PRICE = 100; //單位100個JBL-Token
    ...
    constructor ()  public ERC721("JBL-SGhomeR", "JBL-SGhomeR"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-SGhomeR";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/player/JBL-SGhomeR.png";

        token.transferFrom(msg.sender, address(this), PRICE*1*10**18);
        
        mint_total = mint_total-1;

        cards.push(Card(name, 5, tokenURI, NFT_APY, PRICE));//5:打擊
