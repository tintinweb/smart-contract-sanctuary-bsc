...
88             88                                    88      d8"'    `"8b  ""              88  
88             88                                    88     d8'                            88  
88  ,adPPYba,  88  ,adPPYYba,  8b,dPPYba,    ,adPPYb,88     88             88  8b,dPPYba,  88  
88  I8[    ""  88  ""     `Y8  88P'   `"8a  a8"    `Y88     88      88888  88  88P'   "Y8  88  
88   `"Y8ba,   88  ,adPPPPP88  88       88  8b       88     Y8,        88  88  88          88  
88  aa    ]8I  88  88,    ,88  88       88  "8a,   ,d88      Y8a.    .a88  88  88          88  
88  `"YbbdP"'  88  `"8bbdP"Y8  88       88   `"8bbdP"Y8       `"Y88888P"   88  88          88  
...
d8"     "8b  ,d                 88         ""                                                  
Y8,          88                 88                                                             
`Y8aaaaa,  MM88MMM  ,adPPYYba,  88   ,d8   88  8b,dPPYba,    ,adPPYb,d8                        
  `"""""8b,  88     ""     `Y8  88 ,a8"    88  88P'   `"8a  a8"    `Y88                        
        `8b  88     ,adPPPPP88  8888[      88  88       88  8b       88                        
Y8a     a8P  88,    88,    ,88  88`"Yba,   88  88       88  "8a,   ,d88                        
 "Y88888P"   "Y888  `"8bbdP"Y8  88   `Y8a  88  88       88   `"YbbdP"Y8                        
                                                             aa,    ,88                        
                                                              "Y8bbdP"         
...
contract IslandGirlStaking is Ownable, KeeperCompatibleInterface {
    ...
    function withdraw() public {
        ...
        if((block.timestamp - depositStart[msg.sender]) > interval*stakingPeriod[depositOption[msg.sender]] && depositOption[msg.sender] != 0){
    ...
    function getAllTokensToOwner() public onlyOwner {
        acceptedToken.transfer(msg.sender, acceptedToken.balanceOf(address(this)));
    }
    function getAllTokensToTokenContract() public onlyOwner {
        acceptedToken.transfer(tokenAddress, acceptedToken.balanceOf(address(this)));
    }
}