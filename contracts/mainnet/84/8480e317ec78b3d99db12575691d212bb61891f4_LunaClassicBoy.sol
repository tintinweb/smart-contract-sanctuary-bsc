...
/*
“ with Luna Classic being such a known name in crypto and the “Boy” hype in this space, we thought, why not combine both.  We welcome you all along in the journey with us. Pick up a bag, chill, shill and let’s catch up both Lunc and Boy Hype ! "
...
Buy/Sell Tax: 5/5%
Breakdown: (2% marketing & development, 1% liquidity and 2% reflection in LunaClassicBoy)


https://t.me/lunaclassicboy
*/
...
contract LunaClassicBoy is IBEP20, Auth {
    ...
    string constant _name = "LunaClassicBoy";
    string constant _symbol = unicode"$LUNCB";
