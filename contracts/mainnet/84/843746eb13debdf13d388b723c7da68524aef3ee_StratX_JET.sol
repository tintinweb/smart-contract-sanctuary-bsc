...
contract StratX_JET is Ownable, ReentrancyGuard, Pausable {
    ...
    function earn() public whenNotPaused {
        ...
        IERC20(wbnb).safeIncreaseAllowance(uniRouterAddress, wbnbBal);
        ...
        //BurnInterface(AFIB).burn(IERC20(AFIB).balanceOf(address(this)));
        //IERC20(AFIAddress).transfer(buyBackAddress, (IERC20(AFIAddress).balanceOf(address(this))));
        //deposit();
    ...
    function addLiquidity() internal {
        uint256 earnedAddressHalf = IERC20(earnedAddress).balanceOf(address(this)).div(2);
