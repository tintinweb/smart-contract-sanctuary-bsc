...
Well, It's Arabian Cheems for you! 

Arabian Cheems This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best

Why Arabian Cheems ?

It is a Community Powered - Arabian Cheems fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - Arabian Cheems smart contract has been verified and its Liquidity Pool is locked. 
That means next to zero risk for our users and community from potential bad actors.

Socials:
Telegram : https://t.me/arabiancheems
Twitter : https://twitter.com/arabiancheems
*/
...
contract ARABIANCHEEMS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbE82e5dd3484e0772531A50Da6778dBef9F921ac); 
    address payable public Wallet_Dev = payable(0x6A056c5d4f832AB35832927496b894fEfBBF249e);
    ...
    string private constant _symbol = unicode"ARABIANCHEEMS"; 
