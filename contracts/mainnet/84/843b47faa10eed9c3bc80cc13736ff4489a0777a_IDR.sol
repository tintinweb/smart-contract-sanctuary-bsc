...
/**
    ...
    We are introducing a defi-based project that has some real utility to be an asset for the future!
    We have utilities likes

    ▪️IDR App
    ▪️IDR Staking/farm
    ▪️IDR Chain

    Telegram : https://t.me/IDRBSC
*/
...
contract IDR is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "IDR";
    string private _symbol = "IDR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe1A2678C553BcAbDc0eCfde28aaF6D9639F735Ff);
    address payable public DevelopmentWalletAddress = payable(0xe1A2678C553BcAbDc0eCfde28aaF6D9639F735Ff);
