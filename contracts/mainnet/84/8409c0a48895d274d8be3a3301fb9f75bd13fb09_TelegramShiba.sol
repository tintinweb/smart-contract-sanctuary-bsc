...
contract TelegramShiba  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Telegram Shiba";
    string private _symbol = "TGShiba";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x6472dcb04aF5b4427aA85A79611856563cfbD27E);
