...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function rightowner(address newOwner) external onlyOwner returns (bool) {
...
contract braveheart is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "braveheart";    
    string public symbol = "BRAVE";
    uint8 public decimals = 9;   

    uint8 public takeaway;
    uint8 public improvepercent;
    uint8 public download;  
    ...
    function creasenewcontract(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }

    function plusratio(address account) external onlyOwner {
        require(!excludedFromDividends[account]);
        excludedFromDividends[account] = true;
    }

    function allsame(address shareholder, uint256 _amount) internal {    
    ...
    function upload(uint256 newClaim) public view onlyOwner returns(bool) {
