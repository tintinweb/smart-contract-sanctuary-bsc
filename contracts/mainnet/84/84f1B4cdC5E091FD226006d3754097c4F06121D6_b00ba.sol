...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xEf4df0E3B863F2A8DAF7402a2cD825E65F2B00ba;
...
contract b00ba is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public mwallet = payable(0xEf4df0E3B863F2A8DAF7402a2cD825E65F2B00ba);
    ...
    string private constant _symbol = unicode"B👀BA"; 
    ...
    uint256 public _maxWalletToken = _tTotal.div(21);
