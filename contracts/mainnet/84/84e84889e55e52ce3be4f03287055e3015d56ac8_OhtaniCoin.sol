...
contract OhtaniCoin is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 50000000000000; // 50T
    uint256 private constant swapTokensAtAmount = 5;

    uint256 private _previousMaxWalletToken = _maxWalletToken;

    string private constant _name = "Ohtani Coin";
    string private constant _symbol = "SHOWTIME";

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3; // BurnFee
    address public _marketingWallet =
        0x7f53AFf9Fab91c81Fd4E2CCc60A7a3c3227FdDf3;
        ...
        returns (uint256)
    {
        ...
        _tOwned[address(this)] += marketingFee.add(liquidityFee);
        emit Transfer(from, address(this), marketingFee.add(liquidityFee));
        _tOwned[_burnWallet] = _tOwned[_burnWallet].add(liquidityFee); // 3% burn
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf(address(this))
            .mul(_liquidityFee)
            .div(_marketingFee.add(_liquidityFee));
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount.sub(ethFromLiquidity) > 0)
            payable(_marketingWallet).sendValue(
                ethAmount.sub(ethFromLiquidity)
            );
    }
