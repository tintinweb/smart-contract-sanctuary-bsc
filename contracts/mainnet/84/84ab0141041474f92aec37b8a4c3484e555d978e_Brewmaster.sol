...
🌎Telegram: https://t.me/Brewmaaster
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCB925737eFCD7a0D977533FA49618a4Cc1c36EfE;
...
contract Brewmaster is Context, IERC20, Ownable {
    ...
    string private constant _name = "Brewmaster"; // 
    string private constant _symbol = "$Bewma"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xCB925737eFCD7a0D977533FA49618a4Cc1c36EfE);
