...
contract RabbitInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 17_000 * 10**_decimals;
    ...
    address public marketingAddress = 0xF185778f12C40cc5b4236491b88D1c1d5c9be7C6;
    address public devAddress = 0x640E8ABEcf3Bd7F17C5726Ce67cB4310d6bC8497;

    string private constant _name = "Bugs Bunny Inu";
    ...
    // Owner cannot transfer out RabbitInu from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out RabbitInu!");
