...
contract BMZILLA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Mechazilla";
    string constant _symbol = "BMZILLA";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 7e9 * (10 ** _decimals);
