...
/**
Welcome to Two Buck Chuck!

For those of you who dont know the story, I owned a winery when my wife divorced me and tried to take everything I have. To keep ger fomr getting anything I sold all my bottles at $2 and never made a dime. 

So with my last $2 I give you this coin. 

Hopfully you have better successes and marriages than I did. - Chuck
...
contract TwoBuckChuck is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TwoBuckChuck";
    string constant _symbol = "SHAW";
