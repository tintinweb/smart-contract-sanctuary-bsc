...
CROSWAP
$CROS is a Swap community-driven token and decentralized meme coin in bsc 
THE MOON IS MADE
OF CROSWAP.
Trade, earn, and win crypto on the most popular decentralized platform in the galaxy.
Telegram : https://t.me/CroSwapBsc
website : http://www.cro-swap.com/
...
contract CroSwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "CroSwap"; //
    string private constant _symbol = "$CROS "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address private _marketingWallet = 0xd5119606F7c35f8D7FB0ebc8A9717e49a248126E ;
