...
contract IDOCSWT is ReentrancyGuard, Context, Ownable {
    ...
    function startIDO(uint256 endDate, uint256 _minPurchase,uint256 _maxPurchase,  uint256 _hardcap) external onlyOwner icoNotActive() {
