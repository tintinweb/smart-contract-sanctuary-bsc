...
contract ShibaTiger is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShibaTiger";
    string constant _symbol = "SHIBTIGER";
    ...
    uint256 public _maxTxAmount = _totalSupply * 20 / 100; // 20% 
    uint256 public _walletMax = _totalSupply * 30 / 100; // 30%
