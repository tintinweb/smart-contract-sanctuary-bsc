...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc739dc7a701630C94f0b44a747d1ada46209E46b; // owner address
...
contract LOGOAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOGO AI";
    string private _symbol = "LOGO AI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x31D40D9872F31463D2052d7013B408006ad3cB08); // Marketing Address
    address payable private teamWalletAddress = payable(0xc739dc7a701630C94f0b44a747d1ada46209E46b); // Team Address
