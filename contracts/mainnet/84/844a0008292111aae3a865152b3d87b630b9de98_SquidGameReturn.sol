...
/*
The return of SquidGame has come.

TG: https://t.me/SquidGameReturn
*/
...
contract SquidGameReturn is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'SquidGame Return';
    string private constant _symbol = '$SGR';
    //uints
    uint public constant InitialSupply= 45600000000 * 10**_decimals;
    ...
    address private projectWallet=0x7fB99A5dC63304C1830ff2154e2AD733b5E61814;
    address constant lpReceiver=0x46e1982b469815e91917e63b8988832De00f144F;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x46e1982b469815e91917e63b8988832De00f144F);
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            uint BuyTaxDuration=33 seconds;
    ...
    function SetupEnableTrading() external onlyOwner{
        ...
        maxTransactionAmount = InitialSupply * 150 / 10000;
