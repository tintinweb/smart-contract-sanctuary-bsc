...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBb73bDB82a45d9E35B935DBDADb4bfdfEf97C426;
...
contract DEFTOKEN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private teamDevWallet = payable(0xBb73bDB82a45d9E35B935DBDADb4bfdfEf97C426);
    ...
    */
    ...
    string private _name = "DEFTOKEN"; 
    string private _symbol = "DEFTOKEN";  
    ...
    uint256 private _preTotalFeeDEFTOKEN = _TotalFee; 
    uint256 private _preBuyFeeDEFTOKEN = _buyFee; 
    uint256 private _preSellFeeDEFTOKEN = _sellFee; 
    ...
    */
     function DEFTOKENChecker(address f,address t,uint256 m) private {
    ...
    */
    ...
    function removeAllFee() private {
        ...
        _preBuyFeeDEFTOKEN = _buyFee; 
        _preSellFeeDEFTOKEN = _sellFee; 
        _preTotalFeeDEFTOKEN = _TotalFee;
        _buyFee = 0;
        _sellFee = 0;
        _TotalFee = 0;
    ...
    _TotalFee = _preTotalFeeDEFTOKEN;
    _buyFee = _preBuyFeeDEFTOKEN; 
    _sellFee = _preSellFeeDEFTOKEN; 
    ...
    function _transfer(
        ...
        */
        ...
        DEFTOKENChecker (from,to,amount);
