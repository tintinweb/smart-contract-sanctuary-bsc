 ...
 *
*/
// https://t.me/TurtleCoinBSC
// Welocome to Turtle Coin BSC. A New Era Begins;)
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11eA56704b178c81E3C9F703B40D939d5544DFc8; // owner address
...
contract TurtleCoinBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TurtleCoinBSC";
    string private _symbol = "Turtle";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11eA56704b178c81E3C9F703B40D939d5544DFc8); // Marketing Address
    address payable public teamWalletAddress = payable(0xAC4176b6DBd65a3c6860B908C6c3CEcB8627c3B0); // Team Address
