...
contract ARABIANDOGETATE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian Doge Tate";
    string private _symbol = "ADTOPG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB082a01D7aFD6413499886Ee39f6F2c1CA074DE); 
    address payable public DevelopmentalWalletAddress = payable(0xD2104dFca6eea8F83F2f7A33D365a0671458779C); 
