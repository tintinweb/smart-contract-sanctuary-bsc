...
library Address{
 ...
 contract  RUGMEMIAKHALIFA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1FEB72f2a0aC18956905Cf60fBed01A605c7777C;
    address public donationWallet =0x1FEB72f2a0aC18956905Cf60fBed01A605c7777C ;

    string private constant _name = "RUG ME MIA KHALIFA";
    string private constant _symbol = "RMMK";
