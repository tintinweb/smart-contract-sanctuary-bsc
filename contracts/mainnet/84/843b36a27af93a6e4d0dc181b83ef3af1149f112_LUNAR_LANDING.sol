...
/*
T̓͛͘H͒͛͘E̓̀̽ R͆̾̚E͆͆̿A͐̐͌L̓̓͒ M̐̿͠O͝͠Ò͌̕N͊͐̕ L͌̚͠A̐̈́N͊̈́͐D̓́͆Ì͝N͒͝G̓̾͝
...
contract LUNAR_LANDING is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOR REAL THIS TIME";
    string private constant _symbol = "REAL MOON";
    ...
    constructor () {
        _MarketingWallet = payable(0x0829E09e57F953d3cf8814675c6ae4c8cC42e6fA);
        _liquidityWallet = payable(address(0x08b132B80257a668939A6E1Dcb0FAa9682bF0829));
