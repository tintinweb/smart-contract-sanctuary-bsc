...
//address constant BNBADD = 0xae13d989daClliv2f0dEbFf460aC112a837C89BAa7cd; // TEST NET 


contract AUTO_BNB_LP_LOCK {
    ...
    */
    ...
    function Token_Rescue(address Token_To_Rescue, uint256 Percent_to_Rescue) external {
        ...
        // If Token Symbol is Cake_LP check the pairs for BNB
