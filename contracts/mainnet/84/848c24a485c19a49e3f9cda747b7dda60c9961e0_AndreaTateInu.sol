...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 HU2 = IBEP20(0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = HU2.balanceOf(address(this));
        ...
        uint256 amount = HU2.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            HU2.transfer(shareholder, amount);
...
contract AndreaTateInu is IBEP20, Auth {
    ...
    address HU2 = 0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C;
