...
contract UnskippableAdds is IBEP20, Auth {
    ...
    string constant _name = "McGrimace";
    string constant _symbol = "Mcdo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100; //2%
    ...
    address private marketingFeeReceiver = 0x5C73aba253057C82647613E870ec45F66928c24F;
    address private developmentFeeReceiver = 0x495320C73A742D9e16bC9923125eF66280aF06c3;
