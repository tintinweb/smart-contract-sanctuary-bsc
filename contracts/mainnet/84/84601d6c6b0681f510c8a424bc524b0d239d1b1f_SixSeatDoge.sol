...
contract SixSeatDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SixSeat Doge";
    string constant _symbol = "6IXDOGE";
    ...
    uint256 _totalSupply = 600000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x2b08E9f8ACD84376f4018bA6FBF6f0047cBa5100;
