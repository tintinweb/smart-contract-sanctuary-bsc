...
contract CRYPTO is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    CRYPTODividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0xC71d551e955916264274b75702dDAE0A6822523c);
    address payable public _charityWalletAddress = payable(0x108cfD1489CD4B33290fc6c26a4C91D9495aD193);
    address payable public _buybackWalletAddress = payable(0x3917c77ca6e7f25eE8Ae5763326DC0C148C3E215);
    ...
    constructor() BEP20("CRYPTO", "CRPT") {
        dividendTracker = new CRYPTODividendTracker();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         // Create a uniswap pair for this new token. @dev //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 //0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "CRYPTO: The dividend tracker already has that address");
        CRYPTODividendTracker newDividendTracker = CRYPTODividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "CRYPTO: The new dividend tracker must be owned by the CRYPTO token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "CRYPTO: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CRYPTO: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "CRYPTO: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CRYPTO: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "CRYPTO: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "CRYPTO: Cannot update gasForProcessing to same value");
...
contract CRYPTODividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("CRYPTO_Dividend_Tracker", "CRYPTO_Dividend_Tracker") {
        claimWait = 3600;
...
//    // Because 'BUSDRewardsFee = 0' --> then Dividends/Reflections/Rewards are currently turned off. If they are turned on, Holders will earn in BUSD.
    function _transfer(address, address, uint256) internal pure override {
        require(false, "CRYPTO_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "CRYPTO_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CRYPTO contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "CRYPTO_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "CRYPTO_Dividend_Tracker: Cannot update claimWait to same value");
