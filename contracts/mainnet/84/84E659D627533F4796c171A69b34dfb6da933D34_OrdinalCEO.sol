...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5AE85057C939864116D4d8Fa6235cA229ed50C97; // owner address
...
contract OrdinalCEO is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Ordinal CEO";
    string private _symbol = unicode"OCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5AE85057C939864116D4d8Fa6235cA229ed50C97); // Marketing Address
    address payable public teamWalletAddress = payable(0x5AE85057C939864116D4d8Fa6235cA229ed50C97); // Team Address
