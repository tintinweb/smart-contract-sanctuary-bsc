...
/**
🦍 Telegram : https://t.me/habibiapeinu
*/
...
contract HabibiApeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Habibi Ape Inu";
    string private _symbol = "$HAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x50eF4bA6BFAB4A7693FA238870702DE4dC935350);
    address payable private teamWalletAddress = payable(0x50eF4bA6BFAB4A7693FA238870702DE4dC935350);
    ...
    uint256 public _maxTxAmount = 30000 * 10**6 * 1**1* 10**_decimals; 
    uint256 public _walletMax = 30000 * 10**6 * 1**1* 10**_decimals;
