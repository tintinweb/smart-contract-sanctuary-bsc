...
contract distributionContract is Ownable{
    ...
    function addTokens(address userAddress, uint256 amount1, uint256 amount2)  public onlyOwner{
        lockedBalances[userAddress].push((amount1*1e16)*5);
        lockedBalances[userAddress].push((amount1*1e16)*15);
        lockedBalances[userAddress].push((amount1*1e16)*15);
        lockedBalances[userAddress].push((amount1*1e16)*15);
        lockedBalances[userAddress].push((amount1*1e16)*15);
        lockedBalances[userAddress].push((amount1*1e16)*20);
        lockedBalances[userAddress].push((amount1*1e16)*15);
        //Bonus
        lockedBalances[userAddress].push((amount2*1e16)*5);
        lockedBalances[userAddress].push((amount2*1e16)*15);
        lockedBalances[userAddress].push((amount2*1e16)*15);
        lockedBalances[userAddress].push((amount2*1e16)*15);
        lockedBalances[userAddress].push((amount2*1e16)*15);
        lockedBalances[userAddress].push((amount2*1e16)*20);
        lockedBalances[userAddress].push((amount2*1e16)*15); 
