...
contract AntDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x605dade3cbc360Bc2D38Ca445D33743E75C1f1f1;
    address public receiveSellFeeWallet = 0x875643a74a487dbE13be5e0ceAc9AC36952dC47E;
    IWrap public wrap = IWrap(0x1a961386BE71d089Eb16d06AF0c47216F4A512Ea);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Ant DAO", "ANT", 18, 31000000 * 10 ** 18){
        address msgSender = _msgSender();
