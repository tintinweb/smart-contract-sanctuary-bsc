...
contract GameCertificateTokenGoblin is ERC721Upgradeable,IProxyMint {
    ...
    function proxyMint(address reciever, uint256 amount) public override onlyProxyAddress {
        for (uint256 i; i < amount; i++) {
            _mint(reciever, totalSupply);
        }
    }
