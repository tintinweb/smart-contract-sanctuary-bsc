...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);//要分红的币
...
contract DOGETIME is IBEP20, Auth {
    ...
    string constant _name = "DogeTime";//名字
    string constant _symbol = "DogeTime";//名字
    ...
    uint256 public reflectionFee   = 5;//分红税
    uint256 public marketingFee    = 4;//营销费
    uint256 public devFee          = 2;//dev费
