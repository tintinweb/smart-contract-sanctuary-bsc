...
contract BSHIB is Context, IERC20, Ownable {
    ...
    string private _name = "Pink Rbbits";
    string private _symbol = "Pink Rbbits";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x51e73284633881aD14BDc6d2BBd88Ff5374A19EA); 
    address payable private teamWalletAddress = payable(0xDEB0c25054779fcEacf3835EdC52A8164E882c1C); 
