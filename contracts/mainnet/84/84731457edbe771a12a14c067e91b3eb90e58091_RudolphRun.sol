...
contract RudolphRun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rudolph Run";
    string private _symbol = "RRun";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x210569796916A0348657553ACd7e35720aefE226); // Marketing Address
    address payable private developmentWalletAddress = payable(0x0346f54Ed35E1155d94351665E872B633F35225D); // Development Address
    ...
    uint256 private _developmentShare = 4;
