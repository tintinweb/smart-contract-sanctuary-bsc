...
contract Wings is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 WINGS
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Wings Shares", "WINGS") {
        _mint(msg.sender, 1 ether); // mint 1 UNICORN Share for initial pools deployment
