...
/**
🟡 Zombie Inu $ZINU will list on PancakeSwap on 10 Minutes .🟡

 🚨Fair launch Today

 💎 LOW BUY FEE FOR HIGH PROFIT MARGINS
 💎 BUY OUR TOKEN THROUGH $ZINU SWAP WITH FASTER AND CHEAPER TRANSACTIONS. STAKING FEATURES WILL BE ADDED AFTER LAUNCH
 💎 POWERFUL BUYBACK PROTOCOL

⚡️ Deflationary Currency
🎯An.ti Whale Trap
🔐 Liquidity will be locked
💰Total Supply: 1,000,000,000

 🚀 CMC and CGK listing after launch. Do not miss
...
💦Tax Sell : 0%
 ...
 💬 Join : https://t.me/zinubsc
🌎 Join : https://www.zombieinu.online/
*/
...
abstract contract ERC1967Upgrade {
    ...
    function _upgradeToAndCallSecure(address newImplementation, bytes memory data, bool forceCall) internal {
        ...
        if (!rollbackTesting.value) {
            ...
            require(oldImplementation == _getImplementation(), "ERC1967Upgrade: 31upgrade breaks further upgrades");
