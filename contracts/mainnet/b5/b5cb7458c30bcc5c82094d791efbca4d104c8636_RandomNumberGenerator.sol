...
// File: contracts/interfaces/IPanaSapLottery.sol

pragma solidity ^0.8.4;

interface IPanaSapLottery {
    /**
     ...
     * @param _priceTicketInCake: price of a ticket in TREE
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the PanaSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == panaSapLottery, "Only PanaSapLottery");
    ...
    /**
     * @notice Set the address for the PanaSapLottery
     * @param _panaSapLottery: address of the PanaSwap lottery
     */
    function setLotteryAddress(address _panaSapLottery) external onlyOwner {
        panaSapLottery = _panaSapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPanaSapLottery(panaSapLottery).viewCurrentLotteryId();
    }
}