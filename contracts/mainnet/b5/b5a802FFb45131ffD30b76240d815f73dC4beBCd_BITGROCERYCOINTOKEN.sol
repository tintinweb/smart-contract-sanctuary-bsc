...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract BITGROCERYCOINTOKEN is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "BITGROCERYCOIN";
        string private  _symbol = "BITGROCERY";
   ...
   address payable marketingWallet = payable(0x073902c415218d88A2A2B84c5F5c3b19212D470f);
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function setLiquidityFee(uint8 liquidityfee) public onlyOwner {
