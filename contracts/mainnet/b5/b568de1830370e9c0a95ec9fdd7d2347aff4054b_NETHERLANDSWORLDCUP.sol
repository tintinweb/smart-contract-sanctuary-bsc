...
contract NETHERLANDSWORLDCUP is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xA72a78965B34A0c0C05675A9b00c0760305Ba590); 
    address payable private Wallet_Dev = payable(0xD0a965e4cC16daaA112543a0858A79674FBf0608);
    ...
    string private constant _name = "NETHERLANDS WORLD  CUP"; 
    string private constant _symbol = unicode"NTLDWC"; 
    ...
    uint256 public _Tax_On_Sell = 8;
     function _Fix_Taxes(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    constructor () {
        ...
        _owner = 0xD0a965e4cC16daaA112543a0858A79674FBf0608;
    ...
    function LFGTrade_set(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function bla_la(address[] calldata addresses) external onlyOwner {
    ...
    function b_lal_free(address addresses) external onlyOwner {
    ...
    function addLP_WL(address addresses) external onlyOwner {
    ...
    function bla_rmv(address[] calldata addresses) external onlyOwner {
    ...
    function bla_rmve(address addresses) external onlyOwner {
    ...
    function WhL_rmve(address addresses) external onlyOwner {
