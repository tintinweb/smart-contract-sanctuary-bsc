...
Telegram: https://t.me/ml16092022
Twitter:  https://twitter.com/_MOJITOKEN_
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B4476d0A777058a5246a931e9ea8cc489ea6cCe; 
...
contract MOJITOken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "mojitoken";
    string private constant _symbol = unicode"moji";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x7B4476d0A777058a5246a931e9ea8cc489ea6cCe); // Marketing Address
    address payable public teamWalletAddress = payable(0x7B4476d0A777058a5246a931e9ea8cc489ea6cCe); // Team Address
