...
contract BabyBonk is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe602BFD561c4998DB2BCC2938dbC7DA943F6828d); 
    address payable public reserveWalletAddress = payable(0x26cA036741a67914A474801fE80a3B24971650F1); 
    address payable public stakingWalletAddress = payable(0x99dF9366Cb6B384EBD7f01CF9a6cB0E65De5E2A8); 
    address payable public devWalletAddress = payable(0x205dD43CD76bdeeabF636C21d58dfA8EB87c9ABb); 
    ...
    string private constant _name = "Baby Bonk Coin";
    ...
    external onlyOwner 
    {
        ...
        require(totalSwapableFee + totalSwapableSaleFee <= 30, "Must be less than 30% total");
