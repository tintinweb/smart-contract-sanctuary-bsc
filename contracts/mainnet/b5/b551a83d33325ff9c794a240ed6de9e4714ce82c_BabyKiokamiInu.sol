...
contract BabyKiokamiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x957744f8b69fcbb00884048093560F70335FFF9e);
    address payable public Wallet_Dev = payable(0xF046427cEA4990F59E55236a7a9CC461E79e7193);
    ...
    string private constant _name = "Baby Kiokami Inu";
    string private constant _symbol = unicode"BKIOINU";
