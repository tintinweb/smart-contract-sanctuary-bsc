...
contract DividendDistributor is IDividendDistributor {
    ...
    contract SENIORDOGE is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Senior Doge";
    string constant _symbol = "Sr. DOGE";
    ...
    uint256 rewardFeeBuy = 2;      //Reward might be turned on later
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0c40ebE4f4613B1b409449991F2904044fa552fF; //Marketing wallet
        devFeeReceiver = 0xe11dBD4E0B9B909224F89D2D0F7e20C4d3bFDcF8; //Dev fee
