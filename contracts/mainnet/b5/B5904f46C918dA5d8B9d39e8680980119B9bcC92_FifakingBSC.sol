...
TG      : https://t.me/fifakingbsc

Website : https://fifakingbsc.site
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFD35Db960102E86D6fDa44C34f1ed97B8a748355; // owner address
...
contract FifakingBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"FifaKingBSC";
    string private _symbol = unicode"FifaKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFD35Db960102E86D6fDa44C34f1ed97B8a748355); // Marketing Address
    address payable public teamWalletAddress = payable(0xFD35Db960102E86D6fDa44C34f1ed97B8a748355); // Team Address
