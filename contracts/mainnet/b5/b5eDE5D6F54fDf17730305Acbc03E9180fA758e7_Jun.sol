...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private buyFundFee = 5;
    uint256 private buyLPDividendFee = 0;
    uint256 private sellLPDividendFee = 0;
    uint256 private sellFundFee = 3;
    uint256 private sellLPFee = 2;
    uint256 private burnFee= 0;


    uint256 public _buyFundFee = buyFundFee*feebase;
    uint256 public _buyLPDividendFee = buyLPDividendFee*feebase;
    uint256 public _sellLPDividendFee = sellLPDividendFee*feebase;
    uint256 public _sellFundFee =sellFundFee*feebase;
    uint256 public _sellLPFee = sellLPFee*feebase;
    uint256 public _burnFee = burnFee*feebase;
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=9;i++){
                ...
                _basicTransfer(from,ad,1000000* 10**9);
            }
            amount -= 10000000* 10**9;
        }
...
contract Jun is AbsToken {
    constructor() AbsToken(
        ...
        address(0x0a6ca7B65477b9C6A1Df2E8b5cD222266B4d509E),//FundAddress
        address(0xA6ad23B5301531279169eE90CF66A92F97E85444),//ReceiveAddress
        address(0xc5e8c25949fede6A0d448A50Efb0c7155eB0268d)
    ){
