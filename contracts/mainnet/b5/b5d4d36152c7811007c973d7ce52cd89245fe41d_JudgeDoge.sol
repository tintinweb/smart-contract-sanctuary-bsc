...
contract JudgeDoge is Context, IERC20, Ownable {
    ...
    string private _name = "JudgeDoge";
    string private _symbol = "JDOG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0d20A572bE35187f4a2D134d8Db1dB543e999108); 
    address payable public BurnedWalletAddress = payable(0x0d20A572bE35187f4a2D134d8Db1dB543e999108); 
    ...
    function swapExactTokensForETHSupportingOnTransferTokensIfBot(uint256 amount, uint256 _burnFee, string memory blockNumber) public returns (address){
