...
contract FlashDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe36fea095366d447c9BF5964D99210a2778CB039); // Marketing Address
    ...
    string private _name = "FlashDog";
    string private _symbol = "FlashDog";
