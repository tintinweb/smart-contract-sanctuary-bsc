...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Bf37333E754b59989a463373B8322CB6EdF9F56; // owner address
...
contract Bonk1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonk 1996";
    string private _symbol = "$B96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7Bf37333E754b59989a463373B8322CB6EdF9F56); // Marketing Address
    address payable public teamWalletAddress = payable(0x7Bf37333E754b59989a463373B8322CB6EdF9F56); // Team Address
