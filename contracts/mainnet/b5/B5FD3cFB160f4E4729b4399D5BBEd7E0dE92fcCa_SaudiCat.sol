...
contract SaudiCat is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5ebd1A176ea9C3689E4b199b920bC0Df45740A21); // Marketing Address
    address payable public devWalletAddress = payable(0x5ebd1A176ea9C3689E4b199b920bC0Df45740A21); // Dev Address
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x5ebd1A176ea9C3689E4b199b920bC0Df45740A21, 'We can not exclude Uniswap router.');
