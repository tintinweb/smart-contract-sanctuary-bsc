...
contract BANG is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_500_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xE149EB5C2E8505E24da221A590A41e592192fD1F;
    address public devWallet = 0x352eB27F9F13cb1369F96CBDf1BA831728Cd3812;

    string private constant _name = "BANG FINANCE";
    ...
    Taxes public taxes = Taxes(3, 5, 2, 1);
    Taxes public sellTaxes = Taxes(3, 5, 2, 1);
    ...
    function setSellTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
        require(_dev > 1,"Dev Tax should be greater than 1");
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 10_000_000_000_000, "Cannot set swap threshold amount higher than 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxWallet >= 1_000_000_000_000, "Cannot set max wallet amount lower than 0.1% of tokens");
