...
/**
Introducing Squirrel P2E Game-Fi that pays you money just by making a game account and finish your mission!
Squirrel is a token that is going to launch on BEP-20 Chain (BSC) the next moonshot coin, 
a BSC token that will provide utility (P2E Platform and NFTs) exciting features to all holders!

Our Socials 
Telegram : https://t.me/squirrelglobalofficial
Twitter : https://twitter.com/squirrel_ofc
Website : https://squirrelgame.online/
DYOR
*/
...
pragma solidity ^0.8.6;
 ...
 contract Squirrel is Context, IERC20, Ownable {
     ...
     string private constant _name = "Squirrel Token";
     string private constant _symbol = "SQUIRREL";
     uint8 private constant _decimals = 9; 
     
     uint256 public _marketingFee = 9;
     uint256 public _liquidityFee = 3;
     address public _marketingWallet = 0x11366b431a85Da952B79Ea8e8A3EEb2A93983Aa9;
