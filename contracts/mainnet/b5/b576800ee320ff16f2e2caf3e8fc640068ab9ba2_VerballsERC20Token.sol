...
abstract contract ERC20 is IERC20 {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, uint256 initialBalance_) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
...
contract VerballsERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("Verballs", "VBALLS", 9, 32000000) 
    ERC20Permit("Verballs") 
