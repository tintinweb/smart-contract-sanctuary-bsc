...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD1f207A99374e60E6cE3feaF5439aCB4D2EdE626; // owner address
...
contract LegitInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Legit Inu";
    string private _symbol = "Legit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd36C246D70163E9Ba02FEcc3Fa46418d5d3a53b5); // Marketing Address
    address payable public teamWalletAddress = payable(0xd36C246D70163E9Ba02FEcc3Fa46418d5d3a53b5); // Team Address
