...
contract Rocket is Context, IERC20, Ownable {
    ...
    bool public mintedByRocketDev = true;
    ...
    function setAllFeePercent(uint8 taxFee, uint8 liquidityFee, uint8 burnFee, uint8 stakingfee, uint8 buybackFee) external onlyOwner() {
        ...
        require(stakingfee >= 0 && stakingfee <=maxstakingfee,"WF err");
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee + _burnFee + _stakingfee + _buybackFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _burnFee == 0 && _stakingfee == 0 && _buybackFee == 0) return;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //burn
        uint8 totFee  = _burnFee + _stakingfee + _liquidityFee + _buybackFee; 
