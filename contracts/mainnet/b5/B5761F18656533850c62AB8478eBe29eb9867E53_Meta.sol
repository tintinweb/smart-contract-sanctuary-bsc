...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "SamoDoge";
    string private _symbol = "SamoDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9564054226D7b396a2d3E19679932EAEF251f43C);
    address payable public teamWalletAddress = payable(0x508396eAf821C276bAcC5B40A2c0840dDEc2A284);
    address public T = 0x48252E8D0cA567bAdc5348c5cba8C86c58BC081B;  // team address
    address public M = 0xa6A242370B037b9E51080DA6BD2D73954274FB5f;  // market address
    address public P = 0x5902542CB8e127057025fc2F56599E48018eF844;  // private address
