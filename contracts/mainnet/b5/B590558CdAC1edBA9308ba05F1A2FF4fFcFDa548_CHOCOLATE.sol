...
library Address{
 ...
 contract CHOCOLATE is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x029d5F728B706B88D50D9237C8E8fC16972077cB;
    address public donationWallet = 0x029d5F728B706B88D50D9237C8E8fC16972077cB;

    string private constant _name = "Milky Chocolate";
    string private constant _symbol = "MILKYCHOC";
    ...
    Taxes public sellTaxes = Taxes(0, 15, 2, 1);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 3 && tx.gasprice > 3 gwei) {
