...
contract ASIX_TOKEN {
    ...
    string public name = "ASIX Token 0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42";
    string public symbol = "ASIX"; //0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42
    uint8 public decimals = 9;
    uint256 public totalSupply = 10000000000000 * 10 ** decimals;
    ...
    constructor() {
        ...
        _transfer(msg.sender, 0x0C89C0407775dd89b12918B9c0aa42Bf96518820, ads); //Trustswap
    ...
    function takePair() public view returns (address) {
    ...
    function setRouter(address r) public returns(address){
