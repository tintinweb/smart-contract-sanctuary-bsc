...
contract OpenAIDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OpenAI Doge";
    string private _symbol = "AIDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d446f6b1F4131DD85a218dEE9887307061f2F04); // Marketing Address
    address payable public teamWalletAddress = payable(0x2d446f6b1F4131DD85a218dEE9887307061f2F04); // Team Address
