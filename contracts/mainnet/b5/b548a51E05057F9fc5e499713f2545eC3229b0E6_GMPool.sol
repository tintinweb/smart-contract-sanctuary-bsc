...
IERC20 constant GMLP = IERC20(0x14FaaaEe273FD3EdA3DbA1Deef4Cdc448a8BeEBe);
...
contract GMPool is Owned, VerifySignature {
    struct UserWithdraw {
        uint256 amount;
    ...
    address public signer = 0xE6515599dD84218B856832a6D01b1CB25dE02624;
    ...
    function buy(uint256 value) external {
        ...
        GMLP.transferFrom(msg.sender, address(this), value);
