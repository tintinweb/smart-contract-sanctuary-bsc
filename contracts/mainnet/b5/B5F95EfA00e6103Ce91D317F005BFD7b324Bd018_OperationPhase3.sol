...
contract OperationPhase3{
    ...
    //TSLswap节点卡合约地址
    address public SwapNodeContract = address(0xC746Ee56E81A03b3d5735353Bb15faEA428F75a8);
    //上下级合约
    ...
    //购买USDT价格
    uint256 public BuyTokenUsdtnumber = 300 * 10**18;
    ...
    //修改合成开关
    function setsynthesisSwitch(bool synthesisSwitch_) 
        public 
        Owner 
        returns (bool)
        {
            synthesisSwitch = synthesisSwitch_;
            return true;
        }
    ...
    function Mint_synthesis(address[] memory teslaContract_,uint256[] memory tokenid_) 
        ...
        returns(bool)
        {
            ...
            require(synthesisSwitch, "Synthesis is not open yet");
    ...
    function Mint_buy(address TokenContracts_) 
        ...
        returns(bool)
        {
            ...
            if(SwapNodeCards.fNumber_(address(f)) == 3){
                ...
                emit MintGives(address(this),address(f),tokenidgive, block.number);
            }
            return true;
        }
    //usdt转换代币
