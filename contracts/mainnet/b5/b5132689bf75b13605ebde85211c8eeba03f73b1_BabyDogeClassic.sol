...
abstract contract Auth {
    ...
    constructor(address _owner) {
        _owner = 0xeC948967011cA832bd3a9e7C627f5Ec42c05C07c;
        owner = _owner;
...
contract BabyDogeClassic is IBEP20, Auth {
    ...
    string  _name = "BabyDogeClassic";
    string  _symbol = "$BabyDogeClassic";
    ...
    address private marketingFeeReceiver = payable (0x2dcd2Fa273C27f36a641291DAb4Aa97dD3c9be42);
    address private buybackFeeReceiver = payable (0x2dcd2Fa273C27f36a641291DAb4Aa97dD3c9be42);
