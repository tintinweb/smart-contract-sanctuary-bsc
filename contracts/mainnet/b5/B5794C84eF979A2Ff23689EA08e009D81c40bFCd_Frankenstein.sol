...
// https://t.me/FrankenSteinDogeEntry
// https://twitter.com/FogeBSC
...
library Address{
 ...
 contract Frankenstein is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 666_666_666 * 10**9;
    ...
    address public marketingWallet = 0x5747aa3DC14Bfd679f37c92e013f75dae2DC6d39;
    address public donationWallet = 0x5747aa3DC14Bfd679f37c92e013f75dae2DC6d39;

    string private constant _name = "Frankenstein doge";
    string private constant _symbol = "FOGE";
    ...
    Taxes public sellTaxes = Taxes(1, 6, 3, 0);
