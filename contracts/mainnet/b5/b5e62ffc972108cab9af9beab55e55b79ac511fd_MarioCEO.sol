...
/*
 MARIO IS THE CEO! https://t.me/marioceomain

 MARIO + CEO Is the Perfect combination name from Elon tweet
MARIO CEO Is meme cryptocurrency coin on BSC Network
MARIO CEO Will be low taxes and fully contract renounced, so you all can trade with low fees, and safely!
...
contract MarioCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mario CEO";
    string private constant _symbol = "$MARIO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x8E4cfF723518D007E862b7b6B8306bD263E05AFD);
    address payable private _marketingAddress = payable(0x8E4cfF723518D007E862b7b6B8306bD263E05AFD);
