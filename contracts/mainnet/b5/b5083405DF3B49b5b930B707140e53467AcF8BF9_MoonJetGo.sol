...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4693A216D81a00c9Fb9dba9d65413075A4A9f2FA;
...
contract MoonJetGo is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF935a7023424618Dbe4a726Ab9693e7d6242C8Fd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MoonJetGo";
    string private _symbol = "MjG";
