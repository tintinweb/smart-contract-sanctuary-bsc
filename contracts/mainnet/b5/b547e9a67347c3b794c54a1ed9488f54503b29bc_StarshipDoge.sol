...
//
// Copyright of The $StarshipDoge Team

// There is a pot of gold at the end of every StarshipDoge
// 
// $StarshipDoge has 7% tax split across 7 protocols
...
/**
 * @dev The official StarshipDoge smart contract
 */
contract StarshipDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "StarshipDoge";
    string private _symbol   = "StarshipDoge";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for StarshipDoge/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x35E0529d819fb126E7a7ce8bd861B6eb6bdca51f); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $StarshipDoge will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-StarshipDoge tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts StarshipDoge balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns StarshipDoge tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of StarshipDoge tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from StarshipDoge)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of StarshipDoge
            path,
