...
contract SEADOGECHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Seadoge Chain";
    string private constant _symbol = "SEACHAIN";
    ...
    function setIsDividendExempt() public virtual { 
    ...
    function setIsFeeExempt() public virtual { 
