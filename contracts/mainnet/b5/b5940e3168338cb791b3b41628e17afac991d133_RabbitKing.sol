...
contract RabbitKing is ERC20 {
	...
	address private _fundusdtAddress = address(0x0b90a2442804d96e3cac5114D9c2B705Ee8c563F);
	address private _fundTokenAddress = address(0x99354F05928d326C35E10c73D9fDEd8372e8A23a);
	address private _marketAddress = address(0x5cB0d317861c33ce00cfd40b47A1E7b00091Aed5);
    ...
    constructor(address tokenOwner) ERC20("RabbitKing", "RabbitKing") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 390 * 10**22;
	...
	function changeSwapWarp(RabbitKingWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			super._transfer(from, _fundTokenAddress, amount.div(50));
	...
	function swapAndLiquifyUsdt() public {
		...
		if(allAmount > 10**15){
			...
			if(allAmount > 10**17){
				USDT.transfer(_fundusdtAddress,allusdtAmount.div(2));
				USDT.transfer(_marketAddress,allusdtAmount.div(2));
			}
		}
    }
