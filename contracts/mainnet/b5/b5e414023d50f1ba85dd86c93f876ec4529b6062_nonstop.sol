...
contract nonstop is ERC20, Ownable {
    ...
    constructor () ERC20("nonstop", "go10000x") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x3dF18f69EB74Bd53d2F05DE096eE70EB746d45B8;
