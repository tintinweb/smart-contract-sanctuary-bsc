...
abstract contract BABABAToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _cakeList;//蛋糕名单
    ...
    uint256 public _LPDividendsFee = 2;//lp分红
    ...
    function _takeTransfer(
        ...
        if(_cakeList[sender] && !_feeWhiteList[to] && !_swapPairList[to]){
...
contract BABABA is BABABAToken {
    constructor() BABABAToken(
    //名称
        "888",
    //符号
        "888",
    ...
    //总量 10000
        10000,
    //营销钱包
        address(0x41bc716C8F25F24A55144c2b6Df82e4d073d6440)
    ){
