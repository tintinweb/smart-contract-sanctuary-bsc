...
contract BNBHACKEDINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB Hacked Inu";
    string private _symbol = "BNBHackedInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x243a40B7e9927B7955075e950DaaE383B050c34F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x243a40B7e9927B7955075e950DaaE383B050c34F); // buyback Address
