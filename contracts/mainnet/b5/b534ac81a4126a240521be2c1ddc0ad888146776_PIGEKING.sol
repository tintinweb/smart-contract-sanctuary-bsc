...
contract PIGEKING is Context, IERC20, Ownable {
    ...
    string private constant _name = "PIGE KING"; // 
    string private constant _symbol = "PIGEKING"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xFFDbD330EdDfA4854a55F4e27A45fBa02ed382Ce ;
