...
contract NothingPass is NothingPassDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NothingPassTeam;
    address private CharityNothingPass;
    ...
    string public override name = "NothingPass";
    string public override symbol = "BETA";
    ...
    constructor(uint totalSupplyValue, address NothingPassTeamAddress, address CharityNothingPassAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NothingPassTeam = NothingPassTeamAddress;
        CharityNothingPass = CharityNothingPassAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NothingPassTeam] =  totalSupply * 4 / 100;
        balances[CharityNothingPass] = totalSupply * 4 / 100;
