...
contract PizzaINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PIZZAINU";
    ...
    function _transfer(
        ...
        // transfer between wallets is commisioned
        ...
        _transferStandard(from, to, amount, _buyFee);
    }
    ...
    function setBuyFee(uint256 buyFee) external onlyOwner {
        require(buyFee < 15, "Buy fee must be lower than 15.");
        _buyFee = buyFee;
    ...
    function setSellFee(uint256 sellFee) external onlyOwner {
        require(sellFee < 61, "Sell fee must be lower than 61.");
        _sellFee = sellFee;
