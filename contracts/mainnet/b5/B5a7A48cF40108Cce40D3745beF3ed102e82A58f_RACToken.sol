...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        address RouterAddress, address MainToken,
        ...
        address mainPair = swapFactory.createPair(address(this), MainToken);
        ...
        lpRewardCondition = 20000 * tokenDecimals;

        excludeHolder[address(0)] = true;
        excludeHolder[address(0x000000000000000000000000000000000000dEaD)] = true;
        excludeHolder[address(this)] = true;

        holderRewardCondition = 20000 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 holdDividendAmount = _holdDividendFee * tAmount / 100;
            if (holdDividendAmount > 0) {
                feeAmount += holdDividendAmount;
                _takeTransfer(sender, address(_tokenDistributor), holdDividendAmount);
            }
