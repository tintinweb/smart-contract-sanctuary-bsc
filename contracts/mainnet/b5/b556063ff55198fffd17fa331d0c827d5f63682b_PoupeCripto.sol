...
contract PoupeCripto is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 700000000 * 10**_decimals;     // Supply do Token = 700 millions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 2000000 * 10**_decimals;    // 2 millions - Initial max buy
    uint256 public _maxRxAmount = 500000 * 10**_decimals;    // 500k - Initial max sell
	uint256 public _maxWallet = 5000000 * 10**_decimals;     // 5 millions - Initial max Wallet	
    uint256 public numTokensToSwap = 100000 * 10**_decimals; // 100k - Swap 
	uint public sellPerSecond = 3; // 3 seconds for sell
    uint public buyPerSecond = 3;	// 3 seconds for buy
    ...
    string private constant _name = "PoupeCripto";
    string private constant _symbol = "POUPE";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        marketingAddress = payable(0xFaB0F3A6dd4dd0af1FB2B1077f1251CE3A9e636c); // wallet marketing bnb
