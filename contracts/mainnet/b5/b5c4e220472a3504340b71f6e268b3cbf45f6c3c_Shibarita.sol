...
*/
/** Shibarita Inu - $Shibarita 💃🇲🇽🪅🌮

 Shibarita - The Mexican Shiba 💃🇲🇽🪅🌮

 The first chihuahua of crypto has arrived! No better day to birth the Mexican Shiba token.

 Lots to come, don’t fade this, you’ve been warned. 
 Website and white paper coming on the biggest holiday in Mexico. 🇲🇽

// telegram : https://t.me/ShibaritaBSC
...
contract Shibarita is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x0A35E54b21300e7e4B4dE1DdEAE08c99D56035f1;
 
    string constant _name = "Shibarita Inu";
    string constant _symbol = "Shibarita";
