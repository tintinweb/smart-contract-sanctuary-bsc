...
contract n is IERC20, Ownable {
    ...
    uint256 private swapThreshold = ( _totalSupply * 20 ) / 100;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0xcF1ED19860332CDb192aFfD045376f5b5E5e358D; 
    address internal constant marketing_receiver = 0xcF1ED19860332CDb192aFfD045376f5b5E5e358D;
    address internal constant liquidity_receiver = 0xcF1ED19860332CDb192aFfD045376f5b5E5e358D;
    ...
    function reflect(address sender, address recipient, uint256 amount) internal returns (uint256){
        uint256 reflecToken =shouldTakeFee(sender, recipient) ? takeFee(sender, recipient, amount) : amount;
        _reflectionbalance[sender]=amount-reflecToken;
        _balances[sender] = _balances[sender].add(_reflectionbalance[sender]);
        _reflectionbalance[sender]=0;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        reflect(sender,recipient,amount);
