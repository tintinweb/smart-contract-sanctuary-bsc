...
contract country is Context, IERC20, Ownable {
    ...
    string private _name = "country";
    string private _symbol = "country";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cA2042F70188df5501ac1CE0C9346c715a5A945);
    address payable public teamWalletAddress = payable(0x7cA2042F70188df5501ac1CE0C9346c715a5A945);
