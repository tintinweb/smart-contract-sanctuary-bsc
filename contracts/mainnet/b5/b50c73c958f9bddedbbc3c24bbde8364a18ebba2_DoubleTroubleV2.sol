...
A contract that automatically pays double the BNB sent to it!
Now reviewed and tested. All verifiable on BSCScan.

Originally introduced by Vincent.

Website - https://doubletroublebsc.com/
Telegram - https://t.me/DoubleTroubleV2
...
contract DoubleTroubleV2 is Ownable, IBEP20 {
    ...
    string constant _name = "Double Trouble V2";
    string constant _symbol = "DT2";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x0Aa889ed6648b1E386C12C7050D400226089ADcE;
        marketingWallet = 0x0Aa889ed6648b1E386C12C7050D400226089ADcE;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 12);
        require (newTotalSell < 12);
