...
Telegram : https://t.me/kittensquidportal
Website : http://kittensquid.com/
*/
...
contract KttenSquid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x9B65852D2f11A9BF90aef83aAb966f9725FA75C1); 
    address payable public liquidityAddress = payable(0x723223353dFef55bCD2CBa6069Fd8bc139241650);
    ...
    uint256 private constant _tTotal = 1000000000 * 1e18; // 100.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Kitten Squid";
    string private constant _symbol = "KSQUID";
    ...
    uint256 public maxBuyAmount = (_tTotal / 1000) * 150; // 1,5% of Supply
    uint256 public maxSellAmount = (_tTotal / 1000) * 30; // 0,3% of Supply
    uint256 public maxWallet = (_tTotal / 1000) * 150; // 1,5% of Supply
