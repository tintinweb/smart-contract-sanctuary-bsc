...
contract metalblock is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200_000_000 * 10**9;
    uint256 public _maxTxAmount = 6_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Metal Blockchain"; // 
    string private constant _symbol = "METAL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x261750394EeA266424e8864E604b7c2fD85bF795;
