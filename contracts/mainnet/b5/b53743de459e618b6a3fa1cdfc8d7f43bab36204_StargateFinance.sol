...
interface StargateFinanceDeployer {
...
contract StargateFinance is StargateFinanceDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private StargateFinanceTeam;
    address private CharityStargateFinance;
    ...
    string public override name = "Stargate Finance";
    string public override symbol = "Stargate Finance";
    ...
    constructor(uint totalSupplyValue, address StargateFinanceTeamAddress, address CharityStargateFinanceAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        StargateFinanceTeam = StargateFinanceTeamAddress;
        CharityStargateFinance = CharityStargateFinanceAddress;
        
        // split the tokens according to agreed upon percentages
        balances[StargateFinanceTeam] =  totalSupply * 4 / 100;
        balances[CharityStargateFinance] = totalSupply * 4 / 100;
