...
contract ZF is ZFToken {
    constructor() ZFToken(
        ...
        18,
        1000,
        address(0x07C58668f7b6316e76c3C3C0b4fcf70297d6041f),  //营销1  3%手续费
        address(0x2570D4922A5fd981Fd49F5A3485EDe90666F6AA9),   //营销地址2  2%手续费
        address(0xfEf5CBaE35C21497daE1D41fae250A72c8888888),   //接收代币的地址
        5 //限购数量
    ){
