...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x3A244F8049Ea391d5336c5f84f6e78097DE554aF;
...
contract USWAP is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Ultime Swap"; 
    string private constant _symbol = unicode"USWAP"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x3A244F8049Ea391d5336c5f84f6e78097DE554aF), BNB_Tot);
            }
