   ...
   //     0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
        ...
        returns (uint256)
    {
        if (0 <= pastDay && pastDay < 15) {
            return 0;
        } else if (15 <= pastDay && pastDay < 500) {
            return 50 * 10**usdt_decimals;
        } else if (500 <= pastDay && pastDay < 600) {
            return 50 * 10**usdt_decimals;
        } else if (600 <= pastDay && pastDay < 800) {
            return 50 * 10**usdt_decimals;
        } else if (800 <= pastDay && pastDay < 900) {
            return 50 * 10**usdt_decimals;
        } else if (900 <= pastDay && pastDay < 960) {
            return 50 * 10**usdt_decimals;
        } else {
            return MAX;
        }
