...
contract GOATY is ERC20, Ownable {
    ...
    uint256 public  marketingFeeOnBuy   = 6;
    uint256 public  marketingFeeOnSell  = 6;

    uint256 private _totalFeesOnBuy     = 12;
    uint256 private _totalFeesOnSell    = 12;

    address public  marketingWallet = 0xf64E3B5f19eBBBB24499760336369987B967C27D;
    ...
    constructor(
        ...
        _mint(newOwner, 200_000_000 * (10 ** 18));
        operator = msg.sender;
        require(
            liquidityFeeOnBuy  + 
            marketingFeeOnBuy  + 
    	...
    	dividendTracker = new DividendTracker( 10000 , rewardToken);
        ...
        if (swapEnabled && 
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(marketingShare > 0) {
                    ...
                    uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: marketingBNB}(
                        0,
                        path,
                        marketingWallet,
                        block.timestamp
    ...
    function setLastProcessedIndex(uint256 index) external onlyOperator {
