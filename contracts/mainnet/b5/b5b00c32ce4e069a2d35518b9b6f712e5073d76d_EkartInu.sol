...
//EKART INU is a revolutionary new digital currency powered by blockchain technology that provides users with unprecedented levels of financial freedom, transparency, and security. EKART INU allows anyone to store, transfer and trade funds quickly and securely on the blockchain, giving users complete control over their finances. With fast transactions, advanced privacy features, and low fees, EKART INU is the ideal choice for individuals or businesses looking to transition into the world of cryptocurrency.
...
//telegram:https://t.me/EkartInuBsc
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8806E24f9e6f4e0aF688841d7D6134b745a16669;
...
contract EkartInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ekart Inu"; // 
    string private constant _symbol = "Ekart"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x8806E24f9e6f4e0aF688841d7D6134b745a16669);
