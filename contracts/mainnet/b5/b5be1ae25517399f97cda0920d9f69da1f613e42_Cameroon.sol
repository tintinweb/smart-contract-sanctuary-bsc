...
contract Cameroon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cameroon";
    string private _symbol = "Cameroon";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD5CE0a34dD4F14407bd47907eeD2d238aA8eb0c3); 
    address payable public BurnedWalletAddress = payable(0xD5CE0a34dD4F14407bd47907eeD2d238aA8eb0c3); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (block.number < ( genesisBlock + coolBlock) && sender == uniswapPair&&!isExcludedFromFee[recipient])
            {
