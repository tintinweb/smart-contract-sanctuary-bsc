...
contract BtrueAz is ERC721, Ownable{
    ...
    uint256 public immutable maxBtrueAz;
    ...
    function reserveBtrueAz() public onlyOwner {
    ...
    function mintBtrueAz(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxBtrueAz, "Purchase would exceed max supply of BtrueAz");
