...
contract Fractest is Context, IERC20, Ownable {
    ...
    address payable public marketingwallet =
        payable(address(0x8cBE4F8A25386B4f756b4F9bc22fAB354e86e1cf));
    address payable public insurancewallet =
        payable(address(0x57558620DAB495AbcC247A57B941D0cC37403Cd9));
    address payable public treasuryWallet =
        payable(address(0x94d50f9FBe52d8C7ccDDa79991158EaDecd46388)); 
    address public liquidityReceiver =
        0x384423D1850a4e62270905498C92FB30691f51A7;
    ...
    constructor() {
        ...
        _isExcludedFromLimit[marketingwallet] = true;
        _isExcludedFromLimit[insurancewallet] = true;
    ...
    function updateinsuranceWallet(address payable newAddress) external onlyOwner {
    ...
    function setBothFees(
        ...
        buyFee.insurance = buy_insurance;
        ...
        sellFee.insurance = sell_insurance;
        ...
        )
    {
        ...
        uint256 tWallet = calculateMarketingFee(tAmount) +
            calculatetreasuryFee(tAmount) + calculateinsuranceFee(tAmount) ;
    ...
    function calculateinsuranceFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
        return _amount.mul(_insuranceFee).div(10**2);
    }
    ...
    function setBuy() private {
        ...
        _insuranceFee = buyFee.insurance;
    ...
    function setSell() private {
        ...
        _insuranceFee = sellFee.insurance;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 insuranceAmt = unitBalance *
            2 *
            (buyFee.insurance + sellFee.insurance);
        ...
        if (insuranceAmt > 0) {
            insurancewallet.transfer(insuranceAmt);
        }
