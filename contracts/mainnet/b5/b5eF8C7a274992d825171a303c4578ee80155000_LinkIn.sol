...
/**
TG: https://t.me/LinkInOfficial
Website : https://Link-In.IO

twitter : https://Twitter.com/officialLink_In
 */
 ...
 */
contract LinkIn is IBEP20, Ownable {
    ...
    event SetDevelopmentWallet(address indexed oldDevWallet, address indexed newDevWallet);
    ...
    // Basic Contract Info
    string constant _name = "LINK IN";
    string constant _symbol = "LINK-IN";
    ...
    address private developmentWallet = 0xEa3fB8Fe3068373EA81b82e8bec9F8768Fd316D6;
    address private marketingFeeReceiver = 0xF6b5e4027418f7872Fa34F6ec01146Db80e84244;
    ...
    function _distributeBNB(uint256 amountBNB) private {
        ...
        (bool devSuccess, /* bytes memory data */) = payable(developmentWallet).call{value: BNBDev, gas: 30000}("");
    ...
    function _addLiquidity (uint256 amountToLiquify, uint256 amountBNBLiquidity) private{
        ...
        _addingLP = true;
            router.addLiquidityETH{value: amountBNBLiquidity}(
                ...
                0,
                0,
                developmentWallet, // Dev receive additional LP tokens
                block.timestamp
            ); }
        _addingLP = false;
    }
    ...
    function setDevelopmentWallet(address DevelopmentWallet) external onlyOwner { // Owner can set new Dev Fee receiver
        require(developmentWallet != DevelopmentWallet,"This address is already DevelopmentWallet");
        address oldWallet = developmentWallet;
        developmentWallet = DevelopmentWallet;
        emit SetDevelopmentWallet(oldWallet, DevelopmentWallet);
    }
