...
contract YaShibLe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Ya Shib Le";
    string private _symbol = "YSL";
    uint8 private _decimals = 0;

    uint256 _totalSupply = 1000000 * 10**12 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xbFcae4E5ED000610258B6e4Ed6bfC7A771635826; 
