...
TELEGRAM : https://t.me/gloriousnetwork
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9793d372494844284001b0b48450cb1Ed3806990; // owner address
...
contract GNT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Glorious Network";
    string private _symbol = "GNT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF859dF0bc8ee8755D8c2596685366Ed58Ab56E29); // Marketing Address
    address payable public teamWalletAddress = payable(0x9793d372494844284001b0b48450cb1Ed3806990); // Team Address
