...
contract ChromeInu is IBEP20, Ownable {
    ...
    string constant _name = "Chrome Inu";
    string constant _symbol = unicode"WEBINU";
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(4, 4, 2, 0);
    Fees public sellFees    = Fees(4, 4, 0, 0);
