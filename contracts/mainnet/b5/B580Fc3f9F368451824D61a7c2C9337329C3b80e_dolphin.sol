...
contract dolphin is Context, IERC20, Ownable {
    ...
    string private _name = "Dolphin whales";
    string private _symbol = "SEA";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xEa2618023b51cE39656052343E0667bb4C608D5c); 
    address payable public marketingAddress2 = payable(0xB3b76b10f7624fc7FBe8db82ae0999C8aA7970c5); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xe41f45361ff5011f1284228404cc47938bDE8981);
