...
contract Shiba14 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Shiba14";

    string private _symbol = "$S14";

    uint8 private _decimals = 9;

    address public feeAddress = 0xA996F4C25AcD6b9D14a056b14e47177B25d12881;
