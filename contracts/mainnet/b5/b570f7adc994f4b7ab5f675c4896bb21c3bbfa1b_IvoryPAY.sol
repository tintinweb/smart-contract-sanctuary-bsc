...
contract IvoryPAY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "IvoryPAY";
    //change the token symbol
    string constant _symbol = "IvYPAY";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xfbeEDbad7d6Fb773Cfb358BA1bdfA0C55Ad9E17F;
