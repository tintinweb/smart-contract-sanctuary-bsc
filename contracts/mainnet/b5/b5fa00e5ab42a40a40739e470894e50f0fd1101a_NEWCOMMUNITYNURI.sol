...
contract NEWCOMMUNITYNURI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x56faBB7b9ff1E6000E3e3f1FAcDC613D148F543e);
    address payable public Wallet_Dev = payable(0x6b0E8890adfde4310F8cDddFD1f17c7aC2725070);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "NEW COMMUNITY NURI"; 
    string private constant _symbol = unicode"NCNURI";
