...
/**
     BSC is now dead. As well as the crypto market. 
     Everything dies, the bsc dies. Avax dies, Solana dies, my savings are all in crypto and there is no way out. 
     It is not possible that the market has emptied itself in this way. 
     All billionaires continue to become more billionaires and poor people continue to starve. 
     We're back to 2017. BTC falls and everything else behind it follows. 
     How beautiful were the projects of the past. Doge X, SLAM, Vetter, DogeCola, DKYC, DogeBull, BabyCake, BabyDogeCoin. 
     Will the old days ever return?
     Jeets, jeets everywhere
     
     I hope so.
     Telegram: https://t.me/bscpleasecomeback
*/
...
contract PLEASE is IBEP20, Auth {
    ...
    string constant _name = "BSC is now dead. As well as the crypto market. Everything dies, the bsc dies. Avax dies, Solana dies, my savings are all in crypto and there is no way out.  It is not possible that the market has emptied itself in this way. All billionaires continue to become more billionaires and poor people continue to starve. We're back to 2017. BTC falls and everything else behind it follows.  How beautiful were the projects of the past. Doge X, SLAM, Vetter, DogeCola, DKYC, DogeBull, BabyCake, BabyDogeCoin. Will the old days ever return? I hope so.";
    ...
    address public marketingFeeReceiver = 0x289dcCAf50a77756900b92Cec834086199d7Ee89;
