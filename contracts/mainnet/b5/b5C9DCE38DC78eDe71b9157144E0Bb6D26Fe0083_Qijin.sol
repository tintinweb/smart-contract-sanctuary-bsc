...
contract Qijin is Ownable, IERC20 {
    ...
    string public _name = "Qijin";
    string public _symbol = "Qijin";
    ...
    uint256 public _totalSupply = 9600 * 10 ** _decimals;
    uint256 public _maxTxAmount = 9600 * 10 ** _decimals;
    uint256 public _maxWallet =   9600 * 10 ** _decimals;
