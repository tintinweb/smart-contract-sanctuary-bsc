...
/**
🤡 APERIL SAFU COIN🤡
Aperil Safu Coin is a Community-owned, 100% safe crypto project deployed on Binance Smart Chain (BSC). Our contract is fully lock and renounced.

✅Stealth Launch 1 April 2022
✅Ownership Renounced 
✅No Team and Dev wallet
✅Lock 7 days,(LP WILL BE BURN UPON UNLOCKED IF COMMUNITY STRONG)

Telegram Chat: https://t.me/+XSDqRtOIvSc5OTQ1
*/
...
contract aperilfool is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 40_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "APERIL SAFU COIN"; //
    string private constant _symbol = " A$C"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x9C9b5E235d75114D76Ca085b513e4C64cBF3c27B ;
