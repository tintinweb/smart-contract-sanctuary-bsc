...
/*        Wednesday Token
    ...
    Telegram : https://t.me/wednesdaytoken
    
    Website: http://wednesday.org/
...
contract Wednesday is ERC20, Ownable {
    ...
    event UpdateBuyFees(uint256 liquidityFeeOnBuy, uint256 marketingFeeOnBuy, uint256 buybackFeeOnBuy);
    event UpdateSellFees(uint256 liquidityFeeOnSell, uint256 marketingFeeOnSell, uint256 buybackFeeOnSell);
    event SwapAndLiquify(uint256 tokensSwapped,uint256 bnbReceived,uint256 tokensIntoLiqudity);
    event SwapAndSendMarketing(uint256 tokensSwapped, uint256 bnbSend);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("Wednesday Token", "WEDNESDAY") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xd0efa670874B14dDb0ecc6e740A2328760839012;
        ...
        maxWalletAmount = totalSupply() * 10 / 100000; // 1%
    }
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _buybackFeeOnBuy) external onlyOwner {
        ...
        emit UpdateBuyFees(liquidityFeeOnBuy, marketingFeeOnBuy, buybackFeeOnBuy);
    }
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _buybackFeeOnSell) external onlyOwner {
        ...
        emit UpdateSellFees(liquidityFeeOnSell, marketingFeeOnSell, buybackFeeOnSell);
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (buybackShare > 0) {
                uint256 buybackTokens = contractTokenBalance * buybackShare / totalFee;
                swapBuyBack(buybackTokens);
            }               
    ...
    function swapBuyBack(uint256 tokenAmount) private{
