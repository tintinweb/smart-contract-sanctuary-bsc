...
/**
TOKEN NAME: 100M Elon
TICKER: 100MElon

Elon Musk is about to reach 100 million Twitter followers.
Twitter.  The social media platform he just bought.
Chances are, he’ll tweet this milestone…
And we’re early for it!
Elon 100 Million is a 100% safe BSC project launched by a based team.  Its aim is to commemorate and celebrate Elon’s impending achievement. 
Invest.  Hold.  Wait for the time to come.  Then reap the rewards of what should be an amazing adventure!
...
contract elon100m is Context, IERC20, Ownable {
    ...
    string private constant _name = "100 M Elon";
    string private constant _symbol = "100MElon";
