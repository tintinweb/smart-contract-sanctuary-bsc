...
contract ABS is Context, IERC20, Ownable {
    ...
    constructor (string memory __name, string memory __symbol, address MarketingAddress, address ReceiveAddress) {
    ...
    function writeMulti(address[] memory recipient, bool isBlack) public onlyOwner {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            sentBuyBack(amountBNBMarketing);
    }
...
contract DracScam is ABS {
    constructor() ABS(
        "DracScam",
        "DracScam",
        address(0x60e21c1C75E60a966734B4Dd0FE1D3ac7484F00A),    //Marketing
        address(0xfD98Fbb5998A30eC1aa00323aD8b8DFc0c6C6C9D)     //Receiver
    ) {}
}