...
/**
 *The Northman-Inu is coming to take Vengeance on the Bears & Conquer the Crypto Market and become the #1 Community token! Join Us... Skol!!
 * 
 */
...
contract Northman is Context, IERC20, Ownable {
    ...
    string private _name = "Northman";
    string private _symbol = "Northman";
