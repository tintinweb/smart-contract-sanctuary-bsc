...
contract FITI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 60000000000 * 10**18; // 60 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Fiticoin";
    string private constant _symbol = "FITI";
    uint8 private constant _decimals = 18;

    uint256 public _taxFee = 2; // 2 -> 0.2% or 20 means 2%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 2; // 2 -> 0.2% or 20 means 2%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _charityFee = 2;  // 2 -> 0.2% or 20 means 2%
    uint256 private _previousCharityFee = _charityFee;

    uint256 public _teamFee = 2; // 2 -> 0.2% or 20 means 2%
    ...
    uint256 public _maxTxAmount = 50000000 * 10**18; // 50M
