...
contract PresaleGenerator is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0x9c215c9Ab78b544345047b9aB604c9c9AC391100);
        PRESALE_SETTINGS = IPresaleSettings(0x0331d999d5D2Ec4f04A2dD0E55855C98C655dd7a);
    }
...
contract Presale is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0x0331d999d5D2Ec4f04A2dD0E55855C98C655dd7a);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0xF84BD9d391c9d4874032809BE3Fd121103de5F60);
