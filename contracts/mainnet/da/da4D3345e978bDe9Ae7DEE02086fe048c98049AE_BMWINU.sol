...
telegram : https://t.me/bmwinuoficial
TWITTER : https://twitter.com/bmwinu
*/
...
contract BMWINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaE8e6B318d83a3Db48F533dcFA2ECdcB050c749c); 
    address payable public Wallet_Dev = payable(0xaE8e6B318d83a3Db48F533dcFA2ECdcB050c749c);
    address payable public constant Wallet_Burn = payable(0xaE8e6B318d83a3Db48F533dcFA2ECdcB050c749c); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "BMW INU OFICIAL"; 
    string private constant _symbol = unicode"BMW"; 
    ...
    constructor () {
        ...
        _owner = 0xaE8e6B318d83a3Db48F533dcFA2ECdcB050c749c;
