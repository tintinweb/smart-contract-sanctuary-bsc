...
contract THEPROTOCOLBSC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500_000 * 10**9;
    uint256 public _maxTxAmount = 1_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000_000 * 10**9; 
    string private constant _name = "The protocol bsc";
    string private constant _symbol = "TPBSC"; 
