...
contract CBridgeFacet is IMiraidon, ReentrancyGuard, SwapperV2, Validatable {
    /// Storage ///
    ...
    /**
     *  @notice Not used now. Performs a swap before bridging via CBridge
     *  @param _bridgeData the core information needed for bridging
    ...
    /**
     *  @notice logic for the bridge via CBridge
     *  @param _bridgeData the core information needed for bridging
     *  @param _cBridgeData data specific to CBridge
     */
    function _startBridge(
        ...
        require(
            uint64(block.chainid) != _bridgeData.destinationChainId,
            GenericErrors.E02
        );
...
abstract contract ReentrancyGuard {
    ...
    bytes32 private constant NAMESPACE =
        keccak256("com.miraidon.reentrancyguard");
...
contract SwapperV2 is IMiraidon {
    /// Types ///
    ...
    function _depositAndSwap(
        ...
        require(numSwaps != 0, GenericErrors.E04);
        ...
        require(newBalance >= _minAmount, GenericErrors.E31);
...
interface ICBridge {
     ...
     * @param _nonce It's not account nonce.A number to gurantee unique for this transfering.
     * @param _maxSlippage The maximum number of slipages can accepted,
     *                     given as percentage in point(2000 means 0.2%)
     *
     */
    function send(
        address _receiver,
    ...
    /**
     *  send a transfer of the mainnet native token
     *
     * @param _receiver receiver address
     * @param _amount transfer amount
     * @param _dstChainId destination chain ID
