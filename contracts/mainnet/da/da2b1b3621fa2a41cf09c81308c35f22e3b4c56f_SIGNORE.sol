...
contract SIGNORE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SIGNORE";
    string constant _symbol = "SIGNORE";
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 3000000}("");
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 3000000}("");
