...
Telegram https://t.me/norrachain
website https://norrachain.com
...
contract NorraChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Norra Chain";
    string private _symbol = "NRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10b04a46CA77EA37Ac0e1Aa494ea43Fc46f40894); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7F559dB9d4B3FAa941F811d966F65EfEa942bf81); // BuyBack Address
    ...
    uint256 public _BuyBackShare = 8;
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**1 * 10**9; 
