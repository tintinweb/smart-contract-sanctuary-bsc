...
contract ReflectingContract {
    function reflectToOwners(uint256 bnb) payable public {
    }
}
...
address payable modAddress;
    ...
    ReflectingContract public reflectingContract = ReflectingContract(0xf262Dc22ca5B2f1F4Ba5FefA6453Ff1c030A99b2);
...
function bet(uint256 _betChoice) public payable betConditions nonReentrant {
    ...
    reflectingContract.reflectToOwners(nftAmount);
}
