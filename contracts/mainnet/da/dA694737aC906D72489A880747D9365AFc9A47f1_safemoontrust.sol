...
contract safemoontrust is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon Trust";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 50, "Buy fee can't go higher than 50");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 50, "Sell fee can't go higher than 50");
