...
contract OSCNFT is ERC721URIStorage{

  uint public counter;
  address private _owner;

  constructor() ERC721("OSC-NFT", "OSCNFT"){
    counter = 10000;
    _owner = msg.sender;
  }
  ...
  function createNFTs (string memory tokenURI) public onlyOwner returns(uint) {
   ...
   function createListNFTs (uint256 number,address _address,string memory tokenURI) public onlyOwner{
