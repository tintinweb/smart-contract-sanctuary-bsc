...
contract RedZhaogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RedZhaogeInu"; 
    string private _symbol = "RZINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01908F382f1cC77BaB7cd5dDFf399A0f3537c982
);
    address payable public teamWalletAddress = payable(0x01908F382f1cC77BaB7cd5dDFf399A0f3537c982
);
