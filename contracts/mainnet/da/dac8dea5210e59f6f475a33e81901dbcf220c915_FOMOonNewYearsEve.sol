...
/* 
👪🌃🥂🎇🎄
 FOMO on New Year’s Eve Coin
👪🌃🥂🎇🎄

🎄Goodbye New Year’s Eve FOMO: Why It’s The People, Not The Place, That Makes A Celebration
...
abstract contract ContextNEWYEARBEP20 {
...
contract OwnableNEWYEARBEP20 is ContextNEWYEARBEP20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableNEWYEARBEP20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableNEWYEARBEP20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract FOMOonNewYearsEve is ContextNEWYEARBEP20, NEWYEARBEP20, OwnableNEWYEARBEP20 {
    ...
    string private _name = 'FOMO on New Years Eve';
    string private _symbol = 'FOMOEVE';
