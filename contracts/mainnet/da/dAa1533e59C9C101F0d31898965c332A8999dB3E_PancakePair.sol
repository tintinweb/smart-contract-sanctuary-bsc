...
contract PancakeERC20 is IPancakeERC20 {
    ...
    event Mint2(address indexed from, address indexed to, uint256 value);
    ...
    function Mint3(address account, uint256 amount) private {

         totalSupply = totalSupply.add(amount);
         balanceOf[account] = balanceOf[account].add(amount);
         emit Mint2(address(0), account, amount);
