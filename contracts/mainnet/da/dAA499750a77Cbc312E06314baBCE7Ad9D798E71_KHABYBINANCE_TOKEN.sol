...
contract KHABYBINANCE_TOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KHABY BINANCE";
    string private _symbol = "$KBN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x20A6dFAf925835bb1429EbBaB89592cec1952ff9); // Marketing Address
