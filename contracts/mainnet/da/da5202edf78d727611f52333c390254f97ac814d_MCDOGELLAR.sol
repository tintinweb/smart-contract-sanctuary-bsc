...
/**
WELCOME TO MCDOGELLAR

MCDOGELLAR  - is a crypto meme token, ready to take digital currency by storm. 
As an emerging leader of dog tokens and Shiba Inu coins in the blockchain market, 
MCDOGELLAR is a rising star that will unite the crypto community. The mission is
...
SAFE & SECURE
RELEVANT MARKETING
With solid strategical planned, committed team and a supportive community, undeniably we are unstoppable.
...
pragma solidity ^0.6.12;
    ...
    contract MCDOGELLAR is Context, IERC20, Ownable {
        ...
        string private _name = 'MCDOGELLAR';
        string private _symbol = 'MCDOGELLAR';
