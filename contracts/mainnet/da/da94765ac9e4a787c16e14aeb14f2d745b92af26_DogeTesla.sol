...
contract DogeTesla is Context, IERC20, Ownable {
    ...
    string private constant _name = " Doge Tesla "; // 
    string private constant _symbol = " $DOGELA "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x50F64bE9CDeBD1684cb95EDd4bbFdbfB4ff6564b;
