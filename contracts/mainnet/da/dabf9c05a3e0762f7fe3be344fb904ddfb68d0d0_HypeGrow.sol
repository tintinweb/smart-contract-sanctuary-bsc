...
contract HypeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HypeGrow";
    string private _symbol = "HypeGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3BF4A4f13567478A8b5F9F7A8A2eC68BfFD2C63d);
    address payable public BuyBackWalletAddress = payable(0x3BF4A4f13567478A8b5F9F7A8A2eC68BfFD2C63d);
    ...
    uint256 private minimumTokensBeforeSwap = 1500000000 * 10**9;
