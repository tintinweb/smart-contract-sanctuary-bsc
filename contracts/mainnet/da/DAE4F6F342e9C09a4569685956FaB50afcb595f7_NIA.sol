...
contract NIA is Context, IERC20, Ownable {
    ...
    string private _name     = "NeuroLatin IA";
    string private _symbol   = "NIA";
    ...
    { 
        ...
        marketingWallet = 0xF98CfE69501c1b20fA19FDcAa31669dF3c4781D5;
        ...
        _isExcludedFromFees[address(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83)] = true;
        _isExcludedFromFees[address(0xF98CfE69501c1b20fA19FDcAa31669dF3c4781D5)] = true; //pinklock

        _isExcluded[address(this)] = true;
        _isExcluded[address(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83)] = true; //pinklock
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83)] = _rTotal;
        _tOwned[address(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83)] = _tTotal;

        emit Transfer(address(0), address(0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83), _tTotal);
    }
