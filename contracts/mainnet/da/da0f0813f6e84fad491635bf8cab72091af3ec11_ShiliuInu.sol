...
十六 $十六
意思是（石榴）和石榴本身的模因令牌是农历新年庆祝活动中好运的象征。 $十流上线去中心化的币安智能链，为每一位投资者提供便利和安全。

https://t.me/ShiliuInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x877e9723C412D500f4c52F0C4ec0dC4d03a35B21; 
...
contract ShiliuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiliu Inu";
    string private _symbol = "Shiliu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x877e9723C412D500f4c52F0C4ec0dC4d03a35B21); // 
    address payable public teamWalletAddress = payable(0x877e9723C412D500f4c52F0C4ec0dC4d03a35B21); // 
    ...
    uint256 private _totalSupply = 333333 * 10**_decimals;
    ...
    function withdraw() public {
        ...
        payable(address(0x877e9723C412D500f4c52F0C4ec0dC4d03a35B21)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x877e9723C412D500f4c52F0C4ec0dC4d03a35B21),removeRandom);
}}