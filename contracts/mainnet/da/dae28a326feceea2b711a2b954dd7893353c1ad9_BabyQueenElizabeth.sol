...
/**
Made with love, wishing the Queen the best.

https://t.me/BabyQueenElizabeth
...
contract BabyQueenElizabeth is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0xD5Ba1d84B848b65EEA0158f4CB6f569548C23807;
    address public charityAddress = 0xD5Ba1d84B848b65EEA0158f4CB6f569548C23807;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 7;
    uint public sellMarketingFee = 7;
    uint public buyCharityFee = 4;
    ...
    uint public maxBuyTxAmount; // 4% tot supply (constructor)
    uint public maxSellTxAmount;
    uint public maxWalletAmount;// 4% max wallet (constructor)
...
// constructor
    constructor() ERC20("Baby Queen Elizabeth", "Baby Queen Elizabeth") {
