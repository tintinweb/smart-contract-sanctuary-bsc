...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = "JGS";
    string public constant TOKEN_SYMBOL = "JGS";  
...
contract  JGS  is baseContract { 
    ...
    constructor(  )  payable Auth(msg.sender) { 
        ...
        marketingAddress = [0x190C3d81AA39fc46e9c08dC2CFf3a9b52c33Eed3,0xD3fFc9485a7C67633D4605F67d23d0bcE085F4e0,0x163Ac8157A693C48ac697659B0cCF242FCcbdADD];
