...
/**
        ...
        tg      : https://t.me/HappySquidInu

        ✅ Stealth Launch
        ✅ Squid Hype
        ✅ MOONSHOT GEM x100000
        ✅ SAFU Project
        ✅ Based Dev
        ✅ Low Tax 2%
        ✅ LP Lock
...
contract HappySquidInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xab6A75E0331eC092B126D0304DdAa4B58559D096;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xab6A75E0331eC092B126D0304DdAa4B58559D096] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xab6A75E0331eC092B126D0304DdAa4B58559D096] = true;
