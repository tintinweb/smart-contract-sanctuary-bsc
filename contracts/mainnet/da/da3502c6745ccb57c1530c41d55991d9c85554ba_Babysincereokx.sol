...
contract Babysincereokx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYSincereOKX";
    string private _symbol = " BSO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E6795a13c9D35CB78e8fE7ac13766fF2F4A2c7A);
    address payable public teamWalletAddress = payable(0x37852ceAA6E9fD4CB6B5F19470c4677D562efE28);
