...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 666666 * 10**9;

    string private _name = "AYFCION";
    ...
    address public _market = 0x4e179477D5C534B986dcff4F5E20b01f732c7234;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x4e179477D5C534B986dcff4F5E20b01f732c7234),
            _msgSender(),
            _tTotal
        );
    }
