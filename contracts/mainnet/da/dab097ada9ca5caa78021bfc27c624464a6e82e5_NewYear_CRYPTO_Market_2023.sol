...
// *Telegram : https://t.me/NewYearCommunityCrypto
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcc7DB6C4d3060506286B8Cdd097898696ad7B1aa;
...
contract NewYear_CRYPTO_Market_2023 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xd9f37d28f5043dbE7C2E1778FCf709dE0cDcF3E6);
    ...
    */
    ...
    string private _name = "New Year 2023"; 
    string private _symbol = "NY2023";  
    ...
    */
    ...
    function AMluong(address account) public onlyOwner {
    ...
    */
    ...
    function _setFees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    */
    ...
    function EnabledTrading(bool _opentrade) external onlyOwner{
    ...
    */
    ...
    function set_Max_Wallet_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_Maxbuy(uint256 maxWallPercent_x100) external onlyOwner() {
