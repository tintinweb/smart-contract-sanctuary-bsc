...
Join us on private TG : https://t.me/+QPUd-6jp8sdiN2M8

We will soon announce the launch . Stay SAFU
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69d380B7f49F035E1edCC76835FA10bD0052Fb9F; // owner address
...
contract SnoopDoge1969 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SnoopDoge1969";
    string private _symbol = "$SD69";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x69d380B7f49F035E1edCC76835FA10bD0052Fb9F); // Marketing Address
    address payable public teamWalletAddress = payable(0x69d380B7f49F035E1edCC76835FA10bD0052Fb9F); // Team Address
