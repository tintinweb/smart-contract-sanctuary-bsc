...
contract LegendaryElonsGate is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Legendary Elon's Gate";
    string private _symbol = "LEG";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0x7DCdAB72Ed48A9d5Eb0E7aEE8160850a6C45ef1a); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7DCdAB72Ed48A9d5Eb0E7aEE8160850a6C45ef1a); // BuyBack Address
