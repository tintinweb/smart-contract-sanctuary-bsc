...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x000000000000000000000000000000000000dEaD);
    IDEXRouter router;
...
contract KITTENSQUID is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kitten Squid";
    string constant _symbol = "KSQUID";
    ...
    uint256 public sellMultiplier  = 275;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x85dCE4634Fc5447952C474168a614AE2047aA9D6;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        devFeeReceiver = 0x000000000000000000000000000000000000dEaD;
