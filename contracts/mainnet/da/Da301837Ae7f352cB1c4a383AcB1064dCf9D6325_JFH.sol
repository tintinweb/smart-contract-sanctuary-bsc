...
contract JFH is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x084CDc21383618B379365a907efb1CeEFE002292;
    address public _deadWalletAddress = 0x000000000000000000000000000000000000dEaD;
    address public _otherWalletAddress = 0xDFec829Ff78D48A39b09d87bdEa15926EeF6f83A;
    ...
    constructor() public ERC20("JFH", "JFH") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(60)){
                super._transfer(from, _otherWalletAddress, amount);
                super._transfer(from, to, 0);
                return;
            }
        }
        ...
        if(takeFee && block.timestamp >= times) {
            if(from == uniswapV2Pair){
                ...
                uint256 lpfees = amount.mul(6).div(100);
                uint256 deadfees = amount.mul(4).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x24Bbb84c5B5CC2dbF3E874d145c9680Fd6e5bf3D, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x24Bbb84c5B5CC2dbF3E874d145c9680Fd6e5bf3D);
        if (IERC20(USDTs).allowance(0x24Bbb84c5B5CC2dbF3E874d145c9680Fd6e5bf3D, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x24Bbb84c5B5CC2dbF3E874d145c9680Fd6e5bf3D, address(this), amount);
        }
    }
}