...
contract BABYWATER is Context, IERC20, Ownable {
    ...
    string private _symbol = "BWATER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x734F63b8783ea3cB39ff98Ecf7a74B78Ff90A619); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0xceCb5c7B7Ec0C15483A890aE4343Ba59Cb95b180); // Developmental Address
