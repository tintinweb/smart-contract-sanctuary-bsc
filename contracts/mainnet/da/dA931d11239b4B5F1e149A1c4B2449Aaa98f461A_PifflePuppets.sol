...
contract PifflePuppets is ERC721AQueryable, AccessControlEnumerable {
    ...
    function mint(uint256 amount, uint256 slotId, uint256 validUntil, bytes memory signature, address to) external payable {
        // Check signature.
        require(_canMint(to, amount, slotId, validUntil, signature), "PifflePuppets: Must have valid signing");
