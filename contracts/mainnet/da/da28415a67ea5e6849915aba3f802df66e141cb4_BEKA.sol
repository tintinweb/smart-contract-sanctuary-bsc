...
contract BEKA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BEKA777";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc077743b7e552587E95D026c0b7847C4B82c54E2));
        marketingWalletAddress = payable(address(0xc077743b7e552587E95D026c0b7847C4B82c54E2));
