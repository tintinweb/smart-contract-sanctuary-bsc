...
contract BeeUSDGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BEEUSDGROW";
    string private _symbol = "$BEEGROW";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x91EB4c5ACB25c6134A57483d4b40F10B2D801D86); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x558C04711EC8cC807Ff83200A7b928718c67cfD3); // Team Address
