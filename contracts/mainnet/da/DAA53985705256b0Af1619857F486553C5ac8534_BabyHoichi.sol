...
contract BabyHoichi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Hoichi";
    string private constant _symbol = unicode"BABY芳";
