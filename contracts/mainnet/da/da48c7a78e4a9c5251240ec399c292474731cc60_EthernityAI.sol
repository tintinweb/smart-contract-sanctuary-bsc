...
abstract contract Contextbep20EthernityAI {
...
contract Ownablebep20EthernityAI is Contextbep20EthernityAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20EthernityAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20EthernityAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract EthernityAI  is Contextbep20EthernityAI, bep20EthernityAI, Ownablebep20EthernityAI {
