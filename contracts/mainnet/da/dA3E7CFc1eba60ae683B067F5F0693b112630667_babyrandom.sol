...
contract babyrandom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyRamadan";
    string private _symbol = "BabyRamadan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97AD6904C3D82ddE04326e73976cC4aB7e83a249);
