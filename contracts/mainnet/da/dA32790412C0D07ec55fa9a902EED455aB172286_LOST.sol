...
contract LOST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOST TOKEN";
    string private _symbol = "LOST";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address constant public _invitation = 0x776c6Cb05453E5502966C95d255787F05F340090;
    address public idoAddress = 0xe86442B331554A13141bC7A7276fD493a75Db19A; // ido Address
    address payable public marketingWalletAddress = payable(0xE950Cea99f7D651aEe606188a7F4A2342a58eA35); // Marketing Address
    address payable public teamWalletAddress = payable(0x1d09241160A54daf8915B967DEE45CE0C90e247e); // Team Address
    ...
    uint256 private _totalSupply = 50000000000 * 10**_decimals; // 1000000000000000
    uint256 public _maxTxAmount = 50000000000 * 10**_decimals; 
    uint256 public _walletMax = 50000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 5000000000 * 5 **_decimals; 
    ...
    constructor () {
        ...
        isExcludedFromFee[idoAddress] = true;
        ...
        isWalletLimitExempt[idoAddress] = true;

        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[idoAddress] = true;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint userAmount = amount.mul(_buyLiquidityFee).div(100);
        
        if(feeAmount > 0) {
            _balances[address(this)] = _balances[address(this)].add(feeAmount).add(userAmount);
            emit Transfer(sender, address(this), feeAmount);
            emit Transfer(sender, inviter, userAmount);

        }

        return amount.sub(feeAmount).sub(userAmount);
    }
