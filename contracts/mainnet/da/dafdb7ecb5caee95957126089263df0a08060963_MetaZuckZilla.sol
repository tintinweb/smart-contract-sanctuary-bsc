...
contract ZuckDividendDistributor is IDividendDistributor {
    ...
    // BSC Polkadot-PEG  
    IERC20 REWARD = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); 
...
contract MetaZuckZilla is ERC20, Ownable {
    ...
    constructor() ERC20("PHONEBOOTH", "$PHONE") {
    	...
    	marketingAddress = address(0xE5140f82b61641BCb813fd670037Ac9025A2Ac13);
