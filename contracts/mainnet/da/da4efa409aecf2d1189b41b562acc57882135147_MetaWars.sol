...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x736Cec0B31C5A1ff37b42A4fF2d43b12EA00f371; // owner address
...
contract MetaWars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaWars";
    string private _symbol = "MWR"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7687235977d1464e6335efA05d0e676f1CA5321); // Marketing Address
    address payable public teamWalletAddress = payable(0x8bd5E0BcAC4614b8014Ef4cdABA9174d69419d84); // Team Address
