...
// Telegram chat: https://t.me/Grimace2point0
...
contract GRIMACETWO is IBEP20, Auth {
    ...
    string constant private _name = "Grimance 2.0";
    string constant private _symbol = "GRIMACETWO";
    ...
    function checkTxLimitEx(address sender, uint256 amount) internal view {
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function Cooldown(bool _status, uint8 _interval) public authorized {
