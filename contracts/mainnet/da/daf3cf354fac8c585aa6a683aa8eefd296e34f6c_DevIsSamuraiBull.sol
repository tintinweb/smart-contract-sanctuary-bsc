...
/**
   #DevSBULL The New Community of Ape Token
    
   I make this #DevSBULL to hand it over to the community.
   I suggest a Telegram group name for you to create: Dev Is Samurai Bull is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/DevisSamuraiBull
...
I will lock the pool for 365 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..

   Can we make #DevSBULL 1000X ?
*/
...
contract DevIsSamuraiBull is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dev Is Samurai Bull";
    string private constant _symbol = "DevSBULL";
    ...
    address private marketingWallet = address(0x152e68c2f435f6b22F6E2855e4F8bb1E692f41Db);
