...
contract PounderProtocol is ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardYield = 3615000;
    uint256 public rewardYieldDenominator = 10000000000;

    uint256 public rebaseFrequency = 1800;
    uint256 public nextRebase = 1651433400;
    ...
    0x1ccCE182F4B5d1e57FF09eFEC2cEcb3f84a81E50;
    address public treasuryReceiver =
    0x20B13196C789BC90442119c3578D59daeB81Ae38;
    address public insuranceFundsReceiver =
    0x2A37b4a4AA001B7D951cbb53c3F310eEB375b111;
    
    address constant public usdtToken = 0x55d398326f99059fF775485246999027B3197955; //mainnet
    ...
    uint256 public buyFeeIF = 3;
    uint256 public sellFeeTreasuryAdded = 5;
    uint256 public totalBuyFee = liquidityFee.add(treasuryFee).add(buyFeeIF);
    ...
    constructor() ERC20Detailed("PounderProtocol", "POUND", uint8(DECIMALS))
    {
        ...
        _isFeeExempt[insuranceFundsReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        if (amountToRFV > 0) {
            _swapTokensForBNB(amountToRFV, insuranceFundsReceiver);
        }
    ...
    function setFeeReceivers(
        ...
        address _insuranceFundsReceiver
    ) external onlyOwner {
        liquidityReceiver = _liquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        insuranceFundsReceiver = _insuranceFundsReceiver;
        emit SetFeeReceivers(_liquidityReceiver, _treasuryReceiver, _insuranceFundsReceiver);
    }

    function setFees(
        uint256 _liquidityFee,
        uint256 _insuranceFunds,
        ...
        buyFeeIF = _insuranceFunds;
        treasuryFee = _treasuryFee;
        sellFeeTreasuryAdded = _sellFeeTreasuryAdded;
        totalBuyFee = liquidityFee.add(treasuryFee).add(buyFeeIF);
        ...
        emit SetFees(_liquidityFee, _insuranceFunds, _treasuryFee, _sellFeeTreasuryAdded, _feeDenominator);
    }
