...
contract TestToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0x6af0b8C21f7ef76a5B76525560418334cBDB1b54; // Marketing Address
	address payable public burningAddress = 0x0000000000000000000000000000000000000000; // burn Address
	address payable public devAddress = 0x6af0b8C21f7ef76a5B76525560418334cBDB1b54; // Dev Address
