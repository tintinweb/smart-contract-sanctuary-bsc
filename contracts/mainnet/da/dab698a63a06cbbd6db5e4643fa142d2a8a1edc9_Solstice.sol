...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0xfA54fF1a158B5189Ebba6ae130CEd6bbd3aEA76e);
...
contract Solstice is IERC20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "Solstice";
    string public constant _symbol = "SOLS";
    uint8 public constant _decimals = 18;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public RewardToken = 0xfA54fF1a158B5189Ebba6ae130CEd6bbd3aEA76e;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x76B1f1EE7750d3e55014573E08873bBBA3e89d05; 
    ...
    function removeShareholder(address holder) internal  {
        isDividendExempt[holder] = true;
        dividendDistributor.setShare(holder, 0);
        emit dividendExemptStatusChanged(holder, true);
    }
    ...
    function changeBlacklistDivs(address[] calldata addresses, bool status) public onlyOwner {
        require(canUseBlacklist, "");
        for (uint256 i; i < addresses.length; ++i) {
            isBlacklisted[addresses[i]] = status;
            changeDividends(addresses[i], status);
        }
    }

    function changeDividends(address holder, bool exempt) internal {
