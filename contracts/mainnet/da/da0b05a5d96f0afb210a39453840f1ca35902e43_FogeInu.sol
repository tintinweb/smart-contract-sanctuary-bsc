...
contract FogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FogeInu";
    string private _symbol = "FogeInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb93E0C54d2cC6479597f8CB7eC84873fe95e411D); // Marketing Address
    address payable public teamWalletAddress = payable(0x56d258F68313Ede9a0180dc2fA7A1EA780723230); // Team Address
