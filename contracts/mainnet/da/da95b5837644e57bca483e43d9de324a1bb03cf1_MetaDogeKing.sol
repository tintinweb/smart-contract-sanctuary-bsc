...
contract MetaDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaDogeKing";
    string private _symbol = "MDK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x235Cf7739646B47690f2f2D26f7684A0931c73B7); // Marketing Address
    address payable public teamWalletAddress = payable(0x98515A33aBFC3f7c34E3C75f7d88a32D92Ae8E0f); // Team Address
    ...
    uint256 public _maxTxAmount = 21 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 21 * 10**6 * 10**_decimals;
