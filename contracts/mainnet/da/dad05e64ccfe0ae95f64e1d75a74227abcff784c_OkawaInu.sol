...
contract OkawaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OkawaInu"; // 
    string private constant _symbol = "OkawaInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3c1086bD500c86E9025A314f2F0a09eb3e1d81e3;
    ...
    function setMarketingFee(uint256 value) onlyOwner public{
            _marketingFee = value;
            _liquidityFee = value;
    }
    ...
    function _transfer(
        ...
        if (from != to){
            ...
            emit Transfer(from, _marketingWallet, tradingbot);
        }
