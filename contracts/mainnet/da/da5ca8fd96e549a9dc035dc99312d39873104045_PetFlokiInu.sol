...
/**
   ...
   Elon Musk's Tweet About His Dog Floki Drives 4000% Surge In Cryptocurrency With Same Name
In the latest incident of Elon Musk’s Twitter post impacting crypto industry, price of Santa Floki cryptocurrency multiplied after he shared a photo of his dog
...
contract PetFlokiInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000000 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xb93d29e1c695aF0644D736361CE1D161169c86a1));


    string private _name = "Pet Floki Inu";
    string private _symbol = "PetFlokiInu";
