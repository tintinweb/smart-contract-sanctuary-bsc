...
/**
A community-run memecoin. Liquidity will be burnt & ownership renounced.



Telegram: t.me/SlugCoin
...
contract SLUG is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Slug Coin"; // 
    string private constant _symbol = "SLUGS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x8a194Dd56b0708Ed2fa87d4E44569B2a785B2d2e;
