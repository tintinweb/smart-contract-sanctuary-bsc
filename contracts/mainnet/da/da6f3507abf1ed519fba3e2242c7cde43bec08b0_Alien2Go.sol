...
// CHANGE
contract Alien2Go is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Alien2Go";
    string constant _symbol = "A2GO";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xDBdf2bC63759b208B6243462107DDc4D9c01bcaf);
