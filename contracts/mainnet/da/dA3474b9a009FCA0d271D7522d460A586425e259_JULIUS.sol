...
contract JULIUS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "JULIUS CAESAR";
    string constant _symbol = "J.CAESAR";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x79b76fFe0eFBa032A350A43F32eFfC87b5ade283;
