...
// .....
// mini version of asixtoken.com
// telegram : https://t.me/MiniAsixToken
// -
// -
// -
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ASIX = IBEP20(0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ASIX.balanceOf(address(this));
        ...
        uint256 amount = ASIX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ASIX.transfer(shareholder, amount);
...
contract MiniAsixToken is IBEP20, Auth {
    using SafeMath for uint256;

    address ASIX = 0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniAsixToken";
    string constant _symbol = "MINI ASIX Token";
