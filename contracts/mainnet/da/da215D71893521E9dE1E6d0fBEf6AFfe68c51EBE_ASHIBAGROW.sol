...
Telegram: https://t.me/ArabianShibaGrow
...
contract ASHIBAGROW is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xdD44F19Aa7ef50E2943401f215616677DebBc7F3;
    address public devAddress = 0x9797bBFA76B11645676D3608d9fA456EDFE4Ce97;

    string private constant _name = "Arabian Shiba Grow";
    string private constant _symbol = "ASHIBAGROW";
    ...
    // Owner cannot transfer out ASHIBAGROW from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out ASHIBAGROW!");
