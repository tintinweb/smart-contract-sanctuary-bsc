...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a BRASIL shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BRASIL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "BRASIL";
    string private constant _symbol = "BRASIL";
    ...
    address payable public marketingWallet = payable(0x2b0F2294eb499c2d5f4e6dB238f96913d606EB56);
    address payable public treasury = payable(0x0629205099e1452695e82c7688a1dDcae9E4b4D3);
    ...
    constructor (    ) Auth(0x55Ef3f25F22cb8AEf07442688245bf605b97F335) {
        address _owner = 0x55Ef3f25F22cb8AEf07442688245bf605b97F335;
