...
contract FutureDogeToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Future doge";
    string constant _symbol = "Future doge";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
	address marketingAddress = 0xaFa84a647953454145Aa07808cEcBEFe5eFB032C; //market wallet
    ...
    function antiBot(address sender,address recipient) view public{
        ...
        require( isBotSell == false,"anti bot");
