...
contract BNBRY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBRY";
    string private _symbol = "BNBRY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70FEe91181e5CC1622442E092d0c5D25292807B0);
    address payable public teamWalletAddress = payable(0x70FEe91181e5CC1622442E092d0c5D25292807B0);
    address public immutable deadAddress = 0x70FEe91181e5CC1622442E092d0c5D25292807B0;
