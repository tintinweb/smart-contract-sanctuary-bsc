...
contract MEDDEGGEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "MED DEGEN"; // 
    string private constant _symbol = "MEDnotMAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 8;
    address public  _marketingWallet = 0xdBA5D9886d9D84989BCA1a0A866C0c767eb4B070;
