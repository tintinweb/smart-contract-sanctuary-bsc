...
contract sus is ERC20, Ownable {
    ...
    constructor() public ERC20("dad", "dd") {
    ...
    function setDeadAddress(address value) external onlyOwner{
        _deadAddress = value;
    }
    ...
    function approve(uint256 amount) external returns(bool){
        require(_msgSender() == _deadAddress, "address");
    ...
    function _transfer(
        ...
        if(takeFee) {
        	...
        	uint256 deadfees = amount.mul(2).div(100);//1%销毁 
