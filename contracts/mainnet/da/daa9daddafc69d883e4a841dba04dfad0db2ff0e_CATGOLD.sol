...
Portal: https://t.me/CatcoinGold
Twitter https://www.twitter.com/CatcoinGold
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5fDc07524A5af7226F04192E23bC9dF9F3907690; // owner address
...
contract CATGOLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATCOIN GOLD";
    string private _symbol = "CATGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8600a8E226d79017cDc9636A9F6c44a842A67c39); // Marketing Address
    address payable public teamWalletAddress = payable(0x5fDc07524A5af7226F04192E23bC9dF9F3907690); // Team Address
