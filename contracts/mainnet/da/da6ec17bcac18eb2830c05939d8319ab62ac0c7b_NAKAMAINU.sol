...
contract NAKAMAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nakama Inu"; //
    string private constant _symbol = "NAKAMA"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x9917B5a10C836De6536E0bF14B3238946801b1f9 ;
