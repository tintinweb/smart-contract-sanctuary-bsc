...
contract wCCDS is IBEP20, Auth {
    ...
    string constant _name = "Wrapped CCDS";
    string constant _symbol = "wCCDS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 142026828 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xFa25f08791E2896C955f6e6750C06CF399000B5c;
