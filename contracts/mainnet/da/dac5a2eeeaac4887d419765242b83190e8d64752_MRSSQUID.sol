...
contract MRSSQUID is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MRS.Squid";
    string constant _symbol = "MRSSQUID";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xaFCF3a6B7Bab3a535eBF136aa966AFbB17A29A2c;
