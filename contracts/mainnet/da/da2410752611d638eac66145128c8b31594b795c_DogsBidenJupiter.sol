...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc1E6F2eACd2d683A7bc3713d8Cb9d1a4FD6b7976;
...
contract DogsBidenJupiter is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x277567fE79aaE8FA97bcb17feF565ed68E897F1f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 7648764000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DogsBiden Jupiter";
    string private _symbol = "DOBI";
    ...
    uint256 public _maxTxAmount = 7648764000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 7648764 * 10**18;
