...
contract seikiroinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Seikiro Inu";
    string private _symbol = "SEIKINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x089BD2704114d2173a1b542317537eA8fd46689e); 
    address payable public teamWalletAddress = payable(0xdE4376FbEf6d2b862CE1a7A3d92B7f804682d99F); 
