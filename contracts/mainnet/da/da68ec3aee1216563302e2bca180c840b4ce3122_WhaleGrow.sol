...
// WhaleGrow is the 1st Grow token on the BSC blockchain that actually Grows the bag of a loyal Holder.
// Telegram : https://t.me/WhaleGrow
// LP - 2 BNB 
// Tax - 3/3 
// Ownership Renounced
// Community Grow
...
interface IERC20 {
    ...
    function walletBalance(address account) external returns (uint256);
...
contract WhaleGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Whale Grow";
    string private constant _symbol = "$WGROW";
    ...
    function walletBalance(address account) public override returns (uint256) {
