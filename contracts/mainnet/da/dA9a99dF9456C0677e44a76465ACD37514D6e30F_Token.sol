...
contract Token is Context, IERC20, Ownable {
    ...
    uint public killblock;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0703a6d09162771c8df0B1B802CFe352594A51dF); 
    address payable public teamWalletAddress = payable(0x0703a6d09162771c8df0B1B802CFe352594A51dF);
    ...
    uint256 public _maxTxAmount = _totalSupply.div(100000000);
    uint256 public _walletMax = _totalSupply.div(100000000);
    ...
    function Launch(bool val, uint256 kb) public onlyOwner {
        isLaunch = val;
        killblock = kb;
    ...
    function setFeeWhiteList(address account, bool newValue) public onlyOwner {
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) external onlyOwner() {//设置税收分配
