...
contract FootballBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Football Billionaire";
    string private _symbol = "FBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE54F39801dDf03f45bB7e134c8ED1250F9855b99); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE54F39801dDf03f45bB7e134c8ED1250F9855b99); // BuyBack Address
    ...
    uint256 public _walletMax = 100 * 10**15 * 10**9;
