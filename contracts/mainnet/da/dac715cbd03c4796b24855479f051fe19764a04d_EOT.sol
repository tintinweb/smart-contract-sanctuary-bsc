...
/*
Egg of Tsuka
EGG OF TSUKA, is a mysterious new token and NFT collection 
launching on uniswap ethereum network, this collecion of 300 NFT’S, 
each with randomly generated combinations of 250+ unique attributes, are sure to captivate and inspire. 
EGG OF TSUKA is more than just an NFT collection – it’s a community-driven project with a 
mission to produce top quality content and support the bionics charity of its choice. The team behind EGG OF 
TSUKA are passionate and reliable, With their ambitious roadmap and Token launching today, you won’t want to miss out on this exciting project!
📊Tokenomics :
🟡Burn 0%
🟡Tax 3% Taxless
🟡Friendly Whales
...
contract EOT is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Egg Of Tsuka';
