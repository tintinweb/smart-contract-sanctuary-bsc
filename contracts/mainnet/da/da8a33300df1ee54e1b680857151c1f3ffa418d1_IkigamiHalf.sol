...
contract IkigamiHalf  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ikigami 0.5";
    string private _symbol = "Ikigami half";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xd47CBA01C084B12a9f1Df44840BA26b6FB79BF6D);
