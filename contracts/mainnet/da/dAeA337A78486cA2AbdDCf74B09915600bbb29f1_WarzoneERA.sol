...
contract WarzoneERA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WarzoneERADividendTracker public dividendTracker;
    ...
    constructor() ERC20("WarzoneERA", "WarzoneERA") {
        marketingWallet = payable(0x29328B2c42C05CF32c1498B85FF2c710194d86CD);
        devWallet = payable(0x29328B2c42C05CF32c1498B85FF2c710194d86CD);
        ...
        dividendTracker = new WarzoneERADividendTracker(
            payable(this),
            router,
...
contract WarzoneERADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WarzoneERA public WarzoneERAContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WarzoneERAContract = WarzoneERA(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WarzoneERA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WarzoneERA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WarzoneERA contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WarzoneERAContract);

            uint256 prevBalance = WarzoneERAContract.balanceOf(address(this));
            ...
            {
                uint256 received = WarzoneERAContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WarzoneERAContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
