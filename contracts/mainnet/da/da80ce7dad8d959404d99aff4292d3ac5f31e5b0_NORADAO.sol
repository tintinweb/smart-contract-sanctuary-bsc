...
Next Level Is Coming; Get Ready.”
...
contract NORADAO is NORADAODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NORADAOTeam;
    address private CharityNORADAO;
    ...
    string public override name = "NORADAO";
    string public override symbol = "NORADAO";
    ...
    constructor(uint totalSupplyValue, address NORADAOTeamAddress, address CharityNORADAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NORADAOTeam = NORADAOTeamAddress;
        CharityNORADAO = CharityNORADAOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NORADAOTeam] =  totalSupply * 4 / 100;
        balances[CharityNORADAO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NORADAOTeam pot
