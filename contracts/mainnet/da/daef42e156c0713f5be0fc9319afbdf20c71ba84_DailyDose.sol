...
-No gays, blacks or girls allowed in the tg.

-Indians will only be permitted to stay if they say "Hello doctor, I'm here for my daily dose" over voice message.

-Anus must be properly lubricated before application.
...
contract DailyDose is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42_069 * 10**9;
    uint256 public _maxTxAmount = 2_500 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "Piccolo Dick"; // 
    string private constant _symbol = "DailyDose"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x01FDc366D2FF3D58EE08D7F6Fd3F7ae0A3660B2e;
