...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ebf83025c8a3f7C9567040cB6c8cCD8526f4e7c; // owner address
...
contract BabyHippo is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABYHIPINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5ebf83025c8a3f7C9567040cB6c8cCD8526f4e7c); // Marketing Address
    address payable public teamWalletAddress = payable(0x5ebf83025c8a3f7C9567040cB6c8cCD8526f4e7c); // Team Address
