...
contract SpaceZhaoZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpaceZhaoZilla";
    string private constant _symbol = "SZZ";
    ...
    address public SpaceZhaoZilla_Marketing = 0x346497304Cad77a05B3a6B33eD08CCC3E28084e6;
    address public SpaceZhaoZilla_Team = 0x346497304Cad77a05B3a6B33eD08CCC3E28084e6;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[SpaceZhaoZilla_Marketing] = true;
        _isExcludedFromFee[SpaceZhaoZilla_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[SpaceZhaoZilla_Marketing] = true;
        allowedTransfer[SpaceZhaoZilla_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(SpaceZhaoZilla_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(SpaceZhaoZilla_Team).sendValue(teamAmt);
        }
    }
    ...
    function SpaceZhaoZilla_UpdateWallet(address newWallet) external onlyOwner{
        SpaceZhaoZilla_Marketing = newWallet;
    }
    
    function SpaceZhaoZilla_UpdateTeamWallet(address newWallet) external onlyOwner{
        SpaceZhaoZilla_Team = newWallet;
    }
