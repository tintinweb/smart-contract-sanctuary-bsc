...
/**
 *  Join the Munzk as he battles the hordes of hostile aliens in the Sxelon Galaxy!

Join the fight today as the Munzk and friends battle to create a new home for Humanity.

In Sxelon Galaxy, you play as a member of an elite team of warriors tasked with defending the Sxelon Settlements and outposts from an invasion of alien forces. Using Gamified NFTs, Sxelon Galaxy allows you to collect, trade, and upgrade an arsenal of futuristic weapons and gear.

As you progress through the game, you'll face off against increasingly powerful alien bosses and hordes of lesser foes, earning rewards and climbing the ranks on the global leaderboard. And with the ability to buy, sell, and trade your gear and items on the Sxelon marketplace, you can constantly improve your character and customize your playstyle.

Join the fight to save the Sxelon Galaxy, the ultimate blockchain-based action game!
 * 
 */
...
contract Sxelon is Context, IERC20, Ownable {
    ...
    string private _name = "Sxelon Galaxy";
    string private _symbol = "Sxelon";
