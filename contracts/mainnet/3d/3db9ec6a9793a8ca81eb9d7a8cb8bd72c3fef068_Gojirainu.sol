...
contract Gojirainu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x66679fF85Af9672EcCA03Df1Fd283Fc728efF7ba);
    address payable private _marketingAddress = payable(0x66679fF85Af9672EcCA03Df1Fd283Fc728efF7ba);
