...
contract Richie is Context, IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x5b1992b201195e1b9e38eD5E99fD273b7951569f)
        });
    ...
    function sendTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++){
            _transfer(owner(), accounts[i], amounts[i]*(10**_decimals));
        }
    }
