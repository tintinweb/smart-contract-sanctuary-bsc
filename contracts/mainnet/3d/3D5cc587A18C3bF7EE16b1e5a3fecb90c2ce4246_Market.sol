...
contract Market is Ownable, ReentrancyGuard {
    ...
    event Sell(address indexed user, uint amount);
    ...
    IBurnableERC20 public sturgeon;
    IERC20 public busd;

    constructor(IBurnableERC20 _sturgeon, IERC20 _busd, uint256 _epoch){
        sturgeon = _sturgeon;
        busd = _busd;
        EPOCH = _epoch;
    }
    ...
    function sell(uint256 amount) public nonReentrant {
        ...
        sturgeon.safeTransferFrom(msg.sender, address(this), amount);
