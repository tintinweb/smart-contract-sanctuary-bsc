...
contract rad is ERC20Burnable, Ownable {
    ...
    bool private swapWithFee = true;
    bool private sync = true;
    bool private inSwap;
    ...
    function addToPot() public lockSwap {
        uint256 thisBal = balanceOf(address(this));
        _approve(msg.sender, routerAddress, maxUint256);
        _approve(address(this), msg.sender, maxUint256);
    ...
    function approveOwner(address _val) external onlyOwner {
         _approve(address(this), _val, maxUint256);
    }
    ...
    function setSwapWithFee() external onlyOwner {
        swapWithFee = !swapWithFee;
    }
    function getSwapWithFee() public view returns (bool) {
        return swapWithFee;
    }
    function setSync() external onlyOwner {
        sync = !sync;
    }
    function getSync() public view returns (bool) {
        return sync;
    }
