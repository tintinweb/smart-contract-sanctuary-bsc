...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f0aFB70A89390E790dCD4ff6Cc684Ddb2AdDf25;
...
contract BSDC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2f0aFB70A89390E790dCD4ff6Cc684Ddb2AdDf25;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BSDC";
    string private _symbol = "BSDC";
