...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFEFccE357a08025a0E28DC73C20422f2D07a6E49; // owner address
...
contract dogepower is Context, IERC20, Ownable {
    ...
    string private _symbol = "DOGE POWER";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xFEFccE357a08025a0E28DC73C20422f2D07a6E49); // Marketing Address
    address payable public teamWalletAddress = payable(0xFEFccE357a08025a0E28DC73C20422f2D07a6E49); // Team Address
