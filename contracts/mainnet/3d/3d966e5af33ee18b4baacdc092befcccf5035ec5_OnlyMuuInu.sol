...
/**
Telegram : https://t.me/OnlyMuuInu
Website  : TBA
...
contract OnlyMuuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Only Muu Inu";
    string private _symbol = "OMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7eC38aeeF6a6fE891a71C7f053aBCFE6C7a0Ce96); // Marketing Address
