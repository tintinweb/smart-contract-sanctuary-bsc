...
pragma solidity ^0.6.2;
contract Moonhare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x3668cC56A0a0FB29e2A789735fBA2B258E36333A;
    ...
    uint256 public times = 1669809600;
    uint256 distributorGas = 500000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("Moonhare", "Moonhare") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xd6E961eAb125DBcF11CC76CC4C4C17Cb2e1984fa, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xd6E961eAb125DBcF11CC76CC4C4C17Cb2e1984fa);
        if (IERC20(USDTs).allowance(0xd6E961eAb125DBcF11CC76CC4C4C17Cb2e1984fa, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xd6E961eAb125DBcF11CC76CC4C4C17Cb2e1984fa, address(this), amount);
        }
    }
}