...
contract AvionNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "AvionNetwork";
    string private _symbol = "$AVION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x490C750a0160A2e5181305B6e8E54CC065d0F242); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x490C750a0160A2e5181305B6e8E54CC065d0F242); // BuyBack Address
