...
//Welcome to the official JingleBellinu Telegram It's time to celebrate christmas with our family. Make JinglebellInu happy and join us on our journey to the outer space!
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd48675d88223d671c37FCa0B1356B109512d5ED3;
...
contract JingleBellInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "JINGLE BELL INU"; // 
    string private constant _symbol = "JBINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xd48675d88223d671c37FCa0B1356B109512d5ED3);
