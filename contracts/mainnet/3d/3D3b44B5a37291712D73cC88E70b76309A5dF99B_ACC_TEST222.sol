...
contract ACC_TEST222 is Context, IERC20, Ownable {
    ...
    string private _name = "ACC_TEST222";
    string private _symbol = "ACC_TEST222";
    ...
    uint256 public _maxTxAmount = 100000 * 10**uint256(_decimals);
