...
function Change_TimeLock(address Lock_Address,uint256 releasetime) onlyOwner() public {

require(Lockup[Lock_Address].time != 0,"It's not locked up");

Lockup[Lock_Address].time = releasetime;
...
contract SAHARAToken is BEP20,BEP20Burnable {

constructor(uint256 initialSupply) public BEP20("SAHARA", "SAHARA") {
