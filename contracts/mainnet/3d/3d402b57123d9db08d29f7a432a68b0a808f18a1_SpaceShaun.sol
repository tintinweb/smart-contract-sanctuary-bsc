...
contract SpaceShaun
 is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceShaun";
    string private _symbol = "SpaceShaun";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x86239A21B4DF96f5A1CC575456630347F7f6ba0a);
    address payable public teamWalletAddress = payable(0x86239A21B4DF96f5A1CC575456630347F7f6ba0a);
    address public immutable deadAddress = 0x86239A21B4DF96f5A1CC575456630347F7f6ba0a;
