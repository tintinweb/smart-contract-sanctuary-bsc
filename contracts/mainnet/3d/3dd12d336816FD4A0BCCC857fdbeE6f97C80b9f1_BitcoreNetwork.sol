...
TG: https://t.me/BitcoreNetworkOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA47d8Aa6790c600Ee6bd1ab9f3dA251B2675dc13; // owner address
...
contract BitcoreNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BitcoreNetwork";
    string private _symbol = unicode"Bitcore";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA47d8Aa6790c600Ee6bd1ab9f3dA251B2675dc13); // Marketing Address
    address payable public teamWalletAddress = payable(0xA47d8Aa6790c600Ee6bd1ab9f3dA251B2675dc13); // Team Address
