...
contract SuperBowlLVII is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Super Bowl LVII";
    string private _symbol = "SBowlLVII";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2a10dEe7B408Fb61fc6B2B67a2D5Fc7a5E2151fd); // Marketing Address
    address payable public teamWalletAddress = payable(0x83B1138f29dD0A6096767B569f13B67bac51155e); // Team Address
    ...
    uint256 public _totalDistributionShares = 46;
