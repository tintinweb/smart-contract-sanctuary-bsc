...
/**
                        telegram : https://t.me/BabyMeowthcoin
...
contract BabyMeowthCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyMeowthCoin"; 
    string private _symbol = "BMeowthCoin";
