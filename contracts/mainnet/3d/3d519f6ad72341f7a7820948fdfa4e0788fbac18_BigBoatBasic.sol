...
contract BigBoatBasic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCD59120Ec422C171c1f37405cF3A449C131bd8C9); // Marketing Address
    ...
    string private _name = "Big Boat Basic";
