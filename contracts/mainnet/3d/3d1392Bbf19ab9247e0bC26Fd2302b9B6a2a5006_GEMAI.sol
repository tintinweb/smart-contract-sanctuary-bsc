...
contract GEMAI is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'GEM AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'GEM AI: incorrect fee percent');
        require(owner != address(0), 'GEM AI: incorrect owner address');
        require(mintToAddr != address(0), 'GEM AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'GEM AI: transfer from the zero address');
        require(recipient != address(0), 'GEM AI: transfer to the zero address');
