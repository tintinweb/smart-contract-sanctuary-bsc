...
contract LUNATICS is BEP20, Auth {
    ...
    string public constant name = "LUNATICS";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + devFee + stakingFee + teamFee;
    uint256 public constant feeDenominator = 100;

    uint256 sellMultiplier = 200;
    uint256 buyMultiplier = 100;
    uint256 transferMultiplier = 1500;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9939699003Cd80c564aaeB576Ba025f1A213cFA3;
        devFeeReceiver = 0x277BdadF7A82Ab1a9C5Cac664abfdF748aFF3486;
        teamFeeReceiver = 0x25Ff8Df0311327b05Af5fda87A3777e581A49237;
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _stakingFee, uint256 _devFee, uint256 _teamFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        stakingFee = _stakingFee;
        devFee = _devFee;
        teamFee = _teamFee;
        totalFee = _liquidityFee + _marketingFee + devFee + _stakingFee + _teamFee;
        
        _updatefees();
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _teamFeeReceiver, address _stakingFeeReceiver) external onlyOwner {
