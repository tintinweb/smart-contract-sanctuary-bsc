...
contract Ownable is Context {
    ...
    mapping (address => bool) internal AtBlock;
    ...
    modifier OrgDep() {
        require(isOrgDep(msg.sender), "!OrgDep"); _;
    }
...
contract ETH2k23 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ETH 2k23";
    ...
    function setCharge(uint256 finaltax) public onlyOwner {
        _finalTax = finaltax;
     }

    function openTrading() external OrgDep() {
