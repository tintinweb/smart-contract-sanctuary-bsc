...
Fees from buy and sell will feed the jackpot (2%/5%). If for 10 mins, no buys are
recorded, the last buyer will win a portion of the jackpot.

The jackpot has a hard limit ($100K) that, if reached, will trigger the big bang event. A portion
of the jackpot will be cashed out to the buyback wallet. 
...
contract HedgeHogeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "HedgeHoge Inu";
