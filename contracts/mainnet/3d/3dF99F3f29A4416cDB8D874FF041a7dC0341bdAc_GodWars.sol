...
contract GodWars is IERC20 {
    ...
    string constant private _name = "GodWars";
    string constant private _symbol = "GWR";
    ...
    address payable public marketingWallet = payable(0x61dfFF3610791E5C51e2EFfCB9D78677eE68A456);
