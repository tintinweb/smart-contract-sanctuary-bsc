...
contract PaddyDoge is Ownable, IBEP20 {
    ...
    string constant _name = "PaddyDoge";
    string constant _symbol = "PADDYDOGE";
    ...
    uint256 public PaddyDogeMarketingFee = 7;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x2aE386598f75FC11F5836c493cfC2fc0c8B81e5f;
        marketingWallet = 0x3BA305D3cC6d9db4bA5D71e365a46c1dF05324D3;

        totalFee = liquidityFee.add(PaddyDogeMarketingFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(PaddyDogeMarketingFee).div(totalBNBFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newPaddyDogeMarketingFee) external onlyOwner {
        liquidityFee = newLiqFee;
        PaddyDogeMarketingFee = newPaddyDogeMarketingFee;
