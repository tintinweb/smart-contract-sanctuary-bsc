...
Telegram : https://t.me/THORGIOFFICIAL
*/
...
contract Thor is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2500000 * 10**9; //
    string private constant _name = "THORGI GROW"; // 
    string private constant _symbol = "$ThorGrow"; //    
