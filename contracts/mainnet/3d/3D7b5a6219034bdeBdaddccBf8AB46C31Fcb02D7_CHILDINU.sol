...
contract CHILDINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Child Inu";

    string private _symbol = "\u5b69\u5b50";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x54144591382f59c5B8Dc8F558d2969c93520b4fE;
