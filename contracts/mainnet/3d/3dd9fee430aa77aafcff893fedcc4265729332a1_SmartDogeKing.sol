...
// File: contracts/SmartDogeKing.sol

/**
 *Smart Doge King Fair Launch
  Ownership Renounced
  1M Supply
  Fee 5 buy / 5 sell
  LP 15 Days Lock
  
  Smart DogeKing, The Smartest MEME Token on BSC. 
  Smart DogeKing Token is not an investment and created as a meme parody like Shiba Inu or Dogecoin.
  https://smartdoge.xyz/
...
contract SmartDogeKing is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdBdaCFFf3175699f890a59d4bdceEB1312c59F9d); 
    address payable public Wallet_Dev = payable(0xdBdaCFFf3175699f890a59d4bdceEB1312c59F9d);
    ...
    string private constant _name = "Smart Doge King"; 
    string private constant _symbol = unicode"SDoge KING"; 
    ...
    constructor () {
        ...
        _owner = 0xEDc1F58398129f4AEEB6C0fB29D71bCe63aEEfBF;
