...
/**
In honor of our most precious little yoda we bring you this LUCKY YODA that will 
make you 1000x richer!

TELEGRAM : https://t.me/luckyyodainu
...
Lucky Yoda Inu is a self sustaining token that has auto-burn and auto liquidity feature.
Overtime the value of the token will increase due to its functions.

Lucky Yoda Inu will be stealth launched 50% of the total supplies will be burned prior to launch.

Ownership will be renounced once the token has been locked.
Liquidity will be extended if we reach 150k MCAP

When the inevitable Elon tweet comes about "May The 4th Be With You" we will open the chat and go full send!
...
contract LuckyYoda is Context, IERC20, Ownable {
    ...
    string private _name = "Lucky Yoda Inu";
    string private _symbol = "LYI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x25afba063751321e7016f457CDd96127dD722b9E);
