...
TELEGRAM: https://t.me/FlokiProtocol
|
*/
...
contract FlokiProtocol  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Floki Protocol ";
    string private _symbol = " FPL "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCE1652F9434E55C4A595302b7772Aa76F6674117); 
    address payable public teamWalletAddress = payable(0x604528e2D128dFc4Cc1DA3C9eE7A7714D386A27b); 
