...
contract SHENGWEIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShengweiInu";
    string private _symbol = "SWINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA88B9F3B09f2CEf01F76E373FB4a34C943C0CF83); 
    address payable public DevWalletAddress = payable(0xB07D67c5f5C345634C06B182C35dbAA197791D72); 
    ...
    uint256 public _buyMarketingFee = 93;
