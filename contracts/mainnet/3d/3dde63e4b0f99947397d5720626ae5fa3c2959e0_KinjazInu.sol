...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x523EeE88366bD6A9924C71b4479689fa033e32Dd;
...
contract KinjazInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "kinjaz Inu"; // 
    string private constant _symbol = "$KinjazInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xcF7Fb9391f3212AEc127190B343F3B6c0783C9b1);
