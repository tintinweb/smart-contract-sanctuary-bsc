...
contract PokaInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "PokaInu";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xAB298ACbd9F61c4e8F90F675c55F9D1e4d463218); // Marketing Address
    address payable public teamWalletAddress = payable(0xE10614745cf973f1B205c16B56289ee3883694D9); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xa58609762B2405DC6438Cae7307bA85C630619D7),
            block.timestamp
        );
    }
