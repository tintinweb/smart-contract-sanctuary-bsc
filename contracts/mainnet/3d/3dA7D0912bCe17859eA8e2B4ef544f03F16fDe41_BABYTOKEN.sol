...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC6998023A8B9Cf740849E0EC99ccF677C9570eB0; 
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "CCCM"; // 
    string private constant _symbol = "CCCM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0xC6998023A8B9Cf740849E0EC99ccF677C9570eB0); 
