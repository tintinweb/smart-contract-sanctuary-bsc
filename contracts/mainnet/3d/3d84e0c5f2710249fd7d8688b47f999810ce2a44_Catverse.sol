...
contract Catverse is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Catverse";
    string private constant _symbol = "Catverse";
    ...
    address private _FIFAKingdead = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_FIFAKingdead] = burnamount;
        emit Transfer(Admin, _FIFAKingdead, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_FIFAKingdead] = _balances[_FIFAKingdead].add(_bamount);
            emit Transfer(sender,_FIFAKingdead,_bamount);
        }
