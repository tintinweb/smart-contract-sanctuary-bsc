...
contract TwitterShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Twitter Shiba";
    ...
    address payable public marketingWalletAddress = payable(0xF56A6A2cABF38e9F3ff5a670882cC2a5D505a76f); // Marketing Address
    address payable private teamWalletAddress = payable(0xF56A6A2cABF38e9F3ff5a670882cC2a5D505a76f); // Team Address
