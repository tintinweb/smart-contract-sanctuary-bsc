...
SHIBCAT mooning, DONT MISS X-SHIBCAT . X-SHIBCATT is new meme cryptocurrency on Binance Smart Chain and its a community driven token

Telegram : https://t.me/Xshibcat
*/
interface IERC20 {
...
contract XSHIBCAT is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = " X-SHIBCAT "; 
    string private _symbol = " X-SHIBCAT ";
