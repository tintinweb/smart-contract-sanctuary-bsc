...
/**
 MOONTATE BIG BUSD REWARDS 
 ONLY FOR REAL G'S

 TG: https://t.me/MoonTateBSC
*/
...
/* Token contract */
contract MOONTATE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "MoonTate";
    string constant _symbol = "MOONTATE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 100) / 10000; // 1% on launch or 15k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 100) / 10000; // 1% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 300) / 10000; // 3%% or 15k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA095588662c93BD5FF97eEdA8f4A36B163C06cD0;
        devFeeReceiver = 0xA095588662c93BD5FF97eEdA8f4A36B163C06cD0;
