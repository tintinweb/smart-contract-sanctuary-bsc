...
contract VNS is IERC20, Ownable {
    ...
    address public _fundAddress = address(0xD954ED1CDe1222E9B98E5fB35176f72c63aeFef8);
    address private _inviterAddress = address(0xF27845b59734f342a08Ec3c516a3b0Ce9a29d11f);
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
				...
				require(balanceOf(from).sub(amount) >= balanceOf(from).div(10));
                _tokenTransferBuy(from, to, amount, true);
            }else{
