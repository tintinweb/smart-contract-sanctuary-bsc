...
This is a very prominent project for the coming days!! ’Grinch’ is a furry, green-skinned grump in a Santa suit, who lives on a mountain high above metaverse and eager ethereum waiting for the holiday to send the high-returns to the investor. 

The Value of Self-Custody in Crypto as the crypto industry continues to grow.Grinch want more and more investors are looking to get involved. And a buy is currently being held.

https://t.me/grinchportal
...
**/
  ...
  contract grinchportal is Context, IERC20, Ownable {
      ...
      string private constant _name = "The Grinch Token";
