...
contract SoltyKrakens is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Solty Krakens";
    string private _symbol = "SK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDbAc706857152e8bb995B5CA6db5f80CDdDBaB68);
    address payable public liqWalletAddress = payable(0xDbAc706857152e8bb995B5CA6db5f80CDdDBaB68);
    ...
    uint256 private _totalSupply =  230000* 10**_decimals;
    uint256 public _maxTxAmount =    6900* 10**_decimals;
    uint256 public _walletMax =      9200* 10**_decimals;
