...
contract MicrosoftInu is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Microsoft Inu";
    ...
    constructor () {
        ...
        _liquidityWallet = payable(0xb55919579d751Fd864349d061a58c47Af3b6C7A9);
        _devWallet = payable(0xb55919579d751Fd864349d061a58c47Af3b6C7A9);
        ...
        emit Transfer(address(0xb55919579d751Fd864349d061a58c47Af3b6C7A9), _msgSender(), _tTotal);
    }
