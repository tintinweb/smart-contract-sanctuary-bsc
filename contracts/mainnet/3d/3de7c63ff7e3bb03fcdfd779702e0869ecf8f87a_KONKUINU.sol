...
contract KONKUINU is IBEP20, Ownable {
    ...
    string constant _name = "Konku Inu";
    string constant _symbol = unicode"KONKU";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply     = 1000000000 * 10**_decimals;
    uint256 public _maxTxAmount     = 25000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 25000000 * 10**_decimals;

    address private deadWallet      = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0xb618077F52014E347Ca17BE6A23a81378A5A4dB0;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(2, 3, 1, 1);
    Fees public sellFees    = Fees(2, 3, 1, 1);
