...
contract Ownable is Context {
    ...
    constructor (address ownerAddress) {
        address msgSender = ownerAddress;
        _owner = msgSender;
...
contract ENFT is Context, IERC20, Ownable {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        uint256 bAmount = tAmount.mul(_taxFee).div(10**2);
        uint256 rAmount = tAmount.sub(bAmount);
