...
contract BNBFLY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBFLY";
    string private _symbol = "BNBFLY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x42caCb76f5771A208Ec721f0382417d5fC62072B); // Marketing Address
    address payable private teamWalletAddress = payable(0x42caCb76f5771A208Ec721f0382417d5fC62072B); // Team Address
