...
/* Token contract */
contract  METAGALAXYNETWORK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xB2984e72dFBBc485F23Af9A51dC70Ff5C596B245;
    ...
    // Name and symbol
    string constant _name = "METAGALAXY NETWORK";
    string constant _symbol = "MEGANET";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 138000000 * (10 ** _decimals); // 100 Million
