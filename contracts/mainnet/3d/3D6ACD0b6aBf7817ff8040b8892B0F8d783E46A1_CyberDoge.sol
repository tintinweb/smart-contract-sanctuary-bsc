...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).approve(RouterAddress, MAX);
        _allowances[address(this)][address(swapRouter)] = MAX;
        ISwapFactory swapFactory = ISwapFactory(swapRouter.factory());
        address swapPair = swapFactory.createPair(address(this), 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
        _mainPair = swapPair;
    ...
    function _tokenTransfer(
        ...
        uint256 feeAmount;
        if (takeFee) {
            uint256 swapFee = _marketingFee + _LPFee;
    ...
    {
        uint256 totalFee = _marketingFee + _LPFee;
        ...
        _tokenTransfer(address(this),_mainPair,lpAmount,false);
...
contract CyberDoge is AbsToken {
