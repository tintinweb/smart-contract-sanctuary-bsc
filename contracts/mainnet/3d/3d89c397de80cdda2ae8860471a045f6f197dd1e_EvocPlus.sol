...
contract EvocPlus is IBEP20, Auth {
    using SafeMath for uint256;
   ...
   address public REWARD = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; //Ada
    ...
    address MKT  = 0x03bA256a12cDaDA46613f1A9D374e6eCDc0FF1E5;    
    address public BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD  
    address public buyBackToken = BUSD;
    

    string constant _name = "Teste Plus";
    ...
    function setBuyBackToken(address _tokenAddress) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        if (totalFee > 0) {
            ...
            if (marketingFee > 0) {
                ...
                // tmpSuccess = false;
                swapMarketingFee(amountBNBMarketing);
    ...
    function swapMarketingFee(uint256 tokens) private  {
        ...
        IBEP20(BUSD).transfer(marketingFeeReceiver, newBalance);
        
    }

    function swapTokensForBUSD(uint256 tokens) private {
        address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = WBNB;
        path[2] = BUSD;    
