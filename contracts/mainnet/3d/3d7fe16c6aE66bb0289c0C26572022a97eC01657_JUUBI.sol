...
// telegram : https://t.me/juubiportal
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract JUUBI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x23d6B27F2bfF4F5A98318115C2130008e8E0122C); // Marketing Address

    address payable public teamAddress =
        payable(0x23d6B27F2bfF4F5A98318115C2130008e8E0122C); // Team Address

    address payable public liquidityAddress =
        payable(0xC035dD93d0599Cc0D55597C7Ebfe17197F8269d6); // Liquidity Address
    ...
    string private constant _name = "JUUBI";
    string private constant _symbol = "JUUBI";
