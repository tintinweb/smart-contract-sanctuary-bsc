...
contract Wof is Context, IERC20, Ownable {
    ...
    string private _name = "Warriors of Future";//Warriors of Future
    string private _symbol = "Wof";
    uint8 private _decimals = 9;

    //These three variables are used to set kill blocks
    uint public launchedBlock;
    uint public whiteblock = 20;
    bool public isLaunch = false;
    
    //Marketing wallet and liquidity wallet
    address payable private marketingWalletAddress = payable(0x288ac275295e45aF0565200390E11D5565319527);
    address payable private activityWalletAddress = payable(0x9aC0E1AFDc673d163061b9365f2E05D45B607388);
    address payable private liquidityWalletAddress = payable(0x288ac275295e45aF0565200390E11D5565319527);
    ...
    uint256 public _buyActivityFee = 2;
    
    //Sell Fee is set here
    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 2;
    uint256 public _sellActivityFee = 2;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (block.number < launchedBlock + whiteblock 
    ...
    function setWhiteBuy(address[] memory whiteBuyLists) public onlyOwner {
        for(uint i = 0 ; i < whiteBuyLists.length ; i++ )
            whiteBuy[whiteBuyLists[i]] = true;
    }
