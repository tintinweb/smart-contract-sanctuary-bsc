...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdE1177A4c189e534a0D5f460B69E9bF1C7b5Afa0; // owner address
...
contract BabyMecha is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Mecha";
    string private _symbol = "BMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb01f58fda2B4096de002d8A3e08eCEbC004952E5); // Marketing Address
    address payable public buybackWalletAddress = payable(0xdE1177A4c189e534a0D5f460B69E9bF1C7b5Afa0); // Buyback Address
