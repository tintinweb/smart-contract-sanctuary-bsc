...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "Saturns";       //Full name
    string public symbol_ = "Saturns";      //abbreviation

    uint256 public deadFee = 1;       //Destroyed
    ...
    constructor(
        ...
        uint256 totalSupply = 20000 * 10 ** decimals();      //Supply
        ...
        marketingWalletAddress = 0xb1FC2340005d754FC7126589f80136648B95aaeE;    //Marketing address
