...
/**
// Elon Hyped Token
  https://twitter.com/elonmusk/status/1527315290132185088?s=20&t=V0eOAhPRKjef0quL13L9YA


  TG: https://t.me/RepsorDemsInu
...
contract RepsorDemsInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Reps or Dems Inu";
    string private constant _symbol = "$REPDEM";
    ...
    address private marketingWallet = address(0x29766bFC7A1FA5bc3dB1424d665f9276d7F940CA);
    address private liquidityReceiver = address(0x29766bFC7A1FA5bc3dB1424d665f9276d7F940CA);
