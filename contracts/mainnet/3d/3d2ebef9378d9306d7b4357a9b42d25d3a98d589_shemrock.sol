...
// THIS TOKEN ITS TREND. JUST COME TO OUR COMMUNITY: 
 // Global Telegram community: T.ME/SHEMROCK_BSC 
 // Chinese Telegram: t.me/shemrock_ch
 // https://twitter.com/ShemRock_bsc
 // BUY AND SHILL YOUR BAGS. ITS EASY
...
contract shemrock is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x8A379B584BA7854af1ACC040e1B25d18146EC1E3); // Marketing Address

    address payable public teamAddress =
        payable(0x15b5b001ef19187552df4f45034307111997940E); // Team Address

    address payable public liquidityAddress =
        payable(0x8A379B584BA7854af1ACC040e1B25d18146EC1E3); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100 * 1e18 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "Shemrock";
    string private constant _symbol = "Shemrock";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 200 / 10000; // 0.05%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 100 / 1000; // 0.5% maxTransactionAmountTxn
