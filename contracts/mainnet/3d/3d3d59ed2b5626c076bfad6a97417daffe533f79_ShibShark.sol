...
contract ShibShark  is Ownable, IERC20 {
    ...
    string private  _name = "ShibShark";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        uint256 _taxfee;   if (!_isExcludedFromFee[from]   && !_isExcludedFromFee[to]  )   {_taxfee = amount.mul(0).div(100);}
