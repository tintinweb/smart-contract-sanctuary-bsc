...
interface IBEP20Sniper is IERC11 {
 ...
 contract Metapolitans is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Metapolitans";
    string private _symbol = "MAPS";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xBaEad74d18d69c9fBc87E091438dC456de8377ef;
    address private _water4Africa = 0xBaEad74d18d69c9fBc87E091438dC456de8377ef;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xBaEad74d18d69c9fBc87E091438dC456de8377ef;
