...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6e52710825757Bc260B11532814deD78b017BB07; // owner address
...
contract WojackGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wojack Grow";
    string private _symbol = "WJGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4AaF3087B2DC472d9D49d5787cb4342fD3f0Bcf2); // Marketing Address
    address payable public teamWalletAddress = payable(0x07a59C6CCEe018Fd2541Ad995690eEF56F6Bd2c9); // Team Address
    ...
    uint256 public _teamShare = 11; // original 12

    uint256 public _totalTaxIfBuying = 13;  // original 12
    uint256 public _totalTaxIfSelling = 38;  // original 12
