...
/**
    ...
    *sustainability tax stays in the contract.
    ...
    12 days cut off time 
    240 hours withdraw cooldown.
...
contract TheFarmOfFortune {
	...
	/** default percentages **/
	uint256 public PROJECT_FEE = 350;
	...
	uint256 public CUTOFF_STEP = 288 * 60 * 60;
	uint256 public WITHDRAW_COOLDOWN = 240 * 60 * 60;
	uint256 public COMPOUND_COOLDOWN = 240 * 60 * 60;
    ...
    uint public startTime = 1664820000; // Monday, 3 October 2022 18:00:00 UTC https://www.unixtimestamp.com/
