...
contract CCTToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 9;
    string private _symbol = "CCT";
    string private _name= "Children Care Token";
...
contract CCTTokenSale {
    address payable admin;
    CCTToken public tokenContract;
    ...
    constructor(CCTToken _tokenContract, uint256 _tokensSold)  {
    ...
    function multiply(uint x, uint y) internal pure returns (uint z) {
   	...
   	function buyTokens(uint256 _numberOfTokens) public payable {
		uint256 _bnbvalue = (_numberOfTokens/1000000000)*tokenPrice;
