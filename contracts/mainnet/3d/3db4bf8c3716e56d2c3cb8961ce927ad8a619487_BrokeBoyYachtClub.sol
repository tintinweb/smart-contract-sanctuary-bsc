...
contract BrokeBoyYachtClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Broke Boy Yacht Club";
    string private _symbol = "BBYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7A6DFE110e980a2A9aE581C85b5aFd73fa618321); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xcD54A0A9fF3dBB0B2171A5EA8231d019798488e9); // Buyback Wallet Address
    ...
    uint256 private _totalSupply = 999999999 * 10**9;
