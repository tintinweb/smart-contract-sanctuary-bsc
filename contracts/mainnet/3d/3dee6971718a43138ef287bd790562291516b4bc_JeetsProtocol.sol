...
contract JeetsProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Jeets Protocol"; // Edit Name
    string constant _symbol = "JTSPRTCL"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 200000000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public reflectionFee   = 0; // Edit BUSD Reward Fee
    uint256 public marketingFee    = 2; // Edit Marketing Fee
    uint256 public devFee          = 4; // Edit Dev Fee
    ...
    uint256 public swapThreshold = _totalSupply * 12 / 1000; // Adjust Auto-Sell (10 = 0.1%)
    bool inSwap;
