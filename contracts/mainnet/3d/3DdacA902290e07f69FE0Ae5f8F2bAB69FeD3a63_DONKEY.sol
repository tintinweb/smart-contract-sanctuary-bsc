...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB3Ba332CfaE1f5c4BC9feaEd5881c314d773B452;
...
contract DONKEY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Donkey Girl"; // 
    string private constant _symbol = "$DoGirl"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xB3Ba332CfaE1f5c4BC9feaEd5881c314d773B452);
