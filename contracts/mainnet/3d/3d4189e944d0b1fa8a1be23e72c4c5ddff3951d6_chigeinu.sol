...
WELCOME TO CHIGE INU!

Pige hype + Animal hype!
Chicken + Doge!

This is a combination that will set the BSC barn on fire!  Grab your cocks and get set for a fantastic ride ahead!  LP locked.  CA renounced!  Based team!  Moonshot imminent!

Come join the farm-liy today!
...
TG: https://t.me/chigeinu_bsc
TWITTER: https://t.me/chigeinu_bsc
...
contract chigeinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chige Inu";
    string private constant _symbol = "CHIGE";
