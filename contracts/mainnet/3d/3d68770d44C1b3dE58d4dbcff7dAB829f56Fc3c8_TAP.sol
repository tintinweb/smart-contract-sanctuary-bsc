...
contract TAP is Context, IERC20, IERC20Metadata, Manage {
    ...
    uint256 public maxNumber=5000000000000000000;
    ...
    function changePoolFeeAddr(address addr)public {
        poolFeeAddr=addr;
    }

    function changePoolFeeRatio(uint256 _ratio)public {
        poolFeeRatio=_ratio;
    }

    function changeMaxNumber(uint256 _number)public {
        maxNumber=_number;
    }
