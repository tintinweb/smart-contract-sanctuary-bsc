...
contract Sidu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SiduInu"; // 
    string private constant _symbol = "$Sidu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xb5a041a8036bd16493ace5BeF0cA31E71D28EFEc;
