...
contract DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "DogeSharkMoonDaoMetaAwmSun2.0";
    string private _symbol = "DogeSharkMoonDaoMetaAwmSun2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5124793cec90E1a3fd4a8Ce311879829d7d5bE02);
