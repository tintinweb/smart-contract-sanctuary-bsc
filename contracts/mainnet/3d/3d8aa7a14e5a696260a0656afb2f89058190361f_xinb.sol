        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5cF62574dF0E0E8Fb41819D589170dc86A99bd33), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000000,//Su
        address(0x5cF62574dF0E0E8Fb41819D589170dc86A99bd33),//
        address(0x5cF62574dF0E0E8Fb41819D589170dc86A99bd33)//
    ){
    }
}