...
def __init__():
    ...
    self.WCOIN=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
...
def honeyCheck(
    ...
    raw_call(
        ...
        _abi_encode(            
            ...
            self,
            block.timestamp + 10, 
            method_id=method_id("swapExactTokensForTokensSupportingFeeOnTransferTokens(uint,uint,address[],address,uint,address)")
        ),
        max_outsize=0,
