...
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
import "./core/IUniswapV2Factory.sol";
import "./core/IUniswapV2Pair.sol";
import "./core/IUniswapV2Router02.sol";
import "./core/IUniswapV2Router01.sol";

contract Two is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWO";
    string private _symbol = "$TWO";
    ...
    address payable private _marketingWallet = payable(0xecB985268C4100F3A6269263C42dEDf2D47A5Db7);

    uint256 private constant MAX = ~uint256(0);
    uint256 private initialsupply = 2_200_000_000_000;
