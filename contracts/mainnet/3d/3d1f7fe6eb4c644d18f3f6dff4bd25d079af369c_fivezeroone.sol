...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA661cCc89CAa4e1F6662b0226d3cFE3672Af8CE0; // owner address
...
contract fivezeroone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "501";
    string private _symbol = "501";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA661cCc89CAa4e1F6662b0226d3cFE3672Af8CE0); // 
    address payable public teamWalletAddress = payable(0xA661cCc89CAa4e1F6662b0226d3cFE3672Af8CE0); // 
    ...
    uint256 private _totalSupply = 5010 * 10**_decimals;
