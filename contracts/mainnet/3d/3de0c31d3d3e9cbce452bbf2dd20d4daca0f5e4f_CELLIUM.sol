...
Telegram https://t.me/CELLIUMNETWORK
Website https://celliumnetwork.tech/
*/
...
contract CELLIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CELLIUM NETWORK";
    string private _symbol = "$CLM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2fC330E8b80684afb49c88107b98987A27CADf45); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2fC330E8b80684afb49c88107b98987A27CADf45); // BuyBack Address
    ...
    uint256 private _totalSupply = 150 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 150 * 10**4 * 10**9;
    uint256 public _walletMax = 300 * 10**4 * 10**9;
