...
contract ElonMoonMusk is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x68Fb048BF64c32542740C62f92CB1b61D7B36334;

    string private constant _name = "Emoon Musk";
    string private constant _symbol = "EMOONMUSK";
    ...
    Taxes public taxes = Taxes(2,2,4,0);
