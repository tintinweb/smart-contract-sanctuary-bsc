...
contract  TAAINU is Context, IERC20, Ownable {

    uint256 public publlc=
    150204226878642622067527889049274545390382094927;
    using SafeMath for uint256;
    string private _name = "TAMANU";
    string private _symbol = "TAAINU";
    ...
    constructor () {
        ...
        teammWalletAddress = payable(address(0x82AdB4eb71316f7ED89187f6dD4Bf2942C6547eD));
