...
// Telegram: https://t.me/BabyFreedomProtocol
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6845E50258400543793909E1e879344983D00Fe1; // owner address
...
contract BABYFREEDOMPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Freedom Protocol";
    string private _symbol = "$BFREE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6845E50258400543793909E1e879344983D00Fe1);
    address payable public teamWalletAddress = payable(0x6845E50258400543793909E1e879344983D00Fe1); 
