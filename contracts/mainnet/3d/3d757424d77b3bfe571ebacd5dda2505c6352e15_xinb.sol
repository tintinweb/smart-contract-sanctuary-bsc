        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xAea2475873daa5F71f0E4eaC23bB48A74f1FEB29), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        300000,//Su
        address(0xAea2475873daa5F71f0E4eaC23bB48A74f1FEB29),//
        address(0xAea2475873daa5F71f0E4eaC23bB48A74f1FEB29)//
    ){
    }
}