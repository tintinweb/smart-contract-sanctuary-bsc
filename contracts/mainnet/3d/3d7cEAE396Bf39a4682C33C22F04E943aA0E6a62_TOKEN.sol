...
abstract contract AbsToken is IERC20, Ownable {
    uint256 public _sellHoldDividendFee = _transferBurnFee;
    uint256 public _buyHoldDividendFee = _transferBurnFee;
    ...
    constructor (
        ...
        _limitAmount = 1000000000000000 * 10 ** _decimals;
...
function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
    ...
    function setKill1(uint256 _Kill) external onlyOwner {
        kill = _Kill;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x7B8b9bB9fE793D868460D635763188a9EBa47cAE),
