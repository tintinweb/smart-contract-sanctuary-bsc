...
contract BomberzillaNFTSale is Rescueable {
    ...
    function resale(
        ...
        _collectionAddress.burn(msg.sender, _tokenId, _quantity);
        emit Resale(_collectionAddress, _tokenId, msg.sender, _quantity);
    }
    ...
    function setResaleEnabled(bool _resaleEnabled) external onlyOwner {
