...
contract Stakes is Owner, ReentrancyGuard {
    ...
    constructor(ERC20 _erc20, address _owner, uint8 _rate, uint256 _maturity, uint8 _penalization, uint256 _lower, uint256 _higher) Owner(_owner) {
    ...
    function set(uint256 _lower, uint256 _higher, uint256 _maturity, uint8 _rate, uint8 _penalization) public isOwner {
