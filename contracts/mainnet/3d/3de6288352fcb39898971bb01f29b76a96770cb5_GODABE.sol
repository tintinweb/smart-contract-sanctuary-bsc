...
contract GODABE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GodSpeedABE";
    string private _symbol = "GodSpeedABE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x028062e113C6d9Bb2cEA64Cc7e072eCE20eC9147); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x028062e113C6d9Bb2cEA64Cc7e072eCE20eC9147); // Dev Address
