 ...
 * that a supply mechanism has to be added in a derived contract using {_nt}.
...
contract ERC20 is Context, IERC20 {
     ...
     */
    function _nt(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: nt to the zero address");
...
interface IUniswapV2Pair {
    ...
    function nt(address to) external returns (uint liquidity);
...
contract BabyExaDarkSiderael is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby ExaDarkSiderael", "BabyExaDarkSiderael") {

    	marketingWallet = 0xD5ca9D7005d51a4Ae6540c8Bb8F5C2BACC2D2D21;
    	rewardsWallet = 0x766196aC0cCF6235297b3A092763721C8c213143;
        ...
        /*
            _nt is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _nt(owner(), _totalSupply);
    }
    ...
    receive() external payable {
  	...
  	function whitelistTrading(address _JeetsAddress) external onlyOwner {
  	    presaleAddress = _JeetsAddress;
        isExcludedFromFees[_JeetsAddress] = true;
