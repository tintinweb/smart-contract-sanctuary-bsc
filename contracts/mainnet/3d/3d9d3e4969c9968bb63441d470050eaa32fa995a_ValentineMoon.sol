...
contract ValentineMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Valentine Moon";
    string private constant _symbol = "V-MOON";
