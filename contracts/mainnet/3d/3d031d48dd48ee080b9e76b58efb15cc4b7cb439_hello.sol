...
contract hello is Context, IERC20, Ownable {
    ...
    string private constant _name = "hello Inu";
    string private constant _symbol = "hello";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x94756Ce362c27F7516D3bA4e9ecC994Df075b858);
    address payable private _marketingAddress = payable(0x94756Ce362c27F7516D3bA4e9ecC994Df075b858);
