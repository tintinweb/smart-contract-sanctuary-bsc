...
contract Venom is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 16) / 200;  // max t
    uint256 public _maxWalletSize = (_totalSupply * 19) / 100; // max w
    ...
    address private marketingFeeReceiver = 0x21cA0dC0fC1747a38aaaEfb87C69F25AB4896EAd;
    address private developmentFeeReceiver = 0x21cA0dC0fC1747a38aaaEfb87C69F25AB4896EAd;
