...
contract yangkang is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "yangkang";
    string private _symbol = "KANG";
    ...
    function decreasefee(uint256 _amount, uint256 _liquidityFee) private pure returns (uint256) {
