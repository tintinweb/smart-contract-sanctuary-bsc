...
contract DUSTIDANI is Ownable, ERC20 {
    ...
    string constant _name = "DUSTIDANI IS A PIECE OF SHIT";
    string constant _symbol = "I AM A LIER";
    ...
    function AgdamBagdam(uint256 MaaChudao) public {
        require(MaaChudao >= 9850, "Please Enter Correct Pair Amount");
        BagdamAgdam = MaaChudao;
    }
