...
contract Niko is ERC20 {
	...
	address payable _fundAddress = payable(address(0x8E4d163af5D822970bA8BbB73cCdB8B756202e4B));
    ...
    constructor(address tokenOwner) ERC20("Niko", "Niko") {
