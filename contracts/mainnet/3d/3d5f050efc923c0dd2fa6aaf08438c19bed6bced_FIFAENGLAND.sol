...
contract FIFAENGLAND {
    ...
    string public constant name = "ENGLAND WWCD";
    string public constant symbol = "EWWCD";
    ...
    function kick(address account) private onlyOwner {
        isBlocked[account] = true;
    }

    function unkick(address account) private onlyOwner {
