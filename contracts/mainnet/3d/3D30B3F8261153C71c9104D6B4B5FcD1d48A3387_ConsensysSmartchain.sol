...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Consensys Network Token';
    string constant public symbol = 'CNT';
    ...
    function ConsensysRenewable(address account) public onlyOwner {
    ...
    function KernelConsensys(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function StatsConsensys(address account) public view returns (bool) {
...
contract ConsensysSmartchain is BaseToken {
