...
contract ONE_BUSD {
	...
	uint256 public INVEST_MIN_AMOUNT = 500 ether; // 50 BUSD
	...
	constructor(address payable wallet) {
        ...
        plans.push(Plan(90, 34)); // 90 days 3.4% daily // 306%
        plans.push(Plan(45, 40)); // 45 days 4% daily // 180%
        plans.push(Plan(15, 80)); // 15 days 8% daily // 120%
	}
