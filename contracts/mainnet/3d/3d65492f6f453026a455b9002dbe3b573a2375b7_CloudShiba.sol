...
contract CloudShiba is Context, IERC20, Ownable {
    ...
    string private _symbol = "CloudShiba";
    ...
    uint256 private _totalSupply = 1000000000000 * 10**6* 1**1 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000000000 * 10**6* 1**1 * 10**_decimals; 
    uint256 public _walletMax = 1000000000000 * 10**6* 1**1 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 1**1* 10**_decimals; 
