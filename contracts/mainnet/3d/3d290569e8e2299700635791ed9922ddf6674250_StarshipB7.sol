...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xd6A31F814BC83c2cD5B9d7933c1272834cf790EB));
...
contract StarshipB7 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarshipB7";
    string private _symbol = "StarshipB7";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd6A31F814BC83c2cD5B9d7933c1272834cf790EB);
    address payable public teamWalletAddress = payable(0xd6A31F814BC83c2cD5B9d7933c1272834cf790EB);
