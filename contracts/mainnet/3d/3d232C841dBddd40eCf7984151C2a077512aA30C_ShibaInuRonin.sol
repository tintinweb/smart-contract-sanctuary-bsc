...
contract ShibaInuRonin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0faa95Aa4D8E56469daA4B51FF9C3CBD73C2332f); 
    address payable public Wallet_Dev = payable(0x0faa95Aa4D8E56469daA4B51FF9C3CBD73C2332f);
    ...
    string private constant _name = "ShibaInu Ronin"; 
    string private constant _symbol = unicode"SHIBRONIN"; 
    ...
    uint256 public Percent_lp = 0;
    uint256 public Percent_Marketing = 100;    
    uint256 public Burned_tax = 0;             
    ...
    constructor () {
        ...
        _owner = 0x0faa95Aa4D8E56469daA4B51FF9C3CBD73C2332f;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Burned_tax / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Percent_lp / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_lp + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Percent_lp + Percent_Marketing + Percent_Dev);
