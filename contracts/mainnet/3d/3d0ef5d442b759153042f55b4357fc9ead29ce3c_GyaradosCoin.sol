...
contract GyaradosCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Gyarados Coin";
    string constant _symbol = "GYARADOS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3Ff8dC8267c95bBF4A79a94e74330608fb8bD143;
