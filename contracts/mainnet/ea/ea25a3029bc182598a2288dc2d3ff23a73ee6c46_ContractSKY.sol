...
pragma solidity 0.7.6;
    ...
    /*====================================
    | SKY TOKEN - t.me/skycoin_bsc       |
    | Can you touch the $SKY?            |
    |                                    |
    | OWNED AND OPERATED BY DALESSANDRO  |
    ====================================*/

abstract contract Project {
    address public marketingWallet = 0xCEdFD7e15ed61e2F2d629Cfa05A856EafbEA1Fb8;
    address public treasuryWallet = 0x01Ed3CF86B2f067DDf4C0795e006ad6118EC3A07;

    string constant _name = "SKY";
    string constant _symbol = "SKY";
...
contract ContractSKY is Project, IBEP20, Auth {
    using SafeMath for uint256;
