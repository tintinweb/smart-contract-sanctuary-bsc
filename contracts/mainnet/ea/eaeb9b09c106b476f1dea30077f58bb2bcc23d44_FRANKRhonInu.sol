...
contract FRANKRhonInu is FRANKDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FRANKTeam;
    address private CharityFRANK;
    ...
    string public override name = "Frank Inu";
    string public override symbol = "FRANK";
    ...
    constructor(uint totalSupplyValue, address FRANKTeamAddress, address CharityFRANKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FRANKTeam = FRANKTeamAddress;
        CharityFRANK = CharityFRANKAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FRANKTeam] =  totalSupply * 45 / 100;
        balances[CharityFRANK] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's FRANKTeam pot
