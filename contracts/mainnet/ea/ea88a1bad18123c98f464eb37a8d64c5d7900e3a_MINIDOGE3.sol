...
contract MINIDOGE3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI DOGE3.0";
    string private _symbol = "MDOGE3.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e8a0C68517c59357B780Ae04E4787546e2751df); 
    address payable public TeamWalletAddress = payable(0x8E8D64A757A6F070Db85F77d708493E934C59C16);
