...
contract LUNA2 is Context, IERC20, Ownable {
    ...
    string private _name = "LUNA2";
    string private _symbol = "LUNA2";
    
    uint256 public _burnFee = 30; //3% burn
    uint256 public _fundFee = 50; //5% fund
    uint256 public _mkFee = 50;   //5% fund
