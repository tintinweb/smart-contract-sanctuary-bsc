...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xd4669132eED0481C52Ff8617CD2672D98D936862); // BUSD
...
contract SquiadmasEve is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x25BEeD176919a1De86559f11cc9Dd65750ebA007;

    string constant _name = "Squidmas Eve";
    string constant _symbol = "SmasEve";
    ...
    uint256 public marketingFee    = 58;
