...
Telegram: https://t.me/metazillagrow
...
contract METAZILLAGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaZillaGROW";
    string private constant _symbol = "$MZGROW";
    ...
    constructor () {
        _MarketingWallet = payable(0xC58d1928594423e8798378027a4e1a72C7827B34);
        _liquidityWallet = payable(0xC58d1928594423e8798378027a4e1a72C7827B34);
        _devWallet = payable(0xC58d1928594423e8798378027a4e1a72C7827B34);
        ...
        emit Transfer(address(0xC58d1928594423e8798378027a4e1a72C7827B34), _msgSender(), _tTotal);
    }
