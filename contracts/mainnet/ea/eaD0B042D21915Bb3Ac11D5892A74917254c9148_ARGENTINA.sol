...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4BCDbeB2Fc6B4b0d47f08d954Efdd4E14f0420ab; // owner 
...
contract ARGENTINA is Context, IERC20, Ownable {
    ...
    string private _name = "CHAMPION ARGENTINA";
    string private _symbol = "CHAMPION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4BCDbeB2Fc6B4b0d47f08d954Efdd4E14f0420ab); // Marketing Address
    address payable public teamWalletAddress = payable(0x4BCDbeB2Fc6B4b0d47f08d954Efdd4E14f0420ab); // Team Address
