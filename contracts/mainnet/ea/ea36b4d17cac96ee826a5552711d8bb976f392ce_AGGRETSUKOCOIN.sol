...
/**
// AGGRETSUKO COIN - $AGGRETKO

    Welcome to Aggretsuko Coin! 

    Inspired on the Aggretsuko the Hyped Netflix Anime.

    We aim to be the new Meme token from BSC to reach the millions ! 

    Stealth Launch!
    Doxed dev - Owner of Cheems calls 🌟🚀

    ⭐️ 3D NFT COLLECTION 
    🚀 NFT STAKING 
    ⭐️ BUSD REWARDS
    🚀 P2E CASINO MINIGAMES

    New concept. Inovation within the MemeFactor.

    Our Socials:
    Telegram : https://t.me/AggretsukoCoinPortal
    Twitter : https://twitter.com/AggretsukoCoin
    Web: http://www.aggretsukocoin.com/
*
*
*/
...
contract AGGRETSUKOCOIN  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x6b679C52dA794BC87c9184e57378a5D7A2c2d249;
 
    string constant _name = "AGGRETSUKO COIN ";
    string constant _symbol = "$AGGRETKO";
