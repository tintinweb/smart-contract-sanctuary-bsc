...
contract TaigaKagamiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Taiga Kagami Inu";
    string private _symbol = "TKINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCa72f928c2FB789D5095fbBa2D591A256899f891); // Marketing Address
    address payable public teamWalletAddress = payable(0xCa72f928c2FB789D5095fbBa2D591A256899f891); // Team Address
