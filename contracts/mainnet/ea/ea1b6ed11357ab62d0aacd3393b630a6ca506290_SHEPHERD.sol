...
contract SHEPHERD is Context, IERC20, Ownable {
    ...
    string private _symbol = " $SINU2.0 "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe673167CCFf02BF4A3c4Cf5299FbF9B8B7Eb4fDe);
    address payable public teamWalletAddress = payable(0xe673167CCFf02BF4A3c4Cf5299FbF9B8B7Eb4fDe); 
