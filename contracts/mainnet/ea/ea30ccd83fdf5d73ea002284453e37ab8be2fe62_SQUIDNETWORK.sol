...
contract SQUIDNETWORK is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xFD4C06267Cd0Bef1E66Fc64a76B52390320ffCcE); 
    address payable private Wallet_Dev = payable(0xFD4C06267Cd0Bef1E66Fc64a76B52390320ffCcE);
    ...
    string private constant _name = "SQUID NETWORK"; 
    string private constant _symbol = "SQNET"; 
    ...
    constructor () {
        ...
        _owner = 0xFD4C06267Cd0Bef1E66Fc64a76B52390320ffCcE;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xFD4C06267Cd0Bef1E66Fc64a76B52390320ffCcE); // Testnet
