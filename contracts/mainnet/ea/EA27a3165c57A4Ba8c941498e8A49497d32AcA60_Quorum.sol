...
/*
Quorum is a free, lightning-fast, peer-to-peer, cross-chain transactional network for digital assets,
which enables other blockchain distributed ledgers to gain high TPS,
sub-second confirmations, zero transaction fee, and enhanced privacy.

Telegram : https://t.me/quorumnetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbfDD3037fC9269eEFb8e99ba4945d08C4D41257F;
...
contract Quorum is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xbfDD3037fC9269eEFb8e99ba4945d08C4D41257F);
    ...
    */
    ...
    string private _name = "QUORUM NETWORK"; 
    ...
    */
    ...
    function _set_Taxs(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    */
    ...
    function removeAllFee() private {
        if(_AllTax == 0 && _BuyTax == 0 && _SellTax == 0) return;


        _previousBuyFee = _BuyTax; 
        _previousSellFee = _SellTax; 
        _previousTotalFee = _AllTax;
        _BuyTax = 0;
        _SellTax = 0;
        _AllTax = 0;
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_AllTax = _BuyTax;} else if (to == uniswapV2Pair){_AllTax = _SellTax;}
    ...
    */
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tDev = tAmount*_AllTax/100;
