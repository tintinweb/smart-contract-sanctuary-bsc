...
TELEGRAM: https://t.me/saudshiryo
*/
...
contract SaudiShiryo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Shiryo"; // 
    string private constant _symbol = "SSO"; //    
