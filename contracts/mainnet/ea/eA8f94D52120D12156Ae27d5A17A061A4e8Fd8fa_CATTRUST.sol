...
contract CATTRUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatTrust";
    string private _symbol = "CT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3180855896CFF7828B1147E306cE2328ecF26548); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3180855896CFF7828B1147E306cE2328ecF26548); // BuyBack Address
    ...
    function staking(address newAddress) external virtual {
