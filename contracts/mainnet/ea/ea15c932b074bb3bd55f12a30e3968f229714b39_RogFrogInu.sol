...
Telegram : https://t.me/BADTOMinubsc
Website  : TBA
...
contract RogFrogInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeD90d20d5a953eE524249e540dd5C6618180A140); 
    address payable public Wallet_Dev = payable(0xeD90d20d5a953eE524249e540dd5C6618180A140);
    ...
    string private constant _name = "RogFrog INU"; 
    string private constant _symbol = unicode"$RogFrog"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 99;
    ...
    constructor () {
        ...
        _owner = 0xeD90d20d5a953eE524249e540dd5C6618180A140;
