...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA7A43fBd9921e35d68c452C8453DF7F3231D1255;
...
contract $Ninjaverse_Wallet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1B77295eD2308015A5020E4441C97Bdb14fBC9f8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 55100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ninjaverse Wallet";
    string private _symbol = "NVW";
    ...
    uint256 public _maxTxAmount = 55100000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 19285000 * 10**18;
