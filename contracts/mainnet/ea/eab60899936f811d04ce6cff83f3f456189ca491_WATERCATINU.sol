...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x057343CFB8fb036BE58FA3D3Ab595352Dff3eB21; // owner address
...
contract WATERCATINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WATER CAT INU 2.0";
    string private _symbol = "WCAT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Da5Ec1B875083015dAf33359a4549E0ff3341dC); // Marketing Address
    address payable public teamWalletAddress = payable(0x34199907705db2013a3A8fC024A16049d1519e9A); // Team Address
    ...
    uint256 public _teamShare = 6; // original 12
    ...
    uint256 public _walletMax = 3000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10000000000 * 10**3;
