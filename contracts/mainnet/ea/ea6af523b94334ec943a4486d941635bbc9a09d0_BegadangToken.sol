...
/**
    ...
    TG: https://t.me/BegadangPortal

    BEGADANG PROJECT
    BEGADANG STEALTH LAUNCH
    BEGADANG MOONSHOT
*/
...
contract BegadangToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCcCD07D6A24ABd34dFEF6B46Bd4A29b1A493c06f);
    address payable public teamWalletAddress = payable(0xCcCD07D6A24ABd34dFEF6B46Bd4A29b1A493c06f);
    ...
    string private _name = "BEGADANG TOKEN";
