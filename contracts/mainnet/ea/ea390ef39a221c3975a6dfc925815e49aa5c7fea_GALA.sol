...
contract GALA is Context, IERC20, Ownable {
    ...
    string private _name = "GALA2.0";
    string private _symbol = "GALA2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x76509Fe841c132FD50C7A6C8b1F0cDb55915A2AD); 
    address payable public BurnedWalletAddress = payable(0x76509Fe841c132FD50C7A6C8b1F0cDb55915A2AD); 
