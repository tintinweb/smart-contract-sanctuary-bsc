...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // sushiswap router on arbitrum - 0x10ED43C718714eb63d5aA57B78B54704E256024E
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)); // 
...
contract Pollux is ERC20, Ownable {
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 500000 && newValue <= 750000, " gasForProcessing must be between 200,000 and 500,000");
