...
contract ICO {
    ...
    function updateConfig(uint256 _price, uint256 _minAmount, uint256 _maxAmount, uint256 _endTime, uint256 _referralFee, uint256 _softCap, uint256 _hardCap)external onlyOwner {
        price = _price;
        minAmount = _minAmount;
        maxAmount = _maxAmount;
        endTime = _endTime;
