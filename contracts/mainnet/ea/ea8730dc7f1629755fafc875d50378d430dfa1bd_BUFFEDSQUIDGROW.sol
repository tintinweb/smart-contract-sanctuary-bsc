...
THE MOST POWERFUL MEME TOKEN RIDING THE SQUID HYPE TRAIN!
...
contract BUFFEDSQUIDGROW is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BUFFED SQUID GROW';
    string private constant _symbol = '$BSQUID';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 100 000 000 tokens
    ...
    //DevWallets
    address public Development=payable(0xCa7CE2541D602E824f7F77068e4D9EeE6e7BaAeb);
    address public Marketing=payable(0x40dF84c67E70f57d00dD7D98Ca93ff8ebB479dB2);
    //MainNet
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 4000000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingETH() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Development).transfer((amount*18) / 100);
        payable(Marketing).transfer((amount*82) / 100);
    } 
    function TeamWithdrawXMarketingETH(uint256 amount) public onlyOwner{
        require(amount<=marketingBalance);
        marketingBalance-=amount;
        payable(Development).transfer((amount*17) / 100);
        payable(Marketing).transfer((amount*83) / 100);
    } 
