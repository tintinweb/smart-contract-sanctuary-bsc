...
contract RatMoonBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x99b7bA8084776B0504D47c037D8173F2A4246e70); 
    address payable private Wallet_Dev = payable(0x99b7bA8084776B0504D47c037D8173F2A4246e70);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "RatMoon BSC"; 
    string private constant _symbol = unicode"RATMOON"; 
    ...
    constructor () {
        ...
        _owner = 0x99b7bA8084776B0504D47c037D8173F2A4246e70;
