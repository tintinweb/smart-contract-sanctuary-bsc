...
contract PreSaleVesting is Ownable {
    ...
    /* the cliff time of the Pre Sale vesting */
	...
	/* the whitelist of the Pre Sale vesting */
	...
	function _vestedAmount(address addr) private view returns (uint256) {
		...
		// linear part during 1 month cliff + 12 months
			...
			uint256 initialAmount = balanceOfINERY[addr].mul(20).div(100); // 20% after cliff time
