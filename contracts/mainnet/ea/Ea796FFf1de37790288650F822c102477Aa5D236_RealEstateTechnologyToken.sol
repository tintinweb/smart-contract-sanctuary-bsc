...
Staking:https://stakev2.rtechtoken.com
...
contract RealEstateTechnologyToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1C0b526bFEC789069989A296a2Cd8a629a98aD12); // Marketing Address
    address payable public charityAddress = payable(0xf6732cbF2db606474248eC1227249a59252Ec8f1); // Charity/Dev Address
    ...
    string private _name = "Real Estate Technology Token";
    string private _symbol = "$Rtech";
    ...
    uint256 public charityDivisor = 4; //
    bool public welcome = true;
    
    uint256 public _maxTxAmount = 100000000000000000000000 * 10**18;  //
    uint256 private minimumTokensBeforeSwap = 1000000000000000000000000 * 10**18;  //
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external  onlyOwner {
    ...
    function prepareForPreSale() external  {
        ...
        _liquidityFee = 0;
        _burnFee = 0;
        _maxTxAmount = 10000000000000000000 * 10**18;
    }
    ...
    function afterPreSale() external  {
        ...
        _liquidityFee = 0;
        _burnFee = 0;
        _maxTxAmount = 1000000000000000000000 * 10**18;
    }
