...
/**
Mini Whale is a token community with holder solidarity to share and create a solid and strong community.
with max buy and max wallet 0.5%
Telegram groups will be created when a solid community occurs during mc 5k
*/
...
contract MiniWhale is IBEP20, Auth {
    ...
    string constant _name = "Mini Whale";
    string constant _symbol = "MW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000;  //0.5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 1000;  //0.5% max wallet
    ...
    address private marketingFeeReceiver =0x3dd548911111338e8490240cca0DD47F5C5F0904;
    address private teamFeeReceiver =0x3dd548911111338e8490240cca0DD47F5C5F0904;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x3dd548911111338e8490240cca0DD47F5C5F0904;
