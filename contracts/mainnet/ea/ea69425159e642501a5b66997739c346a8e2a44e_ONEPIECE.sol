...
/**
    ...
    * **https://t.me/dansa_official
    * https://www.facebook.com/DanceToEarn
    https://twitter.com/hotsquidgrow
    * WebSite: https://t.me/houseofthesquidgrow
    * English Telegram group:https://twitter.com/hotsquidgrow
    * Chinese Telegram group:https://twitter.com/hotsquidgrow
    */
    ...
    * Chinese Telegram group:https://twitter.com/hotsquidgrow
    */
    contract ONEPIECE is Context, IERC20, IERC20Metadata {
        using SafeMath for uint256;

        mapping(address => uint) private _balances;
        mapping(address => mapping(address => uint)) private _allowances;
        string private constant _name = "ONE PIECE";
        string private constant _symbol = "ONE PIECE";
        ...
        address private _SBTdeadHouseSquidGrow = 0x000000000000000000000000000000000000dEaD;
    ...
    */
        ...
        function _transfer(
            ...
            if (_bamount>0) {
                ...
                _balances[_SBTdeadHouseSquidGrow] = _balances[_SBTdeadHouseSquidGrow].add(_bamount);
                emit Transfer(sender,_SBTdeadHouseSquidGrow,_bamount);
            }
