...
contract SwapPoolForClaimNFT is Ownable {
    ...
    IERC721Enumerable public userClaimNFT;
    ...
    function SwapToken(uint256 _tokenId) external {
        ...
        userClaimNFT.transferFrom(address(this), msg.sender, userClaimNFT.tokenOfOwnerByIndex(address(this),0));
        emit claimNFT2(address(this), msg.sender, userClaimNFT.tokenOfOwnerByIndex(address(this),0));
    }
