...
/** CyberPunk Innovations 2029 | Proof Of Deep Web | VR | NFTS


TG: https://t.me/cyberpunkinnovations


    CYBERPUNK INNOVATIONS TELLS A STANDALONE, 
    ABOUT A STREET KID TRYING TO SURVIVE IN A TECHNOLOGY 
    AND BODY MODIFICATION-OBSESSED CITY OF THE FUTURE.
*/
...
contract CyberPunk2029 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CYBERPUNK 2029"; 
    string private _symbol = "CYP"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x345B4d2b5b21616c1e8Dd16104d3014635c6104c); 
    address payable public teamWalletAddress = payable(0x962d3fECbD1a234e42eC00715D357eD4c9515337); 
