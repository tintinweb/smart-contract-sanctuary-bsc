...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD77f72d503Ad62b1722cd01643eBADEC2D85e249;
...
contract PepaFloki  is Context, IERC20, Ownable {
    ...
    string private _name = " Pepa Floki ";
    string private _symbol = " PEPAFLOKI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD77f72d503Ad62b1722cd01643eBADEC2D85e249);
    address payable public teamWalletAddress = payable(0xD77f72d503Ad62b1722cd01643eBADEC2D85e249);
