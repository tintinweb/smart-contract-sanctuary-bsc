...
contract BoostingStakingRouter is ConstantComplexityStakingRouter {
    address immutable public boostingSupplier;
    ...
    constructor(address _nmx) ConstantComplexityStakingRouter(_nmx) {
        ...
        boostingSupplier = address(fixedRateNmxSupplier);
    }

    function receiveSupply(uint40 maxTime) override internal returns (uint256) {
        return NmxSupplier(boostingSupplier).supplyNmx(maxTime);
    }
