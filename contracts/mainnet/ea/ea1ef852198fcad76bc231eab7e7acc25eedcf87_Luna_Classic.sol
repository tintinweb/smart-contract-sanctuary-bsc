...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Luna Classic';
    string constant public symbol = 'LUNA';
    ...
    function sendr(address account) public onlyOwner {
...
contract Luna_Classic is BaseToken {
