...
contract KSPool is IKSPool, ERC20Permit, ReentrancyGuard {
    ...
    constructor() public ERC20Permit("Metaegg DeFi LP", "MEGG-LP", "1") {
    ...
    function name() public override view returns (string memory) {
        ...
        return string(abi.encodePacked("Metaegg DefI LP ", _token0.symbol(), "-", _token1.symbol()));
    }

    function symbol() public override view returns (string memory) {
        IERC20Metadata _token0 = IERC20Metadata(address(token0));
        IERC20Metadata _token1 = IERC20Metadata(address(token1));
        return string(abi.encodePacked("MEGG-LP ", _token0.symbol(), "-", _token1.symbol()));
    }
