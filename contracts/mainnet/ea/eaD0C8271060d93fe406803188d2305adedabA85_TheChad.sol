...
contract TheChad is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TheChad", "CHAD") {
        ...
        marketingWallet = address(0x1B6CfD6978d0Dc9d46157B18ceBCDC70F4CC2880); // set as marketing wallet
