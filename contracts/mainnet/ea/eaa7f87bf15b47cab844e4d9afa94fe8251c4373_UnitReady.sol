...
contract UnitReady is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UnitReady";
    string private _symbol = "$UR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xBae2a2286e06AaE57dd332B9C681050DB164F537); 
    address payable public BurnedWalletAddress = payable(0xBae2a2286e06AaE57dd332B9C681050DB164F537); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply.mul(2).div(10**6);
