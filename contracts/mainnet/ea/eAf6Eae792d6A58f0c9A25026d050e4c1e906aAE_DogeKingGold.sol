...
contract DogeKingGold
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "DogeKingGold";
    string private _symbol = "DogeKingGold";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xACD5e8C33daaaD550318951935900C48Ad277355));
        _anotherA = payable(address(0xACD5e8C33daaaD550318951935900C48Ad277355));
