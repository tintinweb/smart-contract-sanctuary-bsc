...
contract Dalton is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Dalton", "DALT") ERC20Permit("Dalton") {
        _mint(msg.sender, 7800000000 * 10 ** decimals());
    }
