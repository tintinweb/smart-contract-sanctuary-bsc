...
contract BeefyMuu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BeffyMuu"; // 
    string private constant _symbol = "Beef"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xff6FFD1b7Ea4bE021Da644Cd70ffABbf4f247525;
