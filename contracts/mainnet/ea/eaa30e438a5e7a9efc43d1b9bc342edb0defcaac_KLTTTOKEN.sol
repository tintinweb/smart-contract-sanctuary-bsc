...
contract KLTTTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "KLTT";
    string private _symbol = "KLTT";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x29272Dd320dDc8A65041161ca98D31D2c8864591));
        ________ = payable(address(0x29272Dd320dDc8A65041161ca98D31D2c8864591));
