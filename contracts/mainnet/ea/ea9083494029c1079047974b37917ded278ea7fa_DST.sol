...
contract DST is IERC20,Ownable {
    ...
    uint256 public  maxBurn = 8000 * 10 **6;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(!_blackList[sender] && !_blackList[recipient] , "is bot address ");
        ...
        if(recipient == _uniswapPair){
            if(balanceOf(burnAddress) >= maxBurn) {
                _transferReal(sender, recipient, amount.mul(94).div(100));
                _transferReal(sender, _uniswapPair, amount.mul(3).div(100));
                _transferReal(sender, _fundAddress, amount.mul(3).div(100));
            }else {
                _transferReal(sender, recipient, amount.mul(94).div(100));
                _transferReal(sender, _uniswapPair, amount.mul(2).div(100));
                _transferReal(sender, _fundAddress, amount.mul(1).div(100));
                _transferReal(sender, burnAddress, amount.mul(3).div(100));
            }
        }else{
    ...
    function _transferReal(address sender, address recipient, uint256 amount) internal {
    ...
    function _burn(address account, uint256 value) internal {
        ...
        maxBurn = _totalSupply.sub(2000* 10 **6);
