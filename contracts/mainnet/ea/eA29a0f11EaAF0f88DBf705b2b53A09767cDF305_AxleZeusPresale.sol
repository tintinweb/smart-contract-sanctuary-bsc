...
contract AxleZeusPresale is Ownable {
    ...
    uint256 public referRewardpercentage = 5;
    uint256 public bonusRewardpercentage = 25;

    //@dev ERC20 token address and decimals
    address payable public mainWallet = payable(0x2a2A8c7cF19867B9ab170fda864401EcA446CE39);
    address public tokenAddress=0x7c56C79a454CBFaf63BAdb39f82555109a2A80Bf;
    ...
    uint256 public minEthLimit = 200000000000000000;
    ...
    function buyToken() public payable returns (address) {
        ...
        uint256 tokenAmountWithbonusReward = tokenAmount + tokenAmount.mul(bonusRewardpercentage).div(100);

        require( IToken(tokenAddress).transfer(msg.sender, tokenAmountWithbonusReward),
                "Insufficient balance of presale contract!" );

        tokenSold += tokenAmountWithbonusReward;
