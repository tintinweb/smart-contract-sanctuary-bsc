...
contract BabyArgentinU  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Baby ArgentinU ";
    string private _symbol = " $BTINU "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46D8364588fc4C0a2504a5ff09f0d7080115b9D9); 
    address payable public teamWalletAddress = payable(0x46D8364588fc4C0a2504a5ff09f0d7080115b9D9); 
