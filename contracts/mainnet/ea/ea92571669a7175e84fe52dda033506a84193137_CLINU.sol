...
/**
TOKEN NAME: CloudChat Inu
TICKER: $CLINU

Welcome! Grab a bag, chill and help us spread the word. Launched by safe, vouched for, experienced well known developer + İnfluencer in the cryptocurrency space. 
CloudChat Inu is a safe community meme coin based off the hype & meta of social media names with inu attached to the end going around the crypto space right now. 
This token was also launched in FULL support of the official & one and only CloudChat Token which recently launched and ran from 2 MILLION MCAP to over 80 MILLION MCAP within the first 42 hours of launch!

TOTAL SUPPLY: 100,000,000 (of course)

Buy/Sell Tax: 7/7 (Higher buy and sell tax FIRST hour to prevent bots and help build up marketing funds)


1.5% max TRX, 1.5% max wallet

Telegram: https://t.me/CloudChatPortal
Twitter:  https://twitter.com/CloudChatInu
Website:  https://CloudChat.com
*/
...
contract CLINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "CloudChat Inu";
