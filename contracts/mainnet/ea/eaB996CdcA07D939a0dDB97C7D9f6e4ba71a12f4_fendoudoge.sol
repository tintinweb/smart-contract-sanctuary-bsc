...
contract fendoudoge is Context, IERC20, Ownable {
    ...
    string private _name = unicode" Fen Dou Doge";
    string private _symbol = unicode"Fen Dou Doge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xafcE3aB6C4af08c6adB2fbDCD701b1B501F6E02E);
