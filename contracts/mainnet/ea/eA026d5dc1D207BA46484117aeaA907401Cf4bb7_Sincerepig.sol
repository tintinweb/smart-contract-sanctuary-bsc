...
contract Sincerepig is Context, IERC20, Ownable {
    ...
    string private _name = "Sincere pig";
    string private _symbol = "SPig";
    uint8 private _decimals = 3;

    address payable private marketingWalletAddress = payable(0x4D46bd0310e9A7451D1d59c83A2e5b7164999999); 
    address payable private teamWalletAddress = payable(0x4D46bd0310e9A7451D1d59c83A2e5b7164999999); 
