...
abstract contract AbsToken is ERC20, Ownable {
    ...
    uint256 private numTokensCanSwap = 200000 * 10**18;
    ...
    constructor (
        ...
        address FundAddress, address TeamRewards, address LPAddress
    ) ERC20(Name, Symbol) {
        ...
        _mint(address(LPAddress),Supply * (650) / (1000));
        _mint(address(TeamRewards),Supply * (25) / (1000));
        _mint(address(deadWallet),Supply * (325) / (1000));
        totalBurn += Supply * (325) / (1000);
...
contract OnlyChain is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        "Only Chain",//Name
        "OC",//Symbol
        2000000000 * 10**18,//Supply
        address(0xa2B9b40DfF4dBcACB57583e9F92d5e0F8cE98170),//FundAddress
        address(0xD7400BC0113436d2D7EA1Cd6cA8C0BBaCe9F31F2),//TeamRewards
        address(0x57Ff93FCFCdB5AB53889Ba4b83C84315D683f3A5)//LPAddress
    ){
