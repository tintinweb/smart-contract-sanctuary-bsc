...
Telegram: https://t.me/spookybrunettes
...
contract SPOOKYBRUNETTES is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPOOKY BRUNETTES"; // 
    string private constant _symbol = "$SBrunettes"; //    
