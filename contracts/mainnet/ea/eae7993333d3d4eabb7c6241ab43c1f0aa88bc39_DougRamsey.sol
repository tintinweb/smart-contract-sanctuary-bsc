...
/*
https://t.me/DobermanPortal
*/

/*
https://dobermaninu.online
*/
...
contract DougRamsey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doug Ramsey";
    string private _symbol = "$BYND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B08cB96130AB7F93EA37cEa4559580A126ddAdb); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x0B08cB96130AB7F93EA37cEa4559580A126ddAdb); // Team Address
