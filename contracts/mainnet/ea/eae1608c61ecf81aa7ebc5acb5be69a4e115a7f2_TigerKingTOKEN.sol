...
contract TigerKingTOKEN is ERC20, Ownable  {
    mapping (address => bool) private _isExcludedFromFee;

    uint256 private constant total =  3000 * 1e1 * 1e18  ;

    address public constant marketAddress = 0xd8246958C07bD0b448F7B08b7CC85B9eDee8b2a4;
    uint256 public constant _liquidityFee = 5;
    uint256 public constant _buymarketFee = 3;
    uint256 public constant _sellmarketFee = 8;
    ...
    uint256 public minDistribution = total / 600;

    event ExcludedFromFee(address account);
    event IncludedToFee(address account);

    constructor() ERC20("TigerKing TOKEN", "TigerKing") {
