...
/**
 * Contract: SRG20 
 * https://t.me/charityforturkey
Charity for Turkey is a token aimed at helping the recent earthquake victims.
The token collects funds for the victims and all taxes generated will be donated to on-the-ground ONG to meet the needs of the affected people.
By investing in the token, you are giving help to those in need. 
The crypto community can make a significant difference for these people by using the token to provide food and medicine and support rebuilding efforts.
Join us and help the earthquake victims get back on their feet and regain hope for the future by investing in Charity for Turkey.
 */
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "CHARITY FOR TURKEY";
    ...
    //Tax wallets
    address public teamWallet = 0xAD961282E86C5B5d3D1c75a8496D023c00127209;
    address public treasuryWallet = 0xAD961282E86C5B5d3D1c75a8496D023c00127209;
