...
TG: https://t.me/OctoCats


1 mill Total Supply
20k max wallet (will raise to 30k after launch)
10k max tran (will raise to 20k after launch)

10% Buy 
10% Sell (will be higher at launch)
...
contract OctoCats is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Octo Cats';
    string private constant _symbol = 'octo';
    ...
    //DevWallets
    address public Development=payable(0x79f251B148716479017c5916e0150c3Be5cBC7bb);
    address public Marketing=payable(0x79f251B148716479017c5916e0150c3Be5cBC7bb);
    //TestNet
