...
contract BSHIBDAO is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "BABY SHIBA INU DAO";
    string public symbol = "BSHIBDAO";
    ...
    constructor() public {
        _decimals = 9;
        _totalSupply = 996553252663 * 10 ** 9;
