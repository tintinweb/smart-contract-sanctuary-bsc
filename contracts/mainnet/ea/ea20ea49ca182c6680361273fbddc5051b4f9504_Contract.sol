...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doraemon Christmas"; //
    string private constant _symbol = "Doraemon"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x434FfABAf3b43f2BAC9e3C0bE9B5a1d54813fb04;
