...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x842603b67CAc5AA12Ec0945A4ee32a0AE231b2DD;
...
contract QL is AbsToken {
    constructor() AbsToken(
        ...
        address(0xd481f44ffeD7B82e87D06CD42fE3c06dA762ea82),
    
        address(0x8097E366F4bbB299DC170777443e226f7d3C8A30)
    ){
