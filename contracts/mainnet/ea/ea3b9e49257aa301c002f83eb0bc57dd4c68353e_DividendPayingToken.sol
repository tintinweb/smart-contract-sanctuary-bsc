...
contract MoceansDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("BLOCKPAY", "BTRACKER", _rewardTokenAddress) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * (10 ** 18); 
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "BTRACKER: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BTRACKER: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
...
contract BLOCKPAY is ERC20, Ownable {
