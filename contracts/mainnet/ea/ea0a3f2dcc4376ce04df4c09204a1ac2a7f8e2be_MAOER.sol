...
contract MAOER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MAOER";
    string private _symbol = "MAOER";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xBbE866b81f74E7Ab7A10cD691BC14E8E627D9ce8); // Marketing Address
    address payable public teamWalletAddress = payable(0xBbE866b81f74E7Ab7A10cD691BC14E8E627D9ce8); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xBbE866b81f74E7Ab7A10cD691BC14E8E627D9ce8),
            block.timestamp
        );
    }
