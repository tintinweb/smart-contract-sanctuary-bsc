...
//Telegram : https://t.me/hokujirutwo
...
contract hokujirutwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hokujiru2.0"; // 
    string private constant _symbol = "HOKUJIRU  @.0"; //    
