...
contract LpoolContract is Ownable {
	...
	/* the balances (in INERY) of all lpool members */
	mapping(address => uint256) public balanceOfINERY;

	/* the whitelist of the Lpool Contract */
    ...
    function transfer(address addr) external afterClosed {
