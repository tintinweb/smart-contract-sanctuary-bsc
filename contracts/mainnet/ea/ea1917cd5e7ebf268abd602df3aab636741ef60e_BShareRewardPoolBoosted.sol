...
contract BShareRewardPoolBoosted {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        require(_bShare != address(0), "_bShare");
        require(_treasury != address(0), "_treasury");
        bShare = IERC20(_bShare);
        treasury = _treasury;
        bSharePerSecond = TOTAL_REWARDS.div(365).div(24).div(60).div(60);   
    ...
    function setTaxTiersEntry(uint8 _index, uint256 _value) external onlyOperator {
        ...
        require(_value >= 10 && _value <= 1000, "_value: out of range"); // [0.1%, 20%]
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            if (enableTaxes && taxAmount != 0) {
                pool.token.safeTransfer(treasury, taxAmount);
