...
contract sincerecat is Context, IERC20, Ownable {
    ...
    string private _symbol = "SinCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x737110229F4ae0b7Dd6d81077f1df6554560C367); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCc6DAac8B864b9C590A6b4C1C04E2176E549d468); // BuyBack Address
