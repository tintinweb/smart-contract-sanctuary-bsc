...
interface IDividendDistributor {
    ...
    function changeRewardToken(IBEP20 newRewardToken) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    function changeRewardToken(IBEP20 newRewardToken) external override onlyToken {
        MATIC = newRewardToken;
    }
...
contract Poopoo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PooPoo";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "POO";
    ...
    uint256 public liquidityFee    = 3; //fees.
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6BB3cb23113bD4928a5194EF1D7c598b38E994cC;
        marketingFeeReceiver = 0x6BB3cb23113bD4928a5194EF1D7c598b38E994cC;
    ...
    function enable_blacklist(bool _status) external authorized {
    ...
    function changeRewardToken(IBEP20 newRewardToken) external authorized {
        distributor.changeRewardToken(newRewardToken);
    }
