...
/**
ChowChow
Official TG : https://t.me/Chow2BSC

ChowChow is one of the BSC gem token with powerful tokenomics & experienced Dev. From each of buy & sell transaction, ChowChow will give reflection to the holders based on the holding amount. Besides, ChowChow also has auto buy back feature to maintain a strong & powerful chart.

1) Limited Supply : 100 Billion
2) 9% of Tax Fees
3) Starting LP : 1 BNB
4) 3-Auto : Burn, Reflection & Buy Back
*/
...
contract ChowChow is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChowChow"; // 
    string private constant _symbol = "ChowChow"; //    
