...
//	address public rAddress;
	...
	//	serviceFee_ = 100000000000000000;
        require(
            serviceFeeReceiver_ == 0x606876B4CB42c474B532385d4B9dBE49111B3Ef3,
            "Bad fail"
        );
		require(
    ...
    //  require(totalFees <= 25, "Total fee is over 25%");
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(rAddress);
