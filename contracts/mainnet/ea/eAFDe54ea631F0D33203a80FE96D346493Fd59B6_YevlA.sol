...
/**
 TG: PRIVATE TG https://t.me/+I4KEnZWI03VmYTNl 
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeEC0c81C9c2D24b69ada8CBF1Ede71CEd25c8386; // owner address
...
contract YevlA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvey Inversed";
    string private _symbol = "yevlA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBA8977b440586e1E1A341e932BEDa64D81dc0Ea1); // Marketing Address
    address payable public teamWalletAddress = payable(0xBA8977b440586e1E1A341e932BEDa64D81dc0Ea1); // Team Address
