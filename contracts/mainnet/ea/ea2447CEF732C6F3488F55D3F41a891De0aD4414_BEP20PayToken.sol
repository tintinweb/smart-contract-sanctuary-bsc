...
contract BEP20PayToken is Ownable{
    ...
    IUniswapV2Router02 public immutable uniswapV2Router = IUniswapV2Router02(uniswapRouterV2Address);

    address private _usdtAddress = address(0x55d398326f99059fF775485246999027B3197955);
    address private _token = address(0x8e2Dcb8d38F07f11B84e92900bF5867202696E67);
    ...
    function payToken(uint amount) external returns(bool){
        ...
        uint _remainAmount = amount.mul(45).div(100);
        IERC20(_usdtAddress).transferFrom(sender, address(this), _remainAmount);
        //购买
        uint _buyAmount = amount.sub(_feeAmount).sub(_remainAmount);
