...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0D6CFe6f9000f667f9910C9229aDd7947032c424; //
...
contract token is Context, IERC20, Ownable {
    ...
    string private constant _name = "MEAN"; // 
    string private constant _symbol = "MEAN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _markerFee = 5; //
    uint256 public _LPFee = 0; //
    address payable public  _makerAddress = payable(0x0D6CFe6f9000f667f9910C9229aDd7947032c424); //
    ...
    constructor () {
        ...
        _isExcludedFromFee[_makerAddress] = true;
        
        isWalletLimitExempt[owner()] = true;
        isWalletLimitExempt[address(uniswapV2Pair)] = true;
        isWalletLimitExempt[address(this)] = true;
        isWalletLimitExempt[_makerAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[_makerAddress] = true;
