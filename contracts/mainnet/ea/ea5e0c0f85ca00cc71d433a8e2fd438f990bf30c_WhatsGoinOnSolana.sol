...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3890672cC2CcbDAA3e7aBaBae29ff13B12Bc92Dc; // owner address
...
contract WhatsGoinOnSolana is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WHATS GOIN ON SOLANA";
    string private _symbol = "$WGOS"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB12Ad9b3D19d990b22C4D8CFA40af9640499bc59); // Marketing Address
    address payable public teamWalletAddress = payable(0xB12Ad9b3D19d990b22C4D8CFA40af9640499bc59); // Team Address
