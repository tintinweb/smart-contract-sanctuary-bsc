...
contract CyberCat is Context, IBEP20, Ownable {
    ...
    uint256 public  _liquidityFee = 6; // ZERO tax for transfering tokens
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 1000 / 10000; // 5% of total supply
    ...
    constructor () {
        ...
        // change this
        _marketingWallet = 0x30593de9054eDE20D176Cd54F051BE4643cbeBF7;
        ...
        _isExcludedFromAntiWhale[address(0x30593de9054eDE20D176Cd54F051BE4643cbeBF7)]            = true;

        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x30593de9054eDE20D176Cd54F051BE4643cbeBF7)] = true;
