...
contract TwitterBack is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterBack";
    string private _symbol = "TwitterBack";
    ...
    address public burnAddress = 0x7BbCF6677E5b032F8E4A008b700aba943C3F79BF;
    address payable private _marketingWallet = payable(0x4A4e75250f87Aa71628bc1B98e487d0d21993219);
    address payable private _devWallet = payable(0x7BbCF6677E5b032F8E4A008b700aba943C3F79BF);
