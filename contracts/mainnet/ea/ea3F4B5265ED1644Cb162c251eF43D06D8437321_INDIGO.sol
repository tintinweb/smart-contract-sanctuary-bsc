...
contract INDIGO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2FaEE3a5A082cfA2b56508C0f30f6a984508Ef3b); 
    address payable public developmentAddress = payable(0x2FaEE3a5A082cfA2b56508C0f30f6a984508Ef3b); 
    address payable public charityAddress = payable(0x2FaEE3a5A082cfA2b56508C0f30f6a984508Ef3b); 
    address payable public vaultRewardAddress = payable(0x2FaEE3a5A082cfA2b56508C0f30f6a984508Ef3b); 
    ...
    string private constant _name = "INDIGO CASH";
    string private constant _symbol = "INDIGO";
