...
contract TokenMasksLabs is ERC721A, Ownable, DefaultOperatorFilterer{
    ...
    constructor(
    ) ERC721A ('Binance MASKS','BM'){// コレクション名：　ETH MASKS、　トークンの名前：EM
        setBaseURI('https://nftstorage.link/ipfs/bafybeifg4ukd2tir24ukmzqj7ob7mkwaylt7rcrqbdzhn6bvemf4sgalae/');
    }
