...
contract scale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x59F1C071285bA95A28Ef4876a9B21b56941d4f5E); // Marketing Address
    ...
    string private _name = "scale";
    string private _symbol = "scale";
    ...
    uint256 public _maxTxAmountSell = 100000000000000 * 10**9;
