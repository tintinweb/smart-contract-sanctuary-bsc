...
contract NoriGOUSDBetaV1 is ERC20, Ownable {
    ...
    constructor() ERC20("NoriGO! USD Placeholder V1", "USD V1") {
        uint256 totalSupply = 100 * 1e9 * 1e18;

        // update this!
        address newOwner = address(0xb4f14AC4e1b4Aae8Cc58cbf6A02663E8d4B7D708);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(_isExcludedFromFees[from] || _isExcludedFromFees[to], "Transfers to/from unexcluded address not allowed.");
