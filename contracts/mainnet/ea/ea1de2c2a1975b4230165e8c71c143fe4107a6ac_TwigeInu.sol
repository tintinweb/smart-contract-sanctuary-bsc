...
contract TwigeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Twige Inu ";
    string private _symbol = " $TWIGE "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48974d30d46f5E038eD417F458d5cb2E5e02a276); 
    address payable public teamWalletAddress = payable(0x48974d30d46f5E038eD417F458d5cb2E5e02a276); 
