...
/**
    ...
    Telegram  : https://t.me/Ftx1996Portal

    基于币安智能链网络的 MEME Utility 代币。

    该项目是社区驱动的令牌，专为与社区一起生活和成长的旧 BSC 风格而制作。 Swap Utility 即将上线。
...
contract FTX1996 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xab2FC6c5e719EBE0df4F26728fe1dA6C154Fb1dC);
    address payable public teamWalletAddress = payable(0x3082212a1B15e721eF7612632465bE3aE0FBB8C3);
    ...
    string private _name = "FTX 1996";
    string private _symbol = "FTX 1996";
