...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x86Ab25F1AeEA4B51DC7c83E2882D5a38CfA0C080;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x86Ab25F1AeEA4B51DC7c83E2882D5a38CfA0C080),//fund address
    
        address(0x86Ab25F1AeEA4B51DC7c83E2882D5a38CfA0C080)//dev address
    ){
