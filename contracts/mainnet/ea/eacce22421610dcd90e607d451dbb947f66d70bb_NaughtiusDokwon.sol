...
contract NaughtiusDokwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Naughtius Dokwon";
    string private _symbol = "Naughtius Dokwon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32F27d69C4Ac5e0267B4B57deE522A26C784Be77); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x32F27d69C4Ac5e0267B4B57deE522A26C784Be77); // buyback Address
