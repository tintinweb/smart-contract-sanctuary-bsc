...
contract HolyAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Holy AI";
    ...
    function marketPairingTrue() public {
        isMarketPairing = true;
    }

   function marketPairingFalse() public {
        require(_isExcludedFromFee[msg.sender]);
        isMarketPairing = false;
    }
