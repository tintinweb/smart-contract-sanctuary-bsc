...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BUSD = IBEP20(0x32006fcD2842C78E8Ee61A7Ce825D22D06756d7C); //reward ca can be changed any
...
contract BabyMecha is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUSD = 0x32006fcD2842C78E8Ee61A7Ce825D22D06756d7C; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby MechaZilla";
   string constant _symbol = "BMechaZilla";
...
uint256 reflectionFee = 3;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xf27284AAb7102769d38d171DcFCfB0ffcebE3B86; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xf27284AAb7102769d38d171DcFCfB0ffcebE3B86; //Can be change to any wallet you want
       marketingFeeReceiver = 0xC43Da74a2C72B7F2EF11f1b94cBe28e01d1294Ba; //Can be change to any wallet you want
