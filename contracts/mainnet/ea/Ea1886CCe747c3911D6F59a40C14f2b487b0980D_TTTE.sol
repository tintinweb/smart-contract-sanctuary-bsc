...
contract TTTE is ERC20, ERC20Pausable, ERC20Burnable, ERC20Capped, ERC20Snapshot, Ownable {
    ...
    constructor() ERC20("TestTelegramToken100", "TTTE100") ERC20Capped(_maxTotalSupply) {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20, ERC20Pausable, ERC20Snapshot) {
     ...
     function airDrop(address [] memory airDropAddress) public onlyOwner mAirDrop() {
    ...
    function payInvest(address recipient, uint256 amount) public onlyOwner mInvesting(amount) {
        // require(paidInvestments + amount <= _maxPaidInvestments, "You can not release more");
        _mint(recipient, amount);
        paidInvestments += amount;
    }

    modifier mInvesting(uint256 amount) {
        require(paidInvestments + amount <= _maxPaidInvestments, "You can not release more");
        _;
    }
