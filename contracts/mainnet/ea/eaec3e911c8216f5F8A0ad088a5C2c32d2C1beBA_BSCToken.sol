...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xee1b66689ebaA7b5ca7E841c031530e8AeF05066; // owner address
...
contract BSCToken is Context, IERC20, Ownable {
    ...
    string private _name = "2048";
    string private _symbol = "2048";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xee1b66689ebaA7b5ca7E841c031530e8AeF05066); // Marketing Address
    address payable public teamWalletAddress = payable(0xee1b66689ebaA7b5ca7E841c031530e8AeF05066); // Team Address
    ...
    uint256 private _totalSupply = 2048000000 * 10**_decimals;
