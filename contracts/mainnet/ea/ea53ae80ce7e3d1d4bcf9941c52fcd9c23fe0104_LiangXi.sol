...
contract LiangXi is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x7216a7B12D9dF793537F6D8C26e87bD34AdD581C);
    address payable private _marketingAddress = payable(0x7216a7B12D9dF793537F6D8C26e87bD34AdD581C);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 90, "Redis cannot be more than 90.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 4.");
	    require(taxFeeOnSell < 90, "Tax cannot be more than 90.");
