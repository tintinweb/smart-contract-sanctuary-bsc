...
contract GifKong is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GifKong";
    string constant _symbol = "GifKong";
    ...
    uint256 giveawayFeeBuy     = 2;
    uint256 public totalFeeBuy = 10; //Total Fee
    uint256 feeDenominatorBuy  = 100;

    uint256 liquidityFeeSell    = 22;
    uint256 reflectionFeeSell   = 0;
    uint256 marketingFeeSell    = 22;
    uint256 teamFeeSell         = 33;
    uint256 giveawayFeeSell     = 22;
    uint256 public totalFeeSell = 99; //Total Fee
