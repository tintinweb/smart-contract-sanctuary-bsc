...
contract SQUIDRATBOY is Context, IERC20 { 
    ...
    string private constant _name = "SQUID RAT BOY"; 
    string private constant _symbol = unicode"SQUIDRATBOY"; 
