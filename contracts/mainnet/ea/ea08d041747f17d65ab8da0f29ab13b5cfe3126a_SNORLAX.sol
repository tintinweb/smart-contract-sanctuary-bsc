...
*/
/**
 Telegram https://t.me/snorlaxinuportal
*/
...
contract SNORLAX is IBEP20, Auth {
    ...
    string constant _symbol = "SNORLAX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * (10 ** _decimals);     // total supply setting
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100;     // 2% supply max transaction
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;   // 2% supply max wallet hold
    ...
    address private marketingFeeReceiver = 0x6676442De1d751003f6F076791077246F551DD2B;
    address private buybackFeeReceiver = 0x6676442De1d751003f6F076791077246F551DD2B;
