...
Zurica Network is a project that builds a security system on the blockchain, in a utility feature that will be created (ZRC WALLET) and not only wallet utilities that we have, we also have staking, farming, and swap features (all in the wallet) into 1!

ZRC Decentralized Finance

▫️Bridge 
▫️Farm,Staking,Yield Up to 258%
▫️WEB 3 App
▫️Layer 2 Blockchain
▫️ZRC Wallet
 https://t.me/ZuricaNetwork
 https://twitter.com/ZuricaNetwork
*/
...
contract ZuricaNetwork is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xAF93Ee6B28306F420c227e1A31c42Eb16A0f4837);
    ...
    */
    ...
    string private _name = "Zurica Network"; 
    string private _symbol = "ZRC";  
