...
contract Universe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Metamen";
    string private constant _symbol = "MTM";

    address public _PancakeSwapV1RouterUniswap = 0xf27013b4B3Db21F3e486C48441B2676E8Ff78E3a; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xf27013b4B3Db21F3e486C48441B2676E8Ff78E3a; //can be the same

    uint256 private _tTotal = 500 * 10**_decimals;     // Supply do Token = 280 millions
