...
/*
   Fat SamuraInuは、何らかの理由で2023年の最高のミームコインとして主張しました.
   背後にあるベースのチーム、十分につながっており、適切な以前のプロジェクトがあります。 
   Fat SamuraInu は、クリーンな契約、所有権の放棄、低税率、最高の 
   LP ロッカーで所有者を保護します。 1000倍のムーンショットをお見逃しなく！
   電報: https://t.me/FatSamuraInu
...
contract FATSAINU is ERC20, Ownable {
    ...
    constructor() ERC20("FatSamuraInu", "FATSAINU") {
        ...
        devWallet = address(0x93c5Abba01A6B16f966fDb2D60dC84a8604386Cc); 
