...
contract STEALTHSQUID is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "Stealth Squid";
string private _symbol = "STEALTHSQUID";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0x386Ec36DD89B6De1b4d36b1D4E03709eCD4d4780); // Marketing Address
address payable private TeamWallet = payable(0x386Ec36DD89B6De1b4d36b1D4E03709eCD4d4780); // Buy Back Address
