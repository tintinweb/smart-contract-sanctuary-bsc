...
abstract contract LpFee is Owned, DexBase, ERC20 {
    ...
    function shouldSwapToSUN(address sender) internal view returns (bool) {
    ...
    function swapAndToSun() internal lockTheSwap {
        uint256 swapAmount = balanceOf[address(distributor)];
        super._transfer(address(distributor), address(this), swapAmount);
...
contract MercuryToken is ExcludedFromFeeList, LpFee {
    uint256 private constant _totalSupply = 99999 * 1e18;
    ...
    constructor() ERC20("MERCURY", "MERCURY", 18) LpFee(2 * 1e18) {
