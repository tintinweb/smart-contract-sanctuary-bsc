...
library Address{
 ...
 contract ShikokuGrow is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 1000_000_000_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 666_666_666_666 * 10**9;
    uint256 public maxBuyLimit = 1000_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 1000_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 1000_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xf4837bFEa0ECeE45D12438A95016c5219a991898;
    address public donationWallet = 0xf4837bFEa0ECeE45D12438A95016c5219a991898;

    string private constant _name = "ShikokuGrow";
    string private constant _symbol = "ShikokuGrow";
    ...
    Taxes public taxes = Taxes(1, 5, 3, 0);
    Taxes public sellTaxes = Taxes(1, 5, 3, 0);
