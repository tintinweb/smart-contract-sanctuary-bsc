...
contract MasterCastle is Ownable {
    ...
    uint256 public constant POISON_CAP = 1600000000000000000000000;
    ...
    function deposit(uint256 _pid, uint256 _amount) external {
        ...
        if (hodler == true) {
            require(
                Poison.balanceOf(msg.sender) >= 500000000000000000000,
        ...
        if (block.timestamp > (startTime + 5 days) && pending > 0) {
    ...
    function burn(uint256 _amount) external {
        ...
        Poison.burn(collector, _amount);       
    }

    function setHodler(bool _hodler) external onlyOwner {       
        hodler = _hodler;
    }
