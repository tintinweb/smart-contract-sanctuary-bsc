...
contract RedEmpTion is Ownable {
    ...
    function initRedEmpTionDown(uint256 minimumDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumDividends = minimumDividends;
    }

    function setExcludeRedEmpTion(address account) external onlyOwner {
	...
	function processRedEmpTionIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
