...
Telegram: https://t.me/halfshibainubsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x39D9Ae96aC89A56302EA2C91A309f16Cd346ce98;
...
contract HALFSHIBAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALF SHIBA INU"; // 
    string private constant _symbol = "SHIB.5"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x39D9Ae96aC89A56302EA2C91A309f16Cd346ce98);
