...
contract $CATFACE is Context, IERC20, Ownable {
    ...
    string private _name = "$CATFACE";
    string private _symbol = "SCF";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xB1660c06F1632606Dc79676f1AC2808b500b6eE3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xB1660c06F1632606Dc79676f1AC2808b500b6eE3); // BuyBack Address
