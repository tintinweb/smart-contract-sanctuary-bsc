...
contract BabyBusdPrinter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyBusdPrinter", "PFP") {
        marketingWallet = payable(0xBba372fF8F57428385cD5Ab409C0F0632dCa02b4);
        devWallet = payable(0xBba372fF8F57428385cD5Ab409C0F0632dCa02b4);
        ...
        uint256 totalTokenSupply = (500_000) * (10**18);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;
     ...
     BabyBusdPrinter public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BabyBusdPrinter(mainContract);
