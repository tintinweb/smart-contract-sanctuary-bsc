...
contract BeerusPurpleCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BeerusPurpleCat";
    string private _symbol = "BPCAT";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x9F930cA5714c391De5D5D654A57709b90323170B); 
    address payable public teamWalletAddress = payable(0x9F930cA5714c391De5D5D654A57709b90323170B); 
