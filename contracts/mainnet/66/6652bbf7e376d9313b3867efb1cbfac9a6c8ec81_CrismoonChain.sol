...
contract CrismoonChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4856940bE5BE6B78837D15622E665D2bFE8277Bc); // Marketing Address
    address payable public charityAddress = payable(0x4856940bE5BE6B78837D15622E665D2bFE8277Bc); // Charity/Dev Address
    ...
    string private _name = "CrismoonChain";
    ...
    uint256 public _maxTxAmount = 5000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 1500000000000000000000; // 150; token will be given on airdrop
    ...
    uint256 private salePrice = 1000000;// 0.01*1500000=15,000 token for 0.01 bnb (set as per requirements)
