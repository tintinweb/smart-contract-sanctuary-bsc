...
contract BabyCOCA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCOCA";
    string private _symbol = "BabyCOCA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x64a2dCd98B5C9a61C5ca9801D24bEf26B3FdE1e8); 
    address payable public BurnedWalletAddress = payable(0x64a2dCd98B5C9a61C5ca9801D24bEf26B3FdE1e8); 
