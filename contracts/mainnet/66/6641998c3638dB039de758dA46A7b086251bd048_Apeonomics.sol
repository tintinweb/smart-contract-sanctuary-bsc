...
contract Apeonomics is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xb00Da178f18eF7Ea06d55c510bAEaA4D1323Ee9B);

    string private _name = "Apeonomics";
    string private _symbol = "APEONOMICS";
    ...
    uint256 public _maxWalletHoldingAmount = 2000000000 * 10**18;
