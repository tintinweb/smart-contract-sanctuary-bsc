...
contract HANNYA is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1000000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 20000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 20000000000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1000000000000000000000 * 10**3;
