...
contract  PugZillainu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PugZilla Inu";
    string private _symbol = "PZINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1499fCC074eCd5A72bdEbf2e70EaD348220BA161); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1499fCC074eCd5A72bdEbf2e70EaD348220BA161); // BuyBack Address
