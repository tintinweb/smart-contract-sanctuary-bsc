...
contract babyad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babyad";
    string private _symbol = "babyad";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9F9eA665679DcC7bAc09FC3d19e9fef4F6B48CAa); 
    address payable public BurnedWalletAddress = payable(0x9F9eA665679DcC7bAc09FC3d19e9fef4F6B48CAa); 
