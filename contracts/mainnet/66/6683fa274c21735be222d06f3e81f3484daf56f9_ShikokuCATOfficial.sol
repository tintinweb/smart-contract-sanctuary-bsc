...
/**
TG: https://t.me/shikokucatofficial
Max Hold : 20,000,000
Max Buy : 20,000,000
DEV : @CJTROY22
DYOR / TYOR
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x903d9e0e8900158ca9a245585643B1AD9C2a234A; // owner address
...
contract ShikokuCATOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikoku Cat";
    string private _symbol = "$SC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x903d9e0e8900158ca9a245585643B1AD9C2a234A); // Marketing Address
    address payable private teamWalletAddress = payable(0x903d9e0e8900158ca9a245585643B1AD9C2a234A); // Team Address
