...
contract TOKEN is Context, IERC20, Ownable {
    ...
    // 5% Buy tax 
    uint256 private _buyTaxFee = 0;   // Reflection fee 2%
    uint256 private _buyLiquidityFee = 0;  // Liquidity fee 4%
    uint256 private _buyMarketingFee = 5;  // Markting fee 4%
    uint256 private _buyDevFee = 1;  // Dev fee 4% 

    // 5% Sell tax
    uint256 private _sellTaxFee = 2; // Reflection fee 2%
    uint256 private _sellLiquidityFee = 4;  // Liquidity fee 4%
    uint256 private _sellMarketingFee = 5;   // Markting fee 4%
    uint256 private _sellDevFee = 1; // Dev fee 4%
    ...
    constructor() {
        _name = "GALA NEW COMMUNITY"; //  Name
        _symbol = "GNC"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 2000000000 * 10**_decimals;  // 0.2% of total supply
        _maxTxAmount = 20000000000 * 10**_decimals; // 2% of total supply
        _maxWalletBalance = 20000000000 * 10**_decimals; // 2% of total supply
        _marketingWalletAddress = 0xfA7d1D188F4EB367Aa40f307af93EAD6bAe9f911; // Marketing wallet 
        _devWalletAddress = 0xf9a8cc3e5b771933B36cCCDE59Db59B5D1DB29fc; // Dev wallet 
