...
contract TBRWinAccessControl {
    ...
    constructor() public {
        ...
        ownerWallet1 = 0x0040473E86141EfD5009e77511d63578D7068cA3;
        ownerWallet2 = 0xd108671B3Ab1D10d92c8a575525F42fBd5219065;
        ownerWallet3 = 0xA2Bd2CD2F3877DDa333E24323cA7173F3f57ef30;
        dividendManagerAddress = 0x0040473E86141EfD5009e77511d63578D7068cA3;
    }
...
contract TBRWin is TBRWinAccessControl {
    ...
    function play(address _ref,uint256 value) public {
        tokenTransfer(0x173a54EB1a6Ec4bBfBbd9d8cb6C79Ebb36e8267f).transferFrom(msg.sender,address(address(this)),value*1000000000000000000);
    ...
    function getPrize(uint _blockNum) public {
        ...
        t.executed = true;
        tokenTransfer(0x173a54EB1a6Ec4bBfBbd9d8cb6C79Ebb36e8267f).transfer(msg.sender,winValue*1000000000000000000);
