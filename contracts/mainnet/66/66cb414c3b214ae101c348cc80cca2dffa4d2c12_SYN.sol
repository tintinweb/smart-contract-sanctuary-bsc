...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RewardToken = BEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd); // Rewards Token
...
contract SYN is BEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "SYN";
    string constant _symbol = "SYN";
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        require(liquidityFee.add(rewardsFee).add(marketingFee) <=20, "Buy Taxes cannot be higher than 20%");
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell) external authorized {
        require(liquidityFeeSell.add(rewardsFeeSell).add(marketingFeeSell) <=20, "Sell Taxes cannot be higher than 20%");
