...
contract SOFT is ERC20("Soft", "SOFT"), Ownable {
    ...
    uint256 public constant NUM_SOFT_USDC_LP = 50_000_000;
    ...
    bool public USDCLPSoftMinted = false;
    ...
    function mintUSDCLPSoft() external onlyOwner {
        require(
            !USDCLPSoftMinted,
            "USDC Soft LP has already been minted"
        );
        USDCLPSoftMinted = true;
        _mint(owner(), NUM_SOFT_USDC_LP * ONE_SOFT);
    }
