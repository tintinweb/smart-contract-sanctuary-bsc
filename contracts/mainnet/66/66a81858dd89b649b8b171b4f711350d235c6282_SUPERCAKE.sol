...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Deviden = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
contract SUPERCAKE is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Super CAKE";
    string constant _symbol = "sCAKE";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 30000000; //Max tx 
    uint256 public _maxWalletHold = 30000000;// Maxwallet
