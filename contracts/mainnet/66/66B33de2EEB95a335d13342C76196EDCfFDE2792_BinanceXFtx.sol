...
Telegram: https://t.me/BinanceFtxPortal
...
library Address{
 ...
 contract BinanceXFtx is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8895FAA44f7a8D8F1255852E24AF4DeB56f94426;
    address public developmentWallet = 0x8895FAA44f7a8D8F1255852E24AF4DeB56f94426;

    string private constant _name = "Binance X Ftx";
    string private constant _symbol = "BinanceFtx";
    ...
    Taxes public taxes = Taxes(0, 0, 3, 6);
    Taxes public sellTaxes = Taxes(0, 0, 3, 6);
