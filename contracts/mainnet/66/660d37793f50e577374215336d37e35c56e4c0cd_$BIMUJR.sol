...
*/
// 
// https://t.me/BillmurrayInuJR - Fair Launch
...
contract $BIMUJR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bill Murray Inu Jr ";
    string private _symbol = "$BMINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b5938aBfa07e5BC7995D862cd37b9b268A98e0C); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x6E0F03b3E0E6a3D7f256376F0E12074F58FC07A0); // Development Address
