...
contract PointerInu  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "PointerInu";
    string constant _symbol = "PointerInu";
