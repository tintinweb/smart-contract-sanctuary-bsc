...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x280A4e3f9d1BE4ABA59aa02062dFDCAaB7E78782; // owner address
...
contract SnapchatInu is Context, IERC20, Ownable {
    ...
    string private _name = "Snapchat INU";
    string private _symbol = "SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD916dC8cE4cA1aD82a1dbA32b7a62f95D00AE7b9); // Marketing Address
    address payable public teamWalletAddress = payable(0x84958aDAfF8c14aD358c6c2609693692AA6A3Aa7); // Team Address
