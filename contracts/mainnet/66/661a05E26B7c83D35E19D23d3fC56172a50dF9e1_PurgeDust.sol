...
contract PurgeDust is Context, IERC20, Ownable {
    ...
    string private constant _name = "PurgeDust"; // 
    string private constant _symbol = unicode"$PDUST"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _CreatorWallet = 0x330A3231783c35e541d4B7cD5820BF42C7C94c3F;
