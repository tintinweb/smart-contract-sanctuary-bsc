...
contract FoolDog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "FoolDog";
    string private _symbol = "FoolDog";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 59 * 10**29 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x754Fb06044a69Ac18a0564EcCE2522e60c2137Ab
; 
