...
/** 
RELAUNCH DUE TO WE WERE BOTTED

BTC IS PUMPIN BITCHES, FINALLY A FIRST SIGN OF ME MAKING SOME MONEY AFTER BUYING THE TOP AND SELLING THE BOTTOM FOR THE LAST 12 MONTHS, 
THIS TIME RNG GOD IS ON MY SIDE, I WILL BECOME SO RICH THAT I GOD WILL BE ASKING ME FOR MONEY KEK, 
BTC PUMPIN = WE PUMPIN = KYLECALLS IS A BITCH = FUCK SQUIDGAMECALLS = ANAL FISTING FOR EVERYONE WHO BUYS THE TOKEN

https://t.me/PUMPIN_BTC
...
contract PUMPIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC IS PUMPIN BITCHES, FINALLY A FIRST SIGN OF ME MAKING SOME MONEY AFTER BUYING THE TOP AND SELLING THE BOTTOM FOR THE LAST 12 MONTHS, THIS TIME RNG GOD IS ON MY SIDE, I WILL BECOME SO RICH THAT I GOD WILL BE ASKING ME FOR MONEY KEK, BTC PUMPIN = WE PUMPIN = KYLECALLS IS A BITCH = FUCK SQUIDGAMECALLS = ANAL FISTING FOR EVERYONE WHO BUYS THE TOKEN";
    string private _symbol = "PUMPIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42cC0B555bC5bb5022b84bf7490d5b950353FA87); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x42cC0B555bC5bb5022b84bf7490d5b950353FA87); // buyback Address
    ...
    uint256 public _maxTxAmount = 25000000000000 * 10**9; // 2.5%
    uint256 public _walletMax = 40000000000000 * 10**9; // 4%
