...
//Telegram : https://t.me/SquidKingBSCportal
...
contract SquidKingBSC is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Squid King BSC";
    string constant _symbol = "SKG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 19) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *19) / 100; 
