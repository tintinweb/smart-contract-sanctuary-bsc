...
contract KenzanInu is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x690737a483d4FBDc40d8CF4dD38c0FA32cdcD627;
    address public devAddress = 0x690737a483d4FBDc40d8CF4dD38c0FA32cdcD627;

    string private constant _name = "Kenzan Inu";
    string private constant _symbol = "KenzanInu";
    ...
    Taxes public taxes = Taxes(0,1,1,2);
    ...
    // Owner cannot transfer out KenzanInu from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out KenzanInu!");
