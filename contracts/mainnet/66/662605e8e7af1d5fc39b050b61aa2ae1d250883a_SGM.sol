...
contract SGM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid German";
    ...
    address payable private TeamWallet = payable(0x95caDD919d5323b5d5Dc38CbE6D22f07Df7051d4); // Buy Back Address
