 ...
 * DYOR - Doge Your Own Research

    The team behind $DYOR, (great and safe fellas) are pushing the "whitelist stealth launch" contract to the next level. 
    Intelligently combining volume-generated dividends with selective trading, 
    they founded Doge Your Own Research. 
    The dividends will be enabled at 100k MC. Utilizing it's rich experience in marketing and promotion, DYOR is dedicated to project reviews and public relations services.  

    As of now, the tokenomics are as follows: 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // 2% DOGE Rewards
...
contract DYOR_BSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DYOR-Doge Your Own Research";
