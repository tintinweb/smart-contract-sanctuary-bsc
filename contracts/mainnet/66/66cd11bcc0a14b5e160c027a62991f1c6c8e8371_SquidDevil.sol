...
contract SquidDevil is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SquidDevil", "SquidDevil") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SquidDevil";
    string private _symbol = "SquidDevil";
