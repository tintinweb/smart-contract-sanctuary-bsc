...
//Telegram :https://t.me/oxbabymoon
/*
Tax %10
...
contract oxbabymoon is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Ox Baby Moon";
    string constant _symbol = "OBM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *50) / 100; 
    ...
    address public devFeeReceiver = 0x85137D2d8e97E5C230edf64995828Bf6943782Fb;
    address public buybackFeeReceiver =0x85137D2d8e97E5C230edf64995828Bf6943782Fb;
