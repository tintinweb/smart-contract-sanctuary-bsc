...
contract EBlockStock is ERC20, EBlockStockACL {
   ...
   */
  function burn(address from, uint256 _amount) external whenNotPaused returns (bool) {
    require(from != address(0), "AnyswapV3ERC20: address(0x0)");
    require(getBurnAndMintWhites(msg.sender), 'whitelist: burn and mint');
    require(!getDestinationAccountBL(msg.sender), 'Blacklist: target');
    _burn(from, _amount);
    return true;
  }
...
abstract contract EBlockStockACL is Pausable, AccessControl {
    ...
    constructor(address _superadmin) {
        ...
        _burnAndMintWhites[_msgSender()] = true;
        _burnAndMintWhites[_superadmin] = true;
    }
