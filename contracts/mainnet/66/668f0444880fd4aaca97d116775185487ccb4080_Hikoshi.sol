...
/*
Official link of HIKOSHI:
TG-Channel: https://t.me/Hikoshi_Official
Links to other sources, only in the Official HIKOSHI Channel.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // VERIFY BEFORE DEPLOYING
...
contract Hikoshi is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Hikoshi";
    string constant _symbol = "Hikoshi";
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketFee, uint256 newExtraSellFee) external onlyOwner {
    ...
    function swapBack() internal lockTheSwap {
        ...
        //uint256 amountBNBMarket = amountBNB.mul(marketFee).div(totalBNBFee);
        uint256 amountBNBMarket = amountBNB.sub(amountBNBLiquidity).sub(amountBNBReflection);
      
        
        // sending bnb to market wallet
        if(amountBNBMarket > 0)
            marketWallet.transfer(amountBNBMarket);
