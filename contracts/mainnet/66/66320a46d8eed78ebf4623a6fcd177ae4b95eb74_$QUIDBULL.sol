...
contract $QUIDBULL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Bull"; 
    string private _symbol = "SB"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1F62006c757CF353BcF0B5810623A5d9ea9A03b5); 
    address payable public teamWalletAddress = payable(0x1F62006c757CF353BcF0B5810623A5d9ea9A03b5); 
