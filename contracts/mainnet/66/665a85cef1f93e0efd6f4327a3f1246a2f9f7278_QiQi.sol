...
contract QiQi is Context, IERC20, Ownable {
    ...
    string private _name = "QiQi";
    string private _symbol = unicode"QQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD07BE5D1dADFc1a5f07234669B888797be9bF860); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD07BE5D1dADFc1a5f07234669B888797be9bF860); // buyback Address
