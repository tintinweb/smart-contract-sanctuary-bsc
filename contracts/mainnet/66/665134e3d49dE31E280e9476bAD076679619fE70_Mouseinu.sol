...
contract Mouseinu is Context, IERC20, Ownable {
    ...
    payable(0xaF8b4f87c7a98189CA12f5201e7800Dab8C43731);
    ...
    string private constant _name = "Mouse Inu";

    string private constant _symbol = "SQUEEK";
