...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    address public busd = 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd; //TestNet
...
contract BRAToken is BEP20Detailed {
    ...
    constructor() BEP20Detailed("BRA", "BRA", 18) public {
        ...
        _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet kyle
