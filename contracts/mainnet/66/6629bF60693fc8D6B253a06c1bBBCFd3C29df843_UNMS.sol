...
contract UNMS is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5292ACC7be139d4f78090ADfe489A38680dBA152));
        marketingWalletAddress = payable(address(0x4B83DE807ffE5C7D78B775419016437FCc8b8749));
