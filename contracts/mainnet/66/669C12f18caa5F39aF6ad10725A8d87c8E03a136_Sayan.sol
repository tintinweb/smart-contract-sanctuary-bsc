...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2fc53bc333FF6098bA10f1b67d434982DE3d7E8C;
...
contract Sayan is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAFD5D550427b6ec5ba05509957f74Db461504A64;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SayanToken";
    string private _symbol = "SYT";
