...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf706F4F70e54b972239742B04199Fb4068f32686;
...
contract MkcoinToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdf12e025618c7a65c2831791Fa47e3509a91076E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MkcoinToken";
    string private _symbol = "MKCT";
