...
contract    SMARTBANK_FINANCE{
    ...
    constructor() public{
        ceoAddress=address(0xC9D4e7a68753669A321B0ECc855C45d243711039);
        ceoAddress2=address(0x2fB62eb4F96a5Ecc3C4426c6Dd681dff8E800185);
    }
    ...
    function devFee(uint256 amount) public pure returns(uint256){
        return SafeMath.div(SafeMath.mul(amount,40),100);
    }
