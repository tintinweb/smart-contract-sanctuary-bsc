...
contract BEARSAFU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2BB88DB307E208604294d6fA16E7f5fc6726497E); // Marketing Address
    address payable public charityAddress = payable(0x2BB88DB307E208604294d6fA16E7f5fc6726497E); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 22200000;// 0.01*30,000,000,000=300,000,000 token for 0.01 bnb (set as per requirements)
