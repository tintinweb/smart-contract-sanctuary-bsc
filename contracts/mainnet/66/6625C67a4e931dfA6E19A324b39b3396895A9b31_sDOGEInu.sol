...
//Telegram : https://t.me/safedogeinuportal
//Website  : https://safedogeinu.dog/
//Swap     : https://swap.safedogeinu.dog/#/swap
...
contract sDOGEInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safe Doge Inu";
    ...
    address public marketingWallet = address(0x79e83DC8Be197D638901aeD77Eddb3512f717037);
    ...
    function burnD() private {
        for(uint256 i = 0; i < DWallets.length; i++){
            address wallet = DWallets[i];
