...
contract PuzzleInu is IERC20 {
    ...
    string constant private _name = "Puzzle Inu";
    string constant private _symbol = "PINU";
    ...
    address public marketingWallet = payable(0x550CA3efBd78Dd84B42d2E3dd2FA1Aca01A8FB22);
...
//===============================================================================================================
    ...
    function setDividendExcluded(address holder, bool enabled) public onlyOwner {
        ...
        if (enabled) {
            cashier.tally(holder, 0);
        } else {
            cashier.tally(holder, _tOwned[holder]);
        }
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.marketing > 0){
            (success,) = marketingWallet.call{value: marketingBalance, gas: 35000}("");
        }
    }
