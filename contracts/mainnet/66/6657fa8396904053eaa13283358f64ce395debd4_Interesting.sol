...
contract Interesting {
    ...
    uint256 public maxDeposit = 100000000; //default max deposit is 0.1 BNB
    uint256 public interestFactor = 60;
    bool public depositsPaused = false;
    bool public maxDepositToggle = true; // by default, max deposit check is enabled
    ...
    function withdraw() public {
        ...
        // only to supress warning msg
        tmpSuccess2 = false;
        emit LogWithdraw(msg.sender, balance[msg.sender] + interest);
    }
}