...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hoteiosho Inu"; //
    string private constant _symbol = "Hoti"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x73A036a61607a2f23523d139eeE5d6f591C8d6B0;
