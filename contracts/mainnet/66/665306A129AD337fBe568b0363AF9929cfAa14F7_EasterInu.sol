...
//address
    ...
    address public marketingAddress = 0x7Cc418fadB3d7Dd17051390C7D16af5c21Cd26b5;
    address public charityAddress = 0xEC3aa40a50905F9C385e60A83eFD83764ef5fAc3;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 10;
    uint public sellMarketingFee = 2;
    uint public buyCharityFee = 11;
    uint public sellCharityFee = 4;
...
// constructor
    constructor() ERC20("EasterInu", "EASTER") {
        ...
        maxWalletAmount = ( total_supply / 100 ) * 4;
        //spawn pair
