...
contract CommandAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CommandAI";
    string private _symbol = "CAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC8e9de4Ff84D8958AC957eA861C1D48F667997B4);
    address payable public liqWalletAddress = payable(0x7AfF53c8e0a850fEfA14175F878E68f753fc1675);
