...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4f6AD7feB0656e21D2C314357033B0BeE1fEB6B;
...
contract FITMINE  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x4219a78f796cAe73A044Ee3ECe3fdbBBf7DB9f21;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fitmine";
    string private _symbol = "FITMINE";
