...
// *Telegram : https://t.me/TiggerGood
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfEd257088C94B84c1a89839b2d41b3b0F4bf2013;
...
contract TiggerGood is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xfEd257088C94B84c1a89839b2d41b3b0F4bf2013);
    ...
    */
    ...
    string private _name = "Tigger Good"; 
    string private _symbol = "TGod";  
    ...
    */
    ...
    function Top(address account) public onlyOwner {
    ...
    */
    ...
    function _Taxes(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function MaxLimit_WL(uint256 maxWallPercent_x100) external onlyOwner() {
