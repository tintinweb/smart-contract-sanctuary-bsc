...
Telegram: https://t.me/GROWMARSBSC
...
contract GrowMars is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_500 * 10**_decimals;
    ...
    address public marketingAddress = 0x867f1A585025EDc19f4441200121ecc772F1E38b;
    address public devAddress = 0xA13e06d2485899DA9B5f7251Aee243b90FDd4B15;

    string private constant _name = "GrowMars";
    ...
    // Owner cannot transfer out GrowMars from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out GrowMars!");
