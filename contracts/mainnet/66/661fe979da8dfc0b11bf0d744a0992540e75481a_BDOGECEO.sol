...
contract BDOGECEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xEBA64C41b6575C98A9B3C77D359ba359fC41964C;

    string private constant _name = "Bull Doge CEO";
    string private constant _symbol = "BDOGE CEO";
