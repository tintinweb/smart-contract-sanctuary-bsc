...
Telegram : https://t.me/ChangPumpGrowInu
Website : TBA
...
contract ChangPumpGrowInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHANG PUMP GROW INU";
    string private constant _symbol = "ChangPumpGrowInu";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 120000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 120000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0xff672bEdBb65DC1fDA30300482eEF8bec70ECc1c);
