...
contract GalaxyInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x96f9568f37ebe1a5c4976A9782ab10590FDf6C1f;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x96f9568f37ebe1a5c4976A9782ab10590FDf6C1f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x96f9568f37ebe1a5c4976A9782ab10590FDf6C1f] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x96f9568f37ebe1a5c4976A9782ab10590FDf6C1f,
                block.timestamp
            );
