  ...
  , IERC20Metadata
{
  ...
  string private _name = "Matakala";
  string private _symbol = "MAKA";
  uint8 private _decimals = 9;
  uint256 private _totalSupply;
  uint256 private _taxBuy = 10;
  uint256 private _taxSell = 10;    
  uint256 public _taxDivider = 100;
  address public _taxReserved;

  function setTaxSell(uint256 input_) public onlyOwner { _taxBuy = input_; }
  function setTaxBuy(uint256 input_) public onlyOwner { _taxSell = input_; }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "MATAKALA: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "MATAKALA: transfer from the zero address");
    require(recipient != address(0), "MATAKALA: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "MATAKALA: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "MATAKALA: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "MATAKALA: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "MATAKALA: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "MATAKALA: approve from the zero address");
    require(spender != address(0), "MATAKALA: approve to the zero address");
