...
contract DogeMayeMusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeMayeMusk";
    string private _symbol = "DOGEMAYE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x0e72963af3d8741eb039BEF3a3774Db556b8c612);
