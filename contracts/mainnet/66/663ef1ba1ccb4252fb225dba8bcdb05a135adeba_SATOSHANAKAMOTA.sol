...
//
//Welcome to SATOSHA NAKAMOTA .FUN PLAY BASED ON ELONA  https://t.me/satoshanakamota
...
contract SATOSHANAKAMOTA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SATOSHA NAKAMOTA";
    string private _symbol = "SNM";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0x113E0746c8d38ECe23719b21040B4F73B2027b0e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x113E0746c8d38ECe23719b21040B4F73B2027b0e); // BuyBack Address
