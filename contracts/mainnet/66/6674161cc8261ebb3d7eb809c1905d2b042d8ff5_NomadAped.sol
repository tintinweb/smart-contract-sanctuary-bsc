...
contract NomadAped is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NomadAped";
    string private _symbol = "NomadAped";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x553f7F4aD76121534ba6C2115107A36AA64d4132); // Marketing Address
    address payable public devWalletAddress = payable(0x49BA33A62B4ee93e31973b14D490E2CF4f905526); // Dev Address
    ...
    uint256 private _maxSellTxAmount = 300 * 10**6 * 10**9;
