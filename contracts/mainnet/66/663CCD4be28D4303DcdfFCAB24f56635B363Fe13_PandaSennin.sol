...
/*
PandaSennin - BSC Gem Degen Token
Delivering good news to BSC, PandaSennin is a new ambitious gem token that aims to raise & become one of the top gainers token of the year. We believe a combination of great community & dev is the main key to success on this market.

~ Brought to you by experienced Dev Team
~ Gem token with 200x potential
~ Anti-sniper protocol
~ Tax to liquidity to maintain a powerful chart

TG : https://t.me/PandaSenninBSC
*/
...
contract PandaSennin is Context, IERC20 { 
    ...
    string private constant _name = "PandaSennin"; 
    string private constant _symbol = "$PSENNIN"; 
