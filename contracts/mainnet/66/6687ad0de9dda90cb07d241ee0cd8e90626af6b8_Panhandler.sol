...
contract Panhandler is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x95958927cc4fD47aE5C96f2AC10B9273669c8b1E); // Marketing Address
    ...
    string private _name = "Panhandler";
    string private _symbol = "QG";
