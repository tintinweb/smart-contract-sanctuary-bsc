...
// *Telegram : https://t.me/PitbullGrow
...
contract pitbull is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xeDD4F0C2FaF0a9C8a2441e98C34EbE185892939B));
    address payable public devWallet =
        payable(address(0xeDD4F0C2FaF0a9C8a2441e98C34EbE185892939B));
    address public liquidityReceiver =
        0xeDD4F0C2FaF0a9C8a2441e98C34EbE185892939B;
    ...
    string private _symbol = "$PITBULLG";
