...
contract CCGDB is ERC20 {
	...
	address private _fundAddress = address(0x6F627e2E1280E9F6e8edcF14f01991C03935eebD);
    ...
    constructor(address tokenOwner) ERC20("CCGDB", "CCGDB") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                require(balanceOf(to).add(amount) <= 500 * 10**18);     
        ...
        if (takeFee) {
			...
			changeUsdtAmount = changeUsdtAmount.add(amount.div(100).mul(8));
