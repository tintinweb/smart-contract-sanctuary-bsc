...
/*
💕OnlyAi💕
bot celebration of the $1 Million Market cap of the $ONLYAI Erc20
💕NSFW Image Generation AI💕
💕Lock Lp
💕Renounce
💕Safu Contarct
💕Low tax 3%
💕Group telegram https://t.me/OnlyAiBSC
💕Bot Image Generation AI https://t.me/AdultAICryptoBot
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.18;

abstract contract Contextbep20OnlyAI {
...
contract Ownablebep20OnlyAI is Contextbep20OnlyAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20OnlyAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20OnlyAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract OnlyAI  is Contextbep20OnlyAI, bep20OnlyAI, Ownablebep20OnlyAI {
