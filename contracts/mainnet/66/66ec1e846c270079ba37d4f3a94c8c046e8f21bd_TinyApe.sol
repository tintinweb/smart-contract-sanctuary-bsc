...
contract TinyApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiny Ape";
    string private _symbol = "TAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18e56d2A48750bd990036B630Ed1706c24ca7BcF); 
    address payable public buyBackWalletAddress = payable(0x18e56d2A48750bd990036B630Ed1706c24ca7BcF); 
    ...
    uint256 private minimumTokensBeforeSwap = 15000 * 10**9; 
