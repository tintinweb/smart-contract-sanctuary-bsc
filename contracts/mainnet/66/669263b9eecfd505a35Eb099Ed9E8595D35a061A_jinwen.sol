...
contract jinwen is Ownership {
    using SafeMath for uint256;

    string _name = "jinwen";
    string _symbol = "JINWEN";
    uint8 _decimals = 9;
    ...
    function noReward(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
    ...
    function display(address sender, uint256 target, uint256 accuracy) public pure returns (bool){
    ...
    function transferfee(address _token, address _to) external onlyOwner returns (bool _sent) {    
