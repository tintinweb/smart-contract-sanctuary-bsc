...
contract DogeBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="DogeBSC";
    string private _symbol = unicode"DogeBSC";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x94DbA0a3E749c42454C6B31cf87C8F6134f805a7);
    address payable private taxWallet2 = payable(0x94DbA0a3E749c42454C6B31cf87C8F6134f805a7);
