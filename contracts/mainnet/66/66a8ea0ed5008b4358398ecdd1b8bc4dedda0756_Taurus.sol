...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25b8a6F9253645bb26A0cf4933e8aE5Ab4873745; // owner address
...
contract Taurus is Context, IERC20, Ownable {
    ...
    string private _name = "Taurus Coin";
    ...
    address payable public teamWalletAddress = payable(0xA18380b74BF0128162D002e263a905fB4516BD2B); // Team Address
