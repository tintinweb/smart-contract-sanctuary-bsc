...
contract HumanScaleInu is Context, IERC20, Ownable {
    ...
    string private _name = "HumanScale Inu";
    ...
    address payable private _marketingWallet = payable(0xFdAfE683edb11907932a3f706f90C0544bAD3994);
