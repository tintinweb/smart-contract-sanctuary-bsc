...
// Welcome to Dejitaru Rayquaza 
// https://t.me/dejitarurayquaza
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81b1e508C5eD4031b88Ef0eDab76bc6068003B92; // owner address
...
contract DEJITARURAYQUAZA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEJITARU RAYQUAZA";
    string private _symbol = "$DQUAZA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x81b1e508C5eD4031b88Ef0eDab76bc6068003B92); 
    address payable public teamWalletAddress = payable(0x81b1e508C5eD4031b88Ef0eDab76bc6068003B92);
