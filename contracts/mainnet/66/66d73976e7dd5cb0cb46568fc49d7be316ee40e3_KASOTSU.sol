...
https://t.me/KASOTSUKA_BSC

If currency is what the higher civilizations of the universe use to imprison and control human beings
Kasō tsuka means to rule virtual currency
*/
...
contract KASOTSU is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1Cc9Ac841BFF60D3c0586978b731e096b3AF8078; 
    address DevWallet       = 0x1Cc9Ac841BFF60D3c0586978b731e096b3AF8078; 

    string constant _name = "Kaso Tsuka";
    string constant _symbol = "KASOTSU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 50000000 * (10 ** _decimals);
    uint256 public _maxSell = 1000000000 * (10 ** _decimals);
