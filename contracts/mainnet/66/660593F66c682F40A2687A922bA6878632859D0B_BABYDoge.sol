...
contract BABYDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9056B24666728Bb20DE0e6F3Bf2bcfc9D09Ac0bb));
        marketingWalletAddress = payable(address(0x9056B24666728Bb20DE0e6F3Bf2bcfc9D09Ac0bb));
