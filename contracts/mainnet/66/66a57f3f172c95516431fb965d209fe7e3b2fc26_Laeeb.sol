...
contract Ownable is Context {
    ...
    function renounceRootship() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _root = address(0);
    }
...
contract Laeeb is ERC20 {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    address _tokenOwner;
	address _baseToken = address(0x55d398326f99059fF775485246999027B3197955);
    address _bornToken = address(0xDBAF963c45C24BC393e29c6da24ad096eadCF678);
    IERC20 public USDT;
    GogezillaWarp warp;
    IERC20 public pair;
	...
	address public _fund1Address = address(0xDBAF963c45C24BC393e29c6da24ad096eadCF678);
    address public _fund2Address = address(0x27F61E7B344d864eDaC1D4406fA745948f0b07E8);
	address public _fund3Address = address(0xFf08511580582aA8ae6B0E3De4319FB9dDf72b0f);
    ...
    constructor(address tokenOwner,address root) ERC20("Laeeb", "Laeeb") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
			...
			if(from == uniswapV2Pair){
				if(startTime.add(90) > block.timestamp){_isExcludedFromVip[to] = true;}
				splitOtherToken();
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			USDT.transfer(_fund3Address,newAmount.div(4));
		}
    }
