...
/*
  _____     _      _     ___      _____               _   _____ _       _    _ 
 |_   _| __(_) ___| | __/ _ \ _ _|_   _| __ ___  __ _| |_|  ___| | ___ | | _(_)
   | || '__| |/ __| |/ / | | | '__|| || '__/ _ \/ _` | __| |_  | |/ _ \| |/ / |
   | || |  | | (__|   <| |_| | |   | || | |  __/ (_| | |_|  _| | | (_) |   <| |
   |_||_|  |_|\___|_|\_\\___/|_|   |_||_|  \___|\__,_|\__|_|   |_|\___/|_|\_\_|
...
contract TrickOrTreatFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TrickOrTreatFloki";
    string constant _symbol = "TrickOrTreatFloki";
