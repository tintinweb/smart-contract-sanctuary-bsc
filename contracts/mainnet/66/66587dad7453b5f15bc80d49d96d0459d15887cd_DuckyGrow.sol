...
contract DuckyGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ducky Grow";
    string private _symbol = "DUCKYGROW";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xbc7CF657B0037C060611658AAac835A61cEA4147);
