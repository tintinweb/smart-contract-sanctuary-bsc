...
contract TBOSS is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Twittelon BOSS", "TBOSS", uint8(DECIMALS)) Ownable() {
        ...
        marketingReceiver = 0x33Bf1f369B8b426cd0f1eF29EaF09F1EbfBA2ab5;  
        admin = 0x33Bf1f369B8b426cd0f1eF29EaF09F1EbfBA2ab5;
        ...
        _maxTxAmount = 2 * 10**10 * 10**DECIMALS;
        _maxWalletToken = 100 * 10**10 * 10**DECIMALS;
