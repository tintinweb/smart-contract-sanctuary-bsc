...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 PIGE = IBEP20(0x1FDB2c3851D067502Ce2122bE80a41ea212949E2); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = PIGE.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = PIGE.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           PIGE.transfer(shareholder, amount);
...
contract SAUDIPIGE is IBEP20, Auth {
   ...
   address PIGE = 0x1FDB2c3851D067502Ce2122bE80a41ea212949E2; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x21a831108D22a8937B53Bb648AD8D1004E7B3420; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x21a831108D22a8937B53Bb648AD8D1004E7B3420; //Can be change to any wallet you want
       marketingFeeReceiver = 0x21a831108D22a8937B53Bb648AD8D1004E7B3420; //Can be change to any wallet you want
