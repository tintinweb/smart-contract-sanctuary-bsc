 ...
 *  Shīru Inu シール  ( $SHIRU ) the meme coin revolution inspired by Ocean and Japanese Dog
 *  Telegram: https://t.me/ShiruInu
 *  Twitter: https://twitter.com/ShiruInuToken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x12FE5D09FCd7590B8DE1527D7ACA7e7f6CADBcab; // owner address
...
contract Shiru is Context, IERC20, Ownable {
    ...
    string private _name = "Shiru Inu";
    string private _symbol = "$SHIRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12FE5D09FCd7590B8DE1527D7ACA7e7f6CADBcab); // 
    address payable public teamWalletAddress = payable(0x12FE5D09FCd7590B8DE1527D7ACA7e7f6CADBcab); // 
