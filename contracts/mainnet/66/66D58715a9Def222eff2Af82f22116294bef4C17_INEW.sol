...
contract INEW is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 4300899;
    ...
    address public liquidityReceiver = 0x0C8De3A69882D4dE94171eE0b8ccc499e99DD2b0;
    address public treasuryReceiver = 0x86Ea10bb61C8f5de432cCDaee26D03ea85e74Ec8;
    address public riskFreeValueReceiver = 0x2E2c1857b080246b063BfffCAd8a76716076cCD2;
    ...
    constructor(address _owner) ERC20Detailed("inew", "INEW", uint8(DECIMALS)) {
