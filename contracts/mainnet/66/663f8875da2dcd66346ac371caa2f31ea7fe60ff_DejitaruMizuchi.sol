...
*
*
*  The objective of this project is "reaching the Moon". 
*
*  Dejitaru Mizuchi (Digital Mizuchi) is a de decentralized token powered by Binance Smart Chain Network.
*
*  Marketing will be hosted by experts with experience in the domain while our team will provide the essential information for the buyers.
*
*  Tokenomics : 

*  Total Pupply: 100,000,000 $MIZUCHI
*  Max Transaction (at launch): 20,000,000 $MIZUCHI (2%)
*  Tax: 8% Buy/Sell

*  Powered by @AlexBasedDev 

*  Telegram: https://t.me/DejitaruMizuchi
...
contract DejitaruMizuchi  is Context, IERC20, Ownable {
    ...
    string private _name = "Dejitaru Mizuchi";
