...
// SPDX-License-Identifier: Unlicensed
 /**
 Connex ID Network Purpose and Goals
The purpose of Connex ID Network is to enable users to create their own ID systems with blockchain.
 This created ID system will be available on all blockchain infrastructure and CXID supported platforms.
 At the same time, users will be able to authenticate on exchanges with their CXID Identity IDs.
 www.connexid.network
 https://t.me/connexidnetwork
 https://twitter.com/connexidnetwork
*/
...
contract ConnexidNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Connex Id Network";
    string private _symbol = "CXID";
    ...
    address public charityWallet = 0xC8d548E0636eAe10B5Df7129D0773e39E1a57f9e;
