...
contract DOGCHAININU is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGCHAIN INU";
    string private constant _symbol = "DOGI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x035a38b5d849a85d00CfB577DEd43c2AB40046a2);
    address payable private _marketingAddress = payable(0x035a38b5d849a85d00CfB577DEd43c2AB40046a2);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 30, "Redis cannot be more than 15.");
	    require(redisFeeOnSell < 30, "Redis cannot be more than 15.");
	    require(taxFeeOnBuy < 30, "Tax cannot be more than 15.");
	    require(taxFeeOnSell < 30, "Tax cannot be more than 15.");
