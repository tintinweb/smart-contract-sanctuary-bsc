...
contract PoopDogg is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 33; // 3% 
    uint256 public maxTxAmountSell = _tTotal / 33; // 3% 
    uint256 public maxWalletAmount = _tTotal / 33; // 3% 
    ...
    string private constant _name = "Poop Dogg";
    string private constant _symbol = "POOPDOGG";
