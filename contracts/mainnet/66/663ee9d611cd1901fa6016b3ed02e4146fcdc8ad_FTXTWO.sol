...
contract FTXTWO is Context, IERC20, Ownable {
    ...
    string private _name = "FTX 2.0";
    string private _symbol = "FTX 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE010886d753cf05A69A4a8A250E2aC55de90e42D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xE010886d753cf05A69A4a8A250E2aC55de90e42D); // buyback Address
    ...
    uint256 public _walletMax =  40000000000 * 10**9; // 4%
