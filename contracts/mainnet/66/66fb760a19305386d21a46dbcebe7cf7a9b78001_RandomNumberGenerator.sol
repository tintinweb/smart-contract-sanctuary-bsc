...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public KasaSwapLottery;
     ...
     * @param _seed: seed provided by the KasaSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == KasaSwapLottery, "Only KasaSwapLottery");
    ...
    /**
     * @notice Set the address for the KasaSwapLottery
     * @param _KasaSwapLottery: address of the KasaSwap lottery
     */
    function setLotteryAddress(address _KasaSwapLottery) external onlyOwner {
        KasaSwapLottery = _KasaSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IKasaSwapLottery(KasaSwapLottery).viewCurrentLotteryId();
    }
}