...
contract FIFA23 is Ownable, IBEP20 {
    ...
    string constant _name = "FIFA23";
    string constant _symbol = "$WORLDCUP";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x51dA238d09d9D2d0A489462f22380904b813323C;
