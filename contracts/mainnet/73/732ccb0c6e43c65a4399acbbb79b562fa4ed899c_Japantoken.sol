...
// グローバルコミュニティ : https://t.me/JapanToken
...
contract Japantoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Japan Token";
    string private _symbol = "$JPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23Da594711E99f1F5A1AD391B12dd552813BCa63);
    address payable public teamWalletAddress = payable(0x23Da594711E99f1F5A1AD391B12dd552813BCa63);
