...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC2D008C145c48888481e85523Fed8e5199155cf8;
...
contract ApeZeus is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFed8e303952794e856b87AF826e9fbdBcd1bDdF8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ape Zeus";
    string private _symbol = "ApeZeus";
