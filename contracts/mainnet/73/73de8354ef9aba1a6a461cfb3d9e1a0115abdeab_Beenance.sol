...
🐝Beenance is a Community token inspired by bees and binance that comes in yellow and black. Binance's beloved bee, Beenance, produces delicious honey for you in the form of a long-term project.
...
Tax buy and sell: 0-12%

🐝This is Beenance's first project and we plan to reach the moon even further 🌗🚀

🐝 Website  : (Will live soon) 
🐝 Twitter  : https://twitter.com/beenance3
🐝 Telegram : https://t.me/Beenance3
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0DCFF9C539FBc48D6521c45D3E65Cc8CbaC8de0F;
...
contract Beenance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Beenance"; // 
    string private constant _symbol = "BEENB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x2A2A88F5290510c0a867F49aFb207E3A9cEEcDe3);
