...
contract USDY is ERC20 {
    ...
    address _tokenOwner;
	address _baseToken = address(0xC91e402874473662b66510A470c43c891cde3070);
    IERC20 public OY;
    EthWarp public warp;
    bool private swapping;
    uint256 public swapTokensAtAmount;
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
	address public fundAddress = address(0x71a979d538e4aa7CB38cD28b13Aecc0B73B8ec7A);
    ...
    constructor(address tokenOwner) ERC20("USDY", "USDY") {
        ...
        OY = IERC20(_baseToken);
        OY.approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E),10**30);
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			super._transfer(from, fundAddress, amount.div(100).mul(2));
    ...
    function swapTokensForOther(uint256 tokenAmount) public {
		...
		uint256 oldValue = OY.balanceOf(address(warp));
