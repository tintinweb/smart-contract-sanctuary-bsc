...
contract NoGoalNoParty is IBEP20, Auth {
    ...
    address MarketingWallet = 0x46eAa0B1002B84C4d9527C2f33af3e76829bac46;
    address DevWallet       = 0x4a16ef4B4f7c503a59AF9f249AD042932B3912ab;
    ...
    uint256 private totalFee = marketingFee + liquidityFee + projectFee;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(projectFee).div(totalBNBFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(projectFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
