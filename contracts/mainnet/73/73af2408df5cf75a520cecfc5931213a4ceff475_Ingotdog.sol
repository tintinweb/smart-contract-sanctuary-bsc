...
contract Ingotdog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0f4FC1744759CAb25392c4B60F2AFD4e84D83F18); // Marketing Address
    ...
    uint256 private _tTotal = 8000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ingotdog";
    string private _symbol = "$IDOG";
    ...
    uint256 public _maxTxAmount = 8000000000 * 10**2 * 10**9;
