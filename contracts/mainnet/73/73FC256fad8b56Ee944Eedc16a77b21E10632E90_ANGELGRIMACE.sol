...
// Telegram: https://t.me/AngelGrimaceBSC - 2 hype in 1 coin.
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E);
...
/* Token contract */
contract ANGELGRIMACE is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5385F3E30AEcC7c43a0da8b442A01E89C2d132A6;
    ...
    // Name and symbol
    string constant _name = "Angel Grimace";
    string constant _symbol = "$ADGrimace";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3af2B576c46732e1cd112793D38FEa1C7cD442d6;
