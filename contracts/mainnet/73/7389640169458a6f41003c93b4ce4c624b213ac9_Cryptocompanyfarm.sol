...
contract Cryptocompanyfarm is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 10000000 * _decimalFactor; // Supply Token
    ...
    uint256 public maxBuyAmount = 240000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 240000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 240000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "BRIGA DE BOTS";
