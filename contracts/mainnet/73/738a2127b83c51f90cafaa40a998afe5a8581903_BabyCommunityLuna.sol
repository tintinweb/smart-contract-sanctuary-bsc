...
contract BabyCommunityLuna is IBEP20, Auth {
    ...
    string constant _name = "Baby Community Luna";
    string constant _symbol = "bLuna";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 200; //3% 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; //3%
    ...
    address private marketingFeeReceiver = 0xb5e9DF2CA7CEe802f34FB7423C84A6390aa54c3c;
    address private developmentFeeReceiver = 0x7987C4b942A36761D128e5FB81cb54b0Ff8F6Ff6;
