...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc47dDa71ECFf5074657C7ACe3BDe75686242c59E; // owner address
...
contract KAMAITACHIINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "TACHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc47dDa71ECFf5074657C7ACe3BDe75686242c59E);
    address payable public teamWalletAddress = payable(0xc47dDa71ECFf5074657C7ACe3BDe75686242c59E); 
