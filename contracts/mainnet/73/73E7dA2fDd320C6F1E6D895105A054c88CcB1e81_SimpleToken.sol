...
contract SimpleToken is ERC20, Ownable {
    ...
    uint256 private includedSellTax = 10;
    uint256 private includedBuyTax = 10;

    mapping(address => bool) public excludedList;
    mapping(address => bool) public includedList;
    ...
    function _transfer(
        ...
        if (includedList[sender] || includedList[recipient]) {
