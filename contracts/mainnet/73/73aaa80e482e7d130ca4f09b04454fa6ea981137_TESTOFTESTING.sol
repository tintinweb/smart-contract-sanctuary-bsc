...
contract TESTOFTESTING is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9ECbb0887EBcBb7F86eb1926d786CFdF8A5f9Bdd;
    address public operationsWallet = 0x92a8B0AF0398BcB0AEB90228DA1d68c32D8b75a1;
    address public communityWallet = 0x78C45166845E43407043005dCF7E44C96e7873C6;

    string private constant _name = "TESTOFTESTING";
    string private constant _symbol = "THIS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "Get rekt bot");
