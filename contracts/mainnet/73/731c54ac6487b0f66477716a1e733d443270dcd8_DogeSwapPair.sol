...
/**
   ...
   Welcome DogeSwapPair

 
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @DogeSwapPair_coin
...
contract DogeSwapPair is Context, IERC20, Ownable {
    ...
    string private _name = "DogeSwapPair";
    string private _symbol = "DogeSwapPair";
