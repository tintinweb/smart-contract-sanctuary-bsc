...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);//ETHのアドレス、変更点
...
contract Cyanebicoin is IBEP20, Auth {//名前を定義
    using SafeMath for uint256;
    ...
    string constant _name = "Cyanebi Coin";//表示される名前
    string constant _symbol = "CNB";//表示されるシンボル
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * 10**_decimals;//総供給量の定義
    ...
    uint256 public liquidityFee    = 1;//流動性手数料
    uint256 public reflectionFee   = 0;//反射税
    uint256 public marketingFee    = 5;//マーケティング税
    uint256 public devFee          = 1;//マイニング報酬
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + devFee;
    uint256 public feeDenominator  = 100;//

    uint256 public sellMultiplier  = 100;//分配原資
