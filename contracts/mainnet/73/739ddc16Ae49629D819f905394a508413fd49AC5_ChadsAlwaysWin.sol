...
contract ChadsAlwaysWin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chads Always Win";
    string private _symbol = "CAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe9b8A2025cf84Af13501D72a34F03Ee391E4a1e9); // Marketing Address
    address payable public DevWalletAddress = payable(0xE4aCf3665aB8a3100f6FFddD29451Bd016680D1C); // Dev Address
