...
contract Growbull is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bulls World Grow";
    string private constant _symbol = "Bull Grow";
    ...
    address private marketingWallet = address(0x3253e22196851a9e32aAA64f80336279057873C1);
    address private liquidityReceiver = address(0x3253e22196851a9e32aAA64f80336279057873C1);
