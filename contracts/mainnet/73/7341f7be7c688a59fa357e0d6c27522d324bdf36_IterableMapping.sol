...
contract DEPLOY is ERC20, Ownable {
    ...
    constructor() payable ERC20("OpenAIToken", "OPAI") {

        rewardToken = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // ShibInu
        ...
        treasuryWallet = 0x252d30812b760Da0C39f91A80F56e822CF3e60B1; //DevSecondWallet DNT
        ...
        _mint(owner(), 10000000000 * (10 ** 18)); //1 Billion
        swapTokensAtAmount = totalSupply() / 50000; //50000 = 0.0005
    }
