...
contract RABGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RABBIT GROW";
    string private _symbol = "RABGROW";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xb5F9BBeeD35859F02fed990b9B4C9A291275294E); // Marketing Address
    address payable public BuyBackWallet = payable(0xb5F9BBeeD35859F02fed990b9B4C9A291275294E); // Team Address
