 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/McAnnoyed
 * 
 * 
 * McAnnoyed token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract McAnnoyed is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McAnnoyed";
    string constant _symbol = "MCAN";
