...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public REWARD = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // temp BNB
...
contract ORYX is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    uint256 constant marketingFee = 70; 
    uint256 constant reflectionFee = 0;  
    uint256 constant liquidityFee = 20; 
    uint256 constant charityFee = 0; 
    uint256 constant devFee = 0;     
    uint256 constant totalFee = 90;  
    ...
    constructor () {
        ...
        _maxWalletSize = _totalSupply / 500; // 2%

        smallSwapThreshold  = _totalSupply.mul(1000).div(1000000000);
        largeSwapThreshold = _totalSupply.mul(3000).div(1000000000);
