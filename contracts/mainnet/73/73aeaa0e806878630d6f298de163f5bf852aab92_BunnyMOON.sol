...
contract BunnyMOON is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Lunar Bunny Rocket";
    string private constant _symbol   = "BunnyMoon";
    ...
    uint256 public  _maxTxAmount     = _tTotal * 1000 / 10000;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 1000 / 10000; // 10% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xed25aC9464e11412E957798575036515F789CbFe;
        _marketingWallet = 0x85125F192a22F3A0fFF1658B4290BE333b932655;
