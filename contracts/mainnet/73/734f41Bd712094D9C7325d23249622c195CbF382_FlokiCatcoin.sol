...
/**
               ...
               ||STEALTH LAUNCH||
Welcome to $FLOKICATCOIN 


$FLOKICATCOIN is a community meme token and aggressive to be at the crypto market to get hype on meme tokens and make this trend for the it’s own community and seek benefits for all the holders. 

* Potential x1000 Gem * 💎
Did you miss out Floki / Cat coin ? 
...
pragma solidity ^0.6.12;
    ...
    contract FlokiCatcoin is Context, IERC20, Ownable {
        ...
        string private _name = 'FlokiCatcoin';
