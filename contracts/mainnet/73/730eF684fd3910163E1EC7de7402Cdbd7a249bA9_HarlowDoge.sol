...
contract HarlowDoge
 is Context, IERC20, Ownable {
    ...
    string private _name = "HarlowDoge";
    string private _symbol = "HarlowDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x51af9e27F3D7Bc5c338AD7dC7a266FA5bD9f70de));
        _anotherA = payable(address(0x51af9e27F3D7Bc5c338AD7dC7a266FA5bD9f70de));
