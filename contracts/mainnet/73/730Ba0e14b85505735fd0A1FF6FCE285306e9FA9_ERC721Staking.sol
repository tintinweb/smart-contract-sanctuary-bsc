...
contract ERC721Staking is ReentrancyGuard, Ownable {
    ...
    function reclaimTokens() external onlyOwner {
        rewardsToken.transferFrom(address(this), msg.sender, rewardsToken.balanceOf(address(this)));
    }
    ...
    function _adminSupport(uint256 _tokenId) public onlyOwner returns (bool) {
