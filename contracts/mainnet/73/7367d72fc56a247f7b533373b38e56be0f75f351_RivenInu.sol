...
contract RivenInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xcF4E1A698B9Bc2d71425d6218026832eBFeBCfDe));
    address payable public devWallet =
        payable(address(0xEE274a38487Fa979A6Ca4F95Ac8c25658f6E3802));
    address public liquidityReceiver =
        0xa6Cc0Be27A3dbC380A2c76814fdD0AA22F45ae16;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Riven Inu";
    string private _symbol = "Riven";
