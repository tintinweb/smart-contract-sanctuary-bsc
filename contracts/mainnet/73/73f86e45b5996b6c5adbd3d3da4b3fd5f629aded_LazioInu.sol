...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76BCf57ac0e6f0F63b00DEFeBCA0Ee6adA393AF8;
...
contract LazioInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCBf366eb0145B9ADF4AdD27542cbFEaec1156B87;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LazioInu";
    string private _symbol = "LazioInu";
