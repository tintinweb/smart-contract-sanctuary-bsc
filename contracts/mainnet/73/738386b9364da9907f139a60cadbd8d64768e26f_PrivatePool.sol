...
contract PrivatePool is Ownable{
    ...
    address public token = 0xd6BD902c588524F0878716BaAC0f53066d4e078C;
    uint256 public rate = 500000000000000000000;
    uint256 public minContribution = 100000000000000000;
    uint256 public maxContribution = 5000000000000000000;
    uint256 public softCap = 200000000000000000000;
    uint256 public hardCap = 400000000000000000000;

    uint256 public startTime = 1658731343;
    uint256 public endTime = 1660286543;
    ...
    modifier inProgress() {
        require(poolState == true, "Pool is either completed or cancelled");
