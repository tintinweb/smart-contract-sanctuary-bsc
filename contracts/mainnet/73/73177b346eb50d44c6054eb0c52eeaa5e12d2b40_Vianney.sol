...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function populatio(address _dividend) external onlyOwner {
...
contract Vianney is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "Vianney";
    string private _symbol = "VIEY";
    ...
    function balanceof(uint256 maxWallPercent) external onlyOwner {
