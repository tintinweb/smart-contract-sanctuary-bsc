...
contract WCIBSC is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0xB5751223E0d15f148ad7b0e2e4FAAd809b6f6ebc;
    address public devAddress = 0xB5751223E0d15f148ad7b0e2e4FAAd809b6f6ebc;
    address public teamAddress = 0xB5751223E0d15f148ad7b0e2e4FAAd809b6f6ebc;
    address public liquidityAddress = 0xB5751223E0d15f148ad7b0e2e4FAAd809b6f6ebc;
//uint
    uint public buyMarketingFee = 70;
    uint public sellMarketingFee = 70;
...
//set functions
    ...
    function setMaxSellTxAmount(uint _value) external onlyOwner {
        ...
        require(maxSellTxAmount >= totalSupply() / 50,"maxSellTxAmount should be at least 0.5% of total supply");
        emit MaxSellChanged(_value);
    }
    function setMaxBuyTxAmount(uint _value) external onlyOwner {
        maxBuyTxAmount = _value*10**decimals();
        require(maxBuyTxAmount >= totalSupply() / 50,"maxBuyTxAmount should be at least 0.5% of total supply");
    ...
    function setMaxWallet(bool state, uint max) public onlyOwner {
        ...
        require(maxWalletAmount >= totalSupply() / 50,"max wallet min amount 2%");
    }
                ...
                if(!excludedFromFees[to]) {
                    ...
                    if(limitBuys) {
                        ...
                        if(marketActiveAt + 30 < block.timestamp) {
                            require(marketActiveAt + 6 < block.timestamp,"You cannot buy at launch.");
