...
contract SnorlaxCoin is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "SnorlaxCoin";
    string constant _symbol = "SnorlaxCoin";
