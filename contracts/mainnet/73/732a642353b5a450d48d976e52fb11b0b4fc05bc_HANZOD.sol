...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x677E26b7f27ed5F538fAE7f241e0c1C752a54A10;
...
contract HANZOD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x677E26b7f27ed5F538fAE7f241e0c1C752a54A10;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HANZO DAO";
    string private _symbol = "HANZOD";
