...
contract CaiShenRabbit
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " CaiShenRabbit";
    string private _symbol = " CaiShenRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C254e2356755f9C7EEF239F18dCA7A4906687CD);
    address payable public teamWalletAddress = payable(0x2C254e2356755f9C7EEF239F18dCA7A4906687CD);
    address public immutable deadAddress =0x2C254e2356755f9C7EEF239F18dCA7A4906687CD;
