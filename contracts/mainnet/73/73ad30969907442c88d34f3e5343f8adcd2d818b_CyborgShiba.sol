...
contract CyborgShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cyborg Shiba Inu"; // 
    string private constant _symbol = "CyborgShiba"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x1BFe44b40a5A5AB4a2D3412D657aE05d3eee0252;
