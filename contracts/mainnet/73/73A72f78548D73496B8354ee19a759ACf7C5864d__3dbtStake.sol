// SPDX-License-Identifier: MIT
    ...
    contract _3dbtStake is Ownable, IERC721Receiver{
    ...
    // Contract Addresses
    address _nft_Contract = 0x6f1Dc8a50489C96B6c09bb2aEc28c4043fB1A802;
    address _token_Contract = 0x2B5A25B4007Ad41FBc463b077022fdf5dd7c8b23;
    ...
    function claimRewards(uint256 _tokenID) public {
        ...
        uint256 rewardRelease = (tokenStakedDuration[msg.sender][_tokenID] * 1 * 10 ** 18) / 86400;
