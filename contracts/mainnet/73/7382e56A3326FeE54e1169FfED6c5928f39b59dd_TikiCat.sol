...
contract TikiCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEAC342be5d8AB1937834224d74C3b679a6F50e42); 
    address payable public Wallet_Dev = payable(0xa5145317765556EFd108c4B3bfF6c47435997222);
    ...
    string private constant _name = "Tiki Cat"; 
    string private constant _symbol = unicode"$TIKI"; 
    ...
    constructor () {
        ...
        _owner = 0xbdfa129013EA4feBdFCd7C123e5CB4EDcaB7AB63;
