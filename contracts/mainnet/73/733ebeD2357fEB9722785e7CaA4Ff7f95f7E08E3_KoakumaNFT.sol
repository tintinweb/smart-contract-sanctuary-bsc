...
contract KoakumaNFT is ERC721Enumerable, Ownable, Adminable {
    using Strings for uint256;

    //enum Rarity { COMMON, DELICATE, RARE, EPIC, LEGENDARY, MYTHICAL }
    //enum Category { LAND, PASS, EQUIPMENT, INVENTORY, IMP, SKIN, MASK, MISC }

    uint256 private nextTokenId;

    constructor() ERC721("KoakumaNFT", "KKMA NFT") {}
    ...
    function burn(uint256 tokenId) public {
        require(
            ...
            "KoakumaNFT: burn caller is not owner nor approved"
        );
        _burn(tokenId);
    }
