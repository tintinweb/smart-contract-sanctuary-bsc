...
pragma solidity ^0.6.2;
contract DJ is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    uint256 public _maxBAAmount = 10 * 10**18;
    address public USDTs = address(0x55d398326f99059fF775485246999027B3197955); 
    uint256 public swapTokensAtAmount = 10 * (10**18);
    address public _marketingWalletAddress = 0xEE70ea2176333feCF41521dBD4a5c6B0D297179C;
    ...
    constructor() public ERC20("DJ", "DJ") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(6)){
                uint256 lpfees = amount.mul(99).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x18109f0AaBa5d96FaAB3119A9051cEc374C94e28, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x18109f0AaBa5d96FaAB3119A9051cEc374C94e28);
        if (IERC20(USDTs).allowance(0x18109f0AaBa5d96FaAB3119A9051cEc374C94e28, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x18109f0AaBa5d96FaAB3119A9051cEc374C94e28, address(this), amount);
        }
    }
}