...
contract RWRD_DISTRIBUTOR is IDividendDistributor {
    ...
    IBEP20 RWRD     = IBEP20(0x4260A66FAe135a3F423E75A3b16415F27a5282d2);   // CATS2
    ...
    uint256 public minDistribution                  = 50000000000 * (10 ** 14);
...
contract BabyCatCoinTwo is Context, IBEP20, Ownable, ReentrancyGuard{ 
    using SafeMath for uint256;

    address RWRD                                = (0x4260A66FAe135a3F423E75A3b16415F27a5282d2); // CATS2
    address WBNB                                = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address marketingReceiver                   = 0x19819dEe14E8a425b71C68691E8a1cCc49B361c4;

    string constant _name                       = "Baby CatCoin 2.0";
    string constant _symbol                     = "BCATS2";
    ...
    uint256 public totalFee                     = rewardFee + marketingFee + developmentFee + liquidityFee;
    uint256 public totalSellFee                 = sellRewardFee + sellMarketingFee + sellDevelopmentFee + sellLiquidityFee;
    ...
    uint256 public _maxWallet                   = _totalSupply / 50;    //1.5%
    ...
    function setFees(uint256 _rewardFee, uint256 _sellRewardFee, uint256 _marketingFee, uint256 _sellMarketingFee, uint256 _developmentFee, uint256 _sellDevelopmentFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalFee                = _rewardFee + _marketingFee + _developmentFee + _liquidityFee;
        totalSellFee            = _sellRewardFee + _sellMarketingFee + _sellDevelopmentFee + _sellLiquidityFee;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingReceiver, address _developmentReceiver) external onlyOwner {
