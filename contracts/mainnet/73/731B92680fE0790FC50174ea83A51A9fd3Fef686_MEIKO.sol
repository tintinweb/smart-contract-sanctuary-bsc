...
// TELEGRAM: https://t.me/MeikoOfficial

// 𝐖𝐄𝐁𝐒𝐈𝐓𝐄: https://meiko.club

// 𝐓𝐖𝐈𝐓𝐓𝐄𝐑: https://twitter.com/CryptoMeiko

// 𝐓𝐎𝐊𝐄𝐍𝐎𝐌𝐈𝐂𝐒 > 2% 𝙇𝙋, 2% 𝙈𝘼𝙍𝙆𝙀𝙏𝙄𝙉𝙂
...
contract MEIKO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meiko";
    string private constant _symbol = "MEIKO";
    uint8 private constant _decimals = 9;

    uint256 public _MeikoliquidityFee = 2;
    uint256 public _MeikomarketingFee = 2;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _MeikomarketingFee / 100;
        uint256 liquidityFee = amount * _MeikoliquidityFee / 100;
    ...
    function swapAndLiquify() private {
        uint256 liquidityTokens = balanceOf (address(this)) * _MeikoliquidityFee / (_MeikomarketingFee + _MeikoliquidityFee);
