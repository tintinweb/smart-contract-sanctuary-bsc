...
contract Workers is ERC721Enumerable, Ownable, WorkerFactory, PriceConsumerWTN {
        ...
        returns (Worker memory)
    {
     ...
     function test_value() public view returns (uint256) {
        uint256 ERC20_BNB_Price = _getERC20Price(tokenAddress);
        return ERC20_BNB_Price; //  amounBNBReward = weis cuantos bnb son la cantidad de dolares deseada    erc20_bnb_price = weis de bnb
    }
...
contract PriceConsumerWTN {
    ...
    function test_getErc20Price(address ERC20_ADDRESS) public
        view
        returns (uint256[] memory) {
