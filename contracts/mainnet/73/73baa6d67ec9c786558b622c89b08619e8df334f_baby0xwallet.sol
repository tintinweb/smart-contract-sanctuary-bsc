...
contract baby0xwallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby 0xWallet"; // 
    string private constant _symbol = "B0XW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xaA8bdF6F74B8FC5a1d384564223236cf300f6C8A;
