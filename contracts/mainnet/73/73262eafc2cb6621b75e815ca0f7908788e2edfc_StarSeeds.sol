...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22657C6BCD688c072eeA447026Ce6e4aAf946030;
...
contract StarSeeds is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA28DC72186854b856f1DBF8495CCbe7d4d3A6373;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Star Seeds";
    string private _symbol = "SSToken";
