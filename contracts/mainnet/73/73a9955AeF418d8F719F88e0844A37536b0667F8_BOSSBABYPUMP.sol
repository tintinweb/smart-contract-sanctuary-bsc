...
/**
Telegram: https://t.me/BOSSBABYPUMP
...
contract BOSSBABYPUMP is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 30 / 1000; // THRESHOLD: 1 = 0.1%
    ...
    string private constant _name = "BOSSBABYPUMP"; //
    ...
    Taxes public taxes = Taxes(1,9,2,0); //
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        uint256 marketingAmt = unitBalance * 9 * taxes.marketing;
        if(marketingAmt > 0){
    ...
    // Owner cannot transfer out BOSSBABYPUMP from this smart contract
