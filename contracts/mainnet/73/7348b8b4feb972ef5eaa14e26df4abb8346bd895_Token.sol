...
contract Token is ERC20 {
	...
	address payable _receive = payable(address(0xeCB2a93cE84cc54F28ed9F4cbc85e01a080B5F7e));
    ...
    constructor(address tokenOwner) ERC20("SpaceX Falcon", "SpaceX Falcon") {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > 0){
            if (
                ...
                swapAndLiquifyV1(haveAmount.div(5).mul(4));
