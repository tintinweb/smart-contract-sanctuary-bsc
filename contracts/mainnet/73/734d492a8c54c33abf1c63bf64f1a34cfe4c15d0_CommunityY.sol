...
contract CommunityY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Community is Everything";
    string private constant _symbol = unicode"CommunityY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0xA1c2d96F501ca6B5ed73F94F8b6Ac26833aaBf15);
    address payable private MarketingWallet = payable(0xA1c2d96F501ca6B5ed73F94F8b6Ac26833aaBf15);
