...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 210000 * 10** Decimals;
        walletLimit =  210000 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyFundFee + _buyLiquidityFee) * 2 / swapFee;
        uint256 liquidityAmount = fistBalance * (_sellLiquidityFee + _sellFundFee) * 2 / swapFee;
...
contract DAMC is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        210000,//Supply
        address(0xB2AF2A058EA8C57Fb62AA99220058fdAC2F06356),//FundAddress
