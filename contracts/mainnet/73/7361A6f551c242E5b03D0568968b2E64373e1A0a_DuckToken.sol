...
contract DuckToken is Context, IERC20, Ownable {
    ...
    string private _name = "BL2";
    string private _symbol = "BL2";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x0a16d702e7a90CA975229eDF9D1E14988B67a0e8);
    address payable public teamWalletAddress = payable(0x0a16d702e7a90CA975229eDF9D1E14988B67a0e8);    
