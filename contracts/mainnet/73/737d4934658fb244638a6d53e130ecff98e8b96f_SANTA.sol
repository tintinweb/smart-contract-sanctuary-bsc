...
// 🎅 PitbullSanta is basically a meme token. But as we approach the new year, we have special surprises for you. 🐶

// 🐶 Let's all see x100 together on New Year. Join the team and let's celebrate together. 🎅

// 🎅 PitbullSanta wishes you a happy 🆕🆕 year! 🎅 🥳 🎇

// 🐶 https://t.me/PitbullSanta 
...
contract SANTA is ERC20, Ownable {
    ...
    constructor () ERC20("PITBULL SANTA", "SANTA") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x0174D1db03413c5d8121a708645a2C48eE20d559;
