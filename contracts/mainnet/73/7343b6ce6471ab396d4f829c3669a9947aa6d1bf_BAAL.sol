...
contract BAAL is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 300 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "Baal";
    string private _symbol = "BAAL";
    uint8 private _decimals = 18;


    uint256 public _taxFee = 5; // 10 = 1%, 5 = 0.5%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _burnFee = 5; // 10 = 1%, 5 = 0.5%
