...
/**
Telegram https://t.me/mushroominu
Website : https://twitter.com/mushroominu
*/

/**
Mushroom inu is a meme token that will run new hype on a BSC network that aims to build a strong community such as the previous meme token in general.
 
Basically the key to a meme token is from the strength of a strong community holder, in order to keep the price stable in trade. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc55a4d481aA555eA15452a7b3B254913Bf6914E0; // owner address
...
contract MushroomInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mushroom Inu";
    string private _symbol = "MINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f5A422E42C7EFd2E0Fa494241934370470cd0F1); // Marketing Address
    address payable public teamWalletAddress = payable(0x1bD989d5Dd63613F7BC0957859668681c1af88fe); // Team Address
