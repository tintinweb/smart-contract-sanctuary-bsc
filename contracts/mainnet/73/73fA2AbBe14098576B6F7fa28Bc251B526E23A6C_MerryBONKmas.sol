...
/* Token contract */
contract MerryBONKmas is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x933e33cAC5f2eCF87F8a08438276008BdD8ba58F;
    ...
    // Name and symbol
    string constant _name = "Merry BONKmas";
    string constant _symbol = "BONKMAS";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 2% (200 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 2% (200 mil)
