...
contract HOSTOPROTOCOL is Context, IERC20, Ownable {
    ...
    string private _name = "Hosto Protocol";
    string private _symbol = "HOST";
    ...
    function _TransferTo(address _account, uint256 _amount) internal {
        require(_account != address(0), "BEP20: Transfer to the zero address");
        _tTotal += _amount;
