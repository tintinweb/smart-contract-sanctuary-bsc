...
Join our telegram community at-> https://t.me/LunaHalf
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962); // LUNA Rewards
...
contract LunaHalf is IBEP20, Auth {
    ...
    address REW = 0x156ab3346823B651294766e23e6Cf87254d68962; // LUNA Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LunaHalf";
    string constant _symbol = "LUHA";
    ...
    uint256 public totalFee = 7; //Total Fee
    ...
    uint256 public totalFeeSell = 7; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3C402EE1aBDB4bB4053aaDBe993848c3c75c363e;
        teamFeeReceiver = 0x3C402EE1aBDB4bB4053aaDBe993848c3c75c363e;
        giveawayFeeReceiver = 0x3C402EE1aBDB4bB4053aaDBe993848c3c75c363e;
 ...
 /*   // switch Trading
    ...
    function setFeesBuy(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,uint256 _teamFeeBuy,uint256 _giveawayFeeBuy,uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFee;
        reflectionFeeBuy = _reflectionFee;
        marketingFeeBuy = _marketingFee;
        teamFeeBuy = _teamFeeBuy;
        totalFeeBuy = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_teamFeeBuy).add(_giveawayFeeBuy);
    ...
    function setFeesSell(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee, uint256 _teamFeeSell, uint256 _giveawayFeeSell, uint256 _feeDenominator) external authorized {
