...
contract IDKTHEDEV_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "IDK THE DEV";
    string private constant _symbol = "IDKDEV";
