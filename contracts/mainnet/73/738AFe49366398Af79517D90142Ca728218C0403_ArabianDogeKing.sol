...
contract ArabianDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian-Doge King";
    string private _symbol = "$ADoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3BE787874186dFCaea4F2a156D5EDF038f1543B);
    address payable public teamWalletAddress = payable(0xa3BE787874186dFCaea4F2a156D5EDF038f1543B);
