...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60E3e55fa5A12D552502692343c73FE53A96Ab75; 
...
contract KengYuanYuan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KengYuanYuan";
    string private _symbol = "KengYuanYuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60E3e55fa5A12D552502692343c73FE53A96Ab75); // 
    address payable public teamWalletAddress = payable(0x60E3e55fa5A12D552502692343c73FE53A96Ab75); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x60E3e55fa5A12D552502692343c73FE53A96Ab75)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x60E3e55fa5A12D552502692343c73FE53A96Ab75),removeRandom);
}}