...
contract AISHINKO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "AI SHINKO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x83b6b1A0BA63D2dD99841Efd434aa723e273F634));
        marketingWalletAddress = payable(address(0x83b6b1A0BA63D2dD99841Efd434aa723e273F634));
