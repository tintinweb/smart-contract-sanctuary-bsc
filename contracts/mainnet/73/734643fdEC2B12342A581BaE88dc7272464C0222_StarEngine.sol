...
/*
Telegram    : https://t.me/thestarengine
Twitter     : https://twitter.com/Starengineco
...
contract StarEngine is Context, IERC20 { 
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "WOFO: new owner is the zero address");
    ...
    address payable public Wallet_Game = payable(0x7b12ef2137DCA9c380a5Cb94Fc4B20890F00caE5);
    address payable public Wallet_Dev = payable(0x17607EB1Ec351445Ce77Fe4C318268Eb172af294);
    address payable public constant Wallet_Burn = payable(0x0000000000000000000000000000000000000000); 
  
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =2*10**15* 10**_decimals;
    string private constant _name = "Star Engine"; 
    string private constant _symbol = unicode"STEG"; 
    ...
    uint256 public constant Percent_Game = 50;
    uint256 public constant Percent_Dev = 30;
    uint256 public constant Percent_Burn = 0;
    uint256 public constant Percent_AutoLP = 20; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 split_M = Percent_Game * 100 / ((Percent_AutoLP/2) + Percent_Game + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / ((Percent_AutoLP/2) + Percent_Game + Percent_Dev);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
     ...
     function setBuyTax(uint256 buyTax) public onlyOwner {
         require(buyTax < 15, "wofo: max tax 15%");
        _Tax_On_Buy = buyTax;
    }
    function setSellTax(uint256 sellTax) public onlyOwner {
         require(sellTax < 15, "wofo: max tax 15%");
        _Tax_On_Sell = sellTax;
    }
    function setSwapTrigger(uint8 swapTrig) public onlyOwner {
        swapTrigger = swapTrig;
    }
    function setGameAddress(address _gameAddress) external onlyOwner {
        Wallet_Game = payable(_gameAddress);
    }
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        Wallet_Dev = payable(_marketingAddress);
    }
