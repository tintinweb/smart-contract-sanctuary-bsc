...
FIND DOKWON created by whales and holders LUNC is a hyper-deflationary token,
released on the Binance Smart Chain network, dedicated to helping the LUNA
CLASSIC community by constantly burning $LUNC tokens and rewarding the holders
with high passive income in $LUNC, also with a charity utility ready to help the
 people in need from all ver the world!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962); //LUNC
...
contract  FDK is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FIND DOKWON";
    string constant _symbol = "FDK";
    ...
    address RewardToken = 0x156ab3346823B651294766e23e6Cf87254d68962; 
        //How to get Reward?? add LUNC token ahead and hold your FDK Token to recieve LUNC reward!
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xDB731B25c875a8B9D83406adA56b1FfEDe62F3A9;
