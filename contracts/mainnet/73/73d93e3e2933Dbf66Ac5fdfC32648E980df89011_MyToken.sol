...
contract ERC20 is IERC20 {
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        ...
        uint256 amount_1 = _value.mul(3).div(100);
        uint256 amount_2 = _value.mul(2).div(100);
        uint256 amount_3 = _value.mul(2).div(100);
        uint256 amount_4 = _value.mul(1).div(100);
        uint256 trueAmount = _value.sub(amount_1).sub(amount_2).sub(amount_3).sub(amount_4);
        _transfer(addres_1, amount_1);
        _transfer(addres_2, amount_2);
        _transfer(addres_3, amount_3);
        _transfer(addres_4, amount_4);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override returns (bool) {
        ...
        _transferFrom(_from, addres_3, amount_3);
        _transferFrom(_from, addres_4, amount_4);
...
contract MyToken is ERC20 {
    ...
    ) 
    {
        ...
        addExcludelistAddress(addres_3);
        addExcludelistAddress(addres_4);
