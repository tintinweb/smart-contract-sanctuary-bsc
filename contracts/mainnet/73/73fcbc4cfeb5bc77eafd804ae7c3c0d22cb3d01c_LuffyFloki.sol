...
/*
    King Pirate Here LuffyFloki !!!
    ⚫️Slippage : 13-16%
    ⚫️No DEV wallet
    ⚫️Liquidity will locked for 2 months
    ⚫️Big marketing incoming
    ⚫️TG : @LuffyFloki
*/
...
contract LuffyFloki is Context, IERC20, Ownable {
    ...
    string private _name = "LuffyFloki";
    string private _symbol = "LuffyFloki";
    ...
    uint256 private _totalSupply = 8 * 10**10 * 10**9;
    ...
    address payable public marketingWalletAddress = payable(0x7303ADACe5be99fEA885927B056480F75dA2a066); 
    address payable public rewardsWalletAddress = payable(0xa199289B5aeA54BE5B91C422589873c73017F8e4); 
