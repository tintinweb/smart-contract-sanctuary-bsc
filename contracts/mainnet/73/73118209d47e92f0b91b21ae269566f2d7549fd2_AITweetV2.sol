...
contract AITweetV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI Tweet V2";
    string private constant _symbol = "AITv2";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0x1B86Fe911A71f8dF8410EB2DF3f4a3254110d084);
    address payable private _charitableAddress = payable(0xd66052cd517Df5bef3052aE9C596F12ADf2D4F45);
