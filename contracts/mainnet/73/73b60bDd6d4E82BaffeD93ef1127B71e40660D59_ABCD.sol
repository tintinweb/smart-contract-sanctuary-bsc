...
contract ABCD is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "ABCD";       //Full name
    string public symbol_ = "ABCD";      //abbreviation

    uint256 public deadFee = 0;       //Destroyed
    uint256 public liquidityFee = 0;      //LP reflow
    uint256 public marketingFee = 20;      //marketing
    ...
    uint256 public maxburn = 10000000000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0xDc3458F4dEA9473A3358312D41cE24514Af65172;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 10000000000 * (10**18);       //Supply
