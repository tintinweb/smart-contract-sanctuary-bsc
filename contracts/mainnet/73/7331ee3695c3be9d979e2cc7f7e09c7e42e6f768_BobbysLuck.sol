...
library Address{
 ...
 contract BobbysLuck is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x736F62254C572256E10b8B41F03D217e8b37197c;
    address public donationWallet = 0x736F62254C572256E10b8B41F03D217e8b37197c;

    string private constant _name = "Bobby's Luck";
    ...
    Taxes public taxes = Taxes(0, 2, 4, 4);
    Taxes public sellTaxes = Taxes(0, 2, 4, 4);
