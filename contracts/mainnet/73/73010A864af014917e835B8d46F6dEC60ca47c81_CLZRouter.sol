...
contract CLZRouter is SafeOwnable {
    ...
    function addLiquidityAndStaked(
        address tokenA,
        address tokenB,
        uint amountADesired,
        uint amountBDesired,
        ...
        )
    {
        ...
        IEMEPair(pair).approve(address(dispatchPool), liquidity);
        dispatchPool.stakeFor(msg.sender, liquidity);
    }
