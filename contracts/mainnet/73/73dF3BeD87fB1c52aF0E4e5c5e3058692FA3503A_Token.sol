...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "JXZ";
    string private _symbol = "JXZ";
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x846452923AAc7CE9267aE8cb1de4A6CAC430c8C8),
            _msgSender(),
            _tTotal
        );
    }
