...
contract FastFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FastFloki";
    ...
    uint256 public swapThreshold = _totalSupply * 384 / 100000; // 0.01% of supply
    bool inSwap;
