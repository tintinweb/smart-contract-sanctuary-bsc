...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9dd917aCFDED74aFa2b3Ae47F4b83D5e4935B11E; // owner address
...
contract BoosterAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BoosterAI";
    string private _symbol = "BAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9dd917aCFDED74aFa2b3Ae47F4b83D5e4935B11E); // Marketing Address
    address payable public teamWalletAddress = payable(0x9dd917aCFDED74aFa2b3Ae47F4b83D5e4935B11E); // Team Address
