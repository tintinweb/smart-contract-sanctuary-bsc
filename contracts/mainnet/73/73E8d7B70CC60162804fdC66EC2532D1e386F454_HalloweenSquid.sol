...
/**
telegram : https://t.me/HalloweenSquid

website : https://HallowenSquid.live
...
contract HalloweenSquid is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Halloween Squid";
    string constant _symbol = "$HSQD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 6 * 10**6 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x48bbD1297eb78F2cfe799f2395d36ED6Be3De598;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x48bbD1297eb78F2cfe799f2395d36ED6Be3De598;
