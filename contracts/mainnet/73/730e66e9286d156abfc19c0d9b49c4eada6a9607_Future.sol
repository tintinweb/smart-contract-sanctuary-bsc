...
contract Future is IERC20, Auth {
    ...
    string private constant  _name = "TheFuture";
    string private constant _symbol = "TFU";
    ...
    address payable public marketingWallet = payable(0xD22F2C11375d0783Fb2c8e44C6762FF34E5d9AfE);
