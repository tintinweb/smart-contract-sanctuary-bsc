...
contract TWITTERADVERTISEMENT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Advertisers";
    string private _symbol = "Twitter Advertisers";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x840d29585b5a310905c29ceac1cDE2778dB290ff); 
    address payable public TeamWalletAddress = payable(0x840d29585b5a310905c29ceac1cDE2778dB290ff); 
