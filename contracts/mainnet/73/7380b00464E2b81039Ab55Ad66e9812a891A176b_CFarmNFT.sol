...
contract CFarmNFT is Pausable, Ownable, ReentrancyGuard {
    ...
    address public   treasuryWallet = 0x6D86162DF4C2b54e4FEA1F6916DF157fd81C64d3;
    ...
    //função consultada pelo backend no monitoramento da treasuryWallet
    ...
    whenNotPaused {
        ...
        if (wichToken == 1) {
            ...
            IERC20(addressBUSD).transferFrom(buyer, address(this), amount);
        ...
        //cfarm
            ...
            IERC20(addressCFarm).transferFrom(buyer, address(this), amount);
