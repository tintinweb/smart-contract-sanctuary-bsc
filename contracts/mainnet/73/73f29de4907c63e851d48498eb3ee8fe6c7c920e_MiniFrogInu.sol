...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72D241b6498dA9D87E54Ee26e5e86E2da5ff7ad9;
...
contract MiniFrogInu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x72D241b6498dA9D87E54Ee26e5e86E2da5ff7ad9;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 3**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mini Frog Inu";
    string private _symbol = "MINIFROG";
