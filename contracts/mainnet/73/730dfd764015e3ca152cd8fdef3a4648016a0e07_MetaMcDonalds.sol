...
contract MetaMcDonalds is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x67bB16590F8d41BC4E65b21a1837c093133388f6); // Marketing Address
    ...
    string private _name = "Meta McDonalds";
    string private _symbol = "MetaMc";
