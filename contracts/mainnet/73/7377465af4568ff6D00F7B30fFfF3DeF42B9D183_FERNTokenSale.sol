...
contract FERNToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "FERN";
    string private _name= "FERN COIN";
...
contract FERNTokenSale {
    address payable admin;
    FERNToken public tokenContract;
    ...
    constructor(FERNToken _tokenContract, uint256 _tokensSold)  {
