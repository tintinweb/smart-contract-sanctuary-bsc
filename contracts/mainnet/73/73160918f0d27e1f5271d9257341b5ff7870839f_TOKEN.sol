...
contract TOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xdAfa77C0C0012daD295799C7c0bD6B0733cDEc41));
    address payable public devWallet =
        payable(address(0xeCAD36a8734afBF67a1f6FE42F16f509d2239D69));
    address payable public charityWallet =
        payable(address(0xA8565D7c3dEde035908a7514bfe55B4da57c59D8));
    address public liquidityReceiver =
        0xfA711022BEd14501558EDf95eD4D43e8A0F1EdD0;
        ...
        )
    {
        ...
        tTransferAmount.sub(tLiquidity);
        tTransferAmount = tTransferAmount.sub(tWallet);
        tTransferAmount = tTransferAmount.sub(tburn);

        return (tTransferAmount, tFee, tLiquidity, tCharity, tWallet, tburn);
    }
