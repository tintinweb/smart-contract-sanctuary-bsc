...
contract TestInu is IERC20, Auth {
    ...
    address payable public marketingWallet = payable(0xE6e3d91f28fa5A6ff588E48Be1B17DEDd9123456);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (enableBlacklistBlock && sender == pair && recipient != address(router) && !isFeeExempt[recipient]) {
