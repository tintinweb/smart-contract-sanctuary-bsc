...
contract SendorBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "SendorBNB";
    string private constant _symbol = "SendorBNB";
