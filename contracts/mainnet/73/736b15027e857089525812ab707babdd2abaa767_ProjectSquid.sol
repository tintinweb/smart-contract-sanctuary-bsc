...
contract ProjectSquid is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "PROJECT SQUID";
    string private _symbol = "PSQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7fB0c8c170F618C4A3013E7c04094d12465FA673);
    address payable public DevelopmentWalletAddress = payable(0x7fB0c8c170F618C4A3013E7c04094d12465FA673);
    ...
    uint256 private _totalSupply = 250000 * 10**9;
    uint256 public _maxTxAmount = 250000 * 10**9;
    uint256 public _walletMax = 250000 * 10**9;
