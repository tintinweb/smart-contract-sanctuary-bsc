...
contract BLOWINGCLOUDS is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'BLOWING CLOUDS';
    string private constant _symbol = 'BLOWING CLOUDS';
    ...
    uint256 public _maxWalletToken = ( _tTotal * 400 ) / 10000;
    uint256 public _mStx = ( _tTotal * 200 ) / 10000;
    ...
    uint256 public sT = 2000000000 * (10 ** _decimals);
    bool sTart = false;
