...
contract NewBee is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "NewBee";
    string constant _symbol = "NB";
    ...
    function removefee(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
   ...
   function getAccuracyBacking(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
    ...
    function supplytoken(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
