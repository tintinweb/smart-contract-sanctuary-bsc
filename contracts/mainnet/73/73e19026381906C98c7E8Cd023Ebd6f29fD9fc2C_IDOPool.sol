...
contract IDOPool is Ownable {
    ...
    function purchase(
        ...
        if (txnTokenAddress != address(0)) {
            ...
            uint256 dividAmount = txnAmount.mul(10).div(100);
            require(IERC20(txnTokenAddress).transferFrom(msg.sender, dividAddress, dividAmount));
            
            uint256 idoAmount = txnAmount.sub(dividAmount);
            require(IERC20(txnTokenAddress).transferFrom(msg.sender, address(this), idoAmount));
        } else {
