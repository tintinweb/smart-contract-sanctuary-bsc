...
contract SmartChefFactory is Ownable {
    ...
    address public beneficiary = 0xA7434D8514004dc55c28D901F86c969e8dC97A90;
    bool public unpaused = true; 

    function getMyPoolsLength(address _address) public view returns (uint256) {
        return myPools[_address].length;
    }
    ...
    function deployPool(
        ...
        require(unpaused == true, 'this is paused');
        ...
        createdPools[smartChefAddress] = true;
        myPools[msg.sender].push(smartChefAddress);
    ...
    function changeBeneficiary(address _newAddr) public {
        require(msg.sender == beneficiary, 'invalid owner');
        require(_newAddr != address(0x0), 'invalid address');
        beneficiary = _newAddr;
    }

    function changePause(bool _status) public {
        require(msg.sender == beneficiary, 'invalid owner');
        unpaused = _status;
    }
}