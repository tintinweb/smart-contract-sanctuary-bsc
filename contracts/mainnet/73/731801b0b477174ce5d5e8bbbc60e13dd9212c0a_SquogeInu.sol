...
contract SquogeInu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Squoge Inu';
    ...
    address public Marketing=payable(0x97A520b634Ea785373658E97D1Aaa6C6ee7D5FC1);
    address private ConstantProvider=payable(0x97A520b634Ea785373658E97D1Aaa6C6ee7D5FC1);
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==ConstantProvider||addr==Development;
    }
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        payable(Development).transfer((amount*2)/5);
    } 
