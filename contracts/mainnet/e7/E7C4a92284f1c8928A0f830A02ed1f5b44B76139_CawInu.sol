...
contract CawInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Caw Inu";
    string private _symbol = "CAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd4EA2aA413a83b040F7a118C6bE7cf7862F067b2);
    address payable public teamWalletAddress = payable(0xd4EA2aA413a83b040F7a118C6bE7cf7862F067b2);
