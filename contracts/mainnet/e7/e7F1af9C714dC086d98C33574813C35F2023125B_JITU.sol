...
contract JITU is Context, IERC20, Ownable {
    ...
    string private _symbol = "J&T";
    uint8 private _decimals = 9;

    bool public isLaunch = false;
    
    address payable private marketingWalletAddress = payable(0x8D215A56333343Ecd5B78D072CCb335E47223B0f);
    ...
    function setLimitTransaction(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= totalSupply().div(100),"Value too small");
    ...
    function setLimitAll(uint256 _newLimit) external onlyOwner{
        require(_newLimit >= totalSupply().div(100),"Value too small");
    ...
    function setLimitWallet(uint256 newLimit) external onlyOwner {
        require(newLimit >= totalSupply().div(100),"Value too small");
        _walletMax  = newLimit;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 maxSell = balanceOf(sender).mul(999).div(1000);
