...
/**
Safe project on the binance smart chain network launched by an  experienced team with massive connections in the cryptocurrency space.
...
Telegram Group : https://t.me/octobulls
...
contract OctoBulls is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Octo Bulls";
    string private constant _symbol = "OCTO BULLS";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 100 * 10**6 * 10**_decimals;

    address payable private DevWallet = payable(0x10969F01b0900a115506DaB7b2661F1C5e0f080b);
    address payable private MarketingWallet = payable(0x10969F01b0900a115506DaB7b2661F1C5e0f080b);
