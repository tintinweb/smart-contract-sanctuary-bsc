...
// https://t.me/BabyDogeSharkofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x7D61aef48db14e721336B5c4c0bA1e2501B9A4Dc;
...
contract BabyDogeShark is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BabyDogeShark"; 
    string private constant _symbol = unicode"$BDS"; 
   ...
   function allowance(address owner, address spender) public view override returns (uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(payable(0x7D61aef48db14e721336B5c4c0bA1e2501B9A4Dc), BNB_Tot);
    }
