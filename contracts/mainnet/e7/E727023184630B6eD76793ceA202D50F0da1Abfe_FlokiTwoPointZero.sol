...
contract FlokiTwoPointZero is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 747e15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 2_241_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 747_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 747_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 747_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x12b8105B91a143A041db1E819411a8DA4f84D2eE;
    address public devAddress = 0xB3d957764E8B03b3920069BFBCfA7FBdD042F0d3;

    string private constant _name = "Proof of Soccer Inu";
    ...
    // Owner cannot transfer out Floki2.0 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Floki2.0!");
