...
contract ctmoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Moon";
    string private _symbol = "ctmoon";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xe8612F790835a4e4E273aA0E60BC5d55DBA9e623); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe8612F790835a4e4E273aA0E60BC5d55DBA9e623); // BuyBack Address
