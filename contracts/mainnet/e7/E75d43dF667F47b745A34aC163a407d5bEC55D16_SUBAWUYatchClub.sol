...
contract SUBAWUYatchClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUBAWU Yatch Club";
    string private _symbol = "SUBAWUYATCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x91BaD8e556deA8F2e4F6ab678e2380df73E09b5f);
    address payable public teamWalletAddress = payable(0x91BaD8e556deA8F2e4F6ab678e2380df73E09b5f);
