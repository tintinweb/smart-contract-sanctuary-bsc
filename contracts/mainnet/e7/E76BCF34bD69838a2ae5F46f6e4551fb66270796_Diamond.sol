...
contract Diamond is ERC20 {
    ...
    uint256 public lpFee = 70;
    uint256 public marketFee = 70;
    ...
    constructor() ERC20("77", "77") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0xE3C0cB344B66E87687448f6E596CAF586FB93a51);
        marketAddress = address(0xE3C0cB344B66E87687448f6E596CAF586FB93a51);
        teamAddress= address(0xE3C0cB344B66E87687448f6E596CAF586FB93a51);
        ...
        _mint(_tokenOwner, 77 * 10**18);
        divLpHolderAmount = 1 * 10**16;
        lpTokenDivThres = 77 * 10**18;
    }
