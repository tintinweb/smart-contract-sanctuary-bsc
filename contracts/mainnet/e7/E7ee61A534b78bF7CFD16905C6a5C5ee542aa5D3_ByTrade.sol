...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[owner] = 8000000000*10** uint(decimals);
    balances[address(this)] = 2000000000*10** uint(decimals);
    emit Transfer(address(0), owner, 8000000000*10** uint(decimals));
    emit Transfer(address(0), address(this), 2000000000*10** uint(decimals)); 
  }
...
contract ByTrade is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 125*10** uint(decimals), 200000000);
      startSale(block.number, 99999999, 0, 12500*10** uint(decimals), 1800000000);
}
