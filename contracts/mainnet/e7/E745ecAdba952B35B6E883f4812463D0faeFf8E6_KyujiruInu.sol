...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3060C9217c3FA1509004bd148844ACEcB4DD64f5; // owner address
...
contract KyujiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Kyujiru Inu";
    string private _symbol = unicode"KYU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3060C9217c3FA1509004bd148844ACEcB4DD64f5); // Marketing Address
    address payable public teamWalletAddress = payable(0x3060C9217c3FA1509004bd148844ACEcB4DD64f5); // Team Address
