...
//      JAIL KWON coins have been popular lately, this one is a Chinese coin that is picking up some momentum..
//  
//      Tg:https://t.me/JAILBABYKWON
...
contract JAILBABYKWON is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("JAIL BABYKWON", "JBKWON") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "JAIL BABYKWON";
    string private _symbol = "JBKWON";
