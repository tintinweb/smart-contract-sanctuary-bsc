...
contract BioDeposit_Core is AccessControlUpgradeable, PausableUpgradeable
{
   ...
   struct LeaderBonus{
    ...
    function initialize(address _NFTContract) public initializer {
       ...
       // ID=3 initialize
       totalBuyAmounts[0] += 10030000000000000000000;
       users[3].personalDeposit += 10030000000000000000000;
       addItems(3,0,85);
       users[2].firstLineVolume += 10030000000000000000000;
       users[2].structureVolume += 10030000000000000000000;
       users[2].mainBranchVolume += 10030000000000000000000;

       users[1].structureVolume += 10030000000000000000000;
       users[1].mainBranchVolume += 10030000000000000000000;
       users[1].USDBalance += 1905700000000000000000;
       users[1].USDBalanceWithdrawn += 1905700000000000000000;

       counters[0] += 1905700000000000000000;
       counters[2] += 1905700000000000000000;
