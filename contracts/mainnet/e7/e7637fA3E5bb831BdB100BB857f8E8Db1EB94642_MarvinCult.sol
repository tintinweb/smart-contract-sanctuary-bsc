...
contract MarvinCult is IBEP20, Auth {
    ...
    string constant _name = "MarvinCult";
    string constant _symbol = "MarvinCult";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 200; //1.5% 
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100; //3%
    ...
    address private marketingFeeReceiver = 0xeBDFdaF53206e745f79Ed84e4AE208Fad01eA2E6;
    address private developmentFeeReceiver = 0xeBDFdaF53206e745f79Ed84e4AE208Fad01eA2E6;
