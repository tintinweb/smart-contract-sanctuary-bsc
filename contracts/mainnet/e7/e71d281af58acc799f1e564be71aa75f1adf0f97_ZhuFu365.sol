...
contract     ZhuFu365
 is Context, IERC20, Ownable {
    ...
    string private _name = " ZhuFu365";
    string private _symbol = " ZhuFu365";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55ca39d602019b0F9c96C958A447CA9573554767);
    address payable public teamWalletAddress = payable(0x55ca39d602019b0F9c96C958A447CA9573554767);
    address public immutable deadAddress =0x55ca39d602019b0F9c96C958A447CA9573554767;
    ...
    uint256 private _totalSupply =  365 * 10**_decimals;
    uint256 public _maxTxAmount =   365 * 10**_decimals; 
    uint256 public _walletMax =     365 * 10**_decimals;
