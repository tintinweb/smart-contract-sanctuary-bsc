...
contract Mercury is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf71Cf824aa57DDAf335863634b8Df7b0DC487bA9); // Marketing Address
    ...
    uint256 public _tTotal = 1000000000000 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "MercuryCoin";
    string public _symbol = "MERC";
    ...
    function setGiveaway(uint256 sellTaxFee, uint256 sellLiquidityFee) external onlyOwner {
