...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(uint256 minBalance, address _rewardToken) DividendPayingToken("BabyCookieSale Reward Tracker", "BabyCookieSaleDividendTracker", _rewardToken) {
    	claimWait = 3600;
...
contract BabyCookieSale is ERC20, Ownable {
    ...
    address public marketingWallet = 0x2806152af8567C7B092f72aFbE415D5CC931919f; 
    ...
    address public constant rewardToken = 0x6d342877fC199c629f49A5C6C521C297b15BC92d;//COOKIE
    ...
    constructor() ERC20("BabyCookieSale", "BabyCookieSale") {
    ...
    function recoverForeignToken(address token, uint256 amount) public onlyOwner {
        require(token != address(this),"Cannot withdraw the native token");
