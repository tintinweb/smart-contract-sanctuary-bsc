...
contract NPV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NPV";
    string private _symbol = "NPV";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x756d170295b9cAfe303ad33a6a5C0dC22db7e6b2); 
    address payable public BurnedWalletAddress = payable(0x756d170295b9cAfe303ad33a6a5C0dC22db7e6b2); 
