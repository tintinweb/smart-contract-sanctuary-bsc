...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e3D38fdd6bE750ce897aD9642E6a57942a144a5;
...
contract SEXYSHIBAINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC569AC2fca697af047500b6dE454b3eb7Aa3a355;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "$EXY SHIBA INU";
    string private _symbol = "$EXY INU";
