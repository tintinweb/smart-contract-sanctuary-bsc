...
/**
 leonardoge da inu 
 join our journey for moon mission 100000x
 telegram group : https://t.me/LDIGLOBAL
...
contract LeonardogeDaInu is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xB01cD70003DedCF8B10Dc93d02BA9723E1c50f8A); 
    address payable private Wallet_Dev = payable(0xe4665B7667CaFA58BE6B6110f695B185f64EC1aD);
    ...
    string private constant _name = "Leonardoge Da Inu"; 
    ...
    uint256 private Percent_AutoLP = 17; 
    ...
    constructor () {
        ...
        _owner = 0xe4665B7667CaFA58BE6B6110f695B185f64EC1aD;
