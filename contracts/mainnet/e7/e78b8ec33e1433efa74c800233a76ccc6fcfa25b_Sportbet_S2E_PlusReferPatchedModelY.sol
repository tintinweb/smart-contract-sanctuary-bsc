...
contract Sportbet_S2E_PlusReferPatchedModelY is Ownable {
    ...
    address constant nullAddress = 0x794f8A70a6507e8E2DddDf3E26c6130a2016d7dc; //<<UPDATE TO PERSONAL ADDRESS TO COLLECT FEES <<0x000000000000000000000000000000000000dEaD;
    ...
    constructor(IERC20 _chipToken, uint _earningsFeeBP, uint _referralRewardsFeeBP) {
    ...
    external onlyOwner {
        ...
        require(_maxPoolSize >= 10*1e9 && _maxPoolSize <= 4*1e9*1e9 , "createGambling: _maxPoolSize should be between 10 S2K and 4 BILLION S2K (ATTENTION: the decimal digits in this contract is 9)!");
        ...
        odds: [_aTeamOdds, _drawOdds, _bTeamOdds], maxPoolSize: _maxPoolSize*1e9}));
    }
