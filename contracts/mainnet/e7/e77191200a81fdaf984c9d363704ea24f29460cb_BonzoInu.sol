...
library Address{
 ...
 contract BonzoInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB755a6d0130f91498AbB2AB04Ab4dCc6399Db44B;
    address public donationWallet = 0xB755a6d0130f91498AbB2AB04Ab4dCc6399Db44B;

    string private constant _name = "Bonzo Inu";
    string private constant _symbol = "BONZO";
    ...
    Taxes public taxes = Taxes(6, 3, 3, 0);
    Taxes public sellTaxes = Taxes(6, 3, 3, 0);
