...
contract BANKERINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Banker Inu";

    string private _symbol = "Banker Inu";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x185645a49cea5a1c9D294F19DE200D540CC79a5e;
