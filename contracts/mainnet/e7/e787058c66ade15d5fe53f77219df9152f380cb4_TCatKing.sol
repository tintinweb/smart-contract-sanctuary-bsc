...
contract TCatKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TCatKing";
    string private _symbol = "TCatKing";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x78108Af8685e9d27D52B885ef14C1066B05fA3bB); 
    address payable public ttWal = payable(0x78108Af8685e9d27D52B885ef14C1066B05fA3bB); 
