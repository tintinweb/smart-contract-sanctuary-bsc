...
contract token is ERC20 {
    ...
    string internal tokenName = "cscs";
    string internal tokenSymbol = "cscs";
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(to == uniswapV2Pair){
                require(amount <= (balanceOf(from) / 10000),"exceed max");
                super._transfer(from, address(0xdead), amount.div(100).mul(5));
