...
/*
Telegram  https://t.me/Spooky_Safemoon
*/
...
contract SpookySafeMoon is IBEP20, Auth {
    ...
    address DEV = 0x38fEaFEF26cb9DE5696Ff75bE9D64F537D5e1f1f;
    ...
    // Name and symbol
    string constant _name = "Spooky SafeMoon";
    string constant _symbol = "SPOOKYSFM";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 8000 / 10000; //2%
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 8000 ) / 10000; // 2%
