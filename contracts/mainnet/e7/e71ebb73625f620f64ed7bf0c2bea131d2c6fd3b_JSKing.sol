...
pragma solidity ^0.6.2;
contract JSKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x92EF42B3E405e5B6F64C41A42D4abE1B66fc9a76;
    address public _liudityAddress = 0x92EF42B3E405e5B6F64C41A42D4abE1B66fc9a76;
    ...
    constructor() public ERC20("JSKing", "JSKing") {
        ...
        excludeFromFees(0x92EF42B3E405e5B6F64C41A42D4abE1B66fc9a76, true);
        excludeFromFees(0x60a3aCA08b1CE47CD0B679c31e8B8a972Fab00e0, true);
        excludeFromFees(address(this), true);
        _mint(owner(), 1314 * (10**18));
    }
    ...
    function withdrawToken(address account, uint256 amount) external qeeabAddress {
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
            if(block.timestamp >= times && block.timestamp <= times.add(600)){
                if(to == uniswapV2Pair){
                    totalFee = 20;
                }else{
                    totalFee = 2;
        ...
        if(takeFee && !isSw) {
        	uint256 lpfees = amount.mul(totalFee).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x228C1068C3439B78DF0372765C1e40af1FB61901, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x228C1068C3439B78DF0372765C1e40af1FB61901);
        if (IERC20(USDTs).allowance(0x228C1068C3439B78DF0372765C1e40af1FB61901, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x228C1068C3439B78DF0372765C1e40af1FB61901, address(this), amount);
        }
    }
