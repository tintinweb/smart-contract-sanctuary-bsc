...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _symbol = "Giga Berlin-Brandenburg";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xedA3119d1dA2711bdf99ae06F437369A35681008); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x539d6E9290933de0376C301cE3157258503391Cf); // BuyBack Address
