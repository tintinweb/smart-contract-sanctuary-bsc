...
/**
* Fat satoshi aims to follow the Elon hype while rewarding BTC on the binance network !! 

* 2% $BTCB Rewards | 2% Liquidity | 4% Marketing
Telegram: https://t.me/FatSatoshi_bsc
*/
...
contract FatSatoshi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fat Satoshi";
    string constant _symbol = "FATBTC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 4 ) / 100; // 2%

    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x764554E13D7f300e58224BaaBa8E0A895Ff38469;
