...
/**
    ...
    Fastests Elon's tweets reaction tokens. 

 0,5% Max TX | 3% Max Wallet | 10% Total Tax : 2% Liq 5% Marketing 3% Buyback
...
contract BATTLES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Battles of the World";
    string private _symbol = "BOTW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85334a57076A675022B2d98117676CF3389840dB); 
    address payable public buyBackWalletAddress = payable(0x85334a57076A675022B2d98117676CF3389840dB); 
