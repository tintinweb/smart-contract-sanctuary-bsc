...
contract GGZ is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        // _usdt = 0x7d002bd0BaB2F031C613E95CeA1d07B0d7C6bF15; //susdt
        // _fist = 0x8a9424745056Eb399FD19a0EC26A14316684e274; //dai
        // _main = 0xDeb6BBc6a8850608C703cd2179937AE0E022c47d; //test-2

        _dead = 0x0000000000000000000000000000000000000000;
        _fund = 0x48e4275eD3f56b6BEDc1b685a7aFaE91169E98cC;
        _referralfund = 0xBeED407a6aFDc1f83A86f0b2f89D0539eF38B076;
    ...
    function _transfer(
        ...
        if (_referrer1 == address(0)) {
            _balances[_referralfund] += up1Amount;
            emit Transfer(sender, _referralfund, up1Amount);
        }else{
        ...
        if (_referrer2 == address(0)) {
            _balances[_referralfund] += up2Amount;
            emit Transfer(sender, _referralfund, up2Amount);
        }else{
