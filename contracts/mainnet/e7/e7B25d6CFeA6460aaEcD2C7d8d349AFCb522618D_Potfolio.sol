...
contract Potfolio is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Potfolio", "PTF") {
        ...
        address _owner = 0x264e1d32777F52CC51633f3dDEb6ac662b2372B9;

        _decimals = 9;

        uint256 totalSupply = 1 * 1e15 * (10**_decimals);
        
        maxTransactionAmount = totalSupply * 2 / 100; // 2% maxTransactionAmountTx
    	...
    	maintenanceWallet = address(0x02DaC1829BdCD8C62B0cDC82bCDF2c46cA96C2aD); // set as maintenance wallet
