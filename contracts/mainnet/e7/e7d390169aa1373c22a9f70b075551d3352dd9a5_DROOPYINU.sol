...
/* Token contract */
contract DROOPYINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5964B85FA7F416750c2bF7b57F99d73634F58cfd;
    ...
    // Name and symbol
    string constant _name = "Droopy Inu";
    string constant _symbol = "Droopy";
    ...
    // Sell fees
    uint256 liquidityFeeSell = 5400;
    uint256 buybackFeeSell = 0;
    uint256 reflectionFeeSell = 100;
    uint256 marketingFeeSell = 4000;
