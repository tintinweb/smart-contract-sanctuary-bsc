...
contract FUKU is ExcludedFromFeeList, BlackList, LiquidityFee {
    uint256 private constant _totalSupply = 800000000000000 * 1e9;
    uint256 public launchedAt;
    uint256 public launchedAtTimestamp;

    constructor()
        ERC20("Fuku", "FUKU", 9)
        LiquidityFee(3, _totalSupply / 100000, true)
    {
