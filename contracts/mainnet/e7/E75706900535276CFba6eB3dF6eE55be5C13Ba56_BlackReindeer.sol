...
contract BlackReindeer is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Reindeer";
    string private constant _symbol = "BRD";
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =  1000000000  * 10**_decimals;

    uint256 public _maxWalletAmount = _tTotal / 50;
    uint256 public _maxTxAmount = _tTotal / 50;
    uint256 public swapTokenAtAmount = 3300000 * 10**_decimals;
    ...
    function takeBuyFees(uint256 amount, address from) private returns (uint256) {
        ...
        swapTokenAtAmount = (_tTotal / 300) - (feeDistribution.vaultToken / 300);
