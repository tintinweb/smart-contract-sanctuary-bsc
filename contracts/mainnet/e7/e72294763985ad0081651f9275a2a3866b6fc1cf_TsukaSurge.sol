...
/**
 * TSUKASURGE
 * Taxes: 6% (4% Manual Buyback, 2% Treasury for events)
 * Max Wallet: 1% (1 000 000 $TsukaSurge) for first 10 mins
 * Telegram: https://t.me/TSUKASURGE
 */
...
contract TsukaSurge is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Tsuka Surge";
    string private constant _symbol = "$TSURGE";
    ...
    //Tax wallets
    address public teamWallet = 0xDD4F25642f00eCaF4A852f7b2Ee3d352c82863a1;
    address public treasuryWallet = 0xDD4F25642f00eCaF4A852f7b2Ee3d352c82863a1;
    address public buybackWallet = 0xb897f94a7c4f2ccB5C15d3C19B114301c411D456;
    ...
    uint256 public buybackShare = 67;
