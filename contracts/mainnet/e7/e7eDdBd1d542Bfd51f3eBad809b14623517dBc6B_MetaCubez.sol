...
contract MetaCubez is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 200 * 10**6 * 10**4;
    ...
    uint256 public _maxTxAmount = 2 * 10**5 * 10**4;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**4 * 10**4;
