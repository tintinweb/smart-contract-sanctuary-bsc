...
contract AToken is Context, IERC20, Ownable {
    ...
    string private _name = "A Token";
    string private _symbol = "$A";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x276C28b0e9F24817D27b7051822B0C09705C1F4D); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x276C28b0e9F24817D27b7051822B0C09705C1F4D); // Development Address
