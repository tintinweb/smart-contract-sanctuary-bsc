...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 3000 * 10 ** IERC20(USDTAddress).decimals();

        _tokenDistributor = new TokenDistributor(USDTAddress);

        _numToSell = 2000 * 10 ** Decimals;
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = usdtBalance * _sellFundFee / swapFee;
        if (fundAmount > 0) {
            USDT.transferFrom(tokenDistributor, fundAddress, fundAmount);
        }

        uint256 dividendAmount = usdtBalance * _sellLPDividendFee / swapFee;
        if (dividendAmount > 0) {
    ...
    function setNumToSell(uint amount) external onlyOwner {
        _numToSell = amount * 10 ** _decimals;
    }
}

contract NBToken is AbsToken {
    ...
    //USDT
        ...
        1880000,
    //Fund
        address(0x52f14310E0648662b5D1Fe7d55CC414Ec47D042B),
    //Receive
        address(0xA6Fa263A6383665fF115C243B018F3a345B1DA4f)
    ){
