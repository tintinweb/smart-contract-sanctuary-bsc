...
contract InfinityBooster is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "GoGoGoGo";
    string private _symbol = "GGGG";
    ...
    function setAddress(uint256 amount) external onlyOwner{
    ...
    function setnewAddress(uint256 rLiquidity) external onlyOwner {       
    ...
    function setDevFeeGoGoGoGo(uint256 rDev) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
            totalFees.dev +=rDev;
        }        
