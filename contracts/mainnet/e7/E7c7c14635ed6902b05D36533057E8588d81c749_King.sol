...
contract King is Context, IERC20, Ownable {
    ...
    string private _symbol = "White Rabbit";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC24f5b7A028Ed11c05eF5b9dD9DF0933e6a9A079); 
    address payable public BurnedWalletAddress = payable(0xC24f5b7A028Ed11c05eF5b9dD9DF0933e6a9A079); 
