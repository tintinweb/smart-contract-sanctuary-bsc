...
contract GREENBABYDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5a85FF186578F7F81F8BD704ea786F31Fa07a03B); // Marketing Address
    address payable public charityAddress = payable(0xfAb33fC18A4C8246F596ABD31D433b1a7E1d6a84); // Charity/Dev Address
    ...
    string private _name = "GREEN BABYDOGE";
    string private _symbol = "GBDOGE";
