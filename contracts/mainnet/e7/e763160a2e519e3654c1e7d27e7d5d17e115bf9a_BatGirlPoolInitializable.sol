...
// File: contracts/BatGirlPoolInitializable.sol

pragma solidity 0.6.12;

contract BatGirlPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public BatGirl_POOL_FACTORY;
    ...
    constructor() public {
        BatGirl_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == BatGirl_POOL_FACTORY, "Not factory");
