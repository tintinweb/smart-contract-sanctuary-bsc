...
abstract contract Ownable is Context {
 ...
 contract JuttoNft is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public Token;
  IBEP20 public BUSD;
  ...
  uint256 public MinitngPricein_bnb=70;    // BUSD 
 ...
 /////////////////whitelist prices///////////////////////////// 
  ...
  function mint_with_token(uint256 _count ,uint256 amount) public payable
     {
        ...
        uint256 token  = ValueinToken;
         ...
         uint256 totalamountinbnb = bnb*_count;
      ...
      else
      {
        ...
        require(msg.value>=totalamountinbnb,"please enter token2");
...
// Jutto token 0xd3C93C8de541a3dABeE4CBD2d2403dc3521F2dBF
// BUSD 0xe9e7cea3dedca5984780bafc599bd69add087d56
// BNBtoBUSDLP 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16
// JuttotoBNBLP 0x1ac14DF0582DE473325A25C92F01E57a4805ea1a
