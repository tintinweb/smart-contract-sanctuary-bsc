...
contract PriceFetcher is Ownable {
    ...
    function getTokenPriceInUSD(address pairAddress) public view returns(uint){
        ...
        IPancakeswapV2Pair pairBNBInUSD = IPancakeswapV2Pair(0x1B96B92314C44b159149f7E0303511fB2Fc4774f);
