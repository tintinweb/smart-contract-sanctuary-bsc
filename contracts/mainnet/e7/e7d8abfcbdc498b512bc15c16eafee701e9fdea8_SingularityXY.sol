...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE31eF125315581066e8246dA79e547B698827D06; // owner address
...
contract SingularityXY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SingularityXY";
    string private _symbol = "SXY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE31eF125315581066e8246dA79e547B698827D06); // Marketing Address
    address payable public teamWalletAddress = payable(0xE31eF125315581066e8246dA79e547B698827D06); // Team Address
