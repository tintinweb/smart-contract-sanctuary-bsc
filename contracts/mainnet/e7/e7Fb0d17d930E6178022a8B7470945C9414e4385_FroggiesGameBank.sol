...
contract FroggiesGameBank is Ownable, Pausable {
    ...
    function withdrawFroggies(uint256 _amount) external {
        ...
        uint256 multiplier = 1000000000;
        uint256 newAmount = _amount * multiplier;
        froggies.transfer(msg.sender, newAmount);
    ...
    function fundAddress(address box, uint256 amount) public payable whenNotPaused {
        require(msg.sender == 0x69136eB598F0eF7BEBBf4F84669E82eC23AFe036);
