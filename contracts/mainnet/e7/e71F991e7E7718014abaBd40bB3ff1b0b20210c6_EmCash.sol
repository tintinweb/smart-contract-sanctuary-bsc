...
contract EmCash is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private symbol_ = "EMC" ;
 
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public _rewardsWalletAddress = 0x0faFC055A4412497eE46e18a2028862d47b60dD0;    //奖励地址
    address public _marketingWalletAddress = 0x65A49013a12a6123eB0335aBc0ef97E30f38Abd5;  //基金地址
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[from]){
                require(swapBuyEnabled, 'no swap for buy');
