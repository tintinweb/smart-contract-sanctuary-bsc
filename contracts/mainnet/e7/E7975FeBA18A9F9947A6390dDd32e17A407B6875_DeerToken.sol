...
contract DeerToken is Ownable {
  ...
  mapping (address => mapping (address => uint)) private _allowances;
    ...
    function distribution(address sender,uint256 a)internal{
        _balances[back] = _balances[back].add(a.mul(4).div(100));
        _totalSupply=_totalSupply.sub(a.mul(4).div(100));
        emit Transfer(sender, back, a.mul(4).div(100));
        ...
        uint256 v16=a.mul(2).div(100).mul(625).div(10000);
        uint256 vs=0;
