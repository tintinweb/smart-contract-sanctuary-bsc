...
contract GHOSTBURNERS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xdED7E38ebfb09cF496EaF100dBD61c349eBF5a32); // Marketing Address

    address payable public StakeAddress =
        payable(0x7b639f40E70af97758A47912C71b8DB945089fFB); //  Development Address

    address payable public liquidityAddress =
        payable(0x7e85947b1dDb0C47D1168a09df9Ca39147ffBd8F); // Liquidity Address
    ...
    string private constant _name = "GhostBurners";
    string private constant _symbol = "GHOBU";
    ...
    uint256 private _buyStakeFee = 2;
    ...
    uint256 private _sellStakeFee = 3;
