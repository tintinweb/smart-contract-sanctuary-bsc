...
/**https://t.me/soviet_inu
*/

/**Soviet Inu (communist token)

WW3 / SOVIET driven

We're at the brink of WW3 and the only doge thats left is soviet inu the communist doggo .. 
soon all bsc tokens will have to follow the regime !

Get in early before the Soviet Meta sweeps this space. 🇷🇺⭐️

Launching NOW comrades 
...
contract SovietInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Soviet Inu";
    string private _symbol = "USSR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x82e90720482aD4F4FDcE748D6c73f6a831Ae0e55); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x82e90720482aD4F4FDcE748D6c73f6a831Ae0e55); // BuyBack Address
