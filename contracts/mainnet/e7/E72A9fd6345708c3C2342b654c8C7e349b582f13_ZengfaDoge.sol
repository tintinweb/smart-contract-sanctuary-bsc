...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x629719D6b11be0aF55dDD2FA5Fe9f11541F8FB3A));
        marketingWalletAddress = payable(address(0x629719D6b11be0aF55dDD2FA5Fe9f11541F8FB3A));
