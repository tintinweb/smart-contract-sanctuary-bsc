...
/**   // SPDX-License-Identifier: MIT
       ...
       Telegram Group : https://t.me/meandmodels
       Website :  https://MeAndModels
...
contract MEANDMODELS is Context, IERC20, Ownable {
    ...
    string private _name = "Me And Models";
    string private _symbol = "MAMDL";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;

    address payable private marketing =
        payable(0x3af170bca99fa740EB3D47De119b7c8f3b5ECc80);
