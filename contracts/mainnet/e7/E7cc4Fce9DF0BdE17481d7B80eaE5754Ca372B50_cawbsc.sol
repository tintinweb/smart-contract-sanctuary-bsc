...
contract cawbsc is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666666666666666 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 666666666666666 * 10**_decimals;
    
    uint256 public maxSellAmount = 666666666666666 * 10**_decimals;
    uint256 public maxBuyAmount = 666666666666666 * 10**_decimals;
    uint256 public maxWalletBalance = 666666666666666 * 10**_decimals;

    address public marketingAddress = 0xD92FB0D1E8FCb600fCE2F1dA3dd850F298be5Fc9;
    address public devAddress = 0xD92FB0D1E8FCb600fCE2F1dA3dd850F298be5Fc9;
    ...
    Taxes public taxes = Taxes(0,0,0,9);
    Taxes public sellTaxes = Taxes(0,0,0,14);
