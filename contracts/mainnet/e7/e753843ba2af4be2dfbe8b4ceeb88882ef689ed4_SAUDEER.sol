...
Telegram
https://t.me/saudeerbsc

$SAUDEER is a double reward token of Saudi Muu & MUU INU. A passive earning of $SM and $MINU just by holding.
Taxes: Buy/Sell 10%
2% Automatic Liquidity
2% Passive Income/Reflections
6% Marketing
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x4d81fBb77a9d94b0e66617dBAEe16cF3Bd540E23); //the reward token you want distributed 
...
contract SAUDEER is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x4d81fBb77a9d94b0e66617dBAEe16cF3Bd540E23; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0xA010d35c5357BFD64d9E4190817d1A939282862D;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Saudi Deer";
    string constant _symbol = "SAUDEER";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 2500; // will start swapping once 0.05% of supply is in the swap wallet
    bool inSwap;
