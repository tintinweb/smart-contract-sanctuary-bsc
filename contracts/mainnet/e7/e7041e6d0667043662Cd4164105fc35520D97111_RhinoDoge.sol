...
/**
RHINO DOGE IS LAUNCHING FOR THE BSC BY THE BSC COME AND GET IN TO THE NEXT COMMUNITY MOONSHOT
LOW TAX ALL TO LP NO MARKETING AS I WANT TO MAKE THIS JUST LIKE DOGE LETS BUILD AN ARMY!
...
contract RhinoDoge is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Rhino Doge';
    string private constant _symbol = 'RHOGE';
    ...
    bool swapping; 
    bool botOn = true;
    uint256 swapThreshold = ( _totalSupply * 260 ) / 100000;
