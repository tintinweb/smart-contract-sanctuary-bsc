...
contract DollarOrdinal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Dollar Ordinal";
    string private _symbol = unicode"Dollaro";
