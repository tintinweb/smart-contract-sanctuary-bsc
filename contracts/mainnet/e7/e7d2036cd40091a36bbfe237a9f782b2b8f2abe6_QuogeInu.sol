...
contract QuogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QuogeInu";
    string private _symbol = "Q";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25BbF955eD57C62025158b64B8685af50B24187B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe318661A2cc4C6eB8D3fDbA97984fc30C9B57436); // BuyBack Address
