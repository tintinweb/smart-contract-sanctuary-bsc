...
contract bnbhu4tinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB Hu4t Inu"; // 
    string private constant _symbol = "$BHinu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x8736f8E4A8e6431acb5498d9Faf0783f849AC435;
