...
/**
 Token created after the news that Mbappe is staying at PSG and not signing for Real Madrid. 
 Self-driving token. You can expect renounce and liquidity lock for a week. 
 If the token grows enough the lock will be extended.
*/
...
contract MbappeStays is IBEP20, Auth {
    ...
    string constant _name = "MbappeStays";
    string constant _symbol = "MBPS";
    uint8 constant _decimals = 18;


    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 120; 
    ...
    address private marketingFeeReceiver = 0x265EC9326BDAc1C237AFf7f48950263a6319084A;
    address private buybackFeeReceiver = 0x265EC9326BDAc1C237AFf7f48950263a6319084A;
