...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61De46E932f9F28B51cA032CeaFd914b45583b04; // owner address
...
contract TWITTERDOWN is Context, IERC20, Ownable {
    ...
    string private _name = "TWITTER DOWN";
    string private _symbol = "TDOWN";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xAdD1d3562e4DA0c17f841E31Ce80cCF2D152c614); 
    address payable public teamWalletAddress = payable(0xAdD1d3562e4DA0c17f841E31Ce80cCF2D152c614);
