...
// CHANGE
contract UncleCowInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Uncle Cow Inu";
    string constant _symbol = "UCI";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xD734E4854aD294705fa10eFf8f28ee1216a27D9c);
    ...
    function setFees(uint256 _liquidityFee, uint256 _DevelopmentFee, uint256 _ReflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
