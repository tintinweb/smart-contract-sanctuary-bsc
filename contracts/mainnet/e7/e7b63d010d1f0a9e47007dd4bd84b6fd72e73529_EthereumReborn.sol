...
contract EthereumReborn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ethereum Reborn";
    string constant _symbol = "ETHREBORN";
    ...
    uint256 public totalFee = marketingFee + buybackFee + liquidityFee + reflectionFee;
