...
contract TWITTER is IBEP20, Ownable {
    ...
    string private _name = "Twitter on Twitter";
    ...
    TierTaxes public _sellTaxes = TierTaxes({first: 10, second: 10, third: 10});
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0x0a9eA754176CFF4f31e26ba46d5df0D7A981DbbE,
            events: 0x0a9eA754176CFF4f31e26ba46d5df0D7A981DbbE,
            marketing: 0x0a9eA754176CFF4f31e26ba46d5df0D7A981DbbE
        });
