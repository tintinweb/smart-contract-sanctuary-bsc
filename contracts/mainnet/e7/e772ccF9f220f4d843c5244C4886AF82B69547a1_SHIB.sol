...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _manualBurn(address account, uint256 amount) internal virtual {
...
contract SHIB is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1;
    address public devWallet = 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1;
    address public utilityWallet = 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1;
    address public charityWallet = 0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1;
    ...
    constructor(address routerAdd) ERC20("SHIBA INU", "SHIB") {
        ...
        exemptFee[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; // add addresses here devWallet+utilityWallet etc.
        exemptFee[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; //
        exemptFee[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; //
        ...
        allowedTransfer[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; // add addresses here devWallet+utilityWallet etc.
        allowedTransfer[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; // add addresses here devWallet+utilityWallet etc.
        allowedTransfer[0x1fFdD1d7B31Ae4c09529f8b83A3B7f656AdCbEA1] = true; // add addresses here devWallet+utilityWallet etc.
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 utilityAmt = unitBalance * 2 * swapTaxes.utility;
            if (utilityAmt > 0) {
