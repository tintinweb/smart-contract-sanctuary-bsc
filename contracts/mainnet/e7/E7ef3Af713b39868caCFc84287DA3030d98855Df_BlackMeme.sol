...
contract BlackMeme is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x3221bd0bcC5f8A221610DA740F7C392e8eb0bB4F);
    ...
    string private constant _name = "Black Meme"; 
    string private constant _symbol = unicode"BMEME"; 
    ...
    uint256 public _maxWalletToken = 100e4 * (10 ** _decimals);
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = 100e4 * (10 ** _decimals); 
