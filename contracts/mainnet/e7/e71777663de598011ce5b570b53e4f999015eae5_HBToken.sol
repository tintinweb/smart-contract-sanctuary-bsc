...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && amount > 0) {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_txLimitAmount > 0) {
                if (_swapPairList[sender]) {
                    require(_txLimitAmount >= tAmount - feeAmount, "buyLimit");
                } else {
                    require(_txLimitAmount >= tAmount, "sellLimit");
                }
            }
        }
        _takeTransfer(sender, recipient, tAmount - feeAmount);
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 fundUSDT = usdtBalance * fundFee / txFee;
    ...
    function processLP(uint256 gas) private {
        ...
        IERC20 usdtPair = _usdtPair;
        uint totalPair = usdtPair.totalSupply();
        if (0 == totalPair) {
            return;
        }
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            pairBalance = usdtPair.balanceOf(shareHolder);
...
contract HBToken is AbsToken {
    ...
    //USDT
        ...
        5555,
    //Fund
        address(0x5B022d6716aF42BdBb82D4c881331324Aa2F05aD),
    //Received
        address(0x6Af9DeCE966d67431d60b228790880ECF82ffD4E)
    ){
