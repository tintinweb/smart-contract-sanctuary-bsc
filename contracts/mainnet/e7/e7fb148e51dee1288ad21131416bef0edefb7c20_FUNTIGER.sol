...
contract Ownable is Context {
    ...
    address private _marketingAddress = 0x9B19946BFD565F8d5Ff54C9CB5EeF0289d490B2E;
...
contract FUNTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUNTIGER";
    string private _symbol = "FunTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B19946BFD565F8d5Ff54C9CB5EeF0289d490B2E); // Marketing Address
    address payable public teamWalletAddress = payable(0x3dc782e97Db55A81b280216D1E9fA242218E3628); // Team Address
