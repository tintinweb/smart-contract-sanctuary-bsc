...
contract ShibaBoss is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Boss";
    string private constant _symbol = "SBOSS";
    ...
    constructor (address payable _marketingWallet) {
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), BUSD_ADDRESS);
