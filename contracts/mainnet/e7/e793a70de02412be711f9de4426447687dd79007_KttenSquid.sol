...
Telegram : https://t.me/SatoshiCoinBsc
Website : hhttp://www.satoshicoin.space
*/
...
contract KttenSquid is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 1e18; // 1.000.000.000
    ...
    uint256 public maxBuyAmount = (_tTotal / 1000) * 15; // 1,5% of Supply
    uint256 public maxSellAmount = (_tTotal / 1000) * 3; // 0,3% of Supply
    uint256 public maxWallet = (_tTotal / 1000) * 30; // 1,5% of Supply
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xC5Be5dACaD4c9BC3392125C5601eba3CE680896E); // Marketing Address
                
        liquidityAddress = payable(0xC5Be5dACaD4c9BC3392125C5601eba3CE680896E); // Liquidity 100% Burn
