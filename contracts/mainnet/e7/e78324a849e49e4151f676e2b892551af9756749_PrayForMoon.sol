...
// File: contracts/prayformoon.sol
...
contract PrayForMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "PRAY FOR MOON"; // 
    string private constant _symbol = "$PFM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x8230Dbc1E4B3F67e2CfebF193236F6909DAF9c8d);
