...
contract OlympicCheemsInu is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Olympic Cheems";
   string constant _symbol = "OCI";
...
uint256 reflectionFee = 100;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x5AcdD5F8aa119877d19c98720eFa64CafAeF9037;
