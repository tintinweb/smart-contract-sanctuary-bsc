...
Telegram : https://t.me/Worldfinance                                                                                      
...
contract WORLDFINANCE is Context, IERC20, Ownable {
    ...
    string private constant _name = "WORLD FINANCE";
    string private constant _symbol = "WORLD";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 600000000000* 10**_decimals;
    uint256 public _maxTxAmount = 600000000000* 10**_decimals;
    uint256 public swapTokenAtAmount = 600000000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0xc3A89A04E0Ca0D6443F4Bf2a25Beebc72C6f0BdB);
    address private liquidityReceiver = address(0xab9DCB9042d76e7650E32A50B85f94535aD79029);
