...
/**
TELEGRAM: https://t.me/CronPortal
WEBSITES: https://medium.com/@cronofficial
TWITTER: https://twitter.com/CronOfficial
*/

/**
Cron is a Proof of Elapsed Time (PoET) consensus mechanism.
It is designed to provide a fair and efficient way to select the next 
leader to create the next block in the blockchain.

One of the main advantages of PoET is that it is designed
to be highly energy-efficient, as it does not require significant computational
resources to participate in the consensus process. 
This makes it well-suited for use in enterprise settings,
where there may be a large number of nodes on the network...
...
contract CRONBLOCKCHAIN is IBEP20, Ownable {
    ...
    address public marketingFeeReceiver = 0xAb3c2d119646007cEd3603DEb5E5aB388795ad46;
