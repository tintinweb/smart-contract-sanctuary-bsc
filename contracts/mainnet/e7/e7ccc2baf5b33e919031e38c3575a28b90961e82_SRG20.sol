 ...
 * TG : https://t.me/pikachurge
Pikachurge, the most complete cryptocurrency wallet on the market. 
With our multichain wallet, you can easily manage your cryptocurrencies, including Ethereum, Binance Smart Chain and SRG.

Pikachurge also offers you the ability to swap on ETH, BSC, and SRG, saving you time and increasing efficiency in your cryptocurrency exchanges. And that's not all! With our wallet, you have real-time visualization of all ETH, BSC, and SRG tokens you hold, as well as alerts for new tokens released on Surge.

In addition, our ranking of all SRG tokens by volume will keep you informed on the best investments of the moment. And we have many more features to come, offering you a complete and seamless cryptocurrency wallet experience.

To use the Pikachurge wallet, you will need to hold at least 1% of the total supply (this will change based on marketcap).

Advertisements in the app will be used to buy back and burn.

Join us today to discover the power of Pikachurge.
 */
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "PIKACHURGE";
    ...
    //Tax wallets
    address public teamWallet = 0x7A581F3f951B841865c869E0eAa52a49e8d4C631;
    address public treasuryWallet = 0x7dA9C31a6BBA797c267DE51363cAf3FF2f7A60b9;
