...
contract OneSplit is Initializable, IOneSplit, OneSplitRoot, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function swapMulti(
        ...
        returnAmount = _swapMultiInternal(tokens, amount, minReturn, distribution, flags, isWrapper, msg.sender);
    }
    ...
    function swapMultiWithRecipient(
        ...
        require(recipient != address(0), "Recipient Address cannot be null");
        returnAmount = _swapMultiInternal(tokens, amount, minReturn, distribution, flags, isWrapper, recipient);
    }
