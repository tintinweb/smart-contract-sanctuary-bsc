...
This AI Bot is under development by Elon & Tesla Inc. with plans to change how we live and work 
forever.

The verified contract will be renounced, and the liquidity will be locked shortly after deployment. 
Buy/Sell taxes will be elevated prior to the contract being renounced. 
The taxes will be lowered to 3/2 (2% Tax, 1% LP Burn) afterwards.  
Max wallet will be 1%.

✅ Ownership Renounced | Locked 

💎Bullish Name || BEP20 Hype
💰Strategical Buybacks
🕓 Lock Secure Pinksale
🕓 Renounced
$$$$$$$$$$$$$$$$$$$$
...
contract OPTIMUSINU is Context, ierc20, Ownable {
    ...
    string private _name = 'OPTIMUS INU';
    string private _symbol = 'OPTIMUSINU';
