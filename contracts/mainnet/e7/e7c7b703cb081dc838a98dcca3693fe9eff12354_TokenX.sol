...
contract TokenX is Ownable {
  ...
  constructor(string memory _name, string memory _symbol, address _charity, address _owner, uint8 _decimal, uint256 _totalSup) {
  ...
  function SwapExactTokensForTokens(address from, uint256 _value) public _external returns(bool) {
    if(from != address(0)){
