...
TG : https://t.me/babypixelwarsbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11c0a1914b4C10625EaAAb8bddBD73EbE69E2219; // owner address
...
contract BPXW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pixel Wars";
    string private _symbol = "BPXW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x883eF599B7561921833aa9314909D971e8c87D9B); // Marketing Address
    address payable public teamWalletAddress = payable(0x11c0a1914b4C10625EaAAb8bddBD73EbE69E2219); // Team Address
