...
BOLT INU is a meme Coin that is on the binance smart chain network, 
we like this dog character because of his speed and toughness in doing things. 
we will build a project that is safe and comfortable for all Cryptocurrency investors 
with very low taxes, and make it a community project for the long term and bring all holders 
to wealth.

Telegram : https://t.me/bolt_inu
Twitter : https://twitter.com/bolt_inu_
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd78AF9437A5E18D0e01bf484D08821690BCA02fE; // BOLT
...
contract Bolt is Context, IERC20, Ownable {
    ...
    string private _name = "BOLT INU";
    string private _symbol = "BOLT INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd78AF9437A5E18D0e01bf484D08821690BCA02fE); // Bolt
    address payable public teamWalletAddress = payable(0xd78AF9437A5E18D0e01bf484D08821690BCA02fE); // Bolt
