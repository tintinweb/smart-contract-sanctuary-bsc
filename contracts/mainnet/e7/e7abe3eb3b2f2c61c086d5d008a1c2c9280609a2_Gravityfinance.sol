...
//Telegram : https://t.me/GRAVITYFINANCEOFC

//website : http://gravityfinance.site/
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0xccA7Be847483578981a0e39Bb869153aFcA548d6;
...
/* Token contract */
contract Gravityfinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xccA7Be847483578981a0e39Bb869153aFcA548d6;
    ...
    // Name and symbol
    string constant _name = "GRAVITY FINANCE";
    string constant _symbol = "GRAFI";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 20B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 5% or 50B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xFD23C518B7b266dD10F04e945B8d43A16a1639d9;
