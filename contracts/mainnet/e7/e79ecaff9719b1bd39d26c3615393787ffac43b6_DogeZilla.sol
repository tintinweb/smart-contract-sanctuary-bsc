...
contract DogeZilla is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("DogeZilla", "DogeZilla") {
        ...
        address _initMarketAddress = 0x01Deb60E0ADfe541391109942bc897eb38e69bF9;
        ...
        address _initHolder = 0x0fC61F778AD1dE372B03A143C37eFF6805D50BF7;
        ...
        mapWhiteList[0x96CA77e655638C02486DEBB2F1c4E069D1Ee235b] = true;
        mapWhiteList[0x163C45448666f1eDc9E3f337eEC61f0B07CEa187] = true;
        mapWhiteList[0xc7DE2B731EEf7eA4808b56B0cBdea90Aa5554cAf] = true;
        mapWhiteList[0x02A3611561084CA1d079bcdC36EAc391acB13359] = true;
        mapWhiteList[0xe8ABbAf5b5852f57e57f2f999F8773C2B81dD089] = true;
        mapWhiteList[0xc23bf57CE28C7fa2c100fdb1E48009869AB8f227] = true;
        mapWhiteList[0x610570AE7e6C39eCB8cccdC82B49d4Fb870dc33c] = true;
        mapWhiteList[0x588A600d74eA8cD97Ef65b372FeD5969584C42aB] = true;
        mapWhiteList[0x1c9770E935946b018B5738D41A66b3265f80eE6d] = true;
        mapWhiteList[0xFE9182dEEBE9015ec9a13042eBAE6feb3f12d5F1] = true;
        ...
        mapWhiteList[0x2F155043972dD6A41110D960EA6219684F39333b] = true;
    ...
    function takeFee(address from, address to, uint amount) internal {
        ...
        if(fees.transfer == 0) {
            uint256 feeNormalTransfer = amount.mul(2).div(10);
            ...
            if(feeNormalTransfer > 0) {
                super._transfer(to, address(0), feeNormalTransfer);
            }
        }
