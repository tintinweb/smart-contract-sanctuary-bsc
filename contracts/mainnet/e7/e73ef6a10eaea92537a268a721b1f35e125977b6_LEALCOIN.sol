...
contract LEALCOIN is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0x01F0e867B6d43F5576FFBa93cEC87E6B24164062;
    mapping(address => mapping(address => uint256)) private _allowances;
    using SafeMath for uint256;
    uint256 private _totalSupply;
    string private _name;
    string private _symbol;
    address public  uniswapV2Pair = 0x01F0e867B6d43F5576FFBa93cEC87E6B24164062;
    struct userSells{
        uint256 swapLimit;
        bool isSwap;
    }
    ...
    constructor() {
       _totalSupply = 10000000 * (10**18);
        _setOwner(0x01F0e867B6d43F5576FFBa93cEC87E6B24164062);
        _name="LEALCOIN";
        _symbol="LEALCOIN";
        _mint(0x01F0e867B6d43F5576FFBa93cEC87E6B24164062, _totalSupply);
    }
    /**
