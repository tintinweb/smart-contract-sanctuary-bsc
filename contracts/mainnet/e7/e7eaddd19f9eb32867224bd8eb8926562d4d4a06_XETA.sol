...
/**
 * @dev Contract for XETA Token
 */
contract XETA is Pausable, Supervisable, Burnable, Freezable, Lockable, BEP20 {
    uint256 private constant _initialSupply = 5_000_000_000e18;

    constructor() BEP20("XETA", "XETA") {
    ...
    function addTimeLock(
        ...
        uint256 amount,
        uint256 expiresAt
    ) external onlyLocker whenNotPaused {
