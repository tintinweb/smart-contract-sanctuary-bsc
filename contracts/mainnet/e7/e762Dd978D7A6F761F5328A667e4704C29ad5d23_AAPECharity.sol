...
contract AAPECharity is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AAPE Charity";
    ...
    address lotteryWallet = 0xB4BB88269d9630a47988f940b988BdAA02b53CD5; 
    ...
    uint256 public extraLotteryOnSell = 2;
    uint256 public extraLiquidityOnSell = 3;
    ...
    constructor () Auth(msg.sender) public {
        ...
        totalFee = totalFee.add(lotteryFee);
        totalFee = totalFee.add(charityFee);
        totalFeeIfSelling = totalFee.add(extraLotteryOnSell);
        totalFeeIfSelling = totalFee.add(extraLiquidityOnSell);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        {
            charityAmount = amount.mul(charityFee).div(100);
        ...
        {
            lotteryAmount = amount.mul(lotteryFee).div(100);
