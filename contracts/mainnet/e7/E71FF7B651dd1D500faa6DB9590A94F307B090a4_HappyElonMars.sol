...
contract HappyElonMars is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Happy Elon Mars";
    string constant _symbol = "HMRS";
