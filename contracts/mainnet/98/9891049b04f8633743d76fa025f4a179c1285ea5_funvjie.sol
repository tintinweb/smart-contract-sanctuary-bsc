...
contract funvjie is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpacepiDoge";
    string private _symbol = "SpacepiDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe1f341453cAc9dD8831c1b807C101F7AbE924116);
    address payable public teamWalletAddress = payable(0xeFEa74f74355A920151102a3A5A58Bb833852D16);
