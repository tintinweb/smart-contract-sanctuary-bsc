...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6016E68E0A1E8df03Ca4baEC621231ed02403797;
...
contract OwgeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Owge Inu"; //
    string private constant _symbol = "OwgeInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x9DC7aD74e9b80449163f75F2025e2e7E9c48ee39);
