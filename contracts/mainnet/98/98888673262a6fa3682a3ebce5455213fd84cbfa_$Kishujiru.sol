...
// *Telegram : https://t.me/khisujiruinu
...
contract $Kishujiru is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xae86C73BB32e21B1131C3b8B7c6C806CD4Cb9A67));
    address payable public devWallet =
        payable(address(0xae86C73BB32e21B1131C3b8B7c6C806CD4Cb9A67));
    address public liquidityReceiver =
        0xae86C73BB32e21B1131C3b8B7c6C806CD4Cb9A67;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Kishujiru Inu";
    string private _symbol = "$Kishujiru";
    ...
    uint256 public _maxWalletSize = 125000000000 * 10**9;
