...
contract BabyTDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "BabyTDOGE";
    string private _symbol = "BabyTDOGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0eA9321F335aBd2Cae511308eC3cf5738a853f96); 
    address payable private teamWalletAddress = payable(0x3cC7Fe82335EFE1C0eCf1CADebE85019407CBf4c); 
