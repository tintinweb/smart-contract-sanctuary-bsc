...
contract DogeYears is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DogeYears";
    string private constant _symbol = unicode"DOGEYEARS";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x2a58c42Ae6A94A5754e48b4C8c95F38E281eBf23);
    address payable public MarketingWallet = payable(0x17C716B94d97a642F6E2cc955099097678B3DbE4);
