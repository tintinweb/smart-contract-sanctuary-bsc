...
contract YARIGAIJINRO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yarigai Jinro";
    string private _symbol = "JIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0fd4cC4164DaFBa053F110eCeF4034E3B00D75Bf); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0fd4cC4164DaFBa053F110eCeF4034E3B00D75Bf); // Treasury / Buyback
    ...
    function _status_checkFeestoDeadaddr() internal {
        if (block.number > zeroFeeBlocks + 130) {
