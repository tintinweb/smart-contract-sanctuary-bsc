...
contract BankLink is ReentrancyGuard, AccessControlEnumerable {
    ...
    constructor() {
        ...
        iAccount = IAccount(0x4398BFB88D28430aa55BcA7e1AFC81754Fc6fa03);
        iRandom = IRandom(0xe18EcA8C398e2f927e48753E10944d9438f8e283);
    ...
    function restart(uint256 depositIndex) external {
        ...
        require(block.timestamp > deposits[msg.sender][depositIndex].createTimestamp + restartWaitingTime * INTERVAL, "BankLink: this deposit not satisfy to restart.");
    ...
    uint256 public baseLmt = 2000e18;
    uint256 public offsetLmt = 1_0000e18;
