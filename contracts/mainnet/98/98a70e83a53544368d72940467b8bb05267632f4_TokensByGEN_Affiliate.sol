...
contract TokensByGEN_Affiliate { 
    ...
    string public constant TokensByGEN_Website = "https://tokensbygen.com/";
    string public constant Utility = "Holders of this token are official affiliates of TokensByGEN. They will earn up to 20% percentage of all contract generator fees.";
