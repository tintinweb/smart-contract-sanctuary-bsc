...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5c9235016B67C62402a752BFAc4892c580B74441;
...
contract DOGE3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGE 3.0"; // 
    string private constant _symbol = "DOGE3.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x5c9235016B67C62402a752BFAc4892c580B74441);
