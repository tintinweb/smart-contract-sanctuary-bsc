...
/*
    #SteamX - https://sabza.com
    https://sabza.com/tgds
    Total Fees: 10%
    2% fee is added to the Baby Cheems Inu developer wallet as BNB *Note the team will not be selling tokens*
    3% fee is added to the Baby Cheems Inu marketing wallet as BNB *Note the team will not be selling tokens*
    0% is reflected to holders
    5% is added to LP
    */
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract Sabza is Context, IERC20, Ownable {
    ...
    string private _name = "Sabza";
    string private _symbol = "SBZ";
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), " Sabza: cannot burn from zero address");
    require(_balances[account] >= amount, "Sabza: Cannot burn more than the account owns");
