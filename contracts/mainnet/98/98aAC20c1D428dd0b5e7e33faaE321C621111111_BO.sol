...
contract BO is ERC20, Ownable {
    ...
    constructor(
        ...
        address[4] memory addrs, // router,owner,markting,fund
    ...
    function _transfer(
        ...
        // 如果用户加流动性的时候 也是免手续费
        if (automatedMarketMakerPairs[to] && _isAddLiquidity()) {
            takeFee = false;
        }
