...
contract ShioUNI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ShioUNI";
    string private _symbol = "SUNI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x56C97D26Ea071De9147BFAfe629711e50E2a2Fbb);
    address payable public liqWalletAddress = payable(0x56C97D26Ea071De9147BFAfe629711e50E2a2Fbb);
    ...
    uint256 public _maxTxAmount =   264000 * 10**_decimals;
    uint256 public _walletMax =     352000 * 10**_decimals;
