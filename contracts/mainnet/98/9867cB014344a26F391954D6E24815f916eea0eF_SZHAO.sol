...
contract SZHAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpaceChangPumpZhaoge"; // 
    string private constant _symbol = "$SZHAO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x1E8cAa5726325Ae0913d7e7416060c7D58506809;
