...
library Address{
 ...
 contract WojakInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1e6 * 10**9;
    uint256 public maxSellLimit = 1e6 * 10**9;
    uint256 public maxWalletLimit = 1e6 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x8D17Bb54F3b627c575686bbAde9D459681a9c918;
    address public donationWallet = 0x8D17Bb54F3b627c575686bbAde9D459681a9c918;
