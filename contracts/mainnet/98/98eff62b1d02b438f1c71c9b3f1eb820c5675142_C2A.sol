...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x555c75F511141723FB9bB798F8D4bfd63A4f00A4;
...
contract C2A is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x335766c6e46e92808F02dcb754Ff77dC687Cf9C6); 
    address payable private Wallet_Token_Burn = payable(0x555c75F511141723FB9bB798F8D4bfd63A4f00A4); 
    address payable private Wallet_Dev = payable(0x555c75F511141723FB9bB798F8D4bfd63A4f00A4); 
    ...
    string private _name = "CUM2AI"; 
    string private _symbol = "C2A";  
