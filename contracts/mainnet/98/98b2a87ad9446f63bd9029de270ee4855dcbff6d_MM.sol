...
contract MM is ERC20, Ownable {
    ...
    constructor() payable ERC20("MM token", "$MM") {
        ...
        totalBuyFee         = liquidityFeeOnBuy + treasuryFeeOnBuy + rewardsFeeOnBuy + charityFeeOnBuy;
        ...
        totalSellFee        = liquidityFeeOnSell + treasuryFeeOnSell + rewardsFeeOnSell + charityFeeOnSell;

        treasuryWallet = 0x5E577ef2a48EF9C37778A04a21c1e06B80B6b7c9;
        charityWallet = 0x8aE4234ef29f3c2d9E1a988bcfA78686259eC3a4;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy, uint256 _charityFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 100, "Buy fee cannot be more than 10%");

        emit BuyFeesUpdated(totalBuyFee);
    }

    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell, uint256 _charityFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 100, "Sell fee cannot be more than 10%");
    ...
    function changeCharityyWallet(address _charityWallet) external onlyOwner {
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((charityFeeOnBuy + charityFeeOnSell) > 0) {
                    uint256 charityBNB = newBalance * (charityFeeOnBuy + charityFeeOnSell) / bnbShare;
