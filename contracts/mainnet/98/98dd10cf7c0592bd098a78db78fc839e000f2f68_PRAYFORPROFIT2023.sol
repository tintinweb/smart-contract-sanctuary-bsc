...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFCAAf46A4fa27862A10C1CC10c0F057ff616b6Fe;
...
contract PRAYFORPROFIT2023 is Context, IERC20, Ownable {
    ...
    string private constant _name = "PRAY FOR PROFIT 2023"; // 
    string private constant _symbol = "$PFP23"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xFCAAf46A4fa27862A10C1CC10c0F057ff616b6Fe);
