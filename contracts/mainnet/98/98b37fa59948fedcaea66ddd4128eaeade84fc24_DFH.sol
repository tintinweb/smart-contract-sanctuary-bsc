...
contract DFH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DFH";
    string private _symbol = "DFH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5fd7530d11e11FbA4b6690DFAbda7b5Fa37BD9e1); 
    address payable public teamWalletAddress = payable(0xc1e5c120d00AC109fE51dd06b5Dca38919B23F4b); 
