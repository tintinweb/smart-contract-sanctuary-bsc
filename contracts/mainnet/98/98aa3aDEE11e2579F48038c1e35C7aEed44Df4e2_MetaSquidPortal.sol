...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1eBc77690898d945E4923880928A57226778a39a; // owner address
...
contract MetaSquidPortal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaSquid";
    string private _symbol = "Msquid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x173f6F327b67cB2B8302c8Ef4c29CDa7f609348a); // Marketing Address
    address payable public teamWalletAddress = payable(0x1eBc77690898d945E4923880928A57226778a39a); // Team Address
