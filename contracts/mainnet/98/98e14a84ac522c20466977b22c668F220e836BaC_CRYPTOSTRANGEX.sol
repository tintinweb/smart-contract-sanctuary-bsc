...
/*
Telegram: https://t.me/CryptoStrangeOfficialX
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC7Fb6952bfc9b00B11990BdD262932b0300E75D4; // owner address
...
contract CRYPTOSTRANGEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CRYPTO STRANGE";
    string private _symbol = "StrangeX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC7Fb6952bfc9b00B11990BdD262932b0300E75D4); // Marketing Address
    address payable public teamWalletAddress = payable(0xC7Fb6952bfc9b00B11990BdD262932b0300E75D4); // Use Same Address as Marketing Address
    ...
    uint256 public _maxTxAmount = 99_000_000 * 10**_decimals; 
    uint256 public _walletMax = 99_000_000 * 10**_decimals;
