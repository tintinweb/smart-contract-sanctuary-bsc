...
contract WDEO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WDEO DAO";
    string private _symbol = "WDEO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress =
        payable(0x97e7deA9D660F596A74cD07237cCABE7ADd5bcBF); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x97e7deA9D660F596A74cD07237cCABE7ADd5bcBF); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x27a9020a8CBD4E2952B156b747E861246709E967;
    ...
    uint256 public _liquidityShare = 3; // original 3
    uint256 public _marketingShare = 1;
    uint256 public _teamShare = 1; // original 3

    uint256 public _totalTaxIfBuying = 5; // original 3
    uint256 public _totalTaxIfSelling = 5; // original 3
    uint256 public _totalDistributionShares = 5; // original 3
