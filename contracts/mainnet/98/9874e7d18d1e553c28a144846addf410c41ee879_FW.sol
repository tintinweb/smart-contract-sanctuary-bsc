...
contract FW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fuck Whitelist";
    string private _symbol = "Fuck Whitelist";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x785D98922410db5c634Ed822f5e43B04E99605bE); // Marketing Address
    address payable private teamWalletAddress = payable(0x785D98922410db5c634Ed822f5e43B04E99605bE); // Team Address
