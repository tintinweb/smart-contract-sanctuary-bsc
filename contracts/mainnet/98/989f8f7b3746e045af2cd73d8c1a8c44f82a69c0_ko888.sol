...
contract ko888 is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name="ko888";
    string public _symbol="ko888";
    ...
    uint256 public _totalSupply=100000000000000000000000000000000000000000;
