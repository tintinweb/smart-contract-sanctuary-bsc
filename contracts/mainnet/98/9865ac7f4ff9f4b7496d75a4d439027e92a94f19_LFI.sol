...
contract LFI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x51a48221df1D71249727C9f1a3A907277641BeAA);
    address payable public buyBackWalletAddress = payable(0x51a48221df1D71249727C9f1a3A907277641BeAA);
