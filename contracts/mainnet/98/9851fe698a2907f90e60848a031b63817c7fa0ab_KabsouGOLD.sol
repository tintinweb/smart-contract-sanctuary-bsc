...
Telegram t.me/KabosuGOLD
Kabosu GOLD is here, ready to outperform, ready to go 100m+ 
...
contract KabsouGOLD is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x48dE4CAdA776e5E4cd717bdfbe1b0576b93b89f2;

    string constant _name = "Kabosu GOLD";
    string constant _symbol = "KabosuGOLD";
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/3, "Fees cannot be more than 45%");
    }
