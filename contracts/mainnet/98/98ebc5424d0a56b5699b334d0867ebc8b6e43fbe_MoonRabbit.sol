...
// Yutu is a magic rabbit who lives on the moon.
...
contract MoonRabbit is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name     = "The Moon Rabbit of Immortality";
    string private constant _symbol   = "YUTU";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 10000 / 10000; // 2% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xD0E1C7f79eC9152A284930A2073642d3d7A63eFf;
        _marketingWallet = 0x8062c6dDE87c97988fa511A12C42f82176A5c758;
