...
| $$  | $$| $$       /$$__  $$| $$  | $$        \  $$$/  | $$| $$_  $$ | $$| $$  | $$| $$  | $$ \____  $$
|  $$$$$$$| $$$$$$$$|  $$$$$$$| $$$$$$$/         \  $/   | $$| $$ \  $$| $$| $$  | $$|  $$$$$$$ /$$$$$$$/
 \_______/|________/ \_______/|_______/           \_/    |__/|__/  \__/|__/|__/  |__/ \____  $$|_______/ 
                                                                                      /$$  \ $$          
                                        PRESENTS                                     |  $$$$$$/          
                                                                                      \______/           
      ▄• ▄▌▄▄▄      ·▄▄▄▄  ▄▄▄ . ▌ ▐·    ▪  .▄▄ ·     ·▄▄▄▄  ▄▄▄ . ▄▄▄· ·▄▄▄▄  
...
0% Tax
LP Locked
Renounced to the dEaD wallet
https://t.me/OurDevIsdEaD
*/
...
contract ODID is BEP20, Ownable {
    ...
    constructor() BEP20("Our Dev Is dEaD", "ODID") {
    ...
    function _transfer(
        ...
        if (earlyTradingEnabled && sender == pair && whitelist[recipient]) {
            require(amount <= maxBuyLimit, "You are exceeding maxBuyLimit");
            require(balanceOf(recipient) + amount <= maxWalletLimit, "You are exceeding maxWalletLimit");
        }

        if (earlyTradingEnabled && sender != pair && whitelist[recipient] && whitelist[sender]) {
        ...
        if (sender != pair && !whitelist[recipient] && !whitelist[sender]) {
            require(amount <= maxSellLimit, "You are exceeding maxSellLimit");
            if (recipient != pair) {
                require(balanceOf(recipient) + amount <= maxWalletLimit, "You are exceeding maxWalletLimit");
            }
    ...
    function EnableTrading() external onlyOwner {
        ...
        maxBuyLimit = 10_000_000 * 10**18;
        maxSellLimit = 2_500_000 * 10**18;
        maxWalletLimit = 10_000_000 * 10**18;
        tradingEnabled = true;
    }

    function EnableEarlyTrading() external onlyOwner {
        require(!earlyTradingEnabled, "Cannot re-enable early trading");
        maxBuyLimit = 2_000_000 * 10**18;
        maxSellLimit = 1_000_000 * 10**18;
        maxWalletLimit = 5_000_000 * 10**18;
        earlyTradingEnabled = true;
    }

    function DisableEarlyTrading() external onlyOwner {
        require(earlyTradingEnabled, "No its alreay enabled");
        earlyTradingEnabled = false;
    }
