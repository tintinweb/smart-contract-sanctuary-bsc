...
contract SpacepiCat is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("SpacepiCat", "SpacepiCat") {
        _marketingWalletAddress1 = 0xF5EB4BcBa82c54633Fd23cc94De3a5B35AdE42aa;
        _marketingWalletAddress2 = 0x5ea622188728466fB31C36771EE8777BC1481566;
        _marketingWalletAddress3 = 0x61056bCA7a880399c1ec5062B950F156dA82a738;

        tokenRewardsFee = 4;
        liquidityFee = 4;
        marketingFee = 4;
        uint256 totalsupply_=10000000*10**8*10**18;
        ...
        excludeFromFees(0x2FBa428106A2EA045687524d249E302B22217332, true);
        excludeFromFees(0x90ae89D0a8186D7aB303385a59e3Ac2aD3D0e4a3, true);
        excludeFromFees(0xab2A6DF88e993AfB25B145A5BD5B09962c054278, true);
        excludeFromFees(0xeB9c322350d8A9dB7b5590F3405bF797639cEac1, true);
        excludeFromFees(0x1723d3D5237e3F2527AcB7D22df616B5f3E6ad11, true);
        excludeFromFees(0x7d172A9619cE01c29771bbaba6597a2f9a51B903, true);
        /*
    ...
    function blacklistAddress(address[] memory accounts) public onlyOwner(){
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        address(_marketingWalletAddress1).call{ value: newBalance.div(3) }("");
        address(_marketingWalletAddress2).call{ value: newBalance.div(3) }("");
        address(_marketingWalletAddress3).call{ value: newBalance.div(3)}("");
    }
