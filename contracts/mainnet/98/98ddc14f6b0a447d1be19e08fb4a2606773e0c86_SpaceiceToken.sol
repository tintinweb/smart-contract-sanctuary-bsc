...
contract SpaceiceToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Space Ice";
    string constant _symbol = "Space Ice";
    ...
    uint256 _totalSupply = 1 * 15000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply/10000 ;
    uint256 public _walletMax = _totalSupply/10000 ;
