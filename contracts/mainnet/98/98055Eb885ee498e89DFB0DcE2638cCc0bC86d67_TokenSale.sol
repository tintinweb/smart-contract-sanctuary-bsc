...
contract TokenSale {
    ...
    uint256 private PRIVATE_SALE_TIME_TO_WAIT = 31; // 30 days + 1 because contract deployed 1 day in advance
    ...
    mapping(address => uint256) private releasePercentage;
    ...
    function buyPrivateSaleTokens() external payable {
        ...
        releasePercentage[msg.sender] = PRIVATE_RELEASE_PERCENTAGE;
    ...
    function transferTokens(
        ...
        releasePercentage[_user] = _releasePercentage;
    ...
    function releaseTokens() external {
        ...
        uint256 releaseAmount = balances[msg.sender]
            .mul(releasePercentage[msg.sender])
            .div(100);
