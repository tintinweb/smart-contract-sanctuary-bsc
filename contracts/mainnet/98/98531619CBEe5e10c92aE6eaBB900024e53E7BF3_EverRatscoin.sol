...
Stealth Launch EverRatscoin
Low Mcap
Safe Token
Lp Lock and Renounched
Buy and Hold get earn x1000
Telegram Chat: https://t.me/EverRatscoin
...
contract EverRatscoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ever RatsCoin"; //
    string private constant _symbol = "$ERATS "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0xc617099F4bBAE2C37b5b030eC96acaDd85C9058F ;
