...
contract MetaverseBoredApe is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Metaverse Bored Ape';
    string private _symbol = 'MBA';
