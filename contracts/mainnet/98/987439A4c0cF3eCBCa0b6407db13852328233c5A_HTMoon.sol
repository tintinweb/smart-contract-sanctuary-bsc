...
contract HTMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x324bdeCFDc9CA82Ccb2cD494b7A4ebf2eb17Bae9); // Marketing Address
    address payable public teamWalletAddress = payable(0x7e53cB76f3C4c077694CDf5E99C95dB39775C687); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000000000 * 5 **_decimals; 
