...
// Telegram : https://t.me/SantaCocacola
// Twitter  : https://twitter.com/SantaCoca_Cola
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd6B2dE38B6A5851Ee2B0B08362a02c97C00F7E7a; // SantaCocaCola
...
contract Santacocacola is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Coca Cola";
    string private _symbol = "SantaCola";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6e0C2223E083CfB7d1bE4aB7445516E8D2d1A60a
); // Marketing Address
