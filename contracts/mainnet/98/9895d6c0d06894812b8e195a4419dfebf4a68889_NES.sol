...
contract NES is Context, IERC20, Ownable {
    ...
    string private constant _name = "NES";
    string private constant _symbol = "NES";

    address public _PancakeSwapV1RouterUniswap = 0x7A311F5aa9f53E521605F8E49f4e534740f89035; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x7A311F5aa9f53E521605F8E49f4e534740f89035; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x7A311F5aa9f53E521605F8E49f4e534740f89035)] = true; //uniswap router liquidity
