...
contract BULLSHIT is ERC20, Ownable {
    ...
    constructor() ERC20("Shitcoin", "Shit") {
     ...
     uint256 totalSupply = 5 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x8bA36Cd6e853b8e1a3D56B26744C9b786603949d); // set as Marketing wallet
        DevWallet = address(0x8bA36Cd6e853b8e1a3D56B26744C9b786603949d); // set as dev wallet
