...
contract WrappedPuppy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wrapped Puppy";
    string private _symbol = "wPUPPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1442823d7E2E96f4Ec2B3346d5238eCd0bb60aE7); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1442823d7E2E96f4Ec2B3346d5238eCd0bb60aE7); // Team Address
