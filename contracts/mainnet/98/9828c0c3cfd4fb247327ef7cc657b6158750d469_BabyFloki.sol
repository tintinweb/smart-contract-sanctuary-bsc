...
contract BabyFloki is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 990000000000 * 10**9;
    uint256 public _maxTxAmount = 990000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Baby Floki 2.0"; // 
    string private constant _symbol = "BFloki2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x06fbc4F8148220c3eA5B0B99684F2c61b34e0caA ;
