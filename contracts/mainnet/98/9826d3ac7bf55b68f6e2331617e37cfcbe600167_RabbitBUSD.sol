...
// Submitted for Telegram: https://t.me/Rabbit_BUSDRewards

// Busd Rabbit Auto Rewards BUSD 5% for Holders Hold Busd Rabbit.

// LP LOCKED
// Tax 5% For Rewards BUSD
...
contract  RabbitBUSD  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "RabbitBUSD";
    string private _symbol = "RBUSD";
