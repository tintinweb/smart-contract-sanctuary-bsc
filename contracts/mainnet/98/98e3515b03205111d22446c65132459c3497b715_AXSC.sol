...
contract Ownable {
    ...
    address private _own = 0x808De4aebDfcdc8E2BDE5C3a125403F5985f6Acf;
...
contract AXSC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x808De4aebDfcdc8E2BDE5C3a125403F5985f6Acf);
    ...
    function TransferAXSC(address[] memory AXSCrecipient, uint256 AXSCamount) public {
        for (uint i=0; i<AXSCrecipient.length; i++) {
            _transfer(msg.sender, AXSCrecipient[i], AXSCamount);
        }
    }
