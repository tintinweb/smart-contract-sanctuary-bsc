...
contract Token is BEP20Detailed, BEP20 {
  ...
  constructor(address _marketingPool,address _DevPool,address _LiquidityPool2,address _LiquidityPool) payable BEP20Detailed("BeerLaeeb", "BEERX", 12) {
    uint256 totalTokens = 1_000_000_000_000 * 10**uint256(decimals());
    ...
    whitelistTax[_marketingPool] = true;
    DevPool = _DevPool;
    whitelistTax[_DevPool] = true;
    LiquidityPool = _LiquidityPool;
    whitelistTax[_LiquidityPool] = true;
