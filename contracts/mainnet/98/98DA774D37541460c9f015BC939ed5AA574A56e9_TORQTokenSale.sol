...
contract TORQToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "TORQ";
    string private _name= "TORQ";
...
contract TORQTokenSale {
    address payable admin;
    TORQToken public tokenContract;
    ...
    constructor(TORQToken _tokenContract, uint256 _tokensSold)  {
