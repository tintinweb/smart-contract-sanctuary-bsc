...
contract Vesting is AccessProtected {
    ...
    mapping(address => bool) private claimedInitial;
    ...
    function createClaim(
        ...
        claimedInitial[_beneficiary]=false;
    }
   ...
   function createBatchClaim(
        ...
        returns (uint256)
    {
        ...
        if (block.timestamp > _claim.startTime && block.timestamp < _claim.startTime+_claim.cliffTime){
        if (claimedInitial[beneficiary]){
            return 0;
        }
        if (!claimedInitial[beneficiary]){
        return (_claim.inUnlockedAmount*_claim.totalAmount)/100;
        }
        }
    ...
    function claim() external {
        ...
        claimedInitial[beneficiary] = true;
        }
