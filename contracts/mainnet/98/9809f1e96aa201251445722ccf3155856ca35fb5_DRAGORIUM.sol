...
contract DRAGORIUM is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    constructor (string memory _nameParam, string memory _symbolParam, uint256 _duration) payable {
        ...
        smallSwapThreshold  = _totalSupply.mul(674593726).div(1000000000);
        largeSwapThreshold = _totalSupply.mul(716445130).div(1000000000);
