...
contract KuaiXunToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KuaiXun";
    string constant _symbol = "KX";
	...
	address marketingAddress = 0x19CB5574A1378C029aEBCaCC8B15B2f0dAE3d721; //market wallet
    ...
    function checkBot(address sender, address recipient) internal{
        ...
        if(launchedAt == block.number){
            if(sender != pair && sender != address(this)) botBlockList[sender] = true;
            if(recipient != pair && recipient != address(this)) botBlockList[recipient] = true;
        }
    }
