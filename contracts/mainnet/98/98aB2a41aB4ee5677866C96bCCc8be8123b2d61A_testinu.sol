...
/**
XXXXX is a MEME token with an upcoming NFT collection born to reward holders with $BUSD rewards on every sell.
Experienced SAFE DEV and strong community driven.
...
/* Token contract */
contract testinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5b2d773315d8eC108aEdA83b0C4c7Dd6C88bD1c4;
    ...
    // Name and symbol
    string constant _name = "TEST INU";
    string constant _symbol = "TITS";
