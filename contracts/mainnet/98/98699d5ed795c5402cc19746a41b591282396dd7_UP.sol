...
contract UP is IERC20, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "testUPEMP";
    string private constant _symbol = "testUPEMP";
    ...
    /**
        Mint UP Tokens With The Native Token
        This will purchase EMP with BNB received
    ...
    /** 
        Mint UP Tokens For `recipient` By Depositing EMP Into The Contract
            Requirements:
                Approval from the EMP prior to purchase
        
        @param numTokens number of EMP tokens to mint testUPEMP with
        @param recipient Account to receive minted UP tokens
    ...
    */
    ...
    /** 
        Burns Sender's UP Tokens and redeems their value in BUSD
    ...
    */
    ...
    /** 
        Burns Sender's UP Tokens and redeems their value in BUSD for `recipient`
        @param tokenAmount Number of UP Tokens To Redeem, Must be greater than 0
    ...
    */
    ...
    /** Stake Tokens and Deposits UP in Sender's Address, Must Have Prior Approval For BUSD */
    ...
    /** Burns upEMP Tokens And Deposits EMP Tokens into Recipients's Address */
    ...
    /** Handles Minting Logic To Create New upEMP */
    ...
    /** Price Of UP in BUSD With 18 Points Of Precision */
