...
contract EduPaycoin is Context, Ownable, IERC20 {
    ...
    string private _name = "EduPay Coin";
    string private _symbol = "EDPC";
    ...
    address payable public referralWallet = payable(0x99C8C103B54044B9cE87eAfA4a73AFbcAcf76f52);
    address payable public rewardWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    address payable public liquidityWallet = payable(0x7Ec644e076a6770Dd67440dA0a4025aEFd796D63);
    address payable public marketingWallet = payable(0x96bc28420d6BAC441a49F8242a552DB817A42535);
