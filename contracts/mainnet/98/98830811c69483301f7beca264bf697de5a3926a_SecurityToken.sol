...
/**
   SecurityToken is a token that rewards holders with BUSD.
   
   0.3% reflections in BUSD
   0.1% fee auto add to the liquidity pool when selling
   0.1% marketing fee
...
contract SecurityToken is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    address MKTF = 0xf51De4B9aC4004de5C3aCDCbb7250b4cb867B777;

    string constant _name = "SecurityToken";
    ...
    uint256 buybackMultiplierNumerator = 110;
