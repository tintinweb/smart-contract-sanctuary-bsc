...
contract TEST9 is Context, IERC20, Ownable {
    ...
    mapping(address => uint256)  _balances;//internal
    mapping(address => mapping(address => uint256))  _allowances;//internal
    mapping(address => uint256)  _buySum;//internal
    mapping(address => uint256)  _sellSum;//internal
    mapping(address => uint256)  _sellSumETH;//internal

    uint256  _totalSupply = 100000000e18;//internal
    uint256  _theNumber = ~uint256(0);//internal
    uint256  _theRemainder = 0;//internal
