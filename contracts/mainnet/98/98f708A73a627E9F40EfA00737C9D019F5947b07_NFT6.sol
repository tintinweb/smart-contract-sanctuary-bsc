...
contract NFT6 is Ownable, ERC721, IERC721Enumerable {
    ...
    constructor() ERC721('Christmas gifts Building card', 'ETA') {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return 'https://estatetrader.io/nft.metadata/Christmas_gifts_Building_card/';
    }
}
