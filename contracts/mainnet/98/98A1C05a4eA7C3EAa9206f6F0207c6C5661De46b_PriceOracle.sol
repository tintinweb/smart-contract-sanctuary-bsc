...
pragma solidity ^0.6.6 || ^0.8.4 || ^0.7.6 || ^0.8.0;
...
contract PriceOracle is Ownable {
    ...
    mapping(address => PriceInformation) public pairInformation;

    function initialize(address _uniSwapRouter) public onlyOwner {
    ...
    function initPair(address _pair) internal {
    ...
    function initPairs(address[] calldata _pairs) public {
    ...
    function updatePairs(address[] calldata _pairs) public {
        for (uint256 i = 0; i < _pairs.length; i++) {
            update(_pairs[i]);
        }
    }
