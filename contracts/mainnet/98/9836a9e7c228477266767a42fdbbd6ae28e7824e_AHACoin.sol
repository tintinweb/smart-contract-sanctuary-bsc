...
// TG: https://t.me/+cfNfDN2jYDgyMWM1
interface IERC20 {
...
contract AHACoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB0f5ef14A6EffAb4939d2E26Ce0b499b40FD813E;

    string private constant _name = "AHA Coin";
    string private constant _symbol = "AHA";
    ...
    Taxes public taxes = Taxes(2,6,2,2);
