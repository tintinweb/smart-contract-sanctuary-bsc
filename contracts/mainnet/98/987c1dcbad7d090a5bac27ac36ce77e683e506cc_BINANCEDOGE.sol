...
contract BINANCEDOGE is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x3376C7F2e1e17b0a0cBbdB38C51d05410b7e7f32));
    ...
    string private _name = "Binance Doge";
    string private _symbol = "Bidog";
