...
contract BrickVerse is BEP20 {
    ...
    address public sphynxTokenAddress =
        0x6e281f90c6D1b5E5A01FB6f14C428afF69c04C3F;
    ...
    uint256 public maxTxAmount = 5000 * (10**8); // Initial Max Tx Amount
    ...
    constructor() public BEP20("BrickVerse", "Brick", 8) {
        devmarketingFeeOnBuy = 5;
        devmarketingFeeOnSell = 6;
        fundFeeOnBuy = 4;
        fundFeeOnSell = 6;
        liquidityFeeOnSell = 6;
