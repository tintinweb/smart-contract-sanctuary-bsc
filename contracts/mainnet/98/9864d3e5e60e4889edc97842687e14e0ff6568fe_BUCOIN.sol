...
// main contract
contract  BUCOIN is Context, IERC20, Ownable {

//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "BUCOIN";
    string private _symbol = "BUC";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0xf8A3b4ef71f25dA7b2784663E385afdd3b6C8636;
    address public _DevelopmentWalletAddress = 0xf8A3b4ef71f25dA7b2784663E385afdd3b6C8636;
    address public _Nft_treasuryWalletAddress = 0xcf5B856cC64FA85836C3F7318ae0a472F45E5f9C;
    address public _BuybackWalletAddress = 0xcf5B856cC64FA85836C3F7318ae0a472F45E5f9C;
...
//uint
    ...
    uint public buyNft_treasuryFee = 0;
    uint public sellNft_treasuryFee = 0;
...
// constructor
    constructor() {
        ...
        maxBuyTx = _tTotal / 100; // 10%
        maxSellTx = (_tTotal / 100) / 2; // 10%
        maxWallet = (_tTotal * 2) / 100; // 10%
