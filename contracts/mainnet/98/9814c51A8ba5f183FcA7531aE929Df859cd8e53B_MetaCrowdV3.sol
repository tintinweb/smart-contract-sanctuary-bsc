...
contract MetaCrowdV3 is AccessControl {
    ...
    address public fundAlloc = 0xb72C71447a003EFa03E13C167Aa34348a97A084d;
    uint16[] public bonus = [0, 20, 30, 40, 50, 60, 70];
    uint16[] public defaultParams = [2, 10, 100, 5, 500, 600, 10, 50];
    uint16[] public crowdParams = [110, 30, 700, 10, 200, 100, 3000, 1000, 3, 1];
