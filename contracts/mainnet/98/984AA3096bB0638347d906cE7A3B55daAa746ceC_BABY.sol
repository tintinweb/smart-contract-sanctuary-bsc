...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 100  ** IERC20(FISTAddress).decimals();//这里是判断  用户持有多少币 加池子才可以获得分红的条件
...
contract BABY is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0x12F556316FEd07CC02B5ceA9eF0f64a4c36d9fEb),
