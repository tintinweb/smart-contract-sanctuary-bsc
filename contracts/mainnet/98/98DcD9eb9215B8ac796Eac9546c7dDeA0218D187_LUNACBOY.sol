...
contract LUNACBOY is Context, IERC20, Ownable {
    ...
    address private Lunc_Marketing_Wallet = 0x1d80192531912f049f3f0D247B7CB87d5B3403D7;
    address private Lunc_Team_Wallet = 0x1d80192531912f049f3f0D247B7CB87d5B3403D7;

    uint256 public Lunc_max_WalletLimit = 20000 * 10**9; //2%
    uint256 public swapTokensAtAmount = 3000 * 10**9; //0.3%
    uint256 public Luncboy_max_BuyLimit = 30000 * 10**9; // 2%
    uint256 public Luncboy_max_SellLimit = 30000 * 10**9; //2%
