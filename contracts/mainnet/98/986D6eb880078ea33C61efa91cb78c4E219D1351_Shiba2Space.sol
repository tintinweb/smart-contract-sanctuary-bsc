...
contract Shiba2Space is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba2Space";
    string private _symbol = "Shiba2Space";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x95287784D4614EB73373728bc4d5F6Ac359DdA19); 
    address payable public ttWal = payable(0x95287784D4614EB73373728bc4d5F6Ac359DdA19); 
