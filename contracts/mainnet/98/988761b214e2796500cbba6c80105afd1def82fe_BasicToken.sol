...
contract BasicToken is ERC20, Ownable {
    uint256 private constant initialSupply = 10_000_000 * 10**18;
    ...
    constructor(address _router) ERC20("Year of the Apes", "YOTA") payable
    {
        ...
        // External wallets 
        taxWallets["marketing"] = 0x1cC85f58A8aB0B6074a932A9338E8ff7D22dd678;
        taxWallets["dev"] = 0x5445fF577c6EB4b7650827BA4Cdf09fC0c54D63E;

        maxTxAmount = initialSupply * 75 / 10000;
        maxOwnedAmount = initialSupply * 150 / 10000;
