...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x2c63169b5A0EF9a7B5eBcEa61Ecbc20DB2794388;
...
contract SonarRium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sonar Rium"; // 
    string private constant _symbol = "$SONAR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable private  _marketingWallet = payable(0xc11ba04df6527FF2C9332d1103AD8B5D6E729c4a);
