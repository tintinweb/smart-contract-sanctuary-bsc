...
//  Join our socials to play our Venom Arena P2E GAME !
//  Website: https://www.VenomArena.com/
//  Telegram: https://t.me/VenomArenaToken
/**
...
contract VenomArena is ERC20, Ownable, Shared {
    ...
    address public marketingWalletAddress = 0x91fa86EAC5240f0402d01C56C2347F79EA6a14E3;
    address public devWalletAddress = 0x91fa86EAC5240f0402d01C56C2347F79EA6a14E3;
    ...
    constructor() ERC20("Venom Arena", "VENOM") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "VENOM: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "VENOM: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "VENOM: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":VENOM Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "VENOM: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "VENOM: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "VENOM: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "VENOM: Blacklisted address");
