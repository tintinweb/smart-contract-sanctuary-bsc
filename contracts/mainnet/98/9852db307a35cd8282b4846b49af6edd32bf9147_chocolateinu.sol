...
/**
    ...
    Telegram: https://t.me/chocolateinuportal

    Twitter: https://twitter.com/chocolateinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf2Ae40EadE35602284dEd4d3A7F72274b97C9630; // owner address
...
contract chocolateinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chocolate Inu";
    string private _symbol = "CHINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2Ae40EadE35602284dEd4d3A7F72274b97C9630); // Marketing Address
    address payable public teamWalletAddress = payable(0xf2Ae40EadE35602284dEd4d3A7F72274b97C9630); // Team Address
