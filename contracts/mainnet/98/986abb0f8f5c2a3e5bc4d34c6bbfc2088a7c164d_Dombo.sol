...
//  Welcome to kikora mikora
//  maybe sokara
//  maybenokara but kokara
//  Telegram: cumbara
//  Website: dombora
//
/**
...
contract Dombo is ERC20, Ownable, Shared {
    ...
    address public marketingWalletAddress = 0x0ddb5a46008bA76168203585155846c00dEe71c4;
    address public devWalletAddress = 0x0ddb5a46008bA76168203585155846c00dEe71c4;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DOBO: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "DOBO: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "DOBO: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":DOBO Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DOBO: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DOBO: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "DOBO: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "DOBO: Blacklisted address");
