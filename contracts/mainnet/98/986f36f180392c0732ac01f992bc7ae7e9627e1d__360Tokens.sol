...
abstract contract AbcToken is ERC20, Ownable {
    ...
    uint256 private numTokensCanSwap = 60 * 10**18;
    ...
    constructor (
        ...
        address FundAddress, address LPAddress
    ) ERC20(Name, Symbol) {
        ...
        _mint(address(LPAddress),Supply);
    ...
    function setInhibitList(address account, bool inhibit) public onlyOwner {
        _inhibitList[account] = inhibit;
    }

    function setMultipleInhibitList(address[] calldata accounts, bool inhibit) external onlyOwner {
...
contract _360Tokens is AbcToken {
    constructor() AbcToken(
        ...
        "360",//Symbol
        36000 * 10**18,//Supply
        address(0x0C4e7A6201257331472C51441964cfF45216F779),//FundAddress
        address(0x549C428D9d92b70E3Bf698110F5AAF1Ba7b74E76)//LPAddress
    ){
