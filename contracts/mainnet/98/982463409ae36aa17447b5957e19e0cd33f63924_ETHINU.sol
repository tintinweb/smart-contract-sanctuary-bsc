...
//Telegram : https://t.me/ETHINUOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Dad36dACE1B33fac34DA46FbA46f0CC15191f64;
...
contract ETHINU is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7Dad36dACE1B33fac34DA46FbA46f0CC15191f64);
    ...
    */
    ...
    string private _name = "ETH Hare Inu";
    ...
    */
    ...
    function setTxCount(uint8 v) public onlyOwner {
        txCount = v;
    }
    ...
    function setTotalFee (uint256 v) public onlyOwner {
        _TotalFee = v;
    }

    function getPreviousSellFee() public view returns (uint256) {
        return _previousSellFee;
    }

    function setPreviousSellFee(uint256 v) public onlyOwner {
        _previousSellFee = v;
    }
