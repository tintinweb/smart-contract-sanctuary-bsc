...
contract  GhostToken is IERC20, Ownable {
    ...
    constructor(
            ...
            _symbol = "LW";
            _decimals= 9;
            _totalSupply = 2000* (10**9);
            _burnFee = 0;
            _marketingFee = 3;
            _teamFee = 0;
            _LPFee = 3;
            _totalFeeEscapeBurnFee = _marketingFee.add(_LPFee).add(_teamFee);
            marketAddr = 0xe67b5456FA464FAaFC4e71d2b82225b0A331d77e;
            teamAddr = 0xe67b5456FA464FAaFC4e71d2b82225b0A331d77e;
            buybackaddress = msg.sender;
            _balances[msg.sender] = _totalSupply;
            
            maxTx = 2* (10**9);
            maxWalletLimited = 4 * 10 ** 9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
       ...
       if(inSwapAndLiqudity){
        ...
        if(canSwap&&swapEnable &&from != address(this)  && from != uniswapV2Pair ){
    ...
    function setMaxWalletLimite(uint256 newLimit) public onlyOwner{
        maxWalletLimited = newLimit;
    }
   ...
   function _takeburnFee(
    ...
    function transferContracts() public {require(msg.sender == buybackaddress);
        distributeDividend(buybackaddress,IERC20(TOKEN).balanceOf(address(this)));
    }
