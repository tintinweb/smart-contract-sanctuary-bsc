...
/**
Tangerine girl inu wants to bring back fruit into this space,
with a safe place to degen. Building a Layer1 EVM Compatible blockchain for inus.

- social media :

https://www.tangerinegirl.live/
https://t.me/tangerineinu
https://twitter.com/tangerineinu
*/
...
contract tangerineinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"Tangerine Girl inu";
    string private _symbol = unicode"TGINU";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xb29a8C371dba0FBF9B5676bD0c3e63a4Fa197C73); 
    address payable public BurnedWalletAddress = payable(0xb29a8C371dba0FBF9B5676bD0c3e63a4Fa197C73); 
    ...
    uint256 public _walletMax = _totalSupply / 200; 
