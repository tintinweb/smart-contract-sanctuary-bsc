...
contract RocketShibaUp is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RocketShibaUp";
    string constant _symbol = "RSHIBUP";
    ...
    uint256 public _maxTxAmount = _totalSupply * 50 / 100; // 50% 
    uint256 public _walletMax = _totalSupply * 80 / 100; // 80%
