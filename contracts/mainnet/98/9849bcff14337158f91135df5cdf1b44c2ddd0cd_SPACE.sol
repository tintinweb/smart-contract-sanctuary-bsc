...
Telegram : https://t.me/spacecatcointwo
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2fA77F93E1AE9a1B628a438a4095B705C4cFbadF;
...
contract SPACE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPACE CATCOIN 2.0"; // 
    string private constant _symbol = "$SPACE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x5282Cd273b7A8Bd6EDC98584E093df798d663999);
