...
contract DexERC20 is IDexERC20 {
    ...
    string public constant name = 'Oceanland Dex LPs';
    string public constant symbol = 'OLAND-LP';
...
contract DexPair is IDexPair, DexERC20 {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        ...
        if (feeOn) {
            if (_kLast != 0) {
                ...
                if (rootK > rootKLast) {
                    uint256 numerator = totalSupply.mul(rootK.sub(rootKLast)).mul(15);
                    uint256 denominator = rootK.mul(15).add(rootKLast.mul(15));
    ...
    function swap(
        ...
        require(amount0In > 0 || amount1In > 0, "Dex: INSUFFICIENT_INPUT_AMOUNT");
        {
            ...
            uint256 balance0Adjusted = (balance0.mul(10000).sub(amount0In.mul(30)));
            uint256 balance1Adjusted = (balance1.mul(10000).sub(amount1In.mul(30)));
            require(
