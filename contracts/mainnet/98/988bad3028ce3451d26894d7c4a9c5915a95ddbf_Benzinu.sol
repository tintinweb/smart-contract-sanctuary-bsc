...
contract Benzinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BenzinuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Mercedez Benz Inu", "BENZI") {
        marketingWallet = payable(0x9D77A572B5E38Bdd290227BBcf58e70948fB765E);
        buybackfeeWallet = payable(0xfc5Bb417B3dd212D9D871451397df6e46888eE48);
        ...
        dividendTracker = new BenzinuDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 20; // 2%
...
contract BenzinuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Benzinu public BenzinuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BenzinuContract = Benzinu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Benzinu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Benzinu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Benzinu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BenzinuContract);

            uint256 prevBalance = BenzinuContract.balanceOf(address(this));
            ...
            {
                uint256 received = BenzinuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BenzinuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
