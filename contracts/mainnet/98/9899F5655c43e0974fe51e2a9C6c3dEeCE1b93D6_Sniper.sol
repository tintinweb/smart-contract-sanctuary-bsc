...
contract Sniper is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        require(block.number > startBlock + slienceBlock, "silent block");
        require(tx.gasprice <= 8000000000, "Gas Price Too High");
