...
contract CWGToken is IERC20, Ownable,WhiteList,BlackList {
    ...
    address public marketAddress = 0xbF520990A81D8d9ab5D5Eb8AcbB4462650c4F000;
    address private bep20usdt = 0x55d398326f99059fF775485246999027B3197955;
   

    uint256 private _tFeeTotal;

    string private _name = "CWG";
    string private _symbol = "CWG";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 75;
    uint256 private _previousburnFee;

    uint256 public _LPFee = 125;
    ...
    uint256 private _tTotal = 1170000 * 10**9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function setParent(address account,address panent) public onlyOwner {
        inviter[account] = panent;
    }

    function updateIsExcludedFromFeeBatch(address[] calldata accounts, bool state) public onlyOwner {
    ...
    function _transfer(
        ...
        require(!isBlackListed(from), "Blacklist users are prohibited from trading");
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || from == address(uniswapV2Router) || to == uniswapV2Pair || isBlackListed(from)) {
            takeFee = 0;
