...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        _name = "project one coin";
        _symbol = "POC";

        _main = 0x1013bBA9dccA0bC943f2270c3dD24e7cDE5bB807;
        _mark = 0x1013bBA9dccA0bC943f2270c3dD24e7cDE5bB807;
    ...
    function _transfer(
        ...
        if (balance >= _maxsell && !_swap && sender != _pair) {
            _swap = true;
    ...
    function setMark(address mark) public onlyOwner {
        _mark = mark;
    }
