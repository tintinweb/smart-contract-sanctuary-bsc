...
TG: https://t.me/ResurrectionBotSystem
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD94c61AA159cC04dCc48064791535E57f9DA8FaC; // owner address
...
contract ResurrectionBotSystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Resurrection Bot System";
    string private _symbol = unicode"RESS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD94c61AA159cC04dCc48064791535E57f9DA8FaC); // Marketing Address
    address payable public teamWalletAddress = payable(0xD94c61AA159cC04dCc48064791535E57f9DA8FaC); // Team Address
