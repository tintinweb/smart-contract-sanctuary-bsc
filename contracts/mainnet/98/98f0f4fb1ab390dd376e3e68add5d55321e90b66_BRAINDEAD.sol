...
Telegram : https://t.me/BRAINDEADMARK3X
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17573B5b0D9E78c1aC857329cb2Dd4fC7E8564B8;
...
contract BRAINDEAD is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 80000000 * 10**9; //
    string private constant _name = "BRAINDEAD?!?!"; // 
    string private constant _symbol = "$BRAINDEAD?!"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x17573B5b0D9E78c1aC857329cb2Dd4fC7E8564B8);
