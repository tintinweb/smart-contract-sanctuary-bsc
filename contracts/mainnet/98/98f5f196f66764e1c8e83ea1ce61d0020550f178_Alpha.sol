...
//Contract
contract Alpha is IBEP20, Ownable {
    ...
    string private constant _name = 'Fubuki neko';  
    string private constant _symbol = 'FubuNek';    
    ...
    uint8 private _sellTax=25;
    uint8 private _transferTax=25;
    ...
    uint256 public constant blacklistBlocks = 7;
...
//constructor
    constructor () {
        ...
        _excluded.add(0xC4e737F43913069AEa6284a5a7c9DC7Db4039848);
        _excluded.add(0x9dE14aE638CFA19888Cd12fD38BDf69fF1B3b668);
...
/////////////////////////////   STAKING REWARDS  /////////////////////////////////////////
    ...
    uint16 public AutoLPThreshold=30;
