...
$FOOT combines the best from all worlds into one token package; The goal of $FOOT is to bring people from all over the world together. Together we achieve financial freedom – all through memes!

Following the hype of meme and football coins on BEP20, footballium will become the top coin.
...
Telegram: https://t.me/footballiumbsc
...
contract footballium is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "footballium ";
    string constant _symbol = "FOOT";
