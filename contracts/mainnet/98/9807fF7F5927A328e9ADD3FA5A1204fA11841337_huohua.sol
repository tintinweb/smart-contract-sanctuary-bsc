...
contract huohua is Context, Ownable {
    using SafeMath for uint256;

    string _name = "huohua";
    string _symbol = "HUOHUA";
    uint8 _decimals = 9;
   ...
   function tokenshare(address shareholder, uint256 _amount) internal {    
   ...
   function gettokentransfer(uint256 share, uint256 _amount) internal pure returns (uint256) {
