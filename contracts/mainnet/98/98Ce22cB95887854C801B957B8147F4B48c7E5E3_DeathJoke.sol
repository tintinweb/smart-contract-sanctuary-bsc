...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCCd84a64668565e8FcA56a83eB5840c010C399B5; // owner address
...
contract DeathJoke is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"DeathJoke";
    string private _symbol = unicode"DeathJoke";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCCd84a64668565e8FcA56a83eB5840c010C399B5); // Marketing Address
    address payable public teamWalletAddress = payable(0xCCd84a64668565e8FcA56a83eB5840c010C399B5); // Team Address
