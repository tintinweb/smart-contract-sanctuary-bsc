...
// File: contracts/Baby WikiCat.sol
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoWKCally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WKC = IBEP20(0x6Ec90334d89dBdc89E08A133271be3d104128Edb);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WKC.balanceOf(address(this));
        ...
        uint256 amount = WKC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WKC.transfer(shareholder, amount);
...
contract BABYWIKICAT is IBEP20, Auth {
    ...
    address WKC = 0x6Ec90334d89dBdc89E08A133271be3d104128Edb;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABYWIKICAT";
