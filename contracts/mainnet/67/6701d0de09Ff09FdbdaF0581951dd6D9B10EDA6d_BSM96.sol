...
library Address{
 ...
 contract BSM96 is Context, IERC20, Ownable {
    ...
    address private donationWallet = msg.sender;

    string private constant _name = "Baby Safemoon 1996";
    string private constant _symbol = "BSM96";
    ...
    Taxes private taxes = Taxes(0,5,5, 0);
    Taxes private sellTaxes = Taxes(0, 5, 5, 0);
