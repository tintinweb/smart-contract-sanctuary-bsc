...
/**
                      SPOOKYSHARK
    SpookyShark $SSHARK is a meme token created with a spooky touch,
    purely designed to give back to the community burns.
   

    Telegram  : https://t.me/SpookySharkBsc
*/
...
contract SPOOKYSHARK is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x07f0998fD1accBe1F2F825fE1EDebd1986ca24C3);
    address payable public teamWalletAddress = payable(0xd4680eb72EbC4829d5C5aA8f5C54A0c677630725);
    ...
    string private _name = "SPOOKY SHARK";
    string private _symbol = "SSHARK";
