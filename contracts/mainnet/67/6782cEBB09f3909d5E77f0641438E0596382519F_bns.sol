...
contract bns is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 4500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Binance Name Service';
    string private _symbol = 'BNS';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 1;
    uint256 private _burnFee = 1;
    uint256 private _maxTxAmount = 4500000000 * 10**18;
