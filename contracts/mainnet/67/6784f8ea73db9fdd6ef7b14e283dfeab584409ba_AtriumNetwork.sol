...
THE NEXT BNB AND CRO
A decentralized project that has real utility and will road to DeFi 2.0


    Official Website
    https://twitter.com/AtriumNetBsc

    Telegram Global Community
    https://t.me/AtriumNetwork
...
contract AtriumNetwork is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x262bde40a812ed88494A2943466090f1F79C571A));


    string private _name = "Atrium Network";
