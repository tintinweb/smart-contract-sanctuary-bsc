...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8730aa757C8C457Ed5678989EaEd23aC60B4A410; // owner address
...
contract NoMarketingDontBuy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "No Marketing Dont Buy";
    string private _symbol = "NMDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8730aa757C8C457Ed5678989EaEd23aC60B4A410); // Marketing Address
    address payable public teamWalletAddress = payable(0x8730aa757C8C457Ed5678989EaEd23aC60B4A410); // Team Address
