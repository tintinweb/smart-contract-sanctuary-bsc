...
GOREZILLAX
Tax 10/10
Telegram : https://t.me/Gorezillatoken
*/
...
contract GOREZILLAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOREZILLAX";
    string private _symbol = "GOREX";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xF991E1E331d0eba0A4765a279e825371b89c2A0d); // Marketing Address
    address payable public teamWalletAddress = payable(0x0d03111d5214eFd1101960514EeE487bbB6E76dB); // Team Address
