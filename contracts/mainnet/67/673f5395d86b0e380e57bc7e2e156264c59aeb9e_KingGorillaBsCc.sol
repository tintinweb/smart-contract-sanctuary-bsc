...
contract KingGorillaBsCc is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Gorilla Token"; // 
    string private constant _symbol = "$KGT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xd4da907c130c669c03a65B235F55fC5016aa28dA;
