...
//import "./ISportyBox.sol";
//import "./ISportyNFT.sol";
...
interface ISportyBox is IERC1155 {
    function burn(
        address account,
        uint256 id,
        uint256 value
...
interface ISportyNFT is IERC721 {
    function safeMint(
        address _to,
        uint256 _nftType
    ) external;
...
contract BoxOpen is VRFConsumerBaseV2, Context, Ownable, ReentrancyGuard {
    ...
    ISportyBox public boxAddress;
    ISportyNFT public nftAddress;
    ...
    constructor(address _boxAddress, address _nftAddress, uint64 subscriptionId) VRFConsumerBaseV2(vrfCoordinator) {
        boxAddress = ISportyBox(_boxAddress);
        nftAddress = ISportyNFT(_nftAddress);
    ...
    function changeNftAddress(address _newNFTAddress) external onlyOwner{
        nftAddress = ISportyNFT(_newNFTAddress);
    }

    function changeBoxAddress(address _newBoxAddress) external onlyOwner{
        boxAddress = ISportyBox(_newBoxAddress);
    }
