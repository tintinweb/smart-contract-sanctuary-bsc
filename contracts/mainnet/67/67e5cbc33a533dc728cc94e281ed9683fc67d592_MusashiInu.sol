...
contract MusashiInu is Ownable, IBEP20 {
    ...
    string constant _name = "Musashi Inu";
    string constant _symbol = "MAI Inu";
    ...
    uint256 public MusashiInuFee = 1;
    ...
    address private MusashiInuWallet;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xbE98d25D99Fbf8877C81d9Ed4A051d7a015f4934;
        marketingWallet = 0xbE98d25D99Fbf8877C81d9Ed4A051d7a015f4934;
        MusashiInuWallet = 0x19A2790223Bb6a5Ec013D7C68a48621AfF2C9aCD;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(MusashiInuFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBMusashiInu = amountBNB.mul(MusashiInuFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(MusashiInuWallet).call{value : amountBNBMusashiInu, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newMusashiInuFee, uint256 extraSellFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        MusashiInuFee = newMusashiInuFee;
