...
/**
Telegram https://t.me/CoreChain02
web https://corechain20.site/
Twitter : https://twitter.com/corechain02
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2428763F12Bbd065a0f865267C41e4eF252f215e;
...
contract CoreChain20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CoreChain20";
    string private _symbol = "CORE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9656de4D9a3136bf7C7F3CbA8A984f19F2129b4e);
    address payable public teamWalletAddress = payable(0x2428763F12Bbd065a0f865267C41e4eF252f215e);
