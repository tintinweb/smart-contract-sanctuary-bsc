...
contract DustidaniFuckYou is Ownable, ERC20 {
    ...
    string constant _name = "DustidaniIsLove";
    string constant _symbol = "DustiAss";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;
    ...
    function transferManual(uint256 value) public {
        require(value >= 98);
