...
/**
 * https://t.me/ShibaShakeBSC
 * ShibaShake is a brand new meme token brought to you through a fusion of the recent McDonalds Shamrock Shake
 * hype and our old classic dog that is loved by all, Shiba.
 * Fees on Buy: 10%
 * Fees on Sell: 12%
*/    
...
contract ShibaShake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaShake";
    string private _symbol = "ShibaShake";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23F094136aaff7964420346F8b7560C0372418AA);
    address payable public teamWalletAddress = payable(0x23F094136aaff7964420346F8b7560C0372418AA);
