...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7d9030BC8Eaee66F0e81bC43f2f5Dfc6cAD2c708; // owner address
...
contract AndrewChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Andrew Chain";
    string private _symbol = "AChain"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9DB22223A4B1D527DaF0a857be22c6BC2e63745); // Marketing Address
    address payable public teamWalletAddress = payable(0xC9DB22223A4B1D527DaF0a857be22c6BC2e63745); // Team Address
