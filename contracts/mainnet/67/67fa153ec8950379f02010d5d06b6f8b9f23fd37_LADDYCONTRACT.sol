...
contract LADDYCONTRACT is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = _tTotal * 5 / 100;
    
    address public marketingWallet = 0x121216443b5F9407789D9f9130F19686aC76A526;
    address public devWallet = 0x121216443b5F9407789D9f9130F19686aC76A526;
    address public buybackWallet = 0x121216443b5F9407789D9f9130F19686aC76A526;

    string private constant _name = "MOC";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // buy or recept transfer
        if (to != pair) {
            _lastSell[to] = block.timestamp;
        }

        // check transfer or buy
        if (from != pair) {
            if(coolDownEnabled) {
