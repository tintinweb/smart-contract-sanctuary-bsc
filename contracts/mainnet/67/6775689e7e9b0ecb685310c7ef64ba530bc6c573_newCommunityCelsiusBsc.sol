...
// https://telegram.me/newCommunityCelsiusBsc
...
contract newCommunityCelsiusBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "New Community Celsius";
    string constant _symbol = "nCelsius";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10**4 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x355AC19fd0aEB1e5FC210d62Aae1E18F2A7Cbe0E;
