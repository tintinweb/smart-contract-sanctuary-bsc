...
contract Bayern is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000000 * (10**6);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baviera Capital";
    ...
    address public marketingWallet = 0xFFFf57547e90FDf5739523Ca83fe4B1282163090;
    ...
    uint256 public numTokensSellToAddToLiquidity = 2000000 * 10**6;
    ...
    constructor() {
        ...
        // exclude dead wallet from rewards
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount*10**6 >= totalSupply().div(10000), "transaction amount must be greater than 0.01% of total supply");
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 10, "total tax must be less than or equalto 10");
        _taxFee = taxFee;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmount*10**6;
    }
