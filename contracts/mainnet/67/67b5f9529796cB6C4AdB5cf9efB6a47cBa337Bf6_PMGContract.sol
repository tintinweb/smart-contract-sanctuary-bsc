...
/**
 * @dev Required interface of an ERC721 compliant contract.A
 */
interface IERC721 is IERC165 {
    /**
     * @dev Emitted when `tokenId` token is transferred from `from` to `to`.AAA
     */
     ...
     */
    event Approval(address indexed owner, address indexed approved, uint256 indexed tAokenId);
