...
contract PREY is PREYDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private PREYTeam;
    address private CharityPREY;
    ...
    string public override name = "Prey";
    string public override symbol = "PREY";
    ...
    constructor(uint totalSupplyValue, address PREYTeamAddress, address CharityPREYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        PREYTeam = PREYTeamAddress;
        CharityPREY = CharityPREYAddress;
       
        // split the tokens according to agreed upon percentages
        balances[PREYTeam] =  totalSupply * 4 / 100;
        balances[CharityPREY] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's PREYTeam pot
