...
contract OGNEKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG Neko";
    string private _symbol = "OGNEKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB9A1d674000D809efe92A22e1c32De0f4De9C2cA); 
    address payable public teamWalletAddress = payable(0x4a6f98B963A32e0Db1d9914191ddCd2FA952Beea); 
