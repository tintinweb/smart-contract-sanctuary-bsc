...
// 
//
// 📱 Telegram:https::https://t.me/SquidFanToken
/*
...
contract SquidFanToken is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SquidFanToken", "SquidFanToken") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SquidFanToken";
    string private _symbol = "SquidFanToken";
