...
contract SafeOneNftStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // rewards contract
        ...
        RTOKEN.approve(address(this), 1000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
