...
contract Ste is Context, IERC20, Ownable {
    ...
    string private _name = "ste";
    string private _symbol = unicode"ste";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xaAC8F93c77693CD4B9288b3db5C0495469e0F5Db));
        marketingWallet = payable(address(0x932360B1a743fb3aEcBDb07dEB09e74Dc5611d65));
