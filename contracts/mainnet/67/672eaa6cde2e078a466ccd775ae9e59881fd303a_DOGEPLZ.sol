...
contract DOGEPLZ is IERC20 {
    ...
    string constant private _name = "\xc4\x90OGE PLZ";
    string constant private _symbol = "PLZ";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xa4f65dae01d8B0C847816FAB8b5496AaC780B569),
        buyback: payable(0xa4f65dae01d8B0C847816FAB8b5496AaC780B569)
        });
