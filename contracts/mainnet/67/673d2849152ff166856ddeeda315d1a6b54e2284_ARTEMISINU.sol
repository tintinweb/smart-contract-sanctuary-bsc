...
contract ARTEMISINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x01aB718De73705e0272CDe76fc6b4c1f61C247ab); 
    address payable public Wallet_Dev = payable(0xaAB6929336f3b4EB2f6ee3f03B8DCcf48fD8D47e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Artemis Inu"; 
    string private constant _symbol = unicode"ARTEMISINU";
