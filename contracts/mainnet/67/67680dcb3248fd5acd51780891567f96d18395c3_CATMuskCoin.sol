...
contract CATMuskCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1559Aa606890b261de8602D67Ab22565283240d5); // Marketing Address
    ...
    string private _name = "CAT Musk Coin";
