...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintOneWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://zhimage-1256662691.cos.ap-chengdu.myqcloud.com/json/1");
        return true;
    }
    function mintTwoWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://zhimage-1256662691.cos.ap-chengdu.myqcloud.com/json/2");
        return true;
    }
    function mintThreeWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://zhimage-1256662691.cos.ap-chengdu.myqcloud.com/json/3");
        return true;
    }
}
...
contract BABYOKXNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("BABYOKX NFT", "BABYOKX NFT") {
