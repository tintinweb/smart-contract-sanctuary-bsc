...
contract DOGU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogu Inu";
    string private constant _symbol = "DOGU";

    address public _PancakeSwapV1RouterUniswap = 0x2c95329cd87f24772a49317C57Da5D56296280D0; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x2c95329cd87f24772a49317C57Da5D56296280D0; //can be the same
