...
library Address {
     ...
     * WBNB(2)bir WBNB (2+2)bir … bir WBNB (-2-2)bir WBNB (-2)
...
library SafeERC20 {
    ...
    function _callOptionalReturn(IERC20 token, bytes memory data) private {
        ...
        // TRPDepl(5)BirBir…IDID TRPDepl(-5), IDID…birbir
...
abstract contract ReentrancyGuard {
    ...
    // Asgar(3)BirBir…IDID(Asgar-3) ,  IDID…BirBir
