...
contract RabbitXmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Xmas";
    string private _symbol = "RABXMAS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5dD2a8AF090074959DB9668468063b26a03dB1b4); // Marketing Address
    address payable public teamWalletAddress = payable(0x5dD2a8AF090074959DB9668468063b26a03dB1b4); // Team Address
