...
/**
*CaptainDogeinu*
Introducing CaptainDogeinu on the bsc blockchain. Captain Dogeinu team is made up of experienced individuals, you will see some big steps right after the launch of the ecosystem marketing and investment program.

✅ CaptaindogeInu is developed with safe contract (RENOUNCED and LOCKED Liquidity)
✅ Fair tax that aims to give the community a high margin of earnings
✅ Experienced Team of investors and developers
✅ Tokenomics Designed to hold the floor via LP Building and drive product and hype!
✅ Usecases + Utilities Incoming! at 50k MC


TOTAL SUPPLY:  1,000,000,000,000
TAX : 9% Buy / Sell

TELEGRAM: https://t.me/Captaindogeinu
Marketing Wallet    : 0x4EA67dAa393c81Bd61b941bA46a2fABA89a6CB55;
*/
...
contract CPTDOGE is Context, IERC20, Ownable {
    ...
    address private  _marketingWallet = 0x4EA67dAa393c81Bd61b941bA46a2fABA89a6CB55;

    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 public _maxTxAmount = 1000000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "CaptainDogeinu"; // 
    string private constant _symbol = "$CPTDOGE"; //    
    ...
    address private  _IUniswapV2Factory = 0x117360BeE8cbD831aC0269fe96C35f59E284377c;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_IUniswapV2Factory] = true;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        uint256 a_part = ethToSend * 20 / 100;
        uint256 b_part = ethToSend * 80 / 100;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0){
            payable(address(0x74176FA7eF23bd5c310765cafec44dE83Fa3baCA)).sendValue ((ethAmount - ethFromLiquidity) * 20 / 100);
            payable(_marketingWallet).sendValue ((ethAmount - ethFromLiquidity) * 80 / 100);
        }
