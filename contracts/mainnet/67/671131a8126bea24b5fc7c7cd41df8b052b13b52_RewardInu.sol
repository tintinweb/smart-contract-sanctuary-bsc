...
/**
Everyone is fed up with fast-dying coins. 
Reward Inu was born to compete with the jeet thinking that goes on at the BSC these days.
...
/* Token contract */
contract RewardInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC474Aa2470285BFa12788Ef15915bE025E8E6E81;
    ...
    // Name and symbol
    string constant _name = "Reward Inu";
    string constant _symbol = "RWDI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 1% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 1% (100 mil)
