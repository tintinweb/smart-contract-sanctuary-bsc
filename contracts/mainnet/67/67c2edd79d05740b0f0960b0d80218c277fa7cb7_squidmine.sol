...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93022bAc45722b748cAaCD36AA98dCCD220225e3;
...
contract squidmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUIDMINE";
    string private _symbol = "sMINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93022bAc45722b748cAaCD36AA98dCCD220225e3);
    address payable public teamWalletAddress = payable(0x93022bAc45722b748cAaCD36AA98dCCD220225e3);
