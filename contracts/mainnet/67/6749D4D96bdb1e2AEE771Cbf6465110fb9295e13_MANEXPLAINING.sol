...
Telegram: https://t.me/Man_Explaining

Twitter: https://twitter.com/ManExplaining

Website: https://manexplaining.xyz
...
contract MANEXPLAINING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ManExplaining";
    string constant _symbol = "ME";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 6000000 * 10**6 * 10**18;
    ...
    uint256 private _tTotal = 100 * 10**18 * 10**18;
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.35% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 6000000 * 10**6 * 10**18;
