...
$RUSSO - ルッソ 
RUSSO Token
Russo Inu - The best hunting dog
@russo_inu
https://t.me/GoldenRabbit_Inu
📜Tax 3%
📜Whales are Welcome
📜Renounce
📜SAFU 1000000%
📜LP LOCK
 🆗Contract Address : 0x679074983941729d7f813c2882b907c55748daa6
🆗https://poocoin.app/tokens/0x679074983941729d7f813c2882b907c55748daa6
...
contract RUSSO is RUSSODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private RUSSOTeam;
    address private CharityRUSSO;
    ...
    string public override name = "RUSSO INU";
    string public override symbol = "RUSSO";
    ...
    constructor(uint totalSupplyValue, address RUSSOTeamAddress, address CharityRUSSOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        RUSSOTeam = RUSSOTeamAddress;
        CharityRUSSO = CharityRUSSOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[RUSSOTeam] =  totalSupply * 45 / 100;
        balances[CharityRUSSO] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's RUSSOTeam pot
