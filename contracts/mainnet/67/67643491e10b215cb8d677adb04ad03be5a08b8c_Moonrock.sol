...
/**
    ...
    https://moonrockbsc.eu/
    
    Features:
    - auto Rewards in USDC = 8%
    - auto Burn = 1%
    - auto Liquidity adding = 1%
    - Team + Marketing Fee = 1%
    ----------------------------------
***/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); // USDC the reward token you want distributed 
...
contract Moonrock is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; // Input the Reward Token Address // USDC on BSC
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // testnetBNB: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd MainnetBNB: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x3cf0adF48CEd244C8350ed90Fe768cBBD4484b88;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // testnet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E

    string constant _name = "Moonrock";
    string constant _symbol = "MRK";
    ...
    uint256 distributorGas = 9000000;
...
function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeToTokenAmount = feeAmount.sub(burnAmount);

        _balances[address(this)] = _balances[address(this)].add(feeToTokenAmount);
        emit Transfer(sender, address(this), feeToTokenAmount);
