...
contract NotFlokiAdvice is Context, IERC20, Ownable {
    ...
    string private constant _name = "Not Floki Advice";
    ...
    function setMaxWalletAndTx(uint256 newMaxWalletAndTx) external onlyOwner {
        _maxTxAmount = newMaxWalletAndTx * 10**_decimals;
        _maxWalletAmount = newMaxWalletAndTx * 10**_decimals;
    }
