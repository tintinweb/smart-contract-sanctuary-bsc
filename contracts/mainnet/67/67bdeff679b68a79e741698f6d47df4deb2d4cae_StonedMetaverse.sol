...
contract StonedMetaverse is Initializable,ERC20Upgradeable,OwnableUpgradeable {
  ...
  using SafeERC20Upgradeable for address;
    ...
    uint256 public dexTaxFee; //take fee while sell token to dex
