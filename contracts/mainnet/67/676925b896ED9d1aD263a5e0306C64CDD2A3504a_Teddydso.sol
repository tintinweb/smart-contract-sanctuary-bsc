...
contract Teddydso is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teddydao";
    string private _symbol = "Teddydao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb5c2a5Ee472167eEfF7df5a3E8dF38ffEFCdE7dc); // Marketing Address
    address payable public teamWalletAddress = payable(0xb5c2a5Ee472167eEfF7df5a3E8dF38ffEFCdE7dc); // Team Address
