...
contract UBDToken is ERC20, Ownable {
    ...
    constructor(
        ...
        tradeStartTime = block.timestamp.add(5 days);
    ...
    function _isTrade(address _from, address _to) private view returns (bool) {
        return tradeStartTime <= block.timestamp || (_isExcludedFromFees[_to] || _isExcludedFromFees[_from]);
    }
