...
contract Stake is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_0 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 100_0 * 10**9;
    uint256 public maxBuyLimit = 1_000_0 * 10**9;
    uint256 public maxSellLimit = 1_000_0 * 10**9;
    uint256 public maxWalletLimit = 2_000_0 * 10**9;
    ...
    string private constant _name = "Stake";
