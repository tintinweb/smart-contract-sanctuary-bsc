 ...
 */
contract SKYDIToken is ERC20Mintable, ERC20Detailed {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("Skyline Diamond", "SKYDI", 6) Ownable(initialOwner) {
        _mint(recipient, 1000000e6);
    }
