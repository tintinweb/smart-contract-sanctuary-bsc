...
// Telegram : https://t.me/BabyOkxBinance
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe64E35c73c5039e9b7659a60eC03C1d2E87763D3; // owner address
...
contract BabyOkxBinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyOKXBinance";
    string private _symbol = "BOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B7FD3eE16C739CC62d2E8B04C3e56AEE33e7600); // Marketing Address
    address payable public teamWalletAddress = payable(0x26226e876Cb8C5A20acCB04a86e08898348210dF); // Team Address
