...
TELEGRAM: https://t.me/Ai_Pikachu
...
contract Catgirl  is Context, IERC20, Ownable {
    ...
    uint256 public _marketingFee = 125;
    uint256 public _liquidityFee = 125;
    address public  _marketingWallet = 0x6446919bc5F8DA21b1eF8DEd44d5362d6c8A6a5F;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 10000; 
        uint256 liquidityFee = amount * _liquidityFee / 10000; 
