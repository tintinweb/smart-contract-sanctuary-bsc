...
contract Ryoshiba is RyoshibaDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private RyoshibaTeam;
    address private CharityRyoshiba;
    ...
    string public override name = "Ryoshiba";
    string public override symbol = "Ryoshiba";
    ...
    constructor(uint totalSupplyValue, address RyoshibaTeamAddress, address CharityRyoshibaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        RyoshibaTeam = RyoshibaTeamAddress;
        CharityRyoshiba = CharityRyoshibaAddress;
       
        // split the tokens according to agreed upon percentages
        balances[RyoshibaTeam] =  totalSupply * 4 / 100;
        balances[CharityRyoshiba] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's RyoshibaTeam pot
