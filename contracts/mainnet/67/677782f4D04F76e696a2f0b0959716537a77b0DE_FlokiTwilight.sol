...
FLOKITWILIGHT is a community meme token and aggressive to be at the crypto market to get hype on meme 
tokens and make this trend for the it’s own community and seek benefits for all the holders.

https://t.me/FlokiTwilight
...
pragma solidity ^0.6.12;
    ...
    contract FlokiTwilight is Context, IERC20, Ownable {
        ...
        string private _name = 'FlokiTwilight';
