...
contract wte is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Whalentine";
    string private _symbol = "WLE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xa3a71Dd41820815d6aC9F77e70eE6935c50C2503);
