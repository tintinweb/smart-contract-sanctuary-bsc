...
/** Telegram: https://t.meHERSHEYSINUOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60903Fbc45327F1fFF52666A33a79ebBE6Bd861F; // owner address
...
contract HersheysInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HersheysInu";
    string private _symbol = "Hersheys"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDEC2a315AD503027F730C5FBE705e0350dB6E003); // Marketing Address
    address payable public teamWalletAddress = payable(0xDEC2a315AD503027F730C5FBE705e0350dB6E003); // Team Address
