...
contract FLToken is Context, IERC20, Ownable {
    ...
    uint public lpTxAmount = 10e9;
    uint public lqAmount;
    uint public lqTxAmount = 100e9;
    ...
    function setLpTxAmount(uint _lpTxAmount,uint _lqTxAmount)external onlyOwner{
    ...
    function _transfer(
     ...
     function swapAndDividend(uint256 contractTokenBalance) private  {    
