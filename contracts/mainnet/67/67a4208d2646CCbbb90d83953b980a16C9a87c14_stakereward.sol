...
contract stakereward {
    ...
    uint256[32] public _priceID = [2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,
                                   2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,
                                   2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8,2000*1e8];
    ...
    uint public increasePrice = 50*1e8;
    uint public BASE = 10000;

    uint public inviteFee = 500;
    uint public winnerFee = 7500;
    uint public team1Fee = 250;
    uint public team2Fee = 250;
