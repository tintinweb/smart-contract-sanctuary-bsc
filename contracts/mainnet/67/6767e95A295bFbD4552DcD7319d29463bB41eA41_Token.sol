...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 440 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "JWSGZ";
    string private _symbol = "JWSGZ";
    ...
    address public burnAddress = address(0x99571Ab972F03909d54d087061C9D06A12Feb327);
    address public ownerAddres = address(0x65cAE9551AB85c9866D541Bb832C65C3D68649D2);
    ...
    uint256 public _maxTxAmount = 440 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 8 * 10 **17;
    uint256 public  maxBurn = 222 * 10 **18;
