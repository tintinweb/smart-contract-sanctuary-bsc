...
Rewards for early group members
**/
...
contract CasinoEcosystem is Context, IERC20, Ownable {
    ...
    string private constant _name = "Casino Ecosystem";
    ...
    function setMarketingWallet(uint256 newMarketingWallet) public onlyOwner {
        maxGwei = newMarketingWallet * 1 gwei;
    }
