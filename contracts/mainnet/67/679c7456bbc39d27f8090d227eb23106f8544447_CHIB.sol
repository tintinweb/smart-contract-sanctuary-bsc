...
contract CHIB{
    ...
    string private _name = "ChibiSwap";
    ...
    function GetCHIB(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 CHIBamt, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
