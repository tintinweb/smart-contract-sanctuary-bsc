...
contract MAGIC is IERC20, Ownable {
    ...
    address private fundAddress = address(0x4F604ddcC32B9803E316cBB52c4d14d9a4856D13);
    address private fundAddress2= address(0x86da20db315e087656A18E2c3af2671B69cD8FCf);
    address private fundAddress3 = address(0xEE3d5510255E52Ef70AE3Ad7af3cd8A01e8a67be);
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            takeFee = true;
            require(balanceOf(from).mul(99).div(100)>=amount,"sell max 99");
        }else{
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || balanceOf(_destroyAddress)>=980000000*10**18) {
            takeFee = false;
        }
