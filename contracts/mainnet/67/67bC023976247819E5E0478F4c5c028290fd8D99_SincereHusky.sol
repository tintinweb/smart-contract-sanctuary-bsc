...
/**
 ...
 🔥WELCOME TO SincereHusky

SincereHusky is the next SincereShib. This is another project based around the autonomous yield and liquidity generation protocol. This is safe, we will pump SincereHusky.

♻️TOTAL SUPPLY: 1,000,000,000,000
🔥BURN SUPPLY: 40%


TELEGRAM: https://t.me/SincereHusky
...
contract SincereHusky is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sincere Husky";
    string constant _symbol = "SINCEREHUSKY";
    ...
    uint256 public totalFeeSell = 17; //Total Fee
