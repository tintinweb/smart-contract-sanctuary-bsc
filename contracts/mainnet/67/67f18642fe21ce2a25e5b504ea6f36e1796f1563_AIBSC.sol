...
contract AIBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"AI BSC TOKEN";
    string private _symbol = unicode"AI";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x57D96Ec333FBC3c0E605596dCA4C7C2667C773d8); 
    address payable public BurnedWalletAddress = payable(0x57D96Ec333FBC3c0E605596dCA4C7C2667C773d8); 
    ...
    uint256 public _maxWalletPercent = 300;
