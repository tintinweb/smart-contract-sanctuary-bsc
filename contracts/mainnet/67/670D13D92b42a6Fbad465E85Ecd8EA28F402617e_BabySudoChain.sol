...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x497b15EC5FAe486aC703ce1EAf23a14408b71C11; // owner address
...
contract BabySudoChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BabySudoChain";
    string private _symbol = unicode"BAPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x497b15EC5FAe486aC703ce1EAf23a14408b71C11); // Marketing Address
    address payable public teamWalletAddress = payable(0x497b15EC5FAe486aC703ce1EAf23a14408b71C11); // Team Address
