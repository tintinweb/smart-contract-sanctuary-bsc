...
// CHANGE
contract BuffalogeInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Buffaloge Inu";
    string constant _symbol = "BI";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xa99Ad93f57553986147Bdea65Dc782E410756167);
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 500 && multiplier * totalFee <= 490000, "Multiplier too high");
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
