...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x950a831314Ee75EA5e3F794C9aCe18705931005b; // owner address
...
contract Elementnetwork is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Element Network";
    string private _symbol = unicode"Elnet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x950a831314Ee75EA5e3F794C9aCe18705931005b); // Marketing Address
    address payable public teamWalletAddress = payable(0x950a831314Ee75EA5e3F794C9aCe18705931005b); // Team Address
