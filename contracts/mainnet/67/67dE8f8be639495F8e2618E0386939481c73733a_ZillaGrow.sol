...
contract ZillaGrow is IBEP20, Ownable
{
    ...
    string private constant _symbol = 'ZGROW';
    ...
    uint public MaxWallet=15000*10**_decimals;
    uint public MaxTX=5000*10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell) tax=sellTax;
            ...
            require(amount+_balances[recipient]<=MaxWallet,"MaxWallet");
            if(isBuy)tax=buyTax;
    ...
    function SetLimits(uint maxWallet, uint maxTX) external onlyOwner{
        require(maxWallet>=InitialSupply/100);
        MaxWallet=maxWallet;
        require(maxTX>=InitialSupply/500);
        MaxTX=maxTX;
    }
