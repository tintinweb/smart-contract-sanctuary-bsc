...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CLOUD = IERC20(0x0c2bfA54d6d4231b6213803dF616a504767020eA);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CLOUD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CLOUD);
        ...
        uint256 amount = CLOUD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CLOUD.transfer(shareholder, amount);
...
contract MiniCloudChat is IERC20, Ownable {
    using SafeMath for uint256;

    
    address CLOUD = 0x0c2bfA54d6d4231b6213803dF616a504767020eA;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mini Cloud Chat";
    ...
    uint256 totalFee = 800; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x8c0C96849Edb0d000e5CB1Fe967B6Ff04f011E98);
        marketingFeeReceiver = address(0x8c0C96849Edb0d000e5CB1Fe967B6Ff04f011E98);
