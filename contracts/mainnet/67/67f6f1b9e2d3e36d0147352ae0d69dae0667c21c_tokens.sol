...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000,//Su 数量后面加20个0
        address(0x88AD89F20f0F3E10Cf9697295B65aCC95Ce81f9b),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x88AD89F20f0F3E10Cf9697295B65aCC95Ce81f9b)//
    ){
    }
}