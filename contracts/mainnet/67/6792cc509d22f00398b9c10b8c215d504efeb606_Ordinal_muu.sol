...
// Telegram : https://t.me/OrdinalMuu
...
contract Ordinal_muu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ordinal Muu";
    string private _symbol = "oMUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x440c2ef79C115b33aEE0fc18113E02dbda6E2071); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x440c2ef79C115b33aEE0fc18113E02dbda6E2071); // BuyBack Address
    ...
    uint256 public _walletMax = 120000 * 10**_decimals;
