...
// 
//
// 📱 Telegram:https::https://t.me/+eAs3eI-29UlkYzhl
/*
...
contract $MBAPEFANTOKEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$MBAPEFAN TOKEN", "$MBAPEFANTOKEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "$MBAPEFANTOKEN";
    string private _symbol = "$MBAPEFANTOKEN";
