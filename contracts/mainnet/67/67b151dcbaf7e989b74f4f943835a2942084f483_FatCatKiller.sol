...
library Address{
 ...
 contract FatCatKiller is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900e12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 9_000_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 9_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 9_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 18_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xeeb8Aac98858c37A860AE0B1d6AEBc6CDbAA9E4a;
    address public donationWallet = 0xeeb8Aac98858c37A860AE0B1d6AEBc6CDbAA9E4a    ;

    string private constant _name = "Fat Cat Killer";
    ...
    Taxes public taxes = Taxes(0, 4, 6, 1);
    Taxes public sellTaxes = Taxes(0, 4, 6, 1);
