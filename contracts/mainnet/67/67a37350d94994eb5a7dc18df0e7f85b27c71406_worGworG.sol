...
TG https://t.me/worGworG


    Grow Grow.... but backwards.
    ...
    dev is middle class in Europe too. Wealthy enough to not rug, too broke to be a billionaire, o.g in the space.
...
contract worGworG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x923f5de4557eBB8352167CC2FB22a0df98386f04;
 
    string constant _name = "worG worG";
    string constant _symbol = "$worG";
