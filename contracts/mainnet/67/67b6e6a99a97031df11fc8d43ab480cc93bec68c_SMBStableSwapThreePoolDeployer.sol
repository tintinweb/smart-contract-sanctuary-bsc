...
contract SMBStableSwapThreePool is Ownable, ReentrancyGuard {
...
contract SMBStableSwapThreePoolDeployer is Ownable {
    uint256 public constant N_COINS = 3;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SMBStableSwapThreePool).creationCode;
        ...
        SMBStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
