...
contract LPLock is Ownable {
    ...
    uint256 public unlockPeriod = 7776000; // 7776000 - 90 days in seconds
    uint256 public unlockPercent = 1000; // its 100%
    uint256 public nextUnlock;
    uint256 public level;
    bool public vestingIsStarted;
    uint256 public startUnlock;
    address public tokenAddress = 0x6BFD29A83a79a07627FcF02bf5EAa59b60A55De1;
    address public LPAddress = 0x91e09a8a72f9451d95787E2B9679c510F7D874a1;
    ...
    function claim() public {
        ...
        _token.safeTransfer(LPAddress, _amount);
    }

    function changeLPAddress(address newLP) public onlyOwner() {
        LPAddress = newLP;
    }
