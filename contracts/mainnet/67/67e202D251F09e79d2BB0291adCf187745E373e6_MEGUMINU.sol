...
Telegram : https://t.me/meguminubsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x666b2f8f60cE410A18a3509768adC2D1e31862d1;
...
contract MEGUMINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "MEGUM INU"; // 
    string private constant _symbol = "$MINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address payable public  _marketingWallet = payable(0x666b2f8f60cE410A18a3509768adC2D1e31862d1);
