...
Jeflonomics stealth launch, contract reward. So while you holding $Jeflonomics, easy earn $JEMB as rewards. Tax only 9% then you get 3% reflection for reward.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 JEMB = IBEP20(0x28Aa95Dd8ED60366E463BcAC70fbAFB0b4b542b0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = JEMB.balanceOf(address(this));
        ...
        uint256 amount = JEMB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JEMB.transfer(shareholder, amount);
...
contract $JFLNMCS is IBEP20, Auth {
    using SafeMath for uint256;

    address JEMB = 0x28Aa95Dd8ED60366E463BcAC70fbAFB0b4b542b0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Jeflonomics";
    string constant _symbol = "$JFLNMCS";
