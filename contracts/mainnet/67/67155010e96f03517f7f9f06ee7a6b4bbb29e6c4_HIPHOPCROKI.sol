...
/*
HIPHOP CROKI - STEALTH

NEW HYPED IN THE MARKET
POSSIBLE 10,000X MOONSHOT
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract HIPHOPCROKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HipHop Croki";
    string private _symbol = "HIPHOPCROKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x534187F54e9fEe84Ca7fA7E3b7567565045C34De);
    address payable public teamWalletAddress = payable(0x534187F54e9fEe84Ca7fA7E3b7567565045C34De);
