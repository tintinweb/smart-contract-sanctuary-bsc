...
// File: IGenericPancakeMasterChef.sol
...
// File: PancakeswapV2MCV2Worker02.sol
...
contract PancakeswapV2MCV2Worker02 is
  OwnableUpgradeSafe,
  ...
  IWorker02
{
  ...
  function initialize(
    ...
    require(
      baseToken != cake,
      "PancakeswapV2MCV2Worker02::initialize:: base token cannot be a reward token"
    );
    require(
  ...
  modifier onlyEOA() {
    require(
      ...
      "PancakeswapV2MCV2Worker02::onlyEOA:: not eoa"
    );
    _;
  }
  ...
  modifier onlyOperator() {
    require(
      msg.sender == operator,
      "PancakeswapV2MCV2Worker02::onlyOperator:: not operator"
    );
    _;
  }
  ...
  modifier onlyReinvestor() {
    require(
      ...
      "PancakeswapV2MCV2Worker02::onlyReinvestor:: not reinvestor"
    );
    _;
  }
  ...
  function _reinvest(
    ...
    require(
      ...
      "PancakeswapV2MCV2Worker02::_reinvest:: bad treasury account"
    );
  ...
  function work(
    ...
    require(
      okStrats[strat],
      "PancakeswapV2MCV2Worker02::work:: unapproved work strategy"
    );
    require(
  ...
  function getMktSellAmount(
    ...
    require(
      rIn > 0 && rOut > 0,
      "PancakeswapV2MCV2Worker02::getMktSellAmount:: bad reserve values"
    );
  ...
  function setRewardPath(address[] calldata _rewardPath) external onlyOwner {
    require(
      ...
      "PancakeswapV2MCV2Worker02::setRewardPath:: rewardPath length must be >= 2"
    );
    require(
      _rewardPath[0] == cake &&
