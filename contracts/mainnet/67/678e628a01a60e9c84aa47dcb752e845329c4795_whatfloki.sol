...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d03f89C413555036359432D372fB89E4BFe61FE; // owner address
...
contract whatfloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WHAT FLOKI???";
    string private _symbol = "wFLOKI";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x0d03f89C413555036359432D372fB89E4BFe61FE); // Marketing Address
    address payable public teamWalletAddress = payable(0x0d03f89C413555036359432D372fB89E4BFe61FE); // Team Address
