...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "LUNA-plus";
    string private _symbol = "LUNA-plus";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xa64f4d22cFED5F4ca8F092f1697E3885975B67A6);
    address payable public teamWalletAddress = payable(0x5F502Ea9C0f3665Ce698E9C8938c80095EaE04cB);
