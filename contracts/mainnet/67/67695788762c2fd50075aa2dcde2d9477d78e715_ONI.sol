...
contract ONI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x30E4fB8667040beF7aCC8aCBaDEFEB321Df6cCDC); 
    address payable public Wallet_Dev = payable(0x67b9E8d1aB23c2FB421939AB188da847114e08fe);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "ONI"; 
    string private constant _symbol = unicode"鬼";
