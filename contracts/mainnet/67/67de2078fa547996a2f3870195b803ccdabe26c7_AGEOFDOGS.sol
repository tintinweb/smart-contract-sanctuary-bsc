...
/**
 Age of Doges has begun

 Rewards in Doge 14% Fees 
 https://t.me/ageofdogs
 ⠀⠀▄   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀▄    
⠀⠀⠀⠀⠀⠀⠀⠀▌▒█⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀▄▀▒▌   
⠀⠀⠀⠀⠀⠀⠀⠀▌▒▒█⠀⠀⠀⠀⠀⠀⠀⠀▄▀▒▒▒▐   
⠀⠀⠀⠀⠀⠀⠀▐▄█▒▒▀▀▀▀▄▄▄▀▒▒▒▒▒▐   
...
contract AGEOFDOGS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AGEOFDOGS";
    ...
    uint256 public _maxTxAmount = 4 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 4 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x5cF33D351e8c222d9EAD5Fd3a63Df64B58D57418;
        marketingWallet = 0x22e27e9d7f38c08de0D6f40f538e9954702Ebc96;
        devWallet = 0x5cF33D351e8c222d9EAD5Fd3a63Df64B58D57418;
