...
contract VIETNAMSEAGAME31 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC3F7938e3bc98ee9C11479163659400e1f85Df5A); 
    address payable public Wallet_Dev = payable(0xA78a4361daDA3B8868df790E792cb1815EF428e9);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 31**6 * 10**_decimals;
    string private constant _name = "VIET NAM SEAGAME 31"; 
    string private constant _symbol = unicode"Seagame 31"; 
    ...
    constructor () {
        ...
        _owner = 0xA78a4361daDA3B8868df790E792cb1815EF428e9;
