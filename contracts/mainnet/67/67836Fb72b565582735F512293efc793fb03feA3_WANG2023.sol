...
contract WANG2023 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2_023 * 10**9;
    uint256 public _maxTxAmount = 20.23 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "WANG 2023"; // 
    string private constant _symbol = "WANG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xC49298459e5b8032922A6720B7c8f5D5fFA4667a;
