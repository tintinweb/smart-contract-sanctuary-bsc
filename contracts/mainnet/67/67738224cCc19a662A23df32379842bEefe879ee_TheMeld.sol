...
contract TheMeld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 800;
    uint256 MAX_MINT_BINANCE = 900;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_BINANCE, "Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, string(abi.encodePacked("You have to send some/more BNB to cover traversal gas fee estimate. You will be refunded the difference. Estimate: ", Strings.toString(messageFee))));
