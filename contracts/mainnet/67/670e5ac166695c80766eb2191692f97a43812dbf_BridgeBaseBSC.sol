...
contract BridgeBaseBSC is Ownable{
    ...
    constructor(string memory _network) {
        ...
        // Update Token
        updateAuthorizationForToken(0x55d398326f99059fF775485246999027B3197955,true); //USDT 
        updateAuthorizationForToken(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d,true); //USDC
        updateAuthorizationForToken(0x4DB5a66E937A9F4473fA95b1cAF1d1E1D62E29EA,true); //WETH
