...
contract NFTMarketplace {
  ...
  event ApprovedOffer(uint offerId, uint id, address newOwner);
...
address  public  contract_owner;
  ...
  function fillOffer(uint _offerId) public  {
    ...
    userFunds[_offer.user] += _offer.price;
    sellers[count].userAddres = _offer.user;
    sellers[count].balance = _offer.price;
  ...
  function claimFunds() public {
    ...
    require(userFunds[msg.sender] <= balance,'Balance not available');


    shahToken.approve(address(this), userFunds[msg.sender]);
    uint256 extractFee = this.calculateFee(userFunds[msg.sender]);
    shahToken.transferFrom(address(this), owner, extractFee);
    shahToken.transferFrom(address(this), msg.sender, userFunds[msg.sender] - extractFee);
