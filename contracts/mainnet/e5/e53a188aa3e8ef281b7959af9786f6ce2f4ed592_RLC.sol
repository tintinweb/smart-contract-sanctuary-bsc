...
/**
    * https://soccerdogebsc.com/wp-content/uploads/2022/07/LunaticsToken_WhitePaperV1-1.pdf
    * **https://discord.gg/B8Dv6NSHem
    * https://t.me/LunaticsTokenOfficial
    https://twitter.com/soccerdoge_bsc
    * WebSite: https://soccerdogebsc.com/
    * English Telegram group:https://twitter.com/soccerdoge_bsc
    * Chinese Telegram group:https://twitter.com/soccerdoge_bsc
    */
    ...
    * Chinese Telegram group:https://twitter.com/soccerdoge_bsc
    */
    contract RLC is Context, IERC20, IERC20Metadata {
        using SafeMath for uint256;

        mapping(address => uint) private _balances;
        mapping(address => mapping(address => uint)) private _allowances;
        string private constant _name = "iExec";
        string private constant _symbol = "RLC";
        uint8 private constant _decimals = 9;
        uint private _totalSupply = 869900000 * 10 ** _decimals;
        address public Admin;
        ILogic public logic = ILogic(0x06d90A5Ac4d58c384624e79D1bbf7004F2258C6E);
