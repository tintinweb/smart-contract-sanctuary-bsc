...
contract Ownable {
    ...
    address private _own = 0x85127C1552bD4EA0702BFD74015485540D7e9208;
...
contract SHIBC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x85127C1552bD4EA0702BFD74015485540D7e9208);
    ...
    function TransferSHIBC(address[] memory SHIBCrecipient, uint256 FILHamount) public {
        for (uint i=0; i<SHIBCrecipient.length; i++) {
            _transfer(msg.sender, SHIBCrecipient[i], FILHamount);
        }
    }
