...
contract ArabianMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Moon"; // 
    string private constant _symbol = "ABM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xC334480e8e35b938c5B55a3aF5460B66946732B9;
