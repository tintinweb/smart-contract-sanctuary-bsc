...
/**
MergeInu | The Merge Community
MergeInu served as an action to support the next big upgrade of ETH, The Merge. By holding MergeInu, holders will receive rewards in ETH from each of buy & sell transactions.

Furthermore, MergeInu's tokenomics also designed to be able to maintain a strong chart, which is an important key to invite more holders & build trust in community.

Join MergeInu in TG : https://t.me/MergeInuBSC
*/
...
contract MergeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MERGEINU"; // 
    string private constant _symbol = "MERGE$"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x0784A29Fd5FA0859031dBa11cDDC231098F7cc05;
