...
contract WayuInu is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 2_000_000_000 * 10**18;
    uint256 public maxSellLimit = 2_000_000_000 * 10**18;
    ...
    address public marketingWallet = 0x7cbCAbE873Ec3F0b24695aaBec72F387E04610f7;
    address private devWallet = 0xe7bB9862DAc32FfbcC8b8ea0852Bf0a77a592a55;
    address public buybackWallet = 0x495feAb2B9087A9ca5eA29761aefdee35EE1d4aD;
    ...
    Taxes public taxes = Taxes(6, 1, 1, 3, 1);
    Taxes public sellTaxes = Taxes(6, 1, 1, 3, 1);
    ...
    constructor(address routerAdd) ERC20("WayuInu", "Winu") {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner {
        require(maxBuy >= 100_000_000, "Cannot set max buy amount lower than 0.1% of tokens");
        require(maxSell >= 100_000_000, "Cannot set max sell amount lower than 0.1% of tokens%");
        maxBuyLimit = maxBuy * 10**decimals();
        maxSellLimit = maxSell * 10**decimals();
    }

    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 100_000_000, "Cannot set max wallet amount lower than 0.1% of tokens");
