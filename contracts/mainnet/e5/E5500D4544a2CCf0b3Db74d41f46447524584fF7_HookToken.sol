...
contract  HookToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3A3328DC773C1c65D7D73664b9b7336624b4eC76); 
    ...
    uint256 private _totalSupply = 500 *  10**6 * 10**_decimals;
