...
contract ATM is Owned {
    ...
    uint256 public INVEST_MAX_AMOUNT = 2000000000000000000; // 1 bnb
    uint256 public PROJECT_FEE = 50; // 50 = 5%
    ...
    constructor() {
        ...
        plans.push(Plan(10, 100)); // 10 days, 100 = 10%
    }
    ...
    function invest(address referrer) public payable {
        require(started, "ATM: not launched");
        
        require(msg.value >= INVEST_MIN_AMOUNT, "ATM: Deposit value is too small");
        require(msg.value <= INVEST_MAX_AMOUNT, "ATM: Deposit limit exceeded");
        require(planCurrent < plans.length, "ATM: Invalid plan");
    ...
    function withdrawreferalsbonus() public {
        ...
        require(referralBonus > 0, "ATM: User has no referal payments");
        require(contractBalance > referralBonus , "ATM: No enought balance. Try later");
    ...
    function withdrawdeposit(uint256 index) public {
        ...
        require(amount > 0, "ATM: No deposit amount");
