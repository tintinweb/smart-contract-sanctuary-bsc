...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Grizzly = IBEP20(0xa045E37a0D1dd3A45fefb8803D22457abc0A728a);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Grizzly.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Grizzly);
        ...
        uint256 amount = Grizzly.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Grizzly.transfer(shareholder, amount);
...
contract GRIZZLY_GROW is IBEP20, Auth {
    using SafeMath for uint256;

    address Grizzly = 0xa045E37a0D1dd3A45fefb8803D22457abc0A728a;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GRIZZLY_GROW";
    ...
    uint256 init_reflectionFee   = 5;
    uint256 init_marketingFee    = 10;
