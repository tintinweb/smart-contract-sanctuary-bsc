...
contract TotalBusd is Context, Ownable , ReentrancyGuard {
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
        ...
        require(_amount>=min && _amount <= max, "Out Of Deposit Amount");
        ...
        uint256 deadline_weekly = block.timestamp + 2 days;
