...
contract NFTAvatar is ERC721, ERC721Enumerable, Pausable, Operators {
    string public baseURI = "https://api.tapfantasy.io/api/assets/nftavatar/";

    event UpdateBaseURI(address from, string baseUri);

    constructor() ERC721("TAP AVATAR", "TFAVATAR") {}
