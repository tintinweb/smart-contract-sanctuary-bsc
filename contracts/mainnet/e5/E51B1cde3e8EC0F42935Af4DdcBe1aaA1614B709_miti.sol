...
contract miti is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "miti";
    string private _symbol = "miti";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9393504C1770f211f8e5F0f60A3E14C22B4efc67);
    address payable public teamWalletAddress = payable(0x9393504C1770f211f8e5F0f60A3E14C22B4efc67);
