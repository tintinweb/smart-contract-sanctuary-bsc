...
contract BabyDripto is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "BabyDripto"; //  Name
        _symbol = "BDRIPTO"; //  Symbol
        ...
        _maxWalletBalance = 60000000000 * 10**_decimals; // 6% of total supply
        _marketingWalletAddress = 0x4DB210e4A897870E46BA889eaC9a4cAc4589bA1a; // Marketing wallet 
        _devWalletAddress = 0x4DB210e4A897870E46BA889eaC9a4cAc4589bA1a; // Dev wallet 
