...
/*
    ...
    A Decentralized token focused on revolutionizing the way we look at Crypto. It's the year of the tiger!

    ↩️ Tokenomics:

    5% of every transaction is transformed into liquidity for Pancakeswap.

    1% of every buy or sell will be rewarded to holders

    2.5% of every transaction is allocated to Marketing

    🌍: https://www.tigerinutoken.com/
    🐦: https://twitter.com/Tiger_Inu_Token
    🗣: https://t.me/TigerInuTokenBSC
...
contract ELONFLOKI is Context, IERC20, Ownable {
    ...
    string private _symbol = "ELONFLOKI";
