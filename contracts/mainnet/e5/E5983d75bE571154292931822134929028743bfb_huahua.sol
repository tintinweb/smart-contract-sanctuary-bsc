...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 DOGE = IERC20(0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E);
...
contract huahua is IERC20, Ownable {
    ...
    string constant _name = "heuheu";
    string constant _symbol = "a";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 1000) / 100000; // 1% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 50000; // 2% of Total supply
    ...
    uint256 public swapThreshold = _totalSupply / 40000; // 0.25%
    bool inSwap;
