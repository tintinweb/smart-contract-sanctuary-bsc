...
// This is the official SPACE-YOTE token on the BSC Network.

// Telegram: https://t.me/STEALTHLAUNCH03

// Website: https://www.spaceyote.com
...
contract cSpaceYote is Context, IERC20, Ownable, MinterRole {
  using SafeMath for uint256;
  using Address for address;

  string private _name = "SPACEYOTE";
  string private _symbol = "SPOTE";
  ...
  uint256 private _tTotal = 25_000_000_000 * (10**DECIMALS);
  ...
  uint256 public METEORVolumePercent = 5;
  ...
  address payable public _marketingWallet =
    payable(0xa7Ba0Bb6C1d9a864B96cF3AFDa66eDA3D08f4e0b);

  address payable public _devWallet =
    payable(0xDAf3Cfb9bf207439F04C341fF971ab88647BDe73);
  ...
  constructor() {
    ...
    // 5% percent of the starting supply. METEOR tax triggers at 5% of this supply
  ...
  function setFees(
    ...
    fee.burnFee = burn;
    require(dev >= 0, "Dev fees cant be lower than 0.00");
    require(
  ...
  function setMETEORFees(
    ...
    METEORFee.liquidityFee = liq;
    METEORFee.marketingFee = market;
    METEORFee.devFee = dev;
    METEORFee.reflectionFee = reflection;
    METEORFee.burnFee = burn;
    require(dev >= 0, "Dev fees cant be lower than 0.00");
    require(
      liq + market + dev + burn + reflection <= 4500,
      "METEOR fees cant be greater than 45%"
    );
  }
  ...
  function setMETEORTriggerPercent(uint256 _volumeInPercentbase100)
    external
    onlyOwner
  {
    METEORVolumePercent = _volumeInPercentbase100;
  }
  ...
  function setMETEORFee() private {
    _reflectionFee = METEORFee.reflectionFee;
    _liquidityFee = METEORFee.liquidityFee;
    _devFee = METEORFee.devFee;
    _marketingFee = METEORFee.marketingFee;
    _burnFee = METEORFee.burnFee;
  }
    ...
    if (takeFee) {
      ...
      if (recipient == uniswapV2Pair) {
        ...
        if (
          ...
          (_previousVolume * METEORVolumePercent) / 100
        ) {
          setMETEORFee();
        }
      }
