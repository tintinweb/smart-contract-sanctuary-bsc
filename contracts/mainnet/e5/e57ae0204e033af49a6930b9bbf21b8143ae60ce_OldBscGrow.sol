...
contract OldBscGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaB652e3762cE7aacdAF771d89F6C9A82598fd469); 
    address payable public Wallet_Dev = payable(0x8A22871b9085185e939596474be5128F8Ac9d3e7);
    ...
    string private constant _name = "OldBscGrow"; 
    string private constant _symbol = unicode"OBG"; 
    ...
    constructor () {
        ...
        _owner = 0x8A22871b9085185e939596474be5128F8Ac9d3e7;
