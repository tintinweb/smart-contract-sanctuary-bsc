...
contract $CAESARINU is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000_000 * 10**9; //
    string private constant _name = "CAESAR INU"; //
    string private constant _symbol = "$CAESAR"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet =  0x40eeb23C0baf901E6882a8C12C627b343f3A2EB7    ;
