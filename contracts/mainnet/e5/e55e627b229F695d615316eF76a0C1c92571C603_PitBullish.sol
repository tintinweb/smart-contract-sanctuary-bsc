...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
        claimWait = 1 hours;
        minimumTokenBalanceForDividends = 10 * 1e9; //must hold 10 tokens to receive dividends
    }
...
contract PitBullish is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address _owner, address _marketingWallet)
        ERC20("PitBullish Inu", "PBI", 9)
    {
        address newOwner = _owner; //make sure to transfer tokens to owner
        uint256 _totalSupply = 1_000_000 * 1e9; //1 million
