...
contract HomoToken is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Homo Finance", "HOMO", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x25B6f3F42cd712B50fc67ec362198f6C5362Bdc8;
        TreasuryReceiver = 0x1563022291B216BDbdAfD3553dFF9fF1cd761eAE;
        RiskFreeValueReceiver = 0x6D29a6b29dEAd73Ec32ee52Bec2Fec19C64cb545;
