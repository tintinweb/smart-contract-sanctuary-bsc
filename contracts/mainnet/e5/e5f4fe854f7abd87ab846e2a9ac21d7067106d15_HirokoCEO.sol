...
contract HirokoCEO is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100 *10**5 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e5 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xFD094C0E4C720083365ADB689952B05414486c05;

    string private constant _name = "Hiroko CEO";
