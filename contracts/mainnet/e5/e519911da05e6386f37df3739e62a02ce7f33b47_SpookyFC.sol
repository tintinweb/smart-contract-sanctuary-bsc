...
contract  SpookyFC  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Football Club"; // 
    string private constant _symbol = unicode"$SPOOKYFC"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x60Ef3cb8e7d8517e3BD35184dB5199f033DDF9b9;
