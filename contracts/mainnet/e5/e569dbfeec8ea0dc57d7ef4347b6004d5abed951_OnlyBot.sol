...
👾Website   : https://only.bot
👾Telegram : https://t.me/onlybotofficial
...
contract OnlyBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Only Bot";
    string private _symbol = "OnlyBot";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xFd2fe9644Bf1E4bDD418D1B9B00A2095fcC5C147);
    address payable public liqWalletAddress = payable(0xFd2fe9644Bf1E4bDD418D1B9B00A2095fcC5C147);
    ...
    uint256 public _walletMax =     480000 * 10**_decimals;
