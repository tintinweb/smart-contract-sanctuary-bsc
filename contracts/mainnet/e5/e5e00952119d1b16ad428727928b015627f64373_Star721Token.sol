...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
	...
	uint256 tokenUserId;
    function mintNftWithUserAddress(address to) public onlyMinter returns (bool) {
		tokenUserId += 1;
        _mint(to, tokenUserId);
        _setTokenURI(tokenUserId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/starNft/star");
        return true;
    }
}
...
contract Star721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("Star chain", "Star chain") {
