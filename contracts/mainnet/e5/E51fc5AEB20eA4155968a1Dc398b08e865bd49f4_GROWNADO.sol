...
/*
成长纳多
一场风暴正在酝酿 Binance Smart Chain
保持或被吹到很远的地方
广告24小时后开始

Medium: https://medium.com/@grownado
Telegram: https://t.me/grownado
*/
...
contract GROWNADO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x46d7a499Aff01c726cc6fBF5C27cE70080017E23); 
    address payable public Wallet_Dev = payable(0x46d7a499Aff01c726cc6fBF5C27cE70080017E23);
    ...
    string private constant _name = "Grownado"; 
    string private constant _symbol = unicode"Grownado"; 
    ...
    constructor () {
        ...
        _owner = 0x4C25dbFdc05e1d6F192cd539C38993686DcF5ac0;
