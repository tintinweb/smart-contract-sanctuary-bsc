...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0xEf590298c8C79E4e261E737Ff450582444E03415;
...
/* Token contract */
contract KingApeSafu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xEf590298c8C79E4e261E737Ff450582444E03415;
    ...
    // Name and symbol
    string constant _name = "KingApe Safu ";
    string constant _symbol = "KAS";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3% or 3B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x73df4a040527491cDFbdcB6051e8791066Fede99;
