...
contract FuryMinerBUSD is ReentrancyGuard {

    using SafeERC20 for IERC20;
    address private tokenAddr = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    IERC20 public token;

	uint256 constant public MIN = 10 ether;
	...
	uint256 constant public REWARD = 1000 ether;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public W_PERIOD = 7 days;
	...
	constructor() {
		ceoWallet = payable(0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4);
		devWallet = payable(0xb02cBb877479a14541A9ef1B2D7b5c286804aE0F);
		topD_round = 0;
	...
	function withdraw() public noReentrant {
		...
		require( (user.cpWithdraw + W_PERIOD) < block.timestamp, "only once a week");
