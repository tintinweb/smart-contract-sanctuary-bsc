...
contract MJR is MJRDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private MJRTeam;
    address private CharityMJR;
    ...
    string public override name = "Major Protocol";
    string public override symbol = "MJR";
    ...
    constructor(uint totalSupplyValue, address MJRTeamAddress, address CharityMJRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        MJRTeam = MJRTeamAddress;
        CharityMJR = CharityMJRAddress;
       
        // split the tokens according to agreed upon percentages
        balances[MJRTeam] =  totalSupply * 4 / 100;
        balances[CharityMJR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MJRTeam pot
