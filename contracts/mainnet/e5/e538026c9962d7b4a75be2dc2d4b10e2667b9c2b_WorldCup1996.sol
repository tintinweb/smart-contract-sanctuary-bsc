...
// *Telegram : https://t.me/worldcup1996official
// 

// SPDX-License-Identifier: MIT
/*
    WorldCup1996 Token
    8% tax for buy and sell - 2% LP 6% marketing wallet!  NO DEV FEES
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD6A1E5C46B540828e198E8b541429dBdb59196f5; // owner address
...
contract WorldCup1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "World Cup 1996";
    string private _symbol = "WC1996";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb96590df1522595Cbf37d0a942ECa82A739B5BE3); // Marketing Address
    address payable public teamWalletAddress = payable(0xb96590df1522595Cbf37d0a942ECa82A739B5BE3); // Team Address
