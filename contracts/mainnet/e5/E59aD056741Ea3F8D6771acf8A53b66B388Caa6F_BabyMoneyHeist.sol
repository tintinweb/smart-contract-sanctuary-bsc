...
|.============[_B_A_B_Y________M_O_N_E_Y_______H_E_I_S_T_]============.|
...
/* Token contract */
contract BabyMoneyHeist is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xCF2eF46a04cD71594CBAfDA27b69968c0C27D74A;
    ...
    // Name and symbol
    string constant _name = "Baby Moneyheist";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 2.5% on launch or 2M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 250 ) / 10000; // 2.5% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCF2eF46a04cD71594CBAfDA27b69968c0C27D74A;
