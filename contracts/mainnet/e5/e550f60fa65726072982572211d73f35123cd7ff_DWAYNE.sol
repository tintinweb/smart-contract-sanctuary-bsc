...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfc90c4a5F0716a37F6Bdfa29225E23a7103a8dcC; // owner address
...
contract DWAYNE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DWAYNE";
    string private _symbol = "DW"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3050DE72E33421Fc0345934cC7cBb1dEB61b3401); // Marketing Address
    address payable public teamWalletAddress = payable(0xadb85048817306a685415DF5FBeEeE624223c592); // Team Address
