...
contract HELPINGSHIBA is ERC20, Ownable {
    ...
    address public advisorWallet = 0x7563eD5F97Af7b63000db05DD499632e5e0C346D;
    address public opsWallet = 0x7FB31a56056C276E0Bb69a005467C4F58f954124;
    address public charityWallet = 0x9aE5155F69Bc6070b89dDF5aD3f32Cf8E982A1F5;    
    address private devWallet = 0x6985d4864221A4c4192D96f49062D537e9753333;
    ...
    Taxes public taxes = Taxes(5, 1, 1, 2, 2, 1);
    Taxes public sellTaxes = Taxes(5, 1, 1, 2, 2, 1);
    ...
    constructor(address routerAdd) ERC20("Helping Shiba", "HEBA") {
        ...
        allowedTransfer[advisorWallet] = true;
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 advisorAmt = unitBalance * 2 * swapTaxes.advisor;
            if (advisorAmt > 0) {
                payable(advisorWallet).sendValue(advisorAmt);
            }
    ...
    function UpdateBuyTaxes(
        ...
        require((_marketing + _advisor + _ops +_charity + _liquidity + _dev) <= 24, "Must keep fees at 24% or less");
        taxes = Taxes(_marketing, _advisor, _ops, _charity, _liquidity, _dev);
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _advisor + _ops + _charity + _liquidity + _dev) <= 24, "Must keep fees at 24% or less");
        sellTaxes = Taxes(_marketing, _advisor, _ops, _charity, _liquidity, _dev);
    }
    ...
    function updateMaxWalletlimit(uint256 maxWallet) external onlyOwner {
        require(maxWallet >= 1_000_000, "Cannot set max wallet amount lower than 0.1%");
    ...
    function rescueBEP20Tokens(address tokenAdd, uint256 amount) external onlyOwner {
