...
contract BusdLottery_V1 is ReentrancyGuard{
    ...
    address private busdminer = 0xB1ffA17D9501BA3165072653d57eAcb6319B47F9;
    address private dev = 0xA294D7AA0356e70084fD40ebCAC8965Ff76FF979;
...
for (uint i=0; i<arrayLength2; i++) {
  ...
  if (participants[i]==ad){
    ...
    function pickwinner() internal {
        ...
        uint256 busdminerFee = SafeMath.div(SafeMath.mul(contractBalance,30),100);
        uint256 devFee = SafeMath.div(SafeMath.mul(contractBalance,0),100);
      
        BusdInterface.transfer(busdminer,busdminerFee);
        uint256 winnerAmount = SafeMath.sub(contractBalance,busdminerFee);
        winnerAmount -= devFee;
