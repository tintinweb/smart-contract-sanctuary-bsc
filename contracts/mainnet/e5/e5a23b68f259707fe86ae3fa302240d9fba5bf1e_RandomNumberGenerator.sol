...
// File: contracts/interfaces/IKnightSwapLottery.sol

pragma solidity ^0.8.4;

interface IKnightSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in KNIGHT per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in KNIGHT token
     * @dev Callable by operator
     */
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public knightSwapLottery;
     ...
     * @param _seed: seed provided by the KnightSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == knightSwapLottery, "Only KnightSwapLottery");
    ...
    /**
     * @notice Set the address for the KnightSwapLottery
     * @param _knightSwapLottery: address of the KnightSwap lottery
     */
    function setLotteryAddress(address _knightSwapLottery) external onlyOwner {
        knightSwapLottery = _knightSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IKnightSwapLottery(knightSwapLottery).viewCurrentLotteryId();
    }
}