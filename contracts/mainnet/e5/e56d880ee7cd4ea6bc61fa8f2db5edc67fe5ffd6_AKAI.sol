...
interface IRouter {
    ...
    address private devWallet = 0x833938727EdedB412d6E747b4353830620Fe95db;
    ...
    Taxes private taxes = Taxes(5, 3, 2, 1);
    Taxes private sellTaxes = Taxes(5, 3, 2, 1);
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateWalletTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        maxBuyLimit = maxBuy * 10**decimals();
        maxSellLimit = maxSell * 10**decimals();
