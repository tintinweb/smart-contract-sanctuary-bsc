...
contract CometCatAI is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x222937f72d82eb060c0A534A0937C7C2d9cF6543;
    address public opsWallet = 0x000000000000000000000000000000000000dEaD;
    address public devWallet = 0x222937f72d82eb060c0A534A0937C7C2d9cF6543;

    string private constant _name = "CometCatAI";
    ...
    Taxes public taxes = Taxes(3, 0, 1, 3, 1);
    Taxes public sellTaxes = Taxes(3, 0, 1, 3, 1);
