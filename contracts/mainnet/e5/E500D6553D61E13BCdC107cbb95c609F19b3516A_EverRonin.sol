...
contract EverRonin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1BE66eFa904dd368B9EB5e7d96f8a6586B5B5987); 
    address payable public Wallet_Dev = payable(0x1BE66eFa904dd368B9EB5e7d96f8a6586B5B5987);
    ...
    string private constant _name = "EVER RONIN"; 
    string private constant _symbol = unicode"EVERONIN"; 
    ...
    constructor () {
        ...
        _owner = 0x1BE66eFa904dd368B9EB5e7d96f8a6586B5B5987;
