...
contract StandardToken is ERC20, Ownable {
    ...
    uint256 initialSupply_ = 22000000000000000000000000;
    string name_ = "MTA";
    string symbol_ = "MTA";
    uint8 decimals_ = 18;
    ...
    address payable protocolFeeTaker = payable(0x20E2A55f0B20D24AB395E8a0D90C6664EF7C0B9E); // Address that gets the protocol fee
