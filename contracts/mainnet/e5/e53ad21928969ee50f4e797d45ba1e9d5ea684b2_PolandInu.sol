...
/**
Telegram : https://t.me/Polandinuportal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC996AC1525dbFbf41c6fB6864587F2Dc9dE56E91; // owner address
...
contract PolandInu is Context, IERC20, Ownable {
    ...
    string private _name = "Poland Inu";
    string private _symbol = "PZPN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC996AC1525dbFbf41c6fB6864587F2Dc9dE56E91); // Marketing Address
    address payable public teamWalletAddress = payable(0xC996AC1525dbFbf41c6fB6864587F2Dc9dE56E91); // Team Address
