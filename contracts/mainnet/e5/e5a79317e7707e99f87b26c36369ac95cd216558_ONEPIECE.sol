...
contract ONEPIECE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB9aAd2e0fb04c8BfCeDf2deCa5A87Ef929D56502); // Marketing Address
    address payable public teamWalletAddress = payable(0x4C42fD843684f20E57dC2308E0F55BE96EB94aBf); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x23cb0B9e6777EB472Bd50eE629e38d4619644Dd3),
            block.timestamp
        );
    }
