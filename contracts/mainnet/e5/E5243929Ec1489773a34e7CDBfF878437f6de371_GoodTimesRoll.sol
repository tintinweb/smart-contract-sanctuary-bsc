...
Telegram :     https://t.me/GoodTimesRollBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x211bD12733ca93fa7C02F0DE381719D114322807;
...
contract GoodTimesRoll is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOOD TIMES ROLL"; // 
    string private constant _symbol = "$GTR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x211bD12733ca93fa7C02F0DE381719D114322807);
