...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x96cC54793b0A796B44fE703F6B5B1eD905e66ac7;
...
contract SETTERINUTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAb4d0aea4081b14ebFAfBecC579A6ef9A300E04A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 65000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Setter Inu Token";
    string private _symbol = "SETTER";
