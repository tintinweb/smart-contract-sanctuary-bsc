...
contract SXKILLER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SXKILLER";
    string private _symbol = "SXKILLER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x993B150d42A7060eEb73475a0c6D7a3B0090b9E1); // Marketing Address
    address payable public teamWalletAddress = payable(0x993B150d42A7060eEb73475a0c6D7a3B0090b9E1); // Team Address
