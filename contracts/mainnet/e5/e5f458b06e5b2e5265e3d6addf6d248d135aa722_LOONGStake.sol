...
contract LOONGStake is Ownable, ReentrancyGuard {
    ...
    address public USDT;
    address public mk = 0x5Aac0B2700C8983E22D8Ca6f14A551268Aaa78F4;
    ...
    function deposit(uint256 _glod) public nonReentrant {
      ...
      if (_glod == 1) {
        ...
        if (superior_1 != address(0) && (_isGoldCardFromFee[superior_1] || _isSilverCardFromFee[superior_1])) {
            ...
            if (_isGoldCardFromFee[superior_3]) {
        ...
        if (superior_1 != address(0) && (_isGoldCardFromFee[superior_1] || _isSilverCardFromFee[superior_1])) {
            ...
            address superior_3 =  _parents[superior_2];
            if (_isGoldCardFromFee[superior_3]) {
                IERC20(USDT).transferFrom(msg.sender, superior_3, PRICE_1.mul(5).div(100));
                amount = amount.sub(PRICE_1.mul(5).div(100));
                _referralBonuses[superior_3].add(PRICE_1.mul(5).div(100));
            }
        }
