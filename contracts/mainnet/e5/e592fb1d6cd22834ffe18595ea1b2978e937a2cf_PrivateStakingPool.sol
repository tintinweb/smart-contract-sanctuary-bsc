...
contract PrivateStakingPool {
    ...
    function checkLockedTokens() internal view returns(uint256) {
        uint256 weeksSinceLaunch = (block.timestamp - timeOfLaunch) / 1 hours;
...
contract AstroX_Test is IBEP20 {
    string constant _name = "AstroX_Test";
    string constant _symbol = "ATX_Test";
    ...
    address public constant CEO = 0x0122ee05E08aAb0a989861e907cE4F18D06F146E;
    ...
    address public marketingWallet = 0xB693ba6bcf166Ec640aE84fB640B2008F28166AA;
