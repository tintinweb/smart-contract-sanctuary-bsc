...
contract MetaPool is LPTokenWrapper, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    uint256 public lpLockDuration = 90 days;
        ...
        checkStart
    {
        ...
        super._stake(amount);
        nftPool.stake(msg.sender, amount);
        ...
        checkLock
    {
        ...
        nftPool.withdraw(msg.sender, amount);
    ...
    function isUnLocked(address account) public view returns (bool) {
        return block.timestamp - stakeTime[account] >= lpLockDuration;
    }

    modifier checkLock() {
        require(isUnLocked(msg.sender), "Unlock time not reached");
        _;
    }
