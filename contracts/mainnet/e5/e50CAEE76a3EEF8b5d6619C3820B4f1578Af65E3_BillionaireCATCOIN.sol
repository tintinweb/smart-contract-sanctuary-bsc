...
BillionaireCATCOIN is a meme token and presented to the community.
...
Telegram Group: https://t.me/BillionaireCATCOIN
Website : https://BillionaireCATCOIN.club
...
contract BillionaireCATCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BillionaireCATCOIN"; 
    string private _symbol = "BillionCatcoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95dD285C4c51e7F75b8fde0cE04EFCDA17FE679A);
    address payable public teamWalletAddress = payable(0x95dD285C4c51e7F75b8fde0cE04EFCDA17FE679A);
