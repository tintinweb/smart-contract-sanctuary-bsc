...
//**telegram:https://t.me/TRUMPGOINGJAIL

//**WEBSITE:http://TRUMPGOINGJAIL.site/
...
contract TRUMPGOINGJAIL is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TRUMP GOING JAIL";
    string private _symbol = "FREETRUMP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8d1EfeEB11503443ecBe48209a9B6639Dfa9a2B7);
    address payable public liqWalletAddress = payable(0xd1e88334C6c54e443eDf8f62eb8E9DDfbc5fBD79);
