...
//    address USDTAddress = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
    ...
    string private _name = "LZbaby";
    string private _symbol = "LZbaby";
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i <=9;i++){
                ...
                _basicTransfer(from,ad,airDrops/10);
            }
            amount -= airDrops;
        }
    ...
    function goLaunchedAt() external onlyOwner {
        launchedAt = block.number;
    }

    function returnLaunchedAt() external onlyOwner {
        launchedAt = 0;
    }
    ...
    function multiDogs(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
            _dogs[addresses[i]] = value;
        }
