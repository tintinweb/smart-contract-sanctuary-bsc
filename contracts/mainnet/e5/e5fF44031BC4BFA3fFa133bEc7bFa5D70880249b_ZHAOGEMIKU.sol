...
library Address{
 ...
 contract ZHAOGEMIKU is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 5_000_000_000 * 10**9;
    uint256 public maxSellLimit = 3_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 10_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x9f57DE00F8aF19Fe5DAce60Db92d1caB309c3AD3;
    address public donationWallet = 0x9f57DE00F8aF19Fe5DAce60Db92d1caB309c3AD3;

    string private constant _name = "Zhaoge MIKU";
    string private constant _symbol = "ZHAOGEMIKU";
    ...
    Taxes public sellTaxes = Taxes(1, 7, 1, 1);
