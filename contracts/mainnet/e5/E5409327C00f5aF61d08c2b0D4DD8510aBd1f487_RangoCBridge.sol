...
contract BaseInterchainContract is BaseProxyContract {
    ...
    function handleDestinationMessage(
        ...
        else if (m.actionType == Interchain.ActionType.WRAP)
            (ok, dstAmount, outToken) = _handleWrap(sourceToken, _amount, baseStorage);
        else if (m.actionType == Interchain.ActionType.UNWRAP)
            (ok, dstAmount, outToken) = _handleUnwrap(sourceToken, _amount, baseStorage);
    ...
    function _handleCall(
        ...
        if (action.preAction == Interchain.CallPreActionType.WRAP) {
        ...
        } else if (action.preAction == Interchain.CallPreActionType.UNWRAP) {
    ...
    function _handleWrap(
        ...
        IWETH(baseStorage.WETH).deposit{value: _amount}();
        emit ActionDone(Interchain.ActionType.WRAP, baseStorage.WETH, true, "");
    ...
    function _handleUnwrap(
        ...
        emit ActionDone(Interchain.ActionType.UNWRAP, baseStorage.WETH, true, "");
...
interface Interchain {
    ...
    enum CallPreActionType { WRAP, UNWRAP, NO_ACTION }
