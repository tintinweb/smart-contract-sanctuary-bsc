...
/** Telegram: https://t.me/AlphaGalaBuy
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x70a7221461Fd56f36d1Be53d5B26d70d7126E347; // owner address
...
contract AlphaGala is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlphaGalaBuy";
    string private _symbol = "AGB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7ff88096838BeCeD25CaB343D2852CAEdb8B74c4); // Marketing Address
    address payable public teamWalletAddress = payable(0x7ff88096838BeCeD25CaB343D2852CAEdb8B74c4); // Team Address
