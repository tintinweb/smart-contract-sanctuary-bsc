...
contract BitSolToken is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xd4B71F7237806ECFd8a428B73119f1703414116C));

    address private liquidityReceiver =
        0xd4B71F7237806ECFd8a428B73119f1703414116C;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "BITSOL";
    string private _symbol = "BITSOL";
    uint8 private _decimals = 9;

    uint256 public _maxTxAmount = _tTotal * 3 / 100; // 2% TOTAL
    uint256 private numTokensSellToAddToLiquidity = 6245* 10**9;
