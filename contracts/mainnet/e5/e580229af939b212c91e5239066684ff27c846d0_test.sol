...
contract test is IBEP20, Auth {
    ...
    constructor() Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0c2EB39f8222dC5B6f792dE345BF1fEDE282Da8C;
        marketingFeeReceiver = 0x0c2EB39f8222dC5B6f792dE345BF1fEDE282Da8C;
    ...
    function checkBot(address sender, address recipient) internal {
        if(block.timestamp < tradingOpenAt + extraTime && !authorizations[sender] && !authorizations[recipient]) {
