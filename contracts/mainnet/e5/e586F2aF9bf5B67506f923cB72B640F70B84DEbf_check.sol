...
contract check is ERC20, Ownable {
    ...
    constructor() ERC20("check Inu", "check") {
        ...
        maxTransactionAmount = 300000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 400000 * 1e18; // 2% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 20) / 10000; // 0.1% swap wallet
		...
		charityWallet = address(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298); // set as charity wallet
