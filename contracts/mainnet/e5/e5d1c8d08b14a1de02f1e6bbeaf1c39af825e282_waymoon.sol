...
contract waymoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MoonWay", "WM") {
    	...
    	marketingWallet = address(0x726Edd2a118928fbFb4E3ce54c048b4e5eE31741); // set as marketing wallet
        charityWallet = address(0x6e722D41e01Fd43343ad965dF58461675FAC2ed7); // set as charity wallet
    	devWallet = address(0x1D89c13A6AB56039A666E6265e9dB1aA17fcfFdc); // set as dev wallet
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    require(newAmount >= totalSupply() * 1 / 150000, "Swap amount cannot be lower than 0.001% total supply.");
  	    require(newAmount <= totalSupply() * 5 / 1500, "Swap amount cannot be higher than 0.5% total supply.");
