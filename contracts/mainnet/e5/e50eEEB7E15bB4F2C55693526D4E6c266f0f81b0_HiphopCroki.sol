...
// HipHop Croki🐊 
// A meme + utility token
// TG: https://t.me/HipHopCrokiChannel
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xE0ED449f728A576C8f85c40b96ce8A1F8728e071);
...
/* Token contract */
contract HiphopCroki is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0xE0ED449f728A576C8f85c40b96ce8A1F8728e071; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb01e7Bf8ad722b0e0a6Bd84e5C239D67A5bFDAFd;
    ...
    // Name and symbol
    string constant _name = "Hiphop Croki";
    string constant _symbol = "HHCROKI";
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 2% of supply, 0.7%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAA976Be95cD952E69A9c975141e245126A5F9775;
