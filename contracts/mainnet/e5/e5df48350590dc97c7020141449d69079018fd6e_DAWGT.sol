...
// $DAWGT is an BEP-20 governance token
// Join us https://dwarfs.digital

/*
 DAWGT holders will be able to claim rewards if they stake their tokens, play the game, 
 and participate in key governance votes. 
 Players will also be able to earn $DAWGT when they play various games 
 within the DAW Metaverse and through user-generated content initiatives.
...
contract DAWGT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x89DcaC23ce625317B3F1DeF9ED5dCE3fB36ab3D4); 
    address payable public Wallet_Dev = payable(0x89DcaC23ce625317B3F1DeF9ED5dCE3fB36ab3D4);
    ...
    string private constant _name = "Dwarf Alt World Gold Token"; 
    string private constant _symbol = unicode"DAWGT"; 
    ...
    constructor () {
        ...
        _owner = 0x89DcaC23ce625317B3F1DeF9ED5dCE3fB36ab3D4;
