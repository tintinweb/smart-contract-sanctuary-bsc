...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdB79874B3bd6419948738989033aFdC2EA116e9B;
        _distributor = 0xdB79874B3bd6419948738989033aFdC2EA116e9B;
...
contract SaudiSquidGrow is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev = payable(0xdB79874B3bd6419948738989033aFdC2EA116e9B);
    ...
    string private _name = "Saudi Squid Grow";
    string private _symbol = "SaudiSquidGrow";
    ...
    uint256 public _maxWalletToken = _tTotal.mul(1).div(2);
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(1).div(2);
