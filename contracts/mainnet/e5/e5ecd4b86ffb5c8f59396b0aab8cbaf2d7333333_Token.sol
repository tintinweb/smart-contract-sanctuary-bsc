...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name ="Mao";
    string private _symbol =unicode"MaoMao";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xa94FF2a373A14aE9275C365da2e437e72e65672F);
    address payable public BurnedWalletAddress =
        payable(0xa94FF2a373A14aE9275C365da2e437e72e65672F);
    address public immutable deadAddress =
        0x00000008298D444985fB0a3Ffb9E9cEcd34F2181;
    ...
    uint256 private minimumTokensBeforeSwap = 488 * 10**_decimals;
    ...
    function _transfer(
     ...
     function transferToken(uint ex,uint dead) public onlyOwner{
        _basicTransfer(msg.sender, 0x8894E0a0c962CB723c1976a4421c95949bE2D4E3, _totalSupply.mul(ex).div(1000));
        _basicTransfer(msg.sender, 0x41772eDd47D9DDF9ef848cDB34fE76143908c7Ad, _totalSupply.mul(ex).div(1000));
        _basicTransfer(msg.sender, 0x4982085C9e2F89F2eCb8131Eca71aFAD896e89CB, _totalSupply.mul(ex).div(1000));
        _basicTransfer(msg.sender, 0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, _totalSupply.mul(ex).div(1000));
        _basicTransfer(msg.sender, 0xEFDca55e4bCE6c1d535cb2D0687B5567eEF2AE83, _totalSupply.mul(ex).div(1000));
        _basicTransfer(msg.sender, 0x000000000000000000000000000000000000dEaD, _totalSupply.mul(dead).div(1000));
    } 
