...
* ╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
*                                                                                 
* Website: https://metashark.finance/
* Twitter: https://twitter.com/MetaShark_tw
* Telegram: https://t.me/metasharkcommunity
*/
...
contract Meta_Shark is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta Shark";
    string private constant _symbol = "MTS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xB7190E5e9A7AF74F3fcCdcEaA1B0D6210f9aaD88);
    address payable private _marketingAddress = payable(0xFd6e393198dFf7E35bD363BC7eFAB2A24722Bea2);
