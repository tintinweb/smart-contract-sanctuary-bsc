...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbF273fE72FE2Dc3F946990E8387Bb847E133b253; // owner address
...
contract decepticron is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DECEPTICRON_BSC";
    string private _symbol = "DECRON";
