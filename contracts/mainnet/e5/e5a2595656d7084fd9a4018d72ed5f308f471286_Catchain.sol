...
contract Catchain is Context, IERC20, Ownable {
    ...
    string private _symbol = "Cat Chain";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x461E4c06eA006c351d7b8e096C10f0058219d1bB);
    address payable public teamWalletAddress = payable(0x8188FC39c6A981D5428280fAE3e1c6642cD664B6);
