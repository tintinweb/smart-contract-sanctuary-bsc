...
contract d is Context, IERC20, Ownable {
    ...
    string private constant _name = "digi"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x54bfDfB26a301017B8eAbFd2B71c91c66159870B).transfer(ethToSend); //marketing wallet
    }
