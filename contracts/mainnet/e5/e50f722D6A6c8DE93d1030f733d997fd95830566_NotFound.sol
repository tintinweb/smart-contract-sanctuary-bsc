...
contract NotFound is IBEP20, Ownable {
    string private constant _name = "+404"; // Name
    string private constant _symbol = "+++"; // Symbol
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 1e9 * 10**_decimals; //Token Decimals
    uint256 public maxHoldAmount = _totalSupply ;
    ...
    constructor() {
        ...
        liquedityReceiver = address(0x9616EE8F785C3e5B7B5E237680EFf80F99B3a250);
        marketFeeReceiver = address(0x9616EE8F785C3e5B7B5E237680EFf80F99B3a250);
        devFeeReceiver = address(0x9616EE8F785C3e5B7B5E237680EFf80F99B3a250);
