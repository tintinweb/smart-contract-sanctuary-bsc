...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD  = IBEP20(0x331226A9D62Be729AdeAD1419Fb99736fd8ae233);
...
/* Token contract */
contract JUST1 is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x331226A9D62Be729AdeAD1419Fb99736fd8ae233; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x224B58Cf320B14a1289B802cAb2A443c518d4444;
    ...
    // Name and symbol
    string constant _name = "JUST 1";
    string constant _symbol = "JUST1";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1 * (10 ** _decimals); // 1

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // MAX Buy 1% 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // Max Sell 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // Max wallet 1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1691124b32E20B27E262f50889b39E749eE8f7E2;
