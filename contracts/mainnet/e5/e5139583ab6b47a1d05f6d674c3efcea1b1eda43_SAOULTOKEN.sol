...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf60B0D946dE66f6b05c31E2A40730191bb46449;
...
contract SAOULTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAf60B0D946dE66f6b05c31E2A40730191bb46449;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SAOUL TOKEN";
    string private _symbol = "SAOUL";
