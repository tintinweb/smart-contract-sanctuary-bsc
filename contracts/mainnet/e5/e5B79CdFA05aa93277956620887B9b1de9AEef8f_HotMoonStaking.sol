...
contract HotMoonStaking {
    ...
    uint256[5] interestRates = [0, 5, 15, 40, 100];
    ...
    function deposit(uint256 _amount, uint8 _pid) public noReentrant {
        require(_amount <= erc20Contract.balanceOf(msg.sender), "Not enough STATE tokens in your wallet, please try lesser _amount");
