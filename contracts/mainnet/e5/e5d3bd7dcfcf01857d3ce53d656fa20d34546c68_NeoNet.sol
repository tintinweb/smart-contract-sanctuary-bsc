...
/**
Telegram : https://t.me/NeoNetOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85f2B1C2b2D66a4Cfa7976a5cE990c92A98ba563; // owner address
...
contract NeoNet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NeoNet";
    string private _symbol = "NEON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85f2B1C2b2D66a4Cfa7976a5cE990c92A98ba563); // Marketing Address
    address payable public teamWalletAddress = payable(0x85f2B1C2b2D66a4Cfa7976a5cE990c92A98ba563); // Team Address
