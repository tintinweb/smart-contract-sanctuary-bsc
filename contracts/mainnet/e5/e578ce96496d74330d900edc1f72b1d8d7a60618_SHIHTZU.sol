...
contract SHIHTZU is IBEP20, Auth {
    ...
    uint256 public _maxTxAmountBuy = _totalSupply * 1 / 1000; // 0.1%
    uint256 public _maxTxAmountSell = _totalSupply * 1 / 1000; // 0.1%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 25 ) / 1000; // 0.25%
    ...
    function setMaxWallet(uint256 maxWallet) external authorized() {
