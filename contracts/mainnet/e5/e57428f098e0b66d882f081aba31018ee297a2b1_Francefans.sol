...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x602BaE0B6ed34269818D8A6422bc1eb7a5Aa387a; // owner address
...
contract Francefans is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "France Fans";
    string private _symbol = "Francefans";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE2037046c7F48852170e2592E9C608cd5aCeD36E); // Marketing Address
    address payable public teamWalletAddress = payable(0x602BaE0B6ed34269818D8A6422bc1eb7a5Aa387a); // Team Address
