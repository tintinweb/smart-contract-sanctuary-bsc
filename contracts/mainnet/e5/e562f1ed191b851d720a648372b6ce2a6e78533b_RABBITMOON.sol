...
contract  RABBITMOON is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**26;
    uint256 public _maxTxAmount = 1000000 * 10**26; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**26; //
    string private constant _name = unicode"RABBIT MOON"; // 
    string private constant _symbol = unicode"RBM"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE9253Ca88B3CcFF4813Aa06FD119B6f679097892;
