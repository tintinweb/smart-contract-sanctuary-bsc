...
contract FuckBro is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuckBro";
    string private _symbol = "$FUCK";
    uint8 private _decimals = 18;
    uint256 public _totalDistributionShares = 2;

    address payable public marketingwallet = payable(0xcb9711E58591FB7Fd1D991FD86fCAB40F231de77);
    ...
    function swapAndLiquify(uint256 tAmount) private swapIsLocked {
        ...
        if(amountETHTeam > 0)
            transferToAddressETH(marketingwallet, amountETHTeam);
