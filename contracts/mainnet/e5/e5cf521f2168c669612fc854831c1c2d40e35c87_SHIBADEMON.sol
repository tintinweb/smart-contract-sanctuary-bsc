...
contract SHIBADEMON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x41C9804F854fB75da76a73798B69a5C80A000BAE); 
    address payable public Wallet_Dev = payable(0x41C9804F854fB75da76a73798B69a5C80A000BAE);
    address payable public constant Wallet_Burn = payable(0x41C9804F854fB75da76a73798B69a5C80A000BAE); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "SHIBA DEMON"; 
    string private constant _symbol = unicode"SDN"; 
    ...
    constructor () {
        ...
        _owner = 0x41C9804F854fB75da76a73798B69a5C80A000BAE;
