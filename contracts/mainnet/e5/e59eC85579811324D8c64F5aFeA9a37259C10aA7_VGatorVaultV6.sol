...
contract VGatorVaultV6 is ERC20, Ownable, ReentrancyGuard {
    ...
    function deposit(uint _amount) public nonReentrant {
        ...
        //     if (users[referrer].deposit=true && referrer != msg.sender) {
        ...
        //     for (uint256 i = 0; i < 3; i++) {
        //         if (upline != address(0)) {
        //             uint256 amount = shares.mul(REFERRAL_PERCENTS[i]).div(
        //                 PERCENTS_DIVIDER
        //             );
    ...
    function getUserDepositInfo(address userAddress) public view returns (bool amount)
    {
    ...
    function withdraw(uint256 _shares) public {
        ...
        want().safeTransfer(msg.sender, totalAmount);
    }
