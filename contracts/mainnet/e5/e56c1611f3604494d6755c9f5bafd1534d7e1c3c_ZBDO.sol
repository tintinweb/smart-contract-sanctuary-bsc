...
contract ZBDO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingAddress =
        payable(0xeC3297Dee4be73014acFeDDEFf6793141ce65d57); // Marketing Address
    ...
    string private _name = "Zoobdoo";
    string private _symbol = "$ZBDO";
    ...
    function setNumTokensForSwap(uint256 _minimumTokensBeforeSwap)
        external
        onlyOwner
    {
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 4;
        _maxSellTxAmount = 10**6 * 10**9;
        _maxBuyTxAmount = 10**6 * 10**9;
    }
