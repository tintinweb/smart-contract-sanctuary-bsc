...
TG: https://t.me/BITGODSMARTCHAIN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB97ac8E0627F68c189a790e55FFe99ca2Ad6763C; // owner address
...
contract BITGODSMARTCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BITGOD SMART CHAIN";
    string private _symbol = unicode"BGSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB97ac8E0627F68c189a790e55FFe99ca2Ad6763C); // Marketing Address
    address payable public teamWalletAddress = payable(0xB97ac8E0627F68c189a790e55FFe99ca2Ad6763C); // Team Address
