 ...
 address[] memory path = new address[](2);     
   ...
   for (uint i = 0; i < LPList.length; i++) {
        ...
        uint256 outPut1 = 0;
            ...
            outPut0 = getAmountOut(IToken(token0).balanceOf(pair) - _reserve0, _reserve0, _reserve1);
            outPut1 = getAmountOut(IToken(token1).balanceOf(pair) - _reserve1, _reserve1, _reserve0);
