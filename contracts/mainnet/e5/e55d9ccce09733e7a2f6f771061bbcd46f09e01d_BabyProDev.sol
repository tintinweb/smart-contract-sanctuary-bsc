...
Telegram: https://t.me/BabyProDevInu
...
contract BabyProDev is IBEP20, Auth {
    ...
    string constant _name = "Baby Prodev Innovations";
    string constant _symbol = unicode"$BabyPro";
    ...
    // Exclude bots
    function Add_Blakcklist(address _address, bool _value) public onlyOwner{
