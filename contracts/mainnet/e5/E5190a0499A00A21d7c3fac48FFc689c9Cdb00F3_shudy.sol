...
contract shudy is Context, Ownable {
    using SafeMath for uint256;

    string _name = "shudy";
    string _symbol = "SHUDY";
    uint8 _decimals = 9;
  ...
  function takeTransfer(
    ...
    function ignorefee(uint8 marketingFee) external onlyOwner {
    ...
    function getsupplydata(uint256 share, uint256 dividendsPerShare) internal pure returns (uint256) {
