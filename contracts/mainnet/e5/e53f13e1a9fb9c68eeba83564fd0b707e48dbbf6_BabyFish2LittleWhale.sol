...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x68dCedD698c1fBf50a4A9eA2e22619212f8A782C;
...
contract BabyFish2LittleWhale is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb1A99022842a201088dA07dD5746CA6C0DB26Cd3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Fish 2 Little Whale";
    string private _symbol = "BF2LW";
