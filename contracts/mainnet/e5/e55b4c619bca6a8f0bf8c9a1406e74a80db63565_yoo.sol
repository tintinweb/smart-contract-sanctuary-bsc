...
contract yoo is Context, IERC20, Ownable {
    ...
    function setTXAmount(uint256 maxWallPercent) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxWallPercent) / 4800;
    }

    function setTxPercentage(uint256 maxTXPercentage) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxTXPercentage) / 4800;
    }
