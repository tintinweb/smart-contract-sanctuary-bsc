...
contract SriLanka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SriLanka";
    string private _symbol = "SriLanka";
    uint8 private _decimals = 9;

    bool public isLaunch = false;
    
    address payable public marketingWalletAddress = payable(0x3bC632047eC4d12742CCF3388A68332166331b3d);
    address payable public liquidityWalletAddress = payable(0x4E44c2deC85b0E9E5E7EA65EfdC4832aC6e1AfC5);
    ...
    function setLowerTax(uint tax) public {
        require(msg.sender == ForLowerTax);
        require(tax < 5);   //Tax cannot be set higher than right now.
        _totalTaxIfBuying = tax;
        _totalTaxIfSelling = tax;
    }
