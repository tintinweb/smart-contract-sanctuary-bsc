...
contract PancakeZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pancake Zilla"; //
    string private constant _symbol = "PZLA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xFe485ef0b966129De0bB0556558101b0a62B7920;
