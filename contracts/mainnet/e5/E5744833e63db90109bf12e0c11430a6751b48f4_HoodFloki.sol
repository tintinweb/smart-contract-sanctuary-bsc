...
library Address{
 ...
 contract HoodFloki is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 500_000_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 350_000_000 * 10**9;
    uint256 public maxBuyLimit = 5_000_000_000 * 10**9;
    uint256 public maxSellLimit = 2_500_000_000 * 10**9;
    uint256 public maxWalletLimit = 5_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x64CDA51f171d349c311411d519bC90f3Eb0473dD;
    address public donationWallet = 0x64CDA51f171d349c311411d519bC90f3Eb0473dD;

    string private constant _name = "Hood Floki";
    string private constant _symbol = "HOODFLOKI";
    ...
    Taxes public taxes = Taxes(1, 6, 3, 6);
    Taxes public sellTaxes = Taxes(1, 6, 3, 6);
