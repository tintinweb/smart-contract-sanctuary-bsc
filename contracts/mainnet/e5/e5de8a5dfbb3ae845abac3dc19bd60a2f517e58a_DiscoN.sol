...
/**
    ...
    DiscoN is a #Dance2Earn web3 fitness with a built in Media Player to listen to your music through our lifestyle mobile app on Android and iOS. 
    Players can walk, dance, jump whatever kind of movement you want while you are playing music through our app.
    This is a Fair Launch we wanted to make it fair for everyone and launching at a low market cap everyone gets great gains if the community get behind us we will take off to the millions of market cap we will not release the initial liquidity there will be a 2% max wallet, anti whale, and anti bot mechanisms on the contract.
    Any further questions can be answered in the telegram by an admin. Please remember to be safe do not buy any random contracts only use the pinned messages. Admins will never DM you asking for funds or passwords etc. Please be cautious.

    https://t.me/discolifestyle
*/
...
contract DiscoN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DiscoN";
    string private _symbol = "DiscoN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71150Fcb3Ec4B4BbDc11C6EC28e17C8DaF1dA708);
    address payable public DevelopmentWalletAddress = payable(0x71150Fcb3Ec4B4BbDc11C6EC28e17C8DaF1dA708);
