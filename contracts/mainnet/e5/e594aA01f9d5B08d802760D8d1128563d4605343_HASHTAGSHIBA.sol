...
/** SHIBA ARMY
Telegram: https://t.me/hashtagshiba

HASHSTAG SHIBA TO THE MOON
...
contract HASHTAGSHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hashtag Shiba";
    string private _symbol = "HTSHIB";
