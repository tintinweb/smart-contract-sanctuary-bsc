...
// File: Factory/Working Files/Farm-Router-Flat.sol
...
interface IFarmageddonFactory {
    ...
    function FactoryFee() external view returns (uint256 factoryFee);
}
...
contract FGRouter is Ownable {
    ...
    constructor(address _factory, address _WETH) {
        factory = _factory;
        WETH = _WETH;
        Factory = IFarmageddonFactory(_factory);
    }
    ...
    function removeLiquidityWithPermit(
        ...
        address pair = FarmageddonLibrary.pairFor(factory, tokenA, tokenB);
        uint value = approveMax ? MAX_INT : liquidity;
    ...
    function swapExactTokensForTokens(
        ...
        amounts = FarmageddonLibrary.getAmountsOut(factory, amountIn, path, Factory.FactoryFee());
    ...
    function swapTokensForExactTokens(
        ...
        amounts = FarmageddonLibrary.getAmountsIn(factory, amountOut, path, Factory.FactoryFee());
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = FarmageddonLibrary.getAmountOut(amountInput, reserveInput, reserveOutput, Factory.FactoryFee());
            }
    ...
    {
        return FarmageddonLibrary.getAmountOut(amountIn, reserveIn, reserveOut, Factory.FactoryFee());
    }
    ...
    {
        return FarmageddonLibrary.getAmountIn(amountOut, reserveIn, reserveOut, Factory.FactoryFee());
    }
    ...
    function getAmountsOut(uint amountIn, address[] memory path)
        ...
        returns (uint[] memory amounts)
    {
        return FarmageddonLibrary.getAmountsOut(factory, amountIn, path, Factory.FactoryFee());
    }
    ...
    function getAmountsIn(uint amountOut, address[] memory path)
        ...
        returns (uint[] memory amounts)
    {
        return FarmageddonLibrary.getAmountsIn(factory, amountOut, path, Factory.FactoryFee());
    }
}