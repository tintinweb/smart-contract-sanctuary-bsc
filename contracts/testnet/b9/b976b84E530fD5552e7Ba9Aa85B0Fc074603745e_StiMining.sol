...
contract StiMining is Ownable {
    ...
    function getUserInPool(address addr_) public view returns(uint[] memory opt){
    ...
    function _takeInvReward(uint pId_, uint reward_, address inviter_) private returns(uint invReward) {
