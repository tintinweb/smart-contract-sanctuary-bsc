...
contract ShopStore {
    ...
    address private allowLogicContractAddress;
    ...
    function setUAddress(address tempAddress_) external onlyLogic {
        uAddress = tempAddress_;
    }

    function getUAddress() external view onlyLogic returns (address) {
        return uAddress;
    }
    ...
    function setCollectionAddress(address tempAddress_) external onlyLogic {
        collectionAddress = tempAddress_;
    }

    function getCollectionAddress() external view onlyLogic returns (address) {
        return collectionAddress;
    }

    function setStakingAddress(address tempAddress_) external onlyLogic {
        stakingAddress = tempAddress_;
    }

    function getStakingAddress() external view onlyLogic returns (address) {
    ...
    modifier onlyLogic() {
        require(msg.sender == allowLogicContractAddress);
        _;
    }

    function setLogicContractAddress(address tempAddress_)
        external
        onlyMinter
        returns (bool)
    {
        allowLogicContractAddress = tempAddress_;
