...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47EDEDEf4A5fAca5c909F4d6F42E0741Fc6e0647;
...
contract LIONE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x47Afa2F66d623e79bEB9357d5143a2C284a99E3A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LIONE";
    string private _symbol = "LIONE";
