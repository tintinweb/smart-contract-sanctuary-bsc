...
contract Prubbnk is Context, Ownable {
    ...
    uint256 private constant maxCompoundMultiplier = 10; //10x of real investment
    ...
    uint256 private constant decreasePercent = 100; //1% yield decrease per withdraw
    uint256 private constant maxYieldPercent = 600; //6%
    uint256 private constant baseYieldPercent = 200; //2%
    ...
    ERC20 private token = ERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
