...
contract OTToken is Context, IERC20, Ownable {
    ...
    string private _name = "OT";
    string private _symbol = "OT";
    ...
    address public mainAddres = address(0x5aa2Ef4CbE3B23F18A1DBA987b88DD3b3072d349);
    address public marketAddress = address(0xe13cF7f614bF5d6Bd502fd803119B9C69f0f9312);
    address public liquidAddress = address(0xB4E8C8f5e84897e25bCDC03ACa7baE860F2e8473);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 20000 * 10 ** 18 
        ...
        _takeLiquidity(sender, tElseFee / 5); // 2%
        _takeBurn(sender, tElseFee / 10);      // 1%
        _takeMarket(sender, tElseFee / 10);   // 1%
