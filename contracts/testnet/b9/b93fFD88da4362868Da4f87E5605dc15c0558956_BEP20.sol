...
contract wTest1 is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    wTest1DividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0xFa2f2D391db925E0001f59b002EEe2BC8F6AF1a1);
    address payable public _buybackWalletAddress = payable(0x4Dd0f96C95a0395bA5b342851438ad87d75BD2E3);
    ...
    constructor() BEP20("wTest1", "wT1") 
    {
        dividendTracker = new wTest1DividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "wTest1: The dividend tracker already has that address");
        wTest1DividendTracker newDividendTracker = wTest1DividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "wTest1: The new dividend tracker must be owned by the wTest1 token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "wTest1: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "wTest1: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "wTest1: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "wTest1: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "wTest1: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "wTest1: Cannot update gasForProcessing to same value");
...
contract wTest1DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("wTest1_Dividend_Tracker", "wTest1_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "wTest1_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "wTest1_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main wTest1 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "wTest1_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "wTest1_Dividend_Tracker: Cannot update claimWait to same value");
