...
contract testing is Context, BEP20 { 
    ...
    address payable public Wallet_Marketing = payable(0x87297fC7E456dC2476FBB3ab8F394CA7A54F61c5); 
    address payable public Wallet_Team = payable(0xa644940280c013ea358B70f37bdEba4AFDecbCf7);
    ...
    string private constant _name = "ContohPertama"; 
    string private constant _symbol = unicode"CPRA"; 
    ...
    constructor () {
        ...
        _owner = 0xa644940280c013ea358B70f37bdEba4AFDecbCf7;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 totalRandom = BEP20(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = BEP20(random_Token_Address).transfer(Wallet_Team, removeRandom);
