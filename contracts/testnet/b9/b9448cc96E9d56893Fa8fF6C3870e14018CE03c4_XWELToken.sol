...
// XWELToken with Governance.
contract XWELToken is BEP20('XWEL-POC Token', 'XWEL-POC', 100000000e18) {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "XWEL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "XWEL::delegateBySig: invalid nonce");
        require(now <= expiry, "XWEL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "XWEL::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying XWELs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "XWEL::_writeCheckpoint: block number exceeds 32 bits");
