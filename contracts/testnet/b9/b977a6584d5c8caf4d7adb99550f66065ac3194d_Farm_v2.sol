...
// File contracts/game/farm/v2/sigGuardian/FarmSigValidator_v2.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.9;

contract FarmSigValidator_v2 {
  ...
  function _hasCorrectClaimId(bytes32 hashDigest, ClaimTokenData calldata claimData)
    internal
    pure
    returns (bool)
  {
  ...
  function _getClaimID(ClaimTokenData calldata claimData) internal pure virtual returns (uint256) {
    return
      uint256(
        keccak256(
          abi.encode(
...
contract FarmSigGuardian_v2 is FarmSigValidator_v2 {
