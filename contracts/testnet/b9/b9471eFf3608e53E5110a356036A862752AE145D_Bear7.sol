...
// Main Contract
contract Bear7 is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Bear Token5';
   string private _symbol = 'BEAR5';
   ...
   // Taxes
   uint256 public burnTaxS  = 4;
   uint256 public burnTaxB  = 0;
   uint256 public treasuryTaxS  = 4;
   uint256 public treasuryTaxB  = 4;
   uint256 public liqTaxS = 2;
   ...
   function _transfer(address sender, address recipient, uint256 amount) internal virtual {
       ...
       for(uint8 i=0; i<botList.length; i++){
           require (sender != botList[i], "Bot Wallet");
       }
