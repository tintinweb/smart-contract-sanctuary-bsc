...
//可加上batch mint
contract ERC721DutchAuctionExample is
    Context,
    Permission,
    ERC721Enumerable,
    ERC721Burnable,
    ...
    PurchaseTime
{
    ...
    function buyNft() external checkInTime{
        _senderPayUsdt(address(this), 100**18);
...
//only manager
    ...
    function pause() external virtual onlyRole(MANAGER_ROLE){
        _pause();
    }

    function unpause() external virtual onlyRole(MANAGER_ROLE){
        _unpause();
    }
