...
Telegram Portal: https://t.me/Hokitoken
Website: https://hokitoken.com
Twitter: https://twitter.com/HOKIToken
...
contract HOKI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xd28657B2e79A829D1bDe7E2878604F7DAB50B10b));
    address payable public _devwallet =
        payable(address(0x13C1A768Cf6D0200b39cbFd973391D6B9610C439));
    address public _exchangewallet =
        payable(address(0x3F1E4C600428656c6776D91f7F23EF6192E967aE));
    address _partnershipswallet =
        payable(address(0xf44e1F02120DDF5e4E127BdCa7107CeA45C375b5));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "HOKI";
    string private _symbol = "HOKI";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**11 * 10**9;
    uint256 public _maxWalletSize = 80 * 10**12 * 10**9;
