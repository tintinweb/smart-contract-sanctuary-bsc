...
contract LaunchpadFactory is Ownable {
    ...
    IDOProjectFactory public projectFactory;
    ...
    function setFactory(IDOProjectFactory _projectFactory, INOProjectFactory _inoFactory) external onlyOwner {
    ...
    function createProject(uint _projectId, address _operator, address _userLevel) external onlyOperator {
        ...
        address _projectAddress = projectFactory.createProject(_projectId, _operator, _userLevel, address(this));
