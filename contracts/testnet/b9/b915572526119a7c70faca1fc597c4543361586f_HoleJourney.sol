...
contract HoleJourney is IERC20, Ownable {
    ...
    mapping(address => bool) private _isExcludedFromPriceLimit;
    ...
    address public _usdtAddress = 0x54a9B7E16345d9C328384Ea915A77b75721f393e;//0x55d398326f99059fF775485246999027B3197955
    ...
    constructor() {
        ...
        _isExcludedFromPriceLimit[msg.sender] = true;
        _isExcludedFromPriceLimit[address(this)] = true;
    ...
    function transfer(address recipient, uint256 amount)public override returns (bool) {
        ...
        if(msg.sender == uniswapV2Pair){
            ...
            //if price below _priceLimit and account not belongs to _isExcludedFromPriceLimit then can't to swap
            require(prices[1]>=_priceLimit || _isExcludedFromPriceLimit[recipient], "SWAP: price is limit");
        ...
        }else if(recipient == uniswapV2Pair && !_isExcludedFromFee[msg.sender]){
            uint256 amounts = amount.div(100).mul(_swapFee);
            _bonusTotal = _bonusTotal.add(amounts);
            _transfer(msg.sender, recipient, amount.sub(amounts));
            _transfer(msg.sender, address(this), amounts);
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function excludeFromPriceLimit(address account) public onlyOwner {
        _isExcludedFromPriceLimit[account] = true;
    }

    function includeInPriceLimit(address account) public onlyOwner {
        _isExcludedFromPriceLimit[account] = false;
    }
    ...
    function isExcludedFromPriceLimit(address account) public view returns (bool) {
        return _isExcludedFromPriceLimit[account];
    }
