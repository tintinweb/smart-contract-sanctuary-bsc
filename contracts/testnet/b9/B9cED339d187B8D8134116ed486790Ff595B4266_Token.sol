...
contract Token is ERC20, PauseOwners {
	...
	function _transfer(
		...
		bool isWalletToWalletTransfer = !senderIsContract &&
			!recipientIsContract;
	...
	function takeFees(
		...
		super._transfer(sender, address(this), walletFeeInTokens);
		swapAndTransferFees(
			walletFeeInTokens,
			developmentFee,
			marketingFee,
		...
		if (liquidityTaxEnabled) {
			...
			super._transfer(sender, address(this), liquidityFeeInTokens);
