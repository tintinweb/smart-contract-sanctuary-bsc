...
contract LFCRO is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "LFCRO";
    ...
    address public marketingWallet = 0xE2914AD733BE8cB7a18232cEeFE4a5ad190a4311;
    address public teamWallet = 0xE2914AD733BE8cB7a18232cEeFE4a5ad190a4311;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newteamFee) external authorized {
        ...
        require(newteamFee <= 2, "Team Tax on buys can not be higher than 2%");
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell, uint256 newteamFeeSell) external authorized {
        ...
        require(newteamFeeSell <= 2, "Team Tax on sells can not be higher than 2%");
