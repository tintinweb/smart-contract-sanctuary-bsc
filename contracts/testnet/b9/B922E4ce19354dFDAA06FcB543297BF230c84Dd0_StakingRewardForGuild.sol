...
contract StakingRewardForGuild is StakeTokenWrapper, Ownable {
   ...
   /**
     ...
     */
    function earned(address account, uint256 guildId) internal view returns (uint256) {
    ...
    function getStakingInfo(address account,uint256 guildId) public view returns (uint256,uint256,uint256){
