...
contract JuneLogic is OwnableUpgradeable, ERC20Upgradeable, Manager {
    ...
    function setDaysConfig(uint256 _mint, uint256 _burn, uint256 _burnFee) public onlyMint {
        DayMintAmount = _mint;
        DayBurnAmount = _burn;
        WithdrawBurnFee = _burnFee;
    }
    ...
    function setSlippageConfig(address value, uint256 min) public onlyManager {
        SlippageAddr = value;
        DividendMin = min;
    }

    function setMarketingRates(uint256 sellRate, uint256 buyRate) public onlyManager {
        sellMarketingRates = sellRate;
        buyMarketingRates = buyRate;
    }
