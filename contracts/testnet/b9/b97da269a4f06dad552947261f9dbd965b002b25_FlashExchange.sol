...
contract FlashExchange is Ownable{
    ...
    // 修改系统配置
    function setting(uint _usdtToNxx, uint _usdtToNxxDenominator, uint _nxxToUsdt, uint _nxxToUsdtDenominator, uint256 _minAmount) public onlyOwner{
        usdtToNxx = _usdtToNxx;
        usdtToNxxDenominator = _usdtToNxxDenominator;
        nxxToUsdt = _nxxToUsdt;
        nxxToUsdtDenominator = _minAmount;
        minAmount = _nxxToUsdtDenominator;
    }
    ...
    function usdtToNxxExchange(uint256 _usdt) public{
        require(_usdt >= minAmount, "once Min usdt");
    ...
    function nxxToUsdtExchange(uint256 _nxx) public{
        require(_nxx >= minAmount, "once Min Newxx");
