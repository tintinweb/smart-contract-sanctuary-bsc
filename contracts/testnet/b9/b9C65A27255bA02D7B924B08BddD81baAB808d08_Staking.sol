...
contract Staking is ReentrancyGuard {
    ...
    function earned(address account) public view returns (uint256) {
        ...
        uint256 currentpercentage = currentBalance/1000*REWARD_RATE;

        
        uint256 currentRewardPerToken =
        (((block.timestamp - s_lastUpdateTime) * currentpercentage * 1e18) / 1000);
        currentRewardPerToken=currentRewardPerToken/86400;
        currentRewardPerToken=currentRewardPerToken/1e18;
        uint256 _earned = currentRewardPerToken;
    ...
    function rewardPerToken() public view returns (uint256) {
        if (s_totalSupply == 0) {
            ...
            return
                ...
                (((block.timestamp - s_lastUpdateTime) * REWARD_RATE * 1e18) / 1000);
        }
    }
    ...
    function claimReward(uint256 amount) external updateReward(msg.sender) {
