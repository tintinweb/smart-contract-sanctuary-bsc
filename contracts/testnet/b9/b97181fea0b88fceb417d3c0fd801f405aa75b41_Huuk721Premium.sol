    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        __Huuk721General_init(name_, symbol_, version_, baseTokenURI_);
    }
    ...
    function __Huuk721General_init(
        ...
        __Huuk721General_init_unchained(baseTokenURI_);
    }
    ...
    modifier verifiedUserGuard() {
        require(
            ...
            "Huuk721General: must have verified role"
        );
        _;
    }
        ...
        returns (string memory)
    {
        require(
            _exists(_tokenId),
            "Huuk721General: URI query for nonexistent token"
        );
    ...
    ) external verifiedUserGuard returns (uint256 tokenId) {
        require(!executed[_nonce], "Huuk721General: duplicated nonce");
        executed[_nonce] = true;
        require(
            _recover(_owner, _tokenURI, _royaltyFee, _nonce, _signature) ==
                _owner,
            "Huuk721General: signer and owner mismatched"
        );
