...
contract HipsterShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HipsterShiba";
    string constant _symbol = "HIPSTER";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**15* (10 ** _decimals); //1 000 000 000 000 000
