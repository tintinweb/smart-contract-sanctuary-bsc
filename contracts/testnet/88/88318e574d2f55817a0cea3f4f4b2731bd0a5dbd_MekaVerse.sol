...
contract MekaVerse is ERC721Enumerable, Ownable {
    ...
    function mint(uint _tokensId) public payable saleIsOpen {

            _mintAnElement(msg.sender, _tokensId);

    }

    function signatureWallet(address wallet, uint256[] memory _tokensId, uint256 _timestamp, bytes memory _signature) public  returns (address){
