...
contract MasterChef is Ownable {
	...
	function updatePool(uint256 _pid) public {
		...
		if(isMint) {
			...
			sphynx.transferFrom(sphynx.owner(), devaddr, sphynxReward.div(100));
			sphynx.transferFrom(sphynx.owner(), address(this), sphynxReward);
		}
	...
	function enterStaking(uint256 _amount, bool ) public {
