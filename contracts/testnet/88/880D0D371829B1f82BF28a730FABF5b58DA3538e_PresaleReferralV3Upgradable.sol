    ...
    UUPSUpgradeable
{
    ...
    function _addReferrer(address _referrer) private returns (bool) {
        ...
        parentAccount.referredAddresses.push(msg.sender);
        emit RegisteredReferer(msg.sender, referrer);

        return true;
    }

    function _addParent(address _parent) private returns (bool) {
        ...
        if (parent == address(0)) {
            ...
            return false;
        } else if (isCircularReference(parent, msg.sender)) {
            emit RegisterRefererFailed(
                msg.sender,
                parent,
            ...
            return false;
        } else if (accounts[msg.sender].parent != address(0)) {
            emit RegisterRefererFailed(
                msg.sender,
                parent,
        ...
        emit RegisteredParent(msg.sender, userAccount.referrer, parent);
