...
=== 'SMART TOKEN' Token contract with following features ===
    => BEP20 Compliance
...
contract SMART is owned {
    
    using SafeMath for uint256;

    string constant private _name = "SMART TOKEN";
    string constant private _symbol = "SMT";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 90000000 * (10**_decimals);
