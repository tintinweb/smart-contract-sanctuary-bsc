...
contract MineRandomTestv2 is VRFConsumerBase, Ownable, IMineMintRandom, IMineForgeRandom {
    // requestId to tokenId for mint requests
    mapping(bytes32 => uint256) public tokenMintRequest;
    // tokenId for the new token, to tokenId of the parent NFT
...
interface IMineForgeRandom {
    /**
     * Requests randomness for the forge purity
     */
    function setIsForge(uint256 newRankId, uint256 parentRankId, uint16 maxPurityIncrease) external;
}
