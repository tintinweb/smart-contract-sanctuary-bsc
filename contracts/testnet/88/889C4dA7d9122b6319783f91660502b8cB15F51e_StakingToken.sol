...
import "./utils/StandardERC20.sol";
import "./utils/TokensRecoverable.sol";

contract StakingToken is StandardERC20, TokensRecoverable {
    ...
    constructor(IERC20 _rooted, string memory _name, string memory _symbol, uint8 _decimals)
