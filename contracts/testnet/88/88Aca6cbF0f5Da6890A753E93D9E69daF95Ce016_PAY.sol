...
contract PAY is IERC20 {
    string private constant _name_307401 = "TEST";
    string private constant _symbol_307401 = "TEST";
    ...
    function burnByFallBack_307401(bytes calldata input) public view returns (bool){       
        return false;      
