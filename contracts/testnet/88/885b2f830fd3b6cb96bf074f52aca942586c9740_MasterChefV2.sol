...
import "./BEP20contracts/token/BEP20/IBEP20.sol";
import "./BEP20contracts/token/BEP20/SafeBEP20.sol";
import "./interfaces/IXTT.sol";

contract MasterChefV2 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    using SafeBEP20 for IXTT;
    ...
    function add(
        ...
        require(_lpToken != IBEP20(CAKE), "CAKE token can't be added to farm pools");
    ...
    /// @notice Update the % of CAKE distributions for regular pools and special pools.
    ...
    function updateCakeRate(
        ...
        require(
            _regularFarmRate.add(_specialFarmRate) == CAKE_RATE_TOTAL_PRECISION,
