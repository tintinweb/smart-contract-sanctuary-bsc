...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a24D15d606cb8CfC4822389E0196d05B7644E8B; // ShakaTestnet
...
contract ShakaTestnet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShakaTestnet";
    string private _symbol = "SHAKANET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a24D15d606cb8CfC4822389E0196d05B7644E8B); // ShakaTestnet Marketing
    address payable public earnWalletAddress = payable(0x7a24D15d606cb8CfC4822389E0196d05B7644E8B); // ShakaTestnet Earning Pool
