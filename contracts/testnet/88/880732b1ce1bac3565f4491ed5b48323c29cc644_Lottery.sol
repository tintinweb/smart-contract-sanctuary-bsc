...
contract Lottery is Initializable, OwnableUpgradeable {
	...
	// Config Prize
	function updatePrizeConfig() public onlyOwner {
		limitPrize[PrizeType.NFT_MAP] = 22;
		limitPrize[PrizeType.PRIZE_ONE] = 8;
		limitPrize[PrizeType.PRIZE_TWO] = 4;
		limitPrize[PrizeType.PRIZE_THREE] = 2;
		limitPrize[PrizeType.PRIZE_FOUR] = 1;
	}

	function updatePrize() public onlyOwner {
		prize[PrizeType.PRIZE_ONE] = 1000;
		prize[PrizeType.PRIZE_TWO] = 500;
		prize[PrizeType.PRIZE_THREE] = 200;
		prize[PrizeType.PRIZE_FOUR] = 100;
	}
	...
	function spinTicketEvent() external onlyNonContract {
		bool prizesLeft = (limitPrize[PrizeType.PRIZE_ONE] > 0) ||
