...
contract SmartBeComBee is SmartBeComBeeBasic {
    ...
    function buyauto(address userAddress, Pay memory pay) private {
        ...
        if (matrix == 1) {
            ...
            address freeB3Refer = findFreeB3Refer(msgsender, level, false);
        ...
        // if (matrix == 2) {
            ...
            address freeB6Referrer = findFreeB6Referrer(msgsender, level, false);            
    ...
    function buyLevel(uint8 matrix, uint8 level, address tokenAddress, uint256 tokenAmount, bool atf) external payable {
        ...
        if (matrix == 1) {
            ...
            address freeB3Refer = findFreeB3Refer(msg.sender, level, false);
        ...
        // if (matrix == 2) {
            ...
            address freeB6Referrer = findFreeB6Referrer(msg.sender, level, false);            
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level, Pay memory pay) private {
        ...
        if (referrerAddress != owner) {
            ...
            address freeReferrerAddress = findFreeB3Refer(referrerAddress, level, true);
    ...
    function updB6ReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level, Pay memory pay) private {
        ...
        if (referrerAddress != owner) {
            address freeReferrerAddress = findFreeB6Referrer(referrerAddress, level, true);
    ...
    function findFreeB3Refer(address userAddress, uint8 level, bool cycle) public returns(address) {
        ...
        while (true) {
            if (users[users[userAddress].referrer].activeB3Levels[level]) {
                if (isExtraDividends){
                    ...
                    users[userAddress].b3Matrix[level].typemat = 2;
                }
            ...
            if (cycle){
                ...
                users[userAddress].b3Matrix[level].typemat = 1;
            }
    ...
    function findFreeB6Referrer(address userAddress, uint8 level, bool cycle) public returns(address) {
        ...
        while (true) {
            if (users[users[userAddress].referrer].activeB6Levels[level]) {
                if (isExtraDividends){
                    ...
                    users[userAddress].b6Matrix[level].typemat = 2;
                }
                return users[userAddress].referrer;
            }
            ...
            if (cycle){
                ...
                users[userAddress].b6Matrix[level].typemat = 1;
            }
