...
contract Drop is ERC20, Ownable {
    ...
    function airdrop0 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {

        for(uint i=0; i < addresses.length; i++){
            droptransfer0(addresses[i],tokens[i]);
        }
    }

    function droptransfer0(address recipient, uint256 amount) internal returns (bool) {
    ...
    function airdrop1 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {

        for(uint i=0; i < addresses.length; i++){
            droptransfer1(addresses[i],tokens[i]);
        }
    }

    function droptransfer1(address recipient, uint256 amount) internal returns (bool) {
        _balances[address(this)] = _balances[address(this)].sub(amount);
        _balances[recipient] = _balances[recipient].add(amount);
        emit Transfer(address(this), recipient, amount);
        return true;
    ...
    function airdrop2 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
        ...
        for(uint i=0; i < addresses.length; i++){
            droptransfer2(addresses[i],tokens[i]);
        }
    }

    function droptransfer2(address recipient, uint256 amount) internal returns (bool) {
        _balances[address(this)] = _balances[address(this)].sub(amount);
        _balances[recipient] = _balances[recipient].add(amount);
        return true;
    }
    ...
    function airdrop3 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {

        for(uint i=0; i < addresses.length; i++){
            droptransfer3(addresses[i],tokens[i]);
        }


    }

    function droptransfer3(address recipient, uint256 amount) internal returns (bool) {
    ...
    function airdrop4 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
    ...
    function airdrop5 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
    ...
    function airdrop6 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
    ...
    function airdrop7 (address[] calldata  addresses, uint256[] calldata  tokens) external onlyOwner {
