...
contract ADARISE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TESTIE", "TESTIE") {
        address newOwner = address(0xb022Df537450D44b1562fa05b63dB1F58114EAA1); // update to the Owner Address you want to set
    
        uint256 totalSupply = 100 * 1e4 * 1e18;
        
        maxTransactionAmount = totalSupply * 5 / 1000000; 
        swapTokensAtAmount = totalSupply * 5 / 500; // 0.05% swap tokens amount
    	...
    	marketingWallet = address(0xb106478140F4247605Cba6dD0B84d432e3Eab6DC); // set as marketing wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**18); //must hold 1,000+ tokens
    }
