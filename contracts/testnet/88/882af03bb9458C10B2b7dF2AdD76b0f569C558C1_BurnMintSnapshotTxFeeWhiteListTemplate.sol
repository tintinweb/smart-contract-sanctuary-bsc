...
// File contracts/templates/BurnMintSnapshotTxFeeWhitelistTemplate.sol
    ...
    PausableWithWhitelistFeature
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, TxFeeFeatureAlt, PausableWithWhitelistFeature) {
