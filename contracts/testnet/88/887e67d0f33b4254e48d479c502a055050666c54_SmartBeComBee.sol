...
contract SmartBeComBee {
    ...
    struct B3 {
        ...
        address[] referrals;
        uint[] typeReferrals;
        mapping(uint => address[]) reinvestReferrals;
        mapping(uint => uint[]) reinvestTypeReferrals;
        uint reinvestCount;
        bool blocked;
    }
    ...
    struct B6 {
        ...
        mapping(uint => address[]) reinvestFirstReferrals;
        mapping(uint => address[]) reinvestSecondReferrals;
        mapping(uint => uint[]) reinvestTypeFirstReferrals;
        mapping(uint => uint[]) reinvestTypeSecondReferrals;
        uint reinvestCount;
        bool blocked;
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        users[referrerAddress].b3Matrix[level].reinvestReferrals[inv] = users[referrerAddress].b3Matrix[level].referrals;
    ...
    function usersB3MatrixReinvest2(address userAddress, uint8 level, uint reinvest) public view returns(address[] memory, uint, uint8) {
        return (users[userAddress].b3Matrix[level].reinvestReferrals[reinvest],
                reinvest, 
                level);
    }
    ...
    function usersB6MatrixReinvest2(address userAddress, uint8 level, uint reinvest) public view returns(address[] memory, address[] memory, uint, uint8, uint[] memory, uint[] memory) {
        return (users[userAddress].b6Matrix[level].reinvestFirstReferrals[reinvest],
                users[userAddress].b6Matrix[level].reinvestSecondReferrals[reinvest],
                reinvest,
                level,
                users[userAddress].b6Matrix[level].reinvestTypeFirstReferrals[reinvest],
                users[userAddress].b6Matrix[level].reinvestTypeSecondReferrals[reinvest]);
    }
