...
contract FFC is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0xD11691164f2dc62f607Eee7B27EeCF160eE268d8);
    
    address public ownerAddres = address(0x630e7EF701dC4BCe5A24A43347c4af1B9C73f618);
    address public devAddress = address(0x53Ae19a1Af3632279A456f95667854D6fAa3c575);
    address public foundAddress = address(0x4d499E56ee2B162cb1C071AFCF82aDc48F8C0D7E);
