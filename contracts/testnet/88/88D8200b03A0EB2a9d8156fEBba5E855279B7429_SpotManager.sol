    ...
    ISpotManager
{
        ...
        onlyOwner
    {
        ...
        emit UpdateMaxFindingWordsIndex(address(this) ,_newMaxFindingWordsIndex);
    }
    ...
    function _internalOpenMarketOrder(
        ...
        emit MarketFilled(
            ...
            passedPipCount,
                remainingLiquidity,
            tickPosition[singleSlot.pip].filledIndex
        );
    }
...
interface ISpotManager {
    ...
    event UpdateMaxFindingWordsIndex(address spotManager, uint128 newMaxFindingWordsIndex);
    ...
    event LimitOrderUpdated(address spotManager , uint64 orderId, uint128 pip, uint256 size);
