...
import "./Fyb3rArtTradable.sol";

contract Fyb3rArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new Fyb3rArtTradable contract
        ...
        returns (address)
    {
        ...
        Fyb3rArtTradable nft = new Fyb3rArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
...
/**
 * @title Fyb3rArtTradable
 * Fyb3rArtTradable - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract Fyb3rArtTradable is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
