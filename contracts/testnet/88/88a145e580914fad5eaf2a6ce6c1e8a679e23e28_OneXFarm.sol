...
contract OneXFarm is Ownable, IERC721Receiver {
  ...
  uint256[] public STAKE_TYPES_DAILY_PERCENTS = [270, 444, 350, 306];
  uint256[] public STAKE_TYPES_TERMS = [0, 27, 40, 72];
