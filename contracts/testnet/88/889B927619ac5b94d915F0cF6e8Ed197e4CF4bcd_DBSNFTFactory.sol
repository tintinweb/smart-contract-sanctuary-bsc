 ...
 * tokens.
 */
contract DBSNFTFactory is FactoryERC1155, Ownable, ReentrancyGuard {
    ...
    function _mint(
        ...
        tradable.mint(_toAddress, _tokenId, _amount, _data);
    }
    ...
    function mintBatch(
        ...
        _batchMint(_ids, _toAddress, _amounts, _data);
    }
    ...
    function _batchMint(
        ...
        DBSNFTTokens tradable = DBSNFTTokens(nftAddress);
        tradable.batchMint(_toAddress, _ids, _amounts, _data);
    }
    /**
        ...
        returns (uint256)
    {
        ...
        DBSNFTTokens nft = DBSNFTTokens(nftAddress);
        uint256 currentSupply = nft.totalSupply(_tokenId);
