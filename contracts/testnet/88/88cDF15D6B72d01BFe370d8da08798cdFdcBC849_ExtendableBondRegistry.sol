...
contract ExtendableBondRegistry is Initializable, Adminable {
    ...
    event GroupCreated(string indexed groupTopic, string groupName);
    event GroupDestroyed(string indexed groupTopic, string groupName);
    event GroupItemAppended(string indexed groupTopic, string groupName, address item);
    event GroupItemRemoved(string indexed groupTopic, string groupName, address item);
    ...
    function createGroup(
        ...
        emit GroupCreated(groupName_, groupName_);
    }
    ...
    function destroyGroup(
        ...
        emit GroupDestroyed(groupName_, groupName_);
    }
    ...
    function appendGroupItem(
        ...
        emit GroupItemAppended(groupName_, groupName_, itemAddress_);
    }
    ...
    function removeGroupItem(
        ...
        for (uint256 i = group.length - 1; i >= 0; i--) {
            ...
            group.pop();
            emit GroupItemRemoved(groupName_, groupName_, itemAddress_);
            break;
        }
    }
