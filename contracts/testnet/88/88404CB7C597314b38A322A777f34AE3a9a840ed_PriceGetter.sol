...
contract StakingVaultV600 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    function depositOperation(
        ...
        require(totalLockDuration <= MAX_LOCK_DURATION, '>mxlck');
    ...
    function setDistributors(address payable _feeDistributor, address payable _rewardDistributor/*, address _feeTracker*/) external onlyOwner {
