...
// Copyright of The Chipino Team (chipinomeshworks.com)
//
// $CHIPI token is based off of the rainbow token project: https://rainbowtoken.finance/ and is
// customized to function in the Chipino DAO.
// 
// $CHIPI has 7% tax split across 7 protocols
// (Sells have doubled tax)
// 
// Red     1%: Burn
// Orange  1%: Buyback
// Yellow  1%: 0.5% reflected to users 0.5% reflected to staking pools
// Green   1%: Charity
// Blue    1%: Liquidity
// Indigo  1%: Marketing
// Violet  1%: Lottery
...
// File @uniswap/v2-periphery/contracts/interfaces/IUn[email protected]
...
// File contracts/ChipiToken.sol                 

pragma solidity ^0.8.4;

/**
 * @dev The official ChipinoToken smart contract
 */
contract ChipinoToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "ChipinoToken";
    string private _symbol   = "CHIPI";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for CHIPI/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xa1Dc622641d0106B56fdBBde5128Abc2475Bfe8F); // Marketing address used to pay for marketing
    ...
    address public _stakingAddress = 0xa1Dc622641d0106B56fdBBde5128Abc2475Bfe8F; // Staking pool
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $CHIPI will be used to buy at maximum in any one trade
    ...
    // STAKING
    uint256 private _stakingPool         = 0;                  // How many reflections are in the lottery pool
    ...
    /**
     * @notice Withdraws non-CHIPI tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function getLotteryTokens() public view returns (uint256) {
        ...
        function getStakingTokens() public view returns (uint256) {
        return tokenFromReflection(_stakingPool);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts CHIPI balance for buybacks, charity, liquidity and marketing
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount) private {
        ...
        // split the reflections in half
        rTransferAmount = rTransferAmount.div(2);

		_rOwned[recipient] = _rOwned[recipient].add(rTransferAmount); 
        _rOwned[_stakingAddress] = _rOwned[_stakingAddress].add(rTransferAmount); 
    ...
    /**
     * @notice Burns CHIPI tokens straight to the burn address
     */
    ...
    function _reflectTokens(uint256 tFee) private {
        uint256 rStaking = tFee.div(2).mul(_getRate()); 
        uint256 rFee = tFee.div(2).mul(_getRate());

        _rTotal = _rTotal.sub(rFee); 
        _totalReflections = _totalReflections.add(tFee);

        // add half of reflections to staking pools
        _stakingPool = _stakingPool.add(rStaking);
    }
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of CHIPI tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from CHIPI)
