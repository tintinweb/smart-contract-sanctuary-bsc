	...
	Pausable
{
	...
	function transfer(uint256 _amount, address _userAddress)
		external
		nonReentrant
		whenNotPaused
		...
		onlyRoleOrOpenRole(transferRole)
	{
		...
		require(owner.amount >= _amount, 'Owner does not have enough tokens');
		UserInfo storage user = userInfo[_userAddress];

		// reduce owner amount
		owner.amount = owner.amount.sub(_amount);
