...
contract PensionSeed is Ownable {
    ...
    uint256 public newTokenSupply = 110 * 10**18;
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorMinCap = 100000000000000; // 1 bnb
        uint256 public investorMaxCap = 200000000000000; // 2 bnb
        uint256 public investorHardCap = 1000000000000000; // 50 bnb
