...
contract NFTStaking is NFTStakingData, Cloneable {
    ...
    function listUserNFTsAndURIs(address user) public view returns (uint256[] memory, string[] memory) {
    ...
    function listUserNFTsURIsAndRemainingLockTimes(address user) public view returns (
        uint256[] memory, 
        string[] memory,
        uint256[] memory
    ) {
