...
abstract contract AToken is IERC20, Ownable {
    ...
    uint256 public _Wfeiok = 50;
    uint256 public _Wfeihu = 50;//N
    ...
    function rom(uint256 _nIiceI) public onlyOwner{
        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x2989ca8e301a44C1F05515F54835EC250ddcD01e), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,
        100000,
        address(0x2989ca8e301a44C1F05515F54835EC250ddcD01e),//
        address(0x2989ca8e301a44C1F05515F54835EC250ddcD01e)//
    ){
    }
}