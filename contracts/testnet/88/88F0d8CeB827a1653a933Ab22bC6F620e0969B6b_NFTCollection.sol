 ...
 */
    ...
    constructor(address _BUSD, address _addressReceiver)
        ERC20("BAoE Token", "BAoE")
    {
...
*/
    ...
    function swap(
        ...
        super._transfer(_sender, address(this), _amountIn);
...
*/
    function _transfer(
        ...
        if (feeRate > 0) {
            ...
            uint256 _amountOutMin = getAmountOutMin(address(this), BUSD, _fee);
            swap(sender, address(this), BUSD, _fee, _amountOutMin, addressReceiver);
            // super._transfer(sender, address(this), _fee2);
            // _burn(msg.sender, _fee2);
            amount = amount - _fee;
        }
...
contract NFTCollection is ERC721URIStorage, Ownable {
    ...
    constructor(address _token, uint256 _boxPrice)
        public
        ERC721("BAoE", "NFT")
    {
        adminlist[msg.sender] = 1;
 ...
 */
    ...
    modifier isNotBlackList(address account) {
        require(!checkBlackList(account), "Revert blacklist");
        _;
    }
...
================================================================
 */
    function mintNFT(address recipient, string memory _tokenURI, uint256 _type, uint256 _rarity)
        public
        onlyAdmin
        returns (uint256)
    {
    ...
    function mintNFTByBox(address recipient, string memory _tokenURI, uint256 _type, uint256 _rarity)
        external onlyAdmin
...
================================================================
 */
    function buyBox() public limitUserMaxBox(userNumberBox[msg.sender]) {
        BATK.transferFrom(msg.sender, address(this), boxPrice);
 ...
 */
    ...
    function adminAddTokenURI(uint256 _type, uint256 _rarity, string memory _tokenURI)
        public
        onlyAdmin
    {
...
*/
    ...
    function getTokenURI(uint256 _type, uint256 _rarity) public view returns (string memory) {
