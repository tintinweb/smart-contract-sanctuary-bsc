...
contract Lottery {
    ...
    uint256 public constant ticketCommission = 10000000000000000; // commition per ticket
    ...
    function getWinningsForAddress(address addr) public view returns (uint256) {
       ...
       function setToken(address _tokenAddress, uint256 _ticketPrice) public isOperator  {
    ...
    function BuyTickets() public payable {
        ...
        require(tokenContract.transferFrom(msg.sender, address(this), numOfTicketsToBuy));
