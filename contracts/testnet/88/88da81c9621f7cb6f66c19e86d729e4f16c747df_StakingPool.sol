...
contract StakingPool is Upgradable {
   ...
   */
    ...
    */
    function withDrawNFT721(address _tokenAddress, address _account, uint256 tokenId)
        external
        onlyAdmins
    {
    ...
    */
    function withDrawNFT1155(address _tokenAddress, address _account, uint256 tokenId, uint256 amount)
        external
        onlyAdmins
    {
