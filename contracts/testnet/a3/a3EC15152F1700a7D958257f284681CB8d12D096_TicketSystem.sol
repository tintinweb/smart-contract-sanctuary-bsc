...
contract TicketSystem is Ownable, ReentrancyGuard {
    ...
    constructor() {
        // Set BUSD address
        setBUSDAddress(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function purchaseTicket(uint256 numberOfTickets) external nonReentrant {
        ...
        require(
            BUSD.balanceOf(_msgSender()) >= totalTicketAmountBUSD,
            "Purchase Ticket: Insufficient busd Balance, Add Funds to Purchase Tickets!"
        );
        BUSD.transfer(_msgSender(), totalTicketAmountBUSD);
    ...
    */
    ...
    function Withdraw() public onlyOwner {
        ...
        BUSD.transferFrom(address(this), owner(), balance);
