...
contract Cyberbunnynft is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Cyberbunnynft", "CY") {}
    ...
    function AdminMint() external Validmint onlyOwner {
        _safeMint(msg.sender, 1);
    }
