...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "NewOneInuVerified";
    string internal constant SYMBOL = "NOINUV";
...
abstract contract NewOneInuVerifiedAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract NewOneInuVerified is NewOneInuVerifiedAbstract {
    constructor() NewOneInuVerifiedAbstract(Env.Testnet) {
