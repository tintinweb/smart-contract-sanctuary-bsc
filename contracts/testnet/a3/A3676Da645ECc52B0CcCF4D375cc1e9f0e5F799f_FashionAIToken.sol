...
contract FashionAIToken is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = 5000001 * 10 ** _decimals; // 1% total supply
    uint256 public maxWalletAmount = 10000001 * 10 ** _decimals; // 2% total supply
    ...
    function launchpad() external onlyOwner {
        sellTaxForMarketing = 3;
        buyTaxForLiquidity = 3;
        maxTxAmount = 5000001 * 10 ** _decimals;
