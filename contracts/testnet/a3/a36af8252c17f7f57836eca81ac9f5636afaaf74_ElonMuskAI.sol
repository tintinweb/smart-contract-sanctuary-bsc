...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TruthGpt = IBEP20(0xCf9A056763857E6798Af1bD5b35d211e6ee9F214);
...
contract ElonMuskAI is IBEP20, Auth {
    ...
    address TruthGpt = 0xCf9A056763857E6798Af1bD5b35d211e6ee9F214;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    function showYourEarnings() public view{
         try distributor.getUnpaidEarnings(msg.sender) {} catch {}
    }

   function showHoldEarnings(address holder) public view{
        try distributor.getUnpaidEarnings(holder) {} catch {}
    }
