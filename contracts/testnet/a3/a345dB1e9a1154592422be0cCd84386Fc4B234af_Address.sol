...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd02171508df382Ae811e0145c9FA84B2173bcCcF;
...
contract POLICORN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb3535d2F960d7Fb6D8c0283749063dAD14b4D412;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "POLI CORN";
    string private _symbol = "PCORN";
