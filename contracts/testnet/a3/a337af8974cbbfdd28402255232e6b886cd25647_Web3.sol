...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 80 * 10 ** IERC20(FISTAddress).decimals();
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 9990 / 10000;
...
contract Web3 is AbsToken {
    constructor() AbsToken(
        ...
        8,//Decimals
        100000,//Supply
        address(0x254A4F90b79a94151c3D7cB67456FB9f341e6b72),//FundAddress
        address(0x100d75de2455789Bb190582328FBEF7e21CE9967)//ReceiveAddress
    ){
