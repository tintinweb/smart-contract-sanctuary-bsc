...
contract MyFootNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function safeMint(address to, string memory tokenURI) public returns(uint256 tokenId) {
