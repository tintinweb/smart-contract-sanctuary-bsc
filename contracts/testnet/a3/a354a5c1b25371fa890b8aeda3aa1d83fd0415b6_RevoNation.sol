...
contract RevoNation{
    ...
    uint256 private _totalSupply = 77000000000000000000000000;
    string private _name = "RevoNation";
    ...
    uint256 private salePrice = 7700;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 997709598;
    }
