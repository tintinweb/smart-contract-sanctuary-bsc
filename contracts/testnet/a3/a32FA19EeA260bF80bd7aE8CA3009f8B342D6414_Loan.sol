...
contract Loan is ERC721Holder, AccessControlEnumerable, ReentrancyGuard {
    ...
    // address public lp = 0xaaA633c8EA5bD06639c679Ee81b9A2Eb95994401;
    // address public token = 0x84892b6107F671cc14d15722e4F5934ca5ceebfB;
    // address public usdt = 0x9948a363C8CD2442156824Fe7600290183588c29;
    // address public medals = 0xf14856a7389B2C6Ec9AadF562Adb0c0CB86079bE;
    // address public gasStake = 0x7FB48a3F743E3443E180Ff0A7049E4abDBD12e4a;

    address public lp = 0x7F9cA3e7e4059753bD6F3B8e45D49fcE7726C92c;
    address public token = 0x9CE5056D5B9CA28aF913607769Bd456d5Ad89d86;
    address public usdt = 0xbd1E08E4d1B8290892c14cF2caA70D63d00b8d71;
    address public medals = 0xD5D33b0cE48D75b39B859e7517F761656c2b6f9e;
    address public gasStake = 0x35c148BfFe435B3b8a1038e1Fbd1D82f08033036;

    uint256 public maxLevel;
    uint256 public creatorRatio = 2e17;  //TODO 分红比例 0.2
    uint256 public gasStakeRatio = 8e17; //TODO 分红比例 0.8
    ...
    function setMedals(address _medals) external onlyRole(OPERATER_ROLE) {
        medals = _medals;
    }
    ...
    function createLoanTeam(address[] memory addrs, uint256 _tokenId) external nonReentrant {
        ...
        require(_checkValid(addrs, msg.sender), "Loan: invalid address!");
    ...
    function redeem(uint256 _groupIndex, uint256 _tokenId) external nonReentrant {
        uint index = _getIndex(msg.sender, _groupIndex);
        require(index > 0, "Loan: invalid groupIndex!");
    ...
    function levelUp(uint256 _groupIndex) external {
        uint index = _getIndex(msg.sender, _groupIndex);
        require(index > 0, "Loan: invalid groupIndex!");
    ...
    function borrow(uint256 _groupIndex, address _addr) external nonReentrant {
        ...
        uint256 amount = config.loanAmount / price;
        IERC20(token).safeTransfer(_addr, amount);
    }

    function repay(uint256 _index) external nonReentrant {
    ...
    function _checkValid(address[] memory addrs, address _msgSender) private view returns (bool) {
    ...
    function _reset(uint256 _index) private view {
        Member[] memory members = teamMember[_index];
        for (uint256 i = 0; i < members.length; i++) {
    ...
    function getBrorrowInfo(address _addr) external view returns (LoanInfo memory) {
        return loanInfos[_addr][loanInfos[_addr].length - 1];
    }
