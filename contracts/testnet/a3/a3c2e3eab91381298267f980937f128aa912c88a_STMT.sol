...
contract STMT is Ownable, IBEP20 {
    ...
    address pancakeAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;      //testnet

    uint256 public gas = 4 * 1 gwei;

    string constant _name = "Stranger Things Meme Token";
    string constant _symbol = "STMT";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xa187256E20C2541831Abd62d66C4b88AfCf6B9F2;
        marketingWallet = 0x239Cc31D5e1225e90AD6BD561aE89772660C557c;
        airdropWallet = 0x239Cc31D5e1225e90AD6BD561aE89772660C557c;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(airFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBairdrop = amountBNB.mul(airFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(airdropWallet).call{value : amountBNBairdrop, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newairFee, uint256 extraSellFee) external onlyOwner {
