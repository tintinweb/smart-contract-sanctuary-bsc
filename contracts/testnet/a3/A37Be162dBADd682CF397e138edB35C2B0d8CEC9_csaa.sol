...
contract csaa is Ownable {
    using SafeMath for uint256;

    string constant public name = 'cssl0525bnb';

    string constant public symbol = 'cssl25';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 80000000*10**uint256(decimals);
