...
contract YiBoxSetting is Ownable {
    ...
    constructor() public {
        ...
        // m_u32ProbabilityL1 = 3000;
        // m_u32ProbabilityL2 = 3000;
        // m_u32ProbabilityL3 = 2000;
        // m_u32ProbabilityL4 = 1000;
        // m_u32ProbabilityL5 = 1000;
    ...
    function calcOpenBox() external onlyGuardian returns (uint256 _lv, uint256 _hr,uint256[2] memory _seed) {
