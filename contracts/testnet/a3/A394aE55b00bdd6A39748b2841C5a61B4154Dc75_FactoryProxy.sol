...
contract UpgradableProxy is Proxy, ProxyOwnable{
    ...
    constructor(address _implementation) ProxyOwnable() {
...
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "../libs/proxy/UpgradableProxy.sol";


contract FactoryProxy is UpgradableProxy{
    constructor(address _implementation) UpgradableProxy(_implementation){
    }
}