...
contract UsdtToCNC is Ownable{
    address public USDT;
    address public usdt2;
    address public SAGToken;
    IdexRouter02 router02 = IdexRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);


    function init(address _SAGtoken, address _USDT, address _router02, address _usdt2) public onlyOwner() {
        SAGToken = _SAGtoken;
        USDT = _USDT;
        usdt2 = _usdt2;
        ...
        IERC20(usdt2).approve(address(router02), uint256(-1));
    }
