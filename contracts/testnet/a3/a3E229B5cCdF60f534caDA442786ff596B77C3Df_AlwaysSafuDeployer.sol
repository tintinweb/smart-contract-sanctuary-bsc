...
contract AlwaysSafuDeployer is Auth {

    constructor(address master) Auth(msg.sender){
        new ALWAYSSAFU(master);
    }
}
...
contract ALWAYSSAFU is ERC20Detailed, Auth {
    ...
    uint256 public swapThreshold = INITIAL_FRAGMENTS_SUPPLY * 800 / 100000;
    ...
    constructor(address _master) ERC20Detailed("ALWAYSSAFU", "SAFE", uint8(DECIMALS)) Auth(msg.sender) {
        ...
        marketingReceiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9; 
        CentralBank = 0x86487b859D42cDDeDE8453c28b402E5F210A8152;
        destructor = 0x4Bd372cf6Cdae4bba4C0Fd9A5534f783c1307d02;
        master = _master;
