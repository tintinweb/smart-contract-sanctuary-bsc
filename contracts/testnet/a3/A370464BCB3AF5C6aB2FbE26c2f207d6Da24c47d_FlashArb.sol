...
contract FlashArb is Ownable {
    ...
    // ACCESS CONTROL
    // Only the `permissionedPairAddress` may call the `uniswapV2Call|pancakeCall` function
    ...
    function uniswapV2Call(
        ...
        pancakeCall(sender, amount0, amount1, data);
    }
