...
contract PawSwap is Ownable {
    ...
    function buyOnPawSwap (
        ...
        swapEthForTokens(ethToSwap, minTokensToReceive, tokenAddress);
    ...
    function sellOnPawSwap (
        ...
        swapTokensForEth(tokensToSwap, minEthToReceive, tokenAddress);
    ...
    function swapEthForTokens(uint256 ethToSwap, uint256 minTokensToReceive, address tokenAddress) private {
    ...
    function swapTokensForEth(uint256 tokenAmount, uint256 minEthToReceive, address tokenAddress) private {
        address[] memory path = new address[](2);
        path[0] = tokenAddress;
