...
contract StakingPool is Upgradable {
   ...
   */
    ...
    */
    function getMaxTVL(uint256 poolDuration, uint256 totalReward) internal view returns(uint256){
        return (totalReward*10**20)/poolDuration;
    }
