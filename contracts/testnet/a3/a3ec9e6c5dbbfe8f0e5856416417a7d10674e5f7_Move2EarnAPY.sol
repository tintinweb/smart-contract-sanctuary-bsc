...
contract Move2EarnAPY is Initializable {
    ...
    // Basic Variables
    address public _liquifier;  // cuurrent - 0x32892BA342cB0C4f3C09b81981d7977965083F31
    address public _stabilizer; // current - 0x5060E2fBB789c021C9b510e2eFd9Bf965e6a2475 wallet
    address public _treasury; // current - 0xcCa3C1D62C80834f8B303f45D89298866C097B1a wallet
    address public _blackHole; // current - 0x1C57a30c8E1aFb11b28742561afddAAcF2aBDfb7
    ...
    function initialize(address owner_) public initializer {
        ...
        _liquidityFee = 400; // should be considered half for bnb/MOVEAPY
