...
contract Mining {
    ...
    uint256 public _tokenPerSecond = _oneToken.div(24).div(60).div(60);
...
contract CBEToken is ERC20, ICBE, Mining {
    ...
    address private constant PANCAKE_ROUTER_ADDRESS = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   // testnet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function activateAccount(address inviter) public payable override {
        ...
        if (_activatedAddress.length >= MAX_MINTER_COUNT) {
            ...
            _mint(_owner, totalSupply().mul(20).div(100)); // mint 20% of total supply for owner
        }
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        ...
        uint256 amountToAddToPool = 0;

        // normal transfer do not need fee
        if (from == pair || to == pair) {
            amountToBurn = amount.mul(BURN_RATE).div(100);
            amountToAddToPool = amount.mul(POOL_RATE).div(100);
