...
// 0xdf7f193D14331c8878D4eC6b2630a1505EB7215a
// StableTokensPoolUpgradeable
contract Box is OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function emitTokenSwapped(uint256 amount1, uint256 amount2) public {
        txIndex += 1;
        emit TokenSwapped(
            msg.sender,
