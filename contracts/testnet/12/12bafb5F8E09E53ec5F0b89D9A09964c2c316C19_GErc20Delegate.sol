...
abstract contract GToken is GTokenInterface, ExponentialNoError, TokenErrorReporter {
    ...
    function accrueInterest() virtual override public returns (uint) {
        ...
        emit TotalBorrowsChanged(totalBorrows, totalBorrowsNew);
    ...
    function borrowFresh(address payable borrower, uint borrowAmount) internal {
        ...
        emit Borrow(borrower, borrowAmount, accountBorrowsNew, totalBorrowsNew, accountBorrowsPrev);
    ...
    function repayBorrowFresh(address payer, address borrower, uint repayAmount) internal returns (uint) {
        ...
        emit RepayBorrow(payer, borrower, actualRepayAmount, accountBorrowsNew, totalBorrowsNew, accountBorrowsPrev); 
        /* We call the defense hook */
        // unused function
...
abstract contract GTokenInterface is GTokenStorage {
     ...
     */
    event Borrow(address borrower, uint borrowAmount, uint accountBorrows, uint totalBorrows, uint accountBorrowsPrev);

    /**
     * @notice Event emitted when a borrow is repaid
     */
    event RepayBorrow(address payer, address borrower, uint repayAmount, uint accountBorrows, uint totalBorrows, uint accountBorrowsPrev);
    ...
    /**
     * @notice Event everytime totalBorrows is changed
     */
    event TotalBorrowsChanged(uint totalBorrows, uint totalBorrowsNew);
