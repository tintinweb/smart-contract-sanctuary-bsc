...
contract Pool is Ownable {
    ...
    function withdrawToken(
        ...
        require(!_usedNonce[_msgSender()][nonce], "Pool:Nonce has used");
        ...
        require(
            ...
            "Pool: Signature incorrect"
        );

        uint256 poolContractBalance = ZODIBO(token).balanceOf(address(this));
        if (poolContractBalance < amount) {
            return;
        }
