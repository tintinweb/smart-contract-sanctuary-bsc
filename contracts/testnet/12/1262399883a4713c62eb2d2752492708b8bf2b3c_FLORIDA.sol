...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public RWRD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract FLORIDA is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    string constant private _name = "FLORIDA";
    string constant private _symbol = "FRIDA";
    ...
    FloridaDividendTracker public dividendTracker;
    uint256 public gasForProcessing = 300000;
    address public RWRD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // Reward Token
    ...
    constructor () {
        ...
        dividendTracker = new FloridaDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FloridaDividendTracker newDividendTracker = FloridaDividendTracker(payable(newAddress));
...
contract FloridaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Florida Reward Tracker", "FloridaDividendTracker") {
    	claimWait = 3600;
