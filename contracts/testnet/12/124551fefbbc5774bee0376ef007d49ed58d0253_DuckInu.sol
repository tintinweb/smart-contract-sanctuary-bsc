...
contract DuckInu is IERC20, Auth {
    ...
    string private constant  _name = "DuckInu";
    ...
    uint256 public addLiquidFee = 3;
    uint256 public buyFeeRate = 6;
    uint256 public sellFeeRate = 8;

    uint256 private feeDenominator = 100;

    address payable public marketingWallet = payable(0x32e1BC224B9fCB2a97E48d8Eb69eEa0dd8ec7fb2);
    ...
    bool private inSwap;
    bool public enableAddLiquid = true;
	...
	function _distributeTaxEth(uint256 _amount) private {
		marketingWallet.transfer(_amount);
	}
