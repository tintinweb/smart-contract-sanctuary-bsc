...
contract CryptoCricketToken is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    // tokenomics
    uint256 public MAX_MG_REWARDS = 5 * 10**6 * 10**decimals();
    uint256 public MAX_FC_REWARDS = 5 * 10**6 * 10**decimals();
    uint256 public MAX_MCG_REWARDS = 50 * 10**6 * 10**decimals();
    uint256 public MAX_STAKING_REWARDS = 10 * 10**6 * 10**decimals();
    uint256 public MAX_TEAM_REWARDS = 13 * 10**6 * 10**decimals();
    uint256 public MAX_OTHER_REWARDS = 17 * 10**6 * 10**decimals();
    // year wise minting schedule
    uint256 public MG_REWARDS_PER_YEAR = 5 * 10**5 * 10**decimals();
    uint256 public FC_REWARDS_PER_YEAR = 5 * 10**5 * 10**decimals();
    uint256 public MCG_REWARDS_PER_YEAR = 5 * 10**6 * 10**decimals();
    uint256 public STAKING_REWARDS_PER_YEAR = 1 * 10**5 * 10**decimals();
    uint256 public TEAM_REWARDS_PER_YEAR = 65 * 10**5 * 10**decimals();
    uint256 public OTHER_REWARDS_PER_YEAR = MAX_OTHER_REWARDS;

    uint256 mintingStartdate = 0;
    uint256 mintedMGRewards = 0;
    uint256 mintedFCRewards = 0;
    uint256 mintedMCGRewards = 0;
    uint256 mintedStakingRewards = 0;
    uint256 mintedTeamRewards = 0;
    uint256 mintedOtherRewards = 0;

    constructor() ERC20("CryptoCricket Token", "BALL") {}
    ...
    function maximumRewards() external view returns (uint256) {
        return
            MAX_MG_REWARDS +
            MAX_FC_REWARDS +
            MAX_MCG_REWARDS +
    ...
    function mintRewards(
        ...
        require(mintingStartdate > 0, "Minting has not yet begun");
    ...
    function getCurrentYear() internal view returns (uint256) {
        uint256 duration = block.timestamp - mintingStartdate;
        return (duration / SECONDS_IN_YEAR) + 1;
    }

    function startMinting() external onlyOwner {
        require(mintingStartdate == 0, "Minting has already commenced");
        mintingStartdate = block.timestamp;
    }
}
