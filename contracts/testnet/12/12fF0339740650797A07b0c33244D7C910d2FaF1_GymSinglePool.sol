...
// all initialize parameters are mandatory
    ...
    */
    function _claim(
            ...
            if (pending > 0) {
                ...
                IGymMLM(relationship).distributeRewards(distributeRewardTokenAmt, address(tokenAddress), msg.sender, 3);
    ...
    */
    ...
    function _claimAll(bool reinvest,uint8 reinvestPeriodId) private {
        ...
        IGymMLM(relationship).distributeRewards(distributeRewardTokenAmtTotal, address(tokenAddress), msg.sender, 3);
