...
contract SmartBeComBeeBasic {
    ...
    event Blocked(address indexed user, uint8 matrix, uint8 level);
        event Blocked2(address indexed user, uint8 matrix, uint8 level, bool blk);
...
contract SmartBeComBee is SmartBeComBeeBasic {
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level, Pay memory pay) private {
        ...
        emit Blocked2(referrerAddress, 1, level, !users[referrerAddress].activeB3Levels[level+1]);
