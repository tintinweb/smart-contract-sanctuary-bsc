...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
  function mint(uint256 amount) public onlySupplyController returns (bool) {
   ...
   */
  function burn(uint256 amount) public onlySupplyController returns (bool) {
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    require(!frozen[owner] && !frozen[spender] && !frozen[msg.sender], "address frozen");
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    function claimOwnership() public {
     ...
     /**
     * @dev Reclaim all XX token at the contract address.
     * This sends the xx tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimToken() external onlyOwner {
        address owner = owner();
        address contractAddr = address(this);
        uint256 _balance = _balances[contractAddr];
        _balances[contractAddr] = 0;
        _balances[owner] = _balances[owner].add(_balance);
        emit Transfer(contractAddr, owner, _balance);
    }
