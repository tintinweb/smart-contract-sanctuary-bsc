...
contract AA_Ref_Test is Context, IERC20 { 
    ...
    // Token Info
    string private  _name = "Ref_Test";
    string private  _symbol = "REFTEST";
    ...
    */
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool Fee) private {
        ...
        // Check for fee and calculate all fee values
        if (Fee){
        ...
        rTransferAmount = tTransferAmount * RFI;
