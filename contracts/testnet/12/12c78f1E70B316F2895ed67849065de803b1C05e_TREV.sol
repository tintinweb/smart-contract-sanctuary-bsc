...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // CHANGE - TESTNET BUSD rewards
    address WFTM = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // CHANGE - TESTNET BNB
    ...
    constructor (address _router) {
        ...
        : IUniswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // CHANGE - router
        _token = msg.sender;
    }
...
contract TREV is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // CHANGE - Busd rewards
    address public WFTM = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // CHANGE - BNB wrapped
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TestRewards";
    string constant _symbol = "TREV";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals); // 1 Billion tokens created
    ...
    address public autoLiquidityReceiver=0x0657771fc16E325efd8888Ad05890514fE50fbAc; //liq address
    address public marketingFeeReceiver=0x0657771fc16E325efd8888Ad05890514fE50fbAc; // marketing address
    ...
    uint256 public TwentyFourhours = 600000000;

    mapping(address => user) public tradeData;

    constructor () Auth(msg.sender) {
        address _router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // CHANGE - Router
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // CHANGE - Router
        //bool isBuy=sender== pair|| sender == routerAddress;
        bool isSell=recipient== pair|| recipient == routerAddress;
        
        // Seller can sell only 10% of his holdings ONCE every X hours!
        if (!isSell && !_isFree[recipient]){
            require(amount <= _maxTxAmount, "ERR: Max tx exceeding max available amount");

            uint blkTime = block.timestamp;
          
            uint256 onePercent = _balances[sender].mul(txfee).div(100); // 1% of senders balance
            ...
            if( blkTime > tradeData[sender].lastTradeTime + TwentyFourhours) {
                ...
                require(tradeData[sender].tradeAmount + amount <= onePercent, "ERR: Can't sell more than 10% in one day");
