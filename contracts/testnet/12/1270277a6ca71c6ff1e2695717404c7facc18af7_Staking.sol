...
contract Staking is Owned {
    ...
    uint256 public stakingRate = 50; // 50%
    uint256 public totalStakes;

    address public ATGX = 0x49c0252A9402d07F6e909968563CD628bbEbA966;
    ...
    function ClaimReward() external {
        ...
        require(IERC20(ATGX).transfer(msg.sender, _pendingReward));
    ...
    function StopStaking() external {
        ...
        require(IERC20(ATGX).transfer(msg.sender, _activeDeposit));

        totalStakes = totalStakes.sub(_activeDeposit);
    ...
    function _newDeposit(uint256 _amount) internal {
        if (users[msg.sender].activeDeposit > 0) {
            ...
            require(
                IERC20(ATGX).transferFrom(msg.sender, address(this), _amount)
            );
        }
    }
    ...
    function _addToExisting(uint256 _amount) internal {
        ...
        require(IERC20(ATGX).transferFrom(msg.sender, address(this), _amount));
        // update global stats
        totalStakes = totalStakes.add(_amount);
    }
}