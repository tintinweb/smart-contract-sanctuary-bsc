...
contract CrossChainManagerRemote is
    ...
    function _nonblockingLzReceive(
        ...
        (address fromSale,,,,,,) = abi.decode(_payload, (address, address, uint32, uint256, uint128, uint128, bool));

        (bool success,) = fromSale.call(abi.encodeWithSelector(IGovSaleRemote.receiveCall.selector, _payload));
