...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(REWARDSTOKEN);
    ...
    function setREWARDSTOKEN (address newdefault) external override onlyToken {
    REWARDSTOKEN = newdefault;
...
contract DividendDistributor1 is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(REWARDSTOKEN);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
 ...
 contract DividendDistributor2 is IDividendDistributor {
    ...
    IBEP20 DOGE = IBEP20(REWARDSTOKEN);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
...
// BIG POPPA BTC DIVIDEND DISTRIBUTOR
 contract DividendDistributor3 is IDividendDistributor {
    ...
    IBEP20 BTC = IBEP20 (REWARDSTOKEN);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
...
// BNB FEES ARE COLLECTED HERE GUYS 
    ...
    function setREWARDSTOKEN (address newdefault) external authorized {
    distributor.setREWARDSTOKEN(newdefault);
    }
     function setREWARDSTOKEN1 (address newdefault) external authorized {
    distributor1.setREWARDSTOKEN(newdefault);
    }
     function setREWARDSTOKEN2 (address newdefault) external authorized {
    distributor2.setREWARDSTOKEN(newdefault);
    }
     function setREWARDSTOKEN3 (address newdefault) external authorized {
    distributor3.setREWARDSTOKEN(newdefault);
