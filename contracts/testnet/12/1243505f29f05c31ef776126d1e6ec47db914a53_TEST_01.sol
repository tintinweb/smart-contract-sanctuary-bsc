...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function Sell_Price_Impact_Tiers__Percentage_Multiplied_by_100() external view returns (
                ...
                uint Price_Impact1,
                uint Price_impact2,
                string memory Info_About_Impact1,
                string memory Info_About_Impact2,
                string memory) {

                Price_Impact1 =  price_impact1;
                Price_impact2 =  price_impact2;

                string memory Impact1_Info;
                string memory Impact2_Info;

                string memory Message_0;
                string memory Message_3;

                if (price_impact1 != 0) {Impact1_Info = "Price Impact1 feature is enabled";} 
                else {Impact1_Info = "Price Impact1 feature is NOT used";}
                Info_About_Impact1 = Impact1_Info;

                if (price_impact2 != 0) {Impact2_Info = "Price Impact2 feature is enabled";} 
                else {Impact2_Info = "Price Impact2 feature is NOT used";}
                Info_About_Impact2 = Impact2_Info;

                Message_0 = "Bla bla";
                Message_3 = "Bla bla bla"; 

                return(Message_0, Price_Impact1, Price_impact2, Info_About_Impact1, Info_About_Impact2, Message_3);
        }
