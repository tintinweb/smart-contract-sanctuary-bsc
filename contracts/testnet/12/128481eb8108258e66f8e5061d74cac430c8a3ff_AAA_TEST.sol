...
contract AAA_TEST is Ownable  {
    ...
    // update mapping for CA when time is extended
    mapping (address => address) private LP_CA;
    ...
    function Token_Information(address Contract_Address) public view returns(
        ...
        address LP_Address = LP_CA[Contract_Address];
        ...
        return (BEP20(Contract_Address).name(),
                BEP20(Contract_Address).symbol(),
                _Website[LP_Address],
