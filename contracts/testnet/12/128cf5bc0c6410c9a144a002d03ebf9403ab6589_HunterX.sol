...
import "./HuntDividendTracker.sol";
import "./SafeMath.sol";
...
import "./HuntStorage.sol";

contract HunterX is ERC20, Ownable {
    using SafeMath for uint256;
    using HuntStorage for HuntStorage.Data;
    ...
    HuntStorage.Data private _storage;
    ...
    HuntDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HunterX Inu", "$HINU") {
        ...
        _storage.dividendTracker = new HuntDividendTracker(payable(address(this)), address(_storage.pair), _storage.router.WETH());
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        _storage.dividendTracker = HuntDividendTracker(payable(newAddress));
