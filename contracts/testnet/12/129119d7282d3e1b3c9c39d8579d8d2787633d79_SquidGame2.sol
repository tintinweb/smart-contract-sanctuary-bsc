...
/**
Telegram: https://t.me/squidgametwo
Website: Coming soon
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfa8CebD69D993Ad5A258dd9b1380390172f6404F; // owner address
...
contract SquidGame2 is Context, IERC20, Ownable {
    ...
    string private _symbol = "SG2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60F53e9479CC74dFF95d946c9536f52e52635dF1); // Marketing Address
    address payable public teamWalletAddress = payable(0xfa8CebD69D993Ad5A258dd9b1380390172f6404F); // Team Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x02Be5f1c16fFF5a4d2Cd1f8Ca6BAE7fa235f7E8e); 
