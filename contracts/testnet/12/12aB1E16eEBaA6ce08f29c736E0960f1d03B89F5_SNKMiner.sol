...
contract SNKMiner is LPTokenWrapper {
    ...
    uint256 private mintTotalRewards = 0;
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            uint256 mintReward = reward.mul(17).div(75);
            if (mintReward > 0) {
                token.safeTransfer(feeAddress, mintReward);

                mintTotalRewards = mintTotalRewards.add(mintReward);
            }
        ...
        )
    {
        ...
        return (starttime, stoptime, totalSupply(), left, mintTotalRewards);
    }
        ...
        returns (uint256)
    {
        ...
        return totalBalances.sub(maxBalances);
    }
