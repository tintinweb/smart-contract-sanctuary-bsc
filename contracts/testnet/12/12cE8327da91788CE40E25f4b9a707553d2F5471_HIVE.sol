...
contract HIVE is Context, IERC20, IERC20Metadata, Ownable {
     ...
     * construction.
     */
    constructor(address operateAccount_, address lockAccount_) {
        _name = "HIVE Token";
        _symbol = "HIVE";
        _lockAccount = lockAccount_;

        _mint(operateAccount_, 150000000000000000000000);
        _mint(lockAccount_, 850000000000000000000000);
    }
