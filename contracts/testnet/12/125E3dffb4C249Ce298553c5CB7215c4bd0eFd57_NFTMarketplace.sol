...
contract NFTMarketplace {
    ...
    event NftAuctionBidPriceCreated(
        address nftContractAddress,
        uint256 tokenId,
        uint256 bidPrice,
        address nftBidder
    ...
    event NftAuctionBidPriceUpdated(
        address nftContractAddress,
        uint256 tokenId,
        ...
        isSaleResetByOwner(_nftContractAddress, _tokenId)
    {
        ...
        emit NftFixedSaleCancelled(_nftContractAddress, msg.sender, _tokenId);
    }
        ...
        )
    {
        ...
        emit NftAuctionBidPriceCreated(_nftContractAddress, _tokenId, _bidPrice, msg.sender);
    }
        ...
        )
    {
        ...
        emit NftAuctionBidPriceUpdated(
            nftContractAddress,
            tokenId,
            finalBidPrice,
            msg.sender
        ...
        isbidNotMakeTillNow(_nftContractAddress, _tokenId)
    {
        ...
        emit NftAuctionSaleCancelled(_nftContractAddress, _tokenId, msg.sender);
    }
        ...
        isAuctionOver(_nftContractAddress, _tokenId)
    {
        ...
        emit NftBidWithdrawed(_nftContractAddress, _tokenId, msg.sender);
    }
