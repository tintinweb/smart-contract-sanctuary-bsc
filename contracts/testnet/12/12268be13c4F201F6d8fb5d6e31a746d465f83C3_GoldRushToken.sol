...
contract GoldRushToken is Context, IERC20, Ownable {
  ...
  function setMaxTxAmount(uint256 amount) external onlyOwner() {
    require(amount > 0, "Max tx amount should be over zero");
    maxTxAmount = amount;
  ...
  function setFarmPool(address poolAddress) external onlyOwner {
    emit UpdateStakingPool(farmPool, poolAddress);
