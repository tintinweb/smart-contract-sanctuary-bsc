...
/**
Token Name: Sheepa Inu
Symbol: SHEEPA 
Total Supply: 100,000,000
Taxations
5% Marketing (in BNBs)
3% Liquidity
2% Development (in BNBs)
...
contract SheepaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Sheepa Inu";
    string private _symbol = "Sheepa";
    ...
    address payable public devWallet = payable(0x67f7fFF86b5AB08EeC870aFb5E72AF8113166A7B); // 4
    address payable public marketingWallet = payable(0x5Cea5Cc09E749f1f52eBA56d5F666B7CD770DD4A); //5 
...
// Anti Bot functions
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForMarketing = contractTokenBalance.mul(_marketingFee).div(_liquidityFee.add(_marketingFee).add(_devFee));
