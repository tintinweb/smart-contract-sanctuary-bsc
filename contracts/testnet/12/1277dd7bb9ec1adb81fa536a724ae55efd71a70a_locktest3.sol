...
contract locktest3 is Initializable, OwnableUpgradeSafe, PausableUpgradeSafe {
    ...
    * @dev initialize
    */
    function initialize(address payable _treasuryAddr, address payable _stakingAddr)
    external
    {
        treasuryAddr = _treasuryAddr;
        stakingAddr = _stakingAddr;
        depositFee = 0.05 ether;
        feeDividend = 400; // will divide by 1000 to get % value
    ...
    */
    ...
    returns (uint256 _id)
    {
        ...
        if(takeFee){
            require(msg.value >= depositFee.mul(_amounts.length));
        }
    ...
    */
    ...
    /*take fee or not*/
    function changeFeeStatus(bool _takeFee) onlyOwner public {
        takeFee = _takeFee;
    }
