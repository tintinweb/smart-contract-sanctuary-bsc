...
contract ireward is Context, Ownable, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    string private _name = "i-reward";
    string private _symbol = "i-reward";
    uint8 private _decimals = 18;
    uint256 private _totalSupply;
    uint256 public _taxSell = 0;
    uint256 public _taxBuy = 0;
    ...
    constructor() {
        ...
        _mint(_msgSender(), 1000000000000000000 * 10**uint256(_decimals));
    }
