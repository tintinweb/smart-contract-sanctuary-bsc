...
contract Crowd {
	...
	constructor() public {
        ...
        owner = msg.sender;
        plans.push(Plan(60, 200, 2e21, 6e22, 80));    //Crowd Leader plan
        plans.push(Plan(45, 100, 2e20, 6e21, 40));    //Crowd Manager plan
        plans.push(Plan(28, 80, 1e18, 12e20, 20));    //Crowd Troopers plan
        plans.push(Plan(90, 300, 6e22, 1e25, 200));   //Crowd Ambassador plan
