    ...
    ERC721Burnable
{
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(_baseURI(), uriPool[memberPassLevel[tokenId]])
            );
    }
    ...
    function mintNFT(uint256 amount, uint256 memberLevel)
        public
        payable
        mintStartedOnly
    ...
    function whitelistMintNFT(uint256 amount, uint256 memberLevel)
        public
        payable
        mintStartedOnly
        validMemberLevel(memberLevel)
    ...
    function ownerMintNFT(uint256 amount, uint256 memberLevel)
        public
        onlyOwner
        mintStartedOnly
        validMemberLevel(memberLevel)
    ...
    function setWhitelistMintPrice(uint256[] memory _whitelistMintPrice)
        public
        onlyOwner
    {
    ...
    function setMaxAmountPerAddress(uint256 _maxAmountPerAddress)
        public
        onlyOwner
    {
