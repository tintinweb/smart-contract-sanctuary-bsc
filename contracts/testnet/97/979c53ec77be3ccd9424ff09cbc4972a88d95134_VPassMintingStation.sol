...
// File contracts/IVPass.sol

pragma solidity ^0.8.4;

interface IVPass is IERC721Enumerable {
...
// File contracts/VPassMintingStation.sol

pragma solidity ^0.8.4;


contract VPassMintingStation is AccessControl {
    IVPass public vpass;
    ...
    function changeOwnershipNFTContract(address _newOwner) external onlyOwner {
        vpass.transferOwnership(_newOwner);
    }
}