...
contract UNQ is ERC721A, Ownable{
    ...
    event UpdateBlackList(address account, bool value);
    constructor() ERC721A("Unique", "UNQ", 1) {
        saleIsActive = true;
    }
    ...
    function updateBlacklist(address _account) public onlyOwner{
        blacklist[_account] = !blacklist[_account];
        emit UpdateBlackList(_account, blacklist[_account]);
    }
