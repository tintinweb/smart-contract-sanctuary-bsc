...
contract TresLechesCC is IBEP20, Auth {
    using SafeMath for uint256;
    address public CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //CAKE Address
	//address public TresLechesCake = 0x106FEFf621a395043b21a602D4b6a2039e16bBeC; //Tres Leches Cake
    ...
    address public DEV = 0x1D1dc3B5C1e52D22C7AC22c109386A0E48Ad3113; // Development Wallet
...
//Variables have been defined now we move on the rest of the configuration	
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _charityFeeReceiver) external authorized {
