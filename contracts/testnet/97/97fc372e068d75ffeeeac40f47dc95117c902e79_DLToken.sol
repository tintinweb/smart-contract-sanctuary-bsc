...
contract DLToken is IERC20, Ownable {
    //用于存储每个地址的余额数量
    ...
    constructor(string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, address DividendAddress) {
        ...
        //BSC PancakeSwap 路由地址     0x10ED43C718714eb63d5aA57B78B54704E256024E
        _swapRouter = ISwapRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);       //0xB6BA90af76D139AB3170c7df0139636dB6120F7e    
        // 0x55d398326f99059fF775485246999027B3197955
        usdt = address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);                  //0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb                           
