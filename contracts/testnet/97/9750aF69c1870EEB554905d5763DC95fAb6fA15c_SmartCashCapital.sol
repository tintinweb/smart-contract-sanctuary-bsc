...
contract SmartCashCapital is Context, Ownable {
    ...
    function getContractInfo() view external returns(uint256 totalUsers, uint256 userCompounds, uint256 totalDeposited, uint256 totalCompounded, uint256 totalWithdrawn) {
