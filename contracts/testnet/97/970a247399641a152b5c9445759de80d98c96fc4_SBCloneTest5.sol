...
contract SBCloneTest5 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SBCloneTest5";
    string private constant _symbol = "SBCT5";
    ...
    address private charityAddress = 0x5736E2F48361bFCE4934e052B15F39aF9Eb28b03;
    address private communityAddress = 0x5736E2F48361bFCE4934e052B15F39aF9Eb28b03;
    ...
    constructor() {
        ...
        distribution = Distribution(20, 20, 20, 20, 20);
    ...
    function sendETHToFee(uint256 amount) private lockTheSwap {
        ...
        uint256 communityShare = distributionEth.mul(distribution.community).div(100);
        ...
        payable(communityAddress).transfer(communityShare);
    }
