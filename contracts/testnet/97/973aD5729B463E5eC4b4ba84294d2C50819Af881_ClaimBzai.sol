...
contract ClaimBzai is Ownable,ERC721Enumerable, ReentrancyGuard {
    ...
    event NFTReset(address indexed user,uint256 indexed nftId, string vestingType, uint256 amount);
    ...
    function resetNFT(uint256 tokenId) external onlyOwner{
        ...
        _publicVestingAmount[tokenId] = [0,0,0,0];
    ...
    function setPrivateVesting(address _user, uint256 _amount) external onlyOwner {
        ...
        _privateVestingAmount[nftId][0] = claimablePart;
    ...
    function setPublicVesting(address _user, uint256 _amount) external onlyOwner {
        ...
        _publicVestingAmount[nftId][0] = claimablePart;
        _publicVestingAmount[nftId][1] = claimablePart;
        _publicVestingAmount[nftId][2] = claimablePart;
        _publicVestingAmount[nftId][3] = claimablePart + modulo;

        emit AllocSetted(_user, "public", _amount);
    }
    ...
    function withdrawUnassigned() external onlyOwner{
        uint256 _amount = balanceOf(address(this)) - assigned;
