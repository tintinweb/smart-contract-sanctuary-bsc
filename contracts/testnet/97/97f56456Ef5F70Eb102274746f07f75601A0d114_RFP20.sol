...
/*contract DividendPayingToken is BEP20,DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
 ...
 function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      bool success = BEP20(ETH).transfer(user, _withdrawableDividend);
...
contract RFP20 is BEP20{
    ...
    uint256 public swapTokensAtAmount = 300000000 * (10**18); //0.1%
    ...
    address public _developmentWalletAddress = 0xee4FbdF874E7aD3F28d24Ef4b3b24358A47D88Df;
     address public _charity = 0xee4FbdF874E7aD3F28d24Ef4b3b24358A47D88Df;
   ...
   constructor()  BEP20("REWARD FOR PASSION", "RFP-TEST") {

    	//dividendTracker = new RFPDividendTracker();
    ...
    //	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //mainnet
     ...
     //   IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  //testnet
      ...
      /*  dividendTracker.excludeFromDividends(address(dividendTracker));
       ...
       // excludeFromFees(uniswapV2Router, true);
   ...
   /* function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "RFP: The dividend tracker already has that address");

        RFPDividendTracker newDividendTracker = RFPDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "RFP: The new dividend tracker must be owned by the RFP token contract");
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
      ...
      function setMinimumSwapToken(uint256 minSwapToken) external{

          swapTokensAtAmount = minSwapToken;
    ...
    function setETHRewardsFee(uint256 value) external onlyOwner{
            require(value<=5,"Max liquidity Exceeded");
        ETHRewardsFee = value;
    ...
    function setMarketingFee(uint256 _marketingFee) external onlyOwner{
        require(_marketingFee<=5,"Max Marketing Exceeded");
    ...
    function setSwapTokenAmount(uint256 swap) external {
        swapTokensAtAmount = swap*(10**18);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "RFP: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "RFP: Cannot update gasForProcessing to same value");
...
*/
  ...
  //  }
        ...
        
        {
           ...
           uint256 charity = balanceOf(address(this));
        ...
        if(takeFee) {
           ...
           // super._transfer(from, address(_marketingWalletAddress), fees);
           // super._transfer(from, address(_developmentWalletAddress), fees);
            
               super._transfer(from, address(this), fees*3);
...
/*contract RFPDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("RFP_Dividen_Tracker", "RFP_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override pure{
        require(false, "RFP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "RFP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RFP contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "RFP_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "RFP_Dividend_Tracker: Cannot update claimWait to same value");
