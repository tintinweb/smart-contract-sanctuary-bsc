...
contract pipi is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x24be8DE0D813a36F20B704C8966aD00b37aCDc24));
        marketingWalletAddress = payable(address(0x90E127BFD5b3b2D1e36b02F43452C510a44ea4c4));
