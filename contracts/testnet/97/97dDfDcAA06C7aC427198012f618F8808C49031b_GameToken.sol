...
/**
 * @dev This contract was copied from OpenZeppelin library 4.5.2. The only change is make _balances variable `internal`
 * to be able to access it from _transferBatch() function on GameToken.
 */
