...
contract Skwidd  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Skwidd';
    string private constant _symbol = 'skrd';
    ...
    bool swapping; 
    bool botOn = false;
    uint256 swapThreshold = ( _totalSupply * 300 ) / 10000000;
    uint256 _minTokenAmount = ( _totalSupply * 15 ) / 10000000;
