...
contract AltcoinsOnline is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 26 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Altcoins Online";
    string private _symbol = "AOL";
    ...
    uint256 public _maxTxAmount = 26 * 10**5 * 10**9;
