...
contract AndromedaMiner is Context, Ownable {
    ...
    function sellEggs() public {
        ...
        soldEggs[msg.sender]=soldEggs[msg.sender]+SafeMath.sub(eggValue,fee);
    }
    ...
    function showRate() public view returns(uint256) {
        return calculateEggBuySimple(1000000000000000000)/1080000*94/100;
    }
