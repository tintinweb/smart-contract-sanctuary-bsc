...
contract MetaverserItems is  IMetaverserItems,ERC1155Burnable,ERC1155Pausable,Ownable{
    ...
    constructor() ERC1155("https://assets.metaverser.me/Items-v2/token-{id}.json") {
        name = "Metaverser Items V.02";
        symbol = "MITM2";
    ...
    function mint(address to, uint256 amount,string memory _name) public onlyAccessable{
     ...
     function _beforeTokenTransfer(
        ...
        bytes memory data
    ) internal override(ERC1155Pausable,ERC1155) virtual {
        if( !holders[to] ){
