...
contract Token is IERC20 {
    ...
    uint256 public _one;
    uint256 public _twenty;
    uint256 public _forty;
    ...
    function setTargets() public onlyOwner {
        ...
        target_buy = price.add(price * (_one / _twenty));
        target_sell = price.add(price * (_one / _forty));
    }
    ...
    function adjustTargets() private {
        target_sell = target_sell.add(target_buy * (_one / _forty));
        target_buy = target_buy.add(target_sell * (_one / _twenty));
    }
