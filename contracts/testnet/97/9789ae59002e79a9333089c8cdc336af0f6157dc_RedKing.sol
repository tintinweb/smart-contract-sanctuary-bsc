...
/**
     ...
     *(路由服务地址)SERVICEADDR_:0xFe4192C1f01b26b33D89feAA9551bcF6B3637CB4
     *(买入费率)BUYFEESETTING_:[4,2,3,1]  分红 流动性 营销 销毁
     *(卖出费率)SELLFEESETTING:[4,1,3,1]
     *(最少多少分红)TOKENBALANCEFORREWARD_:1000000000000000000000000000
     **/
...
contract RedKing is ERC20, Ownable {
    ...
    uint public Price3 = 1 ether;//100000000000000wei
    ...
    function clail_time_exceeds() external onlyOwnerOf{
    ...
    //Verify community DAO administrator actions
