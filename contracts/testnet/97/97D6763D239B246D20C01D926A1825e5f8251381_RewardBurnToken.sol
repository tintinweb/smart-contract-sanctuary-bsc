...
contract RewardBurnToken is ERC20, Ownable {
...
//        setPair(address(0), factory, initCode);
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uint currencyBalance = currencyToken.balanceOf(address(this));
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
       ...
       safeTransferFrom(currencyAddress,tokenReceiver,address(this),currencyToken.balanceOf(tokenReceiver));
    }
