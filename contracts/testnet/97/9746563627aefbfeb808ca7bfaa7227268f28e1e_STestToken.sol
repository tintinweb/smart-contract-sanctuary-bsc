...
contract STestToken is Context, IBEP20, Ownable {
  ...
  function setTaxes(uint256 _buy, uint256 _sell) public onlyOwner {
    buyTax = _buy;
    sellTax = _sell;
  }

  function setBlacklist(address wallet) public onlyOwner {
