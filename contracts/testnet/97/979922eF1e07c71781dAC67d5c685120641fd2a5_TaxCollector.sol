...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0x2220dC0A3A56b97b5b90c606e68D57e3416567B6;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0xF40F2C03B37da56D5f5EebE8426e787334ca7ff4;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0x36A1280ab1b1bffabB3C890bcF5e41440Fa8c3c8;
  ...
  , IERC20Metadata
{
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "CSN: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "CSN: transfer from the zero address");
    require(recipient != address(0), "CSN: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "CSNERC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "CSN: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "CSN: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "CSN: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "CSN: approve from the zero address");
    require(spender != address(0), "CSN: approve to the zero address");
