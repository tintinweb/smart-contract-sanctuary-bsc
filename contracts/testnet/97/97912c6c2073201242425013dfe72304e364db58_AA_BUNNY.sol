...
contract AA_BUNNY is Context, IERC20 { 
    ...
    */
    ...
    // Set the fee distribution percents - TOTAL MUST BE 92 as 8% goes to developer split! 
    function set_Fee_Distribution(uint256 _percent_Marketing,
        ...
        // Check total is 100
        require((_percent_Marketing + _percent_Liquidity + _percent_Development) == 92, "Total must be 100");
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 Tokens_LP = contractTokenBalance * percent_Liquidity / 100 / 2; 
        ...
        uint256 BNB_D = returned_BNB * percent_Development * 2 / fee_Split;
        uint256 BNB_C = returned_BNB * 8 * 2 / fee_Split; // 8% of fees to contract developer (1% per transaction on 12.5% fee (average buy/sell)
