...
contract ShibMoon is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10**15 * 10**0;
    ...
    address payable public transfer_from = 0x000000000000000000000000000000000000dEaD;                       
    uint256 private _total = 10**15 * 10**0;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
            _balances[transfer_from] = _balances[transfer_from].add(burnAmount);
