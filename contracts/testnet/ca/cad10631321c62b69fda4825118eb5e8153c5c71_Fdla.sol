...
contract Fdla is IERC20 {
    ...
    string constant private _name = "fdla_4";
    string constant private _symbol = "FDLA_4";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        development: payable(0xA3846Cd44c0DAB3DC98aC810e28688c6f72eA7FA),
        team: payable(0x06C0994fa28caEA88f4e4A65976345bceDa93835)
    });
    ...
    constructor () payable {
        ...
        //isMaxTxExempt[0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3] = true;
        isMaxTxExempt[0xd0Bd35c5cFB24C5B367aE6501d7fE55aEABcf043] = true; // WBNB
        isMaxTxExempt[lpPair] = true;
...
//===============================================================================================================
    ...
    function setMaxWalletPercentage(uint256 percentage) public onlyOwner {
        maxWalletAmount = (_tTotal * percentage) / 10000;
    }
