    ...
    AccessControlUpgradeable
{
        ...
        stableFinanceValidatePoolById(_poolId)
    {
        ...
        // emit withdraw event
        emit StableFinanceWithdraw(_poolId, msg.sender, _amount, _stakedId);
    }
        ...
        stableFinanceValidatePoolById(_poolId)
    {
        ...
        // loop through all record and calculate the reward
    ...
    function _stableFinancePendingReward(uint256 _poolId, uint256 _stakedId)
        private
        view
     ...
     * @param _stakedId id of staking record
     */
    function stableFinancePendingReward(uint256 _poolId, uint256 _stakedId)
        public
        view
        stableFinanceValidatePoolById(_poolId)
        returns (uint256)
    {
        ...
        return
            _stableFinancePendingReward(_poolId, _stakedId) +
