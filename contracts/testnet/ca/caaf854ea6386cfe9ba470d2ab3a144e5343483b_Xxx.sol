...
contract Xxx is ERC20, ERC20Detailed, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    */
    ...
    constructor (address to) public ERC20Detailed(_name, _symbol, 18) {
        ...
        // _mint(to, _numTokens * (10000 ** uint256(decimals())));  // minting all supply to one address
    ...
    */
    ...
    function changeTransferLimit(uint256 _limit) onlyOwner public minLimit(_limit) {
