...
//减产机制 0-1.5年 10000 ，1.5-3年 8000 ，3-4.5年 5.12，4.5后4.096 
  function Reduceproduction()public view  returns(uint256)  {
    ...
    function _deposit(address _user, uint256 _amount) private { 
        ...
        if(user.count==1){
           require(_amount>=100*1e18&&_amount<=1000*1e18,"100-1000 for the first ");
        }
        if(user.count==2){ 
           require(_amount>=100*1e18&&_amount<=1500*1e18,"100-1500 for the second ");
        }
        if(user.count==3){ 
           require(_amount>=100*1e18&&_amount<=2000*1e18,"100-2000 for the third ");
        }
