...
// File: contracts/PaymentGatewayFactory.sol


pragma solidity >=0.8.14;


contract PaymentGatewayFactory is Owner {
  address[] public gateways;

  event ContractCreated(address gateway);

  function create(string memory name, address owner) public isOwner {
    PaymentGateway gateway = new PaymentGateway(name, owner);
