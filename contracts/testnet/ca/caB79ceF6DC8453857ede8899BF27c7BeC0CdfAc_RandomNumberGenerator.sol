...
contract RandomNumberGenerator is VRFConsumerBaseV2,IRandomNumberGenerator {
  ...
  function fulfillRandomWords(
   ...
   /**
     * Requests randomness from a user-provided seed
     */
    function generatorRandomNumber() external override onlyLottery{
        requestRandomWords();
    }
     ...
     * Views random result
     */
    function viewRandomResult() external override view returns (uint256[] memory){
