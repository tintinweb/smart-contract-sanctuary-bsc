...
contract FitrBlinkBox is ERC721URIStorage, Ownable, ReentrancyGuard {
     ...
     * public mint from 1001 - 5000 (5000 max supply)
     **/
    ...
    uint256 public immutable maxPublicMint = 5000;
     ...
     * max supply 4000, no limit on # of tokens
     */
    function publicMint()
        public
        payable
