...
contract foodfilpstaking is Ownable {
    ...
    function withdraw(uint256 _plan) public {
        ...
        uint256 preReward;{
            ...
            require(amount>0,"Insufficient Tokens Staked");
            ...
            user.totalStakedlp[_plan] -=amount;
        ...
        returns (uint256 _reward)
    {
        ...
        _reward = users[_user].lpStakes[_plan].amount*timeelapsed*tokenReward[_plan]/percentdivider;
    }
