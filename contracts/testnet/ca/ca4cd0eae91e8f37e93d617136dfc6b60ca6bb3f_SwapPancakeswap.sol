...
contract SwapPancakeswap is Ownable{
    ...
    constructor() Ownable() {
        //IERC20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684).approve(address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3), type(uint256).max);
        //IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).approve(address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3), type(uint256).max);
    }
    ...
    function tradeFromBNBToToken(uint256 amountOutMin, address[] calldata path, uint256 deadlineOffset) external payable onlyOwner{       
        ...
        // Es posible que no haga falta hacer un value: msg.value en la llamada si hago antes un:
    ...
    function tradeFromBNBToToken2(uint256 amountOutMin, address[] calldata path, uint256 deadlineOffset) external payable onlyOwner{       
        require(path.length >= 2, "Length of path needs to be 2 at least");
        
        // Es posible que no haga falta hacer un value: msg.value en la llamada si hago antes un:
        IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).transferFrom(msg.sender, address(this), msg.value);
        //IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).transfer(address(this), msg.value);
