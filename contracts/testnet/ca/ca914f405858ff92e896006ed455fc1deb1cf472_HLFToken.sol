...
contract HLFToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**6 * 10**9;//发币数量 1000    000 000   000 000 000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "lfhung Token";//合约名称
    string private _symbol = "HLF";//代币符号
    uint8 private _decimals = 9;//合约精度
    ...
    uint256 public _maxTxAmount = 5000  * 10**6 * 10**9;//5000 000   000 000   000 000 000
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**6 * 10**9;//到达一定数量把代币添加到流动性池子
    ...
    constructor () public {
        ...
        // 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F  路由v1地址
        // 0x10ED43C718714eb63d5aA57B78B54704E256024E  路由v2地址
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6CE77ca7E5ABC29C7E1b7D2adAC9E754110C30bc);//路由合约修改  确保这个合约地址存在否则部署报错
