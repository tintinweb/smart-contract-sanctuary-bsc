...
/**
 * WMLM = The integrated Finance Token
 * A new type of contract that designed and implemented by WMLM Community
 */
contract WMLM is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "WMLM";
    string private constant _SYMBOL = "WMLM";
    ...
    uint256 private _tTotal = (10**10) * _DECIMALFACTOR; // Total supply: 1 Quadrillion
    ...
    uint256 public RECV_CHARGE = 100; // 1%
    uint256 public BUY_RATE = 100; // 1%
    uint256 public SELL_RATE = 100; // 1%
