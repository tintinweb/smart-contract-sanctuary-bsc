...
contract Token is Context, IERC20 {
    ...
    constructor (string memory  na, string memory  sy, uint8 de, uint total,address market,address ow) payable {
        _name=na;
        _symbol=sy;
        _decimals=de;
        marketingWalletAddress=payable(market);
        teamWalletAddress=payable(market);
        _totalSupply=total*10**_decimals;
        _maxTxAmount=_totalSupply;
        _walletMax=_totalSupply;
        address msgSender = ow;
        ...
        _balances[ow] = _totalSupply;
        emit Transfer(address(0),ow, _totalSupply);
    }
