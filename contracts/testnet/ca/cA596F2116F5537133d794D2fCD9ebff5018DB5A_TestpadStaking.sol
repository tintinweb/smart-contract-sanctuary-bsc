...
contract TestpadStaking is Ownable, IStakingLockable {
  ...
  function updateUserApr(address account) internal {
    UserInfo storage user = userInfo[account];
    if(user.amount < 100000000000){
      user.apr = 0;
    }else if(user.amount >= 100000000000 && user.amount <= 300000000000){
      user.apr = 5;
    }else if(user.amount > 300000000000 && user.amount <= 600000000000){
      user.apr = 10;
    }else if(user.amount > 600000000000){
      user.apr = 15;
    }
  }
