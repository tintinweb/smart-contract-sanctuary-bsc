...
contract MVTPToken is ERC20, AccessControl {
    ...
    address private _marketingWallet; // 营销钱包
    address private _lpPool; // ?流动性池
    ...
    function _transferFromUniswap(
        ...
        address user;
        // 这个函数只有在买或卖才调用，所以必然有一个地址等于用户
        // 不会出现两个地址都等于 uniswap 的情况
