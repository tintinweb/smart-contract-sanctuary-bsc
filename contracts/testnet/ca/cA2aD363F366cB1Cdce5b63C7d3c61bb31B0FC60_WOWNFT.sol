...
contract WOWNFT is ERC721, Pausable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://FILL_YOUR_URL_HERE";
    }
     ...
     */
    function addListing(uint256 _price, uint256 _tokenId) private onlyOwner {
     ...
     */
    function safeMint(address _minter, uint256 _price) external onlyOwner returns(uint256) {
    ...
    function buy(address _receiver, uint256 _tokenId, uint256 _price) payable public whenNotPaused {
        ...
        uint256 finalPrice = tokens[_tokenId] + getBNBFee(); // NFTPrice + 0.95 USD
