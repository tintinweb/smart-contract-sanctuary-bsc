...
contract BSG is Ownable{
    ...
    mapping(address => uint256) public withDraw_;
    ...
    function withdraw() external {
        ...
        // uint256 withDraw_[msg.sender] = Total[msg.sender] * maximunwithdraw;
        if(withdrawable > withDraw_[msg.sender])
        {
            remainingReward[msg.sender] = withdrawable.sub(withDraw_[msg.sender]);
            withdrawable = withDraw_[msg.sender];
        }
        else
        {
    ...
    function _deposit(address _user, uint256 _amount) private {
        ...
        withDraw_[msg.sender] = Total[msg.sender] * maximunwithdraw;
