...
contract DelegationOrder is Ownable {
    ...
    address private _MerchantStorage;  
    address _OrderAddr;
    address _recordAddr;
    ...
    function authFromContract(
        ...
        _MerchantStorage = _merchantStorage;
    ...
    function addBuyDelegation(
        ...
        require(MerchantStorage(_MerchantStorage).getPledgeStatus(msg.sender), 
...
/*
    function modify(
        ...
        uint _itype,
        string memory _terms,
        string memory _legal_currency_name     
    ) external payable{
        ...
        _payFee("modify");
        _record.totalCount = _total_money;
        _record.pay_type = _pay_type;
        _record.max_money = _max_money;
        _record.min_money = _min_money;
        _record.price = _price;
        _record.itype = _itype;
        _record.terms = _terms;
