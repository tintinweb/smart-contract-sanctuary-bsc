...
/**
    Telegram : https://t.me/SilkRoadSquid
*/
...
contract SilkRoadSquid is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SilkRoadSquid";
    string private _symbol = "SilkRoadSquid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBF26Dce522b0c4158490E82B4Fa742151EC97205); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xBF26Dce522b0c4158490E82B4Fa742151EC97205); // Development Address
    ...
    uint256 public _walletMax = 2 * 10**4 * 10**9;
