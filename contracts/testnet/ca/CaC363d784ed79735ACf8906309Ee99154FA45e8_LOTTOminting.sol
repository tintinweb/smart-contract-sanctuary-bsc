...
contract LOTTOminting is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    constructor(string memory baseURI) ERC721("Rug at a Million Lottery", "RAMLotto") {
        Token = IBEP20(0x628dF6fbC6b7fC5FCcbA0c1408aeF5d242EA9784);
        setBaseURI(baseURI);
        pause(true);
    }
