 ...
 * @notice It handles the distribution of MST token.
 * It auto-adjusts block rewards over a set number of periods.
 */
contract StakingPoolForMST is ReentrancyGuard {
    ...
    /**
     * @notice Constructor
     * @param _mstToken MST token address
    ...
    constructor(
        ...
        uint256 nonCirculatingSupply = IMetaSportsToken(_mstToken).supplyCap() -
            IMetaSportsToken(_mstToken).totalSupply();
        ...
        // 2. Store values
        mstToken = IMetaSportsToken(_mstToken);
     ...
     * @param amount amount to deposit (in MST)
     */
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer MST tokens to this contract
        mstToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function harvest() external nonReentrant {
        ...
        mstToken.safeTransfer(msg.sender, pendingRewards);
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer MST tokens to the sender
        mstToken.safeTransfer(msg.sender, amount);
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ...
            bool mintStatus = mstToken.mint(address(this), tokenRewardForStaking);
            if (mintStatus) {
    ...
    function _updateRewardsPerBlock(uint256 _newStartBlock) internal {
        ...
        emit NewRewardsPerBlock(currentPhase, _newStartBlock, rewardPerBlockForStaking);
    }
