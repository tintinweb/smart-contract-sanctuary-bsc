...
contract VaultOwner is Ownable {
    ...
    DutyVault public immutable dutyVault;

    /**
     * @notice Constructor
     * @param _dutyVaultAddress: DutyVault contract address
     */
    constructor(address _dutyVaultAddress) public {
        dutyVault = DutyVault(_dutyVaultAddress);
    }
    ...
    function setAdmin() external onlyOwner {
        dutyVault.setAdmin(address(this));
    }
    ...
    function setTreasury(address _treasury) external onlyOwner {
        dutyVault.setTreasury(_treasury);
    }
    ...
    function setPerformanceFee(uint256 _performanceFee) external onlyOwner {
        dutyVault.setPerformanceFee(_performanceFee);
    }
    ...
    function setWithdrawFee(uint256 _withdrawFee) external onlyOwner {
        dutyVault.setWithdrawFee(_withdrawFee);
    }
    ...
    function setWithdrawFeePeriod(uint256 _withdrawFeePeriod) external onlyOwner {
        dutyVault.setWithdrawFeePeriod(_withdrawFeePeriod);
    }
    ...
    function inCaseTokensGetStuck(address _token) external onlyOwner {
        dutyVault.inCaseTokensGetStuck(_token);
