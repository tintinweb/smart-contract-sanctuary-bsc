...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public minPriceTicketInBNB = 0.00001 ether;
    ...
    uint256 public presentTime = block.timestamp;
        ...
        payable
    {
        ...
        // payable(address(this)).transfer(amountBNBToTransfer);
