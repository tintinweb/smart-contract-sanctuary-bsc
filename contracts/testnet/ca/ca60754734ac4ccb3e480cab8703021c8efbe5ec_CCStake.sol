...
contract CCStake is LPTokenWrapper {
    IERC20 public token;
    
    uint256 public DURATION = 10 minutes;
    

    uint256 public totalreward = 1140*1e18;
    
    uint256 public initreward = 342*1e18;
    
    uint256 public monthFlag = 1;
    uint256 public totalReferralReward = 0;

    uint256 public starttime = 1645771800;
    uint256 public finishtime = 1645773600;
    uint256 public getrewardtime = 1645773900;
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish && monthFlag < 3) {
            ...
            if(monthFlag == 1) {
                ...
                initreward = totalreward.mul(40).div(100); 
                DURATION = 10 minutes;
            }
