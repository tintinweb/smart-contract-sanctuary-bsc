...
contract BHOStaking is OwnableUpgradeable, PausableUpgradeable {
    ...
    mapping(address => StakeHistory[]) public usersHistories;
    ...
    function stakeBHO(uint256 _amount, uint256 _pid)
        external
        whenNotPaused returns (uint256 amount, uint256 duration)
    {
        ...
        usersHistories[user].push(StakeHistory({
            amount: _amount,
            interest: 0,
            fee: 0,
            timestamp: stakedAt,
     ...
     */
    function unstakeBHO() external whenNotPaused {
        address user = _msgSender();
        UserInfo memory userInfo = usersInfo[user];
        require(userInfo.amount > 0, "Amount invalid");
        require(
