...
contract GFi is Context, IBEP20, Ownable, ReentrancyGuard{ 
    ...
    uint256 totalFeeBuy 				            = buyLiquidityFee + buyRewardFee + buyEcosystemFee + buyDevFee + buyReserveFee;
    ...
    uint256 totalFeeSell 				            = sellLiquidityFee + sellRewardFee + sellEcosystemFee + devFee + sellReserveFee;
