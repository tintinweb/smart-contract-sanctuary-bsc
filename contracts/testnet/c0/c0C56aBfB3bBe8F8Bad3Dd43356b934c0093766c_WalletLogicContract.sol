...
contract WalletLogicContract is BaseWallet {
    ...
    function payFullFee(
        ...
        uint usedGasInEth = gasleft() - gasLeftBeforeCall;
        uint usedGasInToken;
        if (feeTokenAddress != address(0)) {
            ...
            bytes memory payload = abi.encodeWithSignature("transferFrom(address,address,uint256)", address(this), feeMaster, fullFee);
