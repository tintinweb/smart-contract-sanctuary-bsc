...
// File: contracts/dress show token.sol
...
contract DressShowToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor()
        ERC20("Dress Show Token", "DS")
        ERC20Permit("Dress Show Token")
    {
