...
contract DripCrops {
    ...
    IToken public token_DRIP;
	address erctoken = 0xE9afc3A2d8022E21A2A302aea38D3797C06bBAFe; /** DRIP Testnet **/
    //address erctoken = 0x20f663CEa80FaCE82ACDFA3aAE6862d246cE0333; /** DRIP Mainnet **/
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 DRIP  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 DRIP  **/
    ...
    function sellEggs() public{
        ...
        token_DRIP.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_DRIP.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_DRIP.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_DRIP.transfer(owner, tax);
        token_DRIP.transfer(dev1, tax);
        token_DRIP.transfer(dev2, tax);
        token_DRIP.transfer(dev3, tax);
        token_DRIP.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_DRIP.balanceOf(address(this));
	}
...
DRIP Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for BUSD. 
  ...
  10 DRIP minimum investment.
  10,000 DRIP max deposits per wallet.
