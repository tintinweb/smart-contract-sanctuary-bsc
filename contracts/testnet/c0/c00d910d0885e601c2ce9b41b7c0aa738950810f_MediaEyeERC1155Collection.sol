    ...
    MediaEyeCollection
{
    ...
    /**
     * @notice  mint tokens using ERC1155 implementation
     * @dev     caller has to have minter role
     * @param _to address receiving tokens minted
     * @param _amount amount of tokens to mint
     * @param _data data passed to mint for onERC1155Received function call
     * @param _metadataURI URI for tokens
     ...
     * @dev     caller has to have minter role
     * @param _to address receiving tokens minted
     * @param _amounts amounts of each token ID to mint
     * @param _data data passed to mint for onERC1155Received function call
     * @param _metadataURIs URIs for each tokenId
    ...
    function mintBatch(
        ...
        uint256 amount_len = _amounts.length;
        uint256[] memory tokenIds = new uint256[](amount_len);
        for (uint256 i = 0; i < amount_len;) {
            tokenIds[i] = _tokenIdTracker.current();
            creators[tokenIds[i]] = _to;
            _tokenIdTracker.increment();
            unchecked {
     ...
     * @param _ids list of tokenIds to burn
     * @param _amounts amounts of each token ID to burn
     */
