...
contract NFTMusix is IERC20 {
    ...
    string constant private _name = "NFT Musix";
    string constant private _symbol = "$Musix";
    ...
    struct TaxWallets {
        ...
        address payable teamDevelopment;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x43dCA2da6f6f06Af0d4AE1619f089D1FC927Bb47),
        teamDevelopment: payable(0x900456207A7e99358BA77544523303af5DAe9F48)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 teamDevelopment, uint16 marketing) external onlyOwner {
        _ratios.teamDevelopment = teamDevelopment;
        _ratios.marketing = marketing;
        _ratios.totalSwap = teamDevelopment + marketing;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable teamDevelopment) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.teamDevelopment = payable(teamDevelopment);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        uint256 teamDevelopmentBalance = (amtBalance * ratios.teamDevelopment) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: marketingBalance, gas: 35000}("");
        }
        if (ratios.teamDevelopment > 0) {
            (success,) = _taxWallets.marketing.call{value: teamDevelopmentBalance, gas: 35000}("");
        }
    }
