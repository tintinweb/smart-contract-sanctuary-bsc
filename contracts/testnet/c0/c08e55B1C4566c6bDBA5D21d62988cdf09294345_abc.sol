...
/**
    ...
    📣 Telegram: https://t.me/SoloMetaverse
    ...
    (2%) kickback to wallet for developer
	(2%) kickback to wallet for marketing
...
contract abc is Context, IERC20, Ownable {
    ...
    string private _name = "ABC METAVERSE";
    ...
    uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee).add(_DevFee); //6% Total Buy Fee
    
    
    

    address payable public marketingWallet =  payable(0xcBaC15E0eeAEC3A96D0a7032d883Aef6C02306dF);
    address payable public DevWallet =  payable(0x40ed85E760De8b015d13E52858527922ed3EFE4c);
