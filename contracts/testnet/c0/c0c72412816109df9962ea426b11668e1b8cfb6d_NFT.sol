...
contract NFT is ERC721URIStorage {
    ...
    function mintToken(string memory tokenURI,uint _price) public returns (uint256) {
        require(msg.sender == owner,"Only Owner Can Mint");
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _mint(msg.sender, newItemId);
        _creators[newItemId] = msg.sender;
        getCountofMintedNft = newItemId;
        pricefortokenid[newItemId] = _price;
...
contract Marketplace is ReentrancyGuard, IERC721Receiver {
    ...
    */
    ...
    // mapping(address => mapping(uint256 => BidDetails)) internal showbids;
    ...
    */
    ...
    function bid(address _nft, uint256 _tokenId) external payable {
        ...
        require(block.timestamp +auction.duration > block.timestamp, "Deadline already passed");
...
// //////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    // function showAllBids(address _nft,uint _tokenId) public view returns ()
