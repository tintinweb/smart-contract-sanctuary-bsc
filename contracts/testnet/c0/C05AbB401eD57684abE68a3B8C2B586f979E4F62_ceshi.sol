...
contract ceshi is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd1992c021957cA57F927bdBE8e9C5427a11A937b));
        marketingWalletAddress = payable(address(0xd1992c021957cA57F927bdBE8e9C5427a11A937b));
