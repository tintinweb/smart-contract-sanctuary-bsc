...
contract  Donate{
    ...
    address                                           public  pair;
    address                                           public  Charitynft = 0xCa9F375b0de06907fd54f6C6e70c18A3a18a033d;
    ...
    function allocation(address urt, uint256  _liquidity) public returns (uint){  
    ...
    function vote(uint256 _order,uint256  _tokenid) public returns (bool){      
    ...
    function voteAuto(uint256 _order) public returns (bool){      
