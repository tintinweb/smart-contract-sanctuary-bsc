...
contract Billionica  {
    ...
    function _pay() internal  {
        ...
        /* checks */        
        require(msg.value == 3000000 gwei, "Amount must be 0.003 BNB");
        

        /* credit treasury (pool) */        
        treasury += 2000000 gwei;
        reserve +=  1000000 gwei;
    ...
    function withdrawAccountFunds() public noReentrant {
        ...
        require(block.number.sub(lastPaymentBlock) >= 600, "Too early to witdraw, wait 600 blocks");
