...
contract TeamVesting is Ownable {
    ...
    function setTeamVesting(VestingDetail[] calldata _vestingDetails)
        external
        onlyOperator
    {
    ...
    function terminateNow(address beneficiary) external onlyOperator {
    ...
    event SetStartDate(uint256 date);
}
