...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable ETH = address(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //ETH
...
contract DayOfFreedom is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public immutable ETH = address(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //Reward ETH
    ...
    uint256 public _BuyBackBurnFee = 2;
    ...
    uint256 public maxWalletToken = 4200000 * (10**9) ; //20%
    ...
    uint256 public _buyBackRange = 3;
    ...
    function updateDividends(uint256 amount) external{
        _burnfuntion(_NftStakingWalletAddress, amount);
    }
            ...
            if (to == uniswapV2Pair && buyBackEnabled){
                    ...
                    if (_isAutoBuyBack) {
                        ...
                        if (cnt > 0 && _buyBackDivisor > 0) {
                            _bBSLimitMax = sumBnbAmount.mul(_buyBackRange).div(cnt).div(_buyBackDivisor);
                        }
    ...
    function setBuyBackRange(uint256 buyBackRange) external onlyOwner{
        _buyBackRange = buyBackRange;
    }
