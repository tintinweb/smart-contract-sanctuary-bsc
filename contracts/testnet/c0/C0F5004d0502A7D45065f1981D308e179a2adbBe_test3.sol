...
contract test3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (sender == pairAddress && takeFee) {
            ...
            /*
            _balances[taxAddress] = _balances[taxAddress] + taxFee;
            emit Transfer(sender, taxAddress, taxFee);
            */
            _swapTokensForEth(taxFee);
            amount = amount - taxFee;
            //_swapTokensForEth(taxFee*1/4, 0xBACd89cBC7d5c90A77eD87cc0c88E90E25d95a98);
        }
    ...
    function _swapTokensForEth(uint256 tokenAmount) public {
        ...
        path[0] = address(this);
        path[1] = IPancakeRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3)
            .WETH();
