...
contract BasketTest is Ownable {
  ...
  function withdrawViaBridge(address account, uint256 voucherIndex, uint256 inChain, uint256 outChain, uint256 price, uint256 rate, uint256 fee) public payable {
    ...
    ILiquidCryptoBridge_v1(bridge).depositForUser(voucher, fee);
  }
