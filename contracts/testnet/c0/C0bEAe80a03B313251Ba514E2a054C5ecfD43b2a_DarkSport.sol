...
contract DarkSport is OwnableUpgradeSafe {
    ...
    uint8 public constant SIZE_OF_TOKEN_BETTING = 10;
    ...
    uint256[100000][3][3][10] public _betMatchDoor;
    uint256[100000][10] public totalMatchesBet;
    ...
    function addMatchBetType(uint256 _matchId, string memory _betDescription, uint8 _numDoors, uint32[] memory _odds, uint256 _maxBudget) public onlyAdmin returns (uint8 _betTypeId) {
        ...
        doorBetAmount: new uint256[](_numDoors * SIZE_OF_TOKEN_BETTING),
    ...
    function buyTicket(uint256 _indexToken, uint256 _matchId, uint8 _betTypeId, uint8 _betDoor, uint32 _betOdd, uint256 _betAmount) public lock returns (uint256 _ticketIndex) {
       ...
       // require(_betOdd == betType.odds[_betDoor], "Invalid _betOdd");
        ...
        betType.doorBetAmount[_betDoor.mul(SIZE_OF_TOKEN_BETTING).add(_indexToken)] = betType.doorBetAmount[_betDoor.mul(SIZE_OF_TOKEN_BETTING).add(_indexToken)].add(_betAmount);
