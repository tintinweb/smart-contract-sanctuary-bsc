...
contract melcoi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0xE304b7Bfb3Eee3fe3209BA1aeA85937289b3ed4b); // Marketing Address
        
    address payable private teamAddress =
        payable(0xFF39EA6Cc339dB1Eb554D9Eb3888076361db35c7); // Team Address
        
    address payable private liquidityAddress =
        payable(0xb6713201916363B7183CE4dD735aa6e1C03DCD18); // Liquidity Address
    ...
    string private constant _name = "melcoi";
    string private constant _symbol = "melcoi";
    
    uint8 private constant _decimals = 18;
    
    uint256 private constant BUY = 9;
    uint256 private constant SELL = 9;
    uint256 private constant TRANSFER = 9;
...
//add Single whitelist Address. 1 in _whiteliststatus  is to whitelist and 0 is to blacklist 
    function AddwhitelistAdr(address _addr, uint256 _whiteliststatus ) onlyOwner  public{
    ...
    function AddmultiplewhitelistAdr(address[] calldata _addr, uint256 _whiteliststatus ) onlyOwner  public{
