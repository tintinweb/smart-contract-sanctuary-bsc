...
contract Henkz is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB8EC72B057D55B7EEf2a640E49cdD0B1dD7F1ADB); 
    address payable public Wallet_Dev = payable(0xB8EC72B057D55B7EEf2a640E49cdD0B1dD7F1ADB);
    ...
    string private constant _name = "Henkz"; 
    string private constant _symbol = unicode"$HENKZ"; 
    ...
    uint256 public _maxWalletToken = 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0xB8EC72B057D55B7EEf2a640E49cdD0B1dD7F1ADB;
