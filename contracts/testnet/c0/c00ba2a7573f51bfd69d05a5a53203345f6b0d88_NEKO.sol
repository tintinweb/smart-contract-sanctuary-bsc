...
abstract contract Tokenomics {
    ...
    // --------------------- Token Settings ------------------- //
    string internal constant NAME = "NKGToken";
    string internal constant SYMBOL = "NKGT";
    ...
    address internal charityAddress =
        0xa401e6b1bbDc0d95bf32b1bE4BDB67FeD8453080;
    address internal marketingAddress =
        0x40f1A64B139512A5B37F0E4d4a9a4c945E19E385;
...
abstract contract NKGToken is BaseRfiToken, Liquifier, Antiwhale {
    using SafeMath for uint256;
...
contract NEKO is NKGToken {
    constructor() NKGToken(Env.Testnet) {
