...
contract Primaax is ERC20, Ownable {
    ...
    returns(uint gTotalBonus, uint sTotalBonus, uint totalBonus, uint rClaimed, uint gSales, uint gEnd) {
        address puser = _user;
        ...
        return (user.totalGroupBonus, user.totalStakeBonus, user.totalAllBonus, user.totalClaimed, user.totalGroupSales, user.flushDeathline );
    }
