...
contract CockFactory is Initializable, 
    ERC721Upgradeable , 
    ...
    function initialize() public initializer {
        __ERC721_init("CockFactory", "COCKFACTORY");
    ...
    function mintTo(address owner) external onlyRole(MINTER_ROLE) whenNotPaused {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://robocockuwu.com/api/nft/cock/factory/";
    }
