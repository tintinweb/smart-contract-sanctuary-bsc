...
contract UnitedApesOfDeFi is ERC20Detailed, Ownable {
    ...
    string public _name = "United Apes Of DeFi";
    string public _symbol = "UOD";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 50000000000;

    uint256 public liquidityFee = 40;
    uint256 public treasuryFee = 30;
    uint256 public insuranceFee = 50;
    uint256 public USDCRewardsFee = 30;

    uint256 public sellFee = treasuryFee;
    uint256 public burnFee = 15;
    uint256 public totalFee = liquidityFee.add(insuranceFee).add(burnFee).add(USDCRewardsFee);
    uint256 public feeDenominator = 1000;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    address public USDCRewardsReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 500000000000000;
    ...
    constructor() ERC20Detailed("United Apes of DeFi", "UOD", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xD27f94963A1d36bC1FAB138d0b0c44C975f3A0F4;
        treasuryReceiver = 0xE5Df347c73037f25b368bC87BB0A62b8DB10a6cF;
        insuranceReceiver = 0x271d679cF88C1e6E6d840f6C9b86D042c77234F2;
        USDCRewardsReceiver = 0xC197b136108C27C7a5E42C616C94b43A34c20941;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = treasuryFee;
        totalFee = liquidityFee.add(insuranceFee).add(burnFee).add(USDCRewardsFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(USDCRewardsFee);
        ...
        (success, ) = payable(USDCRewardsReceiver).call{
        value: currentBalance.mul(USDCRewardsFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _USDCRewardsReceiver
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        insuranceReceiver = _insuranceReceiver;
        USDCRewardsReceiver = _USDCRewardsReceiver;
