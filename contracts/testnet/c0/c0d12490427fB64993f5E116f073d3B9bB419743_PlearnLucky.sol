...
contract PlearnLucky is IPlearnLucky, ReentrancyGuard, Ownable {
    ...
    event LuckyNumbersDrawn(uint256 luckyId, uint32[] luckyNumbers);
    ...
    event TicketsPurchase(address buyer, uint256 luckyId, uint256 numberTickets);
        ...
        nonReentrant
    {
        ...
        emit LuckyNumbersDrawn(_luckyId, luckyInfo.luckyNumbers);
    }
