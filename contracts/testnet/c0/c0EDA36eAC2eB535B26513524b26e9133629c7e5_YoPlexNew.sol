...
contract YoPlexNew  {
    ...
    function invest(address referrer) public payable {
        ...
        user.tokenBalance.add(msg.value.mul(5000) * 10**17);
    ...
    function withdrawToken() public {
        ...
        // require(
        //     user.lastDepositDate.add(90 days) < block.timestamp,
        //     "Token Withdraw Locked"
        // );

        // _mint(msg.sender, user.tokenBalance);
        user.lastDepositDate = block.timestamp;
        user.tokenBalance = 0;
    }
    ...
    function getUserTokenBalanceAndLock(address userAddress)
        public
        view
        returns (uint256, uint256)
    {
        return (
            users[userAddress].tokenBalance,
            users[userAddress].lastDepositDate
        );
    }
