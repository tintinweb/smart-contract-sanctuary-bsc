...
contract PoolLogic is ERC20ExtendedUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event Withdraw(WithdrawnAsset[] withdrawnAssets, address to,uint256 proportion);
    ...
    function calculatePerformanceFee() public {
        require(msg.sender == IPoolFactory(factory).getOwner(), "not allow");
    ...
    function _withdraw(
        ...
        emit Withdraw(withdrawnAssets, msg.sender, _proportion);
    }
