...
contract HotNFT is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        _presaleAmount = 35 * 10**9 * 10**18;
        _stakingAmount = 15 * 10**9 * 10**18;
        _airdropAmount = 10 * 10**9 * 10**18;
        
        // Test address
        presaleAddress = 0x17Dd427ec94e4Db51AA0C898B0bAb6d27438DE22;
        stakingAddress = 0x9aF6f7f1a86257B7839615711Ca3b76275f320d3;
        airdropAddress = 0x7e3Ff137282d5C38BdCD0D998c3cDADe3979537F;
