...
contract BetController {
                        ...
                        returns(address)
    {
        ...
        try new BetContract(msg.sender, title, description, whitelistedAddresses, options, pickedOption, multipleEntries, value, maxP, verificationPercent, donation) returns (BetContract newContract){      
    ...
    */
    function ParticipateInBet(address betAddress, uint optionIndex) public payable{
        ...
        currentBet.AddParticipant(msg.sender, optionIndex);
