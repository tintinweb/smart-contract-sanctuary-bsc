...
contract WDA is ERC20, Ownable {
    ...
    event ChangeTax(uint256 sellTax, uint256 buyTax, uint256 transferTax);
    ...
    function setLiquidityAddress(address account, bool permission)
        external
        onlyOwner
    {
        _liquidityAddress[account] = permission;
    }
    ...
    function setTaxes(
        ...
        emit ChangeTax(sellTax_, buyTax_, transferTax_);
    }
