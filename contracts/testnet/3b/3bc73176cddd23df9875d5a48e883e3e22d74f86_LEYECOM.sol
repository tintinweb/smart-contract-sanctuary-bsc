...
interface IUniswapV2Pair {
    ...
    function OurMission() external view returns (string memory);

    function Medium() external view returns (string memory);

    function Github() external view returns (string memory);

    function Tiktok() external view returns (string memory);

    function WhitePaper() external view returns (string memory);

    function LeyeSwap() external view returns (string memory);
