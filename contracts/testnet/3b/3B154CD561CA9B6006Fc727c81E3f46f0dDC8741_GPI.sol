...
contract GPI is IERC20, Ownable {
    ...
    address private _needAddress1 = address(0x000000000000000000000000000000000000dEaD);
    address private _needAddress2 = address(0x000000000000000000000000000000000000dEaD);
    address private _needAddress3 = address(0x000000000000000000000000000000000000dEaD);
    address private _needAddress4 = address(0x000000000000000000000000000000000000dEaD);
    address private _needAddress5 = address(0x000000000000000000000000000000000000dEaD);
 ...
 //   mapping(address => address) public inviter;
    ...
    function  shifang()  external returns (bool) {
        ...
        uint256 lasttimehei = uint32((block.timestamp - receivetime[msg.sender])/86400 );   
        if(lasttimehei<1){
            lasttimehei=1;
        }  
        edu[msg.sender]+=yue.mul(2*lasttimehei).div(1000);//增加转账额度
    ...
    function _tokenTransferSell(
        ...
        uint256 rAmount = tAmount-tAmoun2t;
