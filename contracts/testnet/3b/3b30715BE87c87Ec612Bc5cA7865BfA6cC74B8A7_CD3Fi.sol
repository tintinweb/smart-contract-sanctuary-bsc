...
contract CD3Fi is IBEP20, Ownable {
    ...
    address _childContract = 0x52942dBFBb0C446448ca636D8d10452A8C39A984;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount, bool isBuy, bool isSell) internal{
        ...
        if(isBuy){
            ...
            _transferCD3Fi(sender, address(_childContract), _taxData.CD3FiAmountForBusdReward + _taxData.CD3FiAmountForStabilityFund);  //transfer tax amount of CD3Fi token
            ...
            IChildCD3Fi(address(_childContract))._swapCD3FiForBusd(address(this), address(this), swapAmountIn);
    ...
    function _swapCD3FiForBusd(uint256 sellAmount, uint256 amountOut) private returns (uint256){        
        require(
