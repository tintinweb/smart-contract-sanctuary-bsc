...
// PDOLLAR FINANCE
contract PDOLLARToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 20000 ether; // 20000 of PUSD

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the PDOLLAR ERC-20 contract.
     */
    constructor() public ERC20("PDOLLARToken", "PDOLLAR") {
        _mint(msg.sender, 1000 ether);
    }

    /**
     * @notice Operator mints PDOLLAR to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of PDOLLAR to mint to
