...
contract DistributorV2 is AccessControl {
    ...
    function createDistribution(
        ...
        emit DistributionStarted(msg.sender, _rewardAmount);
    }
    ...
    function claim(
        ...
        bytes32 message = keccak256(
            abi.encodePacked(msg.sender, _amount, block.chainid, _salt)//add salt
        ); 
