...
contract TEST1 is  Initializable ,ContextUpgradeable, BEP20Upgradeable, OwnableUpgradeable {
    using AddressUpgradeable for address;
    ...
    function swapAndLiquify() public onlyOwner lockTheSwap {
    ...
    function updateNumTokensSellToAddToLiquidity(uint256 amount) private onlyOwner {
