...
contract OtcExchange is IOrderEscrow, IOrderFixed, Ownable, ReentrancyGuard {
    ...
    mapping(address => bool) private availableQuoteTokens;
 ...
 //   );
    ...
    function createOrderFixed(
       ...
       returns (bool success) {
        ...
        uint256 price =  (amountQuote * 10 ** (18 - ERC20(tokenQuote).decimals() ) )  /
                         (amountBase * 10 ** (18 - ERC20(tokenBase).decimals() ) )  * 1e18;        
    ...
    function updateOrderFixed(
      ...
      returns (bool success) {
        ...
        uint256 price =  (amountQuote * 10 ** (18 - ERC20(oldOrder.tokenQuote).decimals() ) )  /
                         (amountBase * 10 ** (18 - ERC20(oldOrder.tokenQuote).decimals() ) )  * 1e18;       
    ...
    function takeOrderEscrow(
      ...
      returns (bool success) {
        ...
        if (orderSelected.orderType) {
            ...
            uint256 amountBase = (amountToken /  (orderSelected.price / 1e18) );
