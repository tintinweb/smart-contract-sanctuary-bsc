...
contract HTE is Context, IERC20, Ownable {
    ...
    string private constant _name = "HTE"; // 
    ...
    address payable public  _marketingWallet = payable(0x82D2b127C9530DBEa99B07D542894bcF4b1B3244);
