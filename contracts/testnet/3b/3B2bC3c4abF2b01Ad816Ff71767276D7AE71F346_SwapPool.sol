...
contract SwapPool is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event PoolUnstake(uint256 commission, uint256 amount);
    ...
    function triggerRebalanceAnkr() external virtual nonReentrant onlyManager {
        ...
        if (isStake) {
            ...
            emit PoolUnstake(commission, abnbcAmount);
        }
    }
    ...
    function flashFee(address _token, uint256 amount) public view returns (uint128) {
