...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63d1b2d29D047d912D192750Eff5e607185909c4;
...
contract MSKT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x63d1b2d29D047d912D192750Eff5e607185909c4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MSKToken";
    string private _symbol = "MSKT";
