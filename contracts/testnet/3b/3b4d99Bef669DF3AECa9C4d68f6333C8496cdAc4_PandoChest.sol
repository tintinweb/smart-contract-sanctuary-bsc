...
contract PandoChest is Ownable, Pausable {
    ...
    function allocateReward(uint256 _allocationAmount, uint256 _allocateDay) external onlyOperator whenNotPaused{
        ...
        if (IERC20(busd).balanceOf(address(this)) < _allocationAmount) {
