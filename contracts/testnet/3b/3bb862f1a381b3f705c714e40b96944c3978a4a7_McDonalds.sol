...
/* Token contract */
contract McDonalds is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xF3ff4951b1F7C50B7C070BAb96326851451b9513;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1 / 10000; // 3.0% on launch or 3M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 10000; // 3% or 3M tokens
    uint256 public _maxWalletToken = _totalSupply * 50 / 10000; // 4% or 4M tokens
