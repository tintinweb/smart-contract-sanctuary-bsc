...
contract NEXTUSD is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        presaleFinishDate = block.timestamp - 90 days; // TODO: Revert to + 90days
    }
    ...
    function isPreseller(address account) public view returns (bool) {
        return _allowedPresellers[account];
    }
    ...
    function takeFeeReward() public virtual returns (bool) {
        ...
        require((unpaidRewardAmount) > (1 * 10 ** decimals()), "Reward should be higher than $1.");
