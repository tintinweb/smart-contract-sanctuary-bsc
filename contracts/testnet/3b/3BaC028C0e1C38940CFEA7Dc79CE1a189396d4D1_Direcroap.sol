...
contract Direcroap is Ownable , ReentrancyGuard { 
    ...
    uint256 public freelancer_ = 1000;//10%
   ...
   function setTokenAddress(address _wallet) public onlyOwner {
    ...
    approve_[pIds]=proposal(pIds,false,false,false,_amount,msg.sender,_addr,0,0,block.timestamp,block.timestamp+acceptLimit_);
    }
