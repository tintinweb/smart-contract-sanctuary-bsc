...
*/
    ...
    */
    ...
    address public _distributionWallet = 0x294658373ADBDBe836e2E841BB1996ceA9e56Fe3;

    uint256 public _lastUserId;

    uint256 public _minDistributionPerWallet = 200000 * 10 ** 9; //change to 100000 * 10 ** 9 for mainnet
    ...
    modifier onlyDistributor() {
        require(_distributionWallet == _msgSender(), "Unauthorized function call");
        _;
    }
    ...
    function withdrawFee(uint256 amount) external onlyDistributor {
        require(amount <= address(this).balance, "Insufficient contract balance");
        (bool sent, ) = payable(_distributionWallet).call{value: amount}("");
        require(sent, "Failed to send BNB");
    }


    function sendReward(uint256 from, uint256 perPage, uint256 amount) external onlyDistributor {
    ...
    function processPayment(address account, uint256 level) internal {
        ...
        uint256 rest = totalAmount * 95 / 100;
        bool sent;
        for (uint i = 0; i < 3; i++) {
