...
contract AFI is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        UNSTAKING_FEE = 1;
        REF_BONUS = 2;
        MIN_DEPOSIT = 1000000000000000000; // 1 Tokens TODO: Change back to 50!
        MAX_DEPOSIT = 10000000000000000000000; // 10000 Tokens
    ...
    function revenueAmount() private view returns (uint256) {
        if (block.timestamp.sub(CONTRACT_INITIATED_AT) < 135 days) {
            return 80;
        }
        return 50;
    }
    ...
    function claimRewards() public nonReentrant {
        ...
        require(
            secondsSinceLastClaim(msg.sender) >= 43200, //TODO: Change back to 10 days, use ** daysSinceLastClaim **!!!
    ...
    function unstake(uint8 index) public nonReentrant {
        ...
        Deposit memory depositStake = users[msg.sender].deposits[index];
        require(
            block.timestamp.sub(depositStake.start) >= 1 days, //TODO: Change back to 60!
        ...
        uint256 tokensAfterFee = Math.sub(depositStake.amount, totalFee);
        ...
        totalCurrentInvested = totalCurrentInvested.sub(depositStake.amount);
