...
contract OLOGY is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    constructor () BEP20Detailed("Coinology", "OLOGY", 9) {
    ...
    function setBuyFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 15, "Total buy fees should be less than 15%");
    }
    ...
    function setSellFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 15, "Total sell fees should be less than 15%");
    }


    function setMarketingAddress(address payable wallet) external onlyOwner
    {
        require(wallet != address(0), "Marketing address can't be DEAD address!");
