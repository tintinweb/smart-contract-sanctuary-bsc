...
contract RAMSvsBengals is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bengals Team";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 300 / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 300 / 1000; // 1% maxWalletToken
