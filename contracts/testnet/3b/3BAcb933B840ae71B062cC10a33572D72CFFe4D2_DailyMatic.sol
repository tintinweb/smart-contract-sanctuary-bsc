...
contract DailyMatic is Ownable {
    ...
    uint256 private constant MIN_WITHDRAW = 0.00 ether;
    uint256 private constant MIN_INVESTMENT = 0.00 ether;
    ...
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 100;
    ...
    function _invest(address _addr, address _ref, uint256 _amount ) private returns (bool){
        require(msg.value >= MIN_INVESTMENT, "Minimum investment is 0.1 BNB");
