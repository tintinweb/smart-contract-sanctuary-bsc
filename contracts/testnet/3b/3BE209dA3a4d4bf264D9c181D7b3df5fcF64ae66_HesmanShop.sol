...
contract HesmanShop is Ownable, ReentrancyGuard {
    ...
    voucherDetail[] public voucherList;
    ...
    function setVoucherForSell(uint256[] memory _idList, uint256[] memory _priceList) public onlyOwner {
        ...
        for(uint256 index = 0; index < _idList.length; index++){
            ...
            if(idExistedMap[_idList[index]] == false){
                ...
                voucher.voucherPrice = _priceList[index];
    ...
    function getVoucherList() public view returns (voucherDetail[] memory) {
        return voucherList;
    }

    function setVoucherSoldOut(uint256[] memory _idList) public onlyOwner {
