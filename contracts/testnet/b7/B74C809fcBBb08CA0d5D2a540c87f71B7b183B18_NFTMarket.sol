...
contract NFTMarket is ERC721Holder, ERC1155Holder, Ownable, ReentrancyGuard {
    ...
    event SetAdminAddress(address admin, bool isAdmin);
    ...
    modifier onlyAdmin() {
        require(isAdmin[msg.sender], "Management: Not admin");
        _;
    }
    ...
    function buyTokenUsingUSDT(
        ...
        _buyToken(_collection, _tokenId, _amount, _price);
    }
    ...
    function createAskOrder(
        ...
        if (_collections[_collection].nftType == CollectionType.ERC721) {
        ...
        // Emit event
        emit AskNew(_collection, msg.sender, _tokenId, _amount, _askPrice);
    }
    ...
    function addCollection(
        ...
        require(
            IERC721(_collection).supportsInterface(0x80ac58cd) ||
                IERC1155(_collection).supportsInterface(0xd9b67a26),
            "Operations: Not NFT"
        );
        ...
        bool nftType = IERC721(_collection).supportsInterface(0x80ac58cd);
        ...
        _collections[_collection] = Collection({
            ...
            nftType: nftType ? CollectionType.ERC721 : CollectionType.ERC1155,
    ...
    function recoverNonFungibleToken(
        ...
        if (IERC1155(_token).supportsInterface(0xd9b67a26)) {
    ...
    function setAdminAddress(address _admin, bool _isAdmin) external onlyOwner {
        require(
            _admin != address(0),
            "Operations: admin address cannot be zero"
        );
        ...
        emit SetAdminAddress(_admin, _isAdmin);
    }
        ...
        )
    {
        ...
        return _calculatePriceAndFeesForCollection(collection, amount, price);
    }
    ...
    function _buyToken(
        ...
        Collection memory collections = _collections[_collection];
        require(
            collections.status == CollectionStatus.Open,
        ...
        (
            ...
            uint256 tradingFee,
            uint256 creatorFee
        ) = _calculatePriceAndFeesForCollection(_collection, _amount, _price);
        ...
        if (collections.nftType == CollectionType.ERC721) {
    ...
    {
        uint256 totalAskPrice = _askPrice.mul(_amount);
        tradingFee =
            (totalAskPrice.mul(_collections[_collection].tradingFee)) /
            100;
        creatorFee =
            (totalAskPrice.mul(_collections[_collection].creatorFee)) /
            100;
