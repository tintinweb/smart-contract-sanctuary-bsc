...
contract MFETVault is Context, Ownable, ReentrancyGuard {
    ...
    /// @dev %40 drip %40 instant %20 locked on contract
    ...
    =            PUBLIC FUNCTIONS           =
    =======================================*/
    /// @dev reward investors daily earning dividends
    function reward(uint256 _reward)
        ...
        returns (uint256)
    {
        require(_reward >= minInvest, "min reward amount error");
    ...
    function invest(uint256 _investAmount)
        ...
        returns (uint256)
    {
        require(_investAmount >= minInvest, "min invest amount error");
