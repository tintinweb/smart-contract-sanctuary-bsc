...
abstract contract SingleRewardPool is ReentrancyGuard, Ownable {
    ...
    modifier onlyPoolRewardDistributor {
        require(
            ...
            "SingleRewardPool: caller is not the PoolRewardDistributor"
        );
        _;
    }
    ...
    */
    function notifyRewardAmount(uint256 reward_) external onlyPoolRewardDistributor updateReward(address(0)) {
        ...
        require(rewardRate <= balance / rewardsDuration, "SingleRewardPool: provided reward too high");
