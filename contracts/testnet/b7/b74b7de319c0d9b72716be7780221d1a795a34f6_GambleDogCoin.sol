...
// Dependency file: contracts/baby/GambleDogCoinDividendTracker.sol
...
contract GambleDogCoinDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/GambleDogCoinDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract GambleDogCoin is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    GambleDogCoinDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = GambleDogCoinDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GambleDogCoinDividendTracker newDividendTracker = GambleDogCoinDividendTracker(
            payable(newAddress)
        );
