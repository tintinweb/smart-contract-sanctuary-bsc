...
contract BlindboxSell is ERC1155Receiver, Ownable, ReentrancyGuard, Pausable {
    ...
    event BoxListing(uint256 _tokenId, uint256 _amount, uint256 _limit, uint256 _price);
    ...
    function boxListing(
        ...
        for (uint256 index = 0; index < _tokenIds.length; index++) {
            ...
            emit BoxListing(_tokenIds[index], _amounts[index], _limits[index], _prices[index]);
        }
    }
