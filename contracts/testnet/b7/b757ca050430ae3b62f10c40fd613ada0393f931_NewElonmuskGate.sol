...
/*
 ...
 #cElonGate New Community ElonGate
    
   I make this #cElonGate to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityElonGatePortal

   Great features:
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee Marketing so I will help with marketing 
...
contract NewElonmuskGate is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Elon Gate"; 
    string private constant _symbol = "cElonGate"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 3;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x27c6b3A802701D49e73e7CaC9BF215415E9f51dF;
