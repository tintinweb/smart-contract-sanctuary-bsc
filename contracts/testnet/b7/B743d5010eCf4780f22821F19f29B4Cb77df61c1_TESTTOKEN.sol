...
contract TESTTOKEN is IERC20, Ownable {
    ...
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB Mainet
    ...
    // Swap and send fees ( initially Busd can change later)
	/* MainNet */
    //address public SWAPTOKEN = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB Mainnet
    //address public REWARD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD Mainnet
    ...
    //uint8 constant _divisor = 1; //Mainnet
    uint16 constant _divisor = 1000; //TestNet
    ...
    address public marketingFeeReceiver = 0x6C412A151dc1D6378ce062039b13CAD5389AEB9D; //Marketing Wallet
    address public devFeeReceiver = 0x5aEF45910dB01Cc30705966D27F0244648592B81; //Dev Wallet
    ...
    constructor() {
        ...
        // address public pinkAntiBotAddress = 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002; // PinkAntiBot Mainnet
	...
	// Claim Tokens - Disable for security Reason
	/*
	...
	*/
    ...
    function prepareForLaunch() external onlyOwner {
        updateBuyFees(5,4,0,1,0);
        updateSellFees(6,6,0,1,0);
		maxWalletTokens = (_totalSupply * 100) / 10000; // 1% of supply
		maxTxAmount = (_totalSupply * 5) / 10000; // 0.05% of supply
    }

    function normalizeAfterLaunch() external onlyOwner {
        updateBuyFees(5,3,0,1,1);
        updateSellFees(5,3,0,1,1);
		maxWalletTokens = (_totalSupply * 200) / 10000; // 2% of supply
