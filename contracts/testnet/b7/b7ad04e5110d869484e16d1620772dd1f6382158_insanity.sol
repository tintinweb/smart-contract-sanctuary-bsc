...
contract insanity is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_REBASE_FREQUENCY = 10;
    ...
    constructor() ERC20Detailed("crazy", "INSANITY", uint8(DECIMALS)) {
    ...
    function shouldRebase() internal view returns (bool) {
        return nextRebase <= block.timestamp + 31536000 + rebaseFrequency;
    }
