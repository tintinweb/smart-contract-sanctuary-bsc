...
import "./interface/IInfectionNFT.sol";
...
contract WinDaoDonate is  Ownable{
    ...
    uint256 public UNIT_TOKEN_AMOUNT = 7900000 * 10 ** 18;
    ...
    function donate() external payable  {
        ...
        donateSum +=msg.value;
        IInfectionNFT(infectionNFTAddr).ownerMinting(msg.sender, msg.value.div(UNIT_PRICE));
