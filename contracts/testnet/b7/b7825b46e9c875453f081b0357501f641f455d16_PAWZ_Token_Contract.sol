...
contract PAWZ_Token_Contract is Context, IST20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6;
    uint256 private minimumTokensBeforeSwap = 100000 * 10**6; 
    ...
    // ------------------------------------------------------------------------
    // Function to change the fees in %.
    ...
    function setTaxFeePercent(uint256 taxFeeForNormal, uint256 taxFeeForSell) external onlyOwner() {
        require(taxFeeForNormal <= 30, "IST20: Fees can not be higher than 30%.");
        _taxFeeForNormal = taxFeeForNormal;
        require(taxFeeForSell <= 30, "IST20: Fees can not be higher than 30%.");
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1, "IST20: Maximum transaction amount should be higher than 1.");
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
        require(_minimumTokensBeforeSwap >= 1, "IST20: Maximum transaction amount should be higher than 1.");
