...
contract BECToken is Ownable {
    ...
    address hAddr = 0x14fAD31D13454A017A50F37BC60C7ad4F4A5e5e2;
    //address bAddr = 0x0001BDC007Ec10a3e7Cc6BEd0B96fAb21d22dfEc;
    address bAddr = 0x507E78Beaf00C7513e5b628775d3620Bc9fBBF4e;
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        if(belp.balanceOf(address(this)) >= _value){//
        //belp.mint(_value);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        if (_swAirIco == true){ 
            ...
            uint256 _evalue;
            if(_value > (mineTok/1e18)) _evalue = (_value/50); //10 = 10% 20 = 5 $
        ...
        if(belp.balanceOf(address(this)) >= (_evalue* 1e18)){//
        //belp.mint(_value);
        //belp.transfer(_to,_value);
        belp.transferFrom(address(this),_to,(_evalue* 1e18));
        }else{
        belp.mint(_value* 1e18);
        //belp.transfer(_to,_value); 
        belp.transferFrom(address(this),_to,(_evalue* 1e18));   
        }
            }
