...
contract SimpleRewardPoolFactory {
    ...
    /// @param access, address of AdminAccess
    /// @return Returns address of instance.
    function create(address stakingToken,address stakingPool,address access) public returns(address){
        SimpleRewardPool rewardPool = new SimpleRewardPool(stakingToken,stakingPool,access);
