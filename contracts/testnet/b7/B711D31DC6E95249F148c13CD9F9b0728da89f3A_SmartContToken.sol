...
contract SmartContToken is Context, BEP20, Ownable {
    ...
    function swapAndLiquify(uint256 TotalAmount) private lockTheSwap {
        /* Split the contract balance into halves */
        (,uint256 tFee,uint256 tLiquidity,) = _getTValues(TotalAmount);
        uint256 tokenAmount = tFee.add(tLiquidity);
    ...
    function setWBNBAdress(address payable _WBNBAddress) public onlyOwner() {
