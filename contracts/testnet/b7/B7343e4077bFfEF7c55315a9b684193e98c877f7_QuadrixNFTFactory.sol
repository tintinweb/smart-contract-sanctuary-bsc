...
contract QuadrixNFTFactory{
    ...
    function updateSigner(address _signer)public _onlyOwner{
        require(_signer != address(0),"QuadrixNFTFactory:Invalid Signer Address");
        signer = _signer;
    }
    ...
    function collection(Collection memory collections,uint expiry,Sig memory sig) public {
        ...
        require(collections.collectionLimit > 0 ,"QuadrixNFTFactory : Invalid Collection Limits");
        ...
        coll.collectionPercentage = collections.collectionPercentage;
