...
contract MetaproINS is Ownable, ERC1155Holder, ReentrancyGuard {
    ...
    function create(
        ...
        require(
            _pricePerToken > 0,
            "INS: pricePerToken must ge greater than 0"
        );
        require(
    ...
    function withdraw(uint256 insId, bytes memory _data) external nonReentrant {
        ...
        IERC1155 tokenContract = IERC1155(insContractAddress[insId]);
        require(
    ...
    function sendTokenToDepositer(
        ...
        IERC1155 tokenContract = IERC1155(
            insContractAddress[_insConfiguration.insId]
        );
