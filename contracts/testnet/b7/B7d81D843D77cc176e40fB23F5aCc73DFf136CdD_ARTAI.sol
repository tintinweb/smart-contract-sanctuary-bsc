...
contract ARTAI is ERC20, Ownable {
    ...
    address public marketingWallet = 0x4b698343edDCB1038CCEb6C264AC0Ee466a18c16;
    address private devWallet = 0x51c603e3D3AD5d77701C0Afc5b15DE1902Dfa93d;
    ...
    uint256 public TotalSellFee =
        sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev;
    ...
    constructor() ERC20("Art AI", "ARTAI") {
        ...
        exemptFee[0xb70ed8c6917955d78bC1288D0f7b286E411132Cf] = true;
    }
    ...
    function updateIsEarlyBuyer(address account, bool state)
        external
        onlyOwner
    {
    ...
    function bulkIsEarlyBuyer(address[] memory accounts, bool state)
        external
        onlyOwner
    {
