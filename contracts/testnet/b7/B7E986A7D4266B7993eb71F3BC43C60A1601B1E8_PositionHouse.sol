...
library PositionHouseFunction {
    ...
    function getClaimAmount(
        ...
        console.log("funding payment", fundingPayment.abs());
        totalClaimableAmount =
            totalClaimableAmount +
...
//        int256 totalQuantity = _positionDataWithoutLimit.quantity + _quantity;
        ...
        )
    {
        ...
        if (_oldPosition.quantity != 0) {
            ...
            console.log("funding payment in calcRemainMarginWithFundingPayment", fundingPayment.abs(), _oldPosition.quantity.abs());
        }
