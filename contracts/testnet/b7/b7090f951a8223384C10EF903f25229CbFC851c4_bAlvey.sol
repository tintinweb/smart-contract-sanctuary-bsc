...
contract bAlvey is ERC20, Ownable {
    ...
    constructor() payable ERC20("Baby Alvey", "bAlvey") {

        rewardToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // Alvey token
        ...
        treasuryWallet = 0x8a5472379978D186571f58f82697d845d7b26515;

        dividendTracker = new DividendTracker(5_000_000, rewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // PCS Mainnet
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount >= 0, "SwapTokensAtAmount must be greater than 0.001% of total supply");
