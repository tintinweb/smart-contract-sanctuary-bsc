...
contract ChainToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    
    using SafeMath for uint;

    uint256 private totalTokens;

    constructor() ERC20("Chain Token", "CHT") {
        totalTokens = 4200 * 10 ** 6 * 10 ** uint256(decimals()); // 4200M
