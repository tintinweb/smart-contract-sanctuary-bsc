...
contract SpaceRat is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "SpaceRat";       //Full name
    string public symbol_ = "SUN";      //abbreviation
    ...
    address public lpRewardToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;      //Dividend tokens 0x55d398326f99059fF775485246999027B3197955

    uint256 public maxburn = 10000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x000014e9d69547c673Ef39fa60316462beD06bec;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 10000 * (10**18);       //Supply
