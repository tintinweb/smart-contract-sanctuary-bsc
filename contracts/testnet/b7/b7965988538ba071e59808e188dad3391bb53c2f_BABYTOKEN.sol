...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        uint256 totalSupply_ =  2 * 10**13 * (10**18);
        uint256 minimumTokenBalanceForDividends_ = totalSupply_.div(10**4);// 0.01%
        uint8[3]  memory feeSettings=[20,20,10];
        address[4]  memory addrs = [address(0xF000942c4398360aace96a16DCbAfCBDe3752b1B), address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3), address(0xF000942c4398360aace96a16DCbAfCBDe3752b1B), address(0x94c8a5DD8116a59e9c893EE7D29BA3940D084594)];
        rewardToken = addrs[0];
        ...
        require(totalFees <=60, "Total fee is over 60%");
