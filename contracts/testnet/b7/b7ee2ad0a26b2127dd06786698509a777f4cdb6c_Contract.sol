...
contract Contract is ERC20Pausable, AccessControl {
    ...
    function _setFees(uint256 inputTotalFee) internal {
        require(inputTotalFee <= 25, "Error: fees need to be smaller than 25!");
        _totalFee = inputTotalFee;
    }

    function setFees(uint256 newTotalFeePercent) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _setFees(newTotalFeePercent);
    }
    ...
    function _setFeeRouterAndPair() internal {
