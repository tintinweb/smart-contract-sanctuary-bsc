...
contract LGO is ERC20 {
    ...
    address _tokenOwner;
	address _baseToken = address(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd);//0x55d398326f99059fF775485246999027B3197955
    IERC20 public USDT;
    GogezillaWarp warp;
    IERC20 public pair;
	...
	address public _fundAddress = address(0xd9C3C033888312217910cB2C2d19A2a10C201E3A);
	address public _luckAddress = address(0xd69Ee41352249Af8843637289102Fcb5F974d78c);
    ...
    constructor(address tokenOwner) ERC20("LGO", "LGO") {
		...
		total = 10**24;
        _approve(address(this), address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1), total.mul(10000));//0xD99D1c33F9fC3444f8101754aBC46c52416550D1
