...
contract LodicoinToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("LODICOIN", "LODI", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x2a3ee83D4A70B663EEe4190Cb7d5b8aDD0A5eB64;
        developmentGuardReceiver = 0x8cbE2429d99b646f361E9Edf3D3e0a1c77f54DFA; 
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum > (_totalSupply * 1 / 10000)/1e9, "Cannot set maxTransactionAmount lower than 0.01%");
    ...
    function setInSwap(bool _flag) public onlyOwner {
        inSwap = _flag;
    }
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        ...
        for(uint256 i = 0; i < airdropWallets.length; i++){
            ...
            _transferFrom(msg.sender, wallet, amount);
        }
        return true;
    }
    //staking pool
    function calculateProfit(uint256 _stakeAmount) public view returns (uint256){
        ...
        return(
            (((_stakeAmount * 100 * 10**RATE_DECIMALS) / totalPoolAmount) / 100) * LCBR_TOKEN_AMOUT
        );
    }
