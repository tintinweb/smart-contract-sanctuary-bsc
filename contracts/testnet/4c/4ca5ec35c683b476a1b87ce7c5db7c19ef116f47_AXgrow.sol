...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4707154C46394C29f73D747fA8c0959D9c3Cb94A;
...
contract AXgrow is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4707154C46394C29f73D747fA8c0959D9c3Cb94A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AxGRowe";
    string private _symbol = "$AXGROWe";
