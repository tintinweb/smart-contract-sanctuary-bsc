    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _spotHouse)
        public
        initializer
    {
    ...
    function createPairManager(
        ...
        require(_quoteAsset != _baseAsset, "IDENTICAL_ADDRESSES");
        require(
        ...
        bytes32 salt = keccak256(abi.encodePacked(_baseAsset, _quoteAsset));
        assembly {
            _pairManager := create2(0, add(bytecode, 32), mload(bytecode), salt)
        }

        IPairManager(_pairManager).initialize(
            _quoteAsset,
            _baseAsset,
            spotHouse,
            _basisPoint,
    ...
    IPairManager
{
    ...
    function initialize(
        ...
        // TODO shorter string and define in Errors
        require(_isInitialized == false, "!Initializable");
        ...
        )
    {
        ...
        if (
            ...
            // open market
            (sizeOut, quoteAmount) = _openMarketPositionWithMaxPip(
                size,
                isBuy,
                pip
            );
    ...
    function resetFee() public override onlyCounterParty {
        baseFeeFunding = 0;
        quoteFeeFunding = 0;
    }
        ...
        onlyOwner
    {
        ...
        emit UpdateBasisPoint(address(this), _newBasisPoint);
    }
        ...
        onlyOwner
    {
        ...
        emit UpdateBaseBasicPoint(address(this), _newBaseBasisPoint);
    }
    ...
    function _internalOpenMarketOrder(
        ...
        emit Swap(msg.sender, _size, sizeOut);
        emit MarketFilled(
            _isBuy,
            sizeOut,
            singleSlot.pip,
