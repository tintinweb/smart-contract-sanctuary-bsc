...
contract TEST1 is Ownable {
    ...
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 80;

    uint256 private constant MIN_WITHDRAW = 0.00000000000001 ether;
    uint256 private constant MIN_INVESTMENT = 0.00000000000001 ether;
    uint256 private constant TIME_STEP = 1 days;
    
    uint256 private constant REINVEST_TIME_STEP = 0 days;
    
    uint256 private constant WITHDRAW_TIME_STEP = 0 days;
    
    uint256 private constant DAILY_INTEREST_RATE = 70;
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 1000;
    uint256 private constant ON_WITHDRAW_AUTO_REINTEREST_RATE = 0;
	uint256 private constant PERCENTS_DIVIDER = 1000;
	uint256 private constant TOTAL_RETURN = 2100;
	uint256 private constant TOTAL_REF = 160;
	uint256[] private REFERRAL_PERCENTS = [80, 40, 20, 1, 1];
    ...
    function reinvest() public {
		require(investors[msg.sender].lastWithdrawDate.add(REINVEST_TIME_STEP) <= block.timestamp,"Reinvest limit is 1 withdrawal in 24 hours");
        uint256 dividendAmount = getDividends(msg.sender);

        //0% daily reinvestment
    ...
    function withdraw() public {
		require(investors[msg.sender].lastWithdrawDate.add(WITHDRAW_TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 withdrawal in 5 days");
