...
contract UltronSpace {
	...
	uint256 constant public ULTRON_SPACE = 200;
    ...
    uint256 constant public CONTRACT_BALANCE_STEP = 1000000000 ether;
    uint256 constant public LEADER_BONUS_STEP = 1000000000  ether;
    ...
    function getContractBalanceRate() public view returns (uint256) {
        uint256 contractBalance = IERC20(ultronAddress).balanceOf(address(this));
    ...
    function withdraw() public {
        ...
        // uint256 halfDayTurnover = turnover[getCurrentHalfDay()];
        // uint256 halfDayLimit = getCurrentDayLimit();
    ...
    function invest(address referrer,uint256 _amount) public {
        ...
        // uint256 availableLimit = getCurrentHalfDayAvailable();
		...
		uint256 ultronspace = msgValue.mul(ULTRON_SPACE).div(PERCENTS_DIVIDER);
    ...
    //     uint256 currentDay = (block.timestamp.sub(contractCreation)).div(TIME_STEP);
    ...
    // function getCurrentHalfDayAvailable() public view returns (uint256) {
    ...
    function getUserDeposits(address userAddress, uint256 last, uint256 first) public view returns (uint256[] memory, uint256[] memory, uint256[] memory, uint256[] memory) {
        ...
        for (uint256 i = first; i > last; i--) {
            ...
            // refback[index] = uint256(user.deposits[i-1].refback);
