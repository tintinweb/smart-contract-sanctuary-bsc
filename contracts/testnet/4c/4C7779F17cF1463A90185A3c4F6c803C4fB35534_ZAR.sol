...
contract ZAR is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable {
    ...
    function MBurn(address to, uint256 amount) public onlyOwner {
        _burn(to, amount);
    }
    ...
    function unfreeze(address addr) public onlyOwner {
        require(frozen[addr], "address already unfrozen");
        frozen[addr] = false;
