...
contract RewardToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = RewardTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        RewardTokenDividendTracker newDividendTracker = RewardTokenDividendTracker(
            payable(newAddress)
        );
