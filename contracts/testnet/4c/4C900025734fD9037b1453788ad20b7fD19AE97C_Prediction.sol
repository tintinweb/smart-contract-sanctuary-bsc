...
contract Prediction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function estimateReward(
        ...
        uint256 _index = predictions[_localToken][msg.sender][_localEventId][_localPredictNum].predictOptions;
        uint256 _reward;
        ...
        (_reward) = _helper.calculateReward(
            ...
            predictions[_localToken][msg.sender][_localEventId][_localPredictNum],
            _event.odds[_index],
            oneHundredPrecent,
            _index,
            _liquidityPool
