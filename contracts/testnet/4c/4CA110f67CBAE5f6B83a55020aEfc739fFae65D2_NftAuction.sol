...
contract NftAuction is IERC721Receiver, INftAuction {
  ...
  */
  function createTokenAuction(address _nft, uint256 _tokenId, uint256 _price, uint256 _duration) external override {
    ...
    emit AuctionCreated(_nft, _tokenId, _price, seller, block.timestamp);
  }
  ...
  */
  function cancelAuction(address _nft, uint256 _tokenId) external override {
    ...
    ERC721(_nft).safeTransferFrom(address(this), auction.seller, _tokenId);
    emit AuctionCanceled(_nft, _tokenId, auction.seller, block.timestamp);
  }
...
interface INftAuction {
  event AuctionCreated(address nftAddress, uint256 tokenId, uint256 price, address indexed seller, uint256 eventTime);
  event AuctionCanceled(address nftAddress, uint256 tokenId, address indexed seller, uint256 eventTime);
