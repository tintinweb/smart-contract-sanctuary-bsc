...
contract Implementation is Initializable, UUPSUpgradeable, GetterSetter {
     ...
     * @param (0) total copies, (1) onSaleQuantity, (2) price, (3) token type, (4) amount, (5) isOffer
     * @param (0) buyer, (1) seller, (2) signer, (3) collectionAddress, (4) tokenAddress
     * @param (0) nftId, (1) saleOrderId, (1) transactionId
    ...
    /**
     * @dev Handler buy request
     * @param (0) token id, (1) onSaleQuantity, (2) price, (3) token type, (4) amount, (5) royalty fee, (6) isOffer
     * @param (0) buyer, (1) seller, (2) signer, (3) collectionAddress, (4) tokenAddress
