...
contract BnbMaster {
	...
	uint[] public					REFERRAL_PERCENTS				= [70, 50, 10, 10, 10, 5, 5, 5, 5];	// 7% 5% 1% 1% 1% 0.5% 0.5% 0.5% 0.5%
	uint constant public			DEV_FEE							= 100;					// dev fee 10% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 25 ether;				// claim 25 BNB max per time
	...
	constructor(address payable _walletDev) {
		...
		PLANS.push( TPlan(300,10) ); // 1% per day for 300 days
	}
