...
// File: contracts/METAPUNKNFT.sol
...
contract METAPUNKNFT is ERC721A, Ownable, ERC721Holder {
    using Strings for uint256;
    ...
    string baseURI =
        "https://crypto-nfts.mypinata.cloud/ipfs/QmZGzBwxdMmBK65ue3oUaxBMJwBxffXv96UA2jNYdbMAuq/";
    //Uri for mastery box NFT ipfs  ###Remember end with /
    string public notRevealedUri =
        "https://crypto-nfts.mypinata.cloud/ipfs/QmZGzBwxdMmBK65ue3oUaxBMJwBxffXv96UA2jNYdbMAuq/";
    uint256 public mintPrice = 0.01 ether;
    uint256 public presaleMintPrice = 0.005 ether;

    string baseExtension = ".json";
    //Change to your image type .gif / .png
    string imageExtension = ".png";

    constructor() ERC721A("MetaPunk NFT", "MetaPunkNFT") {}
