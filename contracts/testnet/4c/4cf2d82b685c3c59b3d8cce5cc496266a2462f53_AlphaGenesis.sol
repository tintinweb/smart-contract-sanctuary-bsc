...
contract AlphaGenesis is BEP20, Ownable {
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum > (totalSupply() * 5 / 1000)/10**18, "");
        ...
        if(takeFee){
            ...
            // Buying process without DumpCircuit
                ...
                if(walletSellDumpCircuitEndTime[to] == 0){
                    ...
                    walletSellDumpCircuitEndTime[to] = amount >= holderBalance ? block.timestamp + dumpcircuitDuration : walletSellDumpCircuitEndTime[to] + (dumpcircuitDuration * (amount*10**18/holderBalance))/10**18;
    ...
    function getHolderDumpCircuitSellTax(address wallet) public view returns (uint256){
        ...
        uint256 walletDumpCircuitTax = (dumpcircuitTax*(timeRemainingForDumpCircuit*10**18/dumpcircuitDuration))/10**18;
