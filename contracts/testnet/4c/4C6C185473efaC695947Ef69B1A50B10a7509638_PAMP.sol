...
contract PAMP is ERC20, ReentrancyGuard, Ownable {
    ...
    bool public swapForRewardsOnTransfer = true;
    ...
    function _transfer(address _from, address _to, uint256 _amount) internal override {
        ...
        if (takeFees) {
            ...
            _reflectionsFee = _amount.mul(reflectionsFee).div(100);
            ...
            if (dividendsInETH && !automatedMarketMakerPairs[_from]) {
                ...
                // Works if user is selling token from LP Pool, but not when user is buying token
    ...
    function claimETH() external nonReentrant {
        require(dividendsHoldersInfo[msg.sender].claimableETH > 0, "Cannot claim 0 amount");
        ...
        uint256 claimableDividends = dividendsHoldersInfo[msg.sender].claimableETH.mul(100).div(totalSupply());
