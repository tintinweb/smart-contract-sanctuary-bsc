...
contract NFT is Ownable, ERC721URIStorage, ReentrancyGuard {
    ...
    function getCurrentSupplyCount() view public returns (uint256) {
...
//??
    ...
    function mintNFT() external payable {
        ...
        require(LAUNCH_SUPPLY <= MAX_SUPPLY, "max supply reached");
        _safeMint(msg.sender, newItemId);
        LAUNCH_SUPPLY++;
    }

    function withdraw() public payable onlyOwner{  //noReentrant
