...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAbCE315D10Be896BFA60ddF4d9F76AAd76f3231;
...
contract DominoFi is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF7AcD29a45f51B36F98a9dBd60bf706F09858972;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 750000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DominoFi";
    ...
    uint256 public _maxTxAmount = 750000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 750000000 * 10**18;
