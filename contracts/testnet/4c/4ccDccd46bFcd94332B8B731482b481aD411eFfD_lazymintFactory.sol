...
contract lazymintFactory is AccessControl {
    ...
    function create(
        ...
        LazyNFT lazynft = new LazyNFT(market, _maxsupply, name_, symbol_, _uri, _collection);
...
contract LazyNFT is AccessControl, ERC721P {
    ...
    uint256 internal presaleSupply = maxsupply / 2;
    uint256 internal valuation;
    uint256 internal price = 10 ether;
    uint256 internal presale = 5 ether;
