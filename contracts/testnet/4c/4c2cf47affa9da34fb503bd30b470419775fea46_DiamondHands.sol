...
contract DiamondHands is ERC20, Ownable, BaseToken {
    ...
    constructor(
    ...
    ) payable ERC20("DiamondHands", "DiamondHands") {
        ...
        uint256 minimumTokenBalanceForDividends_ = 100000 * 10**18;
    ...
    function getNumberOfDividendTokenHolders() external view returns (uint256) {
     ...
     //Locks the contract for owner for the amount of time provided
    function updateStartTime(uint256 time) public virtual onlyOwner {
        startTime = time;
    }
