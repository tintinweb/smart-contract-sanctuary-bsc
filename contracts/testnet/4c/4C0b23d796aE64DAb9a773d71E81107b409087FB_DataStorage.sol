...
contract DataStorage {
    ...
    function getJDroidBotCreating(uint256 _pandoBoxLevel) external pure returns (uint256, uint256) {
        return (10000 * 100000 * (MULTIPLIER ** _pandoBoxLevel) / (PRECISION ** _pandoBoxLevel), 1000 * 2000000 * (MULTIPLIER ** _pandoBoxLevel) / (PRECISION ** _pandoBoxLevel));
    }
    ...
    function getJDroidBotUpgrading(uint256 _droidBot1Level) external pure returns (uint256, uint256) {
        ...
        return (10000 * 100000 * (MULTIPLIER ** _droidBot1Level) / (PRECISION ** _droidBot1Level), 1000 * 2000000 * (MULTIPLIER ** _droidBot1Level) / (PRECISION ** _droidBot1Level));
    }
}
