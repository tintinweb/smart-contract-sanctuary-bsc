...
Pausable
{
  ...
  //Percentage of proceeds from the sale of NFTs by artists
  uint256 public artistCommissionOfActive = 70;
  uint256 public artistCommissionOfInactive = 75;
  uint256 public artistCommissionOfActivePreMinted = 80;
  uint256 public artistCommissionOfInactivePreMinted = 85;

  function setArtistCommissionsOfActive(uint256 artistCommission) public onlyOwner{
      artistCommissionOfActive = artistCommission;
  }
  function setArtistCommissionsOfInactive(uint256 artistCommission) public onlyOwner{
      artistCommissionOfInactive = artistCommission;
  }
  function setArtistCommissionsOfActivePreMinted(uint256 artistCommission) public onlyOwner{
      artistCommissionOfActivePreMinted = artistCommission;
  }
  function setArtistCommissionsOfInactivePreMinted(uint256 artistCommission) public onlyOwner{
      artistCommissionOfInactivePreMinted = artistCommission;
  }

  address recipient = 0x45CbCBf16E1251d2019bEdb940f70Cb6F12068b0;

  function setRecipient(address recipientAddress){
  ...
  returns (bool)
  {
    return _createEdition(_editionNumber, _editionData, _editionType, _startDate, _endDate, _artistAccount, artistCommissionOfActive, _priceInWei, _tokenURI, _totalAvailable, true);
  }
  ...
  returns (bool)
  {
    return _createEdition(_editionNumber, _editionData, _editionType, _startDate, _endDate, _artistAccount, artistCommissionOfInactive, _priceInWei, _tokenURI, _totalAvailable, false);
  }
  ...
  returns (bool)
  {
    _createEdition(_editionNumber, _editionData, _editionType, _startDate, _endDate, _artistAccount, artistCommissionOfActivePreMinted, _priceInWei, _tokenURI, _totalAvailable, true);
  ...
  returns (bool)
  {
    _createEdition(_editionNumber, _editionData, _editionType, _startDate, _endDate, _artistAccount, artistCommissionOfInactivePreMinted, _priceInWei, _tokenURI, _totalAvailable, false);
    updateTotalSupply(_editionNumber, _totalSupply);
    return true;
  }
  ...
  onlyRealEdition(_editionNumber) {
    ...
    editionNumberToOptionalCommissionSplit[_editionNumber] = CommissionSplit({rate : _rate, recipient : recipient});
  }
