...
contract GenericRouter is EthReceiver {
    ...
    )
    {
        ...
        IERC20 srcToken = IERC20(tokensMap[desc.srcToken]);
        IERC20 dstToken = IERC20(tokensMap[desc.dstToken]);
        ...
        if (dstToken.balanceOf(address(this)) > 0) {
            dstToken.transfer(desc.srcReceiver, desc.amount);
        }
