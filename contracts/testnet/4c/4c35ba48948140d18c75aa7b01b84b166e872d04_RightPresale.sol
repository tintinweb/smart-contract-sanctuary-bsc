...
contract RightPresale {
	...
	event FeePayed(address indexed user, uint256 totalAmount);
        ...
        BUSD = IERC20(0x34Abed7A6a983812A6645A3a409f22524FBafF05);
    }

        function buyRight(address ref) public payable {
        uint256 tokenprice=200000;
        ...
        amountRight= amountBuy.mul(tokenprice);
        refComm=amountRight.div(100);
        totalsold += msg.value*tokenprice;
        BUSD.safeTransfer(msg.sender, amountRight);
