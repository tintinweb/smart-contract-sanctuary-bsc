...
contract StakePoolBNBForToken is States, Ownable {
    ...
    function setTokens(uint256 _earlyUstakeFee, IBEP20 _rewardingToken, address _rewardingTokenWallet) public onlyOwner {
    ...
    function setTokens(IBEP20 _stakingtoken, IBEP20 _rewardingtoken) public onlyOwner {
        isStakeActive = true;
    ...
    function _unstakeBNB() internal {
        ...
        _msgSender().transfer(wUser.amount);
    ...
    function EarlyUnstakeBNB() public {
        ...
        _msgSender().transfer(wUser.amount.sub(_fee));
...
contract FactoryStakingPool{
    ...
    function createBNBForToken(address ownerAddress, uint256 _earlyUstakeFee, IBEP20 _rewardingToken, address _rewardingTokenWallet) public returns (address)
    {
        StakePoolBNBForToken toDeploy = new StakePoolBNBForToken();
        toDeploy.setTokens(_earlyUstakeFee, _rewardingToken, _rewardingTokenWallet);
