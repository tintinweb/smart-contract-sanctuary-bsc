...
contract CamlyExchangeMarket is AccessControl{
    ...
    */
    ...
    /**
        @notice this function accepts all tokens for donation.
        @param tokenAddress - address of the token, which is used as donation token(WETH/WBNB/WMATIC...).
        @param donationAddress - address of receiver, who will receive the donation amount.
    ...
    /**
        @notice this function accepts all NFT tokens for donation.
        @param tokenAddress - address of the NFT contract address, which is used as donation token.
        @param donationAddress - address of receiver, who will receive the NFT.
