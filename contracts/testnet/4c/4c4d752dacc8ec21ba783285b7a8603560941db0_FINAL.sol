...
//web3tokeninfo
    ...
    function CirculatingSupply() public view  returns (uint256){
        return (totalSupply()  - balanceOf(address(stakeWallet)) - balanceOf(address(rewardWallet)) - balanceOf(address(this)) - balanceOf(owner()))/10**18;
        //totalsupply -fee - staking - owner
    }
...
//web3shareholder
    function stakewallet() private view returns (address) {
        return stakeWallet;
    }
}