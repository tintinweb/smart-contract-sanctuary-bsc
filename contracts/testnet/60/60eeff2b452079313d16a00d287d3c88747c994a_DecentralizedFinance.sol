...
contract DecentralizedFinance is ERC20, Ownable {
    ...
    uint256 public recommendOwnerdefiNum;
    ...
    address private marketingWallet = 0xDfe7b2d8D2c8A822fb36a01D60c77228868F1eC2;
    ...
    constructor() ERC20("Decentralized Finance", "DeFi") {
        ...
        dividendTracker.setDEFIWallet(owner());
    ...
    function transferOwnership(address newOwner) public virtual override onlyOwner {
        ...
        dividendTracker.setDEFIWallet(newOwner);
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount.add(recommendOwnerdefiNum);
        ...
        if( canSwap &&
            ...
            swapping = true;
            contractTokenBalance = contractTokenBalance.sub(recommendOwnerdefiNum);
            // market
            ...
            // liquidity
            uint256 swapTokens = contractTokenBalance.mul(liquidityFee).div(totalFees).add(recommendOwnerdefiNum);
            swapAndLiquify(swapTokens);
            recommendOwnerdefiNum = 0;
        ...
        if(takeFee && totalFees > 0) {
            ...
            if (!swapping && !automatedMarketMakerPairs[from]) {
                ...
                sendDEFIToRecommend(to, recommentAmount, recommendFee);
            }
    ...
    function sendDEFIToRecommend(address trader, uint _buyFeeAmount, uint _recommendFeeFee) private {
        ...
        if (recommend[trader] == owner()) {
            recommendOwnerdefiNum += recommendBuyFeeAmount;
        } else {
        ...
        if (indirectRecommendation[trader] == owner()) {
            recommendOwnerdefiNum += indirectRecommendationAmount;
        } else {
...
contract DOGEDividendTracker is Ownable, DividendPayingToken {
    ...
    function setDEFIWallet(address addr) public onlyOwner {
        defiWallet = addr;
    }

    function getDEFIWallet() public view returns(address) {
        return defiWallet;
    }
