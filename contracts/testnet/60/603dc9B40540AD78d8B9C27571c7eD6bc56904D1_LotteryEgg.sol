...
contract LotteryEgg {
    ...
    //Get unopened eggs count
    function GetUnopenedeggscount(address adr) public view returns(uint256)
    {
        return Usersinfo[adr].eggsinfo.length;
    }
    //Get eggs balance
    ...
    function Getinvestmentbalance(address investoraddress) public view returns(uint256){
        return InvestorsBalance[investoraddress].balance;
    }
    //Investment deposit
