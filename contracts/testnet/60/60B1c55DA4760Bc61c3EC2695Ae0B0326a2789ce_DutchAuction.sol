    ...
    IERC721ReceiverUpgradeable
{
    ...
    /// Settles Interface NFT Offer
    /// @param nftContractAddress Contract address on auction
    /// @param tokenId Identifier of the NFT
    /// @param pushPrice NFT Price Accepted
    function executeOffer(address nftContractAddress, uint256 tokenId, uint256 pushPrice) external{
        _transferNftAndPaySeller(nftContractAddress, tokenId, pushPrice);
    }
