    ...
    BEP721BurnableUpgradeable
{
    ...
    uint256 private quamserviceValue;
    address private QuamAddress;
    ...
    function initialize() public initializer {
        __Ownable_init();
        BEP721Upgradeable.__BEP721_init("Quam Network", "Quam");
        _tid = 1;
    ...
    function getQUAMFee() public view returns (uint256) {
        return quamserviceValue;
    }

    function quamserviceFunction(uint256 _quamserviceValue) public onlyOwner {
        quamserviceValue = _quamserviceValue;
    }
    ...
    function setTokenAddress(address _quamAddress, address _Wethaddress)
        public
        onlyOwner
    {
        QuamAddress = _quamAddress;
    ...
    function newtokenasbid(
        ...
        if (tokenAddress == QuamAddress) {
            fee = quamserviceValue;
        }
