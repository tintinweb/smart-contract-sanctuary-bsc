...
import {Incentive} from "./SubLevel/Incentive.sol";
...
contract IncentiveFactory {
  ...
  event IncentiveCreated(address _Owner, address _Token, uint256[6] _Seed_Details, uint256[6] _Presale_Details, uint256[6] _Community_Details);
  ...
  function setSaleMasterAddress(address _saleMasterAddress) public onlyOwner {
    address prev_address = _saleMasterAddress;

    saleMasterAddress = _saleMasterAddress;
    _saleMaster = iSaleMaster(_saleMasterAddress);

    emit SaleMasterAddressChanged(prev_address, saleMasterAddress);
  }
  ...
  function createIncentive(address owner_, address _token, uint256[6] memory _seed_details, uint256[6] memory _presale_details, uint256[6] memory _community_details) public returns (address) {
    ...
    emit IncentiveCreated(owner_, _token, _seed_details, _presale_details, _community_details);
