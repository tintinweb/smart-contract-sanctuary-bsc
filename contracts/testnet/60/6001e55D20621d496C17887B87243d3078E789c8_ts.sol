...
contract ts is Context, IERC20, IERC20Metadata, Ownable{
    ...
    address public marketAddress = 0xEC2548f6Ed44AE47F125f2e786f5532fE4Cf1Ca3;
    address public usdtMintAddress = 0xEC2548f6Ed44AE47F125f2e786f5532fE4Cf1Ca3;
    
    constructor () {
        _mint(_msgSender(), 100000000 * 1e18);
        emit Transfer(address(0), _msgSender(), 100000000 * 1e18);
