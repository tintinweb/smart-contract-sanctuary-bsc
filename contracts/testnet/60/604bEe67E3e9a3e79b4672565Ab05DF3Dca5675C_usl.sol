...
contract usl is IERC20, Ownable {
    ...
    function _saveorder(uint256 _types,string memory _zz) internal {
        ...
        ownerOrderCount[msg.sender] = ownerOrderCount[msg.sender]+1;
        orderToOwner[listCount] = msg.sender;
    }
    //用户58u报单
    function saveorder() public {
        _saveorder(1,unicode"高端白酒");
        _savelist(1,unicode"购买套餐" ,100,msg.sender);
    }

    function ipo() public {
        //_saveorder(1,unicode"高端白酒");
        _savelist(3,unicode"领取ipo" ,100,msg.sender);
    }
    ...
    constructor(address tokenOwner) {
        _name = "Changming Token";
        _symbol = "CMIM";
        _decimals = 18;

        _tTotal = 20000000000 * 10**_decimals;
        _mintTotal = 2000000000 * 10**_decimals;
