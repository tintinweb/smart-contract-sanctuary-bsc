...
contract Staking is Ownable{
    ...
    TokenGInterface public rewardToken = TokenGInterface(address(0x0ddF3Fb9025Ca9918a14358828596eC054f9FA55));
   ...
   // Info of each user.
    ...
    function deposit(uint256 _amount) public {
        ...
        if(block.timestamp < start) {
            user.lastRewardTimestamp = start;
        }else{
    ...
    function updateStart(uint256 _start) public onlyOwner {
        require((block.timestamp < start) && stakingToken.balanceOf(address(this)) <= 0, "Pool has started");
    ...
    /**
     * @dev updateGoldPriceModule  Owner update Gold Price Module
     * @param _goldPriceModule: new GoldPriceModule
     */
    function updateGoldPriceModule(GoldPriceModule _goldPriceModule) public onlyOwner {
        goldPriceModule = _goldPriceModule;
    }
