 ...
 \  \:\ \:\/:/ \  \:\/:/    \__\/  /  /:/ \  \:\__/\_\/
  \  \:\_\::/   \  \::/           /  /:/   \  \:\ \:\  
   \  \:\/:/     \__\/           /  /:/     \  \:\/:/  
    ...
    Aeon is a gaming token, being used for the main in-game currency for Aeon Colony - A story driven, semi-open world survival metaverse,
    Make sure to join one of our channels to keep updated with the development.
    
    To start with, we will have a 6% tax on every buy and 12% on every sell, this will be spread out as follows:
    1% | 2% of every buy|sell transacion is added to the liquidity.
    2% | 4% of every buy|sell transacion is converted to BNB and is funds used to purchase assets, pay designers, artists etc - All the work that needs to be outsourced.
    3% | 6% of every buy|sell transaction is converted to BNB and added to the marketing funds
...
contract VVIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BJMG VVIP";
    string private _symbol = "VVIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57b894207C4e96141C66e0ac3595D0DCdDccf97a); // marketingWalletAddress need to be change
    address payable public DevOutsourceWallet = payable(0x57b894207C4e96141C66e0ac3595D0DCdDccf97a); 
    ...
    uint256 public _devShare = _buyDevFee.add(_sellDevFee);
    ...
    function setDevOutsourceWallet(address newAddress) external onlyOwner() {
        DevOutsourceWallet = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBDev > 0)
            transferToAddressETH(DevOutsourceWallet, amountBNBDev);
