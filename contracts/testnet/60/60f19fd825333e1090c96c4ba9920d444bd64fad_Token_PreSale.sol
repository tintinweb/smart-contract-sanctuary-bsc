...
contract Token_PreSale is Ownable {
    ...
    constructor(address _tokenSale) public {
        ...
        _meltStatus = false;
		_endSaleBlock = block.number.add(5000);
		_openBlockArr[0] = _endSaleBlock.add(0);
		_openBlockArr[1] = _endSaleBlock.add(100);
		_openBlockArr[2] = _endSaleBlock.add(200);
		_openBlockArr[3] = _endSaleBlock.add(300);
	}
