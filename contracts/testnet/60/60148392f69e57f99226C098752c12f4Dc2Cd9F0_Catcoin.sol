...
contract Catcoin is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        console.log("---------------1 swap and liquify-------------");
        ...
        if (contractTokenBalance > 0 &&
            ...
            console.log("swap and liquify start ", contractTokenBalance);
            swapAndLiquify(contractTokenBalance);
            console.log("swap and liquify end ");
        }
        console.log("---------------2 token transfer-------------");
        console.log("CATCOIN _transfer token start");
        bool takeFee = true;
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            takeFee = false;
        }
        _tokenTransfer(from, to, amount, takeFee);
        console.log("CATCOIN transfer token end");
    }
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if (charityAmt > 0) {
            payable(_charitywallet).transfer(marketingAmt);
        }

        if (operationAmt > 0) {
            payable(_operationwallet).transfer(marketingAmt);
        }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        console.log("_isExcluded[sender]", _isExcluded[sender]);
        console.log("_isExcluded[recipient]", _isExcluded[recipient]);
