...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5a3aA03a2243ABdf57147630dDDBf6c9bCA2a76B;
...
contract VeraInfinity is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x9ce3d43c7D96687Cf7Db141352aD26f288Bf0FE8;
    ...
    string private _name = "VERA INFINITY";
    ...
    uint256 public maxSellPerDay = 2000000 * 10**1 * 10**18;
    ...
    function setAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressMarketingFee) external onlyOwner {
        ...
        _addressFees[_address]._marketingFee = _addressMarketingFee;
    }
    
    function setBuyAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressMarketingFee) external onlyOwner {
        _addressFees[_address].enable = _enable;
    ...
    function setSellAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressMarketingFee) external onlyOwner {
        _addressFees[_address].enable = _enable;
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(_addressFees[from].enable){
                ...
                if(to == uniswapV2Pair){
                    ...
                    _marketingFee = _addressFees[from]._sellMarketingFee;
                }
            }
            else{
