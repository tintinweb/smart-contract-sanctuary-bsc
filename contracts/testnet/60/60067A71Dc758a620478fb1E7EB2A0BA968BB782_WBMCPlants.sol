...
abstract contract WBMCWarbots is _loc {
    
    function assembleWarbot (uint256 _plant, uint256 _plantlevel, address _target ,  Location  memory _location,  uint256 _period, uint256 _warbotposition, string memory __tokenURI) external virtual returns(uint256);
    function _tokenURI ( ) external virtual returns ( string memory );
...
contract WBMCPlants is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, _loc  {
    ...
    uint256 public deposits=392000000000;
    ...
    constructor(address _EngineEcosystemContractAddress ) ERC721("MicroMachineWarBots", "MMWarBot") {
        ...
        manufacturingPeriod = 10 seconds; //remove for mainnet
    ...
    function setEngineEcosystemContractAddress ( address _address ) public onlyOwner {
        ...
        _enginecontract = EngineEcosystemContract ( _address );
    ...
    function setLocation ( uint256 _plant , Location memory _location) public onlyEcosystem {
        ManufacturingPlants[_plant]._location = _location;
    }
    
    function setPlantProfile ( uint256  _plant , uint256 _profile ) public onlyEcosystem {
        plantProfile[_plant] = _profile;
    }
    
    function setName ( uint256 _plant , string memory _name) public onlyEcosystem {
        ManufacturingPlants[_plant]._name = _name;
    }
    
    function setFuturesOnPlant ( uint256 _plant, uint256 _period , bool _switch ) public onlyEcosystem {
    ...
    function setManufacturingPeriod( uint256 _minutes ) public onlyEcosystem {
    ...
    uint256 public migrationFee = 15000000000000000;
    
    function setMigrationFee (uint256 _migrationFee ) public onlyOwner {
        migrationFee = _migrationFee;
    }

   

    function migratePlant ( uint256 _plant, address _owner,  uint256 _micromachinesstaked, uint256 _timeofexpiration, uint256 _timeunitslocked, uint256 _timeinitiated, uint256 _lastmanufacture, uint256 _warbotsmanufactured, uint256 _periodproductionrate, uint256 _periodsmanufactured, bool _status  ) public onlyEcosystem {
    ...
    function upgradePlant ( uint256 _plant ) public {
        ...
        ManufacturingPlants[_plant]._level++;
         ...
         ERC20 _nano = ERC20(_enginecontract.returnAddress("NMAC"));
        _nano.transferFrom ( msg.sender , address(this), calculatePlantUpgradeCost( _plant, ManufacturingPlants[_plant]._level ));
        _nano.transfer( _enginecontract.returnAddress("NanoReserve"), calculatePlantUpgradeCost( _plant, ManufacturingPlants[_plant]._level ));
    }
    ...
    function setPlantMaxLevel( uint8 _maxlevel ) public onlyEcosystem {
        plantMaxLevel = _maxlevel;
    }
    
    function setUpgradeCost( uint256 _cost ) public onlyEcosystem {
        require ( _cost > 0 , "cost bust be greater than zero");
        upgradeCost = _cost * 10 ** 18;
    }
    
    function transferPlant ( address _owner , uint256 _plant, address _newowner ) public  {
        ...
        plantArrayPosition[userManufacturingPlants[_owner][pos]] = pos;
    ...
    function manufacture( uint256 _plant, uint256 _option ) public payable {
        ...
        */
        ...
        WBMCWarbots _wbmcwarbots = WBMCWarbots (_enginecontract.returnAddress("WBMCWarbots"));
        for ( uint i = 0; i < _option; i++ ) {
           ...
           _wbmcwarbots.assembleWarbot ( _plant, ManufacturingPlants[ _plant]._level,  msg.sender ,  ManufacturingPlants[ _plant]._location, ManufacturingPlants[ _plant]._periodsmanufactured, _warbotposition,  _wbmcwarbots._tokenURI());
        }
    ...
    function unstakeMicroMachines ( uint256 _plant ) public  {
        ...
        require ( ManufacturingPlants[ _plant]._periodsmanufactured >= ManufacturingPlants[ _plant]._timeunitslocked && splitManufacturing[_plant] == 0  );
