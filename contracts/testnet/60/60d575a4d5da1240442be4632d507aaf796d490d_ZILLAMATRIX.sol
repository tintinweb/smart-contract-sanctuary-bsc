...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);
...
contract ZILLAMATRIX is IBEP20, Auth {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**33 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[0xaA31C42a159B2C707566FD75e30EA0893E58E862] = true;
        isTxLimitExempt[0xaA31C42a159B2C707566FD75e30EA0893E58E862] = true;

        isTimelockExempt[0xaA31C42a159B2C707566FD75e30EA0893E58E862] = true;
        ...
        marketingFeeReceiver = 0xBBaB8a041C6a9d87abf4796f348880dFc120edE5;
        devFeeReceiver = 0xBBaB8a041C6a9d87abf4796f348880dFc120edE5;

        _rBalance[0xaA31C42a159B2C707566FD75e30EA0893E58E862] = rSupply;
        emit Transfer(address(0), 0xaA31C42a159B2C707566FD75e30EA0893E58E862, _totalSupply);
    }
