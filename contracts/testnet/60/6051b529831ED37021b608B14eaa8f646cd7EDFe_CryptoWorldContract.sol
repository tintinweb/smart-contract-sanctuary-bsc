...
contract CryptoWorldContract is Ownable, ReentrancyGuard {
    ...
    function _contractSecurityLockFunction() private {
        ...
        if (address(this).balance <= (picoMaximoDoContrato / 100) * 50)
        {
    ...
    // function getPicoSecurityLock() public view returns(uint256 picoMaximoDoContratoVal, uint256 picoFlutuanteDoContratoVal, bool contractSecurityLockVal)
    // {
    //     picoMaximoDoContratoVal = picoMaximoDoContrato;
    //     picoFlutuanteDoContratoVal = picoFlutuanteDoContrato;
    //     contractSecurityLockVal = contractSecurityLock;
    // }
}
