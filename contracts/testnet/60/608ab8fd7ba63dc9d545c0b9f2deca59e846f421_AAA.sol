...
contract AAA is Context, IERC20 { /// Switch

    using SafeMath for uint256;
    using Address for address;

    address private _owner = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0); ///
    address public Wallet_Liquidity = _owner; /// And here check this
    address payable public Wallet_Marketing = payable(_owner); /// Check what he wants here! 

    // Token Info
    string private  _name = "AA_TEST"; /// Switch
    string private  _symbol = "AA"; /// SWT
 ...
 ///   IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    uint256 private swapTrigger = 3; /// put to 11
    uint256 private burnTrigger = 6; /// Update to 51 
    ...
    function Contract_SetUp_07__Update_Project_Wallets(
        ...
        require(Marketing_Wallet != address(0), "E06"); // Enter a valid wallet address
    ...
    */
    ...
    function Rewards_Include_Wallet(address account) external onlyOwner() {
        require(account != Wallet_Burn, "ERR"); // Can not inlcude burn wallet in rewards
    ...
    */
    ...
    function _transfer(
        ...
        require(balanceOf(from) >= amount, "Sender does not have enough tokens!"); ///err mess
    ...
    */
    ...
    function swapAndLiquify(uint256 Tokens) private {
        ...
        if(BNB_Owner > 0){
            ...
            send_BNB(owner(), BNB_Contract); /// Check if wallet owner ok or other 
