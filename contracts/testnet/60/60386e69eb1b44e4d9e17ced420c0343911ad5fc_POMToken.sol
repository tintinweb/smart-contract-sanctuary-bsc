...
contract POMToken is BEP20('Pomwap', 'POM') {
    ...
    */
        ...
        external
    {
        ...
        require(nonce == nonces[signatory]++, "POM::delegateBySig: invalid nonce");
        require(now <= expiry, "POM::delegateBySig: signature expired");
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "POM: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "POM: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "POM: index out of bounds");
