...
contract TopGunAI {
   ...
   // uint256 public MIN_INVEST = 50 ether; /** 50 BUSD  **/ MAINNET
    uint256 public MIN_INVEST = 5 ether; /** 50 BUSD  **/ //TESTNET
  //uint256 public ACTION_COOLDOWN = 86400; /** 24 hours  **/ MAINNET
    uint256 public ACTION_COOLDOWN = 120; /** 2 nmin  **/ //TESTNET
   
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 ether; /** 10,000 BUSD  **/
    uint256 public REFERRAL = 10;  //
    uint256 public JETS_TO_HIRE_1MINERS = 632;//3888000; // 2%
    ...
    address private sustainability;
     ...
     //uint256 public TOP_DEPOSIT_STEP = 86400; // 24 hrs MAINNET
     uint256 public TOP_DEPOSIT_STEP = 600; // 10 min TESTNET
    ...
    function compoundJets(bool isCompound) public {
        ...
        if(isCompound) {
            ...
            if(user.dailyCompoundCount == 2*COMPOUND_FOR_NO_TAX_WITHDRAWAL)
            {
              uint256 jetsReward = calculateJetsBuy(user.initialDeposit);
              uint256 minerRewards = jetsReward.div(JETS_TO_HIRE_1MINERS);
