...
// File: contracts/KongProject/KongBUSD_v3.sol
...
contract KongStakeV3 is Ownable, ReentrancyGuard {
    struct user{   
        uint256 totalStakedBalance;
        uint256 totalClaimed;
        uint256 totalCompounded;
    ...
    address public dev1 = 0xe36e8740d842261eA6e2f8afb91EEB9CfD946D1b;
    address public dev2 = 0xe36e8740d842261eA6e2f8afb91EEB9CfD946D1b;
    address public dev3 = 0xe36e8740d842261eA6e2f8afb91EEB9CfD946D1b;
    ...
    uint256 public magnitude = 1000000000;
    ...
    */
    ...
    function getClaimableBalance(uint256 _stakeId) public view returns(uint256){
        ...
        uint applicableDividends = ((userStakeDetails.stakeAmount * ((roi * magnitude)/3600))/(percentageDivisor))/magnitude; //divided by 10000 to handle decimal percentages like 0.1%
    ...
    function getElapsedTime(uint256 _stakeId) public view returns(uint256){
        userStake memory userStakeDetails = userStakesById[_stakeId];
        uint256 lapsedDays = block.timestamp - userStakeDetails.lastActionedTime;
        return lapsedDays;  
    }
