...
contract TokenPresaleBridge is Ownable {
    ...
    uint256 public tokensPerBnb =  35866596650*1e18; // .25% of 1 
    ...
    uint256 public totalBnbCap = 300*1e18;
    ...
    constructor() {
        address token = address(0x2faD176D48Ba7bF9bE26edFd38A1c1EEd8c54b95);
        
        tokenAddress = token;
        transferOwnership(0xB83a423FC88602D73eb1402f0325719Ae4ED94f2);
    }
