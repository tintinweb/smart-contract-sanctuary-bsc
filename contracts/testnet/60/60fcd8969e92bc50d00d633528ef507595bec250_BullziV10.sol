...
contract DividendDistributor is IDividendDistributor {
    ...
    //0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7 busd tesnet
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
          ...
          //  BUSD.transfer(addr_taxes,amount2);           
...
contract BullziV10 is ERC20Detailed, Ownable {
    ...
    uint256 public treasuryFee = 20; // 2% Achats + 2% Vente
    uint256 public safuDividendFee = 90; // -> 5% Holders 3% Dev 2 % SIF
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 20; //  2% Burn
    ...
    constructor() ERC20Detailed("BullziV10", "BullziV10", uint8(DECIMALS)) Ownable() {
