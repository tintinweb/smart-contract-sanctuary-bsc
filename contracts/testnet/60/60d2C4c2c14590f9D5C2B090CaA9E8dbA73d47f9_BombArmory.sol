...
contract BombArmory {
    ...
    address erctoken = 0x84392649eb0bC1c1532F2180E58Bae4E1dAbd8D6; /** BUSD Mainnet **/
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 1000 * 1e18; /** 10000 BUSD  **/
    ...
    function CHANGE_PRIZE(address value) external {
        require(msg.sender == prize, "Admin use only.");
        prize = value;
    }
