...
contract ENTERNAME is BEP20, LockToken {
    ...
    address payable public _marketingWalletAddress = payable(0x8FDF94D4A0E847af325d53FB62319CEE44f831B4);
    address payable public _buybackWalletAddress = payable(0xc764C2C00839AB4b9Df55Ab04b7C99B61e4E74BA);
    ...
    constructor() BEP20("TESTLAUNCH", "TEST") 
    {
