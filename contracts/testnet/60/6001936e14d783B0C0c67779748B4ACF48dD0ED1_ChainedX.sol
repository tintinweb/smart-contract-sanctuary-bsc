...
contract ChainedX is ERC20, Ownable {
    ...
    address public burnAd = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 private buyoperationFee;
    uint256 private buyBurnFee;
    uint256 private buyLiquidityFee;

    uint256 public sellTotalFees;
    uint256 private selloperationFee;
    uint256 private sellBurnFee;
    uint256 private sellLiquidityFee;

    uint256 private tokensForoperation;
    ...
    constructor() ERC20("ChainedX", "CHDX") {
        ...
        uint256 _buyoperationFee = 0;
        uint256 _buyBurnFee = 0;
        uint256 _buyLiquidityFee = 0;

        uint256 _selloperationFee = 1;
        ...
        operationWallet = address(0xb50b4fC27554cAc9D55B11894455A29f90d2DB53);
   ...
   struct buyfeeRatesStruct {
    ...
    sellfeeRatesStruct public sellFeeRates = sellfeeRatesStruct(
     {_selloperationFee : 1,
      _sellBurnFee : 1,
      _sellLiquidityFee : 1,
      totalSellFees: 3
    ...
    buyfeeRatesStruct public buyFeeRates = buyfeeRatesStruct(
     {_buyoperationFee : 0,
      _buyBurnFee : 0,
      _buyLiquidityFee : 0,
      totalBuyFees : 0
    ...
    function setRouterAddress(address newRouter) external onlyOwner returns (address) {
        
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(newRouter);
         
        return newRouter;
    }
    function setSwapThreshold(uint256 _swapTokensAtAmount) external onlyOwner  {
...
function unstuckETH(address payable destination) public onlyOwner{
   ...
   payable(destination).transfer(ethBalance);
    ...
    function _transfer(
        ...
        uint256 amountToBurn = tokensForBurn;

        transfer(burnAd, amountToBurn);
    ...
    function swapBack() private {
        ...
        uint256 ethForoperation = ethBalance.mul(tokensForoperation).div(
            totalTokensToSwap
        );
