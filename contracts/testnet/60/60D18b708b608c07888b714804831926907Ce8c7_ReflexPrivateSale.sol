...
contract ReflexPrivateSale is Crowdsale, FinalizableCrowdsale, AccessControlUpgradeable {
  ...
  function updateCapPercentage(uint256 _capPercentage) external onlyOwner {
    ...
    function finalization() virtual internal override{
      ...
      uint256 refundBalance = tokenBalanceInContract - tokensSold - tokensForReflexOwner;
      if(refundType == 1){
