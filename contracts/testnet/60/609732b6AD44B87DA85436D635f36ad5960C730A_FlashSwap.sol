...
contract FlashSwap {    
    ApePair lp;
    constructor(ApePair _lp) public {
        lp = _lp;
    }

    function swap(uint256 amount0Out, uint256 amount1Out, uint256 _amount) public {
        ApeERC20(lp.token0()).transferFrom(msg.sender, address(lp), _amount);
        lp.swap(
