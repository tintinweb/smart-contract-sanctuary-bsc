...
///////
    ...
    function Take_chest (uint256 num_Track, uint256 chest_num) public {
        ...
        MITICOIN.transfer(msg.sender, _MITI/100*procent_owner*1000);
        USDT.transfer(msg.sender, _USDT/100*procent_owner*1000);

        MITICOIN.transfer(dis.getLandLord(), _MITI/100*procent_landlord*1000);
        USDT.transfer(dis.getLandLord(), _USDT/100*procent_landlord*1000);
