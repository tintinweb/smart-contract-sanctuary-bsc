...
// File: contracts/OptimusMinter.sol
 ...
 * @title Optimus
 */
contract OptimusMinter is ERC721, Ownable, ReentrancyGuard {
    ...
    function mintNFTs(uint256 _mintAmount) external onlyOwner {
    ...
    function getAllNfts(address user) public view returns (uint256[] memory){
        uint256[] memory ret = new uint256[](_tokenSupply.current());
