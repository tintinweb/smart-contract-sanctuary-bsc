...
contract Token is ERC20, Ownable {
    ...
    uint256 public timeDelayPool = 3600 seconds;

    constructor() ERC20("Rimer Finance Testnet _0", "RimerT_0") {
        _mint(address(this), INITIAL_SUPPLY);
    
        poolStartTime = block.timestamp;
        Token.transfer(address(this), 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2, 1e5);
    }
   ...
   function claim() external returns (bool) {
        require(block.timestamp - _timestamps[msg.sender] >= timeDelay, "Token: you can't claim during the next 60 minutes");
