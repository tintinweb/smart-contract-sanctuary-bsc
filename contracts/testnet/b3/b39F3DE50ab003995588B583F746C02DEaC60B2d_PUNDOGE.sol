...
contract PUNDOGE is IBEP20, Ownable {
    ...
    string private _name = "PUN DOGE";
    string private _symbol = "PUNDOGE";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x8D935f23C3987Ff4c9770b50aB783Bd05Fc3119A,
        treasury: 0x0A202fde8B0C08394E9B78E06aAC76B93c71bbC8,
        marketing: 0x02446D7F5CaA5A6bcccddb716859e397c6123a2d
    });
    ...
    uint8 private miscRewardSplit=100;
    ...
    address public mainReward = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdatetreasuryWallet(address newtreasuryWallet);          
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        _excluded.add(_taxWallet.treasury);
...
///// AUTHORIZED FUNCTIONS /////
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newDev + newLiquidity + newtreasury + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newDev, newLiquidity, newtreasury, newMarketing, newRewards);
    }
    ...
    function withdrawtreasury() external authorized {
        uint256 amount = treasuryBalance;
        treasuryBalance = 0;
        _sendBnb(_taxWallet.treasury, amount);
    }
    ...
    function settreasuryWallet(address payable addr) external authorized {
        address prevtreasury = _taxWallet.treasury;
        _excluded.remove(prevtreasury);
        _taxWallet.treasury = addr;
        _excluded.add(_taxWallet.treasury);
        emit UpdatetreasuryWallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 dev, uint256 treasury, uint256 marketing) {
        return (buybackBalance, devBalance, treasuryBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 treasurySplit = (bnbAmount*_taxRatios.treasury) / distributeRatio;      
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (isContractTransfer || isLiquidityTransfer || isExcluded) {
            ...
            require(tradingEnabled || isWhitelisted[recipient] || isWhitelisted[sender], 'Trading has not been enabled yet.'); 
