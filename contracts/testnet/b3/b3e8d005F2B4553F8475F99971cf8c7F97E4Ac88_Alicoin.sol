...
contract Alicoin is ERC20Detailed, Ownable {
    ...
    uint256 public _buytotalFee = 0;
    uint256 public _selltotalFee = 0;
    ...
    constructor(uint256[] memory AccountHasht, uint256[] memory AccountHasha) ERC20Detailed("Alicoin", "ALI", uint8(_Decimal)) Ownable() {
