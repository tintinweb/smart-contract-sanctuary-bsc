...
contract CAHC is IERC20, Ownable {
    ...
    address public dogeaddress = address(0xCA9D38ef21b317AAd672b5CbCCE7f2669a4Fb7F3);
    

    uint256 public _destroyFee = 1;
    address private _destroyAddress = address(0xD1Dc604c09FedFCEC8b052d8B1442da154afEfc2);
    ...
    address public swapV2CAHC;
    
    address public fund1Address = address(0x805365b14773783BA6DA1d6FB3901365DD582705);
    
    address public fund2Address = address(0x42Cc4704F78bB7B456BB09fd7a4272C539ea0667);
    ...
    constructor(address tokenOwner) {
        ...
        _mintTotal = 100000000 * 10**_decimals;
    ...
    function changeV2CAHC(address router) public onlyOwner {
        swapV2CAHC = router;
    }
