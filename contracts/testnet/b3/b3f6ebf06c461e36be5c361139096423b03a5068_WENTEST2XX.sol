...
/**
 * This is the 4th wentstx LFG 3% BUSD REWARDS
*/
...
Telegram: Private till after launch
...
contract WENTEST2XX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Wem Test 4XX";
    string constant _symbol = "TS4";
    ...
    uint256 targetLiquidity = 70; // 70% from total collected liquidity(3% on every Transfer) will be used to rewarded liquidity providers
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x88741F85e530bE77F7bb142d00bC3Dbf8Da4D8E3;
        marketingFeeReceiver = 0x7AEFf9B17A94F2e9b10951e7FEDd390e7EA362c1;
        ecosystemfeeReceiver = 0xa4529C4DCa31fdc86Af7e8360f680e62E7569C7d;
