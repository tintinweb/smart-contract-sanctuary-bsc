...
//    uint256 reserve = 2 ether;
    ...
    function arb(address _fromToken, address _toToken, uint256 _fromAmount, bytes memory _0xData, bytes memory _oneInchData) onlyOwner payable public {
    ...
    function trade(address _fromToken, address _toToken, uint256 _fromAmount, bytes memory _0xData, bytes memory _1inchData) onlyOwner payable public {
