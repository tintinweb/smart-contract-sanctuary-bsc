...
contract PotionNFT is ERC721Enumerable, Ownable {
    ...
    function _getPotionPowers(uint256 _tokenId) internal view returns(uint256[7] memory){
        Potion memory i = potions[_tokenId];
        return [i.powers.water,i.powers.fire,i.powers.metal,i.powers.air,i.powers.stone,i.powers.rest,i.powers.xp];
    }
