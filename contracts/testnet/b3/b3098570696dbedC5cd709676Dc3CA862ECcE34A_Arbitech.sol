...
contract Arbitech is ERC20, ERC20Detailed {
    ...
    uint256 public maxSlotTime = 7884000; 
    ...
    constructor () ERC20Detailed("Arbitech Solution", "ArbiCoin",18) {
        ...
        currentSupply = balanceOf(address(this));
    ...
    function WithdrawableTokens(address _user) public view returns(uint256){
        ...
        Supply = tokenBalance.sub(_reward);/////changing _reward
        TokenPerMinutes = (Supply.div(Duration));
    ...
    function withdraw(address _owner) public onlyOwner {
        uint256 transferReward = WithdrawableTokens(_owner);
        withdrawlAmount += transferReward;
        require(withdrawlAmount <= balanceOf(address(this)), "Not enough balance!");
        transfer(_owner, transferReward);
        currentSupply -= transferReward;
    }
