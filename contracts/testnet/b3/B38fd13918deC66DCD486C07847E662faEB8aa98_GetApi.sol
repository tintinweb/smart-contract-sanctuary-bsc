...
contract GetApi is ChainlinkClient, ConfirmedOwner {
    ...
    constructor() ConfirmedOwner(msg.sender) {
        setChainlinkToken(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06); //avax 0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846 //bsc : 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
        setChainlinkOracle(0xa98AC187050b67350A33db16E7096a4333A85CCf); // bsc: 0xCC79157eb46F5624204f47AB42b3906cAA40eaB7 , avax : 0x022EEA14A6010167ca026B32576D6686dD7e85d2
        jobId = "6546c7425f8140909ccdc54992c30d50";
    ...
    function check_response(uint256 _response) internal {
         require (_response == 1, "transaction not complient");
         test();
    }
