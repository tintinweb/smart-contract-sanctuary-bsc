...
contract KINGAPETOKEN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KING APE";
    string constant _symbol = "KAPE";
    ...
    uint256 _maxTxAmount = 15 * 10**3 * (10 ** _decimals);
    uint256 _walletMax = 3 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xe11798B7018De6c80e5401ff2A0c7b3Ec18e1194;
        devWallet = 0x1265E336eD4ff40B76AD7b8d3d4503D26978A29F;
