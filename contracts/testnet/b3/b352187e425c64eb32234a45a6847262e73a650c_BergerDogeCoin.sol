...
contract BergerDogeCoin is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xd330547ecA71787a2C4Ed739b658E5dE4B8219c2;
    address public devWallet = 0x72Ddf57efc0ac2E8dbC88E87179c5f7A9dE3C083;
    address public reserveWallet = 0xA545F672C59825408C4301DF0352945e6C0C7c2d;

    address public loteryWallet;

    string private constant _name = "Berger Doge Coin v4";
    string private constant _symbol = "BergerDoge v4";
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
        uint256 liquidity;
    ...
    // Buy 1% reflection, 1% mkt, 1% dev, 1 loterry
    Taxes public buyTaxes = Taxes(1, 1, 1, 1, 1);
    // Sell 23% reflection, 23% mkt, 23% lq, 23% dev, 1 loterry
    Taxes public sellTaxes = Taxes(23, 23, 23, 23, 1);
