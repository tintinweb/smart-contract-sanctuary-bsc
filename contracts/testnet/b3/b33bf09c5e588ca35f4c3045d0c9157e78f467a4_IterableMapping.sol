...
contract FNL0711ttx is ERC20, Ownable {
    ...
    constructor(address newOwner) ERC20("FNL0711ttx", "FNL") 
    {
        _transferOwnership(newOwner);
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy, uint256 _liquidityFeeOnBuy, uint256 _burnFeeOnBuy,uint256 _rewardFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy + _devFeeOnBuy + _liquidityFeeOnBuy + _burnFeeOnBuy + _rewardFeeOnBuy <= 12, "Fees cannot be more than 12%");
