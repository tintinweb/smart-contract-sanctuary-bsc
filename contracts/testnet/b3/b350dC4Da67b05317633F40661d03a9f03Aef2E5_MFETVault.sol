...
contract MFETVault is Context, Ownable, ReentrancyGuard {
    ...
    function changePayoutRate(uint8 _rate) public onlyOwner {
        require(_rate > 0 && _rate <= 100, "must between 1-100");
        payoutRate_ = _rate;
    }
        ...
        returns (uint256)
    {
        ...
        mfetT.transferFrom(msg.sender, address(this), _reward);
        ...
        returns (uint256)
    {
        ...
        mfetT.transferFrom(msg.sender, address(this), _investAmount);
        ...
        returns (uint256)
    {
        ...
        mfetT.transfer(msg.sender, _dividends);
        ...
        onlyInvestors
    {
        ...
        mfetT.transfer(msg.sender, _amountOfTokens);
