...
contract InfiniteBattles is Ownable {
    ...
    event BattleWon(address indexed winnerAddress, uint256 lastBlockReward);
    ...
    function battleWinner(uint256 blockId_, address winner_) external returns(uint256) {
        ...
        emit BattleWon(winner_, currentBlock.lastRewardsBlock);
    }
