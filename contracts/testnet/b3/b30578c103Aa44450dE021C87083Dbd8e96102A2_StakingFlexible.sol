...
contract StakingFlexible is TokenStakeOwnable, ReentrancyGuard {
        ...
        updateCumulativeIndex(usersStake[_msgSender()][stakeIndex].stakeToken)
    {
        ...
        TokenStakeInfo memory _stakeInfo = tokenStakeInfo[
    ...
    function _setEmissionPerDay(
        address _stakeToken,
        uint256 _initEmissionPerDay
    ) internal updateCumulativeIndex(_stakeToken) {
