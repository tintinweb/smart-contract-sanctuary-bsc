...
contract BitdriveLaunchpad is Owned {
    ...
    function getTokenPerUser() public view returns (uint256) {
        ...
        uint256 remainingTokens = (totalSupply >= round2Amount)
            ...
            : 0;
        uint256 eachTier = (remainingTokens>0 && round2Users>0)?remainingTokens / round2Users:0;
    ...
    function availableVesting(address _user) public view returns (uint256,uint256,uint256) {
        ...
        diff = lastClaimed-block.timestamp;
        uint calcVesting = diff / vestingPeriod;
...
contract Proxy is ContextUpgradeable, OwnableUpgradeable {
    ...
    function unstakeTest(address _user, uint256 numberOfdays)
        public
