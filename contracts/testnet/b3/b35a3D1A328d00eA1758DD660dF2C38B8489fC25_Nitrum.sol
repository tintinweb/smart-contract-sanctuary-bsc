...
contract Nitrum is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nitrum Network";
    string private _symbol = "NMX";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x900D4ffd0c6aCD028402d5dB4dC777492034f2da);
