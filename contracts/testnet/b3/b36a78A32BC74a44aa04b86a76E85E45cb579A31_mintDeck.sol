...
contract mintDeck is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://app.lasthorde.com/NFTs/{id}.json") {
         ...
         createIde( "Ademius");
          ...
          createIde( "Skeleton");
          mint( msg.sender,"Skeleton",700,1);
          createIde( "SkeletonV");
          mint( msg.sender,"SkeletonV",230,2);
          createIde( "SkeletonD");
          mint( msg.sender,"SkeletonD",50,3);
           createIde( "SkeletonR");
          mint( msg.sender,"SkeletonR",15,4);
           createIde( "SkeletonM");
          mint( msg.sender,"SkeletonM",5,5);
          createIde( "Spider");
          ...
          createIde( "TimulV");
          mint( msg.sender,"TimulV",230,2);
          createIde( "TimulD");
          mint( msg.sender,"TimulD",50,3);
           createIde( "TimulR");
          mint( msg.sender,"TimulR",15,4);
           createIde( "TimulM");
          mint( msg.sender,"TimulM",5,5);
          createIde( "Tower");
          mint( msg.sender,"Tower",700,1);
          createIde( "TowerV");
          mint( msg.sender,"TowerV",230,2);
          createIde( "TowerD");
          mint( msg.sender,"TowerD",50,3);
           createIde( "TowerR");
          mint( msg.sender,"TowerR",15,4);
           createIde( "TowerM");
          mint( msg.sender,"TowerM",5,5);
          createIde( "Troll");
          mint( msg.sender,"Troll",700,1);
          createIde( "TrollV");
          mint( msg.sender,"TrollV",230,2);
          createIde( "TrollD");
          mint( msg.sender,"TrollD",50,3);
           createIde( "TrollR");
          mint( msg.sender,"TrollR",15,4);
           createIde( "TrollM");
          mint( msg.sender,"TrollM",5,5);
          createIde( "WarHorn");
          mint( msg.sender,"WarHorn",700,1);
          createIde( "WarHornV");
          mint( msg.sender,"WarHornV",230,2);
          createIde( "WarHornD");
          mint( msg.sender,"WarHornD",50,3);
           createIde( "WarHornR");
          mint( msg.sender,"WarHornR",15,4);
           createIde( "WarHornM");
          mint( msg.sender,"WarHornM",5,5);
          createIde( "Werewolf");
          mint( msg.sender,"Werewolf",700,1);
