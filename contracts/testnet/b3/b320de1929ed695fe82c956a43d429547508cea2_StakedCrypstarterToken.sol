...
contract StakedCrypstarterToken is
    ...
    VaultOwned
{
    ...
    modifier onlyStakingContract() {
        require(
            ...
            "StakingContract: caller is not staking contract"
        );
        _;
    }
    ...
    uint256 private _totalSupply; // total fragment supply
    ...
    function initialize(uint256 _index) public initializer {
        __ERC20_init("StakedCrypstarterToken", "sCST");
        __Ownable_init();
    ...
    function _setIndex(uint256 _index) internal onlyInitializing {
        INDEX = gonsForBalance(_index);
    }

    // do this last
    function setAddresses(address _stakingContract, address _treasury)
        external
        onlyOwner
    {
    ...
    /**
        @notice increases total supply relative to profit_
        ...
        returns (uint256)
    {
        ...
        console.logUint(circulatingSupply_);
        if (profit_ == 0) {
