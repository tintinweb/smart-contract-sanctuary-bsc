...
//cardType |  1-11 is constelle  |  12-15 is Tenjin
...
contract NFTPackage is ERC721, Member {
    using Strings for uint256;

    event OpenCard(address account, uint8[] cardType);
    ...
    function open(uint256 packageId) external {
        ...
        emit OpenCard(msg.sender, cardIdPres);
    }
