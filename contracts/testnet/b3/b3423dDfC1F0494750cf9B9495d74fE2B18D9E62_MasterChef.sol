...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // Safe FANC transfer function, just in case if rounding error causes pool to not have enough BASHs.
    ...
    function updateEmissionRate(uint256 _fancPerBlock) public onlyOwner {
        massUpdatePools();
