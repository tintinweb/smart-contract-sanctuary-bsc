...
contract TWD is ERC721A, Ownable, ReentrancyGuard { 
    ...
    address public creator = 0xbF1496057ABb59B6c1f7223FC1Bc49909aAD7537;
    address public digitone = 0x3BFaa933274CFDcd8DECff4B59359117f368f3f3;
    address public feeAddress = 0x9c485b7c742e5ea82B636a6e6f001126fD25f337;
    ...
    function withdrawFee(uint256 _value) internal {
        uint256 pay = SafeMath.mul(4875, _value);
        ...
        uint256 pay2 = SafeMath.mul(4875, _value);
        ...
        (bool os2, ) = payable(feeAddress).call{value: _left}("");
        require(os2, "pay fee failed" );
    }
