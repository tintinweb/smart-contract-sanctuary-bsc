...
contract Presale is Ownable {
    ...
    function deposit(uint256 amount) public {
        ...
        require(publicSaleActive || privateSaleAccess[msg.sender], "You do not have access to the Private Sale");
    ...
    function withdrawProjectExpenses() public onlyOwner {
        require(BUSD.balanceOf((address(this))) > 50000 * 1e18, "Balance too low");
