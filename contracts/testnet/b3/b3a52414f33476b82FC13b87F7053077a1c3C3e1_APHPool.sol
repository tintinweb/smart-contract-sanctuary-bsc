...
contract APHPool is PoolBase, PoolSetting, PoolEvent, PoolToken {
        ...
        returns (WithdrawResult memory)
    {
        ...
        // TODO: add transfer out for interest if ot zero
        return result;
    }
...
contract AssetHandler {
    ...
    address public constant wethHandler = 0x3E039E0Fce25C031559C8e7890aB33e24c71b7B6;
    ...
    function _transferFromOut(
        ...
        if (token == wethAddress) {
            ...
            WETHHandler(wethHandler).withdrawETH(to, amount);
...
contract StakePoolBase is AssetHandler, Ownable, Manager {
    struct StakeInfo {
