...
contract LamaToken is ERC20, ERC20Burnable, Ownable, Pausable, EmergencyGuard {
    ...
    constructor(
        ...
        _approve(contractAddress, address(uniswapRouter), initialSupply);
        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(contractAddress, _uniswapV2Router.WETH());
    ...
    * @param user address of the user than will now have to pay transaction fees.
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        if (!pairAddresses[_msgSender()]) {
            ...
            uint256 contractBnbBalance = contractAddress.balance;
    ...
    function swapLamaTokensForBnb(uint256 amount) internal {
        ...
        _approve(contractAddress, address(uniswapRouter), amount);
