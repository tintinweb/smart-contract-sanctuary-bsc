...
library Address {
    ...
    function functaticCall(address target, bytes memory data) internal view returns (bytes memory) {
        return functaticCall(target, data, "Address: low-level static call failed");
    }
    
    function functaticCall(address target, bytes memory data, string memory errorMessage) internal view returns (bytes memory) {
...
contract XXTEST is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0x546305842553E6c6a8CfD973F8798F1C0DF31b75);
    address payable private _liquidityWalletAddress = payable(0x83F54926cF75944E67854B0d09940819489E4293);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "XXXTEST";
    ...
    //setting the fees for auto LP 
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
   
    //fee for the marketing wallet 
    uint256 private _marketingFee = 3;
    uint256 private _previousMarketingFee = _marketingFee;
    
    //max wallet holding _maxWalletToken * 10**9 
    uint256 public _maxWalletToken= 1000000 * 10**9;
                                     
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    //this is the maximum transaction amount (in tokens) 
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x546305842553E6c6a8CfD973F8798F1C0DF31b75)] = true;
        ...
        _isExcluded[address(0x546305842553E6c6a8CfD973F8798F1C0DF31b75)] = true;
    ...
    function tokenFromReflection(uint256 rAmount) public view returns(uint256) {
        require(rAmount <= _rTotal, "Amount must be less than total reflec");
    ...
    function setFeeMarketingPercent(uint256 marketingFee) external onlyOwner() {
