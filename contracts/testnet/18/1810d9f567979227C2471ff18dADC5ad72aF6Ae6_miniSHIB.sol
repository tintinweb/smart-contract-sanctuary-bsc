...
contract miniSHIB is Context, IERC20, Ownable {
    ...
    address private _owner = (0x6FAb006e100181BEf669bC872F53C6A297a9e584);
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x6FAb006e100181BEf669bC872F53C6A297a9e584); // Marketing Address
        
        devAddress = payable(0x6FAb006e100181BEf669bC872F53C6A297a9e584); // Dev Address
        ...
        emit Transfer(address(0x6FAb006e100181BEf669bC872F53C6A297a9e584), _owner, _tTotal);
    }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 100, "Must keep buy taxes below 100%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 100, "Must keep sell taxes below 100%");
