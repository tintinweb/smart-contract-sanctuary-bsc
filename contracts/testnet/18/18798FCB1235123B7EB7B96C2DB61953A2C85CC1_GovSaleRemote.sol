...
contract GovSaleRemote is
    ...
    function init(
        ...
        endpoint = ISaleGatewayRemote(factory.dstSaleGateway()).lzEndpoint();
    ...
    function estimateFees(
        ...
        (fees,) = endpoint.estimateFees(dstChainId, factory.dstSaleGateway(), getPayload(_amountIn, _buyer), false, getAdapterParams());
    ...
    function buyToken(uint128 _amountIn) external payable whenNotPaused nonReentrant {
        ...
        ISaleGatewayRemote(factory.dstSaleGateway()).buyToken{value: feeNeeded}(address(factory), getPayload(_amountIn, sender), getAdapterParams(), tax);
    ...
    // todo: remove these vars after testing
    uint128 public remoteRaisedC;
    uint128 public remoteRevenueC;
    uint256 public remoteSoldC;
    address[] public remoteUsersC;
    uint128[] public remoteUsersBoughtC;
    uint128[] public remoteUsersReceivedC;
    uint128[] public remoteUsersFeeC;

    function finalize(bytes calldata _payload) external {
        require(_msgSender() == factory.dstSaleGateway(), "unknown");
        ...
        // todo: remove these vars after testing 
        remoteRaisedC = raised;
        remoteRevenueC = revenue;
        remoteSoldC = sold;
        remoteUsersC = remoteUsers;
        remoteUsersBoughtC = remoteUsersBought;
        remoteUsersReceivedC = remoteUsersReceived;
        remoteUsersFeeC = remoteUsersFee;
    }
