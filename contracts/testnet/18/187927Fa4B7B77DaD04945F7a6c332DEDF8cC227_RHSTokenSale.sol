...
contract RHS is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "Readhead Solutions";
    string private _name= "RHS";
...
contract RHSTokenSale {
    ...
    constructor(RHS _tokenContract, uint256 _tokensSold)  {
...
function buyTokens(uint256 _numberOfTokens, address _refer) public payable {
		...
		uint256 _refertokens=(_numberOfTokens*10)/100;
