...
contract Arcadian is Context, BEP20, Ownable, BEP20Burnable{
    ...
    function _reflectFee(uint256 tAmount) private {
        ...
        (,,uint256 rFee) = _getRValues(tAmount, tFee,currentRate);
    ...
    function _swapTokensForBNB(uint256 tokenAmount) public onlyOwner {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
