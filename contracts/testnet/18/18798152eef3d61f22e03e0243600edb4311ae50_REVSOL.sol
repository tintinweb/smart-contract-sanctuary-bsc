...
contract REVSOL is Context, IERC20, Ownable {
    ...
    string private _name = "REVSOL TOKEN";
    string private _symbol = "REVSOL";
    ...
    uint256 public _maxWalletSize = 4000000000 * 10**18; // 4%
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**18; // 0.1%
