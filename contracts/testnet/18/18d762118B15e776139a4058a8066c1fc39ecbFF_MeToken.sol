...
contract MeToken is Ownable, IERC20 {
    ...
    uint8 public splitTimesPerTran = 20;//每次分20个
    ...
    function init() private onlyOwner {
        ...
        swapTokensAtAmount = 1000 ether; //分红价格
    ...
    function _transfer(
        ...
        if(currentSplitIndex > 0 || (balanceOf(address(this))-waitSellTokenNum) >= swapTokensAtAmount){
