...
contract SmartContToken is Context, BEP20, Ownable {
    ...
    function _sendToLiquidity(address sender, uint256 tLiquidity) private {
        ...
        emit TransferFee(sender, address(this), tLiquidity);
    }
    ...
    function _sendToCompany(address sender, uint256 tCompany) private {
        ...
        emit TransferFee(sender, address(this), tCompany);
    }
    ...
    */
    ...
    event TransferFee(address sender, address recipient, uint256 tLiquidity);
