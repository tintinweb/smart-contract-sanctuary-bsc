...
contract ShareTokenRewardPool is Operator {
    ...
    uint256 public constant TOTAL_USER_REWARD = 14400 ether;
    uint256 public constant TOTAL_DAO_REWARD = 1800 ether;
    uint256 public constant TOTAL_DEV_REWARD = 1800 ether;
    uint256 public constant runningTime = 540 days; // 18 months

    uint256 public immutable shareTokenPerSecond;
    uint256 public immutable shareTokenPerSecondForDaoFund;
    uint256 public immutable shareTokenPerSecondForDevFund;
    ...
    constructor(
        ...
        shareTokenPerSecond = TOTAL_USER_REWARD.div(runningTime);
        shareTokenPerSecondForDaoFund = TOTAL_DAO_REWARD.div(runningTime);
        shareTokenPerSecondForDevFund = TOTAL_DEV_REWARD.div(runningTime);
    }
    ...
    function setDepositFeePercent(uint256 _pid, uint256 _value) public onlyOperator {
	...
	function isDaoFund(address _address) public view returns (bool) {
