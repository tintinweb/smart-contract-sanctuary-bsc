...
contract Unitnumbersgame is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant maxSupply = 199;
    ...
    uint256 public AMOUNT1 = 49;
    uint256 public AMOUNT2 = 99;
    uint256 public AMOUNT3 = 149;
    uint256 public AMOUNT4 = 199;
   ...
   struct Info {
    ...
    function freemint(uint256 amount) external {
        ...
        require(totalSupply().add(amount) <= AMOUNT1,"Max supply for freemint reached!");
    ...
    function mintpublic(uint256 amount) external payable {
        ...
        require(totalSupply().add(amount) <= AMOUNT2,"Max supply for mintpublic reached!");
        require(totalSupply().add(amount) <= maxSupply, "max supply would be exceeded");
    ...
    function mintbatch(uint256 amount) external payable {
        ...
        require(totalSupply().add(amount) <= AMOUNT3,"Max supply for mintbatch reached!");
        require(totalSupply().add(amount) <= maxSupply, "max supply would be exceeded");
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply().add(amount) <= AMOUNT4,"Max supply for mint reached!");
        require(totalSupply().add(amount) <= maxSupply, "max supply would be exceeded");
