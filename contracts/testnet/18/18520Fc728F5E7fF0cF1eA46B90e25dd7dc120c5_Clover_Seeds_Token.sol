...
contract BEP20 is Context, IBEP20 {
    ...
    event Value(string str, uint val);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(senderBalance >= amount, "BEP0: transfer amount exceeds balance");
        unchecked {
    ...
    function collectFeeOnBuy(uint256 amount) private returns (uint256) {
        uint256 transferAmount = amount;
    ...
    function swapTokensForBnb(uint256 amount, address ethRecipient) public {
