...
contract TestLBT is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory _name,string memory _symbol,address _router) initializer public {
    ...
    function setRouter() public onlyOwner{
        ...
        isFeeActive = true;
        distributionWallet = _msgSender();
        nftRoyalPoolWallet = _msgSender();
        lotteryPoolWallet  = _msgSender();
