...
contract PrivateSale {
     ...
     */ 
    function withdrawWrongTokenByEmergency(IERC20 _token, address _withdrawalAddress) external onlyOwner returns (uint256) {
        uint256 totalBalance = _token.balanceOf(address(this));
        require(
            _token.transferFrom(address(this), _withdrawalAddress, totalBalance),
