...
contract Token is ERC20, Ownable {
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor() payable ERC20("MAXIM", "MAXIM")  {
        uint256 totalSupply = 10000 * (10**18);
        swapTokensAtAmount = totalSupply.mul(2).div(10**4);
        ...
        marketingWalletAddress = 0xe370a6c717BD2d71edAec70Bd66d70Ce167897A1;
        liquidityReceiveAddress = 0xe183a5235F79eC70c8Bd8096ba340d27B811E280;
    ...
    function _transfer(
        ...
        if (
            ...
            if(block.timestamp<=_scientisttime)
            {
