...
contract KhephrenNFTStaking is IKhephrenNFTStaking {
    ...
    */
    ...
    function createProject(address _nftAddress, bytes[3] memory _projectDetails)
        external
        payable
        virtual
        override
...
interface IKhephrenNFTStaking{
    function createProject(address _nftAddress, bytes[3] calldata _projectDetails) payable external returns (address);
...
contract Project721 is IProject721 {
    ...
    bytes[3] private projectDetails;
    /*
        events
    */
    ...
    function setProjectDetails(
        address _nftAddress,
        bytes[3] memory _projectdetails,
...
interface IProject721{
    function setProjectDetails(address _nftAddress, bytes[3] memory _projectdetails, address _project721Owner) external;
