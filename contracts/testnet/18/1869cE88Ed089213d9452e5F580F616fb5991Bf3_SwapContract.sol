...
contract SwapContract {
    ...
    uint256 public priceforSolachain=20000000*1e18;
    ...
    function SwapTokens() public payable
    {
        ...
        tokenTransfer(msg.sender,(msg.value.mul(priceforSolachain)).div(1e18));
        emit Swap(msg.sender,msg.value,(msg.value.mul(priceforSolachain)).div(1e18),now);
    }
