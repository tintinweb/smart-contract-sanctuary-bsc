...
contract KarnTest1 is Context, Ownable, IERC20 {
    ...
    string private _name = "Karn Test1";
    ...
    feeRatesStruct public buyFees = feeRatesStruct(
     {taxFee: 0,
	  ...
	  liquidityFee: 1000,
      marketingFee: 1000, 
      swapFee: 2000, // referralFee+rewardFee+liquidityFee+marketingFee
      totFees: 0
    });
    ...
    address payable public referralWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    address payable public rewardWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    address payable public liquidityWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    address payable public marketingWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    ...
    uint256 private minTokensToSwap = 50 * 10**8;
    ...
    constructor () {
        ...
        antiwhale_measures[0] = antiwhale({selling_threshold: _tTotal*25/10000, extra_tax: 1});//0.025% of initial supply
        antiwhale_measures[1] = antiwhale({selling_threshold: _tTotal*50/10000, extra_tax: 2});//0.05% of initial supply
        antiwhale_measures[2] = antiwhale({selling_threshold: _tTotal*75/10000, extra_tax: 3});//0.075% of initial supply
