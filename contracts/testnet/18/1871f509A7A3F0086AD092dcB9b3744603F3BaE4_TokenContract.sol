...
contract TokenContract is ERC20, Ownable {
    ...
    // -- Addresses --
    address public _exchangeRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 ;
    
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;

    address public autoLiquidityReceiver = msg.sender;  // TO-DO ---- ADD WALLET
    address public marketingReceiver = msg.sender;      // TO-DO ---- ADD WALLET
    address public developmentReceiver = msg.sender;    // TO-DO ---- ADD WALLET
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 0; buyFee.marketingFee = 60; buyFee.developmentFee = 30;
        buyFee.total = buyFee.liquidityFee + buyFee.marketingFee + buyFee.developmentFee;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 30; sellFee.marketingFee = 60; sellFee.developmentFee = 30;
        sellFee.total = sellFee.liquidityFee + sellFee.marketingFee + sellFee.developmentFee;
    ...
    function ownerSetTargetLiquidity(uint256 target) external onlyOwner {
       ...
       // Use 10 to set 1% -- Base 1000 for easier fine adjust
    function ownerUpdateBuyFees (uint256 _liquidityFee, uint256 _marketingFee, uint256 _developmentFee) external onlyOwner {
        ...
        // Use 10 to set 1% -- Base 1000 for easier fine adjust
    function ownerUpdateSellFees (uint256 _liquidityFee, uint256 _marketingFee, uint256 _developmentFee) external onlyOwner {
    ...
    function _transfer(address sender,address recipient,uint256 amount) private {
        ...
        else if(antiSniperMode)_punishSnipers(sender,recipient,amount);
    ...
    function _distributeBNB(uint256 remainingBNB) private {
        ...
        uint256 totalFee = (developmentFee + marketingFee);

        uint256 amountBNBDevelopment = remainingBNB * (developmentFee) / (totalFee);
        ...
        (bool developmentSuccess, /* bytes memory data */) = payable(developmentReceiver).call{value: amountBNBDevelopment, gas: 30000}("");
