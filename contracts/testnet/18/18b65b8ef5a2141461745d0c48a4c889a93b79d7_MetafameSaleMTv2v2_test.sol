...
contract MetafameSaleMTv2v2_test is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    function initialize(IMF1155 _metafame1155) initializer public {
        ...
        publicSaleStart = 1664344867;
        publicSaleEnd = 1672178299;

        wlRoundNumber =  1;
        wlRound[1] = RoundInfo({
            startTime: 1664344867,
            endTime: 1672178299,
            limit: 500,
            alreadySaled: 0
        });
    ...
    function purchaseBoxPresale(
        ...
        require(metafame1155.getAllocatedBoxQuantity() + 1 <= metafame1155.getMaxSupply() - _FOR_OWNER, "Metafame1155: Reach the max supply");
    ...
    function _mintBox(
        ...
        metafame1155.mint(to, tokenId, 1, gender, skin, tier);
        return tokenId;
    }
    ...
    function makeOver( 
        ...
        uint256 tier = metafame1155.getTier(tokenId);
