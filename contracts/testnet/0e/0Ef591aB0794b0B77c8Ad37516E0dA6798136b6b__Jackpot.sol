...
contract _Jackpot is Ownable {
    ...
    function getJackpotCounter() public view returns (uint256) {
        return jackpotCounter;
    }

    function getLastPoolSize() public view returns (uint256) {
        Jackpot storage j = jackpots[jackpotCounter - 1];
        return j.poolSize;
    }

    function getLastTotalInvested() public view returns (uint256) {
        Jackpot storage j = jackpots[jackpotCounter - 1];
        return j.totalInvested;
    }

    function getLastMinimumBet() public view returns (uint256) {
        Jackpot storage j = jackpots[jackpotCounter - 1];
        return j.minimumBet;
    }
