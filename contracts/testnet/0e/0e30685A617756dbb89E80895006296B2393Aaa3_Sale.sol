...
contract Sale is Ownable, ReentrancyGuard {
    ...
    function withdrawTokens() external {
        ...
        uint256 withdrawn = Formula.mulDiv(amount, Formula.SCALE, Constant.WITHDRAWABLE_RATE);
    ...
    function buyTokens(uint256 _amount, address _stableCoin) external nonReentrant hasSaleRunning {
        ...
        require((boughtCashes[msg.sender] + _amount) <= Constant.SALE_MAX_AMOUNT, "IDO: Total contribute is greater than 1000 USDT");
...
library Constant {
    ...
    uint256 public constant PRIVATE_SALE_RATE = 700000000000000000;  /// 1 token = 0.7 USDT
    ...
    uint256 public constant SALE_MINT_TOKEN_AMOUNT = 5000000 * FIXED_POINT; // 5% supply = 5 milion token

    uint256 public constant ECOSYSTEM_MINT_TOKEN_AMOUNT = 1200000 * FIXED_POINT; // 5% supply = 5 milion token

    uint256 public constant TEAM_MINT_TOKEN_AMOUNT = 1300000 * FIXED_POINT; // 5% supply = 5 milion token

    uint256 public constant TREASURY_MINT_TOKEN_AMOUNT = 3000000 * FIXED_POINT; // 5% supply = 5 milion token

    uint256 public constant LIQUIDITY_MINT_TOKEN_AMOUNT = 3600000 * FIXED_POINT; // 5% supply = 5 milion token
}
