...
contract BoxNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable{
    ...
    function initialize() public initializer {
      __ERC721_init("BOX NFT STEPVERSE", "BNS");
      openBoxActive=true;
      minQuality[1]=4;
      minQuality[2]=8;
      minQuality[3]=15;
    ...
    function initByOwner(ShoeNFT _shoeNFT,address _boxShop, UtilsVRF _utilsVRF,Utils _utils,address _boxMarketPlace, address _operator) public  onlyOwner {
        shoeNFT = _shoeNFT;
        boxShop=_boxShop;
...
function openBox(uint256 tokenId) external whenNotPaused returns (uint256 shoeId){
        ...
        uint256 [] memory randomMulti = utils.randomMulti(minQuality[rare],maxQuality[rare]);
...
contract ShoeNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize() public initializer {
        __ERC721_init("SHOE NFT STEPVERSE", "SNS");
        isTransfer=true;
        __Ownable_init();
    }
