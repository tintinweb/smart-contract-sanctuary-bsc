...
contract FarmPublicSale is Ownable, ReentrancyGuard {
    ...
    address public receiverAddress = 0xD4cB7d966123c4B1E92b1aE129B9D92390F98fB9; // for testing
    ...
    constructor(address _tokenAddress) {
        ...
        phaseInfo[1] = PhaseInfo({
            tokenLimit: 6250000 * decimalsValue,
            tokenSold: 0,
            expirationTimestamp: ICOStartTime + 21 days, //21 days
            price: 35,
            isComplete: false
        });
        phaseInfo[2] = PhaseInfo({
            tokenLimit: 6250000 * decimalsValue,
            tokenSold: 0,
            expirationTimestamp: phaseInfo[1].expirationTimestamp + 20 days, //20 days
            price: 50,
            isComplete: false
        });
        phaseInfo[3] = PhaseInfo({
            tokenLimit: 112_500_000 * decimalsValue,
            tokenSold: 0,
            expirationTimestamp: phaseInfo[2].expirationTimestamp + 30 days, //30 days
            price: 70,
            isComplete: false
        });
    }
