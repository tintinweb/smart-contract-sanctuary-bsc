...
contract Blocktechnology is ERC20, Ownable {
    ...
    constructor(
        ...
        require(buyTokenRewardsFee.add(buyLiquidityFee).add(buyMarketingFee).add(buyDeadFee) <= 50, "Total purchase cost exceeds 25%");
        require(sellTokenRewardsFee.add(sellLiquidityFee).add(sellMarketingFee).add(sellDeadFee) <= 50, "Total sales expense exceeds 25%");
