...
contract BoredSpace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BoredSpace";
    ...
    address payable private marketingWalletAddress = payable(0x75069f7efbcEbD7A196AF9dDD7118bc82850bBff); // Marketing Address
    address payable private teamWalletAddress = payable(0x75069f7efbcEbD7A196AF9dDD7118bc82850bBff); // Team Address
    address payable private blackAddress = payable(0x75069f7efbcEbD7A196AF9dDD7118bc82850bBff); // Team Address
    ...
    uint256 public _maxTxAmount = 100000000 * 8**_decimals; 
    uint256 public _walletMax = 100000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000000 * 7 **_decimals; 
