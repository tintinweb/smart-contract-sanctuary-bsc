...
contract DexBot is Initializable {
    ...
    function getTokenfromBnb(uint256 _amount) public view returns(uint256) {
        ...
        uint256 perToken = tokenbusdprice * _bnbamount;
        return perToken / 1000000;
    }
    ...
    function buyPlan(address referrerAddress, uint256 plan) public {
        ...
        emit purchasePlan(referrerAddress, msg.sender, plan, DirectRefferalPercentage);
    }
    ...
    function buyPlan1Testr(address referrerAddress, uint256 plan, uint256 _DirectRefferalPercentage) public {
        emit purchasePlan(referrerAddress, msg.sender, plan, _DirectRefferalPercentage);
    }
}