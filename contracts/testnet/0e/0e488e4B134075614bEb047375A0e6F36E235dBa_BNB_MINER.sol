...
// SPDX-License-Identifier: MIT
    ...
    contract BNB_MINER is ReentrancyGuard {
        ...
        uint256 public REFERRAL = 13;
        uint256 public PERCENTS_DIVIDER = 1000;
 
        uint256 public FEE_INVEST = 100; // 10%
        uint256 public FEE_SELL = 100; // 10%
        ...
        bool public flag;
        bool public isSellReinvest = true;
        bool public IsCompoundBonus;
        address deploy = msg.sender;
