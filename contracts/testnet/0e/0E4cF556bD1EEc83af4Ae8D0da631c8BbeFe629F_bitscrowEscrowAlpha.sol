...
contract bitscrowEscrowAlpha {
    ...
    uint256 private _btscrwTax = 500;
    ...
    uint256 private _maxDiscount = 450;
    ...
    function seeStateArray(uint256 escrowNumber)
        external
        view
        returns (uint256[] memory stateArr)
    {
        return _relativeService[escrowNumber]._stateArr;
    }

    function isUserValidator(address _user)
        public
        view
    ...
    function isUserSilverValidator(address _user)
        public
        view
        returns (bool isSilverValidator)
    {
    ...
    function isUserGoldValidator(address _user)
        external
        view
        returns (bool isGoldValidator)
    {
