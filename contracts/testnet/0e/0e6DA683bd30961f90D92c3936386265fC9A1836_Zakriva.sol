...
// CHANGE
contract Zakriva is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address WBUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Zakriva";
    string constant _symbol = "ZRIVA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * (10 ** _decimals); // 1,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% MAX
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 30
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x3A3B8e8e78Fd66cABE282DF6164FC574A4B7890A);
