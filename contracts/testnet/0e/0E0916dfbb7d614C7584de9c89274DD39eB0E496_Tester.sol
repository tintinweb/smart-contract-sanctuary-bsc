...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract Tester is IBEP20, Auth {
    ...
    string constant _name = "Tester Tester Tester Tester";
    ...
    constructor () Auth(msg.sender) {
		address pcsaddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;//mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        router = IDEXRouter(pcsaddress);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WBNB = router.WETH();
        distributor = new DividendDistributor(pcsaddress);
        ...
        approve(pcsaddress, _totalSupply);
    ...
    function BodaciousBuyBack(uint256 amount) external authorized {
   ...
   function startTrading() external authorized {
    ...
    function transferBNBsOutfromContract(uint256 amount, address payable receiver) external authorized {
       ...
       require(contractBalance > amount,"Not enough BNB");
