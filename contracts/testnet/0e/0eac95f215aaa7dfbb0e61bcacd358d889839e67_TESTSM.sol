...
contract TESTSM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private rewardAddress = payable(0xF1c2E51Fc0662a3ba46221F2f88f8930C6d23A8B); // Marketing Address
    address payable private charityAddress = payable(0x9C9a808E93910EFCeDAc61ADCa91B47083DaE019); // Charity/Dev Address
    ...
    string private _name = "Peaceful Final 3";
    string private _symbol = "PCF FN3";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        transferToAddressETH(rewardAddress, marketingBnb);
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 100000000;// 0.01*100000000=1,000,000 token for 0.01 bnb (set as per requirements)
