...
contract NiftyFlex is ERC721, Ownable {
    ...
    address ashContract_address = 0x09d8AF358636D9BCC9a3e177B66EB30381a4b1a8;  // ZAPO address  for test
    // address ashContract_address = 0x09d8AF358636D9BCC9a3e177B66EB30381a4b1a8;  // ASH address  for live

    //Token_baseURI
    string  public  baseURI = "https://nifty-flex.xyz/metaData/";
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(_exists(tokenId), "NiftyFlex#_setTokenURI: URI set of nonexistent token");
        require(bytes(_tokenURI).length > 0 , "NiftyFlex#_setTokenURI: TokenURI cannot be empty.");
        _tokenURIs[tokenId] = string(abi.encodePacked(baseURI, _tokenURI)) ;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(_tokenURI).length > 0 ? string(abi.encodePacked(baseURI, _tokenURI)) : "";
    ...
    function buyProduct(uint256 _productId, string memory tokenUri) public payable {  
        ...
        ERC20  ashContract = ERC20(ashContract_address);
        ...
        // assign metadata uri to minted token
