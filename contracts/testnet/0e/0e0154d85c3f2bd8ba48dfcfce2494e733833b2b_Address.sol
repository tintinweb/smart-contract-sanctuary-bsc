...
contract DRYP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Dripto";
    string private _symbol = "DRYP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F11D0341Dee19755519A9e56C0Fa6fEdc774d59); // Marketing Address
    address payable public buybackWalletAddress = payable(0x4F11D0341Dee19755519A9e56C0Fa6fEdc774d59); // Buyback Address
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9; // 3%
    uint256 public _walletMax = 1000 * 10**6 * 10**9; // 3%
