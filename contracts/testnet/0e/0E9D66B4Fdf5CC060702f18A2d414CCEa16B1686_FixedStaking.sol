...
contract FixedStaking is Ownable {
    ...
    function unStake(uint _amount) external {
        ...
        launchpad(launchpadAddress).transferIDOTokenToFixed(address(this), initialAmount * idoMulti / 1000000000000000000);
        idoBalance[msg.sender] = idoBalance[msg.sender] - (initialAmount * idoMulti / 1000000000000000000); 
        IDO(address(idoToken)).burn(address(this), (initialAmount * idoMulti / 1000000000000000000));
