...
contract ApexFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "Apex Finance";
    string public _symbol = "APXF";
    ...
    uint256 public apxfBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = apxfBankFee.add(nftHolderFee);
    ...
    address public apxfBankReceiver;
    ...
    constructor() ERC20Detailed("Apex Finance", "APXF", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xC67E45e40240DD2e2927b0e9ea388C557d105dD9;
        treasuryReceiver = 0xf7fFad4214e797B5Dd41C22c8992cD726e0FfDb3;
        insuranceReceiver = 0xb6Cac34b18007b5E152bA670702F350AE00ae1B9;
        apxfBankReceiver = 0xF9aECebc99A0e51eD49f82f57ef1929121A977b9;
        nftHolderReceiver = 0x4E3007C415213c0Fb10219b7342B5349c593df12;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = apxfBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(apxfBankFee).add(nftHolderFee);
        ...
        (success, ) = payable(apxfBankReceiver).call{
        value: currentBalance.mul(apxfBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
