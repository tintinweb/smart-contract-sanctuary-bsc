...
//    uint8[7] public grade_requirements = [0,3,10,6,5,3,2];
    uint8[7] public grade_requirements = [0,2,3,2,2,2,1];
    ...
    function setRecommender(address recommender) public {
        ...
        require(createTime[msg.sender] != 0, "Already bound recommender!");
    ...
    function join() public {
        ...
        for(uint256 i = 0; i < 8; i++) {
            ...
            if(current_vip > remain_vip && current_vip < 7){
    ...
    function calculationGrade(address account) public view returns(uint8){
        if(referral_grade[account][6] >= grade_requirements[6] && IDCARD[account] != 0){
            return 7;
        }else if(referral_grade[account][5] >= grade_requirements[5] && IDCARD[account] != 0){
            return 6;
        }else if(referral_grade[account][4] >= grade_requirements[4] && IDCARD[account] != 0){
            return 5;
        }else if(referral_grade[account][3] >= grade_requirements[3] && IDCARD[account] != 0){
            return 4;
        }else if(referral_grade[account][2] >= grade_requirements[2] && IDCARD[account] != 0){
            return 3;
        }else if(referral_grade[account][1] >= grade_requirements[1] && IDCARD[account] != 0){
            return 2;
