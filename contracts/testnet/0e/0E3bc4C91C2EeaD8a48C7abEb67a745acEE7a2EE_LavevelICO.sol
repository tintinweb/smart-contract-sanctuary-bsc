...
contract LavevelICO is Ownable {
  ...
  uint256 public constant RATE = 10000000; // Number of tokens per Ether
  uint256 public constant CAP = 5350; // Cap in Ether
  uint256 public constant START = 1519862400; // Mar 26, 2018 @ 12:00 EST
  uint256 public constant DAYS = 90; // 45 Day
  
  uint256 public constant initialTokens = 2000000000 * 10**9; // Initial number of tokens available
