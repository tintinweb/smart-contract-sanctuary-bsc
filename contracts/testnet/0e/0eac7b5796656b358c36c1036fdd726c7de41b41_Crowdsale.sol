...
contract Crowdsale is Pausable, Ownable {
    ...
    uint256 private constant ICO_SUPPLY_PER_PHASE = 10 ether;
    uint256 private constant PHASES = 5;
    uint256 private constant PHASE_DURATION = 10 minutes;
    uint256 private constant SOFT_CAP = 5000 ether;
    ...
    constructor(
        ...
        tokenPrices[1] = 1000000000 gwei; // 1 BUSD
        tokenPrices[2] = 2000000000 gwei; // 2 BUSD
        tokenPrices[3] = 3000000000 gwei; // 3 BUSD
        tokenPrices[4] = 4000000000 gwei; // 4 BUSD
        tokenPrices[5] = 5000000000 gwei; // 5 BUSD
    }
