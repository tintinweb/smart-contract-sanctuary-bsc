...
// @EAGLENFTAddress NFT address
    ...
    uint256 private coolingTime = 10 minutes;
    ...
    constructor(
        ...
        address coinAddr = 0xf01a6d2c68A1715A0a66715cc0b91d66Bad5c824;
        ...
        usdt = IERC20(0xCFd213453e55769fC8b4D8bFce21741CFA42b23B);
    ...
    function usdtDistribute(uint256 usdtBalance) private {
        (address[] memory holdAddress, uint256[] memory types) = EAGLENFTAddress
            .getNFTConfig();
        uint128 tigerEaglecardNum = 88;
        uint128 PhoenixEagleCardNum = 888;
    ...
    function receiveNFTrewards(uint256 _tokenId) external {
        ...
        super._transfer(BonusAccount, msg.sender, coinReward);
    }
