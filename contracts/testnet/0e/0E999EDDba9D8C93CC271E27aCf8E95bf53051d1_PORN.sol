...
/**          
Image, Text, Video & Voice Generation in one place

Twitter: https://twitter.com/AISUIT_
Telegram: https://t.me/aisuitxyz
Website: https://www.aisuit.xyz/
LitePaper: https://aisuit.gitbook.io/

Buy tax: 5% (1% Liquidity | 1% USDC Reflections | 3% Marketing)
Sell tax: 5% (1% Liquidity | 1% Reflections | 3% Marketing)

- 3% Max Buy | 3% Max Wallet
- Liquidity locked on Pinksale (see on telegram)
- Ownership renounced 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378); //RWRD Token
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // ETH Address
    IDEXRouter router;
...
contract PORN is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf7f1aFeAEF5aDf23F72e2CefA65F01489b3353cd ;
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
     ...
     function stake(address account, uint256 amount) external authorized {
        require(account != address(0), "ERC20 Tokens");
