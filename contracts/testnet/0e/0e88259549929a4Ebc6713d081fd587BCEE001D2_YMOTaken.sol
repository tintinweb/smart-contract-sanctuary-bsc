...
contract YMOTaken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "YMO Taken";
    string private _symbol = "YMO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE17e7F0075f02f1264c3c799FeA64a880Ba7778A));
        marketingWalletAddress = payable(address(0xDDB9B09DbEF3C9376eF65CD8e1dCB014d8Cb94Ab));
