...
contract SDBX is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 600000  * 10**9;
    ...
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner() {
        require(marketingFee <=4,"Marketing fee cannot exceed 4%");
        _marketingFee = marketingFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <=4,"liquidity fee cannot exceed 4%");
