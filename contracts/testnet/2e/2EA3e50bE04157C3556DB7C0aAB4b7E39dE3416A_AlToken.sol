...
contract AlToken is Ownable, IERC20 {
    ...
    function setupLP() private onlyOwner {
        ...
        else if (block.chainid == 97) // bsc testnet
        {
          ...
          usdt = IERC20(0x09Fdb9D9a28155ce73ABbe43c504B6AEe7a53F1a);
        }
    ...
    function _transferWithSellFee(address from, address to, uint256 amount) internal returns(bool) {
        ...
        uint256 tAmount = amount - feeAmount;
        uint256 amountLP = (feeAmount * 300) / _totalSellFee;
        uint256 amountA = (feeAmount * 400) / _totalSellFee;
        uint256 amountB = (feeAmount * 400) / _totalSellFee;
