...
contract GainFolios {
	...
	uint256 constant private INVEST_MAX_AMOUNT = 10 ether; 
	uint256[] private REFERRAL_PERCENTS = [5, 3, 2];
	uint256 constant private TOTAL_REF = 10;
	uint256 constant private CEO_FEE = 20;
	uint256 constant private DEV_FEE = 20;
	uint256 constant private HOLD_BONUS = 30;
