...
contract NewToken is Context, IBEP20, Ownable{
    ...
    address marketingWalletAddress  = 0x2A05caf2b94A21D6419A73F1cf51e250b802ffA9 ; // market wallet

    address devWalletAddress = 0x2A05caf2b94A21D6419A73F1cf51e250b802ffA9; // dev wallet

    address public contractHash = 0x8c00aBbE02D034b4b95Cd70424b824f6D450Ae15; // contract hash

    uint256 private _totalSupply  = 10000000000 * (10**uint256(_decimals));

    uint256 public _walletMax = 1000000000000 * (10**uint256(_decimals));

    uint256 public _maxTxAmount = 1000000000000 * (10**uint256(_decimals));

    uint256 private minimumTokensBeforeSwap = 1000000000 * (10**uint256(_decimals)); 
