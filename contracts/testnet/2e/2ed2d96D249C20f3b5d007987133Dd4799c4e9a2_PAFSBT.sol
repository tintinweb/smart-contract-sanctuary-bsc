...
import "./IPAFSBT721.sol";

/**
 * @title ERC-721 Non-Fungible Token Standard, optional metadata extension
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
interface IPAFERC721Metadata is IPAFSBT721 {
    /**
...
interface IPAFSBT721 {
     ...
     * authenticated `to` field.
     */
    event Attest(address indexed to, uint256 indexed tokenId, bytes32 playfabID_, bytes32 createdAt_);
 ...
 * - `uint256 -> bytes32` (`UintToBytes32Map`) since demonstration of FSBT
 *
 * [WARNING]
 * ====
...
library EnumerableMap {
    ...
    function set(
        ...
        map._inner._values[bytes32(key)] = value;
        return map._inner._keys.add(bytes32(key));
    }
    ...
    function tryGet(UintToBytes32Map storage map, uint256 key) internal view returns (bool, bytes32) {
        return tryGet(map._inner, bytes32(key));
    }
