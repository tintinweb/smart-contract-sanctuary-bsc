...
contract OceansNFTStakingPool is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        __Ownable_init();
        whitelistedCaller = 0x2BFcdA02F4f30f2Aa0Bb1556F806bB27a906BcC7;   
        OCEANS = IERC20(0x3034405C89b321BCbf81A738ea2F55E0FA34f88A);    //testnet
        unstakeTime = 30 days;
    ...
    function unstake(uint _amount) public nonReentrant {
        ...
        require(_userDB[_user]._unlockvalue == 0,"Amount is Locked!!");
        ...
        uint percent = (_amount / subtotal) * 100;
