...
contract ContractCryptopolisBooster is ERC721Burnable, ERC721URIStorage {
    ...
    */
     ...
     */
    function mintBooster(address to, string calldata _uri) public onlyOwner {
        _mint(to, idCount);
     ...
     */
    function mintBoosterBatch(address to, string[] calldata _uri) public onlyOwner {
