...
contract Claim is Ownable {
    ...
    constructor(address _rewardWallet, address _rewardToken) {
        if (_rewardWallet == address(0)) revert addressIsZero("_rewardWallet");
    ...
    function claimRewards() external {
        ...
        totalClaims += balance;
        IERC20(rewardToken).transferFrom(rewardWallet, _msgSender(), balance);
    ...
    function withdraw() external onlyOwner {
        (bool success, ) = rewardWallet.call{value: address(this).balance}("");
