...
contract Token is Context, IERC20, Ownable {
    ...
    address public mintAddress =
        address(0xA6111557442769B5B11E55290cE31B8DA699110b);
    ...
    function _takeMint() private {
        ...
        uint256 cycle = blockNumber.sub(lastMintBlock).div(120);
        ...
        lastMintBlock = cycle.mul(120).add(lastMintBlock);
        nextMintBlock = lastMintBlock.add(120);
    }
