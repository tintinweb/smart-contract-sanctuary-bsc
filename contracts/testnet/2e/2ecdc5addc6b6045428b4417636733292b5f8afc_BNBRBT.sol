...
contract BNBRBT is IERC20, Ownable {
	...
	uint256 private constant _tTotal = 10_000_000_000_000_000_000_000_000 * 10**_decimals;
	...
	uint256 public minimumTokensBeforeSwap = 25000000 * 10**_decimals;
	...
	constructor() {  
        ...
        _isExcludedFromFee[address(_uniswapV2Pair)] = true;
        ...
        _setOwner(0xA68e5f5d9079A1f5c1606d148cBd71638479e387);
