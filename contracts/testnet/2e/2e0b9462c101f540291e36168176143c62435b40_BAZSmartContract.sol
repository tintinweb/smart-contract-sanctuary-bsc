...
/**  Staycation Club Inu
The project aims to promote tourist spots in the world where Staycation Club Community will be given special access and privileges 
to an amazing staycation experience while earning money through crypto NFT and StaycationToken trading. 

BAZ BlockChainDeveloper at https://t.me/BAZ_BlockChainDeveloper and [email protected]
*/
...
contract BAZSmartContract is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 10**_decimals; //100B
    ...
    string private constant _name = "retesting Token";
    string private constant _symbol = "RTT100B";
