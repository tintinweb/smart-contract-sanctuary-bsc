...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C); // Mainnet
    address WBNB = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C; // Mainnet
...
contract MyTestToken is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "MyTestToken";
    string constant _symbol = "MTTN";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 10 ** 9 * (10 ** _decimals); // 10 ** 9 is 1 billion
    ...
    address public buybackFeeReceiver = 0xd4dd967CE081CC7A922D3417728fc3FE006867Ef;

    address RWRD = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C; // Mainnet
	address WBNB = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C; // Mainnet
