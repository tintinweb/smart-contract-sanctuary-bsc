...
contract COWS_Market_1155 is ReentrancyGuard {
    ...
    uint256 public sellingOrders=0;
    ...
    */
    ...
    function getSellings() external view returns (SaleInfo[] memory _nftItems) {
        SaleInfo[] memory sellings = new SaleInfo[](saleList.length);
        uint j = 0;
