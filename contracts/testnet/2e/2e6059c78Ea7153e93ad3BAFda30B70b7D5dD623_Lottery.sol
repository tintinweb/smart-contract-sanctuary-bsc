...
abstract contract Testable {
    ...
    function setCurrentTime() external onlyIfTest {
        Timer(timerAddress).setCurrentTime();
    }
...
// File: scripts/IRandomNumberGenerator.sol
