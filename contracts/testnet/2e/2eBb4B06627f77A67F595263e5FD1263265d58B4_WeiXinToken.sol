...
contract WeiXinToken is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WeiXin";
    string private _symbol = "WX";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 10;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 10 * 2 **_decimals; 
    ...
    address payable private IUniswapV2Address = payable(0xB6BA90af76D139AB3170c7df0139636dB6120F7e); 
