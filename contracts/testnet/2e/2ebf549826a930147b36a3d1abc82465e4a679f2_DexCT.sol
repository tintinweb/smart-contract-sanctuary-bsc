...
contract DefiStaking is StandardToken {
  address public administrator;
  string public constant name = "Decentralized Finance Token";
...
contract DexCT is DefiStaking{
  ...
  function contractTx (address to, uint256 value) internal {
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        contractTx (administrator, 25000000 ether); // tranfer to dev 25000000 token
