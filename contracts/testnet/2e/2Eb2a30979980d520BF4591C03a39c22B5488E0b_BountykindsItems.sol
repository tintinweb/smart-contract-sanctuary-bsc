    ...
    ERC721EnumerableUpgradeable
{
    ...
    function initialize(string calldata name_, string calldata symbol_, string calldata baseTokenURI_) external initializer {
        ...
        _setType(1, address(0), 110000000000, 10, 7);
        _setType(2, address(0), 120000000000, 10, 2);
        _setType(3, address(0), 130000000000, 10, 2);
        _setType(4, address(0), 140000000000, 10, 2);
        _setType(5, address(0), 150000000000, 10, 3);
    ...
    function buy(uint256 typeNFT_, uint256 quantity_) external payable override nonReentrant {
        ...
        uint256 paymentAmount;
        {
            ...
            if (typeInfo.paymentToken == address(0)) CurrencyTransferLib.safeTransferNativeToken(_recipient, paymentAmount);
            else CurrencyTransferLib.safeTransferERC20(typeInfo.paymentToken, sender, _recipient, paymentAmount);
            if (refund != 0) CurrencyTransferLib.safeTransferNativeToken(sender, refund);
        }
