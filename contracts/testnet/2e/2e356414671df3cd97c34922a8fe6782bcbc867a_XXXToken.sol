...
contract XXXToken is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public nextRebase = block.timestamp + 0;
    ...
    address public liquidityReceiver = 0xf2ad1491E878607417D1C3a4a0dB3C3AA7f79caF;
    address public treasuryReceiver = 0x572294341C871e4126049008Be209F90A3Fe0834;
    address public diamondRiskReceiver = 0xe2B4240F6b7eB06cA3d647139382052ddF03A34F;
    ...
    constructor() ERC20Detailed("TokenX", "XXX", uint8(DECIMALS)) {
