...
contract PlanB is ITRC20, Owend{
    ...
    address public _platformUsdtAddress=address(0x4552F1a62a562667F8c7946518B98518Fe38f8dC);

    address public _symbolAddress=address(0x64829ee3C420754Afa161641eEacaA38Bbd285a2);

    address public _usdtAddress=address(0x62E79D3f16acBdbfe73913A9Ab2f27FBd657a837);

    address public _canAddress=address(0xD197b4Cd60F864377244e90aFeec195E23856bB8);
