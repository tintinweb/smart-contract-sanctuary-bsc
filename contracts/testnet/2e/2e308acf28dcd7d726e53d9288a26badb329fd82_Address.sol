...
contract KalmarLpStaking is ReentrancyGuard, Initializable {
    ...
    IKalmarStakingRewardConfig public constant rewardConfig = IKalmarStakingRewardConfig(0x94F6E22d2Af18Ba556C88C11b2AB7BdB04943D1f);
    ...
    function getWeek() external view returns (uint256) {
        return (block.timestamp - startTime) / 300;
    }
    ...
    function _getRewardData(address _token) internal view returns (uint256 accRewardPerShare, uint256 rewardsPerSecond) {
        ...
        uint256 currentWeek = (block.timestamp - start) / 300;
