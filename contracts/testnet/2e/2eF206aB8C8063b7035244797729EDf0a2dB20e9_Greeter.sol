...
contract Greeter is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    ICrossChainBridgeRouter public ccbRouter; // Set the function to a variable
    uint256 private mintOnce = 2;

    constructor() ERC20("Hello Dan", "DANCOIN") {
    ...
    function mint(uint256 amount) public onlyOwner {
        require(mintOnce <= 2, "No more minting for you");
        // Mint the on chain token amounts
        _mint(address(this), amount);
    }

    // Working to add LP tokens
    function addToBridge(uint256 amount) public onlyOwner {
        // Mint the amount of tokens that the bridge has access to on chain
    ...
    function getChainId() public view {
