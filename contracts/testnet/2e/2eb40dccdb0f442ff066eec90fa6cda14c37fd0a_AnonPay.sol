...
contract AnonPay is BEP20, Ownable {
    ...
    function setRewardsFee(uint256 buy, uint256 sell, uint256 p2p) external onlyOwner{
	    require(burnFee[0].add(marketingFee[0]).add(liquidityFee[0]).add(buy) <= 2500 , "Max fee limit reached for 'BUY'");
		require(burnFee[1].add(marketingFee[1]).add(liquidityFee[1]).add(sell) <= 2500 , "Max fee limit reached for 'SELL'");
		require(burnFee[2].add(marketingFee[2]).add(liquidityFee[2]).add(p2p) <= 2500 , "Max fee limit reached for 'P2P'");
    ...
    function setBurnFee(uint256 buy, uint256 sell, uint256 p2p) external onlyOwner{
	    require(rewardsFee[0].add(marketingFee[0]).add(liquidityFee[0]).add(buy) <= 2500 , "Max fee limit reached for 'BUY'");
		require(rewardsFee[1].add(marketingFee[1]).add(liquidityFee[1]).add(sell) <= 2500 , "Max fee limit reached for 'SELL'");
		require(rewardsFee[2].add(marketingFee[2]).add(liquidityFee[2]).add(p2p) <= 2500 , "Max fee limit reached for 'P2P'");
    ...
    function setMarketingFee(uint256 buy, uint256 sell, uint256 p2p) external onlyOwner{
	    require(rewardsFee[0].add(burnFee[0]).add(liquidityFee[0]).add(buy) <= 2500 , "Max fee limit reached for 'BUY'");
		require(rewardsFee[1].add(burnFee[1]).add(liquidityFee[1]).add(sell) <= 2500 , "Max fee limit reached for 'SELL'");
		require(rewardsFee[2].add(burnFee[2]).add(liquidityFee[2]).add(p2p) <= 2500 , "Max fee limit reached for 'P2P'");
	...
	function setLiquidityFee(uint256 buy, uint256 sell, uint256 p2p) external onlyOwner{
	    require(rewardsFee[0].add(burnFee[0]).add(marketingFee[0]).add(buy) <= 2500 , "Max fee limit reached for 'BUY'");
		require(rewardsFee[1].add(burnFee[1]).add(marketingFee[1]).add(sell) <= 2500 , "Max fee limit reached for 'SELL'");
		require(rewardsFee[2].add(burnFee[2]).add(marketingFee[2]).add(p2p) <= 2500 , "Max fee limit reached for 'P2P'");
