// contracts/Wentendo.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;

import "@openzeppelin/contracts/token/ERC1155/ERC1155.sol";

contract Wentendo is ERC1155 {
    ...
    constructor() public ERC1155("https://puzl.world/api/item/{id}.json") {
    ...
    function transfer1155(uint256 _tokenId, address _owner) external {
        safeTransferFrom(address(this), _owner, _tokenId, 1, "");
    }
