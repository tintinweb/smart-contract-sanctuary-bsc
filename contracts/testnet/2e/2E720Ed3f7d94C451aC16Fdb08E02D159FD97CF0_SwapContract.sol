...
contract SwapContract is Ownable {
    ...
    IERC20 _stbContract;
   	constructor() {
        ...
        _usdcContract = _usdcContract;
        _usctContract = _usctContract;
        _stbContract  = _stbContract;

        // router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // rinkeby mainnet
        router = IPancakeSwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // rinkeby testnet
    ...
    function sellUSCT(uint256 amount) public {
        ...
        _usdcContract.transfer(msg.sender, amount);
        _usctContract.burn(address(this), amount); 
    }
