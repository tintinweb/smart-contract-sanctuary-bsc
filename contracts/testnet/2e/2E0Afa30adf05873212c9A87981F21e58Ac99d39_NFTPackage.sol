...
contract NFTPackage is TRC21, ERC721Full("NFTPackage", "P1"), Ownable {
    ...
    constructor() public {
        ...
        _changeMinFee(0);
        countTypeNFT = 0;
        fiats = [TRC21(0x0358d8b092450B85E69aDe64058b801F8e0C18F0)];
    ...
    function buyNFT(uint256 _num, uint256 _typeNFT, TRC21 _buyFiat) public isValidFiatBuy(_buyFiat){
        require(typeNFTs[_typeNFT].price > 0);
        require(_buyFiat.transferFrom(msg.sender, taker, typeNFTs[_typeNFT].price * _num * 1 ether));
