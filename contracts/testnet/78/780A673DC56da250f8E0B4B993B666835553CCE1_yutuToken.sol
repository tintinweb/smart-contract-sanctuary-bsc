...
contract yutuToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 2023 * 10**18;
    string private _name = "yutu";
    string private _symbol = "yutu";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x9516A1b77736eBDF7CE9294fcA185a0803C625b9);
    address public pointAddress = address(0xCDffC3Bdc16B3c966CF46f7d6dd10A0B6f0b65f5);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 2023 * 10**18;
