...
contract MetafameSaleMTv7_0708 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Presalable{
    ...
    uint256 public bnbPerBox;
    uint256 public bnbPerBoxWL;
    ...
    function purchaseBoxPresale(
        ...
        require(msg.value == bnbPerBoxWL * number, "Insufficient BNB");
        price = bnbPerBoxWL  * number;
    ...
    function purchaseBoxPublicSale(
        ...
        require(msg.value == bnbPerBox * number, "Insufficient BNB");
        price = bnbPerBox  * number;
    ...
    function makeOver( 
        ...
        require(msg.value == makeOverPrice, "Insufficient BNB");
    ...
    function refresh( 
        ...
        require(msg.value == refreshPrice, "Insufficient BNB");
    ...
    function setBNBPerBox(uint256 saleType, uint256 weiPrice) onlyOwner whenPaused public {
        if(saleType == 0){
            bnbPerBoxWL = weiPrice;
        }
        else{
            bnbPerBox = weiPrice;
        }  
    ...
    function setRefreshPrice(uint256 weiPrice) onlyOwner whenPaused public {
        refreshPrice = weiPrice;
    }
    ...
    function setRefreshRoundInfo(uint256 roundNumber, uint256 _startTime, uint256 _endTime, uint256 _limit) onlyOwner whenPaused public {
    ...
    function setDNA(uint256 tokenId, string memory itemsDNA, string memory layersDNA) onlyOwner public {
