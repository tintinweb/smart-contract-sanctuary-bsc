...
contract FuryMinerBNB is ReentrancyGuard {
	...
	uint256 constant public W_PERIOD = 7 hours;
	...
	constructor() {
		ceoWallet = payable(0x590a786aaa17D365525a4d1F0CC81a4A0BeCf77c);
		devWallet = payable(0x590a786aaa17D365525a4d1F0CC81a4A0BeCf77c);
		topD_round = 0;
