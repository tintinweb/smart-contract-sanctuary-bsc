...
contract ERC20_Taxed is ERC20, Ownable {
    ...
    event LGEWhitelisterTransferred(
        address indexed previousLGEWhitelister,
        address indexed newLGEWhitelister
    );

    modifier onlyLGEWhitelister() {
        require(
            _LGEwhitelister == _msgSender(),
    ...
    function removeFromSenderWhitelist(address whitelistAddress)
        external
        onlyOwner
    {
    ...
    function addToRecipientWhitelist(address whitelistAddress)
        external
        onlyOwner
    {
    ...
    function removeFromRecipientWhitelist(address whitelistAddress)
        external
        onlyOwner
    {
    ...
    function transferLGEWhitelister(address newLGEWhitelister)
        external
        onlyOwner
    {
