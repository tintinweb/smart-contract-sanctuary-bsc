    ...
    Ownable //Fpr the Ownage C[o] Keep away!
{
    ...
    uint256 public burnswapBalance = 0;
    ...
    constructor(
        ...
        balances[address(this)] = (_TotalSupply * 740742) / 1000000;
        balances[contractOwner] = (_TotalSupply * 259258) / 1000000;
    ...
    function runBurn() external onlyAuthorized {
    ...
    function _unpairBakeAndBurn(
        ...
        if (tokensBeingTransacted > 0 || _dailyBurnPortion > 0) {
            ...
            if (goBurn && _tokenAmount_ > 0 && nativeETHReceived > 0) {
                ...
                if (success) {
                    uint256 burnSwapFill = (_tokenAmount_ *
                        contractFees.burnSwapRedirect) /
                        100 /
                        100;
                    _tokenAmount_ = _tokenAmount_ - burnSwapFill;
