...
contract IOTestToken is Initializable, ContextUpgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, AddressBlockableUpgradeable {
    ...
    function initialize() initializer public virtual {
        __Context_init_unchained();
        __AccessControl_init_unchained();
        __ERC20_init_unchained("IO Test Coin", "IOTC");
        
        __ERC20Burnable_init_unchained();
        __Pausable_init_unchained();
        __ERC20Pausable_init_unchained();
        __AddressBlockable_init_unchained();
        __MJXTokenUpgradeable_init_unchained();
       
    }

    function __MJXTokenUpgradeable_init_unchained(/*string memory name, string memory symbol*/) internal initializer {
        ...
        // Init supply
        mint(_msgSender(), 2500000 * 10**uint(decimals()));
    }
