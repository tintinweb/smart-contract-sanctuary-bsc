...
contract LANDSPRIVATESALE1 is Ownable {
    ...
    uint256 private constant TokenAmount = 20000;
    ...
    function vesting(uint256 countSetOfTokens) public {
        uint256 amount_ = TokenAmount * countSetOfTokens * _decimals;
        ...
        require(
            this.FEGetVestingSchedulesCount() < 300,
        ...
        uint256 cliff_ = startTime_ + 200; // Cliff => 1 month (2629743)
        uint256 duration_ = startTime_ + 400; // Total Vesting Duration => 11 months (28927173)
