...
contract TreasuryFeeManager is AccessControl {
    ...
    /*
     * Params
     * uint256 _startingIndex - Starting index of unwrapping lp tokens
     * uint256 _endingIndex - Ending index of unwrapping lp tokens (not included)
     *
     * Function will go through array of lp tokens in range: [_startingIndex, _endingIndex)
     * Function removes liquidity in exchange for lp tokens and swaps both tokens for WETH/WBNB
     */
    function unwrapTokens(uint256 _startingIndex, uint256 _endingIndex)
        external
    {
        //gas saving
