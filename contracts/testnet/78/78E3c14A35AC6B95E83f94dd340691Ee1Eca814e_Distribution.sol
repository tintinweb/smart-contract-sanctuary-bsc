...
contract Distribution is Ownable, ReentrancyGuard {
	...
	constructor(address _lvgc, uint256[] memory _claimableTimestamp, uint256[] memory _claimablePercent) {
        LVGC = IERC20(_lvgc);
    ...
    function claim() external nonReentrant {
        ...
        uint256 contractTokenBalance = LVGC.balanceOf(address(this));
        ...
        // Release token
        LVGC.safeTransfer(_msgSender(), tokenQuantity);
