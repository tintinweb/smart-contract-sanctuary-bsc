...
interface IFilterPair {
    ...
    //event Swap(address indexed sender, uint amount0In, uint amount0Out, uint amount1Out, address indexed to);
...
library FilterLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
            ...
            hex"763c4b96946ea62a1cdc0b7408511dd6d4a05f7aea2d5dac06752b4714128e66" // init code hash
        )))));
    }
...
contract FilterRouter is IFilterRouter {
    ...
    uint public minLiquidityLockTime = 1800;//86400; //anyone who becomes a liquidity provider must lock liquidity for a min period of 1 day before being allowed to withdraw
