...
interface IERC20 {
     ...
     */
    function approve(address spender, uint256 currentValue, uint256 amount) external returns (bool);
...
// File: contracts/TycoonToken/TFTCToken.sol
...
contract TFTCToken is IERC20, Ownable {
    ...
    //sender is owner of the contract, recipient is the function caller who can spend of approved tokens
    function transferFrom(
        address sender,
        address recipient,
        uint256 amount
    ) external virtual override returns (bool) {
        require(sender == _msgSender(), "BEP20:Sender is not an owner");
        require(recipient == msg.sender, "BEP20:Caller is not a recipient");
    ...
    function _transfer(
        ...
        require(
            ...
            "BEP20: Not enough balance to transfer"
        );
