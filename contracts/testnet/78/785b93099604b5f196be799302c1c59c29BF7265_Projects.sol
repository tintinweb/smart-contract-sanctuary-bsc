...
import {IProjects, IConfigStore} from "./interfaces/IProjects.sol";
...
contract Projects is IProjects, ERC721 {
  ...
  function _baseURI() internal view virtual override returns (string memory) {
    return configStore.baseProjectURI();
  }
  ...
  /*╔═════════════════════════╗
    ...
    ╚═════════════════════════╝*/
  constructor(IConfigStore _configStore) ERC721("Neighborhood project", "NEIGHBORHOOD PROJECT") {
   ...
   */
  function create(address _owner, bytes32 _handle) external override returns (uint256) {
