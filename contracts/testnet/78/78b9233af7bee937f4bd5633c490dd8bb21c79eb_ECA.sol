...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0x50b7B12a6689e3755a5AE79392caA1814C06292c;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0x1279D5be3a25Cb059cbcA598FfcA2d978892633D;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0x75b93b8a730100f7AA6bE18E261eEB98076D16c9;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "EIZPHERCHAIN";
  ...
  constructor() {
    ...
    _mint(_msgSender(), 100000000000 * 10 ** uint256(_decimals));
  }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "ECA: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "ECA: transfer from the zero address");
    require(recipient != address(0), "ECA: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "EECARC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "ECA: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "ECA: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "ECA: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "ECA: approve from the zero address");
    require(spender != address(0), "ECA: approve to the zero address");
