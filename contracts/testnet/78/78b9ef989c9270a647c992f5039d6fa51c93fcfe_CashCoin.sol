...
contract CashCoin is Context, Ownable, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    string private _name = "Cash Coin";
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Cash Coin: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "Cash Coin: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "Cash Coin: transfer to the zero address"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "Cash Coin: mint to the zero address"
        );
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "Cash Coin: burn from the zero address"
        );

        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "Cash Coin: burn amount exceeds balance"
        );
        unchecked {
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "Cash Coin: approve from the zero address"
        );
        require(
            spender != address(0),
            "Cash Coin: approve to the zero address"
        );
