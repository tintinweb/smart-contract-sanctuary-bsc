...
contract Timelock {
    ...
    function deleverageOnce(address _stratAddress) public {
        require(msg.sender == admin, "Timelock::executeTransaction: Call must come from admin.");
        IStrategy(_stratAddress).deleverageOnce();
    }

    function wrapBNB(address _stratAddress) public {
        require(msg.sender == admin, "Timelock::executeTransaction: Call must come from admin.");
    ...
    * @dev No timelock functions
    ...
    function withdrawBEP20(address _tokenAddress) public payable {
        ...
        IERC20(_tokenAddress).safeIncreaseAllowance(admin, tokenBal);
        IERC20(_tokenAddress).transfer(admin, tokenBal);
    }
