...
*/
    ...
    event DATAT(address s, uint a, uint i, uint ini, uint pos);
    event DDATAT(uint open, bool b, uint lev, uint tp, uint sl);
    event DATATT(uint a, uint t, uint x, uint xx, uint y, bool b);
    ...
    function registerTrade(
        ...
        emit DATA("FINALFUNCIO");
        //emit DATAT(trade.trader, trade.pairIndex, trade.index, trade.initialPosToken, trade.positionSizeDai);
        //emit DDATAT(trade.openPrice, trade.buy, trade.leverage, trade.tp, trade.sl);
       // emit DATATT(0, v.tokenPriceDai, trade.positionSizeDai * trade.leverage, 0, 0, false);
/*
        /*
    ...
    */
        ...
        return (trade, 0); // ESTE ES EL REAL
    }
