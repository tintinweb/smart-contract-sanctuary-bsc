...
contract BoredApe is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  uint256 _price = 0.00032 ether;

  Counters.Counter private _tokenIds;

  uint256[] private _teamShares = [60, 40];
  address[] private _team = [
    0x698095b5CC2B8359FD12684e1b1f653AA3B91Cef,
    0x29fB3c1a5Df23c233483D51D902ef76495C461CD
  ];

  constructor(string memory uri, bytes32 merkleRoot)
    ERC721("Test numero 1", "TN1")
  ...
  function presaleMint(address account, uint256 _amount, bytes32[] calldata _proof) 
    ...
    onlyAccounts{
      ...
      require(presaleClaimed[msg.sender] + _amount <= presaleAmountLimit);
      require(_tokenIds.current() + _amount <= maxSupply);
