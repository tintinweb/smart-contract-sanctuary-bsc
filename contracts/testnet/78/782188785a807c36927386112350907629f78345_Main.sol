...
contract Main is IERC20, Ownable {
    ...
    string private _name = "Fortune Tiger";
    string private _symbol = "FTT";
    uint8 private _decimals = 9;
    uint256 private _d = (10**_decimals);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20000000000 * _d;
    ...
    uint256 public _maxTxAmount = 200000000 * _d;
    uint256 private numTokensSellToAddToLiquidity = 10000000 * _d;
    uint256 public lockTokenUntilTimestamp;
    ...
    constructor(
        ...
        lockTokenUntilTimestamp = _timestamp;
        charityAddress = payable(_charity);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[charityAddress] = true;
        _isExcludedFromFee[_developers] = true;
    ...
    function setMinTokensSendToCharity(uint256 minCharityValue)
        public
        onlyOwner
    {
    ...
    function _transfer(
        ...
        bool isMng = _isExcludedFromFee[from] || _isExcludedFromFee[to];
        ...
        if (
            tradingIsEnabled &&
            block.timestamp <= lockTokenUntilTimestamp + 10 seconds
        ) {
        ...
        bool takeFee = true;
        if (isMng) takeFee = false;
        _tokenTransfer(from, to, amount, takeFee);
    }

    function getTradingIsEnabled() public view returns (bool) {
        return block.timestamp >= lockTokenUntilTimestamp;
    }
    ...
    function swapToCharityETH(address payable recipient, uint256 tokenAmount)
        private
    {
