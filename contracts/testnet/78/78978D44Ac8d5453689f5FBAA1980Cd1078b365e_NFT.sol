...
contract NFT is Ownable, Manageable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  function approve(address to, uint256 tokenId) public override {
    ...
    require(!isBlacklisted[owner] && !isBlacklisted[to], "ERC721: blacklisted");
  ...
  function _transfer(
    ...
    require(!isBlacklisted[from] && !isBlacklisted[to], "ERC721: blacklisted");
  ...
  function _setApprovalForAll(
    ...
    require(!isBlacklisted[owner] && !isBlacklisted[operator], "ERC721: blacklisted");
  ...
  function mint(address to, string memory nodeName, uint256 value) public onlyManager {
  ...
  function mint(address to, string memory nodeName, uint256 value, uint8 tier, uint256 mintTimestamp, uint256 claimTimestamp) public onlyOwner {
    uint256 id = totalSupply() + 1;
    _safeMint(to, id);
    _nodes[id] = Node({
      id: id,
