...
contract Beef is Initializable, UUPSUpgradeable, OwnableUpgradeable, IERC20 {
    ...
    string constant _message_link = "http://chum.com/msg";

    string private constant _name = "Chum";
    string private constant _symbol = "CHUM";
    ...
    function _mint( uint256 amount) private  {
        ...
        _tOwned[owner()] = _tOwned[owner()] + amount;
        rate = _getRate();
    ...
    function mintDrop(
        ...
        uint256 mintAmount;
        for (uint256 i; i < amountsInTokens.length; i++) {
