...
contract FactoryStakingInto1155 is AccessControl {
    ...
    function createStaking20Plus20Into1155(IERC20[2] memory _stakeToken, uint256[2] memory _stakeTokenAmount, IERC1155 _rewardToken, uint256 _rewardTokenID, uint256 _rewardTokenAmount, uint256 _startTime, uint256[2] memory _duration) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        instance.setCreator(_msgSender());
        _rewardToken.safeTransferFrom(_msgSender(), address(instance), _rewardTokenID, _rewardTokenAmount, "");
        emit NewContract(address(instance), 0);
    }

    function createStaking20Plus1155Into1155(IERC20 _stakeTokenERC20, uint256 _stakeTokenAmount, IERC1155 _stakeTokenERC1155, uint256 _stakeTokenID, IERC1155 _rewardToken, uint256 _rewardTokenID, uint256 _rewardTokenAmount, uint256 _startTime, uint256[2] memory _duration) external onlyRole(DEFAULT_ADMIN_ROLE) {
