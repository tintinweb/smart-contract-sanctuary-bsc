...
contract Meta is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x94879457b016A15842699B70CED43b84839d4faa);
    address payable public teamWalletAddress = payable(0xc9aedEa02480330156Ed4F6cB9bdff03c2053baD);
