...
contract Xindex {
    ...
    uint256 constant LaunchTime = 1665241200; //Launch time :  8th October 2022 15:00 UTC
    ...
    uint256 constant MinStakeAmount = 50 * 10**18;
    ...
    function deposit(uint256 _amount, address _upline) public {
        require(block.timestamp >= LaunchTime, "App did not launch yet.");
        ...
        BUSD.safeTransferFrom(msg.sender, dev, dev_mar_commisison);
