...
contract App {
    ...
    event productPurcharsed(address indexed user, address owner, uint price);
    ...
    function addProduct(string memory name, 
      ...
      function transferTokens(address _owner, uint _price, address _buyer) private {
            ...
            require(token.allowance(_buyer, address(this)) >= _price, 'Insuficent allowance to make reserve');
      ...
      function buyProduct(uint product_id) public {
        product storage Product = products[product_id];
        require(msg.sender != Product.owner, 'You cannot buy products');
        ...
        emit productPurcharsed(msg.sender, Product.owner, Product.price);
      }
