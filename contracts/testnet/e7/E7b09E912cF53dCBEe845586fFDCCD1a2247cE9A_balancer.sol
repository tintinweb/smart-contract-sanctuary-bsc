...
contract balancer is Ownable {
  ...
  function setAuth(address _auth) public onlyOwner {
	...
	function balanceTokenLit() public view returns (uint256) {
      address pair = pairBusdLit;

      uint256 balanceTokenLitPair = IERC20(LIT).balanceOf(pair);
      
      return balanceTokenLitPair;
	...
	function getProposalAbove() public view returns (uint256) {
      ...
      // uint256 desiredAmountOutBUSD = (balanceTokenBusd - balanceTokenLit) / 2; 
      
      return balanceTokenBusd;
