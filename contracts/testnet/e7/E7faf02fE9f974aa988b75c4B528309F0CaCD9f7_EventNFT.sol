...
contract EventNFT {
  ...
  event NewEventNFTCreated(address addr, bytes32 signature);
  ...
  function createEventNFTContract(
    ...
    string memory eventSymbol
        ...
        bytes32 salt = keccak256(abi.encodePacked(signature, eventName));
        ...
        emit NewEventNFTCreated(address(_contract), signature);
  }
