...
contract CatTomInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Tom Inu";
    string private _symbol = "TOM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23D5471C1DB20646bCFFf0371a02387a1a24f8cF);
    address payable public teamWalletAddress = payable(0x23D5471C1DB20646bCFFf0371a02387a1a24f8cF);
    address payable public autoliqudityAddress = payable(0x23D5471C1DB20646bCFFf0371a02387a1a24f8cF);
