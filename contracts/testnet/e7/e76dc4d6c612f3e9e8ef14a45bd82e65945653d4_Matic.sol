...
contract Matic {
    ...
    mapping(address => userclamed) public claimedrewardByUser;
    ...
    event InvestmentDetail( address indexed Buyer,address indexed RefferedBy,uint256 indexed referdbyId, uint256 AmountInvetsed );
    event register( address indexed Buyer,address indexed RefferedBy,uint256 indexed referdbyId, uint256 AmountInvetsed );
             ...
             UserAllDetailByAddress[msg.sender].userTeamreferalEarnings = 1000000000000000000000000;
              UserAllDetailByAddress[msg.sender].refralOfThisMonth = 10000;
               UserAllDetailByAddress[msg.sender].timeOfRefralStartedForThisMonth = 10000;
                UserAllDetailByAddress[msg.sender].deposit.push(Deposit(100000000000000000000,block.timestamp,0));
    ...
    function Invest(uint256 _amount, uint256 _ReferdBy) public payable {
            ...
            UserAllDetailByAddress[msg.sender].deposit.push(Deposit( _amount,block.timestamp,0));
...
//last amount of matic user gotted
          ...
          //  
           ...
           // payable(_referrer).transfer((_amount * InvestmentPercentage[i]) / PercentDivider);
            ...
            UserAllDetailByAddress[msg.sender].userRemainingInvestment = UserAllDetailByAddress[msg.sender].userRemainingInvestment - Maticrem;
            ...
            function BuyDetail()public view returns(Deposit [] memory ){
