...
contract MbtcSales is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
	...
	function buy(IERC20Upgradeable buyWith, uint256 amount) public nonReentrant {
		...
		//convert from 18 decimals to decimals of selectedDecimals
		uint256 reqTokenBal = (amount * sellPrice) / (10 ** (MAX_DECIMALS - selectedDecimals));
		...
		require(reqTokenBal > 0, "precision error");
