...
contract TestMultisend is Ownable, ITestMultisend {
    ...
    function multisendToken(address token, bool ensureExactAmount, address[] calldata targets, uint256[] calldata amounts) external payable override {
        if (token == address(0)) {
            ...
            function(IERC20, address, address, uint256) transfer = ensureExactAmount ? _safeTransferFromEnsureExactAmount : _safeTransferFrom;
