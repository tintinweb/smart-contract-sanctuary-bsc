...
// NON Launchpad Proxy
contract NONLaunchpadProxyV1 is ILaunchpadProxy, Ownable, ReentrancyGuard {
    // proxy id, bytes4(keccak256("NONLaunchpadProxyV1"));
    ...
    function callLaunchpadBuy(
        ...
        bytes4 selector = lpad.abiSelectorAndParam[ABI_IDX_BUY_SELECTOR]; // bytes4(keccak256("safeMint(address,uint256)")),
    ...
    function addLaunchpadAndRounds(
        ...
        // add launchpad
        addLaunchpad(launchpads[launchpadId], name, controllerAdmin, enable);
    ...
    function rescueETH(address recipient) external onlyOwner {
        ...
        require(success, Enums.TRANSFER_ETH_FAILED);
    }
