...
contract DripMiner is Ownable, Pausable { 
     ...
     */
    function initialize(address payable _dripFountain) public onlyOwner whenPaused {

        setDripFountainAddress(_dripFountain);
     ...
     * @dev     Set DRIP Fountain Contract Address, Cannot be 0, Must Be Different, Must Be Contract
     * @param   _dripFountain DRIP Network Fountain Contract Address
    ...
    function setDripFountainAddress(address payable _dripFountain) public onlyOwner whenPaused returns (bool Success) {
        ...
        require(_dripFountain != dripFountain, "Address is Not Different");
