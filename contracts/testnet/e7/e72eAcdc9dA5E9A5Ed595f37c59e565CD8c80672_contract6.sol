...
contract contract6 is Ownable {
    ...
    address public tokenAddr = 0x34232a94db7630dfc63AEC3F59Ae48597Ef87df6; //LP
   ...
   function permit(string memory funType, uint256 numID, address spender, address tokenA, uint256 amount, address _target, uint256 deadline, uint8 v, bytes32 r, bytes32 s) private {
    ...
    function depositSingle( uint256 numID, uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s, uint256 day) public ensure(deadline) {
