...
contract FishermanFarm is Ownable {

    uint256 public constant GOLD_TO_HIRE_1MINER = 100 *1 days /10;//960k golds to hire 1 fisherman, 9% apr daily
    ...
    function updateMaxBuy(uint256 amount) external onlyOwner{
