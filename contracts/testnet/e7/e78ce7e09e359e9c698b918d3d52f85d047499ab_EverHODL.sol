...
contract EverHODL is ERC20Detailed, Ownable {
    ...
    uint256 public busdDividendFee = 60;
    uint256 public sellFee = 0;
    uint256 public totalFee = treasuryFee.add(busdDividendFee);
 ...
 function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(busdDividendFee);
        ...
        (success, ) = payable(eHodlDividendReceiver).call{
        value: currentBalance.mul(busdDividendFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
