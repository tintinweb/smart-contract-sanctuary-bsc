...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("DarthmOOn_Div_Track", "DMT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract DarthMoonStake is Main {

    constructor() Main (
        "Darth mOOn stake",       // Name
        "DeathStake",        // Symbol
        9,                  // Decimal
        0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7,     // Reward MoonWalk
        0xe7c533355a7Fa04baf083C726a442db7Dc0971b1,     // Marketing address
        0xe7c533355a7Fa04baf083C726a442db7Dc0971b1,     // Team address
        0xe7c533355a7Fa04baf083C726a442db7Dc0971b1,     // Multi Use address
