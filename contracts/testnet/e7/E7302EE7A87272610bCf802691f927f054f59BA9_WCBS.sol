...
contract WCBS is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.div(2));
        USDT.transferFrom(address(_tokenDistributor), devAddress, fundAmount.div(2));
