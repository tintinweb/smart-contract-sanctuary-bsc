...
contract TuesdayLottery is ReentrancyGuard {
    ...
    bool public isFridayLotteryActive;
    ...
    function addWinningNumber(
        ...
        uint256 _star1,
        uint256 _star2
    ) external onlyOwner checkLotteryStarted{
        require(
            (_number1 != 0 &&
                _number2 != 0 &&
                _number3 != 0 &&
    ...
    function annouceWinner() external nonReentrant onlyOwner checkLotteryStarted {
        require(
        ...
        sendMaintenanceStakeAndGoodCausesAmount(maintenanceStakeAndGoodCausesAmount);
