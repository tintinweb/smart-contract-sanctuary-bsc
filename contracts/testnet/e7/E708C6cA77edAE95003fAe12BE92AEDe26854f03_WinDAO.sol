...
contract WinDAO is DAO, DAOCountVotes, DAOVotes, DAOQuorum {
    ...
    uint256 public proposeCoolDown = 200;
...
abstract contract DAO is Context, ERC165, EIP712, IDAO {
    ...
    function setFirstFinalProposal() public virtual {
        ...
        require(higestRateProposalId != 0, "DAO:Queued Empty");
        require(
            _finalProposalId == 0 ||
                state(_finalProposalId) == ProposalState.Defeated,
            "DAO: Invalid proposalId"
        );
    ...
    function execute(
        ...
        uint256 highestRateForProposal = _highestRateFor();
        if (highestRateForProposal!= 0) {
            _setFinalProposal(highestRateForProposal);
        }
        return proposalId;
    }
