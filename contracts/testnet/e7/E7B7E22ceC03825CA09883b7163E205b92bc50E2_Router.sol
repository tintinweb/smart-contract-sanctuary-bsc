...
interface IFactory {
    event PairCreatedA(address indexed token0, address indexed token1, address pair, uint);
...
interface IPair is IPancakeERC20 {
    event MintA(address indexed sender, uint amount0, uint amount1);
    event BurnA(address indexed sender, uint amount0, uint amount1, address indexed to);
    event SwapA(
    ...
    event SyncA(uint112 reserve0, uint112 reserve1);
...
interface IPancakeERC20 {
    event ApprovalA(address indexed owner, address indexed spender, uint value);
    event TransferA(address indexed from, address indexed to, uint value);
