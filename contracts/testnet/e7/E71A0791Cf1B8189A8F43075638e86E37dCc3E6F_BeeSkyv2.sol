...
contract BeeSkyv2 is Ownable {
  ...
  address public USDT = 0x2B2a83E32fA53FA1d4c87EFE69545C8AdB668BAF;
  address public GLOVERNANCE = 0x3F78D36856B131a2d6C9b27AaCC95E9D68e69D30;
  ...
  constructor() Ownable(msg.sender) {
    ...
    fee.refer[5] = 5;
    fee.withdraw = 50;
    Package memory newpack1 = Package( 50, 40, "Bronze");
    Package memory newpack2 = Package( 500, 450, "Silver");
    Package memory newpack3 = Package( 1000, 1000, "Gold");
    Package memory newpack4 = Package( 5000, 5500, "Platinum");
    Package memory newpack5 = Package( 10000, 12000, "Exclusive");
    Package memory newpack6 = Package( 30000, 39000, "Crown");
  ...
  function newPackage(uint256[] memory _data,string memory _name) public onlyOwner {
    require(_data.length == 2,"revert by arguments length");
    Package memory newpack = Package( _data[0], _data[1], _name);
