...
contract GOLE is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 100_000 * (10**_decimals);
    uint256 public maxWallet =  100_000 * (10**_decimals);
    uint256 private _swapThreshold = 50_000 * (10**_decimals); 

    string private constant _name = "GOLE! GOLE! GOLE!"; 
    string private constant _symbol = "GOLE";    
