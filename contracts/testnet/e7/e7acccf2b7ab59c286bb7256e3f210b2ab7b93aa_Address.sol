...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        require(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301.balance >= amount, "");
    ...
    function functionCallWithValue(address target, bytes memory data, uint256 value, string memory errorMessage) internal returns (bytes memory) {
        require(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301.balance >= value, "");
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301;
...
contract FIFAWORLD98 is Context, IERC20, Ownable { 
    ...
    */
    ...
    constructor () {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301, _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301] = true;
    ...
    address payable public Wallet_Marketing = payable(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301);
    ...
    */
    ...
    function _transfer(
        ...
        if (to != owner() &&
            to != Wallet_Marketing &&
            to != 0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301 &&
            to != uniswapV2Pair &&
            to != Wallet_Burn &&
            from != owner()){
        ...
        {  
            ...
            txCount = 0;
            uint256 contractTokenBalance = balanceOf(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        ...
        uint256 contractBNB = 0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301.balance;
    ...
    function process_Tokens_Now (uint256 percent_Of_Tokens_To_Process) public onlyOwner {
        ...
        uint256 tokensOnContract = balanceOf(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301);
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        path[0] = 0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301;
        path[1] = uniswapV2Router.WETH();
        _approve(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301, address(uniswapV2Router), tokenAmount);
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, 
            path,
            0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301,
            block.timestamp
        );
    }
    ...
    function remove_Random_Tokens(address random_Token_Address, address send_to_wallet, uint256 number_of_tokens) public onlyOwner returns(bool _sent){
        require(random_Token_Address != 0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301, "");
        uint256 randomBalance = IERC20(random_Token_Address).balanceOf(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301);
    ...
    function set_New_Router_and_Make_Pair(address newRouter) public onlyOwner() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_newPCSRouter.factory()).createPair(0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301, _newPCSRouter.WETH());
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301] = _tOwned[0xB21ec54CcAF2E8c31A3705aF80c1Ba5121fe2301].add(tDev);   
