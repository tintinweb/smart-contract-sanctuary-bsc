...
contract TreasuryCasinoTest is ERC20Capped, ERC20Mintable, ERC20Burnable, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = totalSupply().div(10000); // 0.01 % of totalSupply
    ...
    constructor() ERC20("Treasury Casino Test", "CCHIPSTest")
                    ERC20Capped(5000000000*10**6)  {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "CCHIPS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CCHIPS: Automated market maker pair is already set to that value");
    ...
    function setSwapTokensAtAmount(uint256 newAmt) external onlyOwner() {
        swapTokensAtAmount = newAmt * (10**6);
    }

     function setFees(uint256 _marketingBuyFee, uint256 _marketingSellFee) external onlyOwner() {
