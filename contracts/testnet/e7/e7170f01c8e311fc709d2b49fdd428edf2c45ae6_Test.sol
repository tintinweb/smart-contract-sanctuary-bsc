 ...
 */
    ...
    function changeBurnRate(uint256 rate) external notGreaterThanLimitThreshold(rate) onlyAdmin {
        burnRate = rate;
        emit ChangeBurnRate(burnRate);
    }

    function changeTreasuryRate(uint256 rate) external notGreaterThanLimitThreshold(rate) onlyAdmin {
        treasuryRate = rate;
    ...
    function changePercentAmountWhale(uint256 rate) external notGreaterThanLimitThreshold(rate) onlyAdmin {
