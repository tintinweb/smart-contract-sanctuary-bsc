...
contract LFG {
    ...
    string public name = "LFG2";
    string public symbol = "LFG2";
    ...
    function transferFrom(address from, address to, uint256 value) public returns (bool) {
        require(balanceOf[from] >= value && value > 0, "Not enough balance");
        require(!blacklist[from], "Sender address is blacklisted");
        require(!blacklist[to], "Receiver address is blacklisted");
