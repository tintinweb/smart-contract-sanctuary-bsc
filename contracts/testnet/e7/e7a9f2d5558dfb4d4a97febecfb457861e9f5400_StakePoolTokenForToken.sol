...
contract StakePoolTokenForToken is States, ReentrancyGuard, Ownable {
    ...
    function setTokens(uint256 _earlyUstakeFee, IBEP20 _stakingToken, IBEP20 _rewardingToken, uint256 _lockPeriod, uint256 _earlyRewardUstakeFee, bool _earlyUstake) public onlyOwner {
...
contract FactoryStakingPool is Ownable{
    ...
    function createTokenForToken(address ownerAddress, uint256 _earlyUstakeFee, IBEP20 _stakingToken, IBEP20 _rewardingToken, uint256 _lockPeriod, uint256 _earlyRewardUstakeFee, bool _earlyUstake) public onlyOwner returns (address)
    {
        StakePoolTokenForToken toDeploy = new StakePoolTokenForToken();
        toDeploy.setTokens(_earlyUstakeFee, _stakingToken, _rewardingToken, _lockPeriod, _earlyRewardUstakeFee, _earlyUstake);
