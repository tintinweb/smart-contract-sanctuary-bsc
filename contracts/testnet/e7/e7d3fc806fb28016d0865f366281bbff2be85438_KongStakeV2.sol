...
// File: contracts/KongProject/KongBUSD_V2.sol
...
contract KongStakeV2 is Ownable, ReentrancyGuard {
    ...
    function activateMigratedStake(uint256 _stakeId, uint256 _amount) public{
        ...
        userStakesById[stakeId] = userStakeDetails;
        updateStakeArray(stakeId,msg.sender);
    ...
    function unstake(uint256 _stakeId) nonReentrant external returns (bool){
        ...
        users[msg.sender] = userDetails;
        updateStakeArray(_stakeId,msg.sender);
    ...
    function updateStakeArray(uint256 _stakeId, address _userAddress) internal {
        userStake[] storage userStakesArray = userStakeLists[_userAddress];
    ...
    function setActionedTime(uint256 _stakeId, uint256 _days, address _userAddress)  public {
        ...
        userStakeDetails.nextActionTime = userStakeDetails.lastActionedTime + 1 days;
        userStakesById[_stakeId] = userStakeDetails;
        updateStakeArray(_stakeId, _userAddress);
    }
