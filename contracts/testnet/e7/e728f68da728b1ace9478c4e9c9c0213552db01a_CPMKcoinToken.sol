...
contract CPMKcoinToken {
 ...
 constructor() {
        name = "Champamongkon Coin 6"; // Sets the name of the token, i.e Ether
        symbol = "CPMKCOIN6"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 5000000000; // Holds an initial supply of coins
