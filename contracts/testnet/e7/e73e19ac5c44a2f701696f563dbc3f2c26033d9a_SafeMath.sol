...
contract METALAXY  is IBEP20, Auth {
    ...
    string constant _name = "tesese";
    string constant _symbol = "tesese";
    ...
    uint256 _totalSupply = 10* 12**10 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2 * 12**10 * (10 ** _decimals);
    uint256 public _walletMax = 2 * 12**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x69AA937815e7b9a8817D072413751c3338fF5344;
        marketingWallet = 0x69AA937815e7b9a8817D072413751c3338fF5344;
        devWallet = 0x69AA937815e7b9a8817D072413751c3338fF5344;
