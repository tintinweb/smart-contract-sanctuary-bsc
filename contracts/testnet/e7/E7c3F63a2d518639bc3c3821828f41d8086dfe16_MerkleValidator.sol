...
contract MerkleValidator is Ownable{
    ...
    function setTransferNFTManagerAddress(address _transferNFTManagerAddress) public onlyOwner {
    ...
    returns (address)
    {
        ...
        require( (msg.sender == proxyForFrom) || (msg.sender == transferNFTManagerAddress) , "Only owner's proxy or  transferNFTManager can process nft transfer!");
