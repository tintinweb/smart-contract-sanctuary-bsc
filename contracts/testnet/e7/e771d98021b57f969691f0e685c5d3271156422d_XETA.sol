...
contract XETA is ERC20, ERC20Detailed, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    uint   private constant _numTokens = 4875000000;
    ...
    */
    ...
    constructor (address to, address _liquidity, address _seed, address _private, address _public) public ERC20Detailed(_name, _symbol, 18) {
        require(to!=address(0),"Null Address");
        _mint(to, _numTokens * (10 ** uint256(decimals())));  // minting vesting supply 
        _mint(_liquidity, 75000000 * (10 ** uint256(decimals())));  
        _mint(_seed, 10000000 * (10 ** uint256(decimals())));  
        _mint(_private, 30000000 * (10 ** uint256(decimals())));  
        _mint(_public, 10000000 * (10 ** uint256(decimals())));  
    ...
    */
    ...
    function changeTransferLimit(uint256 _limit) onlyOwner external minLimit(_limit) {
