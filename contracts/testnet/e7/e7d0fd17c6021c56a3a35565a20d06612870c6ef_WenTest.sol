...
contract WenTest is Context, IERC20, Ownable {
    ...
    //Distribution
    address payable public _distributionTokenContractAddress = payable(0x2B547d7F32aAC8270139A3D6FFbb8213f5Aed3f7); //Contract for our WenDistributionToken
    address payable public _wenTokenDistributionLockWallet = payable(0xbB66e8a7e4D2CFD81F6Fb8CF03D76A03eDFBF5f5); //Locked Wallet with WenToken that get distributed
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**6 * 10**9; // 10 Million $WEN will be used to buy at maximum in any one trade
    ...
    function getLiquidityPairAddress() external view returns (address) {
        return _pancakeswapV2LiquidityPair;
    }
