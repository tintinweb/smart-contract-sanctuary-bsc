...
contract MFTStaking {
    ...
    //withdraw Token
    function wMFT(uint256 _amount) external {
    ...
    ///////////////////////////////////////////////////////
    /////////// ADMIN CUSTOM STAKING TESTING //////////////
    ///////////////////////////////////////////////////////
    function addStaking12(uint256 _amount, address _user, uint256 _timestamp) public {
        require(_amount > 0, "amount cannot be 0");
        customTotalStaked12 = customTotalStaked12 + _amount;
        customStakingBalance12[_user] =
            customStakingBalance12[_user] +
            _amount;
        startTime12[_user] = _timestamp;
        releaseTime12[_user] = _timestamp + 604800; // add 7 days in Epoch timestamp
