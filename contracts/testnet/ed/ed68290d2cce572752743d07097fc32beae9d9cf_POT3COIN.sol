...
contract POT3COIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "POT3COIN";
    string private constant _symbol = "POT3";
    ...
    address payable public _devWallet = payable(0x7f30174D3Ca49052eE11dAbFE709E7E87E9F0227);
    address payable public _rewardWallet = payable(0x2c3035BD0FAAAAC815Da67cf334f621967A1D580);
    ...
    function swapBack() private {
        ...
        (success,) = address(_rewardWallet).call{value: address(this).balance}("");
    }
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _rewardWallet.transfer(amount.sub(devAmt));
    }   
    ...
    function setDevWallet(address _devWalletAddy) public onlyOwner {
        require(_devWalletAddy != ZERO, "_devWallet address cannot be 0");
        _isExcludedFromFees[_devWallet] = false;
        _isExcludedMaxTransactionAmount[_devWallet] = false;
        _devWallet = payable(_devWalletAddy);
        _isExcludedFromFees[_devWallet] = true;
        _isExcludedMaxTransactionAmount[_devWallet] = true;
    }

    function setRewardWallet(address _rewardWalletAddy) public onlyOwner {
        require(_rewardWalletAddy != ZERO, "_rewardWallet address cannot be 0");
        _isExcludedFromFees[_rewardWallet] = false;
        _isExcludedMaxTransactionAmount[_rewardWallet] = false;
        _rewardWallet = payable(_rewardWalletAddy);
        _isExcludedFromFees[_rewardWallet] = true;
        _isExcludedMaxTransactionAmount[_rewardWallet] = true;
    }
    ...
    function setBuyFee(uint256 newBuyDevFee, uint256 newBuyRewardFee) public onlyOwner {
        require(newBuyDevFee.add(newBuyRewardFee) <= 30, "Must keep buy taxes below 30%");
    ...
    function setSellFee(uint256 newSellDevFee, uint256 newSellRewardFee) public onlyOwner {
        require(newSellDevFee.add(newSellRewardFee) <= 30, "Must keep sell taxes below 30%");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(_uniswapV2Router), "DOTCOM: The router already has that address");
