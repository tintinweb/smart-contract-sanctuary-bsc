...
contract GeeKproToken is owned, ERC165 {
    ...
    string constant private _name = "GeeKpro";
    string constant private _symbol = "GKP";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 600000000000 * (10**_decimals);         //20 billion tokens
    uint256 constant public maxSupply = 6000000000000 * (10**_decimals);    //20 billion tokens
