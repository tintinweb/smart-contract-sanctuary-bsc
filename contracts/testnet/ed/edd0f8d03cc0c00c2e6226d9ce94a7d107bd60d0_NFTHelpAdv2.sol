...
contract NFTHelpAdv2 is AYiBoxBase {
    ...
    function getAllHashrateParam(address target) public view haveHeroAddress returns(uint256 suit, uint256 suits,uint256 lv4, uint256 lv5,uint128 lv4per, uint128 lv5per, uint256 bounes,uint256 hs, uint256 rhs) {
        ...
        // 0 start, 32 end, 64 hashrate, 128 basehashrate, 196 lTime
    ...
    function checkAndUpdatehashrate(uint256 _tT, uint256[] memory _stH, uint256[] memory _stL,Base memory b_, B1 memory b1) internal {
    ...
    function levelUp(uint256 _tT, uint256[] memory _stH, uint256[] memory _stL) public lock returns (bool, uint256, uint256) {
        ...
        checkAndUpdatehashrate(_tT, _stH, _stL, b_, b1);
