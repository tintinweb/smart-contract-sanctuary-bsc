...
contract Elektron is ERC20, ERC20Burnable, SubscriptionControl, Pausable, Ownable {
    constructor(uint256 _totalSupply) ERC20("Elektron", "EKTN") {
...
// Under Development
    ...
    */
        ...
        returns (bytes32)
    {
        ...
        require((token.allowance(msg.sender, address(this)) >= amountRequired),
        ...
        // Save subscription
        bytes32 subscriptionId = keccak256(abi.encodePacked(msg.sender, block.timestamp));
        ...
        token.safeTransferFrom(msg.sender, _payeeAddress, _amountInitial);
    ...
    */
        ...
        returns (bool)
    {
        ...
        IERC20 token = IERC20(address(this));
        token.safeTransferFrom(subscription.owner, subscription.payeeAddress, _amount);
