...
contract Multi is Ownable , StandardToken {
    ...
    */
    ...
    function sendBSC(address payable[] memory _to, uint _value) public {
    ...
    */
	...
	function mutiSendBSCWithDifferentValue(address payable[] memory _to, uint[] memory _value)  public {
    ...
    */
    ...
    function mutiSendBSCWithSameValue(address payable[] memory _to, uint _value)  public {
		BSCSendSameValue(_to,_value);
    ...
    */
	...
	function mutiSendCoinWithSameValue(address _tokenAddress, address[] memory _to, uint _value)  public {
    ...
    */
	function mutiSendCoinWithDifferentValue(address _tokenAddress, address[] memory _to, uint[] memory _value)  public {
    ...
    */
    function multisendToken(address _tokenAddress, address[] memory _to, uint[] memory _value)  public {
	    coinSendDifferentValue(_tokenAddress, _to, _value);
