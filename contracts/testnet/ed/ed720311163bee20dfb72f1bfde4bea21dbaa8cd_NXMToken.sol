...
contract NXMToken is IERC20 {
    ...
    mapping(address => uint256) public isLockedForMV;
    ...
    modifier onlyOperator() {
        if (operator != address(0)) require(msg.sender == operator);
        _;
    }

    constructor(address _founderAddress, uint256 _initialSupply) public {
