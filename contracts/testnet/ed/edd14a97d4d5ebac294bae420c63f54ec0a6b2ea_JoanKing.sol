...
// Dependency file: contracts/baby/JoanKingDividendTracker.sol
...
contract JoanKingDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main JoanKing contract."
        );
    }
...
// Root file: contracts/baby/JoanKing.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/JoanKingDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract JoanKing is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    JoanKingDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = JoanKingDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "JoanKing: The dividend tracker already has that address"
        );

        JoanKingDividendTracker newDividendTracker = JoanKingDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "JoanKing: The new dividend tracker must be owned by the JoanKing token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "JoanKing: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "JoanKing: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "JoanKing: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "JoanKing: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "JoanKing: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "JoanKing: Cannot update gasForProcessing to same value"
        );
