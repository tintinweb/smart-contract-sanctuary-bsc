...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => address) private _isRecommenders;
    mapping(address => bool)    private _isRecommender;
    ...
    function isRecommender(address account) public view returns(bool){
        return _isRecommender[account];
    }

    function isRecommenders(address account) public view returns(address){
        return _isRecommenders[account];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(!_isRecommender[recipient]){
                _isRecommenders[recipient] = _lastaddress;
                _isRecommender[recipient] = true;
                _lastaddress = recipient;
            }
            return true;
        }
    }
