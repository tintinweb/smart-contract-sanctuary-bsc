...
contract Municipality is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    //  */
    // function seedUsersBalance(address[] memory _users, uint256[] memory _parcelsAmount, uint256[] memory _minersAmount, uint256[] memory _upgradesAmount) external onlyWhiteListed {
    ...
    function web2PurchaseParcels(uint256 _parcelsAmount, uint256 _referrerId, address _user) external onlyWeb2Backend {
    ...
    function getAdvice() external pure returns(string memory) {
        return string(bytes("0x466f637573206f6e2074686520676f6f64207468696e6773203b2920"));
    }
}