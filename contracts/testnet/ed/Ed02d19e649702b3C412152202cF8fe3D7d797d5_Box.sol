...
contract Box is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    */
    ...
    function mint(address _to, uint256 _tokenId) external onlyMinter {
        require(!_exists(_tokenId), "GameBox: must have unique tokenId");
        _mint(_to, _tokenId);
    }
        ...
        onlyMinter
    {
        ...
        require(counter > 0, "Box: number of tokens must be greater then 0");
        for (uint256 i = 0; i < counter; i++) {
            require(!_exists(tokenIds[i]), "GameBox: must have unique tokenId");
    ...
    */
    ...
    function openBox(
        ...
        require(
            ECDSA.recover(_msgHash, _signature) == msg.sender,
        ...
        //mint item
        nftContr.mintBatch(msg.sender, _tokenIds);

        emit BoxOpened(msg.sender, _boxType, _tokenIds);
    }
}
