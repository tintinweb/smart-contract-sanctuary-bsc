...
contract BabaluBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Babalu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x623eDE2168e6628c4039A599046775d573774dd7);
        _feeAddrWallet2 = payable(0x623eDE2168e6628c4039A599046775d573774dd7);
