...
contract mm {
    ...
    constructor () public {
        ...
        balances[0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883] = _totalSupply;
        emit Transfer(address(this), 0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883, _totalSupply);
    ...
    function sellMbe(uint mbe)public  view returns (uint){
        if(ERC20(address(0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883)).balanceOf(pir) > 0){
            ...
            uint[] memory amount;
            path[0]=address(this);
            path[1]=0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883;
