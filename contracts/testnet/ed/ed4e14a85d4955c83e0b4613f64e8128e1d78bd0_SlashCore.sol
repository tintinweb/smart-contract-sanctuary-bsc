...
contract SlashCore is ISlashCore, Ownable {
    ...
    function doMerchantDeposit(
        ...
        if (payingToken_ == receiveToken) {
            ...
            if (amountIn_ > requiredAmountOut_) {
                ...
                return (amountIn_.sub(requiredAmountOut_));
            } else {
                return 0;
            }
        } else {
    ...
    function submitTransaction(
        ...
        excessRequestToken = doMerchantDeposit(
            merchant,
            account_,
            payingToken_,
            amountIn_,
        ...
        if (msg.value > ethRequired) {
            ...
            residualPlatformTokens = msg.value.sub(ethRequired);
        }else{
            residualPlatformTokens = 0;
        }
         
        return (excessRequestToken, residualPlatformTokens);
    }
