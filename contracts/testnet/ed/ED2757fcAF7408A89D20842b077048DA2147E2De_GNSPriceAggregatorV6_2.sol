...
// Arg [4] : _staking (address): 0xfb06a737f549eb2512eb6082a808fc7f16c0819d
// Arg [5] : _daiVaultFeeP (uint256): 40
// Arg [6] : _lpFeeP (uint256): 20
// Arg [7] : _sssFeeP (uint256): 40
...
contract GNSPriceAggregatorV6_2 is ChainlinkClient {
    ...
    bool public DENTROANTESIF = false;
    bool public DENTROFULFILLEJECUTOCALLBACK = false;
    bool public checkreturn = false;
    uint public ALENGTH = 0;
    // Events
