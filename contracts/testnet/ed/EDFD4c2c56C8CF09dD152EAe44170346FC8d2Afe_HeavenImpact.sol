...
/** HEAVEN IMPACT
Official TG: https://t.me/HeavenImpactOfficial
...
contract HeavenImpact is IBEP20, Auth {

    address private WETH;

    string private constant _name = "Heaven Impact";
    string private constant _symbol = "iHeaven";
    ...
    uint256 private _moderateBuyDisc = 2;
    uint256 private _severeBuyDisc = 4;
    uint256 private _extremeBuyDisc = 6;
    ...
    address public marketingWallet = payable(0x8E561C9a65Bc96560A79673118580dE7C2a0248E);
    address public ecosystemWallet = payable(0x8E561C9a65Bc96560A79673118580dE7C2a0248E);
	...
	require(newEcoFee <= 5 && newBuyMktFee <= 10 && newSellMktFee <= 10 && newLpFee <= 5, "Fees Too High");
	ecoFee = newEcoFee;
	buyMkt = newBuyMktFee;
	...
	require(moderateSellFee <= 25 && severeSellFee <= 25 && extremeSellFee <= 25, "Fees must be less than 25");
