...
contract TateInu is BaseErc20, AntiSniper, Burnable, Taxable, Dividends {
    ...
    constructor () {
        configure(0xc328617629372a77c49f58B25BB126C0571deACB);
        ...
        exchanges[pair] = true;
        taxDistributor = new TaxDistributor(routerAddress, pair, WBNB, 1500, 1500);
        ...
        taxDistributor.createWalletTax("Marketing", 500, 500, 0xc1F910B8230508DCee02FB8a34CCB0Af7Cb24F42, true);
        taxDistributor.createWalletTax("Development", 200, 200, 0x2DC1B289a884442810F79f3cCF2C782dD8FD3686, true);
        taxDistributor.createDividendTax("Reflections", 200, 200, dividendDistributorAddress(), false);
        autoSwapTax = true;

        // Dividends
        dividendDistributorGas  = 900_000;
