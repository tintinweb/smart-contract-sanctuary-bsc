        ...
        if(isBuy||isSale){
          if(isBuy){ //买
           ...
           trueAmount = amount.mul(97).div(100);
            _balances[Marketing] = _balances[recipient].add(trueAmount);
           emit Transfer(sender, recipient, trueAmount);
           marketAmount = amount.mul(2).div(100);
          
           setYt(recipient);
           _balances[Marketing] = _balances[Marketing].add(marketAmount);
          ...
          if(isSale){ //卖
           ...
           burnAmount = amount.mul(1).div(100);
            _balances[Marketing] = _balances[burnAccount].add(burnAmount);
