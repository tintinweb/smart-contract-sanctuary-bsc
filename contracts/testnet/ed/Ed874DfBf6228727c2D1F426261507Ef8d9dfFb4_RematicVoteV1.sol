...
contract RematicVoteV1 is ReentrancyGuard, Ownable {
    ...
    function _signatureWallet(address wallet, bytes memory _signature)
        private
        pure
        returns (address)
    {
    ...
    function voteQuestions(
        ...
        address wallet = _signatureWallet(_msgSender(), _signature);
        require(wallet == signer, "You're not authorized to vote.");
