...
contract MGToken is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = "MG";
    _decimals = 18;
    _totalSupply = 1000000000000000000000000000; // 1 billion (100 Crores)
  ...
  */
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    function setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 2000, 'taxFee should be in 0 - 2000');
        _taxFee = taxFee;
    }
