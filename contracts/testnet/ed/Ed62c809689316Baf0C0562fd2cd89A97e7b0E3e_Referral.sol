...
contract Referral is ReferralFetchers {
    ...
    function claimReward(address friendAddress) external {
        ...
        uint256 noOfActiveInsuranceInvestment = (regularInvestmentContract
            .getNoOfInvestmentsArray(friendAddress))[1];
        uint256 noOfActiveRegularInvestment = (regularInvestmentContract
            .getNoOfInvestmentsArray(friendAddress))[1];
        ...
        if (
            noOfActiveInsuranceInvestment < reward.minInsuranceInvestmentCount &&
