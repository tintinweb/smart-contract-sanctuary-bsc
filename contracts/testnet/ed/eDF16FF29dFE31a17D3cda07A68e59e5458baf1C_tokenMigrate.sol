...
contract tokenMigrate is Ownable {
    ...
    uint256 numberOfV1TokensForOneV2Token;

    event newMigrate(uint256 tokenAmountV1, uint256 tokenAmountV2, address toUser);
    event changeRation(uint256 newRatio, uint256 oldRatio);

    constructor() {
        TOKENV1 = IERC20(0xc0fe33B654d13AF5a72C47Dc5a370674ba85b3E6);
        TOKENV2 = IERC20(0xc0fe33B654d13AF5a72C47Dc5a370674ba85b3E6);
        numberOfV1TokensForOneV2Token = 500;
    }
