...
contract TierTokenLock is Ownable {
    ...
    function extendLockTime(uint256 additionalDays) external {
        require(
            additionalDays >= FOURTEEN_DAYS,
            "OrbitLock: Lock period should be at least 14 days!"
        );
        ...
        // TODO: Uncomment this line
        // lockInfo.unlockTimestamp += 3600 * 24 * additionalDays;
        lockInfo.unlockTimestamp += 60 * additionalDays;
        userLockInfo[msg.sender] = lockInfo;
    }
