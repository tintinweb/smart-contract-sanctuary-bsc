...
contract NFTGMARKET is ReentrancyGuard, ERC721URIStorage, Ownable {
  ...
  uint256 listingPercentage = 100;

  bool _takeFees = false;
  ...
  function takeCommission(
    ...
    require(royaltyPercent <= 500, 'Value Overflow: Stated Value Is Above 50 percent');
  ...
  function buyTokenNFTG(uint256 tokenId, address tokenContract) public nonReentrant {
