...
contract GUN_GunFishCrypto is ERC721{
    ...
    uint[] price_upgrade_gun_type0 = [1000*10**18,2000*10**18,3000*10**18,4000*10**18];
    uint[] price_upgrade_gun_type1 = [1100*10**18,2100*10**18,3100*10**18,4100*10**18];
    uint[] price_upgrade_gun_type2 = [1200*10**18,2200*10**18,3200*10**18,4200*10**18];
    uint[] price_upgrade_gun_type3 = [1300*10**18,2300*10**18,3300*10**18,4300*10**18];
    uint[] price_upgrade_gun_type4 = [1400*10**18,2400*10**18,3400*10**18,4400*10**18];
    ...
    function client_upgradeGun(uint tokenIdGun_1, uint tokenIdGun_2, uint tokenIdGun_3, uint _type, uint tokenAmountPos) public returns(address, uint, uint, uint, uint, uint, uint){
        ...
        if(_type==4){
            require(tokenAmountPos<price_upgrade_gun_type4.length, "[-3]Wrong token amount");
            ...
            return(msg.sender, tokenIdGun_1, tokenIdGun_2, tokenIdGun_3, _type, tokenAmountPos, price_upgrade_gun_type4[tokenAmountPos] );
        }
