...
//token:    0x7Be200bf340d2086B981AB5989A2a8bc670c2Df2
...
contract SocialMusifySale {
    ...
    uint256 private totalleft = openingTime.add(3000);
    ...
    function endSale(uint256 _amountLeft) public {
        require(msg.sender == admin);
        require(token.transfer(admin, token.balanceOf(address(this))));
        token.transfer(msg.sender, _amountLeft);
    }
}