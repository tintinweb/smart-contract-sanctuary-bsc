...
contract Yeni11 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50 * 10**2;  // Total supply * Decimals
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _totalBal;

    string private _name = "Yeni11" ;
    string private _symbol = "Y11";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**2;
