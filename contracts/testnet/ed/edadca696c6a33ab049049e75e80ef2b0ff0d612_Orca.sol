...
contract Orca is Ownable, ERC721, ERC721Enumerable {
    ...
    function _actualMintPrice() public view returns (uint) {
        ...
        if (currentSupply >= 1751) {
            ...
            return 100000000000000000; // 1 - 1000 0.11 BNB
        }
    }
    ...
    function _updateReflections() internal {
        ...
        if (currentSupply >= 1751) {
            ...
            _reflection = (100000000000000000 * _mintSharesReflect) / (10 ** _decimalBase); // 1 - 1000 0.11 BNB
        }
    }
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*2500)/10000); //20% Charity
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*2000)/10000); // 16% Treasury
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*1250)/10000); // 10% Orca Fund
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*2000)/10000); // 16% Dev Fund
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*750)/10000); // 6% Co-Founder
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*750)/10000); // 6% Co-Founder
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*750)/10000); // 6% Co-Founderz
        _balanceTeam = 0;
    }
