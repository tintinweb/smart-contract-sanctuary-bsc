...
contract X4Capital is Context, Ownable {
    ...
    function Deposit(address _upline, uint256 amount) external {
        require(amount >= mindeposit, "Minimum Deposit is 100 USDT!");
    ...
    function Reinvest() external {   
        ...
        require(player.dividends >= minredeposit, "Minimum reinvest is 50 USDT.");
    ...
    function Payout() external {      
        ...
        require(player.dividends >= minclaim, "Minimum payout is 50 USDT.");
    ...
    function setMindeposit(uint256 _mindeposit) public onlyOwner returns (bool success) {
        mindeposit = _mindeposit;
        return true;
    } 

    function setMinredeposit(uint256 _minredeposit) public onlyOwner returns (bool success) {
        minredeposit = _minredeposit;
        return true;
    } 

    function setMinclaim(uint256 _minclaim) public onlyOwner returns (bool success) {
        minclaim = _minclaim;
        return true;
    } 
