...
contract ENFT is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "England national football team";
    string private constant _SYMBOL = "ENFT";
    ...
    uint256 private _tTotal = (10**10) * _DECIMALFACTOR; // Total supply: 10000000000 tokens
