...
contract PandaToken is Context, IERC20, Ownable {
    ...
    string private _name = "Panda Token";
    ...
    // Anti bot
    uint256 public allowedBuyAmount;
    ...
    constructor(IPancakeV2Router02 _pancakeV2Router, address _marketingWallet, address _antiManager, uint256 _allowedBuyAmount) {
        ...
        allowedBuyAmount = _allowedBuyAmount;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != address(pancakeV2Router), 'We can not exclude Pancake router.');
    ...
    function _transfer(
        ...
        if (antiBotEnabled && from == pancakeV2Pair) {
            require(amount <= allowedBuyAmount, "Only allowed buy amounts");
        }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient] || recipient == pancakeV2Pair) {
            restoreAllFee();
        }
    }
