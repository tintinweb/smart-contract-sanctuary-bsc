...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    constructor(address _xox, address _usd) public {
        ...
        UniswapV2Pair(newPair).initialize(_xox, _usd, 10, msg.sender);
        xox = _xox;
        usd = _usd;
        pair = newPair;
    ...
    function swap(
        ...
        uint256 balance1;
        {
            ...
            if (amount1Out > 0) {
                ...
                _safeTransfer(_token1, profitWallet, tax); // optimistically transfer tokens
                _safeTransfer(_token1, to, amount1Out.sub(tax)); // optimistically transfer tokens
            }
            if (data.length > 0)
