...
contract MyToken is ERC20Upgradeable {
    ...
    function initialize(address stakingContract) external initializer {
        ...
        _mint(msg.sender, 600000000000000000000000000000); // 600 Billion -> 600,000,000,000
    ...
    function getAmountMintedForBonusPool() public pure returns (uint256) {
        return 200000000000000000000000000000; // 200 Billion -> 200,000,000,000
    }
    ...
    function getAmountMintedForBonusPoolOfLPStaking() public pure returns (uint256) {
        return 200000000000000000000000000000; // 200 Billion -> 200,000,000,000
    }
}
