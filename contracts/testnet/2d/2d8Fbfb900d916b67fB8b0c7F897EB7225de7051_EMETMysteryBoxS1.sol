...
contract EMETMysteryBoxS1 is ERC721Holder, Ownable, RandomGenerator {
    ...
    // tokenId - user
    mapping (uint => address) internal nftCardOwner;
    // user - tokenIdList
    ...
    function initialize(address token_, address nft_) public onlyOwner {
        setOpen(true, block.timestamp, 10 ether);
    ...
    function setOpen(bool isOpen_, uint startTime_, uint openPrice_) public onlyOwner {
        isOpen = isOpen_;
