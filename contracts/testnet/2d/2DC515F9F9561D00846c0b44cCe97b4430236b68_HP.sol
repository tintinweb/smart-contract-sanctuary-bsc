...
contract HP is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("HP", "hpps") {}


    function mint(uint256 quantity) external payable {
        // _safeMint's second argument now takes in a quantity, not a tokenId.
        // require(quantity + _numberMinted(msg.sender) <= perAddressLimit2, "Exceeded the limit");
