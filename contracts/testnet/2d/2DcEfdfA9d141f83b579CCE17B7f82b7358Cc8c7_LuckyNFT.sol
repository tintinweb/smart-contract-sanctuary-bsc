...
contract LuckyNFT {
    ...
    constructor(
        ...
        maxRarity[1] = 300;
        maxRarity[0] = 645;
        maxLuckyNFT = maxRarity[4] + maxRarity[3] + maxRarity[2] + maxRarity[1] + maxRarity[0];
 ...
 */
    ...
    function getLuckyNFT(uint256 numNFT) public returns (uint256 [] memory) {
    ...
    function openBatchLuckyNFTv1(address user, uint256 numNFT) internal returns (uint256 [] memory) {
        uint256 [] memory listLuckyNFT = new uint[](numNFT);
    ...
    function openBatchLuckyNFTv2(address user, uint256 numNFT) internal returns ( uint256 [] memory) {
        uint256 [] memory listLuckyNFT = new uint[](numNFT);
        for (uint256 i = 0; i < numNFT; i++){
 ...
 */
    ...
    function changeMaxRarity(uint256 legendary, uint256 ultraRare, uint256 superRare, uint256 rare, uint256 common) public onlyAdmin {
 ...
 */
    ...
    function getUserLuckyNFT(address user)
        public
        view returns (uint256)
    {
