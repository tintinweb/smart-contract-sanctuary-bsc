...
abstract contract Admin is Ownable {
    ...
    uint256[] public dailyRateDays = [90, 83, 76, 69, 62];
    uint256 public constant DAYS = 24 seconds; //1 days;
    uint256 public constant HOURS = 1 seconds; //1 hours;
    ...
    function setDailyDistribution(
        address[5] memory stakedToken,
        address[5] memory rewardToken,
        uint256[5] memory dailyDistribution
    ) public onlyOwner {
        require(
    ...
    function updateSequence(
        address stakedToken,
        address[5] memory rewardTokenSequence
    ) public onlyOwner {
    ...
    function setRewardCap(
        ...
        uint256[5] memory rewardsCaps
    ) public onlyOwner returns (bool) {
        require(
            tokenAddresses.length == rewardsCaps.length,
            "Invalid elements"
        );
        for (uint8 v = 0; v < tokenAddresses.length; v++) {
            ...
            require(rewardsCaps[v] > 0, "Invalid Reward Amount");
            rewardCap[tokenAddresses[v]] = rewardsCaps[v];
        }
        return true;
    }
}

// File contracts/SuperPoolsV1.sol

pragma solidity ^0.7.6;

/**
 * @title SuperPools Contract
 * @author Joacoca & Zokret
 */

contract SuperPoolsV1 is Admin {
    ...
    function updatePoolStartTime(uint256 newpoolStartTime) public onlyOwner {
        require(block.timestamp < poolStartTime, "Invalid pool start time");

        poolStartTime = newpoolStartTime;
    }

    function setTokenInfos(
        TokenView memory tokenViewA,
        TokenView memory tokenViewB,
        TokenView memory tokenViewC,
        TokenView memory tokenViewD,
        TokenView memory tokenViewE,
        uint256[5] memory _rewardsCaps
    ) public onlyOwner {
        uint256[5] memory tokensRPerPool = [
            _rewardsCaps[0].div(5),
            _rewardsCaps[1].div(5),
            _rewardsCaps[2].div(5),
            _rewardsCaps[3].div(5),
            _rewardsCaps[4].div(5)
        ];

        _addsTokens(tokenViewA, tokenViewB, tokenViewC, tokenViewD, tokenViewE);

        _setDistributionsPerDay(
            [
                tokenViewA.tokenAds,
                tokenViewB.tokenAds,
                tokenViewC.tokenAds,
    ...
    function _setDistributionsPerDay(
        ...
        setDailyDistribution(
            ...
            [
                _rewards[0].div(dailyRateDays[0].mul(24)),
                _rewards[1].div(dailyRateDays[1].mul(24)),
                _rewards[2].div(dailyRateDays[2].mul(24)),
                _rewards[3].div(dailyRateDays[3].mul(24)),
                _rewards[4].div(dailyRateDays[4].mul(24))
            ]
        );
        ...
        setDailyDistribution(
            ...
            [
                _rewards[1].div(dailyRateDays[0].mul(24)),
                _rewards[2].div(dailyRateDays[1].mul(24)),
                _rewards[3].div(dailyRateDays[2].mul(24)),
                _rewards[4].div(dailyRateDays[3].mul(24)),
                _rewards[0].div(dailyRateDays[4].mul(24))
            ]
        );
        ...
        setDailyDistribution(
            ...
            [
                _rewards[2].div(dailyRateDays[0].mul(24)),
                _rewards[3].div(dailyRateDays[1].mul(24)),
                _rewards[4].div(dailyRateDays[2].mul(24)),
                _rewards[0].div(dailyRateDays[3].mul(24)),
                _rewards[1].div(dailyRateDays[4].mul(24))
            ]
        );
        ...
        setDailyDistribution(
            ...
            [
                _rewards[3].div(dailyRateDays[0].mul(24)),
                _rewards[4].div(dailyRateDays[1].mul(24)),
                _rewards[0].div(dailyRateDays[2].mul(24)),
                _rewards[1].div(dailyRateDays[3].mul(24)),
                _rewards[2].div(dailyRateDays[4].mul(24))
            ]
        );
        ...
        setDailyDistribution(
            ...
            [
                _rewards[4].div(dailyRateDays[0].mul(24)),
                _rewards[0].div(dailyRateDays[1].mul(24)),
                _rewards[1].div(dailyRateDays[2].mul(24)),
                _rewards[2].div(dailyRateDays[3].mul(24)),
                _rewards[3].div(dailyRateDays[4].mul(24))
            ]
        );
    }

    function _setSequencesTokens(address[5] memory _tokenAddresses) internal {
        updateSequence(
            _tokenAddresses[0],
            [
                _tokenAddresses[0],
    ...
    function stake(
        ...
        require(
            block.timestamp > poolStartTime,
            "contract does not launch yet"
        );
        // checks
        require(
