...
contract ETRNL is Context, Ownable, Token {
    ...
    function initializeETRNL() external onlyOwner {
        require(!started, "Protocol already started.");
    ...
    function deposit(address referrer, uint256 amount) public payable {
        ...
        require(started, "Protocol not yet started.");
        ...
        ) 
    {
        ...
        currentstarted       = lastDepositLastDrawAction;  
    ...
    function topDepositInfo() 
        ...
        returns(
            ...
            uint256 topDepositCurrentstarted, 
        ...
        ) 
    {
        ...
        topDepositCurrentstarted       = topDepositLastDrawAction;
