...
contract NODERewardManagement {
    ...
    uint256 public feeDueDays = 30 minutes;
        ...
        onlySentry
    {
        ...
        NodeFee memory _nodeFee = NodeFee(block.timestamp, 0);
        ...
        returns (uint256 dueDate, uint256 lastPaidFee)
    {
        ...
        return (nodeFee.lastPaidDate, nodeFee.lastPaidFee);
    }
