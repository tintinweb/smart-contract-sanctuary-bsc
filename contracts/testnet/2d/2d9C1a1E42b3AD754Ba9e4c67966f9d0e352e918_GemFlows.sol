...
contract GemFlows  is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address private constant ETH = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x09cBCFb407E6d38241268116c14b0AB10Ae1bb2e)); //marketing wallet
    ...
    constructor() ERC20("GemFlowsCapital", "GFC1") {
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);   //BSC Testnet
    ...
    function swapAndSendToMarketing(uint256 tokens) private {
        ...
        totalTreasuryAmount = totalTreasuryAmount.add(newBalance);
    }
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("DOGEX_Dividend_Tracker", "DOGEX_Dividend_Tracker")
    {
        claimWait = 3600;
