...
contract LuckyTicketWDA is Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    uint256 public period = 300; // 300 secs = 5m
    ...
    function cronRollingWinningTicket() external {
        _setTicket100000WDA();
        _setTicket5000WDA();
        lastTimeCheck = block.timestamp;
    }

    function _setTicket5000WDA() internal isPeriod {
        getRandomNumber();
        // random number ticket for 1% user reward 5000 WDA
        uint256 _winnerCount = totalTicketSoldPerPeriod;
    ...
    function _setTicket100000WDA() internal isPeriod {
    ...
    function resetTicketEachDay() external onlyOwner {
        ticketSoldPerDay = 0;
    }

    function resetAllTicket() external onlyOwner isPeriod {
