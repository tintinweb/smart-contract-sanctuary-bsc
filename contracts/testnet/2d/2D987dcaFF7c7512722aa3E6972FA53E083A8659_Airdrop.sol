...
contract Airdrop is Validatable {
    ...
    function airdrop(uint256 amount) external payable {
        ...
        require(amount > 0 && boughtAmountOf[_msgSender()] + amount <= maxPerUser, "Invalid receives");
        // Set new amount
        boughtAmountOf[_msgSender()] += amount;
        ...
        // Emit events
        emit Airdroped(_msgSender(), amount);
    }
}
