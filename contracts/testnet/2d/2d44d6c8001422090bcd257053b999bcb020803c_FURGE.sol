...
contract FURGE is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string constant private _name = "FURGE";
    string constant private  _symbol = "FURGE";
    ...
    //Tax wallets
    address public teamWallet = 0xFDC55954c41431cBCbcD64C3a552EF088E0deB68;
    address public treasuryWallet = 0xFDC55954c41431cBCbcD64C3a552EF088E0deB68 ;
    ...
    //trading parameters
    uint256 public liquidity = 3 ether;
    ...
    /** Purchases FURGE Tokens and Deposits Them in Sender's Address*/
    function _buy(uint256 minTokenOut, uint256 deadline) public nonReentrant ensure(deadline) payable returns (bool) {
        ...
        // revert if under 1
        require(tokensToSend > 1,'Must Buy more than 1 decimal of Furge');
    ...
    /** Sells FURGE Tokens And Deposits the BNB into Seller's Address */
