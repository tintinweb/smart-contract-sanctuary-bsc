...
abstract contract StratX2 is Ownable, ReentrancyGuard {
    ...
    function withdraw(uint256 _wantAmt) public virtual onlyOwner nonReentrant returns (uint256, uint256) {
        checkForFarmAddressCall();
    ...
    function setSettings(uint256 _entranceFeeFactor, uint256 _withdrawFeeFactor) public virtual onlyOwner {
    ...
    function inCaseTokensGetStuck(address _token, uint256 _amount, address _to) public virtual onlyOwner {
