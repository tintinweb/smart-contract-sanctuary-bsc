...
contract LoneMTest is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address _reserveAddress)
        public
        ERC721("LMtEST-NFT", "L-NFT")
    {
        pricePer = 0.005 * 10 ** 18;
        maxPerTx = 1;
        maxMotor = 2000;
    ...
    function reserveMotor() public onlyOwner {   
     ...
     function mintMotor(uint256 numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxPerTx, "No more than 1 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxMotor, "Purchase would exceed max supply of L-NFT");
