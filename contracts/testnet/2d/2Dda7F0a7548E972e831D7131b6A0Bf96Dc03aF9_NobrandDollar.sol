...
// No Brand Dollar
//   _   _         ____                      _   ____        _ _            
//  | \ | | ___   | __ ) _ __ __ _ _ __   __| | |  _ \  ___ | | | __ _ _ __ 
//  |  \| |/ _ \  |  _ \| '__/ _` | '_ \ / _` | | | | |/ _ \| | |/ _` | '__|
//  | |\  | (_) | | |_) | | | (_| | | | | (_| | | |_| | (_) | | | (_| | |   
//  |_| \_|\___/  |____/|_|  \__,_|_| |_|\__,_| |____/ \___/|_|_|\__,_|_|   
...
// inherit
import "./bentobox/IBentoBoxV1.sol";

/// @title Cauldron
/// @dev This contract allows contract calls to any contract (except BentoBox)
/// from arbitrary callers thus, don't trust calls from this contract in any circumstances.
contract NobrandDollar is ERC20, BoringOwnable {
    using BoringMath for uint256;
    // ERC20 'variables'
    string public constant symbol = "TNBD";
    string public constant name = "TEST No Brand Dollar";
    ...
    function burn(uint256 amount) public {
        require(amount <= balanceOf[msg.sender], "NBD: not enough");
