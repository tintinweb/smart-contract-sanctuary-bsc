...
contract TBT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tbt🥊";
    string private constant _symbol = unicode"tbt🥊";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xF1b4ffC21FdE438b2717bC2aD4F4983EFa5e88E8); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9f12e2237eb5087B872C6AAF54c19a275805E47c); // buyback Address
    ...
    uint256 public _maxTxAmount = 1500 * 10**4 * 10**9;
    uint256 public _walletMax = 6000 * 10**4 * 10**9;
    uint256 private minimumTokensBeforeSwap = 8000 * 10**7; 
