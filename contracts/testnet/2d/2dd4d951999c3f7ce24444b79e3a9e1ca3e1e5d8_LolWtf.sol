...
contract LolWtf is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x6c31d8E6feb9fC3eE14e3D82592F1eb90B6CE915;
    address DevelopmentWallet = 0xa1BFa53959DEDf64F260Ed786ba6f968FFcd5F69;

    string constant _name = "LOLWTFBRO";
    string constant _symbol = unicode"LOLWTF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 888888888 * (10 ** _decimals);
    uint256 public _maxTxAmount = 9000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 18000000 * (10 ** _decimals);
