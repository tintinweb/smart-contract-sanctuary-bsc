...
contract SquidGame is SquidGameBasic {
    ...
    constructor(address _ownerAddress, address _secWallet, address _regWallet, IERC20 _depositTokenAddress) {
        ...
        LevelPayments[1].timeToOpen = block.timestamp + 20 minutes;
        LevelPayments[2].timeToOpen = block.timestamp + 40 minutes;
        LevelPayments[2].timeToOpen = block.timestamp + 60 minutes;
        LevelPayments[4].timeToOpen = block.timestamp + 80 minutes;
        LevelPayments[5].timeToOpen = block.timestamp + 100 minutes;
        LevelPayments[6].timeToOpen = block.timestamp + 120 minutes;
        LevelPayments[7].timeToOpen = block.timestamp + 140 minutes;
        LevelPayments[8].timeToOpen = block.timestamp + 160 minutes;
        LevelPayments[9].timeToOpen = block.timestamp + 180 minutes;
        LevelPayments[10].timeToOpen = block.timestamp + 200 minutes;
        LevelPayments[11].timeToOpen = block.timestamp + 220 minutes;
        LevelPayments[12].timeToOpen = block.timestamp + 240 minutes;
        LevelPayments[13].timeToOpen = block.timestamp + 260 minutes;
        LevelPayments[14].timeToOpen = block.timestamp + 280 minutes;
