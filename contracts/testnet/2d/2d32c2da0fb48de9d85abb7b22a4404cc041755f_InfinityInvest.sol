...
library SafeMath {
    ...
    contract InfinityInvest is Context, IBEP20, Ownable {
     ...
     * construction.
     */
    constructor(string memory name, string memory symbol, string memory company, string memory companyID, uint256 supply) {
        _name = name;
        _symbol = symbol;
        _decimals = 18;
        _totalSupply = supply;
    ...
    function blackList(address _user) public onlyOwner {
        ...
        require(_user != address(this), "Cannot blacklist Owner");
