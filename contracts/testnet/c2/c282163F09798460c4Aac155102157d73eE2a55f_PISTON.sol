...
contract PISTON is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public virtual initializer {
        ...
        feeTargetTokenAddress = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD testnet
        liquidityTokenAddress = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD testnet
        ...
        address _uniswapV2PairBNB = IUniswapV2Factory(_uniswapV2Router.factory())
        ...
        if(_devWalletAddress != _ecosystemWalletAddress){
