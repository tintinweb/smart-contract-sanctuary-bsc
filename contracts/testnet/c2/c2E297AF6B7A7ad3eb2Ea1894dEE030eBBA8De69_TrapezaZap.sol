...
contract TrapezaZap is TrapezaControlled {
  ...
  address private FIDL;

  IPancakeRouter02 private constant router = IPancakeRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
  IStakingV2 private stakingV2;
  // IStakingV2 private constant stakingV2 = IStakingV2(0x119b879011fC52Fd50A27E7ce645426C0F56c87b);
  ...
  function swapStakingVersion(address _newStaking) external onlyManager {
    stakingV2 = IStakingV2(_newStaking);
    IERC20(FIDL).approve(_newStaking, uint256(-1));
  }
  ...
  /* ======== CONSTRUCTOR ======== */
  constructor(address _busd, address _fidl) {
    ...
    //FIDL-BUSD
    addBond(IBond(0xeC57324d06030d2be12A2147128fF03381545C04), true);
    //BUSD
  ...
  console.log("fidlAmount", fidlAmount);
  ...
  function _Bond(
    ...
    require(
      ...
      string(abi.encodePacked("slippage exceeds, can only receive", uintToStr(outAmount)))
    );
