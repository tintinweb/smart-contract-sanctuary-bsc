...
contract Test1 is ERC20, Ownable{
    ...
    address public marketingWallet = 0x1857a4FDdee7B1Eaea619A2fb3032e19DB8E5D58;
    address public devWallet = 0x45815EcFFFC2636dd0768918E8507dDC4B821Dfb;
    address public operationWallet = 0x0F6D4FEa7b40f7775d1bCAaB4a47ED6af1199E5c;
    ...
    constructor() ERC20("Test1", "Test1s") {
        _mint(msg.sender, 420000000 * 10 ** decimals());
        exemptFee[msg.sender] = true;

        IRouter _router = IRouter(0x45815EcFFFC2636dd0768918E8507dDC4B821Dfb);
