...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWD = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); //XRP
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RWD.transfer(shareholder, amount); //Reward
...
/* Token contract */
contract CumXRP is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWD = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //XRP
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB PAIR
    ...
    address DEV = 0xa8820ECB6495536d8aD6feFE2e4519D689b7b43E; //DEV
    ...
    // Name and symbol
    string constant _name = "CumXRP";
    string constant _symbol = "CUMXRP";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000000000000000 * (10 ** _decimals); // 1 octillion
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //mainet
        ...
        autoLiquidityReceiver = 0xa8820ECB6495536d8aD6feFE2e4519D689b7b43E;
        marketingFeeReceiver = 0xa8820ECB6495536d8aD6feFE2e4519D689b7b43E; //Marketing Wallet
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient] && recipient != pair){
    ...
    // Enable GREED
    function enableGREED(uint256 _seconds) external authorized {
