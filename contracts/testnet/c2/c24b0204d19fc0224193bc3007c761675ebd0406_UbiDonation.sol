...
contract UbiDonation is Initializable, JaxOwnable {
    ...
    function initialize(IERC20 _wjax, UBI _ubi) external initializer {
        wjax = _wjax;
        ubi = _ubi;
        ubi_admin_fee = 5; // 5%
    ...
    function deposit_reward() external {
        require(wjax.balanceOf(address(this)) > 0, "Nothing to deposit");
        ubi.deposit_reward(wjax.balanceOf(address(this)));
    }
}
