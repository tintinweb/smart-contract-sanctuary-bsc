...
contract Quantic is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0x8ACD539223B2E4b2b9096109C0637c99B13BA463;
        sustainabilityFeeReceiver = 0x3E0a34E74cF223348226C1a9aE66b6D735cdC1Fa; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != treasuryFeeReceiver && recipient != sustainabilityFeeReceiver){
    ...
    function tradingStatus(uint256 _deadBlocks) external onlyOwner {
        tradingOpen = true;
    ...
    function setFeeReceivers(address _treasuryFeeReceiver, address _sustainabilityFeeReceiver ) external authorized {
