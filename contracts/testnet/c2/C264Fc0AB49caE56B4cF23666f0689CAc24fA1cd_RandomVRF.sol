...
contract RandomVRF is VRFConsumerBase, Ownable {
    ...
    )
  {
    ...
    fee = 5000000000000000; // 0.005 LINK (Varies by network)
    uint256 max = 2 ** 256 - 1;
    IERC20(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06).safeApprove(address(0x6A2AAd07396B36Fe02a22b33cf443582f682c82f), max);
  }
