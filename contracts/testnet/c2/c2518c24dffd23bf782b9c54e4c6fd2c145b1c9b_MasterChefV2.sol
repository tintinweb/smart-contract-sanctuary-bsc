...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. Zeuses to distribute per block.
        uint256 lastRewardBlock;  // Last block number that Zeuses distribution occurs.
        uint256 accTokenPerShare;   // Accumulated Zeuses per share, times 1e12. See below.
