...
contract Ens2Music is ERC721Enumerable, Ownable, AccessControl {
    ...
    // Music pass price
    uint256 private purchasePrice = 100000000000000 wei;
    ...
    string[6] pronoun = ["the", "their", "our", "his", "her", "my"];
    string[93] noun = ["airdrop", "alpha", "altcoin", "ape", "ATH", "ATL", "bear market", "Bitcoin", "block", "blockchain", "blockchain domains", "block explorer", "bridge", "buidl", "bull market", "CEX", "CeFi", "coin", "collateral", "cold wallet", "consensus", "consensus mechanism", "cryptocurrency", "DAO", "Dapp", "data", "degen", "DeFi", "DEX", "Diamond Hands", "difficulty bomb", "EIP", "ERC", "fiat", "flippening", "FOMO", "fork", "FUD", "full node", "gas", "genesis block", "gm", "Gwei", "hard fork", "hash rate", "HODL", "ICO", "IEO", "key", "L1", "L2", "lambo", "liquidity pool", "mainnet", "market cap", "master node", "metaverse", "NFT", "NFT Domains", "nocoiner", "node", "oracle", "paper hands", "PFP", "private key", "PoS", "PoW", "protocol", "public key", "rollup", "satoshis", "seed phrase", "SHA-256", "shitcoin", "sidechain", "smart contract", "solidity", "stablecoin", "testnet", "token", "TPS", "transaction", "TVL", "txn hash", "WAGMI", "wallet", "wallet address", "web1", "web2", "web3", "YOLO", "AI", "avatar"];
    string[15] verb = ["airdrop", "ape", "buidl", "burn", "fork", "fractionalize", "hard fork", "hashing", "mining", "minting", "pump and dump", "red Pilled", "rug pull", "sharding", "slashing"];
    uint8 pronounLen = 6;
    uint8 nounLen = 93;
    uint8 verbLen = 15;
...
//        ens = _ens;
    ...
    function convertString(string calldata str) public pure returns (uint256 value) {
    ...
    function purchaseMusicPass(string calldata walletAddress, uint32 genreId) external payable {
        require(!paused, "The contract has been paused");

        // Hash wallet address
        uint256 pronounIdx = convertString(walletAddress[2:12])%pronounLen;
        uint256 nounIdx = convertString(walletAddress[12:22])%nounLen;
        uint256 verbIdx = convertString(walletAddress[22:32])%verbLen;
        string memory domainName = append(pronoun[pronounIdx], " ", verb[verbIdx], " ", noun[nounIdx]);
