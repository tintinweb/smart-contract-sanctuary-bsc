...
contract ARB is Ownable {
    ...
    constructor (){
        ...
        lpAddress = 0xB233B380286ABE66596c96fa135f3F22a5aDa636; //LP地址
        ...
        arbAddress = 0x2b1becb8835Ae2885Ed9A5b2A53352Fcfe4Ec8A8;//ARB代币
        usdtAddress = 0xaeabC0F28A0dE80AC642616189E0d6c382b4BD9E;//USDT代币
    ...
    function _addLiq(uint256 arbAmount, uint256 usdtAmount, address lpAcceptAddress) internal returns(uint) {
      ...
      remainArb = remainArb.add(arbAmount.sub(amountA));
      remainUsdt = remainUsdt.add(usdtAmount.sub(amountB));
      return lpAmount;
    }
