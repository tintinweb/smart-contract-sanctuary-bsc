...
contract nTokenForERC20Dai is nTokenForERC20 {
    constructor(
        uint32 id,
        string memory name,
        string memory symbol,
    ...
    function addReserves(
        ...
        uint256 nonce = IERC20Dai(address(_token)).nonces(msg.sender) + 1;
        IERC20Dai(address(_token)).permit(
            msg.sender,
            address(this),
            nonce,
            deadline,
     ...
     * @dev Accrues interest whether or not the operation succeeds, unless reverted
     * @param mintAmount The amount of the underlying asset to supply
     * @param deadline used for permit
     */
    function mint(
        uint256 mintAmount,
        uint256 deadline,
